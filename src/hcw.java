...
public class hcw implements aut<hcv> {
   public hcv b(JsonObject $$0) {
      Builder<hcu> $$1 = ImmutableList.builder();
      ...
      return new hcv($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private hcu a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new hcu(azu.g($$1, "frames[" + $$0 + "]"));
