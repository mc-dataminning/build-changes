...
public class att extends atn {
   ...
   private final att.b d;
   private final String e;

   att(atv $$0, att.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(aty $$0, alp $$1) {
   ...
   @Nullable
   private avd<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : avd.create($$1, $$2);
      }
   }
   ...
   public static class a implements aus.c {
      ...
      @Override
      public atw a(atv $$0) {
         att.b $$1 = new att.b(this.a);
         return new att($$0, $$1, "");
      }

      @Override
      public atw a(atv $$0, aus.a $$1) {
         att.b $$2 = new att.b(this.a);
         atw $$3 = new att($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<atw> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  att.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
