...
class att implements Path {
   private static final BasicFileAttributes a = new atr() {
      @Override
   ...
   private static final BasicFileAttributes b = new atr() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<att> c = Comparator.comparing(att::n);
   ...
   public att(atv $$0, String $$1, @Nullable att $$2, atw $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private att a(@Nullable att $$0, String $$1) {
      return new att(this.e, $$1, $$0, atw.b);
   }
   ...
   att a(String $$0) {
      if (a(this.i)) {
         return new att(this.e, $$0, this, this.i);
      } else if (this.i instanceof atw.a $$1) {
         att $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new att(this.e, $$0, this, atw.a);
      } else if (this.i instanceof atw.b) {
         return new att(this.e, $$0, this, atw.a);
      } else {
   ...
   private att c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof att $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atw.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atw.a i() {
      return this.i instanceof atw.a $$0 ? $$0 : null;
   }
