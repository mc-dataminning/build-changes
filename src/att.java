...
public class att implements atp {
   ...
   public void a(atr $$0, all $$1, Consumer<Path> $$2) {
      v.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(atr $$0, String $$1, String $$2, atp.a $$3) {
      v.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<all, auv<InputStream>> $$6 = new HashMap<>();
   ...
   public auv<InputStream> a(atr $$0, all $$1) {
      return (auv<InputStream>)v.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();
   ...
   public <T> T a(auc<T> $$0) {
      auv<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public avh d() {
      return $$0 -> Optional.ofNullable(this.a(atr.a, $$0)).map($$0x -> new avc(this, $$0x));
   }
}
