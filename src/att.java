...
public class att {
   public static final Codec<att> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(asu.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), asu.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, att::new)
   );
   ...
   private final Predicate<agi> f;

   private att(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
