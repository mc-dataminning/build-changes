...
public class att extends ayb {
   public att(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", ayz.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(ayz.s, "minecraft:piston");
