public class fjr<T extends cdh> extends fmn<T> {
   public fjr(fmv $$0) {
      super($$0);
   }
   ...
   public static fnb a(fmz $$0) {
      fnd $$1 = fki.a($$0, 0.0F);
      fne $$2 = $$1.a();
      $$2.a("left_arm", fna.c().a(32, 48).a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fmx.a(5.0F, 2.0F, 0.0F));
      $$2.a("left_leg", fna.c().a(16, 48).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fmx.a(1.9F, 12.0F, 0.0F));
