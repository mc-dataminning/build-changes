...
public class fjr {
   public static List<flc> a(fjr.a... $$0) {
      for (fjr.a $$1 : $$0) {
         a($$1.j);
      }

      List<flc> $$2 = Lists.newArrayList();

      for (fjr.a $$3 : $$0) {
         $$2.add(new flc($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(flc::a));
      return $$2;
   }
   ...
   public static List<flc> a() {
      return a(fjr.a.values());
   }
