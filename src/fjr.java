...
public class fjr {
   public static void a(fyu $$0, fjp $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fjo>> $$6 : $$1.c().entrySet()) {
         Optional<gbb> $$7 = $$0.a($$6.getKey());
         List<fjo> $$8 = $$6.getValue();
         $$7.ifPresent($$4x -> $$8.forEach($$4xx -> {
               fjq[] $$5x = $$4xx.b();
               int $$6x = Math.max(0, azj.a(0, $$5x.length, $$2xxx -> $$5 <= $$5x[$$2xxx].a()) - 1);
               ...
               float $$11;
               if ($$7x != $$6x) {
                  $$11 = azj.a($$10 / ($$9.a() - $$8x.a()), 0.0F, 1.0F);
               } else {
                  $$11 = 0.0F;
               }
   ...
   private static float a(fjp $$0, long $$1) {
