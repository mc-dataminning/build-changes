...
public class fjr implements fsy {
   ...
   protected void a(fhf $$0, float $$1, int $$2, int $$3, fsz $$4) {
   ...
   private void a(fhf $$0, int $$1, int $$2, float $$3, float $$4, fsx $$5) {
      if ($$5 != fsv.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fsv.a || !this.g.a($$1).aS_())) {
         $$1 += $$0;
      }
