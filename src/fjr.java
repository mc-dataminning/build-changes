...
public class fjr extends hhv {
   ...
   public void aT_() {
      ...
      this.R = this.n / 2 - 187;
      this.S = this.n / 2 + 190;
      this.T = this.c(foe.a(xv.c("mco.configure.world.buttons.players"), $$0x -> this.m.a(new fkc(this, this.P))).a(this.a(0, 3), g(0), 100, 20).a());
      this.U = this.c(foe.a(xv.c("mco.configure.world.buttons.settings"), $$0x -> this.m.a(new fkh(this, this.P.g()))).a(this.a(1, 3), g(0), 100, 20).a());
      this.V = this.c(
         foe.a(xv.c("mco.configure.world.buttons.subscription"), $$0x -> this.m.a(new fkj(this, this.P.g(), this.O))).a(this.a(2, 3), g(0), 100, 20).a()
      );
      this.ab.clear();
      ...
      this.Z = this.c(
         foe.a(xv.c("mco.configure.world.buttons.switchminigame"), $$0x -> this.m.a(new fkg(xv.c("mco.template.title.minigame"), this::a, fii.d.b)))
            .a(this.b(0), g(13) - 5, 100, 20)
            .a()
      );
      this.W = this.c(
         foe.a(xv.c("mco.configure.world.buttons.options"), $$0x -> this.m.a(new fki(this, this.P.i.get(this.P.p).d(), this.P.m, this.P.p)))
            .a(this.b(0), g(13) - 5, 90, 20)
            .a()
      );
      this.X = this.c(foe.a(xv.c("mco.configure.world.backup"), $$0x -> this.m.a(new fjo(this, this.P.g(), this.P.p))).a(this.b(1), g(13) - 5, 90, 20).a());
      this.Y = this.c(
         foe.a(xv.c("mco.configure.world.buttons.resetworld"), $$0x -> this.m.a(fke.a(this, this.P.g(), () -> this.m.execute(() -> this.m.a(this.g())))))
            .a(this.b(2), g(13) - 5, 90, 20)
            .a()
      );
      this.c(foe.a(xu.k, $$0x -> this.aP_()).a(this.S - 80 + 8, g(13) - 5, 70, 20).a());
      this.X.j = true;
      if (this.P == null) {
         this.K();
         this.J();
   ...
   private void F() {
      fkg $$0 = new fkg(xv.c("mco.template.title.minigame"), this::a, fii.d.b);
      $$0.a(xv.c("mco.minigame.world.info.line1"), xv.c("mco.minigame.world.info.line2"));
      this.m.a($$0);
   }

   private void a(int $$0, fii $$1) {
      this.m.a(fkd.a(this, xv.c("mco.configure.world.slot.switch.question.line1"), $$2 -> {
         this.f();
   ...
   private void b(fnr $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.P.j) {
