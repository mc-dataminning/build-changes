...
public class fjr extends fjh<cnm> {
   ...
   private final fiw R = new fiw(0);
   private final fiw S = new fiw(1);
   private final fiw T = new fiw(2);
   @Nullable
   private ceu U;

   public fjr(cnm $$0, cit $$1, vu $$2) {
   ...
   @Override
   protected void I() {
      this.U = new ceu(this.f.r, 0.0, 0.0, 0.0);
      this.U.s(true);
      this.U.a(true);
      this.U.aX = 210.0F;
      this.U.s(25.0F);
   ...
   public void E() {
      super.E();
      Optional<cro> $$0 = this.J();
      this.R.a(C);
      this.S.a($$0.map(cro::y).orElse(List.of()));
      this.T.a($$0.map(cro::z).orElse(List.of()));
   }

   private Optional<cro> J() {
      cqm $$0 = this.p.b(0).g();
      return !$$0.b() && $$0.d() instanceof cro $$1 ? Optional.of($$1) : Optional.empty();
   }
   ...
   protected void a(fav $$0, float $$1, int $$2, int $$3) {
      ...
      fjg.a($$0, (float)(this.t + 141), (float)(this.u + 75), 25.0F, M, N, null, this.U);
   }
   ...
   private void d(fav $$0, int $$1, int $$2) {
      ...
      if (this.r != null) {
         ...
         } else if ($$4.d() instanceof cro $$6 && $$5.b()) {
            if (this.r.e == 1) {
               $$3 = Optional.of($$6.i());
            } else if (this.r.e == 2) {
               $$3 = Optional.of($$6.j());
