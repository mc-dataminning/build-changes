...
public class ddq {
   public static <T> List<ddq.b> a(List<T> $$0, Function<T, List<jn<eib>>> $$1, boolean $$2) {
      Object2IntMap<eib> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eib c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jn<eib>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jj<eib> $$12 : $$10.get($$11)) {
               eib $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && axv.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<ddq.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eib> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddq.b($$28));
      }
   ...
   public static record b(List<eib> a, ToIntFunction<eib> b) {
      b(List<eib> $$0) {
         this($$0, ac.h($$0));
      }
   }
