...
public class fdg extends fbt<cil> {
   private static final agi x = new agi("container/stonecutter/scroller");
   private static final agi y = new agi("container/stonecutter/scroller_disabled");
   private static final agi z = new agi("container/stonecutter/recipe_selected");
   private static final agi A = new agi("container/stonecutter/recipe_highlighted");
   private static final agi B = new agi("container/stonecutter/recipe");
   private static final agi C = new agi("textures/gui/container/stonecutter.png");
   ...
   private void b(euo $$0, int $$1, int $$2, int $$3) {
      List<coq<cph>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.M = atm.a(this.M - $$5, 0.0F, 1.0F);
