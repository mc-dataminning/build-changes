...
public class fdg {
   ...
   @Nullable
   private String g;
   private static final fdg.a h = new fdg.a() {
      @Nullable
      @Override
      public fdf a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fdj.a(this.d, "Get capabilities")) {
         ...
         if (fdj.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fdj.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fdj.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fdf a(fdg.c $$0) {
      return ($$0 == fdg.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fdg.a {
      private final int a;
      private final Set<fdf> b = Sets.newIdentityHashSet();
      ...
      public fdf a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fdg.a.warn("Maximum sound pool size {} reached", this.a);
            }
