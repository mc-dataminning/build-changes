public class fdg<T extends bfj> extends fbo<T> {
   ...
   public static fek b() {
      ...
      $$1.a("body0", fej.c().a(0, 0).a(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F), feg.a(0.0F, 15.0F, 0.0F));
      $$1.a("body1", fej.c().a(0, 12).a(-5.0F, -4.0F, -6.0F, 10.0F, 8.0F, 12.0F), feg.a(0.0F, 15.0F, 9.0F));
      ...
      $$1.a("right_middle_hind_leg", $$3, feg.a(-4.0F, 15.0F, 1.0F));
      $$1.a("left_middle_hind_leg", $$4, feg.a(4.0F, 15.0F, 1.0F));
      $$1.a("right_middle_front_leg", $$3, feg.a(-4.0F, 15.0F, 0.0F));
      $$1.a("left_middle_front_leg", $$4, feg.a(4.0F, 15.0F, 0.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      float $$11 = -(apa.b($$1 * 0.6662F * 2.0F + (float) (Math.PI / 2)) * 0.4F) * $$2;
      float $$12 = -(apa.b($$1 * 0.6662F * 2.0F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * $$2;
      float $$13 = Math.abs(apa.a($$1 * 0.6662F + 0.0F) * 0.4F) * $$2;
      float $$14 = Math.abs(apa.a($$1 * 0.6662F + (float) Math.PI) * 0.4F) * $$2;
      float $$15 = Math.abs(apa.a($$1 * 0.6662F + (float) (Math.PI / 2)) * 0.4F) * $$2;
      float $$16 = Math.abs(apa.a($$1 * 0.6662F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * $$2;
      this.l.f += $$9;
      this.m.f += -$$9;
      this.n.f += $$10;
      this.o.f += -$$10;
