...
public abstract class bwf extends cgz implements bvp {
   public static final int bY = 144;
   private static final int cc = 2;
   private static final int cd = 3;
   private static final int ce = 1;
   protected static final ajy<Byte> bZ = akc.a(bwf.class, aka.a);
   protected static final ajy<Optional<UUID>> ca = akc.a(bwf.class, aka.r);
   private boolean cf;

   protected bwf(but<? extends bwf> $$0, dgj $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(btc $$0) {
      if (this.dV() instanceof ard $$1 && $$1.O().b(dgf.n) && this.ag_() instanceof are $$2) {
         $$2.a(this.eQ().a());
      }
   ...
   public boolean gu() {
      bvi $$0 = this.ag_();
      return $$0 != null && this.g((bum)this.ag_()) >= 144.0;
   }
   ...
   public class a extends ccz {
      public a(final double param3, final axf<bte> bwf.this) {
         super(bwf.this, $$1, $$2);
      }
