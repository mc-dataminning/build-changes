...
public class frc implements fra {
   ...
   private final frc.a n;
   private final List<ayk> o;
   private fra.a p = fra.a.a;
   private long q;
   private float r;
   private float s;
   ...
   public frc(fnz $$0, frc.a $$1, wo $$2, @Nullable wo $$3, boolean $$4, int $$5) {
      this.n = $$1;
   ...
   public frc(fnz $$0, frc.a $$1, wo $$2, @Nullable wo $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, 0);
   }
   ...
   public void a(frb $$0, long $$1) {
      if (this.u > 0) {
         ...
         this.r = ayy.b(this.r, this.s, (float)($$1 - this.q) / 100.0F);
         this.q = $$1;
      }
   }
