...
public class frc extends fqs implements gbs.a {
   private static final alh x = alh.b("textures/gui/advancements/window.png");
   ...
   private static final xh F = xh.c("advancements.sad_label");
   private static final xh G = xh.c("advancements.empty");
   private static final xh H = xh.c("gui.advancements");
   private final fon I = new fon(this);
   @Nullable
   private final fqs J;
   private final gbs K;
   private final Map<ag, fqy> L = Maps.newLinkedHashMap();
   @Nullable
   private fqy M;
   private boolean N;
   ...
   public frc(gbs $$0, @Nullable fqs $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aS_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fqy $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(fkz.a(xg.d, $$0x -> this.d()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fkm $$0, int $$1, int $$2) {
      $$0.a(gig::B, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fqy $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fqy $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fkm $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ah $$0) {
      fqy $$1 = fqy.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
