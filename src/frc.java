...
public class frc {
   ...
   public frc(fra $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(boolean $$0, float $$1, float $$2, Matrix4f $$3, fgw $$4, int $$5, int $$6) {
      float $$7 = $$1 + this.f;
      float $$8 = $$1 + this.g;
      float $$9 = $$2 + this.h;
      float $$10 = $$2 + this.i;
   ...
   public void a(frc.a $$0, Matrix4f $$1, fgw $$2, int $$3) {
   ...
   public static record b(float a, float b, int c, frc d, ys e, float f) {
   }
}
