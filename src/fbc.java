...
public class fbc extends fau {
   ...
   private static final agi b = new agi("textures/misc/vignette.png");
   ...
   private int z;
   private final evq A = new evq(false);

   public fbc(boolean $$0, Runnable $$1) {
      super(esv.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fbc.a $$1) {
      try (Reader $$2 = this.f.Y().openAsReader(new agi($$0))) {
         $$1.read($$2);
