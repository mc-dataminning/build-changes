...
public abstract class fbc extends fbe {
   ...
   public fbc(int $$0, int $$1, int $$2, int $$3, vu $$4, double $$5) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
   }
   ...
   public void a(ffc $$0) {
      ...
      if (this.j) {
         if (this.aJ_()) {
            $$0.a(ffb.d, vu.c("narration.slider.usage.focused"));
         } else {
            $$0.a(ffb.d, vu.c("narration.slider.usage.hovered"));
         }
      }
   }
