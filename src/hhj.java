...
public class hhj extends hgw {
   private final List<hhj.a> b;
   private final Map<dwx, BitSet> c = new Reference2ObjectOpenHashMap();

   private static hgs a(List<hhj.a> $$0) {
      if ($$0.isEmpty()) {
   ...
   public static record a(Predicate<dwx> a, hgs b) {
   }
}
