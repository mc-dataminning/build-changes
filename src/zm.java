...
public class zm<B extends ByteBuf, V, T> implements zn<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<zm.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   zm(Function<V, ? extends T> $$0, List<zm.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         xg.a($$0, $$3);
         zm.b<B, V, T> $$4 = this.c.get($$3);

         try {
            zn<? super B, V> $$5 = (zn<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> zm.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new zm.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<zm.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public zm.a<B, V, T> a(T $$0, zn<? super B, ? extends V> $$1) {
         this.a.add(new zm.b<>($$1, $$0));
         return this;
      }
      ...
      public zm<B, V, T> a() {
         ...
         return new zm<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(zn<? super B, ? extends V> a, T b) {
   }
}
