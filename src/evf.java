...
public class evf implements Comparable<evf> {
   private static final Map<String, evf> h = Maps.newHashMap();
   private static final Map<eov.a, evf> i = Maps.newHashMap();
   ...
   private final eov.a m;
   private final String n;
   private eov.a o;
   private boolean p;
   private int q;

   public static void a(eov.a $$0) {
      evf $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(eov.a $$0, boolean $$1) {
      evf $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (evf $$0 : h.values()) {
         if ($$0.o.a() == eov.b.a && $$0.o.b() != eov.bv.b()) {
            $$0.a(eov.a(evh.O().aM().i(), $$0.o.b()));
         }
      }
   }
   ...
   public evf(String $$0, int $$1, String $$2) {
      this($$0, eov.b.a, $$1, $$2);
   }

   public evf(String $$0, eov.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(eov.a $$0) {
      this.o = $$0;
   }

   public int a(evf $$0) {
      return this.n.equals($$0.n) ? gfr.a(this.l).compareTo(gfr.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(evf $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(eov.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == eov.bv.b() ? this.o.a() == eov.b.b && this.o.b() == $$1 : this.o.a() == eov.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == eov.b.c && this.o.b() == $$0;
   }
