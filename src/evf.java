...
public class evf {
   ...
   public evf(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evg> $$1) throws IOException {
   ...
   public List<evg> a(Path $$0) throws IOException {
      List<evg> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evg> a(Path $$0, boolean $$1) throws IOException {
      List<evg> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evg> $$1) throws IOException {
