...
public abstract class evf {
   ...
   public euh a() {
      if (this.c()) {
         ...
         return new euh(this.b(it.a.a), this.b(it.a.b), this.b(it.a.c), this.c(it.a.a), this.c(it.a.b), this.c(it.a.c));
      }
   }

   public evf b() {
      return this.c() ? evc.a() : evc.a(this.b(it.a.a), this.b(it.a.b), this.b(it.a.c), this.c(it.a.a), this.c(it.a.b), this.c(it.a.c));
   }
   ...
   public evf a(double $$0, double $$1, double $$2) {
      return (evf)(this.c() ? evc.a() : new euo(this.a, new evb(this.a(it.a.a), $$0), new evb(this.a(it.a.b), $$1), new evb(this.a(it.a.c), $$2)));
   }

   public evf d() {
      evf[] $$0 = new evf[]{evc.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = evc.b($$0[0], evc.a($$1, $$2, $$3, $$4, $$5, $$6), euq.o));
      return $$0[0];
   }
   ...
   public List<euh> e() {
      List<euh> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new euh($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(it.a $$0, double $$1) {
      return ayf.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public eui a(eum $$0, eum $$1, io $$2) {
      if (this.c()) {
         return null;
      } else {
         eum $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(it.a.a, $$4.c - (double)$$2.u()), this.a(it.a.b, $$4.d - (double)$$2.v()), this.a(it.a.c, $$4.e - (double)$$2.w()))
               ? new eui($$4, it.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : euh.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<eum> a(eum $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         eum[] $$1 = new eum[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = ayf.a($$0.a(), $$2, $$5);
            double $$9 = ayf.a($$0.b(), $$3, $$6);
            double $$10 = ayf.a($$0.c(), $$4, $$7);
   ...
   public evf a(it $$0) {
      if (!this.c() && this != evc.b()) {
         if (this.b != null) {
            evf $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private evf b(it $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new evd(this, $$1, $$4);
      }
   }

   public double a(it.a $$0, euh $$1, double $$2) {
      return this.a(il.a($$0, it.a.a), $$1, $$2);
   }

   protected double a(il $$0, euh $$1, double $$2) {
      if (this.c()) {
         return $$2;
