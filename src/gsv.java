...
public class gsv extends gqd<cih, gyu, gcc> {
   private static final Map<cih.a, alz> a = ae.a(Maps.newEnumMap(cih.a.class), $$0 -> {
      $$0.put(cih.a.a, alz.b("textures/entity/panda/panda.png"));
      $$0.put(cih.a.b, alz.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(cih.a.c, alz.b("textures/entity/panda/worried_panda.png"));
      $$0.put(cih.a.d, alz.b("textures/entity/panda/playful_panda.png"));
      $$0.put(cih.a.e, alz.b("textures/entity/panda/brown_panda.png"));
      $$0.put(cih.a.f, alz.b("textures/entity/panda/weak_panda.png"));
      $$0.put(cih.a.g, alz.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gsv(grj.a $$0) {
      super($$0, new gcc($$0.a(geg.bI)), new gcc($$0.a(geg.bJ)), 0.9F);
      this.a(new gvu(this, $$0.b()));
   }

   public alz a(gyu $$0) {
      return a.getOrDefault($$0.a, a.get(cih.a.a));
   }
   ...
   public void a(cih $$0, gyu $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.gA();
      $$1.b = $$0.p() > 0;
      $$1.c = $$0.t();
   ...
   protected void a(gyu $$0, fgl $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.k > 0.0F) {
         float $$4 = bae.i($$0.k);
         int $$5 = bae.d($$0.k);
