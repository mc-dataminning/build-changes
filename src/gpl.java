...
public class gpl implements gpe {
   ...
   private gpl(List<alf> $$0, alf $$1, Map<String, alf> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(gpk a, Supplier<IntUnaryOperator> b, alf c) implements gpe.b {
      @Nullable
      public gou a(gpd $$0) {
         Object var3;
         try {
            eza $$1 = this.a.a().a(this.b.get());
            return new gou(this.c, new gqn($$1.a(), $$1.b()), $$1, aur.a);
         } catch (IllegalArgumentException | IOException var7) {
            gpl.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
