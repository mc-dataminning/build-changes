...
public class gpl {
   private static final gqc a = gqc.u(alg.b("textures/map/map_background.png"));
   private static final gqc b = gqc.u(alg.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fos au;
   private final hhy av = new hhy();
   private cyy aw = cyy.k;
   private cyy ax = cyy.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gvx aC;
   private final gwx aD;
   private final hfg aE;

   public gpl(fos $$0, gvx $$1, gwx $$2, hfg $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bxc $$0, cyy $$1, cyw $$2, boolean $$3, fjc $$4, gps $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dV(), $$6, hif.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fjc $$0, gps $$1, int $$2, bwv $$3) {
      hbf $$4 = (hbf)this.aC.<gom>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bwv.b ? 1.0F : -1.0F;
      ...
      alg $$6 = this.au.t.c().a();
      if ($$3 == bwv.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cqz.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cqz.c));
      }

      $$0.b();
   }

   private void a(fjc $$0, gps $$1, int $$2, float $$3, bwv $$4, float $$5, cyy $$6) {
      float $$7 = $$4 == bwv.b ? 1.0F : -1.0F;
   ...
   private void a(fjc $$0, gps $$1, int $$2, cyy $$3) {
      ...
      exz $$4 = $$3.a(kj.M);
      eyb $$5 = czl.a($$4, this.au.s);
      fjg $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fjc $$0, gps $$1, int $$2, float $$3, float $$4, bwv $$5) {
      boolean $$6 = $$5 != bwv.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azm.c($$4);
      ...
      hbf $$15 = (hbf)this.aC.<gom>a($$14);
      alg $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cqz.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cqz.c));
      }
   }

   private void a(fjc $$0, float $$1, bwv $$2, cyy $$3, cqy $$4) {
      float $$5 = (float)$$4.fB() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bxc)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fjc $$0, float $$1, bwv $$2, cyy $$3, cqy $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fjc $$0, bwv $$1, float $$2) {
      int $$3 = $$1 == bwv.b ? 1 : -1;
   ...
   private void b(fjc $$0, bwv $$1, float $$2) {
      int $$3 = $$1 == bwv.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fjc $$1, gps.a $$2, gop $$3, int $$4) {
      float $$5 = $$3.D($$0);
      bua $$6 = (bua)MoreObjects.firstNonNull($$3.aJ, bua.a);
      float $$7 = $$3.k($$0);
      gpl.a $$8 = a($$3);
      float $$9 = azm.h($$0, $$3.cu, $$3.cs);
      float $$10 = azm.h($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.i($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.j($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bua.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azm.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, bua.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bua.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azm.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, bua.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gpl.a a(gop $$0) {
      cyy $$1 = $$0.fa();
      cyy $$2 = $$0.fb();
      boolean $$3 = $$1.a(czc.pg) || $$2.a(czc.pg);
      boolean $$4 = $$1.a(czc.xb) || $$2.a(czc.xb);
      if (!$$3 && !$$4) {
         return gpl.a.a;
      } else if ($$0.fy()) {
         return b($$0);
      } else {
         return a($$1) ? gpl.a.b : gpl.a.a;
      }
   }

   private static gpl.a b(gop $$0) {
      cyy $$1 = $$0.fA();
      bua $$2 = $$0.fz();
      if (!$$1.a(czc.pg) && !$$1.a(czc.xb)) {
         return $$2 == bua.a && a($$0.fb()) ? gpl.a.b : gpl.a.a;
      } else {
         return gpl.a.a($$2);
      }
   }
   ...
   private static boolean a(cyy $$0) {
      return $$0.a(czc.xb) && cxr.g($$0);
   }

   private void a(gom $$0, float $$1, float $$2, bua $$3, float $$4, cyy $$5, float $$6, fjc $$7, gps $$8, int $$9) {
      if (!$$0.gG()) {
         boolean $$10 = $$3 == bua.a;
         bwv $$11 = $$10 ? $$0.fx() : $$0.fx().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cp()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fy() && $$0.fB() > 0 && $$0.fz() == $$3 && !$$12) {
               ...
               float $$15 = (float)$$5.a((bxc)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cxr.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? cyw.e : cyw.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bwv.b;
            int $$21 = $$20 ? 1 : -1;
            if ($$0.fy() && $$0.fB() > 0 && $$0.fz() == $$3) {
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$22 = (float)$$5.a((bxc)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
                     float $$23 = $$22 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$21 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$21 * -9.785F));
                     float $$27 = (float)$$5.a((bxc)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
                     float $$28 = $$27 / 10.0F;
                     if ($$28 > 1.0F) {
                        $$28 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$20 ? cyw.e : cyw.d, !$$20, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, fjc $$2, int $$3, bwv $$4) {
   ...
   private boolean a(cyy $$0, cyy $$1) {
      return cyy.a($$0, $$1) ? true : !this.aE.a($$1);
   }
