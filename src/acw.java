...
public class acw {
   ...
   public acw(dzw $$0) {
      ...
      for (Entry<ji, dus> $$2 : $$0.I().entrySet()) {
         this.d.add(acw.a.a($$2.getValue()));
      }
   }

   public acw(wa $$0, int $$1, int $$2) {
      this.b = $$0.o();
      if (this.b == null) {
   ...
   static class a {
      public static final yn<wa, acw.a> a = yn.a(acw.a::a, acw.a::new);
      public static final yn<wa, List<acw.a>> b = a.a(yl.a());
      final int c;
      final int d;
      final duu<?> e;
      @Nullable
      ...
      private a(int $$0, int $$1, duu<?> $$2, @Nullable tq $$3) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
         this.f = $$3;
   ...
   @FunctionalInterface
   public interface b {
      void accept(ji var1, duu<?> var2, @Nullable tq var3);
   }
}
