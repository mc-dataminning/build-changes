...
public class acw {
   ...
   public acw(dza $$0) {
      ...
      for (Entry<ji, dtx> $$2 : $$0.I().entrySet()) {
   ...
   static class a {
      ...
      private a(int $$0, int $$1, dtz<?> $$2, @Nullable tq $$3) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
         this.f = $$3;
   ...
   @FunctionalInterface
   public interface b {
      void accept(ji var1, dtz<?> var2, @Nullable tq var3);
   }
}
