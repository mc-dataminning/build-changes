public class ftm {
   ...
   public void a(fsh $$0, int $$1, float $$2) {
      this.a($$0, $$1, $$2, 30);
   }

   public void a(fsh $$0, int $$1, float $$2, int $$3) {
      int $$4 = $$1 / 2 - 128;
      float $$5 = this.o ? 1.0F : $$2;
      int $$6 = axw.a($$5);
      $$0.a(gqx::H, this.n ? b : a, $$4, $$3, 0.0F, 0.0F, 256, 44, 256, 64, $$6);
      int $$7 = $$1 / 2 - 64;
      int $$8 = $$3 + 44 - 7;
      $$0.a(gqx::H, c, $$7, $$8, 0.0F, 0.0F, 128, 14, 128, 16, $$6);
   }
}
