public class ftm extends fuh {
   private final fuc a;

   ftm(fqe $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fuc $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         chl $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dt();
            if (this.h > $$1) {
   ...
   public static class a implements ftk<kc> {
      ...
      public fth a(kc $$0, fqe $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ftm($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements ftk<kc> {
      ...
      public fth a(kc $$0, fqe $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fth $$8 = new ftm($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
