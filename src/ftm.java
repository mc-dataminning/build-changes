public class ftm extends fuz<cfy> implements ftp {
   private final fxq a;
   private final fxq b;
   private final fxq f;
   private final fxq g;
   ...
   public static fxw b() {
      fxy $$0 = new fxy();
      fxz $$1 = $$0.a();
      fxz $$2 = $$1.a("root", fxv.c(), fxs.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", fxv.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new fxu(0.0F)), fxs.a(0.0F, -3.99F, 0.0F));
      fxz $$3 = $$2.a(
         "body",
         fxv.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new fxu(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new fxu(-0.2F)),
         fxs.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", fxv.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fxu(-0.01F)), fxs.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", fxv.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fxu(-0.01F)), fxs.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", fxv.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fxu(0.0F)), fxs.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", fxv.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fxu(0.0F)), fxs.a(0.5F, 0.0F, 0.6F));
      return fxw.a($$0, 32, 32);
   }

   public void a(cfy $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
