...
public abstract class ftm extends fsz {
   protected float D;
   private final Quaternionf a = new Quaternionf();

   protected ftm(fpx $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }

   protected ftm(fpx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }
   ...
   public interface a {
      ftm.a a = ($$0, $$1, $$2) -> $$0.set($$1.f());
      ftm.a b = ($$0, $$1, $$2) -> $$0.set(0.0F, $$1.f().y, 0.0F, $$1.f().w);
