...
public class ftm implements ftq.a {
   ...
   private final esr J;
   private final Map<ht, ftm.a> K = Maps.newHashMap();
   private final Map<UUID, xb.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bki $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dG();
      });
   }

   private void b(enk $$0, fqh $$1, double $$2, double $$3, double $$4) {
      ht $$5 = ht.a($$2, $$3, $$4);
   ...
   private static void a(enk $$0, fqh $$1, ht $$2) {
      float $$3 = 0.05F;
      ftq.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(enk $$0, fqh $$1, ht $$2, List<String> $$3) {
      float $$4 = 0.05F;
      ftq.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(enk $$0, fqh $$1, ftm.a $$2) {
      int $$3 = 0;
   ...
   private void a(enk $$0, fqh $$1, xb.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         fty.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(enk $$0, fqh $$1, xb.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(enk $$0, fqh $$1, String $$2, ftm.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }

   private static void a(enk $$0, fqh $$1, String $$2, ht $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      ftq.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(enk $$0, fqh $$1, im $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      ht $$9 = ht.a($$2);
      ...
      float $$13 = 0.5F;
      ftq.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }

   private Set<String> b(ftm.a $$0) {
      return this.b($$0.a).stream().map(ach::a).collect(Collectors.toSet());
   }

   private Set<String> c(ftm.a $$0) {
      return this.c($$0.a).stream().map(ach::a).collect(Collectors.toSet());
   }

   private boolean b(xb.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(xb.a $$0) {
      cdm $$1 = this.J.s;
   ...
   private Collection<UUID> b(ht $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(xb.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(ht $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(xb.a::a).collect(Collectors.toSet());
   }

   private Map<ht, List<String>> c() {
      Map<ht, List<String>> $$0 = Maps.newHashMap();

      for (xb.a $$1 : this.L.values()) {
   ...
   private void d() {
      ftq.a(this.J.al(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
