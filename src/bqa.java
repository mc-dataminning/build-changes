...
public interface bqa {
   static bpu<StringReader> a(String $$0) {
      return new bqa.b($$0);
   }

   static bpu<StringReader> a(char $$0) {
      return new bqa.a($$0);
   }

   public static record a(char a) implements bpu<StringReader> {
      @Override
      public boolean a(bpq<StringReader> $$0, bps $$1, bpm $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bpu<StringReader> {
      @Override
      public boolean a(bpq<StringReader> $$0, bps $$1, bpm $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
