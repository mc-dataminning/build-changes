...
public class bqa implements bpt {
   ...
   public static Set<bpr> a() {
      Builder<bpr> $$0 = ImmutableSet.builder();

      try {
         bqa.a $$1 = new bqa.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bpr.a("cpu#" + $$1x, bpq.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bpr.a("heap MiB", bpq.e, () -> (double)ac.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bps.a.a());
      return $$0.build();
   }
   ...
   public static bpr a(final LongSupplier $$0) {
      ...
      bpr.d $$3 = new bpr.d(2.0F);
      return bpr.a("ticktime", bpq.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
