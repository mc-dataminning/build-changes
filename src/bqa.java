...
public abstract class bqa<R extends Runnable> implements bpi, bqc<R>, Executor {
   ...
   @Override
   public List<bpf> bx() {
      return ImmutableList.of(bpf.a(this.b + "-pending-tasks", bpe.b, this::bz));
   }
