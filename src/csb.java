...
public abstract class csb {
   ...
   private final ka<cwo> n = ka.a();
   public final ka<cty> k = ka.a();
   private final List<csv> o = Lists.newArrayList();
   private cwo p = cwo.j;
   private final ka<cwo> q = ka.a();
   ...
   private int v = -1;
   private int w;
   private final Set<cty> x = Sets.newHashSet();
   private final List<csp> y = Lists.newArrayList();
   @Nullable
   private csq z;
   private boolean A;

   protected csb(@Nullable ctk<?> $$0, int $$1) {
      this.u = $$0;
      this.l = $$1;
   }
   ...
   protected void b(bsc $$0, int $$1, int $$2) {
      for (int $$3 = 0; $$3 < 3; $$3++) {
         for (int $$4 = 0; $$4 < 9; $$4++) {
            this.a(new cty($$0, $$4 + ($$3 + 1) * 9, $$1 + $$4 * 18, $$2 + $$3 * 18));
         }
      }
   }
   ...
   protected static boolean a(cso $$0, cow $$1, djl $$2) {
   ...
   protected static void a(csn $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.k.size(); $$0++) {
         cwo $$1 = this.k.get($$0).g();
         Supplier<cwo> $$2 = Suppliers.memoize($$1::v);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cwo $$1, Supplier<cwo> $$2) {
      cwo $$3 = this.n.get($$0);
      if (!cwo.a($$3, $$1)) {
         cwo $$4 = $$2.get();
         this.n.set($$0, $$4);
   ...
   private void b(int $$0, cwo $$1, Supplier<cwo> $$2) {
      if (!this.A) {
         cwo $$3 = this.q.get($$0);
         if (!cwo.a($$3, $$1)) {
            cwo $$4 = $$2.get();
   ...
   public abstract cwo b(cow var1, int var2);

   public void a(int $$0, int $$1) {
      if ($$0 >= 0 && $$0 < this.k.size()) {
         cwo $$2 = this.k.get($$0).g();
         cvb.a($$2, $$1);
      }
   }

   public void a(int $$0, int $$1, csm $$2, cow $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, csm $$2, cow $$3) {
      cov $$4 = $$3.gi();
      if ($$2 == csm.f) {
         int $$5 = this.w;
         this.w = d($$1);
         ...
         this.f();
      } else if (($$2 == csm.a || $$2 == csm.b) && ($$1 == 0 || $$1 == 1)) {
         csl $$16 = $$1 == 0 ? csl.a : csl.b;
         if ($$0 == -999) {
            if (!this.g().f()) {
               if ($$16 == csl.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.f()) {
                  if (!$$21.f()) {
                     int $$22 = $$16 == csl.a ? $$21.M() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.f()) {
                     int $$23 = $$16 == csl.a ? $$20.M() : ($$20.M() + 1) / 2;
                     Optional<cwo> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cwo> $$26 = $$19.a($$20.M(), $$21.k() - $$21.M(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.M());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == csm.d && $$3.fV() && this.g().f() && $$0 >= 0) {
         cty $$32 = this.k.get($$0);
         if ($$32.h()) {
            cwo $$33 = $$32.g();
            this.b($$33.c($$33.k()));
         }
      } else if ($$2 == csm.e && this.g().f() && $$0 >= 0) {
         cty $$34 = this.k.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().M();
         if (!$$3.gl()) {
            return;
         ...
         cwo $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
         $$3.g($$36);
         if ($$1 == 1) {
            while (!$$36.f() && cwo.b($$34.g(), $$36)) {
               if (!$$3.gl()) {
                  return;
               }
         ...
         if (!$$38.f() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.k.size() && $$38.M() < $$38.k(); $$42 += $$40) {
                  cty $$43 = this.k.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cwo $$44 = $$43.g();
                     if ($$41 != 0 || $$44.M() != $$44.k()) {
                        cwo $$45 = $$43.b($$44.M(), $$38.k() - $$38.M(), $$3);
                        $$38.g($$45.M());
                     }
                  }
               }
   ...
   private boolean a(cow $$0, csl $$1, cty $$2, cwo $$3, cwo $$4) {
      crs $$5 = $$0.dV().K();
   ...
   private static void a(cow $$0, cwo $$1) {
      boolean $$2;
      boolean var10000;
      label27: {
         $$2 = $$0.dQ() && $$0.dR() != buk.d.e;
   ...
   public void a(int $$0, int $$1, cwo $$2) {
      this.b($$0).f($$2);
      this.t = $$1;
   }

   public void a(int $$0, List<cwo> $$1, cwo $$2) {
   ...
   public abstract boolean b(cow var1);

   protected boolean a(cwo $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cow $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cty $$0, cwo $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cwo.c($$1, $$0.g()) ? $$0.g().M() + ($$2 ? 0 : $$1.M()) <= $$1.k() : $$3;
   }

   public static int a(Set<cty> $$0, int $$1, cwo $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dty $$0) {
