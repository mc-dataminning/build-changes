...
public class csb extends cuh {
   ...
   private static float a(cwc $$0) {
      return $$0.a(ctr.uu) ? 1.6F : 3.15F;
   }
   ...
   public void a(cto $$0, dax $$1, bso $$2, int $$3) {
      ...
      float $$5 = a($$4, $$0);
      if ($$5 >= 1.0F && !j($$0) && a($$2, $$0)) {
         $$1.a(null, $$2.du(), $$2.dw(), $$2.dA(), avh.go, $$2.de(), 1.0F, 1.0F / ($$1.E_().i() * 0.5F + 1.0F) + 0.2F);
      }
   }

   private static boolean a(bso $$0, cto $$1) {
      List<cto> $$2 = a($$1, $$0.g($$1), $$0);
      if (!$$2.isEmpty()) {
         $$1.b(kb.D, cwc.a($$2));
         return true;
      } else {
   ...
   protected void a(bso $$0, cmo $$1, int $$2, float $$3, float $$4, float $$5, @Nullable bso $$6) {
      ...
      float $$16 = a($$0.el(), $$2);
      $$0.dP().a(null, $$0.du(), $$0.dw(), $$0.dA(), avh.gu, $$0.de(), 1.0F, $$16);
   }

   private static Vector3f a(bso $$0, euk $$1, float $$2) {
   ...
   protected cmo a(dax $$0, bso $$1, cto $$2, cto $$3, boolean $$4) {
      if ($$3.a(ctr.uu)) {
         return new cmj($$0, $$3, $$1, $$1.du(), $$1.dy() - 0.15F, $$1.dA(), true);
      } else {
         cmo $$5 = super.a($$0, $$1, $$2, $$3, $$4);
         if ($$5 instanceof cmc $$6) {
            $$6.q(true);
            $$6.b(avh.gn);
         }
   ...
   protected int k(cto $$0) {
      return $$0.a(ctr.uu) ? 3 : 1;
   }

   public void a(dax $$0, bso $$1, bpt $$2, cto $$3, float $$4, float $$5, @Nullable bso $$6) {
      if (!$$0.x_()) {
         cwc $$7 = $$3.b(kb.D, cwc.a);
         if ($$7 != null && !$$7.b()) {
            this.a($$0, $$1, $$2, $$3, $$7.a(), $$4, $$5, $$1 instanceof clw, $$6);
   ...
   private static float a(ayk $$0, int $$1) {
      return $$1 == 0 ? 1.0F : a(($$1 & 1) == 1, $$0);
   }

   private static float a(boolean $$0, ayk $$1) {
   ...
   public void a(dax $$0, bso $$1, cto $$2, int $$3) {
      if (!$$0.B) {
         ...
         if ($$7 >= 0.2F && !this.l) {
            this.l = true;
            $$0.a(null, $$1.du(), $$1.dw(), $$1.dA(), $$5, avi.h, 0.5F, 1.0F);
         }

         if ($$7 >= 0.5F && $$6 != null && !this.m) {
            this.m = true;
            $$0.a(null, $$1.du(), $$1.dw(), $$1.dA(), $$6, avi.h, 0.5F, 1.0F);
         }
      }
   }
   ...
   private static float a(int $$0, cto $$1) {
   ...
   public void a(cto $$0, @Nullable dax $$1, List<wx> $$2, cvh $$3) {
      ...
      if ($$4 != null && !$$4.b()) {
         cto $$5 = $$4.a().get(0);
         $$2.add(wx.c("item.minecraft.crossbow.projectile").b(ww.v).b($$5.G()));
         if ($$3.a() && $$5.a(ctr.uu)) {
            List<wx> $$6 = Lists.newArrayList();
            ctr.uu.a($$5, $$1, $$6, $$3);
            if (!$$6.isEmpty()) {
               for (int $$7 = 0; $$7 < $$6.size(); $$7++) {
                  $$6.set($$7, wx.b("  ").b($$6.get($$7)).a(n.h));
               }
