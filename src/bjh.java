...
public class bjh extends DataFix {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bis.H);
      Type<?> $$1 = this.getInputSchema().getType(bis.H);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bkg.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bis.g);
      Type<?> $$1 = this.getInputSchema().getType(bis.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bkg.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
