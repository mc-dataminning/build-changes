...
public abstract class bjh extends DataFix {
   private final String a;

   public bjh(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bit.D);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bit.D);
      Type<Pair<String, String>> $$2 = DSL.named(bit.B.typeName(), bko.a());
      if (!Objects.equals(this.getOutputSchema().getType(bit.B), $$2)) {
