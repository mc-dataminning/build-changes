...
public class bjh implements bji {
   ...
   private static final bjh j = new bjh();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bjg $$0) {
      URL $$1 = bjh.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bjg $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bjk a = new bjk(() -> bjh.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bjh.this.k && $$0.getState() == RecordingState.STOPPED) {
