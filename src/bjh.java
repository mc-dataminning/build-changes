...
public class bjh extends DataFix {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(biq.J);
      Type<?> $$1 = this.getInputSchema().getType(biq.J);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bkj.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(biq.g);
      Type<?> $$1 = this.getInputSchema().getType(biq.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bkj.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
