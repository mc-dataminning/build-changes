...
public class ez implements ArgumentType<Integer> {
   private static final Collection<String> a = Arrays.asList("container.5", "12", "weapon");
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> vd.b("slot.unknown", $$0));
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", blu.a.a(98));
      $$0.put("weapon.mainhand", blu.a.a(98));
      $$0.put("weapon.offhand", blu.b.a(98));
      $$0.put("armor.head", blu.f.a(100));
      $$0.put("armor.chest", blu.e.a(100));
      $$0.put("armor.legs", blu.d.a(100));
      $$0.put("armor.feet", blu.c.a(100));
