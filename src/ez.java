...
public class ez implements ArgumentType<ez.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xd.c("argument.angle.incomplete"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xd.c("argument.angle.invalid"));
