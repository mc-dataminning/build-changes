public class eud {
   ...
   private int a(eaj $$0, int $$1, int $$2, int $$3) {
      int $$4 = kl.c($$0.h($$1) + 1);
      jj.a $$5 = this.e.d($$2, $$4, $$3);
      jj.a $$6 = this.f.a($$5, jo.a);
      dym $$7 = dkw.a.m();
   ...
   public boolean a(dgv $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dgv $$0, int $$1, int $$2, jj $$3, dym $$4, jj $$5, dym $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dgv $$0, jj $$1, dym $$2) {
      jj.a $$3 = this.e.g($$1);
      jj.a $$4 = this.f.a($$1, jo.a);
      dym $$5 = $$2;
