...
public interface eud {
   eud a(double var1, double var3, double var5);

   eud a(int var1, int var2, int var3, int var4);

   eud a(float var1, float var2);

   eud a(int var1, int var2);

   eud b(int var1, int var2);

   eud a(float var1, float var2, float var3);
   ...
   default eud a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(etz.a $$0, fyn $$1, float $$2, float $$3, float $$4, int $$5, int $$6) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, new int[]{$$5, $$5, $$5, $$5}, $$6, false);
   }

   default void a(etz.a $$0, fyn $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(etx.j.b());
   ...
   default eud a(etz.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default eud a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default eud b(etz.a $$0, float $$1, float $$2, float $$3) {
