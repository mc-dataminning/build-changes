...
public class eud extends euk {
   ...
   private static final IntSupplier f = () -> enn.N().m.a().c() ? e : d;
   ...
   public void a(eox $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(fkf.D(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         $$10 = 1.0F - apa.a($$7 - 1.0F, 0.0F, 1.0F);
      } else if (this.p) {
         ...
         $$0.a(fkf.D(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         $$10 = apa.a($$8, 0.0F, 1.0F);
      } else {
         int $$13 = f.getAsInt();
   ...
   static class a extends fuo {
      ...
      protected fuo.a b(akx $$0) {
         ajo $$1 = enn.N().aa();
         akp<InputStream> $$2 = $$1.a(ajm.a, eud.c);
         if ($$2 == null) {
            return new fuo.a(new FileNotFoundException(eud.c.toString()));
         } else {
            try {
               fuo.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new fuo.a(new fwn(true, true), ehk.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new fuo.a(var9);
            }
         }
      }
   }
