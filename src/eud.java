...
public class eud {
   ...
   @Nullable
   private String g;
   private static final eud.a h = new eud.a() {
      @Nullable
      @Override
      public euc a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (euh.a(this.d, "Get capabilities")) {
         ...
         if (euh.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  euh.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !euh.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public euc a(eud.c $$0) {
      return ($$0 == eud.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eud.a {
      private final int a;
      private final Set<euc> b = Sets.newIdentityHashSet();
      ...
      public euc a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               eud.a.warn("Maximum sound pool size {} reached", this.a);
            }
