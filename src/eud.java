...
public class eud implements fdb {
   ...
   protected void a(erw $$0, float $$1, int $$2, int $$3, fdc $$4) {
   ...
   private void a(erw $$0, int $$1, int $$2, float $$3, float $$4, fda $$5) {
      if ($$5 != fcy.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fcy.a || !this.g.a($$1).aG_())) {
         $$1 += $$0;
      }
