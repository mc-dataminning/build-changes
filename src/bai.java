...
public class bai extends ber {
   public static final String a = "_filtered_correct";
   private static final String b = "black";

   public bai(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, bfs.s, $$2);
   }
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bai::a);
   }
}
