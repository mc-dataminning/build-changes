...
public class bai extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfy.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bfy.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bfy.s);
