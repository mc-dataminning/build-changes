...
public class exq extends ews {
   ...
   public exq(ewk $$0, int $$1, int $$2, int $$3, int $$4, vd $$5, vd $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new ext($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(far $$0) {
      $$0.a(faq.a, vd.a("gui.narrate.editBox", this.x(), this.j()));
   }
   ...
   protected void a(ewm $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         vd $$2 = vd.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      ext.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         ext.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
