...
public class ahl {
   ...
   private static <T extends ArgumentBuilder<dt, T>> T a(T $$0, ahl.c $$1) {
      return (T)$$0.then(
   ...
   private static bgr a(dt $$0, gw $$1) throws CommandSyntaxException {
      dcv $$2 = $$0.e().c_($$1);
      if (!($$2 instanceof bgr)) {
         throw ahf.a.create($$1.u(), $$1.v(), $$1.w());
      } else {
         return (bgr)$$2;
      }
   }

   private static int a(dt $$0, gw $$1, List<cjf> $$2, ahl.a $$3) throws CommandSyntaxException {
      bgr $$4 = a($$0, $$1);
   ...
   private static int a(dt $$0, gw $$1, int $$2, int $$3, List<cjf> $$4, ahl.a $$5) throws CommandSyntaxException {
      bgr $$6 = a($$0, $$1);
      int $$7 = $$6.b();
      if ($$2 >= 0 && $$2 < $$7) {
   ...
   private static int a(Collection<akr> $$0, List<cjf> $$1, ahl.a $$2) throws CommandSyntaxException {
   ...
   private static int a(Collection<? extends biq> $$0, int $$1, int $$2, List<cjf> $$3, ahl.a $$4) throws CommandSyntaxException {
      List<cjf> $$5 = Lists.newArrayListWithCapacity($$3.size());

      for (biq $$6 : $$0) {
         if ($$6 instanceof akr $$7) {
            a($$6, $$3, $$1, $$2, $$5);
            $$7.bS.d();
         } else {
            a($$6, $$3, $$1, $$2, $$5);
   ...
   private static int a(dt $$0, ehn $$1, List<cjf> $$2, ahl.a $$3) throws CommandSyntaxException {
      akq $$4 = $$0.e();
      $$2.forEach($$2x -> {
   ...
   private static void a(dt $$0, List<cjf> $$1, aew $$2) {
      if ($$1.size() == 1) {
         cjf $$3 = $$1.get(0);
   ...
   private static int a(CommandContext<dt> $$0, gw $$1, cjf $$2, ahl.b $$3) throws CommandSyntaxException {
      dt $$4 = (dt)$$0.getSource();
      akq $$5 = $$4.e();
      dfj $$6 = $$5.a_($$1);
      dcv $$7 = $$5.c_($$1);
   ...
   private static int a(CommandContext<dt> $$0, biq $$1, ahl.b $$2) throws CommandSyntaxException {
      if (!($$1 instanceof bjg)) {
         throw c.create($$1.N_());
      } else {
         aew $$3 = ((bjg)$$1).ez();
   ...
   private static int a(CommandContext<dt> $$0, aew $$1, ahl.b $$2) throws CommandSyntaxException {
      dt $$3 = (dt)$$0.getSource();
      ecw $$4 = new ecw.a($$3.e()).b(efb.a, $$3.f()).a(efb.f, $$3.d()).a(efa.c);
      return a($$0, $$1, $$4, $$2);
   }

   private static int a(CommandContext<dt> $$0, aew $$1, gw $$2, cjf $$3, ahl.b $$4) throws CommandSyntaxException {
      dt $$5 = (dt)$$0.getSource();
      ecw $$6 = new ecw.a($$5.e()).a(efb.f, ehn.b($$2)).a(efb.i, $$3).b(efb.a, $$5.f()).a(efa.f);
      return a($$0, $$1, $$6, $$4);
   }

   private static int a(CommandContext<dt> $$0, aew $$1, ecw $$2, ahl.b $$3) throws CommandSyntaxException {
      dt $$4 = (dt)$$0.getSource();
   ...
   @FunctionalInterface
   interface b {
      int accept(CommandContext<dt> var1, List<cjf> var2, ahl.a var3) throws CommandSyntaxException;
   }

   @FunctionalInterface
   interface c {
      ArgumentBuilder<dt, ?> construct(ArgumentBuilder<dt, ?> var1, ahl.b var2);
   }
}
