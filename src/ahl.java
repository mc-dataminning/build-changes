...
public class ahl {
   ...
   private static Optional<? extends hk.b<dvi>> a(eu.c<dvi> $$0, ht<dvi> $$1) {
      return (Optional<? extends hk.b<dvi>>)$$0.a().map($$1x -> $$1.b($$1x).map($$0xx -> hk.a($$0xx)), $$1::b);
   }

   private static int a(dt $$0, eu.c<dvi> $$1) throws CommandSyntaxException {
      ht<dvi> $$2 = $$0.e().G_().d(je.az);
      hk<dvi> $$3 = (hk<dvi>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      gw $$4 = gw.a($$0.d());
      akr $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(ac.c);
      Pair<gw, hg<dvi>> $$7 = $$5.k().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(dt $$0, et.c<cqt> $$1) throws CommandSyntaxException {
      ...
      Pair<gw, hg<cqt>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(dt $$0, et.c<bui> $$1) throws CommandSyntaxException {
      ...
      Optional<Pair<hg<bui>, gw>> $$5 = $$3.w().e($$1, $$2, 256, buf.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
