...
public class bwi<E extends bvg> {
   ...
   private final Map<Integer, Map<cqn, Set<bxa<? super E>>>> f = Maps.newTreeMap();
   private cqp g = cqp.c;
   private final Map<cqn, Set<Pair<cek<?>, cel>>> h = Maps.newHashMap();
   private final Map<cqn, Set<cek<?>>> i = Maps.newHashMap();
   private Set<cqn> j = Sets.newHashSet();
   private final Set<cqn> k = Sets.newHashSet();
   private cqn l = cqn.b;
   ...
   public List<bxa<? super E>> e() {
      ...
      for (Map<cqn, Set<bxa<? super E>>> $$1 : this.f.values()) {
   ...
   public void a(cqn $$0, int $$1, ImmutableList<? extends bxa<? super E>> $$2) {
      this.a($$0, this.a($$1, $$2));
   }

   public void a(cqn $$0, int $$1, ImmutableList<? extends bxa<? super E>> $$2, cek<?> $$3) {
      Set<Pair<cek<?>, cel>> $$4 = ImmutableSet.of(Pair.of($$3, cel.a));
      Set<cek<?>> $$5 = ImmutableSet.of($$3);
      this.a($$0, this.a($$1, $$2), $$4, $$5);
   }

   public void a(cqn $$0, ImmutableList<? extends Pair<Integer, ? extends bxa<? super E>>> $$1) {
      this.a($$0, $$1, ImmutableSet.of(), Sets.newHashSet());
   }

   public void a(cqn $$0, ImmutableList<? extends Pair<Integer, ? extends bxa<? super E>>> $$1, Set<Pair<cek<?>, cel>> $$2) {
      this.a($$0, $$1, $$2, Sets.newHashSet());
   }

   public void a(cqn $$0, ImmutableList<? extends Pair<Integer, ? extends bxa<? super E>>> $$1, Set<Pair<cek<?>, cel>> $$2, Set<cek<?>> $$3) {
      this.h.put($$0, $$2);
      if (!$$3.isEmpty()) {
         this.i.put($$0, $$3);
      }
   ...
   private void d(ard $$0, E $$1) {
      ...
      for (Map<cqn, Set<bxa<? super E>>> $$3 : this.f.values()) {
         for (Entry<cqn, Set<bxa<? super E>>> $$4 : $$3.entrySet()) {
            cqn $$5 = $$4.getKey();
