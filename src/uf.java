...
public class uf extends MessageToMessageDecoder<wu<?>> {
   @Nullable
   private wt.a a;
   @Nullable
   private wt b;
   private final AttributeKey<? extends wt.b> c;

   public uf(AttributeKey<? extends wt.b> $$0) {
      this.c = $$0;
   }

   protected void a(ChannelHandlerContext $$0, wu<?> $$1, List<Object> $$2) throws Exception {
      wt.b $$3 = (wt.b)$$0.channel().attr(this.c).get();
      if ($$3 == null) {
