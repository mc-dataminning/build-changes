...
public class gfm extends aqm<List<String>> {
   ...
   protected List<String> a(aqh $$0, bgr $$1) {
      try {
         List var4;
         try (BufferedReader $$2 = evg.O().Z().openAsReader(a)) {
   ...
   public eyi a() {
      ...
      if ($$0.get(2) + 1 == 12 && $$0.get(5) == 24) {
         ...
         return this.d != null && b.a(this.c.size()) == 42 ? new eyi(this.d.c().toUpperCase(Locale.ROOT) + " IS YOU") : new eyi(this.c.get(b.a(this.c.size())));
      }
   }
}
