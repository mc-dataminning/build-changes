...
public class ezo {
   ...
   public ezo(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ezp> $$1) throws IOException {
   ...
   public List<ezp> a(Path $$0) throws IOException {
      List<ezp> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ezp> a(Path $$0, boolean $$1) throws IOException {
      List<ezp> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ezp> $$1) throws IOException {
