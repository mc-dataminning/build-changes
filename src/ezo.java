...
public class ezo extends ezs implements ezq {
   ...
   public ezo.c a() {
      return new ezo.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, ezy.a $$1) {
   ...
   private ezo.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezo.a $$9 = new ezo.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezo.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == ezy.b.a || this.q == ezy.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<ezz> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      ezz $$1 = (ezz)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == ezz.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == ezz.b.c) {
         ezq.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezq.a($$11));
         this.a($$14 + 5, ezq.a($$12));
         this.a($$14 + 6, ezq.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(ezy a, int b, int c, ezy.b d, ezy.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezo.a c;
      private boolean d;

      b(final int $$1, final ezo.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(ezy.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fab $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
