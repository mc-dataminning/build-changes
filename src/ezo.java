...
public class ezo {
   private final List<ConcurrentLinkedQueue<ezn>> a = ImmutableList.of(
   ...
   public void a(ezn $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ezn> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ezn> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ezn> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ezn> j() {
