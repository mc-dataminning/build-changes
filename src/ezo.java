...
public class ezo extends eyk {
   ...
   private static final arj n = arj.forward("_", uh.a.a(n.a));
   private static final arj o = arj.forward("_", uh.a.a(n.h));
   private final cbu p;
   private final cjf q;
   private boolean s;
   private boolean t;
   ...
   private void c(boolean $$0) {
      if (this.s) {
         ...
         this.f.J().b(new abt($$1, this.w, $$0 ? Optional.of(this.x.trim()) : Optional.empty()));
      }
   }
   ...
   public void a(esf $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.t) {
         ...
         arj $$7 = arj.composite(arj.forward(this.x, uh.a), $$6 ? n : o);
         int $$8 = this.i.a(l);
