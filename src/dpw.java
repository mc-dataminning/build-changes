...
public class dpw extends dpj<drg> {
   public dpw(Codec<drg> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? ati.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(ato $$0, crt $$1, int $$2, int $$3, ht $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ht $$2, crt $$3, boolean $$4, double $$5, ht $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(crt $$0, ht $$1) {
      if ($$0.a_($$1.c()).a(cuv.dN)) {
         this.a($$0, $$1.c(), cuv.a.o());
      }
   }

   private void a(crt $$0, ato $$1, ht $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dgw $$13) {
   ...
   private void a(ht $$0, crt $$1, ato $$2, int $$3, int $$4, boolean $$5, boolean $$6, dgw $$7) {
      dgw $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cuv.dP) || $$8.a(cuv.dO) || $$8.a(cuv.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cuv.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cuv.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, ht $$2, int $$3, ato $$4) {
      float $$5 = 10.0F * ati.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(ato $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(ato $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dgw $$0) {
      return $$0.a(cuv.iC) || $$0.a(cuv.dP) || $$0.a(cuv.mW);
   }
   ...
   private void a(crt $$0, ht $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cuv.dN)) {
                  if (this.a((cqy)$$0, $$10)) {
                     this.a($$0, $$10, cuv.a.o());
                     this.a($$0, $$10.c(), cuv.a.o());
                  } else if (c($$11)) {
                     dgw[] $$12 = new dgw[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
