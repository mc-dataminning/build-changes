...
public class dpw implements dpv {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<dpw> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dkk.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dkm.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dkl.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bfy.b(1, 20).fieldOf("outer_wall_distance").orElse(bge.a(4, 5)).forGetter($$0x -> $$0x.i),
               bfy.b(1, 20).fieldOf("distribution_points").orElse(bge.a(3, 4)).forGetter($$0x -> $$0x.j),
               bfy.b(0, 10).fieldOf("point_offset").orElse(bge.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dpw(dkk $$0, dkm $$1, dkl $$2, double $$3, double $$4, boolean $$5, bfy $$6, bfy $$7, bfy $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
