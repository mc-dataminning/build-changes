...
public class dpw implements dpr {
   public static final Codec<dpw> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jb.f.q().fieldOf("block").flatXmap(dpw::a, DataResult::success).orElse((cxk)csn.fg).forGetter($$0x -> $$0x.b),
   ...
   public final hi<csm> h;
   private final ObjectArrayList<ha> i;

   private static DataResult<cxk> a(csm $$0) {
      return $$0 instanceof cxk $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public dpw(cxk $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, hi<csm> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<ha> a(aru $$0, ha $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<ha> a(aru $$0) {
