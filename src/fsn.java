...
public abstract class fsn<T extends bii> {
   ...
   public final int b(T $$0, float $$1) {
      gu $$2 = gu.a($$0.k($$1));
      return fnk.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, gu $$1) {
      return $$0.dK().a(cpv.a, $$1);
   }

   protected int a(T $$0, gu $$1) {
      return $$0.bM() ? 15 : $$0.dK().a(cpv.b, $$1);
   }
   ...
   public boolean a(T $$0, fqn $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         ...
         egz $$5 = $$0.k_().g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new egz($$0.dp() - 2.0, $$0.dr() - 2.0, $$0.dv() - 2.0, $$0.dp() + 2.0, $$0.dr() + 2.0, $$0.dv() + 2.0);
         }
   ...
   protected void a(T $$0, tf $$1, elg $$2, fnl $$3, int $$4) {
      ...
      if (!($$5 > 4096.0)) {
         ...
         Matrix4f $$9 = $$2.c().a();
         float $$10 = eqm.O().m.a(0.25F);
         int $$11 = (int)($$10 * 255.0F) << 24;
         eru $$12 = this.b();
         float $$13 = (float)(-$$12.a($$1) / 2);
         $$12.a($$1, $$13, (float)$$8, 553648127, false, $$9, $$3, $$6 ? eru.a.b : eru.a.a, $$11, $$4);
         if ($$6) {
            $$12.a($$1, $$13, (float)$$8, -1, false, $$9, $$3, eru.a.a, 0, $$4);
         }
