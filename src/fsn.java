...
public class fsn extends ftg<cdn> {
   private final Map<cdn.b, Pair<aex, ffv<cdn>>> a;

   public fsn(fth.a $$0, boolean $$1) {
      super($$0);
      this.d = 0.8F;
      this.a = Stream.of(cdn.b.values()).collect(ImmutableMap.toImmutableMap($$0x -> $$0x, $$2 -> Pair.of(new aex(a($$2, $$1)), this.a($$0, $$2, $$1))));
   }
   ...
   public void a(cdn $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      if ($$6 > 0.0F) {
         $$3.a(a.b.rotationDegrees(arx.a($$6) * $$6 * $$7 / 10.0F * (float)$$0.z()));
      }
      ...
      Pair<aex, ffv<cdn>> $$9 = this.a.get($$0.A());
      aex $$10 = (aex)$$9.getFirst();
   ...
   public aex a(cdn $$0) {
      return (aex)this.a.get($$0.A()).getFirst();
   }
}
