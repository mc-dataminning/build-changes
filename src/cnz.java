...
public class cnz extends cms {
   ...
   public cnz(vf $$0, vf $$1, vf $$2, vf $$3, vf $$4, List<ahg> $$5, List<ahg> $$6) {
      super(new cms.a());
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static cnz a(ahf<cpd> $$0) {
      return a($$0.a());
   }

   public static cnz a(ahg $$0) {
      return new cnz(f, g, vf.c(ac.a("trim_pattern", $$0)).a(a), h, i, A(), B());
   }

   public static cnz h() {
      return new cnz(j, k, e, r, s, C(), D());
   }
