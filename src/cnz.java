...
public class cnz {
   ...
   @VisibleForTesting
   protected final ArrayList<bum> c;
   private final cnz.a k;
   @VisibleForTesting
   protected final Object2IntMap<bum> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cnz> a(Predicate<bum> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cnz::b)).apply($$1, $$1x -> new cnz($$0, $$1x))
      );
   }

   public cnz(Predicate<bum> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cnz.a(this);
   ...
   public void a(ard $$0, Predicate<bum> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bum>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bum> $$6 = (Entry<bum>)$$5.next();
         int $$7 = $$6.getIntValue();
         bum $$8 = (bum)$$6.getKey();
         bum.d $$9 = $$8.dR();
   ...
   public int b(@Nullable bum $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bvi> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bvi).map($$0 -> (bvi)$$0);
   }

   @VisibleForTesting
   protected static record a(cnz a) implements Comparator<bum> {
      public int a(bum $$0, bum $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof coy;
               boolean $$7 = $$1 instanceof coy;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
