...
class atx extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atw && $$1 instanceof atw && $$0.equals($$1);
   }
   ...
   private static atw a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atw) {
         return (atw)$$0;
      } else {
