...
class atx implements Path {
   private static final BasicFileAttributes a = new atv() {
      @Override
   ...
   private static final BasicFileAttributes b = new atv() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atx> c = Comparator.comparing(atx::n);
   ...
   public atx(atz $$0, String $$1, @Nullable atx $$2, aua $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atx a(@Nullable atx $$0, String $$1) {
      return new atx(this.e, $$1, $$0, aua.b);
   }
   ...
   atx a(String $$0) {
      if (a(this.i)) {
         return new atx(this.e, $$0, this, this.i);
      } else if (this.i instanceof aua.a $$1) {
         atx $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atx(this.e, $$0, this, aua.a);
      } else if (this.i instanceof aua.b) {
         return new atx(this.e, $$0, this, aua.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aua $$0) {
      return $$0 == aua.a || $$0 == aua.b;
   }
   ...
   private atx c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atx $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aua.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aua.a i() {
      return this.i instanceof aua.a $$0 ? $$0 : null;
   }
