...
public class atx extends atr {
   ...
   private final atx.b d;
   private final String e;

   atx(atz $$0, atx.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(auc $$0, alr $$1) {
   ...
   @Nullable
   private avg<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : avg.create($$1, $$2);
      }
   }
   ...
   public static class a implements auv.c {
      ...
      @Override
      public aua a(atz $$0) {
         atx.b $$1 = new atx.b(this.a);
         return new atx($$0, $$1, "");
      }

      @Override
      public aua a(atz $$0, auv.a $$1) {
         atx.b $$2 = new atx.b(this.a);
         aua $$3 = new atx($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aua> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  atx.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
