...
public class atx {
   ...
   public static final Codec<Object> b = a(aui.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(auf.e($$0));
   ...
   public static final Codec<atx.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ahh.b($$0.substring(1)).map($$0x -> new atx.f($$0x, true)) : ahh.b($$0).map($$0x -> new atx.f($$0x, false)), atx.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !ahh.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> atx.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new atx.b<>($$0, $$1);
   }

   public static <K, V> atx.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new atx.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof atx.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(ahh a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
