...
public class atx implements att {
   private static final Logger c = LogUtils.getLogger();
   private final ats d;
   private final atl e;
   private final Set<String> f;
   private final List<Path> g;
   private final Map<atv, List<Path>> h;

   atx(ats $$0, atl $$1, Set<String> $$2, List<Path> $$3, Map<atv, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(atv $$0, alk $$1, Consumer<Path> $$2) {
      w.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(atv $$0, String $$1, String $$2, att.a $$3) {
      w.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<alk, auz<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(att.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      atw.a($$1, $$4, $$3, $$0);
   }
   ...
   public auz<InputStream> a(atv $$0, alk $$1) {
      return (auz<InputStream>)w.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = w.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && atw.a($$5)) {
               return auz.create($$5);
            }
         }
   ...
   public <T> T a(aug<T> $$0) {
      auz<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public avk d() {
      return $$0 -> Optional.ofNullable(this.a(atv.a, $$0)).map($$0x -> new avf(this, $$0x));
   }
}
