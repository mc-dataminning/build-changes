...
public class atx {
   ...
   @Nullable
   public static atx a(atb $$0, atx.c $$1, ate $$2, atd $$3) {
      int $$4 = ab.b().a($$2);
      atx.a $$5 = a($$0, $$1, $$4);
      return $$5 != null ? new atx($$0, $$1, $$5, $$3) : null;
   }

   public atx(atb $$0, atx.c $$1, atx.a $$2, atd $$3) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   @Nullable
   public static atx.a a(atb $$0, atx.c $$1, int $$2) {
      try {
         atx.a var11;
         try (atc $$3 = $$1.a($$0)) {
            atq $$4 = $$3.a(atq.b);
   ...
   public static record a(wp a, aty b, crs c, List<String> d) {
   }
   ...
   public static enum b {
      ...
      public <T> int a(List<T> $$0, T $$1, Function<T, atd> $$2, boolean $$3) {
         atx.b $$4 = $$3 ? this.a() : this;
         if ($$4 == b) {
            int $$5;
            for ($$5 = 0; $$5 < $$0.size(); $$5++) {
               atd $$6 = $$2.apply($$0.get($$5));
               if (!$$6.c() || $$6.b() != this) {
                  break;
               }
            }
