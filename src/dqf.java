...
public class dqf implements dqa {
   public static final Codec<dqf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jd.f.q().fieldOf("block").flatXmap(dqf::a, DataResult::success).orElse((cxt)csw.fg).forGetter($$0x -> $$0x.b),
   ...
   public dqf(cxt $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, hk<csv> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<hc> a(asc $$0, hc $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<hc> a(asc $$0) {
