...
public class dpl {
   private static final dpl a = new dpl(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dpl.a a(int $$0, int $$1) {
         return new dpl.a(1.0, 0.0);
      }
   ...
   private static final edn b = edn.b(new dpk(42L), pg.a);
   ...
   private final Long2ObjectOpenHashMap<dpm> h;
   private final Long2ObjectOpenHashMap<dpm> i;

   public static dpl a() {
      return a;
   }

   public static dpl a(@Nullable ang $$0) {
      if ($$0 == null) {
         return a;
      } else {
         csp $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dpm> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dpm> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = aui.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dpl($$2, $$3);
         }
      }
   }

   dpl(Long2ObjectOpenHashMap<dpm> $$0, Long2ObjectOpenHashMap<dpm> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dpl.a a(int $$0, int $$1) {
      int $$2 = is.a($$0);
      int $$3 = is.a($$1);
      double $$4 = this.a($$2, 0, $$3, dpm::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dpl.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(is.d(csp.a($$5x)), is.d(csp.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = aui.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = aui.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dpl.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(doc.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(is.d(csp.a($$6x)), is.d(csp.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = aui.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = aui.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return aui.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dpl.b $$3) {
      int $$4 = is.e($$0);
      int $$5 = is.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dpl.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dpm $$6 = (dpm)this.h.get(csp.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - is.d($$1), $$4, $$5 - is.d($$2)) : Double.MAX_VALUE;
   }

   public cuk a(cuk $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ih<cuh> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ih<cuh> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ih<cuh>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(is.d(csp.a($$5x)), $$1, is.d(csp.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = aui.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = aui.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ih)$$4.getValue();
      }
   }

   public static void a(ang $$0, dkw $$1) {
      csp $$2 = $$1.f();
      boolean $$3 = $$1.s();
      hx.a $$4 = new hx.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(doj.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dkw $$0, hx $$1) {
      dja $$2 = $$0.a_($$1);
      if ($$2.a(asb.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cud $$0, dlr $$1) {
      csp $$2 = $$1.f();
      Builder<id, dpm> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dof.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dpl.c a(@Nullable dpm $$0, Map<id, dpm> $$1) {
      List<dpl.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dpl.c a(@Nullable id $$0, dpm $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ic $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return aui.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dpm var1, int var2, int var3, int var4);
   }
