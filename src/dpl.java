...
public class dpl extends dnw<dqz> {
   public dpl(Codec<dqz> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dny<dqz> $$0) {
      cqp $$1 = $$0.b();
      dqz $$2 = $$0.f();
      asc $$3 = $$0.d();
      gw $$4 = $$0.e();
      Predicate<dfj> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dfi.a::i) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(dny<dqz> $$0, cqp $$1, dqz $$2, asc $$3, Set<gw> $$4, int $$5, int $$6) {
      for (gw $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(cqp $$0, dqz $$1, Predicate<dfj> $$2, asc $$3, gw.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dfj $$7 = $$1.c.a($$3, $$4);
         dfj $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
