...
public class cin extends cja {
   ...
   public static final ajx<Boolean> cc = akb.a(cin.class, ajz.k);
   public static final ajx<Long> cd = akb.a(cin.class, ajz.c);
   public final bub ce = new bub();
   public final bub cf = new bub();
   public final bub cg = new bub();
   public final bub ch = new bub();
   public final bub ci = new bub();
   private static final bum cJ = bum.b(buq.t.l(), buq.t.m() - 1.43F).b(0.845F);
   private int cK = 0;
   private int cL = 0;

   public cin(buq<? extends cin> $$0, dgg $$1) {
      super($$0, $$1);
      this.bP = new cin.c();
      this.bO = new cin.b();
      ceq $$2 = (ceq)this.L();
   ...
   public static bwm.a p() {
      return gR().a(bwn.s, 32.0).a(bwn.v, 0.09F).a(bwn.o, 0.42F).a(bwn.B, 1.5);
   }
   ...
   protected bwh<?> a(Dynamic<?> $$0) {
      return cio.a(this.ed().a($$0));
   }

   @Override
   public bum e(bvr $$0) {
      return $$0 == bvr.k ? cJ.a(this.ej()) : super.e($$0);
   }
   ...
   public void h() {
      ...
      if (this.cK > 0) {
         this.cK--;
         if (this.cK == 0) {
            this.dW().a(null, this.dw(), avz.dB, awa.g, 1.0F, 1.0F);
         }
      }
   ...
   protected float e(cov $$0) {
      ...
      return (float)this.h(bwn.v) + $$1;
   }

   @Override
   protected fax j(bvf $$0) {
      return this.t() ? new fax(this.dO(), this.dM()) : super.j($$0);
   }

   @Override
   protected fay b(cov $$0, fay $$1) {
      return this.t() ? fay.c : super.b($$0, $$1);
   }
   ...
   protected void b(float $$0, fay $$1) {
      ...
      this.i(this.bT().d(1.0, 0.0, 1.0).d().c((double)(22.2222F * $$0) * this.h(bwn.v) * (double)this.aT()).b(0.0, (double)(1.4285F * $$0) * $$2, 0.0));
      this.cK = 55;
      this.x(true);
      this.ar = true;
   }
   ...
   protected void b(ji $$0, dwv $$1) {
      if ($$1.a(awo.br)) {
         this.a(avz.dJ, 1.0F, 1.0F);
      } else {
         this.a(avz.dI, 1.0F, 1.0F);
      }
   }
   ...
   public boolean gp() {
      return this.g(this.gs() ? bvr.a : bvr.k);
   }
   ...
   public boolean a(cgw $$0) {
      if ($$0 != this && $$0 instanceof cin $$1 && this.gY() && $$1.gY()) {
         return true;
      }
   ...
   @Nullable
   public cin b(arc $$0, bua $$1) {
      return buq.t.a($$0, bup.e);
   }
   ...
   protected fay a(buj $$0, bum $$1, float $$2) {
      ...
      return new fay(0.0, (double)$$6, (double)($$5 * $$2)).b(-this.dM() * (float) (Math.PI / 180.0));
   }
   ...
   private double a(boolean $$0, float $$1, bum $$2, float $$3) {
      ...
      if ($$8) {
         ...
         float $$15 = ayy.a((float)this.gF() + $$1, 0.0F, (float)$$10);
         boolean $$16 = $$15 < (float)$$11;
         float $$17 = $$16 ? $$15 / (float)$$11 : ($$15 - (float)$$11) / (float)($$10 - $$11);
         float $$18 = $$5 - $$12 * $$6;
         $$4 += $$9 ? (double)ayy.h($$17, $$16 ? $$5 : $$18, $$16 ? $$18 : $$7) : (double)ayy.h($$17, $$16 ? $$7 - $$5 : $$7 - $$18, $$16 ? $$7 - $$18 : 0.0F);
      }
   ...
   public fay s(float $$0) {
      ...
      float $$2 = this.ej();
      return new fay(0.0, this.a(true, $$0, $$1, $$2) - (double)(0.2F * $$2), (double)($$1.a() * 0.56F));
   }
   ...
   @Override
   protected cbb G() {
      return new cin.a(this);
   }

   class a extends cbb {
      public a(final cin $$0) {
         super($$0);
      }
   ...
   class c extends cbg {
      ...
      @Override
      public void a() {
         if (this.k == cbg.a.b && !cin.this.P_() && cin.this.gs() && !cin.this.gB() && cin.this.gp()) {
            cin.this.gD();
         }
