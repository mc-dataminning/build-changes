...
public class fjw {
   ...
   public void a(flp $$0, String $$1, fmm.a $$2, eyv $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fjw.b $$13 = new fjw.b($$1.trim(), this.f, $$3, $$2);
                  fjw.a $$14 = new fjw.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fjw.c $$30 = new fjw.c(this.f, $$2, $$0);
                        fjw.a $$31 = new fjw.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new flt(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eyv $$2) throws IOException {
      ...
      File $$15 = new File(foz.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final eyv $$2, final fmm.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fjw.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fjw.this.b && !fjw.this.d) {
            try {
               fjw.this.e = true;
               fjw.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fjw.a.error("Error extracting archive", var3);
               fjw.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fmm.a c;
      private final flp d;

      c(final File $$0, final fmm.a $$1, final flp $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fjw.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fjw.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fjw.this.g);
                  fjw.this.c = true;
               } else {
                  fjw.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fjw.this.d = true;
               }
            } catch (IOException var3) {
               fjw.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fjw.this.d = true;
            }
         }
      }
