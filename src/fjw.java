...
public class fjw extends hhp {
   ...
   public void aT_() {
      ...
      $$0.a(fny.a(xv.c("mco.configure.world.buttons.invite"), $$0x -> this.m.a(new fjq(this.E, this, this.F))).a());
   ...
   class a extends foe.a<fjw.a> {
      ...
      private void c(int $$0) {
         if ($$0 >= 0 && $$0 < fjw.this.F.h.size()) {
            ...
            }, fjw.c, xv.a("mco.configure.world.uninvite.player", $$1.a()));
            fjw.this.m.a($$2);
         }
      }
      ...
      public void a(fnl $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         int $$14 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(fjw.this.p, this.j.a(), $$3 + 8 + 32, $$14, $$10, false);
         int $$15 = $$2 + $$5 / 2 - 10;
         int $$16 = $$3 + $$4 - this.k.y();
         this.k.c($$16, $$15);
         this.k.a($$0, $$6, $$7, $$9);
   ...
   class b extends foe<fjw.a> {
      ...
      protected void a(fnl $$0, int $$1, int $$2) {
         ...
         $$0.a(fjw.this.p, $$4, $$1 + this.a() / 2 - fjw.this.p.a($$4) / 2, $$2, -1, false);
      }
