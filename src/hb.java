...
public interface hb<T> {
   ...
   hd<T> a(@Nullable sd var1, CommandDispatcher<T> var2, T var3) throws dx;
   ...
   static <T extends dw<T>> hb<T> a(agm $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hc<T> $$4 = new hc<>();
   ...
   static <T extends dw<T>> gs<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new gu.c<>($$2.getString(), $$4.get());
      }
   }
}
