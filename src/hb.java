...
public class hb implements ArgumentType<hb.a> {
   ...
   public hb.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         return new hb.a() {
            ...
            @Override
            public Pair<alc, Either<ih<et>, Collection<ih<et>>>> b(CommandContext<et> $$0) throws CommandSyntaxException {
               return Pair.of($$1, Either.right(hb.b($$0, $$1)));
            }

            @Override
            public Pair<alc, Collection<ih<et>>> c(CommandContext<et> $$0) throws CommandSyntaxException {
   ...
   static ih<et> a(CommandContext<et> $$0, alc $$1) throws CommandSyntaxException {
      return ((et)$$0.getSource()).l().aE().a($$1).orElseThrow(() -> c.create($$1.toString()));
   }

   static Collection<ih<et>> b(CommandContext<et> $$0, alc $$1) throws CommandSyntaxException {
   ...
   public static Pair<alc, Either<ih<et>, Collection<ih<et>>>> b(CommandContext<et> $$0, String $$1) throws CommandSyntaxException {
      return ((hb.a)$$0.getArgument($$1, hb.a.class)).b($$0);
   }

   public static Pair<alc, Collection<ih<et>>> c(CommandContext<et> $$0, String $$1) throws CommandSyntaxException {
   ...
   public interface a {
      ...
      Pair<alc, Either<ih<et>, Collection<ih<et>>>> b(CommandContext<et> var1) throws CommandSyntaxException;

      Pair<alc, Collection<ih<et>>> c(CommandContext<et> var1) throws CommandSyntaxException;
   }
}
