...
public interface hb<T> {
   ...
   hd<T> a(@Nullable sl var1, CommandDispatcher<T> var2, T var3) throws dv;
   ...
   static <T extends du<T>> hb<T> a(ahd $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hc<T> $$4 = new hc<>();
   ...
   static <T extends du<T>> gs<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
