...
public abstract class gwo extends fob {
   ...
   private final List<gwm> a = Lists.newArrayList();
   ...
   protected gwm a(gwm $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public wz m() {
      return wy.a(this.a.stream().map(gwm::a).collect(Collectors.toList()));
   }
}
