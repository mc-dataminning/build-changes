...
public class eac extends eaf<eab> {
   public eac(Codec<eab> $$0) {
      super($$0);
   }

   public boolean a(eab $$0, aym $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eaa $$0, eab $$1, dud $$2, Function<ja, jj<ddd>> $$3, aym $$4, dxl $$5, dbk $$6, duc $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eaf.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eaa $$0, eab $$1, dud $$2, Function<ja, jj<ddd>> $$3, dxl $$4, double $$5, double $$6, double $$7, float $$8, double $$9, duc $$10, eaf.a $$11
   ) {
      double $$12 = 1.5 + (double)(aye.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(aye.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = aye.b($$13);
         $$6 += (double)(aye.b($$12) * $$27);
         $$7 += (double)aye.a($$13);
         $$8 += (double)(aye.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
