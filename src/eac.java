...
public class eac extends LongLinkedOpenHashSet {
   private final eac.a a;

   public eac(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eac.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = ars.f(60000000);
      private static final int b = ars.f(60000000);
