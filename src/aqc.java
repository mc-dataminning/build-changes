...
public class aqc {
   ...
   private static Collection<String> a(Collection<? extends bvj> $$0) {
   ...
   private static int a(ew $$0, Collection<? extends bvj> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(ew $$0, Collection<? extends bvj> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
