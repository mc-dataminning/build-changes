...
public class gnf {
   ...
   static final ThreadLocal<gnf.d> f = ThreadLocal.withInitial(gnf.d::new);

   public gnf(fmm $$0) {
      this.d = $$0;
   }

   public void a(dfl $$0, hgt $$1, dwy $$2, ji $$3, ffv $$4, ffz $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      boolean $$10 = flk.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(dfl $$0, hgt $$1, dwy $$2, ji $$3, ffv $$4, ffz $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      ...
      for (jn $$14 : c) {
         $$7.b($$8);
         List<gng> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || djn.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gng> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dfl $$0, hgt $$1, dwy $$2, ji $$3, ffv $$4, ffz $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      ji.a $$11 = $$3.k();

      for (jn $$12 : c) {
         $$7.b($$8);
         List<gng> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || djn.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = glv.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gng> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dfl $$0, dwy $$1, ji $$2, ffv $$3, ffz $$4, List<gng> $$5, float[] $$6, BitSet $$7, gnf.b $$8, int $$9) {
      for (gng $$10 : $$5) {
   ...
   private void a(
      dfl $$0, dwy $$1, ji $$2, ffz $$3, ffv.a $$4, gng $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dfl $$0, dwy $$1, ji $$2, int[] $$3, jn $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dfl $$0, dwy $$1, ji $$2, int $$3, int $$4, boolean $$5, ffv $$6, ffz $$7, List<gng> $$8, BitSet $$9) {
      for (gng $$10 : $$8) {
         if ($$5) {
   ...
   public void a(ffv.a $$0, ffz $$1, @Nullable dwy $$2, hgt $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azh $$9 = azh.a();
      long $$10 = 42L;
   ...
   private static void a(ffv.a $$0, ffz $$1, float $$2, float $$3, float $$4, List<gng> $$5, int $$6, int $$7) {
      for (gng $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gnf.e[]{gnf.e.k, gnf.e.d, gnf.e.k, gnf.e.j, gnf.e.e, gnf.e.j, gnf.e.e, gnf.e.d},
         new gnf.e[]{gnf.e.k, gnf.e.c, gnf.e.k, gnf.e.i, gnf.e.e, gnf.e.i, gnf.e.e, gnf.e.c},
         new gnf.e[]{gnf.e.l, gnf.e.c, gnf.e.l, gnf.e.i, gnf.e.f, gnf.e.i, gnf.e.f, gnf.e.c},
         new gnf.e[]{gnf.e.l, gnf.e.d, gnf.e.l, gnf.e.j, gnf.e.f, gnf.e.j, gnf.e.f, gnf.e.d}
      ),
      b(
         new jn[]{jn.f, jn.e, jn.c, jn.d},
         1.0F,
         true,
         new gnf.e[]{gnf.e.f, gnf.e.d, gnf.e.f, gnf.e.j, gnf.e.l, gnf.e.j, gnf.e.l, gnf.e.d},
         new gnf.e[]{gnf.e.f, gnf.e.c, gnf.e.f, gnf.e.i, gnf.e.l, gnf.e.i, gnf.e.l, gnf.e.c},
         new gnf.e[]{gnf.e.e, gnf.e.c, gnf.e.e, gnf.e.i, gnf.e.k, gnf.e.i, gnf.e.k, gnf.e.c},
         new gnf.e[]{gnf.e.e, gnf.e.d, gnf.e.e, gnf.e.j, gnf.e.k, gnf.e.j, gnf.e.k, gnf.e.d}
      ),
      c(
         new jn[]{jn.b, jn.a, jn.f, jn.e},
         0.8F,
         true,
         new gnf.e[]{gnf.e.b, gnf.e.k, gnf.e.b, gnf.e.e, gnf.e.h, gnf.e.e, gnf.e.h, gnf.e.k},
         new gnf.e[]{gnf.e.b, gnf.e.l, gnf.e.b, gnf.e.f, gnf.e.h, gnf.e.f, gnf.e.h, gnf.e.l},
         new gnf.e[]{gnf.e.a, gnf.e.l, gnf.e.a, gnf.e.f, gnf.e.g, gnf.e.f, gnf.e.g, gnf.e.l},
         new gnf.e[]{gnf.e.a, gnf.e.k, gnf.e.a, gnf.e.e, gnf.e.g, gnf.e.e, gnf.e.g, gnf.e.k}
      ),
      d(
         new jn[]{jn.e, jn.f, jn.a, jn.b},
         0.8F,
         true,
         new gnf.e[]{gnf.e.b, gnf.e.k, gnf.e.h, gnf.e.k, gnf.e.h, gnf.e.e, gnf.e.b, gnf.e.e},
         new gnf.e[]{gnf.e.a, gnf.e.k, gnf.e.g, gnf.e.k, gnf.e.g, gnf.e.e, gnf.e.a, gnf.e.e},
         new gnf.e[]{gnf.e.a, gnf.e.l, gnf.e.g, gnf.e.l, gnf.e.g, gnf.e.f, gnf.e.a, gnf.e.f},
         new gnf.e[]{gnf.e.b, gnf.e.l, gnf.e.h, gnf.e.l, gnf.e.h, gnf.e.f, gnf.e.b, gnf.e.f}
      ),
      e(
         new jn[]{jn.b, jn.a, jn.c, jn.d},
         0.6F,
         true,
         new gnf.e[]{gnf.e.b, gnf.e.d, gnf.e.b, gnf.e.j, gnf.e.h, gnf.e.j, gnf.e.h, gnf.e.d},
         new gnf.e[]{gnf.e.b, gnf.e.c, gnf.e.b, gnf.e.i, gnf.e.h, gnf.e.i, gnf.e.h, gnf.e.c},
         new gnf.e[]{gnf.e.a, gnf.e.c, gnf.e.a, gnf.e.i, gnf.e.g, gnf.e.i, gnf.e.g, gnf.e.c},
         new gnf.e[]{gnf.e.a, gnf.e.d, gnf.e.a, gnf.e.j, gnf.e.g, gnf.e.j, gnf.e.g, gnf.e.d}
      ),
      f(
         new jn[]{jn.a, jn.b, jn.c, jn.d},
         0.6F,
         true,
         new gnf.e[]{gnf.e.g, gnf.e.d, gnf.e.g, gnf.e.j, gnf.e.a, gnf.e.j, gnf.e.a, gnf.e.d},
         new gnf.e[]{gnf.e.g, gnf.e.c, gnf.e.g, gnf.e.i, gnf.e.a, gnf.e.i, gnf.e.a, gnf.e.c},
         new gnf.e[]{gnf.e.h, gnf.e.c, gnf.e.h, gnf.e.i, gnf.e.b, gnf.e.i, gnf.e.b, gnf.e.c},
         new gnf.e[]{gnf.e.h, gnf.e.d, gnf.e.h, gnf.e.j, gnf.e.b, gnf.e.j, gnf.e.b, gnf.e.d}
      );
      ...
      final gnf.e[] k;
      final gnf.e[] l;
      private static final gnf.a[] m = af.a(new gnf.a[6], $$0 -> {
         $$0[jn.a.d()] = a;
         $$0[jn.b.d()] = b;
         $$0[jn.c.d()] = c;
         $$0[jn.d.d()] = d;
      ...
      private a(final jn[] $$0, final float $$1, final boolean $$2, final gnf.e[] $$3, final gnf.e[] $$4, final gnf.e[] $$5, final gnf.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dfl $$0, dwy $$1, ji $$2, jn $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dwy $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dwy $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dwy $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dwy $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gnf.c[] k = af.a(new gnf.c[6], $$0 -> {
         $$0[jn.a.d()] = a;
         $$0[jn.b.d()] = b;
         $$0[jn.c.d()] = c;
         $$0[jn.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dwy $$0, dfl $$1, ji $$2) {
         long $$3 = $$2.a();
         if (this.a) {
