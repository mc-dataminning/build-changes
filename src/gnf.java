public class gnf<T extends cft> extends gnk<T, ftu<T>> {
   private final gej a;

   public gnf(gku<T, ftu<T>> $$0, gej $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(ezz $$0, gdp $$1, int $$2, boolean $$3, dsd $$4, int $$5, grb $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(gdx.r(goz.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
