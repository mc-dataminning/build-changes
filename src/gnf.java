...
public class gnf {
   ...
   public static class a extends Thread {
      ...
      public a(gnf.b $$0) throws IOException {
         super("LanServerDetector #" + gnf.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gnf.b));
   ...
   public static class b {
      private final List<gne> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gne> a() {
         if (this.b) {
            List<gne> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
