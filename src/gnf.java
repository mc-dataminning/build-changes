public class gnf extends goa {
   private final gnv a;

   gnf(gjr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gnv $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cqy $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dC();
            if (this.h > $$1) {
   ...
   public static class a implements gnd<mb> {
      ...
      public gna a(mb $$0, gjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gnf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gnd<mb> {
      ...
      public gna a(mb $$0, gjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gna $$8 = new gnf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
