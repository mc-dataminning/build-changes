...
public class gnf {
   ...
   public final Map<jn, gng> c;
   @Nullable
   public final gnh d;
   public final boolean e;
   public final int f;

   public gnf(Vector3f $$0, Vector3f $$1, Map<jn, gng> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gnf(Vector3f $$0, Vector3f $$1, Map<jn, gng> $$2, @Nullable gnh $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jn, gng> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gnf> {
      ...
      public gnf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !ayp.c($$3, "shade")) {
            ...
            return new gnf($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gnh a(JsonObject $$0) {
         gnh $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jn, gng> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gng> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jn, gng> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gng> $$2 = Maps.newEnumMap(jn.class);
         JsonObject $$3 = ayp.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jn $$5 = this.a($$4.getKey());
            $$2.put($$5, (gng)$$0.deserialize($$4.getValue(), gng.class));
         }
