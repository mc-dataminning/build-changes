...
public class emw {
   ...
   private final emw.a g;

   @Deprecated
   public static emw a(azf $$0, emw.a $$1) {
      return new emw($$0, $$1, false);
   }

   public static emw a(azf $$0, int $$1, double... $$2) {
      return b($$0, new emw.a($$1, new DoubleArrayList($$2)));
   }

   public static emw b(azf $$0, emw.a $$1) {
      return new emw($$0, $$1, true);
   }

   private emw(azf $$0, emw.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<emw.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(emw.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(emw.a::b))
               .apply($$0, emw.a::new)
      );
      public static final Codec<ji<emw.a>> b = ala.a(lq.aH, a);
