...
public class emw {
   ...
   public static final emw.a bv;

   public static emw.a a(int $$0, int $$1) {
      return $$0 == -1 ? emw.b.b.a($$1) : emw.b.a.a($$0);
   }

   public static emw.a a(String $$0) {
      if (emw.a.e.containsKey($$0)) {
         return emw.a.e.get($$0);
      } else {
         for (emw.b $$1 : emw.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final int c;
      private final atl<uv> d;
      static final Map<String, emw.a> e = Maps.newHashMap();

      a(String $$0, emw.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new atl<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? uv.b($$2.toUpperCase(Locale.ROOT)) : uv.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? uv.b($$2) : uv.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ry.a().b($$1) ? uv.c($$1) : uv.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<emw.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, uv> g;

      private static void a(emw.b $$0, String $$1, int $$2) {
         emw.a $$3 = new emw.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, uv> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public emw.a a(int $$0) {
         return (emw.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
