...
public class amc {
   ...
   private static int a(et $$0, Collection<GameProfile> $$1, @Nullable wz $$2) throws CommandSyntaxException {
      auy $$3 = $$0.l().ah().f();
      int $$4 = 0;

      for (GameProfile $$5 : $$1) {
         if (!$$3.a($$5)) {
            auz $$6 = new auz($$5, null, $$0.c(), null, $$2 == null ? null : $$2.getString());
            $$3.a($$6);
            $$4++;
            $$0.a(() -> wz.a("commands.ban.success", wz.b($$5.getName()), $$6.d()), true);
            aqv $$7 = $$0.l().ah().a($$5.getId());
            if ($$7 != null) {
               $$7.c.a(wz.c("multiplayer.disconnect.banned"));
            }
         }
      }
