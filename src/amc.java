...
public class amc extends bsm {
   ...
   private void p() {
      ...
      double $$1 = Math.max(1.0, (double)this.i) / (double)bal.b;
      int $$2 = (int)((double)(bal.c * $$0) / $$1);
      String $$3 = String.format("%.2f", $$0 == 0L ? (double)this.g() : $$1 / (double)$$0);
      this.j = 0L;
      this.i = 0L;
      this.l.aH().a(() -> xi.a("commands.tick.sprint.report", $$2, $$3), true);
      this.g = 0L;
      this.a(this.k);
      this.l.F();
   }
