...
public class amc {
                           ...
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a("damageType", fd.a($$1, lf.s))
                                    .executes(
                                       $$0x -> a(
                                             ...
                                             new bqp(fd.a($$0x, "damageType", lf.s))
                                          )
                                    ))
                                 .then(
                                    ef.a("at")
                                          ...
                                          ef.a("location", gh.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      er.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bqp(fd.a($$0x, "damageType", lf.s), gh.a($$0x, "location"))
                                                   )
                                             )
                                       )
                                 ))
                                       ...
                                       ((RequiredArgumentBuilder)ef.a("entity", er.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      er.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bqp(fd.a($$0x, "damageType", lf.s), er.a($$0x, "entity"))
                                                   )
                                             ))
                                          .then(
                                             ef.a("from")
                                                   ...
                                                   ef.a("cause", er.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               er.a($$0x, "target"),
                                                               FloatArgumentType.getFloat($$0x, "amount"),
                                                               new bqp(fd.a($$0x, "damageType", lf.s), er.a($$0x, "entity"), er.a($$0x, "cause"))
                                                            )
                                                      )
                                                )
                                          )
   ...
   private static int a(ee $$0, brw $$1, float $$2, bqp $$3) throws CommandSyntaxException {
      if ($$1.a($$3, $$2)) {
