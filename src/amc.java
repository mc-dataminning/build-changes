...
public class amc {
   ...
   private static final SuggestionProvider<ee> g = ($$0, $$1) -> {
      ath $$2 = ((ee)$$0.getSource()).l().aG();
      Collection<String> $$3 = $$2.d();
      coj $$4 = ((ee)$$0.getSource()).w();
      return ej.b(
                     ...
                     ef.a("enable")
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a(
                                          ...
                                          .suggests(g)
                                          .executes(
                                             $$0x -> a((ee)$$0x.getSource(), a($$0x, "name", true), ($$0xx, $$1) -> $$1.k().a($$0xx, $$1, ate::h, false))
                                          ))
                                       .then(
                                          ef.a("after")
                                             .then(
   ...
   private static int a(ee $$0, ate $$1, amc.a $$2) throws CommandSyntaxException {
      ath $$3 = $$0.l().aG();
      List<ate> $$4 = Lists.newArrayList($$3.f());
      $$2.apply($$4, $$1);
      $$0.a(() -> wx.a("commands.datapack.modify.enable", $$1.a(true)), true);
      anq.a($$4.stream().map(ate::g).collect(Collectors.toList()), $$0);
      return $$4.size();
   }

   private static int a(ee $$0, ate $$1) {
      ath $$2 = $$0.l().aG();
      List<ate> $$3 = Lists.newArrayList($$2.f());
      $$3.remove($$1);
      $$0.a(() -> wx.a("commands.datapack.modify.disable", $$1.a(true)), true);
      anq.a($$3.stream().map(ate::g).collect(Collectors.toList()), $$0);
      return $$3.size();
   }
   ...
   private static ate a(CommandContext<ee> $$0, String $$1, boolean $$2) throws CommandSyntaxException {
      String $$3 = StringArgumentType.getString($$0, $$1);
      ath $$4 = ((ee)$$0.getSource()).l().aG();
      ate $$5 = $$4.c($$3);
      if ($$5 == null) {
         throw a.create($$3);
      } else {
         ...
         if ($$2 && $$6) {
            ...
            coj $$7 = ((ee)$$0.getSource()).w();
            coj $$8 = $$5.e();
            if (!$$2 && !$$8.b() && $$5.l() == ati.d) {
               throw d.create($$3);
            } else if (!$$8.a($$7)) {
               throw e.create($$3, col.a($$7, $$8));
            } else {
               return $$5;
            }
         }
