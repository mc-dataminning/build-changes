public class bpx extends bql {
   private static final int[] a = new int[]{0, 1, 4, 5, 6, 7};
   private final bvf b;
   private final int c;
   private boolean d;

   public bpx(bvf $$0, int $$1) {
      this.b = $$0;
      this.c = b($$1);
   }
   ...
   private boolean a(gw $$0, int $$1, int $$2, int $$3) {
      gw $$4 = $$0.b($$1 * $$3, 0, $$2 * $$3);
      return this.b.dL().b_($$4).a(aqa.a) && !this.b.dL().a_($$4).d();
   }
   ...
   public void e() {
      boolean $$0 = this.d;
      if (!$$0) {
         eag $$1 = this.b.dL().b_(this.b.dl());
         this.d = $$1.a(aqa.a);
      }

      if (this.d && !$$0) {
         this.b.a(apg.fV, 1.0F, 1.0F);
      }

      ehh $$2 = this.b.do();
      if ($$2.d * $$2.d < 0.03F && this.b.dD() != 0.0F) {
         this.b.s(asb.j(0.2F, this.b.dD(), 0.0F));
      } else if ($$2.f() > 1.0E-5F) {
         double $$3 = $$2.h();
