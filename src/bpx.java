...
public record bpx<T>(bpp<StringReader> a, bpn<T> b) {
   public Optional<T> a(bps<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bpq.a<StringReader> $$1 = new bpq.a<>();
      bqb $$2 = new bqb(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bpr::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bpq.a<StringReader> $$2 = new bpq.a<>();
      bqb $$3 = new bqb(this.a(), $$2, $$1);
      this.a($$3);
      List<bpr<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bpr<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bqa $$7) {
               en.a($$7.a(), $$5);
            } else {
