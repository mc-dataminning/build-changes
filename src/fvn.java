...
public class fvn<T extends cfh> extends fsn<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.Z_()) {
         ...
         this.n.f = ayd.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = ayd.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = ayd.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = ayd.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = ayd.b($$1 * 0.6662F) * 1.4F * $$2;
      }
