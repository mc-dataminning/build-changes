...
public class fvn extends asg<fvn.a> {
   ...
   protected fvn.a a(asb $$0, bin $$1) {
      ...
      $$1.b();
      return new fvn.a($$2, $$3, $$4);
   }

   protected void a(fvn.a $$0, asb $$1, bin $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(asb $$0, bin $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, era.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, era.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, era.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
