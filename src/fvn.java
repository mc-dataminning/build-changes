...
public class fvn extends fux<fvn.b> {
   ...
   private boolean ac;
   private boolean ad;
   private final Set<axe<cwj>> ae = new HashSet<>();
   private final boolean af;
   private final fvq ag;

   public fvn(gkt $$0, crr $$1, boolean $$2) {
      super(new fvn.b($$0), $$0.gi(), wn.a);
      $$0.cd = this.z;
      this.u = 136;
      this.s = 195;
      this.af = $$2;
   ...
   private void a(crr $$0, boolean $$1, jt.a $$2) {
      gfx $$3 = this.m.L();
      if (this.a($$3 != null ? $$3.D() : null, $$0, $$1, $$2)) {
         for (cvc $$4 : cvd.d()) {
            Collection<cwn> $$5 = $$4.l();
            if ($$4 == V) {
               if ($$4.k() == cvc.h.a && $$5.isEmpty()) {
                  this.a(cvd.b());
               } else {
                  this.a($$5);
               }
   ...
   private boolean a(@Nullable ggo $$0, crr $$1, boolean $$2, jt.a $$3) {
      if (!cvd.a($$1, $$2, $$3)) {
         return false;
      } else {
         if ($$0 != null) {
            List<cwn> $$4 = List.copyOf(cvd.e().l());
            $$0.a($$3, $$4);
            $$0.a($$4);
         }
   ...
   private void a(Collection<cwn> $$0) {
   ...
   public void E() {
      ...
      if (this.m != null) {
         ...
         if (!this.m.r.f()) {
            this.m.a(new fvy(this.m.t));
         }
      }
   }

   @Override
   protected void a(@Nullable ctx $$0, int $$1, int $$2, csl $$3) {
      if (this.a($$0)) {
         this.Y.c(false);
         this.Y.o(0);
      }
      ...
      boolean $$4 = $$3 == csl.b;
      $$3 = $$1 == -999 && $$3 == csl.a ? csl.e : $$3;
      if ($$3 != csl.e || this.m.t.gl()) {
         this.a($$0, $$3);
         if ($$0 == null && V.k() != cvc.h.b && $$3 != csl.f) {
            ...
            if ($$0 == this.aa && $$4) {
               for (int $$5 = 0; $$5 < this.m.t.cc.c().size(); $$5++) {
                  this.m.t.cc.b($$5).f(cwn.j);
                  this.m.r.a(cwn.j, $$5);
               }
            } else if (V.k() == cvc.h.b) {
               if ($$0 == this.aa) {
                  this.z.b(cwn.j);
               } else if ($$3 == csl.e && $$0 != null && $$0.h()) {
                  cwn $$6 = $$0.a($$2 == 0 ? 1 : $$0.g().k());
                  cwn $$7 = $$0.g();
                  this.m.t.a($$6, true);
                  this.m.r.a($$6);
                  this.m.r.a($$7, ((fvn.c)$$0).a.d);
               } else if ($$3 == csl.e && $$1 == -999 && !this.z.g().f()) {
                  this.m.t.a(this.z.g(), true);
                  this.m.r.a(this.z.g());
                  this.z.b(cwn.j);
               } else {
                  this.m.t.cc.a($$0 == null ? $$1 : ((fvn.c)$$0).a.d, $$2, $$3, this.m.t);
                  this.m.t.cc.d();
               }
            } else if ($$3 != csl.f && $$0.c == S) {
               cwn $$8 = this.z.g();
               cwn $$9 = $$0.g();
               if ($$3 == csl.c) {
                  if (!$$9.f()) {
               ...
               cwn $$13 = $$0 == null ? cwn.j : this.z.b($$0.d).g();
               this.z.a($$0 == null ? $$1 : $$0.d, $$2, $$3, this.m.t);
               if (csa.d($$2) == 2) {
                  for (int $$14 = 0; $$14 < 9; $$14++) {
                     this.m.r.a(this.z.b(45 + $$14).g(), 36 + $$14);
                  }
               } else if ($$0 != null && cou.d($$0.i()) && V.k() != cvc.h.b) {
                  if ($$3 == csl.e && !$$13.f() && !this.z.g().f()) {
                     int $$15 = $$2 == 0 ? 1 : $$13.M();
                     cwn $$16 = $$13.c($$15);
                     $$13.h($$15);
                     this.m.t.a($$16, true);
   ...
   private boolean a(@Nullable ctx $$0) {
      return $$0 != null && $$0.c == S;
   }
   ...
   protected void aR_() {
      if (this.m.r.f()) {
         super.aR_();
         this.Y = new foz(this.p, this.C + 82, this.D + 6, 80, 9, wo.c("itemGroup.search"));
         this.Y.f(50);
         this.Y.d(false);
         this.Y.g(false);
         this.Y.m(16777215);
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (V.k() != cvc.h.d) {
         ...
         boolean $$4 = fen.a($$0, $$1).e().isPresent();
         if ($$3 && $$4 && this.a($$0, $$1)) {
            this.ac = true;
            return true;
         } else {
   ...
   private void a(cvc $$0) {
      ...
      if (V.k() == cvc.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.k.size(); $$10++) {
            ...
            ctx $$26 = new fvn.c($$9.k.get($$10), $$10, $$14, $$15);
            this.z.k.add($$26);
         }

         this.aa = new ctx(S, 0, 173, 112);
   ...
   public void a(fob $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.aa != null && V.k() == cvc.h.b && this.a(this.aa.e, this.aa.f, 16, 16, (double)$$1, (double)$$2)) {
         $$0.a(this.p, T, $$1, $$2);
      }
   ...
   public List<wo> a(cwn $$0) {
      boolean $$1 = this.B != null && this.B instanceof fvn.a;
      boolean $$2 = V.k() == cvc.h.a;
      boolean $$3 = V.k() == cvc.h.d;
      cyf.a $$4 = this.m.n.m ? cyf.a.b : cyf.a.a;
      cyf $$5 = $$1 ? $$4.c() : $$4;
      List<wo> $$6 = $$0.a(cwj.b.a(this.m.s), this.m.t, $$5);
      if ($$2 && $$1) {
         return $$6;
      } else {
   ...
   protected void a(fob $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(gmf::H, V.c(), this.C, this.D, 0.0F, 0.0F, this.s, this.u, 256, 256);
      this.Y.a($$0, $$2, $$3, $$1);
      int $$5 = this.C + 175;
      int $$6 = this.D + 18;
      int $$7 = $$6 + 112;
      if (V.e()) {
         aku $$8 = this.I() ? G : H;
         $$0.a(gmf::H, $$8, $$5, $$6 + (int)((float)($$7 - $$6 - 17) * this.W), 12, 15);
      }

      this.a($$0, V);
      if (V.k() == cvc.h.b) {
         fvy.a($$0, this.C + 73, this.D + 6, this.C + 105, this.D + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.m.t);
      }
   }
   ...
   protected boolean a(cvc $$0, double $$1, double $$2) {
      int $$3 = this.b($$0);
      int $$4 = this.c($$0);
      return $$1 >= (double)$$3 && $$1 <= (double)($$3 + 26) && $$2 >= (double)$$4 && $$2 <= (double)($$4 + 32);
   }

   protected boolean a(fob $$0, cvc $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(fob $$0, cvc $$1) {
      boolean $$2 = $$1 == V;
      boolean $$3 = $$1.g() == cvc.f.a;
      int $$4 = $$1.f();
      ...
      $$0.a(gmf::H, $$7[ayy.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static void a(flh $$0, int $$1, boolean $$2, boolean $$3) {
      gkt $$4 = $$0.t;
      kf $$5 = $$4.dW().K_();
      flc $$6 = $$0.aD();
      gkv $$7 = $$6.a($$1);
   ...
   public static class b extends csa {
      public final ka<cwn> m = ka.a();
      private final csa n;
      ...
      public b(cov $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new fvn.a(fvn.S, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }
      ...
      protected float e(int $$0) {
         return ayy.a((float)$$0 / (float)this.l(), 0.0F, 1.0F);
      }

      protected float a(float $$0, double $$1) {
         return ayy.a($$0 - (float)($$1 / (double)this.l()), 0.0F, 1.0F);
      }
   ...
   static class c extends ctx {
      ...
      public c(ctx $$0, int $$1, int $$2, int $$3) {
         super($$0.c, $$1, $$2, $$3);
         this.a = $$0;
      }
