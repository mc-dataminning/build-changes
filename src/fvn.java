...
public class fvn implements fvm {
   private final fvm.a a;
   private final fvm.a b = fvm.a(new erv(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public ese getBuffer(fvu $$0) {
      if ($$0.K()) {
         ...
         return new fvn.a($$1, this.c, this.d, this.e, this.f);
      } else {
         ese $$2 = this.a.getBuffer($$0);
         Optional<fvu> $$3 = $$0.J();
         if ($$3.isPresent()) {
            ese $$4 = this.b.getBuffer($$3.get());
            fvn.a $$5 = new fvn.a($$4, this.c, this.d, this.e, this.f);
            return esh.a($$5, $$2);
         } else {
            return $$2;
         }
