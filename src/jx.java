...
public class jx extends jz {
   ...
   jx(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }

   public static jx a(int $$0, int $$1, int $$2) {
      return new jx($$0, $$1, $$2);
   }

   public static jx a(iu $$0) {
   ...
   public static jx a(jo $$0) {
      return new jx(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static jx a(long $$0) {
   ...
   public iu g(short $$0) {
      return new iu(this.d($$0), this.e($$0), this.f($$0));
   }
   ...
   public static long e(long $$0) {
      return b(a(iu.a($$0)), a(iu.b($$0)), a(iu.c($$0)));
   }
   ...
   public iu j() {
      return new iu(c(this.a()), c(this.b()), c(this.c()));
   }
   ...
   public jx d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new jx(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }

   public Stream<iu> t() {
      return iu.a(this.d(), this.e(), this.f(), this.g(), this.h(), this.i());
   }

   public static Stream<jx> a(jx $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<jx> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<jx>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final ix a = new ix($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super jx> $$0x) {
            if (this.a.a()) {
               $$0.accept(new jx(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
   ...
   public static void a(iu $$0, LongConsumer $$1) {
      a($$0.u(), $$0.v(), $$0.w(), $$1);
   }

   public static void a(long $$0, LongConsumer $$1) {
      a(iu.a($$0), iu.b($$0), iu.c($$0), $$1);
   }
