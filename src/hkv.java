...
public class hkv<T> implements hkz<T> {
   protected final Comparator<T> a;
   protected final hky<T> b;

   public hkv(Function<T, Stream<ald>> $$0, List<T> $$1) {
   ...
   protected List<T> a(String $$0, String $$1) {
      List<T> $$2 = this.b.a($$0);
      List<T> $$3 = this.b.b($$1);
      return ImmutableList.copyOf(new hkw<T>($$2.iterator(), $$3.iterator(), this.a));
   }
}
