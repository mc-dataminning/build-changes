...
public class ays {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axu.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axu.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ays.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alh.d($$0.substring(1)).map($$0x -> new ays.c($$0x, true)) : alh.d($$0).map($$0x -> new ays.c($$0x, false)), ays.c::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bag.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> E = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kj.e.fieldOf("id").forGetter(GameProfile::getId), y.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static Codec<String> C = Codec.STRING
      .validate($$0 -> !alh.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ays.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ays.b<>($$0, $$1);
   }
   ...
   public static <T> Codec<jt<T>> b(Codec<jt<T>> $$0) {
      return $$0.validate(
   ...
   public static record c(alh a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
