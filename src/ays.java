...
public class ays {
   ...
   public static jn<cvg> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return lu.g.c(alb.a($$2)).orElseThrow(() -> new JsonSyntaxException("Expected " + $$1 + " to be an item, was unknown string '" + $$2 + "'"));
      } else {
         throw new JsonSyntaxException("Expected " + $$1 + " to be an item, was " + d($$0));
      }
   }

   public static jn<cvg> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jn<cvg> a(JsonObject $$0, String $$1, @Nullable jn<cvg> $$2) {
