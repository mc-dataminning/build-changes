...
public class egj extends efz<egi> {
   ...
   private static boolean a(dhh $$0, ji $$1, egi $$2, boolean $$3) {
      if ($$0.a($$1, dwx.a::v)) {
         return true;
      } else {
   ...
   private void a(dhh $$0, azh $$1, egi $$2, ji $$3, int $$4, boolean $$5) {
      ji.a $$6 = new ji.a();
      dwy $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(dhh $$0, azh $$1, egi $$2, ji $$3, int $$4, boolean $$5) {
      ji.a $$6 = new ji.a();
      boolean $$7 = $$2.d.a(djp.lm);
   ...
   private void a(dgk $$0, azh $$1, egi $$2, ji.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(dgk $$0, azh $$1, ji $$2, dwy $$3, boolean $$4) {
      if ($$0.a_($$2.e()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(ji $$0, dgk $$1, azh $$2) {
      ji.a $$3 = $$0.k().c(jn.a);
      if ($$1.u($$3)) {
         int $$4 = ayz.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
