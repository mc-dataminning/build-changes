...
public class egj extends egp<eir> {
   public egj(Codec<eir> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egr<eir> $$0) {
      dhx $$1 = $$0.b();
      jh $$2 = $$0.e();
      eir $$3 = $$0.f();
      bac $$4 = $$0.d();
   ...
   private void a(dhx $$0, bac $$1, jh $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, eir $$9) {
      Optional<ecz> $$10 = ecz.a($$0, $$2, $$9.b, egk::c, egk::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            if ($$17.isPresent() && $$24 && !this.a((dhc)$$0, $$2.h($$17.getAsInt()))) {
               ...
               if ($$11.isPresent()) {
                  $$26 = Math.max(0, $$22 + azu.b($$1, -$$9.e, $$9.e));
               } else {
            ...
            if ($$11.isPresent()) {
               egk.a($$0, $$2.h($$11.getAsInt() - 1), jm.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               egk.a($$0, $$2.h($$17.getAsInt() + 1), jm.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dhc $$0, jh $$1) {
      return $$0.a_($$1).a(dkf.K);
   }

   private int a(bac $$0, int $$1, int $$2, float $$3, int $$4, eir $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
         int $$6 = Math.abs($$1) + Math.abs($$2);
         float $$7 = (float)azu.a((double)$$6, 0.0, (double)$$5.l, (double)$$4 / 2.0, 0.0);
   ...
   private boolean b(dhx $$0, jh $$1) {
      dxo $$2 = $$0.a_($$1);
      if (!$$2.a(dkf.J) && !$$2.a(dkf.sW) && !$$2.a(dkf.sV)) {
         if ($$0.a_($$1.d()).y().a(axq.a)) {
            return false;
         } else {
            for (jm $$3 : jm.c.a) {
   ...
   private boolean a(dha $$0, jh $$1) {
      dxo $$2 = $$0.a_($$1);
      return $$2.a(axk.bg) || $$2.y().a(axq.a);
   }

   private void a(dhx $$0, jh $$1, int $$2, jm $$3) {
      jh.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, eir $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
      return (double)azu.b((float)$$7, 0.0F, (float)$$4.k, $$4.j, 1.0F);
   }

   private static float a(bac $$0, float $$1, float $$2, float $$3, float $$4) {
      return brz.a($$0, $$3, $$4, $$1, $$2);
   }
}
