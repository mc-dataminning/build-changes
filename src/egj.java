...
public class egj extends egr<egi> {
   public egj(Codec<egi> $$0) {
      super($$0);
   }

   public boolean a(egi $$0, azs $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(egm $$0, egi $$1, eaj $$2, Function<jj, js<dis>> $$3, azs $$4, edx $$5, dgw $$6, eai $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private float[] a(egm $$0, egi $$1, azs $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(egi $$0, azs $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - azk.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)azk.b($$1, 0.75F, 1.0F);
   }

   private boolean a(egm $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
