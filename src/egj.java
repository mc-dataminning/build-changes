...
public class egj extends egd<egj.a> {
   protected egj(dnp $$0) {
      super(cvw.a, $$0, new egj.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dnh g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && jb.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dnh(15) : new dnh();
         }
      }
   }

   private static dnh a(dnh $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends ega<egj.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dnh> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public egj.a a() {
         return new egj.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
