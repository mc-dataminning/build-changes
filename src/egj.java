...
public class egj extends efw<eht> {
   public egj(Codec<eht> $$0) {
      super($$0);
   }
   ...
   private void a(azg $$0, dgh $$1, int $$2, int $$3, ji $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ji $$2, dgh $$3, boolean $$4, double $$5, ji $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dgh $$0, ji $$1) {
      if ($$0.a_($$1.d()).a(djm.ea)) {
         this.a($$0, $$1.d(), djm.a.m());
      }
   }

   private void a(dgh $$0, azg $$1, ji $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dwv $$13) {
   ...
   private void a(ji $$0, dgh $$1, azg $$2, int $$3, int $$4, boolean $$5, boolean $$6, dwv $$7) {
      dwv $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(djm.ec) || $$8.a(djm.eb) || $$8.a(djm.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(djm.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, djm.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, ji $$2, int $$3, azg $$4) {
   ...
   private static boolean c(dwv $$0) {
      return $$0.a(djm.ja) || $$0.a(djm.ec) || $$0.a(djm.ny);
   }
   ...
   private void a(dgh $$0, ji $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(djm.ea)) {
                  if (this.a((dfl)$$0, $$10)) {
                     this.a($$0, $$10, djm.a.m());
                     this.a($$0, $$10.d(), djm.a.m());
                  } else if (c($$11)) {
                     dwv[] $$12 = new dwv[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
