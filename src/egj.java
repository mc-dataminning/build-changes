...
public class egj extends egh {
   public static final MapCodec<egj> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bqa.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  bqa.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final bqa i;
   private final jm<dfa> j;

   public egj(int $$0, int $$1, int $$2, bqa $$3, float $$4, bqa $$5, jm<dfa> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<eep.a> a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, int $$3, iz $$4, edz $$5) {
      List<eep.a> $$6 = Lists.newArrayList();
      iz.a $$7 = new iz.a();
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new eep.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, int $$3, edz $$4, List<eep.a> $$5, iz.a $$6, int $$7, je $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new eep.a($$16, 0, false));
         $$5.add(new eep.a($$16.c(2), 0, false));
      }
   }
