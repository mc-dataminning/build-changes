...
public record cwa(int c, int d, iw<cvp> e, Optional<cwa.a> f) {
   private static final int g = 3;
   public static final MapCodec<cwa> a = cwa.a.a
      .flatXmap(cwa::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final yg<vt, cwa> b = yg.a(cwa::a, cwa::b);

   public static cwa a(Map<Character, cvp> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cwa a(Map<Character, cvp> $$0, List<String> $$1) {
      cwa.a $$2 = new cwa.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cwa> a(cwa.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      iw<cvp> $$4 = iw.a($$2 * $$3, cvp.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cwa($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cnm $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cwa b(vt $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      iw<cvp> $$3 = iw.a($$1 * $$2, cvp.a);
      $$3.replaceAll($$1x -> cvp.b.decode($$0));
      return new cwa($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cwa.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cvp> b, List<String> c) {
      ...
      public static final MapCodec<cwa.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(awu.d(e, cvp.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cwa.a::new)
      );

      public Map<Character, cvp> a() {
         return this.b;
      }
