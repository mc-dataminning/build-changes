...
public class fja implements ewx {
   static final Logger b = LogUtils.getLogger();
   private final exv c;
   private final fio<fja.b> d;

   fja(exv $$0, fio<fja.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akn c, int d, int e, int[][] f) implements fjc {
      ...
      public static final MapCodec<fja.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akn.a.fieldOf("file").forGetter(fja.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fja.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fja.a::e),
                     g.fieldOf("chars").forGetter(fja.a::f)
                  )
                  .apply($$0, fja.a::new)
         )
         .validate(fja.a::a);
      ...
      private static DataResult<fja.a> a(fja.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fja.b $$15 = $$9.a($$12, new fja.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fja.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(exv $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, exv b, int c, int d, int e, int f, int g, int h) implements eww {
