...
public class fja implements gug {
   private static final long a = 3000L;
   private final fft b;
   private final List<fja.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fja.b> e = new ArrayList<>();
   ...
   public void a(fhf $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fja.b> $$10 = this.e.iterator();
            ...
            for (fja.b $$12 : this.e) {
               ...
               if ($$15 != null) {
                  ...
                  int $$25 = ayg.d(ayg.b(255.0F, 75.0F, (float)(ac.c() - $$15.b) / (float)(3000.0 * $$9)));
   ...
   @Override
   public void a(gtc $$0, gui $$1, float $$2) {
      if ($$1.a() != null) {
         wu $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fja.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new ewf($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fja.b($$3, $$2, new ewf($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(ewf a, long b) {
   }

   static class b {
      private final wu a;
      private final float b;
      private final List<fja.a> c = new ArrayList<>();

      public b(wu $$0, float $$1, ewf $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fja.a($$2, ac.c()));
      }
      ...
      public void b(ewf $$0) {
         ...
         this.c.add(new fja.a($$0, ac.c()));
      }

      public boolean c(ewf $$0) {
         if (Float.isInfinite(this.b)) {
            ...
            fja.a $$1 = this.a($$0);
            return $$1 == null ? false : $$0.a((jt)$$1.a, (double)this.b);
         }
      }
