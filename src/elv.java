public abstract class elv extends emb {
   ...
   protected elv(emo $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, jm $$7) {
      super($$0, 0, emb.a($$1, $$2, $$3, $$7, $$4, $$5, $$6));
      this.a = $$4;
      this.b = $$5;
      this.c = $$6;
      this.a($$7);
   ...
   protected boolean a(dfc $$0, elp $$1, int $$2) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$3 = 0;
   ...
   protected boolean a(dfc $$0, int $$1) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$2 = $$0.al() + 1;
