...
public class elv {
   public static List<emx> a(elv.a... $$0) {
      for (elv.a $$1 : $$0) {
         a($$1.j);
      }

      List<emx> $$2 = Lists.newArrayList();

      for (elv.a $$3 : $$0) {
         $$2.add(new emx($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(emx::a));
      return $$2;
   }
   ...
   public static List<emx> a() {
      return a(elv.a.values());
   }
