...
public class els {
   ...
   @Nullable
   private String g;
   private static final els.a h = new els.a() {
      @Nullable
      @Override
      public elr a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (elv.a(this.d, "Get capabilities")) {
         ...
         if (elv.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  elv.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !elv.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public elr a(els.c $$0) {
      return ($$0 == els.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements els.a {
      private final int a;
      private final Set<elr> b = Sets.newIdentityHashSet();
      ...
      public elr a() {
         if (this.b.size() >= this.a) {
            if (aa.aT) {
               els.a.warn("Maximum sound pool size {} reached", this.a);
            }
