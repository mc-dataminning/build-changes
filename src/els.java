...
public class els {
   ...
   public void a(enc $$0, String $$1, enz.a $$2, ebw $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  els.b $$13 = new els.b($$1.trim(), this.f, $$3, $$2);
                  els.a $$14 = new els.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        els.c $$30 = new els.c(this.f, $$2, $$0);
                        els.a $$31 = new els.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eng(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ebw $$2) throws IOException {
      ...
      File $$15 = new File(eql.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ebw d;
      private final enz.a e;

      b(String $$0, File $$1, ebw $$2, enz.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((els.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !els.this.b && !els.this.d) {
            try {
               els.this.e = true;
               els.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               els.a.error("Error extracting archive", var3);
               els.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final enz.a c;
      private final enc d;

      c(File $$0, enz.a $$1, enc $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((els.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !els.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, els.this.g);
                  els.this.c = true;
               } else {
                  els.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  els.this.d = true;
               }
            } catch (IOException var3) {
               els.a.error("Error copying resourcepack file: {}", var3.getMessage());
               els.this.d = true;
            }
         }
      }
