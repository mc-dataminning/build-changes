...
public class els {
   ...
   private static final doy.f e = ($$0, $$1, $$2) -> $$0.a(dca.co);
   ...
   public static Optional<els> a(cyy $$0, ib $$1, ih.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<els> a(cyy $$0, ib $$1, Predicate<els> $$2, ih.a $$3) {
      Optional<els> $$4 = Optional.of(new els($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ih.a $$5 = $$3 == ih.a.a ? ih.a.c : ih.a.a;
         return Optional.of(new els($$0, $$1, $$5)).filter($$2);
      }
   }

   public els(cyy $$0, ib $$1, ih.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(doz $$0) {
      return $$0.i() || $$0.a(avc.aK) || $$0.a(dca.ed);
   }
   ...
   public static esa a(l.a $$0, ih.a $$1, esa $$2, bpy $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = axk.a(axk.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         ih.a $$10 = ih.a.b;
         $$11 = axk.a(axk.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new esa($$8, $$11, $$14);
   }

   public static elr a(aps $$0, l.a $$1, ih.a $$2, esa $$3, bpv $$4, esa $$5, float $$6, float $$7) {
      ib $$8 = $$1.a;
      doz $$9 = $$0.a_($$8);
      ih.a $$10 = $$9.d(dpp.H).orElse(ih.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bpy $$13 = $$4.a($$4.ap());
      int $$14 = $$2 == $$10 ? 0 : 90;
      esa $$15 = $$2 == $$10 ? $$5 : new esa($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == ih.a.a;
      esa $$20 = new esa((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      esa $$21 = a($$20, $$0, $$4, $$13);
      return new elr($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static esa a(esa $$0, aps $$1, bpv $$2, bpy $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         esa $$5 = $$0.b(0.0, $$4, 0.0);
         est $$6 = esq.a(erv.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<esa> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<esa> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
