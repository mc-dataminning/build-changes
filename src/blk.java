...
public abstract class blk extends bmo {
   private static final agj<Boolean> bT = agm.a(blk.class, agl.k);
   ...
   protected blk(blt<? extends blk> $$0, cti $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract blk a(amz var1, blk var2);
   ...
   protected void m() {
      if (!this.o_() && this.bO() && this.cZ() instanceof cgv $$0 && !$$0.a((blp)this)) {
         this.ac();
      }
   }
