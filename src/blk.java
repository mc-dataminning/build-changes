...
public class blk<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public blk(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> blk<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bll<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bll<T> $$0 = bll.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bll<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  blk.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = blk.this.c.position();
               }
