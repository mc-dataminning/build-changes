...
public class blk extends blo {
   public static final Codec<blk> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static blk a(float $$0, float $$1, float $$2, float $$3) {
      return new blk($$0, $$1, $$2, $$3);
   }

   private blk(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(awt $$0, float $$1, float $$2, float $$3, float $$4) {
      return awm.a(awm.c($$0, $$1, $$2), $$3, $$4);
   }
