...
public class blk extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bln.a(new Dynamic($$0, $$1), blk.a, bln.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bgr.s.typeName()) ? super.getChoiceType($$0, bid.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bgr.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bgr.s, () -> DSL.optionalFields("components", bgr.w.in($$0), DSL.taggedChoiceLazy("id", bid.a(), $$2)));
      $$0.registerType(
         true,
         bgr.t,
         () -> DSL.hook(
