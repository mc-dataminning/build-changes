...
public class dgp {
   ...
   private final List<dgn> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dgp.a l = new dgp.d(5.999997E7F);
   public static final dgp.c e = new dgp.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(eha $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public gv b(double $$0, double $$1, double $$2) {
      return gv.a(aro.a($$0, this.e(), this.g()), $$1, aro.a($$2, this.f(), this.h()));
   }

   public double a(big $$0) {
   ...
   public boolean a(big $$0, eha $$1) {
      double $$2 = Math.max(aro.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dgp.a)($$0 == $$1 ? new dgp.d($$1) : new dgp.b($$0, $$1, $$2));
   ...
   class b implements dgp.a {
      ...
      @Override
      public double a() {
         return aro.a(dgp.this.a() - this.e() / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
      }

      @Override
      public double c() {
         return aro.a(dgp.this.b() - this.e() / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? aro.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dgo i() {
         return this.c < this.b ? dgo.b : dgo.a;
      }
      ...
      @Override
      public dgp.a l() {
         return (dgp.a)(this.g() <= 0L ? dgp.this.new d(this.c) : this);
      }
      ...
      public ehy m() {
         return ehv.a(
            ehv.c,
            ehv.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehj.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dgp.c a(DynamicLike<?> $$0, dgp.c $$1) {
         double $$2 = aro.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = aro.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dgp.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dgp.a {
      ...
      private void n() {
         this.c = aro.a(dgp.this.a() - this.b / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
         this.d = aro.a(dgp.this.b() - this.b / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
         this.e = aro.a(dgp.this.a() + this.b / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
         this.f = aro.a(dgp.this.b() + this.b / 2.0, (double)(-dgp.this.k), (double)dgp.this.k);
         this.g = ehv.a(
            ehv.c,
            ehv.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehj.e
