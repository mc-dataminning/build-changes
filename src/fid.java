...
public class fid extends fhs implements fix {
   private static final fjh d = new fjh(new akk("widget/text_field"), new akk("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axs> D = ($$0x, $$1x) -> axs.forward($$0x, xr.a);
   @Nullable
   private wu E;
   private long F = ac.c();

   public fid(fhf $$0, int $$1, int $$2, wu $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fid(fhf $$0, int $$1, int $$2, int $$3, int $$4, wu $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fid(fhf $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fid $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axs> $$0) {
      this.D = $$0;
   }
   ...
   public void e(int $$0) {
      this.w = ayg.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayg.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fnl.s());
   }
   ...
   public void b(fhh $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aK_() && (ac.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = ayg.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gen.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = ayg.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayg.a(this.v, 0, this.p.length());
      }
   }
