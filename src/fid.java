...
public class fid {
   public static List<fjo> a(fid.a... $$0) {
      for (fid.a $$1 : $$0) {
         a($$1.j);
      }

      List<fjo> $$2 = Lists.newArrayList();

      for (fid.a $$3 : $$0) {
         $$2.add(new fjo($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fjo::a));
      return $$2;
   }
   ...
   public static List<fjo> a() {
      return a(fid.a.values());
   }
