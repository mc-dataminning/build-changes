...
public abstract class feq<T extends cia> extends fdy<T> {
   ...
   private void c(ews $$0, int $$1, int $$2) {
      ...
      if (!$$5.isEmpty() && $$4 >= 32) {
         ...
         if ($$6) {
            ...
            if ($$10 != null) {
               List<vf> $$12 = List.of(this.a($$10), bli.a($$10, 1.0F));
   ...
   private void a(ews $$0, int $$1, int $$2, Iterable<blh> $$3, boolean $$4) {
      int $$5 = this.u;
   ...
   private void b(ews $$0, int $$1, int $$2, Iterable<blh> $$3, boolean $$4) {
      gfi $$5 = this.f.aE();
      int $$6 = this.u;
   ...
   private void a(ews $$0, int $$1, int $$2, Iterable<blh> $$3) {
      int $$4 = this.u;
