...
public class feq {
   ...
   public static final feq.a bv;

   public static feq.a a(int $$0, int $$1) {
      return $$0 == -1 ? feq.b.b.a($$1) : feq.b.a.a($$0);
   }

   public static feq.a a(String $$0) {
      if (feq.a.e.containsKey($$0)) {
         return feq.a.e.get($$0);
      } else {
         for (feq.b $$1 : feq.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final feq.b b;
      private final int c;
      private final ayt<wp> d;
      static final Map<String, feq.a> e = Maps.newHashMap();

      a(String $$0, feq.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<feq.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wp> g;

      private static void a(feq.b $$0, String $$1, int $$2) {
         feq.a $$3 = new feq.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public feq.a a(int $$0) {
         return (feq.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
