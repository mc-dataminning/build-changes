...
public class feq {
   ...
   public void a(dbe $$0, bsu $$1, boolean $$2, boolean $$3, float $$4) {
      this.c = true;
      this.d = $$0;
      this.e = $$1;
      this.n = $$2;
      ...
      if ($$2) {
         ...
         float $$6 = $$1 instanceof btp $$5 ? $$5.ee() : 1.0F;
         this.a(-this.a((double)(4.0F * $$6)), 0.0, 0.0);
      } else if ($$1 instanceof btp && ((btp)$$1).fL()) {
         je $$7 = ((btp)$$1).fN();
   ...
   protected void a(double $$0, double $$1, double $$2) {
      ...
      this.a(new evr(this.f.c + $$3, this.f.d + $$4, this.f.e + $$5));
   }
   ...
   public feq.a j() {
      ...
      double $$3 = $$2 * $$1;
      evr $$4 = new evr(this.h).a(0.05F);
      evr $$5 = new evr(this.j).a($$3);
      evr $$6 = new evr(this.i).a($$2);
      return new feq.a($$4, $$5, $$6);
   }
   ...
   public enx k() {
      if (!this.c) {
         ...
         env $$0 = this.d.b_(this.g);
         if ($$0.a(awv.a) && this.f.d < (double)((float)this.g.v() + $$0.a(this.d, this.g))) {
            return enx.b;
         } else {
            feq.a $$1 = this.j();

            for (evr $$3 : Arrays.asList($$1.a, $$1.a(), $$1.b(), $$1.c(), $$1.d())) {
               evr $$4 = this.f.e($$3);
               iz $$5 = iz.a($$4);
               env $$6 = this.d.b_($$5);
               if ($$6.a(awv.b)) {
