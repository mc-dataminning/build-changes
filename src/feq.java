...
public class feq<T extends buu> extends fdm<T> {
   public final fhn a;
   private final fhn b;
   private final fhn f;
   private final fhn g;
   ...
   public static fht c() {
      fhv $$0 = new fhv();
      fhw $$1 = $$0.a();
      fhw $$2 = $$1.a("head", fhs.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fhp.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fhs.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fhp.a);
      $$2.a("left_ear", fhs.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fhp.a);
      $$2.a("nose", fhs.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fhp.a);
      fhw $$3 = $$1.a("body", fhs.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fhp.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fhr $$4 = new fhr(0.001F);
      fhs $$5 = fhs.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fhs $$6 = fhs.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fhp.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fhp.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fhp.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fhp.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fhs.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fhp.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fht.a($$0, 48, 32);
   }
