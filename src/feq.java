...
public class feq implements jo {
   public static final Codec<feq> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> af.a($$0, 3).map($$0x -> new feq((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final yw<ByteBuf, feq> b = new yw<ByteBuf, feq>() {
      public feq a(ByteBuf $$0) {
         return vu.f($$0);
      }

      public void a(ByteBuf $$0, feq $$1) {
         vu.a($$0, $$1);
      }
   };
   public static final feq c = new feq(0.0, 0.0, 0.0);
   ...
   public static feq a(jz $$0) {
      return new feq((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static feq a(jz $$0, double $$1, double $$2, double $$3) {
      return new feq((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static feq b(jz $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static feq c(jz $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static feq a(jz $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public feq(double $$0, double $$1, double $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
   }

   public feq(Vector3f $$0) {
   ...
   public feq a(feq $$0) {
      return new feq($$0.d - this.d, $$0.e - this.e, $$0.f - this.f);
   }

   public feq d() {
      double $$0 = Math.sqrt(this.d * this.d + this.e * this.e + this.f * this.f);
      return $$0 < 1.0E-5F ? c : new feq(this.d / $$0, this.e / $$0, this.f / $$0);
   }

   public double b(feq $$0) {
      return this.d * $$0.d + this.e * $$0.e + this.f * $$0.f;
   }

   public feq c(feq $$0) {
      return new feq(this.e * $$0.f - this.f * $$0.e, this.f * $$0.d - this.d * $$0.f, this.d * $$0.e - this.e * $$0.d);
   }
   ...
   public feq a(double $$0) {
      return this.a($$0, $$0, $$0);
   }

   public feq a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }

   public feq b(double $$0) {
      return this.b($$0, $$0, $$0);
   }
   ...
   public feq b(double $$0, double $$1, double $$2) {
      return new feq(this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public boolean a(feq $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.d;
      double $$4 = $$0.b() - this.e;
      double $$5 = $$0.c() - this.f;
   ...
   public feq d(double $$0, double $$1, double $$2) {
      return new feq(this.d * $$0, this.e * $$1, this.f * $$2);
   }

   public feq f() {
      return new feq(this.d, 0.0, this.f);
   }

   public feq a(azv $$0, float $$1) {
   ...
   public feq a(feq $$0, double $$1) {
      return new feq(azm.d($$1, this.d, $$0.d), azm.d($$1, this.e, $$0.e), azm.d($$1, this.f, $$0.f));
   }

   public feq a(float $$0) {
      float $$1 = azm.b($$0);
      float $$2 = azm.a($$0);
      double $$3 = this.d;
   ...
   public static feq a(float $$0, float $$1) {
      ...
      return new feq((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public feq a(EnumSet<ja.a> $$0) {
   ...
   public feq a(ja.a $$0, double $$1) {
      double $$2 = $$0 == ja.a.a ? $$1 : this.d;
      double $$3 = $$0 == ja.a.b ? $$1 : this.e;
      double $$4 = $$0 == ja.a.c ? $$1 : this.f;
      return new feq($$2, $$3, $$4);
   }

   public feq a(ja $$0, double $$1) {
      jz $$2 = $$0.q();
      return new feq(this.d + $$1 * (double)$$2.u(), this.e + $$1 * (double)$$2.v(), this.f + $$1 * (double)$$2.w());
   }
