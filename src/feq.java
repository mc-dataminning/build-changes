...
public abstract class feq {
   ...
   public fdr a() {
      if (this.c()) {
         ...
         return new fdr(this.b(ja.a.a), this.b(ja.a.b), this.b(ja.a.c), this.c(ja.a.a), this.c(ja.a.b), this.c(ja.a.c));
      }
   }

   public feq b() {
      return this.c() ? fen.a() : fen.a(this.b(ja.a.a), this.b(ja.a.b), this.b(ja.a.c), this.c(ja.a.a), this.c(ja.a.b), this.c(ja.a.c));
   }
   ...
   public feq a(double $$0, double $$1, double $$2) {
      return (feq)(this.c() ? fen.a() : new fdy(this.a, new fem(this.a(ja.a.a), $$0), new fem(this.a(ja.a.b), $$1), new fem(this.a(ja.a.c), $$2)));
   }

   public feq d() {
      feq[] $$0 = new feq[]{fen.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fen.b($$0[0], fen.a($$1, $$2, $$3, $$4, $$5, $$6), fea.o));
      return $$0[0];
   }

   public void a(fen.a $$0) {
      this.a
         .a(
   ...
   public List<fdr> e() {
      ...
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fdr($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(ja.a.a, $$4.d - (double)$$2.u()), this.a(ja.a.b, $$4.e - (double)$$2.v()), this.a(ja.a.c, $$4.f - (double)$$2.w()))
               ? new fds($$4, ja.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fdr.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fdw> b(fdw $$0) {
      if (this.c()) {
   ...
   public feq a(ja $$0) {
      if (!this.c() && this != fen.b()) {
         if (this.b != null) {
            feq $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private feq b(ja $$0) {
      ...
      if (this.d($$1)) {
         ...
         feo $$4 = new feo(this, $$1, $$3);
         if ($$4.c()) {
            return fen.a();
         } else {
            return (feq)($$4.f() ? fen.b() : $$4);
         }
      }
   }
   ...
   public double a(ja.a $$0, fdr $$1, double $$2) {
      return this.a(ir.a($$0, ja.a.a), $$1, $$2);
   }

   protected double a(ir $$0, fdr $$1, double $$2) {
      if (this.c()) {
         return $$2;
