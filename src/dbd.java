...
public class dbd {
   public static <T> List<dbd.b> a(List<T> $$0, Function<T, List<iz<efk>>> $$1, boolean $$2) {
      Object2IntMap<efk> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, efk c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<iz<efk>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (iv<efk> $$12 : $$10.get($$11)) {
               efk $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && axl.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<dbd.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<efk> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dbd.b($$28));
      }
   ...
   public static record b(List<efk> a, ToIntFunction<efk> b) {
      b(List<efk> $$0) {
         this($$0, ac.h($$0));
      }
   }
