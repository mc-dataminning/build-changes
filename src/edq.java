...
public abstract class edq<M extends edk<M>, S extends edn<M>> implements edm {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = edq.a.a(1);
   private static final int g = 512;
   protected static final ia[] d = ia.values();
   protected final dkz e;
   protected final S f;
   ...
   private final hv.a k = new hv.a();
   private static final int l = 2;
   private final long[] m = new long[2];
   private final dky[] n = new dky[2];

   protected edq(dkz $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(cse $$0, hv $$1, dip $$2, dip $$3) {
      return $$3 == $$2 ? false : $$3.b($$0, $$1) != $$2.b($$0, $$1) || $$3.h() != $$2.h() || $$3.g() || $$2.g();
   }

   public static int a(cse $$0, dip $$1, hv $$2, dip $$3, hv $$4, ia $$5, int $$6) {
      boolean $$7 = a($$1);
      boolean $$8 = a($$3);
      if ($$7 && $$8) {
         return $$6;
      } else {
         elu $$9 = $$7 ? elr.a() : $$1.c($$0, $$2);
         elu $$10 = $$8 ? elr.a() : $$3.c($$0, $$4);
         return elr.b($$9, $$10, $$5) ? 16 : $$6;
      }
   }

   public static elu a(cse $$0, hv $$1, dip $$2, ia $$3) {
      return a($$2) ? elr.a() : $$2.a($$0, $$1, $$3);
   }
   ...
   protected dip c(hv $$0) {
      int $$1 = ix.a($$0.u());
      int $$2 = ix.a($$0.w());
      dky $$3 = this.a($$1, $$2);
      return $$3 == null ? cwb.F.o() : $$3.a_($$0);
   }

   protected int a(dip $$0, hv $$1) {
      return Math.max(1, $$0.b(this.e.q(), $$1));
   }

   protected boolean a(long $$0, dip $$1, long $$2, dip $$3, ia $$4) {
      elu $$5 = this.a($$1, $$0, $$4);
      elu $$6 = this.a($$3, $$2, $$4.g());
      return elr.b($$5, $$6);
   }

   protected elu a(dip $$0, long $$1, ia $$2) {
      return a(this.e.q(), this.k.f($$1), $$0, $$2);
   }

   @Nullable
   protected dky a(int $$0, int $$1) {
      long $$2 = csf.c($$0, $$1);
   ...
   public void a(long $$0, @Nullable dkr $$1) {
      this.f.a($$0, $$1);
   }

   public void b(csf $$0, boolean $$1) {
      this.f.c(ix.b($$0.e, $$0.f), $$1);
   }
   ...
   public static class a {
      ...
      public static long a(int $$0, ia $$1) {
         long $$2 = c(1008L, $$1);
         return a($$2, $$0);
      }
      ...
      public static long a(int $$0, boolean $$1, ia $$2) {
         long $$3 = c(1008L, $$2);
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static long b(int $$0, boolean $$1, ia $$2) {
         long $$3 = 0L;
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static boolean a(long $$0, ia $$1) {
      ...
      private static long b(long $$0, ia $$1) {
         return $$0 | 1L << $$1.ordinal() + 4;
      }

      private static long c(long $$0, ia $$1) {
         return $$0 & ~(1L << $$1.ordinal() + 4);
      }
   }
}
