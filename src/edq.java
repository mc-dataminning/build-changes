...
public class edq implements eda {
   public static final Codec<edq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ehm.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               efb.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               efb.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dyz.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, edq::new)
   );
   ...
   public edq(ji<ehm> $$0, int $$1, int $$2, axe<dex> $$3, efb $$4, int $$5, int $$6, int $$7, int $$8, efb $$9, int $$10, int $$11, dyz $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
