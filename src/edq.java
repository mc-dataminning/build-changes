...
public class edq implements doi.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<edq> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final auh<edq> a = auh.a(f);
   private final edu g;
   private final edu h;
   private final edu i;
   ...
   public static edq a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new edq(new dpq(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private edq(edu $$0, edu $$1, edu $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public edq(auu $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         edu.a($$0, IntStream.rangeClosed(-15, 0)),
         edu.a($$0, IntStream.rangeClosed(-15, 0)),
         edu.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public edq a(auu $$0) {
      return new edq($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(doi.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         edr $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(edu.b($$4 * $$13), edu.b($$5 * $$13), edu.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = edu.b($$1 * $$13);
         double $$21 = edu.b($$2 * $$13);
         double $$22 = edu.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            edr $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aun.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
