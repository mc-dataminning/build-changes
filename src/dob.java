...
public class dob implements dqa {
   public static final Codec<dob> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               aex.a.listOf().fieldOf("fossil_structures").forGetter($$0x -> $$0x.b),
               aex.a.listOf().fieldOf("overlay_structures").forGetter($$0x -> $$0x.c),
   ...
   public final hg<dyz> d;
   public final hg<dyz> e;
   public final int f;

   public dob(List<aex> $$0, List<aex> $$1, hg<dyz> $$2, hg<dyz> $$3, int $$4) {
      if ($$0.isEmpty()) {
