...
@Deprecated
public class dob extends dnm<dob.a> {
   private static final dez a = csm.nc.n();

   public dob(Codec<dob.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dno<dob.a> $$0) {
      gu $$1 = $$0.e();
      cqf $$2 = $$0.b();
      aru $$3 = $$0.d();
      dob.a $$4 = $$0.f();
   ...
   public static record a(drr b, drr c) implements dpq {
      public static final Codec<dob.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(drr.a.fieldOf("fluid").forGetter(dob.a::a), drr.a.fieldOf("barrier").forGetter(dob.a::b)).apply($$0, dob.a::new)
      );
