...
public class flz {
   public static void a(gcv $$0, flx $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<flw>> $$6 : $$1.c().entrySet()) {
         Optional<gfc> $$7 = $$0.a($$6.getKey());
         List<flw> $$8 = $$6.getValue();
   ...
   private static float a(flx $$0, long $$1) {
