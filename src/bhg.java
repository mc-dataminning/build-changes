...
public abstract class bhg<R extends Runnable> implements bgo, bhi<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bhg(String $$0) {
      this.b = $$0;
      bgm.a.a(this);
   }
   ...
   @Override
   public List<bgl> bk() {
      return ImmutableList.of(bgl.a(this.b + "-pending-tasks", bgk.b, this::bm));
   }
}
