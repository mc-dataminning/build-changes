...
public abstract class bhg extends DataFix {
   private final String a;

   public bhg(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bgv.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bgv.B);
      Type<Pair<String, String>> $$2 = DSL.named(bgv.z.typeName(), big.a());
      if (!Objects.equals(this.getOutputSchema().getType(bgv.z), $$2)) {
