...
public class bhg extends DataFix {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bgs.H);
      Type<?> $$1 = this.getInputSchema().getType(bgs.H);
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bgs.g);
      Type<?> $$1 = this.getInputSchema().getType(bgs.g);
