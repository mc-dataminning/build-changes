...
public class aof {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("random").then(a("value", false))).then(a("roll", true)))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("reset").requires($$0x -> $$0x.c(2)))
                  ...
                  .then(
                     ((RequiredArgumentBuilder)eu.a("sequence", fu.a()).suggests(aof::a).executes($$0x -> a((et)$$0x.getSource(), fu.c($$0x, "sequence"))))
                        .then(
                           ((RequiredArgumentBuilder)eu.a("seed", IntegerArgumentType.integer())
      ...
      return (LiteralArgumentBuilder<et>)eu.a($$0)
         .then(
            ((RequiredArgumentBuilder)eu.a("range", fr.a()).executes($$1x -> a((et)$$1x.getSource(), fr.b.a($$1x, "range"), null, $$1)))
               .then(
                  ((RequiredArgumentBuilder)eu.a("sequence", fu.a()).suggests(aof::a).requires($$0x -> $$0x.c(2)))
   ...
   private static int a(et $$0, dh.d $$1, @Nullable alb $$2, boolean $$3) throws CommandSyntaxException {
      azk $$4;
      if ($$2 != null) {
         $$4 = $$0.e().a($$2);
      } else {
   ...
   private static int a(et $$0, alb $$1) throws CommandSyntaxException {
      $$0.e().M().b($$1);
      $$0.a(() -> xd.a("commands.random.reset.success", xd.a($$1)), false);
      return 1;
   }

   private static int a(et $$0, alb $$1, int $$2, boolean $$3, boolean $$4) throws CommandSyntaxException {
      $$0.e().M().a($$1, $$2, $$3, $$4);
      $$0.a(() -> xd.a("commands.random.reset.success", xd.a($$1)), false);
      return 1;
   }
