...
public class aof {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xa.c("commands.op.failed"));
   ...
   public static void a(CommandDispatcher<ej> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ek.a("op").requires($$0x -> $$0x.c(3))).then(ek.a("targets", ey.a()).suggests(($$0x, $$1) -> {
            ...
            return eo.b($$2.t().stream().filter($$1x -> !$$2.f($$1x.gi())).map($$0xx -> $$0xx.gi().getName()), $$1);
   ...
   private static int a(ej $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if (!$$2.f($$4)) {
            $$2.a($$4);
            $$3++;
            $$0.a(() -> xa.a("commands.op.success", $$4.getName()), true);
         }
      }
