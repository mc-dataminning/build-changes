...
public class aof {
   ...
   private static int b(ep $$0) {
      ...
      coi $$1 = bsz.aC.a((dbx)$$0.e());
      if ($$1 == null) {
         $$0.b(xo.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(bta.f, coh.a($$0.v().b(lq.d)));
         $$1.a_($$0.d().c, $$0.d().d, $$0.d().e);
         $$1.a($$0.e(), $$0.e().d_(iz.a($$0.d())), bts.n, null);
         $$0.e().a_($$1);
         return 1;
      }
   }
