...
public class aof {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xj.c("commands.pardon.failed"));
   ...
   private static int a(ew $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if ($$2.a($$4)) {
            $$2.c($$4);
            $$3++;
            $$0.a(() -> xj.a("commands.pardon.success", xj.b($$4.getName())), true);
         }
      }
