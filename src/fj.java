...
public class fj implements ArgumentType<fj.b> {
   ...
   public static evp a(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      return b($$0, $$1).iterator().next();
   }

   public static Collection<evp> b(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      return a($$0, $$1, Collections::emptyList);
   }

   public static Collection<evp> c(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      return a($$0, $$1, ((ee)$$0.getSource()).l().aK()::e);
   }

   public static Collection<evp> a(CommandContext<ee> $$0, String $$1, Supplier<Collection<evp>> $$2) throws CommandSyntaxException {
      Collection<evp> $$3 = ((fj.b)$$0.getArgument($$1, fj.b.class)).getNames((ee)$$0.getSource(), $$2);
      if ($$3.isEmpty()) {
         throw er.d.create();
      } else {
         return $$3;
   ...
   @FunctionalInterface
   public interface b {
      Collection<evp> getNames(ee var1, Supplier<Collection<evp>> var2) throws CommandSyntaxException;
   }
   ...
   public static class c implements fj.b {
      ...
      @Override
      public Collection<evp> getNames(ee $$0, Supplier<Collection<evp>> $$1) throws CommandSyntaxException {
         List<? extends brw> $$2 = this.a.b($$0);
         if ($$2.isEmpty()) {
            throw er.d.create();
         } else {
