...
public abstract class gxb extends fon {
   ...
   private final List<gwz> a = Lists.newArrayList();
   ...
   protected gwz a(gwz $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xe B() {
      return xd.a(this.a.stream().map(gwz::a).collect(Collectors.toList()));
   }
}
