public abstract class gxb<M extends gdg> extends gwt<gzw, M> {
   private final gcw a;
   private final akv b;
   private final gxb.a c;

   public gxb(gtf<?, gzw, M> $$0, gcw $$1, akv $$2, gxb.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(gzw var1);
   ...
   private void a(ffu $$0, gly $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hei.d);
   }
