...
public class eyu {
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new fdm($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(fvu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      ...
      float $$10 = (float)avr.b.a($$6) / 255.0F;
      float $$11 = (float)avr.b.b($$6) / 255.0F;
      float $$12 = (float)avr.b.c($$6) / 255.0F;
      float $$13 = (float)avr.b.d($$6) / 255.0F;
      ese $$14 = this.f.getBuffer($$0);
   ...
   private void a(ese $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      float $$8 = (float)avr.b.a($$6) / 255.0F;
      float $$9 = (float)avr.b.b($$6) / 255.0F;
      float $$10 = (float)avr.b.c($$6) / 255.0F;
      float $$11 = (float)avr.b.d($$6) / 255.0F;
      float $$12 = (float)avr.b.a($$7) / 255.0F;
      float $$13 = (float)avr.b.b($$7) / 255.0F;
      float $$14 = (float)avr.b.c($$7) / 255.0F;
      float $$15 = (float)avr.b.d($$7) / 255.0F;
   ...
   public void a(eys $$0, String $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.b($$1) / 2, $$3, $$4);
   }

   public void a(eys $$0, vq $$1, int $$2, int $$3, int $$4) {
      avt $$5 = $$1.g();
      this.b($$0, $$5, $$2 - $$0.a($$5) / 2, $$3, $$4);
   }

   public void a(eys $$0, avt $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(eys $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(eys $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, eys.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(eys $$0, avt $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(eys $$0, avt $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, eys.a.a, 0, 15728880);
      this.g();
      return $$6;
   }

   public int b(eys $$0, vq $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(eys $$0, vq $$1, int $$2, int $$3, int $$4, boolean $$5) {
      return this.a($$0, $$1.g(), $$2, $$3, $$4, $$5);
   }

   public void a(eys $$0, vv $$1, int $$2, int $$3, int $$4, int $$5) {
      for (avt $$6 : $$0.c($$1, $$4)) {
   ...
   public void a(coz $$0, int $$1, int $$2) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(coz $$0, int $$1, int $$2, int $$3) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(coz $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3, $$4);
   }

   public void b(coz $$0, int $$1, int $$2) {
      this.b($$0, $$1, $$2, 0);
   }

   public void b(coz $$0, int $$1, int $$2, int $$3) {
      this.a(null, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(bog $$0, coz $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dM(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable bog $$0, @Nullable cvn $$1, coz $$2, int $$3, int $$4, int $$5) {
   ...
   public void a(eys $$0, coz $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(eys $$0, coz $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.b()) {
         this.e.a();
         if ($$1.M() != 1 || $$4 != null) {
   ...
   public void b(eys $$0, coz $$1, int $$2, int $$3) {
      this.a($$0, ffe.a(this.d, $$1), $$1.a(), $$2, $$3);
   }

   public void a(eys $$0, List<vq> $$1, Optional<cme> $$2, int $$3, int $$4) {
      List<fhw> $$5 = $$1.stream().map(vq::g).map(fhw::a).collect(Collectors.toList());
      $$2.ifPresent($$1x -> $$5.add(1, fhw.a($$1x)));
      this.a($$0, $$5, $$3, $$4, fhy.a);
   }

   public void a(eys $$0, vq $$1, int $$2, int $$3) {
      this.b($$0, List.of($$1.g()), $$2, $$3);
   }

   public void a(eys $$0, List<vq> $$1, int $$2, int $$3) {
      this.b($$0, Lists.transform($$1, vq::g), $$2, $$3);
   }

   public void b(eys $$0, List<? extends avt> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(fhw::a).collect(Collectors.toList()), $$2, $$3, fhy.a);
   }

   public void a(eys $$0, List<avt> $$1, fhx $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(fhw::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(eys $$0, List<fhw> $$1, int $$2, int $$3, fhx $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
         ...
         this.e.a();
         int $$14 = 400;
         this.a(() -> fia.a(this, $$12, $$13, $$9, $$10, 400));
   ...
   public void a(eys $$0, @Nullable wn $$1, int $$2, int $$3) {
      if ($$1 != null && $$1.i() != null) {
         vw $$4 = $$1.i();
         vw.c $$5 = $$4.a(vw.a.b);
         if ($$5 != null) {
   ...
   static class a {
      private final Deque<fdm> a = new ArrayDeque<>();

      public fdm a(fdm $$0) {
         fdm $$1 = this.a.peekLast();
         if ($$1 != null) {
            fdm $$2 = Objects.requireNonNullElse($$0.b($$1), fdm.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
