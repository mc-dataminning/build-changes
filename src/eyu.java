...
public class eyu {
   ...
   public static final eyu.a bv;

   public static eyu.a a(int $$0, int $$1) {
      return $$0 == -1 ? eyu.b.b.a($$1) : eyu.b.a.a($$0);
   }

   public static eyu.a a(String $$0) {
      if (eyu.a.e.containsKey($$0)) {
         return eyu.a.e.get($$0);
      } else {
         for (eyu.b $$1 : eyu.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eyu.b b;
      private final int c;
      private final ayt<xp> d;
      static final Map<String, eyu.a> e = Maps.newHashMap();

      a(String $$0, eyu.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayt<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xp.b($$2.toUpperCase(Locale.ROOT)) : xp.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xp.b($$2) : xp.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> un.a().b($$1) ? xp.c($$1) : xp.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eyu.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xp> g;

      private static void a(eyu.b $$0, String $$1, int $$2) {
         eyu.a $$3 = new eyu.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xp> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eyu.a a(int $$0) {
         return (eyu.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
