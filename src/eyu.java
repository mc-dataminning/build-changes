...
public enum eyu {
   ...
   private eyu(final String... $$0) {
      this.c = $$0;
   }

   public List<auh<InputStream>> a(atb $$0) throws IOException {
      return List.of(
   ...
   public auh<InputStream> b(atb $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private auh<InputStream> a(atb $$0, String $$1) throws IOException {
