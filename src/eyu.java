...
public class eyu extends eyf implements fin.a {
   private static final aeu p = new aeu("textures/gui/advancements/window.png");
   ...
   private static final ti w = ti.c("advancements.sad_label");
   private static final ti x = ti.c("advancements.empty");
   private static final ti y = ti.c("gui.advancements");
   private final fin z;
   private final Map<af, eyq> A = Maps.newLinkedHashMap();
   @Nullable
   private eyq B;
   private boolean C;
   ...
   protected void aD_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         eyq $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(esa $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (eyq $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (eyq $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      eyq $$1 = eyq.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
