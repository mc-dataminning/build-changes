...
public class caz extends can {
   ...
   public caz(bty $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!cel.a(this.a)) {
         ...
         if (this.e && this.a.dP().R()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               evr $$2 = cen.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.c($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<iz> $$3x = $$0.y().d($$0xx -> $$0xx.a(axa.b), this::a, $$2x, 10, cet.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<iz> $$3 = $$0.y().d($$0x -> $$0x.a(axa.b), this::a, iz.a($$2), 10, cet.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().i();
                     ...
                     $$4.b($$5);
                     if (this.c == null) {
                        evr $$6 = cek.a(this.a, 10, 7, evr.c(this.d), (float) (Math.PI / 2));
                        if ($$6 == null) {
                           return false;
                        }
