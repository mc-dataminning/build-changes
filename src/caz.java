...
public class caz extends cay {
   ...
   private static final aim<Byte> bW = aiq.a(caz.class, aio.a);
   private static final int bX = 1;
   private static final caf bY = caf.b().a(4.0);
   public final bot d = new bot();
   public final bot e = new bot();
   @Nullable
   private ib bZ;

   public caz(bpd<? extends caz> $$0, cxb $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   protected void Y() {
      ...
      if (this.s()) {
         ...
         ept $$6 = this.dp();
         ept $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.g($$7);
   ...
   public static boolean b(bpd<caz> $$0, cxc $$1, bpt $$2, ib $$3, axd $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
