public class ggg<T extends bpo, M extends fpi<T>> extends ghs<T, M> {
   private static final ajh a = new ajh("textures/entity/bee/bee_stinger.png");

   public ggg(gdz<T, M> $$0) {
      super($$0);
   }
   ...
   @Override
   protected void a(etz $$0, fxq $$1, int $$2, bow $$3, float $$4, float $$5, float $$6, float $$7) {
   ...
   private static void a(eud $$0, etz.a $$1, float $$2, int $$3, float $$4, float $$5, int $$6) {
      $$0.a($$1, $$2, (float)$$3, 0.0F).a(255, 255, 255, 255).a($$4, $$5).c(giq.d).b($$6).b($$1, 0.0F, 1.0F, 0.0F).e();
   }
}
