...
public class fps {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((djj)MoreObjects.firstNonNull(this.b.r.h(), djj.b)).b());
               }
   ...
   private void a(eat $$0, iv $$1, @Nullable tz $$2) {
   ...
   private void a(alg $$0, ffc $$1, @Nullable tz $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.p("UUID");
         $$2.p("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().d();
         boolean $$5 = fiu.a(fpt.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fiu.a(fpt.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fiu.a(fpt.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ag.c();
            this.e = ag.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof gcf) || ((gcf)$$6).u <= ag.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
               boolean $$7 = this.b.aO().i();
               this.b.n.ad().a($$7);
               this.b.n.az();
               if (this.b.z instanceof gcc $$8) {
                  $$8.c($$7);
               }
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fqb.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$9 = $$6 == null || !($$6.aI_() instanceof ftj) || !((ftj)$$6.aI_()).c();
            if ($$9) {
               if (fys.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$10 = this.b.n.av().c() == fpv.a;
                  this.b.n.av().a(fpv.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$10);
                  }
         ...
         label201: {
            ...
            label157:
            if (!$$15) {
               if (this.b.z instanceof fyn $$16 && !$$16.m()) {
                  break label157;
               }
