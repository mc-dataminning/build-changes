...
public class uh {
   ...
   public static final Codec<uh> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               aew.a.optionalFieldOf("font").forGetter($$0x -> Optional.ofNullable($$0x.m))
            )
            .apply($$0, uh::a)
   );
   public static final aew c = new aew("minecraft", "default");
   @Nullable
   final uj d;
   @Nullable
   final Boolean e;
   ...
   public static class b implements JsonDeserializer<uh>, JsonSerializer<uh> {
      ...
      @Nullable
      private static aew a(JsonObject $$0) {
         if ($$0.has("font")) {
            String $$1 = arn.i($$0, "font");
      ...
      private static tq b(JsonObject $$0) {
         if ($$0.has("hoverEvent")) {
            JsonObject $$1 = arn.u($$0, "hoverEvent");
            tq $$2 = tq.a($$1);
            if ($$2 != null && $$2.a().a()) {
               return $$2;
            }
      ...
      private static tj c(JsonObject $$0) {
         if ($$0.has("clickEvent")) {
            JsonObject $$1 = arn.u($$0, "clickEvent");
            String $$2 = arn.a($$1, "action", null);
            tj.a $$3 = $$2 == null ? null : tj.a.a($$2);
            String $$4 = arn.a($$1, "value", null);
      ...
      private static String d(JsonObject $$0) {
         return arn.a($$0, "insertion", null);
      }

      @Nullable
      private static uj e(JsonObject $$0) {
         if ($$0.has("color")) {
            String $$1 = arn.i($$0, "color");
            return uj.a($$1);
         } else {
            return null;
         }
