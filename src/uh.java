...
public class uh extends ua<uy> {
   ...
   public static final va<uh> a = new va.b<uh>() {
      public uh a(DataInput $$0, uk $$1) throws IOException {
         $$1.b();
      ...
      private static uh d(DataInput $$0, uk $$1) throws IOException {
         $$1.b(37L);
         byte $$2 = $$0.readByte();
         int $$3 = $$0.readInt();
         if ($$2 == 0 && $$3 > 0) {
            ...
            $$1.a(4L, (long)$$3);
            va<?> $$4 = vb.a($$2);
            List<uy> $$5 = Lists.newArrayListWithCapacity($$3);
   ...
   public uh e() {
      Iterable<uy> $$0 = (Iterable<uy>)(vb.a(this.w).d() ? this.c : Iterables.transform(this.c, uy::d));
      List<uy> $$1 = Lists.newArrayList($$0);
      return new uh($$1, this.w);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof uh && Objects.equals(this.c, ((uh)$$0).c);
   }
   ...
   @Override
   public uv.b a(uv $$0) {
      switch ($$0.a(vb.a(this.w), this.c.size())) {
         case c:
            return uv.b.c;
         case b:
            return $$0.b();
