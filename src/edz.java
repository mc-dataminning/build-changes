...
public class edz extends eec {
   ...
   public static final Codec<edz> a = RecordCodecBuilder.create($$0 -> a($$0).and(aex.a.fieldOf("name").forGetter($$0x -> $$0x.c)).apply($$0, edz::new));
   private final aex c;

   private edz(List<efp> $$0, aex $$1) {
      super($$0);
      this.c = $$1;
   }
