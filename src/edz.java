...
public class edz implements dor.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<edz> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final auj<edz> a = auj.a(f);
   private final eed g;
   private final eed h;
   private final eed i;
   ...
   public static edz a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new edz(new dpz(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private edz(eed $$0, eed $$1, eed $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public edz(auw $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eed.a($$0, IntStream.rangeClosed(-15, 0)),
         eed.a($$0, IntStream.rangeClosed(-15, 0)),
         eed.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public edz a(auw $$0) {
      return new edz($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dor.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eea $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eed.b($$4 * $$13), eed.b($$5 * $$13), eed.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eed.b($$1 * $$13);
         double $$21 = eed.b($$2 * $$13);
         double $$22 = eed.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eea $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aup.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
