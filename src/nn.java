...
public abstract class nn {
   ...
   public static <T1 extends Comparable<T1>> nn.a<T1> a(dse<T1> $$0) {
      return new nn.a<>($$0);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>> nn.b<T1, T2> a(dse<T1> $$0, dse<T2> $$1) {
      return new nn.b<>($$0, $$1);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> nn.c<T1, T2, T3> a(dse<T1> $$0, dse<T2> $$1, dse<T3> $$2) {
   ...
   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> nn.d<T1, T2, T3, T4> a(
      dse<T1> $$0, dse<T2> $$1, dse<T3> $$2, dse<T4> $$3
   ) {
   ...
   public static class c<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends nn {
      private final dse<T1> a;
      private final dse<T2> b;
      private final dse<T3> c;

      c(dse<T1> $$0, dse<T2> $$1, dse<T3> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class d<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends nn {
      ...
      private final dse<T2> b;
      private final dse<T3> c;
      private final dse<T4> d;

      d(dse<T1> $$0, dse<T2> $$1, dse<T3> $$2, dse<T4> $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   public static class e<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
      ...
      private final dse<T3> c;
      private final dse<T4> d;
      private final dse<T5> e;

      e(dse<T1> $$0, dse<T2> $$1, dse<T3> $$2, dse<T4> $$3, dse<T5> $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
