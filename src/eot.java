...
public class eot extends ged {
   ...
   private static final te C = te.c("mco.upload.verifying");
   private final eom D;
   private final ebw E;
   ...
   private volatile te K = te.c("mco.upload.preparing");
   ...
   public eot(long $$0, int $$1, eom $$2, ebw $$3, Runnable $$4) {
      super(eqf.a);
      this.F = $$0;
      this.G = $$1;
      this.D = $$2;
   ...
   @Override
   public void aE_() {
      this.Q = this.d(esi.a(td.k, $$0 -> this.B()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.Q.j = false;
      this.R = this.d(esi.a(td.e, $$0 -> this.C()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.P) {
         if (this.D.a == -1) {
            this.E();
         } else {
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.K = te.c("mco.upload.close.failure");
                  } else {
                     enc $$3 = null;
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.M) {
                              ...
                              this.K = te.a("mco.upload.uploading", this.E.b());
                              elv $$11 = new elv($$0, this.F, this.G, $$3, this.f.U(), aa.b().c(), this.H);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    this.N = true;
                                    this.K = te.c("mco.upload.done");
                                    this.Q.b(td.d);
                                    epg.b($$2);
                                 } else if ($$1x.a == 400 && $$1x.b != null) {
                                    this.a(te.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(te.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              elt $$8 = elt.a($$7);
                              elt $$9 = elt.a(5368709120L);
                              if (elt.b($$7, $$8).equals(elt.b(5368709120L, $$9)) && $$8 != elt.a) {
                                 elt $$10 = elt.values()[$$8.ordinal() - 1];
                                 this.a(
                                    te.a("mco.upload.size.failure.line1", this.E.b()),
                                    te.a("mco.upload.size.failure.line2", elt.b($$7, $$10), elt.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    te.a("mco.upload.size.failure.line1", this.E.b()),
                                    te.a("mco.upload.size.failure.line2", elt.b($$7, $$8), elt.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(te.a("mco.upload.failed", var21.getMessage()));
               } catch (enk var22) {
                  this.a(te.a("mco.upload.failed", var22.a.b()));
   ...
   private void F() {
      this.K = te.c("mco.upload.cancelled");
