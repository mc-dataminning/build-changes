...
public class eot {
   ...
   private static final Queue<eot.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eot.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eot::a), eor::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eot::a), eor::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eot.a(this.b) + ", type=" + eot.b(this.c) + ", severity=" + eot.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
