...
public class eot {
   ...
   private static final drz.f e = ($$0, $$1, $$2) -> $$0.a(dez.co);
   ...
   public static Optional<eot> a(dbx $$0, iz $$1, je.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<eot> a(dbx $$0, iz $$1, Predicate<eot> $$2, je.a $$3) {
      Optional<eot> $$4 = Optional.of(new eot($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         je.a $$5 = $$3 == je.a.a ? je.a.c : je.a.a;
         return Optional.of(new eot($$0, $$1, $$5)).filter($$2);
      }
   }

   public eot(dbx $$0, iz $$1, je.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dsa $$0) {
      return $$0.i() || $$0.a(awo.aK) || $$0.a(dez.ed);
   }
   ...
   public static evp a(l.a $$0, je.a $$1, evp $$2, bsv $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = ayx.a(ayx.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         je.a $$10 = je.a.b;
         $$11 = ayx.a(ayx.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new evp($$8, $$11, $$14);
   }

   public static eos a(are $$0, l.a $$1, je.a $$2, evp $$3, bss $$4, evp $$5, float $$6, float $$7) {
      iz $$8 = $$1.a;
      dsa $$9 = $$0.a_($$8);
      je.a $$10 = $$9.d(dsq.H).orElse(je.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bsv $$13 = $$4.a($$4.ar());
      int $$14 = $$2 == $$10 ? 0 : 90;
      evp $$15 = $$2 == $$10 ? $$5 : new evp($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == je.a.a;
      evp $$20 = new evp((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      evp $$21 = a($$20, $$0, $$4, $$13);
      return new eos($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static evp a(evp $$0, are $$1, bss $$2, bsv $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         evp $$5 = $$0.b(0.0, $$4, 0.0);
         ewi $$6 = ewf.a(evk.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<evp> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<evp> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
