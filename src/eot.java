...
public class eot extends eou {
   ...
   private static final Codec<Either<aku, ero>> g = Codec.of(eot::a, aku.a.map(Either::left));
   public static final MapCodec<eot> b = RecordCodecBuilder.mapCodec($$0 -> $$0.group(d(), b(), e(), c()).apply($$0, eot::new));
   protected final Either<aku, ero> c;
   protected final jr<erm> d;
   protected final Optional<eqy> e;

   private static <T> DataResult<T> a(Either<aku, ero> $$0, DynamicOps<T> $$1, T $$2) {
   ...
   protected static <E extends eot> RecordCodecBuilder<E, Either<aku, ero>> d() {
      return g.fieldOf("location").forGetter($$0 -> $$0.c);
   }

   protected eot(Either<aku, ero> $$0, jr<erm> $$1, eow.a $$2, Optional<eqy> $$3) {
      super($$2);
      this.c = $$0;
      this.d = $$1;
      this.e = $$3;
