...
public enum fcd implements eqc {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static erb a(int $$0, int $$1, fcd.a $$2) {
      erb $$3 = new erb(erb.a.a, $$0, $$1, false);
