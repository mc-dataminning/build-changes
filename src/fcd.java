...
public class fcd {
   ...
   public static final fcd.a bv;

   public static fcd.a a(int $$0, int $$1) {
      return $$0 == -1 ? fcd.b.b.a($$1) : fcd.b.a.a($$0);
   }

   public static fcd.a a(String $$0) {
      if (fcd.a.e.containsKey($$0)) {
         return fcd.a.e.get($$0);
      } else {
         for (fcd.b $$1 : fcd.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fcd.b b;
      private final int c;
      private final ayz<xe> d;
      static final Map<String, fcd.a> e = Maps.newHashMap();

      a(String $$0, fcd.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayz<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xe.b($$2.toUpperCase(Locale.ROOT)) : xe.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xe.b($$2) : xe.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ub.a().b($$1) ? xe.c($$1) : xe.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fcd.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xe> g;

      private static void a(fcd.b $$0, String $$1, int $$2) {
         fcd.a $$3 = new fcd.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xe> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fcd.a a(int $$0) {
         return (fcd.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
