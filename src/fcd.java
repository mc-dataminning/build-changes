...
public class fcd extends fdm {
   public static final double a = 7.0;
   private static final vg c = vg.c("chat_screen.usage");
   ...
   protected void aP_() {
      ...
      this.b = new eya(this.f.i, 4, this.h - 12, this.g - 4, 12, vg.c("chat.editBox")) {
         @Override
         protected vu aM_() {
            return super.aM_().b(fcd.this.o.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new exu(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
      this.c(this.b);
   }
   ...
   public void a(exe $$0, int $$1, int $$2, float $$3) {
      ...
      this.o.a($$0, $$1, $$2);
      $$0.c().b();
      evm $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.i, this.i.c($$4.g(), 210), $$1, $$2);
      } else {
         wd $$5 = this.b((double)$$1, (double)$$2);
         if ($$5 != null && $$5.i() != null) {
            $$0.a(this.i, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(fbk $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fbj.a, vg.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private wd b(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return avm.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
