...
public class fcd<T extends bfj> extends fad<T> {
   ...
   public static fem a(fei $$0) {
      ...
      $$2.a(
         ...
         feg.a(0.0F, 15.0F, -9.0F)
      );
      $$2.a("body", fej.c().a(20, 0).a(-2.0F, 3.0F, -8.0F, 4.0F, 16.0F, 6.0F, $$0), feg.a(0.0F, 12.0F, -10.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("tail1", fej.c().a(0, 15).a(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, $$0), feg.a(0.0F, 15.0F, 8.0F, 0.9F, 0.0F, 0.0F));
      $$2.a("tail2", fej.c().a(4, 15).a(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, $$3), feg.a(0.0F, 20.0F, 14.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if (this.p != 3) {
         ...
         if (this.p == 2) {
            ...
            this.m.e = 1.7278761F + (float) (Math.PI / 10) * apa.b($$1) * $$2;
         } else {
            this.h.e = apa.b($$1 * 0.6662F) * $$2;
            ...
            if (this.p == 1) {
               this.m.e = 1.7278761F + (float) (Math.PI / 4) * apa.b($$1) * $$2;
            } else {
               this.m.e = 1.7278761F + 0.47123894F * apa.b($$1) * $$2;
            }
         }
      }
   }
