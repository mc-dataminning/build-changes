...
public class eep implements eem, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final btl c;
   private final eeu d;
   private final SequencedMap<dje, eep.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected eep(eew $$0, Path $$1, boolean $$2) {
      this.d = new eeu($$0, $$1, $$2);
      this.c = new btl(eep.b.values().length, ag.i(), "IOWorker-" + $$0.c());
   }

   public boolean a(dje $$0, int $$1) {
      dje $$2 = new dje($$0.h - $$1, $$0.i - $$1);
      dje $$3 = new dje($$0.h + $$1, $$0.i + $$1);
   ...
   public CompletableFuture<Void> a(dje $$0, Supplier<ua> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         ua $$2 = $$1.get();
         eep.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new eep.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<ua>> a(dje $$0) {
      return this.a((eep.c<Optional<ua>>)(() -> {
         eep.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((eep.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dje $$0, ux $$1) {
      return this.a((eep.c<Void>)(() -> {
         try {
            eep.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(eep.c<T> $$0) {
      return this.c.a(eep.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dje, eep.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new btn.c(eep.b.b.ordinal(), this::b));
   }

   private void a(dje $$0, eep.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(eep.b.c.ordinal(), $$0 -> $$0.complete(bay.a)).join();
   }
