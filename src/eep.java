...
public class eep implements azh {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eep> b = eeo.a.xmap($$0 -> new eep($$0), $$0 -> $$0.e);
   private eeo e;
   private final edq f = new edq(this);

   public eep(long $$0) {
      this.e = new eeo(eed.c($$0));
   }
   ...
   @Override
   public azh d() {
      return new eep(this.e.a(), this.e.a());
   }

   @Override
   public eeb e() {
      return new eep.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements eeb {
      ...
      public azh a(int $$0, int $$1, int $$2) {
         long $$3 = ayz.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eep($$4, this.b);
      }

      @Override
      public azh a(String $$0) {
         eed.a $$1 = eed.a($$0);
         return new eep($$1.a(this.a, this.b));
      }

      @Override
      public azh a(long $$0) {
         return new eep($$0 ^ this.a, $$0 ^ this.b);
      }
