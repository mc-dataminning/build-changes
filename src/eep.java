...
public class eep {
   ...
   static class a implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         return $$0.c[ih.f.d()] && !$$0.b[ih.f.d()].d;
      }

      @Override
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         $$1.d = true;
         $$1.b[ih.f.d()].d = true;
         return new eep.k($$0, $$1);
      }
   }

   static class b implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         if ($$0.c[ih.f.d()] && !$$0.b[ih.f.d()].d && $$0.c[ih.b.d()] && !$$0.b[ih.b.d()].d) {
            eep.v $$1 = $$0.b[ih.f.d()];
            return $$1.c[ih.b.d()] && !$$1.b[ih.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         ...
         $$1.b[ih.f.d()].d = true;
         $$1.b[ih.b.d()].d = true;
         $$1.b[ih.f.d()].b[ih.b.d()].d = true;
         return new eep.l($$0, $$1);
      }
   }

   static class c implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         return $$0.c[ih.b.d()] && !$$0.b[ih.b.d()].d;
      }
      ...
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         $$1.d = true;
         $$1.b[ih.b.d()].d = true;
         return new eep.m($$0, $$1);
      }
   }

   static class d implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         if ($$0.c[ih.c.d()] && !$$0.b[ih.c.d()].d && $$0.c[ih.b.d()] && !$$0.b[ih.b.d()].d) {
            eep.v $$1 = $$0.b[ih.c.d()];
            return $$1.c[ih.b.d()] && !$$1.b[ih.b.d()].d;
         } else {
            return false;
      ...
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         ...
         $$1.b[ih.c.d()].d = true;
         $$1.b[ih.b.d()].d = true;
         $$1.b[ih.c.d()].b[ih.b.d()].d = true;
         return new eep.n($$0, $$1);
      }
   }

   static class e implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         return $$0.c[ih.c.d()] && !$$0.b[ih.c.d()].d;
      }

      @Override
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         eep.v $$3 = $$1;
         if (!$$1.c[ih.c.d()] || $$1.b[ih.c.d()].d) {
            $$3 = $$1.b[ih.d.d()];
         }

         $$3.d = true;
         $$3.b[ih.c.d()].d = true;
         return new eep.o($$0, $$3);
      }
   }

   static class f implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         return true;
      }
      ...
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         $$1.d = true;
         return new eep.s($$0, $$1, $$2);
      }
   }

   static class g implements eep.i {
      @Override
      public boolean a(eep.v $$0) {
         return !$$0.c[ih.e.d()] && !$$0.c[ih.f.d()] && !$$0.c[ih.c.d()] && !$$0.c[ih.d.d()] && !$$0.c[ih.b.d()];
      }

      @Override
      public eep.r a(ih $$0, eep.v $$1, awt $$2) {
         $$1.d = true;
         return new eep.t($$0, $$1);
      }
   }

   public static class h extends eep.r {
      ...
      private eep.v G;
      private eep.v H;
      private final List<eep.r> I = Lists.newArrayList();

      public h(awt $$0, int $$1, int $$2, ih $$3) {
         super(ecx.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eep.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eep.p($$3, this.G));
         this.I.add(new eep.j($$3, this.H));
         List<eep.i> $$5 = Lists.newArrayList();
         $$5.add(new eep.b());
         $$5.add(new eep.d());
         $$5.add(new eep.e());
         $$5.add(new eep.a());
         ...
         eby $$10 = eby.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eby $$11 = eby.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eby $$12 = eby.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eep.u($$3, $$10, $$13++));
         this.I.add(new eep.u($$3, $$11, $$13++));
         this.I.add(new eep.q($$3, $$12));
      }
      ...
      private List<eep.v> b(awt $$0) {
         eep.v[] $$1 = new eep.v[75];
         ...
         eep.v $$23 = new eep.v(1003);
         eep.v $$24 = new eep.v(1001);
         eep.v $$25 = new eep.v(1002);
         $$1[v].a(ih.b, $$23);
         $$1[w].a(ih.d, $$24);
         $$1[x].a(ih.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ih.f.d()].d = true;
         this.H.b[ih.c.d()].d = true;
         this.H.b[ih.f.d()].b[ih.c.d()].d = true;
         this.H.b[ih.b.d()].d = true;
         this.H.b[ih.f.d()].b[ih.b.d()].d = true;
         this.H.b[ih.c.d()].b[ih.b.d()].d = true;
         this.H.b[ih.f.d()].b[ih.c.d()].b[ih.b.d()].d = true;
         ObjectArrayList<eep.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cwz $$2, awt $$3, eby $$4) {
         int $$5 = 24;
      ...
      private void a(cwz $$0, awt $$1, eby $$2) {
      ...
      private void b(cwz $$0, awt $$1, eby $$2) {
      ...
      private void c(cwz $$0, awt $$1, eby $$2) {
      ...
      private void d(cwz $$0, awt $$1, eby $$2) {
      ...
      private void e(cwz $$0, awt $$1, eby $$2) {
      ...
      private void f(cwz $$0, awt $$1, eby $$2) {
   ...
   interface i {
      boolean a(eep.v var1);

      eep.r a(ih var1, eep.v var2, awt var3);
   }

   public static class j extends eep.r {
      public j(ih $$0, eep.v $$1) {
         super(ecx.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cwz $$0, cwx $$1, dob $$2, awt $$3, eby $$4, cvl $$5, ib $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, czh.ch.o(), czh.ch.o(), false);
   ...
   public static class k extends eep.r {
      public k(ih $$0, eep.v $$1) {
         super(ecx.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(cwz $$0, cwx $$1, dob $$2, awt $$3, eby $$4, cvl $$5, ib $$6) {
         eep.v $$7 = this.B.b[ih.f.d()];
         eep.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ih.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ih.a.d()]);
         }
   ...
   public static class l extends eep.r {
      public l(ih $$0, eep.v $$1) {
         super(ecx.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eep.r {
      public m(ih $$0, eep.v $$1) {
         super(ecx.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(cwz $$0, cwx $$1, dob $$2, awt $$3, eby $$4, cvl $$5, ib $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ih.a.d()]);
         }

         eep.v $$7 = this.B.b[ih.b.d()];
         if ($$7.b[ih.b.d()] == null) {
   ...
   public static class n extends eep.r {
      public n(ih $$0, eep.v $$1) {
         super(ecx.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(cwz $$0, cwx $$1, dob $$2, awt $$3, eby $$4, cvl $$5, ib $$6) {
         eep.v $$7 = this.B.b[ih.c.d()];
         eep.v $$8 = this.B;
         eep.v $$9 = $$7.b[ih.b.d()];
         eep.v $$10 = $$8.b[ih.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ih.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ih.a.d()]);
         }
   ...
   public static class o extends eep.r {
      public o(ih $$0, eep.v $$1) {
         super(ecx.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eep.r {
      public p(ih $$0, eep.v $$1) {
         super(ecx.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eep.r {
      public q(ih $$0, eby $$1) {
         super(ecx.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eck {
      protected static final dme b = czh.hZ.o();
      protected static final dme c = czh.ia.o();
      protected static final dme d = czh.ib.o();
      protected static final dme h = c;
      protected static final dme i = czh.ii.o();
      protected static final boolean j = true;
      protected static final dme k = czh.G.o();
      protected static final Set<czf> l = ImmutableSet.builder().add(czh.dO).add(czh.iC).add(czh.mW).add(k.b()).build();
      ...
      public r(ecx $$0, ih $$1, int $$2, eby $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ecx $$0, int $$1, ih $$2, eep.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eby a(ih $$0, eep.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eby $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cwz $$0, eby $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dme $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cwz $$0, eby $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cwz $$0, eby $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dme $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eby $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cwz $$0, eby $$1, int $$2, int $$3, int $$4) {
         ib $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cev $$6 = bol.C.a((cwe)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dj()), bpb.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eep.r {
      private int a;

      public s(ih $$0, eep.v $$1, awt $$2) {
         super(ecx.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(cwz $$0, cwx $$1, dob $$2, awt $$3, eby $$4, cvl $$5, ib $$6) {
         ...
         if (this.B.b[ih.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ih.a.d()] && !this.B.c[ih.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eep.r {
      public t(ih $$0, eep.v $$1) {
         super(ecx.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eep.r {
      private int a;

      public u(ih $$0, eby $$1, int $$2) {
         super(ecx.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
