...
public class eep extends eer {
   public static final Codec<eep> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eer.d.forGetter($$0x -> $$0x), brn.c.fieldOf("vertical_rotation").forGetter($$0x -> $$0x.b), eep.a.a.fieldOf("shape").forGetter($$0x -> $$0x.c)
            )
            .apply($$0, eep::new)
   );
   public final brn b;
   ...
   public eep(float $$0, elt $$1, brn $$2, edm $$3, ees $$4, jv<djm> $$5, brn $$6, eep.a $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5);
      this.b = $$6;
      this.c = $$7;
   }

   public eep(eer $$0, brn $$1, eep.a $$2) {
