...
public class ih {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, ie.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends ie.a<A>> void a(JsonObject $$0, ie<A, T> $$1, ie.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", mf.u.b($$2.a()).toString());
