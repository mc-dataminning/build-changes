...
public class bmb {
   ...
   private bmb(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bmb a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bmb($$0, $$1);
   }

   public bmb.d a() throws IOException {
      bmb.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bmb.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bmb.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bmb.c $$3 = bmb.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bmb.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bmb.a($$0, $$3);
            }
         }
   ...
   public bmb.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bmb.c> $$2 = this.a().c();
      ...
      bmb.e $$4 = new bmb.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bmb.c b) implements bmb.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bmb.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bmb.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bmb.b> {
      private final List<bmb.b> a;

      d(List<bmb.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bmb.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bmb.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bmb.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bmb.d a() {
         ListIterator<bmb.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bmb.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bmb.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bmb.b> b() {
         return this.a.stream();
      }

      public Set<bmb.c> c() {
         return this.a.stream().map(bmb.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bmb.c b) implements bmb.b {
