...
public class bmb<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bmb(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bmb<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bmc<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bmc<T> $$0 = bmc.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bmc<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bmb.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bmb.this.c.position();
               }
