...
public class cak extends caa {
   ...
   public cak(btl $$0, double $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   ...
   public boolean b() {
      ...
      if ($$0 == null) {
         ...
         return !this.a.a($$0.dr()) ? false : !($$0 instanceof cml) || !$$0.N_() && !((cml)$$0).f();
      }
   }
   ...
   public void e() {
      ...
      if ($$0 != null) {
         ...
         if ((this.c || this.a.L().a($$0))
            && this.h <= 0
            && (this.e == 0.0 && this.f == 0.0 && this.g == 0.0 || $$0.i(this.e, this.f, this.g) >= 1.0 || this.a.dU().i() < 0.05F)) {
            this.e = $$0.dw();
            this.f = $$0.dy();
            this.g = $$0.dC();
            this.h = 4 + this.a.dU().a(7);
            double $$1 = this.a.g((bsh)$$0);
            if ($$1 > 1024.0) {
               this.h += 10;
            } else if ($$1 > 256.0) {
               this.h += 5;
