...
public class cak extends cam {
   ...
   public cak(bul $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dP();
      this.h = $$1;
      this.i = $$0.K();
      ...
      if (!($$0.K() instanceof ccz) && !($$0.K() instanceof ccy)) {
   ...
   public boolean a() {
      ...
      if ($$0 == null) {
         ...
         return false;
      } else if (this.e.g((bst)$$0) < (double)(this.l * this.l)) {
         return false;
      } else {
         this.f = $$0;
         return true;
   ...
   public boolean b() {
      if (this.i.l()) {
         ...
         return this.h() ? false : !(this.e.g((bst)this.f) <= (double)(this.k * this.k));
      }
   }
   ...
   private boolean a(iz $$0) {
      eol $$1 = eoq.b(this.e, $$0);
      if ($$1 != eol.c) {
         return false;
      } else {
         dsb $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof dji) {
            return false;
         } else {
            iz $$3 = $$0.b(this.e.dp());
