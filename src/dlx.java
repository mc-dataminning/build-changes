...
public class dlx {
   ...
   private final cpz p;
   private static final List<csx> q = List.of(csy.l, csy.L, csy.i, csy.b, csy.k, csy.I, csy.K, csy.fl, csy.dP, csy.iA, csy.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<hg<cqv>>> t;
   ...
   public static final Codec<dlx> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlx::a, Function.identity());

   private static DataResult<dlx> a(dlx $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlx(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<hg<cqv>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hz.c($$0);
      int $$5 = hz.c($$1) - $$4;
   ...
   @Nullable
   public static dlx a(akz $$0, int $$1, int $$2) {
      dhh $$3 = $$0.a($$1, $$2);
      dlx $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dhm.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hd> a(cqr $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dhh $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ary.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dhh $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dku.a.a)) {
         $$3 = Math.min($$0.a(dku.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }
   ...
   private static double a(dhh $$0, gw.a $$1) {
      return a($$0, (gw)$$1.c(hc.a)) ? 1.0 : -1.0;
   }

   private static double b(dhh $$0, gw.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dhh $$0, int $$1, int $$2, int $$3) {
   ...
   private List<hg<cqv>> b(dhh $$0, int $$1, int $$2) {
      ObjectArrayList<hg<cqv>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + hs.a(this.p.H_());
   ...
   private static boolean a(dhh $$0, gw $$1) {
      dfl $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(apu.O)) {
         ...
         return $$2.a(csy.eU) || $$2.a(csy.eV) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dlx.a $$3) {
      if ($$1 >= hs.a(this.p.H_()) && $$1 < hs.a(this.p.aj())) {
         int $$4 = $$1 - hs.a(this.p.H_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               hg<cqv> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dlx.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlx.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, hg<cqv> var3);
   }
