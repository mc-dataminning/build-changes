...
public class apo {
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(wp.c("commands.data.merge.failed"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> wp.b("commands.data.get.invalid", $$0));
   private static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> wp.b("commands.data.get.unknown", $$0));
   private static final SimpleCommandExceptionType g = new SimpleCommandExceptionType(wp.c("commands.data.get.multiple"));
   private static final DynamicCommandExceptionType h = new DynamicCommandExceptionType($$0 -> wp.b("commands.data.modify.expected_object", $$0));
   private static final DynamicCommandExceptionType i = new DynamicCommandExceptionType($$0 -> wp.b("commands.data.modify.expected_value", $$0));
   private static final Dynamic2CommandExceptionType j = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wp.b("commands.data.modify.invalid_substring", $$0, $$1)
   );
   public static final List<Function<String, apo.c>> a = ImmutableList.of(app.a, apm.a, apq.a);
   public static final List<apo.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<apo.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<ex> $$0) {
      ...
      for (apo.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<ex, ?>, apo.b>)(($$0x, $$1x) -> $$0x.then(
                           ey.a("insert")
                              .then(
   ...
   private static List<un> a(List<un> $$0, apo.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<ex, ?> a(BiConsumer<ArgumentBuilder<ex, ?>, apo.b> $$0) {
   ...
   private static List<un> a(CommandContext<ex> $$0, apo.c $$1) throws CommandSyntaxException {
      apn $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<un> b(CommandContext<ex> $$0, apo.c $$1) throws CommandSyntaxException {
      apn $$2 = $$1.a($$0);
      fp.g $$3 = fp.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<ex> $$0, apo.c $$1, apo.a $$2, List<un> $$3) throws CommandSyntaxException {
      apn $$4 = $$1.a($$0);
   ...
   private static int a(ex $$0, apn $$1, fp.g $$2) throws CommandSyntaxException {
      tq $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static un a(fp.g $$0, apn $$1) throws CommandSyntaxException {
   ...
   private static int b(ex $$0, apn $$1, fp.g $$2) throws CommandSyntaxException {
      un $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof ug) {
         $$4 = ayz.a(((ug)$$3).j());
   ...
   private static int a(ex $$0, apn $$1, fp.g $$2, double $$3) throws CommandSyntaxException {
      un $$4 = a($$2, $$1);
      if (!($$4 instanceof ug)) {
   ...
   private static int a(ex $$0, apn $$1) throws CommandSyntaxException {
      tq $$2 = $$1.a();
      $$0.a(() -> $$1.a((un)$$2), false);
      return 1;
   }

   private static int a(ex $$0, apn $$1, tq $$2) throws CommandSyntaxException {
      tq $$3 = $$1.a();
      if (fp.g.a($$2, 0)) {
         throw fp.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<ex, ?> create(apo.a var1);
   }

   public interface c {
      apn a(CommandContext<ex> var1) throws CommandSyntaxException;
