...
public class fgd {
   ...
   public static void a(File $$0, eyy $$1, Consumer<wu> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eyy $$2, Consumer<wu> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eyy $$2, Consumer<wu> $$3) {
      ezn $$4 = a($$2);
   ...
   public static ezn a(eyy $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ezn $$3 = new ezn($$1, $$2, false);
   ...
   public fgd(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
