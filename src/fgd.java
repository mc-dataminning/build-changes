...
public class fgd extends eyc<fgd.a> {
   ...
   private final ffz O;
   private final List<fgd.d> P = Lists.newArrayList();
   private final fgd.a Q = new fgd.b();
   private final List<fgd.c> R = Lists.newArrayList();

   public fgd(ffz $$0, evi $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.O = $$0;
   }
   ...
   public void a(foe $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.P.add(new fgd.d(this.O, $$0.a($$1)));
      }

      this.e();
   }

   public void a(List<gis> $$0) {
      int $$1 = $$0.size() - this.R.size();
      this.R.clear();

      for (gis $$2 : $$0) {
         this.R.add(new fgd.c(this.O, $$2));
      }

      this.e();

      for (int $$3 = this.R.size() - $$1; $$3 < this.R.size(); $$3++) {
         fgd.c $$4 = this.R.get($$3);
         int $$5 = $$3 - this.R.size() + this.l().size();
         int $$6 = this.g($$5);
         int $$7 = this.h($$5);
         if ($$7 >= this.C() && $$6 <= this.E()) {
            this.c.aW().b(vf.a("multiplayer.lan.server_found", $$4.c()));
         }
      }
   }
   ...
   public abstract static class a extends eyc.a<fgd.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fgd.a {
      private final evi a = evi.O();

      @Override
      public void a(ewu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fgd.H, this.a.y.g / 2 - this.a.h.a(fgd.H) / 2, $$10, 16777215, false);
         String $$11 = fcm.a(ac.b());
   ...
   public static class c extends fgd.a {
   ...
   public class d extends fgd.a {
      ...
      protected d(ffz $$1, fod $$2) {
         this.e = $$1;
         this.g = $$2;
         this.f = evi.O();
         this.h = fcg.b(this.f.Y(), $$2.b);
      }
      ...
      public void a(ewu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         List<aua> $$11 = this.f.h.c(this.g.d, $$4 - 32 - 2);
      ...
      protected void a(ewu $$0, int $$1, int $$2, ahg $$3) {
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fgd.E.error("Invalid icon for server {} ({})", new Object[]{this.g.a, this.g.b, var3});
               return false;
            }
         }
      ...
      public boolean a(int $$0, int $$1, int $$2) {
         if (fdb.t()) {
            ...
            if ($$0 == 264 && $$4 < this.e.H().c() - 1 || $$0 == 265 && $$4 > 0) {
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fgd.this.q();
         double $$4 = $$1 - (double)fgd.this.g(fgd.this.l().indexOf(this));
         if ($$3 <= 32.0) {
            ...
            if ($$3 < 16.0 && $$4 > 16.0 && $$5 < this.e.H().c() - 1) {
               this.a($$5, $$5 + 1);
               return true;
            }
         }
