...
public class fgd {
   ...
   @Nullable
   private String g;
   private static final fgd.a h = new fgd.a() {
      @Nullable
      @Override
      public fgc a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fgg.a(this.d, "Get capabilities")) {
         ...
         if (fgg.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fgg.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fgg.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fgc a(fgd.c $$0) {
      return ($$0 == fgd.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fgd.a {
      private final int a;
      private final Set<fgc> b = Sets.newIdentityHashSet();
      ...
      public fgc a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fgd.a.warn("Maximum sound pool size {} reached", this.a);
            }
