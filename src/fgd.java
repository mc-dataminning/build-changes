...
public abstract class fgd<T extends ckb> extends ffe implements fhi<T> {
   ...
   private coz J = coz.h;
   private long K;
   protected final Set<clw> v = Sets.newHashSet();
   protected boolean w;
   private int L;
   private int M;
   private boolean N;
   ...
   public void a(eyu $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      coz $$10 = this.F.b() ? this.p.g() : this.F;
      if (!$$10.b()) {
         int $$11 = 8;
         int $$12 = this.F.b() ? 8 : 16;
         String $$13 = null;
         if (!this.F.b() && this.E) {
            $$10 = $$10.c(awh.f((float)$$10.M() / 2.0F));
   ...
   protected List<vq> a(coz $$0) {
      return a(this.f, $$0);
   }

   private void a(eyu $$0, coz $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(eyu var1, float var2, int var3, int var4);

   protected void a(eyu $$0, clw $$1) {
      int $$2 = $$1.f;
      int $$3 = $$1.g;
      coz $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$1 == this.A && !this.F.b() && this.E && !$$4.b()) {
         ...
         if (ckb.a($$1, $$7, true) && this.p.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.g(), $$1.a_($$7));
            int $$10 = $$1.g().b() ? 0 : $$1.g().M();
            int $$11 = ckb.a(this.v, this.L, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if (!$$0.b() && this.w) {
         if (this.L == 2) {
            ...
            for (clw $$1 : this.v) {
               ...
               int $$5 = Math.min(ckb.a(this.v, this.L, $$0) + $$3, $$4);
               this.O -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private clw b(double $$0, double $$1) {
      for (int $$2 = 0; $$2 < this.p.i.size(); $$2++) {
         clw $$3 = this.p.i.get($$2);
         if (this.a($$3, $$0, $$1) && $$3.d()) {
            return $$3;
         }
      }
               ...
               if (this.f.m.W().c()) {
                  ...
                  if (this.p.g().b()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (eqv.a(exh.O().aM().i(), 340) || eqv.a(exh.O().aM().i(), 344));
                        ckk $$11 = ckk.a;
                        if ($$10) {
                           this.S = $$4 != null && $$4.h() ? $$4.g().q() : coz.h;
                           $$11 = ckk.b;
                        } else if ($$9 == -999) {
                           $$11 = ckk.e;
                        }
   ...
   private void a(int $$0) {
      if (this.r != null && this.p.g().b()) {
         if (this.f.m.F.a($$0)) {
            this.a(this.r, this.r.e, 40, ckk.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.f.m.U[$$1].a($$0)) {
               this.a(this.r, this.r.e, $$1, ckk.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.A != null && this.f.m.W().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.F.M() > 1 && $$5 != null && ckb.a($$5, this.F, false)) {
               long $$7 = ac.b();
               if (this.C == $$5) {
                  if ($$7 - this.K > 500L) {
                     this.a(this.A, this.A.e, 0, ckk.a);
                     this.a($$5, $$5.e, 1, ckk.a);
                     this.a(this.A, this.A.e, 0, ckk.a);
                     this.K = $$7 + 750L;
                     this.F.h(1);
                  }
      ...
      } else if (this.w && $$5 != null && !$$6.b() && ($$6.M() > this.v.size() || this.L == 2) && ckb.a($$5, $$6, true) && $$5.a($$6) && this.p.b($$5)) {
         this.v.add($$5);
         this.K();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.R && $$3 != null && $$2 == 0 && this.p.a(coz.h, $$3)) {
         if (v()) {
            if (!this.S.b()) {
               for (clw $$8 : this.p.i) {
                  if ($$8 != null && $$8.a(this.f.s) && $$8.h() && $$8.d == $$3.d && ckb.a($$8, this.S, true)) {
                     this.a($$8, $$8.e, $$2, ckk.b);
                  }
               }
            }
         } else {
         ...
         if (this.A != null && this.f.m.W().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = ckb.a($$3, this.F, false);
               if ($$7 != -1 && !this.F.b() && $$9) {
                  this.a(this.A, this.A.e, $$2, ckk.a);
                  this.a($$3, $$7, 0, ckk.a);
                  if (this.p.g().b()) {
                     this.J = coz.h;
                  } else {
                     this.a(this.A, this.A.e, $$2, ckk.a);
                     this.G = awh.a($$0 - (double)$$4);
                     this.H = awh.a($$1 - (double)$$5);
                     this.B = this.A;
                     this.J = this.F;
                     this.I = ac.b();
                  }
            ...
            this.a(null, -999, ckb.b(0, this.L), ckk.f);

            for (clw $$10 : this.v) {
               this.a($$10, $$10.e, ckb.b(1, this.L), ckk.f);
            }

            this.a(null, -999, ckb.b(2, this.L), ckk.f);
         } else if (!this.p.g().b()) {
            if (this.f.m.J.a($$2)) {
               this.a($$3, $$7, $$2, ckk.d);
            } else {
               boolean $$11 = $$7 != -999 && (eqv.a(exh.O().aM().i(), 340) || eqv.a(exh.O().aM().i(), 344));
               if ($$11) {
                  this.S = $$3 != null && $$3.h() ? $$3.g().q() : coz.h;
               }

               this.a($$3, $$7, $$2, $$11 ? ckk.b : ckk.a);
            }
         }
      }
   ...
   private boolean a(clw $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.r != null && this.r.h()) {
            if (this.f.m.J.a($$0, $$1)) {
               this.a(this.r, this.r.e, 0, ckk.d);
            } else if (this.f.m.G.a($$0, $$1)) {
               this.a(this.r, this.r.e, t() ? 1 : 0, ckk.e);
            }
         }
      ...
      if (this.p.g().b() && this.r != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.f.m.U[$$2].a($$0, $$1)) {
               this.a(this.r, this.r.e, $$2, ckk.c);
               return true;
            }
         }
      }
