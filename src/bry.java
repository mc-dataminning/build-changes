...
public abstract class bry<R extends Runnable> implements brf, bse<R>, Executor {
   ...
   @Override
   public List<brc> bw() {
      return ImmutableList.of(brc.a(this.b + "-pending-tasks", brb.b, this::by));
   }
