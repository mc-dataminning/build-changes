...
public class bry extends bsf {
   public static final MapCodec<bry> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  bsf.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bry a(bsf $$0, int $$1, int $$2) {
      return new bry($$0, $$1, $$2);
   }

   public bry(bsf $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Override
   public int a(bac $$0) {
      return azu.a(this.b.a($$0), this.f, this.g);
   }
