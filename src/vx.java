...
public class vx extends ByteBuf {
   ...
   public <T> T a(DynamicOps<va> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, um.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<va> $$0, Codec<T> $$1, um $$2) {
      va $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vx a(DynamicOps<va> $$0, Codec<T> $$1, T $$2) {
   ...
   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = axv.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yw<? super vx, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yx<? super vx, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yw<? super vx, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yw<? super vx, K> $$1, yw<? super vx, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yw<? super vx, K> $$0, yw<? super vx, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yx<? super vx, K> $$1, yx<? super vx, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yx<? super vx, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yw<? super vx, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yw<? super vx, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yw<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yx<? super vx, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yx<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static io b(ByteBuf $$0) {
      return io.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, io $$1) {
      $$0.writeLong($$1.a());
   }

   public dag f() {
      return new dag(this.readLong());
   }
   ...
   public eum k() {
      return new eum(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> vx a(ToIntFunction<T> $$0, T $$1) {
   ...
   public static void a(ByteBuf $$0, @Nullable va $$1) {
      ...
      try {
         uq.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ud f(ByteBuf $$0) {
      va $$1 = a($$0, um.a(2097152L));
      if ($$1 != null && !($$1 instanceof ud)) {
   ...
   @Nullable
   public static va a(ByteBuf $$0, um $$1) {
      try {
         va $$2 = uq.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return wn.a(this.d, $$0);
   }

   public vx a(String $$0) {
      return this.a($$0, 32767);
   }

   public vx a(String $$0, int $$1) {
      wn.a(this.d, $$0, $$1);
      return this;
   }

   public akn q() {
      return new akn(this.d(32767));
   }
   ...
   public <T> akm<T> a(akm<? extends jk<T>> $$0) {
      akn $$1 = this.q();
      return akm.a($$0, $$1);
   }
   ...
   public eui v() {
      io $$0 = this.e();
      it $$1 = this.b(it.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new eui(new eum((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ayf.e($$1, 8)));
      }
   }
   ...
   public vx a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vx a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vx a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vx a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vx a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vx a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vx a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vx a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public vx b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vx c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vx d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vx e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vx f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vx g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vx h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vx a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vx b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vx i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vx a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vx a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vx b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vx b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vx b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vx b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vx b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vx b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vx g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vx b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vx a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vx a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public vx a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vx a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vx a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public vx h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vx c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vx b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vx b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vx b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
