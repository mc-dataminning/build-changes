...
public class vx {
   public static <T extends vo> vx.b a(vq<T> $$0) {
      return a(new vm<T>($$0));
   }

   private static vx.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends vo> vx.d b(vq<T> $$0) {
      return a(new vn<T>($$0));
   }

   private static vx.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof yp)) {
            $$0.fireChannelRead($$1);
         } else {
