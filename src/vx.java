...
public class vx extends ByteBuf {
   ...
   public euk k() {
      return new euk(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> akl<T> a(akl<? extends jk<T>> $$0) {
      akm $$1 = this.q();
      return akl.a($$0, $$1);
   }
   ...
   public eug v() {
      ...
      return new eug(new euk((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ayd.e($$1, 8)));
      }
   }
