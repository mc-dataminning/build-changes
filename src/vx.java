...
public class vx extends SimpleChannelInboundHandler<zk<?>> {
   ...
   private static final wl<aiw> j = aiv.b;
   private final zl k;
   private volatile boolean l = true;
   private final Queue<Consumer<vx>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
   private SocketAddress o;
   @Nullable
   private volatile wj p;
   @Nullable
   private volatile wj q;
   @Nullable
   private vz r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xd.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof wq) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xd.c("disconnect.timeout"));
            } else {
               xd $$3 = xd.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wj $$4 = this.q;
               vz $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == zl.b) {
                     zk<?> $$7 = (zk<?>)(this.l ? new ajd($$3) : new zt($$3));
                     this.a($$7, wk.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zk<?> $$1) {
      if (this.n.isOpen()) {
         wj $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xd.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wj> void a(zk<T> $$0, wj $$1) {
      $$0.a((T)$$1);
   }

   private void b(wl<?> $$0, wj $$1) {
   ...
   public <T extends wj> void a(wl<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wj $$0) {
      ...
      } else if (this.k == zl.a && $$0.a() == zl.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public <S extends wp, C extends vu> void a(String $$0, int $$1, wl<S> $$2, wl<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ais.c : ais.b);
   }

   private <S extends wp, C extends vu> void a(String $$0, int $$1, wl<S> $$2, wl<C> $$3, C $$4, ais $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<vx>)($$6 -> {
            this.a($$3, $$4);
   ...
   public void a(zk<?> $$0, @Nullable wk $$1) {
      this.a($$0, $$1, true);
   }

   public void a(zk<?> $$0, @Nullable wk $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zk<?> $$0, @Nullable wk $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zk<?> $$0, @Nullable wk $$1, boolean $$2) {
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final vx $$2) {
   ...
   public static void a(ChannelPipeline $$0, zl $$1, boolean $$2, @Nullable vq $$3) {
      zl $$4 = $$1.a();
      boolean $$5 = $$1 == zl.a;
      boolean $$6 = $$4 == zl.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wh<aiw>(j) : new ws.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wi<aiw>(j) : new ws.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new we() : new wx());
   }

   private static ChannelInboundHandler a(@Nullable vq $$0, boolean $$1) {
      if (!$$1) {
         return new ww($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wc($$0) : new wd());
      }
   }

   public static void a(ChannelPipeline $$0, zl $$1) {
      a($$0, $$1, true, null);
   }

   public static vx a(SocketAddress $$0) {
      final vx $$1 = new vx(zl.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vs($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new vt($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof vv $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new vv($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof vw $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new vw($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof vv) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof vw) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wj $$0 = this.k();
            wj $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               vz $$2 = Objects.requireNonNullElseGet(this.l(), () -> new vz(xd.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
