...
public interface cua extends cta, cth, cun, cuy.a {
   @Nullable
   dll a(int var1, int var2, dlq var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(doy.a var1, int var2, int var3);

   int C_();

   cuy G_();

   default ih<cuw> t(hx $$0) {
      return this.G_().a($$0);
   }

   default Stream<djp> c(elx $$0) {
      int $$1 = aup.a($$0.a);
      int $$2 = aup.a($$0.d);
      int $$3 = aup.a($$0.b);
      int $$4 = aup.a($$0.e);
   ...
   @Override
   default int a(hx $$0, cti $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ih<cuw> getNoiseBiome(int $$0, int $$1, int $$2) {
      dll $$3 = this.a(is.e($$0), is.e($$2), dlq.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ih<cuw> a(int var1, int var2, int var3);
   ...
   default dll a(int $$0, int $$1) {
      return this.a($$0, $$1, dlq.n, true);
   }

   default dll a(int $$0, int $$1, dlq $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default ctd c(int $$0, int $$1) {
      return this.a($$0, $$1, dlq.c, false);
   }

   default boolean z(hx $$0) {
      return this.b_($$0).a(asn.a);
   }

   default boolean d(elx $$0) {
      int $$1 = aup.a($$0.a);
      int $$2 = aup.c($$0.d);
      int $$3 = aup.a($$0.b);
      int $$4 = aup.c($$0.e);
   ...
   default <T> ij<T> a(ahg<? extends it<? extends T>> $$0) {
      it<T> $$1 = this.I_().d($$0);
      return $$1.p().a(this.I());
   }
}
