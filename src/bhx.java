...
public class bhx extends bic {
   public static final Codec<bhx> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bhx a(float $$0, float $$1, int $$2, int $$3) {
      return new bhx($$0, $$1, $$2, $$3);
   }

   private bhx(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(ats $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)atm.a(atm.c($$0, $$1, $$2), $$3, $$4);
   }
