...
public class bhx extends bgr {
   public bhx(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bhv.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bjj.a($$0.get("id").asString("minecraft:air"));
