...
public class bky implements bkz {
   ...
   private static final bky k = new bky();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bkx $$0) {
      URL $$1 = bky.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bkx $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final blb a = new blb(() -> bky.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bky.this.l && $$0.getState() == RecordingState.STOPPED) {
