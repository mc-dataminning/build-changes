...
public class dpv {
   ...
   private final im e;
   private final ir f;
   private final List<im> g = Lists.newArrayList();
   private final List<im> h = Lists.newArrayList();
   private final ir i;

   public dpv(czu $$0, im $$1, ir $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dpy $$0 = this.b.a_(this.e);
      if (!dpr.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == elw.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dpy $$0) {
      return $$0.a(dcx.hV) || $$0.a(dcx.pg);
   }

   private static boolean a(dpy $$0, dpy $$1) {
      if ($$0.a(dcx.pg) && $$1.a(dcx.hV)) {
         return false;
      } else {
         return $$0.a(dcx.hV) && $$1.a(dcx.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(im $$0, ir $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dpr.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dpy $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dpr.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dpr.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
