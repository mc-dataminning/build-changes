...
public class dpv implements dpq {
   public static final Codec<dpv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jb.f.q().fieldOf("block").flatXmap(dpv::a, DataResult::success).orElse((cxj)csm.fg).forGetter($$0x -> $$0x.b),
   ...
   public final hi<csl> h;
   private final ObjectArrayList<ha> i;

   private static DataResult<cxj> a(csl $$0) {
      return $$0 instanceof cxj $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public dpv(cxj $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, hi<csl> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
