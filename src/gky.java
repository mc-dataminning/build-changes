...
public class gky {
   ...
   private static final List<gky.e> c = Lists.newArrayList(new gky.e[]{new gky.a(), new gky.b()});
   ...
   public static Vector4f a(fln $$0, float $$1, gfi $$2, int $$3, float $$4) {
      ety $$5 = $$0.k();
      bvj $$6 = $$0.g();
      float $$19;
      float $$20;
   ...
   @Nullable
   private static gky.e a(bvj $$0, float $$1) {
      return $$0 instanceof bwf $$2 ? c.stream().filter($$2x -> $$2x.a($$2, $$1)).findFirst().orElse(null) : null;
   }

   public static gkx a(fln $$0, gky.d $$1, Vector4f $$2, float $$3, boolean $$4, float $$5) {
      if (!g) {
         return gkx.a;
      } else {
         ety $$6 = $$0.k();
         ...
         if ($$6 == ety.a) {
            ...
            $$8.b = -8.0F;
            $$8.c = 96.0F;
            if ($$7 instanceof gkf $$12) {
               $$8.c = $$8.c * Math.max(0.25F, $$12.F());
               jq<dij> $$13 = $$12.dV().t($$12.dv());
               if ($$13.a(axt.aa)) {
                  $$8.c *= 0.85F;
               }
            }
         ...
         return new gkx($$8.b, $$8.c, $$8.d, $$2.x, $$2.y, $$2.z, $$2.w);
      }
   }

   static class a implements gky.e {
      @Override
      public jq<bum> a() {
         return buq.o;
      }
      ...
      @Override
      public void a(gky.c $$0, bwf $$1, buo $$2, float $$3, float $$4) {
   ...
   static class b implements gky.e {
      @Override
      public jq<bum> a() {
         return buq.G;
      }
   ...
   interface e {
      ...
      void a(gky.c var1, bwf var2, buo var3, float var4, float var5);
