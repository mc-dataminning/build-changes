...
public class gky extends gks<cfg, fvn<cfg>> {
   private static final Map<cfg.a, akk> a = ac.a(Maps.newEnumMap(cfg.a.class), $$0 -> {
      $$0.put(cfg.a.a, new akk("textures/entity/panda/panda.png"));
      $$0.put(cfg.a.b, new akk("textures/entity/panda/lazy_panda.png"));
      $$0.put(cfg.a.c, new akk("textures/entity/panda/worried_panda.png"));
      $$0.put(cfg.a.d, new akk("textures/entity/panda/playful_panda.png"));
      $$0.put(cfg.a.e, new akk("textures/entity/panda/brown_panda.png"));
      $$0.put(cfg.a.f, new akk("textures/entity/panda/weak_panda.png"));
      $$0.put(cfg.a.g, new akk("textures/entity/panda/aggressive_panda.png"));
   });

   public gky(gjm.a $$0) {
      super($$0, new fvn<>($$0.a(fxn.aF)), 0.9F);
      this.a(new gnu(this, $$0.d()));
   }

   public akk a(cfg $$0) {
      return a.getOrDefault($$0.gA(), a.get(cfg.a.a));
   }

   protected void a(cfg $$0, fam $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.cb > 0) {
         int $$6 = $$0.cb;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ayg.i($$25, $$0.dI(), $$0.dI() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(ayg.i($$27, $$0.dI(), $$0.dI() + 180.0F)));
      }
   }
