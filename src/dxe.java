...
public class dxe {
   ...
   private final Map<Character, Predicate<dxc>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dxe a(char $$0, Predicate<dxc> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dxd b() {
      return new dxd(this.c());
   }

   private Predicate<dxc>[][][] c() {
      this.d();
      Predicate<dxc>[][][] $$0 = (Predicate<dxc>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxc>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
