...
public class dxe {
   ...
   static class a implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
         return $$0.c[ha.f.d()] && !$$0.b[ha.f.d()].d;
      }

      @Override
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         $$1.d = true;
         $$1.b[ha.f.d()].d = true;
         return new dxe.k($$0, $$1);
      }
   }

   static class b implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         ...
         return new dxe.l($$0, $$1);
      }
   }

   static class c implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         $$1.d = true;
         $$1.b[ha.b.d()].d = true;
         return new dxe.m($$0, $$1);
      }
   }

   static class d implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         ...
         return new dxe.n($$0, $$1);
      }
   }

   static class e implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         ...
         $$3.d = true;
         $$3.b[ha.c.d()].d = true;
         return new dxe.o($$0, $$3);
      }
   }

   static class f implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
         return true;
      }
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         $$1.d = true;
         return new dxe.s($$0, $$1, $$2);
      }
   }

   static class g implements dxe.i {
      @Override
      public boolean a(dxe.v $$0) {
      ...
      public dxe.r a(ha $$0, dxe.v $$1, ash $$2) {
         $$1.d = true;
         return new dxe.t($$0, $$1);
      }
   }

   public static class h extends dxe.r {
      ...
      private dxe.v G;
      private dxe.v H;
      private final List<dxe.r> I = Lists.newArrayList();

      public h(ash $$0, int $$1, int $$2, ha $$3) {
         super(dvt.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxe.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxe.p($$3, this.G));
         this.I.add(new dxe.j($$3, this.H));
         List<dxe.i> $$5 = Lists.newArrayList();
         $$5.add(new dxe.b());
         $$5.add(new dxe.d());
         $$5.add(new dxe.e());
         $$5.add(new dxe.a());
         ...
         duu $$10 = duu.a(this.b(1, 1, 1), this.b(23, 8, 21));
         duu $$11 = duu.a(this.b(34, 1, 1), this.b(56, 8, 21));
         duu $$12 = duu.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxe.u($$3, $$10, $$13++));
         this.I.add(new dxe.u($$3, $$11, $$13++));
         this.I.add(new dxe.q($$3, $$12));
      }
      ...
      private List<dxe.v> b(ash $$0) {
         dxe.v[] $$1 = new dxe.v[75];
         ...
         dxe.v $$23 = new dxe.v(1003);
         dxe.v $$24 = new dxe.v(1001);
         dxe.v $$25 = new dxe.v(1002);
         $$1[v].a(ha.b, $$23);
         $$1[w].a(ha.d, $$24);
         $$1[x].a(ha.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dxe.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqv $$2, ash $$3, duu $$4) {
         int $$5 = 24;
      ...
      private void a(cqv $$0, ash $$1, duu $$2) {
      ...
      private void b(cqv $$0, ash $$1, duu $$2) {
      ...
      private void c(cqv $$0, ash $$1, duu $$2) {
      ...
      private void d(cqv $$0, ash $$1, duu $$2) {
      ...
      private void e(cqv $$0, ash $$1, duu $$2) {
      ...
      private void f(cqv $$0, ash $$1, duu $$2) {
   ...
   interface i {
      boolean a(dxe.v var1);

      dxe.r a(ha var1, dxe.v var2, ash var3);
   }

   public static class j extends dxe.r {
      public j(ha $$0, dxe.v $$1) {
         super(dvt.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqv $$0, cqt $$1, dha $$2, ash $$3, duu $$4, cpi $$5, gw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cte.ch.o(), cte.ch.o(), false);
   ...
   public static class k extends dxe.r {
      public k(ha $$0, dxe.v $$1) {
         super(dvt.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dxe.r {
      public l(ha $$0, dxe.v $$1) {
         super(dvt.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dxe.r {
      public m(ha $$0, dxe.v $$1) {
         super(dvt.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dxe.r {
      public n(ha $$0, dxe.v $$1) {
         super(dvt.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dxe.r {
      public o(ha $$0, dxe.v $$1) {
         super(dvt.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dxe.r {
      public p(ha $$0, dxe.v $$1) {
         super(dvt.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dxe.r {
      public q(ha $$0, duu $$1) {
         super(dvt.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvg {
      protected static final dfd b = cte.hZ.o();
      protected static final dfd c = cte.ia.o();
      protected static final dfd d = cte.ib.o();
      protected static final dfd h = c;
      protected static final dfd i = cte.ii.o();
      protected static final boolean j = true;
      protected static final dfd k = cte.G.o();
      protected static final Set<ctc> l = ImmutableSet.builder().add(cte.dO).add(cte.iC).add(cte.mW).add(k.b()).build();
      ...
      public r(dvt $$0, ha $$1, int $$2, duu $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvt $$0, int $$1, ha $$2, dxe.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static duu a(ha $$0, dxe.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         duu $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqv $$0, duu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dfd $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cqv $$0, duu $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqv $$0, duu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dfd $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(duu $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqv $$0, duu $$1, int $$2, int $$3, int $$4) {
         gw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            bzd $$6 = bja.A.a((cqb)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dl()), bjq.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dxe.r {
      private int a;

      public s(ha $$0, dxe.v $$1, ash $$2) {
         super(dvt.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(cqv $$0, cqt $$1, dha $$2, ash $$3, duu $$4, cpi $$5, gw $$6) {
         ...
         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ha.a.d()] && !this.B.c[ha.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends dxe.r {
      public t(ha $$0, dxe.v $$1) {
         super(dvt.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dxe.r {
      private int a;

      public u(ha $$0, duu $$1, int $$2) {
         super(dvt.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
