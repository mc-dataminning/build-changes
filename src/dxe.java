...
public class dxe {
   ...
   private final List<dxc> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dxe.a l = new dxe.d(5.999997E7F);
   public static final dxe.c d = new dxe.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(jh $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(ezr $$0) {
   ...
   public ezr c(double $$0, double $$1, double $$2) {
      return new ezr(azn.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azn.a($$2, this.f(), this.h() - 1.0E-5F));
   }

   public double a(bui $$0) {
      return this.b($$0.dD(), $$0.dJ());
   }
   ...
   public boolean a(bui $$0, ezm $$1) {
      double $$2 = Math.max(azn.a($$1.b(), $$1.d()), 1.0);
      return this.a($$0) < $$2 * 2.0 && this.a($$0.dD(), $$0.dJ(), $$2);
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dxe.a)($$0 == $$1 ? new dxe.d($$1) : new dxe.b($$0, $$1, $$2));
   ...
   public dxe.c t() {
      return new dxe.c(this);
   }

   public void a(dxe.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dxe.a {
      ...
      @Override
      public double a() {
         return azn.a(dxe.this.a() - this.e() / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
      }

      @Override
      public double c() {
         return azn.a(dxe.this.b() - this.e() / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azn.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dxd i() {
         return this.c < this.b ? dxd.b : dxd.a;
      }
      ...
      @Override
      public dxe.a l() {
         return (dxe.a)(this.g() <= 0L ? dxe.this.new d(this.c) : this);
      }
      ...
      public fal m() {
         return fai.a(
            fai.c,
            fai.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezv.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dxe.c a(DynamicLike<?> $$0, dxe.c $$1) {
         double $$2 = azn.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azn.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dxe.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dxe.a {
      ...
      private void n() {
         this.c = azn.a(dxe.this.a() - this.b / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
         this.d = azn.a(dxe.this.b() - this.b / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
         this.e = azn.a(dxe.this.a() + this.b / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
         this.f = azn.a(dxe.this.b() + this.b / 2.0, (double)(-dxe.this.k), (double)dxe.this.k);
         this.g = fai.a(
            fai.c,
            fai.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezv.e
