...
public class fzu {
   ...
   private fzu(int $$0, List<fzw> $$1) {
      this.a = $$1.toArray(fzw[]::new);
      this.b = $$1.size();
   }

   private List<fzw> c() {
      List<fzw> $$0 = new ArrayList<>(this.d());
