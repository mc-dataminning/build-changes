...
public class fzu implements fzx.a, AutoCloseable {
   ...
   eli[] f;
   @Nullable
   private final fzu.a g;
   private final aov h;

   public fzu(afw $$0, gbn $$1, eli $$2, aov $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gbl $$4 = $$3.a(gbl.a).orElse(gbl.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eli[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fzp.a(this.f, $$0);
   ...
   @Nullable
   private fzu.a a(gbn $$0, int $$1, int $$2, gbl $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fzu.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fzu.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fzu.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fzu.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fzu.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fzu.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eli[] $$4) {
   ...
   class a {
      ...
      a(List<fzu.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fzu.this.c;
         int $$4 = this.b($$2) * fzu.this.d;
         fzu.this.a($$0, $$1, $$3, $$4, fzu.this.f);
      }

      public fzw a() {
         return fzu.this.new d(this, this.d ? fzu.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eli[] b = new eli[fzu.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fzu.this.c >> $$0;
            int $$2 = fzu.this.d >> $$0;
            this.b[$$0] = new eli($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fzu.d $$2) {
         fzu.a $$3 = $$2.d;
         List<fzu.b> $$4 = $$3.b;
         fzu.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fzu.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fzu.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fzu.this.f[$$2].a($$3 + ($$0.a($$1) * fzu.this.c >> $$2), $$4 + ($$0.b($$1) * fzu.this.d >> $$2));
      }
   ...
   class d implements fzw {
      int b;
      int c;
      final fzu.a d;
      @Nullable
      private final fzu.c e;

      d(fzu.a $$0, @Nullable fzu.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
