...
public class dcs extends dcv {
   ...
   public void a(biq $$0, boolean $$1, int $$2) {
      if (this.l.size() < 3) {
         ...
         if (this.o != null) {
            ...
            gw $$5 = this.p();
            this.o.a(null, (double)$$5.u(), (double)$$5.v(), (double)$$5.w(), apd.bG, ape.e, 1.0F, 1.0F);
         ...
         if ($$10 && $$5 != dcs.b.c) {
            ...
            if ($$11 != null) {
               if (!$$11.ag().a(apv.c)) {
                  ...
                  $$0.a(null, $$1, apd.bH, ape.e, 1.0F, 1.0F);
   ...
   public static void a(cpv $$0, gw $$1, dfj $$2, dcs $$3) {
      ...
      if (!$$3.l.isEmpty() && $$0.D_().j() < 0.005) {
         ...
         $$0.a(null, $$4, $$5, $$6, apd.bJ, ape.e, 1.0F, 1.0F);
      }
