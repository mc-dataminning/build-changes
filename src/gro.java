...
public class gro {
   ...
   public static grh a(Vector3f $$0, Vector3f $$1, grj $$2, hix $$3, ja $$4, hln $$5, @Nullable grk $$6, boolean $$7, int $$8) {
      grl $$9 = $$2.d();
      if ($$5.b()) {
         $$9 = a($$2.d(), $$4, $$5.a());
      }
      ...
      return new grh($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static grl a(grl $$0, ja $$1, j $$2) {
      ...
      return new grl(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private static int[] a(grl $$0, hix $$1, ja $$2, float[] $$3, j $$4, @Nullable grk $$5) {
      int[] $$6 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, ja $$2, grl $$3, float[] $$4, hix $$5, j $$6, @Nullable grk $$7) {
      gpn.b $$8 = gpn.a($$2).a($$1);
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hix $$3, grl $$4) {
      int $$5 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable grk $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
