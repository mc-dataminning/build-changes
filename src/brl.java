...
public class brl implements bre {
   ...
   public static Set<brc> a() {
      Builder<brc> $$0 = ImmutableSet.builder();

      try {
         brl.a $$1 = new brl.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> brc.a("cpu#" + $$1x, brb.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(brc.a("heap MiB", brb.e, () -> (double)ac.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(brd.a.a());
      return $$0.build();
   }
   ...
   public static brc a(final LongSupplier $$0) {
      ...
      brc.d $$3 = new brc.d(2.0F);
      return brc.a("ticktime", brb.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
