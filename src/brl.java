...
public class brl {
   ...
   private final List<brj> d = Lists.newArrayList();
   private final btq e;
   private int f;
   private int g;
   private int h;
   ...
   private static boolean a(bro $$0) {
      return $$0.d() instanceof btq;
   }

   private xp a(bsv $$0, xp $$1, String $$2, String $$3) {
      cuq $$5 = $$0 instanceof btq $$4 ? $$4.eX() : cuq.l;
      return !$$5.e() && $$5.b(km.g) ? xp.a($$2, this.e.O_(), $$1, $$5.G()) : xp.a($$3, this.e.O_(), $$1);
   }

   private xp a(brj $$0, @Nullable bsv $$1) {
      bro $$2 = $$0.a();
      if (!$$2.a(awr.n) && !$$2.a(awr.t)) {
         ...
         brt $$3 = Objects.requireNonNullElse($$0.c(), brt.a);
         return xp.a($$3.a(), this.e.O_());
      }
   }

   @Nullable
   private static xp a(@Nullable bsv $$0) {
   ...
   public xp a() {
      if (this.d.isEmpty()) {
         ...
         brj $$0 = this.d.get(this.d.size() - 1);
         bro $$1 = $$0.a();
         brj $$2 = this.d();
         brs $$3 = $$1.j().e();
         if ($$3 == brs.b && $$2 != null) {
