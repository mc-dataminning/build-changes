...
public class brl extends brq {
   public static final MapCodec<brl> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static brl a(float $$0, float $$1, int $$2, int $$3) {
      return new brl($$0, $$1, $$2, $$3);
   }

   private brl(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
