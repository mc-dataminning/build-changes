...
public class fta extends ftw {
   private static final alz a = alz.b("icon/draft_report");
   private int b;
   private final xv c;
   private final boolean d;
   private xv s;
   private final List<fod> u = Lists.newArrayList();
   @Nullable
   private fod v;

   public fta(@Nullable xv $$0, boolean $$1) {
   ...
   protected void aT_() {
      ...
      this.u.add(this.c(fod.a($$0, $$0x -> {
         this.m.t.ge();
         $$0x.j = false;
      }).a(this.n / 2 - 100, this.o / 4 + 72, 200, 20).a()));
      this.v = this.c(
         fod.a(xv.c("deathScreen.titleScreen"), $$0x -> this.m.bb().a(this.m, this, this::l, true)).a(this.n / 2 - 100, this.o / 4 + 96, 200, 20).a()
      );
      this.u.add(this.v);
      this.c(false);
   ...
   private void E() {
      ...
      this.m.b(new fth(xv.c("menu.savingLevel")));
      this.m.a(new fty());
   }
   ...
   public void a(fnq $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.v != null && this.m.bb().c()) {
         $$0.a(glt::B, a, this.v.D() + this.v.y() - 17, this.v.E() + 3, 15, 15);
      }
   }
   ...
   static void a(fnq $$0, int $$1, int $$2) {
