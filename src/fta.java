...
public class fta extends aqm<fta.a> {
   ...
   protected fta.a a(aqh $$0, bgr $$1) {
      ...
      $$1.b();
      return new fta.a($$2, $$3, $$4);
   }

   protected void a(fta.a $$0, aqh $$1, bgr $$2) {
      this.c = $$0.a();
   }
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eot.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eot.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eot.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
