...
public abstract class bsn extends btx {
   private static final akj<Boolean> bY = akn.a(bsn.class, akl.k);
   ...
   protected bsn(bsz<? extends bsn> $$0, dbx $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bsn a(are var1, bsn var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof cou $$0 && !$$0.b((bst)this)) {
         this.ac();
      }
   }
