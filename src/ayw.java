...
public class ayw {
   ...
   public static final Codec<ayw.d> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ali.d($$0.substring(1)).map($$0x -> new ayw.d($$0x, true)) : ali.d($$0).map($$0x -> new ayw.d($$0x, false)), ayw.d::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> ban.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static <K, V> ayw.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayw.c<>($$0, $$1);
   }
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return ayw.a($$0, this.a::get, $$1::get);
      }

      public ayw.b<I, V> a(I $$0, V $$1) {
   ...
   public static record d(ali a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
