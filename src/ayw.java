...
public class ayw extends avv {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), ayw::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", ayw::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", ayw::k);
         $$0 = this.a($$0, "minecraft:fox", ayw::j);
         $$0 = this.a($$0, "minecraft:item", ayw::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", ayw::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", ayw::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", ayw::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", ayw::e);
         return this.a($$0, "minecraft:piglin", ayw::d);
      });
   }
