...
public interface ayw {
   ...
   static ayw codepoint(int $$0, yf $$1) {
      return $$2 -> $$2.accept(0, $$1, $$0);
   }

   static ayw forward(String $$0, yf $$1) {
      return $$0.isEmpty() ? a : $$2 -> baf.a($$0, $$1, $$2);
   }

   static ayw forward(String $$0, yf $$1, Int2IntFunction $$2) {
      return $$0.isEmpty() ? a : $$3 -> baf.a($$0, $$1, decorateOutput($$3, $$2));
   }

   static ayw backward(String $$0, yf $$1) {
      return $$0.isEmpty() ? a : $$2 -> baf.b($$0, $$1, $$2);
   }

   static ayw backward(String $$0, yf $$1, Int2IntFunction $$2) {
