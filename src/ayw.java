...
public class ayw {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axy.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axy.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayw.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? all.d($$0.substring(1)).map($$0x -> new ayw.c($$0x, true)) : all.d($$0).map($$0x -> new ayw.c($$0x, false)), ayw.c::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bak.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static Codec<String> C = Codec.STRING
      .validate($$0 -> !all.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayw.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
   ...
   public static record c(all a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
