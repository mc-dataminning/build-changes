...
public abstract class ayw extends DataFix {
   private final String a;

   public ayw(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(aym.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(aym.x);
      Type<Pair<String, String>> $$2 = DSL.named(aym.v.typeName(), azu.a());
      if (!Objects.equals(this.getOutputSchema().getType(aym.v), $$2)) {
