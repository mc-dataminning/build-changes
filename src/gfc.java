...
public class gfc implements AutoCloseable {
   private static final String a = "minecraft:main";
   private final ezv b;
   private final auh c;
   private final String d;
   private final List<gfd> e = Lists.newArrayList();
   private final Map<String, ezv> f = Maps.newHashMap();
   private final List<ezv> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public gfc(gqm $$0, auh $$1, ezv $$2, akr $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gqm $$0, akr $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(gqm $$0, JsonElement $$1) throws IOException {
   ...
   private void b(JsonElement $$0) throws aku {
      ...
      String $$2 = aye.i($$1, "name");
      faz $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
   ...
   public ezv a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      ezv $$3 = new ezw($$1, $$2, true, fgo.a);
   ...
   public gfd a(String $$0, ezv $$1, ezv $$2, boolean $$3) throws IOException {
      gfd $$4 = new gfd(this.c, $$0, $$1, $$2, $$3);
   ...
   @Nullable
   private ezv b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
