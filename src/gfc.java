...
public class gfc {
   private static final gfo a = gfo.t(new akt("textures/map/map_background.png"));
   private static final gfo b = gfo.t(new akt("textures/map/map_background_checkerboard.png"));
   ...
   private final fgj au;
   private cuh av = cuh.i;
   private cuh aw = cuh.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gko aB;
   private final glp aC;

   public gfc(fgj $$0, gko $$1, glp $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bso $$0, cuh $$1, cue $$2, boolean $$3, fbc $$4, gfg $$5, int $$6) {
      if (!$$1.d()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dU(), $$6, gqp.d, $$0.al() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = aym.a($$1, 0.0F, 1.0F);
      return -aym.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(fbc $$0, gfg $$1, int $$2, bsi $$3) {
      gqb $$4 = (gqb)this.aB.<gef>a(this.au.s);
      $$0.a();
   ...
   private void a(fbc $$0, gfg $$1, int $$2, float $$3, bsi $$4, float $$5, cuh $$6) {
      ...
      float $$8 = aym.c($$5);
      float $$9 = aym.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * aym.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * aym.a($$5 * (float) Math.PI);
   ...
   private void a(fbc $$0, gfg $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = aym.c($$5);
      float $$7 = -0.2F * aym.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * aym.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = aym.a($$6 * (float) Math.PI);
   ...
   private void a(fbc $$0, gfg $$1, int $$2, float $$3, float $$4, bsi $$5) {
      boolean $$6 = $$5 != bsi.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = aym.c($$4);
      float $$9 = -0.3F * aym.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * aym.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * aym.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = aym.a($$4 * $$4 * (float) Math.PI);
      float $$13 = aym.a($$8 * (float) Math.PI);
   ...
   private void a(fbc $$0, float $$1, bsi $$2, cuh $$3) {
      float $$4 = (float)this.au.s.fH() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.t();
      if ($$5 < 0.8F) {
         float $$6 = aym.e(aym.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(fbc $$0, float $$1, bsi $$2, cuh $$3, float $$4) {
      this.b($$0, $$2, $$4);
      float $$5 = (float)(this.au.s.fH() % 10);
      float $$6 = $$5 - $$1 + 1.0F;
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * aym.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bsi.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(fbc $$0, bsi $$1, float $$2) {
      int $$3 = $$1 == bsi.b ? 1 : -1;
      float $$4 = aym.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = aym.a(aym.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(fbc $$0, bsi $$1, float $$2) {
      int $$3 = $$1 == bsi.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fbc $$1, gfg.a $$2, gei $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bpz $$6 = (bpz)MoreObjects.firstNonNull($$3.aU, bpz.a);
      float $$7 = aym.i($$0, $$3.Q, $$3.dM());
      gfc.a $$8 = a($$3);
      float $$9 = aym.i($$0, $$3.cV, $$3.cT);
      float $$10 = aym.i($$0, $$3.cU, $$3.cS);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bpz.a ? $$5 : 0.0F;
         float $$12 = 1.0F - aym.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bpz.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bpz.b ? $$5 : 0.0F;
         float $$14 = 1.0F - aym.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bpz.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gfc.a a(gei $$0) {
      cuh $$1 = $$0.fg();
      cuh $$2 = $$0.fh();
      boolean $$3 = $$1.a(cuk.pK) || $$2.a(cuk.pK);
      boolean $$4 = $$1.a(cuk.xE) || $$2.a(cuk.xE);
      if (!$$3 && !$$4) {
         return gfc.a.a;
      } else if ($$0.fE()) {
         return b($$0);
      } else {
         return a($$1) ? gfc.a.b : gfc.a.a;
      }
   }

   private static gfc.a b(gei $$0) {
      cuh $$1 = $$0.fG();
      bpz $$2 = $$0.fF();
      if (!$$1.a(cuk.pK) && !$$1.a(cuk.xE)) {
         return $$2 == bpz.a && a($$0.fh()) ? gfc.a.b : gfc.a.a;
      } else {
         return gfc.a.a($$2);
      }
   }
   ...
   private static boolean a(cuh $$0) {
      return $$0.a(cuk.xE) && css.j($$0);
   }

   private void a(gef $$0, float $$1, float $$2, bpz $$3, float $$4, cuh $$5, float $$6, fbc $$7, gfg $$8, int $$9) {
      if (!$$0.gL()) {
         boolean $$10 = $$3 == bpz.a;
         bsi $$11 = $$10 ? $$0.fD() : $$0.fD().e();
         $$7.a();
         if ($$5.d()) {
            if ($$10 && !$$0.cm()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fE() && $$0.fH() > 0 && $$0.fF() == $$3) {
               ...
               float $$15 = (float)$$5.t() - ((float)this.au.s.fH() - $$1 + 1.0F);
               float $$16 = $$15 / (float)css.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = aym.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * aym.a(aym.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * aym.a(aym.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * aym.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cue.e : cue.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bsi.b;
            if ($$0.fE() && $$0.fH() > 0 && $$0.fF() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.u()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.t() - ((float)this.au.s.fH() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.t() - ((float)this.au.s.fH() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * aym.a(aym.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * aym.a(aym.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * aym.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cue.e : cue.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = aym.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = aym.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + aym.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + aym.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
