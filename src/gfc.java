...
public class gfc implements aju {
   ...
   private final AtomicReference<gfc.a> l = new AtomicReference<>(gfc.a.a);

   public gfc(wp $$0, flz $$1, @Nullable gfs $$2, @Nullable ftr $$3, boolean $$4, @Nullable Duration $$5, Consumer<xv> $$6, @Nullable gfw $$7) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(gfc.a $$0) {
      gfc.a $$1 = this.l.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(ajz $$0) {
      ...
      this.f
         .a(
            acg.d,
            new gfb(this.b, this.f, new gfi($$1, this.b.u().a(this.g, this.h, this.i), gfg.a().a(), csq.i, null, this.c, this.d, this.j, null, Map.of(), amr.a))
         );
      this.f.a(akg.a);
      this.f.a(acg.b);
   ...
   static enum a {
      ...
      private a(final xv $$0, final Set<gfc.a> $$1) {
         this.e = $$0;
         this.f = $$1;
      }
   }
