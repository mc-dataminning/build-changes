public class gfc extends ggp {
   private final double a;
   private final double b;
   private final double F;
   private final boolean G;
   private final gfp.a H;

   gfc(gci $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, false, gfp.a.a);
   }

   gfc(gci $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, boolean $$7, gfp.a $$8) {
      super($$0, $$1, $$2, $$3);
      this.G = $$7;
      this.H = $$8;
      this.e($$8.b());
   ...
   public static class c implements gfs<lv> {
      ...
      public gfp a(lv $$0, gci $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gfc $$8 = new gfc($$1, $$2, $$3, $$4, $$5, $$6, $$7, true, new gfp.a(0.0F, 0.6F, 0.25F, 1.0F));
         $$8.d(1.5F);
         $$8.a(this.a);
         return $$8;
      }
