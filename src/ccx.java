...
public class ccx {
   ...
   private int g = atm.b(ats.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(iv.a.fieldOf("uuid").forGetter(Pair::getFirst), asu.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bkq> j;
   @VisibleForTesting
   protected final ArrayList<bkq> c;
   private final ccx.a k;
   @VisibleForTesting
   protected final Object2IntMap<bkq> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<ccx> a(Predicate<bkq> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(ccx::b)).apply($$1, $$1x -> new ccx($$0, $$1x))
      );
   }

   public ccx(Predicate<bkq> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new ccx.a(this);
   ...
   public void a(ame $$0, Predicate<bkq> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bkq>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bkq> $$6 = (Entry<bkq>)$$5.next();
         int $$7 = $$6.getIntValue();
         bkq $$8 = (bkq)$$6.getKey();
         bkq.c $$9 = $$8.dJ();
   ...
   public int b(@Nullable bkq $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<blg> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof blg).map($$0 -> (blg)$$0);
   }

   @VisibleForTesting
   protected static record a(ccx a) implements Comparator<bkq> {
      public int a(bkq $$0, bkq $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cdu;
               boolean $$7 = $$1 instanceof cdu;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
