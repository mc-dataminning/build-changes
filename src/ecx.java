...
public record ecx(eda j, dwx k, dwx l, ecy m, edj.o n, List<dht.d> o, int p, boolean q, boolean r, boolean s, boolean t) {
   ...
   public static final Codec<jr<ecx>> b = akr.a(mc.aR, a);
   public static final aku<ecx> c = aku.a(mc.aR, akv.b("overworld"));
   public static final aku<ecx> d = aku.a(mc.aR, akv.b("large_biomes"));
   public static final aku<ecx> e = aku.a(mc.aR, akv.b("amplified"));
   public static final aku<ecx> f = aku.a(mc.aR, akv.b("nether"));
   public static final aku<ecx> g = aku.a(mc.aR, akv.b("end"));
   public static final aku<ecx> h = aku.a(mc.aR, akv.b("caves"));
   public static final aku<ecx> i = aku.a(mc.aR, akv.b("floating_islands"));
