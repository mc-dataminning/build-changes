...
public class biq extends bgn {
   private static final Logger a = LogUtils.getLogger();

   public biq(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bhs.s, "minecraft:trial_spawner");
   }

   public Dynamic<?> a(Dynamic<vg> $$0) {
      Optional<Dynamic<vg>> $$1 = $$0.get("normal_config").result();
      if ($$1.isEmpty()) {
         return $$0;
      } else {
         Optional<Dynamic<vg>> $$2 = $$0.get("ominous_config").result();
         if ($$2.isEmpty()) {
            return $$0;
         } else {
            alh $$3 = biq.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(ux.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<vg>, Dynamic<vg>>, alh> a = new HashMap<>();

      private a() {
      }

      private static void a(alh $$0, String $$1, String $$2) {
         try {
            uj $$3 = a($$1);
            uj $$4 = a($$2);
            uj $$5 = $$3.i().a($$4);
      ...
      private static Dynamic<vg> a(uj $$0) {
         return new Dynamic(ux.a, $$0);
      }

      private static uj a(String $$0) {
         try {
            return vh.a($$0);
      ...
      static {
         ...
         a(
            alh.b("trial_chamber/melee/husk"),
         ...
         a(
            alh.b("trial_chamber/melee/spider"),
         ...
         a(
            alh.b("trial_chamber/melee/zombie"),
         ...
         a(
            alh.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            alh.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            alh.b("trial_chamber/ranged/stray"),
         ...
         a(
            alh.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            alh.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            alh.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            alh.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            alh.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            alh.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            alh.b("trial_chamber/small_melee/slime"),
