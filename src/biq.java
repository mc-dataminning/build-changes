...
public class biq extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bjd.y);
      Type<?> $$1 = this.getOutputSchema().getType(bjd.y);
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bky.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bky.a($$1.substring(0, $$2))));
   ...
   private <T> Dynamic<T> g(Dynamic<T> $$0, String $$1) {
      try {
         ...
         $$2.expect(' ');
         int $$6 = $$2.readInt();
         Dynamic<T> $$7 = $$0.createIntList(IntStream.of(azq.d($$3), azq.d($$4), azq.d($$5)));
