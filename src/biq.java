...
public class biq implements bir {
   ...
   private static final biq j = new biq();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bip $$0) {
      URL $$1 = biq.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bip $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bit a = new bit(() -> biq.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == biq.this.k && $$0.getState() == RecordingState.STOPPED) {
