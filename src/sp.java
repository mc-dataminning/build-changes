...
public class sp extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<rr> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, rh.a);
   }

   @Deprecated
   public <T> T a(DynamicOps<rr> $$0, Codec<T> $$1, rh $$2) {
      rr $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> sp a(DynamicOps<rr> $$0, Codec<T> $$1, T $$2) {
      rr $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = aro.a(h, this.r(), JsonElement.class);
   ...
   public <T> void a(hl<hg<T>> $$0, hg<T> $$1, sp.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> hg<T> a(hl<hg<T>> $$0, sp.a<T> $$1) {
      int $$2 = this.m();
      if ($$2 == 0) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, sp.a<T> $$1) {
      int $$2 = this.m();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, sp.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, sp.a<K> $$1, sp.a<V> $$2) {
      int $$3 = this.m();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(sp.a<K> $$0, sp.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, sp.b<K> $$1, sp.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, sp.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, sp.b<L> $$1, sp.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(sp.a<L> $$0, sp.a<R> $$1) {
   ...
   public <T> sp a(ToIntFunction<T> $$0, T $$1) {
   ...
   public sp a(@Nullable rr $$0) {
      if ($$0 == null) {
         $$0 = ra.b;
      }

      try {
         ri.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   public rr a(rh $$0) {
      try {
         rr $$1 = ri.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return tc.a(this.d, $$0);
   }

   public sp a(String $$0) {
      return this.a($$0, 32767);
   }

   public sp a(String $$0, int $$1) {
      tc.a(this.d, $$0, $$1);
      return this;
   }

   public aex s() {
      return new aex(this.d(32767));
   }
   ...
   public <T> aew<T> a(aew<? extends ht<T>> $$0) {
      aex $$1 = this.s();
      return aew.a($$0, $$1);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, arx.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), sp::a);
   }

   public Property B() {
      String $$0 = this.r();
      String $$1 = this.r();
      String $$2 = this.c(sp::r);
   ...
   public sp a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sp a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public sp a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sp a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sp a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sp a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sp a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public sp a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public sp b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public sp c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public sp d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public sp e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public sp f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public sp g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public sp h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public sp a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public sp b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public sp i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public sp a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public sp a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public sp b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sp b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public sp b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sp b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sp b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sp b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public sp a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sp a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public sp a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sp a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public sp a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sp a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public sp a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public sp b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public sp b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public sp b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sp b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public sp b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
   ...
   @FunctionalInterface
   public interface a<T> extends Function<sp, T> {
      default sp.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<sp, T> {
      default sp.b<Optional<T>> asOptional() {
