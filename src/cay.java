...
public class cay extends bzi implements dkc {
   ...
   private static final aee<Integer> cd = aeh.a(cay.class, aeg.b);
   ...
   public boolean b(bho $$0) {
      return this.gh() && !$$0.a(apu.d) ? true : super.b($$0);
   }
   ...
   protected void b(gw $$0, dfj $$1) {
      this.a(apd.zN, 10.0F, 1.0F);
   }

   @Override
   public boolean C(biq $$0) {
      this.dL().a(this, (byte)4);
      this.a(apd.zy, 10.0F, this.eW());
      bow.a(this, 40);
      return super.C($$0);
   }
   ...
   public void l() {
      ...
      if (this.dL().w_()) {
         if (this.ah % this.gl() == 0) {
            this.cu = 10;
            if (!this.aS()) {
               this.dL().a(this.dq(), this.ds(), this.dw(), apd.zC, this.da(), 5.0F, this.eW(), false);
            }
         }
   ...
   private int gl() {
      ...
      return 40 - arw.d(arw.a($$0, 0.0F, 1.0F) * 30.0F);
   }

   public float E(float $$0) {
      return arw.i($$0, (float)this.ct, (float)this.cs) / 10.0F;
   }

   public float F(float $$0) {
      return arw.i($$0, (float)this.cv, (float)this.cu) / 10.0F;
   }
   ...
   private void a(bim $$0) {
      if ((float)$$0.b() < 4500.0F) {
         ...
         if ($$2.l() != cza.a) {
            for (int $$3 = 0; $$3 < 30; $$3++) {
               double $$4 = this.dq() + (double)arw.b($$1, -0.7F, 0.7F);
               double $$5 = this.ds();
               double $$6 = this.dw() + (double)arw.b($$1, -0.7F, 0.7F);
   ...
   public static void a(akq $$0, ehn $$1, @Nullable biq $$2, int $$3) {
   ...
   class a implements dkc.d {
      ...
      public void a(akq $$0, gw $$1, djt $$2, @Nullable biq $$3, @Nullable biq $$4, float $$5) {
         if (!cay.this.ev()) {
            ...
            cay.this.a(apd.zO, 5.0F, cay.this.eW());
            gw $$6 = $$1;
            if ($$4 != null) {
