...
public record dk(@Nullable Float c, @Nullable Float d) {
   ...
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vs.c("argument.range.ints"));

   public static dk a(float $$0) {
      return new dk($$0, $$0);
   }

   public static dk a(float $$0, float $$1) {
      return new dk($$0, $$1);
   }

   public static dk b(float $$0) {
      return new dk($$0, null);
   }

   public static dk c(float $$0) {
      return new dk(null, $$0);
   }
   ...
   public static dk a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         ...
         float $$1 = awc.e($$0, "value");
         return new dk($$1, $$1);
      } else {
         JsonObject $$2 = awc.m($$0, "value");
         Float $$3 = $$2.has("min") ? awc.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? awc.m($$2, "max") : null;
         return new dk($$3, $$4);
      }
   }

   public static dk a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static dk a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
