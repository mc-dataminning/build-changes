...
public class ddi {
   ...
   private final ddi.a e;
   private final long f;

   public ddi(ddi.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public ddi a(ddi.a $$0) {
      return new ddi($$0, this.f);
   }

   public jj<ddg> a(ja $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jj<ddg> a(double $$0, double $$1, double $$2) {
      int $$3 = ju.a(ayg.a($$0));
      int $$4 = ju.a(ayg.a($$1));
      int $$5 = ju.a(ayg.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      jj<ddg> getNoiseBiome(int var1, int var2, int var3);
   }
}
