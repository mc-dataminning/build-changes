...
public class ddi {
   public static <T> List<ddi.b> a(List<T> $$0, Function<T, List<jm<ehp>>> $$1, boolean $$2) {
      Object2IntMap<ehp> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, ehp c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jm<ehp>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ji<ehp> $$12 : $$10.get($$11)) {
               ehp $$13 = $$12.a();
      ...
      Builder<ddi.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<ehp> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddi.b($$28));
      }
   ...
   public static record b(List<ehp> a, ToIntFunction<ehp> b) {
      b(List<ehp> $$0) {
         this($$0, ac.h($$0));
      }
   }
