...
public class hhf {
   ...
   public static Object2IntMap<dwx> a(fml $$0, hgu.c $$1) {
      Map<djm, List<dxz<?>>> $$2 = new HashMap<>();
      Map<hhf.a, Set<dwx>> $$3 = new HashMap<>();
      $$1.c().forEach(($$3x, $$4x) -> {
         List<dxz<?>> $$5x = $$2.computeIfAbsent($$4x.a().b(), $$1xx -> List.copyOf($$0.a($$1xx)));
         hhf.a $$6x = hhf.a.a($$4x.a(), $$4x.b(), $$5x);
   ...
   static record a(Object a, List<Object> b) {
      public static hhf.a a(dwx $$0, gns $$1, List<dxz<?>> $$2) {
         List<Object> $$3 = a($$0, $$2);
         Object $$4 = $$1.a($$0);
         return new hhf.a($$4, $$3);
      }
