...
public final class nz {
   ...
   private static final Comparator<dth.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dth.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dth.a::toString).collect(Collectors.joining(","));
   }
