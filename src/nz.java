...
public final class nz {
   ...
   private static final Comparator<dtf.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dtf.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dtf.a::toString).collect(Collectors.joining(","));
   }
