...
public final class nz {
   ...
   private static final Comparator<dtg.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dtg.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dtg.a::toString).collect(Collectors.joining(","));
   }
