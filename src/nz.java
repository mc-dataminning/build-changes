...
public class nz {
   ...
   public akm a(ddy $$0, BiConsumer<akm, Supplier<JsonElement>> $$1) {
      return this.B.a($$0, this.A, $$1);
   }

   public akm a(ddy $$0, String $$1, BiConsumer<akm, Supplier<JsonElement>> $$2) {
      return this.B.a($$0, $$1, this.A, $$2);
   }

   private static nz.a a(Function<ddy, nx> $$0, nv $$1) {
      return $$2 -> new nz($$0.apply($$2), $$1);
   }

   public static nz a(akm $$0) {
   ...
   public interface a {
      ...
      default akm create(ddy $$0, BiConsumer<akm, Supplier<JsonElement>> $$1) {
         return this.get($$0).a($$0, $$1);
      }

      default akm createWithSuffix(ddy $$0, String $$1, BiConsumer<akm, Supplier<JsonElement>> $$2) {
