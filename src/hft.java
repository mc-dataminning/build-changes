...
public class hft {
   ...
   public static class a extends Thread {
      private final hft.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hft.b $$0) throws IOException {
         super("LanServerDetector #" + hft.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hft.b));
   ...
   public static class b {
      private final List<hfs> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hfs> a() {
         if (this.b) {
            List<hfs> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
