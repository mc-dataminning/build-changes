...
public class fhi {
   ...
   private static final Queue<fhi.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fhi.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fhi::a), fhf::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fhi::a), fhf::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fhi.a(this.b) + ", type=" + fhi.b(this.c) + ", severity=" + fhi.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
