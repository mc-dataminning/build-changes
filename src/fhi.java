...
public abstract class fhi extends fgh {
   private final dku b;
   private dkv c;
   ...
   public fhi(dku $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, vs.c("sign.edit"));
   }

   public fhi(dku $$0, boolean $$1, boolean $$2, vs $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = dge.a($$0.n().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(vs::getString).toArray(String[]::new);
   }

   @Override
   protected void aP_() {
      this.c(fak.a(vr.d, $$0 -> this.H()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new fdd(() -> this.k[this.n], this::a, fdd.a(this.f), fdd.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.c());
   }
   ...
   private boolean E() {
      return this.f != null && this.f.s != null && !this.b.o() && !this.b.b(this.f.s.ct());
   }
   ...
   public void k() {
      frb $$0 = this.f.K();
      if ($$0 != null) {
         $$0.b(new agn(this.b.aD_(), this.l, this.k[0], this.k[1], this.k[2], this.k[3]));
      }
   }
   ...
   protected abstract void a(ezx var1, dme var2);
   ...
   private void d(ezx $$0) {
      ...
      Vector3f $$1 = this.o();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fze.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(fwy.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
