...
public class fhi extends fgx implements fic {
   private static final fim d = new fim(new alb("widget/text_field"), new alb("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayg> D = ($$0x, $$1x) -> ayg.forward($$0x, yi.a);
   @Nullable
   private xl E;
   private long F = ac.c();

   public fhi(fgk $$0, int $$1, int $$2, xl $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fhi(fgk $$0, int $$1, int $$2, int $$3, int $$4, xl $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fhi(fgk $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fhi $$5, xl $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, ayg> $$0) {
      this.D = $$0;
   }
   ...
   protected xz aL_() {
      xl $$0 = this.y();
      return xl.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = ayu.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayu.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fmy.s());
   }
   ...
   public void b(fgm $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = ayu.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gdr.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = ayu.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayu.a(this.v, 0, this.p.length());
      }
   }
