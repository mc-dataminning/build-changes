...
public class gkh extends gkd {
   private fbx h = fbx.c;
   private int i;

   public gkh(gfj $$0, GameProfile $$1) {
      super($$0, $$1);
      this.ad = true;
   }
   ...
   public void d_() {
      ...
      if (this.i > 0) {
         this.i(new fbx((this.h.d - this.dz().d) / (double)this.i, (this.h.e - this.dz().e) / (double)this.i, (this.h.f - this.dz().f) / (double)this.i));
         this.i--;
      }
