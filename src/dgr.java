...
public class dgr {
   ...
   private final List<dgp> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dgr.a l = new dgr.d(5.999997E7F);
   public static final dgr.c e = new dgr.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public gu b(double $$0, double $$1, double $$2) {
      return gu.a(arp.a($$0, this.e(), this.g()), $$1, arp.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bii $$0, egz $$1) {
      double $$2 = Math.max(arp.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dgr.a)($$0 == $$1 ? new dgr.d($$1) : new dgr.b($$0, $$1, $$2));
   ...
   public dgr.c t() {
      return new dgr.c(this);
   }

   public void a(dgr.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dgr.a {
      ...
      @Override
      public double a() {
         return arp.a(dgr.this.a() - this.e() / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
      }

      @Override
      public double c() {
         return arp.a(dgr.this.b() - this.e() / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? arp.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dgq i() {
         return this.c < this.b ? dgq.b : dgq.a;
      }
      ...
      @Override
      public dgr.a l() {
         return (dgr.a)(this.g() <= 0L ? dgr.this.new d(this.c) : this);
      }
      ...
      public ehx m() {
         return ehu.a(
            ehu.c,
            ehu.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehi.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dgr.c a(DynamicLike<?> $$0, dgr.c $$1) {
         double $$2 = arp.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = arp.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dgr.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dgr.a {
      ...
      private void n() {
         this.c = arp.a(dgr.this.a() - this.b / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
         this.d = arp.a(dgr.this.b() - this.b / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
         this.e = arp.a(dgr.this.a() + this.b / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
         this.f = arp.a(dgr.this.b() + this.b / 2.0, (double)(-dgr.this.k), (double)dgr.this.k);
         this.g = ehu.a(
            ehu.c,
            ehu.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehi.e
