...
public class bfo extends DataFix {
   ...
   public bfo(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bfa.F);
      Type<?> $$1 = this.getInputSchema().getType(bfa.F);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bgk.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bfa.g);
      Type<?> $$1 = this.getInputSchema().getType(bfa.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bgk.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
