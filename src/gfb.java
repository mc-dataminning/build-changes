...
public class gfb extends dzn {
   ...
   public gfb(gff $$0, int $$1) {
      this.e = $$0;
      this.b = new dzp($$0, new dgf(0, 0), $$0.K_().e(mb.aI).b(dii.b));
      this.c = new etf(this, true, $$0.G_().g());
      this.d = new gfb.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dzt $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dgf $$3 = $$0.f();
   ...
   @Nullable
   public dzt b(int $$0, int $$1, eak $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dzt $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dzt a(int $$0, int $$1, wh $$2, um $$3, Consumer<ads.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dzt $$6 = this.d.b.get($$5);
         dgf $$7 = new dgf($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dzt(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dzt> b;
      ...
      void a(int $$0, @Nullable dzt $$1) {
         dzt $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gfb.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dzt $$5 = gfb.this.d.b.get(gfb.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dgf $$6 = $$5.f();
            ...
            gfb.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
