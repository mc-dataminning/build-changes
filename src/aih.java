...
public class aih {
   ...
   private static int a(du $$0, Collection<? extends bkq> $$1, ib<cpu> $$2, int $$3) throws CommandSyntaxException {
      cpu $$4 = $$2.a();
      if ($$3 > $$4.a()) {
         ...
         for (bkq $$6 : $$1) {
            if ($$6 instanceof blg) {
               ...
               clj $$8 = $$7.eU();
               if (!$$8.b()) {
                  if ($$4.a($$8) && cpw.a(cpw.a($$8).keySet(), $$4)) {
                     $$8.a($$4, $$3);
                     $$5++;
                  } else if ($$1.size() == 1) {
         ...
         if ($$5 == 0) {
            ...
            if ($$1.size() == 1) {
               $$0.a(() -> ur.a("commands.enchant.success.single", $$4.d($$3), $$1.iterator().next().P_()), true);
            } else {
