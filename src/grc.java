...
public class grc {
   ...
   @Nullable
   private grk h;
   private final AtomicReference<grc.b> i = new AtomicReference<>();
   private final AtomicReference<grc.a> j = new AtomicReference<>();
   ...
   public void a(guf $$0, List<gub.b> $$1, List<gub.b> $$2) {
   ...
   public void a(boolean $$0, fow $$1, guf $$2, List<gub.b> $$3, LongOpenHashSet $$4) {
      fex $$5 = $$1.b();
   ...
   private void a(boolean $$0, fow $$1, fex $$2, LongOpenHashSet $$3) {
      this.f = false;
      LongOpenHashSet $$4 = $$3.clone();
      this.g = CompletableFuture.runAsync(() -> {
         grc.b $$4x = new grc.b(this.h);
         this.j.set($$4x.b);
         Queue<grc.d> $$5 = Queues.newArrayDeque();
         this.a($$1, $$5);
   ...
   private void a(boolean $$0, guf $$1, List<gub.b> $$2, fex $$3, LongOpenHashSet $$4) {
      grc.b $$5 = this.i.get();
      this.a($$5);
      if (!$$5.b.b.isEmpty()) {
         Queue<grc.d> $$6 = Queues.newArrayDeque();
   ...
   private void a(grc.b $$0) {
      LongIterator $$1 = $$0.b.a.iterator();

      while ($$1.hasNext()) {
         long $$2 = $$1.nextLong();
         List<gub.b> $$3 = (List<gub.b>)$$0.a.c.get($$2);
         if ($$3 != null && $$3.get(0).a()) {
            $$0.b.b.addAll($$3);
            $$0.a.c.remove($$2);
         }
   ...
   private void a(grc.a $$0, dio $$1) {
      $$0.a.add(dio.c($$1.h - 1, $$1.i));
      $$0.a.add(dio.c($$1.h, $$1.i - 1));
      $$0.a.add(dio.c($$1.h + 1, $$1.i));
      $$0.a.add(dio.c($$1.h, $$1.i + 1));
      $$0.a.add(dio.c($$1.h - 1, $$1.i - 1));
      $$0.a.add(dio.c($$1.h - 1, $$1.i + 1));
      $$0.a.add(dio.c($$1.h + 1, $$1.i - 1));
      $$0.a.add(dio.c($$1.h + 1, $$1.i + 1));
   }

   private void a(fow $$0, Queue<grc.d> $$1) {
      iv $$2 = $$0.c();
      long $$3 = jy.c($$2);
      int $$4 = jy.c($$3);
      gub.b $$5 = this.h.a($$3);
      if ($$5 == null) {
         ...
         int $$8 = $$7 ? $$6.aq() : $$6.ar();
         int $$9 = this.h.b();
         List<grc.d> $$10 = Lists.newArrayList();
         int $$11 = jy.b($$3);
         int $$12 = jy.d($$3);

         for (int $$13 = -$$9; $$13 <= $$9; $$13++) {
            for (int $$14 = -$$9; $$14 <= $$9; $$14++) {
               gub.b $$15 = this.h.a(jy.b($$13 + $$11, $$8, $$14 + $$12));
               if ($$15 != null && this.a($$3, $$15.g())) {
                  jb $$16 = $$7 ? jb.b : jb.a;
                  grc.d $$17 = new grc.d($$15, $$16, 0);
                  $$17.a($$17.d, $$16);
                  if ($$13 > 0) {
                     $$17.a($$17.d, jb.f);
                  } else if ($$13 < 0) {
         ...
         $$1.add(new grc.d($$5, null, 0));
      }
   }

   private void a(grc.c $$0, fex $$1, Queue<grc.d> $$2, boolean $$3, Consumer<gub.b> $$4, LongOpenHashSet $$5) {
      jy $$6 = jy.a($$1);
      long $$7 = $$6.s();
      iv $$8 = $$6.k();
      ...
      while (!$$2.isEmpty()) {
         ...
         if (!$$5.contains($$9.a.g())) {
            ...
            $$9.a.c.compareAndSet(gub.a.a, gub.a.b);
         }
            ...
            if ($$14 != null && (!$$3 || !$$9.a($$13.g()))) {
               ...
               if ($$3 && $$12) {
                  ...
                  while ($$24.distanceSquared($$1.d, $$1.e, $$1.f) > 3600.0) {
                     ...
                     gub.b $$28 = this.h.a(iv.a($$24.x, $$24.y, $$24.z));
               ...
               if ($$29 != null) {
                  ...
                  grc.d $$30 = new grc.d($$14, $$13, $$9.b + 1);
                  $$30.a($$9.d, $$13);
                  if ($$14.a()) {
                     $$2.add($$30);
                     $$0.a.a($$14, $$30);
   ...
   @Nullable
   private gub.b a(long $$0, gub.b $$1, jb $$2) {
      long $$3 = $$1.a($$2);
      if (!this.a($$0, $$3)) {
         return null;
      } else {
   ...
   static record a(LongSet a, BlockingQueue<gub.b> b) {
   ...
   static record b(grc.c a, grc.a b) {

      b(grk $$0) {
         this(new grc.c($$0), new grc.a());
      }
   }

   static class c {
      public final grc.e a;
      public final gqn b;
      public final Long2ObjectMap<List<gub.b>> c;

      public c(grk $$0) {
         this.a = new grc.e($$0.f.length);
         this.b = new gqn($$0.d(), $$0.b(), $$0.c, $$0.b.G_());
   ...
   public static class d {
      @bav
      protected final gub.b a;
      private byte c;
      byte d;
      @bav
      public final int b;

      d(gub.b $$0, @Nullable jb $$1, int $$2) {
         this.a = $$0;
         if ($$1 != null) {
            this.b($$1);
         }
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof grc.d $$1) ? false : this.a.g() == $$1.a.g();
      }
   }

   static class e {
      private final grc.d[] a;

      e(int $$0) {
         this.a = new grc.d[$$0];
      }

      public void a(gub.b $$0, grc.d $$1) {
         this.a[$$0.b] = $$1;
      }

      @Nullable
      public grc.d a(gub.b $$0) {
         int $$1 = $$0.b;
