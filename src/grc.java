...
public class grc implements asv<grb> {
   public grb b(JsonObject $$0) {
      Builder<gra> $$1 = ImmutableList.builder();
      ...
      return new grb($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gra a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gra(axw.g($$1, "frames[" + $$0 + "]"));
