...
public abstract class cfh extends cft {
   private static final double f = 2.0;
   private static final agj<Byte> g = agm.a(cfh.class, agl.a);
   private static final agj<Byte> h = agm.a(cfh.class, agl.a);
   ...
   protected boolean b;
   protected int c;
   public cfh.a d = cfh.a.a;
   public int e;
   private int m;
   private double n = 2.0;
   private int o;
   private arl p = this.u();
   @Nullable
   ...
   protected cfh(blt<? extends cfh> $$0, cti $$1, cmr $$2) {
      super($$0, $$1);
      this.s = $$2.p();
   }

   protected cfh(blt<? extends cfh> $$0, double $$1, double $$2, double $$3, cti $$4, cmr $$5) {
      this($$0, $$4, $$5);
      this.a_($$1, $$2, $$3);
   }

   protected cfh(blt<? extends cfh> $$0, bmf $$1, cti $$2, cmr $$3) {
   ...
   public void l() {
      ...
      if (this.O == 0.0F && this.N == 0.0F) {
         double $$2 = $$1.h();
         this.r((float)(aui.d($$1.c, $$1.e) * 180.0F / (float)Math.PI));
         this.s((float)(aui.d($$1.d, $$2) * 180.0F / (float)Math.PI));
         this.N = this.dC();
         this.O = this.dE();
      }
      ...
      if (this.b && !$$0) {
         ...
         elm $$8 = this.dk();
         elm $$9 = $$8.e($$1);
         elk $$10 = this.dM().a(new csr($$8, $$9, csr.a.a, csr.b.a, this));
         if ($$10.c() != elk.a.a) {
            $$9 = $$10.e();
         }
         ...
         while (!this.dH()) {
            ...
            if ($$10 != null && $$10.c() == elk.a.c) {
               blp $$12 = ((elj)$$10).a();
               blp $$13 = this.w();
               if ($$12 instanceof cfb && $$13 instanceof cfb && !((cfb)$$13).a((cfb)$$12)) {
                  $$10 = null;
                  $$11 = null;
               }
            }
         ...
         double $$21 = $$1.h();
         if ($$0) {
            this.r((float)(aui.d(-$$14, -$$16) * 180.0F / (float)Math.PI));
         } else {
            this.r((float)(aui.d($$14, $$16) * 180.0F / (float)Math.PI));
         }

         this.s((float)(aui.d($$15, $$21) * 180.0F / (float)Math.PI));
   ...
   private boolean I() {
      return this.b && this.dM().b(new elh(this.dk(), this.dk()).g(0.06));
   }
   ...
   protected void a(elj $$0) {
      ...
      int $$3 = aui.c(aui.a((double)$$2 * this.n, 0.0, 2.147483647E9));
      if (this.E() > 0) {
         if (this.q == null) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof bmf $$10) {
            if (!this.dM().B && this.E() <= 0) {
               $$10.p($$10.eO() + 1);
            }

            if (this.o > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.b(bnl.i));
               elm $$12 = this.dp().d(1.0, 0.0, 1.0).d().a((double)this.o * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dM().B && $$5 instanceof bmf) {
               cre.a($$10, $$5);
               cre.b((bmf)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof cfb && $$5 instanceof ana && !this.aU()) {
               ((ana)$$5).c.b(new aac(aac.g, 0.0F));
            }
            ...
            if (!this.dM().B && $$5 instanceof ana $$13) {
   ...
   protected void a(eli $$0) {
      ...
      super.a($$0);
      elm $$1 = $$0.e().a(this.dr(), this.dt(), this.dx());
      this.g($$1);
      elm $$2 = $$1.d().a(0.05F);
   ...
   protected elj a(elm $$0, elm $$1) {
      return cfu.a(this.dM(), this, $$0, $$1, this.cH().b(this.dp()).g(1.0), this::a);
   }
   ...
   public void a(sl $$0) {
      ...
      if ($$0.b("inBlockState", 10)) {
         this.l = ta.a(this.dM().a(ke.f), $$0.p("inBlockState"));
      }
      ...
      this.d = cfh.a.a($$0.f("pickup"));
      this.a($$0.q("crit"));
      this.a($$0.f("PierceLevel"));
      if ($$0.b("SoundEvent", 8)) {
         this.p = kd.b.b(new ahd($$0.l("SoundEvent"))).orElse(this.u());
      }

      this.q($$0.q("ShotFromCrossbow"));
      if ($$0.b("item", 10)) {
         this.s = cmr.a($$0.p("item"));
      }
   }
   ...
   public void b(@Nullable blp $$0) {
      super.b($$0);
      if ($$0 instanceof cfb) {
         this.d = ((cfb)$$0).fT().d ? cfh.a.c : cfh.a.b;
      }
   }
