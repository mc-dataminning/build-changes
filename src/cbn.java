...
public class cbn extends cbu {
   private static final int g = 240;
   private final Predicate<bsf> h;
   protected int a;
   protected int b = -1;
   protected int c = -1;

   public cbn(bvh $$0, Predicate<bsf> $$1) {
      super($$0);
      this.h = $$1;
   }

   public cbn(bvh $$0, int $$1, Predicate<bsf> $$2) {
      this($$0, $$2);
      this.c = $$1;
   }
   ...
   public boolean b() {
      if (!super.b()) {
         ...
         return !a(this.d).O().b(dgc.c) ? false : this.a(this.d.dW().am()) && !this.h();
      }
   }
   ...
   public void a() {
      ...
      if (this.a == this.f() && this.a(this.d.dW().am())) {
         ...
         this.d.dW().c(2001, this.e, djk.j(this.d.dW().a_(this.e)));
      }
   }

   private boolean a(bsf $$0) {
