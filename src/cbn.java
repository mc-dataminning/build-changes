...
public class cbn extends cbc {
   ...
   protected void z() {
      ...
      this.bO.a(0, new brm<>(this, cle.a(new cjf(cji.rv), clf.i), apd.zn, $$0 -> this.dL().O() && !$$0.cd()));
      this.bO.a(0, new brm<>(this, new cjf(cji.pQ), apd.zs, $$0 -> this.dL().N() && $$0.cd()));
   ...
   protected apc c(cjf $$0) {
      return $$0.a(cji.pQ) ? apd.zo : apd.zp;
   }

   @Override
   protected apc w(boolean $$0) {
      return $$0 ? apd.zu : apd.zr;
   }
