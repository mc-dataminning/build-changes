...
public class bcy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfp.z);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bcy::c), this.a("minecraft:arrow", bcy::a), this.a("minecraft:spectral_arrow", bcy::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bcy.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bfp.z, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bfp.z, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bcy.a<?> $$1, Type<?> $$2, Type<T> $$3) {
