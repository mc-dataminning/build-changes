...
public class ah implements Comparable<ah> {
   ...
   private static final Codec<Instant> c = asu.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static final Codec<ah> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(asu.a(d, "criteria", Map.of()).forGetter($$0x -> $$0x.e), Codec.BOOL.fieldOf("done").orElse(true).forGetter(ah::a))
