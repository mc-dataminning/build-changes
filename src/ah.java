...
public class ah implements Comparable<ah> {
   ...
   private static final Codec<Instant> c = atq.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static final Codec<ah> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(atq.a(d, "criteria", Map.of()).forGetter($$0x -> $$0x.e), Codec.BOOL.fieldOf("done").orElse(true).forGetter(ah::a))
   ...
   public void a(ug $$0) {
      $$0.a(this.e, ug::a, ($$0x, $$1) -> $$1.a($$0x));
   }

   public static ah b(ug $$0) {
      Map<String, ao> $$1 = $$0.a(ug::s, ao::b);
      return new ah($$1);
   }
   ...
   public vd d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return vd.a("advancements.progress", $$1, $$0);
         }
      }
   }
