...
public class ah implements Comparable<ah> {
   ...
   private static final Codec<Instant> c = axo.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static ah b(vr $$0) {
      Map<String, ao> $$1 = $$0.a(vr::p, ao::b);
      return new ah($$1);
   }
   ...
   public wu d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return wu.a("advancements.progress", $$1, $$0);
         }
      }
   }
