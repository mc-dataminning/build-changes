...
public class ah implements Comparable<ah> {
   ...
   private static final Codec<Instant> c = awu.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static final Codec<ah> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(awu.a(d, "criteria", Map.of()).forGetter($$0x -> $$0x.e), Codec.BOOL.fieldOf("done").orElse(true).forGetter(ah::a))
   ...
   public static ah b(vi $$0) {
      Map<String, ao> $$1 = $$0.a(vi::p, ao::b);
      return new ah($$1);
   }
   ...
   public wi d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return wi.a("advancements.progress", $$1, $$0);
         }
      }
   }
