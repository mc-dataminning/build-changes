...
public class ah implements Comparable<ah> {
   ...
   private static final Codec<Instant> c = atx.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static final Codec<ah> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(atx.a(d, "criteria", Map.of()).forGetter($$0x -> $$0x.e), Codec.BOOL.fieldOf("done").orElse(true).forGetter(ah::a))
   ...
   public void a(uj $$0) {
      $$0.a(this.e, uj::a, ($$0x, $$1) -> $$1.a($$0x));
   }

   public static ah b(uj $$0) {
      Map<String, ao> $$1 = $$0.a(uj::s, ao::b);
      return new ah($$1);
   }
   ...
   public vg d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return vg.a("advancements.progress", $$1, $$0);
         }
      }
   }
