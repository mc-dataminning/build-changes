...
public interface fkh {
   fkh a(float var1, float var2, float var3);

   fkh a(int var1, int var2, int var3, int var4);

   fkh a(float var1, float var2);

   fkh a(int var1, int var2);

   fkh b(int var1, int var2);

   fkh b(float var1, float var2, float var3);
   ...
   default fkh a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(fkd.a $$0, grx $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fkd.a $$0, grx $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      Vector3fc $$11 = $$1.d().s();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(fkb.b.b());
   ...
   default fkh a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default fkh a(fkd.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default fkh a(fkd.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fkh a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default fkh b(fkd.a $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.a($$1, $$2, $$3, new Vector3f());
      return this.b($$4.x(), $$4.y(), $$4.z());
   }

   default fkh b(fkd.a $$0, Vector3f $$1) {
