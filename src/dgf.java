...
public interface dgf extends dhc {
   int g = 16;
   ...
   default fbo a(dgh $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dxn $$2 = this.a_($$1);
         fbs $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new fbo($$0x.a(), jm.a($$3.d, $$3.e, $$3.f), jh.a((ka)$$0x.a()), false) : null;
      }, $$0x -> {
         fbs $$1 = $$0x.b().d($$0x.a());
         return fbo.a($$0x.a(), jm.a($$1.d, $$1.e, $$1.f), jh.a((ka)$$0x.a()));
      });
   }
   ...
   @Nullable
   default fbo a(fbs $$0, fbs $$1, jh $$2, fcm $$3, dxn $$4) {
      fbo $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         fbo $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(fcm $$0, Supplier<fcm> $$1) {
      if (!$$0.c()) {
         return $$0.c(jm.a.b);
      } else {
   ...
   static <T, C> T a(fbs $$0, fbs $$1, C $$2, BiFunction<C, jh, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<jh> a(fbs $$0, fbs $$1, fbn $$2) {
      fbs $$3 = $$1.d($$0);
   ...
   private static void a(Set<jh> $$0, fbs $$1, fbs $$2, fbn $$3) {
      fbs $$4 = $$2.d($$1);
      int $$5 = bae.a($$1.d);
      int $$6 = bae.a($$1.e);
      int $$7 = bae.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<fbs> $$18 = fbn.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            fbs $$19 = $$18.get();
