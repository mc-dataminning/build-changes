...
public class gxa implements gxd.a, AutoCloseable {
   ...
   fci[] f;
   @Nullable
   private final gxa.a g;
   private final auy h;

   public gxa(ale $$0, gyu $$1, fci $$2, auy $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gys $$4 = $$3.a(gys.a).orElse(gys.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new fci[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gwv.a(this.f, $$0);
   ...
   @Nullable
   private gxa.a a(gyu $$0, int $$1, int $$2, gys $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gxa.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gxa.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gxa.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gxa.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gxa.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gxa.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fci[] $$4) {
   ...
   class a {
      ...
      a(final List<gxa.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gxa.this.c;
         int $$4 = this.b($$2) * gxa.this.d;
         gxa.this.a($$0, $$1, $$3, $$4, gxa.this.f);
      }

      public gxc a() {
         return gxa.this.new d(this, this.d ? gxa.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fci[] b = new fci[gxa.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gxa.this.c >> $$0;
            int $$2 = gxa.this.d >> $$0;
            this.b[$$0] = new fci($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gxa.d $$2) {
         gxa.a $$3 = $$2.c;
         List<gxa.b> $$4 = $$3.b;
         gxa.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, axq.a($$6, $$14, $$15));
                  }
               }
            }

            gxa.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gxa.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gxa.this.f[$$2].a($$3 + ($$0.a($$1) * gxa.this.c >> $$2), $$4 + ($$0.b($$1) * gxa.this.d >> $$2));
      }
   ...
   class d implements gxc {
      int a;
      int b;
      final gxa.a c;
      @Nullable
      private final gxa.c d;

      d(final gxa.a $$0, @Nullable final gxa.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
