public abstract class gxa<M extends gdf> extends gws<gzv, M> {
   private final gcv a;
   private final akv b;
   private final gxa.a c;

   public gxa(gte<?, gzv, M> $$0, gcv $$1, akv $$2, gxa.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(gzv var1);
   ...
   private void a(fft $$0, glx $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, heh.d);
   }
