...
public class cvx extends ctd implements csx {
   ...
   private final csv c;
   private final aev<dnj<?, ?>> d;

   protected cvx(dfi.d $$0, aev<dnj<?, ?>> $$1, csv $$2) {
      super($$0);
      this.d = $$1;
      this.c = $$2;
   }
   ...
   protected boolean d(dfj $$0, cpb $$1, gw $$2) {
      return $$0.a(aps.aK) || $$0.a(csw.fl) || $$0.a(csw.dY) || super.d($$0, $$1, $$2);
   }

   private Optional<? extends he<dnj<?, ?>>> a(cpy $$0) {
      return $$0.G_().d(jc.as).b(this.d);
   }
