...
public final class dda {
   ...
   public static final MapCodec<dda> b = dda.a.a
      .flatXmap(dda::a, $$0 -> $$0.h.<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final yt<wg, dda> c = yt.a(yr.h, $$0 -> $$0.e, yr.h, $$0 -> $$0.f, dch.b.a(yr.a()), $$0 -> $$0.g, dda::a);
   private final int e;
   private final int f;
   private final List<Optional<dch>> g;
   private final Optional<dda.a> h;
   private final int i;
   private final boolean j;

   public dda(int $$0, int $$1, List<Optional<dch>> $$2, Optional<dda.a> $$3) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   private static dda a(Integer $$0, Integer $$1, List<Optional<dch>> $$2) {
      return new dda($$0, $$1, $$2, Optional.empty());
   }

   public static dda a(Map<Character, dch> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static dda a(Map<Character, dch> $$0, List<String> $$1) {
      dda.a $$2 = new dda.a($$0, $$1);
      return (dda)a($$2).getOrThrow();
   }

   private static DataResult<dda> a(dda.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      List<Optional<dch>> $$4 = new ArrayList<>($$2 * $$3);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new dda($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(dbz $$0, boolean $$1) {
   ...
   public List<Optional<dch>> c() {
      return this.g;
   }

   public static record a(Map<Character, dch> b, List<String> c) {
      ...
      public static final MapCodec<dda.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(ays.b(e, dch.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, dda.a::new)
      );

      public Map<Character, dch> a() {
         return this.b;
      }
