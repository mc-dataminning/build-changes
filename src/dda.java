...
public abstract class dda implements dcz {
   public static final Codec<dda> a = lp.ab.q().dispatchStable(dda::a, Function.identity());
   private final Supplier<Set<ji<dcw>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<ji<dcw>> b();
   ...
   @Nullable
   public Pair<iz, ji<dcw>> a(int $$0, int $$1, int $$2, int $$3, Predicate<ji<dcw>> $$4, azg $$5, ddf.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<iz, ji<dcw>> a(iz $$0, int $$1, int $$2, int $$3, Predicate<ji<dcw>> $$4, ddf.f $$5, dca $$6) {
      Set<ji<dcw>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         int $$8 = Math.floorDiv($$1, $$2);
         int[] $$9 = ayy.a($$0.v(), $$6.I_() + 1, $$6.am(), $$3).toArray();
         ...
         for (iz.a $$10 : iz.a(iz.c, $$8, je.f, je.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = jt.a($$15);
               ji<dcw> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.as ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               ji<dcw> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract ji<dcw> getNoiseBiome(int var1, int var2, int var3, ddf.f var4);
