...
public abstract class bxp {
   ...
   public bxp(boi $$0, cvn $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = awh.a($$0.g(bpl.i) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract ehg a(int var1);
   ...
   @Nullable
   public final ehe a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(hz.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ehe a(Stream<hz> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ehe a(Set<hz> $$0, int $$1) {
   ...
   @Nullable
   protected ehe a(Set<hz> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(bpl.i));
   }

   @Nullable
   protected ehe a(Set<hz> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         hz $$5 = $$2 ? this.a.dm().c() : this.a.dm();
         int $$6 = (int)($$4 + (float)$$1);
         cwa $$7 = new cwa(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         ehe $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.af().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ehe $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            ens $$0 = this.b();
            ens $$1 = this.c.a(this.a);
            if ($$0.d > $$1.d && !this.a.aC() && awh.a($$0.c) == awh.a($$1.c) && awh.a($$0.e) == awh.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(ens $$0) {
      hz $$1 = hz.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ehj.a(this.b, $$1);
   }
   ...
   private boolean c(ens $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ens $$1 = ens.c(this.c.g());
         if (!$$0.a((it)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ens $$2 = ens.c(this.c.d(this.c.f() + 1));
            ens $$3 = $$1.d($$0);
            ens $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void U_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            ehc $$1 = this.c.a($$0);
            ehc $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dlf $$3 = this.b.a_(new hz($$1.a, $$1.b, $$1.c));
            if ($$3.a(atz.bk)) {
   ...
   public boolean b(eha $$0) {
      return $$0 != eha.n && $$0 != eha.p && $$0 != eha.d;
   }

   protected static boolean a(boi $$0, ens $$1, ens $$2, boolean $$3) {
      ens $$4 = new ens($$2.c, $$2.d + (double)$$0.dh() * 0.5, $$2.e);
      return $$0.dM().a(new cuw($$1, $$4, cuw.a.a, $$3 ? cuw.b.c : cuw.b.a, $$0)).c() == enq.a.a;
   }
   ...
   public boolean b(hz $$0) {
      if (this.m) {
         ...
         ehc $$1 = this.c.d();
         ens $$2 = new ens(((double)$$1.a + this.a.dr()) / 2.0, ((double)$$1.b + this.a.dt()) / 2.0, ((double)$$1.c + this.a.dx()) / 2.0);
