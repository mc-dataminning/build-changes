...
public class gkc {
   ...
   static final ThreadLocal<gkc.d> f = ThreadLocal.withInitial(gkc.d::new);

   public gkc(fkz $$0) {
      this.d = $$0;
   }

   public void a(deh $$0, hav $$1, dvo $$2, jh $$3, fek $$4, feo $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      boolean $$10 = fjx.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(deh $$0, hav $$1, dvo $$2, jh $$3, fek $$4, feo $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      ...
      for (jm $$14 : c) {
         $$7.b($$8);
         List<gke> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dij.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gke> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(deh $$0, hav $$1, dvo $$2, jh $$3, fek $$4, feo $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jh.a $$11 = $$3.k();

      for (jm $$12 : c) {
         $$7.b($$8);
         List<gke> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dij.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = git.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gke> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(deh $$0, dvo $$1, jh $$2, fek $$3, feo $$4, List<gke> $$5, float[] $$6, BitSet $$7, gkc.b $$8, int $$9) {
      for (gke $$10 : $$5) {
   ...
   private void a(
      deh $$0, dvo $$1, jh $$2, feo $$3, fek.a $$4, gke $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(deh $$0, dvo $$1, jh $$2, int[] $$3, jm $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(deh $$0, dvo $$1, jh $$2, int $$3, int $$4, boolean $$5, fek $$6, feo $$7, List<gke> $$8, BitSet $$9) {
      for (gke $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fek.a $$0, feo $$1, @Nullable dvo $$2, hav $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azv $$9 = azv.a();
      long $$10 = 42L;
   ...
   private static void a(fek.a $$0, feo $$1, float $$2, float $$3, float $$4, List<gke> $$5, int $$6, int $$7) {
      for (gke $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = azn.a($$2, 0.0F, 1.0F);
            $$10 = azn.a($$3, 0.0F, 1.0F);
            $$11 = azn.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gkc.e[]{gkc.e.k, gkc.e.d, gkc.e.k, gkc.e.j, gkc.e.e, gkc.e.j, gkc.e.e, gkc.e.d},
         new gkc.e[]{gkc.e.k, gkc.e.c, gkc.e.k, gkc.e.i, gkc.e.e, gkc.e.i, gkc.e.e, gkc.e.c},
         new gkc.e[]{gkc.e.l, gkc.e.c, gkc.e.l, gkc.e.i, gkc.e.f, gkc.e.i, gkc.e.f, gkc.e.c},
         new gkc.e[]{gkc.e.l, gkc.e.d, gkc.e.l, gkc.e.j, gkc.e.f, gkc.e.j, gkc.e.f, gkc.e.d}
      ),
      b(
         new jm[]{jm.f, jm.e, jm.c, jm.d},
         1.0F,
         true,
         new gkc.e[]{gkc.e.f, gkc.e.d, gkc.e.f, gkc.e.j, gkc.e.l, gkc.e.j, gkc.e.l, gkc.e.d},
         new gkc.e[]{gkc.e.f, gkc.e.c, gkc.e.f, gkc.e.i, gkc.e.l, gkc.e.i, gkc.e.l, gkc.e.c},
         new gkc.e[]{gkc.e.e, gkc.e.c, gkc.e.e, gkc.e.i, gkc.e.k, gkc.e.i, gkc.e.k, gkc.e.c},
         new gkc.e[]{gkc.e.e, gkc.e.d, gkc.e.e, gkc.e.j, gkc.e.k, gkc.e.j, gkc.e.k, gkc.e.d}
      ),
      c(
         new jm[]{jm.b, jm.a, jm.f, jm.e},
         0.8F,
         true,
         new gkc.e[]{gkc.e.b, gkc.e.k, gkc.e.b, gkc.e.e, gkc.e.h, gkc.e.e, gkc.e.h, gkc.e.k},
         new gkc.e[]{gkc.e.b, gkc.e.l, gkc.e.b, gkc.e.f, gkc.e.h, gkc.e.f, gkc.e.h, gkc.e.l},
         new gkc.e[]{gkc.e.a, gkc.e.l, gkc.e.a, gkc.e.f, gkc.e.g, gkc.e.f, gkc.e.g, gkc.e.l},
         new gkc.e[]{gkc.e.a, gkc.e.k, gkc.e.a, gkc.e.e, gkc.e.g, gkc.e.e, gkc.e.g, gkc.e.k}
      ),
      d(
         new jm[]{jm.e, jm.f, jm.a, jm.b},
         0.8F,
         true,
         new gkc.e[]{gkc.e.b, gkc.e.k, gkc.e.h, gkc.e.k, gkc.e.h, gkc.e.e, gkc.e.b, gkc.e.e},
         new gkc.e[]{gkc.e.a, gkc.e.k, gkc.e.g, gkc.e.k, gkc.e.g, gkc.e.e, gkc.e.a, gkc.e.e},
         new gkc.e[]{gkc.e.a, gkc.e.l, gkc.e.g, gkc.e.l, gkc.e.g, gkc.e.f, gkc.e.a, gkc.e.f},
         new gkc.e[]{gkc.e.b, gkc.e.l, gkc.e.h, gkc.e.l, gkc.e.h, gkc.e.f, gkc.e.b, gkc.e.f}
      ),
      e(
         new jm[]{jm.b, jm.a, jm.c, jm.d},
         0.6F,
         true,
         new gkc.e[]{gkc.e.b, gkc.e.d, gkc.e.b, gkc.e.j, gkc.e.h, gkc.e.j, gkc.e.h, gkc.e.d},
         new gkc.e[]{gkc.e.b, gkc.e.c, gkc.e.b, gkc.e.i, gkc.e.h, gkc.e.i, gkc.e.h, gkc.e.c},
         new gkc.e[]{gkc.e.a, gkc.e.c, gkc.e.a, gkc.e.i, gkc.e.g, gkc.e.i, gkc.e.g, gkc.e.c},
         new gkc.e[]{gkc.e.a, gkc.e.d, gkc.e.a, gkc.e.j, gkc.e.g, gkc.e.j, gkc.e.g, gkc.e.d}
      ),
      f(
         new jm[]{jm.a, jm.b, jm.c, jm.d},
         0.6F,
         true,
         new gkc.e[]{gkc.e.g, gkc.e.d, gkc.e.g, gkc.e.j, gkc.e.a, gkc.e.j, gkc.e.a, gkc.e.d},
         new gkc.e[]{gkc.e.g, gkc.e.c, gkc.e.g, gkc.e.i, gkc.e.a, gkc.e.i, gkc.e.a, gkc.e.c},
         new gkc.e[]{gkc.e.h, gkc.e.c, gkc.e.h, gkc.e.i, gkc.e.b, gkc.e.i, gkc.e.b, gkc.e.c},
         new gkc.e[]{gkc.e.h, gkc.e.d, gkc.e.h, gkc.e.j, gkc.e.b, gkc.e.j, gkc.e.b, gkc.e.d}
      );
      ...
      final gkc.e[] k;
      final gkc.e[] l;
      private static final gkc.a[] m = ae.a(new gkc.a[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
      ...
      private a(final jm[] $$0, final float $$1, final boolean $$2, final gkc.e[] $$3, final gkc.e[] $$4, final gkc.e[] $$5, final gkc.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(deh $$0, dvo $$1, jh $$2, jm $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dvo $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dvo $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dvo $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dvo $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gkc.c[] k = ae.a(new gkc.c[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dvo $$0, deh $$1, jh $$2) {
         long $$3 = $$2.a();
         if (this.a) {
