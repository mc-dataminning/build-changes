...
public class gkc extends sv {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gkc(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gkc a(aso $$0, List<String> $$1, boolean $$2) {
      ...
      return new gkc(ImmutableMap.copyOf($$3), $$2);
   }
