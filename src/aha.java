...
public final class aha<E> implements Codec<ih<E>> {
   private final ahc<? extends it<E>> a;

   public static <E> aha<E> a(ahc<? extends it<E>> $$0) {
      return new aha<>($$0);
   }

   private aha(ahc<? extends it<E>> $$0) {
      this.a = $$0;
   }
