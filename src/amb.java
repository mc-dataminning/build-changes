...
public class amb {
   ...
   private static int a(et $$0, Collection<? extends aum<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> wz.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> wz.a("commands.banlist.list", $$1.size()), false);

         for (aum<?> $$2 : $$1) {
            $$0.a(() -> wz.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
