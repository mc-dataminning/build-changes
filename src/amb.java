...
public class amb extends aqy {
   private final alb h;
   private final Set<UUID> i = Sets.newHashSet();
   private int j;
   private int k = 100;

   public amb(alb $$0, xl $$1) {
      super($$1, bqf.a.g, bqf.b.a);
      this.h = $$0;
      this.a(0.0F);
   }
   ...
   public void a(int $$0) {
      this.j = $$0;
      this.a(ayu.a((float)$$0 / (float)this.k, 0.0F, 1.0F));
   }

   public void b(int $$0) {
      this.k = $$0;
      this.a(ayu.a((float)this.j / (float)$$0, 0.0F, 1.0F));
   }
   ...
   public boolean a(Collection<arc> $$0) {
      Set<UUID> $$1 = Sets.newHashSet();
      Set<arc> $$2 = Sets.newHashSet();
   ...
   public static amb a(ur $$0, alb $$1, jk.a $$2) {
      amb $$3 = new amb($$1, xl.a.a($$0.l("Name"), $$2));
      $$3.d($$0.q("Visible"));
      $$3.a($$0.h("Value"));
      $$3.b($$0.h("Max"));
      $$3.a(bqf.a.a($$0.l("Color")));
      $$3.a(bqf.b.a($$0.l("Overlay")));
