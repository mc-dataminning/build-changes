...
public class amb extends alx {
   static final Logger c = LogUtils.getLogger();
   private final amb.b d;
   private final String e;

   amb(String $$0, amb.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(ame $$0, aeu $$1) {
   ...
   @Nullable
   private anh<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : anh.create($$1, $$2);
      }
   }
   ...
   public static class a implements amx.c {
      ...
      public amd a(String $$0) {
         amb.b $$1 = new amb.b(this.a);
         return new amb($$0, $$1, this.b, "");
      }

      @Override
      public amd a(String $$0, amx.a $$1) {
         amb.b $$2 = new amb.b(this.a);
         amd $$3 = new amb($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<amd> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new amb($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  amb.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
