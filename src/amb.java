...
public abstract class amb implements amh {
   private static final Logger c = LogUtils.getLogger();
   private final String d;
   private final boolean e;

   protected amb(String $$0, boolean $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public <T> T a(amt<T> $$0) throws IOException {
      anl<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(amt<T> $$0, InputStream $$1) {
      JsonObject $$3;
