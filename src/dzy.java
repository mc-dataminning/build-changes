...
public class dzy {
   ...
   private final dcw p;
   private static final List<dfw> q = List.of(dfy.l, dfy.L, dfy.i, dfy.b, dfy.k, dfy.I, dfy.K, dfy.fl, dfy.dP, dfy.iA, dfy.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<jm<ddu>>> t;
   ...
   public static final Codec<dzy> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dzy::a, Function.identity());

   private static DataResult<dzy> a(dzy $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dzy(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ad.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<jm<ddu>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kf.c($$0);
      int $$5 = kf.c($$1) - $$4;
   ...
   @Nullable
   public static dzy a(ara $$0, int $$1, int $$2) {
      duw $$3 = $$0.a($$1, $$2);
      dzy $$4 = $$3.t();
      if ($$4 != null && !$$3.k().d(dvx.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jj> a(ddq $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, duw $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayn.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(duw $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dyv.a.a)) {
         $$3 = Math.min($$0.a(dyv.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(duw $$0, jd.a $$1) {
      return a($$0, (jd)$$1.c(ji.a)) ? 1.0 : -1.0;
   }

   private static double b(duw $$0, jd.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(duw $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jm<ddu>> b(duw $$0, int $$1, int $$2) {
      ObjectArrayList<jm<ddu>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(duw $$0, jd $$1) {
      dta $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awd.O)) {
         ...
         return $$2.a(dfy.eT) || $$2.a(dfy.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dzy.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dzy.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, jm<ddu> var3);
   }
