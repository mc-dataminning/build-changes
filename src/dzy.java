public class dzy {
   ...
   private int a(dhh $$0, int $$1, int $$2, int $$3) {
      int $$4 = hz.c($$0.g($$1) + 1);
   ...
   public boolean a(cpd $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(cpd $$0, int $$1, int $$2, gw $$3, dfl $$4, gw $$5, dfl $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(cpd $$0, gw $$1, dfl $$2) {
      gw.a $$3 = this.e.g($$1);
   ...
   private static boolean a(cpd $$0, gw $$1, dfl $$2, gw $$3, dfl $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         eii $$5 = eaf.a($$0, $$1, $$2, hc.a);
         eii $$6 = eaf.a($$0, $$3, $$4, hc.b);
         return eif.b($$5, $$6);
      }
   }
