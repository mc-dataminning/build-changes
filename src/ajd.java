...
public class ajd {
   ...
   private static int a(dt $$0, eif $$1, int $$2) {
      $$1.a($$2);
      $$0.a(() -> tl.a("commands.trigger.add.success", $$1.d().e(), $$2), true);
      return $$1.b();
   }

   private static int b(dt $$0, eif $$1, int $$2) {
      $$1.b($$2);
      $$0.a(() -> tl.a("commands.trigger.set.success", $$1.d().e(), $$2), true);
      return $$2;
   }

   private static int a(dt $$0, eif $$1) {
      $$1.a(1);
      $$0.a(() -> tl.a("commands.trigger.simple.success", $$1.d().e()), true);
      return $$1.b();
   }

   private static eif a(aku $$0, eid $$1) throws CommandSyntaxException {
      if ($$1.c() != eij.b) {
         throw b.create();
      } else {
         eig $$2 = $$0.gh();
