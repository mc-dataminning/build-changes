...
public final class ajd<E> implements Codec<il<E>> {
   private final ajg<? extends iy<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> ajd<E> a(ajg<? extends iy<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> ajd<E> a(ajg<? extends iy<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new ajd<>($$0, $$1, $$2);
   }

   private ajd(ajg<? extends iy<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(il<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof ajf<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> ajh.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
   ...
   public <T> DataResult<Pair<il<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof ajf<?> $$2) {
         ...
         if ($$3.isEmpty()) {
            ...
            im<E> $$4 = $$3.get();
            DataResult<Pair<ajh, T>> $$5 = ajh.a.decode($$0, $$1);
            if ($$5.result().isEmpty()) {
               return !this.c ? DataResult.error(() -> "Inline definitions not allowed here") : this.b.decode($$0, $$1).map($$0x -> $$0x.mapFirst(il::a));
            } else {
               Pair<ajh, T> $$6 = (Pair<ajh, T>)$$5.result().get();
               ajg<E> $$7 = ajg.a(this.a, (ajh)$$6.getFirst());
               return $$4.a($$7)
