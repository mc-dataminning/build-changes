...
public class ajd {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> vd.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(vd.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> vd.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType a = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> vd.b("commands.execute.function.instantiationFailure", $$0, $$1)
   );
   private static final SuggestionProvider<ds> f = ($$0, $$1) -> {
      egs $$2 = ((ds)$$0.getSource()).l().aJ();
      return dx.a($$2.a(egu.a), $$1);
   };
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a(
                                       ...
                                       .then(dt.a("at").then(dt.a("targets", ef.b()).fork($$2, $$0x -> {
                                          ...
                                          for (blp $$2x : ef.c($$0x, "targets")) {
                                             $$1x.add(((ds)$$0x.getSource()).a((amz)$$2x.dM()).a($$2x.dk()).a($$2x.bG()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a("positioned")
                                       ...
                                       .then(dt.a("over").then(dt.a("heightmap", ei.a()).redirect($$2, $$0x -> {
                                          elm $$1x = ((ds)$$0x.getSource()).d();
                                          amz $$2x = ((ds)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(iz.b($$3), iz.b($$4))) {
                                             throw fm.a.create();
                                          } else {
                                             int $$5 = $$2x.a(ei.a($$0x, "heightmap"), aui.a($$3), aui.a($$4));
                                             return ((ds)$$0x.getSource()).a(new elm($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         dt.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)dt.a("id", et.a())
                     .suggests(ain.a)
                     .then(dt.a("value").redirect($$0, $$1x -> a((ds)$$1x.getSource(), ain.a($$1x), true, $$2))))
                  .then(dt.a("max").redirect($$0, $$1x -> a((ds)$$1x.getSource(), ain.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             dt.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         ek.a($$2xx, "path"),
                                                         $$1xxx -> sq.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          dt.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      ek.a($$2xx, "path"),
                                                      $$1xxx -> so.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       dt.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   ek.a($$2xx, "path"),
                                                   $$1xxx -> td.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    dt.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                ek.a($$2xx, "path"),
                                                $$1xxx -> st.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 dt.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             ek.a($$2xx, "path"),
                                             $$1xxx -> sm.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              dt.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          ek.a($$2xx, "path"),
                                          $$1xxx -> sj.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static ds a(ds $$0, Collection<emp> $$1, emi $$2, boolean $$3) {
      emq $$4 = $$0.l().aH();
      return $$0.a(($$4x, $$5) -> {
         for (emp $$6 : $$1) {
            emo $$7 = $$4.c($$6, $$2);
   ...
   private static ds a(ds $$0, aic $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ds a(ds $$0, alp $$1, ek.g $$2, IntFunction<ti> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            sl $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(amz $$0, hx $$1) {
      csp $$2 = new csp($$1);
      dlh $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == ams.d && $$0.c($$2.a());
   }
                                       ...
                                       dt.a("pos", fm.a())
                                          .then(
                                             a(
                                                ...
                                                dt.a("block", fi.a($$3)),
                                                $$2,
                                                $$0x -> fi.a($$0x, "block").test(new dje(((ds)$$0x.getSource()).e(), fm.a($$0x, "pos"), true))
                                             )
                                          )
                                    )
                              ))
                                             ...
                                             dt.a(">=")
                                                .then(
                                                   dt.a("source", ew.a())
                                                      .suggests(ew.a)
                                                      .then(
                                                         a($$0, dt.a("sourceObjective", em.a()), $$2, $$0x -> a($$0x, (ajd.e)(($$0xx, $$1x) -> $$0xx >= $$1x)))
                                                      )
                                                )
                                          ))
                  ...
                  dt.a("entity")
                     .then(
                        ((RequiredArgumentBuilder)dt.a("entities", ef.b()).fork($$0, $$1x -> a($$1x, $$2, !ef.c($$1x, "entities").isEmpty())))
                           .executes(a($$2, (ajd.b)($$0x -> ef.c($$0x, "entities").size())))
                     )
               ))
            .then(dt.a("predicate").then(a($$0, dt.a("predicate", et.a()).suggests(f), $$2, $$0x -> a((ds)$$0x.getSource(), et.c($$0x, "predicate"))))))
         .then(dt.a("function").then(dt.a("name", fx.a()).suggests(aji.b).fork($$0, new ajd.d($$2))));
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)dt.a("path", ek.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), ek.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (ajd.b)($$1xx -> a($$4.a($$1xx), ek.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static Command<ds> a(boolean $$0, ajd.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ds)$$1x.getSource()).a(() -> vd.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ds)$$1x.getSource()).a(() -> vd.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(alp $$0, ek.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ds> $$0, ajd.e $$1) throws CommandSyntaxException {
      emp $$2 = ew.a($$0, "target");
      emi $$3 = em.a($$0, "targetObjective");
      emp $$4 = ew.a($$0, "source");
      emi $$5 = em.a($$0, "sourceObjective");
      emq $$6 = ((ds)$$0.getSource()).l().aH();
      emm $$7 = $$6.d($$2, $$3);
      emm $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ds> $$0, ck.d $$1) throws CommandSyntaxException {
      emp $$2 = ew.a($$0, "target");
      emi $$3 = em.a($$0, "targetObjective");
      emq $$4 = ((ds)$$0.getSource()).l().aH();
      emm $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ds $$0, ejo $$1) {
      amz $$2 = $$0.e();
      egv $$3 = new egv.a($$2).a(eja.f, $$0.d()).b(eja.a, $$0.f()).a(eiz.d);
      egp $$4 = new egp.a($$3).a(Optional.empty());
      $$4.b(egp.a($$1));
      return $$1.test($$4);
   }
   ...
   private static ArgumentBuilder<ds, ?> a(CommandNode<ds> $$0, ArgumentBuilder<ds, ?> $$1, boolean $$2, ajd.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ds)$$2x.getSource()).a(() -> vd.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ds> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ds)$$0.getSource()).a(() -> vd.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ds> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ds)$$0.getSource()).a(() -> vd.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(amz $$0, hx $$1, hx $$2, hx $$3, boolean $$4) throws CommandSyntaxException {
      dyr $$5 = dyr.a($$1, $$2);
      dyr $$6 = dyr.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ds> a(Function<blp, Optional<blp>> $$0) {
      return $$1 -> {
         ds $$2 = (ds)$$1.getSource();
         blp $$3 = $$2.f();
   ...
   private static RedirectModifier<ds> b(Function<blp, Stream<blp>> $$0) {
      return $$1 -> {
         ds $$2 = (ds)$$1.getSource();
         blp $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<ds> a(CommandNode<ds> $$0, LiteralArgumentBuilder<ds> $$1) {
      return (LiteralArgumentBuilder<ds>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              dt.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<blp, Optional<blp>>)($$0x -> $$0x instanceof bmn $$1x ? Optional.ofNullable($$1x.R_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              dt.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<blp, Optional<blp>>)($$0x -> $$0x instanceof bmh $$1x ? Optional.ofNullable($$1x.fT()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           dt.a("target")
                              .fork($$0, a((Function<blp, Optional<blp>>)($$0x -> $$0x instanceof bnb $$1x ? Optional.ofNullable($$1x.q()) : Optional.empty())))
                        ))
                     .then(
                        dt.a("attacker")
                           .fork($$0, a((Function<blp, Optional<blp>>)($$0x -> $$0x instanceof bln $$1x ? Optional.ofNullable($$1x.V_()) : Optional.empty())))
                     ))
                  .then(dt.a("vehicle").fork($$0, a((Function<blp, Optional<blp>>)($$0x -> Optional.ofNullable($$0x.cZ()))))))
               .then(dt.a("controller").fork($$0, a((Function<blp, Optional<blp>>)($$0x -> Optional.ofNullable($$0x.cN()))))))
            .then(
               dt.a("origin").fork($$0, a((Function<blp, Optional<blp>>)($$0x -> $$0x instanceof bnc $$1x ? Optional.ofNullable($$1x.w()) : Optional.empty())))
            ))
         .then(dt.a("passengers").fork($$0, b((Function<blp, Stream<blp>>)($$0x -> $$0x.cP().stream()))));
   }

   private static ds a(ds $$0, ih.c<blt<?>> $$1) throws CommandSyntaxException {
      blp $$2 = ala.a($$0, $$1, $$0.d(), new sl(), true);
      return $$0.a($$2);
   }

   public static <T extends du<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable sl $$5, gp<T> $$6, ajd.a<T, Collection<hb<T>>> $$7, gj $$8
   ) {
   ...
   static class d implements gm.a<ds> {
      ...
      public void a(ds $$0, List<ds> $$1, ContextChain<ds> $$2, gj $$3, gp<ds> $$4) {
         ajd.a($$0, $$1, aji::a, this.a, $$2, null, $$4, $$0x -> fx.a($$0x, "name"), $$3);
      }
   }
