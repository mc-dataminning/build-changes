...
public class gen extends aui<gen.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final akq b = akq.b("gpu_warnlist.json");
   ...
   protected gen.a a(aud $$0, bne $$1) {
      ...
      $$1.b();
      return new gen.a($$2, $$3, $$4);
   }

   protected void a(gen.a $$0, aud $$1, bne $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aud $$0, bne $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ezw.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ezw.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ezw.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
