...
public class blm extends bkx<cbh> {
   ...
   private static final Map<cbk, aex> g = ac.a(Maps.newHashMap(), $$0 -> {
      $$0.put(cbk.c, eco.an);
      $$0.put(cbk.d, eco.ao);
      $$0.put(cbk.e, eco.ap);
      $$0.put(cbk.f, eco.aq);
   ...
   protected boolean b(akr $$0, cbh $$1, long $$2) {
   ...
   private List<cjf> a(cbh $$0) {
      if ($$0.m_()) {
         ...
         if (g.containsKey($$1)) {
            ...
            ecw $$3 = new ecw.a((akr)$$0.dL()).a(efb.f, $$0.dj()).a(efb.a, $$0).a(efa.i);
            return $$2.a($$3);
         } else {
