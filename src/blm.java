...
public class blm {
   ...
   private blm(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blm a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blm($$0, $$1);
   }

   public blm.d a() throws IOException {
      blm.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blm.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blm.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blm.c $$3 = blm.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blm.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blm.a($$0, $$3);
            }
         }
   ...
   public blm.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blm.c> $$2 = this.a().c();
      ...
      blm.e $$4 = new blm.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blm.c b) implements blm.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blm.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blm.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blm.b> {
      private final List<blm.b> a;

      d(List<blm.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blm.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blm.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blm.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blm.d a() {
         ListIterator<blm.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blm.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blm.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blm.b> b() {
         return this.a.stream();
      }

      public Set<blm.c> c() {
         return this.a.stream().map(blm.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blm.c b) implements blm.b {
