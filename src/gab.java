...
public class gab extends anu<List<String>> {
   private static final aeu a = new aeu("texts/splashes.txt");
   private static final arx b = arx.a();
   ...
   protected List<String> a(anp $$0, bdk $$1) {
      try {
         List var4;
         try (BufferedReader $$2 = eqq.O().Z().openAsReader(a)) {
   ...
   protected void a(List<String> $$0, anp $$1, bdk $$2) {
      this.c.clear();
      this.c.addAll($$0);
   }
