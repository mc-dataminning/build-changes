...
public interface bhl<T, F> {
   ...
   public static final class a implements bhl<bhl.b, Runnable> {
   ...
   public static final class c<T> implements bhl<T, T> {
