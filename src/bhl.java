...
public class bhl extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bhw.y);
      Type<?> $$1 = this.getOutputSchema().getType(bhw.y);
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         ...
         tq $$4 = a($$1.substring($$2));
         if ($$4 != null) {
            $$3 = $$3.set("tag", new Dynamic(ue.a, $$4).convert($$0.getOps()));
         }
      }
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bjk.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bjk.a($$1.substring(0, $$2))));
