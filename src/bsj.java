...
public class bsj implements bsg {
   ...
   protected void b() {
      if (!this.a.N().l()) {
         this.a.aW = auo.c(this.a.aW, this.a.aU, (float)this.a.ab());
      }
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(auo.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(auo.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   private static double b(blv $$0) {
      return $$0 instanceof bml ? $$0.dv() : ($$0.cH().b + $$0.cH().e) / 2.0;
   }
}
