...
public class ejs implements duk.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ejs> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axe<ejs> a = axe.a(f);
   private final ejw g;
   private final ejw h;
   private final ejw i;
   ...
   public static ejs a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ejs(new dvs(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ejs(ejw $$0, ejw $$1, ejw $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ejs(axr $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ejw.a($$0, IntStream.rangeClosed(-15, 0)),
         ejw.a($$0, IntStream.rangeClosed(-15, 0)),
         ejw.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ejs a(axr $$0) {
      return new ejs($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(duk.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ejt $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ejw.b($$4 * $$13), ejw.b($$5 * $$13), ejw.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ejw.b($$1 * $$13);
         double $$21 = ejw.b($$2 * $$13);
         double $$22 = ejw.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ejt $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return axk.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
