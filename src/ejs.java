...
public class ejs {
   ...
   static class a implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
         return $$0.c[it.f.d()] && !$$0.b[it.f.d()].d;
      }

      @Override
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         $$1.d = true;
         $$1.b[it.f.d()].d = true;
         return new ejs.k($$0, $$1);
      }
   }

   static class b implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         ...
         return new ejs.l($$0, $$1);
      }
   }

   static class c implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         $$1.d = true;
         $$1.b[it.b.d()].d = true;
         return new ejs.m($$0, $$1);
      }
   }

   static class d implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         ...
         return new ejs.n($$0, $$1);
      }
   }

   static class e implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         ...
         $$3.d = true;
         $$3.b[it.c.d()].d = true;
         return new ejs.o($$0, $$3);
      }
   }

   static class f implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
         return true;
      }
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         $$1.d = true;
         return new ejs.s($$0, $$1, $$2);
      }
   }

   static class g implements ejs.i {
      @Override
      public boolean a(ejs.v $$0) {
      ...
      public ejs.r a(it $$0, ejs.v $$1, ayk $$2) {
         $$1.d = true;
         return new ejs.t($$0, $$1);
      }
   }

   public static class h extends ejs.r {
      ...
      private ejs.v G;
      private ejs.v H;
      private final List<ejs.r> I = Lists.newArrayList();

      public h(ayk $$0, int $$1, int $$2, it $$3) {
         super(eia.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ejs.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ejs.p($$3, this.G));
         this.I.add(new ejs.j($$3, this.H));
         List<ejs.i> $$5 = Lists.newArrayList();
         $$5.add(new ejs.b());
         $$5.add(new ejs.d());
         $$5.add(new ejs.e());
         $$5.add(new ejs.a());
         ...
         ehb $$10 = ehb.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ehb $$11 = ehb.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ehb $$12 = ehb.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ejs.u($$3, $$10, $$13++));
         this.I.add(new ejs.u($$3, $$11, $$13++));
         this.I.add(new ejs.q($$3, $$12));
      }
      ...
      private List<ejs.v> b(ayk $$0) {
         ejs.v[] $$1 = new ejs.v[75];
         ...
         ejs.v $$23 = new ejs.v(1003);
         ejs.v $$24 = new ejs.v(1001);
         ejs.v $$25 = new ejs.v(1002);
         $$1[v].a(it.b, $$23);
         $$1[w].a(it.d, $$24);
         $$1[x].a(it.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ejs.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dbs $$2, ayk $$3, ehb $$4) {
         int $$5 = 24;
      ...
      private void a(dbs $$0, ayk $$1, ehb $$2) {
      ...
      private void b(dbs $$0, ayk $$1, ehb $$2) {
      ...
      private void c(dbs $$0, ayk $$1, ehb $$2) {
      ...
      private void d(dbs $$0, ayk $$1, ehb $$2) {
      ...
      private void e(dbs $$0, ayk $$1, ehb $$2) {
      ...
      private void f(dbs $$0, ayk $$1, ehb $$2) {
   ...
   interface i {
      boolean a(ejs.v var1);

      ejs.r a(it var1, ejs.v var2, ayk var3);
   }

   public static class j extends ejs.r {
      public j(it $$0, ejs.v $$1) {
         super(eia.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dbs $$0, dbq $$1, dsy $$2, ayk $$3, ehb $$4, dae $$5, io $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dea.ch.n(), dea.ch.n(), false);
   ...
   public static class k extends ejs.r {
      public k(it $$0, ejs.v $$1) {
         super(eia.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ejs.r {
      public l(it $$0, ejs.v $$1) {
         super(eia.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ejs.r {
      public m(it $$0, ejs.v $$1) {
         super(eia.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ejs.r {
      public n(it $$0, ejs.v $$1) {
         super(eia.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ejs.r {
      public o(it $$0, ejs.v $$1) {
         super(eia.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ejs.r {
      public p(it $$0, ejs.v $$1) {
         super(eia.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ejs.r {
      public q(it $$0, ehb $$1) {
         super(eia.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ehn {
      protected static final drb b = dea.hZ.n();
      protected static final drb c = dea.ia.n();
      protected static final drb d = dea.ib.n();
      protected static final drb h = c;
      protected static final drb i = dea.ii.n();
      protected static final boolean j = true;
      protected static final drb k = dea.G.n();
      protected static final Set<ddy> l = ImmutableSet.builder().add(dea.dO).add(dea.iC).add(dea.mW).add(k.b()).build();
      ...
      public r(eia $$0, it $$1, int $$2, ehb $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eia $$0, int $$1, it $$2, ejs.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ehb a(it $$0, ejs.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ehb $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dbs $$0, ehb $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  drb $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dbs $$0, ehb $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dbs $$0, ehb $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, drb $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ehb $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dbs $$0, ehb $$1, int $$2, int $$3, int $$4) {
         io $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cir $$6 = bsa.D.a((dax)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), bss.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ejs.r {
      private int a;

      public s(it $$0, ejs.v $$1, ayk $$2) {
         super(eia.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ejs.r {
      public t(it $$0, ejs.v $$1) {
         super(eia.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ejs.r {
      private int a;

      public u(it $$0, ehb $$1, int $$2) {
         super(eia.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
