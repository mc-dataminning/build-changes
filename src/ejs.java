...
public class ejs extends ejv {
   ...
   static final ejs.b l = new ejs.b(854, 480);

   public ejs(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ejs.a[] e = values();
   ...
   static class b {
      ...
      static List<ejs.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ejs.b($$0, $$1), ejs.l) : ImmutableList.of(ejs.l);
      }
