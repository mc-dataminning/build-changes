...
public class ejs extends ejx {
   ...
   public List<eif.a> a(dfl $$0, BiConsumer<jh, dvo> $$1, azv $$2, int $$3, jh $$4, ehp $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azn.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azn.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ejs.a> $$13 = Lists.newArrayList();
      $$13.add(new ejs.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jh $$21 = $$4.b(azn.a($$19), $$12 - 1, azn.a($$20));
               jh $$22 = $$21.b(5);
      ...
      List<eif.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dfl $$0, BiConsumer<jh, dvo> $$1, azv $$2, jh $$3, jh $$4, boolean $$5, ehp $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jh $$13 = $$3.b(azn.d(0.5F + (float)$$12 * $$9), azn.d(0.5F + (float)$$12 * $$10), azn.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dov.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dfl $$0, BiConsumer<jh, dvo> $$1, azv $$2, int $$3, jh $$4, List<ejs.a> $$5, ehp $$6) {
      for (ejs.a $$7 : $$5) {
         int $$8 = $$7.a();
