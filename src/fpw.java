...
public class fpw {
   ...
   public static void a(File $$0, fie $$1, Consumer<wy> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fie $$2, Consumer<wy> $$3) {
      fiu $$4 = a($$2);
      ...
      ag.i().execute(() -> {
         try {
            $$4.a($$6);
            wy $$3x = wy.b($$6.getName()).a(o.t).a($$1xx -> $$1xx.a(new ww.d($$6.getAbsoluteFile())));
   ...
   public static fiu a(fie $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fiu $$3 = new fiu($$1, $$2, false);
      RenderSystem.bindTexture($$0.g().d());
      $$3.a(0, true);
      $$3.h();
      return $$3;
   }
   ...
   public fpw(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
