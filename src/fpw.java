...
public class fpw {
   ...
   public static List<fpw.a> a(String $$0, fpw.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fpw.a> a(String $$0, List<fpw.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fpw.a> a(List<String> $$0, List<fpw.b> $$1) {
      int $$2 = 0;
      List<fpw.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fpw.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fpw.b a(String $$0, String $$1) {
         return new fpw.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fpw.b a(String $$0) {
         return new fpw.b($$0);
      }
   }
}
