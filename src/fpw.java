...
public class fpw extends fpt {
   private static final alb a = alb.b("textures/misc/credits_vignette.png");
   ...
   private static final alb w = alb.b("texts/end.txt");
   private static final alb x = alb.b("texts/credits.json");
   private static final alb y = alb.b("texts/postcredits.txt");
   ...
   private int J;
   private final fkr K = new fkr(false);

   public fpw(boolean $$0, Runnable $$1) {
      super(fhs.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void a(alb $$0, fpw.a $$1) {
      try (Reader $$2 = this.m.ab().openAsReader($$0)) {
         $$1.read($$2);
   ...
   private void c(fjn $$0) {
      $$0.a(ghe::D, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
