...
public class fpw<T extends cbp> extends fmv<T> {
   ...
   public static fqn a(fqj $$0) {
      ...
      fqo $$2 = $$1.a();
      float $$3 = 13.5F;
      fqo $$4 = $$2.a("head", fqk.c(), fqh.a(-1.0F, 13.5F, -7.0F));
      $$4.a(
         "real_head",
         fqk.c()
            .a(0, 0)
      ...
      $$2.a("body", fqk.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, $$0), fqh.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("upper_body", fqk.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, $$0), fqh.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fqk $$5 = fqk.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0);
      $$2.a("right_hind_leg", $$5, fqh.a(-2.5F, 16.0F, 7.0F));
      $$2.a("left_hind_leg", $$5, fqh.a(0.5F, 16.0F, 7.0F));
      $$2.a("right_front_leg", $$5, fqh.a(-2.5F, 16.0F, -4.0F));
      $$2.a("left_front_leg", $$5, fqh.a(0.5F, 16.0F, -4.0F));
      fqo $$6 = $$2.a("tail", fqk.c(), fqh.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$6.a("real_tail", fqk.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0), fqh.a);
      return $$1;
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.aa_()) {
         ...
         this.n.f = awm.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.A()) {
         ...
         this.j.e = awm.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = awm.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = awm.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = awm.b($$1 * 0.6662F) * 1.4F * $$2;
      }
