...
public class bcz extends bft {
   public bcz(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bgv.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bgv.D.typeName(), big.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bgv.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bgv.D.typeName(), "minecraft:saddle"));
