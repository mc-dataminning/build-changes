...
public class bcz extends azs {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcz::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcz::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcz::k);
         $$0 = this.a($$0, "minecraft:fox", bcz::j);
         $$0 = this.a($$0, "minecraft:item", bcz::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcz::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcz::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcz::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcz::e);
         return this.a($$0, "minecraft:piglin", bcz::d);
      });
   }
