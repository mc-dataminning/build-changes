...
public abstract class fya<T extends blt, S> extends fyk<T> {
   private final fyj a;

   protected fya(fyl.a $$0) {
      super($$0);
      this.a = $$0.a();
   }
   ...
   private static float a(eur $$0) {
      return $$0.e() - 180.0F;
   }

   private static float b(eur $$0) {
      return -$$0.d();
   }
   ...
   protected abstract void a(T var1, S var2, epz var3, ftf var4, int var5, float var6);

   public static class a extends fya<blt.b, blt.b.a> {
      private final ftz a;
      ...
      public void a(blt.b $$0, blt.b.a $$1, epz $$2, ftf $$3, int $$4, float $$5) {
         this.a.a($$1.a(), $$2, $$3, $$4, gec.d);
      }
   }

   public static class b extends fya<blt.g, blt.g.a> {
      private final fzj a;
      ...
      public void a(blt.g $$0, blt.g.a $$1, epz $$2, ftf $$3, int $$4, float $$5) {
         $$2.a(a.d.rotation((float) Math.PI));
         this.a.a($$1.a(), $$1.b(), $$4, gec.d, $$2, $$3, $$0.dM(), $$0.aj());
      }
   }

   public static class c extends fya<blt.l, blt.l.e> {
      private final ewq a;
      ...
      public void a(blt.l $$0, blt.l.e $$1, epz $$2, ftf $$3, int $$4, float $$5) {
         byte $$6 = $$1.e();
         boolean $$7 = ($$6 & 2) != 0;
         boolean $$8 = ($$6 & 4) != 0;
         boolean $$9 = ($$6 & 1) != 0;
         ...
         if ($$13 != 0) {
            eqd $$21 = $$3.getBuffer($$7 ? ftn.r() : ftn.q());
         ...
         for (blt.l.c $$22 : $$17.a()) {
            ...
            this.a.a($$22.a(), $$23, $$15, $$11 << 24 | 16777215, $$9, $$16, $$3, $$7 ? ewq.a.b : ewq.a.c, 0, $$4);
            $$15 += (float)$$18;
         }
      }
   }
