...
public class fya implements fxz {
   public static final int a = 0;
   private final fya.b c = new fya.b();
   private final fya.b d = new fya.b();
   public final fya.a b;
   ...
   private float a(cix $$0, fin $$1, int $$2, bii $$3) {
   ...
   @Nullable
   private fin a(bii $$0, @Nullable fin $$1) {
      return $$1 == null && $$0.dK() instanceof fin ? (fin)$$0.dK() : $$1;
   }
   ...
   public interface a {
      @Nullable
      hd getPos(fin var1, cix var2, bii var3);
   }
