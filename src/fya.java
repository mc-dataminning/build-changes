public class fya<T extends ciu> extends fvt<T> {
   ...
   public static fyq a(fyo $$0) {
      fys $$1 = new fys();
      fyt $$2 = $$1.a();
      $$2.a("shoulders", fyp.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), fym.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         fyp.c()
         ...
         fym.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         fyp.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         fym.a(-2.0F, 6.9F + ayo.b(0.20420352F) * 10.0F, -0.5F + ayo.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", fyp.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fym.a);
      fyp $$4 = fyp.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, fym.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, fym.a(10.0F, 4.0F, 0.0F));
   ...
   private static <T extends ciu> void a(T $$0, fyk $$1, int $$2) {
