...
public class fxq implements fxs {
   ...
   @Override
   public void a(fpa $$0, int $$1, int $$2, int $$3, int $$4, fpc $$5) {
      if (this.r.g()) {
         this.b($$0, $$1, $$2, $$3, $$4, $$5);
      } else {
         this.c($$0, $$1, $$2, $$3, $$4, $$5);
   ...
   private void b(fpa $$0, int $$1, int $$2, int $$3, int $$4, fpc $$5) {
      b($$1 + this.a($$3), $$2, $$0, $$5);
      this.a($$1 + this.a($$3), $$2 + d($$0) + 4, $$0, $$5);
   }

   private void c(fpa $$0, int $$1, int $$2, int $$3, int $$4, fpc $$5) {
      boolean $$6 = this.r.e() > 12;
      List<cxh> $$7 = this.b(this.r.a());
      int $$8 = $$1 + this.a($$3) + 96;
      int $$9 = $$2 + this.d() * 24;
      int $$10 = 1;
   ...
   private static boolean a(List<cxh> $$0, int $$1) {
      return $$0.size() >= $$1;
   }

   private int a(List<cxh> $$0) {
      return this.r.b().skip((long)$$0.size()).mapToInt(cxh::M).sum();
   }

   private void a(int $$0, int $$1, int $$2, List<cxh> $$3, int $$4, fpa $$5, fpc $$6) {
      int $$7 = $$3.size() - $$0;
      boolean $$8 = $$7 == this.r.h();
      cxh $$9 = $$3.get($$7);
      if ($$8) {
         $$6.a(gnh::H, d, $$1, $$2, 24, 24);
      } else {
         $$6.a(gnh::H, f, $$1, $$2, 24, 24);
      }

      $$6.a($$9, $$1 + 4, $$2 + 4, $$4);
      $$6.a($$5, $$9, $$1 + 4, $$2 + 4);
      if ($$8) {
         $$6.a(gnh::F, e, $$1, $$2, 24, 24);
      }
   }

   private static void a(int $$0, int $$1, int $$2, fpa $$3, fpc $$4) {
      $$4.a($$3, "+" + $$2, $$0 + 12, $$1 + 10, 16777215);
   }

   private void a(fpa $$0, fpc $$1, int $$2, int $$3, int $$4) {
      if (this.r.i()) {
         cxh $$5 = this.r.a(this.r.h());
         wp $$6 = $$5.B();
         int $$7 = $$0.a($$6.g());
         int $$8 = $$2 + $$4 / 2 - 12;
         $$1.a($$0, $$6, $$8 - $$7 / 2, $$3 - 15, $$5.a(kv.H));
      }
   }

   private void a(int $$0, int $$1, fpa $$2, fpc $$3) {
      $$3.a(gnh::H, this.g(), $$0 + 1, $$1, this.f(), 13);
      $$3.a(gnh::H, a, $$0, $$1, 96, 13);
      wp $$4 = this.h();
      if ($$4 != null) {
   ...
   private static void b(int $$0, int $$1, fpa $$2, fpc $$3) {
      $$3.a($$2, q, $$0, $$1, 96, 11184810);
   }

   private static int d(fpa $$0) {
