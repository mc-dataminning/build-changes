public class fxq implements fxm<dix> {
   private final gbr a;
   ...
   public void a(dix $$0, float $$1, esa $$2, fvm $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.r().c(dlv.bv);
         if ($$6 > 0) {
            ie $$7 = $$0.f();
            if ($$7 != null) {
               ...
               if (!$$8.b()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = fvk.a($$0.i(), $$0.r(), $$0.aE_().a($$7));
                  this.a.a($$8, cow.i, $$11, ggl.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
