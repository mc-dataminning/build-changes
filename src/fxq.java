...
public class fxq implements fyj {
   ...
   private CompletableFuture<Optional<cnb>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public fxq(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cnb::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cnb>> a(Optional<cnb> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cnb.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cnb $$0) {
      ...
      if ($$0 != null) {
         if (aa.aX) {
            cnb.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cnb a(UserApiService $$0) throws axx, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cnc.a $$2 = a($$1);
         return new cnb(axw.a($$1.keyPair().privateKey()), new cnc($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cnc.a a(KeyPairResponse $$0) throws axx {
      KeyPair $$1 = $$0.keyPair();
