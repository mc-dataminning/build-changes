...
public class fxq extends fxu<ctc> {
   ...
   private static final List<fxu.a> j = List.of(
      new fxu.a(fya.a), new fxu.a(cxs.pA, cxs.ps, dcf.c), new fxu.a(cxs.eK, dcf.a), new fxu.a(cxs.qY, cxs.oQ, dcf.d), new fxu.a(cxs.lV, dcf.b)
   );
   ...
   @Override
   protected void a(fxs $$0, ddi $$1, bbp $$2) {
      $$0.b(this.f.m(), $$2, $$1.d());
