...
public class dve<T> implements dvm<T> {
   private final jr<T> a;
   private final axj<T> b;
   private final dvn<T> c;
   private final int d;

   public dve(jr<T> $$0, int $$1, dvn<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dve(jr<T> $$0, int $$1, dvn<T> $$2) {
      this($$0, $$1, $$2, axj.c(1 << $$1));
   }

   private dve(jr<T> $$0, int $$1, dvn<T> $$2, axj<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dvm<T> c() {
      return new dve<>(this.a, this.d, this.c, this.b.b());
   }
}
