...
public class agg {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> sw.a("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> sw.a("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> sw.a("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ds $$0, eeh $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bfj> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         agg.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> sw.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static void a(eeh $$0, double $$1, aif $$2, apf $$3, double $$4, double $$5, double $$6, double $$7, int $$8, agg.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bfj> $$0, aif $$1, agg.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<efi, agg.a> $$7 = Maps.newHashMap();

      for (bfj $$8 : $$0) {
         agg.a $$10;
         if ($$4) {
            efi $$9 = $$8 instanceof byo ? $$8.cd() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)apa.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)apa.a($$10.b) + 0.5, Set.of(), $$8.dy(), $$8.dA());
   ...
   private static agg.a[] a(apf $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      agg.a[] $$6 = new agg.a[$$1];
