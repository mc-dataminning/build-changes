...
public class agg {
   ...
   private static int a(dt $$0, afv $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.g() == $$2) {
         if ($$2) {
            throw k.create();
         } else {
   ...
   private static int a(dt $$0, afv $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         throw h.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(dt $$0, afv $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         throw i.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(dt $$0, afv $$1, bgo.a $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(dt $$0, afv $$1, bgo.b $$2) throws CommandSyntaxException {
      if ($$1.m().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(dt $$0, afv $$1, Collection<aks> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
   ...
   private static int e(dt $$0, afv $$1) {
      afw $$2 = $$0.l().aJ();
      $$1.b();
      $$2.a($$1);
   ...
   public static afv a(CommandContext<dt> $$0) throws CommandSyntaxException {
      aex $$1 = es.e($$0, "id");
      afv $$2 = ((dt)$$0.getSource()).l().aJ().a($$1);
      if ($$2 == null) {
