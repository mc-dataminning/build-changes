...
public class agg implements Comparable<agg> {
   public static final Codec<agg> a = Codec.STRING.comapFlatMap(agg::b, agg::toString).stable();
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(ur.c("argument.id.invalid"));
   ...
   protected agg(String $$0, String $$1, @Nullable agg.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public agg(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private agg(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static agg a(String $$0, char $$1) {
      return new agg(b($$0, $$1));
   }
   ...
   @Nullable
   public static agg a(String $$0, String $$1) {
      try {
         return new agg($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<agg> b(String $$0) {
      try {
         return DataResult.success(new agg($$0));
      } catch (z var2) {
   ...
   public agg c(String $$0) {
      return new agg(this.f, d(this.f, $$0), null);
   }

   public agg a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public agg d(String $$0) {
      return this.c($$0 + this.g);
   }

   public agg e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof agg $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static agg a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<agg>, JsonSerializer<agg> {
      public agg a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new agg(asy.a($$0, "location"));
      }

      public JsonElement a(agg $$0, Type $$1, JsonSerializationContext $$2) {
