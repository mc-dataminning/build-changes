...
public class fnl extends fmw {
   ...
   @Override
   protected void aM_() {
      this.x = this.c(new fic(this.m, this.n, this.o, this));
      int $$0 = -1;
      ezd $$1 = this.m.aO();
      eyy $$2 = $$1.t();
      int $$3;
      ...
      ffj<Integer> $$6 = new ffj<>("options.fullscreen.resolution", ffj.a(), ($$1x, $$2x) -> {
         if ($$2 == null) {
            return xp.c("options.fullscreen.unavailable");
         } else if ($$2x == -1) {
            return ffk.a($$1x, xp.c("options.fullscreen.current"));
         } else {
            ezc $$3x = $$2.a($$2x);
            return ffk.a($$1x, xp.a("options.fullscreen.entry", $$3x.a(), $$3x.b(), $$3x.f(), $$3x.c() + $$3x.d() + $$3x.e()));
         }
      }, new ffj.f(-1, $$2 != null ? $$2.e() - 1 : -1), $$3, $$2x -> {
         if ($$2 != null) {
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         if (this.y.g()) {
            ...
            this.m.a(new fnk(u, $$3, ImmutableList.of(new fnk.a(v, $$0x -> {
               this.c.j().a(fez.c);
               ffg.Q().f.f();
               this.y.e();
               this.m.a(this);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (fne.s()) {
         ffj<Integer> $$4 = this.c.aq();
         if ($$4.e() instanceof ffj.c $$5) {
            int $$6 = $$4.c();
            int $$7 = $$6 == 0 ? $$5.b() + 1 : $$6;
            int $$8 = $$7 + (int)Math.signum($$3);
            if ($$8 != 0 && $$8 <= $$5.b() && $$8 >= $$5.d()) {
               fhm<Integer> $$9 = (fhm<Integer>)this.x.b($$4);
               if ($$9 != null) {
                  $$4.a($$8);
                  $$9.a($$8);
                  this.x.a(0.0);
