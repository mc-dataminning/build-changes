...
public class fnl extends fnd {
   ...
   private int F;
   private final fhv G = new fhv(false);

   public fnl(boolean $$0, Runnable $$1) {
      super(fex.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fnl.a $$1) {
