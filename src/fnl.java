...
public class fnl {
   private static final alb a = new alb("advancements/title_box");
   ...
   public fnl(fnj $$0, ffa $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = um.a().a($$1.h.a($$3.a(), 163));
      this.y = ayu.d($$3.f() * 28.0F);
      this.z = ayu.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = um.a().a(this.a(xo.a($$3.b().f(), yi.a.a($$3.e().a())), $$7));
   ...
   private static float a(ffl $$0, List<xq> $$1) {
   ...
   public void a(fgm $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
