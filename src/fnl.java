...
public class fnl {
   ...
   private fnl(String $$0, @Nullable String[] $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public xc a() {
      if (!hmk.a(this.c)) {
         ...
         return this.d == null ? xc.c(this.c) : xc.a(this.c, this.d);
      }
   }

   public static fnl a(JsonObject $$0) {
      String $$1 = fpr.a("translationKey", $$0);
