...
public class fnl {
   ...
   public static void a(File $$0, ffy $$1, Consumer<wv> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ffy $$2, Consumer<wv> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ffy $$2, Consumer<wv> $$3) {
      fgo $$4 = a($$2);
      ...
      af.i().execute(() -> {
         try {
            $$4.a($$6);
            wv $$3x = wv.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new wt.d($$6.getAbsoluteFile())));
            $$3.accept(wv.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(wv.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static fgo a(ffy $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fgo $$3 = new fgo($$1, $$2, false);
   ...
   public fnl(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
