...
public class dux {
   ...
   private final Map<String, Long2ObjectMap<qw>> e = Maps.newHashMap();
   private final Map<String, dvf> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public dux(@Nullable ebw $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public qw a(qw $$0) {
      qw $$1 = $$0.p("Level");
      cpi $$2 = new cpi($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(cpi.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(cpi.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private qw a(qw $$0, cpi $$1) {
      qw $$2 = $$0.p("Level");
      qw $$3 = $$2.p("Structures");
      qw $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<qw> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable ebw $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            qw $$2 = new qw();

            try {
               $$2 = $$0.a($$1, atg.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               qw $$4 = $$2.p($$3);
               long $$5 = cpi.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               rc $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  qw $$14 = $$2.p($$13);
                  $$12.a(cpi.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static dux a(aey<cqb> $$0, @Nullable ebw $$1) {
      if ($$0 == cqb.h) {
         return new dux(
            $$1,
         ...
         return new dux($$1, $$2, $$2);
      } else if ($$0 == cqb.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new dux($$1, $$3, $$3);
      } else {
