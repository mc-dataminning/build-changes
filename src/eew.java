...
public class eew implements eex, eey {
   ...
   private final ejm<MinecraftServer> I;
   ...
   public eew(csj $$0, dnu $$1, eew.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         0,
   ...
   public static <T> eew a(Dynamic<T> $$0, csj $$1, eew.a $$2, dnu $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new eew(
         (sd)sd.a.parse($$0.get("Player").orElseEmptyMap()).result().orElse(null),
         ...
         (UUID)$$0.get("WanderingTraderId").read(iz.a).result().orElse(null),
         ...
         new ejm<>(ejl.a, $$0.get("ScheduledEvents").asStream()),
         (sd)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dkz.a.a).resultOrPartial(f::error).orElse(dkz.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public sd a(it $$0, @Nullable sd $$1) {
      if ($$1 == null) {
         $$1 = this.q;
      }
   ...
   private void a(it $$0, sd $$1, @Nullable sd $$2) {
      ...
      $$1.a("Version", $$3);
      ss.g($$1);
      DynamicOps<ta> $$4 = agk.a(sr.a, $$0);
      dns.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dkz.a.a.encodeStart(sr.a, this.A), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<ta> $$5 = csy.b.encodeStart(sr.a, this.g.g());
      $$5.get().ifLeft($$1x -> $$1.a((sd)$$1x)).ifRight($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.B != null) {
   ...
   private static sj a(Set<String> $$0) {
      sj $$1 = new sj();
      $$0.stream().map(sy::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean B() {
      return this.i == eew.a.b;
   }

   @Override
   public boolean C() {
      return this.i == eew.a.c;
   }
