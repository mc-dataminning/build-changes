...
public class evp extends evj<evp.a> {
   protected evp(eby $$0) {
      super(diy.a, $$0, new evp.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected ebq g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && jx.c($$0) < $$2) {
            ...
            return this.j($$0) ? new ebq(15) : new ebq();
         }
      }
   }

   private static ebq a(ebq $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends evg<evp.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<ebq> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public evp.a a() {
         return new evp.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
