...
public class gaa extends fvi {
   ...
   private final fte M = new fte(this);
   @Nullable
   private final fvi N;
   fzz O;
   fpz P;
   private String Q = "";
   private gaa.a R = gaa.a.a;
   private fpq S;
   private fpq T;
   private fpq U;
   private fpq V;
   ...
   protected void aR_() {
      this.M.a(c, this.p);
      this.O = new fzz(this, this.m, this.n, this.E() - 88, 88, 36);
      int $$0 = this.O.a() / 3;
      int $$1 = this.O.u();
      int $$2 = this.O.v();
      this.S = this.c(fpq.a(u, $$0x -> this.a(gaa.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fpq.a(v, $$0x -> this.a(gaa.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fpq.a(w, $$0x -> this.a(gaa.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fpz(this.p, this.F() + 28, 74, 200, 15, A) {
         @Override
         protected xd d() {
            return !gaa.this.P.a().isEmpty() && gaa.this.O.b() ? super.d().f(", ").b(gaa.B) : super.d();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fpq.a(E, fuf.b(this, axv.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fpq.a(wo.d, $$0x -> this.aO_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fpc $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(gnh::H, d, $$4, 64, 236, this.m() + 16);
      $$0.a(gnh::H, s, $$4 + 10, 76, 12, 12);
   }
