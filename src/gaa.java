...
public class gaa {
   ...
   private gaa(int $$0, List<gac> $$1) {
      this.a = $$1.toArray(gac[]::new);
      this.b = $$1.size();
   }

   private List<gac> c() {
      List<gac> $$0 = new ArrayList<>(this.d());
