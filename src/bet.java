...
public class bet {
   ...
   private bet(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bet a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bet($$0, $$1);
   }

   public bet.d a() throws IOException {
      bet.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bet.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bet.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bet.c $$3 = bet.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bet.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bet.a($$0, $$3);
            }
         }
   ...
   public bet.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bet.c> $$2 = this.a().c();
      ...
      bet.e $$4 = new bet.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bet.c b) implements bet.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bet.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bet.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bet.b> {
      private final List<bet.b> a;

      d(List<bet.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bet.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bet.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bet.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bet.d a() {
         ListIterator<bet.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bet.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bet.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bet.b> b() {
         return this.a.stream();
      }

      public Set<bet.c> c() {
         return this.a.stream().map(bet.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bet.c b) implements bet.b {
