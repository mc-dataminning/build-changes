...
public class fa implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ti.a("team.notFound", $$0));

   public static fa a() {
      return new fa();
   }

   public static eif a(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
