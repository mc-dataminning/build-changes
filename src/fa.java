...
public class fa implements ArgumentType<fa.g> {
   ...
   public static fa.g a(CommandContext<ei> $$0, String $$1) {
      return (fa.g)$$0.getArgument($$1, fa.g.class);
   }

   public fa.g a(StringReader $$0) throws CommandSyntaxException {
      List<fa.h> $$1 = Lists.newArrayList();
      int $$2 = $$0.getCursor();
      Object2IntMap<fa.h> $$3 = new Object2IntOpenHashMap();
      boolean $$4 = true;
      ...
      return new fa.g($$0.getString().substring($$2, $$0.getCursor()), $$1.toArray(new fa.h[0]), $$3);
   }

   private static fa.h a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return (fa.h)(switch ($$0.peek()) {
   ...
   static class a implements fa.h {
      public static final fa.a a = new fa.a();
   ...
   static class b implements fa.h {
   ...
   static class c implements fa.h {
      private final int a;
   ...
   public static class g {
      ...
      private final Object2IntMap<fa.h> c;
      private final fa.h[] d;
      public static final Codec<fa.g> a = Codec.STRING.comapFlatMap($$0 -> {
         try {
            fa.g $$1 = new fa().a(new StringReader($$0));
      ...
      public static fa.g a(String $$0) throws CommandSyntaxException {
         return new fa().a(new StringReader($$0));
      }

      public g(String $$0, fa.h[] $$1, Object2IntMap<fa.h> $$2) {
         this.b = $$0;
         this.d = $$1;
         this.c = $$2;
      }
      ...
      private CommandSyntaxException a(fa.h $$0) {
         int $$1 = this.c.getInt($$0);
         return fa.c.create(this.b.substring(0, $$1));
      }
