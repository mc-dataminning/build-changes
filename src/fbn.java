...
public class fbn extends gty {
   ...
   public fbn(flz $$0, far $$1, String $$2, BooleanConsumer $$3) {
      super(fdt.a);
      this.Z = $$3;
      this.E = $$0;
      this.J = $$2;
   ...
   private void C() {
      if (!this.Q) {
         if (!this.Y && this.a(this.F.a) >= 5368709120L) {
            wx $$0 = wx.a("mco.download.confirmation.line1", ezg.b(5368709120L));
   ...
   private wx D() {
      ...
      if (this.N != null) {
         ...
         $$0.add(wx.a("mco.download.speed.narration", ezg.b(this.U)));
      }
   ...
   private void a(ffn $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.p, wx.a("mco.download.speed", ezg.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
