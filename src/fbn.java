...
public class fbn {
   private static final agm a = new agm("advancements/title_box");
   ...
   private final atc r;
   private final int s;
   private final List<atc> t;
   private final eti u;
   @Nullable
   private fbn v;
   private final List<fbn> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fbn(fbl $$0, eti $$1, ag $$2, aq $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ry.a().a($$1.h.a($$3.a(), 163));
      this.y = atq.d($$3.f() * 28.0F);
      this.z = atq.d($$3.g() * 27.0F);
      int $$4 = $$2.a().g().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = ry.a().a(this.a(uy.a($$3.b().f(), vs.a.a($$3.e().b())), $$7));
   ...
   private static float a(etu $$0, List<va> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<va> a(uv $$0, int $$1) {
      etu $$2 = this.u.h.b();
      List<va> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<va> $$6 = $$2.b($$0, $$1 - $$5, vs.a);
