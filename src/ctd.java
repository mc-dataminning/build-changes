...
public record ctd(Map<ctc.a, Integer> b, int c, jn<awc> d, Predicate<cvl> e, List<ctd.a> f, float g, float h) {
   public static final Codec<jn<ctd>> a = lu.ao.r();

   public int a(ctc.a $$0) {
      return this.b.getOrDefault($$0, 0);
   }

   public Map<ctc.a, Integer> a() {
      return this.b;
   }
