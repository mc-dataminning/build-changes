...
public class ctd extends cvj {
   ...
   private static boolean a(btq $$0, cuq $$1) {
   ...
   private static Vector3f a(btq $$0, evs $$1, float $$2) {
   ...
   protected cnq a(dbz $$0, btq $$1, cuq $$2, cuq $$3, boolean $$4) {
      if ($$3.a(cut.uu)) {
         return new cnl($$0, $$3, $$1, $$1.du(), $$1.dy() - 0.15F, $$1.dA(), true);
      } else {
         cnq $$5 = super.a($$0, $$1, $$2, $$3, $$4);
         if ($$5 instanceof cne $$6) {
            $$6.q(true);
            $$6.b(awa.gn);
         }
   ...
   public void a(dbz $$0, btq $$1, bqu $$2, cuq $$3, float $$4, float $$5, @Nullable btq $$6) {
      if (!$$0.x_()) {
         cxe $$7 = $$3.b(km.E, cxe.a);
         if ($$7 != null && !$$7.b()) {
            this.a($$0, $$1, $$2, $$3, $$7.a(), $$4, $$5, $$1 instanceof cmy, $$6);
   ...
   private static float a(int $$0, cuq $$1) {
