...
public class fji implements AutoCloseable {
   private final fjg.a a;
   @Nullable
   private fjg.a b;
   private final fji.a c;

   public fji(fjg.a $$0, fji.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fjo $$2) {
      int $$3 = $$2.a(fjp.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fji.b a(fjg $$0, fjr $$1) {
      if (this.c.d() != fjo.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fji.b $$3 = new fji.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fjo a, int b, int c, fjo.c d, fjo.b e) {
   }

   public static record b(Vector3f[] a, fjo.b b) {
      @Nullable
      public fjg.a a(fjg $$0, fjr $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fjo.b $$1) {
