public class la implements lb {
   ...
   @Override
   public final cwb dispense(ky $$0, cwb $$1) {
      cwb $$2 = this.a($$0, $$1);
      this.a($$0);
      this.a($$0, $$0.d().c(dkj.b));
      return $$2;
   }
   ...
   public static void a(dfb $$0, cwb $$1, int $$2, jm $$3, ka $$4) {
      double $$5 = $$4.a();
      double $$6 = $$4.b();
      double $$7 = $$4.c();
      if ($$3.o() == jm.a.b) {
   ...
   protected cwb a(ky $$0, cwb $$1, cwb $$2) {
      $$1.h(1);
      if ($$1.f()) {
         return $$2;
      } else {
