...
public class anu {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("particle").requires($$0x -> $$0x.c(2)))
            .then(
               ((RequiredArgumentBuilder)ey.a("name", fu.a($$1))
                     .executes(
                        $$0x -> a(
                              (ex)$$0x.getSource(), fu.a($$0x, "name"), ((ex)$$0x.getSource()).d(), fbb.c, 0.0F, 0, false, ((ex)$$0x.getSource()).l().ag().t()
                           )
                     ))
                  .then(
                     ((RequiredArgumentBuilder)ey.a("pos", ha.a())
                           .executes(
                              $$0x -> a((ex)$$0x.getSource(), fu.a($$0x, "name"), ha.a($$0x, "pos"), fbb.c, 0.0F, 0, false, ((ex)$$0x.getSource()).l().ag().t())
                           ))
                        .then(
   ...
   private static int a(ex $$0, lr $$1, fbb $$2, fbb $$3, float $$4, int $$5, boolean $$6, Collection<are> $$7) throws CommandSyntaxException {
      int $$8 = 0;
