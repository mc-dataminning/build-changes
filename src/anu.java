...
public class anu implements anr {
   ...
   private final Map<ans, List<Path>> g;

   anu(anm $$0, Set<String> $$1, List<Path> $$2, Map<ans, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(ans $$0, agg $$1, Consumer<Path> $$2) {
   ...
   public void a(ans $$0, String $$1, String $$2, anr.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<agg, aov<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(anr.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      ant.a($$1, $$4, $$3, $$0);
   }
   ...
   public aov<InputStream> a(ans $$0, agg $$1) {
      return (aov<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && ant.a($$5)) {
               return aov.create($$5);
            }
         }
   ...
   public <T> T a(aod<T> $$0) {
      aov<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public apg c() {
      return $$0 -> Optional.ofNullable(this.a(ans.a, $$0)).map($$0x -> new apb(this, $$0x));
   }
}
