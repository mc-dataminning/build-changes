...
public class anu {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wz.c("commands.random.error.range_too_large"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wz.c("commands.random.error.range_too_small"));
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("random").then(a("value", false))).then(a("roll", true)))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("reset").requires($$0x -> $$0x.c(2)))
                  ...
                  .then(
                     ((RequiredArgumentBuilder)eu.a("sequence", fu.a()).suggests(anu::a).executes($$0x -> a((et)$$0x.getSource(), fu.c($$0x, "sequence"))))
                        .then(
                           ((RequiredArgumentBuilder)eu.a("seed", IntegerArgumentType.integer())
      ...
      return (LiteralArgumentBuilder<et>)eu.a($$0)
         .then(
            ((RequiredArgumentBuilder)eu.a("range", fr.a()).executes($$1x -> a((et)$$1x.getSource(), fr.b.a($$1x, "range"), null, $$1)))
               .then(
                  ((RequiredArgumentBuilder)eu.a("sequence", fu.a()).suggests(anu::a).requires($$0x -> $$0x.c(2)))
   ...
   private static int a(et $$0, dh.d $$1, @Nullable akr $$2, boolean $$3) throws CommandSyntaxException {
      ayw $$4;
      if ($$2 != null) {
         $$4 = $$0.e().a($$2);
      } else {
      ...
      if ($$8 == 0L) {
         ...
         int $$9 = ayo.b($$4, $$6, $$7);
         if ($$3) {
            $$0.l().ah().a(wz.a("commands.random.roll", $$0.b(), $$9, $$6, $$7), false);
         } else {
            $$0.a(() -> wz.a("commands.random.sample.success", $$9), false);
         }
   ...
   private static int a(et $$0, akr $$1) throws CommandSyntaxException {
      $$0.e().L().b($$1);
      $$0.a(() -> wz.a("commands.random.reset.success", wz.a($$1)), false);
      return 1;
   }

   private static int a(et $$0, akr $$1, int $$2, boolean $$3, boolean $$4) throws CommandSyntaxException {
      $$0.e().L().a($$1, $$2, $$3, $$4);
      $$0.a(() -> wz.a("commands.random.reset.success", wz.a($$1)), false);
      return 1;
   }
   ...
   private static int a(et $$0) {
      int $$1 = $$0.e().L().a();
      $$0.a(() -> wz.a("commands.random.reset.all.success", $$1), false);
      return $$1;
   }
   ...
   private static int a(et $$0, int $$1, boolean $$2, boolean $$3) {
      ...
      $$4.a($$1, $$2, $$3);
      int $$5 = $$4.a();
      $$0.a(() -> wz.a("commands.random.reset.all.success", $$5), false);
      return $$5;
   }
}
