...
public class anu implements AutoCloseable {
   ...
   private anu(URL $$0, anu.c $$1, URL $$2, anu.b $$3, URL $$4, anu.b $$5, String $$6, anu.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static anu a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = ato.a($$0);
            URI $$2 = new URI(ato.i($$1, "apiServer"));
            String $$3 = ato.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = ato.a($$1, "ruleId", 1);
               String $$5 = ato.a($$1, "serverId", "");
               String $$6 = ato.a($$1, "roomId", "Java:Chat");
               int $$7 = ato.a($$1, "hashesToDrop", -1);
               int $$8 = ato.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = ato.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, anu.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<ang> a(GameProfile $$0, String $$1, anu.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(ang.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = ato.a($$4, "response", false);
            if ($$5) {
               return ang.a($$1);
            } else {
               String $$6 = ato.a($$4, "hashed", null);
               if ($$6 == null) {
                  return ang.b($$1);
               } else {
                  JsonArray $$7 = ato.v($$4, "hashes");
                  vf $$8 = this.a($$1, $$7, $$2);
                  return new ang($$1, $$8);
               }
            }
   ...
   private vf a(String $$0, JsonArray $$1, anu.a $$2) {
      if ($$1.isEmpty()) {
         return vf.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return vf.b;
      } else {
         vf $$3 = new vf($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new anu.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public ant a(GameProfile $$0) {
      return new anu.d($$0);
   }
   ...
   public interface a {
      anu.a a = ($$0, $$1) -> false;
      anu.a b = ($$0, $$1) -> $$0.length() == $$1;

      static anu.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static anu.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ant {
      ...
      d(GameProfile $$0) {
         this.c = $$0;
         bie<Runnable> $$1 = bie.a(anu.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         anu.this.a(this.c, anu.this.g, anu.this.h, this.d);
      }

      @Override
      public void b() {
         anu.this.a(this.c, anu.this.i, anu.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<ang>> a(List<String> $$0) {
         List<CompletableFuture<ang>> $$1 = $$0.stream().map($$0x -> anu.this.a(this.c, $$0x, anu.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<ang> a(String $$0) {
         return anu.this.a(this.c, $$0, anu.this.l, this.d);
      }
   }
