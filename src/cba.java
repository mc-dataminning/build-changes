...
public class cba<T extends cjr & cjv> extends caa {
   private final T a;
   ...
   public cba(T $$0, double $$1, int $$2, float $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3 * $$3;
   ...
   public void e() {
      btc $$0 = this.a.p();
      if ($$0 != null) {
         double $$1 = this.a.i($$0.dw(), $$0.dy(), $$0.dC());
