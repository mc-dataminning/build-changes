...
public class cba {
   public static final Codec<cba> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arf.i.fieldOf("ticks_since_last_warning").orElse(0).forGetter($$0x -> $$0x.g),
               arf.i.fieldOf("warning_level").orElse(0).forGetter($$0x -> $$0x.h),
               arf.i.fieldOf("cooldown_ticks").orElse(0).forGetter($$0x -> $$0x.i)
            )
            .apply($$0, cba::new)
   );
   ...
   public static OptionalInt a(akq $$0, gw $$1, akr $$2) {
      if (a($$0, $$1)) {
   ...
   private static List<akr> b(akq $$0, gw $$1) {
      ehn $$2 = ehn.b($$1);
      Predicate<akr> $$3 = $$1x -> $$1x.dj().a((ho)$$2, 16.0);
