...
public class cba extends cao {
   ...
   public cba(btz $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!cem.a(this.a)) {
         ...
         if (this.e && this.a.dP().R()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               evs $$2 = ceo.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.c($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<iz> $$3x = $$0.y().d($$0xx -> $$0xx.a(axa.b), this::a, $$2x, 10, ceu.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<iz> $$3 = $$0.y().d($$0x -> $$0x.a(axa.b), this::a, iz.a($$2), 10, ceu.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().i();
                     ...
                     $$4.b($$5);
                     if (this.c == null) {
                        evs $$6 = cel.a(this.a, 10, 7, evs.c(this.d), (float) (Math.PI / 2));
                        if ($$6 == null) {
                           return false;
                        }
