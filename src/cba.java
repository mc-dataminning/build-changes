public abstract class cba extends ccf implements cbf {
   private static final aim<Boolean> b = aiq.a(cba.class, aio.k);

   public cba(bpc<? extends cba> $$0, cwz $$1) {
      super($$0, $$1);
      this.bO = new cba.a(this);
   }

   public static bqu.a r() {
      return bpq.A().a(bqv.q, 3.0);
   }
   ...
   protected void z() {
      ...
      this.bR.a(2, new bvs<>(this, cis.class, 8.0F, 1.6, 1.4, bpb.f::test));
      this.bR.a(4, new cba.b(this));
   }
   ...
   static class a extends bvo {
      ...
      public void a() {
         ...
         if (this.k == bvo.a.b && !this.l.K().l()) {
            float $$0 = (float)(this.h * this.l.g(bqv.r));
