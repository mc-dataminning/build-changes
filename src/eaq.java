...
public class eaq extends eax<edi> {
   private static final dsk a = dsk.a(dfa.I);
   private final dsb b = dfa.I.o();
   private final dsb c = dfa.jF.o();
   private final dsb d = dfa.aV.o();
   private final dsb an = dfa.G.o();

   public eaq(Codec<edi> $$0) {
      super($$0);
   }
   ...
   private static void b(dcs $$0, iz $$1) {
      $$0.a($$1, dfa.J.o(), 3);
      $$0.a($$1, dpi.N).ifPresent($$1x -> $$1x.a(eqd.bd, $$1.a()));
   }
}
