...
public class bbg extends bfv {
   public bbg(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgx.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgx.s, "minecraft:jukebox");
