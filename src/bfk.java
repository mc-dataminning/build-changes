...
public class bfk extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bho.D.typeName(), bjc.a()));
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$2x -> {
            ...
            if ($$4.filter($$0xx -> $$0xx.equals("minecraft:white_banner")).isPresent()) {
               return $$2x.updateTyped($$2, $$0xx -> $$0xx.update(DSL.remainderFinder(), bfk::b));
            } else {
               return $$4.filter($$0xx -> $$0xx.equals("minecraft:filled_map")).isPresent()
                  ? $$2x.updateTyped($$2, $$0xx -> $$0xx.update(DSL.remainderFinder(), bfk::a))
                  : $$2x;
            }
         }
      );
   ...
   private static <T> Dynamic<T> a(Dynamic<T> $$0, Predicate<String> $$1) {
      ...
      Optional<String> $$3 = $$2.asString().result().flatMap(ban::a).filter($$1);
