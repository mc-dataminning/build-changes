...
public class bfk extends DataFix {
         ...
         ImmutableMap.of(
            ...
            a(
               ...
               DSL.taggedChoiceType(
                  ...
                  ImmutableMap.of(
                     "minecraft:fixed",
                     a("biome", $$0.getType(bgr.K)),
                     "minecraft:multi_noise",
                     DSL.list(a("biome", $$0.getType(bgr.K))),
                     "minecraft:checkerboard",
                     a("biomes", DSL.list($$0.getType(bgr.K))),
               ...
               "settings",
               DSL.or(DSL.string(), a("default_block", $$0.getType(bgr.C), "default_fluid", $$0.getType(bgr.C)))
            )
         )
      );
      CompoundListType<String, ?> $$2 = DSL.compoundList(bid.a(), a("generator", $$1));
      Type<?> $$3 = DSL.and($$2, DSL.remainderType());
      Type<?> $$4 = $$0.getType(bgr.M);
   ...
   protected static Type<? extends Pair<? extends Either<? extends Pair<? extends Either<?, Unit>, ? extends Pair<? extends Either<? extends List<? extends Pair<? extends Either<?, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>> a(
      ...
      return b("settings", a("biome", $$0.getType(bgr.K), "layers", DSL.list(b("block", $$0.getType(bgr.C)))));
   }
