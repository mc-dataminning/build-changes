...
public interface bkp<T, F> {
   ...
   public static final class a implements bkp<bkp.b, Runnable> {
   ...
   public static final class c<T> implements bkp<T, T> {
