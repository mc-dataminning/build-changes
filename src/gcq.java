public class gcq extends gdl {
   private final gdg a;

   gcq(fzd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gdg $$7) {
   ...
   public static class a implements gco<lq> {
      ...
      public gcl a(lq $$0, fzd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gcq($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gco<lq> {
      ...
      public gcl a(lq $$0, fzd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gcl $$8 = new gcq($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
