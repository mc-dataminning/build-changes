public class gcq<S extends gzd> extends gcc<S> implements gaw, gcl {
   private final gfe a;
   private final gfe b;
   private final gfe c;
   private final gfe d;
   ...
   public static gfk a() {
      gfm $$0 = new gfm();
      gfo $$1 = $$0.a();
      gfo $$2 = $$1.a("head", gfj.c().a(0, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F), gfg.a(0.0F, 0.0F, 0.0F));
      $$2.a("hat", gfj.c().a(32, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 12.0F, 8.0F, new gfi(0.45F)), gfg.a);
      $$2.a("nose", gfj.c().a(24, 0).a(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F), gfg.a(0.0F, -2.0F, 0.0F));
      $$1.a(
         "body",
         gfj.c().a(16, 20).a(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F).a(0, 38).a(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new gfi(0.5F)),
         gfg.a(0.0F, 0.0F, 0.0F)
      );
      gfo $$3 = $$1.a(
         "arms",
         gfj.c().a(44, 22).a(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F).a(40, 38).a(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F),
         gfg.a(0.0F, 3.0F, -1.0F, -0.75F, 0.0F, 0.0F)
      );
      $$3.a("left_shoulder", gfj.c().a(44, 22).a().a(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F), gfg.a);
      ...
      $$1.a("right_arm", gfj.c().a(40, 46).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), gfg.a(-5.0F, 2.0F, 0.0F));
      $$1.a("left_arm", gfj.c().a(40, 46).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), gfg.a(5.0F, 2.0F, 0.0F));
   ...
   public void a(S $$0) {
      ...
      if ($$3 == clg.a.b) {
         if ($$0.aW_().c()) {
            gau.a(this.g, this.f, true, $$0.m, $$0.u);
         } else {
            gau.a(this.f, this.g, $$0.d, $$0.m, $$0.u);
         }
      } else if ($$3 == clg.a.c) {
         this.f.d = 0.0F;
         this.f.b = -5.0F;
         ...
         gau.a(this.f, this.g, this.a, true);
      } else if ($$3 == clg.a.f) {
         gau.a(this.f, this.g, (float)$$0.k, $$0.l, true);
      } else if ($$3 == clg.a.g) {
         this.f.d = 0.0F;
         this.f.b = -5.0F;
