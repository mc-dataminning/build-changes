...
public class gcq implements fud, fux {
   ...
   public gcq(gcy $$0, boolean $$1) {
      this.l = $$0;
      this.m = $$1;
   }

   public void a(gcv $$0, baz $$1, boolean $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      this.j = $$0;
      List<dfl> $$8 = $$0.a(gcv.a.b);
      List<dfl> $$9 = $$2 ? Collections.emptyList() : $$0.a(gcv.a.c);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         dfl $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.h + 4 + 25 * ($$20 % $$12);
         int $$24 = this.i + 5 + 25 * ($$20 / $$12);
         if (this.m) {
            this.f.add(new gcq.c($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         } else {
            this.f.add(new gcq.a($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         }
      }
   ...
   public void a(fsm $$0, int $$1, int $$2, float $$3) {
      if (this.g) {
         ...
         int $$7 = 4;
         $$0.a(grc::H, b, this.h, this.i, $$5 * 25 + 8, $$6 * 25 + 8);
   ...
   class a extends gcq.b {
      ...
      public a(final int $$0, final int $$1, final dfm $$2, final dfk $$3, final baz $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<gcq.b.a> a(dfk $$0, baz $$1) {
         List<gcq.b.a> $$2 = new ArrayList<>();
   ...
   abstract class b extends fsy {
      final dfm b;
      private final boolean c;
      private final List<gcq.b.a> d;

      public b(final int $$0, final int $$1, final dfm $$2, final boolean $$3, final List<gcq.b.a> $$4) {
      ...
      protected static gcq.b.a a(int $$0, int $$1, List<czn> $$2) {
         return new gcq.b.a(3 + $$0 * 7, 3 + $$1 * 7, $$2);
      }
      ...
      public void b(fsm $$0, int $$1, int $$2, float $$3) {
         $$0.a(grc::H, this.b(this.c), this.F(), this.G(), this.g, this.h);
         float $$4 = (float)(this.F() + 2);
         float $$5 = (float)(this.G() + 2);
         float $$6 = 150.0F;

         for (gcq.b.a $$7 : this.d) {
            $$0.c().a();
            $$0.c().a($$4 + (float)$$7.a, $$5 + (float)$$7.b, 150.0F);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0F, -8.0F, 0.0F);
            $$0.a($$7.a(gcq.this.l.currentIndex()), 0, 0);
            $$0.c().b();
         }
      }

      protected static record a(int a, int b, List<czn> c) {

         public a(int a, int b, List<czn> c) {
            if (c.isEmpty()) {
   ...
   class c extends gcq.b {
      ...
      public c(final int $$0, final int $$1, final dfm $$2, final dfk $$3, final baz $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }
