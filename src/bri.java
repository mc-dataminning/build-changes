...
public class bri implements brj {
   ...
   private static final bri k = new bri();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(brh $$0) {
      URL $$1 = bri.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, brh $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final brl a = new brl(() -> bri.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bri.this.l && $$0.getState() == RecordingState.STOPPED) {
