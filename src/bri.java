...
public class bri {
   ...
   private static void a(brq $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<brr> $$0) {
      JsonObject $$1 = new JsonObject();
      brv<brr> $$2 = brv.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(brr::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         brv<brr> $$6 = brv.a((List<brr>)$$4);
         ...
         Function<brr, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<edf, brv<brk>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((brv)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<edf, brv<brk>> $$3 : $$0) {
         brv<brk> $$4 = (brv<brk>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((edf)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<brt> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqx.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(brg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bri::a));
      $$1.add("chunksWritten", this.a($$0.m(), bri::a));
      return $$1;
   }
   ...
   private JsonElement c(brg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bri::a));
      $$1.add("received", this.a($$0.k(), bri::a));
      return $$1;
   }

   private <T> JsonElement a(brp<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<brm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<brm>, ToDoubleFunction<brm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, brm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, brm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, brm::c));
      return $$1;
   }
}
