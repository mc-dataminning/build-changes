...
public class ll {
   ...
   public aeu a(csq $$0, BiConsumer<aeu, Supplier<JsonElement>> $$1) {
      return this.A.a($$0, this.z, $$1);
   }

   public aeu a(csq $$0, String $$1, BiConsumer<aeu, Supplier<JsonElement>> $$2) {
      return this.A.a($$0, $$1, this.z, $$2);
   }

   private static ll.a a(Function<csq, lj> $$0, lh $$1) {
      return $$2 -> new ll($$0.apply($$2), $$1);
   }

   public static ll a(aeu $$0) {
   ...
   public interface a {
      ...
      default aeu create(csq $$0, BiConsumer<aeu, Supplier<JsonElement>> $$1) {
         return this.get($$0).a($$0, $$1);
      }

      default aeu createWithSuffix(csq $$0, String $$1, BiConsumer<aeu, Supplier<JsonElement>> $$2) {
