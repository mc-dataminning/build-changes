...
public class hel {
   ...
   public static CompletableFuture<akv> a(akv $$0, Path $$1, String $$2, boolean $$3) {
      return CompletableFuture.<feu>supplyAsync(() -> {
         feu $$3x;
         try {
            $$3x = a($$1, $$2);
   ...
   private static feu a(Path $$0, String $$1) throws IOException {
      if (Files.isRegularFile($$0)) {
         ...
         feu $$7;
         try {
            $$3 = (HttpURLConnection)$$4.toURL().openConnection(flj.Q().Z());
            $$3.setDoInput(true);
            $$3.setDoOutput(false);
            $$3.connect();
   ...
   private static CompletableFuture<akv> a(akv $$0, feu $$1) {
      flj $$2 = flj.Q();
   ...
   private static feu a(feu $$0, String $$1) {
      int $$2 = $$0.b();
      int $$3 = $$0.a();
      if ($$3 == 64 && ($$2 == 32 || $$2 == 64)) {
         boolean $$4 = $$2 == 32;
         if ($$4) {
            feu $$5 = new feu(64, 64, true);
            $$5.a($$0);
            $$0.close();
            $$0 = $$5;
            $$5.a(0, 32, 64, 32, 0);
