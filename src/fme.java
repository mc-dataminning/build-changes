...
public class fme {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.i.d("gamemode " + ((dhe)MoreObjects.firstNonNull(this.b.r.i(), dhe.b)).b());
               }
   ...
   private void a(dxu $$0, jh $$1, @Nullable ux $$2) {
   ...
   private void a(alz $$0, fbx $$1, @Nullable ux $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = ffm.a(fmf.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!ffm.a(fmf.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ffm.a(fmf.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ae.c();
            this.e = ae.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxi) || ((fxi)$$6).u <= ae.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fmn.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aM_() instanceof fon) || !((fon)$$6.aM_()).c();
            if ($$7) {
               if (ftx.r() && $$1 == 66 && this.b.aZ().a() && this.b.n.w().c()) {
                  boolean $$8 = this.b.n.av().c() == fmh.a;
                  this.b.n.av().a(fmh.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof fts $$14 && !$$14.l()) {
                  break label153;
               }
