...
public class fme {
   public static List<fnp> a(fme.a... $$0) {
      for (fme.a $$1 : $$0) {
         a($$1.j);
      }

      List<fnp> $$2 = Lists.newArrayList();

      for (fme.a $$3 : $$0) {
         $$2.add(new fnp($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fnp::a));
      return $$2;
   }
   ...
   public static List<fnp> a() {
      return a(fme.a.values());
   }
