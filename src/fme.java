...
public class fme {
   ...
   private static final xj h = xj.c("chat.deleted_marker").a(n.h, n.u);
   private final fke i;
   private final axz<String> j = new axz<>(100);
   private final List<fjx> k = Lists.newArrayList();
   private final List<fjx.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fme.a> o = new ArrayList<>();
   ...
   public void a(flq $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            if ($$33 > 0L) {
               ...
               $$0.a(-2, 0, $$9 + 4, 9, $$35 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, xj.a("chat.queue", $$33), 0, 1, 16777215 + ($$34 << 24));
               $$0.c().b();
            }
   ...
   private void a(flq $$0, int $$1, int $$2, fjy.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fjx.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == cor.c;
   }
   ...
   public void a(xj $$0) {
      this.a($$0, null, this.i.W() ? fjy.b() : fjy.a());
   }

   public void a(xj $$0, @Nullable xv $$1, @Nullable fjy $$2) {
      fjx $$3 = new fjx(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fjx $$0) {
      ...
      List<ayy> $$3 = fmi.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fjx.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fme.a b(xv $$0) {
      int $$1 = this.i.m.e();
      ListIterator<fjx> $$2 = this.k.listIterator();
   ...
   private fjx d(fjx $$0) {
      return new fjx($$0.b(), h, null, fjy.a());
   }
   ...
   private void n() {
      ...
      for (fjx $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public fjy c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fjx.a $$1, fjy $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fjy.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.z instanceof fqs;
   }
   ...
   public fme.b k() {
      return new fme.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }
   ...
   public static class b {
      ...
      public b(List<fjx> $$0, List<String> $$1, List<fme.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
