...
public class ebe extends eay<edd> {
   private static final je[] a = je.values();

   public ebe(Codec<edd> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<edd> $$0) {
      edd $$1 = $$0.f();
      azh $$2 = $$0.d();
      iz $$3 = $$0.e();
      dct $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dyt $$9 = new dyt(new dxv($$4.C()));
      emy $$10 = emy.a($$9, -4, 1.0);
      ...
      for (iz $$44 : $$31) {
         ...
         for (je $$46 : a) {
            ...
            dsc $$48 = $$4.a_($$47);
            if ($$45.b(dss.C)) {
               $$45 = $$45.a(dss.C, Boolean.valueOf($$48.u().b()));
            }
