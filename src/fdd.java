...
public class fdd {
   ...
   @Nullable
   public fcv a(@Nullable String $$0) {
      return (fcv)this.c.get($$0);
   }

   public fcv a(String $$0, fdg $$1, xv $$2, fdg.a $$3, boolean $$4, @Nullable zl $$5) {
      if (this.c.containsKey($$0)) {
         throw new IllegalArgumentException("An objective with the name '" + $$0 + "' already exists!");
      } else {
         fcv $$6 = new fcv(this, $$0, $$1, $$2, $$3, $$4, $$5);
   ...
   public final void a(fdg $$0, fdc $$1, Consumer<fdb> $$2) {
      ((List)this.d.getOrDefault($$0, Collections.emptyList())).forEach($$2x -> $$2.accept(this.a($$1, $$2x, true)));
   }

   private fcx f(String $$0) {
      return this.e.computeIfAbsent($$0, $$0x -> new fcx());
   }

   public fdb c(fdc $$0, fcv $$1) {
      return this.a($$0, $$1, false);
   }

   public fdb a(final fdc $$0, final fcv $$1, boolean $$2) {
      final boolean $$3 = $$2 || !$$1.c().e();
      fcx $$4 = this.f($$0.cI());
      final MutableBoolean $$5 = new MutableBoolean();
      final fda $$6 = $$4.a($$1, $$1x -> $$5.setTrue());
      return new fdb() {
         @Override
         public int a() {
            return $$6.a();
   ...
   @Nullable
   public fcz d(fdc $$0, fcv $$1) {
      fcx $$2 = this.e.get($$0.cI());
      return $$2 != null ? $$2.a($$1) : null;
   }

   public Collection<fcw> i(fcv $$0) {
      List<fcw> $$1 = new ArrayList<>();
      this.e.forEach(($$2, $$3) -> {
         fda $$4 = $$3.a($$0);
         if ($$4 != null) {
            $$1.add(new fcw($$2, $$4.a(), $$4.d(), $$4.c()));
         }
      });
      return $$1;
   }
   ...
   public void b(fdc $$0) {
      fcx $$1 = this.e.remove($$0.cI());
      if ($$1 != null) {
         this.a($$0);
      }
   }

   public void e(fdc $$0, fcv $$1) {
      fcx $$2 = this.e.get($$0.cI());
      if ($$2 != null) {
         boolean $$3 = $$2.b($$1);
         if (!$$2.a()) {
            fcx $$4 = this.e.remove($$0.cI());
            if ($$4 != null) {
               this.a($$0);
            }
         } else if ($$3) {
   ...
   public Object2IntMap<fcv> c(fdc $$0) {
      fcx $$1 = this.e.get($$0.cI());
   ...
   public void j(fcv $$0) {
      ...
      for (fcu $$1 : fcu.values()) {
         if (this.a($$1) == $$0) {
            this.a($$1, null);
         }
      }

      List<fcv> $$2 = (List<fcv>)this.d.get($$0.c());
      if ($$2 != null) {
         $$2.remove($$0);
      }

      for (fcx $$3 : this.e.values()) {
         $$3.b($$0);
      }
   ...
   @Nullable
   public fcy b(String $$0) {
      return (fcy)this.g.get($$0);
   }

   public fcy c(String $$0) {
      fcy $$1 = this.b($$0);
      if ($$1 != null) {
   ...
   @Nullable
   public fcy e(String $$0) {
      return (fcy)this.h.get($$0);
   }
