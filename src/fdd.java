...
public class fdd extends evi {
   ...
   private void a(vd $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            fde.b $$9 = fde.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            fde.b $$10 = fde.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            fde.a $$11 = fde.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(vd $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         fdf $$5 = fdf.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, fdf.b.d());
            return fdf.b;
         });
         String $$6 = $$3.l("Name");
         xv $$7 = xv.a.a($$3.l("DisplayName"), $$1);
         fdf.a $$8 = fdf.a.a($$3.l("RenderType"));
