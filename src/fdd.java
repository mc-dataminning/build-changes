...
public abstract class fdd extends fcc {
   private final dhm b;
   private dhn c;
   ...
   public fdd(dhm $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, vb.c("sign.edit"));
   }

   public fdd(dhm $$0, boolean $$1, boolean $$2, vb $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = dcy.a($$0.r().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(vb::getString).toArray(String[]::new);
   }

   @Override
   protected void aP_() {
      this.d(ewh.a(va.d, $$0 -> this.D()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new eyz(() -> this.k[this.n], this::a, eyz.a(this.f), eyz.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   public void aG_() {
      fmu $$0 = this.f.I();
      if ($$0 != null) {
         $$0.b(new aeo(this.b.aB_(), this.l, this.k[0], this.k[1], this.k[2], this.k[3]));
      }
   }
   ...
   protected abstract void a(evw var1, dip var2);
   ...
   private void d(evw $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fuw.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(fsq.D(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
