...
public class fdd extends gvb {
   ...
   public void aN_() {
      this.a(this.I.a);
      this.c(fgz.a(xl.c("mco.configure.world.subscription.extend"), $$0 -> flp.a(this, axq.a(this.I.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.I.j) {
         this.c(fgz.a(xl.c("mco.configure.world.delete.button"), $$0 -> {
            xl $$1 = xl.c("mco.configure.world.delete.question.line1");
            xl $$2 = xl.c("mco.configure.world.delete.question.line2");
            this.m.a(new fcp(this::c, fcp.a.a, $$1, $$2, true));
         }).a(this.n / 2 - 100, g(10), 200, 20).a());
      } else if (fae.b() && this.I.s != null) {
         this.c(new fhj(this.n / 2 - 100, g(8), 200, 46, xl.a("mco.snapshot.subscription.info", this.I.s), this.p).a(-6250336));
      } else {
         this.c(new fhj(this.n / 2 - 100, g(8), 200, 46, G, this.p).a(-6250336));
      }

      this.c(fgz.a(xk.k, $$0 -> this.d()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  fdd.a.error("Couldn't delete world", var2);
               }

               fdd.this.m.execute(() -> fdd.this.m.a(fdd.this.J));
            }
         }).start();
      }
