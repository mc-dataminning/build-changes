...
public class ajk {
   ...
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> tl.b("commands.data.get.invalid", $$0));
   private static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> tl.b("commands.data.get.unknown", $$0));
   private static final SimpleCommandExceptionType g = new SimpleCommandExceptionType(tl.c("commands.data.get.multiple"));
   private static final DynamicCommandExceptionType h = new DynamicCommandExceptionType($$0 -> tl.b("commands.data.modify.expected_object", $$0));
   private static final DynamicCommandExceptionType i = new DynamicCommandExceptionType($$0 -> tl.b("commands.data.modify.expected_value", $$0));
   private static final Dynamic2CommandExceptionType j = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> tl.b("commands.data.modify.invalid_substring", $$0, $$1)
   );
   public static final List<Function<String, ajk.c>> a = ImmutableList.of(ajl.a, aji.a, ajm.a);
   public static final List<ajk.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<ajk.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<dt> $$0) {
      ...
      for (ajk.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<dt, ?>, ajk.b>)(($$0x, $$1x) -> $$0x.then(
                           du.a("insert")
                              .then(
   ...
   private static List<rq> a(List<rq> $$0, ajk.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<dt, ?> a(BiConsumer<ArgumentBuilder<dt, ?>, ajk.b> $$0) {
   ...
   private static List<rq> a(CommandContext<dt> $$0, ajk.c $$1) throws CommandSyntaxException {
      ajj $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<rq> b(CommandContext<dt> $$0, ajk.c $$1) throws CommandSyntaxException {
      ajj $$2 = $$1.a($$0);
      ej.g $$3 = ej.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<dt> $$0, ajk.c $$1, ajk.a $$2, List<rq> $$3) throws CommandSyntaxException {
      ajj $$4 = $$1.a($$0);
   ...
   private static int a(dt $$0, ajj $$1, ej.g $$2) throws CommandSyntaxException {
      qw $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static rq a(ej.g $$0, ajj $$1) throws CommandSyntaxException {
   ...
   private static int b(dt $$0, ajj $$1, ej.g $$2) throws CommandSyntaxException {
      rq $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof rk) {
         $$4 = asb.a(((rk)$$3).j());
   ...
   private static int a(dt $$0, ajj $$1, ej.g $$2, double $$3) throws CommandSyntaxException {
      rq $$4 = a($$2, $$1);
      if (!($$4 instanceof rk)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = asb.a(((rk)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(dt $$0, ajj $$1) throws CommandSyntaxException {
      qw $$2 = $$1.a();
      $$0.a(() -> $$1.a((rq)$$2), false);
      return 1;
   }

   private static int a(dt $$0, ajj $$1, qw $$2) throws CommandSyntaxException {
      qw $$3 = $$1.a();
      if (ej.g.a($$2, 0)) {
         throw ej.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<dt, ?> create(ajk.a var1);
   }

   public interface c {
      ajj a(CommandContext<dt> var1) throws CommandSyntaxException;
