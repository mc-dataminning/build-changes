...
public class dme {
   ...
   public static MapCodec<dme> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               cxq.b.optionalFieldOf("spawn_data").forGetter($$0x -> $$0x.h),
   ...
   public dme(Set<UUID> $$0, Set<UUID> $$1, long $$2, long $$3, int $$4, Optional<cxq> $$5, Optional<ajh> $$6) {
      this.c.addAll($$0);
      this.d.addAll($$1);
      this.e = $$2;
      this.f = $$3;
   ...
   public void a(dmd $$0) {
      blm<cxq> $$1 = $$0.i();
      if ($$1.d()) {
         this.j = blm.a(this.h.orElseGet(cxq::new));
      } else {
         this.j = $$1;
      }
   }
   ...
   public boolean a(apf $$0, dmd $$1, int $$2) {
   ...
   public void a(apf $$0, ib $$1, dmb $$2, dmb.a $$3, int $$4) {
   ...
   public boolean a(apf $$0, dmd $$1, float $$2) {
      long $$3 = this.e - (long)$$1.h();
      return (float)$$0.X() >= (float)$$3 + $$2;
   }

   public boolean b(apf $$0, dmd $$1, float $$2) {
      long $$3 = this.e - (long)$$1.h();
   ...
   public void a(dmc $$0, axd $$1, bpc<?> $$2) {
      this.a($$0, $$1).a().a("id", ki.g.b($$2).toString());
   }

   protected cxq a(dmc $$0, axd $$1) {
      if (this.h.isPresent()) {
         return this.h.get();
      } else {
         this.h = Optional.of(this.j.b($$1).map(blo.b::b).orElseGet(cxq::new));
         $$0.e();
         return this.h.get();
      }
   }
   ...
   @Nullable
   public bow a(dmc $$0, cwz $$1, dmf $$2) {
      if ($$0.a($$1) && $$2.d()) {
         if (this.k == null) {
            ta $$3 = this.a($$0, $$1.E_()).a();
            if ($$3.b("id", 8)) {
               this.k = bpc.a($$3, $$1, Function.identity());
            }
         }
   ...
   public ta a(dmf $$0) {
      ...
      this.h
         .ifPresent($$1x -> $$1.a("spawn_data", (tx)cxq.b.encodeStart(to.a, $$1x).result().orElseThrow(() -> new IllegalStateException("Invalid SpawnData"))));
      return $$1;
   }
