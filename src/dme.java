...
public class dme extends dmm<dmd> {
   public dme(Codec<dmd> $$0) {
      super($$0);
   }

   public boolean a(dmd $$0, art $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dmh $$0, dmd $$1, dgu $$2, Function<gv, hf<cqi>> $$3, art $$4, djt $$5, cor $$6, dgt $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private void a(
      ...
      for (int $$20 = $$12; $$20 < $$13; $$20++) {
         double $$21 = 1.5 + (double)(aro.a((float)$$20 * (float) Math.PI / (float)$$13) * $$9);
         double $$22 = $$21 * $$14;
         $$21 *= (double)$$1.c.e.a($$16);
         $$22 = this.a($$1, $$16, $$22, (float)$$13, (float)$$20);
         float $$23 = aro.b($$11);
         float $$24 = aro.a($$11);
         $$6 += (double)(aro.b($$10) * $$23);
         $$7 += (double)$$24;
         $$8 += (double)(aro.a($$10) * $$23);
         $$11 *= 0.7F;
         $$11 += $$19 * 0.05F;
         $$10 += $$18 * 0.05F;
         $$19 *= 0.8F;
   ...
   private float[] a(dmh $$0, dmd $$1, art $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(dmd $$0, art $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - aro.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)aro.b($$1, 0.75F, 1.0F);
   }

   private boolean a(dmh $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
