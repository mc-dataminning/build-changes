...
public abstract class eyv extends exv {
   private final dds b;
   private ddt c;
   private final String[] k;
   private final boolean l;
   protected final dgl a;
   private int m;
   private int n;
   @Nullable
   private eut o;

   public eyv(dds $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, te.c("sign.edit"));
   }

   public eyv(dds $$0, boolean $$1, boolean $$2, te $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = czk.a($$0.q().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(te::getString).toArray(String[]::new);
   }

   @Override
   protected void aE_() {
      this.d(esi.a(td.d, $$0 -> this.C()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new eut(() -> this.k[this.n], this::a, eut.a(this.f), eut.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   private boolean B() {
      return this.f != null && this.f.t != null && !this.b.r() && !this.b.b(this.f.t.cv());
   }
   ...
   public void h() {
      fif $$0 = this.f.I();
      if ($$0 != null) {
         $$0.b(new acm(this.b.p(), this.l, this.k[0], this.k[1], this.k[2], this.k[3]));
      }
   }
   ...
   protected abstract void a(erx var1, dey var2);
   ...
   private void d(erx $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fpu.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(fno.E(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
