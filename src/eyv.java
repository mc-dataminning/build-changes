...
public class eyv extends eyy {
   public static final int a = 854;
   public static final int b = 480;
   static final eyv.b l = new eyv.b(854, 480);

   public eyv(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eyv.a[] e = values();
   ...
   static class b {
      ...
      static List<eyv.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyv.b($$0, $$1), eyv.l) : ImmutableList.of(eyv.l);
      }
