...
public class eyv extends eza {
   ...
   public void a(djz $$0, iw $$1, ebg $$2, @Nullable eyy $$3, boolean $$4) {
      ...
      for (boolean $$7 = true; $$6.hasNext(); $$7 = false) {
         ...
         int $$11 = b($$10);
         ebg $$12 = $$0.a_($$9);
         if ($$12.a(this.a) && !$$12.c(dtn.f).equals($$11)) {
            int $$13 = 2;
            if (!$$4 || !$$7) {
               $$13 |= 128;
            }

            $$0.a($$9, $$12.b(dtn.f, Integer.valueOf($$11)), $$13);
         } else {
            $$6.remove();
         }
      }
   ...
   private static boolean a(ebg $$0, jc $$1) {
      ece<ecl> $$2 = dtn.g.get($$1);
      return $$2 == null ? $$1 == jc.a : $$0.c($$2).a();
   }

   private static eyy a(djz $$0, @Nullable eyy $$1) {
      eyy $$2;
      if ($$1 != null) {
         $$2 = $$1;
      } else {
      ...
      return $$2.a(jc.b).a(eyy.a.a);
   }

   private void a(djz $$0, iw $$1, eyy $$2) {
      ebg $$3 = $$0.a_($$1);
      if ($$3.a(this.a)) {
         this.a($$1, $$3.c(dtn.f), $$2);
         this.b.add($$1);
      } else {
         this.a($$0, $$1, 0, $$2, true);
      }
   ...
   private static int a(eyy $$0, int $$1) {
      return $$0.i() << 4 | $$1;
   }

   private static eyy a(int $$0) {
      return eyy.a($$0 >> 4);
   }
   ...
   private void a(iw $$0, int $$1, eyy $$2) {
      this.d.compute($$0, ($$2x, $$3) -> $$3 == null ? a($$2, $$1) : a(a($$3), $$1));
   }

   private void a(djz $$0, iw $$1, int $$2, eyy $$3, boolean $$4) {
      for (jc $$5 : $$3.g()) {
         iw $$6 = $$1.a($$5);
   ...
   private void b(djz $$0, iw $$1, int $$2, eyy $$3, boolean $$4) {
      ebg $$5 = $$0.a_($$1);
      if ($$5.a(this.a)) {
         int $$6 = this.a($$1, $$5);
