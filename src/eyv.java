...
public class eyv {
   ...
   public void b(esf $$0, int $$1, int $$2) {
      ...
      aew $$3 = Objects.requireNonNullElse(this.f.d(), fzf.a);
      int $$4 = arw.a(this.k);
      int $$5 = arw.a(this.l);
      int $$6 = $$4 % 16;
      int $$7 = $$5 % 16;
   ...
   public void a(esf $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      $$0.a(0, 0, 234, 113, arw.d(this.q * 255.0F) << 24);
      boolean $$5 = false;
      int $$6 = arw.a(this.k);
      int $$7 = arw.a(this.l);
      ...
      $$0.c().b();
      if ($$5) {
         this.q = arw.a(this.q + 0.02F, 0.0F, 0.3F);
      } else {
         this.q = arw.a(this.q - 0.04F, 0.0F, 1.0F);
      }
   }
   ...
   public void a(double $$0, double $$1) {
      if (this.o - this.m > 234) {
         this.k = arw.a(this.k + $$0, (double)(-(this.o - 234)), 0.0);
      }

      if (this.p - this.n > 113) {
         this.l = arw.a(this.l + $$1, (double)(-(this.p - 113)), 0.0);
      }
   }
