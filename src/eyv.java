...
public class eyv {
   ...
   public static final eyv.a bv;

   public static eyv.a a(int $$0, int $$1) {
      return $$0 == -1 ? eyv.b.b.a($$1) : eyv.b.a.a($$0);
   }

   public static eyv.a a(String $$0) {
      if (eyv.a.e.containsKey($$0)) {
         return eyv.a.e.get($$0);
      } else {
         for (eyv.b $$1 : eyv.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eyv.b b;
      private final int c;
      private final ayt<xp> d;
      static final Map<String, eyv.a> e = Maps.newHashMap();

      a(String $$0, eyv.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eyv.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xp> g;

      private static void a(eyv.b $$0, String $$1, int $$2) {
         eyv.a $$3 = new eyv.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eyv.a a(int $$0) {
         return (eyv.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
