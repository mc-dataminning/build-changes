...
public class eyv {
   ...
   public eyv(eqv $$0, eyz $$1, eyw $$2, int $$3, ag $$4, aq $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void a(esf $$0, int $$1, int $$2, boolean $$3) {
   ...
   public void b(esf $$0, int $$1, int $$2) {
      if (!this.r) {
      ...
      aex $$3 = Objects.requireNonNullElse(this.f.d(), fzf.a);
      int $$4 = arx.a(this.k);
      int $$5 = arx.a(this.l);
      int $$6 = $$4 % 16;
      int $$7 = $$5 % 16;
   ...
   public void a(esf $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      $$0.a(0, 0, 234, 113, arx.d(this.q * 255.0F) << 24);
      boolean $$5 = false;
      int $$6 = arx.a(this.k);
      int $$7 = arx.a(this.l);
      if ($$1 > 0 && $$1 < 234 && $$2 > 0 && $$2 < 113) {
         for (eyx $$8 : this.j.values()) {
            if ($$8.a($$6, $$7, $$1, $$2)) {
               $$5 = true;
      ...
      $$0.c().b();
      if ($$5) {
         this.q = arx.a(this.q + 0.02F, 0.0F, 0.3F);
      } else {
         this.q = arx.a(this.q - 0.04F, 0.0F, 1.0F);
      }
   }
   ...
   @Nullable
   public static eyv a(eqv $$0, eyz $$1, int $$2, ag $$3) {
      Optional<aq> $$4 = $$3.a().d();
      if ($$4.isEmpty()) {
         return null;
      } else {
         for (eyw $$5 : eyw.values()) {
            if ($$2 < $$5.a()) {
               return new eyv($$0, $$1, $$5, $$2, $$3, $$4.get());
            }
   ...
   public void a(double $$0, double $$1) {
      if (this.o - this.m > 234) {
         this.k = arx.a(this.k + $$0, (double)(-(this.o - 234)), 0.0);
      }

      if (this.p - this.n > 113) {
         this.l = arx.a(this.l + $$1, (double)(-(this.p - 113)), 0.0);
      }
   }
   ...
   public void a(ag $$0) {
      Optional<aq> $$1 = $$0.a().d();
      if (!$$1.isEmpty()) {
         eyx $$2 = new eyx(this, this.a, $$0, $$1.get());
         this.a($$2, $$0.b());
      }
   }

   private void a(eyx $$0, af $$1) {
      this.j.put($$1, $$0);
      int $$2 = $$0.d();
      int $$3 = $$2 + 28;
      int $$4 = $$0.c();
