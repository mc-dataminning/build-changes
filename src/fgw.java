...
public class fgw {
   ...
   public static void a(File $$0, ezt $$1, Consumer<wz> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ezt $$2, Consumer<wz> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ezt $$2, Consumer<wz> $$3) {
      fah $$4 = a($$2);
   ...
   public static fah a(ezt $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fah $$3 = new fah($$1, $$2, false);
   ...
   public fgw(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
