...
public abstract class fgw extends fha implements fif, fiy {
   private static final fip a = new fip(new ale("widget/text_field"), new ale("widget/text_field_highlighted"));
   ...
   public fgw(int $$0, int $$1, int $$2, int $$3, xo $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return ayx.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = ayx.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fgp var1, int var2, int var3, float var4);
}
