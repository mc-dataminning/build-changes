...
public class cdq extends cde {
   ...
   public cdq(bim<? extends cdq> $$0, cpm $$1) {
      super($$0, $$1);
   }

   public cdq(cpm $$0, double $$1, double $$2, double $$3) {
   ...
   protected void a(@Nullable bhg $$0, double $$1) {
      if (!this.dK().B) {
         ...
         this.dK().a(this, $$0, null, this.dp(), this.dr(), this.dv(), (float)(4.0 + this.ag.j() * 1.5 * $$2), false, cpm.a.d);
         this.ak();
      }
   }
   ...
   public void A() {
      ...
      if (!this.dK().B) {
         ...
         if (!this.aS()) {
            this.dK().a(null, this.dp(), this.dr(), this.dv(), aow.xG, aox.e, 1.0F, 1.0F);
         }
      }
   }
