...
public class dqi extends dql<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dqi(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dqi $$1 && super.equals($$0)) {
   ...
   public static dqi a(String $$0, int $$1, int $$2) {
      return new dqi($$0, $$1, $$2);
   }
