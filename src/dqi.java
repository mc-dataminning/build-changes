...
public class dqi extends dpv<drs> {
   public dqi(Codec<drs> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dpx<drs> $$0) {
      ht $$1 = $$0.e();
      csu $$2 = $$0.b();
      $$1 = new ht($$1.u(), $$0.c().e(), $$1.w());
      ats $$3 = $$0.d();
      boolean $$4 = $$3.j() > 0.7;
      dhi $$5 = $$0.f().b;
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? atm.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(ats $$0, csb $$1, int $$2, int $$3, ht $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ht $$2, csb $$3, boolean $$4, double $$5, ht $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(csb $$0, ht $$1) {
      if ($$0.a_($$1.c()).a(cvc.dN)) {
         this.a($$0, $$1.c(), cvc.a.o());
      }
   }

   private void a(csb $$0, ats $$1, ht $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dhi $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, ht.b, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, ht.b, $$7, $$1);
      if ($$14 < 0.0) {
         ht $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(ht $$0, csb $$1, ats $$2, int $$3, int $$4, boolean $$5, boolean $$6, dhi $$7) {
      dhi $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cvc.dP) || $$8.a(cvc.dO) || $$8.a(cvc.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cvc.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cvc.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, ht $$2, int $$3, ats $$4) {
      float $$5 = 10.0F * atm.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, ht $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(ats $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(ats $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dhi $$0) {
      return $$0.a(cvc.iC) || $$0.a(cvc.dP) || $$0.a(cvc.mW);
   }
   ...
   private void a(csb $$0, ht $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cvc.dN)) {
                  if (this.a((crg)$$0, $$10)) {
                     this.a($$0, $$10, cvc.a.o());
                     this.a($$0, $$10.c(), cvc.a.o());
                  } else if (c($$11)) {
                     dhi[] $$12 = new dhi[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
