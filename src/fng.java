...
public class fng extends fnd {
   ...
   private int F;
   private final fid G = new fid(false);

   public fng(boolean $$0, Runnable $$1) {
      super(fff.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fng.a $$1) {
