...
public class fng extends fnd {
   ...
   public fng(eqv $$0, fix $$1, fiy $$2, apo $$3, eqi $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.p());
      this.cp = $$0;
      this.cn = $$2;
      this.cE = $$3;
   ...
   public void l() {
      if (this.dL().f(this.dp(), this.dv())) {
         super.l();
         if (this.bN()) {
            this.cn.b(new aby.c(this.dB(), this.dD(), this.aA()));
            this.cn.b(new acg(this.bk, this.bm, this.co.g, this.co.h));
            biq $$0 = this.cV();
            if ($$0 != this && $$0.cW()) {
               this.cn.b(new abz($$0));
               this.C();
   ...
   private void B() {
      ...
      boolean $$0 = this.bR();
      if ($$0 != this.cP) {
         acf.a $$1 = $$0 ? acf.a.a : acf.a.b;
         this.cn.b(new acf(this, $$1));
         this.cP = $$0;
      }
      ...
      if (this.v()) {
         ...
         this.cR++;
         boolean $$7 = arw.f($$2, $$3, $$4) > arw.k(2.0E-4) || this.cR >= 20;
         boolean $$8 = $$5 != 0.0 || $$6 != 0.0;
         if (this.bN()) {
            ehn $$9 = this.do();
            this.cn.b(new aby.b($$9.c, -999.0, $$9.e, this.dB(), this.dD(), this.aA()));
            $$7 = false;
         } else if ($$7 && $$8) {
            this.cn.b(new aby.b(this.dq(), this.ds(), this.dw(), this.dB(), this.dD(), this.aA()));
         } else if ($$7) {
            this.cn.b(new aby.a(this.dq(), this.ds(), this.dw(), this.aA()));
         } else if ($$8) {
            this.cn.b(new aby.c(this.dB(), this.dD(), this.aA()));
         } else if (this.cN != this.aA()) {
            this.cn.b(new aby.d(this.aA()));
         }
   ...
   public boolean a(boolean $$0) {
      ace.a $$1 = $$0 ? ace.a.d : ace.a.e;
      cjf $$2 = this.fR().a($$0);
      this.cn.b(new ace($$1, gw.b, ha.a));
      return !$$2.b();
   }
   ...
   protected void h() {
      this.cn.b(new acf(this, acf.a.f, arw.d(this.t() * 100.0F)));
   }

   public void i() {
      this.cn.b(new acf(this, acf.a.h));
   }
   ...
   public void b_() {
      ...
      float $$3 = arw.a(0.3F + cnq.b(this), 0.0F, 1.0F);
      this.co.a(this.u(), $$3);
      ...
      if (this.co.g && !$$10 && !$$0 && !this.fS().b && !this.bN() && !this.c_()) {
         ...
         if ($$11.a(cji.nh) && chz.d($$11) && this.fW()) {
            this.cn.b(new acf(this, acf.a.i));
         }
      }
      ...
      if (this.a(apx.a)) {
         int $$12 = this.M_() ? 10 : 1;
         this.db = arw.a(this.db + $$12, 0, 600);
      } else if (this.db > 0) {
         this.a(apx.a);
         this.db = arw.a(this.db - 10, 0, 600);
      }
   ...
   private void E() {
      ...
      if (this.av) {
         ...
         if (this.cv == 0.0F) {
            this.cp.ai().a(gch.b(apd.sW, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }
      ...
      this.cv = arw.a(this.cv + $$0, 0.0F, 1.0F);
      this.J();
   }
   ...
   protected boolean b(ehn $$0) {
      ...
      double $$2 = (double)arw.a($$1);
      double $$3 = (double)arw.b($$1);
      double $$4 = (double)this.bk * $$3 - (double)this.bm * $$2;
      double $$5 = (double)this.bm * $$3 + (double)this.bk * $$2;
      double $$6 = arw.k($$4) + arw.k($$5);
      double $$7 = arw.k($$0.c) + arw.k($$0.e);
   ...
   public float A() {
      if (!this.a(apx.a)) {
         ...
         if ((float)this.db >= 600.0F) {
            ...
            float $$2 = arw.a((float)this.db / 100.0F, 0.0F, 1.0F);
            float $$3 = (float)this.db < 100.0F ? 0.0F : arw.a(((float)this.db - 100.0F) / 500.0F, 0.0F, 1.0F);
   ...
   protected boolean fK() {
      ...
      if (this.M_()) {
         ...
         if (!$$0 && $$1) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.x, ape.i, 1.0F, 1.0F, false);
            this.cp.ai().a((gcm)(new gcp.b(this)));
         }

         if ($$0 && !$$1) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.y, ape.i, 1.0F, 1.0F, false);
         }
   ...
   public ehn q(float $$0) {
      if (this.cp.m.aw().a()) {
         float $$1 = arw.i($$0 * 0.5F, this.dB(), this.N) * (float) (Math.PI / 180.0);
