...
public class eiu implements eit {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<eiu> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               edg.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               edi.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               edh.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bsf.b(1, 20).fieldOf("outer_wall_distance").orElse(bsl.a(4, 5)).forGetter($$0x -> $$0x.i),
               bsf.b(1, 20).fieldOf("distribution_points").orElse(bsl.a(3, 4)).forGetter($$0x -> $$0x.j),
               bsf.b(0, 10).fieldOf("point_offset").orElse(bsl.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public eiu(edg $$0, edi $$1, edh $$2, double $$3, double $$4, boolean $$5, bsf $$6, bsf $$7, bsf $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
