...
public class foy {
   ...
   private static final Map<ecq.a, String> e = af.a(new EnumMap<>(ecq.a.class), $$0 -> {
      $$0.put(ecq.a.a, "SW");
      $$0.put(ecq.a.b, "S");
      $$0.put(ecq.a.c, "OW");
      $$0.put(ecq.a.d, "O");
   ...
   private dza l;
   @Nullable
   private CompletableFuture<dza> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   ...
   public foy(flh $$0) {
      ...
      this.g = new foy.a();
      this.h = $$0.h;
      this.w = new fqh(this.h, this.r);
      this.x = new fqk(this.h, this.s, () -> $$0.s.u().g());
      this.y = new fqi(this.h, this.t);
      this.z = new fqg(this.h, this.u);
      this.A = new fqj(this.h);
   }
   ...
   private void a(fob $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dgg $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arc ? ((arc)$$23).y() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayy.h($$15.dM()), ayy.h($$15.dO())));
         dza $$27 = this.u();
         if ($$27.E()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(dgp.a, $$14);
            int $$30 = this.f.s.a(dgp.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dza $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (ecq.a $$33 : ecq.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.w();
                  bsg $$37 = new bsg($$23.am(), $$23.ae(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dgr.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bvi> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bvi.values())
   ...
   private static String a(jr<dhi> $$0) {
   ...
   private dgg s() {
      return (dgg)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ai()))), this.f.s);
   }
   ...
   private dza t() {
      if (this.m == null) {
         ...
         this.m = $$0.m().b(this.k.h, this.k.i, dzr.n, false).thenApply($$0x -> (dza)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fel.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", flh.Q().aO().k(), flh.Q().aO().l(), fel.a()),
            fel.c(),
            fel.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == faw.a.b) {
            ...
            for (Entry<dxx<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == faw.a.b) {
            ...
            for (Entry<dxx<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dxx<?>, Comparable<?>> $$0) {
      dxx<?> $$1 = $$0.getKey();
