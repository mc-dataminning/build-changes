...
public class foy implements fcj {
   static final Logger b = LogUtils.getLogger();
   private final fdk c;
   private final fol<foy.b> d;

   foy(fdk $$0, fol<foy.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(all c, int d, int e, int[][] f) implements fpa {
      ...
      public static final MapCodec<foy.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     all.a.fieldOf("file").forGetter(foy.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(foy.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(foy.a::e),
                     g.fieldOf("chars").forGetter(foy.a::f)
                  )
                  .apply($$0, foy.a::new)
         )
         .validate(foy.a::a);
      ...
      private static DataResult<foy.a> a(foy.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     foy.b $$15 = $$9.a($$12, new foy.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        foy.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(fdk $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, fdk b, int c, int d, int e, int f, int g, int h) implements fci {
