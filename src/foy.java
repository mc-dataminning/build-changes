...
public class foy {
   ...
   public foq a(Vector3f $$0, Vector3f $$1, fot $$2, fyu $$3, ha $$4, gbd $$5, @Nullable fou $$6, boolean $$7, aer $$8) {
      fov $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = arp.i($$11, $$9.a[0], $$12);
      $$9.a[2] = arp.i($$11, $$9.a[2], $$12);
      $$9.a[1] = arp.i($$11, $$9.a[1], $$13);
      $$9.a[3] = arp.i($$11, $$9.a[3], $$13);
      ...
      return new foq($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fov a(fov $$0, ha $$1, j $$2, aer $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(arp.b($$23), arp.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fov(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fov $$0, fyu $$1, ha $$2, float[] $$3, j $$4, @Nullable fou $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ha $$2, fov $$3, float[] $$4, fyu $$5, j $$6, @Nullable fou $$7, boolean $$8) {
      fnl.b $$9 = fnl.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, fyu $$3, fov $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fou $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ha $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (arp.a($$13, $$18) && arp.a($$14, $$19) && arp.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
