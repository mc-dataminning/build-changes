...
public abstract class emk<T extends emk<T>> {
   ...
   public emk(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = emi.a();
         if ($$3 != null) {
         ...
         throw new ent(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ent(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ent(var2.getMessage(), var2);
      }
   }
   ...
   public static emk<?> a(String $$0) {
      return new emk.b($$0, 5000, 60000);
   }

   public static emk<?> a(String $$0, int $$1, int $$2) {
      return new emk.b($$0, $$1, $$2);
   }

   public static emk<?> c(String $$0, String $$1) {
      return new emk.c($$0, $$1, 5000, 60000);
   }

   public static emk<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new emk.c($$0, $$1, $$2, $$3);
   }

   public static emk<?> b(String $$0) {
      return new emk.a($$0, 5000, 60000);
   }

   public static emk<?> d(String $$0, String $$1) {
      return new emk.d($$0, $$1, 5000, 60000);
   }

   public static emk<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new emk.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends emk<emk.a> {
   ...
   public static class b extends emk<emk.b> {
   ...
   public static class c extends emk<emk.c> {
      ...
      public emk.c f() {
         try {
            ...
            throw new ent(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends emk<emk.d> {
      private final String c;
