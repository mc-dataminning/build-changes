...
public class emk extends emt {
   public static final MapCodec<emk> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ji.a.listOf().fieldOf("positions").forGetter($$0x -> $$0x.c)).apply($$0, emk::new)
   );
   private final List<ji> c;

   public static emk a(ji... $$0) {
      return new emk(List.of($$0));
   }

   private emk(List<ji> $$0) {
      this.c = $$0;
   }
