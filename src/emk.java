...
public abstract class emk<M extends emh<M>> {
   private final dbi i;
   protected final dtm a;
   ...
   protected final Long2ObjectMap<dte> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected emk(dbi $$0, dtm $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dte a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dte a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dte c(long $$0) {
      dte $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = jq.e($$0);
      dte $$2 = this.a($$1, true);
      return $$2.a(jq.b(io.a($$0)), jq.b(io.b($$0)), jq.b(io.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(jq.b(io.a($$0)), jq.b(io.b($$0)), jq.b(io.c($$0)), $$1);
      jq.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(jq.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected dte g(long $$0) {
      dte $$1 = (dte)this.g.get($$0);
      return $$1 != null ? $$1 : new dte();
   }
   ...
   protected void a(emn<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dte $$2 = (dte)this.g.remove($$1);
            dte $$3 = this.d.d($$1);
            if (this.k.contains(jq.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dte>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dte> $$6 = (Entry<dte>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dte $$8 = (dte)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dte $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jq.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, emk.a.a($$9, emk.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public emk.b k(long $$0) {
      return emk.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static emk.b c(byte $$0) {
         if ($$0 == 0) {
            return emk.b.a;
         } else {
            return a($$0) ? emk.b.c : emk.b.b;
         }
      }
   }
