...
public class yr implements xh {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = azg.b.validate(yr::b);
   private static final Codec<Object> e = Codec.either(d, xi.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xg $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yr> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xh.a<yr> c = new xh.a<>(b, "translatable");
   private static final xl f = xl.e("%");
   private static final xl g = xl.e("null");
   ...
   @Nullable
   private tv k;
   private List<xl> l = ImmutableList.of();
   ...
   private static yr a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yr($$0, $$1.orElse(null), a($$2));
   }

   public yr(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xl> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (ys var4) {
            this.l = ImmutableList.of(xl.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xl> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new ys(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xl a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xg) {
            ...
            return $$1 == null ? g : xl.e($$1.toString());
         }
      } else {
         throw new ys(this, $$0);
      }
   ...
   public xu a(@Nullable ek $$0, @Nullable bxe $$1, int $$2) throws CommandSyntaxException {
      ...
      return xu.a(new yr(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yr $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
