...
public interface biw<T, F> {
   ...
   public static final class a implements biw<biw.b, Runnable> {
   ...
   public static final class c<T> implements biw<T, T> {
