...
public class BlockUtil {
   ...
   private static int packDifferenceInPositionInternal(
      final int xRadius, final int yRadius, final int zRadius, final int xDiff, final int yDiff, final int zDiff
   ) {
