...
public record AdvancementRequirements(List<List<String>> requirements) {
   ...
   public static final StreamCodec<ByteBuf, AdvancementRequirements> STREAM_CODEC = ByteBufCodecs.STRING_UTF8
      .apply(ByteBufCodecs.list())
      .apply(ByteBufCodecs.list())
      .map(AdvancementRequirements::new, AdvancementRequirements::requirements);
