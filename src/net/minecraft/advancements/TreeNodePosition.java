...
public class TreeNodePosition {
   ...
   public TreeNodePosition(
      ...
      @Nullable final TreeNodePosition parent,
      @Nullable final TreeNodePosition previousSibling,
   ...
   @Nullable
   private TreeNodePosition addChild(final AdvancementNode node, @Nullable TreeNodePosition previous) {
