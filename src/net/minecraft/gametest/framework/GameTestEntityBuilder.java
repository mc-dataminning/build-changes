...
public class GameTestEntityBuilder<E extends Entity> {
   ...
   public GameTestEntityBuilder<E> spawnReason(@Nullable final EntitySpawnReason spawnReason) {
      this.spawnReason = spawnReason;
      return this;
   }

   public GameTestEntityBuilder<E> rotation(@Nullable final Rotation rotation) {
