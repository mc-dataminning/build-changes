...
public final class DataComponentPatch {
      ...
      return new StreamCodec<RegistryFriendlyByteBuf, DataComponentPatch>() {
         ...
         public void encode(final RegistryFriendlyByteBuf output, final DataComponentPatch patch) {
            if (patch.isEmpty()) {
               ...
               ObjectIterable<it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Object>> fastEntries = Reference2ObjectMaps.fastIterable(
                  patch.map
               );
               int positiveCount = 0;
               int negativeCount = 0;
               ...
               while (var6.hasNext()) {
                  it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Object> entry = (it.unimi.dsi.fastutil.objects.Reference2ObjectMap.Entry<DataComponentType<?>, Object>)var6.next();
   ...
   static <T> T getFromPatchAndPrototype(
      final Reference2ObjectMap<DataComponentType<?>, Object> patch, final DataComponentGetter prototype, final DataComponentType<? extends T> type
   ) {
   ...
   public boolean equals(final Object obj) {
      if (this == obj) {
         ...
         if (obj instanceof DataComponentPatch patch && this.map.equals(patch.map)) {
            return true;
         }
   ...
   static String toString(final Reference2ObjectMap<DataComponentType<?>, Object> map) {
      ...
      while (var3.hasNext()) {
         Entry<DataComponentType<?>, Object> entry = (Entry<DataComponentType<?>, Object>)var3.next();
         if (first) {
            first = false;
         } else {
            builder.append(", ");
