...
public class DataComponents {
   ...
   public static final DataComponentType<SwingAnimation> ATTACK_ANIMATION = register(
      "attack_animation", b -> b.persistent(SwingAnimation.CODEC).networkSynchronized(SwingAnimation.STREAM_CODEC)
   );
   public static final DataComponentType<SwingAnimation> INTERACT_ANIMATION = register(
      "interact_animation", b -> b.persistent(SwingAnimation.CODEC).networkSynchronized(SwingAnimation.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<Holder<BlockTransformer>> BLOCK_TRANSFORMER = register(
      "block_transformer", b -> b.persistent(BlockTransformer.CODEC).networkSynchronized(BlockTransformer.STREAM_CODEC).cacheEncoding()
   );
   public static final DataComponentType<VillagerFood> VILLAGER_FOOD = register(
      "villager_food", b -> b.persistent(VillagerFood.CODEC).networkSynchronized(VillagerFood.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<HolderSet<BannerPattern>> PROVIDES_BANNER_PATTERNS = register(
      ...
      b -> b.persistent(RegistryCodecs.holderSet(Registries.BANNER_PATTERN))
   ...
   public static final DataComponentType<CookingFuel> COOKING_FUEL = register(
      "cooking_fuel", b -> b.persistent(CookingFuel.CODEC).networkSynchronized(CookingFuel.STREAM_CODEC)
   );
   public static final DataComponentType<BrewingFuel> BREWING_FUEL = register(
      "brewing_fuel", b -> b.persistent(BrewingFuel.CODEC).networkSynchronized(BrewingFuel.STREAM_CODEC)
   );
   public static final DataComponentType<MobVisibility> MOB_VISIBILITY = register(
      "mob_visibility", b -> b.persistent(MobVisibility.CODEC).networkSynchronized(MobVisibility.STREAM_CODEC)
   );
   ...
   public static final DataComponentType<SignText> SIGN_TEXT_FRONT = register(
      "sign_text_front", b -> b.persistent(SignText.CODEC).networkSynchronized(SignText.STREAM_CODEC).cacheEncoding()
   );
   public static final DataComponentType<SignText> SIGN_TEXT_BACK = register(
      "sign_text_back", b -> b.persistent(SignText.CODEC).networkSynchronized(SignText.STREAM_CODEC).cacheEncoding()
   );
   ...
   public static final DataComponentMap COMMON_ITEM_COMPONENTS = DataComponentMap.builder()
      ...
      .set(ATTACK_ANIMATION, SwingAnimation.DEFAULT)
      .set(INTERACT_ANIMATION, SwingAnimation.DEFAULT)
      .build();
