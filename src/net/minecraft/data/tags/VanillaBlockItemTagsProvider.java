...
public class VanillaBlockItemTagsProvider extends BlockItemTagsProvider {
   ...
   protected void run() {
      ...
      this.tag(BlockItemTags.WOOL_STAIRS).addAll(BlockItemIds.WOOL_STAIRS.asList());
      this.tag(BlockItemTags.WOOL_SLABS).addAll(BlockItemIds.WOOL_SLAB.asList());
      ...
      this.tag(BlockItemTags.POPLAR_LOGS)
         .add(BlockItemIds.POPLAR_LOG, BlockItemIds.POPLAR_WOOD, BlockItemIds.STRIPPED_POPLAR_LOG, BlockItemIds.STRIPPED_POPLAR_WOOD);
      ...
      this.tag(BlockItemTags.LOGS_THAT_BURN)
         ...
         .addTag(BlockItemTags.POPLAR_LOGS);
      ...
      this.tag(BlockItemTags.SLABS)
         ...
         .addTag(BlockItemTags.WOOL_SLABS, BlockItemTags.CONCRETE_SLABS);
      ...
      this.tag(BlockItemTags.STAIRS)
         ...
         .add(
            ...
            BlockItemIds.BAMBOO_MOSAIC_STAIRS,
         ...
         .addTag(BlockItemTags.WOOL_STAIRS, BlockItemTags.CONCRETE_STAIRS);
      ...
      this.tag(BlockItemTags.DAMPENS_VIBRATIONS)
         .addTag(BlockItemTags.WOOL)
         .addTag(BlockItemTags.WOOL_CARPETS)
         .addTag(BlockItemTags.WOOL_SLABS)
         .addTag(BlockItemTags.WOOL_STAIRS);
      ...
      this.tag(BlockItemTags.ORES)
         .addTag(BlockItemTags.COPPER_ORES)
         .addTag(BlockItemTags.GOLD_ORES)
         .addTag(BlockItemTags.IRON_ORES)
         .addTag(BlockItemTags.COAL_ORES)
         .addTag(BlockItemTags.DIAMOND_ORES)
         .addTag(BlockItemTags.EMERALD_ORES)
         .addTag(BlockItemTags.LAPIS_ORES)
      ...
      this.tag(BlockItemTags.CONCRETE_STAIRS).addAll(BlockItemIds.CONCRETE_STAIRS.asList());
      this.tag(BlockItemTags.CONCRETE_SLABS).addAll(BlockItemIds.CONCRETE_SLAB.asList());
