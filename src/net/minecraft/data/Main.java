...
public class Main {
   ...
   public static void main(String[] $$0) throws IOException {
      ...
      if (!$$11.has($$2) && $$11.hasOptions()) {
         ...
         lz $$19 = a($$12, $$11.valuesOf($$10).stream().map($$0x -> Paths.get($$0x)).collect(Collectors.toList()), $$14, $$15, $$16, $$17, $$18, ab.b(), true);
         $$19.a();
      } else {
   ...
   private static <T extends ma> ma.a<T> a(BiFunction<mc, CompletableFuture<jo.a>, T> $$0, CompletableFuture<jo.a> $$1) {
      return $$2 -> $$0.apply($$2, $$1);
   }

   public static lz a(Path $$0, Collection<Path> $$1, boolean $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6, ae $$7, boolean $$8) {
      lz $$9 = new lz($$0, $$7, $$8);
      lz.a $$10 = $$9.a($$2 || $$3);
      $$10.a($$1x -> new pg($$1x, $$1).a(new ph()));
      CompletableFuture<jo.a> $$11 = CompletableFuture.supplyAsync(pc::a, ad.g());
      lz.a $$12 = $$9.a($$2);
      $$12.a(np::new);
      lz.a $$13 = $$9.a($$3);
      $$13.a(a(oz::new, $$11));
      ...
      $$13.a(a(nh::a, $$11));
      $$13.a(a(ox::new, $$11));
      py<dfw> $$14 = $$13.a(a(qb::new, $$11));
      py<cuj> $$15 = $$13.a($$2x -> new qd($$2x, $$11, $$14.c()));
      py<ddu> $$16 = $$13.a(a(pk::new, $$11));
      py<dpv> $$17 = $$13.a(a(pj::new, $$11));
      py<ejm> $$18 = $$13.a(a(px::new, $$11));
      $$13.a(a(pl::new, $$11));
      $$13.a(a(pm::new, $$11));
      $$13.a(a(po::new, $$11));
      $$13.a(a(pp::new, $$11));
      ...
      $$13 = $$9.a($$3, "bundle");
      $$13.a(a(ow::new, $$11));
      $$13.a($$0x -> nl.a($$0x, wy.c("dataPack.bundle.description"), cpj.a(cpl.b)));
      CompletableFuture<kc.g> $$22 = pb.a($$11);
      CompletableFuture<jo.a> $$23 = $$22.thenApply(kc.g::b);
      lz.a $$24 = $$9.a($$3, "trade_rebalance");
      $$24.a(a(oz::new, $$23));
      $$24.a($$0x -> nl.a($$0x, wy.c("dataPack.trade_rebalance.description"), cpj.a(cpl.c)));
      $$24.a(a(mz::a, $$11));
      $$24.a(a(qa::new, $$11));
      $$24.a(a(pz::new, $$11));
      return $$9;
