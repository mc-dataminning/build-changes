...
public class BlockFamilies {
   ...
   public static final BlockFamily PALE_OAK_PLANKS = familyBuilder(Blocks.PALE_OAK_PLANKS)
      ...
      .recipeUnlockedBy("has_planks")
      .getFamily();
   public static final BlockFamily POPLAR_PLANKS = familyBuilder(Blocks.POPLAR_PLANKS)
      .log(Blocks.POPLAR_LOG)
      .strippedLog(Blocks.STRIPPED_POPLAR_LOG)
      .button(Blocks.POPLAR_BUTTON)
      .fence(Blocks.POPLAR_FENCE)
      .fenceGate(Blocks.POPLAR_FENCE_GATE)
      .pressurePlate(Blocks.POPLAR_PRESSURE_PLATE)
      .hangingSign(Blocks.POPLAR_HANGING_SIGN, Blocks.POPLAR_WALL_HANGING_SIGN)
      .sign(Blocks.POPLAR_SIGN, Blocks.POPLAR_WALL_SIGN)
      .slab(Blocks.POPLAR_SLAB)
      .stairs(Blocks.POPLAR_STAIRS)
      .door(Blocks.POPLAR_DOOR)
      .trapdoor(Blocks.POPLAR_TRAPDOOR)
      .recipeGroupPrefix("wooden")
      .recipeUnlockedBy("has_planks")
      .getFamily();
   ...
   public static final ColorCollection<BlockFamily> WOOL = ColorCollection.VALUES
      .map(
         color -> familyBuilder(Blocks.WOOL.pick(color))
               .carpet(Blocks.CARPET.pick(color))
               .stairs(Blocks.WOOL_STAIRS.pick(color))
               .slab(Blocks.WOOL_SLAB.pick(color))
               .recipeGroupPrefix("woolen")
               .getFamily()
      );
   public static final ColorCollection<BlockFamily> CONCRETE = ColorCollection.VALUES
      .map(
         color -> familyBuilder(Blocks.CONCRETE.pick(color))
               .stairs(Blocks.CONCRETE_STAIRS.pick(color))
               .slab(Blocks.CONCRETE_SLAB.pick(color))
   ...
   @Nullable
   public static BlockFamily getFamily(final Block base) {
      return MAP.get(base);
   }
}
