                                    ...
                                    EntityPredicate.Builder.entity()
                                       .components(
                                          DataComponentExactPredicate.expect(
                                             DataComponents.CHICKEN_VARIANT, this.chickenVariants.getOrThrow(ChickenVariants.TEMPERATE)
                                          )
                                       )
                                 )
                              ),
                              ...
                              .when(
                                 LootItemEntityPropertyCondition.hasProperties(
                                    ...
                                    EntityPredicate.Builder.entity()
                                       .components(
                                          DataComponentExactPredicate.expect(
                                             DataComponents.CHICKEN_VARIANT, this.chickenVariants.getOrThrow(ChickenVariants.WARM)
                                          )
                                       )
                                 )
                              ),
                              ...
                              .when(
                                 LootItemEntityPropertyCondition.hasProperties(
                                    ...
                                    EntityPredicate.Builder.entity()
                                       .components(
                                          DataComponentExactPredicate.expect(
                                             DataComponents.CHICKEN_VARIANT, this.chickenVariants.getOrThrow(ChickenVariants.COLD)
                                          )
                                       )
                                 )
                              )
