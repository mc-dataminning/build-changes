...
public class VanillaChestLoot implements LootTableSubProvider {
   ...
   public VanillaChestLoot(final LootTableSubProvider.Context output) {
      this.output = output;
   ...
   public void run() {
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.BOOK).setWeight(10).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     ...
                     .add(LootItem.lootTableItem(Items.REDSTONE).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 9))))
                     .add(LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 9))))
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 8))))
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Blocks.RAIL).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))))
                     ...
                     .add(LootItem.lootTableItem(Blocks.TORCH).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 16))))
                     .add(
                        LootItem.lootTableItem(Items.MUSIC_DISC_BOUNCE)
                           .when(
                              LocationCheck.checkLocation(
                                 LocationPredicate.Builder.location().setBiomes(HolderSet.direct(this.biomes.getOrThrow(Biomes.SULFUR_CAVES)))
                              )
                           )
                           .setWeight(10)
                     )
      ...
      this.output.accept(BuiltInLootTables.BASTION_BRIDGE, this.bastionBridgeLootTable());
      this.output.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, this.bastionHoglinStableLootTable());
      this.output.accept(BuiltInLootTables.BASTION_OTHER, this.bastionOtherLootTable());
      this.output.accept(BuiltInLootTables.BASTION_TREASURE, this.bastionTreasureLootTable());
      this.output
         .accept(
            BuiltInLootTables.BURIED_TREASURE,
            LootTable.lootTable()
               .withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.HEART_OF_THE_SEA)))
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(5, 8))
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Blocks.TNT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 3))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))))
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(
                        LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5)))
                     )
               )
               .withPool(
                  LootPool.lootPool()
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.COOKED_COD).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
                     .add(LootItem.lootTableItem(Items.COOKED_SALMON).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
               )
               .withPool(
                  LootPool.lootPool()
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.COPPER_NAUTILUS_ARMOR).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
                     )
                     ...
                     .add(
                        LootItem.lootTableItem(Items.DIAMOND_NAUTILUS_ARMOR).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
                     )
               )
         );
      this.output.accept(BuiltInLootTables.ANCIENT_CITY, this.ancientCityLootTable());
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.GOLDEN_CARROT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
                     .add(LootItem.lootTableItem(Items.BAKED_POTATO).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
      ...
      this.output.accept(BuiltInLootTables.DESERT_PYRAMID, this.desertPyramidLootTable());
      this.output.accept(BuiltInLootTables.END_CITY_TREASURE, this.endCityTreasureLootTable());
      this.output
         .accept(
            ...
            LootTable.lootTable()
               ...
               .withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.GOLDEN_APPLE)))
         );
      this.output.accept(BuiltInLootTables.JUNGLE_TEMPLE, this.jungleTempleLootTable());
      this.output
         .accept(
      ...
      this.output.accept(BuiltInLootTables.NETHER_BRIDGE, this.netherBridgeLootTable());
      this.output.accept(BuiltInLootTables.PILLAGER_OUTPOST, this.pillagerOutpostLootTable());
      this.output.accept(BuiltInLootTables.SHIPWRECK_MAP, this.shipwreckMapLootTable());
      this.output.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, this.shipwreckSupplyLootTable());
      this.output.accept(BuiltInLootTables.SHIPWRECK_TREASURE, this.shipwreckTreasureLootTable());
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 3))
                     .add(LootItem.lootTableItem(Items.LEATHER).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
            ...
            LootTable.lootTable()
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.STICK).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 12))))
                     .add(LootItem.lootTableItem(Blocks.OAK_PLANKS).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 12))))
                     .add(LootItem.lootTableItem(Blocks.OAK_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.SPRUCE_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.BIRCH_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.JUNGLE_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.ACACIA_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.DARK_OAK_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.MANGROVE_LOG).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
         );
      this.output.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, this.strongholdCorridorLootTable());
      this.output
         .accept(
      ...
      this.output.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, this.strongholdLibraryLootTable());
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.APPLE).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     ...
                     .add(LootItem.lootTableItem(Blocks.OBSIDIAN).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 7))))
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(3, 8))
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.IRON_PICKAXE).setWeight(5))
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.PAPER).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.COMPASS).setWeight(5))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 5))
                     .add(LootItem.lootTableItem(Items.CLAY_BALL).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     ...
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(4).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 5))
                     .add(LootItem.lootTableItem(Blocks.WOOL.white()).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 8))))
                     .add(LootItem.lootTableItem(Blocks.WOOL.black()).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.WOOL.gray()).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.WOOL.brown()).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Blocks.WOOL.lightGray()).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1))
                     .add(LootItem.lootTableItem(Items.SHEARS).setWeight(1))
                     .add(LootItem.lootTableItem(Items.WHEAT).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 6))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 5))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1))
                     .add(LootItem.lootTableItem(Items.PORKCHOP).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.WHEAT).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.BEEF).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.MUTTON).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 5))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1))
                     .add(LootItem.lootTableItem(Items.ARROW).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.FEATHER).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.EGG).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.FLINT).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.STICK).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(1, 5))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1))
                     .add(LootItem.lootTableItem(Items.COD).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.SALMON).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.WATER_BUCKET).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.BARREL).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.LEATHER_LEGGINGS).setWeight(2))
                     .add(LootItem.lootTableItem(Items.SADDLE).setWeight(1))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(3, 8))
                     .add(LootItem.lootTableItem(Items.REDSTONE).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     ...
                     .add(LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(3, 8))
                     .add(LootItem.lootTableItem(Items.GOLD_NUGGET).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.DANDELION).setWeight(2))
                     .add(LootItem.lootTableItem(Items.POPPY).setWeight(1))
                     .add(LootItem.lootTableItem(Items.POTATO).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 7))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.APPLE).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.BOOK).setWeight(1))
                     .add(LootItem.lootTableItem(Items.FEATHER).setWeight(1))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Blocks.OAK_SAPLING).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(3, 8))
                     .add(LootItem.lootTableItem(Items.IRON_NUGGET).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.FERN).setWeight(2))
                     .add(LootItem.lootTableItem(Items.LARGE_FERN).setWeight(2))
                     .add(LootItem.lootTableItem(Items.POTATO).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 7))))
                     .add(LootItem.lootTableItem(Items.SWEET_BERRIES).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 7))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.PUMPKIN_SEEDS).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.PUMPKIN_PIE).setWeight(1))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Blocks.SPRUCE_SAPLING).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     .add(LootItem.lootTableItem(Items.SPRUCE_SIGN).setWeight(1))
                     .add(LootItem.lootTableItem(Items.SPRUCE_LOG).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.SADDLE).setWeight(1))
                     .add(LootItem.lootTableItem(Blocks.TORCH).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.POTATO).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 7))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.BEETROOT_SEEDS).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
                     ...
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Blocks.CACTUS).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.WHEAT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 7))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.BOOK).setWeight(1))
                     ...
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
      ...
      this.output.accept(BuiltInLootTables.WOODLAND_MANSION, this.woodlandMansionLootTable());
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.GOLDEN_SWORD).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments))
                     )
                     ...
                     .add(
                        LootItem.lootTableItem(Items.GOLDEN_SHOVEL).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments))
                     )
                     .add(
                        LootItem.lootTableItem(Items.GOLDEN_PICKAXE)
                           .setWeight(15)
                           .apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments))
                     )
                     .add(
                        LootItem.lootTableItem(Items.GOLDEN_BOOTS).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments))
                     )
                     .add(
                     ...
                     .add(
                        LootItem.lootTableItem(Items.GOLDEN_HELMET).setWeight(15).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments))
                     )
                     .add(
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.WATER_BUCKET).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
               )
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.WATER_BUCKET).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))).setWeight(4))
                     .add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))).setWeight(4))
                     .add(LootItem.lootTableItem(Items.SNOWBALL).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))).setWeight(6))
                     .add(LootItem.lootTableItem(Items.EGG).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))).setWeight(2))
                     .add(LootItem.lootTableItem(Items.FIRE_CHARGE).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))).setWeight(6))
                     .add(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))).setWeight(100))
                     .add(LootItem.lootTableItem(Items.TRIAL_KEY).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))).setWeight(10))
                     .add(LootItem.lootTableItem(Items.MUSIC_DISC_CREATOR_MUSIC_BOX).setWeight(5))
                     .add(LootItem.lootTableItem(Items.DIAMOND).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))).setWeight(5))
                     .add(LootItem.lootTableItem(Items.EMERALD_BLOCK).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))).setWeight(5))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.WOODEN_AXE).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))).setWeight(10))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.BAMBOO_HANGING_SIGN).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))).setWeight(2)
                     )
      ...
      Holder.Reference<LootTable> trialChambersRewardRare = this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.SHIELD).setWeight(3).apply(SetItemDamageFunction.setDamage(ContextFloatProviders.between(0.5F, 1.0F))))
                     .add(
                        LootItem.lootTableItem(Items.BOW)
                           .setWeight(3)
                           .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(5, 15)))
                     )
                     .add(
                        LootItem.lootTableItem(Items.CROSSBOW)
                           .setWeight(2)
                           .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(5, 20)))
                     )
                     .add(
                        LootItem.lootTableItem(Items.IRON_AXE)
                           .setWeight(2)
                           .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(0, 10)))
                     )
                     .add(
                        ...
                        LootItem.lootTableItem(Items.BOOK)
                           ...
                           .apply(
                              new EnchantRandomlyFunction.Builder()
                                 .withOneOf(
                                    HolderSet.direct(
                                       this.enchantments.getOrThrow(Enchantments.SHARPNESS),
                                       this.enchantments.getOrThrow(Enchantments.BANE_OF_ARTHROPODS),
                                       this.enchantments.getOrThrow(Enchantments.EFFICIENCY),
                                       this.enchantments.getOrThrow(Enchantments.FORTUNE),
                                       this.enchantments.getOrThrow(Enchantments.SILK_TOUCH),
                                       this.enchantments.getOrThrow(Enchantments.FEATHER_FALLING)
                                    )
                                 )
                           )
                     )
                        ...
                        LootItem.lootTableItem(Items.BOOK)
                           ...
                           .apply(
                              new EnchantRandomlyFunction.Builder()
                                 .withOneOf(
                                    HolderSet.direct(
                                       this.enchantments.getOrThrow(Enchantments.RIPTIDE),
                                       this.enchantments.getOrThrow(Enchantments.LOYALTY),
                                       this.enchantments.getOrThrow(Enchantments.CHANNELING),
                                       this.enchantments.getOrThrow(Enchantments.IMPALING),
                                       this.enchantments.getOrThrow(Enchantments.MENDING)
                                    )
                                 )
                           )
                     )
      ...
      Holder.Reference<LootTable> trialChambersRewardCommon = this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.ARROW).setWeight(4).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 8))))
                     .add(
                        LootItem.lootTableItem(Items.TIPPED_ARROW)
                           .setWeight(4)
                     ...
                     .add(LootItem.lootTableItem(Items.WIND_CHARGE).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 4))))
                     .add(LootItem.lootTableItem(Items.HONEY_BOTTLE).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(
      ...
      Holder.Reference<LootTable> trialChambersRewardUnique = this.output
         .accept(
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardRare).setWeight(8))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardCommon).setWeight(2))
               )
               .withPool(LootPool.lootPool().setRolls(ContextIntProviders.between(1, 3)).add(NestedLootTable.lootTableReference(trialChambersRewardCommon)))
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .when(LootItemRandomChanceCondition.randomChance(0.25F))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardUnique))
               )
         );
      Holder.Reference<LootTable> trialChambersRewardOminousRare = this.output
         .accept(
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.DIAMOND_AXE)
                           .setWeight(3)
                           .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(10, 20)))
                     )
                     .add(
                        LootItem.lootTableItem(Items.DIAMOND_CHESTPLATE)
                           .setWeight(3)
                        ...
                        LootItem.lootTableItem(Items.BOOK)
                           ...
                           .apply(
                              new EnchantRandomlyFunction.Builder()
                                 .withOneOf(
                                    HolderSet.direct(
                                       this.enchantments.getOrThrow(Enchantments.KNOCKBACK),
                                       this.enchantments.getOrThrow(Enchantments.PUNCH),
                                       this.enchantments.getOrThrow(Enchantments.SMITE),
                                       this.enchantments.getOrThrow(Enchantments.LOOTING),
                                       this.enchantments.getOrThrow(Enchantments.MULTISHOT)
                                    )
                                 )
                           )
                     )
                     .add(
                        LootItem.lootTableItem(Items.BOOK)
                           ...
                           .apply(
                              new EnchantRandomlyFunction.Builder()
                                 .withOneOf(
                                    HolderSet.direct(this.enchantments.getOrThrow(Enchantments.BREACH), this.enchantments.getOrThrow(Enchantments.DENSITY))
                                 )
                           )
                     )
                     .add(
                        LootItem.lootTableItem(Items.BOOK)
                           ...
                           .apply(
                              new SetEnchantmentsFunction.Builder()
                                 .withEnchantment(this.enchantments.getOrThrow(Enchantments.WIND_BURST), ContextIntProviders.exactly(1))
                           )
                     )
                     .add(LootItem.lootTableItem(Items.DIAMOND_BLOCK).setWeight(1))
               )
         );
      Holder.Reference<LootTable> trialChambersRewardOminousCommon = this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.EMERALD).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 10))))
                     .add(LootItem.lootTableItem(Items.WIND_CHARGE).setWeight(4).apply(SetItemCountFunction.setCount(ContextIntProviders.between(8, 12))))
                     .add(
                        LootItem.lootTableItem(Items.TIPPED_ARROW)
                           .setWeight(3)
                           .apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 12)))
                     ...
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 3))))
                     .add(
                        LootItem.lootTableItem(Items.OMINOUS_BOTTLE)
                           .setWeight(1)
                           .apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
                           .apply(SetOminousBottleAmplifierFunction.setAmplifier(ContextIntProviders.between(2, 4)))
                     )
               )
         );
      Holder.Reference<LootTable> trialChambersRewardOminousUnique = this.output
         .accept(
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardOminousRare).setWeight(8))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardOminousCommon).setWeight(2))
               )
               .withPool(
                  LootPool.lootPool().setRolls(ContextIntProviders.between(1, 3)).add(NestedLootTable.lootTableReference(trialChambersRewardOminousCommon))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .when(LootItemRandomChanceCondition.randomChance(0.75F))
                     .add(NestedLootTable.lootTableReference(trialChambersRewardOminousUnique))
               )
         );
      this.spawnerLootTables();
      this.abandonedCampLootTables();
   }
   ...
   public void spawnerLootTables() {
      this.output
         .accept(
            ...
            LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.TRIAL_KEY)))
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.COOKED_CHICKEN).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.BREAD).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.BAKED_POTATO).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(
                        LootItem.lootTableItem(Items.POTION)
                           .apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
                           .apply(SetPotionFunction.setPotion(Potions.REGENERATION))
      ...
      this.output
         .accept(
            ...
            LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.OMINOUS_TRIAL_KEY)))
         );
      this.output
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.COOKED_BEEF).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(LootItem.lootTableItem(Items.BAKED_POTATO).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
                     .add(LootItem.lootTableItem(Items.GOLDEN_CARROT).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(
                        LootItem.lootTableItem(Items.POTION)
                           .apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
         ...
         .accept(
            ...
            LootTable.lootTable()
               ...
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(
                     ...
                     .add(LootItem.lootTableItem(Items.FIRE_CHARGE).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
                     .add(LootItem.lootTableItem(Items.WIND_CHARGE).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               )
         );
   }
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.PAPER).setWeight(8).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 12))))
               ...
               .add(LootItem.lootTableItem(Items.POISONOUS_POTATO).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 6))))
               .add(LootItem.lootTableItem(Items.CARROT).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))))
               .add(LootItem.lootTableItem(Items.WHEAT).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(8, 21))))
               .add(
                  LootItem.lootTableItem(Items.SUSPICIOUS_STEW)
                     .setWeight(10)
                     .apply(
               ...
               .add(LootItem.lootTableItem(Items.LEATHER_HELMET).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               .add(LootItem.lootTableItem(Items.LEATHER_CHESTPLATE).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               .add(LootItem.lootTableItem(Items.LEATHER_LEGGINGS).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               .add(LootItem.lootTableItem(Items.LEATHER_BOOTS).setWeight(3).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
   ...
   public LootTable.Builder shipwreckMapLootTable() {
      return LootTable.lootTable()
         .withPool(LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(this.buriedTreasureMapItem()))
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(3))
               ...
               .add(LootItem.lootTableItem(Items.PAPER).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
               .add(LootItem.lootTableItem(Items.FEATHER).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Blocks.GOLD_BLOCK).setWeight(16).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 9))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 9))))
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 7))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 8))))
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 7))))
               .add(LootItem.lootTableItem(Items.EMERALD).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 6))))
               ...
               .add(
                  LootItem.lootTableItem(Items.DIAMOND_SWORD)
                     .setWeight(3)
                     .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(20, 39)))
               )
               .add(
   ...
   public LootTable.Builder netherBridgeLootTable() {
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(2, 4))
               .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               ...
               .add(LootItem.lootTableItem(Items.NETHER_WART).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 7))))
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Blocks.GOLD_BLOCK).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 5))))
               .add(LootItem.lootTableItem(Blocks.IRON_BLOCK).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 5))))
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 9))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 9))))
               .add(LootItem.lootTableItem(Blocks.CRYING_OBSIDIAN).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 5))))
               .add(LootItem.lootTableItem(Items.QUARTZ).apply(SetItemCountFunction.setCount(ContextIntProviders.between(8, 23))))
         ...
         .withPool(
            LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE).setWeight(1))
         );
   }
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.DIAMOND_SHOVEL).setWeight(6).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
               .add(
                  LootItem.lootTableItem(Items.CROSSBOW)
                     .setWeight(6)
               ...
               .add(LootItem.lootTableItem(Items.GOLDEN_CARROT).setWeight(12).apply(SetItemCountFunction.setCount(ContextIntProviders.between(6, 17))))
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 6))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 6))))
               .add(LootItem.lootTableItem(Items.GOLDEN_SWORD).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Blocks.OBSIDIAN).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 6))))
               .add(LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 8))))
      ...
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.PUMPKIN_SEEDS).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
               .add(LootItem.lootTableItem(Items.BEETROOT_SEEDS).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
               .add(LootItem.lootTableItem(Items.RESIN_CLUMP).setWeight(50).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(3))
   ...
   public LootTable.Builder strongholdLibraryLootTable() {
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool().setRolls(ContextIntProviders.exactly(1)).add(LootItem.lootTableItem(Items.EYE_ARMOR_TRIM_SMITHING_TEMPLATE).setWeight(1))
         );
   }
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.IRON_BOOTS).setWeight(5))
               .add(LootItem.lootTableItem(Items.GOLDEN_APPLE))
               .add(LootItem.lootTableItem(Items.LEATHER).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.COPPER_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.IRON_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.DIAMOND_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.MUSIC_DISC_OTHERSIDE))
               .add(LootItem.lootTableItem(Items.BOOK).apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.exactly(30))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
            ...
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.DIAMOND_HOE)
                     ...
                     .apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
                     .apply(SetItemDamageFunction.setDamage(ContextFloatProviders.between(0.8F, 1.0F)))
                     .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(30, 50)))
               )
               ...
               .add(LootItem.lootTableItem(Items.LEATHER).setWeight(2).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(3)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(this.enchantments.getOrThrow(Enchantments.SWIFT_SNEAK)))
               )
               ...
               .add(LootItem.lootTableItem(Items.AMETHYST_SHARD).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 15))))
               ...
               .add(LootItem.lootTableItem(Items.GLOW_BERRIES).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 15))))
               .add(
                  LootItem.lootTableItem(Items.IRON_LEGGINGS)
                     .setWeight(3)
                     .apply(EnchantWithLevelsFunction.enchantWithLevels(this.enchantments, ContextIntProviders.between(20, 39)))
               ...
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 10))))
               .add(LootItem.lootTableItem(Items.BONE).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 15))))
               .add(LootItem.lootTableItem(Items.SOUL_TORCH).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 15))))
               .add(LootItem.lootTableItem(Items.COAL).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(6, 15))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 7))))
               .add(LootItem.lootTableItem(Blocks.BAMBOO).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               ...
               .add(LootItem.lootTableItem(Items.LEATHER).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.COPPER_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.IRON_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR))
               .add(LootItem.lootTableItem(Items.DIAMOND_HORSE_ARMOR))
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(90).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               ...
               .add(LootItem.lootTableItem(Items.EMERALD).setWeight(40).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.IRON_NUGGET).setWeight(50).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
               .add(LootItem.lootTableItem(Items.GOLD_NUGGET).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
               .add(LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 10))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
   ...
   public LootTable.Builder pillagerOutpostLootTable() {
      return LootTable.lootTable()
         ...
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(2, 3))
               .add(LootItem.lootTableItem(Items.WHEAT).setWeight(7).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 5))))
               .add(LootItem.lootTableItem(Items.POTATO).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 5))))
               .add(LootItem.lootTableItem(Items.CARROT).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 5))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(1, 3))
               .add(LootItem.lootTableItem(Blocks.DARK_OAK_LOG).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 3))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(2, 3))
               .add(LootItem.lootTableItem(Items.EXPERIENCE_BOTTLE).setWeight(7))
               .add(LootItem.lootTableItem(Items.STRING).setWeight(4).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 6))))
               .add(LootItem.lootTableItem(Items.ARROW).setWeight(4).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 7))))
               ...
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(3).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(1).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(0, 1))
               .add(LootItem.lootTableItem(Items.GOAT_HORN))
               .apply(SetInstrumentFunction.setInstrumentOptions(this.instruments.getOrThrow(InstrumentTags.REGULAR_GOAT_HORNS)))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
      ...
      return LootTable.lootTable()
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.between(2, 4))
               .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(5).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 7))))
               .add(LootItem.lootTableItem(Items.EMERALD).setWeight(15).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3))))
               .add(LootItem.lootTableItem(Items.BONE).setWeight(25).apply(SetItemCountFunction.setCount(ContextIntProviders.between(4, 6))))
               ...
               .add(LootItem.lootTableItem(Items.ROTTEN_FLESH).setWeight(25).apply(SetItemCountFunction.setCount(ContextIntProviders.between(3, 7))))
               .add(LootItem.lootTableItem(Items.LEATHER).setWeight(20).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 5))))
               .add(LootItem.lootTableItem(Items.COPPER_HORSE_ARMOR).setWeight(15))
               .add(LootItem.lootTableItem(Items.IRON_HORSE_ARMOR).setWeight(15))
               .add(LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR).setWeight(10))
               .add(LootItem.lootTableItem(Items.DIAMOND_HORSE_ARMOR).setWeight(5))
               .add(LootItem.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomlyFunction.randomApplicableEnchantment(this.enchantments)))
               .add(LootItem.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
               .add(LootItem.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(LootItem.lootTableItem(Items.ROTTEN_FLESH).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 8))))
               .add(LootItem.lootTableItem(Items.STRING).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 8))))
               .add(LootItem.lootTableItem(Blocks.SAND).setWeight(10).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 8))))
         )
         .withPool(
            LootPool.lootPool()
               .setRolls(ContextIntProviders.exactly(1))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.COAL).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(2, 4))))
                     ...
                     .add(
                        LootItem.lootTableItem(Items.DYED_CANDLE.white()).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 3)))
                     )
               ...
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     .add(LootItem.lootTableItem(Items.BUNDLE).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.WOODEN_AXE).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.FISHING_ROD).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.FLINT_AND_STEEL).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(LootItem.lootTableItem(Items.BUCKET).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_AXE).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_BOOTS).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_CHESTPLATE).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_LEGGINGS).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_SPEAR).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_SWORD).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.SPYGLASS).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.SHEARS).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(1))
                     ...
                     .add(
                        this.explorationMapItemExcludingBiome(
                           ...
                           this.biomes.getOrThrow(Biomes.DAPPLED_FOREST)
                        )
                     )
                     .add(
                        this.explorationMapItemExcludingBiome(
                     ...
                     .add(
                        this.explorationMapItemExcludingBiome(
                           ...
                           this.biomes.getOrThrow(Biomes.PALE_GARDEN)
                        )
                     )
                     .add(
                        this.explorationMapItemExcludingBiome(
         ...
         .accept(
            ...
            LootTable.lootTable()
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.exactly(2))
                     .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(
                        LootItem.lootTableItem(Items.POTION)
                           .setWeight(1)
                           .apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1)))
               ...
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(4, 6))
                     .add(LootItem.lootTableItem(Items.MAP).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
                     .add(LootItem.lootTableItem(Items.COPPER_INGOT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.between(1, 2))))
                     .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(1).apply(SetItemCountFunction.setCount(ContextIntProviders.exactly(1))))
               )
               .withPool(
                  LootPool.lootPool()
                     .setRolls(ContextIntProviders.between(0, 1))
               ...
               .withPool(
                  LootPool.lootPool()
                     ...
                     .add(
                        this.explorationMapItem(StructureTags.ON_BURIED_TRIAL_CHAMBERS_MAPS, MapDecorationTypes.TRIAL_CHAMBERS, Items.BURIED_TRIAL_CHAMBERS_MAP)
                     )
   ...
   private UniformContainerBase.Builder<?> explorationMapItem(
      final TagKey<Structure> structureTag, final Holder<MapDecorationType> decoration, final Item mapItem, @Nullable final String translationKey
   ) {
      ...
      return entry.apply(
            ExplorationMapFunction.makeExplorationMap(this.structures.getOrThrow(structureTag)).setMapDecoration(decoration).setSkipKnownStructures(true)
         )
