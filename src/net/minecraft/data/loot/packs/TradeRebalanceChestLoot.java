...
public class TradeRebalanceChestLoot implements LootTableSubProvider {
   ...
   public TradeRebalanceChestLoot(final LootTableSubProvider.Context output) {
      this.output = output;
                  ...
                  LootPool.lootPool()
                     ...
                     .add(
                        LootItem.lootTableItem(Items.BOOK)
                           .setWeight(1)
                           .apply(new EnchantRandomlyFunction.Builder().withEnchantment(this.enchantments.getOrThrow(Enchantments.EFFICIENCY)))
                     )
               )
         );
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(2)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(this.enchantments.getOrThrow(Enchantments.QUICK_CHARGE)))
               )
         );
   }
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(2)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(this.enchantments.getOrThrow(Enchantments.UNBREAKING)))
               )
         );
   }
         ...
         .withPool(
            LootPool.lootPool()
               ...
               .add(
                  LootItem.lootTableItem(Items.BOOK)
                     .setWeight(4)
                     .apply(new EnchantRandomlyFunction.Builder().withEnchantment(this.enchantments.getOrThrow(Enchantments.MENDING)))
               )
