...
public class NetherPlacements {
   ...
   public static void bootstrap(final BootstrapContext<PlacedFeature> context) {
      ...
      PlacementUtils.register(
         ...
         BlockPredicateFilter.forPredicate(
            BlockPredicate.allOf(
               BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.matchesBlocks(Direction.UP, Blocks.NETHERRACK, Blocks.BASALT, Blocks.BLACKSTONE)
            )
         ),
         BiomeFilter.biome()
      );
      ...
      PlacementUtils.register(
         ...
         BiomeFilter.biome(),
         BlockPredicateFilter.forPredicate(BlockPredicate.matchesTag(Direction.DOWN, BlockTags.NYLIUM)),
      ...
      PlacementUtils.register(
         ...
         ImmutableList.builder()
            .add(new PlacementModifier[]{CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()})
            .addAll(spreadTwistingVines(8, 4))
            .build()
      );
      PlacementUtils.register(
         context,
         ...
         BiomeFilter.biome(),
         BlockPredicateFilter.forPredicate(
            BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.matchesBlocks(Direction.UP, Blocks.NETHERRACK, Blocks.NETHER_WART_BLOCK))
         )
      );
      PlacementUtils.register(
         context,
      ...
      PlacementUtils.register(
         ...
         PlacementUtils.FULL_RANGE,
         BlockPredicateFilter.forPredicate(
            BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.not(BlockPredicate.matchesTag(Direction.UP, BlockTags.AIR)))
         ),
         BiomeFilter.biome()
      );
      PlacementUtils.register(
   ...
   private static List<PlacementModifier> firePlacement(final Block onlyOnBlock) {
      return List.of(
         ...
         OffsetPlacement.ofTriangle(7, 3),
         BlockPredicateFilter.forPredicate(
            BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE, BlockPredicate.matchesBlocks(Direction.DOWN, onlyOnBlock))
         )
      );
   }

   public static List<PlacementModifier> spreadTwistingVines(final int spreadWidth, final int spreadHeight) {
      BlockPredicateFilter placementFilter = BlockPredicateFilter.forPredicate(
         BlockPredicate.allOf(
            BlockPredicate.ONLY_IN_AIR_PREDICATE,
            BlockPredicate.matchesBlocks(Direction.DOWN, Blocks.NETHERRACK, Blocks.WARPED_NYLIUM, Blocks.WARPED_WART_BLOCK)
         )
      );
      return List.of(
         placementFilter,
         CountPlacement.of(spreadWidth * spreadWidth),
         OffsetPlacement.of(UniformInt.of(-spreadWidth, spreadWidth), UniformInt.of(-spreadHeight, spreadHeight)),
         OffsetPlacement.of(Direction.DOWN),
         EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.not(BlockPredicate.ONLY_IN_AIR_PREDICATE), 32),
         OffsetPlacement.of(Direction.UP),
         placementFilter
      );
   }
}
