...
public class OverworldBiomes {
   ...
   private static Biome.BiomeBuilder baseBiome(final float temperature, final float downfall) {
      return new Biome.BiomeBuilder()
         ...
         .downfall(downfall)
         .setAttribute(EnvironmentAttributes.SKY_COLOR, ARGB.vector3fFromRGB24(calculateSkyColor(temperature)))
   ...
   public static Biome jungle(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder();
      BiomeDefaultFeatures.baseJungleSpawns(mobs);
      mobs.addSpawn(EntityTypes.PARROT, 40, 1, 2)
         .addSpawn(EntityTypes.OCELOT, MobCategory.MONSTER, 2, new UniformInt(1, 3))
         .addSpawn(EntityTypes.PANDA, 1, 1, 2);
   ...
   public static Biome bambooJungle(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      BiomeDefaultFeatures.baseJungleSpawns(mobs);
      mobs.addSpawn(EntityTypes.PARROT, 40, 1, 2)
         .addSpawn(EntityTypes.PANDA, 80, 1, 2)
         .addSpawn(EntityTypes.OCELOT, MobCategory.MONSTER, 2, new ConstantInt(1));
   ...
   private static Biome.BiomeBuilder baseJungle(
      ...
      final HolderGetter<WorldCarver> carvers,
   ...
   public static Biome savanna(
      final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean shattered, final boolean plateau
   ) {
      BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(placedFeatures, carvers);
      globalOverworldGeneration(generation);
      if (!shattered) {
   ...
   public static Biome badlands(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean wooded) {
      ...
      return baseBiome.hasPrecipitation(false)
   ...
   public static Biome lukeWarmOcean(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean deep) {
      ...
      mobs.addSpawn(EntityTypes.PUFFERFISH, 5, 1, 3)
         .addSpawn(EntityTypes.TROPICAL_FISH, 25, 8, 8)
         .addSpawn(EntityTypes.DOLPHIN, 2, 1, 2)
         .addSpawn(EntityTypes.NAUTILUS, 5, 1, 1);
      BiomeGenerationSettings.Builder generation = baseOceanGeneration(placedFeatures, carvers);
      ...
      return baseOcean()
         .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-16509389))
   ...
   public static Biome frozenOcean(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean deep) {
      MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder()
         .addSpawn(EntityTypes.SQUID, 1, 1, 4)
         .addSpawn(EntityTypes.SALMON, 15, 1, 5)
         .addSpawn(EntityTypes.POLAR_BEAR, 1, 1, 2)
         .addSpawn(EntityTypes.NAUTILUS, 2, 1, 1);
      BiomeDefaultFeatures.commonSpawns(mobs);
   ...
   public static Biome forest(
      final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean birch, final boolean tall, final boolean flower
   ) {
      BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(placedFeatures, carvers);
      globalOverworldGeneration(generation);
   ...
   public static Biome darkForest(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean isPaleGarden) {
      ...
      EnvironmentAttributeMap paleGardenAttributes = EnvironmentAttributeMap.builder()
         .set(EnvironmentAttributes.SKY_COLOR, ARGB.vector3fFromRGB24(-4605511))
         .set(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(-8292496))
         .set(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-11179648))
   ...
   public static Biome swamp(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      return baseBiome(0.8F, 0.9F)
         .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-14474473))
   ...
   public static Biome mangroveSwamp(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      return baseBiome(0.8F, 0.9F)
         .setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(-4138753))
         .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-11699616))
         .modifyAttribute(EnvironmentAttributes.WATER_FOG_END_DISTANCE, FloatModifier.MULTIPLY, 0.85F)
         .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_SWAMP))
         .setAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT, true)
         .specialEffects(
   ...
   public static Biome beach(
      final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean snowy, final boolean stony
   ) {
      MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder();
   ...
   public static Biome meadowOrCherryGrove(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers, final boolean cherryGrove) {
      ...
      if (cherryGrove) {
         ...
         return baseBiome(0.5F, 0.8F)
            .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-10635281))
      ...
      return baseBiome(0.6F, 0.6F)
         .putAttributes(
            EnvironmentAttributeMap.builder()
               ...
               .set(EnvironmentAttributes.SKY_COLOR, ARGB.vector3fFromRGB24(8168447))
               .set(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(13424866))
               .set(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(3625300))
               .build()
         )
         .specialEffects(
            new BiomeSpecialEffects.Builder()
   ...
   public static Biome sulfurCaves(final HolderGetter<PlacedFeature> placedFeatures, final HolderGetter<WorldCarver> carvers) {
      ...
      return baseBiome(0.8F, 0.4F)
         .setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(-7555023))
         .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_SULFUR_CAVES))
         .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(-15248324))
