...
public class Structures {
   public static void bootstrap(final BootstrapContext<Structure> context) {
               ...
               .spawnOverrides(
                  Map.of(
                     ...
                     new StructureSpawnOverride(
                        ...
                        WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.PILLAGER, new ConstantInt(1)))
                     )
                  )
               )
      ...
      context.register(
         BuiltinStructures.WOODLAND_MANSION, new WoodlandMansionStructure(new Structure.StructureSettings(biomes.getOrThrow(BiomeTags.HAS_WOODLAND_MANSION)))
      );
      context.register(
      ...
      context.register(
         BuiltinStructures.SHIPWRECK_BEACHED, new ShipwreckStructure(new Structure.StructureSettings(biomes.getOrThrow(BiomeTags.HAS_SHIPWRECK_BEACHED)), true)
      );
      context.register(
            ...
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_SWAMP_HUT))
               .spawnOverrides(
                  Map.of(
                     MobCategory.MONSTER,
                     new StructureSpawnOverride(
                        StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.WITCH, new ConstantInt(1)))
                     ),
                     MobCategory.CREATURE,
                     new StructureSpawnOverride(
                        StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.CAT, new ConstantInt(1)))
                     )
                  )
               )
               .build()
            ...
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_OCEAN_MONUMENT))
               .spawnOverrides(
                  Map.of(
                     ...
                     new StructureSpawnOverride(
                        StructureSpawnOverride.BoundingBoxType.STRUCTURE,
                        WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.GUARDIAN, new UniformInt(2, 4)))
                     ),
      ...
      context.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_VILLAGE_SAVANNA)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(),
      ...
      context.register(
         ...
         new RuinedPortalStructure(
            ...
            List.of(
               ...
               new RuinedPortalStructure.Setup(RuinedPortalPiece.VerticalPlacement.ON_LAND_SURFACE, 0.0F, 0.2F, false, false, true, false, 0.5F)
            )
         )
      );
      context.register(
      ...
      context.register(
         ...
         new RuinedPortalStructure(
            ...
            new RuinedPortalStructure.Setup(RuinedPortalPiece.VerticalPlacement.ON_LAND_SURFACE, 0.0F, 0.8F, true, true, false, false, 1.0F)
         )
      );
      context.register(
      ...
      context.register(
         ...
         new RuinedPortalStructure(
            ...
            new RuinedPortalStructure.Setup(RuinedPortalPiece.VerticalPlacement.IN_NETHER, 0.0F, 0.0F, false, false, false, true, 1.0F)
         )
      );
      context.register(
         ...
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS))
               ...
               .spawnOverrides(
                  Arrays.stream(MobCategory.values())
                     .collect(
                        Collectors.toMap(c -> (MobCategory)c, c -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of()))
                     )
               )
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_BAMBOO_JUNGLE,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_BAMBOO_JUNGLE))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_BIRCH_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_BIRCH_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_CHERRY_GROVE,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_CHERRY_GROVE))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_DAPPLED_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_DAPPLED_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_FLOWER_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_FLOWER_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_MEADOW,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_MEADOW))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_PALE_GARDEN,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_PALE_GARDEN))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_SAVANNA,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_SAVANNA))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_SNOWY_TAIGA,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_SNOWY_TAIGA))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_SPARSE_JUNGLE,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_SPARSE_JUNGLE))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_SWAMP,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_SWAMP))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_TAIGA,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_TAIGA))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_WINDSWEPT_FOREST,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_WINDSWEPT_FOREST))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
      ...
      context.register(
         BuiltinStructures.ABANDONED_CAMP_WOODED_BADLANDS,
         new JigsawStructure(
            new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ABANDONED_CAMP_WOODED_BADLANDS))
               .terrainAdapation(TerrainAdjustment.BEARD_THIN)
               .build(),
