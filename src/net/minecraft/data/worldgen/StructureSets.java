...
public interface StructureSets {
   static void bootstrap(final BootstrapContext<StructureSet> context) {
      ...
      context.register(
         ...
         new StructureSet(structures.getOrThrow(BuiltinStructures.DESERT_PYRAMID), new RandomSpreadStructurePlacement(32, 8, RandomSpreadType.LINEAR, 14357617))
      );
      context.register(
      ...
      context.register(
         ...
         new StructureSet(structures.getOrThrow(BuiltinStructures.JUNGLE_TEMPLE), new RandomSpreadStructurePlacement(32, 8, RandomSpreadType.LINEAR, 14357619))
      );
      context.register(
      ...
      context.register(
         ...
         new StructureSet(
            ...
            new RandomSpreadStructurePlacement(
               Vec3i.ZERO,
               AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1,
               0.2F,
               165745296,
               Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(villages, 10)),
               32,
               8,
      ...
      context.register(
         ...
         new StructureSet(structures.getOrThrow(BuiltinStructures.ANCIENT_CITY), new RandomSpreadStructurePlacement(24, 8, RandomSpreadType.LINEAR, 20083232))
      );
      context.register(
      ...
      context.register(
         ...
         new StructureSet(
            ...
            new RandomSpreadStructurePlacement(
               new Vec3i(9, 0, 9),
               AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2,
               0.01F,
               0,
               Optional.empty(),
               1,
      ...
      context.register(
         ...
         new StructureSet(structures.getOrThrow(BuiltinStructures.NETHER_FOSSIL), new RandomSpreadStructurePlacement(2, 1, RandomSpreadType.LINEAR, 14357921))
      );
      context.register(
         BuiltinStructureSets.END_CITIES,
         new StructureSet(structures.getOrThrow(BuiltinStructures.END_CITY), new RandomSpreadStructurePlacement(20, 11, RandomSpreadType.TRIANGULAR, 10387313))
      );
      context.register(
      ...
      context.register(
         BuiltinStructureSets.ABANDONED_CAMP,
         new StructureSet(
            List.of(
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_BAMBOO_JUNGLE)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_BIRCH_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_CHERRY_GROVE)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_DAPPLED_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_FLOWER_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_MEADOW)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_PALE_GARDEN)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_SAVANNA)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_SNOWY_TAIGA)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_SPARSE_JUNGLE)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_SWAMP)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_TAIGA)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_WINDSWEPT_FOREST)),
               StructureSet.entry(structures.getOrThrow(BuiltinStructures.ABANDONED_CAMP_WOODED_BADLANDS))
            ),
