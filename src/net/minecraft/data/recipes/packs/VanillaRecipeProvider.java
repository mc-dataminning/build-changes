...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   private final BrewingProvider brewingProvider = new VanillaBrewingProvider(this.output);
   ...
   protected void buildRecipes() {
      Advancement.Builder.recipeAdvancement()
         ...
         .register(this.advancementOutput);
      ...
      this.shaped(RecipeCategory.MISC, Items.BOWL, 4)
         ...
         .pattern("# #")
         .pattern(" # ")
         .unlockedBy("has_mushroom", this.has(ItemTags.MUSHROOMS))
      ...
      this.shaped(RecipeCategory.DECORATIONS, Items.STRAW_BED, 4)
         .define('X', Items.HAY_BLOCK)
         .pattern("XXX")
         .unlockedBy("has_hay_block", this.has(Items.HAY_BLOCK))
         .unlockedBy("has_straw_bed", this.has(Items.STRAW_BED))
         .save(this.output);
      ...
      this.shapeless(RecipeCategory.FOOD, Items.RABBIT_STEW)
         ...
         .requires(Items.BOWL)
         .requires(Items.CARROT)
         .requires(Blocks.SHELF_MUSHROOM)
         .group("rabbit_stew")
         .unlockedBy("has_cooked_rabbit", this.has(Items.COOKED_RABBIT))
      ...
      TransmuteRecipeBuilder.transmute(RecipeCategory.MISC, this.tag(ItemTags.CLONABLE_MAPS), Ingredient.of(Items.MAP), TransmuteResult.KEEP_INPUT_ITEM)
      ...
      SpecialRecipeBuilder.special(
            () -> new MapExtendingRecipe(this.tag(ItemTags.EXTENDABLE_MAPS), Ingredient.of(Items.PAPER), TransmuteResult.KEEP_INPUT_ITEM)
         )
      ...
      SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.NETHER_QUARTZ_ORE), RecipeCategory.MISC, CookingBookCategory.MISC, Items.QUARTZ, 0.2F, 200)
         .unlockedBy("has_nether_quartz_ore", this.has(Blocks.NETHER_QUARTZ_ORE))
      ...
      SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.ANCIENT_DEBRIS), RecipeCategory.MISC, CookingBookCategory.MISC, Items.NETHERITE_SCRAP, 2.0F, 200)
         .unlockedBy("has_ancient_debris", this.has(Blocks.ANCIENT_DEBRIS))
