...
public abstract class AbstractCubeMob extends AgeableMob {
   ...
   private static class CubeMobFloatGoal extends Goal {
      ...
      @Override
      public boolean canUse() {
         return this.cubeMob.isInLiquid() && this.cubeMob.getMoveControl() instanceof AbstractCubeMob.CubeMobMoveControl;
      }
   ...
   private static class CubeMobRandomDirectionGoal extends Goal {
      ...
      public boolean canUse() {
         return this.cubeMob.getTarget() == null
            && (this.cubeMob.onGround() || this.cubeMob.isInLiquid() || this.cubeMob.hasEffect(MobEffects.LEVITATION))
