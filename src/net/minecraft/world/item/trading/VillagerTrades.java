...
public class VillagerTrades {
   ...
   public static final ResourceKey<VillagerTrade> CARTOGRAPHER_3_EMERALD_AND_COMPASS_OCEAN_MONUMENT_MAP = resourceKey(
      "cartographer/3/emerald_and_compass_ocean_monument_map"
   );
   public static final ResourceKey<VillagerTrade> CARTOGRAPHER_3_EMERALD_AND_COMPASS_BURIED_TRIAL_CHAMBERS_MAP = resourceKey(
   ...
   public static final ResourceKey<VillagerTrade> WANDERING_TRADER_EMERALD_POPLAR_LOG = resourceKey("wandering_trader/emerald_poplar_log");
   ...
   public static final ResourceKey<VillagerTrade> WANDERING_TRADER_EMERALD_POPLAR_SAPLING = resourceKey("wandering_trader/emerald_poplar_sapling");
   ...
   public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
      ...
      register(
         context, FARMER_1_WHEAT_EMERALD, VillagerTrade.builder(new TradeCost(Items.WHEAT, 20), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, FARMER_1_POTATO_EMERALD, VillagerTrade.builder(new TradeCost(Items.POTATO, 26), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, FARMER_1_CARROT_EMERALD, VillagerTrade.builder(new TradeCost(Items.CARROT, 22), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         FARMER_1_BEETROOT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.BEETROOT, 15), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, FARMER_1_EMERALD_BREAD, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.BREAD, 6), 16, 1, 0.05F).build()
      );
      register(
         context, FARMER_2_PUMPKIN_EMERALD, VillagerTrade.builder(new TradeCost(Items.PUMPKIN, 6), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      register(
         context,
      ...
      register(
         context, FARMER_2_EMERALD_APPLE, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.APPLE, 4), 16, 5, 0.05F).build()
      );
      register(
         context,
         FARMER_3_EMERALD_COOKIE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.COOKIE, 18), 12, 10, 0.05F).build()
      );
      register(
         context, FARMER_3_MELON_EMERALD, VillagerTrade.builder(new TradeCost(Items.MELON, 4), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.STRING, 20), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, FISHERMAN_1_COAL_EMERALD, VillagerTrade.builder(new TradeCost(Items.COAL, 10), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_1_RAW_COD_AND_EMERALD_COOKED_COD,
         VillagerTrade.builder(new TradeCost(Items.COD, 6), new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.COOKED_COD, 6), 16, 1, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_1_EMERALD_COD_BUCKET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.COD_BUCKET), 16, 1, 0.05F).build()
      );
      register(
         context, FISHERMAN_2_COD_EMERALD, VillagerTrade.builder(new TradeCost(Items.COD, 15), new ItemStackTemplate(Items.EMERALD), 16, 10, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_2_SALMON_AND_EMERALD_COOKED_SALMON,
         VillagerTrade.builder(new TradeCost(Items.SALMON, 6), new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.COOKED_SALMON, 6), 16, 5, 0.05F)
            .build()
      );
      register(
         context,
         FISHERMAN_2_EMERALD_CAMPFIRE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.CAMPFIRE), 12, 5, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_3_SALMON_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.SALMON, 13), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_3_EMERALD_ENCHANTED_FISHING_ROD,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.FISHING_ROD), 3, 10, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.FISHING_ROD))
            .build()
      );
      register(
         context,
         FISHERMAN_4_TROPICAL_FISH_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.TROPICAL_FISH, 6), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         FISHERMAN_5_PUFFERFISH_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.PUFFERFISH, 4), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      registerBoatTrades(context, villagerVariants);
      registerShepherdWoolSales(context);
      register(
         context, SHEPHERD_1_EMERALD_SHEARS, VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.SHEARS), 12, 1, 0.05F).build()
      );
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.PAINTING, 3), 12, 30, 0.05F).build()
      );
      register(
         context, FLETCHER_1_STICK_EMERALD, VillagerTrade.builder(new TradeCost(Items.STICK, 32), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         FLETCHER_1_EMERALD_ARROW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.ARROW, 16), 12, 1, 0.05F).build()
      );
      register(
         context,
         FLETCHER_1_GRAVEL_AND_EMERALD_FLINT,
         VillagerTrade.builder(new TradeCost(Items.GRAVEL, 10), new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.FLINT, 10), 12, 1, 0.05F).build()
      );
      register(
         context, FLETCHER_2_FLINT_EMERALD, VillagerTrade.builder(new TradeCost(Items.FLINT, 26), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.STRING, 14), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F).build()
      );
      register(
         context,
         FLETCHER_3_EMERALD_CROSSBOW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.CROSSBOW), 12, 10, 0.05F).build()
      );
      register(
         context,
         FLETCHER_4_FEATHER_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.FEATHER, 24), new ItemStackTemplate(Items.EMERALD), 16, 30, 0.05F).build()
      );
      register(
         context,
         FLETCHER_4_EMERALD_ENCHANTED_BOW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.BOW), 3, 15, 0.05F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.BOW))
            .build()
      );
      register(
         context,
         FLETCHER_5_TRIPWIRE_HOOK_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.TRIPWIRE_HOOK, 8), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         FLETCHER_5_EMERALD_ENCHANTED_CROSSBOW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.CROSSBOW), 3, 15, 0.05F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.CROSSBOW))
            .build()
      );
      register(
         context,
         FLETCHER_5_ARROW_AND_EMERALD_TIPPED_ARROW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new TradeCost(Items.ARROW, 5), new ItemStackTemplate(Items.TIPPED_ARROW, 5), 12, 30, 0.05F)
            .addModifier(SetRandomPotionFunction.fromTagKey(potionsForTippedArrows))
            .build()
      );
      register(
         context, LIBRARIAN_1_PAPER_EMERALD, VillagerTrade.builder(new TradeCost(Items.PAPER, 24), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_1_EMERALD_AND_BOOK_ENCHANTED_BOOK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 1, 0.2F)
            .addModifiers(enchantedBook(items, enchantmentsForBooks))
            .doubleTradePriceEnchantments(doubleTradePrice)
            .build()
      );
      register(
         context,
         LIBRARIAN_1_EMERALD_BOOKSHELF,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.BOOKSHELF), 12, 1, 0.05F).build()
      );
      register(
         context, LIBRARIAN_2_BOOK_EMERALD, VillagerTrade.builder(new TradeCost(Items.BOOK, 4), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_2_EMERALD_AND_BOOK_ENCHANTED_BOOK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 5, 0.2F)
            .addModifiers(enchantedBook(items, enchantmentsForBooks))
            .doubleTradePriceEnchantments(doubleTradePrice)
            .build()
      );
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.LANTERN), 12, 5, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_3_INK_SAC_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.INK_SAC, 5), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_3_EMERALD_AND_BOOK_ENCHANTED_BOOK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 10, 0.2F)
            .addModifiers(enchantedBook(items, enchantmentsForBooks))
            .doubleTradePriceEnchantments(doubleTradePrice)
            .build()
      );
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.WRITABLE_BOOK, 2), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_4_EMERALD_AND_BOOK_ENCHANTED_BOOK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 15, 0.2F)
            .addModifiers(enchantedBook(items, enchantmentsForBooks))
            .doubleTradePriceEnchantments(doubleTradePrice)
            .build()
      );
      register(
         context, LIBRARIAN_4_EMERALD_CLOCK, VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.CLOCK), 12, 15, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_4_EMERALD_COMPASS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.COMPASS), 12, 15, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_5_EMERALD_YELLOW_CANDLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.DYED_CANDLE.yellow()), 12, 30, 0.05F).build()
      );
      register(
         context,
         LIBRARIAN_5_EMERALD_RED_CANDLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.DYED_CANDLE.red()), 12, 30, 0.05F).build()
      );
      register(
         context,
         CARTOGRAPHER_1_PAPER_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.PAPER, 24), new ItemStackTemplate(Items.EMERALD), 12, 2, 0.05F).build()
      );
      register(
         context, CARTOGRAPHER_1_EMERALD_MAP, VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.MAP), 12, 1, 0.05F).build()
      );
      register(
         context,
         CARTOGRAPHER_2_GLASS_PANE_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.GLASS_PANE, 11), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      registerBasicExplorerMapTrades(context, villagerVariants, structures);
      register(
         context,
         CARTOGRAPHER_3_COMPASS_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.COMPASS, 1), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         CARTOGRAPHER_3_EMERALD_AND_COMPASS_OCEAN_MONUMENT_MAP,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new TradeCost(Items.COMPASS, 1), new ItemStackTemplate(Items.OCEAN_MONUMENT_MAP), 12, 10, 0.2F)
            .addModifiers(
               Holder.direct(
                  ExplorationMapFunction.makeExplorationMap(structures.getOrThrow(StructureTags.ON_OCEAN_MONUMENT_MAPS))
                     .setMapDecoration(MapDecorationTypes.OCEAN_MONUMENT)
                     .setSearchRadius(100)
                     .setSkipKnownStructures(true)
                     .build()
               ),
               discardItemIfItsNot(anyValidMap())
            )
            .build()
      );
      register(
         context,
         CARTOGRAPHER_3_EMERALD_AND_COMPASS_BURIED_TRIAL_CHAMBERS_MAP,
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 12), new TradeCost(Items.COMPASS, 1), new ItemStackTemplate(Items.BURIED_TRIAL_CHAMBERS_MAP), 12, 10, 0.2F
            )
            .addModifiers(
               Holder.direct(
                  ExplorationMapFunction.makeExplorationMap(structures.getOrThrow(StructureTags.ON_BURIED_TRIAL_CHAMBERS_MAPS))
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.ITEM_FRAME), 12, 15, 0.05F).build()
      );
      registerCartographerBannerTrades(context, villagerVariants);
      register(
         context,
         CARTOGRAPHER_5_EMERALD_GLOBE_BANNER_PATTERN,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.GLOBE_BANNER_PATTERN), 12, 30, 0.05F).build()
      );
      register(
         context,
         CARTOGRAPHER_5_EMERALD_AND_COMPASS_WOODLAND_MANSION_MAP,
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 14), new TradeCost(Items.COMPASS, 1), new ItemStackTemplate(Items.WOODLAND_MANSION_MAP), 12, 30, 0.2F
            )
            .addModifiers(
               Holder.direct(
                  ExplorationMapFunction.makeExplorationMap(structures.getOrThrow(StructureTags.ON_WOODLAND_MANSION_MAPS))
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.ROTTEN_FLESH, 32), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         CLERIC_1_EMERALD_REDSTONE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.REDSTONE, 2), 12, 1, 0.05F).build()
      );
      register(
         context,
         CLERIC_2_GOLD_INGOT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.GOLD_INGOT, 3), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      register(
         context,
         CLERIC_2_EMERALD_LAPIS_LAZULI,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.LAPIS_LAZULI), 12, 5, 0.05F).build()
      );
      register(
         context,
         CLERIC_3_RABBIT_FOOT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.RABBIT_FOOT, 2), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         CLERIC_3_EMERALD_GLOWSTONE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.GLOWSTONE), 12, 10, 0.05F).build()
      );
      register(
         context,
         CLERIC_4_TURTLE_SCUTE_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.TURTLE_SCUTE, 4), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         CLERIC_4_GLASS_BOTTLE_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.GLASS_BOTTLE, 9), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         CLERIC_4_EMERALD_ENDER_PEARL,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.ENDER_PEARL), 12, 15, 0.05F).build()
      );
      register(
         context,
         CLERIC_5_NETHER_WART_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.NETHER_WART, 22), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         CLERIC_5_EMERALD_EXPERIENCE_BOTTLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.EXPERIENCE_BOTTLE), 12, 30, 0.05F).build()
      );
      register(
         context, COMMON_SMITH_1_COAL_EMERALD, VillagerTrade.builder(new TradeCost(Items.COAL, 15), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         COMMON_SMITH_2_IRON_INGOT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.IRON_INGOT, 4), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      register(
         context, COMMON_SMITH_2_EMERALD_BELL, VillagerTrade.builder(new TradeCost(Items.EMERALD, 36), new ItemStackTemplate(Items.BELL), 12, 5, 0.2F).build()
      );
      register(
         context,
         ARMORER_1_EMERALD_IRON_LEGGINGS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.IRON_LEGGINGS), 12, 1, 0.2F).build()
      );
      register(
         context,
         ARMORER_1_EMERALD_IRON_BOOTS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.IRON_BOOTS), 12, 1, 0.2F).build()
      );
      register(
         context,
         ARMORER_1_EMERALD_IRON_HELMET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.IRON_HELMET), 12, 1, 0.2F).build()
      );
      register(
         context,
         ARMORER_1_EMERALD_IRON_CHESTPLATE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.IRON_CHESTPLATE), 12, 1, 0.2F).build()
      );
      register(
         context,
         ARMORER_2_EMERALD_CHAINMAIL_BOOTS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 12, 5, 0.2F).build()
      );
      register(
         context,
         ARMORER_2_EMERALD_CHAINMAIL_LEGGINGS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.CHAINMAIL_LEGGINGS), 12, 5, 0.2F).build()
      );
      register(
         context,
         ARMORER_3_LAVA_BUCKET_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.LAVA_BUCKET, 1), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         ARMORER_3_EMERALD_CHAINMAIL_HELMET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 12, 10, 0.2F).build()
      );
      register(
         context,
         ARMORER_3_EMERALD_CHAINMAIL_CHESTPLATE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.CHAINMAIL_CHESTPLATE), 12, 10, 0.2F).build()
      );
      register(
         context, ARMORER_3_EMERALD_SHIELD, VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.SHIELD), 12, 10, 0.2F).build()
      );
      register(
         context,
         ARMORER_3_DIAMOND_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.DIAMOND, 1), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_DIAMOND_LEGGINGS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 14), new ItemStackTemplate(Items.DIAMOND_LEGGINGS), 3, 15, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_DIAMOND_BOOTS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.DIAMOND_BOOTS), 3, 15, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_ENCHANTED_DIAMOND_HELMET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.DIAMOND_HELMET), 3, 30, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_ENCHANTED_DIAMOND_CHESTPLATE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 16), new ItemStackTemplate(Items.DIAMOND_CHESTPLATE), 3, 30, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_CHESTPLATE))
            .build()
      );
      register(
         context,
         WEAPONSMITH_1_EMERALD_IRON_AXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.IRON_AXE), 12, 1, 0.2F).build()
      );
      register(
         context,
         WEAPONSMITH_1_EMERALD_ENCHANTED_IRON_SWORD,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.IRON_SWORD), 12, 1, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_SWORD))
            .build()
      );
      register(
         context,
         WEAPONSMITH_3_FLINT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.FLINT, 24), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         WEAPONSMITH_4_EMERALD_ENCHANTED_DIAMOND_AXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 12), new ItemStackTemplate(Items.DIAMOND_AXE), 3, 15, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_AXE))
            .build()
      );
      register(
         context,
         WEAPONSMITH_4_DIAMOND_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.DIAMOND, 1), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         WEAPONSMITH_5_EMERALD_ENCHANTED_DIAMOND_SWORD,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.DIAMOND_SWORD), 3, 30, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_SWORD))
            .build()
      );
      register(
         context,
         TOOLSMITH_1_EMERALD_STONE_AXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.STONE_AXE), 12, 1, 0.2F).build()
      );
      register(
         context,
         TOOLSMITH_1_EMERALD_STONE_SHOVEL,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.STONE_SHOVEL), 12, 1, 0.2F).build()
      );
      register(
         context,
         TOOLSMITH_1_EMERALD_STONE_PICKAXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.STONE_PICKAXE), 12, 1, 0.2F).build()
      );
      register(
         context,
         TOOLSMITH_1_EMERALD_STONE_HOE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.STONE_HOE), 12, 1, 0.2F).build()
      );
      register(
         context, TOOLSMITH_3_FLINT_EMERALD, VillagerTrade.builder(new TradeCost(Items.FLINT, 30), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
         TOOLSMITH_3_EMERALD_IRON_AXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.IRON_AXE), 3, 10, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_AXE))
            .build()
      );
      register(
         context,
         TOOLSMITH_3_EMERALD_IRON_SHOVEL,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.IRON_SHOVEL), 3, 10, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_SHOVEL))
            .build()
      );
      register(
         context,
         TOOLSMITH_3_EMERALD_IRON_PICKAXE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.IRON_PICKAXE), 3, 10, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_PICKAXE))
            .build()
      );
      register(
         context,
         TOOLSMITH_3_EMERALD_DIAMOND_HOE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.DIAMOND_HOE), 3, 10, 0.2F).build()
      );
      register(
         context,
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.DIAMOND_SHOVEL), 3, 15, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_SHOVEL))
            .build()
      );
      register(
         context,
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new ItemStackTemplate(Items.DIAMOND_PICKAXE), 3, 30, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.DIAMOND_PICKAXE))
            .build()
      );
      register(
         context,
         BUTCHER_1_CHICKEN_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.CHICKEN, 14), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         BUTCHER_1_PORKCHOP_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.PORKCHOP, 7), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, BUTCHER_1_RABBIT_EMERALD, VillagerTrade.builder(new TradeCost(Items.RABBIT, 4), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         BUTCHER_1_EMERALD_RABBIT_STEW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.RABBIT_STEW), 12, 1, 0.05F).build()
      );
      register(
         context, BUTCHER_2_COAL_EMERALD, VillagerTrade.builder(new TradeCost(Items.COAL, 15), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         BUTCHER_2_EMERALD_COOKED_PORKCHOP,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.COOKED_PORKCHOP, 5), 16, 5, 0.05F).build()
      );
      register(
         context,
         BUTCHER_2_EMERALD_COOKED_CHICKEN,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.COOKED_CHICKEN, 8), 16, 5, 0.05F).build()
      );
      register(
         context, BUTCHER_3_MUTTON_EMERALD, VillagerTrade.builder(new TradeCost(Items.MUTTON, 7), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F).build()
      );
      register(
         context, BUTCHER_3_BEEF_EMERALD, VillagerTrade.builder(new TradeCost(Items.BEEF, 10), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F).build()
      );
      register(
         context,
         BUTCHER_4_DRIED_KELP_BLOCK_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.DRIED_KELP_BLOCK, 10), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         BUTCHER_5_SWEET_BERRIES_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.SWEET_BERRIES, 10), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      register(
         context,
         LEATHERWORKER_1_LEATHER_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.LEATHER, 6), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context,
         LEATHERWORKER_1_EMERALD_DYED_LEATHER_LEGGINGS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.LEATHER_LEGGINGS), 12, 1, 0.2F)
            .addModifiers(dyedItem(items, Items.LEATHER_LEGGINGS))
            .build()
      );
      register(
         context,
         LEATHERWORKER_1_EMERALD_DYED_LEATHER_CHESTPLATE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.LEATHER_CHESTPLATE), 12, 1, 0.2F)
            .addModifiers(dyedItem(items, Items.LEATHER_CHESTPLATE))
            .build()
      );
      register(
         context,
         LEATHERWORKER_2_FLINT_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.FLINT, 26), new ItemStackTemplate(Items.EMERALD), 12, 10, 0.05F).build()
      );
      register(
         context,
         LEATHERWORKER_2_EMERALD_DYED_LEATHER_HELMET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.LEATHER_HELMET), 12, 5, 0.2F)
            .addModifiers(dyedItem(items, Items.LEATHER_HELMET))
            .build()
      );
      register(
         context,
         LEATHERWORKER_2_EMERALD_DYED_LEATHER_BOOTS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.LEATHER_BOOTS), 12, 5, 0.2F)
            .addModifiers(dyedItem(items, Items.LEATHER_BOOTS))
            .build()
      );
      register(
         context,
         LEATHERWORKER_3_RABBIT_HIDE_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.RABBIT_HIDE, 9), new ItemStackTemplate(Items.EMERALD), 12, 20, 0.05F).build()
      );
      register(
         context,
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 6), new ItemStackTemplate(Items.LEATHER_HORSE_ARMOR), 12, 15, 0.2F)
            .addModifiers(dyedItem(items, Items.LEATHER_HORSE_ARMOR))
            .build()
      );
      register(
         context,
         LEATHERWORKER_5_EMERALD_SADDLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 6), new ItemStackTemplate(Items.SADDLE), 12, 30, 0.2F).build()
      );
      register(
         context,
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.CLAY_BALL, 10), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F).build()
      );
      register(
         context, MASON_1_EMERALD_BRICK, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.BRICK, 10), 16, 1, 0.05F).build()
      );
      register(
         context, MASON_2_STONE_EMERALD, VillagerTrade.builder(new TradeCost(Items.STONE, 20), new ItemStackTemplate(Items.EMERALD), 16, 10, 0.05F).build()
      );
      register(
         context,
         MASON_2_EMERALD_CHISELED_STONE_BRICKS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.CHISELED_STONE_BRICKS, 4), 16, 5, 0.05F).build()
      );
      registerMasonLevelThreeStones(context);
      registerMasonLevelThreeBlocks(context);
      register(
         context, MASON_4_QUARTZ_EMERALD, VillagerTrade.builder(new TradeCost(Items.QUARTZ, 12), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F).build()
      );
      registerMasonLevelFourTerracotta(context);
      register(
         context,
         MASON_5_EMERALD_QUARTZ_PILLAR,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.QUARTZ_PILLAR), 12, 30, 0.05F).build()
      );
      register(
         context,
         MASON_5_EMERALD_QUARTZ_BLOCK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.QUARTZ_BLOCK), 12, 30, 0.05F).build()
      );
      context.register(
      ...
      context.register(
         ...
         VillagerTrade.builder(new TradeCost(Items.WATER_BUCKET, 1), new ItemStackTemplate(Items.EMERALD, 2), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_MILK_BUCKET_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.MILK_BUCKET, 1), new ItemStackTemplate(Items.EMERALD, 2), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_FERMENTED_SPIDER_EYE_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.FERMENTED_SPIDER_EYE, 1), new ItemStackTemplate(Items.EMERALD, 3), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_BAKED_POTATO_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.BAKED_POTATO, 4), new ItemStackTemplate(Items.EMERALD, 1), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_HAY_BLOCK_EMERALD,
         VillagerTrade.builder(new TradeCost(Items.HAY_BLOCK, 1), new ItemStackTemplate(Items.EMERALD), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PACKED_ICE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.PACKED_ICE), 6, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_BLUE_ICE, VillagerTrade.builder(new TradeCost(Items.EMERALD, 6), new ItemStackTemplate(Items.BLUE_ICE), 6, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_GUNPOWDER,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.GUNPOWDER, 4), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PODZOL, VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.PODZOL, 3), 6, 1, 0.05F).build()
      );
      ...
      context.register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.IRON_PICKAXE), 1, 1, 0.2F)
            .addModifiers(enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_PICKAXE))
            .build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_LONG_INVISIBILITY_POTION,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.POTION), 1, 1, 0.05F)
            .addModifier(SetPotionFunction.setPotion(Potions.LONG_INVISIBILITY))
            .build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_TROPICAL_FISH_BUCKET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.TROPICAL_FISH_BUCKET), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PUFFERFISH_BUCKET,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.PUFFERFISH_BUCKET), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SEA_PICKLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.SEA_PICKLE), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SLIME_BALL,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.SLIME_BALL), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_GLOWSTONE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.GLOWSTONE), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_NAUTILUS_SHELL,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.NAUTILUS_SHELL), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_FERN, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.FERN), 12, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SUGAR_CANE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.SUGAR_CANE), 8, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PUMPKIN, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.PUMPKIN), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_KELP, VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.KELP), 12, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_CACTUS, VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.CACTUS), 8, 1, 0.05F).build()
      );
      ...
      context.register(
         WANDERING_TRADER_EMERALD_VINE, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.VINE, 3), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PALE_HANGING_MOSS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.PALE_HANGING_MOSS, 3), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_BROWN_MUSHROOM,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.BROWN_MUSHROOM, 3), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_RED_MUSHROOM,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.RED_MUSHROOM, 3), 4, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_LILY_PAD,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.LILY_PAD, 5), 2, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SMALL_DRIPLEAF,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.SMALL_DRIPLEAF, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SAND, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.SAND, 8), 8, 1, 0.05F).build()
      );
      context.register(
      ...
      context.register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.POINTED_DRIPSTONE, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_SULFUR_SPIKE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.SULFUR_SPIKE, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_ROOTED_DIRT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.ROOTED_DIRT, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_MOSS_BLOCK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.MOSS_BLOCK, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_PALE_MOSS_BLOCK,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(Items.PALE_MOSS_BLOCK, 2), 5, 1, 0.05F).build()
      );
      context.register(
         WANDERING_TRADER_EMERALD_FIREFLY_BUSH,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.FIREFLY_BUSH), 12, 1, 0.05F).build()
      );
      context.register(
   ...
   private static void registerWanderingTraderFlowers(final BootstrapContext<VillagerTrade> context) {
      ...
      context.register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.GOLDEN_DANDELION), 12, 1, 0.05F).build()
      );
   }
   ...
   private static void registerWanderingTraderDyes(final BootstrapContext<VillagerTrade> context) {
      ColorCollection.zipApply(
         ...
         Items.DYE,
         (name, dye) -> context.register(name, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(dye, 3), 12, 1, 0.05F).build())
      );
   }
   ...
   private static void registerWanderingTraderTerracottaSellTrades(
      ...
      ColorCollection.zipApply(
         trades,
         items,
         (trade, item) -> register(context, trade, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(item), 12, 15, 0.05F).build())
      );
   }
   ...
   private static VillagerTrade createMasonBoatBuyTrade(
      ...
      return VillagerTrade.builder(new TradeCost(item, 1), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05F)
         .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, villagerTypes)))
         .build();
   }
   ...
   private static void registerWoolPurchases(final BootstrapContext<VillagerTrade> context) {
      ColorCollection.zipApply(
         ...
         Items.WOOL,
         (name, wool) -> register(context, name, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(wool), 16, 5, 0.05F).build())
      );
   }
   ...
   private static void registerCarpetPurchases(final BootstrapContext<VillagerTrade> context) {
      ColorCollection.zipApply(
         ...
         (name, carpet) -> register(
               context, name, VillagerTrade.builder(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(carpet, 4), 16, 5, 0.05F).build()
            )
      );
   }
   ...
   private static void registerBedTrades(final BootstrapContext<VillagerTrade> context) {
      ColorCollection.zipApply(
         ...
         Items.BED,
         (name, bed) -> register(context, name, VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(bed), 12, 10, 0.05F).build())
      );
   }
   ...
   private static void registerShepherdBannerTrades(final BootstrapContext<VillagerTrade> context) {
      ColorCollection.zipApply(
         ...
         Items.BANNER,
         (name, banner) -> register(context, name, VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(banner), 12, 15, 0.05F).build())
      );
   }
   ...
   private static VillagerTrade createCartographerBannerSell(
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(item), 12, 15, 0.05F)
         .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, villagerTypes)))
         .build();
   }

   private static void registerBasicExplorerMapTrades(
      final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants, final HolderGetter<Structure> structures
   ) {
      register(
         context,
      ...
      register(
         ...
         createBasicExplorerMapTrades(
            villagerVariants,
            structures,
            StructureTags.ON_SWAMP_HUT_MAPS,
      ...
      register(
         ...
         createBasicExplorerMapTrades(
            villagerVariants,
            structures,
            StructureTags.ON_JUNGLE_PYRAMID_MAPS,
   ...
   private static VillagerTrade createBasicExplorerMapTrades(
      ...
      final HolderGetter<Structure> structures,
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new TradeCost(Items.COMPASS, 1), new ItemStackTemplate(mapItem), 12, 5, 0.2F)
         .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, villagerTypes)))
         .addModifiers(
            Holder.direct(
               ExplorationMapFunction.makeExplorationMap(structures.getOrThrow(structureTagKey))
   ...
   private static List<Holder<LootItemFunction>> dyedItem(final HolderGetter<Item> items, final Item expectedItem) {
      ItemPredicate.Builder anyDyedItem = new ItemPredicate.Builder()
   ...
   public static List<Holder<LootItemFunction>> enchantedBook(final HolderGetter<Item> items, final HolderSet<Enchantment> options) {
      ItemPredicate.Builder bookWithAnyEnchants = new ItemPredicate.Builder()
      ...
      return discardItemIfItsNot(
         new EnchantRandomlyFunction.Builder().withOptions(options).allowingIncompatibleEnchantments().includeAdditionalCostComponent(), bookWithAnyEnchants
      );
   }
   ...
   public static List<Holder<LootItemFunction>> enchantedItem(
      final HolderGetter<Item> items, final Holder<Enchantment> enchantment, final int level, final Item expectedItem
   ) {
      ItemPredicate.Builder itemWithExactLevelEnchants = new ItemPredicate.Builder()
         .of(items, expectedItem)
         .withComponents(
            DataComponentMatchers.Builder.components()
               .partial(
   ...
   public static Holder<LootItemFunction> discardItemIfItsNot(final ItemPredicate.Builder test) {
      return Holder.direct(FilteredFunction.filtered(test.build()).onFail(DiscardItem.discardItem().build()).build());
   }
