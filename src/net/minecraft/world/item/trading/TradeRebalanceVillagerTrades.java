...
public class TradeRebalanceVillagerTrades extends VillagerTrades {
   ...
   public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.IRON_INGOT, 5), new ItemStackTemplate(Items.EMERALD), 12, 5, 0.05F)
            .merchantPredicate(
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.IRON_BOOTS), 12, 5, 0.05F)
            .merchantPredicate(
               villagerTypeRestriction(
                  villagerTypeHolderSet(
                     villagerVariants, List.of(VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA)
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.IRON_HELMET), 12, 5, 0.05F)
            .merchantPredicate(
               villagerTypeRestriction(
                  villagerTypeHolderSet(
                     villagerVariants, List.of(VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA)
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.IRON_LEGGINGS), 12, 5, 0.05F)
            .merchantPredicate(
               villagerTypeRestriction(
                  villagerTypeHolderSet(
                     villagerVariants, List.of(VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA)
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.IRON_CHESTPLATE), 12, 5, 0.05F)
            .merchantPredicate(
               villagerTypeRestriction(
                  villagerTypeHolderSet(
                     villagerVariants, List.of(VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA)
      ...
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 4), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 12, 5, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE, VillagerType.SWAMP))))
            .build()
      );
      register(
         context,
         ARMORER_2_EMERALD_CHAINMAIL_HELMET_GROUP_2,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 12, 5, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE, VillagerType.SWAMP))))
            .build()
      );
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.CHAINMAIL_LEGGINGS), 12, 5, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE, VillagerType.SWAMP))))
            .build()
      );
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.CHAINMAIL_CHESTPLATE), 12, 5, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE, VillagerType.SWAMP))))
            .build()
      );
      register(
         context, ARMORER_3_EMERALD_BELL, VillagerTrade.builder(new TradeCost(Items.EMERALD, 36), new ItemStackTemplate(Items.BELL), 12, 10, 0.2F).build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_BOOTS_DESERT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.IRON_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.IRON_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_HELMET_DESERT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.IRON_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.IRON_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_LEGGINGS_DESERT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 11), new ItemStackTemplate(Items.IRON_LEGGINGS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.IRON_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_CHESTPLATE_DESERT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new ItemStackTemplate(Items.IRON_CHESTPLATE), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.IRON_CHESTPLATE))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.IRON_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.IRON_BOOTS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.IRON_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.IRON_HELMET))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 11), new ItemStackTemplate(Items.IRON_LEGGINGS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.IRON_LEGGINGS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new ItemStackTemplate(Items.IRON_CHESTPLATE), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.IRON_CHESTPLATE))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_BOOTS_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 2), new ItemStackTemplate(Items.IRON_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.IRON_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_HELMET_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.IRON_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.IRON_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_LEGGINGS_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(Items.IRON_LEGGINGS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.IRON_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_IRON_CHESTPLATE_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.IRON_CHESTPLATE), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.IRON_CHESTPLATE))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.IRON_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SNOW))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.FROST_WALKER), 1, Items.IRON_BOOTS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.IRON_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SNOW))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.AQUA_AFFINITY), 1, Items.IRON_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_CHAINMAIL_BOOTS_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.UNBREAKING), 1, Items.CHAINMAIL_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_CHAINMAIL_HELMET_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.UNBREAKING), 1, Items.CHAINMAIL_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_CHAINMAIL_LEGGINGS_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 11), new ItemStackTemplate(Items.CHAINMAIL_LEGGINGS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.UNBREAKING), 1, Items.CHAINMAIL_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_4_EMERALD_ENCHANTED_CHAINMAIL_CHESTPLATE_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new ItemStackTemplate(Items.CHAINMAIL_CHESTPLATE), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.UNBREAKING), 1, Items.CHAINMAIL_CHESTPLATE))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.MENDING), 1, Items.CHAINMAIL_BOOTS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.MENDING), 1, Items.CHAINMAIL_HELMET))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 11), new ItemStackTemplate(Items.CHAINMAIL_LEGGINGS), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.MENDING), 1, Items.CHAINMAIL_LEGGINGS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 13), new ItemStackTemplate(Items.CHAINMAIL_CHESTPLATE), 3, 15, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.MENDING), 1, Items.CHAINMAIL_CHESTPLATE))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 4), new TradeCost(Items.DIAMOND_BOOTS, 1), new ItemStackTemplate(Items.DIAMOND_LEGGINGS), 3, 15, 0.05F
            )
      ...
      register(
         ...
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 4), new TradeCost(Items.DIAMOND_LEGGINGS, 1), new ItemStackTemplate(Items.DIAMOND_CHESTPLATE), 3, 15, 0.05F
            )
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .build()
      );
      register(
         ...
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 4), new TradeCost(Items.DIAMOND_HELMET, 1), new ItemStackTemplate(Items.DIAMOND_BOOTS), 3, 15, 0.05F
            )
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .build()
      );
      register(
         ...
         VillagerTrade.builder(
               new TradeCost(Items.EMERALD, 2), new TradeCost(Items.DIAMOND_CHESTPLATE, 1), new ItemStackTemplate(Items.DIAMOND_HELMET), 3, 15, 0.05F
            )
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .build()
      );
      register(
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 16), new TradeCost(Items.DIAMOND, 4), new ItemStackTemplate(Items.DIAMOND_CHESTPLATE), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.DIAMOND_CHESTPLATE))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_LEGGINGS_DESERT,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 16), new TradeCost(Items.DIAMOND, 3), new ItemStackTemplate(Items.DIAMOND_LEGGINGS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.THORNS), 1, Items.DIAMOND_LEGGINGS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 16), new TradeCost(Items.DIAMOND, 3), new ItemStackTemplate(Items.DIAMOND_LEGGINGS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.DIAMOND_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_BOOTS_PLAINS,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 12), new TradeCost(Items.DIAMOND, 2), new ItemStackTemplate(Items.DIAMOND_BOOTS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.PLAINS))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROTECTION), 1, Items.DIAMOND_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_HELMET_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 6), new TradeCost(Items.DIAMOND, 2), new ItemStackTemplate(Items.DIAMOND_HELMET), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.DIAMOND_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_CHESTPLATE_SAVANNA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new TradeCost(Items.DIAMOND, 3), new ItemStackTemplate(Items.DIAMOND_CHESTPLATE), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SAVANNA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BINDING_CURSE), 1, Items.DIAMOND_CHESTPLATE))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 12), new TradeCost(Items.DIAMOND, 2), new ItemStackTemplate(Items.DIAMOND_BOOTS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SNOW))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.FROST_WALKER), 1, Items.DIAMOND_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_HELMET_SNOW,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 12), new TradeCost(Items.DIAMOND, 3), new ItemStackTemplate(Items.DIAMOND_HELMET), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SNOW))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.AQUA_AFFINITY), 1, Items.DIAMOND_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_CHAINMAIL_HELMET_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.PROJECTILE_PROTECTION), 1, Items.CHAINMAIL_HELMET))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_CHAINMAIL_BOOTS_JUNGLE,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.JUNGLE))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.FEATHER_FALLING), 1, Items.CHAINMAIL_BOOTS))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 9), new ItemStackTemplate(Items.CHAINMAIL_HELMET), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.RESPIRATION), 1, Items.CHAINMAIL_HELMET))
            .build()
      );
      register(
         context,
         ...
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 8), new ItemStackTemplate(Items.CHAINMAIL_BOOTS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.SWAMP))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.DEPTH_STRIDER), 1, Items.CHAINMAIL_BOOTS))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_CHESTPLATE_TAIGA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 18), new TradeCost(Items.DIAMOND, 4), new ItemStackTemplate(Items.DIAMOND_CHESTPLATE), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BLAST_PROTECTION), 1, Items.DIAMOND_CHESTPLATE))
            .build()
      );
      register(
         context,
         ARMORER_5_EMERALD_AND_DIAMOND_DIAMOND_LEGGINGS_TAIGA,
         VillagerTrade.builder(new TradeCost(Items.EMERALD, 18), new TradeCost(Items.DIAMOND, 3), new ItemStackTemplate(Items.DIAMOND_LEGGINGS), 3, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .addModifiers(enchantedItem(items, enchantments.getOrThrow(Enchantments.BLAST_PROTECTION), 1, Items.DIAMOND_LEGGINGS))
            .build()
      );
      register(
         context,
         ARMORER_5_DIAMOND_BLOCK_EMERALD_TAIGA,
         VillagerTrade.builder(new TradeCost(Items.DIAMOND_BLOCK, 1), new ItemStackTemplate(Items.EMERALD, 42), 12, 30, 0.05F)
            .merchantPredicate(villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, List.of(VillagerType.TAIGA))))
            .build()
      );
      return register(
   ...
   private static VillagerTrade createLibrarianLevel1EnchantmentTrade(
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 1, 0.2F)
         .merchantPredicate(villagerTypeRestriction(villagerTypes))
         .addModifiers(enchantedBook(items, enchantments))
   ...
   private static VillagerTrade createLibrarianLevel2EnchantmentTrade(
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 5, 0.2F)
         .merchantPredicate(villagerTypeRestriction(villagerTypes))
         .addModifiers(enchantedBook(items, enchantments))
         .doubleTradePriceEnchantments(doubleTradePrice)
         .build();
   ...
   private static VillagerTrade createLibrarianLevel3EnchantmentTrade(
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 10, 0.2F)
         .merchantPredicate(villagerTypeRestriction(villagerTypes))
         .addModifiers(enchantedBook(items, enchantments))
         .doubleTradePriceEnchantments(doubleTradePrice)
         .build();
   ...
   private static VillagerTrade createLibrarianLevel5EnchantmentTrade(
      ...
      return VillagerTrade.builder(
         ...
         .merchantPredicate(villagerTypeRestriction(villagerTypes))
         .addModifiers(enchantedBook(items, enchantment, level))
         .doubleTradePriceEnchantments(doubleTradePrice)
         .build();
   }
   ...
   private static VillagerTrade createLibrarianLevel5SpecialEnchantmentTrade(
      ...
      return VillagerTrade.builder(new TradeCost(Items.EMERALD, 0), new TradeCost(Items.BOOK, 1), new ItemStackTemplate(Items.ENCHANTED_BOOK), 12, 30, 0.2F)
         .merchantPredicate(villagerTypeRestriction(villagerTypes))
         .addModifiers(enchantedBook(items, HolderSet.direct(enchantment)))
         .doubleTradePriceEnchantments(doubleTradePrice)
         .build();
   }
}
