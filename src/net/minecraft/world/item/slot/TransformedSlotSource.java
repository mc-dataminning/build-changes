...
public abstract class TransformedSlotSource implements SlotSource {
   ...
   protected static <T extends TransformedSlotSource> P1<Mu<T>, Holder<SlotSource>> commonFields(final Instance<T> i) {
   ...
   public final SlotCollection provide(final LootContext context) {
      return this.transform(this.slotSource.value().provide(context));
   }
