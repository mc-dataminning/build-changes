...
public class SoundType {
   ...
   public static final SoundType SHELF_MUSHROOM = new SoundType(
      1.0F,
      1.0F,
      SoundEvents.SHELF_MUSHROOM_BREAK,
      SoundEvents.SHELF_MUSHROOM_STEP,
      SoundEvents.SHELF_MUSHROOM_PLACE,
      SoundEvents.EMPTY,
      SoundEvents.SHELF_MUSHROOM_FALL
   );
   public static final SoundType POPLAR_LEAVES = new SoundType(
      1.0F,
      1.0F,
      SoundEvents.POPLAR_LEAVES_BREAK,
      SoundEvents.POPLAR_LEAVES_STEP,
      SoundEvents.POPLAR_LEAVES_PLACE,
      SoundEvents.POPLAR_LEAVES_HIT,
      SoundEvents.POPLAR_LEAVES_FALL
   );
   public static final SoundType STRAW_BED = new SoundType(
      1.0F, 1.0F, SoundEvents.STRAW_BED_BREAK, SoundEvents.STRAW_BED_STEP, SoundEvents.STRAW_BED_PLACE, SoundEvents.STRAW_BED_HIT, SoundEvents.STRAW_BED_FALL
   );
   public static final SoundType RED_SHRUB = new SoundType(
      1.0F, 1.0F, SoundEvents.RED_SHRUB_BREAK, SoundEvents.EMPTY, SoundEvents.RED_SHRUB_PLACE, SoundEvents.EMPTY, SoundEvents.EMPTY
   );
