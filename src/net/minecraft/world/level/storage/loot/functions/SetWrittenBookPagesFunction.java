...
public class SetWrittenBookPagesFunction extends LootItemConditionalFunction {
   ...
   protected SetWrittenBookPagesFunction(
      final Optional<Holder<LootItemCondition>> condition, final List<Filterable<Component>> pages, final ListOperation pageOperation
   ) {
      super(condition);
      this.pages = pages;
