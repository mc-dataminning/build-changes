...
public class ContextIntProviders {
   ...
   public static final ResourceKey<ContextIntProvider> COMPOSTABLE_LOW = createKey("compostable/low");
   public static final ResourceKey<ContextIntProvider> COMPOSTABLE_LOW_MEDIUM = createKey("compostable/low_medium");
   public static final ResourceKey<ContextIntProvider> COMPOSTABLE_MEDIUM = createKey("compostable/medium");
   public static final ResourceKey<ContextIntProvider> COMPOSTABLE_MEDIUM_HIGH = createKey("compostable/medium_high");
   public static final ResourceKey<ContextIntProvider> COMPOSTABLE_ALWAYS_ADD_ONE = createKey("compostable/always_add_one");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_BAMBOO = createKey("cooking/time_bamboo");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOL_SLABS = createKey("cooking/time_wool_slabs");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOL_CARPETS = createKey("cooking/time_wool_carpets");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_DRY_PLANTS = createKey("cooking/time_dry_plants");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOD_ITEMS_EXTRA_SMALL = createKey("cooking/time_wood_items_extra_small");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOL = createKey("cooking/time_wool");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOD_SLABS = createKey("cooking/time_wood_slabs");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOD_ITEMS_LARGE = createKey("cooking/time_wood_items_large");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOD_ITEMS_SMALL = createKey("cooking/time_wood_items_small");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_ROOTS = createKey("cooking/time_roots");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_WOOD_BLOCKS = createKey("cooking/time_wood_blocks");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_HANGING_SIGNS = createKey("cooking/time_hanging_signs");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_BOATS = createKey("cooking/time_boats");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_COAL = createKey("cooking/time_coal");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_BLAZE_ROD = createKey("cooking/time_blaze_rod");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_DRIED_KELP_BLOCK = createKey("cooking/time_dried_kelp_block");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_COAL_BLOCK = createKey("cooking/time_coal_block");
   public static final ResourceKey<ContextIntProvider> COOKING_TIME_LAVA_BUCKET = createKey("cooking/time_lava_bucket");
   public static final ResourceKey<ContextIntProvider> COOKING_NORMAL_BURN_TIME_REDUCTION_FACTOR = createKey("cooking/normal_burn_time_reduction_factor");
   public static final ResourceKey<ContextIntProvider> COOKING_FAST_BURN_TIME_REDUCTION_FACTOR = createKey("cooking/fast_burn_time_reduction_factor");
   public static final ResourceKey<ContextIntProvider> BREWING_DEFAULT_USES = createKey("brewing/uses_default");
   ...
   private static ContextIntProvider compostable(final HolderGetter<Block> blocks, final int layerIncreaseChance) {
      if (layerIncreaseChance >= 100) {
         ...
         WeightedList<Holder<ContextIntProvider>> cases = WeightedList.<Holder<ContextIntProvider>>builder()
            .add(exactly(1), layerIncreaseChance)
            .add(exactly(0), 100 - layerIncreaseChance)
            .build();
         return new NumberDispatcher(List.of(emptyCase), weighted(cases));
      }
   }

   private static ContextIntProvider cooking(
      final HolderGetter<LootItemCondition> predicates,
      final Holder.Reference<ContextIntProvider> normalBurnTimeDivisor,
      final Holder.Reference<ContextIntProvider> fastBurnTimeDivisor,
      ...
      return div(exactly(timeSeconds), Holder.direct(fastConditional)).value();
   }
   ...
   public static Holder<ContextIntProvider> binomial(final int n, final float p) {
      return Holder.direct(new BinomialDistributionGenerator(exactly(n), ContextFloatProviders.exactly(p)));
   }
   ...
   public static Holder<ContextIntProvider> fromScoreboard(final LootContext.EntityTarget entityTarget, final String score) {
      return Holder.direct(new ScoreboardValue(ContextScoreboardNameProvider.forTarget(entityTarget), score, exactly(0)));
   }
