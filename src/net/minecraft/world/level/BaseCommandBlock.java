...
public abstract class BaseCommandBlock {
   ...
   private BaseCommandBlock.CloseableCommandBlockSource createSource(final ServerLevel level) {
   ...
   public void setLastOutput(@Nullable final Component lastOutput) {
