...
public final class MaterialRuleContext {
   ...
   @Nullable
   private DensityBuffer preliminarySurfaceBuffer;
   ...
   MaterialRuleContext(
      final MaterialSystem system,
      final RandomState randomState,
      final DensityVolume expectedVolume,
      ...
      this.preliminarySurfaceVolume = new DensityVolume(
         expectedVolume.sizeX(), 1, expectedVolume.sizeZ(), expectedVolume.minBlockX(), 0, expectedVolume.minBlockZ()
      );
   }
      ...
      return new DoubleSupplier() {
         ...
         public double getAsDouble() {
            if (this.lastUpdateY != MaterialRuleContext.this.lastUpdateY) {
               this.lastNoise = (double)noise.get(
                  (double)MaterialRuleContext.this.blockX, (double)MaterialRuleContext.this.blockY, (double)MaterialRuleContext.this.blockZ
               );
