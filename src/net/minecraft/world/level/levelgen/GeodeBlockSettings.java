...
public record GeodeBlockSettings(
   ...
   public static final Codec<GeodeBlockSettings> CODEC = RecordCodecBuilder.create(
      i -> i.group(
               ...
               RegistryCodecs.holderSet(Registries.BLOCK).fieldOf("cannot_replace").forGetter(GeodeBlockSettings::cannotReplace),
               RegistryCodecs.holderSet(Registries.BLOCK).fieldOf("invalid_blocks").forGetter(GeodeBlockSettings::invalidBlocks)
            )
