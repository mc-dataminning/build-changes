...
public class Main {
   ...
   public static void main(String[] $$0) {
      ...
      try {
         ...
         alb $$25 = alb.a(new YggdrasilAuthenticationService(Proxy.NO_PROXY), $$24);
         String $$26 = (String)Optional.ofNullable((String)$$18.valueOf($$12)).orElse($$21.a().m);
         eob $$27 = eob.b($$24.toPath());
         eob.c $$28 = $$27.d($$26);
         Dynamic<?> $$29;
         if ($$28.m()) {
            eoc $$30;
         ...
         ale $$43;
         try {
            ald.c $$42 = a($$21.a(), $$39, $$40, $$41);
            $$43 = ac.<ale>c($$6x -> ald.a($$42, $$5xx -> {
                  jj<dua> $$6xx = $$5xx.d().d(le.aT);
                  if ($$39 != null) {
                     eny $$7x = eob.a($$39, $$5xx.b(), $$6xx, $$5xx.c());
                     return new ald.b<>($$7x.a(), $$7x.b().b());
                  } else {
                     ...
                     if ($$18.has($$4)) {
                        ...
                        ape $$11x = $$21.a();
                        $$8x = new dah($$11x.m, $$11x.l, $$11x.u, $$11x.k, false, new czz(), $$5xx.b());
                     ...
                     return new ald.b<>(new eof($$8x, $$9x, $$15x.d(), $$16x), $$15x.b());
                  }
               }, ale::new, ac.f(), $$6x)).get();
         ...
         boolean $$47 = $$18.has($$8);
         if ($$18.has($$6) || $$47) {
            a($$28, azg.a(), $$18.has($$7), () -> true, $$46, $$47);
         }

         eoh $$48 = $$43.d();
         $$28.a($$46, $$48);
         final apd $$49 = MinecraftServer.a((Function<Thread, apd>)($$11x -> {
            apd $$12x = new apd($$11x, $$28, $$41, $$43, $$21, azg.a(), $$25, aqs::b);
   ...
   private static ald.c a(ape $$0, @Nullable Dynamic<?> $$1, boolean $$2, atc $$3) {
      boolean $$5;
      dax $$6;
      if ($$1 != null) {
         dax $$4 = eob.a($$1);
      ...
      ald.d $$9 = new ald.d($$3, $$6, $$2, $$5);
      return new ald.c($$9, ee.a.b, $$0.B);
   }

   private static void a(eob.c $$0, DataFixer $$1, boolean $$2, BooleanSupplier $$3, jk $$4, boolean $$5) {
      a.info("Forcing world upgrade!");
      bpa $$6 = new bpa($$0, $$1, $$4, $$2, $$5);
      wu $$7 = null;
      ...
      while (!$$6.b()) {
         ...
         if ($$9 > 0) {
            int $$10 = $$6.f() + $$6.g();
            a.info("{}% completed ({} / {} chunks)...", new Object[]{axz.d((float)$$10 / (float)$$9 * 100.0F), $$10, $$9});
         }
