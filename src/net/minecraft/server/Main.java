...
public class Main {
   ...
   public static void main(String[] $$0) {
      ...
      try {
         ...
         aln $$25 = aln.a(new YggdrasilAuthenticationService(Proxy.NO_PROXY), $$24);
         ...
         alq $$43;
         try {
            alp.c $$42 = a($$21.a(), $$39, $$40, $$41);
            $$43 = ad.<alq>c($$6x -> alp.a($$42, $$5xx -> {
                  jn<dwv> $$6xx = $$5xx.d().d(li.aT);
                  if ($$39 != null) {
                     erc $$7x = erf.a($$39, $$5xx.b(), $$6xx, $$5xx.c());
                     return new alp.b<>($$7x.a(), $$7x.b().b());
                  } else {
                     ...
                     return new alp.b<>(new erj($$8x, $$9x, $$15x.d(), $$16x), $$15x.b());
                  }
               }, alq::new, ad.f(), $$6x)).get();
         ...
         boolean $$47 = $$18.has($$8);
         if ($$18.has($$6) || $$47) {
            a($$28, azt.a(), $$18.has($$7), () -> true, $$46, $$47);
         }

         erl $$48 = $$43.d();
         $$28.a($$46, $$48);
         final app $$49 = MinecraftServer.a((Function<Thread, app>)($$11x -> {
            app $$12x = new app($$11x, $$28, $$41, $$43, $$21, azt.a(), $$25, are::b);
   ...
   private static alp.c a(apq $$0, @Nullable Dynamic<?> $$1, boolean $$2, ato $$3) {
      boolean $$5;
      dcu $$6;
      if ($$1 != null) {
         dcu $$4 = erf.a($$1);
      ...
      alp.d $$9 = new alp.d($$3, $$6, $$2, $$5);
      return new alp.c($$9, ei.a.b, $$0.B);
   }

   private static void a(erf.c $$0, DataFixer $$1, boolean $$2, BooleanSupplier $$3, jo $$4, boolean $$5) {
      a.info("Forcing world upgrade!");
      bpo $$6 = new bpo($$0, $$1, $$4, $$2, $$5);
      xe $$7 = null;
      ...
      while (!$$6.b()) {
         ...
         if ($$9 > 0) {
            int $$10 = $$6.f() + $$6.g();
            a.info("{}% completed ({} / {} chunks)...", new Object[]{aym.d((float)$$10 / (float)$$9 * 100.0F), $$10, $$9});
         }
