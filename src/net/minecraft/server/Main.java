...
public class Main {
   ...
   public static void main(String[] $$0) {
      ...
      try {
         ...
         alg $$25 = alg.a(new YggdrasilAuthenticationService(Proxy.NO_PROXY), $$24);
         String $$26 = (String)Optional.ofNullable((String)$$18.valueOf($$12)).orElse($$21.a().m);
         eov $$27 = eov.b($$24.toPath());
         eov.c $$28 = $$27.d($$26);
         Dynamic<?> $$29;
         if ($$28.m()) {
            eow $$30;
         ...
         alj $$43;
         try {
            ali.c $$42 = a($$21.a(), $$39, $$40, $$41);
            $$43 = ac.<alj>c($$6x -> ali.a($$42, $$5xx -> {
                  jk<duu> $$6xx = $$5xx.d().d(lf.aT);
                  if ($$39 != null) {
                     eos $$7x = eov.a($$39, $$5xx.b(), $$6xx, $$5xx.c());
                     return new ali.b<>($$7x.a(), $$7x.b().b());
                  } else {
                     ...
                     if ($$18.has($$4)) {
                        ...
                        apj $$11x = $$21.a();
                        $$8x = new dbb($$11x.m, $$11x.l, $$11x.u, $$11x.k, false, new dat(), $$5xx.b());
                     ...
                     return new ali.b<>(new eoz($$8x, $$9x, $$15x.d(), $$16x), $$15x.b());
                  }
               }, alj::new, ac.g(), $$6x)).get();
         ...
         boolean $$47 = $$18.has($$8);
         if ($$18.has($$6) || $$47) {
            a($$28, azk.a(), $$18.has($$7), () -> true, $$46, $$47);
         }

         epb $$48 = $$43.d();
         $$28.a($$46, $$48);
         final api $$49 = MinecraftServer.a((Function<Thread, api>)($$11x -> {
            api $$12x = new api($$11x, $$28, $$41, $$43, $$21, azk.a(), $$25, aqx::b);
   ...
   private static ali.c a(apj $$0, @Nullable Dynamic<?> $$1, boolean $$2, ath $$3) {
      boolean $$5;
      dbr $$6;
      if ($$1 != null) {
         dbr $$4 = eov.a($$1);
      ...
      ali.d $$9 = new ali.d($$3, $$6, $$2, $$5);
      return new ali.c($$9, ef.a.b, $$0.B);
   }

   private static void a(eov.c $$0, DataFixer $$1, boolean $$2, BooleanSupplier $$3, jl $$4, boolean $$5) {
      a.info("Forcing world upgrade!");
      bpi $$6 = new bpi($$0, $$1, $$4, $$2, $$5);
      wx $$7 = null;
      ...
      while (!$$6.b()) {
         ...
         if ($$9 > 0) {
            int $$10 = $$6.f() + $$6.g();
            a.info("{}% completed ({} / {} chunks)...", new Object[]{ayd.d((float)$$10 / (float)$$9 * 100.0F), $$10, $$9});
         }
