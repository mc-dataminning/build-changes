...
public record ClientboundRespawnPacket(CommonPlayerSpawnInfo commonPlayerSpawnInfo, byte dataToKeep) implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundRespawnPacket> STREAM_CODEC = StreamCodec.composite(
      CommonPlayerSpawnInfo.STREAM_CODEC,
      ClientboundRespawnPacket::commonPlayerSpawnInfo,
      ByteBufCodecs.BYTE,
      ClientboundRespawnPacket::dataToKeep,
