...
public record ClientboundSwingAnimationPacket(int entityId, InteractionHand hand, SwingAnimation animation) implements Packet<ClientGamePacketListener> {
   public static final StreamCodec<ByteBuf, ClientboundSwingAnimationPacket> STREAM_CODEC = StreamCodec.composite(
      ByteBufCodecs.VAR_INT,
      ClientboundSwingAnimationPacket::entityId,
      InteractionHand.STREAM_CODEC,
      ClientboundSwingAnimationPacket::hand,
      SwingAnimation.STREAM_CODEC,
      ClientboundSwingAnimationPacket::animation,
      ClientboundSwingAnimationPacket::new
   );
