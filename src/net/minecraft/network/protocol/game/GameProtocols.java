...
public class GameProtocols {
   ...
   public static final UnboundProtocol<ServerGamePacketListener, RegistryFriendlyByteBuf, GameProtocols.Context> SERVERBOUND_TEMPLATE = ProtocolInfoBuilder.contextServerboundProtocol(
      ...
      builder -> builder.addPacket(GamePacketTypes.SERVERBOUND_ACCEPT_TELEPORTATION, ServerboundAcceptTeleportationPacket.STREAM_CODEC)
            ...
            .addPacket(
               ...
               dispatchCodec(
                  context -> context.canUseCommandBlocks()
                        ? ServerboundCommandSuggestionPacket.STREAM_CODEC
                        : ServerboundCommandSuggestionPacket.CHAT_ONLY_STREAM_CODEC
               )
            )
            ...
            .addPacket(GamePacketTypes.SERVERBOUND_PUNCH, ServerboundPunchPacket.STREAM_CODEC)
   ...
   public static final SimpleUnboundProtocol<ClientGamePacketListener, RegistryFriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
      ...
      builder -> builder.withBundlePacket(GamePacketTypes.CLIENTBOUND_BUNDLE, ClientboundBundlePacket::new, new ClientboundBundleDelimiterPacket())
            ...
            .addPacket(CommonPacketTypes.CLIENTBOUND_POST_EFFECTS, ClientboundPostEffectsPacket.STREAM_CODEC)
            ...
            .addPacket(GamePacketTypes.CLIENTBOUND_SWING_ANIMATION, ClientboundSwingAnimationPacket.STREAM_CODEC)
   ...
   private static <P> CodecModifier<RegistryFriendlyByteBuf, P, GameProtocols.Context> dispatchCodec(
      final Function<GameProtocols.Context, StreamCodec<? super RegistryFriendlyByteBuf, P>> codecGetter
   ) {
      return (var1, context) -> new StreamCodec<RegistryFriendlyByteBuf, P>() {
            public P decode(final RegistryFriendlyByteBuf input) {
               return (P)((StreamCodec)codecGetter.apply(context)).decode(input);
            }

            public void encode(final RegistryFriendlyByteBuf output, final P value) {
               ((StreamCodec)codecGetter.apply(context)).encode(output, value);
            }
         };
   }
