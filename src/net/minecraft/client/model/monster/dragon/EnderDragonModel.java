...
public class EnderDragonModel extends EntityModel<EnderDragonRenderState> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition body = root.addOrReplaceChild(
         "body",
         CubeListBuilder.create()
            .addBox("body", -12.0F, -16.0F, -16.0F, 24, 24, 64, 0, 0)
            .addBox("scale", -1.0F, -22.0F, -10.0F, 2, 6, 12, 220, 53)
            .addBox("scale", -1.0F, -22.0F, 10.0F, 2, 6, 12, 220, 53)
            .addBox("scale", -1.0F, -22.0F, 30.0F, 2, 6, 12, 220, 53),
      ...
      PartDefinition leftWing = body.addOrReplaceChild(
         ...
         PartPose.offset(12.0F, -15.0F, -6.0F)
      );
      ...
      PartDefinition leftFrontLeg = body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(12.0F, 0.0F, -6.0F, 1.3F, 0.0F, 0.0F)
      );
      ...
      PartDefinition leftRearLeg = body.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(16.0F, -4.0F, 34.0F, 1.0F, 0.0F, 0.0F)
      );
