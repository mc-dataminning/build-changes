...
public class ConfirmLinkScreen extends ConfirmScreen {
   ...
   public static void confirmLinkNow(@Nullable final Screen parentScreen, final URI uri, final boolean trusted) {
      Minecraft minecraft = Minecraft.getInstance();
      minecraft.gui.setScreen(new ConfirmLinkScreen(shouldOpen -> {
         if (shouldOpen) {
            Util.getPlatform().openUri(uri);
   ...
   public static void confirmLinkNow(@Nullable final Screen parentScreen, final URI uri) {
