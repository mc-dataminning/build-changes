...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public EntityRenderDispatcher(
      ...
      final PalettedTextureManager palettedTextures
   ) {
   ...
   public AvatarRenderer<?> getRenderer(final AvatarRenderState state) {
      AvatarRenderer<AbstractClientPlayer> playerRenderer = this.playerRenderers.get(state.skin.model());
      return playerRenderer != null ? playerRenderer : this.playerRenderers.get(PlayerModelType.WIDE);
   }

   public <S extends EntityRenderState> EntityRenderer<?, ? super S> getRenderer(final S entityRenderState) {
      return (EntityRenderer<?, ? super S>)(entityRenderState instanceof AvatarRenderState avatarRenderState
   ...
   public <E extends Entity> boolean shouldRender(
      final E entity, final Frustum culler, final double camX, final double camY, final double camZ, final float partialTicks
   ) {
