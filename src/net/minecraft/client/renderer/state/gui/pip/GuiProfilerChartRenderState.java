...
public record GuiProfilerChartRenderState(
   Matrix3x2fc pose, List<ResultField> chartData, int x0, int y0, int x1, int y1, @Nullable ScreenRectangle scissorArea, @Nullable ScreenRectangle bounds
) implements PictureInPictureRenderState {
   public GuiProfilerChartRenderState(
      final Matrix3x2fc pose,
      final List<ResultField> chartData,
      final int x0,
      final int y0,
      final int x1,
      final int y1,
