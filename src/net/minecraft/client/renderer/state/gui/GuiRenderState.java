...
public class GuiRenderState {
   ...
   @Nullable
   private ScreenRectangle windowRectangleForDebug;
            ...
            this.current
               .addGuiElement(
                  new ColoredRectangleRenderState(
                     RenderPipelines.GUI, TextureSetup.noTexture(), new Matrix3x2f(), 0, 0, 10000, 10000, 2000962815, 2000962815, clippedBounds
                  )
               );
         }
      }
