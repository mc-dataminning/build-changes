...
public class js {
   ...
   public static final jv aa = a("white_smoke", false);
   public static final jv ab = a("sneeze", false);
   public static final jv ac = a("spit", true);
   public static final jv ad = a("squid_ink", true);
   public static final jv ae = a("sweep_attack", true);
   public static final jv af = a("totem_of_undying", false);
   public static final jv ag = a("underwater", false);
   public static final jv ah = a("splash", false);
   public static final jv ai = a("witch", false);
   public static final jv aj = a("bubble_pop", false);
   public static final jv ak = a("current_down", false);
   public static final jv al = a("bubble_column_up", false);
   public static final jv am = a("nautilus", false);
   public static final jv an = a("dolphin", false);
   public static final jv ao = a("campfire_cosy_smoke", true);
   public static final jv ap = a("campfire_signal_smoke", true);
   public static final jv aq = a("dripping_honey", false);
   public static final jv ar = a("falling_honey", false);
   public static final jv as = a("landing_honey", false);
   public static final jv at = a("falling_nectar", false);
   public static final jv au = a("falling_spore_blossom", false);
   public static final jv av = a("ash", false);
   public static final jv aw = a("crimson_spore", false);
   public static final jv ax = a("warped_spore", false);
   public static final jv ay = a("spore_blossom_air", false);
   public static final jv az = a("dripping_obsidian_tear", false);
   public static final jv aA = a("falling_obsidian_tear", false);
   public static final jv aB = a("landing_obsidian_tear", false);
   public static final jv aC = a("reverse_portal", false);
   public static final jv aD = a("white_ash", false);
   public static final jv aE = a("small_flame", false);
   public static final jv aF = a("snowflake", false);
   public static final jv aG = a("dripping_dripstone_lava", false);
   public static final jv aH = a("falling_dripstone_lava", false);
   public static final jv aI = a("dripping_dripstone_water", false);
   public static final jv aJ = a("falling_dripstone_water", false);
   public static final jv aK = a("glow_squid_ink", true);
   public static final jv aL = a("glow", true);
   public static final jv aM = a("wax_on", true);
   public static final jv aN = a("wax_off", true);
   public static final jv aO = a("electric_spark", true);
   public static final jv aP = a("scrape", true);
   public static final jr<ju> aQ = a("shriek", false, ju.b, $$0 -> ju.a);
   public static final jv aR = a("egg_crack", false);
   public static final jv aS = a("dust_plume", false);
   public static final Codec<jq> aT = jy.k.q().dispatch("type", jq::b, jr::e);
