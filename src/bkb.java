...
public class bkb extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WallPropertyFix", this.getInputSchema().getType(biw.u), $$0 -> $$0.update(DSL.remainderFinder(), bkb::a));
   }
   ...
   private static <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      return $$0.update($$1, $$0x -> (Dynamic)DataFixUtils.orElse($$0x.asString().result().map(bkb::a).map($$0x::createString), $$0x));
   }
