...
public abstract class bkb extends bur implements bjo {
   protected static final aef<Byte> bT = aei.a(bkb.class, aeh.a);
   protected static final aef<Optional<UUID>> bU = aei.a(bkb.class, aeh.q);
   private boolean bW;
   ...
   @Override
   public void a(bho $$0) {
      if (!this.dL().B && this.dL().X().b(cpr.m) && this.O_() instanceof aks) {
         this.O_().a(this.eJ().a());
      }
