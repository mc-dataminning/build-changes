...
public class bkb extends bjm {
      ...
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         ...
         Optional<Dynamic<T>> $$3 = $$2.get("CriteriaType").get().result().flatMap($$1x -> {
            ...
            if ($$2x.isPresent() && $$3x.isPresent()) {
               String $$4 = $$2x.get();
               return $$4.equals("_special") ? Optional.of($$2.createString($$3x.get())) : Optional.of($$1x.createString(bkb.b($$4) + ":" + bkb.b($$3x.get())));
            } else {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bhy.H, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), c, d));
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", bhy.D.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", bhy.C.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", bhy.z.in($$0));
