public class fxn extends fpa<fxn.a> {
   ...
   public fxn(fme $$0, fxm $$1, int $$2, int $$3, xv $$4) {
      super($$0, $$2, $$3, 33, 36);
      this.x = $$1;
      this.w = $$4;
      this.e = false;
   ...
   public static class a extends fpa.a<fxn.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final fxn e;
      protected final fme a;
      private final fxl.a f;
      private final azq g;
      private final fox h;
      private final azq i;
      private final fox j;

      public a(fme $$0, fxn $$1, fxl.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static azq a(fme $$0, xv $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fox b(fme $$0, xv $$1) {
         return fox.a($$0.h, 157, 2, $$1);
      }
      ...
      public void a(fnq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(glt::B, this.f.a(), $$3, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
         azq $$12 = this.g;
         fox $$13 = this.h;
         if (this.d() && (this.a.n.ac().c() || $$8 || this.e.g() == this && this.e.aN_())) {
            ...
            if (this.f.o()) {
               if ($$14 < 32) {
                  $$0.a(glt::B, fxn.a, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glt::B, fxn.m, $$3, $$2, 32, 32);
               }
            } else {
               if (this.f.p()) {
                  if ($$14 < 16) {
                     $$0.a(glt::B, fxn.n, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(glt::B, fxn.o, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.q()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 < 16) {
                     $$0.a(glt::B, fxn.p, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(glt::B, fxn.q, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.r()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 > 16) {
                     $$0.a(glt::B, fxn.r, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(glt::B, fxn.s, $$3, $$2, 32, 32);
                  }
               }
            }
         }
