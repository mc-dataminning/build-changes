...
public class fxn {
   ...
   public fxn(Runnable $$0, Function<avd, alz> $$1, avg $$2, Consumer<avg> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fxn.a> a() {
      return this.c.stream().map($$0 -> new fxn.d($$0));
   }

   public Stream<fxn.a> b() {
      return this.b.stream().map($$0 -> new fxn.c($$0));
   }
   ...
   abstract class b implements fxn.a {
      private final avd b;
      ...
      @Override
      public alz a() {
         return fxn.this.d.apply(this.b);
      }
