...
public class fxn implements fyg {
   ...
   private CompletableFuture<Optional<cmy>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public fxn(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cmy::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cmy>> a(Optional<cmy> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cmy.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cmy $$0) {
      ...
      if ($$0 != null) {
         if (aa.aX) {
            cmy.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cmy a(UserApiService $$0) throws axw, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cmz.a $$2 = a($$1);
         return new cmy(axv.a($$1.keyPair().privateKey()), new cmz($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cmz.a a(KeyPairResponse $$0) throws axw {
      KeyPair $$1 = $$0.keyPair();
