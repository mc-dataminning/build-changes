...
public class fpk extends fnw<crq> {
   private static final alb D = new alb("container/stonecutter/scroller");
   private static final alb E = new alb("container/stonecutter/scroller_disabled");
   private static final alb F = new alb("container/stonecutter/recipe_selected");
   private static final alb G = new alb("container/stonecutter/recipe_highlighted");
   private static final alb H = new alb("container/stonecutter/recipe");
   private static final alb I = new alb("textures/gui/container/stonecutter.png");
   ...
   private void b(fgm $$0, int $$1, int $$2, int $$3) {
      List<cys<czk>> $$4 = this.w.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.S = ayu.a(this.S - $$5, 0.0F, 1.0F);
