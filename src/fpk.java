...
public class fpk implements fpm {
   ...
   @Override
   public void a(fgx $$0, int $$1, int $$2, fgz $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, fgz $$4, fgx $$5) {
      if ($$2 >= this.f.d()) {
         this.a($$4, $$0, $$1, $$3 ? fpk.a.a : fpk.a.b);
      } else {
         cua $$6 = this.f.a($$2);
         this.a($$4, $$0, $$1, fpk.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            fns.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(fgz $$0, int $$1, int $$2, fpk.a $$3) {
