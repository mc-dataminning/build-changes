...
public class fpk {
   ...
   public void a(fpv $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fpv.a) {
            fvj.b($$1, fvj.a.a, wy.c("narrator.toast.disabled"), null);
         } else {
            fvj.b($$1, fvj.a.a, wy.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fvj.b($$1, fvj.a.a, wy.c("narrator.toast.disabled"), wy.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fpk.a("Narrator library is not active");
      }
   }
