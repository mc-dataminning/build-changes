...
public abstract class fpk<E extends fpk.a<E>> extends fph {
   private static final aku a = aku.b("textures/gui/menu_list_background.png");
   private static final aku m = aku.b("textures/gui/inworld_menu_list_background.png");
   protected final fmg c;
   protected final int d;
   private final List<E> n = new fpk.b();
   ...
   public fpk(fmg $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wo.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fpk(fmg $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(fpc $$0) {
      aku $$1 = this.c.s == null ? fvi.h : fvi.j;
      aku $$2 = this.c.s == null ? fvi.i : fvi.k;
      $$0.a(gnh::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gnh::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(fpc $$0) {
      aku $$1 = this.c.s == null ? a : m;
      $$0.a(gnh::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(fpc $$0) {
   ...
   @Override
   public Optional<frn> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(ftv $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(ftv $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fpc $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public ftl.a w() {
      if (this.aM_()) {
         ...
         return this.q != null ? ftl.a.b : ftl.a.a;
      }
   }
   ...
   protected void a(ftn $$0, E $$1) {
      List<E> $$2 = this.aH_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(ftm.b, wp.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fpk.a<E>> implements frn {
      @Deprecated
      fpk<E> a;
      ...
      public abstract void a(fpc var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
