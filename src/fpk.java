...
public class fpk extends fpa<crg> {
   ...
   private final foo X = new foo(0);
   private final foo Y = new foo(1);
   private final foo Z = new foo(2);
   @Nullable
   private cij aa;

   public fpk(crg $$0, cmj $$1, wu $$2) {
   ...
   @Override
   protected void G() {
      this.aa = new cij(this.l.r, 0.0, 0.0, 0.0);
      this.aa.b(true);
      this.aa.a(true);
      this.aa.aY = 210.0F;
      this.aa.t(25.0F);
   ...
   public void E() {
      super.E();
      Optional<cvg> $$0 = this.J();
      this.X.a(I);
      this.Y.a($$0.map(cvg::m).orElse(List.of()));
      this.Z.a($$0.map(cvg::n).orElse(List.of()));
   }

   private Optional<cvg> J() {
      cuc $$0 = this.w.b(0).g();
      return !$$0.e() && $$0.g() instanceof cvg $$1 ? Optional.of($$1) : Optional.empty();
   }
   ...
   protected void a(fhf $$0, float $$1, int $$2, int $$3) {
      ...
      foz.a($$0, (float)(this.z + 141), (float)(this.A + 75), 25.0F, S, T, null, this.aa);
   }
   ...
   @Override
   protected void c(fhf $$0, int $$1, int $$2) {
      if (this.K()) {
         $$0.a(D, $$1 + 65, $$2 + 46, 28, 21);
      }
   }

   private void d(fhf $$0, int $$1, int $$2) {
      ...
      if (this.y != null) {
         ...
         } else if ($$4.g() instanceof cvg $$6 && $$5.e()) {
            if (this.y.d == 1) {
               $$3 = Optional.of($$6.k());
            } else if (this.y.d == 2) {
               $$3 = Optional.of($$6.l());
