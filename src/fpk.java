...
public class fpk implements fph {
   public static final String a = "OR";
   private final Iterable<? extends fph> d;

   public fpk(Iterable<? extends fph> $$0) {
      this.d = $$0;
   }

   @Override
   public Predicate<dez> getPredicate(dfa<csl, dez> $$0) {
      List<Predicate<dez>> $$1 = Streams.stream(this.d).map($$1x -> $$1x.getPredicate($$0)).collect(Collectors.toList());
