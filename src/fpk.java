...
public class fpk {
   ...
   public fpd a(Vector3f $$0, Vector3f $$1, fpf $$2, fzg $$3, hc $$4, gbp $$5, @Nullable fpg $$6, boolean $$7, aey $$8) {
      fph $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ary.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ary.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ary.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ary.i($$11, $$9.a[3], $$13);
      ...
      return new fpd($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fph a(fph $$0, hc $$1, j $$2, aey $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ary.b($$23), ary.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fph(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fph $$0, fzg $$1, hc $$2, float[] $$3, j $$4, @Nullable fpg $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[hc.values().length];
      $$2[fnx.a.f] = $$0.x() / 16.0F;
      $$2[fnx.a.e] = $$0.y() / 16.0F;
      $$2[fnx.a.d] = $$0.z() / 16.0F;
      $$2[fnx.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, hc $$2, fph $$3, float[] $$4, fzg $$5, j $$6, @Nullable fpg $$7, boolean $$8) {
      fnx.b $$9 = fnx.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, fzg $$3, fph $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fpg $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static hc a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? hc.b : $$7;
      }
   }

   private void a(int[] $$0, hc $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[hc.values().length];
      $$3[fnx.a.f] = 999.0F;
      $$3[fnx.a.e] = 999.0F;
      $$3[fnx.a.d] = 999.0F;
      $$3[fnx.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (ary.a($$13, $$18) && ary.a($$14, $$19) && ary.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
