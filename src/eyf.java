...
public class eyf implements eyg, eyh {
   ...
   private final fdj<MinecraftServer> G;
   ...
   public eyf(dit $$0, egl $$1, eyf.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iu.c,
   ...
   public static <T> eyf a(Dynamic<T> $$0, dit $$1, eyf.a $$2, egl $$3, Lifecycle $$4) {
      ...
      return new eyf(
         ...
         new fdj<>(fdi.a, $$0.get("ScheduledEvents").asStream()),
         (tx)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(edo.a.a).resultOrPartial(f::error).orElse(edo.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public tx a(js $$0, @Nullable tx $$1) {
      if ($$1 == null) {
         $$1 = this.o;
      }
   ...
   private void a(js $$0, tx $$1, @Nullable tx $$2) {
      ...
      egj.a($$4, this.h, $$0).resultOrPartial(af.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (uu)edo.a.a.encodeStart(ul.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      djn.b.encodeStart(ul.a, this.g.g()).ifSuccess($$1x -> $$1.a((tx)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == eyf.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eyf.a.c;
   }
