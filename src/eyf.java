...
public class eyf extends eyk {
   ...
   public void a(djm $$0, iv $$1, eat $$2, @Nullable eyi $$3, boolean $$4) {
      ...
      for (boolean $$7 = true; $$6.hasNext(); $$7 = false) {
         ...
         int $$11 = b($$10);
         eat $$12 = $$0.a_($$9);
         if ($$12.a(this.a) && !$$12.c(dta.f).equals($$11)) {
            int $$13 = 2;
            if (!$$4 || !$$7) {
               $$13 |= 128;
            }

            $$0.a($$9, $$12.b(dta.f, Integer.valueOf($$11)), $$13);
         } else {
            $$6.remove();
         }
      }
   ...
   private static boolean a(eat $$0, jb $$1) {
      ebr<eby> $$2 = dta.g.get($$1);
      return $$2 == null ? $$1 == jb.a : $$0.c($$2).a();
   }

   private static eyi a(djm $$0, @Nullable eyi $$1) {
      eyi $$2;
      if ($$1 != null) {
         $$2 = $$1;
      } else {
      ...
      return $$2.a(jb.b).a(eyi.a.a);
   }

   private void a(djm $$0, iv $$1, eyi $$2) {
      eat $$3 = $$0.a_($$1);
      if ($$3.a(this.a)) {
         this.a($$1, $$3.c(dta.f), $$2);
         this.b.add($$1);
      } else {
         this.a($$0, $$1, 0, $$2, true);
      }
   ...
   private static int a(eyi $$0, int $$1) {
      return $$0.i() << 4 | $$1;
   }

   private static eyi a(int $$0) {
      return eyi.a($$0 >> 4);
   }
   ...
   private void a(iv $$0, int $$1, eyi $$2) {
      this.d.compute($$0, ($$2x, $$3) -> $$3 == null ? a($$2, $$1) : a(a($$3), $$1));
   }

   private void a(djm $$0, iv $$1, int $$2, eyi $$3, boolean $$4) {
      for (jb $$5 : $$3.g()) {
         iv $$6 = $$1.a($$5);
   ...
   private void b(djm $$0, iv $$1, int $$2, eyi $$3, boolean $$4) {
      eat $$5 = $$0.a_($$1);
      if ($$5.a(this.a)) {
         int $$6 = this.a($$1, $$5);
