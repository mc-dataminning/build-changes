...
public class eyf extends eqj {
   ...
   private void a(uh $$0, jo.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            eyg.b $$9 = eyg.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            eyg.b $$10 = eyg.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            eyg.a $$11 = eyg.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(uh $$0, jo.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         eyh $$5 = eyh.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, eyh.b.d());
            return eyh.b;
         });
         String $$6 = $$3.l("Name");
         wz $$7 = wz.a.a($$3.l("DisplayName"), $$1);
         eyh.a $$8 = eyh.a.a($$3.l("RenderType"));
