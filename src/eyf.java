...
public abstract class eyf {
   protected final dsv a;

   protected eyf(dsv $$0) {
      this.a = $$0;
   }

   public abstract void a(djh var1, iv var2, eao var3, @Nullable eyd var4, boolean var5);

   protected int a(djh $$0, iv $$1) {
      return this.a.a($$0, $$1);
   }

   protected int a(iv $$0, eao $$1) {
      return $$1.a(this.a) ? $$1.c(dsv.f) : 0;
   }
