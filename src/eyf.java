...
public class eyf extends eyi {
   ...
   static final eyf.b l = new eyf.b(854, 480);

   public eyf(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eyf.a[] e = values();
   ...
   static class b {
      ...
      static List<eyf.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyf.b($$0, $$1), eyf.l) : ImmutableList.of(eyf.l);
      }
