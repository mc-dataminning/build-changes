...
public class fbl {
   ...
   @Nullable
   private String g;
   private static final fbl.a h = new fbl.a() {
      @Nullable
      @Override
      public fbk a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fbo.a(this.d, "Get capabilities")) {
         ...
         if (fbo.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fbo.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fbo.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fbk a(fbl.c $$0) {
      return ($$0 == fbl.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fbl.a {
      private final int a;
      private final Set<fbk> b = Sets.newIdentityHashSet();
      ...
      public fbk a() {
         if (this.b.size() >= this.a) {
            if (ab.aW) {
               fbl.a.warn("Maximum sound pool size {} reached", this.a);
            }
