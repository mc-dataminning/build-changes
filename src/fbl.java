public class fbl extends etg<fbl.a> {
   static final aez a = new aez("transferable_list/select_highlighted");
   static final aez m = new aez("transferable_list/select");
   static final aez n = new aez("transferable_list/unselect_highlighted");
   static final aez o = new aez("transferable_list/unselect");
   static final aez p = new aez("transferable_list/move_up_highlighted");
   static final aez q = new aez("transferable_list/move_up");
   static final aez s = new aez("transferable_list/move_down_highlighted");
   static final aez t = new aez("transferable_list/move_down");
   static final tl u = tl.c("pack.incompatible");
   static final tl v = tl.c("pack.incompatible.confirm.title");
   private final tl w;
   final fbk x;

   public fbl(eqp $$0, fbk $$1, int $$2, int $$3, tl $$4) {
   ...
   public static class a extends etg.a<fbl.a> {
      ...
      private static arn a(eqp $$0, tl $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static etd b(eqp $$0, tl $$1) {
         return etd.a($$0.h, $$1, 157, 2);
      }
