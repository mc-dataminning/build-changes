...
public class ezu {
   ...
   public ezu(azt $$0, bay $$1, jg.a $$2) {
      this($$0, $$1, Optional.of($$2), Set.of());
   }

   public ezu(azt $$0, bay $$1) {
      this($$0, $$1, Optional.empty(), Set.of());
   }

   private ezu(azt $$0, bay $$1, Optional<jg.a> $$2, Set<alf<?>> $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public ezu a(String $$0) {
      return new ezu(this.a.a($$0), this.b, this.c, this.d);
   }

   public ezu a(String $$0, alf<?> $$1) {
      Set<alf<?>> $$2 = ImmutableSet.builder().addAll(this.d).add($$1).build();
      return new ezu(this.a.a($$0), this.b, this.c, $$2);
   }
   ...
   public ezu a(bay $$0) {
      return new ezu(this.a, $$0, this.c, this.d);
   }
