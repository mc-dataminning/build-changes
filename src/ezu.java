...
public class ezu extends ezy implements ezw {
   ...
   public ezu.c a() {
      return new ezu.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(fae.b $$0, fae $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (faf)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(fae $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == ezx.k;
         boolean $$2 = $$0 == ezx.j;
   ...
   private IntConsumer a(int $$0, fae.a $$1) {
   ...
   private ezu.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezu.a $$9 = new ezu.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezu.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fae.b.a || this.q == fae.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<faf> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      faf $$1 = (faf)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == faf.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == faf.b.c) {
         ezw.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezw.a($$11));
         this.a($$14 + 5, ezw.a($$12));
         this.a($$14 + 6, ezw.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fae a, int b, int c, fae.b d, fae.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezu.a c;
      private boolean d;

      b(final int $$1, final ezu.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(fae.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fah $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
