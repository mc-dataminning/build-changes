...
public class ezu {
   ...
   private static final Queue<ezu.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ezu.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ezu::a), ezs::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ezu::a), ezs::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ezu.a(this.b) + ", type=" + ezu.b(this.c) + ", severity=" + ezu.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
