...
public class ezu {
   private final List<ConcurrentLinkedQueue<ezt>> a = ImmutableList.of(
   ...
   public void a(ezt $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ezt> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ezt> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ezt> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ezt> j() {
