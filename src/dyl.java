...
public class dyl implements dyi, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bqq c;
   private final dyq d;
   private final SequencedMap<deb, dyl.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dyl(dys $$0, Path $$1, boolean $$2) {
      this.d = new dyq($$0, $$1, $$2);
      this.c = new bqq(dyl.b.values().length, ad.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(deb $$0, int $$1) {
      deb $$2 = new deb($$0.e - $$1, $$0.f - $$1);
      deb $$3 = new deb($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         deb $$3 = deb.b($$0, $$1);
         BitSet $$4 = new BitSet();
         deb.a($$2, $$3).forEach($$1xx -> {
            vn $$2x = new vn(new vp(uo.a, "DataVersion"), new vp(uj.b, "blending_data"));
            ...
            if ($$2x.d() instanceof uj $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(deb $$0, Supplier<uj> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         uj $$2 = $$1.get();
         dyl.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new dyl.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<uj>> a(deb $$0) {
      return this.a((dyl.c<Optional<uj>>)(() -> {
         dyl.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((dyl.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(deb $$0, vd $$1) {
      return this.a((dyl.c<Void>)(() -> {
         try {
            dyl.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(dyl.c<T> $$0) {
      return this.c.a(dyl.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<deb, dyl.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bqs.c(dyl.b.b.ordinal(), this::b));
   }

   private void a(deb $$0, dyl.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(dyl.b.c.ordinal(), $$0 -> $$0.complete(bao.a)).join();
   }
