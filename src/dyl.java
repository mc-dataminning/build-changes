...
public class dyl {
   ...
   private final List<dyj> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dyl.a l = new dyl.d(5.999997E7F);
   public static final dyl.c d = new dyl.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(ji $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(fay $$0) {
   ...
   public fay c(double $$0, double $$1, double $$2) {
      return new fay(ayy.a($$0, this.e(), this.g() - 1.0E-5F), $$1, ayy.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dyl.a)($$0 == $$1 ? new dyl.d($$1) : new dyl.b($$0, $$1, $$2));
   ...
   class b implements dyl.a {
      ...
      @Override
      public double a() {
         return ayy.a(dyl.this.a() - this.e() / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
      }

      @Override
      public double c() {
         return ayy.a(dyl.this.b() - this.e() / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
      }
      ...
      @Override
      public dyk i() {
         return this.c < this.b ? dyk.b : dyk.a;
      }
      ...
      @Override
      public dyl.a l() {
         return (dyl.a)(this.g() <= 0L ? dyl.this.new d(this.c) : this);
      }
      ...
      public fbs m() {
         return fbp.a(
            fbp.c,
            fbp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbc.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dyl.c a(DynamicLike<?> $$0, dyl.c $$1) {
         ...
         return new dyl.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dyl.a {
      ...
      private void n() {
         this.c = ayy.a(dyl.this.a() - this.b / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
         this.d = ayy.a(dyl.this.b() - this.b / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
         this.e = ayy.a(dyl.this.a() + this.b / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
         this.f = ayy.a(dyl.this.b() + this.b / 2.0, (double)(-dyl.this.k), (double)dyl.this.k);
         this.g = fbp.a(
            fbp.c,
            fbp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbc.e
