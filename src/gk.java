...
public interface gk<T> {
   void a(T var1, ContextChain<T> var2, boolean var3, go<T> var4) throws CommandSyntaxException;
   ...
   public abstract static class b<T extends dw<T>> implements gk<T> {
      public final void a(T $$0, ContextChain<T> $$1, boolean $$2, go<T> $$3) throws CommandSyntaxException {
         try {
            this.b($$0, $$1, $$2, $$3);
      ...
      protected void a(CommandSyntaxException $$0, T $$1, boolean $$2) {
      }
