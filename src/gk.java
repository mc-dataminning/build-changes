...
public class gk {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, gi.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends gi.a<A>> void a(JsonObject $$0, gi<A, T> $$1, gi.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", jd.x.b($$2.a()).toString());
