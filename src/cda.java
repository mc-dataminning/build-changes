public class cda extends cdb {
   ...
   @Override
   protected evr b() {
      return new evr(this.a.du(), (double)this.s(), this.a.dA());
   }

   @Override
   public eoj a(iz $$0, int $$1) {
      dui $$2 = this.b.N().a(kb.a($$0.u()), kb.a($$0.w()));
      if ($$2 == null) {
         return null;
      } else {
         if ($$2.a_($$0).i()) {
   ...
   private int s() {
      if (this.a.be() && this.p()) {
         int $$0 = this.a.dv();
         dsc $$1 = this.b.a_(iz.a(this.a.du(), (double)$$0, this.a.dA()));
         int $$2 = 0;
