...
public abstract class cda {
   ...
   public cda(btq $$0, dbx $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = ayy.a($$0.g(buw.k) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract eok a(int var1);
   ...
   @Nullable
   public final eoi a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(iz.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eoi a(Stream<iz> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eoi a(Set<iz> $$0, int $$1) {
   ...
   @Nullable
   protected eoi a(Set<iz> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(buw.k));
   }

   @Nullable
   protected eoi a(Set<iz> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         dck $$7 = new dck(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         eoi $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ag().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eoi $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            if ($$0.d > $$1.d && !this.a.aE() && ayy.a($$0.c) == ayy.a($$1.c) && ayy.a($$0.e) == ayy.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(evq $$0) {
      iz $$1 = iz.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : eoq.a(this.b, $$1);
   }
   ...
   private boolean c(evq $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         evq $$1 = evq.c(this.c.g());
         if (!$$0.a((js)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            evq $$2 = evq.c(this.c.d(this.c.f() + 1));
            evq $$3 = $$1.d($$0);
            evq $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void S_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eog $$1 = this.c.a($$0);
            eog $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dsb $$3 = this.b.a_(new iz($$1.a, $$1.b, $$1.c));
            if ($$3.a(awo.bl)) {
   ...
   public boolean b(eol $$0) {
      return $$0 != eol.n && $$0 != eol.p && $$0 != eol.d;
   }

   protected static boolean a(btq $$0, evq $$1, evq $$2, boolean $$3) {
      evq $$4 = new evq($$2.c, $$2.d + (double)$$0.dk() * 0.5, $$2.e);
      return $$0.dP().a(new dbg($$1, $$4, dbg.a.a, $$3 ? dbg.b.c : dbg.b.a, $$0)).c() == evo.a.a;
   }
   ...
   public boolean b(iz $$0) {
      if (this.m) {
         ...
         eog $$1 = this.c.d();
         evq $$2 = new evq(((double)$$1.a + this.a.du()) / 2.0, ((double)$$1.b + this.a.dw()) / 2.0, ((double)$$1.c + this.a.dA()) / 2.0);
