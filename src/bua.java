public abstract class bua extends btt {
   protected static final float bX = 0.0F;

   protected bua(btc<? extends bua> $$0, dca $$1) {
      super($$0, $$1);
   }
   ...
   public boolean gn() {
      if (this.bD.a(ccv.Z)) {
         return this.bD.c(ccv.Z).isPresent();
      } else {
         for (ccd $$0 : this.bS.b()) {
            if ($$0.h() && $$0.k() instanceof cbi) {
               return true;
            }
         }
   ...
   protected void gc() {
      ...
      if ($$0 != null && $$0.dP() == this.dP()) {
         this.a($$0.dp(), 5);
         float $$1 = this.f($$0);
         if (this instanceof buo && ((buo)this).y()) {
            if ($$1 > 10.0F) {
               this.a(true, true);
            }
         ...
         if ($$1 > 10.0F) {
            ...
            this.bS.b(cap.a.a);
            float $$5 = 2.0F;
            evt $$6 = new evt($$0.du() - this.du(), $$0.dw() - this.dw(), $$0.dA() - this.dA()).d().a((double)Math.max($$1 - 2.0F, 0.0F));
