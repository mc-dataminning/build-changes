...
public abstract class bua extends bvn {
   private static final ajx<Boolean> bY = akb.a(bua.class, ajz.k);
   ...
   protected bua(buq<? extends bua> $$0, dgg $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bua a(arc var1, bua var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dl() instanceof cqs $$0 && !$$0.b((buj)this)) {
         this.ae();
      }
   }
