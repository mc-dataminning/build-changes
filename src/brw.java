...
public class brw {
   ...
   protected brw(String $$0, brv $$1, DoubleSupplier $$2, @Nullable Runnable $$3, @Nullable brw.c $$4) {
      this.b = $$0;
      this.c = $$1;
      this.h = $$3;
      this.d = $$2;
   ...
   public static brw a(String $$0, brv $$1, DoubleSupplier $$2) {
      return new brw($$0, $$1, $$2, null, null);
   }

   public static <T> brw a(String $$0, brv $$1, T $$2, ToDoubleFunction<T> $$3) {
      return a($$0, $$1, $$3, $$2).a();
   }

   public static <T> brw.a<T> a(String $$0, brv $$1, ToDoubleFunction<T> $$2, T $$3) {
      return new brw.a<>($$0, $$1, $$2, $$3);
   }
   ...
   public static class a<T> {
      ...
      public a(String $$0, brv $$1, ToDoubleFunction<T> $$2, T $$3) {
         this.a = $$0;
         this.b = $$1;
      ...
      public brw.a<T> a(Consumer<T> $$0) {
         this.e = () -> $$0.accept(this.d);
         return this;
      }

      public brw.a<T> a(brw.c $$0) {
         this.f = $$0;
         return this;
      }

      public brw a() {
         return new brw(this.a, this.b, this.c, this.e, this.f);
      }
   }
   ...
   public static class d implements brw.c {
