...
public class bmm extends bkx<bwm> {
   ...
   private ehn i;
   private final Function<bwm, apc> j;
   private final Function<bwm, apc> k;

   public bmm(Function<bwm, bgj> $$0, bts $$1, float $$2, ToDoubleFunction<bwm> $$3, Function<bwm, apc> $$4, Function<bwm, apc> $$5) {
   ...
   protected boolean a(akq $$0, bwm $$1) {
      return $$1.dN().a(bsh.V);
   }

   protected boolean a(akq $$0, bwm $$1, long $$2) {
      return $$1.dN().a(bsh.V);
   }

   protected void b(akq $$0, bwm $$1, long $$2) {
      gw $$3 = $$1.dl();
      bkg<?> $$4 = $$1.dN();
      ehn $$5 = $$4.c(bsh.V).get();
   ...
   protected void c(akq $$0, bwm $$1, long $$2) {
      ...
      if (!$$3.isEmpty()) {
         ...
         float $$9 = arw.a($$1.fe() * 1.65F, 0.2F, 3.0F) + $$8;
         float $$10 = $$5.f($$0.ag().b((bjg)$$1)) ? 0.5F : 1.0F;
         $$5.q((double)($$10 * $$9) * this.h.applyAsDouble($$1), this.i.a(), this.i.c());
         this.b($$0, $$1);
         $$0.a(null, $$1, this.j.apply($$1), ape.g, 1.0F, 1.0F);
      } else if (this.c($$0, $$1)) {
         $$0.a(null, $$1, this.j.apply($$1), ape.g, 1.0F, 1.0F);
         boolean $$11 = $$1.gk();
         if ($$11) {
            $$0.a(null, $$1, this.k.apply($$1), ape.g, 1.0F, 1.0F);
         }
   ...
   private boolean c(akq $$0, bwm $$1) {
      ehn $$2 = $$1.do().d(1.0, 0.0, 1.0).d();
      gw $$3 = gw.a($$1.dj().e($$2));
      return $$0.a_($$3).a(aps.ce) || $$0.a_($$3.c()).a(aps.ce);
   }

   protected void b(akq $$0, bwm $$1) {
      $$0.a($$1, (byte)59);
