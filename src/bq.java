...
public class bq extends dz<bq.a> {
   ...
   public void a(are $$0, @Nullable bum $$1) {
      evs $$2 = $$1 != null ? bx.b($$0, $$1) : null;
   ...
   public static record a(Optional<bi> b, Optional<dl> c, Optional<bi> d) implements dz.a {
      ...
      public boolean a(are $$0, @Nullable evs $$1) {
         return this.c.isPresent() && !this.c.get().a((bvi)$$0) ? false : !this.d.isPresent() || $$1 != null && this.d.get().a($$1);
      }
