...
public class bq extends de<bq.a> {
   @Override
   public Codec<bq.a> a() {
      return bq.a.a;
   }

   public void a(aqi $$0, bqf $$1, float $$2, float $$3, boolean $$4) {
      this.a($$0, $$5 -> $$5.a($$0, $$1, $$2, $$3, $$4));
   }

   public static record a(Optional<bc> b, Optional<bf> c) implements de.a {
      public static final Codec<bq.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(axh.a(br.b, "player").forGetter(bq.a::a), axh.a(bf.a, "damage").forGetter(bq.a::c)).apply($$0, bq.a::new)
      );
      ...
      public boolean a(aqi $$0, bqf $$1, float $$2, float $$3, boolean $$4) {
