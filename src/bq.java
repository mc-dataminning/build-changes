...
public class bq extends dr<bq.a> {
   ...
   public void a(arf $$0, dsb $$1) {
      this.a($$0, $$1x -> $$1x.a($$1));
   }

   public static record a(Optional<bf> b, Optional<ji<dey>> c, Optional<dx> d) implements dr.a {
      ...
      private static DataResult<bq.a> a(bq.a $$0) {
         return $$0.c
            .<DataResult<bq.a>>flatMap(
               $$1 -> $$0.d.<String>flatMap($$1x -> $$1x.a(((dey)$$1.a()).l())).map($$1x -> DataResult.error(() -> "Block" + $$1 + " has no property " + $$1x))
            )
            .orElseGet(() -> DataResult.success($$0));
      }

      public static an<bq.a> a(dey $$0) {
