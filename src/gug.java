...
public class gug {
   ...
   private final fga n;
   private boolean o;
   private final eyk p = new eyk();
   private final eyl q = this.p.e();
   private final guf r;
   private final guh s = new guh();
   private final gty t = new gty(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<gug.a> w = new AtomicReference<>(gug.a.c);
   private final Map<gte, gty.a> x = Maps.newHashMap();
   private final Multimap<avi, gte> y = HashMultimap.create();
   private final List<gtf> z = Lists.newArrayList();
   private final Map<gte, Integer> A = Maps.newHashMap();
   private final Map<gte, Integer> B = Maps.newHashMap();
   private final List<gui> C = Lists.newArrayList();
   private final List<gtf> D = Lists.newArrayList();
   private final List<gtb> E = Lists.newArrayList();

   public gug(guj $$0, fga $$1, atz $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new guf($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(eyj::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gug.a.c, gug.a.a)) {
               String $$2 = this.n.at().c();
               ac.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gug.a.a, gug.a.b);
                     }
                  ...
                  this.w.compareAndSet(gug.a.a, gug.a.c);
               });
            }
         }

         return this.w.compareAndSet(gug.a.b, gug.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(gte::s).forEach(this::c);
      this.D.clear();
      ...
      for (gtf $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            ewh $$3 = new ewh($$0.h(), $$0.i(), $$0.j());
            gty.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<gte, gty.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gte, gty.a> $$6 = $$5.next();
         gty.a $$7 = $$6.getValue();
         gte $$8 = $$6.getKey();
      ...
      Iterator<Entry<gte, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gte, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gte $$13 = $$12.getKey();
            if ($$13 instanceof gtf) {
               ((gtf)$$13).q();
            }
   ...
   private static boolean d(gte $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gte $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gte $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gte $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != guj.d) {
                  if ($$3 == guj.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        ewh $$11 = new ewh($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != gte.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<gty.a> $$16 = this.t.a($$3.g() ? eyk.c.b : eyk.c.a);
                           gty.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aU) {
   ...
   private float g(gte $$0) {
      return ayg.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gte $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eyj::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eyj::e));
      }
   }
   ...
   public void a(ffg $$0) {
      if (this.o && $$0.h()) {
         eym $$1 = new eym($$0.b(), new ewh($$0.l()), new ewh($$0.m()));
