...
public class frh implements fer {
   static final Logger b = LogUtils.getLogger();
   private final ffs c;
   private final fqv<frh.b> d;

   frh(ffs $$0, fqv<frh.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alz c, int d, int e, int[][] f) implements frj {
      ...
      public static final MapCodec<frh.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alz.a.fieldOf("file").forGetter(frh.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(frh.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(frh.a::e),
                     g.fieldOf("chars").forGetter(frh.a::f)
                  )
                  .apply($$0, frh.a::new)
         )
         .validate(frh.a::a);
      ...
      private static DataResult<frh.a> a(frh.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     frh.b $$15 = $$9.a($$12, new frh.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        frh.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ffs $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ffs b, int c, int d, int e, int f, int g, int h) implements feq {
