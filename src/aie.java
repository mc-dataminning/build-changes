...
public class aie {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ui.c("commands.help.failed"));
                     ...
                     $$1 -> {
                        ...
                        if ($$2.getContext().getNodes().isEmpty()) {
                           ...
                           for (String $$4 : $$3.values()) {
                              ((du)$$1.getSource()).a(() -> ui.b("/" + $$2.getReader().getString() + " " + $$4), false);
                           }
