...
public class gte extends MinecraftServer {
   ...
   public gte(Thread $$0, fff $$1, epw.c $$2, aua $$3, amc $$4, alz $$5, arp $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.as(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gtd(this, this.bd(), this.g));
      this.m = $$1;
   }
   ...
   @Override
   public dbv bf() {
      return this.r() ? (dbv)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
