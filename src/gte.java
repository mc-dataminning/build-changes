...
public class gte {
   ...
   public static class a extends Thread {
      private final gte.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gte.b $$0) throws IOException {
         super("LanServerDetector #" + gte.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gte.b));
   ...
   public static class b {
      private final List<gtd> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gtd> a() {
         if (this.b) {
            List<gtd> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
