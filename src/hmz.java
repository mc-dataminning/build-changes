...
public class hmz {
   ...
   private final foj n;
   private boolean o;
   private final fgd p = new fgd();
   private final fge q = this.p.e();
   private final hmy r;
   private final hna s = new hna();
   private final hmq t = new hmq(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hmz.a> w = new AtomicReference<>(hmz.a.c);
   private final Map<hlw, hmq.a> x = Maps.newHashMap();
   private final Multimap<awm, hlw> y = HashMultimap.create();
   private final List<hlx> z = Lists.newArrayList();
   private final Map<hlw, Integer> A = Maps.newHashMap();
   private final Map<hlw, Integer> B = Maps.newHashMap();
   private final List<hnb> C = Lists.newArrayList();
   private final List<hlx> D = Lists.newArrayList();
   private final List<hlt> E = Lists.newArrayList();

   public hmz(hnc $$0, foj $$1, ave $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hmy($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fgc::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hmz.a.c, hmz.a.a)) {
               String $$2 = this.n.aw().c();
               af.i().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hmz.a.a, hmz.a.b);
                     }
                  ...
                  this.w.compareAndSet(hmz.a.a, hmz.a.c);
               });
            }
         }

         return this.w.compareAndSet(hmz.a.b, hmz.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hlw::s).forEach(this::c);
      this.D.clear();
      ...
      for (hlx $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            fdw $$3 = new fdw($$0.h(), $$0.i(), $$0.j());
            hmq.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hlw, hmq.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hlw, hmq.a> $$6 = $$5.next();
         hmq.a $$7 = $$6.getValue();
         hlw $$8 = $$6.getKey();
      ...
      Iterator<Entry<hlw, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hlw, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hlw $$13 = $$12.getKey();
            if ($$13 instanceof hlx) {
               ((hlx)$$13).q();
            }
   ...
   private static boolean d(hlw $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hlw $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hlw $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hlw $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hnc.e) {
                  if ($$3 == hnc.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        fdw $$11 = new fdw($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hlw.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hmq.a> $$16 = this.t.a($$3.g() ? fgd.c.b : fgd.c.a);
                           hmq.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hlw $$0) {
      return azk.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hlw $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fgc::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fgc::e));
      }
   }
   ...
   public void a(fnn $$0) {
      if (this.o && $$0.h()) {
         fgf $$1 = new fgf($$0.b(), new fdw($$0.l()), new fdw($$0.m()));
