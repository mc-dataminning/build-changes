public interface cwj {
   int a = 256;
   float b = 7.0F;
   aku<cwh> c = a("ponder_goat_horn");
   aku<cwh> d = a("sing_goat_horn");
   aku<cwh> e = a("seek_goat_horn");
   aku<cwh> f = a("feel_goat_horn");
   aku<cwh> g = a("admire_goat_horn");
   aku<cwh> h = a("call_goat_horn");
   aku<cwh> i = a("yearn_goat_horn");
   aku<cwh> j = a("dream_goat_horn");

   private static aku<cwh> a(String $$0) {
      return aku.a(mc.I, akv.b($$0));
   }

   static void a(qe<cwh> $$0) {
   ...
   static void a(qe<cwh> $$0, aku<cwh> $$1, jr<avz> $$2, float $$3, float $$4) {
      xd $$5 = wp.c(af.a("instrument", $$1.a()));
      $$0.a($$1, new cwh($$2, $$3, $$4, $$5));
   }
}
