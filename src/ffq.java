public class ffq implements ffs {
   ...
   @Override
   public void a(ewr $$0, int $$1, int $$2, ewt $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, ewt $$4, ewr $$5) {
      if ($$2 >= this.f.size()) {
         this.a($$4, $$0, $$1, $$3 ? ffq.a.a : ffq.a.b);
      } else {
         cmx $$6 = this.f.get($$2);
         this.a($$4, $$0, $$1, ffq.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            fdz.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(ewt $$0, int $$1, int $$2, ffq.a $$3) {
