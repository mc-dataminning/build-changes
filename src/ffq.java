...
public class ffq {
   ...
   public static void a(File $$0, eyl $$1, Consumer<xp> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eyl $$2, Consumer<xp> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eyl $$2, Consumer<xp> $$3) {
      eza $$4 = a($$2);
      ...
      ac.h().execute(() -> {
         try {
            $$4.a($$6);
            xp $$3x = xp.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new xn(xn.a.b, $$6.getAbsolutePath())));
            $$3.accept(xp.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(xp.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eza a(eyl $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eza $$3 = new eza($$1, $$2, false);
   ...
   public ffq(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
