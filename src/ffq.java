...
public final class ffq implements AutoCloseable {
   ...
   public ffq(int $$0, int $$1, boolean $$2) {
      this(ffq.a.a, $$0, $$1, $$2);
   }

   public ffq(ffq.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private ffq(ffq.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static ffq a(InputStream $$0) throws IOException {
      return a(ffq.a.a, $$0);
   }

   public static ffq a(@Nullable ffq.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ffq a(ByteBuffer $$0) throws IOException {
      return a(ffq.a.a, $$0);
   }

   public static ffq a(byte[] $$0) throws IOException {
   ...
   public static ffq a(@Nullable ffq.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new ffq($$0 == null ? ffq.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
   ...
   public ffq a(IntUnaryOperator $$0) {
      if (this.d != ffq.a.a) {
         ...
         this.j();
         ffq $$1 = new ffq(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (frg.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(ffq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ffq $$4) {
      this.j();
      if ($$4.c() != this.d) {
