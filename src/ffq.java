...
public class ffq {
   ...
   public void a(ffq.b $$0, List<atb> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ffq.c($$0, $$1.stream().map(atb::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ffq.c(ffq.b.c, ImmutableList.of());
      }

      this.b.c = new ffq.a($$0);
   }
   ...
   static class c {
      private final ffq.b a;
      private final List<String> b;
      @Nullable
      ffq.a c;
      boolean d;

      c(ffq.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
