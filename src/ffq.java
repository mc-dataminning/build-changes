...
public class ffq<T extends bjg> extends feb<T> implements fee, ffl {
   ...
   public ffq(fic $$0, Function<aex, fom> $$1) {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.n.e = arx.b($$1 * 0.6662F + (float) Math.PI) * 2.0F * $$2 * 0.5F / $$8;
      this.o.e = arx.b($$1 * 0.6662F) * 2.0F * $$2 * 0.5F / $$8;
      this.n.g = 0.0F;
      this.o.g = 0.0F;
      this.p.e = arx.b($$1 * 0.6662F) * 1.4F * $$2 / $$8;
      this.q.e = arx.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2 / $$8;
      this.p.f = 0.005F;
      this.q.f = -0.005F;
      this.p.g = 0.005F;
      this.q.g = -0.005F;
      ...
      if (this.u > 0.0F) {
         ...
         if (!$$0.fm()) {
            if ($$12 < 14.0F) {
               ...
               this.n.e = arx.i($$14, this.n.e, 0.0F);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = arx.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, (float) Math.PI + 1.8707964F * this.a($$12) / this.a(14.0F));
               this.n.g = arx.i($$14, this.n.g, (float) Math.PI - 1.8707964F * this.a($$12) / this.a(14.0F));
            } else if ($$12 >= 14.0F && $$12 < 22.0F) {
               float $$16 = ($$12 - 14.0F) / 8.0F;
               this.o.e = this.a($$15, this.o.e, (float) (Math.PI / 2) * $$16);
               this.n.e = arx.i($$14, this.n.e, (float) (Math.PI / 2) * $$16);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = arx.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, 5.012389F - 1.8707964F * $$16);
               this.n.g = arx.i($$14, this.n.g, 1.2707963F + 1.8707964F * $$16);
            } else if ($$12 >= 22.0F && $$12 < 26.0F) {
               float $$17 = ($$12 - 22.0F) / 4.0F;
               this.o.e = this.a($$15, this.o.e, (float) (Math.PI / 2) - (float) (Math.PI / 2) * $$17);
               this.n.e = arx.i($$14, this.n.e, (float) (Math.PI / 2) - (float) (Math.PI / 2) * $$17);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = arx.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, (float) Math.PI);
               this.n.g = arx.i($$14, this.n.g, (float) Math.PI);
            }
         }

         float $$18 = 0.3F;
         float $$19 = 0.33333334F;
         this.q.e = arx.i(this.u, this.q.e, 0.3F * arx.b($$1 * 0.33333334F + (float) Math.PI));
         this.p.e = arx.i(this.u, this.p.e, 0.3F * arx.b($$1 * 0.33333334F));
      }
   ...
   private void a(T $$0) {
      switch (this.s) {
         ...
         case h:
            ...
            break;
         case i:
            this.n.e = arx.a(this.k.e, -1.2F, 1.2F) - 1.4835298F;
   ...
   private void b(T $$0) {
      switch (this.r) {
         ...
         case h:
            ...
            break;
         case i:
            this.o.e = arx.a(this.k.e, -1.2F, 1.2F) - 1.4835298F;
   ...
   protected void a(T $$0, float $$1) {
      if (!(this.c <= 0.0F)) {
         ...
         fic $$3 = this.a($$2);
         float $$4 = this.c;
         this.m.f = arx.a(arx.c($$4) * (float) (Math.PI * 2)) * 0.2F;
         if ($$2 == bja.a) {
            this.m.f *= -1.0F;
         }

         this.n.d = arx.a(this.m.f) * 5.0F;
         this.n.b = -arx.b(this.m.f) * 5.0F;
         this.o.d = -arx.a(this.m.f) * 5.0F;
         this.o.b = arx.b(this.m.f) * 5.0F;
         ...
         $$4 *= $$4;
         $$4 = 1.0F - $$4;
         float $$5 = arx.a($$4 * (float) Math.PI);
         float $$6 = arx.a(this.c * (float) Math.PI) * -(this.k.e - 0.7F) * 0.75F;
         $$3.e -= $$5 * 1.2F + $$6;
         $$3.f = $$3.f + this.m.f * 2.0F;
         $$3.g = $$3.g + arx.a(this.c * (float) Math.PI) * -0.4F;
      }
   }
