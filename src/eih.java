...
public class eih extends ebl {
   ...
   private void a(rc $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         if ($$2.b("NameTagVisibility", 8)) {
            eii.b $$8 = eii.b.a($$2.l("NameTagVisibility"));
            if ($$8 != null) {
               $$4.a($$8);
            }
         }
         ...
         if ($$2.b("DeathMessageVisibility", 8)) {
            eii.b $$9 = eii.b.a($$2.l("DeathMessageVisibility"));
            if ($$9 != null) {
               $$4.b($$9);
            }
         }
         ...
         if ($$2.b("CollisionRule", 8)) {
            eii.a $$10 = eii.a.a($$2.l("CollisionRule"));
            if ($$10 != null) {
               $$4.a($$10);
            }
         }
   ...
   private void b(rc $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         eij $$4 = eij.a($$3).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$3, eij.a.d());
            return eij.a;
         });
         String $$5 = $$2.l("Name");
         tl $$6 = tl.a.a($$2.l("DisplayName"));
         eij.a $$7 = eij.a.a($$2.l("RenderType"));
         this.c.a($$5, $$4, $$6, $$7);
      }
   }
