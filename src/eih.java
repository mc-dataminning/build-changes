...
public class eih extends eib<eih.a> {
   protected eih(dpj $$0) {
      super(cxi.a, $$0, new eih.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dpb g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && je.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dpb(15) : new dpb();
         }
      }
   }

   private static dpb a(dpb $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends ehy<eih.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dpb> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public eih.a a() {
         return new eih.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
