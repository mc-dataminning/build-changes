...
public class etc {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((crx)MoreObjects.firstNonNull(this.b.q.k(), crx.b)).b());
               }
   ...
   private void a(dhi $$0, ht $$1, @Nullable rz $$2) {
   ...
   private void a(agi $$0, eju $$1, @Nullable rz $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aL().i()) {
         boolean $$5 = emr.a(etd.N().aL().i(), 292);
         if (this.d > 0L) {
            if (!emr.a(etd.N().aL().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (emr.a(etd.N().aL().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fbo) || ((fbo)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aL().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               eto.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aU().a() && this.b.m.s().c()) {
            boolean $$7 = $$6 == null || !($$6.t() instanceof evi) || !((evi)$$6.t()).e();
            if ($$3 != 0 && $$1 == 66 && fau.p() && $$7) {
               boolean $$8 = this.b.m.ap().c() == etf.a;
               this.b.m.ap().a(etf.a(this.b.m.ap().c().a() + 1));
               if ($$6 instanceof faw) {
                  ((faw)$$6).l();
               }
         ...
         if (this.b.y == null || this.b.y instanceof fap $$10 && !$$10.l()) {
            emr.a $$11 = emr.a($$1, $$2);
            if ($$3 == 0) {
               etb.a($$11, false);
               if ($$1 == 292) {
      ...
      if ($$0 == this.b.aL().i()) {
         ...
         if ($$3 != null && this.b.aI() == null) {
            if (Character.charCount($$1) == 1) {
               fau.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fau.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", atm.f((float)$$1 / 1000.0F));
            }
