...
public class etc {
   ...
   public static void a(File $$0, elw $$1, Consumer<ur> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, elw $$2, Consumer<ur> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, elw $$2, Consumer<ur> $$3) {
      eml $$4 = a($$2);
   ...
   public static eml a(elw $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eml $$3 = new eml($$1, $$2, false);
   ...
   public etc(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
