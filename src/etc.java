...
public class etc extends ese {
   ...
   public etc(erx $$0, int $$1, int $$2, int $$3, int $$4, tl $$5, tl $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new etf($$0, $$3 - this.b());
      this.o.a(this::w);
   }
   ...
   @Override
   public void a(ewd $$0) {
      $$0.a(ewc.a, tl.a("gui.narrate.editBox", this.m(), this.v()));
   }
   ...
   private void w() {
      double $$0 = this.c();
      etf.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         etf.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
