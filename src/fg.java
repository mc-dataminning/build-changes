...
public class fg implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> wi.b("team.notFound", $$0));

   public static fg a() {
      return new fg();
   }

   public static eti a(CommandContext<dv> $$0, String $$1) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return $$0.getSource() instanceof ea ? ea.b(((ea)$$0.getSource()).r(), $$1) : Suggestions.empty();
   }
