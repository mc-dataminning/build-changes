...
public class adn implements yn<aay> {
   public static final ye<vg, adn> a = yn.a(adn::a, adn::new);
   private static final int b = 12;
   private final je c;
   private final short[] d;
   private final doz[] e;

   public adn(je $$0, ShortSet $$1, drg $$2) {
      this.c = $$0;
      int $$3 = $$1.size();
      this.d = new short[$$3];
      this.e = new doz[$$3];
   ...
   private void a(vg $$0) {
      ...
      for (int $$1 = 0; $$1 < this.d.length; $$1++) {
         $$0.a((long)dby.i(this.e[$$1]) << 12 | (long)this.d[$$1]);
      }
   }
   ...
   public void a(BiConsumer<ib, doz> $$0) {
      ib.a $$1 = new ib.a();
