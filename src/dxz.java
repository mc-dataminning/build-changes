...
public abstract class dxz<T extends Comparable<T>> {
   ...
   private final Codec<dxz.a<T>> e = this.d.xmap(this::c, dxz.a::b);

   protected dxz(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dxz.a<T> c(T $$0) {
      return new dxz.a<>(this, $$0);
   }

   public dxz.a<T> a(dwz<?, ?> $$0) {
      return new dxz.a<>(this, $$0.c(this));
   }

   public Stream<dxz.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dxz<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dwz<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dxz<T> a, T b) {
      public a(dxz<T> a, T b) {
         if (!a.a().contains(b)) {
