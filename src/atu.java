...
public class atu implements AutoCloseable {
   ...
   private atu(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static atu.a a(Path $$0) {
         return new atu.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
