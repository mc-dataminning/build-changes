...
public class atu extends axz {
   public atu(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", ayx.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(ayx.s, "minecraft:jukebox");
