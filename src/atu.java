...
public class atu {
   ...
   private static List<atu.b> a(final Path $$0) throws IOException {
      try {
         final List<atu.b> $$1 = new ArrayList<>();
   ...
   private static List<atu.a> a(List<atu.b> $$0) {
      List<atu.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (atu.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new atu.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<atu.a> a = Comparator.comparing(atu.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<atu.b> a = Comparator.comparing(atu.b::b).reversed();
