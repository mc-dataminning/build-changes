...
public class eru {
   ...
   @Nullable
   private String g;
   private static final eru.a h = new eru.a() {
      @Nullable
      @Override
      public ert a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ery.a(this.d, "Get capabilities")) {
         ...
         if (ery.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ery.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ery.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ert a(eru.c $$0) {
      return ($$0 == eru.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eru.a {
      private final int a;
      private final Set<ert> b = Sets.newIdentityHashSet();
      ...
      public ert a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               eru.a.warn("Maximum sound pool size {} reached", this.a);
            }
