...
public class eru {
   ...
   public static List<eru.a> a(String $$0, eru.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<eru.a> a(String $$0, List<eru.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<eru.a> a(List<String> $$0, List<eru.b> $$1) {
      int $$2 = 0;
      List<eru.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<eru.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static eru.b a(String $$0, String $$1) {
         return new eru.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static eru.b a(String $$0) {
         return new eru.b($$0);
      }
   }
}
