...
public class eru extends erv {
   ...
   private eru(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   public static eru a(String $$0) {
      try {
         ...
         String $$3 = ets.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = ets.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = ets.a("worldClosed", $$2, false);
               String $$7 = ets.b("token", $$2, null);
               return new eru($$6, $$7, $$5);
            }
         }
