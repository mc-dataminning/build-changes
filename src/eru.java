...
public class eru {
   ...
   public float a = 1.0F;
   private int ae;
   private cix af = cix.b;
   private final eso ag;
   private final etn ah;
   private final eud ai;
   private final eth aj;
   private final esf ak;
   private int al;
   @Nullable
   private tf am;
   @Nullable
   ...
   public void a(erv $$0, float $$1) {
      ...
      float $$6 = arp.i($$1, this.W.s.cu, this.W.s.ct);
      if ($$6 > 0.0F && !this.W.s.a(bhx.i)) {
         this.c($$0, $$6);
      }
      ...
      if (this.W.s.fU() > 0) {
         ...
         $$0.a(foc.D(), 0, 0, this.av, this.aw, $$11);
         this.W.aG().c();
      }
   ...
   private void a(erv $$0, ert $$1, int $$2, int $$3, int $$4) {
   ...
   private void d(erv $$0) {
      eqp $$1 = this.W.m;
      if ($$1.av().a()) {
         if (this.W.q.l() != cpi.d || this.a(this.W.v)) {
            if (this.ag.d() && !this.W.s.gg() && !$$1.R().c()) {
               epw $$2 = this.W.j.m();
               elf $$3 = RenderSystem.getModelViewStack();
               $$3.a();
               $$3.a($$0.c().c().a());
               ...
               if (this.W.m.A().c() == epv.b) {
                  float $$5 = this.W.s.B(0.0F);
                  boolean $$6 = false;
                  if (this.W.u != null && this.W.u instanceof biy && $$5 >= 1.0F) {
                     $$6 = this.W.s.gj() > 5.0F;
                     $$6 &= this.W.u.bv();
                  }
   ...
   private boolean a(ehb $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == ehb.a.c) {
         return ((eha)$$0).a() instanceof bgt;
      } else if ($$0.c() == ehb.a.b) {
         gu $$1 = ((egz)$$0).a();
         cpl $$2 = this.W.r;
   ...
   protected void a(erv $$0) {
      Collection<bhv> $$1 = this.W.s.eq();
      if (!$$1.isEmpty()) {
         if (this.W.y instanceof ezp $$2 && $$2.G()) {
            return;
         }
   ...
   public void a(bjj $$0, erv $$1, int $$2) {
      this.W.aG().a("jumpBar");
      float $$3 = this.W.s.s();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   public void c(erv $$0) {
      ...
      if (this.W.r.V() >= 120500L) {
         ...
         $$1 = tf.a("demo.remainingTime", asi.a((int)(120500L - this.W.r.V())));
      }
   ...
   private void a(erv $$0, ehz $$1) {
      eic $$2 = $$1.a();
      Collection<eib> $$3 = $$2.i($$1);
      List<eib> $$4 = $$3.stream().filter($$0x -> $$0x.e() != null && !$$0x.e().startsWith("#")).collect(Collectors.toList());
      if ($$4.size() > 15) {
      ...
      List<Pair<eib, tf>> $$5 = Lists.newArrayListWithCapacity($$3.size());
      tf $$6 = $$1.d();
      int $$7 = this.f().a($$6);
      int $$8 = $$7;
      int $$9 = this.f().b(": ");
      ...
      for (Pair<eib, tf> $$20 : $$5) {
         $$17++;
         eib $$21 = (eib)$$20.getFirst();
   ...
   private cbm m() {
      return !(this.W.am() instanceof cbm) ? null : (cbm)this.W.am();
   }
   ...
   private void e(erv $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$9 = this.av / 2 + 91;
         int $$10 = this.aw - 39;
         float $$11 = Math.max((float)$$1.b(bke.a), (float)Math.max($$5, $$2));
         int $$12 = arp.f($$1.fi());
   ...
   private void a(erv $$0, cbm $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      eru.a $$11 = eru.a.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, eru.a.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == eru.a.d ? $$11 : eru.a.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(erv $$0, eru.a $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void f(erv $$0) {
      biy $$1 = this.n();
      if ($$1 != null) {
         int $$2 = this.a($$1);
         if ($$2 != 0) {
   ...
   private void a(erv $$0, aer $$1, float $$2) {
   ...
   private void b(erv $$0, float $$1) {
      ...
      $$0.a(foc.D(), 0, $$10, this.av, this.aw, -90, -16777216);
      $$0.a(foc.D(), 0, 0, this.av, $$8, -90, -16777216);
      $$0.a(foc.D(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(foc.D(), $$9, $$8, this.av, $$10, -90, -16777216);
   }

   private void a(bii $$0) {
      if ($$0 != null) {
         gu $$1 = gu.a($$0.dp(), $$0.dt(), $$0.dv());
         float $$2 = fnt.a($$0.dK().x_(), $$0.dK().z($$1));
         float $$3 = arp.a(1.0F - $$2, 0.0F, 1.0F);
         this.a = this.a + ($$3 - this.a) * 0.01F;
      }
   }

   private void a(erv $$0, bii $$1) {
      dgq $$2 = this.W.r.w_();
      float $$3 = (float)$$2.a($$1);
   ...
   private void a(erv $$0, int $$1, int $$2, float $$3, cbm $$4, cix $$5, int $$6) {
      if (!$$5.b()) {
         float $$7 = (float)$$5.K() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
   ...
   private void g(erv $$0) {
      if (this.W.m.ab().c() && (this.ax > 0.0F || this.ay > 0.0F)) {
         int $$1 = arp.d(255.0F * arp.a(arp.i(this.W.as(), this.ay, this.ax), 0.0F, 1.0F));
         if ($$1 > 8) {
            ert $$2 = this.f();
            int $$3 = $$2.a(L);
