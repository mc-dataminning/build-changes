...
public class eiq implements bai {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eiq> b = eip.a.xmap($$0 -> new eiq($$0), $$0 -> $$0.e);
   private eip e;
   private final ehr f = new ehr(this);

   public eiq(long $$0) {
      this.e = new eip(eie.c($$0));
   }
   ...
   @Override
   public bai d() {
      return new eiq(this.e.a(), this.e.a());
   }

   @Override
   public eic e() {
      return new eiq.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements eic {
      ...
      public bai a(int $$0, int $$1, int $$2) {
         long $$3 = azz.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eiq($$4, this.b);
      }

      @Override
      public bai a(String $$0) {
         eie.a $$1 = eie.a($$0);
         return new eiq($$1.a(this.a, this.b));
      }

      @Override
      public bai a(long $$0) {
         return new eiq($$0 ^ this.a, $$0 ^ this.b);
      }
