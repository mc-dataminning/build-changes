...
public class eiq extends eit<eip> {
   public eiq(Codec<eip> $$0) {
      super($$0);
   }

   public boolean a(eip $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eio $$0, eip $$1, ecl $$2, Function<iv, jf<dkk>> $$3, azv $$4, efz $$5, dio $$6, eck $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eit.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eio $$0, eip $$1, ecl $$2, Function<iv, jf<dkk>> $$3, efz $$4, double $$5, double $$6, double $$7, float $$8, double $$9, eck $$10, eit.a $$11
   ) {
