...
public class ewk {
   ...
   public ewk(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ewl> $$1) throws IOException {
   ...
   public List<ewl> a(Path $$0) throws IOException {
      List<ewl> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ewl> a(Path $$0, boolean $$1) throws IOException {
      List<ewl> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ewl> $$1) throws IOException {
