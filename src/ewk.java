...
public class ewk extends fbi {
   ...
   public ewk(int $$0, int $$1, int $$2, int $$3, int $$4, fbi.c $$5) {
   ...
   public void a(evi $$0) {
      this.A = new ewk.b($$0, this.z);
      this.a(this.A, $$0.o);
   }

   private void a(ewk.b $$0, @Nullable String $$1) {
      vu $$2 = switch ($$0.c) {
         case c -> v;
         case b -> $$0.b ? w : x;
         default -> null;
   ...
   static ewk.a a(evi $$0, boolean $$1, boolean $$2) {
      if ($$1 && !$$0.j && $$0.e != evi.c.c) {
         return ewk.a.c;
      } else {
         return $$1 || $$2 && $$0.j ? ewk.a.a : ewk.a.b;
      }
   }
   ...
   public void b(fav $$0, int $$1, int $$2, float $$3) {
      if (this.A != null) {
         ...
         ajh $$7;
         if (this.A.b) {
            $$7 = exx.a(String.valueOf(this.A.h), this.A.i);
         } else if (this.A.a) {
            $$7 = a;
         ...
         $$0.a($$15, eum.a(this.A.f, this.A.g.a()), $$4 + 40, $$5 + 80 + 2, -1);
      }
   }
   ...
   public static class b {
      ...
      public final ewk.a c;

      public b(evi $$0, int $$1) {
         this.b = $$1 == 4;
         if (this.b) {
            this.d = $$0.m == evi.d.b;
            this.e = ewk.y.getString();
            this.h = (long)$$0.p;
            this.i = $$0.q;
            this.a = $$0.p == -1;
            this.f = "";
