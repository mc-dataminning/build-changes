...
public abstract class ewk {
   ...
   public evm a() {
      if (this.c()) {
         ...
         return new evm(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
      }
   }

   public ewk b() {
      return this.c() ? ewh.a() : ewh.a(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
   }
   ...
   public ewk a(double $$0, double $$1, double $$2) {
      return (ewk)(this.c() ? ewh.a() : new evt(this.a, new ewg(this.a(je.a.a), $$0), new ewg(this.a(je.a.b), $$1), new ewg(this.a(je.a.c), $$2)));
   }

   public ewk d() {
      ewk[] $$0 = new ewk[]{ewh.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewh.b($$0[0], ewh.a($$1, $$2, $$3, $$4, $$5, $$6), evv.o));
      return $$0[0];
   }

   public void a(ewh.a $$0) {
      this.a
         .a(
   ...
   public List<evm> e() {
      List<evm> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new evm($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(je.a.a, $$4.c - (double)$$2.u()), this.a(je.a.b, $$4.d - (double)$$2.v()), this.a(je.a.c, $$4.e - (double)$$2.w()))
               ? new evn($$4, je.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : evm.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<evr> a(evr $$0) {
      if (this.c()) {
   ...
   public ewk a(je $$0) {
      if (!this.c() && this != ewh.b()) {
         if (this.b != null) {
            ewk $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewk b(je $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewi(this, $$1, $$4);
      }
   }

   public double a(je.a $$0, evm $$1, double $$2) {
      return this.a(iw.a($$0, je.a.a), $$1, $$2);
   }

   protected double a(iw $$0, evm $$1, double $$2) {
      if (this.c()) {
         return $$2;
