...
public class ewk {
   ...
   static class b {
      static final Optional<ewk> a = Optional.ofNullable(a());
      ...
      private static ewk a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ewk();
      }
   }
}
