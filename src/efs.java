...
public class efs extends efy<eia> {
   public efs(Codec<eia> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ega<eia> $$0) {
      dhg $$1 = $$0.b();
      ji $$2 = $$0.e();
      eia $$3 = $$0.f();
      azh $$4 = $$0.d();
   ...
   private void a(dhg $$0, azh $$1, ji $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, eia $$9) {
      Optional<eci> $$10 = eci.a($$0, $$2, $$9.b, eft::c, eft::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dgl)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dgl)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               eft.a($$0, $$2.h($$11.getAsInt() - 1), jn.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               eft.a($$0, $$2.h($$17.getAsInt() + 1), jn.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dgl $$0, ji $$1) {
      return $$0.a_($$1).a(djo.K);
   }

   private int a(azh $$0, int $$1, int $$2, float $$3, int $$4, eia $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dhg $$0, ji $$1) {
      dwx $$2 = $$0.a_($$1);
      if (!$$2.a(djo.J) && !$$2.a(djo.sW) && !$$2.a(djo.sV)) {
         if ($$0.a_($$1.d()).y().a(awv.a)) {
            return false;
         } else {
            for (jn $$3 : jn.c.a) {
               if (!this.a((dgj)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dgj)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private void a(dhg $$0, ji $$1, int $$2, jn $$3) {
      ji.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, eia $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
