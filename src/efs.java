...
public interface efs {
   static efs a(egk $$0, dih $$1, egm $$2, egt $$3, int $$4, int $$5, efs.a $$6) {
      return new efs.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static efs a(final efs.a $$0) {
      return new efs() {
         @Nullable
         @Override
         public eah a(efz.b $$0x, double $$1) {
   ...
   @Nullable
   eah a(efz.b var1, double var2);

   boolean a();

   public interface a {
      efs.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, eah b) {

      public eah a(int $$0) {
         return $$0 < this.a ? this.b : dmh.a.m();
      }
   }

   public static class c implements efs {
      ...
      private final efz p;
      private final egt q;
      private final efs.b[] r;
      private final long[] s;
      private final efs.a t;
      private final efz u;
      private final efz v;
      private boolean w;
      private final int x;
      ...
      c(egk $$0, dih $$1, egm $$2, egt $$3, int $$4, int $$5, efs.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public eah a(efz.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            efs.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dmh.K)) {
               this.w = false;
               return dmh.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dmh.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dmh.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(efz.b $$0, MutableDouble $$1, efs.b $$2, efs.b $$3) {
         int $$4 = $$0.b();
         eah $$5 = $$2.a($$4);
         eah $$6 = $$3.a($$4);
         if ((!$$5.a(dmh.K) || !$$6.a(dmh.J)) && (!$$5.a(dmh.J) || !$$6.a(dmh.K))) {
      ...
      private efs.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            efs.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private efs.b b(int $$0, int $$1, int $$2) {
         efs.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               efs.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new efs.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, efs.b $$3, int $$4, boolean $$5) {
         efz.e $$6 = new efz.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dkt.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new efz.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azm.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private eah a(int $$0, int $$1, int $$2, efs.b $$3, int $$4) {
         eah $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != eee.g && $$3.b != dmh.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new efz.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dmh.K.m();
            }
         }
