...
public class efs extends efw {
   public static final MapCodec<efs> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eff.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
   ...
   protected final eff e;
   protected final int f;
   protected final List<je> g;

   public efs(float $$0, int $$1, int $$2, eff $$3, int $$4, List<je> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(efw.a $$0, iz $$1, je $$2) {
