...
public class efs extends efv<efr> {
   public efs(Codec<efr> $$0) {
      super($$0);
   }

   public boolean a(efr $$0, bam $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(efq $$0, efr $$1, dzp $$2, Function<jh, jq<dij>> $$3, bam $$4, edb $$5, dgn $$6, dzo $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         efv.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      efq $$0, efr $$1, dzp $$2, Function<jh, jq<dij>> $$3, edb $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dzo $$10, efv.a $$11
   ) {
