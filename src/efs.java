...
public record efs<T>(T b, gu c, int d, efx e) {
   ...
   public static final Strategy<efs<?>> a = new Strategy<efs<?>>() {
      public int a(efs<?> $$0) {
   ...
   public static <T> void a(qx $$0, Function<String, Optional<T>> $$1, clt $$2, Consumer<efs<T>> $$3) {
      long $$4 = $$2.a();
   ...
   public static <T> Optional<efs<T>> a(qr $$0, Function<String, Optional<T>> $$1) {
      return $$1.apply($$0.l("i")).map($$1x -> {
         gu $$2 = new gu($$0.h("x"), $$0.h("y"), $$0.h("z"));
         return new efs<>((T)$$1x, $$2, $$0.h("t"), efx.a($$0.h("p")));
      });
   }
   ...
   public eft<T> a(long $$0, long $$1) {
      return new eft<>(this.b, this.c, $$0 + (long)this.d, this.e, $$1);
   }

   public static <T> efs<T> a(T $$0, gu $$1) {
      return new efs<>($$0, $$1, 0, efx.d);
   }
