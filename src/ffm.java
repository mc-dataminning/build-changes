...
public class ffm {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cB.d("gamemode spectator");
               } else {
                  this.b.s.cB.d("gamemode " + ((dca)MoreObjects.firstNonNull(this.b.q.i(), dca.b)).b());
               }
   ...
   private void a(dsh $$0, ja $$1, @Nullable tx $$2) {
   ...
   private void a(akk $$0, evz $$1, @Nullable tx $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = ezb.a(ffn.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!ezb.a(ffn.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ezb.a(ffn.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.c();
            this.e = ac.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fqm) || ((fqm)$$6).s <= ac.c() - 20L)) {
            if (this.b.m.Q.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.N.a($$1, $$2)) {
               ...
               ffx.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aI_() instanceof fhv) || !((fhv)$$6.aI_()).c();
            if ($$7) {
               if (fnd.s() && $$1 == 66 && this.b.aX().a() && this.b.m.u().c()) {
                  boolean $$8 = this.b.m.as().c() == ffp.a;
                  this.b.m.as().a(ffp.a(this.b.m.as().c().a() + 1));
                  this.b.m.av();
                  if ($$6 instanceof flv $$9) {
                     $$9.h();
                  }

                  if ($$6 instanceof fpz $$10) {
                     $$10.F();
                  }
         ...
         label191: {
            ...
            label151:
            if (!$$13) {
               if (this.b.y instanceof fmy $$14 && !$$14.m()) {
                  break label151;
               }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", aye.f((float)$$1 / 1000.0F));
            }
