...
public class ffm {
   ...
   public static final ffm.a bv;

   public static ffm.a a(int $$0, int $$1) {
      return $$0 == -1 ? ffm.b.b.a($$1) : ffm.b.a.a($$0);
   }

   public static ffm.a a(String $$0) {
      if (ffm.a.e.containsKey($$0)) {
         return ffm.a.e.get($$0);
      } else {
         for (ffm.b $$1 : ffm.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ffm.b b;
      private final int c;
      private final ayt<wp> d;
      static final Map<String, ffm.a> e = Maps.newHashMap();

      a(String $$0, ffm.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wp.b($$2.toUpperCase(Locale.ROOT)) : wp.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wp.b($$2) : wp.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tl.a().b($$1) ? wp.c($$1) : wp.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ffm.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wp> g;

      private static void a(ffm.b $$0, String $$1, int $$2) {
         ffm.a $$3 = new ffm.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, wp> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ffm.a a(int $$0) {
         return (ffm.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
