...
public class ffm {
   ...
   public void a(ffm.b $$0, List<ata> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ffm.c($$0, $$1.stream().map(ata::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ffm.c(ffm.b.c, ImmutableList.of());
      }

      this.b.c = new ffm.a($$0);
   }
   ...
   static class c {
      private final ffm.b a;
      private final List<String> b;
      @Nullable
      ffm.a c;
      boolean d;

      c(ffm.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
