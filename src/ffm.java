...
public class ffm {
   ...
   static class b {
      static final Optional<ffm> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ffm a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ffm();
      }
   }
}
