public class ffm extends ffo<bzg> {
   ...
   public static fik b() {
      ...
      fij $$3 = fij.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, fig.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", fij.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), fig.a(0.0F, 0.0F, -8.25F));
      fin $$11 = $$2.a("tail0", fij.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), fig.a);
      fin $$12 = $$11.a("tail1", fij.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), fig.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", fij.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), fig.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(bzg $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$8 != null) {
         ...
         ehp $$12 = $$0.f(0.0F);
         $$12 = new ehp($$12.c, 0.0, $$12.e);
         ehp $$13 = new ehp($$10.c - $$9.c, 0.0, $$10.e - $$9.e).d().b((float) (Math.PI / 2));
         double $$14 = $$12.b($$13);
         this.p.b = ary.c((float)Math.abs($$14)) * 2.0F * (float)Math.signum($$14);
      }

      this.p.k = true;
      float $$15 = $$0.E($$6);
      this.r[0].f = ary.a($$15) * (float) Math.PI * 0.05F;
      this.r[1].f = ary.a($$15) * (float) Math.PI * 0.1F;
      this.r[2].f = ary.a($$15) * (float) Math.PI * 0.15F;
   }
   ...
   private static float a(int $$0, float $$1, float $$2) {
      return 1.0F + ary.b($$1 * 1.5F + (float)$$0) * 0.01F - $$2;
   }
