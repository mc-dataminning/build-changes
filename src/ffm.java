...
public class ffm extends feo {
   ...
   public ffm(fef $$0, int $$1, int $$2, int $$3, int $$4, ws $$5, ws $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new ffp($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fiq $$0) {
      $$0.a(fip.a, ws.a("gui.narrate.editBox", this.y(), this.j()));
   }
   ...
   protected void a(feh $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         ws $$2 = ws.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      ffp.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         ffp.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
