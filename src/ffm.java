...
public class ffm extends ffe {
   ...
   private int z;
   private final ezy A = new ezy(false);

   public ffm(boolean $$0, Runnable $$1) {
      super(ewz.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, ffm.a $$1) {
      try (Reader $$2 = this.f.Z().openAsReader(new aiy($$0))) {
         $$1.read($$2);
