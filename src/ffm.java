...
public class ffm extends fdz<cjz> {
   ...
   private void b(ewt $$0, int $$1, int $$2, int $$3) {
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (this.N && this.I()) {
         ...
         this.O = (int)((double)(this.M * (float)this.H()) + 0.5) * 4;
         return true;
      } else {
