...
public class czk {
   private final Map<alg, czk.a> a = Maps.newHashMap();
   private int b;
   ...
   public float a(czn $$0, float $$1) {
      alg $$2 = this.b($$0);
      czk.a $$3 = this.a.get($$2);
      if ($$3 != null) {
   ...
   public void a() {
      this.b++;
      if (!this.a.isEmpty()) {
         Iterator<Entry<alg, czk.a>> $$0 = this.a.entrySet().iterator();

         while ($$0.hasNext()) {
            Entry<alg, czk.a> $$1 = $$0.next();
   ...
   public void a(alg $$0, int $$1) {
      this.a.put($$0, new czk.a(this.b, this.b + $$1));
      this.b($$0, $$1);
   }
