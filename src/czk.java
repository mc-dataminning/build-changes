...
public class czk extends czn {
   ...
   private final List<czk.a> l = Lists.newArrayList();
   @Nullable
   private gu m;
   ...
   public boolean c() {
      if (this.o == null) {
         ...
         for (gu $$0 : gu.a(this.p.b(-1, -1, -1), this.p.b(1, 1, 1))) {
            if (this.o.a_($$0).b() instanceof csj) {
               return true;
            }
         }
   ...
   public void a(@Nullable byo $$0, dcb $$1, czk.b $$2) {
   ...
   private List<bfj> a(dcb $$0, czk.b $$1) {
      List<bfj> $$2 = Lists.newArrayList();
   ...
   public void a(bfj $$0, boolean $$1, int $$2) {
      if (this.l.size() < 3) {
         ...
         this.a($$3, $$2, $$1);
         if (this.o != null) {
            if ($$0 instanceof brm $$4 && $$4.r() && (!this.v() || this.o.z.h())) {
               this.m = $$4.q();
            }
   ...
   public void a(qr $$0, int $$1, boolean $$2) {
      this.l.add(new czk.a($$0, $$1, $$2 ? 2400 : 600));
   }

   private static boolean a(cmm $$0, gu $$1, dcb $$2, czk.a $$3, @Nullable List<bfj> $$4, czk.b $$5, @Nullable gu $$6) {
      if (($$0.O() || $$0.Z()) && $$5 != czk.b.c) {
         return false;
      } else {
         qr $$7 = $$3.a.h();
         d($$7);
         ...
         if ($$10 && $$5 != czk.b.c) {
            ...
            bfj $$11 = bfn.a($$7, $$0, $$0x -> $$0x);
            if ($$11 != null) {
               if (!$$11.ae().a(amz.c)) {
                  return false;
               } else {
                  if ($$11 instanceof brm $$12) {
                     if ($$6 != null && !$$12.r() && $$0.z.i() < 0.9F) {
                        $$12.i($$6);
                     }

                     if ($$5 == czk.b.a) {
                        $$12.gm();
                        if ($$2.a(amw.aE, $$0x -> $$0x.b(cph.b))) {
                           int $$13 = a($$2);
                           if ($$13 < 5) {
                              ...
                              $$0.b($$1, $$2.a(cph.b, Integer.valueOf($$13 + $$14)));
                           }
                        }
                     }
                  ...
                  $$0.a(null, $$1, amh.bH, ami.e, 1.0F, 1.0F);
                  $$0.a(dgl.c, $$1, dgl.a.a($$11, $$0.a_($$1)));
                  return $$0.b($$11);
               }
            } else {
               return false;
   ...
   private static void a(cmm $$0, gu $$1, dcb $$2, List<czk.a> $$3, @Nullable gu $$4) {
      boolean $$5 = false;
      Iterator<czk.a> $$6 = $$3.iterator();

      while ($$6.hasNext()) {
         czk.a $$7 = $$6.next();
         if ($$7.b > $$7.c) {
            czk.b $$8 = $$7.a.q("HasNectar") ? czk.b.a : czk.b.b;
   ...
   public void a(qr $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.size(); $$2++) {
         qr $$3 = $$1.a($$2);
         czk.a $$4 = new czk.a($$3.p("EntityData"), $$3.h("TicksInHive"), $$3.h("MinOccupationTicks"));
         this.l.add($$4);
      }
