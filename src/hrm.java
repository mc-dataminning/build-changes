...
public abstract class hrm extends gad {
   ...
   private final List<hrl> a = Lists.newArrayList();
   ...
   protected hrl a(hrl $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xa m() {
      return wz.a(this.a.stream().map(hrl::a).collect(Collectors.toList()));
   }
}
