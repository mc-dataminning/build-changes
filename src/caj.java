...
public class caj extends cam {
   ...
   public caj(btq $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<btq> $$0 = this.a.dP().a(btq.class, this.a.cK().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (btq $$1 : $$0) {
            if (!$$1.ch()) {
               this.c = $$1;
