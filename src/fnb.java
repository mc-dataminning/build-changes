...
public class fnb extends fmy {
   ...
   public final fit cl;
   private final apk cC;
   private final eqd cD;
   private final List<gbr> cE = Lists.newArrayList();
   private int cF = 0;
   private double cG;
   private double cH;
   private double cI;
   ...
   public fnb(eqq $$0, fis $$1, fit $$2, apk $$3, eqd $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.p());
      this.cn = $$0;
      this.cl = $$2;
      this.cC = $$3;
      ...
      this.cN = $$5;
      this.cO = $$6;
      this.cE.add(new gcj(this, $$0.ai()));
      this.cE.add(new gbw(this));
      this.cE.add(new gbv(this, $$0.ai(), $$1.z_()));
   }
   ...
   public boolean a(bil $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cdg) {
            this.cn.ai().a((gch)(new gcb(this, (cdg)$$0, true)));
            this.cn.ai().a((gch)(new gcb(this, (cdg)$$0, false)));
         }
   ...
   public void l() {
      if (this.dK().f(this.do(), this.du())) {
         super.l();
         if (this.bN()) {
            this.cl.b(new abw.c(this.dA(), this.dC(), this.aA()));
            this.cl.b(new ace(this.bk, this.bm, this.cm.g, this.cm.h));
            bil $$0 = this.cV();
            if ($$0 != this && $$0.cW()) {
               this.cl.b(new abx($$0));
               this.B();
   ...
   private void A() {
      ...
      boolean $$0 = this.bR();
      if ($$0 != this.cN) {
         acd.a $$1 = $$0 ? acd.a.a : acd.a.b;
         this.cl.b(new acd(this, $$1));
         this.cN = $$0;
      }
      ...
      if (this.u()) {
         ...
         this.cP++;
         boolean $$7 = ars.f($$2, $$3, $$4) > ars.k(2.0E-4) || this.cP >= 20;
         boolean $$8 = $$5 != 0.0 || $$6 != 0.0;
         if (this.bN()) {
            ehi $$9 = this.dn();
            this.cl.b(new abw.b($$9.c, -999.0, $$9.e, this.dA(), this.dC(), this.aA()));
            $$7 = false;
         } else if ($$7 && $$8) {
            this.cl.b(new abw.b(this.dp(), this.dr(), this.dv(), this.dA(), this.dC(), this.aA()));
         } else if ($$7) {
            this.cl.b(new abw.a(this.dp(), this.dr(), this.dv(), this.aA()));
         } else if ($$8) {
            this.cl.b(new abw.c(this.dA(), this.dC(), this.aA()));
         } else if (this.cL != this.aA()) {
            this.cl.b(new abw.d(this.aA()));
         }
   ...
   public boolean a(boolean $$0) {
      acc.a $$1 = $$0 ? acc.a.d : acc.a.e;
      cja $$2 = this.fQ().a($$0);
      this.cl.b(new acc($$1, gw.b, hc.a));
      return !$$2.b();
   }
   ...
   protected void h() {
      this.cl.b(new acd(this, acd.a.f, ars.d(this.s() * 100.0F)));
   }

   public void i() {
      this.cl.b(new acd(this, acd.a.h));
   }
   ...
   private boolean i(gw $$0) {
      ehd $$1 = this.cG();
      ehd $$2 = new ehd((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   @Override
   public bgs fm() {
      return Objects.requireNonNullElse(this.cU, bgs.a);
   }
   ...
   public void a(aec<?> $$0) {
      ...
      if (t.equals($$0)) {
         ...
         bgs $$2 = (this.an.b(t) & 2) > 0 ? bgs.b : bgs.a;
         if ($$1 && !this.cT) {
            this.c($$2);
         } else if (!$$1 && this.cT) {
            this.fr();
      ...
      if (ao.equals($$0) && this.fu() && !this.cY) {
         this.cn.ai().a((gch)(new gbx(this)));
      }
   }

   @Nullable
   public bjm p() {
      if (this.cZ() instanceof bjm $$0 && $$0.a()) {
         return $$0;
      }
   ...
   public void a(ddy $$0, boolean $$1) {
      if ($$0 instanceof ddm $$2) {
         this.cn.a(new ezz($$2, $$1, this.cn.aQ()));
      } else {
         this.cn.a(new fam($$0, $$1, this.cn.aQ()));
      }
   }
   ...
   public void b_() {
      ...
      boolean $$1 = this.cm.h;
      boolean $$2 = this.J();
      this.cM = !this.fR().b && !this.bY() && !this.bN() && this.g(bjn.f) && (this.bR() || !this.fB() && !this.g(bjn.a));
      float $$3 = ars.a(0.3F + cnl.b(this), 0.0F, 1.0F);
      this.cm.a(this.t(), $$3);
      ...
      if (this.cm.g && !$$10 && !$$0 && !this.fR().b && !this.bN() && !this.j_()) {
         cja $$11 = this.c(biq.e);
         if ($$11.a(cjd.nh) && chu.d($$11) && this.fV()) {
            this.cl.b(new acd(this, acd.a.i));
         }
      }
      ...
      if (this.a(apt.a)) {
         int $$12 = this.G_() ? 10 : 1;
         this.cZ = ars.a(this.cZ + $$12, 0, 600);
      } else if (this.cZ > 0) {
         this.a(apt.a);
         this.cZ = ars.a(this.cZ - 10, 0, 600);
      }
   ...
   private void D() {
      ...
      float $$0 = 0.0F;
      if (this.av) {
         if (this.cn.y != null && !this.cn.y.j() && !(this.cn.y instanceof exe)) {
            if (this.cn.y instanceof ezd) {
               this.q();
            }
         ...
         if (this.ct == 0.0F) {
            this.cn.ai().a(gcc.b(aoz.sW, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }

         $$0 = 0.0125F;
         this.av = false;
      } else if (this.a(bia.i) && !this.b(bia.i).a(60)) {
         $$0 = 0.006666667F;
      } else if (this.ct > 0.0F) {
         $$0 = -0.05F;
      }

      this.ct = ars.a(this.ct + $$0, 0.0F, 1.0F);
      this.I();
   }
   ...
   protected void f(float $$0, float $$1) {
      if (this.E()) {
         ehi $$2 = this.di();
         ehi $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         ehi $$4 = new ehi((double)$$0, 0.0, (double)$$1);
         float $$5 = this.fd();
         float $$6 = (float)$$4.g();
         if ($$6 <= 0.001F) {
            ehh $$7 = this.cm.a();
            ...
            $$4 = new ehi((double)($$8 * $$11 - $$9 * $$10), $$4.d, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.g();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         float $$12 = ars.i($$6);
         ehi $$13 = $$4.a((double)$$12);
         ehi $$14 = this.bG();
         float $$15 = (float)($$14.c * $$13.c + $$14.e * $$13.e);
         if (!($$15 < -0.15F)) {
            ehn $$16 = ehn.a(this);
            gw $$17 = gw.a(this.dp(), this.cG().e, this.dv());
            dfe $$18 = this.dK().a_($$17);
            if ($$18.b(this.dK(), $$17, $$16).c()) {
               $$17 = $$17.c();
               dfe $$19 = this.dK().a_($$17);
               if ($$19.b(this.dK(), $$17, $$16).c()) {
                  float $$20 = 7.0F;
                  float $$21 = 1.2F;
                  if (this.a(bia.h)) {
                     $$21 += (float)(this.b(bia.h).e() + 1) * 0.75F;
                  }

                  float $$22 = Math.max($$5 * 7.0F, 1.0F / $$12);
                  ehi $$24 = $$3.e($$13.a((double)$$22));
                  float $$25 = this.df();
                  float $$26 = this.dg();
                  ehd $$27 = new ehd($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  ehi $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  ehi $$28 = $$13.c(new ehi(0.0, 1.0, 0.0));
                  ehi $$29 = $$28.a((double)($$25 * 0.5F));
                  ehi $$30 = $$23.d($$29);
                  ehi $$31 = $$24.d($$29);
                  ehi $$32 = $$23.e($$29);
                  ehi $$33 = $$24.e($$29);
                  Iterable<eib> $$34 = this.dK().d(this, $$27);
                  Iterator<ehd> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean b(ehi $$0) {
      ...
      double $$2 = (double)ars.a($$1);
      double $$3 = (double)ars.b($$1);
      double $$4 = (double)this.bk * $$3 - (double)this.bm * $$2;
      double $$5 = (double)this.bm * $$3 + (double)this.bk * $$2;
      double $$6 = ars.k($$4) + ars.k($$5);
      double $$7 = ars.k($$0.c) + ars.k($$0.e);
   ...
   private boolean H() {
      return !this.bX() && this.J() && this.K() && !this.fl() && !this.a(bia.o) && (!this.bN() || this.c(this.cY())) && !this.fu();
   }

   private boolean c(bil $$0) {
      return $$0.dD() && $$0.cW();
   }
   ...
   public float z() {
      if (!this.a(apt.a)) {
         ...
         if ((float)this.cZ >= 600.0F) {
            ...
            float $$2 = ars.a((float)this.cZ / 100.0F, 0.0F, 1.0F);
            float $$3 = (float)this.cZ < 100.0F ? 0.0F : ars.a(((float)this.cZ - 100.0F) / 500.0F, 0.0F, 1.0F);
   ...
   protected boolean fJ() {
      ...
      if (this.G_()) {
         ...
         if (!$$0 && $$1) {
            this.dK().a(this.dp(), this.dr(), this.dv(), aoz.x, apa.i, 1.0F, 1.0F, false);
            this.cn.ai().a((gch)(new gck.b(this)));
         }

         if ($$0 && !$$1) {
            this.dK().a(this.dp(), this.dr(), this.dv(), aoz.y, apa.i, 1.0F, 1.0F, false);
         }
   ...
   public ehi q(float $$0) {
      if (this.cn.m.av().a()) {
         float $$1 = ars.i($$0 * 0.5F, this.dA(), this.N) * (float) (Math.PI / 180.0);
         float $$2 = ars.i($$0 * 0.5F, this.dC(), this.O) * (float) (Math.PI / 180.0);
         double $$3 = this.fk() == biv.b ? -1.0 : 1.0;
         ehi $$4 = new ehi(0.39 * $$3, -0.6, 0.3);
