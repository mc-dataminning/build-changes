...
public class fnb extends fnq {
   ...
   fnb(fjr $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public float b(float $$0) {
      return this.D * asy.a(((float)this.s + $$0) / (float)this.t * 0.75F, 0.0F, 1.0F);
   }

   @Override
   public void a(eml $$0, eqz $$1, float $$2) {
      if (this.G <= 0) {
         this.y = 1.0F - asy.a(((float)this.s + $$2) / (float)this.t, 0.0F, 1.0F);
   ...
   private void a(eml $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
   ...
   public static class a implements fmt<ju> {
      private final fnl a;
      ...
      public fmq a(ju $$0, fjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fnb $$8 = new fnb($$1, $$2, $$3, $$4, $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
