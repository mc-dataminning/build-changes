...
public class fnb extends fmt<cpf> implements fox {
   private float D;
   private float E;
   private final foq F = new foq();
   private boolean G;
   private boolean H;

   public fnb(clh $$0) {
      super($$0.cb, $$0.ga(), wu.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void C() {
      if (this.m.q.f()) {
         this.m.a(new fmq(this.m.s, this.m.s.h.y(), this.m.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         ...
         this.c(new ffq(this.z + 104, this.o / 2 - 22, 20, 18, foq.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.n, this.c);
   ...
   public static void a(fer $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bsa $$9) {
   ...
   public static void a(fer $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bsa $$7) {
      $$0.c().a();
