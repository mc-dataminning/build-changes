...
public class fsu {
   ...
   private final fpo g;
   final Map<UUID, ftj> h = Maps.newLinkedHashMap();
   ...
   private void a(fsh $$0, int $$1, int $$2, btw $$3) {
   ...
   private void a(fsh $$0, int $$1, int $$2, btw $$3, int $$4, alg[] $$5, alg[] $$6) {
      $$0.a(gqx::H, $$5[$$3.l().ordinal()], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      if ($$3.m() != btw.b.a) {
         $$0.a(gqx::H, $$6[$$3.m().ordinal() - 1], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      }
   }
   ...
   public void a(acd $$0) {
      $$0.a(new acd.b() {
         ...
         public void a(UUID $$0, wy $$1, float $$2, btw.a $$3, btw.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fsu.this.h.put($$0, new ftj($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
