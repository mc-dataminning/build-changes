...
public class fsu extends frz {
   ...
   public fsu(frm $$0, int $$1, int $$2, int $$3, int $$4, wy $$5, wy $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.n = $$0;
      this.o = $$5;
      this.p = new fsx($$0, $$3 - this.b());
      this.p.a(this::r);
   }
   ...
   @Override
   public void a(fvz $$0) {
      $$0.a(fvy.a, wy.a("gui.narrate.editBox", this.B(), this.q()));
   }
   ...
   private void r() {
      double $$0 = this.g();
      fsx.a $$1 = this.p.c((int)($$0 / 9.0));
      if (this.p.d() <= $$1.a()) {
         $$0 = (double)(this.p.g() * 9);
      } else {
         fsx.a $$2 = this.p.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.p.d() > $$2.b()) {
