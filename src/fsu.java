...
public class fsu extends fob {
   ...
   private final flx M = new flx(this);
   @Nullable
   private final fob N;
   fst O;
   fit P;
   private String Q = "";
   private fsu.a R = fsu.a.a;
   private fik S;
   private fik T;
   private fik U;
   private fik V;
   ...
   protected void aT_() {
      this.M.a(c, this.o);
      this.O = new fst(this, this.l, this.m, this.C() - 88, 88, 36);
      int $$0 = this.O.b() / 3;
      int $$1 = this.O.s();
      int $$2 = this.O.t();
      this.S = this.c(fik.a(u, $$0x -> this.a(fsu.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fik.a(v, $$0x -> this.a(fsu.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fik.a(w, $$0x -> this.a(fsu.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fit(this.o, this.D() + 28, 74, 200, 15, A) {
         @Override
         protected xn aQ_() {
            return !fsu.this.P.a().isEmpty() && fsu.this.O.c() ? super.aQ_().f(", ").b(fsu.B) : super.aQ_();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fik.a(E, fmy.b(this, axj.o)).a(this.m / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fik.a(wy.d, $$0x -> this.d()).a(200).a());
      this.M.a($$1x -> {
