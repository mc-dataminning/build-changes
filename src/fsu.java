...
public abstract class fsu<E extends fsu.a<E>> extends fsr {
   ...
   protected final fpt c;
   protected final int d;
   private final List<E> n = new fsu.b();
   ...
   public fsu(fpt $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wx.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fsu(fpt $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(fsm $$0) {
      alg $$1 = this.c.s == null ? fys.h : fys.j;
      alg $$2 = this.c.s == null ? fys.i : fys.k;
      $$0.a(grc::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(grc::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(fsm $$0) {
      alg $$1 = this.c.s == null ? a : m;
      $$0.a(grc::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(fsm $$0) {
   ...
   @Override
   public Optional<fux> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fxf $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fxf $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fwv.a w() {
      if (this.aJ_()) {
         ...
         return this.q != null ? fwv.a.b : fwv.a.a;
      }
   }
   ...
   protected void a(fwx $$0, E $$1) {
      List<E> $$2 = this.aE_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fww.b, wy.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fsu.a<E>> implements fux {
      @Deprecated
      fsu<E> a;
      ...
      public abstract void a(fsm var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
