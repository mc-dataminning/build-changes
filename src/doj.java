...
public class doj extends dnw<dpt> {
   public doj(Codec<dpt> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? arw.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(asc $$0, cpw $$1, int $$2, int $$3, gw $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, gw $$2, cpw $$3, boolean $$4, double $$5, gw $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cpw $$0, gw $$1) {
      if ($$0.a_($$1.c()).a(csw.dN)) {
         this.a($$0, $$1.c(), csw.a.n());
      }
   }

   private void a(cpw $$0, asc $$1, gw $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dfj $$13) {
   ...
   private void a(gw $$0, cpw $$1, asc $$2, int $$3, int $$4, boolean $$5, boolean $$6, dfj $$7) {
      dfj $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(csw.dP) || $$8.a(csw.dO) || $$8.a(csw.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(csw.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, csw.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, gw $$2, int $$3, asc $$4) {
      float $$5 = 10.0F * arw.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(asc $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(asc $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dfj $$0) {
      return $$0.a(csw.iC) || $$0.a(csw.dP) || $$0.a(csw.mW);
   }
   ...
   private void a(cpw $$0, gw $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(csw.dN)) {
                  if (this.a((cpb)$$0, $$10)) {
                     this.a($$0, $$10, csw.a.n());
                     this.a($$0, $$10.c(), csw.a.n());
                  } else if (c($$11)) {
                     dfj[] $$12 = new dfj[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
