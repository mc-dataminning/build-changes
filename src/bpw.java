public abstract class bpw extends bpq {
   protected static final float bW = 0.0F;

   protected bpw(bpc<? extends bpw> $$0, cwz $$1) {
      super($$0, $$1);
   }
   ...
   public boolean gk() {
      if (this.bC.a(byr.Z)) {
         return this.bC.c(byr.Z).isPresent();
      } else {
         for (bxz $$0 : this.bR.b()) {
            if ($$0.h() && $$0.k() instanceof bxe) {
               return true;
            }
         }
   ...
   protected void ga() {
      ...
      if ($$0 != null && $$0.dM() == this.dM()) {
         this.a($$0.dm(), 5);
         float $$1 = this.f($$0);
         if (this instanceof bqk && ((bqk)this).y()) {
            if ($$1 > 10.0F) {
               this.a(true, true);
            }
         ...
         if ($$1 > 10.0F) {
            ...
            this.bR.b(bwl.a.a);
            float $$5 = 2.0F;
            epr $$6 = new epr($$0.dr() - this.dr(), $$0.dt() - this.dt(), $$0.dx() - this.dx()).d().a((double)Math.max($$1 - 2.0F, 0.0F));
