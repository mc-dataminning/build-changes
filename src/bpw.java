...
public class bpw implements bpp {
   ...
   public static Set<bpn> a() {
      Builder<bpn> $$0 = ImmutableSet.builder();

      try {
         bpw.a $$1 = new bpw.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bpn.a("cpu#" + $$1x, bpm.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bpn.a("heap MiB", bpm.e, () -> (double)ac.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bpo.a.a());
      return $$0.build();
   }
   ...
   public static bpn a(final LongSupplier $$0) {
      ...
      bpn.d $$3 = new bpn.d(2.0F);
      return bpn.a("ticktime", bpm.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
