...
public class bpw extends bqb {
   ...
   public boolean a() {
      ...
      for (cdn $$2 : $$0) {
         biq $$3 = $$2.cN();
         if ($$3 instanceof cbu && (arw.e(((cbu)$$3).bk) > 0.0F || arw.e(((cbu)$$3).bm) > 0.0F)) {
            $$1 = true;
            break;
         }
      }

      return this.c != null && (arw.e(this.c.bk) > 0.0F || arw.e(this.c.bm) > 0.0F) || $$1;
   }
   ...
   @Override
   public boolean b() {
      return this.c != null && this.c.bN() && (arw.e(this.c.bk) > 0.0F || arw.e(this.c.bm) > 0.0F);
   }
   ...
   @Override
   public void e() {
      boolean $$0 = arw.e(this.c.bk) > 0.0F || arw.e(this.c.bm) > 0.0F;
