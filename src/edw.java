...
public class edw implements eew<bwi> {
   ...
   public edw(eeh $$0, arq $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
   ...
   @Override
   public CompletableFuture<eer<bwi>> a(dio $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               try {
                  dio $$2 = ((tz)$$1x.get()).<dio>a("Position", dio.a).orElseThrow();
   ...
   private static eer<bwi> b(dio $$0) {
      return new eer<>($$0, ImmutableList.of());
   }

   @Override
   public void a(eer<bwi> $$0) {
      dio $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
         ...
         tz $$3 = uo.e(new tz());
         $$3.a("Entities", $$2);
         $$3.a("Position", dio.a, $$1);
         this.a(this.e.a($$1, $$3), $$1);
         this.f.remove($$1.a());
      }
   }

   private void a(CompletableFuture<?> $$0, dio $$1) {
      $$0.exceptionally($$1x -> {
   ...
   private void b(CompletableFuture<?> $$0, dio $$1) {
      $$0.exceptionally($$1x -> {
