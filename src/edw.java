...
public class edw {
   ...
   private final Map<String, edl> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public edw(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends edl> T a(edl.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends edl> T b(edl.a $$0, String $$1) {
      edl $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends edl> T a(Function<rz, T> $$0, aun $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
            rz $$4 = this.a($$2, $$1, aa.b().d().c());
   ...
   public void a(String $$0, edl $$1) {
      this.b.put($$0, $$1);
   }

   public rz a(String $$0, aun $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
