...
public class edw {
   ...
   private final dgl o;
   private static final List<djn> p = List.of(djp.l, djp.O, djp.i, djp.b, djp.k, djp.L, djp.N, djp.fA, djp.ec, djp.iY, djp.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jr<dhl>>> s;
   private final transient double[][] t;

   private edw(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> af.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jr<dhl>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kk.c($$0);
      int $$5 = kk.c($$1) - $$4;
   ...
   @Nullable
   public static edw a(@Nullable edw.d $$0) {
      return $$0 == null ? null : new edw($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public edw.d a() {
      ...
      return new edw.d(this.o.ap(), this.o.aq() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static edw a(arl $$0, int $$1, int $$2) {
      dyt $$3 = $$0.a($$1, $$2);
      edw $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(dzu.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jo> a(dhh $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dyt $$1, int $$2, int $$3) {
   ...
   private int a(dyt $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ect.a.a)) {
         $$3 = Math.min($$0.a(ect.a.a, $$1, $$2), this.o.an());
      } else {
         $$3 = this.o.an();
      }
   ...
   private static double a(dyt $$0, ji.a $$1) {
      return a($$0, (ji)$$1.c(jn.a)) ? 1.0 : -1.0;
   }

   private static double b(dyt $$0, ji.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dyt $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jr<dhl>> b(dyt $$0, int $$1, int $$2) {
      ObjectArrayList<jr<dhl>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dyt $$0, ji $$1) {
      dwy $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(awp.Q)) {
         ...
         return $$2.a(djp.fh) || $$2.a(djp.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, edw.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, edw.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jr<dhl> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<edw.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(edw.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(edw.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(edw.d::c)
                  )
                  .apply($$0, edw.d::new)
         )
         .validate(edw.d::a);

      private static DataResult<edw.d> a(edw.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != edw.n
            ? DataResult.error(() -> "heights has to be of length " + edw.n)
