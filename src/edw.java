...
public class edw extends edq<efv> {
   private static final jj[] a = jj.values();

   public edw(Codec<efv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eds<efv> $$0) {
      efv $$1 = $$0.f();
      azl $$2 = $$0.d();
      je $$3 = $$0.e();
      dfd $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      ebj $$9 = new ebj(new eal($$4.C()));
      eps $$10 = eps.a($$9, -4, 1.0);
      ...
      for (je $$33 : je.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<je, Integer> $$37 : $$7) {
            $$35 += azd.f($$33.j((ki)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (je $$38 : $$11) {
            $$36 += azd.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, dhl.a.o(), $$32);
      ...
      for (je $$44 : $$31) {
         ...
         for (jj $$46 : a) {
            ...
            duo $$48 = $$4.a_($$47);
            if ($$45.b(dve.C)) {
               $$45 = $$45.b(dve.C, Boolean.valueOf($$48.y().b()));
            }
