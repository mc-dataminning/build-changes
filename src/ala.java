...
public final class ala<E> implements Codec<ji<E>> {
   private final ald<? extends jv<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> ala<E> a(ald<? extends jv<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> ala<E> a(ald<? extends jv<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new ala<>($$0, $$1, $$2);
   }

   private ala(ald<? extends jv<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
