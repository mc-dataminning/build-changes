...
public class dgm {
   public static final dgm a = new dgm(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<dgm> b = RecordCodecBuilder.create(
   ...
   public dgm(List<String> $$0, List<String> $$1) {
