...
public interface dgm extends dhj {
   int g = 16;
   ...
   default fbt a(dgo $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dxu $$2 = this.a_($$1);
         fbx $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new fbt($$0x.a(), jm.a($$3.d, $$3.e, $$3.f), jh.a((ka)$$0x.a()), false) : null;
      }, $$0x -> {
         fbx $$1 = $$0x.b().d($$0x.a());
         return fbt.a($$0x.a(), jm.a($$1.d, $$1.e, $$1.f), jh.a((ka)$$0x.a()));
      });
   }
   ...
   @Nullable
   default fbt a(fbx $$0, fbx $$1, jh $$2, fcr $$3, dxu $$4) {
      fbt $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         fbt $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(fcr $$0, Supplier<fcr> $$1) {
      if (!$$0.c()) {
         return $$0.c(jm.a.b);
      } else {
   ...
   static <T, C> T a(fbx $$0, fbx $$1, C $$2, BiFunction<C, jh, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<jh> a(fbx $$0, fbx $$1, fbs $$2) {
      fbx $$3 = $$1.d($$0);
   ...
   private static void a(Set<jh> $$0, fbx $$1, fbx $$2, fbs $$3) {
      fbx $$4 = $$2.d($$1);
      int $$5 = bae.a($$1.d);
      int $$6 = bae.a($$1.e);
      int $$7 = bae.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<fbx> $$18 = fbs.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            fbx $$19 = $$18.get();
