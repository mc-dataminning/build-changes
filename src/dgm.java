...
public record dgm(alg d) implements dgc {
   private static final Logger e = LogUtils.getLogger();
   public static final MapCodec<dgm> a = RecordCodecBuilder.mapCodec($$0 -> $$0.group(alg.a.fieldOf("function").forGetter(dgm::b)).apply($$0, dgm::new));
