...
public class gch extends gcd {
   ...
   gch(fxw $$0, double $$1, double $$2, double $$3, dxa $$4, int $$5) {
      super($$0, $$1, $$2, $$3, 0.0, 0.0, 0.0);
      this.D = 0.3F;
      this.a = $$4;
      this.t = $$5;
      Optional<evs> $$6 = $$4.a($$0);
      if ($$6.isPresent()) {
         evs $$7 = $$6.get();
         double $$8 = $$1 - $$7.a();
         double $$9 = $$2 - $$7.b();
   ...
   public void a(fad $$0, fer $$1, float $$2) {
      ...
      float $$4 = ayz.i($$2, this.F, this.b);
      float $$5 = ayz.i($$2, this.H, this.G) + (float) (Math.PI / 2);
      this.a($$0, $$1, $$2, $$3x -> $$3x.rotateY($$4).rotateX(-$$5).rotateY($$3));
      this.a($$0, $$1, $$2, $$3x -> $$3x.rotateY((float) -Math.PI + $$4).rotateX($$5).rotateY($$3));
   }

   private void a(fad $$0, fer $$1, float $$2, Consumer<Quaternionf> $$3) {
      evs $$4 = $$1.b();
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         Optional<evs> $$0 = this.a.a(this.c);
         if ($$0.isEmpty()) {
            this.k();
         } else {
            int $$1 = this.t - this.s;
   ...
   public static class a implements gbg<ln> {
      private final gby a;
      ...
      public gbd a(ln $$0, fxw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gch $$8 = new gch($$1, $$2, $$3, $$4, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
