...
public class gch {
   ...
   public static class a extends Thread {
      private final gch.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gch.b $$0) throws IOException {
         super("LanServerDetector #" + gch.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gch.b));
   ...
   public static class b {
      private final List<gcg> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gcg> a() {
         if (this.b) {
            List<gcg> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
