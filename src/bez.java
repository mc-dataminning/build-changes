...
public class bez extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(bhm.D.typeName(), biz.a()));
      Type<Pair<String, String>> $$1 = DSL.named(bhm.D.typeName(), biz.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(bhm.t),
         this.getOutputSchema().getType(bhm.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(bhm.D.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
