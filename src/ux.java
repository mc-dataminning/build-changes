...
public class ux implements to {
   public static final Object[] b = new Object[0];
   private static final tr c = tr.e("%");
   private static final tr d = tr.e("null");
   ...
   @Nullable
   private qt h;
   private List<tr> i = ImmutableList.of();
   private static final Pattern j = Pattern.compile("%(?:(\\d+)\\$)?([A-Za-z%]|$)");

   public ux(String $$0, @Nullable String $$1, Object[] $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   private void d() {
      ...
      if ($$0 != this.h) {
         ...
         try {
            Builder<tr> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.i = $$2.build();
         } catch (uy var4) {
            this.i = ImmutableList.of(tr.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<tr> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new uy(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private tr a(int $$0) {
      if ($$0 >= 0 && $$0 < this.g.length) {
         ...
         if ($$1 instanceof tn) {
            ...
            return $$1 == null ? d : tr.e($$1.toString());
         }
      } else {
         throw new uy(this, $$0);
      }
   ...
   public ua a(@Nullable dt $$0, @Nullable bis $$1, int $$2) throws CommandSyntaxException {
      ...
      return ua.a(new ux(this.e, this.f, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ux $$1 && Objects.equals(this.e, $$1.e) && Objects.equals(this.f, $$1.f) && Arrays.equals(this.g, $$1.g)) {
            return true;
         }
