...
public class ux<T> {
   ...
   public static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(wy.c("argument.nbt.expected.compound"));
   ...
   public static final Codec<tz> i = Codec.STRING.comapFlatMap($$0 -> {
      try {
         uw $$1 = a(un.a, $$0);
   ...
   public static final Codec<tz> j = Codec.withAlternative(i, tz.a);
   private final DynamicOps<T> v;
   private final StringReader w;

   private static tz a(StringReader $$0, uw $$1) throws CommandSyntaxException {
      if ($$1 instanceof tz) {
         return (tz)$$1;
      } else {
   ...
   public static <T> T b(DynamicOps<T> $$0, StringReader $$1) throws CommandSyntaxException {
      return new ux<T>($$0, $$1).c();
   }

   public static tz a(StringReader $$0) throws CommandSyntaxException {
      uw $$1 = b(un.a, $$0);
      return a($$0, $$1);
   }

   private ux(DynamicOps<T> $$0, StringReader $$1) {
      this.v = $$0;
      this.w = $$1;
   }
