...
public class ccb extends ccf {
   ...
   private static final adz<Integer> g = aec.a(ccb.class, aeb.b);
   private static final adz<Boolean> h = aec.a(ccb.class, aeb.k);
   private int i;
   private int j;
   private int k;
   private int l;
   ...
   @Nullable
   private bii o;
   private ccb.a p = ccb.a.a;
   private final int q;
   private final int r;

   private ccb(bim<? extends ccb> $$0, cpm $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.at = true;
      this.q = Math.max(0, $$2);
      this.r = Math.max(0, $$3);
   ...
   public ccb(bim<? extends ccb> $$0, cpm $$1) {
      this($$0, $$1, 0, 0);
   }

   public ccb(cbn $$0, cpm $$1, int $$2, int $$3) {
      this(bim.bu, $$1, $$2, $$3);
      this.b($$0);
      float $$4 = $$0.dC();
      float $$5 = $$0.dA();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      ehe $$13 = new ehe((double)(-$$7), (double)arp.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
   ...
   public void l() {
      ...
      if ($$0 == null) {
         ...
         this.B();
         if (this.p == ccb.a.a && (this.aA() || this.P)) {
            this.f(ehe.b);
         }
   ...
   private boolean a(cbn $$0) {
      ciy $$1 = $$0.eR();
      ciy $$2 = $$0.eS();
      boolean $$3 = $$1.a(cjb.qh);
      boolean $$4 = $$2.a(cjb.qh);
   ...
   protected boolean a(bii $$0) {
      return super.a($$0) || $$0.bv() && $$0 instanceof byg;
   }
   ...
   private boolean b(gu $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         ccb.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case c:
               return false;
            case a:
   ...
   private ccb.b a(gu $$0, gu $$1) {
      return gu.b($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : ccb.b.c).orElse(ccb.b.c);
   }

   private ccb.b c(gu $$0) {
      dfa $$1 = this.dK().a_($$0);
      if (!$$1.i() && !$$1.a(csn.fm)) {
         ead $$2 = $$1.u();
         return $$2.a(apq.a) && $$2.b() && $$1.k(this.dK(), $$0).c() ? ccb.b.b : ccb.b.c;
      } else {
         return ccb.b.a;
      }
   }
   ...
   public int a(ciy $$0) {
      ...
      if (!this.dK().B && $$1 != null && !this.a($$1)) {
         ...
         if (this.o != null) {
            ...
            $$2 = this.o instanceof byg ? 3 : 5;
         } else if (this.j > 0) {
            ecn $$3 = new ecn.a((akk)this.dK()).a(ees.f, this.di()).a(ees.i, $$0).a(ees.a, this).a((float)this.q + $$1.gm()).a(eer.f);
            ecp $$4 = this.dK().n().aH().getLootTable(ecf.ai);
            List<ciy> $$5 = $$4.a($$3);
            ai.D.a((akl)$$1, $$0, this, $$5);

            for (ciy $$6 : $$5) {
               byg $$7 = new byg(this.dK(), this.dp(), this.dr(), this.dv(), $$6);
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dK().B && this.o instanceof cbn && ((cbn)this.o).g()) {
         this.c(this.o);
      }
   ...
   protected void c(bii $$0) {
      bii $$1 = this.v();
      if ($$1 != null) {
         ehe $$2 = new ehe($$1.dp() - this.dp(), $$1.dr() - this.dr(), $$1.dv() - this.dv()).a(0.1);
         $$0.f($$0.dn().e($$2));
      }
   }
   ...
   public cbn m() {
      bii $$0 = this.v();
      return $$0 instanceof cbn ? (cbn)$$0 : null;
   }
