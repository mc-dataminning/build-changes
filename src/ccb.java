public abstract class ccb extends ccm {
   public double b;
   public double c;
   public double d;

   protected ccb(biu<? extends ccb> $$0, cpv $$1) {
      super($$0, $$1);
   }
   ...
   public ccb(biu<? extends ccb> $$0, bjg $$1, double $$2, double $$3, double $$4, cpv $$5) {
   ...
   public vd<ww> di() {
      biq $$0 = this.v();
      int $$1 = $$0 == null ? 0 : $$0.ah();
      return new wx(this.ah(), this.cv(), this.dq(), this.ds(), this.dw(), this.dD(), this.dB(), this.ag(), $$1, new ehn(this.b, this.c, this.d), 0.0);
   }
