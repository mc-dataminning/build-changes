...
public class akr extends ats {
   private static final Logger a = LogUtils.getLogger();
   private static final Gson b = new GsonBuilder().create();
   private Map<akf, af> c = Map.of();
   private ak d = new ak();
   private final ix.a e;
   private final eod f;

   public akr(ix.a $$0, eod $$1) {
   ...
   protected void a(Map<akf, JsonElement> $$0, ato $$1, ble $$2) {
      akd<JsonElement> $$3 = this.e.a(JsonOps.INSTANCE);
      Builder<akf, af> $$4 = ImmutableMap.builder();
      $$0.forEach(($$2x, $$3x) -> {
         try {
