...
public final class akr<E> implements Codec<jr<E>> {
   ...
   public static <E> akr<E> a(aku<? extends ke<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> akr<E> a(aku<? extends ke<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new akr<>($$0, $$1, $$2);
   }

   private akr(aku<? extends ke<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(jr<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof akt<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> akv.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
   ...
   public <T> DataResult<Pair<jr<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof akt<?> $$2) {
         ...
         if ($$3.isEmpty()) {
            ...
            js<E> $$4 = $$3.get();
            DataResult<Pair<akv, T>> $$5 = akv.a.decode($$0, $$1);
            if ($$5.result().isEmpty()) {
               return !this.c ? DataResult.error(() -> "Inline definitions not allowed here") : this.b.decode($$0, $$1).map($$0x -> $$0x.mapFirst(jr::a));
            } else {
               Pair<akv, T> $$6 = (Pair<akv, T>)$$5.result().get();
               aku<E> $$7 = aku.a(this.a, (akv)$$6.getFirst());
               return $$4.a($$7)
