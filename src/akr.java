...
public class akr {
   ...
   static final ayi c = new ayi();
   private final akq d;
   private final akr.b<?>[] e;
   private boolean f;
   ...
   public static <T> akn<T> a(Class<? extends akq> $$0, ako<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> akr.b<T> b(akn<T> $$0) {
      return (akr.b<T>)this.e[$$0.a()];
   }

   public <T> T a(akn<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(akn<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(akn<T> $$0, T $$1, boolean $$2) {
      akr.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(akr.b<T> $$0, akr.c<?> $$1) {
   ...
   public static class a {
      ...
      public a(akq $$0) {
         this.a = $$0;
         this.b = new akr.b[akr.c.b($$0.getClass())];
      }

      public <T> akr.a a(akn<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public akr.c<T> e() {
         return akr.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, ako<T> b, T c) {

      public static <T> akr.c<T> a(akn<T> $$0, T $$1) {
         ako<T> $$2 = $$0.b();
         return new akr.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static akr.c<?> a(wn $$0, int $$1) {
         int $$2 = $$0.l();
         ako<?> $$3 = akp.a($$2);
         if ($$3 == null) {
      ...
      private static <T> akr.c<T> a(wn $$0, int $$1, ako<T> $$2) {
         return new akr.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
