...
public class dqt {
   ...
   public static final Codec<dqt> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               c.lenientOptionalFieldOf("filtered_messages").forGetter(dqt::d),
               ctj.q.fieldOf("color").orElse(ctj.p).forGetter($$0x -> $$0x.f),
   ...
   public dqt() {
      this(c(), c(), ctj.p, false);
   }

   public dqt(xp[] $$0, xp[] $$1, ctj $$2, boolean $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   private static dqt a(xp[] $$0, Optional<xp[]> $$1, ctj $$2, boolean $$3) {
      return new dqt($$0, $$1.orElse(Arrays.copyOf($$0, $$0.length)), $$2, $$3);
   }
   ...
   public dqt a(boolean $$0) {
      return $$0 == this.g ? this : new dqt(this.d, this.e, this.f, $$0);
   }
   ...
   public dqt a(ctj $$0) {
      return $$0 == this.b() ? this : new dqt(this.d, this.e, $$0, this.g);
   }
   ...
   public dqt a(int $$0, xp $$1) {
      return this.a($$0, $$1, $$1);
   }

   public dqt a(int $$0, xp $$1, xp $$2) {
      xp[] $$3 = Arrays.copyOf(this.d, this.d.length);
      xp[] $$4 = Arrays.copyOf(this.e, this.e.length);
      $$3[$$0] = $$1;
      $$4[$$0] = $$2;
      return new dqt($$3, $$4, this.f, this.g);
   }
