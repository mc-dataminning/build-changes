...
public class dqt implements dqs {
   ...
   public static final Codec<dqt> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dlh.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dlj.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dli.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bhg.b(1, 20).fieldOf("outer_wall_distance").orElse(bhm.a(4, 5)).forGetter($$0x -> $$0x.i),
               bhg.b(1, 20).fieldOf("distribution_points").orElse(bhm.a(3, 4)).forGetter($$0x -> $$0x.j),
               bhg.b(0, 10).fieldOf("point_offset").orElse(bhm.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dqt(dlh $$0, dlj $$1, dli $$2, double $$3, double $$4, boolean $$5, bhg $$6, bhg $$7, bhg $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
