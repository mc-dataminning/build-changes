...
public class dqt extends dph {
   ...
   protected void b(us $$0, jk.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vp)cxr.a.encodeStart(vg.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", xp.a.a(this.m, $$1));
      }
   }
   ...
   protected void a(us $$0, jk.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         cxr.a.parse(vg.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = alf.a($$0.l("note_block_sound"));
      }

      if ($$0.b("custom_name", 8)) {
         this.m = xp.a.a($$0.l("custom_name"), $$1);
      } else {
         this.m = null;
      }
   }

   public static void a(dby $$0, iz $$1, dsc $$2, dqt $$3) {
      if ($$2.b(dmb.a) && $$2.c(dmb.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
   ...
   public static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && azv.f($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
