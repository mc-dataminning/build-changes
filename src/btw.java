...
public class btw implements coz {
   ...
   public int a(akk $$0, boolean $$1, boolean $$2) {
      if (!$$0.N() && $$1) {
         float $$3 = $$0.f(0.0F);
         if ((double)$$3 == 0.5) {
            this.c = $$0.z.a(10) == 0 ? btw.a.b : btw.a.c;
         }
   ...
   private void b(akk $$0) {
      ehe $$1 = this.a($$0, new gu(this.f, this.g, this.h));
      if ($$1 != null) {
         bzu $$2;
         try {
            $$2 = new bzu($$0);
   ...
   @Nullable
   private ehe a(akk $$0, gu $$1) {
      for (int $$2 = 0; $$2 < 10; $$2++) {
         int $$3 = $$1.u() + $$0.z.a(16) - 8;
         int $$4 = $$1.w() + $$0.z.a(16) - 8;
         int $$5 = $$0.a(dkj.a.b, $$3, $$4);
         gu $$6 = new gu($$3, $$5, $$4);
         if ($$0.b($$6) && bzb.b(bim.bp, $$0, bjc.h, $$6, $$0.z)) {
            return ehe.c($$6);
         }
      }
