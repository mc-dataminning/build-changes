...
public class cxu {
   ...
   public boolean a(dfj $$0, cpb $$1, gw $$2, hc $$3) {
   ...
   public Optional<cxu.c> a(dfj $$0, cpw $$1, gw $$2, hc $$3, asc $$4, boolean $$5) {
      return hc.a($$4).stream().map($$5x -> this.a($$0, $$1, $$2, $$3, $$5x, $$5)).filter(Optional::isPresent).findFirst().orElse(Optional.empty());
   }

   private long a(dfj $$0, cpw $$1, gw $$2, hc $$3, boolean $$4) {
      return hc.a().map($$5 -> this.a($$0, $$1, $$2, $$3, $$5, $$4)).filter(Optional::isPresent).count();
   }

   @VisibleForTesting
   public Optional<cxu.c> a(dfj $$0, cpw $$1, gw $$2, hc $$3, hc $$4, boolean $$5) {
      return this.a($$0, $$1, $$2, $$3, $$4, this.b::a).flatMap($$2x -> this.a($$1, $$2x, $$5));
   }

   public Optional<cxu.c> a(dfj $$0, cpb $$1, gw $$2, hc $$3, hc $$4, cxu.d $$5) {
      if ($$4.o() == $$3.o()) {
   ...
   public static class a implements cxu.b {
      ...
      @Nullable
      @Override
      public dfj a(dfj $$0, cpb $$1, gw $$2, hc $$3) {
         return this.a.c($$0, $$1, $$2, $$3);
      }

      protected boolean a(cpb $$0, gw $$1, gw $$2, hc $$3, dfj $$4) {
   ...
   public interface b {
      @Nullable
      dfj a(dfj var1, cpb var2, gw var3, hc var4);
   ...
   public static enum e {
      ...
      public abstract cxu.c a(gw var1, hc var2, hc var3);
   }
}
