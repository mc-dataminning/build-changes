...
public class aoy {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xa.c("commands.schedule.same_tick"));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> xa.b("commands.schedule.cleared.failure", $$0));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xa.b("commands.schedule.macro"));
   ...
   private static int a(ej $$0, Pair<ali, Either<hx<ej>, Collection<hx<ej>>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.e().ae() + (long)$$2;
         ali $$5 = (ali)$$1.getFirst();
         ffd<MinecraftServer> $$6 = $$0.l().aZ().I().s();
         ...
         if ($$7.isPresent()) {
            ...
            $$6.a($$8, $$4, new fez($$5));
            $$0.a(() -> xa.a("commands.schedule.created.function", xa.a($$5), $$2, $$4), true);
         } else {
            String $$9 = "#" + $$5;
            if ($$3) {
               $$6.a($$9);
            ...
            $$6.a($$9, $$4, new ffa($$5));
            $$0.a(() -> xa.a("commands.schedule.created.tag", xa.a($$5), $$2, $$4), true);
         }
   ...
   private static int a(ej $$0, String $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         $$0.a(() -> xa.a("commands.schedule.cleared.success", $$2, $$1), true);
         return $$2;
      }
   }
}
