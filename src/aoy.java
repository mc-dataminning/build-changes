...
public class aoy {
   ...
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xl.b("commands.schedule.macro"));
   ...
   private static int a(ew $$0, Pair<all, Either<ik<ew>, Collection<ik<ew>>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.e().aa() + (long)$$2;
         all $$5 = (all)$$1.getFirst();
         eze<MinecraftServer> $$6 = $$0.l().aZ().I().s();
