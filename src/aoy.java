...
public class aoy {
   ...
   private static int a(ex $$0, Collection<? extends bum> $$1, String $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.tag.add.success.single", $$2, $$1.iterator().next().p_()), true);
         } else {
   ...
   private static int b(ex $$0, Collection<? extends bum> $$1, String $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.tag.remove.success.single", $$2, $$1.iterator().next().p_()), true);
         } else {
   ...
   private static int a(ex $$0, Collection<? extends bum> $$1) {
      ...
      if ($$1.size() == 1) {
         ...
         if ($$2.isEmpty()) {
            ...
            $$0.a(() -> wp.a("commands.tag.list.single.success", $$4.p_(), $$2.size(), ws.a($$2)), false);
         }
      } else if ($$2.isEmpty()) {
