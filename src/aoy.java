...
public class aoy extends aox {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aoy.a> s;
   private final aot t;
   private long u;
   private final afo v;

   private aoy(afo $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aou.c($$2, 7, $$0.getLength());
      }
   }
