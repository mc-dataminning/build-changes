...
public class aoy implements aov {
   ...
   private final Map<aow, List<Path>> g;

   aoy(aop $$0, Set<String> $$1, List<Path> $$2, Map<aow, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aow $$0, ahg $$1, Consumer<Path> $$2) {
   ...
   public void a(aow $$0, String $$1, String $$2, aov.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ahg, apz<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aov.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aox.a($$1, $$4, $$3, $$0);
   }
   ...
   public apz<InputStream> a(aow $$0, ahg $$1) {
      return (apz<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aox.a($$5)) {
               return apz.create($$5);
            }
         }
   ...
   public <T> T a(aph<T> $$0) {
      apz<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public aqk c() {
      return $$0 -> Optional.ofNullable(this.a(aow.a, $$0)).map($$0x -> new aqf(this, $$0x));
   }
}
