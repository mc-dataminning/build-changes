...
public class aoy {
   ...
   private static int a(et $$0, eyd $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends btj> $$6) throws CommandSyntaxException {
      arg $$7 = $$0.e();
      int $$8 = $$7.G_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         aoy.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
   ...
   private static int a(Collection<? extends btj> $$0) {
      Set<ezk> $$1 = Sets.newHashSet();
   ...
   private static void a(eyd $$0, double $$1, arg $$2, azk $$3, double $$4, double $$5, double $$6, double $$7, int $$8, aoy.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends btj> $$0, arg $$1, aoy.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ezk, aoy.a> $$7 = Maps.newHashMap();

      for (btj $$8 : $$0) {
         aoy.a $$10;
         if ($$4) {
            ezk $$9 = $$8 instanceof cnp ? $$8.co() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)azc.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)azc.a($$10.b) + 0.5, Set.of(), $$8.dI(), $$8.dK(), true);
   ...
   private static aoy.a[] a(azk $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aoy.a[] $$6 = new aoy.a[$$1];
   ...
   static class a {
      ...
      public boolean b(dcx $$0, int $$1) {
         je $$2 = je.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dua $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.n() && !$$3.a(aws.aL);
      }

      public void a(azk $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = azc.a($$0, $$1, $$3);
         this.b = azc.a($$0, $$2, $$4);
      }
   }
