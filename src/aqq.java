...
public class aqq<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqq.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqq.this.remove(this.b + 1);
      }
   }
}
