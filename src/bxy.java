...
public class bxy extends byb {
   private final brg a;
   private final Predicate<brg> b;
   @Nullable
   private brg c;
   ...
   public bxy(brg $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<brg> $$0 = this.a.dN().a(brg.class, this.a.cI().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (brg $$1 : $$0) {
            if (!$$1.cf()) {
               this.c = $$1;
