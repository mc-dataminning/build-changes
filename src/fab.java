...
public class fab implements AutoCloseable {
   ...
   private fad a(ezt.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(ezt.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, gec $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, gec $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.n != null && (this.i == fad.b.a || this.i == fad.b.b)) {
