...
public class fab extends ezi<cfd> {
   private static final aew[] E = new aew[]{
      new aew("container/enchanting_table/level_1"), new aew("container/enchanting_table/level_2"), new aew("container/enchanting_table/level_3")
   };
   private static final aew[] F = new aew[]{
      new aew("container/enchanting_table/level_1_disabled"),
      new aew("container/enchanting_table/level_2_disabled"),
      new aew("container/enchanting_table/level_3_disabled")
   };
   private static final aew G = new aew("container/enchanting_table/enchantment_slot_disabled");
   private static final aew H = new aew("container/enchanting_table/enchantment_slot_highlighted");
   private static final aew I = new aew("container/enchanting_table/enchantment_slot");
   private static final aew J = new aew("textures/gui/container/enchanting_table.png");
   private static final aew K = new aew("textures/entity/enchanting_table_book.png");
   ...
   private void d(esf $$0, int $$1, int $$2, float $$3) {
      float $$4 = arw.i($$3, this.D, this.C);
      float $$5 = arw.i($$3, this.z, this.y);
      ekl.c();
      $$0.c().a();
      ...
      float $$8 = arw.a(arw.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = arw.a(arw.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.M.a(0.0F, $$8, $$9, $$4);
