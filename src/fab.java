...
public class fab {
   ...
   private static final Queue<fab.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fab.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fab::a), ezz::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fab::a), ezz::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fab.a(this.b) + ", type=" + fab.b(this.c) + ", severity=" + fab.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
