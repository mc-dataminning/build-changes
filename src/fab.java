...
public class fab extends faf implements fad {
   ...
   public fab.c a() {
      return new fab.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(fal.b $$0, fal $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (fam)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(fal $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == fae.k;
         boolean $$2 = $$0 == fae.j;
   ...
   private IntConsumer a(int $$0, fal.a $$1) {
   ...
   private fab.b q() {
      ...
      this.k += $$5;
      this.j++;
      fab.a $$9 = new fab.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new fab.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fal.b.a || this.q == fal.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fam> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fam $$1 = (fam)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fam.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fam.b.c) {
         fad.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, fad.a($$11));
         this.a($$14 + 5, fad.a($$12));
         this.a($$14 + 6, fad.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fal a, int b, int c, fal.b d, fal.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(fal.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fao $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
