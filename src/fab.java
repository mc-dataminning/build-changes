...
public class fab {
   private final ImmutableList<fac> a;
   private final ImmutableMap<String, fac> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private ezz e;

   public fab(ImmutableMap<String, fac> $$0) {
      this.b = $$0;
