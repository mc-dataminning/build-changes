...
public class cjm extends cjd {
   ...
   public void b() {
      ...
      if (this.e % 2 == 0 && this.e < 10) {
         ...
         for (int $$4 = 0; $$4 < 8; $$4++) {
            ...
            for (int $$8 = 0; $$8 < 6; $$8++) {
               this.a.dS().a(lo.h, $$5, $$6, $$7, -$$0.d * 0.08F * (double)$$8, -$$0.e * 0.6F, -$$0.f * 0.08F * (double)$$8);
            }
   ...
   public void c() {
      ...
      if (this.e >= 200) {
         ...
         $$5 = (double)(azf.a($$5) + 1);
         this.g = new btm(this.a.dS(), $$2, $$5, $$3);
         this.g.a(this.a);
         this.g.a(5.0F);
         this.g.a(200);
         this.g.a(lo.h);
         this.g.a(new bsy(bta.g));
         this.a.dS().b(this.g);
      }
   }
