...
class atl extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atk && $$1 instanceof atk && $$0.equals($$1);
   }
   ...
   private static atk a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atk) {
         return (atk)$$0;
      } else {
