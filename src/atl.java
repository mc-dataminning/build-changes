...
public class atl {
   ...
   private static List<atl.b> a(final Path $$0) throws IOException {
      try {
         final List<atl.b> $$1 = new ArrayList<>();
   ...
   private static List<atl.a> a(List<atl.b> $$0) {
      List<atl.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (atl.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new atl.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<atl.a> a = Comparator.comparing(atl.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<atl.b> a = Comparator.comparing(atl.b::b).reversed();
