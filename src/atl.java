...
public class atl extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(ayp.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(ayp.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(ayp.s);
