...
public class atl extends atf {
   ...
   atl(atn $$0, atl.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atq $$0, alj $$1) {
   ...
   public static class a implements auk.c {
      ...
      @Override
      public ato a(atn $$0) {
         atl.b $$1 = new atl.b(this.a);
         return new atl($$0, $$1, "");
      }

      @Override
      public ato a(atn $$0, auk.a $$1) {
         atl.b $$2 = new atl.b(this.a);
         ato $$3 = new atl($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<ato> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  atl.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
