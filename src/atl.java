...
public class atl implements ath {
   ...
   private final Map<atj, List<Path>> h;

   atl(atg $$0, asz $$1, Set<String> $$2, List<Path> $$3, Map<atj, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(atj $$0, ale $$1, Consumer<Path> $$2) {
      v.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(atj $$0, String $$1, String $$2, ath.a $$3) {
      v.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ale, aun<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(ath.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      atk.a($$1, $$4, $$3, $$0);
   }
   ...
   public aun<InputStream> a(atj $$0, ale $$1) {
      return (aun<InputStream>)v.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && atk.a($$5)) {
               return aun.create($$5);
            }
         }
   ...
   public <T> T a(atu<T> $$0) {
      aun<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public auz d() {
      return $$0 -> Optional.ofNullable(this.a(atj.a, $$0)).map($$0x -> new aut(this, $$0x));
   }
}
