...
public class tr {
                           ...
                           ((LiteralArgumentBuilder)ef.a("clearall").executes($$0x -> l.a($$0x, 200).b()))
                              .then(
                                 ef.a("radius", IntegerArgumentType.integer())
                                    .executes($$0x -> l.a($$0x, ayf.a(IntegerArgumentType.getInteger($$0x, "radius"), 0, 1024)).b())
                              )
                        ))
                     .then(
                        ef.a("import")
   ...
   private static int a(sz $$0) {
      $$0.f().a_(null, $$0.d()).stream().forEach($$0x -> $$0x.a(brw.c.b));
      $$0.e().c($$0.f());
      tp.a($$0.d(), $$0.f());
   ...
   private static Optional<sz> a(io $$0, aqn $$1, tm $$2) {
      dpx $$3 = (dpx)$$1.c_($$0);
      if ($$3 == null) {
   ...
   private static int a(ee $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         aqn $$5 = $$0.e();
         io $$6 = a($$0).d();
         tp.a($$1.toLowerCase(), $$6, new js($$2, $$3, $$4), dkn.a, $$5);
         io $$7 = $$6.c();
         io $$8 = $$7.b($$2 - 1, 0, $$4 - 1);
         io.d($$7, $$8).forEach($$1x -> $$5.b($$1x, dec.F.n()));
         tp.a($$6, new io(1, 0, -1), dkn.a, $$5);
         return 0;
      } else {
   ...
   private static int a(ee $$0, String $$1) throws CommandSyntaxException {
      eui $$2 = (eui)$$0.h().a(10.0, 1.0F, false);
      io $$3 = $$2.a();
      aqn $$4 = $$0.e();
      ...
      if ($$5.isEmpty()) {
         ...
         if ($$6 == null) {
            ...
            agb.a($$4, new io($$3), $$8, -2147418368, 10000);
            return 1;
         }
      }
   }
   ...
   private static boolean a(aqn $$0, String $$1) {
      if ($$0.q().b(new akn($$1)).isEmpty()) {
   ...
   static void a(aqn $$0, String $$1, n $$2) {
   ...
   public static record c(aqn a, tk b) implements ta {
      @Override
      public void a(sz $$0) {
      }
      ...
      private static void a(aqn $$0, tk $$1) {
         if ($$1.i()) {
