...
public class tr {
   ...
   public int a() {
      return (int)this.f.stream().filter(tg::i).filter(tg::r).count();
   }

   public int b() {
      return (int)this.f.stream().filter(tg::i).filter(tg::s).count();
   }

   public int c() {
      return (int)this.f.stream().filter(tg::k).count();
   }
   ...
   public Collection<tg> f() {
      return this.f.stream().filter(tg::i).filter(tg::r).collect(Collectors.toList());
   }

   public Collection<tg> g() {
      return this.f.stream().filter(tg::i).filter(tg::s).collect(Collectors.toList());
   }
