public class cgg extends cfh {
   private static final int c = 300;
   private static final aim<Boolean> d = aiq.a(cgg.class, aio.k);
   public static final String b = "StrayConversionTime";
   private int e;
   private int bX;

   public cgg(bpc<? extends cgg> $$0, cwz $$1) {
      super($$0, $$1);
   }
   ...
   public void b(ta $$0) {
      super.b($$0);
      $$0.a("StrayConversionTime", this.go() ? this.bX : -1);
   }
