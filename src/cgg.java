...
public class cgg extends cff {
   private static final akk<iz> bZ = ako.a(cgg.class, akm.o);
   private static final akk<Boolean> cb = ako.a(cgg.class, akm.k);
   private static final akk<Boolean> cc = ako.a(cgg.class, akm.k);
   private static final akk<iz> cd = ako.a(cgg.class, akm.o);
   private static final akk<Boolean> ce = ako.a(cgg.class, akm.k);
   private static final akk<Boolean> cf = ako.a(cgg.class, akm.k);
   private static final float cg = 0.3F;
   private static final bsx ch = bta.bh.n().a(bsw.a().a(bsv.a, 0.0F, bta.bh.m(), -0.25F)).a(0.3F);
   int ci;
   public static final Predicate<btp> bY = $$0 -> $$0.p_() && !$$0.be();

   public cgg(bta<? extends cgg> $$0, dby $$1) {
      super($$0, $$1);
      this.a(eom.j, 0.0F);
      this.a(eom.t, -1.0F);
      this.a(eom.s, -1.0F);
      this.a(eom.r, -1.0F);
      this.bP = new cgg.e(this);
   }
   ...
   public static boolean c(bta<cgg> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      return $$3.v() < $$1.z_() + 4 && dnr.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void z() {
      this.bS.a(0, new cgg.f(this, 1.2));
      this.bS.a(1, new cgg.a(this, 1.0));
      this.bS.a(1, new cgg.d(this, 1.0));
      this.bS.a(2, new cbv(this, 1.1, $$0 -> $$0.a(awy.av), false));
      this.bS.a(3, new cgg.c(this, 1.0));
      this.bS.a(4, new cgg.b(this, 1.0));
      this.bS.a(7, new cgg.i(this, 1.0));
      this.bS.a(8, new cav(this, cmx.class, 8.0F));
      this.bS.a(9, new cgg.h(this, 1.0, 100));
   }

   public static buw.a y() {
      return btr.A().a(bux.q, 30.0).a(bux.r, 0.25).a(bux.v, 1.0);
   }
   ...
   @Override
   protected avz v() {
      return !this.be() && this.aE() && !this.p_() ? awa.Ac : super.v();
   }
   ...
   protected avz d(brn $$0) {
      return this.p_() ? awa.Aj : awa.Ai;
   }

   @Nullable
   @Override
   protected avz o_() {
      return this.p_() ? awa.Ae : awa.Ad;
   }

   @Override
   protected void b(iz $$0, dsc $$1) {
      avz $$2 = this.p_() ? awa.Am : awa.Al;
      this.a($$2, 0.15F, 1.0F);
   }
   ...
   protected cdb b(dby $$0) {
      return new cgg.g(this, $$0);
   }

   @Nullable
   @Override
   public bso a(arf $$0, bso $$1) {
      return bta.bh.a((dby)$$0);
   }
   ...
   public float a(iz $$0, dcb $$1) {
      if (!this.gx() && $$1.b_($$0).a(awv.a)) {
         return 10.0F;
      } else {
         return dnr.a($$1, $$0) ? 10.0F : $$1.w($$0);
      }
   }
   ...
   public void n_() {
      ...
      if (this.bD() && this.u() && this.ci >= 1 && this.ci % 5 == 0) {
         iz $$0 = this.dp();
         if (dnr.a(this.dP(), $$0)) {
            this.dP().c(2001, $$0, dez.i(this.dP().a_($$0.d())));
            this.a(dwv.u);
         }
      }
   }
   ...
   static class a extends bzz {
      ...
      protected void g() {
         ...
         if (this.b.ab().b(dbu.f)) {
            this.b.b(new btf(this.b, this.a.du(), this.a.dw(), this.a.dA(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends can {
      ...
      public void e() {
         ...
         if (this.a.K().l()) {
            evr $$2 = evr.c($$0);
            evr $$3 = cek.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = cek.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dP().a_(iz.a($$3)).a(dfb.G)) {
               $$3 = cek.a(this.a, 16, 5, $$2, (float) (Math.PI / 2));
            }
   ...
   static class c extends cba {
      ...
      protected boolean a(dcb $$0, iz $$1) {
         return $$0.a_($$1).a(dfb.G);
      }
   }

   static class d extends cba {
      private final cgg g;
      ...
      public void e() {
         ...
         if (!this.g.be() && this.m()) {
            if (this.g.ci < 1) {
               ...
               dby $$1 = this.g.dP();
               $$1.a(null, $$0, awa.Ak, awb.e, 0.3F, 0.9F + $$1.z.i() * 0.2F);
               iz $$2 = this.e.c();
               dsc $$3 = dfb.mf.o().a(dnr.f, Integer.valueOf(this.g.ah.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(dwv.i, $$2, dwv.a.a(this.g, $$3));
               this.g.w(false);
               this.g.x(false);
               this.g.t(600);
            }
      ...
      @Override
      protected boolean a(dcb $$0, iz $$1) {
         return !$$0.u($$1.c()) ? false : dnr.b($$0, $$1);
      }
   }
      ...
      public void a() {
         ...
         if (this.k == bzq.a.b && !this.l.K().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aY = this.l.dF();
               float $$5 = (float)(this.h * this.l.g(bux.r));
               this.l.y(ayz.i(0.125F, this.l.fn(), $$5));
   ...
   static class g extends ccy {
      ...
      public boolean a(iz $$0) {
         if (this.a instanceof cgg $$1 && $$1.gy()) {
            return this.b.a_($$0).a(dfb.G);
         }
   ...
   static class h extends cbk {
      private final cgg i;

      h(cgg $$0, double $$1, int $$2) {
         super($$0, $$1, $$2);
         this.i = $$0;
      }
   ...
   static class i extends can {
      ...
      public void e() {
         if (this.a.K().l()) {
            evr $$0 = evr.c(this.a.gw());
            evr $$1 = cek.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
