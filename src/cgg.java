...
public class cgg {
   ...
   @Nullable
   public static fba a(bvp $$0, Supplier<ji> $$1) {
      return a($$1, $$0::c);
   }

   @Nullable
   public static fba a(Supplier<ji> $$0, ToDoubleFunction<ji> $$1) {
      ...
      return $$3 != null ? fba.c($$3) : null;
   }

   public static ji a(bvp $$0, int $$1, azh $$2, ji $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.ge() && $$1 > 1) {
         ji $$6 = $$0.gb();
