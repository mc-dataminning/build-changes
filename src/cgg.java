...
public class cgg extends chg {
   ...
   public cgg(int $$0, cdl $$1) {
      this($$0, $$1, cgp.a);
   }

   public cgg(int $$0, cdl $$1, cgp $$2) {
      super(chl.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected chh l() {
      return chh.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   @Override
   protected boolean a(cdm $$0, boolean $$1) {
      return ($$0.fT().d || $$0.cf >= this.w.b()) && this.w.b() > 0;
   }

   @Override
   protected void a(cdm $$0, clb $$1) {
      if (!$$0.fT().d) {
         $$0.c(-this.w.b());
      }
      ...
      this.o.a(($$1x, $$2x) -> {
         dgw $$3 = $$1x.a_($$2x);
         if (!$$0.fT().d && $$3.a(arc.M) && $$0.ef().i() < 0.12F) {
            dgw $$4 = ctt.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         clb $$4 = $$0.p();
         clb $$5 = this.q.a(1);
         Map<cpm, Integer> $$6 = cpo.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cle.tD) && !cjx.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cpm, Integer> $$16 = cpo.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cpm $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fT().d || $$0.a(cle.tD)) {
                        $$22 = true;
                     }
