...
public class crl extends crd {
   ...
   public void g() {
      if (this.h() instanceof ard $$0) {
         this.a.bf();
         ji var11 = this.a.p();
         dww $$3 = this.h().a_(var11);
         boolean $$4 = dja.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(djn.hE)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dpm.f));
            }
         } else {
            this.a.e($$0);
         }
   ...
   public void a(ard $$0) {
      ...
      $$10 = new faz($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      buk $$20 = this.a.cZ();
      faz $$22;
      ...
      $$10 = this.j();
      this.a.a(bvk.a, new faz(ayz.a($$36 * $$10.d, -$$37, $$37), 0.0, ayz.a($$36 * $$10.f, -$$37, $$37)));
      ...
      faz $$38 = this.d(this.a.dA(), this.a.dC(), this.a.dG());
      if ($$38 != null && $$6 != null) {
   ...
   @Nullable
   public faz a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ayz.a($$0);
      int $$5 = ayz.a($$1);
      int $$6 = ayz.a($$2);
   ...
   public faz d(double $$0, double $$1, double $$2) {
      ...
      dww $$6 = this.h().a_(new ji($$3, $$4, $$5));
      if (dja.h($$6)) {
         dxz $$7 = $$6.c(((dja)$$6.b()).c());
         Pair<km, km> $$8 = cqv.a($$7);
         km $$9 = (km)$$8.getFirst();
   ...
   @Override
   public boolean i() {
      fau $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.B() && this.j().j() >= 0.01) {
         ...
         for (buk $$3 : this.h().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bI() && $$3 instanceof cqv) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public faz c(faz $$0) {
      return new faz(ayz.a($$0.d, -0.4, 0.4), $$0.e, ayz.a($$0.f, -0.4, 0.4));
   }
