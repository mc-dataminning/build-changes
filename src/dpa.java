...
public class dpa extends dog implements bpz {
   public int a;
   public float b;
   public float c;
   public float d;
   ...
   public float i;
   public float j;
   private static final ayk k = ayk.a();
   @Nullable
   private wx l;

   public dpa(io $$0, drb $$1) {
      super(doi.m, $$0, $$1);
   }
   ...
   public static void a(dax $$0, io $$1, drb $$2, dpa $$3) {
      $$3.g = $$3.f;
      $$3.i = $$3.h;
      clw $$4 = $$0.a((double)$$1.u() + 0.5, (double)$$1.v() + 0.5, (double)$$1.w() + 0.5, 3.0, false);
      if ($$4 != null) {
