...
public class glo {
   ...
   private static final List<glo.e> c = Lists.newArrayList(new glo.e[]{new glo.a(), new glo.b()});
   ...
   public static Vector4f a(fkr $$0, float $$1, gfz $$2, int $$3, float $$4) {
      etb $$5 = $$0.k();
      bul $$6 = $$0.g();
      float $$19;
      float $$20;
   ...
   @Nullable
   private static glo.e a(bul $$0, float $$1) {
      return $$0 instanceof bvh $$2 ? c.stream().filter($$2x -> $$2x.a($$2, $$1)).findFirst().orElse(null) : null;
   }

   public static gln a(fkr $$0, glo.d $$1, Vector4f $$2, float $$3, boolean $$4, float $$5) {
      if (!g) {
         return gln.a;
      } else {
         etb $$6 = $$0.k();
         ...
         if ($$6 == etb.a) {
            ...
            $$8.b = -8.0F;
            $$8.c = 96.0F;
            if ($$7 instanceof gkw $$12) {
               $$8.c = $$8.c * Math.max(0.25F, $$12.F());
               jr<dhk> $$13 = $$12.dV().t($$12.dv());
               if ($$13.a(awo.aa)) {
                  $$8.c *= 0.85F;
               }
            }
         ...
         return new gln($$8.b, $$8.c, $$8.d, $$2.x, $$2.y, $$2.z, $$2.w);
      }
   }

   static class a implements glo.e {
      @Override
      public jr<bto> a() {
         return bts.o;
      }
      ...
      @Override
      public void a(glo.c $$0, bvh $$1, btq $$2, float $$3, float $$4) {
   ...
   static class b implements glo.e {
      @Override
      public jr<bto> a() {
         return bts.G;
      }
   ...
   interface e {
      ...
      void a(glo.c var1, bvh var2, btq var3, float var4, float var5);
