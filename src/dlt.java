...
public class dlt {
   ...
   private final int j;
   private final int k;
   private List<dlt.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public dlt(boolean $$0, axe<dey> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static dlt a() {
      return new dlt(false, awo.bS, 10, 4, 10, 5);
   }

   public static dlt b() {
      return new dlt(true, awo.bT, 50, 1, 5, 10);
   }
   ...
   public void a(ur $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<dlt.a> $$1 = (List<dlt.a>)dlt.a.b.listOf().parse(new Dynamic(vf.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(ur $$0) {
      dlt.a.b.listOf().encodeStart(vf.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(iz $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dlt.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dlt.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(dby $$0, iz $$1, azg $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<dlt.a> $$4 = new ArrayList<>();
         Map<iz, dlt.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dlt.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  iz.a.fieldOf("pos").forGetter(dlt.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dlt.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dlt.a::c),
      ...
      private boolean a(dby $$0, iz $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dby $$0, iz $$1, azg $$2, dlt $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static dlo a(dsb $$0) {
         return $$0.b() instanceof dlo $$1 ? $$1 : dlo.s_;
      }

      private static List<kd> a(azg $$0) {
         return ac.a(c, $$0);
      }

      @Nullable
      private static iz a(dby $$0, iz $$1, azg $$2) {
         iz.a $$3 = $$1.j();
         iz.a $$4 = $$1.j();
      ...
      private static boolean a(dby $$0, iz $$1, iz $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            iz $$3 = $$2.b($$1);
      ...
      private static boolean a(dby $$0, iz $$1, je $$2) {
         iz $$3 = $$1.a($$2);
