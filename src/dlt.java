...
public class dlt extends djl {
   public static final MapCodec<dlt> b = RecordCodecBuilder.mapCodec($$0 -> $$0.group(dls.a.forGetter($$0x -> $$0x.c), t()).apply($$0, dlt::new));
   private final dkd c;
