...
public class dlt extends dki {
      ...
      d = CacheBuilder.newBuilder()
         ...
         .build(new CacheLoader<String, CompletableFuture<Optional<GameProfile>>>() {
            public CompletableFuture<Optional<GameProfile>> a(String $$0x) {
               return $$2.getAsBoolean() ? CompletableFuture.completedFuture(Optional.empty()) : dlt.a($$0, $$0, $$2);
            }
         });
   }
   ...
   public static void a(cxb $$0, ib $$1, dnb $$2, dlt $$3) {
      if ($$2.b(dhd.a) && $$2.c(dhd.a)) {
         $$3.i = true;
         $$3.h++;
      } else {
         $$3.i = false;
   ...
   private static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && ciu.c($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
