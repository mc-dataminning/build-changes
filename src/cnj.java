...
public class cnj {
   ...
   private int g = azj.b(azr.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kj.a.fieldOf("uuid").forGetter(Pair::getFirst), ays.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<btz> j;
   @VisibleForTesting
   protected final ArrayList<btz> c;
   private final cnj.a k;
   @VisibleForTesting
   protected final Object2IntMap<btz> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cnj> a(Predicate<btz> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cnj::b)).apply($$1, $$1x -> new cnj($$0, $$1x))
      );
   }

   public cnj(Predicate<btz> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cnj.a(this);
   ...
   public void a(arm $$0, Predicate<btz> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<btz>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<btz> $$6 = (Entry<btz>)$$5.next();
         int $$7 = $$6.getIntValue();
         btz $$8 = (btz)$$6.getKey();
         btz.c $$9 = $$8.dT();
   ...
   public int b(@Nullable btz $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<buv> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof buv).map($$0 -> (buv)$$0);
   }

   @VisibleForTesting
   protected static record a(cnj a) implements Comparator<btz> {
      public int a(btz $$0, btz $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof coh;
               boolean $$7 = $$1 instanceof coh;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
