...
public enum fcc {
   ...
   private fcc(final String... $$0) {
      this.c = $$0;
   }

   public List<aun<InputStream>> a(ath $$0) throws IOException {
      return List.of(
   ...
   public aun<InputStream> b(ath $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aun<InputStream> a(ath $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      aun<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
