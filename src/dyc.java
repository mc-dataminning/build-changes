...
public class dyc {
   ...
   public static Optional<dyc> a(cmn $$0, gu $$1, ha.a $$2) {
   ...
   public static eei a(l.a $$0, ha.a $$1, eei $$2, bfk $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = apa.a(apa.c($$2.a($$1) - (double)$$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         ha.a $$10 = ha.a.b;
         $$11 = apa.a(apa.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
   ...
   private static eei a(eei $$0, aif $$1, bfj $$2, bfk $$3) {
      if (!($$3.a > 4.0F) && !($$3.b > 4.0F)) {
         double $$4 = (double)$$3.b / 2.0;
         eei $$5 = $$0.b(0.0, $$4, 0.0);
         efb $$6 = eey.a(eed.a($$5, (double)$$3.a, 0.0, (double)$$3.a).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<eei> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a, (double)$$3.b, (double)$$3.a);
         Optional<eei> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
