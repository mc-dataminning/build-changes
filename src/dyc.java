...
public class dyc {
   ...
   static class a implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
         return $$0.c[hx.f.d()] && !$$0.b[hx.f.d()].d;
      }

      @Override
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         $$1.d = true;
         $$1.b[hx.f.d()].d = true;
         return new dyc.k($$0, $$1);
      }
   }

   static class b implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         ...
         return new dyc.l($$0, $$1);
      }
   }

   static class c implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         $$1.d = true;
         $$1.b[hx.b.d()].d = true;
         return new dyc.m($$0, $$1);
      }
   }

   static class d implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         ...
         return new dyc.n($$0, $$1);
      }
   }

   static class e implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         ...
         $$3.d = true;
         $$3.b[hx.c.d()].d = true;
         return new dyc.o($$0, $$3);
      }
   }

   static class f implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
         return true;
      }
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         $$1.d = true;
         return new dyc.s($$0, $$1, $$2);
      }
   }

   static class g implements dyc.i {
      @Override
      public boolean a(dyc.v $$0) {
      ...
      public dyc.r a(hx $$0, dyc.v $$1, ate $$2) {
         $$1.d = true;
         return new dyc.t($$0, $$1);
      }
   }

   public static class h extends dyc.r {
      ...
      private dyc.v G;
      private dyc.v H;
      private final List<dyc.r> I = Lists.newArrayList();

      public h(ate $$0, int $$1, int $$2, hx $$3) {
         super(dwr.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dyc.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dyc.p($$3, this.G));
         this.I.add(new dyc.j($$3, this.H));
         List<dyc.i> $$5 = Lists.newArrayList();
         $$5.add(new dyc.b());
         $$5.add(new dyc.d());
         $$5.add(new dyc.e());
         $$5.add(new dyc.a());
         ...
         dvs $$10 = dvs.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dvs $$11 = dvs.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dvs $$12 = dvs.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dyc.u($$3, $$10, $$13++));
         this.I.add(new dyc.u($$3, $$11, $$13++));
         this.I.add(new dyc.q($$3, $$12));
      }
      ...
      private List<dyc.v> b(ate $$0) {
         dyc.v[] $$1 = new dyc.v[75];
         ...
         dyc.v $$23 = new dyc.v(1003);
         dyc.v $$24 = new dyc.v(1001);
         dyc.v $$25 = new dyc.v(1002);
         $$1[v].a(hx.b, $$23);
         $$1[w].a(hx.d, $$24);
         $$1[x].a(hx.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dyc.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, crt $$2, ate $$3, dvs $$4) {
         int $$5 = 24;
      ...
      private void a(crt $$0, ate $$1, dvs $$2) {
      ...
      private void b(crt $$0, ate $$1, dvs $$2) {
      ...
      private void c(crt $$0, ate $$1, dvs $$2) {
      ...
      private void d(crt $$0, ate $$1, dvs $$2) {
      ...
      private void e(crt $$0, ate $$1, dvs $$2) {
      ...
      private void f(crt $$0, ate $$1, dvs $$2) {
   ...
   interface i {
      boolean a(dyc.v var1);

      dyc.r a(hx var1, dyc.v var2, ate var3);
   }

   public static class j extends dyc.r {
      public j(hx $$0, dyc.v $$1) {
         super(dwr.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(crt $$0, crr $$1, dhy $$2, ate $$3, dvs $$4, cqg $$5, ht $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cuc.ch.o(), cuc.ch.o(), false);
   ...
   public static class k extends dyc.r {
      public k(hx $$0, dyc.v $$1) {
         super(dwr.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dyc.r {
      public l(hx $$0, dyc.v $$1) {
         super(dwr.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dyc.r {
      public m(hx $$0, dyc.v $$1) {
         super(dwr.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dyc.r {
      public n(hx $$0, dyc.v $$1) {
         super(dwr.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dyc.r {
      public o(hx $$0, dyc.v $$1) {
         super(dwr.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dyc.r {
      public p(hx $$0, dyc.v $$1) {
         super(dwr.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dyc.r {
      public q(hx $$0, dvs $$1) {
         super(dwr.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dwe {
      protected static final dgb b = cuc.hZ.o();
      protected static final dgb c = cuc.ia.o();
      protected static final dgb d = cuc.ib.o();
      protected static final dgb h = c;
      protected static final dgb i = cuc.ii.o();
      protected static final boolean j = true;
      protected static final dgb k = cuc.G.o();
      protected static final Set<cua> l = ImmutableSet.builder().add(cuc.dO).add(cuc.iC).add(cuc.mW).add(k.b()).build();
      ...
      public r(dwr $$0, hx $$1, int $$2, dvs $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dwr $$0, int $$1, hx $$2, dyc.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dvs a(hx $$0, dyc.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dvs $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(crt $$0, dvs $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dgb $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(crt $$0, dvs $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(crt $$0, dvs $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dgb $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dvs $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(crt $$0, dvs $$1, int $$2, int $$3, int $$4) {
         ht $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            caa $$6 = bjx.A.a((cqz)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dl()), bkn.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dyc.r {
      private int a;

      public s(hx $$0, dyc.v $$1, ate $$2) {
         super(dwr.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dyc.r {
      public t(hx $$0, dyc.v $$1) {
         super(dwr.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dyc.r {
      private int a;

      public u(hx $$0, dvs $$1, int $$2) {
         super(dwr.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
