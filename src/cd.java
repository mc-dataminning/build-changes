...
public class cd extends dy<cd.a> {
   ...
   public void a(asi $$0, cxp $$1, cqm $$2, Collection<cxp> $$3) {
      ewp $$4 = bw.b($$0, (bvk)($$2.s() != null ? $$2.s() : $$2));
   ...
   public static record a(Optional<bh> b, Optional<cu> c, Optional<bh> d, Optional<cu> e) implements dy.a {
      ...
      public boolean a(cxp $$0, ewp $$1, Collection<cxp> $$2) {
         if (this.c.isPresent() && !this.c.get().a($$0)) {
            ...
            if (this.e.isPresent()) {
               boolean $$3 = false;
               bvk $$4 = $$1.c(ezj.a);
               if ($$4 instanceof cmb $$5 && this.e.get().a($$5.l())) {
                  $$3 = true;
               }
