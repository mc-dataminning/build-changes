...
public class hau extends haz {
   ...
   public hau(@Nullable File $$0, String $$1, alp $$2, boolean $$3, @Nullable Runnable $$4) {
      super($$2);
      this.i = $$0;
      this.j = $$1;
      this.k = $$3;
      ...
      if (this.m == null) {
         ...
         if ($$2 != null) {
            ...
            this.m = CompletableFuture.runAsync(() -> {
               ...
               try {
                  $$0x = (HttpURLConnection)new URL(this.j).openConnection(flz.Q().Z());
                  $$0x.setDoInput(true);
   ...
   private static void a(ffl $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            int $$7 = $$0.a($$5, $$6);
            if (ayf.a($$7) < 128) {
   ...
   private static void b(ffl $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            $$0.a($$5, $$6, ayf.f($$0.a($$5, $$6)));
         }
      }
   }
}
