...
public class gdy {
   ...
   public static void a(fff $$0, ezy $$1) {
      cmx $$2 = $$0.s;
      if (!$$2.ag) {
         dsc $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static void a(goz $$0, ezy $$1) {
   ...
   private static void b(fff $$0, ezy $$1) {
      RenderSystem.setShader(gdh::r);
      RenderSystem.setShaderTexture(0, a);
      ezt $$2 = faa.b().d();
      iz $$3 = iz.a($$0.s.du(), $$0.s.dy(), $$0.s.dA());
      float $$4 = gdn.a($$0.s.dP().D_(), $$0.s.dP().A($$3));
   ...
   private static void c(fff $$0, ezy $$1) {
      ezt $$2 = faa.b().d();
      RenderSystem.setShader(gdh::q);
