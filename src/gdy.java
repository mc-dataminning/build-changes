...
public class gdy implements gdx {
   ...
   private final gdx.a b = gdx.a(new fab(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public fak getBuffer(gef $$0) {
      if ($$0.M()) {
         fak $$1 = this.b.getBuffer($$0);
         return new gdy.a($$1, this.c, this.d, this.e, this.f);
      } else {
         fak $$2 = this.a.getBuffer($$0);
         Optional<gef> $$3 = $$0.L();
         if ($$3.isPresent()) {
            fak $$4 = this.b.getBuffer($$3.get());
            gdy.a $$5 = new gdy.a($$4, this.c, this.d, this.e, this.f);
            return fan.a($$5, $$2);
         } else {
            return $$2;
         }
   ...
   static class a extends faf {
      ...
      a(fak $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
