...
public class hni extends MinecraftServer {
   ...
   public hni(Thread $$0, foz $$1, eyv.c $$2, aun $$3, amf $$4, amb $$5, asb $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hnh(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dix bd() {
      return this.r() && !this.r_() ? (dix)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
