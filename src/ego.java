...
public class ego implements azt {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<ego> b = egn.a.xmap($$0 -> new ego($$0), $$0 -> $$0.e);
   private egn e;
   private final efp f = new efp(this);

   public ego(long $$0) {
      this.e = new egn(egc.c($$0));
   }
   ...
   @Override
   public azt d() {
      return new ego(this.e.a(), this.e.a());
   }

   @Override
   public ega e() {
      return new ego.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements ega {
      ...
      public azt a(int $$0, int $$1, int $$2) {
         long $$3 = azk.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new ego($$4, this.b);
      }

      @Override
      public azt a(String $$0) {
         egc.a $$1 = egc.a($$0);
         return new ego($$1.a(this.a, this.b));
      }

      @Override
      public azt a(long $$0) {
         return new ego($$0 ^ this.a, $$0 ^ this.b);
      }
