...
@Deprecated
public class ego extends efz<ego.a> {
   private static final dwy a = djp.nE.m();

   public ego(Codec<ego.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egb<ego.a> $$0) {
      ji $$1 = $$0.e();
      dhh $$2 = $$0.b();
      azh $$3 = $$0.d();
      ego.a $$4 = $$0.f();
   ...
   public static record a(eke b, eke c) implements eid {
      public static final Codec<ego.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eke.a.fieldOf("fluid").forGetter(ego.a::a), eke.a.fieldOf("barrier").forGetter(ego.a::b)).apply($$0, ego.a::new)
      );
