...
public class ego implements efy {
   public static final Codec<ego> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ekk.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               axl.b(lw.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               ehz.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               ehz.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               ebv.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, ego::new)
   );
   ...
   public ego(jo<ekk> $$0, int $$1, int $$2, axl<dhm> $$3, ehz $$4, int $$5, int $$6, int $$7, int $$8, ehz $$9, int $$10, int $$11, ebv $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
