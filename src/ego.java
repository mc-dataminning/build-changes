...
public class ego extends egt {
   public static final MapCodec<ego> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, ego::new));
   ...
   public List<efb.a> a(dcm $$0, BiConsumer<ja, dsl> $$1, ayo $$2, int $$3, ja $$4, eel $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayg.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayg.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ego.a> $$13 = Lists.newArrayList();
      $$13.add(new ego.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ja $$21 = $$4.b(ayg.a($$19), $$12 - 1, ayg.a($$20));
               ja $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  ja $$27 = new ja($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new ego.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<efb.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcm $$0, BiConsumer<ja, dsl> $$1, ayo $$2, ja $$3, ja $$4, boolean $$5, eel $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         ja $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ja $$13 = $$3.b(ayg.d(0.5F + (float)$$12 * $$9), ayg.d(0.5F + (float)$$12 * $$10), ayg.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlu.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcm $$0, BiConsumer<ja, dsl> $$1, ayo $$2, int $$3, ja $$4, List<ego.a> $$5, eel $$6) {
      for (ego.a $$7 : $$5) {
         int $$8 = $$7.a();
         ja $$9 = new ja($$4.u(), $$8, $$4.w());
