...
public class ajz {
   ...
   private static int a(du $$0, ejh $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bki> $$6) throws CommandSyntaxException {
      ama $$7 = $$0.f();
      int $$8 = $$7.I_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         ajz.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
   ...
   private static int a(Collection<? extends bki> $$0) {
      Set<ekj> $$1 = Sets.newHashSet();
   ...
   private static void a(ejh $$0, double $$1, ama $$2, ato $$3, double $$4, double $$5, double $$6, double $$7, int $$8, ajz.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bki> $$0, ama $$1, ajz.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ekj, ajz.a> $$7 = Maps.newHashMap();

      for (bki $$8 : $$0) {
         ajz.a $$10;
         if ($$4) {
            ekj $$9 = $$8 instanceof cdm ? $$8.cf() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)ati.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)ati.a($$10.b) + 0.5, Set.of(), $$8.dB(), $$8.dD());
   ...
   private static ajz.a[] a(ato $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      ajz.a[] $$6 = new ajz.a[$$1];
   ...
   static class a {
      ...
      public boolean b(cqy $$0, int $$1) {
         ht $$2 = ht.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dgw $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(arc.aJ);
      }

      public void a(ato $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = ati.a($$0, $$1, $$3);
         this.b = ati.a($$0, $$2, $$4);
      }
   }
