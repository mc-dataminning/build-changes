...
public class ajz {
   ...
   public static <T> ajv<T> a(Class<? extends ajy> $$0, ajw<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> ajz.b<T> b(ajv<T> $$0) {
      return (ajz.b<T>)this.e[$$0.a()];
   }

   public <T> T a(ajv<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(ajv<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(ajv<T> $$0, T $$1, boolean $$2) {
      ajz.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(ajz.b<T> $$0, ajz.c<?> $$1) {
   ...
   public static class a {
      private final ajy a;
      private final ajz.b<?>[] b;

      public a(ajy $$0) {
         this.a = $$0;
         this.b = new ajz.b[ajz.c.b($$0.getClass())];
      }

      public <T> ajz.a a(ajv<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public ajz.c<T> e() {
         return ajz.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, ajw<T> b, T c) {

      public static <T> ajz.c<T> a(ajv<T> $$0, T $$1) {
         ajw<T> $$2 = $$0.b();
         return new ajz.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static ajz.c<?> a(wj $$0, int $$1) {
         int $$2 = $$0.l();
         ajw<?> $$3 = ajx.a($$2);
         if ($$3 == null) {
      ...
      private static <T> ajz.c<T> a(wj $$0, int $$1, ajw<T> $$2) {
         return new ajz.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
