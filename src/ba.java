...
public class ba extends dj<ba.a> {
   ...
   public void a(arp $$0, je<dam> $$1) {
      this.a($$0, $$1x -> $$1x.a($$1));
   }

   public static record a(Optional<bi> b, Optional<je<dam>> c) implements dj.a {
      public static final Codec<ba.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(bx.b.optionalFieldOf("player").forGetter(ba.a::a), dam.a.optionalFieldOf("potion").forGetter(ba.a::c)).apply($$0, ba.a::new)
      );
