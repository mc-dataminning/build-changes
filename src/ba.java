...
public class ba extends dy<ba.a> {
   ...
   public void a(asi $$0, aly<dha> $$1, aly<dha> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bh> b, Optional<aly<dha>> c, Optional<aly<dha>> d) implements dy.a {
      public static final Codec<ba.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  bw.b.optionalFieldOf("player").forGetter(ba.a::a),
                  aly.a(mb.bd).optionalFieldOf("from").forGetter(ba.a::c),
                  aly.a(mb.bd).optionalFieldOf("to").forGetter(ba.a::d)
               )
               .apply($$0, ba.a::new)
      );
