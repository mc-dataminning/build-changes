...
public class clq extends cmq {
   ...
   public clq(int $$0, cir $$1) {
      this($$0, $$1, clz.a);
   }

   public clq(int $$0, cir $$1, clz $$2) {
      super(cmv.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cmr l() {
      return cmr.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   @Override
   protected boolean a(cis $$0, boolean $$1) {
      return ($$0.fM() || $$0.cm >= this.w.b()) && this.w.b() > 0;
   }

   @Override
   protected void a(cis $$0, cqk $$1) {
      if (!$$0.ga().d) {
         $$0.c(-this.w.b());
      }
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cqk $$4 = $$0.q();
         cqk $$5 = this.q.a(1);
         Map<cuu, Integer> $$6 = cuv.a($$4);
         $$2 += $$0.J() + ($$5.b() ? 0 : $$5.J());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cqn.ut) && !cph.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cuu, Integer> $$16 = cuv.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cuu $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.ga().d || $$0.a(cqn.ut)) {
                        $$22 = true;
                     }
