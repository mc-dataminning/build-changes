...
public class clq extends bxb implements cnl {
   private static final Logger bJ = LogUtils.getLogger();
   public static final akh<Integer> a = akl.a(clq.class, akj.b);
   private static final cho bK = cho.a().a(64.0);
   ...
   private final cln[] bQ;
   public final cln c;
   private final cln bR;
   private final cln bS;
   private final cln bT;
   private final cln bU;
   private final cln bV;
   private final cln bW;
   private final cln bX;
   public float d;
   public float bE;
   public boolean bF;
   public int bG;
   ...
   private edo bY;
   private iu bZ = iu.c;
   private final cmh ca;
   private int cb = 100;
   private float cc;
   private final ewh[] cd = new ewh[24];
   private final int[] ce = new int[24];
   private final ewf cf = new ewf();

   public clq(bwj<? extends clq> $$0, dip $$1) {
      super(bwj.P, $$1);
      this.c = new cln(this, "head", 1.0F, 1.0F);
      this.bR = new cln(this, "neck", 3.0F, 3.0F);
      this.bS = new cln(this, "body", 5.0F, 3.0F);
      this.bT = new cln(this, "tail", 2.0F, 2.0F);
      this.bU = new cln(this, "tail", 2.0F, 2.0F);
      this.bV = new cln(this, "tail", 2.0F, 2.0F);
      this.bW = new cln(this, "wing", 4.0F, 2.0F);
      this.bX = new cln(this, "wing", 4.0F, 2.0F);
      this.bQ = new cln[]{this.c, this.bR, this.bS, this.bT, this.bU, this.bV, this.bW, this.bX};
      this.d(this.eT());
      this.ad = true;
      this.ca = new cmh(this);
   }
   ...
   public static bye.a m() {
      return bxb.E().a(byf.s, 200.0);
   }

   @Override
   public boolean ba() {
      float $$0 = azk.b(this.bE * (float) (Math.PI * 2));
   ...
   public void aZ() {
      if (this.dV().C && !this.bb()) {
         this.dV().a(this.dA(), this.dC(), this.dG(), awl.iy, this.dm(), 5.0F, 0.8F + this.ae.i() * 0.3F, false);
      }
   }
   ...
   public void k_() {
      ...
      if (this.dV().C) {
         ...
         if (!this.bb() && !this.ca.a().a() && --this.cb < 0) {
            this.dV().a(this.dA(), this.dC(), this.dG(), awl.iz, this.dm(), 2.5F, 0.8F + this.ae.i() * 0.3F, false);
            this.cb = 200 + this.ae.a(200);
         }
      }

      if (this.bY == null && this.dV() instanceof aro $$0) {
         edo $$1 = $$0.F();
         ...
         if (this.gf()) {
            ...
            if (this.dV() instanceof aro $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.w(azk.h(this.dL()));
                  fdw $$17 = $$10.a(this.dA(), this.dC(), this.dG()).d();
                  fdw $$18 = new fdw((double)azk.a(this.dL() * (float) (Math.PI / 180.0)), this.dy().e, (double)(-azk.b(this.dL() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new fdw(0.0, 0.0, -1.0));
                  if (this.bF) {
                     this.a(bxd.a, this.dy().c(0.8F));
                  } else {
            ...
            this.aV = this.dL();
            fdw[] $$25 = new fdw[this.bQ.length];

            for (int $$26 = 0; $$26 < this.bQ.length; $$26++) {
               $$25[$$26] = new fdw(this.bQ[$$26].dA(), this.bQ[$$26].dC(), this.bQ[$$26].dG());
            }
            ...
            if (this.dV() instanceof aro $$33 && this.aN == 0) {
               this.a($$33, $$33.a(this, this.bW.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bwh.e));
               this.a($$33, $$33.a(this, this.bX.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bwh.e));
               this.b($$33, $$33.a(this, this.c.cR().g(1.0), bwh.e));
               this.b($$33, $$33.a(this, this.bR.cR().g(1.0), bwh.e));
            }

            float $$34 = azk.a(this.dL() * (float) (Math.PI / 180.0) - this.bH * 0.01F);
            float $$35 = azk.b(this.dL() * (float) (Math.PI / 180.0) - this.bH * 0.01F);
            float $$36 = this.gm();
   ...
   private void a(cln $$0, double $$1, double $$2, double $$3) {
   ...
   private void gn() {
      ...
      if (this.ae.a(10) == 0) {
         List<clp> $$0 = this.dV().a(clp.class, this.cR().g(32.0));
         clp $$1 = null;
   ...
   private void a(aro $$0, List<bwa> $$1) {
   ...
   private void b(aro $$0, List<bwa> $$1) {
      for (bwa $$2 : $$1) {
         if ($$2 instanceof bwz) {
            bup $$3 = this.dW().b((bwz)this);
            $$2.a($$0, $$3, 10.0F);
            dfh.a($$0, $$2, $$3);
         }
      }
   ...
   public boolean a(aro $$0, cln $$1, bup $$2, float $$3) {
      if (this.ca.a().h() == cmg.j) {
         return false;
      } else {
         $$3 = this.ca.a().a($$2, $$3);
         if ($$1 != this.c) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof cqs || $$2.a(axb.y)) {
               float $$4 = this.eF();
               this.c($$0, $$2, $$3);
   ...
   protected void c(aro $$0, bup $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void em() {
      ...
      if (this.dV() instanceof aro $$4) {
         if (this.bG > 150 && this.bG % 5 == 0 && $$4.O().c(dil.f)) {
            bwo.a($$4, this.dt(), azk.d((float)$$3 * 0.08F));
         }
      ...
      if (this.bG == 200 && this.dV() instanceof aro $$7) {
         if ($$7.O().c(dil.f)) {
            bwo.a($$7, this.dt(), azk.d((float)$$3 * 0.2F));
         }
   ...
   public int n() {
      if (this.cd[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dV().a(efn.a.f, new iu($$3, 0, $$4)).v() + $$1);
            this.cd[$$0] = new ewh($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      ewh $$5 = new ewh(azk.a($$0), azk.a($$1), azk.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public ewj a(int $$0, int $$1, @Nullable ewh $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         ewh $$4 = this.cd[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private ewj a(ewh $$0, ewh $$1) {
      List<ewh> $$2 = Lists.newArrayList();
      ewh $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new ewj($$2, new iu($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(tx $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.ca.a(cmg.a($$0.h("DragonPhase")));
      }
   ...
   public fdw J(float $$0) {
      cma $$1 = this.ca.a();
      cmg<? extends cma> $$2 = $$1.h();
      fdw $$8;
      if ($$2 == cmg.d || $$2 == cmg.e) {
         iu $$3 = this.dV().a(efn.a.f, eis.a(this.bZ));
   ...
   public void a(aro $$0, clp $$1, iu $$2, bup $$3) {
      cqs $$5;
      if ($$3.d() instanceof cqs $$4) {
         $$5 = $$4;
      } else {
