...
public class fau<T extends bfj> extends fad<T> {
   ...
   public static fek c() {
      ...
      $$1.a("red_thing", fej.c().a(14, 4).a(-1.0F, -2.0F, -3.0F, 2.0F, 2.0F, 2.0F), feg.a(0.0F, 15.0F, -4.0F));
      $$1.a("body", fej.c().a(0, 9).a(-3.0F, -4.0F, -3.0F, 6.0F, 8.0F, 6.0F), feg.a(0.0F, 16.0F, 0.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
