...
public class fau extends ezi<cgh> {
   private static final aex x = new aex("container/stonecutter/scroller");
   private static final aex y = new aex("container/stonecutter/scroller_disabled");
   private static final aex z = new aex("container/stonecutter/recipe_selected");
   private static final aex A = new aex("container/stonecutter/recipe_highlighted");
   private static final aex B = new aex("container/stonecutter/recipe");
   private static final aex C = new aex("textures/gui/container/stonecutter.png");
