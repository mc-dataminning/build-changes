...
public record cpu(cpu.a d) {
   ...
   public static final Codec<cpu> c = cpu.a.a.xmap(cpu::new, cpu::b);

   public static cpu a(azm $$0, UUID $$1, cpu.a $$2) throws cpu.b {
      if (!$$2.a($$0, $$1)) {
         throw new cpu.b(e);
      } else {
         return new cpu($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cpu.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayi.q.fieldOf("expires_at").forGetter(cpu.a::b), axx.f.fieldOf("key").forGetter(cpu.a::c), ayi.r.fieldOf("signature_v2").forGetter(cpu.a::d)
               )
               .apply($$0, cpu.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cpu.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
