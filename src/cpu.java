...
public class cpu extends cpr {
   ...
   public cpu(but<? extends cpu> $$0, dgj $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public cpu(dgj $$0, bvi $$1, bum $$2, jn.a $$3) {
      this(but.bc, $$0);
      this.c($$1);
      fbb $$4 = $$1.cR().f();
   ...
   public void h() {
      ...
      if (!this.dV().C) {
         ...
         if (this.b == null || !this.b.bL() || this.b instanceof coy && this.b.Z_()) {
            this.bf();
         } else {
   ...
   protected void a(fay $$0) {
      ...
      bum $$1 = $$0.a();
      bum $$2 = this.p();
      bvi $$3 = $$2 instanceof bvi ? (bvi)$$2 : null;
      btc $$4 = this.dW().a(this, $$3);
      ...
      if ($$5) {
         ...
         if ($$1 instanceof bvi $$7) {
            $$7.b(new btr(btt.y, 200), (bum)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   private void m() {
      this.at();
      this.dV().a(ebu.o, this.dt(), ebu.a.a(this));
   }
