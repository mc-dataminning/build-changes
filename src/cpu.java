...
public class cpu {
   ...
   private int g = azk.b(azt.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jy.a.fieldOf("uuid").forGetter(Pair::getFirst), ays.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bwa> j;
   @VisibleForTesting
   protected final ArrayList<bwa> c;
   private final cpu.a k;
   @VisibleForTesting
   protected final Object2IntMap<bwa> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cpu> a(Predicate<bwa> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cpu::b)).apply($$1, $$1x -> new cpu($$0, $$1x))
      );
   }

   public cpu(Predicate<bwa> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cpu.a(this);
   ...
   public void a(aro $$0, Predicate<bwa> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bwa>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bwa> $$6 = (Entry<bwa>)$$5.next();
         int $$7 = $$6.getIntValue();
         bwa $$8 = (bwa)$$6.getKey();
         bwa.e $$9 = $$8.dR();
   ...
   public int b(@Nullable bwa $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bwz> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bwz).map($$0 -> (bwz)$$0);
   }

   @VisibleForTesting
   protected static record a(cpu a) implements Comparator<bwa> {
      public int a(bwa $$0, bwa $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cqs;
               boolean $$7 = $$1 instanceof cqs;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
