...
public class axt implements AutoCloseable {
   ...
   private axt(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static axt.a a(Path $$0) {
         return new axt.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
