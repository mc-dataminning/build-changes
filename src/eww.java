...
public class eww extends epc {
   ...
   private void a(uy $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            ewx.b $$9 = ewx.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            ewx.b $$10 = ewx.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            ewx.a $$11 = ewx.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(uy $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         ewy $$5 = ewy.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, ewy.b.d());
            return ewy.b;
         });
         String $$6 = $$3.l("Name");
         xp $$7 = xp.a.a($$3.l("DisplayName"), $$1);
         ewy.a $$8 = ewy.a.a($$3.l("RenderType"));
