...
public class eww {
   private final ImmutableList<ewx> a;
   private final ImmutableMap<String, ewx> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private ewu e;

   public eww(ImmutableMap<String, ewx> $$0) {
      this.b = $$0;
