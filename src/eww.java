public class eww extends eym {
   ...
   public eww(eyk $$0, eqz $$1) {
      super($$0, $$1, tm.c("options.accessibility.title"), a($$1));
   }
   ...
   protected void aI_() {
      ...
      if ($$0 != null && !this.f.aa().b().contains("high_contrast")) {
         $$0.i = false;
         $$0.a(eua.a(tm.c("options.accessibility.high_contrast.error.tooltip")));
      }
   }

   @Override
   protected void f() {
      this.d(esq.a(tm.c("options.accessibility.link"), $$0 -> this.f.a(new exc($$0x -> {
            if ($$0x) {
      ...
      this.d(esq.a(tl.d, $$0 -> this.f.a(this.a)).a(this.g / 2 + 5, this.h - 27, 150, 20).a());
   }
}
