...
public class di extends dy<di.a> {
   ...
   public void a(asi $$0, aly<ewt> $$1) {
      this.a($$0, $$1x -> $$1x.b($$1));
   }

   public static record a(Optional<bh> b, aly<ewt> c) implements dy.a {
      ...
      public static ap<di.a> a(aly<ewt> $$0) {
         return ao.Q.a(new di.a(Optional.empty(), $$0));
      }

      public boolean b(aly<ewt> $$0) {
         return this.c == $$0;
      }
