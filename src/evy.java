...
public class evy {
   private final List<ConcurrentLinkedQueue<evx>> a = ImmutableList.of(
   ...
   public void a(evx $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<evx> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<evx> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<evx> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<evx> j() {
