...
public class evy {
   ...
   public static List<evy.a> a(String $$0, evy.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<evy.a> a(String $$0, List<evy.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<evy.a> a(List<String> $$0, List<evy.b> $$1) {
      int $$2 = 0;
      List<evy.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<evy.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static evy.b a(String $$0, String $$1) {
         return new evy.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static evy.b a(String $$0) {
         return new evy.b($$0);
      }
   }
}
