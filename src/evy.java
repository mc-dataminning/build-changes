...
public class evy {
   ...
   private final evy.a g;

   @Deprecated
   public static evy a(azv $$0, evy.a $$1) {
      return new evy($$0, $$1, false);
   }

   public static evy a(azv $$0, int $$1, double... $$2) {
      return b($$0, new evy.a($$1, new DoubleArrayList($$2)));
   }

   public static evy b(azv $$0, evy.a $$1) {
      return new evy($$0, $$1, true);
   }

   private evy(azv $$0, evy.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<evy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(evy.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(evy.a::b))
               .apply($$0, evy.a::new)
      );
      public static final Codec<jf<evy.a>> b = alc.a(mh.aY, a);
