public class evy {
   ...
   private int a(ece $$0, int $$1, int $$2, int $$3) {
      int $$4 = jx.c($$0.h($$1) + 1);
   ...
   public boolean a(dig $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dig $$0, int $$1, int $$2, iu $$3, eah $$4, iu $$5, eah $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dig $$0, iu $$1, eah $$2) {
      iu.a $$3 = this.e.g($$1);
