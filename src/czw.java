...
public class czw extends czg {
   ...
   public static dcb a() {
      return dcb.a().a(byp.c, new byn(h, 5.0, byn.a.a), bwt.b).a(byp.e, new byn(i, -3.4F, byn.a.a), bwt.b).a();
   }
   ...
   public float a(bwi $$0, float $$1, bux $$2) {
      if ($$2.c() instanceof bxj $$3) {
         if (!b($$3)) {
            ...
            return $$3.dU() instanceof arq $$11 ? (float)($$8 + (double)dfz.b($$11, $$3.dY(), $$0, $$2, 0.0F) * $$7) : (float)$$8;
         }
      } else {
         return 0.0F;
      }
   ...
   private static void a(djh $$0, bwi $$1, bwi $$2) {
      $$0.c(2013, $$2.aP(), 750);
   ...
   private static double a(bwi $$0, bxj $$1, fex $$2) {
