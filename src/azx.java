...
public class azx extends Schema {
   ...
   protected static final HookFunction a = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return azx.a(new Dynamic($$0, $$1), azx.c, "ArmorStand");
      }
   };
   ...
   protected static TypeTemplate a(Schema $$0) {
      return DSL.optionalFields("Equipment", DSL.list(avw.m.in($$0)));
   }
   ...
   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", avw.r.in($$0)));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "Item", $$1x -> DSL.optionalFields("Item", avw.m.in($$0)));
      $$0.registerSimple($$1, "XPOrb");
      b($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", avw.r.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", avw.r.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", avw.r.in($$0)));
      b($$0, $$1, "Snowball");
      b($$0, $$1, "Fireball");
      b($$0, $$1, "SmallFireball");
      b($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", avw.r.in($$0), "Potion", avw.m.in($$0)));
      b($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", avw.m.in($$0)));
      b($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", avw.r.in($$0), "TileEntityData", avw.l.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", avw.m.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", avw.r.in($$0), "Items", DSL.list(avw.m.in($$0))));
      c($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", avw.r.in($$0), "Items", DSL.list(avw.m.in($$0))));
      c($$0, $$1, "MinecartFurnace");
      c($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", avw.r.in($$0), avw.u.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", avw.r.in($$0), "Items", DSL.list(avw.m.in($$0))));
      ...
      a($$0, $$1, "Ghast");
      a($$0, $$1, "PigZombie");
      $$0.register($$1, "Enderman", $$1x -> DSL.optionalFields("carried", avw.r.in($$0), a($$0)));
      a($$0, $$1, "CaveSpider");
      a($$0, $$1, "Silverfish");
      a($$0, $$1, "Blaze");
      a($$0, $$1, "LavaSlime");
      ...
      a($$0, $$1, "VillagerGolem");
      $$0.register(
         $$1, "EntityHorse", $$1x -> DSL.optionalFields("Items", DSL.list(avw.m.in($$0)), "ArmorItem", avw.m.in($$0), "SaddleItem", avw.m.in($$0), a($$0))
      );
      a($$0, $$1, "Rabbit");
      $$0.register(
         $$1,
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", $$1x -> DSL.optionalFields("RecordItem", avw.m.in($$0)));
      d($$0, $$1, "Trap");
      d($$0, $$1, "Dropper");
      $$0.registerSimple($$1, "Sign");
      $$0.register($$1, "MobSpawner", $$1x -> avw.u.in($$0));
      ...
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), avw.s.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, avw.b, () -> DSL.optionalFields("Inventory", DSL.list(avw.m.in($$0)), "EnderItems", DSL.list(avw.m.in($$0))));
      $$0.registerType(
         false,
         avw.c,
         () -> DSL.fields(
      ...
      $$0.registerType(true, avw.l, () -> DSL.taggedChoiceLazy("id", DSL.string(), $$2));
      $$0.registerType(true, avw.p, () -> DSL.optionalFields("Riding", avw.p.in($$0), avw.q.in($$0)));
      $$0.registerType(false, avw.o, () -> DSL.constType(axd.a()));
      $$0.registerType(true, avw.q, () -> DSL.taggedChoiceLazy("id", DSL.string(), $$1));
      $$0.registerType(
         true,
         avw.m,
         () -> DSL.hook(
               DSL.optionalFields(
                  "id",
                  DSL.or(DSL.constType(DSL.intType()), avw.s.in($$0)),
                  "tag",
                  DSL.optionalFields(
                     "EntityTag",
                     avw.p.in($$0),
      ...
      $$0.registerType(false, avw.r, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(axd.a())));
      ...
      $$0.registerType(
         ...
         avw.h,
         () -> DSL.optionalFields(
               "data", DSL.optionalFields("Features", DSL.compoundList(avw.v.in($$0)), "Objectives", DSL.list(avw.w.in($$0)), "Teams", DSL.list(avw.x.in($$0)))
            )
      );
      ...
      $$0.registerType(false, avw.k, () -> DSL.optionalFields("Entities", DSL.list(avw.p.in($$0))));
   }

   protected static <T> T a(Dynamic<T> $$0, Map<String, String> $$1, String $$2) {
      return (T)$$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
            String $$3x = $$0.get("id").asString().result().map(axd::a).orElse("minecraft:air");
            ...
            return "minecraft:armor_stand".equals(axd.a($$3x)) ? $$2xx.set("id", $$0.createString($$2)) : $$2xx;
         })).getValue();
   }
}
