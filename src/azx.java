...
public class azx {
   public static final Codec<azx> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(ayu.p.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), ayu.p.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, azx::new)
   );
   ...
   private final Predicate<alg> f;

   private azx(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
