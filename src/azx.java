...
public class azx {
   ...
   private static final Optional<Object> b = Optional.of(bah.a);

   private static boolean a(ya $$0, ayp $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, ya $$1, ayp $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, ya $$1, ayp $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, ya $$1, ayp $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, ya $$2, ayp $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, ya $$2, ya $$3, ayp $$4) {
      int $$5 = $$0.length();
      ya $$6 = $$2;
   ...
   public static boolean a(xi $$0, ya $$1, ayp $$2) {
