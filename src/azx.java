...
public class azx extends ayb {
   public azx(Schema $$0, boolean $$1) {
      super($$0, $$1, "Villager trade fix", ayz.x, "minecraft:villager");
   }
   ...
   protected Typed<?> a(Typed<?> $$0) {
      ...
      if (!($$2.type() instanceof ListType<?> $$4)) {
         ...
         OpticFinder<Pair<String, String>> $$10 = DSL.fieldFinder("id", DSL.named(ayz.z.typeName(), bah.a()));
