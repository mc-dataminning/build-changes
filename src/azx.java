...
public class azx extends DataFix {
   ...
   private Typed<?> a(Typed<?> $$0, Map<String, String> $$1) {
      return $$0.update(DSL.remainderFinder(), $$1x -> {
         for (Entry<String, String> $$2 : $$1.entrySet()) {
            $$1x = ays.a($$1x, $$2.getKey(), $$2.getValue(), ays::a);
         }
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      return $$0.update("frames", $$0x -> $$0x.createList($$0x.asStream().map($$0xx -> {
            $$0xx = ays.a($$0xx, "Pos", "pos", ays::a);
            $$0xx = ays.a($$0xx, "Rotation", "rotation");
            return ays.a($$0xx, "EntityId", "entity_id");
         }))).update("banners", $$0x -> $$0x.createList($$0x.asStream().map($$0xx -> {
            $$0xx = ays.a($$0xx, "Pos", "pos");
            $$0xx = ays.a($$0xx, "Color", "color");
            return ays.a($$0xx, "Name", "name");
         })));
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      $$0.add(
         this.fixTypeEverywhereTyped(
            "BlockPos format for compass target", $$1, bdh.a($$1, "minecraft:compass"::equals, $$0x -> $$0x.update("LodestonePos", ays::a))
         )
      );
   ...
   private void a(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(bfa.z, "minecraft:bee", Map.of("HivePos", "hive_pos", "FlowerPos", "flower_pos")));
      $$0.add(this.a(bfa.z, "minecraft:end_crystal", Map.of("BeamTarget", "beam_target")));
      $$0.add(this.a(bfa.z, "minecraft:wandering_trader", Map.of("WanderTarget", "wander_target")));

      for (String $$1 : a) {
         $$0.add(this.a(bfa.z, $$1, Map.of("PatrolTarget", "patrol_target")));
      }

      $$0.add(
         this.fixTypeEverywhereTyped(
            "BlockPos format in Leash for mobs",
            this.getInputSchema().getType(bfa.z),
            $$0x -> $$0x.update(DSL.remainderFinder(), $$0xx -> ays.a($$0xx, "Leash", "leash", ays::a))
         )
      );
   }

   private void b(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(bfa.s, "minecraft:beehive", Map.of("FlowerPos", "flower_pos")));
      $$0.add(this.a(bfa.s, "minecraft:end_gateway", Map.of("ExitPortal", "exit_portal")));
   }
