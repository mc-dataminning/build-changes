...
public class erf {
   public static void a(fex<?> $$0, erd $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<erc>> $$6 : $$1.c().entrySet()) {
         Optional<fhn> $$7 = $$0.a($$6.getKey());
         List<erc> $$8 = $$6.getValue();
   ...
   private static float a(erd $$0, long $$1) {
