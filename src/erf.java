...
public class erf {
   ...
   public static final Codec<erf> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ag.a($$0, 6).map($$0x -> new erf($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public erf(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static erf a() {
      return new erf(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static erf a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jb $$9) {
      switch ($$9) {
         case d:
         default:
            return new erf($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new erf($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new erf($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new erf($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dir> b() {
      ...
      int $$2 = jy.a(this.k());
      int $$3 = jy.a(this.m());
      return dir.a(new dir($$0, $$1), new dir($$2, $$3));
   }
   ...
   public static Optional<erf> a(Iterable<iv> $$0) {
      Iterator<iv> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         erf $$2 = new erf($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<erf> b(Iterable<erf> $$0) {
      Iterator<erf> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         erf $$2 = $$1.next();
         erf $$3 = new erf($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   public erf b(int $$0, int $$1, int $$2) {
      return new erf(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public erf c(int $$0, int $$1, int $$2) {
      return new erf(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
