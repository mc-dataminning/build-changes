...
public class dvg extends dwa implements cto {
   ...
   private ka<cxh> q = ka.a(9, cxh.k);
   private int r = 0;
   protected final cti k = new cti() {
   ...
   protected csw a(int $$0, cpq $$1) {
      return new ctm($$0, $$1, this, this.k);
   }
   ...
   private boolean a(int $$0, cxh $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            cxh $$4 = this.a($$3);
            if ($$4.f() || $$4.M() < $$0 && cxh.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(dgz $$0, ji $$1, dxq $$2, dvg $$3) {
      int $$4 = $$3.r - 1;
      if ($$4 >= 0) {
         $$3.r = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.b(dlx.b, Boolean.valueOf(false)), 3);
         }
      }
   }
