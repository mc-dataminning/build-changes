...
public class dvg implements dvc, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bpm<bpo.b> c;
   private final dvl d;
   private final Map<dbe, dvg.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvg(dvn $$0, Path $$1, boolean $$2) {
      this.d = new dvl($$0, $$1, $$2);
      this.c = new bpm<>(new bpo.a(dvg.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dbe $$0, int $$1) {
      dbe $$2 = new dbe($$0.e - $$1, $$0.f - $$1);
      dbe $$3 = new dbe($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dbe $$0, @Nullable ur $$1) {
      return this.a(() -> {
         dvg.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvg.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dbe $$0, vl $$1) {
      return this.a(() -> {
         try {
            dvg.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bpo.b(dvg.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dbe, dvg.a>> $$0 = this.e.entrySet().iterator();
         Entry<dbe, dvg.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bpo.b(dvg.b.b.ordinal(), this::a));
   }

   private void a(dbe $$0, dvg.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bpo.b(dvg.b.c.ordinal(), () -> $$0.a(bab.a))).join();
         this.c.close();
