...
public class dvg<T> implements dvo<T> {
   ...
   public dvg(jr<T> $$0, int $$1, dvp<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dvg(jr<T> $$0, int $$1, dvp<T> $$2) {
      this($$0, $$1, $$2, axk.c(1 << $$1));
   }

   private dvg(jr<T> $$0, int $$1, dvp<T> $$2, axk<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dvo<T> c() {
      return new dvg<>(this.a, this.d, this.c, this.b.b());
   }
}
