...
public class fcx extends evc {
   ...
   private void a(us $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         um $$3 = $$0.a($$2);
         String $$4 = $$3.l("Name");
         fcr $$5 = this.c.c($$4);
         xk $$6 = xk.a.a($$3.l("DisplayName"), $$1);
         if ($$6 != null) {
            $$5.a($$6);
         }
         ...
         if ($$3.b("MemberNamePrefix", 8)) {
            xk $$7 = xk.a.a($$3.l("MemberNamePrefix"), $$1);
            if ($$7 != null) {
               $$5.b($$7);
            }
         }
         ...
         if ($$3.b("MemberNameSuffix", 8)) {
            xk $$8 = xk.a.a($$3.l("MemberNameSuffix"), $$1);
            if ($$8 != null) {
               $$5.c($$8);
            }
         }
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            fcy.b $$9 = fcy.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            fcy.b $$10 = fcy.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            fcy.a $$11 = fcy.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(us $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         um $$3 = $$0.a($$2);
         String $$4 = $$3.l("CriteriaName");
         fcz $$5 = fcz.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, fcz.b.d());
            return fcz.b;
         });
         String $$6 = $$3.l("Name");
         xk $$7 = xk.a.a($$3.l("DisplayName"), $$1);
         fcz.a $$8 = fcz.a.a($$3.l("RenderType"));
         boolean $$9 = $$3.q("display_auto_update");
         za $$10 = (za)zc.b.parse($$1.a(va.a), $$3.c("format")).result().orElse(null);
   ...
   private us b(js.a $$0) {
      ...
      for (fcr $$3 : this.c.g()) {
         ...
         $$4.a("MemberNamePrefix", xk.a.a($$3.e(), $$0));
         $$4.a("MemberNameSuffix", xk.a.a($$3.f(), $$0));
   ...
   private us c(js.a $$0) {
      ...
      for (fco $$3 : this.c.c()) {
         ...
         $$4.a("DisplayName", xk.a.a($$3.d(), $$0));
         $$4.a("RenderType", $$3.h().a());
         $$4.a("display_auto_update", $$3.e());
         za $$5 = $$3.f();
         if ($$5 != null) {
            zc.b.encodeStart($$0.a(va.a), $$5).ifSuccess($$1x -> $$4.a("format", $$1x));
         }
