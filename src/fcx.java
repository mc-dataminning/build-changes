public abstract class fcx {
   ...
   public void a(fav $$0, int $$1, int $$2) {
      int $$3 = $$0.b();
      $$0.a(fya.E(), $$1, $$3 - 60, $$1 + $$2, $$3, -1873784752);
      long $$4 = 0L;
      long $$5 = 2147483647L;
      long $$6 = -2147483648L;
      ...
      $$0.a(fya.E(), $$1, $$1 + $$2 - 1, $$3 - 60, -1);
      $$0.a(fya.E(), $$1, $$1 + $$2 - 1, $$3 - 1, -1);
      $$0.b(fya.E(), $$1, $$3 - 60, $$3, -1);
      $$0.b(fya.E(), $$1 + $$2 - 1, $$3 - 60, $$3, -1);
      if ($$8 > 0) {
   ...
   protected void b(fav $$0, int $$1, int $$2, int $$3) {
      long $$4 = this.e.a($$3);
      int $$5 = this.b((double)$$4);
      int $$6 = this.a($$4);
      $$0.a(fya.E(), $$2, $$1 - $$5, $$2 + 1, $$1, $$6);
   }

   protected void c(fav $$0, int $$1, int $$2, int $$3) {
   }
   ...
   protected void d(fav $$0, int $$1, int $$2, int $$3) {
   }

   protected void a(fav $$0, String $$1, int $$2, int $$3) {
      $$0.a(fya.E(), $$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
