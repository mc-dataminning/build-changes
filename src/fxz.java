public abstract class fxz<T extends cvz> extends fxx<T> implements gbm {
   private final gbh<?> G;
   private boolean H;

   public fxz(T $$0, gbh<?> $$1, cqr $$2, ww $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fvw G();

   private void M() {
      fvw $$0 = this.G();
      this.c(new fsc($$0.a(), $$0.b(), 20, 18, gbh.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fvw $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
