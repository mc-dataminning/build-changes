...
public class fxz extends fye<cah> {
   private static final ahd a = new ahd("textures/entity/end_crystal/end_crystal.png");
   ...
   public static fmv a() {
      fmx $$0 = new fmx();
      fmy $$1 = $$0.a();
      $$1.a("glass", fmu.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fmr.a);
      $$1.a("cube", fmu.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fmr.a);
      $$1.a("base", fmu.c().a(0, 16).a(-6.0F, 0.0F, -6.0F, 12.0F, 4.0F, 12.0F), fmr.a);
      return fmv.a($$0, 64, 32);
   }

   public void a(cah $$0, float $$1, float $$2, ept $$3, fsz $$4, int $$5) {
      $$3.a();
      float $$6 = a($$0, $$2);
      ...
      if ($$11 != null) {
         ...
         $$3.a($$15, $$16, $$17);
         fya.a(-$$15, -$$16 + $$6, -$$17, $$2, $$0.b, $$3, $$4, $$5);
      }

      super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   public static float a(cah $$0, float $$1) {
      float $$2 = (float)$$0.b + $$1;
      float $$3 = aui.a($$2 * 0.2F) / 2.0F + 0.5F;
      $$3 = ($$3 * $$3 + $$3) * 0.4F;
      return $$3 - 1.4F;
   }
   ...
   public boolean a(cah $$0, fwc $$1, double $$2, double $$3, double $$4) {
