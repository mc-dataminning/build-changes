...
public class djv {
   ...
   private final Map<Character, Predicate<djt>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public djv a(char $$0, Predicate<djt> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dju b() {
      return new dju(this.c());
   }

   private Predicate<djt>[][][] c() {
      this.d();
      Predicate<djt>[][][] $$0 = (Predicate<djt>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<djt>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
