...
public interface djv {
   static djv a(dkn $$0, cot $$1, dkp $$2, dkw $$3, int $$4, int $$5, djv.a $$6) {
      return new djv.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static djv a(final djv.a $$0) {
      return new djv() {
         @Nullable
         @Override
         public dfa a(dkc.b $$0x, double $$1) {
   ...
   @Nullable
   dfa a(dkc.b var1, double var2);

   boolean a();

   public interface a {
      djv.b computeFluid(int var1, int var2, int var3);
   }
   ...
   public static final class b {
      ...
      public b(int $$0, dfa $$1) {
         this.a = $$0;
         this.b = $$1;
      }

      public dfa a(int $$0) {
         return $$0 < this.a ? this.b : csn.a.n();
      }
   }

   public static class c implements djv {
      ...
      private final dkc p;
      private final dkw q;
      private final djv.b[] r;
      private final long[] s;
      private final djv.a t;
      private final dkc u;
      private final dkc v;
      private boolean w;
      private final int x;
      ...
      c(dkn $$0, cot $$1, dkp $$2, dkw $$3, int $$4, int $$5, djv.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dfa a(dkc.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            djv.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(csn.H)) {
               this.w = false;
               return csn.H.n();
            } else {
               ...
               if ($$31 <= 0.0) {
                  this.w = $$31 >= k;
                  return $$32;
               } else if ($$32.a(csn.G) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(csn.H)) {
                  this.w = true;
                  return $$32;
               } else {
      ...
      private double a(dkc.b $$0, MutableDouble $$1, djv.b $$2, djv.b $$3) {
         int $$4 = $$0.b();
         dfa $$5 = $$2.a($$4);
         dfa $$6 = $$3.a($$4);
         if ((!$$5.a(csn.H) || !$$6.a(csn.G)) && (!$$5.a(csn.G) || !$$6.a(csn.H))) {
      ...
      private djv.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            djv.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private djv.b b(int $$0, int $$1, int $$2) {
         djv.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               djv.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).i()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new djv.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, djv.b $$3, int $$4, boolean $$5) {
         dkc.e $$6 = new dkc.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (cra.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new dkc.e($$6, $$7, $$8)) * 10.0;
         int $$12 = arp.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dfa a(int $$0, int $$1, int $$2, djv.b $$3, int $$4) {
         dfa $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != dij.g && $$3.b != csn.H.n()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new dkc.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = csn.H.n();
            }
         }
