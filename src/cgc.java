...
public class cgc extends cga {
   ...
   public cgc(blz<? extends cgc> $$0, ctp $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public cgc(ctp $$0, bml $$1, blv $$2, ic.a $$3) {
      this(blz.aI, $$0);
      this.b($$1);
      hx $$4 = $$1.dm();
   ...
   public void l() {
      ...
      if (!this.dM().B) {
         ...
         if (this.c == null || !this.c.bx() || this.c instanceof cfi && this.c.P_()) {
            if (!this.aV()) {
               this.g(this.dp().b(0.0, -0.04, 0.0));
            }
         } else {
            this.f = auo.a(this.f * 1.025, -1.0, 1.0);
            this.g = auo.a(this.g * 1.025, -1.0, 1.0);
            this.h = auo.a(this.h * 1.025, -1.0, 1.0);
            elt $$0 = this.dp();
            this.g($$0.b((this.f - $$0.c) * 0.2, (this.g - $$0.d) * 0.2, (this.h - $$0.e) * 0.2));
         }

         elr $$1 = cgb.a(this, this::a);
         if ($$1.c() != elr.a.a) {
            this.a($$1);
         }
      }
   ...
   protected void a(elq $$0) {
      ...
      blv $$1 = $$0.a();
      blv $$2 = this.w();
      bml $$3 = $$2 instanceof bml ? (bml)$$2 : null;
      boolean $$4 = $$1.a(this.dN().a(this, $$3), 4.0F);
      if ($$4) {
         this.a($$3, $$1);
         if ($$1 instanceof bml $$5) {
            $$5.b(new bli(blk.y, 200), (blv)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(elp $$0) {
      ...
      this.a(ars.vR, 1.0F, 1.0F);
   }

   private void s() {
      this.am();
      this.dM().a(dnr.o, this.dk(), dnr.a.a(this));
   }
