...
public class blf extends bkz {
   public static final Codec<blf> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static blf a(float $$0, float $$1, float $$2) {
      return new blf($$0, $$1, $$2);
   }

   private blf(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
