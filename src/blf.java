...
public class blf extends bko {
   ...
   protected static void b(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> ble.a($$0));
   }

   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = Maps.newHashMap();
      $$0.register($$1, "minecraft:area_effect_cloud", $$1x -> DSL.optionalFields("Particle", bit.y.in($$0)));
      a($$0, $$1, "minecraft:armor_stand");
      $$0.register($$1, "minecraft:arrow", $$1x -> DSL.optionalFields("inBlockState", bit.u.in($$0)));
      a($$0, $$1, "minecraft:bat");
      a($$0, $$1, "minecraft:blaze");
      $$0.registerSimple($$1, "minecraft:boat");
      a($$0, $$1, "minecraft:cave_spider");
      $$0.register($$1, "minecraft:chest_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0), "Items", DSL.list(bit.t.in($$0))));
      a($$0, $$1, "minecraft:chicken");
      $$0.register($$1, "minecraft:commandblock_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0), "LastOutput", bit.z.in($$0)));
      a($$0, $$1, "minecraft:cow");
      a($$0, $$1, "minecraft:creeper");
      $$0.register($$1, "minecraft:donkey", $$1x -> DSL.optionalFields("Items", DSL.list(bit.t.in($$0)), "SaddleItem", bit.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carriedBlockState", bit.u.in($$0)));
      ...
      $$0.register($$1, "minecraft:falling_block", $$1x -> DSL.optionalFields("BlockState", bit.u.in($$0), "TileEntityData", bit.s.in($$0)));
      $$0.registerSimple($$1, "minecraft:fireball");
      $$0.register($$1, "minecraft:fireworks_rocket", $$1x -> DSL.optionalFields("FireworksItem", bit.t.in($$0)));
      $$0.register($$1, "minecraft:furnace_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0)));
      a($$0, $$1, "minecraft:ghast");
      a($$0, $$1, "minecraft:giant");
      a($$0, $$1, "minecraft:guardian");
      $$0.register($$1, "minecraft:hopper_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0), "Items", DSL.list(bit.t.in($$0))));
      $$0.register($$1, "minecraft:horse", $$1x -> DSL.optionalFields("ArmorItem", bit.t.in($$0), "SaddleItem", bit.t.in($$0)));
      a($$0, $$1, "minecraft:husk");
      a($$0, $$1, "minecraft:illusion_illager");
      $$0.register($$1, "minecraft:item", $$1x -> DSL.optionalFields("Item", bit.t.in($$0)));
      $$0.register($$1, "minecraft:item_frame", $$1x -> DSL.optionalFields("Item", bit.t.in($$0)));
      $$0.registerSimple($$1, "minecraft:leash_knot");
      $$0.register(
         $$1, "minecraft:llama", $$1x -> DSL.optionalFields("Items", DSL.list(bit.t.in($$0)), "SaddleItem", bit.t.in($$0), "DecorItem", bit.t.in($$0))
      );
      $$0.registerSimple($$1, "minecraft:llama_spit");
      a($$0, $$1, "minecraft:magma_cube");
      $$0.register($$1, "minecraft:minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0)));
      a($$0, $$1, "minecraft:mooshroom");
      $$0.register($$1, "minecraft:mule", $$1x -> DSL.optionalFields("Items", DSL.list(bit.t.in($$0)), "SaddleItem", bit.t.in($$0)));
      a($$0, $$1, "minecraft:ocelot");
      $$0.registerSimple($$1, "minecraft:painting");
      a($$0, $$1, "minecraft:parrot");
      a($$0, $$1, "minecraft:pig");
      a($$0, $$1, "minecraft:polar_bear");
      $$0.register($$1, "minecraft:potion", $$1x -> DSL.optionalFields("Potion", bit.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", $$1x -> DSL.optionalFields("SaddleItem", bit.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0), bit.H.in($$0)));
      $$0.register($$1, "minecraft:spectral_arrow", $$1x -> DSL.optionalFields("inBlockState", bit.u.in($$0)));
      a($$0, $$1, "minecraft:spider");
      a($$0, $$1, "minecraft:squid");
      a($$0, $$1, "minecraft:stray");
      $$0.registerSimple($$1, "minecraft:tnt");
      $$0.register($$1, "minecraft:tnt_minecart", $$1x -> DSL.optionalFields("DisplayState", bit.u.in($$0)));
      a($$0, $$1, "minecraft:vex");
      $$0.register(
         $$1,
         "minecraft:villager",
         $$1x -> DSL.optionalFields("Inventory", DSL.list(bit.t.in($$0)), "Offers", DSL.optionalFields("Recipes", DSL.list(bit.x.in($$0))))
      );
      ...
      $$0.register($$1, "minecraft:zombie_horse", $$1x -> DSL.optionalFields("SaddleItem", bit.t.in($$0)));
      a($$0, $$1, "minecraft:zombie_pigman");
      $$0.register($$1, "minecraft:zombie_villager", $$1x -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(bit.x.in($$0)))));
      return $$1;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:jukebox", $$1x -> DSL.optionalFields("RecordItem", bit.t.in($$0)));
      b($$0, $$1, "minecraft:dispenser");
      b($$0, $$1, "minecraft:dropper");
      $$0.register($$1, "minecraft:sign", () -> bop.a($$0));
      $$0.register($$1, "minecraft:mob_spawner", $$1x -> bit.H.in($$0));
      $$0.register($$1, "minecraft:piston", $$1x -> DSL.optionalFields("blockState", bit.u.in($$0)));
      b($$0, $$1, "minecraft:brewing_stand");
      $$0.register($$1, "minecraft:enchanting_table", () -> ble.b($$0));
      $$0.registerSimple($$1, "minecraft:end_portal");
      $$0.register($$1, "minecraft:beacon", () -> ble.b($$0));
      $$0.register($$1, "minecraft:skull", () -> DSL.optionalFields("custom_name", bit.z.in($$0)));
      $$0.registerSimple($$1, "minecraft:daylight_detector");
      b($$0, $$1, "minecraft:hopper");
      $$0.registerSimple($$1, "minecraft:comparator");
      $$0.register($$1, "minecraft:banner", () -> ble.b($$0));
      $$0.registerSimple($$1, "minecraft:structure_block");
      $$0.registerSimple($$1, "minecraft:end_gateway");
      $$0.register($$1, "minecraft:command_block", () -> DSL.optionalFields("LastOutput", bit.z.in($$0)));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bit.L, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         bit.b,
         () -> DSL.optionalFields(
      ...
      $$0.registerType(true, bit.s, () -> DSL.optionalFields("components", bit.w.in($$0), DSL.taggedChoiceLazy("id", a(), $$2)));
      $$0.registerType(true, bit.C, () -> DSL.optionalFields("Passengers", DSL.list(bit.C.in($$0)), bit.D.in($$0)));
      $$0.registerType(true, bit.D, () -> DSL.and(bit.A.in($$0), DSL.optionalFields("CustomName", bit.z.in($$0), DSL.taggedChoiceLazy("id", a(), $$1))));
      $$0.registerType(true, bit.t, () -> DSL.hook(DSL.optionalFields("id", bit.F.in($$0), "tag", bop.b($$0)), bon.b, HookFunction.IDENTITY));
      ...
      $$0.registerType(false, bit.E, () -> DSL.constType(a()));
      $$0.registerType(false, bit.F, () -> DSL.constType(a()));
      $$0.registerType(false, bit.u, DSL::remainder);
      $$0.registerType(false, bit.v, DSL::remainder);
      Supplier<TypeTemplate> $$3 = () -> DSL.compoundList(bit.F.in($$0), DSL.constType(DSL.intType()));
      $$0.registerType(
         false,
         bit.g,
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  new Pair[]{
                     Pair.of("minecraft:mined", DSL.compoundList(bit.E.in($$0), DSL.constType(DSL.intType()))),
                     ...
                     Pair.of("minecraft:killed", DSL.compoundList(bit.B.in($$0), DSL.constType(DSL.intType()))),
                     Pair.of("minecraft:killed_by", DSL.compoundList(bit.B.in($$0), DSL.constType(DSL.intType()))),
      ...
      $$0.registerType(false, bit.I, DSL::remainder);
      Map<String, Supplier<TypeTemplate>> $$4 = bld.a($$0);
      $$0.registerType(
         false,
         bit.J,
         () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4), "DisplayName", bit.z.in($$0)), bld.c, bld.d)
      );
      $$0.registerType(
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields("criteria", DSL.compoundList(bit.M.in($$0), DSL.constType(DSL.string()))),
               "minecraft:adventure/kill_a_mob",
               DSL.optionalFields("criteria", DSL.compoundList(bit.B.in($$0), DSL.constType(DSL.string()))),
      ...
      $$0.registerType(false, bit.M, () -> DSL.constType(a()));
      $$0.registerType(false, bit.B, () -> DSL.constType(a()));
