...
public class blf extends bjj {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "biomes",
                        DSL.optionalFields("palette", DSL.list(bhv.K.in($$0))),
                        "block_states",
                        DSL.optionalFields("palette", DSL.list(bhv.u.in($$0)))
                     )
                  ),
                  "Structures",
      ...
      $$0.registerType(false, bhv.L, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         bhv.M,
         () -> DSL.fields(
                           ...
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 ...
                                 DSL.taggedChoiceLazy(
                                    ...
                                    ImmutableMap.of(
                                       ...
                                       (Supplier<TypeTemplate>)() -> DSL.or(DSL.fields("preset", bhv.L.in($$0)), DSL.list(DSL.fields("biome", bhv.K.in($$0)))),
