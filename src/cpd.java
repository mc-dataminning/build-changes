...
public class cpd extends cor {
   ...
   public cpd(bsy<? extends cpd> $$0, dbw $$1) {
      super($$0, $$1);
   }

   public cpd(dbw $$0, double $$1, double $$2, double $$3) {
      super(bsy.bd, $$0, $$1, $$2, $$3);
   }
   ...
   public boolean a(brl $$0, float $$1) {
      if ($$0.c() instanceof cnb $$3 && $$3.bQ()) {
         brl $$4 = this.dQ().d(this, $$0.d());
         this.a($$4, $$3.ds().g());
      }
   ...
   protected void a(@Nullable brl $$0, double $$1) {
      if (!this.dP().B) {
         ...
         this.dP().a(this, $$0, null, this.du(), this.dw(), this.dA(), (float)(4.0 + this.ah.j() * 1.5 * $$2), false, dbw.a.d);
         this.ao();
      }
   }
   ...
   private static boolean e(brl $$0) {
