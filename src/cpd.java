...
public abstract class cpd extends cpo {
   public static final double a = 0.1;
   public static final double b = 0.5;
   public double c = 0.1;

   protected cpd(buq<? extends cpd> $$0, dgg $$1) {
      super($$0, $$1);
   }

   protected cpd(buq<? extends cpd> $$0, double $$1, double $$2, double $$3, dgg $$4) {
      this($$0, $$4);
      this.a_($$1, $$2, $$3);
   }

   public cpd(buq<? extends cpd> $$0, double $$1, double $$2, double $$3, fay $$4, dgg $$5) {
      this($$0, $$5);
   ...
   public cpd(buq<? extends cpd> $$0, bvf $$1, fay $$2, dgg $$3) {
   ...
   public void h() {
      ...
      if (this.dW().C || ($$0 == null || !$$0.dR()) && this.dW().B(this.dw())) {
         faw $$1 = cpq.a(this, this::b, this.ak_());
         fay $$2;
         if ($$1.d() != faw.a.a) {
            $$2 = $$1.g();
         } else {
