...
public abstract class cpd extends cpp {
   private static final double d = 2.0;
   private static final int e = 7;
   private static final float f = 0.6F;
   private static final float g = 0.99F;
   private static final ajy<Byte> h = akc.a(cpd.class, aka.a);
   private static final ajy<Byte> i = akc.a(cpd.class, aka.a);
   private static final ajy<Boolean> j = akc.a(cpd.class, aka.k);
   private static final int k = 1;
   private static final int l = 2;
   @Nullable
   private dww m;
   protected int a;
   public cpd.a b = cpd.a.a;
   public int c;
   private int n;
   ...
   @Nullable
   private List<buk> r;
   private cwo s = this.v();
   @Nullable
   private cwo t = null;

   protected cpd(bur<? extends cpd> $$0, dgh $$1) {
      super($$0, $$1);
   }

   protected cpd(bur<? extends cpd> $$0, double $$1, double $$2, double $$3, dgh $$4, cwo $$5, @Nullable cwo $$6) {
      this($$0, $$4);
      this.s = $$5.v();
      this.b($$5.a(kv.g));
      baf $$7 = $$5.d(kv.v);
   ...
   protected cpd(bur<? extends cpd> $$0, bvg $$1, dgh $$2, cwo $$3, @Nullable cwo $$4) {
   ...
   public void h() {
      ...
      if (this.l() && $$0) {
         ...
         this.v(f(this.dL(), $$9));
         if ($$0) {
            fav $$12 = this.dV().b(new dfp($$7, $$7.e($$1), dfp.a.a, dfp.b.a, this));
            this.b($$12);
         } else {
            this.b($$7.e($$1));
            this.aK();
   ...
   private void b(fav $$0) {
      while (this.bL()) {
         faz $$1 = this.dt();
         faw $$2 = this.c($$1, $$0.g());
         faz $$3 = Objects.requireNonNullElse($$2, $$0).g();
         this.b($$3);
         this.a($$1, $$3);
   ...
   private boolean D() {
      return this.l() && this.dV().b(new fau(this.dt(), this.dt()).g(0.06));
   }
   ...
   protected void a(faw $$0) {
      ...
      double $$3 = this.o;
      buk $$4 = this.p();
      bta $$5 = this.dW().a(this, (buk)($$4 != null ? $$4 : this));
      if (this.dZ() != null && this.dV() instanceof ard $$6) {
         $$3 = (double)dda.a($$6, this.dZ(), $$1, $$5, (float)$$3);
      }
      ...
      if ($$1.b($$5, (float)$$7)) {
         ...
         if ($$1 instanceof bvg $$12) {
            ...
            if (this.dV() instanceof ard $$13) {
               dda.a($$13, $$12, $$5, this.dZ());
            }

            this.a($$12);
            if ($$12 != $$4 && $$12 instanceof cow && $$4 instanceof are && !this.bb()) {
   ...
   protected void a(bvg $$0, bta $$1) {
      double $$3 = (double)(this.t != null && this.dV() instanceof ard $$2 ? dda.d($$2, this.t, $$0, $$1, 0.0F) : 0.0F);
      if ($$3 > 0.0) {
         double $$4 = Math.max(0.0, 1.0 - $$0.h(bwo.p));
         faz $$5 = this.dy().d(1.0, 0.0, 1.0).d().c($$3 * 0.6 * $$4);
         if ($$5.h() > 0.0) {
            $$0.j($$5.d, 0.1, $$5.f);
         }
      }
   ...
   protected void a(fav $$0) {
      ...
      faz $$3 = this.dy();
      faz $$4 = new faz(Math.signum($$3.d), Math.signum($$3.e), Math.signum($$3.f));
      faz $$5 = $$4.c(0.05F);
      this.b(this.dt().d($$5));
      this.i(faz.c);
   ...
   protected void a(ard $$0, fav $$1, cwo $$2) {
      faz $$3 = $$1.b().a($$1.g());
      dda.a($$0, $$2, this.p() instanceof bvg $$4 ? $$4 : null, this, null, $$3, $$0.a_($$1.b()), $$0x -> this.t = null);
   }
   ...
   protected faw c(faz $$0, faz $$1) {
      return cpr.a(this.dV(), this, $$0, $$1, this.cR().b(this.dy()).g(1.0), this::b);
   }

   @Override
   protected boolean b(buk $$0) {
      return $$0 instanceof cow && this.p() instanceof cow $$1 && !$$1.a((cow)$$0) ? false : super.b($$0) && (this.q == null || !this.q.contains($$0.ar()));
   }
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("weapon", 10)) {
         this.t = cwo.a(this.dX(), (un)$$0.p("weapon")).orElse(null);
      } else {
         this.t = null;
      }
   }
   ...
   public void c(@Nullable buk $$0) {
      ...
      this.b = switch ($$0) {
         ...
         case cow $$1 when this.b == cpd.a.a -> cpd.a.b;
         case bvm $$2 -> cpd.a.a;
      };
   }
