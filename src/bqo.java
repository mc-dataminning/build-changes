...
public abstract class bqo extends bqb {
   ...
   public bqo(bjp $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bqo(bjp $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
   ...
   protected abstract boolean a(cpy var1, gw var2);
}
