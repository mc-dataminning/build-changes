...
public class bqo extends bqs {
   public static final MapCodec<bqo> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bqo a(float $$0, float $$1, float $$2, float $$3) {
      return new bqo($$0, $$1, $$2, $$3);
   }

   private bqo(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(azl $$0, float $$1, float $$2, float $$3, float $$4) {
      return azd.a(azd.c($$0, $$1, $$2), $$3, $$4);
   }
