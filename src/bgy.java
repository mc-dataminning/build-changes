...
public class bgy implements bgz {
   ...
   private static final bgy j = new bgy();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bgx $$0) {
      URL $$1 = bgy.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bgx $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bhb a = new bhb(() -> bgy.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bgy.this.k && $$0.getState() == RecordingState.STOPPED) {
