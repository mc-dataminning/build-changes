...
public class frg {
   ...
   private int k;
   private double l;
   private final baj m = new baj();
   private final baj n = new baj();
   private double o;
   private double p;
   private final fro q;
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.Z_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = azq.a(this.b.t.gk().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gk().a($$11);
                  }
               } else {
                  cry $$12 = this.b.t.gj();
                  $$12.c(fro.a((double)$$10, $$12.f(), cry.h()));
               }
            }
         }
      }
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            fkc.a(this.b.aO().h(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aO().m() / 2);
         this.g = (double)(this.b.aO().n() / 2);
         fkc.a(this.b.aO().h(), 212993, this.f, this.g);
      }
   }
