...
public class frg implements feq {
   static final Logger b = LogUtils.getLogger();
   private final ffr c;
   private final fqu<frg.b> d;

   frg(ffr $$0, fqu<frg.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alz c, int d, int e, int[][] f) implements fri {
      ...
      public static final MapCodec<frg.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alz.a.fieldOf("file").forGetter(frg.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(frg.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(frg.a::e),
                     g.fieldOf("chars").forGetter(frg.a::f)
                  )
                  .apply($$0, frg.a::new)
         )
         .validate(frg.a::a);
      ...
      private static DataResult<frg.a> a(frg.a $$0) {
      ...
      private feq a(avv $$0) throws IOException {
         ...
         try (InputStream $$2 = $$0.open($$1)) {
            ...
            fqu<frg.b> $$9 = new fqu<>(frg.b[]::new, frg.b[][]::new);
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     frg.b $$15 = $$9.a($$12, new frg.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        frg.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
