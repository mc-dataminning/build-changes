...
public class gsx extends gqf<cid, gyw, gce> {
   private static final Map<cid.a, alp> a = ae.a(Maps.newEnumMap(cid.a.class), $$0 -> {
      $$0.put(cid.a.a, alp.b("textures/entity/panda/panda.png"));
      $$0.put(cid.a.b, alp.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(cid.a.c, alp.b("textures/entity/panda/worried_panda.png"));
      $$0.put(cid.a.d, alp.b("textures/entity/panda/playful_panda.png"));
      $$0.put(cid.a.e, alp.b("textures/entity/panda/brown_panda.png"));
      $$0.put(cid.a.f, alp.b("textures/entity/panda/weak_panda.png"));
      $$0.put(cid.a.g, alp.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gsx(grl.a $$0) {
      super($$0, new gce($$0.a(gei.bL)), new gce($$0.a(gei.bM)), 0.9F);
      this.a(new gvw(this, $$0.b()));
   }

   public alp a(gyw $$0) {
      return a.getOrDefault($$0.a, a.get(cid.a.a));
   }
   ...
   public void a(cid $$0, gyw $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.gC();
      $$1.b = $$0.p() > 0;
      $$1.c = $$0.t();
   ...
   protected void a(gyw $$0, fgl $$1, float $$2, float $$3) {
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(azu.h($$24, $$0.V, $$0.V + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(azu.h($$26, $$0.V, $$0.V + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? azu.h($$3, $$0, $$1) : $$0;
   }
}
