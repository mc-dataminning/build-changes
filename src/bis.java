...
public class bis extends bid {
               ...
               $$2.get("CriteriaName")
                  ...
                  .map($$0x -> {
                     ...
                     if ($$1x < 0) {
                        ...
                        try {
                           akr $$2x = akr.a($$0x.substring(0, $$1x), '.');
                           akr $$3 = akr.a($$0x.substring($$1x + 1), '.');
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bgr.H, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), c, d));
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", bgr.D.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", bgr.C.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", bgr.z.in($$0));
