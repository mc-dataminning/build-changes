...
public class bis implements bit {
   ...
   private static final bis j = new bis();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bir $$0) {
      URL $$1 = bis.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bir $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final biv a = new biv(() -> bis.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bis.this.k && $$0.getState() == RecordingState.STOPPED) {
