...
public class bis extends bgp {
   private static final Logger a = LogUtils.getLogger();

   public bis(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bhu.s, "minecraft:trial_spawner");
   }

   public Dynamic<?> a(Dynamic<vh> $$0) {
      Optional<Dynamic<vh>> $$1 = $$0.get("normal_config").result();
      if ($$1.isEmpty()) {
         return $$0;
      } else {
         Optional<Dynamic<vh>> $$2 = $$0.get("ominous_config").result();
         if ($$2.isEmpty()) {
            return $$0;
         } else {
            ali $$3 = bis.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(uy.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<vh>, Dynamic<vh>>, ali> a = new HashMap<>();

      private a() {
      }

      private static void a(ali $$0, String $$1, String $$2) {
         try {
            uk $$3 = a($$1);
            uk $$4 = a($$2);
            uk $$5 = $$3.i().a($$4);
      ...
      private static Dynamic<vh> a(uk $$0) {
         return new Dynamic(uy.a, $$0);
      }

      private static uk a(String $$0) {
         try {
            return vi.a($$0);
      ...
      static {
         ...
         a(
            ali.b("trial_chamber/melee/husk"),
         ...
         a(
            ali.b("trial_chamber/melee/spider"),
         ...
         a(
            ali.b("trial_chamber/melee/zombie"),
         ...
         a(
            ali.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            ali.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            ali.b("trial_chamber/ranged/stray"),
         ...
         a(
            ali.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            ali.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            ali.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            ali.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            ali.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            ali.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            ali.b("trial_chamber/small_melee/slime"),
