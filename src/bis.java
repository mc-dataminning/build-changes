...
public class bis extends bhn {
   public bis(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", biq.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bkj.a($$0.get("id").asString("minecraft:air"));
