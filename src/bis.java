...
public abstract class bis<R extends Runnable> implements bia, biu<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bis(String $$0) {
      this.b = $$0;
      bhy.a.a(this);
   }
   ...
   @Override
   public List<bhx> bp() {
      return ImmutableList.of(bhx.a(this.b + "-pending-tasks", bhw.b, this::br));
   }
}
