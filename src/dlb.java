...
public class dlb extends den {
   public static final MapCodec<dlb> c = b(dlb::new);
   public static final dsr d = dsq.r;
   private static final Map<dbc, List<dlb.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dbw $$0, iz $$1, boolean $$2) {
      List<dlb.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dlb.a($$1.i(), $$0.Z()));
      }
