...
public class aoc {
   ...
   final List<uh> g = Collections.synchronizedList(Lists.newArrayList());

   public aoc(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new anx(aoc.this.d()));
               uh.a($$1, xh.a, null);
               int $$2 = aoc.this.e.m();
               uh $$3 = (uh)($$2 > 0 ? new us($$2) : new uh(xh.a));
               aoc.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new aoe(aoc.this.e, $$3));
            }
            ...
            if (!$$1.l()) {
               if ($$1.k()) {
                  try {
                     ...
                     vg $$3 = vg.b("Internal server error");
                     $$1.a(new xl($$3), uq.a(() -> $$1.a($$3)));
                     $$1.o();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<aoc.a.a> d = Lists.newArrayList();
