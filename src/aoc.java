...
class aoc implements Path {
   private static final BasicFileAttributes a = new aoa() {
      @Override
   ...
   private static final BasicFileAttributes b = new aoa() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aoc> c = Comparator.comparing(aoc::n);
   ...
   public aoc(aoe $$0, String $$1, @Nullable aoc $$2, aof $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aoc a(@Nullable aoc $$0, String $$1) {
      return new aoc(this.e, $$1, $$0, aof.b);
   }
   ...
   aoc a(String $$0) {
      if (a(this.i)) {
         return new aoc(this.e, $$0, this, this.i);
      } else if (this.i instanceof aof.a $$1) {
         aoc $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aoc(this.e, $$0, this, aof.a);
      } else if (this.i instanceof aof.b) {
         return new aoc(this.e, $$0, this, aof.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aof $$0) {
      return $$0 == aof.a || $$0 == aof.b;
   }
   ...
   private aoc c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aoc $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aof.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aof.a i() {
      return this.i instanceof aof.a $$0 ? $$0 : null;
   }
