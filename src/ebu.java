...
public abstract class ebu<M extends ebr<M>> {
   private final csb i;
   ...
   protected final Long2ObjectMap<diy> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected ebu(csb $$0, djg $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected diy a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected diy a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected diy c(long $$0) {
      diy $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = iu.e($$0);
      diy $$2 = this.a($$1, true);
      return $$2.a(iu.b(ht.a($$0)), iu.b(ht.b($$0)), iu.b(ht.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(iu.b(ht.a($$0)), iu.b(ht.b($$0)), iu.b(ht.c($$0)), $$1);
      iu.a($$0, this.f::add);
   }
   ...
   protected void a(ebx<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            diy $$2 = (diy)this.g.remove($$1);
            diy $$3 = this.d.d($$1);
            if (this.k.contains(iu.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<diy>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<diy> $$6 = (Entry<diy>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               diy $$8 = (diy)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable diy $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = iu.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, ebu.a.a($$9, ebu.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public ebu.b k(long $$0) {
      return ebu.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static ebu.b c(byte $$0) {
         if ($$0 == 0) {
            return ebu.b.a;
         } else {
            return a($$0) ? ebu.b.c : ebu.b.b;
         }
      }
   }
