...
public class ebu extends eaz<edl> {
   ...
   protected boolean a(
      dcu $$0, azh $$1, edl $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dsd $$0, Function<iz, dsd> $$1, azh $$2, edl $$3, edl.a $$4, iz.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
