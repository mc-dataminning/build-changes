...
public class foe {
   ...
   public static List<foe.a> a(String $$0, foe.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<foe.a> a(String $$0, List<foe.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<foe.a> a(List<String> $$0, List<foe.b> $$1) {
      int $$2 = 0;
      List<foe.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<foe.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static foe.b a(String $$0, String $$1) {
         return new foe.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static foe.b a(String $$0) {
         return new foe.b($$0);
      }
   }
}
