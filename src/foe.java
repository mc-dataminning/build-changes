...
public abstract class foe extends fne {
   private final dqs b;
   private dqt c;
   ...
   public foe(dqs $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, xp.c("sign.edit"));
   }

   public foe(dqs $$0, boolean $$1, boolean $$2, xp $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
   ...
   @Override
   protected void aM_() {
      this.c(fhf.a(xo.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fjz(() -> this.d[this.u], this::a, fjz.a(this.m), fjz.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   protected abstract void a(fgs var1, dsd var2);
   ...
   private void d(fgs $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : ggd.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gdx.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
