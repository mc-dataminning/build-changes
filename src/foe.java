...
public class foe {
   ...
   public void a(final foc $$0, final Runnable $$1) throws UnknownHostException {
      final fpe $$2 = fpe.a($$0.b);
      Optional<InetSocketAddress> $$3 = fpg.a.a($$2).map(fpd::d);
      if ($$3.isEmpty()) {
         this.a(fbu.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fpe $$1, final foc $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)ug.g.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fnw($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.g = -1;
               $$2.h = vf.b($$2xx);
               $$2.d = vf.b($$3);
               $$2.c = foe.a($$4, $$5);
