public class foe extends fns<cpt> {
   ...
   protected void a(cra $$0, int $$1, int $$2, cpo $$3) {
      if ($$0 instanceof cpu && !$$0.h() && !this.I.N_()) {
         switch ($$3) {
            case a:
               if (this.w.e($$1)) {
                  this.a($$1);
   ...
   private void a(int $$0, boolean $$1) {
      ...
      this.I.a(avf.Ar.a(), 0.4F, $$2);
   }

   @Override
   public void a(fgz $$0, cra $$1) {
      if ($$1 instanceof cpu $$2 && this.w.e($$1.d)) {
         this.a($$0, $$2);
         return;
      }
   ...
   public void a(fgz $$0, int $$1, int $$2, float $$3) {
      ...
      this.c($$0);
      this.a($$0, $$1, $$2);
      if (this.y instanceof cpu && !this.w.e(this.y.d) && this.w.g().e() && !this.y.h() && !this.I.N_()) {
         $$0.a(this.o, H, $$1, $$2);
      }
   }
