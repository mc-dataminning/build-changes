...
public class foe {
   ...
   private void a(n $$0, ww $$1) {
      this.b.m.d().a(ww.i().b(ww.c("debug.prefix").a($$0, n.r)).b(wv.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(ww.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dim)MoreObjects.firstNonNull(this.b.r.h(), dim.b)).b());
               }
            ...
            case 81:
               ...
               frr $$3 = this.b.m.d();
               $$3.a(ww.c("debug.reload_chunks.help"));
               $$3.a(ww.c("debug.show_hitboxes.help"));
               $$3.a(ww.c("debug.copy_location.help"));
               $$3.a(ww.c("debug.clear_chat.help"));
               $$3.a(ww.c("debug.chunk_boundaries.help"));
               $$3.a(ww.c("debug.advanced_tooltips.help"));
               $$3.a(ww.c("debug.inspect.help"));
               $$3.a(ww.c("debug.profiling.help"));
               $$3.a(ww.c("debug.creative_spectator.help"));
               $$3.a(ww.c("debug.pause_focus.help"));
               $$3.a(ww.c("debug.help.help"));
               $$3.a(ww.c("debug.dump_dynamic_textures.help"));
               $$3.a(ww.c("debug.reload_resourcepacks.help"));
               $$3.a(ww.c("debug.pause.help"));
               $$3.a(ww.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               ww $$6 = ww.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new wu.d($$5)));
   ...
   private void a(dzo $$0, iu $$1, @Nullable tx $$2) {
   ...
   private void a(ale $$0, fdw $$1, @Nullable tx $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().d();
         boolean $$5 = fhl.a(fof.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fhl.a(fof.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fhl.a(fof.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof gav) || ((gav)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
               boolean $$7 = this.b.aO().i();
               this.b.n.ad().a($$7);
               this.b.n.az();
               if (this.b.z instanceof gas $$8) {
                  $$8.c($$7);
               }
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fon.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$9 = $$6 == null || !($$6.aH_() instanceof frz) || !((frz)$$6.aH_()).c();
            if ($$9) {
               if (fxi.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$10 = this.b.n.av().c() == foh.a;
                  this.b.n.av().a(foh.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$10);
                  }
         ...
         label201: {
            ...
            label157:
            if (!$$15) {
               if (this.b.z instanceof fxd $$16 && !$$16.m()) {
                  break label157;
               }
