...
public interface ky {
   ...
   CompletableFuture<?> a(kw var1);

   String a();

   static <T> CompletableFuture<?> a(kw $$0, in.a $$1, Codec<T> $$2, T $$3, Path $$4) {
      ajr<JsonElement> $$5 = $$1.a(JsonOps.INSTANCE);
      JsonElement $$6 = ac.a($$2.encodeStart($$5, $$3), IllegalStateException::new);
      return a($$0, $$6, $$4);
   }

   static CompletableFuture<?> a(kw $$0, JsonElement $$1, Path $$2) {
   ...
   @FunctionalInterface
   public interface a<T extends ky> {
      T create(la var1);
   }
}
