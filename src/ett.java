...
public class ett {
   ...
   public static void a(File $$0, emn $$1, Consumer<uv> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, emn $$2, Consumer<uv> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, emn $$2, Consumer<uv> $$3) {
      enc $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            uv $$3x = uv.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new ut(ut.a.b, $$6.getAbsolutePath())));
            $$3.accept(uv.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(uv.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static enc a(emn $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      enc $$3 = new enc($$1, $$2, false);
   ...
   public ett(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
