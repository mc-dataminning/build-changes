...
public class emb extends elz {
   public static final MapCodec<emb> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bsf.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  bsf.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final bsf i;
   private final ju<dkd> j;

   public emb(int $$0, int $$1, int $$2, bsf $$3, float $$4, bsf $$5, ju<dkd> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<ekf.a> a(dhf $$0, BiConsumer<jh, dxo> $$1, bac $$2, int $$3, jh $$4, ejp $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new ekf.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dhf $$0, BiConsumer<jh, dxo> $$1, bac $$2, int $$3, ejp $$4, List<ekf.a> $$5, jh.a $$6, int $$7, jm $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new ekf.a($$16, 0, false));
         $$5.add(new ekf.a($$16.c(2), 0, false));
      }
   }
