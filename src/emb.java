...
public class emb {
   ...
   static class a implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         return $$0.c[ji.f.d()] && !$$0.b[ji.f.d()].d;
      }

      @Override
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         $$1.d = true;
         $$1.b[ji.f.d()].d = true;
         return new emb.k($$0, $$1);
      }
   }

   static class b implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         if ($$0.c[ji.f.d()] && !$$0.b[ji.f.d()].d && $$0.c[ji.b.d()] && !$$0.b[ji.b.d()].d) {
            emb.v $$1 = $$0.b[ji.f.d()];
            return $$1.c[ji.b.d()] && !$$1.b[ji.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         ...
         $$1.b[ji.f.d()].d = true;
         $$1.b[ji.b.d()].d = true;
         $$1.b[ji.f.d()].b[ji.b.d()].d = true;
         return new emb.l($$0, $$1);
      }
   }

   static class c implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         return $$0.c[ji.b.d()] && !$$0.b[ji.b.d()].d;
      }
      ...
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         $$1.d = true;
         $$1.b[ji.b.d()].d = true;
         return new emb.m($$0, $$1);
      }
   }

   static class d implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         if ($$0.c[ji.c.d()] && !$$0.b[ji.c.d()].d && $$0.c[ji.b.d()] && !$$0.b[ji.b.d()].d) {
            emb.v $$1 = $$0.b[ji.c.d()];
            return $$1.c[ji.b.d()] && !$$1.b[ji.b.d()].d;
         } else {
            return false;
      ...
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         ...
         $$1.b[ji.c.d()].d = true;
         $$1.b[ji.b.d()].d = true;
         $$1.b[ji.c.d()].b[ji.b.d()].d = true;
         return new emb.n($$0, $$1);
      }
   }

   static class e implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         return $$0.c[ji.c.d()] && !$$0.b[ji.c.d()].d;
      }

      @Override
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         emb.v $$3 = $$1;
         if (!$$1.c[ji.c.d()] || $$1.b[ji.c.d()].d) {
            $$3 = $$1.b[ji.d.d()];
         }

         $$3.d = true;
         $$3.b[ji.c.d()].d = true;
         return new emb.o($$0, $$3);
      }
   }

   static class f implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         return true;
      }
      ...
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         $$1.d = true;
         return new emb.s($$0, $$1, $$2);
      }
   }

   static class g implements emb.i {
      @Override
      public boolean a(emb.v $$0) {
         return !$$0.c[ji.e.d()] && !$$0.c[ji.f.d()] && !$$0.c[ji.c.d()] && !$$0.c[ji.d.d()] && !$$0.c[ji.b.d()];
      }

      @Override
      public emb.r a(ji $$0, emb.v $$1, ayw $$2) {
         $$1.d = true;
         return new emb.t($$0, $$1);
      }
   }

   public static class h extends emb.r {
      ...
      private emb.v G;
      private emb.v H;
      private final List<emb.r> I = Lists.newArrayList();

      public h(ayw $$0, int $$1, int $$2, ji $$3) {
         super(eki.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<emb.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new emb.p($$3, this.G));
         this.I.add(new emb.j($$3, this.H));
         List<emb.i> $$5 = Lists.newArrayList();
         $$5.add(new emb.b());
         $$5.add(new emb.d());
         $$5.add(new emb.e());
         $$5.add(new emb.a());
         ...
         ejj $$10 = ejj.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ejj $$11 = ejj.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ejj $$12 = ejj.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new emb.u($$3, $$10, $$13++));
         this.I.add(new emb.u($$3, $$11, $$13++));
         this.I.add(new emb.q($$3, $$12));
      }
      ...
      private List<emb.v> b(ayw $$0) {
         emb.v[] $$1 = new emb.v[75];
         ...
         emb.v $$23 = new emb.v(1003);
         emb.v $$24 = new emb.v(1001);
         emb.v $$25 = new emb.v(1002);
         $$1[v].a(ji.b, $$23);
         $$1[w].a(ji.d, $$24);
         $$1[x].a(ji.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ji.f.d()].d = true;
         this.H.b[ji.c.d()].d = true;
         this.H.b[ji.f.d()].b[ji.c.d()].d = true;
         this.H.b[ji.b.d()].d = true;
         this.H.b[ji.f.d()].b[ji.b.d()].d = true;
         this.H.b[ji.c.d()].b[ji.b.d()].d = true;
         this.H.b[ji.f.d()].b[ji.c.d()].b[ji.b.d()].d = true;
         ObjectArrayList<emb.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dds $$2, ayw $$3, ejj $$4) {
         int $$5 = 24;
      ...
      private void a(dds $$0, ayw $$1, ejj $$2) {
      ...
      private void b(dds $$0, ayw $$1, ejj $$2) {
      ...
      private void c(dds $$0, ayw $$1, ejj $$2) {
      ...
      private void d(dds $$0, ayw $$1, ejj $$2) {
      ...
      private void e(dds $$0, ayw $$1, ejj $$2) {
      ...
      private void f(dds $$0, ayw $$1, ejj $$2) {
   ...
   interface i {
      boolean a(emb.v var1);

      emb.r a(ji var1, emb.v var2, ayw var3);
   }

   public static class j extends emb.r {
      public j(ji $$0, emb.v $$1) {
         super(eki.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dga.ch.o(), dga.ch.o(), false);
   ...
   public static class k extends emb.r {
      public k(ji $$0, emb.v $$1) {
         super(eki.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         emb.v $$7 = this.B.b[ji.f.d()];
         emb.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ji.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ji.a.d()]);
         }
   ...
   public static class l extends emb.r {
      public l(ji $$0, emb.v $$1) {
         super(eki.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends emb.r {
      public m(ji $$0, emb.v $$1) {
         super(eki.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ji.a.d()]);
         }

         emb.v $$7 = this.B.b[ji.b.d()];
         if ($$7.b[ji.b.d()] == null) {
   ...
   public static class n extends emb.r {
      public n(ji $$0, emb.v $$1) {
         super(eki.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         emb.v $$7 = this.B.b[ji.c.d()];
         emb.v $$8 = this.B;
         emb.v $$9 = $$7.b[ji.b.d()];
         emb.v $$10 = $$8.b[ji.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ji.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ji.a.d()]);
         }
   ...
   public static class o extends emb.r {
      public o(ji $$0, emb.v $$1) {
         super(eki.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends emb.r {
      public p(ji $$0, emb.v $$1) {
         super(eki.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends emb.r {
      public q(ji $$0, ejj $$1) {
         super(eki.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ejv {
      protected static final dtc b = dga.hZ.o();
      protected static final dtc c = dga.ia.o();
      protected static final dtc d = dga.ib.o();
      protected static final dtc h = c;
      protected static final dtc i = dga.ii.o();
      protected static final boolean j = true;
      protected static final dtc k = dga.G.o();
      protected static final Set<dfy> l = ImmutableSet.builder().add(dga.dO).add(dga.iC).add(dga.mW).add(k.b()).build();
      ...
      public r(eki $$0, ji $$1, int $$2, ejj $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eki $$0, int $$1, ji $$2, emb.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ejj a(ji $$0, emb.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ejj $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
      ...
      protected void a(dds $$0, ejj $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dtc $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ejj $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4) {
         jd $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjs $$6 = bsx.D.a((dcw)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eN());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.do()), btr.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends emb.r {
      private int a;

      public s(ji $$0, emb.v $$1, ayw $$2) {
         super(eki.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         ...
         if (this.B.b[ji.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ji.a.d()] && !this.B.c[ji.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends emb.r {
      public t(ji $$0, emb.v $$1) {
         super(eki.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends emb.r {
      private int a;

      public u(ji $$0, ejj $$1, int $$2) {
         super(eki.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
