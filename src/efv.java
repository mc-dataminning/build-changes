...
public class efv extends egb {
   public static final MapCodec<efv> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, efv::new));

   public efv(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<eej.a> a(dbz $$0, BiConsumer<iz, drx> $$1, azc $$2, int $$3, iz $$4, edt $$5) {
      ...
      $$6.add(new eej.a(new iz($$14, $$16, $$15), 0, true));
      ...
      for (int $$20 = -1; $$20 <= 2; $$20++) {
         for (int $$21 = -1; $$21 <= 2; $$21++) {
            if (($$20 < 0 || $$20 > 1 || $$21 < 0 || $$21 > 1) && $$2.a(3) <= 0) {
               ...
               $$6.add(new eej.a(new iz($$14 + $$20, $$16, $$15 + $$21), 0, false));
            }
         }
      }
