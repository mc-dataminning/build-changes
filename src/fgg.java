...
public class fgg implements AutoCloseable {
   ...
   private fgg(int $$0, alz $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fgg a(alz $$0, fgg.a $$1, String $$2) throws gmb.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gmb.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fgg($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fgg.a[] c = values();
