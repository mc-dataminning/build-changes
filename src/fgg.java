...
public class fgg {
   ...
   public fgg(Runnable $$0, Function<app, ahg> $$1, aps $$2, Consumer<aps> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fgg.a> a() {
      return this.c.stream().map($$0 -> new fgg.d($$0));
   }

   public Stream<fgg.a> b() {
      return this.b.stream().map($$0 -> new fgg.c($$0));
   }
   ...
   abstract class b implements fgg.a {
      private final app b;
      ...
      @Override
      public ahg a() {
         return fgg.this.d.apply(this.b);
      }
