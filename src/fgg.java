...
public class fgg {
   ...
   public void a(fgq $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fgq.a) {
            fku.b($$1, fku.a.a, wz.c("narrator.toast.disabled"), null);
         } else {
            fku.b($$1, fku.a.a, wz.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fku.b($$1, fku.a.a, wz.c("narrator.toast.disabled"), wz.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fgg.a("Narrator library is not active");
      }
   }
