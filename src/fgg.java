...
public class fgg {
   ...
   private static final Queue<fgg.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fgg.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fgg::a), fgd::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fgg::a), fgd::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fgg.a(this.b) + ", type=" + fgg.b(this.c) + ", severity=" + fgg.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
