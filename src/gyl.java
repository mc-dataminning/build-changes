...
public class gyl extends ub {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gyl(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gyl a(auv $$0, List<String> $$1, boolean $$2) {
      ...
      ua.a().a($$3);
      return new gyl(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<aut> $$1, Map<String, String> $$2) {
      for (aut $$3 : $$1) {
