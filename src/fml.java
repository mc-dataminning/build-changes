...
public class fml {
   private static final akm a = new akm("advancements/title_box");
   ...
   @Nullable
   private fml v;
   private final List<fml> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fml(fmj $$0, fdz $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ty.a().a($$1.h.a($$3.a(), 163));
      this.y = ayd.d($$3.f() * 28.0F);
      this.z = ayd.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
   ...
   private static float a(fel $$0, List<xc> $$1) {
   ...
   public void a(ffm $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
