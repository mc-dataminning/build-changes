...
public class fml extends awa<Map<String, List<fml.a>>> implements AutoCloseable {
   ...
   public fml(alz $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<fml.a>> a(avv $$0, bpt $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<fml.a>> $$0, avv $$1, bpt $$2) {
      ...
      public void run() {
         ...
         for (fml.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fqp.a(fmg.Q().aA(), fqp.a.g, xv.a($$2.c, $$3), xv.a($$2.d, $$3)));
                  return;
               }
            }
         }
