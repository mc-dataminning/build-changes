...
public class auu extends ava {
   ...
   private final Set<auv<?>> e = Sets.newHashSet();

   public auu(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<auv<?>> d() {
      Set<auv<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  to $$4 = a($$3.getAsJsonObject());
                  $$4 = ays.g.a($$0, $$4, ud.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<auv<T>> a(auy<T> $$0, String $$1) {
      return Optional.ofNullable(ajv.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static to a(JsonObject $$0) {
      to $$1 = new to();
   ...
   protected String b() {
      Map<auy<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<auv<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<auv<?>>)$$3.next();
         auv<?> $$2 = (auv<?>)$$1.getKey();
      ...
      for (Entry<auy<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(kt.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> ajv b(auv<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(apv $$0) {
      Object2IntMap<auv<?>> $$1 = new Object2IntOpenHashMap();
