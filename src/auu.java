...
public class auu extends aut {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, auu.a> s;
   private final aup t;
   private long u;
   private final aky v;

   private auu(aky $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == auq.c($$2, 7, $$0.getLength());
      }
   }
