...
public class auu extends axu {
   private static final String a = ti.a.a(th.a);
   private static final String[] b = new String[]{
      "Text1", "Text2", "Text3", "Text4", "FilteredText1", "FilteredText2", "FilteredText3", "FilteredText4", "Color", "GlowingText"
   };

   public auu(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, ays.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", auu::b);
      $$0 = $$0.update("back_text", auu::b);
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), auu::a);
   }
}
