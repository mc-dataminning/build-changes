...
public interface ig<T> extends Iterable<ib<T>> {
   ...
   Either<arh<T>, List<ib<T>>> c();

   Optional<ib<T>> a(ate var1);
   ...
   @Deprecated
   @VisibleForTesting
   static <T> ig.c<T> a(ie<T> $$0, arh<T> $$1) {
      return new ig.c<>($$0, $$1);
   }
   ...
   public static class a<T> extends ig.b<T> {
      ...
      @Override
      public Either<arh<T>, List<ib<T>>> c() {
         return Either.right(this.a);
      }

      @Override
      public Optional<arh<T>> d() {
