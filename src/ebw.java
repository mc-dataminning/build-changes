...
public abstract class ebw<T extends Comparable<T>> {
   ...
   private final Codec<ebw.a<T>> e = this.d.xmap(this::c, ebw.a::b);

   protected ebw(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public ebw.a<T> c(T $$0) {
      return new ebw.a<>(this, $$0);
   }

   public ebw.a<T> a(eav<?, ?> $$0) {
      return new ebw.a<>(this, $$0.c(this));
   }

   public Stream<ebw.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof ebw<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends eav<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(ebw<T> a, T b) {
      public a(ebw<T> a, T b) {
         if (!a.a().contains(b)) {
