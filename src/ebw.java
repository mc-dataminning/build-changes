...
public class ebw {
   ...
   private final Map<String, ebl> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public ebw(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends ebl> T a(ebl.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends ebl> T b(ebl.a $$0, String $$1) {
      ebl $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends ebl> T a(Function<qw, T> $$0, atg $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
            qw $$4 = this.a($$2, $$1, aa.b().d().c());
   ...
   public qw a(String $$0, atg $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
