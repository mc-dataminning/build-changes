...
public class ebw extends ebr {
   ...
   private ebw(int $$0, int $$1, byte $$2, boolean $$3, boolean $$4, boolean $$5, aev<cpv> $$6) {
      this.f = $$2;
      this.c = $$0;
      this.d = $$1;
      this.e = $$6;
   ...
   public static ebw a(double $$0, double $$1, byte $$2, boolean $$3, boolean $$4, aev<cpv> $$5) {
      int $$6 = 128 * (1 << $$2);
      int $$7 = arw.a(($$0 + 64.0) / (double)$$6);
      int $$8 = arw.a(($$1 + 64.0) / (double)$$6);
      int $$9 = $$7 * $$6 + $$6 / 2 - 64;
      int $$10 = $$8 * $$6 + $$6 / 2 - 64;
      return new ebw($$9, $$10, $$2, $$3, $$4, false, $$5);
   }

   public static ebw a(byte $$0, boolean $$1, aev<cpv> $$2) {
      return new ebw(0, 0, $$0, false, false, $$1, $$2);
   }

   public static ebw b(qw $$0) {
      aev<cpv> $$1 = (aev<cpv>)dis.a(new Dynamic(ri.a, $$0.c("dimension")))
         .resultOrPartial(i::error)
         .orElseThrow(() -> new IllegalArgumentException("Invalid map dimension: " + $$0.c("dimension")));
      int $$2 = $$0.h("xCenter");
      int $$3 = $$0.h("zCenter");
      byte $$4 = (byte)arw.a($$0.f("scale"), 0, 4);
   ...
   @Override
   public qw a(qw $$0) {
      aew.a.encodeStart(ri.a, this.e.a()).resultOrPartial(i::error).ifPresent($$1x -> $$0.a("dimension", $$1x));
      $$0.a("xCenter", this.c);
      $$0.a("zCenter", this.d);
      $$0.a("scale", this.f);
      $$0.a("colors", this.g);
   ...
   public ebw a(int $$0) {
      return a((double)this.c, (double)this.d, (byte)arw.a(this.f + $$0, 0, 4), this.l, this.m, this.e);
   }
   ...
   public class a {
      ...
      vd<?> a(int $$0) {
         ...
         return $$3 == null && $$1 == null ? null : new ym($$0, ebw.this.f, ebw.this.h, $$3, $$1);
      }
