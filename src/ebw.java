...
public class ebw {
   ...
   private final Map<Character, Predicate<ebu>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public ebw a(char $$0, Predicate<ebu> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public ebv b() {
      return new ebv(this.c());
   }

   private Predicate<ebu>[][][] c() {
      this.d();
      Predicate<ebu>[][][] $$0 = (Predicate<ebu>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<ebu>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
