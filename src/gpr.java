...
public class gpr implements gpx.a {
   ...
   private final flj F;
   private final Map<ji, gpr.a> G = Maps.newHashMap();
   ...
   private void b(ffu $$0, glx $$1, double $$2, double $$3, double $$4) {
      ji $$5 = ji.a($$2, $$3, $$4);
   ...
   private void a(ffu $$0, glx $$1, gpr.a $$2) {
      int $$3 = 0;
   ...
   private void a(ffu $$0, glx $$1, zv.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gqg.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(ffu $$0, glx $$1, zv.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(ffu $$0, glx $$1, String $$2, gpr.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      gpx.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
