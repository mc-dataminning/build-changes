public class gpr extends gqm {
   private final gqh a;

   gpr(gmd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gqh $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         crz $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dC();
            if (this.h > $$1) {
   ...
   public static class a implements gpp<md> {
      ...
      public gpm a(md $$0, gmd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gpr($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gpp<md> {
      ...
      public gpm a(md $$0, gmd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gpm $$8 = new gpr($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
