...
public class baa extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfp.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bfp.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bfp.s);
