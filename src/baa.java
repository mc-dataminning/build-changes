...
public class baa extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bgq.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", baa::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", baa::a);
      return this.a($$0, "minecraft:trident", baa::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bgq.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bgq.B, $$1);
