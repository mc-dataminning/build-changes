...
public class beo extends bhv {
   public beo(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bjb.D, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bjb.F.typeName(), bkw.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bjb.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bjb.F.typeName(), "minecraft:saddle"));
