...
public class beo {
   ...
   protected beo(String $$0, ben $$1, DoubleSupplier $$2, @Nullable Runnable $$3, @Nullable beo.c $$4) {
      this.b = $$0;
      this.c = $$1;
      this.h = $$3;
      this.d = $$2;
   ...
   public static beo a(String $$0, ben $$1, DoubleSupplier $$2) {
      return new beo($$0, $$1, $$2, null, null);
   }

   public static <T> beo a(String $$0, ben $$1, T $$2, ToDoubleFunction<T> $$3) {
      return a($$0, $$1, $$3, $$2).a();
   }

   public static <T> beo.a<T> a(String $$0, ben $$1, ToDoubleFunction<T> $$2, T $$3) {
      return new beo.a<>($$0, $$1, $$2, $$3);
   }
   ...
   public static class a<T> {
      ...
      public a(String $$0, ben $$1, ToDoubleFunction<T> $$2, T $$3) {
         this.a = $$0;
         this.b = $$1;
      ...
      public beo.a<T> a(Consumer<T> $$0) {
         this.e = () -> $$0.accept(this.d);
         return this;
      }

      public beo.a<T> a(beo.c $$0) {
         this.f = $$0;
         return this;
      }

      public beo a() {
         return new beo(this.a, this.b, this.c, this.e, this.f);
      }
   }
   ...
   public static class d implements beo.c {
