...
public class beo extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhm.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         bao.a(this.a("minecraft:trident", beo::c), this.a("minecraft:arrow", beo::a), this.a("minecraft:spectral_arrow", beo::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, beo.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhm.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhm.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, beo.a<?> $$1, Type<?> $$2, Type<T> $$3) {
