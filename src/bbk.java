...
public class bbk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bjd.D), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bbk::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bbk::a);
      return this.a($$0, "minecraft:trident", bbk::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bjd.D, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bjd.D, $$1);
