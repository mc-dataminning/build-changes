...
public class fnr implements afm {
   ...
   @Nullable
   private String i;
   private final AtomicReference<fnr.a> j = new AtomicReference<>(fnr.a.a);

   public fnr(ug $$0, evi $$1, @Nullable fod $$2, @Nullable fdb $$3, boolean $$4, @Nullable Duration $$5, Consumer<vf> $$6) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(fnr.a $$0) {
      fnr.a $$1 = this.j.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(afp $$0) {
      ...
      try {
         SecretKey $$1 = atm.a();
         PublicKey $$2 = $$0.d();
         $$3 = new BigInteger(atm.a($$0.a(), $$2, $$1)).toString(16);
         $$4 = atm.a(2, $$1);
         $$5 = atm.a(1, $$1);
         byte[] $$6 = $$0.e();
         $$7 = new afv($$1, $$2, $$6);
   ...
   public void a(afo $$0) {
      ...
      GameProfile $$1 = $$0.a();
      this.f.a(new afw());
      this.f.a(new fnq(this.b, this.f, new fnw($$1, this.b.t().a(this.g, this.h, this.i), fnu.a().a(), chu.h, null, this.c, this.d)));
   ...
   public void a(vf $$0) {
      if (this.c != null && this.c.e()) {
         this.b.a(new gkl(this.d, ve.q, $$0));
      } else {
         this.b.a(new fcd(this.d, ve.q, $$0));
      }
   }
