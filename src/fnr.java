...
public class fnr extends fnc implements fxp.a {
   private static final ale w = new ale("textures/gui/advancements/window.png");
   ...
   private static final xo C = xo.c("advancements.sad_label");
   private static final xo D = xo.c("advancements.empty");
   private static final xo E = xo.c("gui.advancements");
   private final fkq F = new fkq(this);
   @Nullable
   private final fnc G;
   private final fxp H;
   private final Map<af, fnn> I = Maps.newLinkedHashMap();
   @Nullable
   private fnn J;
   private boolean K;
   ...
   public fnr(fxp $$0, @Nullable fnc $$1) {
      super(E);
      this.H = $$0;
      this.G = $$1;
   }
   ...
   protected void aM_() {
      ...
      if (this.J == null && !this.I.isEmpty()) {
         fnn $$0 = this.I.values().iterator().next();
         this.H.a($$0.c().b(), true);
      } else {
         this.H.a(this.J == null ? null : this.J.c().b(), true);
      }

      this.F.b(fhd.a(xn.d, $$0x -> this.d()).a(200).a());
      this.F.a($$1 -> {
   ...
   public void a(fgq $$0, int $$1, int $$2) {
      ...
      if (this.I.size() > 1) {
         for (fnn $$3 : this.I.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.J);
         }

         for (fnn $$4 : this.I.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fgq $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.J != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ag $$0) {
      fnn $$1 = fnn.a(this.m, this, this.I.size(), $$0);
      if ($$1 != null) {
         this.I.put($$0.b(), $$1);
      }
   }
