...
public class fnr {
   ...
   public fnr(fnp $$0, fft $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ts.a().a($$1.h.a($$3.a(), 163));
      this.y = ayg.d($$3.f() * 28.0F);
      this.z = ayg.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
   ...
   private static float a(fge $$0, List<wz> $$1) {
   ...
   public void a(fhf $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
