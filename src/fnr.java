...
public class fnr extends cto {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dnd e = new dnd();
   private final dnj<blu> f = new dnj<>(blu.class, new fnr.b());
   private final fns D;
   private final fte E;
   private final fnr.a F;
   private final fsv G;
   private final bkk H;
   private final evh I = evh.O();
   final List<fsf> J = Lists.newArrayList();
   private emw K = new emw();
   private final Map<String, ega> L = Maps.newHashMap();
   private static final long M = 16777215L;
   private int N;
   private final Object2ObjectArrayMap<csz, ewl> O = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(fss.a, new ewl($$0xx -> this.b($$0xx, fss.a)));
      $$0x.put(fss.b, new ewl($$0xx -> this.b($$0xx, fss.b)));
      $$0x.put(fss.c, new ewl($$0xx -> this.b($$0xx, fss.c)));
   });
   private final fnn P;
   private final Deque<Runnable> Q = Queues.newArrayDeque();
   private int R;
   private final foz S = new foz();
   private static final Set<cms> T = Set.of(cna.hA, cna.hB);

   public void b(int $$0) {
      this.S.a($$0, this);
   }

   public void b(hx $$0, djg $$1, int $$2) {
      if (!this.S.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(hx $$0, djg $$1, els $$2) {
      djg $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cfh $$4 = this.I.s;
   ...
   public fnr(fns $$0, fnr.a $$1, ahf<cto> $$2, ih<dmp> $$3, int $$4, int $$5, Supplier<bgr> $$6, fte $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.f(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.P = new fnn(this, $$4);
      this.H = new bkk();
      this.F = $$1;
      this.E = $$7;
      this.G = fsv.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.Z().a(ctk.l).a(false, null);
      } else {
         this.Z().a(ctk.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<blu> e() {
      return this.G().a();
   }
   ...
   private void a(blu $$0, blu $$1) {
      if ($$1.dH() || $$1.cZ() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof cfh || this.e.c($$1)) {
         $$1.bp();
         $$1.ah++;
         $$1.t();
   ...
   private cwp p() {
      if (this.I.q.l() == ctl.b) {
         cmx $$0 = this.I.s.eT();
         cms $$1 = $$0.d();
         if (T.contains($$1) && $$1 instanceof ckq $$2) {
            return $$2.e();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, auu $$4, @Nullable cwp $$5, hx.a $$6) {
   ...
   private void a(hx $$0, djg $$1, jv $$2, boolean $$3) {
      if ($$1.u().c()) {
         eml $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(ic.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(hx $$0, jv $$1, eml $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, jv $$5) {
      this.a($$5, aun.d(this.z.j(), $$0, $$1), $$4, aun.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable cfh $$0, blu $$1, ih<arq> $$2, ars $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.ai().a((ghz)(new ghq($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(blu $$0, arq $$1, ars $$2, float $$3, float $$4) {
      this.I.ai().a((ghz)(new ghq($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, arq $$3, ars $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.I.j.m().b().c($$0, $$1, $$2);
      ghu $$10 = new ghu($$3, $$4, $$5, $$6, auu.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, @Nullable sn $$6) {
      this.I.g.a(new fqf.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
   }
   ...
   public ih<cun> a(int $$0, int $$1, int $$2) {
      return this.I_().d(ke.at).f(cuu.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (aun.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = aun.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public els a(els $$0, float $$1) {
      float $$2 = this.f($$1);
      els $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      cup $$4 = this.G_();
      els $$5 = ato.a($$3, ($$1x, $$2x, $$3x) -> els.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = aun.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = aun.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new els((double)$$7, (double)$$8, (double)$$9);
   }

   public els h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = aun.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = aun.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new els((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (aun.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = aun.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(hx $$0, csz $$1) {
      ewl $$2 = (ewl)this.O.get($$1);
      return $$2.a($$0);
   }

   public int b(hx $$0, csz $$1) {
      int $$2 = evh.O().m.C().c();
      if ($$2 == 0) {
   ...
   protected Map<String, ega> l() {
      return ImmutableMap.copyOf(this.L);
   }

   protected void a(Map<String, ega> $$0) {
      this.L.putAll($$0);
   }
   ...
   public static class a implements egs {
      ...
      public a(bjx $$0, boolean $$1, boolean $$2) {
         this.k = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new ctk();
   ...
   final class b implements dnf<blu> {
      public void a(blu $$0) {
      }
