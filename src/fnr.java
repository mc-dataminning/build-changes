...
public class fnr {
   ...
   @Nullable
   private fnr v;
   private final List<fnr> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fnr(fnp $$0, ffg $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(ffr $$0, List<xu> $$1) {
   ...
   public void a(fgs $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
   ...
   public void a(fgs $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
