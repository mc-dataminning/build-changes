...
public class fnr extends hpw {
   ...
   public void aO_() {
      int $$0 = this.n / 4 - 2;
      this.c(fsv.a(wy.c("mco.terms.buttons.agree"), $$0x -> this.E()).a(this.n / 4, g(12), $$0, 20).a());
      this.c(fsv.a(wy.c("mco.terms.buttons.disagree"), $$0x -> this.m.a(this.D)).a(this.n / 2 + 4, g(12), $$0, 20).a());
   }
   ...
   private void E() {
      ...
      try {
         $$0.j();
         this.m.a(new fne(this.D, new fok(this.D, this.E)));
      } catch (fmk var3) {
