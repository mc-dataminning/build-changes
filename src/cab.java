...
public class cab extends bzi {
   ...
   private static final aee<Boolean> d = aeh.a(cab.class, aeg.k);
   private static final aee<Integer> bX = aeh.a(cab.class, aeg.b);
   private static final aee<Boolean> bY = aeh.a(cab.class, aeg.k);
   ...
   public boolean a(bho $$0, float $$1) {
      if (!super.a($$0, $$1)) {
         return false;
      } else if (!(this.dL() instanceof akq)) {
         return false;
      } else {
         akq $$2 = (akq)this.dL();
         bjg $$3 = this.q();
         ...
         if ($$3 != null && this.dL().ai() == bgv.d && (double)this.ag.i() < this.b(bkm.m) && this.dL().X().b(cpr.e)) {
            ...
            for (int $$8 = 0; $$8 < 50; $$8++) {
               int $$9 = $$4 + arw.a(this.ag, 7, 40) * arw.a(this.ag, -1, 1);
               int $$10 = $$5 + arw.a(this.ag, 7, 40) * arw.a(this.ag, -1, 1);
               int $$11 = $$6 + arw.a(this.ag, 7, 40) * arw.a(this.ag, -1, 1);
   ...
   class a extends brd {
      ...
      public void a(cpw $$0, gw $$1) {
         $$0.a(null, $$1, apd.Bg, ape.f, 0.5F, 0.9F + cab.this.ag.i() * 0.2F);
      }
