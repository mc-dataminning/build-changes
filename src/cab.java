...
public abstract class cab extends bzo {
   ...
   public cab(bsz $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cab(bsz $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bzo.a.a, bzo.a.c));
   }
   ...
   protected abstract boolean a(dbc var1, io var2);
}
