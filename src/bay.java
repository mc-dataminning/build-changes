...
public class bay extends axx {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bay::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bay::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bay::k);
         $$0 = this.a($$0, "minecraft:fox", bay::j);
         $$0 = this.a($$0, "minecraft:item", bay::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bay::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bay::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bay::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bay::e);
         return this.a($$0, "minecraft:piglin", bay::d);
      });
   }
