...
public class bay extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bhu.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bay::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bay::a);
      return this.a($$0, "minecraft:trident", bay::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bhu.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bhu.B, $$1);
