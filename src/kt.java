...
public class kt implements jj {
   private final jl.a d;
   private final jl.a e;

   public kt(jl $$0) {
      this.d = $$0.a(jl.b.b, "blockstates");
      this.e = $$0.a(jl.b.b, "models");
   }

   @Override
   public CompletableFuture<?> a(jh $$0) {
      Map<csk, ku> $$1 = Maps.newHashMap();
      Consumer<ku> $$2 = $$1x -> {
         csk $$2x = $$1x.a();
         ku $$3x = $$1.put($$2x, $$1x);
         if ($$3x != null) {
      ...
      Map<aep, Supplier<JsonElement>> $$3 = Maps.newHashMap();
      Set<cir> $$4 = Sets.newHashSet();
      BiConsumer<aep, Supplier<JsonElement>> $$5 = ($$1x, $$2x) -> {
         Supplier<JsonElement> $$3x = $$3.put($$1x, $$2x);
         if ($$3x != null) {
            throw new IllegalStateException("Duplicate model definition for " + $$1x);
         }
      };
      Consumer<cir> $$6 = $$4::add;
      new kr($$2, $$5, $$6).a();
      new ks($$5).a();
      List<csk> $$7 = jc.f.s().filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
   ...
   private <T> CompletableFuture<?> a(jh $$0, Map<T, ? extends Supplier<JsonElement>> $$1, Function<T, Path> $$2) {
