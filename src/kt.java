public class kt implements ku {
   ...
   @Override
   public final cud dispense(kr $$0, cud $$1) {
      cud $$2 = this.a($$0, $$1);
      this.a($$0);
      this.a($$0, $$0.d().c(dhn.b));
      return $$2;
   }
   ...
   public static void a(dcg $$0, cud $$1, int $$2, jf $$3, jt $$4) {
      double $$5 = $$4.a();
      double $$6 = $$4.b();
      double $$7 = $$4.c();
      if ($$3.o() == jf.a.b) {
   ...
   protected cud a(kr $$0, cud $$1, cud $$2) {
      $$1.h(1);
      if ($$1.e()) {
         return $$2;
      } else {
