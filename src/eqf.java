...
public class eqf extends eqj {
   ...
   public List<eon.a> a(dkp $$0, BiConsumer<iw, ebq> $$1, bai $$2, int $$3, iw $$4, enx $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new eon.a(new iw($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new eon.a(new iw($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
