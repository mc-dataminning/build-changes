...
public class eqf extends eqj implements eqh {
   ...
   public eqf.c a() {
      return new eqf.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, eqp.a $$1) {
   ...
   private eqf.b q() {
      ...
      this.k += $$5;
      this.j++;
      eqf.a $$9 = new eqf.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new eqf.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eqp.b.a || this.q == eqp.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eqq> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eqq $$1 = (eqq)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eqq.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eqq.b.c) {
         eqh.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, eqh.a($$11));
         this.a($$14 + 5, eqh.a($$12));
         this.a($$14 + 6, eqh.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eqp a, int b, int c, eqp.b d, eqp.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eqp.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eqs $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
