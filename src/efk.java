...
public interface efk {
   static efk a(egc $$0, dic $$1, ege $$2, egl $$3, int $$4, int $$5, efk.a $$6) {
      return new efk.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static efk a(final efk.a $$0) {
      return new efk() {
         @Nullable
         @Override
         public dzz a(efr.b $$0x, double $$1) {
   ...
   @Nullable
   dzz a(efr.b var1, double var2);

   boolean a();

   public interface a {
      efk.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dzz b) {

      public dzz a(int $$0) {
         return $$0 < this.a ? this.b : dmc.a.m();
      }
   }

   public static class c implements efk {
      ...
      private final efr p;
      private final egl q;
      private final efk.b[] r;
      private final long[] s;
      private final efk.a t;
      private final efr u;
      private final efr v;
      private boolean w;
      private final int x;
      ...
      c(egc $$0, dic $$1, ege $$2, egl $$3, int $$4, int $$5, efk.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dzz a(efr.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            efk.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dmc.K)) {
               this.w = false;
               return dmc.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dmc.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dmc.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(efr.b $$0, MutableDouble $$1, efk.b $$2, efk.b $$3) {
         int $$4 = $$0.b();
         dzz $$5 = $$2.a($$4);
         dzz $$6 = $$3.a($$4);
         if ((!$$5.a(dmc.K) || !$$6.a(dmc.J)) && (!$$5.a(dmc.J) || !$$6.a(dmc.K))) {
      ...
      private efk.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            efk.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private efk.b b(int $$0, int $$1, int $$2) {
         efk.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               efk.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new efk.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, efk.b $$3, int $$4, boolean $$5) {
         efr.e $$6 = new efr.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dko.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new efr.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azm.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dzz a(int $$0, int $$1, int $$2, efk.b $$3, int $$4) {
         dzz $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != edw.g && $$3.b != dmc.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new efr.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dmc.K.m();
            }
         }
