...
public class bpl {
   ...
   private bpl(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bpl a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bpl($$0, $$1);
   }

   public bpl.d a() throws IOException {
      bpl.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bpl.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bpl.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bpl.c $$3 = bpl.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bpl.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bpl.a($$0, $$3);
            }
         }
   ...
   public bpl.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bpl.c> $$2 = this.a().c();
      ...
      bpl.e $$4 = new bpl.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bpl.c b) implements bpl.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bpl.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bpl.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bpl.b> {
      private final List<bpl.b> a;

      d(List<bpl.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bpl.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bpl.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bpl.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bpl.d a() {
         ListIterator<bpl.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bpl.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bpl.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bpl.b> b() {
         return this.a.stream();
      }

      public Set<bpl.c> c() {
         return this.a.stream().map(bpl.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bpl.c b) implements bpl.b {
