...
public interface bpl<T, F> {
   ...
   public static final class a implements bpl<bpl.b, Runnable> {
   ...
   public static final class c<T> implements bpl<T, T> {
