...
public abstract class bpl<R extends Runnable> implements bot, bpn<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bpl(String $$0) {
      this.b = $$0;
      bor.a.a(this);
   }
   ...
   @Override
   public List<boq> bv() {
      return ImmutableList.of(boq.a(this.b + "-pending-tasks", bop.b, this::bx));
   }
}
