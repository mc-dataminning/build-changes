...
public class fc implements ArgumentType<fc.a> {
   ...
   public static fc.a a(CommandContext<eq> $$0, String $$1) {
      return (fc.a)$$0.getArgument($$1, fc.a.class);
   }
   ...
   public static enum a {
      a("feet", ($$0, $$1) -> $$0),
      b("eyes", ($$0, $$1) -> new evz($$0.c, $$0.d + (double)$$1.cL(), $$0.e));
      ...
      private final BiFunction<evz, bsd, evz> e;

      private a(final String $$0, final BiFunction<evz, bsd, evz> $$1) {
         this.d = $$0;
         this.e = $$1;
      }

      @Nullable
      public static fc.a a(String $$0) {
         return c.get($$0);
      }
