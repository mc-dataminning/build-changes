...
public interface fc<T extends ct<?>> extends ArgumentType<T> {
   static fc.b a() {
      return new fc.b();
   }
   ...
   public static class a implements fc<ct.c> {
      private static final Collection<String> a = Arrays.asList("0..5.2", "0", "-5.4", "-100.76..", "..100");

      public static ct.c a(CommandContext<ee> $$0, String $$1) {
   ...
   public static class b implements fc<ct.d> {
      private static final Collection<String> a = Arrays.asList("0..5", "0", "-5", "-100..", "..100");

      public static ct.d a(CommandContext<ee> $$0, String $$1) {
