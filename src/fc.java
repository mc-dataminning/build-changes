...
public class fc implements ArgumentType<Integer> {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(te.c("argument.time.invalid_unit"));
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> te.a("argument.time.tick_count_too_low", $$1, $$0));
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      ...
      return dv.b(d.keySet(), $$1.createOffset($$1.getStart() + $$2.getCursor()));
   }
   ...
   public static class a implements gh<fc, fc.a.a> {
      public void a(fc.a.a $$0, sh $$1) {
         $$1.p($$0.b);
      }

      public fc.a.a a(sh $$0) {
         int $$1 = $$0.readInt();
         return new fc.a.a($$1);
      }
      ...
      public final class a implements gh.a<fc> {
         final int b;
