...
public class fc implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> wi.b("slot.only_single_allowed", $$0));

   public static fc a() {
      return new fc();
   }

   public static int a(CommandContext<dv> $$0, String $$1) {
