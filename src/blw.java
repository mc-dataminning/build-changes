...
public class blw {
   ...
   private blw(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blw a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blw($$0, $$1);
   }

   public blw.d a() throws IOException {
      blw.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blw.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blw.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blw.c $$3 = blw.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blw.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blw.a($$0, $$3);
            }
         }
   ...
   public blw.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blw.c> $$2 = this.a().c();
      ...
      blw.e $$4 = new blw.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blw.c b) implements blw.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blw.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blw.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blw.b> {
      private final List<blw.b> a;

      d(List<blw.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blw.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blw.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blw.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blw.d a() {
         ListIterator<blw.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blw.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blw.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blw.b> b() {
         return this.a.stream();
      }

      public Set<blw.c> c() {
         return this.a.stream().map(blw.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blw.c b) implements blw.b {
