...
public class blw extends blh {
               ...
               $$2.get("CriteriaName")
                  ...
                  .map($$0x -> {
                     ...
                     if ($$1x < 0) {
                        ...
                        try {
                           alr $$2x = alr.a($$0x.substring(0, $$1x), '.');
                           alr $$3 = alr.a($$0x.substring($$1x + 1), '.');
      ...
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         ...
         Optional<Dynamic<T>> $$3 = $$2.get("CriteriaType").get().result().flatMap($$1x -> {
            ...
            if ($$2x.isPresent() && $$3x.isPresent()) {
               String $$4 = $$2x.get();
               return $$4.equals("_special") ? Optional.of($$2.createString($$3x.get())) : Optional.of($$1x.createString(blw.b($$4) + ":" + blw.b($$3x.get())));
            } else {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(
         false, bjm.J, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4), "DisplayName", bjm.z.in($$0)), c, d)
      );
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", bjm.F.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", bjm.E.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", bjm.B.in($$0));
