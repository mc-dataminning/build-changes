...
public class bok implements bod {
   ...
   public bok(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<bob> a() {
      Builder<bob> $$0 = ImmutableSet.builder();

      try {
         bok.a $$1 = new bok.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bob.a("cpu#" + $$1x, boa.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bob.a("heap MiB", boa.e, () -> (double)ab.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(boc.a.a());
      return $$0.build();
   }
   ...
   public static bob a(final LongSupplier $$0) {
      ...
      bob.d $$3 = new bob.d(2.0F);
      return bob.a("ticktime", boa.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
