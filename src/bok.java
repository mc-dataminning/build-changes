...
public class bok {
   ...
   private bok(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bok a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bok($$0, $$1);
   }

   public bok.d a() throws IOException {
      bok.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bok.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bok.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bok.c $$3 = bok.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bok.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bok.a($$0, $$3);
            }
         }
   ...
   public bok.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bok.c> $$2 = this.a().c();
      ...
      bok.e $$4 = new bok.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bok.c b) implements bok.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bok.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bok.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bok.b> {
      private final List<bok.b> a;

      d(List<bok.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bok.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bok.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bok.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bok.d a() {
         ListIterator<bok.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bok.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bok.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bok.b> b() {
         return this.a.stream();
      }

      public Set<bok.c> c() {
         return this.a.stream().map(bok.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bok.c b) implements bok.b {
