public class cqp extends cqq {
   public cqp(bvr<? extends cqp> $$0, dhi $$1) {
      super($$0, $$1);
   }

   public cqp(dhi $$0, cke $$1) {
      this(bvr.az, $$0);
      this.c($$1);
      this.a_(
   ...
   public void h() {
      ...
      this.F();
      float $$5 = 0.99F;
      if (this.dW().a(this.cR()).noneMatch(dxu.a::l)) {
         this.at();
      } else if (this.bm()) {
         this.at();
      } else {
   ...
   protected void a(fbv $$0) {
      super.a($$0);
      if (this.p() instanceof bwg $$1) {
         bvk $$2 = $$0.a();
         bua $$3 = this.dX().b(this, $$1);
