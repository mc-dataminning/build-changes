...
public class epf {
   ...
   public static List<epf.a> a(String $$0, epf.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<epf.a> a(String $$0, List<epf.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<epf.a> a(List<String> $$0, List<epf.b> $$1) {
      int $$2 = 0;
      List<epf.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<epf.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static epf.b a(String $$0, String $$1) {
         return new epf.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static epf.b a(String $$0) {
         return new epf.b($$0);
      }
   }
}
