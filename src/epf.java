...
public class epf {
   ...
   public static final epf.a bv;

   public static epf.a a(int $$0, int $$1) {
      return $$0 == -1 ? epf.b.b.a($$1) : epf.b.a.a($$0);
   }

   public static epf.a a(String $$0) {
      if (epf.a.e.containsKey($$0)) {
         return epf.a.e.get($$0);
      } else {
         for (epf.b $$1 : epf.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final int c;
      private final auk<vg> d;
      static final Map<String, epf.a> e = Maps.newHashMap();

      a(String $$0, epf.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new auk<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vg.b($$2.toUpperCase(Locale.ROOT)) : vg.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vg.b($$2) : vg.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> sj.a().b($$1) ? vg.c($$1) : vg.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<epf.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vg> g;

      private static void a(epf.b $$0, String $$1, int $$2) {
         epf.a $$3 = new epf.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vg> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public epf.a a(int $$0) {
         return (epf.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
