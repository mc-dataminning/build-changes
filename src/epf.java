...
public class epf extends epn {
   public static final MapCodec<epf> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eos.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayy.b(jc.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, epf::new)
   );
   ...
   public epf(float $$0, int $$1, int $$2, eos $$3, int $$4, List<jc> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(epn.a $$0, iw $$1, jc $$2) {
