...
public class fnp implements ekv, AutoCloseable {
   ...
   private final List<elb> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, elb> l = Maps.newHashMap();
   private final int m;
   ...
   public fnp(anp $$0, String $$1) throws IOException {
      aeu $$2 = new aeu("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      ann $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.p = a(arj.a($$5, "blend", null));
         this.s = a($$0, eky.a.a, $$6);
         this.t = a($$0, eky.a.b, $$7);
         this.m = ekz.a();
         ekz.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = elb.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ekw a(anp $$0, eky.a $$1, String $$2) throws IOException {
      eky $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ekw)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         ekw $$7;
         if ($$3 == null) {
            aeu $$4 = new aeu("shaders/program/" + $$2 + $$1.b());
            ann $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static eku a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new eku();
      } else {
         int $$1 = 32774;
