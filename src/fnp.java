...
public class fnp {
   ...
   @Nullable
   private fnp v;
   private final List<fnp> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fnp(fnn $$0, ffe $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = um.a().a($$1.h.a($$3.a(), 163));
      this.y = ayy.d($$3.f() * 28.0F);
      this.z = ayy.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
   ...
   private static float a(ffp $$0, List<xt> $$1) {
   ...
   public void a(fgq $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
