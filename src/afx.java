...
public class afx {
   ...
   public afx(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<afx.a> b(Scanner $$0) {
      aev<cpv> $$1 = (aev<cpv>)agg.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new afx.a($$1, new ehn((double)$$2, (double)$$3, (double)$$4), new ehm($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<akr> $$1 = this.e.ac().t();
         if (!$$1.isEmpty()) {
            akr $$2 = $$1.get(0);
            akq $$3 = this.e.D();
   ...
   static record a(aev<cpv> a, ehn b, ehm c) {
   }
}
