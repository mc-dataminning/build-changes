...
public class afx {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("commands.schedule.same_tick"));
                  ...
                  dt.a("function")
                     .then(
                        dt.a("function", ft.a())
                           .suggests(aes.a)
                           .then(
                              ((RequiredArgumentBuilder)((RequiredArgumentBuilder)dt.a("time", fb.a())
                                       .executes($$0x -> a((ds)$$0x.getSource(), ft.b($$0x, "function"), IntegerArgumentType.getInteger($$0x, "time"), true)))
                                    .then(
                                       dt.a("append")
                                          .executes(
                                             $$0x -> a((ds)$$0x.getSource(), ft.b($$0x, "function"), IntegerArgumentType.getInteger($$0x, "time"), false)
                                          )
                                    ))
                                 .then(
                                    dt.a("replace")
   ...
   private static int a(ds $$0, Pair<acq, Either<dn, Collection<dn>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         ...
         edv<MinecraftServer> $$6 = $$0.l().aU().K().u();
