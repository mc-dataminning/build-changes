...
public class fbh extends faz {
   private static final Logger a = LogUtils.getLogger();
   private static final agm b = new agm("textures/misc/vignette.png");
   private static final uv c = uv.b("============").a(n.p);
   ...
   private int z;
   private final evv A = new evv(false);

   public fbh(boolean $$0, Runnable $$1) {
      super(eta.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fbh.a $$1) {
      try (Reader $$2 = this.f.Y().openAsReader(new agm($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : atg.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(uv.b($$4).a(n.o), true);
         this.a(c, true);
         this.D();
         this.D();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(uv.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(uv.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.r.addAll(this.f.h.c(uv.b($$0), 256));
   }

   private void a(uv $$0, boolean $$1) {
      if ($$1) {
