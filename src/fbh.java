...
public class fbh {
   ...
   private final List<eza.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fbh.a> o = new ArrayList<>();
   ...
   public void a(fat $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.k()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fat $$0, int $$1, int $$2, ezb.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(eza.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean k() {
      return this.i.m.m().c() == ciq.c;
   }
   ...
   public void a(vu $$0) {
      this.a($$0, null, this.i.W() ? ezb.b() : ezb.a());
   }

   public void a(vu $$0, @Nullable wg $$1, @Nullable ezb $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(vu $$0, @Nullable ezb $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, ezb::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(vu $$0, @Nullable wg $$1, int $$2, @Nullable ezb $$3, boolean $$4) {
      int $$5 = aww.a((double)this.f() / this.h());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<awi> $$6 = fbl.a($$0, $$5, this.i.h);
      boolean $$7 = this.e();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new eza.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private fbh.a b(wg $$0) {
      int $$1 = this.i.l.e();
      ListIterator<eza> $$2 = this.k.listIterator();
   ...
   private eza a(eza $$0) {
      return new eza($$0.a(), h, null, ezb.a());
   }
   ...
   @Nullable
   public ezb c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, eza.a $$1, ezb $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         ezb.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.y instanceof ffv;
   }
