...
public class fbh {
   private final ImmutableList<fbi> a;
   private final ImmutableMap<String, fbi> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private fbf e;

   public fbh(ImmutableMap<String, fbi> $$0) {
      this.b = $$0;
