...
public class fbh<T extends brv> extends fad<T> {
   public final fee a;
   private final fee b;
   private final fee f;
   private final fee g;
   ...
   public static fek c() {
      ...
      fen $$3 = $$1.a("body", fej.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), feg.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
