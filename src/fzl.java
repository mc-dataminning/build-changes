...
public final class fzl {
   ...
   private static final fzl c = new fzl(HostAndPort.fromParts("server.invalid", 25565));

   public fzl(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fzl(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fzl a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fzl($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fzl ? this.b.equals(((fzl)$$0).b) : false;
      }
   }
