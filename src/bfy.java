...
public class bfy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bbu.a(this.a("minecraft:trident", bfy::c), this.a("minecraft:arrow", bfy::a), this.a("minecraft:spectral_arrow", bfy::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfy.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bix.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bix.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bfy.a<?> $$1, Type<?> $$2, Type<T> $$3) {
