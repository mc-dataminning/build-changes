...
public class bfy {
   ...
   private JsonElement a(List<Pair<dix, bgi<bga>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bgi)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dix, bgi<bga>> $$3 : $$0) {
         bgi<bga> $$4 = (bgi<bga>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dix)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bgg> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bfo.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bfw $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bge $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bge.b $$3 = (bge.b)$$1x.getFirst();
         bge.a $$4 = (bge.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bgb> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bgb>, ToDoubleFunction<bgb>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bgb::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bgb::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bgb::c));
      return $$1;
   }
}
