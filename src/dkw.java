...
public class dkw implements dkl.a, dkl.b {
   ...
   public dkw(int $$0, dlg $$1, int $$2, int $$3, dla $$4, dkm.c $$5, dkx $$6, dke.a $$7, dlu $$8) {
      ...
      this.x = $$4.a();
      this.b = $$0;
      this.c = arx.a($$4.d(), this.x);
      this.d = arx.a($$4.c(), this.x);
   ...
   public int a(int $$0, int $$1) {
      int $$2 = hs.c(hs.a($$0));
      int $$3 = hs.c(hs.a($$1));
      return this.l.computeIfAbsent(akh.a($$2, $$3), this::a);
   }
   ...
   public class i implements dkm.m, dkw.h {
      ...
      void a(double $$0) {
         this.p = arx.d($$0, this.h, this.l);
         this.q = arx.d($$0, this.j, this.n);
         this.r = arx.d($$0, this.i, this.m);
         this.s = arx.d($$0, this.k, this.o);
      }

      void b(double $$0) {
         this.t = arx.d($$0, this.p, this.q);
         this.u = arx.d($$0, this.r, this.s);
      }

      void c(double $$0) {
         this.v = arx.d($$0, this.t, this.u);
      }
