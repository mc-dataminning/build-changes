...
public class yx<B extends ByteBuf, V, T> implements yy<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<yx.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   yx(Function<V, ? extends T> $$0, List<yx.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         wr.a($$0, $$3);
         yx.b<B, V, T> $$4 = this.c.get($$3);

         try {
            yy<? super B, V> $$5 = (yy<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> yx.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new yx.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<yx.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public yx.a<B, V, T> a(T $$0, yy<? super B, ? extends V> $$1) {
         this.a.add(new yx.b<>($$1, $$0));
         return this;
      }
      ...
      public yx<B, V, T> a() {
         ...
         return new yx<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(yy<? super B, ? extends V> a, T b) {
   }
}
