...
public class ega extends egf {
   ...
   public List<een.a> a(dcd $$0, BiConsumer<iz, dsb> $$1, azg $$2, int $$3, iz $$4, edx $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ega.a> $$13 = Lists.newArrayList();
      $$13.add(new ega.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iz $$21 = $$4.b(ayy.a($$19), $$12 - 1, ayy.a($$20));
               iz $$22 = $$21.b(5);
      ...
      List<een.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcd $$0, BiConsumer<iz, dsb> $$1, azg $$2, iz $$3, iz $$4, boolean $$5, edx $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iz $$13 = $$3.b(ayy.d(0.5F + (float)$$12 * $$9), ayy.d(0.5F + (float)$$12 * $$10), ayy.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlk.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcd $$0, BiConsumer<iz, dsb> $$1, azg $$2, int $$3, iz $$4, List<ega.a> $$5, edx $$6) {
      for (ega.a $$7 : $$5) {
         int $$8 = $$7.a();
