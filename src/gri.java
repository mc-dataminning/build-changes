...
public abstract class gri<T extends bvf, S extends gxo> {
   protected static final float c = 0.025F;
   public static final int d = 24;
   protected final grh e;
   private final fnj a;
   protected float f;
   protected float g = 1.0F;
   private final S b = this.d();

   protected gri(grj.a $$0) {
      this.e = $$0.a();
      this.a = $$0.j();
   }
   ...
   public final int a(T $$0, float $$1) {
      jh $$2 = jh.a((ka)$$0.n($$1));
      return glc.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, jh $$1) {
      return $$0.dV().a(dhj.a, $$1);
   }

   protected int a(T $$0, jh $$1) {
      return $$0.bY() ? 15 : $$0.dV().a(dhj.b, $$1);
   }

   public boolean a(T $$0, gov $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if (!this.b($$0)) {
         return true;
      } else {
         fbn $$5 = this.a($$0).g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new fbn($$0.dA() - 2.0, $$0.dC() - 2.0, $$0.dG() - 2.0, $$0.dA() + 2.0, $$0.dC() + 2.0, $$0.dG() + 2.0);
         }

         if ($$1.a($$5)) {
            return true;
         } else {
            if ($$0 instanceof bvz $$6) {
               bvf $$7 = $$6.A();
               if ($$7 != null) {
   ...
   private static void a(fgl $$0, gle $$1, gxo.a $$2) {
      float $$3 = 0.025F;
   ...
   protected void a(S $$0, xv $$1, fgl $$2, gle $$3, int $$4) {
      fbs $$5 = $$0.z;
      if ($$5 != null) {
         boolean $$6 = !$$0.v;
         ...
         if ($$6) {
            $$9.a($$1, $$10, (float)$$7, -1, false, $$8, $$3, fnj.a.a, 0, glc.b($$4, 2));
         }
   ...
   public void a(T $$0, S $$1, float $$2) {
      ...
      if ($$8) {
         $$1.y = this.c($$0);
         $$1.z = $$0.ds().a(bvg.c, 0, $$0.k($$2));
      } else {
         $$1.y = null;
      }

      $$1.v = $$0.cg();
      bvf $$10 = $$0 instanceof bvz $$9 ? $$9.A() : null;
      if ($$10 != null) {
         ...
         $$15.f = $$0.dV().a(dhj.a, $$13);
         $$15.g = $$0.dV().a(dhj.a, $$14);
      } else {
         $$1.A = null;
      }
