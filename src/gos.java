...
public class gos implements gov.a, AutoCloseable {
   ...
   eyy[] f;
   @Nullable
   private final gos.a g;
   private final auq h;

   public gos(ale $$0, gql $$1, eyy $$2, auq $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gqj $$4 = $$3.a(gqj.a).orElse(gqj.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eyy[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gon.a(this.f, $$0);
   ...
   @Nullable
   private gos.a a(gql $$0, int $$1, int $$2, gqj $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gos.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gos.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gos.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gos.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gos.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gos.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eyy[] $$4) {
   ...
   class a {
      ...
      a(final List<gos.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gos.this.c;
         int $$4 = this.b($$2) * gos.this.d;
         gos.this.a($$0, $$1, $$3, $$4, gos.this.f);
      }

      public gou a() {
         return gos.this.new d(this, this.d ? gos.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eyy[] b = new eyy[gos.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gos.this.c >> $$0;
            int $$2 = gos.this.d >> $$0;
            this.b[$$0] = new eyy($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gos.d $$2) {
         gos.a $$3 = $$2.c;
         List<gos.b> $$4 = $$3.b;
         gos.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gos.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gos.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gos.this.f[$$2].a($$3 + ($$0.a($$1) * gos.this.c >> $$2), $$4 + ($$0.b($$1) * gos.this.d >> $$2));
      }
   ...
   class d implements gou {
      int a;
      int b;
      final gos.a c;
      @Nullable
      private final gos.c d;

      d(final gos.a $$0, @Nullable final gos.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
