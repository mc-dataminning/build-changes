...
public class dby {
   ...
   private boolean a(hv $$0) {
      return cvo.a(this.a, $$0) || cvo.a(this.a, $$0.c()) || cvo.a(this.a, $$0.d());
   }
   ...
   private dby b(hv $$0) {
      dip $$2 = this.a.a_($$0);
      if (cvo.g($$2)) {
         return new dby(this.a, $$0, $$2);
      } else {
         hv $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (cvo.g($$2)) {
            return new dby(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return cvo.g($$2) ? new dby(this.a, $$1, $$2) : null;
         }
      }
   }
   ...
   private boolean b(dby $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dby $$0) {
      this.f.add($$0.b);
      hv $$1 = this.b.e();
      hv $$2 = this.b.f();
      hv $$3 = this.b.g();
   ...
   public dby a(boolean $$0, boolean $$1, djt $$2) {
      hv $$3 = this.b.e();
      hv $$4 = this.b.f();
      hv $$5 = this.b.g();
      hv $$6 = this.b.h();
