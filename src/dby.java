...
public class dby {
   ...
   public dby a(dby.a $$0) {
      return new dby($$0, this.f);
   }

   public ix<dbw> a(io $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ix<dbw> a(double $$0, double $$1, double $$2) {
      int $$3 = ji.a(ayd.a($$0));
      int $$4 = ji.a(ayd.a($$1));
      int $$5 = ji.a(ayd.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = axz.a($$7, $$0);
      double $$10 = b($$7);
      return ayd.k($$6 + $$10) + ayd.k($$5 + $$9) + ayd.k($$4 + $$8);
   }
   ...
   public interface a {
      ix<dbw> getNoiseBiome(int var1, int var2, int var3);
   }
}
