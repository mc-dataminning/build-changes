...
public class dnr extends dnl<dpq> {
   private static final hb[] a = hb.values();

   public dnr(Codec<dpq> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dnn<dpq> $$0) {
      dpq $$1 = $$0.f();
      art $$2 = $$0.d();
      gv $$3 = $$0.e();
      cqe $$4 = $$0.b();
      int $$5 = $$1.l;
      int $$6 = $$1.n;
      List<Pair<gv, Integer>> $$7 = Lists.newLinkedList();
      int $$8 = $$1.j.a($$2);
      dlg $$9 = new dlg(new dki($$4.A()));
      dze $$10 = dze.a($$9, -4, 1.0);
      List<gv> $$11 = Lists.newLinkedList();
      ...
      List<gv> $$31 = Lists.newArrayList();
      Predicate<dey> $$32 = a($$1.c.g);

      for (gv $$33 : gv.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         double $$34 = $$10.a((double)$$33.u(), (double)$$33.v(), (double)$$33.w()) * $$1.o;
         double $$35 = 0.0;
         double $$36 = 0.0;

         for (Pair<gv, Integer> $$37 : $$7) {
            $$35 += aro.f($$33.j((ia)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (gv $$38 : $$11) {
            $$36 += aro.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, csl.a.n(), $$32);
      ...
      for (gv $$44 : $$31) {
         ...
         for (hb $$46 : a) {
            ...
            dey $$48 = $$4.a_($$47);
            if ($$45.b(dfo.C)) {
               $$45 = $$45.a(dfo.C, Boolean.valueOf($$48.u().b()));
            }
