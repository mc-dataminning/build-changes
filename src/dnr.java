...
public class dnr extends dny<dqj> {
   private static final dfu a = dfu.a(csy.I);
   private final dfl b = csy.I.n();
   private final dfl c = csy.jF.n();
   private final dfl d = csy.aV.n();
   private final dfl an = csy.G.n();

   public dnr(Codec<dqj> $$0) {
      super($$0);
   }
   ...
   private static void b(cqr $$0, gw $$1) {
      $$0.a($$1, csy.J.n(), 3);
      $$0.a($$1, dcz.N).ifPresent($$1x -> $$1x.a(ecq.aC, $$1.a()));
   }
}
