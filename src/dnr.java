...
public class dnr extends doi implements cnx {
   ...
   private je<csd> r = je.a(9, csd.i);
   private int s = 0;
   protected final cnr l = new cnr() {
   ...
   public dnr(im $$0, dpy $$1) {
      super(dnf.P, $$0, $$1);
   }

   @Override
   protected ws k() {
      return ws.c("container.crafter");
   }

   @Override
   protected cnh a(int $$0, ckk $$1) {
      return new cnv($$0, $$1, this, this.l);
   }
   ...
   private boolean a(int $$0, csd $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            csd $$4 = this.a($$3);
            if ($$4.d() || $$4.G() < $$0 && csd.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(czu $$0, im $$1, dpy $$2, dnr $$3) {
      int $$4 = $$3.s - 1;
      if ($$4 >= 0) {
         $$3.s = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.a(deo.b, Boolean.valueOf(false)), 3);
         }
      }
   }
