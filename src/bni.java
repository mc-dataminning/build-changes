...
public class bni implements bnj {
   ...
   private static final bni k = new bni();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bnh $$0) {
      URL $$1 = bni.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnh $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnl a = new bnl(() -> bni.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bni.this.l && $$0.getState() == RecordingState.STOPPED) {
