...
public class gst extends gtl<clv, gyy, gck> {
   ...
   private static final gmj k = gmj.g(b);

   public gst(gsf.a $$0) {
      this($$0, 0.5F, gfd.aZ);
   }

   protected gst(gsf.a $$0, float $$1, gfc $$2) {
      super($$0, new gck($$0.a($$2)), $$1);
   }

   public boolean a(clv $$0, gpr $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gt()) {
            bvi $$5 = $$0.gu();
            if ($$5 != null) {
               fbb $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               fbb $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new faw($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private fbb a(bvi $$0, double $$1, float $$2) {
   ...
   public void a(gyy $$0, ffv $$1, glz $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fbb $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(ffv $$0, ffz $$1, fbb $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(ffz $$0, ffv.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hej.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(clv $$0, gyy $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.m($$2);
   ...
   @Nullable
   private static bum a(clv $$0) {
      bum $$1 = flk.Q().ao();
      return (bum)($$0.gt() ? $$0.gu() : $$1);
   }
}
