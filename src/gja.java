...
public class gja {
   ...
   private final giz r;
   private final gjb s = new gjb();
   private final giw t = new giw(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<gja.a> w = new AtomicReference<>(gja.a.c);
   private final Map<ghz, giw.a> x = Maps.newHashMap();
   private final Multimap<ars, ghz> y = HashMultimap.create();
   private final List<gia> z = Lists.newArrayList();
   private final Map<ghz, Integer> A = Maps.newHashMap();
   private final Map<ghz, Integer> B = Maps.newHashMap();
   private final List<gjc> C = Lists.newArrayList();
   private final List<gia> D = Lists.newArrayList();
   private final List<ghw> E = Lists.newArrayList();

   public gja(gjd $$0, evl $$1, aqk $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new giz($$2);
   }
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gja.a.c, gja.a.a)) {
               String $$2 = this.n.aq().c();
               ac.g().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gja.a.a, gja.a.b);
                     }
                  ...
                  this.w.compareAndSet(gja.a.a, gja.a.c);
               });
            }
         }

         return this.w.compareAndSet(gja.a.b, gja.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(ghz::s).forEach(this::c);
      this.D.clear();
      ...
      Iterator<Entry<ghz, giw.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<ghz, giw.a> $$6 = $$5.next();
         giw.a $$7 = $$6.getValue();
         ghz $$8 = $$6.getKey();
      ...
      Iterator<Entry<ghz, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<ghz, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            ghz $$13 = $$12.getKey();
            if ($$13 instanceof gia) {
               ((gia)$$13).q();
            }
   ...
   private static boolean d(ghz $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(ghz $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(ghz $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(ghz $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gjd.d) {
                  if ($$3 == gjd.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != ghz.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<giw.a> $$16 = this.t.a($$3.g() ? env.c.b : env.c.a);
                           giw.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aW) {
   ...
   private float g(ghz $$0) {
      return aun.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(ghz $$0) {
   ...
   public void a(eus $$0) {
      if (this.o && $$0.h()) {
         enx $$1 = new enx($$0.b(), new els($$0.l()), new els($$0.m()));
