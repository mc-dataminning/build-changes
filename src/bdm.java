...
public class bdm extends bad {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdm::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdm::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdm::k);
         $$0 = this.a($$0, "minecraft:fox", bdm::j);
         $$0 = this.a($$0, "minecraft:item", bdm::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdm::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdm::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdm::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdm::e);
         return this.a($$0, "minecraft:piglin", bdm::d);
      });
   }
