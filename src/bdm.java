...
public class bdm extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         azq.a(this.a("minecraft:trident", bdm::c), this.a("minecraft:arrow", bdm::a), this.a("minecraft:spectral_arrow", bdm::b))
      );
   }
   ...
   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bdm.a<?> $$1, Type<?> $$2, Type<T> $$3) {
