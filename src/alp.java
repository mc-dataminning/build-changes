...
public abstract class alp implements vo {
   ...
   public alp(MinecraftServer $$0, sm $$1, ali $$2) {
      this.b = $$0;
      this.c = $$1;
      this.f = ac.b();
      this.i = $$2.b();
   ...
   public void b(tl $$0) {
      this.c.a(new vj($$0), sv.a(() -> this.c.a($$0)));
      this.c.o();
      this.b.h(this.c::p);
   }
   ...
   protected ali a(aki $$0) {
      return new ali(this.j(), this.i, $$0);
   }
}
