...
public class exh {
   ...
   private final evi i;
   private final atd<String> j = new atd<>(100);
   private final List<evc> k = Lists.newArrayList();
   private final List<evc.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<exh.a> o = new ArrayList<>();
   ...
   public void a(ewu $$0, int $$1, int $$2, int $$3) {
      if (!this.j()) {
         int $$4 = this.i();
         int $$5 = this.l.size();
         if ($$5 > 0) {
            ...
            int $$8 = auo.f((float)this.e() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = auo.d((float)($$9 - 40) / $$7);
   ...
   private void a(ewu $$0, int $$1, int $$2, evd.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(evc.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean j() {
      return this.i.m.m().c() == cfg.c;
   }
   ...
   public void a(vf $$0) {
      this.a($$0, null, this.i.U() ? evd.b() : evd.a());
   }

   public void a(vf $$0, @Nullable vr $$1, @Nullable evd $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(vf $$0, @Nullable evd $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, evd::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(vf $$0, @Nullable vr $$1, int $$2, @Nullable evd $$3, boolean $$4) {
      int $$5 = auo.a((double)this.e() / this.g());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<aua> $$6 = exl.a($$0, $$5, this.i.h);
      boolean $$7 = this.m();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new evc.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private exh.a b(vr $$0) {
      int $$1 = this.i.l.e();
      ListIterator<evc> $$2 = this.k.listIterator();
   ...
   private evc a(evc $$0) {
      return new evc($$0.a(), h, null, evd.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)auo.a((double)this.e() / this.g()) && $$4 < 0.0 && $$4 > (double)auo.a(-9.0 * this.g())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public wc b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         evc.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), auo.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public evd c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, evc.a $$1, evd $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         evd.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         if (!($$0 < -4.0) && !($$0 > (double)auo.a((double)this.e() / this.g()))) {
            int $$2 = Math.min(this.i(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = auo.a($$1 + (double)this.m);
   ...
   private boolean m() {
      return this.i.y instanceof fbs;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return auo.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return auo.a($$0 * 160.0 + 20.0);
   }
