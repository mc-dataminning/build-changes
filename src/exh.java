...
public class exh<T> implements exg<T> {
   private static final Comparator<exf<?>> a = ($$0, $$1) -> exk.b.compare($$0.b(), $$1.b());
   ...
   private final BiConsumer<exf<T>, exk<T>> j = ($$0x, $$1x) -> {
      if ($$1x.equals($$0x.b())) {
         this.b($$1x);
      }
   };

   public exh(LongPredicate $$0, Supplier<bnk> $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public void a(dbh $$0, exf<T> $$1) {
      long $$2 = $$0.a();
      this.d.put($$2, $$1);
      exk<T> $$3 = $$1.b();
      if ($$3 != null) {
   ...
   private void a(long $$0, int $$1, bnk $$2) {
      this.a($$0);
   ...
   private void a(Queue<exf<T>> $$0, exf<T> $$1, long $$2, int $$3) {
      if (this.a($$3)) {
         exf<T> $$4 = $$0.peek();
         exk<T> $$5 = $$4 != null ? $$4.b() : null;

         while (this.a($$3)) {
            exk<T> $$6 = $$1.b();
            if ($$6 == null || $$6.c() > $$2 || $$5 != null && exk.b.compare($$6, $$5) > 0) {
               break;
            }
   ...
   public boolean a(iz $$0, T $$1) {
      exf<T> $$2 = (exf<T>)this.d.get(dbh.a($$0));
   ...
   public boolean b(iz $$0, T $$1) {
      this.d();
      return this.i.contains(exk.a($$1, $$0));
   }
   ...
   private void a(eie $$0, exh.a<T> $$1) {
   ...
   public void a(eie $$0, kd $$1) {
      this.a(this, $$0, $$1);
   }

   public void a(exh<T> $$0, eie $$1, kd $$2) {
      List<exk<T>> $$3 = new ArrayList<>();
      Predicate<exk<T>> $$4 = $$1x -> $$1.b($$1x.b());
      $$0.h.stream().filter($$4).forEach($$3::add);
      $$0.g.stream().filter($$4).forEach($$3::add);
      $$0.a($$1, ($$2x, $$3x) -> $$3x.d().filter($$4).forEach($$3::add));
      LongSummaryStatistics $$5 = $$3.stream().mapToLong(exk::e).summaryStatistics();
      long $$6 = $$5.getMin();
      long $$7 = $$5.getMax();
      $$3.forEach($$3x -> this.a(new exk<>((T)$$3x.a(), $$3x.b().a($$2), $$3x.c(), $$3x.d(), $$3x.e() - $$6 + $$7 + 1L)));
   }

   @Override
   public int a() {
      return this.d.values().stream().mapToInt(exm::a).sum();
   }

   @FunctionalInterface
   interface a<T> {
      void accept(long var1, exf<T> var3);
   }
}
