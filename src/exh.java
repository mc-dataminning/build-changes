public class exh extends eyk {
   ...
   private static final tm c = tm.c("credits_and_attribution.screen.title");
   private static final tm k = tm.c("credits_and_attribution.button.credits");
   private static final tm l = tm.c("credits_and_attribution.button.attribution");
   private static final tm m = tm.c("credits_and_attribution.button.licenses");
   private final eyk n;
   ...
   protected void aI_() {
      ...
      this.o.b(esq.a(tl.d, $$0x -> this.az_()).a());
      this.o.a();
      this.o.a(this::d);
   }
