...
public enum ekd implements aub {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final aub.a<ekd> t = aub.a(ekd::values);
   public static final IntFunction<ekd> u = asb.a(ekd::a, values(), asb.a.a);
   private final int v;
   private final String w;

   private ekd(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
