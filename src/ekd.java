...
public class ekd extends ejm<elx> {
   private static final Logger a = LogUtils.getLogger();
   private static final bwo<?>[] b = new bwo[]{bwo.bf, bwo.bO, bwo.bO, bwo.bo};
   private static final eah c = dmh.nI.m();

   public ekd(Codec<elx> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejo<elx> $$0) {
      Predicate<eah> $$1 = ejm.a(axc.bS);
      iu $$2 = $$0.e();
      azv $$3 = $$0.d();
      djz $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.G_() && !$$4.a_($$23.e()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(dmh.cG)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, dmh.cx.m(), $$1);
                        } else {
                           this.a($$4, $$23, dmh.m.m(), $$1);
                        }
                     }
                  } else if (!$$24.a(dmh.cG) && !$$24.a(dmh.cD)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.v($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, erf.a($$4, $$30, dmh.cG.m()), $$1);
                     buj.a($$4, $$3, $$30, ezd.c);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, dmh.cD.m(), $$1);
         if ($$4.c_($$2) instanceof dyx $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
