...
public enum ekd {
   ...
   private ekd(String... $$0) {
      this.c = $$0;
   }

   public List<ano<InputStream>> a(amk $$0) throws IOException {
      return List.of(
   ...
   public ano<InputStream> b(amk $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private ano<InputStream> a(amk $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      ano<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
