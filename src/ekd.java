...
public class ekd {
   ...
   @Nullable
   private String g;
   private static final ekd.a h = new ekd.a() {
      @Nullable
      @Override
      public ekc a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ekg.a(this.d, "Get capabilities")) {
         ...
         if (ekg.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ekg.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ekg.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ekc a(ekd.c $$0) {
      return ($$0 == ekd.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ekd.a {
      private final int a;
      private final Set<ekc> b = Sets.newIdentityHashSet();
      ...
      public ekc a() {
         if (this.b.size() >= this.a) {
            if (aa.aT) {
               ekd.a.warn("Maximum sound pool size {} reached", this.a);
            }
