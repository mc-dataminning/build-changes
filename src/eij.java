...
public class eij extends eim<eii> {
   public eij(Codec<eii> $$0) {
      super($$0);
   }

   public boolean a(eii $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eih $$0, eii $$1, ece $$2, Function<iu, je<dkd>> $$3, azv $$4, efs $$5, dih $$6, ecd $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eim.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eih $$0, eii $$1, ece $$2, Function<iu, je<dkd>> $$3, efs $$4, double $$5, double $$6, double $$7, float $$8, double $$9, ecd $$10, eim.a $$11
   ) {
