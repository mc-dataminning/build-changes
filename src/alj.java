...
public class alj {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wg.c("commands.deop.failed"));
   ...
   private static int a(du $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if ($$2.f($$4)) {
            $$2.b($$4);
            $$3++;
            $$0.a(() -> wg.a("commands.deop.success", $$1.iterator().next().getName()), true);
         }
      }
