...
public class ebb implements eay, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bsa c;
   private final ebg d;
   private final SequencedMap<dgn, ebb.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected ebb(ebi $$0, Path $$1, boolean $$2) {
      this.d = new ebg($$0, $$1, $$2);
      this.c = new bsa(ebb.b.values().length, ae.h(), "IOWorker-" + $$0.c());
   }
   ...
   public CompletableFuture<Void> a(dgn $$0, Supplier<ux> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         ux $$2 = $$1.get();
         ebb.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new ebb.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<ux>> a(dgn $$0) {
      return this.a((ebb.c<Optional<ux>>)(() -> {
         ebb.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((ebb.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dgn $$0, vr $$1) {
      return this.a((ebb.c<Void>)(() -> {
         try {
            ebb.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(ebb.c<T> $$0) {
      return this.c.a(ebb.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dgn, ebb.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bsc.c(ebb.b.b.ordinal(), this::b));
   }

   private void a(dgn $$0, ebb.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(ebb.b.c.ordinal(), $$0 -> $$0.complete(bbk.a)).join();
   }
