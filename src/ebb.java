...
public class ebb implements ecb<bvk> {
   ...
   public ebb(ebm $$0, ash $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = new brz($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<ebw<bvk>> a(dgo $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               List<bvk> $$6 = bvr.a($$5, this.d, bvq.r).collect(ImmutableList.toImmutableList());
               return new ebw<>($$0, $$6);
            }
         }, this.g::a_);
      }
   ...
   private static dgo a(ux $$0) {
      int[] $$1 = $$0.n("Position");
      return new dgo($$1[0], $$1[1]);
   }

   private static void a(ux $$0, dgo $$1) {
      $$0.a("Position", new vb(new int[]{$$1.h, $$1.i}));
   }

   private static ebw<bvk> b(dgo $$0) {
      return new ebw<>($$0, ImmutableList.of());
   }

   @Override
   public void a(ebw<bvk> $$0) {
      dgo $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
   ...
   private void a(CompletableFuture<?> $$0, dgo $$1) {
      $$0.exceptionally($$1x -> {
   ...
   private void b(CompletableFuture<?> $$0, dgo $$1) {
      $$0.exceptionally($$1x -> {
