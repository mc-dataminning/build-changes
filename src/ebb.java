...
public class ebb extends ebe<eba> {
   public ebb(Codec<eba> $$0) {
      super($$0);
   }

   public boolean a(eba $$0, ayw $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eaz $$0, eba $$1, duy $$2, Function<jd, jm<ddw>> $$3, ayw $$4, dyk $$5, dcd $$6, dux $$7) {
      int $$8 = kf.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         ebe.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eaz $$0, eba $$1, duy $$2, Function<jd, jm<ddw>> $$3, dyk $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dux $$10, ebe.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayo.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayo.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayo.b($$13);
         $$6 += (double)(ayo.b($$12) * $$27);
         $$7 += (double)ayo.a($$13);
         $$8 += (double)(ayo.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
