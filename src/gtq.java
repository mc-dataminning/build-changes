...
public class gtq extends gqy<chn, gzr, gcy> {
   private static final Map<chn.a, akv> a = af.a(Maps.newEnumMap(chn.a.class), $$0 -> {
      $$0.put(chn.a.a, akv.b("textures/entity/panda/panda.png"));
      $$0.put(chn.a.b, akv.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(chn.a.c, akv.b("textures/entity/panda/worried_panda.png"));
      $$0.put(chn.a.d, akv.b("textures/entity/panda/playful_panda.png"));
      $$0.put(chn.a.e, akv.b("textures/entity/panda/brown_panda.png"));
      $$0.put(chn.a.f, akv.b("textures/entity/panda/weak_panda.png"));
      $$0.put(chn.a.g, akv.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gtq(gse.a $$0) {
      super($$0, new gcy($$0.a(gfc.bL)), new gcy($$0.a(gfc.bM)), 0.9F);
      this.a(new gwp(this));
   }
