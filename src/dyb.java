...
public class dyb extends dye<dya> {
   public dyb(Codec<dya> $$0) {
      super($$0);
   }

   public boolean a(dya $$0, ayg $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dxz $$0, dya $$1, dsd $$2, Function<in, iw<dbc>> $$3, ayg $$4, dvl $$5, czk $$6, dsc $$7) {
      int $$8 = jp.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dye.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dxz $$0, dya $$1, dsd $$2, Function<in, iw<dbc>> $$3, dvl $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dsc $$10, dye.a $$11
   ) {
      double $$12 = 1.5 + (double)(axz.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(axz.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = axz.b($$13);
         $$6 += (double)(axz.b($$12) * $$27);
         $$7 += (double)axz.a($$13);
         $$8 += (double)(axz.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
