...
public class dyb implements dxw {
   public static final Codec<dyb> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ki.e.q().fieldOf("block").flatXmap(dyb::a, DataResult::success).orElse((dfb)dae.fg).forGetter($$0x -> $$0x.b),
   ...
   public final ip<dac> h;
   private final ObjectArrayList<ih> i;

   private static DataResult<dfb> a(dac $$0) {
      return $$0 instanceof dfb $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public dyb(dfb $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, ip<dac> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
