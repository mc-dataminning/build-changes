...
public class dyb {
   ...
   private final Map<Character, Predicate<dxz>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dyb a(char $$0, Predicate<dxz> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dxz>[][][] c() {
      this.d();
      Predicate<dxz>[][][] $$0 = (Predicate<dxz>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxz>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
