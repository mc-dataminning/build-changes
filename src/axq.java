...
public class axq<T> extends AbstractList<T> implements ayz<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axq.this.get(this.b--);
      }

      @Override
      public void remove() {
         axq.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements ayz<T> {
      private final axq<T> b;

      public b(final axq<T> $$0) {
         this.b = $$0;
      }
