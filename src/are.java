...
public abstract class are implements zs {
   private static final Logger e = LogUtils.getLogger();
   public static final int a = 15000;
   private static final wu f = wu.c("disconnect.timeout");
   static final wu b = wu.c("multiplayer.disconnect.unexpected_query_response");
   ...
   public are(MinecraftServer $$0, vs $$1, aqw $$2) {
      this.c = $$0;
      this.d = $$1;
      this.h = ac.b();
      this.k = $$2.b();
   ...
   public void b(wu $$0) {
      this.d.a(new zj($$0), wb.a(() -> this.d.a($$0)));
      this.d.m();
      this.c.h(this.d::n);
   }
   ...
   protected aqw a(apw $$0) {
      return new aqw(this.j(), this.k, $$0, this.g);
   }
}
