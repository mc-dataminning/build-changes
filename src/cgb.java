...
public abstract class cgb extends cga {
   @Nullable
   private ib b;
   private boolean c;
   private boolean d;

   protected cgb(bpd<? extends cgb> $$0, cxb $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bR.a(4, new cgb.a<>(this, 0.7, 0.595));
   }
   ...
   public bqh a(cxq $$0, bnb $$1, bpt $$2, @Nullable bqh $$3) {
      if ($$2 != bpt.p && $$2 != bpt.h && $$2 != bpt.d && $$0.E_().i() < 0.06F && this.go()) {
         this.c = true;
      }
   ...
   public static boolean b(bpd<? extends cgb> $$0, cxc $$1, bpt $$2, ib $$3, axd $$4) {
      return $$1.a(cxk.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends cgb> extends bwm {
      ...
      public void e() {
         ...
         if ($$1.l()) {
            ...
            if (this.b.gw() && $$2.isEmpty()) {
               ...
               ept $$3 = ept.c(this.b.gp());
               ept $$4 = this.b.dk();
               ept $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).a(0.4).e($$3);
               ept $$6 = $$3.d($$4).d().a(10.0).e($$4);
               ib $$7 = ib.a($$6);
               $$7 = this.b.dM().a(dso.a.f, $$7);
      ...
      private List<cgb> h() {
         return this.b.dM().a(cgb.class, this.b.cH().g(16.0), $$0 -> $$0.gu() && !$$0.t(this.b));
      }
