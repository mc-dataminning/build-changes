...
public class apr {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> xg.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> xg.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> xg.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ek $$0, fgb $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bxe> $$6) throws CommandSyntaxException {
      asb $$7 = $$0.e();
      int $$8 = $$7.K_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         apr.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> xg.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.j, $$1.k, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bxe> $$0) {
      Set<fhj> $$1 = Sets.newHashSet();
   ...
   private static void a(fgb $$0, double $$1, asb $$2, bai $$3, double $$4, double $$5, double $$6, double $$7, int $$8, apr.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bxe> $$0, asb $$1, apr.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<fhj, apr.a> $$7 = Maps.newHashMap();

      for (bxe $$8 : $$0) {
         apr.a $$10;
         if ($$4) {
            fhj $$9 = $$8 instanceof csi ? $$8.cq() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)azz.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)azz.a($$10.b) + 0.5, Set.of(), $$8.dL(), $$8.dN(), true);
   ...
   private static apr.a[] a(bai $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      apr.a[] $$6 = new apr.a[$$1];
   ...
   static class a {
      ...
      public boolean b(djn $$0, int $$1) {
         iw $$2 = iw.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         ebq $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.n() && !$$3.a(axn.aN);
      }

      public void a(bai $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = azz.a($$0, $$1, $$3);
         this.b = azz.a($$0, $$2, $$4);
      }
   }
