...
public class ama {
   ...
   private static int a(ee $$0, Collection<aqo> $$1, Predicate<ctq> $$2) throws CommandSyntaxException {
      return a($$0, $$1, $$2, -1);
   }

   private static int a(ee $$0, Collection<aqo> $$1, Predicate<ctq> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = 0;
