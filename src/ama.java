...
public class ama {
   ...
   private Optional<ama.a> b(Scanner $$0) {
      aku<dgh> $$1 = (aku<dgh>)amj.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new ama.a($$1, new faz((double)$$2, (double)$$3, (double)$$4), new fay($$6, $$5)));
      }
   }
   ...
   private void b(String $$0) {
      this.e.execute(() -> {
         ...
         if (!$$1.isEmpty()) {
            are $$2 = $$1.get(0);
            ard $$3 = this.e.J();
            ex $$4 = new ex($$2.z(), faz.a($$3.Z()), fay.a, $$3, 4, "", wo.a, this.e, $$2);
            ey $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(aku<dgh> a, faz b, fay c) {
   }
}
