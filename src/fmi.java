...
public abstract class fmi<T extends fmi<T>> {
   ...
   public fmi(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fmg.a();
         if ($$3 != null) {
         ...
         throw new foa(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new foa(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new foa(var2.getMessage(), var2);
      }
   }
   ...
   public static fmi<?> a(String $$0) {
      return new fmi.b($$0, 5000, 60000);
   }

   public static fmi<?> a(String $$0, int $$1, int $$2) {
      return new fmi.b($$0, $$1, $$2);
   }

   public static fmi<?> b(String $$0, String $$1) {
      return new fmi.c($$0, $$1, 5000, 60000);
   }

   public static fmi<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fmi.c($$0, $$1, $$2, $$3);
   }

   public static fmi<?> b(String $$0) {
      return new fmi.a($$0, 5000, 60000);
   }

   public static fmi<?> c(String $$0, String $$1) {
      return new fmi.d($$0, $$1, 5000, 60000);
   }

   public static fmi<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fmi.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fmi<fmi.a> {
   ...
   public static class b extends fmi<fmi.b> {
   ...
   public static class c extends fmi<fmi.c> {
      ...
      public fmi.c f() {
         try {
            ...
            throw new foa(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fmi<fmi.d> {
      private final String c;
