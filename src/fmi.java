...
public class fmi extends fkv<coy> {
   private static final ajv A = new ajv("container/stonecutter/scroller");
   private static final ajv B = new ajv("container/stonecutter/scroller_disabled");
   private static final ajv C = new ajv("container/stonecutter/recipe_selected");
   private static final ajv D = new ajv("container/stonecutter/recipe_highlighted");
   private static final ajv E = new ajv("container/stonecutter/recipe");
   private static final ajv F = new ajv("textures/gui/container/stonecutter.png");
   ...
   private void b(fdl $$0, int $$1, int $$2, int $$3) {
      List<cvu<cwm>> $$4 = this.s.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.P = axm.a(this.P - $$5, 0.0F, 1.0F);
