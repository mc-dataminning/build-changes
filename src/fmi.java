...
public class fmi {
   ...
   private static final Comparator<gct> p = Comparator.<gct>comparingInt($$0 -> -$$0.j())
      .thenComparingInt($$0 -> $$0.e() == dey.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), fan::b, ""))
   ...
   private xi t;
   private boolean u;
   private final Map<UUID, fmi.a> v = new Object2ObjectOpenHashMap();

   public fmi(fji $$0, fkt $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public xi a(gct $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fan.a($$0.h(), xi.b($$0.a().getName())));
   }

   private xi a(gct $$0, xw $$1) {
      return $$0.e() == dey.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(boolean $$0) {
      if (this.u != $$0) {
         ...
         this.u = $$0;
         if ($$0) {
            xi $$1 = xl.a(this.b(), xi.b(", "), this::a);
            this.q.aZ().c(xi.a("multiplayer.player.list.narration", $$1));
         }
      }
   }
   ...
   public void a(fku $$0, int $$1, fas $$2, @Nullable fak $$3) {
      List<gct> $$4 = this.b();
      List<fmi.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               com $$44 = this.q.s.b($$43.getId());
               boolean $$45 = $$44 != null && gpl.b($$44);
               boolean $$46 = $$44 != null && $$44.a(coo.g);
               fmg.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45, -1);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dey.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dey.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fku $$0, int $$1, int $$2, int $$3, gct $$4) {
      ali $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(gir::B, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fak $$0, int $$1, fmi.b $$2, int $$3, int $$4, UUID $$5, fku $$6) {
      if ($$0.h() == fav.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fku $$4, int $$5) {
      fmi.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fmi.a($$5));
      $$6.a($$5, (long)this.r.e());
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            xi $$14 = xi.a("multiplayer.player.list.hp", $$13);
            xi $$15;
            if ($$2 - this.q.h.a($$14) >= $$1) {
               $$15 = $$14;
            } else {
               $$15 = xi.b(Float.toString($$13));
            }
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(gir::B, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(gir::B, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(gir::B, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(gir::B, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(gir::B, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(gir::B, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
   ...
   static record b(xi a, int b, @Nullable xi c, int d) {
   }
}
