...
public abstract class cmm implements cmn, AutoCloseable {
   ...
   public void a(@Nullable bfj $$0, gu $$1, amg $$2, ami $$3, float $$4, float $$5) {
      this.a($$0 instanceof byo $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public cme a(@Nullable bfj $$0, double $$1, double $$2, double $$3, float $$4, cmm.a $$5) {
      return this.a($$0, null, null, $$1, $$2, $$3, $$4, false, $$5);
   }

   public cme a(@Nullable bfj $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, cmm.a $$6) {
      return this.a($$0, null, null, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   public cme a(@Nullable bfj $$0, @Nullable ben $$1, @Nullable cmf $$2, eei $$3, float $$4, boolean $$5, cmm.a $$6) {
   ...
   public cme a(@Nullable bfj $$0, @Nullable ben $$1, @Nullable cmf $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, cmm.a $$8, boolean $$9) {
      cme.a $$10 = switch ($$8) {
         case a -> cme.a.a;
         case b -> this.a(cmi.M);
         case c -> this.X().b(cmi.c) ? this.a(cmi.N) : cme.a.a;
         case d -> this.a(cmi.O);
      };
   ...
   public czn c_(gu $$0) {
      if (this.r($$0)) {
         ...
         return !this.B && Thread.currentThread() != this.c ? null : this.l($$0).a($$0, dei.b.a);
      }
   }
   ...
   public <T extends bfj> void a(dfz<bfj, T> $$0, eed $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      this.ad().d("getEntities");
      this.E().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   public boolean q(gu $$0) {
      if (!this.Z()) {
         ...
         return false;
      } else if (this.a(dhk.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         cnk $$1 = this.s($$0).a();
