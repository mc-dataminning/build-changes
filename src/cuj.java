...
public class cuj {
   ...
   private final cuj.a e;
   private final long f;

   public cuj(cuj.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cuj a(cuj.a $$0) {
      return new cuj($$0, this.f);
   }

   public ih<cuh> a(hx $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ih<cuh> a(double $$0, double $$1, double $$2) {
      int $$3 = is.a(aui.a($$0));
      int $$4 = is.a(aui.a($$1));
      int $$5 = is.a(aui.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = aue.a($$7, $$0);
      double $$10 = b($$7);
      return aui.k($$6 + $$10) + aui.k($$5 + $$9) + aui.k($$4 + $$8);
   }
   ...
   public interface a {
      ih<cuh> getNoiseBiome(int var1, int var2, int var3);
   }
}
