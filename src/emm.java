...
public class emm extends ena {
   public static final MapCodec<emm> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ji.a.e.fieldOf("axis").orElse(ji.a.b).forGetter($$0x -> $$0x.g)
            )
            .apply($$0, emm::new)
   );
   ...
   public emm(float $$0, float $$1, int $$2, int $$3, ji.a $$4) {
      if ($$2 >= $$3) {
