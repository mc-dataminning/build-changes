...
public class emm {
   private final ImmutableList<emn> a;
   private final ImmutableMap<String, emn> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private emk e;

   public emm(ImmutableMap<String, emn> $$0) {
      this.b = $$0;
