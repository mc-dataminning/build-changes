...
public class emm implements emp {
   public static final Codec<emm> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               btw.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               btw.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               btw.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               btu.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               btu.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public emm(int $$0, btw $$1, btw $$2, int $$3, int $$4, btw $$5, btu $$6, btu $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
