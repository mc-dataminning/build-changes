...
public abstract class emm {
   ...
   public elo a() {
      if (this.c()) {
         ...
         return new elo(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
      }
   }

   public emm b() {
      return this.c() ? emj.a() : emj.a(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
   }
   ...
   public emm a(double $$0, double $$1, double $$2) {
      return (emm)(this.c() ? emj.a() : new elv(this.a, new emi(this.a(ic.a.a), $$0), new emi(this.a(ic.a.b), $$1), new emi(this.a(ic.a.c), $$2)));
   }

   public emm d() {
      emm[] $$0 = new emm[]{emj.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = emj.b($$0[0], emj.a($$1, $$2, $$3, $$4, $$5, $$6), elx.o));
      return $$0[0];
   }

   public void a(emj.a $$0) {
      this.a
         .a(
   ...
   public List<elo> e() {
      List<elo> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new elo($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(ic.a $$0, double $$1) {
      return auo.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public elp a(elt $$0, elt $$1, hx $$2) {
      if (this.c()) {
         return null;
      } else {
         elt $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ic.a.a, $$4.c - (double)$$2.u()), this.a(ic.a.b, $$4.d - (double)$$2.v()), this.a(ic.a.c, $$4.e - (double)$$2.w()))
               ? new elp($$4, ic.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : elo.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<elt> a(elt $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         elt[] $$1 = new elt[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = auo.a($$0.a(), $$2, $$5);
            double $$9 = auo.a($$0.b(), $$3, $$6);
            double $$10 = auo.a($$0.c(), $$4, $$7);
   ...
   public emm a(ic $$0) {
      if (!this.c() && this != emj.b()) {
         if (this.b != null) {
            emm $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private emm b(ic $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new emk(this, $$1, $$4);
      }
   }

   public double a(ic.a $$0, elo $$1, double $$2) {
      return this.a(hv.a($$0, ic.a.a), $$1, $$2);
   }

   protected double a(hv $$0, elo $$1, double $$2) {
      if (this.c()) {
         return $$2;
