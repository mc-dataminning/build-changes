...
public class emm {
   private final List<ConcurrentLinkedQueue<eml>> a = ImmutableList.of(
   ...
   public void a(eml $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eml> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eml> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eml> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eml> j() {
