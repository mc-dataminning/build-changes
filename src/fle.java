...
public class fle {
   public static class a implements flt<iy> {
      ...
      public flq a(iy $$0, fis $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fle.b $$8 = new fle.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends fmq {
      ...
      public float b(float $$0) {
         return 7.1F * asb.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fmc {
      private boolean b;
      private boolean F;
      private final fls G;
      private float H;
      ...
      c(fis $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fls $$7, fml $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fle.c $$0 = new fle.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements flt<iy> {
      ...
      public flq a(iy $$0, fis $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fle.c $$8 = new fle.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, eqp.O().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends flo {
      private int a;
      private final fls b;
      private rc D;
      private boolean E;

      public e(fis $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fls $$7, @Nullable qw $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, aph.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            qw $$7 = this.D.a($$6);
            cip.a $$8 = cip.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            flq $$17 = this.b.a(iv.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               apf $$19 = $$18 ? apg.hL : apg.hK;
               this.c.a(this.g, this.h, this.i, $$19, aph.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fle.c $$10 = (fle.c)this.b.a(iv.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = asb.d($$18, $$13, $$16) * $$0;
                  double $$20 = asb.d($$18, $$14, $$17) * $$0;
