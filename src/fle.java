...
public class fle {
   ...
   private void b() {
      try {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            this.e[$$2] = gky.a.parse(ue.a, $$0.c(String.valueOf($$2))).resultOrPartial($$0x -> b.warn("Failed to parse hotbar: {}", $$0x)).orElseGet(gky::new);
         }
   ...
   public void a() {
      try {
         ...
         for (int $$1 = 0; $$1 < 9; $$1++) {
            gky $$2 = this.a($$1);
            DataResult<un> $$3 = gky.a.encodeStart(ue.a, $$2);
