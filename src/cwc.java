...
public abstract class cwc extends cwp {
   ...
   public static djg a(csu $$0, hx $$1) {
      hx $$2 = $$1.d();
      djg $$3 = $$0.a_($$2);
      return ddz.h($$3) ? cwr.cs.o() : ((czp)cwr.cr).b($$0, $$1);
   }
   ...
   public void a(djg $$0, cto $$1, hx $$2, auu $$3) {
      if ($$3.a(24) == 0) {
         $$1.a((double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, arr.ip, ars.e, 1.0F + $$3.i(), $$3.i() * 0.7F + 0.3F, false);
      }
   ...
   protected abstract boolean f(djg var1);
   ...
   public void b(djg $$0, cto $$1, hx $$2, djg $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<efo> $$5 = efo.a($$1, $$2, ic.a.a);
            if ($$5.isPresent()) {
               $$5.get().b();
               return;
            }
   ...
   public static boolean a(cto $$0, hx $$1, ic $$2) {
      djg $$3 = $$0.a_($$1);
      return !$$3.i() ? false : a($$0, $$1).a((ctr)$$0, $$1) || b($$0, $$1, $$2);
   }

   private static boolean b(cto $$0, hx $$1, ic $$2) {
      if (!a($$0)) {
         return false;
      } else {
         hx.a $$3 = $$1.j();
