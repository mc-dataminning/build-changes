...
public class evx {
   ...
   public evx(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evy> $$1) throws IOException {
   ...
   public List<evy> a(Path $$0) throws IOException {
      List<evy> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evy> a(Path $$0, boolean $$1) throws IOException {
      List<evy> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evy> $$1) throws IOException {
