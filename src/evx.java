...
public class evx extends aqo<Map<String, List<evx.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<evx.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(evx.a::a),
                     Codec.LONG.fieldOf("period").forGetter(evx.a::b),
                     Codec.STRING.fieldOf("title").forGetter(evx.a::c),
                     Codec.STRING.fieldOf("message").forGetter(evx.a::d)
                  )
                  .apply($$0, evx.a::new)
         )
         .listOf()
   ...
   public evx(ahh $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<evx.a>> a(aqj $$0, bgt $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<evx.a>> $$0, aqj $$1, bgt $$2) {
      List<evx.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<evx.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<evx.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<evx.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public evx.b a(List<evx.a> $$0, long $$1) {
         this.cancel();
         return new evx.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (evx.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> ezy.a(evr.O().ay(), ezy.a.f, vg.a($$2.c, $$3), vg.a($$2.d, $$3)));
                  return;
               }
            }
         }
