...
public class evx implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<evx.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public evx(List<evx.a> $$0) {
      this.c = $$0;
   }
   ...
   public static evx a(BufferedReader $$0) {
      return new evx($$0.lines().flatMap($$0x -> evx.a.a($$0x).stream()).toList());
   }

   public static record a(evx.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<evx.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new evx.a(evx.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new evx.a(evx.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new evx.a(evx.b.b, $$3));
      ...
      static evx.a b(String $$0) {
         return new evx.a(evx.b.a, "glob:" + $$0);
      }

      static evx.a c(String $$0) {
         return new evx.a(evx.b.a, "regex:" + $$0);
      }

      static evx.a d(String $$0) {
         return new evx.a(evx.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      evx.b a = FileSystem::getPathMatcher;
      evx.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
