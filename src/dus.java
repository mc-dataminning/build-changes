...
public abstract class dus {
   ...
   public final void c(tq $$0, jt.a $$1) {
      this.a($$0, $$1);
      dus.a.a.parse($$1.a(ue.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final tq d(jt.a $$0) {
      tq $$1 = new tq();
      this.b($$1, $$0);
      dus.a.a.encodeStart($$0.a(ue.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((tq)$$1x));
      return $$1;
   }
   ...
   public static void a(tq $$0, duu<?> $$1) {
      $$0.a("id", duu.a($$1).toString());
   }
   ...
   @Nullable
   public static dus a(ji $$0, dxq $$1, tq $$2, jt.a $$3) {
      String $$4 = $$2.l("id");
      aku $$5 = aku.c($$4);
      if ($$5 == null) {
   ...
   protected static void a(dgz $$0, ji $$1, dxq $$2) {
      $$0.q($$1);
      if (!$$2.l()) {
         $$0.b($$1, $$2.b());
      }
   ...
   public void a(ji $$0, dxq $$1, boolean $$2) {
      if (this instanceof bsr $$3 && this.n != null) {
         bsu.a(this.n, $$0, $$3);
      }
   }
   ...
   @Nullable
   public static wp a(@Nullable un $$0, jt.a $$1) {
      return $$0 == null
         ? null
         : (wp)wr.a.parse($$1.a(ue.a), $$0).resultOrPartial($$0x -> d.warn("Failed to parse custom name, discarding: {}", $$0x)).orElse(null);
   }
