...
public interface hi<T> extends Iterable<he<T>> {
   ...
   Either<aqa<T>, List<he<T>>> c();

   Optional<he<T>> a(aru var1);
   ...
   @Deprecated
   @VisibleForTesting
   static <T> hi.c<T> a(hh<T> $$0, aqa<T> $$1) {
      return new hi.c<>($$0, $$1);
   }
   ...
   public static class a<T> extends hi.b<T> {
      ...
      @Override
      public Either<aqa<T>, List<he<T>>> c() {
         return Either.right(this.a);
      }

      @Override
      public Optional<aqa<T>> d() {
