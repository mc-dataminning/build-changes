...
public abstract class gmg {
   ...
   protected static final gmg.n aq = new gmg.n(heq.d, bad.b, true);
   protected static final gmg.n ar = new gmg.n(heq.d, bad.b, false);
   ...
   protected static final gmg.k aO = new gmg.k("main_target", () -> fli.Q().h().a(false), () -> {
   });
   ...
   private static void a(float $$0) {
      long $$1 = (long)((double)af.c() * fli.Q().n.ap().c() * 8.0);
         ...
         super("line_width", () -> {
            if (!Objects.equals($$0, OptionalDouble.of(1.0))) {
               if ($$0.isPresent()) {
                  ...
                  RenderSystem.lineWidth(Math.max(2.5F, (float)fli.Q().aO().k() / 1920.0F * 2.5F));
               }
            }
         }, () -> {
            if (!Objects.equals($$0, OptionalDouble.of(1.0))) {
   ...
   protected static class i extends gmg.e {
      ...
      public static final class a {
         private final Builder<gmg.i.b> a = new Builder();

         public gmg.i.a a(akv $$0, boolean $$1, boolean $$2) {
            this.a.add(new gmg.i.b($$0, $$1, $$2));
            return this;
         }
