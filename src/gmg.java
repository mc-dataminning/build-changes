...
public class gmg extends auu<Optional<gmg.b>> implements AutoCloseable {
   ...
   private gmg.a o = gmg.a.b;
   @Nullable
   private fls p;
   @Nullable
   private gmg.b q;
   private final fgu r = new fgu(fel.b);
   private boolean s;

   protected Optional<gmg.b> a(aup $$0, bpj $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gmg.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gmg.b> $$0, aup $$1, bpj $$2) {
   ...
   public void a(int $$0, fls $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fbx $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            fgq $$21 = this.a(fgt.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
   ...
   private void a(gnh $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gmh $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fgq a(fgt $$0, int $$1, int $$2, fls $$3, gmg.a $$4, gnh $$5) {
      float $$6 = 0.8F;
   ...
   private void a(gmg.a $$0, fgm $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(gmg.a $$0, fgm $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
