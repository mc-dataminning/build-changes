...
public class gmg extends gmh {
   @Nullable
   private CompletableFuture<gmh.a> f;

   public gmg(ato $$0, akf $$1, Executor $$2) {
      super($$1);
      this.f = CompletableFuture.supplyAsync(() -> gmh.a.a($$0, $$1), $$2);
   }
   ...
   public void a(gmp $$0, ato $$1, akf $$2, Executor $$3) {
      this.f = CompletableFuture.supplyAsync(() -> gmh.a.a($$1, this.e), ac.f());
