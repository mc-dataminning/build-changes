...
public class djl<T extends dja> implements AutoCloseable {
   ...
   public void a(Writer $$0) throws IOException {
      aqz $$1 = aqz.a().a("x").a("y").a("z").a("visibility").a("load_status").a("entity_count").a($$0);
      this.f.a().forEach($$1x -> {
   ...
   class a implements djb {
      ...
      public void a() {
         ...
         if ($$1 != this.d) {
            djn $$2 = this.e.c();
            if (!this.e.b(this.c)) {
               djl.a.warn("Entity {} wasn't found in section {} (moving to {})", new Object[]{this.c, hz.a(this.d), $$1});
            }
      ...
      public void a(biq.c $$0) {
         if (!this.e.b(this.c)) {
            djl.a.warn("Entity {} wasn't found in section {} (destroying due to {})", new Object[]{this.c, hz.a(this.d), $$0});
         }
