...
public abstract class cdr extends cde {
   ...
   public cdr(bwo $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cdr(bwo $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cde.a.a, cde.a.c));
   }
   ...
   protected abstract boolean a(dhl var1, jh var2);
}
