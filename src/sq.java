...
public class sq extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<rs> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, rh.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<rs> $$0, Codec<T> $$1, rh $$2) {
      rs $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> sq a(DynamicOps<rs> $$0, Codec<T> $$1, T $$2) {
      rs $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = arp.a(h, this.r(), JsonElement.class);
   ...
   public <T> void a(hl<hg<T>> $$0, hg<T> $$1, sq.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> hg<T> a(hl<hg<T>> $$0, sq.a<T> $$1) {
      int $$2 = this.m();
      if ($$2 == 0) {
         return hg.a($$1.apply(this));
      } else {
         hg<T> $$3 = $$0.a($$2 - 1);
         if ($$3 == null) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, sq.a<T> $$1) {
      int $$2 = this.m();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, sq.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, sq.a<K> $$1, sq.a<V> $$2) {
      int $$3 = this.m();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(sq.a<K> $$0, sq.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, sq.b<K> $$1, sq.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, sq.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, sq.b<L> $$1, sq.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(sq.a<L> $$0, sq.a<R> $$1) {
   ...
   public ehp k() {
      return new ehp(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> sq a(ToIntFunction<T> $$0, T $$1) {
   ...
   public sq a(@Nullable rs $$0) {
      if ($$0 == null) {
         $$0 = ra.b;
      }

      try {
         rj.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   @Nullable
   public qy p() {
      rs $$0 = this.a(rh.a(2097152L));
      if ($$0 != null && !($$0 instanceof qy)) {
   ...
   public rs a(rh $$0) {
      try {
         rs $$1 = rj.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return td.a(this.d, $$0);
   }

   public sq a(String $$0) {
      return this.a($$0, 32767);
   }

   public sq a(String $$0, int $$1) {
      td.a(this.d, $$0, $$1);
      return this;
   }

   public aey s() {
      return new aey(this.d(32767));
   }
   ...
   public <T> aex<T> a(aex<? extends ht<T>> $$0) {
      aey $$1 = this.s();
      return aex.a($$0, $$1);
   }
   ...
   public ehl x() {
      gw $$0 = this.e();
      hc $$1 = this.b(hc.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new ehl(new ehp((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ary.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), sq::a);
   }

   public Property B() {
      String $$0 = this.r();
      String $$1 = this.r();
      String $$2 = this.c(sq::r);
   ...
   public sq a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sq a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public sq a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sq a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sq a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sq a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sq a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public sq a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public sq b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public sq c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public sq d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public sq e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public sq f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public sq g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public sq h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public sq a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public sq b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public sq i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public sq a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public sq a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public sq b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sq b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public sq b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sq b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sq b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sq b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public sq a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sq a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public sq a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sq a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public sq a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sq a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public sq a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public sq b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public sq b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public sq b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sq b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public sq b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
   ...
   @FunctionalInterface
   public interface a<T> extends Function<sq, T> {
      default sq.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<sq, T> {
      default sq.b<Optional<T>> asOptional() {
