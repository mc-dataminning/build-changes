...
public class bbc extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bdn.y);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bbc::c), this.a("minecraft:arrow", bbc::a), this.a("minecraft:spectral_arrow", bbc::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bbc.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bdn.y, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bdn.y, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bbc.a<?> $$1, Type<?> $$2, Type<T> $$3) {
