...
public class bbc extends bfu {
   public bbc(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bgw.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bgw.s, "minecraft:piston");
