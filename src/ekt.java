...
public class ekt extends ejy<emk> {
   public ekt(Codec<emk> $$0) {
      super($$0);
   }
   ...
   protected boolean a(
      dkl $$0, azv $$1, emk $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(eat $$0, Function<iv, eat> $$1, azv $$2, emk $$3, emk.a $$4, iv.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
