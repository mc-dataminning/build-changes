...
public class ekt implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ekt.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ekt(List<ekt.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ekt a(BufferedReader $$0) {
      return new ekt($$0.lines().flatMap($$0x -> ekt.a.a($$0x).stream()).toList());
   }

   public static record a(ekt.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ekt.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ekt.a(ekt.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ekt.a(ekt.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ekt.a(ekt.b.b, $$3));
      ...
      static ekt.a b(String $$0) {
         return new ekt.a(ekt.b.a, "glob:" + $$0);
      }

      static ekt.a c(String $$0) {
         return new ekt.a(ekt.b.a, "regex:" + $$0);
      }

      static ekt.a d(String $$0) {
         return new ekt.a(ekt.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ekt.b a = FileSystem::getPathMatcher;
      ekt.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
