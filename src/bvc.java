...
public class bvc extends bvj implements bxe {
   private static final Logger c = LogUtils.getLogger();
   private static final int d = 5;
   private static final alc<Float> e = alg.a(bvc.class, ale.d);
   private static final alc<Boolean> f = alg.a(bvc.class, ale.k);
   private static final alc<lq> g = alg.a(bvc.class, ale.l);
   ...
   private czn k = czn.a;
   private final Map<bvj, Integer> l = Maps.newHashMap();
   private int m = 600;
   private int n = 20;
   private int o = 20;
   private int p;
   ...
   public bvc(bvq<? extends bvc> $$0, dhh $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public bvc(dhh $$0, double $$1, double $$2, double $$3) {
      this(bvq.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof ll $$1) {
         int $$2 = this.k.equals(czn.a) ? 0 : this.k.b();
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  List<buo> $$4 = Lists.newArrayList();
                  if (this.k.e().isPresent()) {
                     for (buo $$5 : this.k.e().get().a().a()) {
                        $$4.add(new buo($$5.c(), $$5.a($$0x -> $$0x / 4), $$5.e(), $$5.f(), $$5.g()));
                     }
                  }
   ...
   protected void a(ux $$0) {
      ...
      if ($$0.e("potion_contents")) {
         czn.b.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> c.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(ux $$0) {
      ...
      if (!this.k.equals(czn.a)) {
         vu $$2 = (vu)czn.b.encodeStart($$1, this.k).getOrThrow();
