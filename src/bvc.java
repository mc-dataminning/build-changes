...
public class bvc extends bvf {
   ...
   public bvc(bok $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<bok> $$0 = this.a.dM().a(bok.class, this.a.cH().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bok $$1 : $$0) {
            if (!$$1.ce()) {
               this.c = $$1;
