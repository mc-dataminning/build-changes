...
public class eyg extends eyj {
   public static final int a = 854;
   public static final int b = 480;
   static final eyg.b l = new eyg.b(854, 480);

   public eyg(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eyg.a[] e = values();
   ...
   static class b {
      ...
      static List<eyg.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyg.b($$0, $$1), eyg.l) : ImmutableList.of(eyg.l);
      }
