...
public abstract class eyg<T extends eyg<T>> {
   ...
   public eyg(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eye.a();
         if ($$3 != null) {
         ...
         throw new ezp(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ezp(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ezp(var2.getMessage(), var2);
      }
   }
   ...
   public static eyg<?> a(String $$0) {
      return new eyg.b($$0, 5000, 60000);
   }

   public static eyg<?> a(String $$0, int $$1, int $$2) {
      return new eyg.b($$0, $$1, $$2);
   }

   public static eyg<?> b(String $$0, String $$1) {
      return new eyg.c($$0, $$1, 5000, 60000);
   }

   public static eyg<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eyg.c($$0, $$1, $$2, $$3);
   }

   public static eyg<?> b(String $$0) {
      return new eyg.a($$0, 5000, 60000);
   }

   public static eyg<?> c(String $$0, String $$1) {
      return new eyg.d($$0, $$1, 5000, 60000);
   }

   public static eyg<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eyg.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eyg<eyg.a> {
   ...
   public static class b extends eyg<eyg.b> {
   ...
   public static class c extends eyg<eyg.c> {
      ...
      public eyg.c f() {
         try {
            ...
            throw new ezp(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eyg<eyg.d> {
      private final String c;
