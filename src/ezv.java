...
public class ezv extends ezz implements ezx {
   ...
   public ezv.c a() {
      return new ezv.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(faf.b $$0, faf $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (fag)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(faf $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == ezy.k;
         boolean $$2 = $$0 == ezy.j;
   ...
   private IntConsumer a(int $$0, faf.a $$1) {
   ...
   private ezv.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezv.a $$9 = new ezv.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezv.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == faf.b.a || this.q == faf.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fag> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fag $$1 = (fag)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fag.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fag.b.c) {
         ezx.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezx.a($$11));
         this.a($$14 + 5, ezx.a($$12));
         this.a($$14 + 6, ezx.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(faf a, int b, int c, faf.b d, faf.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezv.a c;
      private boolean d;

      b(final int $$1, final ezv.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(faf.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fai $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
