...
public class bwx extends bvh<che> {
   ...
   protected void b(aqu $$0, che $$1, long $$2) {
      ...
      buq<?> $$4 = $$1.dU();
      exa $$5 = $$4.c(ccs.W).get();
      this.i = new exa((double)$$3.u() - $$5.a(), 0.0, (double)$$3.w() - $$5.c()).d();
      $$4.a(ccs.m, new ccv($$5, this.g, 0));
   }

   protected void c(aqu $$0, che $$1, long $$2) {
      List<btn> $$3 = $$0.a(btn.class, this.f, $$1, $$1.cL());
      buq<?> $$4 = $$1.dU();
      if (!$$3.isEmpty()) {
         btn $$5 = $$3.get(0);
         brk $$6 = $$0.aj().c((btn)$$1);
         ...
         float $$10 = ayo.a($$1.fk() * 1.65F, 0.2F, 3.0F) + $$9;
   ...
   private boolean c(aqu $$0, che $$1) {
      exa $$2 = $$1.ds().d(1.0, 0.0, 1.0).d();
      jd $$3 = jd.a((jw)$$1.dn().e($$2));
      return $$0.a_($$3).a(awe.cm) || $$0.a_($$3.d()).a(awe.cm);
   }

   protected void b(aqu $$0, che $$1) {
      $$0.a($$1, (byte)59);
      $$1.dU().a(ccs.V, this.e.apply($$1).a($$0.z));
      $$1.dU().b(ccs.W);
   }
}
