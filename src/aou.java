...
public class aou {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wp.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wp.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wp.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ex $$0, fba $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bum> $$6) throws CommandSyntaxException {
      ard $$7 = $$0.e();
      int $$8 = $$7.L_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         aou.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> wp.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bum> $$0) {
      Set<fci> $$1 = Sets.newHashSet();
   ...
   private static void a(fba $$0, double $$1, ard $$2, azh $$3, double $$4, double $$5, double $$6, double $$7, int $$8, aou.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bum> $$0, ard $$1, aou.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<fci, aou.a> $$7 = Maps.newHashMap();

      for (bum $$8 : $$0) {
         aou.a $$10;
         if ($$4) {
            fci $$9 = $$8 instanceof coy ? $$8.cr() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)ayz.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)ayz.a($$10.b) + 0.5, Set.of(), $$8.dL(), $$8.dN(), true);
   ...
   private static aou.a[] a(azh $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aou.a[] $$6 = new aou.a[$$1];
