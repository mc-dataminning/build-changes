...
public class aou extends aoo {
   static final Logger c = LogUtils.getLogger();
   private final aou.b d;
   private final String e;

   aou(String $$0, aou.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aox $$0, ahg $$1) {
   ...
   @Nullable
   private aqa<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aqa.create($$1, $$2);
      }
   }
   ...
   public static class a implements apq.c {
      ...
      public aow a(String $$0) {
         aou.b $$1 = new aou.b(this.a);
         return new aou($$0, $$1, this.b, "");
      }

      @Override
      public aow a(String $$0, apq.a $$1) {
         aou.b $$2 = new aou.b(this.a);
         aow $$3 = new aou($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aow> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aou($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aou.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
