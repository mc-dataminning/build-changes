...
public class ebx extends ebk<edh> {
   public ebx(Codec<edh> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? ayg.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(ayo $$0, dcg $$1, int $$2, int $$3, ja $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ja $$2, dcg $$3, boolean $$4, double $$5, ja $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dcg $$0, ja $$1) {
      if ($$0.a_($$1.c()).a(dfj.dN)) {
         this.a($$0, $$1.c(), dfj.a.o());
      }
   }

   private void a(dcg $$0, ayo $$1, ja $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dsk $$13) {
   ...
   private void a(ja $$0, dcg $$1, ayo $$2, int $$3, int $$4, boolean $$5, boolean $$6, dsk $$7) {
      dsk $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dfj.dP) || $$8.a(dfj.dO) || $$8.a(dfj.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dfj.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dfj.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, ja $$2, int $$3, ayo $$4) {
      float $$5 = 10.0F * ayg.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(ayo $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(ayo $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dsk $$0) {
      return $$0.a(dfj.iC) || $$0.a(dfj.dP) || $$0.a(dfj.mW);
   }
   ...
   private void a(dcg $$0, ja $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dfj.dN)) {
                  if (this.a((dbl)$$0, $$10)) {
                     this.a($$0, $$10, dfj.a.o());
                     this.a($$0, $$10.c(), dfj.a.o());
                  } else if (c($$11)) {
                     dsk[] $$12 = new dsk[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
