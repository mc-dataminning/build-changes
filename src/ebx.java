...
public class ebx implements dmp.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ebx> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final atk<ebx> a = atk.a(f);
   private final ecb g;
   private final ecb h;
   private final ecb i;
   ...
   public static ebx a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ebx(new dnx(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ebx(ecb $$0, ecb $$1, ecb $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ebx(atw $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ecb.a($$0, IntStream.rangeClosed(-15, 0)),
         ecb.a($$0, IntStream.rangeClosed(-15, 0)),
         ecb.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ebx a(atw $$0) {
      return new ebx($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dmp.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eby $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ecb.b($$4 * $$13), ecb.b($$5 * $$13), ecb.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ecb.b($$1 * $$13);
         double $$21 = ecb.b($$2 * $$13);
         double $$22 = ecb.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eby $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return atq.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
