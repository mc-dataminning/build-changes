...
public class ebx {
   ...
   private final Map<String, ebm> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public ebx(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends ebm> T a(ebm.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends ebm> T b(ebm.a $$0, String $$1) {
      ebm $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends ebm> T a(Function<qu, T> $$0, asv $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
            qu $$4 = this.a($$2, $$1, aa.b().d().c());
   ...
   public qu a(String $$0, asv $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
