...
public class fsi extends fsf {
   ...
   private final euu cG;
   private final List<ghj> cH = Lists.newArrayList();
   private int cI = 0;
   private double cJ;
   private double cK;
   private double cL;
   ...
   public fsi(evh $$0, fnr $$1, fns $$2, asc $$3, euu $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.q());
      this.cp = $$0;
      this.cn = $$2;
      this.cF = $$3;
      ...
      this.cQ = $$5;
      this.cR = $$6;
      this.cH.add(new gib(this, $$0.ai()));
      this.cH.add(new gho(this));
      this.cH.add(new ghn(this, $$0.ai(), $$1.G_()));
   }
   ...
   public boolean a(blu $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cgz) {
            this.cp.ai().a((ghz)(new ght(this, (cgz)$$0, true)));
            this.cp.ai().a((ghz)(new ght(this, (cgz)$$0, false)));
         }
   ...
   public void a(did $$0, boolean $$1) {
      if ($$0 instanceof dhr $$2) {
         this.cp.a(new few($$2, $$1, this.cp.aQ()));
      } else {
         this.cp.a(new ffj($$0, $$1, this.cp.aQ()));
      }
   }
   ...
   private void G() {
      ...
      float $$0 = 0.0F;
      if (this.av) {
         if (this.cp.y != null && !this.cp.y.k() && !(this.cp.y instanceof fbz)) {
            if (this.cp.y instanceof fdz) {
               this.r();
            }
         ...
         if (this.cw == 0.0F) {
            this.cp.ai().a(ghu.b(arr.tM, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected boolean fL() {
      ...
      if (this.P_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.cp.ai().a((ghz)(new gic.b(this)));
         }
