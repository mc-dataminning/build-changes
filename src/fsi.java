...
public class fsi extends fsn<bwz> {
   ...
   public static fht a() {
      fhv $$0 = new fhv();
      fhw $$1 = $$0.a();
      $$1.a("glass", fhs.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fhp.a);
      $$1.a("cube", fhs.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fhp.a);
      $$1.a("base", fhs.c().a(0, 16).a(-6.0F, 0.0F, -6.0F, 12.0F, 4.0F, 12.0F), fhp.a);
      return fht.a($$0, 64, 32);
   }

   public void a(bwz $$0, float $$1, float $$2, elg $$3, fnl $$4, int $$5) {
      $$3.a();
      float $$6 = a($$0, $$2);
   ...
   public boolean a(bwz $$0, fqn $$1, double $$2, double $$3, double $$4) {
