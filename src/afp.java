...
public class afp {
   ...
   private static final Object2IntMap<Class<? extends bki>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final bki d;
   private final Int2ObjectMap<afp.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> afm<T> a(Class<? extends bki> $$0, afn<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(afm<T> $$0, T $$1) {
      afp.a<T> $$2 = new afp.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(afm<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> afp.a<T> c(afm<T> $$0) {
      this.f.readLock().lock();

      afp.a<T> $$1;
      try {
         $$1 = (afp.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(afm<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(afm<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(afm<T> $$0, T $$1, boolean $$2) {
      afp.a<T> $$3 = this.c($$0);
   ...
   private <T> void a(afp.a<T> $$0, afp.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public afp.b<T> e() {
         return afp.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, afn<T> b, T c) {

      public static <T> afp.b<T> a(afm<T> $$0, T $$1) {
         afn<T> $$2 = $$0.b();
         return new afp.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static afp.b<?> a(tu $$0, int $$1) {
         int $$2 = $$0.n();
         afn<?> $$3 = afo.a($$2);
         if ($$3 == null) {
      ...
      private static <T> afp.b<T> a(tu $$0, int $$1, afn<T> $$2) {
         return new afp.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
