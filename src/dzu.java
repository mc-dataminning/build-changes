...
public class dzu {
   ...
   public dzu(byte[] $$0) {
      ...
      this.f = 0;
      if ($$0.length != 2048) {
         throw (IllegalArgumentException)ae.b(new IllegalArgumentException("DataLayer should be 2048 bytes not: " + $$0.length));
      }
   }
   ...
   public dzu b() {
      return this.d == null ? new dzu(this.f) : new dzu((byte[])this.d.clone());
   }
