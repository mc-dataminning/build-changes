...
public class dzu {
   ...
   private final Map<Character, Predicate<dzs>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dzu a(char $$0, Predicate<dzs> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dzs>[][][] c() {
      this.d();
      Predicate<dzs>[][][] $$0 = (Predicate<dzs>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dzs>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
