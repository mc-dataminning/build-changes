...
public class ghj implements AutoCloseable {
   ...
   public ghj(ghb $$0, fip $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new fbt(16, 16, false);
      this.e.a(9729);
   ...
   private float b(float $$0) {
      bsy $$1 = this.i.t.c(bta.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bun $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, azf.b(((float)$$0.ag - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$1 != null) {
            ...
            if (this.i.t.b(bta.p)) {
               $$9 = ghb.a(this.i.t, $$0);
            } else if ($$8 > 0.0F && this.i.t.b(bta.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
            ...
            ggu $$17 = Objects.requireNonNull(RenderSystem.setShader(ggv.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            fdd $$18 = RenderSystem.renderThreadTesselator().a(fdn.c.h, fdg.a);
            $$18.a(0.0F, 0.0F, 0.0F);
            $$18.a(1.0F, 0.0F, 0.0F);
            $$18.a(1.0F, 1.0F, 0.0F);
            $$18.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(dyo $$0, int $$1) {
      return a($$0.s(), $$1);
   }
