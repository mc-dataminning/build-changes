...
public class bzu extends bzt implements cbb {
   private static final Logger b = LogUtils.getLogger();
   private static final adz<Boolean> c = aec.a(bzu.class, aeb.k);
   private static final adz<cba> d = aec.a(bzu.class, aeb.t);
   ...
   public bzu(bim<? extends bzu> $$0, cpl $$1) {
      super($$0, $$1);
      jb.A.a(this.ag).ifPresent($$0x -> this.a(this.gl().a((cbc)$$0x.a())));
   }
   ...
   protected void a_() {
      super.a_();
      this.an.a(c, false);
      this.an.a(d, new cba(cbe.c, cbc.b, 1));
   }

   @Override
   public void b(qr $$0) {
      super.b($$0);
      cba.c.encodeStart(rc.a, this.gl()).resultOrPartial(b::error).ifPresent($$1 -> $$0.a("VillagerData", $$1));
      if (this.ce != null) {
         $$0.a("Offers", this.ce);
      }
   ...
   public void b(byte $$0) {
      if ($$0 == 16) {
         if (!this.aS()) {
            this.dK().a(this.dp(), this.dt(), this.dv(), aow.Bt, this.da(), 1.0F + this.ag.i(), this.ag.i() * 0.7F + 0.3F, false);
         }
      } else {
         super.b($$0);
      }
         ...
         for (int $$3 = (int)this.dp() - 4; $$3 < (int)this.dp() + 4 && $$1 < 14; $$3++) {
            for (int $$4 = (int)this.dr() - 4; $$4 < (int)this.dr() + 4 && $$1 < 14; $$4++) {
               for (int $$5 = (int)this.dv() - 4; $$5 < (int)this.dv() + 4 && $$1 < 14; $$5++) {
                  dez $$6 = this.dK().a_($$2.d($$3, $$4, $$5));
                  if ($$6.a(csm.eX) || $$6.b() instanceof cse) {
                     if (this.ag.i() < 0.3F) {
                        $$0++;
                     }
