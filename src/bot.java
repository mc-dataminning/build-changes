...
public abstract class bot<R extends Runnable> implements bob, bov<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bot(String $$0) {
      this.b = $$0;
      bnz.a.a(this);
   }
   ...
   @Override
   public List<bny> bv() {
      return ImmutableList.of(bny.a(this.b + "-pending-tasks", bnx.b, this::bx));
   }
}
