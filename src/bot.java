...
public class bot extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bow.a(new Dynamic($$0, $$1), bot.a, bow.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), biz.s.typeName()) ? super.getChoiceType($$0, bku.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, biz.s, () -> DSL.optionalFields("components", biz.w.in($$0), DSL.taggedChoiceLazy("id", bku.a(), $$2)));
