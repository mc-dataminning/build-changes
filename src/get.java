public class get extends gfo {
   private final gfj a;

   get(gbh $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gfj $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cnu $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dz();
            if (this.h > $$1) {
   ...
   public static class a implements ger<lr> {
      ...
      public geo a(lr $$0, gbh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new get($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements ger<lr> {
      ...
      public geo a(lr $$0, gbh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         geo $$8 = new get($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
