...
public class get {
   ...
   public gem a(Vector3f $$0, Vector3f $$1, geo $$2, gpa $$3, je $$4, grj $$5, @Nullable gep $$6, boolean $$7, alf $$8) {
      geq $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      return new gem($$14, $$2.c, $$15, $$3, $$7);
   }

   public static geq a(geq $$0, je $$1, j $$2, alf $$3) {
      ...
      return new geq(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(geq $$0, gpa $$1, je $$2, float[] $$3, j $$4, @Nullable gep $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, je $$2, geq $$3, float[] $$4, gpa $$5, j $$6, @Nullable gep $$7, boolean $$8) {
      gdg.b $$9 = gdg.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gpa $$3, geq $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gep $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
