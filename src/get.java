public class get extends gda<hbe> {
   ...
   private static ggk c() {
      ggk $$0 = new ggk();
      ggm $$1 = $$0.a();
      $$1.a("lid", ggh.c().a(0, 0).a(-8.0F, -16.0F, -8.0F, 16.0F, 12.0F, 16.0F), gge.a(0.0F, 24.0F, 0.0F));
      $$1.a("base", ggh.c().a(0, 28).a(-8.0F, -8.0F, -8.0F, 16.0F, 8.0F, 16.0F), gge.a(0.0F, 24.0F, 0.0F));
      return $$0;
   }

   public static ggi a() {
      ggk $$0 = c();
      $$0.a().a("head", ggh.c().a(0, 52).a(-3.0F, 0.0F, -3.0F, 6.0F, 6.0F, 6.0F), gge.a(0.0F, 12.0F, 0.0F));
