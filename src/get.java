...
public class get implements fae, AutoCloseable {
   ...
   private static final ezx t = new ezx();
   ...
   private final List<faf> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, faf> C = Maps.newHashMap();
   private final int D;
   ...
   public get(atz $$0, String $$1, fat $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         this.H = a($$0, fac.a.a, $$6);
         this.I = a($$0, fac.a.b, $$7);
         this.D = fad.a();
         int $$18 = 0;
   ...
   private static fac a(final atz $$0, fac.a $$1, String $$2) throws IOException {
      fac $$3 = $$1.c().get($$2);
      fac $$8;
      if ($$3 == null) {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        get.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static ezy a(JsonObject $$0) {
      if ($$0 == null) {
         return new ezy();
      } else {
         int $$1 = 32774;
