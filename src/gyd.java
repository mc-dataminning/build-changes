...
public class gyd implements gxw {
   static final Logger c = LogUtils.getLogger();
   public static final MapCodec<gyd> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.list(alh.a).fieldOf("textures").forGetter($$0x -> $$0x.d),
               alh.a.fieldOf("palette_key").forGetter($$0x -> $$0x.f),
               Codec.unboundedMap(Codec.STRING, alh.a).fieldOf("permutations").forGetter($$0x -> $$0x.e)
            )
            .apply($$0, gyd::new)
   );
   private final List<alh> d;
   private final Map<String, alh> e;
   private final alh f;

   private gyd(List<alh> $$0, alh $$1, Map<String, alh> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   public void a(ava $$0, gxw.a $$1) {
      ...
      for (alh $$4 : this.d) {
         ...
         if ($$6.isEmpty()) {
            ...
            gyc $$7 = new gyc($$5, $$6.get(), $$3.size());

            for (Entry<String, Supplier<IntUnaryOperator>> $$8 : $$3.entrySet()) {
               alh $$9 = $$4.g("_" + $$8.getKey());
               $$1.a($$9, new gyd.a($$7, $$8.getValue(), $$9));
            }
         }
      }
   }
   ...
   private static int[] a(ava $$0, alh $$1) {
   ...
   static record a(gyc a, Supplier<IntUnaryOperator> b, alh c) implements gxw.b {
      @Nullable
      public gxm a(gxv $$0) {
         Object var3;
         try {
            fct $$1 = this.a.a().a(this.b.get());
            return new gxm(this.c, new gzg($$1.a(), $$1.b()), $$1, avc.a);
         } catch (IllegalArgumentException | IOException var7) {
            gyd.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
