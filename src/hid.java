...
public class hid implements hig<String> {
   ...
   private static final MapCodec<hid.a> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final hig.a<hid, String> c = hig.a.a(f.flatXmap(hid::a, $$0 -> DataResult.success($$0.g)), b);
   private final hid.a g;
   private final DateFormat h;
   private long i;
   private String j = "";

   private hid(hid.a $$0, DateFormat $$1) {
      this.g = $$0;
      this.h = $$1;
   }

   public static hid a(String $$0, String $$1, Optional<TimeZone> $$2) {
      return (hid)a(new hid.a($$0, $$1, $$2)).getOrThrow($$0x -> new IllegalStateException("Failed to validate format: " + $$0x));
   }

   private static DataResult<hid> a(hid.a $$0) {
      ...
      return DataResult.success(new hid($$0, $$3));
   }
