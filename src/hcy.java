...
public class hcy implements aut<hcx> {
   public hcx b(JsonObject $$0) {
      Builder<hcw> $$1 = ImmutableList.builder();
      ...
      return new hcx($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private hcw a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new hcw(azu.g($$1, "frames[" + $$0 + "]"));
