...
public class dwu {
   ...
   private double j;
   int k = 29999984;
   private dwu.a l = new dwu.d(5.999997E7F);
   public static final dwu.c d = new dwu.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public jg b(double $$0, double $$1, double $$2) {
      return jg.a((jz)this.c($$0, $$1, $$2));
   }
   ...
   public ezh c(double $$0, double $$1, double $$2) {
      return new ezh(azj.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azj.a($$2, this.f(), this.h() - 1.0E-5F));
   }

   public double a(btz $$0) {
   ...
   public boolean a(btz $$0, ezc $$1) {
      double $$2 = Math.max(azj.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dwu.a)($$0 == $$1 ? new dwu.d($$1) : new dwu.b($$0, $$1, $$2));
   ...
   class b implements dwu.a {
      ...
      @Override
      public double a() {
         return azj.a(dwu.this.a() - this.e() / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
      }

      @Override
      public double c() {
         return azj.a(dwu.this.b() - this.e() / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azj.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dwt i() {
         return this.c < this.b ? dwt.b : dwt.a;
      }
      ...
      @Override
      public dwu.a l() {
         return (dwu.a)(this.g() <= 0L ? dwu.this.new d(this.c) : this);
      }
      ...
      public fab m() {
         return ezy.a(
            ezy.c,
            ezy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezl.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dwu.c a(DynamicLike<?> $$0, dwu.c $$1) {
         double $$2 = azj.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azj.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dwu.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dwu.a {
      ...
      private void n() {
         this.c = azj.a(dwu.this.a() - this.b / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
         this.d = azj.a(dwu.this.b() - this.b / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
         this.e = azj.a(dwu.this.a() + this.b / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
         this.f = azj.a(dwu.this.b() + this.b / 2.0, (double)(-dwu.this.k), (double)dwu.this.k);
         this.g = ezy.a(
            ezy.c,
            ezy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezl.e
