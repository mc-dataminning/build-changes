...
public final class dwu extends dwx<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dwu(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dwu $$1 && super.equals($$0)) {
   ...
   public static dwu a(String $$0, int $$1, int $$2) {
      return new dwu($$0, $$1, $$2);
   }
