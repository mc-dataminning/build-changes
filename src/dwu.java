...
public class dwu {
   ...
   public dwu(dgi $$0, ji $$1, jn $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dwx $$0 = this.b.a_(this.e);
      if (!dwq.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == ete.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dwx $$0) {
      return $$0.a(djo.it) || $$0.a(djo.pI);
   }

   private static boolean a(dwx $$0, dwx $$1) {
      if ($$0.a(djo.pI) && $$1.a(djo.it)) {
         return false;
      } else {
         return $$0.a(djo.it) && $$1.a(djo.pI) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ji $$0, jn $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dwq.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dwx $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dwq.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dwq.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
