...
public class ahd {
   ...
   private static int a(dt $$0, fx $$1, Collection<akr> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = $$1.a().l();
      int $$5 = $$4 * 100;
      cjf $$6 = $$1.a($$3, false);
      if ($$3 > $$5) {
         ...
         for (akr $$7 : $$2) {
            ...
            while ($$8 > 0) {
               ...
               if ($$11 && $$10.b()) {
                  ...
                  $$7.dL().a(null, $$7.dq(), $$7.ds(), $$7.dw(), apd.ma, ape.h, 0.2F, (($$7.ef().i() - $$7.ef().i()) * 0.7F + 1.0F) * 2.0F);
                  $$7.bS.d();
               } else {
                  byn $$12 = $$7.a($$10, false);
                  if ($$12 != null) {
