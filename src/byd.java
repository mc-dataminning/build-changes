...
public class byd extends bjg {
   ...
   public static final aee<Byte> bC = aeh.a(byd.class, aeg.a);
   public static final aee<hv> bD = aeh.a(byd.class, aeg.m);
   public static final aee<hv> bE = aeh.a(byd.class, aeg.m);
   public static final aee<hv> bF = aeh.a(byd.class, aeg.m);
   public static final aee<hv> bG = aeh.a(byd.class, aeg.m);
   public static final aee<hv> bH = aeh.a(byd.class, aeg.m);
   public static final aee<hv> bI = aeh.a(byd.class, aeg.m);
   private static final Predicate<biq> bX = $$0 -> $$0 instanceof cdl && ((cdl)$$0).z() == cdl.a.a;
   private final hn<cjf> bY = hn.a(2, cjf.b);
   private final hn<cjf> bZ = hn.a(4, cjf.b);
   private boolean ca;
   public long bJ;
   private int cb;
   private hv cc = bL;
   ...
   public boolean a(bho $$0, float $$1) {
      if (this.dL().B || this.dG()) {
         ...
         return false;
      } else if ($$0.a(apu.v) && this.eu() > 0.5F) {
         this.g($$0, 4.0F);
         return false;
      } else {
         boolean $$2 = "player".equals($$0.e());
         boolean $$3 = $$0.a(apu.A);
         if (!$$2 && !$$3) {
            return false;
         } else {
            if ($$0.d() instanceof cbu $$4 && !$$4.fS().e) {
               return false;
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 32) {
         if (this.dL().B) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.an, this.da(), 0.3F, 1.0F, false);
            this.bJ = this.dL().V();
         }
      } else {
         super.b($$0);
   ...
   private void L() {
      this.dL().a(null, this.dq(), this.ds(), this.dw(), apd.al, this.da(), 1.0F, 1.0F);
   }
   ...
   @Override
   public bjg.a eF() {
      return new bjg.a(apd.am, apd.am);
   }
