...
public class vh {
   public static <T extends uy> vh.b a(va<T> $$0) {
      return a(new uw<T>($$0));
   }

   private static vh.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends uy> vh.d b(va<T> $$0) {
      return a(new ux<T>($$0));
   }

   private static vh.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof xz)) {
            $$0.fireChannelRead($$1);
         } else {
