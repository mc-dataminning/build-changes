...
public class grx implements avi, AutoCloseable {
   private static final Logger d = LogUtils.getLogger();
   private static final alk e = alk.b("transparency");
   private static final alk f = alk.b("entity_outline");
   ...
   private final guo j;
   private final gsk k;
   private final gsx l = new gsx();
   private final grm m = new grm();
   private final gtd n = new gtd();
   private final gtc o = new gtc();
   @Nullable
   private gmd p;
   private final gss q = new gss();
   private final ObjectArrayList<gvs.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gvs.b> s = new ObjectArrayList(50);
   private final Set<dye> t = Sets.newHashSet();
   @Nullable
   private gta u;
   private int v;
   private final Int2ObjectMap<aqu> w = new Int2ObjectOpenHashMap();
   private final Long2ObjectMap<SortedSet<aqu>> x = new Long2ObjectOpenHashMap();
   @Nullable
   private fjs y;
   private final gry z = new gry();
   ...
   private gvs I;
   private int J = -1;
   private final List<bwv> K = new ArrayList<>();
   private int L;
   private gvw M;
   private boolean N;
   @Nullable
   ...
   public grx(frf $$0, gyi $$1, guo $$2, gsk $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void a() {
      ...
      this.y = new fjt("Entity Outline", this.h.aO().k(), this.h.aO().l(), true);
   }
   ...
   public void d() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gvs(this.p, this, ag.h(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
         ...
         this.u = new gta(this.I, this.p, this.h.n.aH(), this);
         this.q.a(this.u);
         this.A();
         fqn $$0 = this.h.j.k();
         this.u.a(jz.a($$0.b()));
   ...
   private void a(fqn $$0, gvw $$1, boolean $$2, boolean $$3) {
      ffs $$4 = $$0.b();
   ...
   public static gvw a(gvw $$0) {
      return new gvw($$0).a(8);
   }

   private void b(gvw $$0) {
      if (!frf.Q().bx()) {
         throw new IllegalStateException("applyFrustum called from wrong thread: " + Thread.currentThread().getName());
      } else {
         brc.a().a("apply_frustum");
         this.A();
   ...
   public void a(ffs $$0, Matrix4f $$1, Matrix4f $$2) {
      this.M = new gvw($$1, $$2);
      this.M.a($$0.a(), $$0.b(), $$0.c());
   }

   public void a(fks $$0, fqv $$1, boolean $$2, fqn $$3, grs $$4, Matrix4f $$5, Matrix4f $$6) {
      float $$7 = $$1.a(false);
      ...
      gvw $$14 = $$13 ? this.O : this.M;
      brc.a().b("captureFrustum");
      if (this.N) {
         this.O = $$13 ? new gvw($$5, $$6) : $$14;
         this.O.a($$10, $$11, $$12);
         this.N = false;
      }
      ...
      $$8.b("fog");
      float $$15 = $$4.j();
      boolean $$16 = this.h.s.c().a(azq.a($$10), azq.a($$11)) || this.h.m.j().d();
      Vector4f $$17 = grr.a($$3, $$7, this.h.s, this.h.n.aH(), $$4.c($$7));
      grq $$18 = grr.a($$3, grr.d.b, $$17, $$15, $$16, $$7);
      grq $$19 = grr.a($$3, grr.d.a, $$17, $$15, $$16, $$7);
      $$8.b("cullEntities");
      ...
      $$27.a(() -> {
         fjs $$1x = this.h.h();
         RenderSystem.getDevice().b().a($$1x.d(), aya.a(0.0F, $$17.x, $$17.y, $$17.z), $$1x.e(), 1.0);
      });
      if (!$$16) {
         this.b($$22, $$3, $$7, $$19);
      }
   ...
   private void a(fir $$0, gvw $$1, fqn $$2, Matrix4f $$3, Matrix4f $$4, grq $$5, boolean $$6, boolean $$7, fqv $$8, brd $$9) {
      fis $$10 = $$0.a("main");
      ...
      $$10.a(() -> {
         ...
         double $$16 = $$13x.c();
         $$9.a("terrain");
         this.a(gsn.d(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gsn.e(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gsn.f(), $$14x, $$15, $$16, $$3, $$4);
         if (this.p.c().e()) {
            fkd.a();
         } else {
            fkd.b();
         ...
         $$9.b("translucent");
         this.a(gsn.g(), $$14x, $$15, $$16, $$3, $$4);
         $$9.b("string");
         this.a(gsn.t(), $$14x, $$15, $$16, $$3, $$4);
         if ($$6) {
            this.a($$2, $$19, $$18, true);
         }
   ...
   private void a(fir $$0, fqn $$1, float $$2, grq $$3) {
      fis $$4 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fir $$0, fqr $$1, ffs $$2, float $$3, int $$4, float $$5) {
      fis $$6 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fir $$0, ffs $$1, float $$2, grq $$3) {
   ...
   private void a(fir $$0, ffs $$1, grq $$2) {
      fis $$3 = $$0.a("late_debug");
   ...
   private boolean a(fqn $$0, gvw $$1, List<bwv> $$2) {
      ffs $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      boolean $$7 = false;
      boolean $$8 = this.c();
      bwv.b(azq.a((double)this.h.n.aH() / 8.0, 1.0, 2.5) * this.h.n.g().c());

      for (bwv $$9 : this.p.d()) {
         if (this.i.a($$9, $$1, $$4, $$5, $$6) || $$9.A(this.h.t)) {
            iw $$10 = $$9.dv();
            if ((this.p.e($$10.v()) || this.a($$10))
               && ($$9 != $$0.g() || $$0.i() || $$0.g() instanceof bxw && ((bxw)$$0.g()).fR())
               && (!($$9 instanceof grb) || $$0.g() == $$9)) {
               $$2.add($$9);
               if ($$8 && this.h.b($$9)) {
                  $$7 = true;
               }
   ...
   private void a(flq $$0, gsc.a $$1, fqn $$2, fqv $$3, List<bwv> $$4) {
      ffs $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
      ...
      for (bwv $$11 : $$4) {
         ...
         if ($$10 && this.h.b($$11)) {
            ...
            $$13 = $$12;
            int $$14 = $$11.f_();
            $$12.a(aya.b($$14), aya.c($$14), aya.d($$14), 255);
         } else {
            $$13 = $$1;
         }
   ...
   private void a(flq $$0, gsc.a $$1, gsc.a $$2, fqn $$3, float $$4) {
      ffs $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
      ...
      while (var13.hasNext()) {
         ...
         if (!$$10.isEmpty()) {
            for (dye $$11 : $$10) {
               ...
               SortedSet<aqu> $$14 = (SortedSet<aqu>)this.x.get($$12.a());
               if ($$14 != null && !$$14.isEmpty()) {
                  int $$15 = $$14.last().c();
                  if ($$15 >= 0) {
                     flq.a $$16 = $$0.c();
                     flt $$17 = new flr($$2.getBuffer(hnm.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        flt $$3x = $$1.getBuffer($$2x);
                        return $$2x.T() ? flw.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(flq $$0, fqn $$1, gsc.a $$2) {
      ffs $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         Entry<SortedSet<aqu>> $$7 = (Entry<SortedSet<aqu>>)var11.next();
         iw $$8 = iw.d($$7.getLongKey());
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            SortedSet<aqu> $$9 = (SortedSet<aqu>)$$7.getValue();
            if ($$9 != null && !$$9.isEmpty()) {
               int $$10 = $$9.last().c();
               $$0.a();
               $$0.a((double)$$8.u() - $$4, (double)$$8.v() - $$5, (double)$$8.w() - $$6);
               flq.a $$11 = $$0.c();
               flt $$12 = new flr($$2.getBuffer(hnm.l.get($$10)), $$11, 1.0F);
   ...
   private void a(fqn $$0, gsc.a $$1, flq $$2, boolean $$3) {
      if (this.h.w instanceof ffo $$4) {
         if ($$4.d() != ffq.a.a) {
            iw $$6 = $$4.b();
            ebg $$7 = this.p.a_($$6);
            if (!$$7.l() && this.p.E_().a($$6)) {
               ...
               if ($$10) {
                  flt $$11 = $$1.getBuffer(gsn.x());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               flt $$12 = $$1.getBuffer(gsn.w());
               int $$13 = $$10 ? -11010079 : aya.c(102, -16777216);
   ...
   private void a(bwv $$0, double $$1, double $$2, double $$3, float $$4, flq $$5, gsc $$6) {
      double $$7 = azq.d((double)$$4, $$0.aa, $$0.dA());
      double $$8 = azq.d((double)$$4, $$0.ab, $$0.dC());
      double $$9 = azq.d((double)$$4, $$0.ac, $$0.dG());
   ...
   private void a(ffs $$0) {
      if (!this.r.isEmpty()) {
         ...
         brc.a().a("translucent_sort");
         gvs.e $$3 = new gvs.e();
         ObjectListIterator $$5 = this.s.iterator();

         while ($$5.hasNext()) {
            gvs.b $$4 = (gvs.b)$$5.next();
            this.a($$4, $$3, $$0, $$2, true);
         }
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gvs.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gvs.b $$0, gvs.e $$1, ffs $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(gsn $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      RenderSystem.assertOnRenderThread();
      bri $$6 = brc.a().c(() -> "render_" + $$0.b);
      $$6.a($$0::toString);
      boolean $$7 = $$0 != gsn.g();
      ObjectListIterator<gvs.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      fjr $$9 = $$0.M();

      try (fld $$10 = RenderSystem.getDevice().b().a($$0.L().d(), OptionalInt.empty(), $$0.L().e(), OptionalDouble.empty())) {
         $$10.a($$9);

         for (int $$11 = 0; $$11 < 12; $$11++) {
            flj $$12 = RenderSystem.getShaderTexture($$11);
            if ($$12 != null) {
               $$10.a("Sampler" + $$11, $$12);
            }
         }

         ArrayList<fld.a> $$13 = new ArrayList<>();

         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gvs.b $$14 = $$7 ? (gvs.b)$$8.next() : (gvs.b)$$8.previous();
            gvs.c $$15 = $$14.a($$0);
            if (!$$14.d().a($$0) && $$15 != null) {
               fii $$17;
               flu.b $$18;
   ...
   public void m() {
      ...
      if (this.v % 20 == 0) {
         Iterator<aqu> $$0 = this.w.values().iterator();
   ...
   private void a(aqu $$0) {
      long $$1 = $$0.b().a();
      Set<aqu> $$2 = (Set<aqu>)this.x.get($$1);
      $$2.remove($$0);
      if ($$2.isEmpty()) {
         this.x.remove($$1);
      }
   ...
   private void b(fir $$0, fqn $$1, float $$2, grq $$3) {
      exs $$4 = $$1.k();
      if ($$4 != exs.c && $$4 != exs.a && !this.b($$1)) {
         gro $$5 = this.p.c();
         gro.d $$6 = $$5.c();
         if ($$6 != gro.d.a) {
            fis $$7 = $$0.a("sky");
   ...
   private boolean b(fqn $$0) {
      return !($$0.g() instanceof bxw $$1) ? false : $$1.b(bwb.o) || $$1.b(bwb.G);
   }
   ...
   private void c(fqn $$0) {
      ...
      gvq $$2 = new gvq();
      iw $$3 = $$0.c();
      List<gvs.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.r.iterator();

      while (var6.hasNext()) {
         gvs.b $$5 = (gvs.b)var6.next();
         if ($$5.i() && $$5.a()) {
            boolean $$6 = false;
            if (this.h.n.m().c() == frl.c) {
               iw $$7 = jz.a($$5.g()).k();
               $$6 = $$7.j($$3) < 768.0 || $$5.j();
            } else if (this.h.n.m().c() == frl.b) {
               $$6 = $$5.j();
            }
   ...
   private void a(flq $$0, flt $$1, bwv $$2, double $$3, double $$4, double $$5, iw $$6, ebg $$7, int $$8) {
      gsv.a($$0, $$1, $$7.a(this.p, $$6, ffx.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }

   public void a(djd $$0, iw $$1, ebg $$2, ebg $$3, int $$4) {
      this.a($$1, ($$4 & 8) != 0);
   }
   ...
   @Nullable
   gpm b(lx $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private gpm b(lx $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      fqn $$9 = this.h.j.k();
      arm $$10 = this.a($$2);
      if ($$1) {
         ...
         return $$10 == arm.c ? null : this.h.g.a($$0, $$3, $$4, $$5, $$6, $$7, $$8);
      }
   }

   private arm a(boolean $$0) {
      arm $$1 = this.h.n.au().c();
      if ($$0 && $$1 == arm.c && this.p.A.a(10) == 0) {
         $$1 = arm.b;
      }

      if ($$1 == arm.b && this.p.A.a(3) == 0) {
         $$1 = arm.c;
      }
   ...
   public void a(Collection<dye> $$0, Collection<dye> $$1) {
      synchronized (this.t) {
         this.t.removeAll($$0);
         this.t.addAll($$1);
      }
   ...
   public static int a(dja $$0, iw $$1) {
      return a($$0, $$0.a_($$1), $$1);
   }

   public static int a(dja $$0, ebg $$1, iw $$2) {
      if ($$1.b($$0, $$2)) {
         return 15728880;
      } else {
         int $$3 = $$0.a(dki.a, $$2);
   ...
   @baz
   public ObjectArrayList<gvs.b> v() {
      return this.r;
   }
