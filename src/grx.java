...
public class grx implements AutoCloseable {
   ...
   public grx(grq $$0, frd $$1) {
      this.h = $$0;
      this.i = $$1;
      fla $$2 = RenderSystem.getDevice();
      this.e = $$2.a("Light Texture", fli.a, 16, 16, 1);
      this.e.a(flg.b, false);
      $$2.b().a(this.e, -1);
   }
   ...
   private float a(bxu $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, azo.b(((float)$$0.af - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            float $$7 = this.i.t.a(bvz.G, $$0) * $$6;
            float $$8 = this.a(this.i.t, $$7, $$0) * $$6;
            float $$9 = this.i.t.D();
            float $$10;
            if (this.i.t.b(bvz.p)) {
               $$10 = grq.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(bvz.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            try (flb $$18 = RenderSystem.getDevice().b().a(this.e, OptionalInt.empty())) {
               $$18.a(gsj.aH);
               ...
               $$18.a(0, RenderSystem.getQuadVertexBuffer(() -> "Light texture vertex buffer"));
               RenderSystem.a $$19 = RenderSystem.getSequentialBuffer(fls.c.h);
               $$18.a($$19.b(6), $$19.a());
               $$18.a(0, 6);
            }
   ...
   public static float a(efb $$0, int $$1) {
      return a($$0.s(), $$1);
   }
