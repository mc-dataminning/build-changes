...
public class grx implements atd<grw> {
   public grw b(JsonObject $$0) {
      Builder<grv> $$1 = ImmutableList.builder();
      ...
      return new grw($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private grv a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new grv(aye.g($$1, "frames[" + $$0 + "]"));
