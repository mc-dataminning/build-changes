...
public class grx extends gsp<cmo, gyb, gbn> {
   ...
   private static final glo k = glo.f(b);

   public grx(grj.a $$0) {
      this($$0, 0.5F, geg.aW);
   }

   protected grx(grj.a $$0, float $$1, gef $$2) {
      super($$0, new gbn($$0.a($$2)), $$1);
   }

   public boolean a(cmo $$0, gov $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gn()) {
            bwb $$5 = $$0.go();
            if ($$5 != null) {
               fbs $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               fbs $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new fbn($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private fbs a(bwb $$0, double $$1, float $$2) {
   ...
   public void a(gyb $$0, fgl $$1, gle $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fbs $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fgl $$0, fgp $$1, fbs $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fgp $$0, fgl.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hav.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cmo $$0, gyb $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.m($$2);
   ...
   @Nullable
   private static bvf a(cmo $$0) {
      bvf $$1 = flz.Q().ao();
      return (bvf)($$0.gn() ? $$0.go() : $$1);
   }
}
