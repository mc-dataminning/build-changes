public class grx extends grp<cqm, gyd> {
   private static final alz a = alz.b("textures/entity/fishing_hook.png");
   private static final glv b = glv.f(a);
   ...
   public boolean a(cqm $$0, gpc $$1, double $$2, double $$3, double $$4) {
      return super.a($$0, $$1, $$2, $$3, $$4) && $$0.m() != null;
   }

   public void a(gyd $$0, fgs $$1, gll $$2, int $$3) {
      $$1.a();
      $$1.a();
      $$1.b(0.5F, 0.5F, 0.5F);
      $$1.a(this.e.b());
   ...
   private fby a(cpx $$0, float $$1, float $$2) {
      int $$3 = $$0.fy() == bwa.b ? 1 : -1;
      cxp $$4 = $$0.eZ();
      if (!$$4.a(cxt.rJ)) {
         $$3 = -$$3;
      }
      ...
      if (this.e.d.aE().a() && $$0 == fmg.Q().t) {
         ...
         fby $$13 = this.e.b.j().a((float)$$3 * 0.525F, -0.1F).c($$12).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.m($$2).e($$13);
      } else {
   ...
   private static void a(fgw $$0, fgs.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(hbc.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }

   private static void a(float $$0, float $$1, float $$2, fgw $$3, fgs.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
   ...
   public void a(cqm $$0, gyd $$1, float $$2) {
      super.a($$0, $$1, $$2);
      cpx $$3 = $$0.m();
      if ($$3 == null) {
         $$1.a = fby.c;
         ...
         fby $$6 = this.a($$3, $$5, $$2);
         fby $$7 = $$0.o($$2).b(0.0, 0.25, 0.0);
         $$1.a = $$6.d($$7);
      }
   }

   protected boolean a(cqm $$0) {
      return false;
   }
}
