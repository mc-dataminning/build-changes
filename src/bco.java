...
public class bco extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bff.z);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bco::c), this.a("minecraft:arrow", bco::a), this.a("minecraft:spectral_arrow", bco::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bco.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bff.z, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bff.z, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bco.a<?> $$1, Type<?> $$2, Type<T> $$3) {
