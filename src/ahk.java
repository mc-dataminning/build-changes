...
public class ahk implements zv<agv> {
   ...
   private static final zm<wz, Int2ObjectMap<cuo>> c = zk.a(Int2ObjectOpenHashMap::new, zk.d.a(Short::intValue, Integer::shortValue), cuo.h, 128);
   private final int d;
   private final int e;
   private final int f;
   private final int g;
   ...
   public ahk(int $$0, int $$1, int $$2, int $$3, cqc $$4, cuo $$5, Int2ObjectMap<cuo> $$6) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
