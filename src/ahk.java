...
public class ahk {
   ...
   public static void a(CommandDispatcher<dt> $$0, dn $$1) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("locate").requires($$0x -> $$0x.c(2)))
                  .then(du.a("structure").then(du.a("structure", eu.a(jc.az)).executes($$0x -> a((dt)$$0x.getSource(), eu.a($$0x, "structure", jc.az, c))))))
               .then(du.a("biome").then(du.a("biome", et.a($$1, jc.ap)).executes($$0x -> a((dt)$$0x.getSource(), et.a($$0x, "biome", jc.ap))))))
            .then(du.a("poi").then(du.a("poi", et.a($$1, jc.S)).executes($$0x -> b((dt)$$0x.getSource(), et.a($$0x, "poi", jc.S)))))
      );
   }

   private static Optional<? extends hi.b<dvi>> a(eu.c<dvi> $$0, hq<dvi> $$1) {
      return (Optional<? extends hi.b<dvi>>)$$0.a().map($$1x -> $$1.b($$1x).map($$0xx -> hi.a($$0xx)), $$1::b);
   }

   private static int a(dt $$0, eu.c<dvi> $$1) throws CommandSyntaxException {
      hq<dvi> $$2 = $$0.e().G_().d(jc.az);
      hi<dvi> $$3 = (hi<dvi>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      gw $$4 = gw.a($$0.d());
      akq $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(ac.c);
      Pair<gw, he<dvi>> $$7 = $$5.k().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(dt $$0, et.c<cqt> $$1) throws CommandSyntaxException {
      gw $$2 = gw.a($$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(ac.c);
      Pair<gw, he<cqt>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(dt $$0, et.c<bui> $$1) throws CommandSyntaxException {
      gw $$2 = gw.a($$0.d());
      akq $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(ac.c);
      Optional<Pair<he<bui>, gw>> $$5 = $$3.w().e($$1, $$2, 256, buf.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(dt $$0, gw $$1, Pair<gw, ? extends he<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      gw $$7 = (gw)$$2.getFirst();
      int $$8 = $$4 ? arw.d(arw.c((float)$$1.j($$7))) : arw.d(a($$1.u(), $$1.w(), $$7.u(), $$7.w()));
