...
public class ahk {
   ...
   public ahk(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<ahk.a> b(Scanner $$0) {
      agh<csa> $$1 = (agh<csa>)aht.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new ahk.a($$1, new eju((double)$$2, (double)$$3, (double)$$4), new ejt($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<amf> $$1 = this.e.ae().t();
         if (!$$1.isEmpty()) {
            amf $$2 = $$1.get(0);
            ame $$3 = this.e.F();
            du $$4 = new du($$2, eju.a($$3.S()), ejt.a, $$3, 4, "", uq.a, this.e, $$2);
            dv $$5 = this.e.aE();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(agh<csa> a, eju b, ejt c) {
   }
}
