...
public class bph {
   ...
   private static void a(bpk $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dyg, bpt<bpj>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bpt)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ae.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dyg, bpt<bpj>> $$3 : $$0) {
         bpt<bpj> $$4 = (bpt<bpj>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dyg)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bow.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bpf $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bph::a));
      $$1.add("chunksWritten", this.a($$0.m(), bph::a));
      return $$1;
   }

   private JsonElement a(bpm.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bpf $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bph::a));
      $$1.add("received", this.a($$0.k(), bph::a));
      return $$1;
   }

   private <T> JsonElement a(bpo<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bpl> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bpl>, ToDoubleFunction<bpl>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bpl::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bpl::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bpl::c));
      return $$1;
   }
}
