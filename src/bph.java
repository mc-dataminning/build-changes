...
public class bph {
   ...
   private bph(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bph a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bph($$0, $$1);
   }

   public bph.d a() throws IOException {
      bph.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bph.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bph.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bph.c $$3 = bph.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bph.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bph.a($$0, $$3);
            }
         }
   ...
   public bph.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bph.c> $$2 = this.a().c();
      ...
      bph.e $$4 = new bph.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bph.c b) implements bph.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bph.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bph.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bph.b> {
      private final List<bph.b> a;

      d(List<bph.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bph.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bph.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bph.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bph.d a() {
         ListIterator<bph.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bph.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bph.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bph.b> b() {
         return this.a.stream();
      }

      public Set<bph.c> c() {
         return this.a.stream().map(bph.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bph.c b) implements bph.b {
