...
public record blu<T>(blm<StringReader> a, blk<T> b) {
   public Optional<T> a(blp<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bln.a<StringReader> $$1 = new bln.a<>();
      bly $$2 = new bly(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(blo::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bln.a<StringReader> $$2 = new bln.a<>();
      bly $$3 = new bly(this.a(), $$2, $$1);
      this.a($$3);
      List<blo<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (blo<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof blx $$7) {
               ej.a($$7.a(), $$5);
            } else {
