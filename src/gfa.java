...
public class gfa extends aui<gfa.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final akt b = new akt("gpu_warnlist.json");
   ...
   protected gfa.a a(aud $$0, bmo $$1) {
      ...
      $$1.b();
      return new gfa.a($$2, $$3, $$4);
   }

   protected void a(gfa.a $$0, aud $$1, bmo $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aud $$0, bmo $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ezv.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ezv.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ezv.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
