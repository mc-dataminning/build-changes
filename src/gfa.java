...
public class gfa extends gfy<hdn> {
   private final gjc[] a;
   private final gjc b;
   ...
   public static gji a() {
      gjk $$0 = new gjk();
      gjm $$1 = $$0.a();
      $$1.a("head", gjh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), gje.a);
      float $$2 = 0.0F;
      gjh $$3 = gjh.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = azm.b($$2) * 9.0F;
         float $$6 = -2.0F + azm.b((float)($$4 * 2) * 0.25F);
         float $$7 = azm.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, gje.a($$5, $$6, $$7));
         $$2++;
      }
