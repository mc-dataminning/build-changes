...
public abstract class gfa implements aai {
   private static final xv k = xv.c("disconnect.lost");
   private static final Logger l = LogUtils.getLogger();
   protected final flz a;
   protected final wp b;
   @Nullable
   protected final gfs c;
   @Nullable
   protected String d;
   protected final hgt e;
   @Nullable
   protected final ftr f;
   protected boolean g;
   private final List<gfa.a> m = new ArrayList<>();
   protected final Map<alz, byte[]> h;
   protected Map<String, String> i;
   protected amr j;

   protected gfa(flz $$0, wp $$1, gfi $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   public void a(aap $$0) {
      ...
      if ($$2 == null) {
         ...
         String $$3 = $$0.f();
         boolean $$4 = $$0.g();
         gfs.a $$5 = this.c != null ? this.c.b() : gfs.a.c;
         if ($$5 != gfs.a.c && (!$$4 || $$5 != gfs.a.b)) {
            this.a.af().a($$1, $$2, $$3);
         } else {
   ...
   public void a(aas $$0) {
      ...
      if (this.c == null) {
         ...
         this.b.m();
         this.b.n();
         ggv $$1 = new ggv($$0.b(), $$0.e());
         fsq.a(Objects.requireNonNullElseGet(this.f, ftt::new), this.a, $$1, this.c, false, new gfw(this.h));
      }
   }
   ...
   protected void e() {
      Iterator<gfa.a> $$0 = this.m.iterator();
   ...
   protected ftr b(wr $$0) {
      ftr $$1 = Objects.requireNonNullElseGet(this.f, () -> new fwh(new ftt()));
      return (ftr)(this.c != null && this.c.e() ? new hhm($$1, k, $$0.a()) : new fsy($$1, k, $$0));
   }
   ...
   private void a(aac<? extends xh> $$0, BooleanSupplier $$1, Duration $$2) {
      if ($$1.getAsBoolean()) {
         ...
         this.m.add(new gfa.a($$0, $$1, ae.c() + $$2.toMillis()));
      }
   }

   private ftr a(UUID $$0, URL $$1, String $$2, boolean $$3, @Nullable xv $$4) {
      ftr $$5 = this.a.z;
      return $$5 instanceof gfa.b $$6 ? $$6.a(this.a, $$0, $$1, $$2, $$3, $$4) : new gfa.b(this.a, $$5, List.of(new gfa.b.a($$0, $$1, $$2)), $$3, $$4);
   }
   ...
   class b extends fsp {
      private final List<gfa.b.a> s;
      @Nullable
      private final ftr u;

      b(final flz $$0, @Nullable final ftr $$1, final List<gfa.b.a> $$2, final boolean $$3, @Nullable final xv $$4) {
         super(
            $$5 -> {
               $$0.a($$1);
               hed $$6 = $$0.af();
               if ($$5) {
                  ...
                  $$6.h();
                  if ($$3) {
                     gfa.this.b.a(xv.c("multiplayer.requiredTexturePrompt.disconnect"));
                  } else if (gfa.this.c != null) {
                     gfa.this.c.a(gfs.a.b);
                  }
               }
            ...
            gfa.a($$3 ? xv.c("multiplayer.requiredTexturePrompt.line2").a(n.o, n.r) : xv.c("multiplayer.texturePrompt.line2"), $$4),
            $$3 ? xu.i : xu.f,
            $$3 ? xu.p : xu.g
         );
         this.s = $$2;
      ...
      public gfa.b a(flz $$0, UUID $$1, URL $$2, String $$3, boolean $$4, @Nullable xv $$5) {
         List<gfa.b.a> $$6 = ImmutableList.builderWithExpectedSize(this.s.size() + 1).addAll(this.s).add(new gfa.b.a($$1, $$2, $$3)).build();
         return gfa.this.new b($$0, this.u, $$6, $$4, $$5);
      }
