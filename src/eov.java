...
public class eov extends epg {
   private static final Logger c = LogUtils.getLogger();
   public long a;
   public List<UUID> b;

   public static eov a(JsonObject $$0) {
      eov $$1 = new eov();

      try {
         $$1.a = erd.a("serverId", $$0, -1L);
         String $$2 = erd.b("playerList", $$0, null);
         if ($$2 != null) {
   ...
   private static List<UUID> a(JsonArray $$0) {
      ...
      for (JsonElement $$2 : $$0) {
         if ($$2.isJsonObject()) {
            UUID $$3 = erd.a("playerId", $$2.getAsJsonObject(), null);
            if ($$3 != null) {
               $$1.add($$3);
            }
         }
