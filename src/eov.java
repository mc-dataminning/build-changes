...
public class eov {
   ...
   public Optional<l.a> a(iz $$0, boolean $$1, dtv $$2) {
      cev $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<cew> $$5 = $$3.b($$0x -> $$0x.a(cez.r), $$0, $$4, cev.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<cew>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dsu.H))
         .findFirst();
      return $$5.map($$0x -> {
         iz $$1x = $$0x.f();
         this.n.l().a(ark.f, new dbh($$1x), 3, $$1x);
         dse $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dsu.H), 21, je.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(iz $$0, je.a $$1) {
      ...
      for (iz.a $$10 : iz.a($$0, 16, je.f, je.d)) {
         int $$11 = Math.min($$8, this.n.a(dxw.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, dfd.co.o(), 3);
            }
         }
      }

      dse $$26 = dfd.ed.o().a(dkf.b, $$1);
