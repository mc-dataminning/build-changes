...
public class eov {
   ...
   public static final eov.a bv;

   public static eov.a a(int $$0, int $$1) {
      return $$0 == -1 ? eov.b.b.a($$1) : eov.b.a.a($$0);
   }

   public static eov.a a(String $$0) {
      if (eov.a.e.containsKey($$0)) {
         return eov.a.e.get($$0);
      } else {
         for (eov.b $$1 : eov.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eov.b b;
      private final int c;
      private final aui<vf> d;
      static final Map<String, eov.a> e = Maps.newHashMap();

      a(String $$0, eov.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new aui<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vf.b($$2.toUpperCase(Locale.ROOT)) : vf.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vf.b($$2) : vf.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> si.a().b($$1) ? vf.c($$1) : vf.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eov.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vf> g;

      private static void a(eov.b $$0, String $$1, int $$2) {
         eov.a $$3 = new eov.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vf> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eov.a a(int $$0) {
         return (eov.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
