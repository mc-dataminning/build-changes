...
public class yj implements wz {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayu.b.validate(yj::b);
   private static final Codec<Object> e = Codec.either(d, xa.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wy $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yj> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final wz.a<yj> c = new wz.a<>(b, "translatable");
   private static final xd f = xd.e("%");
   private static final xd g = xd.e("null");
   ...
   @Nullable
   private tu k;
   private List<xd> l = ImmutableList.of();
   ...
   private static yj a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yj($$0, $$1.orElse(null), a($$2));
   }

   public yj(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xd> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yk var4) {
            this.l = ImmutableList.of(xd.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xd> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yk(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xd a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wy) {
            ...
            return $$1 == null ? g : xd.e($$1.toString());
         }
      } else {
         throw new yk(this, $$0);
      }
   ...
   public xm a(@Nullable ei $$0, @Nullable bwd $$1, int $$2) throws CommandSyntaxException {
      ...
      return xm.a(new yj(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yj $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
