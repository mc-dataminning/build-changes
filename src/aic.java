...
public class aic {
   ...
   private static int a(du $$0, Collection<? extends bki> $$1, ib<bjt> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      bjt $$6 = $$2.a();
      int $$7 = 0;
      int $$8;
      if ($$3 != null) {
      ...
      for (bki $$13 : $$1) {
         if ($$13 instanceof bky) {
            bjv $$14 = new bjv($$6, $$8, $$4, false, $$5);
            if (((bky)$$13).b($$14, $$0.g())) {
               $$7++;
            }
         }
      ...
      if ($$7 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ur.a("commands.effect.give.success.single", $$6.e(), $$1.iterator().next().O_(), $$8 / 20), true);
         } else {
   ...
   private static int a(du $$0, Collection<? extends bki> $$1) throws CommandSyntaxException {
      int $$2 = 0;

      for (bki $$3 : $$1) {
         if ($$3 instanceof bky && ((bky)$$3).eq()) {
            $$2++;
         }
      }
      ...
      if ($$2 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ur.a("commands.effect.clear.everything.success.single", $$1.iterator().next().O_()), true);
         } else {
   ...
   private static int a(du $$0, Collection<? extends bki> $$1, ib<bjt> $$2) throws CommandSyntaxException {
      bjt $$3 = $$2.a();
      int $$4 = 0;

      for (bki $$5 : $$1) {
         if ($$5 instanceof bky && ((bky)$$5).d($$3)) {
            $$4++;
         }
      }
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ur.a("commands.effect.clear.specific.success.single", $$3.e(), $$1.iterator().next().O_()), true);
         } else {
