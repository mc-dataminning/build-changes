   ...
   private static int a(dt $$0, int $$1, boolean $$2) {
      ...
      for (int $$11 = $$7; $$11 <= $$8; $$11++) {
         for (int $$12 = $$9; $$12 <= $$10; $$12++) {
            cpi $$13 = new cpi($$12, $$11);
            dhk $$14 = $$4.a($$12, $$11, false);
            if ($$14 != null && (!$$2 || !$$14.s())) {
      ...
      bfx<Runnable> $$16 = bfx.a(ac.f(), "worldgen-resetchunks");
      long $$17 = System.currentTimeMillis();
      int $$18 = ($$1 * 2 + 1) * ($$1 * 2 + 1);
      UnmodifiableIterator var33 = ImmutableList.of(dhe.f, dhe.g, dhe.h, dhe.i, dhe.j, dhe.k).iterator();

      while (var33.hasNext()) {
         dhe $$19 = (dhe)var33.next();
         ...
         for (int $$22 = $$6.f - $$1; $$22 <= $$6.f + $$1; $$22++) {
            for (int $$23 = $$6.e - $$1; $$23 <= $$6.e + $$1; $$23++) {
               cpi $$24 = new cpi($$23, $$22);
               dhk $$25 = $$4.a($$23, $$22, false);
               if ($$25 != null && (!$$2 || !$$25.s())) {
                  List<dgz> $$26 = Lists.newArrayList();
                  int $$27 = Math.max(1, $$19.e());

                  for (int $$28 = $$24.f - $$27; $$28 <= $$24.f + $$27; $$28++) {
                     for (int $$29 = $$24.e - $$27; $$29 <= $$24.e + $$27; $$29++) {
                        dgz $$30 = $$4.a($$29, $$28, $$19.d(), true);
                        dgz $$31;
                        if ($$30 instanceof dhj) {
                           $$31 = new dhj(((dhj)$$30).C(), true);
                        } else if ($$30 instanceof dhk) {
                           $$31 = new dhj((dhk)$$30, true);
                        } else {
                           $$31 = $$30;
                        }
                  ...
                  $$21 = $$21.thenComposeAsync($$5x -> $$19.a($$16::a, $$3, $$4.g(), $$3.p(), $$4.a(), $$0xx -> {
                        ...
                        if ($$19 == dhe.g) {
                           $$1xx.left().ifPresent($$0xxx -> dkm.a($$0xxx, dhe.b));
                        }
      ...
      for (int $$35 = $$6.f - $$1; $$35 <= $$6.f + $$1; $$35++) {
         for (int $$36 = $$6.e - $$1; $$36 <= $$6.e + $$1; $$36++) {
            cpi $$37 = new cpi($$36, $$35);
            dhk $$38 = $$4.a($$36, $$35, false);
            if ($$38 != null && (!$$2 || !$$38.s())) {
