...
public class bu extends dv<bu.a> {
   @Override
   public Codec<bu.a> a() {
      return bu.a.a;
   }

   public void a(ari $$0, bsg $$1, float $$2, float $$3, boolean $$4) {
      this.a($$0, $$5 -> $$5.a($$0, $$1, $$2, $$3, $$4));
   }

   public static record a(Optional<bg> b, Optional<bj> c) implements dv.a {
      ...
      public boolean a(ari $$0, bsg $$1, float $$2, float $$3, boolean $$4) {
