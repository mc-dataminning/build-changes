...
public class cki {
   ...
   public static Map<ckg, Integer> a(qx $$0) {
      Map<ckg, Integer> $$1 = Maps.newLinkedHashMap();
   ...
   public static void a(Map<ckg, Integer> $$0, cfz $$1) {
      ...
      for (Entry<ckg, Integer> $$3 : $$0.entrySet()) {
         ckg $$4 = $$3.getKey();
         if ($$4 != null) {
            int $$5 = $$3.getValue();
            $$2.add(a(a($$4), $$5));
   ...
   private static void a(cki.a $$0, cfz $$1) {
      if (!$$1.b()) {
         qx $$2 = $$1.x();
   ...
   private static void a(cki.a $$0, Iterable<cfz> $$1) {
      for (cfz $$2 : $$1) {
         a($$0, $$2);
      }
   }
   ...
   public static float a(bfz $$0) {
      int $$1 = a(ckk.t, $$0);
      return $$1 > 0 ? ckw.e($$1) : 0.0F;
   }

   public static void a(bfz $$0, bfj $$1) {
      cki.a $$2 = ($$2x, $$3) -> $$2x.b($$0, $$1, $$3);
      if ($$0 != null) {
         a($$2, $$0.bK());
      }
   ...
   @Nullable
   public static Entry<bfo, cfz> b(ckg $$0, bfz $$1) {
      return a($$0, $$1, $$0x -> true);
   }

   @Nullable
   public static Entry<bfo, cfz> a(ckg $$0, bfz $$1, Predicate<cfz> $$2) {
      Map<bfo, cfz> $$3 = $$0.a($$1);
      if ($$3.isEmpty()) {
         return null;
      } else {
         List<Entry<bfo, cfz>> $$4 = Lists.newArrayList();

         for (Entry<bfo, cfz> $$5 : $$3.entrySet()) {
            cfz $$6 = $$5.getValue();
         ...
         return $$4.isEmpty() ? null : $$4.get($$1.ec().a($$4.size()));
      }
   }
   ...
   public static List<ckj> b(apf $$0, cfz $$1, int $$2, boolean $$3) {
      ...
      if ($$6 <= 0) {
         ...
         $$2 = apa.a(Math.round((float)$$2 + (float)$$2 * $$7), 1, Integer.MAX_VALUE);
         List<ckj> $$8 = a($$2, $$1, $$3);
         if (!$$8.isEmpty()) {
