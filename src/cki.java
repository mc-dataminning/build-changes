...
public class cki extends coj {
   private static final Predicate<bsu> e = $$0 -> $$0.bD() && !($$0 instanceof cki);
   ...
   public cki(bta<? extends cki> $$0, dby $$1) {
      super($$0, $$1);
      this.bN = 20;
      this.a(eom.v, 0.0F);
   }
   ...
   protected void z() {
      ...
      this.bS.a(4, new cax(this, 1.0, true));
      this.bS.a(5, new cca(this, 0.4));
      this.bS.a(6, new cav(this, cmx.class, 6.0F));
      this.bS.a(10, new cav(this, btr.class, 8.0F));
      this.bT.a(2, new ccf(this, coj.class).a());
      this.bT.a(3, new ccg<>(this, cmx.class, true));
      this.bT.a(4, new ccg<>(this, cmf.class, true, $$0 -> !$$0.p_()));
      this.bT.a(4, new ccg<>(this, cfr.class, true));
   }

   @Override
   protected void S() {
      boolean $$0 = !(this.cQ() instanceof btr) || this.cQ().ak().a(awt.c);
   ...
   public static buw.a s() {
      return ckd.gw().a(bux.q, 100.0).a(bux.r, 0.3).a(bux.n, 0.75).a(bux.c, 12.0).a(bux.d, 1.5).a(bux.k, 32.0).a(bux.v, 1.0);
   }
   ...
   public void n_() {
      ...
      if (this.bD()) {
         if (this.fg()) {
            ...
            double $$1 = this.f(bux.r).b();
            this.f(bux.r).a(ayz.d(0.1, $$1, $$0));
         }

         if (this.Q && this.dP().ab().b(dbu.c)) {
            boolean $$2 = false;
            evm $$3 = this.cK().g(0.2);
   ...
   private void gC() {
      if (this.bD()) {
         for (btp $$1 : this.dP().a(btp.class, this.cK().g(4.0), e)) {
            if (!($$1 instanceof cjk)) {
               $$1.a(this.dQ().b((btp)this), 6.0F);
            }
