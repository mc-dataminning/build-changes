...
@Deprecated
public class eef extends edq<eef.a> {
   private static final duo a = dhl.nc.o();

   public eef(Codec<eef.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eds<eef.a> $$0) {
      je $$1 = $$0.e();
      dfd $$2 = $$0.b();
      azl $$3 = $$0.d();
      eef.a $$4 = $$0.f();
   ...
   public static record a(ehv b, ehv c) implements efu {
      public static final Codec<eef.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ehv.a.fieldOf("fluid").forGetter(eef.a::a), ehv.a.fieldOf("barrier").forGetter(eef.a::b)).apply($$0, eef.a::new)
      );
