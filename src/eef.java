...
public abstract class eef<M extends eec<M>> {
   private final cty i;
   ...
   protected final Long2ObjectMap<dlj> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eef(cty $$0, dlr $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dlj a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dlj a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dlj c(long $$0) {
      dlj $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected void a(eei<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dlj>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dlj> $$6 = (Entry<dlj>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dlj $$8 = (dlj)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dlj $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = iz.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eef.a.a($$9, eef.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eef.b k(long $$0) {
      return eef.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eef.b c(byte $$0) {
         if ($$0 == 0) {
            return eef.b.a;
         } else {
            return a($$0) ? eef.b.c : eef.b.b;
         }
      }
   }
