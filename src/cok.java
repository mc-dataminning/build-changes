...
public class cok extends epc {
   ...
   public static epc.a<cok> a(arf $$0) {
      return new epc.a<>(() -> new cok($$0), ($$1, $$2) -> a($$0, $$1), bag.l);
   }
   ...
   @Nullable
   public coi a(arg $$0, iz $$1) {
      if ($$0.N_()) {
         return null;
      } else if (this.c.ab().b(dbu.B)) {
         return null;
      } else {
         dvu $$2 = $$0.dP().D_();
         if (!$$2.c()) {
            ...
            List<ceu> $$3 = this.c.y().c($$0x -> $$0x.a(axa.b), $$1, 64, cet.b.b).toList();
            int $$4 = 0;
            evr $$5 = evr.b;
   ...
   private coi a(arf $$0, iz $$1) {
      coi $$2 = $$0.d($$1);
      return $$2 != null ? $$2 : new coi(this.b(), $$0, $$1);
   }

   public static cok a(arf $$0, us $$1) {
      cok $$2 = new cok($$0);
   ...
   public static String a(ji<dvu> $$0) {
      return $$0.a(dvs.c) ? "raids_end" : "raids";
   }
