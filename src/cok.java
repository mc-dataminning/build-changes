...
public abstract class cok implements dr {
   private static final SimpleDateFormat b = new SimpleDateFormat("HH:mm:ss");
   private static final te c = te.b("@");
   private long d = -1L;
   ...
   public te l() {
      return this.h == null ? td.a : this.h;
   }

   public qs a(qs $$0) {
      $$0.a("Command", this.i);
      $$0.a("SuccessCount", this.f);
      $$0.a("CustomName", te.a.a(this.j));
      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", te.a.a(this.h));
      }
   ...
   public void b(qs $$0) {
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = te.a.a($$0.l("LastOutput"));
         } catch (Throwable var3) {
            this.h = te.b(var3.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public void a(te $$0) {
      if (this.g) {
         this.h = te.b("[" + b.format(new Date()) + "] ").b($$0);
         this.f();
      }
   }

   public abstract aki e();
   ...
   public abstract ehf g();

   public abstract ds i();

   @Override
   public boolean f_() {
      return this.e().X().b(cpg.o) && this.g;
   }
