...
public class dha {
   ...
   public gw b(double $$0, double $$1, double $$2) {
      return gw.a(arw.a($$0, this.e(), this.g()), $$1, arw.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(biq $$0, ehi $$1) {
      double $$2 = Math.max(arw.a($$1.b(), $$1.d()), 1.0);
   ...
   class b implements dha.a {
      ...
      @Override
      public double a() {
         return arw.a(dha.this.a() - this.e() / 2.0, (double)(-dha.this.k), (double)dha.this.k);
      }

      @Override
      public double c() {
         return arw.a(dha.this.b() - this.e() / 2.0, (double)(-dha.this.k), (double)dha.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? arw.d($$0, this.b, this.c) : this.c;
      }
   ...
   public static class c {
      ...
      public static dha.c a(DynamicLike<?> $$0, dha.c $$1) {
         double $$2 = arw.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = arw.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
   ...
   class d implements dha.a {
      ...
      private void n() {
         this.c = arw.a(dha.this.a() - this.b / 2.0, (double)(-dha.this.k), (double)dha.this.k);
         this.d = arw.a(dha.this.b() - this.b / 2.0, (double)(-dha.this.k), (double)dha.this.k);
         this.e = arw.a(dha.this.a() + this.b / 2.0, (double)(-dha.this.k), (double)dha.this.k);
         this.f = arw.a(dha.this.b() + this.b / 2.0, (double)(-dha.this.k), (double)dha.this.k);
         this.g = eid.a(
            eid.c,
            eid.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehr.e
