...
public class elb extends ejm<emp> {
   public elb(Codec<emp> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejo<emp> $$0) {
      djz $$1 = $$0.b();
      emp $$2 = $$0.f();
      azv $$3 = $$0.d();
      iu $$4 = $$0.e();
      Predicate<eah> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, eag.a::l) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(ejo<emp> $$0, djz $$1, emp $$2, azv $$3, Set<iu> $$4, int $$5, int $$6) {
      for (iu $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(djz $$0, emp $$1, Predicate<eah> $$2, azv $$3, iu.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         eah $$7 = $$1.c.a($$3, $$4);
         eah $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
