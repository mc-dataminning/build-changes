...
public class bwh {
   ...
   private static void f(bkg<bwg> $$0) {
      $$0.a(
         cdf.q,
         ImmutableList.of(Pair.of(0, new bly(f, apd.iK)), Pair.of(1, new blz<>(f, 2, 4, 1.5F, $$0x -> apd.iJ, aps.bK, 0.5F, bwh::a))),
   ...
   private static void g(bkg<bwg> $$0) {
      $$0.a(cdf.s, 0, ImmutableList.of(bnl.a(), new bwi(apd.iL, apd.iG)), bsh.o);
   }
