...
public class bwh {
   ...
   public static buk<bsz> a(float $$0) {
      ...
      return bxw.a(
         (Function<bxw.b<bsz>, ? extends App<bxw.c<bsz>, bxz<bsz>>>)($$3 -> $$3.group($$3.c(cbu.m), $$3.c(cbu.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.Y() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cdu $$7 = $$4x.y();
                        Optional<io> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cdy.n), $$5.dp(), 48, cdu.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dp()) <= 4.0)) {
                           ...
                           Set<Pair<ix<cdx>, io>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cdy.n), $$10, $$5.dp(), 48, cdu.b.c).collect(Collectors.toSet());
                           enk $$12 = buc.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              io $$13 = $$12.l();
                              Optional<ix<cdx>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cbx($$13, $$0, 1));
                                 agb.c($$4x, $$13);
                              }
