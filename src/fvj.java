...
public class fvj<T extends cgv> extends fuq<T> {
   private final fxq a;
   private final fxq b;
   private final fxq f;
   private final fxq g;
   ...
   public static fxw a(fxu $$0) {
      ...
      $$2.a(
         ...
         fxs.a(0.0F, 7.0F, -6.0F)
      );
      $$2.a("body", fxv.c().a(29, 0).a(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, $$0), fxs.a(0.0F, 5.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("right_chest", fxv.c().a(45, 28).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fxs.a(-8.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      $$2.a("left_chest", fxv.c().a(45, 41).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fxs.a(5.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      int $$3 = 4;
      int $$4 = 14;
      fxv $$5 = fxv.c().a(29, 29).a(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, $$0);
      $$2.a("right_hind_leg", $$5, fxs.a(-3.5F, 10.0F, 6.0F));
      $$2.a("left_hind_leg", $$5, fxs.a(3.5F, 10.0F, 6.0F));
      $$2.a("right_front_leg", $$5, fxs.a(-3.5F, 10.0F, -5.0F));
      $$2.a("left_front_leg", $$5, fxs.a(3.5F, 10.0F, -5.0F));
      return fxw.a($$1, 128, 64);
   }
