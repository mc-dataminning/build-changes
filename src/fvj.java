public class fvj implements fvf<dgy> {
   private final fzj a;
   ...
   public void a(dgy $$0, float $$1, epz $$2, ftf $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.r().c(djw.bv);
         if ($$6 > 0) {
            ic $$7 = $$0.f();
            if ($$7 != null) {
               ...
               if (!$$8.b()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = ftd.a($$0.i(), $$0.r(), $$0.aB_().a($$7));
                  this.a.a($$8, cmu.i, $$11, gec.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
