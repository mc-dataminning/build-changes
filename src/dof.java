...
public class dof implements dob, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bkn<bkp.b> c;
   private final doi d;
   private final Map<cuu, dof.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dof(Path $$0, boolean $$1, String $$2) {
      this.d = new doi($$0, $$1);
      this.c = new bkn<>(new bkp.a(dof.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(cuu $$0, int $$1) {
      cuu $$2 = new cuu($$0.e - $$1, $$0.f - $$1);
      cuu $$3 = new cuu($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         cuu $$3 = cuu.b($$0, $$1);
         BitSet $$4 = new BitSet();
         cuu.a($$2, $$3).forEach($$1xx -> {
            ua $$2x = new ua(new uc(tb.a, "DataVersion"), new uc(sw.b, "blending_data"));
            ...
            if ($$2x.d() instanceof sw $$5 && this.a($$5)) {
   ...
   private boolean a(sw $$0) {
      return $$0.b("DataVersion", 99) && $$0.h("DataVersion") >= 3441 ? $$0.b("blending_data", 10) : true;
   }

   public CompletableFuture<Void> a(cuu $$0, @Nullable sw $$1) {
      return this.a(() -> {
         dof.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dof.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<sw>> a(cuu $$0) {
      return this.a(() -> {
         dof.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(cuu $$0, tq $$1) {
      return this.a(() -> {
         try {
            dof.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bkp.b(dof.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cuu, dof.a>> $$0 = this.e.entrySet().iterator();
         Entry<cuu, dof.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bkp.b(dof.b.b.ordinal(), this::a));
   }

   private void a(cuu $$0, dof.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bkp.b(dof.b.c.ordinal(), () -> $$0.a(axk.a))).join();
         this.c.close();
