...
public abstract class dof {
   public static dof.b a(int $$0, int $$1) {
      return new dof.b($$0 - 1, $$1 + 1);
   }

   public static dof.b b(int $$0, int $$1) {
      return new dof.b($$0, $$1);
   }

   public static dof a(int $$0) {
      return new dof.c($$0, false);
   }

   public static dof b(int $$0) {
      return new dof.c($$0 + 1, false);
   }

   public static dof c(int $$0) {
      return new dof.c($$0, true);
   }

   public static dof d(int $$0) {
      return new dof.c($$0 - 1, true);
   }
   ...
   public static dof a(OptionalInt $$0, OptionalInt $$1) {
   ...
   public dof a(OptionalInt $$0) {
      return a($$0, this.b());
   }

   public dof b(OptionalInt $$0) {
      return a(this.c(), $$0);
   }

   public static Optional<dof> a(ctu $$0, hx $$1, int $$2, Predicate<djg> $$3, Predicate<djg> $$4) {
      hx.a $$5 = $$1.j();
      if (!$$0.a($$1, $$3)) {
   ...
   private static OptionalInt a(ctu $$0, int $$1, Predicate<djg> $$2, Predicate<djg> $$3, hx.a $$4, int $$5, ic $$6) {
      $$4.q($$5);
   ...
   public static final class a extends dof {
      static final dof.a a = new dof.a();
