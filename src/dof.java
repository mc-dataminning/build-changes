...
@Deprecated
public class dof extends dnq<dof.a> {
   private static final dfd a = cte.nc.o();

   public dof(Codec<dof.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dns<dof.a> $$0) {
      gw $$1 = $$0.e();
      cqv $$2 = $$0.b();
      ash $$3 = $$0.d();
      dof.a $$4 = $$0.f();
   ...
   public static record a(drv b, drv c) implements dpu {
      public static final Codec<dof.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(drv.a.fieldOf("fluid").forGetter(dof.a::a), drv.a.fieldOf("barrier").forGetter(dof.a::b)).apply($$0, dof.a::new)
      );
