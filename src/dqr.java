...
public class dqr extends dqu<dqq> {
   public dqr(Codec<dqq> $$0) {
      super($$0);
   }

   public boolean a(dqq $$0, auu $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dqp $$0, dqq $$1, dlc $$2, Function<hx, ih<cun>> $$3, auu $$4, dob $$5, csv $$6, dlb $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dqu.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dqp $$0, dqq $$1, dlc $$2, Function<hx, ih<cun>> $$3, dob $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dlb $$10, dqu.a $$11
   ) {
      double $$12 = 1.5 + (double)(aun.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(aun.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = aun.b($$13);
         $$6 += (double)(aun.b($$12) * $$27);
         $$7 += (double)aun.a($$13);
         $$8 += (double)(aun.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
