...
public class byg extends bii implements bjw {
   private static final adz<ciy> c = aec.a(byg.class, aeb.h);
   ...
   public byg(bim<? extends byg> $$0, cpm $$1) {
      super($$0, $$1);
      this.b = this.ag.i() * (float) Math.PI * 2.0F;
      this.r(this.ag.i() * 360.0F);
   }

   public byg(cpm $$0, double $$1, double $$2, double $$3, ciy $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$0.z.j() * 0.2 - 0.1, 0.2, $$0.z.j() * 0.2 - 0.1);
   }

   public byg(cpm $$0, double $$1, double $$2, double $$3, ciy $$4, double $$5, double $$6, double $$7) {
      this(bim.ad, $$0);
      this.e($$1, $$2, $$3);
      this.o($$5, $$6, $$7);
      this.a($$4);
   ...
   private void A() {
      if (this.B()) {
         for (byg $$1 : this.dK().a(byg.class, this.cG().c(0.5, 0.0, 0.5), $$0 -> $$0 != this && $$0.B())) {
            if ($$1.B()) {
               this.a($$1);
               if (this.dF()) {
                  break;
   ...
   public static ciy a(ciy $$0, ciy $$1, int $$2) {
   ...
   private static void a(byg $$0, ciy $$1, ciy $$2) {
      ciy $$3 = a($$1, $$2, 64);
      $$0.a($$3);
   }

   private static void a(byg $$0, ciy $$1, byg $$2, ciy $$3) {
      a($$0, $$1, $$3);
   ...
   public boolean a(bhg $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if (!this.j().b() && this.j().a(cjb.ty) && $$0.a(apn.l)) {
         return false;
