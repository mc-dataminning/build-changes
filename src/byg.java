...
public class byg extends byf {
   ...
   private static final aef<cjf> g = aei.a(byg.class, aeh.h);
   private static final aef<Integer> h = aei.a(byg.class, aeh.b);
   ...
   public byg(cpv $$0, gw $$1, hc $$2) {
      this(biu.af, $$0, $$1, $$2);
   }

   public byg(biu<? extends byg> $$0, cpv $$1, gw $$2, hc $$3) {
      super($$0, $$1, $$2);
      this.a($$3);
   }
   ...
   public boolean a(bho $$0, float $$1) {
      if (this.j) {
         return !$$0.a(apv.d) && !$$0.g() ? false : super.a($$0, $$1);
      } else if (this.b($$0)) {
         return false;
      } else if (!$$0.a(apv.l) && !this.F().b()) {
         if (!this.dL().B) {
            this.b($$0.d(), false);
            this.a(djt.c, $$0.d());
