public class goe extends goz {
   private final gou a;

   goe(gkq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gou $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         crm $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dB();
            if (this.h > $$1) {
   ...
   public static class a implements goc<mc> {
      ...
      public gnz a(mc $$0, gkq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new goe($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements goc<mc> {
      ...
      public gnz a(mc $$0, gkq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gnz $$8 = new goe($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
