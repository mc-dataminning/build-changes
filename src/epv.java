...
public class epv extends epz implements epx {
   ...
   public epv.c a() {
      return new epv.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(eqf.b $$0, eqf $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (eqg)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(eqf $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == epy.k;
         boolean $$2 = $$0 == epy.j;
   ...
   private IntConsumer a(int $$0, eqf.a $$1) {
   ...
   private epv.b q() {
      ...
      this.k += $$5;
      this.j++;
      epv.a $$9 = new epv.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new epv.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eqf.b.a || this.q == eqf.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eqg> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eqg $$1 = (eqg)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eqg.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eqg.b.c) {
         epx.super.a(this.b, this.c, this.d, this.e);
      }
   }

   @Override
   public eqe a(int $$0, int $$1, int $$2, int $$3) {
      if (this.a) {
         throw new IllegalStateException();
      } else {
         return epx.super.a($$0, $$1, $$2, $$3);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, epx.a($$11));
         this.a($$14 + 5, epx.a($$12));
         this.a($$14 + 6, epx.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eqf a, int b, int c, eqf.b d, eqf.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eqf.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eqi $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
