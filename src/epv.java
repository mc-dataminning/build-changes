...
public class epv {
   ...
   static class a implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
         return $$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d;
      }

      @Override
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.f.d()].d = true;
         return new epv.k($$0, $$1);
      }
   }

   static class b implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         ...
         return new epv.l($$0, $$1);
      }
   }

   static class c implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.b.d()].d = true;
         return new epv.m($$0, $$1);
      }
   }

   static class d implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         ...
         return new epv.n($$0, $$1);
      }
   }

   static class e implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[jn.c.d()].d = true;
         return new epv.o($$0, $$3);
      }
   }

   static class f implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
         return true;
      }
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         $$1.d = true;
         return new epv.s($$0, $$1, $$2);
      }
   }

   static class g implements epv.i {
      @Override
      public boolean a(epv.v $$0) {
      ...
      public epv.r a(jn $$0, epv.v $$1, azh $$2) {
         $$1.d = true;
         return new epv.t($$0, $$1);
      }
   }

   public static class h extends epv.r {
      ...
      private epv.v G;
      private epv.v H;
      private final List<epv.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, jn $$3) {
         super(eoc.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<epv.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new epv.p($$3, this.G));
         this.I.add(new epv.j($$3, this.H));
         List<epv.i> $$5 = Lists.newArrayList();
         $$5.add(new epv.b());
         $$5.add(new epv.d());
         $$5.add(new epv.e());
         $$5.add(new epv.a());
         ...
         end $$10 = end.a(this.b(1, 1, 1), this.b(23, 8, 21));
         end $$11 = end.a(this.b(34, 1, 1), this.b(56, 8, 21));
         end $$12 = end.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new epv.u($$3, $$10, $$13++));
         this.I.add(new epv.u($$3, $$11, $$13++));
         this.I.add(new epv.q($$3, $$12));
      }
      ...
      private List<epv.v> b(azh $$0) {
         epv.v[] $$1 = new epv.v[75];
         ...
         epv.v $$23 = new epv.v(1003);
         epv.v $$24 = new epv.v(1001);
         epv.v $$25 = new epv.v(1002);
         $$1[v].a(jn.b, $$23);
         $$1[w].a(jn.d, $$24);
         $$1[x].a(jn.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<epv.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhf $$2, azh $$3, end $$4) {
         int $$5 = 24;
      ...
      private void a(dhf $$0, azh $$1, end $$2) {
      ...
      private void b(dhf $$0, azh $$1, end $$2) {
      ...
      private void c(dhf $$0, azh $$1, end $$2) {
      ...
      private void d(dhf $$0, azh $$1, end $$2) {
      ...
      private void e(dhf $$0, azh $$1, end $$2) {
      ...
      private void f(dhf $$0, azh $$1, end $$2) {
   ...
   interface i {
      boolean a(epv.v var1);

      epv.r a(jn var1, epv.v var2, azh var3);
   }

   public static class j extends epv.r {
      public j(jn $$0, epv.v $$1) {
         super(eoc.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhf $$0, dhd $$1, dys $$2, azh $$3, end $$4, dfn $$5, ji $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, djn.co.m(), djn.co.m(), false);
   ...
   public static class k extends epv.r {
      public k(jn $$0, epv.v $$1) {
         super(eoc.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends epv.r {
      public l(jn $$0, epv.v $$1) {
         super(eoc.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends epv.r {
      public m(jn $$0, epv.v $$1) {
         super(eoc.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends epv.r {
      public n(jn $$0, epv.v $$1) {
         super(eoc.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends epv.r {
      public o(jn $$0, epv.v $$1) {
         super(eoc.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends epv.r {
      public p(jn $$0, epv.v $$1) {
         super(eoc.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends epv.r {
      public q(jn $$0, end $$1) {
         super(eoc.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends enp {
      protected static final dww b = djn.ix.m();
      protected static final dww c = djn.iy.m();
      protected static final dww d = djn.iz.m();
      protected static final dww h = c;
      protected static final dww i = djn.iG.m();
      protected static final boolean j = true;
      protected static final dww k = djn.J.m();
      protected static final Set<djl> l = ImmutableSet.builder().add(djn.eb).add(djn.ja).add(djn.ny).add(k.b()).build();
      ...
      public r(eoc $$0, jn $$1, int $$2, end $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eoc $$0, int $$1, jn $$2, epv.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static end a(jn $$0, epv.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         end $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhf $$0, end $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dww $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhf $$0, end $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhf $$0, end $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dww $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(end $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhf $$0, end $$1, int $$2, int $$3, int $$4) {
         ji $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clm $$6 = bur.M.a($$0.a(), buq.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), buq.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends epv.r {
      private int a;

      public s(jn $$0, epv.v $$1, azh $$2) {
         super(eoc.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends epv.r {
      public t(jn $$0, epv.v $$1) {
         super(eoc.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends epv.r {
      private int a;

      public u(jn $$0, end $$1, int $$2) {
         super(eoc.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
