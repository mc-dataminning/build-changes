...
public class epv {
   ...
   @Nullable
   private String g;
   private static final epv.a h = new epv.a() {
      @Nullable
      @Override
      public epu a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (epz.a(this.d, "Get capabilities")) {
         ...
         if (epz.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  epz.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !epz.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public epu a(epv.c $$0) {
      return ($$0 == epv.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements epv.a {
      private final int a;
      ...
      public epu a() {
         if (this.b.size() >= this.a) {
            if (aa.aU) {
               epv.a.warn("Maximum sound pool size {} reached", this.a);
            }
