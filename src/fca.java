...
public interface fca {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new fca.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new fca.d($$0, $$1);
      }
   }

   public static record a(String d) implements fca {
   ...
   public static record b(int e, @Nullable wz f) implements fca {
      public static final fca.b c = new fca.b(429, wz.c("mco.errorMessage.serviceBusy"));
      public static final wz d = wz.c("mco.errorMessage.retry");

      public static fca.b a(String $$0) {
         return new fca.b(500, wz.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fca.b a(fdi $$0) {
         return new fca.b(500, wz.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static fca.b a(int $$0) {
         return new fca.b($$0, d);
      }

      public static fca.b b(int $$0) {
         return new fca.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements fca {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements fca {
      @Override
      public int a() {
         return this.c;
      }
