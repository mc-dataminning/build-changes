...
public class fca {
   ...
   private static final Queue<fca.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fca.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fca::a), fbx::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fca::a), fbx::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fca.a(this.b) + ", type=" + fca.b(this.c) + ", severity=" + fca.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
