...
public class edr<T> implements edt<T> {
   ...
   private edr(jl<T> $$0, int $$1, edu<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private edr(jl<T> $$0, T[] $$1, edu<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public edt<T> a(edu<T> $$0) {
      return new edr<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
