...
public class cbr {
   ...
   public boolean a(cmb<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cmb<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cbr.a($$0).a($$2, $$1);
   }

   public int b(cmb<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cmb<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cbr.a($$0).b($$1, $$2);
   }

   public static ciy a(int $$0) {
      return $$0 == 0 ? ciy.b : new ciy(cit.b($$0));
   }
   ...
   class a {
      private final cmb<?> b;
      private final List<cly> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cbr.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
