...
public class dqq extends dpp {
   ...
   private akj<ekf> j = akj.a(lr.aT, new akk("empty"));
   private dqq.a k = dqq.a.a;
   private String l = "minecraft:air";
   private int m;
   private int q;

   public dqq(ja $$0, dsk $$1) {
      super(dpr.F, $$0, $$1);
   }
   ...
   protected void a(tx $$0, jl.a $$1) {
      ...
      this.k = dqq.a.a($$0.l("joint")).orElseGet(() -> djj.m(this.n()).o().d() ? dqq.a.b : dqq.a.a);
   ...
   public void a(aqm $$0, int $$1, boolean $$2) {
      ja $$3 = this.az_().a(this.n().c(djj.b).a());
      jw<ekf> $$4 = $$0.H_().d(lr.aT);
      jj<ekf> $$5 = $$4.g(this.j);
      ejz.a($$0, $$5, this.i, $$1, $$3, $$2);
   }
   ...
   public static enum a implements azc {
      ...
      public static Optional<dqq.a> a(String $$0) {
