...
public class dqq implements dqs {
   public static final Codec<dqq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bhg.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bhg.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bhg.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bhe.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bhe.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dqq(int $$0, bhg $$1, bhg $$2, int $$3, int $$4, bhg $$5, bhe $$6, bhe $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
