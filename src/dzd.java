...
public class dzd {
   ...
   private final List<dzb> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dzd.a l = new dzd.d(5.999997E7F);
   public static final dzd.c d = new dzd.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public fbs c(double $$0, double $$1, double $$2) {
      return new fbs(bae.a($$0, this.e(), this.g() - 1.0E-5F), $$1, bae.a($$2, this.f(), this.h() - 1.0E-5F));
   }

   public double a(bvf $$0) {
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dzd.a)($$0 == $$1 ? new dzd.d($$1) : new dzd.b($$0, $$1, $$2));
   ...
   class b implements dzd.a {
      ...
      @Override
      public double a() {
         return bae.a(dzd.this.a() - this.e() / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
      }

      @Override
      public double c() {
         return bae.a(dzd.this.b() - this.e() / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
      }
      ...
      @Override
      public dzc i() {
         return this.c < this.b ? dzc.b : dzc.a;
      }
      ...
      @Override
      public dzd.a l() {
         return (dzd.a)(this.g() <= 0L ? dzd.this.new d(this.c) : this);
      }
      ...
      public fcm m() {
         return fcj.a(
            fcj.c,
            fcj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbw.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dzd.c a(DynamicLike<?> $$0, dzd.c $$1) {
         ...
         return new dzd.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dzd.a {
      ...
      private void n() {
         this.c = bae.a(dzd.this.a() - this.b / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
         this.d = bae.a(dzd.this.b() - this.b / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
         this.e = bae.a(dzd.this.a() + this.b / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
         this.f = bae.a(dzd.this.b() + this.b / 2.0, (double)(-dzd.this.k), (double)dzd.this.k);
         this.g = fcj.a(
            fcj.c,
            fcj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbw.e
