...
public class dzd implements dkc.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzd> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final arj<dzd> a = arj.a(f);
   private final dzh g;
   private final dzh h;
   private final dzh i;
   ...
   public static dzd a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzd(new dlk(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzd(dzh $$0, dzh $$1, dzh $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzd(aru $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzh.a($$0, IntStream.rangeClosed(-15, 0)),
         dzh.a($$0, IntStream.rangeClosed(-15, 0)),
         dzh.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzd a(aru $$0) {
      return new dzd($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dkc.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dze $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzh.b($$4 * $$13), dzh.b($$5 * $$13), dzh.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzh.b($$1 * $$13);
         double $$21 = dzh.b($$2 * $$13);
         double $$22 = dzh.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dze $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return arp.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
