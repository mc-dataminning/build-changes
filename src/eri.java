...
public class eri extends erc<eri.a> {
   protected eri(dxw $$0) {
      super(dfo.a, $$0, new eri.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dxo g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kj.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dxo(15) : new dxo();
         }
      }
   }
   ...
   protected static final class a extends eqz<eri.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dxo> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public eri.a a() {
         return new eri.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
