...
public class eri {
   ...
   public static void a(File $$0, ekd $$1, Consumer<tn> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ekd $$2, Consumer<tn> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ekd $$2, Consumer<tn> $$3) {
      eks $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            tn $$3x = tn.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new tl(tl.a.b, $$6.getAbsolutePath())));
            $$3.accept(tn.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(tn.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eks a(ekd $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eks $$3 = new eks($$1, $$2, false);
   ...
   public eri(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
