...
public abstract class fam<T extends fam<T>> {
   ...
   public fam(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fak.a();
         if ($$3 != null) {
         ...
         throw new fbv(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fbv(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fbv(var2.getMessage(), var2);
      }
   }
   ...
   public static fam<?> a(String $$0) {
      return new fam.b($$0, 5000, 60000);
   }

   public static fam<?> a(String $$0, int $$1, int $$2) {
      return new fam.b($$0, $$1, $$2);
   }

   public static fam<?> b(String $$0, String $$1) {
      return new fam.c($$0, $$1, 5000, 60000);
   }

   public static fam<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fam.c($$0, $$1, $$2, $$3);
   }

   public static fam<?> b(String $$0) {
      return new fam.a($$0, 5000, 60000);
   }

   public static fam<?> c(String $$0, String $$1) {
      return new fam.d($$0, $$1, 5000, 60000);
   }

   public static fam<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fam.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fam<fam.a> {
   ...
   public static class b extends fam<fam.b> {
   ...
   public static class c extends fam<fam.c> {
      ...
      public fam.c f() {
         try {
            ...
            throw new fbv(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fam<fam.d> {
      private final String c;
