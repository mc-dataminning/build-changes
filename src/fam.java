...
public class fam {
   public static List<fbo> a(fam.a... $$0) {
      for (fam.a $$1 : $$0) {
         a($$1.j);
      }

      List<fbo> $$2 = Lists.newArrayList();

      for (fam.a $$3 : $$0) {
         $$2.add(new fbo($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fbo::a));
      return $$2;
   }
   ...
   public static List<fbo> a() {
      return a(fam.a.values());
   }
