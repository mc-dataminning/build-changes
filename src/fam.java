...
public class fam {
   ...
   public void a(fbw $$0, String $$1, fcs.a $$2, epx $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fam.b $$13 = new fam.b($$1.trim(), this.f, $$3, $$2);
                  fam.a $$14 = new fam.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fam.c $$30 = new fam.c(this.f, $$2, $$0);
                        fam.a $$31 = new fam.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fca(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epx $$2) throws IOException {
      ...
      File $$15 = new File(ffg.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final epx $$2, final fcs.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fam.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fam.this.b && !fam.this.d) {
            try {
               fam.this.e = true;
               fam.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fam.a.error("Error extracting archive", var3);
               fam.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fcs.a c;
      private final fbw d;

      c(final File $$0, final fcs.a $$1, final fbw $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fam.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fam.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fam.this.g);
                  fam.this.c = true;
               } else {
                  fam.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fam.this.d = true;
               }
            } catch (IOException var3) {
               fam.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fam.this.d = true;
            }
         }
      }
