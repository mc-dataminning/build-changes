...
public class aya {
   ...
   public static SecretKey a() throws ayb {
      try {
   ...
   public static KeyPair b() throws ayb {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws ayb {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, aya.a<T> $$3) throws ayb {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws ayb {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", aya::b);
   }

   public static PublicKey b(String $$0) throws ayb {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", aya::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws ayb {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws ayb {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws ayb {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws ayb {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws ayb {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws ayb {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws ayb {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws ayb;
   }

   public static record b(long b, byte[] c) {
      public static final aya.b a = new aya.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(wa $$0, aya.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
