...
public class aya<K> implements js<K> {
   ...
   private aya(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> aya<A> c(int $$0) {
      return new aya((int)((float)$$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (azd.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public aya<K> b() {
      return new aya<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
