...
public class aya implements AutoCloseable {
   ...
   private aya(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static aya.a a(Path $$0) {
         return new aya.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
