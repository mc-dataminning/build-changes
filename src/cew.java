...
public class cew extends cee {
   ...
   private final ceu r = ceu.a();
   public final int[] k = new int[3];
   public final int[] l = new int[]{-1, -1, -1};
   public final int[] m = new int[]{-1, -1, -1};

   public cew(int $$0, cbm $$1) {
      this($$0, $$1, cep.a);
   }

   public cew(int $$0, cbm $$1, cep $$2) {
      super(cfj.m, $$0);
      this.p = $$2;
      this.a(new cfw(this.o, 0, 15, 47) {
         @Override
         public int a() {
            return 1;
         }
      });
      this.a(new cfw(this.o, 1, 35, 47) {
         @Override
      ...
      this.a(ceu.a(this.k, 0));
      this.a(ceu.a(this.k, 1));
      this.a(ceu.a(this.k, 2));
      this.a(this.r).a($$1.m.fY());
      this.a(ceu.a(this.l, 0));
      this.a(ceu.a(this.l, 1));
      this.a(ceu.a(this.l, 2));
      this.a(ceu.a(this.m, 0));
      this.a(ceu.a(this.m, 1));
      this.a(ceu.a(this.m, 2));
   }
      ...
      if ($$0 == this.o) {
         ...
         if (!$$1.b() && $$1.D()) {
            this.p.a(($$1x, $$2x) -> {
               ...
               for (int $$6 = 0; $$6 < 3; $$6++) {
                  if (this.k[$$6] > 0) {
                     List<cni> $$7 = this.a($$1, $$6, this.k[$$6]);
                     if ($$7 != null && !$$7.isEmpty()) {
                        cni $$8 = $$7.get(this.q.a($$7.size()));
                        this.l[$$6] = jb.g.a($$8.a);
                        this.m[$$6] = $$8.b;
                     }
                  }
   ...
   public boolean b(cbn $$0, int $$1) {
      if ($$1 >= 0 && $$1 < this.k.length) {
         ...
         if (($$3.b() || $$3.L() < $$4) && !$$0.fR().d) {
            ...
            this.p.a(($$5, $$6) -> {
               ciy $$7 = $$2;
               List<cni> $$8 = this.a($$2, $$1, this.k[$$1]);
               if (!$$8.isEmpty()) {
                  $$0.a($$2, $$4);
                  boolean $$9 = $$2.a(cjb.qb);
                  if ($$9) {
                     $$7 = new ciy(cjb.tC);
                     qr $$10 = $$2.v();
                     if ($$10 != null) {
   ...
   private List<cni> a(ciy $$0, int $$1, int $$2) {
      this.q.b((long)(this.r.b() + $$1));
      List<cni> $$3 = cnh.b(this.q, $$0, $$2, false);
      if ($$0.a(cjb.qb) && $$3.size() > 1) {
