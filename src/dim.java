...
public abstract class dim {
   ...
   public void a(bwr<?> $$0, @Nullable djm $$1, azv $$2, iv $$3) {
         ...
         if (this.c > 0) {
            ...
            for (int $$5 = 0; $$5 < this.j; $$5++) {
               ...
               if ($$0.b($$7.get().a($$8.d, $$8.e, $$8.f))) {
                  ...
                  int $$12 = $$0.a(
                        eff.b($$11.getClass()),
                        new fex((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.n),
                        bwp.f
                     )
                     .size();
                  ...
                  if ($$11 instanceof bxl $$13) {
                     if ($$4.b().isEmpty() && !$$13.a($$0, bwq.c) || !$$13.a((djp)$$0)) {
                        continue;
                     }
   ...
   public void a(@Nullable djm $$0, iv $$1, tz $$2) {
      this.c = $$2.e("Delay");
      $$2.<dkg>a("SpawnData", dkg.b).ifPresent($$2x -> this.a($$0, $$1, $$2x));
      this.d = $$2.<bsq<dkg>>a("SpawnPotentials", dkg.c).orElseGet(() -> bsq.a(this.e != null ? this.e : new dkg()));
   ...
   public tz a(tz $$0) {
      ...
      $$0.b("SpawnData", dkg.b, this.e);
      $$0.a("SpawnPotentials", dkg.c, this.d);
      return $$0;
   }

   @Nullable
   public bwi b(djm $$0, iv $$1) {
      if (this.k == null) {
   ...
   protected void a(@Nullable djm $$0, iv $$1, dkg $$2) {
      this.e = $$2;
   }

   private dkg a(@Nullable djm $$0, azv $$1, iv $$2) {
      if (this.e != null) {
         return this.e;
      } else {
         this.a($$0, $$2, this.d.a($$1).orElseGet(dkg::new));
         return this.e;
      }
   }

   public abstract void a(djm var1, iv var2, int var3);
