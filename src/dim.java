...
public class dim {
   ...
   public dim(akk $$0, long $$1, dim.a $$2) {
      this($$0, $$1, $$2, gu.b);
   }

   public dim(akk $$0, long $$1, dim.a $$2, gu $$3) {
      this.l = $$0;
      this.m = $$3;
   ...
   public dim.a b() {
      return new dim.a(this.x, this.t, this.u, false, Optional.ofNullable(this.w), Optional.ofNullable(this.y), Optional.of(this.n));
   }
   ...
   public void c() {
      ...
      if (!this.k.h().isEmpty()) {
         this.l.k().a(akp.b, new cot(0, 0), 9, asp.a);
         boolean $$0 = this.n();
         if (this.x && $$0) {
            this.j();
            this.x = false;
         ...
         this.l.k().b(akp.b, new cot(0, 0), 9, asp.a);
      }
   }
   ...
   @Nullable
   private dff.b m() {
      cot $$0 = new cot(this.m);

      for (int $$1 = -8 + $$0.e; $$1 <= 8 + $$0.e; $$1++) {
         for (int $$2 = -8 + $$0.f; $$2 <= 8 + $$0.f; $$2++) {
            dhh $$3 = this.l.d($$1, $$2);

            for (dcm $$4 : $$3.G().values()) {
               if ($$4 instanceof deb) {
                  dff.b $$5 = this.o.a(this.l, $$4.p());
                  if ($$5 != null) {
                     gu $$6 = $$5.a(3, 3, 3).d();
                     if (this.y == null) {
                        this.y = $$6;
      ...
      gu $$7 = dnm.a(this.m);
      int $$8 = this.l.a(dkj.a.e, $$7).v();

      for (int $$9 = $$8; $$9 >= this.l.C_(); $$9--) {
         dff.b $$10 = this.o.a(this.l, new gu($$7.u(), $$9, $$7.w()));
         if ($$10 != null) {
            if (this.y == null) {
               this.y = $$10.a(3, 3, 3).d();
            }
   ...
   private boolean n() {
      if (this.v) {
         ...
         for (int $$1 = -8 + $$0.e; $$1 <= 8 + $$0.e; $$1++) {
            for (int $$2 = 8 + $$0.f; $$2 <= 8 + $$0.f; $$2++) {
               dgw $$3 = this.l.a($$1, $$2, dhb.n, false);
               if (!($$3 instanceof dhh)) {
                  return false;
               }
   ...
   private void p() {
      ...
      for (dox.a $$0 : dox.a(this.l)) {
         this.q = this.q + this.l.a(bwz.class, $$0.f()).size();
      }
   ...
   public void a(bxa $$0) {
      if ($$0.cv().equals(this.w)) {
         ...
         this.q();
         if (!this.u) {
            this.l.b(this.l.a(dkj.a.e, dnm.a(this.m)), csn.fA.n());
         }
   ...
   private void a(boolean $$0) {
      dnm $$1 = new dnm($$0);
      if (this.y == null) {
         this.y = this.l.a(dkj.a.f, dnm.a(this.m)).d();

         while (this.l.a_(this.y).a(csn.F) && this.y.v() > this.l.t_()) {
            this.y = this.y.d();
         }
      }

      $$1.a(dpr.m, this.l, this.l.k().g(), aru.a(), this.y);
   }

   @Nullable
   private bxa r() {
      this.l.l(new gu(this.m.u(), 128 + this.m.v(), this.m.w()));
      bxa $$0 = bim.C.a((cpm)this.l);
      if ($$0 != null) {
         $$0.a(this);
         $$0.h(this.m);
         $$0.fW().a(bxq.a);
   ...
   public void g() {
      if (this.t && this.z == null) {
         ...
         List<bwz> $$2 = Lists.newArrayList();
         gu $$3 = $$0.b(1);

         for (ha $$4 : ha.c.a) {
            List<bwz> $$5 = this.l.a(bwz.class, new egz($$3.a($$4, 2)));
            if ($$5.isEmpty()) {
               return;
            }
   ...
   private void a(List<bwz> $$0) {
      if (this.t && this.z == null) {
         for (dff.b $$1 = this.m(); $$1 != null; $$1 = this.m()) {
            for (int $$2 = 0; $$2 < this.o.c(); $$2++) {
               for (int $$3 = 0; $$3 < this.o.b(); $$3++) {
                  for (int $$4 = 0; $$4 < this.o.a(); $$4++) {
                     dfe $$5 = $$1.a($$2, $$3, $$4);
                     if ($$5.a().a(csn.F) || $$5.a().a(csn.fx)) {
                        this.l.b($$5.d(), csn.fz.n());
                     }
                  }
               }
            }
   ...
   public void h() {
      for (dox.a $$0 : dox.a(this.l)) {
         for (bwz $$2 : this.l.a(bwz.class, $$0.f())) {
            $$2.m(false);
            $$2.a(null);
         }
      }
   ...
   public static record a(boolean c, boolean d, boolean e, boolean f, Optional<UUID> g, Optional<gu> h, Optional<List<Integer>> i) {
      public static final Codec<dim.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  Codec.BOOL.fieldOf("NeedsStateScanning").orElse(true).forGetter(dim.a::a),
                  Codec.BOOL.fieldOf("DragonKilled").orElse(false).forGetter(dim.a::b),
                  Codec.BOOL.fieldOf("PreviouslyKilled").orElse(false).forGetter(dim.a::c),
                  Codec.BOOL.optionalFieldOf("IsRespawning", false).forGetter(dim.a::d),
                  hy.a.optionalFieldOf("Dragon").forGetter(dim.a::e),
                  gu.a.optionalFieldOf("ExitPortalLocation").forGetter(dim.a::f),
                  Codec.list(Codec.INT).optionalFieldOf("Gateways").forGetter(dim.a::g)
               )
               .apply($$0, dim.a::new)
      );
      public static final dim.a b = new dim.a(true, false, false, false, Optional.empty(), Optional.empty(), Optional.empty());
