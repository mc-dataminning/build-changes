...
public class dim {
   private static final dim a = new dim(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dim.a a(int $$0, int $$1) {
         return new dim.a(1.0, 0.0);
      }
   ...
   public static dim a(@Nullable aim $$0) {
      if ($$0 == null) {
         ...
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<din> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<din> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = apa.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dim($$2, $$3);
         }
      }
   }
   ...
   public dim.a a(int $$0, int $$1) {
      int $$2 = hq.a($$0);
      int $$3 = hq.a($$1);
      double $$4 = this.a($$2, 0, $$3, din::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dim.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(hq.d(clt.a($$5x)), hq.d(clt.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = apa.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
   ...
   public double a(dhd.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(hq.d(clt.a($$6x)), hq.d(clt.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = apa.f((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
   ...
   private double a(int $$0, int $$1, int $$2, dim.b $$3) {
      int $$4 = hq.e($$0);
      int $$5 = hq.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dim.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   private he<cnk> a(int $$0, int $$1, int $$2) {
      ...
      MutableObject<he<cnk>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(hq.d(clt.a($$5x)), $$1, hq.d(clt.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = apa.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
   ...
   public static void a(cng $$0, des $$1) {
      clt $$2 = $$1.f();
      Builder<hb, din> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dhg.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dim.c a(@Nullable din $$0, Map<hb, din> $$1) {
      List<dim.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dim.c a(@Nullable hb $$0, din $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ha $$4 : $$0.a()) {
   ...
   interface b {
      double get(din var1, int var2, int var3, int var4);
   }
