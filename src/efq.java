...
public class efq extends eft {
   public static final MapCodec<efq> a = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(efq::new, $$0 -> $$0.d);
   ...
   public void a(eft.a $$0) {
      ...
      if (!($$1.i() >= this.d)) {
         ...
         if (!$$5.isEmpty()) {
            ...
            if (!$$6.isEmpty()) {
               $$0.a($$6.get(), dfa.pe.o().a(des.b, b));
               $$0.a().a($$6.get(), dpi.H).ifPresent($$1x -> {
                  int $$2x = 2 + $$1.a(2);

                  for (int $$3x = 0; $$3x < $$2x; $$3x++) {
                     $$1x.a(dpd.c.a($$1.a(599)));
                  }
               });
            }
         }
