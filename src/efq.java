...
public class efq<T> implements efp<T> {
   ...
   private final Queue<eft<T>> g = new ArrayDeque<>();
   private final List<eft<T>> h = new ArrayList<>();
   private final Set<eft<?>> i = new ObjectOpenCustomHashSet(eft.c);
   private final BiConsumer<efo<T>, eft<T>> j = ($$0x, $$1x) -> {
      if ($$1x.equals($$0x.b())) {
         this.b($$1x);
      }
   };

   public efq(LongPredicate $$0, Supplier<ban> $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   private void a(Queue<efo<T>> $$0, efo<T> $$1, long $$2, int $$3) {
      if (this.a($$3)) {
         efo<T> $$4 = $$0.peek();
         eft<T> $$5 = $$4 != null ? $$4.b() : null;

         while (this.a($$3)) {
            eft<T> $$6 = $$1.b();
            if ($$6 == null || $$6.c() > $$2 || $$5 != null && eft.b.compare($$6, $$5) > 0) {
               break;
            }
   ...
   public boolean a(gu $$0, T $$1) {
      efo<T> $$2 = (efo<T>)this.d.get(clt.a($$0));
   ...
   private void a(drs $$0, efq.a<T> $$1) {
   ...
   public void a(efq<T> $$0, drs $$1, hz $$2) {
      List<eft<T>> $$3 = new ArrayList<>();
      Predicate<eft<T>> $$4 = $$1x -> $$1.b($$1x.b());
      $$0.h.stream().filter($$4).forEach($$3::add);
      $$0.g.stream().filter($$4).forEach($$3::add);
      $$0.a($$1, ($$2x, $$3x) -> $$3x.d().filter($$4).forEach($$3::add));
      LongSummaryStatistics $$5 = $$3.stream().mapToLong(eft::e).summaryStatistics();
      long $$6 = $$5.getMin();
      long $$7 = $$5.getMax();
      $$3.forEach($$3x -> this.a(new eft<>((T)$$3x.a(), $$3x.b().a($$2), $$3x.c(), $$3x.d(), $$3x.e() - $$6 + $$7 + 1L)));
   }
   ...
   @FunctionalInterface
   interface a<T> {
      void accept(long var1, efo<T> var3);
   }
}
