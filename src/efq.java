...
public class efq extends efu {
   public static final MapCodec<efq> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               efd.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
   ...
   protected final efd e;
   protected final int f;
   protected final List<je> g;

   public efq(float $$0, int $$1, int $$2, efd $$3, int $$4, List<je> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(efu.a $$0, iz $$1, je $$2) {
