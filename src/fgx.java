...
public class fgx {
   ...
   @Nullable
   private String g;
   private static final fgx.a h = new fgx.a() {
      @Nullable
      @Override
      public fgw a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fha.a(this.d, "Get capabilities")) {
         ...
         if (fha.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fha.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fha.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fgw a(fgx.c $$0) {
      return ($$0 == fgx.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fgx.a {
      private final int a;
      private final Set<fgw> b = Sets.newIdentityHashSet();
      ...
      public fgw a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fgx.a.warn("Maximum sound pool size {} reached", this.a);
            }
