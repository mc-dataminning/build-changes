...
public record fgx(int i, int j, fgx.a k, fgx.b l, int m) {
   public static final int a = 32;
   private static final fgx[] n = new fgx[32];
   private static final List<fgx> o = new ArrayList<>(32);
   public static final fgx b = a(0, 0, fgx.a.a, fgx.b.a, 3);
   public static final fgx c = a(1, 0, fgx.a.b, fgx.b.c, 4);
   public static final fgx d = a(2, 0, fgx.a.a, fgx.b.d, 2);
   public static final fgx e = d;
   public static final fgx f = a(3, 1, fgx.a.e, fgx.b.d, 2);
   public static final fgx g = a(4, 2, fgx.a.e, fgx.b.d, 2);
   public static final fgx h = a(5, 0, fgx.a.c, fgx.b.b, 3);

   public fgx(int i, int j, fgx.a k, fgx.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fgx a(int $$0, int $$1, fgx.a $$2, fgx.b $$3, int $$4) {
      fgx $$5 = new fgx($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fgx.b $$1) {
      return $$0 == 0 || $$1 == fgx.b.d;
   }
   ...
   @Nullable
   public static fgx a(int $$0) {
      return n[$$0];
   }

   public static Stream<fgx> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fgx.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
