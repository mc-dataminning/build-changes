...
public class fgx implements AutoCloseable {
   ...
   public fgx(fgv $$0, fgw $$1, ByteBuffer $$2) {
   ...
   public fgx.a a(int $$0, int $$1) {
      if (this.f) {
         ...
         return $$2 == null ? null : new fgx.a(this.d.h, $$2);
      }
   }
