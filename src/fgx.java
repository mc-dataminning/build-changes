...
public abstract class fgx<E extends fgx.a<E>> extends fgu {
   protected static final int b = 6;
   private static final ale a = new ale("widget/scroller");
   private static final ale m = new ale("widget/scroller_background");
   private static final ale n = new ale("textures/gui/menu_list_background.png");
   private static final ale o = new ale("textures/gui/inworld_menu_list_background.png");
   protected final ffd c;
   protected final int d;
   private final List<E> p = new fgx.b();
   ...
   public fgx(ffd $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xn.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayx.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aE_().get($$7) : null;
   }

   public void a(int $$0, fkp $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(fgp $$0) {
      RenderSystem.enableBlend();
      ale $$1 = this.c.r == null ? fnb.h : fnb.j;
      ale $$2 = this.c.r == null ? fnb.i : fnb.k;
   ...
   public void a(double $$0) {
      this.q = ayx.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = ayx.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(flg $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(flg $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fgp $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public fkw.a t() {
      if (this.aI_()) {
         ...
         return this.v != null ? fkw.a.b : fkw.a.a;
      }
   }
   ...
   protected void a(fky $$0, E $$1) {
      List<E> $$2 = this.aE_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fkx.b, xo.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fgx.a<E>> implements fiy {
      @Deprecated
      fgx<E> a;
      ...
      public abstract void a(fgp var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
