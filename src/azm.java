...
public class azm extends bea {
   public azm(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bfa.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bfa.s, "minecraft:piston");
