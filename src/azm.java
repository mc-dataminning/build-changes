...
public class azm extends DataFix {
   ...
   public azm(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(ayz.D);
      Type<?> $$1 = this.getInputSchema().getType(ayz.D);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bah.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(ayz.g);
      Type<?> $$1 = this.getInputSchema().getType(ayz.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bah.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
