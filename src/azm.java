...
public class azm {
   ...
   private static final BiFunction<Integer, Schema, Schema> c = bhl::new;
   ...
   private static void a(DataFixerBuilder $$0) {
      $$0.addSchema(99, bks::new);
      Schema $$1 = $$0.addSchema(100, bhm::new);
      $$0.addFixer(new bcc($$1, true));
      Schema $$2 = $$0.addSchema(101, b);
      $$0.addFixer(new baq($$2, false));
      Schema $$3 = $$0.addSchema(102, bhn::new);
      $$0.addFixer(new bds($$3, true));
      $$0.addFixer(new bdu($$3, false));
      Schema $$4 = $$0.addSchema(105, b);
      $$0.addFixer(new bdy($$4, true));
      Schema $$5 = $$0.addSchema(106, bhp::new);
      $$0.addFixer(new bey($$5, true));
      Schema $$6 = $$0.addSchema(107, bhq::new);
      $$0.addFixer(new bcj($$6, true));
      Schema $$7 = $$0.addSchema(108, b);
      $$0.addFixer(new bcw($$7, true));
      Schema $$8 = $$0.addSchema(109, b);
      $$0.addFixer(new bce($$8, true));
      Schema $$9 = $$0.addSchema(110, b);
      $$0.addFixer(new bcf($$9, true));
      Schema $$10 = $$0.addSchema(111, b);
      $$0.addFixer(new bcl($$10, true));
      Schema $$11 = $$0.addSchema(113, b);
      $$0.addFixer(new bcq($$11, true));
      Schema $$12 = $$0.addSchema(135, bhs::new);
      $$0.addFixer(new bcs($$12, true));
      Schema $$13 = $$0.addSchema(143, bht::new);
      $$0.addFixer(new bcy($$13, true));
      Schema $$14 = $$0.addSchema(147, b);
      $$0.addFixer(new bbv($$14, true));
      Schema $$15 = $$0.addSchema(165, b);
      $$0.addFixer(new bej($$15, true));
      Schema $$16 = $$0.addSchema(501, bkk::new);
      $$0.addFixer(new azu($$16, "Add 1.10 entities fix", bga.z));
      Schema $$17 = $$0.addSchema(502, b);
      $$0.addFixer(bdw.a($$17, "cooked_fished item renamer", $$0x -> Objects.equals(bhl.a($$0x), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : $$0x));
      $$0.addFixer(new bdd($$17, false));
      Schema $$18 = $$0.addSchema(505, b);
      $$0.addFixer(new bfk($$18, false));
      Schema $$19 = $$0.addSchema(700, bkl::new);
      $$0.addFixer(new bcb($$19, true));
      Schema $$20 = $$0.addSchema(701, bkm::new);
      $$0.addFixer(new bcv($$20, true));
      Schema $$21 = $$0.addSchema(702, bkn::new);
      $$0.addFixer(new bdc($$21, true));
      Schema $$22 = $$0.addSchema(703, bko::new);
      $$0.addFixer(new bcg($$22, true));
      Schema $$23 = $$0.addSchema(704, bkp::new);
      $$0.addFixer(new bak($$23, true));
      Schema $$24 = $$0.addSchema(705, bkq::new);
      $$0.addFixer(new bch($$24, true));
      Schema $$25 = $$0.addSchema(804, c);
      $$0.addFixer(new bdq($$25, true));
      Schema $$26 = $$0.addSchema(806, c);
      $$0.addFixer(new bei($$26, false));
      Schema $$27 = $$0.addSchema(808, bkr::new);
      $$0.addFixer(new azu($$27, "added shulker box", bga.s));
      Schema $$28 = $$0.addSchema(808, 1, c);
      $$0.addFixer(new bct($$28, false));
      Schema $$29 = $$0.addSchema(813, c);
      $$0.addFixer(new bdx($$29, false));
      $$0.addFixer(new bao($$29, false));
      Schema $$30 = $$0.addSchema(816, c);
      $$0.addFixer(new bfn($$30, false));
      Schema $$31 = $$0.addSchema(820, c);
      $$0.addFixer(bdw.a($$31, "totem item renamer", a("minecraft:totem", "minecraft:totem_of_undying")));
      Schema $$32 = $$0.addSchema(1022, bho::new);
      $$0.addFixer(new bhh($$32, "added shoulder entities to players", bga.b));
      Schema $$33 = $$0.addSchema(1125, bhr::new);
      $$0.addFixer(new bbb($$33, true));
      $$0.addFixer(new bab($$33, false));
      Schema $$34 = $$0.addSchema(1344, c);
      $$0.addFixer(new bfl($$34, false));
      Schema $$35 = $$0.addSchema(1446, c);
      $$0.addFixer(new bfm($$35, false));
      Schema $$36 = $$0.addSchema(1450, c);
      $$0.addFixer(new baw($$36, false));
      Schema $$37 = $$0.addSchema(1451, bhu::new);
      $$0.addFixer(new azu($$37, "AddTrappedChestFix", bga.s));
      Schema $$38 = $$0.addSchema(1451, 1, bhv::new);
      $$0.addFixer(new bbh($$38, true));
      Schema $$39 = $$0.addSchema(1451, 2, bhw::new);
      $$0.addFixer(new bai($$39, true));
      Schema $$40 = $$0.addSchema(1451, 3, bhx::new);
      $$0.addFixer(new bbw($$40, true));
      $$0.addFixer(new bed($$40, false));
      Schema $$41 = $$0.addSchema(1451, 4, bhy::new);
      $$0.addFixer(new bas($$41, true));
      $$0.addFixer(new beg($$41, false));
      Schema $$42 = $$0.addSchema(1451, 5, bhz::new);
      $$0.addFixer(
         new bdv(
            $$42,
            false,
      ...
      $$0.addFixer(new azu($$42, "RemoveNoteBlockFlowerPotFix", bga.s));
      $$0.addFixer(new bee($$42, false, "minecraft:spawn_egg"));
      $$0.addFixer(new bdb($$42, false));
      $$0.addFixer(new bah($$42, false));
      $$0.addFixer(new bep($$42, false));
      Schema $$43 = $$0.addSchema(1451, 6, bia::new);
      $$0.addFixer(new bgn($$43, true));
      $$0.addFixer(new bal($$43, false));
      Schema $$44 = $$0.addSchema(1451, 7, c);
      $$0.addFixer(new bhb($$44, false));
      Schema $$45 = $$0.addSchema(1456, c);
      $$0.addFixer(new bci($$45, false));
      Schema $$46 = $$0.addSchema(1458, c);
      $$0.addFixer(new bca($$46, false));
      $$0.addFixer(new bdr($$46, false));
      $$0.addFixer(new baj($$46, false));
      Schema $$47 = $$0.addSchema(1460, bib::new);
      $$0.addFixer(new bcm($$47, false));
      Schema $$48 = $$0.addSchema(1466, bic::new);
      $$0.addFixer(new azu($$48, "Add DUMMY block entity", bga.s));
      $$0.addFixer(new bbn($$48, true));
      Schema $$49 = $$0.addSchema(1470, bid::new);
      $$0.addFixer(new azu($$49, "Add 1.13 entities fix", bga.z));
      Schema $$50 = $$0.addSchema(1474, c);
      $$0.addFixer(new bbo($$50, false));
      $$0.addFixer(
         bau.a($$50, "Colorless shulker block fixer", $$0x -> Objects.equals(bhl.a($$0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : $$0x)
      );
      $$0.addFixer(
         bdw.a($$50, "Colorless shulker item fixer", $$0x -> Objects.equals(bhl.a($$0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : $$0x)
      );
      ...
      $$0.addFixer(bau.a($$52, "Rename coral blocks", b(bgf.a)));
      $$0.addFixer(bdw.a($$52, "Rename coral items", b(bgf.a)));
      Schema $$53 = $$0.addSchema(1481, bie::new);
      $$0.addFixer(new azu($$53, "Add conduit", bga.s));
      Schema $$54 = $$0.addSchema(1483, bif::new);
      $$0.addFixer(new bco($$54, true));
      $$0.addFixer(bdw.a($$54, "Rename pufferfish egg item", b(bco.a)));
      ...
      $$0.addFixer(new bdn($$55, false));
      Schema $$56 = $$0.addSchema(1486, big::new);
      $$0.addFixer(new bbz($$56, true));
      $$0.addFixer(bdw.a($$56, "Rename cod/salmon egg items", b(bbz.b)));
      ...
      $$0.addFixer(bdw.a($$58, "Rename kelptop", a("minecraft:kelp_top", "minecraft:kelp")));
      $$0.addFixer(new bez($$58, false, "Command block block entity custom name fix", bga.s, "minecraft:command_block") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), bca::a);
         }
      });
      $$0.addFixer(new bez($$58, false, "Command block minecart custom name fix", bga.z, "minecraft:commandblock_minecart") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), bca::a);
         }
      });
      $$0.addFixer(new bdp($$58, false));
      ...
      $$0.addFixer(new bec($$61, false));
      Schema $$62 = $$0.addSchema(1496, c);
      $$0.addFixer(new bem($$62, false));
      ...
      $$0.addFixer(new bfb($$65, "Recipes fix", bga.H, b(bfx.a)));
      Schema $$66 = $$0.addSchema(1506, c);
      $$0.addFixer(new beo($$66, false));
      Schema $$67 = $$0.addSchema(1510, bih::new);
      $$0.addFixer(bau.a($$67, "Block renamening fix", b(bcx.b)));
      $$0.addFixer(bdw.a($$67, "Item renamening fix", b(bcx.c)));
      $$0.addFixer(new bfb($$67, "Recipes renamening fix", bga.H, b(bfy.a)));
      $$0.addFixer(new bcx($$67, true));
      $$0.addFixer(
         new bgo(
            $$67,
            "SwimStatsRenameFix",
      ...
      $$0.addFixer(new bfd($$68, false));
      $$0.addFixer(new bgt($$68, false));
      $$0.addFixer(new bfe($$68, false));
      Schema $$69 = $$0.addSchema(1515, c);
      $$0.addFixer(bau.a($$69, "Rename coral fan blocks", b(bge.a)));
      Schema $$70 = $$0.addSchema(1624, c);
      $$0.addFixer(new bgv($$70, false));
      Schema $$71 = $$0.addSchema(1800, bii::new);
      $$0.addFixer(new azu($$71, "Added 1.14 mobs fix", bga.z));
      $$0.addFixer(bdw.a($$71, "Rename dye items", b(bbs.a)));
      Schema $$72 = $$0.addSchema(1801, bij::new);
      $$0.addFixer(new azu($$72, "Added Illager Beast", bga.z));
      ...
      $$0.addFixer(new bdt($$74, false));
      Schema $$75 = $$0.addSchema(1904, bik::new);
      $$0.addFixer(new azu($$75, "Added Cats", bga.z));
      $$0.addFixer(new bby($$75, false));
      Schema $$76 = $$0.addSchema(1905, c);
      $$0.addFixer(new bbk($$76, false));
      Schema $$77 = $$0.addSchema(1906, bil::new);
      $$0.addFixer(new azu($$77, "Add POI Blocks", bga.s));
      Schema $$78 = $$0.addSchema(1909, bim::new);
      $$0.addFixer(new azu($$78, "Add jigsaw", bga.s));
      Schema $$79 = $$0.addSchema(1911, c);
      $$0.addFixer(new bbl($$79, false));
      Schema $$80 = $$0.addSchema(1914, c);
      $$0.addFixer(new bhd($$80, false));
      Schema $$81 = $$0.addSchema(1917, c);
      $$0.addFixer(new bax($$81, false));
      Schema $$82 = $$0.addSchema(1918, c);
      $$0.addFixer(new bgy($$82, "minecraft:villager"));
      $$0.addFixer(new bgy($$82, "minecraft:zombie_villager"));
      Schema $$83 = $$0.addSchema(1920, bin::new);
      $$0.addFixer(new bfc($$83, false));
      $$0.addFixer(new azu($$83, "Add campfire", bga.s));
      Schema $$84 = $$0.addSchema(1925, c);
      $$0.addFixer(new beu($$84, false));
      Schema $$85 = $$0.addSchema(1928, bio::new);
      $$0.addFixer(new bcp($$85, true));
      $$0.addFixer(bdw.a($$85, "Rename ravager egg item", b(bcp.a)));
      Schema $$86 = $$0.addSchema(1929, bip::new);
      $$0.addFixer(new azu($$86, "Add Wandering Trader and Trader Llama", bga.z));
      Schema $$87 = $$0.addSchema(1931, biq::new);
      $$0.addFixer(new azu($$87, "Added Fox", bga.z));
      Schema $$88 = $$0.addSchema(1936, c);
      $$0.addFixer(new bfi($$88, false));
      Schema $$89 = $$0.addSchema(1946, c);
      $$0.addFixer(new bgg($$89, false));
      Schema $$90 = $$0.addSchema(1948, c);
      $$0.addFixer(new bfg($$90));
      Schema $$91 = $$0.addSchema(1953, c);
      $$0.addFixer(new bff($$91, false));
      Schema $$92 = $$0.addSchema(1955, c);
      $$0.addFixer(new bha($$92, false));
      $$0.addFixer(new bhi($$92, false));
      Schema $$93 = $$0.addSchema(1961, c);
      $$0.addFixer(new bbg($$93, false));
      Schema $$94 = $$0.addSchema(1963, c);
      $$0.addFixer(new bgc($$94, false));
      Schema $$95 = $$0.addSchema(2100, bir::new);
      $$0.addFixer(new azu($$95, "Added Bee and Bee Stinger", bga.z));
      $$0.addFixer(new azu($$95, "Add beehive", bga.s));
      $$0.addFixer(new bfb($$95, "Rename sugar recipe", bga.H, a("minecraft:sugar", "minecraft:sugar_from_sugar_cane")));
      ...
      $$0.addFixer(bdw.a($$97, "Rename bee_hive item to beehive", $$98));
      $$0.addFixer(new bfu($$97, "Rename bee_hive poi to beehive", $$98));
      $$0.addFixer(bau.a($$97, "Rename bee_hive block to beehive", $$98));
      Schema $$99 = $$0.addSchema(2211, c);
      $$0.addFixer(new bgq($$99, false));
      Schema $$100 = $$0.addSchema(2218, c);
      $$0.addFixer(new bdj($$100, false));
      Schema $$101 = $$0.addSchema(2501, bis::new);
      $$0.addFixer(new bdk($$101, true));
      Schema $$102 = $$0.addSchema(2502, bit::new);
      $$0.addFixer(new azu($$102, "Added Hoglin", bga.z));
      Schema $$103 = $$0.addSchema(2503, c);
      $$0.addFixer(new bhc($$103, false));
      ...
      Schema $$104 = $$0.addSchema(2505, biu::new);
      $$0.addFixer(new azu($$104, "Added Piglin", bga.z));
      $$0.addFixer(new bev($$104, "minecraft:villager"));
      ...
      Schema $$106 = $$0.addSchema(2509, biv::new);
      $$0.addFixer(new bde($$106));
      $$0.addFixer(bdw.a($$106, "Rename zombie pigman egg item", b(bde.a)));
      Schema $$107 = $$0.addSchema(2511, c);
      $$0.addFixer(new bcn($$107));
      Schema $$108 = $$0.addSchema(2514, c);
      $$0.addFixer(new bcz($$108));
      $$0.addFixer(new bar($$108));
      $$0.addFixer(new bfs($$108));
      $$0.addFixer(new ber($$108));
      $$0.addFixer(new bgi($$108));
      $$0.addFixer(new beh($$108));
      Schema $$109 = $$0.addSchema(2516, c);
      $$0.addFixer(new bdm($$109, "minecraft:villager"));
      $$0.addFixer(new bdm($$109, "minecraft:zombie_villager"));
      Schema $$110 = $$0.addSchema(2518, c);
      $$0.addFixer(new bek($$110, false));
      $$0.addFixer(new bel($$110, false));
      Schema $$111 = $$0.addSchema(2519, biw::new);
      $$0.addFixer(new azu($$111, "Added Strider", bga.z));
      Schema $$112 = $$0.addSchema(2522, bix::new);
      $$0.addFixer(new azu($$112, "Added Zoglin", bga.z));
      ...
      $$0.addFixer(new bgp($$116, false));
      Schema $$117 = $$0.addSchema(2531, c);
      $$0.addFixer(new bfz($$117));
      Schema $$118 = $$0.addSchema(2533, c);
      $$0.addFixer(new bgz($$118));
      Schema $$119 = $$0.addSchema(2535, c);
      $$0.addFixer(new bcu($$119));
      Schema $$120 = $$0.addSchema(2538, c);
      $$0.addFixer(new beq($$120));
      Schema $$121 = $$0.addSchema(2550, c);
      $$0.addFixer(new bhf($$121));
      Schema $$122 = $$0.addSchema(2551, biy::new);
      $$0.addFixer(new bhh($$122, "add types to WorldGenData", bga.K));
      Schema $$123 = $$0.addSchema(2552, c);
      $$0.addFixer(new bfb($$123, "Nether biome rename", bga.I, a("minecraft:nether", "minecraft:nether_wastes")));
      Schema $$124 = $$0.addSchema(2553, c);
      $$0.addFixer(new bfb($$124, "Biomes fix", bga.I, b(bad.a)));
      Schema $$125 = $$0.addSchema(2558, c);
      $$0.addFixer(new bew($$125, false));
      $$0.addFixer(new bfp($$125, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
      Schema $$126 = $$0.addSchema(2568, biz::new);
      $$0.addFixer(new azu($$126, "Added Piglin Brute", bga.z));
      Schema $$127 = $$0.addSchema(2571, bja::new);
      $$0.addFixer(new azu($$127, "Added Goat", bga.z));
      Schema $$128 = $$0.addSchema(2679, c);
      $$0.addFixer(new bay($$128, false));
      Schema $$129 = $$0.addSchema(2680, c);
      $$0.addFixer(bdw.a($$129, "Renamed grass path item to dirt path", a("minecraft:grass_path", "minecraft:dirt_path")));
      $$0.addFixer(bau.a($$129, "Renamed grass path block to dirt path", a("minecraft:grass_path", "minecraft:dirt_path")));
      Schema $$130 = $$0.addSchema(2684, bjb::new);
      $$0.addFixer(new azu($$130, "Added Sculk Sensor", bga.s));
      Schema $$131 = $$0.addSchema(2686, bjc::new);
      $$0.addFixer(new azu($$131, "Added Axolotl", bga.z));
      Schema $$132 = $$0.addSchema(2688, bjd::new);
      $$0.addFixer(new azu($$132, "Added Glow Squid", bga.z));
      $$0.addFixer(new azu($$132, "Added Glow Item Frame", bga.z));
      ...
      ImmutableMap<String, String> $$134 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bdw.a($$133, "Renamed copper block items to new oxidized terms", b($$134)));
      ...
      ImmutableMap<String, String> $$136 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bdw.a($$135, "Rename copper item suffixes", b($$136)));
      $$0.addFixer(bau.a($$135, "Rename copper blocks suffixes", b($$136)));
      Schema $$137 = $$0.addSchema(2693, c);
      $$0.addFixer(new azt($$137, bga.K, "has_increased_height_already", false));
      ...
      ImmutableMap<String, String> $$139 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bdw.a($$138, "Renamed grimstone block items to deepslate", b($$139)));
      ...
      $$0.addFixer(new bgh($$141));
      Schema $$142 = $$0.addSchema(2702, c);
      $$0.addFixer(new azq($$142));
      Schema $$143 = $$0.addSchema(2704, bje::new);
      $$0.addFixer(new azu($$143, "Added Goat", bga.z));
      Schema $$144 = $$0.addSchema(2707, bjf::new);
      $$0.addFixer(new azu($$144, "Added Marker", bga.z));
      $$0.addFixer(new azt($$144, bga.K, "has_increased_height_already", true));
      Schema $$145 = $$0.addSchema(2710, c);
      $$0.addFixer(new bgo($$145, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
      Schema $$146 = $$0.addSchema(2717, c);
      $$0.addFixer(bdw.a($$146, "Rename azalea_leaves_flowers", b(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      $$0.addFixer(
      ...
      $$0.addFixer(new azt($$147, bga.K, "has_increased_height_already", false));
      Schema $$148 = $$0.addSchema(2831, bjg::new);
      $$0.addFixer(new bgm($$148));
      Schema $$149 = $$0.addSchema(2832, bjh::new);
      $$0.addFixer(new bhg($$149));
      $$0.addFixer(new bbf($$149));
      Schema $$150 = $$0.addSchema(2833, c);
      $$0.addFixer(new bhe($$150));
      Schema $$151 = $$0.addSchema(2838, c);
      $$0.addFixer(new bfb($$151, "Caves and Cliffs biome renames", bga.I, b(baz.a)));
      Schema $$152 = $$0.addSchema(2841, c);
      $$0.addFixer(new bbi($$152));
      Schema $$153 = $$0.addSchema(2842, bji::new);
      $$0.addFixer(new bbj($$153));
      Schema $$154 = $$0.addSchema(2843, c);
      $$0.addFixer(new bfq($$154));
      $$0.addFixer(new bfb($$154, "Remove Deep Warm Ocean", bga.I, a("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      $$0.addFixer(new bhe($$156));
      Schema $$157 = $$0.addSchema(2967, c);
      $$0.addFixer(new bgr($$157));
      Schema $$158 = $$0.addSchema(2970, c);
      $$0.addFixer(new bgs($$158));
      Schema $$159 = $$0.addSchema(3076, bjj::new);
      $$0.addFixer(new azu($$159, "Added Sculk Catalyst", bga.s));
      Schema $$160 = $$0.addSchema(3077, c);
      $$0.addFixer(new bbd($$160));
      Schema $$161 = $$0.addSchema(3078, bjk::new);
      $$0.addFixer(new azu($$161, "Added Frog", bga.z));
      $$0.addFixer(new azu($$161, "Added Tadpole", bga.z));
      $$0.addFixer(new azu($$161, "Added Sculk Shrieker", bga.s));
      Schema $$162 = $$0.addSchema(3081, bjl::new);
      $$0.addFixer(new azu($$162, "Added Warden", bga.z));
      Schema $$163 = $$0.addSchema(3082, bjm::new);
      $$0.addFixer(new azu($$163, "Added Chest Boat", bga.z));
      Schema $$164 = $$0.addSchema(3083, bjn::new);
      $$0.addFixer(new azu($$164, "Added Allay", bga.z));
      ...
      $$0.addFixer(new bda($$166, "Change cat variant type", bga.z, "minecraft:cat", "CatType", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      $$0.addFixer(new bft($$172, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
      Schema $$174 = $$0.addSchema(3108, c);
      $$0.addFixer(new bag($$174));
      Schema $$175 = $$0.addSchema(3201, c);
      $$0.addFixer(new bfo($$175));
      Schema $$176 = $$0.addSchema(3202, bjo::new);
      $$0.addFixer(new azu($$176, "Added Hanging Sign", bga.s));
      Schema $$177 = $$0.addSchema(3203, bjp::new);
      $$0.addFixer(new azu($$177, "Added Camel", bga.z));
      Schema $$178 = $$0.addSchema(3204, bjq::new);
      $$0.addFixer(new azu($$178, "Added Chiseled Bookshelf", bga.s));
      Schema $$179 = $$0.addSchema(3209, c);
      $$0.addFixer(new bee($$179, false, "minecraft:pig_spawn_egg"));
      Schema $$180 = $$0.addSchema(3214, c);
      $$0.addFixer(new bfj($$180));
      Schema $$181 = $$0.addSchema(3319, c);
      $$0.addFixer(new bfh($$181));
      Schema $$182 = $$0.addSchema(3322, c);
      $$0.addFixer(new bbt($$182));
      Schema $$183 = $$0.addSchema(3325, bjr::new);
      $$0.addFixer(new azu($$183, "Added displays", bga.z));
      Schema $$184 = $$0.addSchema(3326, bjs::new);
      $$0.addFixer(new azu($$184, "Added Sniffer", bga.z));
      Schema $$185 = $$0.addSchema(3327, bjt::new);
      $$0.addFixer(new azu($$185, "Archaeology", bga.s));
      Schema $$186 = $$0.addSchema(3328, bju::new);
      $$0.addFixer(new azu($$186, "Added interaction", bga.z));
      Schema $$187 = $$0.addSchema(3438, bjv::new);
      $$0.addFixer(ban.a($$187, "Rename Suspicious Sand to Brushable Block", a("minecraft:suspicious_sand", "minecraft:brushable_block")));
      $$0.addFixer(new bbx($$187));
      $$0.addFixer(
         bdw.a(
            $$187,
      ...
      $$0.addFixer(new azu($$187, "Added calibrated sculk sensor", bga.s));
      ...
      $$0.addFixer(new bfb($$189, "Replace experimental 1.20 overworld", bga.J, a("minecraft:overworld_update_1_20", "minecraft:overworld")));
      $$0.addFixer(new bdf($$189, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      ...
      Schema $$192 = $$0.addSchema(3448, bjw::new);
      ...
      $$0.addFixer(new bfw($$197));
      Schema $$198 = $$0.addSchema(3566, c);
      $$0.addFixer(new bgj($$198));
      Schema $$199 = $$0.addSchema(3568, c);
      $$0.addFixer(new bex($$199));
      Schema $$200 = $$0.addSchema(3682, bjx::new);
      $$0.addFixer(new azu($$200, "Added Crafter", bga.s));
      Schema $$201 = $$0.addSchema(3683, bjy::new);
      $$0.addFixer(new bfv($$201));
      Schema $$202 = $$0.addSchema(3685, bjz::new);
      $$0.addFixer(new bdi($$202));
      Schema $$203 = $$0.addSchema(3689, bka::new);
      $$0.addFixer(new azu($$203, "Added Breeze", bga.z));
      $$0.addFixer(new azu($$203, "Added Trial Spawner", bga.s));
      ...
      $$0.addFixer(bdw.a($$204, "Rename grass item to short_grass", $$205));
      Schema $$206 = $$0.addSchema(3799, bkb::new);
      $$0.addFixer(new azu($$206, "Added Armadillo", bga.z));
      Schema $$207 = $$0.addSchema(3800, c);
      UnaryOperator<String> $$208 = b(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      $$0.addFixer(bdw.a($$207, "Rename scute item to turtle_scute", $$208));
      Schema $$209 = $$0.addSchema(3803, c);
      $$0.addFixer(new bgd($$209, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema $$210 = $$0.addSchema(3807, bkc::new);
      $$0.addFixer(new azu($$210, "Added Vault", bga.s));
      Schema $$211 = $$0.addSchema(3807, 1, c);
      $$0.addFixer(new bet($$211));
      Schema $$212 = $$0.addSchema(3808, bkd::new);
      $$0.addFixer(new bdo($$212, "minecraft:horse", "ArmorItem"));
      Schema $$213 = $$0.addSchema(3808, 1, bke::new);
      $$0.addFixer(new bdo($$213, "minecraft:llama", "DecorItem"));
      Schema $$214 = $$0.addSchema(3809, c);
      $$0.addFixer(new bba($$214));
      Schema $$215 = $$0.addSchema(3812, c);
      $$0.addFixer(new azo($$215));
      Schema $$216 = $$0.addSchema(3813, c);
      $$0.addFixer(new bat($$216));
      Schema $$217 = $$0.addSchema(3814, c);
      $$0.addFixer(new azy($$217, "Rename jump strength attribute", a("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      Schema $$218 = $$0.addSchema(3816, bkf::new);
      $$0.addFixer(new azu($$218, "Added Bogged", bga.z));
      Schema $$219 = $$0.addSchema(3818, bkg::new);
      $$0.addFixer(new bac($$219));
      $$0.addFixer(new bbu($$219));
      Schema $$220 = $$0.addSchema(3818, 1, c);
      $$0.addFixer(new baa($$220));
      Schema $$221 = $$0.addSchema(3818, 2, c);
      $$0.addFixer(new bgu($$221));
      Schema $$222 = $$0.addSchema(3818, 3, bkh::new);
      $$0.addFixer(new bhh($$222, "Inject data component types", bga.w));
      Schema $$223 = $$0.addSchema(3818, 4, bki::new);
      $$0.addFixer(new bea($$223));
      Schema $$224 = $$0.addSchema(3818, 5, c);
      $$0.addFixer(new azx($$224));
      Schema $$225 = $$0.addSchema(3820, c);
      $$0.addFixer(new bfr($$225));
      $$0.addFixer(new bes($$225));
      Schema $$226 = $$0.addSchema(3825, bkj::new);
      $$0.addFixer(new beb($$226));
      $$0.addFixer(new azz($$226));
      $$0.addFixer(new bgw($$226));
      $$0.addFixer(new azu($$226, "Added Ominous Item Spawner", bga.z));
   }
   ...
   private static UnaryOperator<String> b(Map<String, String> $$0) {
      return $$1 -> $$0.getOrDefault(bhl.a($$1), $$1);
   }

   private static UnaryOperator<String> a(String $$0, String $$1) {
      return $$2 -> Objects.equals(bhl.a($$2), $$0) ? $$1 : $$2;
   }
}
