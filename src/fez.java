...
public class fez extends fer<cjb> implements fgu {
   private float x;
   private float y;
   private final fgo z = new fgo();
   private boolean A;
   private boolean B;
   ...
   public void D() {
      if (this.f.q.g()) {
         this.f.a(new feo(this.f.s, this.f.s.cn.y(), this.f.m.G().c()));
      } else {
         this.z.g();
      }
   }
   ...
   protected void aN_() {
      if (this.f.q.g()) {
         ...
         this.d(new exr(this.t + 104, this.h / 2 - 22, 20, 18, fgo.a, $$0 -> {
            this.z.e();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(ewt $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bmk $$9) {
   ...
   public static void a(ewt $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bmk $$7) {
      $$0.c().a();
