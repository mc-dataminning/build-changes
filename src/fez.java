...
public class fez {
   public static List<fgj> a(fez.a... $$0) {
      for (fez.a $$1 : $$0) {
         a($$1.j);
      }

      List<fgj> $$2 = Lists.newArrayList();

      for (fez.a $$3 : $$0) {
         $$2.add(new fgj($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fgj::a));
      return $$2;
   }
   ...
   public static List<fgj> a() {
      return a(fez.a.values());
   }
