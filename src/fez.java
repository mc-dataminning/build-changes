...
public class fez extends ffe {
   ...
   protected void aQ_() {
      ...
      this.d(new fao(0, this.A ? 40 : 10, this.g, 9, this.e, this.i));
   }
   ...
   private void E() {
      ...
      $$1.a(this.a(o, () -> new ffu(this.f.s.cq.r())));
      $$1.a(this.a(p, () -> new ffn(this, this.f.s.j())));
      ...
      $$1.a(this.a(t, () -> new fev(this, this.f.m)));
      if (this.f.S() && !this.f.T().p()) {
         $$1.a(this.a(u, () -> new fff(this)));
      } else {
         $$1.a(this.a(v, fjo::new));
      }

      vq $$2 = this.f.R() ? w : vp.p;
      this.B = $$1.a(ezh.a($$2, $$0x -> {
         $$0x.j = false;
         this.f.aY().a(this.f, this, this::H, true);
      }).a(204).a(), 2);
      $$0.a();
      fcr.a($$0, 0, 0, this.g, this.h, 0.5F, 0.25F);
      $$0.a(this::d);
   }
   ...
   private ezh a(vq $$0, Supplier<ffe> $$1) {
      return ezh.a($$0, $$1x -> this.f.a($$1.get())).a(98).a();
   }

   private ezh a(vq $$0, String $$1) {
      return ezh.a($$0, fdw.b(this, $$1)).a(98).a();
   }
}
