public class gmh<T extends btq, M extends fvg<T>> extends gnt<T, M> {
   private static final alf a = new alf("textures/entity/bee/bee_stinger.png");

   public gmh(gjz<T, M> $$0) {
      super($$0);
   }
   ...
   @Override
   protected void a(ezz $$0, gdp $$1, int $$2, bsv $$3, float $$4, float $$5, float $$6, float $$7) {
   ...
   private static void a(fad $$0, ezz.a $$1, float $$2, int $$3, float $$4, float $$5, int $$6) {
      $$0.a($$1, $$2, (float)$$3, 0.0F).a(255, 255, 255, 255).a($$4, $$5).c(gor.d).b($$6).b($$1, 0.0F, 1.0F, 0.0F).e();
   }
}
