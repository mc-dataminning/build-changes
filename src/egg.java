...
public class egg extends ego<eiz> {
   private static final dxw a = dxw.a(dkg.L);
   private final dxn b = dkg.L.m();
   private final dxn c = dkg.jX.m();
   private final dxn d = dkg.bc.m();
   private final dxn ao = dkg.J.m();

   public egg(Codec<eiz> $$0) {
      super($$0);
   }
   ...
   private static void b(dhy $$0, jh $$1) {
      $$0.a($$1, dkg.M.m(), 3);
      $$0.a($$1, dur.O).ifPresent($$1x -> $$1x.a(ewd.aX, $$1.a()));
   }
}
