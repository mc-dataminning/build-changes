...
public class egg extends ege {
   ...
   private final bpx i;
   private final jm<dex> j;

   public egg(int $$0, int $$1, int $$2, bpx $$3, float $$4, bpx $$5, jm<dex> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<eem.a> a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, int $$3, iz $$4, edw $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new eem.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, int $$3, edw $$4, List<eem.a> $$5, iz.a $$6, int $$7, je $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new eem.a($$16, 0, false));
         $$5.add(new eem.a($$16.c(2), 0, false));
      }
   }
