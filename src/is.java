...
public class is<T> {
   ...
   private final List<iz.b> b;
   private final iz.b c;

   public is(List<T> $$0) {
      this($$0, ac.a(() -> {
         iz.b[] $$1 = new iz.b[$$0.size()];
         Arrays.fill($$1, iz.b);
         return Arrays.asList($$1);
      }));
   }

   private is(List<T> $$0, List<iz.b> $$1) {
      this.a = List.copyOf($$0);
      this.b = List.copyOf($$1);
      this.c = new iz.c(a($$1.stream())).d();
   }
   ...
   private iz.b a(int $$0, int $$1) {
      return new iz.c(a(this.b.subList($$0, $$1).stream())).d();
   }

   public is<T> a(T $$0, iz.b... $$1) {
      return this.a($$0, Arrays.asList($$1));
   }

   public is<T> a(T $$0, List<iz.b> $$1) {
      int $$2 = this.d($$0);
      if ($$1.size() > this.b.size() - $$2) {
         throw new IllegalStateException("Too many values to replace");
      } else {
         List<iz.b> $$3 = new ArrayList<>();
