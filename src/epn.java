...
public class epn {
   ...
   public static Optional<eoj.b> a(
      eoj.a $$0, jq<ept> $$1, Optional<alz> $$2, int $$3, jh $$4, boolean $$5, Optional<edp.a> $$6, int $$7, epx $$8, epj $$9, erv $$10
   ) {
      ke $$11 = $$0.a();
      dzq $$12 = $$0.b();
      esm $$13 = $$0.e();
   ...
   private static Optional<jh> a(epr $$0, alz $$1, jh $$2, drb $$3, esm $$4, eeo $$5) {
   ...
   private static void a(eed $$0, int $$1, boolean $$2, dzq $$3, esm $$4, dhj $$5, bam $$6, kd<ept> $$7, eof $$8, List<eof> $$9, fcr $$10, epx $$11, erv $$12) {
   ...
   public static boolean a(ash $$0, jq<ept> $$1, alz $$2, int $$3, jh $$4, boolean $$5) {
      dzq $$6 = $$0.m().g();
      esm $$7 = $$0.r();
      did $$8 = $$0.b();
      bam $$9 = $$0.H_();
      eoj.a $$10 = new eoj.a($$0.K_(), $$6, $$6.d(), $$0.m().i(), $$7, $$0.D(), new dgn($$4), $$0, $$0x -> true);
   ...
   static final class b {
      private final kd<ept> a;
      private final int b;
      private final dzq c;
      private final esm d;
      private final List<? super eof> e;
      private final bam f;
      final bap<epn.a> g = new bap<>();

      b(kd<ept> $$0, int $$1, dzq $$2, esm $$3, List<? super eof> $$4, bam $$5) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
      ...
      void a(eof $$0, MutableObject<fcr> $$1, int $$2, boolean $$3, dhj $$4, eed $$5, epx $$6, erv $$7) {
         epr $$8 = $$0.b();
         jh $$9 = $$0.c();
         drb $$10 = $$0.a();
         ept.a $$11 = $$8.f();
         ...
         for (esl.a $$16 : $$8.a(this.d, $$9, $$10, this.f)) {
            ...
            aly<ept> $$23 = a($$16, $$6);
            Optional<? extends jq<ept>> $$24 = this.a.a($$23);
            if ($$24.isEmpty()) {
               epn.a.warn("Empty or non-existent pool: {}", $$23.a());
            } else {
               jq<ept> $$25 = (jq<ept>)$$24.get();
               if ($$25.a().b() == 0 && !$$25.a(rr.a)) {
                  ...
                  if ($$26.a().b() == 0 && !$$26.a(rr.a)) {
                     ...
                     for (epr $$32 : $$30) {
                        ...
                        for (drb $$33 : drb.b(this.f)) {
                           List<esl.a> $$34 = $$32.a(this.d, jh.c, $$33, this.f);
                           eob $$35 = $$32.a(this.d, jh.c, $$33);
                           int $$37;
                           if ($$3 && $$35.e() <= 16) {
                              $$37 = $$34.stream().mapToInt($$2x -> {
                                 esl.d $$3x = $$2x.a();
                                 if (!$$35.b($$3x.a().a(dop.o($$3x.b())))) {
                                    return 0;
                                 } else {
                                    aly<ept> $$4x = a($$2x, $$6);
                                    Optional<? extends jq<ept>> $$5x = this.a.a($$4x);
                                    Optional<jq<ept>> $$6x = $$5x.map($$0xx -> ((ept)$$0xx.a()).a());
                           ...
                           for (esl.a $$38 : $$34) {
                              if (dop.a($$16, $$38)) {
                                 ...
                                 int $$45 = $$39.v();
                                 int $$46 = $$21 - $$45 + dop.o($$17.b()).k();
                                 int $$47;
                                 if ($$12 && $$44) {
                                    $$47 = $$15 + $$46;
                                 } else {
                                    if ($$22 == Integer.MIN_VALUE) {
                                       $$22 = this.c.b($$19.u(), $$19.w(), edp.a.a, $$4, $$5);
                                    }
      ...
      private static aly<ept> a(esl.a $$0, epx $$1) {
