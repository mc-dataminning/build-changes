...
public class epn {
   ...
   public static List<epn.a> a(String $$0, epn.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<epn.a> a(String $$0, List<epn.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<epn.a> a(List<String> $$0, List<epn.b> $$1) {
      int $$2 = 0;
      List<epn.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<epn.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static epn.b a(String $$0, String $$1) {
         return new epn.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static epn.b a(String $$0) {
         return new epn.b($$0);
      }
   }
}
