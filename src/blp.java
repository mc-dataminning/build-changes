...
public abstract class blp extends bmt {
   private static final agm<Boolean> bT = agp.a(blp.class, ago.k);
   ...
   protected blp(bly<? extends blp> $$0, cto $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract blp a(and var1, blp var2);
   ...
   protected void m() {
      if (!this.o_() && this.bO() && this.cZ() instanceof chb $$0 && !$$0.a((blu)this)) {
         this.ac();
      }
   }
