...
public class dwb {
   ...
   private final Map<Character, Predicate<dvz>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dwb a(char $$0, Predicate<dvz> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dwa b() {
      return new dwa(this.c());
   }

   private Predicate<dvz>[][][] c() {
      this.d();
      Predicate<dvz>[][][] $$0 = (Predicate<dvz>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dvz>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
