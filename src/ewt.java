...
public class ewt {
   ...
   public static final baj b = ezh.q;
   ...
   public static final Codec<jr<ewt>> e = akq.a(mc.bi, d);
   private final baj g;
   private final Optional<aku> h;
   private final List<ews> i;
   private final List<eyc> j;
   private final BiFunction<cxh, ewo, cxh> k;

   ewt(baj $$0, Optional<aku> $$1, List<ews> $$2, List<eyc> $$3) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static Consumer<cxh> a(ard $$0, Consumer<cxh> $$1) {
      return $$2 -> {
         if ($$2.a($$0.K())) {
            if ($$2.M() < $$2.k()) {
               $$1.accept($$2);
   ...
   public void a(ewr $$0, Consumer<cxh> $$1) {
      this.a(new ewo.a($$0).a(this.h), $$1);
   }

   public void a(ewo $$0, Consumer<cxh> $$1) {
      ewo.c<?> $$2 = ewo.a(this);
      if ($$0.b($$2)) {
         Consumer<cxh> $$3 = eyc.a(this.k, $$1, $$0);
   ...
   public void a(ewr $$0, long $$1, Consumer<cxh> $$2) {
      this.a(new ewo.a($$0).a($$1).a(this.h), a($$0.a(), $$2));
   }

   public void b(ewr $$0, Consumer<cxh> $$1) {
      this.a($$0, a($$0.a(), $$1));
   }

   public void b(ewo $$0, Consumer<cxh> $$1) {
      this.a($$0, a($$0.d(), $$1));
   }

   public ObjectArrayList<cxh> a(ewr $$0, azh $$1) {
      return this.a(new ewo.a($$0).a($$1).a(this.h));
   }

   public ObjectArrayList<cxh> a(ewr $$0, long $$1) {
      return this.a(new ewo.a($$0).a($$1).a(this.h));
   }

   public ObjectArrayList<cxh> a(ewr $$0) {
      return this.a(new ewo.a($$0).a(this.h));
   }

   private ObjectArrayList<cxh> a(ewo $$0) {
      ObjectArrayList<cxh> $$1 = new ObjectArrayList();
      this.b($$0, $$1::add);
      return $$1;
   }
   ...
   public void a(bsr $$0, ewr $$1, long $$2) {
      ewo $$3 = new ewo.a($$1).a($$2).a(this.h);
      ObjectArrayList<cxh> $$4 = this.a($$3);
      azh $$5 = $$3.b();
   ...
   private void a(ObjectArrayList<cxh> $$0, int $$1, azh $$2) {
      List<cxh> $$3 = Lists.newArrayList();
      Iterator<cxh> $$4 = $$0.iterator();
      ...
      while ($$1 - $$0.size() - $$3.size() > 0 && !$$3.isEmpty()) {
         cxh $$6 = $$3.remove(ayz.a($$2, 0, $$3.size() - 1));
   ...
   private List<Integer> a(bsr $$0, azh $$1) {
   ...
   public static class a implements exy<ewt.a> {
      ...
      public ewt.a a(baj $$0) {
         this.c = $$0;
         return this;
      }

      public ewt.a a(aku $$0) {
