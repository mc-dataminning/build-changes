...
public class ewt {
   ...
   public Optional<iu> a(iu $$0, boolean $$1, ebg $$2) {
      cib $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cif.r), $$0, $$4, cib.b.c)
         .map(cic::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(eae.J))
   ...
   public Optional<l.a> a(iu $$0, ja.a $$1) {
      ...
      for (iu.a $$11 : iu.a($$0, 16, ja.f, ja.d)) {
         int $$12 = Math.min($$8, this.n.a(efn.a.e, $$11.u(), $$11.w()));
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new iu($$0.u() - $$2.j() * 1, azk.a($$0.v(), $$17, $$18), $$0.w() - $$2.l() * 1).j();
         $$4 = $$7.b($$4);
         ja $$19 = $$2.h();
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dlw.cv.m(), 3);
            }
         }
      }

      dzo $$26 = dlw.eq.m().b(drd.b, $$1);
