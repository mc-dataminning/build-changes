...
public class fsw implements epl, AutoCloseable {
   ...
   private final List<epr> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, epr> l = Maps.newHashMap();
   private final int m;
   ...
   public fsw(aqh $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, epo.a.a, $$6);
         this.t = a($$0, epo.a.b, $$7);
         this.m = epp.a();
         epp.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = epr.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static epm a(aqh $$0, epo.a $$1, String $$2) throws IOException {
      epo $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof epm)) {
   ...
   public static epk a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new epk();
      } else {
         int $$1 = 32774;
