...
public class fsw<T extends bfz, M extends fbs<T>, A extends fbs<T>> extends ftg<T, M> {
   ...
   private void a(eij $$0, fjx $$1, T $$2, bfo $$3, int $$4, A $$5) {
      cfz $$6 = $$2.c($$3);
      if ($$6.d() instanceof cdj $$7) {
         if ($$7.g() == $$3) {
            this.c().a($$5);
            this.a($$5, $$3);
            boolean $$9 = this.b($$3);
            if ($$7 instanceof cep $$10) {
               int $$11 = $$10.e_($$6);
            ...
            cib.a($$2.dI().B_(), $$6).ifPresent($$6x -> this.a($$7.d(), $$0, $$1, $$4, $$6x, $$5, $$9));
            if ($$6.B()) {
               this.a($$0, $$1, $$4, $$5);
            }
         }
