...
public class fsw {
   ...
   private final List<fph> k = Lists.newArrayList();
   private final List<fph.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fsw.a> o = new ArrayList<>();
   ...
   public void a(fsh $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fsh $$0, int $$1, int $$2, fpi.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fph.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == crg.c;
   }
   ...
   public void a(wy $$0) {
      this.a($$0, null, this.i.W() ? fpi.b() : fpi.a());
   }

   public void a(wy $$0, @Nullable xk $$1, @Nullable fpi $$2) {
      fph $$3 = new fph(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fph $$0) {
      ...
      List<ayy> $$3 = fta.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fph.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fsw.a b(xk $$0) {
      int $$1 = this.i.m.e();
      ListIterator<fph> $$2 = this.k.listIterator();
   ...
   private fph d(fph $$0) {
      return new fph($$0.b(), h, null, fpi.a());
   }
   ...
   private void n() {
      ...
      for (fph $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public fpi c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fph.a $$1, fpi $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fpi.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.z instanceof fxj;
   }
   ...
   public fsw.b k() {
      return new fsw.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fsw.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fph> $$0, List<String> $$1, List<fsw.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
