...
public class bzo extends bup implements bke<Optional<cht>>, bza {
   ...
   protected static final aee<ha> b = aeh.a(bzo.class, aeg.p);
   protected static final aee<Byte> c = aeh.a(bzo.class, aeg.a);
   protected static final aee<Byte> d = aeh.a(bzo.class, aeg.a);
   ...
   private static float G(float $$0) {
      return 0.5F - arw.a((0.5F + $$0) * (float) Math.PI) * 0.5F;
   }
   ...
   private boolean gg() {
      ...
      if (this.cd == $$0) {
         ...
         if (this.cd > $$0) {
            this.cd = arw.a(this.cd - 0.05F, $$0, 1.0F);
         } else {
            this.cd = arw.a(this.cd + 0.05F, 0.0F, $$0);
         }
   ...
   public static ehi a(ha $$0, float $$1) {
      return a($$0, -1.0F, $$1);
   }

   public static ehi a(ha $$0, float $$1, float $$2) {
   ...
   public void e(double $$0, double $$1, double $$2) {
      ...
      if (this.bN()) {
         ...
         super.e((double)arw.a($$0) + 0.5, (double)arw.a($$1 + 0.5), (double)arw.a($$2) + 0.5);
      }
   ...
   protected boolean t() {
      if (!this.fT() && this.bv()) {
         ...
         for (int $$1 = 0; $$1 < 5; $$1++) {
            gw $$2 = $$0.b(arw.b(this.ag, -8, 8), arw.b(this.ag, -8, 8), arw.b(this.ag, -8, 8));
            if ($$2.v() > this.dL().H_() && this.dL().t($$2) && this.dL().B_().a($$2) && this.dL().a(this, new ehi($$2).h(1.0E-6))) {
               ha $$3 = this.i($$2);
               if ($$3 != null) {
                  this.ae();
                  this.a($$3);
                  this.a(apd.vj, 1.0F, 1.0F);
   ...
   void b(int $$0) {
      if (!this.dL().B) {
         ...
         if ($$0 == 0) {
            this.a(bkm.i).c(bT);
            this.a(apd.vd, 1.0F, 1.0F);
            this.a(djt.j);
         } else {
            this.a(apd.vh, 1.0F, 1.0F);
            this.a(djt.k);
         }
      }
   ...
   public float E(float $$0) {
      return arw.i($$0, this.cc, this.cd);
   }
            ...
            if ($$0 != null) {
               ...
               if ($$1 < 400.0) {
                  if (this.b <= 0) {
                     ...
                     bzo.this.a(apd.vi, 2.0F, (bzo.this.ag.i() - bzo.this.ag.i()) * 0.2F + 1.0F);
                  }
               } else {
                  bzo.this.h(null);
               }
   ...
   class d extends bpd {
      ...
      protected Optional<Float> i() {
         ...
         return !(Math.abs($$8) > 1.0E-5F) && !(Math.abs($$9) > 1.0E-5F)
            ? Optional.empty()
            : Optional.of((float)(arw.d((double)(-$$8), (double)$$9) * 180.0F / (float)Math.PI));
      }
