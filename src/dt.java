...
public record dt(@Nullable Float c, @Nullable Float d) {
   public static final dt a = new dt(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(ws.c("argument.range.ints"));

   public static dt a(float $$0) {
      return new dt($$0, $$0);
   }

   public static dt a(float $$0, float $$1) {
      return new dt($$0, $$1);
   }

   public static dt b(float $$0) {
      return new dt($$0, null);
   }

   public static dt c(float $$0) {
      return new dt(null, $$0);
   }
   ...
   public static dt a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (axm.b($$0)) {
         float $$1 = axm.e($$0, "value");
         return new dt($$1, $$1);
      } else {
         JsonObject $$2 = axm.m($$0, "value");
         Float $$3 = $$2.has("min") ? axm.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? axm.m($$2, "max") : null;
         return new dt($$3, $$4);
      }
   }

   public static dt a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static dt a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         throw cs.a.createWithContext($$0);
      } else {
         int $$3 = $$0.getCursor();
         Float $$4 = a(b($$0, $$1), $$2);
         Float $$5;
