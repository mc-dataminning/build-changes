...
public class dt implements dw {
   ...
   public dt b(ehn $$0) {
      ...
      float $$6 = arx.g((float)(-(arx.d($$3, $$5) * 180.0F / (float)Math.PI)));
      float $$7 = arx.g((float)(arx.d($$4, $$2) * 180.0F / (float)Math.PI) - 90.0F);
   ...
   @Nullable
   public aks i() {
      return this.k instanceof aks $$0 ? $$0 : null;
   }
