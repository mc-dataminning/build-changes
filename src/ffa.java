...
public class ffa implements fev {
   protected static final fev a = new ffa(false, -Double.MAX_VALUE, czd.k, $$0 -> false, null) {
      @Override
      public boolean a(ffk $$0, iu $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected ffa(boolean $$0, double $$1, czd $$2, Predicate<ewo> $$3, @Nullable bwf $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected ffa(bwf $$0, boolean $$1) {
      ...
      // 38: pop
      // 39: invokedynamic test (Lbxe;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, bxe.a (Lewo;)Z, (Lewo;)Z ]
      // 3e: goto 46
      // 41: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, ffa.a (Lewo;)Z, (Lewo;)Z ]
      // 46: aload 1
      // 47: invokespecial ffa.<init> (ZDLczd;Ljava/util/function/Predicate;Lbwf;)V
      // 4a: return
   }
