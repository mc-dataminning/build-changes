...
public class ffa extends ffe {
   ...
   private static final aix<cwm> q = cwt.b;
   ...
   @Nullable
   private static dze a(ik<cyo> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, doo.c);
      int $$10 = $$9 - $$2;

      Optional<ij.c<cyo>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new dze($$10, $$11.get().a());
      }
   }

   private static List<dze> a(ik<cyo> $$0, String $$1) {
      List<dze> $$2 = Lists.newArrayList();
      String[] $$3 = $$1.split(",");
      int $$4 = 0;
   ...
   public static dzh a(ik<cyo> $$0, ik<cwm> $$1, ik<ebk> $$2, ik<eai> $$3, String $$4, dzh $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return dzh.a($$1, $$2, $$3);
      } else {
         List<dze> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return dzh.a($$1, $$2, $$3);
         } else {
            ij.c<cwm> $$8 = $$1.b(q);
   ...
   protected void aQ_() {
      ...
      this.x = new ezq(this.i, 50, 40, this.g - 100, 20, this.t);
      this.x.f(1230);
      fkc $$0 = this.r.a.o().k();
      iw $$1 = $$0.a();
      cjs $$2 = $$0.g().b();
      ...
      ik<ebk> $$4 = $$1.b(kg.aF);
      ik<eai> $$5 = $$1.b(kg.aC);
      ik<cyo> $$6 = $$1.b(kg.f).a($$2);
      this.x.a(a(this.r.n()));
      this.y = this.r.n();
      this.e(this.x);
      this.v = this.d(new ffa.a($$1, $$2));
      this.w = this.d(ezh.a(vq.c("createWorld.customize.presets.select"), $$4x -> {
         dzh $$5x = a($$6, $$3, $$4, $$5, this.x.a(), this.y);
         this.r.a($$5x);
         this.f.a(this.r);
      }).a(this.g / 2 - 155, this.h - 28, 150, 20).a());
      this.d(ezh.a(vp.e, $$0x -> this.f.a(this.r)).a(this.g / 2 + 5, this.h - 28, 150, 20).a());
   ...
   class a extends fad<ffa.a.a> {
      public a(iw $$0, cjs $$1) {
         super(ffa.this.f, ffa.this.g, ffa.this.h - 117, 80, 24);

         for (ij<dzf> $$2 : $$0.d(kg.az).c(aud.a)) {
            Set<cyo> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               ffa.c
                  .info(
               ...
               this.b(new ffa.a.a($$2));
            }
         }
      }

      public void a(@Nullable ffa.a.a $$0) {
         super.a($$0);
         ffa.this.c($$0 != null);
      }
      ...
      public class a extends fad.a<ffa.a.a> {
         ...
         public a(ij<dzf> $$1) {
            this.c = $$1.a();
            this.d = $$1.e().map($$0x -> vq.c($$0x.a().f("flat_world_preset"))).orElse(ffa.a);
         }

         @Override
         public void a(eyu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            this.a($$0, $$3, $$2, this.c.a().a());
            $$0.a(ffa.this.i, this.d, $$3 + 18 + 5, $$2 + 6, 16777215, false);
         }
         ...
         void b() {
            a.this.a(this);
            ffa.this.y = this.c.b();
            ffa.this.x.a(ffa.a(ffa.this.y));
            ffa.this.x.b(false);
         }

         private void a(eyu $$0, int $$1, int $$2, cou $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new coz($$3), $$1 + 2, $$2 + 2);
         }

         private void a(eyu $$0, int $$1, int $$2) {
            $$0.a(ffa.b, $$1, $$2, 0, 18, 18);
         }
