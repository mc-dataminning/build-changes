...
public class ffa extends ffc {
   ...
   static final ffa.b l = new ffa.b(854, 480);
   ...
   static enum a {
      ...
      private static final ffa.a[] e = values();
   ...
   static class b {
      ...
      static List<ffa.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ffa.b($$0, $$1), ffa.l) : ImmutableList.of(ffa.l);
      }
