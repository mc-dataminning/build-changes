...
public class ffa extends fes<cjc> implements fgv {
   private float x;
   private float y;
   private final fgp z = new fgp();
   private boolean A;
   private boolean B;
   ...
   public void D() {
      if (this.f.q.g()) {
         this.f.a(new fep(this.f.s, this.f.s.cn.y(), this.f.m.G().c()));
      } else {
         this.z.g();
      }
   }
   ...
   protected void aN_() {
      if (this.f.q.g()) {
         ...
         this.d(new exs(this.t + 104, this.h / 2 - 22, 20, 18, fgp.a, $$0 -> {
            this.z.e();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(ewu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bml $$9) {
   ...
   public static void a(ewu $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bml $$7) {
      $$0.c().a();
