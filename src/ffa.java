...
public class ffa {
   ...
   public static List<ffa.a> a(String $$0, ffa.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<ffa.a> a(String $$0, List<ffa.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<ffa.a> a(List<String> $$0, List<ffa.b> $$1) {
      int $$2 = 0;
      List<ffa.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<ffa.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static ffa.b a(String $$0, String $$1) {
         return new ffa.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static ffa.b a(String $$0) {
         return new ffa.b($$0);
      }
   }
}
