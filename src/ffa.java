...
public class ffa {
   private static final Map<String, ffa.a> a = Maps.newHashMap();
   ...
   private static akr b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            akr $$4 = gpz.b();
            a.put($$0, new ffa.a($$1, $$4));
            return $$4;
         } else {
            akr $$5 = akr.a("realms", "dynamic/" + $$0);
            fgm.Q().aa().a($$5, new gpw($$3));
            a.put($$0, new ffa.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static fah a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return fah.a($$2.put($$1).flip());
