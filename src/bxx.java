...
public abstract class bxx extends bii {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<bii> b = $$0 -> $$0 instanceof bxx;
   private int f;
   protected gu c;
   protected ha d;

   protected bxx(bim<? extends bxx> $$0, cpl $$1) {
      super($$0, $$1);
      this.d = ha.d;
   }

   protected bxx(bim<? extends bxx> $$0, cpl $$1, gu $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void s() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new egy($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable bii var1);
