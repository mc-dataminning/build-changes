...
public class axx {
   ...
   axx(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static axx.a a() {
      return new axx.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(axx::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public axx.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public axx a(Writer $$0) throws IOException {
         return new axx($$0, this.a);
      }
   }
}
