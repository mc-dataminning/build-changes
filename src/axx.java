...
public class axx<T> extends AbstractList<T> implements azg<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axx.this.get(this.b--);
      }

      @Override
      public void remove() {
         axx.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azg<T> {
      private final axx<T> b;

      public b(final axx<T> $$0) {
         this.b = $$0;
      }
