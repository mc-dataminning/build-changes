...
public class nt implements lw {
   ...
   public CompletableFuture<?> a(lu $$0) {
      ...
      Consumer<cuk> $$6 = $$4::add;
      new nr($$2, $$5, $$6).a();
      new ns($$5).a();
      List<dez> $$7 = lp.e.g().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
