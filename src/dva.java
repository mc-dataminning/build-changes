...
public class dva extends duu<dwz> {
   private static final ih[] a = ih.values();

   public dva(Codec<dwz> $$0) {
      super($$0);
   }

   @Override
   public boolean a(duw<dwz> $$0) {
      dwz $$1 = $$0.f();
      awt $$2 = $$0.d();
      ib $$3 = $$0.e();
      cwz $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dsp $$9 = new dsp(new drr($$4.C()));
      egu $$10 = egu.a($$9, -4, 1.0);
      ...
      for (ib $$33 : ib.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<ib, Integer> $$37 : $$7) {
            $$35 += awm.f($$33.j((jf)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (ib $$38 : $$11) {
            $$36 += awm.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, czh.a.o(), $$32);
      ...
      for (ib $$44 : $$31) {
         ...
         for (ih $$46 : a) {
            ...
            dme $$48 = $$4.a_($$47);
            if ($$45.b(dmu.C)) {
               $$45 = $$45.a(dmu.C, Boolean.valueOf($$48.u().b()));
            }
