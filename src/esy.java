...
public class esy {
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cpv $$16 = this.p();
         LongSet $$17 = (LongSet)($$16 instanceof akr ? ((akr)$$16).u() : LongSets.EMPTY_SET);
         ...
         $$18.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$9, $$14, arx.g($$8.dB()), arx.g($$8.dD())));
         dhq $$20 = this.r();
         if ($$20.C()) {
   ...
   private static String a(hg<cqt> $$0) {
