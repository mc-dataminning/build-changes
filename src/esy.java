...
public class esy extends esa {
   ...
   public esy(ert $$0, int $$1, int $$2, int $$3, int $$4, tf $$5, tf $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new etb($$0, $$3 - this.b());
      this.o.a(this::w);
   }
   ...
   @Override
   public void a(evy $$0) {
      $$0.a(evx.a, tf.a("gui.narrate.editBox", this.m(), this.v()));
   }
   ...
   protected void a(erv $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         tf $$2 = tf.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void w() {
      double $$0 = this.c();
      etb.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         etb.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
