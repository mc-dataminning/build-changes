...
public class esy extends etc implements eta {
   ...
   public esy.c a() {
      return new esy.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, eti.a $$1) {
   ...
   private esy.b q() {
      ...
      this.k += $$5;
      this.j++;
      esy.a $$9 = new esy.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new esy.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eti.b.a || this.q == eti.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<etj> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      etj $$1 = (etj)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == etj.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == etj.b.c) {
         eta.super.a(this.b, this.c, this.d, this.e);
      }
   }

   @Override
   public eth a(int $$0, int $$1, int $$2, int $$3) {
      if (this.a) {
         throw new IllegalStateException();
      } else {
         return eta.super.a($$0, $$1, $$2, $$3);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, eta.a($$11));
         this.a($$14 + 5, eta.a($$12));
         this.a($$14 + 6, eta.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eti a, int b, int c, eti.b d, eti.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eti.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable etl $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
