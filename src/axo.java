...
public enum axo {
   ...
   public <A> Codec<A> a(final Codec<A> $$0, final DataFixer $$1, final int $$2) {
      return new Codec<A>() {
         public <T> DataResult<T> encode(A $$0x, DynamicOps<T> $$1x, T $$2x) {
            return $$0.encode($$0, $$1, $$2).flatMap($$1xxx -> $$1.mergeToMap($$1xxx, $$1.createString("DataVersion"), $$1.createInt(axo.a())));
         }
   ...
   public sw a(DataFixer $$0, sw $$1, int $$2, int $$3) {
      return (sw)this.a($$0, new Dynamic(tk.a, $$1), $$2, $$3).getValue();
   }

   public sw a(DataFixer $$0, sw $$1, int $$2) {
      return this.a($$0, $$1, $$2, a());
   }
