...
public class jg<T> {
   ...
   public static class a {
      private final Map<ald<? extends kb<?>>, jg<?>> a = new HashMap<>();

      public <T> jg.a a(ald<? extends kb<? extends T>> $$0, Codec<T> $$1) {
         this.a.put($$0, new jg($$1));
         return this;
      }

      @Nullable
      public <T> jg<T> a(ald<? extends kb<? extends T>> $$0) {
         return (jg<T>)this.a.get($$0);
      }
   }
}
