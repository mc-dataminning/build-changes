...
public class hfx {
   ...
   public static class a extends Thread {
      private final hfx.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hfx.b $$0) throws IOException {
         super("LanServerDetector #" + hfx.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hfx.b));
   ...
   public static class b {
      private final List<hfw> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hfw> a() {
         if (this.b) {
            List<hfw> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
