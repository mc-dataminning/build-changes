...
public class cow implements bsc, bsm {
   ...
   public int a(Predicate<cwp> $$0, int $$1, bsc $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
   ...
   public cwp a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).f() ? bsd.a($$2, $$0, $$1) : cwp.j;
   }
   ...
   public void b(tw $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         tq $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cwp $$4 = cwp.a(this.k.dY(), (un)$$2).orElse(cwp.j);
