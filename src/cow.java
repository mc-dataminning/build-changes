...
public abstract class cow extends cov implements coz {
   private jr<cur> c = jr.a(36, cur.l);
   @Nullable
   private ale<eqp> d;
   private long e;

   protected cow(btc<?> $$0, dca $$1) {
      super($$0, $$1);
   }

   protected cow(btc<?> $$0, double $$1, double $$2, double $$3, dca $$4) {
      super($$0, $$4, $$1, $$2, $$3);
   }
