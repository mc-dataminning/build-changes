...
public class ezj {
   ...
   public static final ezj.a bv;

   public static ezj.a a(int $$0, int $$1) {
      return $$0 == -1 ? ezj.b.b.a($$1) : ezj.b.a.a($$0);
   }

   public static ezj.a a(String $$0) {
      if (ezj.a.e.containsKey($$0)) {
         return ezj.a.e.get($$0);
      } else {
         for (ezj.b $$1 : ezj.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ezj.b b;
      private final int c;
      private final aya<wu> d;
      static final Map<String, ezj.a> e = Maps.newHashMap();

      a(String $$0, ezj.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new aya<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<ezj.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wu> g;

      private static void a(ezj.b $$0, String $$1, int $$2) {
         ezj.a $$3 = new ezj.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ezj.a a(int $$0) {
         return (ezj.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
