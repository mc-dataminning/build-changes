...
public class ezj {
   public static List<fal> a(ezj.a... $$0) {
      for (ezj.a $$1 : $$0) {
         a($$1.j);
      }

      List<fal> $$2 = Lists.newArrayList();

      for (ezj.a $$3 : $$0) {
         $$2.add(new fal($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fal::a));
      return $$2;
   }
   ...
   public static List<fal> a() {
      return a(ezj.a.values());
   }
