...
public class ezj {
   ...
   public static ezm a(BooleanConsumer $$0, BanDetails $$1) {
      return new ezm($$0, a($$1), b($$1), "https://aka.ms/mcjavamoderation", uq.m, true);
   }

   public static ezm a(Runnable $$0) {
   ...
   public static ezm a(String $$0, Runnable $$1) {
