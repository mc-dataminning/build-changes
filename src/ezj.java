public class ezj extends eyx<cet> implements fbr {
   private static final aer x = new aer("textures/gui/container/crafting_table.png");
   private final fbl y = new fbl();
   private boolean z;

   public ezj(cet $$0, cbm $$1, tf $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aE_() {
      ...
      this.d(new est(this.t + 5, this.h / 2 - 49, 20, 18, fbl.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
