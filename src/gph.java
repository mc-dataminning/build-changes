...
public class gph implements gpj.a {
   final fme a;
   ...
   public void a(fgq $$0, glj $$1, double $$2, double $$3, double $$4) {
      ...
      if (this.d != null) {
         ...
         for (Entry<dgn, String> $$9 : this.d.a.entrySet()) {
            ...
            for (String $$14 : $$12) {
               gpj.a($$0, $$1, $$14, (double)kj.a($$10.g, 8), $$8 + (double)$$13, (double)kj.a($$10.h, 8), -1, 0.15F, true, 0.0F, true);
               $$13 -= 2;
            }
         }
      }
   ...
   final class a {
      ...
      a(final hfu $$0, final double $$1, final double $$2) {
         gfi $$3 = gph.this.a.s;
         aly<dhh> $$4 = $$3.ah();
         int $$5 = kj.a($$1);
         int $$6 = kj.a($$2);
