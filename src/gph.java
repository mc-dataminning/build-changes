...
public class gph implements asw<gpg> {
   public gpg b(JsonObject $$0) {
      Builder<gpf> $$1 = ImmutableList.builder();
      int $$2 = axv.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = axv.a($$0, "width", -1);
      int $$9 = axv.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = axv.a($$0, "interpolate", false);
   ...
   private gpf a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gpf(axv.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = axv.m($$1, "frames[" + $$0 + "]");
         int $$3 = axv.a($$2, "time", -1);
         if ($$2.has("time")) {
