...
public abstract class buo extends cfh implements btz {
   protected static final akk<Byte> bY = ako.a(buo.class, akm.a);
   protected static final akk<Optional<UUID>> bZ = ako.a(buo.class, akm.r);
   private boolean cb;

   protected buo(btc<? extends buo> $$0, dca $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(brp $$0) {
      if (!this.dP().B && this.dP().ab().b(dbw.n) && this.P_() instanceof arg) {
         this.P_().a(this.eP().a());
      }
