...
public class bnb implements Comparable<bnb> {
   ...
   @Nullable
   private bnb p;
   private final bnb.a q = new bnb.a();

   public bnb(ij<bmz> $$0) {
      this($$0, 0, 0);
   }

   public bnb(ij<bmz> $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bnb(ij<bmz> $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bnb(ij<bmz> $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bnb(ij<bmz> $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null);
   }

   public bnb(ij<bmz> $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bnb $$6) {
      this.j = $$0;
      this.k = $$1;
      this.l = $$2;
      this.m = $$3;
   ...
   public boolean a(bog $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bnb $$1) ? false : this.k == $$1.k && this.l == $$1.l && this.m == $$1.m && this.j.equals($$1.j);
      }
   }
   ...
   @Nullable
   public static bnb b(sw $$0) {
      aiy $$1 = aiy.a($$0.l("id"));
      return $$1 == null ? null : kf.d.c($$1).map($$1x -> a($$1x, $$0)).orElse(null);
   }

   private static bnb a(ij<bmz> $$0, sw $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      return new bnb($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7);
   }
      ...
      public void b(bnb $$0) {
         ...
         if ($$1 == 0) {
            ...
            if (this.a != $$2) {
               ...
               this.a = this.a + awh.a($$2 - this.a, -$$3, $$3);
            }
         }
      }

      private static float c(bnb $$0) {
         boolean $$1 = !$$0.a(d($$0));
         return $$1 ? 1.0F : 0.0F;
      }

      private static int d(bnb $$0) {
         return $$0.b().a().b();
      }
