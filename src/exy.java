...
public class exy {
   ...
   public void a(exy.b $$0, List<aqp> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new exy.c($$0, $$1.stream().map(aqp::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new exy.c(exy.b.c, ImmutableList.of());
      }

      this.b.c = new exy.a($$0);
   }
   ...
   static class c {
      private final exy.b a;
      private final List<String> b;
      @Nullable
      exy.a c;
      boolean d;

      c(exy.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
