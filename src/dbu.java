...
public class dbu {
   public static final dbu a = new dbu(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<dbu> b = RecordCodecBuilder.create(
   ...
   public dbu(List<String> $$0, List<String> $$1) {
