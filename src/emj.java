...
public class emj {
   ...
   private static final emj.f[] g = new emj.f[]{
      new emj.f(emj.n.class, 40, 0),
      new emj.f(emj.h.class, 5, 5),
      new emj.f(emj.d.class, 20, 0),
      new emj.f(emj.i.class, 20, 0),
      new emj.f(emj.j.class, 10, 6),
      new emj.f(emj.o.class, 5, 5),
      new emj.f(emj.l.class, 5, 5),
      new emj.f(emj.c.class, 5, 4),
      new emj.f(emj.a.class, 5, 4),
      new emj.f(emj.e.class, 10, 2) {
         @Override
         public boolean a(int $$0) {
            return super.a($$0) && $$0 > 4;
         }
      },
      new emj.f(emj.g.class, 20, 1) {
         @Override
         public boolean a(int $$0) {
   ...
   private static List<emj.f> h;
   static Class<? extends emj.p> i;
   private static int j;
   static final emj.k k = new emj.k();
   ...
   private static emj.p a(Class<? extends emj.p> $$0, ejw $$1, ayw $$2, int $$3, int $$4, int $$5, @Nullable ji $$6, int $$7) {
      emj.p $$8 = null;
      if ($$0 == emj.n.class) {
         $$8 = emj.n.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.h.class) {
         $$8 = emj.h.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.d.class) {
         $$8 = emj.d.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.i.class) {
         $$8 = emj.i.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.j.class) {
         $$8 = emj.j.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.o.class) {
         $$8 = emj.o.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.l.class) {
         $$8 = emj.l.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.c.class) {
         $$8 = emj.c.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.a.class) {
         $$8 = emj.a.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.e.class) {
         $$8 = emj.e.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      } else if ($$0 == emj.g.class) {
         $$8 = emj.g.a($$1, $$3, $$4, $$5, $$6, $$7);
      }

      return $$8;
   }

   private static emj.p a(emj.m $$0, ejw $$1, ayw $$2, int $$3, int $$4, int $$5, ji $$6, int $$7) {
      if (!b()) {
         return null;
      } else {
         if (i != null) {
            emj.p $$8 = a(i, $$1, $$2, $$3, $$4, $$5, $$6, $$7);
            i = null;
            if ($$8 != null) {
               return $$8;
            }
         ...
         ejj $$13 = emj.b.a($$1, $$2, $$3, $$4, $$5, $$6);
         return $$13 != null && $$13.i() > 1 ? new emj.b($$7, $$13, $$6) : null;
      }
   }

   static ejv b(emj.m $$0, ejw $$1, ayw $$2, int $$3, int $$4, int $$5, @Nullable ji $$6, int $$7) {
      if ($$7 > 50) {
         return null;
      } else if (Math.abs($$3 - $$0.f().h()) <= 112 && Math.abs($$5 - $$0.f().j()) <= 112) {
         ejv $$8 = a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7 + 1);
         if ($$8 != null) {
            $$1.a($$8);
            $$0.c.add($$8);
         }
   ...
   public static class a extends emj.p {
      private static final int a = 5;
      private static final int b = 5;
      private static final int c = 7;
      private boolean d;

      public a(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.t, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
      }
      ...
      public void a(ejv $$0, ejw $$1, ayw $$2) {
         this.a((emj.m)$$0, $$1, $$2, 1, 1);
      }

      public static emj.a a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, 7, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.a($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 4, 4, 6, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 1, 1, 0);
         this.a($$0, $$3, $$4, emj.p.a.a, 1, 1, 6);
         ...
         if (!this.d && $$4.b(this.b(3, 2, 3))) {
            this.d = true;
            this.a($$0, $$4, $$3, 3, 2, 3, ern.y);
         }
      }
   }

   public static class b extends emj.p {
      private final int a;

      public b(int $$0, ejj $$1, ji $$2) {
         super(eki.u, $$0, $$1);
         this.a($$2);
      ...
      public static ejj a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5) {
         int $$6 = 3;
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, 4, $$5);
         ejv $$8 = $$0.a($$7);
         if ($$8 == null) {
            return null;
         } else {
            if ($$8.f().i() == $$7.i()) {
               for (int $$9 = 2; $$9 >= 1; $$9--) {
                  $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, $$9, $$5);
                  if (!$$8.f().a($$7)) {
                     return ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, $$9 + 1, $$5);
                  }
               }
            }
   ...
   public static class c extends emj.p {
      ...
      public void a(ejv $$0, ejw $$1, ayw $$2) {
         ...
         this.a((emj.m)$$0, $$1, $$2, 5, 1);
         if (this.d) {
            this.b((emj.m)$$0, $$1, $$2, $$3, 1);
         }

         if (this.i) {
            this.b((emj.m)$$0, $$1, $$2, $$4, 7);
         }

         if (this.j) {
            this.c((emj.m)$$0, $$1, $$2, $$3, 1);
         }

         if (this.k) {
            this.c((emj.m)$$0, $$1, $$2, $$4, 7);
         }
      }

      public static emj.c a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -4, -3, 0, 10, 9, 11, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.c($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 9, 8, 10, true, $$3, emj.k);
         ...
         this.a($$0, $$4, 1, 2, 1, 8, 2, 6, false, $$3, emj.k);
         this.a($$0, $$4, 4, 1, 5, 4, 4, 9, false, $$3, emj.k);
         this.a($$0, $$4, 8, 1, 5, 8, 4, 9, false, $$3, emj.k);
         this.a($$0, $$4, 1, 4, 7, 3, 4, 9, false, $$3, emj.k);
         this.a($$0, $$4, 1, 3, 5, 3, 3, 6, false, $$3, emj.k);
         this.a($$0, $$4, 1, 3, 4, 3, 3, 4, dga.jE.o(), dga.jE.o(), false);
         this.a($$0, $$4, 1, 4, 6, 3, 4, 6, dga.jE.o(), dga.jE.o(), false);
         this.a($$0, $$4, 5, 1, 7, 7, 1, 8, false, $$3, emj.k);
   ...
   public static class d extends emj.q {
      public d(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.w, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
      }
      ...
      public void a(ejv $$0, ejw $$1, ayw $$2) {
         ji $$3 = this.i();
         if ($$3 != ji.c && $$3 != ji.f) {
            this.c((emj.m)$$0, $$1, $$2, 1, 1);
         } else {
            this.b((emj.m)$$0, $$1, $$2, 1, 1);
         }
      }

      public static emj.d a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, 5, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.d($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 4, 4, 4, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 1, 1, 0);
         ji $$7 = this.i();
         if ($$7 != ji.c && $$7 != ji.f) {
   ...
   public static class e extends emj.p {
      ...
      public e(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.x, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
         this.i = $$2.e() > 6;
      ...
      public static emj.e a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -4, -1, 0, 14, 11, 15, $$5);
         if (!a($$7) || $$0.a($$7) != null) {
            $$7 = ejj.a($$2, $$3, $$4, -4, -1, 0, 14, 6, 15, $$5);
            if (!a($$7) || $$0.a($$7) != null) {
               return null;
            }
         }

         return new emj.e($$6, $$1, $$7, $$5);
      }
      ...
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         ...
         this.a($$0, $$4, 0, 0, 0, 13, $$7 - 1, 14, true, $$3, emj.k);
         ...
         this.a($$0, $$4, $$3, 3, 3, 5, ern.w);
         if (this.i) {
            this.a($$0, e, 12, 9, 1, $$4);
            this.a($$0, $$4, $$3, 12, 8, 1, ern.w);
         }
      }
   }

   static class f {
      public final Class<? extends emj.p> a;
      public final int b;
      public int c;
      public final int d;

      public f(Class<? extends emj.p> $$0, int $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.d = $$2;
      }
   ...
   public static class g extends emj.p {
      ...
      public static emj.g a(ejw $$0, int $$1, int $$2, int $$3, ji $$4, int $$5) {
         ejj $$6 = ejj.a($$1, $$2, $$3, -4, -1, 0, 11, 8, 16, $$4);
         return a($$6) && $$0.a($$6) == null ? new emj.g($$5, $$6, $$4) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 10, 7, 15, false, $$3, emj.k);
         this.a($$0, $$3, $$4, emj.p.a.c, 4, 1, 0);
         int $$7 = 6;
         this.a($$0, $$4, 1, 6, 1, 1, 6, 14, false, $$3, emj.k);
         this.a($$0, $$4, 9, 6, 1, 9, 6, 14, false, $$3, emj.k);
         this.a($$0, $$4, 2, 6, 1, 8, 6, 2, false, $$3, emj.k);
         this.a($$0, $$4, 2, 6, 14, 8, 6, 14, false, $$3, emj.k);
         this.a($$0, $$4, 1, 1, 1, 2, 1, 4, false, $$3, emj.k);
         this.a($$0, $$4, 8, 1, 1, 9, 1, 4, false, $$3, emj.k);
         this.a($$0, $$4, 1, 1, 1, 1, 1, 3, dga.H.o(), dga.H.o(), false);
         this.a($$0, $$4, 9, 1, 1, 9, 1, 3, dga.H.o(), dga.H.o(), false);
         this.a($$0, $$4, 3, 1, 8, 7, 1, 12, false, $$3, emj.k);
         ...
         this.a($$0, $$4, 4, 1, 5, 6, 1, 7, false, $$3, emj.k);
         this.a($$0, $$4, 4, 2, 6, 6, 2, 7, false, $$3, emj.k);
         this.a($$0, $$4, 4, 3, 7, 6, 3, 7, false, $$3, emj.k);
   ...
   public static class h extends emj.p {
      ...
      public static emj.h a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 9, 5, 11, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.h($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 8, 4, 10, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 1, 1, 0);
         this.a($$0, $$4, 1, 1, 10, 3, 3, 10, e, e, false);
         this.a($$0, $$4, 4, 1, 1, 4, 3, 1, false, $$3, emj.k);
         this.a($$0, $$4, 4, 1, 3, 4, 3, 3, false, $$3, emj.k);
         this.a($$0, $$4, 4, 1, 7, 4, 3, 7, false, $$3, emj.k);
         this.a($$0, $$4, 4, 1, 9, 4, 3, 9, false, $$3, emj.k);
   ...
   public static class i extends emj.q {
      public i(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.A, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
      }
      ...
      public static emj.i a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, 5, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.i($$6, $$1, $$7, $$5) : null;
      }
   ...
   public static class j extends emj.p {
      protected static final int a = 11;
      ...
      @Override
      public void a(ejv $$0, ejw $$1, ayw $$2) {
         this.a((emj.m)$$0, $$1, $$2, 4, 1);
         this.b((emj.m)$$0, $$1, $$2, 1, 4);
         this.c((emj.m)$$0, $$1, $$2, 1, 4);
      }

      public static emj.j a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -4, -1, 0, 11, 7, 11, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.j($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 10, 6, 10, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 4, 1, 0);
         ...
         switch (this.d) {
            ...
            case 2:
               ...
               this.a($$0, $$12, 9, 2, 3, $$4);
               this.a($$0, $$12, 9, 3, 3, $$4);
               this.a($$0, $$4, $$3, 3, 4, 8, ern.x);
         }
      }
   }

   static class k extends ejv.a {
      @Override
   ...
   public static class l extends emj.p {
      private static final int a = 5;
      private static final int b = 11;
      private static final int c = 5;
      private final boolean d;

      public l(eki $$0, int $$1, int $$2, int $$3, ji $$4) {
      ...
      public l(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.C, $$0, $$2);
         this.d = false;
         this.a($$3);
         this.h = this.b($$1);
      ...
      public static emj.l a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -7, 0, 5, 11, 5, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.l($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 4, 10, 4, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 1, 7, 0);
         this.a($$0, $$3, $$4, emj.p.a.a, 1, 1, 4);
   ...
   public static class m extends emj.l {
      public emj.f a;
      @Nullable
      public emj.g b;
      public final List<ejv> c = Lists.newArrayList();

      public m(ayw $$0, int $$1, int $$2) {
         super(eki.D, 0, $$1, $$2, a($$0));
      }
   ...
   public static class n extends emj.p {
      private static final int a = 5;
      private static final int b = 5;
      private static final int c = 7;
      private final boolean d;
      ...
      public n(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.E, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
         this.d = $$1.a(2) == 0;
      ...
      public void a(ejv $$0, ejw $$1, ayw $$2) {
         this.a((emj.m)$$0, $$1, $$2, 1, 1);
         if (this.d) {
            this.b((emj.m)$$0, $$1, $$2, 1, 2);
         }

         if (this.i) {
            this.c((emj.m)$$0, $$1, $$2, 1, 2);
         }
      }

      public static emj.n a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -1, 0, 5, 5, 7, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.n($$6, $$1, $$7, $$5) : null;
      }
   ...
   public static class o extends emj.p {
      private static final int a = 5;
      private static final int b = 11;
      private static final int c = 8;

      public o(int $$0, ayw $$1, ejj $$2, ji $$3) {
         super(eki.F, $$0, $$2);
         this.a($$3);
         this.h = this.b($$1);
      }
      ...
      public static emj.o a(ejw $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5, int $$6) {
         ejj $$7 = ejj.a($$2, $$3, $$4, -1, -7, 0, 5, 11, 8, $$5);
         return a($$7) && $$0.a($$7) == null ? new emj.o($$6, $$1, $$7, $$5) : null;
      }

      @Override
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejj $$4, dcd $$5, jd $$6) {
         this.a($$0, $$4, 0, 0, 0, 4, 10, 7, true, $$3, emj.k);
         this.a($$0, $$3, $$4, this.h, 1, 7, 0);
         this.a($$0, $$3, $$4, emj.p.a.a, 1, 1, 7);
   ...
   abstract static class p extends ejv {
      protected emj.p.a h = emj.p.a.a;

      protected p(eki $$0, int $$1, ejj $$2) {
         super($$0, $$1, $$2);
      }

      public p(eki $$0, ub $$1) {
         super($$0, $$1);
         this.h = emj.p.a.valueOf($$1.l("EntryDoor"));
      }
      ...
      protected void a(dds $$0, ayw $$1, ejj $$2, emj.p.a $$3, int $$4, int $$5, int $$6) {
         switch ($$3) {
            case a:
      ...
      @Nullable
      protected ejv a(emj.m $$0, ejw $$1, ayw $$2, int $$3, int $$4) {
         ji $$5 = this.i();
         if ($$5 != null) {
            switch ($$5) {
               case c:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$3, this.f.i() + $$4, this.f.j() - 1, $$5, this.g());
               case d:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$3, this.f.i() + $$4, this.f.m() + 1, $$5, this.g());
               case e:
                  return emj.b($$0, $$1, $$2, this.f.h() - 1, this.f.i() + $$4, this.f.j() + $$3, $$5, this.g());
               case f:
                  return emj.b($$0, $$1, $$2, this.f.k() + 1, this.f.i() + $$4, this.f.j() + $$3, $$5, this.g());
            }
         }
      ...
      @Nullable
      protected ejv b(emj.m $$0, ejw $$1, ayw $$2, int $$3, int $$4) {
         ji $$5 = this.i();
         if ($$5 != null) {
            switch ($$5) {
               case c:
                  return emj.b($$0, $$1, $$2, this.f.h() - 1, this.f.i() + $$3, this.f.j() + $$4, ji.e, this.g());
               case d:
                  return emj.b($$0, $$1, $$2, this.f.h() - 1, this.f.i() + $$3, this.f.j() + $$4, ji.e, this.g());
               case e:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$4, this.f.i() + $$3, this.f.j() - 1, ji.c, this.g());
               case f:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$4, this.f.i() + $$3, this.f.j() - 1, ji.c, this.g());
            }
         }
      ...
      @Nullable
      protected ejv c(emj.m $$0, ejw $$1, ayw $$2, int $$3, int $$4) {
         ji $$5 = this.i();
         if ($$5 != null) {
            switch ($$5) {
               case c:
                  return emj.b($$0, $$1, $$2, this.f.k() + 1, this.f.i() + $$3, this.f.j() + $$4, ji.f, this.g());
               case d:
                  return emj.b($$0, $$1, $$2, this.f.k() + 1, this.f.i() + $$3, this.f.j() + $$4, ji.f, this.g());
               case e:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$4, this.f.i() + $$3, this.f.m() + 1, ji.d, this.g());
               case f:
                  return emj.b($$0, $$1, $$2, this.f.h() + $$4, this.f.i() + $$3, this.f.m() + 1, ji.d, this.g());
            }
         }
   ...
   public abstract static class q extends emj.p {
      protected static final int a = 5;
      protected static final int b = 5;
      protected static final int c = 5;

      protected q(eki $$0, int $$1, ejj $$2) {
         super($$0, $$1, $$2);
      }
