...
public class vs extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<uu> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, ug.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<uu> $$0, Codec<T> $$1, ug $$2) {
      uu $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vs a(DynamicOps<uu> $$0, Codec<T> $$1, T $$2) {
      uu $$3 = (uu)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yv<? super vs, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yw<? super vs, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yv<? super vs, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yv<? super vs, K> $$1, yv<? super vs, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yv<? super vs, K> $$0, yv<? super vs, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yw<? super vs, K> $$1, yw<? super vs, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yw<? super vs, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yv<? super vs, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yv<? super vs, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yv<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yw<? super vs, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yw<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static dhw c(ByteBuf $$0) {
      return new dhw($$0.readLong());
   }

   public static void a(ByteBuf $$0, dhw $$1) {
      $$0.writeLong($$1.a());
   }
   ...
   public static fdw f(ByteBuf $$0) {
      return new fdw($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, fdw $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public vs a(@Nullable uu $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable uu $$1) {
      if ($$1 == null) {
         $$1 = tz.b;
      }

      try {
         uk.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static tx h(ByteBuf $$0) {
      uu $$1 = a($$0, ug.a(2097152L));
      if ($$1 != null && !($$1 instanceof tx)) {
   ...
   @Nullable
   public static uu a(ByteBuf $$0, ug $$1) {
      try {
         uu $$2 = uk.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public <T> ald<T> a(ald<? extends jr<T>> $$0) {
      ale $$1 = this.q();
      return ald.a($$0, $$1);
   }
   ...
   public fds v() {
      ...
      return new fds(new fdw((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5, $$6);
   }
   ...
   public vs k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vs d(ByteBuf $$0, int $$1) {
