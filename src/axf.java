...
public class axf extends azt {
   public axf(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bat.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bat.z.typeName(), bcb.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bat.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bat.z.typeName(), "minecraft:saddle"));
