...
public class axf implements AutoCloseable {
   ...
   private axf(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static axf.a a(Path $$0) {
         return new axf.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
