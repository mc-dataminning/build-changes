...
public class axf {
   ...
   private static final Optional<Object> b = Optional.of(axo.a);

   private static boolean a(wp $$0, avz $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, wp $$1, avz $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, wp $$1, avz $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, wp $$1, avz $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, wp $$2, avz $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, wp $$2, wp $$3, avz $$4) {
      int $$5 = $$0.length();
      wp $$6 = $$2;
   ...
   public static boolean a(vx $$0, wp $$1, avz $$2) {
