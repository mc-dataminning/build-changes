...
public abstract class kz {
   ...
   public static <T1 extends Comparable<T1>> kz.a<T1> a(dgh<T1> $$0) {
      return new kz.a<>($$0);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>> kz.b<T1, T2> a(dgh<T1> $$0, dgh<T2> $$1) {
      return new kz.b<>($$0, $$1);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> kz.c<T1, T2, T3> a(dgh<T1> $$0, dgh<T2> $$1, dgh<T3> $$2) {
   ...
   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> kz.d<T1, T2, T3, T4> a(
      dgh<T1> $$0, dgh<T2> $$1, dgh<T3> $$2, dgh<T4> $$3
   ) {
   ...
   public static class c<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends kz {
      private final dgh<T1> a;
      private final dgh<T2> b;
      private final dgh<T3> c;

      c(dgh<T1> $$0, dgh<T2> $$1, dgh<T3> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class d<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends kz {
      ...
      private final dgh<T2> b;
      private final dgh<T3> c;
      private final dgh<T4> d;

      d(dgh<T1> $$0, dgh<T2> $$1, dgh<T3> $$2, dgh<T4> $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   public static class e<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
      ...
      private final dgh<T3> c;
      private final dgh<T4> d;
      private final dgh<T5> e;

      e(dgh<T1> $$0, dgh<T2> $$1, dgh<T3> $$2, dgh<T4> $$3, dgh<T5> $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
