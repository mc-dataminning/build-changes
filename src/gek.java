...
public class gek {
   ...
   public final Map<je, gel> c;
   public final gem d;
   public final boolean e;

   public gek(Vector3f $$0, Vector3f $$1, Map<je, gel> $$2, @Nullable gem $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<je, gel> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gek> {
      private static final boolean a = true;

      public gek a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gem $$6 = this.a($$3);
         Map<je, gel> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayn.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayn.a($$3, "shade", true);
            return new gek($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gem a(JsonObject $$0) {
         gem $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = ayn.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            je.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = ayn.a($$2, "rescale", false);
            $$1 = new gem($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = ayn.m($$0, "angle");
         if ($$1 != 0.0F && ayx.e($$1) != 22.5F && ayx.e($$1) != 45.0F) {
      ...
      private Map<je, gel> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gel> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<je, gel> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gel> $$2 = Maps.newEnumMap(je.class);
         JsonObject $$3 = ayn.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            je $$5 = this.a($$4.getKey());
            $$2.put($$5, (gel)$$0.deserialize($$4.getValue(), gel.class));
         }
