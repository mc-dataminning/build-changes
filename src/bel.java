...
public class bel extends bau {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bel::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bel::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bel::k);
         $$0 = this.a($$0, "minecraft:fox", bel::j);
         $$0 = this.a($$0, "minecraft:item", bel::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bel::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bel::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bel::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bel::e);
         return this.a($$0, "minecraft:piglin", bel::d);
      });
   }
