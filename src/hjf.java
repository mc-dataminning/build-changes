...
public class hjf {
   ...
   public static class a extends Thread {
      private final hjf.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hjf.b $$0) throws IOException {
         super("LanServerDetector #" + hjf.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hjf.b));
   ...
   public static class b {
      private final List<hje> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hje> a() {
         if (this.b) {
            List<hje> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
