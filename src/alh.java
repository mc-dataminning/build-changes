...
public class alh {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vq.c("commands.help.failed"));
                     ...
                     $$1 -> {
                        ...
                        if ($$2.getContext().getNodes().isEmpty()) {
                           ...
                           for (String $$4 : $$3.values()) {
                              ((du)$$1.getSource()).a(() -> vq.b("/" + $$2.getReader().getString() + " " + $$4), false);
                           }
