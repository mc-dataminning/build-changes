...
public class alh {
   ...
   final List<sg> g = Collections.synchronizedList(Lists.newArrayList());

   public alh(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new alc(alh.this.d()));
               sg.a($$1, uy.a, null);
               int $$2 = alh.this.e.m();
               sg $$3 = (sg)($$2 > 0 ? new sr($$2) : new sg(uy.a));
               alh.this.g.add($$3);
               $$1.addLast("packet_handler", $$3);
               $$3.b(new alj(alh.this.e, $$3));
            }
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<alh.a.a> d = Lists.newArrayList();
