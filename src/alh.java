...
public final class alh<E> implements Codec<jq<E>> {
   private final alk<? extends kd<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> alh<E> a(alk<? extends kd<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> alh<E> a(alk<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new alh<>($$0, $$1, $$2);
   }

   private alh(alk<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(jq<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof alj<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> all.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
