...
public class alh<T> {
   ...
   public static <T> Codec<alh<T>> a(alh<? extends kd<T>> $$0) {
      return ali.a.xmap($$1 -> a($$0, $$1), alh::a);
   }

   public static <T> zg<ByteBuf, alh<T>> b(alh<? extends kd<T>> $$0) {
      return ali.b.a($$1 -> a($$0, $$1), alh::a);
   }

   public static <T> alh<T> a(alh<? extends kd<T>> $$0, ali $$1) {
      return a($$0.c, $$1);
   }

   public static <T> alh<kd<T>> a(ali $$0) {
      return a(lz.a, $$0);
   }
   ...
   public boolean c(alh<? extends kd<?>> $$0) {
      return this.b.equals($$0.a());
   }

   public <E> Optional<alh<E>> d(alh<? extends kd<E>> $$0) {
