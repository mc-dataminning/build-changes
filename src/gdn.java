...
public class gdn implements ezr, AutoCloseable {
   ...
   private final List<ezx> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezx> l = Maps.newHashMap();
   private final int m;
   ...
   public gdn(atx $$0, String $$1) throws IOException {
      akk $$2 = new akk("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      ats $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, ezu.a.a, $$6);
         this.t = a($$0, ezu.a.b, $$7);
         this.m = ezv.a();
         ezv.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezx.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezs a(atx $$0, ezu.a $$1, String $$2) throws IOException {
      ezu $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezs)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         ezs $$7;
         if ($$3 == null) {
            akk $$4 = new akk("shaders/program/" + $$2 + $$1.b());
            ats $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static ezq a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezq();
      } else {
         int $$1 = 32774;
