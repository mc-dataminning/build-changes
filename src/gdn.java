...
public class gdn implements AutoCloseable {
   ...
   public gdn(gdh $$0, fff $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gom(16, 16, false);
   ...
   private float b(float $$0) {
      bsc $$1 = this.j.s.c(bse.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(btp $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.b(bse.p)) {
               $$9 = gdh.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(bse.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   public static float a(dvu $$0, int $$1) {
