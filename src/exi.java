...
public class exi extends exc<exi.a> {
   protected exi(edo $$0) {
      super(dkg.a, $$0, new exi.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected edg g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && jy.c($$0) < $$2) {
            ...
            return this.j($$0) ? new edg(15) : new edg();
         }
      }
   }

   private static edg a(edg $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends ewz<exi.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<edg> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public exi.a a() {
         return new exi.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
