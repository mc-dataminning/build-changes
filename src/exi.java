...
public class exi extends eye {
   ...
   public exi(eye $$0, BooleanConsumer $$1, fjd $$2) {
   ...
   @Override
   protected void aH_() {
      this.n = new est(this.i, this.g / 2 - 100, 66, 200, 20, tl.c("addServer.enterName"));
      this.n.a(this.l.a);
      this.n.b($$0 -> this.D());
      this.e(this.n);
      this.m = new est(this.i, this.g / 2 - 100, 106, 200, 20, tl.c("addServer.enterIp"));
      this.m.l(128);
      this.m.a(this.l.b);
      this.m.b($$0 -> this.D());
      this.e(this.m);
      ...
      this.c = this.d(esk.a(tl.c("addServer.add"), $$0 -> this.l()).a(this.g / 2 - 100, this.h / 4 + 96 + 18, 200, 20).a());
      this.d(esk.a(tk.e, $$0 -> this.k.accept(false)).a(this.g / 2 - 100, this.h / 4 + 120 + 18, 200, 20).a());
      this.c(this.n);
      this.D();
   }
   ...
   private void D() {
      this.c.i = fke.b(this.m.a()) && !this.n.a().isEmpty();
   }
