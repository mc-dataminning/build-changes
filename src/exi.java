...
public class exi extends exm implements exk {
   ...
   public exi.c a() {
      return new exi.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(exs.b $$0, exs $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (ext)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(exs $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == exl.k;
         boolean $$2 = $$0 == exl.j;
   ...
   private IntConsumer a(int $$0, exs.a $$1) {
   ...
   private exi.b q() {
      ...
      this.k += $$5;
      this.j++;
      exi.a $$9 = new exi.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new exi.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == exs.b.a || this.q == exs.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<ext> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      ext $$1 = (ext)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == ext.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == ext.b.c) {
         exk.super.a(this.b, this.c, this.d, this.e);
      }
   }

   @Override
   public exr a(int $$0, int $$1, int $$2, int $$3) {
      if (this.a) {
         throw new IllegalStateException();
      } else {
         return exk.super.a($$0, $$1, $$2, $$3);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, exk.a($$11));
         this.a($$14 + 5, exk.a($$12));
         this.a($$14 + 6, exk.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(exs a, int b, int c, exs.b d, exs.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(exs.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable exv $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
