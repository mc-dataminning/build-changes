...
public class cop implements dft {
   ...
   private void a(ard $$0, coo $$1, int $$2) {
      ji $$3 = this.a($$0, $$1.dv(), $$2);
      if ($$3 != null) {
         cjj $$4 = bur.bx.a($$0, $$3, buq.h);
         if ($$4 != null) {
            $$4.b($$1, true);
         }
      }
   ...
   private ji a(dgk $$0, ji $$1, int $$2) {
      ...
      for (int $$5 = 0; $$5 < 10; $$5++) {
         ...
         int $$8 = $$0.a(ecr.a.b, $$6, $$7);
         ji $$9 = new ji($$6, $$8, $$7);
         if ($$4.isSpawnPositionOk($$0, $$9, bur.bE)) {
            $$3 = $$9;
            break;
         }
      }
