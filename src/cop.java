...
public abstract class cop extends coo {
   @Nullable
   private iv a;
   private boolean b;
   private boolean c;

   protected cop(bwr<? extends cop> $$0, djm $$1) {
      super($$0, $$1);
   }
   ...
   protected void D() {
      super.D();
      this.bD.a(4, new cop.a<>(this, 0.7, 0.595));
   }
   ...
   public byb a(dkd $$0, bue $$1, bwq $$2, @Nullable byb $$3) {
      ...
      if (this.gu()) {
         this.a(bws.f, ctc.a(this.dW().f(mh.aF)));
         this.a(bws.f, 2.0F);
      }
   ...
   public static boolean b(bwr<? extends cop> $$0, djn $$1, bwq $$2, iv $$3, azv $$4) {
      return $$1.a(djv.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends cop> extends cef {
      ...
      public void a() {
         ...
         if ($$1.k()) {
            ...
            if (this.b.gz() && $$2.isEmpty()) {
               ...
               ffc $$3 = ffc.c(this.b.x());
               ffc $$4 = this.b.ds();
               ffc $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).c(0.4).e($$3);
               ffc $$6 = $$3.d($$4).d().c(10.0).e($$4);
               iv $$7 = iv.a((jp)$$6);
               $$7 = this.b.dU().a(egs.a.f, $$7);
      ...
      private List<cop> h() {
         return this.b.dU().a(cop.class, this.b.cQ().g(16.0), $$0 -> $$0.gx() && !$$0.u(this.b));
      }
