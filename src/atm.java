...
class atm implements Path {
   private static final BasicFileAttributes a = new atk() {
      @Override
   ...
   private static final BasicFileAttributes b = new atk() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atm> c = Comparator.comparing(atm::n);
   ...
   public atm(ato $$0, String $$1, @Nullable atm $$2, atp $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atm a(@Nullable atm $$0, String $$1) {
      return new atm(this.e, $$1, $$0, atp.b);
   }
   ...
   atm a(String $$0) {
      if (a(this.i)) {
         return new atm(this.e, $$0, this, this.i);
      } else if (this.i instanceof atp.a $$1) {
         atm $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atm(this.e, $$0, this, atp.a);
      } else if (this.i instanceof atp.b) {
         return new atm(this.e, $$0, this, atp.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atp $$0) {
      return $$0 == atp.a || $$0 == atp.b;
   }
   ...
   private atm c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atm $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atp.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atp.a i() {
      return this.i instanceof atp.a $$0 ? $$0 : null;
   }
