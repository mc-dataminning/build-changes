...
public class atm extends axu {
   public atm(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", ays.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(ays.s, "minecraft:piston");
