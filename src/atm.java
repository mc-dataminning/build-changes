...
public class atm extends axr {
   public atm(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", ayp.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(ayp.s, "minecraft:jukebox");
