...
public class hfw extends MinecraftServer {
   ...
   public hfw(Thread $$0, fmg $$1, ewd.c $$2, avg $$3, amy $$4, amu $$5, ass $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hfv(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dhf bd() {
      return this.r() && !this.w_() ? (dhf)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
