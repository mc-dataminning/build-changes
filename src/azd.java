...
public class azd {
   ...
   public static final Codec<Vector3f> c = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ae.a($$0, 3).map($$0x -> new Vector3f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2))), $$0 -> List.of($$0.x(), $$0.y(), $$0.z())
      );
   public static final Codec<Vector4f> d = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ae.a($$0, 4).map($$0x -> new Vector4f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3))),
         $$0 -> List.of($$0.x(), $$0.y(), $$0.z(), $$0.w())
      );
   public static final Codec<Quaternionf> e = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ae.a($$0, 4).map($$0x -> new Quaternionf((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3)).normalize()),
         $$0 -> List.of($$0.x, $$0.y, $$0.z, $$0.w)
      );
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> ayf.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> ayf.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<azd.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alp.d($$0.substring(1)).map($$0x -> new azd.c($$0x, true)) : alp.d($$0).map($$0x -> new azd.c($$0x, false)), azd.c::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bar.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> E = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kk.e.fieldOf("id").forGetter(GameProfile::getId), y.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static final Codec<String> C = Codec.STRING
      .validate($$0 -> !alp.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <P, I> Codec<I> a(Codec<P> $$0, String $$1, String $$2, BiFunction<P, P, DataResult<I>> $$3, Function<I, P> $$4, Function<I, P> $$5) {
      Codec<I> $$6 = Codec.list($$0).comapFlatMap($$1x -> ae.a($$1x, 2).flatMap($$1xx -> {
            P $$2x = (P)$$1xx.get(0);
            P $$3x = (P)$$1xx.get(1);
   ...
   public static <K, V> azd.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new azd.b<>($$0, $$1);
   }
   ...
   public static <A> Codec<A> d(final Codec<A> $$0) {
   ...
   public static <T> Codec<Object2BooleanMap<T>> e(Codec<T> $$0) {
   ...
   public static <A> Codec<Optional<A>> f(final Codec<A> $$0) {
   ...
   public static record c(alp a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
