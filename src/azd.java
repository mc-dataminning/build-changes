...
public class azd implements AutoCloseable {
   ...
   private azd(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static azd.a a(Path $$0) {
         return new azd.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
