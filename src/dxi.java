...
public class dxi implements dxp.c {
   ...
   private final ObjectListIterator<dxi.a> h;
   private final ObjectListIterator<ejn> i;

   public static dxi a(dcs $$0, dbg $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<dxi.a> $$4 = new ObjectArrayList(10);
      ObjectList<ejn> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eiw.a).forEach($$5x -> {
         eiw $$6 = $$5x.h().d();
         ...
         for (eip $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eih) {
                  ...
                  $$4.add(new dxi.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new dxi($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public dxi(ObjectListIterator<dxi.a> $$0, ObjectListIterator<ejn> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(eid a, eiw b, int c) {
   }
}
