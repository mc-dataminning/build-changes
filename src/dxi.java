...
public interface dxi {
   static dxi a(dya $$0, dbh $$1, dyc $$2, dyj $$3, int $$4, int $$5, dxi.a $$6) {
      return new dxi.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static dxi a(final dxi.a $$0) {
      return new dxi() {
         @Nullable
         @Override
         public dse a(dxp.b $$0x, double $$1) {
   ...
   @Nullable
   dse a(dxp.b var1, double var2);

   boolean a();

   public interface a {
      dxi.b computeFluid(int var1, int var2, int var3);
   }
   ...
   public static final class b {
      ...
      public b(int $$0, dse $$1) {
         this.a = $$0;
         this.b = $$1;
      }

      public dse a(int $$0) {
         return $$0 < this.a ? this.b : dfd.a.o();
      }
   }

   public static class c implements dxi {
      ...
      private final dxp p;
      private final dyj q;
      private final dxi.b[] r;
      private final long[] s;
      private final dxi.a t;
      private final dxp u;
      private final dxp v;
      private boolean w;
      private final int x;
      ...
      c(dya $$0, dbh $$1, dyc $$2, dyj $$3, int $$4, int $$5, dxi.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dse a(dxp.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            dxi.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dfd.H)) {
               this.w = false;
               return dfd.H.o();
            } else {
               ...
               if ($$31 <= 0.0) {
                  this.w = $$31 >= k;
                  return $$32;
               } else if ($$32.a(dfd.G) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dfd.H)) {
                  this.w = true;
                  return $$32;
               } else {
      ...
      private double a(dxp.b $$0, MutableDouble $$1, dxi.b $$2, dxi.b $$3) {
         int $$4 = $$0.b();
         dse $$5 = $$2.a($$4);
         dse $$6 = $$3.a($$4);
         if ((!$$5.a(dfd.H) || !$$6.a(dfd.G)) && (!$$5.a(dfd.G) || !$$6.a(dfd.H))) {
      ...
      private dxi.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            dxi.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private dxi.b b(int $$0, int $$1, int $$2) {
         dxi.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               dxi.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).i()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new dxi.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, dxi.b $$3, int $$4, boolean $$5) {
         dxp.e $$6 = new dxp.e($$0, $$1, $$2);
         double $$7;
         double $$8;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new dxp.e($$6, $$7, $$8)) * 10.0;
         int $$12 = ayz.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dse a(int $$0, int $$1, int $$2, dxi.b $$3, int $$4) {
         dse $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != dvw.g && $$3.b != dfd.H.o()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new dxp.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dfd.H.o();
            }
         }
