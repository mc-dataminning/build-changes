...
public class eok {
   private final List<ConcurrentLinkedQueue<eoj>> a = ImmutableList.of(
   ...
   public void a(eoj $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eoj> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eoj> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eoj> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eoj> j() {
