...
public class eok extends eon {
   public static final int a = 854;
   public static final int b = 480;
   static final eok.b l = new eok.b(854, 480);

   public eok(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eok.a[] e = values();
   ...
   static class b {
      ...
      static List<eok.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eok.b($$0, $$1), eok.l) : ImmutableList.of(eok.l);
      }
