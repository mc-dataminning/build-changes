...
public class dup<T> implements dux<T> {
   private final jo<T> a;
   private final axc<T> b;
   private final duy<T> c;
   private final int d;

   public dup(jo<T> $$0, int $$1, duy<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dup(jo<T> $$0, int $$1, duy<T> $$2) {
      this($$0, $$1, $$2, axc.c(1 << $$1));
   }

   private dup(jo<T> $$0, int $$1, duy<T> $$2, axc<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dux<T> c() {
      return new dup<>(this.a, this.d, this.c, this.b.b());
   }
}
