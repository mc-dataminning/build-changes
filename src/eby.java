...
public class eby extends ece<eeg> {
   ...
   private void a(dds $$0, ayw $$1, jd $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, eeg $$9) {
      ...
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dcz)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dcz)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
               this.a($$0, $$2.h($$17.getAsInt()), $$25, ji.a);
               if ($$11.isPresent()) {
                  $$26 = Math.max(0, $$22 + ayo.b($$1, -$$9.e, $$9.e));
               } else {
            ...
            if ($$11.isPresent()) {
               ebz.a($$0, $$2.h($$11.getAsInt() - 1), ji.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               ebz.a($$0, $$2.h($$17.getAsInt() + 1), ji.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private int a(ayw $$0, int $$1, int $$2, float $$3, int $$4, eeg $$5) {
      if ($$0.i() > $$3) {
         ...
         float $$7 = (float)ayo.a((double)$$6, 0.0, (double)$$5.l, (double)$$4 / 2.0, 0.0);
   ...
   private boolean b(dds $$0, jd $$1) {
      dtc $$2 = $$0.a_($$1);
      if (!$$2.a(dga.G) && !$$2.a(dga.su) && !$$2.a(dga.st)) {
         if ($$0.a_($$1.d()).u().a(awk.a)) {
            return false;
         } else {
            for (ji $$3 : ji.c.a) {
               if (!this.a((dcx)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dcx)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, eeg $$4) {
      ...
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
      return (double)ayo.b((float)$$7, 0.0F, (float)$$4.k, $$4.j, 1.0F);
   }

   private static float a(ayw $$0, float $$1, float $$2, float $$3, float $$4) {
      return bpq.a($$0, $$3, $$4, $$1, $$2);
   }
}
