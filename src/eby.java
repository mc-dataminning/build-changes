...
public class eby extends ebl<edi> {
   public eby(Codec<edi> $$0) {
      super($$0);
   }
   ...
   private void a(ayo $$0, dch $$1, int $$2, int $$3, ja $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ja $$2, dch $$3, boolean $$4, double $$5, ja $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dch $$0, ja $$1) {
      if ($$0.a_($$1.c()).a(dfk.dN)) {
         this.a($$0, $$1.c(), dfk.a.o());
      }
   }

   private void a(dch $$0, ayo $$1, ja $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dsl $$13) {
   ...
   private void a(ja $$0, dch $$1, ayo $$2, int $$3, int $$4, boolean $$5, boolean $$6, dsl $$7) {
      dsl $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dfk.dP) || $$8.a(dfk.dO) || $$8.a(dfk.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dfk.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dfk.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dsl $$0) {
      return $$0.a(dfk.iC) || $$0.a(dfk.dP) || $$0.a(dfk.mW);
   }
   ...
   private void a(dch $$0, ja $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dfk.dN)) {
                  if (this.a((dbm)$$0, $$10)) {
                     this.a($$0, $$10, dfk.a.o());
                     this.a($$0, $$10.c(), dfk.a.o());
                  } else if (c($$11)) {
                     dsl[] $$12 = new dsl[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
