...
public class fm implements ArgumentType<fm.a> {
   ...
   public static fm.a a(CommandContext<eq> $$0, String $$1) {
      return (fm.a)$$0.getArgument($$1, fm.a.class);
   }
   ...
   private static fm.a a(String $$0) throws CommandSyntaxException {
      return (fm.a)($$0.equals("><") ? ($$0x, $$1) -> {
         int $$2 = $$0x.a();
         $$0x.a($$1.a());
         $$1.a($$2);
      } : b($$0));
   ...
   private static fm.b b(String $$0) throws CommandSyntaxException {
      return switch ($$0) {
         case "=" -> ($$0x, $$1) -> $$1;
         case "+=" -> Integer::sum;
         case "-=" -> ($$0x, $$1) -> $$0x - $$1;
   ...
   @FunctionalInterface
   public interface a {
      void apply(exj var1, exj var2) throws CommandSyntaxException;
   }

   @FunctionalInterface
   interface b extends fm.a {
      int apply(int var1, int var2) throws CommandSyntaxException;

      @Override
      default void apply(exj $$0, exj $$1) throws CommandSyntaxException {
