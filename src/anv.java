...
public abstract class anv implements xn {
   private static final Logger d = LogUtils.getLogger();
   public static final int a = 15000;
   private static final vd e = vd.c("disconnect.timeout");
   ...
   public anv(MinecraftServer $$0, ue $$1, ano $$2) {
      this.b = $$0;
      this.c = $$1;
      this.f = ac.b();
      this.i = $$2.b();
   ...
   public void a(xs $$0) {
      xf.a($$0, this, this.b);
      if ($$0.a() == xs.a.b && this.b.V()) {
         d.info("Disconnecting {} due to resource pack rejection", this.j().getName());
         this.b(vd.c("multiplayer.requiredTexturePrompt.disconnect"));
      }
   }
   ...
   public void b(vd $$0) {
      this.c.a(new xi($$0), un.a(() -> this.c.a($$0)));
      this.c.o();
      this.b.h(this.c::p);
   }
   ...
   protected ano a(amo $$0) {
      return new ano(this.j(), this.i, $$0);
   }
}
