...
public abstract class bqn<R extends Runnable> implements bpu, bqt<R>, Executor {
   ...
   protected void d(R $$0) {
      try {
         ...
         c.error(LogUtils.FATAL_MARKER, "Error executing task on {}", this.x_(), var3);
         throw var3;
      }
   }
   ...
   @Override
   public List<bpr> bx() {
      return ImmutableList.of(bpr.a(this.b + "-pending-tasks", bpq.b, this::bz));
   }
