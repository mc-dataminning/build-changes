...
public interface bqn<T, F> {
   ...
   public static final class a implements bqn<bqn.b, Runnable> {
   ...
   public static final class c<T> implements bqn<T, T> {
