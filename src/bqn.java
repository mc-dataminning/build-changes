...
public class bqn {
   ...
   private static void a(bqv $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<ear, bqz<bqp>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqz)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ae.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<ear, bqz<bqp>> $$3 : $$0) {
         bqz<bqp> $$4 = (bqz<bqp>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((ear)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bqx> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqc.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bql $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bqn::a));
      $$1.add("chunksWritten", this.a($$0.m(), bqn::a));
      return $$1;
   }
   ...
   private JsonElement c(bql $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bqn::a));
      $$1.add("received", this.a($$0.k(), bqn::a));
      return $$1;
   }

   private <T> JsonElement a(bqu<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bqr> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bqr>, ToDoubleFunction<bqr>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bqr::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bqr::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bqr::c));
      return $$1;
   }
}
