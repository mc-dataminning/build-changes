...
public class bkj {
   ...
   private static void a(bkr $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bkm $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dpc, bkv<bkl>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bkv)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dpc, bkv<bkl>> $$3 : $$0) {
         bkv<bkl> $$4 = (bkv<bkl>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dpc)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bkt> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bjy.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bkh $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bkj::a));
      $$1.add("chunksWritten", this.a($$0.m(), bkj::a));
      return $$1;
   }

   private JsonElement a(bko.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bkh $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bkj::a));
      $$1.add("received", this.a($$0.k(), bkj::a));
      return $$1;
   }

   private <T> JsonElement a(bkq<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bkn> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bkn>, ToDoubleFunction<bkn>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bkn::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bkn::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bkn::c));
      return $$1;
   }
}
