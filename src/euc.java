...
public class euc extends euh {
   ...
   @Override
   public void a(dgg $$0, ji $$1, dwv $$2, @Nullable euf $$3, boolean $$4) {
      euf $$5 = a($$0, $$3);
      this.a($$0, $$1, $$5);
      ...
      for (boolean $$7 = true; $$6.hasNext(); $$7 = false) {
         ...
         int $$11 = b($$10);
         dwv $$12 = $$0.a_($$9);
         if ($$12.a(this.a) && !$$12.c(dpr.f).equals($$11)) {
            int $$13 = 2;
            if (!$$4 || !$$7) {
               $$13 |= 128;
            }

            $$0.a($$9, $$12.b(dpr.f, Integer.valueOf($$11)), $$13);
         } else {
            $$6.remove();
         }
      }
   ...
   private static boolean a(dwv $$0, jn $$1) {
      dxs<dxz> $$2 = dpr.g.get($$1);
      return $$2 == null ? $$1 == jn.a : $$0.c($$2).a();
   }

   private static euf a(dgg $$0, @Nullable euf $$1) {
      euf $$2;
      if ($$1 != null) {
         $$2 = $$1;
      } else {
      ...
      return $$2.a(jn.b).a(euf.a.a);
   }

   private void a(dgg $$0, ji $$1, euf $$2) {
      dwv $$3 = $$0.a_($$1);
      if ($$3.a(this.a)) {
         this.a($$1, $$3.c(dpr.f), $$2);
         this.b.add($$1);
      } else {
         this.a($$0, $$1, 0, $$2, true);
      }
   ...
   private static int a(euf $$0, int $$1) {
      return $$0.i() << 4 | $$1;
   }

   private static euf a(int $$0) {
      return euf.a($$0 >> 4);
   }
   ...
   private void a(ji $$0, int $$1, euf $$2) {
      this.d.compute($$0, ($$2x, $$3) -> $$3 == null ? a($$2, $$1) : a(a($$3), $$1));
   }

   private void a(dgg $$0, ji $$1, int $$2, euf $$3, boolean $$4) {
      for (jn $$5 : $$3.g()) {
         ji $$6 = $$1.a($$5);
   ...
   private void b(dgg $$0, ji $$1, int $$2, euf $$3, boolean $$4) {
      dwv $$5 = $$0.a_($$1);
      if ($$5.a(this.a)) {
         int $$6 = this.a($$1, $$5);
