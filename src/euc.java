...
public class euc {
   ...
   public euc(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eud> $$1) throws IOException {
   ...
   public List<eud> a(Path $$0) throws IOException {
      List<eud> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eud> a(Path $$0, boolean $$1) throws IOException {
      List<eud> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eud> $$1) throws IOException {
