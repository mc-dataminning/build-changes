...
public class bef extends bat {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bef::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bef::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bef::k);
         $$0 = this.a($$0, "minecraft:fox", bef::j);
         $$0 = this.a($$0, "minecraft:item", bef::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bef::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bef::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bef::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bef::e);
         return this.a($$0, "minecraft:piglin", bef::d);
      });
   }
