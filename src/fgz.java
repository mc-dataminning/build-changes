...
public abstract class fgz extends fhd implements fii, fjb {
   private static final fis a = new fis(new alf("widget/text_field"), new alf("widget/text_field_highlighted"));
   ...
   public fgz(int $$0, int $$1, int $$2, int $$3, xp $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(fgs var1, int var2, int var3, float var4);
}
