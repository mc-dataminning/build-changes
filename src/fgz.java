...
public class fgz {
   ...
   private final ffn d;
   private final fag e;
   private final gdx.a f;
   private final fgz.a g = new fgz.a();
   private final fha h;
   private boolean i;

   private fgz(ffn $$0, fag $$1, gdx.a $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.h = $$0.aH();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3) {
      this.a(gef.D(), $$0, $$1, $$2, $$3);
   }

   public void a(gef $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$2 < $$1) {
         int $$5 = $$1;
         $$1 = $$2;
         $$2 = $$5;
   ...
   public void b(int $$0, int $$1, int $$2, int $$3) {
      this.b(gef.D(), $$0, $$1, $$2, $$3);
   }

   public void b(gef $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$3 < $$2) {
         int $$5 = $$2;
         $$2 = $$3;
         $$3 = $$5;
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new fls($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a(gef.D(), $$0, $$1, $$2, $$3, $$4, $$5);
   }

   public void a(gef $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, 0, $$5);
   }

   public void a(gef $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      ...
      float $$10 = (float)axo.b.a($$6) / 255.0F;
      float $$11 = (float)axo.b.b($$6) / 255.0F;
      float $$12 = (float)axo.b.c($$6) / 255.0F;
      float $$13 = (float)axo.b.d($$6) / 255.0F;
      fak $$14 = this.f.getBuffer($$0);
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a(gef.D(), $$0, $$1, $$2, $$3, $$5, $$6, $$4);
   }

   public void a(gef $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      fak $$8 = this.f.getBuffer($$0);
      this.a($$8, $$1, $$2, $$3, $$4, $$7, $$5, $$6);
      this.g();
   }

   private void a(fak $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      float $$8 = (float)axo.b.a($$6) / 255.0F;
      float $$9 = (float)axo.b.b($$6) / 255.0F;
      float $$10 = (float)axo.b.c($$6) / 255.0F;
      float $$11 = (float)axo.b.d($$6) / 255.0F;
      float $$12 = (float)axo.b.a($$7) / 255.0F;
      float $$13 = (float)axo.b.b($$7) / 255.0F;
      float $$14 = (float)axo.b.c($$7) / 255.0F;
      float $$15 = (float)axo.b.d($$7) / 255.0F;
   ...
   public void b(gef $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      Matrix4f $$6 = this.e.c().a();
      fak $$7 = this.f.getBuffer($$0);
   ...
   public void a(fgx $$0, String $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.b($$1) / 2, $$3, $$4);
   }

   public void a(fgx $$0, wu $$1, int $$2, int $$3, int $$4) {
      axq $$5 = $$1.g();
      this.b($$0, $$5, $$2 - $$0.a($$5) / 2, $$3, $$4);
   }

   public void a(fgx $$0, axq $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(fgx $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgx $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fgx.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(fgx $$0, axq $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgx $$0, axq $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fgx.a.a, 0, 15728880);
      this.g();
      return $$6;
   }

   public int b(fgx $$0, wu $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgx $$0, wu $$1, int $$2, int $$3, int $$4, boolean $$5) {
      return this.a($$0, $$1.g(), $$2, $$3, $$4, $$5);
   }

   public void a(fgx $$0, wz $$1, int $$2, int $$3, int $$4, int $$5) {
      for (axq $$6 : $$0.c($$1, $$4)) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, gpi $$5) {
      this.a($$5, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, gpi $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   public void a(akk $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      gpi $$6 = this.h.a($$0);
      gra $$7 = this.h.a($$6);
      if ($$7 instanceof gra.b) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5);
      } else if ($$7 instanceof gra.c $$8) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5, 0, 0, $$8.b(), $$8.c(), $$8.b(), $$8.c());
      } else if ($$7 instanceof gra.a $$9) {
   ...
   private void a(gpi $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      if ($$8 != 0 && $$9 != 0) {
         this.a(
            $$0.i(),
            $$5,
   ...
   private void a(gpi $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      if ($$4 != 0 && $$5 != 0) {
   ...
   private void a(gpi $$0, gra.a $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      gra.a.a $$7 = $$1.d();
   ...
   private void a(gpi $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, int $$11) {
      if ($$4 > 0 && $$5 > 0) {
         if ($$8 > 0 && $$9 > 0) {
   ...
   public void a(cua $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3, $$4);
   }

   public void b(cua $$0, int $$1, int $$2) {
      this.b($$0, $$1, $$2, 0);
   }
   ...
   public void a(bsy $$0, cua $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dP(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable bsy $$0, @Nullable dcd $$1, cua $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 0);
   }

   private void a(@Nullable bsy $$0, @Nullable dcd $$1, cua $$2, int $$3, int $$4, int $$5, int $$6) {
      if (!$$2.e()) {
         grj $$7 = this.d.ar().a($$2, $$1, $$0, $$5);
         this.e.a();
         ...
         try {
            ...
            this.d.ar().a($$2, ctx.g, false, this.e, this.d(), 15728880, goz.d, $$7);
            this.e();
            if ($$8) {
               ezc.d();
            }
   ...
   public void a(fgx $$0, cua $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(fgx $$0, cua $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.e()) {
         this.e.a();
         if ($$1.H() != 1 || $$4 != null) {
         ...
         if ($$1.p()) {
            ...
            int $$8 = $$2 + 2;
            int $$9 = $$3 + 13;
            this.a(gef.E(), $$8, $$9, $$8 + 13, $$9 + 2, -16777216);
            this.a(gef.E(), $$8, $$9, $$8 + $$6, $$9 + 1, $$7 | 0xFF000000);
         }

         gcz $$10 = this.d.s;
         float $$11 = $$10 == null ? 0.0F : $$10.gt().a($$1.g(), this.d.at());
         if ($$11 > 0.0F) {
            int $$12 = $$3 + aye.d(16.0F * (1.0F - $$11));
            int $$13 = $$12 + aye.f(16.0F * $$11);
            this.a(gef.E(), $$2, $$12, $$2 + 16, $$13, Integer.MAX_VALUE);
         }
   ...
   public void b(fgx $$0, cua $$1, int $$2, int $$3) {
      this.a($$0, fnd.a(this.d, $$1), $$1.b(), $$2, $$3);
   }

   public void a(fgx $$0, List<wu> $$1, Optional<crk> $$2, int $$3, int $$4) {
      List<fpm> $$5 = $$1.stream().map(wu::g).map(fpm::a).collect(ac.b());
      $$2.ifPresent($$1x -> $$5.add($$5.isEmpty() ? 0 : 1, fpm.a($$1x)));
      this.a($$0, $$5, $$3, $$4, fpo.a);
   }

   public void a(fgx $$0, wu $$1, int $$2, int $$3) {
      this.b($$0, List.of($$1.g()), $$2, $$3);
   }

   public void a(fgx $$0, List<wu> $$1, int $$2, int $$3) {
      this.b($$0, Lists.transform($$1, wu::g), $$2, $$3);
   }

   public void b(fgx $$0, List<? extends axq> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(fpm::a).collect(Collectors.toList()), $$2, $$3, fpo.a);
   }

   public void a(fgx $$0, List<axq> $$1, fpn $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(fpm::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(fgx $$0, List<fpm> $$1, int $$2, int $$3, fpn $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
         ...
         this.e.a();
         int $$14 = 400;
         this.a(() -> fpq.a(this, $$12, $$13, $$9, $$10, 400));
   ...
   public void a(fgx $$0, @Nullable xr $$1, int $$2, int $$3) {
      if ($$1 != null && $$1.i() != null) {
         xa $$4 = $$1.i();
         xa.c $$5 = $$4.a(xa.a.b);
         if ($$5 != null) {
   ...
   static class a {
      private final Deque<fls> a = new ArrayDeque<>();

      public fls a(fls $$0) {
         fls $$1 = this.a.peekLast();
         if ($$1 != null) {
            fls $$2 = Objects.requireNonNullElse($$0.b($$1), fls.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
