...
public abstract class fgz extends fhb {
   ...
   public fgz(int $$0, int $$1, int $$2, int $$3, xo $$4, double $$5) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
   }
   ...
   public void a(fkz $$0) {
      ...
      if (this.j) {
         if (this.aH_()) {
            $$0.a(fky.d, xo.c("narration.slider.usage.focused"));
         } else {
            $$0.a(fky.d, xo.c("narration.slider.usage.hovered"));
         }
      }
   }
