...
public class fia {
   ...
   @Nullable
   private String g;
   private static final fia.a h = new fia.a() {
      @Nullable
      @Override
      public fhz a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fid.a(this.d, "Get capabilities")) {
         ...
         if (fid.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fid.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fid.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fhz a(fia.c $$0) {
      return ($$0 == fia.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fia.a {
      private final int a;
      private final Set<fhz> b = Sets.newIdentityHashSet();
      ...
      public fhz a() {
         if (this.b.size() >= this.a) {
            if (ac.aU) {
               fia.a.warn("Maximum sound pool size {} reached", this.a);
            }
