public class ged extends gfd<fuk, fng<fuk>> {
   public ged(gcn<fuk, fng<fuk>> $$0) {
      super($$0);
   }

   public void a(esa $$0, fvl $$1, int $$2, fuk $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      if (!$$3.ce() && $$3.a(chi.a)) {
         ghs $$10 = $$3.b();
         if ($$10.c() != null) {
            coz $$11 = $$3.c(bnv.e);
            if (!$$11.a(cpc.nS)) {
               ...
               ese $$22 = $$1.getBuffer(fvt.c($$10.c()));
               this.c().b($$0, $$22, $$2, ggk.d);
               $$0.b();
            }
         }
      }
