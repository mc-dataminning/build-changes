...
public abstract class ged extends exv {
   ...
   private final List<geb> a = Lists.newArrayList();
   ...
   protected geb a(geb $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public te l() {
      return td.a(this.a.stream().map(geb::a).collect(Collectors.toList()));
   }
}
