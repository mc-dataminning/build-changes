public class bwq extends bwo {
   ...
   public bwq(bqq $$0, int $$1, int $$2, float $$3, float $$4, boolean $$5) {
      super($$0);
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a() {
      ...
      if (this.k == bwo.a.b && !this.d.K().l()) {
         ...
         if ($$3 < 2.5000003E-7F) {
            ...
            this.d.aX = this.d.dC();
            this.d.aZ = this.d.dC();
            float $$5 = (float)(this.h * this.d.g(brv.r));
            if (this.d.bc()) {
               this.d.y($$5 * this.p);
               double $$6 = Math.sqrt($$0 * $$0 + $$2 * $$2);
               if (Math.abs($$1) > 1.0E-5F || Math.abs($$6) > 1.0E-5F) {
                  float $$7 = -((float)(axk.d($$1, $$6) * 180.0F / (float)Math.PI));
                  $$7 = axk.a(axk.g($$7), (float)(-this.n), (float)this.n);
                  this.d.s(this.a(this.d.dE(), $$7, 5.0F));
               }

               float $$8 = axk.b(this.d.dE() * (float) (Math.PI / 180.0));
               float $$9 = axk.a(this.d.dE() * (float) (Math.PI / 180.0));
               this.d.bp = $$8 * $$5;
               this.d.bo = -$$9 * $$5;
            } else {
               float $$10 = Math.abs(axk.g(this.d.dC() - $$4));
               float $$11 = a($$10);
   ...
   private static float a(float $$0) {
      return 1.0F - axk.a(($$0 - 10.0F) / 50.0F, 0.0F, 1.0F);
   }
}
