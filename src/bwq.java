...
public abstract class bwq extends bur implements bgt, biz, bjo, bjr, bjw {
   ...
   private static final aef<Byte> cv = aei.a(bwq.class, aeh.a);
   ...
   public int v(int $$0) {
      int $$1 = arx.a(this.gy() + $$0, 0, this.gE());
      this.u($$1);
      return $$1;
   }
      ...
      if (!$$1.k()) {
         ...
         if (this.bO() && this.ct) {
            ...
            if (this.cu > 5 && this.cu % 3 == 0) {
               ...
               this.a(ape.lq, $$3.a() * 0.15F, $$3.b());
            }
         } else if (this.b($$3)) {
            this.a(ape.lq, $$3.a() * 0.15F, $$3.b());
         } else {
            this.a(ape.lp, $$3.a() * 0.15F, $$3.b());
         }
      }
   }
   ...
   protected void b(float $$0, ehn $$1) {
      ...
      this.au = true;
      if ($$1.e > 0.0) {
         float $$5 = arx.a(this.dB() * (float) (Math.PI / 180.0));
         float $$6 = arx.b(this.dB() * (float) (Math.PI / 180.0));
         this.f(this.do().b((double)(-0.4F * $$5 * $$0), 0.0, (double)(0.4F * $$6 * $$0)));
      }
   }

   protected void gK() {
      this.a(ape.lm, 0.4F, 1.0F);
   }
   ...
   public float E(float $$0) {
      return arx.i($$0, this.cG, this.cF);
   }

   public float F(float $$0) {
      return arx.i($$0, this.cI, this.cH);
   }

   public float G(float $$0) {
      return arx.i($$0, this.cK, this.cJ);
   }
