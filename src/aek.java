...
public class aek<C extends bgm> implements aej<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final cbt a = new cbt();
   protected cbo b;
   protected cfq<C> c;
   ...
   public void a(ako $$0, @Nullable cmf<? extends cme<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.F().b($$1)) {
         this.b = $$0.fQ();
         if (this.b() || $$0.f()) {
            this.a.a();
            $$0.fQ().a(this.a);
            this.c.a(this.a);
            if (this.a.a((cme<?>)$$1.b(), null)) {
               this.a($$1, $$2);
            } else {
               this.a();
               $$0.c.b(new yq($$0.bQ.j, $$1));
            }
   ...
   protected void a(cmf<? extends cme<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            cja $$3 = this.c.b($$2).e().p();
            if (!$$3.b()) {
               int $$4 = this.b.d($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (cja $$5 : $$0) {
                     if (cja.b($$5, $$3) && $$5.L() != $$5.g() && $$5.L() + $$3.L() <= $$5.g()) {
                        $$5.g($$3.L());
                        $$3.f(0);
                        break;
                     }
