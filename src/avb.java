...
public class avb<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return avb.this.get(this.b--);
      }

      @Override
      public void remove() {
         avb.this.remove(this.b + 1);
      }
   }
}
