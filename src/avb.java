...
public class avb extends ava {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avb.a> s;
   private final auv t;
   private long u;
   private final ale v;

   private avb(ale $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == auw.c($$2, 7, $$0.getLength());
      }
   }
