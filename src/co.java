...
public class co extends cv<co.a> {
   ...
   public void a(ana $$0, blp $$1, bkn $$2, float $$3, float $$4, boolean $$5) {
      egp $$6 = bp.b($$0, $$1);
   ...
   public static record a(Optional<bb> b, Optional<be> c, Optional<bb> d) implements cv.a {
      public static final Codec<co.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atq.a(bp.b, "player").forGetter(co.a::a), atq.a(be.a, "damage").forGetter(co.a::c), atq.a(bp.b, "entity").forGetter(co.a::d))
               .apply($$0, co.a::new)
      );
      ...
      public boolean a(ana $$0, egp $$1, bkn $$2, float $$3, float $$4, boolean $$5) {
