...
public class co extends cv<co.a> {
   ...
   public void a(ane $$0, blv $$1, bkt $$2, float $$3, float $$4, boolean $$5) {
      egw $$6 = bp.b($$0, $$1);
   ...
   public static record a(Optional<bb> b, Optional<be> c, Optional<bb> d) implements cv.a {
      public static final Codec<co.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atw.a(bp.b, "player").forGetter(co.a::a), atw.a(be.a, "damage").forGetter(co.a::c), atw.a(bp.b, "entity").forGetter(co.a::d))
               .apply($$0, co.a::new)
      );
      ...
      public boolean a(ane $$0, egw $$1, bkt $$2, float $$3, float $$4, boolean $$5) {
