...
public class co extends cv<co.a> {
   ...
   public void a(ane $$0, blu $$1, bks $$2, float $$3, float $$4, boolean $$5) {
      egv $$6 = bp.b($$0, $$1);
   ...
   public static record a(Optional<bb> b, Optional<be> c, Optional<bb> d) implements cv.a {
      public static final Codec<co.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atv.a(bp.b, "player").forGetter(co.a::a), atv.a(be.a, "damage").forGetter(co.a::c), atv.a(bp.b, "entity").forGetter(co.a::d))
               .apply($$0, co.a::new)
      );
      ...
      public boolean a(ane $$0, egv $$1, bks $$2, float $$3, float $$4, boolean $$5) {
