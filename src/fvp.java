...
public class fvp {
   private static final fwb a = fwb.t(new aiy("textures/map/map_background.png"));
   private static final fwb b = fwb.t(new aiy("textures/map/map_background_checkerboard.png"));
   ...
   private final exo au;
   private cpd av = cpd.h;
   private cpd aw = cpd.h;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gay aB;
   private final gby aC;

   public fvp(exo $$0, gay $$1, gby $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(boi $$0, cpd $$1, cpa $$2, boolean $$3, esh $$4, fvt $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, ggs.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = awi.a($$1, 0.0F, 1.0F);
      return -awi.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(esh $$0, fvt $$1, int $$2, boc $$3) {
      gge $$4 = (gge)this.aB.<fus>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == boc.b ? 1.0F : -1.0F;
   ...
   private void a(esh $$0, fvt $$1, int $$2, float $$3, boc $$4, float $$5, cpd $$6) {
      float $$7 = $$4 == boc.b ? 1.0F : -1.0F;
      ...
      float $$8 = awi.c($$5);
      float $$9 = awi.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * awi.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * awi.a($$5 * (float) Math.PI);
   ...
   private void a(esh $$0, fvt $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = awi.c($$5);
      float $$7 = -0.2F * awi.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * awi.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = awi.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(esh $$0, fvt $$1, int $$2, cpd $$3) {
      ...
      Integer $$4 = cpk.d($$3);
      eig $$5 = cpk.a($$4, this.au.r);
      esl $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(esh $$0, fvt $$1, int $$2, float $$3, float $$4, boc $$5) {
      boolean $$6 = $$5 != boc.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = awi.c($$4);
      float $$9 = -0.3F * awi.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * awi.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * awi.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = awi.a($$4 * $$4 * (float) Math.PI);
      float $$13 = awi.a($$8 * (float) Math.PI);
   ...
   private void a(esh $$0, float $$1, boc $$2, cpd $$3) {
      float $$4 = (float)this.au.s.fq() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.s();
      if ($$5 < 0.8F) {
         float $$6 = awi.e(awi.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(esh $$0, float $$1, boc $$2, cpd $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * awi.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != boc.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(esh $$0, boc $$1, float $$2) {
      int $$3 = $$1 == boc.b ? 1 : -1;
      float $$4 = awi.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = awi.a(awi.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(esh $$0, boc $$1, float $$2) {
      int $$3 = $$1 == boc.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, esh $$1, fvt.a $$2, fuv $$3, int $$4) {
      float $$5 = $$3.x($$0);
      blv $$6 = (blv)MoreObjects.firstNonNull($$3.aG, blv.a);
      float $$7 = awi.i($$0, $$3.N, $$3.dE());
      fvp.a $$8 = a($$3);
      float $$9 = awi.i($$0, $$3.cy, $$3.cw);
      float $$10 = awi.i($$0, $$3.cx, $$3.cu);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == blv.a ? $$5 : 0.0F;
         float $$12 = 1.0F - awi.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, blv.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == blv.b ? $$5 : 0.0F;
         float $$14 = 1.0F - awi.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, blv.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fvp.a a(fuv $$0) {
      cpd $$1 = $$0.eT();
      cpd $$2 = $$0.eU();
      boolean $$3 = $$1.a(cpg.ot) || $$2.a(cpg.ot);
      boolean $$4 = $$1.a(cpg.vP) || $$2.a(cpg.vP);
      if (!$$3 && !$$4) {
         return fvp.a.a;
      } else if ($$0.fn()) {
         return b($$0);
      } else {
         return a($$1) ? fvp.a.b : fvp.a.a;
      }
   }

   private static fvp.a b(fuv $$0) {
      cpd $$1 = $$0.fp();
      blv $$2 = $$0.fo();
      if (!$$1.a(cpg.ot) && !$$1.a(cpg.vP)) {
         return $$2 == blv.a && a($$0.eU()) ? fvp.a.b : fvp.a.a;
      } else {
         return fvp.a.a($$2);
      }
   }
   ...
   private static boolean a(cpd $$0) {
      return $$0.a(cpg.vP) && cnl.d($$0);
   }

   private void a(fus $$0, float $$1, float $$2, blv $$3, float $$4, cpd $$5, float $$6, esh $$7, fvt $$8, int $$9) {
      if (!$$0.gr()) {
         boolean $$10 = $$3 == blv.a;
         boc $$11 = $$10 ? $$0.fm() : $$0.fm().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               ...
               float $$15 = (float)$$5.s() - ((float)this.au.s.fq() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cnl.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = awi.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * awi.a(awi.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * awi.a(awi.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * awi.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cpa.e : cpa.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == boc.b;
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.t()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.s() - ((float)this.au.s.fq() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.s() - ((float)this.au.s.fq() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * awi.a(awi.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * awi.a(awi.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * awi.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cpa.e : cpa.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.A()) {
         this.ax = awi.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = awi.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + awi.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + awi.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
