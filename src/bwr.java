...
public class bwr extends bwd {
   protected static final akj<Integer> a = akn.a(bwr.class, akl.b);
   ...
   @Nullable
   private cqy j;
   private final bwx k = new bwx(this);

   public bwr(div $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bwm.V, $$0);
      this.a_($$1, $$2, $$3);
      if (!this.dV().C) {
   ...
   public bwr(bwm<? extends bwr> $$0, div $$1) {
      super($$0, $$1);
   }
   ...
   public void h() {
      ...
      if (this.ak && this.dV().C) {
         ...
         if (this.R && $$1 < -this.be()) {
            this.i(new fei(this.dy().d, -$$1 * 0.4, this.dy().f));
         }
   ...
   private void j() {
      ...
      if (this.j != null) {
         fei $$1 = new fei(this.j.dA() - this.dA(), this.j.dC() + (double)this.j.cS() / 2.0 - this.dC(), this.j.dG() - this.dG());
         double $$2 = $$1.h();
   ...
   private void m() {
      if (this.dV() instanceof arq) {
         for (bwr $$1 : this.dV().a(eel.a(bwr.class), this.cR().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(arq $$0, fei $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bwr($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(arq $$0, fei $$1, int $$2) {
      fed $$3 = fed.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.C_().a(40);
      List<bwr> $$5 = $$0.a(eel.a(bwr.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bwr $$6 = $$5.get(0);
         $$6.i++;
         $$6.g = 0;
   ...
   private static boolean a(bwr $$0, int $$1, int $$2) {
      return !$$0.dQ() && ($$0.ar() - $$1) % 40 == 0 && $$0.f() == $$2;
   }

   private void b(bwr $$0) {
      this.i = this.i + $$0.i;
   ...
   private int a(arr $$0, int $$1) {
      Optional<dfk> $$2 = dfn.a(dfm.z, $$0, cyy::n);
      if ($$2.isPresent()) {
         cyy $$3 = $$2.get().a();
         int $$4 = dfn.c($$0.y(), $$3, $$1);
