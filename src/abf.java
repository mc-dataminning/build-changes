...
public class abf implements yb<aam> {
   public static final xs<uu, abf> a = yb.a(abf::a, abf::new);
   ...
   private final int i;
   private final List<abf.b> j;

   public abf(RootCommandNode<dz> $$0) {
   ...
   private static void a(List<abf.b> $$0, BiPredicate<abf.b, IntSet> $$1) {
   ...
   private static void a(List<abf.b> $$0) {
      a($$0, abf.b::a);
      a($$0, abf.b::b);
   }
   ...
   private static List<abf.b> a(Object2IntMap<CommandNode<dz>> $$0) {
      ObjectArrayList<abf.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static abf.b b(uu $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      abf.e $$4 = a($$0, $$1);
      return new abf.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static abf.e a(uu $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
         ...
         if ($$5 == null) {
            ...
            hn.a<?> $$6 = $$5.b($$0);
            ajh $$7 = ($$1 & 16) != 0 ? $$0.q() : null;
            return new abf.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.p();
         return new abf.c($$8);
   ...
   private static abf.b a(CommandNode<dz> $$0, Object2IntMap<CommandNode<dz>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<dz> a(dq $$0) {
      return (RootCommandNode<dz>)new abf.d($$0, this.j).a(this.i);
   }

   static class a implements abf.e {
      ...
      @Nullable
      private static ajh a(@Nullable SuggestionProvider<dz> $$0) {
         return $$0 != null ? hr.a($$0) : null;
      }

      a(String $$0, hn.a<?> $$1, @Nullable ajh $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(uu $$0, hn.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends hn.a<A>> void a(uu $$0, hn<A, T> $$1, hn.a<A> $$2) {
         $$0.c(ki.w.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable abf.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements abf.e {
      private final String a;
