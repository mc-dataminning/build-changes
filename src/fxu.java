...
public class fxu implements fpj, fqd {
   ...
   public fxu(fyc $$0, boolean $$1) {
      this.l = $$0;
      this.m = $$1;
   }

   public void a(fxz $$0, bbp $$1, boolean $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      this.j = $$0;
      List<ddk> $$8 = $$0.a(fxz.a.b);
      List<ddk> $$9 = $$2 ? Collections.emptyList() : $$0.a(fxz.a.c);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         ddk $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.h + 4 + 25 * ($$20 % $$12);
         int $$24 = this.i + 5 + 25 * ($$20 / $$12);
         if (this.m) {
            this.f.add(new fxu.c($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         } else {
            this.f.add(new fxu.a($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         }
      }
   ...
   public void a(fns $$0, int $$1, int $$2, float $$3) {
      if (this.g) {
         ...
         int $$7 = 4;
         $$0.a(glv::C, b, this.h, this.i, $$5 * 25 + 8, $$6 * 25 + 8);
   ...
   class a extends fxu.b {
      ...
      public a(final int $$0, final int $$1, final ddl $$2, final ddj $$3, final bbp $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<fxu.b.a> a(ddj $$0, bbp $$1) {
         List<fxu.b.a> $$2 = new ArrayList<>();
   ...
   abstract class b extends fod {
      final ddl b;
      private final boolean c;
      private final List<fxu.b.a> d;

      public b(final int $$0, final int $$1, final ddl $$2, final boolean $$3, final List<fxu.b.a> $$4) {
      ...
      protected static fxu.b.a a(int $$0, int $$1, List<cxp> $$2) {
         return new fxu.b.a(3 + $$0 * 7, 3 + $$1 * 7, $$2);
      }
      ...
      public void b(fns $$0, int $$1, int $$2, float $$3) {
         $$0.a(glv::C, this.b(this.c), this.D(), this.E(), this.g, this.h);
         float $$4 = (float)(this.D() + 2);
         float $$5 = (float)(this.E() + 2);
         float $$6 = 150.0F;

         for (fxu.b.a $$7 : this.d) {
            $$0.c().a();
            $$0.c().a($$4 + (float)$$7.a, $$5 + (float)$$7.b, 150.0F);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0F, -8.0F, 0.0F);
            $$0.a($$7.a(fxu.this.l.currentIndex()), 0, 0);
            $$0.c().b();
         }
      }

      protected static record a(int a, int b, List<cxp> c) {

         public a(int a, int b, List<cxp> c) {
            if (c.isEmpty()) {
   ...
   class c extends fxu.b {
      ...
      public c(final int $$0, final int $$1, final ddl $$2, final ddj $$3, final bbp $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }
