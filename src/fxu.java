...
public class fxu {
   ...
   public fxn a(Vector3f $$0, Vector3f $$1, fxp $$2, ghz $$3, ih $$4, gkh $$5, @Nullable fxq $$6, boolean $$7, ajc $$8) {
      fxr $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = awm.i($$11, $$9.a[0], $$12);
      $$9.a[2] = awm.i($$11, $$9.a[2], $$12);
      $$9.a[1] = awm.i($$11, $$9.a[1], $$13);
      $$9.a[3] = awm.i($$11, $$9.a[3], $$13);
      ...
      return new fxn($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fxr a(fxr $$0, ih $$1, j $$2, ajc $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(awm.b($$23), awm.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fxr(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fxr $$0, ghz $$1, ih $$2, float[] $$3, j $$4, @Nullable fxq $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ih $$2, fxr $$3, float[] $$4, ghz $$5, j $$6, @Nullable fxq $$7, boolean $$8) {
      fwh.b $$9 = fwh.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, ghz $$3, fxr $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fxq $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ih $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (awm.a($$13, $$18) && awm.a($$14, $$19) && awm.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
