...
public class fxu extends fxq {
   ...
   protected void m() {
      ...
      fln<Integer> $$6 = new fln<>("options.fullscreen.resolution", fln.a(), ($$1x, $$2x) -> {
         if ($$2 == null) {
            return wp.c("options.fullscreen.unavailable");
         } else if ($$2x == -1) {
            return flo.a($$1x, wp.c("options.fullscreen.current"));
         } else {
            fex $$3x = $$2.a($$2x);
            return flo.a($$1x, wp.a("options.fullscreen.entry", $$3x.a(), $$3x.b(), $$3x.f(), $$3x.c() + $$3x.d() + $$3x.e()));
         }
      }, new fln.f(-1, $$2 != null ? $$2.e() - 1 : -1), $$3, $$2x -> {
         if ($$2 != null) {
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         if (this.z.g()) {
            ...
            this.m.a(new fxt(w, $$3, ImmutableList.of(new fxt.a(x, $$0x -> {
               this.c.k().a(flc.c);
               flk.Q().f.e();
               this.z.e();
               this.m.a(this);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (fum.s()) {
         fln<Integer> $$4 = this.c.at();
         if ($$4.e() instanceof fln.c $$5) {
            int $$6 = $$4.c();
            int $$7 = $$6 == 0 ? $$5.b() + 1 : $$6;
            int $$8 = $$7 + (int)Math.signum($$3);
            if ($$8 != 0 && $$8 <= $$5.b() && $$8 >= $$5.d()) {
               fpb<Integer> $$9 = (fpb<Integer>)this.d.b($$4);
               if ($$9 != null) {
                  $$4.a($$8);
                  $$9.a($$8);
                  this.d.a(0.0);
