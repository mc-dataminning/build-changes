...
public class fxu extends foy<fxu.b> {
   ...
   public fxu(fxv $$0, fli $$1) {
      super($$1, $$0.n, $$0.s.d(), $$0.s.c(), 20);
      this.m = $$0;
      flg[] $$2 = (flg[])ArrayUtils.clone($$1.n.V);
   ...
   public class c extends fxu.b {
      ...
      protected void c() {
         ...
         if (this.h) {
            ...
            this.f.a(fqd.a(wp.a("controls.keybinds.duplicateKeybinds", $$0)));
         } else {
            this.f.a(null);
         }
