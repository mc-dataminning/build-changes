...
public class bfv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bbf.a(this.a("minecraft:trident", bfv::c), this.a("minecraft:arrow", bfv::a), this.a("minecraft:spectral_arrow", bfv::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfv.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bjb.D, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bjb.D, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bfv.a<?> $$1, Type<?> $$2, Type<T> $$3) {
