...
public class ftz extends ftu<buz, ffn<buz>> {
   private static final Map<buz.a, aer> a = ac.a(Maps.newEnumMap(buz.a.class), $$0 -> {
      $$0.put(buz.a.a, new aer("textures/entity/panda/panda.png"));
      $$0.put(buz.a.b, new aer("textures/entity/panda/lazy_panda.png"));
      $$0.put(buz.a.c, new aer("textures/entity/panda/worried_panda.png"));
      $$0.put(buz.a.d, new aer("textures/entity/panda/playful_panda.png"));
      $$0.put(buz.a.e, new aer("textures/entity/panda/brown_panda.png"));
      $$0.put(buz.a.f, new aer("textures/entity/panda/weak_panda.png"));
      $$0.put(buz.a.g, new aer("textures/entity/panda/aggressive_panda.png"));
   });

   public ftz(fso.a $$0) {
      super($$0, new ffn<>($$0.a(fhm.az)), 0.9F);
      this.a(new fws(this, $$0.d()));
   }

   public aer a(buz $$0) {
      return a.getOrDefault($$0.gl(), a.get(buz.a.a));
   }

   protected void a(buz $$0, elg $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
