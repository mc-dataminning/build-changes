...
public class ftz extends fty {
   ...
   protected void aT_() {
      ...
      this.z = $$0.u();
      this.A = $$0.aZ().m();
      this.c(fom.a(dhf::e).a(dhf.a, dhf.d, dhf.b, dhf.c).a(this.z).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.z = $$1x));
      this.c(fom.b(this.A).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.A = $$1x));
      fof $$1 = fof.a(xv.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         xv $$2;
      ...
      this.C = new foo(this.p, this.n / 2 - 75, 160, 150, 20, xv.c("lanServer.port"));
      this.C.b($$1x -> {
         xv $$2 = this.a($$1x);
      ...
      this.c(this.C);
      this.c($$1);
      this.c(fof.a(xu.e, $$0x -> this.aP_()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
