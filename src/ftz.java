...
public class ftz extends ftx {
   ...
   public ftz(boolean $$0) {
      this($$0, null);
   }

   public ftz(boolean $$0, @Nullable fow $$1) {
      super(b);
      this.y = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fow(false));
   }
   ...
   public static CompletableFuture<Void> a(hbl $$0, Executor $$1) {
      return CompletableFuture.allOf($$0.a(fow.a, $$1), $$0.a(fow.c, $$1), $$0.a(gln.a, $$1), e.a($$0, $$1));
   }
   ...
   protected void aT_() {
      ...
      $$3 = this.a($$3, 24);
      fpk $$4 = this.c(foi.a(20, $$0x -> this.m.a(new fwx(this, this.m.n, this.m.ah())), true));
      int var10001 = this.n / 2 - 124;
      $$3 += 36;
      $$4.c(var10001, $$3);
      this.c(foe.a(xv.c("menu.options"), $$0x -> this.m.a(new fxa(this, this.m.n))).a(this.n / 2 - 100, $$3, 98, 20).a());
      this.c(foe.a(xv.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3, 98, 20).a());
      fpk $$5 = this.c(foi.b(20, $$0x -> this.m.a(new fwu(this, this.m.n)), true));
      $$5.c(this.n / 2 + 104, $$3);
      this.c(new fpd($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new fsz(this)), this.p));
      if (this.w == null) {
         this.w = new fjz();
      }
   ...
   private int a(int $$0, int $$1) {
      if (ab.aU) {
         this.c(foe.a(xv.b("Create Test World"), $$0x -> fyw.b(this.m, this)).a(this.n / 2 - 100, $$0 += $$1, 200, 20).a());
      }
   ...
   private int b(int $$0, int $$1) {
      this.c(foe.a(xv.c("menu.singleplayer"), $$0x -> this.m.a(new fze(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      xv $$2 = this.E();
      boolean $$3 = $$2 == null;
      fpq $$4 = $$2 != null ? fpq.a($$2) : null;
      int var6;
      this.c(foe.a(xv.c("menu.multiplayer"), $$0x -> {
         ftx $$1x = (ftx)(this.m.n.u ? new fwn(this) : new fwo(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, var6 = $$0 + $$1, 200, 20).a($$4).a()).j = $$3;
      this.c(foe.a(xv.c("menu.online"), $$0x -> this.m.a(new fhc(this))).a(this.n / 2 - 100, $$0 = var6 + $$1, 200, 20).a($$4).a()).j = $$3;
      return $$0;
   }
   ...
   private int c(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(foe.a(xv.c("menu.playdemo"), $$1x -> {
         if ($$2) {
            this.m.x().a("Demo_World", () -> this.m.a(this));
         } else {
            this.m.x().a("Demo_World", MinecraftServer.d, een.b, enz::a, this);
         }
   ...
   private boolean F() {
      try {
         boolean var2;
         try (ewc.c $$0 = this.m.m().e("Demo_World")) {
            var2 = $$0.m();
         }
   ...
   private void c(boolean $$0) {
      if ($$0) {
         try (ewc.c $$1 = this.m.m().e("Demo_World")) {
            $$1.k();
         } catch (IOException var7) {
            fqo.b(this.m, "Demo_World");
