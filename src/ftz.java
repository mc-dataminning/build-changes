...
public class ftz implements fud.a {
   ...
   private final etd J;
   private final Map<ht, ftz.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bkq $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dI();
      });
   }

   private void b(enw $$0, fqu $$1, double $$2, double $$3, double $$4) {
      ht $$5 = ht.a($$2, $$3, $$4);
   ...
   private void a(enw $$0, fqu $$1, ftz.a $$2) {
      int $$3 = 0;
   ...
   private void a(enw $$0, fqu $$1, xb.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ful.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(enw $$0, fqu $$1, xb.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(enw $$0, fqu $$1, String $$2, ftz.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(ftz.a $$0) {
      return this.b($$0.a).stream().map(acj::a).collect(Collectors.toSet());
   }

   private Set<String> c(ftz.a $$0) {
      return this.c($$0.a).stream().map(acj::a).collect(Collectors.toSet());
   }
   ...
   private void d() {
      fud.a(this.J.al(), 8).ifPresent($$0 -> this.M = $$0.cw());
   }
