public class ftz<T extends bsu> extends fuj<T> {
   ...
   public static fxg b() {
      ...
      for (int $$3 = 0; $$3 < 4; $$3++) {
         $$1.a(
            a($$3),
            fxf.c().a(f[$$3][0], f[$$3][1]).a((float)b[$$3][0] * -0.5F, 0.0F, (float)b[$$3][2] * -0.5F, (float)b[$$3][0], (float)b[$$3][1], (float)b[$$3][2]),
            fxc.a(0.0F, (float)(24 - b[$$3][1]), $$2)
         );
         if ($$3 < 3) {
