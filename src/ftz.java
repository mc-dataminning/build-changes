...
public class ftz {
   private static final alp a = alp.b("advancements/title_box");
   ...
   private final ai r;
   private final at s;
   private final List<azg> t;
   private final int u;
   private final List<azg> v;
   private final flz w;
   @Nullable
   private ftz x;
   private final List<ftz> y = Lists.newArrayList();
   @Nullable
   private aj z;
   private final int A;
   private final int B;

   public ftz(ftx $$0, flz $$1, ai $$2, at $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
      this.t = $$1.h.c($$3.a(), 163);
      this.A = azu.d($$3.f() * 28.0F);
      this.B = azu.d($$3.g() * 27.0F);
      int $$4 = Math.max(this.t.stream().mapToInt($$1.h::a).max().orElse(0), 80);
      int $$5 = this.e();
      int $$6 = 29 + $$4 + $$5;
      this.v = uh.a().a(this.a(xn.a($$3.b().f(), yh.a.a($$3.e().a())), $$6));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         xk $$2 = xk.a("advancements.progress", $$0, $$0);
         return this.w.h.a($$2) + 8;
      }
   }

   private static float a(fmj $$0, List<xp> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xp> a(xk $$0, int $$1) {
      fmj $$2 = this.w.h.b();
      List<xp> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : p) {
         List<xp> $$6 = $$2.b($$0, $$1 - $$5, yh.a);
   ...
   public void a(fnl $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(glq::H, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(fnl $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fnj $$6 = this.w.h;
      ...
      xk $$13 = this.z == null ? null : this.z.d();
      int $$14 = $$13 == null ? 0 : $$6.a($$13);
      boolean $$15 = $$9 + $$11 >= 113;
      float $$16 = this.z == null ? 0.0F : this.z.c();
      int $$17 = azu.d($$16 * (float)this.u);
      fua $$18;
      fua $$19;
      fua $$20;
      if ($$16 >= 1.0F) {
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(glq::H, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(glq::H, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(glq::H, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(glq::H, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(glq::H, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(glq::H, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(fnl $$0, List<azg> $$1, int $$2, int $$3, int $$4) {
      fnj $$5 = this.w.h;
