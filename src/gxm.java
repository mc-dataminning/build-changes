...
public class gxm extends gye<coj, hds, ggy> {
   ...
   private static final grc k = grc.g(j);

   public gxm(gwy.a $$0) {
      this($$0, 0.5F, gjs.bj);
   }

   protected gxm(gwy.a $$0, float $$1, gjr $$2) {
      super($$0, new ggy($$0.a($$2)), $$1);
   }

   public boolean a(coj $$0, guk $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.x()) {
            bxj $$5 = $$0.gt();
            if ($$5 != null) {
               ffc $$6 = this.a($$5, (double)$$5.dq() * 0.5, 1.0F);
               ffc $$7 = this.a($$0, (double)$$0.cR(), 1.0F);
               return $$1.a(new fex($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private ffc a(bxj $$0, double $$1, float $$2) {
   ...
   public void a(hds $$0, fkd $$1, gqr $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      ffc $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fkd $$0, fkh $$1, ffc $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fkh $$0, fkd.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hjg.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(coj $$0, hds $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.n($$2);
