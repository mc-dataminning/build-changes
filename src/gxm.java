...
public class gxm implements gxp.a, AutoCloseable {
   ...
   fct[] f;
   @Nullable
   private final gxm.a g;
   private final avc h;

   public gxm(alh $$0, gzg $$1, fct $$2, avc $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gze $$4 = $$3.a(gze.a).orElse(gze.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new fct[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gxh.a(this.f, $$0);
   ...
   @Nullable
   private gxm.a a(gzg $$0, int $$1, int $$2, gze $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gxm.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gxm.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gxm.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gxm.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gxm.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gxm.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fct[] $$4) {
   ...
   class a {
      ...
      a(final List<gxm.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gxm.this.c;
         int $$4 = this.b($$2) * gxm.this.d;
         gxm.this.a($$0, $$1, $$3, $$4, gxm.this.f);
      }

      public gxo a() {
         return gxm.this.new d(this, this.d ? gxm.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fct[] b = new fct[gxm.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gxm.this.c >> $$0;
            int $$2 = gxm.this.d >> $$0;
            this.b[$$0] = new fct($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gxm.d $$2) {
         gxm.a $$3 = $$2.c;
         List<gxm.b> $$4 = $$3.b;
         gxm.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gxm.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gxm.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gxm.this.f[$$2].a($$3 + ($$0.a($$1) * gxm.this.c >> $$2), $$4 + ($$0.b($$1) * gxm.this.d >> $$2));
      }
   ...
   class d implements gxo {
      int a;
      int b;
      final gxm.a c;
      @Nullable
      private final gxm.c d;

      d(final gxm.a $$0, @Nullable final gxm.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
