...
public class enc {
   public static final aku<enb> a = a("normal");
   public static final aku<enb> b = a("flat");
   public static final aku<enb> c = a("large_biomes");
   public static final aku<enb> d = a("amplified");
   public static final aku<enb> e = a("single_biome_surface");
   public static final aku<enb> f = a("debug_all_block_states");

   public static void a(qe<enb> $$0) {
      new enc.a($$0).a();
   }

   private static aku<enb> a(String $$0) {
      return aku.a(mc.bb, akv.b($$0));
   }

   public static Optional<aku<enb>> a(edn $$0) {
   ...
   static class a {
      ...
      private void a(aku<enb> $$0, eat $$1) {
         this.a.a($$0, this.a($$1));
      }
