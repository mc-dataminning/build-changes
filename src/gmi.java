...
public class gmi implements gml.a, AutoCloseable {
   ...
   ewo[] f;
   @Nullable
   private final gmi.a g;
   private final atq h;

   public gmi(akf $$0, goa $$1, ewo $$2, atq $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gny $$4 = $$3.a(gny.a).orElse(gny.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ewo[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gmd.a(this.f, $$0);
   ...
   @Nullable
   private gmi.a a(goa $$0, int $$1, int $$2, gny $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gmi.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gmi.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gmi.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gmi.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gmi.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gmi.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ewo[] $$4) {
   ...
   class a {
      ...
      a(List<gmi.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gmi.this.c;
         int $$4 = this.b($$2) * gmi.this.d;
         gmi.this.a($$0, $$1, $$3, $$4, gmi.this.f);
      }

      public gmk a() {
         return gmi.this.new d(this, this.d ? gmi.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ewo[] b = new ewo[gmi.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gmi.this.c >> $$0;
            int $$2 = gmi.this.d >> $$0;
            this.b[$$0] = new ewo($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gmi.d $$2) {
         gmi.a $$3 = $$2.d;
         List<gmi.b> $$4 = $$3.b;
         gmi.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gmi.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gmi.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gmi.this.f[$$2].a($$3 + ($$0.a($$1) * gmi.this.c >> $$2), $$4 + ($$0.b($$1) * gmi.this.d >> $$2));
      }
   ...
   class d implements gmk {
      int b;
      int c;
      final gmi.a d;
      @Nullable
      private final gmi.c e;

      d(gmi.a $$0, @Nullable gmi.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
