public class gvr extends gvj<cri, hbx> {
   private static final ale a = ale.b("textures/entity/fishing_hook.png");
   private static final gpn g = gpn.f(a);
   ...
   public boolean a(cri $$0, gsw $$1, double $$2, double $$3, double $$4) {
      return super.a($$0, $$1, $$2, $$3, $$4) && $$0.g() != null;
   }

   public void a(hbx $$0, fiq $$1, gpd $$2, int $$3) {
      $$1.a();
      $$1.a();
      $$1.b(0.5F, 0.5F, 0.5F);
      $$1.a(this.d.b());
   ...
   public static bws a(cqs $$0) {
      return $$0.fa().h() instanceof cyb ? $$0.fx() : $$0.fx().e();
   }

   private fdw a(cqs $$0, float $$1, float $$2) {
      int $$3 = a($$0) == bws.b ? 1 : -1;
      if (this.d.d.aE().a() && $$0 == fof.Q().t) {
         double $$11 = 960.0 / (double)this.d.d.ak().c().intValue();
         fdw $$12 = this.d.b.j().a((float)$$3 * 0.525F, -0.1F).c($$11).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.n($$2).e($$12);
      } else {
         float $$4 = azk.h($$2, $$0.aW, $$0.aV) * (float) (Math.PI / 180.0);
   ...
   private static void a(fiu $$0, fiq.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(hhp.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }

   private static void a(float $$0, float $$1, float $$2, fiu $$3, fiq.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
   ...
   public void a(cri $$0, hbx $$1, float $$2) {
      super.a($$0, $$1, $$2);
      cqs $$3 = $$0.g();
      if ($$3 == null) {
         $$1.a = fdw.c;
