...
public class csn {
   public static final bxv a = bxx.a(bwm.aZ);
   public static final MapCodec<csn> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               csn.a.e.fieldOf("status").forGetter($$0x -> $$0x.O),
   ...
   private final Map<Integer, cso> z = Maps.newHashMap();
   private final Map<Integer, Set<cso>> A = Maps.newHashMap();
   ...
   private boolean H;
   private int I;
   private final arm J = new arm(u, btr.a.c, btr.b.c);
   private int K;
   private int L;
   ...
   private csn(boolean $$0, boolean $$1, long $$2, int $$3, int $$4, int $$5, int $$6, float $$7, int $$8, csn.a $$9, iu $$10, Set<UUID> $$11) {
      this.E = $$0;
      this.H = $$1;
      this.C = $$2;
      this.G = $$3;
   ...
   public boolean d() {
      return this.O == csn.a.d;
   }

   public boolean e() {
      return this.O == csn.a.b;
   }

   public boolean f() {
      return this.O == csn.a.c;
   }
   ...
   public Set<cso> h() {
      Set<cso> $$0 = Sets.newHashSet();

      for (Set<cso> $$1 : this.A.values()) {
         $$0.addAll($$1);
      }
               ...
               if (this.K < 40) {
                  ...
                  for (UUID $$8 : this.B) {
                     ...
                     if ($$9 instanceof bxc) {
                        bxc $$10 = (bxc)$$9;
                        if (!$$9.U_()) {
                           $$10.a(new bvh(bvj.F, 48000, this.G - 1, false, false, true));
   ...
   private void e(arq $$0) {
      Iterator<Set<cso>> $$1 = this.A.values().iterator();
   ...
   private void a(arq $$0, iu $$1) {
      ...
      for (arr $$6 : $$0.z()) {
         ...
         if ($$9 <= 64.0 || $$4.contains($$6)) {
            $$6.f.b(new afv(awn.vN, awo.g, $$10, $$6.dC(), $$11, 64.0F, 1.0F, $$5));
         }
      }
   }
   ...
   public void a(arq $$0, int $$1, cso $$2, @Nullable iu $$3, boolean $$4) {
   ...
   public void a(arq $$0, cso $$1, boolean $$2) {
      Set<cso> $$3 = this.A.get($$1.gF());
      if ($$3 != null) {
   ...
   public static cyy a(jf<dwm> $$0) {
      cyy $$1 = new cyy(czc.vV);
      dwn $$2 = new dwn.a()
         .a($$0, dwo.z, cxw.j)
         .a($$0, dwo.f, cxw.i)
         .a($$0, dwo.j, cxw.h)
         ...
         if (azm.a($$10 - this.D.v()) <= 96) {
            ...
            if (!$$0.c($$4) || $$2 <= 7) {
               ...
               if ($$0.b($$4.u() - 10, $$4.w() - 10, $$4.u() + 10, $$4.w() + 10)
                  && $$0.f($$4)
                  && (a.isSpawnPositionOk($$0, $$4, bwm.aZ) || $$0.a_($$4.e()).a(dmc.eb) && $$0.a_($$4).l())) {
                  return $$4;
               }
            }
         }
   ...
   private boolean a(arq $$0, int $$1, cso $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   public boolean a(arq $$0, int $$1, cso $$2, boolean $$3) {
      this.A.computeIfAbsent($$1, $$0x -> Sets.newHashSet());
      Set<cso> $$4 = this.A.get($$1);
      cso $$5 = null;
   ...
   public void a(int $$0, cso $$1) {
      this.z.put($$0, $$1);
      $$1.a(bwn.f, a($$1.dX().f(mg.aF)));
      $$1.a(bwn.f, 2.0F);
   }
   ...
   private int a(csn.b $$0, int $$1, boolean $$2) {
      return $$2 ? $$0.h[this.N] : $$0.h[$$1];
   }

   private int a(csn.b $$0, azv $$1, int $$2, btz $$3, boolean $$4) {
      bty $$5 = $$3.a();
      boolean $$6 = $$5 == bty.b;
      boolean $$7 = $$5 == bty.c;
      int $$9;
   ...
   static enum a implements bak {
      ...
      public static final Codec<csn.a> e = bak.a(csn.a::values);
   ...
   static enum b {
      a(bwm.bE, new int[]{0, 0, 2, 0, 1, 4, 2, 5}),
      b(bwm.S, new int[]{0, 0, 0, 0, 0, 1, 1, 2}),
      c(bwm.aT, new int[]{0, 4, 3, 3, 4, 4, 4, 2}),
      d(bwm.bI, new int[]{0, 0, 0, 0, 3, 0, 0, 1}),
      e(bwm.aZ, new int[]{0, 0, 0, 1, 0, 1, 0, 2});

      static final csn.b[] f = values();
      final bwm<? extends cso> g;
      final int[] h;

      private b(final bwm<? extends cso> $$0, final int[] $$1) {
         this.g = $$0;
         this.h = $$1;
      }
   }
