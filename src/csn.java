...
public record csn(int c, int d, is<csc> e, Optional<csn.a> f) {
   private static final int g = 3;
   public static final MapCodec<csn> a = csn.a.a
      .flatXmap(csn::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final xo<vb, csn> b = xo.a(csn::a, csn::b);

   public static csn a(Map<Character, csc> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static csn a(Map<Character, csc> $$0, List<String> $$1) {
      csn.a $$2 = new csn.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<csn> a(csn.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      is<csc> $$4 = is.a($$2 * $$3, csc.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new csn($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(ckv $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static csn b(vb $$0) {
      int $$1 = $$0.n();
      int $$2 = $$0.n();
      is<csc> $$3 = is.a($$1 * $$2, csc.a);
      $$3.replaceAll($$1x -> csc.b.decode($$0));
      return new csn($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<csn.a> d() {
      return this.f;
   }

   public static record a(Map<Character, csc> b, List<String> c) {
      ...
      public static final MapCodec<csn.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(avq.d(e, csc.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, csn.a::new)
      );

      public Map<Character, csc> a() {
         return this.b;
      }
