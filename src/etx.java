...
public class etx<T> {
   ...
   private final etw<T> e;
   private final Queue<etx.a<T>> f = new PriorityQueue<>(c());
   private UnsignedLong g = UnsignedLong.ZERO;
   private final Table<String, Long, etx.a<T>> h = HashBasedTable.create();

   private static <T> Comparator<etx.a<T>> c() {
      return Comparator.<etx.a<T>>comparingLong($$0 -> $$0.a).thenComparing($$0 -> $$0.b);
   }

   public etx(etw<T> $$0, Stream<? extends Dynamic<?>> $$1) {
      this($$0);
      this.f.clear();
      this.h.clear();
   ...
   public void a(String $$0, long $$1, etv<T> $$2) {
      if (!this.h.contains($$0, $$1)) {
         this.g = this.g.plus(UnsignedLong.ONE);
         etx.a<T> $$3 = new etx.a<>($$1, this.g, $$0, $$2);
         this.h.put($$0, $$1, $$3);
         this.f.add($$3);
      }
   }
   ...
   public int a(String $$0) {
      Collection<etx.a<T>> $$1 = this.h.row($$0).values();
   ...
   public static class a<T> {
      ...
      public final etv<T> d;

      a(long $$0, UnsignedLong $$1, String $$2, etv<T> $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
