...
public class etx {
   ...
   static class a implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
         return $$0.c[jb.f.d()] && !$$0.b[jb.f.d()].d;
      }

      @Override
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jb.f.d()].d = true;
         return new etx.k($$0, $$1);
      }
   }

   static class b implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         ...
         return new etx.l($$0, $$1);
      }
   }

   static class c implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jb.b.d()].d = true;
         return new etx.m($$0, $$1);
      }
   }

   static class d implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         ...
         return new etx.n($$0, $$1);
      }
   }

   static class e implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         ...
         $$3.d = true;
         $$3.b[jb.c.d()].d = true;
         return new etx.o($$0, $$3);
      }
   }

   static class f implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
         return true;
      }
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         $$1.d = true;
         return new etx.s($$0, $$1, $$2);
      }
   }

   static class g implements etx.i {
      @Override
      public boolean a(etx.v $$0) {
      ...
      public etx.r a(jb $$0, etx.v $$1, azv $$2) {
         $$1.d = true;
         return new etx.t($$0, $$1);
      }
   }

   public static class h extends etx.r {
      ...
      private etx.v G;
      private etx.v H;
      private final List<etx.r> I = Lists.newArrayList();

      public h(azv $$0, int $$1, int $$2, jb $$3) {
         super(ese.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<etx.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new etx.p($$3, this.G));
         this.I.add(new etx.j($$3, this.H));
         List<etx.i> $$5 = Lists.newArrayList();
         $$5.add(new etx.b());
         $$5.add(new etx.d());
         $$5.add(new etx.e());
         $$5.add(new etx.a());
         ...
         erf $$10 = erf.a(this.b(1, 1, 1), this.b(23, 8, 21));
         erf $$11 = erf.a(this.b(34, 1, 1), this.b(56, 8, 21));
         erf $$12 = erf.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new etx.u($$3, $$10, $$13++));
         this.I.add(new etx.u($$3, $$11, $$13++));
         this.I.add(new etx.q($$3, $$12));
      }
      ...
      private List<etx.v> b(azv $$0) {
         etx.v[] $$1 = new etx.v[75];
         ...
         etx.v $$23 = new etx.v(1003);
         etx.v $$24 = new etx.v(1001);
         etx.v $$25 = new etx.v(1002);
         $$1[v].a(jb.b, $$23);
         $$1[w].a(jb.d, $$24);
         $$1[x].a(jb.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<etx.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dkl $$2, azv $$3, erf $$4) {
         int $$5 = 24;
      ...
      private void a(dkl $$0, azv $$1, erf $$2) {
      ...
      private void b(dkl $$0, azv $$1, erf $$2) {
      ...
      private void c(dkl $$0, azv $$1, erf $$2) {
      ...
      private void d(dkl $$0, azv $$1, erf $$2) {
      ...
      private void e(dkl $$0, azv $$1, erf $$2) {
      ...
      private void f(dkl $$0, azv $$1, erf $$2) {
   ...
   interface i {
      boolean a(etx.v var1);

      etx.r a(jb var1, etx.v var2, azv var3);
   }

   public static class j extends etx.r {
      public j(jb $$0, etx.v $$1) {
         super(ese.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dkl $$0, dki $$1, ecr $$2, azv $$3, erf $$4, dir $$5, iv $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dmt.cr.m(), dmt.cr.m(), false);
   ...
   public static class k extends etx.r {
      public k(jb $$0, etx.v $$1) {
         super(ese.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends etx.r {
      public l(jb $$0, etx.v $$1) {
         super(ese.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends etx.r {
      public m(jb $$0, etx.v $$1) {
         super(ese.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends etx.r {
      public n(jb $$0, etx.v $$1) {
         super(ese.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends etx.r {
      public o(jb $$0, etx.v $$1) {
         super(ese.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends etx.r {
      public p(jb $$0, etx.v $$1) {
         super(ese.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends etx.r {
      public q(jb $$0, erf $$1) {
         super(ese.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends err {
      protected static final eat b = dmt.iB.m();
      protected static final eat c = dmt.iC.m();
      protected static final eat d = dmt.iD.m();
      protected static final eat h = c;
      protected static final eat i = dmt.iK.m();
      protected static final boolean j = true;
      protected static final eat k = dmt.J.m();
      protected static final Set<dmr> l = ImmutableSet.builder().add(dmt.ee).add(dmt.je).add(dmt.nC).add(k.b()).build();
      ...
      public r(ese $$0, jb $$1, int $$2, erf $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ese $$0, int $$1, jb $$2, etx.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static erf a(jb $$0, etx.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         erf $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dkl $$0, erf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  eat $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dkl $$0, erf $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dkl $$0, erf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, eat $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(erf $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dkl $$0, erf $$1, int $$2, int $$3, int $$4) {
         iv $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            coc $$6 = bwr.M.a($$0.a(), bwq.d);
            if ($$6 != null) {
               $$6.c($$6.eT());
   ...
   public static class s extends etx.r {
      private int a;

      public s(jb $$0, etx.v $$1, azv $$2) {
         super(ese.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends etx.r {
      public t(jb $$0, etx.v $$1) {
         super(ese.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends etx.r {
      private int a;

      public u(jb $$0, erf $$1, int $$2) {
         super(ese.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
