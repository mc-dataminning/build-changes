...
public class etx {
   ...
   public static List<etx.a> a(String $$0, etx.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<etx.a> a(String $$0, List<etx.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<etx.a> a(List<String> $$0, List<etx.b> $$1) {
      int $$2 = 0;
      List<etx.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<etx.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static etx.b a(String $$0, String $$1) {
         return new etx.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static etx.b a(String $$0) {
         return new etx.b($$0);
      }
   }
}
