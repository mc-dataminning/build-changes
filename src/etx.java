...
public class etx {
   private static final Map<String, etx.a> a = Maps.newHashMap();
   ...
   private static ahg b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            ahg $$4 = ged.b();
            a.put($$0, new etx.a($$1, $$4));
            return $$4;
         } else {
            ahg $$5 = new ahg("realms", "dynamic/" + $$0);
            evi.O().Y().a($$5, new gea($$3));
            a.put($$0, new etx.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static epc a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return epc.a($$2.put($$1).flip());
