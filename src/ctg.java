...
public class ctg {
   ...
   public ctg(brr $$0, int $$1, int $$2, int $$3) {
      this.c = $$0;
      this.a = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public Optional<cvx> a(int $$0, int $$1, coh $$2) {
      if (!this.a($$2)) {
   ...
   public cvx b(int $$0, int $$1, coh $$2) {
      Optional<cvx> $$3 = this.a($$0, $$1, $$2);
      $$3.ifPresent($$1x -> this.a($$2, $$1x));
      return $$3.orElse(cvx.k);
   }
