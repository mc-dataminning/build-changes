...
public abstract class gks<T extends btd, M extends fuo<T>> extends gkn<T, M> {
   public static final int h = 24;

   public gks(gjm.a $$0, M $$1, float $$2) {
      super($$0, $$1, $$2);
   }

   protected boolean a(T $$0) {
      return super.b($$0) && ($$0.cG() || $$0.ah() && $$0 == this.c.c);
   }
   ...
   private <E extends bsg> void a(T $$0, float $$1, fam $$2, ged $$3, E $$4) {
      $$2.a();
      ewf $$5 = $$4.r($$1);
      double $$6 = (double)(ayg.i($$1, $$0.aZ, $$0.aY) * (float) (Math.PI / 180.0)) + (Math.PI / 2);
      ewf $$7 = $$0.q($$1);
      double $$8 = Math.cos($$6) * $$7.e + Math.sin($$6) * $$7.c;
      double $$9 = Math.sin($$6) * $$7.e - Math.cos($$6) * $$7.c;
      double $$10 = ayg.d((double)$$1, $$0.L, $$0.dv()) + $$8;
      double $$11 = ayg.d((double)$$1, $$0.M, $$0.dx()) + $$7.d;
      double $$12 = ayg.d((double)$$1, $$0.N, $$0.dB()) + $$9;
      $$2.a($$8, $$7.d, $$9);
      float $$13 = (float)($$5.c - $$10);
      float $$14 = (float)($$5.d - $$11);
      float $$15 = (float)($$5.e - $$12);
      float $$16 = 0.025F;
      faq $$17 = $$3.getBuffer(gel.h());
      Matrix4f $$18 = $$2.c().a();
      ...
      int $$26 = $$0.dQ().a(dco.a, $$22);
      int $$27 = $$0.dQ().a(dco.a, $$23);
