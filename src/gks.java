...
public class gks extends gkm<cfd, fvh<cfd>> {
   private static final Map<cfd.a, akk> a = ac.a(Maps.newEnumMap(cfd.a.class), $$0 -> {
      $$0.put(cfd.a.a, new akk("textures/entity/panda/panda.png"));
      $$0.put(cfd.a.b, new akk("textures/entity/panda/lazy_panda.png"));
      $$0.put(cfd.a.c, new akk("textures/entity/panda/worried_panda.png"));
      $$0.put(cfd.a.d, new akk("textures/entity/panda/playful_panda.png"));
      $$0.put(cfd.a.e, new akk("textures/entity/panda/brown_panda.png"));
      $$0.put(cfd.a.f, new akk("textures/entity/panda/weak_panda.png"));
      $$0.put(cfd.a.g, new akk("textures/entity/panda/aggressive_panda.png"));
   });

   public gks(gjg.a $$0) {
      super($$0, new fvh<>($$0.a(fxh.aF)), 0.9F);
      this.a(new gno(this, $$0.d()));
   }

   public akk a(cfd $$0) {
      return a.getOrDefault($$0.gz(), a.get(cfd.a.a));
   }

   protected void a(cfd $$0, fag $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.cb > 0) {
         int $$6 = $$0.cb;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(aye.i($$25, $$0.dH(), $$0.dH() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(aye.i($$27, $$0.dH(), $$0.dH() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? aye.i($$3, $$0, $$1) : $$0;
   }
}
