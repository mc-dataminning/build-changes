...
public class gks extends awa<Optional<gks.b>> implements AutoCloseable {
   ...
   protected Optional<gks.b> a(avv $$0, bps $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gks.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gks.b> $$0, avv $$1, bps $$2) {
   ...
   public void a(int $$0, flr $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fbx $$5, float $$6) {
      if (this.q != null) {
   ...
   private void a(glu $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gkt $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fgq a(fgt $$0, int $$1, int $$2, flr $$3, gks.a $$4, glu $$5) {
      float $$6 = 0.8F;
      ...
      fgm $$11 = $$0.a($$5.P(), $$5.O());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == flr.c);
      return $$11.a();
   }

   private void a(gks.a $$0, fgm $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(gks.a $$0, fgm $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
