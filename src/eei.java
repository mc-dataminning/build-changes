...
public class eei implements ho {
   public static final Codec<eei> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> ac.a($$0, 3).map($$0x -> new eei((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   ...
   public static eei a(hz $$0) {
      return new eei((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }
   ...
   public eei d() {
      ...
      return $$0 < 1.0E-4 ? b : new eei(this.c / $$0, this.d / $$0, this.e / $$0);
   }
   ...
   public static eei a(float $$0, float $$1) {
      float $$2 = apa.b(-$$1 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$3 = apa.a(-$$1 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$4 = -apa.b(-$$0 * (float) (Math.PI / 180.0));
      float $$5 = apa.a(-$$0 * (float) (Math.PI / 180.0));
      return new eei((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }
