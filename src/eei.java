...
public class eei {
   ...
   private final Map<String, edx> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public eei(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends edx> T a(edx.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends edx> T b(edx.a $$0, String $$1) {
      edx $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends edx> T a(Function<rz, T> $$0, aus $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
   ...
   public void a(String $$0, edx $$1) {
      this.b.put($$0, $$1);
   }

   public rz a(String $$0, aus $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
