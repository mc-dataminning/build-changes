...
public class eei extends eec {
   public static final Codec<eei> a = RecordCodecBuilder.create(
      $$0 -> a($$0).and(arf.a(eei.b.a.listOf()).fieldOf("modifiers").forGetter($$0x -> $$0x.b)).apply($$0, eei::new)
   );
   ...
   public static eei.c a(String $$0, he<bkh> $$1, bkk.a $$2, egk $$3) {
   ...
   static record b(String b, he<bkh> c, bkk.a d, egk e, List<biv> f, Optional<UUID> g) {
      private static final Codec<List<biv>> h = arf.a(
