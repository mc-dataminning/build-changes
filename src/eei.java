...
public class eei {
   private static final dxv a = dko.hz.m();
   private static final dxv b = dko.hA.m();
   private static final dxv c = dko.iR.m();
   private static final dxv d = dko.hD.m();
   private static final dxv e = dko.hL.m();
   private static final dxv f = dko.hN.m();
   private static final dxv g = dko.hH.m();
   private static final dxv h = dko.iT.m();
   private static final dxv i = dko.ec.m();
   private final dxv j;
   private final int k;
   private final dxv[] l;
   private final eta m;
   ...
   public eei(eee $$0, dxv $$1, int $$2, eed $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(edz.P);
   ...
   public void a(eee $$0, dim $$1, kd<dik> $$2, boolean $$3, een $$4, final dzq $$5, edu $$6, eeh.o $$7) {
      ...
      eeh.g $$13 = new eeh.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      eeh.u $$14 = $$7.apply($$13);
      jh.a $$15 = new jh.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(edq.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            jq<dik> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dir.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(edq.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dxv> a(eeh.o $$0, efr $$1, Function<jh, jq<dik>> $$2, dzq $$3, edu $$4, jh $$5, boolean $$6) {
      eeh.g $$7 = new eeh.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().e(mb.aI), $$1);
      eeh.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dxv $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dzn $$0, int $$1, int $$2, int $$3, dhk $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dik $$1, dzn $$2, jh.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dko.J) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(bam $$0, dxv[] $$1, int $$2, dxv $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dxv a(int $$0, int $$1, int $$2) {
