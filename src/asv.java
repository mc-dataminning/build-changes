...
public class asv implements ajj, wm {
   ...
   public asv(MinecraftServer $$0, vr $$1, boolean $$2) {
      this.f = $$0;
      this.g = $$1;
   ...
   public void a(ajl $$0) {
      ...
      Validate.validState(bal.f($$0.b()), "Invalid characters in username", new Object[0]);
      this.j = $$0.b();
   ...
   private void c(GameProfile $$0) {
      ...
      if ($$2 != null) {
         ...
         if (this.f.az() >= 0 && !this.g.e()) {
            this.g.a(new aje(this.f.az()), wf.a(() -> this.g.a(this.f.az(), true)));
         }
   ...
   public void a(ajm $$0) {
      ...
      try {
         ...
         Cipher $$3 = ayj.a(2, $$2);
         Cipher $$4 = ayj.a(1, $$2);
         $$5 = new BigInteger(ayj.a("", this.f.R().getPublic(), $$2)).toString(16);
         this.h = asv.a.c;
         this.g.a($$3, $$4);
      } catch (ayk var7) {
