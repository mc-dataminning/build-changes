...
public class asv {
   ...
   private static List<asv.b> a(final Path $$0) throws IOException {
      try {
         final List<asv.b> $$1 = new ArrayList<>();
   ...
   private static List<asv.a> a(List<asv.b> $$0) {
      List<asv.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (asv.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new asv.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<asv.a> a = Comparator.comparing(asv.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<asv.b> a = Comparator.comparing(asv.b::b).reversed();
