...
public class asv extends asj<GameProfile> {
   public asv(@Nullable GameProfile $$0) {
      this($$0, null, null, null, null);
   }

   public asv(@Nullable GameProfile $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }

   public asv(JsonObject $$0) {
      super(b($$0), $$0);
   }
