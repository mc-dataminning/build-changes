...
public class asv implements atc {
   private final atc c;
   private final List<atc> d;

   public asv(atc $$0, List<atc> $$1) {
      this.c = $$0;
      List<atc> $$2 = new ArrayList<>($$1.size() + 1);
   ...
   @Nullable
   @Override
   public <T> T a(atp<T> $$0) throws IOException {
      return this.c.a($$0);
   }
