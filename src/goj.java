...
public class goj extends gni<buj, gui> {
   public goj(gnj.a $$0) {
      super($$0);
   }

   public void a(gui $$0, fde $$1, ghg $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(buj $$0, gui $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(buj $$0) {
      return false;
   }
}
