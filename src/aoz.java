...
public class aoz {
   ...
   private static ArgumentBuilder<ew, ?> a(es $$0, ArgumentBuilder<ew, ?> $$1, aoz.a $$2) {
      return $$1.then(ex.a("blank").executes($$1x -> $$2.run($$1x, yz.a))).then(ex.a("fixed").then(ex.a("contents", ff.a($$0)).executes($$1x -> {
         xl $$2x = ff.a($$1x, "contents");
   ...
   private static CompletableFuture<Suggestions> a(ew $$0, Collection<fav> $$1, SuggestionsBuilder $$2) {
   ...
   private static int a(ew $$0, fav $$1, fao $$2) throws CommandSyntaxException {
      faw $$3 = $$0.l().aJ();
      fas $$4 = $$3.d($$1, $$2);
      if ($$4 == null) {
         throw f.create($$2.b(), $$1.hk());
      } else {
         $$0.a(() -> xl.a("commands.scoreboard.players.get.success", $$1.hk(), $$4.a(), $$2.g()), false);
         return $$4.a();
      }
   }
   ...
   private static int a(ew $$0, Collection<fav> $$1, fao $$2, fs.a $$3, Collection<fav> $$4, fao $$5) throws CommandSyntaxException {
      faw $$6 = $$0.l().aJ();
      int $$7 = 0;
   ...
   private static int a(ew $$0, Collection<fav> $$1, fao $$2) throws CommandSyntaxException {
      if ($$2.c() != faz.c) {
         throw e.create();
      } else {
         faw $$3 = $$0.l().aJ();
   ...
   private static int b(ew $$0, Collection<fav> $$1, fao $$2) {
      faw $$3 = $$0.l().aJ();
   ...
   private static int a(ew $$0, Collection<fav> $$1, fao $$2, int $$3) {
      faw $$4 = $$0.l().aJ();
   ...
   private static int a(ew $$0, Collection<fav> $$1, fao $$2, @Nullable xl $$3) {
      faw $$4 = $$0.l().aJ();
   ...
   private static int a(ew $$0, Collection<fav> $$1, fao $$2, @Nullable zb $$3) {
      faw $$4 = $$0.l().aJ();
   ...
   private static int b(ew $$0, Collection<fav> $$1, fao $$2, int $$3) {
      faw $$4 = $$0.l().aJ();
      int $$5 = 0;
   ...
   private static int c(ew $$0, Collection<fav> $$1, fao $$2, int $$3) {
      faw $$4 = $$0.l().aJ();
      int $$5 = 0;
   ...
   private static int a(ew $$0) {
      Collection<fav> $$1 = $$0.l().aJ().e();
      if ($$1.isEmpty()) {
         $$0.a(() -> xl.c("commands.scoreboard.players.list.empty"), false);
      } else {
         $$0.a(() -> xl.a("commands.scoreboard.players.list.success", $$1.size(), xo.b($$1, fav::hk)), false);
      }
   ...
   private static int a(ew $$0, fav $$1) {
      Object2IntMap<fao> $$2 = $$0.l().aJ().c($$1);
      if ($$2.isEmpty()) {
         $$0.a(() -> xl.a("commands.scoreboard.players.list.entity.empty", $$1.hk()), false);
      } else {
         $$0.a(() -> xl.a("commands.scoreboard.players.list.entity.success", $$1.hk(), $$2.size()), false);
         Object2IntMaps.fastForEach(
            $$2, $$1x -> $$0.a(() -> xl.a("commands.scoreboard.players.list.entity.entry", ((fao)$$1x.getKey()).g(), $$1x.getIntValue()), false)
         );
      }
   ...
   private static int a(ew $$0, fan $$1, fao $$2) throws CommandSyntaxException {
      faw $$3 = $$0.l().aJ();
      if ($$3.a($$1) == $$2) {
         throw c.create();
      } else {
   ...
   private static int a(ew $$0, fao $$1, xl $$2) {
      if (!$$1.d().equals($$2)) {
         $$1.a($$2);
   ...
   private static int a(ew $$0, fao $$1, boolean $$2) {
      if ($$1.e() != $$2) {
         $$1.a($$2);
         if ($$2) {
   ...
   private static int a(ew $$0, fao $$1, @Nullable zb $$2) {
      $$1.b($$2);
      if ($$2 != null) {
   ...
   private static int a(ew $$0, fao $$1, faz.a $$2) {
      if ($$1.h() != $$2) {
         $$1.a($$2);
   ...
   private static int a(ew $$0, fao $$1) {
      faw $$2 = $$0.l().aJ();
      $$2.j($$1);
   ...
   private static int a(ew $$0, String $$1, faz $$2, xl $$3) throws CommandSyntaxException {
      faw $$4 = $$0.l().aJ();
      if ($$4.a($$1) != null) {
         throw a.create();
      } else {
   ...
   private static int b(ew $$0) {
      Collection<fao> $$1 = $$0.l().aJ().c();
      if ($$1.isEmpty()) {
         $$0.a(() -> xl.c("commands.scoreboard.objectives.list.empty"), false);
      } else {
         $$0.a(() -> xl.a("commands.scoreboard.objectives.list.success", $$1.size(), xo.b($$1, fao::g)), false);
      }
   ...
   @FunctionalInterface
   public interface a {
      int run(CommandContext<ew> var1, @Nullable zb var2) throws CommandSyntaxException;
   }
}
