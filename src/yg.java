...
public class yg implements ww {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ays.b.validate(yg::b);
   private static final Codec<Object> e = Codec.either(d, wx.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wv $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yg> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ww.a<yg> c = new ww.a<>(b, "translatable");
   private static final xa f = xa.e("%");
   private static final xa g = xa.e("null");
   ...
   @Nullable
   private tr k;
   private List<xa> l = ImmutableList.of();
   ...
   private static yg a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yg($$0, $$1.orElse(null), a($$2));
   }

   public yg(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xa> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yh var4) {
            this.l = ImmutableList.of(xa.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xa> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yh(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xa a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wv) {
            ...
            return $$1 == null ? g : xa.e($$1.toString());
         }
      } else {
         throw new yh(this, $$0);
      }
   ...
   public xj a(@Nullable ex $$0, @Nullable bvs $$1, int $$2) throws CommandSyntaxException {
      ...
      return xj.a(new yg(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yg $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
