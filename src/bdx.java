...
public class bdx extends bgv {
   public bdx(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bia.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bia.D.typeName(), bjo.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bia.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bia.D.typeName(), "minecraft:saddle"));
