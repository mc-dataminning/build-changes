...
public class bdx extends bhp {
   private final String c;
   private final DoubleUnaryOperator d;

   public bdx(Schema $$0, String $$1, String $$2, String $$3, DoubleUnaryOperator $$4) {
      super($$0, false, $$1, bit.D, $$2);
      this.c = $$3;
      this.d = $$4;
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.update("attributes", $$1 -> $$0.createList($$1.asStream().map($$0xx -> {
            String $$1x = bko.a($$0xx.get("id").asString(""));
            if (!$$1x.equals(this.c)) {
               return $$0xx;
            } else {
