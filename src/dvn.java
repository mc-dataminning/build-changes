...
public class dvn extends dty {
   ...
   public dvn(ji $$0, dww $$1) {
      super(dua.q, $$0, $$1);
   }

   public static void a(final alq $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, alq $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, alq $$1, BooleanSupplier $$2) {
   ...
   protected void b(tq $$0, jt.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (un)czn.a.encodeStart(ue.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", wp.a.a(this.m, $$1));
      }
   }
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         czn.a.parse(ue.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = akv.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dgh $$0, ji $$1, dww $$2, dvn $$3) {
      if ($$2.b(dqs.a) && $$2.c(dqs.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
