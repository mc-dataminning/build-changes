...
public class dvn extends dvs<dxu> {
   public dvn(Codec<dxu> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dvu<dxu> $$0) {
      cxw $$1 = $$0.b();
      ib $$2 = $$0.e();
      dxu $$3 = $$0.f();
      axd $$4 = $$0.d();
   ...
   private void a(cxw $$0, axd $$1, ib $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, dxu $$9) {
      Optional<dse> $$10 = dse.a($$0, $$2, $$9.b, dvo::c, dvo::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((cxe)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((cxe)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               dvo.a($$0, $$2.h($$11.getAsInt() - 1), ih.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               dvo.a($$0, $$2.h($$17.getAsInt() + 1), ih.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(cxe $$0, ib $$1) {
      return $$0.a_($$1).a(dae.H);
   }

   private int a(axd $$0, int $$1, int $$2, float $$3, int $$4, dxu $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(cxw $$0, ib $$1) {
      dnb $$2 = $$0.a_($$1);
      if (!$$2.a(dae.G) && !$$2.a(dae.su) && !$$2.a(dae.st)) {
         if ($$0.a_($$1.c()).u().a(aus.a)) {
            return false;
         } else {
            for (ih $$3 : ih.c.a) {
               if (!this.a((cxc)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((cxc)$$0, $$1.d());
         }
      } else {
         return false;
      }
   ...
   private void a(cxw $$0, ib $$1, int $$2, ih $$3) {
      ib.a $$4 = $$1.j();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, dxu $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
