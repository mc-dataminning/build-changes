...
public class cse extends ctf {
   ...
   public cse(int $$0, cov $$1) {
      this($$0, $$1, cso.a);
   }

   public cse(int $$0, cov $$1, cso $$2) {
      super(ctk.i, $$0, $$1, $$2, o());
      this.a(this.y);
   }

   private static ctg o() {
      return ctg.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected void a(cow $$0, cwo $$1) {
      ...
      this.q.a(($$1x, $$2x) -> {
         dww $$3 = $$1x.a_($$2x);
         if (!$$0.fV() && $$3.a(awp.O) && $$0.dY().i() < 0.12F) {
            dww $$4 = dil.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
      ...
      if (!$$0.f() && dda.a($$0)) {
         ...
         if (!$$5.f()) {
            ...
            if ($$4.m() && $$0.b($$5)) {
               ...
               for (Entry<jr<dcy>> $$19 : $$16.b()) {
                  jr<dcy> $$20 = (jr<dcy>)$$19.getKey();
                  int $$21 = $$6.a($$20);
                  int $$22 = $$19.getIntValue();
                  $$22 = $$21 == $$22 ? $$22 + 1 : Math.max($$22, $$21);
                  dcy $$23 = $$20.a();
                  boolean $$24 = $$23.c($$0);
                  if (this.r.gj().d || $$0.a(cws.vv)) {
                     $$24 = true;
                  }

                  for (jr<dcy> $$25 : $$6.a()) {
                     if (!$$25.equals($$20) && !dcy.a($$20, $$25)) {
                        $$24 = false;
                        $$1++;
                     }
                  }
