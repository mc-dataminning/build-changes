...
public abstract class cse extends bwi implements byh {
   @Nullable
   private UUID a;
   @Nullable
   private bwi b;
   ...
   public fex d(double $$0, double $$1, double $$2, float $$3, float $$4) {
      return new fex($$0, $$1, $$2)
         .d()
   ...
   public static <T extends cse> T a(cse.a<T> $$0, arq $$1, czk $$2, bxj $$3, float $$4, float $$5, float $$6) {
      return a($$0.create($$1, $$3, $$2), $$1, $$2, $$4x -> $$4x.a($$3, $$3.dM(), $$3.dK(), $$4, $$5, $$6));
   }

   public static <T extends cse> T a(cse.a<T> $$0, arq $$1, czk $$2, bxj $$3, double $$4, double $$5, double $$6, float $$7, float $$8) {
      return a($$0.create($$1, $$3, $$2), $$1, $$2, $$5x -> $$5x.c($$4, $$5, $$6, $$7, $$8));
   }

   public static <T extends cse> T a(T $$0, arq $$1, czk $$2, double $$3, double $$4, double $$5, float $$6, float $$7) {
      return a($$0, $$1, $$2, $$6x -> $$0.c($$3, $$4, $$5, $$6, $$7));
   }

   public static <T extends cse> T a(T $$0, arq $$1, czk $$2) {
      return a($$0, $$1, $$2, $$0x -> {
      });
   }

   public static <T extends cse> T a(T $$0, arq $$1, czk $$2, Consumer<T> $$3) {
      $$3.accept($$0);
      $$1.b($$0);
      $$0.b($$1, $$2);
      return $$0;
   ...
   public void b(arq $$0, czk $$1) {
      dfz.a($$0, $$1, this, $$0x -> {
      });
      if (this instanceof crr $$2) {
         czk $$3 = $$2.dY();
   ...
   protected csf b(fev $$0) {
      ...
      } else if (this.x() && $$0 instanceof fet $$4 && $$4.f()) {
         csf $$5 = csf.b;
   ...
   protected void a(fev $$0) {
      ...
      if ($$1 == fev.a.c) {
         feu $$2 = (feu)$$0;
         bwi $$3 = $$2.a();
         if ($$3.an().a(axf.H) && $$3 instanceof cse $$4) {
            $$4.a(csf.c, this.q(), this.q(), true);
         }

         this.a($$2);
         this.dU().a(efo.J, $$0.g(), efo.a.a(this, null));
      } else if ($$1 == fev.a.b) {
         fet $$5 = (fet)$$0;
         this.a($$5);
         iv $$6 = $$5.b();
         this.dU().a(efo.J, $$6, efo.a.a(this, this.dU().a_($$6)));
      }
   }
   ...
   public boolean c(arq $$0, iv $$1) {
      bwi $$2 = this.q();
      return $$2 instanceof crj ? $$2.c($$0, $$1) : $$2 == null || $$0.O().c(djd.d);
   }

   public boolean a(arq $$0) {
      return this.an().a(axf.g) && $$0.O().c(djd.h);
   }
   ...
   public interface a<T extends cse> {
      T create(arq var1, bxj var2, czk var3);
   }
}
