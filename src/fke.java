...
public record fke(int i, int j, fke.a k, fke.b l, int m) {
   public static final int a = 32;
   private static final fke[] n = new fke[32];
   private static final List<fke> o = new ArrayList<>(32);
   public static final fke b = a(0, 0, fke.a.a, fke.b.a, 3);
   public static final fke c = a(1, 0, fke.a.b, fke.b.c, 4);
   public static final fke d = a(2, 0, fke.a.a, fke.b.d, 2);
   public static final fke e = d;
   public static final fke f = a(3, 1, fke.a.e, fke.b.d, 2);
   public static final fke g = a(4, 2, fke.a.e, fke.b.d, 2);
   public static final fke h = a(5, 0, fke.a.c, fke.b.b, 3);

   public fke(int i, int j, fke.a k, fke.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fke a(int $$0, int $$1, fke.a $$2, fke.b $$3, int $$4) {
      fke $$5 = new fke($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fke.b $$1) {
      return $$0 == 0 || $$1 == fke.b.d;
   }
   ...
   @Nullable
   public static fke a(int $$0) {
      return n[$$0];
   }

   public static Stream<fke> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fke.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
