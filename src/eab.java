...
public class eab extends LongLinkedOpenHashSet {
   private final eab.a a;

   public eab(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eab.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = asb.f(60000000);
      private static final int b = asb.f(60000000);
