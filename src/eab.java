...
public class eab implements ebb<buj> {
   ...
   public eab(eam $$0, arc $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = new bqy($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<eaw<buj>> a(dfm $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               List<buj> $$6 = buq.a($$5, this.d, bup.r).collect(ImmutableList.toImmutableList());
               return new eaw<>($$0, $$6);
            }
         }, this.g::a_);
      }
   ...
   private static dfm a(tq $$0) {
      int[] $$1 = $$0.n("Position");
      return new dfm($$1[0], $$1[1]);
   }

   private static void a(tq $$0, dfm $$1) {
      $$0.a("Position", new tu(new int[]{$$1.h, $$1.i}));
   }

   private static eaw<buj> b(dfm $$0) {
      return new eaw<>($$0, ImmutableList.of());
   }

   @Override
   public void a(eaw<buj> $$0) {
      dfm $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
   ...
   private void a(CompletableFuture<?> $$0, dfm $$1) {
      $$0.exceptionally($$1x -> {
   ...
   private void b(CompletableFuture<?> $$0, dfm $$1) {
      $$0.exceptionally($$1x -> {
