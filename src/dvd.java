...
public class dvd extends dvx implements ctp {
   ...
   private jz<cxk> n = jz.a(9, cxk.k);
   private int r = 0;
   protected final ctj k = new ctj() {
   ...
   protected csx a(int $$0, cpr $$1) {
      return new ctn($$0, $$1, this, this.k);
   }
   ...
   private boolean a(int $$0, cxk $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            cxk $$4 = this.a($$3);
            if ($$4.f() || $$4.L() < $$0 && cxk.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(dha $$0, jh $$1, dxn $$2, dvd $$3) {
      int $$4 = $$3.r - 1;
      if ($$4 >= 0) {
         $$3.r = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.b(dly.b, Boolean.valueOf(false)), 3);
         }
      }
   }
