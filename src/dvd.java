...
public class dvd {
   ...
   public dvd(@Nullable ecc $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(cpc.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(cpc.c($$0, $$1))) {
               return true;
            }
         }
   ...
   public static dvd a(aev<cpv> $$0, @Nullable ecc $$1) {
      if ($$0 == cpv.h) {
         return new dvd(
            $$1,
         ...
         return new dvd($$1, $$2, $$2);
      } else if ($$0 == cpv.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new dvd($$1, $$3, $$3);
      } else {
