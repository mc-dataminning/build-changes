...
public class ckw extends ckt implements bwg<jr<ckx>> {
   private static final ajy<jr<ckx>> g = akc.a(ckw.class, aka.A);
   ...
   public ckw(bur<? extends ckw> $$0, dgh $$1) {
      super($$0, $$1);
   }
   ...
   public static Optional<ckw> a(dgh $$0, ji $$1, jn $$2) {
      ckw $$3 = new ckw($$0, $$1);
   ...
   private ckw(dgh $$0, ji $$1) {
      super(bur.aK, $$0, $$1);
   }

   public ckw(dgh $$0, ji $$1, jn $$2, jr<ckx> $$3) {
      this($$0, $$1);
      this.b($$3);
      this.a($$2);
   }
