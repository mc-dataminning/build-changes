...
public class ckw extends clw {
   ...
   public ckw(int $$0, chz $$1) {
      this($$0, $$1, clf.a);
   }

   public ckw(int $$0, chz $$1, clf $$2) {
      super(cmb.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected clx l() {
      return clx.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected boolean a(cia $$0, boolean $$1) {
      return ($$0.fW().d || $$0.ck >= this.w.b()) && this.w.b() > 0;
   }
   ...
   protected void a(cia $$0, cpq $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dme $$3 = $$1x.a_($$2x);
         if (!$$0.fW().d && $$3.a(aue.M) && $$0.ef().i() < 0.12F) {
            dme $$4 = cyf.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cpq $$4 = $$0.q();
         cpq $$5 = this.q.a(1);
         Map<ctz, Integer> $$6 = cua.a($$4);
         $$2 += $$0.J() + ($$5.b() ? 0 : $$5.J());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cpt.us) && !com.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<ctz, Integer> $$16 = cua.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (ctz $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fW().d || $$0.a(cpt.us)) {
                        $$22 = true;
                     }
