...
public class gea {
   ...
   public static void a(ffh $$0, faa $$1) {
      cmz $$2 = $$0.s;
      if (!$$2.ag) {
         dse $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static void a(gpb $$0, faa $$1) {
   ...
   private static void b(ffh $$0, faa $$1) {
      RenderSystem.setShader(gdj::r);
      RenderSystem.setShaderTexture(0, a);
      ezv $$2 = fac.b().d();
      iz $$3 = iz.a($$0.s.du(), $$0.s.dy(), $$0.s.dA());
      float $$4 = gdp.a($$0.s.dP().D_(), $$0.s.dP().A($$3));
   ...
   private static void c(ffh $$0, faa $$1) {
      ezv $$2 = fac.b().d();
      RenderSystem.setShader(gdj::q);
