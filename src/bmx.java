...
public interface bmx {
   static bmr<StringReader> a(String $$0) {
      return new bmx.b($$0);
   }

   static bmr<StringReader> a(char $$0) {
      return new bmx.a($$0);
   }

   public static record a(char a) implements bmr<StringReader> {
      @Override
      public boolean a(bmn<StringReader> $$0, bmp $$1, bmj $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bmr<StringReader> {
      @Override
      public boolean a(bmn<StringReader> $$0, bmp $$1, bmj $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
