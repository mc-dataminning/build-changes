...
public class bmx extends Schema {
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bia.s.typeName()) ? super.getChoiceType($$0, bjo.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bia.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bia.s, () -> DSL.optionalFields("components", bia.w.in($$0), DSL.taggedChoiceLazy("id", bjo.a(), $$2)));
      $$0.registerType(
         true,
         bia.t,
         () -> DSL.hook(
