...
public abstract class ewy {
   ...
   public ewa a() {
      if (this.c()) {
         ...
         return new ewa(this.b(jf.a.a), this.b(jf.a.b), this.b(jf.a.c), this.c(jf.a.a), this.c(jf.a.b), this.c(jf.a.c));
      }
   }

   public ewy b() {
      return this.c() ? ewv.a() : ewv.a(this.b(jf.a.a), this.b(jf.a.b), this.b(jf.a.c), this.c(jf.a.a), this.c(jf.a.b), this.c(jf.a.c));
   }
   ...
   public ewy a(double $$0, double $$1, double $$2) {
      return (ewy)(this.c() ? ewv.a() : new ewh(this.a, new ewu(this.a(jf.a.a), $$0), new ewu(this.a(jf.a.b), $$1), new ewu(this.a(jf.a.c), $$2)));
   }

   public ewy d() {
      ewy[] $$0 = new ewy[]{ewv.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewv.b($$0[0], ewv.a($$1, $$2, $$3, $$4, $$5, $$6), ewj.o));
      return $$0[0];
   }

   public void a(ewv.a $$0) {
      this.a
         .a(
   ...
   public List<ewa> e() {
      List<ewa> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new ewa($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(jf.a $$0, double $$1) {
      return ayg.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public ewb a(ewf $$0, ewf $$1, ja $$2) {
      if (this.c()) {
         return null;
      } else {
         ewf $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(jf.a.a, $$4.c - (double)$$2.u()), this.a(jf.a.b, $$4.d - (double)$$2.v()), this.a(jf.a.c, $$4.e - (double)$$2.w()))
               ? new ewb($$4, jf.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : ewa.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<ewf> a(ewf $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         ewf[] $$1 = new ewf[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = ayg.a($$0.a(), $$2, $$5);
            double $$9 = ayg.a($$0.b(), $$3, $$6);
            double $$10 = ayg.a($$0.c(), $$4, $$7);
   ...
   public ewy a(jf $$0) {
      if (!this.c() && this != ewv.b()) {
         if (this.b != null) {
            ewy $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewy b(jf $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new eww(this, $$1, $$4);
      }
   }

   public double a(jf.a $$0, ewa $$1, double $$2) {
      return this.a(ix.a($$0, jf.a.a), $$1, $$2);
   }

   protected double a(ix $$0, ewa $$1, double $$2) {
      if (this.c()) {
         return $$2;
