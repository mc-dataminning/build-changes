public abstract class ewy extends exc implements eyh, eyz {
   private static final eyr a = new eyr(new ahg("widget/text_field"), new ahg("widget/text_field_highlighted"));
   ...
   protected void a(ews $$0, int $$1, int $$2, int $$3, int $$4) {
   ...
   protected abstract void c(ews var1, int var2, int var3, float var4);
}
