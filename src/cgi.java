...
public class cgi implements dft {
   ...
   private void b(ard $$0) {
      faz $$1 = this.a($$0, new ji(this.f, this.g, this.h));
      if ($$1 != null) {
         cmq $$2;
         try {
            $$2 = new cmq($$0);
            $$2.a($$0, $$0.d_($$2.dv()), buq.h, null);
   ...
   @Nullable
   private faz a(ard $$0, ji $$1) {
      for (int $$2 = 0; $$2 < 10; $$2++) {
         int $$3 = $$1.u() + $$0.A.a(16) - 8;
         int $$4 = $$1.w() + $$0.A.a(16) - 8;
         int $$5 = $$0.a(ecr.a.b, $$3, $$4);
         ji $$6 = new ji($$3, $$5, $$4);
         if ($$0.c($$6) && clx.b(bur.bN, $$0, buq.h, $$6, $$0.A)) {
            return faz.c($$6);
         }
      }
