...
public class gwe implements gvq.a {
   private final fqq a;
   private double b = Double.MIN_VALUE;
   private List<bxe> c = Collections.emptyList();
   ...
   private void a(fld $$0, grn $$1, double $$2, double $$3, double $$4, bxe $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.ax.ifPresent($$10 -> {
   ...
   private double a(bxe $$0) {
      return 0.02 * (double)(String.valueOf((double)$$0.ao() + 0.132453657).hashCode() % 1000) / 1000.0;
   }

   private void a(iw $$0, fld $$1, double $$2, double $$3, double $$4, grn $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gsg.a($$1, $$5.getBuffer(gry.w()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gvq.a($$1, $$5.getBuffer(gry.w()), this.a.s.a_($$0).b(this.a.s, $$0, fgh.a()).a($$0), -$$2, -$$3, -$$4, $$7, $$8, $$9, 1.0F, false);
   }
}
