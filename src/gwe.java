...
public class gwe implements gwh.a, AutoCloseable {
   ...
   fbp[] f;
   @Nullable
   private final gwe.a g;
   private final auu h;

   public gwe(alb $$0, gxy $$1, fbp $$2, auu $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gxw $$4 = $$3.a(gxw.a).orElse(gxw.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new fbp[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gvz.a(this.f, $$0);
   ...
   @Nullable
   private gwe.a a(gxy $$0, int $$1, int $$2, gxw $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gwe.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gwe.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gwe.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gwe.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gwe.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gwe.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fbp[] $$4) {
   ...
   class a {
      ...
      a(final List<gwe.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gwe.this.c;
         int $$4 = this.b($$2) * gwe.this.d;
         gwe.this.a($$0, $$1, $$3, $$4, gwe.this.f);
      }

      public gwg a() {
         return gwe.this.new d(this, this.d ? gwe.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fbp[] b = new fbp[gwe.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gwe.this.c >> $$0;
            int $$2 = gwe.this.d >> $$0;
            this.b[$$0] = new fbp($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gwe.d $$2) {
         gwe.a $$3 = $$2.c;
         List<gwe.b> $$4 = $$3.b;
         gwe.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, axn.a($$6, $$14, $$15));
                  }
               }
            }

            gwe.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gwe.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gwe.this.f[$$2].a($$3 + ($$0.a($$1) * gwe.this.c >> $$2), $$4 + ($$0.b($$1) * gwe.this.d >> $$2));
      }
   ...
   class d implements gwg {
      int a;
      int b;
      final gwe.a c;
      @Nullable
      private final gwe.c d;

      d(final gwe.a $$0, @Nullable final gwe.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
