...
public class dgn {
   ...
   public static dgn a(int $$0, int $$1) {
      return new dgn($$0 << 5, $$1 << 5);
   }

   public static dgn b(int $$0, int $$1) {
      return new dgn(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public static Stream<dgn> a(final dgn $$0, final dgn $$1) {
      ...
      return StreamSupport.stream(new AbstractSpliterator<dgn>((long)($$2 * $$3), 64) {
         ...
         @Override
         public boolean tryAdvance(Consumer<? super dgn> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
