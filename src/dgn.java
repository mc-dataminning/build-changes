...
public class dgn {
   public static final Codec<dgn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dgl.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dgl.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               cxy.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final yt<wg, dgn> b = yt.a(dgn::a, dgn::a);
   private final dgl c;
   private final Optional<dgl> d;
   private final cxy e;
   private int f;
   private final int g;
   ...
   private dgn(dgl $$0, Optional<dgl> $$1, cxy $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dgn(dgl $$0, cxy $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dgn(dgl $$0, Optional<dgl> $$1, cxy $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dgn(dgl $$0, Optional<dgl> $$1, cxy $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dgn(dgl $$0, Optional<dgl> $$1, cxy $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   public cxy c() {
      return this.d.map(dgl::d).orElse(cxy.k);
   }
   ...
   private static void a(wg $$0, dgn $$1) {
      dgl.b.encode($$0, $$1.d());
      cxy.i.encode($$0, $$1.f());
      dgl.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dgn a(wg $$0) {
      dgl $$1 = dgl.b.decode($$0);
      cxy $$2 = cxy.i.decode($$0);
      Optional<dgl> $$3 = dgl.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dgn $$11 = new dgn($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
