...
public class avj extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bbg.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", avj::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", avj::a);
      return this.a($$0, "minecraft:trident", avj::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bbg.x, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bbg.x, $$1);
