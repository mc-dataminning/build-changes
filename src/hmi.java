...
public class hmi implements hme {
   ...
   private final dkf e;
   private final azv f;
   private final Object2ObjectArrayMap<dkd, hmi.a> g = new Object2ObjectArrayMap();
   private Optional<dkb> h = Optional.empty();
   private Optional<dka> i = Optional.empty();
   private float j;
   @Nullable
   private dkd k;

   public hmi(gox $$0, hoa $$1, dkf $$2) {
      this.f = $$0.dV().C_();
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   ...
   @Override
   public void a() {
      this.g.values().removeIf(hmd::m);
      dkd $$0 = this.e.a(this.c.dA(), this.c.dC(), this.c.dG()).a();
      if ($$0 != this.k) {
         this.k = $$0;
         this.h = $$0.m();
         this.i = $$0.n();
         this.g.values().forEach(hmi.a::o);
         ...
         .ifPresent(
            $$0x -> {
               ...
               if ($$4 > 0) {
                  ...
                  this.j = this.j - (float)($$1.a(djj.b, $$3) - 1) / (float)$$0x.b();
               }
               ...
               if (this.j >= 1.0F) {
                  ...
                  double $$12 = $$11 + $$0x.d();
                  hmp $$13 = hmp.a($$0x.a().a(), this.f, this.c.dA() + $$8 / $$11 * $$12, this.c.dE() + $$9 / $$11 * $$12, this.c.dG() + $$10 / $$11 * $$12);
                  this.d.a($$13);
                  this.j = 0.0F;
               } else {
