...
public class ghz extends gjq {
   private final float a;
   private final gjl b;

   ghz(gfi $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gjl $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements git<lk> {
      ...
      public giq a(lk $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.l() && $$8.o() == dqu.a) {
            ...
            jh $$9 = jh.a($$2, $$3, $$4);
            int $$10 = fme.Q().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof dni) {
               $$10 = ((dni)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new ghz($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
