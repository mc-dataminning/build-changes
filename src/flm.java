...
public class flm extends fmb {
   ...
   flm(fii $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   private void a(elk $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
   ...
   public static class a implements fle<ix> {
      private final flw a;
      ...
      public flb a(ix $$0, fii $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flm $$8 = new flm($$1, $$2, $$3, $$4, $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
