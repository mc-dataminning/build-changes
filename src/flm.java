...
public class flm implements ezm {
   static final Logger b = LogUtils.getLogger();
   private final faj c;
   private final fla<flm.b> d;

   flm(faj $$0, fla<flm.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akr c, int d, int e, int[][] f) implements flo {
      ...
      public static final MapCodec<flm.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akr.a.fieldOf("file").forGetter(flm.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(flm.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(flm.a::e),
                     g.fieldOf("chars").forGetter(flm.a::f)
                  )
                  .apply($$0, flm.a::new)
         )
         .validate(flm.a::a);
      ...
      private static DataResult<flm.a> a(flm.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     flm.b $$15 = $$9.a($$12, new flm.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        flm.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(faj $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, faj b, int c, int d, int e, int f, int g, int h) implements ezl {
