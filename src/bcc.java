...
public class bcc extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(biq.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(biq.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(biq.s);
