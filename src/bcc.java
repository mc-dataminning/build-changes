...
public class bcc extends bfm {
   private static final String[] a = new String[]{
      "Text1", "Text2", "Text3", "Text4", "FilteredText1", "FilteredText2", "FilteredText3", "FilteredText4", "Color", "GlowingText"
   };

   public bcc(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, bgq.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", bcc::b);
      $$0 = $$0.update("back_text", bcc::b);
