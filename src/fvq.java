...
public class fvq extends fva<fvq.b> {
   ...
   private final fvt ag;

   public fvq(gkw $$0, crt $$1, boolean $$2) {
      super(new fvq.b($$0), $$0.gi(), wo.a);
      $$0.cd = this.z;
      this.u = 136;
      this.s = 195;
      this.af = $$2;
      this.a($$0.j.D(), $$1, this.a($$0), $$0.dV().K_());
      this.ag = new fvt(this);
   }
   ...
   private boolean a(@Nullable ggr $$0, crt $$1, boolean $$2, jt.a $$3) {
      if (!cvf.a($$1, $$2, $$3)) {
         return false;
      } else {
         if ($$0 != null) {
         ...
         if ($$0 == null && V.k() != cve.h.b && $$3 != csn.f) {
            ...
            if ($$0 == this.aa && $$4) {
               ...
               if ($$0 == this.aa) {
                  ...
                  this.m.t.a($$6, true);
                  this.m.r.a($$6);
                  this.m.r.a($$7, ((fvq.c)$$0).a.d);
               } else if ($$3 == csn.e && $$1 == -999 && !this.z.g().f()) {
                  this.m.t.a(this.z.g(), true);
                  this.m.r.a(this.z.g());
                  this.z.b(cwp.j);
               } else {
                  this.m.t.cc.a($$0 == null ? $$1 : ((fvq.c)$$0).a.d, $$2, $$3, this.m.t);
                  this.m.t.cc.d();
               }
   ...
   protected void aR_() {
      if (this.m.r.f()) {
         super.aR_();
         this.Y = new fpc(this.p, this.C + 82, this.D + 6, 80, 9, wp.c("itemGroup.search"));
         this.Y.f(50);
         this.Y.d(false);
         this.Y.g(false);
         this.Y.m(16777215);
   ...
   private void a(cve $$0) {
      ...
      if (V.k() == cve.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.k.size(); $$10++) {
            ...
            ctz $$26 = new fvq.c($$9.k.get($$10), $$10, $$14, $$15);
            this.z.k.add($$26);
         }
   ...
   public List<wp> a(cwp $$0) {
      boolean $$1 = this.B != null && this.B instanceof fvq.a;
      boolean $$2 = V.k() == cve.h.a;
      boolean $$3 = V.k() == cve.h.d;
      cyh.a $$4 = this.m.n.m ? cyh.a.b : cyh.a.a;
      cyh $$5 = $$1 ? $$4.c() : $$4;
      List<wp> $$6 = $$0.a(cwl.b.a(this.m.s), this.m.t, $$5);
      if ($$2 && $$1) {
         return $$6;
      } else {
   ...
   protected void a(foe $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(gmi::H, V.c(), this.C, this.D, 0.0F, 0.0F, this.s, this.u, 256, 256);
      this.Y.a($$0, $$2, $$3, $$1);
      int $$5 = this.C + 175;
      int $$6 = this.D + 18;
      int $$7 = $$6 + 112;
      if (V.e()) {
         akv $$8 = this.I() ? G : H;
         $$0.a(gmi::H, $$8, $$5, $$6 + (int)((float)($$7 - $$6 - 17) * this.W), 12, 15);
      }

      this.a($$0, V);
      if (V.k() == cve.h.b) {
         fwb.a($$0, this.C + 73, this.D + 6, this.C + 105, this.D + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.m.t);
      }
   }
   ...
   protected boolean a(foe $$0, cve $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(foe $$0, cve $$1) {
      ...
      $$0.a(gmi::H, $$7[ayz.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static class b extends csc {
      ...
      public b(cox $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new fvq.a(fvq.S, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }
