...
public class fvq {
   ...
   @Nullable
   private fvq x;
   private final List<fvq> y = Lists.newArrayList();
   @Nullable
   private ak z;
   private final int A;
   private final int B;

   public fvq(fvo $$0, fmg $$1, aj $$2, au $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
   ...
   private static float a(fmq $$0, List<wu> $$1) {
   ...
   public void a(fpc $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(gnh::H, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(fpc $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fpa $$6 = this.w.h;
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(gnh::H, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(gnh::H, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(gnh::H, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(gnh::H, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(gnh::H, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(gnh::H, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(fpc $$0, List<ayl> $$1, int $$2, int $$3, int $$4) {
      fpa $$5 = this.w.h;
