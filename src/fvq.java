public class fvq extends fty {
   ...
   @Override
   protected void aT_() {
      this.B = new foo(this.p, this.n / 2 - 153, 20, 300, 20, b);
      this.B.f(128);
      this.B.a(this.y.d().a().toString());
      this.B.b($$0x -> this.J());
      this.d(this.B);
      this.z = new foo(this.p, this.n / 2 - 153, 55, 300, 20, c);
      this.z.f(128);
      this.z.a(this.y.b().toString());
      this.z.b($$0x -> this.J());
      this.d(this.z);
      this.A = new foo(this.p, this.n / 2 - 153, 90, 300, 20, d);
      this.A.f(128);
      this.A.a(this.y.c().toString());
      this.A.b($$0x -> this.J());
      this.d(this.A);
      this.C = new foo(this.p, this.n / 2 - 153, 125, 300, 20, s);
      this.C.f(256);
      this.C.a(this.y.f());
      this.d(this.C);
      this.D = new foo(this.p, this.n / 2 - 153, 160, 98, 20, w);
      this.D.f(3);
      this.D.a(Integer.toString(this.y.t()));
      this.D.a(fpr.a(x));
      this.d(this.D);
      this.E = new foo(this.p, this.n / 2 - 50, 160, 98, 20, u);
      this.E.f(3);
      this.E.a(Integer.toString(this.y.k()));
      this.E.a(fpr.a(v));
      this.d(this.E);
      this.K = this.y.j();
      this.H = this.c(fom.a(dwa.a::a).a(dwa.a.values()).a(this.K).a().a(this.n / 2 + 54, 160, 100, 20, a, ($$0x, $$1) -> this.K = $$1));
      boolean $$0 = doq.o(this.y.m()).o().b();
      this.H.j = $$0;
      this.H.k = $$0;
      this.c(new fob(this.n / 2 - 154, 185, 100, 20, xu.a, 0.0) {
         {
            this.b();
         }
         ...
         @Override
         protected void b() {
            this.b(xv.a("jigsaw_block.levels", fvq.this.F));
         }

         @Override
         protected void a() {
            fvq.this.F = bae.a(bae.b(0.0, 20.0, this.c));
         }
      });
      this.c(fom.b(this.G).a(this.n / 2 - 50, 185, 100, 20, xv.c("jigsaw_block.keep_jigsaws"), ($$0x, $$1) -> this.G = $$1));
      this.J = this.c((fof)fof.a(xv.c("jigsaw_block.generate"), $$0x -> {
         this.l();
         this.G();
      }).a(this.n / 2 + 54, 185, 100, 20).a());
      this.I = this.c((fof)fof.a(xu.d, $$0x -> this.l()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
