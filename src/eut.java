...
public class eut extends eul {
   ...
   private eut(int $$0, int $$1, byte $$2, boolean $$3, boolean $$4, boolean $$5, aku<dgi> $$6) {
      this.f = $$2;
      this.c = $$0;
      this.d = $$1;
      this.e = $$6;
   ...
   public static eut a(double $$0, double $$1, byte $$2, boolean $$3, boolean $$4, aku<dgi> $$5) {
      int $$6 = 128 * (1 << $$2);
   ...
   public static eut a(byte $$0, boolean $$1, aku<dgi> $$2) {
      return new eut(0, 0, $$0, false, false, $$1, $$2);
   }

   public static eut b(tq $$0, jt.a $$1) {
      aku<dgi> $$2 = (aku<dgi>)eas.a(new Dynamic(ue.a, $$0.c("dimension")))
   ...
   public void a(cox $$0, cwp $$1) {
      ...
      for (int $$4 = 0; $$4 < this.o.size(); $$4++) {
         ...
         if (!$$6.dQ() && ($$6.gi().b($$3) || $$1.H())) {
            if (!$$1.H() && $$6.dV().ai() == this.e && this.m) {
               this.a(eup.a, $$6.dV(), $$7, $$6.dA(), $$6.dG(), (double)$$6.dL(), null);
            }
         } else {
            this.p.remove($$6);
            this.o.remove($$5);
      ...
      if ($$1.H() && this.m) {
         ...
         this.a(eup.b, $$0.dV(), b($$8.ar()), (double)$$9.u(), (double)$$9.w(), (double)($$8.cO().e() * 90), null);
         this.s.put($$11.e(), $$11);
      }
   ...
   private static boolean b(cox $$0) {
      for (but $$1 : but.values()) {
         if ($$1 != but.a && $$1 != but.b && $$0.a($$1).a(awy.cp)) {
            return true;
         }
      }
   ...
   private void a(jr<euo> $$0, @Nullable dgj $$1, String $$2, double $$3, double $$4, double $$5, @Nullable wp $$6) {
      int $$7 = 1 << this.f;
   ...
   public class a {
      ...
      yw<?> a(eur $$0) {
         ...
         return $$3 == null && $$1 == null ? null : new ade($$0, eut.this.f, eut.this.h, $$3, $$1);
      }
   ...
   public static record c(int b, int c, int d, int e, byte[] f) {
      public static final yn<ByteBuf, Optional<eut.c>> a = yn.a(eut.c::a, eut.c::a);
