...
public class fb implements ArgumentType<Integer> {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(sw.c("argument.time.invalid_unit"));
   ...
   public static class a implements gg<fb, fb.a.a> {
      public void a(fb.a.a $$0, sf $$1) {
         $$1.writeInt($$0.b);
      }

      public fb.a.a a(sf $$0) {
         int $$1 = $$0.readInt();
         return new fb.a.a($$1);
      }
