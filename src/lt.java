...
public class lt {
   ...
   public static final jh<epd> c = b(lu.D, "empty", $$0 -> epf.a);
   ...
   public static final jz<eno<?>> m = a(lu.ah, $$0 -> eno.a);
   public static final jz<eoc<?>> n = a(lu.ai, $$0 -> eoc.b);
   public static final jz<enh<?>> o = a(lu.ac, $$0 -> enh.a);
   ...
   public static final jz<esi> D = a(lu.Q, $$0 -> esf.b);
   public static final jz<etg<?>> E = a(lu.N, $$0 -> eth.e);
   public static final jz<evd> F = a(lu.M, $$0 -> eve.a);
   public static final jz<evx> G = a(lu.P, $$0 -> evz.b);
   public static final jz<evp> H = a(lu.O, $$0 -> evr.c);
   public static final jz<ewg> I = a(lu.R, $$0 -> ewi.c);
   public static final jz<bpv<?>> J = a(lu.C, $$0 -> bpv.a);
   public static final jz<bpx<?>> K = a(lu.J, $$0 -> bpx.a);
   public static final jz<ehy<?>> L = a(lu.H, $$0 -> ehy.a);
   public static final jz<eag<?>> M = a(lu.i, $$0 -> eag.k);
   public static final jz<ebe<?>> N = a(lu.k, $$0 -> ebe.a);
   public static final jz<ece<?>> O = a(lu.A, $$0 -> ece.I);
   public static final jz<ekp<?>> P = a(lu.ao, $$0 -> ekp.a);
   public static final jz<eki> Q = a(lu.an, $$0 -> eki.c);
   public static final jz<eka<?>> R = a(lu.as, $$0 -> eka.f);
   public static final jz<eiz<?>> S = a(lu.Z, $$0 -> eiz.f);
   public static final jz<egk<?>> T = a(lu.j, $$0 -> egk.a);
   public static final jz<efv<?>> U = a(lu.E, $$0 -> efv.a);
   public static final jz<ehn<?>> V = a(lu.au, $$0 -> ehn.a);
   public static final jz<egh<?>> W = a(lu.ag, $$0 -> egh.a);
   public static final jz<ehb<?>> X = a(lu.at, $$0 -> ehb.b);
   public static final jz<efk<?>> Y = a(lu.B, $$0 -> efk.a);
   ...
   public static final jz<ens<?>> af = a(lu.ar, $$0 -> ens.e);
   public static final jz<ela<?>> ag = a(lu.ap, $$0 -> ela.d);
   public static final jz<MapCodec<? extends eld>> ah = a(lu.aq, ele::a);
   ...
   public static final jz<eqo> at = a(lu.aD, eqp::a);
