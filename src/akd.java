...
public class akd {
   ...
   private static Collection<String> a(Collection<? extends bki> $$0) {
   ...
   private static int a(du $$0, Collection<? extends bki> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ur.a("commands.tag.add.success.single", $$2, $$1.iterator().next().O_()), true);
         } else {
   ...
   private static int b(du $$0, Collection<? extends bki> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ur.a("commands.tag.remove.success.single", $$2, $$1.iterator().next().O_()), true);
         } else {
   ...
   private static int a(du $$0, Collection<? extends bki> $$1) {
      ...
      if ($$1.size() == 1) {
         bki $$4 = $$1.iterator().next();
         if ($$2.isEmpty()) {
            $$0.a(() -> ur.a("commands.tag.list.single.empty", $$4.O_()), false);
         } else {
            $$0.a(() -> ur.a("commands.tag.list.single.success", $$4.O_(), $$2.size(), uu.a($$2)), false);
         }
      } else if ($$2.isEmpty()) {
