...
public class drp {
   ...
   static Codec<drp> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               cur.b.listOf().lenientOptionalFieldOf("items_to_eject", List.of()).forGetter($$0x -> $$0x.g),
   ...
   private long f;
   private final List<cur> g = new ObjectArrayList();
   private long h;
   private int i;
   boolean c;

   drp(Set<UUID> $$0, long $$1, List<cur> $$2, int $$3) {
      this.e.addAll($$0);
      this.f = $$1;
      this.g.addAll($$2);
      this.i = $$3;
   ...
   cur f() {
      return this.g.isEmpty() ? cur.l : Objects.requireNonNullElse(this.g.get(this.g.size() - 1), cur.l);
   }
   ...
   cur g() {
      if (this.g.isEmpty()) {
         ...
         this.i();
         return Objects.requireNonNullElse(this.g.remove(this.g.size() - 1), cur.l);
      }
   }
