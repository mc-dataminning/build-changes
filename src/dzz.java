...
public class dzz implements ayw {
   ...
   @Override
   public ayw d() {
      return new dzz(this.e.a(), this.e.a());
   }

   @Override
   public dzl e() {
      return new dzz.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dzl {
      ...
      public ayw a(int $$0, int $$1, int $$2) {
         long $$3 = ayo.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dzz($$4, this.b);
      }

      @Override
      public ayw a(String $$0) {
         dzn.a $$1 = dzn.a($$0);
         return new dzz($$1.a(this.a, this.b));
      }

      @Override
      public ayw a(long $$0) {
         return new dzz($$0 ^ this.a, $$0 ^ this.b);
      }
