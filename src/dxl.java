...
public class dxl<T extends dxg> {
   private final Class<T> a;
   private final Long2ObjectFunction<dxt> b;
   private final Long2ObjectMap<dxk<T>> c = new Long2ObjectOpenHashMap();
   private final LongSortedSet d = new LongAVLTreeSet();

   public dxl(Class<T> $$0, Long2ObjectFunction<dxt> $$1) {
      this.a = $$0;
      this.b = $$1;
   }
   ...
   public Stream<dxk<T>> b(long $$0) {
      return this.a($$0).<dxk<T>>mapToObj(this.c::get).filter(Objects::nonNull);
   }

   private static long f(long $$0) {
      return dcd.c(kf.b($$0), kf.d($$0));
   }

   public dxk<T> c(long $$0) {
      return (dxk<T>)this.c.computeIfAbsent($$0, this::g);
   }

   @Nullable
   public dxk<T> d(long $$0) {
      return (dxk<T>)this.c.get($$0);
   }

   private dxk<T> g(long $$0) {
      long $$1 = f($$0);
      dxt $$2 = (dxt)this.b.get($$1);
      this.d.add($$0);
      return new dxk<>(this.a, $$2);
   }
