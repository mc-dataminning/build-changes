...
public class dxl {
   ...
   public dxl(dgz $$0, jh $$1, jm $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dxo $$0 = this.b.a_(this.e);
      if (!dxh.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == etv.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dxo $$0) {
      return $$0.a(dkf.it) || $$0.a(dkf.pI);
   }

   private static boolean a(dxo $$0, dxo $$1) {
      if ($$0.a(dkf.pI) && $$1.a(dkf.it)) {
         return false;
      } else {
         return $$0.a(dkf.it) && $$1.a(dkf.pI) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jh $$0, jm $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dxh.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dxo $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dxh.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dxh.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
