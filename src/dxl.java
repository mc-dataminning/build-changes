...
public class dxl {
   private static final drb a = dea.hj.n();
   private static final drb b = dea.hk.n();
   private static final drb c = dea.iA.n();
   private static final drb d = dea.hn.n();
   private static final drb e = dea.hv.n();
   private static final drb f = dea.hx.n();
   private static final drb g = dea.hr.n();
   private static final drb h = dea.iC.n();
   private static final drb i = dea.dP.n();
   private final drb j;
   private final int k;
   private final drb[] l;
   private final elx m;
   ...
   public dxl(dxh $$0, drb $$1, int $$2, dxg $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dxc.P);
      this.l = a($$3.a(new akm("clay_bands")));
      this.u = $$0.a(dxc.N);
      this.v = $$0.a(dxc.O);
      this.n = $$0.a(dxc.Q);
      this.o = $$0.a(dxc.R);
   ...
   public void a(dxh $$0, dby $$1, jk<dbw> $$2, boolean $$3, dxq $$4, final dsx $$5, dwx $$6, dxk.o $$7) {
      ...
      dxk.g $$13 = new dxk.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dxk.u $$14 = $$7.apply($$13);
      io.a $$15 = new io.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dwt.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ix<dbw> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dcd.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dwt.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<drb> a(dxk.o $$0, dyt $$1, Function<io, ix<dbw>> $$2, dsx $$3, dwx $$4, io $$5, boolean $$6) {
      dxk.g $$7 = new dxk.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(lf.az), $$1);
      dxk.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      drb $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dsu $$0, int $$1, int $$2, int $$3, daz $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dbw $$1, dsu $$2, io.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dea.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(ayk $$0, drb[] $$1, int $$2, drb $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected drb a(int $$0, int $$1, int $$2) {
