...
public class dxl {
   ...
   private double j;
   int k = 29999984;
   private dxl.a l = new dxl.d(5.999997E7F);
   public static final dxl.c d = new dxl.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(jh $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(ezy $$0) {
   ...
   public ezy c(double $$0, double $$1, double $$2) {
      return new ezy(azm.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azm.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dxl.a)($$0 == $$1 ? new dxl.d($$1) : new dxl.b($$0, $$1, $$2));
   ...
   public dxl.c t() {
      return new dxl.c(this);
   }

   public void a(dxl.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dxl.a {
      ...
      @Override
      public double a() {
         return azm.a(dxl.this.a() - this.e() / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
      }

      @Override
      public double c() {
         return azm.a(dxl.this.b() - this.e() / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
      }
      ...
      @Override
      public dxk i() {
         return this.c < this.b ? dxk.b : dxk.a;
      }
      ...
      @Override
      public dxl.a l() {
         return (dxl.a)(this.g() <= 0L ? dxl.this.new d(this.c) : this);
      }
      ...
      public fas m() {
         return fap.a(
            fap.c,
            fap.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fac.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dxl.c a(DynamicLike<?> $$0, dxl.c $$1) {
         ...
         return new dxl.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dxl.a {
      ...
      private void n() {
         this.c = azm.a(dxl.this.a() - this.b / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
         this.d = azm.a(dxl.this.b() - this.b / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
         this.e = azm.a(dxl.this.a() + this.b / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
         this.f = azm.a(dxl.this.b() + this.b / 2.0, (double)(-dxl.this.k), (double)dxl.this.k);
         this.g = fap.a(
            fap.c,
            fap.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fac.e
