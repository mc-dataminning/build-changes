...
public interface hw<T> {
   ...
   hy<T> a(@Nullable tx var1, CommandDispatcher<T> var2) throws el;
   ...
   static <T extends ek<T>> hw<T> a(ale $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hx<T> $$4 = new hx<>();
   ...
   static <T extends ek<T>> hn<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hp.c<>($$2.getString(), $$4.get());
      }
   }
}
