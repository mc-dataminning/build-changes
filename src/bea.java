...
public class bea extends bhn {
   ...
   public bea(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, bis.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", bea::b);
      $$0 = $$0.update("back_text", bea::b);
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bea::a);
   }
}
