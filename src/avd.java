...
public class avd extends axo {
   public avd(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", aym.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(aym.z.typeName(), azu.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(aym.t);
      ...
      if (!$$4.isPresent() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(aym.z.typeName(), "minecraft:saddle"));
