...
public abstract class avd {
   ...
   public avd(MinecraftServer $$0, jy<ald> $$1, evi $$2, int $$3) {
      this.k = $$0;
      this.v = $$1;
      this.g = $$3;
      this.t = $$2;
   ...
   public void a(vi $$0, ard $$1, ars $$2) {
      ...
      akt<dgi> $$9 = $$8.<akt<dgi>>flatMap($$0x -> eas.a(new Dynamic(ue.a, $$0x.c("Dimension"))).resultOrPartial(h::error)).orElse(dgi.i);
      arc $$10 = this.k.a($$9);
      arc $$11;
      if ($$10 == null) {
   ...
   public ard a(ard $$0, boolean $$1, buk.d $$2) {
      this.l.remove($$0);
      $$0.y().a($$0, $$2);
      etz $$3 = $$0.a(!$$1, etz.a);
      arc $$4 = $$3.b();
      ...
      if (!$$1 && $$11 != null && $$12 != null) {
         dwx $$13 = $$12.a_($$11);
         if ($$13.a(djo.pN)) {
            $$5.f.b(new afm(awa.vY, awb.e, (double)$$11.u(), (double)$$11.v(), (double)$$11.w(), 1.0F, 1.0F, $$4.H_().g()));
         }
      }
   ...
   public void a(@Nullable cox $$0, double $$1, double $$2, double $$3, double $$4, akt<dgi> $$5, yv<?> $$6) {
   ...
   public void a(ard $$0, arc $$1) {
      dyn $$2 = this.k.J().F_();
      $$0.f.b(new acv($$2));
      $$0.f.b(new afi($$1.ad(), $$1.ae(), $$1.O().b(dge.l)));
