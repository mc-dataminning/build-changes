...
public class avd {
   ...
   private static final Optional<Object> b = Optional.of(avm.a);

   private static boolean a(wa $$0, atv $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, wa $$1, atv $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, wa $$1, atv $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, wa $$1, atv $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, wa $$2, atv $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, wa $$2, wa $$3, atv $$4) {
      int $$5 = $$0.length();
      wa $$6 = $$2;
   ...
   public static boolean a(vi $$0, wa $$1, atv $$2) {
