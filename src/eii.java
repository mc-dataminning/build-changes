...
public class eii extends eox {
   ...
   public static eox.a<eii> a() {
      return new eox.a<>(eii::new, eii::b, bab.o);
   }

   private eii(LongSet $$0, LongSet $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static eii b(ur $$0, jk.a $$1) {
      return new eii(new LongOpenHashSet($$0.o("All")), new LongOpenHashSet($$0.o("Remaining")));
   }
