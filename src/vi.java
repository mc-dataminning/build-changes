...
public class vi extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<ul> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, tx.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<ul> $$0, Codec<T> $$1, tx $$2) {
      ul $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vi a(DynamicOps<ul> $$0, Codec<T> $$1, T $$2) {
      ul $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = axc.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yh<? super vi, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yi<? super vi, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yh<? super vi, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yh<? super vi, K> $$1, yh<? super vi, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yh<? super vi, K> $$0, yh<? super vi, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yi<? super vi, K> $$1, yi<? super vi, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yi<? super vi, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yh<? super vi, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yh<? super vi, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yh<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yi<? super vi, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yi<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static id b(ByteBuf $$0) {
      return id.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, id $$1) {
      $$0.writeLong($$1.a());
   }

   public cyn f() {
      return new cyn(this.readLong());
   }
   ...
   public esj k() {
      return new esj(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> vi a(ToIntFunction<T> $$0, T $$1) {
   ...
   public vi a(@Nullable ul $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable ul $$1) {
      if ($$1 == null) {
         $$1 = tq.b;
      }

      try {
         ub.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static to f(ByteBuf $$0) {
      ul $$1 = a($$0, tx.a(2097152L));
      if ($$1 != null && !($$1 instanceof to)) {
   ...
   @Nullable
   public static ul a(ByteBuf $$0, tx $$1) {
      try {
         ul $$2 = ub.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public vi a(String $$0, int $$1) {
      vy.a(this.d, $$0, $$1);
      return this;
   }

   public ajv q() {
      return new ajv(this.d(32767));
   }
   ...
   public <T> aju<T> a(aju<? extends ja<T>> $$0) {
      ajv $$1 = this.q();
      return aju.a($$0, $$1);
   }
   ...
   public esf v() {
      id $$0 = this.e();
      ij $$1 = this.b(ij.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new esf(new esj((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, axm.e($$1, 8)));
      }
   }
   ...
   public vi a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vi a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vi a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vi a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vi a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vi a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vi a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vi a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public vi b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vi c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vi d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vi e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vi f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vi g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vi h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vi a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vi b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vi i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vi a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vi a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vi b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vi b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vi b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vi b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vi b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vi b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vi g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vi b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vi a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vi a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vi a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vi h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vi c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vi b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vi b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vi b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
