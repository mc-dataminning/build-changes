...
public class vi {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xi.c("argument.nbt.trailing"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xi.c("argument.nbt.expected.key"));
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xi.c("argument.nbt.expected.value"));
   public static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(($$0, $$1) -> xi.b("argument.nbt.list.mixed", $$0, $$1));
   public static final Dynamic2CommandExceptionType e = new Dynamic2CommandExceptionType(($$0, $$1) -> xi.b("argument.nbt.array.mixed", $$0, $$1));
   public static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> xi.b("argument.nbt.array.invalid", $$0));
   ...
   public static final Codec<uk> j = Codec.withAlternative(i, uk.a);
   ...
   protected vh c() throws CommandSyntaxException {
      ...
      if (StringReader.isQuotedStringStart(this.v.peek())) {
         return vf.a(this.v.readQuotedString());
      } else {
