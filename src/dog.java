...
@Deprecated
public class dog extends dnr<dog.a> {
   private static final dfe a = csr.nc.n();

   public dog(Codec<dog.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dnt<dog.a> $$0) {
      gw $$1 = $$0.e();
      cqk $$2 = $$0.b();
      arx $$3 = $$0.d();
      dog.a $$4 = $$0.f();
   ...
   public static record a(drw b, drw c) implements dpv {
      public static final Codec<dog.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(drw.a.fieldOf("fluid").forGetter(dog.a::a), drw.a.fieldOf("barrier").forGetter(dog.a::b)).apply($$0, dog.a::new)
      );
