...
public class evs {
   ...
   public vk a(vk $$0, int $$1, wc $$2) {
      final evs.e $$3 = new evs.e((float)$$1);
   ...
   public void a(String $$0, int $$1, wc $$2, boolean $$3, evs.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      wc $$7 = $$2;

      while ($$5 < $$6) {
         evs.b $$8 = new evs.b((float)$$1);
   ...
   public void a(vk $$0, int $$1, wc $$2, BiConsumer<vk, Boolean> $$3) {
      List<evs.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new evs.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public vk a(int $$0, int $$1, wc $$2) {
         euw $$3 = new euw();
         ListIterator<evs.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, wc $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = evs.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements aua {
      ...
      @Override
      public boolean accept(int $$0, wc $$1, int $$2) {
         this.b = this.b - evs.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
