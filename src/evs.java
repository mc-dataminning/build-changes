...
public class evs implements ejs {
   ...
   public static class b implements evo {
      public static final MapCodec<evs.b> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(aex.a.fieldOf("hex_file").forGetter($$0x -> $$0x.c), evs.g.a.listOf().fieldOf("size_overrides").forGetter($$0x -> $$0x.d))
               .apply($$0, evs.b::new)
      );
      private final aex c;
      private final List<evs.g> d;

      private b(aex $$0, List<evs.g> $$1) {
         this.c = $$0;
         this.d = $$1;
      }
   ...
   static record g(int b, int c, evs.c d) {
      private static final Codec<evs.g> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(arg.w.fieldOf("from").forGetter(evs.g::a), arg.w.fieldOf("to").forGetter(evs.g::b), evs.c.a.forGetter(evs.g::c))
               .apply($$0, evs.g::new)
      );
      public static final Codec<evs.g> a = arg.a(
         e,
