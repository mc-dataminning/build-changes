...
public class evs implements js {
   public static final Codec<evs> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> ac.a($$0, 3).map($$0x -> new evs((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final evs b = new evs(0.0, 0.0, 0.0);
   public final double c;
   public final double d;
   public final double e;

   public static evs a(int $$0) {
   ...
   public static evs a(kd $$0) {
      return new evs((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static evs a(kd $$0, double $$1, double $$2, double $$3) {
      return new evs((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static evs b(kd $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static evs c(kd $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static evs a(kd $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public evs(double $$0, double $$1, double $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }

   public evs(Vector3f $$0) {
      this((double)$$0.x(), (double)$$0.y(), (double)$$0.z());
   }

   public evs a(evs $$0) {
      return new evs($$0.c - this.c, $$0.d - this.d, $$0.e - this.e);
   }

   public evs d() {
      double $$0 = Math.sqrt(this.c * this.c + this.d * this.d + this.e * this.e);
      return $$0 < 1.0E-4 ? b : new evs(this.c / $$0, this.d / $$0, this.e / $$0);
   }

   public double b(evs $$0) {
      return this.c * $$0.c + this.d * $$0.d + this.e * $$0.e;
   }

   public evs c(evs $$0) {
      return new evs(this.d * $$0.e - this.e * $$0.d, this.e * $$0.c - this.c * $$0.e, this.c * $$0.d - this.d * $$0.c);
   }
   ...
   public evs a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }
   ...
   public evs b(double $$0, double $$1, double $$2) {
      return new evs(this.c + $$0, this.d + $$1, this.e + $$2);
   }
   ...
   public boolean a(evs $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.c;
      double $$4 = $$0.b() - this.d;
      double $$5 = $$0.c() - this.e;
   ...
   public evs d(double $$0, double $$1, double $$2) {
      return new evs(this.c * $$0, this.d * $$1, this.e * $$2);
   }

   public evs a(azh $$0, float $$1) {
   ...
   public evs a(evs $$0, double $$1) {
      return new evs(ayz.d($$1, this.c, $$0.c), ayz.d($$1, this.d, $$0.d), ayz.d($$1, this.e, $$0.e));
   }
   ...
   public static evs a(evr $$0) {
      return a($$0.i, $$0.j);
   }

   public static evs a(float $$0, float $$1) {
      ...
      return new evs((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public evs a(EnumSet<je.a> $$0) {
   ...
   public evs a(je.a $$0, double $$1) {
      double $$2 = $$0 == je.a.a ? $$1 : this.c;
      double $$3 = $$0 == je.a.b ? $$1 : this.d;
      double $$4 = $$0 == je.a.c ? $$1 : this.e;
      return new evs($$2, $$3, $$4);
   }

   public evs a(je $$0, double $$1) {
      kd $$2 = $$0.q();
      return new evs(this.c + $$1 * (double)$$2.u(), this.d + $$1 * (double)$$2.v(), this.e + $$1 * (double)$$2.w());
   }
