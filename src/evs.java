...
public class evs {
   ...
   @Nullable
   private String g;
   private static final evs.a h = new evs.a() {
      @Nullable
      @Override
      public evr a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (evw.a(this.d, "Get capabilities")) {
         ...
         if (evw.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  evw.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !evw.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public evr a(evs.c $$0) {
      return ($$0 == evs.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements evs.a {
      private final int a;
      private final Set<evr> b = Sets.newIdentityHashSet();
      ...
      public evr a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               evs.a.warn("Maximum sound pool size {} reached", this.a);
            }
