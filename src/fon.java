...
public class fon {
   ...
   private static final xd e = xd.a("gui.banned.skin.description", xd.a(axy.n));

   public static fop a(BooleanConsumer $$0, BanDetails $$1) {
      return new fop($$0, a($$1), b($$1), axy.n, xc.m, true);
   }

   public static fop a(Runnable $$0) {
      URI $$1 = axy.n;
      return new fop($$2 -> {
         if ($$2) {
            ad.m().a($$1);
   ...
   public static fop a(String $$0, Runnable $$1) {
      URI $$2 = axy.n;
      return new fop($$2x -> {
         if ($$2x) {
            ad.m().a($$2);
         ...
         $$1.run();
      }, a, xd.a("gui.banned.name.description", xd.b($$0).a(n.o), xd.a(axy.n)), $$2, xc.m, true);
   }
   ...
   private static xd b(BanDetails $$0) {
      return xd.a("gui.banned.description", c($$0), d($$0), xd.a(axy.n));
   }
