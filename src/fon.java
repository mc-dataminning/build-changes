...
public class fon {
   ...
   private static final Map<edq.a, String> e = ae.a(new EnumMap<>(edq.a.class), $$0 -> {
      $$0.put(edq.a.a, "SW");
      $$0.put(edq.a.b, "S");
      $$0.put(edq.a.c, "OW");
      $$0.put(edq.a.d, "O");
   ...
   private eaa l;
   @Nullable
   private CompletableFuture<eaa> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bod r = new bod(1);
   private final bod s = new bod(boi.values().length);
   private final bod t = new bod(1);
   private final bod u = new bod(1);
   private final Map<boe, bod> v = Map.of(boe.a, this.s);
   private final fpx w;
   private final fqa x;
   private final fpy y;
   private final fpw z;
   ...
   public fon(fmg $$0) {
      ...
      this.g = new fon.a();
      this.h = $$0.h;
      this.w = new fpx(this.h, this.r);
      this.x = new fqa(this.h, this.s, () -> $$0.s.t().g());
      this.y = new fpy(this.h, this.t);
      this.z = new fpw(this.h, this.u);
      this.A = new fpz(this.h);
   }
   ...
   private void a(fns $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         if ($$27.E()) {
            ...
            int $$29 = this.f.s.a(dhr.a, $$14);
            int $$30 = this.f.s.a(dhr.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            eaa $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (edq.a $$33 : edq.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.w();
                  bth $$37 = new bth($$23.al(), $$23.ad(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dht.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bwj> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bwj.values())
   ...
   private static String a(jq<dik> $$0) {
   ...
   private dhi s() {
      return (dhi)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ah()))), this.f.s);
   }
   ...
   private eaa t() {
      if (this.m == null) {
         ...
         this.m = $$0.m().b(this.k.h, this.k.i, ear.n, false).thenApply($$0x -> (eaa)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ffl.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fmg.Q().aO().k(), fmg.Q().aO().l(), ffl.a()),
            ffl.c(),
            ffl.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == fbw.a.b) {
            ...
            for (Entry<dyx<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == fbw.a.b) {
            ...
            for (Entry<dyx<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dyx<?>, Comparable<?>> $$0) {
      dyx<?> $$1 = $$0.getKey();
