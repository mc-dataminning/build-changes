...
public class fon {
   ...
   public static void a(File $$0, fha $$1, Consumer<ww> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fha $$2, Consumer<ww> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fha $$2, Consumer<ww> $$3) {
      fhq $$4 = a($$2);
      ...
      af.i().execute(() -> {
         try {
            $$4.a($$6);
            ww $$3x = ww.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new wu.d($$6.getAbsoluteFile())));
            $$3.accept(ww.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(ww.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static fhq a(fha $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fhq $$3 = new fhq($$1, $$2, false);
   ...
   public fon(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
