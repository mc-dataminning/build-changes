...
public class ni implements ll {
   ...
   public CompletableFuture<?> a(lj $$0) {
      ...
      Map<akn, Supplier<JsonElement>> $$3 = Maps.newHashMap();
      Set<ctl> $$4 = Sets.newHashSet();
      BiConsumer<akn, Supplier<JsonElement>> $$5 = ($$1x, $$2x) -> {
         Supplier<JsonElement> $$3x = $$3.put($$1x, $$2x);
         if ($$3x != null) {
            throw new IllegalStateException("Duplicate model definition for " + $$1x);
         }
      };
      Consumer<ctl> $$6 = $$4::add;
      new ng($$2, $$5, $$6).a();
      new nh($$5).a();
      List<dea> $$7 = le.e.g().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
         ...
         return CompletableFuture.allOf(this.a($$0, $$1, $$0x -> this.d.a($$0x.q().h().a())), this.a($$0, $$3, this.e::a));
      }
   }
