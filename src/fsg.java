public abstract class fsg extends fsc {
   private static final ftw a = new ftw(alg.b("widget/text_field"), alg.b("widget/text_field_highlighted"));
   private static final int c = 4;

   public fsg(int $$0, int $$1, int $$2, int $$3, wy $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(frv var1, int var2, int var3, float var4);
