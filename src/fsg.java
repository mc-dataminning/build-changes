...
public class fsg {
   ...
   private static final Comparator<ffv> L = Comparator.comparing(ffv::d).reversed().thenComparing(ffv::c, String.CASE_INSENSITIVE_ORDER);
   ...
   private final fpo ak;
   private final fsw al;
   private int am;
   @Nullable
   private wy an;
   private int ao;
   ...
   public float b = 1.0F;
   private int ar;
   private czk as = czk.k;
   private final ftd at;
   private final fud au;
   private final fuv av;
   private final ftw aw;
   private final fsu ax;
   private int ay;
   @Nullable
   private wy az;
   @Nullable
   ...
   public fsg(fpo $$0) {
      ...
      this.av = new fuv($$0);
      this.al = new fsw($$0);
      this.aw = new ftw($$0, this);
      this.ax = new fsu($$0);
      this.au = new fud($$0);
      this.a();
      fsk $$1 = new fsk().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ax.a($$0x));
      fsk $$2 = new fsk().a(this::o).a(($$0x, $$1x) -> {
         if (this.at.d()) {
            this.at.a($$0x);
         }
   ...
   public void a(fsh $$0, fpe $$1) {
      this.aL.a($$0, $$1);
   }

   private void c(fsh $$0, fpe $$1) {
      if (fpo.N()) {
         this.a($$0, this.ak.ao());
      }
   ...
   private void d(fsh $$0, fpe $$1) {
      if (this.ak.t.go() > 0) {
         ...
         $$0.a(gqx.M(), 0, 0, $$0.a(), $$0.b(), $$4);
         bqp.a().c();
      }
   }

   private void e(fsh $$0, fpe $$1) {
      fsf $$2 = this.f();
   ...
   private void h(fsh $$0, fpe $$1) {
      fgc $$2 = this.ak.s.R();
      ffu $$3 = null;
      ffx $$4 = $$2.e(this.ak.t.cH());
      if ($$4 != null) {
         fft $$5 = fft.a($$4.o());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      ffu $$6 = $$3 != null ? $$3 : $$2.a(fft.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fsh $$0, fpe $$1) {
      fgc $$2 = this.ak.s.R();
      ffu $$3 = $$2.a(fft.a);
   ...
   private void j(fsh $$0, fpe $$1) {
      fps $$2 = this.ak.n;
      if ($$2.aE().a()) {
         if (this.ak.r.i() != dje.d || this.a(this.ak.w)) {
            if (this.at.d() && !this.ak.t.gz() && !$$2.Y().c()) {
               ...
               int $$5 = 15;
               $$0.a(gqx::K, c, ($$0.a() - 15) / 2, ($$0.b() - 15) / 2, 15, 15);
               if (this.ak.n.F().c() == fov.b) {
                  ...
                  int $$9 = $$0.a() / 2 - 8;
                  if ($$7) {
                     $$0.a(gqx::K, d, $$9, $$8, 16, 16);
                  } else if ($$6 < 1.0F) {
                     int $$10 = (int)($$6 * 17.0F);
                     $$0.a(gqx::K, e, $$9, $$8, 16, 4);
                     $$0.a(gqx::K, f, 16, 4, 0, 0, $$9, $$8, $$10, 4);
                  }
               }
            }
         }
   ...
   private boolean a(@Nullable fev $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.d() == fev.a.c) {
         return ((feu)$$0).a() instanceof bui;
      } else if ($$0.d() == fev.a.b) {
         iv $$1 = ((fet)$$0).b();
         djh $$2 = this.ak.s;
      ...
      if (!$$2.isEmpty() && (this.ak.z == null || !this.ak.z.C())) {
         ...
         for (bvm $$7 : Ordering.natural().reverse().sortedCopy($$2)) {
            ...
            if ($$7.h()) {
               ...
               float $$11 = 1.0F;
               if ($$7.f()) {
                  $$0.a(gqx::H, g, $$9, $$10, 24, 24);
               } else {
                  $$0.a(gqx::H, h, $$9, $$10, 24, 24);
                  if ($$7.a(200)) {
                     int $$12 = $$7.d();
                     int $$13 = 10 - $$12 / 20;
               ...
               $$6.add(() -> {
                  int $$5x = axw.a($$17);
                  $$0.a(gqx::H, $$14, $$15 + 3, $$16 + 3, 18, 18, $$5x);
               });
            }
         }
   ...
   private void l(fsh $$0, fpe $$1) {
      if (this.ak.r.i() == dje.d) {
         this.av.a($$0);
      } else {
         this.m($$0, $$1);
      }
   ...
   private void m(fsh $$0, fpe $$1) {
      ...
      if ($$2 != null) {
         ...
         $$0.a(gqx::H, i, $$5 - 91, $$0.b() - 22, 182, 22);
         $$0.a(gqx::H, j, $$5 - 91 - 1 + $$2.gi().f() * 20, $$0.b() - 22 - 1, 24, 23);
         if (!$$3.f()) {
            if ($$4 == bxa.a) {
               $$0.a(gqx::H, k, $$5 - 91 - 29, $$0.b() - 23, 29, 24);
            } else {
               $$0.a(gqx::H, l, $$5 + 91, $$0.b() - 23, 29, 24);
            }
         }
         ...
         if (this.ak.n.F().c() == fov.c) {
            ...
            if ($$13 < 1.0F) {
               ...
               int $$16 = (int)($$13 * 19.0F);
               $$0.a(gqx::H, m, $$15, $$14, 18, 18);
               $$0.a(gqx::H, n, 18, 18, 0, 18 - $$16, $$15, $$14 + 18 - $$16, 18, $$16);
            }
         }
      }
   }

   private void a(bxt $$0, fsh $$1, int $$2) {
      bqp.a().a("jumpBar");
      float $$3 = this.ak.t.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
      int $$6 = $$1.b() - 32 + 3;
      $$1.a(gqx::H, o, $$2, $$6, 182, 5);
      if ($$0.c() > 0) {
         $$1.a(gqx::H, p, $$2, $$6, 182, 5);
      } else if ($$5 > 0) {
         $$1.a(gqx::H, q, 182, 5, 0, 0, $$2, $$6, $$5, 5);
      }

      bqp.a().c();
   }

   private void a(fsh $$0, int $$1) {
      bqp.a().a("expBar");
      int $$2 = this.ak.t.gs();
      if ($$2 > 0) {
         int $$3 = 182;
         ...
         int $$5 = $$0.b() - 32 + 3;
         $$0.a(gqx::H, r, $$1, $$5, 182, 5);
         if ($$4 > 0) {
            $$0.a(gqx::H, s, 182, 5, 0, 0, $$1, $$5, $$4, 5);
         }
      }
   ...
   @Nullable
   private crj n() {
      return this.ak.ao() instanceof crj $$0 ? $$0 : null;
   }
   ...
   private static void a(fsh $$0, crj $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eQ();
      if ($$6 > 0) {
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fsh $$0, crj $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fsg.b $$11 = fsg.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fsg.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fsg.b.d ? $$11 : fsg.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fsh $$0, fsg.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a(gqx::H, $$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void a(fsh $$0, crj $$1, int $$2, int $$3, int $$4) {
      int $$5 = $$1.cq();
      ...
      if ($$7 || $$6 < $$5) {
         ...
         for (int $$12 = 1; $$12 <= 10; $$12++) {
            int $$13 = $$4 - ($$12 - 1) * 8 - 9;
            if ($$12 <= $$8) {
               $$0.a(gqx::H, C, $$13, $$3, 9, 9);
            } else if ($$11 && $$12 == $$9 && $$7) {
               $$0.a(gqx::H, D, $$13, $$3, 9, 9);
               this.a($$12, $$1, $$10);
            } else if ($$12 > 10 - $$10) {
               int $$14 = $$10 == 10 && this.am % 2 == 0 ? this.aj.a(2) : 0;
               $$0.a(gqx::H, E, $$13, $$3 + $$14, 9, 9);
            }
         }
      }
   }
   ...
   private void a(int $$0, crj $$1, int $$2) {
      if (this.aI != $$0) {
   ...
   private void a(fsh $$0, crj $$1, int $$2, int $$3) {
      cuy $$4 = $$1.gt();
      int $$5 = $$4.a();
      ...
      for (int $$6 = 0; $$6 < 10; $$6++) {
         ...
         int $$14 = $$3 - $$6 * 8 - 9;
         $$0.a(gqx::H, $$8, $$14, $$7, 9, 9);
         if ($$6 * 2 + 1 < $$5) {
            $$0.a(gqx::H, $$10, $$14, $$7, 9, 9);
         }

         if ($$6 * 2 + 1 == $$5) {
            $$0.a(gqx::H, $$9, $$14, $$7, 9, 9);
         }
      }
   }
      ...
      if ($$1 != null) {
         ...
         if ($$2 != 0) {
            ...
            for (int $$7 = 0; $$2 > 0; $$7 += 20) {
               ...
               for (int $$9 = 0; $$9 < $$8; $$9++) {
                  int $$10 = $$5 - $$9 * 8 - 9;
                  $$0.a(gqx::H, F, $$10, $$6, 9, 9);
                  if ($$9 * 2 + 1 + $$7 < $$3) {
                     $$0.a(gqx::H, G, $$10, $$6, 9, 9);
                  }

                  if ($$9 * 2 + 1 + $$7 == $$3) {
                     $$0.a(gqx::H, H, $$10, $$6, 9, 9);
                  }
               }
   ...
   private void a(fsh $$0, alg $$1, float $$2) {
      int $$3 = axw.a($$2);
      $$0.a(gqx::F, $$1, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$3);
   }
   ...
   private void a(fsh $$0, float $$1) {
      ...
      int $$9 = $$7 + $$5;
      int $$10 = $$8 + $$6;
      $$0.a(gqx::H, J, $$7, $$8, 0.0F, 0.0F, $$5, $$6, $$5, $$6);
      $$0.a(gqx.M(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gqx.M(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gqx.M(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gqx.M(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bwi $$0) {
      iv $$1 = iv.a($$0.dz(), $$0.dD(), $$0.dF());
      float $$2 = gqj.a($$0.dU().B_(), $$0.dU().B($$1));
      float $$3 = azm.a(1.0F - $$2, 0.0F, 1.0F);
      this.b = this.b + ($$3 - this.b) * 0.01F;
   }

   private void a(fsh $$0, @Nullable bwi $$1) {
      ecg $$2 = this.ak.s.A_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
      ...
      $$0.a(gqx::J, I, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$7);
   }

   private void b(fsh $$0, float $$1) {
      if ($$1 < 1.0F) {
         $$1 *= $$1;
         $$1 *= $$1;
         $$1 = $$1 * 0.8F + 0.2F;
      ...
      int $$2 = axw.a($$1);
      hjk $$3 = this.ak.ap().a().a(dmo.eu.m());
      $$0.a(gqx::F, $$3, 0, 0, $$0.a(), $$0.b(), $$2);
   }

   private void c(fsh $$0, float $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      $$0.c().a();
      ...
      float $$6 = 0.4F * $$1;
      float $$7 = 0.2F * $$1;
      $$0.a($$0x -> gqx.N(), a, 0, 0, 0.0F, 0.0F, $$2, $$3, $$2, $$3, axw.a(1.0F, $$5, $$6, $$7));
      $$0.c().b();
   }

   private void a(fsh $$0, int $$1, int $$2, fpe $$3, crj $$4, czk $$5, int $$6) {
      if (!$$5.f()) {
