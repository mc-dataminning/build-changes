...
public class fsg extends fsd {
   private final List<fsg.a> c = new ArrayList<>();
   private int d;
   private int e;
   private final fsl f = fsl.i().a(0.5F, 0.5F);
   ...
   public static void a(fsk $$0, int $$1, int $$2, int $$3, int $$4) {
      a($$0, $$1, $$2, $$3, $$4, 0.5F, 0.5F);
   }

   public static void a(fsk $$0, ftb $$1) {
      a($$0, $$1.f().a(), $$1.f().b(), $$1.g(), $$1.h());
   }

   public static void a(fsk $$0, ftb $$1, float $$2, float $$3) {
      a($$0, $$1.d(), $$1.b(), $$1.g(), $$1.h(), $$2, $$3);
   }

   public static void a(fsk $$0, int $$1, int $$2, int $$3, int $$4, float $$5, float $$6) {
      a($$1, $$3, $$0.A(), $$0::j, $$5);
      a($$2, $$4, $$0.y(), $$0::k, $$6);
   }
