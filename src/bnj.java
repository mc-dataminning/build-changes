...
public class bnj<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bnj(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bnj<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bnk<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bnk<T> $$0 = bnk.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bnk<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bnj.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bnj.this.c.position();
               }
