...
public class bnj implements bnk {
   ...
   private static final bnj k = new bnj();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bni $$0) {
      URL $$1 = bnj.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bni $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnm a = new bnm(() -> bnj.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnj.this.l && $$0.getState() == RecordingState.STOPPED) {
