...
public record bnj(Instant a, String b, long c) {
   ...
   public static bnj a(RecordedEvent $$0) {
      ...
      return new bnj($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bnj.a a(List<bnj> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bnj>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bnj $$3 = (bnj)$$2x.get(0);
            bnj $$4 = (bnj)$$2x.get($$2x.size() - 1);
