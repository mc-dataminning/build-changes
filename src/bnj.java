...
public class bnj {
   ...
   private static void a(bnr $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnm $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvc, bnv<bnl>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bnv)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvc, bnv<bnl>> $$3 : $$0) {
         bnv<bnl> $$4 = (bnv<bnl>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dvc)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnt> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bmy.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnh $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnj::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnj::a));
      return $$1;
   }

   private JsonElement a(bno.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bnh $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnj::a));
      $$1.add("received", this.a($$0.k(), bnj::a));
      return $$1;
   }

   private <T> JsonElement a(bnq<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bnn> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bnn>, ToDoubleFunction<bnn>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bnn::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bnn::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bnn::c));
      return $$1;
   }
}
