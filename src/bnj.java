...
public class bnj {
   ...
   private bnj(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bnj a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bnj($$0, $$1);
   }

   public bnj.d a() throws IOException {
      bnj.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bnj.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bnj.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bnj.c $$3 = bnj.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bnj.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bnj.a($$0, $$3);
            }
         }
   ...
   public bnj.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bnj.c> $$2 = this.a().c();
      ...
      bnj.e $$4 = new bnj.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bnj.c b) implements bnj.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bnj.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bnj.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bnj.b> {
      private final List<bnj.b> a;

      d(List<bnj.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bnj.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bnj.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bnj.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bnj.d a() {
         ListIterator<bnj.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bnj.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bnj.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bnj.b> b() {
         return this.a.stream();
      }

      public Set<bnj.c> c() {
         return this.a.stream().map(bnj.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bnj.c b) implements bnj.b {
