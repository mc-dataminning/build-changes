...
public abstract class ayz extends DataFix {
   ...
   public ayz(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(ayp.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(ayp.x);
      Type<Pair<String, String>> $$2 = DSL.named(ayp.v.typeName(), azx.a());
      if (!Objects.equals(this.getOutputSchema().getType(ayp.v), $$2)) {
