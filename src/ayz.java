...
public class ayz {
   ...
   public static int f(float $$0, float $$1, float $$2) {
      return ayj.b.a(0, d($$0 * 255.0F), d($$1 * 255.0F), d($$2 * 255.0F));
   }
   ...
   public static boolean a(evr $$0, evr $$1, evm $$2) {
   ...
   public static int h(float $$0, float $$1, float $$2) {
      ...
      return ayj.b.a(0, a((int)($$8 * 255.0F), 0, 255), a((int)($$9 * 255.0F), 0, 255), a((int)($$10 * 255.0F), 0, 255));
   }
