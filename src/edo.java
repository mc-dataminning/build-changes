...
public class edo extends ece<efc> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<edo.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new edo.b());

   public edo(Codec<efc> $$0) {
      super($$0);
   }

   public static List<edo.a> a(dds $$0) {
      ayw $$1 = ayw.a($$0.C());
      long $$2 = $$1.g() & 65535L;
      return (List<edo.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(ecg<efc> $$0) {
      efc $$1 = $$0.f();
      dds $$2 = $$0.b();
      ayw $$3 = $$0.d();
      jd $$4 = $$0.e();
   ...
   private void a(ddl $$0, ayw $$1, efc $$2, edo.a $$3) {
      int $$4 = $$3.c();
   ...
   public static class a {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new ewx((double)($$0 - $$2), (double)dwy.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)dwy.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<edo.a>> {
      public List<edo.a> a(Long $$0) {
         IntArrayList $$1 = ad.a(IntStream.range(0, 10), ayw.a($$0));
         List<edo.a> $$2 = Lists.newArrayList();
