public class gns<T extends btn, M extends fwp<T>> extends gpe<T, M> {
   private static final akr a = akr.b("textures/entity/bee/bee_stinger.png");

   public gns(glk<T, M> $$0) {
      super($$0);
   }
   ...
   private static void a(fbm $$0, fbi.a $$1, float $$2, int $$3, float $$4, float $$5, int $$6) {
      $$0.a($$1, $$2, (float)$$3, 0.0F).a(-1).a($$4, $$5).b(gqc.d).c($$6).b($$1, 0.0F, 1.0F, 0.0F);
   }
}
