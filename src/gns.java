...
public class gns extends gmr<bue, gtr> {
   public gns(gms.a $$0) {
      super($$0);
   }

   public void a(gtr $$0, fcu $$1, ggv $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bue $$0, gtr $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(bue $$0) {
      return false;
   }
}
