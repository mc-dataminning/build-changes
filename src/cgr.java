...
public enum cgr implements asp, cgq {
   ...
   private final arr<cmg> q;

   private cgr(String $$0, int $$1, EnumMap<cgp.a, Integer> $$2, int $$3, apc $$4, float $$5, float $$6, Supplier<cmg> $$7) {
      this.j = $$0;
      this.k = $$1;
      this.l = $$2;
      this.m = $$3;
