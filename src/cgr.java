...
public class cgr extends che implements btv, bua {
   ...
   public static final akg<Boolean> cc = akk.a(cgr.class, aki.k);
   public static final akg<Long> cd = akk.a(cgr.class, aki.c);
   public final bsk ce = new bsk();
   public final bsk cf = new bsk();
   public final bsk cg = new bsk();
   public final bsk ch = new bsk();
   public final bsk ci = new bsk();
   private static final bss cH = bss.b(bsv.o.l(), bsv.o.m() - 1.43F).b(0.845F);
   private int cI = 0;
   private int cJ = 0;

   public cgr(bsv<? extends cgr> $$0, dbt $$1) {
      super($$0, $$1);
      this.bP = new cgr.c();
      this.bO = new cgr.b();
      ccv $$2 = (ccv)this.K();
   ...
   public static bur.a s() {
      return gP().a(bus.q, 32.0).a(bus.r, 0.09F).a(bus.m, 0.42F).a(bus.v, 1.5);
   }
   ...
   @Override
   public bss e(btw $$0) {
      return $$0 == btw.k ? cH.a(this.ed()) : super.e($$0);
   }
   ...
   public void l() {
      ...
      if (this.cI > 0) {
         this.cI--;
         if (this.cI == 0) {
            this.dP().a(null, this.dp(), avw.dz, avx.g, 1.0F, 1.0F);
         }
      }
   ...
   protected float e(cms $$0) {
      ...
      return (float)this.g(bus.r) + $$1;
   }

   @Override
   protected evl j(btk $$0) {
      return this.u() ? new evl(this.dH(), this.dF()) : super.j($$0);
   }

   @Override
   protected evm b(cms $$0, evm $$1) {
      return this.u() ? evm.b : super.b($$0, $$1);
   }
   ...
   protected void b(float $$0, evm $$1) {
      ...
      this.i(this.bL().d(1.0, 0.0, 1.0).d().a((double)(22.2222F * $$0) * this.g(bus.r) * (double)this.aN()).b(0.0, (double)(1.4285F * $$0) * $$2, 0.0));
      this.cI = 55;
      this.w(true);
      this.av = true;
   }
   ...
   protected void b(iz $$0, drx $$1) {
      if ($$1.a(awl.bp)) {
         this.a(avw.dH, 1.0F, 1.0F);
      } else {
         this.a(avw.dG, 1.0F, 1.0F);
      }
   }
   ...
   public boolean gq() {
      return this.g(this.gy() ? btw.a : btw.k);
   }
   ...
   public boolean a(cfa $$0) {
      if ($$0 != this && $$0 instanceof cgr $$1 && this.gX() && $$1.gX()) {
         return true;
      }
   ...
   @Nullable
   public cgr b(arb $$0, bsj $$1) {
      return bsv.o.a((dbt)$$0);
   }
   ...
   protected evm a(bsp $$0, bss $$1, float $$2) {
      ...
      return new evm(0.0, (double)$$6, (double)($$5 * $$2)).b(-this.dF() * (float) (Math.PI / 180.0));
   }
   ...
   private double a(boolean $$0, float $$1, bss $$2, float $$3) {
      ...
      if ($$8) {
         ...
         float $$15 = ayu.a((float)this.gE() + $$1, 0.0F, (float)$$10);
         boolean $$16 = $$15 < (float)$$11;
         float $$17 = $$16 ? $$15 / (float)$$11 : ($$15 - (float)$$11) / (float)($$10 - $$11);
         float $$18 = $$5 - $$12 * $$6;
         $$4 += $$9 ? (double)ayu.i($$17, $$16 ? $$5 : $$18, $$16 ? $$18 : $$7) : (double)ayu.i($$17, $$16 ? $$7 - $$5 : $$7 - $$18, $$16 ? $$7 - $$18 : 0.0F);
      }
   ...
   public evm p(float $$0) {
      bss $$1 = this.a(this.ar());
      float $$2 = this.ed();
      return new evm(0.0, this.a(true, $$0, $$1, $$2) - (double)(0.2F * $$2), (double)($$1.a() * 0.56F));
   }
   ...
   @Override
   protected bzg E() {
      return new cgr.a(this);
   }

   class a extends bzg {
      public a(final cgr $$0) {
         super($$0);
      }
   ...
   class c extends bzl {
      ...
      @Override
      public void a() {
         if (this.k == bzl.a.b && !cgr.this.gd() && cgr.this.gy() && !cgr.this.gA() && cgr.this.gq()) {
            cgr.this.gC();
         }
