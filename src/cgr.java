...
public class cgr extends cgq {
   ...
   private static final ajy<Byte> bX = akc.a(cgr.class, aka.a);
   ...
   public cgr(bur<? extends cgr> $$0, dgh $$1) {
      super($$0, $$1);
      if (!$$1.C) {
         this.x(true);
      }
   ...
   protected void a(ard $$0) {
      ...
      if (this.p()) {
         ...
         faz $$7 = this.dy();
         faz $$8 = $$7.b((Math.signum($$4) * 0.5 - $$7.d) * 0.1F, (Math.signum($$5) * 0.7F - $$7.e) * 0.1F, (Math.signum($$6) * 0.5 - $$7.f) * 0.1F);
         this.i($$8);
   ...
   public static boolean b(bur<cgr> $$0, dgi $$1, buq $$2, ji $$3, azh $$4) {
      if ($$3.v() >= $$1.a(ecr.a.b, $$3).v()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
         int $$6 = 4;
