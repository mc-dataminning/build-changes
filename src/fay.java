public class fay implements fba {
   private static final aew a = new aew("container/bundle/background");
   private static final int b = 4;
   private static final int c = 1;
   private static final int d = 18;
   private static final int e = 20;
   private final hn<cjf> f;
   private final int g;
   ...
   static enum a {
      a(new aew("container/bundle/blocked_slot"), 18, 20),
      b(new aew("container/bundle/slot"), 18, 20);
