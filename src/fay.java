public class fay<T extends bfj> extends fcp<T> {
   public fay(fee $$0) {
   ...
   public static fek c() {
      ...
      $$1.a(
         "body",
         fej.c().a(18, 4).a(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F).a(52, 0).a(-2.0F, 2.0F, -8.0F, 4.0F, 6.0F, 1.0F),
         feg.a(0.0F, 5.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
      );
