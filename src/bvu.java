...
public class bvu extends bkb implements bjn {
   private static final aef<Boolean> bX = aei.a(bvu.class, aeh.k);
   ...
   protected apd w() {
      if (this.X_()) {
         ...
         return this.s() && this.eu() < 10.0F ? ape.AB : ape.Ay;
      } else {
         return ape.At;
      }
   }
   ...
   public void l() {
      ...
      if (this.bw()) {
         ...
         if (this.ba()) {
            ...
            if (this.cg == 0.0F) {
               this.a(ape.Az, this.eV(), (this.ag.i() - this.ag.i()) * 0.2F + 1.0F);
               this.a(djt.u);
            }
            ...
            if (this.cg > 0.4F) {
               ...
               int $$1 = (int)(arx.a((this.cg - 0.4F) * (float) Math.PI) * 7.0F);
               ehn $$2 = this.do();
   ...
   public float E(float $$0) {
      return Math.min(0.5F + arx.i($$0, this.ch, this.cg) / 2.0F * 0.5F, 1.0F);
   }

   public float f(float $$0, float $$1) {
      float $$2 = (arx.i($$0, this.ch, this.cg) + $$1) / 1.8F;
      if ($$2 < 0.0F) {
         $$2 = 0.0F;
      } else if ($$2 > 1.0F) {
         $$2 = 1.0F;
      ...
      return arx.a($$2 * (float) Math.PI) * arx.a($$2 * (float) Math.PI * 11.0F) * 0.15F * (float) Math.PI;
   }

   public float F(float $$0) {
      return arx.i($$0, this.cd, this.cc) * 0.15F * (float) Math.PI;
   }
   ...
   public static boolean c(biu<bvu> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      return $$1.a_($$3.d()).a(apt.bX) && a($$1, $$3);
   }
