...
public abstract class cno implements cnn {
   ...
   private final Supplier<Set<he<cnk>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   public Pair<gu, he<cnk>> a(gu $$0, int $$1, int $$2, int $$3, Predicate<he<cnk>> $$4, cnt.f $$5, cmp $$6) {
      Set<he<cnk>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.ap ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               he<cnk> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
