...
public class fbs {
   ...
   @Nullable
   public static fbt a(Iterable<fbs> $$0, fbx $$1, fbx $$2, jh $$3) {
   ...
   @Nullable
   private static jm a(fbs $$0, fbx $$1, double[] $$2, @Nullable jm $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jm a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fbx $$6, double[] $$7, @Nullable jm $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public fbx f() {
      return new fbx(bae.d(0.5, this.a, this.d), bae.d(0.5, this.b, this.e), bae.d(0.5, this.c, this.f));
   }

   public fbx g() {
      return new fbx(bae.d(0.5, this.a, this.d), this.b, bae.d(0.5, this.c, this.f));
   }
