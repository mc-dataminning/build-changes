...
public class fbs<T extends bfz> extends fad<T> implements fag, fbn {
   ...
   public final fee p;
   public final fee q;
   public fbs.a r = fbs.a.a;
   public fbs.a s = fbs.a.a;
   public boolean t;
   public float u;
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.n.f = 0.0F;
      this.o.f = 0.0F;
      boolean $$9 = $$0.fh() == bft.b;
      if ($$0.fi()) {
         boolean $$10 = $$0.fj() == bdw.a;
         if ($$10 == $$9) {
            this.a($$0);
         } else {
            this.b($$0);
      ...
      if (this.u > 0.0F) {
         ...
         float $$15 = $$13 == bft.a && this.c > 0.0F ? 0.0F : this.u;
         if (!$$0.fi()) {
            if ($$12 < 14.0F) {
               ...
               this.n.e = apa.i($$14, this.n.e, (float) (Math.PI / 2) * $$16);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = apa.i($$14, this.n.f, (float) Math.PI);
               ...
               this.n.e = apa.i($$14, this.n.e, (float) (Math.PI / 2) - (float) (Math.PI / 2) * $$17);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = apa.i($$14, this.n.f, (float) Math.PI);
   ...
   private void a(T $$0) {
      switch (this.s) {
         ...
         case j:
            ...
            break;
         case h:
            this.n.e = apa.a(this.k.e - 1.9198622F - ($$0.bU() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   private void b(T $$0) {
      switch (this.r) {
         ...
         case j:
            ...
            break;
         case h:
            this.o.e = apa.a(this.k.e - 1.9198622F - ($$0.bU() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   protected void a(T $$0, float $$1) {
      if (!(this.c <= 0.0F)) {
         ...
         $$3.g = $$3.g + apa.a(this.c * (float) Math.PI) * -0.4F;
      }
   }
