...
public abstract class fbs {
   ...
   public fat a() {
      if (this.c()) {
         ...
         return new fat(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
      }
   }

   public fbs b() {
      return this.c() ? fbp.a() : fbp.a(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
   }
   ...
   public fbs a(double $$0, double $$1, double $$2) {
      return (fbs)(this.c() ? fbp.a() : new fba(this.a, new fbo(this.a(jn.a.a), $$0), new fbo(this.a(jn.a.b), $$1), new fbo(this.a(jn.a.c), $$2)));
   }

   public fbs d() {
      fbs[] $$0 = new fbs[]{fbp.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fbp.b($$0[0], fbp.a($$1, $$2, $$3, $$4, $$5, $$6), fbc.o));
      return $$0[0];
   }

   public void a(fbp.a $$0) {
      this.a
         .a(
   ...
   public List<fat> e() {
      List<fat> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fat($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jn.a.a, $$4.d - (double)$$2.u()), this.a(jn.a.b, $$4.e - (double)$$2.v()), this.a(jn.a.c, $$4.f - (double)$$2.w()))
               ? new fau($$4, jn.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fat.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fay> b(fay $$0) {
      if (this.c()) {
   ...
   public fbs a(jn $$0) {
      if (!this.c() && this != fbp.b()) {
         if (this.b != null) {
            fbs $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fbs b(jn $$0) {
      ...
      if (this.d($$1)) {
         ...
         fbq $$4 = new fbq(this, $$1, $$3);
         if ($$4.c()) {
            return fbp.a();
         } else {
            return (fbs)($$4.f() ? fbp.b() : $$4);
         }
      }
   }
   ...
   public double a(jn.a $$0, fat $$1, double $$2) {
      return this.a(jf.a($$0, jn.a.a), $$1, $$2);
   }

   protected double a(jf $$0, fat $$1, double $$2) {
      if (this.c()) {
         return $$2;
