...
public class fbs extends fdb {
   ...
   protected void aN_() {
      ...
      this.b = new exp(this.f.i, 4, this.h - 12, this.g - 4, 12, vf.c("chat.editBox")) {
         @Override
         protected vt aK_() {
            return super.aK_().b(fbs.this.o.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new exj(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
      this.c(this.b);
   }
   ...
   public void a(ewu $$0, int $$1, int $$2, float $$3) {
      ...
      super.a($$0, $$1, $$2, $$3);
      this.o.a($$0, $$1, $$2);
      evd $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(faz $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fay.a, vf.a("chat_screen.message", $$1));
      }
   }
   ...
   public String a(String $$0) {
      return avl.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
