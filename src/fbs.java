...
public class fbs extends fbt {
   ...
   private fbs(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   public static fbs a(String $$0) {
      try {
         ...
         String $$3 = fdq.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = fdq.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = fdq.a("worldClosed", $$2, false);
               String $$7 = fdq.b("token", $$2, null);
               return new fbs($$6, $$7, $$5);
            }
         }
