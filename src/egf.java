...
public class egf extends efz<eie> {
   private static final jn[] a = jn.values();

   public egf(Codec<eie> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egb<eie> $$0) {
      eie $$1 = $$0.f();
      azh $$2 = $$0.d();
      ji $$3 = $$0.e();
      dhh $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      eds $$9 = new eds(new ecu($$4.E()));
      esd $$10 = esd.a($$9, -4, 1.0);
      ...
      for (ji $$44 : $$31) {
         ...
         for (jn $$46 : a) {
            ...
            dwy $$48 = $$4.a_($$47);
            if ($$45.b(dxo.J)) {
               $$45 = $$45.b(dxo.J, Boolean.valueOf($$48.y().b()));
            }
