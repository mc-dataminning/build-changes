...
public class egf extends egg {
   ...
   public static final MapCodec<egf> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ege.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, egf::new)
   );
   private final ege h;

   public egf(bpw $$0, egj $$1, Optional<egd> $$2, ege $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, jd $$3, jd $$4, efe $$5) {
