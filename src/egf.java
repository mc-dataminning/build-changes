...
public class egf implements egm.c {
   ...
   private final ObjectListIterator<egf.a> h;
   private final ObjectListIterator<esq> i;

   public static egf a(dki $$0, dir $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<egf.a> $$4 = new ObjectArrayList(10);
      ObjectList<esq> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != ery.a).forEach($$5x -> {
         ery $$6 = $$5x.h().d();
         ...
         for (err $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof erj) {
                  ...
                  $$4.add(new egf.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new egf($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public egf(ObjectListIterator<egf.a> $$0, ObjectListIterator<esq> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(erf a, ery b, int c) {
   }
}
