...
public class egf {
   ...
   @Nullable
   private String g;
   private static final egf.a h = new egf.a() {
      @Nullable
      @Override
      public ege a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (egi.a(this.d, "Get capabilities")) {
         ...
         this.e = ALC10.alcCreateContext(this.d, (IntBuffer)null);
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !egi.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   static class b implements egf.a {
      private final int a;
      ...
      public ege a() {
         if (this.b.size() >= this.a) {
            if (aa.aS) {
               egf.a.warn("Maximum sound pool size {} reached", this.a);
            }
