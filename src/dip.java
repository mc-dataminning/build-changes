...
public class dip extends daa {
   public static final MapCodec<dip> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ki.e.q().fieldOf("hook").forGetter($$0x -> $$0x.m), u()).apply($$0, dip::new)
   );
   public static final dnq b = dnp.w;
   public static final dnq c = dnp.a;
   public static final dnq d = dnp.d;
   public static final dnq e = dfn.b;
   public static final dnq f = dfn.c;
   public static final dnq g = dfn.d;
   public static final dnq h = dfn.e;
   private static final Map<ih, dnq> k = dbw.f;
   protected static final eqk i = daa.a(0.0, 1.0, 0.0, 16.0, 2.5, 16.0);
   protected static final eqk j = daa.a(0.0, 0.0, 0.0, 16.0, 8.0, 16.0);
   ...
   private void a(cwz $$0, ib $$1) {
      ...
      boolean $$3 = $$2.c(b);
      boolean $$4 = false;
      List<? extends bow> $$5 = $$0.a_(null, $$2.j($$0, $$1).a().a($$1));
      if (!$$5.isEmpty()) {
         for (bow $$6 : $$5) {
            if (!$$6.q_()) {
               $$4 = true;
   ...
   public boolean a(dmz $$0, ih $$1) {
      return $$0.a(this.m) ? $$0.c(diq.b) == $$1.g() : $$0.a(this);
   }
