...
public class djz extends dhr {
   public static final MapCodec<djz> b = RecordCodecBuilder.mapCodec($$0 -> $$0.group(djy.a.forGetter($$0x -> $$0x.c), t()).apply($$0, djz::new));
   private final dij c;
