...
public class fju extends hmd {
   ...
   public fju(fvi $$0, fix $$1, String $$2, BooleanConsumer $$3) {
      super(flx.a);
      this.aa = $$3;
      this.F = $$0;
      this.K = $$2;
   ...
   @Override
   public void aR_() {
      this.J = this.c(fpq.a(wo.e, $$0 -> this.aO_()).a((this.n - 200) / 2, this.o - 42, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      if (!this.R && !this.Z) {
         ...
         if (this.a(this.G.a) >= 5368709120L) {
            wp $$0 = wp.a("mco.download.confirmation.oversized", fhd.b(5368709120L));
   ...
   private wp F() {
      ...
      if (this.O != null) {
         ...
         $$0.add(wp.a("mco.download.speed.narration", fhd.b(this.V)));
      }
   ...
   private void a(fpc $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.b(this.p, wp.a("mco.download.speed", fhd.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1);
      }
   }
