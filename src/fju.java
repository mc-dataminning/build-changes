...
public class fju extends hhv {
   ...
   public fju(ftx $$0, fix $$1, String $$2, BooleanConsumer $$3) {
      super(flw.a);
      this.aa = $$3;
      this.F = $$0;
      this.K = $$2;
   ...
   @Override
   public void aT_() {
      this.J = this.c(foe.a(xu.e, $$0 -> this.aP_()).a((this.n - 200) / 2, this.o - 42, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      if (!this.R && !this.Z) {
         ...
         if (this.a(this.G.a) >= 5368709120L) {
            xv $$0 = xv.a("mco.download.confirmation.oversized", fhd.b(5368709120L));
            this.m.a(fkd.c(this, $$0, $$0x -> {
               this.m.a(this);
               this.G();
            }));
         } else {
   ...
   private xv F() {
      ...
      if (this.O != null) {
         ...
         $$0.add(xv.a("mco.download.speed.narration", fhd.b(this.V)));
      }
   ...
   private void a(fnr $$0, long $$1) {
      if ($$1 > 0L) {
         int $$2 = this.p.b(this.O);
         $$0.a(this.p, xv.a("mco.download.speed", fhd.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
