...
public interface fju {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new fju.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new fju.d($$0, $$1);
      }
   }

   public static record a(String d) implements fju {
   ...
   public static record b(int e, @Nullable wy f) implements fju {
      public static final fju.b c = new fju.b(429, wy.c("mco.errorMessage.serviceBusy"));
      public static final wy d = wy.c("mco.errorMessage.retry");

      public static fju.b a(String $$0) {
         return new fju.b(500, wy.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fju.b a(fln $$0) {
         return new fju.b(500, wy.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static fju.b a(int $$0) {
         return new fju.b($$0, d);
      }

      public static fju.b b(int $$0) {
         return new fju.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements fju {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements fju {
      @Override
      public int a() {
         return this.c;
      }
