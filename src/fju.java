public abstract class fju extends fjy {
   private static final fln a = new fln(alb.b("widget/text_field"), alb.b("widget/text_field_highlighted"));
   private static final alb b = alb.b("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fju(int $$0, int $$1, int $$2, int $$3, xd $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return azc.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = azc.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fjn var1, int var2, int var3, float var4);
}
