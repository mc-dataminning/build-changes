...
public class eor {
   ...
   private final Map<String, eod> b = Maps.newHashMap();
   private final DataFixer c;
   private final iz.a d;
   private final File e;

   public eor(File $$0, DataFixer $$1, iz.a $$2) {
      this.c = $$1;
      this.e = $$0;
      this.d = $$2;
   }
   ...
   public <T extends eod> T a(eod.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends eod> T b(eod.a<T> $$0, String $$1) {
      eod $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends eod> T a(BiFunction<ud, iz.a, T> $$0, azl $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
   ...
   public void a(String $$0, eod $$1) {
      this.b.put($$0, $$1);
   }

   public ud a(String $$0, azl $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);

      ud var9;
      try (
         InputStream $$4 = new FileInputStream($$3);
         PushbackInputStream $$5 = new PushbackInputStream(new axo($$4), 2);
      ) {
         ud $$6;
         if (this.a($$5)) {
            $$6 = uq.a($$5, um.a());
