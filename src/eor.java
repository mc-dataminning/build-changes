...
public class eor extends ger {
   ...
   public eor(long $$0, int $$1, eok $$2, ebx $$3, Runnable $$4) {
      super(eqd.a);
      this.F = $$0;
      this.G = $$1;
      this.D = $$2;
   ...
   @Override
   public void aC_() {
      this.Q = this.d(esg.a(te.k, $$0 -> this.C()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.Q.j = false;
      this.R = this.d(esg.a(te.e, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.P) {
         if (this.D.a == -1) {
            this.F();
         } else {
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.M) {
                              ...
                              elt $$11 = new elt($$0, this.F, this.G, $$3, this.f.V(), aa.b().c(), this.H);
                              $$11.a($$1x -> {
                              ...
                              long $$7 = $$0.length();
                              elr $$8 = elr.a($$7);
                              elr $$9 = elr.a(5368709120L);
                              if (elr.b($$7, $$8).equals(elr.b(5368709120L, $$9)) && $$8 != elr.a) {
                                 elr $$10 = elr.values()[$$8.ordinal() - 1];
                                 this.a(
                                    tf.a("mco.upload.size.failure.line1", this.E.b()),
                                    tf.a("mco.upload.size.failure.line2", elr.b($$7, $$10), elr.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    tf.a("mco.upload.size.failure.line1", this.E.b()),
                                    tf.a("mco.upload.size.failure.line2", elr.b($$7, $$8), elr.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
