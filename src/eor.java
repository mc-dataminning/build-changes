...
public class eor {
   ...
   private static final Queue<eor.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eor.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eor::a), eop::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eor::a), eop::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eor.a(this.b) + ", type=" + eor.b(this.c) + ", severity=" + eor.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
