...
public class eor {
   ...
   public Optional<l.a> a(iz $$0, boolean $$1, dtr $$2) {
      cer $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<ces> $$5 = $$3.b($$0x -> $$0x.a(cev.r), $$0, $$4, cer.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<ces>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dsq.H))
         .findFirst();
      return $$5.map($$0x -> {
         iz $$1x = $$0x.f();
         this.n.l().a(arj.f, new dbd($$1x), 3, $$1x);
         dsa $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dsq.H), 21, je.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(iz $$0, je.a $$1) {
      ...
      for (iz.a $$10 : iz.a($$0, 16, je.f, je.d)) {
         int $$11 = Math.min($$8, this.n.a(dxs.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new iz($$0.u(), ayx.a($$0.v(), $$17, $$18), $$0.w()).i();
         je $$19 = $$2.h();
         if (!$$7.a($$4)) {
            return Optional.empty();
         }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, dez.co.o(), 3);
            }
         }
      }

      dsa $$26 = dez.ed.o().a(dkb.b, $$1);
