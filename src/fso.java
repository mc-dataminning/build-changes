...
public class fso {
   public final fso.d a;
   public final eyn b;
   public final fso.a c;
   public final fso.b d;
   public final fso.c e;

   public fso(fso.d $$0, eyn $$1, fso.a $$2, fso.b $$3, fso.c $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static class a {
      ...
      public Path a() {
         return this.d == null ? this.c.toPath() : gps.a(this.c.toPath(), this.d);
      }
   }
   ...
   public static record c(@Nullable String a, @Nullable String b, @Nullable String c, @Nullable String d) {
      public boolean a() {
         return !azt.h(this.b) || !azt.h(this.c) || !azt.h(this.d);
      }
   ...
   public static class d {
      ...
      public d(ffr $$0, PropertyMap $$1, PropertyMap $$2, Proxy $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
