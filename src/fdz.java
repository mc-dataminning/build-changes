...
public class fdz {
   ...
   private static final wi h = wi.c("chat.deleted_marker").a(n.h, n.u);
   private final fby i;
   private final awa<String> j = new awa<>(100);
   private final List<fbs> k = Lists.newArrayList();
   private final List<fbs.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fdz.a> o = new ArrayList<>();
   ...
   public void a(fdl $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.k()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = axm.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = axm.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, wi.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(fdl $$0, int $$1, int $$2, fbt.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fbs.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean k() {
      return this.i.m.m().c() == cjy.c;
   }
   ...
   public void a(wi $$0) {
      this.a($$0, null, this.i.W() ? fbt.b() : fbt.a());
   }

   public void a(wi $$0, @Nullable wu $$1, @Nullable fbt $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(wi $$0, @Nullable fbt $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, fbt::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(wi $$0, @Nullable wu $$1, int $$2, @Nullable fbt $$3, boolean $$4) {
      int $$5 = axm.a((double)this.f() / this.h());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<awy> $$6 = fed.a($$0, $$5, this.i.h);
      boolean $$7 = this.e();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new fbs.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private fdz.a b(wu $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fbs> $$2 = this.k.listIterator();
   ...
   private fbs a(fbs $$0) {
      return new fbs($$0.a(), h, null, fbt.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)axm.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)axm.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public xf b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         fbs.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), axm.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fbt c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fbs.a $$1, fbt $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fbt.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         if (!($$0 < -4.0) && !($$0 > (double)axm.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = axm.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof fin;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return axm.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return axm.a($$0 * 160.0 + 20.0);
   }
