...
public record fdz(int i, int j, fdz.a k, fdz.b l, int m) {
   public static final int a = 32;
   private static final fdz[] n = new fdz[32];
   private static final List<fdz> o = new ArrayList<>(32);
   public static final fdz b = a(0, 0, fdz.a.a, fdz.b.a, 3);
   public static final fdz c = a(1, 0, fdz.a.b, fdz.b.c, 4);
   public static final fdz d = a(2, 0, fdz.a.a, fdz.b.d, 2);
   public static final fdz e = d;
   public static final fdz f = a(3, 1, fdz.a.e, fdz.b.d, 2);
   public static final fdz g = a(4, 2, fdz.a.e, fdz.b.d, 2);
   public static final fdz h = a(5, 0, fdz.a.c, fdz.b.b, 3);

   public fdz(int i, int j, fdz.a k, fdz.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fdz a(int $$0, int $$1, fdz.a $$2, fdz.b $$3, int $$4) {
      fdz $$5 = new fdz($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fdz.b $$1) {
      return $$0 == 0 || $$1 == fdz.b.d;
   }
   ...
   @Nullable
   public static fdz a(int $$0) {
      return n[$$0];
   }

   public static Stream<fdz> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fdz.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
