...
public class eau {
   ...
   private final Map<Character, Predicate<eas>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public eau a(char $$0, Predicate<eas> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public eat b() {
      return new eat(this.c());
   }

   private Predicate<eas>[][][] c() {
      this.d();
      Predicate<eas>[][][] $$0 = (Predicate<eas>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<eas>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
