...
public class eau extends eaz<edb> {
   public eau(Codec<edb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebb<edb> $$0) {
      dcu $$1 = $$0.b();
      iz $$2 = $$0.e();
      edb $$3 = $$0.f();
      azh $$4 = $$0.d();
   ...
   private void a(dcu $$0, azh $$1, iz $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, edb $$9) {
      Optional<dxl> $$10 = dxl.a($$0, $$2, $$9.b, eav::c, eav::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dcc)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dcc)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               eav.a($$0, $$2.h($$11.getAsInt() - 1), je.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               eav.a($$0, $$2.h($$17.getAsInt() + 1), je.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dcc $$0, iz $$1) {
      return $$0.a_($$1).a(dfc.H);
   }

   private int a(azh $$0, int $$1, int $$2, float $$3, int $$4, edb $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dcu $$0, iz $$1) {
      dsd $$2 = $$0.a_($$1);
      if (!$$2.a(dfc.G) && !$$2.a(dfc.su) && !$$2.a(dfc.st)) {
         if ($$0.a_($$1.c()).u().a(awv.a)) {
            return false;
         } else {
            for (je $$3 : je.c.a) {
               if (!this.a((dca)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dca)$$0, $$1.d());
         }
      } else {
         return false;
      }
   ...
   private boolean a(dca $$0, iz $$1) {
      dsd $$2 = $$0.a_($$1);
      return $$2.a(awp.be) || $$2.u().a(awv.a);
   }

   private void a(dcu $$0, iz $$1, int $$2, je $$3) {
      iz.a $$4 = $$1.j();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, edb $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
