...
public class eau implements ear, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final brw c;
   private final eaz d;
   private final SequencedMap<dgg, eau.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected eau(ebb $$0, Path $$1, boolean $$2) {
      this.d = new eaz($$0, $$1, $$2);
      this.c = new brw(eau.b.values().length, ae.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dgg $$0, int $$1) {
      dgg $$2 = new dgg($$0.g - $$1, $$0.h - $$1);
      dgg $$3 = new dgg($$0.g + $$1, $$0.h + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         dgg $$3 = dgg.b($$0, $$1);
         BitSet $$4 = new BitSet();
         dgg.a($$2, $$3).forEach($$1xx -> {
            wb $$2x = new wb(new wd(vc.a, "DataVersion"), new wd(ux.b, "blending_data"));
            ...
            if ($$2x.d() instanceof ux $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(dgg $$0, Supplier<ux> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         ux $$2 = $$1.get();
         eau.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new eau.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<ux>> a(dgg $$0) {
      return this.a((eau.c<Optional<ux>>)(() -> {
         eau.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((eau.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dgg $$0, vr $$1) {
      return this.a((eau.c<Void>)(() -> {
         try {
            eau.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(eau.c<T> $$0) {
      return this.c.a(eau.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dgg, eau.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bry.c(eau.b.b.ordinal(), this::b));
   }

   private void a(dgg $$0, eau.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(eau.b.c.ordinal(), $$0 -> $$0.complete(bbk.a)).join();
   }
