...
public class azr extends bee {
   public azr(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bff.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bff.s, "minecraft:jukebox");
