...
public class azr {
   ...
   private static final Optional<Object> b = Optional.of(baa.a);

   private static boolean a(yl $$0, ayk $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, yl $$1, ayk $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, yl $$1, ayk $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, yl $$1, ayk $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, yl $$2, ayk $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, yl $$2, yl $$3, ayk $$4) {
      int $$5 = $$0.length();
      yl $$6 = $$2;
   ...
   public static boolean a(xt $$0, yl $$1, ayk $$2) {
