...
public class qt extends qv<qu> {
   ...
   public static final rs<qt> a = new rs.b<qt>() {
      public qt a(DataInput $$0, rf $$1) throws IOException {
         return new qt(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof qt && Arrays.equals(this.c, ((qt)$$0).c);
   }
   ...
   public qu a(int $$0) {
      return qu.a(this.c[$$0]);
   }

   public qu a(int $$0, qu $$1) {
      byte $$2 = this.c[$$0];
      this.c[$$0] = $$1.i();
      return qu.a($$2);
   }

   public void b(int $$0, qu $$1) {
