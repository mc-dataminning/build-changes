...
public class kd implements jj {
   private static final Logger d = LogUtils.getLogger();
   private final jl.a e;
   private final Set<aep> f;
   private final List<kd.a> g;

   public kd(jl $$0, Set<aep> $$1, List<kd.a> $$2) {
      this.e = $$0.a(jl.b.a, "loot_tables");
      this.g = $$2;
      this.f = $$1;
   }
   ...
   public CompletableFuture<?> a(jh $$0) {
      final Map<aep, ecp> $$1 = Maps.newHashMap();
      Map<dkw.a, aep> $$2 = new Object2ObjectOpenHashMap();
      this.g.forEach($$2x -> $$2x.a().get().generate(($$3x, $$4) -> {
            aep $$5x = $$2.put(bgt.a($$3x), $$3x);
            if ($$5x != null) {
      ...
      for (aep $$5 : Sets.difference(this.f, $$1.keySet())) {
      ...
      if (!$$6.isEmpty()) {
         ...
         return CompletableFuture.allOf($$1.entrySet().stream().map($$1x -> {
            aep $$2x = (aep)$$1x.getKey();
            ecp $$3x = (ecp)$$1x.getValue();
            Path $$4 = this.e.a($$2x);
            return jj.a($$0, ecm.c.a().toJsonTree($$3x), $$4);
   ...
   public static record a(Supplier<ke> a, eer b) {
   }
}
