...
public class kd {
   ...
   static <T> jp.b<T> a(final alb<? extends ka<? extends T>> $$0, final Lifecycle $$1, jq<T> $$2, final Map<alb<T>, jn.c<T>> $$3) {
      return new kd.e<T>($$2) {
         @Override
   ...
   public <T> kd a(alb<? extends ka<T>> $$0, Lifecycle $$1, kd.i<T> $$2) {
      this.a.add(new kd.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> kd a(alb<? extends ka<T>> $$0, kd.i<T> $$1) {
   ...
   private static jp.a a(kd.m $$0, kb $$1, Stream<jp.b<?>> $$2) {
      record a<T>(jp.b<T> a, ala.b<T> b) {
         public static <T> a<T> a(jp.b<T> $$0) {
            return new a<>(new kd.d<>($$0, $$0), ala.b.a($$0));
         }

         public static <T> a<T> a(kd.m $$0, jp.b<T> $$1) {
            return new a<>(new kd.d<>($$0.a(), $$1), new ala.b<>($$0.a(), $$1, $$1.g()));
         }
      }

      final Map<alb<? extends ka<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new jp.a() {
         ...
         <T> Optional<a<T>> c(alb<? extends ka<? extends T>> $$0) {
         ...
         @Override
         public <V> ala<V> a(DynamicOps<V> $$0) {
            return ala.a($$0, new ala.c() {
               @Override
   ...
   private jp.a a(kb $$0, jp.a $$1, jf.a $$2, Map<alb<? extends ka<?>>, kd.j<?>> $$3, jp.a $$4) {
      kd.m $$5 = new kd.m();
   ...
   private <T> jp.b<T> a(jq<T> $$0, jf.a $$1, alb<? extends ka<? extends T>> $$2, jp.a $$3, jp.a $$4, MutableObject<jp.a> $$5) {
      jf<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<alb<T>, jn.c<T>> $$7 = new HashMap<>();
         jp.b<T> $$8 = $$3.b($$2);
         $$8.b().forEach($$5x -> {
            alb<T> $$6x = $$5x.h();
   ...
   public kd.g a(kb $$0, jp.a $$1, jf.a $$2) {
      kd.b $$3 = this.b($$0);
      Map<alb<? extends ka<?>>, kd.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<alb<? extends ka<?>>> $$5 = $$0.a().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(kd.m a, kd.l b, Map<alc, jo<?>> c, Map<alb<?>, kd.h<?>> d, List<RuntimeException> e) {

      public static kd.b a(kb $$0, Stream<alb<? extends ka<?>>> $$1) {
         kd.m $$2 = new kd.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         kd.l $$4 = new kd.l($$2);
         Builder<alc, jo<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> qt<T> a() {
         return new qt<T>() {
            @Override
            public jn.c<T> a(alb<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jo<S> a(alb<? extends ka<? extends S>> $$0) {
      ...
      public void c() {
         for (alb<Object> $$0 : this.b.a.keySet()) {
   ...
   static class f<T> extends jn.c<T> {
      ...
      protected f(jq<T> $$0, @Nullable alb<T> $$1) {
   ...
   static record j<T>(alb<? extends ka<? extends T>> a, Lifecycle b, Map<alb<T>, kd.n<T>> c) {

      public jp.b<T> a(kd.m $$0) {
         Map<alb<T>, jn.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            kd.n<T> $$2 = (kd.n<T>)$$1x.getValue();
            jn.c<T> $$3 = $$2.b().orElseGet(() -> jn.c.a($$0.a(), (alb<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(alb<? extends ka<T>> a, Lifecycle b, kd.i<T> c) {
      void b(kd.b $$0) {
         this.c.run($$0.a());
      }

      public kd.j<T> a(kd.b $$0) {
         Map<alb<T>, kd.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<alb<?>, kd.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<alb<?>, kd.h<?>> $$3 = $$2.next();
            alb<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               kd.h<T> $$6 = (kd.h<T>)$$3.getValue();
               jn.c<T> $$7 = (jn.c<T>)$$0.b.a.remove($$4);
               $$1.put((alb<T>)$$4, new kd.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends kd.c<Object> {
      final Map<alb<Object>, jn.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<jn.c<Object>> a(alb<Object> $$0) {
