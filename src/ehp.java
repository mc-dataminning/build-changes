...
public class ehp extends egu<ejg> {
   ...
   protected boolean a(
      dhy $$0, azh $$1, ejg $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dxq $$0, Function<ji, dxq> $$1, azh $$2, ejg $$3, ejg.a $$4, ji.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
