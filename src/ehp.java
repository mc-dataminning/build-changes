...
public class ehp implements dsh.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ehp> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final awq<ehp> a = awq.a(f);
   private final eht g;
   private final eht h;
   private final eht i;
   ...
   public static ehp a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ehp(new dtp(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ehp(eht $$0, eht $$1, eht $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ehp(axd $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eht.a($$0, IntStream.rangeClosed(-15, 0)),
         eht.a($$0, IntStream.rangeClosed(-15, 0)),
         eht.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ehp a(axd $$0) {
      return new ehp($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dsh.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ehq $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eht.b($$4 * $$13), eht.b($$5 * $$13), eht.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eht.b($$1 * $$13);
         double $$21 = eht.b($$2 * $$13);
         double $$22 = eht.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ehq $$24 = this.g.a($$19);
            if ($$24 != null) {
