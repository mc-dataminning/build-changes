...
public class cqg extends cqs<cxw, cxx> {
   ...
   private static final Map<bsk, akk> E = Map.of(bsk.c, B, bsk.d, A, bsk.e, z, bsk.f, y);
   private static final bsk[] F = new bsk[]{bsk.f, bsk.e, bsk.d, bsk.c};
   private final cpv G = new crh(this, 2, 2);
   private final cqv H = new cqv();
   public final boolean D;
   private final cmh I;

   public cqg(cmg $$0, boolean $$1, final cmh $$2) {
      super(null, 0);
      this.D = $$1;
      this.I = $$2;
      this.a(new cqw($$0.l, this.G, this.H, 0, 154, 28));

      for (int $$3 = 0; $$3 < 2; $$3++) {
         for (int $$4 = 0; $$4 < 2; $$4++) {
            this.a(new cra(this.G, $$4 + $$3 * 2, 98 + $$4 * 18, 18 + $$3 * 18));
         }
      }
      ...
      for (int $$5 = 0; $$5 < 4; $$5++) {
         bsk $$6 = F[$$5];
         akk $$7 = E.get($$6);
         this.a(new cph($$0, $$2, $$6, 39 - $$5, 8, 8 + $$5 * 18, $$7));
      }

      for (int $$8 = 0; $$8 < 3; $$8++) {
         for (int $$9 = 0; $$9 < 9; $$9++) {
            this.a(new cra($$0, $$9 + ($$8 + 1) * 9, 8 + $$9 * 18, 84 + $$8 * 18));
         }
      }

      for (int $$10 = 0; $$10 < 9; $$10++) {
         this.a(new cra($$0, $$10, 8 + $$10 * 18, 142));
      }

      this.a(new cra($$0, 40, 77, 62) {
         @Override
   ...
   public boolean a(cyi<cxx> $$0) {
      return $$0.b().a(this.G.aA_(), this.I.dP());
   }

   @Override
   public void a(bpw $$0) {
      cpw.a(this, this.I.dP(), this.I, this.G, this.H, null);
   }
   ...
   public cua b(cmh $$0, int $$1) {
      ...
      if ($$3.h()) {
         ...
         } else if ($$5.a() == bsk.a.b && !this.i.get(8 - $$5.b()).h()) {
            int $$6 = 8 - $$5.b();
            if (!this.a($$4, $$6, $$6 + 1, false)) {
               return cua.l;
            }
         } else if ($$5 == bsk.b && !this.i.get(45).h()) {
