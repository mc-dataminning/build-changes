...
public final class cqg {
   ...
   public static void a(akq $$0, dhq $$1, cqg.d $$2, boolean $$3, boolean $$4, boolean $$5) {
      ...
      // 73: invokestatic cqg.a (Lbjj;Lakq;Ldhq;Lcqg$c;Lcqg$a;)V
      // 76: iinc 8 1
      // 79: goto 18
      // 7c: aload 0
      // 7d: invokevirtual akq.ad ()Lbdp;
      // 80: invokeinterface bdp.c ()V 1
      // 85: return
   }

   public static void a(bjj $$0, akq $$1, dhq $$2, cqg.c $$3, cqg.a $$4) {
      gw $$5 = a($$1, $$2);
      if ($$5.v() >= $$1.H_() + 1) {
         a($$0, $$1, $$2, $$5, $$3, $$4);
      }
   ...
   @asy
   public static void a(bjj $$0, akq $$1, gw $$2) {
      a($$0, $$1, $$1.x($$2), $$2, ($$0x, $$1x, $$2x) -> true, ($$0x, $$1x) -> {
      });
   }

   public static void a(bjj $$0, akq $$1, dhf $$2, gw $$3, cqg.c $$4, cqg.a $$5) {
      cqn $$6 = $$1.a();
      dhg $$7 = $$1.k().g();
      int $$8 = $$3.v();
      dfj $$9 = $$2.a_($$3);
   ...
   private static boolean a(akq $$0, dhf $$1, gw.a $$2, double $$3) {
      if ($$3 <= 576.0) {
         return false;
      } else {
   ...
   private static boolean a(akq $$0, bjj $$1, cqn $$2, dhg $$3, crf.c $$4, gw.a $$5, double $$6) {
      biu<?> $$7 = $$4.b;
      if ($$7.f() == bjj.h) {
         return false;
   ...
   @Nullable
   private static bji a(akq $$0, biu<?> $$1) {
      try {
         biq var3 = $$1.a((cpv)$$0);
   ...
   private static boolean a(akq $$0, bji $$1, double $$2) {
      return $$2 > (double)($$1.ag().f().f() * $$1.ag().f().f()) && $$1.h($$2) ? false : $$1.a($$0, bjk.a) && $$1.a($$0);
   }

   private static Optional<crf.c> a(akq $$0, cqn $$1, dhg $$2, bjj $$3, asc $$4, gw $$5) {
      he<cqt> $$6 = $$0.s($$5);
      return $$3 == bjj.g && $$6.a(apr.al) && $$4.i() < 0.98F ? Optional.empty() : a($$0, $$1, $$2, $$3, $$5, $$6).b($$4);
   }

   private static boolean a(akq $$0, cqn $$1, dhg $$2, bjj $$3, crf.c $$4, gw $$5) {
      return a($$0, $$1, $$2, $$3, $$5, null).e().contains($$4);
   }

   private static bfm<crf.c> a(akq $$0, cqn $$1, dhg $$2, bjj $$3, gw $$4, @Nullable he<cqt> $$5) {
      return a($$4, $$0, $$3, $$1) ? dxh.d : $$2.a($$5 != null ? $$5 : $$0.s($$4), $$1, $$3, $$4);
   }

   public static boolean a(gw $$0, akq $$1, bjj $$2, cqn $$3) {
      if ($$2 == bjj.a && $$1.a_($$0.d()).a(csw.fn)) {
         dvi $$4 = $$3.b().d(jc.az).a(dvc.o);
   ...
   public static void a(cqk $$0, he<cqt> $$1, cpc $$2, asc $$3) {
      crf $$4 = $$1.a().b();
               ...
               for (int $$16 = 0; $$16 < $$10; $$16++) {
                  ...
                  for (int $$18 = 0; !$$17 && $$18 < 4; $$18++) {
                     ...
                     if ($$9.b.c() && a(bka.a($$9.b), $$0, $$19, $$9.b)) {
                        float $$20 = $$9.b.k();
                        double $$21 = arw.a((double)$$12, (double)$$6 + (double)$$20, (double)$$6 + 16.0 - (double)$$20);
                        double $$22 = arw.a((double)$$13, (double)$$7 + (double)$$20, (double)$$7 + 16.0 - (double)$$20);
