...
public class dis extends dio {
   public static final MapCodec<dis> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(dik.d.fieldOf("biomes").forGetter($$0x -> $$0x.c), Codec.intRange(0, 62).fieldOf("scale").orElse(2).forGetter($$0x -> $$0x.e))
            .apply($$0, dis::new)
   );
   private final ju<dik> c;
   private final int d;
   private final int e;

   public dis(ju<dik> $$0, int $$1) {
      this.c = $$0;
      this.d = $$1 + 2;
      this.e = $$1;
   }
