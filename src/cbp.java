...
public class cbp {
   ...
   public boolean a(clz<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(clz<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cbp.a($$0).a($$2, $$1);
   }

   public int b(clz<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(clz<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cbp.a($$0).b($$1, $$2);
   }

   public static ciw a(int $$0) {
      return $$0 == 0 ? ciw.b : new ciw(cir.b($$0));
   }
   ...
   class a {
      private final clz<?> b;
      private final List<clw> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cbp.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
