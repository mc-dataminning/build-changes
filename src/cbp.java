...
public record cbp(cbp.a d) {
   ...
   public static final Codec<cbp> c = cbp.a.a.xmap(cbp::new, cbp::b);

   public static cbp a(arz $$0, UUID $$1, cbp.a $$2) throws cbp.b {
      if (!$$2.a($$0, $$1)) {
         throw new cbp.b(e);
      } else {
         return new cbp($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cbp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  aqy.m.fieldOf("expires_at").forGetter(cbp.a::b), aqp.f.fieldOf("key").forGetter(cbp.a::c), aqy.n.fieldOf("signature_v2").forGetter(cbp.a::d)
               )
               .apply($$0, cbp.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cbp.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
