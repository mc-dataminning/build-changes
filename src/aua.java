...
public class aua extends ayf {
   public aua(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", azd.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(azd.s, "minecraft:jukebox");
