...
class aua extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atz && $$1 instanceof atz && $$0.equals($$1);
   }
   ...
   private static atz a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atz) {
         return (atz)$$0;
      } else {
