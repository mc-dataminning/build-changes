...
public enum ffy implements bak {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bak.a<ffy> t = bak.a(ffy::values);
   public static final IntFunction<ffy> u = ayc.a(ffy::a, values(), ayc.a.a);
   private final int v;
