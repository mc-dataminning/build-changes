...
public class ffy {
   public static void a(fuk<?> $$0, ffw $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<ffv>> $$6 : $$1.c().entrySet()) {
         Optional<fxb> $$7 = $$0.a($$6.getKey());
         List<ffv> $$8 = $$6.getValue();
   ...
   private static float a(ffw $$0, long $$1) {
