public class ffy extends ffh<bvc> {
   ...
   public void a(bvc $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
   ...
   public void a(elk $$0, elo $$1, int $$2, int $$3, float $$4, float $$5, float $$6, float $$7, int $$8) {
      this.a(ffy.a.e);
   ...
   private void a(ffy.a $$0, int $$1, float $$2, float $$3, float $$4, float $$5, float $$6) {
      ...
      switch ($$0) {
         case c:
            break;
         case d:
            float $$7 = ars.b((float)$$1);
            float $$8 = ars.a((float)$$1);
            this.j.b = $$7;
            this.j.c = 15.69F + $$8;
            this.j.e = 0.0F;
            this.j.f = 0.0F;
            this.j.g = ars.a((float)$$1) * 0.4F;
            this.f.b = $$7;
            this.f.c = 16.5F + $$8;
            this.h.g = -0.0873F - $$4;
            this.h.b = 1.5F + $$7;
            ...
            break;
         case b:
            this.l.e = this.l.e + ars.b($$2 * 0.6662F) * 1.4F * $$3;
            this.m.e = this.m.e + ars.b($$2 * 0.6662F + (float) Math.PI) * 1.4F * $$3;
         case a:
         case e:
         default:
            float $$9 = $$4 * 0.3F;
            this.j.c = 15.69F + $$9;
            this.g.e = 1.015F + ars.b($$2 * 0.6662F) * 0.3F * $$3;
            this.g.c = 21.07F + $$9;
            this.f.c = 16.5F + $$9;
            this.h.g = -0.0873F - $$4;
            this.h.c = 16.94F + $$9;
   ...
   private static ffy.a a(bvc $$0) {
      if ($$0.gh()) {
         return ffy.a.d;
      } else if ($$0.t()) {
         return ffy.a.c;
      } else {
         return $$0.gn() ? ffy.a.a : ffy.a.b;
      }
   }
