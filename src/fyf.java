...
public class fyf implements fyi.a, AutoCloseable {
   ...
   ekh[] f;
   @Nullable
   private final fyf.a g;
   private final ano h;

   public fyf(aer $$0, fzy $$1, ekh $$2, ano $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      fzw $$4 = $$3.a(fzw.a).orElse(fzw.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ekh[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fya.a(this.f, $$0);
   ...
   @Nullable
   private fyf.a a(fzy $$0, int $$1, int $$2, fzw $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fyf.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fyf.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fyf.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fyf.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fyf.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fyf.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ekh[] $$4) {
   ...
   class a {
      ...
      a(List<fyf.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fyf.this.c;
         int $$4 = this.b($$2) * fyf.this.d;
         fyf.this.a($$0, $$1, $$3, $$4, fyf.this.f);
      }

      public fyh a() {
         return fyf.this.new d(this, this.d ? fyf.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ekh[] b = new ekh[fyf.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fyf.this.c >> $$0;
            int $$2 = fyf.this.d >> $$0;
            this.b[$$0] = new ekh($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fyf.d $$2) {
         fyf.a $$3 = $$2.d;
         List<fyf.b> $$4 = $$3.b;
         fyf.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fyf.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fyf.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fyf.this.f[$$2].a($$3 + ($$0.a($$1) * fyf.this.c >> $$2), $$4 + ($$0.b($$1) * fyf.this.d >> $$2));
      }
   ...
   class d implements fyh {
      int b;
      int c;
      final fyf.a d;
      @Nullable
      private final fyf.c e;

      d(fyf.a $$0, @Nullable fyf.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
