...
public class qb {
   ...
   public static Collection<py> a(Collection<pt> $$0, gw $$1, czj $$2, aks $$3, qe $$4, int $$5) {
      pu $$6 = new pu($$0, $$1, $$2, $$3, $$4, $$5);
      $$6.b();
      return $$6.a();
   }

   public static Collection<py> b(Collection<qp> $$0, gw $$1, czj $$2, aks $$3, qe $$4, int $$5) {
   ...
   public static Collection<pt> a(Collection<qp> $$0) {
      ...
      return $$1.entrySet().stream().flatMap($$0x -> {
         ...
         Consumer<aks> $$2 = qa.c($$1x);
         Consumer<aks> $$3 = qa.d($$1x);
   ...
   public static void a(aks $$0, gw $$1, qe $$2, int $$3) {
      $$2.a();
      gw $$4 = $$1.b(-$$3, 0, -$$3);
      gw $$5 = $$1.b($$3, 0, $$3);
      gw.b($$4, $$5).filter($$1x -> $$0.a_($$1x).a(csy.pa)).forEach($$1x -> {
         dek $$2x = (dek)$$0.c_($$1x);
         gw $$3x = $$2x.p();
         dvc $$4x = ql.b($$2x);
         ql.a($$4x, $$3x.v(), $$0);
