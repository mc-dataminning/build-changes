...
public class any {
   ...
   private static int b(ex $$0) {
      ...
      crf $$1 = bvi.aT.a($$0.e(), bvh.n);
      if ($$1 == null) {
         $$0.b(wp.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(bvj.f, cre.a($$0.u().e(mc.d)));
         $$1.a_($$0.d().d, $$0.d().e, $$0.d().f);
         $$1.a($$0.e(), $$0.e().d_(ji.a((kb)$$0.d())), bvh.n, null);
         $$0.e().a_($$1);
         return 1;
      }
   }
   ...
   private static int a(ex $$0, @Nullable wp $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         ...
         $$2.a(null, $$3.d, $$3.e, $$3.f, awa.vM, awb.g, 2.0F, 1.0F, $$2.A.g());
      }
