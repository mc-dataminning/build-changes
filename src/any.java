...
public class any implements anv {
   ...
   private final Map<anw, List<Path>> g;

   any(anq $$0, Set<String> $$1, List<Path> $$2, Map<anw, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(anw $$0, agi $$1, Consumer<Path> $$2) {
   ...
   public void a(anw $$0, String $$1, String $$2, anv.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<agi, aoz<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(anv.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      anx.a($$1, $$4, $$3, $$0);
   }
   ...
   public aoz<InputStream> a(anw $$0, agi $$1) {
      return (aoz<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && anx.a($$5)) {
               return aoz.create($$5);
            }
         }
   ...
   public <T> T a(aoh<T> $$0) {
      aoz<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public apk c() {
      return $$0 -> Optional.ofNullable(this.a(anw.a, $$0)).map($$0x -> new apf(this, $$0x));
   }
}
