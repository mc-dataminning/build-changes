...
class any implements Path {
   private static final BasicFileAttributes a = new anw() {
      @Override
   ...
   private static final BasicFileAttributes b = new anw() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<any> c = Comparator.comparing(any::n);
   ...
   public any(aoa $$0, String $$1, @Nullable any $$2, aob $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private any a(@Nullable any $$0, String $$1) {
      return new any(this.e, $$1, $$0, aob.b);
   }
   ...
   any a(String $$0) {
      if (a(this.i)) {
         return new any(this.e, $$0, this, this.i);
      } else if (this.i instanceof aob.a $$1) {
         any $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new any(this.e, $$0, this, aob.a);
      } else if (this.i instanceof aob.b) {
         return new any(this.e, $$0, this, aob.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aob $$0) {
      return $$0 == aob.a || $$0 == aob.b;
   }
   ...
   private any c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof any $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aob.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aob.a i() {
      return this.i instanceof aob.a $$0 ? $$0 : null;
   }
