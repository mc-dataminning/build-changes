...
public class any<K> implements hj<K> {
   ...
   private int d(@Nullable K $$0) {
      return (apa.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public any<K> c() {
      return new any<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
