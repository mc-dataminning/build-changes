...
public class fhe {
   ...
   private static final Comparator<exc> K = Comparator.comparing(exc::d).reversed().thenComparing(exc::c, String.CASE_INSENSITIVE_ORDER);
   ...
   public float a = 1.0F;
   private int ae;
   private cuc af = cuc.l;
   private final fia ag;
   private final fja ah;
   private final fjr ai;
   private final fit aj;
   private final fhr ak;
   private int al;
   @Nullable
   private wu am;
   @Nullable
   ...
   public fhe(fft $$0) {
      ...
      this.ai = new fjr($$0);
      this.Y = new fht($$0);
      this.aj = new fit($$0, this);
      this.ak = new fhr($$0);
      this.ah = new fja($$0);
      this.a();
      fhh $$1 = new fhh().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ak.a($$0x));
      fhh $$2 = new fhh().a(this::o).a(($$0x, $$1x) -> {
         if (this.ag.d()) {
            this.ag.a($$0x);
         }
   ...
   public void a(fhf $$0, float $$1) {
      RenderSystem.enableDepthTest();
      this.ax.a($$0, $$1);
      RenderSystem.disableDepthTest();
   }

   private void c(fhf $$0, float $$1) {
      if (fft.N()) {
         this.a($$0, this.X.an());
      }

      float $$2 = this.X.au();
      this.ay = ayg.i(0.5F * $$2, this.ay, 1.125F);
      if (this.X.m.aA().a()) {
         if (this.X.s.gx()) {
            this.p($$0, this.ay);
         } else {
            this.ay = 0.5F;
            cuc $$3 = this.X.s.fZ().e(3);
            if ($$3.a(dfj.ee.r())) {
               this.a($$0, H, 1.0F);
            }
         }
      ...
      if (this.X.s.cn() > 0) {
         this.a($$0, J, this.X.s.co());
      }

      float $$4 = ayg.i($$1, this.X.s.cK, this.X.s.cJ);
      if ($$4 > 0.0F && !this.X.s.b(brq.i)) {
         this.q($$0, $$4);
      }
   }

   private void d(fhf $$0, float $$1) {
      if (this.X.s.gd() > 0) {
         this.X.aI().a("sleep");
         ...
         $$0.a(gel.E(), 0, 0, $$0.a(), $$0.b(), $$4);
         this.X.aI().c();
      }
   }

   private void e(fhf $$0, float $$1) {
      fhd $$2 = this.f();
      if (this.aa != null && this.ab > 0) {
         ...
         if ($$4 > 8) {
            ...
            int $$5 = 16777215;
            if (this.ac) {
               $$5 = ayg.h($$3 / 50.0F, 0.7F, 0.6F) & 16777215;
            }
   ...
   private void g(fhf $$0, float $$1) {
      if (!this.Y.e()) {
         ezq $$2 = this.X.aO();
         int $$3 = ayg.a(this.X.n.e() * (double)$$2.o() / (double)$$2.m());
         int $$4 = ayg.a(this.X.n.f() * (double)$$2.p() / (double)$$2.n());
         this.Y.a($$0, this.Z, $$3, $$4, false);
      }
   }

   private void h(fhf $$0, float $$1) {
      exj $$2 = this.X.r.M();
      exb $$3 = null;
      exe $$4 = $$2.e(this.X.s.cC());
      if ($$4 != null) {
         exa $$5 = exa.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      exb $$6 = $$3 != null ? $$3 : $$2.a(exa.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fhf $$0, float $$1) {
      exj $$2 = this.X.r.M();
      exb $$3 = $$2.a(exa.a);
   ...
   private void a(fhf $$0, fhd $$1, int $$2, int $$3, int $$4) {
      int $$5 = this.X.m.b(0.0F);
      if ($$5 != 0) {
         int $$6 = -$$3 / 2;
         $$0.a($$6 - 2, $$2 - 2, $$6 + $$3 + 2, $$2 + 9 + 2, axq.b.a($$5, $$4));
      }
   }

   private void j(fhf $$0, float $$1) {
      ffx $$2 = this.X.m;
      if ($$2.aA().a()) {
         if (this.X.q.j() != dcc.d || this.a(this.X.v)) {
            ...
            if (this.ag.d() && !this.X.s.gp() && !$$2.V().c()) {
               ...
               if (this.X.m.D().c() == ffd.b) {
                  float $$6 = this.X.s.E(0.0F);
                  boolean $$7 = false;
                  if (this.X.u != null && this.X.u instanceof btb && $$6 >= 1.0F) {
                     $$7 = this.X.s.gs() > 5.0F;
                     $$7 &= this.X.u.bE();
                  }
   ...
   private boolean a(@Nullable ewd $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == ewd.a.c) {
         return ((ewc)$$0).a() instanceof bqk;
      } else if ($$0.c() == ewd.a.b) {
         ja $$1 = ((ewb)$$0).a();
         dcf $$2 = this.X.r;
   ...
   private void k(fhf $$0, float $$1) {
      Collection<bro> $$2 = this.X.s.eu();
      if (!$$2.isEmpty()) {
         if (this.X.y instanceof foq $$3 && $$3.K()) {
            return;
         }
         ...
         for (bro $$8 : Ordering.natural().reverse().sortedCopy($$2)) {
            jj<brm> $$9 = $$8.c();
            if ($$8.h()) {
               int $$10 = $$0.a();
               int $$11 = 1;
   ...
   private void a(btm $$0, fhf $$1, int $$2) {
      this.X.aI().a("jumpBar");
      float $$3 = this.X.s.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   private void o(fhf $$0, float $$1) {
      if (this.X.K()) {
         ...
         if (this.X.r.Z() >= 120500L) {
            ...
            $$2 = wu.a("demo.remainingTime", azd.a((int)(120500L - this.X.r.Z()), this.X.r.s().f()));
         }
   ...
   @Nullable
   private cmk n() {
      return this.X.an() instanceof cmk $$0 ? $$0 : null;
   }
   ...
   private void b(fhf $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$7 = $$0.a() / 2 + 91;
         int $$8 = $$0.b() - 39;
         float $$9 = Math.max((float)$$1.g(buj.s), (float)Math.max($$5, $$2));
         int $$10 = ayg.f($$1.fp());
   ...
   private static void a(fhf $$0, cmk $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eL();
      if ($$6 > 0) {
         RenderSystem.enableBlend();
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fhf $$0, cmk $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fhe.b $$11 = fhe.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fhe.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fhe.b.d ? $$11 : fhe.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fhf $$0, fhe.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      RenderSystem.enableBlend();
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
      RenderSystem.disableBlend();
   }

   private void a(fhf $$0, cmk $$1, int $$2, int $$3) {
      cpd $$4 = $$1.gj();
      int $$5 = $$4.a();
      RenderSystem.enableBlend();
   ...
   private void a(fhf $$0, akk $$1, float $$2) {
      RenderSystem.disableDepthTest();
   ...
   private void p(fhf $$0, float $$1) {
      ...
      RenderSystem.disableBlend();
      $$0.a(gel.E(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gel.E(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gel.E(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gel.E(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bsg $$0) {
      ja $$1 = ja.a($$0.dv(), $$0.dz(), $$0.dB());
      float $$2 = gec.a($$0.dQ().D_(), $$0.dQ().A($$1));
      float $$3 = ayg.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(fhf $$0, @Nullable bsg $$1) {
      dub $$2 = this.X.r.C_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(fhf $$0, int $$1, int $$2, float $$3, cmk $$4, cuc $$5, int $$6) {
      if (!$$5.e()) {
         float $$7 = (float)$$5.G() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
   ...
   private void q() {
      ...
      this.aw = this.av;
      this.av = ayg.i(0.2F, this.av, $$1 ? 1.0F : 0.0F);
   }
   ...
   public void b(fhf $$0, float $$1) {
      if (this.X.m.af().c() && (this.av > 0.0F || this.aw > 0.0F)) {
         int $$2 = ayg.d(255.0F * ayg.a(ayg.i(this.X.at(), this.aw, this.av), 0.0F, 1.0F));
         if ($$2 > 8) {
            fhd $$3 = this.f();
            int $$4 = $$3.a(M);
