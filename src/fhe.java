...
public class fhe {
   ...
   public void a(fix $$0, String $$1, fju.a $$2, ewc $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fhe.b $$13 = new fhe.b($$1.trim(), this.f, $$3, $$2);
                  fhe.a $$14 = new fhe.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fhe.c $$30 = new fhe.c(this.f, $$2, $$0);
                        fhe.a $$31 = new fhe.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fjb(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ewc $$2) throws IOException {
      ...
      File $$15 = new File(fmf.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ewc d;
      private final fju.a e;

      b(final String $$0, final File $$1, final ewc $$2, final fju.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fhe.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fhe.this.b && !fhe.this.d) {
            try {
               fhe.this.e = true;
               fhe.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fhe.a.error("Error extracting archive", var3);
               fhe.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fju.a c;
      private final fix d;

      c(final File $$0, final fju.a $$1, final fix $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fhe.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fhe.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fhe.this.g);
                  fhe.this.c = true;
               } else {
                  fhe.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fhe.this.d = true;
               }
            } catch (IOException var3) {
               fhe.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fhe.this.d = true;
            }
         }
      }
