...
public class fhe extends fhf {
   ...
   private final fex u = fex.d().a(10);
   private final vu v;
   private final fca w;
   private final fca x;
   private final ekk.c y;

   public fhe(ezg $$0, BooleanConsumer $$1, ekk.c $$2) {
      super(c);
      this.t = $$1;
      this.v = vu.a("recover_world.message", vu.b($$2.d()).a(n.h));
      this.w = new fca(this.v, $$0.h);
      this.y = $$2;
      Exception $$3 = this.a($$2, false);
      Exception $$4 = this.a($$2, true);
      vu $$5 = vu.i().b(this.a($$2, false, $$3)).f("\n").b(this.a($$2, true, $$4));
      this.x = new fca($$5, $$0.h);
      boolean $$6 = $$3 != null && $$4 == null;
      this.u.c().b();
      this.u.a(new fcn(this.e, $$0.h));
      this.u.a(this.w.b(true));
      this.u.a(this.x);
      fex $$7 = fex.e().a(5);
      $$7.a(fbg.a(k, ffw.b(this, "https://aka.ms/snapshotbugs?ref=game")).b(120, 20).a());
      $$7.a(fbg.a(l, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : fcr.a(m)).a()).j = $$6;
      this.u.a($$7);
      this.u.a(fbg.a(vt.k, $$0x -> this.d()).b(120, 20).a());
      this.u.a(this::c);
   }
   ...
   private void a(ezg $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new fgl(vu.c("recover_world.restoring")));
         flx.a(this.y);
         if (this.y.l()) {
            $$0.a(new ffx(this.t, n, o, vt.j, vt.k));
         } else {
            $$0.a(new ffr(() -> this.t.accept(false), n, p));
         }
      } else {
         a.error(
   ...
   private vu a(ekk.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         return vu.i();
      } else {
         wi $$3 = vu.i();
         Instant $$4 = $$0.a($$1);
         wi $$5 = $$4 != null ? vu.b(fmg.a.format($$4)) : vu.c("recover_world.state_entry.unknown");
   ...
   @Nullable
   private Exception a(ekk.c $$0, boolean $$1) {
      try {
         if (!$$1) {
            $$0.a($$0.f());
         } else {
