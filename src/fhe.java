...
public class fhe<T extends bvn> extends fef<T> {
   ...
   public static fht c() {
      ...
      fhw $$1 = $$0.a();
      float $$2 = 13.5F;
      fhw $$3 = $$1.a("head", fhs.c(), fhp.a(-1.0F, 13.5F, -7.0F));
      $$3.a(
         "real_head",
         fhs.c()
            .a(0, 0)
      ...
      $$1.a("body", fhs.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F), fhp.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$1.a("upper_body", fhs.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F), fhp.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fhs $$4 = fhs.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F);
      $$1.a("right_hind_leg", $$4, fhp.a(-2.5F, 16.0F, 7.0F));
      $$1.a("left_hind_leg", $$4, fhp.a(0.5F, 16.0F, 7.0F));
      $$1.a("right_front_leg", $$4, fhp.a(-2.5F, 16.0F, -4.0F));
      $$1.a("left_front_leg", $$4, fhp.a(0.5F, 16.0F, -4.0F));
      fhw $$5 = $$1.a("tail", fhs.c(), fhp.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$5.a("real_tail", fhs.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F), fhp.a);
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.S_()) {
         ...
         this.n.f = arp.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.t()) {
         ...
         this.j.e = arp.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = arp.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = arp.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = arp.b($$1 * 0.6662F) * 1.4F * $$2;
      }
