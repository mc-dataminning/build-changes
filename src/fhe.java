...
public abstract class fhe<T extends fhe<T>> {
   ...
   public fhe(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fhc.a();
         if ($$3 != null) {
         ...
         throw new fiw(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fiw(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fiw(var2.getMessage(), var2);
      }
   }
   ...
   public static fhe<?> a(String $$0) {
      return new fhe.b($$0, 5000, 60000);
   }

   public static fhe<?> a(String $$0, int $$1, int $$2) {
      return new fhe.b($$0, $$1, $$2);
   }

   public static fhe<?> b(String $$0, String $$1) {
      return new fhe.c($$0, $$1, 5000, 60000);
   }

   public static fhe<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fhe.c($$0, $$1, $$2, $$3);
   }

   public static fhe<?> b(String $$0) {
      return new fhe.a($$0, 5000, 60000);
   }

   public static fhe<?> c(String $$0, String $$1) {
      return new fhe.d($$0, $$1, 5000, 60000);
   }

   public static fhe<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fhe.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fhe<fhe.a> {
   ...
   public static class b extends fhe<fhe.b> {
   ...
   public static class c extends fhe<fhe.c> {
      ...
      public fhe.c f() {
         try {
            ...
            throw new fiw(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fhe<fhe.d> {
      private final String c;
