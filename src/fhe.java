...
public class fhe {
   ...
   private final List<fey> k = Lists.newArrayList();
   private final List<fey.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fhe.a> o = new ArrayList<>();
   ...
   public void a(fgq $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = ayy.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = ayy.d((float)($$9 - 40) / $$7);
   ...
   private void a(fgq $$0, int $$1, int $$2, fez.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fey.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.m.m().c() == cmu.c;
   }
   ...
   public void a(xo $$0) {
      this.a($$0, null, this.i.W() ? fez.b() : fez.a());
   }

   public void a(xo $$0, @Nullable ya $$1, @Nullable fez $$2) {
      fey $$3 = new fey(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }

   private void a(fey $$0) {
      String $$1 = $$0.c().getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$2 = x.a($$0.e(), fez::h);
      if ($$2 != null) {
         a.info("[{}] [CHAT] {}", $$2, $$1);
      } else {
         a.info("[CHAT] {}", $$1);
   ...
   private void b(fey $$0) {
      int $$1 = ayy.a((double)this.f() / this.h());
      fez.a $$2 = $$0.a();
      if ($$2 != null) {
         $$1 -= $$2.c + 4 + 2;
      }

      List<ayk> $$3 = fhi.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fey.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fhe.a b(ya $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fey> $$2 = this.k.listIterator();
   ...
   private fey d(fey $$0) {
      return new fey($$0.b(), h, null, fez.a());
   }
   ...
   private void n() {
      ...
      for (fey $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Y && !this.l()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)ayy.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)ayy.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public yl b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         fey.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), ayy.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fez c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fey.a $$1, fez $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fez.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.l()) {
         if (!($$0 < -4.0) && !($$0 > (double)ayy.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = ayy.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof fls;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return ayy.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return ayy.a($$0 * 160.0 + 20.0);
   }
   ...
   public fhe.b k() {
      return new fhe.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fhe.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fey> $$0, List<String> $$1, List<fhe.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
