...
public class fhe {
   ...
   public static List<fhe.a> a(String $$0, fhe.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fhe.a> a(String $$0, List<fhe.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fhe.a> a(List<String> $$0, List<fhe.b> $$1) {
      int $$2 = 0;
      List<fhe.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fhe.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fhe.b a(String $$0, String $$1) {
         return new fhe.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fhe.b a(String $$0) {
         return new fhe.b($$0);
      }
   }
}
