...
public class eus {
   ...
   public void a(csu $$0, blu $$1, boolean $$2, boolean $$3, float $$4) {
      this.b = true;
      this.c = $$0;
      this.d = $$1;
      this.m = $$2;
      this.p = $$4;
      this.a($$1.h($$4), $$1.g($$4));
      this.b(aun.d((double)$$4, $$1.K, $$1.dr()), aun.d((double)$$4, $$1.L, $$1.dt()) + (double)aun.i($$4, this.o, this.n), aun.d((double)$$4, $$1.M, $$1.dx()));
      if ($$2) {
         if ($$3) {
      ...
      } else if ($$1 instanceof bmk && ((bmk)$$1).fD()) {
         ic $$5 = ((bmk)$$1).fF();
   ...
   protected void a(double $$0, double $$1, double $$2) {
      ...
      this.a(new els(this.e.c + $$3, this.e.d + $$4, this.e.e + $$5));
   }
   ...
   protected void b(double $$0, double $$1, double $$2) {
      this.a(new els($$0, $$1, $$2));
   }

   protected void a(els $$0) {
      this.e = $$0;
   ...
   public eus.a j() {
      ...
      double $$3 = $$2 * $$1;
      els $$4 = new els(this.g).a(0.05F);
      els $$5 = new els(this.i).a($$3);
      els $$6 = new els(this.h).a($$2);
      return new eus.a($$4, $$5, $$6);
   }
   ...
   public ees k() {
      if (!this.b) {
         ...
         eeq $$0 = this.c.b_(this.f);
         if ($$0.a(asl.a) && this.e.d < (double)((float)this.f.v() + $$0.a(this.c, this.f))) {
            return ees.b;
         } else {
            eus.a $$1 = this.j();

            for (els $$3 : Arrays.asList($$1.a, $$1.a(), $$1.b(), $$1.c(), $$1.d())) {
               els $$4 = this.e.e($$3);
               hx $$5 = hx.a($$4);
               eeq $$6 = this.c.b_($$5);
               if ($$6.a(asl.b)) {
