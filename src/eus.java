...
public abstract class eus<T extends eus<T>> {
   ...
   public eus(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = euq.a();
         if ($$3 != null) {
         ...
         throw new ewb(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ewb(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ewb(var2.getMessage(), var2);
      }
   }
   ...
   public static eus<?> a(String $$0) {
      return new eus.b($$0, 5000, 60000);
   }

   public static eus<?> a(String $$0, int $$1, int $$2) {
      return new eus.b($$0, $$1, $$2);
   }

   public static eus<?> b(String $$0, String $$1) {
      return new eus.c($$0, $$1, 5000, 60000);
   }

   public static eus<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eus.c($$0, $$1, $$2, $$3);
   }

   public static eus<?> b(String $$0) {
      return new eus.a($$0, 5000, 60000);
   }

   public static eus<?> c(String $$0, String $$1) {
      return new eus.d($$0, $$1, 5000, 60000);
   }

   public static eus<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eus.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eus<eus.a> {
   ...
   public static class b extends eus<eus.b> {
   ...
   public static class c extends eus<eus.c> {
      ...
      public eus.c f() {
         try {
            ...
            throw new ewb(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eus<eus.d> {
      private final String c;
