...
public class eus extends euj {
   ...
   private final eui[] o = new eui[jm.c.a.b()];
   ...
   public eui a() {
      ...
      if (!this.c.a($$2.y())) {
         if (this.f() && this.c.bj()) {
            while (true) {
               if (!$$2.a(dkn.J) && $$2.y() != etx.c.a(false)) {
                  $$1--;
                  break;
               }
   ...
   public static double a(dgm $$0, jh $$1) {
      jh $$2 = $$1.e();
      fcr $$3 = $$0.a_($$2).g($$0, $$2);
   ...
   @Nullable
   protected eui a(int $$0, int $$1, int $$2, int $$3, double $$4, jm $$5, eun $$6) {
      eui $$7 = null;
      jh.a $$8 = new jh.a();
   ...
   @Nullable
   private eui a(int $$0, int $$1, int $$2, int $$3, double $$4, jm $$5, eun $$6, jh.a $$7) {
   ...
   protected eun b(int $$0, int $$1, int $$2) {
      return (eun)this.m.computeIfAbsent(jh.a($$0, $$1, $$2), $$3 -> this.a(this.b, $$0, $$1, $$2, this.c));
   }
   ...
   protected static eun b(dgm $$0, jh $$1) {
      dxu $$2 = $$0.a_($$1);
      dkl $$3 = $$2.b();
      if ($$2.l()) {
         return eun.b;
      } else if ($$2.a(axu.R) || $$2.a(dkn.fA) || $$2.a(dkn.sY)) {
         return eun.e;
      } else if ($$2.a(dkn.rk)) {
         return eun.f;
      } else if ($$2.a(dkn.ed) || $$2.a(dkn.oD)) {
         return eun.q;
      } else if ($$2.a(dkn.pB)) {
         return eun.w;
      } else if ($$2.a(dkn.fQ)) {
         return eun.x;
      } else if (!$$2.a(dkn.ck) && !$$2.a(dkn.sO)) {
         etw $$4 = $$2.y();
         if ($$4.a(aya.b)) {
            return eun.i;
         } else if (a($$2)) {
            return eun.o;
         } else if ($$3 instanceof dmt $$5) {
            if ($$2.c(dmt.c)) {
               return eun.r;
            } else {
               return $$5.b().c() ? eun.s : eun.t;
            }
         } else if ($$3 instanceof dka) {
            return eun.l;
         } else if ($$3 instanceof dox) {
            return eun.v;
         } else if (!$$2.a(axu.U) && !$$2.a(axu.N) && (!($$3 instanceof dnl) || $$2.c(dnl.b))) {
            if (!$$2.a(eul.a)) {
               return eun.a;
            } else {
               return $$4.a(aya.a) ? eun.j : eun.b;
            }
         } else {
            return eun.h;
         }
