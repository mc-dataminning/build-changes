...
public class afr {
   ...
   private static final Object2IntMap<Class<? extends bkq>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final bkq d;
   private final Int2ObjectMap<afr.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> afo<T> a(Class<? extends bkq> $$0, afp<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(afo<T> $$0, T $$1) {
      afr.a<T> $$2 = new afr.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(afo<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> afr.a<T> c(afo<T> $$0) {
      this.f.readLock().lock();

      afr.a<T> $$1;
      try {
         $$1 = (afr.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(afo<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(afo<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(afo<T> $$0, T $$1, boolean $$2) {
      afr.a<T> $$3 = this.c($$0);
   ...
   private <T> void a(afr.a<T> $$0, afr.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public afr.b<T> e() {
         return afr.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, afp<T> b, T c) {

      public static <T> afr.b<T> a(afo<T> $$0, T $$1) {
         afp<T> $$2 = $$0.b();
         return new afr.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static afr.b<?> a(tu $$0, int $$1) {
         int $$2 = $$0.n();
         afp<?> $$3 = afq.a($$2);
         if ($$3 == null) {
      ...
      private static <T> afr.b<T> a(tu $$0, int $$1, afp<T> $$2) {
         return new afr.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
