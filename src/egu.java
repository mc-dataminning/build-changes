...
public class egu extends egs {
   public static final MapCodec<egu> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bpl.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  bpl.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final bpl i;
   private final jn<dfh> j;

   public egu(int $$0, int $$1, int $$2, bpl $$3, float $$4, bpl $$5, jn<dfh> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<efa.a> a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, ja $$4, eek $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new efa.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, eek $$4, List<efa.a> $$5, ja.a $$6, int $$7, jf $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new efa.a($$16, 0, false));
         $$5.add(new efa.a($$16.c(2), 0, false));
      }
   }
