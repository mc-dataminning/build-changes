...
public class egu extends ego<eit> {
   private static final jm[] a = jm.values();

   public egu(Codec<eit> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egq<eit> $$0) {
      eit $$1 = $$0.f();
      bam $$2 = $$0.d();
      jh $$3 = $$0.e();
      dhy $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      eeh $$9 = new eeh(new edj($$4.D()));
      ess $$10 = ess.a($$9, -4, 1.0);
      ...
      for (jh $$44 : $$31) {
         ...
         for (jm $$46 : a) {
            ...
            dxn $$48 = $$4.a_($$47);
            if ($$45.b(dyd.D)) {
               $$45 = $$45.b(dyd.D, Boolean.valueOf($$48.y().b()));
            }
