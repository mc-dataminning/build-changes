...
public class egu {
   ...
   public egu(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<egv> $$1) throws IOException {
   ...
   public List<egv> a(Path $$0) throws IOException {
      List<egv> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<egv> a(Path $$0, boolean $$1) throws IOException {
      List<egv> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<egv> $$1) throws IOException {
