...
public interface aqs {
   aqs a = new aqs() {
      ...
      @Override
      public void a(Consumer<ddm> $$0) {
      }
   };

   static aqs a(ddm $$0, int $$1) {
      return new aqs.a($$0, $$1);
   }

   static void a(aqs $$0, aqs $$1, Consumer<ddm> $$2, Consumer<ddm> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqs.a $$4 && $$1 instanceof aqs.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new ddm($$10, $$11));
                     } else {
                        $$3.accept(new ddm($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(ddm b, int c) implements aqs {
      int c() {
