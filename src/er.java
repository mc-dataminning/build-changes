...
public interface er<T extends cl<?>> extends ArgumentType<T> {
   static er.b a() {
      return new er.b();
   }
   ...
   public static class a implements er<cl.c> {
      private static final Collection<String> a = Arrays.asList("0..5.2", "0", "-5.4", "-100.76..", "..100");

      public static cl.c a(CommandContext<du> $$0, String $$1) {
   ...
   public static class b implements er<cl.d> {
      private static final Collection<String> a = Arrays.asList("0..5", "0", "-5", "-100..", "..100");

      public static cl.d a(CommandContext<du> $$0, String $$1) {
