...
public class er implements ArgumentType<gt> {
   ...
   public static bru a(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static Collection<? extends bru> b(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      Collection<? extends bru> $$2 = c($$0, $$1);
      if ($$2.isEmpty()) {
         throw d.create();
      } else {
         return $$2;
   ...
   public static Collection<? extends bru> c(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      return ((gt)$$0.getArgument($$1, gt.class)).b((ee)$$0.getSource());
   }

   public static Collection<aqn> d(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static aqn e(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static Collection<aqn> f(CommandContext<ee> $$0, String $$1) throws CommandSyntaxException {
      List<aqn> $$2 = ((gt)$$0.getArgument($$1, gt.class)).d((ee)$$0.getSource());
      if ($$2.isEmpty()) {
         throw e.create();
      } else {
         return $$2;
