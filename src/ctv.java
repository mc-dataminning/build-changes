...
public record ctv(int c, int d, iu<ctk> e, Optional<ctv.a> f) {
   private static final int g = 3;
   public static final MapCodec<ctv> a = ctv.a.a
      .flatXmap(ctv::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final xs<vf, ctv> b = xs.a(ctv::a, ctv::b);

   public static ctv a(Map<Character, ctk> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static ctv a(Map<Character, ctk> $$0, List<String> $$1) {
      ctv.a $$2 = new ctv.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<ctv> a(ctv.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      iu<ctk> $$4 = iu.a($$2 * $$3, ctk.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new ctv($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cme $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static ctv b(vf $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      iu<ctk> $$3 = iu.a($$1 * $$2, ctk.a);
      $$3.replaceAll($$1x -> ctk.b.decode($$0));
      return new ctv($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<ctv.a> d() {
      return this.f;
   }

   public static record a(Map<Character, ctk> b, List<String> c) {
      ...
      public static final MapCodec<ctv.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(awe.d(e, ctk.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, ctv.a::new)
      );

      public Map<Character, ctk> a() {
         return this.b;
      }
