...
public class fls extends fld implements fvr.a {
   private static final akh w = new akh("textures/gui/advancements/window.png");
   ...
   private final fld G;
   private final fvr H;
   private final Map<af, flo> I = Maps.newLinkedHashMap();
   @Nullable
   private flo J;
   private boolean K;
   ...
   public fls(fvr $$0, @Nullable fld $$1) {
      super(E);
      this.H = $$0;
      this.G = $$1;
   }
   ...
   protected void aM_() {
      ...
      if (this.J == null && !this.I.isEmpty()) {
         flo $$0 = this.I.values().iterator().next();
         this.H.a($$0.c().b(), true);
      } else {
         this.H.a(this.J == null ? null : this.J.c().b(), true);
      }

      this.F.b(ffe.a(wt.d, $$0x -> this.d()).a(200).a());
      this.F.a($$1 -> {
   ...
   public void a(fer $$0, int $$1, int $$2) {
      ...
      if (this.I.size() > 1) {
         for (flo $$3 : this.I.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.J);
         }

         for (flo $$4 : this.I.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fer $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.J != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ag $$0) {
      flo $$1 = flo.a(this.m, this, this.I.size(), $$0);
      if ($$1 != null) {
         this.I.put($$0.b(), $$1);
      }
   }
