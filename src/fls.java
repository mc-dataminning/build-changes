...
public class fls extends fmd {
      ...
      try {
         ...
         if (azc.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fnz.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fpo.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fnz.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fpo.Q().b($$4)) {
               try {
