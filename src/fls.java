...
public class fls {
   ...
   public static void a(File $$0, fef $$1, Consumer<wp> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fef $$2, Consumer<wp> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fef $$2, Consumer<wp> $$3) {
      fev $$4 = a($$2);
   ...
   public static fev a(fef $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fev $$3 = new fev($$1, $$2, false);
   ...
   public fls(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
