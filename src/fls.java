...
public class fls {
   ...
   public static flv a(BooleanConsumer $$0, BanDetails $$1) {
      return new flv($$0, a($$1), b($$1), "https://aka.ms/mcjavamoderation", xo.m, true);
   }

   public static flv a(Runnable $$0) {
   ...
   public static flv a(String $$0, Runnable $$1) {
