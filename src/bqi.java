...
public class bqi implements bqj {
   ...
   private static final bqi k = new bqi();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bqh $$0) {
      URL $$1 = bqi.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bqh $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bql a = new bql(() -> bqi.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bqi.this.l && $$0.getState() == RecordingState.STOPPED) {
