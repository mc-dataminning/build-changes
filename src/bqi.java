...
public class bqi {
   ...
   private static void a(bqq $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<eaj, bqu<bqk>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqu)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ae.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<eaj, bqu<bqk>> $$3 : $$0) {
         bqu<bqk> $$4 = (bqu<bqk>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((eaj)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bqs> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bpx.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bqg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bqi::a));
      $$1.add("chunksWritten", this.a($$0.m(), bqi::a));
      return $$1;
   }
   ...
   private JsonElement c(bqg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bqi::a));
      $$1.add("received", this.a($$0.k(), bqi::a));
      return $$1;
   }

   private <T> JsonElement a(bqp<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bqm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bqm>, ToDoubleFunction<bqm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bqm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bqm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bqm::c));
      return $$1;
   }
}
