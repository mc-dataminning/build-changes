...
public class bqi extends bqp {
   public static final MapCodec<bqi> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  bqp.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bqi a(bqp $$0, int $$1, int $$2) {
      return new bqi($$0, $$1, $$2);
   }

   public bqi(bqp $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Override
   public int a(azk $$0) {
      return azc.a(this.b.a($$0), this.f, this.g);
   }
