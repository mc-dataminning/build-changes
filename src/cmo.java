...
public class cmo {
   ...
   public boolean a(cyi<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cyi<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cmo.a($$0).a($$2, $$1);
   }

   public int a(cyk<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cyk<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cmo.a($$0.b()).b($$1, $$2);
   }

   public static cuc a(int $$0) {
      return $$0 == 0 ? cuc.l : new cuc(ctx.b($$0));
   }
   ...
   class a {
      private final cyi<?> b;
      private final List<cyf> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public a(final cyi<?> $$0) {
         this.b = $$0;
         this.c.addAll($$0.a());
         this.c.removeIf(cyf::c);
         this.d = this.c.size();
         this.e = this.a();
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cmo.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
