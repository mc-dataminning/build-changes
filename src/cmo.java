...
public abstract class cmo extends cmz {
   ...
   protected cmo(bsj<? extends cmo> $$0, dcd $$1) {
      super($$0, $$1);
   }

   protected cmo(bsj<? extends cmo> $$0, double $$1, double $$2, double $$3, dcd $$4) {
      this($$0, $$4);
      this.a_($$1, $$2, $$3);
   }

   public cmo(bsj<? extends cmo> $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, dcd $$7) {
      this($$0, $$7);
   ...
   public cmo(bsj<? extends cmo> $$0, bsy $$1, double $$2, double $$3, double $$4, dcd $$5) {
   ...
   public void l() {
      ...
      if (this.dP().B || ($$0 == null || !$$0.dK()) && this.dP().B(this.dp())) {
         ...
         evx $$1 = cnb.a(this, this::b, this.af_());
         if ($$1.c() != evx.a.a) {
            this.b($$1);
         }
   ...
   public zb<abn> dl() {
      bsd $$0 = this.s();
      int $$1 = $$0 == null ? 0 : $$0.al();
      return new abo(this.al(), this.cz(), this.du(), this.dw(), this.dA(), this.dH(), this.dF(), this.ak(), $$1, new evz(this.d, this.e, this.f), 0.0);
   }
