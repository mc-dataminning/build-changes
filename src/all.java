...
public class all {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a(
                           ...
                           dt.a("rate")
                              .then(
                                 dt.a("rate", FloatArgumentType.floatArg(1.0F, 10000.0F))
                                    .suggests(($$0x, $$1) -> dx.a(new String[]{b}, $$1))
                     ...
                     .then(
                        ((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a("step").executes($$0x -> b((ds)$$0x.getSource(), 1)))
                           ...
                           .then(
                              dt.a("time", ff.a(1))
                                 .suggests(($$0x, $$1) -> dx.a(new String[]{"1t", "1s"}, $$1))
                  ...
                  .then(
                     ((LiteralArgumentBuilder)dt.a("sprint").then(dt.a("stop").executes($$0x -> c((ds)$$0x.getSource()))))
                        .then(
                           dt.a("time", ff.a(1))
                              .suggests(($$0x, $$1) -> dx.a(new String[]{"60s", "1d", "3d"}, $$1))
   ...
   private static String a(long $$0) {
      return String.format("%.1f", (float)$$0 / (float)avq.b);
   }
   ...
   private static int a(ds $$0, float $$1) {
      ...
      $$0.a(() -> vg.a("commands.tick.rate.success", $$3), true);
      return (int)$$1;
   }
   ...
   private static int a(ds $$0) {
      ...
      if ($$1.a()) {
         $$0.a(() -> vg.c("commands.tick.status.sprinting"), false);
         $$0.a(() -> vg.a("commands.tick.query.rate.sprinting", $$4, $$2), false);
      } else {
         if ($$1.l()) {
            $$0.a(() -> vg.c("commands.tick.status.frozen"), false);
         } else if ($$1.h() < $$0.l().aP()) {
            $$0.a(() -> vg.c("commands.tick.status.lagging"), false);
         } else {
            $$0.a(() -> vg.c("commands.tick.status.running"), false);
         }

         String $$5 = a($$1.h());
         $$0.a(() -> vg.a("commands.tick.query.rate.running", $$4, $$2, $$5), false);
      }
      ...
      $$0.a(() -> vg.a("commands.tick.query.percentiles", $$7, $$8, $$9, $$6.length), false);
      return (int)$$3;
   }
   ...
   private static int a(ds $$0, int $$1) {
      ...
      if ($$2) {
         $$0.a(() -> vg.c("commands.tick.sprint.stop.success"), true);
      }

      $$0.a(() -> vg.c("commands.tick.status.sprinting"), true);
      return 1;
   }
   ...
   private static int a(ds $$0, boolean $$1) {
      ...
      $$2.a($$1);
      if ($$1) {
         $$0.a(() -> vg.c("commands.tick.status.frozen"), true);
      } else {
         $$0.a(() -> vg.c("commands.tick.status.running"), true);
      }
   ...
   private static int b(ds $$0, int $$1) {
      ...
      boolean $$3 = $$2.a($$1);
      if ($$3) {
         $$0.a(() -> vg.a("commands.tick.step.success", $$1), true);
      } else {
         $$0.b(vg.c("commands.tick.step.fail"));
      }
   ...
   private static int b(ds $$0) {
      ...
      boolean $$2 = $$1.b();
      if ($$2) {
         $$0.a(() -> vg.c("commands.tick.step.stop.success"), true);
         return 1;
      } else {
         $$0.b(vg.c("commands.tick.step.stop.fail"));
         return 0;
      }
   }
   ...
   private static int c(ds $$0) {
      ...
      if ($$2) {
         ...
         $$0.b(vg.c("commands.tick.sprint.stop.fail"));
         return 0;
      }
   }
}
