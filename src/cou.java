...
public abstract class cou extends cph {
   private static final evs c = new evs(0.0, 0.0, 0.0);
   private static final akk<Integer> d = ako.a(cou.class, akm.b);
   private static final akk<Integer> e = ako.a(cou.class, akm.b);
   private static final akk<Boolean> i = ako.a(cou.class, akm.k);
   private static final ImmutableMap<buc, ImmutableList<Integer>> j = ImmutableMap.of(
      buc.a, ImmutableList.of(0, 1, -1), buc.f, ImmutableList.of(0, 1, -1), buc.d, ImmutableList.of(0, 1)
   );
   ...
   private double r;
   private evs s = evs.b;
   private static final Map<dth, Pair<kd, kd>> t = ac.a(Maps.newEnumMap(dth.class), $$0 -> {
      kd $$1 = je.e.q();
      kd $$2 = je.f.q();
      kd $$3 = je.c.q();
      kd $$4 = je.d.q();
      ...
      kd $$7 = $$3.o();
      kd $$8 = $$4.o();
      $$0.put(dth.a, Pair.of($$3, $$4));
      $$0.put(dth.b, Pair.of($$1, $$2));
      $$0.put(dth.c, Pair.of($$5, $$2));
      $$0.put(dth.d, Pair.of($$1, $$6));
      $$0.put(dth.e, Pair.of($$3, $$8));
      $$0.put(dth.f, Pair.of($$7, $$4));
      $$0.put(dth.g, Pair.of($$4, $$2));
      $$0.put(dth.h, Pair.of($$4, $$1));
      $$0.put(dth.i, Pair.of($$3, $$1));
      $$0.put(dth.j, Pair.of($$3, $$2));
   });

   protected cou(btb<?> $$0, dbz $$1) {
      super($$0, $$1);
      this.J = true;
   }

   protected cou(btb<?> $$0, dbz $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.a_($$2, $$3, $$4);
      this.L = $$2;
      this.M = $$3;
   ...
   public static cou a(arf $$0, double $$1, double $$2, double $$3, cou.a $$4, cuq $$5, @Nullable cmy $$6) {
      cou $$7 = (cou)(switch ($$4) {
         case b -> new cpb($$0, $$1, $$2, $$3);
         case c -> new cpd($$0, $$1, $$2, $$3);
         case d -> new cpg($$0, $$1, $$2, $$3);
         case e -> new cpf($$0, $$1, $$2, $$3);
         case f -> new cpe($$0, $$1, $$2, $$3);
         case g -> new cpc($$0, $$1, $$2, $$3);
         default -> new cpa($$0, $$1, $$2, $$3);
      });
      btb.<cou>a($$0, $$5, $$6).accept($$7);
      return $$7;
   }
   ...
   protected evs a(je.a $$0, l.a $$1) {
      return btq.j(super.a($$0, $$1));
   }

   @Override
   protected evs a(bsv $$0, bsy $$1, float $$2) {
      boolean $$3 = $$0 instanceof cml || $$0 instanceof cmr;
   ...
   public evs b(btq $$0) {
      ...
      if ($$1.o() == je.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dP().a(coz.a(this.dP(), $$4), () -> coz.a(this.dP(), $$4.d()));
                  if (coz.a($$11)) {
                     evn $$12 = new evn((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b(), (double)$$8);
                     evs $$13 = evs.a($$4, $$11);
                     if (coz.a(this.dP(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            buc $$15 = (buc)var22.next();
            double $$16 = (double)$$0.a($$15).b();
            int $$17 = ayz.c($$14x - (double)$$4.v() + $$16);
            double $$18 = coz.a($$4, $$17, $$0x -> this.dP().a_($$0x).k(this.dP(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   private static Pair<kd, kd> a(dth $$0) {
      return t.get($$0);
   }
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         this.a(this.dF(), this.dH());
         if (this.v() == cou.a.a && this.ds().i() > 0.01) {
            List<bsv> $$8 = this.dP().a(this, this.cK().c(0.2F, 0.0, 0.2F), bta.a(this));
            if (!$$8.isEmpty()) {
               for (bsv $$9 : $$8) {
                  if (!($$9 instanceof cmy) && !($$9 instanceof cfs) && !($$9 instanceof cou) && !this.bS() && !$$9.bR()) {
                     $$9.n(this);
                  } else {
                     $$9.h(this);
                  }
            ...
            for (bsv $$10 : this.dP().a_(this, this.cK().c(0.2F, 0.0, 0.2F))) {
               if (!this.x($$10) && $$10.bA() && $$10 instanceof cou) {
                  $$10.h(this);
               }
            }
         }
   ...
   protected void c(iz $$0, dsd $$1) {
      ...
      $$9 = new evs($$18 * $$14 / $$16, $$9.d, $$18 * $$15 / $$16);
      this.h($$9);
      bsv $$19 = this.cT();
      if ($$19 instanceof cmy) {
         evs $$20 = $$19.ds();
         double $$21 = $$20.i();
         double $$22 = this.ds().i();
      ...
      double $$34 = this.p();
      $$9 = this.ds();
      this.a(btv.a, new evs(ayz.a($$33 * $$9.c, -$$34, $$34), 0.0, ayz.a($$33 * $$9.e, -$$34, $$34)));
      ...
      this.u();
      evs $$35 = this.q(this.du(), this.dw(), this.dA());
      if ($$35 != null && $$5 != null) {
   ...
   @Nullable
   public evs a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ayz.a($$0);
      int $$5 = ayz.a($$1);
      int $$6 = ayz.a($$2);
   ...
   @Nullable
   public evs q(double $$0, double $$1, double $$2) {
      int $$3 = ayz.a($$0);
      int $$4 = ayz.a($$1);
      int $$5 = ayz.a($$2);
            ...
            if (!this.x($$0)) {
               ...
               if ($$3 >= 1.0E-4F) {
                  ...
                  if ($$0 instanceof cou) {
                     ...
                     evs $$7 = new evs($$5, 0.0, $$6).d();
                     evs $$8 = new evs((double)ayz.b(this.dF() * (float) (Math.PI / 180.0)), 0.0, (double)ayz.a(this.dF() * (float) (Math.PI / 180.0))).d();
                     ...
                     evs $$10 = this.ds();
                     evs $$11 = $$0.ds();
                     if (((cou)$$0).v() == cou.a.c && this.v() != cou.a.c) {
                        this.h($$10.d(0.2, 1.0, 0.2));
                        this.j($$11.c - $$1, 0.0, $$11.e - $$2);
                        $$0.h($$11.d(0.95, 1.0, 0.95));
                     } else if (((cou)$$0).v() != cou.a.c && this.v() == cou.a.c) {
   ...
   public abstract cou.a v();

   public dsd w() {
      return !this.A() ? this.x() : dfa.a(this.ap().a(d));
   }
