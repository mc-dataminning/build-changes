...
public class cou {
   ...
   @VisibleForTesting
   protected final ArrayList<bvf> c;
   private final cou.a k;
   @VisibleForTesting
   protected final Object2IntMap<bvf> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cou> a(Predicate<bvf> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cou::b)).apply($$1, $$1x -> new cou($$0, $$1x))
      );
   }

   public cou(Predicate<bvf> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cou.a(this);
   ...
   public void a(ash $$0, Predicate<bvf> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bvf>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bvf> $$6 = (Entry<bvf>)$$5.next();
         int $$7 = $$6.getIntValue();
         bvf $$8 = (bvf)$$6.getKey();
         bvf.c $$9 = $$8.dR();
   ...
   public int b(@Nullable bvf $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bwb> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bwb).map($$0 -> (bwb)$$0);
   }

   @VisibleForTesting
   protected static record a(cou a) implements Comparator<bvf> {
      public int a(bvf $$0, bvf $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cps;
               boolean $$7 = $$1 instanceof cps;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
