public abstract class adt implements wu<acw> {
   ...
   protected adt(double $$0, double $$1, double $$2, float $$3, float $$4, boolean $$5, boolean $$6, boolean $$7) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static class c extends adt {
      ...
      public static adt.c b(ue $$0) {
         float $$1 = $$0.readFloat();
         float $$2 = $$0.readFloat();
         boolean $$3 = $$0.readUnsignedByte() != 0;
         return new adt.c($$1, $$2, $$3);
      }
   ...
   public static class d extends adt {
      public d(boolean $$0) {
         super(0.0, 0.0, 0.0, 0.0F, 0.0F, $$0, false, false);
      }

      public static adt.d b(ue $$0) {
