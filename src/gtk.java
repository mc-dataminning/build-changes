...
public class gtk extends MinecraftServer {
   ...
   public gtk(Thread $$0, ffn $$1, eqc.c $$2, atf $$3, alh $$4, ale $$5, aqu $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.as(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gtj(this, this.bd(), this.g));
      this.m = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (aql $$1 : Lists.newArrayList(this.ah().t())) {
   ...
   @Override
   public dca bf() {
      return this.r() ? (dca)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
