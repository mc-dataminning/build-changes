...
public abstract class ctc extends ctw implements bwx {
   private static final akh<Boolean> h = akl.a(ctc.class, akj.k);
   private static final akh<Boolean> i = akl.a(ctc.class, akj.k);
   private static final akh<Integer> j = akl.a(ctc.class, akj.b);
   ...
   private float n;
   private float o;
   private final bwu p = new bwu(this, 3);
   private boolean q;
   private boolean r;
   private boolean s;
   private boolean t;
   ...
   @Nullable
   private bwx.a aH;
   private final Supplier<cyo> aI;

   public ctc(bwj<? extends ctc> $$0, dip $$1, Supplier<cyo> $$2) {
      super($$0, $$1);
      this.aI = $$2;
      this.I = true;
   }
   ...
   public static boolean a(bwa $$0, bwa $$1) {
   ...
   protected abstract double b(bwd var1);
   ...
   protected fdw a(bwa $$0, bwd $$1, float $$2) {
      ...
      return new fdw(0.0, this.b($$1), (double)$$3).b(-this.dL() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      this.aA = this.az;
      this.az = this.x();
      if (this.az != ctc.a.b && this.az != ctc.a.c) {
         this.n = 0.0F;
      } else {
         this.n++;
      }
      ...
      if (this.dg()) {
         ...
         if (this.dV().C) {
            this.G();
            this.dV().a(new aho(this.c(0), this.c(1)));
         }
      ...
      List<bwa> $$5 = this.dV().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bwh.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dV().C && !(this.cW() instanceof cqs);
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aD) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof cqs) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   @Override
   public fdw cT() {
      return new fdw(0.0, (double)(0.88F * this.cS()), (double)(this.dq() * 0.64F));
   }

   @Override
   public void b(bwa $$0, float $$1) {
      fdw $$2 = $$0.dt().d(this.dt()).d().c((double)$$1 - 6.0);
      fdw $$3 = this.dy();
      boolean $$4 = $$3.b($$2) > 0.0;
   ...
   public float j() {
      fdr $$0 = this.cR();
      fdr $$1 = new fdr($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = azk.a($$1.a) - 1;
      int $$3 = azk.c($$1.d) + 1;
      int $$4 = azk.a($$1.b) - 1;
      int $$5 = azk.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dzo $$16 = this.dV().a_($$11);
                     if (!($$16.b() instanceof dvh) && fen.c($$16.g(this.dV(), $$11).a($$11), $$8, fea.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
   ...
   private void F() {
      ...
      double $$1 = 0.0;
      float $$2 = 0.05F;
      if (this.aA == ctc.a.e && this.az != ctc.a.e && this.az != ctc.a.d) {
         this.u = this.e(1.0);
         ...
         if (this.az == ctc.a.a) {
            ...
            $$2 = 0.9F;
         } else if (this.az == ctc.a.c) {
            $$0 = -7.0E-4;
            $$2 = 0.9F;
         } else if (this.az == ctc.a.b) {
            $$1 = 0.01F;
            $$2 = 0.45F;
         } else if (this.az == ctc.a.e) {
            $$2 = 0.9F;
         } else if (this.az == ctc.a.d) {
            $$2 = this.ay;
            if (this.cW() instanceof cqs) {
               this.ay /= 2.0F;
            }
         }
   ...
   protected void a(bwa $$0, bwa.b $$1) {
      ...
      if (!$$0.aq().a(axd.s)) {
         ...
         $$0.r($$0.cA() + this.o);
         this.c($$0);
         if ($$0 instanceof cio && this.cY().size() == this.n()) {
            int $$2 = $$0.ar() % 2 == 0 ? 90 : 270;
            $$0.s(((cio)$$0).aV + (float)$$2);
            $$0.r($$0.cA() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public fdw b(bwz $$0) {
      fdw $$1 = a((double)(this.dq() * azk.g), (double)$$0.dq(), $$0.dL());
      double $$2 = this.dA() + $$1.d;
      double $$3 = this.dG() + $$1.f;
      iu $$4 = iu.a($$2, this.cR().e, $$3);
      iu $$5 = $$4.e();
      if (!this.dV().A($$5)) {
         List<fdw> $$6 = Lists.newArrayList();
         double $$7 = this.dV().j($$4);
         if (ctk.a($$7)) {
            $$6.add(new fdw($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dV().j($$5);
         if (ctk.a($$8)) {
            $$6.add(new fdw($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fN().iterator();

         while (var14.hasNext()) {
            bxl $$9 = (bxl)var14.next();

            for (fdw $$10 : $$6) {
               if (ctk.a(this.dV(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   public bty a(cqs $$0, btx $$1) {
      ...
      if ($$2 != bty.e) {
         ...
         return (bty)($$0.fX() || !(this.n < 60.0F) || !this.dV().C && !$$0.n(this) ? bty.e : bty.a);
      }
   }
   ...
   @Override
   public bwz cW() {
      return this.cZ() instanceof bwz $$0 ? $$0 : super.cW();
   }
   ...
   @Override
   public boolean bn() {
      return this.az == ctc.a.b || this.az == ctc.a.c;
   }

   @Override
   protected final cyo o() {
      return this.aI.get();
   }

   @Override
   public final cys dI() {
      return new cys(this.aI.get());
   }
