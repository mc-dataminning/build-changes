...
public class ctc {
   ...
   public static final MapCodec<ctc> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ctc.a.e.fieldOf("status").forGetter($$0x -> $$0x.O),
   ...
   private final Map<Integer, ctd> z = Maps.newHashMap();
   private final Map<Integer, Set<ctd>> A = Maps.newHashMap();
   ...
   private ctc(boolean $$0, boolean $$1, long $$2, int $$3, int $$4, int $$5, int $$6, float $$7, int $$8, ctc.a $$9, iv $$10, Set<UUID> $$11) {
      this.E = $$0;
      this.H = $$1;
      this.C = $$2;
      this.G = $$3;
   ...
   public boolean d() {
      return this.O == ctc.a.d;
   }

   public boolean e() {
      return this.O == ctc.a.b;
   }

   public boolean f() {
      return this.O == ctc.a.c;
   }
   ...
   public Set<ctd> h() {
      Set<ctd> $$0 = Sets.newHashSet();

      for (Set<ctd> $$1 : this.A.values()) {
         $$0.addAll($$1);
      }
   ...
   private void e(arq $$0) {
      Iterator<Set<ctd>> $$1 = this.A.values().iterator();
   ...
   public void a(arq $$0, int $$1, ctd $$2, @Nullable iv $$3, boolean $$4) {
   ...
   public void a(arq $$0, ctd $$1, boolean $$2) {
      Set<ctd> $$3 = this.A.get($$1.gI());
      if ($$3 != null) {
   ...
   public static czn a(jg<dxg> $$0) {
      czn $$1 = new czn(czr.wa);
      dxh $$2 = new dxh.a()
         .a($$0, dxi.z, cyl.j)
         .a($$0, dxi.f, cyl.i)
         .a($$0, dxi.j, cyl.h)
         ...
         if (azm.a($$10 - this.D.v()) <= 96) {
            ...
            if (!$$0.c($$4) || $$2 <= 7) {
               ...
               if ($$0.b($$4.u() - 10, $$4.w() - 10, $$4.u() + 10, $$4.w() + 10)
                  && $$0.f($$4)
                  && (a.isSpawnPositionOk($$0, $$4, bwr.aZ) || $$0.a_($$4.e()).a(dmt.ed) && $$0.a_($$4).l())) {
                  return $$4;
               }
            }
         }
   ...
   private boolean a(arq $$0, int $$1, ctd $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   public boolean a(arq $$0, int $$1, ctd $$2, boolean $$3) {
      this.A.computeIfAbsent($$1, $$0x -> Sets.newHashSet());
      Set<ctd> $$4 = this.A.get($$1);
      ctd $$5 = null;
   ...
   private int a(ctc.b $$0, int $$1, boolean $$2) {
      return $$2 ? $$0.h[this.N] : $$0.h[$$1];
   }

   private int a(ctc.b $$0, azv $$1, int $$2, bue $$3, boolean $$4) {
      bud $$5 = $$3.a();
      boolean $$6 = $$5 == bud.b;
      boolean $$7 = $$5 == bud.c;
      int $$9;
   ...
   static enum a implements bak {
      ...
      public static final Codec<ctc.a> e = bak.a(ctc.a::values);
   ...
   static enum b {
      ...
      static final ctc.b[] f = values();
      final bwr<? extends ctd> g;
      final int[] h;

      private b(final bwr<? extends ctd> $$0, final int[] $$1) {
         this.g = $$0;
         this.h = $$1;
      }
   }
