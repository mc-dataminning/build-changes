...
public final class afs<E> implements Codec<ib<E>> {
   private final afv<? extends io<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> afs<E> a(afv<? extends io<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> afs<E> a(afv<? extends io<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new afs<>($$0, $$1, $$2);
   }

   private afs(afv<? extends io<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(ib<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof afu<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> afw.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
   ...
   public <T> DataResult<Pair<ib<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof afu<?> $$2) {
         ...
         if ($$3.isEmpty()) {
            ...
            ic<E> $$4 = $$3.get();
            DataResult<Pair<afw, T>> $$5 = afw.a.decode($$0, $$1);
            if ($$5.result().isEmpty()) {
               return !this.c ? DataResult.error(() -> "Inline definitions not allowed here") : this.b.decode($$0, $$1).map($$0x -> $$0x.mapFirst(ib::a));
            } else {
               Pair<afw, T> $$6 = (Pair<afw, T>)$$5.result().get();
               afv<E> $$7 = afv.a(this.a, (afw)$$6.getFirst());
               return $$4.a($$7)
