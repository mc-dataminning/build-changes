...
public class dwc extends dvs<dwb> {
   private static final float a = 0.06F;

   public dwc(Codec<dwb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dvu<dwb> $$0) {
      cxw $$1 = $$0.b();
      ib $$2 = $$0.e();
      axd $$3 = $$0.d();
      doy $$4 = $$0.c();
   ...
   private static boolean a(cxw $$0, ib $$1, dwb $$2, boolean $$3) {
      if ($$0.a($$1, dna.a::r)) {
         return true;
      } else {
   ...
   private void a(cxw $$0, axd $$1, dwb $$2, ib $$3, int $$4, boolean $$5) {
      ib.a $$6 = new ib.a();
      dnb $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(cxw $$0, axd $$1, dwb $$2, ib $$3, int $$4, boolean $$5) {
      ib.a $$6 = new ib.a();
      boolean $$7 = $$2.d.a(dae.kK);
   ...
   private void a(cxc $$0, axd $$1, dwb $$2, ib.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(cxc $$0, axd $$1, ib $$2, dnb $$3, boolean $$4) {
      if ($$0.a_($$2.d()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(ib $$0, cxc $$1, axd $$2) {
      ib.a $$3 = $$0.j().c(ih.a);
      if ($$1.u($$3)) {
         int $$4 = aww.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
