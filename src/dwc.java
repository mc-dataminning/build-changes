...
public class dwc<T extends dvx> {
   ...
   public dwc(Class<T> $$0, Long2ObjectFunction<dwk> $$1) {
      this.a = $$0;
      this.b = $$1;
   }

   public void a(evh $$0, axh<dwb<T>> $$1) {
      int $$2 = 2;
      int $$3 = kb.a($$0.a - 2.0);
      int $$4 = kb.a($$0.b - 4.0);
      int $$5 = kb.a($$0.c - 2.0);
   ...
   public Stream<dwb<T>> b(long $$0) {
      return this.a($$0).<dwb<T>>mapToObj(this.c::get).filter(Objects::nonNull);
   }

   private static long f(long $$0) {
      return dba.c(kb.b($$0), kb.d($$0));
   }

   public dwb<T> c(long $$0) {
      return (dwb<T>)this.c.computeIfAbsent($$0, this::g);
   }

   @Nullable
   public dwb<T> d(long $$0) {
      return (dwb<T>)this.c.get($$0);
   }

   private dwb<T> g(long $$0) {
      long $$1 = f($$0);
      dwk $$2 = (dwk)this.b.get($$1);
      this.d.add($$0);
      return new dwb<>(this.a, $$2);
   }
