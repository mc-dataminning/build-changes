...
public class gun implements gut.a {
   ...
   private final fpt F;
   private final Map<iv, gun.a> G = Maps.newHashMap();
   ...
   private void b(fkd $$0, gqr $$1, double $$2, double $$3, double $$4) {
      iv $$5 = iv.a($$2, $$3, $$4);
   ...
   private void a(fkd $$0, gqr $$1, gun.a $$2) {
      int $$3 = 0;
   ...
   private void a(fkd $$0, gqr $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gvc.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fkd $$0, gqr $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fkd $$0, gqr $$1, String $$2, gun.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      gut.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cF());
   }
