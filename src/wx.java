...
public class wx {
   ...
   public static Optional<xi> a(@Nullable ed $$0, Optional<wu> $$1, @Nullable brh $$2, int $$3) throws CommandSyntaxException {
      return $$1.isPresent() ? Optional.of(a($$0, $$1.get(), $$2, $$3)) : Optional.empty();
   }

   public static xi a(@Nullable ed $$0, wu $$1, @Nullable brh $$2, int $$3) throws CommandSyntaxException {
      if ($$3 > 100) {
         return $$1.f();
      } else {
         xi $$4 = $$1.b().a($$0, $$2, $$3 + 1);
   ...
   private static xr a(@Nullable ed $$0, xr $$1, @Nullable brh $$2, int $$3) throws CommandSyntaxException {
      xa $$4 = $$1.i();
      if ($$4 != null) {
         wu $$5 = $$4.a(xa.a.a);
         if ($$5 != null) {
