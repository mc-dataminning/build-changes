...
public class gfi extends gfh implements abz, xj {
   private static final Logger l = LogUtils.getLogger();
   private final GameProfile m;
   private cst n;
   private final ke.b o;
   private final gfy p = new gfy();
   @Nullable
   private gfr q;
   @Nullable
   protected fog.b k;

   public gfi(fmg $$0, wp $$1, gfp $$2) {
      super($$0, $$1, $$2);
      this.m = $$2.a();
      this.o = $$2.c();
      this.n = $$2.d();
   ...
   public void a(aca $$0) {
      ...
      this.b.a(ahl.b.a(xg.a($$1)), new gfl(this.a, this.b, new gfp(this.m, this.e, $$1, this.n, this.d, this.c, this.f, this.h, this.k, this.i, this.j)));
      this.b.a(aci.a);
