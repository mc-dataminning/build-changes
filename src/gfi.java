...
public class gfi extends dhh {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ecd e = new ecd();
   private final ecj<bvj> f = new ecj<>(bvj.class, new gfi.b());
   private final gfj E;
   private final glf F;
   private final gle G;
   private final gfi.a H;
   private final gkv I;
   private final btr J;
   private final fme K = fme.Q();
   final List<gkc> L = Lists.newArrayList();
   private final Map<evo, evq> M = Maps.newHashMap();
   private static final int N = -1;
   private int O;
   private final Object2ObjectArrayMap<dgr, fnh> P = ae.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gkp.a, new fnh($$0xx -> this.b($$0xx, gkp.a)));
      $$0x.put(gkp.b, new fnh($$0xx -> this.b($$0xx, gkp.b)));
      $$0x.put(gkp.c, new fnh($$0xx -> this.b($$0xx, gkp.c)));
   });
   private final gfe Q;
   private final Deque<Runnable> R = Queues.newArrayDeque();
   private int S;
   private final ggv T = new ggv();
   private final int U;
   private boolean V;
   ...
   public gfi(gfj $$0, gfi.a $$1, aly<dhh> $$2, jq<ebp> $$3, int $$4, int $$5, glf $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.Q = new gfe(this, $$4);
      this.J = new btr();
      this.H = $$1;
      this.F = $$6;
      this.U = $$9;
      this.G = new gle(this.K, this, $$6);
      this.I = gkv.a($$3.a());
   ...
   public void a(@Nullable cpw $$0, bvj $$1, jq<axe> $$2, axg $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hfg)(new hex($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bvj $$0, axe $$1, axg $$2, float $$3, float $$4) {
      this.K.ak().a((hfg)(new hex($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, axe $$3, axg $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hfb $$10 = new hfb($$3, $$4, $$5, $$6, bam.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<dad> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gia.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
