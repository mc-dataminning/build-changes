...
public interface bzb extends bzs {
   void b(boolean var1);

   void a(bjm var1, cjl var2, ccs var3, float var4);
   ...
   default void b(bjm $$0, float $$1) {
      bhd $$2 = cct.a($$0, cjo.uZ);
      cjl $$3 = $$0.b($$2);
      if ($$0.b(cjo.uZ)) {
         cht.a($$0.dL(), $$0, $$2, $$3, $$1, (float)(14 - $$0.dL().ai().a() * 4));
      }

      this.a();
   }

   default void a(bjm $$0, bjm $$1, ccs $$2, float $$3, float $$4) {
      double $$5 = $$1.dq() - $$0.dq();
      double $$6 = $$1.dw() - $$0.dw();
      double $$7 = Math.sqrt($$5 * $$5 + $$6 * $$6);
      double $$8 = $$1.e(0.3333333333333333) - $$2.ds() + $$7 * 0.2F;
      Vector3f $$9 = this.a($$0, new ehh($$5, $$8, $$6), $$3);
      $$2.c((double)$$9.x(), (double)$$9.y(), (double)$$9.z(), $$4, (float)(14 - $$0.dL().ai().a() * 4));
      $$0.a(apg.fq, 1.0F, 1.0F / ($$0.ef().i() * 0.4F + 0.8F));
   }

   default Vector3f a(bjm $$0, ehh $$1, float $$2) {
