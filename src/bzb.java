...
public class bzb<T extends chr & chv> extends byb {
   private final T a;
   ...
   public bzb(T $$0, double $$1, int $$2, float $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3 * $$3;
