...
public class bzb extends bzs {
   ...
   class a extends bzs.c {
      ...
      protected void k() {
         ...
         float $$3 = (float)arw.d($$0.dw() - bzb.this.dw(), $$0.dq() - bzb.this.dq());
         if (bzb.this.f((biq)$$0) < 9.0) {
            for (int $$4 = 0; $$4 < 5; $$4++) {
               float $$5 = $$3 + (float)$$4 * (float) Math.PI * 0.4F;
               this.a(bzb.this.dq() + (double)arw.b($$5) * 1.5, bzb.this.dw() + (double)arw.a($$5) * 1.5, $$1, $$2, $$5, 0);
            }

            for (int $$6 = 0; $$6 < 8; $$6++) {
               float $$7 = $$3 + (float)$$6 * (float) Math.PI * 2.0F / 8.0F + (float) (Math.PI * 2.0 / 5.0);
               this.a(bzb.this.dq() + (double)arw.b($$7) * 2.5, bzb.this.dw() + (double)arw.a($$7) * 2.5, $$1, $$2, $$7, 3);
            }
         } else {
            for (int $$8 = 0; $$8 < 16; $$8++) {
               double $$9 = 1.25 * (double)($$8 + 1);
               int $$10 = 1 * $$8;
               this.a(bzb.this.dq() + (double)arw.b($$3) * $$9, bzb.this.dw() + (double)arw.a($$3) * $$9, $$1, $$2, $$3, $$10);
            }
         }
      }
