...
public class cod extends cnr {
   private static final byte c = 10;
   private int d = -1;

   public cod(bsa<? extends cod> $$0, dax $$1) {
      super($$0, $$1);
   }

   public cod(dax $$0, double $$1, double $$2, double $$3) {
      super(bsa.bd, $$0, $$1, $$2, $$3);
   }
   ...
   public boolean a(bqn $$0, float $$1) {
      if ($$0.c() instanceof cmc $$3 && $$3.bQ()) {
         bqn $$4 = this.dQ().d(this, $$0.d());
         this.a($$4, $$3.ds().g());
      }
   ...
   protected void a(@Nullable bqn $$0, double $$1) {
      if (!this.dP().B) {
         ...
         this.dP().a(this, $$0, null, this.du(), this.dw(), this.dA(), (float)(4.0 + this.ah.j() * 1.5 * $$2), false, dax.a.d);
         this.ao();
      }
   }
   ...
   public void B() {
      ...
      if (!this.dP().B) {
         ...
         if (!this.aW()) {
            this.dP().a(null, this.du(), this.dw(), this.dA(), avh.zv, avi.e, 1.0F, 1.0F);
         }
      }
   }
   ...
   private static boolean e(bqn $$0) {
