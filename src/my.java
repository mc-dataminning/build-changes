...
public abstract class my<T> implements ji {
   ...
   protected my(jk $$0, acp<? extends hr<T>> $$1, CompletableFuture<hg.b> $$2, CompletableFuture<my.c<T>> $$3) {
      ...
      return this.b()
         ...
         .thenCompose(
            $$1 -> {
               ...
               Predicate<acq> $$3 = $$1x -> $$2.a(acp.a(this.f, $$1x)).isPresent();
               Predicate<acq> $$4 = $$1x -> this.j.containsKey($$1x) || $$1.b.contains(anl.a(this.f, $$1x));
               return CompletableFuture.allOf(
                  this.j
                     ...
                     .map(
                        $$3x -> {
                           acq $$4x = (acq)$$3x.getKey();
                           ani $$5 = (ani)$$3x.getValue();
                           List<anj> $$6 = $$5.b();
                           List<anj> $$7 = $$6.stream().filter($$2xx -> !$$2xx.a($$3, $$4)).toList();
                           if (!$$7.isEmpty()) {
                              ...
                              JsonElement $$8 = (JsonElement)ank.a.encodeStart(JsonOps.INSTANCE, new ank($$6, false)).getOrThrow(false, d::error);
                              Path $$9 = this.e.a($$4x);
                              return ji.a($$0, $$8, $$9);
                           }
                        }
   ...
   protected my.b<T> b(anl<T> $$0) {
      ani $$1 = this.c($$0);
      return new my.b<>($$1);
   }

   protected ani c(anl<T> $$0) {
      return this.j.computeIfAbsent($$0.b(), $$0x -> ani.a());
   }
   ...
   protected static class b<T> {
      ...
      public my.b<T> a(acq $$0) {
         this.a.b($$0);
         return this;
      }

      public my.b<T> b(anl<T> $$0) {
         this.a.c($$0.b());
         return this;
      }

      public my.b<T> b(acq $$0) {
         this.a.d($$0);
         return this;
      }
   }
   ...
   public interface c<T> extends Function<anl<T>, Optional<ani>> {
      ...
      default boolean contains(anl<T> $$0) {
