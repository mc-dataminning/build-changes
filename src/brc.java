...
public interface brc<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements brc<brc.c> {
   ...
   public static final class b implements brc<Runnable> {
      private final Queue<Runnable> a;
