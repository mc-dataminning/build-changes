...
public class brc extends epd {
   private static final Logger a = LogUtils.getLogger();
   private final long b;
   private int c;
   private boolean d = true;
   private boolean e = true;
   private final Map<alf, brb> f = new Object2ObjectOpenHashMap();

   public static epd.a<brc> a(long $$0) {
      return new epd.a<>(() -> new brc($$0), ($$1, $$2) -> a($$0, $$1), bag.m);
   }
   ...
   private brb b(alf $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new brb($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<alf, brb> $$0) {
      this.f.forEach($$0);
   }
   ...
   public us a(us $$0, jk.a $$1) {
      ...
      us $$2 = new us();
      this.f.forEach(($$1x, $$2x) -> $$2.a($$1x.toString(), (vp)brb.a.encodeStart(vg.a, $$2x).result().orElseThrow()));
      $$0.a("sequences", $$2);
      return $$0;
   }
   ...
   public static brc a(long $$0, us $$1) {
      brc $$2 = new brc($$0);
      ...
      for (String $$5 : $$3.e()) {
         try {
            brb $$6 = (brb)((Pair)brb.a.decode(vg.a, $$3.c($$5)).result().get()).getFirst();
            $$2.f.put(new alf($$5), $$6);
   ...
   class a implements azh {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return $$0 instanceof brc.a $$1 ? this.c.equals($$1.c) : false;
         }
      }
   }
}
