...
public record dq(List<dq.c> c) {
   ...
   public <S extends eaj<?, S>> boolean a(eai<?, S> $$0, S $$1) {
      for (dq.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(eai<?, ?> $$0) {
      for (dq.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public dq.a a(ebk<?> $$0, String $$1) {
         this.a.add(new dq.c($$0.f(), new dq.b($$1)));
         return this;
      }

      public dq.a a(ebk<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public dq.a a(ebk<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & bak> dq.a a(ebk<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String e) implements dq.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(eaj<?, ?> $$0, ebk<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(eaj<?, ?> var1, ebk<T> var2);
   }
}
