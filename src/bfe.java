...
public abstract class bfe<R extends Runnable> implements bem, bfg<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bfe(String $$0) {
      this.b = $$0;
      bek.a.a(this);
   }
   ...
   @Override
   public List<bej> bl() {
      return ImmutableList.of(bej.a(this.b + "-pending-tasks", bei.b, this::bn));
   }
}
