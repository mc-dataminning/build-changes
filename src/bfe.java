...
public class bfe extends bbh {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfe::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfe::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfe::k);
         $$0 = this.a($$0, "minecraft:fox", bfe::j);
         $$0 = this.a($$0, "minecraft:item", bfe::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfe::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfe::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfe::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfe::e);
         return this.a($$0, "minecraft:piglin", bfe::d);
      });
   }
