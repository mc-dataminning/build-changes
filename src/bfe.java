...
public class bfe extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(bia.J));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(bia.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(bia.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(bia.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(bia.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(bia.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(bia.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(bia.s);
      Type<?> $$9 = this.getOutputSchema().getType(bia.s);
