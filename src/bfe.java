...
public class bfe {
   ...
   private bfe(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bfe a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bfe($$0, $$1);
   }

   public bfe.d a() throws IOException {
      bfe.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bfe.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bfe.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bfe.c $$3 = bfe.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bfe.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bfe.a($$0, $$3);
            }
         }
   ...
   public bfe.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bfe.c> $$2 = this.a().c();
      ...
      bfe.e $$4 = new bfe.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bfe.c b) implements bfe.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bfe.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bfe.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bfe.b> {
      private final List<bfe.b> a;

      d(List<bfe.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bfe.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bfe.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bfe.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bfe.d a() {
         ListIterator<bfe.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bfe.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bfe.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bfe.b> b() {
         return this.a.stream();
      }

      public Set<bfe.c> c() {
         return this.a.stream().map(bfe.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bfe.c b) implements bfe.b {
