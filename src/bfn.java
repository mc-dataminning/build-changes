...
public class bfn extends bbz {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfn::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfn::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfn::k);
         $$0 = this.a($$0, "minecraft:fox", bfn::j);
         $$0 = this.a($$0, "minecraft:item", bfn::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfn::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfn::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfn::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfn::e);
         return this.a($$0, "minecraft:piglin", bfn::d);
      });
   }
