...
public class fsx implements epm, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final epk c = new epk();
   private static final boolean d = true;
   private static fsx e;
   ...
   private final List<eps> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, eps> l = Maps.newHashMap();
   private final int m;
   ...
   public fsx(aqi $$0, String $$1) throws IOException {
      ahg $$2 = new ahg("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      aqg $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.p = a(aue.a($$5, "blend", null));
         this.s = a($$0, epp.a.a, $$6);
         this.t = a($$0, epp.a.b, $$7);
         this.m = epq.a();
         epq.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = eps.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static epn a(aqi $$0, epp.a $$1, String $$2) throws IOException {
      epp $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof epn)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         epn $$7;
         if ($$3 == null) {
            ahg $$4 = new ahg("shaders/program/" + $$2 + $$1.b());
            aqg $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static epl a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new epl();
      } else {
         int $$1 = 32774;
