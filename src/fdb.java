...
public class fdb extends fct {
   private static final Logger a = LogUtils.getLogger();
   private static final ahd b = new ahd("textures/misc/vignette.png");
   private static final vd c = vd.b("============").a(n.p);
   ...
   private int z;
   private final exp A = new exp(false);

   public fdb(boolean $$0, Runnable $$1) {
      super(eus.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fdb.a $$1) {
      try (Reader $$2 = this.f.Y().openAsReader(new ahd($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : aty.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(vd.b($$4).a(n.o), true);
         this.a(c, true);
         this.D();
         this.D();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(vd.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(vd.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.r.addAll(this.f.h.c(vd.b($$0), 256));
   }
