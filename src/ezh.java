...
public class ezh {
   ...
   public void a(far $$0, String $$1, fbn.a $$2, eox $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  ezh.b $$13 = new ezh.b($$1.trim(), this.f, $$3, $$2);
                  ezh.a $$14 = new ezh.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        ezh.c $$30 = new ezh.c(this.f, $$2, $$0);
                        ezh.a $$31 = new ezh.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fav(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eox $$2) throws IOException {
      ...
      File $$15 = new File(feb.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eox d;
      private final fbn.a e;

      b(String $$0, File $$1, eox $$2, fbn.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((ezh.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !ezh.this.b && !ezh.this.d) {
            try {
               ezh.this.e = true;
               ezh.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               ezh.a.error("Error extracting archive", var3);
               ezh.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fbn.a c;
      private final far d;

      c(File $$0, fbn.a $$1, far $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((ezh.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !ezh.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, ezh.this.g);
                  ezh.this.c = true;
               } else {
                  ezh.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  ezh.this.d = true;
               }
            } catch (IOException var3) {
               ezh.a.error("Error copying resourcepack file: {}", var3.getMessage());
               ezh.this.d = true;
            }
         }
      }
