...
public class ezh {
   ...
   public static final ezh.a bv;

   public static ezh.a a(int $$0, int $$1) {
      return $$0 == -1 ? ezh.b.b.a($$1) : ezh.b.a.a($$0);
   }

   public static ezh.a a(String $$0) {
      if (ezh.a.e.containsKey($$0)) {
         return ezh.a.e.get($$0);
      } else {
         for (ezh.b $$1 : ezh.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      static final Map<String, ezh.a> e = Maps.newHashMap();

      a(String $$0, ezh.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<ezh.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wu> g;

      private static void a(ezh.b $$0, String $$1, int $$2) {
         ezh.a $$3 = new ezh.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ezh.a a(int $$0) {
         return (ezh.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
