...
public final class ezh implements AutoCloseable {
   ...
   public ezh(int $$0, int $$1, boolean $$2) {
      this(ezh.a.a, $$0, $$1, $$2);
   }

   public ezh(ezh.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private ezh(ezh.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static ezh a(InputStream $$0) throws IOException {
      return a(ezh.a.a, $$0);
   }

   public static ezh a(@Nullable ezh.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ezh a(ByteBuffer $$0) throws IOException {
      return a(ezh.a.a, $$0);
   }

   public static ezh a(byte[] $$0) throws IOException {
   ...
   public static ezh a(@Nullable ezh.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new ezh($$0 == null ? ezh.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public ezh a(IntUnaryOperator $$0) {
      if (this.c != ezh.a.a) {
         ...
         this.j();
         ezh $$1 = new ezh(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fkn.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(ezh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ezh $$4) {
      this.j();
      if ($$4.c() != this.c) {
