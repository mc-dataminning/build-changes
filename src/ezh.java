...
public class ezh {
   ...
   public ezh(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ezi> $$1) throws IOException {
   ...
   public List<ezi> a(Path $$0) throws IOException {
      List<ezi> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ezi> a(Path $$0, boolean $$1) throws IOException {
      List<ezi> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ezi> $$1) throws IOException {
