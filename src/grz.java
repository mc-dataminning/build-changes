public abstract class grz extends grv {
   ...
   public void q() {
      ...
      if (!this.n.dK() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = ayy.i(ayy.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = ayy.i(ayy.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
