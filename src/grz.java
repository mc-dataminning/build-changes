...
public class grz {
   ...
   @VisibleForTesting
   static gru.b a(Vector3fc $$0, Vector3fc $$1, jb $$2) {
      return switch ($$2) {
         case a -> new gru.b($$0.x(), 16.0F - $$1.z(), $$1.x(), 16.0F - $$0.z());
         case b -> new gru.b($$0.x(), $$0.z(), $$1.x(), $$1.z());
         case c -> new gru.b(16.0F - $$1.x(), 16.0F - $$1.y(), 16.0F - $$0.x(), 16.0F - $$0.y());
         case d -> new gru.b($$0.x(), 16.0F - $$1.y(), $$1.x(), 16.0F - $$0.y());
         case e -> new gru.b($$0.z(), 16.0F - $$1.y(), $$1.z(), 16.0F - $$0.y());
         case f -> new gru.b(16.0F - $$1.z(), 16.0F - $$1.y(), 16.0F - $$0.z(), 16.0F - $$0.y());
      };
   }

   public static grs a(Vector3fc $$0, Vector3fc $$1, gru $$2, hjk $$3, jb $$4, hly $$5, @Nullable grv $$6, boolean $$7, int $$8) {
      gru.b $$9 = $$2.d();
      if ($$9 == null) {
         $$9 = a($$0, $$1, $$4);
      }
      ...
      return new grs($$11, $$2.b(), $$12, $$3, $$7, $$8);
   }

   private static gru.b a(hjk $$0, gru.b $$1) {
      float $$2 = $$1.a();
      float $$3 = $$1.b();
      float $$4 = $$1.c();
      float $$5 = $$1.d();
      ...
      return new gru.b(azm.h($$6, $$2, $$7), azm.h($$6, $$3, $$8), azm.h($$6, $$4, $$7), azm.h($$6, $$5, $$8));
   }

   private static int[] a(gru.b $$0, i $$1, Matrix4fc $$2, hjk $$3, jb $$4, float[] $$5, k $$6, @Nullable grv $$7) {
      gpz $$8 = gpz.a($$4);
      int[] $$9 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, gpz $$2, gru.b $$3, i $$4, Matrix4fc $$5, float[] $$6, hjk $$7, k $$8, @Nullable grv $$9) {
      gpz.b $$10 = $$2.a($$1);
      Vector3f $$11 = new Vector3f($$6[$$10.a], $$6[$$10.b], $$6[$$10.c]);
      a($$11, $$9);
      a($$11, $$8);
      float $$12 = gru.a($$3, $$4, $$1);
      float $$13 = gru.b($$3, $$4, $$1);
      float $$15;
      float $$14;
      if (f.a($$5)) {
         $$14 = $$12;
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hjk $$3, float $$4, float $$5) {
      int $$6 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable grv $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
