...
public class fzq extends ful {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<aku<dgi>> b = af.a(new Reference2IntOpenHashMap(), $$0 -> {
   ...
   @Nullable
   public static fzq a(flj $$0, BooleanConsumer $$1, DataFixer $$2, evf.c $$3, boolean $$4) {
      try {
         fzx $$5 = $$0.x();
         aua $$6 = aud.a($$3);
   ...
   private fzq(BooleanConsumer $$0, DataFixer $$1, evf.c $$2, dgm $$3, boolean $$4, kf $$5) {
