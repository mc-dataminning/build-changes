...
public class fzq implements fze.a {
   private final exo a;
   private double b = Double.MIN_VALUE;
   private List<bnq> c = Collections.emptyList();
   ...
   private void a(esh $$0, fvt $$1, double $$2, double $$3, double $$4, bnq $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aC.ifPresent($$10 -> {
   ...
   private void a(hz $$0, esh $$1, double $$2, double $$3, double $$4, fvt $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      fvr.a($$1, $$5.getBuffer(fwb.w()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      fvr.a(
         $$1,
         $$5.getBuffer(fwb.w()),
         this.a.r.a_($$0).b(this.a.r, $$0, eoe.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
