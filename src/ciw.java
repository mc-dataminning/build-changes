...
public class ciw {
   ...
   private int g = axk.b(axr.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jf.a.fieldOf("uuid").forGetter(Pair::getFirst), aws.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bpv> j;
   @VisibleForTesting
   protected final ArrayList<bpv> c;
   private final ciw.a k;
   @VisibleForTesting
   protected final Object2IntMap<bpv> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<ciw> a(Predicate<bpv> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(ciw::b)).apply($$1, $$1x -> new ciw($$0, $$1x))
      );
   }

   public ciw(Predicate<bpv> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new ciw.a(this);
   ...
   public void a(aps $$0, Predicate<bpv> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bpv>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bpv> $$6 = (Entry<bpv>)$$5.next();
         int $$7 = $$6.getIntValue();
         bpv $$8 = (bpv)$$6.getKey();
         bpv.c $$9 = $$8.dI();
   ...
   public int b(@Nullable bpv $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bqo> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bqo).map($$0 -> (bqo)$$0);
   }

   @VisibleForTesting
   protected static record a(ciw a) implements Comparator<bpv> {
      public int a(bpv $$0, bpv $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cjt;
               boolean $$7 = $$1 instanceof cjt;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
