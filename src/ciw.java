...
public final class ciw {
   public static final Codec<ciw> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               kf.a(mb.aH).fieldOf("biomes").forGetter(ciw::d)
            )
            .apply($$0, ciw::new)
   );
   public static final zt<xg, ciw> b = zt.a(alz.b, ciw::a, alz.b, ciw::b, alz.b, ciw::c, zr.c(mb.aH), ciw::d, ciw::new);
   public static final Codec<jq<ciw>> c = alv.a(mb.m, a);
   public static final zt<xg, jq<ciw>> d = zr.a(mb.m, b);
   private final alz e;
   private final alz f;
   private final alz g;
   private final alz h;
   private final alz i;
   private final alz j;
   private final ju<dic> k;

   public ciw(alz $$0, alz $$1, alz $$2, ju<dic> $$3) {
      this.e = $$0;
      this.h = a($$0);
      this.f = $$1;
      this.i = a($$1);
