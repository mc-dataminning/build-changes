...
public class fel implements AutoCloseable {
   ...
   public fel(fej $$0, fek $$1, ByteBuffer $$2) {
   ...
   public fel.a a(int $$0, int $$1) {
      if (this.f) {
         ...
         return $$2 == null ? null : new fel.a(this.d.h, $$2);
      }
   }
