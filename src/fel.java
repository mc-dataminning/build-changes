...
public class fel {
   ...
   private static final Queue<fel.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fel.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fel::a), fei::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fel::a), fei::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fel.a(this.b) + ", type=" + fel.b(this.c) + ", severity=" + fel.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
