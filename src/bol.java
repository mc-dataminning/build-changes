...
public class bol implements bom {
   ...
   private static final bol k = new bol();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bok $$0) {
      URL $$1 = bol.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bok $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final boo a = new boo(() -> bol.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bol.this.l && $$0.getState() == RecordingState.STOPPED) {
