...
public class bol extends bop {
   public static final Codec<bol> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bol a(float $$0, float $$1, float $$2, float $$3) {
      return new bol($$0, $$1, $$2, $$3);
   }

   private bol(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(ayg $$0, float $$1, float $$2, float $$3, float $$4) {
      return axz.a(axz.c($$0, $$1, $$2), $$3, $$4);
   }
