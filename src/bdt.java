...
public class bdt extends bal {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdt::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdt::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdt::k);
         $$0 = this.a($$0, "minecraft:fox", bdt::j);
         $$0 = this.a($$0, "minecraft:item", bdt::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdt::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdt::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdt::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdt::e);
         return this.a($$0, "minecraft:piglin", bdt::d);
      });
   }
