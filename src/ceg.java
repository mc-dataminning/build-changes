...
public abstract class ceg {
   ...
   private final hp<cja> l = hp.a();
   public final hp<cfy> i = hp.a();
   private final List<cew> m = Lists.newArrayList();
   private cja n = cja.b;
   private final hp<cja> o = hp.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cfy> v = Sets.newHashSet();
   private final List<ces> w = Lists.newArrayList();
   @Nullable
   private cet x;
   private boolean y;

   protected ceg(@Nullable cfl<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cer $$0, cbp $$1, csq $$2) {
   ...
   protected static void a(bgm $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(ceq $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cew a(cew $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(ceq $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cew.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cja $$1 = this.i.get($$0).e();
         Supplier<cja> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cja $$1, Supplier<cja> $$2) {
      cja $$3 = this.l.get($$0);
      if (!cja.a($$3, $$1)) {
         cja $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cja $$1, Supplier<cja> $$2) {
      if (!this.y) {
         cja $$3 = this.o.get($$0);
         if (!cja.a($$3, $$1)) {
            cja $$4 = $$2.get();
   ...
   public abstract cja a(cbp var1, int var2);

   public void a(int $$0, int $$1, cep $$2, cbp $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
      } catch (Exception var8) {
         o $$5 = o.a(var8, "Container click");
         p $$6 = $$5.a("Click info");
         $$6.a("Menu Type", () -> this.s != null ? jd.s.b(this.s).toString() : "<no type>");
   ...
   private void b(int $$0, int $$1, cep $$2, cbp $$3) {
      cbo $$4 = $$3.fQ();
      if ($$2 == cep.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cep.a || $$2 == cep.b) && ($$1 == 0 || $$1 == 1)) {
         ceo $$16 = $$1 == 0 ? ceo.a : ceo.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == ceo.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == ceo.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == ceo.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<cja> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cja> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cep.d && $$3.fR().d && this.g().b() && $$0 >= 0) {
         cfy $$32 = this.i.get($$0);
         if ($$32.f()) {
            cja $$33 = $$32.e();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == cep.e && this.g().b() && $$0 >= 0) {
         cfy $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.e().L();
         cja $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cep.g && $$0 >= 0) {
         cfy $$37 = this.i.get($$0);
         cja $$38 = this.g();
         if (!$$38.b() && (!$$37.f() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.L() < $$38.g(); $$42 += $$40) {
                  cfy $$43 = this.i.get($$42);
                  if ($$43.f() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cja $$44 = $$43.e();
                     if ($$41 != 0 || $$44.L() != $$44.g()) {
                        cja $$45 = $$43.b($$44.L(), $$38.g() - $$38.L(), $$3);
                        $$38.g($$45.L());
                     }
                  }
               }
   ...
   private boolean a(cbp $$0, ceo $$1, cfy $$2, cja $$3, cja $$4) {
      cdx $$5 = $$0.dK().G();
   ...
   public void a(int $$0, int $$1, cja $$2) {
      this.b($$0).e($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cja> $$1, cja $$2) {
   ...
   public abstract boolean a(cbp var1);

   protected boolean a(cja $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cbp $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cfy $$0, cja $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.f();
      return !$$3 && cja.c($$1, $$0.e()) ? $$0.e().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }

   public static int a(Set<cfy> $$0, int $$1, cja $$2) {
      return switch ($$1) {
         case 0 -> ars.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
   ...
   public static int a(@Nullable dcq $$0) {
      return $$0 instanceof bgm ? b((bgm)$$0) : 0;
   }

   public static int b(@Nullable bgm $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(ceg $$0) {
      Table<bgm, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bgm $$0, int $$1) {
