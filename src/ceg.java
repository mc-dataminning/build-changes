...
public abstract class ceg extends brq {
   protected static final int ca = 6000;
   private int bY;
   @Nullable
   private UUID bZ;

   protected ceg(bsc<? extends ceg> $$0, daz $$1) {
      super($$0, $$1);
      this.a(enn.n, 16.0F);
      this.a(enn.o, -1.0F);
   }
   ...
   public float a(io $$0, dbc $$1) {
      return $$1.a_($$0.d()).a(dec.i) ? 10.0F : $$1.w($$0);
   }
   ...
   public static boolean b(bsc<? extends ceg> $$0, dba $$1, bsu $$2, io $$3, aym $$4) {
      boolean $$5 = bsu.b($$2) || a($$1, $$3);
      return $$1.a_($$3.d()).a(avx.bW) && $$5;
   }

   protected static boolean a(dac $$0, io $$1) {
      return $$0.b($$1, 0) > 8;
   }
   ...
   public abstract boolean o(ctq var1);
   ...
   public aqo gs() {
      if (this.bZ == null) {
         ...
         cly $$0 = this.dP().b(this.bZ);
         return $$0 instanceof aqo ? (aqo)$$0 : null;
      }
   }
   ...
   public void a(aqn $$0, ceg $$1, @Nullable brq $$2) {
      ...
      $$0.a(this, (byte)18);
      if ($$0.aa().b(dav.f)) {
         $$0.b(new bsg($$0, this.du(), this.dw(), this.dA(), this.el().a(7) + 1));
      }
   }
