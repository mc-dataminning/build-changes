...
public class fek {
   ...
   private static final Queue<fek.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fek.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fek::a), feh::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fek::a), feh::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fek.a(this.b) + ", type=" + fek.b(this.c) + ", severity=" + fek.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
