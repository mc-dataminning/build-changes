...
public class fek {
   ...
   public static List<fek.a> a(String $$0, fek.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fek.a> a(String $$0, List<fek.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fek.a> a(List<String> $$0, List<fek.b> $$1) {
      int $$2 = 0;
      List<fek.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fek.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fek.b a(String $$0, String $$1) {
         return new fek.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fek.b a(String $$0) {
         return new fek.b($$0);
      }
   }
}
