...
public class fek {
   ...
   public static void a(File $$0, exe $$1, Consumer<wx> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, exe $$2, Consumer<wx> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, exe $$2, Consumer<wx> $$3) {
      ext $$4 = a($$2);
   ...
   public static ext a(exe $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ext $$3 = new ext($$1, $$2, false);
   ...
   public fek(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
