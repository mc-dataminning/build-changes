...
public class fni {
   ...
   public static List<fni.a> a(String $$0, fni.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fni.a> a(String $$0, List<fni.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fni.a> a(List<String> $$0, List<fni.b> $$1) {
      int $$2 = 0;
      List<fni.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fni.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fni.b a(String $$0, String $$1) {
         return new fni.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fni.b a(String $$0) {
         return new fni.b($$0);
      }
   }
}
