...
public enum fni implements fbc {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fce a(int $$0, int $$1, fni.a $$2) {
      fce $$3 = new fce(fce.a.a, $$0, $$1, false);
   ...
   private fni(final Supplier<fce> $$0) {
      this.c = $$0.get();
   }
