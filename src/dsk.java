...
public class dsk {
   ...
   private final Map<Character, Predicate<dsi>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsk a(char $$0, Predicate<dsi> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dsi>[][][] c() {
      this.d();
      Predicate<dsi>[][][] $$0 = (Predicate<dsi>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsi>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
