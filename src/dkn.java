...
public class dkn {
   public static <T> List<dkn.b> a(List<T> $$0, Function<T, List<ji<eqf>>> $$1, boolean $$2) {
      Object2IntMap<eqf> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eqf c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<ji<eqf>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (je<eqf> $$12 : $$10.get($$11)) {
               eqf $$13 = $$12.a();
      ...
      Builder<dkn.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eqf> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dkn.b($$28));
      }
   ...
   public static record b(List<eqf> a, ToIntFunction<eqf> b) {
      b(List<eqf> $$0) {
         this($$0, af.h($$0));
      }
   }
