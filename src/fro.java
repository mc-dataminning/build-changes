...
public class fro extends fnf {
   ...
   private final fkt L = new fkt(this);
   @Nullable
   private final fnf M;
   frn N;
   fhp O;
   private String P = "";
   private fro.a Q = fro.a.a;
   private fhg R;
   private fhg S;
   private fhg T;
   private fhg U;
   ...
   protected void aM_() {
      ...
      if (this.X) {
         ...
         this.N = new frn(this, this.m, this.n, this.m(), 88, 36);
      }

      int $$0 = this.N.b() / 3;
      int $$1 = this.N.r();
      int $$2 = this.N.s();
      this.R = this.c(fhg.a(s, $$0x -> this.a(fro.a.a)).a($$1, 45, $$0, 20).a());
      this.S = this.c(fhg.a(u, $$0x -> this.a(fro.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.T = this.c(fhg.a(v, $$0x -> this.a(fro.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.O != null ? this.O.a() : "";
      this.O = new fhp(this.p, this.F() + 28, 74, 200, 15, z) {
         @Override
         protected yd aJ_() {
            return !fro.this.O.a().isEmpty() && fro.this.N.c() ? super.aJ_().f(", ").b(fro.A) : super.aJ_();
         }
      };
      this.O.f(16);
      this.O.g(true);
      ...
      this.c(this.O);
      this.d(this.N);
      this.U = this.c(fhg.a(D, flw.b(this, "https://aka.ms/javablocking")).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.X = true;
      this.a(this.Q);
      this.L.b(fhg.a(xo.d, $$0x -> this.d()).a(200).a());
      this.L.a($$1x -> {
