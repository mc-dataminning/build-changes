...
public class fro {
   ...
   public void a(fro.a $$0, Matrix4f $$1, ffy $$2, int $$3) {
      if ($$0.i()) {
   ...
   private void a(fro.a $$0, float $$1, float $$2, int $$3, ffy $$4, int $$5, Matrix4f $$6) {
   ...
   public static record b(float a, float b, int c, int d, fro e, xl f, float g, float h) {
      boolean i() {
         return this.d() != 0;
      }
   }
