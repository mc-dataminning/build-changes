...
public enum fro implements fdq {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fes a(int $$0, int $$1, fro.a $$2) {
      fes $$3 = new fes(fes.a.a, $$0, $$1, false);
   ...
   private fro(final Supplier<fes> $$0) {
      this.c = $$0.get();
   }
