...
public abstract class fro<B extends fzo.a<?>> extends fnj {
   ...
   protected final fnj v;
   protected final fzs w;
   protected B x;

   protected fro(wu $$0, fnj $$1, fzs $$2, B $$3) {
      super($$0);
      this.v = $$1;
      this.w = $$2;
      this.x = $$3;
   ...
   protected fik a(int $$0, int $$1, Consumer<String> $$2) {
      AbuseReportLimits $$3 = this.w.a().b();
      fik $$4 = new fik(this.o, 0, 0, $$0, $$1, D, E);
      $$4.a(this.x.g());
   ...
   private void E() {
      this.G();
      this.l.a(fmv.a(A, y, wt.d, () -> this.l.a(null)));
   }
   ...
   private void a(wu $$0) {
      wu $$1 = $$0.f().a(n.m);
      this.l.a(fmv.a(B, $$1, wt.k, () -> this.l.a(this)));
   }
