...
public class aho {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ti.c("commands.particle.failed"));
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("particle").requires($$0x -> $$0x.c(2)))
            .then(
               ((RequiredArgumentBuilder)du.a("name", eo.a($$1))
                     .executes(
                        $$0x -> a(
                              (dt)$$0x.getSource(), eo.a($$0x, "name"), ((dt)$$0x.getSource()).d(), ehi.b, 0.0F, 0, false, ((dt)$$0x.getSource()).l().ac().t()
                           )
                     ))
                  .then(
                     ((RequiredArgumentBuilder)du.a("pos", fr.a())
                           .executes(
                              $$0x -> a((dt)$$0x.getSource(), eo.a($$0x, "name"), fr.a($$0x, "pos"), ehi.b, 0.0F, 0, false, ((dt)$$0x.getSource()).l().ac().t())
                           ))
                        .then(
   ...
   private static int a(dt $$0, iv $$1, ehi $$2, ehi $$3, float $$4, int $$5, boolean $$6, Collection<ako> $$7) throws CommandSyntaxException {
      int $$8 = 0;
      ...
      if ($$8 == 0) {
         ...
         $$0.a(() -> ti.a("commands.particle.success", jd.k.b($$1.b()).toString()), true);
         return $$8;
      }
   }
}
