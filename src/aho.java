...
public class aho {
   ...
   private static bmi a(bkq $$0, ib<bmh> $$1) throws CommandSyntaxException {
      bmi $$2 = a($$0).eS().a($$1);
      if ($$2 == null) {
   ...
   private static blg a(bkq $$0) throws CommandSyntaxException {
      if (!($$0 instanceof blg)) {
         throw a.create($$0.ad());
      } else {
         return (blg)$$0;
   ...
   private static blg b(bkq $$0, ib<bmh> $$1) throws CommandSyntaxException {
      blg $$2 = a($$0);
      if (!$$2.eS().b($$1)) {
         throw b.create($$0.ad(), a($$1));
      } else {
   ...
   private static int a(du $$0, bkq $$1, ib<bmh> $$2, double $$3) throws CommandSyntaxException {
      blg $$4 = b($$1, $$2);
      double $$5 = $$4.a($$2);
      $$0.a(() -> ur.a("commands.attribute.value.get.success", a($$2), $$1.ad(), $$5), false);
      return (int)($$5 * $$3);
   }

   private static int b(du $$0, bkq $$1, ib<bmh> $$2, double $$3) throws CommandSyntaxException {
      blg $$4 = b($$1, $$2);
      double $$5 = $$4.b($$2);
      $$0.a(() -> ur.a("commands.attribute.base_value.get.success", a($$2), $$1.ad(), $$5), false);
      return (int)($$5 * $$3);
   }

   private static int a(du $$0, bkq $$1, ib<bmh> $$2, UUID $$3, double $$4) throws CommandSyntaxException {
      blg $$5 = b($$1, $$2);
      bmj $$6 = $$5.eS();
      if (!$$6.a($$2, $$3)) {
         ...
         double $$7 = $$6.b($$2, $$3);
         $$0.a(() -> ur.a("commands.attribute.modifier.value.get.success", ur.a($$3), a($$2), $$1.ad(), $$7), false);
         return (int)($$7 * $$4);
      }
   }

   private static int c(du $$0, bkq $$1, ib<bmh> $$2, double $$3) throws CommandSyntaxException {
      a($$1, $$2).a($$3);
      $$0.a(() -> ur.a("commands.attribute.base_value.set.success", a($$2), $$1.ad(), $$3), false);
      return 1;
   }

   private static int a(du $$0, bkq $$1, ib<bmh> $$2, UUID $$3, String $$4, double $$5, bmk.a $$6) throws CommandSyntaxException {
      bmi $$7 = a($$1, $$2);
      bmk $$8 = new bmk($$3, $$4, $$5, $$6);
      if ($$7.a($$8)) {
         throw d.create($$1.ad(), a($$2), $$3);
      } else {
         $$7.c($$8);
         $$0.a(() -> ur.a("commands.attribute.modifier.add.success", ur.a($$3), a($$2), $$1.ad()), false);
         return 1;
      }
   }

   private static int a(du $$0, bkq $$1, ib<bmh> $$2, UUID $$3) throws CommandSyntaxException {
      bmi $$4 = a($$1, $$2);
      if ($$4.c($$3)) {
         $$0.a(() -> ur.a("commands.attribute.modifier.remove.success", ur.a($$3), a($$2), $$1.ad()), false);
         return 1;
      } else {
         throw c.create($$1.ad(), a($$2), $$3);
      }
