...
public class em implements ArgumentType<em.g> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vq.c("arguments.nbtpath.node.invalid"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vq.c("arguments.nbtpath.too_deep"));
   public static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> vq.b("arguments.nbtpath.nothing_found", $$0));
   static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> vq.b("commands.data.modify.expected_list", $$0));
   static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> vq.b("commands.data.modify.invalid_index", $$0));
   ...
   static Predicate<tt> a(sw $$0) {
      return $$1 -> tl.a($$0, $$1, true);
   }
   ...
   static class a implements em.h {
      ...
      @Override
      public void a(tt $$0, Supplier<tt> $$1, List<tt> $$2) {
         if ($$0 instanceof sv<?> $$3) {
            if ($$3.isEmpty()) {
               tt $$4 = $$1.get();
               if ($$3.b(0, $$4)) {
                  $$2.add($$4);
               ...
               $$2.addAll((Collection<? extends tt>)$$3);
            }
         }
      }
      ...
      @Override
      public int a(tt $$0, Supplier<tt> $$1) {
         if (!($$0 instanceof sv<?> $$2)) {
            return 0;
         } else {
            int $$3 = $$2.size();
            if ($$3 == 0) {
   ...
   static class b implements em.h {
      ...
      @Override
      public int a(tt $$0) {
         if ($$0 instanceof sw $$1 && $$1.e(this.a)) {
            $$1.r(this.a);
            return 1;
         }
   ...
   static class e implements em.h {
      private final String a;
      private final sw b;
      private final Predicate<tt> c;

      public e(String $$0, sw $$1) {
         this.a = $$0;
         this.b = $$1;
         this.c = em.a($$1);
      }
   ...
   static class f implements em.h {
      ...
      @Override
      public void a(tt $$0, List<tt> $$1) {
         if ($$0 instanceof sw && this.a.test($$0)) {
            $$1.add($$0);
         }
      }
   ...
   public static class g {
      ...
      public List<tt> a(tt $$0) throws CommandSyntaxException {
         List<tt> $$1 = Collections.singletonList($$0);
      ...
      private List<tt> d(tt $$0) throws CommandSyntaxException {
         List<tt> $$1 = Collections.singletonList($$0);
      ...
      public List<tt> a(tt $$0, Supplier<tt> $$1) throws CommandSyntaxException {
         List<tt> $$2 = this.d($$0);
         em.h $$3 = this.c[this.c.length - 1];
         return $$3.a($$2, $$1);
      }

      private static int a(List<tt> $$0, Function<tt, Integer> $$1) {
         return $$0.stream().map($$1).reduce(0, ($$0x, $$1x) -> $$0x + $$1x);
      }

      public static boolean a(tt $$0, int $$1) {
         if ($$1 >= 512) {
            return true;
         } else {
            if ($$0 instanceof sw $$2) {
      ...
      public int a(tt $$0, tt $$1) throws CommandSyntaxException {
         if (a($$1, this.b())) {
            throw em.b.create();
         } else {
            tt $$2 = $$1.d();
      ...
      public int a(int $$0, sw $$1, List<tt> $$2) throws CommandSyntaxException {
         List<tt> $$3 = new ArrayList<>($$2.size());
         ...
         Collection<tt> $$6 = this.a($$1, tc::new);
         int $$7 = 0;
         boolean $$8 = false;

         for (tt $$9 : $$6) {
            if (!($$9 instanceof sv<?> $$10)) {
               throw em.e.create($$9);
            }
   ...
   interface h {
      void a(tt var1, List<tt> var2);

      void a(tt var1, Supplier<tt> var2, List<tt> var3);

      tt a();

      int a(tt var1, Supplier<tt> var2);

      int a(tt var1);

      default List<tt> a(List<tt> $$0) {
         return this.a($$0, this::a);
      }

      default List<tt> a(List<tt> $$0, Supplier<tt> $$1) {
         return this.a($$0, ($$1x, $$2) -> this.a($$1x, $$1, $$2));
      }

      default List<tt> a(List<tt> $$0, BiConsumer<tt, List<tt>> $$1) {
         List<tt> $$2 = Lists.newArrayList();
