...
public class em implements ArgumentType<it> {
   ...
   public static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> tf.a("particle.notFound", $$0));
   ...
   public static em a(dl $$0) {
      return new em($$0);
   }

   public static it a(CommandContext<dr> $$0, String $$1) {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return du.a(this.c.c().map(aeq::a), $$1);
   }
}
