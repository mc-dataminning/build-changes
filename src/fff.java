public class fff extends ffh<byz> {
   ...
   public void a(byz $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$8 != null) {
         ...
         ehi $$12 = $$0.f(0.0F);
         $$12 = new ehi($$12.c, 0.0, $$12.e);
         ehi $$13 = new ehi($$10.c - $$9.c, 0.0, $$10.e - $$9.e).d().b((float) (Math.PI / 2));
         double $$14 = $$12.b($$13);
         this.p.b = ars.c((float)Math.abs($$14)) * 2.0F * (float)Math.signum($$14);
      }

      this.p.k = true;
      float $$15 = $$0.E($$6);
      this.r[0].f = ars.a($$15) * (float) Math.PI * 0.05F;
      this.r[1].f = ars.a($$15) * (float) Math.PI * 0.1F;
      this.r[2].f = ars.a($$15) * (float) Math.PI * 0.15F;
   }
   ...
   private static float a(int $$0, float $$1, float $$2) {
      return 1.0F + ars.b($$1 * 1.5F + (float)$$0) * 0.01F - $$2;
   }
