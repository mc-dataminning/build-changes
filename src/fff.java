...
public class fff {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.cz.d("gamemode " + ((dbw)MoreObjects.firstNonNull(this.b.q.i(), dbw.b)).b());
               }
   ...
   private void a(dsd $$0, iz $$1, @Nullable us $$2) {
   ...
   private void a(alf $$0, evs $$1, @Nullable us $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = eyu.a(ffg.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!eyu.a(ffg.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eyu.a(ffg.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.c();
            this.e = ac.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fnx) || ((fnx)$$6).r <= ac.c() - 20L)) {
            if (this.b.m.Q.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.N.a($$1, $$2)) {
               ...
               ffq.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aG_() instanceof fho) || !((fho)$$6.aG_()).c();
            if ($$7) {
               if (fne.s() && $$1 == 66 && this.b.aX().a() && this.b.m.u().c()) {
                  boolean $$8 = this.b.m.as().c() == ffi.a;
                  this.b.m.as().a(ffi.a(this.b.m.as().c().a() + 1));
                  this.b.m.av();
                  if ($$6 instanceof fng) {
                     ((fng)$$6).E();
                  }
         ...
         label187: {
            ...
            label147:
            if (!$$11) {
               if (this.b.y instanceof fmz $$12 && !$$12.m()) {
                  break label147;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fne.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fne.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
