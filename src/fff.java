...
public class fff<T extends bvb> extends feb<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.gd()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = arx.b(this.n * 0.4662F) * 0.1F;
         this.g.e = arx.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = arx.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = arx.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
