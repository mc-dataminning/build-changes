...
public class fff extends fds<cjt> {
   private static final ahd x = new ahd("container/stonecutter/scroller");
   private static final ahd y = new ahd("container/stonecutter/scroller_disabled");
   private static final ahd z = new ahd("container/stonecutter/recipe_selected");
   private static final ahd A = new ahd("container/stonecutter/recipe_highlighted");
   private static final ahd B = new ahd("container/stonecutter/recipe");
   private static final ahd C = new ahd("textures/gui/container/stonecutter.png");
   ...
   private void b(ewm $$0, int $$1, int $$2, int $$3) {
      List<cpx<cqp>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.H()) {
         ...
         this.M = aui.a(this.M - $$5, 0.0F, 1.0F);
