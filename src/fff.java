...
public class fff extends hct {
   ...
   public void aT_() {
      this.C.a(a, this.p);
      this.D = this.C.c(new fff.a(this.m));
   ...
   private xd a(String $$0) {
      try {
         return fgb.a.get(Integer.parseInt($$0)).b();
   ...
   private xd b(String $$0) {
      try {
         return fgb.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends fkw<fff.b> {
      public a(final fib $$0) {
         super($$0, fff.this.n, fff.this.C.d(), fff.this.C.c(), 36);
         if (fff.this.B.e != null) {
            fff.this.B.e.forEach(($$0x, $$1) -> this.b(fff.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends fkw.a<fff.b> {
      ...
      public void a(fjn $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fff.this.p, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(fff.this.p, fff.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
