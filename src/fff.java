...
public class fff {
      ...
      if ($$0 == this.a.aO().i()) {
         ...
         if (this.a.aL() == null) {
            if (this.a.y == null) {
               ...
               if ($$4) {
                  $$9.x();
                  fnc.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  fnc.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }
            ...
            if (this.a.y != null) {
               ...
               if (this.a.s.N_()) {
                  if (this.a.l.g().a()) {
                     ...
                     float $$12 = ayy.a(this.a.s.gd().a() + (float)$$10 * 0.005F, 0.0F, 0.2F);
                     this.a.s.gd().a($$12);
                  }
               } else {
   ...
   public void a() {
      ...
      if (this.a.aB()) {
         ...
         if ($$2 != null && this.a.aL() == null && (this.n != 0.0 || this.o != 0.0)) {
            ...
            fnc.a(() -> $$2.f($$3, $$4), "mouseMoved event handler", $$2.getClass().getCanonicalName());
            if (this.h != -1 && this.k > 0.0) {
               ...
               fnc.a(() -> $$2.a($$3, $$4, this.h, $$5, $$6), "mouseDragged event handler", $$2.getClass().getCanonicalName());
            }
   ...
   public void i() {
      if (this.a.aB()) {
         if (!this.s) {
            ...
            eys.a(this.a.aO().i(), 212995, this.e, this.f);
            this.a.a(null);
            this.a.w = 10000;
            this.i = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.e = (double)(this.a.aO().m() / 2);
         this.f = (double)(this.a.aO().n() / 2);
         eys.a(this.a.aO().i(), 212993, this.e, this.f);
      }
   }
