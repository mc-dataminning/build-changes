...
public class enq {
   ...
   static class a implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         return $$0.c[jk.f.d()] && !$$0.b[jk.f.d()].d;
      }

      @Override
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         $$1.d = true;
         $$1.b[jk.f.d()].d = true;
         return new enq.k($$0, $$1);
      }
   }

   static class b implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         if ($$0.c[jk.f.d()] && !$$0.b[jk.f.d()].d && $$0.c[jk.b.d()] && !$$0.b[jk.b.d()].d) {
            enq.v $$1 = $$0.b[jk.f.d()];
            return $$1.c[jk.b.d()] && !$$1.b[jk.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         ...
         $$1.b[jk.f.d()].d = true;
         $$1.b[jk.b.d()].d = true;
         $$1.b[jk.f.d()].b[jk.b.d()].d = true;
         return new enq.l($$0, $$1);
      }
   }

   static class c implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         return $$0.c[jk.b.d()] && !$$0.b[jk.b.d()].d;
      }
      ...
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         $$1.d = true;
         $$1.b[jk.b.d()].d = true;
         return new enq.m($$0, $$1);
      }
   }

   static class d implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         if ($$0.c[jk.c.d()] && !$$0.b[jk.c.d()].d && $$0.c[jk.b.d()] && !$$0.b[jk.b.d()].d) {
            enq.v $$1 = $$0.b[jk.c.d()];
            return $$1.c[jk.b.d()] && !$$1.b[jk.b.d()].d;
         } else {
            return false;
      ...
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         ...
         $$1.b[jk.c.d()].d = true;
         $$1.b[jk.b.d()].d = true;
         $$1.b[jk.c.d()].b[jk.b.d()].d = true;
         return new enq.n($$0, $$1);
      }
   }

   static class e implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         return $$0.c[jk.c.d()] && !$$0.b[jk.c.d()].d;
      }

      @Override
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         enq.v $$3 = $$1;
         if (!$$1.c[jk.c.d()] || $$1.b[jk.c.d()].d) {
            $$3 = $$1.b[jk.d.d()];
         }

         $$3.d = true;
         $$3.b[jk.c.d()].d = true;
         return new enq.o($$0, $$3);
      }
   }

   static class f implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         return true;
      }
      ...
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         $$1.d = true;
         return new enq.s($$0, $$1, $$2);
      }
   }

   static class g implements enq.i {
      @Override
      public boolean a(enq.v $$0) {
         return !$$0.c[jk.e.d()] && !$$0.c[jk.f.d()] && !$$0.c[jk.c.d()] && !$$0.c[jk.d.d()] && !$$0.c[jk.b.d()];
      }

      @Override
      public enq.r a(jk $$0, enq.v $$1, azn $$2) {
         $$1.d = true;
         return new enq.t($$0, $$1);
      }
   }

   public static class h extends enq.r {
      ...
      private enq.v G;
      private enq.v H;
      private final List<enq.r> I = Lists.newArrayList();

      public h(azn $$0, int $$1, int $$2, jk $$3) {
         super(elx.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<enq.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new enq.p($$3, this.G));
         this.I.add(new enq.j($$3, this.H));
         List<enq.i> $$5 = Lists.newArrayList();
         $$5.add(new enq.b());
         $$5.add(new enq.d());
         $$5.add(new enq.e());
         $$5.add(new enq.a());
         ...
         eky $$10 = eky.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eky $$11 = eky.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eky $$12 = eky.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new enq.u($$3, $$10, $$13++));
         this.I.add(new enq.u($$3, $$11, $$13++));
         this.I.add(new enq.q($$3, $$12));
      }
      ...
      private List<enq.v> b(azn $$0) {
         enq.v[] $$1 = new enq.v[75];
         ...
         enq.v $$23 = new enq.v(1003);
         enq.v $$24 = new enq.v(1001);
         enq.v $$25 = new enq.v(1002);
         $$1[v].a(jk.b, $$23);
         $$1[w].a(jk.d, $$24);
         $$1[x].a(jk.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jk.f.d()].d = true;
         this.H.b[jk.c.d()].d = true;
         this.H.b[jk.f.d()].b[jk.c.d()].d = true;
         this.H.b[jk.b.d()].d = true;
         this.H.b[jk.f.d()].b[jk.b.d()].d = true;
         this.H.b[jk.c.d()].b[jk.b.d()].d = true;
         this.H.b[jk.f.d()].b[jk.c.d()].b[jk.b.d()].d = true;
         ObjectArrayList<enq.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dfg $$2, azn $$3, eky $$4) {
         int $$5 = 24;
      ...
      private void a(dfg $$0, azn $$1, eky $$2) {
      ...
      private void b(dfg $$0, azn $$1, eky $$2) {
      ...
      private void c(dfg $$0, azn $$1, eky $$2) {
      ...
      private void d(dfg $$0, azn $$1, eky $$2) {
      ...
      private void e(dfg $$0, azn $$1, eky $$2) {
      ...
      private void f(dfg $$0, azn $$1, eky $$2) {
   ...
   interface i {
      boolean a(enq.v var1);

      enq.r a(jk var1, enq.v var2, azn var3);
   }

   public static class j extends enq.r {
      public j(jk $$0, enq.v $$1) {
         super(elx.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dfg $$0, dfe $$1, dwp $$2, azn $$3, eky $$4, ddp $$5, jf $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dho.ch.n(), dho.ch.n(), false);
   ...
   public static class k extends enq.r {
      public k(jk $$0, enq.v $$1) {
         super(elx.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dfg $$0, dfe $$1, dwp $$2, azn $$3, eky $$4, ddp $$5, jf $$6) {
         enq.v $$7 = this.B.b[jk.f.d()];
         enq.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jk.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jk.a.d()]);
         }
   ...
   public static class l extends enq.r {
      public l(jk $$0, enq.v $$1) {
         super(elx.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends enq.r {
      public m(jk $$0, enq.v $$1) {
         super(elx.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dfg $$0, dfe $$1, dwp $$2, azn $$3, eky $$4, ddp $$5, jf $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jk.a.d()]);
         }

         enq.v $$7 = this.B.b[jk.b.d()];
         if ($$7.b[jk.b.d()] == null) {
   ...
   public static class n extends enq.r {
      public n(jk $$0, enq.v $$1) {
         super(elx.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dfg $$0, dfe $$1, dwp $$2, azn $$3, eky $$4, ddp $$5, jf $$6) {
         enq.v $$7 = this.B.b[jk.c.d()];
         enq.v $$8 = this.B;
         enq.v $$9 = $$7.b[jk.b.d()];
         enq.v $$10 = $$8.b[jk.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jk.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jk.a.d()]);
         }
   ...
   public static class o extends enq.r {
      public o(jk $$0, enq.v $$1) {
         super(elx.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends enq.r {
      public p(jk $$0, enq.v $$1) {
         super(elx.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends enq.r {
      public q(jk $$0, eky $$1) {
         super(elx.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends elk {
      protected static final dus b = dho.hZ.n();
      protected static final dus c = dho.ia.n();
      protected static final dus d = dho.ib.n();
      protected static final dus h = c;
      protected static final dus i = dho.ii.n();
      protected static final boolean j = true;
      protected static final dus k = dho.G.n();
      protected static final Set<dhm> l = ImmutableSet.builder().add(dho.dO).add(dho.iC).add(dho.mW).add(k.b()).build();
      ...
      public r(elx $$0, jk $$1, int $$2, eky $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(elx $$0, int $$1, jk $$2, enq.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eky a(jk $$0, enq.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eky $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dfg $$0, eky $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dus $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dfg $$0, eky $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dfg $$0, eky $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dus $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eky $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dfg $$0, eky $$1, int $$2, int $$3, int $$4) {
         jf $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cks $$6 = bty.D.a($$0.E(), btx.d);
            if ($$6 != null) {
               $$6.c($$6.eQ());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.ds()), btx.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends enq.r {
      private int a;

      public s(jk $$0, enq.v $$1, azn $$2) {
         super(elx.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dfg $$0, dfe $$1, dwp $$2, azn $$3, eky $$4, ddp $$5, jf $$6) {
         ...
         if (this.B.b[jk.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jk.a.d()] && !this.B.c[jk.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends enq.r {
      public t(jk $$0, enq.v $$1) {
         super(elx.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends enq.r {
      private int a;

      public u(jk $$0, eky $$1, int $$2) {
         super(elx.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
