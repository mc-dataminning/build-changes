...
public class enq extends enk<enq.a> {
   protected enq(dum $$0) {
      super(dci.a, $$0, new enq.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected due g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kb.c($$0) < $$2) {
            ...
            return this.j($$0) ? new due(15) : new due();
         }
      }
   }

   private static due a(due $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends enh<enq.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<due> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public enq.a a() {
         return new enq.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
