...
public class enq implements ent {
   ...
   public enq(duq $$0, boolean $$1, boolean $$2) {
      this.c = $$0.q();
      this.a = $$1 ? new enj($$0) : null;
      this.d = $$2 ? new enu($$0) : null;
   }
   ...
   public eno a(dcm $$0) {
      if ($$0 == dcm.b) {
         return (eno)(this.a == null ? eno.a.a : this.a);
      } else {
         return (eno)(this.d == null ? eno.a.a : this.d);
      }
   }

   public String a(dcm $$0, kc $$1) {
      if ($$0 == dcm.b) {
         if (this.a != null) {
            return this.a.b($$1.s());
         }
