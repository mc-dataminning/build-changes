...
public class fl implements fk {
   ...
   public eei a(ds $$0) {
      eeh $$1 = $$0.k();
      eei $$2 = $$0.m().a($$0);
      float $$3 = apa.b(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$4 = apa.a(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$5 = apa.b(-$$1.i * (float) (Math.PI / 180.0));
      float $$6 = apa.a(-$$1.i * (float) (Math.PI / 180.0));
      float $$7 = apa.b((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      float $$8 = apa.a((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      eei $$9 = new eei((double)($$3 * $$5), (double)$$6, (double)($$4 * $$5));
      eei $$10 = new eei((double)($$3 * $$7), (double)$$8, (double)($$4 * $$7));
      eei $$11 = $$9.c($$10).a(-1.0);
