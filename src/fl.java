...
public class fl<T> implements ArgumentType<fl.c<T>> {
   ...
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> ww.b("argument.resource_tag.not_found", $$0, $$1));
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> ww.b("argument.resource_tag.invalid_type", $$0, $$1, $$2)
   );
   private final jg<T> d;
   final ald<? extends jr<T>> e;

   public fl(ee $$0, ald<? extends jr<T>> $$1) {
      this.e = $$1;
      this.d = $$0.e($$1);
   }

   public static <T> fl<T> a(ee $$0, ald<? extends jr<T>> $$1) {
      return new fl<>($$0, $$1);
   }

   public static <T> fl.c<T> a(CommandContext<ei> $$0, String $$1, ald<jr<T>> $$2) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      en.a(this.d.f().map(axp::b), $$1, "#");
      return en.a(this.d.c_().map(ald::a), $$1);
   }
   ...
   public static class a<T> implements ie<fl<T>, fl.a<T>.a> {
      public void a(fl.a<T>.a $$0, vs $$1) {
         $$1.b($$0.b);
      }

      public fl.a<T>.a a(vs $$0) {
   ...
   static record b<T>(je.c<T> a) implements fl.c<T> {
      ...
      @Override
      public <E> Optional<fl.c<E>> a(ald<? extends jr<E>> $$0) {
   ...
   public interface c<T> extends Predicate<je<T>> {
      ...
      <E> Optional<fl.c<E>> a(ald<? extends jr<E>> var1);
