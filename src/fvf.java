...
public class fvf extends fui {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   private static final int y = 256;
   private static final int z = 256;
   public static final fvf.a d = new fvf.a(List.of());
   ...
   private fvf.a A;
   private int B;
   private List<ayk> C = Collections.emptyList();
   private int D = -1;
   private wo E = wn.a;
   private fwg F;
   private fwg G;
   ...
   private fvf(fvf.a $$0, boolean $$1) {
      super(fky.a);
      this.A = $$0;
      this.H = $$1;
   }

   public void a(fvf.a $$0) {
      this.A = $$0;
      this.B = ayy.a(this.B, 0, $$0.a());
      this.L();
      this.D = -1;
   }

   public boolean a(int $$0) {
      int $$1 = ayy.a($$0, 0, this.A.a() - 1);
      if ($$1 != this.B) {
         this.B = $$1;
         this.L();
         this.D = -1;
   ...
   protected void m() {
      this.c(fop.a(wn.d, $$0 -> this.aO_()).a(this.n / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.n - 192) / 2;
      int $$1 = 2;
      this.F = this.c(new fwg($$0 + 116, 159, true, $$0x -> this.H(), this.H));
      this.G = this.c(new fwg($$0 + 43, 159, false, $$0x -> this.G(), this.H));
      this.L();
   }
   ...
   public void b(fob $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(gmf::H, s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }
   ...
   public static record a(List<wo> a) {
      ...
      @Nullable
      public static fvf.a a(cwn $$0) {
         boolean $$1 = flh.Q().aT();
         czv $$2 = $$0.a(kv.T);
         if ($$2 != null) {
            return new fvf.a($$2.a($$1));
         } else {
            czu $$3 = $$0.a(kv.S);
            return $$3 != null ? new fvf.a($$3.a($$1).map(wo::b).toList()) : null;
         }
      }
