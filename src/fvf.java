...
public class fvf {
   ...
   private void a(fnr $$0, int $$1, int $$2, Iterable<buo> $$3, boolean $$4) {
      int $$5 = this.c.D;

      for (buo $$6 : $$3) {
         if ($$4) {
            $$0.a(glu::C, a, $$1, $$5, 120, 32);
         } else {
            $$0.a(glu::C, b, $$1, $$5, 32, 32);
         }
   ...
   private void b(fnr $$0, int $$1, int $$2, Iterable<buo> $$3, boolean $$4) {
      hcj $$5 = this.d.aG();
      int $$6 = this.c.D;
      ...
      for (buo $$7 : $$3) {
         jq<bum> $$8 = $$7.c();
         hbk $$9 = $$5.a($$8);
         $$0.a(glu::C, $$9, $$1 + ($$4 ? 6 : 7), $$6 + 7, 18, 18);
         $$6 += $$2;
      }
   }

   private void a(fnr $$0, int $$1, int $$2, Iterable<buo> $$3) {
      int $$4 = this.c.D;
