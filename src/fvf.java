public class fvf extends ftg<cco> {
   private static final aew a = new aew("textures/entity/shulker/spark.png");
   ...
   public void a(cco $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      $$3.a(0.0F, 0.15F, 0.0F);
      $$3.a(a.d.rotationDegrees(arw.a($$8 * 0.1F) * 180.0F));
      $$3.a(a.b.rotationDegrees(arw.b($$8 * 0.1F) * 180.0F));
      $$3.a(a.f.rotationDegrees(arw.a($$8 * 0.15F) * 360.0F));
      $$3.b(-0.5F, -0.5F, 0.5F);
