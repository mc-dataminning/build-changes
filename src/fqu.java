...
public class fqu implements gag {
   ...
   protected void a(fof $$0, float $$1, int $$2, int $$3, gah $$4) {
      int $$5 = axk.a($$1);
      $$0.a(gmj::H, a, $$2 - 91, $$3, 182, 22, $$5);
      if ($$4.a() >= 0) {
         $$0.a(gmj::H, b, $$2 - 91 - 1 + $$4.a() * 20, $$3 - 1, 24, 23, $$5);
      }
   ...
   private void a(fof $$0, int $$1, int $$2, float $$3, float $$4, gaf $$5) {
      if ($$5 != gad.a) {
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == gad.a || !this.g.a($$1).aT_())) {
         $$1 += $$0;
      }
