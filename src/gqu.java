...
public class gqu {
   ...
   public static class a extends Thread {
      private final gqu.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gqu.b $$0) throws IOException {
         super("LanServerDetector #" + gqu.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gqu.b));
   ...
   public static class b {
      private final List<gqt> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gqt> a() {
         if (this.b) {
            List<gqt> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
