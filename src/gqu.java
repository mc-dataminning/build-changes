public class gqu implements gqk<dwi> {
   public static final hiz a = new hiz(hgr.d, ald.b("entity/enchanting_table_book"));
   private final gdh b;

   public gqu(gql.a $$0) {
      this.b = new gdh($$0.a(ghc.J));
   }

   public void a(dwi $$0, float $$1, fho $$2, gny $$3, int $$4, int $$5) {
      $$2.a();
      $$2.a(0.5F, 0.75F, 0.5F);
      float $$6 = (float)$$0.a + $$1;
