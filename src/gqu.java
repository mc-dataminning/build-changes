...
public abstract class gqu<T extends cqv, S extends gzm> extends gsc<T, S> {
   private static final akv b = akv.b("textures/entity/minecart.png");
   protected final gcu a;
   private final gnb h;

   public gqu(gsd.a $$0, gfa $$1) {
      super($$0);
      this.f = 0.7F;
      this.a = new gcu($$0.a($$1));
      this.h = $$0.d();
   }
   ...
   public void a(S $$0, fft $$1, glx $$2, int $$3) {
      ...
      $$1.b(-1.0F, -1.0F, 1.0F);
      this.a.a($$0);
      ffx $$11 = $$2.getBuffer(this.a.a(b));
      this.a.a($$1, $$11, $$3, heh.d);
      $$1.b();
   }

   private static <S extends gzm> void a(S $$0, fft $$1) {
      $$1.a(a.d.rotationDegrees($$0.b));
      $$1.a(a.f.rotationDegrees(-$$0.a));
      $$1.a(0.0F, 0.375F, 0.0F);
   }

   private static <S extends gzm> void b(S $$0, fft $$1) {
      double $$2 = $$0.r;
      double $$3 = $$0.s;
      double $$4 = $$0.t;
      float $$5 = $$0.a;
   ...
   public void a(T $$0, S $$1, float $$2) {
      super.a($$0, $$1, $$2);
      if ($$0.l() instanceof crk $$3) {
         a($$0, $$3, $$1, $$2);
         $$1.i = true;
      } else if ($$0.l() instanceof crl $$4) {
         a($$0, $$4, $$1, $$2);
         $$1.i = false;
      }
   ...
   private static <T extends cqv, S extends gzm> void a(T $$0, crk $$1, S $$2, float $$3) {
      if ($$1.t()) {
         $$2.j = $$1.e($$3);
         $$2.a = $$1.c($$3);
         $$2.b = $$1.d($$3);
   ...
   private static <T extends cqv, S extends gzm> void a(T $$0, crl $$1, S $$2, float $$3) {
      float $$4 = 0.3F;
      $$2.a = $$0.j($$3);
      $$2.b = $$0.k($$3);
      double $$5 = $$2.r;
      ...
      if ($$8 != null) {
         $$2.k = $$8;
         faz $$9 = $$1.a($$5, $$6, $$7, 0.3F);
         faz $$10 = $$1.a($$5, $$6, $$7, -0.3F);
   ...
   protected void a(S $$0, dww $$1, fft $$2, glx $$3, int $$4) {
      this.h.a($$1, $$2, $$3, $$4, heh.d);
   }
