public class gqu extends gqm {
   protected gqu(gmd $$0, double $$1, double $$2, double $$3) {
   ...
   public void a() {
      ...
      if (this.t-- <= 0) {
         ...
         double $$1 = Math.max(
            this.c.a_($$0).g(this.c, $$0).b(jc.a.b, this.g - (double)$$0.u(), this.i - (double)$$0.w()), (double)this.c.b_($$0).a(this.c, $$0)
         );
