...
public abstract class ass extends ast<Map<ajh, JsonElement>> {
   private static final Logger a = LogUtils.getLogger();
   private final Gson b;
   private final String c;

   public ass(Gson $$0, String $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static void a(aso $$0, String $$1, Gson $$2, Map<ajh, JsonElement> $$3) {
      aja $$4 = aja.a($$1);

      for (Entry<ajh, asm> $$5 : $$4.a($$0).entrySet()) {
         ajh $$6 = $$5.getKey();
         ajh $$7 = $$4.b($$6);

         try (Reader $$8 = $$5.getValue().e()) {
            JsonElement $$9 = awm.a($$2, $$8, JsonElement.class);
