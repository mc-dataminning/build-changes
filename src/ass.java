...
public class ass implements AutoCloseable {
   ...
   public static ass a(Path $$0) throws IOException {
   ...
   private ass(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ass.a a(Path $$0) {
         return new ass.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
