...
public class ass {
   ...
   final List<vr> g = Collections.synchronizedList(Lists.newArrayList());
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               vr.a($$1, zg.a, false, null);
               int $$2 = ass.this.e.o();
               vr $$3 = (vr)($$2 > 0 ? new wi($$2) : new vr(zg.a));
               ass.this.g.add($$3);
               $$3.a($$1);
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wy $$3 = wy.b("Internal server error");
                     $$1.a(new zo($$3), wf.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
