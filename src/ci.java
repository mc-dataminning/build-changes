...
public record ci(cm.d c, Optional<br> d) implements bs {
   public static final MapCodec<ci> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(aws.a(cm.d.d, "blocks_set_on_fire", cm.d.c).forGetter(ci::b), aws.a(br.a, "entity_struck").forGetter(ci::c)).apply($$0, ci::new)
   );
   ...
   public boolean a(bpv $$0, aps $$1, @Nullable esa $$2) {
      return !($$0 instanceof bqn $$3) ? false : this.c.d($$3.r()) && (this.d.isEmpty() || $$3.u().anyMatch($$2x -> this.d.get().a($$1, $$2, $$2x)));
   }
