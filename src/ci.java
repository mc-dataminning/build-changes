...
public record ci(cm.d c, Optional<br> d) implements bs {
   public static final MapCodec<ci> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(avp.a(cm.d.d, "blocks_set_on_fire", cm.d.c).forGetter(ci::b), avp.a(br.a, "entity_struck").forGetter(ci::c)).apply($$0, ci::new)
   );
   ...
   public boolean a(bno $$0, aov $$1, @Nullable ens $$2) {
      return !($$0 instanceof bof $$3) ? false : this.c.d($$3.s()) && (this.d.isEmpty() || $$3.u().anyMatch($$2x -> this.d.get().a($$1, $$2, $$2x)));
   }
