...
public class ci extends dy<ci.a> {
   ...
   public void a(asi $$0, cpv $$1, cxo $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(asi $$0, cpv $$1, cxo $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bh> b, ci.a.a c, List<cu> d) implements dy.a {
      ...
      public boolean a(cpv $$0, cxo $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
