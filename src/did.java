...
public class did {
   ...
   public did(qx $$0, cpx $$1) {
      ...
      a($$0, "neighbor_block_ticks", $$0x -> jd.f.b(aex.a($$0x)).or(() -> Optional.of(csw.a)), this.f);
   ...
   private static void a(dhq $$0, hd $$1) {
      cpv $$2 = $$0.F();
      if ($$0.r().e.remove($$1)) {
         Set<hc> $$3 = $$1.a();
         int $$4 = 0;
   ...
   private static dfj a(dfj $$0, hc $$1, cpw $$2, gw $$3, gw $$4) {
   ...
   public interface a {
      dfj a(dfj var1, hc var2, dfj var3, cpw var4, gw var5, gw var6);
