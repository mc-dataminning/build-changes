...
public class bjp extends DataFix {
   ...
   @Nullable
   private static bjp.a a(String $$0) {
      if (b.contains($$0)) {
         return null;
      } else {
         String $$1 = c.get($$0);
         if ($$1 != null) {
            return new bjp.a("minecraft:custom", $$1);
         } else {
            ...
            if ($$2 < 0) {
               ...
               if ("stat.mineBlock".equals($$3)) {
                  ...
                  return new bjp.a("minecraft:mined", $$4);
               } else {
                  String $$5 = f.get($$3);
                  if ($$5 != null) {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getInputSchema().getType(biz.g);
      Type<?> $$1 = this.getOutputSchema().getType(biz.g);
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getInputSchema().getType(biz.J);
      Type<?> $$1 = this.getOutputSchema().getType(biz.J);
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         ...
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> (Dynamic)DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
               if (a.contains($$0xxx)) {
                  ...
                  bjp.a $$1xx = a($$0xxx);
                  return $$1xx == null ? "dummy" : blj.b($$1xx.a) + ":" + blj.b($$1xx.b);
               }
