...
public abstract class bjp extends DataFix {
   private final String a;

   public bjp(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bjb.D);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bjb.D);
      Type<Pair<String, String>> $$2 = DSL.named(bjb.B.typeName(), bkw.a());
      if (!Objects.equals(this.getOutputSchema().getType(bjb.B), $$2)) {
