...
public class asc<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return asc.this.get(this.b--);
      }

      @Override
      public void remove() {
         asc.this.remove(this.b + 1);
      }
   }
}
