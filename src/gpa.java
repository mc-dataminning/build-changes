...
public class gpa implements gpg.a {
   ...
   private final flz F;
   private final Map<jh, gpa.a> G = Maps.newHashMap();
   private final Map<UUID, aar.a> H = Maps.newHashMap();
   @Nullable
   private UUID I;
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bvb $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dR();
      });
   }

   private void b(fgl $$0, glg $$1, double $$2, double $$3, double $$4) {
      jh $$5 = jh.a($$2, $$3, $$4);
   ...
   private void a(fgl $$0, glg $$1, gpa.a $$2) {
      int $$3 = 0;
   ...
   private void a(fgl $$0, glg $$1, aar.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gpp.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fgl $$0, glg $$1, aar.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fgl $$0, glg $$1, String $$2, gpa.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gpa.a $$0) {
      return this.b($$0.a).stream().map(agx::a).collect(Collectors.toSet());
   }

   private Set<String> c(gpa.a $$0) {
      return this.c($$0.a).stream().map(agx::a).collect(Collectors.toSet());
   }
   ...
   private boolean c(aar.a $$0) {
      cpo $$1 = this.F.t;
      jh $$2 = jh.a($$1.dB(), $$0.h().b(), $$1.dH());
      jh $$3 = jh.a((ka)$$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(jh $$0) {
      return this.H.values().stream().filter($$1 -> $$1.a($$0)).map(aar.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(jh $$0) {
      return this.H.values().stream().filter($$1 -> $$1.b($$0)).map(aar.a::a).collect(Collectors.toSet());
   }

   private Map<jh, List<String>> c() {
      Map<jh, List<String>> $$0 = Maps.newHashMap();

      for (aar.a $$1 : this.H.values()) {
   ...
   private void d() {
      gpg.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
