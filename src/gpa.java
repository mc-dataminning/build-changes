...
public class gpa extends avi<Optional<gpa.b>> implements AutoCloseable {
   ...
   private gpa.a o = gpa.a.b;
   @Nullable
   private fod p;
   @Nullable
   private gpa.b q;
   private final fjf r = new fjf(fgw.b);
   private boolean s;

   protected Optional<gpa.b> a(avd $$0, bqm $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gpa.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gpa.b> $$0, avd $$1, bqm $$2) {
   ...
   public void a(int $$0, fod $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fei $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            fjb $$21 = this.a(fje.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
   ...
   private void a(gqc $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gpb $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fjb a(fje $$0, int $$1, int $$2, fod $$3, gpa.a $$4, gqc $$5) {
      float $$6 = 0.8F;
      ...
      fix $$11 = $$0.a($$5.T(), $$5.S());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fod.c);
      return $$11.a();
   }

   private void a(gpa.a $$0, fix $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(fix $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(gpa.a $$0, fix $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
