...
public class gpa extends gmj<cgs, guw, fyl> {
   private static final Map<cgs.a, ale> a = ad.a(Maps.newEnumMap(cgs.a.class), $$0 -> {
      $$0.put(cgs.a.a, ale.b("textures/entity/panda/panda.png"));
      $$0.put(cgs.a.b, ale.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(cgs.a.c, ale.b("textures/entity/panda/worried_panda.png"));
      $$0.put(cgs.a.d, ale.b("textures/entity/panda/playful_panda.png"));
      $$0.put(cgs.a.e, ale.b("textures/entity/panda/brown_panda.png"));
      $$0.put(cgs.a.f, ale.b("textures/entity/panda/weak_panda.png"));
      $$0.put(cgs.a.g, ale.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gpa(gno.a $$0) {
      super($$0, new fyl($$0.a(gap.bp)), new fyl($$0.a(gap.bq)), 0.9F);
      this.a(new grx(this, $$0.b()));
   }

   public ale a(guw $$0) {
      return a.getOrDefault($$0.a, a.get(cgs.a.a));
   }
   ...
   public void a(cgs $$0, guw $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.gC();
      $$1.b = $$0.q() > 0;
      $$1.c = $$0.t();
   ...
   protected void a(guw $$0, fdi $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.k > 0.0F) {
         float $$4 = azf.i($$0.k);
         int $$5 = azf.d($$0.k);
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(azf.h($$24, $$0.V, $$0.V + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(azf.h($$26, $$0.V, $$0.V + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? azf.h($$3, $$0, $$1) : $$0;
   }
}
