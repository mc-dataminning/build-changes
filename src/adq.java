...
public class adq {
   ...
   private Optional<adq.a> b(Scanner $$0) {
      acp<cmm> $$1 = (acp<cmm>)adz.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new adq.a($$1, new eei((double)$$2, (double)$$3, (double)$$4), new eeh($$6, $$5)));
      }
   }
   ...
   static record a(acp<cmm> a, eei b, eeh c) {
   }
}
