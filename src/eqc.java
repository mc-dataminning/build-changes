...
public class eqc implements AutoCloseable {
   private final eqc.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private eqe a(epu.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(epu.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, ftt $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, ftt $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == eqe.b.a || this.i == eqe.b.b)) {
