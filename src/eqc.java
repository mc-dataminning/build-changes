...
public class eqc {
   ...
   static final Map<String, aku<evw>> e = Map.of("map_chest", evn.G, "treasure_chest", evn.I, "supply_chest", evn.H);
   ...
   public static class a extends enw {
      ...
      public a(erp $$0, akv $$1, ji $$2, dqe $$3, boolean $$4) {
