...
public class eqc {
   ...
   private static final dtb.f e = ($$0, $$1, $$2) -> $$0.a(dga.co);
   ...
   public static Optional<eqc> a(dcx $$0, jd $$1, ji.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<eqc> a(dcx $$0, jd $$1, Predicate<eqc> $$2, ji.a $$3) {
      Optional<eqc> $$4 = Optional.of(new eqc($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ji.a $$5 = $$3 == ji.a.a ? ji.a.c : ji.a.a;
         return Optional.of(new eqc($$0, $$1, $$5)).filter($$2);
      }
   }

   public eqc(dcx $$0, jd $$1, ji.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dtc $$0) {
      return $$0.i() || $$0.a(awe.aK) || $$0.a(dga.ed);
   }
   ...
   public static exa a(l.a $$0, ji.a $$1, exa $$2, bsu $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = ayo.a(ayo.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         ji.a $$10 = ji.a.b;
         $$11 = ayo.a(ayo.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new exa($$8, $$11, $$14);
   }

   public static exa a(exa $$0, aqu $$1, bsr $$2, bsu $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         exa $$5 = $$0.b(0.0, $$4, 0.0);
         ext $$6 = exq.a(ewv.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<exa> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<exa> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
