...
public class bda extends bfu {
   public bda(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bgw.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bgw.D.typeName(), bih.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bgw.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bgw.D.typeName(), "minecraft:saddle"));
