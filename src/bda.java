...
public class bda extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(bfp.H));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(bfp.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(bfp.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(bfp.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(bfp.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(bfp.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(bfp.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(bfp.s);
      Type<?> $$9 = this.getOutputSchema().getType(bfp.s);
