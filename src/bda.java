...
public class bda extends azs {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bda::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bda::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bda::k);
         $$0 = this.a($$0, "minecraft:fox", bda::j);
         $$0 = this.a($$0, "minecraft:item", bda::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bda::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bda::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bda::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bda::e);
         return this.a($$0, "minecraft:piglin", bda::d);
      });
   }
