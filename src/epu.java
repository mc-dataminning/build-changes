...
public class epu extends epz {
   ...
   public List<eod.a> a(dkf $$0, BiConsumer<iw, ebg> $$1, azz $$2, int $$3, iw $$4, enn $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azq.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azq.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<epu.a> $$13 = Lists.newArrayList();
      $$13.add(new epu.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iw $$21 = $$4.b(azq.a($$19), $$12 - 1, azq.a($$20));
               iw $$22 = $$21.b(5);
      ...
      List<eod.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dkf $$0, BiConsumer<iw, ebg> $$1, azz $$2, iw $$3, iw $$4, boolean $$5, enn $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iw $$13 = $$3.b(azq.d(0.5F + (float)$$12 * $$9), azq.d(0.5F + (float)$$12 * $$10), azq.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dtx.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dkf $$0, BiConsumer<iw, ebg> $$1, azz $$2, int $$3, iw $$4, List<epu.a> $$5, enn $$6) {
      for (epu.a $$7 : $$5) {
         int $$8 = $$7.a();
