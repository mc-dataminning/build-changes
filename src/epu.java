...
public class epu {
   ...
   static class a implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         return $$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d;
      }

      @Override
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         $$1.d = true;
         $$1.b[jn.f.d()].d = true;
         return new epu.k($$0, $$1);
      }
   }

   static class b implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         if ($$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d && $$0.c[jn.b.d()] && !$$0.b[jn.b.d()].d) {
            epu.v $$1 = $$0.b[jn.f.d()];
            return $$1.c[jn.b.d()] && !$$1.b[jn.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         ...
         $$1.b[jn.f.d()].d = true;
         $$1.b[jn.b.d()].d = true;
         $$1.b[jn.f.d()].b[jn.b.d()].d = true;
         return new epu.l($$0, $$1);
      }
   }

   static class c implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         return $$0.c[jn.b.d()] && !$$0.b[jn.b.d()].d;
      }
      ...
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         $$1.d = true;
         $$1.b[jn.b.d()].d = true;
         return new epu.m($$0, $$1);
      }
   }

   static class d implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         if ($$0.c[jn.c.d()] && !$$0.b[jn.c.d()].d && $$0.c[jn.b.d()] && !$$0.b[jn.b.d()].d) {
            epu.v $$1 = $$0.b[jn.c.d()];
            return $$1.c[jn.b.d()] && !$$1.b[jn.b.d()].d;
         } else {
            return false;
      ...
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         ...
         $$1.b[jn.c.d()].d = true;
         $$1.b[jn.b.d()].d = true;
         $$1.b[jn.c.d()].b[jn.b.d()].d = true;
         return new epu.n($$0, $$1);
      }
   }

   static class e implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         return $$0.c[jn.c.d()] && !$$0.b[jn.c.d()].d;
      }

      @Override
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         epu.v $$3 = $$1;
         if (!$$1.c[jn.c.d()] || $$1.b[jn.c.d()].d) {
            $$3 = $$1.b[jn.d.d()];
         }

         $$3.d = true;
         $$3.b[jn.c.d()].d = true;
         return new epu.o($$0, $$3);
      }
   }

   static class f implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         return true;
      }
      ...
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         $$1.d = true;
         return new epu.s($$0, $$1, $$2);
      }
   }

   static class g implements epu.i {
      @Override
      public boolean a(epu.v $$0) {
         return !$$0.c[jn.e.d()] && !$$0.c[jn.f.d()] && !$$0.c[jn.c.d()] && !$$0.c[jn.d.d()] && !$$0.c[jn.b.d()];
      }

      @Override
      public epu.r a(jn $$0, epu.v $$1, azg $$2) {
         $$1.d = true;
         return new epu.t($$0, $$1);
      }
   }

   public static class h extends epu.r {
      ...
      private epu.v G;
      private epu.v H;
      private final List<epu.r> I = Lists.newArrayList();

      public h(azg $$0, int $$1, int $$2, jn $$3) {
         super(eob.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<epu.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new epu.p($$3, this.G));
         this.I.add(new epu.j($$3, this.H));
         List<epu.i> $$5 = Lists.newArrayList();
         $$5.add(new epu.b());
         $$5.add(new epu.d());
         $$5.add(new epu.e());
         $$5.add(new epu.a());
         ...
         enc $$10 = enc.a(this.b(1, 1, 1), this.b(23, 8, 21));
         enc $$11 = enc.a(this.b(34, 1, 1), this.b(56, 8, 21));
         enc $$12 = enc.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new epu.u($$3, $$10, $$13++));
         this.I.add(new epu.u($$3, $$11, $$13++));
         this.I.add(new epu.q($$3, $$12));
      }
      ...
      private List<epu.v> b(azg $$0) {
         epu.v[] $$1 = new epu.v[75];
         ...
         epu.v $$23 = new epu.v(1003);
         epu.v $$24 = new epu.v(1001);
         epu.v $$25 = new epu.v(1002);
         $$1[v].a(jn.b, $$23);
         $$1[w].a(jn.d, $$24);
         $$1[x].a(jn.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jn.f.d()].d = true;
         this.H.b[jn.c.d()].d = true;
         this.H.b[jn.f.d()].b[jn.c.d()].d = true;
         this.H.b[jn.b.d()].d = true;
         this.H.b[jn.f.d()].b[jn.b.d()].d = true;
         this.H.b[jn.c.d()].b[jn.b.d()].d = true;
         this.H.b[jn.f.d()].b[jn.c.d()].b[jn.b.d()].d = true;
         ObjectArrayList<epu.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhe $$2, azg $$3, enc $$4) {
         int $$5 = 24;
      ...
      private void a(dhe $$0, azg $$1, enc $$2) {
      ...
      private void b(dhe $$0, azg $$1, enc $$2) {
      ...
      private void c(dhe $$0, azg $$1, enc $$2) {
      ...
      private void d(dhe $$0, azg $$1, enc $$2) {
      ...
      private void e(dhe $$0, azg $$1, enc $$2) {
      ...
      private void f(dhe $$0, azg $$1, enc $$2) {
   ...
   interface i {
      boolean a(epu.v var1);

      epu.r a(jn var1, epu.v var2, azg var3);
   }

   public static class j extends epu.r {
      public j(jn $$0, epu.v $$1) {
         super(eob.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhe $$0, dhc $$1, dyr $$2, azg $$3, enc $$4, dfm $$5, ji $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, djm.co.m(), djm.co.m(), false);
   ...
   public static class k extends epu.r {
      public k(jn $$0, epu.v $$1) {
         super(eob.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dhe $$0, dhc $$1, dyr $$2, azg $$3, enc $$4, dfm $$5, ji $$6) {
         epu.v $$7 = this.B.b[jn.f.d()];
         epu.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jn.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jn.a.d()]);
         }
   ...
   public static class l extends epu.r {
      public l(jn $$0, epu.v $$1) {
         super(eob.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends epu.r {
      public m(jn $$0, epu.v $$1) {
         super(eob.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dhe $$0, dhc $$1, dyr $$2, azg $$3, enc $$4, dfm $$5, ji $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jn.a.d()]);
         }

         epu.v $$7 = this.B.b[jn.b.d()];
         if ($$7.b[jn.b.d()] == null) {
   ...
   public static class n extends epu.r {
      public n(jn $$0, epu.v $$1) {
         super(eob.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dhe $$0, dhc $$1, dyr $$2, azg $$3, enc $$4, dfm $$5, ji $$6) {
         epu.v $$7 = this.B.b[jn.c.d()];
         epu.v $$8 = this.B;
         epu.v $$9 = $$7.b[jn.b.d()];
         epu.v $$10 = $$8.b[jn.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jn.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jn.a.d()]);
         }
   ...
   public static class o extends epu.r {
      public o(jn $$0, epu.v $$1) {
         super(eob.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends epu.r {
      public p(jn $$0, epu.v $$1) {
         super(eob.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends epu.r {
      public q(jn $$0, enc $$1) {
         super(eob.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eno {
      protected static final dwv b = djm.ix.m();
      protected static final dwv c = djm.iy.m();
      protected static final dwv d = djm.iz.m();
      protected static final dwv h = c;
      protected static final dwv i = djm.iG.m();
      protected static final boolean j = true;
      protected static final dwv k = djm.J.m();
      protected static final Set<djk> l = ImmutableSet.builder().add(djm.eb).add(djm.ja).add(djm.ny).add(k.b()).build();
      ...
      public r(eob $$0, jn $$1, int $$2, enc $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eob $$0, int $$1, jn $$2, epu.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static enc a(jn $$0, epu.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         enc $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhe $$0, enc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dwv $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhe $$0, enc $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhe $$0, enc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dwv $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(enc $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhe $$0, enc $$1, int $$2, int $$3, int $$4) {
         ji $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cll $$6 = buq.M.a($$0.a(), bup.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dw()), bup.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends epu.r {
      private int a;

      public s(jn $$0, epu.v $$1, azg $$2) {
         super(eob.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dhe $$0, dhc $$1, dyr $$2, azg $$3, enc $$4, dfm $$5, ji $$6) {
         ...
         if (this.B.b[jn.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jn.a.d()] && !this.B.c[jn.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends epu.r {
      public t(jn $$0, epu.v $$1) {
         super(eob.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends epu.r {
      private int a;

      public u(jn $$0, enc $$1, int $$2) {
         super(eob.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
