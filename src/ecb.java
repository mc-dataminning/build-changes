...
public class ecb extends LongLinkedOpenHashSet {
   private final ecb.a a;

   public ecb(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new ecb.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = ati.f(60000000);
      private static final int b = ati.f(60000000);
