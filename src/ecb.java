...
public class ecb implements ecc, ecd {
   ...
   private final egr<MinecraftServer> K;
   ...
   public ecb(cpq $$0, dlh $$1, ecb.a $$2, Lifecycle $$3) {
      this(
         null,
         aa.b().d().c(),
         null,
   ...
   public static <T> ecb a(Dynamic<T> $$0, DataFixer $$1, int $$2, @Nullable qr $$3, cpq $$4, ebz $$5, ecb.a $$6, dlh $$7, Lifecycle $$8) {
      ...
      return new ecb(
         ...
         new egr<>(egq.a, $$0.get("ScheduledEvents").asStream()),
         (qr)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dim.a.a).resultOrPartial(e::error).orElse(dim.a.b),
         $$4,
         $$7,
         $$6,
         $$8
   ...
   private void a(hs $$0, qr $$1, @Nullable qr $$2) {
      ...
      $$1.a("Version", $$3);
      rd.g($$1);
      DynamicOps<rk> $$4 = aep.a(rc.a, $$0);
      dlf.a($$4, this.g, $$0).resultOrPartial(ac.a("WorldGenSettings: ", e::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dim.a.a.encodeStart(rc.a, this.C), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<rk> $$5 = cqf.b.encodeStart(rc.a, this.f.g());
   ...
   private void N() {
      if (!this.r && this.s != null) {
         if (this.q < aa.b().d().c()) {
            ...
            this.s = ass.b.a(this.p, this.s, this.q);
         }
   ...
   @Override
   public boolean B() {
      return this.h == ecb.a.b;
   }

   @Override
   public boolean C() {
      return this.h == ecb.a.c;
   }
