...
public class gol {
   ...
   public static goe a(Vector3f $$0, Vector3f $$1, gog $$2, hfr $$3, jn $$4, hih $$5, @Nullable goh $$6, boolean $$7, int $$8) {
      goi $$9 = $$2.d();
      if ($$5.b()) {
         $$9 = a($$2.d(), $$4, $$5.a());
      }
      ...
      return new goe($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static goi a(goi $$0, jn $$1, j $$2) {
      ...
      return new goi(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private static int[] a(goi $$0, hfr $$1, jn $$2, float[] $$3, j $$4, @Nullable goh $$5) {
      int[] $$6 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, jn $$2, goi $$3, float[] $$4, hfr $$5, j $$6, @Nullable goh $$7) {
      gml.b $$8 = gml.a($$2).a($$1);
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hfr $$3, goi $$4) {
      int $$5 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable goh $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
