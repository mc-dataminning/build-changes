...
public class erb {
   ...
   private static final dtz.f e = ($$0, $$1, $$2) -> $$0.a(dgx.co);
   ...
   public static Optional<erb> a(ddt $$0, je $$1, jj.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<erb> a(ddt $$0, je $$1, Predicate<erb> $$2, jj.a $$3) {
      Optional<erb> $$4 = Optional.of(new erb($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         jj.a $$5 = $$3 == jj.a.a ? jj.a.c : jj.a.a;
         return Optional.of(new erb($$0, $$1, $$5)).filter($$2);
      }
   }

   public erb(ddt $$0, je $$1, jj.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dua $$0) {
      return $$0.l() || $$0.a(aws.aL) || $$0.a(dgx.ed);
   }
   ...
   public static eye a(l.a $$0, jj.a $$1, eye $$2, btm $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = azc.a(azc.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         jj.a $$10 = jj.a.b;
         $$11 = azc.a(azc.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new eye($$8, $$11, $$14);
   }

   public static eye a(eye $$0, arg $$1, btj $$2, btm $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         eye $$5 = $$0.b(0.0, $$4, 0.0);
         eyx $$6 = eyu.a(exz.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<eye> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<eye> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
