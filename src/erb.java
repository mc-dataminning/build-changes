...
public class erb {
   ...
   public erb a(int $$0, int $$1, int $$2) {
      erb $$3 = new erb($$0, $$1, $$2);
      $$3.d = this.d;
      $$3.e = this.e;
      $$3.f = this.f;
   ...
   public float b(erb $$0) {
      float $$1 = (float)($$0.a - this.a);
      float $$2 = (float)($$0.c - this.c);
      return azd.c($$1 * $$1 + $$2 * $$2);
   }
   ...
   public eys b() {
      return new eys((double)this.a, (double)this.b, (double)this.c);
   }

   @Override
   public boolean equals(Object $$0) {
      return !($$0 instanceof erb $$1) ? false : this.m == $$1.m && this.a == $$1.a && this.b == $$1.b && this.c == $$1.c;
   }
   ...
   public static erb b(wa $$0) {
      erb $$1 = new erb($$0.readInt(), $$0.readInt(), $$0.readInt());
      a($$0, $$1);
      return $$1;
   }

   protected static void a(wa $$0, erb $$1) {
      $$1.j = $$0.readFloat();
      $$1.k = $$0.readFloat();
      $$1.i = $$0.readBoolean();
      $$1.l = $$0.b(erg.class);
