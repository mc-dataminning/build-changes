...
public enum erb {
   ...
   public List<art<InputStream>> a(aqp $$0) throws IOException {
      return List.of(
   ...
   public art<InputStream> b(aqp $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private art<InputStream> a(aqp $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      art<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
