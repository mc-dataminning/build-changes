...
public class ees {
   private static final ees a = new ees(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public ees.a a(int $$0, int $$1) {
         return new ees.a(1.0, 0.0);
      }
   ...
   private static final eta b = eta.b(new eer(42L), ro.a);
   ...
   private final Long2ObjectOpenHashMap<eet> h;
   private final Long2ObjectOpenHashMap<eet> i;

   public static ees a() {
      return a;
   }

   public static ees a(@Nullable asp $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dgo $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<eet> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<eet> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = bae.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new ees($$2, $$3);
         }
      }
   }

   ees(Long2ObjectOpenHashMap<eet> $$0, Long2ObjectOpenHashMap<eet> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public ees.a a(int $$0, int $$1) {
      int $$2 = kb.a($$0);
      int $$3 = kb.a($$1);
      double $$4 = this.a($$2, 0, $$3, eet::a);
      if ($$4 != Double.MAX_VALUE) {
         return new ees.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(dgo.a($$5x)), kb.d(dgo.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(edj.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kb.d(dgo.a($$6x)), kb.d(dgo.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, ees.b $$3) {
      int $$4 = kb.e($$0);
      int $$5 = kb.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(ees.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      eet $$6 = (eet)this.h.get(dgo.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kb.d($$1), $$4, $$5 - kb.d($$2)) : Double.MAX_VALUE;
   }

   public din a(din $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jq<dik> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jq<dik> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jq<dik>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(dgo.a($$5x)), $$1, kb.d(dgo.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(asp $$0, dzq $$1) {
      dgo $$2 = $$1.f();
      boolean $$3 = $$1.u();
      jh.a $$4 = new jh.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(edq.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dzq $$0, jh $$1) {
      dxv $$2 = $$0.a_($$1);
      if ($$2.a(axu.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dig $$0, eak $$1) {
      dgo $$2 = $$1.f();
      Builder<jn, eet> $$3 = ImmutableMap.builder();
   ...
   public static ees.c a(@Nullable eet $$0, Map<jn, eet> $$1) {
      List<ees.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static ees.c a(@Nullable jn $$0, eet $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jm $$4 : $$0.a()) {
   ...
   interface b {
      double get(eet var1, int var2, int var3, int var4);
   }
