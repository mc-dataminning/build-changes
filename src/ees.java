...
public class ees {
   ...
   private final dhj o;
   private static final List<dkl> p = List.of(dkn.l, dkn.O, dkn.i, dkn.b, dkn.k, dkn.L, dkn.N, dkn.fz, dkn.ec, dkn.iR, dkn.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jq<dij>>> s;
   private final transient double[][] t;

   private ees(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dij>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static ees a(@Nullable ees.d $$0) {
      return $$0 == null ? null : new ees($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public ees.d a() {
      ...
      return new ees.d(this.o.ao(), this.o.ap() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }
   ...
   public static Set<jn> a(dif $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dzp $$1, int $$2, int $$3) {
   ...
   private int a(dzp $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(edp.a.a)) {
         $$3 = Math.min($$0.a(edp.a.a, $$1, $$2), this.o.am());
      } else {
         $$3 = this.o.am();
      }
   ...
   private static double a(dzp $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dzp $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dzp $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jq<dij>> b(dzp $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dij>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dzp $$0, jh $$1) {
      dxu $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axu.Q)) {
         ...
         return $$2.a(dkn.fh) || $$2.a(dkn.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, ees.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, ees.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dij> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<ees.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(ees.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(ees.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(ees.d::c)
                  )
                  .apply($$0, ees.d::new)
         )
         .validate(ees.d::a);

      private static DataResult<ees.d> a(ees.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != ees.n
            ? DataResult.error(() -> "heights has to be of length " + ees.n)
