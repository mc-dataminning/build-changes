...
public class aoh {
   ...
   private static int a(et $$0, Collection<ari> $$1, Collection<daj<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(et $$0, Collection<ari> $$1, Collection<daj<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
