...
class aoh extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aog && $$1 instanceof aog && $$0.equals($$1);
   }
   ...
   private static aog a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aog) {
         return (aog)$$0;
      } else {
