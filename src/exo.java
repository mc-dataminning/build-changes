...
public class exo {
   ...
   private static final Map<doq.a, String> e = ac.a(new EnumMap<>(doq.a.class), $$0 -> {
      $$0.put(doq.a.a, "SW");
      $$0.put(doq.a.b, "S");
      $$0.put(doq.a.c, "OW");
      $$0.put(doq.a.d, "O");
   ...
   public exo(evi $$0) {
      ...
      this.w = new eyy(this.h, this.s, () -> $$0.r.s().g());
   ...
   private void a(ewu $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, auo.g($$15.dC()), auo.g($$15.dE())));
         dlo $$27 = this.r();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(cty.a, $$14);
            int $$30 = this.f.r.a(cty.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dlo $$31 = this.q();
            StringBuilder $$32 = new StringBuilder("CH");

            for (doq.a $$33 : doq.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.J_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  bjz $$37 = new bjz($$23.ak(), $$23.Y(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            cua.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bmo> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bmo.values())
   ...
   private static String a(ih<cuo> $$0) {
   ...
   private ctp p() {
      return (ctp)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private dlo q() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dli.n, false).thenApply($$0x -> (dlo)$$0x.map($$0xx -> (dlo)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eou.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", evi.O().aM().k(), evi.O().aM().l(), eou.a()),
            eou.c(),
            eou.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == elr.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dkk<?>, Comparable<?>> $$7 = (Entry<dkk<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == elr.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dkk<?>, Comparable<?>> $$10 = (Entry<dkk<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dkk<?>, Comparable<?>> $$0) {
      dkk<?> $$1 = $$0.getKey();
