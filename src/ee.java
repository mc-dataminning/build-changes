...
public class ee implements ArgumentType<ee.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("argument.player.unknown"));

   public static Collection<GameProfile> a(CommandContext<ds> $$0, String $$1) throws CommandSyntaxException {
      return ((ee.a)$$0.getArgument($$1, ee.a.class)).getNames((ds)$$0.getSource());
   }
