...
public class ee implements ArgumentType<gc> {
   ...
   public static Collection<aks> d(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static aks e(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static Collection<aks> f(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
      List<aks> $$2 = ((gc)$$0.getArgument($$1, gc.class)).d((dt)$$0.getSource());
      if ($$2.isEmpty()) {
         throw e.create();
      } else {
         return $$2;
