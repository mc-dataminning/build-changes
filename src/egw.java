...
public class egw implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<egw.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public egw(List<egw.a> $$0) {
      this.c = $$0;
   }
   ...
   public static egw a(BufferedReader $$0) {
      return new egw($$0.lines().flatMap($$0x -> egw.a.a($$0x).stream()).toList());
   }

   public static record a(egw.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<egw.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new egw.a(egw.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new egw.a(egw.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new egw.a(egw.b.b, $$3));
      ...
      static egw.a b(String $$0) {
         return new egw.a(egw.b.a, "glob:" + $$0);
      }

      static egw.a c(String $$0) {
         return new egw.a(egw.b.a, "regex:" + $$0);
      }

      static egw.a d(String $$0) {
         return new egw.a(egw.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      egw.b a = FileSystem::getPathMatcher;
      egw.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
