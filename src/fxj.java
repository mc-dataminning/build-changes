...
public class fxj extends fyn {
   ...
   protected void aO_() {
      ...
      this.b = new fte(this.m.i, 4, this.o - 12, this.n - 4, 12, wy.c("chat.editBox")) {
         @Override
         protected xm d() {
            return super.d().b(fxj.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fsy(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(fsh $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fpi $$4 = this.m.m.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(fws $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fwr.a, wy.a("chat_screen.message", $$1));
      }
   }
