...
public class fxj implements fyc {
   ...
   public fxj(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cmu::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cmu>> a(Optional<cmu> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (axt | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cmu.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cmu $$0) {
      ...
      if ($$0 != null) {
         if (aa.aX) {
            cmu.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cmu a(UserApiService $$0) throws axt, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cmv.a $$2 = a($$1);
         return new cmu(axs.a($$1.keyPair().privateKey()), new cmv($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cmv.a a(KeyPairResponse $$0) throws axt {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = axs.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cmv.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new axt(var5);
         }
      } else {
         throw new axt(new MissingException("Missing public key"));
      }
   }
}
