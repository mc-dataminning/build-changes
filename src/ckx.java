            ...
            if ($$6 <= 0 || $$4.aY()) {
               if (!$$1.B) {
                  ...
                  if ($$6 == 0) {
                     ...
                     $$1.b($$7);
                     $$1.a(null, $$7, apd.xT, ape.h, 1.0F, 1.0F);
                     if (!$$4.fS().d) {
                        $$4.fR().g($$0);
                     }
                  }
               ...
               if ($$6 > 0) {
                  float $$8 = $$4.dB();
                  float $$9 = $$4.dD();
                  float $$10 = -arw.a($$8 * (float) (Math.PI / 180.0)) * arw.b($$9 * (float) (Math.PI / 180.0));
                  float $$11 = -arw.a($$9 * (float) (Math.PI / 180.0));
                  float $$12 = arw.b($$8 * (float) (Math.PI / 180.0)) * arw.b($$9 * (float) (Math.PI / 180.0));
