...
public class gxx implements atr<gxw> {
   public gxw b(JsonObject $$0) {
      Builder<gxv> $$1 = ImmutableList.builder();
      int $$2 = ays.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = ays.a($$0, "width", -1);
      int $$9 = ays.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = ays.a($$0, "interpolate", false);
      return new gxw($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gxv a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gxv(ays.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = ays.m($$1, "frames[" + $$0 + "]");
         int $$3 = ays.a($$2, "time", -1);
         if ($$2.has("time")) {
