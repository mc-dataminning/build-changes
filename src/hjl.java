...
public class hjl {
   ...
   private final hjk r;
   private final hjm s = new hjm();
   private final hjc t = new hjc(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hjl.a> w = new AtomicReference<>(hjl.a.c);
   private final Map<hii, hjc.a> x = Maps.newHashMap();
   private final Multimap<awb, hii> y = HashMultimap.create();
   private final List<hij> z = Lists.newArrayList();
   private final Map<hii, Integer> A = Maps.newHashMap();
   private final Map<hii, Integer> B = Maps.newHashMap();
   private final List<hjn> C = Lists.newArrayList();
   private final List<hij> D = Lists.newArrayList();
   private final List<hif> E = Lists.newArrayList();

   public hjl(hjo $$0, fln $$1, aus $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hjk($$2);
   }
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hjl.a.c, hjl.a.a)) {
               String $$2 = this.n.aw().c();
               af.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hjl.a.a, hjl.a.b);
                     }
                  ...
                  this.w.compareAndSet(hjl.a.a, hjl.a.c);
               });
            }
         }

         return this.w.compareAndSet(hjl.a.b, hjl.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hii::s).forEach(this::c);
      this.D.clear();
      ...
      Iterator<Entry<hii, hjc.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hii, hjc.a> $$6 = $$5.next();
         hjc.a $$7 = $$6.getValue();
         hii $$8 = $$6.getKey();
      ...
      Iterator<Entry<hii, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hii, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hii $$13 = $$12.getKey();
            if ($$13 instanceof hij) {
               ((hij)$$13).q();
            }
   ...
   private static boolean d(hii $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hii $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hii $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hii $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hjo.e) {
                  if ($$3 == hjo.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hii.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hjc.a> $$16 = this.t.a($$3.g() ? fdh.c.b : fdh.c.a);
                           hjc.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hii $$0) {
      return ayz.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hii $$0) {
