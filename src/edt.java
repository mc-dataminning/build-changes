...
public class edt {
   ...
   private final edt.a g;

   @Deprecated
   public static edt a(auu $$0, edt.a $$1) {
      return new edt($$0, $$1, false);
   }

   public static edt a(auu $$0, int $$1, double... $$2) {
      return b($$0, new edt.a($$1, new DoubleArrayList($$2)));
   }

   public static edt b(auu $$0, edt.a $$1) {
      return new edt($$0, $$1, true);
   }

   private edt(auu $$0, edt.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<edt.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(edt.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(edt.a::b))
               .apply($$0, edt.a::new)
      );
      public static final Codec<ih<edt.a>> b = ahc.a(ke.aB, a);
