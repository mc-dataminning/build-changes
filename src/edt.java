...
public class edt {
   ...
   private final dgi o;
   private static final List<djk> p = List.of(djm.l, djm.O, djm.i, djm.b, djm.k, djm.L, djm.N, djm.fA, djm.ec, djm.iY, djm.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jr<dhi>>> s;
   private final transient double[][] t;

   private edt(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> af.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jr<dhi>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kk.c($$0);
      int $$5 = kk.c($$1) - $$4;
   ...
   @Nullable
   public static edt a(@Nullable edt.d $$0) {
      return $$0 == null ? null : new edt($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public edt.d a() {
      ...
      return new edt.d(this.o.ap(), this.o.aq() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static edt a(ark $$0, int $$1, int $$2) {
      dyq $$3 = $$0.a($$1, $$2);
      edt $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(dzr.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jo> a(dhe $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dyq $$1, int $$2, int $$3) {
      if (this.r[$$0] == Double.MAX_VALUE) {
         this.r[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.t[$$0] = this.a($$1, $$2, $$3, ayy.a(this.r[$$0]));
      this.s.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dyq $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ecq.a.a)) {
         $$3 = Math.min($$0.a(ecq.a.a, $$1, $$2), this.o.an());
      } else {
         $$3 = this.o.an();
      }
   ...
   private static double a(dyq $$0, ji.a $$1) {
      return a($$0, (ji)$$1.c(jn.a)) ? 1.0 : -1.0;
   }

   private static double b(dyq $$0, ji.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dyq $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.c()];
      Arrays.fill($$4, -1.0);
      ji.a $$5 = new ji.a($$1, this.o.an() + 1, $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<jr<dhi>> b(dyq $$0, int $$1, int $$2) {
      ObjectArrayList<jr<dhi>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + kc.a(this.o.L_());
   ...
   private static boolean a(dyq $$0, ji $$1) {
      dwv $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(awo.Q)) {
         ...
         return $$2.a(djm.fh) || $$2.a(djm.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, edt.a $$3) {
      if ($$1 >= kc.a(this.o.L_()) && $$1 <= kc.a(this.o.an())) {
         int $$4 = $$1 - kc.a(this.o.L_());

         for (int $$5 = 0; $$5 < this.s.size(); $$5++) {
            if (this.s.get($$5) != null) {
               jr<dhi> $$6 = this.s.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, edt.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, edt.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jr<dhi> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<edt.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(edt.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(edt.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(edt.d::c)
                  )
                  .apply($$0, edt.d::new)
         )
         .validate(edt.d::a);

      private static DataResult<edt.d> a(edt.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != edt.n
            ? DataResult.error(() -> "heights has to be of length " + edt.n)
