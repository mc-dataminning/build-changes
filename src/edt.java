...
public class edt extends edw<eds> {
   public edt(Codec<eds> $$0) {
      super($$0);
   }

   public boolean a(eds $$0, azu $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(edr $$0, eds $$1, dxq $$2, Function<jh, jq<dgo>> $$3, azu $$4, ebc $$5, des $$6, dxp $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         edw.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      edr $$0, eds $$1, dxq $$2, Function<jh, jq<dgo>> $$3, ebc $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dxp $$10, edw.a $$11
   ) {
