...
public class eny extends eob {
   public static final MapCodec<eny> a = RecordCodecBuilder.mapCodec(
      $$0 -> b($$0)
            .and(
               $$0.group(
                  btw.b(4, 16).fieldOf("height").forGetter($$0x -> $$0x.b),
   ...
   public eny(btw $$0, btw $$1, btw $$2, float $$3, float $$4, float $$5, float $$6) {
      super($$0, $$1);
      this.b = $$2;
      this.c = $$3;
      this.g = $$4;
