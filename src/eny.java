...
public class eny implements dyo.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eny> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayg<eny> a = ayg.a(f);
   private final eoc g;
   private final eoc h;
   private final eoc i;
   ...
   public static eny a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eny(new dzw(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eny(eoc $$0, eoc $$1, eoc $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eny(ayv $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eoc.a($$0, IntStream.rangeClosed(-15, 0)),
         eoc.a($$0, IntStream.rangeClosed(-15, 0)),
         eoc.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eny a(ayv $$0) {
      return new eny($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dyo.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         enz $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eoc.b($$4 * $$13), eoc.b($$5 * $$13), eoc.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eoc.b($$1 * $$13);
         double $$21 = eoc.b($$2 * $$13);
         double $$22 = eoc.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            enz $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ayn.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
