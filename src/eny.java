...
public abstract class eny<M extends ens<M>, S extends env<M>> implements enu {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = eny.a.a(1);
   ...
   private final dus[] n = new dus[2];

   protected eny(dut $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(dbl $$0, ja $$1, dsk $$2, dsk $$3) {
      return $$3 == $$2 ? false : $$3.b($$0, $$1) != $$2.b($$0, $$1) || $$3.h() != $$2.h() || $$3.g() || $$2.g();
   }

   public static int a(dbl $$0, dsk $$1, ja $$2, dsk $$3, ja $$4, jf $$5, int $$6) {
      boolean $$7 = a($$1);
      boolean $$8 = a($$3);
      if ($$7 && $$8) {
         return $$6;
      } else {
         ewy $$9 = $$7 ? ewv.a() : $$1.c($$0, $$2);
         ewy $$10 = $$8 ? ewv.a() : $$3.c($$0, $$4);
         return ewv.b($$9, $$10, $$5) ? 16 : $$6;
      }
   }

   public static ewy a(dbl $$0, ja $$1, dsk $$2, jf $$3) {
      return a($$2) ? ewv.a() : $$2.a($$0, $$1, $$3);
   }
   ...
   protected dsk c(ja $$0) {
      int $$1 = kc.a($$0.u());
      int $$2 = kc.a($$0.w());
      dus $$3 = this.a($$1, $$2);
      return $$3 == null ? dfj.F.o() : $$3.a_($$0);
   }

   protected int a(dsk $$0, ja $$1) {
      return Math.max(1, $$0.b(this.e.q(), $$1));
   }

   protected boolean a(long $$0, dsk $$1, long $$2, dsk $$3, jf $$4) {
      ewy $$5 = this.a($$1, $$0, $$4);
      ewy $$6 = this.a($$3, $$2, $$4.g());
      return ewv.b($$5, $$6);
   }

   protected ewy a(dsk $$0, long $$1, jf $$2) {
      return a(this.e.q(), this.k.f($$1), $$0, $$2);
   }

   @Nullable
   protected dus a(int $$0, int $$1) {
      long $$2 = dbm.c($$0, $$1);
   ...
   public void a(long $$0, @Nullable dul $$1) {
      this.f.a($$0, $$1);
   }
