...
public class eny extends esq {
   private static final aew s = new aew("widget/slot_frame");
   private static final aew t = new aew("icon/checkmark");
   public static final aew a = new aew("textures/gui/realms/empty_frame.png");
   public static final aew b = new aew("minecraft", "textures/gui/title/background/panorama_0.png");
   public static final aew c = new aew("minecraft", "textures/gui/title/background/panorama_2.png");
   public static final aew d = new aew("minecraft", "textures/gui/title/background/panorama_3.png");
