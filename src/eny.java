...
public class eny {
   ...
   public static final eny.a bv;

   public static eny.a a(int $$0, int $$1) {
      return $$0 == -1 ? eny.b.b.a($$1) : eny.b.a.a($$0);
   }

   public static eny.a a(String $$0) {
      if (eny.a.e.containsKey($$0)) {
         return eny.a.e.get($$0);
      } else {
         for (eny.b $$1 : eny.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eny.b b;
      private final int c;
      private final att<vb> d;
      static final Map<String, eny.a> e = Maps.newHashMap();

      a(String $$0, eny.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new att<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vb.b($$2.toUpperCase(Locale.ROOT)) : vb.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vb.b($$2) : vb.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> se.a().b($$1) ? vb.c($$1) : vb.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eny.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vb> g;

      private static void a(eny.b $$0, String $$1, int $$2) {
         eny.a $$3 = new eny.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vb> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eny.a a(int $$0) {
         return (eny.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
