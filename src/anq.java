...
public class anq extends aob<anq.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public anq(anv $$0, List<anp> $$1, Executor $$2, Executor $$3, CompletableFuture<asz> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         AtomicLong $$6 = new AtomicLong();
         AtomicLong $$7 = new AtomicLong();
         bdk $$8 = new bdk(ac.b, () -> 0, false);
         bdk $$9 = new bdk(ac.b, () -> 0, false);
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new anq.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<anq.a> a(List<anq.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
   ...
   public static class a {
      ...
      a(String $$0, bdq $$1, bdq $$2, AtomicLong $$3, AtomicLong $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
