...
public class anq {
   ...
   private static int a(du $$0, Collection<? extends ciu> $$1, int $$2) {
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> vu.a("commands.warden_spawn_tracker.set.success.single", $$1.iterator().next().O_()), true);
      } else {
         $$0.a(() -> vu.a("commands.warden_spawn_tracker.set.success.multiple", $$1.size()), true);
      }
   ...
   private static int a(du $$0, Collection<? extends ciu> $$1) {
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> vu.a("commands.warden_spawn_tracker.clear.success.single", $$1.iterator().next().O_()), true);
      } else {
         $$0.a(() -> vu.a("commands.warden_spawn_tracker.clear.success.multiple", $$1.size()), true);
      }
