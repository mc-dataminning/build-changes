...
public class anq {
   ...
   public static int a(et $$0, jm<elb> $$1, akr $$2, int $$3, jd $$4) throws CommandSyntaxException {
      aqu $$5 = $$0.e();
      dcd $$6 = new dcd($$4);
      a($$5, $$6, $$6);
      if (!ekv.a($$5, $$1, $$2, $$3, $$4, false)) {
         throw b.create();
      } else {
   ...
   public static int b(et $$0, jm.c<ejr> $$1, jd $$2) throws CommandSyntaxException {
      aqu $$3 = $$0.e();
      ejr $$4 = $$1.a();
      duz $$5 = $$3.l().g();
      ejz $$6 = $$4.a($$0.v(), $$5, $$5.d(), $$3.l().i(), $$3.q(), $$3.C(), new dcd($$2), 0, $$3, $$0x -> true);
      if (!$$6.b()) {
         throw c.create();
      } else {
         ejj $$7 = $$6.a();
         ...
         a($$3, $$8, $$9);
         dcd.a($$8, $$9).forEach($$3x -> $$6.a($$3, $$3.a(), $$5, $$3.E_(), new ejj($$3x.d(), $$3.I_(), $$3x.e(), $$3x.f(), $$3.am(), $$3x.g()), $$3x));
   ...
   public static int a(et $$0, akr $$1, jd $$2, dmm $$3, dkv $$4, float $$5, int $$6) throws CommandSyntaxException {
      ...
      if ($$9.isEmpty()) {
         ...
         if ($$5 < 1.0F) {
            $$13.b().a(new emw($$5)).a(drx.b((long)$$6));
         }
