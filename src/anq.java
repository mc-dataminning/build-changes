...
public class anq {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wo.c("commands.op.failed"));
   ...
   private static int a(ex $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if (!$$2.f($$4)) {
            $$2.a($$4);
            $$3++;
            $$0.a(() -> wo.a("commands.op.success", $$1.iterator().next().getName()), true);
         }
      }
