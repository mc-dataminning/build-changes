...
public class anq {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ww.c("commands.help.failed"));
                     ...
                     $$1 -> {
                        ...
                        if ($$2.getContext().getNodes().isEmpty()) {
                           ...
                           for (String $$4 : $$3.values()) {
                              ((ei)$$1.getSource()).a(() -> ww.b("/" + $$2.getReader().getString() + " " + $$4), false);
                           }
