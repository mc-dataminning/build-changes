...
public class fbv {
   public static List<fcv> a(fbv.a... $$0) {
      for (fbv.a $$1 : $$0) {
         a($$1.j);
      }

      List<fcv> $$2 = Lists.newArrayList();

      for (fbv.a $$3 : $$0) {
         $$2.add(new fcv($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fcv::a));
      return $$2;
   }
   ...
   public static List<fcv> a() {
      return a(fbv.a.values());
   }
