...
public abstract class fbv extends fau {
   private final dgm b;
   private dgn c;
   private final String[] k;
   private final boolean l;
   protected final div a;
   private int m;
   private int n;
   @Nullable
   private exr o;

   public fbv(dgm $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, ur.c("sign.edit"));
   }

   public fbv(dgm $$0, boolean $$1, boolean $$2, ur $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = dbz.a($$0.q().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(ur::getString).toArray(String[]::new);
   }

   @Override
   protected void aP_() {
      this.d(euz.a(uq.d, $$0 -> this.D()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new exr(() -> this.k[this.n], this::a, exr.a(this.f), exr.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   public void aG_() {
      flk $$0 = this.f.I();
      if ($$0 != null) {
         $$0.b(new aed(this.b.p(), this.l, this.k[0], this.k[1], this.k[2], this.k[3]));
      }
   }
   ...
   protected abstract void a(euo var1, dhi var2);
   ...
   private void d(euo $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fti.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(frc.D(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
