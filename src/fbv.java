...
public class fbv extends ath<Map<String, List<fbv.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<fbv.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(fbv.a::a),
                     Codec.LONG.fieldOf("period").forGetter(fbv.a::b),
                     Codec.STRING.fieldOf("title").forGetter(fbv.a::c),
                     Codec.STRING.fieldOf("message").forGetter(fbv.a::d)
                  )
                  .apply($$0, fbv.a::new)
         )
         .listOf()
   ...
   public fbv(ajt $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<fbv.a>> a(atc $$0, bko $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<fbv.a>> $$0, atc $$1, bko $$2) {
      List<fbv.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<fbv.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<fbv.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<fbv.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public fbv.b a(List<fbv.a> $$0, long $$1) {
         this.cancel();
         return new fbv.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (fbv.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> ffx.a(fbp.Q().aA(), ffx.a.f, wg.a($$2.c, $$3), wg.a($$2.d, $$3)));
                  return;
               }
            }
         }
