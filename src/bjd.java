...
public class bjd {
   ...
   private bjd(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bjd a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bjd($$0, $$1);
   }

   public bjd.d a() throws IOException {
      bjd.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bjd.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bjd.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bjd.c $$3 = bjd.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bjd.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bjd.a($$0, $$3);
            }
         }
   ...
   public bjd.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bjd.c> $$2 = this.a().c();
      ...
      bjd.e $$4 = new bjd.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bjd.c b) implements bjd.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bjd.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bjd.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bjd.b> {
      private final List<bjd.b> a;

      d(List<bjd.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bjd.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bjd.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bjd.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bjd.d a() {
         ListIterator<bjd.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bjd.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bjd.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bjd.b> b() {
         return this.a.stream();
      }

      public Set<bjd.c> c() {
         return this.a.stream().map(bjd.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bjd.c b) implements bjd.b {
