...
public class bjd extends bhw {
   public bjd(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bjb.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bkw.a($$0.get("id").asString("minecraft:air"));
