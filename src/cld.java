...
public class cld extends bvh<ckz> {
   ...
   protected boolean a(aqu $$0, ckz $$1) {
      return $$1.at() != bua.a ? false : $$1.dU().c(ccs.o).map($$1x -> b($$1, $$1x)).map($$1x -> {
         if (!$$1x) {
            $$1.dU().b(ccs.aV);
         }
   ...
   protected boolean a(aqu $$0, ckz $$1, long $$2) {
      return $$1.dU().a(ccs.o) && $$1.dU().a(ccs.aV);
   }

   protected void b(aqu $$0, ckz $$1, long $$2) {
      $$1.dU().c(ccs.o).ifPresent($$1x -> $$1.b(bua.q));
      $$1.dU().a(ccs.aW, azs.a, (long)h);
