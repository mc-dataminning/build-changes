...
public class boq {
   ...
   private static void a(bot $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dwx, bpc<bos>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bpc)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dwx, bpc<bos>> $$3 : $$0) {
         bpc<bos> $$4 = (bpc<bos>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dwx)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpa> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bof.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(boo $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), boq::a));
      $$1.add("chunksWritten", this.a($$0.m(), boq::a));
      return $$1;
   }

   private JsonElement a(bov.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(boo $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), boq::a));
      $$1.add("received", this.a($$0.k(), boq::a));
      return $$1;
   }

   private <T> JsonElement a(box<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bou> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bou>, ToDoubleFunction<bou>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bou::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bou::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bou::c));
      return $$1;
   }
}
