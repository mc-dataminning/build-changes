...
public abstract class boq<R extends Runnable> implements bny, bos<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected boq(String $$0) {
      this.b = $$0;
      bnw.a.a(this);
   }
   ...
   @Override
   public List<bnv> bu() {
      return ImmutableList.of(bnv.a(this.b + "-pending-tasks", bnu.b, this::bw));
   }
}
