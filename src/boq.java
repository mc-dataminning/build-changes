public abstract class boq extends bok {
   protected static final float bS = 0.0F;

   protected boq(bnw<? extends boq> $$0, cvr $$1) {
      super($$0, $$1);
   }
   ...
   public boolean gd() {
      if (this.bz.a(bxl.Z)) {
         return this.bz.c(bxl.Z).isPresent();
      } else {
         for (bwt $$0 : this.bO.b()) {
            if ($$0.h() && $$0.k() instanceof bvy) {
               return true;
            }
         }
   ...
   protected void fT() {
      ...
      if ($$0 != null && $$0.dM() == this.dM()) {
         this.a($$0.dm(), 5);
         float $$1 = this.e($$0);
         if (this instanceof bpe && ((bpe)this).A()) {
            if ($$1 > 10.0F) {
               this.a(true, true);
            }
         ...
         if ($$1 > 10.0F) {
            ...
            this.bO.b(bvf.a.a);
            float $$5 = 2.0F;
            enz $$6 = new enz($$0.dr() - this.dr(), $$0.dt() - this.dt(), $$0.dx() - this.dx()).d().a((double)Math.max($$1 - 2.0F, 0.0F));
