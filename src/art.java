...
public class art {
   ...
   final List<vt> g = Collections.synchronizedList(Lists.newArrayList());

   public art(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (art.this.e.an()) {
                  $$1.addLast("legacy_query", new aro(art.this.d()));
               }

               vt.a($$1, zh.a, false, null);
               int $$2 = art.this.e.o();
               vt $$3 = (vt)($$2 > 0 ? new wj($$2) : new vt(zh.a));
               art.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new arv(art.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wz $$3 = wz.b("Internal server error");
                     $$1.a(new zp($$3), wg.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<art.a.a> d = Lists.newArrayList();
