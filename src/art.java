...
public class art implements AutoCloseable {
   ...
   private art(URL $$0, art.c $$1, URL $$2, art.b $$3, URL $$4, art.b $$5, String $$6, art.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static art a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = axv.a($$0);
            URI $$2 = new URI(axv.i($$1, "apiServer"));
            String $$3 = axv.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axv.a($$1, "ruleId", 1);
               String $$5 = axv.a($$1, "serverId", "");
               String $$6 = axv.a($$1, "roomId", "Java:Chat");
               int $$7 = axv.a($$1, "hashesToDrop", -1);
               int $$8 = axv.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axv.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, art.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<arf> a(GameProfile $$0, String $$1, art.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arf.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = axv.a($$4, "response", false);
            if ($$5) {
               return arf.a($$1);
            } else {
               String $$6 = axv.a($$4, "hashed", null);
               if ($$6 == null) {
                  return arf.b($$1);
               } else {
                  JsonArray $$7 = axv.v($$4, "hashes");
                  xb $$8 = this.a($$1, $$7, $$2);
                  return new arf($$1, $$8);
               }
            }
   ...
   private xb a(String $$0, JsonArray $$1, art.a $$2) {
      if ($$1.isEmpty()) {
         return xb.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new art.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public ars a(GameProfile $$0) {
      return new art.d($$0);
   }
   ...
   public interface a {
      art.a a = ($$0, $$1) -> false;
      art.a b = ($$0, $$1) -> $$0.length() == $$1;

      static art.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static art.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ars {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bop<Runnable> $$1 = bop.a(art.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         art.this.a(this.c, art.this.g, art.this.h, this.d);
      }

      @Override
      public void b() {
         art.this.a(this.c, art.this.i, art.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<arf>> a(List<String> $$0) {
         List<CompletableFuture<arf>> $$1 = $$0.stream().map($$0x -> art.this.a(this.c, $$0x, art.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arf> a(String $$0) {
         return art.this.a(this.c, $$0, art.this.l, this.d);
      }
   }
