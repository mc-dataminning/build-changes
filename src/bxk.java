...
public class bxk extends bwj {
   private static final afm<ht> bW = afp.a(bxk.class, afo.n);
   private static final afm<Boolean> bX = afp.a(bxk.class, afo.k);
   private static final afm<Boolean> bY = afp.a(bxk.class, afo.k);
   private static final afm<ht> bZ = afp.a(bxk.class, afo.n);
   private static final afm<Boolean> ca = afp.a(bxk.class, afo.k);
   private static final afm<Boolean> cb = afp.a(bxk.class, afo.k);
   public static final coc bT = coc.a(cuv.bw.k());
   int cc;
   public static final Predicate<bky> bU = $$0 -> $$0.n_() && !$$0.aX();

   public bxk(bkm<? extends bxk> $$0, crs $$1) {
      super($$0, $$1);
      this.a(ecr.j, 0.0F);
      this.a(ecr.t, -1.0F);
      this.a(ecr.s, -1.0F);
      this.a(ecr.r, -1.0F);
      this.bL = new bxk.e(this);
      this.t(1.0F);
   }
   ...
   public static boolean c(bkm<bxk> $$0, crt $$1, blc $$2, ht $$3, ato $$4) {
      return $$3.v() < $$1.z_() + 4 && ddi.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void z() {
      this.bO.a(0, new bxk.f(this, 1.2));
      this.bO.a(1, new bxk.a(this, 1.0));
      this.bO.a(1, new bxk.d(this, 1.0));
      this.bO.a(2, new btb(this, 1.1, bT, false));
      this.bO.a(3, new bxk.c(this, 1.0));
      this.bO.a(4, new bxk.b(this, 1.0));
      this.bO.a(7, new bxk.i(this, 1.0));
      this.bO.a(8, new bsb(this, cdm.class, 8.0F));
      this.bO.a(9, new bxk.h(this, 1.0, 100));
   }

   public static bmd.a y() {
      return bla.A().a(bme.l, 30.0).a(bme.m, 0.25);
   }
   ...
   @Override
   protected aqm w() {
      return !this.aX() && this.aA() && !this.n_() ? aqn.ym : super.w();
   }
   ...
   protected aqm d(bjg $$0) {
      return this.n_() ? aqn.yt : aqn.ys;
   }

   @Nullable
   @Override
   protected aqm m_() {
      return this.n_() ? aqn.yo : aqn.yn;
   }

   @Override
   protected void b(ht $$0, dgw $$1) {
      aqm $$2 = this.n_() ? aqn.yw : aqn.yv;
      this.a($$2, 0.15F, 1.0F);
   }
   ...
   protected buh b(crs $$0) {
      return new bxk.g(this, $$0);
   }

   @Nullable
   @Override
   public bkd a(ama $$0, bkd $$1) {
      return bkm.bd.a((crs)$$0);
   }
   ...
   public float a(ht $$0, crv $$1) {
      if (!this.gl() && $$1.b_($$0).a(arh.a)) {
         return 10.0F;
      } else {
         return ddi.a($$1, $$0) ? 10.0F : $$1.v($$0);
      }
   }
   ...
   public void c_() {
      ...
      if (this.bv() && this.t() && this.cc >= 1 && this.cc % 5 == 0) {
         ht $$0 = this.dl();
         if (ddi.a(this.dL(), $$0)) {
            this.dL().c(2001, $$0, cut.i(this.dL().a_($$0.d())));
            this.a(dlg.u);
         }
      }
   }
   ...
   static class a extends brf {
      ...
      protected void g() {
         ...
         ato $$1 = this.a.ef();
         if (this.b.X().b(cro.f)) {
            this.b.b(new bko(this.b, this.a.dq(), this.a.ds(), this.a.dw(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends brt {
      ...
      public void e() {
         ...
         if (this.a.L().l()) {
            eji $$2 = eji.c($$0);
            eji $$3 = bvo.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = bvo.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dL().a_(ht.a($$3)).a(cuv.G)) {
               $$3 = bvo.a(this.a, 16, 5, $$2, (float) (Math.PI / 2));
            }
   ...
   static class d extends bsg {
      ...
      public void e() {
         ...
         if (!this.g.aX() && this.m()) {
            if (this.g.cc < 1) {
               ...
               crs $$1 = this.g.dL();
               $$1.a(null, $$0, aqn.yu, aqo.e, 0.3F, 0.9F + $$1.z.i() * 0.2F);
               ht $$2 = this.e.c();
               dgw $$3 = cuv.mf.o().a(ddi.f, Integer.valueOf(this.g.ag.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(dlg.i, $$2, dlg.a.a(this.g, $$3));
               this.g.w(false);
               this.g.x(false);
               this.g.s(600);
            }
      ...
      @Override
      protected boolean a(crv $$0, ht $$1) {
         return !$$0.t($$1.c()) ? false : ddi.b($$0, $$1);
      }
   }
      ...
      public void a() {
         ...
         if (this.k == bqw.a.b && !this.l.L().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aU = this.l.dB();
               float $$5 = (float)(this.h * this.l.b(bme.m));
               this.l.w(ati.i(0.125F, this.l.fe(), $$5));
   ...
   static class g extends bue {
      ...
      public boolean a(ht $$0) {
         if (this.a instanceof bxk $$1 && $$1.gm()) {
            return this.b.a_($$0).a(cuv.G);
         }
   ...
   static class h extends bsq {
      private final bxk i;

      h(bxk $$0, double $$1, int $$2) {
         super($$0, $$1, $$2);
         this.i = $$0;
      }
   ...
   static class i extends brt {
      ...
      public void e() {
         if (this.a.L().l()) {
            eji $$0 = eji.c(this.a.gk());
            eji $$1 = bvo.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
