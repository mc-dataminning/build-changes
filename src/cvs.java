...
public class cvs {
   public static final cvs a = new cvs(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<cvs> b = RecordCodecBuilder.create(
   ...
   public cvs(List<String> $$0, List<String> $$1) {
