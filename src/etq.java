...
public class etq {
   ...
   public void a(eva $$0, String $$1, evw.a $$2, ejo $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  etq.b $$13 = new etq.b($$1.trim(), this.f, $$3, $$2);
                  etq.a $$14 = new etq.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        etq.c $$30 = new etq.c(this.f, $$2, $$0);
                        etq.a $$31 = new etq.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eve(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ejo $$2) throws IOException {
      ...
      File $$15 = new File(eyk.P().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, ejo $$2, evw.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((etq.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !etq.this.b && !etq.this.d) {
            try {
               etq.this.e = true;
               etq.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               etq.a.error("Error extracting archive", var3);
               etq.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final evw.a c;
      private final eva d;

      c(File $$0, evw.a $$1, eva $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((etq.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !etq.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, etq.this.g);
                  etq.this.c = true;
               } else {
                  etq.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  etq.this.d = true;
               }
            } catch (IOException var3) {
               etq.a.error("Error copying resourcepack file: {}", var3.getMessage());
               etq.this.d = true;
            }
         }
      }
