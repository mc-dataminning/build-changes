...
public class etq extends etk<etq.a> {
   protected etq(eac $$0) {
      super(dhq.a, $$0, new etq.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dzu g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kj.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dzu(15) : new dzu();
         }
      }
   }

   private static dzu a(dzu $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends eth<etq.a> {
      ...
      public a(Long2ObjectOpenHashMap<dzu> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
