...
public class zi<B extends ByteBuf, V, T> implements zj<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<zi.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   zi(Function<V, ? extends T> $$0, List<zi.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         xc.a($$0, $$3);
         zi.b<B, V, T> $$4 = this.c.get($$3);

         try {
            zj<? super B, V> $$5 = (zj<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> zi.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new zi.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<zi.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public zi.a<B, V, T> a(T $$0, zj<? super B, ? extends V> $$1) {
         this.a.add(new zi.b<>($$1, $$0));
         return this;
      }
      ...
      public zi<B, V, T> a() {
         ...
         return new zi<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(zj<? super B, ? extends V> a, T b) {
   }
}
