...
public class ace implements yw<abl> {
   ...
   private final int i;
   private final List<ace.b> j;

   public ace(RootCommandNode<fc> $$0) {
   ...
   private static void a(List<ace.b> $$0, BiPredicate<ace.b, IntSet> $$1) {
   ...
   private static void a(List<ace.b> $$0) {
      a($$0, ace.b::a);
      a($$0, ace.b::b);
   }
   ...
   private static List<ace.b> a(Object2IntMap<CommandNode<fc>> $$0) {
      ObjectArrayList<ace.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static ace.b b(vl $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      ace.e $$4 = a($$0, $$1);
      return new ace.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static ace.e a(vl $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
         ...
         if ($$5 == null) {
            ...
            it.a<?> $$6 = $$5.b($$0);
            akv $$7 = ($$1 & 16) != 0 ? $$0.q() : null;
            return new ace.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.p();
         return new ace.c($$8);
   ...
   private static ace.b a(CommandNode<fc> $$0, Object2IntMap<CommandNode<fc>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<fc> a(et $$0) {
      return (RootCommandNode<fc>)new ace.d($$0, this.j).a(this.i);
   }

   static class a implements ace.e {
      ...
      @Nullable
      private static akv a(@Nullable SuggestionProvider<fc> $$0) {
         return $$0 != null ? ix.a($$0) : null;
      }

      a(String $$0, it.a<?> $$1, @Nullable akv $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   static class b {
      ...
      b(@Nullable ace.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements ace.e {
      private final String a;
