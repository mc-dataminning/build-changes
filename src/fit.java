public abstract class fit {
   ...
   public void a(fgr $$0, int $$1, int $$2) {
      int $$3 = $$0.b();
      $$0.a(gdw.E(), $$1, $$3 - 60, $$1 + $$2, $$3, -1873784752);
      long $$4 = 0L;
      long $$5 = 2147483647L;
      long $$6 = -2147483648L;
      ...
      $$0.a(gdw.E(), $$1, $$1 + $$2 - 1, $$3 - 60, -1);
      $$0.a(gdw.E(), $$1, $$1 + $$2 - 1, $$3 - 1, -1);
      $$0.b(gdw.E(), $$1, $$3 - 60, $$3, -1);
      $$0.b(gdw.E(), $$1 + $$2 - 1, $$3 - 60, $$3, -1);
      if ($$8 > 0) {
   ...
   protected void b(fgr $$0, int $$1, int $$2, int $$3) {
      long $$4 = this.e.a($$3);
      int $$5 = this.b((double)$$4);
      int $$6 = this.a($$4);
      $$0.a(gdw.E(), $$2, $$1 - $$5, $$2 + 1, $$1, $$6);
   }

   protected void c(fgr $$0, int $$1, int $$2, int $$3) {
   }
   ...
   protected void d(fgr $$0, int $$1, int $$2, int $$3) {
   }

   protected void a(fgr $$0, String $$1, int $$2, int $$3) {
      $$0.a(gdw.E(), $$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
