public class fit extends fke<bzb> implements fiv {
   private final fmv a;
   private final fmv b;
   private final fmv f;
   private final fmv g;
   ...
   public static fnb b() {
      fnd $$0 = new fnd();
      fne $$1 = $$0.a();
      fne $$2 = $$1.a("root", fna.c(), fmx.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", fna.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new fmz(0.0F)), fmx.a(0.0F, -3.99F, 0.0F));
      fne $$3 = $$2.a(
         "body",
         fna.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new fmz(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new fmz(-0.2F)),
         fmx.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", fna.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fmz(-0.01F)), fmx.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", fna.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fmz(-0.01F)), fmx.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", fna.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fmz(0.0F)), fmx.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", fna.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fmz(0.0F)), fmx.a(0.5F, 0.0F, 0.6F));
