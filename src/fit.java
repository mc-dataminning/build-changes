...
public class fit {
   ...
   public void a(fit.b $$0, List<atf> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fit.c($$0, $$1.stream().map(atf::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fit.c(fit.b.c, ImmutableList.of());
      }

      this.b.c = new fit.a($$0);
   }
