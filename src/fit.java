...
public class fit extends fii implements fjn {
   private static final fjx d = new fjx(akr.b("widget/text_field"), akr.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, aya> D = ($$0x, $$1x) -> aya.forward($$0x, xw.a);
   @Nullable
   private wz E;
   private long F = ad.c();

   public fit(fhv $$0, int $$1, int $$2, wz $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fit(fhv $$0, int $$1, int $$2, int $$3, int $$4, wz $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fit(fhv $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fit $$5, wz $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, aya> $$0) {
      this.D = $$0;
   }
   ...
   protected xn aQ_() {
      wz $$0 = this.z();
      return wz.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = ayo.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayo.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fob.s());
   }
   ...
   public void b(fhx $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.f()) {
            akr $$4 = d.a(this.C(), this.aO_());
            $$0.a($$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         boolean $$9 = this.aO_() && (ad.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = ayo.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gff.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = ayo.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayo.a(this.v, 0, this.p.length());
      }
   }
   ...
   public int p(int $$0) {
      return $$0 > this.p.length() ? this.D() : this.D() + this.o.b(this.p.substring(0, $$0));
   }
