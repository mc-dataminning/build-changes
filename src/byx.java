...
public class byx {
   ...
   public static bxa<bvo> a(float $$0) {
      ...
      return cam.a(
         (Function<cam.b<bvo>, ? extends App<cam.c<bvo>, cap<bvo>>>)($$3 -> $$3.group($$3.c(cek.m), $$3.c(cek.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.ad() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cgk $$7 = $$4x.A();
                        Optional<ji> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cgo.n), $$5.dw(), 48, cgk.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dw()) <= 4.0)) {
                           ...
                           Set<Pair<jr<cgn>, ji>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cgo.n), $$10, $$5.dw(), 48, cgk.b.c).collect(Collectors.toSet());
                           etn $$12 = bws.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ji $$13 = $$12.l();
                              Optional<jr<cgn>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cen($$13, $$0, 1));
                                 agc.c($$4x, $$13);
                              }
