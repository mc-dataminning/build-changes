...
public record wk<S>(List<wk.a<S>> a) {
   public static <S> wk<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<wk.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<wk.a<S>> $$2 = new ArrayList<>();
