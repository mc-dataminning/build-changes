...
public class wk extends SimpleChannelInboundHandler<zw<?>> {
   ...
   private static final wx<aja> j = aiz.a;
   private final zx k;
   private volatile boolean l = true;
   private final Queue<Consumer<wk>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
   private SocketAddress o;
   @Nullable
   private volatile wv p;
   @Nullable
   private volatile wv q;
   @Nullable
   private xp r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xp.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof xc) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xp.c("disconnect.timeout"));
            } else {
               xp $$3 = xp.a("disconnect.genericReason", "Internal Exception: " + $$1);
               if ($$2) {
                  i.debug("Failed to sent packet", $$1);
                  if (this.g() == zx.b) {
                     zw<?> $$4 = (zw<?>)(this.l ? new ajh($$3) : new aae($$3));
                     this.a($$4, ww.a(() -> this.a($$3)));
                  } else {
                     this.a($$3);
                  }
         ...
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xp.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(xp.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wv> void a(zw<T> $$0, wv $$1) {
      $$0.a((T)$$1);
   }

   private void b(wx<?> $$0, wv $$1) {
   ...
   public <T extends wv> void a(wx<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wv $$0) {
      ...
      } else if (this.k == zx.a && $$0.a() == zx.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, akc $$2) {
      this.a($$0, $$1, aki.a, aki.b, $$2, aiw.a);
   }

   public void a(String $$0, int $$1, ajc $$2) {
      this.a($$0, $$1, ajj.a, ajj.b, $$2, aiw.b);
   }

   public <S extends xb, C extends wh> void a(String $$0, int $$1, wx<S> $$2, wx<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? aiw.c : aiw.b);
   }

   private <S extends xb, C extends wh> void a(String $$0, int $$1, wx<S> $$2, wx<C> $$3, C $$4, aiw $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<wk>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new aix(aa.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zw<?> $$0, @Nullable ww $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zw<?> $$0, @Nullable ww $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zw<?> $$0, @Nullable ww $$1, boolean $$2) {
   ...
   protected void c() {
      this.x = ayz.i(0.75F, (float)this.v, this.x);
      this.w = ayz.i(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static wk a(InetSocketAddress $$0, boolean $$1, @Nullable blu $$2) {
      wk $$3 = new wk(zx.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final wk $$2) {
   ...
   public static void a(ChannelPipeline $$0, zx $$1, boolean $$2, @Nullable wd $$3) {
      zx $$4 = $$1.a();
      boolean $$5 = $$1 == zx.a;
      boolean $$6 = $$4 == zx.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wt<aja>(j) : new xe.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wu<aja>(j) : new xe.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wq() : new xj());
   }

   private static ChannelInboundHandler a(@Nullable wd $$0, boolean $$1) {
      if (!$$1) {
         return new xi($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wo($$0) : new wp());
      }
   }
   ...
   public static wk a(SocketAddress $$0) {
      final wk $$1 = new wk(zx.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new wf($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new wg($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof wi $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new wi($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof wj $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new wj($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof wi) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof wj) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wv $$0 = this.k();
            wv $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               xp $$2 = Objects.requireNonNullElseGet(this.l(), () -> xp.c("multiplayer.disconnect.generic"));
               $$1.a($$2);
            }
         }
      }
