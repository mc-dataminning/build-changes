...
class aog implements Path {
   private static final BasicFileAttributes a = new aoe() {
      @Override
   ...
   private static final BasicFileAttributes b = new aoe() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aog> c = Comparator.comparing(aog::n);
   ...
   public aog(aoi $$0, String $$1, @Nullable aog $$2, aoj $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aog a(@Nullable aog $$0, String $$1) {
      return new aog(this.e, $$1, $$0, aoj.b);
   }
   ...
   aog a(String $$0) {
      if (a(this.i)) {
         return new aog(this.e, $$0, this, this.i);
      } else if (this.i instanceof aoj.a $$1) {
         aog $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aog(this.e, $$0, this, aoj.a);
      } else if (this.i instanceof aoj.b) {
         return new aog(this.e, $$0, this, aoj.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aoj $$0) {
      return $$0 == aoj.a || $$0 == aoj.b;
   }
   ...
   private aog c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aog $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aoj.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aoj.a i() {
      return this.i instanceof aoj.a $$0 ? $$0 : null;
   }
