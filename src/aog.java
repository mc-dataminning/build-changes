...
public abstract class aog {
   ...
   private final List<akr> l = Lists.newArrayList();
   private final Map<UUID, akr> m = Maps.newHashMap();
   private final aom n = new aom(b);
   private final aod o = new aod(c);
   private final aoh p = new aoh(d);
   private final aoo q = new aoo(e);
   private final Map<UUID, apj> r = Maps.newHashMap();
   private final Map<UUID, afe> s = Maps.newHashMap();
   private final ecj t;
   private boolean u;
   private final hl<aff> v;
   ...
   public aog(MinecraftServer $$0, hl<aff> $$1, ecj $$2, int $$3) {
      this.k = $$0;
      this.v = $$1;
      this.h = $$3;
      this.t = $$2;
   ...
   public void a(sm $$0, akr $$1, alf $$2) {
      GameProfile $$3 = $$1.fQ();
      aoc $$4 = this.k.ap();
      String $$6;
      if ($$4 != null) {
      ...
      qw $$8 = this.a($$1);
      aev<cpv> $$9 = $$8 != null ? dis.a(new Dynamic(ri.a, $$8.c("Dimension"))).resultOrPartial(a::error).orElse(cpv.h) : cpv.h;
      akq $$10 = this.k.a($$9);
      akq $$11;
      if ($$10 == null) {
      ...
      ecd $$14 = $$11.z_();
      $$1.c($$8);
      alp $$15 = new alp(this.k, $$0, $$1, $$2);
      cpr $$16 = $$11.X();
      boolean $$17 = $$16.b(cpr.B);
      boolean $$18 = $$16.b(cpr.p);
      boolean $$19 = $$16.b(cpr.v);
      $$15.b(new yl($$1.ah(), $$14.n(), this.k.E(), this.n(), this.w, this.x, $$18, !$$17, $$19, $$1.d($$11)));
      $$15.b(new xi($$14.s(), $$14.t()));
      $$15.b(new yu($$1.fS()));
      $$15.b(new zs($$1.fR().l));
      $$15.b(new aay(this.k.aE().b()));
      this.d($$1);
      $$1.F().c();
      $$1.G().a($$1);
      this.a($$11.f(), $$1);
      ...
      this.l.add($$1);
      this.m.put($$1.cv(), $$1);
      this.a(za.a(List.of($$1)));
      this.a($$1, $$11);
      $$11.c($$1);
      this.k.aJ().a($$1);

      for (bid $$23 : $$1.er()) {
         $$15.b(new aax($$1.ah(), $$23));
      }
   ...
   protected void b(akr $$0) {
      this.t.a($$0);
      apj $$1 = this.r.get($$0.cv());
      if ($$1 != null) {
         $$1.a();
      }

      afe $$2 = this.s.get($$0.cv());
      if ($$2 != null) {
         $$2.b();
      }
   }
   ...
   public tl a(SocketAddress $$0, GameProfile $$1) {
      if (this.n.a($$1)) {
         aon $$2 = this.n.b($$1);
         ty $$3 = tl.a("multiplayer.disconnect.banned.reason", $$2.d());
         if ($$2.c() != null) {
         ...
         aoe $$4 = this.o.b($$0);
         ty $$5 = tl.a("multiplayer.disconnect.banned_ip.reason", $$4.d());
         if ($$4.c() != null) {
   ...
   public akr a(GameProfile $$0, akf $$1) {
      return new akr(this.k, this.k.D(), $$0, $$1);
   }

   public boolean e(GameProfile $$0) {
      UUID $$1 = $$0.getId();
      Set<akr> $$2 = Sets.newIdentityHashSet();
   ...
   public akr a(akr $$0, boolean $$1) {
      ...
      akq $$8 = $$5 != null && $$6.isPresent() ? $$5 : this.k.D();
      akr $$9 = new akr(this.k, $$8, $$0.fQ(), $$0.z());
      $$9.c = $$0.c;
      $$9.a($$0, $$1);
      $$9.e($$0.ah());
      $$9.a($$0.fl());
      ...
      if ($$6.isPresent()) {
         ...
         if (!$$12.a(aps.R) && !$$13) {
            ...
            $$17 = (float)arw.d(arw.d($$15.e, $$15.c) * 180.0F / (float)Math.PI - 90.0);
         }
      ...
      akq $$19 = $$9.x();
      ecd $$20 = $$19.z_();
      $$9.c.b(new zg($$9.d($$19), $$18));
      $$9.c.a($$9.dq(), $$9.ds(), $$9.dw(), $$9.dB(), $$9.dD());
      $$9.c.b(new zv($$8.R(), $$8.S()));
      $$9.c.b(new xi($$20.s(), $$20.t()));
      $$9.c.b(new aab($$9.ch, $$9.cg, $$9.cf));
      this.a($$9, $$8);
      this.d($$9);
      $$8.d($$9);
      this.l.add($$9);
      ...
      $$9.c($$9.eu());
      if ($$11) {
         $$9.c.b(new aan(apd.tL, ape.e, (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), 1.0F, 1.0F, $$8.D_().g()));
      }
   ...
   public void d() {
      if (++this.A > 600) {
         this.a(new za(EnumSet.of(za.a.e), this.l));
         this.A = 0;
      }
   }
   ...
   public void a(GameProfile $$0) {
      this.p.a(new aoi($$0, this.k.i(), this.p.a($$0)));
      akr $$1 = this.a($$0.getId());
      if ($$1 != null) {
         this.d($$1);
      }
   }
   ...
   public void a(@Nullable cbu $$0, double $$1, double $$2, double $$3, double $$4, aev<cpv> $$5, vd<?> $$6) {
   ...
   public void a(akr $$0, akq $$1) {
      dha $$2 = this.k.D().B_();
      $$0.c.b(new ye($$2));
      $$0.c.b(new aaj($$1.V(), $$1.W(), $$1.X().b(cpr.k)));
      $$0.c.b(new zv($$1.R(), $$1.S()));
      if ($$1.Z()) {
         $$0.c.b(new yb(yb.b, 0.0F));
         $$0.c.b(new yb(yb.h, $$1.d(1.0F)));
         $$0.c.b(new yb(yb.i, $$1.b(1.0F)));
      }
   }
   ...
   public void a(tl $$0, Function<akr, tl> $$1, boolean $$2) {
      this.k.a($$0);
   ...
   public void a(ua $$0, dt $$1, th.a $$2) {
      this.a($$0, $$1::a, $$1.i(), $$2);
   }

   public void a(ua $$0, akr $$1, th.a $$2) {
      this.a($$0, $$1::b, $$1, $$2);
   }

   private void a(ua $$0, Predicate<akr> $$1, @Nullable akr $$2, th.a $$3) {
      boolean $$4 = this.a($$0);
   ...
   public afe f(akr $$0) {
      ...
      if ($$2 == null) {
         ...
         $$2 = new afe(this.k.ay(), this, this.k.az(), $$3, $$0);
         this.s.put($$1, $$2);
      }
   ...
   public void u() {
      for (afe $$0 : this.s.values()) {
         $$0.a(this.k.az());
      }

      this.a(new vm(aqk.a(this.v)));
      aay $$1 = new aay(this.k.aE().b());
