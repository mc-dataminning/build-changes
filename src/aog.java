...
public class aog {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xa.c("commands.pardon.failed"));
   ...
   private static int a(ej $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if ($$2.a($$4)) {
            $$2.c($$4);
            $$3++;
            $$0.a(() -> xa.a("commands.pardon.success", xa.b($$4.getName())), true);
         }
      }
