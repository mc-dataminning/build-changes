...
public class hcq extends us {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private hcq(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static hcq a(avv $$0, List<String> $$1, boolean $$2) {
