...
public abstract class gcr {
   ...
   protected static final gcr.k aK = new gcr.k("outline_target", () -> feb.Q().f.s().a(false), () -> feb.Q().h().a(false));
   ...
   private static void a(float $$0) {
      long $$1 = (long)((double)ac.c() * feb.Q().m.am().c() * 8.0);
         ...
         super("line_width", () -> {
            if (!Objects.equals($$0, OptionalDouble.of(1.0))) {
               if ($$0.isPresent()) {
                  ...
                  RenderSystem.lineWidth(Math.max(2.5F, (float)feb.Q().aO().k() / 1920.0F * 2.5F));
               }
            }
         }, () -> {
            if (!Objects.equals($$0, OptionalDouble.of(1.0))) {
   ...
   protected static class i extends gcr.e {
      private final Optional<akn> aT;

      i(ImmutableList<Triple<akn, Boolean, Boolean>> $$0) {
         super(() -> {
            int $$1 = 0;
            UnmodifiableIterator var2 = $$0.iterator();

            while (var2.hasNext()) {
               Triple<akn, Boolean, Boolean> $$2 = (Triple<akn, Boolean, Boolean>)var2.next();
               gnw $$3 = feb.Q().aa();
               $$3.b((akn)$$2.getLeft()).a((Boolean)$$2.getMiddle(), (Boolean)$$2.getRight());
               RenderSystem.setShaderTexture($$1++, (akn)$$2.getLeft());
            }
         }, () -> {
         });
      ...
      public static final class a {
         private final Builder<Triple<akn, Boolean, Boolean>> a = new Builder();

         public gcr.i.a a(akn $$0, boolean $$1, boolean $$2) {
   ...
   protected static class n extends gcr.e {
      ...
      public n(akn $$0, boolean $$1, boolean $$2) {
         super(() -> {
            gnw $$3 = feb.Q().aa();
            $$3.b($$0).a($$1, $$2);
