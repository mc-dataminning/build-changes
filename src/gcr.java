...
public class gcr implements gdk {
   ...
   private CompletableFuture<Optional<cot>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gcr(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cot::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cot>> a(Optional<cot> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cot.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cot $$0) {
      ...
      if ($$0 != null) {
         if (ab.aV) {
            cot.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cot a(UserApiService $$0) throws aym, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cou.a $$2 = a($$1);
         return new cot(ayl.a($$1.keyPair().privateKey()), new cou($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cou.a a(KeyPairResponse $$0) throws aym {
      KeyPair $$1 = $$0.keyPair();
