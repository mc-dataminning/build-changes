...
public abstract class gcr<T extends cwu> implements fud, fux, fwv {
   public static final fun a = new fun(alg.b("recipe_book/button"), alg.b("recipe_book/button_highlighted"));
   ...
   private dfm s;
   private final gcp u;
   private final List<gct> v = Lists.newArrayList();
   @Nullable
   private gct w;
   protected fug e;
   protected final T f;
   ...
   public gcr(T $$0, List<gcr.a> $$1) {
      this.f = $$0;
      this.z = $$1;
      gcy $$2 = () -> azm.d(this.r / 30.0F);
      this.u = new gcp($$2);
      this.B = new gcs(this, $$2, $$0 instanceof cvh);
   }

   public void a(int $$0, int $$1, fpt $$2, boolean $$3) {
      this.g = $$2;
      this.p = $$0;
      this.q = $$1;
      this.I = $$3;
   ...
   private void i() {
      ...
      this.x = new ftj(this.g.h, $$1 + 25, $$2 + 13, 81, 9 + 5, wy.c("itemGroup.search"));
      this.x.f(50);
      this.x.g(true);
      this.x.m(16777215);
      this.x.a($$3);
      this.x.c(j);
      this.J = fxh.a(fxe.a, $$1 + 8, this.x.G(), this.x.F() - this.l(), this.x.y());
      this.B.a(this.g, $$1, $$2);
      this.e = new fug($$1 + 110, $$2 + 12, 26, 16, $$0);
      this.m();
      this.a();
      this.v.clear();

      for (gcr.a $$4 : this.z) {
         this.v.add(new gct($$4));
      }
   ...
   private void m() {
      this.e.a(this.e.a() ? ful.a(this.b()) : ful.a(m));
   }
   ...
   protected abstract boolean a(cxc var1);

   public void b(@Nullable cxc $$0) {
      if ($$0 != null && this.a($$0)) {
         this.s = null;
         this.u.a();
         if (this.d()) {
   ...
   private void o() {
      for (gcr.a $$0 : this.z) {
         for (gcv $$1 : this.A.a($$0.c())) {
            this.a($$1, this.E);
         }
      }
   }

   protected abstract void a(gcv var1, crs var2);

   private void a(boolean $$0, boolean $$1) {
      List<gcv> $$2 = this.A.a(this.w.b());
      List<gcv> $$3 = Lists.newArrayList($$2);
      $$3.removeIf($$0x -> !$$0x.b());
      String $$4 = this.x.a();
      if (!$$4.isEmpty()) {
         gkr $$5 = this.g.L();
         if ($$5 != null) {
            ObjectSet<gcv> $$6 = new ObjectLinkedOpenHashSet($$5.D().b().search($$4.toLowerCase(Locale.ROOT)));
   ...
   public void a(fsm $$0, int $$1, int $$2, float $$3) {
      if (this.d()) {
         ...
         int $$4 = this.l();
         int $$5 = this.k();
         $$0.a(grc::H, b, $$4, $$5, 1.0F, 1.0F, 147, 166, 256, 256);
         this.x.a($$0, $$1, $$2, $$3);
   ...
   public void a(fsm $$0, int $$1, int $$2, @Nullable cxc $$3) {
      if (this.d()) {
         this.B.a($$0, $$1, $$2);
   ...
   private boolean a(gcv $$0, dfm $$1) {
      if (!$$0.a($$1) && $$1.equals(this.s)) {
         return false;
      } else {
         this.s = $$1;
         this.u.a();
         this.g.r.a(this.g.t.bR.l, $$1, fys.t());
         return true;
      }
   }
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (!this.d() || this.g.t.V_()) {
         ...
         this.x.a(true);
         return true;
      } else if (fxc.a($$0) && this.D != null && this.C != null) {
         fsy.b(fpt.Q().ak());
   ...
   public void a(dfk $$0) {
      this.u.a();
      baz $$1 = dfr.a(Objects.requireNonNull(this.g.s));
      this.a(this.u, $$0, $$1);
   }

   protected abstract void a(gcp var1, dfk var2, baz var3);
   ...
   @Override
   public fwv.a w() {
      return this.H ? fwv.a.b : fwv.a.a;
   }

   @Override
   public void b(fwx $$0) {
      List<fwv> $$1 = Lists.newArrayList();
      this.B.a($$1x -> {
         if ($$1x.E()) {
            $$1.add($$1x);
         }
      ...
      $$1.add(this.e);
      $$1.addAll(this.v);
      fys.b $$2 = fys.a($$1, null);
      if ($$2 != null) {
         $$2.a.b($$0.a());
      }
   }

   public static record a(czn a, Optional<czn> b, ddw c) {
      public a(gcx $$0) {
         this(new czn(czr.rK), Optional.empty(), $$0);
      }

      public a(czj $$0, deh $$1) {
         this(new czn($$0), Optional.empty(), $$1);
      }

      public a(czj $$0, czj $$1, deh $$2) {
         this(new czn($$0), Optional.of(new czn($$1)), $$2);
      }
   }
}
