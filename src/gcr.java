...
public class gcr extends gby<cet, fnu<cet>> {
   private static final aiy a = new aiy("textures/" + fwa.i.b().a() + ".png");
   private static final aiy[] i = fwa.j.stream().map($$0 -> new aiy("textures/" + $$0.b().a() + ".png")).toArray(aiy[]::new);
   ...
   public boolean a(cet $$0, fyo $$1, double $$2, double $$3, double $$4) {
