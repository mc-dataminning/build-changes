...
public class cjg extends cjr implements bph<cjg.b> {
   private static final aie<Integer> i = aih.a(cjg.class, aig.b);
   private static final aie<Boolean> j = aih.a(cjg.class, aig.k);
   private static final aie<Boolean> k = aih.a(cjg.class, aig.k);
   private static final aie<Integer> l = aih.a(cjg.class, aig.b);
   ...
   public cjg(bnw<? extends cjg> $$0, cvr $$1) {
      super($$0, $$1);
      this.H = true;
   }

   public cjg(cvr $$0, double $$1, double $$2, double $$3) {
      this(bnw.l, $$0);
      this.a_($$1, $$2, $$3);
      this.J = $$1;
      this.K = $$2;
   ...
   public static boolean a(bnq $$0, bnq $$1) {
   ...
   protected enz a(bnq $$0, bnt $$1, float $$2) {
      ...
      return new enz(0.0, this.y() == cjg.b.i ? (double)($$1.b() * 0.8888889F) : (double)($$1.b() / 3.0F), (double)$$3)
   ...
   public void l() {
      this.aM = this.aL;
      this.aL = this.C();
      if (this.aL != cjg.a.b && this.aL != cjg.a.c) {
         this.q = 0.0F;
      } else {
         this.q++;
      }
      ...
      this.aQ();
      List<bnq> $$5 = this.dM().a(this, this.cH().c(0.2F, -0.01F, 0.2F), bnv.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dM().B && !(this.cN() instanceof chl);

         for (bnq $$7 : $$5) {
            if (!$$7.w(this)) {
               if ($$6 && this.cP().size() < this.z() && !$$7.bO() && this.a($$7) && $$7 instanceof boi && !($$7 instanceof caz) && !($$7 instanceof chl)) {
                  $$7.m(this);
               } else {
                  this.g($$7);
               }
   ...
   private void A() {
      if (this.dM().B) {
         ...
         this.aQ = awi.a(this.aQ, 0.0F, 1.0F);
         this.aS = this.aR;
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aP) {
                  ...
                  this.o($$3.c, this.a($$0 -> $$0 instanceof chl) ? 2.7 : 0.6, $$3.e);
               }
            }
   ...
   public float a(int $$0, float $$1) {
      return this.c($$0) ? awi.b(this.o[$$0] - (float) (Math.PI / 8), this.o[$$0], $$1) : 0.0F;
   }
      ...
      for (int $$8 = $$3; $$8 < $$4; $$8++) {
         ...
         for (int $$10 = $$1; $$10 < $$2; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               egw $$12 = this.dM().b_($$7);
               if ($$12.a(auf.a)) {
                  $$9 = Math.max($$9, $$12.a((cux)this.dM(), $$7));
               }
   ...
   public float w() {
      enu $$0 = this.cH();
      enu $$1 = new enu($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = awi.a($$1.a) - 1;
      int $$3 = awi.c($$1.d) + 1;
      int $$4 = awi.a($$1.b) - 1;
      int $$5 = awi.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dlj $$16 = this.dM().a_($$11);
                     if (!($$16.b() instanceof dht) && eop.c($$16.k(this.dM(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, eod.i)) {
                        $$9 += $$16.b().i();
                        $$10++;
                     }
                  }
      ...
      for (int $$9 = $$1; $$9 < $$2; $$9++) {
         for (int $$10 = $$3; $$10 < $$4; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               egw $$12 = this.dM().b_($$8);
               if ($$12.a(auf.a)) {
                  float $$13 = (float)$$10 + $$12.a((cux)this.dM(), $$8);
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               egw $$13 = this.dM().b_($$9);
               if ($$13.a(auf.a) && $$1 < (double)((float)$$9.v() + $$13.a((cux)this.dM(), $$9))) {
                  if (!$$13.b()) {
                     return cjg.a.c;
                  }
   ...
   private void G() {
      ...
      double $$2 = 0.0;
      this.p = 0.05F;
      if (this.aM == cjg.a.e && this.aL != cjg.a.e && this.aL != cjg.a.d) {
         this.aJ = this.e(1.0);
         ...
         if (this.aL == cjg.a.a) {
            ...
            this.p = 0.9F;
         } else if (this.aL == cjg.a.c) {
            $$1 = -7.0E-4;
            this.p = 0.9F;
         } else if (this.aL == cjg.a.b) {
            $$2 = 0.01F;
            this.p = 0.45F;
         } else if (this.aL == cjg.a.e) {
            this.p = 0.9F;
         } else if (this.aL == cjg.a.d) {
            this.p = this.aK;
            if (this.cN() instanceof chl) {
               this.aK /= 2.0F;
            }
         }
   ...
   private void H() {
      if (this.bP()) {
         ...
         this.g(this.dp().b((double)(awi.a(-this.dC() * (float) (Math.PI / 180.0)) * $$0), 0.0, (double)(awi.b(this.dC() * (float) (Math.PI / 180.0)) * $$0)));
   ...
   protected void a(bnq $$0, bnq.a $$1) {
      ...
      if (!$$0.ai().a(aud.s)) {
         ...
         $$0.n($$0.cp() + this.r);
         this.b($$0);
         if ($$0 instanceof bzx && this.cP().size() == this.z()) {
            int $$2 = $$0.aj() % 2 == 0 ? 90 : 270;
            $$0.o(((bzx)$$0).aU + (float)$$2);
            $$0.n($$0.cp() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public enz b(boi $$0) {
      enz $$1 = a((double)(this.dg() * awi.g), (double)$$0.dg(), $$0.dC());
      double $$2 = this.dr() + $$1.c;
      double $$3 = this.dx() + $$1.e;
      hz $$4 = hz.a($$2, this.cH().e, $$3);
      hz $$5 = $$4.d();
      if (!this.dM().z($$5)) {
         List<enz> $$6 = Lists.newArrayList();
         double $$7 = this.dM().j($$4);
         if (cjj.a($$7)) {
            $$6.add(new enz($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dM().j($$5);
         if (cjj.a($$8)) {
            $$6.add(new enz($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fA().iterator();

         while (var14.hasNext()) {
            bot $$9 = (bot)var14.next();

            for (enz $$10 : $$6) {
               if (cjj.a(this.dM(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   protected void b(bnq $$0) {
      $$0.o(this.dC());
      float $$1 = awi.g($$0.dC() - this.dC());
      float $$2 = awi.a($$1, -105.0F, 105.0F);
      $$0.M += $$2 - $$1;
      $$0.r($$0.dC() + $$2 - $$1);
      $$0.n($$0.dC());
   }
   ...
   protected void a(double $$0, boolean $$1, dlj $$2, hz $$3) {
      ...
      if (!this.bO()) {
         if ($$1) {
            ...
            this.n();
         } else if (!this.dM().b_(this.dm().d()).a(auf.a) && $$0 < 0.0) {
            this.aa -= (float)$$0;
         }
      }
   }
   ...
   public float a(float $$0) {
      return awi.i($$0, this.aS, this.aR);
   }

   public void a(cjg.b $$0) {
      this.am.b(i, $$0.ordinal());
   }

   public cjg.b y() {
      return cjg.b.a(this.am.b(i));
   }

   @Override
   protected boolean q(bnq $$0) {
      return this.cP().size() < this.z() && !this.a(auf.a);
   }
   ...
   @Override
   public boi cN() {
      return this.cQ() instanceof boi $$0 ? $$0 : super.cN();
   }
   ...
   @Override
   public boolean be() {
      return this.aL == cjg.a.b || this.aL == cjg.a.c;
   }

   @Override
   public cpd dz() {
      return new cpd(this.ai_());
   }
   ...
   public static enum b implements axc {
      ...
      private final cys l;
      public static final axc.a<cjg.b> j = axc.a(cjg.b::values);
      private static final IntFunction<cjg.b> m = ava.a(Enum::ordinal, values(), ava.a.a);

      private b(cys $$0, String $$1) {
         this.k = $$1;
         this.l = $$0;
      }
      ...
      public static cjg.b a(int $$0) {
         return m.apply($$0);
      }

      public static cjg.b a(String $$0) {
         return j.a($$0, a);
      }
   }
}
