...
public class cjg extends bst implements bun {
   private static final akj<cuo> d = akn.a(cjg.class, akl.h);
   ...
   public cjg(bsz<? extends cjg> $$0, dbx $$1) {
      super($$0, $$1);
      this.c = this.ah.i() * (float) Math.PI * 2.0F;
      this.r(this.ah.i() * 360.0F);
   }

   public cjg(dbx $$0, double $$1, double $$2, double $$3, cuo $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$0.z.j() * 0.2 - 0.1, 0.2, $$0.z.j() * 0.2 - 0.1);
   }

   public cjg(dbx $$0, double $$1, double $$2, double $$3, cuo $$4, double $$5, double $$6, double $$7) {
      this(bsz.ag, $$0);
      this.a_($$1, $$2, $$3);
      this.o($$5, $$6, $$7);
      this.a($$4);
   ...
   public void l() {
      if (this.p().e()) {
         ...
         boolean $$3 = ayy.a(this.L) != ayy.a(this.du()) || ayy.a(this.M) != ayy.a(this.dw()) || ayy.a(this.N) != ayy.a(this.dA());
         int $$4 = $$3 ? 2 : 40;
   ...
   private void G() {
      if (this.H()) {
         for (cjg $$1 : this.dP().a(cjg.class, this.cK().c(0.5, 0.0, 0.5), $$0 -> $$0 != this && $$0.H())) {
            if ($$1.H()) {
               this.a($$1);
               if (this.dK()) {
                  break;
   ...
   public static boolean a(cuo $$0, cuo $$1) {
      return $$1.I() + $$0.I() > $$1.j() ? false : cuo.c($$0, $$1);
   }
   ...
   private static void a(cjg $$0, cuo $$1, cuo $$2) {
      cuo $$3 = a($$1, $$2, 64);
      $$0.a($$3);
   }

   private static void a(cjg $$0, cuo $$1, cjg $$2, cuo $$3) {
      a($$0, $$1, $$3);
   ...
   public boolean a(brm $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if (!this.p().e() && this.p().a(cur.us) && $$0.a(awq.m)) {
         return false;
      } else if (!this.p().a($$0)) {
         return false;
      } else if (this.dP().B) {
   ...
   public void a(ur $$0) {
      ...
      if ($$0.b("Item", 10)) {
         ur $$1 = $$0.p("Item");
         this.a(cuo.a(this.dR(), (vo)$$1).orElse(cuo.l));
      } else {
         this.a(cuo.l);
      }
