...
public class cjg extends bsu {
   private static final Logger f = LogUtils.getLogger();
   private dsc g = dfb.I.o();
   public int b;
   ...
   @Nullable
   public us d;
   protected static final akk<iz> e = ako.a(cjg.class, akm.o);

   public cjg(bta<? extends cjg> $$0, dby $$1) {
      super($$0, $$1);
   }

   private cjg(dby $$0, double $$1, double $$2, double $$3, dsc $$4) {
      this(bta.O, $$0);
      this.g = $$4;
      this.J = true;
      this.a_($$1, $$2, $$3);
   ...
   public static cjg a(dby $$0, iz $$1, dsc $$2) {
      cjg $$3 = new cjg($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2.b(dss.C) ? $$2.a(dss.C, Boolean.valueOf(false)) : $$2);
      $$0.a($$1, $$2.u().g(), 3);
      $$0.b($$3);
      return $$3;
   }
   ...
   public void l() {
      if (this.g.i()) {
         ...
         if (!this.dP().B) {
            iz $$1 = this.dp();
            boolean $$2 = this.g.b() instanceof dgl;
            boolean $$3 = $$2 && this.dP().b_($$1).a(awv.a);
            double $$4 = this.ds().g();
            if ($$2 && $$4 > 1.0) {
               evn $$5 = this.dP().a(new dbh(new evr(this.L, this.M, this.N), this.dn(), dbh.a.a, dbh.b.b, this));
               if ($$5.c() != evp.a.a && this.dP().b_($$5.a()).a(awv.a)) {
                  $$1 = $$5.a();
                  $$3 = true;
               }
            }
            ...
            if (this.aE() || $$3) {
               ...
               if (!$$6.a(dfb.bQ)) {
                  if (!this.h) {
                     boolean $$7 = $$6.a(new cyb(this.dP(), $$1, je.a, cup.l, je.b));
                     boolean $$8 = dhv.m(this.dP().a_($$1.d())) && (!$$2 || !$$3);
                     boolean $$9 = this.g.a((dcb)this.dP(), $$1) && !$$8;
                     if ($$7 && $$9) {
                        if (this.g.b(dss.C) && this.dP().b_($$1).a() == enw.c) {
                           this.g = this.g.a(dss.C, Boolean.valueOf(true));
                        }
                        ...
                        if (this.dP().a($$1, this.g, 3)) {
                           ...
                           this.ao();
                           if ($$0 instanceof dhu) {
                              ((dhu)$$0).a(this.dP(), $$1, this.g, $$6, this);
                           }
                        ...
                        } else if (this.c && this.dP().ab().b(dbu.i)) {
                           this.ao();
                           this.a($$0, $$1);
                           this.a($$0);
                        }
   ...
   public boolean a(float $$0, float $$1, brn $$2) {
      if (!this.i) {
         ...
         if ($$3 < 0) {
            ...
            Predicate<bsu> $$4 = bsz.e.and(bsz.b);
            brn $$6 = this.g.b() instanceof dhu $$5 ? $$5.a(this) : this.dQ().a(this);
   ...
   @Override
   public zw<aci> dl() {
      return new acj(this, dez.i(this.u()));
   }
