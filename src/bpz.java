...
public class bpz implements bqa {
   ...
   public boolean a(bpy $$0) {
      URL $$1 = bpz.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bpy $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bqc a = new bqc(() -> bpz.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bpz.this.l && $$0.getState() == RecordingState.STOPPED) {
