...
public class bpz {
   ...
   public static boc<bmt> a(float $$0) {
      ...
      return bro.a(
         (Function<bro.b<bmt>, ? extends App<bro.c<bmt>, brr<bmt>>>)($$3 -> $$3.group($$3.c(bvm.m), $$3.c(bvm.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.X() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        bxl $$7 = $$4x.y();
                        Optional<hx> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(bxp.n), $$5.dm(), 48, bxl.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dm()) <= 4.0)) {
                           ...
                           Set<Pair<ih<bxo>, hx>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(bxp.n), $$10, $$5.dm(), 48, bxl.b.c).collect(Collectors.toSet());
                           eff $$12 = bnu.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              hx $$13 = $$12.l();
                              Optional<ih<bxo>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new bvp($$13, $$0, 1));
                                 adi.c($$4x, $$13);
                              }
