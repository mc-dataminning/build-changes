...
public abstract class bpz<C, V> implements bpt<StringReader, V>, bqa {
   private final bpn<alg> b;
   protected final C a;

   protected bpz(bpn<alg> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(bps<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
