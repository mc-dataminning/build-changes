...
public abstract class se {
   ...
   private static volatile se e = c();
   ...
   private static se c() {
      ...
      return new se() {
         ...
         @Override
         public atk a(vg $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> aus.c($$2xxx, $$1x, $$1) ? Optional.empty() : vg.a, vy.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = se.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(ato.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract atk a(vg var1);

   public List<atk> a(List<vg> $$0) {
