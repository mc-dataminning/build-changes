...
public class evc {
   ...
   public static Supplier<String> a(eqq $$0) {
      return () -> b($$0);
   }

   public static String b(eqq $$0) {
      return n.a($$0.o.a().replaceAll("\\r", ""));
   }

   public static Consumer<String> c(eqq $$0) {
      return $$1 -> a($$0, $$1);
   }
   ...
   private int h(int $$0) {
      return ars.a($$0, 0, this.a.get().length());
   }
   ...
   private void a(String $$0, String $$1) {
      ...
      this.f = ars.a(this.f, 0, $$0.length());
   ...
   public void b(int $$0, boolean $$1) {
      this.f = erc.a(this.a.get(), $$0, this.f, true);
      this.c($$1);
   }
   ...
   public void d(int $$0) {
      int $$1 = erc.a(this.a.get(), $$0, this.f, true);
      this.e($$1 - this.f);
   }
