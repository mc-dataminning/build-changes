...
public class alq {
   ...
   final List<so> g = Collections.synchronizedList(Lists.newArrayList());

   public alq(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new all(alq.this.d()));
               so.a($$1, vg.a, null);
               int $$2 = alq.this.e.m();
               so $$3 = (so)($$2 > 0 ? new sz($$2) : new so(vg.a));
               alq.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new als(alq.this.e, $$3));
            }
            ...
            if (!$$1.l()) {
               if ($$1.k()) {
                  try {
                     ...
                     tn $$3 = tn.b("Internal server error");
                     $$1.a(new vk($$3), sx.a(() -> $$1.a($$3)));
                     $$1.o();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<alq.a.a> d = Lists.newArrayList();
