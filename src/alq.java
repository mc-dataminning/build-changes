...
public record alq(MinecraftSessionService a, ServicesKeySet b, GameProfileRepository c, auz d) {
   private static final String e = "usercache.json";

   public static alq a(YggdrasilAuthenticationService $$0, File $$1) {
      MinecraftSessionService $$2 = $$0.createMinecraftSessionService();
      GameProfileRepository $$3 = $$0.createProfileRepository();
      auz $$4 = new auz($$3, new File($$1, "usercache.json"));
      return new alq($$2, $$0.getServicesKeySet(), $$3, $$4);
   }
