...
public class alq {
   ...
   public alq(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<alq.a> b(Scanner $$0) {
      akm<daz> $$1 = (akm<daz>)alz.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new alq.a($$1, new eum((double)$$2, (double)$$3, (double)$$4), new eul($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<aqo> $$1 = this.e.ah().t();
         if (!$$1.isEmpty()) {
            aqo $$2 = $$1.get(0);
            aqn $$3 = this.e.I();
            ee $$4 = new ee($$2, eum.a($$3.U()), eul.a, $$3, 4, "", ww.a, this.e, $$2);
            ef $$5 = this.e.aH();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(akm<daz> a, eum b, eul c) {
   }
}
