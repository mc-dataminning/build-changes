...
public class fai implements fad {
   protected static final fad a = new fai(false, -Double.MAX_VALUE, cwm.k, $$0 -> false, null) {
      @Override
      public boolean a(fas $$0, jh $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected fai(boolean $$0, double $$1, cwm $$2, Predicate<erv> $$3, @Nullable bul $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
