...
public class vp extends SimpleChannelInboundHandler<zd<?>> {
   ...
   private static final we<aix> j = aiw.b;
   private final ze k;
   ...
   @Nullable
   private volatile wc p;
   @Nullable
   private volatile wc q;
   @Nullable
   private vr r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(ww.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof wj) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(ww.c("disconnect.timeout"));
            } else {
               ww $$3 = ww.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wc $$4 = this.q;
               vr $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == ze.b) {
                     zd<?> $$7 = (zd<?>)(this.l ? new ajd($$3) : new zm($$3));
                     this.a($$7, wd.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zd<?> $$1) {
      if (this.n.isOpen()) {
         wc $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(ww.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(ww.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wc> void a(zd<T> $$0, wc $$1) {
      $$0.a((T)$$1);
   }

   private void b(we<?> $$0, wc $$1) {
   ...
   public <T extends wc> void a(we<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wc $$0) {
      ...
      } else if (this.k == ze.a && $$0.a() == ze.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public <S extends wi, C extends vm> void a(String $$0, int $$1, we<S> $$2, we<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ait.c : ait.b);
   }

   private <S extends wi, C extends vm> void a(String $$0, int $$1, we<S> $$2, we<C> $$3, C $$4, ait $$5) {
      if ($$2.a() != $$3.a()) {
   ...
   public void a(zd<?> $$0, @Nullable wd $$1) {
      this.a($$0, $$1, true);
   }

   public void a(zd<?> $$0, @Nullable wd $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zd<?> $$0, @Nullable wd $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zd<?> $$0, @Nullable wd $$1, boolean $$2) {
   ...
   public static vp a(InetSocketAddress $$0, boolean $$1, @Nullable bot $$2) {
      vp $$3 = new vp(ze.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static void a(ChannelPipeline $$0, ze $$1, boolean $$2, @Nullable vi $$3) {
      ze $$4 = $$1.a();
      boolean $$5 = $$1 == ze.a;
      boolean $$6 = $$4 == ze.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wa<aix>(j) : new wl.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wb<aix>(j) : new wl.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new vw() : new wq());
   }
   ...
   private static ChannelInboundHandler a(@Nullable vi $$0, boolean $$1) {
      if (!$$1) {
         ...
         return (ChannelInboundHandler)($$0 != null ? new vx($$0) : new vv());
      }
   }

   public static void a(ChannelPipeline $$0, ze $$1) {
      a($$0, $$1, true, null);
   }

   public static vp a(SocketAddress $$0) {
      final vp $$1 = new vp(ze.b);
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wc $$0 = this.k();
            wc $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               vr $$2 = Objects.requireNonNullElseGet(this.l(), () -> new vr(ww.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
