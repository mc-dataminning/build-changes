...
public class vp {
   ...
   private vp(String $$0, List<vo> $$1, Int2IntFunction $$2) {
      this.a = $$0;
   ...
   public static vp a(uw $$0) {
      return a($$0, $$0x -> $$0x, $$0x -> $$0x);
   }

   public static vp a(uw $$0, Int2IntFunction $$1, UnaryOperator<String> $$2) {
      ...
      return new vp($$2.apply($$3.toString()), $$4, $$1);
   }
}
