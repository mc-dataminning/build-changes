...
public class ara implements AutoCloseable {
   ...
   private ara(URL $$0, ara.c $$1, URL $$2, ara.b $$3, URL $$4, ara.b $$5, String $$6, ara.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? axc.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static ara a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = axc.a($$0);
            URI $$2 = new URI(axc.i($$1, "apiServer"));
            String $$3 = axc.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axc.a($$1, "ruleId", 1);
               String $$5 = axc.a($$1, "serverId", "");
               String $$6 = axc.a($$1, "roomId", "Java:Chat");
               int $$7 = axc.a($$1, "hashesToDrop", -1);
               int $$8 = axc.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axc.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, ara.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<aqm> a(GameProfile $$0, String $$1, ara.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(aqm.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = axc.a($$4, "response", false);
            if ($$5) {
               return aqm.a($$1);
            } else {
               String $$6 = axc.a($$4, "hashed", null);
               if ($$6 == null) {
                  return aqm.b($$1);
               } else {
                  JsonArray $$7 = axc.v($$4, "hashes");
                  wm $$8 = this.a($$1, $$7, $$2);
                  return new aqm($$1, $$8);
               }
            }
   ...
   private wm a(String $$0, JsonArray $$1, ara.a $$2) {
      if ($$1.isEmpty()) {
         return wm.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return wm.b;
      } else {
         wm $$3 = new wm($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ara.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public aqz a(GameProfile $$0) {
      return new ara.d($$0);
   }
   ...
   public interface a {
      ara.a a = ($$0, $$1) -> false;
      ara.a b = ($$0, $$1) -> $$0.length() == $$1;

      static ara.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static ara.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements aqz {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bmy<Runnable> $$1 = bmy.a(ara.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         ara.this.a(this.c, ara.this.g, ara.this.h, this.d);
      }

      @Override
      public void b() {
         ara.this.a(this.c, ara.this.i, ara.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<aqm>> a(List<String> $$0) {
         List<CompletableFuture<aqm>> $$1 = $$0.stream().map($$0x -> ara.this.a(this.c, $$0x, ara.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<aqm> a(String $$0) {
         return ara.this.a(this.c, $$0, ara.this.l, this.d);
      }
   }
