...
public class ara {
   ...
   ara(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ara.a a() {
      return new ara.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ara::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ara.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ara a(Writer $$0) throws IOException {
         return new ara($$0, this.a);
      }
   }
}
