...
class ara implements Path {
   private static final BasicFileAttributes a = new aqy() {
      @Override
   ...
   private static final BasicFileAttributes b = new aqy() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ara> c = Comparator.comparing(ara::n);
   ...
   public ara(arc $$0, String $$1, @Nullable ara $$2, ard $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ara a(@Nullable ara $$0, String $$1) {
      return new ara(this.e, $$1, $$0, ard.b);
   }
   ...
   ara a(String $$0) {
      if (a(this.i)) {
         return new ara(this.e, $$0, this, this.i);
      } else if (this.i instanceof ard.a $$1) {
         ara $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ara(this.e, $$0, this, ard.a);
      } else if (this.i instanceof ard.b) {
         return new ara(this.e, $$0, this, ard.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(ard $$0) {
      return $$0 == ard.a || $$0 == ard.b;
   }
   ...
   private ara c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ara $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ard.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ard.a i() {
      return this.i instanceof ard.a $$0 ? $$0 : null;
   }
