...
public class drr {
   ...
   private final cvp p;
   private static final List<cyo> q = List.of(cyq.l, cyq.L, cyq.i, cyq.b, cyq.k, cyq.I, cyq.K, cyq.fl, cyq.dP, cyq.iA, cyq.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ij<cwm>>> t;
   ...
   public static final Codec<drr> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(drr::a, Function.identity());

   private static DataResult<drr> a(drr $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private drr(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ij<cwm>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jb.c($$0);
      int $$5 = jb.c($$1) - $$4;
   ...
   @Nullable
   public static drr a(apc $$0, int $$1, int $$2) {
      dnb $$3 = $$0.a($$1, $$2);
      drr $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dng.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ig> a(cwi $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dnb $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, awh.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dnb $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dqo.a.a)) {
         $$3 = Math.min($$0.a(dqo.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }
   ...
   private static double a(dnb $$0, hz.a $$1) {
      return a($$0, (hz)$$1.c(ie.a)) ? 1.0 : -1.0;
   }

   private static double b(dnb $$0, hz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dnb $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      hz.a $$5 = new hz.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<ij<cwm>> b(dnb $$0, int $$1, int $$2) {
      ObjectArrayList<ij<cwm>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dnb $$0, hz $$1) {
      dlf $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(atz.O)) {
         ...
         return $$2.a(cyq.eT) || $$2.a(cyq.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, drr.a $$3) {
      if ($$1 >= iu.a(this.p.J_()) && $$1 < iu.a(this.p.al())) {
         int $$4 = $$1 - iu.a(this.p.J_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               ij<cwm> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, drr.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, drr.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ij<cwm> var3);
   }
