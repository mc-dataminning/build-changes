...
public class ald<E> implements Codec<ju<E>> {
   ...
   public static <E> Codec<ju<E>> a(ali<? extends kd<E>> $$0, Codec<jq<E>> $$1, boolean $$2) {
      return new ald<>($$0, $$1, $$2);
   }

   private ald(ali<? extends kd<E>> $$0, Codec<jq<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(axs.b($$0), this.c);
   }

   public <T> DataResult<Pair<ju<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof alh<T> $$2) {
   ...
   private static <E> DataResult<ju<E>> a(jr<E> $$0, axs<E> $$1) {
      return $$0.a($$1)
