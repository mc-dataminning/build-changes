...
public class adb {
   ...
   public adb(dtj $$0) {
      ...
      for (Entry<io, doi> $$2 : $$0.G().entrySet()) {
   ...
   static class a {
      ...
      private a(int $$0, int $$1, dok<?> $$2, @Nullable ud $$3) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
         this.f = $$3;
   ...
   @FunctionalInterface
   public interface b {
      void accept(io var1, dok<?> var2, @Nullable ud var3);
   }
}
