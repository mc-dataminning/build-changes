...
public class adb implements zw<aci> {
   public static final zn<wm, adb> a = zw.a(adb::a, adb::new);
   ...
   private final int i;
   private final List<adb.b> j;

   public adb(RootCommandNode<eu> $$0) {
   ...
   private static void a(List<adb.b> $$0, BiPredicate<adb.b, IntSet> $$1) {
   ...
   private static void a(List<adb.b> $$0) {
      a($$0, adb.b::a);
      a($$0, adb.b::b);
   }
   ...
   private static List<adb.b> a(Object2IntMap<CommandNode<eu>> $$0) {
      ObjectArrayList<adb.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static adb.b b(wm $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      adb.e $$4 = a($$0, $$1);
      return new adb.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static adb.e a(wm $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
         ...
         if ($$5 == null) {
            ...
            ik.a<?> $$6 = $$5.b($$0);
            alf $$7 = ($$1 & 16) != 0 ? $$0.q() : null;
            return new adb.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.p();
         return new adb.c($$8);
   ...
   private static adb.b a(CommandNode<eu> $$0, Object2IntMap<CommandNode<eu>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<eu> a(el $$0) {
      return (RootCommandNode<eu>)new adb.d($$0, this.j).a(this.i);
   }

   static class a implements adb.e {
      ...
      @Nullable
      private static alf a(@Nullable SuggestionProvider<eu> $$0) {
         return $$0 != null ? io.a($$0) : null;
      }

      a(String $$0, ik.a<?> $$1, @Nullable alf $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(wm $$0, ik.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends ik.a<A>> void a(wm $$0, ik<A, T> $$1, ik.a<A> $$2) {
         $$0.c(lp.w.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable adb.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements adb.e {
      private final String a;
