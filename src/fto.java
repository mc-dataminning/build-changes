...
public class fto extends fts {
   ...
   public fto(fmg $$0, avr $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fns $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(glv.H(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(glv.H(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = ayp.a($$10);
      $$0.a($$0x -> glv.L(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> glv.L(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
   ...
   private void a(fns $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends hbe {
      ...
      protected hbe.a b(avv $$0) {
         auk $$1 = fmg.Q().ae();
         avn<InputStream> $$2 = $$1.a(aui.a, fto.a);
         if ($$2 == null) {
            return new hbe.a(new FileNotFoundException(fto.a.toString()));
         } else {
            try {
               hbe.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new hbe.a(new hdj(true, true), ffs.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new hbe.a(var9);
            }
         }
      }
   }
