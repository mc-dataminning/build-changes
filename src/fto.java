...
public class fto extends fuk {
   ...
   public fto(@Nullable wp $$0, boolean $$1) {
   ...
   protected void aR_() {
      ...
      this.v = this.c(
         fos.a(wp.c("deathScreen.titleScreen"), $$0x -> this.m.ba().a(this.m, this, this::m, true)).a(this.n / 2 - 100, this.o / 4 + 96, 200, 20).a()
      );
      this.u.add(this.v);
      this.c(false);
   ...
   private void E() {
      ...
      this.m.b(new ftv(wp.c("menu.savingLevel")));
      this.m.a(new fum());
   }
