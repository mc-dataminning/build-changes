...
public class fto extends ftg<cci> {
   private static final aex a = new aex("textures/entity/fishing_hook.png");
   ...
   public void a(cci $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      if ($$6 != null) {
         ...
         float $$13 = $$6.x($$2);
         float $$14 = arx.a(arx.c($$13) * (float) Math.PI);
         float $$15 = arx.i($$2, $$6.aV, $$6.aU) * (float) (Math.PI / 180.0);
         double $$16 = (double)arx.a($$15);
         double $$17 = (double)arx.b($$15);
         ...
         if ((this.c.d == null || this.c.d.aw().a()) && $$6 == eqv.O().s) {
            ...
            $$25 = $$25.b($$14 * 0.5F);
            $$25 = $$25.a(-$$14 * 0.7F);
            $$26 = arx.d((double)$$2, $$6.K, $$6.dq()) + $$25.c;
            $$27 = arx.d((double)$$2, $$6.L, $$6.ds()) + $$25.d;
            $$28 = arx.d((double)$$2, $$6.M, $$6.dw()) + $$25.e;
            $$29 = $$6.cH();
         } else {
            $$26 = arx.d((double)$$2, $$6.K, $$6.dq()) - $$17 * $$18 - $$16 * 0.8;
            $$27 = $$6.L + (double)$$6.cH() + ($$6.ds() - $$6.L) * (double)$$2 - 0.45;
            $$28 = arx.d((double)$$2, $$6.M, $$6.dw()) - $$16 * $$18 + $$17 * 0.8;
            $$29 = $$6.bW() ? -0.1875F : 0.0F;
         }

         double $$30 = arx.d((double)$$2, $$0.K, $$0.dq());
         double $$31 = arx.d((double)$$2, $$0.L, $$0.ds()) + 0.25;
         double $$32 = arx.d((double)$$2, $$0.M, $$0.dw());
