...
public class amp {
                           ...
                           ef.a("targets", er.d())
                              .then(
                                 ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a("amount", IntegerArgumentType.integer())
                                          .executes(
                                             $$0x -> a((ee)$$0x.getSource(), er.f($$0x, "targets"), IntegerArgumentType.getInteger($$0x, "amount"), amp.a.a)
                                          ))
                                       .then(
                                          ef.a("points")
                                             .executes(
                                    ...
                                    .then(
                                       ef.a("levels")
                                          .executes(
                                             $$0x -> a((ee)$$0x.getSource(), er.f($$0x, "targets"), IntegerArgumentType.getInteger($$0x, "amount"), amp.a.b)
                                          )
                                    )
                              )
                        )
                        ...
                        ef.a("targets", er.d())
                           .then(
                              ((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a("amount", IntegerArgumentType.integer(0))
                                       .executes(
                                          $$0x -> b((ee)$$0x.getSource(), er.f($$0x, "targets"), IntegerArgumentType.getInteger($$0x, "amount"), amp.a.a)
                                       ))
                                    .then(
                                       ef.a("points")
                                          .executes(
                                 ...
                                 .then(
                                    ef.a("levels")
                                       .executes(
                                          $$0x -> b((ee)$$0x.getSource(), er.f($$0x, "targets"), IntegerArgumentType.getInteger($$0x, "amount"), amp.a.b)
                                       )
                                 )
                           )
                     )
               ...
               ef.a("query")
                  .then(
                     ((RequiredArgumentBuilder)ef.a("targets", er.c())
                           .then(ef.a("points").executes($$0x -> a((ee)$$0x.getSource(), er.e($$0x, "targets"), amp.a.a))))
                        .then(ef.a("levels").executes($$0x -> a((ee)$$0x.getSource(), er.e($$0x, "targets"), amp.a.b)))
                  )
            )
      );
   ...
   private static int a(ee $$0, aqo $$1, amp.a $$2) {
      int $$3 = $$2.f.applyAsInt($$1);
      $$0.a(() -> wx.a("commands.experience.query." + $$2.e, $$1.O_(), $$3), false);
      return $$3;
   }

   private static int a(ee $$0, Collection<? extends aqo> $$1, int $$2, amp.a $$3) {
      for (aqo $$4 : $$1) {
         $$3.c.accept($$4, $$2);
      }
   ...
   private static int b(ee $$0, Collection<? extends aqo> $$1, int $$2, amp.a $$3) throws CommandSyntaxException {
      int $$4 = 0;
   ...
   static enum a {
      ...
      }, $$0 -> ayf.d($$0.cq * (float)$$0.gl())),
      b("levels", aqo::c, ($$0, $$1) -> {
         $$0.b($$1);
         return true;
      }, $$0 -> $$0.co);

      public final BiConsumer<aqo, Integer> c;
      public final BiPredicate<aqo, Integer> d;
      public final String e;
      final ToIntFunction<aqo> f;

      private a(String $$0, BiConsumer<aqo, Integer> $$1, BiPredicate<aqo, Integer> $$2, ToIntFunction<aqo> $$3) {
         this.c = $$1;
         this.e = $$0;
         this.d = $$2;
         this.f = $$3;
