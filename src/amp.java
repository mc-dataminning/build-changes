...
class amp implements Path {
   private static final BasicFileAttributes a = new amn() {
      @Override
   ...
   private static final BasicFileAttributes b = new amn() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amp> c = Comparator.comparing(amp::n);
   ...
   public amp(amr $$0, String $$1, @Nullable amp $$2, ams $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amp a(@Nullable amp $$0, String $$1) {
      return new amp(this.e, $$1, $$0, ams.b);
   }
   ...
   amp a(String $$0) {
      if (a(this.i)) {
         return new amp(this.e, $$0, this, this.i);
      } else if (this.i instanceof ams.a $$1) {
         amp $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amp(this.e, $$0, this, ams.a);
      } else if (this.i instanceof ams.b) {
         return new amp(this.e, $$0, this, ams.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(ams $$0) {
      return $$0 == ams.a || $$0 == ams.b;
   }
   ...
   private amp c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amp $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ams.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ams.a i() {
      return this.i instanceof ams.a $$0 ? $$0 : null;
   }
