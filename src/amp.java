...
public class amp {
   ...
   public amp(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<amp.a> b(Scanner $$0) {
      alj<djz> $$1 = (alj<djz>)amy.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amp.a($$1, new ffs((double)$$2, (double)$$3, (double)$$4), new ffr($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<arv> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            arv $$2 = $$1.get(0);
            aru $$3 = this.e.J();
            ek $$4 = new ek($$2.z(), ffs.a($$3.aa()), ffr.a, $$3, 4, "", xb.a, this.e, $$2);
            el $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(alj<djz> a, ffs b, ffr c) {
   }
}
