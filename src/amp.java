...
public class amp {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wg.c("commands.perf.notRunning"));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(wg.c("commands.perf.alreadyRunning"));
   ...
   private static int a(du $$0) throws CommandSyntaxException {
      ...
      if ($$1.aW()) {
         ...
         Consumer<bkn> $$2 = $$1x -> a($$0, $$1x);
         Consumer<Path> $$3 = $$2x -> a($$0, $$2x, $$1);
         $$1.a($$2, $$3);
         $$0.a(() -> wg.c("commands.perf.started"), false);
         return 0;
      }
   }
   ...
   private static void a(du $$0, Path $$1, MinecraftServer $$2) {
      ...
      try {
         ...
         $$0.b(wg.c("commands.perf.reportFailed"));
         a.error("Failed to create report name", var11);
         return;
      }

      try (awv $$7 = new awv(bmg.a.resolve($$4))) {
      ...
      $$0.a(() -> wg.a("commands.perf.reportSaved", $$4), false);
   }

   private static void a(du $$0, bkn $$1) {
      if ($$1 != bkj.a) {
         int $$2 = $$1.f();
         double $$3 = (double)$$1.g() / (double)ayj.a;
         $$0.a(() -> wg.a("commands.perf.stopped", String.format(Locale.ROOT, "%.2f", $$3), $$2, String.format(Locale.ROOT, "%.2f", (double)$$2 / $$3)), false);
      }
   }
}
