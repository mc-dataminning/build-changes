...
public class amp {
   ...
   private static int a(ei $$0, Collection<? extends avj<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> ww.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> ww.a("commands.banlist.list", $$1.size()), false);

         for (avj<?> $$2 : $$1) {
            $$0.a(() -> ww.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
