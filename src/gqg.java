public class gqg extends gpw {
   gqg(gmb $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, gqf $$8) {
   ...
   public static class a implements gpn<mc> {
      ...
      public gpk a(mc $$0, gmb $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gqg($$1, $$2, $$3, $$4, $$5, $$6, $$7, axy.a(255, 204, 31, 102), this.a);
      }
   }
   ...
   public static class b implements gpn<mc> {
      ...
      public gpk a(mc $$0, gmb $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gqg($$1, $$2, $$3, $$4, $$5, $$6, $$7, axy.a(255, 255, 255, 255), this.a);
      }
   }
}
