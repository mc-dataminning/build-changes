...
public class gqg {
   ...
   private static final List<gqg.e> c = Lists.newArrayList(new gqg.e[]{new gqg.a(), new gqg.b()});
   ...
   public static Vector4f a(fpb $$0, float $$1, gkq $$2, int $$3, float $$4) {
      exc $$5 = $$0.k();
      bwi $$6 = $$0.g();
      float $$19;
      float $$20;
      ...
      if ($$5 == exc.b) {
         ...
         dkr $$34 = $$2.D_();
         ffc $$35 = $$0.b().a(2.0, 2.0, 2.0).c(0.25);
         ffc $$36 = aym.a($$35, ($$3x, $$4x, $$5x) -> $$2.c().a(ffc.a($$34.a($$3x, $$4x, $$5x).a().e()), $$33));
         $$19 = (float)$$36.a();
         $$20 = (float)$$36.b();
         $$21 = (float)$$36.c();
         if ($$3 >= 4) {
   ...
   @Nullable
   private static gqg.e a(bwi $$0, float $$1) {
      return $$0 instanceof bxj $$2 ? c.stream().filter($$2x -> $$2x.a($$2, $$1)).findFirst().orElse(null) : null;
   }

   public static gqf a(fpb $$0, gqg.d $$1, Vector4f $$2, float $$3, boolean $$4, float $$5) {
      if (!g) {
         return gqf.a;
      } else {
         exc $$6 = $$0.k();
         ...
         if ($$6 == exc.a) {
            ...
            $$8.b = -8.0F;
            $$8.c = 96.0F;
            if ($$7 instanceof gpo $$12) {
               $$8.c = $$8.c * Math.max(0.25F, $$12.D());
               jf<dkp> $$13 = $$12.dU().u($$12.du());
               if ($$13.a(axb.aa)) {
                  $$8.c *= 0.85F;
               }
            }
         ...
         return new gqf($$8.b, $$8.c, $$8.d, $$2.x, $$2.y, $$2.z, $$2.w);
      }
   }

   static class a implements gqg.e {
      @Override
      public jf<bvk> a() {
         return bvo.o;
      }
      ...
      @Override
      public void a(gqg.c $$0, bxj $$1, bvm $$2, float $$3, float $$4) {
   ...
   static class b implements gqg.e {
      @Override
      public jf<bvk> a() {
         return bvo.G;
      }
   ...
   interface e {
      ...
      void a(gqg.c var1, bxj var2, bvm var3, float var4, float var5);
