...
public interface bfl<T, F> {
   ...
   public static final class a implements bfl<bfl.b, Runnable> {
   ...
   public static final class c<T> implements bfl<T, T> {
