...
public class bfl extends bbn {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfl::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfl::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfl::k);
         $$0 = this.a($$0, "minecraft:fox", bfl::j);
         $$0 = this.a($$0, "minecraft:item", bfl::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfl::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfl::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfl::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfl::e);
         return this.a($$0, "minecraft:piglin", bfl::d);
      });
   }
