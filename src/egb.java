...
public class egb {
   ...
   private final Map<String, Long2ObjectMap<ty>> e = Maps.newHashMap();
   private final Map<String, egj> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public egb(@Nullable enk $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public ty a(ty $$0) {
      ty $$1 = $$0.p("Level");
      czb $$2 = new czb($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(czb.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(czb.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private ty a(ty $$0, czb $$1) {
      ty $$2 = $$0.p("Level");
      ty $$3 = $$2.p("Structures");
      ty $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<ty> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable enk $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ty $$2 = new ty();

            try {
               $$2 = $$0.a($$1, azc.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               ty $$4 = $$2.p($$3);
               long $$5 = czb.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               ue $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ty $$14 = $$2.p($$13);
                  $$12.a(czb.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static egb a(ake<czu> $$0, @Nullable enk $$1) {
      if ($$0 == czu.h) {
         return new egb(
            $$1,
         ...
         return new egb($$1, $$2, $$2);
      } else if ($$0 == czu.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new egb($$1, $$3, $$3);
      } else {
