...
public class egb extends egc {
   public static final int a = 8;
   public static final int b = 15;
   public static final MapCodec<egb> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ega.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, egb::new)
   );
   private final ega h;

   public egb(bpv $$0, egf $$1, Optional<efz> $$2, ega $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dda $$0, BiConsumer<jd, dta> $$1, ayv $$2, jd $$3, jd $$4, efa $$5) {
   ...
   private boolean a(dda $$0, ayv $$1, jd $$2, ji $$3, jd $$4, List<jd> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<jd> a(jd $$0, ji $$1, ayv $$2, jd $$3) {
      jd $$4 = $$0.d();
      jd $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
