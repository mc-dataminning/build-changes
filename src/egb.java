...
public class egb extends egg {
   ...
   public List<eeo.a> a(dce $$0, BiConsumer<iz, dsc> $$1, azh $$2, int $$3, iz $$4, edy $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayz.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayz.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<egb.a> $$13 = Lists.newArrayList();
      $$13.add(new egb.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iz $$21 = $$4.b(ayz.a($$19), $$12 - 1, ayz.a($$20));
               iz $$22 = $$21.b(5);
      ...
      List<eeo.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dce $$0, BiConsumer<iz, dsc> $$1, azh $$2, iz $$3, iz $$4, boolean $$5, edy $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iz $$13 = $$3.b(ayz.d(0.5F + (float)$$12 * $$9), ayz.d(0.5F + (float)$$12 * $$10), ayz.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dll.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dce $$0, BiConsumer<iz, dsc> $$1, azh $$2, int $$3, iz $$4, List<egb.a> $$5, edy $$6) {
      for (egb.a $$7 : $$5) {
         int $$8 = $$7.a();
