...
public class cqa {
   ...
   @VisibleForTesting
   protected final ArrayList<bwd> c;
   private final cqa.a k;
   @VisibleForTesting
   protected final Object2IntMap<bwd> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cqa> a(Predicate<bwd> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cqa::b)).apply($$1, $$1x -> new cqa($$0, $$1x))
      );
   }

   public cqa(Predicate<bwd> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cqa.a(this);
   ...
   public void a(arq $$0, Predicate<bwd> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bwd>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bwd> $$6 = (Entry<bwd>)$$5.next();
         int $$7 = $$6.getIntValue();
         bwd $$8 = (bwd)$$6.getKey();
         bwd.e $$9 = $$8.dR();
   ...
   public int b(@Nullable bwd $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bxc> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bxc).map($$0 -> (bxc)$$0);
   }

   @VisibleForTesting
   protected static record a(cqa a) implements Comparator<bwd> {
      public int a(bwd $$0, bwd $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cqy;
               boolean $$7 = $$1 instanceof cqy;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
