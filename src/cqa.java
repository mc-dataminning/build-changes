public class cqa extends cpt {
   ...
   private cqa(cra<?> $$0, int $$1, cmv $$2, int $$3) {
      this($$0, $$1, $$2, new brc(9 * $$3), $$3);
   }

   public static cqa a(int $$0, cmv $$1) {
      return new cqa(cra.a, $$0, $$1, 1);
   }

   public static cqa b(int $$0, cmv $$1) {
      return new cqa(cra.b, $$0, $$1, 2);
   }

   public static cqa c(int $$0, cmv $$1) {
      return new cqa(cra.c, $$0, $$1, 3);
   }

   public static cqa d(int $$0, cmv $$1) {
      return new cqa(cra.d, $$0, $$1, 4);
   }

   public static cqa e(int $$0, cmv $$1) {
      return new cqa(cra.e, $$0, $$1, 5);
   }

   public static cqa f(int $$0, cmv $$1) {
      return new cqa(cra.f, $$0, $$1, 6);
   }

   public static cqa a(int $$0, cmv $$1, bqm $$2) {
      return new cqa(cra.c, $$0, $$1, $$2, 3);
   }

   public static cqa b(int $$0, cmv $$1, bqm $$2) {
      return new cqa(cra.f, $$0, $$1, $$2, 6);
   }

   public cqa(cra<?> $$0, int $$1, cmv $$2, bqm $$3, int $$4) {
      super($$0, $$1);
      a($$3, $$4 * 9);
      this.l = $$3;
      this.m = $$4;
