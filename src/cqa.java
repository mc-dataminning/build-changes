...
public class cqa extends cpv {
   ...
   public cqa(int $$0, cmx $$1) {
      this($$0, $$1, new bre(5), new crp(2));
   }

   public cqa(int $$0, cmx $$1, bqo $$2, cqf $$3) {
      super(crc.l, $$0);
      a($$2, 5);
      a($$3, 2);
      this.u = $$2;
   ...
   static class b extends crq {
      ...
      public b(cwq $$0, bqo $$1, int $$2, int $$3, int $$4) {
         super($$1, $$2, $$3, $$4);
         this.a = $$0;
      }
   ...
   static class c extends crq {
      public c(bqo $$0, int $$1, int $$2, int $$3) {
         super($$0, $$1, $$2, $$3);
      }
