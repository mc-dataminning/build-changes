...
public class eqy {
   ...
   public static void a(File $$0, ejt $$1, Consumer<te> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ejt $$2, Consumer<te> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ejt $$2, Consumer<te> $$3) {
      eki $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            te $$3x = te.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new tc(tc.a.b, $$6.getAbsolutePath())));
            $$3.accept(te.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(te.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eki a(ejt $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eki $$3 = new eki($$1, $$2, false);
   ...
   public eqy(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
