...
public class eqy {
   ...
   @Nullable
   private String g;
   private static final eqy.a h = new eqy.a() {
      @Nullable
      @Override
      public eqx a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (erc.a(this.d, "Get capabilities")) {
         ...
         if (erc.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  erc.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !erc.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eqx a(eqy.c $$0) {
      return ($$0 == eqy.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eqy.a {
      private final int a;
      private final Set<eqx> b = Sets.newIdentityHashSet();
      ...
      public eqx a() {
         if (this.b.size() >= this.a) {
            if (aa.aV) {
               eqy.a.warn("Maximum sound pool size {} reached", this.a);
            }
