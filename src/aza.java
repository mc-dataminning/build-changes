...
public class aza implements AutoCloseable {
   ...
   private aza(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static aza.a a(Path $$0) {
         return new aza.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
