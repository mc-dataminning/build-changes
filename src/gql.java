...
public class gql implements ato<gqk> {
   public gqk b(JsonObject $$0) {
      Builder<gqj> $$1 = ImmutableList.builder();
      ...
      return new gqk($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gqj a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gqj(ayp.g($$1, "frames[" + $$0 + "]"));
