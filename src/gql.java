...
public class gql {
   ...
   public final Map<ja, gqm> c;
   @Nullable
   public final gqn d;
   public final boolean e;
   public final int f;

   public gql(Vector3f $$0, Vector3f $$1, Map<ja, gqm> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gql(Vector3f $$0, Vector3f $$1, Map<ja, gqm> $$2, @Nullable gqn $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ja, gqm> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gql> {
      private static final boolean a = true;
      private static final int b = 0;

      public gql a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gqn $$6 = this.a($$3);
         Map<ja, gqm> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !aza.c($$3, "shade")) {
            ...
            return new gql($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gqn a(JsonObject $$0) {
         gqn $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<ja, gqm> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ja, gqm> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ja, gqm> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ja, gqm> $$2 = Maps.newEnumMap(ja.class);
         JsonObject $$3 = aza.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ja $$5 = this.a($$4.getKey());
            $$2.put($$5, (gqm)$$0.deserialize($$4.getValue(), gqm.class));
         }
