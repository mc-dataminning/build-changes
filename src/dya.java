...
public abstract class dya<T extends Comparable<T>> {
   ...
   private final Codec<dya.a<T>> e = this.d.xmap(this::c, dya.a::b);

   protected dya(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dya.a<T> c(T $$0) {
      return new dya.a<>(this, $$0);
   }

   public dya.a<T> a(dxa<?, ?> $$0) {
      return new dya.a<>(this, $$0.c(this));
   }

   public Stream<dya.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dya<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dxa<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dya<T> a, T b) {
      public a(dya<T> a, T b) {
         if (!a.a().contains(b)) {
