...
public class dya {
   ...
   private final Map<Character, Predicate<dxy>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dya a(char $$0, Predicate<dxy> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dxz b() {
      return new dxz(this.c());
   }

   private Predicate<dxy>[][][] c() {
      this.d();
      Predicate<dxy>[][][] $$0 = (Predicate<dxy>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxy>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
