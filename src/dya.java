...
public class dya {
   ...
   public Optional<l.a> a(gu $$0, boolean $$1, dds $$2) {
      bqz $$3 = this.n.w();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<bra> $$5 = $$3.b($$0x -> $$0x.a(brd.r), $$0, $$4, bqz.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<bra>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dcr.H))
         .findFirst();
      return $$5.map($$0x -> {
         gu $$1x = $$0x.f();
         this.n.k().a(aik.f, new clt($$1x), 3, $$1x);
         dcb $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dcr.H), 21, ha.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, cpo.co.n(), 3);
            }
         }
      }

      dcb $$26 = cpo.ee.n().a(cup.a, $$1);
