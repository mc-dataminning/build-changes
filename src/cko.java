...
public class cko extends bvf {
   private static final alc<Optional<jh>> b = alg.a(cko.class, ale.p);
   private static final alc<Boolean> c = alg.a(cko.class, ale.k);
   public int a;

   public cko(bvm<? extends cko> $$0, dha $$1) {
      super($$0, $$1);
      this.I = true;
      this.a = this.ae.a(100000);
   }

   public cko(dha $$0, double $$1, double $$2, double $$3) {
      this(bvm.S, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public final boolean a(ash $$0, btv $$1, float $$2) {
      if (this.d($$1)) {
         ...
         if (!this.dQ()) {
            this.a(bvf.c.a);
            if (!$$1.a(axw.l)) {
               btv $$3 = $$1.d() != null ? this.dW().d(this, $$1.d()) : null;
               $$0.a(this, $$3, null, this.dA(), this.dC(), this.dG(), 6.0F, false, dha.a.b);
            }
