...
public class cko extends clx implements cmb {
   private static final ajy<Integer> a = akc.a(cko.class, aka.b);
   private static final ajy<Integer> b = akc.a(cko.class, aka.b);
   private static final ajy<Integer> c = akc.a(cko.class, aka.b);
   private static final List<ajy<Integer>> d = ImmutableList.of(a, b, c);
   private static final ajy<Integer> bY = akc.a(cko.class, aka.b);
   ...
   private int cg;
   private final aqz ch = (aqz)new aqz(this.p_(), brz.a.f, brz.b.a).a(true);
   private static final cfx.a ci = ($$0, $$1) -> !$$0.aq().a(awt.y) && $$0.fM();
   private static final cfx cj = cfx.a().a(20.0).a(ci);

   public cko(bur<? extends cko> $$0, dgh $$1) {
      super($$0, $$1);
   ...
   @Override
   public void d_() {
      faz $$0 = this.dy().d(1.0, 0.6, 1.0);
      if (!this.dV().C && this.c(0) > 0) {
         buk $$1 = this.dV().a(this.c(0));
         if ($$1 != null) {
            double $$2 = $$0.e;
            ...
            $$0 = new faz($$0.d, $$2, $$0.f);
            faz $$3 = new faz($$1.dA() - this.dA(), 0.0, $$1.dG() - this.dG());
            if ($$3.j() > 9.0) {
               faz $$4 = $$3.d();
   ...
   protected void a(ard $$0) {
      if (this.gs() > 0) {
         ...
         if ($$1 <= 0) {
            $$0.a(this, this.dA(), this.dE(), this.dG(), 7.0F, false, dgh.a.c);
            if (!this.bb()) {
               $$0.b(1023, this.dv(), 0);
            }
         }
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      cqd $$12 = new cqd(this.dV(), this, $$11.d());
      $$12.c(this);
      if ($$4) {
         $$12.a(true);
      }
   ...
   public boolean a(ard $$0, bta $$1, float $$2) {
      if (this.a($$0, $$1)) {
         ...
         if (this.gt()) {
            buk $$3 = $$1.c();
            if ($$3 instanceof cpd || $$3 instanceof cqh) {
               return false;
            }
         }
   ...
   public static bwn.a p() {
      return clx.gx().a(bwo.s, 300.0).a(bwo.v, 0.6F).a(bwo.l, 0.6F).a(bwo.m, 40.0).a(bwo.a, 4.0);
   }
