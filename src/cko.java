...
public class cko extends btt implements cjx {
   private static final akk<Integer> bZ = ako.a(cko.class, akm.b);
   ...
   public cko(btc<? extends cko> $$0, dca $$1) {
      super($$0, $$1);
      this.cG();
   ...
   @Override
   protected void z() {
      this.bS.a(1, new cko.b(this));
      this.bS.a(2, new cko.a(this));
      this.bS.a(3, new cko.e(this));
      this.bS.a(5, new cko.c(this));
   ...
   public void a(int $$0, boolean $$1) {
      ...
      this.at();
      this.j_();
      this.f(buz.q).a((double)($$2 * $$2));
      this.f(buz.r).a((double)(0.2F + 0.1F * (float)$$2));
      this.f(buz.c).a((double)$$2);
      if ($$1) {
         this.t(this.eR());
      }
   ...
   @Override
   public btc<? extends cko> ak() {
      return (btc<? extends cko>)super.ak();
   }
   ...
   protected void j(btr $$0) {
      if (this.bD()) {
         int $$1 = this.gr();
         if (this.g((bsw)$$0) < 0.6 * (double)$$1 * 0.6 * (double)$$1 && this.E($$0) && $$0.a(this.dQ().b((btr)this), this.go())) {
   ...
   protected evt a(bsw $$0, bsz $$1, float $$2) {
      return new evt(0.0, (double)$$1.b() - 0.015625 * (double)this.gr() * (double)$$2, 0.0);
   }
   ...
   public static boolean c(btc<cko> $$0, dcb $$1, btv $$2, iz $$3, azh $$4) {
      if (btv.a($$2)) {
         return a($$0, $$1, $$2, $$3, $$4);
      } else {
         if ($$1.al() != bqt.a) {
            ...
            dbh $$5 = new dbh($$3);
            boolean $$6 = dyv.a($$5.e, $$5.f, ((dcv)$$1).C(), 987234911L).a(10) == 0;
   ...
   static class a extends cap {
      ...
      public boolean a() {
         ...
         if ($$0 == null) {
            ...
            return !this.a.c($$0) ? false : this.a.H() instanceof cko.d;
         }
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof cko.d $$1) {
   ...
   static class b extends cap {
      ...
      @Override
      public boolean a() {
         return (this.a.be() || this.a.bs()) && this.a.H() instanceof cko.d;
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof cko.d $$0) {
            $$0.a(1.2);
         }
      }
   }
   ...
   static class d extends bzs {
      ...
      public void a() {
         ...
         if (this.k != bzs.a.b) {
            ...
            this.k = bzs.a.a;
            if (this.d.aE()) {
               this.d.y((float)(this.h * this.d.g(buz.r)));
               if (this.m-- <= 0) {
                  this.m = this.n.y();
                  if (this.o) {
                     this.m /= 3;
   ...
   static class e extends cap {
      ...
      @Override
      public boolean a() {
         return this.a.p() == null && (this.a.aE() || this.a.be() || this.a.bs() || this.a.b(bsg.y)) && this.a.H() instanceof cko.d;
      }
