...
public class gml {
   ...
   public void a(dhi $$0, glj $$1, int $$2, float $$3, fby $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = fmg.N() ? 10 : 5;
         List<gml.a> $$7 = new ArrayList<>();
         List<gml.a> $$8 = new ArrayList<>();
   ...
   private void a(dhi $$0, int $$1, float $$2, fby $$3, int $$4, List<gml.a> $$5, List<gml.a> $$6) {
      int $$7 = bae.a($$3.d);
      int $$8 = bae.a($$3.e);
      int $$9 = bae.a($$3.f);
      jh.a $$10 = new jh.a();
   ...
   private void a(glj $$0, fby $$1, int $$2, float $$3, List<gml.a> $$4, List<gml.a> $$5) {
      $$0.c();
      fgu $$6 = fgu.b();
   ...
   private gml.a a(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      int $$8 = $$1 & 131071;
      int $$9 = $$2 * $$2 * 3121 + $$2 * 45238971 + $$5 * $$5 * 418711 + $$5 * 13761 & 0xFF;
      float $$10 = 3.0F + $$0.i();
      float $$11 = -((float)($$8 + $$9) + $$7) / 32.0F * $$10;
      float $$12 = $$11 % 32.0F;
      return new gml.a($$2, $$5, $$3, $$4, 0.0F, $$12, $$6);
   }

   private gml.a b(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      float $$8 = (float)$$1 + $$7;
      float $$9 = (float)($$0.j() + (double)($$8 * 0.01F * (float)$$0.k()));
      float $$10 = (float)($$0.j() + (double)($$8 * (float)$$0.k() * 0.001F));
      float $$11 = -((float)($$1 & 511) + $$7) / 512.0F;
      int $$12 = glj.a((glj.a($$6) * 3 + 15) / 4, (glj.b($$6) * 3 + 15) / 4);
      return new gml.a($$2, $$5, $$3, $$4, $$9, $$11 + $$10, $$12);
   }

   private void a(fgu $$0, List<gml.a> $$1, fby $$2, float $$3, int $$4, float $$5) {
      fgn $$6 = $$0.a(fgx.c.h, fgq.d);
   ...
   public void a(gfk $$0, flp $$1, int $$2, arz $$3) {
      ...
      if (!($$4 <= 0.0F)) {
         ...
         for (int $$9 = 0; $$9 < $$8; $$9++) {
            int $$10 = $$5.a(21) - 10;
            int $$11 = $$5.a(21) - 10;
            jh $$12 = $$0.a(edq.a.e, $$6.b($$10, 0, $$11));
            if ($$12.v() > $$0.L_() && $$12.v() <= $$6.v() + 10 && $$12.v() >= $$6.v() - 10 && this.a($$0, $$12) == dik.c.b) {
               $$7 = $$12.e();
               if ($$3 == arz.c) {
                  break;
               }
               ...
               lq $$21 = !$$16.a(aya.b) && !$$15.a(dko.le) && !dlb.h($$15) ? ls.ae : ls.af;
         ...
         if ($$7 != null && $$5.a(3) < this.g++) {
            this.g = 0;
            if ($$7.v() > $$6.v() + 1 && $$0.a(edq.a.e, $$6).v() > bae.d((float)$$6.v())) {
