...
public interface fgm {
   ...
   public static record b(int e, @Nullable wp f) implements fgm {
      public static final fgm.b c = new fgm.b(429, wp.c("mco.errorMessage.serviceBusy"));
      public static final wp d = wp.c("mco.errorMessage.retry");

      public static fgm.b a(String $$0) {
         return new fgm.b(500, wp.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fgm.b a(fif $$0) {
         return new fgm.b(500, wp.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }
