...
public class fgm implements grp {
   private static final long a = 3000L;
   private final fde b;
   private final List<fgm.a> c = Lists.newArrayList();
   private boolean d;
   private final List<fgm.a> e = new ArrayList<>();
   ...
   public void a(fer $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fgm.a> $$10 = this.e.iterator();
            ...
            for (fgm.a $$12 : this.e) {
               ...
               int $$24 = axz.d(axz.b(255.0F, 75.0F, (float)(ac.b() - $$12.b()) / (float)(3000.0 * $$9)));
   ...
   @Override
   public void a(gqm $$0, grr $$1, float $$2) {
      if ($$1.a() != null) {
         wu $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fgm.a $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.a(new etp($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fgm.a($$3, $$2, new etp($$0.h(), $$0.i(), $$0.j())));
      }
   }
   ...
   public static class a {
      ...
      public boolean b(etp $$0) {
         return Float.isInfinite(this.b) || $$0.a((jg)this.d, (double)this.b);
      }
   }
}
