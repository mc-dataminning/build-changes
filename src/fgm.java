...
public enum fgm implements bam {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bam.a<fgm> t = bam.a(fgm::values);
   public static final IntFunction<fgm> u = aye.a(fgm::a, values(), aye.a.a);
   private final int v;
   private final String w;

   private fgm(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
