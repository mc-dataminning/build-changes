...
public abstract class fgm<T extends fgm<T>> {
   ...
   public fgm(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fgk.a();
         if ($$3 != null) {
         ...
         throw new fie(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fie(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fie(var2.getMessage(), var2);
      }
   }
   ...
   public static fgm<?> a(String $$0) {
      return new fgm.b($$0, 5000, 60000);
   }

   public static fgm<?> a(String $$0, int $$1, int $$2) {
      return new fgm.b($$0, $$1, $$2);
   }

   public static fgm<?> b(String $$0, String $$1) {
      return new fgm.c($$0, $$1, 5000, 60000);
   }

   public static fgm<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fgm.c($$0, $$1, $$2, $$3);
   }

   public static fgm<?> b(String $$0) {
      return new fgm.a($$0, 5000, 60000);
   }

   public static fgm<?> c(String $$0, String $$1) {
      return new fgm.d($$0, $$1, 5000, 60000);
   }

   public static fgm<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fgm.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fgm<fgm.a> {
   ...
   public static class b extends fgm<fgm.b> {
   ...
   public static class c extends fgm<fgm.c> {
      ...
      public fgm.c f() {
         try {
            ...
            throw new fie(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fgm<fgm.d> {
      private final String c;
