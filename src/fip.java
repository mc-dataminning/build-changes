...
public class fip {
   ...
   public static final fip.a bv;

   public static fip.a a(int $$0, int $$1) {
      return $$0 == -1 ? fip.b.b.a($$1) : fip.b.a.a($$0);
   }

   public static fip.a a(String $$0) {
      if (fip.a.e.containsKey($$0)) {
         return fip.a.e.get($$0);
      } else {
         for (fip.b $$1 : fip.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fip.b b;
      private final int c;
      private final azg<wy> d;
      static final Map<String, fip.a> e = Maps.newHashMap();

      a(String $$0, fip.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<fip.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wy> g;

      private static void a(fip.b $$0, String $$1, int $$2) {
         fip.a $$3 = new fip.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fip.a a(int $$0) {
         return (fip.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
