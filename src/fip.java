...
public class fip extends fie implements fjj {
   private static final fjt d = new fjt(akq.b("widget/text_field"), akq.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axz> D = ($$0x, $$1x) -> axz.forward($$0x, xv.a);
   @Nullable
   private wy E;
   private long F = ad.c();

   public fip(fhr $$0, int $$1, int $$2, wy $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fip(fhr $$0, int $$1, int $$2, int $$3, int $$4, wy $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fip(fhr $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fip $$5, wy $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axz> $$0) {
      this.D = $$0;
   }
   ...
   protected xm aM_() {
      wy $$0 = this.z();
      return wy.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = ayn.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayn.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fnx.s());
   }
   ...
   public void b(fht $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aK_() && (ad.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = ayn.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gfb.C(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = ayn.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayn.a(this.v, 0, this.p.length());
      }
   }
