...
public class fip {
   ...
   public static List<fip.a> a(String $$0, fip.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fip.a> a(String $$0, List<fip.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fip.a> a(List<String> $$0, List<fip.b> $$1) {
      int $$2 = 0;
      List<fip.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fip.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fip.b a(String $$0, String $$1) {
         return new fip.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fip.b a(String $$0) {
         return new fip.b($$0);
      }
   }
}
