...
public class fip extends fio {
   ...
   private void a(fgm $$0, int $$1, int $$2, int $$3, String $$4) {
      this.a($$0, $$4, $$1 + 1, $$3 + 1);
      $$0.a(gdr.E(), $$1, $$1 + $$2 - 1, $$3, -1);
   }
   ...
   private static String c(double $$0) {
      if ($$0 >= 1048576.0) {
         ...
         return $$0 >= 1024.0 ? String.format(Locale.ROOT, "%.1f KiB/s", $$0 / 1024.0) : String.format(Locale.ROOT, "%d B/s", ayu.a($$0));
      }
   }
