...
public class fip implements fim {
   ...
   private FT_Face c;
   final float d;
   private final fxc<fip.b> e = new fxc<>(fip.b[]::new, fip.b[][]::new);

   public fip(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$12 = fxp.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fil a(int $$0, FT_Face $$1, int $$2) {
      int $$3 = FreeType.FT_Load_Glyph($$1, $$2, 4194312);
      if ($$3 != 0) {
         fxp.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
      ...
      if ($$4 == null) {
         ...
         float $$5 = fxp.a($$4.advance());
         FT_Bitmap $$6 = $$4.bitmap();
         int $$7 = $$4.bitmap_left();
         int $$8 = $$4.bitmap_top();
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (fil)($$9 > 0 && $$10 > 0 ? new fip.a((float)$$7, (float)$$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (fxp.a) {
            fxp.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
      ...
      public fxj bake(Function<fin, fxj> $$0) {
         return $$0.apply(new fin() {
            ...
            public void a(int $$0, int $$1, flj $$2) {
               FT_Face $$3 = fip.this.b();

               try (fki $$4 = new fki(fki.a.d, a.this.b, a.this.c, false)) {
                  if ($$4.a($$3, a.this.g)) {
