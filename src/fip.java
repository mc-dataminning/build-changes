...
public class fip extends fig<clw> {
   ...
   protected void a(fav $$0, float $$1, int $$2, int $$3) {
      ...
      cqm $$6 = this.p.b(1).g();
      boolean $$7 = $$6.a(cqp.uh);
      boolean $$8 = $$6.a(cqp.qN);
      boolean $$9 = $$6.a(cqp.fS);
      cqm $$10 = this.p.b(0).g();
      boolean $$11 = false;
      ejy $$12;
      eka $$13;
   ...
   private void a(fav $$0, @Nullable ejy $$1, @Nullable eka $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.t;
      int $$8 = this.u;
      if ($$4 && !$$6) {
   ...
   private void a(fav $$0, @Nullable ejy $$1, @Nullable eka $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
