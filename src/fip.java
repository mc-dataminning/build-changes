...
public class fip extends hle {
   ...
   private static final fqg D = new fqg(akv.b("widget/cross_button"), akv.b("widget/cross_button_highlighted"));
   ...
   protected void aR_() {
      ...
      if (this.S) {
         this.T = this.c(fot.a(wp.c("mco.selectServer.trial"), fti.b(this, axv.q)).a(this.G() - 10 - 99, this.H() - 10 - 4 - 40, 99, 20).a());
      }

      this.c(fot.a(wp.c("mco.selectServer.buy"), fti.b(this, axv.r)).a(this.G() - 10 - 99, this.H() - 10 - 20, 99, 20).a());
      fpf $$0 = this.c(new fpf(this.E() + 4, this.F() + 4, 14, 14, D, $$0x -> this.aO_(), b));
      $$0.a(fqe.a(b));
      int $$1 = 142 - (this.S ? 40 : 20);
      fpd $$2 = new fpd(this.G() - 10 - 100, this.F() + 10, 100, $$1, a, this.p);
      if ($$2.q()) {
         $$2.h(94);
      }
   ...
   public static void a(foe $$0, fot $$1) {
      int $$2 = 8;
      $$0.c().a();
      $$0.c().a(0.0F, 0.0F, 110.0F);
      $$0.a(gmi::H, C, $$1.F() + $$1.A() - 8 - 4, $$1.G() + $$1.y() / 2 - 4, 8, 8);
      $$0.c().b();
   }
   ...
   public void b(foe $$0, int $$1, int $$2, float $$3) {
      ...
      this.A();
      this.b($$0);
      $$0.a(gmi::H, c, this.E(), this.F(), 320, 172);
      if (!Q.isEmpty()) {
         $$0.a(gmi::H, Q.get(this.U), this.E() + 10, this.F() + 10, 0.0F, 0.0F, 195, 152, 195, 152);
      }
   }
