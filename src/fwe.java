...
public class fwe implements fwg {
   ...
   @Override
   public void a(fno $$0, int $$1, int $$2, int $$3, int $$4, fnq $$5) {
      if (this.q.g()) {
         this.b($$0, $$1, $$2, $$3, $$4, $$5);
      } else {
         this.c($$0, $$1, $$2, $$3, $$4, $$5);
   ...
   private void b(fno $$0, int $$1, int $$2, int $$3, int $$4, fnq $$5) {
      b($$1 + this.a($$3), $$2, $$0, $$5);
      this.a($$1 + this.a($$3), $$2 + d($$0) + 4, $$0, $$5);
   }

   private void c(fno $$0, int $$1, int $$2, int $$3, int $$4, fnq $$5) {
   ...
   private void a(int $$0, int $$1, int $$2, List<cxo> $$3, int $$4, fno $$5, fnq $$6) {
      int $$7 = $$3.size() - $$0;
      boolean $$8 = $$7 == this.q.h();
      cxo $$9 = $$3.get($$7);
      if ($$8) {
         $$6.a(glt::B, d, $$1, $$2, 24, 24);
      }

      $$6.a($$9, $$1 + 4, $$2 + 4, $$4);
      $$6.a($$5, $$9, $$1 + 4, $$2 + 4);
      if ($$8) {
         $$6.a(glt::z, e, $$1, $$2, 24, 24);
      }
   }

   private static void a(int $$0, int $$1, int $$2, fno $$3, fnq $$4) {
      $$4.a($$3, "+" + $$2, $$0 + 12, $$1 + 10, 16777215);
   }

   private void a(fno $$0, fnq $$1, int $$2, int $$3, int $$4) {
      if (this.q.i()) {
   ...
   private void a(int $$0, int $$1, fno $$2, fnq $$3) {
      $$3.a(glt::B, this.g(), $$0 + 1, $$1, this.f(), 13);
      $$3.a(glt::B, a, $$0, $$1, 96, 13);
      xv $$4 = this.h();
      if ($$4 != null) {
   ...
   private static void b(int $$0, int $$1, fno $$2, fnq $$3) {
      $$3.a($$2, p, $$0, $$1, 96, 11184810);
   }

   private static int d(fno $$0) {
