...
public class fwe extends fuz<cti> {
   ...
   @Nullable
   private dtp Z;
   private cwo aa = cwo.j;
   private cwo ab = cwo.j;
   private cwo ac = cwo.j;
   private boolean ad;
   private boolean ae;
   private float af;
   private boolean ag;
   ...
   protected void a(fod $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.Z != null && !this.ae) {
         ...
         cvl $$13 = ((cur)$$9.g().h()).b();
         $$0.a($$2x -> goe.a($$0.c(), $$2x, 15728880, heh.d, this.Y, hhb.f, true, $$13, this.Z));
         $$0.c().b();
      } else if (this.ae) {
   ...
   private void a(fod $$0, jr<dto> $$1, int $$2, int $$3) {
      fft $$4 = new fft();
      $$4.a();
      ...
      dtp $$6 = new dtp.a().a($$1, cvl.a).a();
      $$0.a($$2x -> goe.a($$4, $$2x, 15728880, heh.d, this.Y, hhb.f, true, cvl.h, $$6));
      $$4.b();
      $$0.d();
   }
   ...
   private void H() {
      ...
      if ($$0.f()) {
         ...
         this.Z = $$0.a(kv.ai, dtp.a);
      }

      cwo $$1 = this.z.n().g();
      cwo $$2 = this.z.o().g();
      cwo $$3 = this.z.p().g();
      dtp $$4 = $$1.a(kv.ai, dtp.a);
      this.ae = $$4.b().size() >= 6;
      if (this.ae) {
         this.Z = null;
      }

      if (!cwo.a($$1, this.aa) || !cwo.a($$2, this.ab) || !cwo.a($$3, this.ac)) {
