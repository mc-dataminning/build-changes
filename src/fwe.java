   ...
   public void a(ftx $$0) {
      if (this.e != null) {
         ...
         $$0.a($$4x -> {
            ...
            for (brd $$6x : $$1) {
               int $$7x = azo.a($$6x.a / 4.0) + 1;
               flr $$8x = $$4x.getBuffer(gsl.B());
               int $$9x = axy.f($$6x.a());
