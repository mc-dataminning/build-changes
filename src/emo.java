...
public class emo {
   ...
   private static final Queue<emo.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile emo.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(emo::a), emm::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(emo::a), emm::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + emo.a(this.b) + ", type=" + emo.b(this.c) + ", severity=" + emo.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
