...
public enum emo implements avk {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final avk.a<emo> t = avk.a(emo::values);
   public static final IntFunction<emo> u = atg.a(emo::a, values(), atg.a.a);
   private final int v;
   private final String w;

   private emo(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
