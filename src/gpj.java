...
public class gpj implements gpc {
   ...
   private gpj(List<ale> $$0, ale $$1, Map<String, ale> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
      ...
      if ($$1.length != $$0.length) {
         ...
         return $$1x -> {
            ...
            if ($$2x == 0) {
               ...
               int $$3x = ayi.a.e($$1x);
               int $$4x = $$2.getOrDefault($$3x, ayi.a.f($$3x));
               int $$5 = ayi.a.a($$4x);
               return ayi.a.a($$2x * $$5 / 255, $$4x);
            }
         };
      }
   }
   ...
   static record a(gpi a, Supplier<IntUnaryOperator> b, ale c) implements gpc.b {
      @Nullable
      public gos a(gpb $$0) {
         Object var3;
         try {
            eyy $$1 = this.a.a().a(this.b.get());
            return new gos(this.c, new gql($$1.a(), $$1.b()), $$1, auq.a);
         } catch (IllegalArgumentException | IOException var7) {
            gpj.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
