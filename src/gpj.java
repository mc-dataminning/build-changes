...
public class gpj extends gpg {
   ...
   private final foz cF;
   private final bao cG = new bao(20, 1280);
   private final List<hmr> cH = Lists.newArrayList();
   private int cI = 0;
   private double cJ;
   private double cK;
   private double cL;
   ...
   private int cT;
   private boolean cU;
   public gph k = new gph();
   private crh cV = crh.b;
   protected final fpo cq;
   protected int cr;
   public float cs;
   public float ct;
   public float cu;
   ...
   public gpj(fpo $$0, gkl $$1, gkm $$2, awy $$3, foz $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.o());
      this.cq = $$0;
      this.j = $$2;
      this.cE = $$3;
      ...
      this.cR = $$5;
      this.cS = $$6;
      this.cH.add(new hnj(this, $$0.ak()));
      this.cH.add(new hmw(this));
      this.cH.add(new hmv(this, $$0.ak(), $$1.D_()));
   }
   ...
   public boolean a(bwi $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof ctw) {
            this.cq.ak().a((hnh)(new hnb(this, (ctw)$$0, true)));
            this.cq.ak().a((hnh)(new hnb(this, (ctw)$$0, false)));
         }
   ...
   private boolean c(iv $$0) {
      fes $$1 = this.cQ();
      fes $$2 = new fes((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   public void a(dza $$0, boolean $$1) {
      if ($$0 instanceof dyn $$2) {
         this.cq.a(new gaa($$2, $$1, this.cq.aT()));
      } else {
         this.cq.a(new gan($$0, $$1, this.cq.aT()));
      }
   }
   ...
   public void k_() {
      ...
      if (!(this.cq.z instanceof fyl)) {
         this.y(this.A() == dsl.a.a);
         this.M();
      }
   ...
   public dsl.a A() {
      return this.as == null ? dsl.a.b : this.as.a();
   }
   ...
   private void y(boolean $$0) {
      ...
      if ($$0 && this.as != null && this.as.e()) {
         if (this.cq.z != null && !this.cq.z.k() && !(this.cq.z instanceof fxr) && !(this.cq.z instanceof fyq)) {
            if (this.cq.z instanceof fzc) {
               this.p();
            }
         ...
         if (this.cw == 0.0F) {
            this.cq.ak().a(hnc.b(awn.vx, this.ae.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected void f(float $$0, float $$1) {
      if (this.O()) {
         fex $$2 = this.ds();
         fex $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         fex $$4 = new fex((double)$$0, 0.0, (double)$$1);
         float $$5 = this.fn();
         float $$6 = (float)$$4.h();
         if ($$6 <= 0.001F) {
            few $$7 = this.k.b();
            ...
            $$4 = new fex((double)($$8 * $$11 - $$9 * $$10), $$4.e, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.h();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         if (!($$15 < -0.15F)) {
            ...
            if ($$18.b(this.dU(), $$17, $$16).c()) {
               ...
               if ($$19.b(this.dU(), $$17, $$16).c()) {
                  ...
                  fex $$24 = $$3.e($$13.c((double)$$22));
                  float $$25 = this.dp();
                  float $$26 = this.dq();
                  fes $$27 = new fes($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  fex $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  fex $$28 = $$13.c(new fex(0.0, 1.0, 0.0));
                  fex $$29 = $$28.c((double)($$25 * 0.5F));
                  fex $$30 = $$23.d($$29);
                  fex $$31 = $$24.d($$29);
                  fex $$32 = $$23.e($$29);
                  fex $$33 = $$24.e($$29);
                  Iterable<ffr> $$34 = this.dU().d(this, $$27);
                  Iterator<fes> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean ga() {
      ...
      if (this.V_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.cq.ak().a((hnh)(new hnk.b(this)));
         }
