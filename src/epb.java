...
public class epb {
   ...
   private final Map<String, Long2ObjectMap<tw>> e = Maps.newHashMap();
   private final Map<String, epj> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public epb(@Nullable ewt $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tw a(tw $$0) {
      tw $$1 = $$0.p("Level");
      dgw $$2 = new dgw($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.h, $$2.i)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dgw.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dgw.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private tw a(tw $$0, dgw $$1) {
      tw $$2 = $$0.p("Level");
      tw $$3 = $$2.p("Structures");
      tw $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<tw> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable ewt $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            tw $$2 = new tw();

            try {
               $$2 = $$0.a($$1, bax.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               tw $$4 = $$2.p($$3);
               long $$5 = dgw.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               uc $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tw $$14 = $$2.p($$13);
                  $$12.a(dgw.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static epb a(alc<dhp> $$0, @Nullable ewt $$1) {
      if ($$0 == dhp.i) {
         return new epb(
            $$1,
         ...
         return new epb($$1, $$2, $$2);
      } else if ($$0 == dhp.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new epb($$1, $$3, $$3);
      } else {
