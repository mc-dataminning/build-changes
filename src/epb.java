...
public class epb implements dzp.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<epb> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayv<epb> a = ayv.a(f);
   private final epf g;
   private final epf h;
   private final epf i;
   ...
   public static epb a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new epb(new eax(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private epb(epf $$0, epf $$1, epf $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public epb(azk $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         epf.a($$0, IntStream.rangeClosed(-15, 0)),
         epf.a($$0, IntStream.rangeClosed(-15, 0)),
         epf.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public epb a(azk $$0) {
      return new epb($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dzp.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         epc $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(epf.b($$4 * $$13), epf.b($$5 * $$13), epf.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = epf.b($$1 * $$13);
         double $$21 = epf.b($$2 * $$13);
         double $$22 = epf.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            epc $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return azc.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
