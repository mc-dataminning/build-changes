...
public class epb {
   ...
   private static final dsg.f e = ($$0, $$1, $$2) -> $$0.a(dfh.co);
   ...
   public static Optional<epb> a(dce $$0, ja $$1, jf.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<epb> a(dce $$0, ja $$1, Predicate<epb> $$2, jf.a $$3) {
      Optional<epb> $$4 = Optional.of(new epb($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         jf.a $$5 = $$3 == jf.a.a ? jf.a.c : jf.a.a;
         return Optional.of(new epb($$0, $$1, $$5)).filter($$2);
      }
   }

   public epb(dce $$0, ja $$1, jf.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dsh $$0) {
      return $$0.i() || $$0.a(avu.aK) || $$0.a(dfh.ed);
   }
   ...
   public static evz a(l.a $$0, jf.a $$1, evz $$2, bsg $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = aye.a(aye.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         jf.a $$10 = jf.a.b;
         $$11 = aye.a(aye.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new evz($$8, $$11, $$14);
   }

   public static epa a(aqk $$0, l.a $$1, jf.a $$2, evz $$3, bsd $$4, evz $$5, float $$6, float $$7) {
      ja $$8 = $$1.a;
      dsh $$9 = $$0.a_($$8);
      jf.a $$10 = $$9.d(dsx.H).orElse(jf.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bsg $$13 = $$4.a($$4.ar());
      int $$14 = $$2 == $$10 ? 0 : 90;
      evz $$15 = $$2 == $$10 ? $$5 : new evz($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == jf.a.a;
      evz $$20 = new evz((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      evz $$21 = a($$20, $$0, $$4, $$13);
      return new epa($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static evz a(evz $$0, aqk $$1, bsd $$2, bsg $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         evz $$5 = $$0.b(0.0, $$4, 0.0);
         ews $$6 = ewp.a(evu.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<evz> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<evz> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
