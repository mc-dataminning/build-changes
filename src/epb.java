...
public class epb extends gfb {
   ...
   @Override
   public void aH_() {
      this.Q = this.d(esq.a(tk.k, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.Q.j = false;
      this.R = this.d(esq.a(tk.e, $$0 -> this.E()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.P) {
         if (this.D.b == -1) {
            this.G();
         } else {
   ...
   private void D() {
      this.f.a(new eof(new ema(new eyp()), this.F));
   }
