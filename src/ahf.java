...
public class ahf {
   ...
   private static int a(dt $$0, fx $$1, Collection<akt> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = $$1.a().l();
      int $$5 = $$4 * 100;
      cjh $$6 = $$1.a($$3, false);
      if ($$3 > $$5) {
         $$0.b(tn.a("commands.give.failed.toomanyitems", $$5, $$6.J()));
         return 0;
      } else {
         for (akt $$7 : $$2) {
            int $$8 = $$3;
            ...
            while ($$8 > 0) {
               ...
               if ($$11 && $$10.b()) {
                  ...
                  $$7.dL().a(null, $$7.dq(), $$7.ds(), $$7.dw(), apf.ma, apg.h, 0.2F, (($$7.ef().i() - $$7.ef().i()) * 0.7F + 1.0F) * 2.0F);
                  $$7.bS.d();
               } else {
                  byp $$12 = $$7.a($$10, false);
                  if ($$12 != null) {
         ...
         if ($$2.size() == 1) {
            $$0.a(() -> tn.a("commands.give.success.single", $$3, $$6.J(), $$2.iterator().next().N_()), true);
         } else {
            $$0.a(() -> tn.a("commands.give.success.single", $$3, $$6.J(), $$2.size()), true);
         }
