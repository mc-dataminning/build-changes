...
public class cat extends bxy<cpi> {
   ...
   protected boolean a(ash $$0, cpi $$1) {
      return bya.a($$1.ec(), cfj.q, bvq.bD);
   }
   ...
   protected void c(ash $$0, cpi $$1, long $$2) {
      ...
      if (!($$1.g($$3) > 5.0)) {
         bya.a($$1, $$3, 0.5F, 2);
         $$1.a($$0, $$3, $$2);
         if ($$1.gF() && ($$1.gy().b() == cpl.g || $$3.gG())) {
            a($$1, cpi.cc.keySet(), $$3);
         }

         if ($$3.gy().b() == cpl.g && $$1.t().a_(cxs.pS) > cxs.pS.h() / 2) {
   ...
   private static Set<cxk> a(cpi $$0, cpi $$1) {
      ImmutableSet<cxk> $$2 = $$1.gy().b().d();
      ImmutableSet<cxk> $$3 = $$0.gy().b().d();
