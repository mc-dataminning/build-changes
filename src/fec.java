...
public class fec<T extends bwe & bjk> extends fdw<T> {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * asb.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * asb.b($$2 * 0.9F));
