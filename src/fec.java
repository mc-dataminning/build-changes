...
public class fec<T extends bvt & biz> extends fdw<T> {
   ...
   public static fid c() {
      ...
      fig $$1 = $$0.a();
      fig $$2 = $$1.a(
         "body", fic.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fhz.a(0.0F, 20.0F, 5.0F)
      );
      fib $$3 = new fib(0.001F);
      fig $$4 = $$2.a("head", fic.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fhz.a(0.0F, 0.0F, -9.0F));
      fic $$5 = fic.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fic $$6 = fic.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fic $$7 = fic.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fhz.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fhz.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fhz.a(4.0F, 0.0F, -1.0F));
      fic $$8 = fic.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fic $$9 = fic.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fhz.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fhz.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fhz.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fhz.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fic.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fhz.a(0.0F, 0.0F, 1.0F));
   ...
   private Vector3f a(fhx $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fhx $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fhx $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * ars.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * ars.b($$2 * 0.9F));
