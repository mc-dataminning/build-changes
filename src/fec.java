...
public class fec {
   private static final Map<String, fec.a> a = Maps.newHashMap();
   ...
   private static akk b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            akk $$4 = goy.b();
            a.put($$0, new fec.a($$1, $$4));
            return $$4;
         } else {
            akk $$5 = new akk("realms", "dynamic/" + $$0);
            ffn.Q().aa().a($$5, new gov($$3));
            a.put($$0, new fec.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static ezh a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return ezh.a($$2.put($$1).flip());
