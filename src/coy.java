...
public record coy(coy.a d) {
   ...
   public static final Codec<coy> c = coy.a.a.xmap(coy::new, coy::b);

   public static coy a(azl $$0, UUID $$1, coy.a $$2) throws coy.b {
      if (!$$2.a($$0, $$1)) {
         throw new coy.b(e);
      } else {
         return new coy($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<coy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayh.q.fieldOf("expires_at").forGetter(coy.a::b), axw.f.fieldOf("key").forGetter(coy.a::c), ayh.r.fieldOf("signature_v2").forGetter(coy.a::d)
               )
               .apply($$0, coy.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof coy.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
