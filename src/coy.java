...
public class coy {
   ...
   @VisibleForTesting
   protected final ArrayList<bvj> c;
   private final coy.a k;
   @VisibleForTesting
   protected final Object2IntMap<bvj> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<coy> a(Predicate<bvj> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(coy::b)).apply($$1, $$1x -> new coy($$0, $$1x))
      );
   }

   public coy(Predicate<bvj> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new coy.a(this);
   ...
   public void a(ash $$0, Predicate<bvj> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bvj>> $$5 = this.d.object2IntEntrySet().iterator();
   ...
   public int b(@Nullable bvj $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bwf> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bwf).map($$0 -> (bwf)$$0);
   }

   @VisibleForTesting
   protected static record a(coy a) implements Comparator<bvj> {
      public int a(bvj $$0, bvj $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cpw;
               boolean $$7 = $$1 instanceof cpw;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
