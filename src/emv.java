...
public class emv implements dxn.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<emv> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ays<emv> a = ays.a(f);
   private final emz g;
   private final emz h;
   private final emz i;
   ...
   public static emv a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new emv(new dyv(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private emv(emz $$0, emz $$1, emz $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public emv(azh $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         emz.a($$0, IntStream.rangeClosed(-15, 0)),
         emz.a($$0, IntStream.rangeClosed(-15, 0)),
         emz.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public emv a(azh $$0) {
      return new emv($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxn.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         emw $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(emz.b($$4 * $$13), emz.b($$5 * $$13), emz.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = emz.b($$1 * $$13);
         double $$21 = emz.b($$2 * $$13);
         double $$22 = emz.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            emw $$24 = this.g.a($$19);
            if ($$24 != null) {
