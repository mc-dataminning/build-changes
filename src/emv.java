...
public abstract class emv {
   ...
   public elx a() {
      if (this.c()) {
         ...
         return new elx(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
      }
   }

   public emv b() {
      return this.c() ? ems.a() : ems.a(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
   }
   ...
   public emv a(double $$0, double $$1, double $$2) {
      return (emv)(this.c() ? ems.a() : new eme(this.a, new emr(this.a(ic.a.a), $$0), new emr(this.a(ic.a.b), $$1), new emr(this.a(ic.a.c), $$2)));
   }

   public emv d() {
      emv[] $$0 = new emv[]{ems.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ems.b($$0[0], ems.a($$1, $$2, $$3, $$4, $$5, $$6), emg.o));
      return $$0[0];
   }
   ...
   public List<elx> e() {
      List<elx> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new elx($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(ic.a $$0, double $$1) {
      return aup.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public ely a(emc $$0, emc $$1, hx $$2) {
      if (this.c()) {
         return null;
      } else {
         emc $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ic.a.a, $$4.c - (double)$$2.u()), this.a(ic.a.b, $$4.d - (double)$$2.v()), this.a(ic.a.c, $$4.e - (double)$$2.w()))
               ? new ely($$4, ic.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : elx.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<emc> a(emc $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         emc[] $$1 = new emc[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = aup.a($$0.a(), $$2, $$5);
            double $$9 = aup.a($$0.b(), $$3, $$6);
            double $$10 = aup.a($$0.c(), $$4, $$7);
   ...
   public emv a(ic $$0) {
      if (!this.c() && this != ems.b()) {
         if (this.b != null) {
            emv $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private emv b(ic $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new emt(this, $$1, $$4);
      }
   }

   public double a(ic.a $$0, elx $$1, double $$2) {
      return this.a(hv.a($$0, ic.a.a), $$1, $$2);
   }

   protected double a(hv $$0, elx $$1, double $$2) {
      if (this.c()) {
         return $$2;
