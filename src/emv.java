...
public enum emv {
   ...
   private emv(String... $$0) {
      this.c = $$0;
   }

   public List<apd<InputStream>> a(anz $$0) throws IOException {
      return List.of(
   ...
   public apd<InputStream> b(anz $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private apd<InputStream> a(anz $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      apd<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
