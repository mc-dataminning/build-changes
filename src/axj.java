...
public class axj<K> implements jf<K> {
   ...
   private axj(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> axj<A> c(int $$0) {
      return new axj((int)((float)$$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (aym.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public axj<K> c() {
      return new axj<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
