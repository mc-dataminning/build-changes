...
public class axj extends azx {
   public axj(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bax.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bax.z.typeName(), bcf.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bax.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bax.z.typeName(), "minecraft:saddle"));
