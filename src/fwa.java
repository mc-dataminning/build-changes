...
public class fwa extends frp {
   ...
   @Nullable
   gee x;
   private final Consumer<gee> y;
   final fpl z = new fpl(this);
   final gef A;

   public fwa(@Nullable frp $$0, @Nullable gee $$1, gef $$2, Consumer<gee> $$3) {
      super(a);
      this.v = $$0;
      this.x = $$1;
      this.y = $$3;
   ...
   protected void aS_() {
      this.z.a(a, this.p);
      fpp $$0 = this.z.c(fpp.d().a(4));
      this.w = $$0.a(new fwa.a(this.m));
      fwa.a.a $$1 = x.a(this.x, this.w::a);
      this.w.a($$1);
      $$0.a(fpq.b(this.J()));
      fpp $$2 = this.z.b(fpp.e().a(8));
      $$2.a(flw.a(c, fqm.b(this, ayj.m)).a());
      $$2.a(flw.a(xk.d, $$0x -> {
         fwa.a.a $$1x = this.w.h();
         if ($$1x != null) {
            this.y.accept($$1x.b());
   ...
   public class a extends fms<fwa.a.a> {
      public a(final fjx $$1) {
         super($$1, fwa.this.n, fwa.this.K(), fwa.this.z.c(), 18);

         for (gee $$2 : gee.values()) {
            if (!gee.a(fwa.this.A).contains($$2)) {
               this.b(new fwa.a.a($$2));
            }
         }
      }

      @Nullable
      public fwa.a.a a(gee $$0) {
      ...
      public void a(@Nullable fwa.a.a $$0) {
         super.a($$0);
         fwa.this.x = $$0 != null ? $$0.b() : null;
      }

      public class a extends fms.a<fwa.a.a> {
         final gee b;

         public a(final gee $$1) {
            this.b = $$1;
         }
         ...
         public void a(flj $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            int $$10 = $$3 + 1;
            int $$11 = $$2 + ($$5 - 9) / 2 + 1;
            $$0.b(fwa.this.p, this.b.b(), $$10, $$11, -1);
         }
