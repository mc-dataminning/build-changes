...
public class asr {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (asr.this.e.am()) {
                  $$1.addLast("legacy_query", new ask(asr.this.d()));
               }

               wd.a($$1, zr.a, false, null);
               int $$2 = asr.this.e.o();
               wd $$3 = (wd)($$2 > 0 ? new wt($$2) : new wd(zr.a));
               asr.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new ast(asr.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xj $$3 = xj.b("Internal server error");
                     $$1.a(new zz($$3), wq.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<asr.a.a> d = Lists.newArrayList();
