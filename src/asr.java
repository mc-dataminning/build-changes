...
class asr extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof asq && $$1 instanceof asq && $$0.equals($$1);
   }
   ...
   private static asq a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof asq) {
         return (asq)$$0;
      } else {
