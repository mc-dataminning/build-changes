...
public class asr {
   ...
   asr(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static asr.a a() {
      return new asr.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(asr::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public asr.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public asr a(Writer $$0) throws IOException {
         return new asr($$0, this.a);
      }
   }
}
