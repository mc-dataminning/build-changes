...
class asr implements Path {
   private static final BasicFileAttributes a = new asp() {
      @Override
   ...
   private static final BasicFileAttributes b = new asp() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<asr> c = Comparator.comparing(asr::n);
   ...
   public asr(ast $$0, String $$1, @Nullable asr $$2, asu $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private asr a(@Nullable asr $$0, String $$1) {
      return new asr(this.e, $$1, $$0, asu.b);
   }
   ...
   asr a(String $$0) {
      if (a(this.i)) {
         return new asr(this.e, $$0, this, this.i);
      } else if (this.i instanceof asu.a $$1) {
         asr $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new asr(this.e, $$0, this, asu.a);
      } else if (this.i instanceof asu.b) {
         return new asr(this.e, $$0, this, asu.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(asu $$0) {
      return $$0 == asu.a || $$0 == asu.b;
   }
   ...
   private asr c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof asr $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof asu.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public asu.a i() {
      return this.i instanceof asu.a $$0 ? $$0 : null;
   }
