...
@Deprecated
public class ebn extends eay<ebn.a> {
   private static final dsc a = dfb.nc.o();

   public ebn(Codec<ebn.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<ebn.a> $$0) {
      iz $$1 = $$0.e();
      dct $$2 = $$0.b();
      azh $$3 = $$0.d();
      ebn.a $$4 = $$0.f();
   ...
   public static record a(efd b, efd c) implements edc {
      public static final Codec<ebn.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(efd.a.fieldOf("fluid").forGetter(ebn.a::a), efd.a.fieldOf("barrier").forGetter(ebn.a::b)).apply($$0, ebn.a::new)
      );
