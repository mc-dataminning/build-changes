...
public class ebn extends eba<ecx> {
   public ebn(Codec<ecx> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebc<ecx> $$0) {
      iz $$1 = $$0.e();
      dcv $$2 = $$0.b();
   ...
   private void a(azh $$0, dcb $$1, int $$2, int $$3, iz $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iz $$2, dcb $$3, boolean $$4, double $$5, iz $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dcb $$0, iz $$1) {
      if ($$0.a_($$1.c()).a(dfd.dN)) {
         this.a($$0, $$1.c(), dfd.a.o());
      }
   }

   private void a(dcb $$0, azh $$1, iz $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dse $$13) {
   ...
   private void a(iz $$0, dcb $$1, azh $$2, int $$3, int $$4, boolean $$5, boolean $$6, dse $$7) {
      dse $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dfd.dP) || $$8.a(dfd.dO) || $$8.a(dfd.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dfd.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dfd.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dse $$0) {
      return $$0.a(dfd.iC) || $$0.a(dfd.dP) || $$0.a(dfd.mW);
   }
   ...
   private void a(dcb $$0, iz $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dfd.dN)) {
                  if (this.a((dbg)$$0, $$10)) {
                     this.a($$0, $$10, dfd.a.o());
                     this.a($$0, $$10.c(), dfd.a.o());
                  } else if (c($$11)) {
                     dse[] $$12 = new dse[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
