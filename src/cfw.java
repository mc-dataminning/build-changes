...
public class cfw extends cfd {
   ...
   @Nullable
   private cmn y;
   private final List<cmn> z;

   public cfw(int $$0, cbl $$1) {
      this($$0, $$1, ceo.a);
   }

   public cfw(int $$0, cbl $$1, ceo $$2) {
      super(cfi.u, $$0, $$1, $$2);
      this.x = $$1.m.dK();
      this.z = this.x.q().a(cmd.g);
   }
   ...
   @Override
   public void m() {
      List<cmn> $$0 = this.x.q().b(cmd.g, this.q, this.x);
      if ($$0.isEmpty()) {
         this.r.a(0, cix.b);
      } else {
         cmn $$1 = $$0.get(0);
         cix $$2 = $$1.a(this.q, this.x.B_());
         if ($$2.a(this.x.G())) {
            this.y = $$1;
            this.r.a($$1);
            this.r.a(0, $$2);
   ...
   private static OptionalInt a(cmn $$0, cix $$1) {
      if ($$0.a($$1)) {
