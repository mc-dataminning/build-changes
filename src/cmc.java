...
public class cmc {
   ...
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kc.a.fieldOf("uuid").forGetter(Pair::getFirst), ayh.k.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bsw> j;
   @VisibleForTesting
   protected final ArrayList<bsw> c;
   private final cmc.a k;
   @VisibleForTesting
   protected final Object2IntMap<bsw> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cmc> a(Predicate<bsw> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cmc::b)).apply($$1, $$1x -> new cmc($$0, $$1x))
      );
   }

   public cmc(Predicate<bsw> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cmc.a(this);
   ...
   public void a(arf $$0, Predicate<bsw> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsw>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsw> $$6 = (Entry<bsw>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsw $$8 = (bsw)$$6.getKey();
         bsw.c $$9 = $$8.dL();
   ...
   public int b(@Nullable bsw $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btr> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btr).map($$0 -> (btr)$$0);
   }

   @VisibleForTesting
   protected static record a(cmc a) implements Comparator<bsw> {
      public int a(bsw $$0, bsw $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cmz;
               boolean $$7 = $$1 instanceof cmz;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
