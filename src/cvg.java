...
public class cvg extends cxl {
   ...
   public boolean a(cwp $$0, dgi $$1, bvg $$2, int $$3) {
      ...
      if ($$5 >= 1.0F && !g($$0) && a($$2, $$0)) {
         cvg.b $$6 = this.i($$0);
         $$6.c().ifPresent($$2x -> $$1.a(null, $$2.dB(), $$2.dD(), $$2.dH(), (avz)$$2x.a(), $$2.dn(), 1.0F, 1.0F / ($$1.H_().i() * 0.5F + 1.0F) + 0.2F));
         return true;
      } else {
         return false;
      }
   ...
   private static boolean a(bvg $$0, cwp $$1) {
   ...
   protected void a(bvg $$0, cpq $$1, int $$2, float $$3, float $$4, float $$5, @Nullable bvg $$6) {
      ...
      float $$16 = a($$0.dZ(), $$2);
      $$0.dW().a(null, $$0.dB(), $$0.dD(), $$0.dH(), awa.gP, $$0.dn(), 1.0F, $$16);
   }

   private static Vector3f a(bvg $$0, fba $$1, float $$2) {
   ...
   @Override
   protected cpq a(dgi $$0, bvg $$1, cwp $$2, cwp $$3, boolean $$4) {
      if ($$3.a(cwt.vt)) {
         return new cpl($$0, $$3, $$1, $$1.dB(), $$1.dF() - 0.15F, $$1.dH(), true);
      } else {
   ...
   public void a(dgi $$0, bvg $$1, bsi $$2, cwp $$3, float $$4, float $$5, @Nullable bvg $$6) {
   ...
   public void a(dgi $$0, bvg $$1, cwp $$2, int $$3) {
      if (!$$0.C) {
         ...
         if ($$5 >= 0.2F && !this.n) {
            this.n = true;
            $$4.a().ifPresent($$2x -> $$0.a(null, $$1.dB(), $$1.dD(), $$1.dH(), (avz)$$2x.a(), awb.h, 0.5F, 1.0F));
         }

         if ($$5 >= 0.5F && !this.o) {
            this.o = true;
            $$4.b().ifPresent($$2x -> $$0.a(null, $$1.dB(), $$1.dD(), $$1.dH(), (avz)$$2x.a(), awb.h, 0.5F, 1.0F));
         }
      }
   }
   ...
   public static int b(cwp $$0, bvg $$1) {
   ...
   private static float a(int $$0, cwp $$1, bvg $$2) {
