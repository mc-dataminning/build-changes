   ...
   public static dfo a() {
      if (f == null) {
         f = dfp.a()
            .a("?vvv?", ">???<", ">???<", ">???<", "?^^^?")
            .a('?', dfn.a(dfs.a))
            .a('^', dfn.a(dfs.a(csw.fy).a(b, Predicates.equalTo(true)).a(a, Predicates.equalTo(ha.d))))
            .a('>', dfn.a(dfs.a(csw.fy).a(b, Predicates.equalTo(true)).a(a, Predicates.equalTo(ha.e))))
            .a('v', dfn.a(dfs.a(csw.fy).a(b, Predicates.equalTo(true)).a(a, Predicates.equalTo(ha.c))))
            .a('<', dfn.a(dfs.a(csw.fy).a(b, Predicates.equalTo(true)).a(a, Predicates.equalTo(ha.f))))
            .b();
      }
