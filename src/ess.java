...
public class ess extends esm<ess.a> {
   protected ess(dze $$0) {
      super(dgq.a, $$0, new ess.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dyw g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kk.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dyw(15) : new dyw();
         }
      }
   }

   private static dyw a(dyw $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends esj<ess.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dyw> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public ess.a a() {
         return new ess.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
