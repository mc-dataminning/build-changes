...
public class ess {
   ...
   static class a implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
         return $$0.c[ja.f.d()] && !$$0.b[ja.f.d()].d;
      }

      @Override
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         $$1.d = true;
         $$1.b[ja.f.d()].d = true;
         return new ess.k($$0, $$1);
      }
   }

   static class b implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         ...
         return new ess.l($$0, $$1);
      }
   }

   static class c implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         $$1.d = true;
         $$1.b[ja.b.d()].d = true;
         return new ess.m($$0, $$1);
      }
   }

   static class d implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         ...
         return new ess.n($$0, $$1);
      }
   }

   static class e implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         ...
         $$3.d = true;
         $$3.b[ja.c.d()].d = true;
         return new ess.o($$0, $$3);
      }
   }

   static class f implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
         return true;
      }
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         $$1.d = true;
         return new ess.s($$0, $$1, $$2);
      }
   }

   static class g implements ess.i {
      @Override
      public boolean a(ess.v $$0) {
      ...
      public ess.r a(ja $$0, ess.v $$1, azt $$2) {
         $$1.d = true;
         return new ess.t($$0, $$1);
      }
   }

   public static class h extends ess.r {
      ...
      private ess.v G;
      private ess.v H;
      private final List<ess.r> I = Lists.newArrayList();

      public h(azt $$0, int $$1, int $$2, ja $$3) {
         super(eqz.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ess.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ess.p($$3, this.G));
         this.I.add(new ess.j($$3, this.H));
         List<ess.i> $$5 = Lists.newArrayList();
         $$5.add(new ess.b());
         $$5.add(new ess.d());
         $$5.add(new ess.e());
         $$5.add(new ess.a());
         ...
         eqa $$10 = eqa.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eqa $$11 = eqa.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eqa $$12 = eqa.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ess.u($$3, $$10, $$13++));
         this.I.add(new ess.u($$3, $$11, $$13++));
         this.I.add(new ess.q($$3, $$12));
      }
      ...
      private List<ess.v> b(azt $$0) {
         ess.v[] $$1 = new ess.v[75];
         ...
         ess.v $$23 = new ess.v(1003);
         ess.v $$24 = new ess.v(1001);
         ess.v $$25 = new ess.v(1002);
         $$1[v].a(ja.b, $$23);
         $$1[w].a(ja.d, $$24);
         $$1[x].a(ja.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ess.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, djo $$2, azt $$3, eqa $$4) {
         int $$5 = 24;
      ...
      private void a(djo $$0, azt $$1, eqa $$2) {
      ...
      private void b(djo $$0, azt $$1, eqa $$2) {
      ...
      private void c(djo $$0, azt $$1, eqa $$2) {
      ...
      private void d(djo $$0, azt $$1, eqa $$2) {
      ...
      private void e(djo $$0, azt $$1, eqa $$2) {
      ...
      private void f(djo $$0, azt $$1, eqa $$2) {
   ...
   interface i {
      boolean a(ess.v var1);

      ess.r a(ja var1, ess.v var2, azt var3);
   }

   public static class j extends ess.r {
      public j(ja $$0, ess.v $$1) {
         super(eqz.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(djo $$0, djl $$1, ebm $$2, azt $$3, eqa $$4, dhw $$5, iu $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dlw.co.m(), dlw.co.m(), false);
   ...
   public static class k extends ess.r {
      public k(ja $$0, ess.v $$1) {
         super(eqz.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ess.r {
      public l(ja $$0, ess.v $$1) {
         super(eqz.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ess.r {
      public m(ja $$0, ess.v $$1) {
         super(eqz.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ess.r {
      public n(ja $$0, ess.v $$1) {
         super(eqz.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ess.r {
      public o(ja $$0, ess.v $$1) {
         super(eqz.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ess.r {
      public p(ja $$0, ess.v $$1) {
         super(eqz.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ess.r {
      public q(ja $$0, eqa $$1) {
         super(eqz.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eqm {
      protected static final dzo b = dlw.ix.m();
      protected static final dzo c = dlw.iy.m();
      protected static final dzo d = dlw.iz.m();
      protected static final dzo h = c;
      protected static final dzo i = dlw.iG.m();
      protected static final boolean j = true;
      protected static final dzo k = dlw.J.m();
      protected static final Set<dlu> l = ImmutableSet.builder().add(dlw.eb).add(dlw.ja).add(dlw.ny).add(k.b()).build();
      ...
      public r(eqz $$0, ja $$1, int $$2, eqa $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eqz $$0, int $$1, ja $$2, ess.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eqa a(ja $$0, ess.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eqa $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(djo $$0, eqa $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dzo $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(djo $$0, eqa $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(djo $$0, eqa $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dzo $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eqa $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(djo $$0, eqa $$1, int $$2, int $$3, int $$4) {
         iu $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cni $$6 = bwj.M.a($$0.a(), bwi.d);
            if ($$6 != null) {
               $$6.c($$6.eT());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bwi.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ess.r {
      private int a;

      public s(ja $$0, ess.v $$1, azt $$2) {
         super(eqz.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ess.r {
      public t(ja $$0, ess.v $$1) {
         super(eqz.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ess.r {
      private int a;

      public u(ja $$0, eqa $$1, int $$2) {
         super(eqz.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
