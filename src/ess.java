...
public class ess {
   ...
   private static final Map<dkm.a, String> e = ac.a(new EnumMap<>(dkm.a.class), $$0 -> {
      $$0.put(dkm.a.a, "SW");
      $$0.put(dkm.a.b, "S");
      $$0.put(dkm.a.c, "OW");
      $$0.put(dkm.a.d, "O");
   ...
   private dhk l;
   @Nullable
   private CompletableFuture<dhk> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final asj r = new asj();
   private final asj s = new asj();
   private final asj t = new asj();
   private final asj u = new asj();
   private final eua v;
   private final euc w;
   private final eub x;
   private final etz y;
   ...
   private void a(erz $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cqb $$16 = this.p();
         LongSet $$17 = (LongSet)($$16 instanceof akt ? ((akt)$$16).u() : LongSets.EMPTY_SET);
         ...
         $$18.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$9, $$14, asb.g($$8.dB()), asb.g($$8.dD())));
         dhk $$20 = this.r();
         if ($$20.C()) {
            $$18.add("Waiting for chunk...");
         } else {
            int $$21 = this.f.r.i().p().a($$7, 0);
            int $$22 = this.f.r.a(cqk.a, $$7);
            int $$23 = this.f.r.a(cqk.b, $$7);
            $$18.add("Client Light: " + $$21 + " (" + $$22 + " sky, " + $$23 + " block)");
            dhk $$24 = this.q();
            StringBuilder $$25 = new StringBuilder("CH");

            for (dkm.a $$26 : dkm.a.values()) {
               if ($$26.b()) {
            ...
            if ($$7.v() >= this.f.r.H_() && $$7.v() < this.f.r.aj()) {
               ...
               if ($$24 != null) {
                  float $$28 = $$16.an();
                  long $$29 = $$24.u();
                  bhc $$30 = new bhc($$16.ai(), $$16.W(), $$29, $$28);
         ...
         if ($$31 != null) {
            ...
            cqm.d $$37 = $$32.n();
            if ($$37 != null) {
               Object2IntMap<bjp> $$38 = $$37.b();
               int $$39 = $$37.a();
               $$18.add(
                  "SC: "
                     + $$39
                     + ", "
                     + Stream.of(bjp.values())
   ...
   private static String a(he<cqz> $$0) {
   ...
   private cqb p() {
      return (cqb)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ac()))), this.f.r);
   }
   ...
   private dhk q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, dhe.n, false).thenApply($$0x -> (dhk)$$0x.map($$0xx -> (dhk)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ekc.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", eqp.O().aM().k(), eqp.O().aM().l(), ekc.a()),
            ekc.c(),
            ekc.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == ehf.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dgg<?>, Comparable<?>> $$7 = (Entry<dgg<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ehf.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dgg<?>, Comparable<?>> $$10 = (Entry<dgg<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dgg<?>, Comparable<?>> $$0) {
      dgg<?> $$1 = $$0.getKey();
