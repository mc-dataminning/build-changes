...
public class gu extends hz {
   ...
   private static final int e = 1 + apa.f(apa.c(30000000));
   ...
   public static Iterable<gu> a(apf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      int $$8 = $$5 - $$2 + 1;
      int $$9 = $$6 - $$3 + 1;
      int $$10 = $$7 - $$4 + 1;
   ...
   public static Stream<gu> a(eed $$0) {
      return a(apa.a($$0.a), apa.a($$0.b), apa.a($$0.c), apa.a($$0.d), apa.a($$0.e), apa.a($$0.f));
   }
