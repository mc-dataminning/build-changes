...
public class eaf implements eac, AutoCloseable {
   ...
   private final brd c;
   private final eak d;
   private final SequencedMap<dfp, eaf.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected eaf(eam $$0, Path $$1, boolean $$2) {
      this.d = new eak($$0, $$1, $$2);
      this.c = new brd(eaf.b.values().length, af.i(), "IOWorker-" + $$0.c());
   }

   public boolean a(dfp $$0, int $$1) {
      dfp $$2 = new dfp($$0.h - $$1, $$0.i - $$1);
      dfp $$3 = new dfp($$0.h + $$1, $$0.i + $$1);
   ...
   public CompletableFuture<Void> a(dfp $$0, Supplier<tq> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         tq $$2 = $$1.get();
         eaf.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new eaf.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<tq>> a(dfp $$0) {
      return this.a((eaf.c<Optional<tq>>)(() -> {
         eaf.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((eaf.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dfp $$0, uk $$1) {
      return this.a((eaf.c<Void>)(() -> {
         try {
            eaf.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(eaf.c<T> $$0) {
      return this.c.a(eaf.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dfp, eaf.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new brf.c(eaf.b.b.ordinal(), this::b));
   }

   private void a(dfp $$0, eaf.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(eaf.b.c.ordinal(), $$0 -> $$0.complete(baf.a)).join();
   }
