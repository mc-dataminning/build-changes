...
public class eaf extends dzz<ece> {
   private static final it[] a = it.values();

   public eaf(Codec<ece> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eab<ece> $$0) {
      ece $$1 = $$0.f();
      aym $$2 = $$0.d();
      io $$3 = $$0.e();
      dbu $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dxu $$9 = new dxu(new dww($$4.C()));
      elz $$10 = elz.a($$9, -4, 1.0);
      ...
      for (io $$33 : io.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<io, Integer> $$37 : $$7) {
            $$35 += ayf.f($$33.j((js)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (io $$38 : $$11) {
            $$36 += ayf.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, dec.a.n(), $$32);
      ...
      for (io $$44 : $$31) {
         ...
         for (it $$46 : a) {
            ...
            drd $$48 = $$4.a_($$47);
            if ($$45.b(drt.C)) {
               $$45 = $$45.a(drt.C, Boolean.valueOf($$48.u().b()));
            }
