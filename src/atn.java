...
class atn extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atm && $$1 instanceof atm && $$0.equals($$1);
   }
   ...
   private static atm a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atm) {
         return (atm)$$0;
      } else {
