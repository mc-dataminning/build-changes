...
public class atn {
   ...
   private static List<atn.b> a(final Path $$0) throws IOException {
      try {
         final List<atn.b> $$1 = new ArrayList<>();
   ...
   private static List<atn.a> a(List<atn.b> $$0) {
      List<atn.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (atn.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new atn.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<atn.a> a = Comparator.comparing(atn.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<atn.b> a = Comparator.comparing(atn.b::b).reversed();
