...
public abstract class atn implements atw {
   ...
   public <T> T a(auj<T> $$0) throws IOException {
      avd<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(auj<T> $$0, InputStream $$1) {
      JsonObject $$3;
