...
class atn implements Path {
   private static final BasicFileAttributes a = new atl() {
      @Override
   ...
   private static final BasicFileAttributes b = new atl() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atn> c = Comparator.comparing(atn::n);
   ...
   public atn(atp $$0, String $$1, @Nullable atn $$2, atq $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atn a(@Nullable atn $$0, String $$1) {
      return new atn(this.e, $$1, $$0, atq.b);
   }
   ...
   atn a(String $$0) {
      if (a(this.i)) {
         return new atn(this.e, $$0, this, this.i);
      } else if (this.i instanceof atq.a $$1) {
         atn $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atn(this.e, $$0, this, atq.a);
      } else if (this.i instanceof atq.b) {
         return new atn(this.e, $$0, this, atq.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atq $$0) {
      return $$0 == atq.a || $$0 == atq.b;
   }
   ...
   private atn c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atn $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atq.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atq.a i() {
      return this.i instanceof atq.a $$0 ? $$0 : null;
   }
