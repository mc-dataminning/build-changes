...
public record atn(List<atn.a> b) {
   ...
   public static final aud<atn> a = aud.a("overlays", d);
   ...
   public static record a(azf<Integer> a, String b) {
      static final Codec<atn.a> c = RecordCodecBuilder.create(
         $$0 -> $$0.group(azf.a(Codec.INT).fieldOf("formats").forGetter(atn.a::a), Codec.STRING.validate(atn::a).fieldOf("directory").forGetter(atn.a::b))
               .apply($$0, atn.a::new)
      );
