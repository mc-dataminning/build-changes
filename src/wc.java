...
public class wc implements us {
   ...
   public static final MapCodec<wc> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final us.a<wc> c = new us.a<>(b, "translatable");
   private static final uw f = uw.e("%");
   private static final uw g = uw.e("null");
   ...
   @Nullable
   private ru k;
   private List<uw> l = ImmutableList.of();
   ...
   private static wc a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new wc($$0, $$1.orElse(null), a($$2));
   }

   public wc(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<uw> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (wd var4) {
            this.l = ImmutableList.of(uw.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<uw> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new wd(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private uw a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof ur) {
            ...
            return $$1 == null ? g : uw.e($$1.toString());
         }
      } else {
         throw new wd(this, $$0);
      }
   ...
   public vf a(@Nullable du $$0, @Nullable bkq $$1, int $$2) throws CommandSyntaxException {
      ...
      return vf.a(new wc(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof wc $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
