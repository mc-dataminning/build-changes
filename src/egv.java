...
public class egv {
   ...
   public egv(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<egw> $$1) throws IOException {
   ...
   public List<egw> a(Path $$0) throws IOException {
      List<egw> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<egw> a(Path $$0, boolean $$1) throws IOException {
      List<egw> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<egw> $$1) throws IOException {
