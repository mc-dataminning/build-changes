...
public class bcb extends bhp {
   public bcb(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bit.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bit.s, "minecraft:piston");
