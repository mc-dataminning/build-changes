...
public class bcb extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      OpticFinder<String> $$0 = DSL.fieldFinder("id", bjj.a());
      Type<?> $$1 = this.getInputSchema().getType(bhv.B);
      Type<?> $$2 = this.getOutputSchema().getType(bhv.B);
      return this.fixTypeEverywhereTyped("BoatSplitFix", $$1, $$2, $$2x -> {
         ...
         if ($$3.isPresent() && c($$3.get())) {
            ...
            String $$6;
            if (b($$3.get())) {
               $$6 = $$5.map(bcb::e).orElse("minecraft:oak_chest_boat");
            } else {
               $$6 = $$5.map(bcb::d).orElse("minecraft:oak_boat");
            }

            return bao.a($$2, $$2x).update(DSL.remainderFinder(), $$0xx -> $$0xx.remove("Type")).set($$0, $$6);
         } else {
            return bao.a($$2, $$2x);
         }
      });
