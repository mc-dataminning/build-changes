...
public class bcb implements bbu {
   ...
   public static Set<bbs> a() {
      Builder<bbs> $$0 = ImmutableSet.builder();

      try {
         bcb.a $$1 = new bcb.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bbs.a("cpu#" + $$1x, bbr.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bbs.a("heap MiB", bbr.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bbt.a.a());
      return $$0.build();
   }
   ...
   public static bbs a(final LongSupplier $$0) {
