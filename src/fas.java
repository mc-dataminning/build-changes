...
public class fas {
   ...
   private static final Comparator<eqo> K = Comparator.comparing(eqo::d).reversed().thenComparing(eqo::c, String.CASE_INSENSITIVE_ORDER);
   ...
   public float a = 1.0F;
   private int ae;
   private cqk af = cqk.h;
   private final fbo ag;
   private final fco ah;
   private final fdf ai;
   private final fch aj;
   private final fbf ak;
   private int al;
   @Nullable
   private vu am;
   @Nullable
   ...
   public fas(ezg $$0) {
      ...
      this.ai = new fdf($$0);
      this.Y = new fbh($$0);
      this.aj = new fch($$0, this);
      this.ak = new fbf($$0);
      this.ah = new fco($$0);
      this.a();
      fav $$1 = new fav().a(this::b).a(this::i).a(this::k).a(this::m).a(this::j).a(($$0x, $$1x) -> this.ak.a($$0x));
      fav $$2 = new fav().a(this::n).a(($$0x, $$1x) -> {
         if (this.ag.d()) {
            this.ag.a($$0x);
         }
   ...
   private void b(fat $$0, float $$1) {
      ...
      if ($$4 > 0.0F && !this.X.s.a(bol.i)) {
         this.p($$0, $$4);
      }
   }

   private void c(fat $$0, float $$1) {
      if (this.X.s.gd() > 0) {
         this.X.aI().a("sleep");
         ...
         $$0.a(fxy.E(), 0, 0, $$0.a(), $$0.b(), $$4);
         this.X.aI().c();
      }
   }

   private void d(fat $$0, float $$1) {
      far $$2 = this.f();
   ...
   private void g(fat $$0, float $$1) {
      eqv $$2 = this.X.r.K();
      eqn $$3 = null;
      eqq $$4 = $$2.e(this.X.s.cy());
      if ($$4 != null) {
         eqm $$5 = eqm.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      eqn $$6 = $$3 != null ? $$3 : $$2.a(eqm.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void h(fat $$0, float $$1) {
      eqv $$2 = this.X.r.K();
      eqn $$3 = $$2.a(eqm.a);
   ...
   private void a(fat $$0, far $$1, int $$2, int $$3, int $$4) {
   ...
   private void i(fat $$0, float $$1) {
      ezk $$2 = this.X.m;
      if ($$2.ay().a()) {
         if (this.X.q.j() != cww.d || this.a(this.X.v)) {
            ...
            if (this.ag.d() && !this.X.s.gp() && !$$2.T().c()) {
               ...
               if (this.X.m.B().c() == eyq.b) {
                  float $$6 = this.X.s.D(0.0F);
                  boolean $$7 = false;
                  if (this.X.u != null && this.X.u instanceof bpo && $$6 >= 1.0F) {
                     $$7 = this.X.s.gs() > 5.0F;
                     $$7 &= this.X.u.bA();
                  }
   ...
   private boolean a(@Nullable epp $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == epp.a.c) {
         return ((epo)$$0).a() instanceof bng;
      } else if ($$0.c() == epp.a.b) {
         ib $$1 = ((epn)$$0).a();
         cwz $$2 = this.X.r;
   ...
   private void j(fat $$0, float $$1) {
      Collection<boj> $$2 = this.X.s.eu();
      if (!$$2.isEmpty()) {
         if (this.X.y instanceof fiw $$3 && $$3.K()) {
            return;
         }
         ...
         for (boj $$8 : Ordering.natural().reverse().sortedCopy($$2)) {
            il<boh> $$9 = $$8.b();
            if ($$8.g()) {
               int $$10 = $$0.a();
               int $$11 = 1;
   ...
   private void a(bpy $$0, fat $$1, int $$2) {
      this.X.aI().a("jumpBar");
      float $$3 = this.X.s.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   @Nullable
   private cis n() {
      return this.X.ao() instanceof cis $$0 ? $$0 : null;
   }
   ...
   private void b(fat $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$9 = $$0.a() / 2 + 91;
         int $$10 = $$0.b() - 39;
         float $$11 = Math.max((float)$$1.g(bqv.q), (float)Math.max($$5, $$2));
         int $$12 = aww.f($$1.fp());
   ...
   private void a(fat $$0, cis $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fas.b $$11 = fas.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fas.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fas.b.d ? $$11 : fas.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fat $$0, fas.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
   ...
   private void a(fat $$0, ajh $$1, float $$2) {
      RenderSystem.disableDepthTest();
   ...
   private void o(fat $$0, float $$1) {
      ...
      RenderSystem.disableBlend();
      $$0.a(fxy.E(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(fxy.E(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(fxy.E(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(fxy.E(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bow $$0) {
      ib $$1 = ib.a($$0.dr(), $$0.dv(), $$0.dx());
      float $$2 = fxp.a($$0.dM().D_(), $$0.dM().A($$1));
      float $$3 = aww.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(fat $$0, @Nullable bow $$1) {
      doq $$2 = this.X.r.C_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(fat $$0, int $$1, int $$2, float $$3, cis $$4, cqk $$5, int $$6) {
      if (!$$5.b()) {
         float $$7 = (float)$$5.L() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
