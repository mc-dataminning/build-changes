...
public class fas {
   ...
   private fas(boolean $$0, boolean $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.g = $$0;
      this.b = $$2;
      this.d = $$3;
      this.c = $$4;
   ...
   public fas(int $$0, int $$1, int $$2) {
      this(false, false, $$0, $$1, $$0, $$1, $$2);
   }

   public fas(int $$0, int $$1, int $$2, int $$3, int $$4) {
