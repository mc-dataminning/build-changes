...
public class fas {
   ...
   private static final Map<drq.a, String> e = ac.a(new EnumMap<>(drq.a.class), $$0 -> {
      $$0.put(drq.a.a, "SW");
      $$0.put(drq.a.b, "S");
      $$0.put(drq.a.c, "OW");
      $$0.put(drq.a.d, "O");
   ...
   private dol l;
   @Nullable
   private CompletableFuture<dol> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bii r = new bii(1);
   private final bii s = new bii(bin.values().length);
   private final bii t = new bii(1);
   private final bii u = new bii(1);
   private final Map<bij, bii> v = Map.of(bij.a, this.s);
   private final fcb w;
   private final fcd x;
   private final fcc y;
   private final fca z;
   ...
   public fas(eyk $$0) {
      ...
      this.g = new fas.a();
      this.h = $$0.h;
      this.w = new fcb(this.h, this.r);
      this.x = new fcd(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fcc(this.h, this.t);
      this.z = new fca(this.h, this.u);
   }
   ...
   private void a(ezx $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         cwe $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof apa ? ((apa)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.an().do(), this.f.an().dq(), this.f.an().du()));
         $$25.add(String.format(Locale.ROOT, "Block: %d %d %d [%d %d %d]", $$14.u(), $$14.v(), $$14.w(), $$14.u() & 15, $$14.v() & 15, $$14.w() & 15));
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, jd.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, awm.g($$15.dz()), awm.g($$15.dB())));
         dol $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(cwn.a, $$14);
            int $$30 = this.f.r.a(cwn.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dol $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (drq.a $$33 : drq.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.J_() && $$14.v() < this.f.r.ak()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ao();
                  long $$36 = $$31.u();
                  bmj $$37 = new bmj($$23.aj(), $$23.Y(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            cwp.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bpa> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bpa.values())
   ...
   private static String a(il<cxd> $$0) {
   ...
   private cwe r() {
      return (cwe)DataFixUtils.orElse(Optional.ofNullable(this.f.U()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ad()))), this.f.r);
   }
   ...
   private dol s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dof.n, false).thenApply($$0x -> (dol)$$0x.map($$0xx -> (dol)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", erw.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", eyk.P().aN().k(), eyk.P().aN().l(), erw.a()),
            erw.c(),
            erw.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == eot.a.b) {
            ...
            $$4.add(String.valueOf(kh.e.b($$6.b())));
            UnmodifiableIterator var12 = $$6.C().entrySet().iterator();

            while (var12.hasNext()) {
               Entry<dnh<?>, Comparable<?>> $$7 = (Entry<dnh<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == eot.a.b) {
            ...
            $$4.add(String.valueOf(kh.c.b($$9.a())));
            UnmodifiableIterator var17 = $$9.C().entrySet().iterator();

            while (var17.hasNext()) {
               Entry<dnh<?>, Comparable<?>> $$10 = (Entry<dnh<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(kh.g.b($$11.ai())));
         }
   ...
   private String a(Entry<dnh<?>, Comparable<?>> $$0) {
      dnh<?> $$1 = $$0.getKey();
