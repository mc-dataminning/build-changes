...
public abstract class fas {
   ...
   public ezt a() {
      if (this.c()) {
         ...
         return new ezt(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
      }
   }

   public fas b() {
      return this.c() ? fap.a() : fap.a(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
   }
   ...
   public fas a(double $$0, double $$1, double $$2) {
      return (fas)(this.c() ? fap.a() : new faa(this.a, new fao(this.a(jm.a.a), $$0), new fao(this.a(jm.a.b), $$1), new fao(this.a(jm.a.c), $$2)));
   }

   public fas d() {
      fas[] $$0 = new fas[]{fap.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fap.b($$0[0], fap.a($$1, $$2, $$3, $$4, $$5, $$6), fac.o));
      return $$0[0];
   }
   ...
   public List<ezt> e() {
      List<ezt> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new ezt($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jm.a.a, $$4.d - (double)$$2.u()), this.a(jm.a.b, $$4.e - (double)$$2.v()), this.a(jm.a.c, $$4.f - (double)$$2.w()))
               ? new ezu($$4, jm.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : ezt.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<ezy> b(ezy $$0) {
      if (this.c()) {
   ...
   public fas a(jm $$0) {
      if (!this.c() && this != fap.b()) {
         if (this.b != null) {
            fas $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fas b(jm $$0) {
      ...
      if (this.d($$1)) {
         ...
         faq $$4 = new faq(this, $$1, $$3);
         if ($$4.c()) {
            return fap.a();
         } else {
            return (fas)($$4.f() ? fap.b() : $$4);
         }
      }
   }
   ...
   public double a(jm.a $$0, ezt $$1, double $$2) {
      return this.a(je.a($$0, jm.a.a), $$1, $$2);
   }

   protected double a(je $$0, ezt $$1, double $$2) {
      if (this.c()) {
         return $$2;
