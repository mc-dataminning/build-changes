...
public class fas implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fas.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fas(List<fas.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fas a(BufferedReader $$0) {
      return new fas($$0.lines().flatMap($$0x -> fas.a.a($$0x).stream()).toList());
   }

   public static record a(fas.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fas.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fas.a(fas.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fas.a(fas.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fas.a(fas.b.b, $$3));
      ...
      static fas.a b(String $$0) {
         return new fas.a(fas.b.a, "glob:" + $$0);
      }

      static fas.a c(String $$0) {
         return new fas.a(fas.b.a, "regex:" + $$0);
      }

      static fas.a d(String $$0) {
         return new fas.a(fas.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fas.b a = FileSystem::getPathMatcher;
      fas.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
