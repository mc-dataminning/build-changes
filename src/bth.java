...
public class bth extends btb {
   public static final MapCodec<bth> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bth a(float $$0, float $$1, float $$2) {
      return new bth($$0, $$1, $$2);
   }

   private bth(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
