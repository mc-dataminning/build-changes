...
public class bth extends bsw {
   ...
   public bth(dca $$0, double $$1, double $$2, double $$3, int $$4) {
      this(btc.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bth(btc<? extends bth> $$0, dca $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         evt $$0 = new evt(this.k.du() - this.du(), this.k.dw() + (double)this.k.cL() / 2.0 - this.dw(), this.k.dA() - this.dA());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dP() instanceof arf) {
         for (bth $$1 : this.dP().a(dwl.a(bth.class), this.cK().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(arf $$0, evt $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bth($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(arf $$0, evt $$1, int $$2) {
      evo $$3 = evo.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bth> $$5 = $$0.a(dwl.a(bth.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bth $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bth $$0) {
      return $$0 != this && a($$0, this.al(), this.i);
   }

   private static boolean a(bth $$0, int $$1, int $$2) {
      return !$$0.dK() && ($$0.al() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bth $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cmz $$0, int $$1) {
      Entry<btd, cur> $$2 = dad.a(daf.O, $$0, cur::m);
      if ($$2 != null) {
         cur $$3 = $$2.getValue();
