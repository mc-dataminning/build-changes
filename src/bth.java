...
public abstract class bth extends bus {
   private static final akg<Boolean> bY = akk.a(bth.class, aki.k);
   ...
   protected bth(btv<? extends bth> $$0, deg $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bth a(arh var1, bth var2);
   ...
   protected void k() {
      if (!this.o_() && this.bW() && this.dg() instanceof cpu $$0 && !$$0.c(this)) {
         this.af();
      }
   }
