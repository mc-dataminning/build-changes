...
public class fog {
   ...
   private static final Map<edj.a, String> e = ae.a(new EnumMap<>(edj.a.class), $$0 -> {
      $$0.put(edj.a.a, "SW");
      $$0.put(edj.a.b, "S");
      $$0.put(edj.a.c, "OW");
      $$0.put(edj.a.d, "O");
   ...
   private dzt l;
   @Nullable
   private CompletableFuture<dzt> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   ...
   public fog(flz $$0) {
      ...
      this.x = new fpt(this.h, this.s, () -> $$0.s.u().g());
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dgz $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arx ? ((arx)$$23).y() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azu.h($$15.dM()), azu.h($$15.dO())));
         dzt $$27 = this.u();
         if ($$27.E()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.w();
                  bsy $$37 = new bsy($$23.am(), $$23.ae(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dhk.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bwa> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bwa.values())
   ...
   private static String a(jq<dib> $$0) {
   ...
   private dgz s() {
      return (dgz)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ai()))), this.f.s);
   }
   ...
   private dzt t() {
      if (this.m == null) {
         ...
         this.m = $$0.m().b(this.k.h, this.k.i, eak.n, false).thenApply($$0x -> (dzt)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      if (this.f.az()) {
         ...
         if (this.i.d() == fbp.a.b) {
            ...
            for (Entry<dyq<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == fbp.a.b) {
            ...
            for (Entry<dyq<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dyq<?>, Comparable<?>> $$0) {
      dyq<?> $$1 = $$0.getKey();
