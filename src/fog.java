...
public class fog {
   ...
   public void a(dig $$0, bwf $$1, boolean $$2, boolean $$3, float $$4) {
      this.f = true;
      this.g = $$0;
      this.h = $$1;
      this.q = $$2;
      this.t = $$4;
      if ($$1.bZ() && $$1.dk() instanceof ctw $$5 && $$5.f() instanceof cue $$6 && $$6.o()) {
         feq $$7 = $$5.m($$1).d($$5.dt()).d($$1.l($$5)).e(new feq(0.0, (double)azm.h($$4, this.s, this.r), 0.0));
         this.a($$1.j($$4), $$1.i($$4));
         this.a($$6.e($$4).e($$7));
      } else {
         this.a($$1.j($$4), $$1.i($$4));
      ...
      if ($$2) {
         ...
         float $$9 = $$1 instanceof bxe $$8 ? $$8.el() : 1.0F;
         this.a(-this.a(4.0F * $$9), 0.0F, 0.0F);
      } else if ($$1 instanceof bxe && ((bxe)$$1).fR()) {
         ja $$10 = ((bxe)$$1).fT();
   ...
   private float a(float $$0) {
      ...
      for (int $$2 = 0; $$2 < 8; $$2++) {
         ...
         feq $$6 = this.i.b((double)($$3 * 0.1F), (double)($$4 * 0.1F), (double)($$5 * 0.1F));
         feq $$7 = $$6.e(new feq(this.k).c((double)(-$$0)));
         feo $$8 = this.g.a(new dij($$6, $$7, dij.a.c, dij.b.a, this.h));
         if ($$8.d() != feo.a.a) {
   ...
   protected void a(float $$0, float $$1, float $$2) {
      ...
      this.a(new feq(this.i.d + (double)$$3.x, this.i.e + (double)$$3.y, this.i.f + (double)$$3.z));
   }
   ...
   public fog.a j() {
      ...
      double $$3 = $$2 * $$1;
      feq $$4 = new feq(this.k).c(0.05F);
      feq $$5 = new feq(this.m).c($$3);
      feq $$6 = new feq(this.l).c($$2);
      return new fog.a($$4, $$5, $$6);
   }
   ...
   public ewq k() {
      if (!this.f) {
         ...
         ewo $$0 = this.g.b_(this.j);
         if ($$0.a(axh.a) && this.i.e < (double)((float)this.j.v() + $$0.a(this.g, this.j))) {
            return ewq.b;
         } else {
            fog.a $$1 = this.j();

            for (feq $$3 : Arrays.asList($$1.a, $$1.a(), $$1.b(), $$1.c(), $$1.d())) {
               feq $$4 = this.i.e($$3);
               iu $$5 = iu.a((jo)$$4);
               ewo $$6 = this.g.b_($$5);
               if ($$6.a(axh.b)) {
