...
public class fog {
   ...
   static final ThreadLocal<fog.d> f = ThreadLocal.withInitial(fog.d::new);

   public fog(ern $$0) {
      this.d = $$0;
   }

   public void a(cop $$0, gam $$1, dfa $$2, gu $$3, elg $$4, elk $$5, boolean $$6, aru $$7, long $$8, int $$9) {
      boolean $$10 = eqm.N() && $$2.h() == 0 && $$1.a();
      ehe $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(cop $$0, gam $$1, dfa $$2, gu $$3, elg $$4, elk $$5, boolean $$6, aru $$7, long $$8, int $$9) {
      ...
      for (ha $$14 : c) {
         $$7.b($$8);
         List<foh> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || csm.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<foh> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(cop $$0, gam $$1, dfa $$2, gu $$3, elg $$4, elk $$5, boolean $$6, aru $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      gu.a $$11 = $$3.j();

      for (ha $$12 : c) {
         $$7.b($$8);
         List<foh> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || csm.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = fnj.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<foh> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(cop $$0, dfa $$1, gu $$2, elg $$3, elk $$4, List<foh> $$5, float[] $$6, BitSet $$7, fog.b $$8, int $$9) {
      for (foh $$10 : $$5) {
   ...
   private void a(
      cop $$0, dfa $$1, gu $$2, elk $$3, elg.a $$4, foh $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(cop $$0, dfa $$1, gu $$2, int[] $$3, ha $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(cop $$0, dfa $$1, gu $$2, int $$3, int $$4, boolean $$5, elg $$6, elk $$7, List<foh> $$8, BitSet $$9) {
      for (foh $$10 : $$8) {
         if ($$5) {
   ...
   public void a(elg.a $$0, elk $$1, @Nullable dfa $$2, gam $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      aru $$9 = aru.a();
      long $$10 = 42L;
   ...
   private static void a(elg.a $$0, elk $$1, float $$2, float $$3, float $$4, List<foh> $$5, int $$6, int $$7) {
      for (foh $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new fog.e[]{fog.e.k, fog.e.d, fog.e.k, fog.e.j, fog.e.e, fog.e.j, fog.e.e, fog.e.d},
         new fog.e[]{fog.e.k, fog.e.c, fog.e.k, fog.e.i, fog.e.e, fog.e.i, fog.e.e, fog.e.c},
         new fog.e[]{fog.e.l, fog.e.c, fog.e.l, fog.e.i, fog.e.f, fog.e.i, fog.e.f, fog.e.c},
         new fog.e[]{fog.e.l, fog.e.d, fog.e.l, fog.e.j, fog.e.f, fog.e.j, fog.e.f, fog.e.d}
      ),
      b(
         new ha[]{ha.f, ha.e, ha.c, ha.d},
         1.0F,
         true,
         new fog.e[]{fog.e.f, fog.e.d, fog.e.f, fog.e.j, fog.e.l, fog.e.j, fog.e.l, fog.e.d},
         new fog.e[]{fog.e.f, fog.e.c, fog.e.f, fog.e.i, fog.e.l, fog.e.i, fog.e.l, fog.e.c},
         new fog.e[]{fog.e.e, fog.e.c, fog.e.e, fog.e.i, fog.e.k, fog.e.i, fog.e.k, fog.e.c},
         new fog.e[]{fog.e.e, fog.e.d, fog.e.e, fog.e.j, fog.e.k, fog.e.j, fog.e.k, fog.e.d}
      ),
      c(
         new ha[]{ha.b, ha.a, ha.f, ha.e},
         0.8F,
         true,
         new fog.e[]{fog.e.b, fog.e.k, fog.e.b, fog.e.e, fog.e.h, fog.e.e, fog.e.h, fog.e.k},
         new fog.e[]{fog.e.b, fog.e.l, fog.e.b, fog.e.f, fog.e.h, fog.e.f, fog.e.h, fog.e.l},
         new fog.e[]{fog.e.a, fog.e.l, fog.e.a, fog.e.f, fog.e.g, fog.e.f, fog.e.g, fog.e.l},
         new fog.e[]{fog.e.a, fog.e.k, fog.e.a, fog.e.e, fog.e.g, fog.e.e, fog.e.g, fog.e.k}
      ),
      d(
         new ha[]{ha.e, ha.f, ha.a, ha.b},
         0.8F,
         true,
         new fog.e[]{fog.e.b, fog.e.k, fog.e.h, fog.e.k, fog.e.h, fog.e.e, fog.e.b, fog.e.e},
         new fog.e[]{fog.e.a, fog.e.k, fog.e.g, fog.e.k, fog.e.g, fog.e.e, fog.e.a, fog.e.e},
         new fog.e[]{fog.e.a, fog.e.l, fog.e.g, fog.e.l, fog.e.g, fog.e.f, fog.e.a, fog.e.f},
         new fog.e[]{fog.e.b, fog.e.l, fog.e.h, fog.e.l, fog.e.h, fog.e.f, fog.e.b, fog.e.f}
      ),
      e(
         new ha[]{ha.b, ha.a, ha.c, ha.d},
         0.6F,
         true,
         new fog.e[]{fog.e.b, fog.e.d, fog.e.b, fog.e.j, fog.e.h, fog.e.j, fog.e.h, fog.e.d},
         new fog.e[]{fog.e.b, fog.e.c, fog.e.b, fog.e.i, fog.e.h, fog.e.i, fog.e.h, fog.e.c},
         new fog.e[]{fog.e.a, fog.e.c, fog.e.a, fog.e.i, fog.e.g, fog.e.i, fog.e.g, fog.e.c},
         new fog.e[]{fog.e.a, fog.e.d, fog.e.a, fog.e.j, fog.e.g, fog.e.j, fog.e.g, fog.e.d}
      ),
      f(
         new ha[]{ha.a, ha.b, ha.c, ha.d},
         0.6F,
         true,
         new fog.e[]{fog.e.g, fog.e.d, fog.e.g, fog.e.j, fog.e.a, fog.e.j, fog.e.a, fog.e.d},
         new fog.e[]{fog.e.g, fog.e.c, fog.e.g, fog.e.i, fog.e.a, fog.e.i, fog.e.a, fog.e.c},
         new fog.e[]{fog.e.h, fog.e.c, fog.e.h, fog.e.i, fog.e.b, fog.e.i, fog.e.b, fog.e.c},
         new fog.e[]{fog.e.h, fog.e.d, fog.e.h, fog.e.j, fog.e.b, fog.e.j, fog.e.b, fog.e.d}
      );
      ...
      final fog.e[] k;
      final fog.e[] l;
      private static final fog.a[] m = ac.a(new fog.a[6], $$0 -> {
         $$0[ha.a.d()] = a;
         $$0[ha.b.d()] = b;
         $$0[ha.c.d()] = c;
         $$0[ha.d.d()] = d;
      ...
      private a(ha[] $$0, float $$1, boolean $$2, fog.e[] $$3, fog.e[] $$4, fog.e[] $$5, fog.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(cop $$0, dfa $$1, gu $$2, ha $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dfa $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dfa $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dfa $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dfa $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final fog.c[] k = ac.a(new fog.c[6], $$0 -> {
         $$0[ha.a.d()] = a;
         $$0[ha.b.d()] = b;
         $$0[ha.c.d()] = c;
         $$0[ha.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dfa $$0, cop $$1, gu $$2) {
         long $$3 = $$2.a();
         if (this.a) {
