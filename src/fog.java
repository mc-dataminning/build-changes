...
public class fog {
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.U_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = azk.a(this.b.t.gj().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gj().a($$11);
                  }
               } else {
                  cqr $$12 = this.b.t.gi();
                  $$12.e(foo.a((double)$$10, $$12.j, cqr.g()));
               }
            }
         }
      }
   ...
   private void a(double $$0) {
      ...
      if (this.b.n.Z) {
         ...
         $$6 = $$4;
         $$7 = $$5;
      } else if (this.b.n.aE().a() && this.b.t.gG()) {
         this.m.a();
         this.n.a();
         $$6 = this.o * $$2;
         $$7 = this.p * $$2;
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            fhl.a(this.b.aO().h(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aO().m() / 2);
         this.g = (double)(this.b.aO().n() / 2);
         fhl.a(this.b.aO().h(), 212993, this.f, this.g);
      }
   }
