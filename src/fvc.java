...
public class fvc extends fum<fvc.b> {
   ...
   private final fvf ag;

   public fvc(gkg $$0, css $$1, boolean $$2) {
      super(new fvc.b($$0), $$0.gi(), xu.a);
      $$0.cd = this.z;
      this.u = 136;
      this.s = 195;
      this.af = $$2;
      this.a($$0.i.D(), $$1, this.a($$0), $$0.dW().K_());
      this.ag = new fvf(this);
   }
   ...
   private boolean a(@Nullable ggb $$0, css $$1, boolean $$2, js.a $$3) {
      if (!cwe.a($$1, $$2, $$3)) {
         return false;
      } else {
         if ($$0 != null) {
         ...
         if ($$0 == null && V.k() != cwd.h.b && $$3 != ctm.f) {
            ...
            if ($$0 == this.aa && $$4) {
               ...
               if ($$0 == this.aa) {
                  ...
                  this.m.t.a($$6, true);
                  this.m.r.a($$6);
                  this.m.r.a($$7, ((fvc.c)$$0).a.d);
               } else if ($$3 == ctm.e && $$1 == -999 && !this.z.g().f()) {
                  this.m.t.a(this.z.g(), true);
                  this.m.r.a(this.z.g());
                  this.z.b(cxo.j);
               } else {
                  this.m.t.cc.a($$0 == null ? $$1 : ((fvc.c)$$0).a.d, $$2, $$3, this.m.t);
                  this.m.t.cc.d();
               }
               ...
               cxo $$13 = $$0 == null ? cxo.j : this.z.b($$0.d).g();
   ...
   protected void aT_() {
      if (this.m.r.f()) {
         super.aT_();
         this.Y = new fon(this.p, this.C + 82, this.D + 6, 80, 9, xv.c("itemGroup.search"));
         this.Y.f(50);
         this.Y.d(false);
         this.Y.g(false);
         this.Y.g(16777215);
   ...
   private void a(cwd $$0) {
      ...
      if (V.k() == cwd.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.k.size(); $$10++) {
            ...
            cuy $$26 = new fvc.c($$9.k.get($$10), $$10, $$14, $$15);
            this.z.k.add($$26);
         }
   ...
   public List<xv> a(cxo $$0) {
      boolean $$1 = this.B != null && this.B instanceof fvc.a;
   ...
   protected void a(fnr $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(glu::C, V.c(), this.C, this.D, 0.0F, 0.0F, this.s, this.u, 256, 256);
      this.Y.a($$0, $$2, $$3, $$1);
      int $$5 = this.C + 175;
      int $$6 = this.D + 18;
      int $$7 = $$6 + 112;
      if (V.e()) {
         alz $$8 = this.K() ? G : H;
         $$0.a(glu::C, $$8, $$5, $$6 + (int)((float)($$7 - $$6 - 17) * this.W), 12, 15);
      }

      this.a($$0, V);
      if (V.k() == cwd.h.b) {
         fvn.a($$0, this.C + 73, this.D + 6, this.C + 105, this.D + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.m.t);
      }
   }
   ...
   protected boolean a(fnr $$0, cwd $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(fnr $$0, cwd $$1) {
      ...
      $$0.a(glu::C, $$7[bae.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static void a(fmf $$0, int $$1, boolean $$2, boolean $$3) {
      gkg $$4 = $$0.t;
      ke $$5 = $$4.dW().K_();
      fma $$6 = $$0.aD();
      gki $$7 = $$6.a($$1);
   ...
   public static class b extends ctb {
      ...
      public b(cpw $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new fvc.a(fvc.S, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }
