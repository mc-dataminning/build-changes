public abstract class fvc<T extends ctr> extends fva<T> implements fyn {
   private final fyi<?> G;
   private boolean H;

   public fvc(T $$0, fyi<?> $$1, cow $$2, wp $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fsz G();

   private void M() {
      fsz $$0 = this.G();
      this.c(new fpf($$0.a(), $$0.b(), 20, 18, fyi.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fsz $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
