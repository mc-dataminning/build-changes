public class gmn extends gnh<gcl, fvd<gcl>> {
   public gmn(gkr<gcl, fvd<gcl>> $$0) {
      super($$0);
   }
   ...
   public void a(ezw $$0, gdm $$1, int $$2, gcl $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      if ("deadmau5".equals($$3.af().getString()) && !$$3.ch()) {
         faa $$10 = $$1.getBuffer(gdu.c($$3.b().a()));
         int $$11 = gjw.c($$3, 0.0F);

         for (int $$12 = 0; $$12 < 2; $$12++) {
            float $$13 = ayx.i($$6, $$3.O, $$3.dF()) - ayx.i($$6, $$3.aZ, $$3.aY);
            float $$14 = ayx.i($$6, $$3.P, $$3.dH());
            $$0.a();
