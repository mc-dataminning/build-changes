...
public record gmn(Map<String, String> c, Set<String> d) {
   public static final gmn a = new gmn(Map.of(), Set.of());
   public static final Codec<gmn> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gmn::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gmn::e)
            )
            .apply($$0, gmn::new)
   );

   public static gmn.a a() {
      return new gmn.a();
   }
   ...
   public gmn a(gmn $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gmn($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gmn.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gmn.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gmn.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gmn a() {
         return new gmn(this.a.build(), this.b.build());
      }
   }
}
