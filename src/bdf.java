...
public class bdf extends azz {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdf::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdf::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdf::k);
         $$0 = this.a($$0, "minecraft:fox", bdf::j);
         $$0 = this.a($$0, "minecraft:item", bdf::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdf::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdf::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdf::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdf::e);
         return this.a($$0, "minecraft:piglin", bdf::d);
      });
   }
