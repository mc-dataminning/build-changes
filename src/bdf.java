...
public class bdf extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(bhu.D.typeName(), bji.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(bhu.B), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(bhu.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
