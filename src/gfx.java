public class gfx extends gbu<ful, fng<ful>> {
   public gfx(gat.a $$0, boolean $$1) {
      super($$0, new fng<>($$0.a($$1 ? fpb.aS : fpb.aO), $$1), 0.5F);
      this.a(new geu<>(this, new fmn($$0.a($$1 ? fpb.aT : fpb.aQ)), new fmn($$0.a($$1 ? fpb.aU : fpb.aR)), $$0.g()));
      this.a(new gfd<>(this, $$0.d()));
      this.a(new gea<>($$0, this));
      this.a(new gek(this));
      this.a(new gee(this));
      this.a(new gej<>(this, $$0.f(), $$0.d()));
      this.a(new gen<>(this, $$0.f()));
      this.a(new gfb<>(this, $$0.f()));
      this.a(new gfl<>(this, $$0.f()));
      this.a(new geb<>(this));
   }

   public void a(ful $$0, float $$1, float $$2, esa $$3, fvm $$4, int $$5) {
      this.b($$0);
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   public ens a(ful $$0, float $$1) {
   ...
   private static fmo.a a(ful $$0, blt $$1) {
      coz $$2 = $$0.b($$1);
      if ($$2.b()) {
         return fmo.a.a;
      } else {
   ...
   protected void a(ful $$0, esa $$1, float $$2) {
      float $$3 = 0.9375F;
      $$1.b(0.9375F, 0.9375F, 0.9375F);
   }

   protected void a(ful $$0, vq $$1, esa $$2, fvm $$3, int $$4, float $$5) {
      double $$6 = this.c.b($$0);
      $$2.a();
      if ($$6 < 100.0) {
         eow $$7 = $$0.gi();
   ...
   public void a(esa $$0, fvm $$1, int $$2, ful $$3) {
      this.a($$0, $$1, $$2, $$3, this.f.n, this.f.w);
   }

   public void b(esa $$0, fvm $$1, int $$2, ful $$3) {
      this.a($$0, $$1, $$2, $$3, this.f.o, this.f.b);
   }

   private void a(esa $$0, fvm $$1, int $$2, ful $$3, fpc $$4, fpc $$5) {
      fng<ful> $$6 = this.a();
      this.b($$3);
      $$6.c = 0.0F;
      $$6.t = false;
      ...
      $$4.e = 0.0F;
      aiy $$7 = $$3.b().a();
      $$4.a($$0, $$1.getBuffer(fvu.c($$7)), $$2, ggl.d);
      $$5.e = 0.0F;
      $$5.a($$0, $$1.getBuffer(fvu.i($$7)), $$2, ggl.d);
   }

   protected void a(ful $$0, esa $$1, float $$2, float $$3, float $$4, float $$5) {
      float $$6 = $$0.a($$4);
      float $$7 = $$0.g($$4);
      if ($$0.fw()) {
         super.a($$0, $$1, $$2, $$3, $$4, $$5);
