...
public abstract class gfx extends ezd {
   ...
   private final List<gfv> a = Lists.newArrayList();
   ...
   protected gfv a(gfv $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public ui l() {
      return uh.a(this.a.stream().map(gfv::a).collect(Collectors.toList()));
   }
}
