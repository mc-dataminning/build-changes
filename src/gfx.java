...
public class gfx implements aph<gfw> {
   public gfw b(JsonObject $$0) {
      Builder<gfv> $$1 = ImmutableList.builder();
      ...
      return new gfw($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gfv a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gfv(aud.g($$1, "frames[" + $$0 + "]"));
