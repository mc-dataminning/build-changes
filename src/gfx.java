...
public class gfx {
   ...
   public gfq a(Vector3f $$0, Vector3f $$1, gfs $$2, gqf $$3, ji $$4, gso $$5, @Nullable gft $$6, boolean $$7, akq $$8) {
      gfu $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ayn.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ayn.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ayn.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ayn.i($$11, $$9.a[3], $$13);
      ...
      return new gfq($$14, $$2.c, $$15, $$3, $$7);
   }

   public static gfu a(gfu $$0, ji $$1, j $$2, akq $$3) {
      Matrix4f $$4 = jc.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ayn.b($$23), ayn.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new gfu(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(gfu $$0, gqf $$1, ji $$2, float[] $$3, j $$4, @Nullable gft $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ji $$2, gfu $$3, float[] $$4, gqf $$5, j $$6, @Nullable gft $$7, boolean $$8) {
      gek.b $$9 = gek.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gqf $$3, gfu $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gft $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ji $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (ayn.a($$13, $$18) && ayn.a($$14, $$19) && ayn.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
