...
public class grm {
   ...
   public void a(djh $$0, gqm $$1, int $$2, float $$3, fex $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = fpo.N() ? 10 : 5;
         List<grm.a> $$7 = new ArrayList<>();
         List<grm.a> $$8 = new ArrayList<>();
   ...
   private void a(djh $$0, int $$1, float $$2, fex $$3, int $$4, List<grm.a> $$5, List<grm.a> $$6) {
      int $$7 = azm.a($$3.d);
      int $$8 = azm.a($$3.e);
      int $$9 = azm.a($$3.f);
      iv.a $$10 = new iv.a();
   ...
   private void a(gqm $$0, fex $$1, int $$2, float $$3, List<grm.a> $$4, List<grm.a> $$5) {
      if (!$$4.isEmpty()) {
         gqx $$6 = gqx.f(c, fpo.O());
   ...
   private grm.a a(azv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      int $$8 = $$1 & 131071;
      int $$9 = $$2 * $$2 * 3121 + $$2 * 45238971 + $$5 * $$5 * 418711 + $$5 * 13761 & 0xFF;
      float $$10 = 3.0F + $$0.i();
      float $$11 = -((float)($$8 + $$9) + $$7) / 32.0F * $$10;
      float $$12 = $$11 % 32.0F;
      return new grm.a($$2, $$5, $$3, $$4, 0.0F, $$12, $$6);
   }

   private grm.a b(azv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      float $$8 = (float)$$1 + $$7;
      float $$9 = (float)($$0.j() + (double)($$8 * 0.01F * (float)$$0.k()));
      float $$10 = (float)($$0.j() + (double)($$8 * (float)$$0.k() * 0.001F));
      float $$11 = -((float)($$1 & 511) + $$7) / 512.0F;
      int $$12 = gqj.a((gqj.a($$6) * 3 + 15) / 4, (gqj.b($$6) * 3 + 15) / 4);
      return new grm.a($$2, $$5, $$3, $$4, $$9, $$11 + $$10, $$12);
   }

   private void a(fkc $$0, List<grm.a> $$1, fex $$2, float $$3, int $$4, float $$5) {
      for (grm.a $$6 : $$1) {
   ...
   public void a(gkl $$0, fow $$1, int $$2, ari $$3) {
      float $$4 = $$0.d(1.0F) / (fpo.N() ? 1.0F : 2.0F);
      if (!($$4 <= 0.0F)) {
         ...
         for (int $$9 = 0; $$9 < $$8; $$9++) {
            int $$10 = $$5.a(21) - 10;
            int $$11 = $$5.a(21) - 10;
            iv $$12 = $$0.a(egn.a.e, $$6.b($$10, 0, $$11));
            if ($$12.v() > $$0.G_() && $$12.v() <= $$6.v() + 10 && $$12.v() >= $$6.v() - 10 && this.a($$0, $$12) == dkk.c.b) {
               $$7 = $$12.e();
               if ($$3 == ari.c) {
                  break;
               }
               ...
               lw $$21 = !$$16.a(axh.b) && !$$15.a(dmo.lp) && !dnc.h($$15) ? ly.ag : ly.ah;
         ...
         if ($$7 != null && $$5.a(3) < this.g++) {
            this.g = 0;
            if ($$7.v() > $$6.v() + 1 && $$0.a(egn.a.e, $$6).v() > azm.d((float)$$6.v())) {
