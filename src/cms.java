...
public class cms {
   ...
   private int g = azc.b(azk.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kh.a.fieldOf("uuid").forGetter(Pair::getFirst), ayl.k.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<btj> j;
   @VisibleForTesting
   protected final ArrayList<btj> c;
   private final cms.a k;
   @VisibleForTesting
   protected final Object2IntMap<btj> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cms> a(Predicate<btj> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cms::b)).apply($$1, $$1x -> new cms($$0, $$1x))
      );
   }

   public cms(Predicate<btj> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cms.a(this);
   ...
   public void a(arg $$0, Predicate<btj> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<btj>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<btj> $$6 = (Entry<btj>)$$5.next();
         int $$7 = $$6.getIntValue();
         btj $$8 = (btj)$$6.getKey();
         btj.c $$9 = $$8.dO();
   ...
   public int b(@Nullable btj $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<buf> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof buf).map($$0 -> (buf)$$0);
   }

   @VisibleForTesting
   protected static record a(cms a) implements Comparator<btj> {
      public int a(btj $$0, btj $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cnp;
               boolean $$7 = $$1 instanceof cnp;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
