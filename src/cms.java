...
public class cms extends cmr implements cok {
   private static final Logger a = LogUtils.getLogger();
   private static final ajy<Boolean> b = akc.a(cms.class, aka.k);
   private static final ajy<coj> c = akc.a(cms.class, aka.u);
   ...
   public cms(bus<? extends cms> $$0, dgi $$1) {
      super($$0, $$1);
      mb.x.a(this.ae).ifPresent($$0x -> this.a(this.gC().a((col)$$0x.a())));
   }
   ...
   public void b(tq $$0) {
      super.b($$0);
      coj.c.encodeStart(ue.a, this.gC()).resultOrPartial(a::error).ifPresent($$1 -> $$0.a("VillagerData", $$1));
      if (this.ci != null) {
         $$0.a("Offers", (un)dfg.a.encodeStart(this.dX().a(ue.a), this.ci).getOrThrow());
      }
   ...
   public void a(tq $$0) {
      ...
      if ($$0.e("Offers")) {
         dfg.a.parse(this.dX().a(ue.a), $$0.c("Offers")).resultOrPartial(af.a("Failed to load offers: ", a::warn)).ifPresent($$0x -> this.ci = $$0x);
      }
   ...
   private void a(@Nullable UUID $$0, int $$1) {
      ...
      this.au().a(b, true);
      this.e(bts.r);
      this.a(new btq(bts.e, $$1, Math.min(this.dV().am().a() - 1, 0)));
   ...
   private void g(ard $$0) {
      this.a(bus.bC, bug.a(this, false, false), $$1 -> {
         for (but $$2 : this.a($$0, $$0xx -> !ddb.a($$0xx, dda.E))) {
            bvz $$3 = $$1.a_($$2.b() + 300);
            $$3.a(this.a($$2));
         }
