...
public class gcx {
   ...
   public void a(boolean $$0, fdk $$1, gfo $$2, List<gfk.b> $$3) {
      euk $$4 = $$1.b();
   ...
   private void a(boolean $$0, fdk $$1, euk $$2) {
      this.e = false;
      this.f = ac.g().submit(() -> {
   ...
   private void a(boolean $$0, gfo $$1, List<gfk.b> $$2, euk $$3) {
      gcx.b $$4 = this.h.get();
      this.a($$4);
      if (!$$4.b.b.isEmpty()) {
   ...
   private void a(gcx.a $$0, dae $$1) {
      $$0.a.add(dae.c($$1.e - 1, $$1.f));
      $$0.a.add(dae.c($$1.e, $$1.f - 1));
      $$0.a.add(dae.c($$1.e + 1, $$1.f));
      $$0.a.add(dae.c($$1.e, $$1.f + 1));
   }

   private void a(fdk $$0, Queue<gcx.d> $$1) {
      int $$2 = 16;
      euk $$3 = $$0.b();
      io $$4 = $$0.c();
      gfk.b $$5 = this.g.a($$4);
      if ($$5 == null) {
         ...
         int $$9 = ayd.a($$3.c / 16.0) * 16;
         int $$10 = ayd.a($$3.e / 16.0) * 16;
         int $$11 = this.g.b();
   ...
   private void a(gcx.c $$0, euk $$1, Queue<gcx.d> $$2, boolean $$3, Consumer<gfk.b> $$4) {
      int $$5 = 16;
      io $$6 = new io(ayd.a($$1.c / 16.0) * 16, ayd.a($$1.d / 16.0) * 16, ayd.a($$1.e / 16.0) * 16);
      io $$7 = $$6.b(8, 8, 8);
         ...
         for (it $$11 : b) {
            ...
            if ($$12 != null && (!$$3 || !$$8.a($$11.g()))) {
               ...
               if ($$3 && $$10) {
                  ...
                  euk $$18 = new euk((double)$$17.u(), (double)$$17.v(), (double)$$17.w());
                  euk $$19 = $$1.d($$18).d().a(d);
                  boolean $$20 = true;
               ...
               if ($$23 != null) {
                  ...
                  if ($$12.a()) {
                     ...
                     $$0.a.a($$12, $$24);
                     ((List)$$0.c.computeIfAbsent(dae.a($$12.f()), $$0x -> new ArrayList())).add($$12);
                  }
               }
            }
         }
   ...
   private gfk.b a(io $$0, gfk.b $$1, it $$2) {
      ...
      if (!this.a($$0, $$3)) {
         ...
         return ayd.a($$0.v() - $$3.v()) > this.g.b() * 16 ? null : this.g.a($$3);
      }
   }
