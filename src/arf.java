...
public abstract class arf implements aro {
   ...
   public <T> T a(asb<T> $$0) throws IOException {
      asu<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asb<T> $$0, InputStream $$1) {
      JsonObject $$3;
