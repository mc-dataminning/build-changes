...
public abstract class arf {
   ...
   static final int c = aqv.a(arg.d);
   final Long2ObjectMap<ObjectSet<art>> d = new Long2ObjectOpenHashMap();
   private final arj e;
   private final arv f;
   final dku g;
   private final arf.a h = new arf.a(8);
   private final arf.b i = new arf.b(32);
   protected final Set<aqu> b = new ReferenceOpenHashSet();
   final arx j;
   final LongSet k = new LongOpenHashSet();
   final Executor l;
   private int m = 10;

   protected arf(dku $$0, Executor $$1, Executor $$2) {
      this.g = $$0;
      this.e = new arj(this, $$0);
      this.f = new arv($$0);
      btm<Runnable> $$3 = btm.a("player ticket throttler", $$2);
      this.j = new arx($$3, $$1, 4);
      this.l = $$2;
   }
   ...
   public boolean a(aqw $$0) {
      ...
      if (!this.b.isEmpty()) {
         ...
         if (!this.k.isEmpty()) {
            ...
            while ($$5.hasNext()) {
               long $$6 = $$5.nextLong();
               if (this.g.a($$6).stream().anyMatch($$0x -> $$0x.a() == arz.d)) {
                  aqu $$7 = $$0.a($$6);
                  if ($$7 == null) {
                     throw new IllegalStateException();
                  }

                  CompletableFuture<aqx<edl>> $$8 = $$7.b();
   ...
   public void a(jy $$0, art $$1) {
      djc $$2 = $$0.r();
      long $$3 = $$2.a();
      ((ObjectSet)this.d.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
      this.h.b($$3, 0, true);
      this.i.b($$3, 0, true);
      this.g.a(new ary(arz.e, this.e()), $$2);
   }

   public void b(jy $$0, art $$1) {
      djc $$2 = $$0.r();
      long $$3 = $$2.a();
      ObjectSet<art> $$4 = (ObjectSet<art>)this.d.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
         this.d.remove($$3);
         this.h.b($$3, Integer.MAX_VALUE, false);
         this.i.b($$3, Integer.MAX_VALUE, false);
         this.g.b(new ary(arz.e, this.e()), $$2);
      }
   }

   private int e() {
      return Math.max(0, aqv.a(arg.d) - this.m);
   }

   public boolean c(long $$0) {
      return aqv.d(this.f.c($$0));
   }

   public boolean d(long $$0) {
      return aqv.e(this.f.c($$0));
   }
   ...
   class a extends ara {
      ...
      private boolean f(long $$0) {
         ObjectSet<art> $$1 = (ObjectSet<art>)arf.this.d.get($$0);
   ...
   class b extends arf.a {
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            ary $$4 = new ary(arz.d, arf.c);
            if ($$3) {
               arf.this.j.a(() -> arf.this.l.execute(() -> {
                     if (this.c(this.c($$0))) {
                        arf.this.g.a($$0, $$4);
                        arf.this.k.add($$0);
                     } else {
               ...
               arf.this.j.a($$0, () -> arf.this.l.execute(() -> arf.this.g.b($$0, $$4)), true);
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  arf.this.j.onLevelChange(new djc($$1), () -> this.h.get($$1), $$3, $$1x -> {
