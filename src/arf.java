...
public class arf {
   ...
   public static final Codec<arf.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aew.b($$0.substring(1)).map($$0x -> new arf.f($$0x, true)) : aew.b($$0).map($$0x -> new arf.f($$0x, false)), arf.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !aew.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> arf.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new arf.b<>($$0, $$1);
   }

   public static <K, V> arf.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new arf.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof arf.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(aew a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
