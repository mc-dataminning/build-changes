...
public class arf implements AutoCloseable {
   ...
   private arf(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static arf.a a(Path $$0) {
         return new arf.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
