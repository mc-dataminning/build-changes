...
public class yv implements xl {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = azd.b.validate(yv::b);
   private static final Codec<Object> e = Codec.either(d, xm.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xk $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yv> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xl.a<yv> c = new xl.a<>(b, "translatable");
   private static final xp f = xp.e("%");
   private static final xp g = xp.e("null");
   ...
   @Nullable
   private uh k;
   private List<xp> l = ImmutableList.of();
   ...
   private static yv a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yv($$0, $$1.orElse(null), a($$2));
   }

   public yv(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xp> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yw var4) {
            this.l = ImmutableList.of(xp.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xp> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yw(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xp a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xk) {
            ...
            return $$1 == null ? g : xp.e($$1.toString());
         }
      } else {
         throw new yw(this, $$0);
      }
   ...
   public xy a(@Nullable ew $$0, @Nullable bvb $$1, int $$2) throws CommandSyntaxException {
      ...
      return xy.a(new yv(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yv $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
