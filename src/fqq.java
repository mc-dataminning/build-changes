...
public class fqq implements fqu.a {
   ...
   private final eqm J;
   private final Map<gu, fqq.a> K = Maps.newHashMap();
   private final Map<UUID, vn.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bii $$1 = this.J.u.a($$0.getValue().b());
         return $$1 == null || $$1.dF();
      });
   }

   private void b(elg $$0, fnl $$1, double $$2, double $$3, double $$4) {
      gu $$5 = gu.a($$2, $$3, $$4);
   ...
   private void a(elg $$0, fnl $$1, fqq.a $$2) {
      int $$3 = 0;
   ...
   private void a(elg $$0, fnl $$1, vn.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         frc.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(elg $$0, fnl $$1, vn.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(elg $$0, fnl $$1, String $$2, fqq.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(fqq.a $$0) {
      return this.b($$0.a).stream().map(aau::a).collect(Collectors.toSet());
   }

   private Set<String> c(fqq.a $$0) {
      return this.c($$0.a).stream().map(aau::a).collect(Collectors.toSet());
   }

   private boolean b(vn.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(vn.a $$0) {
      cbn $$1 = this.J.v;
      gu $$2 = gu.a($$1.dp(), $$0.h().b(), $$1.dv());
      gu $$3 = gu.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(gu $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(vn.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(gu $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(vn.a::a).collect(Collectors.toSet());
   }

   private Map<gu, List<String>> c() {
      Map<gu, List<String>> $$0 = Maps.newHashMap();

      for (vn.a $$1 : this.L.values()) {
   ...
   private void d() {
      fqu.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
