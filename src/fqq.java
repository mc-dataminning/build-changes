...
public class fqq {
   private static final frc a = frc.s(new agi("textures/map/map_background.png"));
   private static final frc b = frc.s(new agi("textures/map/map_background_checkerboard.png"));
   ...
   private final etd au;
   private clj av = clj.b;
   private clj aw = clj.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fvv aB;
   private final fwv aC;

   public fqq(etd $$0, fvv $$1, fwv $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(blg $$0, clj $$1, clg $$2, boolean $$3, enw $$4, fqu $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dN(), $$6, gbl.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = atm.a($$1, 0.0F, 1.0F);
      return -atm.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(enw $$0, fqu $$1, int $$2, bla $$3) {
      gax $$4 = (gax)this.aB.<fpt>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bla.b ? 1.0F : -1.0F;
   ...
   private void a(enw $$0, fqu $$1, int $$2, float $$3, bla $$4, float $$5, clj $$6) {
      float $$7 = $$4 == bla.b ? 1.0F : -1.0F;
      ...
      float $$8 = atm.c($$5);
      float $$9 = atm.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * atm.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * atm.a($$5 * (float) Math.PI);
   ...
   private void a(enw $$0, fqu $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = atm.c($$5);
      float $$7 = -0.2F * atm.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * atm.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = atm.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(enw $$0, fqu $$1, int $$2, clj $$3) {
      ...
      Integer $$4 = clq.d($$3);
      eec $$5 = clq.a($$4, this.au.r);
      eoa $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(enw $$0, fqu $$1, int $$2, float $$3, float $$4, bla $$5) {
      boolean $$6 = $$5 != bla.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = atm.c($$4);
      float $$9 = -0.3F * atm.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * atm.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * atm.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = atm.a($$4 * $$4 * (float) Math.PI);
      float $$13 = atm.a($$8 * (float) Math.PI);
   ...
   private void a(enw $$0, float $$1, bla $$2, clj $$3) {
      float $$4 = (float)this.au.s.fr() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = atm.e(atm.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(enw $$0, float $$1, bla $$2, clj $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * atm.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bla.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(enw $$0, bla $$1, float $$2) {
      int $$3 = $$1 == bla.b ? 1 : -1;
      float $$4 = atm.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = atm.a(atm.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(enw $$0, bla $$1, float $$2) {
      int $$3 = $$1 == bla.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, enw $$1, fqu.a $$2, fpw $$3, int $$4) {
      float $$5 = $$3.x($$0);
      biw $$6 = (biw)MoreObjects.firstNonNull($$3.aG, biw.a);
      float $$7 = atm.i($$0, $$3.O, $$3.dF());
      fqq.a $$8 = a($$3);
      float $$9 = atm.i($$0, $$3.cu, $$3.cs);
      float $$10 = atm.i($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == biw.a ? $$5 : 0.0F;
         float $$12 = 1.0F - atm.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, biw.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == biw.b ? $$5 : 0.0F;
         float $$14 = 1.0F - atm.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, biw.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fqq.a a(fpw $$0) {
      clj $$1 = $$0.eU();
      clj $$2 = $$0.eV();
      boolean $$3 = $$1.a(clm.or) || $$2.a(clm.or);
      boolean $$4 = $$1.a(clm.vL) || $$2.a(clm.vL);
      if (!$$3 && !$$4) {
         return fqq.a.a;
      } else if ($$0.fo()) {
         return b($$0);
      } else {
         return a($$1) ? fqq.a.b : fqq.a.a;
      }
   }

   private static fqq.a b(fpw $$0) {
      clj $$1 = $$0.fq();
      biw $$2 = $$0.fp();
      if (!$$1.a(clm.or) && !$$1.a(clm.vL)) {
         return $$2 == biw.a && a($$0.eV()) ? fqq.a.b : fqq.a.a;
      } else {
         return fqq.a.a($$2);
      }
   }
   ...
   private static boolean a(clj $$0) {
      return $$0.a(clm.vL) && cjr.d($$0);
   }

   private void a(fpt $$0, float $$1, float $$2, biw $$3, float $$4, clj $$5, float $$6, enw $$7, fqu $$8, int $$9) {
      if (!$$0.gr()) {
         boolean $$10 = $$3 == biw.a;
         bla $$11 = $$10 ? $$0.fn() : $$0.fn().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fo() && $$0.fr() > 0 && $$0.fp() == $$3) {
               ...
               float $$16 = $$15 / (float)cjr.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = atm.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * atm.a(atm.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * atm.a(atm.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * atm.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? clg.e : clg.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bla.b;
            if ($$0.fo() && $$0.fr() > 0 && $$0.fp() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * atm.a(atm.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * atm.a(atm.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * atm.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? clg.e : clg.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.A()) {
         this.ax = atm.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = atm.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + atm.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + atm.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
