...
public class amf extends amb {
   static final Logger c = LogUtils.getLogger();
   private final amf.b d;
   private final String e;

   amf(String $$0, amf.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(ami $$0, aew $$1) {
   ...
   @Nullable
   private anl<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : anl.create($$1, $$2);
      }
   }
   ...
   public static class a implements anb.c {
      ...
      @Override
      public amh a(String $$0) {
         amf.b $$1 = new amf.b(this.a);
         return new amf($$0, $$1, this.b, "");
      }

      @Override
      public amh a(String $$0, anb.a $$1) {
         amf.b $$2 = new amf.b(this.a);
         amh $$3 = new amf($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<amh> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new amf($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  amf.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
