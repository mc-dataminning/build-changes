...
public class amf {
   ...
   private static int a(ex $$0, Collection<? extends auw<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> wo.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> wo.a("commands.banlist.list", $$1.size()), false);

         for (auw<?> $$2 : $$1) {
            $$0.a(() -> wo.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
