...
class amf implements Path {
   private static final BasicFileAttributes a = new amd() {
      @Override
   ...
   private static final BasicFileAttributes b = new amd() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amf> c = Comparator.comparing(amf::n);
   ...
   public amf(amh $$0, String $$1, @Nullable amf $$2, ami $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amf a(@Nullable amf $$0, String $$1) {
      return new amf(this.e, $$1, $$0, ami.b);
   }
   ...
   amf a(String $$0) {
      if (a(this.i)) {
         return new amf(this.e, $$0, this, this.i);
      } else if (this.i instanceof ami.a $$1) {
         amf $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amf(this.e, $$0, this, ami.a);
      } else if (this.i instanceof ami.b) {
         return new amf(this.e, $$0, this, ami.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(ami $$0) {
      return $$0 == ami.a || $$0 == ami.b;
   }
   ...
   private amf c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amf $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ami.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ami.a i() {
      return this.i instanceof ami.a $$0 ? $$0 : null;
   }
