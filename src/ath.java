...
public class ath extends FileSystem {
   private static final Set<String> b = Set.of("basic");
   public static final String a = "/";
   private static final Splitter c = Splitter.on('/');
   private final FileStore d;
   private final FileSystemProvider e = new atg();
   private final atf f;

   ath(String $$0, ath.b $$1) {
      this.d = new ate($$0);
      this.f = a($$1, this, "", null);
   }

   private static atf a(ath.b $$0, ath $$1, String $$2, @Nullable atf $$3) {
      Object2ObjectOpenHashMap<String, atf> $$4 = new Object2ObjectOpenHashMap();
      atf $$5 = new atf($$1, $$2, $$3, new ati.a($$4));
      $$0.b.forEach(($$3x, $$4x) -> $$4.put($$3x, new atf($$1, $$3x, $$5, new ati.b($$4x))));
   ...
   public static ath.a c() {
      return new ath.a();
   }

   public static class a {
      private final ath.b a = new ath.b();

      public ath.a a(List<String> $$0, String $$1, Path $$2) {
         ath.b $$3 = this.a;

         for (String $$4 : $$0) {
            $$3 = $$3.a.computeIfAbsent($$4, $$0x -> new ath.b());
         }
      ...
      public ath.a a(List<String> $$0, Path $$1) {
         if ($$0.isEmpty()) {
   ...
   static record b(Map<String, ath.b> a, Map<String, Path> b) {
