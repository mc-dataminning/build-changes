...
public class ath extends axo {
   public ath(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", aym.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(aym.s, "minecraft:piston");
