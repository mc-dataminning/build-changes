...
public class ath {
   ...
   private static List<ath.b> a(final Path $$0) throws IOException {
      try {
         final List<ath.b> $$1 = new ArrayList<>();
   ...
   private static List<ath.a> a(List<ath.b> $$0) {
      List<ath.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (ath.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new ath.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<ath.a> a = Comparator.comparing(ath.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<ath.b> a = Comparator.comparing(ath.b::b).reversed();
