...
public class ath extends aqh {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         ...
         $$0 = this.a($$0, "minecraft:bee", ath::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", ath::k);
         $$0 = this.a($$0, "minecraft:fox", ath::j);
         $$0 = this.a($$0, "minecraft:item", ath::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", ath::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", ath::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", ath::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", ath::e);
         return this.a($$0, "minecraft:piglin", ath::d);
      });
   }
