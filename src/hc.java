...
public enum hc implements ask {
   ...
   public static final ask.a<hc> g = ask.a(hc::values);
   public static final Codec<hc> h = arb.a(g, hc::a);
   private final int i;
   private final int j;
   private final int k;
   ...
   public static Collection<hc> a(arx $$0) {
   ...
   public static hc a(bil $$0, hc.a $$1) {
      return switch ($$1) {
   ...
   public static hc a(int $$0) {
      return q[ars.a($$0 % q.length)];
   }

   public static hc b(int $$0) {
      return r[ars.a($$0 % r.length)];
   }
   ...
   public static enum a implements ask, Predicate<hc> {
      a("x") {
         @Override
      ...
      public static final ask.a<hc.a> e = ask.a(hc.a::values);
