...
public class gpp {
   ...
   public static class a extends Thread {
      private final gpp.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gpp.b $$0) throws IOException {
         super("LanServerDetector #" + gpp.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gpp.b));
   ...
   public static class b {
      private final List<gpo> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gpo> a() {
         if (this.b) {
            List<gpo> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
