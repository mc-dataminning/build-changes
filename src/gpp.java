...
public class gpp implements gpo {
   public static final int a = 0;
   private final gpp.b c = new gpp.b();
   private final gpp.b d = new gpp.b();
   public final gpp.a b;
   ...
   private float a(cuq $$0, fzd $$1, int $$2, bsr $$3) {
   ...
   @Nullable
   private fzd a(bsr $$0, @Nullable fzd $$1) {
      return $$1 == null && $$0.dP() instanceof fzd ? (fzd)$$0.dP() : $$1;
   }
   ...
   private double a(bsr $$0) {
      return ayo.c((double)($$0.dG() / 360.0F), 1.0);
   }
   ...
   public interface a {
      @Nullable
      jl getPos(fzd var1, cuq var2, bsr var3);
   }
