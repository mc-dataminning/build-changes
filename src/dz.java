...
public class dz implements ArgumentType<dz.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ui.c("argument.angle.incomplete"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(ui.c("argument.angle.invalid"));
   ...
   public static final class a {
      ...
      public float a(du $$0) {
         return asy.g(this.b ? this.a + $$0.l().j : this.a);
      }
   }
}
