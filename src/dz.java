...
public interface dz {
   ...
   CompletableFuture<Suggestions> a(aix<? extends iv<?>> var1, dz.a var2, SuggestionsBuilder var3, CommandContext<?> var4);

   boolean c(int var1);

   static <T> void a(Iterable<T> $$0, String $$1, Function<T, aiy> $$2, Consumer<T> $$3) {
   ...
   static <T> void a(Iterable<T> $$0, String $$1, String $$2, Function<T, aiy> $$3, Consumer<T> $$4) {
      if ($$1.isEmpty()) {
         $$0.forEach($$4);
      } else {
   ...
   static CompletableFuture<Suggestions> a(Iterable<aiy> $$0, SuggestionsBuilder $$1, String $$2) {
      String $$3 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$3, $$2, $$0x -> $$0x, $$2x -> $$1.suggest($$2 + $$2x));
      return $$1.buildFuture();
   }

   static CompletableFuture<Suggestions> a(Stream<aiy> $$0, SuggestionsBuilder $$1, String $$2) {
      return a($$0::iterator, $$1, $$2);
   }

   static CompletableFuture<Suggestions> a(Iterable<aiy> $$0, SuggestionsBuilder $$1) {
      String $$2 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$2, $$0x -> $$0x, $$1x -> $$1.suggest($$1x.toString()));
      return $$1.buildFuture();
   }

   static <T> CompletableFuture<Suggestions> a(Iterable<T> $$0, SuggestionsBuilder $$1, Function<T, aiy> $$2, Function<T, Message> $$3) {
      String $$4 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$4, $$2, $$3x -> $$1.suggest($$2.apply((T)$$3x).toString(), $$3.apply((T)$$3x)));
      return $$1.buildFuture();
   }

   static CompletableFuture<Suggestions> a(Stream<aiy> $$0, SuggestionsBuilder $$1) {
      return a($$0::iterator, $$1);
   }

   static <T> CompletableFuture<Suggestions> a(Stream<T> $$0, SuggestionsBuilder $$1, Function<T, aiy> $$2, Function<T, Message> $$3) {
