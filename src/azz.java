...
public class azz {
   ...
   public azz.d a() throws IOException {
      azz.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new azz.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private azz.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         azz.c $$3 = azz.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new azz.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new azz.a($$0, $$3);
            }
         }
   ...
   public azz.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<azz.c> $$2 = this.a().c();
      ...
      azz.e $$4 = new azz.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, azz.c b) implements azz.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static azz.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new azz.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<azz.b> {
      private final List<azz.b> a;

      d(List<azz.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public azz.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            azz.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  azz.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public azz.d a() {
         ListIterator<azz.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               azz.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<azz.b> iterator() {
         return this.a.iterator();
      }

      public Stream<azz.b> b() {
         return this.a.stream();
      }

      public Set<azz.c> c() {
         return this.a.stream().map(azz.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, azz.c b) implements azz.b {
