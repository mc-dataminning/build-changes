...
public class azz extends bcn {
   public azz(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bdn.y, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bdn.A.typeName(), bew.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bdn.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bdn.A.typeName(), "minecraft:saddle"));
