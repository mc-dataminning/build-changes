...
public class azz extends DataFix {
   ...
   private Typed<?> a(Typed<?> $$0, Map<String, String> $$1) {
      return $$0.update(DSL.remainderFinder(), $$1x -> {
         for (Entry<String, String> $$2 : $$1.entrySet()) {
            $$1x = ayu.a($$1x, $$2.getKey(), $$2.getValue(), ayu::a);
         }
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      return $$0.update("frames", $$0x -> $$0x.createList($$0x.asStream().map($$0xx -> {
            $$0xx = ayu.a($$0xx, "Pos", "pos", ayu::a);
            $$0xx = ayu.a($$0xx, "Rotation", "rotation");
            return ayu.a($$0xx, "EntityId", "entity_id");
         }))).update("banners", $$0x -> $$0x.createList($$0x.asStream().map($$0xx -> {
            $$0xx = ayu.a($$0xx, "Pos", "pos");
            $$0xx = ayu.a($$0xx, "Color", "color");
            return ayu.a($$0xx, "Name", "name");
         })));
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      $$0.add(
         this.fixTypeEverywhereTyped(
            ...
            this.getInputSchema().getType(bff.j),
      ...
      $$0.add(
         this.fixTypeEverywhereTyped(
            "BlockPos format for compass target", $$1, bdk.a($$1, "minecraft:compass"::equals, $$0x -> $$0x.update("LodestonePos", ayu::a))
         )
      );
   ...
   private void a(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(bff.z, "minecraft:bee", Map.of("HivePos", "hive_pos", "FlowerPos", "flower_pos")));
      $$0.add(this.a(bff.z, "minecraft:end_crystal", Map.of("BeamTarget", "beam_target")));
      $$0.add(this.a(bff.z, "minecraft:wandering_trader", Map.of("WanderTarget", "wander_target")));

      for (String $$1 : a) {
         $$0.add(this.a(bff.z, $$1, Map.of("PatrolTarget", "patrol_target")));
      }

      $$0.add(
         this.fixTypeEverywhereTyped(
            "BlockPos format in Leash for mobs",
            this.getInputSchema().getType(bff.z),
            $$0x -> $$0x.update(DSL.remainderFinder(), $$0xx -> ayu.a($$0xx, "Leash", "leash", ayu::a))
         )
      );
   }

   private void b(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(bff.s, "minecraft:beehive", Map.of("FlowerPos", "flower_pos")));
      $$0.add(this.a(bff.s, "minecraft:end_gateway", Map.of("ExitPortal", "exit_portal")));
   }
