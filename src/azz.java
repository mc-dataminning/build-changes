...
public class azz implements axz {
   ...
   public azz(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new azz.a("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   @Override
   public axz d() {
      return new azz(this.c, this.e, (long[])this.b.clone());
   }
