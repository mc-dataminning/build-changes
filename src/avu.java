...
public class avu extends avz {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<avv<?>> e = Sets.newHashSet();

   public avu(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cmv $$0, avv<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<avv<?>> d() {
      Set<avv<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<avv<T>> a(avx<T> $$0, String $$1) {
      return Optional.ofNullable(akq.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<avx<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avv<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avv<?>>)$$3.next();
         avv<?> $$2 = (avv<?>)$$1.getKey();
      ...
      for (Entry<avx<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> akq b(avv<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aqu $$0) {
      Object2IntMap<avv<?>> $$1 = new Object2IntOpenHashMap();
