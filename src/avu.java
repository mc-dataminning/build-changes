...
public class avu {
   ...
   public static final Codec<Object> b = a(awf.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(awc.e($$0));
   ...
   public static <F, S> avu.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new avu.b<>($$0, $$1);
   }

   public static <K, V> avu.f<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new avu.f<>($$0, $$1);
   }
   ...
   static final class e<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof avu.e<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record g(ajc a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
