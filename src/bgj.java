...
public class bgj extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(bix.D.typeName(), bkl.a()));
      Type<Pair<String, String>> $$1 = DSL.named(bix.D.typeName(), bkl.a());
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(bix.D.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
