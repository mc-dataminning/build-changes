...
public class bgj {
   ...
   private JsonElement a(List<Pair<djo, bgt<bgl>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bgt)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<djo, bgt<bgl>> $$3 : $$0) {
         bgt<bgl> $$4 = (bgt<bgl>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((djo)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bgr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bfz.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bgh $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bgp $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bgp.b $$3 = (bgp.b)$$1x.getFirst();
         bgp.a $$4 = (bgp.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bgm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bgm>, ToDoubleFunction<bgm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bgm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bgm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bgm::c));
      return $$1;
   }
}
