...
public abstract class bgj extends DataFix {
   private final String a;

   public bgj(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bfy.z);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bfy.z);
      Type<Pair<String, String>> $$2 = DSL.named(bfy.x.typeName(), bhj.a());
      if (!Objects.equals(this.getOutputSchema().getType(bfy.x), $$2)) {
