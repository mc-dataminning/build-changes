...
public abstract class ftr extends fpu implements fpc {
   ...
   private static final xk b = xk.c("narrator.screen.usage");
   protected static final gkr e = new gkr(alp.b("textures/gui/title/background/panorama"));
   protected static final glj f = new glj(e);
   public static final alp g = alp.b("textures/gui/menu_background.png");
   public static final alp h = alp.b("textures/gui/header_separator.png");
   public static final alp i = alp.b("textures/gui/footer_separator.png");
   private static final alp c = alp.b("textures/gui/inworld_menu_background.png");
   public static final alp j = alp.b("textures/gui/inworld_header_separator.png");
   public static final alp k = alp.b("textures/gui/inworld_footer_separator.png");
   protected final xk l;
   ...
   public static List<xk> a(flz $$0, cxg $$1) {
      return $$1.a(cxc.b.a($$0.s, $$0.t), $$0.t, $$0.n.m ? cyy.a.b : cyy.a.a);
   }

   protected void a_(String $$0, boolean $$1) {
   }

   public boolean a(@Nullable yh $$0) {
      if ($$0 == null) {
         return false;
      } else {
         xi $$1 = $$0.i();
   ...
   public static void a(fnl $$0, alp $$1, int $$2, int $$3, float $$4, float $$5, int $$6, int $$7) {
      int $$8 = 32;
      $$0.a(glq::H, $$1, $$2, $$3, $$4, $$5, $$6, $$7, 32, 32);
   }
   ...
   protected void b(frw $$0) {
      ...
      if ($$2 != null) {
         ...
         if ($$1.size() > 1) {
            $$0.a(frv.b, xk.a("narrator.position.screen", $$2.b + 1, $$1.size()));
            if ($$2.c == fru.a.c) {
               $$0.a(frv.d, this.z());
            }
         }
   ...
   protected xk z() {
      return xk.c("narration.component_list.usage");
   }
   ...
   public void b(List<azg> $$0) {
      this.a($$0, fwd.a, true);
   }

   public void a(List<azg> $$0, fwc $$1, boolean $$2) {
      if (this.F == null || $$2) {
   ...
   static record a(List<azg> a, fwc b) {
   }
