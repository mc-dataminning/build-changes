public abstract class ftr extends ftw {
   public static final int b = 6;
   private double a;
   private static final alr c = alr.b("widget/scroller");
   private static final alr d = alr.b("widget/scroller_background");
   private boolean e;

   public ftr(int $$0, int $$1, int $$2, int $$3, xg $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public void a(double $$0) {
      this.a = azz.a($$0, 0.0, (double)this.i());
   }
   ...
   protected int k() {
      return azz.a((int)((float)(this.h * this.h) / (float)this.n()), 32, this.h - 8);
   }
