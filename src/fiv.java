...
public class fiv extends fik implements fjp {
   private static final fjz d = new fjz(akr.b("widget/text_field"), akr.b("widget/text_field_highlighted"));
   ...
   public fiv(fhx $$0, int $$1, int $$2, wz $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fiv(fhx $$0, int $$1, int $$2, int $$3, int $$4, wz $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fiv(fhx $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fiv $$5, wz $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fod.s());
   }
   ...
   public void b(fhz $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gfh.F(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
