...
public class fiv implements fis {
   ...
   private FT_Face c;
   final float d;
   private final fwn<fiv.b> e = new fwn<>(fiv.b[]::new, fiv.b[][]::new);

   public fiv(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$12 = fxa.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fir a(int $$0, FT_Face $$1, int $$2) {
      int $$3 = FreeType.FT_Load_Glyph($$1, $$2, 4194312);
      if ($$3 != 0) {
         fxa.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
      ...
      if ($$4 == null) {
         ...
         float $$5 = fxa.a($$4.advance());
         FT_Bitmap $$6 = $$4.bitmap();
         int $$7 = $$4.bitmap_left();
         int $$8 = $$4.bitmap_top();
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (fir)($$9 > 0 && $$10 > 0 ? new fiv.a((float)$$7, (float)$$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
      ...
      public fwu bake(Function<fit, fwu> $$0) {
         return $$0.apply(new fit() {
            ...
            public void a(int $$0, int $$1, GpuTexture $$2) {
               FT_Face $$3 = fiv.this.b();

               try (fkf $$4 = new fkf(fkf.a.d, a.this.b, a.this.c, false)) {
                  if ($$4.a($$3, a.this.g)) {
                     RenderSystem.getDevice().createCommandEncoder().writeToTexture($$2, $$4, 0, $$0, $$1, a.this.b, a.this.c, 0, 0);
                  }
               }
            }
