...
public class fiv extends hky {
   ...
   private final fiv.a L;
   @Nullable
   private volatile wo M;
   private volatile wo N = wo.c("mco.download.preparing");
   @Nullable
   ...
   public fiv(fui $$0, fhy $$1, String $$2, BooleanConsumer $$3) {
      super(fky.a);
      this.aa = $$3;
      this.F = $$0;
      this.K = $$2;
      this.G = $$1;
      this.L = new fiv.a();
      this.H = wo.c("mco.download.title");
      this.I = RateLimiter.create(0.1F);
   }

   @Override
   public void aR_() {
      this.J = this.c(fop.a(wn.e, $$0 -> this.aO_()).a((this.n - 200) / 2, this.o - 42, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      if (!this.R && !this.Z) {
         ...
         if (this.a(this.G.a) >= 5368709120L) {
            wo $$0 = wo.a("mco.download.confirmation.oversized", fge.b(5368709120L));
            this.m.a(fje.c(this, $$0, $$0x -> {
               this.m.a(this);
               this.G();
            }));
         } else {
   ...
   private wo F() {
      ...
      $$0.add(this.N);
      if (this.O != null) {
         $$0.add(wo.a("mco.download.percent", this.O));
         $$0.add(wo.a("mco.download.speed.narration", fge.b(this.V)));
      }
   ...
   private void d(fob $$0) {
      ...
      $$0.a(this.p, wo.a("mco.download.percent", this.O), this.n / 2, 84, -1);
   }
   ...
   private void a(fob $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.b(this.p, wo.a("mco.download.speed", fge.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1);
      }
   }
         ...
         try {
            try {
               if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                  this.N = wo.c("mco.download.failed");
                  return;
               }
               ...
               this.N = wo.a("mco.download.downloading", this.K);
               fgf $$0 = new fgf();
               $$0.a(this.G.a);
               ...
               while (!$$0.b()) {
                  if ($$0.c()) {
                     $$0.a();
                     this.M = wo.c("mco.download.failed");
                     this.J.b(wn.d);
                     return;
                  }
                  ...
                  if ($$0.d()) {
                     if (!this.S) {
                        this.N = wo.c("mco.download.extracting");
                     }
   ...
   private void H() {
      this.N = wo.c("mco.download.cancelled");
   }
