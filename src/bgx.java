...
public class bgx implements bgy {
   ...
   private static final bgx j = new bgx();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bgw $$0) {
      URL $$1 = bgx.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bgw $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bha a = new bha(() -> bgx.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bgx.this.k && $$0.getState() == RecordingState.STOPPED) {
