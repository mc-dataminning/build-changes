...
public class bcp extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      OpticFinder<String> $$0 = DSL.fieldFinder("id", bkj.a());
      Type<?> $$1 = this.getInputSchema().getType(biq.D);
      Type<?> $$2 = this.getOutputSchema().getType(biq.D);
      return this.fixTypeEverywhereTyped("BoatSplitFix", $$1, $$2, $$2x -> {
         ...
         if ($$3.isPresent() && c($$3.get())) {
            ...
            String $$6;
            if (b($$3.get())) {
               $$6 = $$5.map(bcp::e).orElse("minecraft:oak_chest_boat");
            } else {
               $$6 = $$5.map(bcp::d).orElse("minecraft:oak_boat");
            }

            return baz.a($$2, $$2x).update(DSL.remainderFinder(), $$0xx -> $$0xx.remove("Type")).set($$0, $$6);
         } else {
            return baz.a($$2, $$2x);
         }
      });
