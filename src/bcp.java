...
public class bcp extends azj {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcp::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcp::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcp::k);
         $$0 = this.a($$0, "minecraft:fox", bcp::j);
         $$0 = this.a($$0, "minecraft:item", bcp::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcp::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcp::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcp::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcp::e);
         return this.a($$0, "minecraft:piglin", bcp::d);
      });
   }
