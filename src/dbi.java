...
public class dbi extends cwo implements czw {
   ...
   protected dbi(dfi.d $$0, dfy $$1) {
      super($$0.a($$1.d()));
      this.l = $$1;
      this.k(this.C.b().a(aC, ha.c).a(a, Boolean.valueOf(false)).a(b, dgi.b).a(c, Boolean.valueOf(false)).a(d, Boolean.valueOf(false)));
   }
   ...
   protected void a(@Nullable cbu $$0, cpv $$1, gw $$2, boolean $$3) {
      $$1.a($$0, $$2, $$3 ? this.l.h() : this.l.g(), ape.e, 1.0F, $$1.D_().i() * 0.1F + 0.9F);
   ...
   public dfj a(cln $$0) {
      ...
      if (!$$0.c() && $$3.o().d()) {
         ...
         $$1 = $$1.a(aC, $$0.g().g()).a(b, $$3 == ha.b ? dgi.b : dgi.a);
      }
