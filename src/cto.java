...
public class cto extends css {
   ...
   @Nullable
   private dar<dbh> A;
   private final List<dar<dbh>> B;

   public cto(int $$0, col $$1) {
      this($$0, $$1, csb.a);
   }

   public cto(int $$0, col $$1, csb $$2) {
      super(csx.v, $$0, $$1, $$2);
      this.z = $$1.k.dX();
      this.B = this.z.r().a(dav.g);
   }
   ...
   private dbi p() {
      return new dbi(this.s.a(0), this.s.a(1), this.s.a(2));
   }
   ...
   public void m() {
      dbi $$0 = this.p();
      List<dar<dbh>> $$1 = this.z.r().b(dav.g, $$0, this.z);
      if ($$1.isEmpty()) {
         this.t.a(0, cwb.k);
      } else {
         dar<dbh> $$2 = $$1.get(0);
         cwb $$3 = $$2.b().a($$0, this.z.H_());
         if ($$3.a(this.z.J())) {
            this.A = $$2;
            this.t.a($$2);
            this.t.a(0, $$3);
   ...
   private static OptionalInt a(dbh $$0, cwb $$1) {
      if ($$0.a($$1)) {
