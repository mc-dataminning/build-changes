...
public class ejr extends eje<elb> {
   public ejr(Codec<elb> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azm.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azv $$0, diw $$1, int $$2, int $$3, iu $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iu $$2, diw $$3, boolean $$4, double $$5, iu $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(diw $$0, iu $$1) {
      if ($$0.a_($$1.d()).a(dmc.eb)) {
         this.a($$0, $$1.d(), dmc.a.m());
      }
   }

   private void a(diw $$0, azv $$1, iu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dzz $$13) {
   ...
   private void a(iu $$0, diw $$1, azv $$2, int $$3, int $$4, boolean $$5, boolean $$6, dzz $$7) {
      dzz $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dmc.ed) || $$8.a(dmc.ec) || $$8.a(dmc.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dmc.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dmc.ed.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, iu $$2, int $$3, azv $$4) {
      float $$5 = 10.0F * azm.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(azv $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azv $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dzz $$0) {
      return $$0.a(dmc.jb) || $$0.a(dmc.ed) || $$0.a(dmc.nz);
   }
   ...
   private void a(diw $$0, iu $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dmc.eb)) {
                  if (this.a((dib)$$0, $$10)) {
                     this.a($$0, $$10, dmc.a.m());
                     this.a($$0, $$10.d(), dmc.a.m());
                  } else if (c($$11)) {
                     dzz[] $$12 = new dzz[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
