...
public class ejr {
   private final List<ConcurrentLinkedQueue<ejq>> a = ImmutableList.of(
   ...
   public void a(ejq $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ejq> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ejq> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ejq> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ejq> j() {
