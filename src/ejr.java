...
public class ejr implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ejr.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ejr(List<ejr.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ejr a(BufferedReader $$0) {
      return new ejr($$0.lines().flatMap($$0x -> ejr.a.a($$0x).stream()).toList());
   }

   public static record a(ejr.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ejr.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ejr.a(ejr.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ejr.a(ejr.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ejr.a(ejr.b.b, $$3));
      ...
      static ejr.a b(String $$0) {
         return new ejr.a(ejr.b.a, "glob:" + $$0);
      }

      static ejr.a c(String $$0) {
         return new ejr.a(ejr.b.a, "regex:" + $$0);
      }

      static ejr.a d(String $$0) {
         return new ejr.a(ejr.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ejr.b a = FileSystem::getPathMatcher;
      ejr.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
