...
public class fd implements ArgumentType<Integer> {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vb.c("argument.time.invalid_unit"));
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> vb.b("argument.time.tick_count_too_low", $$1, $$0));
   ...
   public static class a implements hh<fd, fd.a.a> {
      public void a(fd.a.a $$0, ue $$1) {
         $$1.p($$0.b);
      }

      public fd.a.a a(ue $$0) {
         int $$1 = $$0.readInt();
         return new fd.a.a($$1);
      }
      ...
      public final class a implements hh.a<fd> {
         final int b;
