...
public abstract class ces {
   ...
   protected static boolean a(bvi $$0, fba $$1, fba $$2, boolean $$3) {
      fba $$4 = new fba($$2.d, $$2.e + (double)$$0.ds() * 0.5, $$2.f);
      return $$0.dW().a(new dfq($$1, $$4, dfq.a.a, $$3 ? dfq.b.c : dfq.b.a, $$0)).d() == fay.a.a;
   }
   ...
   public boolean b(ji $$0) {
      if (this.m) {
         ...
         etl $$1 = this.c.d();
         fba $$2 = new fba(((double)$$1.a + this.a.dB()) / 2.0, ((double)$$1.b + this.a.dD()) / 2.0, ((double)$$1.c + this.a.dH()) / 2.0);
