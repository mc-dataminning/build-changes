...
public class ces implements dbm {
   ...
   public int a(arf $$0, boolean $$1, boolean $$2) {
      if (!$$0.R() && $$1) {
         float $$3 = $$0.f(0.0F);
         if ((double)$$3 == 0.5) {
            this.c = $$0.z.a(10) == 0 ? ces.a.b : ces.a.c;
         }
   ...
   private void b(arf $$0) {
      evs $$1 = this.a($$0, new iz(this.f, this.g, this.h));
      if ($$1 != null) {
         ckx $$2;
         try {
            $$2 = new ckx($$0);
            $$2.a($$0, $$0.d_($$2.dp()), btu.h, null);
   ...
   @Nullable
   private evs a(arf $$0, iz $$1) {
      for (int $$2 = 0; $$2 < 10; $$2++) {
         int $$3 = $$1.u() + $$0.z.a(16) - 8;
         int $$4 = $$1.w() + $$0.z.a(16) - 8;
         int $$5 = $$0.a(dxv.a.b, $$3, $$4);
         iz $$6 = new iz($$3, $$5, $$4);
         if ($$0.c($$6) && cke.b(btb.bu, $$0, btu.h, $$6, $$0.z)) {
            return evs.c($$6);
         }
      }
