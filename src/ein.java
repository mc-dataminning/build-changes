...
public class ein extends eit<ekv> {
   public ein(Codec<ekv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eiv<ekv> $$0) {
      djo $$1 = $$0.b();
      iu $$2 = $$0.e();
      ekv $$3 = $$0.f();
      azt $$4 = $$0.d();
   ...
   private void a(djo $$0, azt $$1, iu $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, ekv $$9) {
      Optional<efd> $$10 = efd.a($$0, $$2, $$9.b, eio::c, eio::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dis)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dis)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               eio.a($$0, $$2.h($$11.getAsInt() - 1), ja.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               eio.a($$0, $$2.h($$17.getAsInt() + 1), ja.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dis $$0, iu $$1) {
      return $$0.a_($$1).a(dlw.K);
   }

   private int a(azt $$0, int $$1, int $$2, float $$3, int $$4, ekv $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(djo $$0, iu $$1) {
      dzo $$2 = $$0.a_($$1);
      if (!$$2.a(dlw.J) && !$$2.a(dlw.sY) && !$$2.a(dlw.sX)) {
         if ($$0.a_($$1.d()).y().a(axf.a)) {
            return false;
         } else {
            for (ja $$3 : ja.c.a) {
               if (!this.a((diq)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((diq)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private boolean a(diq $$0, iu $$1) {
      dzo $$2 = $$0.a_($$1);
      return $$2.a(axa.bg) || $$2.y().a(axf.a);
   }

   private void a(djo $$0, iu $$1, int $$2, ja $$3) {
      iu.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, ekv $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
   ...
   private static float a(azt $$0, float $$1, float $$2, float $$3, float $$4) {
      return bsx.a($$0, $$3, $$4, $$1, $$2);
   }
}
