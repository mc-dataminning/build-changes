...
public class ful {
   ...
   public fue a(Vector3f $$0, Vector3f $$1, fug $$2, gen $$3, ic $$4, ggv $$5, @Nullable fuh $$6, boolean $$7, ahg $$8) {
      fui $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = auo.i($$11, $$9.a[0], $$12);
      $$9.a[2] = auo.i($$11, $$9.a[2], $$12);
      $$9.a[1] = auo.i($$11, $$9.a[1], $$13);
      $$9.a[3] = auo.i($$11, $$9.a[3], $$13);
      ...
      return new fue($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fui a(fui $$0, ic $$1, j $$2, ahg $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(auo.b($$23), auo.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fui(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fui $$0, gen $$1, ic $$2, float[] $$3, j $$4, @Nullable fuh $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ic $$2, fui $$3, float[] $$4, gen $$5, j $$6, @Nullable fuh $$7, boolean $$8) {
      fsy.b $$9 = fsy.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gen $$3, fui $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fuh $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ic $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (auo.a($$13, $$18) && auo.a($$14, $$19) && auo.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
