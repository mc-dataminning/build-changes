...
public class ful extends fuk {
   ...
   protected void aR_() {
      ...
      this.z = $$0.u();
      this.A = $$0.aZ().m();
      this.c(foz.a(dgf::e).a(dgf.a, dgf.d, dgf.b, dgf.c).a(this.z).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.z = $$1x));
      this.c(foz.b(this.A).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.A = $$1x));
      fos $$1 = fos.a(wo.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         wo $$2;
      ...
      this.C = new fpb(this.p, this.n / 2 - 75, 160, 150, 20, wo.c("lanServer.port"));
      this.C.b($$1x -> {
         wo $$2 = this.a($$1x);
      ...
      this.c(this.C);
      this.c($$1);
      this.c(fos.a(wn.e, $$0x -> this.aO_()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
