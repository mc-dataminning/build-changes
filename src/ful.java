...
public class ful extends fum {
   ...
   private final fsm B = fsm.d().a(8);
   private final wp C;
   private final fpo D;
   private final fpo E;
   private final evg.c F;

   public ful(flk $$0, BooleanConsumer $$1, evg.c $$2) {
      super(c);
      this.A = $$1;
      this.C = wp.a("recover_world.message", wp.b($$2.f()).a(n.h));
      this.D = new fpo(this.C, $$0.h);
      this.F = $$2;
      Exception $$3 = this.a($$2, false);
      Exception $$4 = this.a($$2, true);
      wp $$5 = wp.i().b(this.a($$2, false, $$3)).f("\n").b(this.a($$2, true, $$4));
      this.E = new fpo($$5, $$0.h);
      boolean $$6 = $$3 != null && $$4 == null;
      this.B.c().b();
      this.B.a(new fqb(this.l, $$0.h));
      this.B.a(this.D.b(true));
      this.B.a(this.E);
      fsm $$7 = fsm.e().a(5);
      $$7.a(fou.a(d, ftj.b(this, axv.j)).b(120, 20).a());
      $$7.a(fou.a(s, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : fqf.a(u)).a()).j = $$6;
      this.B.a($$7);
      this.B.a(fou.a(wo.k, $$0x -> this.aO_()).b(120, 20).a());
      this.B.a(this::c);
   }
   ...
   private void a(flk $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new ftx(wp.c("recover_world.restoring")));
         fzo.a(this.F);
         if (this.F.n()) {
            $$0.a(new ftk(this.A, v, w, wo.j, wo.k));
         } else {
            $$0.a(new ftf(() -> this.A.accept(false), v, x));
         }
      } else {
         a.error(
   ...
   private wp a(evg.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         return wp.i();
      } else {
         xd $$3 = wp.i();
         Instant $$4 = $$0.a($$1);
         xd $$5 = $$4 != null ? wp.b(fzz.a.format($$4)) : wp.c("recover_world.state_entry.unknown");
   ...
   @Nullable
   private Exception a(evg.c $$0, boolean $$1) {
      try {
         if (!$$1) {
            $$0.a($$0.h());
         } else {
