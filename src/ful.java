...
public class ful extends fuh {
   ...
   ful(fqe $$0, double $$1, double $$2, double $$3, dqa $$4, int $$5) {
      super($$0, $$1, $$2, $$3, 0.0, 0.0, 0.0);
      this.D = 0.3F;
      this.a = $$4;
      this.t = $$5;
      Optional<enz> $$6 = $$4.a($$0);
      if ($$6.isPresent()) {
         enz $$7 = $$6.get();
         double $$8 = $$1 - $$7.a();
         double $$9 = $$2 - $$7.b();
         double $$10 = $$3 - $$7.c();
         this.F = this.b = (float)awi.d($$8, $$10);
         this.H = this.G = (float)awi.d($$9, Math.sqrt($$8 * $$8 + $$10 * $$10));
      }
   }

   @Override
   public void a(esl $$0, ewz $$1, float $$2) {
      float $$3 = awi.a(((float)this.s + $$2 - (float) (Math.PI * 2)) * 0.05F) * 2.0F;
      float $$4 = awi.i($$2, this.F, this.b);
      float $$5 = awi.i($$2, this.H, this.G) + (float) (Math.PI / 2);
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         Optional<enz> $$0 = this.a.a(this.c);
         if ($$0.isEmpty()) {
            this.k();
         } else {
            int $$1 = this.t - this.s;
            ...
            enz $$3 = $$0.get();
            this.g = awi.d($$2, this.g, $$3.a());
            this.h = awi.d($$2, this.h, $$3.b());
            this.i = awi.d($$2, this.i, $$3.c());
            double $$4 = this.g - $$3.a();
            double $$5 = this.h - $$3.b();
            double $$6 = this.i - $$3.c();
            this.F = this.b;
            this.b = (float)awi.d($$4, $$6);
            this.H = this.G;
            this.G = (float)awi.d($$5, Math.sqrt($$4 * $$4 + $$6 * $$6));
         }
      }
   }

   public static class a implements ftk<kd> {
      private final fuc a;
      ...
      public fth a(kd $$0, fqe $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ful $$8 = new ful($$1, $$2, $$3, $$4, $$0.c(), $$0.d());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
