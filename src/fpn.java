...
public class fpn {
   ...
   private static final fhn b = new fhn(new akn("recipe_book/page_forward"), new akn("recipe_book/page_forward_highlighted"));
   private static final fhn c = new fhn(new akn("recipe_book/page_backward"), new akn("recipe_book/page_backward_highlighted"));
   ...
   public void a(feb $$0, int $$1, int $$2) {
      ...
      this.j = new fhg($$1 + 93, $$2 + 137, 12, 17, false);
      this.j.a(b);
      this.k = new fhg($$1 + 38, $$2 + 137, 12, 17, true);
      this.k.a(c);
   }
   ...
   public void a(ffn $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      if (this.l > 1) {
   ...
   protected void a(Consumer<ffy> $$0) {
      $$0.accept(this.j);
      $$0.accept(this.k);
      this.d.forEach($$0);
   }
