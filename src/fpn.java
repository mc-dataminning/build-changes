...
public class fpn extends fpf<cqu> implements fsa {
   private float D;
   private float E;
   private final fru F = new fru();
   private boolean G;
   private boolean H;

   public fpn(cmv $$0) {
      super($$0.cc, $$0.fZ(), wy.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void D() {
      if (this.l.q.f()) {
         this.l.a(new fpc(this.l.s, this.l.s.h.x(), this.l.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aP_() {
      if (this.l.q.f()) {
         ...
         this.c(new fis(this.z + 104, this.n / 2 - 22, 20, 18, fru.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.m, this.c);
   ...
   public static void a(fht $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, btl $$9) {
   ...
   public static void a(fht $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, btl $$7) {
      $$0.c().a();
