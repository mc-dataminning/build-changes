...
public class fpn {
   ...
   private void a(o $$0, wy $$1) {
      this.b.m.d().a(wy.i().b(wy.c("debug.prefix").a($$0, o.r)).b(wx.v).b($$1));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dje)MoreObjects.firstNonNull(this.b.r.h(), dje.b)).b());
               }
            ...
            case 83:
               ...
               this.b.aa().a($$5);
               wy $$6 = wy.b($$4.relativize($$5).toString()).a(o.t).a($$1x -> $$1x.a(new ww.d($$5)));
   ...
   private void a(eao $$0, iv $$1, @Nullable tz $$2) {
   ...
   private void a(alg $$0, fex $$1, @Nullable tz $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.p("UUID");
         $$2.p("Pos");
         $$2.p("Dimension");
         String $$3 = uo.b((uw)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().d();
         boolean $$5 = fip.a(fpo.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fip.a(fpo.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fip.a(fpo.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ag.c();
            this.e = ag.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof gca) || ((gca)$$6).u <= ag.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
               boolean $$7 = this.b.aO().i();
               this.b.n.ad().a($$7);
               this.b.n.az();
               if (this.b.z instanceof gbx $$8) {
                  $$8.c($$7);
               }
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fpw.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$9 = $$6 == null || !($$6.aI_() instanceof fte) || !((fte)$$6.aI_()).c();
            if ($$9) {
               if (fyn.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$10 = this.b.n.av().c() == fpq.a;
                  this.b.n.av().a(fpq.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$10);
                  }
         ...
         label201: {
            ...
            label157:
            if (!$$15) {
               if (this.b.z instanceof fyi $$16 && !$$16.m()) {
                  break label157;
               }
