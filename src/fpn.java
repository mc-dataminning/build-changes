...
public record fpn(int a, @Nullable fpn.a b, @Nullable wy c, @Nullable String d) {
   ...
   private static final fpn l = new fpn(13684944, null, e, "System");
   private static final fpn m = new fpn(13684944, null, f, "System");
   private static final fpn n = new fpn(13684944, null, g, "Not Secure");
   private static final fpn o = new fpn(16733525, null, i, "Chat Error");
   ...
   public static fpn a(String $$0) {
      ...
      return new fpn(6316128, fpn.a.a, $$2, "Modified");
   }
   ...
   public static enum a {
      ...
      public void a(fsm $$0, int $$1, int $$2) {
         $$0.a(grc::H, this.b, $$1, $$2, this.c, this.d);
      }
   }
}
