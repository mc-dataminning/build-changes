...
public class fpn extends fnz<crt> {
   ...
   private void b(fgp $$0, int $$1, int $$2, int $$3) {
      List<cyv<czn>> $$4 = this.w.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.I()) {
         ...
         this.S = ayx.a(this.S - $$5, 0.0F, 1.0F);
