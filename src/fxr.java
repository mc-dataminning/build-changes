...
public class fxr implements AutoCloseable {
   ...
   public fxr(fxl $$0, ezi $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gip(16, 16, false);
   ...
   private float b(float $$0) {
      bok $$1 = this.j.s.c(bom.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(bpp $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.a(bom.p)) {
               $$9 = fxl.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.a(bom.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   public static float a(dqo $$0, int $$1) {
