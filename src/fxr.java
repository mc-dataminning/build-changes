...
public class fxr<T extends dit & djw> implements fxl<T> {
   ...
   @Override
   public void a(T $$0, float $$1, esa $$2, fvl $$3, int $$4, int $$5) {
      cvn $$6 = $$0.i();
      boolean $$7 = $$6 != null;
      ...
      if ($$8.b() instanceof cxi<?> $$11) {
         ...
         $$16 = 1.0F - $$16;
         $$16 = 1.0F - $$16 * $$16 * $$16;
         int $$17 = $$14.apply(new fxo<>()).applyAsInt($$4);
         giw $$18 = fwa.a($$0, $$9, this.m);
         ese $$19 = $$18.a($$3, fvt::d);
         if ($$12) {
            if ($$9 == dlx.b) {
