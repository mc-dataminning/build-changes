...
public record gsg(Vector3fc b, Vector3fc c, Vector3fc d) {
   public static final gsg a = new gsg(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));

   public void a(boolean $$0, fkd.a $$1) {
      if (this == a) {
         $$1.a(-0.5F, -0.5F, -0.5F);
      } else {
         float $$2;
   ...
   protected static class a implements JsonDeserializer<gsg> {
