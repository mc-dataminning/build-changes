...
public class djb implements dix, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bgu<bgw.b> c;
   private final dje d;
   private final Map<cqg, djb.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected djb(Path $$0, boolean $$1, String $$2) {
      this.d = new dje($$0, $$1);
      this.c = new bgu<>(new bgw.a(djb.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(cqg $$0, int $$1) {
      cqg $$2 = new cqg($$0.e - $$1, $$0.f - $$1);
      cqg $$3 = new cqg($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         cqg $$3 = cqg.b($$0, $$1);
         BitSet $$4 = new BitSet();
         cqg.a($$2, $$3).forEach($$1xx -> {
            su $$2x = new su(new sw(ry.a, "DataVersion"), new sw(rt.b, "blending_data"));
            ...
            if ($$2x.d() instanceof rt $$5 && this.a($$5)) {
   ...
   private boolean a(rt $$0) {
      return $$0.b("DataVersion", 99) && $$0.h("DataVersion") >= 3441 ? $$0.b("blending_data", 10) : true;
   }

   public CompletableFuture<Void> a(cqg $$0, @Nullable rt $$1) {
      return this.a(() -> {
         djb.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new djb.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<rt>> a(cqg $$0) {
      return this.a(() -> {
         djb.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(cqg $$0, sk $$1) {
      return this.a(() -> {
         try {
            djb.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bgw.b(djb.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cqg, djb.a>> $$0 = this.e.entrySet().iterator();
         Entry<cqg, djb.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bgw.b(djb.b.b.ordinal(), this::a));
   }

   private void a(cqg $$0, djb.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bgw.b(djb.b.c.ordinal(), () -> $$0.a(atz.a))).join();
         this.c.close();
