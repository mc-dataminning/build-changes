...
public class fnx extends hqd implements flh {
   ...
   private final int K;
   final AtomicReference<flg> a = new AtomicReference<>();
   private final fkx L;
   ...
   private fta V;
   private int W;
   private final fwo X = new fwo(this);

   public fnx(@Nullable fot $$0, long $$1, int $$2, fnq $$3, ezi $$4) {
      super(fpk.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aO_() {
      this.U = this.X.b(fta.a(wx.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fta.a(wx.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.H();
            ...
            this.m.a(new fnj(this.G, $$0.toArray(new foq[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fnd(new fko(new fyu()), this.J));
   }
   ...
   private void H() {
      ...
      fma $$1 = fma.a(this.H.g(), true, this.H.l().c());
      flg $$2 = new flg($$0, $$1, this.m.X(), this.J, this.K, this);
