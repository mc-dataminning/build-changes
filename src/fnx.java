public abstract class fnx<T extends cpq> extends fnw<T> implements fqr {
   public final fqh D;
   private boolean E;
   private final alb F;
   private final alb G;
   ...
   public fnx(T $$0, fqh $$1, cmr $$2, xl $$3, alb $$4, alb $$5, alb $$6) {
      super($$0, $$2, $$3);
      this.D = $$1;
      this.F = $$4;
      this.G = $$5;
   ...
   public void aN_() {
      ...
      this.c(new fhl(this.z + 20, this.o / 2 - 49, 20, 18, fql.a, $$0 -> {
         this.D.e();
         this.z = this.D.a(this.n, this.c);
   ...
   protected void a(fgm $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.w.s()) {
         int $$6 = 14;
         int $$7 = ayu.f(this.w.r() * 13.0F) + 1;
         $$0.a(this.G, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = ayu.f(this.w.q() * 24.0F);
