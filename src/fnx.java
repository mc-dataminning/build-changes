...
public class fnx {
   ...
   public boolean b(hx $$0, ic $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.i()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               deb $$4 = $$3.w();
               this.b.ai().a(new ght($$4.f(), ars.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, ghy.t(), $$0));
            }
   ...
   public bka a(fsh $$0, bjz $$1, elo $$2) {
      this.o();
   ...
   private bka b(fsh $$0, bjz $$1, elo $$2) {
      hx $$3 = $$2.a();
      cmx $$4 = $$0.b($$1);
      if (this.j == ctl.d) {
         return bka.a;
   ...
   public fsh a(fnq $$0, asc $$1, eut $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public fsh a(fnq $$0, asc $$1, eut $$2, boolean $$3, boolean $$4) {
      return new fsh(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }
