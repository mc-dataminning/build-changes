public abstract class fnx implements fod {
   private int c;
   private int d;
   protected int a;
   protected int b;

   public fnx(int $$0, int $$1, int $$2, int $$3) {
      this.c = $$0;
      this.d = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   protected abstract static class a {
      ...
      public void b(int $$0, int $$1) {
         ...
         int $$4 = Math.round(azf.h(this.b.f, $$2, $$3));
         this.a.n($$4 + $$0);
      }
   }
}
