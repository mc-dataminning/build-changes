...
public enum fnx implements fbr {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fct a(int $$0, int $$1, fnx.a $$2) {
      fct $$3 = new fct(fct.a.a, $$0, $$1, false);
   ...
   private fnx(final Supplier<fct> $$0) {
      this.c = $$0.get();
   }
