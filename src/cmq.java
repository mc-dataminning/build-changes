...
public class cmq implements dbk {
   ...
   private boolean a(are $$0) {
      ...
      if ($$1 == null) {
         ...
         int $$3 = 48;
         ces $$4 = $$0.y();
         Optional<iz> $$5 = $$4.d($$0x -> $$0x.a(cew.o), $$0x -> true, $$2, 48, ces.b.c);
         iz $$6 = $$5.orElse($$2);
         iz $$7 = this.a($$0, $$6, 48);
   ...
   private void a(are $$0, cmp $$1, int $$2) {
      iz $$3 = this.a($$0, $$1.dp(), $$2);
      if ($$3 != null) {
         chq $$4 = bsz.be.a($$0, $$3, bts.h);
         if ($$4 != null) {
            $$4.b($$1, true);
         }
      }
   ...
   private iz a(dca $$0, iz $$1, int $$2) {
      ...
      for (int $$5 = 0; $$5 < 10; $$5++) {
         ...
         int $$8 = $$0.a(dxt.a.b, $$6, $$7);
         iz $$9 = new iz($$6, $$8, $$7);
         if ($$4.isSpawnPositionOk($$0, $$9, bsz.bl)) {
            $$3 = $$9;
            break;
         }
      }
