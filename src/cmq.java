...
public class cmq implements clz {
   ...
   public cmq(String $$0, cly $$1, cjf $$2, hn<cmg> $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static class a implements cmm<cmq> {
      private static final Codec<cmq> x = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  arf.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.a),
                  ...
                  cmg.c.listOf().fieldOf("ingredients").flatXmap($$0x -> {
                     ...
                     if ($$1.length == 0) {
                        ...
                        return $$1.length > 9 ? DataResult.error(() -> "Too many ingredients for shapeless recipe") : DataResult.success(hn.a(cmg.a, $$1));
                     }
