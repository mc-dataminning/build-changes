...
public class eba {
   ...
   private static final dey.f e = ($$0, $$1, $$2) -> $$0.a(csm.co);
   ...
   public static Optional<eba> a(cpm $$0, gu $$1, ha.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<eba> a(cpm $$0, gu $$1, Predicate<eba> $$2, ha.a $$3) {
      Optional<eba> $$4 = Optional.of(new eba($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ha.a $$5 = $$3 == ha.a.a ? ha.a.c : ha.a.a;
         return Optional.of(new eba($$0, $$1, $$5)).filter($$2);
      }
   }

   public eba(cpm $$0, gu $$1, ha.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dez $$0) {
      return $$0.i() || $$0.a(apl.aJ) || $$0.a(csm.ee);
   }
   ...
   public static ehd a(l.a $$0, ha.a $$1, ehd $$2, bij $$3) {
      ...
      return new ehd($$8, $$11, $$14);
   }

   public static eaz a(akk $$0, l.a $$1, ha.a $$2, ehd $$3, bii $$4, ehd $$5, float $$6, float $$7) {
      gu $$8 = $$1.a;
      dez $$9 = $$0.a_($$8);
      ha.a $$10 = $$9.d(dfp.H).orElse(ha.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bij $$13 = $$4.a($$4.an());
      int $$14 = $$2 == $$10 ? 0 : 90;
      ehd $$15 = $$2 == $$10 ? $$5 : new ehd($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a / 2.0 + ($$11 - (double)$$13.a) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == ha.a.a;
      ehd $$20 = new ehd((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      ehd $$21 = a($$20, $$0, $$4, $$13);
      return new eaz($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static ehd a(ehd $$0, akk $$1, bii $$2, bij $$3) {
      if (!($$3.a > 4.0F) && !($$3.b > 4.0F)) {
         double $$4 = (double)$$3.b / 2.0;
         ehd $$5 = $$0.b(0.0, $$4, 0.0);
         ehw $$6 = eht.a(egy.a($$5, (double)$$3.a, 0.0, (double)$$3.a).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<ehd> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a, (double)$$3.b, (double)$$3.a);
         Optional<ehd> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
