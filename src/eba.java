...
public class eba {
   ...
   private final iv e;
   private final jb f;
   private final List<iv> g = Lists.newArrayList();
   private final List<iv> h = Lists.newArrayList();
   private final jb i;

   public eba(djx $$0, iv $$1, jb $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      ebe $$0 = this.b.a_(this.e);
      if (!eaw.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == ext.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(ebe $$0) {
      return $$0.a(dne.ix) || $$0.a(dne.pO);
   }

   private static boolean a(ebe $$0, ebe $$1) {
      if ($$0.a(dne.pO) && $$1.a(dne.ix)) {
         return false;
      } else {
         return $$0.a(dne.ix) && $$1.a(dne.pO) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(iv $$0, jb $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!eaw.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               ebe $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !eaw.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!eaw.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
