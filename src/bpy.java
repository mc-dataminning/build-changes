...
public record bpy(Instant a, String b, long c) {
   ...
   public static bpy a(RecordedEvent $$0) {
      ...
      return new bpy($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bpy.a a(List<bpy> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bpy>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bpy $$3 = (bpy)$$2x.get(0);
            bpy $$4 = (bpy)$$2x.get($$2x.size() - 1);
