...
public abstract class fuf<E extends fuf.a<E>> extends fuc {
   private static final ali a = ali.b("textures/gui/menu_list_background.png");
   private static final ali m = ali.b("textures/gui/inworld_menu_list_background.png");
   protected final frd c;
   protected final int d;
   private final List<E> n = new fuf.b();
   ...
   public fuf(frd $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wz.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fuf(frd $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected final E c(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = azo.a($$1 - (double)this.G()) - this.f + (int)this.g() - 4;
      int $$7 = $$6 / this.d;
   ...
   protected void b(ftx $$0) {
      ali $$1 = this.c.s == null ? gad.h : gad.j;
      ali $$2 = this.c.s == null ? gad.i : gad.k;
      $$0.a(gsl::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gsl::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(ftx $$0) {
      ali $$1 = this.c.s == null ? a : m;
      $$0.a(gsl::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(ftx $$0) {
   ...
   @Override
   public Optional<fwi> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fyq $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fyq $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fyg.a w() {
      if (this.aN_()) {
         ...
         return this.q != null ? fyg.a.b : fyg.a.a;
      }
   }
   ...
   protected void a(fyi $$0, E $$1) {
      List<E> $$2 = this.aI_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fyh.b, xa.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fuf.a<E>> implements fwi {
      @Deprecated
      fuf<E> a;
      ...
      public abstract void a(ftx var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
