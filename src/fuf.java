...
public class fuf implements anv {
   public static final aex a = new aex("textures/misc/enchanted_glint_entity.png");
   public static final aex b = new aex("textures/misc/enchanted_glint_item.png");
   ...
   public fuf(eqv $$0, fzf $$1, gbl $$2, esa $$3, fnr $$4) {
      ...
      for (cja $$5 : jd.i) {
         if (!k.contains($$5)) {
            this.o.a($$5, new gbm(jd.i.b($$5), "inventory"));
         }
      }
