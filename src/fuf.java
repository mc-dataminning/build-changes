public abstract class fuf extends ftr {
   ...
   @Override
   protected void aT_() {
      this.c = this.c(fny.a(xu.d, $$0x -> this.F()).a(this.n / 2 - 4 - 150, this.o / 4 + 120 + 12, 150, 20).a());
      this.d = this.c(fny.a(xu.e, $$0x -> this.aP_()).a(this.n / 2 + 4, this.o / 4 + 120 + 12, 150, 20).a());
      boolean $$0 = this.l().p();
      this.s = this.c(fof.a(xv.b("O"), xv.b("X")).a($$0).a().a(this.n / 2 + 150 - 20, this.E(), 20, 20, xv.c("advMode.trackOutput"), ($$0x, $$1) -> {
         dga $$2 = this.l();
         $$2.a($$1);
         this.c($$1);
      }));
      this.a = new foh(this.p, this.n / 2 - 150, 50, 300, 20, xv.c("advMode.command")) {
         @Override
         protected yj aR_() {
      ...
      this.a.b(this::a);
      this.d(this.a);
      this.b = new foh(this.p, this.n / 2 - 150, this.E(), 276, 20, xv.c("advMode.previousOutput"));
      this.b.f(32500);
      this.b.e(false);
      this.b.a("-");
      this.d(this.b);
