...
public class fnd implements fnu {
   ...
   private CompletableFuture<Optional<cfd>> g;
   private Instant h = Instant.EPOCH;

   public fnd(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
      this.f = $$2.resolve(d).resolve($$1 + ".json");
      this.g = CompletableFuture.<Optional<cfd>>supplyAsync(() -> this.c().filter($$0x -> !$$0x.c().b().a()), ac.f()).thenCompose(this::a);
   }
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cfd::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cfd>> a(Optional<cfd> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (ath | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cfd.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cfd $$0) {
      ...
      if ($$0 != null) {
         if (aa.aW) {
            cfd.a.encodeStart(JsonOps.INSTANCE, $$0).result().ifPresent($$0x -> {
               try {
   ...
   private cfd a(UserApiService $$0) throws ath, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cfe.a $$2 = a($$1);
         return new cfd(atg.a($$1.keyPair().privateKey()), new cfe($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cfe.a a(KeyPairResponse $$0) throws ath {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = atg.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cfe.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new ath(var5);
         }
      } else {
         throw new ath(new MissingException("Missing public key"));
      }
   }
}
