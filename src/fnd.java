...
public class fnd extends hpj implements fkn {
   ...
   private final int K;
   final AtomicReference<fkm> a = new AtomicReference<>();
   private final fkd L;
   ...
   private fsj V;
   private int W;
   private final fvx X = new fvx(this);

   public fnd(@Nullable fny $$0, long $$1, int $$2, fmw $$3, eyw $$4) {
      super(fop.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aO_() {
      this.U = this.X.b(fsj.a(wx.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fsj.a(wx.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.H();
            ...
            this.m.a(new fmp(this.G, $$0.toArray(new fnw[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fmj(new fju(new fyd()), this.J));
   }
   ...
   private void H() {
      ...
      flg $$1 = flg.a(this.H.g(), true, this.H.l().c());
      fkm $$2 = new fkm($$0, $$1, this.m.X(), this.J, this.K, this);
