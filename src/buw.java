...
public class buw extends buk {
   ...
   public buw(dgi $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bur.W, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public buw(bur<? extends buw> $$0, dgi $$1) {
      super($$0, $$1);
   }
   ...
   public void h() {
      ...
      if (this.j != null) {
         fba $$0 = new fba(this.j.dB() - this.dB(), this.j.dD() + (double)this.j.cS() / 2.0 - this.dD(), this.j.dH() - this.dH());
         double $$1 = $$0.h();
         if ($$1 < 64.0) {
      ...
      if (this.aJ()) {
         this.h(new fba(this.dz().d, -$$3 * 0.4, this.dz().f));
      }
   ...
   private void p() {
      ...
      if (this.dW() instanceof arc) {
         for (buw $$1 : this.dW().a(ebh.a(buw.class), this.cR().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(arc $$0, fba $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
   ...
   private static boolean b(arc $$0, fba $$1, int $$2) {
      fav $$3 = fav.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.H_().a(40);
      List<buw> $$5 = $$0.a(ebh.a(buw.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         buw $$6 = $$5.get(0);
         $$6.i++;
         $$6.f = 0;
   ...
   private int a(ard $$0, int $$1) {
      Optional<dcy> $$2 = ddb.a(dda.z, $$0, cwp::n);
      if ($$2.isPresent()) {
         cwp $$3 = $$2.get().a();
         int $$4 = ddb.c($$0.y(), $$3, $$1);
