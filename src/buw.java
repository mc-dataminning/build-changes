...
public abstract class buw extends bwj {
   private static final alc<Boolean> bZ = alg.a(buw.class, ale.k);
   ...
   protected buw(bvm<? extends buw> $$0, dha $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract buw a(ash var1, buw var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dk() instanceof crp $$0 && !$$0.b((bvf)this)) {
         this.ae();
      }
   }
