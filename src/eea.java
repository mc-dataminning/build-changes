...
public class eea implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<eea.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public eea(List<eea.a> $$0) {
      this.c = $$0;
   }
   ...
   public static eea a(BufferedReader $$0) {
      return new eea($$0.lines().flatMap($$0x -> eea.a.a($$0x).stream()).toList());
   }

   public static record a(eea.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<eea.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new eea.a(eea.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new eea.a(eea.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new eea.a(eea.b.b, $$3));
      ...
      static eea.a b(String $$0) {
         return new eea.a(eea.b.a, "glob:" + $$0);
      }

      static eea.a c(String $$0) {
         return new eea.a(eea.b.a, "regex:" + $$0);
      }

      static eea.a d(String $$0) {
         return new eea.a(eea.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      eea.b a = FileSystem::getPathMatcher;
      eea.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
