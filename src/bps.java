...
public class bps implements bpo {
   ...
   private final Map<String, bps.a> e = new HashMap<>();
   ...
   public void a(String $$0) {
      ...
      if (ab.aU) {
         Optional<StackFrame> $$4 = c.walk(
            $$0x -> $$0x.filter($$0xx -> $$0xx.getDeclaringClass() != bps.class && $$0xx.getDeclaringClass() != bpo.a.class).findFirst()
         );
         if ($$4.isPresent()) {
            StackFrame $$5 = $$4.get();
            $$1 = $$5.getMethodName();
   ...
   public void a(String $$0, int $$1) {
      this.e.computeIfAbsent($$0, $$1x -> new bps.a(this.f + " " + $$0)).b($$1);
   }
