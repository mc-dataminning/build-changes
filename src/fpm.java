...
public class fpm implements ajz<cxr>, fhc, fhv, fjt, fpr {
   public static final fhm a = new fhm(new akm("recipe_book/button"), new akm("recipe_book/button_highlighted"));
   private static final fhm i = new fhm(
      new akm("recipe_book/filter_enabled"),
      new akm("recipe_book/filter_disabled"),
      new akm("recipe_book/filter_enabled_highlighted"),
      new akm("recipe_book/filter_disabled_highlighted")
   );
   protected static final akm b = new akm("textures/gui/recipe_book.png");
   ...
   private final cma x = new cma();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, fdz $$2, boolean $$3, cqg<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fgi(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, wx.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fhf($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (fei $$3 : fei.a(this.g.t())) {
   ...
   private void b() {
      this.f.a(this.f.a() ? fhk.a(this.c()) : fhk.a(m));
   }
   ...
   public void a(ffm $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.f()) {
         this.w.a($$0, $$3, $$4);
         this.b($$0, $$1, $$2, $$3, $$4);
      }
   ...
   private void b(ffm $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fly.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(ffm $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cc.j, $$3, fly.s());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public void a(cxw<?> $$0, List<cqo> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cxr.a($$2), $$1.get(0).f, $$1.get(0).g);
   ...
   protected void j() {
      if (this.h.L() != null) {
         ...
         this.h.L().b(new ahk($$0, $$1, $$2));
      }
   }

   @Override
   public fjt.a t() {
      return this.A ? fjt.a.b : fjt.a.a;
   }

   @Override
   public void b(fjv $$0) {
      List<fjt> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.B()) {
            $$1.add($$1x);
         }
