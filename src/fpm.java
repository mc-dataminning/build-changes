...
public class fpm implements hgk {
   private static final long a = 3000L;
   private final fme b;
   private final List<fpm.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fpm.b> e = new ArrayList<>();
   ...
   public void a(fnq $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fpm.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hfg $$0, hgm $$1, float $$2) {
      if ($$1.a() != null) {
         xv $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fpm.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fbx($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fpm.b($$3, $$2, new fbx($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fbx a, long b) {
   }

   static class b {
      private final xv a;
      private final float b;
      private final List<fpm.a> c = new ArrayList<>();

      public b(xv $$0, float $$1, fbx $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fpm.a($$2, ae.c()));
      }
