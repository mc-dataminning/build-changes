...
public class fpm extends foq {
   ...
   public fpm(fod $$0, int $$1, int $$2, int $$3, int $$4, wp $$5, wp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.n = $$0;
      this.o = $$5;
      this.p = new fpp($$0, $$3 - this.b());
      this.p.a(this::r);
   }
   ...
   @Override
   public void a(fsr $$0) {
      $$0.a(fsq.a, wp.a("gui.narrate.editBox", this.B(), this.q()));
   }
   ...
   protected void c(fof $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aM_()) {
         $$0.a(this.n, (wu)this.o, this.e(), this.p(), this.g - this.b(), -857677600);
      } else {
         int $$5 = this.p.d();
   ...
   protected void b(fof $$0) {
      ...
      if (this.p.b()) {
         int $$1 = this.p.a();
         wp $$2 = wp.a("gui.multiLineEditBox.character_limit", this.p.c().length(), $$1);
   ...
   private void r() {
      double $$0 = this.g();
      fpp.a $$1 = this.p.c((int)($$0 / 9.0));
      if (this.p.d() <= $$1.a()) {
         $$0 = (double)(this.p.g() * 9);
      } else {
         fpp.a $$2 = this.p.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.p.d() > $$2.b()) {
