...
public class fpm {
   ...
   protected static class a implements JsonDeserializer<fpm> {
      ...
      public fpm a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         $$5.mul(0.0625F);
         $$5.set(arw.a($$5.x, -5.0F, 5.0F), arw.a($$5.y, -5.0F, 5.0F), arw.a($$5.z, -5.0F, 5.0F));
         Vector3f $$6 = this.a($$3, "scale", e);
         $$6.set(arw.a($$6.x, -4.0F, 4.0F), arw.a($$6.y, -4.0F, 4.0F), arw.a($$6.z, -4.0F, 4.0F));
