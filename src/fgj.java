...
public class fgj extends ffy implements fhd {
   private static final fhn d = new fhn(new akn("widget/text_field"), new akn("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axr> D = ($$0x, $$1x) -> axr.forward($$0x, xu.a);
   @Nullable
   private wx E;
   private long F = ac.c();

   public fgj(ffl $$0, int $$1, int $$2, wx $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fgj(ffl $$0, int $$1, int $$2, int $$3, int $$4, wx $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fgj(ffl $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fgj $$5, wx $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axr> $$0) {
      this.D = $$0;
   }
   ...
   protected xl aL_() {
      wx $$0 = this.y();
      return wx.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = ayf.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayf.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, flz.s());
   }
   ...
   public void b(ffn $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aJ_() && (ac.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.C() + 4 : this.C();
         int $$11 = this.r ? this.D() + (this.h - 8) / 2 : this.D();
         int $$12 = $$10;
         int $$13 = ayf.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gcs.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = ayf.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayf.a(this.v, 0, this.p.length());
      }
   }
