...
public class fgj {
   ...
   public static final fgj.a bv;

   public static fgj.a a(int $$0, int $$1) {
      return $$0 == -1 ? fgj.b.b.a($$1) : fgj.b.a.a($$0);
   }

   public static fgj.a a(String $$0) {
      if (fgj.a.e.containsKey($$0)) {
         return fgj.a.e.get($$0);
      } else {
         for (fgj.b $$1 : fgj.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fgj.b b;
      private final int c;
      private final aze<wv> d;
      static final Map<String, fgj.a> e = Maps.newHashMap();

      a(String $$0, fgj.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wv.b($$2.toUpperCase(Locale.ROOT)) : wv.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wv.b($$2) : wv.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tr.a().b($$1) ? wv.c($$1) : wv.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fgj.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wv> g;

      private static void a(fgj.b $$0, String $$1, int $$2) {
         fgj.a $$3 = new fgj.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, wv> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fgj.a a(int $$0) {
         return (fgj.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
