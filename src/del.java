...
public class del {
   public static final Codec<del> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> ae.a($$0, 2).map($$0x -> new del($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.g, $$0.h))
      .stable();
   public static final zj<ByteBuf, del> b = new zj<ByteBuf, del>() {
      public del a(ByteBuf $$0) {
         return wi.c($$0);
      }

      public void a(ByteBuf $$0, del $$1) {
         wi.a($$0, $$1);
      }
   };
   private static final int i = 1056;
   public static final long c = c(1875066, 1875066);
   public static final del d = new del(0, 0);
   ...
   public static del a(int $$0, int $$1) {
      return new del($$0 << 5, $$1 << 5);
   }

   public static del b(int $$0, int $$1) {
      return new del(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof del $$1) ? false : this.g == $$1.g && this.h == $$1.h;
      }
   }
   ...
   public static Stream<del> a(del $$0, int $$1) {
      return a(new del($$0.g - $$1, $$0.h - $$1), new del($$0.g + $$1, $$0.h + $$1));
   }

   public static Stream<del> a(final del $$0, final del $$1) {
      int $$2 = Math.abs($$0.g - $$1.g) + 1;
      int $$3 = Math.abs($$0.h - $$1.h) + 1;
      final int $$4 = $$0.g < $$1.g ? 1 : -1;
      final int $$5 = $$0.h < $$1.h ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<del>((long)($$2 * $$3), 64) {
         @Nullable
         private del e;

         @Override
         public boolean tryAdvance(Consumer<? super del> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.g;
               ...
               if ($$1 == $$1.g) {
                  ...
                  this.e = new del($$0.g, $$2 + $$5);
               } else {
                  this.e = new del($$1 + $$4, $$2);
               }
            }
