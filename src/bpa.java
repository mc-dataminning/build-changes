...
public class bpa implements bot {
   ...
   public bpa(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<bor> a() {
      Builder<bor> $$0 = ImmutableSet.builder();

      try {
         bpa.a $$1 = new bpa.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bor.a("cpu#" + $$1x, boq.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bor.a("heap MiB", boq.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bos.a.a());
      return $$0.build();
   }
   ...
   public static bor a(final LongSupplier $$0) {
      ...
      bor.d $$3 = new bor.d(2.0F);
      return bor.a("ticktime", boq.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
