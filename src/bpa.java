...
public class bpa extends bpf {
   ...
   public static bpa a(float $$0, float $$1, int $$2, int $$3) {
      return new bpa($$0, $$1, $$2, $$3);
   }

   private bpa(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(ayt $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)aym.a(aym.c($$0, $$1, $$2), $$3, $$4);
   }
