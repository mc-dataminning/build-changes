...
public class bpa implements bpb {
   ...
   private static final bpa k = new bpa();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(boz $$0) {
      URL $$1 = bpa.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, boz $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bpd a = new bpd(() -> bpa.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bpa.this.l && $$0.getState() == RecordingState.STOPPED) {
