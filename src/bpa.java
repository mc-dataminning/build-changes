...
public class bpa {
   ...
   private bpa(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bpa a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bpa($$0, $$1);
   }

   public bpa.d a() throws IOException {
      bpa.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bpa.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bpa.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bpa.c $$3 = bpa.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bpa.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bpa.a($$0, $$3);
            }
         }
   ...
   public bpa.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bpa.c> $$2 = this.a().c();
      ...
      bpa.e $$4 = new bpa.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bpa.c b) implements bpa.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bpa.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bpa.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bpa.b> {
      private final List<bpa.b> a;

      d(List<bpa.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bpa.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bpa.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bpa.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bpa.d a() {
         ListIterator<bpa.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bpa.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bpa.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bpa.b> b() {
         return this.a.stream();
      }

      public Set<bpa.c> c() {
         return this.a.stream().map(bpa.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bpa.c b) implements bpa.b {
