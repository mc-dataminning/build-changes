...
public class eyh {
   private final List<ConcurrentLinkedQueue<eyg>> a = ImmutableList.of(
   ...
   public void a(eyg $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyg> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyg> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyg> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyg> j() {
