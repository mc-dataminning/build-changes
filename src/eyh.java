...
public class eyh {
   ...
   static eyh a() {
      int[] $$0 = new int[1];
      AL10.alGenSources($$0);
      return eyl.a("Allocate new source") ? null : new eyh($$0[0]);
   }
      ...
      if (this.g != null) {
         try {
            for (int $$1 = 0; $$1 < $$0; $$1++) {
               ...
               if ($$2 != null) {
                  new eym($$2, this.g.a()).c().ifPresent($$0x -> AL10.alSourceQueueBuffers(this.d, new int[]{$$0x}));
               }
            }
   ...
   private int l() {
      ...
      if ($$0 > 0) {
         ...
         eyl.a("Unqueue buffers");
         AL10.alDeleteBuffers($$1);
         eyl.a("Remove processed buffers");
      }
