...
public class eyh extends eyk {
   ...
   static final eyh.b l = new eyh.b(854, 480);
   ...
   static enum a {
      ...
      private static final eyh.a[] e = values();
   ...
   static class b {
      ...
      static List<eyh.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyh.b($$0, $$1), eyh.l) : ImmutableList.of(eyh.l);
      }
