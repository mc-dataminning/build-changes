...
public class eyh extends eyk {
   ...
   @Nullable
   private static dti a(hh<csv> $$0, String $$1, int $$2) {
      ...
      Optional<hg.c<csv>> $$11;
      try {
         $$11 = $$0.a(aew.a(je.e, new aex($$4)));
   ...
   private static List<dti> a(hh<csv> $$0, String $$1) {
   ...
   public static dtl a(hh<csv> $$0, hh<cqt> $$1, hh<dvo> $$2, hh<dum> $$3, String $$4, dtl $$5) {
      ...
      if (!$$6.hasNext()) {
         ...
         if ($$7.isEmpty()) {
            ...
            if ($$6.hasNext()) {
               String $$10 = $$6.next();
               $$9 = Optional.ofNullable(aex.a($$10)).map($$0x -> aew.a(je.ap, $$0x)).flatMap($$1::a).orElseGet(() -> {
   ...
   static String a(dtl $$0) {
      ...
      $$1.append(";");
      $$1.append($$0.d().e().map(aew::a).orElseThrow(() -> new IllegalStateException("Biome not registered")));
      return $$1.toString();
   }
   ...
   class a extends etm<eyh.a.a> {
      public a(hu $$0, cec $$1) {
         ...
         for (hg<dtj> $$2 : $$0.d(je.av).c(apx.a)) {
