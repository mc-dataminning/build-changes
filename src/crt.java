...
public abstract class crt extends csn implements bwd {
   private static final alc<Boolean> h = alg.a(crt.class, ale.k);
   private static final alc<Boolean> i = alg.a(crt.class, ale.k);
   private static final alc<Integer> j = alg.a(crt.class, ale.b);
   ...
   @Nullable
   private bwd.a aN;
   private final Supplier<cxk> aO;

   public crt(bvq<? extends crt> $$0, dhh $$1, Supplier<cxk> $$2) {
      super($$0, $$1);
      this.aO = $$2;
      this.I = true;
   }
   ...
   public static boolean a(bvj $$0, bvj $$1) {
   ...
   public fbx a(jm.a $$0, l.a $$1) {
      return bwf.j(super.a($$0, $$1));
   }

   protected abstract double b(bvm var1);
   ...
   protected fbx a(bvj $$0, bvm $$1, float $$2) {
      ...
      return new fbx(0.0, this.b($$1), (double)$$3).b(-this.dM() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      this.aG = this.aF;
      this.aF = this.F();
      if (this.aF != crt.a.b && this.aF != crt.a.c) {
         this.o = 0.0F;
      } else {
         this.o++;
      }
      ...
      List<bvj> $$5 = this.dW().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bvo.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dW().C && !(this.cX() instanceof cpw);
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aJ) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof cpw) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   @Override
   public fbx cT() {
      return new fbx(0.0, (double)(0.88F * this.cS()), (double)(this.dr() * 0.64F));
   }

   @Override
   public void b(bvj $$0, float $$1) {
      fbx $$2 = $$0.du().d(this.du()).d().c((double)$$1 - 6.0);
      fbx $$3 = this.dz();
      boolean $$4 = $$3.b($$2) > 0.0;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dxu $$16 = this.dW().a_($$11);
                     if (!($$16.b() instanceof dtr) && fco.c($$16.g(this.dW(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, fcb.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
   ...
   private void I() {
      ...
      double $$1 = 0.0;
      this.n = 0.05F;
      if (this.aG == crt.a.e && this.aF != crt.a.e && this.aF != crt.a.d) {
         this.aD = this.e(1.0);
         ...
         if (this.aF == crt.a.a) {
            ...
            this.n = 0.9F;
         } else if (this.aF == crt.a.c) {
            $$0 = -7.0E-4;
            this.n = 0.9F;
         } else if (this.aF == crt.a.b) {
            $$1 = 0.01F;
            this.n = 0.45F;
         } else if (this.aF == crt.a.e) {
            this.n = 0.9F;
         } else if (this.aF == crt.a.d) {
            this.n = this.aE;
            if (this.cX() instanceof cpw) {
               this.aE /= 2.0F;
            }
         }
   ...
   protected void a(bvj $$0, bvj.a $$1) {
      ...
      if (!$$0.aq().a(axy.s)) {
         ...
         $$0.q($$0.cA() + this.p);
         this.c($$0);
         if ($$0 instanceof chw && this.cZ().size() == this.t()) {
            int $$2 = $$0.ar() % 2 == 0 ? 90 : 270;
            $$0.r(((chw)$$0).aX + (float)$$2);
            $$0.q($$0.cA() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public fbx b(bwf $$0) {
      fbx $$1 = a((double)(this.dr() * bae.g), (double)$$0.dr(), $$0.dM());
      ...
      if (!this.dW().z($$5)) {
         ...
         while (var14.hasNext()) {
            bwr $$9 = (bwr)var14.next();

            for (fbx $$10 : $$6) {
               if (csb.a(this.dW(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   public bti a(cpw $$0, bth $$1) {
      ...
      if ($$2 != bti.e) {
         ...
         return (bti)($$0.fY() || !(this.o < 60.0F) || !this.dW().C && !$$0.n(this) ? bti.e : bti.a);
      }
   }
   ...
   @Override
   public bwf cX() {
      return this.da() instanceof bwf $$0 ? $$0 : super.cX();
   }
   ...
   @Override
   public boolean bo() {
      return this.aF == crt.a.b || this.aF == crt.a.c;
   }

   @Override
   protected final cxk u() {
      return this.aO.get();
   }

   @Override
   public final cxo dJ() {
      return new cxo(this.aO.get());
   }
