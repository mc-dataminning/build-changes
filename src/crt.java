...
public abstract class crt extends csn implements bwd {
   ...
   protected fbx a(bvj $$0, bvm $$1, float $$2) {
      ...
      return new fbx(0.0, this.b($$1), (double)$$3).b(-this.dL() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      ...
      List<bvj> $$5 = this.dV().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bvo.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dV().C && !(this.cX() instanceof cpw);
   ...
   @Override
   public fbx cT() {
      return new fbx(0.0, (double)(0.88F * this.cS()), (double)(this.dq() * 0.64F));
   }

   @Override
   public void b(bvj $$0, float $$1) {
      fbx $$2 = $$0.dt().d(this.dt()).d().c((double)$$1 - 6.0);
      fbx $$3 = this.dy();
      boolean $$4 = $$3.b($$2) > 0.0;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dxu $$16 = this.dV().a_($$11);
                     if (!($$16.b() instanceof dtr) && fco.c($$16.g(this.dV(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, fcb.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
   ...
   @Override
   public fbx b(bwf $$0) {
      fbx $$1 = a((double)(this.dq() * bae.g), (double)$$0.dq(), $$0.dL());
   ...
   public bti a(cpw $$0, bth $$1) {
      ...
      if ($$2 != bti.e) {
         ...
         return (bti)($$0.fW() || !(this.o < 60.0F) || !this.dV().C && !$$0.n(this) ? bti.e : bti.a);
      }
   }
