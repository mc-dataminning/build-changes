...
public class bxq extends bxe {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new ehi($$0, this.g.dr() + $$5, $$1);
         }
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               ehi $$8 = new ehi(this.g.dp() - this.a.dp(), 0.0, this.g.dv() - this.a.dv()).d();
               ehi $$9 = new ehi((double)ars.a(this.a.dA() * (float) (Math.PI / 180.0)), 0.0, (double)(-ars.b(this.a.dA() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  ehi $$13 = this.a.f(1.0F);
                  ...
                  cby $$20 = new cby(this.a.dK(), this.a, $$17, $$18, $$19);
   ...
   public void a(bjb $$0) {
      ...
      int $$9 = ars.a(this.g.dr() + $$8);
      eau $$10 = new eau($$3, $$9, $$4);
