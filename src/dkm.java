...
public class dkm {
   ...
   private final dkm.a e;
   private final long f;

   public dkm(dkm.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dkm a(dkm.a $$0) {
      return new dkm($$0, this.f);
   }

   public jf<dkk> a(iv $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jf<dkk> a(double $$0, double $$1, double $$2) {
      int $$3 = jq.a(azm.a($$0));
      int $$4 = jq.a(azm.a($$1));
      int $$5 = jq.a(azm.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      jf<dkk> getNoiseBiome(int var1, int var2, int var3);
   }
}
