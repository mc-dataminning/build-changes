...
public final class dkm {
   private static final Codec<dkl> c = jb.ag.q().dispatch($$0 -> $$0.c().a(), Function.identity());
   ...
   public static Codec<? extends dkl> a(hq<Codec<? extends dkl>> $$0) {
   ...
   private static Codec<? extends dkl> a(hq<Codec<? extends dkl>> $$0, String $$1, arq<? extends dkl> $$2) {
      return hq.a($$0, $$1, $$2.a());
   }

   static <A, O> arq<O> a(Codec<A> $$0, Function<A, O> $$1, Function<O, A> $$2) {
      return arq.a($$0.fieldOf("argument").xmap($$1, $$2));
   }

   static <O> arq<O> a(Function<dkl, O> $$0, Function<O, dkl> $$1) {
      return a(dkl.d, $$0, $$1);
   }

   static <O> arq<O> a(BiFunction<dkl, dkl, O> $$0, Function<O, dkl> $$1, Function<O, dkl> $$2) {
      return arq.a(
         RecordCodecBuilder.mapCodec($$3 -> $$3.group(dkl.d.fieldOf("argument1").forGetter($$1), dkl.d.fieldOf("argument2").forGetter($$2)).apply($$3, $$0))
      );
   }

   static <O> arq<O> a(MapCodec<O> $$0) {
      return arq.a($$0);
   }
   ...
   public static dkl a(he<dzp.a> $$0, @Deprecated double $$1, double $$2, double $$3, double $$4) {
      return a(new dkm.o(new dkl.c($$0), $$1, $$2), $$3, $$4);
   }

   public static dkl a(he<dzp.a> $$0, double $$1, double $$2, double $$3) {
      return a($$0, 1.0, $$1, $$2, $$3);
   }

   public static dkl a(he<dzp.a> $$0, double $$1, double $$2) {
      return a($$0, 1.0, 1.0, $$1, $$2);
   }

   public static dkl a(dkl $$0, dkl $$1, double $$2, he<dzp.a> $$3) {
      return new dkm.v($$0, a(), $$1, $$2, 0.0, new dkl.c($$3));
   }

   public static dkl a(he<dzp.a> $$0) {
      return b($$0, 1.0, 1.0);
   }

   public static dkl b(he<dzp.a> $$0, double $$1, double $$2) {
      return new dkm.o(new dkl.c($$0), $$1, $$2);
   }

   public static dkl a(he<dzp.a> $$0, double $$1) {
      return b($$0, 1.0, $$1);
   }
   ...
   public static dkl b(he<dzp.a> $$0) {
      return new dkm.s(new dkl.c($$0));
   }

   public static dkl c(he<dzp.a> $$0) {
      return new dkm.t(new dkl.c($$0));
   }

   public static dkl d(he<dzp.a> $$0) {
   ...
   public static dkl a(dkl $$0, he<dzp.a> $$1, dkm.z.a $$2) {
   ...
   public static dkl a(ara<dkm.w.b, dkm.w.a> $$0) {
      return new dkm.w($$0);
   }
   ...
   static record aa(int e, int f, double g, double h) implements dkl.d {
      ...
      public static final arq<dkm.aa> a = dkm.a(i);

      @Override
      public double a(dkl.b $$0) {
         return arw.a((double)$$0.b(), (double)this.e, (double)this.f, this.g, this.h);
      }
   ...
   public interface c extends dkl.d {
      arq<dkl> e = arq.a(MapCodec.unit(dkm.b.a));

      @Override
      default arq<? extends dkl> c() {
         return e;
      }
   }
   ...
   protected static enum d implements dkl.d {
      ...
      public static final arq<dkl> e = arq.a(MapCodec.unit(a));
   ...
   static record e(dkl a) implements dkm.x {
      static final arq<dkm.e> e = dkm.a(dkm.e::new, dkm.e::j);
   ...
   protected static record g(dkl e, double f, double g) implements dkm.p {
      ...
      public static final arq<dkm.g> a = dkm.a(h);

      @Override
      public double a(double $$0) {
         return arw.a($$0, this.f, this.g);
      }
   ...
   static record h(double a) implements dkl.d {
      static final arq<dkm.h> e = dkm.a(dkm.d, dkm.h::new, dkm.h::j);
   ...
   protected static final class i implements dkl.d {
      public static final arq<dkm.i> a = arq.a(MapCodec.unit(new dkm.i(0L)));
      ...
      private static float a(dzs $$0, int $$1, int $$2) {
         ...
         int $$5 = $$1 % 2;
         int $$6 = $$2 % 2;
         float $$7 = 100.0F - arw.c((float)($$1 * $$1 + $$2 * $$2)) * 8.0F;
         $$7 = arw.a($$7, -100.0F, 80.0F);
         ...
         for (int $$8 = -12; $$8 <= 12; $$8++) {
            for (int $$9 = -12; $$9 <= 12; $$9++) {
               ...
               if ($$10 * $$10 + $$11 * $$11 > 4096L && $$0.a((double)$$10, (double)$$11) < -0.9F) {
                  float $$12 = (arw.e((float)$$10) * 3439.0F + arw.e((float)$$11) * 147.0F) % 13.0F + 9.0F;
                  float $$13 = (float)($$5 - $$8 * 2);
                  float $$14 = (float)($$6 - $$9 * 2);
                  float $$15 = 100.0F - arw.c($$13 * $$13 + $$14 * $$14) * $$12;
                  $$15 = arw.a($$15, -100.0F, 80.0F);
                  $$7 = Math.max($$7, $$15);
               }
            }
         }
   ...
   @asy
   public static record j(he<dkl> a) implements dkl {
      @Override
      public double a(dkl.b $$0) {
         return this.a.a().a($$0);
      }
      ...
      @Override
      public dkl a(dkl.f $$0) {
         return $$0.apply(new dkm.j(new he.a<>(this.a.a().a($$0))));
      }
   ...
   protected static record k(dkm.k.a a, dkl e, double f, double g) implements dkm.p {
      ...
      static enum a implements asp {
         ...
         final arq<dkm.k> h = dkm.a($$0x -> dkm.k.a(this, $$0x), dkm.k::aw_);
   ...
   protected static record l(dkm.l.a a, dkl e) implements dkm.m {
      ...
      static enum a implements asp {
         ...
         final arq<dkm.m> g = dkm.a($$0x -> new dkm.l(this, $$0x), dkm.m::k);
   ...
   protected static record o(dkl.c f, @Deprecated double g, double h) implements dkl {
      ...
      public static final arq<dkm.o> e = dkm.a(a);
   ...
   static record q(dkl f, double g, double h, dkl i, dkl j) implements dkl {
      ...
      public static final arq<dkm.q> e = dkm.a(a);
   ...
   protected static record r(dkl.c a) implements dkm.u {
      static final arq<dkm.r> e = dkm.a(dkl.c.a, dkm.r::new, dkm.r::j);
   ...
   protected static record s(dkl.c a) implements dkm.u {
      static final arq<dkm.s> e = dkm.a(dkl.c.a, dkm.s::new, dkm.s::j);
   ...
   protected static record t(dkl.c a) implements dkm.u {
      static final arq<dkm.t> e = dkm.a(dkl.c.a, dkm.t::new, dkm.t::j);
   ...
   protected static record v(dkl e, dkl f, dkl g, double h, double i, dkl.c j) implements dkl {
      ...
      public static final arq<dkm.v> a = dkm.a(k);
   ...
   public static record w(ara<dkm.w.b, dkm.w.a> e) implements dkl {
      private static final Codec<ara<dkm.w.b, dkm.w.a>> f = ara.a(dkm.w.a.b);
      private static final MapCodec<dkm.w> g = f.fieldOf("spline").xmap(dkm.w::new, dkm.w::j);
      public static final arq<dkm.w> a = dkm.a(g);
      ...
      @Override
      public dkl a(dkl.f $$0) {
         return $$0.apply(new dkm.w(this.e.a((ara.d<dkm.w.a>)($$1 -> $$1.a($$0)))));
      }
      ...
      public ara<dkm.w.b, dkm.w.a> j() {
         return this.e;
      }

      public static record a(he<dkl> c) implements asv<dkm.w.b> {
         public static final Codec<dkm.w.a> b = dkl.c.xmap(dkm.w.a::new, dkm.w.a::a);

         @Override
         public String toString() {
            Optional<aev<dkl>> $$0 = this.c.e();
            if ($$0.isPresent()) {
               aev<dkl> $$1 = $$0.get();
               if ($$1 == dkz.d) {
                  return "continents";
         ...
         public dkm.w.a a(dkl.f $$0) {
            return new dkm.w.a(new he.a<>(this.c.a().a($$0)));
         }
   ...
   interface y extends dkl {
      ...
      public static enum a implements asp {
         ...
         final arq<dkm.y> e = dkm.a((BiFunction<dkl, dkl, dkm.y>)(($$0x, $$1) -> dkm.y.a(this, $$0x, $$1)), dkm.y::k, dkm.y::l);
         private final String f;
   ...
   protected static record z(dkl e, dkl.c f, dkm.z.a g) implements dkm.x {
      ...
      public static final arq<dkm.z> a = dkm.a(h);
