...
public class fxx extends fpm {
   private static final fpt c = new fpt(alz.b("recipe_book/tab"), alz.b("recipe_book/tab_selected"));
   private final fxv.a d;
   ...
   public void a(flr $$0, boolean $$1) {
      fxz.a $$2 = $$1 ? fxz.a.b : fxz.a.a;

      for (fxz $$4 : $$0.a(this.d.c())) {
         for (ddk $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(fns $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(glv::C, $$5, $$6, this.E(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
