...
public class fxx extends fxu {
   ...
   private int J;
   private final fst K = new fst(false);

   public fxx(boolean $$0, Runnable $$1) {
      super(foi.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(fro $$0) {
      $$0.a(gqc::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
