public class fxx implements fxt<djb> {
   private final gby a;
   ...
   public void a(djb $$0, float $$1, esh $$2, fvt $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.r().c(dlz.bv);
         if ($$6 > 0) {
            ie $$7 = $$0.f();
            if ($$7 != null) {
               ...
               if (!$$8.b()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = fvr.a($$0.i(), $$0.r(), $$0.aE_().a($$7));
                  this.a.a($$8, cpa.i, $$11, ggs.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
