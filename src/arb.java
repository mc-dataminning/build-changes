...
public interface arb {
   arb a = new arb() {
      ...
      @Override
      public void a(Consumer<djc> $$0) {
      }
   };

   static arb a(djc $$0, int $$1) {
      return new arb.a($$0, $$1);
   }

   static void a(arb $$0, arb $$1, Consumer<djc> $$2, Consumer<djc> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof arb.a $$4 && $$1 instanceof arb.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new djc($$10, $$11));
                     } else {
                        $$3.accept(new djc($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(djc b, int c) implements arb {
      int c() {
      ...
      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return arb.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
