...
public abstract class arb {
   ...
   static final int c = aqr.a(arc.d);
   final Long2ObjectMap<ObjectSet<arp>> d = new Long2ObjectOpenHashMap();
   private final arf e;
   private final arr f;
   final djm g;
   private final arb.a h = new arb.a(8);
   private final arb.b i = new arb.b(32);
   protected final Set<aqq> b = new ReferenceOpenHashSet();
   final art j;
   final LongSet k = new LongOpenHashSet();
   final Executor l;
   private int m = 10;

   protected arb(djm $$0, Executor $$1, Executor $$2) {
      this.g = $$0;
      this.e = new arf(this, $$0);
      this.f = new arr($$0);
      bst<Runnable> $$3 = bst.a("player ticket throttler", $$2);
      this.j = new art($$3, $$1, 4);
      this.l = $$2;
   }
   ...
   public boolean a(aqs $$0) {
      ...
      if (!this.b.isEmpty()) {
         ...
         if (!this.k.isEmpty()) {
            ...
            while ($$5.hasNext()) {
               long $$6 = $$5.nextLong();
               if (this.g.a($$6).stream().anyMatch($$0x -> $$0x.a() == arv.d)) {
                  aqq $$7 = $$0.a($$6);
                  if ($$7 == null) {
                     throw new IllegalStateException();
                  }

                  CompletableFuture<aqt<ebv>> $$8 = $$7.b();
   ...
   public void a(jx $$0, arp $$1) {
      dhw $$2 = $$0.r();
      long $$3 = $$2.a();
      ((ObjectSet)this.d.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
      this.h.b($$3, 0, true);
      this.i.b($$3, 0, true);
      this.g.a(new aru(arv.e, this.e()), $$2);
   }

   public void b(jx $$0, arp $$1) {
      dhw $$2 = $$0.r();
      long $$3 = $$2.a();
      ObjectSet<arp> $$4 = (ObjectSet<arp>)this.d.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
         this.d.remove($$3);
         this.h.b($$3, Integer.MAX_VALUE, false);
         this.i.b($$3, Integer.MAX_VALUE, false);
         this.g.b(new aru(arv.e, this.e()), $$2);
      }
   }

   private int e() {
      return Math.max(0, aqr.a(arc.d) - this.m);
   }

   public boolean c(long $$0) {
      return aqr.d(this.f.c($$0));
   }

   public boolean d(long $$0) {
      return aqr.e(this.f.c($$0));
   }
   ...
   class a extends aqw {
      ...
      private boolean f(long $$0) {
         ObjectSet<arp> $$1 = (ObjectSet<arp>)arb.this.d.get($$0);
   ...
   class b extends arb.a {
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            aru $$4 = new aru(arv.d, arb.c);
            if ($$3) {
               arb.this.j.a(() -> arb.this.l.execute(() -> {
                     if (this.c(this.c($$0))) {
                        arb.this.g.a($$0, $$4);
                        arb.this.k.add($$0);
                     } else {
               ...
               arb.this.j.a($$0, () -> arb.this.l.execute(() -> arb.this.g.b($$0, $$4)), true);
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  arb.this.j.onLevelChange(new dhw($$1), () -> this.h.get($$1), $$3, $$1x -> {
