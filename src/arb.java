...
class arb extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof ara && $$1 instanceof ara && $$0.equals($$1);
   }
   ...
   private static ara a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof ara) {
         return (ara)$$0;
      } else {
