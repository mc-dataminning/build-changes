...
public class arb {
   ...
   public static final Codec<ti> b = a(ti.a::a, ti.a::c);
   public static final Codec<ti> c = Codec.STRING.flatXmap($$0 -> {
      try {
         return DataResult.success(ti.a.a($$0));
   ...
   public static final Codec<arb.f> o = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aeu.b($$0.substring(1)).map($$0x -> new arb.f($$0x, true)) : aeu.b($$0).map($$0x -> new arb.f($$0x, false)), arb.f::c
      );
   ...
   public static Codec<String> w = a(
      Codec.STRING, $$0 -> !aeu.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> arb.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new arb.b<>($$0, $$1);
   }

   public static <K, V> arb.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new arb.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof arb.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(aeu a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
