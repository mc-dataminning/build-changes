...
public class xh implements ve<wx> {
   ...
   public static xh b(bgu $$0) {
      return new xh($$0.i(), new xh.f($$0.k()));
   }

   public static xh c(bgu $$0) {
      return new xh($$0.i(), new xh.e($$0.j()));
   }

   public static xh d(bgu $$0) {
      return new xh($$0.i(), new xh.h($$0.l(), $$0.m()));
   }

   public static xh e(bgu $$0) {
   ...
   static class a implements xh.c {
      ...
      private final bgu.a c;
      private final bgu.b d;
      ...
      private a(so $$0) {
         this.a = $$0.m();
         this.b = $$0.readFloat();
         this.c = $$0.b(bgu.a.class);
         this.d = $$0.b(bgu.b.class);
   ...
   public interface b {
      default void a(UUID $$0, tl $$1, float $$2, bgu.a $$3, bgu.b $$4, boolean $$5, boolean $$6, boolean $$7) {
      }
      ...
      default void a(UUID $$0, bgu.a $$1, bgu.b $$2) {
      }
   ...
   static class h implements xh.c {
      private final bgu.a a;
      private final bgu.b b;
      ...
      private h(so $$0) {
         this.a = $$0.b(bgu.a.class);
         this.b = $$0.b(bgu.b.class);
      }
