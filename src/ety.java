...
public class ety {
   ...
   public Optional<ji> a(ji $$0, boolean $$1, dyo $$2) {
      cgm $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cgq.r), $$0, $$4, cgm.b.c)
         .map(cgn::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dxo.K))
   ...
   public Optional<l.a> a(ji $$0, jn.a $$1) {
      ...
      for (ji.a $$11 : ji.a($$0, 16, jn.f, jn.d)) {
         int $$12 = Math.min($$8, this.n.a(ect.a.e, $$11.u(), $$11.w()));
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, djp.cv.m(), 3);
            }
         }
      }

      dwy $$26 = djp.eq.m().b(dou.b, $$1);
