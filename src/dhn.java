...
public class dhn {
   ...
   private final dhn.a e;
   private final long f;

   public dhn(dhn.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dhn a(dhn.a $$0) {
      return new dhn($$0, this.f);
   }

   public jr<dhl> a(ji $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jr<dhl> a(double $$0, double $$1, double $$2) {
      int $$3 = kc.a(ayz.a($$0));
      int $$4 = kc.a(ayz.a($$1));
      int $$5 = kc.a(ayz.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      jr<dhl> getNoiseBiome(int var1, int var2, int var3);
   }
}
