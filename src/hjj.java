...
public class hjj {
   ...
   public static CompletableFuture<alg> a(alg $$0, Path $$1, String $$2, boolean $$3) {
      return CompletableFuture.<fiz>supplyAsync(() -> {
         fiz $$3x;
         try {
            $$3x = a($$1, $$2);
   ...
   private static fiz a(Path $$0, String $$1) throws IOException {
      if (Files.isRegularFile($$0)) {
         ...
         fiz $$7;
         try {
            $$3 = (HttpURLConnection)$$4.toURL().openConnection(fpt.Q().Z());
            $$3.setDoInput(true);
            $$3.setDoOutput(false);
            $$3.connect();
   ...
   private static CompletableFuture<alg> a(alg $$0, fiz $$1) {
      fpt $$2 = fpt.Q();
      return CompletableFuture.supplyAsync(() -> {
         $$2.aa().a($$0, new hjd($$0::toString, $$1));
         return $$0;
      }, $$2);
   }

   private static fiz a(fiz $$0, String $$1) {
      int $$2 = $$0.b();
      int $$3 = $$0.a();
      if ($$3 == 64 && ($$2 == 32 || $$2 == 64)) {
         boolean $$4 = $$2 == 32;
         if ($$4) {
            fiz $$5 = new fiz(64, 64, true);
            $$5.a($$0);
            $$0.close();
            $$0 = $$5;
            $$5.a(0, 32, 64, 32, 0);
   ...
   private static void a(fiz $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            int $$7 = $$0.a($$5, $$6);
            if (axw.a($$7) < 128) {
   ...
   private static void b(fiz $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            $$0.b($$5, $$6, axw.f($$0.a($$5, $$6)));
         }
      }
   }
}
