...
public class ezf extends eyk {
   static final aew a = new aew("gamemode_switcher/slot");
   static final aew b = new aew("gamemode_switcher/selection");
   private static final aew c = new aew("textures/gui/container/gamemode_switcher.png");
