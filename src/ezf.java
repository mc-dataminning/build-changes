...
public class ezf {
   ...
   @Nullable
   private String g;
   private static final ezf.a h = new ezf.a() {
      @Nullable
      @Override
      public eze a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ezi.a(this.d, "Get capabilities")) {
         ...
         if (ezi.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ezi.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ezi.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eze a(ezf.c $$0) {
      return ($$0 == ezf.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ezf.a {
      private final int a;
      private final Set<eze> b = Sets.newIdentityHashSet();
