...
public abstract class ezf extends eye {
   private final deh b;
   private dei c;
   ...
   public ezf(deh $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, tl.c("sign.edit"));
   }

   public ezf(deh $$0, boolean $$1, boolean $$2, tl $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
   ...
   @Override
   protected void aH_() {
      this.d(esk.a(tk.d, $$0 -> this.E()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
   ...
   protected abstract void a(erz var1, dfd var2);
   ...
   private void d(erz $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fqo.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(foi.E(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
