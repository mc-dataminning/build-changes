...
public class ezf {
   ...
   public void a(fap $$0, String $$1, fbl.a $$2, eov $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  ezf.b $$13 = new ezf.b($$1.trim(), this.f, $$3, $$2);
                  ezf.a $$14 = new ezf.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        ezf.c $$30 = new ezf.c(this.f, $$2, $$0);
                        ezf.a $$31 = new ezf.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fat(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eov $$2) throws IOException {
      ...
      File $$15 = new File(fdz.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eov d;
      private final fbl.a e;

      b(String $$0, File $$1, eov $$2, fbl.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((ezf.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !ezf.this.b && !ezf.this.d) {
            try {
               ezf.this.e = true;
               ezf.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               ezf.a.error("Error extracting archive", var3);
               ezf.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fbl.a c;
      private final fap d;

      c(File $$0, fbl.a $$1, fap $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((ezf.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !ezf.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, ezf.this.g);
                  ezf.this.c = true;
               } else {
                  ezf.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  ezf.this.d = true;
               }
            } catch (IOException var3) {
               ezf.a.error("Error copying resourcepack file: {}", var3.getMessage());
               ezf.this.d = true;
            }
         }
      }
