...
public class ezf {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.cu.d("gamemode " + ((cww)MoreObjects.firstNonNull(this.b.q.i(), cww.b)).b());
               }
   ...
   private void a(dmz $$0, ib $$1, @Nullable ta $$2) {
   ...
   private void a(ajh $$0, epr $$1, @Nullable ta $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = esu.a(ezg.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!esu.a(ezg.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (esu.a(ezg.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fhz) || ((fhz)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               ezr.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aY().a() && this.b.m.s().c()) {
            boolean $$9 = $$6 == null || !($$6.aI_() instanceof fbp $$7) || !$$7.d();
            if ($$3 != 0 && $$1 == 66 && fhf.t() && $$9) {
               boolean $$10 = this.b.m.aq().c() == ezi.a;
               this.b.m.aq().a(ezi.a(this.b.m.aq().c().a() + 1));
               this.b.m.at();
               if ($$6 instanceof fhh) {
                  ((fhh)$$6).o();
               }
         ...
         label185: {
            ...
            label144:
            if (!$$13) {
               if (this.b.y instanceof fha $$14 && !$$14.o()) {
                  break label144;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fhf.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fhf.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
