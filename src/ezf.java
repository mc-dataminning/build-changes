...
public class ezf implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ezf.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ezf(List<ezf.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ezf a(BufferedReader $$0) {
      return new ezf($$0.lines().flatMap($$0x -> ezf.a.a($$0x).stream()).toList());
   }

   public static record a(ezf.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ezf.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ezf.a(ezf.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ezf.a(ezf.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ezf.a(ezf.b.b, $$3));
      ...
      static ezf.a b(String $$0) {
         return new ezf.a(ezf.b.a, "glob:" + $$0);
      }

      static ezf.a c(String $$0) {
         return new ezf.a(ezf.b.a, "regex:" + $$0);
      }

      static ezf.a d(String $$0) {
         return new ezf.a(ezf.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ezf.b a = FileSystem::getPathMatcher;
      ezf.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
