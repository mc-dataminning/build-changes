...
public class cdf extends bii implements bjw<cdf.b> {
   private static final adz<Integer> f = aec.a(cdf.class, aeb.b);
   private static final adz<Integer> g = aec.a(cdf.class, aeb.b);
   private static final adz<Float> h = aec.a(cdf.class, aeb.d);
   private static final adz<Integer> i = aec.a(cdf.class, aeb.b);
   private static final adz<Boolean> j = aec.a(cdf.class, aeb.k);
   private static final adz<Boolean> k = aec.a(cdf.class, aeb.k);
   private static final adz<Integer> l = aec.a(cdf.class, aeb.b);
   ...
   public cdf(bim<? extends cdf> $$0, cpl $$1) {
      super($$0, $$1);
      this.I = true;
   }

   public cdf(cpl $$0, double $$1, double $$2, double $$3) {
      this(bim.k, $$0);
      this.e($$1, $$2, $$3);
      this.K = $$1;
      this.L = $$2;
   ...
   protected Vector3f a(bii $$0, bij $$1, float $$2) {
      ...
      return new Vector3f(0.0F, this.v() == cdf.b.i ? $$1.b * 0.8888889F : $$1.b / 3.0F, $$3);
   }
   ...
   public void l() {
      this.aN = this.aM;
      this.aM = this.z();
      if (this.aM != cdf.a.b && this.aM != cdf.a.c) {
         this.q = 0.0F;
      } else {
         this.q++;
      }
      ...
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dK().B && !(this.cN() instanceof cbm);

         for (bii $$7 : $$5) {
            if (!$$7.x(this)) {
               if ($$6 && this.cP().size() < this.w() && !$$7.bN() && this.a($$7) && $$7 instanceof biy && !($$7 instanceof bvl) && !($$7 instanceof cbm)) {
                  $$7.n(this);
               } else {
                  this.g($$7);
               }
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aQ) {
                  ...
                  this.o($$3.c, this.a($$0 -> $$0 instanceof cbm) ? 2.7 : 0.6, $$3.e);
               }
            }
      ...
      for (int $$8 = $$3; $$8 < $$4; $$8++) {
         ...
         for (int $$10 = $$1; $$10 < $$2; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               eac $$12 = this.dK().b_($$7);
               if ($$12.a(apq.a)) {
                  $$9 = Math.max($$9, $$12.a((cor)this.dK(), $$7));
               }
   ...
   public float p() {
      egy $$0 = this.cG();
      egy $$1 = new egy($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = arp.a($$1.a) - 1;
      int $$3 = arp.c($$1.d) + 1;
      int $$4 = arp.a($$1.b) - 1;
      int $$5 = arp.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dez $$16 = this.dK().a_($$11);
                     if (!($$16.b() instanceof dbm) && eht.c($$16.k(this.dK(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, ehh.i)) {
                        $$9 += $$16.b().h();
                        $$10++;
                     }
                  }
      ...
      for (int $$9 = $$1; $$9 < $$2; $$9++) {
         for (int $$10 = $$3; $$10 < $$4; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               eac $$12 = this.dK().b_($$8);
               if ($$12.a(apq.a)) {
                  float $$13 = (float)$$10 + $$12.a((cor)this.dK(), $$8);
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               eac $$13 = this.dK().b_($$9);
               if ($$13.a(apq.a) && $$1 < (double)((float)$$9.v() + $$13.a((cor)this.dK(), $$9))) {
                  if (!$$13.b()) {
                     return cdf.a.c;
                  }
   ...
   private void D() {
      ...
      double $$2 = 0.0;
      this.p = 0.05F;
      if (this.aN == cdf.a.e && this.aM != cdf.a.e && this.aM != cdf.a.d) {
         this.aK = this.e(1.0);
         ...
         if (this.aM == cdf.a.a) {
            ...
            this.p = 0.9F;
         } else if (this.aM == cdf.a.c) {
            $$1 = -7.0E-4;
            this.p = 0.9F;
         } else if (this.aM == cdf.a.b) {
            $$2 = 0.01F;
            this.p = 0.45F;
         } else if (this.aM == cdf.a.e) {
            this.p = 0.9F;
         } else if (this.aM == cdf.a.d) {
            this.p = this.aL;
            if (this.cN() instanceof cbm) {
               this.aL /= 2.0F;
            }
         }
   ...
   protected void a(bii $$0, bii.a $$1) {
      ...
      $$0.n($$0.co() + this.r);
      this.b($$0);
      if ($$0 instanceof buj && this.cP().size() == this.w()) {
         int $$2 = $$0.ah() % 2 == 0 ? 90 : 270;
         $$0.o(((buj)$$0).aU + (float)$$2);
         $$0.n($$0.co() + (float)$$2);
      }
   }
   ...
   @Override
   public ehd b(biy $$0) {
      ehd $$1 = a((double)(this.df() * arp.g), (double)$$0.df(), $$0.dA());
      double $$2 = this.dp() + $$1.c;
      double $$3 = this.dv() + $$1.e;
      gu $$4 = gu.a($$2, this.cG().e, $$3);
      gu $$5 = $$4.d();
      if (!this.dK().y($$5)) {
         List<ehd> $$6 = Lists.newArrayList();
         double $$7 = this.dK().i($$4);
         if (cdi.a($$7)) {
            $$6.add(new ehd($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dK().i($$5);
         if (cdi.a($$8)) {
            $$6.add(new ehd($$2, (double)$$5.v() + $$8, $$3));
         }
   ...
   public void a(cdf.b $$0) {
      this.an.b(i, $$0.ordinal());
   }

   public cdf.b v() {
      return cdf.b.a(this.an.b(i));
   }
   ...
   @Override
   public boolean bc() {
      return this.aM == cdf.a.b || this.aM == cdf.a.c;
   }

   @Override
   public cix dx() {
      return new cix(this.j());
   }
   ...
   public static enum b implements ash {
      ...
      private final csl l;
      public static final ash.a<cdf.b> j = ash.a(cdf.b::values);
      private static final IntFunction<cdf.b> m = aqk.a(Enum::ordinal, values(), aqk.a.a);

      private b(csl $$0, String $$1) {
         this.k = $$1;
         this.l = $$0;
      }
      ...
      public static cdf.b a(int $$0) {
         return m.apply($$0);
      }

      public static cdf.b a(String $$0) {
         return j.a($$0, a);
      }
   }
}
