...
public class ffn {
   ...
   public static void a(File $$0, eyi $$1, Consumer<xo> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eyi $$2, Consumer<xo> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eyi $$2, Consumer<xo> $$3) {
      eyx $$4 = a($$2);
      ...
      ac.h().execute(() -> {
         try {
            $$4.a($$6);
            xo $$3x = xo.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new xm(xm.a.b, $$6.getAbsolutePath())));
            $$3.accept(xo.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(xo.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eyx a(eyi $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eyx $$3 = new eyx($$1, $$2, false);
   ...
   public ffn(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
