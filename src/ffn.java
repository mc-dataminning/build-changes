...
public class ffn {
   ...
   public static final ffn.a bv;

   public static ffn.a a(int $$0, int $$1) {
      return $$0 == -1 ? ffn.b.b.a($$1) : ffn.b.a.a($$0);
   }

   public static ffn.a a(String $$0) {
      if (ffn.a.e.containsKey($$0)) {
         return ffn.a.e.get($$0);
      } else {
         for (ffn.b $$1 : ffn.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ffn.b b;
      private final int c;
      private final azy<xv> d;
      static final Map<String, ffn.a> e = Maps.newHashMap();

      a(String $$0, ffn.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azy<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xv.b($$2.toUpperCase(Locale.ROOT)) : xv.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xv.b($$2) : xv.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> us.a().b($$1) ? xv.c($$1) : xv.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ffn.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xv> g;

      private static void a(ffn.b $$0, String $$1, int $$2) {
         ffn.a $$3 = new ffn.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xv> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ffn.a a(int $$0) {
         return (ffn.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
