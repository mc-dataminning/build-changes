...
public class ffn extends fda {
   ...
   private exf P;
   private exf Q;
   private exm<Boolean> R;
   private exm<dbl> S;
   private exm<Boolean> T;
   private exm<Boolean> U;
   ...
   @Override
   protected void aN_() {
      this.d(exf.a(ve.d, $$0x -> this.n()).a(this.g / 2 - 4 - 150, 210, 150, 20).a());
      this.d(exf.a(ve.e, $$0x -> this.D()).a(this.g / 2 + 4, 210, 150, 20).a());
      this.u = this.t.l();
      this.v = this.t.m();
      this.w = this.t.x();
      this.x = this.t.y();
      this.y = this.t.G();
      this.z = this.t.H();
      this.K = this.d(exf.a(vf.c("structure_block.button.save"), $$0x -> {
         if (this.t.x() == dkq.a) {
            this.a(dii.a.b);
            this.f.a(null);
         }
      }).a(this.g / 2 + 4 + 100, 185, 50, 20).a());
      this.L = this.d(exf.a(vf.c("structure_block.button.load"), $$0x -> {
         if (this.t.x() == dkq.b) {
            this.a(dii.a.c);
            this.f.a(null);
         }
      ...
      this.d(
         exm.<dkq>a($$0x -> vf.c("structure_block.mode." + $$0x.c()))
            .a(r, q)
            .a()
            .a(this.w)
      ...
      this.Q = this.d(exf.a(vf.c("structure_block.button.detect_size"), $$0x -> {
         if (this.t.x() == dkq.a) {
            this.a(dii.a.d);
            this.f.a(null);
         }
      }).a(this.g / 2 + 4 + 100, 120, 50, 20).a());
      this.R = this.d(exm.b(!this.t.y()).a().a(this.g / 2 + 4 + 100, 160, 50, 20, m, ($$0x, $$1x) -> this.t.a(!$$1x)));
      this.S = this.d(exm.<dbl>a(dbl::b).a(dbl.values()).a().a(this.u).a(this.g / 2 - 20, 185, 40, 20, vf.b("MIRROR"), ($$0x, $$1x) -> this.t.a($$1x)));
      this.T = this.d(exm.b(this.t.G()).a().a(this.g / 2 + 4 + 100, 80, 50, 20, o, ($$0x, $$1x) -> this.t.d($$1x)));
      this.U = this.d(exm.b(this.t.H()).a().a(this.g / 2 + 4 + 100, 80, 50, 20, p, ($$0x, $$1x) -> this.t.e($$1x)));
      this.M = this.d(exf.a(vf.b("0"), $$0x -> {
         this.t.a(ddb.a);
         this.E();
      }).a(this.g / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.N = this.d(exf.a(vf.b("90"), $$0x -> {
         this.t.a(ddb.b);
         this.E();
      }).a(this.g / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.O = this.d(exf.a(vf.b("180"), $$0x -> {
         this.t.a(ddb.c);
         this.E();
      }).a(this.g / 2 + 1 + 20, 185, 40, 20).a());
      this.P = this.d(exf.a(vf.b("270"), $$0x -> {
         this.t.a(ddb.d);
         this.E();
      }).a(this.g / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.A = new exo(this.i, this.g / 2 - 152, 40, 300, 20, vf.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !ffn.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.A.f(128);
      this.A.a(this.t.d());
      this.e(this.A);
      hx $$0 = this.t.g();
      this.B = new exo(this.i, this.g / 2 - 152, 80, 80, 20, vf.c("structure_block.position.x"));
      this.B.f(15);
      this.B.a(Integer.toString($$0.u()));
      this.e(this.B);
      this.C = new exo(this.i, this.g / 2 - 72, 80, 80, 20, vf.c("structure_block.position.y"));
      this.C.f(15);
      this.C.a(Integer.toString($$0.v()));
      this.e(this.C);
      this.D = new exo(this.i, this.g / 2 + 8, 80, 80, 20, vf.c("structure_block.position.z"));
      this.D.f(15);
      this.D.a(Integer.toString($$0.w()));
      this.e(this.D);
      jb $$1 = this.t.k();
      this.E = new exo(this.i, this.g / 2 - 152, 120, 80, 20, vf.c("structure_block.size.x"));
      this.E.f(15);
      this.E.a(Integer.toString($$1.u()));
      this.e(this.E);
      this.F = new exo(this.i, this.g / 2 - 72, 120, 80, 20, vf.c("structure_block.size.y"));
      this.F.f(15);
      this.F.a(Integer.toString($$1.v()));
      this.e(this.F);
      this.G = new exo(this.i, this.g / 2 + 8, 120, 80, 20, vf.c("structure_block.size.z"));
      this.G.f(15);
      this.G.a(Integer.toString($$1.w()));
      this.e(this.G);
      this.H = new exo(this.i, this.g / 2 - 152, 120, 80, 20, vf.c("structure_block.integrity.integrity"));
      this.H.f(15);
      this.H.a(this.V.format((double)this.t.z()));
      this.e(this.H);
      this.I = new exo(this.i, this.g / 2 - 72, 120, 80, 20, vf.c("structure_block.integrity.seed"));
      this.I.f(31);
      this.I.a(Long.toString(this.t.A()));
      this.e(this.I);
      this.J = new exo(this.i, this.g / 2 - 152, 120, 240, 20, vf.c("structure_block.custom_data"));
      this.J.f(128);
      this.J.a(this.t.w());
      this.e(this.J);
      this.E();
