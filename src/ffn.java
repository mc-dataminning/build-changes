...
public class ffn extends fea<cka> {
   ...
   private void b(ewu $$0, int $$1, int $$2, int $$3) {
      List<cqe<cqw>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.I()) {
         ...
         this.M = auo.a(this.M - $$5, 0.0F, 1.0F);
