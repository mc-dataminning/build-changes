...
public class ffn extends auu<Map<String, List<ffn.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ffn.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ffn.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ffn.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ffn.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ffn.a::d)
                  )
                  .apply($$0, ffn.a::new)
         )
         .listOf()
   ...
   public ffn(alf $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ffn.a>> a(aup $$0, bnk $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ffn.a>> $$0, aup $$1, bnk $$2) {
      List<ffn.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ffn.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ffn.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ffn.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ffn.b a(List<ffn.a> $$0, long $$1) {
         this.cancel();
         return new ffn.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ffn.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fjo.a(ffh.Q().ax(), fjo.a.f, xp.a($$2.c, $$3), xp.a($$2.d, $$3)));
                  return;
               }
            }
         }
