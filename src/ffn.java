...
public class ffn extends ffc implements fgh {
   private static final fgr d = new fgr(new akh("widget/text_field"), new akh("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axl> D = ($$0x, $$1x) -> axl.forward($$0x, xr.a);
   @Nullable
   private wu E;
   private long F = ac.b();

   public ffn(fep $$0, int $$1, int $$2, wu $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public ffn(fep $$0, int $$1, int $$2, int $$3, int $$4, wu $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public ffn(fep $$0, int $$1, int $$2, int $$3, int $$4, @Nullable ffn $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axl> $$0) {
      this.D = $$0;
   }
   ...
   public void e(int $$0) {
      this.w = axz.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = axz.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fld.s());
   }
   ...
   public void b(fer $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = axz.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gbw.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = axz.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = axz.a(this.v, 0, this.p.length());
      }
   }
