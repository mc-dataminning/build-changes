...
public class gwv extends gxn<cnz, hda, ggh> {
   ...
   private static final gqk k = gqk.g(j);

   public gwv(gwh.a $$0) {
      this($$0, 0.5F, gjb.bj);
   }

   protected gwv(gwh.a $$0, float $$1, gja $$2) {
      super($$0, new ggh($$0.a($$2)), $$1);
   }

   public boolean a(cnz $$0, gtt $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.x()) {
            bxe $$5 = $$0.gr();
            if ($$5 != null) {
               feq $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               feq $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new fel($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private feq a(bxe $$0, double $$1, float $$2) {
   ...
   public void a(hda $$0, fjj $$1, gqa $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      feq $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fjj $$0, fjn $$1, feq $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fjn $$0, fjj.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hin.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cnz $$0, hda $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.n($$2);
   ...
   @Nullable
   private static bwf a(cnz $$0) {
      bwf $$1 = foz.Q().ao();
      return (bwf)($$0.x() ? $$0.gr() : $$1);
   }
}
