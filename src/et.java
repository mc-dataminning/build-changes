...
public class et<T> implements ArgumentType<et.c<T>> {
   ...
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> ti.a("argument.resource_tag.not_found", $$0, $$1));
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> ti.a("argument.resource_tag.invalid_type", $$0, $$1, $$2)
   );
   private final hi<T> d;
   final aet<? extends ht<T>> e;

   public et(dn $$0, aet<? extends ht<T>> $$1) {
      this.e = $$1;
      this.d = $$0.a($$1);
   }

   public static <T> et<T> a(dn $$0, aet<? extends ht<T>> $$1) {
      return new et<>($$0, $$1);
   }

   public static <T> et.c<T> a(CommandContext<dt> $$0, String $$1, aet<ht<T>> $$2) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      dw.a(this.d.e().map(aqd::b), $$1, "#");
      return dw.a(this.d.c().map(aet::a), $$1);
   }
   ...
   public static class a<T> implements gi<et<T>, et.a<T>.a> {
      public void a(et.a<T>.a $$0, sl $$1) {
         $$1.b($$0.b);
      }

      public et.a<T>.a a(sl $$0) {
   ...
   static record b<T>(hg.c<T> a) implements et.c<T> {
      ...
      @Override
      public <E> Optional<et.c<E>> a(aet<? extends ht<E>> $$0) {
   ...
   public interface c<T> extends Predicate<hg<T>> {
      ...
      <E> Optional<et.c<E>> a(aet<? extends ht<E>> var1);
