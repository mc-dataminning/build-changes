...
public class et implements ev<et>, ey {
   ...
   public et(es $$0, eys $$1, eyr $$2, arh $$3, int $$4, String $$5, xd $$6, MinecraftServer $$7, @Nullable bto $$8) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8, false, eq.a, ff.a.a, er.a, bab.immediate($$7));
   }
   ...
   public et b(eys $$0) {
      ...
      float $$6 = azd.g((float)(-(azd.d($$3, $$5) * 180.0F / (float)Math.PI)));
      float $$7 = azd.g((float)(azd.d($$4, $$2) * 180.0F / (float)Math.PI) - 90.0F);
      return this.a(new eyr($$6, $$7));
   }

   public et a(er $$0, bab $$1) {
   ...
   public bto g() throws CommandSyntaxException {
      if (this.k == null) {
         throw b.create();
      } else {
         return this.k;
   ...
   public ari h() throws CommandSyntaxException {
      bto var2 = this.k;
      if (var2 instanceof ari) {
         return (ari)var2;
      } else {
         throw a.create();
      }
   ...
   @Nullable
   public ari i() {
      return this.k instanceof ari $$0 ? $$0 : null;
   }

   public boolean j() {
      return this.k instanceof ari;
   }
   ...
   private void c(xd $$0) {
      ...
      if (this.i.aL().b(dec.p)) {
         for (ari $$2 : this.i.ag().t()) {
      ...
      if (this.c != this.i && this.i.aL().b(dec.m)) {
         this.i.a($$1);
      }
   }
