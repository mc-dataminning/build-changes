...
public class ggd {
   ...
   public gfw a(Vector3f $$0, Vector3f $$1, gfy $$2, gql $$3, ji $$4, gsv $$5, @Nullable gfz $$6, boolean $$7) {
      gga $$8 = $$2.d();
      if ($$5.c()) {
         $$8 = a($$2.d(), $$4, $$5.b());
      }
      ...
      return new gfw($$13, $$2.b(), $$14, $$3, $$7);
   }

   public static gga a(gga $$0, ji $$1, j $$2) {
      ...
      return new gga(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gga $$0, gql $$1, ji $$2, float[] $$3, j $$4, @Nullable gfz $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ji $$2, gga $$3, float[] $$4, gql $$5, j $$6, @Nullable gfz $$7, boolean $$8) {
      geq.b $$9 = geq.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gql $$3, gga $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gfz $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
