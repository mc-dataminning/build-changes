...
public class ggd {
   ...
   private ggd(int $$0, List<ggf> $$1) {
      this.a = $$1.toArray(ggf[]::new);
      this.b = $$1.size();
   }

   private List<ggf> c() {
      List<ggf> $$0 = new ArrayList<>(this.d());
