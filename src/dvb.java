...
public class dvb implements dwa<bsp> {
   ...
   public dvb(dvl $$0, arb $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = bpi.a($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<dvv<bsp>> a(dba $$0) {
      return this.f.contains($$0.a()) ? CompletableFuture.completedFuture(b($$0)) : this.e.a($$0).thenApplyAsync($$1 -> {
         if ($$1.isEmpty()) {
            ...
            List<bsp> $$6 = bsv.a($$5, this.d).collect(ImmutableList.toImmutableList());
            return new dvv<>($$0, $$6);
         }
      }, this.g::a);
   }

   private static dba a(ur $$0) {
      int[] $$1 = $$0.n("Position");
      return new dba($$1[0], $$1[1]);
   }

   private static void a(ur $$0, dba $$1) {
      $$0.a("Position", new uv(new int[]{$$1.e, $$1.f}));
   }

   private static dvv<bsp> b(dba $$0) {
      return new dvv<>($$0, ImmutableList.of());
   }

   @Override
   public void a(dvv<bsp> $$0) {
      dba $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
            this.e.a($$1, null);
