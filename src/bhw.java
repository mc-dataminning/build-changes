...
public abstract class bhw extends DataFix {
   private final String a;

   public bhw(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bhk.z.typeName(), biw.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhk.z), $$2)) {
