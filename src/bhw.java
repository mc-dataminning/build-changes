...
public class bhw extends bgq {
   public bhw(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bhu.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bji.a($$0.get("id").asString("minecraft:air"));
