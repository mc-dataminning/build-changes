      ...
      euv.a a(ejj $$0) {
         if (this.e != null && this.f != null) {
            ...
            if ($$2 > this.c || $$3 > this.d) {
               ...
               int $$5 = this.d - $$3;
               if ($$4 > $$5) {
                  this.e = new euv.a(this.a, this.b, $$2, this.d);
                  this.f = new euv.a(this.a + $$2 + 1, this.b, this.c - $$2 - 1, this.d);
               } else {
                  this.e = new euv.a(this.a, this.b, this.c, $$3);
                  this.f = new euv.a(this.a, this.b + $$3 + 1, this.c, this.d - $$3 - 1);
               }
