...
public class euv extends euk implements evp {
   private static final evz d = new evz(new agg("widget/text_field"), new agg("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, asu> D = ($$0x, $$1x) -> asu.forward($$0x, vo.a);
   @Nullable
   private ur E;
   private long F = ac.b();

   public euv(etz $$0, int $$1, int $$2, ur $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public euv(etz $$0, int $$1, int $$2, int $$3, int $$4, ur $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public euv(etz $$0, int $$1, int $$2, int $$3, int $$4, @Nullable euv $$5, ur $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, asu> $$0) {
      this.D = $$0;
   }
   ...
   public void k(int $$0) {
      this.w = ati.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ati.a($$0) - this.p();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fah.q());
   }
   ...
   public void b(eub $$0, int $$1, int $$2, float $$3) {
      if (this.u()) {
         ...
         int $$12 = $$10;
         int $$13 = ati.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fqp.C(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = ati.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ati.a(this.v, 0, this.p.length());
      }
   }
