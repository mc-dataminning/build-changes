...
public class euv implements efg.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<euv> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azd<euv> a = azd.a(f);
   private final euz g;
   private final euz h;
   private final euz i;
   ...
   public static euv a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new euv(new ego(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private euv(euz $$0, euz $$1, euz $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public euv(azt $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         euz.a($$0, IntStream.rangeClosed(-15, 0)),
         euz.a($$0, IntStream.rangeClosed(-15, 0)),
         euz.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public euv a(azt $$0) {
      return new euv($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(efg.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         euw $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(euz.b($$4 * $$13), euz.b($$5 * $$13), euz.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = euz.b($$1 * $$13);
         double $$21 = euz.b($$2 * $$13);
         double $$22 = euz.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            euw $$24 = this.g.a($$19);
            if ($$24 != null) {
