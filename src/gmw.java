public class gmw extends goi {
   static final azv a = azv.a();
   private final god b;

   gmw(gjz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, god $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.b = $$7;
   ...
   public static class a implements gnl<mb> {
      ...
      public gni a(mb $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gmw $$8 = new gmw($$1, $$2, $$3, $$4, 0.0, 0.0, 0.0, this.b);
         $$8.a(1.0F, 0.9F, 1.0F);
   ...
   public static class b implements gnl<mb> {
      ...
      public gni a(mb $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gmw $$8 = new gmw($$1, $$2, $$3, $$4, 0.5 - gmw.a.j(), $$6, 0.5 - gmw.a.j(), this.a);
         if ($$1.A.h()) {
            $$8.a(0.6F, 1.0F, 0.8F);
         } else {
            $$8.a(0.08F, 0.4F, 0.4F);
