...
public class gmw {
   ...
   public gmw(hgp $$0, hgq $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(hfa $$0, fgr $$1, gmx $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fgv $$6 = $$2.getBuffer(gnh.u($$0.a));
      ...
      for (hfa.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fpa.a.a, Integer.MIN_VALUE, $$4, false);
               $$1.b();
            }
   ...
   public void a(evo $$0, evq $$1, hfa $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
