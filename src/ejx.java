...
public class ejx extends ejy {
   ...
   public static final MapCodec<ejx> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ejw.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, ejx::new)
   );
   private final ejw h;

   public ejx(brn $$0, ekb $$1, Optional<ejv> $$2, ejw $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dgm $$0, BiConsumer<ji, dwv> $$1, azg $$2, ji $$3, ji $$4, eiw $$5) {
   ...
   private boolean a(dgm $$0, azg $$1, ji $$2, jn $$3, ji $$4, List<ji> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<ji> a(ji $$0, jn $$1, azg $$2, ji $$3) {
      ji $$4 = $$0.e();
      ji $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
