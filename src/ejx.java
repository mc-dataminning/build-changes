...
public class ejx {
   ...
   private static final Queue<ejx.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ejx.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ejx::a), ejv::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ejx::a), ejv::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ejx.a(this.b) + ", type=" + ejx.b(this.c) + ", severity=" + ejx.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
