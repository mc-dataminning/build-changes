...
public class wr implements vh {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = atx.a(atx.b, wr::b);
   private static final Codec<Object> e = Codec.either(d, vi.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof vg $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<wr> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               atx.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, wr::a)
   );
   public static final vh.a<wr> c = new vh.a<>(b, "translatable");
   private static final vl f = vl.e("%");
   private static final vl g = vl.e("null");
   ...
   @Nullable
   private sj k;
   private List<vl> l = ImmutableList.of();
   ...
   private static wr a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new wr($$0, $$1.orElse(null), a($$2));
   }

   public wr(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<vl> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (ws var4) {
            this.l = ImmutableList.of(vl.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<vl> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new ws(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private vl a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof vg) {
            ...
            return $$1 == null ? g : vl.e($$1.toString());
         }
      } else {
         throw new ws(this, $$0);
      }
   ...
   public vu a(@Nullable ds $$0, @Nullable blw $$1, int $$2) throws CommandSyntaxException {
      ...
      return vu.a(new wr(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof wr $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
