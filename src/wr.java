...
public class wr {
   public static <T extends wi> wr.b a(wk<T> $$0) {
      return a(new wg<T>($$0));
   }

   private static wr.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends wi> wr.d b(wk<T> $$0) {
      return a(new wh<T>($$0));
   }

   private static wr.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zj)) {
            $$0.fireChannelRead($$1);
         } else {
