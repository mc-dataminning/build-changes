...
public class ecv implements edc.c {
   ...
   private final ObjectListIterator<ecv.a> h;
   private final ObjectListIterator<epf> i;

   public static ecv a(dhw $$0, dgg $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<ecv.a> $$4 = new ObjectArrayList(10);
      ObjectList<epf> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eon.a).forEach($$5x -> {
         eon $$6 = $$5x.h().d();
         ...
         for (eog $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eny) {
                  ...
                  $$4.add(new ecv.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new ecv($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public ecv(ObjectListIterator<ecv.a> $$0, ObjectListIterator<epf> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(enu a, eon b, int c) {
   }
}
