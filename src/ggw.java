...
public class ggw implements ggn {
   ...
   public ggw(List<Pair<Predicate<djh>, ggn>> $$0) {
      this.g = $$0;
      ggn $$1 = (ggn)$$0.iterator().next().getRight();
      this.a = $$1.a();
      this.b = $$1.b();
      this.c = $$1.c();
      this.d = $$1.e();
      ...
      if ($$0 == null) {
         ...
         if ($$3 == null) {
            ...
            for (int $$4 = 0; $$4 < this.g.size(); $$4++) {
               Pair<Predicate<djh>, ggn> $$5 = this.g.get($$4);
         ...
         List<fue> $$6 = Lists.newArrayList();
         long $$7 = $$2.g();

         for (int $$8 = 0; $$8 < $$3.length(); $$8++) {
            if ($$3.get($$8)) {
               $$6.addAll(((ggn)this.g.get($$8).getRight()).a($$0, $$1, auv.a($$7)));
            }
         }
   ...
   public static class a {
      ...
      public void a(Predicate<djh> $$0, ggn $$1) {
