...
public class akc {
   ...
   static final axs c = new axs();
   private final akb d;
   private final akc.b<?>[] e;
   private boolean f;
   ...
   public static <T> ajy<T> a(Class<? extends akb> $$0, ajz<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> akc.b<T> b(ajy<T> $$0) {
      return (akc.b<T>)this.e[$$0.a()];
   }

   public <T> T a(ajy<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(ajy<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(ajy<T> $$0, T $$1, boolean $$2) {
      akc.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(akc.b<T> $$0, akc.c<?> $$1) {
   ...
   public static class a {
      private final akb a;
      private final akc.b<?>[] b;

      public a(akb $$0) {
         this.a = $$0;
         this.b = new akc.b[akc.c.b($$0.getClass())];
      }

      public <T> akc.a a(ajy<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public akc.c<T> e() {
         return akc.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, ajz<T> b, T c) {

      public static <T> akc.c<T> a(ajy<T> $$0, T $$1) {
         ajz<T> $$2 = $$0.b();
         return new akc.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static akc.c<?> a(wa $$0, int $$1) {
         int $$2 = $$0.l();
         ajz<?> $$3 = aka.a($$2);
         if ($$3 == null) {
      ...
      private static <T> akc.c<T> a(wa $$0, int $$1, ajz<T> $$2) {
         return new akc.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
