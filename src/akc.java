...
public class akc {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ur.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ur.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> ur.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(du $$0, ejt $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bkq> $$6) throws CommandSyntaxException {
      ame $$7 = $$0.f();
      int $$8 = $$7.I_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         akc.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> ur.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bkq> $$0) {
      Set<ekv> $$1 = Sets.newHashSet();
   ...
   private static void a(ejt $$0, double $$1, ame $$2, ats $$3, double $$4, double $$5, double $$6, double $$7, int $$8, akc.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bkq> $$0, ame $$1, akc.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ekv, akc.a> $$7 = Maps.newHashMap();

      for (bkq $$8 : $$0) {
         akc.a $$10;
         if ($$4) {
            ekv $$9 = $$8 instanceof cdu ? $$8.cg() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)atm.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)atm.a($$10.b) + 0.5, Set.of(), $$8.dD(), $$8.dF());
   ...
   private static akc.a[] a(ats $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      akc.a[] $$6 = new akc.a[$$1];
   ...
   static class a {
      ...
      public int a(crg $$0, int $$1) {
         ht.a $$2 = new ht.a(this.a, (double)($$1 + 1), this.b);
         boolean $$3 = $$0.a_($$2).i();
         $$2.c(hx.a);
         boolean $$4 = $$0.a_($$2).i();
      ...
      public boolean b(crg $$0, int $$1) {
         ht $$2 = ht.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dhi $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(arg.aJ);
      }

      public void a(ats $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = atm.a($$0, $$1, $$3);
         this.b = atm.a($$0, $$2, $$4);
      }
   }
