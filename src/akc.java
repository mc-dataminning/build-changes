...
public class akc implements ajy.c, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final Map<bfq<?>, akb<? extends Function<bfq<asx>, ?>>> b;
   private final Set<bfq<?>> c;
   private final bfr<bft.b> d;

   public akc(List<bfq<?>> $$0, Executor $$1, int $$2) {
      this.b = $$0.stream().collect(Collectors.toMap(Function.identity(), $$1x -> new akb<>($$1x.bn() + "_queue", $$2)));
      this.c = Sets.newHashSet($$0);
      this.d = new bfr<>(new bft.a(4), $$1, "sorter");
   }

   public boolean a() {
      return this.d.c() || this.b.values().stream().anyMatch(akb::b);
   }

   public static <T> akc.a<T> a(Function<bfq<asx>, T> $$0, long $$1, IntSupplier $$2) {
      return new akc.a<>($$0, $$1, $$2);
   }

   public static akc.a<Runnable> a(Runnable $$0, long $$1, IntSupplier $$2) {
      return new akc.a<>($$1x -> () -> {
            $$0.run();
            $$1x.a(asx.a);
         }, $$1, $$2);
   ...
   public static akc.a<Runnable> a(ajy $$0, Runnable $$1) {
      return a($$1, $$0.l().a(), $$0::n);
   }

   public static <T> akc.a<T> a(ajy $$0, Function<bfq<asx>, T> $$1) {
      return a($$1, $$0.l().a(), $$0::n);
   }

   public static akc.b a(Runnable $$0, long $$1, boolean $$2) {
      return new akc.b($$0, $$1, $$2);
   }

   public <T> bfq<akc.a<T>> a(bfq<T> $$0, boolean $$1) {
      return this.d.<bfq<akc.a<T>>>b($$2 -> new bft.b(0, () -> {
            this.b($$0);
            $$2.a(bfq.a("chunk priority sorter around " + $$0.bn(), $$2xx -> this.a($$0, $$2xx.a, $$2xx.b, $$2xx.c, $$1)));
         })).join();
   }

   public bfq<akc.b> a(bfq<Runnable> $$0) {
      return this.d
         .<bfq<akc.b>>b($$1 -> new bft.b(0, () -> $$1.a(bfq.a("chunk priority sorter around " + $$0.bn(), $$1xx -> this.a($$0, $$1xx.b, $$1xx.a, $$1xx.c)))))
         .join();
   }
   ...
   private <T> void a(bfq<T> $$0, long $$1, Runnable $$2, boolean $$3) {
      this.d.a(new bft.b(1, () -> {
         akb<Function<bfq<asx>, T>> $$4 = this.b($$0);
         $$4.a($$1, $$3);
         if (this.c.remove($$0)) {
            this.a($$4, $$0);
         }
   ...
   private <T> void a(bfq<T> $$0, Function<bfq<asx>, T> $$1, long $$2, IntSupplier $$3, boolean $$4) {
      this.d.a(new bft.b(2, () -> {
         akb<Function<bfq<asx>, T>> $$5 = this.b($$0);
         int $$6 = $$3.getAsInt();
   ...
   private <T> void a(akb<Function<bfq<asx>, T>> $$0, bfq<T> $$1) {
   ...
   private <T> akb<Function<bfq<asx>, T>> b(bfq<T> $$0) {
      akb<? extends Function<bfq<asx>, ?>> $$1 = this.b.get($$0);
      if ($$1 == null) {
         throw (IllegalArgumentException)ac.b(new IllegalArgumentException("No queue for: " + $$0));
      } else {
         return (akb<Function<bfq<asx>, T>>)$$1;
      }
   }
