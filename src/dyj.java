...
public class dyj extends dyo {
   public static final Codec<dyj> a = dxx.a.fieldOf("provider").xmap(dyj::new, $$0 -> $$0.b).codec();
   private final dxx b;
