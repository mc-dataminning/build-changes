...
public class fxt implements AutoCloseable {
   private static final String a = "minecraft:main";
   private final esl b;
   private final aso c;
   private final String d;
   private final List<fxu> e = Lists.newArrayList();
   private final Map<String, esl> f = Maps.newHashMap();
   private final List<esl> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public fxt(gja $$0, aso $$1, esl $$2, ajh $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gja $$0, ajh $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(gja $$0, JsonElement $$1) throws IOException {
   ...
   private void b(JsonElement $$0) throws ajk {
      ...
      String $$2 = awm.i($$1, "name");
      etq $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
   ...
   public esl a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      esl $$3 = new esm($$1, $$2, true, ezg.a);
   ...
   public fxu a(String $$0, esl $$1, esl $$2) throws IOException {
      fxu $$3 = new fxu(this.c, $$0, $$1, $$2);
   ...
   @Nullable
   private esl b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
