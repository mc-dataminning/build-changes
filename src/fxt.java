...
public class fxt extends dbw {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dwg e = new dwg();
   private final dwm<bss> f = new dwm<>(bss.class, new fxt.b());
   private final fxu D;
   private final gdk E;
   private final fxt.a F;
   private final gdb G;
   private final brd H;
   private final ffd I = ffd.Q();
   final List<gcl> J = Lists.newArrayList();
   private final Map<epg, epi> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<dbh, fgh> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gcy.a, new fgh($$0xx -> this.b($$0xx, gcy.a)));
      $$0x.put(gcy.b, new fgh($$0xx -> this.b($$0xx, gcy.b)));
      $$0x.put(gcy.c, new fgh($$0xx -> this.b($$0xx, gcy.c)));
   });
   private final fxp O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final fzf R = new fzf();
   private static final Set<cui> S = Set.of(cuq.hB, cuq.hC);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(iz $$0, dsa $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(iz $$0, dsa $$1, evp $$2) {
      dsa $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cmv $$4 = this.I.s;
   ...
   public fxt(fxu $$0, fxt.a $$1, ald<dbw> $$2, ji<dvs> $$3, int $$4, int $$5, Supplier<bng> $$6, gdk $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.v(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fxp(this, $$4);
      this.H = new brd();
      this.F = $$1;
      this.E = $$7;
      this.G = gdb.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.ab().a(dbs.l).a(false, null);
      } else {
         this.ab().a(dbs.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<bss> e() {
      return this.G().a();
   }
   ...
   @Override
   public void Y() {
      this.D.k().a(xo.c("multiplayer.status.quitting"));
   }
   ...
   private dex p() {
      if (this.I.q.j() == dbt.b) {
         cun $$0 = this.I.s.eX();
         cui $$1 = $$0.g();
         if (S.contains($$1) && $$1 instanceof csl $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azf $$4, @Nullable dex $$5, iz.a $$6) {
   ...
   private void a(iz $$0, dsa $$1, lg $$2, boolean $$3) {
      if ($$1.u().c()) {
         ewi $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(je.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(iz $$0, lg $$1, ewi $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, lg $$5) {
      this.a($$5, ayx.d(this.z.j(), $$0, $$1), $$4, ayx.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable cmv $$0, bss $$1, ji<avy> $$2, awa $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.aj().a((gsl)(new gsc($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bss $$0, avy $$1, awa $$2, float $$3, float $$4) {
      this.I.aj().a((gsl)(new gsc($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avy $$3, awa $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      gsg $$10 = new gsg($$3, $$4, $$5, $$6, azf.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<cxg> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.I.g.a(new gak.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
      }
   }
   ...
   public ji<dcv> a(int $$0, int $$1, int $$2) {
      return this.H_().d(lq.az).g(ddc.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = ayx.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public evp a(evp $$0, float $$1) {
      float $$2 = this.f($$1);
      evp $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      dcx $$4 = this.F_();
      evp $$5 = axy.a($$3, ($$1x, $$2x, $$3x) -> evp.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = ayx.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = ayx.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new evp((double)$$7, (double)$$8, (double)$$9);
   }

   public evp h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = ayx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = ayx.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new evp((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = ayx.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(iz $$0, dbh $$1) {
      fgh $$2 = (fgh)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(iz $$0, dbh $$1) {
      int $$2 = ffd.Q().m.E().c();
      if ($$2 == 0) {
   ...
   protected Map<epg, epi> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<epg, epi> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements eqb {
      ...
      public a(bqp $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new dbs();
   ...
   final class b implements dwi<bss> {
      public void a(bss $$0) {
      }
