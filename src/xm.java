...
public class xm {
   ...
   private static <T> xm a(xm $$0, @Nullable T $$1, @Nullable T $$2) {
      return $$1 != null && $$2 == null && $$0.equals(a) ? a : $$0;
   }

   public xm a(@Nullable xo $$0) {
      return Objects.equals(this.c, $$0) ? this : a(new xm($$0, this.d, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m), this.c, $$0);
   }

   public xm a(@Nullable n $$0) {
      return this.a($$0 != null ? xo.a($$0) : null);
   }

   public xm a(int $$0) {
      return this.a(xo.a($$0));
   }

   public xm b(int $$0) {
      return a(new xm(this.c, $$0, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m), this.d, $$0);
   }

   public xm a(@Nullable Boolean $$0) {
      return Objects.equals(this.e, $$0) ? this : a(new xm(this.c, this.d, $$0, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m), this.e, $$0);
   }

   public xm b(@Nullable Boolean $$0) {
      return Objects.equals(this.f, $$0) ? this : a(new xm(this.c, this.d, this.e, $$0, this.g, this.h, this.i, this.j, this.k, this.l, this.m), this.f, $$0);
   }

   public xm c(@Nullable Boolean $$0) {
      return Objects.equals(this.g, $$0) ? this : a(new xm(this.c, this.d, this.e, this.f, $$0, this.h, this.i, this.j, this.k, this.l, this.m), this.g, $$0);
   }

   public xm d(@Nullable Boolean $$0) {
      return Objects.equals(this.h, $$0) ? this : a(new xm(this.c, this.d, this.e, this.f, this.g, $$0, this.i, this.j, this.k, this.l, this.m), this.h, $$0);
   }

   public xm e(@Nullable Boolean $$0) {
      return Objects.equals(this.i, $$0) ? this : a(new xm(this.c, this.d, this.e, this.f, this.g, this.h, $$0, this.j, this.k, this.l, this.m), this.i, $$0);
   }

   public xm a(@Nullable wn $$0) {
      return Objects.equals(this.j, $$0) ? this : a(new xm(this.c, this.d, this.e, this.f, this.g, this.h, this.i, $$0, this.k, this.l, this.m), this.j, $$0);
   }

   public xm a(@Nullable wv $$0) {
      return Objects.equals(this.k, $$0) ? this : a(new xm(this.c, this.d, this.e, this.f, this.g, this.h, this.i, this.j, $$0, this.l, this.m), this.k, $$0);
   }

   public xm a(@Nullable String $$0) {
   ...
   public xm b(n $$0) {
      ...
      return new xm($$1, this.d, $$2, $$3, $$5, $$4, $$6, this.j, this.k, this.l, this.m);
   }
   ...
   public static class b {
      public static final MapCodec<xm> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  xo.a.optionalFieldOf("color").forGetter($$0x -> Optional.ofNullable($$0x.c)),
