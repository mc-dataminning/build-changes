...
public class bmp implements bmq {
   ...
   private static final bmp k = new bmp();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bmo $$0) {
      URL $$1 = bmp.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bmo $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bms a = new bms(() -> bmp.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmp.this.l && $$0.getState() == RecordingState.STOPPED) {
