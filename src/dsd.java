...
public class dsd extends dsi {
   public static final Codec<dsd> a = drr.a.fieldOf("provider").xmap(dsd::new, $$0 -> $$0.b).codec();
   private final drr b;
