...
public class dsd extends dsf {
   public static final Codec<dsd> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arq.a(Codec.INT, 1, 64).fieldOf("variety").forGetter($$0x -> $$0x.i),
               dzp.a.a.fieldOf("slow_noise").forGetter($$0x -> $$0x.j),
               arg.k.fieldOf("slow_scale").forGetter($$0x -> $$0x.k)
            )
            .and(b($$0))
            .apply($$0, dsd::new)
   );
   private final arq<Integer> i;
   private final dzp.a j;
   private final float k;
   private final dzp l;

   public dsd(arq<Integer> $$0, dzp.a $$1, float $$2, long $$3, dzp.a $$4, float $$5, List<dfj> $$6) {
      super($$3, $$4, $$5, $$6);
      this.i = $$0;
      this.j = $$1;
      this.k = $$2;
   ...
   public dfj a(asc $$0, gw $$1) {
      double $$2 = this.a($$1);
      int $$3 = (int)arx.a($$2, -1.0, 1.0, (double)this.i.a().intValue(), (double)(this.i.b() + 1));
