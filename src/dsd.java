...
public class dsd implements drn {
   public static final Codec<dsd> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dvz.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               arr.b(jz.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dto.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dto.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dnm.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dsd::new)
   );
   ...
   public dsd(ib<dvz> $$0, int $$1, int $$2, arr<cut> $$3, dto $$4, int $$5, int $$6, int $$7, int $$8, dto $$9, int $$10, int $$11, dnm $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
