...
public class ic<T extends ey<T>> {
   @VisibleForTesting
   public static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> xj.b("command.forkLimit", $$0));
   private final String b;
   private final ContextChain<T> c;

   public ic(String $$0, ContextChain<T> $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   protected void a(T $$0, List<T> $$1, hw<T> $$2, hy $$3, hr $$4) {
      ...
      if ($$5.getStage() != Stage.EXECUTE) {
         ...
         try {
            for (int $$8 = $$2.d(); $$5.getStage() != Stage.EXECUTE; $$5 = $$5.nextStage()) {
               ...
               if ($$10 instanceof hu<T> $$11) {
                  $$11.a($$0, $$7, $$5, $$6, hx.a($$2, $$3));
                  return;
               }
      ...
      if ($$7.isEmpty()) {
         ...
         if ($$17.getCommand() instanceof ht<T> $$19) {
            hx<T> $$20 = hx.a($$2, $$3);
            ...
            if ($$6.c()) {
               T $$22 = $$7.get(0);
               $$22 = $$22.b(et.chain($$22.p(), $$3.d()));
               $$7 = List.of($$22);
            }

            ig<T> $$23 = new ig<>(this.b, $$6, $$17);
            ie.a($$2, $$3, $$7, ($$1x, $$2x) -> new hs<>($$1x, $$23.bind((T)$$2x)));
         }
      }
   }

   protected void a(hw<T> $$0, hy $$1) {
      hz $$2 = $$0.b();
      if ($$2 != null) {
         $$2.a($$1.c(), this.b);
      }
   ...
   public static class a<T extends ey<T>> extends ic<T> implements hv<T> {
      ...
      public a(String $$0, ContextChain<T> $$1, hr $$2, T $$3, List<T> $$4) {
         super($$0, $$1);
         this.c = $$3;
         this.d = $$4;
         this.b = $$2;
   ...
   public static class b<T extends ey<T>> extends ic<T> implements hv<T> {
      ...
      public void execute(hw<T> $$0, hy $$1) {
         this.a($$0, $$1);
         this.a(this.b, List.of(this.b), $$0, $$1, hr.a);
      }
   }
