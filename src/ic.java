...
public enum ic implements avj {
   ...
   public static final avj.a<ic> g = avj.a(ic::values);
   public static final Codec<ic> h = atv.a(g, ic::a);
   private final int i;
   private final int j;
   private final int k;
   ...
   public static Collection<ic> a(auu $$0) {
   ...
   public static ic a(blu $$0, ic.a $$1) {
      return switch ($$1) {
   ...
   public static ic a(int $$0) {
      return q[aun.a($$0 % q.length)];
   }

   public static ic b(int $$0) {
      return r[aun.a($$0 % r.length)];
   }
   ...
   public static enum a implements avj, Predicate<ic> {
      a("x") {
         @Override
      ...
      public static final avj.a<ic.a> e = avj.a(ic.a::values);
