...
public enum ic implements ave {
   ...
   public static final ave.a<ic> g = ave.a(ic::values);
   public static final Codec<ic> h = atq.a(g, ic::a);
   private final int i;
   private final int j;
   private final int k;
   ...
   public static Collection<ic> a(aup $$0) {
   ...
   public static ic a(blp $$0, ic.a $$1) {
      return switch ($$1) {
   ...
   public static ic a(int $$0) {
      return q[aui.a($$0 % q.length)];
   }

   public static ic b(int $$0) {
      return r[aui.a($$0 % r.length)];
   }
   ...
   public static enum a implements ave, Predicate<ic> {
      a("x") {
         @Override
      ...
      public static final ave.a<ic.a> e = ave.a(ic.a::values);
