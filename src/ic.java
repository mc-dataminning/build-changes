...
public interface ic<T> {
   ...
   ie<T> a(@Nullable tx var1, CommandDispatcher<T> var2) throws et;
   ...
   static <T extends es<T>> ic<T> a(akk $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      id<T> $$4 = new id<>();
   ...
   static <T extends es<T>> ht<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hv.c<>($$2.getString(), $$4.get());
      }
   }
}
