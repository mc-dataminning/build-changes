...
public class cdo extends ccg {
   private static final cfz c = cfz.b().d();
   private final cfz d;
   ...
   private int k;
   private boolean l;
   private final Predicate<cwq> m;
   private final boolean n;

   public cdo(bvq $$0, double $$1, Predicate<cwq> $$2, boolean $$3) {
      this.a = $$0;
      this.e = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean b() {
      if (this.k > 0) {
         ...
         this.b = a(this.a).a(this.d.a(this.a.h(bwq.E)), this.a);
         return this.b != null;
      }
   }
