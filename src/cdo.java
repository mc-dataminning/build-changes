...
public abstract class cdo extends bnq {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<bnq> b = $$0 -> $$0 instanceof cdo;
   private int f;
   protected hz c;
   protected ie d;

   protected cdo(bnw<? extends cdo> $$0, cvr $$1) {
      super($$0, $$1);
      this.d = ie.d;
   }

   protected cdo(bnw<? extends cdo> $$0, cvr $$1, hz $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void z() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new enu($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable bnq var1);
