...
public class dar {
   public static final Codec<dar> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dap.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dap.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               cuk.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final zj<ww, dar> b = zj.a(dar::a, dar::a);
   private final dap c;
   private final Optional<dap> d;
   private final cuk e;
   private int f;
   private final int g;
   ...
   private dar(dap $$0, Optional<dap> $$1, cuk $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dar(dap $$0, cuk $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dar(dap $$0, Optional<dap> $$1, cuk $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dar(dap $$0, Optional<dap> $$1, cuk $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dar(dap $$0, Optional<dap> $$1, cuk $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   private int a(dap $$0) {
      int $$1 = $$0.b();
      int $$2 = Math.max(0, ayu.d((float)($$1 * this.j) * this.k));
      return ayu.a($$1 + $$2 + this.i, 1, $$0.d().j());
   }

   public cuk c() {
      return this.d.map(dap::d).orElse(cuk.l);
   }
   ...
   private static void a(ww $$0, dar $$1) {
      dap.b.encode($$0, $$1.d());
      cuk.i.encode($$0, $$1.f());
      dap.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dar a(ww $$0) {
      dap $$1 = dap.b.decode($$0);
      cuk $$2 = cuk.i.decode($$0);
      Optional<dap> $$3 = dap.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dar $$11 = new dar($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
