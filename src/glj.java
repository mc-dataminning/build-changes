public class glj extends glg {
   private final fbx a;

   glj(ggy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fbx $$7, int $$8) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   ...
   public static class a implements gkj<ly> {
      private final glb a;
      ...
      public gkg a(ly $$0, ggy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         glj $$8 = new glj($$1, $$2, $$3, $$4, $$5, $$6, $$7, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.a($$0.d());
         return $$8;
      }
