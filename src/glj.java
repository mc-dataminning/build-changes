...
public class glj implements AutoCloseable {
   ...
   public glj(glb $$0, fmg $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new ffd(16, 16, false);
      this.e.a(9729);
   ...
   private float b(float $$0) {
      bup $$1 = this.i.t.c(bur.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bwg $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(bur.p)) {
               $$10 = glb.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(bur.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            gku $$18 = Objects.requireNonNull(RenderSystem.setShader(gkv.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            fgn $$19 = RenderSystem.renderThreadTesselator().a(fgx.c.h, fgq.a);
            $$19.a(0.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 1.0F, 0.0F);
            $$19.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(ebq $$0, int $$1) {
      return a($$0.s(), $$1);
   }
