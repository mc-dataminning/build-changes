...
public class hcl extends uh {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private hcl(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static hcl a(avl $$0, List<String> $$1, boolean $$2) {
      ...
      ug.a().a($$3);
      return new hcl(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<avj> $$1, Map<String, String> $$2) {
      for (avj $$3 : $$1) {
