...
public class elo {
   ...
   public elo(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public elo(elt $$0, elt $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static elo a(dyy $$0) {
      return new elo((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static elo a(elt $$0) {
      return new elo($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static elo a(hx $$0, hx $$1) {
      return new elo(
   ...
   public elo a(double $$0) {
      return new elo($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public elo b(double $$0) {
      return new elo(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public elo c(double $$0) {
      return new elo(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public elo d(double $$0) {
      return new elo(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public elo e(double $$0) {
      return new elo(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public elo f(double $$0) {
      return new elo(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public elo b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public elo c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public elo d(double $$0, double $$1, double $$2) {
      return new elo(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public elo f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public elo h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<elt> b(elt $$0, elt $$1) {
   ...
   @Nullable
   public static elp a(Iterable<elo> $$0, elt $$1, elt $$2, hx $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new elp($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ic a(elo $$0, elt $$1, double[] $$2, @Nullable ic $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public elt f() {
      return new elt(auo.d(0.5, this.a, this.d), auo.d(0.5, this.b, this.e), auo.d(0.5, this.c, this.f));
   }

   public static elo a(elt $$0, double $$1, double $$2, double $$3) {
      return new elo($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
