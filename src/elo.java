...
public class elo {
   ...
   public static ell a(ell $$0) {
      return $$0;
   }

   public static ell a(ell $$0, ell $$1) {
   ...
   static class a implements ell {
      private final ell a;
      private final ell b;

      public a(ell $$0, ell $$1) {
         if ($$0 == $$1) {
