...
public class elo {
   public static final aku<eln> a = a("classic_flat");
   public static final aku<eln> b = a("tunnelers_dream");
   public static final aku<eln> c = a("water_world");
   public static final aku<eln> d = a("overworld");
   public static final aku<eln> e = a("snowy_kingdom");
   public static final aku<eln> f = a("bottomless_pit");
   public static final aku<eln> g = a("desert");
   public static final aku<eln> h = a("redstone_ready");
   public static final aku<eln> i = a("the_void");

   public static void a(qe<eln> $$0) {
      new elo.a($$0).a();
   }

   private static aku<eln> a(String $$0) {
   ...
   static class a {
      ...
      private void a(aku<eln> $$0, dgh $$1, aku<dhk> $$2, Set<aku<ens>> $$3, boolean $$4, boolean $$5, elm... $$6) {
