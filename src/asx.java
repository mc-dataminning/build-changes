...
class asx implements Path {
   private static final BasicFileAttributes a = new asv() {
      @Override
   ...
   private static final BasicFileAttributes b = new asv() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<asx> c = Comparator.comparing(asx::n);
   ...
   public asx(asz $$0, String $$1, @Nullable asx $$2, ata $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private asx a(@Nullable asx $$0, String $$1) {
      return new asx(this.e, $$1, $$0, ata.b);
   }
   ...
   asx a(String $$0) {
      if (a(this.i)) {
         return new asx(this.e, $$0, this, this.i);
      } else if (this.i instanceof ata.a $$1) {
         asx $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new asx(this.e, $$0, this, ata.a);
      } else if (this.i instanceof ata.b) {
         return new asx(this.e, $$0, this, ata.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(ata $$0) {
      return $$0 == ata.a || $$0 == ata.b;
   }
   ...
   private asx c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof asx $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ata.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ata.a i() {
      return this.i instanceof ata.a $$0 ? $$0 : null;
   }
