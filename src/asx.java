...
public class asx extends asr {
   static final Logger c = LogUtils.getLogger();
   private final asx.b d;
   private final String e;

   asx(asz $$0, asx.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atc $$0, ale $$1) {
   ...
   public static class a implements atw.c {
      ...
      @Override
      public ata a(asz $$0) {
         asx.b $$1 = new asx.b(this.a);
         return new asx($$0, $$1, "");
      }

      @Override
      public ata a(asz $$0, atw.a $$1) {
         asx.b $$2 = new asx.b(this.a);
         ata $$3 = new asx($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<ata> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  asx.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
