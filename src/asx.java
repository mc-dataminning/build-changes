...
public class asx<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return asx.this.get(this.b--);
      }

      @Override
      public void remove() {
         asx.this.remove(this.b + 1);
      }
   }
}
