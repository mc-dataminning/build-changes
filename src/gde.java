...
public class gde implements ezj, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final ezh c = new ezh();
   private static final boolean d = true;
   private static gde e;
   ...
   private final List<ezp> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezp> l = Maps.newHashMap();
   private final int m;
   ...
   public gde(aus $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, ezm.a.a, $$6);
         this.t = a($$0, ezm.a.b, $$7);
         this.m = ezn.a();
         ezn.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezp.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezk a(aus $$0, ezm.a $$1, String $$2) throws IOException {
      ezm $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezk)) {
   ...
   public static ezi a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezi();
      } else {
         int $$1 = 32774;
