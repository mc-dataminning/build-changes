...
public class gde extends gea<hbk> {
   private final ghd[] a;
   private final ghd b;
   ...
   public static ghj a() {
      ghl $$0 = new ghl();
      ghn $$1 = $$0.a();
      $$1.a("head", ghi.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), ghf.a);
      float $$2 = 0.0F;
      ghi $$3 = ghi.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = azk.b($$2) * 9.0F;
         float $$6 = -2.0F + azk.b((float)($$4 * 2) * 0.25F);
         float $$7 = azk.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, ghf.a($$5, $$6, $$7));
         $$2++;
      }
