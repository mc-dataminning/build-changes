...
public class bfu extends bbw {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfu::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfu::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfu::k);
         $$0 = this.a($$0, "minecraft:fox", bfu::j);
         $$0 = this.a($$0, "minecraft:item", bfu::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfu::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfu::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfu::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfu::e);
         return this.a($$0, "minecraft:piglin", bfu::d);
      });
   }
