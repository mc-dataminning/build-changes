...
public abstract class bfu<R extends Runnable> implements bfc, bfw<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bfu(String $$0) {
      this.b = $$0;
      bfa.a.a(this);
   }
   ...
   @Override
   public List<bez> bk() {
      return ImmutableList.of(bez.a(this.b + "-pending-tasks", bey.b, this::bm));
   }
}
