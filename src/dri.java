...
public class dri implements dqs {
   public static final Codec<dri> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dve.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               arh.b(jz.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dst.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dst.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dmr.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dri::new)
   );
   ...
   public dri(ib<dve> $$0, int $$1, int $$2, arh<cua> $$3, dst $$4, int $$5, int $$6, int $$7, int $$8, dst $$9, int $$10, int $$11, dmr $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
