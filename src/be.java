...
public class be extends cx<be.a> {
   ...
   public void a(apv $$0, chz $$1, cjn $$2) {
      enk $$3 = br.b($$0, $$1);
      enk $$4 = br.b($$0, $$2);
   ...
   public static record a(Optional<bc> b, Optional<bc> c, Optional<bc> d) implements cx.a {
      public static final Codec<be.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(awu.a(br.b, "player").forGetter(be.a::a), awu.a(br.b, "zombie").forGetter(be.a::c), awu.a(br.b, "villager").forGetter(be.a::d))
               .apply($$0, be.a::new)
      );
