...
public class ely extends emf {
   private static final Codec<bsj> b = bsj.a
      .codec()
      .validate(
         $$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final MapCodec<ely> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bsd.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  bsd.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  bsd.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  bsd.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, ely::new)
   );
   ...
   public ely(int $$0, int $$1, int $$2, bsd $$3, bsd $$4, bsj $$5, bsd $$6) {
      super($$0, $$1, $$2);
      this.h = $$3;
      this.i = $$4;
      this.j = $$5;
      this.k = bsj.a($$5.a(), $$5.b() - 1);
      this.l = $$6;
   }
   ...
   public List<ekk.a> a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, ji $$4, eju $$5) {
      ...
      List<ekk.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new ekk.a($$4.b($$11), 0, false));
      }

      ji.a $$16 = new ji.a();
      jn $$17 = jn.c.a.a($$2);
      Function<dxq, dxq> $$18 = $$1x -> $$1x.c(dqv.d, $$17.o());
   ...
   private ekk.a a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, ji $$4, eju $$5, Function<dxq, dxq> $$6, jn $$7, int $$8, boolean $$9, ji.a $$10) {
      $$10.g($$4).c(jn.b, $$8);
