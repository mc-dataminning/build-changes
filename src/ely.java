...
public class ely {
   ...
   public static elv a(elv $$0) {
      return $$0;
   }

   public static elv a(elv $$0, elv $$1) {
   ...
   static class a implements elv {
      private final elv a;
      private final elv b;

      public a(elv $$0, elv $$1) {
         if ($$0 == $$1) {
