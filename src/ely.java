...
public abstract class ely<T extends ely<T>> {
   ...
   public ely(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = elw.a();
         if ($$3 != null) {
         ...
         throw new enh(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new enh(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new enh(var2.getMessage(), var2);
      }
   }
   ...
   public static ely<?> a(String $$0) {
      return new ely.b($$0, 5000, 60000);
   }

   public static ely<?> a(String $$0, int $$1, int $$2) {
      return new ely.b($$0, $$1, $$2);
   }

   public static ely<?> c(String $$0, String $$1) {
      return new ely.c($$0, $$1, 5000, 60000);
   }

   public static ely<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ely.c($$0, $$1, $$2, $$3);
   }

   public static ely<?> b(String $$0) {
      return new ely.a($$0, 5000, 60000);
   }

   public static ely<?> d(String $$0, String $$1) {
      return new ely.d($$0, $$1, 5000, 60000);
   }

   public static ely<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ely.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ely<ely.a> {
   ...
   public static class b extends ely<ely.b> {
   ...
   public static class c extends ely<ely.c> {
      ...
      public ely.c f() {
         try {
            ...
            throw new enh(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ely<ely.d> {
      private final String c;
