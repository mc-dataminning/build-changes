...
public class bvs extends bur {
   private static final aef<gw> bW = aei.a(bvs.class, aeh.n);
   private static final aef<Boolean> bX = aei.a(bvs.class, aeh.k);
   private static final aef<Boolean> bY = aei.a(bvs.class, aeh.k);
   private static final aef<gw> bZ = aei.a(bvs.class, aeh.n);
   private static final aef<Boolean> ca = aei.a(bvs.class, aeh.k);
   ...
   protected apd d(bho $$0) {
      return this.m_() ? ape.yp : ape.yo;
   }

   @Nullable
   @Override
   protected apd l_() {
      return this.m_() ? ape.yk : ape.yj;
   }

   @Override
   protected void b(gw $$0, dfj $$1) {
      apd $$2 = this.m_() ? ape.ys : ape.yr;
      this.a($$2, 0.15F, 1.0F);
   }
      ...
      public void e() {
         ...
         if (!this.g.aX() && this.m()) {
            if (this.g.cc < 1) {
               ...
               cpv $$1 = this.g.dL();
               $$1.a(null, $$0, ape.yq, apf.e, 0.3F, 0.9F + $$1.z.i() * 0.2F);
               gw $$2 = this.e.c();
      ...
      public void a() {
         ...
         if (this.k == bpe.a.b && !this.l.L().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.w(arx.i(0.125F, this.l.fe(), $$5));
