...
public class bvs extends bur {
   private static final aee<gw> bW = aeh.a(bvs.class, aeg.n);
   private static final aee<Boolean> bX = aeh.a(bvs.class, aeg.k);
   private static final aee<Boolean> bY = aeh.a(bvs.class, aeg.k);
   private static final aee<gw> bZ = aeh.a(bvs.class, aeg.n);
   private static final aee<Boolean> ca = aeh.a(bvs.class, aeg.k);
   private static final aee<Boolean> cb = aeh.a(bvs.class, aeg.k);
   ...
   public static boolean c(biu<bvs> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      return $$3.v() < $$1.y_() + 4 && dbm.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void z() {
      this.bO.a(0, new bvs.f(this, 1.2));
      this.bO.a(1, new bvs.a(this, 1.0));
      this.bO.a(1, new bvs.d(this, 1.0));
      this.bO.a(2, new brj(this, 1.1, bT, false));
      this.bO.a(3, new bvs.c(this, 1.0));
      this.bO.a(4, new bvs.b(this, 1.0));
      this.bO.a(7, new bvs.i(this, 1.0));
      this.bO.a(8, new bqj(this, cbu.class, 8.0F));
      this.bO.a(9, new bvs.h(this, 1.0, 100));
   }

   public static bkl.a y() {
      return bji.A().a(bkm.a, 30.0).a(bkm.d, 0.25);
   }
   ...
   @Override
   protected apc w() {
      return !this.aX() && this.aA() && !this.m_() ? apd.yi : super.w();
   }
   ...
   protected apc d(bho $$0) {
      return this.m_() ? apd.yp : apd.yo;
   }

   @Nullable
   @Override
   protected apc l_() {
      return this.m_() ? apd.yk : apd.yj;
   }

   @Override
   protected void b(gw $$0, dfj $$1) {
      apc $$2 = this.m_() ? apd.ys : apd.yr;
      this.a($$2, 0.15F, 1.0F);
   }
   ...
   protected bsp b(cpv $$0) {
      return new bvs.g(this, $$0);
   }

   @Nullable
   @Override
   public bil a(akq $$0, bil $$1) {
      return biu.bd.a((cpv)$$0);
   }
   ...
   public float a(gw $$0, cpy $$1) {
      if (!this.gk() && $$1.b_($$0).a(apx.a)) {
         return 10.0F;
      } else {
         return dbm.a($$1, $$0) ? 10.0F : $$1.v($$0);
      }
   }
   ...
   static class a extends bpn {
      ...
      protected void g() {
         ...
         asc $$1 = this.a.ef();
         if (this.b.X().b(cpr.f)) {
            this.b.b(new biw(this.b, this.a.dq(), this.a.ds(), this.a.dw(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends bqb {
      ...
      public void e() {
         ...
         if (this.a.L().l()) {
            ehn $$2 = ehn.c($$0);
            ehn $$3 = btw.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = btw.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dL().a_(gw.a($$3)).a(csw.G)) {
               $$3 = btw.a(this.a, 16, 5, $$2, (float) (Math.PI / 2));
            }
   ...
   static class c extends bqo {
      ...
      protected boolean a(cpy $$0, gw $$1) {
         return $$0.a_($$1).a(csw.G);
      }
   }

   static class d extends bqo {
      private final bvs g;
      ...
      public void e() {
         ...
         if (!this.g.aX() && this.m()) {
            if (this.g.cc < 1) {
               ...
               cpv $$1 = this.g.dL();
               $$1.a(null, $$0, apd.yq, ape.e, 0.3F, 0.9F + $$1.z.i() * 0.2F);
               gw $$2 = this.e.c();
               dfj $$3 = csw.mf.n().a(dbm.e, Integer.valueOf(this.g.ag.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(djt.i, $$2, djt.a.a(this.g, $$3));
               this.g.w(false);
               this.g.x(false);
               this.g.s(600);
            }
      ...
      @Override
      protected boolean a(cpy $$0, gw $$1) {
         return !$$0.t($$1.c()) ? false : dbm.b($$0, $$1);
      }
   }
      ...
      public void a() {
         ...
         if (this.k == bpe.a.b && !this.l.L().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aU = this.l.dB();
               float $$5 = (float)(this.h * this.l.b(bkm.d));
               this.l.w(arw.i(0.125F, this.l.fe(), $$5));
   ...
   static class g extends bsm {
      ...
      public boolean a(gw $$0) {
         if (this.a instanceof bvs $$1 && $$1.gl()) {
            return this.b.a_($$0).a(csw.G);
         }
   ...
   static class h extends bqy {
      private final bvs i;

      h(bvs $$0, double $$1, int $$2) {
         super($$0, $$1, $$2);
         this.i = $$0;
      }
   ...
   static class i extends bqb {
      ...
      public void e() {
         if (this.a.L().l()) {
            ehn $$0 = ehn.c(this.a.gj());
            ehn $$1 = btw.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
