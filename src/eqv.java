...
public class eqv {
   ...
   public static final eqv.a bv;

   public static eqv.a a(int $$0, int $$1) {
      return $$0 == -1 ? eqv.b.b.a($$1) : eqv.b.a.a($$0);
   }

   public static eqv.a a(String $$0) {
      if (eqv.a.e.containsKey($$0)) {
         return eqv.a.e.get($$0);
      } else {
         for (eqv.b $$1 : eqv.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eqv.b b;
      private final int c;
      private final awc<vq> d;
      static final Map<String, eqv.a> e = Maps.newHashMap();

      a(String $$0, eqv.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new awc<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eqv.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vq> g;

      private static void a(eqv.b $$0, String $$1, int $$2) {
         eqv.a $$3 = new eqv.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eqv.a a(int $$0) {
         return (eqv.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
