...
public class eqv implements Comparable<eqv> {
   private static final Map<String, eqv> h = Maps.newHashMap();
   private static final Map<ekm.a, eqv> i = Maps.newHashMap();
   ...
   private final ekm.a m;
   private final String n;
   private ekm.a o;
   private boolean p;
   private int q;

   public static void a(ekm.a $$0) {
      eqv $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(ekm.a $$0, boolean $$1) {
      eqv $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (eqv $$0 : h.values()) {
         if ($$0.o.a() == ekm.b.a && $$0.o.b() != ekm.bv.b()) {
            $$0.a(ekm.a(eqx.O().aM().i(), $$0.o.b()));
         }
      }
   }
   ...
   public eqv(String $$0, int $$1, String $$2) {
      this($$0, ekm.b.a, $$1, $$2);
   }

   public eqv(String $$0, ekm.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(ekm.a $$0) {
      this.o = $$0;
   }

   public int a(eqv $$0) {
      return this.n.equals($$0.n) ? gam.a(this.l).compareTo(gam.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<tn> a(String $$0) {
      eqv $$1 = h.get($$0);
      return $$1 == null ? () -> tn.c($$0) : $$1::k;
   }

   public boolean b(eqv $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(ekm.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == ekm.bv.b() ? this.o.a() == ekm.b.b && this.o.b() == $$1 : this.o.a() == ekm.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == ekm.b.c && this.o.b() == $$0;
   }
