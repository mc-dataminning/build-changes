...
public class eqv implements ebj.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eqv> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azf<eqv> a = azf.a(f);
   private final eqz g;
   private final eqz h;
   private final eqz i;
   ...
   public static eqv a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eqv(new ecr(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eqv(eqz $$0, eqz $$1, eqz $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eqv(azu $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eqz.a($$0, IntStream.rangeClosed(-15, 0)),
         eqz.a($$0, IntStream.rangeClosed(-15, 0)),
         eqz.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eqv a(azu $$0) {
      return new eqv($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(ebj.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eqw $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eqz.b($$4 * $$13), eqz.b($$5 * $$13), eqz.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eqz.b($$1 * $$13);
         double $$21 = eqz.b($$2 * $$13);
         double $$22 = eqz.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eqw $$24 = this.g.a($$19);
            if ($$24 != null) {
