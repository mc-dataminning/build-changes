...
public class gfw extends dgg {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebe e = new ebe();
   private final ebk<buj> f = new ebk<>(buj.class, new gfw.b());
   private final gfx E;
   private final glr F;
   private final glq G;
   private final gfw.a H;
   private final gli I;
   private final bsr J;
   private final flh K = flh.Q();
   final List<gkq> L = Lists.newArrayList();
   final List<cjq> M = Lists.newArrayList();
   private final Map<eup, eur> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dfq, fmk> Q = af.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gld.a, new fmk($$0xx -> this.b($$0xx, gld.a)));
      $$0x.put(gld.b, new fmk($$0xx -> this.b($$0xx, gld.b)));
      $$0x.put(gld.c, new fmk($$0xx -> this.b($$0xx, gld.c)));
   });
   private final gfs R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final ghj U = new ghj();
   private final int V;
   private boolean W;
   private static final Set<cwj> X = Set.of(cwr.hY, cwr.hZ);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(ji $$0, dwv $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(ji $$0, dwv $$1, fay $$2) {
      dwv $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cov $$4 = this.K.t;
   ...
   public gfw(gfx $$0, gfw.a $$1, akt<dgg> $$2, jr<eaq> $$3, int $$4, int $$5, glr $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gfs(this, $$4);
      this.J = new bsr();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new glq(this.K, this, $$6);
      this.I = gli.a($$3.a());
   ...
   public boolean h(buj $$0) {
      return $$0.dy().a(this.K.t.dy()) <= this.T;
   }

   public void c(buj $$0) {
      $$0.bz();
      $$0.af++;
      boq.a().a(() -> mb.f.b($$0.aq()).toString());
      $$0.h();
      boq.a().c();
   ...
   private void a(buj $$0, buj $$1) {
      if ($$1.dR() || $$1.dl() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof cov || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   @Override
   public void ac() {
      this.E.k().a(wo.c("multiplayer.status.quitting"));
   }
   ...
   private djk o() {
      if (this.K.r.j() == dgd.b) {
         cwn $$0 = this.K.t.eZ();
         cwj $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cut $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azg $$4, @Nullable djk $$5, ji.a $$6) {
   ...
   private void a(ji $$0, dwv $$1, lr $$2, boolean $$3) {
      if ($$1.y().c()) {
         fbs $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jn.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(ji $$0, lr $$1, fbs $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, lr $$5) {
      this.a($$5, ayy.d(this.A.j(), $$0, $$1), $$4, ayy.d(this.A.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable cov $$0, buj $$1, jr<avy> $$2, awa $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hij)(new hia($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(buj $$0, avy $$1, awa $$2, float $$3, float $$4) {
      this.K.ak().a((hij)(new hia($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avy $$3, awa $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.K.j.k().b().c($$0, $$1, $$2);
      hie $$10 = new hie($$3, $$4, $$5, $$6, azg.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czc> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gio.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jr<dhi> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mc.aI).b(dhp.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayy.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = ayy.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public int a(fay $$0, float $$1) {
      float $$2 = this.f($$1);
      fay $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fay $$4 = axz.a($$3, ($$0x, $$1x, $$2x) -> fay.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
      float $$5 = ayy.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$5 = ayy.a($$5, 0.0F, 1.0F);
      $$4 = $$4.c((double)$$5);
      int $$6 = axj.a($$4);
      float $$7 = this.d($$1);
      ...
      if ($$15 > 0) {
         ...
         $$16 *= 0.45F;
         $$6 = axj.a($$16, $$6, axj.a(204, 204, 255));
      }
   ...
   public int h(float $$0) {
      ...
      float $$2 = this.d($$0);
      if ($$2 > 0.0F) {
         int $$3 = axj.a(axj.e($$1), 0.6F);
         $$1 = axj.a($$2 * 0.95F, $$1, $$3);
      }

      float $$4 = this.f($$0);
      float $$5 = ayy.b($$4 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$5 = ayy.a($$5, 0.0F, 1.0F);
      $$1 = axj.a($$1, axj.a(1.0F, $$5 * 0.9F + 0.1F, $$5 * 0.9F + 0.1F, $$5 * 0.85F + 0.15F));
      float $$6 = this.b($$0);
      if ($$6 > 0.0F) {
         int $$7 = axj.a(axj.e($$1), 0.2F);
         $$1 = axj.a($$6 * 0.95F, $$1, $$7);
      }
   ...
   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayy.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = ayy.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(ji $$0, dfq $$1) {
      fmk $$2 = (fmk)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(ji $$0, dfq $$1) {
      int $$2 = flh.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<eup, eur> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<eup, eur> $$0) {
      this.N.putAll($$0);
   }
   ...
   public static class a implements evk {
      ...
      public a(bsf $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements ebg<buj> {
      public void a(buj $$0) {
      }
      ...
      public void e(buj $$0) {
         ...
         switch ($$0) {
            case gkq $$1:
               ...
               break;
            case cjt $$2:
               gfw.this.M.addAll(Arrays.asList($$2.x()));
               break;
         }
      }
      ...
      public void f(buj $$0) {
         ...
         switch ($$0) {
            case gkq $$1:
               ...
               break;
            case cjt $$2:
               gfw.this.M.removeAll(Arrays.asList($$2.x()));
               break;
         }
      }
