public class gfw extends gft {
   private final gfo a;
   private static final int b = 8;

   protected gfw(gbm $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gfo $$8) {
      ...
      this.l += $$6;
      this.D *= 0.75F * $$7;
      this.t = (int)(8.0F / azf.b(this.r, 0.5F, 1.0F) * $$7);
   ...
   public static class a implements gew<ls> {
      ...
      public get a(ls $$0, gbm $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gfw($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
