...
public class erw implements egm {
   ...
   private final ehk b;
   private final erl<erw.b> c;

   erw(ehk $$0, erl<erw.b> $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static record a(acq c, int d, int e, int[][] f) implements erx {
      ...
      public static final MapCodec<erw.a> a = aoi.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     acq.a.fieldOf("file").forGetter(erw.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(erw.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(erw.a::e),
                     g.fieldOf("chars").forGetter(erw.a::f)
                  )
                  .apply($$0, erw.a::new)
         ),
         erw.a::a
      ...
      private static DataResult<erw.a> a(erw.a $$0) {
      ...
      private egm a(akx $$0) throws IOException {
         ...
         try (InputStream $$2 = $$0.open($$1)) {
            ...
            erl<erw.b> $$9 = new erl<>(erw.b[]::new, erw.b[][]::new);
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     erw.b $$15 = $$9.a($$12, new erw.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        erw.a.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
   ...
   static record b(float a, ehk b, int c, int d, int e, int f, int g, int h) implements egl {
      ...
      public err bake(Function<egn, err> $$0) {
         return $$0.apply(new egn() {
            ...
            @Override
            public float j() {
               return egn.super.j() + 7.0F - (float)b.this.h;
            }
