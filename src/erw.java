...
public class erw extends gjl {
   ...
   @Nullable
   private volatile vb F;
   private volatile vb G = vb.c("mco.download.preparing");
   @Nullable
   ...
   public erw(fcc $$0, era $$1, String $$2, BooleanConsumer $$3) {
      super(euc.a);
      this.T = $$3;
      this.y = $$0;
      this.D = $$2;
      this.z = $$1;
      this.E = new erw.a();
      this.A = vb.c("mco.download.title");
      this.B = RateLimiter.create(0.1F);
   }

   @Override
   public void aP_() {
      this.C = this.d(ewh.a(va.e, $$0 -> {
         this.I = true;
         this.E();
   ...
   private void C() {
      if (!this.K) {
         if (!this.S && this.a(this.z.a) >= 5368709120L) {
            vb $$0 = vb.a("mco.download.confirmation.line1", epp.b(5368709120L));
            vb $$1 = vb.c("mco.download.confirmation.line2");
            this.f.a(new erz($$0x -> {
               this.S = true;
               this.f.a(this);
               this.F();
   ...
   private vb D() {
      ...
      $$0.add(this.G);
      if (this.H != null) {
         $$0.add(vb.a("mco.download.percent", this.H));
         $$0.add(vb.a("mco.download.speed.narration", epp.b(this.O)));
      }
   ...
   private void d(evw $$0) {
      ...
      $$0.a(this.i, vb.a("mco.download.percent", this.H), this.g / 2, 84, 16777215);
   }
   ...
   private void a(evw $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, vb.a("mco.download.speed", epp.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, 16777215, false);
      }
   }
         ...
         try {
            try {
               if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                  this.G = vb.c("mco.download.failed");
                  return;
               }
               ...
               this.G = vb.a("mco.download.downloading", this.D);
               epq $$0 = new epq();
               $$0.a(this.z.a);
               ...
               while (!$$0.b()) {
                  if ($$0.c()) {
                     $$0.a();
                     this.F = vb.c("mco.download.failed");
                     this.C.b(va.d);
                     return;
                  }
                  ...
                  if ($$0.d()) {
                     if (!this.L) {
                        this.G = vb.c("mco.download.extracting");
                     }
   ...
   private void G() {
      this.G = vb.c("mco.download.cancelled");
   }
