...
public class erw {
   ...
   @Nullable
   private String g;
   private static final erw.a h = new erw.a() {
      @Nullable
      @Override
      public erv a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (esa.a(this.d, "Get capabilities")) {
         ...
         if (esa.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  esa.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !esa.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public erv a(erw.c $$0) {
      return ($$0 == erw.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements erw.a {
      private final int a;
      private final Set<erv> b = Sets.newIdentityHashSet();
      ...
      public erv a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               erw.a.warn("Maximum sound pool size {} reached", this.a);
            }
