...
public class cni extends bsv implements bup {
   ...
   public cni(btb<? extends cni> $$0, dbz $$1) {
      super($$0, $$1);
   }

   public cni(dbz $$0, double $$1, double $$2, double $$3, float $$4, int $$5, btq $$6) {
      this(btb.K, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         if (this.e == -8) {
            for (btq $$8 : this.dP().a(btq.class, this.cK().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
