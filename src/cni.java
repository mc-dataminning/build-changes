public class cni extends bsu implements cnm {
   private static final akk<cup> b = ako.a(cni.class, akm.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public cni(bta<? extends cni> $$0, dby $$1) {
      super($$0, $$1);
   }

   public cni(dby $$0, double $$1, double $$2, double $$3) {
      this(bta.N, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void l() {
      ...
      double $$4 = $$0.h();
      this.s(cnp.d(this.P, (float)(ayz.d($$0.d, $$4) * 180.0F / (float)Math.PI)));
      this.r(cnp.d(this.O, (float)(ayz.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
      if (!this.dP().B) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         ...
         $$0 = new evr(Math.cos((double)$$8) * $$9, $$10 + ((double)$$11 - $$10) * 0.015F, Math.sin((double)$$8) * $$9);
         this.h($$0);
      }
   ...
   public void a(us $$0) {
      if ($$0.b("Item", 10)) {
         this.a(cup.a(this.dR(), (vp)$$0.p("Item")).orElse(this.s()));
      } else {
         this.a(this.s());
      }
   }
