...
public class cvb {
   public static final cvb a = new cvb(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<cvb> b = RecordCodecBuilder.create(
   ...
   public cvb(List<String> $$0, List<String> $$1) {
