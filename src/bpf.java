...
public abstract class bpf<R extends Runnable> implements bon, bph<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bpf(String $$0) {
      this.b = $$0;
      bol.a.a(this);
   }
   ...
   @Override
   public List<bok> bv() {
      return ImmutableList.of(bok.a(this.b + "-pending-tasks", boj.b, this::bx));
   }
}
