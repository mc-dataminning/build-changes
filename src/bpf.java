...
public class bpf {
   ...
   private bpf(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bpf a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bpf($$0, $$1);
   }

   public bpf.d a() throws IOException {
      bpf.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bpf.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bpf.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bpf.c $$3 = bpf.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bpf.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bpf.a($$0, $$3);
            }
         }
   ...
   public bpf.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bpf.c> $$2 = this.a().c();
      ...
      bpf.e $$4 = new bpf.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bpf.c b) implements bpf.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bpf.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bpf.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bpf.b> {
      private final List<bpf.b> a;

      d(List<bpf.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bpf.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bpf.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bpf.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bpf.d a() {
         ListIterator<bpf.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bpf.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bpf.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bpf.b> b() {
         return this.a.stream();
      }

      public Set<bpf.c> c() {
         return this.a.stream().map(bpf.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bpf.c b) implements bpf.b {
