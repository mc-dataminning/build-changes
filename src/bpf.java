...
public class bpf extends box {
   ...
   public bpf(cxb $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bpd.N, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bpf(bpd<? extends bpf> $$0, cxb $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         ept $$0 = new ept(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void s() {
      ...
      if (this.dM() instanceof apf) {
         for (bpf $$1 : this.dM().a(drd.a(bpf.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(apf $$0, ept $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bpf($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(apf $$0, ept $$1, int $$2) {
      epo $$3 = epo.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bpf> $$5 = $$0.a(drd.a(bpf.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bpf $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bpf $$0) {
      return $$0 != this && a($$0, this.aj(), this.i);
   }

   private static boolean a(bpf $$0, int $$1, int $$2) {
      return !$$0.dH() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bpf $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(ciu $$0, int $$1) {
      Entry<bpe, cqm> $$2 = cux.a(cuz.L, $$0, cqm::k);
      if ($$2 != null) {
         cqm $$3 = $$2.getValue();
