...
public class dvl extends dmc {
   ...
   public static final MapCodec<dvl> b = RecordCodecBuilder.mapCodec($$0 -> $$0.group(a.forGetter($$0x -> $$0x.c), t()).apply($$0, dvl::new));
   protected final mc c;

   @Override
   public MapCodec<? extends dvl> a() {
      return b;
   }

   protected dvl(mc $$0, ean.d $$1) {
      super($$1);
      this.c = $$0;
   }
