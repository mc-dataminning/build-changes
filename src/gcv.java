...
public class gcv {
   ...
   public static class a extends Thread {
      ...
      public a(gcv.b $$0) throws IOException {
         super("LanServerDetector #" + gcv.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gcv.b));
   ...
   public static class b {
      private final List<gcu> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gcu> a() {
         if (this.b) {
            List<gcu> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
