...
public class dst {
   ...
   private final cwg p;
   private static final List<czf> q = List.of(czh.l, czh.L, czh.i, czh.b, czh.k, czh.I, czh.K, czh.fl, czh.dP, czh.iA, czh.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<il<cxd>>> t;
   ...
   public static final Codec<dst> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dst::a, Function.identity());

   private static DataResult<dst> a(dst $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dst(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<il<cxd>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jd.c($$0);
      int $$5 = jd.c($$1) - $$4;
   ...
   @Nullable
   public static dst a(aph $$0, int $$1, int $$2) {
      doa $$3 = $$0.a($$1, $$2);
      dst $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dof.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ii> a(cwz $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, doa $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, awm.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(doa $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(drq.a.a)) {
         $$3 = Math.min($$0.a(drq.a.a, $$1, $$2) + 1, this.p.ak());
      } else {
         $$3 = this.p.ak();
      }
   ...
   private static double a(doa $$0, ib.a $$1) {
      return a($$0, (ib)$$1.c(ih.a)) ? 1.0 : -1.0;
   }

   private static double b(doa $$0, ib.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(doa $$0, int $$1, int $$2, int $$3) {
   ...
   private List<il<cxd>> b(doa $$0, int $$1, int $$2) {
      ObjectArrayList<il<cxd>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + iw.a(this.p.J_());
   ...
   private static boolean a(doa $$0, ib $$1) {
      dme $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(aue.O)) {
         ...
         return $$2.a(czh.eT) || $$2.a(czh.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dst.a $$3) {
      if ($$1 >= iw.a(this.p.J_()) && $$1 < iw.a(this.p.ak())) {
         int $$4 = $$1 - iw.a(this.p.J_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               il<cxd> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dst.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dst.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, il<cxd> var3);
   }
