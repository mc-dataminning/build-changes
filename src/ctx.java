...
public abstract class ctx extends cur implements bxh {
   private static final akj<Boolean> h = akn.a(ctx.class, akl.k);
   private static final akj<Boolean> i = akn.a(ctx.class, akl.k);
   private static final akj<Integer> j = akn.a(ctx.class, akl.b);
   ...
   @Nullable
   private bxh.a aH;
   private final Supplier<czj> aI;

   public ctx(bwr<? extends ctx> $$0, djm $$1, Supplier<czj> $$2) {
      super($$0, $$1);
      this.aI = $$2;
      this.I = true;
   }
   ...
   protected ffc a(bwi $$0, bwl $$1, float $$2) {
      ...
      return new ffc(0.0, this.b($$1), (double)$$3).b(-this.dK() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      this.aA = this.az;
      this.az = this.x();
      if (this.az != ctx.a.b && this.az != ctx.a.c) {
         this.n = 0.0F;
      } else {
         this.n++;
      }
      ...
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dU().C && !(this.cV() instanceof crm);
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aD) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof crm) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   @Override
   public ffc cS() {
      return new ffc(0.0, (double)(0.88F * this.cR()), (double)(this.dp() * 0.64F));
   }

   @Override
   public void b(bwi $$0, float $$1) {
      ffc $$2 = $$0.ds().d(this.ds()).d().c((double)$$1 - 6.0);
      ffc $$3 = this.dx();
      boolean $$4 = $$3.b($$2) > 0.0;
   ...
   public float j() {
      fex $$0 = this.cQ();
      fex $$1 = new fex($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = azm.a($$1.a) - 1;
      int $$3 = azm.c($$1.d) + 1;
      int $$4 = azm.a($$1.b) - 1;
      int $$5 = azm.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     eat $$16 = this.dU().a_($$11);
                     if (!($$16.b() instanceof dwl) && fft.c($$16.g(this.dU(), $$11).a($$11), $$8, ffg.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
   ...
   private void F() {
      ...
      double $$1 = 0.0;
      float $$2 = 0.05F;
      if (this.aA == ctx.a.e && this.az != ctx.a.e && this.az != ctx.a.d) {
         this.u = this.e(1.0);
         ...
         if (this.az == ctx.a.a) {
            ...
            $$2 = 0.9F;
         } else if (this.az == ctx.a.c) {
            $$0 = -7.0E-4;
            $$2 = 0.9F;
         } else if (this.az == ctx.a.b) {
            $$1 = 0.01F;
            $$2 = 0.45F;
         } else if (this.az == ctx.a.e) {
            $$2 = 0.9F;
         } else if (this.az == ctx.a.d) {
            $$2 = this.ay;
            if (this.cV() instanceof crm) {
               this.ay /= 2.0F;
            }
         }
   ...
   @Override
   public ffc b(bxj $$0) {
      ffc $$1 = a((double)(this.dp() * azm.g), (double)$$0.dp(), $$0.dK());
      double $$2 = this.dz() + $$1.d;
      double $$3 = this.dF() + $$1.f;
      iv $$4 = iv.a($$2, this.cQ().e, $$3);
      iv $$5 = $$4.e();
      if (!this.dU().A($$5)) {
         List<ffc> $$6 = Lists.newArrayList();
         double $$7 = this.dU().j($$4);
         if (cuf.a($$7)) {
            $$6.add(new ffc($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dU().j($$5);
         if (cuf.a($$8)) {
            $$6.add(new ffc($$2, (double)$$5.v() + $$8, $$3));
         }
   ...
   @Override
   public boolean bl() {
      return this.az == ctx.a.b || this.az == ctx.a.c;
   }

   @Override
   protected final czj o() {
      return this.aI.get();
   }

   @Override
   public final czn dH() {
      return new czn(this.aI.get());
   }
