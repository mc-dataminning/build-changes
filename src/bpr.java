...
public class bpr extends bpw {
   ...
   public static bpr a(float $$0, float $$1, int $$2, int $$3) {
      return new bpr($$0, $$1, $$2, $$3);
   }

   private bpr(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(ayw $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)ayo.a(ayo.c($$0, $$1, $$2), $$3, $$4);
   }
