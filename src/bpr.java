...
public interface bpr<T, F> {
   ...
   public static final class a implements bpr<bpr.b, Runnable> {
   ...
   public static final class c<T> implements bpr<T, T> {
