...
public class bbh extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bdt.y);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bbh::c), this.a("minecraft:arrow", bbh::a), this.a("minecraft:spectral_arrow", bbh::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bbh.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bdt.y, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bdt.y, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bbh.a<?> $$1, Type<?> $$2, Type<T> $$3) {
