...
public class ex<T> implements ArgumentType<ex.c<T>> {
   ...
   public ex(ajs<? extends iy<T>> $$0) {
      this.b = $$0;
   }

   public static <T> ex<T> a(ajs<? extends iy<T>> $$0) {
      return new ex<>($$0);
   }

   public static <T> ex.c<T> a(CommandContext<du> $$0, String $$1, ajs<iy<T>> $$2, DynamicCommandExceptionType $$3) throws CommandSyntaxException {
   ...
   public ex.c<T> a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         try {
            $$0.skip();
            ajt $$2 = ajt.a($$0);
            return new ex.d<>(avr.a(this.b, $$2));
         ...
         ajt $$4 = ajt.a($$0);
         return new ex.b<>(ajs.a(this.b, $$4));
      }
   }
   ...
   public static class a<T> implements hn<ex<T>, ex.a<T>.a> {
      public void a(ex.a<T>.a $$0, vg $$1) {
         $$1.b($$0.b);
      }

      public ex.a<T>.a a(vg $$0) {
   ...
   static record b<T>(ajs<T> a) implements ex.c<T> {
      @Override
      public Either<ajs<T>, avr<T>> a() {
         return Either.left(this.a);
      }

      @Override
      public <E> Optional<ex.c<E>> a(ajs<? extends iy<E>> $$0) {
   ...
   public interface c<T> extends Predicate<il<T>> {
      Either<ajs<T>, avr<T>> a();

      <E> Optional<ex.c<E>> a(ajs<? extends iy<E>> var1);

      String b();
   }

   static record d<T>(avr<T> a) implements ex.c<T> {
      @Override
      public Either<ajs<T>, avr<T>> a() {
