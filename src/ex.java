...
public class ex implements ez<ex>, fc {
   ...
   public ex(ew $$0, fbb $$1, fba $$2, ard $$3, int $$4, String $$5, wp $$6, MinecraftServer $$7, @Nullable bum $$8) {
   ...
   private void c(wp $$0) {
      ...
      if (this.d != this.j && this.j.aL().b(dgf.m)) {
         this.j.a($$1);
      }
   }
