...
public class fyr extends fxu {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   private static final int y = 256;
   private static final int z = 256;
   public static final fyr.a d = new fyr.a(List.of());
   ...
   protected void m() {
      this.c(fsc.a(wx.d, $$0 -> this.aK_()).a(this.n / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.n - 192) / 2;
      int $$1 = 2;
      this.F = this.c(new fzs($$0 + 116, 159, true, $$0x -> this.H(), this.H));
      this.G = this.c(new fzs($$0 + 43, 159, false, $$0x -> this.G(), this.H));
      this.L();
   }
   ...
   public void b(fro $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(gqc::H, s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }
   ...
   public static record a(List<wy> a) {
      ...
      @Nullable
      public static fyr.a a(cyy $$0) {
         boolean $$1 = fos.Q().aT();
         dci $$2 = $$0.a(kj.V);
         if ($$2 != null) {
            return new fyr.a($$2.a($$1));
         } else {
            dch $$3 = $$0.a(kj.U);
            return $$3 != null ? new fyr.a($$3.a($$1).map(wy::b).toList()) : null;
         }
      }
