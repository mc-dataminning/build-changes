...
public class fyr {
   ...
   private fyr(int $$0, List<fyt> $$1) {
      this.a = $$1.toArray(fyt[]::new);
      this.b = $$1.size();
   }

   private List<fyt> c() {
      List<fyt> $$0 = new ArrayList<>(this.d());
