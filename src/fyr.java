...
public class fyr extends fyn {
   ...
   fyr(fuh $$0, double $$1, double $$2, double $$3, dtw $$4, int $$5) {
      super($$0, $$1, $$2, $$3, 0.0, 0.0, 0.0);
      this.D = 0.3F;
      this.a = $$4;
      this.t = $$5;
      Optional<esa> $$6 = $$4.a($$0);
      if ($$6.isPresent()) {
         esa $$7 = $$6.get();
         double $$8 = $$1 - $$7.a();
         double $$9 = $$2 - $$7.b();
         double $$10 = $$3 - $$7.c();
         this.F = this.b = (float)axk.d($$8, $$10);
         this.H = this.G = (float)axk.d($$9, Math.sqrt($$8 * $$8 + $$10 * $$10));
      }
   }

   @Override
   public void a(ewm $$0, fba $$1, float $$2) {
      float $$3 = axk.a(((float)this.s + $$2 - (float) (Math.PI * 2)) * 0.05F) * 2.0F;
      float $$4 = axk.i($$2, this.F, this.b);
      float $$5 = axk.i($$2, this.H, this.G) + (float) (Math.PI / 2);
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         Optional<esa> $$0 = this.a.a(this.c);
         if ($$0.isEmpty()) {
            this.k();
         } else {
            int $$1 = this.t - this.s;
            ...
            esa $$3 = $$0.get();
            this.g = axk.d($$2, this.g, $$3.a());
            this.h = axk.d($$2, this.h, $$3.b());
            this.i = axk.d($$2, this.i, $$3.c());
            double $$4 = this.g - $$3.a();
            double $$5 = this.h - $$3.b();
            double $$6 = this.i - $$3.c();
            this.F = this.b;
            this.b = (float)axk.d($$4, $$6);
            this.H = this.G;
            this.G = (float)axk.d($$5, Math.sqrt($$4 * $$4 + $$6 * $$6));
         }
      }
   }

   public static class a implements fxq<kp> {
      private final fyi a;
      ...
      public fxn a(kp $$0, fuh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fyr $$8 = new fyr($$1, $$2, $$3, $$4, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
