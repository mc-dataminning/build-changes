...
public class fyr<T extends bky, M extends fih<T>> extends gab<T, M> {
   private static final agg a = new agg("textures/entity/bee/bee_stinger.png");

   public fyr(fwl<T, M> $$0) {
      super($$0);
   }
   ...
   private static void a(eno $$0, Matrix4f $$1, Matrix3f $$2, float $$3, int $$4, float $$5, float $$6, int $$7) {
      $$0.a($$1, $$3, (float)$$4, 0.0F).a(255, 255, 255, 255).a($$5, $$6).c(gay.d).b($$7).a($$2, 0.0F, 1.0F, 0.0F).e();
   }
}
