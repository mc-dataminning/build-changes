...
public class eui implements Comparable<eui> {
   private static final Map<String, eui> h = Maps.newHashMap();
   private static final Map<eny.a, eui> i = Maps.newHashMap();
   ...
   private final eny.a m;
   private final String n;
   private eny.a o;
   private boolean p;
   private int q;

   public static void a(eny.a $$0) {
      eui $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(eny.a $$0, boolean $$1) {
      eui $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (eui $$0 : h.values()) {
         if ($$0.o.a() == eny.b.a && $$0.o.b() != eny.bv.b()) {
            $$0.a(eny.a(euk.N().aL().i(), $$0.o.b()));
         }
      }
   }
   ...
   public eui(String $$0, int $$1, String $$2) {
      this($$0, eny.b.a, $$1, $$2);
   }

   public eui(String $$0, eny.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(eny.a $$0) {
      this.o = $$0;
   }

   public int a(eui $$0) {
      return this.n.equals($$0.n) ? geu.a(this.l).compareTo(geu.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<vb> a(String $$0) {
      eui $$1 = h.get($$0);
      return $$1 == null ? () -> vb.c($$0) : $$1::k;
   }

   public boolean b(eui $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(eny.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == eny.bv.b() ? this.o.a() == eny.b.b && this.o.b() == $$1 : this.o.a() == eny.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == eny.b.c && this.o.b() == $$0;
   }
