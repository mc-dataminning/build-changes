...
public class eui {
   ...
   public static List<eui.a> a(String $$0, eui.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<eui.a> a(String $$0, List<eui.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<eui.a> a(List<String> $$0, List<eui.b> $$1) {
      int $$2 = 0;
      List<eui.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<eui.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static eui.b a(String $$0, String $$1) {
         return new eui.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static eui.b a(String $$0) {
         return new eui.b($$0);
      }
   }
}
