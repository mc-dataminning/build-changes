...
public class ase implements AutoCloseable {
   ...
   public static ase a(Path $$0) throws IOException {
   ...
   private ase(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ase.a a(Path $$0) {
         return new ase.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
