...
public class ase implements asa {
   ...
   private final Map<asc, List<Path>> h;

   ase(arz $$0, ars $$1, Set<String> $$2, List<Path> $$3, Map<asc, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(asc $$0, akf $$1, Consumer<Path> $$2) {
   ...
   public void a(asc $$0, String $$1, String $$2, asa.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<akf, atg<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asa.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      asd.a($$1, $$4, $$3, $$0);
   }
   ...
   public atg<InputStream> a(asc $$0, akf $$1) {
      return (atg<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && asd.a($$5)) {
               return atg.create($$5);
            }
         }
   ...
   public <T> T a(asn<T> $$0) {
      atg<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public atr d() {
      return $$0 -> Optional.ofNullable(this.a(asc.a, $$0)).map($$0x -> new atm(this, $$0x));
   }
}
