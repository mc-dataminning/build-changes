...
public class ase {
   ...
   private static final Optional<Object> b = Optional.of(asn.a);

   private static boolean a(ua $$0, arb $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, ua $$1, arb $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, ua $$1, arb $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, ua $$1, arb $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, ua $$2, arb $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, ua $$2, ua $$3, arb $$4) {
      int $$5 = $$0.length();
      ua $$6 = $$2;
   ...
   public static boolean a(ti $$0, ua $$1, arb $$2) {
      return !$$0.a(($$1x, $$2x) -> a($$2x, 0, $$1x, $$2) ? Optional.empty() : b, $$1).isPresent();
   }
