...
public class ase implements asa {
   private final asc a;
   private final Long2ObjectOpenHashMap<dyk> b = new Long2ObjectOpenHashMap();
   private del c = new del(0, 0);
   private final int d;
   private final int e;
   private final int f;
   private boolean g;
   ...
   @Nullable
   public dyk a(int $$0, int $$1) {
      return (dyk)this.b.get(del.c($$0 + this.c.g - this.e, $$1 + this.c.h - this.e));
   }
}
