...
public class dg extends dk<dg.a> {
   ...
   public void a(arr $$0, alf<deb<?>> $$1, List<czk> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bj> b, alf<deb<?>> c, List<cm> d) implements dk.a {
      public static final Codec<dg.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  by.b.optionalFieldOf("player").forGetter(dg.a::a),
                  deb.b.fieldOf("recipe_id").forGetter(dg.a::b),
                  cm.a.listOf().optionalFieldOf("ingredients", List.of()).forGetter(dg.a::c)
               )
               .apply($$0, dg.a::new)
      );

      public static ar<dg.a> a(alf<deb<?>> $$0, List<cm.a> $$1) {
         return aq.ac.a(new dg.a(Optional.empty(), $$0, $$1.stream().map(cm.a::b).toList()));
      }

      public static ar<dg.a> a(alf<deb<?>> $$0) {
         return aq.ac.a(new dg.a(Optional.empty(), $$0, List.of()));
      }

      public static ar<dg.a> b(alf<deb<?>> $$0) {
         return aq.ad.a(new dg.a(Optional.empty(), $$0, List.of()));
      }

      boolean b(alf<deb<?>> $$0, List<czk> $$1) {
         if ($$0 != this.c) {
            return false;
         } else {
            List<czk> $$2 = new ArrayList<>($$1);

            for (cm $$3 : this.d) {
               boolean $$4 = false;
               Iterator<czk> $$5 = $$2.iterator();
