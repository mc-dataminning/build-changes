...
public class dg extends cx<dg.a> {
   ...
   public void a(aow $$0, cgp $$1, coz $$2) {
      eiv $$3 = br.b($$0, $$1);
   ...
   public static record a(Optional<bc> b, Optional<bc> c, Optional<cc> d) implements cx.a {
      public static final Codec<dg.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(avp.a(br.b, "player").forGetter(dg.a::a), avp.a(br.b, "villager").forGetter(dg.a::c), avp.a(cc.a, "item").forGetter(dg.a::d))
               .apply($$0, dg.a::new)
      );
