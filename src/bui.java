...
public abstract class bui extends buk {
   ...
   private static final ajx<Integer> p = akb.a(bui.class, ajz.b);
   private static final ajx<Integer> q = akb.a(bui.class, ajz.b);
   private static final ajx<Integer> r = akb.a(bui.class, ajz.b);
   private static final ajx<Vector3f> s = akb.a(bui.class, ajz.D);
   private static final ajx<Vector3f> t = akb.a(bui.class, ajz.D);
   private static final ajx<Quaternionf> u = akb.a(bui.class, ajz.E);
   private static final ajx<Quaternionf> ay = akb.a(bui.class, ajz.E);
   private static final ajx<Byte> az = akb.a(bui.class, ajz.a);
   private static final ajx<Integer> aA = akb.a(bui.class, ajz.b);
   private static final ajx<Float> aB = akb.a(bui.class, ajz.d);
   private static final ajx<Float> aC = akb.a(bui.class, ajz.d);
   private static final ajx<Float> aD = akb.a(bui.class, ajz.d);
   private static final ajx<Float> aE = akb.a(bui.class, ajz.d);
   private static final ajx<Float> aF = akb.a(bui.class, ajz.d);
   private static final ajx<Integer> aG = akb.a(bui.class, ajz.b);
   ...
   public static class b extends bui {
      ...
      private static final ajx<dwx> p = akb.a(bui.b.class, ajz.i);
      @Nullable
      private bui.b.a q;

      public b(bur<?> $$0, dgi $$1) {
         super($$0, $$1);
      }
   ...
   public static class g extends bui {
      ...
      private static final ajx<cwp> q = akb.a(bui.g.class, ajz.h);
      private static final ajx<Byte> r = akb.a(bui.g.class, ajz.a);
      private final bvy s = bvy.a(this::t, this::a);
      @Nullable
      private bui.g.a t;

      public g(bur<?> $$0, dgi $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(tq $$0) {
         super.a($$0);
         if ($$0.e("item")) {
            this.a(cwp.a(this.dY(), (un)$$0.p("item")).orElse(cwp.j));
         } else {
            this.a(cwp.j);
         }

         if ($$0.b("item_display", 8)) {
            cwn.j.decode(ue.a, $$0.c("item_display")).resultOrPartial(af.a("Display entity", bui.o::error)).ifPresent($$0x -> this.a((cwn)$$0x.getFirst()));
         }
      }
   ...
   public static class l extends bui {
      ...
      private static final ajx<wo> aG = akb.a(bui.l.class, ajz.f);
      private static final ajx<Integer> aH = akb.a(bui.l.class, ajz.b);
      private static final ajx<Integer> aI = akb.a(bui.l.class, ajz.b);
      private static final ajx<Byte> aJ = akb.a(bui.l.class, ajz.a);
      private static final ajx<Byte> aK = akb.a(bui.l.class, ajz.a);
      ...
      @FunctionalInterface
      public interface d {
         bui.l.b split(wo var1, int var2);
      }

      public static record e(wo a, int b, bui.f c, bui.f d, byte e) {
      }
   }
