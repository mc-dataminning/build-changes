...
public abstract class dix extends djk {
   ...
   public static dwv a(dfl $$0, ji $$1) {
      ji $$2 = $$1.e();
      dwv $$3 = $$0.a_($$2);
      return dra.o($$3) ? djm.cz.m() : ((dml)djm.cy).b($$0, $$1);
   }
   ...
   public void a(dwv $$0, dgg $$1, ji $$2, azg $$3) {
      if ($$3.a(24) == 0) {
         $$1.a((double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, avz.jt, awa.e, 1.0F + $$3.i(), $$3.i() * 0.7F + 0.3F, false);
      }
   ...
   protected abstract boolean g(dwv var1);
   ...
   protected void b(dwv $$0, dgg $$1, ji $$2, dwv $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<etw> $$5 = etw.a((dgh)$$1, $$2, jn.a.a);
            if ($$5.isPresent()) {
               $$5.get().a($$1);
               return;
            }
   ...
   public static boolean a(dgg $$0, ji $$1, jn $$2) {
      dwv $$3 = $$0.a_($$1);
      return !$$3.l() ? false : a($$0, $$1).a((dgj)$$0, $$1) || b($$0, $$1, $$2);
   }

   private static boolean b(dgg $$0, ji $$1, jn $$2) {
      if (!a($$0)) {
         return false;
      } else {
         ji.a $$3 = $$1.k();
         ...
         if (!$$4) {
            ...
            return etw.a((dgh)$$0, $$1, $$6).isPresent();
         }
      }
   }
}
