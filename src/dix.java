...
public class dix {
   ...
   public dix(cti $$0, hx $$1, ic $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dja $$0 = this.b.a_(this.e);
      if (!dit.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eep.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dja $$0) {
      return $$0.a(cwl.hV) || $$0.a(cwl.pg);
   }

   private static boolean a(dja $$0, dja $$1) {
      if ($$0.a(cwl.pg) && $$1.a(cwl.hV)) {
         return false;
      } else {
         return $$0.a(cwl.hV) && $$1.a(cwl.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(hx $$0, ic $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dit.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dja $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dit.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dit.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
