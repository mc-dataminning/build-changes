...
public abstract class dix {
   ...
   public void a(bxc<?> $$0, @Nullable djx $$1, azx $$2, iv $$3) {
      ...
      if (this.c($$0, $$1)) {
         ...
         if (this.j > 0) {
            ...
            for (int $$5 = 0; $$5 < this.q; $$5++) {
               tz $$6 = $$4.a();
               Optional<bxc<?>> $$7 = bxc.a($$6);
               if ($$7.isEmpty()) {
                  this.d($$0, $$1);
                  return;
               }

               ffq $$8 = $$6.<ffq>a("Pos", ffq.a)
                  .orElseGet(
                     () -> new ffq(
               ...
               if ($$0.b($$7.get().a($$8.d, $$8.e, $$8.f))) {
                  ...
                  } else if (!byp.a($$7.get(), $$0, bxb.c, $$9, $$0.G_())) {
                     continue;
                  }

                  bwt $$11 = bxc.a($$6, $$0, bxb.c, $$1x -> {
                  ...
                  int $$12 = $$0.a(
                        efq.b($$11.getClass()),
                        new ffl((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.u),
                        bxa.f
                     )
                     .size();
                  ...
                  if ($$11 instanceof bxw $$13) {
                     if ($$4.b().isEmpty() && !$$13.a($$0, bxb.c) || !$$13.a((dka)$$0)) {
                        continue;
                     }

                     boolean $$14 = $$4.a().i() == 1 && $$4.a().i("id").isPresent();
                     if ($$14) {
                        ((bxw)$$11).a($$0, $$0.d_($$11.dv()), bxb.c, null);
                     }
   ...
   public void a(@Nullable djx $$0, iv $$1, tz $$2) {
      this.j = $$2.b("Delay", (short)20);
      $$2.<dkr>a("SpawnData", dkr.b).ifPresent($$2x -> this.a($$0, $$1, $$2x));
      this.k = $$2.<btb<dkr>>a("SpawnPotentials", dkr.c).orElseGet(() -> btb.a(this.l != null ? this.l : new dkr()));
   ...
   public tz a(tz $$0) {
      ...
      $$0.b("SpawnData", dkr.b, this.l);
      $$0.a("SpawnPotentials", dkr.c, this.k);
      return $$0;
   }

   @Nullable
   public bwt b(djx $$0, iv $$1) {
      if (this.r == null) {
         tz $$2 = this.a($$0, $$0.G_(), $$1).a();
         if ($$2.i("id").isEmpty()) {
            return null;
         }

         this.r = bxc.a($$2, $$0, bxb.c, Function.identity());
         if ($$2.i() == 1 && this.r instanceof bxw) {
         }
      }
   ...
   protected void a(@Nullable djx $$0, iv $$1, dkr $$2) {
      this.l = $$2;
   }

   private dkr a(@Nullable djx $$0, azx $$1, iv $$2) {
      if (this.l != null) {
         return this.l;
      } else {
         this.a($$0, $$2, this.k.a($$1).orElseGet(dkr::new));
         return this.l;
      }
   }

   public abstract void a(djx var1, iv var2, int var3);
