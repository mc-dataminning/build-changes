...
public class cik extends cib {
   ...
   public void b() {
      ...
      if (this.e % 2 == 0 && this.e < 10) {
         ...
         for (int $$4 = 0; $$4 < 8; $$4++) {
            ...
            for (int $$8 = 0; $$8 < 6; $$8++) {
               this.a.dQ().a(lm.h, $$5, $$6, $$7, -$$0.c * 0.08F * (double)$$8, -$$0.d * 0.6F, -$$0.e * 0.08F * (double)$$8);
            }
   ...
   public void c() {
      ...
      if (this.e >= 200) {
         ...
         eww $$0 = new eww(this.a.e.dv() - this.a.dv(), 0.0, this.a.e.dB() - this.a.dB()).d();
         float $$1 = 5.0F;
         ...
         $$5 = (double)(ayn.a($$5) + 1);
         this.g = new bsm(this.a.dQ(), $$2, $$5, $$3);
         this.g.a(this.a);
         this.g.a(5.0F);
         this.g.a(200);
         this.g.a(lm.h);
         this.g.a(new bry(bsa.g));
         this.a.dQ().b(this.g);
      }
   }
