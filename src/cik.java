...
public class cik extends chy {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new evm($$0, this.g.dw() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               evm $$8 = new evm(this.g.du() - this.a.du(), 0.0, this.g.dA() - this.a.dA()).d();
               evm $$9 = new evm((double)ayu.a(this.a.dF() * (float) (Math.PI / 180.0)), 0.0, (double)(-ayu.b(this.a.dF() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  evm $$13 = this.a.f(1.0F);
                  ...
                  cnb $$20 = new cnb(this.a.dP(), this.a, $$17, $$18, $$19);
   ...
   public void a(btk $$0) {
      ...
      int $$9 = ayu.a(this.g.dw() + $$8);
      eoc $$10 = new eoc($$3, $$9, $$4);
