...
public class bcq extends big {
   public bcq(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bjm.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bjm.s, "minecraft:piston");
