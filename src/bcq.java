...
public class bcq extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bis.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bis.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bis.s);
