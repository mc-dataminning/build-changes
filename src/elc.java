...
public class elc {
   ...
   static class b {
      static final Optional<elc> a = Optional.ofNullable(a());
      ...
      private static elc a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new elc();
      }
   }
}
