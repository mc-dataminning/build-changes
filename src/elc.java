...
public class elc extends elg implements ele {
   ...
   public elc.c a() {
      return new elc.c(this.p, this.l, this.t, this.u);
   }

   public void a(elc.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   public void a(elm.b $$0, elm $$1) {
      if (this.s) {
         ...
         this.p = $$0;
         this.a($$1);
         this.m = (eln)$$1.c().get(0);
         this.n = 0;
         this.h.rewind();
      }
   }

   private void a(elm $$0) {
      if (this.o != $$0) {
         this.o = $$0;
         boolean $$1 = $$0 == elf.k;
         boolean $$2 = $$0 == elf.j;
   ...
   private IntConsumer a(int $$0, elm.a $$1) {
   ...
   private elc.b o() {
      ...
      this.j += $$5;
      this.i++;
      elc.a $$9 = new elc.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new elc.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == elm.b.a || this.p == elm.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<eln> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      eln $$1 = (eln)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == eln.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == eln.b.c) {
         ele.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ele.a($$11));
         this.a($$14 + 5, ele.a($$12));
         this.a($$14 + 6, ele.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(elm a, int b, int c, elm.b d, elm.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(elm.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable elp $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
