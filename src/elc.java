...
public class elc {
   ...
   public elc(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eld> $$1) throws IOException {
   ...
   public List<eld> a(Path $$0) throws IOException {
      List<eld> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eld> a(Path $$0, boolean $$1) throws IOException {
      List<eld> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eld> $$1) throws IOException {
