...
public class fi<T> implements ArgumentType<fi.c<T>> {
   ...
   public fi(akl<? extends jk<T>> $$0) {
      this.b = $$0;
   }

   public static <T> fi<T> a(akl<? extends jk<T>> $$0) {
      return new fi<>($$0);
   }

   public static <T> fi.c<T> a(CommandContext<ee> $$0, String $$1, akl<jk<T>> $$2, DynamicCommandExceptionType $$3) throws CommandSyntaxException {
   ...
   public fi.c<T> a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         try {
            $$0.skip();
            akm $$2 = akm.a($$0);
            return new fi.d<>(awl.a(this.b, $$2));
         ...
         akm $$4 = akm.a($$0);
         return new fi.b<>(akl.a(this.b, $$4));
      }
   }
   ...
   static record b<T>(akl<T> a) implements fi.c<T> {
      @Override
      public Either<akl<T>, awl<T>> a() {
         return Either.left(this.a);
      }

      @Override
      public <E> Optional<fi.c<E>> a(akl<? extends jk<E>> $$0) {
   ...
   public interface c<T> extends Predicate<ix<T>> {
      Either<akl<T>, awl<T>> a();

      <E> Optional<fi.c<E>> a(akl<? extends jk<E>> var1);

      String b();
   }

   static record d<T>(awl<T> a) implements fi.c<T> {
      @Override
      public Either<akl<T>, awl<T>> a() {
