...
public class fi implements ArgumentType<UUID> {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wg.c("argument.uuid.invalid"));
   ...
   public static UUID a(CommandContext<du> $$0, String $$1) {
