...
public class fi implements ArgumentType<fi.a> {
   ...
   public static enum a {
      a("feet", ($$0, $$1) -> $$0),
      b("eyes", ($$0, $$1) -> new ezr($$0.d, $$0.e + (double)$$1.cU(), $$0.f));
      ...
      private final BiFunction<ezr, bui, ezr> e;

      private a(final String $$0, final BiFunction<ezr, bui, ezr> $$1) {
         this.d = $$0;
         this.e = $$1;
      }
