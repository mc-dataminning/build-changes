...
public record cxj(cxj.a e, IntList f, IntList g, boolean h, boolean i) implements cxw {
   ...
   private static final yw<ByteBuf, IntList> j = yu.f.a(yu.a()).a(IntArrayList::new, ArrayList::new);
   public static final yw<ByteBuf, cxj> d = yw.a(cxj.a.f, cxj::a, j, cxj::b, j, cxj::c, yu.b, cxj::d, yu.b, cxj::e, cxj::new);
   ...
   public static enum a implements azj {
      ...
      public static final yw<ByteBuf, cxj.a> f = yu.a(h, cxj.a::b);
      public static final Codec<cxj.a> g = azj.b(cxj.a::values);
      private final int i;
