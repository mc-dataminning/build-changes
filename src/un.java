...
public abstract class un {
   ...
   private static volatile un e = c();
   ...
   private static un c() {
      ...
      return new un() {
         ...
         @Override
         public ayl a(xu $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> azt.c($$2xxx, $$1x, $$1) ? Optional.empty() : xu.a, ym.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = un.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public abstract ayl a(xu var1);

   public List<ayl> a(List<xu> $$0) {
