...
public class alm implements AutoCloseable {
   ...
   private alm(URL $$0, alm.c $$1, URL $$2, alm.b $$3, URL $$4, alm.b $$5, String $$6, alm.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? arf.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static alm a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = arf.a($$0);
            URI $$2 = new URI(arf.i($$1, "apiServer"));
            String $$3 = arf.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arf.a($$1, "ruleId", 1);
               String $$5 = arf.a($$1, "serverId", "");
               String $$6 = arf.a($$1, "roomId", "Java:Chat");
               int $$7 = arf.a($$1, "hashesToDrop", -1);
               int $$8 = arf.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arf.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alm.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<aky> a(GameProfile $$0, String $$1, alm.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(aky.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arf.a($$4, "response", false);
            if ($$5) {
               return aky.a($$1);
            } else {
               String $$6 = arf.a($$4, "hashed", null);
               if ($$6 == null) {
                  return aky.b($$1);
               } else {
                  JsonArray $$7 = arf.v($$4, "hashes");
                  th $$8 = this.a($$1, $$7, $$2);
                  return new aky($$1, $$8);
               }
            }
   ...
   private th a(String $$0, JsonArray $$1, alm.a $$2) {
      if ($$1.isEmpty()) {
         return th.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return th.b;
      } else {
         th $$3 = new th($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alm.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public all a(GameProfile $$0) {
      return new alm.d($$0);
   }
   ...
   public interface a {
      alm.a a = ($$0, $$1) -> false;
      alm.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alm.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alm.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements all {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bfh<Runnable> $$1 = bfh.a(alm.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         alm.this.a(this.c, alm.this.g, alm.this.h, this.d);
      }

      @Override
      public void b() {
         alm.this.a(this.c, alm.this.i, alm.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<aky>> a(List<String> $$0) {
         List<CompletableFuture<aky>> $$1 = $$0.stream().map($$0x -> alm.this.a(this.c, $$0x, alm.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<aky> a(String $$0) {
         return alm.this.a(this.c, $$0, alm.this.l, this.d);
      }
   }
