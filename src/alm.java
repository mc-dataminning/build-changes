...
public final class alm<E> implements Codec<jq<E>> {
   private final alo<? extends kd<E>> a;

   public static <E> alm<E> a(alo<? extends kd<E>> $$0) {
      return new alm<>($$0);
   }

   private alm(alo<? extends kd<E>> $$0) {
      this.a = $$0;
   }
