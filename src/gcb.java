...
public class gcb {
   ...
   private gcb(int $$0, List<gcd> $$1) {
      this.a = $$1.toArray(gcd[]::new);
      this.b = $$1.size();
   }

   private List<gcd> c() {
      List<gcd> $$0 = new ArrayList<>(this.d());
