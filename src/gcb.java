...
public abstract class gcb<T extends boi, M extends fmi<T>> extends gaz<T> implements gcv<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gfl<T, M>> g = Lists.newArrayList();

   public gcb(gba.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gfl<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, esh $$3, fvt $$4, int $$5) {
      ...
      this.f.d = $$0.bO();
      this.f.e = $$0.o_();
      float $$6 = awi.j($$2, $$0.aV, $$0.aU);
      float $$7 = awi.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bO() && $$0.cZ() instanceof boi $$9) {
         $$6 = awi.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = awi.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected fwb a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      aiy $$4 = this.a($$0);
      if ($$2) {
         return fwb.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? fwb.r($$4) : null;
      }
   }

   public static int c(boi $$0, float $$1) {
      return ggs.a(ggs.a($$1), ggs.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected void a(T $$0, esh $$1, float $$2) {
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return exo.L() && $$0 != $$3.an() && $$5 && !$$0.bP();
      }
   }

   public static boolean e(boi $$0) {
      if ($$0 instanceof chl || $$0.ae()) {
         String $$1 = n.a($$0.ad().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof chl) || ((chl)$$0).a(chm.a);
         }
      }
