...
public class gcb implements gcu {
   ...
   private CompletableFuture<Optional<cop>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gcb(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cop::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cop>> a(Optional<cop> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (ayj | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cop.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cop $$0) {
      ...
      if ($$0 != null) {
         if (ab.aV) {
            cop.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cop a(UserApiService $$0) throws ayj, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         coq.a $$2 = a($$1);
         return new cop(ayi.a($$1.keyPair().privateKey()), new coq($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static coq.a a(KeyPairResponse $$0) throws ayj {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = ayi.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new coq.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new ayj(var5);
         }
      } else {
         throw new ayj(new MissingException("Missing public key"));
      }
   }
}
