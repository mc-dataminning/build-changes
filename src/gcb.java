public class gcb extends gcd {
   gcb(fxw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   ...
   public static class e implements gbg<lm> {
      private final gby a;
