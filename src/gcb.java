...
public class gcb extends fys {
   private static final int a = 20;
   private static final int b = 5;
   private static final int c = 20;
   private final wy d;
   private final List<wy> s;
   private final ImmutableList<gcb.a> u;
   private ftt v = ftt.a;
   private int w;
   private int x;

   protected gcb(wy $$0, List<wy> $$1, ImmutableList<gcb.a> $$2) {
      super($$0);
      this.s = $$1;
   ...
   public void aO_() {
      ...
      while ($$1.hasNext()) {
         gcb.a $$0 = (gcb.a)$$1.next();
         this.x = Math.max(this.x, 20 + this.p.a($$0.a) + 20);
      }

      int $$1x = 5 + this.x + 5;
      int $$2 = $$1x * this.u.size();
      this.v = ftt.a(this.p, $$2, this.s.toArray(new wy[0]));
      int $$3 = this.v.a() * 9;
      ...
      for (UnmodifiableIterator var6 = this.u.iterator(); var6.hasNext(); $$5 += $$1x) {
         gcb.a $$6 = (gcb.a)var6.next();
         this.c(fta.a($$6.a, $$6.b).a($$5, $$4, this.x, 20).a());
      }
   }
