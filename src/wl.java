...
public class wl extends ByteBuf {
   ...
   public evq k() {
      return new evq(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public evm v() {
      ...
      return new evm(new evq((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
