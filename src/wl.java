...
public class wl {
   public static <T extends wc> wl.b a(we<T> $$0) {
      return a(new wa<T>($$0));
   }

   private static wl.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends wc> wl.d b(we<T> $$0) {
      return a(new wb<T>($$0));
   }

   private static wl.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zd)) {
            $$0.fireChannelRead($$1);
         } else {
