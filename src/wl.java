...
public class wl extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vo> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, va.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vo> $$0, Codec<T> $$1, va $$2) {
      vo $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> wl a(DynamicOps<vo> $$0, Codec<T> $$1, T $$2) {
      vo $$3 = (vo)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = ayk.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zk<? super wl, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zl<? super wl, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zk<? super wl, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zk<? super wl, K> $$1, zk<? super wl, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zk<? super wl, K> $$0, zk<? super wl, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zl<? super wl, K> $$1, zl<? super wl, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zl<? super wl, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zk<? super wl, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zk<? super wl, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zk<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zl<? super wl, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zl<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static iz b(ByteBuf $$0) {
      return iz.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, iz $$1) {
      $$0.writeLong($$1.a());
   }

   public dba f() {
      return new dba(this.readLong());
   }
   ...
   public evm k() {
      return new evm(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> wl a(ToIntFunction<T> $$0, T $$1) {
   ...
   public wl a(@Nullable vo $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vo $$1) {
      if ($$1 == null) {
         $$1 = ut.b;
      }

      try {
         ve.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ur f(ByteBuf $$0) {
      vo $$1 = a($$0, va.a(2097152L));
      if ($$1 != null && !($$1 instanceof ur)) {
   ...
   @Nullable
   public static vo a(ByteBuf $$0, va $$1) {
      try {
         vo $$2 = ve.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return xb.a(this.d, $$0);
   }

   public wl a(String $$0) {
      return this.a($$0, 32767);
   }

   public wl a(String $$0, int $$1) {
      xb.a(this.d, $$0, $$1);
      return this;
   }

   public alb q() {
      return new alb(this.d(32767));
   }
   ...
   public <T> ala<T> a(ala<? extends jv<T>> $$0) {
      alb $$1 = this.q();
      return ala.a($$0, $$1);
   }
   ...
   public evi v() {
      ...
      return new evi(new evm((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ayu.e($$1, 8)));
      }
   }
   ...
   public wl a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wl a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public wl a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wl a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wl a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wl a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wl a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public wl a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public wl b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public wl c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public wl d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public wl e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public wl f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public wl g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public wl h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public wl a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public wl b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public wl i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public wl a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public wl a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public wl b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wl b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public wl b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wl b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wl b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wl b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public wl g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wl b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public wl a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wl a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public wl a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wl a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public wl a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public wl h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public wl c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public wl b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wl b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public wl b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
