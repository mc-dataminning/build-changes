...
public class byb extends bzi implements bjt, bzm {
   private static final aee<Integer> b = aeh.a(byb.class, aeg.b);
   private static final aee<Integer> c = aeh.a(byb.class, aeg.b);
   private static final aee<Integer> d = aeh.a(byb.class, aeg.b);
   private static final List<aee<Integer>> e = ImmutableList.of(b, c, d);
   private static final aee<Integer> bT = aeh.a(byb.class, aeg.b);
   ...
   private int cb;
   private final akn cc = (akn)new akn(this.N_(), bgo.a.f, bgo.b.a).a(true);
   ...
   public void b_() {
      ...
      this.f($$0);
      if ($$0.i() > 0.05) {
         this.r((float)arw.d($$0.e, $$0.c) * (180.0F / (float)Math.PI) - 90.0F);
      }
      ...
      for (int $$6 = 0; $$6 < 2; $$6++) {
         ...
         if ($$8 != null) {
            ...
            float $$16 = (float)(arw.d($$14, $$12) * 180.0F / (float)Math.PI) - 90.0F;
            float $$17 = (float)(-(arw.d($$13, $$15) * 180.0F / (float)Math.PI));
      ...
      if (this.y() > 0) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ah >= this.bZ[$$1 - 1]) {
               ...
               if ((this.dL().ai() == bgv.c || this.dL().ai() == bgv.d) && this.ca[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
                  double $$4 = arw.a(this.ag, this.dq() - 10.0, this.dq() + 10.0);
                  double $$5 = arw.a(this.ag, this.ds() - 5.0, this.ds() + 5.0);
                  double $$6 = arw.a(this.ag, this.dw() - 10.0, this.dw() + 10.0);
         ...
         if (this.cb > 0) {
            ...
            if (this.cb == 0 && this.dL().X().b(cpr.c)) {
               int $$11 = arw.a(this.ds());
               int $$12 = arw.a(this.dq());
               int $$13 = arw.a(this.dw());
               boolean $$14 = false;
   ...
   public boolean a(bho $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(apu.t) || $$0.d() instanceof byb) {
         return false;
      } else if (this.y() > 0 && !$$0.a(apu.d)) {
         return false;
      } else {
         if (this.a()) {
            biq $$2 = $$0.c();
