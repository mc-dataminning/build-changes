...
public final class cxd implements csa {
   public static final cxd a = new cxd(List.of());
   public static final Codec<cxd> b = cuq.b.listOf().xmap(cxd::new, $$0 -> $$0.f);
   public static final zn<xa, cxd> c = cuq.i.a(zl.a()).a(cxd::new, $$0 -> $$0.f);
   private static final Fraction d = Fraction.getFraction(1, 16);
   private static final int e = -1;
   final List<cuq> f;
   final Fraction g;

   cxd(List<cuq> $$0, Fraction $$1) {
      this.f = $$0;
      this.g = $$1;
   }

   public cxd(List<cuq> $$0) {
      this($$0, a($$0));
   }
   ...
   static Fraction a(cuq $$0) {
      ...
      if ($$1 != null) {
         ...
         List<dpf.c> $$2 = $$0.a(km.ac, List.of());
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cxd $$1) ? false : this.g.equals($$1.g) && cuq.a(this.f, $$1.f);
      }
   }
   ...
   public static class a {
      ...
      public cuq b() {
         if (this.a.isEmpty()) {
            ...
            this.b = this.b.subtract(cxd.a($$0).multiplyBy(Fraction.getFraction($$0.I(), 1)));
            return $$0;
         }
      }
