...
public class fnn extends fmy implements fxl.a {
   private static final alb w = new alb("textures/gui/advancements/window.png");
   ...
   private static final xl C = xl.c("advancements.sad_label");
   private static final xl D = xl.c("advancements.empty");
   private static final xl E = xl.c("gui.advancements");
   private final fkm F = new fkm(this);
   @Nullable
   private final fmy G;
   private final fxl H;
   private final Map<af, fnj> I = Maps.newLinkedHashMap();
   @Nullable
   private fnj J;
   private boolean K;
   ...
   public fnn(fxl $$0, @Nullable fmy $$1) {
      super(E);
      this.H = $$0;
      this.G = $$1;
   }
   ...
   protected void aN_() {
      ...
      if (this.J == null && !this.I.isEmpty()) {
         fnj $$0 = this.I.values().iterator().next();
         this.H.a($$0.c().b(), true);
      } else {
         this.H.a(this.J == null ? null : this.J.c().b(), true);
      }

      this.F.b(fgz.a(xk.d, $$0x -> this.d()).a(200).a());
      this.F.a($$1 -> {
   ...
   public void a(fgm $$0, int $$1, int $$2) {
      ...
      if (this.I.size() > 1) {
         for (fnj $$3 : this.I.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.J);
         }

         for (fnj $$4 : this.I.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fgm $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.J != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ag $$0) {
      fnj $$1 = fnj.a(this.m, this, this.I.size(), $$0);
      if ($$1 != null) {
         this.I.put($$0.b(), $$1);
      }
   }
