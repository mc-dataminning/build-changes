...
public class fbf implements AutoCloseable {
   ...
   private fbh a(fbb.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(fbb.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
         GlStateManager._glBindBuffer(34963, this.c);
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, gfh $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, gfh $$2) {
      $$2.a(this.i, $$0, $$1, fgi.Q().aM());
      $$2.g();
      this.c();
      $$2.f();
   }
