...
public abstract class fbf<T extends fbf<T>> {
   ...
   public fbf(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fbd.a();
         if ($$3 != null) {
         ...
         throw new fco(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fco(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fco(var2.getMessage(), var2);
      }
   }
   ...
   public static fbf<?> a(String $$0) {
      return new fbf.b($$0, 5000, 60000);
   }

   public static fbf<?> a(String $$0, int $$1, int $$2) {
      return new fbf.b($$0, $$1, $$2);
   }

   public static fbf<?> b(String $$0, String $$1) {
      return new fbf.c($$0, $$1, 5000, 60000);
   }

   public static fbf<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fbf.c($$0, $$1, $$2, $$3);
   }

   public static fbf<?> b(String $$0) {
      return new fbf.a($$0, 5000, 60000);
   }

   public static fbf<?> c(String $$0, String $$1) {
      return new fbf.d($$0, $$1, 5000, 60000);
   }

   public static fbf<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fbf.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fbf<fbf.a> {
   ...
   public static class b extends fbf<fbf.b> {
   ...
   public static class c extends fbf<fbf.c> {
      ...
      public fbf.c f() {
         try {
            ...
            throw new fco(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fbf<fbf.d> {
      private final String c;
