...
public class fbf implements AutoCloseable {
   private final fbd.a a;
   @Nullable
   private fbd.a b;
   private final fbf.a c;

   public fbf(fbd.a $$0, fbf.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fbl $$2) {
      int $$3 = $$2.a(fbm.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fbf.b a(fbd $$0, fbo $$1) {
      if (this.c.d() != fbl.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fbf.b $$3 = new fbf.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fbl a, int b, int c, fbl.c d, fbl.b e) {
   }

   public static record b(Vector3f[] a, fbl.b b) {
      @Nullable
      public fbd.a a(fbd $$0, fbo $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fbl.b $$1) {
