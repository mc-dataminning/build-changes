...
public class ayt {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axv.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axv.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayt.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ali.d($$0.substring(1)).map($$0x -> new ayt.c($$0x, true)) : ali.d($$0).map($$0x -> new ayt.c($$0x, false)), ayt.c::c
      );
   ...
   public static Codec<String> C = Codec.STRING
      .validate($$0 -> !ali.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayt.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayt.b<>($$0, $$1);
   }
   ...
   public static record c(ali a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
