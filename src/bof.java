...
public record bof(Instant a, String b, long c) {
   ...
   public static bof a(RecordedEvent $$0) {
      ...
      return new bof($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bof.a a(List<bof> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bof>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bof $$3 = (bof)$$2x.get(0);
            bof $$4 = (bof)$$2x.get($$2x.size() - 1);
