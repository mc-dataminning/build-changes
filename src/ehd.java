...
public class ehd extends ehi {
   ...
   public List<efq.a> a(dda $$0, BiConsumer<jd, dta> $$1, ayv $$2, int $$3, jd $$4, efa $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayn.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayn.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ehd.a> $$13 = Lists.newArrayList();
      $$13.add(new ehd.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jd $$21 = $$4.b(ayn.a($$19), $$12 - 1, ayn.a($$20));
               jd $$22 = $$21.b(5);
      ...
      List<efq.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dda $$0, BiConsumer<jd, dta> $$1, ayv $$2, jd $$3, jd $$4, boolean $$5, efa $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jd $$13 = $$3.b(ayn.d(0.5F + (float)$$12 * $$9), ayn.d(0.5F + (float)$$12 * $$10), ayn.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dmj.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dda $$0, BiConsumer<jd, dta> $$1, ayv $$2, int $$3, jd $$4, List<ehd.a> $$5, efa $$6) {
      for (ehd.a $$7 : $$5) {
         int $$8 = $$7.a();
