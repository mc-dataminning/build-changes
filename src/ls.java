...
public class ls implements la {
   private final lc d;
   private final CompletableFuture<ip.a> e;

   public ls(lc $$0, CompletableFuture<ip.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   private static <T> JsonElement a(jt<T> $$0, DynamicOps<JsonElement> $$1) {
      ajv $$2 = kt.as.b($$0.a());
