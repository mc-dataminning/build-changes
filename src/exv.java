...
public class exv {
   ...
   @Nullable
   private String g;
   private static final exv.a h = new exv.a() {
      @Nullable
      @Override
      public exu a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (exy.a(this.d, "Get capabilities")) {
         ...
         if (exy.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  exy.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !exy.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public exu a(exv.c $$0) {
      return ($$0 == exv.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements exv.a {
      private final int a;
      private final Set<exu> b = Sets.newIdentityHashSet();
      ...
      public exu a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               exv.a.warn("Maximum sound pool size {} reached", this.a);
            }
