...
public class exv {
   ...
   private exv(String $$0, @Nullable String[] $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public wg a() {
      if (!gmo.a(this.c)) {
         ...
         return this.d == null ? wg.c(this.c) : wg.a(this.c, this.d);
      }
   }

   public static exv a(JsonObject $$0) {
      String $$1 = fab.a("translationKey", $$0);
