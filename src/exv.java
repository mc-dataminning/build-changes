...
public class exv extends exz {
   private static final int a = 20;
   private static final int b = 5;
   private static final int c = 20;
   private final tf k;
   private final tj l;
   private final ImmutableList<exv.a> m;
   private eta n = eta.a;
   private int o;
   private int p;

   protected exv(tf $$0, List<tf> $$1, ImmutableList<exv.a> $$2) {
      super($$0);
      this.l = tj.a($$1);
   ...
   public void aE_() {
      ...
      for (UnmodifiableIterator var6 = this.m.iterator(); var6.hasNext(); $$5 += $$1x) {
         exv.a $$6 = (exv.a)var6.next();
         this.d(esh.a($$6.a, $$6.b).a($$5, $$4, this.p, 20).a());
      }
   }
