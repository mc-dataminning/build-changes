...
public enum exv implements azk {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azk.a<exv> t = azk.a(exv::values);
   public static final IntFunction<exv> u = axe.a(exv::a, values(), axe.a.a);
   private final int v;
   private final String w;

   private exv(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
