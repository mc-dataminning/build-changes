...
public final class exv implements AutoCloseable {
   ...
   public exv(int $$0, int $$1, boolean $$2) {
      this(exv.a.a, $$0, $$1, $$2);
   }

   public exv(exv.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private exv(exv.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static exv a(InputStream $$0) throws IOException {
      return a(exv.a.a, $$0);
   }

   public static exv a(@Nullable exv.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static exv a(ByteBuffer $$0) throws IOException {
      return a(exv.a.a, $$0);
   }

   public static exv a(byte[] $$0) throws IOException {
   ...
   public static exv a(@Nullable exv.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new exv($$0 == null ? exv.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public exv a(IntUnaryOperator $$0) {
      if (this.c != exv.a.a) {
         ...
         this.j();
         exv $$1 = new exv(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void b(int $$0, int $$1, int $$2) {
      if (this.c != exv.a.a) {
         ...
         int $$3 = this.a($$0, $$1);
         float $$4 = (float)axp.a.a($$2) / 255.0F;
         float $$5 = (float)axp.a.d($$2) / 255.0F;
         float $$6 = (float)axp.a.c($$2) / 255.0F;
         float $$7 = (float)axp.a.b($$2) / 255.0F;
         float $$8 = (float)axp.a.a($$3) / 255.0F;
         float $$9 = (float)axp.a.d($$3) / 255.0F;
         float $$10 = (float)axp.a.c($$3) / 255.0F;
         float $$11 = (float)axp.a.b($$3) / 255.0F;
         float $$13 = 1.0F - $$4;
         float $$14 = $$4 * $$4 + $$8 * $$13;
         float $$15 = $$5 * $$4 + $$9 * $$13;
         float $$16 = $$6 * $$4 + $$10 * $$13;
         ...
         this.a($$0, $$1, axp.a.a($$18, $$19, $$20, $$21));
      }
   }
      ...
      if (this.c != exv.a.a) {
         ...
         for (int $$1 = 0; $$1 < this.b(); $$1++) {
            for (int $$2 = 0; $$2 < this.a(); $$2++) {
               int $$3 = this.a($$2, $$1);
               $$0[$$2 + $$1 * this.a()] = axp.b.a(axp.a.a($$3), axp.a.b($$3), axp.a.c($$3), axp.a.d($$3));
            }
         }
   ...
   public void a(FT_Face $$0, int $$1) {
      if (this.c.a() != 1) {
         ...
         fjb.a(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph");
   ...
   public void a(exv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, exv $$4) {
      this.j();
      if ($$4.c() != this.c) {
