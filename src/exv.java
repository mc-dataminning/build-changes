...
public abstract class exv {
   ...
   public ewx a() {
      if (this.c()) {
         ...
         return new ewx(this.b(ji.a.a), this.b(ji.a.b), this.b(ji.a.c), this.c(ji.a.a), this.c(ji.a.b), this.c(ji.a.c));
      }
   }

   public exv b() {
      return this.c() ? exs.a() : exs.a(this.b(ji.a.a), this.b(ji.a.b), this.b(ji.a.c), this.c(ji.a.a), this.c(ji.a.b), this.c(ji.a.c));
   }
   ...
   public exv a(double $$0, double $$1, double $$2) {
      return (exv)(this.c() ? exs.a() : new exe(this.a, new exr(this.a(ji.a.a), $$0), new exr(this.a(ji.a.b), $$1), new exr(this.a(ji.a.c), $$2)));
   }

   public exv d() {
      exv[] $$0 = new exv[]{exs.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = exs.b($$0[0], exs.a($$1, $$2, $$3, $$4, $$5, $$6), exg.o));
      return $$0[0];
   }

   public void a(exs.a $$0) {
      this.a
         .a(
   ...
   public List<ewx> e() {
      List<ewx> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new ewx($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(ji.a.a, $$4.c - (double)$$2.u()), this.a(ji.a.b, $$4.d - (double)$$2.v()), this.a(ji.a.c, $$4.e - (double)$$2.w()))
               ? new ewy($$4, ji.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : ewx.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<exc> a(exc $$0) {
      if (this.c()) {
   ...
   public exv a(ji $$0) {
      if (!this.c() && this != exs.b()) {
         if (this.b != null) {
            exv $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private exv b(ji $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ext(this, $$1, $$4);
      }
   }

   public double a(ji.a $$0, ewx $$1, double $$2) {
      return this.a(ja.a($$0, ji.a.a), $$1, $$2);
   }

   protected double a(ja $$0, ewx $$1, double $$2) {
      if (this.c()) {
         return $$2;
