...
public class exv extends LongLinkedOpenHashSet {
   private final exv.a a;

   public exv(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new exv.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azz.f(60000000);
      private static final int b = azz.f(60000000);
