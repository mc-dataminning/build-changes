...
public class gti {
   ...
   public static class a extends Thread {
      ...
      public a(gti.b $$0) throws IOException {
         super("LanServerDetector #" + gti.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gti.b));
   ...
   public static class b {
      private final List<gth> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gth> a() {
         if (this.b) {
            List<gth> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
