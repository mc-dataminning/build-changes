...
public final class ecq extends ect<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private ecq(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ecq $$1 && super.equals($$0)) {
   ...
   public static ecq a(String $$0, int $$1, int $$2) {
