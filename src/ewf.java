...
public class ewf {
   ...
   public static List<ewf.a> a(String $$0, ewf.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<ewf.a> a(String $$0, List<ewf.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<ewf.a> a(List<String> $$0, List<ewf.b> $$1) {
      int $$2 = 0;
      List<ewf.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<ewf.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static ewf.b a(String $$0, String $$1) {
         return new ewf.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static ewf.b a(String $$0) {
         return new ewf.b($$0);
      }
   }
}
