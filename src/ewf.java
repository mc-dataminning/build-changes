...
public class ewf {
   ...
   private static final Queue<ewf.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ewf.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ewf::a), ewd::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ewf::a), ewd::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ewf.a(this.b) + ", type=" + ewf.b(this.c) + ", severity=" + ewf.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
