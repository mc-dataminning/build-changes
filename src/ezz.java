...
public class ezz {
   ...
   static class b {
      static final Optional<ezz> a = Optional.ofNullable(a());
      ...
      private static ezz a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezz();
      }
   }
}
