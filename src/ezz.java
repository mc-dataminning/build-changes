...
public class ezz {
   ...
   private static final Queue<ezz.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ezz.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ezz::a), ezx::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ezz::a), ezx::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ezz.a(this.b) + ", type=" + ezz.b(this.c) + ", severity=" + ezz.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
