...
public class ezz {
   public static void a(fol<?> $$0, ezx $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<ezw>> $$6 : $$1.c().entrySet()) {
         Optional<frd> $$7 = $$0.a($$6.getKey());
         List<ezw> $$8 = $$6.getValue();
   ...
   private static float a(ezx $$0, long $$1) {
