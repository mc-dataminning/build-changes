...
public class ezz implements faa, fab {
   ...
   private final ffd<MinecraftServer> G;
   ...
   public ezz(dkb $$0, eib $$1, ezz.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iv.c,
   ...
   public static <T> ezz a(Dynamic<T> $$0, dkb $$1, ezz.a $$2, eib $$3, Lifecycle $$4) {
      ...
      return new ezz(
         ...
         new ffd<>(ffc.a, $$0.get("ScheduledEvents").asStream()),
         (tz)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(efe.a.a).resultOrPartial(f::error).orElse(efe.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jt $$0, tz $$1, @Nullable tz $$2) {
      ...
      $$1.a("Version", $$3);
      uo.e($$1);
      DynamicOps<uy> $$4 = $$0.a(un.a);
      ehz.a($$4, this.h, $$0).resultOrPartial(ag.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", efe.a.a, this.y);
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }
   ...
   @Override
   public boolean z() {
      return this.i == ezz.a.b;
   }

   @Override
   public boolean A() {
      return this.i == ezz.a.c;
   }
