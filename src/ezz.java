...
public class ezz {
   ...
   public void a(cen $$0, esh $$1, float $$2, int $$3, int $$4) {
      cgf $$5 = $$0.b(this.d);
   ...
   private void a(cgf $$0, aey $$1, float $$2, esh $$3, int $$4, int $$5) {
      fzg $$6 = eqx.O().a(fzf.e).apply($$1);
