public abstract class fqi {
   ...
   protected final foc d;
   protected final bnh e;

   protected fqi(foc $$0, bnh $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public void a(foe $$0, int $$1, int $$2) {
      int $$3 = $$0.b();
      $$0.a(gmi.L(), $$1, $$3 - 60, $$1 + $$2, $$3, -1873784752);
      long $$4 = 0L;
      long $$5 = 2147483647L;
      long $$6 = -2147483648L;
      ...
      $$0.a(gmi.L(), $$1, $$1 + $$2 - 1, $$3 - 60, -1);
      $$0.a(gmi.L(), $$1, $$1 + $$2 - 1, $$3 - 1, -1);
      $$0.b(gmi.L(), $$1, $$3 - 60, $$3, -1);
      $$0.b(gmi.L(), $$1 + $$2 - 1, $$3 - 60, $$3, -1);
      if ($$8 > 0) {
   ...
   protected void b(foe $$0, int $$1, int $$2, int $$3) {
      long $$4 = this.e.a($$3);
      int $$5 = this.b((double)$$4);
      int $$6 = this.a($$4);
      $$0.a(gmi.L(), $$2, $$1 - $$5, $$2 + 1, $$1, $$6);
   }

   protected void c(foe $$0, int $$1, int $$2, int $$3) {
   }
   ...
   protected void d(foe $$0, int $$1, int $$2, int $$3) {
   }

   protected void a(foe $$0, String $$1, int $$2, int $$3) {
      $$0.a(gmi.L(), $$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
