...
public class fqi extends flz {
   private static final wx c = wx.c("gui.socialInteractions.title");
   private static final akn d = new akn("social_interactions/background");
   private static final akn r = new akn("icon/search");
   ...
   private final fjn L = new fjn(this);
   @Nullable
   private final flz M;
   fqh N;
   fgj O;
   ...
   protected void aN_() {
      ...
      int $$1 = this.N.r();
      int $$2 = this.N.s();
      this.R = this.c(fga.a(s, $$0x -> this.a(fqi.a.a)).a($$1, 45, $$0, 20).a());
      this.S = this.c(fga.a(u, $$0x -> this.a(fqi.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.T = this.c(fga.a(v, $$0x -> this.a(fqi.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.O != null ? this.O.a() : "";
      this.O = new fgj(this.p, this.D() + 28, 74, 200, 15, z) {
         @Override
         protected xl aL_() {
            return !fqi.this.O.a().isEmpty() && fqi.this.N.d() ? super.aL_().f(", ").b(fqi.A) : super.aL_();
         }
      };
      this.O.f(16);
      this.O.g(true);
      ...
      this.c(this.O);
      this.d(this.N);
      this.U = this.c(fga.a(D, fkq.b(this, "https://aka.ms/javablocking")).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.X = true;
      this.a(this.Q);
      this.L.b(fga.a(ww.d, $$0x -> this.d()).a(200).a());
      this.L.a($$1x -> {
