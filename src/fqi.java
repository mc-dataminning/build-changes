...
public class fqi {
   ...
   public fqi(Runnable $$0, Function<atx, alf> $$1, aua $$2, Consumer<aua> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fqi.a> a() {
      return this.c.stream().map($$0 -> new fqi.d($$0));
   }

   public Stream<fqi.a> b() {
      return this.b.stream().map($$0 -> new fqi.c($$0));
   }
   ...
   abstract class b implements fqi.a {
      private final atx b;
      ...
      @Override
      public alf a() {
         return fqi.this.d.apply(this.b);
      }
