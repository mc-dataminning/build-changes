...
public class tn extends tp<to> {
   ...
   public static final up<tn> a = new up.b<tn>() {
      public tn a(DataInput $$0, tz $$1) throws IOException {
         return new tn(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof tn && Arrays.equals(this.c, ((tn)$$0).c);
   }
   ...
   public to a(int $$0) {
      return to.a(this.c[$$0]);
   }

   public to a(int $$0, to $$1) {
      byte $$2 = this.c[$$0];
      this.c[$$0] = $$1.i();
      return to.a($$2);
   }

   public void b(int $$0, to $$1) {
   ...
   public boolean b(int $$0, un $$1) {
      if ($$1 instanceof ug) {
         this.c = ArrayUtils.add(this.c, $$0, ((ug)$$1).i());
         return true;
      } else {
         return false;
      }
