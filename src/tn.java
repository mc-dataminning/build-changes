...
public class tn implements tm {
   ...
   public void a(tg $$0) {
      ...
      vd $$3 = vd.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = vd.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(sj $$0) {
      vd $$1 = vd.b("b").a(g);
      this.t = vd.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(sq $$0) {
      this.t = vd.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(so $$0) {
      vd $$1 = vd.b("f").a(g);
      this.t = vd.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(sm $$0) {
      vd $$1 = vd.b("d").a(g);
      this.t = vd.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(si $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         vr $$5 = vd.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(sp $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(vd.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(ss $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         vd $$5 = vd.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(sr $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new tn(this.r, this.s).a($$0.k($$3)));
         }
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            vr $$6 = vd.b(Strings.repeat(this.r, this.s + 1));
            $$6.b(new tn(this.r, this.s + 1).a($$0.k($$5)));
            if ($$5 != $$0.size() - 1) {
   ...
   public void a(sl $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            vr $$6 = vd.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new tn(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static vd a(String $$0) {
      if (h.matcher($$0).matches()) {
         return vd.b($$0).a(d);
      } else {
         String $$1 = tg.b($$0);
         String $$2 = $$1.substring(0, 1);
         vd $$3 = vd.b($$1.substring(1, $$1.length() - 1)).a(d);
         return vd.b($$2).b($$3).f($$2);
      }
   }
