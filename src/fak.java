...
public class fak extends eyy<cfz> {
      ...
      if (this.P) {
         ...
         for (int $$7 = this.O; $$7 < $$5 && $$7 < this.p.n(); $$7++) {
            ...
            if ($$1 >= $$9 && $$1 < $$9 + 16 && $$2 >= $$10 && $$2 < $$10 + 18) {
               $$0.b(this.i, $$6.get($$7).a(this.f.r.B_()), $$1, $$2);
            }
         }
      }
   }
   ...
   private void b(erv $$0, int $$1, int $$2, int $$3) {
      List<cmr> $$4 = this.p.m();
