...
public class fak {
   ...
   public void a(fbu $$0, String $$1, fcq.a $$2, epv $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fak.b $$13 = new fak.b($$1.trim(), this.f, $$3, $$2);
                  fak.a $$14 = new fak.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fak.c $$30 = new fak.c(this.f, $$2, $$0);
                        fak.a $$31 = new fak.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fby(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epv $$2) throws IOException {
      ...
      File $$15 = new File(ffe.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final epv $$2, final fcq.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fak.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fak.this.b && !fak.this.d) {
            try {
               fak.this.e = true;
               fak.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fak.a.error("Error extracting archive", var3);
               fak.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fcq.a c;
      private final fbu d;

      c(final File $$0, final fcq.a $$1, final fbu $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fak.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fak.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fak.this.g);
                  fak.this.c = true;
               } else {
                  fak.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fak.this.d = true;
               }
            } catch (IOException var3) {
               fak.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fak.this.d = true;
            }
         }
      }
