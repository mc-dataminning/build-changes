...
public class fgs implements AutoCloseable {
   private static final int a = 128;
   private static final int b = 128;
   final goy c;
   final gpu d;
   private final Int2ObjectMap<fgs.a> e = new Int2ObjectOpenHashMap();

   public fgs(goy $$0, gpu $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public void a(ezw $$0, gdm $$1, epg $$2, epi $$3, boolean $$4, int $$5) {
      this.b($$2, $$3).a($$0, $$1, $$4, $$5);
   }

   private fgs.a b(epg $$0, epi $$1) {
      return (fgs.a)this.e.compute($$0.b(), ($$1x, $$2) -> {
         if ($$2 == null) {
            return new fgs.a($$1x, $$1);
         } else {
            $$2.a($$1);
            return $$2;
         }
   ...
   class a implements AutoCloseable {
      ...
      a(final int $$0, final epi $$1) {
         this.b = $$1;
         this.c = new gok(128, 128, true);
         ale $$2 = fgs.this.c.a("map/" + $$0, this.c);
         this.d = gdu.t($$2);
      }
      ...
      private void b() {
         for (int $$0 = 0; $$0 < 128; $$0++) {
            for (int $$1 = 0; $$1 < 128; $$1++) {
               int $$2 = $$1 + $$0 * 128;
               this.c.e().a($$1, $$0, enx.b(this.b.g[$$2]));
            }
         }
      ...
      void a(ezw $$0, gdm $$1, boolean $$2, int $$3) {
         if (this.e) {
            this.b();
            this.e = false;
         }
         ...
         for (epc $$10 : this.b.h()) {
            if (!$$2 || $$10.b()) {
               ...
               Matrix4f $$11 = $$0.c().a();
               float $$12 = -0.001F;
               gox $$13 = fgs.this.d.a($$10);
               float $$14 = $$13.c();
               float $$15 = $$13.g();
               float $$16 = $$13.d();
               float $$17 = $$13.h();
               faa $$18 = $$1.getBuffer(gdu.t($$13.i()));
               ...
               if ($$10.g().isPresent()) {
                  ...
                  float $$22 = ayx.a(25.0F / $$21, 0.0F, 6.0F / 9.0F);
                  $$0.a();
                  $$0.a(0.0F + (float)$$10.d() / 2.0F + 64.0F - $$21 * $$22 / 2.0F, 0.0F + (float)$$10.e() / 2.0F + 64.0F + 4.0F, -0.025F);
                  $$0.b($$22, $$22, 1.0F);
                  $$0.a(0.0F, 0.0F, -0.1F);
                  $$19.a($$20, 0.0F, 0.0F, -1, false, $$0.c().a(), $$1, fgn.a.a, Integer.MIN_VALUE, $$3);
                  $$0.b();
               }
