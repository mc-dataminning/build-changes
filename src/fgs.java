...
public class fgs extends ffu {
   ...
   public fgs(ffl $$0, int $$1, int $$2, int $$3, int $$4, wx $$5, wx $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fgv($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fjw $$0) {
      $$0.a(fjv.a, wx.a("gui.narrate.editBox", this.y(), this.j()));
   }
   ...
   protected void a(ffn $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         wx $$2 = wx.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      fgv.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fgv.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
