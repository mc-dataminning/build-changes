...
public class azp extends bea {
   public azp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bfa.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bfa.s, "minecraft:jukebox");
