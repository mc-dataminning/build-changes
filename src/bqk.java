...
public class bqk {
   ...
   private final List<bqi> d = Lists.newArrayList();
   private final bso e;
   private int f;
   private int g;
   private int h;
   ...
   public void a(bqn $$0, float $$1) {
      this.c();
      bqs $$2 = bqs.a(this.e);
      bqi $$3 = new bqi($$0, $$1, $$2, this.e.ac);
      this.d.add($$3);
      this.f = this.e.ai;
      this.j = true;
   ...
   private static boolean a(bqn $$0) {
      return $$0.d() instanceof bso;
   }

   private wx a(bru $$0, wx $$1, String $$2, String $$3) {
      cto $$5 = $$0 instanceof bso $$4 ? $$4.eX() : cto.i;
      return !$$5.e() && $$5.b(kb.f) ? wx.a($$2, this.e.O_(), $$1, $$5.G()) : wx.a($$3, this.e.O_(), $$1);
   }

   private wx a(bqi $$0, @Nullable bru $$1) {
      bqn $$2 = $$0.a();
      if (!$$2.a(avy.n) && !$$2.a(avy.t)) {
         ...
         bqs $$3 = Objects.requireNonNullElse($$0.c(), bqs.a);
         return wx.a($$3.a(), this.e.O_());
      }
   }

   @Nullable
   private static wx a(@Nullable bru $$0) {
   ...
   public wx a() {
      if (this.d.isEmpty()) {
         ...
         bqi $$0 = this.d.get(this.d.size() - 1);
         bqn $$1 = $$0.a();
         bqi $$2 = this.d();
         bqr $$3 = $$1.j().e();
         if ($$3 == bqr.b && $$2 != null) {
