...
public class bqk implements bqd {
   ...
   public static Set<bqb> a() {
      Builder<bqb> $$0 = ImmutableSet.builder();

      try {
         bqk.a $$1 = new bqk.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bqb.a("cpu#" + $$1x, bqa.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bqb.a("heap MiB", bqa.e, () -> (double)ad.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bqc.a.a());
      return $$0.build();
   }
   ...
   public static bqb a(final LongSupplier $$0) {
      ...
      bqb.d $$3 = new bqb.d(2.0F);
      return bqb.a("ticktime", bqa.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
