...
public interface bqk<T, F> {
   ...
   public static final class a implements bqk<bqk.b, Runnable> {
   ...
   public static final class c<T> implements bqk<T, T> {
