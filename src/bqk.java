...
public class bqk extends bqp {
   public static final MapCodec<bqk> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bqk a(float $$0, float $$1, int $$2, int $$3) {
      return new bqk($$0, $$1, $$2, $$3);
   }

   private bqk(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(azk $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)azc.a(azc.c($$0, $$1, $$2), $$3, $$4);
   }
