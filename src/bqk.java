...
public class bqk extends epi {
   private static final Logger a = LogUtils.getLogger();
   private final long b;
   private int c;
   private boolean d = true;
   private boolean e = true;
   private final Map<akk, bqj> f = new Object2ObjectOpenHashMap();

   public static epi.a<bqk> a(long $$0) {
      return new epi.a<>(() -> new bqk($$0), ($$1, $$2) -> a($$0, $$1), azl.m);
   }
   ...
   private bqj b(akk $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new bqj($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<akk, bqj> $$0) {
      this.f.forEach($$0);
   }
   ...
   public tx a(tx $$0, jl.a $$1) {
      ...
      tx $$2 = new tx();
      this.f.forEach(($$1x, $$2x) -> $$2.a($$1x.toString(), (uu)bqj.a.encodeStart(ul.a, $$2x).result().orElseThrow()));
      $$0.a("sequences", $$2);
      return $$0;
   }
   ...
   public static bqk a(long $$0, tx $$1) {
      bqk $$2 = new bqk($$0);
      ...
      for (String $$5 : $$3.e()) {
         try {
            bqj $$6 = (bqj)((Pair)bqj.a.decode(ul.a, $$3.c($$5)).result().get()).getFirst();
            $$2.f.put(new akk($$5), $$6);
   ...
   class a implements aym {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return $$0 instanceof bqk.a $$1 ? this.c.equals($$1.c) : false;
         }
      }
   }
}
