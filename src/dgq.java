...
public class dgq {
   ...
   public dgq a(dgq.a $$0) {
      return new dgq($$0, this.f);
   }

   public jq<dgo> a(jh $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jq<dgo> a(double $$0, double $$1, double $$2) {
      int $$3 = kb.a(azm.a($$0));
      int $$4 = kb.a(azm.a($$1));
      int $$5 = kb.a(azm.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      jq<dgo> getNoiseBiome(int var1, int var2, int var3);
   }
}
