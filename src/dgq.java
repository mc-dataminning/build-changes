...
public class dgq {
   ...
   private double j;
   int k = 29999984;
   private dgq.a l = new dgq.d(5.999997E7F);
   public static final dgq.c e = new dgq.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dgq.a)($$0 == $$1 ? new dgq.d($$1) : new dgq.b($$0, $$1, $$2));
   ...
   public dgq.c t() {
      return new dgq.c(this);
   }

   public void a(dgq.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dgq.a {
      ...
      @Override
      public double a() {
         return arp.a(dgq.this.a() - this.e() / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
      }

      @Override
      public double c() {
         return arp.a(dgq.this.b() - this.e() / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
      }
      ...
      @Override
      public dgp i() {
         return this.c < this.b ? dgp.b : dgp.a;
      }
      ...
      @Override
      public dgq.a l() {
         return (dgq.a)(this.g() <= 0L ? dgq.this.new d(this.c) : this);
      }
      ...
      public ehw m() {
         return eht.a(
            eht.c,
            eht.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehh.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dgq.c a(DynamicLike<?> $$0, dgq.c $$1) {
         ...
         return new dgq.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dgq.a {
      ...
      private void n() {
         this.c = arp.a(dgq.this.a() - this.b / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
         this.d = arp.a(dgq.this.b() - this.b / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
         this.e = arp.a(dgq.this.a() + this.b / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
         this.f = arp.a(dgq.this.b() + this.b / 2.0, (double)(-dgq.this.k), (double)dgq.this.k);
         this.g = eht.a(
            eht.c,
            eht.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehh.e
