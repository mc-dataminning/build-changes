...
public final class km {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> af.a($$0, 4).map(km::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final yt<ByteBuf, UUID> g = new yt<ByteBuf, UUID>() {
