...
public class fzk extends qn {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private fzk(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static fzk a(ank $$0, List<String> $$1, boolean $$2) {
      ...
      return new fzk(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<ani> $$1, Map<String, String> $$2) {
      for (ani $$3 : $$1) {
