...
public class fzk extends fyl<cvt> {
   private float G;
   private float H;
   private boolean I;
   private final fzc J;
   ...
   public fzk(cqy $$0) {
      super($$0.bP, new gbp($$0.bP), $$0.gi(), wy.c("container.crafting"));
      this.v = 97;
      this.J = new fzc(this);
   }
   ...
   public void E() {
      super.E();
      if (this.m.t.fU()) {
         this.m.a(new fyz(this.m.t, this.m.t.j.y(), this.m.n.L().c()));
      }
   }
   ...
   @Override
   protected fwi G() {
      return new fwi(this.C + 104, this.o / 2 - 22);
   }
   ...
   protected void a(fro $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(gqc::H, a, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      a($$0, $$4 + 26, $$5 + 8, $$4 + 75, $$5 + 78, 30, 0.0625F, this.G, this.H, this.m.t);
   }

   public static void a(fro $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bxc $$9) {
   ...
   public static void a(fro $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bxc $$7) {
      $$0.c().a();
