...
public class hbp implements hbi {
   ...
   private hbp(List<alz> $$0, alz $$1, Map<String, alz> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(hbo a, Supplier<IntUnaryOperator> b, alz c) implements hbi.b {
      @Nullable
      public hay a(hbh $$0) {
         Object var3;
         try {
            ffl $$1 = this.a.a().a(this.b.get());
            return new hay(this.c, new hcs($$1.a(), $$1.b()), $$1, avx.a);
         } catch (IllegalArgumentException | IOException var7) {
            hbp.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
