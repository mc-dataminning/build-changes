public abstract class hbp<M extends ghq> extends hbh<hel, M> {
   private final ghg a;
   private final alg b;
   private final hbp.a c;

   public hbp(gxu<?, hel, M> $$0, ghg $$1, alg $$2, hbp.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(hel var1);
   ...
   private void a(fjy $$0, gqm $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hja.d);
   }
