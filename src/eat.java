...
public class eat implements ebt<bvf> {
   ...
   public eat(ebe $$0, ash $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = new bru($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<ebo<bvf>> a(dgg $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               List<bvf> $$6 = bvm.a($$5, this.d, bvl.r).collect(ImmutableList.toImmutableList());
               return new ebo<>($$0, $$6);
            }
         }, this.g::a_);
      }
   ...
   private static dgg a(ux $$0) {
      int[] $$1 = $$0.n("Position");
      return new dgg($$1[0], $$1[1]);
   }

   private static void a(ux $$0, dgg $$1) {
      $$0.a("Position", new vb(new int[]{$$1.g, $$1.h}));
   }

   private static ebo<bvf> b(dgg $$0) {
      return new ebo<>($$0, ImmutableList.of());
   }

   @Override
   public void a(ebo<bvf> $$0) {
      dgg $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
   ...
   private void a(CompletableFuture<?> $$0, dgg $$1) {
      $$0.exceptionally($$1x -> {
   ...
   private void b(CompletableFuture<?> $$0, dgg $$1) {
      $$0.exceptionally($$1x -> {
