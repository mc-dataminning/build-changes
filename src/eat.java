...
public class eat extends eay {
   public static final Codec<eat> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, eat::new));
   ...
   public List<dzg.a> a(cxf $$0, BiConsumer<ib, dmz> $$1, axd $$2, int $$3, ib $$4, dyq $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = aww.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, aww.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eat.a> $$13 = Lists.newArrayList();
      $$13.add(new eat.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ib $$21 = $$4.b(aww.a($$19), $$12 - 1, aww.a($$20));
               ib $$22 = $$21.b(5);
      ...
      List<dzg.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cxf $$0, BiConsumer<ib, dmz> $$1, axd $$2, ib $$3, ib $$4, boolean $$5, dyq $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ib $$13 = $$3.b(aww.d(0.5F + (float)$$12 * $$9), aww.d(0.5F + (float)$$12 * $$10), aww.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dgl.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cxf $$0, BiConsumer<ib, dmz> $$1, axd $$2, int $$3, ib $$4, List<eat.a> $$5, dyq $$6) {
      for (eat.a $$7 : $$5) {
         int $$8 = $$7.a();
