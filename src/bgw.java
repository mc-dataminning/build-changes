...
public class bgw implements bgx {
   ...
   private static final bgw j = new bgw();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bgv $$0) {
      URL $$1 = bgw.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bgv $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bgz a = new bgz(() -> bgw.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bgw.this.k && $$0.getState() == RecordingState.STOPPED) {
