...
public class gwn extends gxf<cnv, hcs, gfz> {
   ...
   private static final gqc k = gqc.g(j);

   public gwn(gvz.a $$0) {
      this($$0, 0.5F, git.bh);
   }

   protected gwn(gvz.a $$0, float $$1, gis $$2) {
      super($$0, new gfz($$0.a($$2)), $$1);
   }

   public boolean a(cnv $$0, gtl $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.x()) {
            bxc $$5 = $$0.gq();
            if ($$5 != null) {
               fei $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               fei $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new fed($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private fei a(bxc $$0, double $$1, float $$2) {
   ...
   public void a(hcs $$0, fjc $$1, gps $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fei $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fjc $$0, fjg $$1, fei $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fjg $$0, fjc.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hif.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cnv $$0, hcs $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.n($$2);
   ...
   @Nullable
   private static bwd a(cnv $$0) {
      bwd $$1 = fos.Q().ao();
      return (bwd)($$0.x() ? $$0.gq() : $$1);
   }
}
