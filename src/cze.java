...
public class cze extends css {
   public static final MapCodec<cze> c = b(cze::new);
   public static final dfu d = dft.r;
   private static final Map<cph, List<cze.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(cqb $$0, gw $$1, boolean $$2) {
      List<cze.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new cze.a($$1.i(), $$0.V()));
      }
