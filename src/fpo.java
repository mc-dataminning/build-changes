...
public abstract class fpo implements fqt, frn, ftg, ftl {
   ...
   private int f;
   private boolean m;
   private final fre n = new fre();

   public fpo(int $$0, int $$1, int $$2, int $$3, wp $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fpc $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fpc var1, int var2, int var3, float var4);

   protected static void a(fpc $$0, fpa $$1, wp $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fpc $$0, fpa $$1, wp $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fpc $$0, fpa $$1, int $$2, int $$3) {
      int $$4 = this.F() + $$2;
   ...
   public static void b(hku $$0) {
      $$0.a(hjj.a(awa.Bp, 1.0F));
   }
   ...
   public ftl.a w() {
      if (this.aM_()) {
         ...
         return this.i ? ftl.a.b : ftl.a.a;
      }
   }

   @Override
   public final void b(ftn $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(ftn var1);

   protected void c(ftn $$0) {
      $$0.a(ftm.a, this.d());
      if (this.j) {
         if (this.aM_()) {
            $$0.a(ftm.d, wp.c("narration.button.usage.focused"));
         } else {
