public class fpo extends foc {
   ...
   public fpo(fqj $$0, fqi $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   public void b(fnr $$0, int $$1, int $$2, float $$3) {
      $$0.a(glu::C, a.a(this.b(), this.B()), this.D(), this.E(), this.g, this.h);
      fnp $$4 = fmf.Q().h;
   ...
   protected void a(fnr $$0, int $$1, int $$2, int $$3, int $$4) {
      ftx.a($$0, ftx.g, $$1, $$2, 0.0F, 0.0F, $$3 - $$1, $$4 - $$2);
   }
   ...
   private void b(fnr $$0, fnp $$1, int $$2) {
   ...
   protected void a(fsc $$0) {
      $$0.a(fsb.a, xv.a("gui.narrate.tab", this.n.a()));
   }
