...
public class fpo implements hgm {
   private static final long a = 3000L;
   private final fmg b;
   private final List<fpo.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fpo.b> e = new ArrayList<>();
   ...
   public void a(fns $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fpo.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hfi $$0, hgo $$1, float $$2) {
      if ($$1.a() != null) {
         xv $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fpo.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fby($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fpo.b($$3, $$2, new fby($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fby a, long b) {
   }

   static class b {
      private final xv a;
      private final float b;
      private final List<fpo.a> c = new ArrayList<>();

      public b(xv $$0, float $$1, fby $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fpo.a($$2, ae.c()));
      }
      ...
      public void b(fby $$0) {
         ...
         this.c.add(new fpo.a($$0, ae.c()));
      }

      public boolean c(fby $$0) {
