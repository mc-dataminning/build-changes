...
public class axk extends aui {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), axk::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", axk::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", axk::k);
         $$0 = this.a($$0, "minecraft:fox", axk::j);
         $$0 = this.a($$0, "minecraft:item", axk::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", axk::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", axk::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", axk::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", axk::e);
         return this.a($$0, "minecraft:piglin", axk::d);
      });
   }
