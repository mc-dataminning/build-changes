...
public class axk implements AutoCloseable {
   ...
   private axk(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static axk.a a(Path $$0) {
         return new axk.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
