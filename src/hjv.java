...
public record hjv(List<alg> d, alg e, Map<String, alg> f, String g) implements hjp {
   static final Logger h = LogUtils.getLogger();
   public static final String b = "_";
   public static final MapCodec<hjv> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.list(alg.a).fieldOf("textures").forGetter(hjv::b),
               alg.a.fieldOf("palette_key").forGetter(hjv::c),
               Codec.unboundedMap(Codec.STRING, alg.a).fieldOf("permutations").forGetter(hjv::d),
               Codec.STRING.optionalFieldOf("separator", "_").forGetter(hjv::e)
            )
            .apply($$0, hjv::new)
   );

   public hjv(List<alg> $$0, alg $$1, Map<String, alg> $$2) {
      this($$0, $$1, $$2, "_");
   }
   ...
   static record a(hju a, Supplier<IntUnaryOperator> b, alg c) implements hjp.b {
      @Nullable
      public hje a(hjo $$0) {
         Object var3;
         try {
            fiu $$1 = this.a.a().a(this.b.get());
            return new hje(this.c, new hkx($$1.a(), $$1.b()), $$1, avf.a);
         } catch (IllegalArgumentException | IOException var7) {
            hjv.h.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
