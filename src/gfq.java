public class gfq extends gda<hbx> {
   ...
   public static ggi a(ggg $$0) {
      ggk $$1 = new ggk();
      ggm $$2 = $$1.a();
      $$2.a("shoulders", ggh.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gge.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         ggh.c()
         ...
         gge.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         ggh.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gge.a(-2.0F, 6.9F + ayz.b(0.20420352F) * 10.0F, -0.5F + ayz.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", ggh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gge.a);
      ggh $$4 = ggh.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gge.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gge.a(10.0F, 4.0F, 0.0F));
   ...
   private static void a(hbx $$0, ggc $$1, int $$2) {
