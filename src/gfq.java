...
public class gfq implements gfw.a {
   ...
   private void b(eys $$0, gck $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(afz::a).collect(Collectors.toSet());
         int $$5 = 1;
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(afz::a).collect(Collectors.toSet()).toString();
      }
   }
   ...
   private void a(eys $$0, gck $$1, io $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gfw.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(eys $$0, gck $$1, aam.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(eys $$0, gck $$1, aab.a $$2) {
      if ($$2.e() != null) {
         gge.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(eys $$0, gck $$1, aab.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(eys $$0, gck $$1, String $$2, aam.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(eys $$0, gck $$1, String $$2, io $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
   ...
   private static void a(eys $$0, gck $$1, jh $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      io $$9 = io.a($$2);
   ...
   private Set<String> a(aam.a $$0) {
      return this.a($$0.a()).stream().map(afz::a).collect(Collectors.toSet());
   }
   ...
   private void g() {
      gfw.a(this.A.ao(), 8).ifPresent($$0 -> this.D = $$0.cz());
   }
