...
public class gfq implements gfw.a {
   ...
   private final feb A;
   private final Map<io, gfq.a> B = new HashMap<>();
   private final Map<UUID, aab.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   private void a(eyu $$0, gck $$1) {
      ...
      for (io $$3 : this.B.keySet()) {
         if ($$2.a($$3, 30.0)) {
            a($$0, $$1, $$3);
         }
      }

      Map<io, Set<UUID>> $$4 = this.d();
   ...
   private Map<io, Set<UUID>> d() {
      Map<io, Set<UUID>> $$0 = Maps.newHashMap();
      this.C.values().forEach($$1 -> $$1.j().forEach($$2 -> $$0.computeIfAbsent($$2, $$0xxx -> Sets.newHashSet()).add($$1.b())));
      return $$0;
   }

   private void b(eyu $$0, gck $$1) {
      Map<io, Set<UUID>> $$2 = Maps.newHashMap();
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aga::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gfw.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aga::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(eyu $$0, gck $$1, io $$2) {
      float $$3 = 0.05F;
      gfw.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(eyu $$0, gck $$1, io $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gfw.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(eyu $$0, gck $$1, aam.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(eyu $$0, gck $$1, aab.a $$2) {
      if ($$2.e() != null) {
         gge.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(eyu $$0, gck $$1, aab.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(eyu $$0, gck $$1, String $$2, aam.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(eyu $$0, gck $$1, String $$2, io $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gfw.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(eyu $$0, gck $$1, jh $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      io $$9 = io.a($$2);
      ...
      float $$13 = 0.5F;
      gfw.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(aam.a $$0) {
      return this.a($$0.a()).stream().map(aga::a).collect(Collectors.toSet());
   }

   private String a(aab.a $$0, io $$1) {
   ...
   private boolean c(aab.a $$0) {
      cly $$1 = this.A.s;
      io $$2 = io.a($$1.du(), $$0.d().b(), $$1.dA());
      io $$3 = io.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(io $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(aab.a::b).collect(Collectors.toSet());
   }

   private Map<io, List<String>> f() {
      Map<io, List<String>> $$0 = Maps.newHashMap();

      for (aab.a $$1 : this.C.values()) {
   ...
   private void g() {
      gfw.a(this.A.an(), 8).ifPresent($$0 -> this.D = $$0.cz());
   }
