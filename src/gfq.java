...
public class gfq extends si {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gfq(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gfq a(aqi $$0, List<String> $$1, boolean $$2) {
      ...
      return new gfq(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<aqg> $$1, Map<String, String> $$2) {
      for (aqg $$3 : $$1) {
