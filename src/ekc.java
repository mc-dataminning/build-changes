...
public class ekc {
   private final List<ConcurrentLinkedQueue<ekb>> a = ImmutableList.of(
   ...
   public void a(ekb $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ekb> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ekb> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ekb> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ekb> j() {
