...
public class ekc {
   ...
   public static final ekc.a bv;

   public static ekc.a a(int $$0, int $$1) {
      return $$0 == -1 ? ekc.b.b.a($$1) : ekc.b.a.a($$0);
   }

   public static ekc.a a(String $$0) {
      if (ekc.a.e.containsKey($$0)) {
         return ekc.a.e.get($$0);
      } else {
         for (ekc.b $$1 : ekc.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ekc.b b;
      private final int c;
      private final arj<te> d;
      static final Map<String, ekc.a> e = Maps.newHashMap();

      a(String $$0, ekc.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new arj<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? te.b($$2.toUpperCase(Locale.ROOT)) : te.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? te.b($$2) : te.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> qn.a().b($$1) ? te.c($$1) : te.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ekc.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, te> g;

      private static void a(ekc.b $$0, String $$1, int $$2) {
         ekc.a $$3 = new ekc.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, te> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ekc.a a(int $$0) {
         return (ekc.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
