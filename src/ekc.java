...
public class ekc {
   ...
   private static final Queue<ekc.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ekc.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ekc::a), eka::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ekc::a), eka::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ekc.a(this.b) + ", type=" + ekc.b(this.c) + ", severity=" + ekc.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
