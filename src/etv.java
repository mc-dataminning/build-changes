...
public class etv extends etm {
   ...
   public etl a() {
      ji.a $$0 = new ji.a();
      int $$1 = this.c.dC();
      dwx $$2 = this.b.a($$0.b(this.c.dB(), (double)$$1, this.c.dH()));
      if (!this.c.a($$2.y())) {
         if (this.f() && this.c.bj()) {
            while (true) {
   ...
   public int a(etl[] $$0, etl $$1) {
      ...
      if (this.c.a($$4) >= 0.0F && $$5 != etq.w) {
         $$3 = ayz.d(Math.max(1.0F, this.c.dQ()));
      }
   ...
   protected boolean a(etl $$0, @Nullable etl $$1, @Nullable etl $$2) {
      if ($$2 == null || $$1 == null || $$2.b > $$0.b || $$1.b > $$0.b) {
         ...
         boolean $$3 = $$2.l == etq.h && $$1.l == etq.h && (double)this.c.dr() < 0.5;
   ...
   private boolean b(etl $$0) {
      fav $$1 = this.c.cR();
      fba $$2 = new fba((double)$$0.a - this.c.dB() + $$1.b() / 2.0, (double)$$0.b - this.c.dD() + $$1.c() / 2.0, (double)$$0.c - this.c.dH() + $$1.d() / 2.0);
      int $$3 = ayz.c($$2.g() / $$1.a());
   ...
   @Override
   public etq a(ets $$0, int $$1, int $$2, int $$3, bvi $$4) {
   ...
   public static etq b(bvi $$0, ji $$1) {
      return a(new ets($$0.dW(), $$0), $$1.k());
   }
