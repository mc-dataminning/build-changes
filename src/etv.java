...
public class etv {
   ...
   public Optional<ji> a(ji $$0, boolean $$1, dyl $$2) {
      cgj $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cgn.r), $$0, $$4, cgj.b.c)
         .map(cgk::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dxl.K))
   ...
   public Optional<l.a> a(ji $$0, jn.a $$1) {
      ...
      for (ji.a $$11 : ji.a($$0, 16, jn.f, jn.d)) {
         int $$12 = Math.min($$8, this.n.a(ecq.a.e, $$11.u(), $$11.w()));
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new ji($$0.u() - $$2.j() * 1, ayy.a($$0.v(), $$17, $$18), $$0.w() - $$2.l() * 1).j();
         $$4 = $$7.b($$4);
         jn $$19 = $$2.h();
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, djm.cv.m(), 3);
            }
         }
      }

      dwv $$26 = djm.eq.m().b(dor.b, $$1);
