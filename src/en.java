...
public record en(@Nullable Float c, @Nullable Float d) {
   ...
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xk.c("argument.range.ints"));
   ...
   public static en a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         ...
         float $$1 = azk.e($$0, "value");
         return new en($$1, $$1);
      } else {
         JsonObject $$2 = azk.m($$0, "value");
         Float $$3 = $$2.has("min") ? azk.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? azk.m($$2, "max") : null;
         return new en($$3, $$4);
      }
   }
