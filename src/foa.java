...
public class foa implements mi {
   ...
   static class a implements Consumer<fob> {
      private final Map<dke, fob> a = new HashMap<>();

      public void a(fob $$0) {
         dke $$1 = $$0.a();
         fob $$2 = this.a.put($$1, $$0);
         if ($$2 != null) {
      ...
      public void a() {
         Stream<jr.c<dke>> $$0 = mb.e.c().filter($$0x -> true);
      ...
      public CompletableFuture<?> a(mg $$0, mk.a $$1) {
         return foa.a($$0, $$1x -> $$1.a($$1x.p().h().a()), this.a);
      }
   }

   static class b implements fnz {
      private final Map<cxd, hcg> a = new HashMap<>();
      private final Map<cxd, cxd> b = new HashMap<>();

      @Override
      public void a(cxd $$0, hck.b $$1) {
         this.a($$0, new hcg($$1, hcg.a.a));
      }

      private void a(cxd $$0, hcg $$1) {
         hcg $$2 = this.a.put($$0, $$1);
         if ($$2 != null) {
      ...
      public void a() {
         mb.g.forEach($$0x -> {
            if (!this.b.containsKey($$0x)) {
               if ($$0x instanceof cvo $$1 && !this.a.containsKey($$1)) {
                  aku $$2 = foo.a($$1.d());
                  this.a($$1, fom.a($$2));
               }
            }
      ...
      public CompletableFuture<?> a(mg $$0, mk.a $$1) {
         return mi.a($$0, hcg.a, $$1x -> $$1.a($$1x.f().h().a()), this.a);
      }
   }

   static class c implements BiConsumer<aku, fon> {
      private final Map<aku, fon> a = new HashMap<>();

      public void a(aku $$0, fon $$1) {
