...
public class foa {
   private static final fom a = fom.s(new aew("textures/map/map_background.png"));
   private static final fom b = fom.s(new aew("textures/map/map_background_checkerboard.png"));
   ...
   private final eqv au;
   private cjf av = cjf.b;
   private cjf aw = cjf.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final ftf aB;
   private final fuf aC;

   public foa(eqv $$0, ftf $$1, fuf $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = arw.a($$1, 0.0F, 1.0F);
      return -arw.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(elp $$0, foe $$1, int $$2, bja $$3) {
      fyh $$4 = (fyh)this.aB.<fnd>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bja.b ? 1.0F : -1.0F;
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, bja $$4, float $$5, cjf $$6) {
      ...
      float $$8 = arw.c($$5);
      float $$9 = arw.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * arw.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * arw.a($$5 * (float) Math.PI);
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = arw.c($$5);
      float $$7 = -0.2F * arw.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * arw.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = arw.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(elp $$0, foe $$1, int $$2, cjf $$3) {
      ...
      Integer $$4 = cjm.d($$3);
      ebw $$5 = cjm.a($$4, this.au.r);
      elt $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, float $$4, bja $$5) {
      boolean $$6 = $$5 != bja.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = arw.c($$4);
      float $$9 = -0.3F * arw.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * arw.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * arw.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = arw.a($$4 * $$4 * (float) Math.PI);
      float $$13 = arw.a($$8 * (float) Math.PI);
   ...
   private void a(elp $$0, float $$1, bja $$2, cjf $$3) {
      float $$4 = (float)this.au.s.fp() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = arw.e(arw.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(elp $$0, float $$1, bja $$2, cjf $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * arw.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bja.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(elp $$0, bja $$1, float $$2) {
      int $$3 = $$1 == bja.b ? 1 : -1;
      float $$4 = arw.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = arw.a(arw.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(elp $$0, bja $$1, float $$2) {
      int $$3 = $$1 == bja.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, elp $$1, foe.a $$2, fng $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bgx $$6 = (bgx)MoreObjects.firstNonNull($$3.aG, bgx.a);
      float $$7 = arw.i($$0, $$3.O, $$3.dD());
      foa.a $$8 = a($$3);
      float $$9 = arw.i($$0, $$3.cu, $$3.cs);
      float $$10 = arw.i($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bgx.a ? $$5 : 0.0F;
         float $$12 = 1.0F - arw.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bgx.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bgx.b ? $$5 : 0.0F;
         float $$14 = 1.0F - arw.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bgx.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static foa.a a(fng $$0) {
      cjf $$1 = $$0.eS();
      cjf $$2 = $$0.eT();
      boolean $$3 = $$1.a(cji.nG) || $$2.a(cji.nG);
      boolean $$4 = $$1.a(cji.uZ) || $$2.a(cji.uZ);
      if (!$$3 && !$$4) {
         return foa.a.a;
      } else if ($$0.fm()) {
         return b($$0);
      } else {
         return a($$1) ? foa.a.b : foa.a.a;
      }
   }

   private static foa.a b(fng $$0) {
      cjf $$1 = $$0.fo();
      bgx $$2 = $$0.fn();
      if (!$$1.a(cji.nG) && !$$1.a(cji.uZ)) {
         return $$2 == bgx.a && a($$0.eT()) ? foa.a.b : foa.a.a;
      } else {
         return foa.a.a($$2);
      }
   }
   ...
   private static boolean a(cjf $$0) {
      return $$0.a(cji.uZ) && chn.d($$0);
   }

   private void a(fnd $$0, float $$1, float $$2, bgx $$3, float $$4, cjf $$5, float $$6, elp $$7, foe $$8, int $$9) {
      if (!$$0.gp()) {
         boolean $$10 = $$3 == bgx.a;
         ...
         if ($$5.b()) {
            ...
            if ($$0.fm() && $$0.fp() > 0 && $$0.fn() == $$3) {
               ...
               float $$16 = $$15 / (float)chn.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = arw.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * arw.a(arw.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * arw.a(arw.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * arw.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cjc.e : cjc.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bja.b;
            if ($$0.fm() && $$0.fp() > 0 && $$0.fn() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * arw.a(arw.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * arw.a(arw.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * arw.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cjc.e : cjc.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.y()) {
         this.ax = arw.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = arw.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + arw.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + arw.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
