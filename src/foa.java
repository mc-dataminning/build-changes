...
public abstract class foa<E extends foa.a<E>> extends fnx {
   ...
   protected final fmg c;
   protected final int d;
   private final List<E> p = new foa.b();
   ...
   public foa(fmg $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xu.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected void a(fns $$0) {
      alz $$1 = this.c.s == null ? fty.h : fty.j;
      alz $$2 = this.c.s == null ? fty.i : fty.k;
      $$0.a(glv::C, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(glv::C, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(fns $$0) {
      alz $$1 = this.c.s == null ? n : o;
      $$0.a(glv::C, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   @Nullable
   protected E a(fsl $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.g());
   }

   @Nullable
   protected E a(fsl $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fsb.a u() {
      if (this.aN_()) {
         ...
         return this.v != null ? fsb.a.b : fsb.a.a;
      }
   }
   ...
   protected void a(fsd $$0, E $$1) {
      List<E> $$2 = this.aI_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fsc.b, xv.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends foa.a<E>> implements fqd {
      @Deprecated
      foa<E> a;
      ...
      public abstract void a(fns var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
