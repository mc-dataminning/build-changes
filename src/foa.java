...
public abstract class foa extends fnj {
   private final dra b;
   private drb c;
   ...
   public foa(dra $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wu.c("sign.edit"));
   }

   public foa(dra $$0, boolean $$1, boolean $$2, wu $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
   ...
   @Override
   protected void aP_() {
      this.c(fhs.a(wt.d, $$0 -> this.F()).a(this.m / 2 - 100, this.n / 4 + 144, 200, 20).a());
      this.v = new fkm(() -> this.q[this.u], this::a, fkm.a(this.l), fkm.c(this.l), $$0 -> this.l.h.b($$0) <= this.b.c());
   }
   ...
   protected abstract void a(fhf var1, dsk var2);
   ...
   private void d(fhf $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : ggr.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.q.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gel.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
