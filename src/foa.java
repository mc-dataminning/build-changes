...
public class foa extends aoa<foa.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final aey b = new aey("gpu_warnlist.json");
   ...
   protected foa.a a(anv $$0, bdr $$1) {
      ...
      $$1.b();
      return new foa.a($$2, $$3, $$4);
   }

   protected void a(foa.a $$0, anv $$1, bdr $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(anv $$0, bdr $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ekk.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ekk.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ekk.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
