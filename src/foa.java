...
public class foa {
   private static final fom a = fom.s(new aex("textures/map/map_background.png"));
   private static final fom b = fom.s(new aex("textures/map/map_background_checkerboard.png"));
   ...
   private float a(float $$0) {
      ...
      $$1 = arx.a($$1, 0.0F, 1.0F);
      return -arx.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, bja $$4, float $$5, cjf $$6) {
      ...
      float $$8 = arx.c($$5);
      float $$9 = arx.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * arx.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * arx.a($$5 * (float) Math.PI);
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = arx.c($$5);
      float $$7 = -0.2F * arx.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * arx.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = arx.a($$6 * (float) Math.PI);
   ...
   private void a(elp $$0, foe $$1, int $$2, float $$3, float $$4, bja $$5) {
      ...
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = arx.c($$4);
      float $$9 = -0.3F * arx.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * arx.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * arx.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = arx.a($$4 * $$4 * (float) Math.PI);
      float $$13 = arx.a($$8 * (float) Math.PI);
   ...
   private void a(elp $$0, float $$1, bja $$2, cjf $$3) {
      ...
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = arx.e(arx.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(elp $$0, float $$1, bja $$2, cjf $$3, float $$4) {
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * arx.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bja.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(elp $$0, bja $$1, float $$2) {
      int $$3 = $$1 == bja.b ? 1 : -1;
      float $$4 = arx.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = arx.a(arx.c($$2) * (float) Math.PI);
      ...
      if (!$$0.gp()) {
         ...
         if ($$5.b()) {
            ...
            if ($$0.fm() && $$0.fp() > 0 && $$0.fn() == $$3) {
               ...
               float $$20 = -0.4F * arx.a(arx.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * arx.a(arx.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * arx.a($$4 * (float) Math.PI);
            ...
            if ($$0.fm() && $$0.fp() > 0 && $$0.fn() == $$3) {
               ...
               float $$36 = -0.4F * arx.a(arx.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * arx.a(arx.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * arx.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
   ...
   public void a() {
      ...
      if ($$0.y()) {
         this.ax = arx.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = arx.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + arx.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + arx.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
