...
public class ws extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vu> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, vg.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vu> $$0, Codec<T> $$1, vg $$2) {
      vu $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> ws a(DynamicOps<vu> $$0, Codec<T> $$1, T $$2) {
      vu $$3 = (vu)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = azu.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zu<? super ws, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zv<? super ws, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zu<? super ws, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zu<? super ws, K> $$1, zu<? super ws, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zu<? super ws, K> $$0, zu<? super ws, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zv<? super ws, K> $$1, zv<? super ws, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zv<? super ws, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zu<? super ws, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zu<? super ws, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zu<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zv<? super ws, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zv<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static dgo c(ByteBuf $$0) {
      return new dgo($$0.readLong());
   }

   public static void a(ByteBuf $$0, dgo $$1) {
      $$0.writeLong($$1.a());
   }
   ...
   public static fby f(ByteBuf $$0) {
      return new fby($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, fby $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public <T> ws a(ToIntFunction<T> $$0, T $$1) {
   ...
   public ws a(@Nullable vu $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vu $$1) {
      if ($$1 == null) {
         $$1 = uz.b;
      }

      try {
         vk.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ux h(ByteBuf $$0) {
      vu $$1 = a($$0, vg.a(2097152L));
      if ($$1 != null && !($$1 instanceof ux)) {
   ...
   @Nullable
   public static vu a(ByteBuf $$0, vg $$1) {
      try {
         vu $$2 = vk.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public ws a(String $$0, int $$1) {
      xl.a(this.d, $$0, $$1);
      return this;
   }

   public alz q() {
      return alz.a(this.d(32767));
   }
   ...
   public <T> aly<T> a(aly<? extends kd<T>> $$0) {
      alz $$1 = this.q();
      return aly.a($$0, $$1);
   }
   ...
   public fbu v() {
      ...
      return new fbu(new fby((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5, $$6);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, bae.e($$1, 8)));
      }
   }
   ...
   public ws a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ws a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public ws a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ws a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ws a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ws a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ws a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public ws b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public ws c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public ws d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public ws e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public ws f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public ws g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public ws h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public ws a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public ws b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public ws i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public ws a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public ws a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public ws b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ws b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public ws b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ws b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ws b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ws b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public ws j(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ws c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public ws a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public ws a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public ws a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ws a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public ws a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public ws k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public ws d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public ws b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public ws b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public ws b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
