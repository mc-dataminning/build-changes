...
public class ws {
   public static <T extends wj> ws.b a(wl<T> $$0) {
      return a(new wh<T>($$0));
   }

   private static ws.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends wj> ws.d b(wl<T> $$0) {
      return a(new wi<T>($$0));
   }

   private static ws.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zk)) {
            $$0.fireChannelRead($$1);
         } else {
