...
public class doe {
   ...
   private boolean a(jh $$0) {
      return dht.a(this.a, $$0) || dht.a(this.a, $$0.d()) || dht.a(this.a, $$0.e());
   }
   ...
   private doe b(jh $$0) {
      dvj $$2 = this.a.a_($$0);
      if (dht.h($$2)) {
         return new doe(this.a, $$0, $$2);
      } else {
         jh $$1 = $$0.d();
         $$2 = this.a.a_($$1);
         if (dht.h($$2)) {
            return new doe(this.a, $$1, $$2);
         } else {
            $$1 = $$0.e();
            $$2 = this.a.a_($$1);
            return dht.h($$2) ? new doe(this.a, $$1, $$2) : null;
         }
      }
   }

   private boolean a(doe $$0) {
      return this.c($$0.b);
   }
   ...
   private boolean b(doe $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(doe $$0) {
      this.f.add($$0.b);
      jh $$1 = this.b.f();
      jh $$2 = this.b.g();
      jh $$3 = this.b.h();
   ...
   public doe a(boolean $$0, boolean $$1, dwn $$2) {
      jh $$3 = this.b.f();
      jh $$4 = this.b.g();
      jh $$5 = this.b.h();
      jh $$6 = this.b.i();
