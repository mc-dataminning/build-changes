...
public class doe extends dny<dqd> {
   private static final hc[] a = hc.values();

   public doe(Codec<dqd> $$0) {
      super($$0);
   }

   @Override
   public boolean a(doa<dqd> $$0) {
      dqd $$1 = $$0.f();
      ase $$2 = $$0.d();
      gw $$3 = $$0.e();
      cqr $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dlt $$9 = new dlt(new dkv($$4.A()));
      dzr $$10 = dzr.a($$9, -4, 1.0);
      ...
      for (gw $$33 : gw.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<gw, Integer> $$37 : $$7) {
            $$35 += ary.f($$33.j((ib)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (gw $$38 : $$11) {
            $$36 += ary.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, csy.a.n(), $$32);
      ...
      for (gw $$44 : $$31) {
         ...
         for (hc $$46 : a) {
            ...
            dfl $$48 = $$4.a_($$47);
            if ($$45.b(dgb.C)) {
               $$45 = $$45.a(dgb.C, Boolean.valueOf($$48.u().b()));
            }
