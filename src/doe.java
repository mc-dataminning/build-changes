...
public class doe extends dnr<dpo> {
   public doe(Codec<dpo> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? ars.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(arx $$0, cpr $$1, int $$2, int $$3, gw $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, gw $$2, cpr $$3, boolean $$4, double $$5, gw $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cpr $$0, gw $$1) {
      if ($$0.a_($$1.c()).a(csr.dN)) {
         this.a($$0, $$1.c(), csr.a.n());
      }
   }

   private void a(cpr $$0, arx $$1, gw $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dfe $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, gw.b, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, gw.b, $$7, $$1);
      if ($$14 < 0.0) {
         gw $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(gw $$0, cpr $$1, arx $$2, int $$3, int $$4, boolean $$5, boolean $$6, dfe $$7) {
      dfe $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(csr.dP) || $$8.a(csr.dO) || $$8.a(csr.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(csr.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, csr.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, gw $$2, int $$3, arx $$4) {
      float $$5 = 10.0F * ars.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, gw $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(arx $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(arx $$0, int $$1, int $$2, int $$3) {
      float $$4 = 1.0F + $$0.i() / 2.0F;
      float $$5 = (1.0F - (float)$$1 / ((float)$$2 * $$4)) * (float)$$3;
      return ars.f($$5 / 2.0F);
   }

   private static boolean c(dfe $$0) {
      return $$0.a(csr.iC) || $$0.a(csr.dP) || $$0.a(csr.mW);
   }
   ...
   private void a(cpr $$0, gw $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(csr.dN)) {
                  if (this.a((cow)$$0, $$10)) {
                     this.a($$0, $$10, csr.a.n());
                     this.a($$0, $$10.c(), csr.a.n());
                  } else if (c($$11)) {
                     dfe[] $$12 = new dfe[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
