...
public abstract class ewm {
   ...
   public evo a() {
      if (this.c()) {
         ...
         return new evo(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
      }
   }

   public ewm b() {
      return this.c() ? ewj.a() : ewj.a(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
   }
   ...
   public ewm a(double $$0, double $$1, double $$2) {
      return (ewm)(this.c() ? ewj.a() : new evv(this.a, new ewi(this.a(je.a.a), $$0), new ewi(this.a(je.a.b), $$1), new ewi(this.a(je.a.c), $$2)));
   }

   public ewm d() {
      ewm[] $$0 = new ewm[]{ewj.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewj.b($$0[0], ewj.a($$1, $$2, $$3, $$4, $$5, $$6), evx.o));
      return $$0[0];
   }

   public void a(ewj.a $$0) {
      this.a
         .a(
   ...
   public List<evo> e() {
      List<evo> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new evo($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(je.a.a, $$4.c - (double)$$2.u()), this.a(je.a.b, $$4.d - (double)$$2.v()), this.a(je.a.c, $$4.e - (double)$$2.w()))
               ? new evp($$4, je.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : evo.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<evt> a(evt $$0) {
      if (this.c()) {
   ...
   public ewm a(je $$0) {
      if (!this.c() && this != ewj.b()) {
         if (this.b != null) {
            ewm $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewm b(je $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewk(this, $$1, $$4);
      }
   }

   public double a(je.a $$0, evo $$1, double $$2) {
      return this.a(iw.a($$0, je.a.a), $$1, $$2);
   }

   protected double a(iw $$0, evo $$1, double $$2) {
      if (this.c()) {
         return $$2;
