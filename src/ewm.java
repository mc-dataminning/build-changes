...
public enum ewm implements azu {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azu.a<ewm> t = azu.a(ewm::values);
   public static final IntFunction<ewm> u = axp.a(ewm::a, values(), axp.a.a);
   private final int v;
   private final String w;

   private ewm(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
