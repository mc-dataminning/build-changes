...
public class bed extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgw.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bed::c), this.a("minecraft:arrow", bed::a), this.a("minecraft:spectral_arrow", bed::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bed.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bgw.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bgw.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bed.a<?> $$1, Type<?> $$2, Type<T> $$3) {
