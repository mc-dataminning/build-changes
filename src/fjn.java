...
public class fjn {
   ...
   static class b {
      static final Optional<fjn> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static fjn a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fjn();
      }
   }
}
