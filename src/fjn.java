...
public class fjn {
   ...
   private fjn(int $$0, List<fjp> $$1) {
      this.a = $$1.toArray(fjp[]::new);
      this.b = $$1.size();
   }

   private List<fjp> c() {
      List<fjp> $$0 = new ArrayList<>(this.d());
