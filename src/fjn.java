...
public class fjn extends hld implements fgx {
   ...
   private final int K;
   final AtomicReference<fgw> a = new AtomicReference<>();
   private final fgn L;
   ...
   private fos V;
   private int W;
   private final fsg X = new fsg(this);

   public fjn(@Nullable fki $$0, long $$1, int $$2, fjg $$3, evf $$4) {
      super(fkz.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aR_() {
      this.U = this.X.b(fos.a(wo.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fos.a(wo.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.H();
         } else {
            List<fkg> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fkn(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fiz(this.G, $$0.toArray(new fkg[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fit(new fge(new fum()), this.J));
   }
   ...
   private void H() {
      ...
      fhq $$1 = fhq.a(this.H.g(), this.H.l().c());
      fgw $$2 = new fgw($$0, $$1, this.m.X(), this.J, this.K, this);
