...
public interface il<T> extends Iterable<ih<T>> {
   ...
   Either<asv<T>, List<ih<T>>> c();

   Optional<ih<T>> a(auu var1);
   ...
   @Deprecated
   @VisibleForTesting
   static <T> il.c<T> a(ik<T> $$0, asv<T> $$1) {
      return new il.c<>($$0, $$1);
   }
   ...
   public static class a<T> extends il.b<T> {
      ...
      @Override
      public Either<asv<T>, List<ih<T>>> c() {
         return Either.right(this.a);
      }

      @Override
      public Optional<asv<T>> d() {
