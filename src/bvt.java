...
public abstract class bvt extends bxk {
   private static final akj<Boolean> bF = akn.a(bvt.class, akl.k);
   ...
   protected bvt(bwm<? extends bvt> $$0, div $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bvt a(arq var1, bvt var2);
   ...
   @Override
   protected void j() {
      if (!this.n_() && this.bZ() && this.dk() instanceof cti $$0 && !$$0.b((bwd)this)) {
         this.bP();
      }
   }
