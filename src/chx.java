...
public class chx {
   ...
   private int g = aww.b(axd.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jf.a.fieldOf("uuid").forGetter(Pair::getFirst), awe.j.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<box> j;
   @VisibleForTesting
   protected final ArrayList<box> c;
   private final chx.a k;
   @VisibleForTesting
   protected final Object2IntMap<box> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<chx> a(Predicate<box> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(chx::b)).apply($$1, $$1x -> new chx($$0, $$1x))
      );
   }

   public chx(Predicate<box> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new chx.a(this);
   ...
   public void a(apf $$0, Predicate<box> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<box>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<box> $$6 = (Entry<box>)$$5.next();
         int $$7 = $$6.getIntValue();
         box $$8 = (box)$$6.getKey();
         box.c $$9 = $$8.dI();
   ...
   public int b(@Nullable box $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bpp> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bpp).map($$0 -> (bpp)$$0);
   }

   @VisibleForTesting
   protected static record a(chx a) implements Comparator<box> {
      public int a(box $$0, box $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof ciu;
               boolean $$7 = $$1 instanceof ciu;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
