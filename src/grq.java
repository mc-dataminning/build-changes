...
public class grq implements AutoCloseable {
   private static final ali e = ali.b("blur");
   ...
   private float H;
   private float I;
   private final fkp J = new fkp(3);
   @Nullable
   private ali K;
   private boolean L;
   private final fql M = new fql();

   public grq(frd $$0, grt $$1, avf $$2, gsi $$3) {
      this.j = $$0;
      this.k = $$2;
      this.c = $$1;
      this.z = new grx(this, $$0);
      this.n = $$3;
   }
   ...
   public void a(@Nullable bwt $$0) {
      this.K = null;
      if ($$0 instanceof cok) {
         this.a(ali.b("creeper"));
      } else if ($$0 instanceof cpk) {
         this.a(ali.b("spider"));
   ...
   public void a(avi $$0) {
      ...
      BiFunction<ali, fkw, String> $$2 = ($$1x, $$2x) -> {
         ali $$3 = $$2x.b().a($$1x);
   ...
   public void a(float $$0) {
      ...
      if ($$1 != null) {
         if (this.j.s != null && this.j.t != null) {
            ...
            ffo $$4 = this.a($$1, $$2, $$3, $$0);
            this.j.w = $$4;
            this.j.v = $$4 instanceof ffn $$5 ? $$5.a() : null;
            bra.a().c();
         }
      }
   }

   private ffo a(bwt $$0, double $$1, double $$2, float $$3) {
      ...
      ffq $$9 = $$0.h($$3);
      ffq $$10 = $$6.b($$9.d * $$4, $$9.e * $$4, $$9.f * $$4);
      float $$11 = 1.0F;
      ffl $$12 = $$0.cR().b($$9.c($$4)).c(1.0, 1.0, 1.0);
      ffn $$13 = csu.a($$0, $$6, $$10, $$12, bxa.h, $$5);
      return $$13 != null && $$13.g().g($$6) < $$8 ? a($$13, $$6, $$2) : a($$7, $$6, $$1);
   }

   private static ffo a(ffo $$0, ffq $$1, double $$2) {
      ffq $$3 = $$0.g();
      if (!$$3.a((jp)$$1, $$2)) {
         ffq $$4 = $$0.g();
         jb $$5 = jb.a($$4.d - $$1.d, $$4.e - $$1.e, $$4.f - $$1.f);
         return ffm.a($$4, $$5, iv.a((jp)$$4));
      } else {
         return $$0;
      }
   }
   ...
   private void n() {
      ...
      this.q = azo.a(this.q, 0.1F, 1.5F);
   }

   private float a(fql $$0, float $$1, boolean $$2) {
      if (this.B) {
         return 90.0F;
      } else {
         float $$3 = 70.0F;
         if ($$2) {
            ...
            $$3 *= azo.h($$1, this.r, this.q);
         }

         if ($$0.g() instanceof bxu $$4 && $$4.eH()) {
   ...
   private void a(flo $$0, float $$1) {
      if (this.j.ao() instanceof bxu $$2) {
   ...
   private void b(flo $$0, float $$1) {
      if (this.j.ao() instanceof gqw $$2) {
         float var7 = $$2.g - $$2.f;
         float $$5 = -($$2.g + var7 * $$1);
         float $$6 = azo.h($$1, $$2.bV, $$2.bW);
         $$0.a(azo.a($$5 * (float) Math.PI) * $$6 * 0.5F, -Math.abs(azo.b($$5 * (float) Math.PI) * $$6), 0.0F);
         $$0.a(a.f.rotationDegrees(azo.a($$5 * (float) Math.PI) * $$6 * 3.0F));
         $$0.a(a.b.rotationDegrees(Math.abs(azo.b($$5 * (float) Math.PI - 0.2F) * $$6) * 5.0F));
      }
   }
   ...
   private void a(fql $$0, float $$1, Matrix4f $$2) {
      if (!this.B) {
         Matrix4f $$3 = this.b(this.a($$0, $$1, false));
         RenderSystem.setProjectionMatrix($$3, fhu.a);
         flo $$4 = new flo();
         $$4.a();
         ...
         boolean $$6 = this.j.ao() instanceof bxu && ((bxu)this.j.ao()).fR();
         if (this.j.n.aE().a() && !$$6 && !this.j.n.X && this.j.r.i() != dju.d) {
            this.z.d();
   ...
   public static float a(bxu $$0, float $$1) {
      bvx $$2 = $$0.c(bvz.p);
      return !$$2.a(200) ? 1.0F : 0.7F + azo.a(((float)$$2.d() - $$1) * (float) Math.PI * 0.2F) * 0.3F;
   }
      ...
      if (!this.j.y) {
         ...
         if ($$3 && $$1 && this.j.s != null) {
            ...
            if (this.K != null && this.L) {
               ...
               gse $$6 = this.j.ab().a(this.K, grw.h);
               if ($$6 != null) {
   ...
   private boolean p() {
      if (!this.v) {
         ...
         bwt $$0 = this.j.ao();
         boolean $$1 = $$0 instanceof crx && !this.j.n.X;
         if ($$1 && !((crx)$$0).gk().e) {
            czy $$2 = ((bxu)$$0).fb();
            ffo $$3 = this.j.w;
            if ($$3 != null && $$3.d() == ffo.a.b) {
               iv $$4 = ((ffm)$$3).b();
               ebe $$5 = this.j.s.a_($$4);
               if (this.j.r.i() == dju.d) {
                  $$1 = $$5.b(this.j.s, $$4) != null;
               } else {
                  ebi $$6 = new ebi(this.j.s, $$4, false);
                  js<dnc> $$7 = this.j.s.J_().f(mh.i);
                  $$1 = !$$2.f() && ($$2.b($$6) || $$2.a($$6));
               }
            }
         }
   ...
   public void a(fqt $$0) {
      ...
      $$3.b("camera");
      fql $$5 = this.M;
      bwt $$6 = (bwt)(this.j.ao() == null ? $$2 : this.j.ao());
      ...
      float $$12 = azo.h($$1, $$2.cx, $$2.cw);
      float $$13 = $$2.a(bvz.i, $$1);
      float $$14 = Math.max($$12, $$13) * $$11 * $$11;
      if ($$14 > 0.0F) {
         float $$15 = 5.0F / ($$14 * $$14 + 5.0F) - $$14 * 0.04F;
         $$15 *= $$15;
         Vector3f $$16 = new Vector3f(0.0F, azo.g / 2.0F, azo.g / 2.0F);
      ...
      RenderSystem.setProjectionMatrix($$9, fhu.a);
   ...
   private void a(ftx $$0, float $$1) {
      if (this.F != null && this.G > 0) {
         ...
         flo $$10 = $$0.c();
         $$10.a();
         $$10.a((float)($$0.a() / 2) + $$8 * azo.e(azo.a($$7 * 2.0F)), (float)($$0.b() / 2) + $$9 * azo.e(azo.a($$7 * 2.0F)), -50.0F);
         float $$11 = 50.0F + 175.0F * azo.a($$7);
         $$10.b($$11, -$$11, $$11);
         $$10.a(a.d.rotationDegrees(900.0F * azo.e(azo.a($$7))));
         $$10.a(a.b.rotationDegrees(6.0F * azo.b($$3 * 8.0F)));
         $$10.a(a.f.rotationDegrees(6.0F * azo.b($$3 * 8.0F)));
         $$0.a($$1x -> this.j.as().a(this.F, czw.i, 15728880, hkq.d, $$10, $$1x, this.j.s, 0));
         $$10.b();
      }
   }
