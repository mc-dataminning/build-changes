public class grq extends gri<cqh, gxw> {
   private static final alz a = alz.b("textures/entity/fishing_hook.png");
   private static final glo b = glo.e(a);
   ...
   public boolean a(cqh $$0, gov $$1, double $$2, double $$3, double $$4) {
      return super.a($$0, $$1, $$2, $$3, $$4) && $$0.m() != null;
   }

   public void a(gxw $$0, fgl $$1, gle $$2, int $$3) {
      $$1.a();
      $$1.a();
      $$1.b(0.5F, 0.5F, 0.5F);
      $$1.a(this.e.b());
   ...
   private fbs a(cps $$0, float $$1, float $$2) {
      int $$3 = $$0.fw() == bvv.b ? 1 : -1;
      cxk $$4 = $$0.eX();
      if (!$$4.a(cxo.rJ)) {
         $$3 = -$$3;
      }
      ...
      if (this.e.d.aE().a() && $$0 == flz.Q().t) {
         ...
         fbs $$13 = this.e.b.j().a((float)$$3 * 0.525F, -0.1F).c($$12).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.m($$2).e($$13);
      } else {
   ...
   private static void a(fgp $$0, fgl.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(hav.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cqh $$0, gxw $$1, float $$2) {
      ...
      if ($$3 == null) {
         ...
         fbs $$6 = this.a($$3, $$5, $$2);
         fbs $$7 = $$0.o($$2).b(0.0, 0.25, 0.0);
         $$1.a = $$6.d($$7);
      }
   }

   protected boolean a(cqh $$0) {
      return false;
   }
}
