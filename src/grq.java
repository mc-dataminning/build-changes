...
public class grq {
   public static final grq a = new grq(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));
   public final Vector3f b;
   public final Vector3f c;
   public final Vector3f d;

   public grq(Vector3f $$0, Vector3f $$1, Vector3f $$2) {
      this.b = new Vector3f($$0);
      this.c = new Vector3f($$1);
      this.d = new Vector3f($$2);
   }

   public void a(boolean $$0, fjj $$1) {
      if (this != a) {
         float $$2 = this.b.x();
         float $$3 = this.b.y();
         float $$4 = this.b.z();
   ...
   protected static class a implements JsonDeserializer<grq> {
      ...
      public grq a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
