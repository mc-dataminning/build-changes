...
public class cnw {
   ...
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kl.a.fieldOf("uuid").forGetter(Pair::getFirst), ayh.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<buj> j;
   @VisibleForTesting
   protected final ArrayList<buj> c;
   private final cnw.a k;
   @VisibleForTesting
   protected final Object2IntMap<buj> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cnw> a(Predicate<buj> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cnw::b)).apply($$1, $$1x -> new cnw($$0, $$1x))
      );
   }

   public cnw(Predicate<buj> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cnw.a(this);
   ...
   public void a(arc $$0, Predicate<buj> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<buj>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<buj> $$6 = (Entry<buj>)$$5.next();
         int $$7 = $$6.getIntValue();
         buj $$8 = (buj)$$6.getKey();
         buj.d $$9 = $$8.dS();
   ...
   public int b(@Nullable buj $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bvf> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bvf).map($$0 -> (bvf)$$0);
   }

   @VisibleForTesting
   protected static record a(cnw a) implements Comparator<buj> {
      public int a(buj $$0, buj $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cov;
               boolean $$7 = $$1 instanceof cov;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
