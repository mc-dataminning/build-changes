...
public class ezg implements Comparable<ezg> {
   private static final Map<String, ezg> h = Maps.newHashMap();
   private static final Map<esw.a, ezg> i = Maps.newHashMap();
   ...
   public static void a(esw.a $$0, boolean $$1) {
      ezg $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (ezg $$0 : h.values()) {
         if ($$0.o.a() == esw.b.a && $$0.o.b() != esw.bv.b()) {
            $$0.a(esw.a(ezi.Q().aO().i(), $$0.o.b()));
         }
      }
   }
   ...
   public ezg(String $$0, int $$1, String $$2) {
      this($$0, esw.b.a, $$1, $$2);
   }

   public ezg(String $$0, esw.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(esw.a $$0) {
      this.o = $$0;
   }

   public int a(ezg $$0) {
      return this.n.equals($$0.n) ? gkh.a(this.l).compareTo(gkh.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(ezg $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(esw.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == esw.bv.b() ? this.o.a() == esw.b.b && this.o.b() == $$1 : this.o.a() == esw.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == esw.b.c && this.o.b() == $$0;
   }
