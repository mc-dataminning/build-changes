...
public class ezg {
   ...
   private static final Queue<ezg.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ezg.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ezg::a), eze::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ezg::a), eze::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ezg.a(this.b) + ", type=" + ezg.b(this.c) + ", severity=" + ezg.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
