...
public class ezg {
   ...
   private final exh g;
   final Map<UUID, ezv> h = Maps.newLinkedHashMap();
   ...
   private void a(eyu $$0, int $$1, int $$2, blk $$3) {
      this.a($$0, $$1, $$2, $$3, 182, c, e);
      int $$4 = awh.b($$3.k(), 0, 182);
      if ($$4 > 0) {
         this.a($$0, $$1, $$2, $$3, $$4, d, f);
      }
   }

   private void a(eyu $$0, int $$1, int $$2, blk $$3, int $$4, aiy[] $$5, aiy[] $$6) {
   ...
   public void a(aaq $$0) {
      $$0.a(new aaq.b() {
         @Override
         public void a(UUID $$0, vq $$1, float $$2, blk.a $$3, blk.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            ezg.this.h.put($$0, new ezv($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
         ...
         @Override
         public void a(UUID $$0, blk.a $$1, blk.b $$2) {
            ezv $$3 = ezg.this.h.get($$0);
            $$3.a($$1);
            $$3.a($$2);
         }
