...
public record br(
   ...
   public static bc a(br $$0) {
      esn $$1 = esq.a(eph.b.a, $$0).build();
      return new bc(List.of($$1));
   }

   public boolean a(aqo $$0, @Nullable brw $$1) {
      return this.a($$0.z(), $$0.dn(), $$1);
   }

   public boolean a(aqn $$0, @Nullable eum $$1, @Nullable brw $$2) {
      if ($$2 == null) {
         return false;
         ...
         if (this.e.isPresent() && !this.e.get().a($$0, $$2.du(), $$2.dw(), $$2.dA())) {
            ...
            if (this.g.isPresent() && !this.g.get().a($$2)) {
               ...
               return false;
            } else if (this.n.isPresent() && !this.n.get().a($$0, $$1, $$2 instanceof bss ? ((bss)$$2).p() : null)) {
               return false;
            } else {
               if (this.o.isPresent()) {
                  evs $$4 = $$2.cj();
   ...
   public static eph b(aqo $$0, brw $$1) {
      epk $$2 = new epk.a($$0.z()).a(erz.a, $$1).a(erz.f, $$0.dn()).a(ery.n);
      return new eph.a($$2).a(Optional.empty());
   }
