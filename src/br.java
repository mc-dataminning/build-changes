...
public record br(Optional<cp> b, Optional<cp> c, Optional<cp> d, Optional<cp> e, Optional<cp> f, Optional<cp> g, Optional<cp> h) {
   ...
   public static br a(jk<dpd> $$0) {
      return br.a.a().a(cp.a.a().a(cud.uP).a(kl.a(cns.a($$0).a()))).b();
   }

   public boolean a(@Nullable bsd $$0) {
      if ($$0 instanceof bsy $$1) {
         if (this.b.isPresent() && !this.b.get().a($$1.a(bsk.f))) {
            return false;
         } else if (this.c.isPresent() && !this.c.get().a($$1.a(bsk.e))) {
            return false;
         } else if (this.d.isPresent() && !this.d.get().a($$1.a(bsk.d))) {
            return false;
         } else if (this.e.isPresent() && !this.e.get().a($$1.a(bsk.c))) {
            return false;
         } else if (this.f.isPresent() && !this.f.get().a($$1.a(bsk.g))) {
            return false;
         } else {
            return this.g.isPresent() && !this.g.get().a($$1.a(bsk.a)) ? false : !this.h.isPresent() || this.h.get().a($$1.a(bsk.b));
         }
      } else {
         return false;
      }
