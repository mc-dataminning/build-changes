...
public class fq implements ArgumentType<fo> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ui.c("argument.rotation.incomplete"));

   public static fq a() {
      return new fq();
   }

   public static fo a(CommandContext<du> $$0, String $$1) {
