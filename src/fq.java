...
public class fq implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> xj.b("arguments.objective.notFound", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> xj.b("arguments.objective.readonly", $$0));
   ...
   public static fav b(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      fav $$2 = a($$0, $$1);
      if ($$2.c().e()) {
         throw c.create($$2.b());
      } else {
