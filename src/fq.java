...
public class fq implements ArgumentType<String> {
   ...
   public static fao a(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
   ...
   public static fao b(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      fao $$2 = a($$0, $$1);
      if ($$2.c().e()) {
         throw c.create($$2.b());
      } else {
