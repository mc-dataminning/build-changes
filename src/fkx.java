...
public class fkx extends fky {
   private static final xk b = xk.c("multiplayer.applyingPack");
   private static final Logger c = LogUtils.getLogger();
   private static final xk d = xk.c("mco.connect.connecting");
   private final fic e;
   private final ftr f;
   ...
   public void run() {
      ...
      try {
            ...
            case 6006:
               ...
               a(
                  (ftr)($$3
                     ...
                     : new fjp(xk.c("mco.brokenworld.nonowner.title"), xk.c("mco.brokenworld.nonowner.error"), this.f))
               );
               return;
            default:
               this.a(var5);
         ...
         this.a(xk.c("mco.errorMessage.connectionFailure"));
         return;
   ...
   private fpb a(fid $$0, UUID $$1, Function<fid, ftr> $$2) {
      xk $$3 = xk.c("mco.configure.world.resourcepack.question");
      return fjx.a(this.f, $$3, $$3x -> {
         ...
         this.a($$0, $$1).thenRun(() -> a($$2.apply($$0))).exceptionally($$1xx -> {
            ...
            a(new fjp(xk.c("mco.download.resourcePack.fail"), this.f));
            return null;
         });
      });
   }
