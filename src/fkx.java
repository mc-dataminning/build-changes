...
public abstract class fkx<E extends bno> extends fmb<E> {
   ...
   protected fkx(boolean $$0, float $$1, float $$2) {
   ...
   protected abstract Iterable<fpc> a();

   protected abstract Iterable<fpc> b();
}
