...
public class fkx {
   ...
   public static List<fkx.a> a(String $$0, fkx.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fkx.a> a(String $$0, List<fkx.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fkx.a> a(List<String> $$0, List<fkx.b> $$1) {
      int $$2 = 0;
      List<fkx.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fkx.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fkx.b a(String $$0, String $$1) {
         return new fkx.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fkx.b a(String $$0) {
         return new fkx.b($$0);
      }
   }
}
