...
public class fkx extends fmk {
   private final float a;
   private final fmf b;

   fkx(fin $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, fmf $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements fln<in> {
      ...
      public flk a(in $$0, fin $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == cyq.a) {
            ...
            gu $$9 = gu.a($$2, $$3, $$4);
            int $$10 = eql.O().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof cvd) {
               $$10 = ((cvd)$$8.b()).d($$8, $$1, $$9);
            }
            ...
            return new fkx($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
