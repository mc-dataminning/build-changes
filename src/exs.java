...
public class exs {
   ...
   @Nullable
   private String g;
   private static final exs.a h = new exs.a() {
      @Nullable
      @Override
      public exr a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (exv.a(this.d, "Get capabilities")) {
         ...
         if (exv.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  exv.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !exv.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public exr a(exs.c $$0) {
      return ($$0 == exs.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements exs.a {
      private final int a;
      private final Set<exr> b = Sets.newIdentityHashSet();
      ...
      public exr a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               exs.a.warn("Maximum sound pool size {} reached", this.a);
            }
