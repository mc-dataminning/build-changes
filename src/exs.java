...
public class exs {
   ...
   public static void a(File $$0, eqm $$1, Consumer<vq> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eqm $$2, Consumer<vq> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eqm $$2, Consumer<vq> $$3) {
      erb $$4 = a($$2);
   ...
   public static erb a(eqm $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      erb $$3 = new erb($$1, $$2, false);
   ...
   public exs(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
