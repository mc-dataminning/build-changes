...
public class exs extends exw implements exu {
   ...
   public exs.c a() {
      return new exs.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(eyc.b $$0, eyc $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (eyd)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(eyc $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == exv.k;
         boolean $$2 = $$0 == exv.j;
   ...
   private IntConsumer a(int $$0, eyc.a $$1) {
   ...
   private exs.b q() {
      ...
      this.k += $$5;
      this.j++;
      exs.a $$9 = new exs.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new exs.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eyc.b.a || this.q == eyc.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eyd> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eyd $$1 = (eyd)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eyd.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eyd.b.c) {
         exu.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, exu.a($$11));
         this.a($$14 + 5, exu.a($$12));
         this.a($$14 + 6, exu.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eyc a, int b, int c, eyc.b d, eyc.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eyc.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eyf $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
