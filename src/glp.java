public class glp extends giy {
   private static final int a = 12235202;

   protected glp(ggy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, glb $$8) {
   ...
   public static class a implements gkj<lx> {
      ...
      public gkg a(lx $$0, ggy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new glp($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
