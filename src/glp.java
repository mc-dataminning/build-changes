...
public class glp extends glj<cfr, fwd<cfr>> {
   private static final Map<cfr.a, akq> a = ad.a(Maps.newEnumMap(cfr.a.class), $$0 -> {
      $$0.put(cfr.a.a, akq.b("textures/entity/panda/panda.png"));
      $$0.put(cfr.a.b, akq.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(cfr.a.c, akq.b("textures/entity/panda/worried_panda.png"));
      $$0.put(cfr.a.d, akq.b("textures/entity/panda/playful_panda.png"));
      $$0.put(cfr.a.e, akq.b("textures/entity/panda/brown_panda.png"));
      $$0.put(cfr.a.f, akq.b("textures/entity/panda/weak_panda.png"));
      $$0.put(cfr.a.g, akq.b("textures/entity/panda/aggressive_panda.png"));
   });

   public glp(gkd.a $$0) {
      super($$0, new fwd<>($$0.a(fyd.aG)), 0.9F);
      this.a(new gol(this, $$0.d()));
   }

   public akq a(cfr $$0) {
      return a.getOrDefault($$0.gy(), a.get(cfr.a.a));
   }

   protected void a(cfr $$0, fbc $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.cb > 0) {
         int $$6 = $$0.cb;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ayn.i($$25, $$0.dI(), $$0.dI() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(ayn.i($$27, $$0.dI(), $$0.dI() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ayn.i($$3, $$0, $$1) : $$0;
   }
}
