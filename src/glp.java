...
public class glp extends auu<glp.a> {
   ...
   protected glp.a a(aup $$0, bos $$1) {
      ...
      return new glp.a($$2, $$3, $$4);
   }

   protected void a(glp.a $$0, aup $$1, bos $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aup $$0, bos $$1) {
      try {
         JsonObject var4;
         try (
            box $$2 = $$1.d("parse_json");
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, fem.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, fem.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, fem.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
