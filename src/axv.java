...
public class axv {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> axx.b.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<axv.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? akq.d($$0.substring(1)).map($$0x -> new axv.c($$0x, true)) : akq.d($$0).map($$0x -> new axv.c($$0x, false)), axv.c::c
      );
   ...
   public static final Codec<String> w = Codec.string(0, 16)
      .validate($$0 -> azk.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static Codec<String> A = Codec.STRING
      .validate($$0 -> !akq.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> axv.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new axv.b<>($$0, $$1);
   }
   ...
   public static record c(akq a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
