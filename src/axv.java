...
public class axv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bdt.y), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", axv::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", axv::a);
      return this.a($$0, "minecraft:trident", axv::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bdt.y, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bdt.y, $$1);
