...
public abstract class fui<B extends gcl.a<?>> extends fqd {
   ...
   protected final fqd x;
   protected final gcp y;
   protected final foc z = foc.d().a(8);
   protected B A;
   private fkm L;
   protected fkk B;

   protected fui(xd $$0, fqd $$1, gcp $$2, B $$3) {
      super($$0);
      this.x = $$1;
      this.y = $$2;
      this.A = $$3;
   ...
   protected flc a(int $$0, int $$1, Consumer<String> $$2) {
      AbuseReportLimits $$3 = this.y.a().b();
      flc $$4 = new flc(this.p, 0, 0, $$0, $$1, H, I);
      $$4.a(this.A.g());
   ...
   protected void m() {
      this.z.a(new flr(this.l, this.p));
   }

   protected abstract void D();

   protected void E() {
      this.L = this.z.a(fkm.a(J, this.p).a(this.A.h()).a(280).a(($$0x, $$1) -> {
         this.A.a($$1);
         this.F();
      }).a());
      foc $$0 = this.z.a(foc.e().a(8));
      $$0.a(fkk.a(xc.k, $$0x -> this.d()).a(120).a());
      this.B = $$0.a(fkk.a(a, $$0x -> this.G()).a(120).a());
   }

   protected void F() {
      gcl.b $$0 = this.A.c();
      this.B.j = $$0 == null && this.L.a();
      this.B.a(x.a($$0, gcl.b::a));
   }
   ...
   private void J() {
      this.L();
      this.m.a(fpp.a(E, C, xc.d, () -> this.m.a(null)));
   }
   ...
   private void a(xd $$0) {
      xd $$1 = $$0.f().a(n.m);
      this.m.a(fpp.a(F, $$1, xc.k, () -> this.m.a(this)));
   }
