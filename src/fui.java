public class fui extends fuk<cka> {
   ...
   public static fxh b() {
      ...
      fxg $$3 = fxg.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, fxd.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", fxg.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), fxd.a(0.0F, 0.0F, -8.25F));
      fxk $$11 = $$2.a("tail0", fxg.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), fxd.a);
      fxk $$12 = $$11.a("tail1", fxg.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), fxd.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", fxg.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), fxd.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(cka $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$8 != null) {
         ...
         evs $$12 = $$0.f(0.0F);
         $$12 = new evs($$12.c, 0.0, $$12.e);
         evs $$13 = new evs($$10.c - $$9.c, 0.0, $$10.e - $$9.e).d().b((float) (Math.PI / 2));
         double $$14 = $$12.b($$13);
         this.p.b = ayz.c((float)Math.abs($$14)) * 2.0F * (float)Math.signum($$14);
      }

      this.p.k = true;
      float $$15 = $$0.G($$6);
      this.r[0].f = ayz.a($$15) * (float) Math.PI * 0.05F;
      this.r[1].f = ayz.a($$15) * (float) Math.PI * 0.1F;
      this.r[2].f = ayz.a($$15) * (float) Math.PI * 0.15F;
   }
