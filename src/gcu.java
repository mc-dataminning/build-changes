...
public class gcu extends dxn {
   ...
   public gcu(gcy $$0, int $$1) {
      this.e = $$0;
      this.b = new dxp($$0, new del(0, 0), $$0.H_().e(ma.aG).b(dgo.b));
      this.c = new erd(this, true, $$0.D_().g());
      this.d = new gcu.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dxt $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         del $$3 = $$0.f();
   ...
   @Nullable
   public dxt b(int $$0, int $$1, dyk $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dxt $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dxt a(int $$0, int $$1, wi $$2, un $$3, Consumer<ads.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dxt $$6 = this.d.b.get($$5);
         del $$7 = new del($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dxt(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dxt> b;
      ...
      void a(int $$0, @Nullable dxt $$1) {
         dxt $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gcu.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dxt $$5 = gcu.this.d.b.get(gcu.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     del $$6 = $$5.f();
            ...
            gcu.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
