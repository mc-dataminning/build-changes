...
public class gcu {
   private static final akm a = new akm("textures/misc/underwater.png");

   public static void a(fdz $$0, eys $$1) {
      clw $$2 = $$0.s;
      if (!$$2.ag) {
         drb $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static void a(gnv $$0, eys $$1) {
   ...
   private static void b(fdz $$0, eys $$1) {
   ...
   private static void c(fdz $$0, eys $$1) {
      eyn $$2 = eyu.b().d();
      RenderSystem.setShader(gcd::r);
      ...
      float $$9 = ($$7 + $$8) / 2.0F;
      float $$10 = $$3.k();
      float $$11 = ayd.i($$10, $$4, $$6);
      float $$12 = ayd.i($$10, $$5, $$6);
      float $$13 = ayd.i($$10, $$7, $$9);
      float $$14 = ayd.i($$10, $$8, $$9);
      float $$15 = 1.0F;
