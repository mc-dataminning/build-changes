public class gcu extends gcr {
   private final gcm a;
   private static final int b = 8;

   protected gcu(fyj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gcm $$8) {
   ...
   public static class a implements gbu<ln> {
      ...
      public gbr a(ln $$0, fyj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gcu($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
