...
public class bll {
   ...
   private static void a(blt $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dsd, blx<bln>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((blx)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dsd, blx<bln>> $$3 : $$0) {
         blx<bln> $$4 = (blx<bln>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dsd)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<blv> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bla.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(blj $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bll::a));
      $$1.add("chunksWritten", this.a($$0.m(), bll::a));
      return $$1;
   }

   private JsonElement a(blq.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(blj $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bll::a));
      $$1.add("received", this.a($$0.k(), bll::a));
      return $$1;
   }

   private <T> JsonElement a(bls<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<blp> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<blp>, ToDoubleFunction<blp>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, blp::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, blp::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, blp::c));
      return $$1;
   }
}
