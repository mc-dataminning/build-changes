...
public class bll extends blq {
   public static final Codec<bll> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bll a(float $$0, float $$1, int $$2, int $$3) {
      return new bll($$0, $$1, $$2, $$3);
   }

   private bll(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(awt $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)awm.a(awm.c($$0, $$1, $$2), $$3, $$4);
   }
