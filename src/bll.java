...
public class bll extends blf {
   ...
   public bll(csy $$0, double $$1, double $$2, double $$3, int $$4) {
      this(blj.K, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bll(blj<? extends bll> $$0, csy $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         elb $$0 = new elb(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dM() instanceof amp) {
         for (bll $$1 : this.dM().a(dmn.a(bll.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(amp $$0, elb $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bll($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(amp $$0, elb $$1, int $$2) {
      ekw $$3 = ekw.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.F_().a(40);
      List<bll> $$5 = $$0.a(dmn.a(bll.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bll $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(bll $$0, int $$1, int $$2) {
      return !$$0.dH() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bll $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cer $$0, int $$1) {
      Entry<blk, cmh> $$2 = cqu.a(cqw.L, $$0, cmh::j);
      if ($$2 != null) {
         cmh $$3 = $$2.getValue();
