...
public class baf {
   ...
   private static final Optional<Object> b = Optional.of(bap.a);

   private static boolean a(yf $$0, ayx $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, yf $$1, ayx $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, yf $$1, ayx $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, yf $$1, ayx $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, yf $$2, ayx $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, yf $$2, yf $$3, ayx $$4) {
      int $$5 = $$0.length();
      yf $$6 = $$2;
   ...
   public static boolean a(xn $$0, yf $$1, ayx $$2) {
