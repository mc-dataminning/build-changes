...
public class ceb {
   ...
   @Nullable
   public static ewh a(btl $$0, Supplier<ja> $$1) {
      return a($$1, $$0::c);
   }

   @Nullable
   public static ewh a(Supplier<ja> $$0, ToDoubleFunction<ja> $$1) {
      ...
      return $$3 != null ? ewh.c($$3) : null;
   }

   public static ja a(btl $$0, int $$1, ayo $$2, ja $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.fX() && $$1 > 1) {
         ja $$6 = $$0.fU();
      ...
      return ja.a((double)$$4 + $$0.dw(), (double)$$3.v() + $$0.dy(), (double)$$5 + $$0.dC());
   }
}
