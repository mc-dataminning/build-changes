...
public class fet implements feq {
   ...
   private FT_Face c;
   final float d;
   private final fqu<fet.b> e = new fqu<>(fet.b[]::new, fet.b[][]::new);
   ...
   public fet(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      ...
      try {
         FT_Vector $$12 = frh.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fep a(int $$0, FT_Face $$1, int $$2) {
      ...
      if ($$3 != 0) {
         frh.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (frh.a) {
            frh.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
