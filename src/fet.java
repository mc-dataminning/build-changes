...
public class fet extends fev {
   ...
   static final fet.b l = new fet.b(854, 480);
   ...
   static enum a {
      ...
      private static final fet.a[] e = values();
   ...
   static class b {
      ...
      static List<fet.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fet.b($$0, $$1), fet.l) : ImmutableList.of(fet.l);
      }
