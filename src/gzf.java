...
public class gzf implements aty<gze> {
   public gze b(JsonObject $$0) {
      Builder<gzd> $$1 = ImmutableList.builder();
      int $$2 = ayz.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = ayz.a($$0, "width", -1);
      int $$9 = ayz.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = ayz.a($$0, "interpolate", false);
      return new gze($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gzd a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gzd(ayz.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = ayz.m($$1, "frames[" + $$0 + "]");
         int $$3 = ayz.a($$2, "time", -1);
         if ($$2.has("time")) {
