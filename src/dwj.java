...
public class dwj {
   ...
   private final List<dwh> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dwj.a l = new dwj.d(5.999997E7F);
   public static final dwj.c d = new dwj.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public jf b(double $$0, double $$1, double $$2) {
      return jf.a((jy)this.c($$0, $$1, $$2));
   }
   ...
   public eyw c(double $$0, double $$1, double $$2) {
      return new eyw(azf.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azf.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public boolean a(btr $$0, eyr $$1) {
      double $$2 = Math.max(azf.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dwj.a)($$0 == $$1 ? new dwj.d($$1) : new dwj.b($$0, $$1, $$2));
   ...
   class b implements dwj.a {
      ...
      @Override
      public double a() {
         return azf.a(dwj.this.a() - this.e() / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
      }

      @Override
      public double c() {
         return azf.a(dwj.this.b() - this.e() / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azf.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dwi i() {
         return this.c < this.b ? dwi.b : dwi.a;
      }
      ...
      @Override
      public dwj.a l() {
         return (dwj.a)(this.g() <= 0L ? dwj.this.new d(this.c) : this);
      }
      ...
      public ezq m() {
         return ezn.a(
            ezn.c,
            ezn.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eza.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dwj.c a(DynamicLike<?> $$0, dwj.c $$1) {
         double $$2 = azf.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azf.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dwj.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dwj.a {
      ...
      private void n() {
         this.c = azf.a(dwj.this.a() - this.b / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
         this.d = azf.a(dwj.this.b() - this.b / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
         this.e = azf.a(dwj.this.a() + this.b / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
         this.f = azf.a(dwj.this.b() + this.b / 2.0, (double)(-dwj.this.k), (double)dwj.this.k);
         this.g = ezn.a(
            ezn.c,
            ezn.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eza.e
