...
public abstract class dwj {
   public static dwj.b a(int $$0, int $$1) {
      return new dwj.b($$0 - 1, $$1 + 1);
   }

   public static dwj.b b(int $$0, int $$1) {
      return new dwj.b($$0, $$1);
   }

   public static dwj a(int $$0) {
      return new dwj.c($$0, false);
   }

   public static dwj b(int $$0) {
      return new dwj.c($$0 + 1, false);
   }

   public static dwj c(int $$0) {
      return new dwj.c($$0, true);
   }

   public static dwj d(int $$0) {
      return new dwj.c($$0 - 1, true);
   }
   ...
   public static dwj a(OptionalInt $$0, OptionalInt $$1) {
   ...
   public dwj a(OptionalInt $$0) {
      return a($$0, this.b());
   }

   public dwj b(OptionalInt $$0) {
      return a(this.c(), $$0);
   }

   public static Optional<dwj> a(dbd $$0, io $$1, int $$2, Predicate<drb> $$3, Predicate<drb> $$4) {
      io.a $$5 = $$1.j();
      if (!$$0.a($$1, $$3)) {
   ...
   private static OptionalInt a(dbd $$0, int $$1, Predicate<drb> $$2, Predicate<drb> $$3, io.a $$4, int $$5, it $$6) {
      $$4.q($$5);
   ...
   public static final class a extends dwj {
      static final dwj.a a = new dwj.a();
   ...
   public static final class c extends dwj {
      private final int a;
