...
public abstract class bwa extends bwd {
   static final Logger o = LogUtils.getLogger();
   public static final int a = -1;
   private static final akj<Integer> p = akn.a(bwa.class, akl.b);
   private static final akj<Integer> q = akn.a(bwa.class, akl.b);
   private static final akj<Integer> r = akn.a(bwa.class, akl.b);
   private static final akj<Vector3f> s = akn.a(bwa.class, akl.F);
   private static final akj<Vector3f> t = akn.a(bwa.class, akl.F);
   private static final akj<Quaternionf> u = akn.a(bwa.class, akl.G);
   private static final akj<Quaternionf> ay = akn.a(bwa.class, akl.G);
   private static final akj<Byte> az = akn.a(bwa.class, akl.a);
   private static final akj<Integer> aA = akn.a(bwa.class, akl.b);
   private static final akj<Float> aB = akn.a(bwa.class, akl.d);
   private static final akj<Float> aC = akn.a(bwa.class, akl.d);
   private static final akj<Float> aD = akn.a(bwa.class, akl.d);
   private static final akj<Float> aE = akn.a(bwa.class, akl.d);
   private static final akj<Float> aF = akn.a(bwa.class, akl.d);
   private static final akj<Integer> aG = akn.a(bwa.class, akl.b);
   ...
   @Nullable
   private bwa.j aT;
   private final bwx aU = new bwx(this, 0);

   public bwa(bwm<?> $$0, div $$1) {
      super($$0, $$1);
      this.ad = true;
      this.aP = this.cR();
   }
   ...
   protected void a(tz $$0) {
      ...
      this.a($$0.<bwa.a>a("billboard", bwa.a.e).orElse(bwa.a.a));
   ...
   private void a(bwa.a $$0) {
      this.al.a(az, $$0.a());
   }

   private bwa.a q() {
      return bwa.a.f.apply(this.al.a(az));
   }
   ...
   private void A() {
      ...
      double $$4 = this.dC();
      double $$5 = this.dG();
      this.aP = new fed($$3 - (double)$$2, $$4, $$5 - (double)$$2, $$3 + (double)$$2, $$4 + (double)$$1, $$5 + (double)$$2);
   }
   ...
   private bwa.j B() {
      return new bwa.j(bwa.e.constant(a(this.al)), this.q(), this.t(), bwa.d.constant(this.v()), bwa.d.constant(this.w()), this.y());
   }

   private bwa.j a(bwa.j $$0, float $$1) {
      j $$2 = $$0.a.get($$1);
      float $$3 = $$0.d.get($$1);
      float $$4 = $$0.e.get($$1);
      return new bwa.j(new bwa.l($$2, a(this.al)), this.q(), this.t(), new bwa.h($$3, this.v()), new bwa.h($$4, this.w()), this.y());
   }
   ...
   public static enum a implements bak {
      ...
      public static final Codec<bwa.a> e = bak.a(bwa.a::values);
      public static final IntFunction<bwa.a> f = ayc.a(bwa.a::a, values(), ayc.a.a);
   ...
   public static class b extends bwa {
      public static final String o = "block_state";
      private static final akj<dzz> p = akn.a(bwa.b.class, akl.i);
      @Nullable
      private bwa.b.a q;

      public b(bwm<?> $$0, div $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(boolean $$0, float $$1) {
         this.q = new bwa.b.a(this.n());
      }

      public static record a(dzz a) {
      }
   }

   static record c(int a, int b) implements bwa.f {
      @Override
   ...
   public static class g extends bwa {
      private static final String o = "item";
      private static final String p = "item_display";
      private static final akj<cyy> q = akn.a(bwa.g.class, akl.h);
      private static final akj<Byte> r = akn.a(bwa.g.class, akl.a);
      private final bxt s = bxt.a(this::n, this::a);
      @Nullable
      private bwa.g.a t;

      public g(bwm<?> $$0, div $$1) {
         super($$0, $$1);
      }
      ...
      private cyw o() {
         return cyw.k.apply(this.al.a(r));
      }
      ...
      protected void a(tz $$0) {
         super.a($$0);
         if ($$0.e("item")) {
            this.a(cyy.a(this.dX(), (uw)$$0.p("item")).orElse(cyy.k));
         } else {
            this.a(cyy.k);
         }

         this.a($$0.<cyw>a("item_display", cyw.j).orElse(cyw.a));
      }
      ...
      protected void b(tz $$0) {
         ...
         $$0.a("item_display", cyw.j, this.o());
      }

      @Override
      public bxt a_(int $$0) {
         return $$0 == 0 ? this.s : bxt.a;
      }
      ...
      protected void a(boolean $$0, float $$1) {
         cyy $$2 = this.n();
         $$2.a(this);
         this.t = new bwa.g.a($$2, this.o());
      }

      public static record a(cyy a, cyw b) {
      }
   }

   static record h(float a, float b) implements bwa.d {
      @Override
   ...
   static record i(int a, int b) implements bwa.f {
      @Override
      public int get(float $$0) {
   ...
   public static record j(bwa.e<j> a, bwa.a b, int c, bwa.d d, bwa.d e, int f) {
   }

   public static class k extends bwa {
      ...
      private static final akj<wy> aG = akn.a(bwa.k.class, akl.f);
      private static final akj<Integer> aH = akn.a(bwa.k.class, akl.b);
      private static final akj<Integer> aI = akn.a(bwa.k.class, akl.b);
      private static final akj<Byte> aJ = akn.a(bwa.k.class, akl.a);
      private static final akj<Byte> aK = akn.a(bwa.k.class, akl.a);
      ...
      protected void a(tz $$0) {
         ...
         Optional<bwa.k.a> $$2 = bwa.k.a.d.decode(un.a, $$0.c("alignment")).resultOrPartial(af.a("Display entity", bwa.o::error)).map(Pair::getFirst);
         if ($$2.isPresent()) {
            $$1 = switch ((bwa.k.a)$$2.get()) {
               case a -> $$1;
               case b -> (byte)($$1 | 8);
               case c -> (byte)($$1 | 16);
            };
         ...
         if ($$3 != null) {
            ...
            try {
               ...
               bwa.o.warn("Failed to parse display entity text {}", $$3, var10);
            }
         }
      }
      ...
      private bwa.k.e u() {
         return new bwa.k.e(this.n(), this.o(), bwa.f.constant(this.q()), bwa.f.constant(this.s()), this.t());
      }

      private bwa.k.e a(bwa.k.e $$0, float $$1) {
         int $$2 = $$0.d.get($$1);
         int $$3 = $$0.c.get($$1);
         return new bwa.k.e(this.n(), this.o(), new bwa.i($$3, this.q()), new bwa.c($$2, this.s()), this.t());
      }

      public bwa.k.b a(bwa.k.d $$0) {
         if (this.aM == null) {
            if (this.aN != null) {
               this.aM = $$0.split(this.aN.a(), this.aN.b());
            } else {
               this.aM = new bwa.k.b(List.of(), 0);
            }
         }
      ...
      public static bwa.k.a a(byte $$0) {
         if (($$0 & 8) != 0) {
            return bwa.k.a.b;
         } else {
            return ($$0 & 16) != 0 ? bwa.k.a.c : bwa.k.a.a;
         }
      }
      ...
      public static enum a implements bak {
         ...
         public static final Codec<bwa.k.a> d = bak.a(bwa.k.a::values);
      ...
      public static record b(List<bwa.k.c> a, int b) {
      }
      ...
      @FunctionalInterface
      public interface d {
         bwa.k.b split(wy var1, int var2);
      }

      public static record e(wy a, int b, bwa.f c, bwa.f d, byte e) {
      }
   }

   static record l(j a, j b) implements bwa.e<j> {
      public j a(float $$0) {
