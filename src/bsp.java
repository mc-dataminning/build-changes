...
public class bsp extends bsr {
   ...
   public bsp(bmq $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dM();
      this.h = $$1;
      this.i = $$0.N();
   ...
   private boolean a(hv $$0) {
      eek $$1 = eet.a(this.g, $$0.j());
      if ($$1 != eek.c) {
         return false;
      } else {
         dip $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof dai) {
            return false;
         } else {
            hv $$3 = $$0.b(this.e.dm());
