...
public abstract class bsp {
   ...
   public bsp(bji $$0, cpv $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = arw.a($$0.b(bkm.b) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract ebd a(int var1);
   ...
   @Nullable
   public final ebb a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(gw.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ebb a(Stream<gw> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ebb a(Set<gw> $$0, int $$1) {
   ...
   @Nullable
   protected ebb a(Set<gw> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.b(bkm.b));
   }

   @Nullable
   protected ebb a(Set<gw> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         cqi $$7 = new cqi(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         ebb $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ad().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ebb $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            if ($$0.d > $$1.d && !this.a.aA() && arw.a($$0.c) == arw.a($$1.c) && arw.a($$0.e) == arw.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(ehn $$0) {
      gw $$1 = gw.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ebg.a(this.b, $$1);
   }
   ...
   private boolean c(ehn $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ehn $$1 = ehn.c(this.c.g());
         if (!$$0.a((ho)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ehn $$2 = ehn.c(this.c.d(this.c.f() + 1));
            ehn $$3 = $$1.d($$0);
            ehn $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void R_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eaz $$1 = this.c.a($$0);
            eaz $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dfj $$3 = this.b.a_(new gw($$1.a, $$1.b, $$1.c));
            if ($$3.a(aps.bk)) {
   ...
   public boolean b(eax $$0) {
      return $$0 != eax.n && $$0 != eax.p && $$0 != eax.d;
   }
   ...
   public boolean b(gw $$0) {
      if (this.m) {
         ...
         eaz $$1 = this.c.d();
         ehn $$2 = new ehn(((double)$$1.a + this.a.dq()) / 2.0, ((double)$$1.b + this.a.ds()) / 2.0, ((double)$$1.c + this.a.dw()) / 2.0);
