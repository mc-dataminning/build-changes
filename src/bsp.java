...
public class bsp extends bst {
   ...
   public static bsp a(float $$0, float $$1, float $$2, float $$3) {
      return new bsp($$0, $$1, $$2, $$3);
   }

   private bsp(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(azs $$0, float $$1, float $$2, float $$3, float $$4) {
