...
public abstract class bsp extends btz {
   private static final akk<Boolean> bY = ako.a(bsp.class, akm.k);
   ...
   protected bsp(btb<? extends bsp> $$0, dbz $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bsp a(arf var1, bsp var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof cow $$0 && !$$0.b((bsv)this)) {
         this.ac();
      }
   }
