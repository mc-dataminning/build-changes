...
public class bsp extends bst implements bun {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final akj<Float> f = akn.a(bsp.class, akl.d);
   private static final akj<Boolean> g = akn.a(bsp.class, akl.k);
   private static final akj<lg> h = akn.a(bsp.class, akl.l);
   ...
   private cwp l = cwp.a;
   private final Map<bst, Integer> m = Maps.newHashMap();
   private int n = 600;
   private int o = 20;
   private int p = 20;
   private int q;
   ...
   public bsp(bsz<? extends bsp> $$0, dbx $$1) {
      super($$0, $$1);
      this.ag = true;
   }

   public bsp(dbx $$0, double $$1, double $$2, double $$3) {
      this(bsz.b, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dP().B) {
         this.ap().a(f, ayy.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void u() {
      ...
      if ($$0 instanceof lb $$1) {
         int $$2 = this.l.equals(cwp.a) ? 0 : this.l.b();
         this.ao.a(h, lb.a($$1.a(), ayi.b.e($$2)));
      }
   }
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         if ($$0) {
            ...
            $$3 = ayy.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ah.i() * (float) (Math.PI * 2);
            float $$9 = ayy.c(this.ah.i()) * $$4;
            double $$10 = this.du() + (double)(ayy.b($$8) * $$9);
            double $$11 = this.dw();
            double $$12 = this.dA() + (double)(ayy.a($$8) * $$9);
            if ($$2.a() == li.u) {
               if ($$0 && this.ah.h()) {
         ...
         if (this.ai % 5 == 0) {
            ...
            if (!this.l.c()) {
               ...
               List<bsb> $$14 = Lists.newArrayList();
               if (this.l.e().isPresent()) {
                  for (bsb $$15 : this.l.e().get().a().a()) {
                     $$14.add(new bsb($$15.c(), $$15.a($$0x -> $$0x / 4), $$15.e(), $$15.f(), $$15.g()));
                  }
               }

               $$14.addAll(this.l.d());
               List<bto> $$16 = this.dP().a(bto.class, this.cK());
               if (!$$16.isEmpty()) {
                  for (bto $$17 : $$16) {
   ...
   protected void a(ur $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cwp.b.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> d.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(ur $$0) {
      ...
      if (!this.l.equals(cwp.a)) {
         vo $$2 = (vo)cwp.b.encodeStart($$1, this.l).getOrThrow();
