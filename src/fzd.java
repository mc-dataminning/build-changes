...
public class fzd extends ful {
   ...
   private final fsh M = new fsh(this);
   @Nullable
   private final ful N;
   fzc O;
   fpc P;
   private String Q = "";
   private fzd.a R = fzd.a.a;
   private fot S;
   private fot T;
   private fot U;
   private fot V;
   ...
   protected void aR_() {
      this.M.a(c, this.p);
      this.O = new fzc(this, this.m, this.n, this.E() - 88, 88, 36);
      int $$0 = this.O.a() / 3;
      int $$1 = this.O.u();
      int $$2 = this.O.v();
      this.S = this.c(fot.a(u, $$0x -> this.a(fzd.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fot.a(v, $$0x -> this.a(fzd.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fot.a(w, $$0x -> this.a(fzd.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fpc(this.p, this.F() + 28, 74, 200, 15, A) {
         @Override
         protected xd d() {
            return !fzd.this.P.a().isEmpty() && fzd.this.O.b() ? super.d().f(", ").b(fzd.B) : super.d();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fot.a(E, fti.b(this, axv.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fot.a(wo.d, $$0x -> this.aO_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(foe $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(gmi::H, d, $$4, 64, 236, this.m() + 16);
      $$0.a(gmi::H, s, $$4 + 10, 76, 12, 12);
   }
