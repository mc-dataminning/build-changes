...
public class edv extends edz {
   public static final Codec<edv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               edi.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               axh.a(is.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, edv::new)
   );
   ...
   protected final List<is> g;

   public edv(float $$0, int $$1, int $$2, edi $$3, int $$4, List<is> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public void a(edz.a $$0) {
      ...
      for (in $$3 : ac.a($$0.d(), $$2)) {
         ...
         if (!$$1.contains($$5) && $$2.i() < this.b && this.a($$0, $$3, $$4)) {
            in $$6 = $$5.b(-this.c, -this.d, -this.c);
            in $$7 = $$5.b(this.c, this.d, this.c);
   ...
   private boolean a(edz.a $$0, in $$1, is $$2) {
