...
public class edv {
   private static final edv a = new edv(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public edv.a a(int $$0, int $$1) {
         return new edv.a(1.0, 0.0);
      }
   ...
   private static final esd b = esd.b(new edu(42L), qi.a);
   ...
   private final Long2ObjectOpenHashMap<edw> h;
   private final Long2ObjectOpenHashMap<edw> i;

   public static edv a() {
      return a;
   }

   public static edv a(@Nullable arl $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dfp $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<edw> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<edw> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayz.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new edv($$2, $$3);
         }
      }
   }

   edv(Long2ObjectOpenHashMap<edw> $$0, Long2ObjectOpenHashMap<edw> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public edv.a a(int $$0, int $$1) {
      int $$2 = kc.a($$0);
      int $$3 = kc.a($$1);
      double $$4 = this.a($$2, 0, $$3, edw::a);
      if ($$4 != Double.MAX_VALUE) {
         return new edv.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dfp.a($$5x)), kc.d(dfp.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(ecm.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kc.d(dfp.a($$6x)), kc.d(dfp.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, edv.b $$3) {
      int $$4 = kc.e($$0);
      int $$5 = kc.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(edv.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      edw $$6 = (edw)this.h.get(dfp.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kc.d($$1), $$4, $$5 - kc.d($$2)) : Double.MAX_VALUE;
   }

   public dho a(dho $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jr<dhl> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jr<dhl> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jr<dhl>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dfp.a($$5x)), $$1, kc.d(dfp.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(arl $$0, dyt $$1) {
      dfp $$2 = $$1.f();
      boolean $$3 = $$1.u();
      ji.a $$4 = new ji.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ect.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dyt $$0, ji $$1) {
      dwy $$2 = $$0.a_($$1);
      if ($$2.a(awp.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dhh $$0, dzn $$1) {
      dfp $$2 = $$1.f();
      Builder<jo, edw> $$3 = ImmutableMap.builder();
   ...
   public static edv.c a(@Nullable edw $$0, Map<jo, edw> $$1) {
      List<edv.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static edv.c a(@Nullable jo $$0, edw $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jn $$4 : $$0.a()) {
   ...
   interface b {
      double get(edw var1, int var2, int var3, int var4);
   }
