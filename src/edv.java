...
public class edv {
   ...
   private final dgk o;
   private static final List<djm> p = List.of(djo.l, djo.O, djo.i, djo.b, djo.k, djo.L, djo.N, djo.fA, djo.ec, djo.iY, djo.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jr<dhk>>> s;
   private final transient double[][] t;

   private edv(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> af.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jr<dhk>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kk.c($$0);
      int $$5 = kk.c($$1) - $$4;
   ...
   @Nullable
   public static edv a(@Nullable edv.d $$0) {
      return $$0 == null ? null : new edv($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public edv.d a() {
      ...
      return new edv.d(this.o.ap(), this.o.aq() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static edv a(arl $$0, int $$1, int $$2) {
      dys $$3 = $$0.a($$1, $$2);
      edv $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(dzt.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jo> a(dhg $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dys $$1, int $$2, int $$3) {
   ...
   private int a(dys $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ecs.a.a)) {
         $$3 = Math.min($$0.a(ecs.a.a, $$1, $$2), this.o.an());
      } else {
         $$3 = this.o.an();
      }
   ...
   private static double a(dys $$0, ji.a $$1) {
      return a($$0, (ji)$$1.c(jn.a)) ? 1.0 : -1.0;
   }

   private static double b(dys $$0, ji.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dys $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jr<dhk>> b(dys $$0, int $$1, int $$2) {
      ObjectArrayList<jr<dhk>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dys $$0, ji $$1) {
      dwx $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(awp.Q)) {
         ...
         return $$2.a(djo.fh) || $$2.a(djo.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, edv.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, edv.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jr<dhk> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<edv.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(edv.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(edv.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(edv.d::c)
                  )
                  .apply($$0, edv.d::new)
         )
         .validate(edv.d::a);

      private static DataResult<edv.d> a(edv.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != edv.n
            ? DataResult.error(() -> "heights has to be of length " + edv.n)
