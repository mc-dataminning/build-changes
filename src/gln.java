...
public class gln extends aut<gln.a> {
   ...
   protected gln.a a(auo $$0, bor $$1) {
      ...
      return new gln.a($$2, $$3, $$4);
   }

   protected void a(gln.a $$0, auo $$1, bor $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(auo $$0, bor $$1) {
      try {
         JsonObject var4;
         try (
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, fel.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, fel.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, fel.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
