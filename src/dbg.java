...
public abstract class dbg implements ep {
   ...
   public abstract ewf g();

   public abstract eq i();

   @Override
   public boolean l_() {
      return this.e().ab().b(dcb.p) && this.g;
   }
