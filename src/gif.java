...
public class gif extends avj<Optional<gif.b>> implements AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private static final all b = all.b("textures/environment/clouds.png");
   ...
   private gif.a o = gif.a.b;
   @Nullable
   private fjj p;
   @Nullable
   private gif.b q;
   private final fen r = new fen(fce.b);
   private boolean s;

   protected Optional<gif.b> a(ave $$0, bor $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gif.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gif.b> $$0, ave $$1, bor $$2) {
   ...
   public void a(int $$0, fjj $$1, float $$2, Matrix4f $$3, Matrix4f $$4, ezr $$5, float $$6) {
      if (this.q != null) {
         ...
         $$12 -= (double)azn.a($$12 / $$14) * $$14;
         $$13 -= (double)azn.a($$13 / $$15) * $$15;
         int $$16 = azn.a($$12 / 12.0);
         int $$17 = azn.a($$13 / 12.0);
         float $$18 = (float)($$12 - (double)((float)$$16 * 12.0F));
         float $$19 = (float)($$13 - (double)((float)$$17 * 12.0F));
         gjh $$20 = $$1 == fjj.c ? gjh.w() : gjh.v();
         this.r.a();
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            fej $$21 = this.a(fem.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
         ...
         if (!this.s) {
            RenderSystem.setShaderColor(axy.h(axy.b($$0)), axy.h(axy.c($$0)), axy.h(axy.d($$0)), 1.0F);
            if ($$1 == fjj.c) {
               this.a(gjh.x(), $$3, $$4, $$18, $$7, $$19);
            }
   ...
   private void a(gjh $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gig $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fej a(fem $$0, int $$1, int $$2, fjj $$3, gif.a $$4, gjh $$5) {
      float $$6 = 0.8F;
      ...
      fef $$11 = $$0.a($$5.O(), $$5.N());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fjj.c);
      return $$11.a();
   }

   private void a(gif.a $$0, fef $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(fef $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(gif.a $$0, fef $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
