...
public class gif implements ara<gie> {
   public gie b(JsonObject $$0) {
      Builder<gid> $$1 = ImmutableList.builder();
      ...
      return new gie($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gid a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gid(avx.g($$1, "frames[" + $$0 + "]"));
