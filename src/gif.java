...
public class gif implements AutoCloseable {
   ...
   public gif(ghx $$0, fji $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new fcm(16, 16, false);
      this.e.a(9729);
   ...
   private float b(float $$0) {
      btj $$1 = this.i.t.c(btl.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bva $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, azk.b(((float)$$0.ag - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(btl.p)) {
               $$10 = ghx.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(btl.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            ghq $$18 = Objects.requireNonNull(RenderSystem.setShader(ghr.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            fdw $$19 = RenderSystem.renderThreadTesselator().a(feg.c.h, fdz.a);
            $$19.a(0.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 1.0F, 0.0F);
            $$19.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(dzf $$0, int $$1) {
      return a($$0.s(), $$1);
   }
