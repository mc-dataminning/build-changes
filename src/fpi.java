...
public class fpi extends fom {
   ...
   public fpi(fnz $$0, int $$1, int $$2, int $$3, int $$4, wo $$5, wo $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.n = $$0;
      this.o = $$5;
      this.p = new fpl($$0, $$3 - this.b());
      this.p.a(this::r);
   }
   ...
   @Override
   public void a(fsn $$0) {
      $$0.a(fsm.a, wo.a("gui.narrate.editBox", this.B(), this.q()));
   }
   ...
   private void r() {
      double $$0 = this.g();
      fpl.a $$1 = this.p.c((int)($$0 / 9.0));
      if (this.p.d() <= $$1.a()) {
         $$0 = (double)(this.p.g() * 9);
      } else {
         fpl.a $$2 = this.p.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.p.d() > $$2.b()) {
