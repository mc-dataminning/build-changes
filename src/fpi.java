...
public class fpi extends fob<crd> {
   ...
   private int ah;
   private final fpi.a[] ai = new fpi.a[7];
   int aj;
   private boolean ak;

   public fpi(crd $$0, cmw $$1, xp $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.u = 107;
   }
   ...
   protected void aM_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.ai[$$3] = this.c(new fpi.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fpi.a) {
               this.ah = ((fpi.a)$$0x).a() + this.aj;
               this.I();
            }
         }));
         $$2 += 20;
   ...
   private void a(fgr $$0, int $$1, int $$2, daw $$3) {
      int $$4 = this.w.n();
      int $$5 = this.w.l();
      if ($$4 < 5) {
   ...
   private void a(fgr $$0, int $$1, int $$2, dax $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fgr $$0, daw $$1, int $$2, int $$3) {
   ...
   private void a(fgr $$0, cup $$1, cup $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.I() == $$1.I()) {
         $$0.a(this.p, $$1, $$3, $$4);
      } else {
   ...
   class a extends fhe {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fhe.c $$3) {
      ...
      public void a(fgr $$0, int $$1, int $$2) {
         if (this.i && fpi.this.w.p().size() > this.a + fpi.this.aj) {
            if ($$1 < this.C() + 20) {
               cup $$3 = fpi.this.w.p().get(this.a + fpi.this.aj).b();
               $$0.b(fpi.this.p, $$3, $$1, $$2);
            } else if ($$1 < this.C() + 50 && $$1 > this.C() + 30) {
               cup $$4 = fpi.this.w.p().get(this.a + fpi.this.aj).c();
               if (!$$4.e()) {
                  $$0.b(fpi.this.p, $$4, $$1, $$2);
               }
            } else if ($$1 > this.C() + 65) {
               cup $$5 = fpi.this.w.p().get(this.a + fpi.this.aj).f();
               $$0.b(fpi.this.p, $$5, $$1, $$2);
            }
         }
      }
   }
