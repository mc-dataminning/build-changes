...
public class gej extends gee<cbs, fpc<cbs>> {
   private static final Map<cbs.a, ajh> a = ac.a(Maps.newEnumMap(cbs.a.class), $$0 -> {
      $$0.put(cbs.a.a, new ajh("textures/entity/panda/panda.png"));
      $$0.put(cbs.a.b, new ajh("textures/entity/panda/lazy_panda.png"));
      $$0.put(cbs.a.c, new ajh("textures/entity/panda/worried_panda.png"));
      $$0.put(cbs.a.d, new ajh("textures/entity/panda/playful_panda.png"));
      $$0.put(cbs.a.e, new ajh("textures/entity/panda/brown_panda.png"));
      $$0.put(cbs.a.f, new ajh("textures/entity/panda/weak_panda.png"));
      $$0.put(cbs.a.g, new ajh("textures/entity/panda/aggressive_panda.png"));
   });

   public gej(gcy.a $$0) {
      super($$0, new fpc<>($$0.a(frc.aB)), 0.9F);
      this.a(new ghf(this, $$0.d()));
   }

   public ajh a(cbs $$0) {
      return a.getOrDefault($$0.gz(), a.get(cbs.a.a));
   }

   protected void a(cbs $$0, etz $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bY > 0) {
         int $$6 = $$0.bY;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(aww.i($$25, $$0.dE(), $$0.dE() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(aww.i($$27, $$0.dE(), $$0.dE() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? aww.i($$3, $$0, $$1) : $$0;
   }
}
