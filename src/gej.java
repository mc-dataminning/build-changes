public class gej extends gea<hax> {
   public static final ghm a = ghm.scaling(2.35F);
   ...
   private final ghd m;
   private final ghd n;
   private final ghd[] o = new ghd[12];
   private final ghd[] p;
   ...
   public static ghj a() {
      ...
      ghi $$3 = ghi.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, ghf.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", ghi.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), ghf.a(0.0F, 0.0F, -8.25F));
      ghn $$11 = $$2.a("tail0", ghi.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), ghf.a);
      ghn $$12 = $$11.a("tail1", ghi.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), ghf.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", ghi.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), ghf.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(hax $$0) {
      ...
      if ($$0.e != null && $$0.d != null) {
         ...
         fcu $$3 = $$0.d;
         $$3 = new fcu($$3.d, 0.0, $$3.f);
         fcu $$4 = new fcu($$0.c.d - $$0.e.d, 0.0, $$0.c.f - $$0.e.f).d().b((float) (Math.PI / 2));
         double $$5 = $$3.b($$4);
