...
public class gbs implements exd, AutoCloseable {
   ...
   private static final eww t = new eww();
   ...
   private final List<exe> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, exe> C = Maps.newHashMap();
   private final int D;
   ...
   public gbs(atr $$0, String $$1, exs $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      akf $$3 = new akf("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = axm.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(axm.a($$5, "blend", null));
         this.H = a($$0, exb.a.a, $$6);
         this.I = a($$0, exb.a.b, $$7);
         this.D = exc.a();
         int $$18 = 0;
   ...
   private static exb a(final atr $$0, exb.a $$1, String $$2) throws IOException {
      exb $$3 = $$1.c().get($$2);
      exb $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         atm $$5 = $$0.getResourceOrThrow(new akf($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = exb.a($$1, $$2, $$6, $$5.b(), new ewu() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gbs.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static ewx a(JsonObject $$0) {
      if ($$0 == null) {
         return new ewx();
      } else {
         int $$1 = 32774;
