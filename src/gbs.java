...
public class gbs implements AutoCloseable {
   private final gbe c;
   public final ewj a;
   public final ewj b;
   ...
   public gbs(atu $$0, String $$1, ewj $$2, ewj $$3, boolean $$4) throws IOException {
      this.c = new gbe($$0, $$1);
      this.a = $$2;
      this.b = $$3;
      this.i = $$4 ? 9729 : 9728;
   ...
   public void a(float $$0) {
      ...
      this.c.b("Time").a($$0);
      fde $$4 = fde.Q();
      this.c.b("ScreenSize").a((float)$$4.aP().k(), (float)$$4.aP().l());
      this.c.g();
      this.b.b(fde.a);
      this.b.a(false);
