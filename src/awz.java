...
public class awz {
   ...
   awz(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static awz.a a() {
      return new awz.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(awz::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public awz.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public awz a(Writer $$0) throws IOException {
         return new awz($$0, this.a);
      }
   }
}
