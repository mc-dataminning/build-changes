...
public record bl(List<eg<bub>> b, Optional<bw> c, Optional<bw> d, Optional<Boolean> e) {
   ...
   public static class a {
      private final Builder<eg<bub>> a = ImmutableList.builder();
