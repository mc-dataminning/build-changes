...
public class eqx {
   ...
   public void a(esh $$0, String $$1, etd.a $$2, egv $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eqx.b $$13 = new eqx.b($$1.trim(), this.f, $$3, $$2);
                  eqx.a $$14 = new eqx.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eqx.c $$30 = new eqx.c(this.f, $$2, $$0);
                        eqx.a $$31 = new eqx.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new esl(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, egv $$2) throws IOException {
      ...
      File $$15 = new File(evr.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, egv $$2, etd.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eqx.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eqx.this.b && !eqx.this.d) {
            try {
               eqx.this.e = true;
               eqx.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eqx.a.error("Error extracting archive", var3);
               eqx.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final etd.a c;
      private final esh d;

      c(File $$0, etd.a $$1, esh $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eqx.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eqx.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eqx.this.g);
                  eqx.this.c = true;
               } else {
                  eqx.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eqx.this.d = true;
               }
            } catch (IOException var3) {
               eqx.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eqx.this.d = true;
            }
         }
      }
