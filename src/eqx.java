...
public class eqx {
   ...
   public static void a(File $$0, ejs $$1, Consumer<tf> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ejs $$2, Consumer<tf> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ejs $$2, Consumer<tf> $$3) {
      ekh $$4 = a($$2);
   ...
   public static ekh a(ejs $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ekh $$3 = new ekh($$1, $$2, false);
   ...
   public eqx(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
