...
public class eqx {
   ...
   public void a(eqx.b $$0, List<aly> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new eqx.c($$0, $$1.stream().map(aly::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new eqx.c(eqx.b.c, ImmutableList.of());
      }

      this.b.c = new eqx.a($$0);
   }
   ...
   static class c {
      private final eqx.b a;
      private final List<String> b;
      @Nullable
      eqx.a c;
      boolean d;

      c(eqx.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
