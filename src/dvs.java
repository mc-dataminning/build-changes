...
public class dvs {
   private static final dpi a = dcj.hj.n();
   private static final dpi b = dcj.hk.n();
   private static final dpi c = dcj.iA.n();
   private static final dpi d = dcj.hn.n();
   private static final dpi e = dcj.hv.n();
   private static final dpi f = dcj.hx.n();
   private static final dpi g = dcj.hr.n();
   private static final dpi h = dcj.iC.n();
   private static final dpi i = dcj.dP.n();
   private final dpi j;
   private final int k;
   private final dpi[] l;
   private final eke m;
   ...
   public dvs(dvo $$0, dpi $$1, int $$2, dvn $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dvj.P);
      this.l = a($$3.a(new ajv("clay_bands")));
      this.u = $$0.a(dvj.N);
      this.v = $$0.a(dvj.O);
      this.n = $$0.a(dvj.Q);
      this.o = $$0.a(dvj.R);
   ...
   public void a(dvo $$0, dah $$1, ja<daf> $$2, boolean $$3, dvx $$4, final dre $$5, dve $$6, dvr.o $$7) {
      final id.a $$8 = new id.a();
      final cyn $$9 = $$5.f();
      int $$10 = $$9.d();
      int $$11 = $$9.e();
      drb $$12 = new drb() {
      ...
      dvr.g $$13 = new dvr.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dvr.u $$14 = $$7.apply($$13);
      id.a $$15 = new id.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dva.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            in<daf> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dam.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dva.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dpi> a(dvr.o $$0, dxa $$1, Function<id, in<daf>> $$2, dre $$3, dve $$4, id $$5, boolean $$6) {
      dvr.g $$7 = new dvr.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(ku.aw), $$1);
      dvr.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dpi $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(drb $$0, int $$1, int $$2, int $$3, czi $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, daf $$1, drb $$2, id.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dcj.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(axt $$0, dpi[] $$1, int $$2, dpi $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dpi a(int $$0, int $$1, int $$2) {
