...
public class dvs implements axr {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dvs> b = dvr.a.xmap($$0 -> new dvs($$0), $$0 -> $$0.e);
   private dvr e;
   private final dut f = new dut(this);

   public dvs(long $$0) {
      this.e = new dvr(dvg.c($$0));
   }
   ...
   @Override
   public axr d() {
      return new dvs(this.e.a(), this.e.a());
   }

   @Override
   public dve e() {
      return new dvs.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dve {
      ...
      public axr a(int $$0, int $$1, int $$2) {
         long $$3 = axk.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dvs($$4, this.b);
      }

      @Override
      public axr a(String $$0) {
         dvg.a $$1 = dvg.a($$0);
         return new dvs($$1.a(this.a, this.b));
      }
