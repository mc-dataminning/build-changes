...
public class dvs implements dvo, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final boz<bpb.b> c;
   private final dvx d;
   private final Map<dbm, dvs.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvs(dvz $$0, Path $$1, boolean $$2) {
      this.d = new dvx($$0, $$1, $$2);
      this.c = new boz<>(new bpb.a(dvs.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dbm $$0, int $$1) {
      dbm $$2 = new dbm($$0.e - $$1, $$0.f - $$1);
      dbm $$3 = new dbm($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dbm $$0, @Nullable tx $$1) {
      return this.a(() -> {
         dvs.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvs.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dbm $$0, ur $$1) {
      return this.a(() -> {
         try {
            dvs.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bpb.b(dvs.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dbm, dvs.a>> $$0 = this.e.entrySet().iterator();
         Entry<dbm, dvs.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bpb.b(dvs.b.b.ordinal(), this::a));
   }

   private void a(dbm $$0, dvs.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bpb.b(dvs.b.c.ordinal(), () -> $$0.a(azk.a))).join();
         this.c.close();
