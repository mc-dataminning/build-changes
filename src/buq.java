...
public class buq<E extends bto> {
   ...
   private final Map<Integer, Map<col, Set<bvi<? super E>>>> f = Maps.newTreeMap();
   private coo g = coo.c;
   private final Map<col, Set<Pair<ccs<?>, cct>>> h = Maps.newHashMap();
   private final Map<col, Set<ccs<?>>> i = Maps.newHashMap();
   private Set<col> j = Sets.newHashSet();
   private final Set<col> k = Sets.newHashSet();
   private col l = col.b;
   private long m = -9999L;

   public static <E extends bto> buq.b<E> a(Collection<? extends ccs<?>> $$0, Collection<? extends cdz<? extends cdy<? super E>>> $$1) {
      return new buq.b<>($$0, $$1);
   }

   public static <E extends bto> Codec<buq<E>> b(final Collection<? extends ccs<?>> $$0, final Collection<? extends cdz<? extends cdy<? super E>>> $$1) {
         ...
         (new MapCodec<buq<E>>() {
               ...
               public <T> DataResult<buq<E>> decode(DynamicOps<T> $$0x, MapLike<T> $$1x) {
                  ...
                  $$1.entries().forEach($$2xxx -> {
                     DataResult<ccs<?>> $$3x = lp.B.q().parse($$0, $$2xxx.getFirst());
   ...
   public List<bvi<? super E>> e() {
      ...
      for (Map<col, Set<bvi<? super E>>> $$1 : this.f.values()) {
   ...
   public void a(col $$0, int $$1, ImmutableList<? extends bvi<? super E>> $$2) {
      this.a($$0, this.a($$1, $$2));
   }

   public void a(col $$0, int $$1, ImmutableList<? extends bvi<? super E>> $$2, ccs<?> $$3) {
      Set<Pair<ccs<?>, cct>> $$4 = ImmutableSet.of(Pair.of($$3, cct.a));
      Set<ccs<?>> $$5 = ImmutableSet.of($$3);
      this.a($$0, this.a($$1, $$2), $$4, $$5);
   }

   public void a(col $$0, ImmutableList<? extends Pair<Integer, ? extends bvi<? super E>>> $$1) {
      this.a($$0, $$1, ImmutableSet.of(), Sets.newHashSet());
   }

   public void a(col $$0, ImmutableList<? extends Pair<Integer, ? extends bvi<? super E>>> $$1, Set<Pair<ccs<?>, cct>> $$2) {
      this.a($$0, $$1, $$2, Sets.newHashSet());
   }

   public void a(col $$0, ImmutableList<? extends Pair<Integer, ? extends bvi<? super E>>> $$1, Set<Pair<ccs<?>, cct>> $$2, Set<ccs<?>> $$3) {
      this.h.put($$0, $$2);
      if (!$$3.isEmpty()) {
         this.i.put($$0, $$3);
      }
   ...
   private void d(are $$0, E $$1) {
      ...
      for (Map<col, Set<bvi<? super E>>> $$3 : this.f.values()) {
         for (Entry<col, Set<bvi<? super E>>> $$4 : $$3.entrySet()) {
            col $$5 = $$4.getKey();
   ...
   public static final class b<E extends bto> {
