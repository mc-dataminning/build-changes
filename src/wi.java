...
public class wi extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vk> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, uw.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vk> $$0, Codec<T> $$1, uw $$2) {
      vk $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> wi a(DynamicOps<vk> $$0, Codec<T> $$1, T $$2) {
      vk $$3 = (vk)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = azd.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zk<? super wi, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zl<? super wi, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zk<? super wi, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zk<? super wi, K> $$1, zk<? super wi, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zk<? super wi, K> $$0, zk<? super wi, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zl<? super wi, K> $$1, zl<? super wi, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zl<? super wi, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zk<? super wi, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zk<? super wi, T> $$0) {
      return a(this, $$0);
   }
   ...
   public <T> void a(@Nullable T $$0, zl<? super wi, T> $$1) {
      a(this, $$0, $$1);
   }
   ...
   public static del c(ByteBuf $$0) {
      return new del($$0.readLong());
   }

   public static void a(ByteBuf $$0, del $$1) {
      $$0.writeLong($$1.a());
   }
   ...
   public static ezr f(ByteBuf $$0) {
      return new ezr($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, ezr $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public <T> wi a(ToIntFunction<T> $$0, T $$1) {
   ...
   public wi a(@Nullable vk $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vk $$1) {
      if ($$1 == null) {
         $$1 = up.b;
      }

      try {
         va.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static un h(ByteBuf $$0) {
      vk $$1 = a($$0, uw.a(2097152L));
      if ($$1 != null && !($$1 instanceof un)) {
   ...
   @Nullable
   public static vk a(ByteBuf $$0, uw $$1) {
      try {
         vk $$2 = va.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public wi a(String $$0, int $$1) {
      xb.a(this.d, $$0, $$1);
      return this;
   }

   public all q() {
      return all.a(this.d(32767));
   }
   ...
   public <T> alk<T> a(alk<? extends kd<T>> $$0) {
      all $$1 = this.q();
      return alk.a($$0, $$1);
   }
   ...
   public ezn v() {
      ...
      return new ezn(new ezr((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5, $$6);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, azn.e($$1, 8)));
      }
   }
   ...
   public wi a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wi a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public wi a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wi a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wi a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wi a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wi a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public wi b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public wi c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public wi d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public wi e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public wi f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public wi g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public wi h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public wi a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public wi b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public wi i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public wi a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public wi a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public wi b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wi b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public wi b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wi b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wi b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wi b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public wi j(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wi c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public wi a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wi a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public wi a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wi a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public wi a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public wi k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public wi d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public wi b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wi b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public wi b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
