...
public record wi<S>(List<wi.a<S>> a) {
   public static <S> wi<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<wi.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<wi.a<S>> $$2 = new ArrayList<>();
