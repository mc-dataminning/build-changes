...
public class ect<T> implements edb<T> {
   private final jk<T> a;
   private final ayi<T> b;
   private final edc<T> c;
   private final int d;

   public ect(jk<T> $$0, int $$1, edc<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public ect(jk<T> $$0, int $$1, edc<T> $$2) {
      this($$0, $$1, $$2, ayi.c(1 << $$1));
   }

   private ect(jk<T> $$0, int $$1, edc<T> $$2, ayi<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public edb<T> a(edc<T> $$0) {
      return new ect<>(this.a, this.d, $$0, this.b.b());
   }
}
