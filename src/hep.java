...
public abstract class hep extends fra {
   ...
   private final List<hen> a = Lists.newArrayList();
   ...
   protected hen a(hen $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xi m() {
      return xh.a(this.a.stream().map(hen::a).collect(Collectors.toList()));
   }
}
