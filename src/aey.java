...
public class aey implements zs<ach> {
   public static final zj<wi, aey> a = zs.a(aey::a, aey::new);
   private static final int b = 12;
   private final kj c;
   private final short[] d;
   private final dvo[] e;

   public aey(kj $$0, ShortSet $$1, dxu $$2) {
      this.c = $$0;
      int $$3 = $$1.size();
      this.d = new short[$$3];
      this.e = new dvo[$$3];
   ...
   private void a(wi $$0) {
      ...
      for (int $$1 = 0; $$1 < this.d.length; $$1++) {
         $$0.a((long)dij.j(this.e[$$1]) << 12 | (long)this.d[$$1]);
      }
   }
   ...
   public void a(BiConsumer<jh, dvo> $$0) {
      jh.a $$1 = new jh.a();
