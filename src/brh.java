...
public class brh implements brj {
   ...
   private brh(bre $$0, LongSupplier $$1, Executor $$2, brn $$3, Consumer<bpr> $$4, Consumer<Path> $$5) {
      this.i = $$0;
      this.j = $$1;
      this.d = new bpm($$1, () -> this.l);
      this.e = $$2;
      this.f = $$3;
      this.g = $$4;
      this.h = b == null ? $$5 : $$5.andThen(b);
      this.k = $$1.getAsLong() + TimeUnit.NANOSECONDS.convert(10L, TimeUnit.SECONDS);
      this.m = new bpl(this.j, () -> this.l, false);
      this.d.c();
   }

   public static brh a(bre $$0, LongSupplier $$1, Executor $$2, brn $$3, Consumer<bpr> $$4, Consumer<Path> $$5) {
      return new brh($$0, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public void d() {
      ...
      if (this.l != 0) {
         for (brc $$0 : this.o) {
            $$0.a(this.l);
            if ($$0.g()) {
               bro $$1 = new bro(Instant.now(), this.l, this.m.d());
   ...
   private void a(bpr $$0) {
      HashSet<brc> $$1 = new HashSet<>(this.o);
      this.e.execute(() -> {
   ...
   private void a(Collection<brc> $$0) {
      for (brc $$1 : $$0) {
         $$1.b();
      }
