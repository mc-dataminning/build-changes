...
public class brh extends bro {
   public static final MapCodec<brh> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  bro.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static brh a(bro $$0, int $$1, int $$2) {
      return new brh($$0, $$1, $$2);
   }

   public brh(bro $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
