...
public class gb implements ArgumentType<gb.b> {
   ...
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xi.c("argument.scoreHolder.empty"));
   final boolean d;
   ...
   public static far a(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      return b($$0, $$1).iterator().next();
   }

   public static Collection<far> b(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      return a($$0, $$1, Collections::emptyList);
   }

   public static Collection<far> c(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      return a($$0, $$1, ((ew)$$0.getSource()).l().aJ()::e);
   }

   public static Collection<far> a(CommandContext<ew> $$0, String $$1, Supplier<Collection<far>> $$2) throws CommandSyntaxException {
      Collection<far> $$3 = ((gb.b)$$0.getArgument($$1, gb.b.class)).getNames((ew)$$0.getSource(), $$2);
      if ($$3.isEmpty()) {
         throw fj.d.create();
      } else {
         return $$3;
   ...
   private gb.b a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '@') {
         ...
         if ($$5.equals("*")) {
            return ($$0x, $$1x) -> {
               Collection<far> $$2 = (Collection<far>)$$1x.get();
               if ($$2.isEmpty()) {
                  throw c.create();
               } else {
                  return $$2;
   ...
   @FunctionalInterface
   public interface b {
      Collection<far> getNames(ew var1, Supplier<Collection<far>> var2) throws CommandSyntaxException;
   }
   ...
   public static class c implements gb.b {
      ...
      @Override
      public Collection<far> getNames(ew $$0, Supplier<Collection<far>> $$1) throws CommandSyntaxException {
         List<? extends bue> $$2 = this.a.b($$0);
         if ($$2.isEmpty()) {
            throw fj.d.create();
         } else {
