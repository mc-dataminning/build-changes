...
public abstract class brq extends bsz {
   private static final ajs<Boolean> bY = ajw.a(brq.class, aju.k);
   ...
   protected brq(bsc<? extends brq> $$0, daz $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract brq a(aqn var1, brq var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof cnv $$0 && !$$0.b((brw)this)) {
         this.ac();
      }
   }
