...
public class fep {
   ...
   public static final fep.a bv;

   public static fep.a a(int $$0, int $$1) {
      return $$0 == -1 ? fep.b.b.a($$1) : fep.b.a.a($$0);
   }

   public static fep.a a(String $$0) {
      if (fep.a.e.containsKey($$0)) {
         return fep.a.e.get($$0);
      } else {
         for (fep.b $$1 : fep.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fep.b b;
      private final int c;
      private final ayt<wp> d;
      static final Map<String, fep.a> e = Maps.newHashMap();

      a(String $$0, fep.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<fep.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wp> g;

      private static void a(fep.b $$0, String $$1, int $$2) {
         fep.a $$3 = new fep.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fep.a a(int $$0) {
         return (fep.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
