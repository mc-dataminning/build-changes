...
public class fep implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fep.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fep(List<fep.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fep a(BufferedReader $$0) {
      return new fep($$0.lines().flatMap($$0x -> fep.a.a($$0x).stream()).toList());
   }

   public static record a(fep.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fep.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fep.a(fep.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fep.a(fep.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fep.a(fep.b.b, $$3));
      ...
      static fep.a b(String $$0) {
         return new fep.a(fep.b.a, "glob:" + $$0);
      }

      static fep.a c(String $$0) {
         return new fep.a(fep.b.a, "regex:" + $$0);
      }

      static fep.a d(String $$0) {
         return new fep.a(fep.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fep.b a = FileSystem::getPathMatcher;
      fep.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
