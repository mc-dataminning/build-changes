...
public class fep extends fes<fep.b> {
   ...
   private boolean V;
   private boolean W;
   private final Set<asw<cmt>> X = new HashSet<>();
   private final boolean Y;

   public fep(cfi $$0, chs $$1, boolean $$2) {
      super(new fep.b($$0), $$0.fS(), ve.a);
      $$0.bS = this.p;
      this.k = 136;
      this.c = 195;
      this.Y = $$2;
      clf.a($$1, this.a($$0), $$0.dM().I_());
   }
   ...
   private void a(chs $$0, boolean $$1, ij.b $$2) {
      if (clf.a($$0, $$1, $$2)) {
         for (cle $$3 : clf.d()) {
            Collection<cmy> $$4 = $$3.l();
            if ($$3 == O) {
               if ($$3.k() == cle.h.a && $$4.isEmpty()) {
                  this.a(clf.b());
               } else {
                  this.a($$4);
               }
   ...
   private void a(Collection<cmy> $$0) {
   ...
   public void D() {
      ...
      if (this.f != null) {
         ...
         if (!this.f.q.g()) {
            this.f.a(new ffa(this.f.s));
         }
      }
   }

   @Override
   protected void a(@Nullable cjw $$0, int $$1, int $$2, cik $$3) {
      if (this.a($$0)) {
         this.R.c(false);
         this.R.i(0);
      }
      ...
      boolean $$4 = $$3 == cik.b;
      $$3 = $$1 == -999 && $$3 == cik.a ? cik.e : $$3;
      if ($$0 == null && O.k() != cle.h.b && $$3 != cik.f) {
         ...
         if ($$0 == this.T && $$4) {
            ...
            if ($$0 == this.T) {
               this.p.b(cmy.f);
            } else if ($$3 == cik.e && $$0 != null && $$0.h()) {
               cmy $$6 = $$0.a($$2 == 0 ? 1 : $$0.g().g());
               cmy $$7 = $$0.g();
               this.f.s.a($$6, true);
               this.f.q.a($$6);
               this.f.q.a($$7, ((fep.c)$$0).a.e);
            } else if ($$3 == cik.e && !this.p.g().b()) {
               this.f.s.a(this.p.g(), true);
               this.f.q.a(this.p.g());
               this.p.b(cmy.f);
            } else {
               this.f.s.bR.a($$0 == null ? $$1 : ((fep.c)$$0).a.e, $$2, $$3, this.f.s);
               this.f.s.bR.d();
            }
         } else if ($$3 != cik.f && $$0.d == L) {
            cmy $$8 = this.p.g();
            cmy $$9 = $$0.g();
            if ($$3 == cik.c) {
               if (!$$9.b()) {
            ...
            cmy $$13 = $$0 == null ? cmy.f : this.p.b($$0.e).g();
   ...
   private boolean a(@Nullable cjw $$0) {
      return $$0 != null && $$0.d == L;
   }
   ...
   protected void aN_() {
      if (this.f.q.g()) {
         super.aN_();
         this.R = new exp(this.i, this.t + 82, this.u + 6, 80, 9, vf.c("itemGroup.search"));
         this.R.f(50);
         this.R.d(false);
         this.R.g(false);
         this.R.g(16777215);
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (O.k() != cle.h.d) {
         ...
         boolean $$4 = eow.a($$0, $$1).e().isPresent();
         if ($$3 && $$4 && this.a($$0, $$1)) {
            this.V = true;
            return true;
         } else {
   ...
   private void a(cle $$0) {
      ...
      if (O.k() == cle.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.i.size(); $$10++) {
            ...
            cjw $$26 = new fep.c($$9.i.get($$10), $$10, $$14, $$15);
            this.p.i.add($$26);
         }

         this.T = new cjw(L, 0, 173, 112);
         this.p.i.add(this.T);
      } else if ($$1.k() == cle.h.b) {
         this.p.i.clear();
   ...
   public void a(ewu $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.T != null && O.k() == cle.h.b && this.a(this.T.f, this.T.g, 16, 16, (double)$$1, (double)$$2)) {
         $$0.a(this.i, M, $$1, $$2);
      }
   ...
   @Override
   public List<vf> a(cmy $$0) {
      boolean $$1 = this.r != null && this.r instanceof fep.a;
      boolean $$2 = O.k() == cle.h.a;
      boolean $$3 = O.k() == cle.h.d;
      coq.a $$4 = this.f.m.m ? coq.a.b : coq.a.a;
      coq $$5 = $$1 ? $$4.c() : $$4;
   ...
   protected void a(ewu $$0, float $$1, int $$2, int $$3) {
      ...
      this.a($$0, O);
      if (O.k() == cle.h.b) {
         ffa.a($$0, this.t + 73, this.u + 6, this.t + 105, this.u + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.f.s);
      }
   }
   ...
   protected boolean a(cle $$0, double $$1, double $$2) {
      int $$3 = this.b($$0);
      int $$4 = this.c($$0);
      return $$1 >= (double)$$3 && $$1 <= (double)($$3 + 26) && $$2 >= (double)$$4 && $$2 <= (double)($$4 + 32);
   }

   protected boolean a(ewu $$0, cle $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(ewu $$0, cle $$1) {
      boolean $$2 = $$1 == O;
      boolean $$3 = $$1.g() == cle.f.a;
      int $$4 = $$1.f();
      ...
      $$0.a($$7[auo.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static void a(evi $$0, int $$1, boolean $$2, boolean $$3) {
      fsj $$4 = $$0.s;
      eve $$5 = $$0.aB();
      fsl $$6 = $$5.a($$1);
      if ($$2) {
         for (int $$7 = 0; $$7 < cfh.g(); $$7++) {
            cmy $$8 = (cmy)$$6.get($$7);
            cmy $$9 = $$8.a($$4.dM().I()) ? $$8.p() : cmy.f;
            $$4.fS().a($$7, $$9);
            $$0.q.a($$9, 36 + $$7);
         }
   ...
   public static class b extends cib {
      public final iq<cmy> k = iq.a();
      private final cib l;
      ...
      public b(cfi $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new fep.a(fep.L, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }

         for (int $$4 = 0; $$4 < 9; $$4++) {
            this.a(new cjw($$1, $$4, 9 + $$4 * 18, 112));
         }
      ...
      protected float e(int $$0) {
         return auo.a((float)$$0 / (float)this.l(), 0.0F, 1.0F);
      }

      protected float a(float $$0, double $$1) {
         return auo.a($$0 - (float)($$1 / (double)this.l()), 0.0F, 1.0F);
      }
   ...
   static class c extends cjw {
      ...
      public c(cjw $$0, int $$1, int $$2, int $$3) {
         super($$0.d, $$1, $$2, $$3);
         this.a = $$0;
      }
