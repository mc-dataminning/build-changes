...
public abstract class fep<E extends fep.a<E>> extends fem {
   protected static final int b = 6;
   private static final akf a = new akf("widget/scroller");
   private static final akf m = new akf("widget/scroller_background");
   private static final akf n = new akf("textures/gui/menu_list_background.png");
   private static final akf o = new akf("textures/gui/inworld_menu_list_background.png");
   protected final fcu c;
   protected final int d;
   private final List<E> p = new fep.b();
   ...
   public fep(fcu $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wr.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = axw.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aE_().get($$7) : null;
   }

   public void a(int $$0, fih $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(feh $$0) {
      RenderSystem.enableBlend();
      akf $$1 = this.c.r == null ? fkt.h : fkt.j;
      akf $$2 = this.c.r == null ? fkt.i : fkt.k;
   ...
   public void a(double $$0) {
      this.q = axw.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = axw.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fiy $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fiy $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fio.a t() {
      if (this.aI_()) {
         ...
         return this.v != null ? fio.a.b : fio.a.a;
      }
   }
   ...
   protected void a(fiq $$0, E $$1) {
      List<E> $$2 = this.aE_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fip.b, ws.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fep.a<E>> implements fgq {
      @Deprecated
      fep<E> a;
      ...
      public abstract void a(feh var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
