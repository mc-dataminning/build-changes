...
public class dht {
   public static <T> List<dht.b> a(List<T> $$0, Function<T, List<jv<emp>>> $$1, boolean $$2) {
      Object2IntMap<emp> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, emp c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jv<emp>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jr<emp> $$12 : $$10.get($$11)) {
               emp $$13 = $$12.a();
      ...
      Builder<dht.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<emp> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dht.b($$28));
      }
   ...
   public static record b(List<emp> a, ToIntFunction<emp> b) {
      b(List<emp> $$0) {
         this($$0, af.h($$0));
      }
   }
