...
public class dht {
   ...
   private final Map<Character, Predicate<dhr>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dht a(char $$0, Predicate<dhr> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dhs b() {
      return new dhs(this.c());
   }

   private Predicate<dhr>[][][] c() {
      this.d();
      Predicate<dhr>[][][] $$0 = (Predicate<dhr>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dhr>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
