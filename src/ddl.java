...
public class ddl extends dcn {
   private final boolean a;
   private final boolean b;
   private final Optional<Float> c;
   private final Optional<jq<dfw>> d;

   public ddl(boolean $$0, boolean $$1, Optional<Float> $$2, Optional<jq<dfw>> $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
