...
public class ddl extends dcm {
   ...
   private aeq<dwi> h = aeq.a(jc.aC, new aer("empty"));
   private ddl.a i = ddl.a.a;
   private String j = "minecraft:air";

   public ddl(gu $$0, dfa $$1) {
      super(dco.F, $$0, $$1);
   }
   ...
   public void a(qr $$0) {
      ...
      this.i = ddl.a.a($$0.l("joint")).orElseGet(() -> cwl.h(this.q()).o().d() ? ddl.a.b : ddl.a.a);
   }
   ...
   public void a(akk $$0, int $$1, boolean $$2) {
      gu $$3 = this.p().a(this.q().c(cwl.a).a());
      hr<dwi> $$4 = $$0.B_().d(jc.aC);
      he<dwi> $$5 = $$4.f(this.h);
      dwc.a($$0, $$5, this.g, $$1, $$3, $$2);
   }
   ...
   public static enum a implements ash {
      ...
      public static Optional<ddl.a> a(String $$0) {
