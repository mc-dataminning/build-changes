...
public class ddl extends cut {
   public static final MapCodec<ddl> a = b(ddl::new);
   public static final dhn b = dag.f;
   public static final dhn c = dag.b;
   public static final dhn d = dag.c;
   public static final dhn e = dag.d;
   public static final dhn f = dag.e;
   public static final Map<hx, dhn> g = dag.h.entrySet().stream().filter($$0 -> $$0.getKey() != hx.a).collect(ac.a());
   protected static final float h = 1.0F;
   private static final ekb i = cut.a(0.0, 15.0, 0.0, 16.0, 16.0, 16.0);
   private static final ekb j = cut.a(0.0, 0.0, 0.0, 1.0, 16.0, 16.0);
   private static final ekb k = cut.a(15.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   private static final ekb l = cut.a(0.0, 0.0, 0.0, 16.0, 16.0, 1.0);
   private static final ekb m = cut.a(0.0, 0.0, 15.0, 16.0, 16.0, 16.0);
   private final Map<dgw, ekb> n;
   ...
   public ddl(dgv.d $$0) {
      ...
      this.n = ImmutableMap.copyOf(this.E.a().stream().collect(Collectors.toMap(Function.identity(), ddl::h)));
   }
   ...
   private boolean b(cqy $$0, ht $$1, hx $$2) {
      if ($$2 == hx.a) {
         return false;
      } else {
         ht $$3 = $$1.a($$2);
   ...
   public static boolean a(cqy $$0, ht $$1, hx $$2) {
      return czs.a($$0, $$2, $$1, $$0.a_($$1));
   }

   private dgw i(dgw $$0, cqy $$1, ht $$2) {
      ht $$3 = $$2.c();
      if ($$0.c(b)) {
         ...
         if ($$3.a(4) == 0) {
            ...
            if ($$4.o().d() && !$$0.c(a($$4))) {
               ...
               if ($$2.v() > $$1.I_()) {
                  ...
                  dgw $$18 = $$1.a_($$17);
                  if ($$18.i() || $$18.a(this)) {
                     dgw $$19 = $$18.i() ? this.o() : $$18;
                     dgw $$20 = this.a($$0, $$19, $$3);
                     if ($$19 != $$20 && this.p($$20)) {
                        $$1.a($$17, $$20, 2);
                     }
                  }
   ...
   private dgw a(dgw $$0, dgw $$1, ato $$2) {
      for (hx $$3 : hx.c.a) {
         if ($$2.h()) {
            dhn $$4 = a($$3);
            if ($$0.c($$4)) {
