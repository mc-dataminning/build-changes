...
public class bbw extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped(this.a + " (Components)", this.getInputSchema().getType(bjd.w), this::a),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped(this.a + " (Entity)", this.getInputSchema().getType(bjd.D), this::b),
            this.fixTypeEverywhereTyped(this.a + " (Player)", this.getInputSchema().getType(bjd.b), this::b)
         }
      );
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0) {
      return bbh.a($$0, "id", this.b);
   }

   private Dynamic<?> b(Dynamic<?> $$0) {
      return bbh.a($$0, "type", this.b);
   }
}
