...
public class bbw extends bgv {
   public bbw(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bia.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bia.s, "minecraft:piston");
