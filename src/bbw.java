...
public class bbw extends bgp {
   public bbw(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bhu.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bhu.s, "minecraft:jukebox");
