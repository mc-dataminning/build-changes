...
public class zo {
   ...
   public static <T extends wk> void a(zl<T> $$0, T $$1, arj $$2) throws alq {
      a($$0, $$1, $$2.o());
   }

   public static <T extends wk> void a(zl<T> $$0, T $$1, bqi<?> $$2) throws alq {
      if (!$$2.by()) {
         $$2.c(() -> {
            if ($$1.a($$0)) {
               try {
   ...
   public static <T extends wk> z a(Exception $$0, zl<T> $$1, T $$2) {
      if ($$0 instanceof z $$3) {
         a($$3.a(), $$2, $$1);
         return $$3;
      } else {
   ...
   public static <T extends wk> void a(o $$0, T $$1, @Nullable zl<T> $$2) {
      if ($$2 != null) {
