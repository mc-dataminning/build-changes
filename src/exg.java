...
public class exg {
   ...
   private static final vf h = vf.c("chat.deleted_marker").a(n.h, n.u);
   private final evh i;
   private final atc<String> j = new atc<>(100);
   private final List<evb> k = Lists.newArrayList();
   private final List<evb.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<exg.a> o = new ArrayList<>();
   ...
   public void a(ewt $$0, int $$1, int $$2, int $$3) {
      if (!this.j()) {
         int $$4 = this.i();
         int $$5 = this.l.size();
         if ($$5 > 0) {
            ...
            int $$8 = aun.f((float)this.e() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = aun.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, vf.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(ewt $$0, int $$1, int $$2, evc.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(evb.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean j() {
      return this.i.m.m().c() == cff.c;
   }
   ...
   public void a(vf $$0) {
      this.a($$0, null, this.i.U() ? evc.b() : evc.a());
   }

   public void a(vf $$0, @Nullable vr $$1, @Nullable evc $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(vf $$0, @Nullable evc $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, evc::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(vf $$0, @Nullable vr $$1, int $$2, @Nullable evc $$3, boolean $$4) {
      int $$5 = aun.a((double)this.e() / this.g());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<atz> $$6 = exk.a($$0, $$5, this.i.h);
      boolean $$7 = this.m();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new evb.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private exg.a b(vr $$0) {
      int $$1 = this.i.l.e();
      ListIterator<evb> $$2 = this.k.listIterator();
   ...
   private evb a(evb $$0) {
      return new evb($$0.a(), h, null, evc.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)aun.a((double)this.e() / this.g()) && $$4 < 0.0 && $$4 > (double)aun.a(-9.0 * this.g())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public wc b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         evb.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), aun.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public evc c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, evb.a $$1, evc $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         evc.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         if (!($$0 < -4.0) && !($$0 > (double)aun.a((double)this.e() / this.g()))) {
            int $$2 = Math.min(this.i(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = aun.a($$1 + (double)this.m);
   ...
   private boolean m() {
      return this.i.y instanceof fbr;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return aun.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return aun.a($$0 * 160.0 + 20.0);
   }
