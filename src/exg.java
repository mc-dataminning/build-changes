...
public class exg {
   ...
   public void a(exq $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == exq.a) {
            fbw.b($$1, fbw.a.a, vq.c("narrator.toast.disabled"), null);
         } else {
            fbw.b($$1, fbw.a.a, vq.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fbw.b($$1, fbw.a.a, vq.c("narrator.toast.disabled"), vq.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new exg.a("Narrator library is not active");
      }
   }
