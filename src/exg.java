...
public class exg {
   ...
   static class b {
      static final Optional<exg> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static exg a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new exg();
      }
   }
}
