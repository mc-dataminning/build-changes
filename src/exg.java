...
public class exg {
   public static List<eyi> a(exg.a... $$0) {
      for (exg.a $$1 : $$0) {
         a($$1.j);
      }

      List<eyi> $$2 = Lists.newArrayList();

      for (exg.a $$3 : $$0) {
         $$2.add(new eyi($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(eyi::a));
      return $$2;
   }
   ...
   public static List<eyi> a() {
      return a(exg.a.values());
   }
