...
public class eyt {
   ...
   public static final eyt.a bv;

   public static eyt.a a(int $$0, int $$1) {
      return $$0 == -1 ? eyt.b.b.a($$1) : eyt.b.a.a($$0);
   }

   public static eyt.a a(String $$0) {
      if (eyt.a.e.containsKey($$0)) {
         return eyt.a.e.get($$0);
      } else {
         for (eyt.b $$1 : eyt.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eyt.b b;
      private final int c;
      private final ayt<xp> d;
      static final Map<String, eyt.a> e = Maps.newHashMap();

      a(String $$0, eyt.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eyt.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xp> g;

      private static void a(eyt.b $$0, String $$1, int $$2) {
         eyt.a $$3 = new eyt.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eyt.a a(int $$0) {
         return (eyt.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
