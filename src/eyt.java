...
public class eyt extends eym {
   private static final Logger a = LogUtils.getLogger();
   private static final aey b = new aey("textures/misc/vignette.png");
   private static final tn c = tn.b("============").a(n.p);
   ...
   private int z;
   private final etj A = new etj(false);

   public eyt(boolean $$0, Runnable $$1) {
      super(eqp.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, eyt.a $$1) {
      try (Reader $$2 = this.f.Z().openAsReader(new aey($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : arp.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(tn.b($$4).a(n.o), true);
         this.a(c, true);
         this.E();
         this.E();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(tn.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(tn.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.s.addAll(this.f.h.c(tn.b($$0), 256));
   }

   private void a(tn $$0, boolean $$1) {
      if ($$1) {
