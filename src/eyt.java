...
public class eyt extends eyy {
   ...
   public void a(djx $$0, iv $$1, ebe $$2, @Nullable eyw $$3, boolean $$4) {
      ...
      for (boolean $$7 = true; $$6.hasNext(); $$7 = false) {
         ...
         int $$11 = b($$10);
         ebe $$12 = $$0.a_($$9);
         if ($$12.a(this.a) && !$$12.c(dtl.f).equals($$11)) {
            int $$13 = 2;
            if (!$$4 || !$$7) {
               $$13 |= 128;
            }

            $$0.a($$9, $$12.b(dtl.f, Integer.valueOf($$11)), $$13);
         } else {
            $$6.remove();
         }
      }
   ...
   private static boolean a(ebe $$0, jb $$1) {
      ecc<ecj> $$2 = dtl.g.get($$1);
      return $$2 == null ? $$1 == jb.a : $$0.c($$2).a();
   }

   private static eyw a(djx $$0, @Nullable eyw $$1) {
      eyw $$2;
      if ($$1 != null) {
         $$2 = $$1;
      } else {
      ...
      return $$2.a(jb.b).a(eyw.a.a);
   }

   private void a(djx $$0, iv $$1, eyw $$2) {
      ebe $$3 = $$0.a_($$1);
      if ($$3.a(this.a)) {
         this.a($$1, $$3.c(dtl.f), $$2);
         this.b.add($$1);
      } else {
         this.a($$0, $$1, 0, $$2, true);
      }
   ...
   private static int a(eyw $$0, int $$1) {
      return $$0.i() << 4 | $$1;
   }

   private static eyw a(int $$0) {
      return eyw.a($$0 >> 4);
   }
   ...
   private void a(iv $$0, int $$1, eyw $$2) {
      this.d.compute($$0, ($$2x, $$3) -> $$3 == null ? a($$2, $$1) : a(a($$3), $$1));
   }

   private void a(djx $$0, iv $$1, int $$2, eyw $$3, boolean $$4) {
      for (jb $$5 : $$3.g()) {
         iv $$6 = $$1.a($$5);
   ...
   private void b(djx $$0, iv $$1, int $$2, eyw $$3, boolean $$4) {
      ebe $$5 = $$0.a_($$1);
      if ($$5.a(this.a)) {
         int $$6 = this.a($$1, $$5);
