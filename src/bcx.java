...
public class bcx extends azq {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcx::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcx::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcx::k);
         $$0 = this.a($$0, "minecraft:fox", bcx::j);
         $$0 = this.a($$0, "minecraft:item", bcx::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcx::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcx::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcx::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcx::e);
         return this.a($$0, "minecraft:piglin", bcx::d);
      });
   }
