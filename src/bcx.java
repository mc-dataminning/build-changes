...
public class bcx implements bdc {
   ...
   private final Map<String, bcx.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, bei>> o = new ObjectArraySet();

   public bcx(LongSupplier $$0, IntSupplier $$1, boolean $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> bdd.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         $$3.b = Math.min($$3.b, $$2);
         if (this.n && $$2 > a) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> bdd.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bcx.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bcx.a());
      }
   ...
   @Override
   public bdd d() {
      return new bda(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }
   ...
   public static class a implements bdf {
