...
public class bcx<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bcx(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bcx<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bcy<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bcy<T> $$0 = bcy.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bcy<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bcx.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bcx.this.c.position();
               }
