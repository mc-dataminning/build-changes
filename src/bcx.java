...
public class bcx extends DataFix {
   ...
   private Dynamic<?> b(Dynamic<?> $$0) {
      ...
      return $$1.isPresent() && $$1.get().get("Sections").asStreamOpt().result().isPresent() ? $$0.set("Level", new bcx.e((Dynamic<?>)$$1.get()).a()) : $$0;
   }
   ...
   public static enum b {
      a(bcx.b.b.b, bcx.b.a.b),
      b(bcx.b.b.a, bcx.b.a.b),
      c(bcx.b.b.b, bcx.b.a.c),
      d(bcx.b.b.a, bcx.b.a.c),
      e(bcx.b.b.b, bcx.b.a.a),
      f(bcx.b.b.a, bcx.b.a.a);

      private final bcx.b.a g;
      private final bcx.b.b h;

      private b(final bcx.b.b $$0, final bcx.b.a $$1) {
         this.g = $$1;
         this.h = $$0;
      }
   ...
   static class d {
      ...
      public void a(int $$0, Dynamic<?> $$1) {
         if (this.h.add($$1)) {
            this.c.add("%%FILTER_ME%%".equals(bcx.a($$1)) ? bcx.c.t : $$1);
         }

         this.i[$$0] = bcx.a(this.b, $$1);
      }
      ...
      public int b(int $$0) {
         if (!this.e) {
            ...
            bcx.a $$2 = this.d.get("Data").asByteBufferOpt().map($$0x -> new bcx.a(DataFixUtils.toArray($$0x))).result().orElseGet(bcx.a::new);
            bcx.a $$3 = this.d.get("Add").asByteBufferOpt().map($$0x -> new bcx.a(DataFixUtils.toArray($$0x))).result().orElseGet(bcx.a::new);
            this.h.add(bcx.c.t);
            bcx.a(this.b, bcx.c.t);
            this.c.add(bcx.c.t);
   ...
   static final class e {
      private int a;
      private final bcx.d[] b = new bcx.d[16];
      ...
      public e(Dynamic<?> $$0) {
         ...
         $$0.get("TileEntities").asStreamOpt().ifSuccess($$0x -> $$0x.forEach($$0xx -> {
               ...
               if (this.f.put($$4x, $$0xx) != null) {
                  bcx.i.warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", new Object[]{this.d, this.e, $$1x, $$2x, $$3x});
               }
            }));
         boolean $$1 = $$0.get("convertedFromAlphaFormat").asBoolean(false);
         $$0.get("Sections").asStreamOpt().ifSuccess($$0x -> $$0x.forEach($$0xx -> {
               bcx.d $$1x = new bcx.d($$0xx);
               this.a = $$1x.b(this.a);
               this.b[$$1x.a] = $$1x;
            }));
                  ...
                  switch ($$3.getIntKey()) {
                     case 2:
                        ...
                        while (var30.hasNext()) {
                           ...
                           $$5 |= $$4;
                           Dynamic<?> $$6 = this.a($$5);
                           if ("minecraft:grass_block".equals(bcx.a($$6))) {
                              String $$7 = bcx.a(this.a(a($$5, bcx.b.b)));
                     ...
                     case 3:
                        ...
                        while (var29.hasNext()) {
                           ...
                           $$8 |= $$4;
                           Dynamic<?> $$9 = this.a($$8);
                           if ("minecraft:podzol".equals(bcx.a($$9))) {
                              String $$10 = bcx.a(this.a(a($$8, bcx.b.b)));
                     ...
                     case 25:
                        ...
                        while (var28.hasNext()) {
                           ...
                           if ($$15 != null) {
                              ...
                              this.a($$14, bcx.c.p.getOrDefault($$16, bcx.c.p.get("false0")));
                           }
                        }
                        break;
                     case 26:
                        ...
                        while (var27.hasNext()) {
                           ...
                           if ($$18 != null) {
                              ...
                              if ($$20 != 14 && $$20 >= 0 && $$20 < 16) {
                                 String $$21 = bcx.a($$19, "facing") + bcx.a($$19, "occupied") + bcx.a($$19, "part") + $$20;
                                 if (bcx.c.r.containsKey($$21)) {
                                    this.a($$17, bcx.c.r.get($$21));
                                 }
                              }
                           }
                        }
                     ...
                     case 197:
                        ...
                        while (var26.hasNext()) {
                           ...
                           if (bcx.a($$40).endsWith("_door")) {
                              Dynamic<?> $$41 = this.a($$39);
                              if ("lower".equals(bcx.a($$41, "half"))) {
                                 int $$42 = a($$39, bcx.b.b);
                                 Dynamic<?> $$43 = this.a($$42);
                                 String $$44 = bcx.a($$41);
                                 if ($$44.equals(bcx.a($$43))) {
                                    String $$45 = bcx.a($$41, "facing");
                                    String $$46 = bcx.a($$41, "open");
                                    String $$47 = $$1 ? "left" : bcx.a($$43, "hinge");
                                    String $$48 = $$1 ? "false" : bcx.a($$43, "powered");
                                    this.a($$39, bcx.c.o.get($$44 + $$45 + "lower" + $$47 + $$46 + $$48));
                                    this.a($$42, bcx.c.o.get($$44 + $$45 + "upper" + $$47 + $$46 + $$48));
                                 }
                              }
                           }
                        }
                     ...
                     case 86:
                        ...
                        while (var25.hasNext()) {
                           ...
                           if ("minecraft:carved_pumpkin".equals(bcx.a($$28))) {
                              String $$29 = bcx.a(this.a(a($$27, bcx.b.a)));
                     ...
                     case 110:
                        ...
                        while (var24.hasNext()) {
                           ...
                           if ("minecraft:mycelium".equals(bcx.a($$12))) {
                              String $$13 = bcx.a(this.a(a($$11, bcx.b.b)));
                     ...
                     case 140:
                        ...
                        while (var23.hasNext()) {
                           ...
                           if ($$31 != null) {
                              ...
                              this.a($$30, bcx.c.m.getOrDefault($$32, bcx.c.m.get("minecraft:air0")));
                           }
                        }
                        break;
                     case 144:
                        ...
                        while (var22.hasNext()) {
                           ...
                           if ($$34 != null) {
                              ...
                              String $$36 = bcx.a(this.a($$33), "facing");
                              String $$38;
                              ...
                              $$34.remove("facing");
                              $$34.remove("Rot");
                              this.a($$33, bcx.c.n.getOrDefault($$38, bcx.c.n.get("0north")));
                           }
                        }
                        break;
                     case 175:
                        ...
                        while (var21.hasNext()) {
                           ...
                           if ("upper".equals(bcx.a($$50, "half"))) {
                              Dynamic<?> $$51 = this.a(a($$49, bcx.b.a));
                              String $$52 = bcx.a($$51);
                              switch ($$52) {
                     ...
                     case 177:
                        ...
                        while (var10.hasNext()) {
                           ...
                           if ($$23 != null) {
                              ...
                              if ($$25 != 15 && $$25 >= 0 && $$25 < 16) {
                                 String $$26 = bcx.a($$24, $$3.getIntKey() == 176 ? "rotation" : "facing") + "_" + $$25;
                                 if (bcx.c.s.containsKey($$26)) {
                                    this.a($$22, bcx.c.s.get($$26));
                                 }
                              }
                           }
                        }
      ...
      public static int a(int $$0, bcx.b $$1) {
         int var10000;
         switch ($$1.b()) {
            case a:
               int $$2 = ($$0 & 15) + $$1.a().a();
      ...
      public Dynamic<?> a(int $$0) {
         if ($$0 >= 0 && $$0 <= 65535) {
            bcx.d $$1 = this.d($$0);
            return $$1 == null ? bcx.c.t : $$1.a($$0 & 4095);
         } else {
            return bcx.c.t;
         }
      }
