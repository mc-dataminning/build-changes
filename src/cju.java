...
public abstract class cju extends bto {
   private static final Logger c = LogUtils.getLogger();
   private int d;
   protected je b;

   protected cju(btv<? extends cju> $$0, deg $$1) {
      super($$0, $$1);
   }

   protected cju(btv<? extends cju> $$0, deg $$1, je $$2) {
      this($$0, $$1);
      this.b = $$2;
   }
   ...
   public abstract void b(@Nullable bto var1);
