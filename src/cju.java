...
public class cju extends bul {
   private static final ajy<Optional<ji>> b = akc.a(cju.class, aka.p);
   private static final ajy<Boolean> c = akc.a(cju.class, aka.k);
   public int a;

   public cju(bus<? extends cju> $$0, dgi $$1) {
      super($$0, $$1);
      this.I = true;
      this.a = this.ae.a(100000);
   }

   public cju(dgi $$0, double $$1, double $$2, double $$3) {
      this(bus.R, $$0);
      this.a_($$1, $$2, $$3);
   }
      ...
      if (this.d($$1)) {
         ...
         if (!this.dQ()) {
            ...
            if (!$$1.a(awr.l)) {
               ...
               $$0.a(this, $$3, null, this.dA(), this.dC(), this.dG(), 6.0F, false, dgi.a.b);
            }
