...
public class cju extends bvi implements clp {
   ...
   public static final ajx<Integer> a = akb.a(cju.class, ajz.b);
   ...
   public cju(bur<? extends cju> $$0, dgi $$1) {
      super(bur.Q, $$1);
   ...
   public void aZ() {
      if (this.dW().C && !this.bb()) {
         this.dW().a(this.dB(), this.dD(), this.dH(), awa.iy, this.dn(), 5.0F, 0.8F + this.ae.i() * 0.3F, false);
      }
   }
   ...
   public void d_() {
      ...
      if (this.dW().C) {
         ...
         if (!this.bb() && !this.ct.a().a() && --this.cu < 0) {
            this.dW().a(this.dB(), this.dD(), this.dH(), awa.iz, this.dn(), 2.5F, 0.8F + this.ae.i() * 0.3F, false);
         ...
         if (this.gc()) {
            ...
            if (this.dW() instanceof arc $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.v(ayz.h(this.dM()));
                  fba $$17 = $$10.a(this.dB(), this.dD(), this.dH()).d();
                  fba $$18 = new fba((double)ayz.a(this.dM() * (float) (Math.PI / 180.0)), this.dz().e, (double)(-ayz.b(this.dM() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$19 = Math.max(((float)$$18.b($$17) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$11) > 1.0E-5F || Math.abs($$13) > 1.0E-5F) {
                     float $$20 = ayz.a(ayz.h(180.0F - (float)ayz.d($$11, $$13) * (180.0F / (float)Math.PI) - this.dM()), -50.0F, 50.0F);
                     this.ca *= 0.8F;
            ...
            for (int $$26 = 0; $$26 < this.cj.length; $$26++) {
               $$25[$$26] = new fba(this.cj[$$26].dB(), this.cj[$$26].dD(), this.cj[$$26].dH());
            }
            ...
            float $$34 = ayz.a(this.dM() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$35 = ayz.b(this.dM() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$36 = this.gn();
   ...
   private void go() {
      ...
      if (this.ae.a(10) == 0) {
         List<cjt> $$0 = this.dW().a(cjt.class, this.cR().g(32.0));
         cjt $$1 = null;
   ...
   private void a(arc $$0, List<buk> $$1) {
   ...
   private void b(arc $$0, List<buk> $$1) {
      for (buk $$2 : $$1) {
         if ($$2 instanceof bvg) {
            bta $$3 = this.dX().b((bvg)this);
            $$2.a($$0, $$3, 10.0F);
            ddb.a($$0, $$2, $$3);
         }
      }
   ...
   public boolean a(arc $$0, cjr $$1, bta $$2, float $$3) {
   ...
   protected void c(arc $$0, bta $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void em() {
      ...
      if (this.dW() instanceof arc $$4) {
         if (this.bZ > 150 && this.bZ % 5 == 0 && $$4.O().b(dge.f)) {
            buw.a($$4, this.du(), ayz.d((float)$$3 * 0.08F));
         }
      ...
      if (this.bZ == 200 && this.dW() instanceof arc $$7) {
         if ($$7.O().b(dge.f)) {
            buw.a($$7, this.du(), ayz.d((float)$$3 * 0.2F));
         }
   ...
   public int t() {
      if (this.cw[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dW().a(ecs.a.f, new ji($$3, 0, $$4)).v() + $$1);
   ...
   public fba J(float $$0) {
      ...
      fba $$8;
      if ($$2 == ckk.d || $$2 == ckk.e) {
         ji $$3 = this.dW().a(ecs.a.f, efx.a(this.cs));
   ...
   public void a(arc $$0, cjt $$1, ji $$2, bta $$3) {
      cox $$4;
