...
public class eum implements eun {
   private static final aer a = new aer("toast/system");
   ...
   private eum(eum.a $$0, tf $$1, List<arc> $$2, int $$3) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.l = $$3;
   ...
   private static ImmutableList<arc> a(@Nullable tf $$0) {
   ...
   public void a(tf $$0, @Nullable tf $$1) {
      this.h = $$0;
      this.i = a($$1);
      this.k = true;
   }
   ...
   public static void a(euo $$0, eum.a $$1, tf $$2, @Nullable tf $$3) {
      $$0.a(new eum($$1, $$2, $$3));
   }

   public static void b(euo $$0, eum.a $$1, tf $$2, @Nullable tf $$3) {
      eum $$4 = $$0.a(eum.class, $$1);
      if ($$4 == null) {
         a($$0, $$1, $$2, $$3);
      } else {
         $$4.a($$2, $$3);
