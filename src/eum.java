...
public class eum {
   ...
   public void a(evw $$0, String $$1, ews.a $$2, ekk $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eum.b $$13 = new eum.b($$1.trim(), this.f, $$3, $$2);
                  eum.a $$14 = new eum.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eum.c $$30 = new eum.c(this.f, $$2, $$0);
                        eum.a $$31 = new eum.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ewa(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ekk $$2) throws IOException {
      ...
      File $$15 = new File(ezg.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, ekk $$2, ews.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eum.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eum.this.b && !eum.this.d) {
            try {
               eum.this.e = true;
               eum.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eum.a.error("Error extracting archive", var3);
               eum.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eum.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eum.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eum.this.g);
                  eum.this.c = true;
               } else {
                  eum.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eum.this.d = true;
               }
            } catch (IOException var3) {
               eum.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eum.this.d = true;
            }
         }
      }
