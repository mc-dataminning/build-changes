public class fwm<T extends buv> extends fwr<T, fed<T>> {
   private final fnz a;

   public fwm(fue<T, fed<T>> $$0, fnz $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(elh $$0, fng $$1, int $$2, boolean $$3, dey $$4, int $$5, gah $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(fno.p(fyf.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
