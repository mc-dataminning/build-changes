...
public class fhw {
   ...
   public void a(cku $$0, ezx $$1, float $$2, int $$3, int $$4) {
      cmp $$5 = $$0.b(this.d);
   ...
   private void a(cmp $$0, ajc $$1, float $$2, ezx $$3, int $$4, int $$5) {
      ghz $$6 = eyk.P().a(ghy.e).apply($$1);
