...
public class fhw extends fhx {
   ...
   private fhw(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   public static fhw a(String $$0) {
      try {
         ...
         String $$3 = fjt.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = fjt.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = fjt.a("worldClosed", $$2, false);
               String $$7 = fjt.b("token", $$2, null);
               return new fhw($$6, $$7, $$5);
            }
         }
