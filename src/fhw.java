...
public class fhw extends fgy {
   ...
   public fhw(fgp $$0, int $$1, int $$2, int $$3, int $$4, xp $$5, xp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fhz($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fla $$0) {
      $$0.a(fkz.a, xp.a("gui.narrate.editBox", this.y(), this.j()));
   }
   ...
   private void k() {
      double $$0 = this.c();
      fhz.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fhz.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
