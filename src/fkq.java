...
public class fkq {
   ...
   public void a(fmj $$0, String $$1, fng.a $$2, ezh $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fkq.b $$13 = new fkq.b($$1.trim(), this.f, $$3, $$2);
                  fkq.a $$14 = new fkq.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fkq.c $$30 = new fkq.c(this.f, $$2, $$0);
                        fkq.a $$31 = new fkq.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fmn(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ezh $$2) throws IOException {
      ...
      File $$15 = new File(fpt.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ezh d;
      private final fng.a e;

      b(final String $$0, final File $$1, final ezh $$2, final fng.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fkq.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fkq.this.b && !fkq.this.d) {
            try {
               fkq.this.e = true;
               fkq.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fkq.a.error("Error extracting archive", var3);
               fkq.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fng.a c;
      private final fmj d;

      c(final File $$0, final fng.a $$1, final fmj $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fkq.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fkq.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fkq.this.g);
                  fkq.this.c = true;
               } else {
                  fkq.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fkq.this.d = true;
               }
            } catch (IOException var3) {
               fkq.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fkq.this.d = true;
            }
         }
      }
