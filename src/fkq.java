...
public interface fkq {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new fkq.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new fkq.d($$0, $$1);
      }
   }

   public static record a(String d) implements fkq {
   ...
   public static record b(int e, @Nullable wy f) implements fkq {
      public static final fkq.b c = new fkq.b(429, wy.c("mco.errorMessage.serviceBusy"));
      public static final wy d = wy.c("mco.errorMessage.retry");

      public static fkq.b a(String $$0) {
         return new fkq.b(500, wy.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fkq.b a(fmj $$0) {
         return new fkq.b(500, wy.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static fkq.b a(int $$0) {
         return new fkq.b($$0, d);
      }

      public static fkq.b b(int $$0) {
         return new fkq.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements fkq {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements fkq {
      @Override
      public int a() {
         return this.c;
      }
