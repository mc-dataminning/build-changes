...
public class dsx extends dsv {
   ...
   private final bfv i;
   private final hi<csm> j;

   public dsx(int $$0, int $$1, int $$2, bfv $$3, float $$4, bfv $$5, hi<csm> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<drd.a> a(cps $$0, BiConsumer<gu, dfa> $$1, aru $$2, int $$3, gu $$4, dqn $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new drd.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(cps $$0, BiConsumer<gu, dfa> $$1, aru $$2, int $$3, dqn $$4, List<drd.a> $$5, gu.a $$6, int $$7, ha $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new drd.a($$16, 0, false));
         $$5.add(new drd.a($$16.c(2), 0, false));
      }
   }
