...
public class dsx {
   ...
   public dsx(dcu $$0, jd $$1, ji $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dta $$0 = this.b.a_(this.e);
      if (!dst.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == epd.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dta $$0) {
      return $$0.a(dfy.hV) || $$0.a(dfy.pg);
   }

   private static boolean a(dta $$0, dta $$1) {
      if ($$0.a(dfy.pg) && $$1.a(dfy.hV)) {
         return false;
      } else {
         return $$0.a(dfy.hV) && $$1.a(dfy.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jd $$0, ji $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dst.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dta $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dst.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dst.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
