...
public class dsx extends dmc {
   public static final MapCodec<dsx> a = b(dsx::new);
   public static final ebf b = ebe.u;
   private static final Map<din, List<dsx.a>> f = new WeakHashMap<>();
   ...
   private static boolean a(djh $$0, iv $$1, boolean $$2) {
      List<dsx.a> $$3 = f.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dsx.a($$1.j(), $$0.ae()));
      }
