...
public class bju extends DataFix {
   ...
   public bju(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(bis.B, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(bis.B), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
