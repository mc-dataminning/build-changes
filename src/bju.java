...
public abstract class bju extends buk implements bjg {
   protected static final adz<Byte> bT = aec.a(bju.class, aeb.a);
   protected static final adz<Optional<UUID>> bU = aec.a(bju.class, aeb.q);
   private boolean bW;

   protected bju(bim<? extends bju> $$0, cpm $$1) {
      super($$0, $$1);
      this.q();
   }
   ...
   @Override
   public void a(bhg $$0) {
      if (!this.dK().B && this.dK().X().b(cpi.m) && this.I_() instanceof akl) {
         this.I_().a(this.eI().a());
      }
