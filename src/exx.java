...
public enum exx implements azk {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azk.a<exx> t = azk.a(exx::values);
   public static final IntFunction<exx> u = axe.a(exx::a, values(), axe.a.a);
   private final int v;
   private final String w;

   private exx(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
