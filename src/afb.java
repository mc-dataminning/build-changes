...
public class afb extends IOException {
   private final List<afb.a> a = Lists.newArrayList();
   private final String b;

   public afb(String $$0) {
      this.a.add(new afb.a());
      this.b = $$0;
   }

   public afb(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new afb.a());
      this.b = $$0;
   }
   ...
   public static afb a(Exception $$0) {
      if ($$0 instanceof afb) {
         return (afb)$$0;
      } else {
