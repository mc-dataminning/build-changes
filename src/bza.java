...
public abstract class bza<E extends bxj> implements bzb<E> {
   public static final int a = 60;
   protected final Map<cgl<?>, cgm> b;
   private bza.a c = bza.a.a;
   private long d;
   private final int e;
   private final int f;

   public bza(Map<cgl<?>, cgm> $$0) {
      this($$0, 60);
   }

   public bza(Map<cgl<?>, cgm> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bza(Map<cgl<?>, cgm> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cgl<?>, cgm> $$1 : this.b.entrySet()) {
         cgl<?> $$2 = $$1.getKey();
         cgm $$3 = $$1.getValue();
         if (!$$0.eb().a($$2, $$3)) {
            return false;
