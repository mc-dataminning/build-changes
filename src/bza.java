...
public abstract class bza {
   ...
   public bza(bpr $$0, cxb $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = aww.a($$0.g(bqw.k) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract ejf a(int var1);
   ...
   @Nullable
   public final ejd a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(ib.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ejd a(Stream<ib> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ejd a(Set<ib> $$0, int $$1) {
   ...
   @Nullable
   protected ejd a(Set<ib> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(bqw.k));
   }

   @Nullable
   protected ejd a(Set<ib> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         cxo $$7 = new cxo(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         ejd $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ae().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ejd $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   protected double a(ept $$0) {
      ib $$1 = ib.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ejj.a(this.b, $$1);
   }
   ...
   private boolean c(ept $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ept $$1 = ept.c(this.c.g());
         if (!$$0.a((iv)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ept $$2 = ept.c(this.c.d(this.c.f() + 1));
            ept $$3 = $$1.d($$0);
            ept $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void S_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            ejb $$1 = this.c.a($$0);
            ejb $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dnb $$3 = this.b.a_(new ib($$1.a, $$1.b, $$1.c));
            if ($$3.a(aun.bl)) {
   ...
   public boolean b(ejg $$0) {
      return $$0 != ejg.n && $$0 != ejg.p && $$0 != ejg.d;
   }

   protected static boolean a(bpr $$0, ept $$1, ept $$2, boolean $$3) {
      ept $$4 = new ept($$2.c, $$2.d + (double)$$0.dh() * 0.5, $$2.e);
      return $$0.dM().a(new cwk($$1, $$4, cwk.a.a, $$3 ? cwk.b.c : cwk.b.a, $$0)).c() == epr.a.a;
   }
   ...
   public boolean b(ib $$0) {
      if (this.m) {
         ...
         ejb $$1 = this.c.d();
         ept $$2 = new ept(((double)$$1.a + this.a.dr()) / 2.0, ((double)$$1.b + this.a.dt()) / 2.0, ((double)$$1.c + this.a.dx()) / 2.0);
