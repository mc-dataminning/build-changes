public class bza extends byy {
   ...
   public void a() {
      if (this.d > 0) {
         ...
         this.h().ifPresent($$0x -> this.a.t(this.a(this.a.dH(), $$0x + 10.0F, this.c)));
      } else {
         if (this.a.K().l()) {
            this.a.t(this.a(this.a.dH(), 0.0F, 5.0F));
         }

         this.a.ba = this.a(this.a.ba, this.a.aY, this.b);
      }

      float $$0 = aye.g(this.a.ba - this.a.aY);
      if ($$0 < (float)(-this.h)) {
         this.a.aY -= 4.0F;
