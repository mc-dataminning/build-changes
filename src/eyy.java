...
public class eyy extends fah {
   ...
   protected void aO_() {
      ...
      this.b = new euv(this.f.i, 4, this.h - 12, this.g - 4, 12, ur.c("chat.editBox")) {
         @Override
         protected vf aL_() {
            return super.aL_().b(eyy.this.o.e());
         }
      };
      this.b.l(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new eup(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
      this.c(this.b);
   }
   ...
   public void a(eub $$0, int $$1, int $$2, float $$3) {
      ...
      super.a($$0, $$1, $$2, $$3);
      this.o.a($$0, $$1, $$2);
      esm $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(eyf $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(eye.a, ur.a("chat_screen.message", $$1));
      }
   }
   ...
   public String a(String $$0) {
      return auc.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
