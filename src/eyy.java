...
public abstract class eyy<T extends ced> extends eya implements fac<T> {
   ...
   private cix J = cix.b;
   private long K;
   protected final Set<cfv> v = Sets.newHashSet();
   protected boolean w;
   private int L;
   private int M;
   private boolean N;
   ...
   public void a(erv $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cix $$10 = this.F.b() ? this.p.g() : this.F;
      if (!$$10.b()) {
         int $$11 = 8;
   ...
   public static void a(erv $$0, int $$1, int $$2, int $$3) {
      $$0.a(foc.D(), $$1, $$2, $$1 + 16, $$2 + 16, -2130706433, -2130706433, $$3);
   }
   ...
   protected List<tf> a(cix $$0) {
      return a(this.f, $$0);
   }

   private void a(erv $$0, cix $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(erv var1, float var2, int var3, int var4);

   private void a(erv $$0, cfv $$1) {
      int $$2 = $$1.f;
      int $$3 = $$1.g;
      cix $$4 = $$1.e();
      boolean $$5 = false;
      ...
      if ($$1 == this.A && !this.F.b() && this.E && !$$4.b()) {
         ...
         if (ced.a($$1, $$7, true) && this.p.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.g(), $$1.a_($$7));
            int $$10 = $$1.e().b() ? 0 : $$1.e().L();
            int $$11 = ced.a(this.v, this.L, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if ($$4.b() && $$1.c()) {
         Pair<aer, aer> $$12 = $$1.b();
         if ($$12 != null) {
            fyu $$13 = this.f.a((aer)$$12.getFirst()).apply((aer)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
      ...
      if (!$$0.b() && this.w) {
         if (this.L == 2) {
            ...
            for (cfv $$1 : this.v) {
               ...
               int $$5 = Math.min(ced.a(this.v, this.L, $$0) + $$3, $$4);
               this.O -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private cfv a(double $$0, double $$1) {
      for (int $$2 = 0; $$2 < this.p.i.size(); $$2++) {
         cfv $$3 = this.p.i.get($$2);
         if (this.a($$3, $$0, $$1) && $$3.c()) {
            return $$3;
         }
      }
               ...
               if (this.f.m.V().c()) {
                  ...
                  if (this.p.g().b()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (eka.a(eql.O().aM().i(), 340) || eka.a(eql.O().aM().i(), 344));
                        cem $$11 = cem.a;
                        if ($$10) {
                           this.S = $$4 != null && $$4.f() ? $$4.e().p() : cix.b;
                           $$11 = cem.b;
                        } else if ($$9 == -999) {
                           $$11 = cem.e;
                        }
   ...
   private void a(int $$0) {
      if (this.s != null && this.p.g().b()) {
         if (this.f.m.F.a($$0)) {
            this.a(this.s, this.s.e, 40, cem.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.f.m.U[$$1].a($$0)) {
               this.a(this.s, this.s.e, $$1, cem.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.A != null && this.f.m.V().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.F.L() > 1 && $$5 != null && ced.a($$5, this.F, false)) {
               long $$7 = ac.b();
               if (this.C == $$5) {
                  if ($$7 - this.K > 500L) {
                     this.a(this.A, this.A.e, 0, cem.a);
                     this.a($$5, $$5.e, 1, cem.a);
                     this.a(this.A, this.A.e, 0, cem.a);
                     this.K = $$7 + 750L;
                     this.F.h(1);
                  }
      ...
      } else if (this.w && $$5 != null && !$$6.b() && ($$6.L() > this.v.size() || this.L == 2) && ced.a($$5, $$6, true) && $$5.a($$6) && this.p.b($$5)) {
         this.v.add($$5);
         this.G();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.R && $$3 != null && $$2 == 0 && this.p.a(cix.b, $$3)) {
         if (q()) {
            if (!this.S.b()) {
               for (cfv $$8 : this.p.i) {
                  if ($$8 != null && $$8.a(this.f.s) && $$8.f() && $$8.d == $$3.d && ced.a($$8, this.S, true)) {
                     this.a($$8, $$8.e, $$2, cem.b);
                  }
               }
            }
         } else {
         ...
         if (this.A != null && this.f.m.V().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = ced.a($$3, this.F, false);
               if ($$7 != -1 && !this.F.b() && $$9) {
                  this.a(this.A, this.A.e, $$2, cem.a);
                  this.a($$3, $$7, 0, cem.a);
                  if (this.p.g().b()) {
                     this.J = cix.b;
                  } else {
            ...
            this.a(null, -999, ced.b(0, this.L), cem.f);

            for (cfv $$10 : this.v) {
               this.a($$10, $$10.e, ced.b(1, this.L), cem.f);
            }

            this.a(null, -999, ced.b(2, this.L), cem.f);
         } else if (!this.p.g().b()) {
            if (this.f.m.J.a($$2)) {
               this.a($$3, $$7, $$2, cem.d);
            } else {
               boolean $$11 = $$7 != -999 && (eka.a(eql.O().aM().i(), 340) || eka.a(eql.O().aM().i(), 344));
               if ($$11) {
                  this.S = $$3 != null && $$3.f() ? $$3.e().p() : cix.b;
               }

               this.a($$3, $$7, $$2, $$11 ? cem.b : cem.a);
            }
         }
      }
   ...
   private boolean a(cfv $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.s != null && this.s.f()) {
            if (this.f.m.J.a($$0, $$1)) {
               this.a(this.s, this.s.e, 0, cem.d);
            } else if (this.f.m.G.a($$0, $$1)) {
               this.a(this.s, this.s.e, p() ? 1 : 0, cem.e);
            }
         }
      ...
      if (this.p.g().b() && this.s != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.f.m.U[$$2].a($$0, $$1)) {
               this.a(this.s, this.s.e, $$2, cem.c);
               return true;
            }
         }
      }
