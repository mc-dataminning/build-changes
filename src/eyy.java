...
public interface eyy {
   eyy a(double var1, double var3, double var5);

   eyy a(int var1, int var2, int var3, int var4);

   eyy a(float var1, float var2);

   eyy a(int var1, int var2);

   eyy b(int var1, int var2);

   eyy a(float var1, float var2, float var3);
   ...
   default eyy a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default eyy a(int $$0) {
      return this.a(axp.b.b($$0), axp.b.c($$0), axp.b.d($$0), axp.b.a($$0));
   }
   ...
   default void a(eyu.a $$0, gdh $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(eyu.a $$0, gdh $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(eys.j.b());
   ...
   default eyy a(eyu.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default eyy a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default eyy b(eyu.a $$0, float $$1, float $$2, float $$3) {
