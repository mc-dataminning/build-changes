...
public class bdz extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgs.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bdz::c), this.a("minecraft:arrow", bdz::a), this.a("minecraft:spectral_arrow", bdz::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bdz.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bgs.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bgs.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bdz.a<?> $$1, Type<?> $$2, Type<T> $$3) {
