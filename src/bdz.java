...
public class bdz extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bec.a(new Dynamic($$0, $$1), bdz.a, "ArmorStand");
      }
   };

   public bdz(int $$0, Schema $$1) {
      super($$0, $$1);
   }
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), baa.s.typeName()) ? super.getChoiceType($$0, bbi.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), baa.z.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, baa.s, () -> DSL.taggedChoiceLazy("id", bbi.a(), $$2));
      $$0.registerType(
         true,
         baa.t,
         () -> DSL.hook(
