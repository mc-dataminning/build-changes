...
public class fkw {
   ...
   public static List<fkw.a> a(String $$0, fkw.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fkw.a> a(String $$0, List<fkw.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fkw.a> a(List<String> $$0, List<fkw.b> $$1) {
      int $$2 = 0;
      List<fkw.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fkw.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fkw.b a(String $$0, String $$1) {
         return new fkw.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fkw.b a(String $$0) {
         return new fkw.b($$0);
      }
   }
}
