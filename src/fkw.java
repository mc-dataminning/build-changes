...
public class fkw {
   ...
   private final Deque<fkv> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends fkv> T a(Class<? extends T> $$0, Object $$1) {
      for (fkw.a<?> $$2 : this.d) {
   ...
   class a<T extends fkv> {
      ...
      private float a(long $$0) {
         ...
         $$1 *= $$1;
         return this.h == fkv.a.b ? 1.0F - $$1 : $$1;
      }

      public boolean a(int $$0, fhz $$1) {
         long $$2 = ad.c();
         if (this.f == -1L) {
            this.f = $$2;
            this.h.a(fkw.this.c.aj());
         }

         if (this.h == fkv.a.a && $$2 - this.f <= 600L) {
            this.g = $$2;
         }

         $$1.c().a();
         $$1.c().a((float)$$0 - (float)this.c.a() * this.a($$2), (float)(this.d * 32), 800.0F);
         fkv.a $$3 = this.c.a($$1, fkw.this, $$2 - this.g);
         $$1.c().b();
         if ($$3 != this.h) {
         ...
         return this.h == fkv.a.b && $$2 - this.f > 600L;
      }
   }
}
