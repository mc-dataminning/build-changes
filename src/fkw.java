...
public abstract class fkw<T extends fkw<T>> {
   ...
   public fkw(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fku.a();
         if ($$3 != null) {
         ...
         throw new fmo(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fmo(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fmo(var2.getMessage(), var2);
      }
   }
   ...
   public static fkw<?> a(String $$0) {
      return new fkw.b($$0, 5000, 60000);
   }

   public static fkw<?> a(String $$0, int $$1, int $$2) {
      return new fkw.b($$0, $$1, $$2);
   }

   public static fkw<?> b(String $$0, String $$1) {
      return new fkw.c($$0, $$1, 5000, 60000);
   }

   public static fkw<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fkw.c($$0, $$1, $$2, $$3);
   }

   public static fkw<?> b(String $$0) {
      return new fkw.a($$0, 5000, 60000);
   }

   public static fkw<?> c(String $$0, String $$1) {
      return new fkw.d($$0, $$1, 5000, 60000);
   }

   public static fkw<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fkw.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fkw<fkw.a> {
   ...
   public static class b extends fkw<fkw.b> {
   ...
   public static class c extends fkw<fkw.c> {
      ...
      public fkw.c f() {
         try {
            ...
            throw new fmo(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fkw<fkw.d> {
      private final String c;
