...
public class fkw {
   ...
   private static final Map<eao.a, String> e = ad.a(new EnumMap<>(eao.a.class), $$0 -> {
      $$0.put(eao.a.a, "SW");
      $$0.put(eao.a.b, "S");
      $$0.put(eao.a.c, "OW");
      $$0.put(eao.a.d, "O");
   ...
   private dwy l;
   @Nullable
   private CompletableFuture<dwy> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bmr r = new bmr(1);
   private final bmr s = new bmr(bmw.values().length);
   private final bmr t = new bmr(1);
   private final bmr u = new bmr(1);
   private final Map<bms, bmr> v = Map.of(bms.a, this.s);
   private final fmf w;
   private final fmi x;
   private final fmg y;
   private final fme z;
   ...
   public fkw(fip $$0) {
      ...
      this.g = new fkw.a();
      this.h = $$0.h;
      this.w = new fmf(this.h, this.r);
      this.x = new fmi(this.h, this.s, () -> $$0.s.s().g());
      this.y = new fmg(this.h, this.t);
      this.z = new fme(this.h, this.u);
      this.A = new fmh(this.h);
   }
   ...
   private void a(fkb $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dej $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arj ? ((arj)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, kh.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azf.h($$15.dI()), azf.h($$15.dK())));
         dwy $$27 = this.u();
         if ($$27.B()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(des.a, $$14);
            int $$30 = this.f.s.a(des.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dwy $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (eao.a $$33 : eao.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.t();
                  brq $$37 = new brq($$23.am(), $$23.ab(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            deu.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<buq> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(buq.values())
   ...
   private static String a(jo<dfk> $$0) {
   ...
   private dej s() {
      return (dej)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ag()))), this.f.s);
   }
   ...
   private dwy t() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dxp.n, false).thenApply($$0x -> (dwy)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fcb.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fip.Q().aP().l(), fip.Q().aP().m(), fcb.a()),
            fcb.c(),
            fcb.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == eyu.a.b) {
            ...
            $$4.add(String.valueOf(lv.e.b($$6.b())));

            for (Entry<dvv<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == eyu.a.b) {
            ...
            $$4.add(String.valueOf(lv.c.b($$9.a())));

            for (Entry<dvv<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lv.f.b($$11.ao())));
         }
   ...
   private String a(Entry<dvv<?>, Comparable<?>> $$0) {
      dvv<?> $$1 = $$0.getKey();
