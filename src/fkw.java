...
public class fkw {
   ...
   static class b {
      static final Optional<fkw> a = Optional.ofNullable(a());
      ...
      private static fkw a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fkw();
      }
   }
}
