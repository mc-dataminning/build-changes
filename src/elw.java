...
public class elw {
   ...
   private final Map<String, Long2ObjectMap<un>> e = Maps.newHashMap();
   private final Map<String, eme> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public elw(@Nullable eto $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public un a(un $$0) {
      un $$1 = $$0.p("Level");
      del $$2 = new del($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.g, $$2.h)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(del.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(del.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private un a(un $$0, del $$1) {
      un $$2 = $$0.p("Level");
      un $$3 = $$2.p("Structures");
      un $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<un> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable eto $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               un $$4 = $$2.p($$3);
               long $$5 = del.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               ut $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  un $$14 = $$2.p($$13);
                  $$12.a(del.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static elw a(alk<dff> $$0, @Nullable eto $$1) {
      if ($$0 == dff.i) {
         return new elw(
            $$1,
         ...
         return new elw($$1, $$2, $$2);
      } else if ($$0 == dff.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new elw($$1, $$3, $$3);
      } else {
