...
public enum elw implements aut {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final aut.a<elw> t = aut.a(elw::values);
   public static final IntFunction<elw> u = asq.a(elw::a, values(), asq.a.a);
   private final int v;
   private final String w;

   private elw(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
