...
public class elw {
   public static List<emy> a(elw.a... $$0) {
      for (elw.a $$1 : $$0) {
         a($$1.j);
      }

      List<emy> $$2 = Lists.newArrayList();

      for (elw.a $$3 : $$0) {
         $$2.add(new emy($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(emy::a));
      return $$2;
   }
   ...
   public static List<emy> a() {
      return a(elw.a.values());
   }
