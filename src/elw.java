...
public class elw implements dwo.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<elw> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axy<elw> a = axy.a(f);
   private final ema g;
   private final ema h;
   private final ema i;
   ...
   public static elw a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new elw(new dxw(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private elw(ema $$0, ema $$1, ema $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public elw(aym $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ema.a($$0, IntStream.rangeClosed(-15, 0)),
         ema.a($$0, IntStream.rangeClosed(-15, 0)),
         ema.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public elw a(aym $$0) {
      return new elw($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dwo.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         elx $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ema.b($$4 * $$13), ema.b($$5 * $$13), ema.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ema.b($$1 * $$13);
         double $$21 = ema.b($$2 * $$13);
         double $$22 = ema.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            elx $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ayf.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
