...
public class elw {
   ...
   static class a implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
         return $$0.c[ji.f.d()] && !$$0.b[ji.f.d()].d;
      }

      @Override
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         $$1.d = true;
         $$1.b[ji.f.d()].d = true;
         return new elw.k($$0, $$1);
      }
   }

   static class b implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         ...
         return new elw.l($$0, $$1);
      }
   }

   static class c implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         $$1.d = true;
         $$1.b[ji.b.d()].d = true;
         return new elw.m($$0, $$1);
      }
   }

   static class d implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         ...
         return new elw.n($$0, $$1);
      }
   }

   static class e implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         ...
         $$3.d = true;
         $$3.b[ji.c.d()].d = true;
         return new elw.o($$0, $$3);
      }
   }

   static class f implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
         return true;
      }
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         $$1.d = true;
         return new elw.s($$0, $$1, $$2);
      }
   }

   static class g implements elw.i {
      @Override
      public boolean a(elw.v $$0) {
      ...
      public elw.r a(ji $$0, elw.v $$1, ayv $$2) {
         $$1.d = true;
         return new elw.t($$0, $$1);
      }
   }

   public static class h extends elw.r {
      ...
      private elw.v G;
      private elw.v H;
      private final List<elw.r> I = Lists.newArrayList();

      public h(ayv $$0, int $$1, int $$2, ji $$3) {
         super(ekd.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<elw.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new elw.p($$3, this.G));
         this.I.add(new elw.j($$3, this.H));
         List<elw.i> $$5 = Lists.newArrayList();
         $$5.add(new elw.b());
         $$5.add(new elw.d());
         $$5.add(new elw.e());
         $$5.add(new elw.a());
         ...
         eje $$10 = eje.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eje $$11 = eje.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eje $$12 = eje.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new elw.u($$3, $$10, $$13++));
         this.I.add(new elw.u($$3, $$11, $$13++));
         this.I.add(new elw.q($$3, $$12));
      }
      ...
      private List<elw.v> b(ayv $$0) {
         elw.v[] $$1 = new elw.v[75];
         ...
         elw.v $$23 = new elw.v(1003);
         elw.v $$24 = new elw.v(1001);
         elw.v $$25 = new elw.v(1002);
         $$1[v].a(ji.b, $$23);
         $$1[w].a(ji.d, $$24);
         $$1[x].a(ji.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<elw.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, ddq $$2, ayv $$3, eje $$4) {
         int $$5 = 24;
      ...
      private void a(ddq $$0, ayv $$1, eje $$2) {
      ...
      private void b(ddq $$0, ayv $$1, eje $$2) {
      ...
      private void c(ddq $$0, ayv $$1, eje $$2) {
      ...
      private void d(ddq $$0, ayv $$1, eje $$2) {
      ...
      private void e(ddq $$0, ayv $$1, eje $$2) {
      ...
      private void f(ddq $$0, ayv $$1, eje $$2) {
   ...
   interface i {
      boolean a(elw.v var1);

      elw.r a(ji var1, elw.v var2, ayv var3);
   }

   public static class j extends elw.r {
      public j(ji $$0, elw.v $$1) {
         super(ekd.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(ddq $$0, ddo $$1, dux $$2, ayv $$3, eje $$4, dcb $$5, jd $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfy.ch.o(), dfy.ch.o(), false);
   ...
   public static class k extends elw.r {
      public k(ji $$0, elw.v $$1) {
         super(ekd.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends elw.r {
      public l(ji $$0, elw.v $$1) {
         super(ekd.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends elw.r {
      public m(ji $$0, elw.v $$1) {
         super(ekd.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends elw.r {
      public n(ji $$0, elw.v $$1) {
         super(ekd.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends elw.r {
      public o(ji $$0, elw.v $$1) {
         super(ekd.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends elw.r {
      public p(ji $$0, elw.v $$1) {
         super(ekd.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends elw.r {
      public q(ji $$0, eje $$1) {
         super(ekd.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ejq {
      protected static final dta b = dfy.hZ.o();
      protected static final dta c = dfy.ia.o();
      protected static final dta d = dfy.ib.o();
      protected static final dta h = c;
      protected static final dta i = dfy.ii.o();
      protected static final boolean j = true;
      protected static final dta k = dfy.G.o();
      protected static final Set<dfw> l = ImmutableSet.builder().add(dfy.dO).add(dfy.iC).add(dfy.mW).add(k.b()).build();
      ...
      public r(ekd $$0, ji $$1, int $$2, eje $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ekd $$0, int $$1, ji $$2, elw.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eje a(ji $$0, elw.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eje $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(ddq $$0, eje $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dta $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(ddq $$0, eje $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(ddq $$0, eje $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dta $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eje $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(ddq $$0, eje $$1, int $$2, int $$3, int $$4) {
         jd $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjq $$6 = bsw.D.a((dcu)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eO());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dq()), btp.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends elw.r {
      private int a;

      public s(ji $$0, elw.v $$1, ayv $$2) {
         super(ekd.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends elw.r {
      public t(ji $$0, elw.v $$1) {
         super(ekd.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends elw.r {
      private int a;

      public u(ji $$0, eje $$1, int $$2) {
         super(ekd.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
