...
public abstract class foq<T extends cpu> extends fob implements fpw<T> {
   ...
   public static void a(fhx $$0, int $$1, int $$2, int $$3) {
      $$0.a(gff.E(), $$1, $$2, $$1 + 16, $$2 + 16, -2130706433, -2130706433, $$3);
   }
   ...
   private void a(fhx $$0, cuq $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(fhx var1, float var2, int var3, int var4);

   protected void a(fhx $$0, crq $$1) {
      int $$2 = $$1.e;
      int $$3 = $$1.f;
      cuq $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$4.e() && $$1.d()) {
         Pair<akr, akr> $$12 = $$1.b();
         if ($$12 != null) {
            gqj $$13 = this.l.a((akr)$$12.getFirst()).apply((akr)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
               ...
               if (this.l.m.Z().c()) {
                  ...
                  if (this.x.g().e()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (fac.a(fgm.Q().aM().j(), 340) || fac.a(fgm.Q().aM().j(), 344));
                        cqe $$11 = cqe.a;
                        if ($$10) {
      ...
      if (this.Y && $$3 != null && $$2 == 0 && this.x.a(cuq.l, $$3)) {
         ...
         if (this.H != null && this.l.m.Z().c()) {
            ...
            if (this.l.m.I.a($$2)) {
               ...
               boolean $$11 = $$7 != -999 && (fac.a(fgm.Q().aM().j(), 340) || fac.a(fgm.Q().aM().j(), 344));
               if ($$11) {
