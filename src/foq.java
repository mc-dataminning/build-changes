...
public class foq {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dis)MoreObjects.firstNonNull(this.b.r.h(), dis.b)).b());
               }
   ...
   private void a(dzz $$0, iu $$1, @Nullable tz $$2) {
   ...
   private void a(alg $$0, fei $$1, @Nullable tz $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().d();
         boolean $$5 = fhx.a(fos.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fhx.a(fos.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fhx.a(fos.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof gbh) || ((gbh)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
               boolean $$7 = this.b.aO().i();
               this.b.n.ad().a($$7);
               this.b.n.az();
               if (this.b.z instanceof gbe $$8) {
                  $$8.c($$7);
               }
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fpa.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$9 = $$6 == null || !($$6.aH_() instanceof fsl) || !((fsl)$$6.aH_()).c();
            if ($$9) {
               if (fxu.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$10 = this.b.n.av().c() == fou.a;
                  this.b.n.av().a(fou.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$10);
                  }
         ...
         label201: {
            ...
            label157:
            if (!$$15) {
               if (this.b.z instanceof fxp $$16 && !$$16.m()) {
                  break label157;
               }
