...
public class foq {
   ...
   private final List<fla> k = Lists.newArrayList();
   private final List<fla.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<foq.a> o = new ArrayList<>();
   ...
   public void a(fob $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$9 = ayy.f((float)this.f() / $$8);
            int $$10 = $$0.b();
            $$0.c().a();
            $$0.c().b($$8, $$8, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$11 = ayy.d((float)($$10 - 40) / $$8);
               ...
               if ($$21 != null) {
                  ...
                  if ($$22 < 200 || $$4) {
                     ...
                     if ($$24 > 3) {
                        ...
                        $$0.b(this.i.h, $$21.b(), 0, $$28, axj.c($$24, -1));
                        $$0.c().b();
                     }
                  }
               }
   ...
   private void a(fob $$0, int $$1, int $$2, flb.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fla.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == cos.c;
   }
   ...
   public void a(wo $$0) {
      this.a($$0, null, this.i.W() ? flb.b() : flb.a());
   }

   public void a(wo $$0, @Nullable xa $$1, @Nullable flb $$2) {
      fla $$3 = new fla(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fla $$0) {
      ...
      List<ayk> $$3 = fov.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fla.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private foq.a b(xa $$0) {
      int $$1 = this.i.m.e();
      ListIterator<fla> $$2 = this.k.listIterator();
   ...
   private fla d(fla $$0) {
      return new fla($$0.b(), h, null, flb.a());
   }
   ...
   private void n() {
      ...
      for (fla $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public flb c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fla.a $$1, flb $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         flb.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.z instanceof fte;
   }
   ...
   public foq.b k() {
      return new foq.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(foq.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fla> $$0, List<String> $$1, List<foq.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
