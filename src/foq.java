public class foq extends fod<cqn> implements fqy {
   private static final alf D = new alf("textures/gui/container/crafting_table.png");
   private final fqs E = new fqs();
   private boolean F;

   public foq(cqn $$0, cmy $$1, xp $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aM_() {
      ...
      this.c(new fhs(this.z + 5, this.o / 2 - 49, 20, 18, fqs.a, $$0 -> {
         this.E.e();
         this.z = this.E.a(this.n, this.c);
