...
public class foq implements gap {
   private final aep a;
   private final j b;
   private final boolean c;
   private final int d;

   public foq(aep $$0, j $$1, boolean $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof foq $$1) ? false : this.a.equals($$1.a) && Objects.equals(this.b, $$1.b) && this.c == $$1.c && this.d == $$1.d;
      }
   }
   ...
   public static class a implements JsonDeserializer<foq> {
      @VisibleForTesting
      ...
      public foq a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         boolean $$6 = this.d($$3);
         int $$7 = this.c($$3);
         return new foq($$4, $$5.b(), $$6, $$7);
      }

      private boolean d(JsonObject $$0) {
         return arf.a($$0, "uvlock", false);
      }

      protected gai a(JsonObject $$0) {
         int $$1 = arf.a($$0, "x", 0);
         int $$2 = arf.a($$0, "y", 0);
         gai $$3 = gai.a($$1, $$2);
         if ($$3 == null) {
      ...
      protected aep b(JsonObject $$0) {
         return new aep(arf.i($$0, "model"));
      }

      protected int c(JsonObject $$0) {
         int $$1 = arf.a($$0, "weight", 1);
         if ($$1 < 1) {
