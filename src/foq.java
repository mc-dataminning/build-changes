public abstract class foq extends fom {
   private static final fqh a = new fqh(akv.b("widget/text_field"), akv.b("widget/text_field_highlighted"));
   ...
   protected abstract void c(fof var1, int var2, int var3, float var4);
