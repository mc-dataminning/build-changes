...
public abstract class fyh<T extends ctr> implements fpv, fqp, fsn {
   public static final fqf a = new fqf(aku.b("recipe_book/button"), aku.b("recipe_book/button_highlighted"));
   ...
   public fyh(T $$0, List<fyh.a> $$1) {
      ...
      this.u = new fyf($$2);
      this.B = new fyi(this, $$2, $$0 instanceof cse);
   }
   ...
   private void i() {
      ...
      this.x = new fpb(this.g.h, $$1 + 25, $$2 + 13, 81, 9 + 5, wo.c("itemGroup.search"));
      this.x.f(50);
      this.x.g(true);
      this.x.m(16777215);
      this.x.a($$3);
   ...
   protected abstract void a(fyl var1, cpc var2);
   ...
   public void a(fod $$0, int $$1, int $$2, @Nullable ctz $$3) {
      if (this.d()) {
         this.B.a($$0, $$1, $$2);
   ...
   protected abstract void a(fyf var1, dcj var2, bak var3);
