...
public class fyh extends fyl<can> {
   ...
   private static final fto i = fto.e(g);
   private static final fto j = fto.l(g);
   private static final fto k = fto.p(h);
   private static final fto l = fto.k(a);
   private static final float m = (float)(Math.sqrt(3.0) / 2.0);
   private final fyh.a n;

   public fyh(fym.a $$0) {
      super($$0);
      this.d = 0.5F;
      this.n = new fyh.a($$0.a(fmv.W));
   }

   public void a(can $$0, float $$1, float $$2, eqa $$3, ftg $$4, int $$5) {
      $$3.a();
      ...
      if ($$0.bV > 0) {
         ...
         eqe $$10 = $$4.getBuffer(fto.o(f));
         this.n.a($$3, $$10, $$5, ged.d, 1.0F, 1.0F, 1.0F, $$9);
         eqe $$11 = $$4.getBuffer(j);
         this.n.a($$3, $$11, $$5, ged.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      } else {
         eqe $$12 = $$4.getBuffer(i);
         this.n.a($$3, $$12, $$5, ged.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      eqe $$13 = $$4.getBuffer(k);
      this.n.a($$3, $$13, $$5, ged.d, 1.0F, 1.0F, 1.0F, 1.0F);
      if ($$0.bV > 0) {
         float $$14 = ((float)$$0.bV + $$2) / 200.0F;
         float $$15 = Math.min($$14 > 0.8F ? ($$14 - 0.8F) / 0.2F : 0.0F, 1.0F);
         auu $$16 = auu.a(432L);
         eqe $$17 = $$4.getBuffer(fto.s());
         $$3.a();
         $$3.a(0.0F, -1.0F, -2.0F);
      ...
      if ($$0.bX != null) {
         ...
         a($$23, $$24 + fyg.a($$0.bX, $$2), $$25, $$2, $$0.ah, $$3, $$4, $$5);
         $$3.b();
      }
   ...
   private static void a(eqe $$0, Matrix4f $$1, int $$2) {
      $$0.a($$1, 0.0F, 0.0F, 0.0F).a(255, 255, 255, $$2).e();
   }

   private static void a(eqe $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, -m * $$3, $$2, -0.5F * $$3).a(255, 0, 255, 0).e();
   }

   private static void b(eqe $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, m * $$3, $$2, -0.5F * $$3).a(255, 0, 255, 0).e();
   }

   private static void c(eqe $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, 0.0F, $$2, 1.0F * $$3).a(255, 0, 255, 0).e();
   }

   public static void a(float $$0, float $$1, float $$2, float $$3, int $$4, eqa $$5, ftg $$6, int $$7) {
      ...
      for (int $$20 = 1; $$20 <= 8; $$20++) {
         ...
         $$10.a($$18, $$14 * 0.2F, $$15 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$16, $$11).c(ged.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$14, $$15, $$9).a(255, 255, 255, 255).a($$16, $$12).c(ged.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21, $$22, $$9).a(255, 255, 255, 255).a($$23, $$12).c(ged.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21 * 0.2F, $$22 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$23, $$11).c(ged.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$14 = $$21;
         $$15 = $$22;
         $$16 = $$23;
      }
   ...
   public static fnc a() {
      ...
      $$3.a("jaw", fnb.c().a("jaw", -6.0F, 0.0F, -16.0F, 12, 4, 16, 176, 65), fmy.a(0.0F, 4.0F, -8.0F));
      $$1.a("neck", fnb.c().a("box", -5.0F, -5.0F, -5.0F, 10, 10, 10, 192, 104).a("scale", -1.0F, -9.0F, -3.0F, 2, 4, 6, 48, 0), fmy.a);
      $$1.a(
         "body",
         fnb.c()
         ...
         fmy.a(0.0F, 4.0F, 8.0F)
      );
      fnf $$4 = $$1.a(
         "left_wing", fnb.c().a().a("bone", 0.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).a("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), fmy.a(12.0F, 5.0F, 2.0F)
      );
      $$4.a(
         "left_wing_tip",
         fnb.c().a().a("bone", 0.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).a("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144),
         fmy.a(56.0F, 0.0F, 0.0F)
      );
      fnf $$5 = $$1.a("left_front_leg", fnb.c().a("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), fmy.a(12.0F, 20.0F, 2.0F));
      fnf $$6 = $$5.a("left_front_leg_tip", fnb.c().a("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), fmy.a(0.0F, 20.0F, -1.0F));
      $$6.a("left_front_foot", fnb.c().a("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), fmy.a(0.0F, 23.0F, 0.0F));
      fnf $$7 = $$1.a("left_hind_leg", fnb.c().a("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), fmy.a(16.0F, 16.0F, 42.0F));
      fnf $$8 = $$7.a("left_hind_leg_tip", fnb.c().a("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), fmy.a(0.0F, 32.0F, -4.0F));
      $$8.a("left_hind_foot", fnb.c().a("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), fmy.a(0.0F, 31.0F, 4.0F));
      fnf $$9 = $$1.a(
         "right_wing", fnb.c().a("bone", -56.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).a("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), fmy.a(-12.0F, 5.0F, 2.0F)
      );
      $$9.a(
         "right_wing_tip",
         fnb.c().a("bone", -56.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).a("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144),
         fmy.a(-56.0F, 0.0F, 0.0F)
      );
      fnf $$10 = $$1.a("right_front_leg", fnb.c().a("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), fmy.a(-12.0F, 20.0F, 2.0F));
      fnf $$11 = $$10.a("right_front_leg_tip", fnb.c().a("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), fmy.a(0.0F, 20.0F, -1.0F));
      $$11.a("right_front_foot", fnb.c().a("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), fmy.a(0.0F, 23.0F, 0.0F));
      fnf $$12 = $$1.a("right_hind_leg", fnb.c().a("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), fmy.a(-16.0F, 16.0F, 42.0F));
      fnf $$13 = $$12.a("right_hind_leg_tip", fnb.c().a("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), fmy.a(0.0F, 32.0F, -4.0F));
      $$13.a("right_hind_foot", fnb.c().a("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), fmy.a(0.0F, 31.0F, 4.0F));
      return fnc.a($$0, 256, 256);
   }

   public static class a extends fjw<can> {
      private final fmw a;
      private final fmw b;
      private final fmw f;
      private final fmw g;
      ...
      private void a(eqa $$0, eqe $$1, int $$2, int $$3, float $$4, fmw $$5, fmw $$6, fmw $$7, fmw $$8, fmw $$9, fmw $$10, fmw $$11, float $$12) {
         $$9.e = 1.0F + $$4 * 0.1F;
         $$10.e = 0.5F + $$4 * 0.1F;
         $$11.e = 0.75F + $$4 * 0.1F;
         $$6.e = 1.3F + $$4 * 0.1F;
