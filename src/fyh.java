...
public class fyh extends fyd<ggn.a> {
   ...
   private fyh(ftx $$0, ggs $$1, ggn.a $$2) {
      super(C, $$0, $$1, $$2);
   }

   public fyh(ftx $$0, ggs $$1, UUID $$2, String $$3) {
      this($$0, $$1, new ggn.a($$2, $$3, $$1.a().b()));
   }

   public fyh(ftx $$0, ggs $$1, ggn $$2) {
   ...
   protected void E() {
      ...
      this.z.a(new fpm(xv.a("gui.abuseReport.name.reporting", $$0), this.p), $$0x -> $$0x.b().a(0, 8));
      this.E = this.a(280, 9 * 8, $$0x -> {
         this.A.a($$0x);
         this.G();
      });
      this.z.a(frp.a(this.p, this.E, D, $$0x -> $$0x.e(12)));
   }
