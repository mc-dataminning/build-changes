public class fyh extends fui<fnd, fgi<fnd>> {
   ...
   protected void a(fnd $$0, tm $$1, elp $$2, foe $$3, int $$4) {
      double $$5 = this.c.b($$0);
      $$2.a();
      if ($$5 < 100.0) {
         eim $$6 = $$0.gg();
         ...
         if ($$7 != null) {
            eil $$8 = $$6.c($$0.cx(), $$7);
            super.a($$0, tm.b(Integer.toString($$8.b())).b(tl.u).b($$7.d()), $$2, $$3, $$4);
   ...
   protected void a(fnd $$0, elp $$1, float $$2, float $$3, float $$4) {
      ...
      if ($$0.fv()) {
         ...
         float $$8 = arx.a($$7 * $$7 / 100.0F, 0.0F, 1.0F);
         if (!$$0.fi()) {
