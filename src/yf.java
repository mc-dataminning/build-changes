...
public class yf {
   ...
   public yf(dhq $$0) {
      ...
      for (Entry<gw, dcv> $$2 : $$0.G().entrySet()) {
         this.d.add(yf.a.a($$2.getValue()));
      }
   }

   public yf(so $$0, int $$1, int $$2) {
      this.b = $$0.p();
      if (this.b == null) {
   ...
   public Consumer<yf.b> a(int $$0, int $$1) {
      return $$2 -> this.a($$2, $$0, $$1);
   }

   private void a(yf.b $$0, int $$1, int $$2) {
      int $$3 = 16 * $$1;
      int $$4 = 16 * $$2;
      gw.a $$5 = new gw.a();
   ...
   static class a {
      ...
      private a(int $$0, int $$1, dcx<?> $$2, @Nullable qw $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
      ...
      static yf.a a(dcv $$0) {
         ...
         return new yf.a($$3, $$2.v(), $$0.u(), $$1.g() ? null : $$1);
      }
   }

   @FunctionalInterface
   public interface b {
      void accept(gw var1, dcx<?> var2, @Nullable qw var3);
   }
}
