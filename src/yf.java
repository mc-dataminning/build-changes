...
public class yf implements wv {
   ...
   private static final Codec<Object> d = axh.b(axh.b, yf::b);
   ...
   public static final MapCodec<yf> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               axh.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, yf::a)
   );
   public static final wv.a<yf> c = new wv.a<>(b, "translatable");
   private static final wz f = wz.e("%");
   private static final wz g = wz.e("null");
   ...
   @Nullable
   private tv k;
   private List<wz> l = ImmutableList.of();
   ...
   private static yf a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yf($$0, $$1.orElse(null), a($$2));
   }

   public yf(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<wz> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yg var4) {
            this.l = ImmutableList.of(wz.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<wz> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yg(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private wz a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wu) {
            ...
            return $$1 == null ? g : wz.e($$1.toString());
         }
      } else {
         throw new yg(this, $$0);
      }
   ...
   public xi a(@Nullable ed $$0, @Nullable brh $$1, int $$2) throws CommandSyntaxException {
      ...
      return xi.a(new yf(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yf $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
