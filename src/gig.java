...
public class gig {
   ...
   public static class a extends Thread {
      private final gig.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gig.b $$0) throws IOException {
         super("LanServerDetector #" + gig.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gig.b));
   ...
   public static class b {
      private final List<gif> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gif> a() {
         if (this.b) {
            List<gif> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
