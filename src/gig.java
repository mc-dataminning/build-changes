...
public class gig {
   ...
   public gig(gza $$0, gzb $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(gxm $$0, feb $$1, gih $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fef $$6 = $$2.getBuffer(gir.t($$0.a));
      ...
      for (gxm.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fks.a.a, Integer.MIN_VALUE, $$4);
               $$1.b();
            }
   ...
   public void a(etc $$0, ete $$1, gxm $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
