...
public class ari extends arn {
   ...
   private final Set<arj<?>> e = Sets.newHashSet();

   public ari(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<arj<?>> d() {
      Set<arj<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  sj $$4 = a($$3.getAsJsonObject());
                  $$4 = avg.g.a($$0, $$4, sy.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<arj<T>> a(arl<T> $$0, String $$1) {
      return Optional.ofNullable(agt.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static sj a(JsonObject $$0) {
      sj $$1 = new sj();
   ...
   protected String b() {
      Map<arl<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<arj<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<arj<?>>)$$3.next();
         arj<?> $$2 = (arj<?>)$$1.getKey();
      ...
      for (Entry<arl<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(kb.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> agt b(arj<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(amq $$0) {
      Object2IntMap<arj<?>> $$1 = new Object2IntOpenHashMap();
