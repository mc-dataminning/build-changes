...
public class ari implements dco {
   private static final Logger a = LogUtils.getLogger();
   private final List<dtt> b;
   private final dtt c;
   private final int d;
   private final arb e;
   ...
   private final azc h;
   private final dvp i;
   private final exi<deu> j = new exi<>($$0x -> this.y($$0x).o());
   private final exi<enp> k = new exi<>($$0x -> this.y($$0x).p());
   private final dcu l;
   private final dba m;
   private final dba n;
   private final dus o;
   ...
   private static final alb s = new alb("worldgen_region_random");

   public ari(arb $$0, List<dtt> $$1, dus $$2, int $$3) {
      this.o = $$2;
      this.p = $$3;
      int $$4 = ayu.a(Math.sqrt((double)$$1.size()));
      if ($$4 * $$4 != $$1.size()) {
         ...
         this.i = $$0.D_();
         this.l = new dcu(this, dcu.a(this.f));
         this.m = $$1.get(0).f();
   ...
   @Override
   public dtt a(int $$0, int $$1) {
      return this.a($$0, $$1, dus.c);
   }
   ...
   @Nullable
   @Override
   public cms a(double $$0, double $$1, double $$2, double $$3, Predicate<bsp> $$4) {
      return null;
   }
   ...
   public boolean a(iz $$0, boolean $$1, @Nullable bsp $$2, int $$3) {
      ...
      if ($$4.i()) {
         ...
         if ($$1) {
            dpc $$5 = $$4.t() ? this.c_($$0) : null;
            deu.a($$4, (dbt)this.e, $$0, $$5, $$2, cuk.l);
         }

         return this.a($$0, dew.a.n(), 3, $$3);
      }
   }
   ...
   public bqn d_(iz $$0) {
      if (!this.b(kb.a($$0.u()), kb.a($$0.w()))) {
         ...
         return new bqn(this.e.al(), this.e.aa(), 0L, this.e.aq());
      }
   }
   ...
   @Override
   public List<bsp> a(@Nullable bsp $$0, evh $$1, @Nullable Predicate<? super bsp> $$2) {
      return Collections.emptyList();
   }
