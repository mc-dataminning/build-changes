...
class ari implements Path {
   private static final BasicFileAttributes a = new arg() {
      @Override
   ...
   private static final BasicFileAttributes b = new arg() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ari> c = Comparator.comparing(ari::n);
   ...
   public ari(ark $$0, String $$1, @Nullable ari $$2, arl $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ari a(@Nullable ari $$0, String $$1) {
      return new ari(this.e, $$1, $$0, arl.b);
   }
   ...
   ari a(String $$0) {
      if (a(this.i)) {
         return new ari(this.e, $$0, this, this.i);
      } else if (this.i instanceof arl.a $$1) {
         ari $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ari(this.e, $$0, this, arl.a);
      } else if (this.i instanceof arl.b) {
         return new ari(this.e, $$0, this, arl.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(arl $$0) {
      return $$0 == arl.a || $$0 == arl.b;
   }
   ...
   private ari c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ari $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof arl.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public arl.a i() {
      return this.i instanceof arl.a $$0 ? $$0 : null;
   }
