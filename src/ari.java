...
public class ari {
   ...
   private static void a(arm $$0, aqm $$1, dth $$2) {
      $$0.b(new adc($$2, $$1.y_(), null, null));
      dae $$3 = $$2.f();
      aga.a($$1, $$3);
   }

   private List<dth> a(apv $$0, dae $$1) {
      int $$2 = ayd.d(this.i);
      List<dth> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : ayd.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
