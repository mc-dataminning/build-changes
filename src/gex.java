...
public class gex implements geq {
   ...
   private gex(List<ahg> $$0, ahg $$1, Map<String, ahg> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(gew a, Supplier<IntUnaryOperator> b, ahg c) implements geq.b {
      @Nullable
      public geg a(gep $$0) {
         Object var3;
         try {
            epb $$1 = this.a.a().a(this.b.get());
            return new geg(this.c, new gfy($$1.a(), $$1.b()), $$1, aqj.a);
         } catch (IllegalArgumentException | IOException var7) {
            gex.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
