...
public class cgf extends cfe {
   private static final akj<iz> bZ = akn.a(cgf.class, akl.o);
   private static final akj<Boolean> cb = akn.a(cgf.class, akl.k);
   private static final akj<Boolean> cc = akn.a(cgf.class, akl.k);
   private static final akj<iz> cd = akn.a(cgf.class, akl.o);
   private static final akj<Boolean> ce = akn.a(cgf.class, akl.k);
   private static final akj<Boolean> cf = akn.a(cgf.class, akl.k);
   private static final float cg = 0.3F;
   private static final bsw ch = bsz.bh.n().a(bsv.a().a(bsu.a, 0.0F, bsz.bh.m(), -0.25F)).a(0.3F);
   int ci;
   public static final Predicate<bto> bY = $$0 -> $$0.p_() && !$$0.be();

   public cgf(bsz<? extends cgf> $$0, dbx $$1) {
      super($$0, $$1);
      this.a(eol.j, 0.0F);
      this.a(eol.t, -1.0F);
      this.a(eol.s, -1.0F);
      this.a(eol.r, -1.0F);
      this.bP = new cgf.e(this);
   }
   ...
   public static boolean c(bsz<cgf> $$0, dby $$1, bts $$2, iz $$3, azg $$4) {
      return $$3.v() < $$1.z_() + 4 && dnq.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void z() {
      this.bS.a(0, new cgf.f(this, 1.2));
      this.bS.a(1, new cgf.a(this, 1.0));
      this.bS.a(1, new cgf.d(this, 1.0));
      this.bS.a(2, new cbu(this, 1.1, $$0 -> $$0.a(awx.av), false));
      this.bS.a(3, new cgf.c(this, 1.0));
      this.bS.a(4, new cgf.b(this, 1.0));
      this.bS.a(7, new cgf.i(this, 1.0));
      this.bS.a(8, new cau(this, cmw.class, 8.0F));
      this.bS.a(9, new cgf.h(this, 1.0, 100));
   }

   public static buv.a y() {
      return btq.A().a(buw.q, 30.0).a(buw.r, 0.25).a(buw.v, 1.0);
   }
   ...
   public void n_() {
      ...
      if (this.bD() && this.u() && this.ci >= 1 && this.ci % 5 == 0) {
         iz $$0 = this.dp();
         if (dnq.a(this.dP(), $$0)) {
            this.dP().c(2001, $$0, dey.i(this.dP().a_($$0.d())));
            this.a(dwu.u);
         }
      }
   }
   ...
   static class a extends bzy {
      ...
      protected void g() {
         ...
         if (this.b.ab().b(dbt.f)) {
            this.b.b(new bte(this.b, this.a.du(), this.a.dw(), this.a.dA(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends cam {
      ...
      public void e() {
         ...
         if (this.a.K().l()) {
            evq $$2 = evq.c($$0);
            evq $$3 = cej.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = cej.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dP().a_(iz.a($$3)).a(dfa.G)) {
   ...
   static class d extends caz {
      ...
      public void e() {
         ...
         if (!this.g.be() && this.m()) {
            if (this.g.ci < 1) {
               ...
               iz $$2 = this.e.c();
               dsb $$3 = dfa.mf.o().a(dnq.f, Integer.valueOf(this.g.ah.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(dwu.i, $$2, dwu.a.a(this.g, $$3));
               this.g.w(false);
               this.g.x(false);
               this.g.t(600);
            }
      ...
      @Override
      protected boolean a(dca $$0, iz $$1) {
         return !$$0.u($$1.c()) ? false : dnq.b($$0, $$1);
      }
   }
      ...
      public void a() {
         ...
         if (this.k == bzp.a.b && !this.l.K().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aY = this.l.dF();
               float $$5 = (float)(this.h * this.l.g(buw.r));
               this.l.y(ayy.i(0.125F, this.l.fn(), $$5));
   ...
   static class g extends ccx {
      ...
      public boolean a(iz $$0) {
         if (this.a instanceof cgf $$1 && $$1.gy()) {
            return this.b.a_($$0).a(dfa.G);
         }
   ...
   static class i extends cam {
      ...
      public void e() {
         if (this.a.K().l()) {
            evq $$0 = evq.c(this.a.gw());
            evq $$1 = cej.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
