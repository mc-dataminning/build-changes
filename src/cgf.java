...
public class cgf {
   ...
   @Nullable
   public static faz a(bvo $$0, Supplier<ji> $$1) {
      return a($$1, $$0::c);
   }

   @Nullable
   public static faz a(Supplier<ji> $$0, ToDoubleFunction<ji> $$1) {
      ...
      return $$3 != null ? faz.c($$3) : null;
   }

   public static ji a(bvo $$0, int $$1, azh $$2, ji $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.ge() && $$1 > 1) {
         ji $$6 = $$0.gb();
