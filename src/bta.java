...
public class bta extends bsp {
   ...
   public bta(dbt $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bsv.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bta(bsv<? extends bta> $$0, dbt $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         evm $$0 = new evm(this.k.du() - this.du(), this.k.dw() + (double)this.k.cL() / 2.0 - this.dw(), this.k.dA() - this.dA());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dP() instanceof arb) {
         for (bta $$1 : this.dP().a(dwe.a(bta.class), this.cK().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(arb $$0, evm $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bta($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(arb $$0, evm $$1, int $$2) {
      evh $$3 = evh.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bta> $$5 = $$0.a(dwe.a(bta.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bta $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(bta $$0, int $$1, int $$2) {
      return !$$0.dK() && ($$0.al() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bta $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cms $$0, int $$1) {
      Entry<bsw, cuk> $$2 = czw.a(czy.O, $$0, cuk::m);
      if ($$2 != null) {
         cuk $$3 = $$2.getValue();
