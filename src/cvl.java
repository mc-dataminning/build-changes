...
public class cvl {
   ...
   public static final cvl b = new cvl(0, 0);
   ...
   public static cvl a(int $$0, int $$1) {
      return new cvl($$0 << 5, $$1 << 5);
   }

   public static cvl b(int $$0, int $$1) {
      return new cvl(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cvl $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public int a(int $$0) {
      return jd.a(this.e, $$0);
   }

   public int b(int $$0) {
      return jd.a(this.f, $$0);
   }
   ...
   public static Stream<cvl> a(cvl $$0, int $$1) {
      return a(new cvl($$0.e - $$1, $$0.f - $$1), new cvl($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cvl> a(final cvl $$0, final cvl $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cvl>((long)($$2 * $$3), 64) {
         @Nullable
         private cvl e;

         @Override
         public boolean tryAdvance(Consumer<? super cvl> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cvl($$0.e, $$2 + $$5);
               } else {
                  this.e = new cvl($$1 + $$4, $$2);
               }
            }
