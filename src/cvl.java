...
public class cvl extends cvd {
   ...
   public void b() {
      if (this.c() instanceof asb $$0) {
         ...
         if ($$4) {
            this.a($$0);
            if ($$3.a(dnq.hI)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dtr.d));
            }
         } else {
            this.a.e($$0);
         }
         ...
         if ($$5 * $$5 + $$6 * $$6 > 0.001) {
            this.b((float)(azz.d($$6, $$5) * 180.0 / Math.PI));
            if (this.a.m()) {
               this.b(this.k() + 180.0F);
            }
         }

         double $$7 = (double)azz.h(this.k() - this.a.N);
         if ($$7 < -170.0 || $$7 >= 170.0) {
            this.b(this.k() + 180.0F);
            this.a.b(!this.a.m());
         }
   ...
   public void a(asb $$0) {
      ...
      $$10 = new fgc($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bxe $$20 = this.a.cZ();
      fgc $$22;
      ...
      $$10 = this.e();
      this.a.a(byj.a, new fgc(azz.a($$36 * $$10.d, -$$37, $$37), 0.0, azz.a($$36 * $$10.f, -$$37, $$37)));
      if ($$13.v() != 0 && azz.a(this.a.dA()) - $$1.u() == $$13.u() && azz.a(this.a.dG()) - $$1.w() == $$13.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$13.v(), this.a.dG());
      } else if ($$14.v() != 0 && azz.a(this.a.dA()) - $$1.u() == $$14.u() && azz.a(this.a.dG()) - $$1.w() == $$14.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$14.v(), this.a.dG());
      }

      this.a(this.a.a(this.e()));
      fgc $$38 = this.d(this.a.dA(), this.a.dC(), this.a.dG());
      if ($$38 != null && $$6 != null) {
      ...
      int $$42 = azz.a(this.a.dA());
      int $$43 = azz.a(this.a.dG());
      if ($$42 != $$1.u() || $$43 != $$1.w()) {
         fgc $$44 = this.e();
         double $$45 = $$44.i();
   ...
   @Nullable
   public fgc a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = azz.a($$0);
      int $$5 = azz.a($$1);
      int $$6 = azz.a($$2);
      if (this.c().a_(new iw($$4, $$5 - 1, $$6)).a(axn.P)) {
         $$5--;
      }

      ebq $$7 = this.c().a_(new iw($$4, $$5, $$6));
      if (dnd.h($$7)) {
         ecu $$8 = $$7.c(((dnd)$$7.b()).c());
         $$1 = (double)$$5;
         if ($$8.b()) {
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && azz.a($$0) - $$4 == $$10.u() && azz.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && azz.a($$0) - $$4 == $$11.u() && azz.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   public fgc d(double $$0, double $$1, double $$2) {
      ...
      int $$4 = azz.a($$1);
      int $$5 = azz.a($$2);
      if (this.c().a_(new iw($$3, $$4 - 1, $$5)).a(axn.P)) {
         $$4--;
      }

      ebq $$6 = this.c().a_(new iw($$3, $$4, $$5));
      if (dnd.h($$6)) {
         ecu $$7 = $$6.c(((dnd)$$6.b()).c());
         Pair<kb, kb> $$8 = cuv.a($$7);
         kb $$9 = (kb)$$8.getFirst();
   ...
   @Override
   public boolean d() {
      ffx $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.y() && this.e().j() >= 0.01) {
         ...
         for (bxe $$3 : this.c().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bG() && $$3 instanceof cuv) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public fgc c(fgc $$0) {
      return !Double.isNaN($$0.d) && !Double.isNaN($$0.e) && !Double.isNaN($$0.f) ? new fgc(azz.a($$0.d, -0.4, 0.4), $$0.e, azz.a($$0.f, -0.4, 0.4)) : fgc.c;
   }
