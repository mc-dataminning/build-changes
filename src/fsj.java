...
public class fsj extends fsn<bxa> {
   ...
   private static final fnt i = fnt.e(g);
   private static final fnt j = fnt.l(g);
   private static final fnt k = fnt.p(h);
   private static final fnt l = fnt.k(a);
   private static final float m = (float)(Math.sqrt(3.0) / 2.0);
   private final fsj.a n;

   public fsj(fso.a $$0) {
      super($$0);
      this.d = 0.5F;
      this.n = new fsj.a($$0.a(fhm.T));
   }

   public void a(bxa $$0, float $$1, float $$2, elg $$3, fnl $$4, int $$5) {
      $$3.a();
      ...
      if ($$0.bV > 0) {
         ...
         elk $$10 = $$4.getBuffer(fnt.o(f));
         this.n.a($$3, $$10, $$5, fyc.d, 1.0F, 1.0F, 1.0F, $$9);
         elk $$11 = $$4.getBuffer(j);
         this.n.a($$3, $$11, $$5, fyc.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      } else {
         elk $$12 = $$4.getBuffer(i);
         this.n.a($$3, $$12, $$5, fyc.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      elk $$13 = $$4.getBuffer(k);
      this.n.a($$3, $$13, $$5, fyc.d, 1.0F, 1.0F, 1.0F, 1.0F);
      if ($$0.bV > 0) {
         float $$14 = ((float)$$0.bV + $$2) / 200.0F;
         float $$15 = Math.min($$14 > 0.8F ? ($$14 - 0.8F) / 0.2F : 0.0F, 1.0F);
         aru $$16 = aru.a(432L);
         elk $$17 = $$4.getBuffer(fnt.t());
         $$3.a();
         $$3.a(0.0F, -1.0F, -2.0F);
      ...
      if ($$0.bX != null) {
         ...
         a($$23, $$24 + fsi.a($$0.bX, $$2), $$25, $$2, $$0.ah, $$3, $$4, $$5);
         $$3.b();
      }
   ...
   private static void a(elk $$0, Matrix4f $$1, int $$2) {
      $$0.a($$1, 0.0F, 0.0F, 0.0F).a(255, 255, 255, $$2).e();
   }

   private static void a(elk $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, -m * $$3, $$2, -0.5F * $$3).a(255, 0, 255, 0).e();
   }

   private static void b(elk $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, m * $$3, $$2, -0.5F * $$3).a(255, 0, 255, 0).e();
   }

   private static void c(elk $$0, Matrix4f $$1, float $$2, float $$3) {
      $$0.a($$1, 0.0F, $$2, 1.0F * $$3).a(255, 0, 255, 0).e();
   }

   public static void a(float $$0, float $$1, float $$2, float $$3, int $$4, elg $$5, fnl $$6, int $$7) {
      ...
      for (int $$20 = 1; $$20 <= 8; $$20++) {
         ...
         $$10.a($$18, $$14 * 0.2F, $$15 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$16, $$11).c(fyc.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$14, $$15, $$9).a(255, 255, 255, 255).a($$16, $$12).c(fyc.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21, $$22, $$9).a(255, 255, 255, 255).a($$23, $$12).c(fyc.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21 * 0.2F, $$22 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$23, $$11).c(fyc.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$14 = $$21;
         $$15 = $$22;
         $$16 = $$23;
      }
   ...
   public static fht a() {
      ...
      $$3.a("jaw", fhs.c().a("jaw", -6.0F, 0.0F, -16.0F, 12, 4, 16, 176, 65), fhp.a(0.0F, 4.0F, -8.0F));
      $$1.a("neck", fhs.c().a("box", -5.0F, -5.0F, -5.0F, 10, 10, 10, 192, 104).a("scale", -1.0F, -9.0F, -3.0F, 2, 4, 6, 48, 0), fhp.a);
      $$1.a(
         "body",
         fhs.c()
         ...
         fhp.a(0.0F, 4.0F, 8.0F)
      );
      fhw $$4 = $$1.a(
         "left_wing", fhs.c().a().a("bone", 0.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).a("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), fhp.a(12.0F, 5.0F, 2.0F)
      );
      $$4.a(
         "left_wing_tip",
         fhs.c().a().a("bone", 0.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).a("skin", 0.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144),
         fhp.a(56.0F, 0.0F, 0.0F)
      );
      fhw $$5 = $$1.a("left_front_leg", fhs.c().a("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), fhp.a(12.0F, 20.0F, 2.0F));
      fhw $$6 = $$5.a("left_front_leg_tip", fhs.c().a("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), fhp.a(0.0F, 20.0F, -1.0F));
      $$6.a("left_front_foot", fhs.c().a("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), fhp.a(0.0F, 23.0F, 0.0F));
      fhw $$7 = $$1.a("left_hind_leg", fhs.c().a("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), fhp.a(16.0F, 16.0F, 42.0F));
      fhw $$8 = $$7.a("left_hind_leg_tip", fhs.c().a("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), fhp.a(0.0F, 32.0F, -4.0F));
      $$8.a("left_hind_foot", fhs.c().a("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), fhp.a(0.0F, 31.0F, 4.0F));
      fhw $$9 = $$1.a(
         "right_wing", fhs.c().a("bone", -56.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88).a("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 88), fhp.a(-12.0F, 5.0F, 2.0F)
      );
      $$9.a(
         "right_wing_tip",
         fhs.c().a("bone", -56.0F, -2.0F, -2.0F, 56, 4, 4, 112, 136).a("skin", -56.0F, 0.0F, 2.0F, 56, 0, 56, -56, 144),
         fhp.a(-56.0F, 0.0F, 0.0F)
      );
      fhw $$10 = $$1.a("right_front_leg", fhs.c().a("main", -4.0F, -4.0F, -4.0F, 8, 24, 8, 112, 104), fhp.a(-12.0F, 20.0F, 2.0F));
      fhw $$11 = $$10.a("right_front_leg_tip", fhs.c().a("main", -3.0F, -1.0F, -3.0F, 6, 24, 6, 226, 138), fhp.a(0.0F, 20.0F, -1.0F));
      $$11.a("right_front_foot", fhs.c().a("main", -4.0F, 0.0F, -12.0F, 8, 4, 16, 144, 104), fhp.a(0.0F, 23.0F, 0.0F));
      fhw $$12 = $$1.a("right_hind_leg", fhs.c().a("main", -8.0F, -4.0F, -8.0F, 16, 32, 16, 0, 0), fhp.a(-16.0F, 16.0F, 42.0F));
      fhw $$13 = $$12.a("right_hind_leg_tip", fhs.c().a("main", -6.0F, -2.0F, 0.0F, 12, 32, 12, 196, 0), fhp.a(0.0F, 32.0F, -4.0F));
      $$13.a("right_hind_foot", fhs.c().a("main", -9.0F, 0.0F, -20.0F, 18, 6, 24, 112, 0), fhp.a(0.0F, 31.0F, 4.0F));
      return fht.a($$0, 256, 256);
   }

   public static class a extends feo<bxa> {
      private final fhn a;
      private final fhn b;
      private final fhn f;
      private final fhn g;
      ...
      public void a(bxa $$0, float $$1, float $$2, float $$3) {
         this.y = $$0;
         this.z = $$3;
      }

      public void a(bxa $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      }
      ...
      private void a(elg $$0, elk $$1, int $$2, int $$3, float $$4, fhn $$5, fhn $$6, fhn $$7, fhn $$8, fhn $$9, fhn $$10, fhn $$11, float $$12) {
         $$9.e = 1.0F + $$4 * 0.1F;
         $$10.e = 0.5F + $$4 * 0.1F;
         $$11.e = 0.75F + $$4 * 0.1F;
         $$6.e = 1.3F + $$4 * 0.1F;
