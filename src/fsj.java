...
public class fsj {
   ...
   private static final fsl e = new fsj.a();
   private static final fsl f = new fsj.b(-1, true);
   private static final fsl g = new fsj.b(1, true);
   private static final fsl h = new fsj.b(1, false);
   ...
   public fsl a(int $$0) {
      ...
      if (this.p > 0 && $$0 == 0) {
         ...
         return $$1 >= 0 && $$1 < this.n.a().size() ? (fsl)MoreObjects.firstNonNull(this.n.a().get($$1), a) : a;
      }
   }

   public List<fsl> a() {
      List<fsl> $$0 = Lists.newArrayList();
