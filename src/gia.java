...
public class gia implements gig.a {
   ...
   private final fgi A;
   private final Map<jd, gia.a> B = new HashMap<>();
   private final Map<UUID, aae.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(aap.a $$0, long $$1) {
      this.B.put($$0.a(), new gia.a($$0, $$1));
   }
   ...
   private void a(fbc $$0, get $$1) {
      ...
      for (jd $$3 : this.B.keySet()) {
         if ($$2.a($$3, 30.0)) {
            a($$0, $$1, $$3);
         }
      }

      Map<jd, Set<UUID>> $$4 = this.d();
   ...
   private Map<jd, Set<UUID>> d() {
      Map<jd, Set<UUID>> $$0 = Maps.newHashMap();
      this.C.values().forEach($$1 -> $$1.j().forEach($$2 -> $$0.computeIfAbsent($$2, $$0xxx -> Sets.newHashSet()).add($$1.b())));
      return $$0;
   }

   private void b(fbc $$0, get $$1) {
      Map<jd, Set<UUID>> $$2 = Maps.newHashMap();
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(agd::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gig.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(agd::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(fbc $$0, get $$1, jd $$2) {
      float $$3 = 0.05F;
      gig.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fbc $$0, get $$1, jd $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gig.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fbc $$0, get $$1, aap.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(fbc $$0, get $$1, aae.a $$2) {
      if ($$2.e() != null) {
         gio.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(fbc $$0, get $$1, aae.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(fbc $$0, get $$1, String $$2, aap.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(fbc $$0, get $$1, String $$2, jd $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gig.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fbc $$0, get $$1, jw $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      jd $$9 = jd.a($$2);
      ...
      float $$13 = 0.5F;
      gig.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(aap.a $$0) {
      return this.a($$0.a()).stream().map(agd::a).collect(Collectors.toSet());
   }

   private String a(aae.a $$0, jd $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(aae.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(aae.a $$0) {
      cmv $$1 = this.A.s;
      jd $$2 = jd.a($$1.dv(), $$0.d().b(), $$1.dB());
      jd $$3 = jd.a((jw)$$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(jd $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(aae.a::b).collect(Collectors.toSet());
   }

   private Map<jd, List<String>> f() {
      Map<jd, List<String>> $$0 = Maps.newHashMap();

      for (aae.a $$1 : this.C.values()) {
   ...
   private void g() {
      gig.a(this.A.an(), 8).ifPresent($$0 -> this.D = $$0.cA());
   }

   static record a(aap.a a, long b) {
   }
}
