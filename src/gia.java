...
public class gia extends gjr {
   private final float a;
   private final gjm b;

   gia(gfj $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gjm $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements giu<lk> {
      ...
      public gir a(lk $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.l() && $$8.o() == dqu.a) {
            ...
            return new gia($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
