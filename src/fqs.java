...
public class fqs implements fqe<ded> {
   ...
   void a(gw $$0, dee $$1, elp $$2, foe $$3, int $$4, int $$5, int $$6, boolean $$7) {
      ...
      int $$8 = a($$1);
      int $$9 = 4 * $$5 / 2;
      ark[] $$10 = $$1.a(eqv.O().aQ(), $$1x -> {
         List<ark> $$2x = this.g.c($$1x, $$6);
         return $$2x.isEmpty() ? ark.a : $$2x.get(0);
      });
      int $$11;
      boolean $$12;
      int $$13;
   ...
   public static int a(dee $$0) {
      ...
      if ($$1 == cht.p.g() && $$0.a()) {
         ...
         double $$2 = 0.4;
         int $$3 = (int)((double)ari.b.b($$1) * 0.4);
         int $$4 = (int)((double)ari.b.c($$1) * 0.4);
         int $$5 = (int)((double)ari.b.d($$1) * 0.4);
         return ari.b.a(0, $$3, $$4, $$5);
      }
   }
