...
public class fqs {
   ...
   public static class b extends fsh {
      b(foe $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * aup.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends frt {
      private boolean b;
      private boolean F;
      private final frj G;
      private float H;
      ...
      c(foe $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, frj $$7, fsc $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fqs.c $$0 = new fqs.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements frk<ka> {
      ...
      public frh a(ka $$0, foe $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqs.c $$8 = new fqs.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, evr.O().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends frf {
      private int a;
      private final frj b;
      private su D;
      private boolean E;

      public e(foe $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, frj $$7, @Nullable so $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, aru.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            so $$7 = this.D.a($$6);
            cml.a $$8 = cml.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            frh $$17 = this.b.a(jx.L, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               ars $$19 = $$18 ? art.iD : art.iC;
               this.c.a(this.g, this.h, this.i, $$19, aru.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fqs.c $$10 = (fqs.c)this.b.a(jx.C, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = aup.d($$18, $$13, $$16) * $$0;
                  double $$20 = aup.d($$18, $$14, $$17) * $$0;
