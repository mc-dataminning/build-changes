public class fqs extends frn {
   private final fri a;

   fqs(fnk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fri $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cfb $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dt();
            if (this.h > $$1) {
   ...
   public static class a implements fqq<ka> {
      ...
      public fqn a(ka $$0, fnk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fqs($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fqq<ka> {
      ...
      public fqn a(ka $$0, fnk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqn $$8 = new fqs($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
