...
public class dty {
   ...
   private final List<dtw> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dty.a l = new dty.d(5.999997E7F);
   public static final dty.c d = new dty.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public ja b(double $$0, double $$1, double $$2) {
      return ja.a(aye.a($$0, this.e(), this.g()), $$1, aye.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bsd $$0, evu $$1) {
      double $$2 = Math.max(aye.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dty.a)($$0 == $$1 ? new dty.d($$1) : new dty.b($$0, $$1, $$2));
   ...
   class b implements dty.a {
      ...
      @Override
      public double a() {
         return aye.a(dty.this.a() - this.e() / 2.0, (double)(-dty.this.k), (double)dty.this.k);
      }

      @Override
      public double c() {
         return aye.a(dty.this.b() - this.e() / 2.0, (double)(-dty.this.k), (double)dty.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? aye.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dtx i() {
         return this.c < this.b ? dtx.b : dtx.a;
      }
      ...
      @Override
      public dty.a l() {
         return (dty.a)(this.g() <= 0L ? dty.this.new d(this.c) : this);
      }
      ...
      public ews m() {
         return ewp.a(
            ewp.c,
            ewp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewd.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dty.c a(DynamicLike<?> $$0, dty.c $$1) {
         double $$2 = aye.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = aye.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dty.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dty.a {
      ...
      private void n() {
         this.c = aye.a(dty.this.a() - this.b / 2.0, (double)(-dty.this.k), (double)dty.this.k);
         this.d = aye.a(dty.this.b() - this.b / 2.0, (double)(-dty.this.k), (double)dty.this.k);
         this.e = aye.a(dty.this.a() + this.b / 2.0, (double)(-dty.this.k), (double)dty.this.k);
         this.f = aye.a(dty.this.b() + this.b / 2.0, (double)(-dty.this.k), (double)dty.this.k);
         this.g = ewp.a(
            ewp.c,
            ewp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewd.e
