...
public class ekl extends ejy<elv> {
   public ekl(Codec<elv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eka<elv> $$0) {
      iv $$1 = $$0.e();
      dkl $$2 = $$0.b();
   ...
   private void a(azv $$0, djn $$1, int $$2, int $$3, iv $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iv $$2, djn $$3, boolean $$4, double $$5, iv $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(djn $$0, iv $$1) {
      if ($$0.a_($$1.d()).a(dmt.ed)) {
         this.a($$0, $$1.d(), dmt.a.m());
      }
   }

   private void a(djn $$0, azv $$1, iv $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, eat $$13) {
   ...
   private void a(iv $$0, djn $$1, azv $$2, int $$3, int $$4, boolean $$5, boolean $$6, eat $$7) {
      eat $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dmt.ef) || $$8.a(dmt.ee) || $$8.a(dmt.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dmt.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dmt.ef.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(eat $$0) {
      return $$0.a(dmt.je) || $$0.a(dmt.ef) || $$0.a(dmt.nC);
   }
   ...
   private void a(djn $$0, iv $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dmt.ed)) {
                  if (this.a((diq)$$0, $$10)) {
                     this.a($$0, $$10, dmt.a.m());
                     this.a($$0, $$10.d(), dmt.a.m());
                  } else if (c($$11)) {
                     eat[] $$12 = new eat[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
