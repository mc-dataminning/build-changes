...
public class gsz implements gtf.a {
   ...
   private final fof F;
   private final Map<iu, gsz.a> G = Maps.newHashMap();
   private final Map<UUID, aad.a> H = Maps.newHashMap();
   @Nullable
   private UUID I;
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bwa $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dQ();
      });
   }

   private void b(fiq $$0, gpd $$1, double $$2, double $$3, double $$4) {
      iu $$5 = iu.a($$2, $$3, $$4);
   ...
   private void a(fiq $$0, gpd $$1, gsz.a $$2) {
      int $$3 = 0;
   ...
   private void a(fiq $$0, gpd $$1, aad.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gto.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fiq $$0, gpd $$1, aad.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fiq $$0, gpd $$1, String $$2, gsz.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gsz.a $$0) {
      return this.b($$0.a).stream().map(agj::a).collect(Collectors.toSet());
   }

   private Set<String> c(gsz.a $$0) {
      return this.c($$0.a).stream().map(agj::a).collect(Collectors.toSet());
   }

   private boolean b(aad.a $$0) {
      return Objects.equals(this.I, $$0.a());
   }

   private boolean c(aad.a $$0) {
      cqs $$1 = this.F.t;
   ...
   private Collection<UUID> b(iu $$0) {
      return this.H.values().stream().filter($$1 -> $$1.a($$0)).map(aad.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(iu $$0) {
      return this.H.values().stream().filter($$1 -> $$1.b($$0)).map(aad.a::a).collect(Collectors.toSet());
   }

   private Map<iu, List<String>> c() {
      Map<iu, List<String>> $$0 = Maps.newHashMap();

      for (aad.a $$1 : this.H.values()) {
   ...
   private void d() {
      gtf.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
