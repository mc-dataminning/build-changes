...
public class buv extends buh implements bjf {
   protected static final adz<Byte> c = aec.a(buv.class, aeb.a);
   ...
   public buv(bim<? extends buv> $$0, cpl $$1) {
      super($$0, $$1);
      this.t(1.0F);
   }
   ...
   @Override
   protected void w() {
      this.bO.a(1, new bqd(this, 1.0, true));
      this.bO.a(2, new bqi(this, 0.9, 32.0F));
      this.bO.a(2, new bqe(this, 0.6, false));
      this.bO.a(4, new bpv(this, 0.6));
      this.bO.a(5, new bqk(this));
      ...
      this.bP.a(3, new brm<>(this, bja.class, 5, false, false, $$0 -> $$0 instanceof bys && !($$0 instanceof bym)));
   ...
   public static bkd.a p() {
      return bja.x().a(bke.a, 100.0).a(bke.d, 0.25).a(bke.c, 1.0).a(bke.f, 15.0);
   }
   ...
   protected void D(bii $$0) {
      if ($$0 instanceof bys && !($$0 instanceof bym) && this.ee().a(20) == 0) {
         this.h((biy)$$0);
      }
   ...
   public boolean C(bii $$0) {
      ...
      if ($$3) {
         double $$5 = $$0 instanceof biy $$4 ? $$4.b(bke.c) : 0.0;
   ...
   public buv.a q() {
      return buv.a.a(this.et() / this.eK());
   }
   ...
   public boolean a(cpo $$0) {
      ...
      if (!$$3.a($$0, $$2, this)) {
         ...
         for (int $$4 = 1; $$4 < 3; $$4++) {
            gu $$5 = $$1.b($$4);
            dez $$6 = $$0.a_($$5);
            if (!cpw.a($$0, $$5, $$6, $$6.u(), bim.ac)) {
               return false;
            }
         }

         return cpw.a($$0, $$1, $$0.a_($$1), ead.a.g(), bim.ac) && $$0.f(this);
      }
   }

   @Override
   public ehd cI() {
      return new ehd(0.0, (double)(0.875F * this.cH()), (double)(this.df() * 0.4F));
   }
   ...
   public static enum a {
      ...
      private static final List<buv.a> e = Stream.of(values())
