...
public interface akt {
   static <T> void a(int $$0, int $$1, dar<?> $$2, Iterable<T> $$3, akt.a<T> $$4) {
      int $$5 = $$0;
      int $$6 = $$1;
      if ($$2.b() instanceof dax $$8) {
         $$5 = $$8.j();
         $$6 = $$8.k();
      }
      ...
      for (int $$11 = 0; $$11 < $$1; $$11++) {
         ...
         int $$13 = azk.d((float)$$1 / 2.0F - (float)$$6 / 2.0F);
         if ($$12 && $$13 > $$11) {
            $$10 += $$0;
            $$11++;
         }
         ...
         for (int $$14 = 0; $$14 < $$0; $$14++) {
            ...
            $$13 = azk.d((float)$$0 / 2.0F - (float)$$5 / 2.0F);
            int $$15 = $$5;
            boolean $$16 = $$14 < $$5;
            if ($$12) {
               $$15 = $$13 + $$5;
