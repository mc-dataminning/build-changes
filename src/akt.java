...
public class akt extends IOException {
   private final List<akt.a> a = Lists.newArrayList();
   private final String b;

   public akt(String $$0) {
      this.a.add(new akt.a());
      this.b = $$0;
   }

   public akt(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new akt.a());
      this.b = $$0;
   }
   ...
   public static akt a(Exception $$0) {
      if ($$0 instanceof akt) {
         return (akt)$$0;
      } else {
