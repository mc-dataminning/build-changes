...
public class fmr extends fmj<coi> implements fom {
   private float D;
   private float E;
   private final fog F = new fog();
   private boolean G;
   private boolean H;

   public fmr(ckl $$0) {
      super($$0.cb, $$0.ga(), ws.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void C() {
      if (this.m.q.f()) {
         this.m.a(new fmg(this.m.s, this.m.s.h.y(), this.m.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         ...
         this.c(new ffg(this.z + 104, this.o / 2 - 22, 20, 18, fog.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.n, this.c);
   ...
   public static void a(feh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bre $$9) {
      ...
      $$9.bc = $$9.dD();
      float $$21 = $$9.ec();
      Vector3f $$22 = new Vector3f(0.0F, $$9.di() / 2.0F + $$6 * $$21, 0.0F);
      float $$23 = (float)$$5 / $$21;
   ...
   public static void a(feh $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bre $$7) {
      $$0.c().a();
