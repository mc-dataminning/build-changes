...
public class fmr extends fmz {
   ...
   private static final IntSupplier f = () -> ffh.Q().m.a().c() ? e : d;
   ...
   public fmr(ffh $$0, aul $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fgt $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gdy.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gdy.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, ffh.a);
         $$10 = 1.0F;
      }
   ...
   private void a(fgt $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends gou {
      ...
      protected gou.a b(aup $$0) {
         atf $$1 = ffh.Q().ad();
         auh<InputStream> $$2 = $$1.a(atd.a, fmr.c);
         if ($$2 == null) {
            return new gou.a(new FileNotFoundException(fmr.c.toString()));
         } else {
            try {
               gou.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gou.a(new gqy(true, true), ezb.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gou.a(var9);
            }
         }
      }
   }
