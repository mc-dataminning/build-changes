...
public class fmr extends fmu {
   fmr(fix $$0, fmp $$1, double $$2, double $$3, double $$4) {
      super($$0, $$2, $$3 - 0.125, $$4);
      this.b(0.01F, 0.01F);
      this.a($$1);
   ...
   fmr(fix $$0, fmp $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
   ...
   public static class a implements flx<ja> {
      ...
      public flu a(ja $$0, fix $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         fmr $$12 = new fmr($$1, this.a, $$2, $$3, $$4, $$9, $$10, $$11);
         $$12.a(0.9F, 0.4F, 0.5F);
         return $$12;
      }
   }
   ...
   public static class b implements flx<ja> {
      ...
      public flu a(ja $$0, fix $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fmr $$8 = new fmr($$1, this.a, $$2, $$3, $$4, 0.0, -0.8F, 0.0) {
            @Override
            public Optional<iu> o() {
               return Optional.of(iu.a);
            }
         };
         $$8.t = arx.b($$1.z, 500, 1000);
         $$8.u = 0.01F;
   ...
   public static class d implements flx<ja> {
      ...
      public flu a(ja $$0, fix $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         fmr $$9 = new fmr($$1, this.a, $$2, $$3, $$4, 0.0, $$8, 0.0);
         $$9.a(0.1F, 0.1F, 0.3F);
         $$9.b(0.001F, 0.001F);
         return $$9;
      }
