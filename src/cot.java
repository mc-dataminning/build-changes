...
public class cot {
   ...
   public static final cot b = new cot(0, 0);
   ...
   public static cot a(int $$0, int $$1) {
      return new cot($$0 << 5, $$1 << 5);
   }

   public static cot b(int $$0, int $$1) {
      return new cot(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cot $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public static Stream<cot> a(cot $$0, int $$1) {
      return a(new cot($$0.e - $$1, $$0.f - $$1), new cot($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cot> a(final cot $$0, final cot $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cot>((long)($$2 * $$3), 64) {
         @Nullable
         private cot e;

         @Override
         public boolean tryAdvance(Consumer<? super cot> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cot($$0.e, $$2 + $$5);
               } else {
                  this.e = new cot($$1 + $$4, $$2);
               }
            }
