...
public abstract class cot {
   ...
   private final jg<cto> l = jg.a();
   public final jg<cqo> i = jg.a();
   private final List<cpl> m = Lists.newArrayList();
   private cto n = cto.i;
   private final jg<cto> o = jg.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cqo> v = Sets.newHashSet();
   private final List<cpf> w = Lists.newArrayList();
   @Nullable
   private cpg x;
   private boolean y;

   protected cot(@Nullable cqa<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cpe $$0, clw $$1, ddy $$2) {
   ...
   protected static void a(bpn $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cpd $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cto $$1 = this.i.get($$0).g();
         Supplier<cto> $$2 = Suppliers.memoize($$1::s);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cto $$1, Supplier<cto> $$2) {
      cto $$3 = this.l.get($$0);
      if (!cto.a($$3, $$1)) {
         cto $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cto $$1, Supplier<cto> $$2) {
      if (!this.y) {
         cto $$3 = this.o.get($$0);
         if (!cto.a($$3, $$1)) {
            cto $$4 = $$2.get();
   ...
   public abstract cto a(clw var1, int var2);

   public void a(int $$0, int $$1, cpc $$2, clw $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cpc $$2, clw $$3) {
      clv $$4 = $$3.gc();
      if ($$2 == cpc.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cpc.a || $$2 == cpc.b) && ($$1 == 0 || $$1 == 1)) {
         cpb $$16 = $$1 == 0 ? cpb.a : cpb.b;
         if ($$0 == -999) {
            if (!this.g().e()) {
               if ($$16 == cpb.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.e()) {
                  if (!$$21.e()) {
                     int $$22 = $$16 == cpb.a ? $$21.I() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.e()) {
                     int $$23 = $$16 == cpb.a ? $$20.I() : ($$20.I() + 1) / 2;
                     Optional<cto> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cto> $$26 = $$19.a($$20.I(), $$21.j() - $$21.I(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.I());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cpc.d && $$3.fP() && this.g().e() && $$0 >= 0) {
         cqo $$32 = this.i.get($$0);
         if ($$32.h()) {
            cto $$33 = $$32.g();
            this.b($$33.c($$33.j()));
         }
      } else if ($$2 == cpc.e && this.g().e() && $$0 >= 0) {
         cqo $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().I();
         cto $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cpc.g && $$0 >= 0) {
         cqo $$37 = this.i.get($$0);
         cto $$38 = this.g();
         if (!$$38.e() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.I() < $$38.j(); $$42 += $$40) {
                  cqo $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cto $$44 = $$43.g();
                     if ($$41 != 0 || $$44.I() != $$44.j()) {
                        cto $$45 = $$43.b($$44.I(), $$38.j() - $$38.I(), $$3);
                        $$38.g($$45.I());
                     }
                  }
               }
   ...
   private boolean a(clw $$0, cpb $$1, cqo $$2, cto $$3, cto $$4) {
      coj $$5 = $$0.dP().J();
   ...
   public void a(int $$0, int $$1, cto $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cto> $$1, cto $$2) {
   ...
   public abstract boolean a(clw var1);

   protected boolean a(cto $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, clw $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cqo $$0, cto $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cto.c($$1, $$0.g()) ? $$0.g().I() + ($$2 ? 0 : $$1.I()) <= $$1.j() : $$3;
   }

   public static int a(Set<cqo> $$0, int $$1, cto $$2) {
      return switch ($$1) {
         case 0 -> ayd.d((float)$$2.I() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.j();
         default -> $$2.I();
      };
   ...
   public static int a(@Nullable dog $$0) {
      return $$0 instanceof bpn ? b((bpn)$$0) : 0;
   }

   public static int b(@Nullable bpn $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cot $$0) {
      Table<bpn, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bpn $$0, int $$1) {
