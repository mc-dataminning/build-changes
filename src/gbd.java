...
public class gbd extends gai {
   public static final float c = 4.5F;
   private static final Vector3f d = new Vector3f(1.0F, 1.0F, 1.0F);
   private static final int s = 16;
   private static final int u = 16;
   private final alr v = alr.b("textures/gui/hanging_signs/" + this.b.b() + ".png");

   public gbd(eac $$0, boolean $$1, boolean $$2) {
      super($$0, $$1, $$2, xg.c("hanging_sign.edit"));
   }
   ...
   protected void c(ftk $$0) {
      ...
      $$0.a(gry::H, this.v, -8, -8, 0.0F, 0.0F, 16, 16, 16, 16);
   }
