...
public class akz {
   ...
   private static int a(ds $$0, Collection<ana> $$1, @Nullable arn $$2, @Nullable ahd $$3) {
      acr $$4 = new acr($$3, $$2);
      ...
      if ($$2 != null) {
         if ($$3 != null) {
            $$0.a(() -> vd.a("commands.stopsound.success.source.sound", vd.a($$3), $$2.a()), true);
         } else {
            $$0.a(() -> vd.a("commands.stopsound.success.source.any", $$2.a()), true);
         }
      } else if ($$3 != null) {
         $$0.a(() -> vd.a("commands.stopsound.success.sourceless.sound", vd.a($$3)), true);
      } else {
         $$0.a(() -> vd.c("commands.stopsound.success.sourceless.any"), true);
      }
