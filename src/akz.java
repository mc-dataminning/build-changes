...
public final class akz<E> implements Codec<jn<E>> {
   private final alb<? extends ka<E>> a;

   public static <E> akz<E> a(alb<? extends ka<E>> $$0) {
      return new akz<>($$0);
   }

   private akz(alb<? extends ka<E>> $$0) {
      this.a = $$0;
   }
