...
public class esa {
   ...
   private final esa.a g;

   @Deprecated
   public static esa a(azg $$0, esa.a $$1) {
      return new esa($$0, $$1, false);
   }

   public static esa a(azg $$0, int $$1, double... $$2) {
      return b($$0, new esa.a($$1, new DoubleArrayList($$2)));
   }

   public static esa b(azg $$0, esa.a $$1) {
      return new esa($$0, $$1, true);
   }

   private esa(azg $$0, esa.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<esa.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(esa.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(esa.a::b))
               .apply($$0, esa.a::new)
      );
      public static final Codec<jr<esa.a>> b = akq.a(mc.aS, a);
