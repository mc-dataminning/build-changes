public abstract class esa extends ese implements eti, eua {
   ...
   public esa(int $$0, int $$1, int $$2, int $$3, tf $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int w() {
      return arp.a((int)((float)(this.g * this.g) / (float)this.x()), 32, this.g);
   }
   ...
   protected void a(erv $$0, int $$1, int $$2, int $$3, int $$4) {
      aer $$5 = a.a(this.ax_(), this.aw_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(erv var1, int var2, int var3, float var4);
}
