...
public class fzw {
   ...
   final List<auh> b;
   final List<auh> c;
   final Function<auh, ald> d;
   final Runnable e;
   private final Consumer<auk> f;

   public fzw(Runnable $$0, Function<auh, ald> $$1, auk $$2, Consumer<auk> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fzw.a> a() {
      return this.c.stream().map($$0 -> new fzw.d($$0));
   }

   public Stream<fzw.a> b() {
      return this.b.stream().map($$0 -> new fzw.c($$0));
   }
   ...
   abstract class b implements fzw.a {
      private final auh b;
      ...
      @Override
      public ald a() {
         return fzw.this.d.apply(this.b);
      }
