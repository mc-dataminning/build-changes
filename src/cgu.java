public abstract class cgu extends cia implements cha {
   private static final ajy<Boolean> a = akc.a(cgu.class, aka.k);

   public cgu(bus<? extends cgu> $$0, dgi $$1) {
      super($$0, $$1);
      this.bP = new cgu.a(this);
   }

   public static bwo.a m() {
      return bvj.F().a(bwp.s, 3.0);
   }
   ...
   protected void E() {
      ...
      this.bS.a(2, new cbm<>(this, cox.class, 8.0F, 1.6, 1.4, buq.f::test));
