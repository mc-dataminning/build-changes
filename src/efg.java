...
public class efg extends eel<egx> {
   ...
   protected boolean a(
      dfy $$0, azs $$1, egx $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dvj $$0, Function<jh, dvj> $$1, azs $$2, egx $$3, egx.a $$4, jh.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
