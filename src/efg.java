...
public record efg(efg.a a, byte b, byte c, byte d, @Nullable vb e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements aut {
      ...
      A("red_x", true, false),
      B("village_desert", true, eed.w.ak, false, true),
      C("village_plains", true, eed.w.ak, false, true),
      D("village_savanna", true, eed.w.ak, false, true),
      E("village_snowy", true, eed.w.ak, false, true),
      F("village_taiga", true, eed.w.ak, false, true),
      G("jungle_temple", true, eed.w.ak, false, true),
      H("swamp_hut", true, eed.w.ak, false, true);

      public static final Codec<efg.a> I = aut.a(efg.a::values);
      ...
      public static efg.a a(byte $$0) {
         return values()[aty.a($$0, 0, values().length - 1)];
      }
