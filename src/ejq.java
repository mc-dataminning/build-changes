...
public class ejq extends ejt {
   ...
   static final ejq.b l = new ejq.b(854, 480);

   public ejq(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ejq.a[] e = values();
   ...
   static class b {
      ...
      static List<ejq.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ejq.b($$0, $$1), ejq.l) : ImmutableList.of(ejq.l);
      }
