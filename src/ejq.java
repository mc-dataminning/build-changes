...
public class ejq implements eja {
   public static final Codec<ejq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eno.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               elb.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               elb.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               eex.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, ejq::new)
   );
   ...
   public ejq(jq<eno> $$0, int $$1, int $$2, ayk<dkm> $$3, elb $$4, int $$5, int $$6, int $$7, int $$8, elb $$9, int $$10, int $$11, eex $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
