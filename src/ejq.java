...
public class ejq {
   private final List<ConcurrentLinkedQueue<ejp>> a = ImmutableList.of(
   ...
   public void a(ejp $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ejp> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ejp> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ejp> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ejp> j() {
