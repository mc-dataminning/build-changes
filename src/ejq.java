...
public class ejq extends ejx {
   private static final Codec<brs> b = brs.a
      .codec()
      .validate(
         $$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final MapCodec<ejq> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  brm.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  brm.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  brm.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  brm.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, ejq::new)
   );
   ...
   public ejq(int $$0, int $$1, int $$2, brm $$3, brm $$4, brs $$5, brm $$6) {
      super($$0, $$1, $$2);
      this.h = $$3;
      this.i = $$4;
      this.j = $$5;
      this.k = brs.a($$5.a(), $$5.b() - 1);
      this.l = $$6;
   }
   ...
   public List<eif.a> a(dfl $$0, BiConsumer<jh, dvo> $$1, azv $$2, int $$3, jh $$4, ehp $$5) {
      ...
      List<eif.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new eif.a($$4.b($$11), 0, false));
      }

      jh.a $$16 = new jh.a();
      jm $$17 = jm.c.a.a($$2);
      Function<dvo, dvo> $$18 = $$1x -> $$1x.c(dov.i, $$17.o());
   ...
   private eif.a a(dfl $$0, BiConsumer<jh, dvo> $$1, azv $$2, int $$3, jh $$4, ehp $$5, Function<dvo, dvo> $$6, jm $$7, int $$8, boolean $$9, jh.a $$10) {
      $$10.g($$4).c(jm.b, $$8);
