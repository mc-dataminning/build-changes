...
public class efr {
   private static final Codec<efp> t = jd.I.q().dispatch("condition", efp::b, efq::a);
   public static final Codec<efp> a = arg.a((Supplier<Codec<efp>>)(() -> arg.e(t, efd.b)));
   ...
   private static efq a(String $$0, Codec<? extends efp> $$1) {
      return ht.a(jd.I, new aex($$0), new efq($$1));
   }
