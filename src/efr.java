...
public class efr extends efu<efq> {
   public efr(Codec<efq> $$0) {
      super($$0);
   }

   public boolean a(efq $$0, azh $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(efp $$0, efq $$1, dzm $$2, Function<ji, jr<dic>> $$3, azh $$4, eda $$5, dgg $$6, dzl $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         efu.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      efp $$0, efq $$1, dzm $$2, Function<ji, jr<dic>> $$3, eda $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dzl $$10, efu.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayz.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayz.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayz.b($$13);
         $$6 += (double)(ayz.b($$12) * $$27);
         $$7 += (double)ayz.a($$13);
         $$8 += (double)(ayz.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
