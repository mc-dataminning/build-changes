...
public class efr extends efu {
   public static final MapCodec<efr> a = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(efr::new, $$0 -> $$0.d);
   ...
   public void a(efu.a $$0) {
      ...
      if (!($$1.i() >= this.d)) {
         ...
         if (!$$5.isEmpty()) {
            ...
            if (!$$6.isEmpty()) {
               $$0.a($$6.get(), dfb.pe.o().a(det.b, b));
               $$0.a().a($$6.get(), dpj.H).ifPresent($$1x -> {
                  int $$2x = 2 + $$1.a(2);

                  for (int $$3x = 0; $$3x < $$2x; $$3x++) {
                     $$1x.a(dpe.c.a($$1.a(599)));
                  }
               });
            }
         }
