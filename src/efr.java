...
public record efr(efr.a a, byte b, byte c, byte d, @Nullable vd e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements ave {
      ...
      A("red_x", true, false),
      B("village_desert", true, eeo.w.ak, false, true),
      C("village_plains", true, eeo.w.ak, false, true),
      D("village_savanna", true, eeo.w.ak, false, true),
      E("village_snowy", true, eeo.w.ak, false, true),
      F("village_taiga", true, eeo.w.ak, false, true),
      G("jungle_temple", true, eeo.w.ak, false, true),
      H("swamp_hut", true, eeo.w.ak, false, true);

      public static final Codec<efr.a> I = ave.a(efr.a::values);
      ...
      public static efr.a a(byte $$0) {
         return values()[aui.a($$0, 0, values().length - 1)];
      }
