...
public class eqe implements eas.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eqe> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azc<eqe> a = azc.a(f);
   private final eqi g;
   private final eqi h;
   private final eqi i;
   ...
   public static eqe a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eqe(new eca(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eqe(eqi $$0, eqi $$1, eqi $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eqe(azr $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eqi.a($$0, IntStream.rangeClosed(-15, 0)),
         eqi.a($$0, IntStream.rangeClosed(-15, 0)),
         eqi.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eqe a(azr $$0) {
      return new eqe($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(eas.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eqf $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eqi.b($$4 * $$13), eqi.b($$5 * $$13), eqi.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eqi.b($$1 * $$13);
         double $$21 = eqi.b($$2 * $$13);
         double $$22 = eqi.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eqf $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return azj.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
