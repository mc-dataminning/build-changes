...
public class eqe extends eqj {
   public static final MapCodec<eqe> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, eqe::new));
   ...
   public List<eon.a> a(dkp $$0, BiConsumer<iw, ebq> $$1, bai $$2, int $$3, iw $$4, enx $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azz.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azz.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eqe.a> $$13 = Lists.newArrayList();
      $$13.add(new eqe.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iw $$21 = $$4.b(azz.a($$19), $$12 - 1, azz.a($$20));
               iw $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  iw $$27 = new iw($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new eqe.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<eon.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dkp $$0, BiConsumer<iw, ebq> $$1, bai $$2, iw $$3, iw $$4, boolean $$5, enx $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         iw $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iw $$13 = $$3.b(azz.d(0.5F + (float)$$12 * $$9), azz.d(0.5F + (float)$$12 * $$10), azz.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(duh.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dkp $$0, BiConsumer<iw, ebq> $$1, bai $$2, int $$3, iw $$4, List<eqe.a> $$5, enx $$6) {
      for (eqe.a $$7 : $$5) {
         int $$8 = $$7.a();
         iw $$9 = new iw($$4.u(), $$8, $$4.w());
