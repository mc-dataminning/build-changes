...
public class eqe implements AutoCloseable {
   ...
   private eqg a(epw.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(epw.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, ftv $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, ftv $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == eqg.b.a || this.i == eqg.b.b)) {
