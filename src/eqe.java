...
public class eqe {
   private final ImmutableList<eqf> a;
   private final ImmutableMap<String, eqf> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private eqc e;

   public eqe(ImmutableMap<String, eqf> $$0) {
      this.b = $$0;
