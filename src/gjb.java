...
public class gjb {
   ...
   static final jl[] c = jl.values();
   private final fkc d;
   private static final int e = 100;
   static final ThreadLocal<gjb.d> f = ThreadLocal.withInitial(gjb.d::new);

   public gjb(fkc $$0) {
      this.d = $$0;
   }

   public void a(ddx $$0, gzu $$1, dvd $$2, jg $$3, fdt $$4, fdx $$5, boolean $$6, azr $$7, long $$8, int $$9) {
      boolean $$10 = fja.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(ddx $$0, gzu $$1, dvd $$2, jg $$3, fdt $$4, fdx $$5, boolean $$6, azr $$7, long $$8, int $$9) {
      ...
      for (jl $$14 : c) {
         $$7.b($$8);
         List<gjd> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dhy.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gjd> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(ddx $$0, gzu $$1, dvd $$2, jg $$3, fdt $$4, fdx $$5, boolean $$6, azr $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jg.a $$11 = $$3.k();

      for (jl $$12 : c) {
         $$7.b($$8);
         List<gjd> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dhy.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = ghs.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gjd> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(ddx $$0, dvd $$1, jg $$2, fdt $$3, fdx $$4, List<gjd> $$5, float[] $$6, BitSet $$7, gjb.b $$8, int $$9) {
      for (gjd $$10 : $$5) {
   ...
   private void a(
      ddx $$0, dvd $$1, jg $$2, fdx $$3, fdt.a $$4, gjd $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(ddx $$0, dvd $$1, jg $$2, int[] $$3, jl $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(ddx $$0, dvd $$1, jg $$2, int $$3, int $$4, boolean $$5, fdt $$6, fdx $$7, List<gjd> $$8, BitSet $$9) {
      for (gjd $$10 : $$8) {
         if ($$5) {
            this.a($$0, $$1, $$2, $$10.b(), $$10.e(), null, $$9);
            jg $$11 = $$9.get(0) ? $$2.a($$10.e()) : $$2;
            $$3 = ghs.a($$0, $$1, $$11);
         }
   ...
   public void a(fdt.a $$0, fdx $$1, @Nullable dvd $$2, gzu $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azr $$9 = azr.a();
      long $$10 = 42L;
   ...
   private static void a(fdt.a $$0, fdx $$1, float $$2, float $$3, float $$4, List<gjd> $$5, int $$6, int $$7) {
      for (gjd $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = azj.a($$2, 0.0F, 1.0F);
            $$10 = azj.a($$3, 0.0F, 1.0F);
            $$11 = azj.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         new jl[]{jl.e, jl.f, jl.c, jl.d},
         0.5F,
         true,
         new gjb.e[]{gjb.e.k, gjb.e.d, gjb.e.k, gjb.e.j, gjb.e.e, gjb.e.j, gjb.e.e, gjb.e.d},
         new gjb.e[]{gjb.e.k, gjb.e.c, gjb.e.k, gjb.e.i, gjb.e.e, gjb.e.i, gjb.e.e, gjb.e.c},
         new gjb.e[]{gjb.e.l, gjb.e.c, gjb.e.l, gjb.e.i, gjb.e.f, gjb.e.i, gjb.e.f, gjb.e.c},
         new gjb.e[]{gjb.e.l, gjb.e.d, gjb.e.l, gjb.e.j, gjb.e.f, gjb.e.j, gjb.e.f, gjb.e.d}
      ),
      b(
         new jl[]{jl.f, jl.e, jl.c, jl.d},
         1.0F,
         true,
         new gjb.e[]{gjb.e.f, gjb.e.d, gjb.e.f, gjb.e.j, gjb.e.l, gjb.e.j, gjb.e.l, gjb.e.d},
         new gjb.e[]{gjb.e.f, gjb.e.c, gjb.e.f, gjb.e.i, gjb.e.l, gjb.e.i, gjb.e.l, gjb.e.c},
         new gjb.e[]{gjb.e.e, gjb.e.c, gjb.e.e, gjb.e.i, gjb.e.k, gjb.e.i, gjb.e.k, gjb.e.c},
         new gjb.e[]{gjb.e.e, gjb.e.d, gjb.e.e, gjb.e.j, gjb.e.k, gjb.e.j, gjb.e.k, gjb.e.d}
      ),
      c(
         new jl[]{jl.b, jl.a, jl.f, jl.e},
         0.8F,
         true,
         new gjb.e[]{gjb.e.b, gjb.e.k, gjb.e.b, gjb.e.e, gjb.e.h, gjb.e.e, gjb.e.h, gjb.e.k},
         new gjb.e[]{gjb.e.b, gjb.e.l, gjb.e.b, gjb.e.f, gjb.e.h, gjb.e.f, gjb.e.h, gjb.e.l},
         new gjb.e[]{gjb.e.a, gjb.e.l, gjb.e.a, gjb.e.f, gjb.e.g, gjb.e.f, gjb.e.g, gjb.e.l},
         new gjb.e[]{gjb.e.a, gjb.e.k, gjb.e.a, gjb.e.e, gjb.e.g, gjb.e.e, gjb.e.g, gjb.e.k}
      ),
      d(
         new jl[]{jl.e, jl.f, jl.a, jl.b},
         0.8F,
         true,
         new gjb.e[]{gjb.e.b, gjb.e.k, gjb.e.h, gjb.e.k, gjb.e.h, gjb.e.e, gjb.e.b, gjb.e.e},
         new gjb.e[]{gjb.e.a, gjb.e.k, gjb.e.g, gjb.e.k, gjb.e.g, gjb.e.e, gjb.e.a, gjb.e.e},
         new gjb.e[]{gjb.e.a, gjb.e.l, gjb.e.g, gjb.e.l, gjb.e.g, gjb.e.f, gjb.e.a, gjb.e.f},
         new gjb.e[]{gjb.e.b, gjb.e.l, gjb.e.h, gjb.e.l, gjb.e.h, gjb.e.f, gjb.e.b, gjb.e.f}
      ),
      e(
         new jl[]{jl.b, jl.a, jl.c, jl.d},
         0.6F,
         true,
         new gjb.e[]{gjb.e.b, gjb.e.d, gjb.e.b, gjb.e.j, gjb.e.h, gjb.e.j, gjb.e.h, gjb.e.d},
         new gjb.e[]{gjb.e.b, gjb.e.c, gjb.e.b, gjb.e.i, gjb.e.h, gjb.e.i, gjb.e.h, gjb.e.c},
         new gjb.e[]{gjb.e.a, gjb.e.c, gjb.e.a, gjb.e.i, gjb.e.g, gjb.e.i, gjb.e.g, gjb.e.c},
         new gjb.e[]{gjb.e.a, gjb.e.d, gjb.e.a, gjb.e.j, gjb.e.g, gjb.e.j, gjb.e.g, gjb.e.d}
      ),
      f(
         new jl[]{jl.a, jl.b, jl.c, jl.d},
         0.6F,
         true,
         new gjb.e[]{gjb.e.g, gjb.e.d, gjb.e.g, gjb.e.j, gjb.e.a, gjb.e.j, gjb.e.a, gjb.e.d},
         new gjb.e[]{gjb.e.g, gjb.e.c, gjb.e.g, gjb.e.i, gjb.e.a, gjb.e.i, gjb.e.a, gjb.e.c},
         new gjb.e[]{gjb.e.h, gjb.e.c, gjb.e.h, gjb.e.i, gjb.e.b, gjb.e.i, gjb.e.b, gjb.e.c},
         new gjb.e[]{gjb.e.h, gjb.e.d, gjb.e.h, gjb.e.j, gjb.e.b, gjb.e.j, gjb.e.b, gjb.e.d}
      );
      ...
      final gjb.e[] k;
      final gjb.e[] l;
      private static final gjb.a[] m = ad.a(new gjb.a[6], $$0 -> {
         $$0[jl.a.d()] = a;
         $$0[jl.b.d()] = b;
         $$0[jl.c.d()] = c;
         $$0[jl.d.d()] = d;
      ...
      private a(final jl[] $$0, final float $$1, final boolean $$2, final gjb.e[] $$3, final gjb.e[] $$4, final gjb.e[] $$5, final gjb.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(ddx $$0, dvd $$1, jg $$2, jl $$3, float[] $$4, BitSet $$5, boolean $$6) {
         jg $$7 = $$5.get(0) ? $$2.a($$3) : $$2;
         gjb.a $$8 = gjb.a.a($$3);
         jg.a $$9 = new jg.a();
         gjb.d $$10 = gjb.f.get();
         $$9.a($$7, $$8.g[0]);
         ...
         dvd $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dvd $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dvd $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dvd $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gjb.c[] k = ad.a(new gjb.c[6], $$0 -> {
         $$0[jl.a.d()] = a;
         $$0[jl.b.d()] = b;
         $$0[jl.c.d()] = c;
         $$0[jl.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dvd $$0, ddx $$1, jg $$2) {
         long $$3 = $$2.a();
         if (this.a) {
   ...
   protected static enum e {
      ...
      private e(final jl $$0, final boolean $$1) {
         this.m = $$0.d() + ($$1 ? gjb.c.length : 0);
      }
   }
}
