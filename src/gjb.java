...
public class gjb {
   ...
   private int u;
   private long v;
   private final AtomicReference<gjb.a> w = new AtomicReference<>(gjb.a.c);
   ...
   private float a(@Nullable art $$0) {
      return $$0 != null && $$0 != art.a ? this.n.a($$0) : 1.0F;
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(env::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gjb.a.c, gjb.a.a)) {
               String $$2 = this.n.aq().c();
               ac.g().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gjb.a.a, gjb.a.b);
                     }
                  ...
                  this.w.compareAndSet(gjb.a.a, gjb.a.c);
               });
            }
         }

         return this.w.compareAndSet(gjb.a.b, gjb.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(gia::s).forEach(this::c);
      this.D.clear();
      ...
      for (gib $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            elt $$3 = new elt($$0.h(), $$0.i(), $$0.j());
            gix.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<gia, gix.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gia, gix.a> $$6 = $$5.next();
         gix.a $$7 = $$6.getValue();
         gia $$8 = $$6.getKey();
      ...
      Iterator<Entry<gia, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gia, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gia $$13 = $$12.getKey();
            if ($$13 instanceof gib) {
               ((gib)$$13).q();
            }
   ...
   private static boolean d(gia $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gia $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gia $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gia $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gje.d) {
                  if ($$3 == gje.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        elt $$11 = new elt($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != gia.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<gix.a> $$16 = this.t.a($$3.g() ? enw.c.b : enw.c.a);
                           gix.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aW) {
   ...
   private float g(gia $$0) {
      return auo.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gia $$0) {
      return this.a($$0.f(), $$0.c());
   }

   private float a(float $$0, art $$1) {
      return auo.a($$0 * this.a($$1), 0.0F, 1.0F);
   }

   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(env::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(env::e));
      }
   }
   ...
   public void a(eut $$0) {
      if (this.o && $$0.h()) {
         eny $$1 = new eny($$0.b(), new elt($$0.l()), new elt($$0.m()));
