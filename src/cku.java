...
public class cku extends bwi implements cmp {
   private static final Logger cd = LogUtils.getLogger();
   public static final alc<Integer> a = alg.a(cku.class, ale.b);
   private static final cgx ce = cgx.a().a(64.0);
   ...
   private final ckr[] ck;
   public final ckr c;
   private final ckr cl;
   private final ckr cm;
   private final ckr cn;
   private final ckr co;
   private final ckr cp;
   private final ckr cq;
   private final ckr cr;
   public float d;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private ebt cs;
   private jh ct = jh.c;
   private final cll cu;
   private int cv = 100;
   private float cw;
   private final euj[] cx = new euj[24];
   private final int[] cy = new int[24];
   private final euh cz = new euh();

   public cku(bvr<? extends cku> $$0, dhi $$1) {
      super(bvr.Q, $$1);
      this.c = new ckr(this, "head", 1.0F, 1.0F);
      this.cl = new ckr(this, "neck", 3.0F, 3.0F);
      this.cm = new ckr(this, "body", 5.0F, 3.0F);
      this.cn = new ckr(this, "tail", 2.0F, 2.0F);
      this.co = new ckr(this, "tail", 2.0F, 2.0F);
      this.cp = new ckr(this, "tail", 2.0F, 2.0F);
      this.cq = new ckr(this, "wing", 4.0F, 2.0F);
      this.cr = new ckr(this, "wing", 4.0F, 2.0F);
      this.ck = new ckr[]{this.c, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.x(this.eS());
      this.ad = true;
      this.cu = new cll(this);
   }
         ...
         if (this.gb()) {
            ...
            if (this.dW() instanceof ash $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.v(bae.h(this.dM()));
                  fby $$17 = $$10.a(this.dB(), this.dD(), this.dH()).d();
                  fby $$18 = new fby((double)bae.a(this.dM() * (float) (Math.PI / 180.0)), this.dz().e, (double)(-bae.b(this.dM() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new fby(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(bwk.a, this.dz().c(0.8F));
                  } else {
            ...
            this.aX = this.dM();
            fby[] $$25 = new fby[this.ck.length];

            for (int $$26 = 0; $$26 < this.ck.length; $$26++) {
               $$25[$$26] = new fby(this.ck[$$26].dB(), this.ck[$$26].dD(), this.ck[$$26].dH());
            }
            ...
            if (this.dW() instanceof ash $$33 && this.aN == 0) {
               this.a($$33, $$33.a(this, this.cq.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bvp.e));
               this.a($$33, $$33.a(this, this.cr.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bvp.e));
               this.b($$33, $$33.a(this, this.c.cR().g(1.0), bvp.e));
               this.b($$33, $$33.a(this, this.cl.cR().g(1.0), bvp.e));
            }
   ...
   private void a(ckr $$0, double $$1, double $$2, double $$3) {
   ...
   private void gn() {
      ...
      if (this.ae.a(10) == 0) {
         List<ckt> $$0 = this.dW().a(ckt.class, this.cR().g(32.0));
         ckt $$1 = null;
   ...
   private void a(ash $$0, List<bvk> $$1) {
   ...
   private void b(ash $$0, List<bvk> $$1) {
      for (bvk $$2 : $$1) {
         if ($$2 instanceof bwg) {
            bua $$3 = this.dX().b((bwg)this);
            $$2.a($$0, $$3, 10.0F);
            deb.a($$0, $$2, $$3);
         }
      }
   ...
   public boolean a(ash $$0, ckr $$1, bua $$2, float $$3) {
      if (this.cu.a().h() == clk.j) {
         return false;
      } else {
         $$3 = this.cu.a().a($$2, $$3);
         if ($$1 != this.c) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof cpx || $$2.a(axw.y)) {
               float $$4 = this.eE();
               this.c($$0, $$2, $$3);
   ...
   protected void c(ash $$0, bua $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void em() {
      ...
      if (this.dW() instanceof ash $$4) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$4.N().b(dhe.f)) {
            bvw.a($$4, this.du(), bae.d((float)$$3 * 0.08F));
         }
      ...
      this.a(bwk.a, new fby(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dW() instanceof ash $$5) {
         if ($$5.N().b(dhe.f)) {
            bvw.a($$5, this.du(), bae.d((float)$$3 * 0.2F));
         }
   ...
   public int t() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dW().a(edq.a.f, new jh($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new euj($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      euj $$5 = new euj(bae.a($$0), bae.a($$1), bae.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eul a(int $$0, int $$1, @Nullable euj $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         euj $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eul a(euj $$0, euj $$1) {
      List<euj> $$2 = Lists.newArrayList();
      euj $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eul($$2, new jh($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ux $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(clk.a($$0.h("DragonPhase")));
      }
   ...
   public fby J(float $$0) {
      cle $$1 = this.cu.a();
      clk<? extends cle> $$2 = $$1.h();
      fby $$8;
      if ($$2 == clk.d || $$2 == clk.e) {
         jh $$3 = this.dW().a(edq.a.f, egv.a(this.ct));
   ...
   public void a(ash $$0, ckt $$1, jh $$2, bua $$3) {
      cpx $$4;
      if ($$3.d() instanceof cpx) {
         $$4 = (cpx)$$3.d();
      } else {
