...
public class cku extends ckb {
   ...
   private static final but c = new but(b, "Baby speed boost", 0.5, but.a.b);
   private static final akj<Boolean> d = akn.a(cku.class, akl.k);
   private static final akj<Integer> cb = akn.a(cku.class, akl.b);
   private static final akj<Boolean> cc = akn.a(cku.class, akl.k);
   public static final float e = 0.05F;
   public static final int bY = 50;
   public static final int bZ = 40;
   public static final int ca = 7;
   private static final bsv cd = bsy.bu.n().a(0.5F).b(0.93F);
   private static final float ce = 0.1F;
   private static final Predicate<bqp> cf = $$0 -> $$0 == bqp.d;
   private final bzv cg = new bzv(this, cf);
   private boolean ch;
   private int ci;
   private int cj;

   public cku(bsy<? extends cku> $$0, dbw $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   protected void z() {
      this.bS.a(4, new cku.a(this, 1.0, 3));
   ...
   protected void u() {
      ...
      this.bS.a(6, new cax(this, 1.0, true, 4, this::gy));
      this.bS.a(7, new cby(this, 1.0));
      this.bT.a(1, new ccd(this).a(ckw.class));
   ...
   public static buu.a gu() {
      return ckb.gw().a(buv.k, 35.0).a(buv.r, 0.23F).a(buv.c, 3.0).a(buv.a, 2.0).a(buv.u);
   }
   ...
   protected void b(bsy<? extends cku> $$0) {
      cku $$1 = this.a($$0, true);
      if ($$1 != null) {
         $$1.G($$1.dP().d_($$1.dp()).d());
         $$1.x($$1.y() && this.gy());
   ...
   public boolean a(brl $$0, float $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$3 != null && this.dP().al() == bqp.d && (double)this.ah.i() < this.g(buv.u) && this.dP().ab().b(dbs.e)) {
            int $$4 = ayx.a(this.du());
            int $$5 = ayx.a(this.dw());
            int $$6 = ayx.a(this.dA());
            cku $$7 = new cku(this.dP());

            for (int $$8 = 0; $$8 < 50; $$8++) {
               int $$9 = $$4 + ayx.a(this.ah, 7, 40) * ayx.a(this.ah, -1, 1);
               int $$10 = $$5 + ayx.a(this.ah, 7, 40) * ayx.a(this.ah, -1, 1);
               int $$11 = $$6 + ayx.a(this.ah, 7, 40) * ayx.a(this.ah, -1, 1);
               iz $$12 = new iz($$9, $$10, $$11);
               bsy<?> $$13 = $$7.ak();
               if (buj.a($$13, this.dP(), $$12) && buj.a($$13, $$2, btr.j, $$12, this.dP().z)) {
                  ...
                  if (!this.dP().a((double)$$9, (double)$$10, (double)$$11, 7.0) && this.dP().f($$7) && this.dP().g($$7) && !this.dP().d($$7.cK())) {
                     ...
                     $$2.a_($$7);
                     this.f(buv.u).d(new but("Zombie reinforcement caller charge", -0.05F, but.a.a));
                     $$7.f(buv.u).d(new but("Zombie reinforcement callee charge", -0.05F, but.a.a));
                     break;
                  }
               }
            }
   ...
   protected void a(azf $$0, bqq $$1) {
      super.a($$0, $$1);
      if ($$0.i() < (this.dP().al() == bqp.d ? 0.05F : 0.01F)) {
         int $$2 = $$0.a(3);
         if ($$2 == 0) {
            this.a(bsz.a, new cun(cuq.pa));
         } else {
            this.a(bsz.a, new cun(cuq.pb));
         }
      }
   }
   ...
   public boolean a(are $$0, btn $$1) {
      ...
      if (($$0.al() == bqp.c || $$0.al() == bqp.d) && $$1 instanceof cmi $$3) {
         if ($$0.al() != bqp.d && this.ah.h()) {
            return $$2;
         }

         ckv $$4 = $$3.a(bsy.bw, false);
         if ($$4 != null) {
            $$4.a($$0, $$0.d_($$4.dp()), btr.i, new cku.b(false, true));
            $$4.a($$3.gB());
            $$4.a($$3.gL().a(vf.a));
            $$4.a($$3.gs().a());
            $$4.b($$3.u());
   ...
   public boolean j(cun $$0) {
      return $$0.a(cuq.qR) && this.p_() && this.bR() ? false : super.j($$0);
   }

   @Override
   public boolean k(cun $$0) {
      return $$0.a(cuq.rg) ? false : super.k($$0);
   }
   ...
   public bug a(dcl $$0, bqq $$1, btr $$2, @Nullable bug $$3) {
      ...
      if ($$3 instanceof cku.b $$6) {
         if ($$6.a) {
            ...
            if ($$6.b) {
               if ((double)$$4.i() < 0.05) {
                  List<cfi> $$7 = $$0.a(cfi.class, this.cK().c(5.0, 3.0, 5.0), bsx.c);
                  if (!$$7.isEmpty()) {
                     cfi $$8 = $$7.get(0);
                     $$8.w(true);
                     this.n($$8);
   ...
   public static boolean a(azf $$0) {
      return $$0.i() < 0.05F;
   }

   protected void G(float $$0) {
      this.gz();
      this.f(buv.n).d(new but("Random spawn bonus", this.ah.j() * 0.05F, but.a.a));
      double $$1 = this.ah.j() * 1.5 * (double)$$0;
      if ($$1 > 1.0) {
         this.f(buv.k).d(new but("Random zombie-spawn bonus", $$1, but.a.c));
      }

      if (this.ah.i() < $$0 * 0.05F) {
         this.f(buv.u).d(new but("Leader zombie bonus", this.ah.j() * 0.25 + 0.5, but.a.a));
         this.f(buv.q).d(new but("Leader zombie bonus", this.ah.j() * 3.0 + 1.0, but.a.c));
         this.x(this.y());
      }
   }

   protected void gz() {
      this.f(buv.u).a(this.ah.j() * 0.1F);
   }
   ...
   class a extends cbn {
      ...
      public void a(dbx $$0, iz $$1) {
         $$0.a(null, $$1, avz.Dv, awa.f, 0.5F, 0.9F + cku.this.ah.i() * 0.2F);
      }
