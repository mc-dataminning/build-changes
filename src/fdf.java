...
public class fdf extends gvu {
   ...
   private fhu X;
   private boolean Y;
   private final List<fcx> Z = Lists.newArrayList();

   public fdf(faz $$0, long $$1) {
      super(D);
      this.M = $$0;
      this.O = $$1;
   }
   ...
   public void aP_() {
      ...
      this.P = this.m / 2 - 187;
      this.Q = this.m / 2 + 190;
      this.R = this.c(fhu.a(wu.c("mco.configure.world.buttons.players"), $$0x -> this.l.a(new fdq(this, this.N))).a(this.a(0, 3), g(0), 100, 20).a());
      this.S = this.c(fhu.a(wu.c("mco.configure.world.buttons.settings"), $$0x -> this.l.a(new fdw(this, this.N.g()))).a(this.a(1, 3), g(0), 100, 20).a());
      this.T = this.c(
         fhu.a(wu.c("mco.configure.world.buttons.subscription"), $$0x -> this.l.a(new fdy(this, this.N.g(), this.M))).a(this.a(2, 3), g(0), 100, 20).a()
      );
      this.Z.clear();
      ...
      this.X = this.c(
         fhu.a(wu.c("mco.configure.world.buttons.switchminigame"), $$0x -> this.l.a(new fdv(wu.c("mco.template.title.minigame"), this::a, fbv.d.b)))
            .a(this.b(0), g(13) - 5, 100, 20)
            .a()
      );
      this.U = this.c(
         fhu.a(wu.c("mco.configure.world.buttons.options"), $$0x -> this.l.a(new fdx(this, this.N.i.get(this.N.n).d(), this.N.m, this.N.n)))
            .a(this.b(0), g(13) - 5, 90, 20)
            .a()
      );
      this.V = this.c(fhu.a(wu.c("mco.configure.world.backup"), $$0x -> this.l.a(new fdc(this, this.N.g(), this.N.n))).a(this.b(1), g(13) - 5, 90, 20).a());
      this.W = this.c(
         fhu.a(wu.c("mco.configure.world.buttons.resetworld"), $$0x -> this.l.a(fdt.a(this, this.N.g(), () -> this.l.execute(() -> this.l.a(this.g())))))
            .a(this.b(2), g(13) - 5, 90, 20)
            .a()
      );
      this.c(fhu.a(wt.k, $$0x -> this.d()).a(this.Q - 80 + 8, g(13) - 5, 70, 20).a());
      this.V.j = true;
      if (this.N == null) {
         this.J();
         this.G();
   ...
   public void a(fhh $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.N == null) {
         ...
         String $$4 = this.N.b();
         int $$5 = this.o.b($$4);
         int $$6 = this.N.e == fbv.c.a ? -6250336 : 8388479;
   ...
   private void a(long $$0) {
      new Thread(() -> {
         ...
         try {
            ...
            this.l.execute(() -> this.l.a(new fdj(var5, this.M)));
         }
      }).start();
   }
   ...
   private void E() {
      fdv $$0 = new fdv(wu.c("mco.template.title.minigame"), this::a, fbv.d.b);
      $$0.a(wu.c("mco.minigame.world.info.line1"), wu.c("mco.minigame.world.info.line2"));
      this.l.a($$0);
   }

   private void a(int $$0, fbv $$1) {
      this.l.a(fdr.a(this, wu.c("mco.configure.world.slot.switch.question.line1"), $$2 -> {
         this.f();
         this.l.a(new fdl(this.M, new ffd($$1.a, $$0, () -> this.l.execute(() -> this.l.a(this.g())))));
      }));
   }

   private void b(int $$0, fbv $$1) {
      this.l.a(fdr.a(this, wu.c("mco.configure.world.slot.switch.question.line1"), $$2 -> {
         this.f();
         fdt $$3 = fdt.a(this, $$0, $$1, () -> this.l.execute(() -> this.l.a(this.g())));
         this.l.a($$3);
      }));
   }
   ...
   private void b(fhh $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      } else if (this.N.e == fbv.c.a) {
         this.a($$0, $$1, $$2, $$3, $$4, A, () -> I);
      } else if (this.N.e == fbv.c.b) {
         if (this.N.l < 7) {
            this.a($$0, $$1, $$2, $$3, $$4, b, () -> {
               if (this.N.l <= 0) {
                  return F;
   ...
   public void b(boolean $$0) {
      fdf $$1 = this.g();
      this.l.a(new fdl($$1, new few(this.N, $$1, $$0, this.l)));
   }

   public void b() {
      fdf $$0 = this.g();
      this.l.a(new fdl($$0, new feq(this.N, $$0)));
   }
   ...
   private void a(@Nullable fcm $$0) {
      if ($$0 != null && fcm.a.b == $$0.i) {
         this.f();
         this.l.a(new fdl(this.M, new ffc(this.N.a, $$0, this.g())));
      } else {
         this.l.a(this);
      }
   }
