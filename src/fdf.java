...
public class fdf {
   ...
   public static final fdf.a bv;

   public static fdf.a a(int $$0, int $$1) {
      return $$0 == -1 ? fdf.b.b.a($$1) : fdf.b.a.a($$0);
   }

   public static fdf.a a(String $$0) {
      if (fdf.a.e.containsKey($$0)) {
         return fdf.a.e.get($$0);
      } else {
         for (fdf.b $$1 : fdf.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fdf.b b;
      private final int c;
      private final azh<xl> d;
      static final Map<String, fdf.a> e = Maps.newHashMap();

      a(String $$0, fdf.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azh<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> ui.a().b($$1) ? xl.c($$1) : xl.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fdf.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xl> g;

      private static void a(fdf.b $$0, String $$1, int $$2) {
         fdf.a $$3 = new fdf.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fdf.a a(int $$0) {
         return (fdf.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
