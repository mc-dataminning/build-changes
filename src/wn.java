...
public class wn {
   public static <T extends we> wn.b a(wg<T> $$0) {
      return a(new wc<T>($$0));
   }

   private static wn.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends we> wn.d b(wg<T> $$0) {
      return a(new wd<T>($$0));
   }

   private static wn.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zf)) {
            $$0.fireChannelRead($$1);
         } else {
