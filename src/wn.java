...
public class wn {
   public static final Codec<wn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(wn.a.h.forGetter($$0x -> $$0x.b), Codec.STRING.fieldOf("value").forGetter($$0x -> $$0x.c)).apply($$0, wn::new)
   );
   private final wn.a b;
   private final String c;

   public wn(wn.a $$0, String $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static enum a implements azv {
      ...
      public static final MapCodec<wn.a> g = azv.a(wn.a::values).fieldOf("action");
      public static final MapCodec<wn.a> h = g.validate(wn.a::a);
