...
public class ajb<E> implements Codec<ip<E>> {
   ...
   public static <E> Codec<ip<E>> a(ajg<? extends iy<E>> $$0, Codec<il<E>> $$1, boolean $$2) {
      return new ajb<>($$0, $$1, $$2);
   }

   private ajb(ajg<? extends iy<E>> $$0, Codec<il<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(avd.b($$0), this.c);
   }

   public <T> DataResult<Pair<ip<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof ajf<T> $$2) {
