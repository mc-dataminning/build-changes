...
public class gke extends gjy<cfp, fuu<cfp>> {
   private static final Map<cfp.a, alb> a = ac.a(Maps.newEnumMap(cfp.a.class), $$0 -> {
      $$0.put(cfp.a.a, new alb("textures/entity/panda/panda.png"));
      $$0.put(cfp.a.b, new alb("textures/entity/panda/lazy_panda.png"));
      $$0.put(cfp.a.c, new alb("textures/entity/panda/worried_panda.png"));
      $$0.put(cfp.a.d, new alb("textures/entity/panda/playful_panda.png"));
      $$0.put(cfp.a.e, new alb("textures/entity/panda/brown_panda.png"));
      $$0.put(cfp.a.f, new alb("textures/entity/panda/weak_panda.png"));
      $$0.put(cfp.a.g, new alb("textures/entity/panda/aggressive_panda.png"));
   });

   public gke(gis.a $$0) {
      super($$0, new fuu<>($$0.a(fwu.aF)), 0.9F);
      this.a(new gna(this, $$0.d()));
   }

   public alb a(cfp $$0) {
      return a.getOrDefault($$0.gC(), a.get(cfp.a.a));
   }

   protected void a(cfp $$0, ezt $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bZ > 0) {
         int $$6 = $$0.bZ;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ayu.i($$25, $$0.dH(), $$0.dH() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(ayu.i($$27, $$0.dH(), $$0.dH() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ayu.i($$3, $$0, $$1) : $$0;
   }
}
