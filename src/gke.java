...
public class gke extends gkh {
   gke(gfz $$0, gkc $$1, double $$2, double $$3, double $$4) {
      super($$0, $$2, $$3 - 0.125, $$4);
      this.b(0.01F, 0.01F);
      this.a($$1);
   ...
   gke(gfz $$0, gkc $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
   ...
   public static class a implements gjk<lx> {
      ...
      public gjh a(lx $$0, gfz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gke $$12 = new gke($$1, this.a, $$2, $$3, $$4, $$9, $$10, $$11);
         $$12.a(0.9F, 0.4F, 0.5F);
         return $$12;
      }
   }
   ...
   public static class b implements gjk<lx> {
      ...
      public gjh a(lx $$0, gfz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gke $$8 = new gke($$1, this.a, $$2, $$3, $$4, 0.0, -0.8F, 0.0) {
            @Override
   ...
   public static class d implements gjk<lx> {
      ...
      public gjh a(lx $$0, gfz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gke $$9 = new gke($$1, this.a, $$2, $$3, $$4, 0.0, $$8, 0.0);
         $$9.a(0.1F, 0.1F, 0.3F);
         $$9.b(0.001F, 0.001F);
         return $$9;
      }
