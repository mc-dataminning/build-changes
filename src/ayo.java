...
public class ayo {
   ...
   public static ji<cuj> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static ji<cuj> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ji<cuj> a(JsonObject $$0, String $$1, @Nullable ji<cuj> $$2) {
