...
public interface ayo<C, I extends bap<C>> extends bap<C> {
   @bat
   String a();

   ayo<C, I> a(ayo.d<I> var1);

   static <C, I extends bap<C>> Codec<ayo<C, I>> a(Codec<I> $$0) {
      MutableObject<Codec<ayo<C, I>>> $$1 = new MutableObject();

      record a<C, I extends bap<C>>(float a, ayo<C, I> b, float c) {
      }
      ...
      Codec<ayo.e<C, I>> $$3 = RecordCodecBuilder.create(
         $$2x -> $$2x.group(
                  $$0.fieldOf("coordinate").forGetter(ayo.e::d),
                  ayv.a($$2.listOf())
                     .fieldOf("points")
                     .forGetter(
                        $$0xx -> IntStream.range(0, $$0xx.c.length)
                              .mapToObj($$1xx -> new a($$0xx.e()[$$1xx], (ayo<C, I>)$$0xx.f().get($$1xx), $$0xx.g()[$$1xx]))
                              .toList()
                     )
               )
               .apply($$2x, ($$0xx, $$1xx) -> {
                  float[] $$2xx = new float[$$1xx.size()];
                  Builder<ayo<C, I>> $$3x = ImmutableList.builder();
                  ...
                  return ayo.e.a((I)$$0xx, $$2xx, $$3x.build(), $$4);
               })
      );
      $$1.setValue(
         Codec.either(Codec.FLOAT, $$3)
            .xmap(
               $$0x -> (ayo)$$0x.map(ayo.c::new, $$0xx -> $$0xx), $$0x -> $$0x instanceof ayo.c<C, I> $$1x ? Either.left($$1x.d()) : Either.right((ayo.e)$$0x)
            )
      );
      return (Codec<ayo<C, I>>)$$1.getValue();
   }

   static <C, I extends bap<C>> ayo<C, I> a(float $$0) {
      return new ayo.c<>($$0);
   }

   static <C, I extends bap<C>> ayo.b<C, I> a(I $$0) {
      return new ayo.b<>($$0);
   }

   static <C, I extends bap<C>> ayo.b<C, I> a(I $$0, bap<Float> $$1) {
   ...
   public static final class b<C, I extends bap<C>> {
      ...
      private final List<ayo<C, I>> d = Lists.newArrayList();
      ...
      public ayo.b<C, I> a(float $$0, float $$1) {
         return this.a($$0, new ayo.c<>(this.b.a($$1)), 0.0F);
      }

      public ayo.b<C, I> a(float $$0, float $$1, float $$2) {
         return this.a($$0, new ayo.c<>(this.b.a($$1)), $$2);
      }

      public ayo.b<C, I> a(float $$0, ayo<C, I> $$1) {
         return this.a($$0, $$1, 0.0F);
      }

      private ayo.b<C, I> a(float $$0, ayo<C, I> $$1, float $$2) {
      ...
      public ayo<C, I> a() {
         if (this.c.isEmpty()) {
            ...
            return ayo.e.a(this.a, this.c.toFloatArray(), ImmutableList.copyOf(this.d), this.e.toFloatArray());
         }
      }
   }

   @bat
   public static record c<C, I extends bap<C>>(float b) implements ayo<C, I> {
      @Override
      public float a(C $$0) {
         return this.b;
      }
   ...
   @bat
   public static record e<C, I extends bap<C>>(I b, float[] c, List<ayo<C, I>> d, float[] e, float f, float g) implements ayo<C, I> {

      public e(I b, float[] c, List<ayo<C, I>> d, float[] e, float f, float g) {
         a(c, d, e);
         this.b = b;
         this.c = c;
         this.d = d;
      ...
      static <C, I extends bap<C>> ayo.e<C, I> a(I $$0, float[] $$1, List<ayo<C, I>> $$2, float[] $$3) {
         a($$1, $$2, $$3);
         int $$4 = $$1.length - 1;
      ...
      private static <C, I extends bap<C>> void a(float[] $$0, List<ayo<C, I>> $$1, float[] $$2) {
      ...
      public String a() {
         return "Spline{coordinate="
            ...
            + this.a(this.e)
            + ", values="
            + this.d.stream().map(ayo::a).collect(Collectors.joining(", ", "[", "]"))
            + "}";
      }
