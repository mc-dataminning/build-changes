...
public class ayo extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(bax.F));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(bax.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(bax.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(bax.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(bax.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(bax.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(bax.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(bax.s);
      Type<?> $$9 = this.getOutputSchema().getType(bax.s);
