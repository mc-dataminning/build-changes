...
public class ayo {
   ...
   public static jr<cwj> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static jr<cwj> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jr<cwj> a(JsonObject $$0, String $$1, @Nullable jr<cwj> $$2) {
