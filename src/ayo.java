...
public class ayo {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> axq.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayo.c> s = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ale.d($$0.substring(1)).map($$0x -> new ayo.c($$0x, true)) : ale.d($$0).map($$0x -> new ayo.c($$0x, false)), ayo.c::c
      );
   ...
   public static final Codec<String> x = Codec.string(0, 16)
      .validate($$0 -> bac.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> D = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ki.e.fieldOf("id").forGetter(GameProfile::getId), x.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static <K, V> ayo.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayo.b<>($$0, $$1);
   }
   ...
   public static <T> Codec<js<T>> b(Codec<js<T>> $$0) {
      return $$0.validate(
   ...
   public static record c(ale a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
