...
public class com implements cnv {
   final int a;
   final int b;
   final il<coc> c;
   final clb d;
   ...
   public com(String $$0, cnu $$1, int $$2, int $$3, il<coc> $$4, clb $$5, boolean $$6) {
      this.e = $$0;
      this.f = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   public com(String $$0, cnu $$1, int $$2, int $$3, il<coc> $$4, clb $$5) {
   ...
   public boolean a(cgu $$0, crs $$1) {
      for (int $$2 = 0; $$2 <= $$0.ax_() - this.a; $$2++) {
         for (int $$3 = 0; $$3 <= $$0.ay_() - this.b; $$3++) {
   ...
   private boolean a(cgu $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.ax_(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.ay_(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
            coc $$8 = coc.a;
   ...
   public static class a implements coj<com> {
      ...
      private static final Codec<com> z = com.a.a.a.flatXmap($$0 -> {
         String[] $$1 = com.a($$0.e);
         int $$2 = $$1[0].length();
         int $$3 = $$1.length;
         il<coc> $$4 = il.a($$2 * $$3, coc.a);
         ...
         for (int $$6 = 0; $$6 < $$1.length; $$6++) {
            ...
            for (int $$8 = 0; $$8 < $$7.length(); $$8++) {
               ...
               coc $$10 = $$9.equals(" ") ? coc.a : $$0.d.get($$9);
               if ($$10 == null) {
         ...
         if (!$$5.isEmpty()) {
            ...
            com $$11 = new com($$0.b, $$0.c, $$2, $$3, $$4, $$0.f, $$0.g);
      ...
      public com b(tu $$0) {
         ...
         return new com($$3, $$4, $$1, $$2, $$5, $$7, $$8);
      }

      public void a(tu $$0, com $$1) {
         $$0.c($$1.a);
         $$0.c($$1.b);
         $$0.a($$1.e);
         $$0.a($$1.f);
      ...
      static record a(String b, cnu c, Map<String, coc> d, List<String> e, clb f, boolean g) {
         public static final Codec<com.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     asq.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.b),
                     cnu.e.fieldOf("category").orElse(cnu.d).forGetter($$0x -> $$0x.c),
                     asq.d(com.a.y, coc.c).fieldOf("key").forGetter($$0x -> $$0x.d),
                     com.a.x.fieldOf("pattern").forGetter($$0x -> $$0x.e),
                     cnw.a.fieldOf("result").forGetter($$0x -> $$0x.f),
                     asq.a(Codec.BOOL, "show_notification", true).forGetter($$0x -> $$0x.g)
                  )
                  .apply($$0, com.a.a::new)
         );
