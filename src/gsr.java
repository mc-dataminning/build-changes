...
public class gsr extends gtj<clt, gyw, gci> {
   ...
   protected gsr(gsd.a $$0, float $$1, gfa $$2) {
      super($$0, new gci($$0.a($$2)), $$1);
   }

   public boolean a(clt $$0, gpp $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gt()) {
            bvg $$5 = $$0.gu();
            if ($$5 != null) {
               faz $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               faz $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new fau($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private faz a(bvg $$0, double $$1, float $$2) {
   ...
   public void a(gyw $$0, fft $$1, glx $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      faz $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fft $$0, ffx $$1, faz $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(ffx $$0, fft.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(heh.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
