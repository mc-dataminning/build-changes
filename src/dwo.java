...
public class dwo extends dwp {
   private static final Codec<Either<aew, dzb>> a = Codec.of(dwo::a, aew.a.map(Either::left));
   public static final Codec<dwo> b = RecordCodecBuilder.create($$0 -> $$0.group(c(), b(), d()).apply($$0, dwo::new));
   protected final Either<aew, dzb> c;
   protected final he<dyz> d;

   private static <T> DataResult<T> a(Either<aew, dzb> $$0, DynamicOps<T> $$1, T $$2) {
      Optional<aew> $$3 = $$0.left();
      return $$3.isEmpty() ? DataResult.error(() -> "Can not serialize a runtime pool element") : aew.a.encode($$3.get(), $$1, $$2);
   }

   protected static <E extends dwo> RecordCodecBuilder<E, he<dyz>> b() {
      return dza.d.fieldOf("processors").forGetter($$0 -> $$0.d);
   }

   protected static <E extends dwo> RecordCodecBuilder<E, Either<aew, dzb>> c() {
      return a.fieldOf("location").forGetter($$0 -> $$0.c);
   }

   protected dwo(Either<aew, dzb> $$0, he<dyz> $$1, dwr.a $$2) {
      super($$2);
      this.c = $$0;
      this.d = $$1;
   }
