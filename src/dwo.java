...
public class dwo extends duw {
   ...
   protected void a(ux $$0, js.a $$1) {
      ...
      try {
         this.k = drb.valueOf($$0.l("rotation"));
      } catch (IllegalArgumentException var12) {
         this.k = drb.a;
      }

      try {
         this.j = dpk.valueOf($$0.l("mirror"));
      } catch (IllegalArgumentException var11) {
         this.j = dpk.a;
      }

      try {
         this.l = dzd.valueOf($$0.l("mode"));
   ...
   public void a(dzd $$0) {
      this.l = $$0;
      dxu $$1 = this.o.a_(this.aB_());
      if ($$1.a(dkn.pv)) {
         this.o.a(this.aB_(), $$1.b(dsm.b, $$0), 2);
      }
   }
   ...
   private Stream<jh> a(jh $$0, jh $$1) {
      return jh.d($$0, $$1)
         .filter($$0x -> this.o.a_($$0x).a(dkn.pv))
         .map(this.o::c_)
         .filter($$0x -> $$0x instanceof dwo)
         .map($$0x -> (dwo)$$0x)
         .filter($$0x -> $$0x.l == dzd.c && Objects.equals(this.e, $$0x.e))
         .map(duw::aB_);
   }

   private static Optional<eob> a(jh $$0, Stream<jh> $$1) {
   ...
   public boolean A() {
      return this.l != dzd.a ? false : this.b(true);
   }
   ...
   public boolean b(boolean $$0) {
      if (this.e == null) {
         ...
         $$4.a(this.o, $$1, this.i, !this.m, dkn.li);
         $$4.a(this.f);
         if ($$0) {
            try {
               return $$3.c(this.e);
   ...
   private void a(ash $$0, esl $$1) {
      this.a($$1);
      esh $$2 = new esh().a(this.j).a(this.k).a(this.m);
      if (this.t < 1.0F) {
         $$2.b().a(new ero(bae.a(this.t, 0.0F, 1.0F))).a(b(this.u));
      }
   ...
   public boolean C() {
      if (this.l == dzd.b && !this.o.C && this.e != null) {
         ash $$0 = (ash)this.o;
         esm $$1 = $$0.r();
