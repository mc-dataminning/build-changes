...
public class dkp extends dks<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dkp(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dkp $$1 && super.equals($$0)) {
   ...
   public static dkp a(String $$0, int $$1, int $$2) {
      return new dkp($$0, $$1, $$2);
   }
