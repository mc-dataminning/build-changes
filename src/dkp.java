...
public class dkp {
   ...
   public final aqh<csv> g;
   public final aqh<csv> h;
   public static final Codec<dkp> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               arf.a(dfj.b.listOf()).fieldOf("inner_placements").forGetter($$0x -> $$0x.f),
               aqh.b(jc.e).fieldOf("cannot_replace").forGetter($$0x -> $$0x.g),
               aqh.b(jc.e).fieldOf("invalid_blocks").forGetter($$0x -> $$0x.h)
            )
            .apply($$0, dkp::new)
   );

   public dkp(dsb $$0, dsb $$1, dsb $$2, dsb $$3, dsb $$4, List<dfj> $$5, aqh<csv> $$6, aqh<csv> $$7) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
