...
public interface dkp<T extends Enum<T>> {
   int x_ = 4;

   Optional<dwy> k_(dwy var1);

   float au_();

   default void a_(dwy $$0, ard $$1, ji $$2, azh $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dwy> c(dwy $$0, ard $$1, ji $$2, azh $$3) {
      ...
      for (ji $$7 : ji.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dkp<?> $$9) {
            Enum<?> $$10 = $$9.c();
