...
public class ban {
   ...
   private static final Optional<Object> b = Optional.of(bay.a);

   private static boolean a(xz $$0, azd $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xz $$1, azd $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xz $$1, azd $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xz $$1, azd $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xz $$2, azd $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xz $$2, xz $$3, azd $$4) {
      int $$5 = $$0.length();
      xz $$6 = $$2;
   ...
   public static boolean a(xh $$0, xz $$1, azd $$2) {
