public class gbc extends gbx {
   private final gbs a;

   gbc(fxq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbs $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cms $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dw();
            if (this.h > $$1) {
   ...
   public static class a implements gba<lm> {
      ...
      public gax a(lm $$0, fxq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gbc($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gba<lm> {
      ...
      public gax a(lm $$0, fxq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gax $$8 = new gbc($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
