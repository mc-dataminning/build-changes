...
public class awe extends awd {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awe.a> s;
   private final avz t;
   private long u;
   private final alv v;

   private awe(alv $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awa.c($$2, 7, $$0.getLength());
      }
   }
