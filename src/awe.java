...
public class awe {
   ...
   public static final Codec<Object> b = a(awp.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(awm.e($$0));
   ...
   public static final Codec<awe.g> q = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ajh.b($$0.substring(1)).map($$0x -> new awe.g($$0x, true)) : ajh.b($$0).map($$0x -> new awe.g($$0x, false)), awe.g::c
      );
   ...
   private static final MapCodec<GameProfile> A = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jf.e.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> y = b(
      Codec.STRING, $$0 -> !ajh.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> awe.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new awe.b<>($$0, $$1);
   }

   public static <K, V> awe.f<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new awe.f<>($$0, $$1);
   }
   ...
   static final class e<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof awe.e<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record g(ajh a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
