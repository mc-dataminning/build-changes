...
public class btd extends bss {
   ...
   public btd(dbw $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bsy.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public btd(bsy<? extends btd> $$0, dbw $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         evp $$0 = new evp(this.k.du() - this.du(), this.k.dw() + (double)this.k.cL() / 2.0 - this.dw(), this.k.dA() - this.dA());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dP() instanceof are) {
         for (btd $$1 : this.dP().a(dwh.a(btd.class), this.cK().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(are $$0, evp $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new btd($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(are $$0, evp $$1, int $$2) {
      evk $$3 = evk.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<btd> $$5 = $$0.a(dwh.a(btd.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         btd $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(btd $$0) {
      return $$0 != this && a($$0, this.al(), this.i);
   }

   private static boolean a(btd $$0, int $$1, int $$2) {
      return !$$0.dK() && ($$0.al() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(btd $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cmv $$0, int $$1) {
      Entry<bsz, cun> $$2 = czz.a(dab.O, $$0, cun::m);
      if ($$2 != null) {
         cun $$3 = $$2.getValue();
