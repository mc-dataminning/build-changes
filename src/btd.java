...
public class btd extends bti {
   public static final MapCodec<btd> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static btd a(float $$0, float $$1, int $$2, int $$3) {
      return new btd($$0, $$1, $$2, $$3);
   }

   private btd(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
