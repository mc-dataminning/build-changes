...
public class geg implements gef {
   private final gef.a a;
   private final gef.a b = gef.a(new faj(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public fas getBuffer(gen $$0) {
      if ($$0.M()) {
         fas $$1 = this.b.getBuffer($$0);
         return new geg.a($$1, this.c, this.d, this.e, this.f);
      } else {
         fas $$2 = this.a.getBuffer($$0);
         Optional<gen> $$3 = $$0.L();
         if ($$3.isPresent()) {
            fas $$4 = this.b.getBuffer($$3.get());
            geg.a $$5 = new geg.a($$4, this.c, this.d, this.e, this.f);
            return fav.a($$5, $$2);
         } else {
            return $$2;
         }
   ...
   static class a extends fan {
      ...
      a(fas $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
