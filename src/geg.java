...
public class geg implements AutoCloseable {
   private static final String a = "minecraft:main";
   private final eyy b;
   private final atz c;
   private final String d;
   private final List<geh> e = Lists.newArrayList();
   private final Map<String, eyy> f = Maps.newHashMap();
   private final List<eyy> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public geg(gpp $$0, atz $$1, eyy $$2, akk $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gpp $$0, akk $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(gpp $$0, JsonElement $$1) throws IOException {
   ...
   private void b(JsonElement $$0) throws akn {
      ...
      String $$2 = axw.i($$1, "name");
      fad $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
   ...
   public eyy a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      eyy $$3 = new eyz($$1, $$2, true, fft.a);
   ...
   public geh a(String $$0, eyy $$1, eyy $$2, boolean $$3) throws IOException {
      geh $$4 = new geh(this.c, $$0, $$1, $$2, $$3);
   ...
   @Nullable
   private eyy b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
