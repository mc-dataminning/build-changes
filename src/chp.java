...
public class chp extends cgx implements bvl {
   private static final ajx<Boolean> bY = akb.a(chp.class, ajz.k);
   ...
   public chp(bur<? extends chp> $$0, dgi $$1) {
      super($$0, $$1);
   }
   ...
   public static bwn.a p() {
      return cgx.gu().a(bwo.s, 30.0).a(bwo.m, 20.0).a(bwo.v, 0.25).a(bwo.c, 6.0);
   }

   public static boolean c(bur<chp> $$0, dgj $$1, buq $$2, ji $$3, azh $$4) {
      jr<dhk> $$5 = $$1.t($$3);
   ...
   class a extends cdx<cox> {
      public a() {
         super(chp.this, cox.class, 20, true, true, null);
      }
      ...
      public boolean b() {
         if (chp.this.e_()) {
            ...
            if (super.b()) {
               for (chp $$1 : chp.this.dW().a(chp.class, chp.this.cR().c(8.0, 4.0, 8.0))) {
                  if ($$1.e_()) {
                     return true;
                  }
               }
   ...
   class c extends cco {
      ...
      protected void a(bvg $$0) {
         if (this.b($$0)) {
            ...
            this.a.c(a(this.a), $$0);
            chp.this.x(false);
         } else if (this.a.g((buk)$$0) < (double)(($$0.dr() + 3.0F) * ($$0.dr() + 3.0F))) {
            if (this.i()) {
               chp.this.x(false);
               this.h();
            }
