...
public abstract class ana implements wu {
   ...
   public ana(MinecraftServer $$0, ts $$1, amt $$2) {
      this.b = $$0;
      this.c = $$1;
      this.f = ac.b();
      this.i = $$2.b();
   ...
   protected amt a(alt $$0) {
      return new amt(this.j(), this.i, $$0);
   }
}
