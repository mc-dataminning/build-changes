...
public enum hgt implements hhi {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, hgt> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (hgt)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   private hgt(final int $$0, final int $$1) {
      this.u = b($$0, $$1);
   ...
   public static hgt a(int $$0, int $$1) {
