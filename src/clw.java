...
public class clw extends clt implements bxg<jq<clx>> {
   private static final alc<jq<clx>> g = alg.a(clw.class, ale.A);
   public static final MapCodec<jq<clx>> d = clx.c.fieldOf("variant");
   public static final Codec<jq<clx>> e = d.codec();
   public static final float f = 0.0625F;

   public clw(bvr<? extends clw> $$0, dhi $$1) {
      super($$0, $$1);
   }
   ...
   public static Optional<clw> a(dhi $$0, jh $$1, jm $$2) {
      clw $$3 = new clw($$0, $$1);
      List<jq<clx>> $$4 = new ArrayList<>();
      ...
      if ($$4.isEmpty()) {
         ...
         if ($$4.isEmpty()) {
            ...
            int $$5 = $$4.stream().mapToInt(clw::c).max().orElse(0);
            $$4.removeIf($$1x -> c($$1x) < $$5);
            Optional<jq<clx>> $$6 = ae.b($$4, $$3.ae);
            if ($$6.isEmpty()) {
               return Optional.empty();
            } else {
               $$3.b($$6.get());
   ...
   private static int c(jq<clx> $$0) {
      return $$0.a().a();
   }

   private clw(dhi $$0, jh $$1) {
      super(bvr.aL, $$0, $$1);
   }

   public clw(dhi $$0, jh $$1, jm $$2, jq<clx> $$3) {
      this($$0, $$1);
      this.b($$3);
      this.a($$2);
   }
