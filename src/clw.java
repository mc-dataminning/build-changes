...
public abstract class clw extends cku {
   private static final int k = 9;
   private static final int l = 3;
   protected final clf o;
   protected final cia p;
   protected final bme q;
   private final List<Integer> m;
   protected final cmk r = new cmk();
   private final int n;

   protected abstract boolean a(cia var1, boolean var2);

   protected abstract void a(cia var1, cpq var2);

   protected abstract boolean a(dme var1);

   public clw(@Nullable cmb<?> $$0, int $$1, chz $$2, clf $$3) {
      super($$0, $$1);
      this.o = $$3;
      this.p = $$2.m;
      clx $$4 = this.l();
   ...
   private void a(clx $$0) {
      for (final clx.b $$1 : $$0.c()) {
         this.a(new cmp(this.q, $$1.a(), $$1.b(), $$1.c()) {
            @Override
   ...
   private void b(clx $$0) {
      this.a(new cmp(this.r, $$0.b().a(), $$0.b().b(), $$0.b().c()) {
         @Override
         public boolean a(cpq $$0) {
            return false;
         }
   ...
   private void a(chz $$0) {
      for (int $$1 = 0; $$1 < 3; $$1++) {
         for (int $$2 = 0; $$2 < 9; $$2++) {
            this.a(new cmp($$0, $$2 + $$1 * 9 + 9, 8 + $$2 * 18, 84 + $$1 * 18));
         }
      }

      for (int $$3 = 0; $$3 < 9; $$3++) {
         this.a(new cmp($$0, $$3, 8 + $$3 * 18, 142));
      }
   }

   public abstract void m();

   protected abstract clx l();
