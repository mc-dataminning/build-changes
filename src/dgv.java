...
public class dgv {
   ...
   private final List<dgt> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dgv.a l = new dgv.d(5.999997E7F);
   public static final dgv.c e = new dgv.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public gw b(double $$0, double $$1, double $$2) {
      return gw.a(ars.a($$0, this.e(), this.g()), $$1, ars.a($$2, this.f(), this.h()));
   }

   public double a(bil $$0) {
   ...
   public boolean a(bil $$0, ehd $$1) {
      double $$2 = Math.max(ars.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dgv.a)($$0 == $$1 ? new dgv.d($$1) : new dgv.b($$0, $$1, $$2));
   ...
   class b implements dgv.a {
      ...
      @Override
      public double a() {
         return ars.a(dgv.this.a() - this.e() / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
      }

      @Override
      public double c() {
         return ars.a(dgv.this.b() - this.e() / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ars.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dgu i() {
         return this.c < this.b ? dgu.b : dgu.a;
      }
      ...
      @Override
      public dgv.a l() {
         return (dgv.a)(this.g() <= 0L ? dgv.this.new d(this.c) : this);
      }
      ...
      public eib m() {
         return ehy.a(
            ehy.c,
            ehy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehm.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dgv.c a(DynamicLike<?> $$0, dgv.c $$1) {
         double $$2 = ars.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ars.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dgv.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dgv.a {
      ...
      private void n() {
         this.c = ars.a(dgv.this.a() - this.b / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
         this.d = ars.a(dgv.this.b() - this.b / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
         this.e = ars.a(dgv.this.a() + this.b / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
         this.f = ars.a(dgv.this.b() + this.b / 2.0, (double)(-dgv.this.k), (double)dgv.this.k);
         this.g = ehy.a(
            ehy.c,
            ehy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ehm.e
