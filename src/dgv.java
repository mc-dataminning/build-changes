...
public class dgv {
   ...
   public static final dgv.e<dgv.a> x = a("doLimitedCrafting", dgv.b.a, dgv.a.a(false, ($$0, $$1) -> {
      for (ary $$2 : $$0.ag().t()) {
         $$2.f.b(new ado(ado.n, $$1.a() ? 1.0F : 0.0F));
      }
   }));
   ...
   public static final dgv.e<dgv.a> E = a("doImmediateRespawn", dgv.b.a, dgv.a.a(false, ($$0, $$1) -> {
      for (ary $$2 : $$0.ag().t()) {
         $$2.f.b(new ado(ado.m, $$1.a() ? 1.0F : 0.0F));
      }
   }));
   ...
   public static final dgv.e<dgv.d> aa = a("minecartMaxSpeed", dgv.b.g, dgv.d.a(8, 1, 1000, csk.a(csm.d), ($$0, $$1) -> {
   }));
   public static final dgv.e<dgv.d> ab = a("spawnChunkRadius", dgv.b.g, dgv.d.a(2, 0, 32, csk.a(), ($$0, $$1) -> {
      arx $$2 = $$0.J();
      $$2.a($$2.Z(), $$2.aa());
   }));
   private final Map<dgv.e<?>, dgv.g<?>> ae;
   private final csk af;
   ...
   public dgv(csk $$0, DynamicLike<?> $$1) {
      this($$0);
      this.a($$1);
   }
   ...
   private static Stream<Entry<dgv.e<?>, dgv.f<?>>> b(csk $$0) {
      return ad.entrySet().stream().filter($$1 -> $$1.getValue().e.a($$0));
   }

   private dgv(Map<dgv.e<?>, dgv.g<?>> $$0, csk $$1) {
      this.ae = $$0;
      this.af = $$1;
   }
   ...
   public static class a extends dgv.g<dgv.a> {
      ...
      static dgv.f<dgv.a> a(boolean $$0, BiConsumer<MinecraftServer, dgv.a> $$1) {
         return new dgv.f<>(BoolArgumentType::bool, $$1x -> new dgv.a($$1x, $$0), $$1, dgv.c::b, csk.a());
      }
   ...
   public static class d extends dgv.g<dgv.d> {
      ...
      private static dgv.f<dgv.d> a(int $$0, BiConsumer<MinecraftServer, dgv.d> $$1) {
         return new dgv.f<>(IntegerArgumentType::integer, $$1x -> new dgv.d($$1x, $$0), $$1, dgv.c::c, csk.a());
      }

      static dgv.f<dgv.d> a(int $$0, int $$1, int $$2, csk $$3, BiConsumer<MinecraftServer, dgv.d> $$4) {
   ...
   public static class f<T extends dgv.g<T>> {
      ...
      f(Supplier<ArgumentType<?>> $$0, Function<dgv.f<T>, T> $$1, BiConsumer<MinecraftServer, T> $$2, dgv.h<T> $$3, csk $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
