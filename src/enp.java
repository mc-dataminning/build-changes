...
public class enp {
   ...
   @Nullable
   private String g;
   private static final enp.a h = new enp.a() {
      @Nullable
      @Override
      public eno a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ens.a(this.d, "Get capabilities")) {
         ...
         if (ens.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ens.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ens.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eno a(enp.c $$0) {
      return ($$0 == enp.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements enp.a {
      private final int a;
      private final Set<eno> b = Sets.newIdentityHashSet();
      ...
      public eno a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               enp.a.warn("Maximum sound pool size {} reached", this.a);
            }
