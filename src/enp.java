...
public class enp extends enj<enp.a> {
   protected enp(dul $$0) {
      super(dch.a, $$0, new enp.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dud g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kb.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dud(15) : new dud();
         }
      }
   }

   private static dud a(dud $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends eng<enp.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dud> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public enp.a a() {
         return new enp.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
