...
public abstract class enp<M extends enm<M>> {
   private final dcm i;
   ...
   protected final Long2ObjectMap<dui> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected enp(dcm $$0, duq $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dui a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dui a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dui c(long $$0) {
      dui $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dui g(long $$0) {
      dui $$1 = (dui)this.g.get($$0);
      return $$1 != null ? $$1 : new dui();
   }
   ...
   protected void a(ens<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dui>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dui> $$6 = (Entry<dui>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dui $$8 = (dui)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dui $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kc.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, enp.a.a($$9, enp.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public enp.b k(long $$0) {
      return enp.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static enp.b c(byte $$0) {
         if ($$0 == 0) {
            return enp.b.a;
         } else {
            return a($$0) ? enp.b.c : enp.b.b;
         }
      }
   }
