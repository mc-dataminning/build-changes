...
public class enp {
   ...
   public enp(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<enq> $$1) throws IOException {
   ...
   public List<enq> a(Path $$0) throws IOException {
      List<enq> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<enq> a(Path $$0, boolean $$1) throws IOException {
      List<enq> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<enq> $$1) throws IOException {
