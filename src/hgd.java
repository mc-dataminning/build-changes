...
public class hgd {
   ...
   private final hgc r;
   private final hge s = new hge();
   private final hfv t = new hfv(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hgd.a> w = new AtomicReference<>(hgd.a.c);
   private final Map<hfb, hfv.a> x = Maps.newHashMap();
   private final Multimap<axg, hfb> y = HashMultimap.create();
   private final List<hfc> z = Lists.newArrayList();
   private final Map<hfb, Integer> A = Maps.newHashMap();
   private final Map<hfb, Integer> B = Maps.newHashMap();
   private final List<hgf> C = Lists.newArrayList();
   private final List<hfc> D = Lists.newArrayList();
   private final List<hey> E = Lists.newArrayList();

   public hgd(hgg $$0, fmd $$1, avy $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hgc($$2);
   }
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hgd.a.c, hgd.a.a)) {
               String $$2 = this.n.aw().c();
               ae.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hgd.a.a, hgd.a.b);
                     }
                  ...
                  this.w.compareAndSet(hgd.a.a, hgd.a.c);
               });
            }
         }

         return this.w.compareAndSet(hgd.a.b, hgd.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hfb::s).forEach(this::c);
      this.D.clear();
      ...
      for (hfc $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            fbs $$3 = new fbs($$0.h(), $$0.i(), $$0.j());
            hfv.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hfb, hfv.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hfb, hfv.a> $$6 = $$5.next();
         hfv.a $$7 = $$6.getValue();
         hfb $$8 = $$6.getKey();
      ...
      Iterator<Entry<hfb, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hfb, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hfb $$13 = $$12.getKey();
            if ($$13 instanceof hfc) {
               ((hfc)$$13).q();
            }
   ...
   private static boolean d(hfb $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hfb $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hfb $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hfb $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hgg.e) {
                  if ($$3 == hgg.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        fbs $$11 = new fbs($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hfb.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hfv.a> $$16 = this.t.a($$3.g() ? fdy.c.b : fdy.c.a);
                           hfv.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hfb $$0) {
      return bae.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hfb $$0) {
   ...
   public void a(fli $$0) {
      if (this.o && $$0.h()) {
         fea $$1 = new fea($$0.b(), new fbs($$0.l()), new fbs($$0.m()));
