...
public class asu {
   ...
   public static final Codec<Object> b = a(atf.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(atc.e($$0));
   ...
   public static final Codec<asu.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? agi.b($$0.substring(1)).map($$0x -> new asu.f($$0x, true)) : agi.b($$0).map($$0x -> new asu.f($$0x, false)), asu.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !agi.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> asu.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new asu.b<>($$0, $$1);
   }

   public static <K, V> asu.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new asu.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof asu.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(agi a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
