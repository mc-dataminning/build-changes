...
public abstract class asu implements AutoCloseable {
   ...
   protected asu(URL $$0, asu.b $$1, asu.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? ayz.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static asu a(aqf $$0) {
      String $$1 = $$0.R;
      if (bag.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<asf> a(GameProfile $$0, String $$1, asu.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(asf.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract asf a(String var1, asu.a var2, JsonObject var3);

   protected xl a(String $$0, JsonArray $$1, asu.a $$2) {
      if ($$1.isEmpty()) {
         return xl.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xl.b;
      } else {
         xl $$3 = new xl($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asu.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      asu.a a = ($$0, $$1) -> false;
      asu.a b = ($$0, $$1) -> $$0.length() == $$1;

      static asu.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static asu.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements asv {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bqo $$2 = new bqo(asu.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a_;
      }

      @Override
      public CompletableFuture<List<asf>> a(List<String> $$0) {
         List<CompletableFuture<asf>> $$1 = $$0.stream().map($$0x -> asu.this.a(this.b, $$0x, asu.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return ad.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<asf> a(String $$0) {
         return asu.this.a(this.b, $$0, asu.this.f, this.c);
      }
   }
