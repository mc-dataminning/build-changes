...
public class asu {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (asu.this.e.am()) {
                  $$1.addLast("legacy_query", new asn(asu.this.d()));
               }

               vt.a($$1, zi.a, false, null);
               int $$2 = asu.this.e.o();
               vt $$3 = (vt)($$2 > 0 ? new wk($$2) : new vt(zi.a));
               asu.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new asw(asu.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xa $$3 = xa.b("Internal server error");
                     $$1.a(new zq($$3), wh.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<asu.a.a> d = Lists.newArrayList();
