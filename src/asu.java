...
public class asu implements asq {
   ...
   private final Map<ass, List<Path>> h;

   asu(asp $$0, asi $$1, Set<String> $$2, List<Path> $$3, Map<ass, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(ass $$0, akr $$1, Consumer<Path> $$2) {
      v.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(ass $$0, String $$1, String $$2, asq.a $$3) {
      v.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<akr, atw<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asq.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      ast.a($$1, $$4, $$3, $$0);
   }
   ...
   public atw<InputStream> a(ass $$0, akr $$1) {
      return (atw<InputStream>)v.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && ast.a($$5)) {
               return atw.create($$5);
            }
         }
   ...
   public <T> T a(atd<T> $$0) {
      atw<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public auh d() {
      return $$0 -> Optional.ofNullable(this.a(ass.a, $$0)).map($$0x -> new auc(this, $$0x));
   }
}
