...
public class ayd {
   ...
   ayd(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ayd.a a() {
      return new ayd.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ayd::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ayd.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ayd a(Writer $$0) throws IOException {
         return new ayd($$0, this.a);
      }
   }
}
