...
public class ayd {
   ...
   private static final BiFunction<Integer, Schema, Schema> c = bfq::new;
   ...
   private static void a(DataFixerBuilder $$0) {
      ...
      $$0.addFixer(new azd($$2, false));
      Schema $$3 = $$0.addSchema(102, bfs::new);
      $$0.addFixer(new bce($$3, true));
      $$0.addFixer(new bcg($$3, false));
      Schema $$4 = $$0.addSchema(105, b);
      $$0.addFixer(new bck($$4, true));
      Schema $$5 = $$0.addSchema(106, bfu::new);
      $$0.addFixer(new bdg($$5, true));
      Schema $$6 = $$0.addSchema(107, bfv::new);
      $$0.addFixer(new bav($$6, true));
      Schema $$7 = $$0.addSchema(108, b);
      $$0.addFixer(new bbi($$7, true));
      Schema $$8 = $$0.addSchema(109, b);
      $$0.addFixer(new baq($$8, true));
      Schema $$9 = $$0.addSchema(110, b);
      $$0.addFixer(new bar($$9, true));
      Schema $$10 = $$0.addSchema(111, b);
      $$0.addFixer(new bax($$10, true));
      Schema $$11 = $$0.addSchema(113, b);
      $$0.addFixer(new bbc($$11, true));
      Schema $$12 = $$0.addSchema(135, bfx::new);
      $$0.addFixer(new bbe($$12, true));
      Schema $$13 = $$0.addSchema(143, bfy::new);
      $$0.addFixer(new bbk($$13, true));
      ...
      $$0.addFixer(new bcj($$29, false));
      $$0.addFixer(new azb($$29, false));
      Schema $$30 = $$0.addSchema(816, c);
      $$0.addFixer(new bdv($$30, false));
      Schema $$31 = $$0.addSchema(820, c);
      $$0.addFixer(bci.a($$31, "totem item renamer", a("minecraft:totem", "minecraft:totem_of_undying")));
      Schema $$32 = $$0.addSchema(1022, bft::new);
      $$0.addFixer(new bfm($$32, "added shoulder entities to players", beh.b));
      Schema $$33 = $$0.addSchema(1125, bfw::new);
      $$0.addFixer(new azo($$33, true));
      $$0.addFixer(new ayp($$33, false));
      Schema $$34 = $$0.addSchema(1344, c);
      $$0.addFixer(new bdt($$34, false));
      Schema $$35 = $$0.addSchema(1446, c);
      $$0.addFixer(new bdu($$35, false));
      Schema $$36 = $$0.addSchema(1450, c);
      $$0.addFixer(new azj($$36, false));
      Schema $$37 = $$0.addSchema(1451, bfz::new);
      $$0.addFixer(new ayl($$37, "AddTrappedChestFix", beh.s));
      Schema $$38 = $$0.addSchema(1451, 1, bga::new);
      $$0.addFixer(new azu($$38, true));
      Schema $$39 = $$0.addSchema(1451, 2, bgb::new);
      $$0.addFixer(new ayv($$39, true));
      Schema $$40 = $$0.addSchema(1451, 3, bgc::new);
      $$0.addFixer(new bai($$40, true));
      $$0.addFixer(new bcm($$40, false));
      Schema $$41 = $$0.addSchema(1451, 4, bgd::new);
      $$0.addFixer(new azf($$41, true));
      $$0.addFixer(new bcp($$41, false));
      Schema $$42 = $$0.addSchema(1451, 5, bge::new);
      $$0.addFixer(
         new bch(
            $$42,
            false,
      ...
      $$0.addFixer(new ayl($$42, "RemoveNoteBlockFlowerPotFix", beh.s));
      $$0.addFixer(new bcn($$42, false, "minecraft:spawn_egg"));
      $$0.addFixer(new bbn($$42, false));
      $$0.addFixer(new ayu($$42, false));
      $$0.addFixer(new bcy($$42, false));
      Schema $$43 = $$0.addSchema(1451, 6, bgf::new);
      $$0.addFixer(new beu($$43, true));
      $$0.addFixer(new ayy($$43, false));
      Schema $$44 = $$0.addSchema(1451, 7, c);
      $$0.addFixer(new bfg($$44, false));
      Schema $$45 = $$0.addSchema(1456, c);
      $$0.addFixer(new bau($$45, false));
      Schema $$46 = $$0.addSchema(1458, c);
      $$0.addFixer(new bam($$46, false));
      $$0.addFixer(new bcd($$46, false));
      $$0.addFixer(new ayw($$46, false));
      Schema $$47 = $$0.addSchema(1460, bgg::new);
      $$0.addFixer(new bay($$47, false));
      Schema $$48 = $$0.addSchema(1466, bgh::new);
      $$0.addFixer(new ayl($$48, "Add DUMMY block entity", beh.s));
      $$0.addFixer(new baa($$48, true));
      Schema $$49 = $$0.addSchema(1470, bgi::new);
      $$0.addFixer(new ayl($$49, "Add 1.13 entities fix", beh.y));
      Schema $$50 = $$0.addSchema(1474, c);
      $$0.addFixer(new bab($$50, false));
      $$0.addFixer(
         azh.a($$50, "Colorless shulker block fixer", $$0x -> Objects.equals(bfq.a($$0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : $$0x)
      );
      $$0.addFixer(
      ...
      $$0.addFixer(new bdh($$58, false, "Command block minecart custom name fix", beh.y, "minecraft:commandblock_minecart") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), bam::a);
         }
      });
      $$0.addFixer(new bcb($$58, false));
      Schema $$59 = $$0.addSchema(1490, c);
      $$0.addFixer(azh.a($$59, "Rename melon_block", a("minecraft:melon_block", "minecraft:melon")));
      $$0.addFixer(
         bci.a(
            $$59,
      ...
      $$0.addFixer(new azz($$60, false));
      Schema $$61 = $$0.addSchema(1494, c);
      $$0.addFixer(new bcl($$61, false));
      Schema $$62 = $$0.addSchema(1496, c);
      $$0.addFixer(new bcv($$62, false));
      Schema $$63 = $$0.addSchema(1500, c);
      $$0.addFixer(new ayz($$63, false));
      ...
      $$0.addFixer(new bcf($$74, false));
      Schema $$75 = $$0.addSchema(1904, bgp::new);
      $$0.addFixer(new ayl($$75, "Added Cats", beh.y));
      $$0.addFixer(new bak($$75, false));
      Schema $$76 = $$0.addSchema(1905, c);
      $$0.addFixer(new azx($$76, false));
      Schema $$77 = $$0.addSchema(1906, bgq::new);
      $$0.addFixer(new ayl($$77, "Add POI Blocks", beh.s));
      Schema $$78 = $$0.addSchema(1909, bgr::new);
      $$0.addFixer(new ayl($$78, "Add jigsaw", beh.s));
      Schema $$79 = $$0.addSchema(1911, c);
      $$0.addFixer(new azy($$79, false));
      Schema $$80 = $$0.addSchema(1914, c);
      $$0.addFixer(new bfi($$80, false));
      Schema $$81 = $$0.addSchema(1917, c);
      $$0.addFixer(new azk($$81, false));
      Schema $$82 = $$0.addSchema(1918, c);
      $$0.addFixer(new bfd($$82, "minecraft:villager"));
      $$0.addFixer(new bfd($$82, "minecraft:zombie_villager"));
      Schema $$83 = $$0.addSchema(1920, bgs::new);
      $$0.addFixer(new bdk($$83, false));
      $$0.addFixer(new ayl($$83, "Add campfire", beh.s));
      ...
      $$0.addFixer(new ayl($$87, "Added Fox", beh.y));
      Schema $$88 = $$0.addSchema(1936, c);
      $$0.addFixer(new bdq($$88, false));
      Schema $$89 = $$0.addSchema(1946, c);
      $$0.addFixer(new ben($$89, false));
      Schema $$90 = $$0.addSchema(1948, c);
      $$0.addFixer(new bdo($$90));
      Schema $$91 = $$0.addSchema(1953, c);
      $$0.addFixer(new bdn($$91, false));
      Schema $$92 = $$0.addSchema(1955, c);
      $$0.addFixer(new bff($$92, false));
      $$0.addFixer(new bfn($$92, false));
      Schema $$93 = $$0.addSchema(1961, c);
      $$0.addFixer(new azt($$93, false));
      Schema $$94 = $$0.addSchema(1963, c);
      $$0.addFixer(new bej($$94, false));
      ...
      $$0.addFixer(bci.a($$97, "Rename bee_hive item to beehive", $$98));
      $$0.addFixer(new beb($$97, "Rename bee_hive poi to beehive", $$98));
      $$0.addFixer(azh.a($$97, "Rename bee_hive block to beehive", $$98));
      Schema $$99 = $$0.addSchema(2211, c);
      $$0.addFixer(new bex($$99, false));
      Schema $$100 = $$0.addSchema(2218, c);
      $$0.addFixer(new bbv($$100, false));
      Schema $$101 = $$0.addSchema(2501, bgx::new);
      $$0.addFixer(new bbw($$101, true));
      Schema $$102 = $$0.addSchema(2502, bgy::new);
      $$0.addFixer(new ayl($$102, "Added Hoglin", beh.y));
      Schema $$103 = $$0.addSchema(2503, c);
      $$0.addFixer(new bfh($$103, false));
      $$0.addFixer(new ayn($$103, false, "Composter category change", a("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      Schema $$104 = $$0.addSchema(2505, bgz::new);
      $$0.addFixer(new ayl($$104, "Added Piglin", beh.y));
      $$0.addFixer(new bdd($$104, "minecraft:villager"));
      ...
      $$0.addFixer(new bcq($$108));
      Schema $$109 = $$0.addSchema(2516, c);
      $$0.addFixer(new bby($$109, "minecraft:villager"));
      $$0.addFixer(new bby($$109, "minecraft:zombie_villager"));
      Schema $$110 = $$0.addSchema(2518, c);
      $$0.addFixer(new bct($$110, false));
      $$0.addFixer(new bcu($$110, false));
      Schema $$111 = $$0.addSchema(2519, bhb::new);
      $$0.addFixer(new ayl($$111, "Added Strider", beh.y));
      Schema $$112 = $$0.addSchema(2522, bhc::new);
      $$0.addFixer(new ayl($$112, "Added Zoglin", beh.y));
      ...
      $$0.addFixer(new bew($$116, false));
      Schema $$117 = $$0.addSchema(2531, c);
      $$0.addFixer(new beg($$117));
      Schema $$118 = $$0.addSchema(2533, c);
      $$0.addFixer(new bfe($$118));
      Schema $$119 = $$0.addSchema(2535, c);
      $$0.addFixer(new bbg($$119));
      Schema $$120 = $$0.addSchema(2538, c);
      $$0.addFixer(new bcz($$120));
      Schema $$121 = $$0.addSchema(2550, c);
      $$0.addFixer(new bfk($$121));
      Schema $$122 = $$0.addSchema(2551, bhd::new);
      $$0.addFixer(new bfm($$122, "add types to WorldGenData", beh.J));
      ...
      Schema $$126 = $$0.addSchema(2568, bhe::new);
      $$0.addFixer(new ayl($$126, "Added Piglin Brute", beh.y));
      Schema $$127 = $$0.addSchema(2571, bhf::new);
      $$0.addFixer(new ayl($$127, "Added Goat", beh.y));
      Schema $$128 = $$0.addSchema(2679, c);
      $$0.addFixer(new azl($$128, false));
      Schema $$129 = $$0.addSchema(2680, c);
      $$0.addFixer(bci.a($$129, "Renamed grass path item to dirt path", a("minecraft:grass_path", "minecraft:dirt_path")));
      $$0.addFixer(azh.a($$129, "Renamed grass path block to dirt path", a("minecraft:grass_path", "minecraft:dirt_path")));
      Schema $$130 = $$0.addSchema(2684, bhg::new);
      $$0.addFixer(new ayl($$130, "Added Sculk Sensor", beh.s));
      Schema $$131 = $$0.addSchema(2686, bhh::new);
      $$0.addFixer(new ayl($$131, "Added Axolotl", beh.y));
      Schema $$132 = $$0.addSchema(2688, bhi::new);
      $$0.addFixer(new ayl($$132, "Added Glow Squid", beh.y));
      $$0.addFixer(new ayl($$132, "Added Glow Item Frame", beh.y));
      ...
      $$0.addFixer(new beo($$141));
      Schema $$142 = $$0.addSchema(2702, c);
      $$0.addFixer(new ayh($$142));
      Schema $$143 = $$0.addSchema(2704, bhj::new);
      $$0.addFixer(new ayl($$143, "Added Goat", beh.y));
      Schema $$144 = $$0.addSchema(2707, bhk::new);
      $$0.addFixer(new ayl($$144, "Added Marker", beh.y));
      $$0.addFixer(new ayk($$144, beh.J, "has_increased_height_already", true));
      ...
      Schema $$148 = $$0.addSchema(2831, bhl::new);
      $$0.addFixer(new bet($$148));
      Schema $$149 = $$0.addSchema(2832, bhm::new);
      $$0.addFixer(new bfl($$149));
      $$0.addFixer(new azs($$149));
      ...
      $$0.addFixer(new azw($$153));
      Schema $$154 = $$0.addSchema(2843, c);
      $$0.addFixer(new bdy($$154));
      $$0.addFixer(new bdj($$154, "Remove Deep Warm Ocean", beh.H, a("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      $$0.addFixer(new bfj($$156));
      Schema $$157 = $$0.addSchema(2967, c);
      $$0.addFixer(new bey($$157));
      Schema $$158 = $$0.addSchema(2970, c);
      $$0.addFixer(new bez($$158));
      Schema $$159 = $$0.addSchema(3076, bho::new);
      $$0.addFixer(new ayl($$159, "Added Sculk Catalyst", beh.s));
      Schema $$160 = $$0.addSchema(3077, c);
      $$0.addFixer(new azq($$160));
      Schema $$161 = $$0.addSchema(3078, bhp::new);
      $$0.addFixer(new ayl($$161, "Added Frog", beh.y));
      $$0.addFixer(new ayl($$161, "Added Tadpole", beh.y));
      $$0.addFixer(new ayl($$161, "Added Sculk Shrieker", beh.s));
      Schema $$162 = $$0.addSchema(3081, bhq::new);
      $$0.addFixer(new ayl($$162, "Added Warden", beh.y));
      Schema $$163 = $$0.addSchema(3082, bhr::new);
      $$0.addFixer(new ayl($$163, "Added Chest Boat", beh.y));
      Schema $$164 = $$0.addSchema(3083, bhs::new);
      $$0.addFixer(new ayl($$164, "Added Allay", beh.y));
      ...
      $$0.addFixer(new bbm($$166, "Change cat variant type", beh.y, "minecraft:cat", "CatType", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      ImmutableMap<String, String> $$167 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(new bac($$166, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", $$1x -> (String)$$167.getOrDefault($$1x, $$1x)));
      Schema $$168 = $$0.addSchema(3087, c);
      $$0.addFixer(new bbm($$168, "Change frog variant type", beh.y, "minecraft:frog", "Variant", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
         $$0x.put(0, "minecraft:temperate");
         $$0x.put(1, "minecraft:warm");
         $$0x.put(2, "minecraft:cold");
      })::get));
      Schema $$169 = $$0.addSchema(3090, c);
      $$0.addFixer(new baw($$169));
      Schema $$170 = $$0.addSchema(3093, c);
      $$0.addFixer(new bap($$170));
      Schema $$171 = $$0.addSchema(3094, c);
      $$0.addFixer(new bbx($$171));
      Schema $$172 = $$0.addSchema(3097, c);
      $$0.addFixer(new bbs($$172));
      $$0.addFixer(new bbt($$172));
      Map<String, String> $$173 = Map.of("minecraft:british", "minecraft:british_shorthair");
      $$0.addFixer(new bfc($$172, "Rename british shorthair", beh.y, "minecraft:cat", $$173));
      $$0.addFixer(
         new bac(
      ...
      $$0.addFixer(new bea($$172, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
      Schema $$174 = $$0.addSchema(3108, c);
      $$0.addFixer(new ayt($$174));
      Schema $$175 = $$0.addSchema(3201, c);
      $$0.addFixer(new bdw($$175));
      Schema $$176 = $$0.addSchema(3202, bht::new);
      $$0.addFixer(new ayl($$176, "Added Hanging Sign", beh.s));
      Schema $$177 = $$0.addSchema(3203, bhu::new);
      $$0.addFixer(new ayl($$177, "Added Camel", beh.y));
      Schema $$178 = $$0.addSchema(3204, bhv::new);
      $$0.addFixer(new ayl($$178, "Added Chiseled Bookshelf", beh.s));
      Schema $$179 = $$0.addSchema(3209, c);
      $$0.addFixer(new bcn($$179, false, "minecraft:pig_spawn_egg"));
      Schema $$180 = $$0.addSchema(3214, c);
      $$0.addFixer(new bdr($$180));
      Schema $$181 = $$0.addSchema(3319, c);
      $$0.addFixer(new bdp($$181));
      Schema $$182 = $$0.addSchema(3322, c);
      $$0.addFixer(new bag($$182));
      Schema $$183 = $$0.addSchema(3325, bhw::new);
      $$0.addFixer(new ayl($$183, "Added displays", beh.y));
      Schema $$184 = $$0.addSchema(3326, bhx::new);
      $$0.addFixer(new ayl($$184, "Added Sniffer", beh.y));
      Schema $$185 = $$0.addSchema(3327, bhy::new);
      $$0.addFixer(new ayl($$185, "Archaeology", beh.s));
      Schema $$186 = $$0.addSchema(3328, bhz::new);
      $$0.addFixer(new ayl($$186, "Added interaction", beh.y));
      Schema $$187 = $$0.addSchema(3438, bia::new);
      $$0.addFixer(aza.a($$187, "Rename Suspicious Sand to Brushable Block", a("minecraft:suspicious_sand", "minecraft:brushable_block")));
      $$0.addFixer(new baj($$187));
      $$0.addFixer(
         bci.a(
            $$187,
      ...
      $$0.addFixer(new ayl($$187, "Added calibrated sculk sensor", beh.s));
      Schema $$188 = $$0.addSchema(3439, c);
      $$0.addFixer(new azc($$188, "Updated sign text format for Signs", "minecraft:sign"));
      $$0.addFixer(new azc($$188, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema $$189 = $$0.addSchema(3440, c);
      $$0.addFixer(new bdj($$189, "Replace experimental 1.20 overworld", beh.I, a("minecraft:overworld_update_1_20", "minecraft:overworld")));
      $$0.addFixer(new bbr($$189, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema $$190 = $$0.addSchema(3441, c);
      $$0.addFixer(new ays($$190));
      ...
      Schema $$192 = $$0.addSchema(3448, bib::new);
      $$0.addFixer(new bad($$192));
      ...
      $$0.addFixer(new azr($$194));
      Schema $$195 = $$0.addSchema(3459, c);
      $$0.addFixer(new bcw($$195));
      Schema $$196 = $$0.addSchema(3564, c);
      $$0.addFixer(new bae($$196, "Drop invalid sign datafix data", "minecraft:sign"));
      $$0.addFixer(new bae($$196, "Drop invalid hanging sign datafix data", "minecraft:hanging_sign"));
      Schema $$197 = $$0.addSchema(3565, c);
      $$0.addFixer(new bed($$197));
      Schema $$198 = $$0.addSchema(3566, c);
      $$0.addFixer(new beq($$198));
      Schema $$199 = $$0.addSchema(3568, c);
      $$0.addFixer(new bdf($$199));
      Schema $$200 = $$0.addSchema(3682, bic::new);
      $$0.addFixer(new ayl($$200, "Added Crafter", beh.s));
      Schema $$201 = $$0.addSchema(3683, bid::new);
      $$0.addFixer(new bec($$201));
      Schema $$202 = $$0.addSchema(3685, bie::new);
      $$0.addFixer(new bbu($$202));
      Schema $$203 = $$0.addSchema(3689, bif::new);
      ...
      Schema $$210 = $$0.addSchema(3807, bih::new);
      $$0.addFixer(new ayl($$210, "Added Vault", beh.s));
      Schema $$211 = $$0.addSchema(3807, 1, c);
      $$0.addFixer(new bdb($$211));
      Schema $$212 = $$0.addSchema(3808, bii::new);
      $$0.addFixer(new bca($$212, "minecraft:horse", "ArmorItem"));
      Schema $$213 = $$0.addSchema(3808, 1, bij::new);
      $$0.addFixer(new bca($$213, "minecraft:llama", "DecorItem"));
      Schema $$214 = $$0.addSchema(3809, c);
      $$0.addFixer(new azn($$214));
      Schema $$215 = $$0.addSchema(3812, c);
      $$0.addFixer(new ayf($$215));
