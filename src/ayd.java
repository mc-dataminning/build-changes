...
public class ayd implements AutoCloseable {
   ...
   private ayd(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayd.a a(Path $$0) {
         return new ayd.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
