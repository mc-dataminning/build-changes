...
public class ayd {
   ...
   private static final Optional<Object> b = Optional.of(aym.a);

   private static boolean a(xd $$0, awx $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xd $$1, awx $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xd $$1, awx $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xd $$1, awx $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xd $$2, awx $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xd $$2, xd $$3, awx $$4) {
      int $$5 = $$0.length();
      xd $$6 = $$2;
   ...
   public static boolean a(wl $$0, xd $$1, awx $$2) {
