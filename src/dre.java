...
public abstract class dre {
   ...
   public final void c(uf $$0, jp.a $$1) {
      this.a($$0, $$1);
      dre.a.a.parse($$1.a(ut.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final uf d(jp.a $$0) {
      uf $$1 = new uf();
      this.b($$1, $$0);
      dre.a.a.encodeStart($$0.a(ut.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((uf)$$1x));
      return $$1;
   }
   ...
   public static void a(uf $$0, drg<?> $$1) {
      $$0.a("id", drg.a($$1).toString());
   }

   public void a(cvl $$0, jp.a $$1) {
      uf $$2 = this.e($$1);
      this.a($$2);
      $$0.c();
      ctl.a($$0, this.q(), $$2);
   ...
   @Nullable
   public static dre a(je $$0, dua $$1, uf $$2, jp.a $$3) {
      String $$4 = $$2.l("id");
      alb $$5 = alb.c($$4);
      if ($$5 == null) {
   ...
   protected static void a(dds $$0, je $$1, dua $$2) {
      $$0.q($$1);
      if (!$$2.l()) {
         $$0.c($$1, $$2.b());
      }
