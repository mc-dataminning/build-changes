...
public class fxe extends fpo<fxe.a> {
   ...
   public fxe(fxa $$0, flj $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public static class c extends fxe.a {
      ...
      protected final hix b;
      private long g;

      protected c(fxa $$0, hix $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = flj.Q();
      }
   ...
   public class d extends fxe.a {
      ...
      public void a(fod $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         wo $$15 = (wo)(this.i.g() == ggn.b.d ? this.i.h.f().a(n.m) : this.i.c);
      ...
      protected void a(fod $$0, int $$1, int $$2, aku $$3) {
