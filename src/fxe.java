...
public class fxe implements fws.a {
   private final evi a;
   private double b = Double.MIN_VALUE;
   private List<blv> c = Collections.emptyList();
   ...
   private void a(eqb $$0, fth $$1, double $$2, double $$3, double $$4, blv $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aD.ifPresent($$10 -> {
   ...
   private void a(hx $$0, eqb $$1, double $$2, double $$3, double $$4, fth $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      ftf.a($$1, $$5.getBuffer(ftp.w()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      ftf.a(
         $$1,
         $$5.getBuffer(ftp.w()),
         this.a.r.a_($$0).b(this.a.r, $$0, ely.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
