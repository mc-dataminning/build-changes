public class fxe extends fyk<gts> implements fxh {
   private final gbm a = this.v.b("head");
   private final gbm b = this.v.b("body");
   private final gbm c = this.b.b("right_arm");
   private final gbm d = this.b.b("left_arm");
   private final gbm e = this.b.b("right_wing");
   private final gbm f = this.b.b("left_wing");
   ...
   public static gbs a() {
      gbu $$0 = new gbu();
      gbw $$1 = $$0.a();
      gbw $$2 = $$1.a("root", gbr.c(), gbo.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", gbr.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new gbq(0.0F)), gbo.a(0.0F, -3.99F, 0.0F));
      gbw $$3 = $$2.a(
         "body",
         gbr.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new gbq(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new gbq(-0.2F)),
         gbo.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", gbr.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gbq(-0.01F)), gbo.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", gbr.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gbq(-0.01F)), gbo.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", gbr.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gbq(0.0F)), gbo.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", gbr.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gbq(0.0F)), gbo.a(0.5F, 0.0F, 0.6F));
