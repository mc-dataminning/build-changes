...
public class fxe implements est, AutoCloseable {
   ...
   private static final esm t = new esm();
   ...
   private final List<esu> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, esu> C = Maps.newHashMap();
   private final int D;
   ...
   public fxe(asi $$0, String $$1, eti $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ajc $$3 = new ajc("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = awc.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(awc.a($$5, "blend", null));
         this.H = a($$0, esr.a.a, $$6);
         this.I = a($$0, esr.a.b, $$7);
         this.D = ess.a();
         int $$18 = 0;
   ...
   private static esr a(final asi $$0, esr.a $$1, String $$2) throws IOException {
      esr $$3 = $$1.c().get($$2);
      esr $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         asd $$5 = $$0.getResourceOrThrow(new ajc($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = esr.a($$1, $$2, $$6, $$5.b(), new esk() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        fxe.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static esn a(JsonObject $$0) {
      if ($$0 == null) {
         return new esn();
      } else {
         int $$1 = 32774;
