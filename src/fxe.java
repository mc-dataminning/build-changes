...
public class fxe extends fxa {
   ...
   protected void l() {
      ...
      fmh<Integer> $$6 = new fmh<>("options.fullscreen.resolution", fmh.a(), ($$1x, $$2x) -> {
         if ($$2 == null) {
            return xv.c("options.fullscreen.unavailable");
         } else if ($$2x == -1) {
            return fmi.a($$1x, xv.c("options.fullscreen.current"));
         } else {
            ffs $$3x = $$2.a($$2x);
            return fmi.a($$1x, xv.a("options.fullscreen.entry", $$3x.a(), $$3x.b(), $$3x.f(), $$3x.c() + $$3x.d() + $$3x.e()));
         }
      }, new fmh.f(-1, $$2 != null ? $$2.e() - 1 : -1), $$3, $$2x -> {
         if ($$2 != null) {
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         if (this.z.g()) {
            ...
            this.m.a(new fxd(w, $$3, ImmutableList.of(new fxd.a(x, $$0x -> {
               this.c.k().a(flw.c);
               fme.Q().f.e();
               this.z.e();
               this.m.a(this);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (ftw.r()) {
         fmh<Integer> $$4 = this.c.at();
         if ($$4.e() instanceof fmh.c $$5) {
            int $$6 = $$4.c();
            int $$7 = $$6 == 0 ? $$5.b() + 1 : $$6;
            int $$8 = $$7 + (int)Math.signum($$3);
            if ($$8 != 0 && $$8 <= $$5.b() && $$8 >= $$5.d()) {
               fok<Integer> $$9 = (fok<Integer>)this.d.b($$4);
               if ($$9 != null) {
                  $$4.a($$8);
                  $$9.a($$8);
                  this.d.b(0.0);
