...
public class dnp extends dfi {
   public static final MapCodec<dnp> a = b(dnp::new);
   private static final dtl b = dtb.aT;
   ...
   private static int a(dch $$0, dsl $$1, ewd $$2, bsh $$3) {
      int $$4 = a($$2, $$2.e());
      int $$5 = $$3 instanceof cmr ? 20 : 8;
      if (!$$0.P().a($$2.a(), $$1.b())) {
         a($$0, $$1, $$4, $$2.a(), $$5);
      }
   ...
   private static int a(ewd $$0, ewh $$1) {
      jf $$2 = $$0.b();
   ...
   private static void a(dch $$0, dsl $$1, int $$2, ja $$3, int $$4) {
