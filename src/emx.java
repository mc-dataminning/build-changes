...
public class emx implements dxp.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<emx> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ays<emx> a = ays.a(f);
   private final enb g;
   private final enb h;
   private final enb i;
   ...
   public static emx a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new emx(new dyx(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private emx(enb $$0, enb $$1, enb $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public emx(azh $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         enb.a($$0, IntStream.rangeClosed(-15, 0)),
         enb.a($$0, IntStream.rangeClosed(-15, 0)),
         enb.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public emx a(azh $$0) {
      return new emx($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxp.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         emy $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(enb.b($$4 * $$13), enb.b($$5 * $$13), enb.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = enb.b($$1 * $$13);
         double $$21 = enb.b($$2 * $$13);
         double $$22 = enb.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            emy $$24 = this.g.a($$19);
            if ($$24 != null) {
