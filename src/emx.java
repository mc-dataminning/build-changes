...
public class emx extends enc {
   ...
   public List<elh.a> a(dhv $$0, BiConsumer<jj, dym> $$1, azs $$2, int $$3, jj $$4, ekr $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<emx.a> $$13 = Lists.newArrayList();
      $$13.add(new emx.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jj $$21 = $$4.b(azk.a($$19), $$12 - 1, azk.a($$20));
               jj $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  jj $$27 = new jj($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new emx.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<elh.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dhv $$0, BiConsumer<jj, dym> $$1, azs $$2, jj $$3, jj $$4, boolean $$5, ekr $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         jj $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jj $$13 = $$3.b(azk.d(0.5F + (float)$$12 * $$9), azk.d(0.5F + (float)$$12 * $$10), azk.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(drl.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dhv $$0, BiConsumer<jj, dym> $$1, azs $$2, int $$3, jj $$4, List<emx.a> $$5, ekr $$6) {
      for (emx.a $$7 : $$5) {
         int $$8 = $$7.a();
         jj $$9 = new jj($$4.u(), $$8, $$4.w());
