...
public class emx extends efv {
   ...
   private void a(st $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         if ($$2.b("NameTagVisibility", 8)) {
            emy.b $$8 = emy.b.a($$2.l("NameTagVisibility"));
            if ($$8 != null) {
               $$4.a($$8);
            }
         }
         ...
         if ($$2.b("DeathMessageVisibility", 8)) {
            emy.b $$9 = emy.b.a($$2.l("DeathMessageVisibility"));
            if ($$9 != null) {
               $$4.b($$9);
            }
         }
         ...
         if ($$2.b("CollisionRule", 8)) {
            emy.a $$10 = emy.a.a($$2.l("CollisionRule"));
            if ($$10 != null) {
               $$4.a($$10);
            }
         }
   ...
   private void b(st $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         emz $$4 = emz.a($$3).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$3, emz.a.d());
            return emz.a;
         });
         String $$5 = $$2.l("Name");
         vf $$6 = vf.a.a($$2.l("DisplayName"));
         emz.a $$7 = emz.a.a($$2.l("RenderType"));
