...
public final class emx implements AutoCloseable {
   ...
   public emx(int $$0, int $$1, boolean $$2) {
      this(emx.a.a, $$0, $$1, $$2);
   }

   public emx(emx.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private emx(emx.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static emx a(InputStream $$0) throws IOException {
      return a(emx.a.a, $$0);
   }

   public static emx a(@Nullable emx.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static emx a(ByteBuffer $$0) throws IOException {
      return a(emx.a.a, $$0);
   }

   public static emx a(byte[] $$0) throws IOException {
   ...
   public static emx a(@Nullable emx.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new emx($$0 == null ? emx.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public emx a(IntUnaryOperator $$0) {
      if (this.c != emx.a.a) {
         ...
         this.j();
         emx $$1 = new emx(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void b(int $$0, int $$1, int $$2) {
      if (this.c != emx.a.a) {
         ...
         int $$3 = this.a($$0, $$1);
         float $$4 = (float)asw.a.a($$2) / 255.0F;
         float $$5 = (float)asw.a.d($$2) / 255.0F;
         float $$6 = (float)asw.a.c($$2) / 255.0F;
         float $$7 = (float)asw.a.b($$2) / 255.0F;
         float $$8 = (float)asw.a.a($$3) / 255.0F;
         float $$9 = (float)asw.a.d($$3) / 255.0F;
         float $$10 = (float)asw.a.c($$3) / 255.0F;
         float $$11 = (float)asw.a.b($$3) / 255.0F;
         float $$13 = 1.0F - $$4;
         float $$14 = $$4 * $$4 + $$8 * $$13;
         float $$15 = $$5 * $$4 + $$9 * $$13;
         float $$16 = $$6 * $$4 + $$10 * $$13;
         ...
         this.a($$0, $$1, asw.a.a($$18, $$19, $$20, $$21));
      }
   }
      ...
      if (this.c != emx.a.a) {
         ...
         for (int $$1 = 0; $$1 < this.b(); $$1++) {
            for (int $$2 = 0; $$2 < this.a(); $$2++) {
               int $$3 = this.a($$2, $$1);
               $$0[$$2 + $$1 * this.a()] = asw.b.a(asw.a.a($$3), asw.a.b($$3), asw.a.c($$3), asw.a.d($$3));
            }
         }
   ...
   public void a(emx $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, emx $$4) {
      this.j();
      if ($$4.c() != this.c) {
