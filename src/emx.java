...
public class emx {
   ...
   @Deprecated
   public static emx a(azg $$0, emx.a $$1) {
      return new emx($$0, $$1, false);
   }

   public static emx a(azg $$0, int $$1, double... $$2) {
      return b($$0, new emx.a($$1, new DoubleArrayList($$2)));
   }

   public static emx b(azg $$0, emx.a $$1) {
      return new emx($$0, $$1, true);
   }

   private emx(azg $$0, emx.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<emx.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(emx.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(emx.a::b))
               .apply($$0, emx.a::new)
      );
      public static final Codec<ji<emx.a>> b = ala.a(lq.aH, a);
