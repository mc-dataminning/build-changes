...
public enum emx implements avl {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final avl.a<emx> t = avl.a(emx::values);
   public static final IntFunction<emx> u = ath.a(emx::a, values(), ath.a.a);
   private final int v;
   private final String w;

   private emx(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
