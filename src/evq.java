public class evq {
   ...
   private int a(ebw $$0, int $$1, int $$2, int $$3) {
      int $$4 = jx.c($$0.h($$1) + 1);
   ...
   public boolean a(dib $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dib $$0, int $$1, int $$2, iu $$3, dzz $$4, iu $$5, dzz $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dib $$0, iu $$1, dzz $$2) {
      iu.a $$3 = this.e.g($$1);
