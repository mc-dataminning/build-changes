...
public class dzo implements dkn.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzo> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ars<dzo> a = ars.a(f);
   private final dzs g;
   private final dzs h;
   private final dzs i;
   ...
   public static dzo a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzo(new dlv(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzo(dzs $$0, dzs $$1, dzs $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzo(ase $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzs.a($$0, IntStream.rangeClosed(-15, 0)),
         dzs.a($$0, IntStream.rangeClosed(-15, 0)),
         dzs.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzo a(ase $$0) {
      return new dzo($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dkn.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dzp $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzs.b($$4 * $$13), dzs.b($$5 * $$13), dzs.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzs.b($$1 * $$13);
         double $$21 = dzs.b($$2 * $$13);
         double $$22 = dzs.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dzp $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ary.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
