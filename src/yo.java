...
public class yo implements xe {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayl.b.validate(yo::b);
   private static final Codec<Object> e = Codec.either(d, xf.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xd $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yo> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xe.a<yo> c = new xe.a<>(b, "translatable");
   private static final xi f = xi.e("%");
   private static final xi g = xi.e("null");
   ...
   @Nullable
   private ua k;
   private List<xi> l = ImmutableList.of();
   ...
   private static yo a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yo($$0, $$1.orElse(null), a($$2));
   }

   public yo(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xi> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yp var4) {
            this.l = ImmutableList.of(xi.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xi> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yp(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xi a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xd) {
            ...
            return $$1 == null ? g : xi.e($$1.toString());
         }
      } else {
         throw new yp(this, $$0);
      }
   ...
   public xr a(@Nullable et $$0, @Nullable btj $$1, int $$2) throws CommandSyntaxException {
      ...
      return xr.a(new yo(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yo $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
