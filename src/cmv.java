...
public class cmv implements bqm, bqy {
   ...
   public final jr<cuo> h = jr.a(36, cuo.l);
   public final jr<cuo> i = jr.a(4, cuo.l);
   public final jr<cuo> j = jr.a(1, cuo.l);
   private final List<jr<cuo>> n = ImmutableList.of(this.h, this.i, this.j);
   public int k;
   public final cmw l;
   private int o;
   ...
   private boolean a(cuo $$0, cuo $$1) {
      return !$$0.e() && cuo.c($$0, $$1) && $$0.k() && $$0.I() < this.e_($$0);
   }
   ...
   public int d(cuo $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         cuo $$2 = this.h.get($$1);
         if (!this.h.get($$1).e() && cuo.c($$0, this.h.get($$1)) && !this.h.get($$1).m() && !$$2.B() && !$$2.b(km.g)) {
            return $$1;
         }
      }
   ...
   public int a(Predicate<cuo> $$0, int $$1, bqm $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
      $$3 += bqn.a(this, $$0, $$1 - $$3, $$4);
      $$3 += bqn.a($$2, $$0, $$1 - $$3, $$4);
      cuo $$5 = this.l.cb.g();
      $$3 += bqn.a($$5, $$0, $$1 - $$3, $$4);
      if ($$5.e()) {
   ...
   public cuo a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).e() ? bqn.a($$2, $$0, $$1) : cuo.l;
   }
   ...
   public void b(ux $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ur $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cuo $$4 = cuo.a(this.l.dR(), (vo)$$2).orElse(cuo.l);
   ...
   public cuo a(boolean $$0) {
      cuo $$1 = this.f();
      return $$1.e() ? cuo.l : this.a(this.k, $$0 ? $$1.I() : 1);
   }
}
