   ...
   public void a(arq $$0) {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new fex($$1, this.g.dB() + $$6, $$2);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               fex $$9 = new fex(this.g.dz() - this.a.dz(), 0.0, this.g.dF() - this.a.dF()).d();
               fex $$10 = new fex((double)azm.a(this.a.dK() * (float) (Math.PI / 180.0)), 0.0, (double)(-azm.b(this.a.dK() * (float) (Math.PI / 180.0)))).d();
               float $$11 = (float)$$10.b($$9);
               float $$12 = (float)(Math.acos((double)$$11) * 180.0F / (float)Math.PI);
               $$12 += 0.5F;
               if (this.d >= 5 && $$12 >= 0.0F && $$12 < 10.0F) {
                  double $$13 = 1.0;
                  fex $$14 = this.a.h(1.0F);
                  ...
                  fex $$21 = new fex($$18, $$19, $$20);
                  if (!this.a.aZ()) {
                     $$0.a(null, 1017, this.a.du(), 0);
                  }

                  crv $$22 = new crv($$0, this.a, $$21.d());
