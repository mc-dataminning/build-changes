...
public class cmh extends bxl implements coc {
   private static final Logger bK = LogUtils.getLogger();
   public static final akj<Integer> a = akn.a(cmh.class, akl.b);
   ...
   private final cme[] bR;
   public final cme c;
   private final cme bS;
   private final cme bT;
   private final cme bU;
   private final cme bV;
   private final cme bW;
   private final cme bX;
   private final cme bY;
   public float d;
   public float bF;
   public boolean bG;
   public int bH;
   ...
   private eeo bZ;
   private iv ca = iv.c;
   private final cmy cb;
   private int cc = 100;
   private float cd;
   private final exh[] ce = new exh[24];
   private final int[] cf = new int[24];
   private final exf cg = new exf();

   public cmh(bwr<? extends cmh> $$0, djh $$1) {
      super(bwr.P, $$1);
      this.c = new cme(this, "head", 1.0F, 1.0F);
      this.bS = new cme(this, "neck", 3.0F, 3.0F);
      this.bT = new cme(this, "body", 5.0F, 3.0F);
      this.bU = new cme(this, "tail", 2.0F, 2.0F);
      this.bV = new cme(this, "tail", 2.0F, 2.0F);
      this.bW = new cme(this, "tail", 2.0F, 2.0F);
      this.bX = new cme(this, "wing", 4.0F, 2.0F);
      this.bY = new cme(this, "wing", 4.0F, 2.0F);
      this.bR = new cme[]{this.c, this.bS, this.bT, this.bU, this.bV, this.bW, this.bX, this.bY};
      this.d(this.eT());
      this.ad = true;
      this.cb = new cmy(this);
   }
         ...
         if (this.gi()) {
            ...
            if (this.dU() instanceof arq $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.w(azm.h(this.dK()));
                  fex $$17 = $$10.a(this.dz(), this.dB(), this.dF()).d();
                  fex $$18 = new fex((double)azm.a(this.dK() * (float) (Math.PI / 180.0)), this.dx().e, (double)(-azm.b(this.dK() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new fex(0.0, 0.0, -1.0));
                  if (this.bG) {
            ...
            this.aV = this.dK();
            fex[] $$25 = new fex[this.bR.length];

            for (int $$26 = 0; $$26 < this.bR.length; $$26++) {
               $$25[$$26] = new fex(this.bR[$$26].dz(), this.bR[$$26].dB(), this.bR[$$26].dF());
            }
   ...
   private void a(cme $$0, double $$1, double $$2, double $$3) {
   ...
   private void gq() {
      ...
      if (this.ae.a(10) == 0) {
         List<cmg> $$0 = this.dU().a(cmg.class, this.cQ().g(32.0));
         cmg $$1 = null;
   ...
   public boolean a(arq $$0, cme $$1, bux $$2, float $$3) {
      if (this.cb.a().h() == cmx.j) {
         return false;
      } else {
         $$3 = this.cb.a().a($$2, $$3);
         if ($$1 != this.c) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof crj || $$2.a(axd.y)) {
               float $$4 = this.eF();
               this.d($$0, $$2, $$3);
   ...
   protected void em() {
      ...
      if (this.dU() instanceof arq $$4) {
         if (this.bH > 150 && this.bH % 5 == 0 && $$4.O().c(djd.g)) {
   ...
   public int n() {
      if (this.ce[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dU().a(egn.a.f, new iv($$3, 0, $$4)).v() + $$1);
            this.ce[$$0] = new exh($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      exh $$5 = new exh(azm.a($$0), azm.a($$1), azm.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public exj a(int $$0, int $$1, @Nullable exh $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         exh $$4 = this.ce[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private exj a(exh $$0, exh $$1) {
      List<exh> $$2 = Lists.newArrayList();
      exh $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new exj($$2, new iv($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(tz $$0) {
      super.a($$0);
      if ($$0.c("DragonPhase")) {
         this.cb.a(cmx.a($$0.f("DragonPhase")));
      }
   ...
   public fex J(float $$0) {
      cmr $$1 = this.cb.a();
      cmx<? extends cmr> $$2 = $$1.h();
      fex $$8;
      if ($$2 == cmx.d || $$2 == cmx.e) {
         iv $$3 = this.dU().a(egn.a.f, ejs.a(this.ca));
   ...
   public void a(arq $$0, cmg $$1, iv $$2, bux $$3) {
      crj $$5;
      if ($$3.d() instanceof crj $$4) {
         $$5 = $$4;
      } else {
