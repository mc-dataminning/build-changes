...
public class ayh {
   public static final Codec<ayh> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(axh.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), axh.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, ayh::new)
   );
   ...
   private final Predicate<akh> f;

   private ayh(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
