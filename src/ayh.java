...
public class ayh<T> extends AbstractList<T> implements azq<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return ayh.this.get(this.b--);
      }

      @Override
      public void remove() {
         ayh.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azq<T> {
      private final ayh<T> b;

      public b(final ayh<T> $$0) {
         this.b = $$0;
      }
