...
public class ayh extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bdn.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bdn.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bdn.s);
