...
public class ayh {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> ayj.b.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayh.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alf.b($$0.substring(1)).map($$0x -> new ayh.c($$0x, true)) : alf.b($$0).map($$0x -> new ayh.c($$0x, false)), ayh.c::c
      );
   ...
   public static Codec<String> A = Codec.STRING
      .validate($$0 -> !alf.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayh.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayh.b<>($$0, $$1);
   }
   ...
   public static record c(alf a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
