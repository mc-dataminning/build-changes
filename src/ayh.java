...
public class ayh extends bav {
   public ayh(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bbv.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bbv.z.typeName(), bdd.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bbv.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bbv.z.typeName(), "minecraft:saddle"));
