...
public class bak extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bgw.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bak::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bak::a);
      return this.a($$0, "minecraft:trident", bak::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bgw.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bgw.B, $$1);
