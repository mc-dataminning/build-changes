...
public abstract class bak extends DataFix {
   private final String a;

   public bak(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(baa.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(baa.x);
      Type<Pair<String, String>> $$2 = DSL.named(baa.v.typeName(), bbi.a());
      if (!Objects.equals(this.getOutputSchema().getType(baa.v), $$2)) {
