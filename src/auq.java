...
public class auq extends auh {
   ...
   private static final atl e = new atl(cuj.h);
   ...
   public static aun a(Path $$0, fdy $$1) {
      return new aun(new auq($$1), new aui($$0, atr.b, auo.e, $$1));
   }

   public static aun c() {
      return new aun(new auq(new fdy($$0 -> true)));
   }

   public static aun a(eyn.c $$0) {
      return a($$0.a(eyl.j), $$0.d().e());
   }
}
