...
public class auq<T> extends AbstractSet<T> {
   private static final int a = 10;
   private final Comparator<T> b;
   T[] c;
   int d;

   private auq(int $$0, Comparator<T> $$1) {
      this.b = $$1;
      if ($$0 < 0) {
   ...
   public static <T extends Comparable<T>> auq<T> a() {
      return a(10);
   }

   public static <T extends Comparable<T>> auq<T> a(int $$0) {
      return new auq<>($$0, Comparator.naturalOrder());
   }

   public static <T> auq<T> a(Comparator<T> $$0) {
      return a($$0, 10);
   }

   public static <T> auq<T> a(Comparator<T> $$0, int $$1) {
      return new auq<>($$1, $$0);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof auq<?> $$1 && this.b.equals($$1.b)) {
   ...
   class a implements Iterator<T> {
      ...
      public boolean hasNext() {
         return this.b < auq.this.d;
      }

      @Override
      public T next() {
         if (this.b >= auq.this.d) {
            throw new NoSuchElementException();
         } else {
            this.c = this.b++;
            return auq.this.c[this.c];
         }
      }
