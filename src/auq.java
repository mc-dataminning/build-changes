...
public class auq extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(ban.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", auq::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", auq::a);
      return this.a($$0, "minecraft:trident", auq::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(ban.x, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(ban.x, $$1);
