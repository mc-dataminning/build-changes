...
public class auq extends avc<auq.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public auq(auv $$0, List<aup> $$1, Executor $$2, Executor $$3, CompletableFuture<bak> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         AtomicLong $$6 = new AtomicLong();
         AtomicLong $$7 = new AtomicLong();
         bnz $$8 = new bnz(ad.c, () -> 0, false);
         bnz $$9 = new bnz(ad.c, () -> 0, false);
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new auq.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<auq.a> a(List<auq.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
   ...
   public static class a {
      ...
      a(String $$0, bof $$1, bof $$2, AtomicLong $$3, AtomicLong $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
