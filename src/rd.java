...
public class rd extends qw<rq> {
   private static final int b = 37;
   public static final rs<rd> a = new rs.b<rd>() {
      public rd a(DataInput $$0, int $$1, rg $$2) throws IOException {
         $$2.a(37L);
         if ($$1 > 512) {
            ...
            if ($$3 == 0 && $$4 > 0) {
               ...
               $$2.a(4L * (long)$$4);
               rs<?> $$5 = rt.a($$3);
               List<rq> $$6 = Lists.newArrayListWithCapacity($$4);
   ...
   public rd e() {
      ...
      return new rd($$1, this.w);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof rd && Objects.equals(this.c, ((rd)$$0).c);
   }
