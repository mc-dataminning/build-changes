...
public class bh extends cv<bh.a> {
   ...
   public static record a(Optional<bb> b, Optional<ci> c, Optional<bg> d) implements cv.a {
      public static final Codec<bh.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atq.a(bp.b, "player").forGetter(bh.a::a), atq.a(ci.a, "start_position").forGetter(bh.a::b), atq.a(bg.a, "distance").forGetter(bh.a::c)
               )
               .apply($$0, bh.a::new)
      );
      ...
      public boolean a(amz $$0, elm $$1, elm $$2) {
