public class bwo implements bwp {
   ...
   private void b() {
      this.a.aX = axm.c(this.a.aX, this.a.aZ, (float)this.a.aa());
   }
   ...
   private void d() {
      int $$0 = this.e - 10;
      float $$1 = axm.a((float)$$0 / 10.0F, 0.0F, 1.0F);
      float $$2 = (float)this.a.aa() * (1.0F - $$1);
      this.a.aX = axm.c(this.a.aX, this.a.aZ, $$2);
   }

   private boolean e() {
      return !(this.a.cQ() instanceof bqv);
   }
