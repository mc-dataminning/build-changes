...
public class gjr extends div implements gjk.a<gjr> {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final eek e = new eek();
   private final eeq<bwd> f = new eeq<>(bwd.class, new gjr.b());
   private final gjs E;
   private final gpn F;
   private final gpm G;
   private final gjr.a H;
   private final gpe I;
   private final buk J;
   private final fos K = fos.Q();
   final List<gom> L = Lists.newArrayList();
   final List<clt> M = Lists.newArrayList();
   private final Map<exz, eyb> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dig, fpv> Q = af.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(goz.a, new fpv($$0xx -> this.b($$0xx, goz.a)));
      $$0x.put(goz.b, new fpv($$0xx -> this.b($$0xx, goz.b)));
      $$0x.put(goz.c, new fpv($$0xx -> this.b($$0xx, goz.c)));
   });
   private final gjn R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final gle U = new gle();
   private final int V;
   private boolean W;
   private static final Set<cyu> X = Set.of(czc.ic, czc.id);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(iu $$0, dzz $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(iu $$0, dzz $$1, fei $$2) {
      dzz $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cqy $$4 = this.K.t;
   ...
   public gjr(gjs $$0, gjr.a $$1, alf<div> $$2, je<edw> $$3, int $$4, int $$5, gpn $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gjn(this, $$4);
      this.J = new buk();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new gpm(this.K, this, $$6);
      this.I = gpe.a($$3.a());
   ...
   private void a(bwd $$0, bwd $$1) {
      if ($$1.dQ() || $$1.dk() != $$0) {
         $$1.bP();
      } else if ($$1 instanceof cqy || this.e.c($$1)) {
         $$1.by();
         $$1.af++;
         $$1.r();
   ...
   public List<bwd> i(bwd $$0, fed $$1) {
      gop $$2 = this.K.t;
      return $$2 != null && $$2 != $$0 && $$2.cR().c($$1) && bwk.a($$0).test($$2) ? List.of($$2) : List.of();
   }
   ...
   private dma o() {
      if (this.K.r.i() == dis.b) {
         cyy $$0 = this.K.t.fa();
         cyu $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cxg $$2) {
            return $$2.c();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azv $$4, @Nullable dma $$5, iu.a $$6) {
   ...
   private void a(iu $$0, dzz $$1, lv $$2, boolean $$3) {
      if ($$1.y().c()) {
         ffc $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(ja.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(iu $$0, lv $$1, ffc $$2, double $$3) {
   ...
   public void a(@Nullable bwd $$0, bwd $$1, je<awm> $$2, awo $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hmm)(new hmd($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bwd $$0, awm $$1, awo $$2, float $$3, float $$4) {
      this.K.ak().a((hmm)(new hmd($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }

   @Override
   public void a(awm $$0, awo $$1, float $$2, float $$3) {
      if (this.K.t != null) {
         this.K.ak().a((hmm)(new hmd($$0, $$1, $$2, $$3, this.K.t, this.A.g())));
      }
   }
   ...
   private void a(double $$0, double $$1, double $$2, awm $$3, awo $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hmh $$10 = new hmh($$3, $$4, $$5, $$6, azv.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<dbm> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gmk.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public je<djy> a(int $$0, int $$1, int $$2) {
      return this.F_().f(mg.aG).b(dkf.b);
   }
   ...
   public int a(fei $$0, float $$1) {
      float $$2 = this.f($$1);
      fei $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fei $$4 = aym.a($$3, ($$0x, $$1x, $$2x) -> fei.a(this.D_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(iu $$0, dig $$1) {
      fpv $$2 = (fpv)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(iu $$0, dig $$1) {
      int $$2 = fos.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<exz, eyb> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<exz, eyb> $$0) {
      this.N.putAll($$0);
   }
   ...
   @Override
   public int s(iu $$0) {
      return fos.Q().aw().a(this.a_($$0), this, $$0, 0);
   }

   @Override
   public void registerForCleaning(gjk<gjr, ?> $$0) {
      this.E.a($$0);
   }

   public static class a implements eyu {
      ...
      public a(bty $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements eem<bwd> {
      public void a(bwd $$0) {
      }
      ...
      public void e(bwd $$0) {
         ...
         switch ($$0) {
            case gom $$1:
               ...
               break;
            case clw $$2:
               gjr.this.M.addAll(Arrays.asList($$2.q()));
               break;
         }
      }
      ...
      public void f(bwd $$0) {
         ...
         switch ($$0) {
            case gom $$1:
               ...
               break;
            case clw $$2:
               gjr.this.M.removeAll(Arrays.asList($$2.q()));
               break;
         }
      }
