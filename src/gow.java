...
public class gow {
   public static class a implements gpp<md> {
      ...
      public gpm a(md $$0, gmd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gow.b $$8 = new gow.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gqm {
      b(gmd $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azq.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gpy {
      private boolean b;
      private boolean F;
      private final gpo G;
      private float H;
      ...
      c(gmd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gpo $$7, gqh $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gow.c $$0 = new gow.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gpp<md> {
      ...
      public gpm a(md $$0, gmd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gow.c $$8 = new gow.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, frf.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gpk {
      ...
      private int D;
      private final gpo E;
      private final List<dco> F;
      private boolean G;

      public e(gmd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gpo $$7, List<dco> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, aws.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gpm $$12 = this.E.a(lz.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)aya.b($$11) / 255.0F, (float)aya.c($$11) / 255.0F, (float)aya.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               awq $$14 = $$13 ? awr.jw : awr.jv;
               this.c.a(this.g, this.h, this.i, $$14, aws.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gow.c $$10 = (gow.c)this.E.a(lz.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azq.d($$18, $$13, $$16) * $$0;
                  double $$20 = azq.d($$18, $$14, $$17) * $$0;
