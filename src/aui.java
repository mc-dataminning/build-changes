...
class aui implements Path {
   private static final BasicFileAttributes a = new aug() {
      @Override
   ...
   private static final BasicFileAttributes b = new aug() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aui> c = Comparator.comparing(aui::n);
   ...
   public aui(auk $$0, String $$1, @Nullable aui $$2, aul $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aui a(@Nullable aui $$0, String $$1) {
      return new aui(this.e, $$1, $$0, aul.b);
   }
   ...
   aui a(String $$0) {
      if (a(this.i)) {
         return new aui(this.e, $$0, this, this.i);
      } else if (this.i instanceof aul.a $$1) {
         aui $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aui(this.e, $$0, this, aul.a);
      } else if (this.i instanceof aul.b) {
         return new aui(this.e, $$0, this, aul.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aul $$0) {
      return $$0 == aul.a || $$0 == aul.b;
   }
   ...
   private aui c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aui $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aul.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aul.a i() {
      return this.i instanceof aul.a $$0 ? $$0 : null;
   }
