...
public class aui extends atw<GameProfile> {
   public aui(@Nullable GameProfile $$0) {
      this($$0, null, null, null, null);
   }

   public aui(@Nullable GameProfile $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public ws e() {
      ...
      return $$0 != null ? ws.b($$0.getName()) : ws.c("commands.banlist.entry.unknown");
   }
