...
public class ejc {
   ...
   @Nullable
   private String g;
   private static final ejc.a h = new ejc.a() {
      @Nullable
      @Override
      public ejb a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ejf.a(this.d, "Get capabilities")) {
         ...
         int $$5 = this.i();
         int $$6 = arp.a((int)arp.c((float)$$5), 2, 8);
         int $$7 = arp.a($$5 - $$6, 8, 255);
         this.i = new ejc.b($$7);
         this.j = new ejc.b($$6);
         ALCapabilities $$8 = AL.createCapabilities($$2);
         ejf.a("Initialization");
         if (!$$8.AL_EXT_source_distance_model) {
            ...
            if (!$$8.AL_EXT_LINEAR_DISTANCE) {
               ...
               ejf.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ejf.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ejb a(ejc.c $$0) {
      return ($$0 == ejc.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ejc.a {
      private final int a;
      private final Set<ejb> b = Sets.newIdentityHashSet();
      ...
      public ejb a() {
         if (this.b.size() >= this.a) {
            if (aa.aS) {
               ejc.a.warn("Maximum sound pool size {} reached", this.a);
            }
