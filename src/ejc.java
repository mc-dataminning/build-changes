...
public class ejc extends ejh {
   public static final MapCodec<ejc> a = eiq.a.fieldOf("provider").xmap(ejc::new, $$0 -> $$0.b);
   private final eiq b;
