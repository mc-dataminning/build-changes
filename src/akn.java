...
public class akn extends IOException {
   private final List<akn.a> a = Lists.newArrayList();
   private final String b;

   public akn(String $$0) {
      this.a.add(new akn.a());
      this.b = $$0;
   }

   public akn(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new akn.a());
      this.b = $$0;
   }
   ...
   public static akn a(Exception $$0) {
      if ($$0 instanceof akn) {
         return (akn)$$0;
      } else {
