...
public abstract class bwj extends byc {
   private static final akl<Boolean> bI = akp.a(bwj.class, akn.k);
   ...
   protected bwj(bxc<? extends bwj> $$0, djx $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bwj a(ars var1, bwj var2);
   ...
   @Override
   protected void j() {
      if (!this.n_() && this.bY() && this.dk() instanceof cui $$0 && !$$0.b((bwt)this)) {
         this.bO();
      }
   }
