...
public abstract class bwj extends buk implements bgl, bir, bjg, bjj, bjp {
   ...
   private static final Predicate<biy> cc = $$0 -> $$0 instanceof bwj && ((bwj)$$0).gt();
   private static final btl cd = btl.b().a(16.0).d().a(cc);
   private static final cly ce = cly.a(cjb.oI, cjb.qM, csn.ij.k(), cjb.nF, cjb.tq, cjb.pm, cjb.pn);
   private static final adz<Byte> cv = aec.a(bwj.class, aeb.a);
   ...
   protected bwj(bim<? extends bwj> $$0, cpm $$1) {
      super($$0, $$1);
      this.t(1.0F);
      this.gv();
   }
   ...
   protected void gp() {
      ...
      this.bO.a(3, new brc(this, 1.25, cly.a(cjb.tq, cjb.pm, cjb.pn), false));
   }
   ...
   public void a(@Nullable aox $$0) {
      this.cp.a(0, new ciy(cjb.mZ));
   }

   public void b(cbn $$0, ciy $$1) {
      if (this.l($$1)) {
         this.cp.a(1, $$1.c(1));
         if (!$$0.fR().d) {
            $$1.h(1);
   ...
   public int v(int $$0) {
      int $$1 = arp.a(this.gu() + $$0, 0, this.gA());
      this.u($$1);
      return $$1;
   }
   ...
   private boolean b(czz $$0) {
      return $$0 == czz.b || $$0 == czz.aP || $$0 == czz.B || $$0 == czz.aQ || $$0 == czz.aO;
   }
   ...
   public static bke.a gz() {
      return bja.x().a(bkf.n).a(bkf.a, 53.0).a(bkf.d, 0.225F);
   }
   ...
   public void b_() {
      ...
      if (!this.dK().B && this.bv()) {
         ...
         if (this.gC()) {
            if (!this.gr() && !this.bO() && this.ag.a(300) == 0 && this.dK().a_(this.dk().d()).a(csn.i)) {
               this.A(true);
            }
   ...
   protected void gB() {
      if (this.gt() && this.i_() && !this.gr()) {
         biy $$0 = this.dK().a(bwj.class, cd, this, this.dp(), this.dr(), this.dv(), this.cG().g(16.0));
   ...
   protected ehe b(cbn $$0, ehe $$1) {
      if (this.aA() && this.cr == 0.0F && this.gs() && !this.cs) {
         ...
         return new ehe((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void a(bid $$0, bwj $$1) {
      this.a($$0, $$1, bkf.a, (double)bY, (double)bZ);
      this.a($$0, $$1, bkf.n, (double)bW, (double)bX);
      this.a($$0, $$1, bkf.d, (double)bT, (double)bU);
   }

   private void a(bid $$0, bwj $$1, bka $$2, double $$3, double $$4) {
   ...
   private bjr a(final int $$0, final Predicate<ciy> $$1) {
      return new bjr() {
         @Override
         public ciy a() {
            return bwj.this.cp.a($$0);
         }
   ...
   public bjr a_(int $$0) {
      ...
      if ($$1 >= 0 && $$1 < 2 && $$1 < this.cp.b()) {
         if ($$1 == 0) {
            return this.a($$1, $$0x -> $$0x.b() || $$0x.a(cjb.mZ));
         }
      ...
      int $$2 = $$0 - 500 + 2;
      return $$2 >= 2 && $$2 < this.cp.b() ? bjr.a(this.cp, $$2) : super.a_($$0);
   }
   ...
   private ehe a(ehe $$0, biy $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (cdj.a($$8)) {
               egz $$9 = $$1.e($$6);
               ehe $$10 = new ehe($$2, (double)$$5.v() + $$8, $$4);
               if (cdj.a(this.dK(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public ehe b(biy $$0) {
      ehe $$1 = a((double)this.df(), (double)$$0.df(), this.dA() + ($$0.fk() == bis.b ? 90.0F : -90.0F));
      ehe $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         ehe $$3 = a((double)this.df(), (double)$$0.df(), this.dA() + ($$0.fk() == bis.a ? 90.0F : -90.0F));
         ehe $$4 = this.a($$3, $$0);
