...
public class fox implements Comparable<fox> {
   private static final Map<String, fox> h = Maps.newHashMap();
   private static final Map<fif.a, fox> i = Maps.newHashMap();
   ...
   private final fif.a m;
   private final String n;
   private fif.a o;
   private boolean p;
   private int q;

   public static void a(fif.a $$0) {
      fox $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(fif.a $$0, boolean $$1) {
      fox $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fox $$0 : h.values()) {
         if ($$0.o.a() == fif.b.a && $$0.o.b() != fif.bv.b()) {
            $$0.a(fif.a(foz.Q().aO().h(), $$0.o.b()));
         }
      }
   }
   ...
   public fox(String $$0, int $$1, String $$2) {
      this($$0, fif.b.a, $$1, $$2);
   }

   public fox(String $$0, fif.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(fif.a $$0) {
      this.o = $$0;
   }

   public int a(fox $$0) {
      return this.n.equals($$0.n) ? hke.a(this.l).compareTo(hke.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(fox $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(fif.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == fif.bv.b() ? this.o.a() == fif.b.b && this.o.b() == $$1 : this.o.a() == fif.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == fif.b.c && this.o.b() == $$0;
   }
