...
public class fox {
   private static final fpj a = fpj.s(new afw("textures/map/map_background.png"));
   private static final fpj b = fpj.s(new afw("textures/map/map_background_checkerboard.png"));
   ...
   private final ero au;
   private ckj av = ckj.b;
   private ckj aw = ckj.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fub aB;
   private final fvb aC;

   public fox(ero $$0, fub $$1, fvb $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bkj $$0, ckj $$1, ckg $$2, boolean $$3, emh $$4, fpb $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dL(), $$6, fzr.d, $$0.ah() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = asy.a($$1, 0.0F, 1.0F);
      return -asy.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(emh $$0, fpb $$1, int $$2, bkd $$3) {
      fzd $$4 = (fzd)this.aB.<fnz>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bkd.b ? 1.0F : -1.0F;
   ...
   private void a(emh $$0, fpb $$1, int $$2, float $$3, bkd $$4, float $$5, ckj $$6) {
      float $$7 = $$4 == bkd.b ? 1.0F : -1.0F;
      ...
      float $$8 = asy.c($$5);
      float $$9 = asy.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * asy.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * asy.a($$5 * (float) Math.PI);
   ...
   private void a(emh $$0, fpb $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = asy.c($$5);
      float $$7 = -0.2F * asy.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * asy.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = asy.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(emh $$0, fpb $$1, int $$2, ckj $$3) {
      ...
      Integer $$4 = ckq.d($$3);
      eco $$5 = ckq.a($$4, this.au.r);
      eml $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(emh $$0, fpb $$1, int $$2, float $$3, float $$4, bkd $$5) {
      boolean $$6 = $$5 != bkd.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = asy.c($$4);
      float $$9 = -0.3F * asy.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * asy.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * asy.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = asy.a($$4 * $$4 * (float) Math.PI);
      float $$13 = asy.a($$8 * (float) Math.PI);
   ...
   private void a(emh $$0, float $$1, bkd $$2, ckj $$3) {
      float $$4 = (float)this.au.s.fq() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = asy.e(asy.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(emh $$0, float $$1, bkd $$2, ckj $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * asy.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bkd.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(emh $$0, bkd $$1, float $$2) {
      int $$3 = $$1 == bkd.b ? 1 : -1;
      float $$4 = asy.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = asy.a(asy.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(emh $$0, bkd $$1, float $$2) {
      int $$3 = $$1 == bkd.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, emh $$1, fpb.a $$2, foc $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bia $$6 = (bia)MoreObjects.firstNonNull($$3.aG, bia.a);
      float $$7 = asy.i($$0, $$3.O, $$3.dD());
      fox.a $$8 = a($$3);
      float $$9 = asy.i($$0, $$3.cu, $$3.cs);
      float $$10 = asy.i($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bia.a ? $$5 : 0.0F;
         float $$12 = 1.0F - asy.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bia.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bia.b ? $$5 : 0.0F;
         float $$14 = 1.0F - asy.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bia.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fox.a a(foc $$0) {
      ckj $$1 = $$0.eS();
      ckj $$2 = $$0.eT();
      boolean $$3 = $$1.a(ckm.nG) || $$2.a(ckm.nG);
      boolean $$4 = $$1.a(ckm.uZ) || $$2.a(ckm.uZ);
      if (!$$3 && !$$4) {
         return fox.a.a;
      } else if ($$0.fn()) {
         return b($$0);
      } else {
         return a($$1) ? fox.a.b : fox.a.a;
      }
   }

   private static fox.a b(foc $$0) {
      ckj $$1 = $$0.fp();
      bia $$2 = $$0.fo();
      if (!$$1.a(ckm.nG) && !$$1.a(ckm.uZ)) {
         return $$2 == bia.a && a($$0.eT()) ? fox.a.b : fox.a.a;
      } else {
         return fox.a.a($$2);
      }
   }
   ...
   private static boolean a(ckj $$0) {
      return $$0.a(ckm.uZ) && cir.d($$0);
   }

   private void a(fnz $$0, float $$1, float $$2, bia $$3, float $$4, ckj $$5, float $$6, emh $$7, fpb $$8, int $$9) {
      if (!$$0.gq()) {
         boolean $$10 = $$3 == bia.a;
         bkd $$11 = $$10 ? $$0.fm() : $$0.fm().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.cd()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               ...
               float $$16 = $$15 / (float)cir.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = asy.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * asy.a(asy.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * asy.a(asy.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * asy.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? ckg.e : ckg.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bkd.b;
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * asy.a(asy.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * asy.a(asy.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * asy.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? ckg.e : ckg.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.y()) {
         this.ax = asy.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = asy.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + asy.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + asy.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
