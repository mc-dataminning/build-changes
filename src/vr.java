...
public class vr extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<ut> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, uf.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<ut> $$0, Codec<T> $$1, uf $$2) {
      ut $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vr a(DynamicOps<ut> $$0, Codec<T> $$1, T $$2) {
      ut $$3 = (ut)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = aza.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yu<? super vr, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yv<? super vr, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yu<? super vr, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yu<? super vr, K> $$1, yu<? super vr, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yu<? super vr, K> $$0, yu<? super vr, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yv<? super vr, K> $$1, yv<? super vr, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yv<? super vr, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yu<? super vr, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yu<? super vr, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yu<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yv<? super vr, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yv<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static jj b(ByteBuf $$0) {
      return jj.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, jj $$1) {
      $$0.writeLong($$1.a());
   }

   public dgw f() {
      return new dgw(this.readLong());
   }
   ...
   public static dgw c(ByteBuf $$0) {
      return new dgw($$0.readLong());
   }

   public static void a(ByteBuf $$0, dgw $$1) {
      $$0.writeLong($$1.a());
   }

   public kl g() {
      return kl.a(this.readLong());
   }
   ...
   public static fcu f(ByteBuf $$0) {
      return new fcu($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, fcu $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public <T> vr a(ToIntFunction<T> $$0, T $$1) {
   ...
   public vr a(@Nullable ut $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable ut $$1) {
      if ($$1 == null) {
         $$1 = ty.b;
      }

      try {
         uj.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static tw h(ByteBuf $$0) {
      ut $$1 = a($$0, uf.a(2097152L));
      if ($$1 != null && !($$1 instanceof tw)) {
   ...
   @Nullable
   public static ut a(ByteBuf $$0, uf $$1) {
      try {
         ut $$2 = uj.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public vr a(String $$0, int $$1) {
      wl.a(this.d, $$0, $$1);
      return this;
   }

   public ald q() {
      return ald.a(this.d(32767));
   }
   ...
   public <T> alc<T> a(alc<? extends kf<T>> $$0) {
      ald $$1 = this.q();
      return alc.a($$0, $$1);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, azk.e($$1, 8)));
      }
   }
   ...
   public vr a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vr a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vr a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vr a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vr a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vr a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vr a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vr a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public vr b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vr c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vr d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vr e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vr f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vr g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vr h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vr a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vr b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vr i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vr a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vr a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vr b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vr b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vr b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vr b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vr b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vr b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vr j(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vr c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vr a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vr a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public vr a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vr a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vr a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public vr k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vr d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vr b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vr b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vr b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
