...
public class vr extends SimpleChannelInboundHandler<zf<?>> {
   ...
   private static final wg<aiz> j = aiy.b;
   private final zg k;
   private volatile boolean l = true;
   private final Queue<Consumer<vr>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               ...
               if ($$2) {
                  ...
                  if (this.g() == zg.b) {
                     zf<?> $$7 = (zf<?>)(this.l ? new ajf($$3) : new zo($$3));
   ...
   public void a(String $$0, int $$1, akb $$2) {
      this.a($$0, $$1, akh.b, akh.d, $$2, aiv.a);
   }

   public void a(String $$0, int $$1, ajb $$2) {
      this.a($$0, $$1, aji.b, aji.d, $$2, aiv.b);
   }

   public <S extends wk, C extends vo> void a(String $$0, int $$1, wg<S> $$2, wg<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? aiv.c : aiv.b);
   }

   private <S extends wk, C extends vo> void a(String $$0, int $$1, wg<S> $$2, wg<C> $$3, C $$4, aiv $$5) {
      if ($$2.a() != $$3.a()) {
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final vr $$2) {
   ...
   public static void a(ChannelPipeline $$0, zg $$1, boolean $$2, @Nullable vk $$3) {
      zg $$4 = $$1.a();
      boolean $$5 = $$1 == zg.a;
      boolean $$6 = $$4 == zg.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wc<aiz>(j) : new wn.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wd<aiz>(j) : new wn.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new vy() : new ws());
   }

   private static ChannelInboundHandler a(@Nullable vk $$0, boolean $$1) {
      if (!$$1) {
         return new wr($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new vz($$0) : new vx());
      }
   }
   ...
   public static vr a(SocketAddress $$0) {
      final vr $$1 = new vr(zg.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vm($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new vn($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof vp $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new vp($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof vq $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new vq($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof vp) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof vq) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            if ($$1 != null) {
               vt $$2 = Objects.requireNonNullElseGet(this.l(), () -> new vt(wy.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
