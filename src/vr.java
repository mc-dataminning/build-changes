...
public class vr extends ByteBuf {
   ...
   @Deprecated
   public <T> vr a(DynamicOps<uu> $$0, Codec<T> $$1, T $$2) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yt<? super vr, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yu<? super vr, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yt<? super vr, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yt<? super vr, K> $$1, yt<? super vr, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yt<? super vr, K> $$0, yt<? super vr, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yu<? super vr, K> $$1, yu<? super vr, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yu<? super vr, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yt<? super vr, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yt<? super vr, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yt<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yu<? super vr, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yu<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static ja b(ByteBuf $$0) {
      return ja.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, ja $$1) {
      $$0.writeLong($$1.a());
   }

   public dbn f() {
      return new dbn(this.readLong());
   }
   ...
   public ewh k() {
      return new ewh(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> akj<T> a(akj<? extends jw<T>> $$0) {
      akk $$1 = this.q();
      return akj.a($$0, $$1);
   }
   ...
   public ewd v() {
      ...
      return new ewd(new ewh((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public vr g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vr b(ByteBuf $$0, int $$1) {
