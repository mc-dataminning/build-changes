...
public class dpf extends dph {
   ...
   private static void a(dby $$0, iz $$1, dsc $$2, dpf $$3, dpf.a $$4) {
      if ($$3.b) {
         $$3.a++;
      }
   ...
   public static void a(dby $$0, iz $$1, dsc $$2, dpf $$3) {
      a($$0, $$1, $$2, $$3, dpf::b);
   }

   public static void b(dby $$0, iz $$1, dsc $$2, dpf $$3) {
      a($$0, $$1, $$2, $$3, dpf::a);
   }
   ...
   private void b() {
      ...
      if (this.n.Z() > this.l + 60L || this.m == null) {
         this.l = this.n.Z();
         evm $$1 = new evm($$0).g(48.0);
         this.m = this.n.a(btp.class, $$1);
      }

      if (!this.n.B) {
         for (btp $$2 : this.m) {
            if ($$2.bD() && !$$2.dK() && $$0.a($$2.dn(), 32.0)) {
               $$2.dS().a(cct.D, this.n.Z());
            }
         }
      }
   }

   private static boolean a(iz $$0, List<btp> $$1) {
      for (btp $$2 : $$1) {
   ...
   private static void a(dby $$0, iz $$1, List<btp> $$2) {
      $$2.stream().filter($$1x -> a($$1, $$1x)).forEach(dpf::a);
   }

   private static void b(dby $$0, iz $$1, List<btp> $$2) {
   ...
   private static boolean a(iz $$0, btp $$1) {
      return $$1.bD() && !$$1.dK() && $$0.a($$1.dn(), 48.0) && $$1.ak().a(awt.c);
   }

   private static void a(btp $$0) {
      $$0.b(new bsc(bse.x, 60));
   }

   @FunctionalInterface
   interface a {
      void run(dby var1, iz var2, List<btp> var3);
   }
}
