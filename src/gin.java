...
public class gin {
   ...
   public final Map<jj, gio> c;
   public final gip d;
   public final boolean e;
   public final int f;

   public gin(Vector3f $$0, Vector3f $$1, Map<jj, gio> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gin(Vector3f $$0, Vector3f $$1, Map<jj, gio> $$2, @Nullable gip $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jj, gio> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gin> {
      private static final boolean a = true;
      private static final int b = 0;

      public gin a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gip $$6 = this.a($$3);
         Map<jj, gio> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayt.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayt.a($$3, "shade", true);
            int $$9 = 0;
            if ($$3.has("light_emission")) {
               boolean $$10 = ayt.b($$3, "light_emission");
               if ($$10) {
                  $$9 = ayt.o($$3, "light_emission");
               }
            ...
            return new gin($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gip a(JsonObject $$0) {
         gip $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = ayt.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            jj.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = ayt.a($$2, "rescale", false);
            $$1 = new gip($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = ayt.m($$0, "angle");
         if ($$1 != 0.0F && azd.e($$1) != 22.5F && azd.e($$1) != 45.0F) {
      ...
      private Map<jj, gio> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jj, gio> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jj, gio> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jj, gio> $$2 = Maps.newEnumMap(jj.class);
         JsonObject $$3 = ayt.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jj $$5 = this.a($$4.getKey());
            $$2.put($$5, (gio)$$0.deserialize($$4.getValue(), gio.class));
         }
