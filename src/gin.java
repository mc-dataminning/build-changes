...
public class gin implements gis.a {
   ...
   private final fgj J;
   private final Map<ir, gin.a> K = Maps.newHashMap();
   private final Map<UUID, aaj.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         brv $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dP();
      });
   }

   private void b(fbc $$0, gfg $$1, double $$2, double $$3, double $$4) {
      ir $$5 = ir.a($$2, $$3, $$4);
   ...
   private void a(fbc $$0, gfg $$1, gin.a $$2) {
      int $$3 = 0;
   ...
   private void a(fbc $$0, gfg $$1, aaj.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gja.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fbc $$0, gfg $$1, aaj.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fbc $$0, gfg $$1, String $$2, gin.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gin.a $$0) {
      return this.b($$0.a).stream().map(agh::a).collect(Collectors.toSet());
   }

   private Set<String> c(gin.a $$0) {
      return this.c($$0.a).stream().map(agh::a).collect(Collectors.toSet());
   }
   ...
   private boolean c(aaj.a $$0) {
      cly $$1 = this.J.s;
      ir $$2 = ir.a($$1.dz(), $$0.h().b(), $$1.dF());
      ir $$3 = ir.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(ir $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(aaj.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(ir $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(aaj.a::a).collect(Collectors.toSet());
   }

   private Map<ir, List<String>> c() {
      Map<ir, List<String>> $$0 = Maps.newHashMap();

      for (aaj.a $$1 : this.L.values()) {
         for (ir $$2 : Iterables.concat($$1.q(), $$1.r())) {
   ...
   private void d() {
      gis.a(this.J.ao(), 8).ifPresent($$0 -> this.M = $$0.cE());
   }
