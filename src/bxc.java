...
public class bxc extends bjd implements byv {
   private static final Logger bY = LogUtils.getLogger();
   public static final aec<Integer> b = aef.a(bxc.class, aee.b);
   private static final btn bZ = btn.a().a(64.0);
   ...
   public int d = -1;
   private final bxa[] cf;
   public final bxa e;
   private final bxa cg;
   private final bxa ch;
   private final bxa ci;
   private final bxa cj;
   private final bxa ck;
   private final bxa cl;
   private final bxa cm;
   public float bS;
   public float bT;
   public boolean bU;
   public int bV;
   ...
   private diq cn;
   private gw co = gw.b;
   private final bxt cp;
   private int cq = 100;
   private float cr;
   private final eau[] cs = new eau[24];
   private final int[] ct = new int[24];
   private final ear cu = new ear();

   public bxc(bip<? extends bxc> $$0, cpq $$1) {
      super(bip.C, $$1);
      this.e = new bxa(this, "head", 1.0F, 1.0F);
      this.cg = new bxa(this, "neck", 3.0F, 3.0F);
      this.ch = new bxa(this, "body", 5.0F, 3.0F);
      this.ci = new bxa(this, "tail", 2.0F, 2.0F);
      this.cj = new bxa(this, "tail", 2.0F, 2.0F);
      this.ck = new bxa(this, "tail", 2.0F, 2.0F);
      this.cl = new bxa(this, "wing", 4.0F, 2.0F);
      this.cm = new bxa(this, "wing", 4.0F, 2.0F);
      this.cf = new bxa[]{this.e, this.cg, this.ch, this.ci, this.cj, this.ck, this.cl, this.cm};
      this.c(this.eK());
      this.af = true;
      this.at = true;
      this.cp = new bxt(this);
   }
   ...
   public static bkg.a q() {
      return bjd.x().a(bkh.a, 200.0);
   }

   @Override
   public boolean aR() {
      float $$0 = ars.b(this.bT * (float) (Math.PI * 2));
      float $$1 = ars.b(this.bS * (float) (Math.PI * 2));
   ...
   public void aQ() {
      if (this.dK().B && !this.aS()) {
         this.dK().a(this.dp(), this.dr(), this.dv(), aoz.gW, this.da(), 5.0F, 0.8F + this.ag.i() * 0.3F, false);
      }
   }
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = ars.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = ars.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
   ...
   public void b_() {
      ...
      if (this.dK().B) {
         ...
         if (!this.aS() && !this.cp.a().a() && --this.cq < 0) {
            this.dK().a(this.dp(), this.dr(), this.dv(), aoz.gX, this.da(), 2.5F, 0.8F + this.ag.i() * 0.3F, false);
            this.cq = 200 + this.ag.a(200);
         }
      }

      if (this.cn == null && this.dK() instanceof akn $$0) {
         diq $$1 = $$0.B();
      ...
      if (this.eu()) {
         ...
         this.dK().a(ix.x, this.dp() + (double)$$2, this.dr() + 2.0 + (double)$$3, this.dv() + (double)$$4, 0.0, 0.0, 0.0);
      } else {
         this.ga();
         ehi $$5 = this.dn();
         ...
         if (this.fQ()) {
            ...
            if (this.dK().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = ars.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.f(this.dn().b(0.0, $$11 * 0.01, 0.0));
                  this.r(ars.g(this.dA()));
                  ehi $$16 = $$9.a(this.dp(), this.dr(), this.dv()).d();
                  ehi $$17 = new ehi((double)ars.a(this.dA() * (float) (Math.PI / 180.0)), this.dn().d, (double)(-ars.b(this.dA() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ars.a(ars.g(180.0F - (float)ars.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dA()), -50.0F, 50.0F);
                     this.bW *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new ehi(0.0, 0.0, -1.0));
                  if (this.bU) {
                     this.a(bjh.a, this.dn().a(0.8F));
                  } else {
            ...
            this.aU = this.dA();
            ehi[] $$24 = new ehi[this.cf.length];

            for (int $$25 = 0; $$25 < this.cf.length; $$25++) {
               $$24[$$25] = new ehi(this.cf[$$25].dp(), this.cf[$$25].dr(), this.cf[$$25].dv());
            }
            ...
            if (!this.dK().B && this.aK == 0) {
               this.b(this.dK().a(this, this.cl.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bio.e));
               this.b(this.dK().a(this, this.cm.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bio.e));
               this.c(this.dK().a(this, this.e.cG().g(1.0), bio.e));
               this.c(this.dK().a(this, this.cg.cG().g(1.0), bio.e));
            }

            float $$32 = ars.a(this.dA() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$33 = ars.b(this.dA() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$34 = this.fZ();
   ...
   private void a(bxa $$0, double $$1, double $$2, double $$3) {
   ...
   private void ga() {
      ...
      if (this.ag.a(10) == 0) {
         List<bxb> $$0 = this.dK().a(bxb.class, this.cG().g(32.0));
         bxb $$1 = null;
   ...
   private void b(List<bil> $$0) {
      ...
      for (bil $$3 : $$0) {
         if ($$3 instanceof bjb) {
            ...
            if (!this.cp.a().a() && ((bjb)$$3).eg() < $$3.ah - 2) {
               $$3.a(this.dL().b((bjb)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bil> $$0) {
      for (bil $$1 : $$0) {
         if ($$1 instanceof bjb) {
            $$1.a(this.dL().b((bjb)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dfe $$13 = this.dK().a_($$12);
               if (!$$13.i() && !$$13.a(apo.aC)) {
                  if (this.dK().X().b(cpm.c) && !$$13.a(apo.aB)) {
   ...
   public boolean a(bxa $$0, bhj $$1, float $$2) {
      if (this.cp.a().i() == bxs.j) {
         return false;
      } else {
         $$2 = this.cp.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cbp || $$1.a(apq.y)) {
               float $$3 = this.et();
               this.g($$1, $$2);
   ...
   protected boolean g(bhj $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void dZ() {
      ...
      if (this.bV >= 180 && this.bV <= 200) {
         ...
         float $$2 = (this.ag.i() - 0.5F) * 8.0F;
         this.dK().a(ix.w, this.dp() + (double)$$0, this.dr() + 2.0 + (double)$$1, this.dv() + (double)$$2, 0.0, 0.0, 0.0);
      }

      boolean $$3 = this.dK().X().b(cpm.f);
      int $$4 = 500;
      ...
      if (this.dK() instanceof akn) {
         if (this.bV > 150 && this.bV % 5 == 0 && $$3) {
            bir.a((akn)this.dK(), this.di(), ars.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bjh.a, new ehi(0.0, 0.1F, 0.0));
      if (this.bV == 200 && this.dK() instanceof akn) {
         if ($$3) {
            bir.a((akn)this.dK(), this.di(), ars.d((float)$$4 * 0.2F));
         }
   ...
   public int t() {
      if (this.cs[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$4;
            if ($$0 < 12) {
               $$3 = ars.d(60.0F * ars.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
               $$4 = ars.d(60.0F * ars.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
            } else if ($$0 < 20) {
               int $$2 = $$0 - 12;
               $$3 = ars.d(40.0F * ars.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$4 = ars.d(40.0F * ars.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$1 += 10;
            } else {
               int var7 = $$0 - 20;
               $$3 = ars.d(20.0F * ars.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
               $$4 = ars.d(20.0F * ars.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
            }

            int $$9 = Math.max(this.dK().t_() + 10, this.dK().a(dkn.a.f, new gw($$3, 0, $$4)).v() + $$1);
            this.cs[$$0] = new eau($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eau $$5 = new eau(ars.a($$0), ars.a($$1), ars.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eaw a(int $$0, int $$1, @Nullable eau $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eau $$4 = this.cs[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eaw a(eau $$0, eau $$1) {
      List<eau> $$2 = Lists.newArrayList();
      eau $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eaw($$2, new gw($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(qu $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cp.a(bxs.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      bxm $$3 = this.cp.a();
      bxs<? extends bxm> $$4 = $$3.i();
      double $$7;
      if ($$4 == bxs.d || $$4 == bxs.e) {
         gw $$5 = this.dK().a(dkn.a.f, dnq.a(this.co));
   ...
   public ehi D(float $$0) {
      bxm $$1 = this.cp.a();
      bxs<? extends bxm> $$2 = $$1.i();
      ehi $$8;
      if ($$2 == bxs.d || $$2 == bxs.e) {
         gw $$3 = this.dK().a(dkn.a.f, dnq.a(this.co));
   ...
   public void a(bxb $$0, gw $$1, bhj $$2) {
      cbp $$3;
      if ($$2.d() instanceof cbp) {
         $$3 = (cbp)$$2.d();
      } else {
