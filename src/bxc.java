...
public class bxc {
   ...
   public static void a(bvh $$0, jh $$1, float $$2, int $$3) {
      a($$0, new bxd($$1), $$2, $$3);
   }
   ...
   public static void a(bvh $$0, cwm $$1, ezy $$2) {
      ezy $$3 = new ezy(0.3F, 0.3F, 0.3F);
      a($$0, $$1, $$2, $$3, 0.3F);
   }

   public static void a(bvh $$0, cwm $$1, ezy $$2, ezy $$3, float $$4) {
   ...
   public static Optional<bvh> a(bvh $$0, cel<UUID> $$1) {
      ...
      return $$2.<bul>map($$1x -> ((arp)$$0.dV()).a($$1x)).map($$0x -> $$0x instanceof bvh $$1x ? $$1x : null);
   }
   ...
   public static ezy a(bvp $$0, int $$1, int $$2) {
      ...
      while ($$3 != null && !$$0.dV().a_(jh.a((ka)$$3)).a(esk.b) && $$4++ < 10) {
         $$3 = cgc.a($$0, $$1, $$2);
      }
