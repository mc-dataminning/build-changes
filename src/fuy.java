public class fuy extends fum {
   private final dvh u;
   private fom<dvh.a> v;
   private fom<Boolean> w;
   private fom<Boolean> x;
   private dvh.a y = dvh.a.c;
   private boolean z;
   private boolean A;
   ...
   protected void aT_() {
      super.aT_();
      this.v = this.c(fom.<dvh.a>a($$0 -> {
         return switch ($$0) {
            case a -> xv.c("advMode.mode.sequence");
            case b -> xv.c("advMode.mode.auto");
            case c -> xv.c("advMode.mode.redstone");
         };
      }).a(dvh.a.values()).a().a(this.y).a(this.n / 2 - 50 - 100 - 4, 165, 100, 20, xv.c("advMode.mode"), ($$0, $$1) -> this.y = $$1));
      this.w = this.c(
         fom.a(xv.c("advMode.mode.conditional"), xv.c("advMode.mode.unconditional"))
            .a()
            .a(this.z)
            .a(this.n / 2 - 50, 165, 100, 20, xv.c("advMode.type"), ($$0, $$1) -> this.z = $$1)
      );
      this.x = this.c(
         fom.a(xv.c("advMode.mode.autoexec.bat"), xv.c("advMode.mode.redstoneTriggered"))
            .a()
            .a(this.A)
