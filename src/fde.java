...
public class fde {
   ...
   public void a(fde.b $$0, List<asa> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fde.c($$0, $$1.stream().map(asa::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fde.c(fde.b.c, ImmutableList.of());
      }

      this.b.c = new fde.a($$0);
   }
   ...
   static class c {
      private final fde.b a;
      private final List<String> b;
      @Nullable
      fde.a c;
      boolean d;

      c(fde.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
