...
public class cte {
   ...
   public static final cte b = new cte(0, 0);
   ...
   public static cte a(int $$0, int $$1) {
      return new cte($$0 << 5, $$1 << 5);
   }

   public static cte b(int $$0, int $$1) {
      return new cte(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cte $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public static Stream<cte> a(cte $$0, int $$1) {
      return a(new cte($$0.e - $$1, $$0.f - $$1), new cte($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cte> a(final cte $$0, final cte $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cte>((long)($$2 * $$3), 64) {
         @Nullable
         private cte e;

         @Override
         public boolean tryAdvance(Consumer<? super cte> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cte($$0.e, $$2 + $$5);
               } else {
                  this.e = new cte($$1 + $$4, $$2);
               }
            }
