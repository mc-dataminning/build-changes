...
public final class dyq extends dyt<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dyq(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dyq $$1 && super.equals($$0)) {
   ...
   public static dyq a(String $$0, int $$1, int $$2) {
