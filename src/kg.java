...
public class kg {
   ...
   static <T> js.b<T> a(final alo<? extends kd<? extends T>> $$0, final Lifecycle $$1, jt<T> $$2, final Map<alo<T>, jq.c<T>> $$3) {
      return new kg.e<T>($$2) {
         @Override
         public alo<? extends kd<? extends T>> g() {
            return $$0;
         }
   ...
   public <T> kg a(alo<? extends kd<T>> $$0, Lifecycle $$1, kg.i<T> $$2) {
      this.a.add(new kg.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> kg a(alo<? extends kd<T>> $$0, kg.i<T> $$1) {
   ...
   private static js.a a(kg.m $$0, ke $$1, Stream<js.b<?>> $$2) {
      record a<T>(js.b<T> a, aln.b<T> b) {
         public static <T> a<T> a(js.b<T> $$0) {
            return new a<>(new kg.d<>($$0, $$0), aln.b.a($$0));
         }

         public static <T> a<T> a(kg.m $$0, js.b<T> $$1) {
            return new a<>(new kg.d<>($$0.a(), $$1), new aln.b<>($$0.a(), $$1, $$1.h()));
         }
      }

      final Map<alo<? extends kd<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new js.a() {
         ...
         <T> Optional<a<T>> e(alo<? extends kd<? extends T>> $$0) {
         ...
         @Override
         public <V> aln<V> a(DynamicOps<V> $$0) {
            return aln.a($$0, new aln.c() {
               @Override
   ...
   private js.a a(ke $$0, js.a $$1, ji.a $$2, Map<alo<? extends kd<?>>, kg.j<?>> $$3, js.a $$4) {
      kg.m $$5 = new kg.m();
   ...
   private <T> js.b<T> a(jt<T> $$0, ji.a $$1, alo<? extends kd<? extends T>> $$2, js.a $$3, js.a $$4, MutableObject<js.a> $$5) {
      ji<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<alo<T>, jq.c<T>> $$7 = new HashMap<>();
         js.b<T> $$8 = $$3.d($$2);
         $$8.c().forEach($$5x -> {
            alo<T> $$6x = $$5x.h();
   ...
   public kg.g a(ke $$0, js.a $$1, ji.a $$2) {
      kg.b $$3 = this.b($$0);
      Map<alo<? extends kd<?>>, kg.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<alo<? extends kd<?>>> $$5 = $$0.b().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(kg.m a, kg.l b, Map<alp, jr<?>> c, Map<alo<?>, kg.h<?>> d, List<RuntimeException> e) {

      public static kg.b a(ke $$0, Stream<alo<? extends kd<?>>> $$1) {
         kg.m $$2 = new kg.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         kg.l $$4 = new kg.l($$2);
         Builder<alp, jr<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> ra<T> a() {
         return new ra<T>() {
            @Override
            public jq.c<T> a(alo<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jr<S> a(alo<? extends kd<? extends S>> $$0) {
      ...
      public void c() {
         for (alo<Object> $$0 : this.b.a.keySet()) {
   ...
   static class f<T> extends jq.c<T> {
      ...
      protected f(jt<T> $$0, @Nullable alo<T> $$1) {
   ...
   static record j<T>(alo<? extends kd<? extends T>> a, Lifecycle b, Map<alo<T>, kg.n<T>> c) {

      public js.b<T> a(kg.m $$0) {
         Map<alo<T>, jq.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            kg.n<T> $$2 = (kg.n<T>)$$1x.getValue();
            jq.c<T> $$3 = $$2.b().orElseGet(() -> jq.c.a($$0.a(), (alo<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(alo<? extends kd<T>> a, Lifecycle b, kg.i<T> c) {
      void b(kg.b $$0) {
         this.c.run($$0.a());
      }

      public kg.j<T> a(kg.b $$0) {
         Map<alo<T>, kg.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<alo<?>, kg.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<alo<?>, kg.h<?>> $$3 = $$2.next();
            alo<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               kg.h<T> $$6 = (kg.h<T>)$$3.getValue();
               jq.c<T> $$7 = (jq.c<T>)$$0.b.a.remove($$4);
               $$1.put((alo<T>)$$4, new kg.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends kg.c<Object> {
      final Map<alo<Object>, jq.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<jq.c<Object>> a(alo<Object> $$0) {
