...
public final class kg {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ad.a($$0, 4).map(kg::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final yx<ByteBuf, UUID> g = new yx<ByteBuf, UUID>() {
