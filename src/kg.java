...
public class kg {
   ...
   static <T> js.b<T> a(final alh<? extends kd<? extends T>> $$0, final Lifecycle $$1, jt<T> $$2, final Map<alh<T>, jq.c<T>> $$3) {
      return new kg.e<T>($$2) {
         @Override
         public alh<? extends kd<? extends T>> g() {
            return $$0;
         }
   ...
   public <T> kg a(alh<? extends kd<T>> $$0, Lifecycle $$1, kg.i<T> $$2) {
      this.a.add(new kg.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> kg a(alh<? extends kd<T>> $$0, kg.i<T> $$1) {
   ...
   private static js.a a(kg.m $$0, ke $$1, Stream<js.b<?>> $$2) {
      record a<T>(js.b<T> a, alg.b<T> b) {
         public static <T> a<T> a(js.b<T> $$0) {
            return new a<>(new kg.d<>($$0, $$0), alg.b.a($$0));
         }

         public static <T> a<T> a(kg.m $$0, js.b<T> $$1) {
            return new a<>(new kg.d<>($$0.a(), $$1), new alg.b<>($$0.a(), $$1, $$1.h()));
         }
      }

      final Map<alh<? extends kd<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new js.a() {
         ...
         <T> Optional<a<T>> e(alh<? extends kd<? extends T>> $$0) {
   ...
   private js.a a(ke $$0, js.a $$1, ji.a $$2, Map<alh<? extends kd<?>>, kg.j<?>> $$3, js.a $$4) {
      kg.m $$5 = new kg.m();
   ...
   private <T> js.b<T> a(jt<T> $$0, ji.a $$1, alh<? extends kd<? extends T>> $$2, js.a $$3, js.a $$4, MutableObject<js.a> $$5) {
      ji<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<alh<T>, jq.c<T>> $$7 = new HashMap<>();
         js.b<T> $$8 = $$3.d($$2);
         $$8.c().forEach($$5x -> {
            alh<T> $$6x = $$5x.h();
   ...
   public kg.g a(ke $$0, js.a $$1, ji.a $$2) {
      kg.b $$3 = this.b($$0);
      Map<alh<? extends kd<?>>, kg.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<alh<? extends kd<?>>> $$5 = $$0.b().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(kg.m a, kg.l b, Map<ali, jr<?>> c, Map<alh<?>, kg.h<?>> d, List<RuntimeException> e) {

      public static kg.b a(ke $$0, Stream<alh<? extends kd<?>>> $$1) {
         kg.m $$2 = new kg.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         kg.l $$4 = new kg.l($$2);
         Builder<ali, jr<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> qy<T> a() {
         return new qy<T>() {
            @Override
            public jq.c<T> a(alh<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jr<S> a(alh<? extends kd<? extends S>> $$0) {
   ...
   static class f<T> extends jq.c<T> {
      ...
      protected f(jt<T> $$0, @Nullable alh<T> $$1) {
   ...
   static record j<T>(alh<? extends kd<? extends T>> a, Lifecycle b, Map<alh<T>, kg.n<T>> c) {

      public js.b<T> a(kg.m $$0) {
         Map<alh<T>, jq.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            kg.n<T> $$2 = (kg.n<T>)$$1x.getValue();
            jq.c<T> $$3 = $$2.b().orElseGet(() -> jq.c.a($$0.a(), (alh<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(alh<? extends kd<T>> a, Lifecycle b, kg.i<T> c) {
      void b(kg.b $$0) {
         this.c.run($$0.a());
      }

      public kg.j<T> a(kg.b $$0) {
         Map<alh<T>, kg.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<alh<?>, kg.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<alh<?>, kg.h<?>> $$3 = $$2.next();
            alh<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               kg.h<T> $$6 = (kg.h<T>)$$3.getValue();
               jq.c<T> $$7 = (jq.c<T>)$$0.b.a.remove($$4);
               $$1.put((alh<T>)$$4, new kg.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends kg.c<Object> {
      final Map<alh<Object>, jq.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<jq.c<Object>> a(alh<Object> $$0) {
