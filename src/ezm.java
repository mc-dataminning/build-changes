...
public abstract class ezm implements far, fbk, fdc, fdh {
   ...
   public ezm(int $$0, int $$1, int $$2, int $$3, vq $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(ezb $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
         this.i = $$1 >= this.B() && $$2 >= this.C() && $$1 < this.B() + this.g && $$2 < this.C() + this.h;
         this.b($$0, $$1, $$2, $$3);
         this.n.a(this.y(), this.aL_(), this.F());
      }
   }
   ...
   public static we a_(vq $$0) {
      return vq.a("gui.narrate.button", $$0);
   }

   protected abstract void b(ezb var1, int var2, int var3, float var4);

   protected static void a(ezb $$0, eyz $$1, vq $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(ezb $$0, eyz $$1, vq $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = awi.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = awi.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(ezb $$0, eyz $$1, int $$2, int $$3) {
      int $$4 = this.B() + $$2;
   ...
   public fdh.a s() {
      if (this.aL_()) {
         ...
         return this.i ? fdh.a.b : fdh.a.a;
      }
   }

   @Override
   public final void b(fdj $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fdj var1);

   protected void c(fdj $$0) {
      $$0.a(fdi.a, this.aN_());
      if (this.j) {
         if (this.aL_()) {
            $$0.a(fdi.d, vq.c("narration.button.usage.focused"));
         } else {
