...
public class ezm {
   ...
   public void a(cee $$0, erw $$1, float $$2, int $$3, int $$4) {
      cfw $$5 = $$0.b(this.d);
   ...
   private void a(cfw $$0, aer $$1, float $$2, erw $$3, int $$4, int $$5) {
      fyl $$6 = eqm.O().a(fyk.e).apply($$1);
