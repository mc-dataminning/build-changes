...
public class ezm extends ast<Map<String, List<ezm.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ezm.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ezm.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ezm.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ezm.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ezm.a::d)
                  )
                  .apply($$0, ezm.a::new)
         )
         .listOf()
   ...
   public ezm(ajh $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ezm.a>> a(aso $$0, bjq $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ezm.a>> $$0, aso $$1, bjq $$2) {
      List<ezm.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ezm.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ezm.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ezm.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ezm.b a(List<ezm.a> $$0, long $$1) {
         this.cancel();
         return new ezm.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ezm.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fdo.a(ezg.Q().aA(), fdo.a.f, vu.a($$2.c, $$3), vu.a($$2.d, $$3)));
                  return;
               }
            }
         }
