...
public class ezm {
   ...
   static class b {
      static final Optional<ezm> a = Optional.ofNullable(a());
      ...
      private static ezm a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezm();
      }
   }
}
