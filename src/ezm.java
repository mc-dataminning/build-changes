...
public class ezm extends ezp {
   public static final int a = 854;
   public static final int b = 480;
   static final ezm.b l = new ezm.b(854, 480);

   public ezm(int $$0, int $$1) {
      super(true);
      this.b($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final ezm.a[] e = values();
   ...
   static class b {
      ...
      static List<ezm.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ezm.b($$0, $$1), ezm.l) : ImmutableList.of(ezm.l);
      }
