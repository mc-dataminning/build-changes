...
public class eqk implements eay.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eqk> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azd<eqk> a = azd.a(f);
   private final eqo g;
   private final eqo h;
   private final eqo i;
   ...
   public static eqk a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eqk(new ecg(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eqk(eqo $$0, eqo $$1, eqo $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eqk(azs $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eqo.a($$0, IntStream.rangeClosed(-15, 0)),
         eqo.a($$0, IntStream.rangeClosed(-15, 0)),
         eqo.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eqk a(azs $$0) {
      return new eqk($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(eay.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eql $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eqo.b($$4 * $$13), eqo.b($$5 * $$13), eqo.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eqo.b($$1 * $$13);
         double $$21 = eqo.b($$2 * $$13);
         double $$22 = eqo.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eql $$24 = this.g.a($$19);
            if ($$24 != null) {
