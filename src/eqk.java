...
public final class eqk extends eoj {
   ...
   public static final MapCodec<eqk> i = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  ...
                  edp.a.g.optionalFieldOf("project_start_to_heightmap").forGetter($$0x -> $$0x.o),
      ...
      .validate(eqk::a);
   private final jq<ept> j;
   private final Optional<alz> k;
   private final int l;
   private final emq m;
   private final boolean n;
   private final Optional<edp.a> o;
   private final int p;
   ...
   public eqk(eoj.c $$0, jq<ept> $$1, Optional<alz> $$2, int $$3, emq $$4, boolean $$5, Optional<edp.a> $$6, int $$7, List<epv> $$8, epj $$9, erv $$10) {
      super($$0);
      this.j = $$1;
      this.k = $$2;
      this.l = $$3;
   ...
   public eqk(eoj.c $$0, jq<ept> $$1, int $$2, emq $$3, boolean $$4, edp.a $$5) {
      this($$0, $$1, Optional.empty(), $$2, $$3, $$4, Optional.of($$5), 80, List.of(), d, e);
   }

   public eqk(eoj.c $$0, jq<ept> $$1, int $$2, emq $$3, boolean $$4) {
   ...
   public Optional<eoj.b> a(eoj.a $$0) {
      dgn $$1 = $$0.h();
      int $$2 = this.m.a($$0.f(), new eem($$0.b(), $$0.i()));
