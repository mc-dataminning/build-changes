...
public abstract class eqk {
   ...
   public epm a() {
      if (this.c()) {
         ...
         return new epm(this.b(ih.a.a), this.b(ih.a.b), this.b(ih.a.c), this.c(ih.a.a), this.c(ih.a.b), this.c(ih.a.c));
      }
   }

   public eqk b() {
      return this.c() ? eqh.a() : eqh.a(this.b(ih.a.a), this.b(ih.a.b), this.b(ih.a.c), this.c(ih.a.a), this.c(ih.a.b), this.c(ih.a.c));
   }
   ...
   public eqk a(double $$0, double $$1, double $$2) {
      return (eqk)(this.c() ? eqh.a() : new ept(this.a, new eqg(this.a(ih.a.a), $$0), new eqg(this.a(ih.a.b), $$1), new eqg(this.a(ih.a.c), $$2)));
   }

   public eqk d() {
      eqk[] $$0 = new eqk[]{eqh.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = eqh.b($$0[0], eqh.a($$1, $$2, $$3, $$4, $$5, $$6), epv.o));
      return $$0[0];
   }

   public void a(eqh.a $$0) {
      this.a
         .a(
   ...
   public List<epm> e() {
      List<epm> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new epm($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ih.a.a, $$4.c - (double)$$2.u()), this.a(ih.a.b, $$4.d - (double)$$2.v()), this.a(ih.a.c, $$4.e - (double)$$2.w()))
               ? new epn($$4, ih.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : epm.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<epr> a(epr $$0) {
      if (this.c()) {
   ...
   public eqk a(ih $$0) {
      if (!this.c() && this != eqh.b()) {
         if (this.b != null) {
            eqk $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private eqk b(ih $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new eqi(this, $$1, $$4);
      }
   }

   public double a(ih.a $$0, epm $$1, double $$2) {
      return this.a(hz.a($$0, ih.a.a), $$1, $$2);
   }

   protected double a(hz $$0, epm $$1, double $$2) {
      if (this.c()) {
         return $$2;
