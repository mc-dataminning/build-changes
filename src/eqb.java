...
public class eqb implements eqc, eqd {
   ...
   private final evf<MinecraftServer> G;
   ...
   public eqb(dcd $$0, dyt $$1, eqb.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iz.c,
   ...
   public static <T> eqb a(Dynamic<T> $$0, dcd $$1, eqb.a $$2, dyt $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new eqb(
         (us)$$0.get("Player").flatMap(us.a::parse).result().orElse(null),
         ...
         new evf<>(eve.a, $$0.get("ScheduledEvents").asStream()),
         (us)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dvy.a.a).resultOrPartial(f::error).orElse(dvy.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public us a(jw $$0, @Nullable us $$1) {
      if ($$1 == null) {
         $$1 = this.o;
      }
   ...
   private void a(jw $$0, us $$1, @Nullable us $$2) {
      ...
      $$1.a("Version", $$3);
      vh.e($$1);
      DynamicOps<vp> $$4 = $$0.a(vg.a);
      dyr.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vp)dvy.a.a.encodeStart(vg.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dct.b.encodeStart(vg.a, this.g.g()).ifSuccess($$1x -> $$1.a((us)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   private static uy a(Set<String> $$0) {
      uy $$1 = new uy();
      $$0.stream().map(vn::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean z() {
      return this.i == eqb.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eqb.a.c;
   }
