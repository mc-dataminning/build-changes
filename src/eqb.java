...
public class eqb {
   ...
   private final eov c;
   private final List<eqb.a> d = Lists.newArrayList();
   private String e;
   private int f;
   private int g;
   private boolean h;
   ...
   public eqb.a e() {
      return new eqb.a(Math.min(this.g, this.f), Math.max(this.g, this.f));
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = apa.a($$0);
      int $$3 = apa.a($$1 / 9.0);
      eqb.a $$4 = this.d.get(apa.a($$3, 0, this.d.size() - 1));
   ...
   public eqb.a k() {
      if (this.e.isEmpty()) {
         ...
         int $$0 = apa.a(this.f, 0, this.e.length() - 1);
   ...
   private void o() {
      ...
      if (this.e.isEmpty()) {
         ...
         this.c.b().a(this.e, this.j, ts.a, false, ($$0, $$1, $$2) -> this.d.add(new eqb.a($$1, $$2)));
         if (this.e.charAt(this.e.length() - 1) == '\n') {
            this.d.add(new eqb.a(this.e.length(), this.e.length()));
         }
      }
   }

   private String c(String $$0) {
      return this.b() ? aps.a($$0, this.i, false) : $$0;
   }
   ...
   protected static record a(int a, int b) {
      static final eqb.a c = new eqb.a(0, 0);
   }
}
