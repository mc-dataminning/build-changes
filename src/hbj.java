...
public class hbj extends MinecraftServer {
   ...
   public hbj(Thread $$0, fil $$1, esv.c $$2, aue $$3, amb $$4, alx $$5, arr $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hbi(this, this.bc(), this.g));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (ari $$1 : Lists.newArrayList(this.ag().t())) {
   ...
   @Override
   public ded be() {
      return this.r() ? (ded)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
