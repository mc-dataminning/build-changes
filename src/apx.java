...
public class apx extends apl<GameProfile> {
   public apx(@Nullable GameProfile $$0) {
      this($$0, null, null, null, null);
   }

   public apx(@Nullable GameProfile $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }

   public apx(JsonObject $$0) {
      super(b($$0), $$0);
   }
