...
public class asj extends asv {
   ...
   private asj(URL $$0, asv.b $$1, URL $$2, asj.a $$3, URL $$4, asj.a $$5, String $$6, asv.a $$7, ExecutorService $$8) {
      super($$0, $$1, $$7, $$8);
      this.c = $$2;
      this.d = $$3;
      this.e = $$4;
   ...
   public asw a(GameProfile $$0) {
      return new asv.c($$0) {
         @Override
         public void a() {
            asj.this.a(this.b, asj.this.c, asj.this.d, this.c);
         }

         @Override
         public void b() {
            asj.this.a(this.b, asj.this.e, asj.this.f, this.c);
         }
      };
   }

   void a(GameProfile $$0, URL $$1, asj.a $$2, Executor $$3) {
      $$3.execute(() -> {
