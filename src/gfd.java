public class gfd extends ggp {
   static final azs a = azs.a();
   private final ggk b;

   gfd(gci $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ggk $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.b = $$7;
   ...
   public static class a implements gfs<lv> {
      ...
      public gfp a(lv $$0, gci $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gfd $$8 = new gfd($$1, $$2, $$3, $$4, 0.0, 0.0, 0.0, this.b);
         $$8.a(1.0F, 0.9F, 1.0F);
   ...
   public static class b implements gfs<lv> {
      ...
      public gfp a(lv $$0, gci $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gfd $$8 = new gfd($$1, $$2, $$3, $$4, 0.5 - gfd.a.j(), $$6, 0.5 - gfd.a.j(), this.a);
         if ($$1.A.h()) {
            $$8.a(0.6F, 1.0F, 0.8F);
         } else {
            $$8.a(0.08F, 0.4F, 0.4F);
   ...
   public static class e implements gfs<lv> {
      private final double a = 0.01;
      private final ggk b;
