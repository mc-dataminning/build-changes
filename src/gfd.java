public class gfd extends geh<cgj, fqd<cgj>> {
   private static final ajh a = new ajh("textures/entity/slime/slime.png");

   public gfd(gdb.a $$0) {
      super($$0, new fqd<>($$0.a(fre.bs)), 0.25F);
      this.a(new ghr<>(this, $$0.f()));
   }

   public void a(cgj $$0, float $$1, float $$2, eub $$3, fxs $$4, int $$5) {
      this.d = 0.25F * (float)$$0.go();
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   protected void a(cgj $$0, eub $$1, float $$2) {
      float $$3 = 0.999F;
