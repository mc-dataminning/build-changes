...
public class gfd implements gfx {
   ...
   private CompletableFuture<Optional<cpz>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gfd(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cpz::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cpz>> a(Optional<cpz> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cpz.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cpz $$0) {
      ...
      if ($$0 != null) {
         if (ab.aU) {
            cpz.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cpz a(UserApiService $$0) throws azd, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cqa.a $$2 = a($$1);
         return new cpz(azc.a($$1.keyPair().privateKey()), new cqa($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cqa.a a(KeyPairResponse $$0) throws azd {
      KeyPair $$1 = $$0.keyPair();
