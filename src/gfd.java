...
public class gfd extends dha {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebw e = new ebw();
   private final ecc<bvf> f = new ecc<>(bvf.class, new gfd.b());
   private final gfe E;
   private final gla F;
   private final gkz G;
   private final gfd.a H;
   private final gkq I;
   private final btn J;
   private final flz K = flz.Q();
   final List<gjx> L = Lists.newArrayList();
   private final Map<evh, evj> M = Maps.newHashMap();
   private static final int N = -1;
   private int O;
   private final Object2ObjectArrayMap<dgk, fnc> P = ae.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gkk.a, new fnc($$0xx -> this.b($$0xx, gkk.a)));
      $$0x.put(gkk.b, new fnc($$0xx -> this.b($$0xx, gkk.b)));
      $$0x.put(gkk.c, new fnc($$0xx -> this.b($$0xx, gkk.c)));
   });
   private final gez Q;
   private final Deque<Runnable> R = Queues.newArrayDeque();
   private int S;
   private final ggq T = new ggq();
   private final int U;
   private boolean V;
   private static final Set<cxg> W = Set.of(cxo.hP, cxo.hQ);

   public void b(int $$0) {
      this.T.a($$0, this);
   }

   public void b(jh $$0, dxn $$1, int $$2) {
      if (!this.T.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(jh $$0, dxn $$1, fbs $$2) {
      dxn $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cps $$4 = this.K.t;
   ...
   public gfd(gfe $$0, gfd.a $$1, aly<dha> $$2, jq<ebi> $$3, int $$4, int $$5, gla $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.Q = new gez(this, $$4);
      this.J = new btn();
      this.H = $$1;
      this.F = $$6;
      this.U = $$9;
      this.G = new gkz(this.K, this, $$6);
      this.I = gkq.a($$3.a());
   ...
   private void a(bvf $$0, bvf $$1) {
      if ($$1.dQ() || $$1.dk() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof cps || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   private dke n() {
      if (this.K.r.j() == dgx.b) {
         cxk $$0 = this.K.t.eX();
         cxg $$1 = $$0.h();
         if (W.contains($$1) && $$1 instanceof cvq $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, bam $$4, @Nullable dke $$5, jh.a $$6) {
   ...
   private void a(jh $$0, dxn $$1, lq $$2, boolean $$3) {
      if ($$1.y().c()) {
         fcm $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jm.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(jh $$0, lq $$1, fcm $$2, double $$3) {
   ...
   public void a(@Nullable cps $$0, bvf $$1, jq<axe> $$2, axg $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hfb)(new hes($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bvf $$0, axe $$1, axg $$2, float $$3, float $$4) {
      this.K.ak().a((hfb)(new hes($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, axe $$3, axg $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hew $$10 = new hew($$3, $$4, $$5, $$6, bam.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czz> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new ghv.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jq<dic> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mb.aH).b(dij.b);
   }
   ...
   public int a(fbs $$0, float $$1) {
      float $$2 = this.f($$1);
      fbs $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fbs $$4 = azf.a($$3, ($$0x, $$1x, $$2x) -> fbs.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(jh $$0, dgk $$1) {
      fnc $$2 = (fnc)this.P.get($$1);
      return $$2.a($$0);
   }

   public int b(jh $$0, dgk $$1) {
      int $$2 = flz.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<evh, evj> k() {
      return ImmutableMap.copyOf(this.M);
   }

   protected void a(Map<evh, evj> $$0) {
      this.M.putAll($$0);
   }
   ...
   public static class a implements ewc {
      ...
      public a(btb $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements eby<bvf> {
      public void a(bvf $$0) {
      }
