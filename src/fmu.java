...
public class fmu {
   public static void a(gcf $$0, fms $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fmr>> $$6 : $$1.c().entrySet()) {
         Optional<gem> $$7 = $$0.a($$6.getKey());
         List<fmr> $$8 = $$6.getValue();
   ...
   private static float a(fms $$0, long $$1) {
