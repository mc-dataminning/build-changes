...
public class fmu extends fnf {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fqq.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fpc.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fqq.Q().b($$4)) {
               try {
