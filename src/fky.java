...
public class fky {
   ...
   public static class b extends fmk {
      b(fin $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends flw {
      ...
      c(fin $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flm $$7, fmf $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fky.c $$0 = new fky.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fln<iy> {
      ...
      public flk a(iy $$0, fin $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fky.c $$8 = new fky.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, eql.O().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fli {
      private int a;
      private final flm b;
      private qx D;
      private boolean E;

      public e(fin $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flm $$7, @Nullable qr $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            ...
            flk $$17 = this.b.a(iv.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fky.c $$10 = (fky.c)this.b.a(iv.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
