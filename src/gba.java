...
public class gba {
   private static final gbm a = gbm.t(new akf("textures/map/map_background.png"));
   private static final gbm b = gbm.t(new akf("textures/map/map_background_checkerboard.png"));
   ...
   private final fcu au;
   private csd av = csd.i;
   private csd aw = csd.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final ggl aB;
   private final ghl aC;

   public gba(fcu $$0, ggl $$1, ghl $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bre $$0, csd $$1, csa $$2, boolean $$3, exn $$4, gbe $$5, int $$6) {
      if (!$$1.d()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dN(), $$6, gmf.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = axw.a($$1, 0.0F, 1.0F);
      return -axw.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(exn $$0, gbe $$1, int $$2, bqy $$3) {
      glr $$4 = (glr)this.aB.<gad>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bqy.b ? 1.0F : -1.0F;
   ...
   private void a(exn $$0, gbe $$1, int $$2, float $$3, bqy $$4, float $$5, csd $$6) {
      float $$7 = $$4 == bqy.b ? 1.0F : -1.0F;
      ...
      float $$8 = axw.c($$5);
      float $$9 = axw.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * axw.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * axw.a($$5 * (float) Math.PI);
   ...
   private void a(exn $$0, gbe $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = axw.c($$5);
      float $$7 = -0.2F * axw.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * axw.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = axw.a($$6 * (float) Math.PI);
   ...
   private void a(exn $$0, gbe $$1, int $$2, csd $$3) {
      ...
      enc $$4 = $$3.a(jz.s);
      ene $$5 = csl.a($$4, this.au.r);
      exr $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(exn $$0, gbe $$1, int $$2, float $$3, float $$4, bqy $$5) {
      boolean $$6 = $$5 != bqy.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = axw.c($$4);
      float $$9 = -0.3F * axw.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * axw.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * axw.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = axw.a($$4 * $$4 * (float) Math.PI);
      float $$13 = axw.a($$8 * (float) Math.PI);
   ...
   private void a(exn $$0, float $$1, bqy $$2, csd $$3) {
      float $$4 = (float)this.au.s.fw() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.t();
      if ($$5 < 0.8F) {
         float $$6 = axw.e(axw.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(exn $$0, float $$1, bqy $$2, csd $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * axw.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bqy.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(exn $$0, bqy $$1, float $$2) {
      int $$3 = $$1 == bqy.b ? 1 : -1;
      float $$4 = axw.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = axw.a(axw.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(exn $$0, bqy $$1, float $$2) {
      int $$3 = $$1 == bqy.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, exn $$1, gbe.a $$2, gag $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bop $$6 = (bop)MoreObjects.firstNonNull($$3.aL, bop.a);
      float $$7 = axw.i($$0, $$3.P, $$3.dF());
      gba.a $$8 = a($$3);
      float $$9 = axw.i($$0, $$3.cE, $$3.cC);
      float $$10 = axw.i($$0, $$3.cD, $$3.cB);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bop.a ? $$5 : 0.0F;
         float $$12 = 1.0F - axw.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bop.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bop.b ? $$5 : 0.0F;
         float $$14 = 1.0F - axw.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bop.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gba.a a(gag $$0) {
      csd $$1 = $$0.eV();
      csd $$2 = $$0.eW();
      boolean $$3 = $$1.a(csg.ou) || $$2.a(csg.ou);
      boolean $$4 = $$1.a(csg.vT) || $$2.a(csg.vT);
      if (!$$3 && !$$4) {
         return gba.a.a;
      } else if ($$0.ft()) {
         return b($$0);
      } else {
         return a($$1) ? gba.a.b : gba.a.a;
      }
   }

   private static gba.a b(gag $$0) {
      csd $$1 = $$0.fv();
      bop $$2 = $$0.fu();
      if (!$$1.a(csg.ou) && !$$1.a(csg.vT)) {
         return $$2 == bop.a && a($$0.eW()) ? gba.a.b : gba.a.a;
      } else {
         return gba.a.a($$2);
      }
   }
   ...
   private static boolean a(csd $$0) {
      return $$0.a(csg.vT) && cqq.j($$0);
   }

   private void a(gad $$0, float $$1, float $$2, bop $$3, float $$4, csd $$5, float $$6, exn $$7, gbe $$8, int $$9) {
      if (!$$0.gy()) {
         boolean $$10 = $$3 == bop.a;
         bqy $$11 = $$10 ? $$0.fs() : $$0.fs().e();
         $$7.a();
         if ($$5.d()) {
            if ($$10 && !$$0.cf()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.ft() && $$0.fw() > 0 && $$0.fu() == $$3) {
               ...
               float $$16 = $$15 / (float)cqq.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = axw.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * axw.a(axw.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * axw.a(axw.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * axw.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? csa.e : csa.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bqy.b;
            if ($$0.ft() && $$0.fw() > 0 && $$0.fu() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * axw.a(axw.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * axw.a(axw.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * axw.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? csa.e : csa.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = axw.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = axw.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + axw.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + axw.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
