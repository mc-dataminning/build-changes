...
public class gba extends gcr {
   private final float a;
   private final gcm b;

   gba(fyj $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gcm $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gbu<lb> {
      ...
      public gbr a(lb $$0, fyj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dln.a) {
            ...
            ja $$9 = ja.a($$2, $$3, $$4);
            int $$10 = fft.Q().av().a($$8, $$1, $$9);
            if ($$8.b() instanceof did) {
               $$10 = ((did)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gba($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
