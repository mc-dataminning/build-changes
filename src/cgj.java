...
public class cgj extends bpr implements cfs {
   private static final aim<Integer> bX = aiq.a(cgj.class, aio.b);
   ...
   public cgj(bpd<? extends cgj> $$0, cxb $$1) {
      super($$0, $$1);
      this.cD();
      this.bO = new cgj.d(this);
   }

   @Override
   protected void z() {
      this.bR.a(1, new cgj.b(this));
      this.bR.a(2, new cgj.a(this));
      this.bR.a(3, new cgj.e(this));
      this.bR.a(5, new cgj.c(this));
      this.bS.a(1, new byf<>(this, ciu.class, 10, true, false, $$0 -> Math.abs($$0.dt() - this.dt()) <= 4.0));
   ...
   public void a(int $$0, boolean $$1) {
      ...
      this.ar();
      this.j_();
      this.f(bqw.q).a((double)($$2 * $$2));
      this.f(bqw.r).a((double)(0.2F + 0.1F * (float)$$2));
      this.f(bqw.c).a((double)$$2);
      if ($$1) {
         this.t(this.eO());
      }
   ...
   @Override
   public bpd<? extends cgj> ai() {
      return (bpd<? extends cgj>)super.ai();
   }
   ...
   protected void j(bpp $$0) {
      if (this.bA()) {
         int $$1 = this.go();
         if (this.g((box)$$0) < 0.6 * (double)$$1 * 0.6 * (double)$$1 && this.E($$0) && $$0.a(this.dN().b((bpp)this), this.gl())) {
            this.a(aty.wQ, 1.0F, (this.ag.i() - this.ag.i()) * 0.2F + 1.0F);
            this.a(this, $$0);
         }
      }
   }
   ...
   protected ept a(box $$0, bpa $$1, float $$2) {
      return new ept(0.0, (double)$$1.b() - 0.015625 * (double)this.go() * (double)$$2, 0.0);
   }
   ...
   protected atx d(bnw $$0) {
      return this.gp() ? aty.xH : aty.wS;
   }

   @Override
   protected atx n_() {
      return this.gp() ? aty.xG : aty.wR;
   }

   protected atx gm() {
      return this.gp() ? aty.xJ : aty.wU;
   }

   public static boolean c(bpd<cgj> $$0, cxc $$1, bpt $$2, ib $$3, axd $$4) {
      if (bpt.a($$2)) {
         return a($$0, $$1, $$2, $$3, $$4);
      } else {
         if ($$1.aj() != bna.a) {
            ...
            cwi $$5 = new cwi($$3);
            boolean $$6 = dtn.a($$5.e, $$5.f, ((cxw)$$1).C(), 987234911L).a(10) == 0;
   ...
   static class a extends bwm {
      ...
      public boolean a() {
         ...
         if ($$0 == null) {
            ...
            return !this.a.c($$0) ? false : this.a.H() instanceof cgj.d;
         }
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof cgj.d $$1) {
   ...
   static class b extends bwm {
      ...
      @Override
      public boolean a() {
         return (this.a.bc() || this.a.bq()) && this.a.H() instanceof cgj.d;
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof cgj.d $$0) {
            $$0.a(1.2);
         }
      }
   }
   ...
   static class d extends bvp {
      ...
      public void a() {
         ...
         if (this.k != bvp.a.b) {
            ...
            this.k = bvp.a.a;
            if (this.d.aC()) {
               this.d.y((float)(this.h * this.d.g(bqw.r)));
               if (this.m-- <= 0) {
                  this.m = this.n.y();
                  if (this.o) {
                     this.m /= 3;
   ...
   static class e extends bwm {
      ...
      @Override
      public boolean a() {
         return this.a.p() == null && (this.a.aC() || this.a.bc() || this.a.bq() || this.a.a(bom.y)) && this.a.H() instanceof cgj.d;
      }
