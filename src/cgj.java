...
public abstract class cgj {
   ...
   public cgj(bxb $$0, dip $$1) {
      this.a = $$0;
      this.b = $$1;
      this.v = this.a(azk.a($$0.i(byf.m) * 16.0));
   }
   ...
   private float r() {
      return Math.max((float)this.a.h(byf.m), this.x);
   }
   ...
   protected abstract ewl a(int var1);
   ...
   @Nullable
   public final ewj a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(iu.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ewj a(Stream<iu> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ewj a(Set<iu> $$0, int $$1) {
   ...
   @Nullable
   protected ewj a(Set<iu> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, this.r());
   }

   @Nullable
   protected ewj a(Set<iu> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$7 = (int)($$4 + (float)$$1);
         djc $$8 = new djc(this.b, $$6.b(-$$7, -$$7, -$$7), $$6.b($$7, $$7, $$7));
         ewj $$9 = this.v.a($$8, this.a, $$0, $$4, $$3, this.u);
         $$5.c();
         if ($$9 != null && $$9.l() != null) {
            this.s = $$9.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ewj $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   protected double a(fdw $$0) {
      iu $$1 = iu.a((jo)$$0);
      return this.b.a_($$1.e()).l() ? $$0.e : ewr.a(this.b, $$1);
   }
   ...
   private boolean c(fdw $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         fdw $$1 = fdw.c(this.c.g());
         if (!$$0.a((jo)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            fdw $$2 = fdw.c(this.c.d(this.c.f() + 1));
            fdw $$3 = $$1.d($$0);
            fdw $$4 = $$2.d($$0);
            double $$5 = $$3.h();
            double $$6 = $$4.h();
   ...
   protected void d() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            ewh $$1 = this.c.a($$0);
            ewh $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dzo $$3 = this.b.a_(new iu($$1.a, $$1.b, $$1.c));
            if ($$3.a(axa.bn)) {
   ...
   public boolean b(ewm $$0) {
      return $$0 != ewm.n && $$0 != ewm.p && $$0 != ewm.d;
   }

   protected static boolean a(bxb $$0, fdw $$1, fdw $$2, boolean $$3) {
      fdw $$4 = new fdw($$2.d, $$2.e + (double)$$0.dr() * 0.5, $$2.f);
      return $$0.dV().a(new dhy($$1, $$4, dhy.a.a, $$3 ? dhy.b.c : dhy.b.a, $$0)).d() == fdu.a.a;
   }
   ...
   public boolean b(iu $$0) {
      if (this.m) {
         ...
         ewh $$1 = this.c.d();
         fdw $$2 = new fdw(((double)$$1.a + this.a.dA()) / 2.0, ((double)$$1.b + this.a.dC()) / 2.0, ((double)$$1.c + this.a.dG()) / 2.0);
