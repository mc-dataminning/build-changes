...
public class hbf implements hbi.a, AutoCloseable {
   ...
   ffs[] f;
   @Nullable
   private final hbf.a g;
   private final avx h;

   public hbf(alz $$0, hcz $$1, ffs $$2, avx $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      hcx $$4 = $$3.a(hcx.a).orElse(hcx.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ffs[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hba.a(this.f, $$0);
   ...
   @Nullable
   private hbf.a a(hcz $$0, int $$1, int $$2, hcx $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<hbf.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new hbf.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new hbf.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<hbf.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            hbf.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new hbf.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ffs[] $$4) {
   ...
   class a {
      ...
      a(final List<hbf.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hbf.this.c;
         int $$4 = this.b($$2) * hbf.this.d;
         hbf.this.a($$0, $$1, $$3, $$4, hbf.this.f);
      }

      public hbh a() {
         return hbf.this.new d(this, this.d ? hbf.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ffs[] b = new ffs[hbf.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hbf.this.c >> $$0;
            int $$2 = hbf.this.d >> $$0;
            this.b[$$0] = new ffs($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hbf.d $$2) {
         hbf.a $$3 = $$2.c;
         List<hbf.b> $$4 = $$3.b;
         hbf.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            hbf.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hbf.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hbf.this.f[$$2].a($$3 + ($$0.a($$1) * hbf.this.c >> $$2), $$4 + ($$0.b($$1) * hbf.this.d >> $$2));
      }
   ...
   class d implements hbh {
      int a;
      int b;
      final hbf.a c;
      @Nullable
      private final hbf.c d;

      d(final hbf.a $$0, @Nullable final hbf.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
