...
public abstract class ezk extends ezm {
   ...
   public ezk(int $$0, int $$1, int $$2, int $$3, vq $$4, double $$5) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
   }
   ...
   public void a(fdj $$0) {
      ...
      if (this.j) {
         if (this.aL_()) {
            $$0.a(fdi.d, vq.c("narration.slider.usage.focused"));
         } else {
            $$0.a(fdi.d, vq.c("narration.slider.usage.hovered"));
         }
      }
   }
   ...
   public void b(ezb $$0, int $$1, int $$2, float $$3) {
      ...
      this.a($$0, $$4.h, 2, $$5 | awi.f(this.l * 255.0F) << 24);
   }
