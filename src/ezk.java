...
public class ezk implements ezn {
   ...
   public ezn.a a(ewt $$0, ezo $$1, long $$2) {
      ...
      if ($$3 != null) {
         ...
         if ($$4.size() == 1) {
            ...
            float $$7 = 300.0F;
            if ($$2 < 1500L) {
               int $$8 = aun.d(aun.a((float)(1500L - $$2) / 300.0F, 0.0F, 1.0F) * 255.0F) << 24 | 67108864;
               $$0.a($$1.b().h, $$3.e().b(), 30, 11, $$5 | $$8, false);
            } else {
               int $$9 = aun.d(aun.a((float)($$2 - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24 | 67108864;
         ...
         if (!this.f && $$2 > 0L) {
            this.f = true;
            if ($$3.e() == al.b) {
               $$1.b().ai().a(ghu.a(arr.zA, 1.0F, 1.0F));
            }
         }

         $$0.b($$3.c(), 8, 8);
         return (double)$$2 >= 5000.0 * $$1.c() ? ezn.a.b : ezn.a.a;
      } else {
         return ezn.a.b;
      }
   }
