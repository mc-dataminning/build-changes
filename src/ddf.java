...
public class ddf {
   ...
   private final ddf.a e;
   private final long f;

   public ddf(ddf.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public ddf a(ddf.a $$0) {
      return new ddf($$0, this.f);
   }

   public jj<ddd> a(ja $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jj<ddd> a(double $$0, double $$1, double $$2) {
      int $$3 = ju.a(aye.a($$0));
      int $$4 = ju.a(aye.a($$1));
      int $$5 = ju.a(aye.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = axz.a($$7, $$0);
      double $$10 = b($$7);
      return aye.k($$6 + $$10) + aye.k($$5 + $$9) + aye.k($$4 + $$8);
   }
   ...
   public interface a {
      jj<ddd> getNoiseBiome(int var1, int var2, int var3);
   }
}
