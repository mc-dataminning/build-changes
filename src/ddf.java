...
public class ddf {
   ...
   private final Optional<ja<avn>> j;
   ...
   public static class a {
      ...
      private Optional<ja<avn>> i = Optional.empty();
   ...
   public static enum b implements azg {
      ...
      public static final Codec<ddf.b> d = azg.a(ddf.b::values);
