...
public class ddf {
   public static <T> List<ddf.b> a(List<T> $$0, Function<T, List<jm<ehm>>> $$1, boolean $$2) {
      Object2IntMap<ehm> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, ehm c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jm<ehm>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ji<ehm> $$12 : $$10.get($$11)) {
               ehm $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && aym.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<ddf.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<ehm> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddf.b($$28));
      }
   ...
   public static record b(List<ehm> a, ToIntFunction<ehm> b) {
      b(List<ehm> $$0) {
         this($$0, ac.h($$0));
      }
   }
