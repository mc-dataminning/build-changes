...
public abstract class aqk {
   ...
   static final int b = aqa.a(aql.d);
   ...
   private final aqk.a f = new aqk.a();
   private final aqk.b g = new aqk.b(8);
   private final ara h = new ara();
   private final aqk.c i = new aqk.c(32);
   ...
   protected aqk(Executor $$0, Executor $$1) {
      bpj<Runnable> $$2 = bpj.a("player ticket throttler", $$1::execute);
      aqe $$3 = new aqe(ImmutableList.of($$2), $$0, 4);
      this.k = $$3;
      this.l = $$3.a($$2, true);
      this.m = $$3.a($$2);
      this.o = $$1;
   ...
   protected void a() {
      this.p++;
      ObjectIterator<Entry<azg<aqy<?>>>> $$0 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$0.hasNext()) {
         Entry<azg<aqy<?>>> $$1 = (Entry<azg<aqy<?>>>)$$0.next();
         Iterator<aqy<?>> $$2 = ((azg)$$1.getValue()).iterator();
         boolean $$3 = false;
         ...
         if ($$3) {
            this.f.b($$1.getLongKey(), a((azg<aqy<?>>)$$1.getValue()), false);
         }

         if (((azg)$$1.getValue()).isEmpty()) {
            $$0.remove();
         }
      }
   }

   private static int a(azg<aqy<?>> $$0) {
      return !$$0.isEmpty() ? $$0.b().b() : aqa.b + 1;
   }

   protected abstract boolean a(long var1);

   @Nullable
   protected abstract apz b(long var1);

   @Nullable
   protected abstract apz a(long var1, int var3, @Nullable apz var4, int var5);

   public boolean a(aqb $$0) {
      this.g.a();
      this.h.a();
      this.i.a();
      ...
      if (!this.j.isEmpty()) {
         ...
         if (!this.n.isEmpty()) {
            ...
            while ($$3.hasNext()) {
               long $$4 = $$3.nextLong();
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == aqz.c)) {
                  apz $$5 = $$0.a($$4);
                  if ($$5 == null) {
                     throw new IllegalStateException();
                  }

                  CompletableFuture<aqc<dvi>> $$6 = $$5.b();
                  $$6.thenAccept($$1x -> this.o.execute(() -> this.m.a(aqe.a(() -> {
                        }, $$4, false))));
               }
            }
   ...
   public <T> void c(aqz<T> $$0, dcd $$1, int $$2, T $$3) {
      aqy<T> $$4 = new aqy<>($$0, aqa.a(aql.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.a($$5, $$4);
      this.h.a($$5, $$4);
   }

   public <T> void d(aqz<T> $$0, dcd $$1, int $$2, T $$3) {
      aqy<T> $$4 = new aqy<>($$0, aqa.a(aql.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.b($$5, $$4);
      this.h.b($$5, $$4);
   ...
   private azg<aqy<?>> g(long $$0) {
      return (azg<aqy<?>>)this.e.computeIfAbsent($$0, $$0x -> azg.a(4));
   }

   protected void a(dcd $$0, boolean $$1) {
      aqy<dcd> $$2 = new aqy<>(aqz.d, aqb.c, $$0);
      long $$3 = $$0.a();
      if ($$1) {
         this.a($$3, $$2);
         this.h.a($$3, $$2);
   ...
   public void a(kf $$0, aqv $$1) {
      dcd $$2 = $$0.r();
      long $$3 = $$2.a();
      ((ObjectSet)this.d.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
      this.g.b($$3, 0, true);
      this.i.b($$3, 0, true);
      this.h.a(aqz.c, $$2, this.g(), $$2);
   }

   public void b(kf $$0, aqv $$1) {
      dcd $$2 = $$0.r();
      long $$3 = $$2.a();
      ObjectSet<aqv> $$4 = (ObjectSet<aqv>)this.d.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
         this.d.remove($$3);
         this.g.b($$3, Integer.MAX_VALUE, false);
         this.i.b($$3, Integer.MAX_VALUE, false);
         this.h.b(aqz.c, $$2, this.g(), $$2);
      }
   }

   private int g() {
      return Math.max(0, aqa.a(aql.d) - this.q);
   }

   public boolean c(long $$0) {
      return aqa.d(this.h.c($$0));
   }

   public boolean d(long $$0) {
      return aqa.e(this.h.c($$0));
   }

   protected String e(long $$0) {
      azg<aqy<?>> $$1 = (azg<aqy<?>>)this.e.get($$0);
   ...
   private void a(String $$0) {
      try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
         ...
         while (var3.hasNext()) {
            ...
            dcd $$3 = new dcd($$2.getLongKey());

            for (aqy<?> $$4 : (azg)$$2.getValue()) {
   ...
   public void e() {
      ImmutableSet<aqz<?>> $$0 = ImmutableSet.of(aqz.g, aqz.f);
      ObjectIterator<Entry<azg<aqy<?>>>> $$1 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$1.hasNext()) {
         Entry<azg<aqy<?>>> $$2 = (Entry<azg<aqy<?>>>)$$1.next();
         Iterator<aqy<?>> $$3 = ((azg)$$2.getValue()).iterator();
         boolean $$4 = false;
         ...
         if ($$4) {
            this.f.b($$2.getLongKey(), a((azg<aqy<?>>)$$2.getValue()), false);
         }

         if (((azg)$$2.getValue()).isEmpty()) {
            $$1.remove();
         }
      }
   }
   ...
   class a extends aqf {
      ...
      protected int b(long $$0) {
         azg<aqy<?>> $$1 = (azg<aqy<?>>)aqk.this.e.get($$0);
         if ($$1 == null) {
   ...
   class b extends aqf {
      ...
      private boolean d(long $$0) {
         ObjectSet<aqv> $$1 = (ObjectSet<aqv>)aqk.this.d.get($$0);
      ...
      private void a(String $$0) {
         try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
            ...
            aqk.a.error("Failed to dump chunks to {}", $$0, var9);
         }
      }
   }

   class c extends aqk.b {
      private int g;
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            aqy<?> $$4 = new aqy<>(aqz.c, aqk.b, new dcd($$0));
            if ($$3) {
               aqk.this.l.a(aqe.a(() -> aqk.this.o.execute(() -> {
                     if (this.c(this.c($$0))) {
                        aqk.this.a($$0, $$4);
                        aqk.this.n.add($$0);
                     } else {
               ...
               aqk.this.m.a(aqe.a(() -> aqk.this.o.execute(() -> aqk.this.b($$0, $$4)), $$0, true));
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  aqk.this.k.onLevelChange(new dcd($$1), () -> this.h.get($$1), $$3, $$1x -> {
