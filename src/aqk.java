...
public class aqk<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqk.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqk.this.remove(this.b + 1);
      }
   }
}
