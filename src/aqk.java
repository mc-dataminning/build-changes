...
public class aqk extends aqj {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aqk.a> s;
   private final aqf t;
   private long u;
   private final agy v;

   private aqk(agy $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aqg.c($$2, 7, $$0.getLength());
      }
   }
