...
public class gf implements ArgumentType<cuz> {
   ...
   public static cuz a(CommandContext<ew> $$0, String $$1) {
      return (cuz)$$0.getArgument($$1, cuz.class);
   }

   public cuz a(StringReader $$0) throws CommandSyntaxException {
