...
public class gf implements ArgumentType<UUID> {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xl.c("argument.uuid.invalid"));
   ...
   public static UUID a(CommandContext<ep> $$0, String $$1) {
