...
public class gf implements ArgumentType<Integer> {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      ...
      return ev.b(d.keySet(), $$1.createOffset($$1.getStart() + $$2.getCursor()));
   }
   ...
   public static class a implements il<gf, gf.a.a> {
      public void a(gf.a.a $$0, vr $$1) {
         $$1.p($$0.b);
      }

      public gf.a.a a(vr $$0) {
         int $$1 = $$0.readInt();
         return new gf.a.a($$1);
      }

      public void a(gf.a.a $$0, JsonObject $$1) {
         $$1.addProperty("min", $$0.b);
      }

      public gf.a.a a(gf $$0) {
         return new gf.a.a($$0.e);
      }

      public final class a implements il.a<gf> {
         final int b;
