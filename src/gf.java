...
public class gf {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ws.c("argument.pos.missing.double"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(ws.c("argument.pos.missing.int"));
   private final boolean d;
   private final double e;

   public gf(boolean $$0, double $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public static gf a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '^') {
