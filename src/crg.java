...
public class crg {
   public static final crg a = new crg(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<crg> b = RecordCodecBuilder.create(
   ...
   public crg(List<String> $$0, List<String> $$1) {
