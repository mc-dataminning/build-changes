...
public class crg {
   private static final List<crf> b = ac.a(new ArrayList<>(), $$0 -> {
      a($$0, "contents", 0);
      a($$0, "container.", 0, 54);
      a($$0, "hotbar.", 0, 9);
      a($$0, "inventory.", 9, 27);
   ...
   public static final Codec<crf> a = azc.b(() -> b.toArray(new crf[0]));
   private static final Function<String, crf> c = azc.a(b.toArray(new crf[0]), $$0 -> $$0);
