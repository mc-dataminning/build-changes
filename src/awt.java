...
public class awt extends awy {
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  ul $$4 = a($$3.getAsJsonObject());
                  $$4 = baw.g.a($$0, $$4, va.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awu<T>> a(aww<T> $$0, String $$1) {
      return Optional.ofNullable(alj.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static ul a(JsonObject $$0) {
      ul $$1 = new ul();
   ...
   private static <T> alj b(awu<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
