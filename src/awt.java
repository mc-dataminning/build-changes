...
public class awt<T> extends AbstractList<T> implements ayc<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return awt.this.get(this.b--);
      }

      @Override
      public void remove() {
         awt.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements ayc<T> {
      private final awt<T> b;

      public b(final awt<T> $$0) {
         this.b = $$0;
      }
