...
public abstract class eqm<T extends eqm<T>> {
   ...
   public eqm(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eqk.a();
         if ($$3 != null) {
         ...
         throw new erv(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new erv(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new erv(var2.getMessage(), var2);
      }
   }
   ...
   public static eqm<?> a(String $$0) {
      return new eqm.b($$0, 5000, 60000);
   }

   public static eqm<?> a(String $$0, int $$1, int $$2) {
      return new eqm.b($$0, $$1, $$2);
   }

   public static eqm<?> b(String $$0, String $$1) {
      return new eqm.c($$0, $$1, 5000, 60000);
   }

   public static eqm<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eqm.c($$0, $$1, $$2, $$3);
   }

   public static eqm<?> b(String $$0) {
      return new eqm.a($$0, 5000, 60000);
   }

   public static eqm<?> c(String $$0, String $$1) {
      return new eqm.d($$0, $$1, 5000, 60000);
   }

   public static eqm<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eqm.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eqm<eqm.a> {
   ...
   public static class b extends eqm<eqm.b> {
   ...
   public static class c extends eqm<eqm.c> {
      ...
      public eqm.c f() {
         try {
            ...
            throw new erv(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eqm<eqm.d> {
      private final String c;
