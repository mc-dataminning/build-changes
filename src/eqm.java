...
public class eqm {
   ...
   public void a(erw $$0, String $$1, ess.a $$2, egl $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eqm.b $$13 = new eqm.b($$1.trim(), this.f, $$3, $$2);
                  eqm.a $$14 = new eqm.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eqm.c $$30 = new eqm.c(this.f, $$2, $$0);
                        eqm.a $$31 = new eqm.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new esa(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, egl $$2) throws IOException {
      ...
      File $$15 = new File(evg.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, egl $$2, ess.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eqm.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eqm.this.b && !eqm.this.d) {
            try {
               eqm.this.e = true;
               eqm.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eqm.a.error("Error extracting archive", var3);
               eqm.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eqm.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eqm.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eqm.this.g);
                  eqm.this.c = true;
               } else {
                  eqm.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eqm.this.d = true;
               }
            } catch (IOException var3) {
               eqm.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eqm.this.d = true;
            }
         }
      }
