...
public class eqm {
   ...
   static class a implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new eqm.k($$0, $$1);
      }
   }

   static class b implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         ...
         return new eqm.l($$0, $$1);
      }
   }

   static class c implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new eqm.m($$0, $$1);
      }
   }

   static class d implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         ...
         return new eqm.n($$0, $$1);
      }
   }

   static class e implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         ...
         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new eqm.o($$0, $$3);
      }
   }

   static class f implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
         return true;
      }
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         $$1.d = true;
         return new eqm.s($$0, $$1, $$2);
      }
   }

   static class g implements eqm.i {
      @Override
      public boolean a(eqm.v $$0) {
      ...
      public eqm.r a(jm $$0, eqm.v $$1, bam $$2) {
         $$1.d = true;
         return new eqm.t($$0, $$1);
      }
   }

   public static class h extends eqm.r {
      ...
      private eqm.v G;
      private eqm.v H;
      private final List<eqm.r> I = Lists.newArrayList();

      public h(bam $$0, int $$1, int $$2, jm $$3) {
         super(eot.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eqm.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eqm.p($$3, this.G));
         this.I.add(new eqm.j($$3, this.H));
         List<eqm.i> $$5 = Lists.newArrayList();
         $$5.add(new eqm.b());
         $$5.add(new eqm.d());
         $$5.add(new eqm.e());
         $$5.add(new eqm.a());
         ...
         enu $$10 = enu.a(this.b(1, 1, 1), this.b(23, 8, 21));
         enu $$11 = enu.a(this.b(34, 1, 1), this.b(56, 8, 21));
         enu $$12 = enu.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eqm.u($$3, $$10, $$13++));
         this.I.add(new eqm.u($$3, $$11, $$13++));
         this.I.add(new eqm.q($$3, $$12));
      }
      ...
      private List<eqm.v> b(bam $$0) {
         eqm.v[] $$1 = new eqm.v[75];
         ...
         eqm.v $$23 = new eqm.v(1003);
         eqm.v $$24 = new eqm.v(1001);
         eqm.v $$25 = new eqm.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eqm.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhy $$2, bam $$3, enu $$4) {
         int $$5 = 24;
      ...
      private void a(dhy $$0, bam $$1, enu $$2) {
      ...
      private void b(dhy $$0, bam $$1, enu $$2) {
      ...
      private void c(dhy $$0, bam $$1, enu $$2) {
      ...
      private void d(dhy $$0, bam $$1, enu $$2) {
      ...
      private void e(dhy $$0, bam $$1, enu $$2) {
      ...
      private void f(dhy $$0, bam $$1, enu $$2) {
   ...
   interface i {
      boolean a(eqm.v var1);

      eqm.r a(jm var1, eqm.v var2, bam var3);
   }

   public static class j extends eqm.r {
      public j(jm $$0, eqm.v $$1) {
         super(eot.N, 1, $$0, $$1, 2, 2, 2);
      }
   ...
   public static class k extends eqm.r {
      public k(jm $$0, eqm.v $$1) {
         super(eot.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eqm.r {
      public l(jm $$0, eqm.v $$1) {
         super(eot.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eqm.r {
      public m(jm $$0, eqm.v $$1) {
         super(eot.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eqm.r {
      public n(jm $$0, eqm.v $$1) {
         super(eot.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eqm.r {
      public o(jm $$0, eqm.v $$1) {
         super(eot.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eqm.r {
      public p(jm $$0, eqm.v $$1) {
         super(eot.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eqm.r {
      public q(jm $$0, enu $$1) {
         super(eot.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eog {
      protected static final dxn b = dkg.iq.m();
      protected static final dxn c = dkg.ir.m();
      protected static final dxn d = dkg.is.m();
      protected static final dxn h = c;
      protected static final dxn i = dkg.iz.m();
      protected static final boolean j = true;
      protected static final dxn k = dkg.J.m();
      protected static final Set<dke> l = ImmutableSet.builder().add(dkg.eb).add(dkg.iT).add(dkg.nr).add(k.b()).build();
      ...
      public r(eot $$0, jm $$1, int $$2, enu $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eot $$0, int $$1, jm $$2, eqm.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static enu a(jm $$0, eqm.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         enu $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhy $$0, enu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dxn $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhy $$0, enu $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhy $$0, enu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dxn $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(enu $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhy $$0, enu $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cmh $$6 = bvm.N.a($$0.a(), bvl.d);
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bvl.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eqm.r {
      private int a;

      public s(jm $$0, eqm.v $$1, bam $$2) {
         super(eot.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eqm.r {
      public t(jm $$0, eqm.v $$1) {
         super(eot.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eqm.r {
      private int a;

      public u(jm $$0, enu $$1, int $$2) {
         super(eot.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
