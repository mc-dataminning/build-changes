public class gbf extends gca {
   private final gbv a;

   gbf(fxt $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbv $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cmv $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dw();
            if (this.h > $$1) {
   ...
   public static class a implements gbd<lm> {
      ...
      public gba a(lm $$0, fxt $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gbf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gbd<lm> {
      ...
      public gba a(lm $$0, fxt $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gba $$8 = new gbf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
