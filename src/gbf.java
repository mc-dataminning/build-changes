public class gbf extends gas<cwg> {
   ...
   private static final xa K = xa.c("gui.togglable_slot");
   private final crx L;

   public gbf(cwg $$0, crw $$1, xa $$2) {
      super($$0, $$1, $$2);
      this.L = $$1.h;
   }
   ...
   protected void a(cxn $$0, int $$1, int $$2, cwb $$3) {
      if ($$0 instanceof cwh && !$$0.h() && !this.L.Z_()) {
         switch ($$3) {
            case a:
               if (this.z.e($$1)) {
                  this.a($$1);
   ...
   private void a(int $$0, boolean $$1) {
      ...
      this.L.a(awp.Bv.a(), 0.4F, $$2);
   }

   @Override
   public void a(ftx $$0, cxn $$1) {
      if ($$1 instanceof cwh $$2 && this.z.e($$1.d)) {
         this.a($$0, $$2);
         return;
      }
   ...
   private void a(ftx $$0, cwh $$1) {
      $$0.a(gsl::H, G, $$1.e - 1, $$1.f - 1, 18, 18);
   }
   ...
   public void a(ftx $$0, int $$1, int $$2, float $$3) {
      ...
      this.d($$0);
      this.a($$0, $$1, $$2);
      if (this.B instanceof cwh && !this.z.e(this.B.d) && this.z.g().f() && !this.B.h() && !this.L.Z_()) {
         $$0.a(this.p, K, $$1, $$2);
      }
   }
