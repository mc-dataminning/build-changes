...
public class gbf implements gby {
   ...
   private CompletableFuture<Optional<cnz>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gbf(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cnz::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cnz>> a(Optional<cnz> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (aye | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cnz.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cnz $$0) {
      ...
      if ($$0 != null) {
         if (ab.aW) {
            cnz.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cnz a(UserApiService $$0) throws aye, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         coa.a $$2 = a($$1);
         return new cnz(ayd.a($$1.keyPair().privateKey()), new coa($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static coa.a a(KeyPairResponse $$0) throws aye {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = ayd.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new coa.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new aye(var5);
         }
      } else {
         throw new aye(new MissingException("Missing public key"));
      }
   }
}
