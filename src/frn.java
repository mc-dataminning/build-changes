...
public class frn extends fne {
   ...
   private final fks L = new fks(this);
   @Nullable
   private final fne M;
   frm N;
   fho O;
   private String P = "";
   private frn.a Q = frn.a.a;
   private fhf R;
   private fhf S;
   private fhf T;
   private fhf U;
   ...
   protected void aM_() {
      ...
      if (this.X) {
         ...
         this.N = new frm(this, this.m, this.n, this.m(), 88, 36);
      }

      int $$0 = this.N.b() / 3;
      int $$1 = this.N.r();
      int $$2 = this.N.s();
      this.R = this.c(fhf.a(s, $$0x -> this.a(frn.a.a)).a($$1, 45, $$0, 20).a());
      this.S = this.c(fhf.a(u, $$0x -> this.a(frn.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.T = this.c(fhf.a(v, $$0x -> this.a(frn.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.O != null ? this.O.a() : "";
      this.O = new fho(this.p, this.F() + 28, 74, 200, 15, z) {
         @Override
         protected yd aJ_() {
            return !frn.this.O.a().isEmpty() && frn.this.N.c() ? super.aJ_().f(", ").b(frn.A) : super.aJ_();
         }
      };
      this.O.f(16);
      this.O.g(true);
      ...
      this.c(this.O);
      this.d(this.N);
      this.U = this.c(fhf.a(D, flv.b(this, "https://aka.ms/javablocking")).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.X = true;
      this.a(this.Q);
      this.L.b(fhf.a(xo.d, $$0x -> this.d()).a(200).a());
      this.L.a($$1x -> {
