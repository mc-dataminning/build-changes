public abstract class frn extends frj {
   private static final ftd a = new ftd(ale.b("widget/text_field"), ale.b("widget/text_field_highlighted"));
   private static final int c = 4;

   public frn(int $$0, int $$1, int $$2, int $$3, ww $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(frc var1, int var2, int var3, float var4);
