public class frn extends frv {
   private static final auv a = auv.a();
   private final frq b;

   frn(fns $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, frq $$7) {
   ...
   public void a() {
      ...
      if (this.g()) {
         ...
         this.e(auo.i(0.05F, this.y, 1.0F));
      }
   }
   ...
   public static class a implements fqy<ka> {
      ...
      public fqv a(ka $$0, fns $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqv $$8 = new frn($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.e(0.15F);
   ...
   public static class b implements fqy<ka> {
      ...
      public fqv a(ka $$0, fns $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new frn($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class e implements fqy<ka> {
      ...
      public fqv a(ka $$0, fns $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         frn $$8 = new frn($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
