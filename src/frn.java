...
public class frn implements enr, AutoCloseable {
   ...
   private static final enk u = new enk();
   ...
   private final List<ens> B = Lists.newArrayList();
   private final List<Integer> C = Lists.newArrayList();
   private final Map<String, ens> D = Maps.newHashMap();
   private final int E;
   ...
   public frn(apo $$0, String $$1, eog $$2) throws IOException {
      this.F = $$1;
      this.M = $$2;
      agm $$3 = new agm("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         this.H = a(atg.a($$5, "blend", null));
         this.K = a($$0, enp.a.a, $$6);
         this.L = a($$0, enp.a.b, $$7);
         this.E = enq.a();
         if (this.J != null) {
            int $$23 = 0;
   ...
   private static enp a(final apo $$0, enp.a $$1, String $$2) throws IOException {
      enp $$3 = $$1.c().get($$2);
      enp $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         apj $$5 = $$0.getResourceOrThrow(new agm($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = enp.a($$1, $$2, $$6, $$5.b(), new eni() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        frn.t.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static enl a(JsonObject $$0) {
      if ($$0 == null) {
         return new enl();
      } else {
         int $$1 = 32774;
