...
public class frn {
   ...
   public static Supplier<String> a(fli $$0) {
      return () -> b($$0);
   }

   public static String b(fli $$0) {
      return n.a($$0.p.a().replaceAll("\\r", ""));
   }

   public static Consumer<String> c(fli $$0) {
      return $$1 -> a($$0, $$1);
   }
   ...
   public void b(int $$0, boolean $$1) {
      this.f = fls.a(this.a.get(), $$0, this.f, true);
      this.c($$1);
   }
   ...
   public void d(int $$0) {
      int $$1 = fls.a(this.a.get(), $$0, this.f, true);
      this.e($$1 - this.f);
   }
