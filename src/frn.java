...
public class frn {
   ...
   private static final Comparator<ffg> L = Comparator.comparing(ffg::d).reversed().thenComparing(ffg::c, String.CASE_INSENSITIVE_ORDER);
   ...
   private final fos ak;
   private final fsd al;
   private int am;
   @Nullable
   private wy an;
   private int ao;
   ...
   public float b = 1.0F;
   private int ar;
   private cyy as = cyy.k;
   private final fsk at;
   private final ftk au;
   private final fuc av;
   private final ftd aw;
   private final fsb ax;
   private int ay;
   @Nullable
   private wy az;
   @Nullable
   ...
   public frn(fos $$0) {
      ...
      this.av = new fuc($$0);
      this.al = new fsd($$0);
      this.aw = new ftd($$0, this);
      this.ax = new fsb($$0);
      this.au = new ftk($$0);
      this.a();
      frr $$1 = new frr().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ax.a($$0x));
      frr $$2 = new frr().a(this::o).a(($$0x, $$1x) -> {
         if (this.at.d()) {
            this.at.a($$0x);
         }
   ...
   private void d(fro $$0, foh $$1) {
      if (this.ak.t.go() > 0) {
         ...
         $$0.a(gqc.L(), 0, 0, $$0.a(), $$0.b(), $$4);
         bql.a().c();
      }
   }

   private void e(fro $$0, foh $$1) {
      frm $$2 = this.f();
      if (this.an != null && this.ao > 0) {
         bql.a().a("overlayMessage");
   ...
   private void f(fro $$0, foh $$1) {
      if (this.az != null && this.ay > 0) {
         frm $$2 = this.f();
         bql.a().a("titleAndSubtitle");
   ...
   private void h(fro $$0, foh $$1) {
      ffn $$2 = this.ak.s.R();
      fff $$3 = null;
      ffi $$4 = $$2.e(this.ak.t.cI());
      if ($$4 != null) {
         ffe $$5 = ffe.a($$4.o());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      fff $$6 = $$3 != null ? $$3 : $$2.a(ffe.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fro $$0, foh $$1) {
      ffn $$2 = this.ak.s.R();
      fff $$3 = $$2.a(ffe.a);
   ...
   private void j(fro $$0, foh $$1) {
      fow $$2 = this.ak.n;
      if ($$2.aE().a()) {
         if (this.ak.r.i() != dis.d || this.a(this.ak.w)) {
            if (this.at.d() && !this.ak.t.gz() && !$$2.Y().c()) {
               ...
               int $$5 = 15;
               $$0.a(gqc::J, c, ($$0.a() - 15) / 2, ($$0.b() - 15) / 2, 15, 15);
               if (this.ak.n.F().c() == fny.b) {
                  float $$6 = this.ak.t.H(0.0F);
                  boolean $$7 = false;
                  if (this.ak.v != null && this.ak.v instanceof bxc && $$6 >= 1.0F) {
                     $$7 = this.ak.t.gC() > 5.0F;
                     $$7 &= this.ak.v.bK();
                  }
                  ...
                  int $$9 = $$0.a() / 2 - 8;
                  if ($$7) {
                     $$0.a(gqc::J, d, $$9, $$8, 16, 16);
                  } else if ($$6 < 1.0F) {
                     int $$10 = (int)($$6 * 17.0F);
                     $$0.a(gqc::J, e, $$9, $$8, 16, 4);
                     $$0.a(gqc::J, f, 16, 4, 0, 0, $$9, $$8, $$10, 4);
                  }
               }
            }
         }
   ...
   private boolean a(@Nullable feg $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.d() == feg.a.c) {
         return ((fef)$$0).a() instanceof bud;
      } else if ($$0.d() == feg.a.b) {
         iu $$1 = ((fee)$$0).b();
         div $$2 = this.ak.s;
   ...
   private void k(fro $$0, foh $$1) {
      Collection<bvh> $$2 = this.ak.t.eC();
      if (!$$2.isEmpty() && (this.ak.z == null || !this.ak.z.C())) {
         ...
         for (bvh $$7 : Ordering.natural().reverse().sortedCopy($$2)) {
            je<bvf> $$8 = $$7.c();
            if ($$7.h()) {
               int $$9 = $$0.a();
               int $$10 = 1;
               ...
               float $$11 = 1.0F;
               if ($$7.f()) {
                  $$0.a(gqc::H, g, $$9, $$10, 24, 24);
               } else {
                  $$0.a(gqc::H, h, $$9, $$10, 24, 24);
                  if ($$7.a(200)) {
                     int $$12 = $$7.d();
                     int $$13 = 10 - $$12 / 20;
               ...
               $$6.add(() -> {
                  int $$5x = axw.a($$17);
                  $$0.a(gqc::H, $$14, $$15 + 3, $$16 + 3, 18, 18, $$5x);
               });
            }
         }
   ...
   private void l(fro $$0, foh $$1) {
      if (this.ak.r.i() == dis.d) {
         this.av.a($$0);
      } else {
         this.m($$0, $$1);
      }
   ...
   private void m(fro $$0, foh $$1) {
      ...
      if ($$2 != null) {
         ...
         $$0.a(gqc::H, i, $$5 - 91, $$0.b() - 22, 182, 22);
         $$0.a(gqc::H, j, $$5 - 91 - 1 + $$2.gi().j * 20, $$0.b() - 22 - 1, 24, 23);
         if (!$$3.f()) {
            if ($$4 == bwv.a) {
               $$0.a(gqc::H, k, $$5 - 91 - 29, $$0.b() - 23, 29, 24);
            } else {
               $$0.a(gqc::H, l, $$5 + 91, $$0.b() - 23, 29, 24);
            }
         }
         ...
         if (this.ak.n.F().c() == fny.c) {
            ...
            if ($$13 < 1.0F) {
               ...
               int $$16 = (int)($$13 * 19.0F);
               $$0.a(gqc::H, m, $$15, $$14, 18, 18);
               $$0.a(gqc::H, n, 18, 18, 0, 18 - $$16, $$15, $$14 + 18 - $$16, 18, $$16);
            }
         }
      }
   }

   private void a(bxm $$0, fro $$1, int $$2) {
      bql.a().a("jumpBar");
      float $$3 = this.ak.t.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
      int $$6 = $$1.b() - 32 + 3;
      $$1.a(gqc::H, o, $$2, $$6, 182, 5);
      if ($$0.c() > 0) {
         $$1.a(gqc::H, p, $$2, $$6, 182, 5);
      } else if ($$5 > 0) {
         $$1.a(gqc::H, q, 182, 5, 0, 0, $$2, $$6, $$5, 5);
      }

      bql.a().c();
   }

   private void a(fro $$0, int $$1) {
      bql.a().a("expBar");
      int $$2 = this.ak.t.gs();
      if ($$2 > 0) {
         int $$3 = 182;
         ...
         int $$5 = $$0.b() - 32 + 3;
         $$0.a(gqc::H, r, $$1, $$5, 182, 5);
         if ($$4 > 0) {
            $$0.a(gqc::H, s, 182, 5, 0, 0, $$1, $$5, $$4, 5);
         }
      }
   ...
   @Nullable
   private cqy n() {
      return this.ak.ao() instanceof cqy $$0 ? $$0 : null;
   }
   ...
   private void b(fro $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$7 = $$0.a() / 2 + 91;
         int $$8 = $$0.b() - 39;
         float $$9 = Math.max((float)$$1.h(byi.s), (float)Math.max($$5, $$2));
         int $$10 = azm.f($$1.fv());
   ...
   private static void a(fro $$0, cqy $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eQ();
      if ($$6 > 0) {
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fro $$0, cqy $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      frn.b $$11 = frn.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, frn.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == frn.b.d ? $$11 : frn.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fro $$0, frn.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a(gqc::H, $$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void a(fro $$0, cqy $$1, int $$2, int $$3, int $$4) {
      int $$5 = $$1.cs();
      ...
      if ($$7 || $$6 < $$5) {
         ...
         for (int $$12 = 1; $$12 <= 10; $$12++) {
            int $$13 = $$4 - ($$12 - 1) * 8 - 9;
            if ($$12 <= $$8) {
               $$0.a(gqc::H, C, $$13, $$3, 9, 9);
            } else if ($$11 && $$12 == $$9 && $$7) {
               $$0.a(gqc::H, D, $$13, $$3, 9, 9);
               this.a($$12, $$1, $$10);
            } else if ($$12 > 10 - $$10) {
               int $$14 = $$10 == 10 && this.am % 2 == 0 ? this.aj.a(2) : 0;
               $$0.a(gqc::H, E, $$13, $$3 + $$14, 9, 9);
            }
         }
      }
   }
   ...
   private void a(int $$0, cqy $$1, int $$2) {
      if (this.aI != $$0) {
   ...
   private void a(fro $$0, cqy $$1, int $$2, int $$3) {
      cum $$4 = $$1.gt();
      int $$5 = $$4.a();
      ...
      for (int $$6 = 0; $$6 < 10; $$6++) {
         ...
         int $$14 = $$3 - $$6 * 8 - 9;
         $$0.a(gqc::H, $$8, $$14, $$7, 9, 9);
         if ($$6 * 2 + 1 < $$5) {
            $$0.a(gqc::H, $$10, $$14, $$7, 9, 9);
         }

         if ($$6 * 2 + 1 == $$5) {
            $$0.a(gqc::H, $$9, $$14, $$7, 9, 9);
         }
      }
   }
      ...
      if ($$1 != null) {
         ...
         if ($$2 != 0) {
            ...
            for (int $$7 = 0; $$2 > 0; $$7 += 20) {
               ...
               for (int $$9 = 0; $$9 < $$8; $$9++) {
                  int $$10 = $$5 - $$9 * 8 - 9;
                  $$0.a(gqc::H, F, $$10, $$6, 9, 9);
                  if ($$9 * 2 + 1 + $$7 < $$3) {
                     $$0.a(gqc::H, G, $$10, $$6, 9, 9);
                  }

                  if ($$9 * 2 + 1 + $$7 == $$3) {
                     $$0.a(gqc::H, H, $$10, $$6, 9, 9);
                  }
               }
   ...
   private void a(fro $$0, alg $$1, float $$2) {
      int $$3 = axw.a($$2);
      $$0.a(gqc::F, $$1, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$3);
   }
   ...
   private void a(fro $$0, float $$1) {
      ...
      int $$9 = $$7 + $$5;
      int $$10 = $$8 + $$6;
      $$0.a(gqc::H, J, $$7, $$8, 0.0F, 0.0F, $$5, $$6, $$5, $$6);
      $$0.a(gqc.L(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gqc.L(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gqc.L(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gqc.L(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bwd $$0) {
      iu $$1 = iu.a($$0.dA(), $$0.dE(), $$0.dG());
      float $$2 = gpp.a($$0.dV().B_(), $$0.dV().B($$1));
      float $$3 = azm.a(1.0F - $$2, 0.0F, 1.0F);
      this.b = this.b + ($$3 - this.b) * 0.01F;
   }

   private void a(fro $$0, @Nullable bwd $$1) {
      ebr $$2 = this.ak.s.A_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
      ...
      $$0.a(gqc::I, I, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$7);
   }

   private void b(fro $$0, float $$1) {
      if ($$1 < 1.0F) {
         $$1 *= $$1;
         $$1 *= $$1;
         $$1 = $$1 * 0.8F + 0.2F;
      ...
      int $$2 = axw.a($$1);
      hip $$3 = this.ak.ap().a().a(dmc.er.m());
      $$0.a(gqc::F, $$3, 0, 0, $$0.a(), $$0.b(), $$2);
   }

   private void c(fro $$0, float $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      $$0.c().a();
      ...
      float $$6 = 0.4F * $$1;
      float $$7 = 0.2F * $$1;
      $$0.a($$0x -> gqc.M(), a, 0, 0, 0.0F, 0.0F, $$2, $$3, $$2, $$3, axw.a(1.0F, $$5, $$6, $$7));
      $$0.c().b();
   }

   private void a(fro $$0, int $$1, int $$2, foh $$3, cqy $$4, cyy $$5, int $$6) {
      if (!$$5.f()) {
