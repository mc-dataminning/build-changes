...
public class auv {
   public static final Codec<auv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(atv.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), atv.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, auv::new)
   );
   ...
   private auv(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
