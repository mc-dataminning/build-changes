...
public class auv<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return auv.this.get(this.b--);
      }

      @Override
      public void remove() {
         auv.this.remove(this.b + 1);
      }
   }
}
