...
public class auv<S> implements aul {
   ...
   protected final CompletableFuture<bac> a = new CompletableFuture<>();
   ...
   public static auv<Void> a(aup $$0, List<auj> $$1, Executor $$2, Executor $$3, CompletableFuture<bac> $$4) {
      return new auv<>($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> $$3x.a($$1x, $$2x, bnf.a, bnf.a, $$2, $$5), $$4);
   }
   ...
   public static aul a(aup $$0, List<auj> $$1, Executor $$2, Executor $$3, CompletableFuture<bac> $$4, boolean $$5) {
