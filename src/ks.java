...
public class ks implements ji {
   ...
   public CompletableFuture<?> a(jg $$0) {
      ...
      Map<acq, Supplier<JsonElement>> $$3 = Maps.newHashMap();
      Set<cfu> $$4 = Sets.newHashSet();
      BiConsumer<acq, Supplier<JsonElement>> $$5 = ($$1x, $$2x) -> {
      ...
      new kq($$2, $$5, $$6).a();
      new kr($$5).a();
      List<cpn> $$7 = jb.f.s().filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
