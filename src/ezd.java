...
public class ezd {
   ...
   @Nullable
   private String g;
   private static final ezd.a h = new ezd.a() {
      @Nullable
      @Override
      public ezc a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ezg.a(this.d, "Get capabilities")) {
         ...
         if (ezg.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ezg.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ezg.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ezc a(ezd.c $$0) {
      return ($$0 == ezd.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ezd.a {
      private final int a;
      private final Set<ezc> b = Sets.newIdentityHashSet();
      ...
      public ezc a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               ezd.a.warn("Maximum sound pool size {} reached", this.a);
            }
