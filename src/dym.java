...
public final class dym extends dyp<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dym(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dym $$1 && super.equals($$0)) {
   ...
   public static dym a(String $$0, int $$1, int $$2) {
      return new dym($$0, $$1, $$2);
   }
