...
public class dym {
   ...
   public static final Codec<dym> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               c.lenientOptionalFieldOf("filtered_messages").forGetter(dym::d),
               cxw.q.fieldOf("color").orElse(cxw.p).forGetter($$0x -> $$0x.f),
   ...
   public dym() {
      this(c(), c(), cxw.p, false);
   }

   public dym(wy[] $$0, wy[] $$1, cxw $$2, boolean $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   private static dym a(wy[] $$0, Optional<wy[]> $$1, cxw $$2, boolean $$3) {
      return new dym($$0, $$1.orElse(Arrays.copyOf($$0, $$0.length)), $$2, $$3);
   }
   ...
   public dym a(boolean $$0) {
      return $$0 == this.g ? this : new dym(this.d, this.e, this.f, $$0);
   }
   ...
   public dym a(cxw $$0) {
      return $$0 == this.b() ? this : new dym(this.d, this.e, $$0, this.g);
   }
   ...
   public dym a(int $$0, wy $$1) {
      return this.a($$0, $$1, $$1);
   }

   public dym a(int $$0, wy $$1, wy $$2) {
      wy[] $$3 = Arrays.copyOf(this.d, this.d.length);
      wy[] $$4 = Arrays.copyOf(this.e, this.e.length);
      $$3[$$0] = $$1;
      $$4[$$0] = $$2;
      return new dym($$3, $$4, this.f, this.g);
   }
