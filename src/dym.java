...
public class dym {
   ...
   private final List<dyk> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dym.a l = new dym.d(5.999997E7F);
   public static final dym.c d = new dym.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(ji $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(faz $$0) {
   ...
   public faz c(double $$0, double $$1, double $$2) {
      return new faz(ayz.a($$0, this.e(), this.g() - 1.0E-5F), $$1, ayz.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dym.a)($$0 == $$1 ? new dym.d($$1) : new dym.b($$0, $$1, $$2));
   ...
   public dym.c t() {
      return new dym.c(this);
   }

   public void a(dym.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dym.a {
      ...
      @Override
      public double a() {
         return ayz.a(dym.this.a() - this.e() / 2.0, (double)(-dym.this.k), (double)dym.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dym.this.b() - this.e() / 2.0, (double)(-dym.this.k), (double)dym.this.k);
      }
      ...
      @Override
      public dyl i() {
         return this.c < this.b ? dyl.b : dyl.a;
      }
      ...
      @Override
      public dym.a l() {
         return (dym.a)(this.g() <= 0L ? dym.this.new d(this.c) : this);
      }
      ...
      public fbt m() {
         return fbq.a(
            fbq.c,
            fbq.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbd.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dym.c a(DynamicLike<?> $$0, dym.c $$1) {
         ...
         return new dym.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dym.a {
      ...
      private void n() {
         this.c = ayz.a(dym.this.a() - this.b / 2.0, (double)(-dym.this.k), (double)dym.this.k);
         this.d = ayz.a(dym.this.b() - this.b / 2.0, (double)(-dym.this.k), (double)dym.this.k);
         this.e = ayz.a(dym.this.a() + this.b / 2.0, (double)(-dym.this.k), (double)dym.this.k);
         this.f = ayz.a(dym.this.b() + this.b / 2.0, (double)(-dym.this.k), (double)dym.this.k);
         this.g = fbq.a(
            fbq.c,
            fbq.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbd.e
