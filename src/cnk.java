public class cnk extends bsw implements cno {
   private static final akk<cur> b = ako.a(cnk.class, akm.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public cnk(btc<? extends cnk> $$0, dca $$1) {
      super($$0, $$1);
   }

   public cnk(dca $$0, double $$1, double $$2, double $$3) {
      this(btc.N, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void l() {
      ...
      double $$4 = $$0.h();
      this.s(cnr.d(this.P, (float)(ayz.d($$0.d, $$4) * 180.0F / (float)Math.PI)));
      this.r(cnr.d(this.O, (float)(ayz.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
      if (!this.dP().B) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         ...
         $$0 = new evt(Math.cos((double)$$8) * $$9, $$10 + ((double)$$11 - $$10) * 0.015F, Math.sin((double)$$8) * $$9);
         this.h($$0);
      }
      ...
      if (!this.dP().B) {
         ...
         if (this.f > 80 && !this.dP().B) {
            this.a(awa.ih, 1.0F, 1.0F);
            this.ao();
            if (this.g) {
               this.dP().b(new cjj(this.dP(), this.du(), this.dw(), this.dA(), this.p()));
            } else {
   ...
   public void a(us $$0) {
      if ($$0.b("Item", 10)) {
         this.a(cur.a(this.dR(), (vp)$$0.p("Item")).orElse(this.s()));
      } else {
         this.a(this.s());
      }
   }
