...
public class cnk extends cno {
   ...
   private static final akj<Integer> g = akn.a(cnk.class, akl.b);
   private static final akj<Boolean> h = akn.a(cnk.class, akl.k);
   private int i;
   private int j;
   private int k;
   private int l;
   ...
   @Nullable
   private bst o;
   private cnk.a p = cnk.a.a;
   private final int q;
   private final int r;

   private cnk(bsz<? extends cnk> $$0, dbx $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.au = true;
      this.q = Math.max(0, $$2);
      this.r = Math.max(0, $$3);
   ...
   public cnk(bsz<? extends cnk> $$0, dbx $$1) {
      this($$0, $$1, 0, 0);
   }

   public cnk(cmw $$0, dbx $$1, int $$2, int $$3) {
      this(bsz.bz, $$1, $$2, $$3);
      this.c($$0);
      float $$4 = $$0.dH();
      float $$5 = $$0.dF();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      evq $$13 = new evq((double)(-$$7), (double)ayy.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
      $$13 = $$13.d(0.6 / $$14 + this.ah.a(0.5, 0.0103365), 0.6 / $$14 + this.ah.a(0.5, 0.0103365), 0.6 / $$14 + this.ah.a(0.5, 0.0103365));
      this.h($$13);
      this.r((float)(ayy.d($$13.c, $$13.e) * 180.0F / (float)Math.PI));
      this.s((float)(ayy.d($$13.d, $$13.h()) * 180.0F / (float)Math.PI));
      this.O = this.dF();
      this.P = this.dH();
   }
   ...
   public void a(akj<?> $$0) {
      ...
      if (h.equals($$0)) {
         this.d = this.ap().a(h);
         if (this.d) {
            this.o(this.ds().c, (double)(-0.4F * ayy.a(this.c, 0.6F, 1.0F)), this.ds().e);
         }
      }
   ...
   public void l() {
      ...
      if ($$0 == null) {
         ...
         this.J();
         if (this.p == cnk.a.a && (this.aE() || this.Q)) {
            this.h(evq.b);
         }
   ...
   protected boolean b(bst $$0) {
      return super.b($$0) || $$0.bD() && $$0 instanceof cjg;
   }
   ...
   private void a(iz $$0) {
      ...
      if (this.j > 0) {
         ...
         if (this.l > 0) {
            ...
            double $$8 = (double)((float)ayy.a(this.dw()) + 1.0F);
            double $$9 = this.dA() + (double)($$6 * (float)this.l * 0.1F);
            dsb $$10 = $$1.a_(iz.a($$7, $$8 - 1.0, $$9));
            if ($$10.a(dfa.G)) {
               if (this.ah.i() < 0.15F) {
         ...
         if (this.ah.i() < $$14) {
            float $$15 = ayy.a(this.ah, 0.0F, 360.0F) * (float) (Math.PI / 180.0);
            float $$16 = ayy.a(this.ah, 25.0F, 60.0F);
            double $$17 = this.du() + (double)(ayy.a($$15) * $$16) * 0.1;
            double $$18 = (double)((float)ayy.a(this.dw()) + 1.0F);
            double $$19 = this.dA() + (double)(ayy.b($$15) * $$16) * 0.1;
            dsb $$20 = $$1.a_(iz.a($$17, $$18 - 1.0, $$19));
            if ($$20.a(dfa.G)) {
         ...
         if (this.k <= 0) {
            this.m = ayy.a(this.ah, 0.0F, 360.0F);
            this.l = ayy.a(this.ah, 20, 80);
         }
      } else {
         this.k = ayy.a(this.ah, 100, 600);
   ...
   private boolean b(iz $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cnk.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case a:
               if ($$1 == cnk.b.c) {
                  return false;
   ...
   private cnk.b a(iz $$0, iz $$1) {
      return iz.d($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cnk.b.c).orElse(cnk.b.c);
   }

   private cnk.b c(iz $$0) {
      dsb $$1 = this.dP().a_($$0);
      if (!$$1.i() && !$$1.a(dfa.fm)) {
         enu $$2 = $$1.u();
         return $$2.a(awu.a) && $$2.b() && $$1.k(this.dP(), $$0).c() ? cnk.b.b : cnk.b.c;
      } else {
         return cnk.b.a;
      }
   }
   ...
   public int a(cuo $$0) {
      ...
      if (!this.dP().B && $$1 != null && !this.a($$1)) {
         ...
         if (this.o != null) {
            ...
            $$2 = this.o instanceof cjg ? 3 : 5;
         } else if (this.j > 0) {
            eqk $$3 = new eqk.a((are)this.dP()).a(etd.f, this.dn()).a(etd.i, $$0).a(etd.a, this).a((float)this.q + $$1.gy()).a(etc.f);
            eqm $$4 = this.dP().o().be().b(eqd.aC);
            List<cuo> $$5 = $$4.a($$3);
            am.E.a((arf)$$1, $$0, this, $$5);

            for (cuo $$6 : $$5) {
               cjg $$7 = new cjg(this.dP(), this.du(), this.dw(), this.dA(), $$6);
               ...
               this.dP().b($$7);
               $$1.dP().b(new bte($$1.dP(), $$1.du(), $$1.dw() + 0.5, $$1.dA() + 0.5, this.ah.a(6) + 1));
               if ($$6.a(awx.aP)) {
                  $$1.a(awj.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dP().B && this.o instanceof cmw && ((cmw)this.o).g()) {
         this.d(this.o);
      }
   ...
   protected void d(bst $$0) {
      bst $$1 = this.s();
      if ($$1 != null) {
         evq $$2 = new evq($$1.du() - this.du(), $$1.dw() - this.dw(), $$1.dA() - this.dA()).a(0.1);
         $$0.h($$0.ds().e($$2));
      }
   }
   ...
   public cmw u() {
      bst $$0 = this.s();
      return $$0 instanceof cmw ? (cmw)$$0 : null;
   }
