...
public class cnk extends cmq {
   ...
   @Nullable
   private ctp<cud> y;
   private final List<ctp<cud>> z;

   public cnk(int $$0, cir $$1) {
      this($$0, $$1, clz.a);
   }

   public cnk(int $$0, cir $$1, clz $$2) {
      super(cmv.v, $$0, $$1, $$2);
      this.x = $$1.m.dM();
      this.z = this.x.r().a(cts.g);
   }
   ...
   @Override
   public void m() {
      List<ctp<cud>> $$0 = this.x.r().b(cts.g, this.q, this.x);
      if ($$0.isEmpty()) {
         this.r.a(0, cqk.h);
      } else {
         ctp<cud> $$1 = $$0.get(0);
         cqk $$2 = $$1.b().a(this.q, this.x.H_());
         if ($$2.a(this.x.I())) {
            this.y = $$1;
            this.r.a($$1);
            this.r.a(0, $$2);
   ...
   private static OptionalInt a(cud $$0, cqk $$1) {
      if ($$0.a($$1)) {
