...
public interface cwh extends cxd {
   @Nullable
   dki c_(ib var1);
   ...
   default epp a(cwj $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dnb $$2 = this.a_($$1);
         ept $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new epp($$0x.a(), ih.a($$3.c, $$3.d, $$3.e), ib.a($$0x.a()), false) : null;
      }, $$0x -> {
         ept $$1 = $$0x.b().d($$0x.a());
         return epp.a($$0x.a(), ih.a($$1.c, $$1.d, $$1.e), ib.a($$0x.a()));
      });
   }
   ...
   @Nullable
   default epp a(ept $$0, ept $$1, ib $$2, eqm $$3, dnb $$4) {
      epp $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         epp $$6 = $$4.m(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(eqm $$0, Supplier<eqm> $$1) {
      if (!$$0.c()) {
         return $$0.c(ih.a.b);
      } else {
   ...
   static <T, C> T a(ept $$0, ept $$1, C $$2, BiFunction<C, ib, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
