...
public abstract class qp {
   ...
   private static volatile qp e = c();
   ...
   private static qp c() {
      ...
      return new qp() {
         ...
         @Override
         public arf a(tm $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> asj.c($$2xxx, $$1x, $$1) ? Optional.empty() : tm.a, ue.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = qp.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(arj.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract arf a(tm var1);

   public List<arf> a(List<tm> $$0) {
