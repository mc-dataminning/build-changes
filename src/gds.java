...
public class gds {
   ...
   private gds(int $$0, List<gdu> $$1) {
      this.a = $$1.toArray(gdu[]::new);
      this.b = $$1.size();
   }

   private List<gdu> c() {
      List<gdu> $$0 = new ArrayList<>(this.d());
