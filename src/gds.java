...
public class gds extends fyn {
   ...
   private final fwj s = new fwj(this);
   private final fyn u;
   private final aun v;
   ...
   public gds(fyn $$0, aun $$1, Consumer<aun> $$2) {
      super(a);
      this.u = $$0;
      this.v = $$1;
      this.w = $$2;
   ...
   protected void aO_() {
      this.s.a(a, this.p);
      fwn $$0 = this.s.c(fwn.d());
      $$0.a(new ftp(b, this.p).d(310), $$0x -> $$0x.e(15));
      gdx.a $$1 = gdx.a(299).a(2, true).b(4);
      this.x.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.x.getBoolean($$1x), $$1xx -> this.x.put($$1x, $$1xx)).a($$1x.c()));
      fwk $$2 = $$1.a().a();
      this.y = new gds.a($$2, 310, 130);
      $$0.a(this.y);
      fwn $$3 = this.s.b(fwn.e().a(8));
      $$3.a(fsv.a(wx.d, $$0x -> this.m()).a());
      $$3.a(fsv.a(wx.e, $$0x -> this.aL_()).a());
      this.s.a($$1x -> {
   ...
   public class a extends fsm {
      private final List<fst> a = new ArrayList<>();
      private final fwk c;

      public a(final fwk $$1, final int $$2, final int $$3) {
         super(0, 0, $$2, $$3, wx.a);
         this.c = $$1;
         $$1.a(this::a);
      }
      ...
      @Override
      public fxc b(fxa $$0) {
         return new fxc(this.F(), this.G(), this.g, this.n());
      }
      ...
      @Override
      public Collection<? extends fwq> L() {
         return this.a;
      }
   }
}
