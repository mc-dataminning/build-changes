...
public class atv {
   ...
   public static final Codec<Object> b = a(aug.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(aud.e($$0));
   ...
   public static final Codec<atv.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ahg.b($$0.substring(1)).map($$0x -> new atv.f($$0x, true)) : ahg.b($$0).map($$0x -> new atv.f($$0x, false)), atv.f::c
      );
   ...
   public static <F, S> atv.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new atv.b<>($$0, $$1);
   }

   public static <K, V> atv.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new atv.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof atv.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
