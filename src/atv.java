...
class atv implements Path {
   private static final BasicFileAttributes a = new att() {
      @Override
   ...
   private static final BasicFileAttributes b = new att() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atv> c = Comparator.comparing(atv::n);
   ...
   public atv(atx $$0, String $$1, @Nullable atv $$2, aty $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atv a(@Nullable atv $$0, String $$1) {
      return new atv(this.e, $$1, $$0, aty.b);
   }
   ...
   atv a(String $$0) {
      if (a(this.i)) {
         return new atv(this.e, $$0, this, this.i);
      } else if (this.i instanceof aty.a $$1) {
         atv $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atv(this.e, $$0, this, aty.a);
      } else if (this.i instanceof aty.b) {
         return new atv(this.e, $$0, this, aty.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aty $$0) {
      return $$0 == aty.a || $$0 == aty.b;
   }
   ...
   private atv c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atv $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aty.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aty.a i() {
      return this.i instanceof aty.a $$0 ? $$0 : null;
   }
