...
public class atv extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(ayz.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(ayz.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(ayz.s);
