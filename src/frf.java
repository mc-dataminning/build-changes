...
public class frf implements frj.a {
   ...
   private final eqp J;
   private final Map<gw, frf.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         biw $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dG();
      });
   }

   private void b(elj $$0, foa $$1, double $$2, double $$3, double $$4) {
      gw $$5 = gw.a($$2, $$3, $$4);
   ...
   private void a(elj $$0, foa $$1, frf.a $$2) {
      int $$3 = 0;
   ...
   private void a(elj $$0, foa $$1, vv.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         frr.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(elj $$0, foa $$1, vv.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(elj $$0, foa $$1, String $$2, frf.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(frf.a $$0) {
      return this.b($$0.a).stream().map(abb::a).collect(Collectors.toSet());
   }

   private Set<String> c(frf.a $$0) {
   ...
   private void d() {
      frj.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
