...
public class frf {
   ...
   public final Map<hx, frg> c;
   public final frh d;
   public final boolean e;

   public frf(Vector3f $$0, Vector3f $$1, Map<hx, frg> $$2, @Nullable frh $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<hx, frg> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<frf> {
      private static final boolean a = true;

      public frf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         frh $$6 = this.a($$3);
         Map<hx, frg> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !asy.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = asy.a($$3, "shade", true);
            return new frf($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private frh a(JsonObject $$0) {
         frh $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = asy.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            hx.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = asy.a($$2, "rescale", false);
            $$1 = new frh($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = asy.m($$0, "angle");
         if ($$1 != 0.0F && ati.e($$1) != 22.5F && ati.e($$1) != 45.0F) {
      ...
      private Map<hx, frg> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<hx, frg> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<hx, frg> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<hx, frg> $$2 = Maps.newEnumMap(hx.class);
         JsonObject $$3 = asy.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            hx $$5 = this.a($$4.getKey());
            $$2.put($$5, (frg)$$0.deserialize($$4.getValue(), frg.class));
         }
