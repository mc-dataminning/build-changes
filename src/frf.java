...
public class frf extends fru {
   ...
   frf(fnr $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   private void a(eqe $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
   ...
   public static class a implements fqx<jz> {
      private final frp a;
      ...
      public fqu a(jz $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         frf $$8 = new frf($$1, $$2, $$3, $$4, $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
