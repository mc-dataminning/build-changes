...
public class frf implements fep {
   static final Logger b = LogUtils.getLogger();
   private final ffq c;
   private final fqt<frf.b> d;

   frf(ffq $$0, fqt<frf.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alz c, int d, int e, int[][] f) implements frh {
      ...
      public static final MapCodec<frf.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alz.a.fieldOf("file").forGetter(frf.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(frf.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(frf.a::e),
                     g.fieldOf("chars").forGetter(frf.a::f)
                  )
                  .apply($$0, frf.a::new)
         )
         .validate(frf.a::a);
      ...
      private static DataResult<frf.a> a(frf.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     frf.b $$15 = $$9.a($$12, new frf.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        frf.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ffq $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ffq b, int c, int d, int e, int f, int g, int h) implements feo {
