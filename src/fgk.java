...
public class fgk {
   ...
   private void b() {
      try {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            this.e[$$2] = ged.a.parse(up.a, $$0.c(String.valueOf($$2))).resultOrPartial($$0x -> b.warn("Failed to parse hotbar: {}", $$0x)).orElseGet(ged::new);
         }
   ...
   public void a() {
      try {
         ...
         for (int $$1 = 0; $$1 < 9; $$1++) {
            ged $$2 = this.a($$1);
            DataResult<uy> $$3 = ged.a.encodeStart(up.a, $$2);
