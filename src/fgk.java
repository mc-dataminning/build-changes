...
public class fgk implements Comparable<fgk> {
   private static final Map<String, fgk> h = Maps.newHashMap();
   private static final Map<fac.a, fgk> i = Maps.newHashMap();
   ...
   private final fac.a m;
   private final String n;
   private fac.a o;
   private boolean p;
   private int q;

   public static void a(fac.a $$0) {
      fgk $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(fac.a $$0, boolean $$1) {
      fgk $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fgk $$0 : h.values()) {
         if ($$0.o.a() == fac.b.a && $$0.o.b() != fac.bv.b()) {
            $$0.a(fac.a(fgm.Q().aM().j(), $$0.o.b()));
         }
      }
   }
   ...
   public fgk(String $$0, int $$1, String $$2) {
      this($$0, fac.b.a, $$1, $$2);
   }

   public fgk(String $$0, fac.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(fac.a $$0) {
      this.o = $$0;
   }

   public int a(fgk $$0) {
      return this.n.equals($$0.n) ? grp.a(this.l).compareTo(grp.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(fgk $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(fac.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == fac.bv.b() ? this.o.a() == fac.b.b && this.o.b() == $$1 : this.o.a() == fac.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == fac.b.c && this.o.b() == $$0;
   }
