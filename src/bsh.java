...
public class bsh implements bsa {
   ...
   public bsh(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<bry> a() {
      Builder<bry> $$0 = ImmutableSet.builder();

      try {
         bsh.a $$1 = new bsh.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bry.a("cpu#" + $$1x, brx.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bry.a("heap MiB", brx.e, () -> (double)ad.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(brz.a.a());
      return $$0.build();
   }
   ...
   public static bry a(final LongSupplier $$0) {
      ...
      bry.d $$3 = new bry.d(2.0F);
      return bry.a("ticktime", brx.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
