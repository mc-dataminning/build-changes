...
public class cel extends cdd {
   private static final cgw c = cgw.b().d();
   private final cgw d;
   ...
   private int k;
   private boolean l;
   private final Predicate<cxo> m;
   private final boolean n;

   public cel(bwn $$0, double $$1, Predicate<cxo> $$2, boolean $$3) {
      this.a = $$0;
      this.e = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean b() {
      if (this.k > 0) {
         ...
         this.b = a(this.a).a(this.d.a(this.a.h(bxn.E)), this.a);
         return this.b != null;
      }
   }
