...
public abstract class cel {
   ...
   private final hp<cjf> l = hp.a();
   public final hp<cgd> i = hp.a();
   private final List<cfb> m = Lists.newArrayList();
   private cjf n = cjf.b;
   private final hp<cjf> o = hp.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cgd> v = Sets.newHashSet();
   private final List<cex> w = Lists.newArrayList();
   @Nullable
   private cey x;
   private boolean y;

   protected cel(@Nullable cfq<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cew $$0, cbu $$1, csv $$2) {
   ...
   protected static void a(bgr $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cev $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cfb a(cfb $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(cev $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cfb.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cjf $$1 = this.i.get($$0).e();
         Supplier<cjf> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cjf $$1, Supplier<cjf> $$2) {
      cjf $$3 = this.l.get($$0);
      if (!cjf.a($$3, $$1)) {
         cjf $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cjf $$1, Supplier<cjf> $$2) {
      if (!this.y) {
         cjf $$3 = this.o.get($$0);
         if (!cjf.a($$3, $$1)) {
            cjf $$4 = $$2.get();
   ...
   public abstract cjf a(cbu var1, int var2);

   public void a(int $$0, int $$1, ceu $$2, cbu $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, ceu $$2, cbu $$3) {
      cbt $$4 = $$3.fR();
      if ($$2 == ceu.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == ceu.a || $$2 == ceu.b) && ($$1 == 0 || $$1 == 1)) {
         cet $$16 = $$1 == 0 ? cet.a : cet.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == cet.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == cet.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == cet.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<cjf> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cjf> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == ceu.d && $$3.fS().d && this.g().b() && $$0 >= 0) {
         cgd $$32 = this.i.get($$0);
         if ($$32.f()) {
            cjf $$33 = $$32.e();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == ceu.e && this.g().b() && $$0 >= 0) {
         cgd $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.e().L();
         cjf $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == ceu.g && $$0 >= 0) {
         cgd $$37 = this.i.get($$0);
         cjf $$38 = this.g();
         if (!$$38.b() && (!$$37.f() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.L() < $$38.g(); $$42 += $$40) {
                  cgd $$43 = this.i.get($$42);
                  if ($$43.f() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cjf $$44 = $$43.e();
                     if ($$41 != 0 || $$44.L() != $$44.g()) {
                        cjf $$45 = $$43.b($$44.L(), $$38.g() - $$38.L(), $$3);
                        $$38.g($$45.L());
                     }
                  }
               }
   ...
   private boolean a(cbu $$0, cet $$1, cgd $$2, cjf $$3, cjf $$4) {
      cec $$5 = $$0.dL().G();
   ...
   public void a(int $$0, int $$1, cjf $$2) {
      this.b($$0).e($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cjf> $$1, cjf $$2) {
   ...
   public abstract boolean a(cbu var1);

   protected boolean a(cjf $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cbu $$1) {
      if ($$0 == 0) {
         return true;
      } else {
         return $$0 == 1 ? true : $$0 == 2 && $$1.fS().d;
      }
   }
   ...
   public static boolean a(@Nullable cgd $$0, cjf $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.f();
      return !$$3 && cjf.c($$1, $$0.e()) ? $$0.e().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }

   public static int a(Set<cgd> $$0, int $$1, cjf $$2) {
      return switch ($$1) {
         case 0 -> arx.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
   ...
   public static int a(@Nullable dcv $$0) {
      return $$0 instanceof bgr ? b((bgr)$$0) : 0;
   }

   public static int b(@Nullable bgr $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cel $$0) {
      Table<bgr, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bgr $$0, int $$1) {
