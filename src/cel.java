...
public class cel {
   ...
   private int g = auo.b(auv.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ja.a.fieldOf("uuid").forGetter(Pair::getFirst), atw.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<blv> j;
   @VisibleForTesting
   protected final ArrayList<blv> c;
   private final cel.a k;
   @VisibleForTesting
   protected final Object2IntMap<blv> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cel> a(Predicate<blv> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cel::b)).apply($$1, $$1x -> new cel($$0, $$1x))
      );
   }

   public cel(Predicate<blv> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cel.a(this);
   ...
   public void a(and $$0, Predicate<blv> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<blv>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<blv> $$6 = (Entry<blv>)$$5.next();
         int $$7 = $$6.getIntValue();
         blv $$8 = (blv)$$6.getKey();
         blv.c $$9 = $$8.dI();
   ...
   public int b(@Nullable blv $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bml> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bml).map($$0 -> (bml)$$0);
   }

   @VisibleForTesting
   protected static record a(cel a) implements Comparator<blv> {
      public int a(blv $$0, blv $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cfi;
               boolean $$7 = $$1 instanceof cfi;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
