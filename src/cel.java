...
public abstract class cel {
   ...
   private final hn<cjf> l = hn.a();
   public final hn<cgd> i = hn.a();
   private final List<cfb> m = Lists.newArrayList();
   private cjf n = cjf.b;
   private final hn<cjf> o = hn.a();
   ...
   protected void a(cbu $$0, bgr $$1) {
      if (!$$0.bv() || $$0 instanceof akr && ((akr)$$0).t()) {
         for (int $$2 = 0; $$2 < $$1.b(); $$2++) {
            $$0.a($$1.b($$2), false);
         }
      } else {
   ...
   public static int a(Set<cgd> $$0, int $$1, cjf $$2) {
      return switch ($$1) {
         case 0 -> arw.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
