...
public interface cxr<T extends Enum<T>> {
   int x_ = 4;

   Optional<djh> i_(djh var1);

   float aw_();

   default void a_(djh $$0, and $$1, hx $$2, auv $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<djh> c(djh $$0, and $$1, hx $$2, auv $$3) {
      ...
      for (hx $$7 : hx.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof cxr<?> $$9) {
            Enum<?> $$10 = $$9.c();
