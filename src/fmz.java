...
public class fmz extends fmw {
   ...
   fmz(fiz $$0, double $$1, double $$2, double $$3, djz $$4, int $$5) {
      super($$0, $$1, $$2, $$3, 0.0, 0.0, 0.0);
      this.D = 0.3F;
      this.a = $$4;
      this.t = $$5;
      Optional<ehp> $$6 = $$4.a($$0);
      if ($$6.isPresent()) {
         ehp $$7 = $$6.get();
         double $$8 = $$1 - $$7.a();
         double $$9 = $$2 - $$7.b();
         double $$10 = $$3 - $$7.c();
         this.F = this.b = (float)ary.d($$8, $$10);
         this.H = this.G = (float)ary.d($$9, Math.sqrt($$8 * $$8 + $$10 * $$10));
      }
   }

   @Override
   public void a(elv $$0, eqi $$1, float $$2) {
      float $$3 = ary.a(((float)this.s + $$2 - (float) (Math.PI * 2)) * 0.05F) * 2.0F;
      float $$4 = ary.i($$2, this.F, this.b);
      float $$5 = ary.i($$2, this.H, this.G) + (float) (Math.PI / 2);
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         Optional<ehp> $$0 = this.a.a(this.c);
         if ($$0.isEmpty()) {
            this.k();
         } else {
            int $$1 = this.t - this.s;
            ...
            ehp $$3 = $$0.get();
            this.g = ary.d($$2, this.g, $$3.a());
            this.h = ary.d($$2, this.h, $$3.b());
            this.i = ary.d($$2, this.i, $$3.c());
            double $$4 = this.g - $$3.a();
            double $$5 = this.h - $$3.b();
            double $$6 = this.i - $$3.c();
            this.F = this.b;
            this.b = (float)ary.d($$4, $$6);
            this.H = this.G;
            this.G = (float)ary.d($$5, Math.sqrt($$4 * $$4 + $$6 * $$6));
         }
      }
   }

   public static class a implements flz<jb> {
      private final fmr a;
      ...
      public flw a(jb $$0, fiz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fmz $$8 = new fmz($$1, $$2, $$3, $$4, $$0.c(), $$0.d());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
