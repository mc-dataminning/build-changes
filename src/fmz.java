...
public class fmz extends fod {
   ...
   protected void aT_() {
      ...
      this.b = new fiv(this.l.i, 4, this.n - 12, this.m - 4, 12, wz.c("chat.editBox")) {
         @Override
         protected xn aQ_() {
            return super.aQ_().b(fmz.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fip(this.l, this, this.b, this.o, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(fhz $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fgj $$4 = this.l.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(fmi $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fmh.a, wz.a("chat_screen.message", $$1));
      }
   }
