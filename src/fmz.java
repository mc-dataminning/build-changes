...
public class fmz extends fnd {
   ...
   private static final ale<dcx> x = dde.b;
   ...
   @Nullable
   private static egk a(jj<dez> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, dvu.c);
      int $$10 = $$9 - $$2;

      Optional<ji.c<dez>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new egk($$10, $$11.get().a());
      }
   }

   private static List<egk> a(jj<dez> $$0, String $$1) {
   ...
   public static egn a(jj<dez> $$0, jj<dcx> $$1, jj<eiq> $$2, jj<eho> $$3, String $$4, egn $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return egn.a($$1, $$2, $$3);
      } else {
         List<egk> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return egn.a($$1, $$2, $$3);
         } else {
            ji.c<dcx> $$8 = $$1.b(x);
   ...
   protected void aM_() {
      ...
      this.D = new fhn(this.p, 50, 40, this.n - 100, 20, this.z);
      this.D.f(1230);
      fsa $$0 = this.y.a.m().k();
      jw $$1 = $$0.a();
      cpl $$2 = $$0.g().b();
      ...
      jj<eiq> $$4 = $$1.b(lq.aL);
      jj<eho> $$5 = $$1.b(lq.aI);
      jj<dez> $$6 = $$1.b(lq.f).a($$2);
      this.D.a(a(this.y.l()));
      this.E = this.y.l();
      this.d(this.D);
      this.B = this.c(new fmz.a($$1, $$2));
      this.C = this.c(fhe.a(xp.c("createWorld.customize.presets.select"), $$4x -> {
         egn $$5x = a($$6, $$3, $$4, $$5, this.D.a(), this.E);
         this.y.a($$5x);
         this.m.a(this.y);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(fhe.a(xo.e, $$0x -> this.m.a(this.y)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends fia<fmz.a.a> {
      public a(final jw $$0, final cpl $$1) {
         super(fmz.this.m, fmz.this.n, fmz.this.o - 117, 80, 24);

         for (ji<egl> $$2 : $$0.d(lq.aF).c(awu.a)) {
            Set<dez> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               fmz.c
                  .info(
      ...
      public class a extends fia.a<fmz.a.a> {
         ...
         private void a(fgr $$0, int $$1, int $$2, cuk $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cup($$3), $$1 + 2, $$2 + 2);
         }
