...
public class fmz extends fnd {
   ...
   private static final IntSupplier f = () -> fft.Q().m.a().c() ? e : d;
   ...
   public fmz(fft $$0, ats $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fhf $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gel.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gel.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, fft.a);
         $$10 = 1.0F;
      }
   ...
   private void a(fhf $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends gph {
      ...
      protected gph.a b(atw $$0) {
         asm $$1 = fft.Q().ad();
         ato<InputStream> $$2 = $$1.a(ask.a, fmz.c);
         if ($$2 == null) {
            return new gph.a(new FileNotFoundException(fmz.c.toString()));
         } else {
            try {
               gph.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gph.a(new grl(true, true), ezn.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gph.a(var9);
            }
         }
      }
   }
