...
public class fmz implements fnd.a {
   ...
   private final enn J;
   private final Map<gu, fmz.b> K = Maps.newHashMap();
   private final Map<UUID, fmz.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bfj $$1 = this.J.s.a($$0.getValue().b);
         return $$1 == null || $$1.dD();
      });
   }

   private void b(eij $$0, fjx $$1, double $$2, double $$3, double $$4) {
      gu $$5 = gu.a($$2, $$3, $$4);
   ...
   private void a(eij $$0, fjx $$1, fmz.b $$2) {
      int $$3 = 0;
   ...
   private void a(eij $$0, fjx $$1, fmz.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j != null) {
         fnl.a($$0, $$1, $$2.j, 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(eij $$0, fjx $$1, fmz.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(eij $$0, fjx $$1, String $$2, fmz.b $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Collection<UUID> b(gu $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(fmz.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(gu $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(fmz.a::a).collect(Collectors.toSet());
   }

   private Map<gu, List<String>> c() {
      Map<gu, List<String>> $$0 = Maps.newHashMap();

      for (fmz.a $$1 : this.L.values()) {
   ...
   private void d() {
      fnd.a(this.J.al(), 8).ifPresent($$0 -> this.M = $$0.ct());
   }
