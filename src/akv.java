...
public class akv {
   ...
   public static final List<Function<String, akv.c>> a = ImmutableList.of(akw.a, akt.a, akx.a);
   public static final List<akv.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<akv.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<du> $$0) {
      ...
      for (akv.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<du, ?>, akv.b>)(($$0x, $$1x) -> $$0x.then(
                           dv.a("insert")
                              .then(
   ...
   private static List<sw> a(List<sw> $$0, akv.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<du, ?> a(BiConsumer<ArgumentBuilder<du, ?>, akv.b> $$0) {
   ...
   private static List<sw> a(CommandContext<du> $$0, akv.c $$1) throws CommandSyntaxException {
      aku $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<sw> b(CommandContext<du> $$0, akv.c $$1) throws CommandSyntaxException {
      aku $$2 = $$1.a($$0);
      el.g $$3 = el.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<du> $$0, akv.c $$1, akv.a $$2, List<sw> $$3) throws CommandSyntaxException {
      aku $$4 = $$1.a($$0);
   ...
   private static int a(du $$0, aku $$1, el.g $$2) throws CommandSyntaxException {
      rz $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static sw a(el.g $$0, aku $$1) throws CommandSyntaxException {
   ...
   private static int b(du $$0, aku $$1, el.g $$2) throws CommandSyntaxException {
      sw $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof sp) {
         $$4 = atm.a(((sp)$$3).j());
   ...
   private static int a(du $$0, aku $$1, el.g $$2, double $$3) throws CommandSyntaxException {
      sw $$4 = a($$2, $$1);
      if (!($$4 instanceof sp)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = atm.a(((sp)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(du $$0, aku $$1) throws CommandSyntaxException {
      rz $$2 = $$1.a();
      $$0.a(() -> $$1.a((sw)$$2), false);
      return 1;
   }

   private static int a(du $$0, aku $$1, rz $$2) throws CommandSyntaxException {
      rz $$3 = $$1.a();
      if (el.g.a($$2, 0)) {
         throw el.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<du, ?> create(akv.a var1);
   }

   public interface c {
      aku a(CommandContext<du> var1) throws CommandSyntaxException;
