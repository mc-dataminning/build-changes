...
public class akv<E> implements Codec<jm<E>> {
   ...
   private static <E> Codec<List<ji<E>>> a(Codec<ji<E>> $$0, boolean $$1) {
      Codec<List<ji<E>>> $$2 = $$0.listOf().validate(ayc.b(ji::f));
      return $$1
         ? $$2
         : Codec.either($$2, $$0)
   ...
   public static <E> Codec<jm<E>> a(ala<? extends jv<E>> $$0, Codec<ji<E>> $$1, boolean $$2) {
      return new akv<>($$0, $$1, $$2);
   }

   private akv(ala<? extends jv<E>> $$0, Codec<ji<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(axb.b($$0), this.c);
   }
   ...
   private static <E> DataResult<jm<E>> a(jj<E> $$0, axb<E> $$1) {
      return $$0.a($$1)
