...
public class akv {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vq.c("commands.effect.give.failed"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vq.c("commands.effect.clear.everything.failed"));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(vq.c("commands.effect.clear.specific.failed"));
                  ...
                  ((LiteralArgumentBuilder)dv.a("clear").executes($$0x -> a((du)$$0x.getSource(), ImmutableList.of(((du)$$0x.getSource()).g()))))
                     .then(
                        ((RequiredArgumentBuilder)dv.a("targets", eh.b()).executes($$0x -> a((du)$$0x.getSource(), eh.b($$0x, "targets"))))
                           .then(dv.a("effect", et.a($$1, kg.Q)).executes($$0x -> a((du)$$0x.getSource(), eh.b($$0x, "targets"), et.f($$0x, "effect"))))
                     )
               ))
            .then(
               dv.a("give")
                  .then(
                     dv.a("targets", eh.b())
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)dv.a("effect", et.a($$1, kg.Q))
   ...
   private static int a(du $$0, Collection<? extends bno> $$1, ij<bmz> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      ...
      if ($$7 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vq.a("commands.effect.give.success.single", $$6.e(), $$1.iterator().next().Q_(), $$8 / 20), true);
         } else {
            $$0.a(() -> vq.a("commands.effect.give.success.multiple", $$6.e(), $$1.size(), $$8 / 20), true);
         }
   ...
   private static int a(du $$0, Collection<? extends bno> $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vq.a("commands.effect.clear.everything.success.single", $$1.iterator().next().Q_()), true);
         } else {
            $$0.a(() -> vq.a("commands.effect.clear.everything.success.multiple", $$1.size()), true);
         }
   ...
   private static int a(du $$0, Collection<? extends bno> $$1, ij<bmz> $$2) throws CommandSyntaxException {
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vq.a("commands.effect.clear.specific.success.single", $$3.e(), $$1.iterator().next().Q_()), true);
         } else {
            $$0.a(() -> vq.a("commands.effect.clear.specific.success.multiple", $$3.e(), $$1.size()), true);
         }
