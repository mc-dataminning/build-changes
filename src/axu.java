...
public class axu {
   public static final Codec<axu> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(awu.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), awu.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, axu::new)
   );
   ...
   private final Predicate<ajv> f;

   private axu(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
