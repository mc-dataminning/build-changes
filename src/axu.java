...
public class axu {
   ...
   public static jj<ctv> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static jj<ctv> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jj<ctv> a(JsonObject $$0, String $$1, @Nullable jj<ctv> $$2) {
