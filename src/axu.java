...
public class axu extends bav {
   private static final String[] a = new String[]{
      "Text1", "Text2", "Text3", "Text4", "FilteredText1", "FilteredText2", "FilteredText3", "FilteredText4", "Color", "GlowingText"
   };

   public axu(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, bbv.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", axu::b);
      $$0 = $$0.update("back_text", axu::b);
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), axu::a);
   }
}
