...
public class axu extends aus {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), axu::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", axu::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", axu::k);
         $$0 = this.a($$0, "minecraft:fox", axu::j);
         $$0 = this.a($$0, "minecraft:item", axu::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", axu::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", axu::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", axu::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", axu::e);
         return this.a($$0, "minecraft:piglin", axu::d);
      });
   }
