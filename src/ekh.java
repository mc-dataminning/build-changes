...
public class ekh extends ejm<ely> {
   public ekh(Codec<ely> $$0) {
      super($$0);
   }
   ...
   protected boolean a(
      djz $$0, azv $$1, ely $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(eah $$0, Function<iu, eah> $$1, azv $$2, ely $$3, ely.a $$4, iu.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
