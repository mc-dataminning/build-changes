...
public final class ekh implements AutoCloseable {
   ...
   public ekh(int $$0, int $$1, boolean $$2) {
      this(ekh.a.a, $$0, $$1, $$2);
   }

   public ekh(ekh.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private ekh(ekh.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static ekh a(InputStream $$0) throws IOException {
      return a(ekh.a.a, $$0);
   }

   public static ekh a(@Nullable ekh.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ekh a(ByteBuffer $$0) throws IOException {
      return a(ekh.a.a, $$0);
   }

   public static ekh a(byte[] $$0) throws IOException {
   ...
   public static ekh a(@Nullable ekh.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new ekh($$0 == null ? ekh.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public ekh a(IntUnaryOperator $$0) {
      if (this.c != ekh.a.a) {
         ...
         this.j();
         ekh $$1 = new ekh(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void a(ekh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ekh $$4) {
      this.j();
      if ($$4.c() != this.c) {
