...
public class ekh {
   ...
   private static final Queue<ekh.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ekh.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ekh::a), ekf::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ekh::a), ekf::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ekh.a(this.b) + ", type=" + ekh.b(this.c) + ", severity=" + ekh.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
