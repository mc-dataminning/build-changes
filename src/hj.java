...
public class hj {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, hh.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends hh.a<A>> void a(JsonObject $$0, hh<A, T> $$1, hh.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", kb.w.b($$2.a()).toString());
