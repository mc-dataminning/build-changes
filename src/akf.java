...
public class akf implements Comparable<akf> {
   public static final Codec<akf> a = Codec.STRING.comapFlatMap(akf::b, akf::toString).stable();
   public static final yq<ByteBuf, akf> b = yo.k.a(akf::new, akf::toString);
   private static final SimpleCommandExceptionType f = new SimpleCommandExceptionType(ws.c("argument.id.invalid"));
   ...
   protected akf(String $$0, String $$1, @Nullable akf.a $$2) {
      this.g = $$0;
      this.h = $$1;
   }
   ...
   public static akf a(String $$0, char $$1) {
      return new akf(b($$0, $$1));
   }
   ...
   @Nullable
   public static akf a(String $$0, String $$1) {
      try {
         return new akf($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<akf> b(String $$0) {
      try {
         return DataResult.success(new akf($$0));
      } catch (z var2) {
   ...
   public akf c(String $$0) {
      return new akf(this.g, d(this.g, $$0), null);
   }

   public akf a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.h));
   }

   public akf d(String $$0) {
      return this.c($$0 + this.h);
   }

   public akf e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof akf $$1) ? false : this.g.equals($$1.g) && this.h.equals($$1.h);
      }
   }
   ...
   public static akf a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<akf>, JsonSerializer<akf> {
      public akf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new akf(axm.a($$0, "location"));
      }

      public JsonElement a(akf $$0, Type $$1, JsonSerializationContext $$2) {
