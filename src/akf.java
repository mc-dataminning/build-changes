...
public interface akf {
   ...
   static akf a(cpc $$0, int $$1) {
      return new akf.a($$0, $$1);
   }

   static void a(akf $$0, akf $$1, Consumer<cpc> $$2, Consumer<cpc> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof akf.a $$4 && $$1 instanceof akf.a $$5 && $$4.a($$5)) {
   ...
   public static record a(cpc b, int c) implements akf {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(akf.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return akf.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
