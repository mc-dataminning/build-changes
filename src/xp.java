...
public record xp(int b, UUID c, UUID d) {
   public static final Codec<xp> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(axh.i.fieldOf("index").forGetter(xp::b), jq.a.fieldOf("sender").forGetter(xp::c), jq.a.fieldOf("session_id").forGetter(xp::d))
            .apply($$0, xp::new)
   );
   ...
   public void a(ayk.a $$0) throws SignatureException {
      $$0.update(jq.b(this.c));
      $$0.update(jq.b(this.d));
