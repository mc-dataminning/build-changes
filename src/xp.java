...
public class xp {
   public static final Codec<xp> a = azp.a(xp.a::values).dispatch(xp::c, xp.a::a);
   ...
   static final MapCodec<xp> g = ayc.u.xmap(xp::new, xp::d).fieldOf("value");
   ...
   public static void a(wl $$0, xp $$1) {
      $$0.a($$1.j);
      if ($$1.j == xp.a.c) {
         $$0.a($$1.i);
      }
