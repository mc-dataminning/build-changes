...
public record xp<S>(List<xp.a<S>> a) {
   public static <S> boolean a(ParseResults<S> $$0) {
      return !b($$0).a().isEmpty();
   }

   public static <S> xp<S> b(ParseResults<S> $$0) {
   ...
   private static <S> List<xp.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<xp.a<S>> $$2 = new ArrayList<>();
