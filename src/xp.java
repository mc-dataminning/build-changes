...
public class xp implements ve<wx> {
   ...
   private final int h;
   private final List<xp.b> i;

   public xp(RootCommandNode<dw> $$0) {
   ...
   private static void a(List<xp.b> $$0, BiPredicate<xp.b, IntSet> $$1) {
   ...
   private static void a(List<xp.b> $$0) {
      a($$0, xp.b::a);
      a($$0, xp.b::b);
   }
   ...
   private static List<xp.b> a(Object2IntMap<CommandNode<dw>> $$0) {
      ObjectArrayList<xp.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static xp.e a(sp $$0, byte $$1) {
      ...
      if ($$2 == 2) {
         ...
         if ($$5 == null) {
            ...
            gi.a<?> $$6 = $$5.b($$0);
            aex $$7 = ($$1 & 16) != 0 ? $$0.s() : null;
            return new xp.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.r();
         return new xp.c($$8);
   ...
   private static xp.b a(CommandNode<dw> $$0, Object2IntMap<CommandNode<dw>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<dw> a(dn $$0) {
      return (RootCommandNode<dw>)new xp.d($$0, this.i).a(this.h);
   }

   static class a implements xp.e {
      ...
      @Nullable
      private static aex a(@Nullable SuggestionProvider<dw> $$0) {
         return $$0 != null ? gm.a($$0) : null;
      }

      a(String $$0, gi.a<?> $$1, @Nullable aex $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   static class b {
      ...
      b(@Nullable xp.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements xp.e {
      private final String a;
