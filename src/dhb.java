...
public class dhb extends dhe<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dhb(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dhb $$1 && super.equals($$0)) {
   ...
   public static dhb a(String $$0, int $$1, int $$2) {
      return new dhb($$0, $$1, $$2);
   }
