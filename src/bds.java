...
public class bds extends bgs {
   public bds(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bhx.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhx.D.typeName(), bjl.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bhx.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bhx.D.typeName(), "minecraft:saddle"));
