...
public class bds extends bgp {
   public bds(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bhu.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhu.D.typeName(), bji.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bhu.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bhu.D.typeName(), "minecraft:saddle"));
