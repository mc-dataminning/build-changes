...
public record dh(@Nullable Float c, @Nullable Float d) {
   public static final dh a = new dh(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(tf.c("argument.range.ints"));
   ...
   public static dh a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         ...
         float $$1 = arg.e($$0, "value");
         return new dh($$1, $$1);
      } else {
         JsonObject $$2 = arg.m($$0, "value");
         Float $$3 = $$2.has("min") ? arg.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? arg.m($$2, "max") : null;
         return new dh($$3, $$4);
      }
   }
