...
public class esm extends gko {
   ...
   @Override
   public void aN_() {
      this.w.a(new eym(a, this.i));
      this.x = this.w.c(new esm.a(this.f));
      this.w.b(exf.a(ve.k, $$0 -> this.aE_()).a());
      this.c();
      this.w.a($$1 -> {
   ...
   private vf a(String $$0) {
      try {
         return etj.a.get(Integer.parseInt($$0)).b();
   ...
   private vf b(String $$0) {
      try {
         return etj.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends eyb<esm.b> {
      public a(evh $$0) {
         super($$0, esm.this.g, esm.this.h - esm.this.w.b() - esm.this.w.c(), esm.this.w.c(), 36);
         if (esm.this.v.e != null) {
            esm.this.v.e.forEach(($$0x, $$1) -> this.b(esm.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends eyb.a<esm.b> {
      ...
      public void a(ewt $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(esm.this.i, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(esm.this.i, esm.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
