...
public class esm {
   private final ImmutableList<esn> a;
   private final ImmutableMap<String, esn> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private esk e;

   public esm(ImmutableMap<String, esn> $$0) {
      this.b = $$0;
