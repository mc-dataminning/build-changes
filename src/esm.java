...
public abstract class esm<M extends esj<M>> {
   private final dgq i;
   protected final dze a;
   ...
   protected final Long2ObjectMap<dyw> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected esm(dgq $$0, dze $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dyw a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dyw a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dyw c(long $$0) {
      dyw $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = kk.e($$0);
      dyw $$2 = this.a($$1, true);
      return $$2.a(kk.b(ji.a($$0)), kk.b(ji.b($$0)), kk.b(ji.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(kk.b(ji.a($$0)), kk.b(ji.b($$0)), kk.b(ji.c($$0)), $$1);
      kk.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(kk.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected dyw g(long $$0) {
      dyw $$1 = (dyw)this.g.get($$0);
      return $$1 != null ? $$1 : new dyw();
   }
   ...
   protected void a(esp<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dyw $$2 = (dyw)this.g.remove($$1);
            dyw $$3 = this.d.d($$1);
            if (this.k.contains(kk.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dyw>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dyw> $$6 = (Entry<dyw>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dyw $$8 = (dyw)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dyw $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kk.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, esm.a.a($$9, esm.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public esm.b l(long $$0) {
      return esm.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static esm.b c(byte $$0) {
         if ($$0 == 0) {
            return esm.b.a;
         } else {
            return a($$0) ? esm.b.c : esm.b.b;
         }
      }
   }
