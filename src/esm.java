...
public class esm {
   private final List<ConcurrentLinkedQueue<esl>> a = ImmutableList.of(
   ...
   public void a(esl $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<esl> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<esl> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<esl> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<esl> j() {
