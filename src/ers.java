...
public class ers implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ers.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ers(List<ers.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ers a(BufferedReader $$0) {
      return new ers($$0.lines().flatMap($$0x -> ers.a.a($$0x).stream()).toList());
   }

   public static record a(ers.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ers.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ers.a(ers.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ers.a(ers.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ers.a(ers.b.b, $$3));
      ...
      static ers.a b(String $$0) {
         return new ers.a(ers.b.a, "glob:" + $$0);
      }

      static ers.a c(String $$0) {
         return new ers.a(ers.b.a, "regex:" + $$0);
      }

      static ers.a d(String $$0) {
         return new ers.a(ers.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ers.b a = FileSystem::getPathMatcher;
      ers.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
