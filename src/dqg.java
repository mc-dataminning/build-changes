...
public class dqg extends dqa<dsf> {
   private static final ib[] a = ib.values();

   public dqg(Codec<dsf> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dqc<dsf> $$0) {
      dsf $$1 = $$0.f();
      atw $$2 = $$0.d();
      hx $$3 = $$0.e();
      csz $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dnv $$9 = new dnv(new dmx($$4.B()));
      eca $$10 = eca.a($$9, -4, 1.0);
      ...
      for (hx $$33 : hx.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<hx, Integer> $$37 : $$7) {
            $$35 += atq.f($$33.j((ja)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (hx $$38 : $$11) {
            $$36 += atq.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, cvh.a.o(), $$32);
      ...
      for (hx $$44 : $$31) {
         ...
         for (ib $$46 : a) {
            ...
            dhn $$48 = $$4.a_($$47);
            if ($$45.b(did.C)) {
               $$45 = $$45.a(did.C, Boolean.valueOf($$48.u().b()));
            }
