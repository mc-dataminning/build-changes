...
public class dit {
   public static final Codec<dit> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dir.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dir.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               czy.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final yy<wl, dit> b = yy.a(dit::a, dit::a);
   private final dir c;
   private final Optional<dir> d;
   private final czy e;
   private int f;
   private final int g;
   ...
   private dit(dir $$0, Optional<dir> $$1, czy $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dit(dir $$0, czy $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dit(dir $$0, Optional<dir> $$1, czy $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dit(dir $$0, Optional<dir> $$1, czy $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dit(dir $$0, Optional<dir> $$1, czy $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   private int a(dir $$0) {
      int $$1 = $$0.b();
      int $$2 = Math.max(0, azo.d((float)($$1 * this.j) * this.k));
      return azo.a($$1 + $$2 + this.i, 1, $$0.d().k());
   }

   public czy c() {
      return this.d.map(dir::d).orElse(czy.k);
   }
   ...
   private static void a(wl $$0, dit $$1) {
      dir.b.encode($$0, $$1.d());
      czy.i.encode($$0, $$1.f());
      dir.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dit a(wl $$0) {
      dir $$1 = dir.b.decode($$0);
      czy $$2 = czy.i.decode($$0);
      Optional<dir> $$3 = dir.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dit $$11 = new dit($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
