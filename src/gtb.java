...
public class gtb {
   ...
   @VisibleForTesting
   static gsv.b a(Vector3fc $$0, Vector3fc $$1, jc $$2) {
      return switch ($$2) {
         case a -> new gsv.b($$0.x(), 16.0F - $$1.z(), $$1.x(), 16.0F - $$0.z());
         case b -> new gsv.b($$0.x(), $$0.z(), $$1.x(), $$1.z());
         case c -> new gsv.b(16.0F - $$1.x(), 16.0F - $$1.y(), 16.0F - $$0.x(), 16.0F - $$0.y());
         case d -> new gsv.b($$0.x(), 16.0F - $$1.y(), $$1.x(), 16.0F - $$0.y());
         case e -> new gsv.b($$0.z(), 16.0F - $$1.y(), $$1.z(), 16.0F - $$0.y());
         case f -> new gsv.b(16.0F - $$1.z(), 16.0F - $$1.y(), 16.0F - $$0.z(), 16.0F - $$0.y());
      };
   }

   public static gst a(Vector3fc $$0, Vector3fc $$1, gsv $$2, hkq $$3, jc $$4, hnf $$5, @Nullable gsw $$6, boolean $$7, int $$8) {
      gsv.b $$9 = $$2.d();
      if ($$9 == null) {
         $$9 = a($$0, $$1, $$4);
      }
      ...
      return new gst($$11, $$2.b(), $$12, $$3, $$7, $$8);
   }

   private static gsv.b a(hkq $$0, gsv.b $$1) {
      float $$2 = $$1.a();
      float $$3 = $$1.b();
      float $$4 = $$1.c();
      float $$5 = $$1.d();
      ...
      return new gsv.b(azz.h($$6, $$2, $$7), azz.h($$6, $$3, $$8), azz.h($$6, $$4, $$7), azz.h($$6, $$5, $$8));
   }

   private static int[] a(gsv.b $$0, i $$1, Matrix4fc $$2, hkq $$3, jc $$4, float[] $$5, k $$6, @Nullable gsw $$7) {
      gra $$8 = gra.a($$4);
      int[] $$9 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, gra $$2, gsv.b $$3, i $$4, Matrix4fc $$5, float[] $$6, hkq $$7, k $$8, @Nullable gsw $$9) {
      gra.b $$10 = $$2.a($$1);
      Vector3f $$11 = new Vector3f($$6[$$10.a], $$6[$$10.b], $$6[$$10.c]);
      a($$11, $$9);
      a($$11, $$8);
      float $$12 = gsv.a($$3, $$4, $$1);
      float $$13 = gsv.b($$3, $$4, $$1);
      float $$15;
      float $$14;
      if (f.a($$5)) {
         $$14 = $$12;
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hkq $$3, float $$4, float $$5) {
      int $$6 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable gsw $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private static void a(int[] $$0, jc $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            float $$19 = b($$2, $$17);
            float $$20 = c($$2, $$17);
            if (azz.a($$13, $$18) && azz.a($$14, $$19) && azz.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
