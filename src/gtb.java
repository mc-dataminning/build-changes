...
public class gtb extends gqj<cil, gza, gci> {
   ...
   public gtb(grp.a $$0) {
      super($$0, new gci($$0.a(gem.bI)), new gci($$0.a(gem.bJ)), 0.9F);
      this.a(new gwa(this, $$0.b()));
   }
   ...
   public void a(cil $$0, gza $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.gC();
      $$1.b = $$0.p() > 0;
      $$1.c = $$0.t();
   ...
   protected void a(gza $$0, fgr $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.k > 0.0F) {
         float $$4 = bae.i($$0.k);
         int $$5 = bae.d($$0.k);
