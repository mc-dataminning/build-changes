public class gtb extends grp<clw, gza> {
   public gtb(grq.a $$0) {
      super($$0);
   }

   public void a(gza $$0, fgs $$1, gll $$2, int $$3) {
      clx $$4 = $$0.b;
      if ($$4 != null) {
         $$1.a();
   ...
   public void a(clw $$0, gza $$1, float $$2) {
      super.a($$0, $$1, $$2);
      jm $$3 = $$0.cO();
      clx $$4 = $$0.s().a();
      $$1.a = $$3;
      ...
      for (int $$10 = 0; $$10 < $$6; $$10++) {
         for (int $$11 = 0; $$11 < $$5; $$11++) {
            ...
            int $$14 = $$0.dA();
            int $$15 = bae.a($$0.dD() + (double)$$13);
            int $$16 = $$0.dG();
            switch ($$3) {
               case c:
                  $$14 = bae.a($$0.dB() + (double)$$12);
                  break;
               case e:
                  $$16 = bae.a($$0.dH() - (double)$$12);
                  break;
               case d:
                  $$14 = bae.a($$0.dB() - (double)$$12);
                  break;
            ...
            $$1.c[$$11 + $$10 * $$5] = glh.a($$9, new jh($$14, $$15, $$16));
         }
      }
   }

   private void a(fgs $$0, fgw $$1, int[] $$2, int $$3, int $$4, hbl $$5, hbl $$6) {
      fgs.a $$7 = $$0.c();
   ...
   private void a(fgs.a $$0, fgw $$1, float $$2, float $$3, float $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, $$2, $$3, $$6).a(-1).a($$4, $$5).b(hbc.d).c($$10).b($$0, (float)$$7, (float)$$8, (float)$$9);
   }
}
