...
public class gtb extends gsa<bve, gzg> {
   public gtb(gsb.a $$0) {
      super($$0);
   }

   public void a(gzg $$0, ffs $$1, glv $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bve $$0, gzg $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bve $$0) {
      return false;
   }
}
