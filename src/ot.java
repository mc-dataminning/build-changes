...
public class ot {
   ...
   public static ot a(dke $$0) {
      alz $$1 = H($$0);
      return b($$1);
   }

   public static ot b(dke $$0) {
      alz $$1 = H($$0);
      return a($$1);
   }
   ...
   public static ot c(dke $$0) {
      return d(ou.p, H($$0));
   }

   public static ot d(dke $$0) {
      return d(ou.i, H($$0));
   }
   ...
   public static ot g(dke $$0) {
      return d(ou.t, H($$0));
   }

   public static ot h(dke $$0) {
   ...
   public static ot i(dke $$0) {
      return d(ou.y, H($$0));
   }

   public static ot a(dke $$0, dke $$1) {
      return new ot().a(ou.y, H($$0)).a(ou.z, H($$1));
   }

   public static ot j(dke $$0) {
      return d(ou.u, H($$0));
   }

   public static ot k(dke $$0) {
      return d(ou.x, H($$0));
   }
   ...
   public static ot b(dke $$0, dke $$1) {
   ...
   public static ot u(dke $$0) {
      return new ot().a(ou.f, a($$0, "_top")).a(ou.e, a($$0, "_bottom"));
   }

   public static ot v(dke $$0) {
   ...
   public static ot w(dke $$0) {
      return new ot().a(ou.C, a($$0, "_0"));
   }

   public static ot x(dke $$0) {
      return new ot().a(ou.C, a($$0, "_1"));
   }

   public static ot y(dke $$0) {
      return new ot().a(ou.D, H($$0));
   }

   public static ot z(dke $$0) {
   ...
   public static ot a(dke $$0, String $$1, String $$2) {
      return new ot().a(ou.i, a($$0, $$1)).a(ou.f, a($$0, $$2)).a(ou.e, a($$0, "_bottom"));
   }

   public static ot a(dke $$0, String $$1, String $$2, String $$3, String $$4) {
      return new ot().a(ou.g, a($$0, $$1)).a(ou.i, a($$0, $$2)).a(ou.f, a($$0, $$3)).a(ou.e, a($$0, $$4));
   }

   public static ot a(cxg $$0) {
   ...
   public static ot c(dke $$0, dke $$1) {
      return new ot()
         .a(ou.c, a($$0, "_front"))
         .a(ou.o, H($$1))
         .a(ou.n, a($$0, "_top"))
   ...
   public static ot d(dke $$0, dke $$1) {
      return new ot()
         .a(ou.c, a($$0, "_front"))
         .a(ou.o, H($$1))
         .a(ou.n, a($$0, "_top"))
   ...
   public static ot a(String $$0) {
      return new ot()
         .a(ou.c, a(dkg.mB, $$0 + "_north"))
         .a(ou.e, a(dkg.mB, $$0 + "_bottom"))
         .a(ou.f, a(dkg.mB, $$0 + "_top"))
         .a(ou.j, a(dkg.mB, $$0 + "_north"))
         .a(ou.k, a(dkg.mB, $$0 + "_south"))
         .a(ou.l, a(dkg.mB, $$0 + "_east"))
         .a(ou.m, a(dkg.mB, $$0 + "_west"));
   }
   ...
   public static ot a(dke $$0, boolean $$1) {
      return new ot()
         .a(ou.c, a(dkg.et, "_side"))
         .a(ou.e, a(dkg.et, "_bottom"))
         .a(ou.f, a(dkg.et, "_top"))
         .a(ou.i, a(dkg.et, "_side"))
         .a(ou.L, a($$0, $$1 ? "_lit" : ""));
   }

   public static ot j(alz $$0) {
      return new ot()
         .a(ou.c, a(dkg.fH, "_side"))
         .a(ou.i, a(dkg.fH, "_side"))
         .a(ou.f, a(dkg.fH, "_top"))
         .a(ou.e, a(dkg.fH, "_bottom"))
         .a(ou.M, a(dkg.fH, "_inner"))
         .a(ou.N, $$0);
   }
   ...
   public static ot a(boolean $$0) {
      ...
      return new ot()
         .a(ou.c, a(dkg.rq, "_bottom"))
         .a(ou.i, a(dkg.rq, "_side"))
         .a(ou.f, a(dkg.rq, "_top"))
         .a(ou.O, a(dkg.rq, $$1 + "_inner_top"))
         .a(ou.e, a(dkg.rq, "_bottom"));
   }

   public static ot b(cxg $$0) {
