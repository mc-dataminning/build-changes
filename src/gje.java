public class gje extends gjh {
   private final gcw a;
   private final gmi b = gmi.j(grx.a);

   gje(gfz $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
      this.a = new gcj(flj.Q().aS().a(gfc.aE));
      this.u = 0.0F;
      this.t = 30;
   }
