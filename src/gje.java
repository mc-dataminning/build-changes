...
public abstract class gje extends gir {
   protected float D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;

   protected gje(gfj $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
   }

   protected gje(gfj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }
   ...
   public interface a {
      gje.a a = ($$0, $$1, $$2) -> $$0.set($$1.f());
      gje.a b = ($$0, $$1, $$2) -> $$0.set(0.0F, $$1.f().y, 0.0F, $$1.f().w);
