...
public class gje implements AutoCloseable {
   ...
   public gje(giw $$0, fke $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new fdc(16, 16, false);
      this.e.a(9729);
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            gip $$18 = Objects.requireNonNull(RenderSystem.setShader(giq.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            fem $$19 = RenderSystem.renderThreadTesselator().a(few.c.h, fep.a);
            $$19.a(0.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 1.0F, 0.0F);
            $$19.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(dzq $$0, int $$1) {
      return a($$0.s(), $$1);
   }
