public class gmo {
   ...
   private final hbk[] b = new hbk[2];
   private final hbk[] c = new hbk[2];
   private hbk d;

   protected void a() {
      this.b[0] = fmf.Q().aE().b().b(dkn.K.m()).e();
      this.b[1] = hdw.c.c();
      this.c[0] = fmf.Q().aE().b().b(dkn.J.m()).e();
      this.c[1] = hdw.d.c();
      this.d = hdw.e.c();
   }
   ...
   public void a(dgj $$0, jh $$1, fgv $$2, dxu $$3, etw $$4) {
      boolean $$5 = $$4.a(aya.b);
      hbk[] $$6 = $$5 ? this.b : this.c;
      int $$7 = $$5 ? 16777215 : gkq.c($$0, $$1);
