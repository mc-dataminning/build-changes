...
public record gmo(Map<String, String> c, Set<String> d) {
   public static final gmo a = new gmo(Map.of(), Set.of());
   public static final Codec<gmo> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gmo::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gmo::e)
            )
            .apply($$0, gmo::new)
   );

   public static gmo.a a() {
      return new gmo.a();
   }
   ...
   public gmo a(gmo $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gmo($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gmo.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gmo.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gmo.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gmo a() {
         return new gmo(this.a.build(), this.b.build());
      }
   }
}
