...
public class gmo {
   ...
   static final ThreadLocal<gmo.d> f = ThreadLocal.withInitial(gmo.d::new);

   public gmo(fng $$0) {
      this.d = $$0;
   }

   public void a(dgj $$0, hdl $$1, dxu $$2, jh $$3, fgq $$4, fgu $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      boolean $$10 = fme.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(dgj $$0, hdl $$1, dxu $$2, jh $$3, fgq $$4, fgu $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      ...
      $$7.b($$8);
      List<gmq> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dgj $$0, hdl $$1, dxu $$2, jh $$3, fgq $$4, fgu $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jh.a $$11 = $$3.k();

      for (jm $$12 : c) {
         $$7.b($$8);
         List<gmq> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
      ...
      $$7.b($$8);
      List<gmq> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dgj $$0, dxu $$1, jh $$2, fgq $$3, fgu $$4, List<gmq> $$5, float[] $$6, BitSet $$7, gmo.b $$8, int $$9) {
      for (gmq $$10 : $$5) {
   ...
   private void a(
      dgj $$0, dxu $$1, jh $$2, fgu $$3, fgq.a $$4, gmq $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dgj $$0, dxu $$1, jh $$2, int $$3, int $$4, boolean $$5, fgq $$6, fgu $$7, List<gmq> $$8, BitSet $$9) {
      for (gmq $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fgq.a $$0, fgu $$1, @Nullable dxu $$2, hdl $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      bam $$9 = bam.a();
      long $$10 = 42L;
   ...
   private static void a(fgq.a $$0, fgu $$1, float $$2, float $$3, float $$4, List<gmq> $$5, int $$6, int $$7) {
      for (gmq $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gmo.e[]{gmo.e.k, gmo.e.d, gmo.e.k, gmo.e.j, gmo.e.e, gmo.e.j, gmo.e.e, gmo.e.d},
         new gmo.e[]{gmo.e.k, gmo.e.c, gmo.e.k, gmo.e.i, gmo.e.e, gmo.e.i, gmo.e.e, gmo.e.c},
         new gmo.e[]{gmo.e.l, gmo.e.c, gmo.e.l, gmo.e.i, gmo.e.f, gmo.e.i, gmo.e.f, gmo.e.c},
         new gmo.e[]{gmo.e.l, gmo.e.d, gmo.e.l, gmo.e.j, gmo.e.f, gmo.e.j, gmo.e.f, gmo.e.d}
      ),
      b(
         new jm[]{jm.f, jm.e, jm.c, jm.d},
         1.0F,
         true,
         new gmo.e[]{gmo.e.f, gmo.e.d, gmo.e.f, gmo.e.j, gmo.e.l, gmo.e.j, gmo.e.l, gmo.e.d},
         new gmo.e[]{gmo.e.f, gmo.e.c, gmo.e.f, gmo.e.i, gmo.e.l, gmo.e.i, gmo.e.l, gmo.e.c},
         new gmo.e[]{gmo.e.e, gmo.e.c, gmo.e.e, gmo.e.i, gmo.e.k, gmo.e.i, gmo.e.k, gmo.e.c},
         new gmo.e[]{gmo.e.e, gmo.e.d, gmo.e.e, gmo.e.j, gmo.e.k, gmo.e.j, gmo.e.k, gmo.e.d}
      ),
      c(
         new jm[]{jm.b, jm.a, jm.f, jm.e},
         0.8F,
         true,
         new gmo.e[]{gmo.e.b, gmo.e.k, gmo.e.b, gmo.e.e, gmo.e.h, gmo.e.e, gmo.e.h, gmo.e.k},
         new gmo.e[]{gmo.e.b, gmo.e.l, gmo.e.b, gmo.e.f, gmo.e.h, gmo.e.f, gmo.e.h, gmo.e.l},
         new gmo.e[]{gmo.e.a, gmo.e.l, gmo.e.a, gmo.e.f, gmo.e.g, gmo.e.f, gmo.e.g, gmo.e.l},
         new gmo.e[]{gmo.e.a, gmo.e.k, gmo.e.a, gmo.e.e, gmo.e.g, gmo.e.e, gmo.e.g, gmo.e.k}
      ),
      d(
         new jm[]{jm.e, jm.f, jm.a, jm.b},
         0.8F,
         true,
         new gmo.e[]{gmo.e.b, gmo.e.k, gmo.e.h, gmo.e.k, gmo.e.h, gmo.e.e, gmo.e.b, gmo.e.e},
         new gmo.e[]{gmo.e.a, gmo.e.k, gmo.e.g, gmo.e.k, gmo.e.g, gmo.e.e, gmo.e.a, gmo.e.e},
         new gmo.e[]{gmo.e.a, gmo.e.l, gmo.e.g, gmo.e.l, gmo.e.g, gmo.e.f, gmo.e.a, gmo.e.f},
         new gmo.e[]{gmo.e.b, gmo.e.l, gmo.e.h, gmo.e.l, gmo.e.h, gmo.e.f, gmo.e.b, gmo.e.f}
      ),
      e(
         new jm[]{jm.b, jm.a, jm.c, jm.d},
         0.6F,
         true,
         new gmo.e[]{gmo.e.b, gmo.e.d, gmo.e.b, gmo.e.j, gmo.e.h, gmo.e.j, gmo.e.h, gmo.e.d},
         new gmo.e[]{gmo.e.b, gmo.e.c, gmo.e.b, gmo.e.i, gmo.e.h, gmo.e.i, gmo.e.h, gmo.e.c},
         new gmo.e[]{gmo.e.a, gmo.e.c, gmo.e.a, gmo.e.i, gmo.e.g, gmo.e.i, gmo.e.g, gmo.e.c},
         new gmo.e[]{gmo.e.a, gmo.e.d, gmo.e.a, gmo.e.j, gmo.e.g, gmo.e.j, gmo.e.g, gmo.e.d}
      ),
      f(
         new jm[]{jm.a, jm.b, jm.c, jm.d},
         0.6F,
         true,
         new gmo.e[]{gmo.e.g, gmo.e.d, gmo.e.g, gmo.e.j, gmo.e.a, gmo.e.j, gmo.e.a, gmo.e.d},
         new gmo.e[]{gmo.e.g, gmo.e.c, gmo.e.g, gmo.e.i, gmo.e.a, gmo.e.i, gmo.e.a, gmo.e.c},
         new gmo.e[]{gmo.e.h, gmo.e.c, gmo.e.h, gmo.e.i, gmo.e.b, gmo.e.i, gmo.e.b, gmo.e.c},
         new gmo.e[]{gmo.e.h, gmo.e.d, gmo.e.h, gmo.e.j, gmo.e.b, gmo.e.j, gmo.e.b, gmo.e.d}
      );
      ...
      final gmo.e[] k;
      final gmo.e[] l;
      private static final gmo.a[] m = ae.a(new gmo.a[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
      ...
      private a(final jm[] $$0, final float $$1, final boolean $$2, final gmo.e[] $$3, final gmo.e[] $$4, final gmo.e[] $$5, final gmo.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gmo.c[] k = ae.a(new gmo.c[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
