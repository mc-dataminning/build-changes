...
public class df extends cx<df.a> {
   ...
   public void a(aow $$0, bno $$1, ens $$2, int $$3) {
      eiv $$4 = br.b($$0, $$1);
   ...
   public static record a(Optional<bc> b, cm.d c, Optional<bc> d) implements cx.a {
      public static final Codec<df.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avp.a(br.b, "player").forGetter(df.a::a),
                  avp.a(cm.d.d, "signal_strength", cm.d.c).forGetter(df.a::b),
                  avp.a(br.b, "projectile").forGetter(df.a::c)
               )
               .apply($$0, df.a::new)
      );
      ...
      public boolean a(eiv $$0, ens $$1, int $$2) {
