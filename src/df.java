...
public record df(Map<ji<brz>, df.b> b) {
   ...
   public boolean a(Map<ji<brz>, bsb> $$0) {
      for (Entry<ji<brz>, df.b> $$1 : this.b.entrySet()) {
         bsb $$2 = $$0.get($$1.getKey());
         if (!$$1.getValue().a($$2)) {
            return false;
         }
      }
   ...
   public Map<ji<brz>, df.b> a() {
      return this.b;
   }

   public static class a {
      private final Builder<ji<brz>, df.b> a = ImmutableMap.builder();

      public static df.a a() {
         return new df.a();
      }

      public df.a a(ji<brz> $$0) {
         this.a.put($$0, new df.b());
         return this;
      }

      public df.a a(ji<brz> $$0, df.b $$1) {
         this.a.put($$0, $$1);
         return this;
      }
   ...
   public static record b(de.d b, de.d c, Optional<Boolean> d, Optional<Boolean> e) {
      ...
      public boolean a(@Nullable bsb $$0) {
         if ($$0 == null) {
            return false;
