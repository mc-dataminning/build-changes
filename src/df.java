...
public abstract class df<T extends df.a> implements ap<T> {
   private final Map<aku, Set<ap.a<T>>> a = Maps.newIdentityHashMap();

   @Override
   public final void a(aku $$0, ap.a<T> $$1) {
      this.a.computeIfAbsent($$0, $$0x -> Sets.newHashSet()).add($$1);
   }

   @Override
   public final void b(aku $$0, ap.a<T> $$1) {
