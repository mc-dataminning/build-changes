...
public record df(Map<ji<bry>, df.b> b) {
   ...
   public boolean a(Map<ji<bry>, bsa> $$0) {
      for (Entry<ji<bry>, df.b> $$1 : this.b.entrySet()) {
         bsa $$2 = $$0.get($$1.getKey());
         if (!$$1.getValue().a($$2)) {
            return false;
         }
      }
   ...
   public Map<ji<bry>, df.b> a() {
      return this.b;
   }

   public static class a {
      private final Builder<ji<bry>, df.b> a = ImmutableMap.builder();

      public static df.a a() {
         return new df.a();
      }

      public df.a a(ji<bry> $$0) {
         this.a.put($$0, new df.b());
         return this;
      }

      public df.a a(ji<bry> $$0, df.b $$1) {
         this.a.put($$0, $$1);
         return this;
      }
