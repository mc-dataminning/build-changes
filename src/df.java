...
public class df extends cx<df.a> {
   ...
   public void a(apt $$0, bpv $$1, esa $$2, int $$3) {
      enb $$4 = br.b($$0, $$1);
   ...
   public static record a(Optional<bc> b, cm.d c, Optional<bc> d) implements cx.a {
      public static final Codec<df.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  aws.a(br.b, "player").forGetter(df.a::a),
                  aws.a(cm.d.d, "signal_strength", cm.d.c).forGetter(df.a::b),
                  aws.a(br.b, "projectile").forGetter(df.a::c)
               )
               .apply($$0, df.a::new)
      );
      ...
      public boolean a(enb $$0, esa $$1, int $$2) {
