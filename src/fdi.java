...
public class fdi extends gvu {
   ...
   public fdi(fnl $$0, fcl $$1, String $$2, BooleanConsumer $$3) {
      super(ffo.a);
      this.Y = $$3;
      this.D = $$0;
      this.I = $$2;
   ...
   @Override
   public void aP_() {
      this.H = this.c(fhu.a(wt.e, $$0 -> this.d()).a((this.m - 200) / 2, this.n - 42, 200, 20).a());
      this.D();
   }
   ...
   private void D() {
      if (!this.P && !this.X) {
         ...
         if (this.a(this.E.a) >= 5368709120L) {
            wu $$0 = wu.a("mco.download.confirmation.oversized", fba.b(5368709120L));
            this.l.a(fdr.c(this, $$0, $$0x -> {
               this.l.a(this);
               this.F();
            }));
         } else {
   ...
   private wu E() {
      ...
      if (this.M != null) {
         ...
         $$0.add(wu.a("mco.download.speed.narration", fba.b(this.T)));
      }
   ...
   private void a(fhh $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.o, wu.a("mco.download.speed", fba.b($$1)), this.m / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
