...
public class fdi {
   ...
   @Nullable
   private String g;
   private static final fdi.a h = new fdi.a() {
      @Nullable
      @Override
      public fdh a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fdl.a(this.d, "Get capabilities")) {
         ...
         if (fdl.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fdl.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fdl.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fdh a(fdi.c $$0) {
      return ($$0 == fdi.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fdi.a {
      private final int a;
      private final Set<fdh> b = Sets.newIdentityHashSet();
      ...
      public fdh a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fdi.a.warn("Maximum sound pool size {} reached", this.a);
            }
