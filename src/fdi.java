...
public class fdi extends gve {
   ...
   private Long Y;
   private long Z;
   private final fkp aa = new fkp(this);

   public fdi(@Nullable fef $$0, long $$1, int $$2, fdb $$3, epv $$4) {
      super(fev.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aM_() {
      this.U = this.aa.b(fhc.a(xn.k, $$0x -> this.D()).a());
      this.U.k = false;
      this.V = this.aa.b(fhc.a(xn.e, $$0x -> this.E()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.I();
         } else {
            List<fed> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fel(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fct(this.G, $$0.toArray(new fed[0])));
         }
      }
   ...
   private void D() {
      this.m.a(new fcm(new fah(new fng()), this.J));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              fak $$10 = new fak($$0, this.J, this.K, $$2, this.m.X(), aa.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              fai $$7 = fai.a($$6);
                              fai $$8 = fai.a(5368709120L);
                              if (fai.b($$6, $$7).equals(fai.b(5368709120L, $$8)) && $$7 != fai.a) {
                                 fai $$9 = fai.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xo.a("mco.upload.size.failure.line1", this.H.b()),
                                    xo.a("mco.upload.size.failure.line2", fai.b($$6, $$9), fai.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xo.a("mco.upload.size.failure.line1", this.H.b()),
                                    xo.a("mco.upload.size.failure.line2", fai.b($$6, $$7), fai.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
