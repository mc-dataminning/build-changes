...
public class fdi implements AutoCloseable {
   private static final int a = -1;
   private final alh b;
   private int c;

   private fdi(int $$0, alh $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fdi a(alh $$0, fdi.a $$1, String $$2) throws gin.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gin.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fdi($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fdi.a[] c = values();
