...
public class fdi {
   ...
   public void a(String $$0, cpz $$1, dlq $$2, Function<hr, dln> $$3) {
      ecg.c $$4 = this.a($$0);
      if ($$4 != null) {
         ane $$5 = anh.a($$4);
         cqo $$6 = $$1.g();
         ...
         try {
            afq.d $$7 = new afq.d($$5, $$6, false, false);
            afr $$8 = this.a($$7, $$3x -> {
               dln.b $$4x = $$3.apply($$3x.c()).a($$3x.d().d(jc.aI));
               return new afq.b<>(new eck($$1, $$2, $$4x.d(), $$4x.a()), $$4x.b());
            }, afr::new);
   ...
   public void a(ecg.c $$0, afg $$1, hl<aff> $$2, ecm $$3) {
      ane $$4 = anh.a($$0);
      anj $$5 = (anj)new afq.d($$4, $$3.F(), false, false).a().getSecond();
      this.b.a($$0.b(), $$0, $$4, new afr($$5, $$1, $$2, $$3), true);
   }

   private afr a(ecg.c $$0, boolean $$1, ane $$2) throws Exception {
      afq.d $$3 = this.b($$0, $$1, $$2);
      return this.a($$3, $$1x -> {
         DynamicOps<rq> $$2x = aeu.a(ri.a, $$1x.c());
         hq<dit> $$3x = $$1x.d().d(jc.aI);
         Pair<ecm, dln.b> $$4 = $$0.a($$2x, $$1x.b(), $$3x, $$1x.c().d());
         if ($$4 == null) {
            throw new IllegalStateException("Failed to load world");
         } else {
            return new afq.b<>((ecm)$$4.getFirst(), ((dln.b)$$4.getSecond()).b());
         }
      }, afr::new);
   }
   ...
   public Pair<cpz, fdg> a(ecg.c $$0) throws Exception {
      ane $$1 = anh.a($$0);
      afq.d $$2 = this.b($$0, false, $$1);

      record a(cpz a, dlq b, hq<dit> c) {
      }

      return this.a($$2, $$1x -> {
         DynamicOps<rq> $$2x = aeu.a(ri.a, $$1x.c());
         hq<dit> $$3 = new hm<>(jc.aI, Lifecycle.stable()).l();
         Pair<ecm, dln.b> $$4 = $$0.a($$2x, $$1x.b(), $$3, $$1x.c().d());
         if ($$4 == null) {
            throw new IllegalStateException("Failed to load world");
         } else {
            return new afq.b<>(new a(((ecm)$$4.getFirst()).L(), ((ecm)$$4.getFirst()).A(), ((dln.b)$$4.getSecond()).c()), $$1x.d());
         }
      }, ($$0x, $$1x, $$2x, $$3) -> {
         $$0x.close();
   ...
   private afq.d b(ecg.c $$0, boolean $$1, ane $$2) {
      cqo $$3 = $$0.e();
      if ($$3 == null) {
         throw new IllegalStateException("Failed to load data pack config");
      } else {
         return new afq.d($$2, $$3, $$1, false);
      }
   }

   public afr a(ecg.c $$0, boolean $$1) throws Exception {
      ane $$2 = anh.a($$0);
      return this.a($$0, $$1, $$2);
   }

   private <D, R> R a(afq.d $$0, afq.f<D> $$1, afq.e<D, R> $$2) throws Exception {
      afq.c $$3 = new afq.c($$0, du.a.c, 2);
      CompletableFuture<R> $$4 = afq.a($$3, $$1, $$2, ac.f(), this.b);
      this.b.c($$4::isDone);
      return $$4.get();
   }
