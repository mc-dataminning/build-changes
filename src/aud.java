...
public class aud {
   ...
   public static ih<cms> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static ih<cms> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ih<cms> a(JsonObject $$0, String $$1, @Nullable ih<cms> $$2) {
