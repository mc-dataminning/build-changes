...
public class aud extends atu {
   ...
   private static final asy d = new asy(cru.h);
   ...
   public static aua a(Path $$0, fap $$1) {
      return new aua(new aud($$1), new atv($$0, ate.b, aub.e, $$1));
   }

   public static aua c() {
      return new aua(new aud(new fap($$0 -> true)));
   }

   public static aua a(eve.c $$0) {
      return a($$0.a(evc.j), $$0.d().e());
   }
}
