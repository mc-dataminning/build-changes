...
public class aud extends atx {
   static final Logger c = LogUtils.getLogger();
   private final aud.b d;
   private final String e;

   aud(auf $$0, aud.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(aui $$0, alz $$1) {
   ...
   @Nullable
   private avn<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : avn.create($$1, $$2);
      }
   }
   ...
   public static class a implements avd.c {
      ...
      @Override
      public aug a(auf $$0) {
         aud.b $$1 = new aud.b(this.a);
         return new aud($$0, $$1, "");
      }

      @Override
      public aug a(auf $$0, avd.a $$1) {
         aud.b $$2 = new aud.b(this.a);
         aug $$3 = new aud($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aug> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aud.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
