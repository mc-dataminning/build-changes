...
public class bcl extends bfu {
   ...
   public bcl(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, bgw.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", bcl::b);
      $$0 = $$0.update("back_text", bcl::b);
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bcl::a);
   }
}
