...
public class bcl extends bfe {
   public bcl(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bgf.z, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bgf.B.typeName(), bhp.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bgf.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bgf.B.typeName(), "minecraft:saddle"));
