...
public class bcl extends bhx {
   public bcl(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bjd.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bjd.s, "minecraft:jukebox");
