...
public class eqi {
   public static List<erk> a(eqi.a... $$0) {
      for (eqi.a $$1 : $$0) {
         a($$1.j);
      }

      List<erk> $$2 = Lists.newArrayList();

      for (eqi.a $$3 : $$0) {
         $$2.add(new erk($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(erk::a));
      return $$2;
   }
   ...
   public static List<erk> a() {
      return a(eqi.a.values());
   }
