...
public final class no {
   ...
   private static final Comparator<dsg.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dsg.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dsg.a::toString).collect(Collectors.joining(","));
   }
