...
public class bim extends bgj {
   private static final Logger a = LogUtils.getLogger();

   public bim(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bho.s, "minecraft:trial_spawner");
   }

   public Dynamic<?> a(Dynamic<vd> $$0) {
      Optional<Dynamic<vd>> $$1 = $$0.get("normal_config").result();
      if ($$1.isEmpty()) {
         return $$0;
      } else {
         Optional<Dynamic<vd>> $$2 = $$0.get("ominous_config").result();
         if ($$2.isEmpty()) {
            return $$0;
         } else {
            ale $$3 = bim.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(uu.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<vd>, Dynamic<vd>>, ale> a = new HashMap<>();

      private a() {
      }

      private static void a(ale $$0, String $$1, String $$2) {
         try {
            ug $$3 = a($$1);
            ug $$4 = a($$2);
            ug $$5 = $$3.i().a($$4);
      ...
      private static Dynamic<vd> a(ug $$0) {
         return new Dynamic(uu.a, $$0);
      }

      private static ug a(String $$0) {
         try {
            return ve.a($$0);
      ...
      static {
         ...
         a(
            ale.b("trial_chamber/melee/husk"),
         ...
         a(
            ale.b("trial_chamber/melee/spider"),
         ...
         a(
            ale.b("trial_chamber/melee/zombie"),
         ...
         a(
            ale.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            ale.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            ale.b("trial_chamber/ranged/stray"),
         ...
         a(
            ale.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            ale.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            ale.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            ale.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            ale.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            ale.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            ale.b("trial_chamber/small_melee/slime"),
