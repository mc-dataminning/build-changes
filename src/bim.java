...
public class bim extends big {
   ...
   public bim(cpk $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bik.J, $$0);
      this.e($$1, $$2, $$3);
   ...
   public bim(bik<? extends bim> $$0, cpk $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         ehf $$0 = new ehf(this.k.dp() - this.dp(), this.k.dr() + (double)this.k.cH() / 2.0 - this.dr(), this.k.dv() - this.dv());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void o() {
      ...
      if (this.dK() instanceof aki) {
         for (bim $$1 : this.dK().a(diw.a(bim.class), this.cG().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(aki $$0, ehf $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bim($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(aki $$0, ehf $$1, int $$2) {
      eha $$3 = eha.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.y_().a(40);
      List<bim> $$5 = $$0.a(diw.a(bim.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bim $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bim $$0) {
      return $$0 != this && a($$0, this.ah(), this.i);
   }

   private static boolean a(bim $$0, int $$1, int $$2) {
      return !$$0.dF() && ($$0.ah() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bim $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cbl $$0, int $$1) {
      Entry<bil, ciw> $$2 = cnf.a(cnh.L, $$0, ciw::j);
      if ($$2 != null) {
         ciw $$3 = $$2.getValue();
