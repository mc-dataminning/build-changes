...
public class gjd extends gjs {
   private static final float a = 1.0472F;
   private int b;

   gjd(gfk $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements giv<lv> {
      private final gjn a;
      ...
      public gis a(lv $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjd $$8 = new gjd($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
