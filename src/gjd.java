...
public abstract class gjd extends giq {
   ...
   protected gjd(gfi $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
   }

   protected gjd(gfi $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }
   ...
   protected void a(fgu $$0, fln $$1, Quaternionf $$2, float $$3) {
      fbx $$4 = $$1.b();
   ...
   protected void a(fgu $$0, Quaternionf $$1, float $$2, float $$3, float $$4, float $$5) {
      float $$6 = this.b($$5);
      float $$7 = this.c();
      float $$8 = this.d();
      float $$9 = this.e();
   ...
   private void a(fgu $$0, Quaternionf $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9, int $$10) {
   ...
   public interface a {
      gjd.a a = ($$0, $$1, $$2) -> $$0.set($$1.f());
      gjd.a b = ($$0, $$1, $$2) -> $$0.set(0.0F, $$1.f().y, 0.0F, $$1.f().w);

      void setRotation(Quaternionf var1, fln var2, float var3);
   }
}
