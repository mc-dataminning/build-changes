...
public class gaj extends gca {
   private final float a;
   private final gbv b;

   gaj(fxt $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gbv $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gbd<la> {
      ...
      public gba a(la $$0, fxt $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dld.a) {
            ...
            iz $$9 = iz.a($$2, $$3, $$4);
            int $$10 = ffd.Q().av().a($$8, $$1, $$9);
            if ($$8.b() instanceof dht) {
               $$10 = ((dht)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gaj($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
