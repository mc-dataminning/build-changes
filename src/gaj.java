...
public class gaj extends gay {
   ...
   public float b(float $$0) {
      return this.D * ayd.a(((float)this.s + $$0) / (float)this.t * 0.75F, 0.0F, 1.0F);
   }

   @Override
   public void a(eyw $$0, fdk $$1, float $$2) {
      if (this.G <= 0) {
         this.y = 1.0F - ayd.a(((float)this.s + $$2) / (float)this.t, 0.0F, 1.0F);
   ...
   private void a(eyw $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
