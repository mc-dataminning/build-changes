public class gaj extends fzc<cwn> {
   ...
   private int ak;
   private final gaj.a[] al = new gaj.a[7];
   int am;
   private boolean an;

   public gaj(cwn $$0, cri $$1, wy $$2) {
      super($$0, $$1, $$2);
      this.s = 276;
      this.x = 107;
   }
   ...
   protected void aO_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.al[$$3] = this.c(new gaj.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof gaj.a) {
               this.ak = ((gaj.a)$$0x).a() + this.am;
               this.G();
            }
         }));
         $$2 += 20;
   ...
   protected void a(fsh $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(gqx::H, P, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 512, 256);
      dig $$6 = this.z.p();
      if (!$$6.isEmpty()) {
         int $$7 = this.ak;
         if ($$7 < 0 || $$7 >= $$6.size()) {
         ...
         dif $$8 = $$6.get($$7);
         if ($$8.r()) {
            $$0.a(gqx::H, G, this.C + 83 + 99, this.D + 35, 28, 21);
         }
      }
   }

   private void a(fsh $$0, int $$1, int $$2, dif $$3) {
      int $$4 = this.z.n();
      int $$5 = this.z.l();
      if ($$4 < 5) {
         $$0.a(gqx::H, H, $$1 + 136, $$2 + 16, 102, 5);
         int $$6 = cqw.b($$4);
         if ($$5 >= $$6 && cqw.d($$4)) {
            int $$7 = 102;
            float $$8 = 102.0F / (float)(cqw.c($$4) - $$6);
            int $$9 = Math.min(azm.d($$8 * (float)($$5 - $$6)), 102);
            $$0.a(gqx::H, I, 102, 5, 0, 0, $$1 + 136, $$2 + 16, $$9, 5);
            int $$10 = this.z.m();
            if ($$10 > 0) {
               int $$11 = Math.min(azm.d((float)$$10 * $$8), 102 - $$9);
               $$0.a(gqx::H, J, 102, 5, $$9, 0, $$1 + 136 + $$9, $$2 + 16, $$11, 5);
            }
         }
      }
   }

   private void a(fsh $$0, int $$1, int $$2, dig $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
         ...
         $$0.a(gqx::H, K, $$1 + 94, $$2 + 18 + $$8, 6, 27);
      } else {
         $$0.a(gqx::H, L, $$1 + 94, $$2 + 18, 6, 27);
      }
   }
   ...
   private void a(fsh $$0, dif $$1, int $$2, int $$3) {
      if ($$1.r()) {
         $$0.a(gqx::H, M, $$2 + 5 + 35 + 20, $$3 + 3, 10, 9);
      } else {
         $$0.a(gqx::H, N, $$2 + 5 + 35 + 20, $$3 + 3, 10, 9);
      }
   }

   private void a(fsh $$0, czk $$1, czk $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.M() == $$1.M()) {
         $$0.a(this.p, $$1, $$3, $$4);
      } else {
   ...
   class a extends fsv {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fsv.c $$3) {
      ...
      public void a(fsh $$0, int $$1, int $$2) {
         if (this.i && gaj.this.z.p().size() > this.a + gaj.this.am) {
            if ($$1 < this.F() + 20) {
               czk $$3 = gaj.this.z.p().get(this.a + gaj.this.am).b();
               $$0.b(gaj.this.p, $$3, $$1, $$2);
            } else if ($$1 < this.F() + 50 && $$1 > this.F() + 30) {
               czk $$4 = gaj.this.z.p().get(this.a + gaj.this.am).c();
               if (!$$4.f()) {
                  $$0.b(gaj.this.p, $$4, $$1, $$2);
               }
            } else if ($$1 > this.F() + 65) {
               czk $$5 = gaj.this.z.p().get(this.a + gaj.this.am).f();
               $$0.b(gaj.this.p, $$5, $$1, $$2);
            }
         }
      }
   }
