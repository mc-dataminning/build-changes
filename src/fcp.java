...
public class fcp<T extends bfj> extends fad<T> {
   ...
   public static fem a(int $$0, fei $$1) {
      fem $$2 = new fem();
      fen $$3 = $$2.a();
      $$3.a("head", fej.c().a(0, 0).a(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F, $$1), feg.a(0.0F, (float)(18 - $$0), -6.0F));
      $$3.a("body", fej.c().a(28, 8).a(-5.0F, -10.0F, -7.0F, 10.0F, 16.0F, 8.0F, $$1), feg.a(0.0F, (float)(17 - $$0), 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fej $$4 = fej.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, (float)$$0, 4.0F, $$1);
      $$3.a("right_hind_leg", $$4, feg.a(-3.0F, (float)(24 - $$0), 7.0F));
      $$3.a("left_hind_leg", $$4, feg.a(3.0F, (float)(24 - $$0), 7.0F));
      $$3.a("right_front_leg", $$4, feg.a(-3.0F, (float)(24 - $$0), -5.0F));
      $$3.a("left_front_leg", $$4, feg.a(3.0F, (float)(24 - $$0), -5.0F));
      return $$2;
   }
