public class fcp extends fbe {
   private static final fct a = new fct(
   ...
   public fcp(fdj $$0, fdi $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   private void b(fat $$0, far $$1, int $$2) {
   ...
   protected void a(ffc $$0) {
      $$0.a(ffb.a, vu.a("gui.narrate.tab", this.n.a()));
   }
