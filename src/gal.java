...
public class gal extends fvi {
   ...
   private final fte s = new fte(this);
   private final fvi u;
   private final aua v;
   ...
   public gal(fvi $$0, aua $$1, Consumer<aua> $$2) {
      super(a);
      this.u = $$0;
      this.v = $$1;
      this.w = $$2;
   ...
   protected void aR_() {
      this.s.a(a, this.p);
      fti $$0 = this.s.c(fti.d());
      $$0.a(new fqk(b, this.p).d(310), $$0x -> $$0x.e(15));
      gaq.a $$1 = gaq.a(299).a(2, true).b(4);
      this.x.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.x.getBoolean($$1x), $$1xx -> this.x.put($$1x, $$1xx)).a($$1x.c()));
      ftf $$2 = $$1.a().a();
      this.y = new gal.a($$2, 310, 130);
      $$0.a(this.y);
      fti $$3 = this.s.b(fti.e().a(8));
      $$3.a(fpq.a(wo.d, $$0x -> this.m()).a());
      $$3.a(fpq.a(wo.e, $$0x -> this.aO_()).a());
      this.s.a($$1x -> {
   ...
   public class a extends fph {
      private final List<fpo> a = new ArrayList<>();
      private final ftf c;

      public a(final ftf $$1, final int $$2, final int $$3) {
         super(0, 0, $$2, $$3, wo.a);
         this.c = $$1;
         $$1.a(this::a);
      }
      ...
      @Override
      public ftx b(ftv $$0) {
         return new ftx(this.F(), this.G(), this.g, this.n());
      }
      ...
      @Override
      public Collection<? extends ftl> L() {
         return this.a;
      }
   }
}
