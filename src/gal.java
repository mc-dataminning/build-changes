...
public class gal extends gcc {
   private final float a;
   private final gbx b;

   gal(fxv $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gbx $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gbf<la> {
      ...
      public gbc a(la $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dlf.a) {
            ...
            iz $$9 = iz.a($$2, $$3, $$4);
            int $$10 = fff.Q().av().a($$8, $$1, $$9);
            if ($$8.b() instanceof dhv) {
               $$10 = ((dhv)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gal($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
