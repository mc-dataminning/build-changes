...
public class gal {
   public static class a implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gal.b $$8 = new gal.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gcb {
      b(fxu $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gbn {
      ...
      c(fxu $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbd $$7, gbw $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gal.c $$0 = new gal.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gal.c $$8 = new gal.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, ffe.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gaz {
      ...
      private int D;
      private final gbd E;
      private final List<cxh> F;
      private boolean G;

      public e(fxu $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbd $$7, List<cxh> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gbb $$12 = this.E.a(li.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)ayi.b.b($$11) / 255.0F, (float)ayi.b.c($$11) / 255.0F, (float)ayi.b.d($$11) / 255.0F);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gal.c $$10 = (gal.c)this.E.a(li.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
