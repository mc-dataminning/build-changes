...
public abstract class gal extends fzy {
   ...
   public void a(eyw $$0, fdk $$1, float $$2) {
      euk $$3 = $$1.b();
      float $$4 = (float)(ayd.d((double)$$2, this.d, this.g) - $$3.a());
      float $$5 = (float)(ayd.d((double)$$2, this.e, this.h) - $$3.b());
      float $$6 = (float)(ayd.d((double)$$2, this.f, this.i) - $$3.c());
      this.p().setRotation(this.a, $$1, $$2);
      if (this.z != 0.0F) {
         this.a.rotateZ(ayd.i($$2, this.A, this.z));
      }
   ...
   public interface a {
      ...
      void setRotation(Quaternionf var1, fdk var2, float var3);
   }
}
