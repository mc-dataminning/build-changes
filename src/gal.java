...
public class gal implements amp<gak> {
   public gak b(JsonObject $$0) {
      Builder<gaj> $$1 = ImmutableList.builder();
      int $$2 = arj.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = arj.a($$0, "width", -1);
      int $$9 = arj.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = arj.a($$0, "interpolate", false);
      return new gak($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gaj a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gaj(arj.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = arj.m($$1, "frames[" + $$0 + "]");
         int $$3 = arj.a($$2, "time", -1);
         if ($$2.has("time")) {
