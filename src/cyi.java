...
public class cyi extends cwl implements cxk {
   ...
   public static czg c() {
      return czg.a().a(bwp.c, new bwn(g, 8.0, bwn.a.a), buu.b).a(bwp.e, new bwn(h, -2.9F, bwn.a.a), buu.b).a();
   }
      ...
      if ($$2 instanceof cox $$4) {
         ...
         if ($$6 < 10) {
            ...
            if ($$7 > 0.0F && !$$4.bk()) {
               ...
               jr<avz> $$8 = ddb.b($$0, dda.C).orElse(awa.Au);
               $$4.b(awk.c.b(this));
               ...
               if ($$7 > 0.0F) {
                  ...
                  if ($$4.aJ()) {
                     float $$17 = 1.1999999F;
                     $$4.a(bvl.a, new fba(0.0, 1.1999999F, 0.0));
                  }
