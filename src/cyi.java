...
public class cyi {
   public static <T> List<cyi.b> a(List<T> $$0, Function<T, List<ip<ecg>>> $$1, boolean $$2) {
      Object2IntMap<ecg> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, ecg c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<ip<ecg>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (il<ecg> $$12 : $$10.get($$11)) {
               ecg $$13 = $$12.a();
      ...
      Builder<cyi.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<ecg> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cyi.b($$28));
      }
   ...
   public static record b(List<ecg> a, ToIntFunction<ecg> b) {
      b(List<ecg> $$0) {
         this($$0, ac.h($$0));
      }
   }
