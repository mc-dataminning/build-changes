...
public class ga implements ArgumentType<UUID> {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xa.c("argument.uuid.invalid"));
   ...
   public static UUID a(CommandContext<ej> $$0, String $$1) {
