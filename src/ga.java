...
public class ga<T> implements ArgumentType<ga.c<T>> {
   ...
   public ga(aly<? extends kd<T>> $$0) {
      this.b = $$0;
   }

   public static <T> ga<T> a(aly<? extends kd<T>> $$0) {
      return new ga<>($$0);
   }

   public static <T> ga.c<T> a(CommandContext<ew> $$0, String $$1, aly<kd<T>> $$2, DynamicCommandExceptionType $$3) throws CommandSyntaxException {
   ...
   public ga.c<T> a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         try {
            $$0.skip();
            alz $$2 = alz.a($$0);
            return new ga.d<>(ayk.a(this.b, $$2));
         ...
         alz $$4 = alz.a($$0);
         return new ga.b<>(aly.a(this.b, $$4));
      }
   }
   ...
   public static class a<T> implements is<ga<T>, ga.a<T>.a> {
      public void a(ga.a<T>.a $$0, ws $$1) {
         $$1.b($$0.b);
      }

      public ga.a<T>.a a(ws $$0) {
   ...
   static record b<T>(aly<T> a) implements ga.c<T> {
      @Override
      public Either<aly<T>, ayk<T>> a() {
         return Either.left(this.a);
      }

      @Override
      public <E> Optional<ga.c<E>> a(aly<? extends kd<E>> $$0) {
   ...
   public interface c<T> extends Predicate<jq<T>> {
      Either<aly<T>, ayk<T>> a();

      <E> Optional<ga.c<E>> a(aly<? extends kd<E>> var1);

      String b();
   }

   static record d<T>(ayk<T> a) implements ga.c<T> {
      @Override
      public Either<aly<T>, ayk<T>> a() {
