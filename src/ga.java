...
public class ga {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(uv.c("argument.item.tag.disallowed"));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> uv.b("argument.item.id.invalid", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> uv.b("arguments.item.tag.unknown", $$0));
   ...
   private final ii<clj> g;
   private final StringReader h;
   private final boolean i;
   private Either<ig<clj>, ik<clj>> j;
   @Nullable
   private sd k;
   private Function<SuggestionsBuilder, CompletableFuture<Suggestions>> l = f;

   private ga(ii<clj> $$0, StringReader $$1, boolean $$2) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
   }

   public static ga.a a(ii<clj> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();

      try {
         ga $$3 = new ga($$0, $$1, false);
         $$3.d();
         ig<clj> $$4 = (ig<clj>)$$3.j.left().orElseThrow(() -> new IllegalStateException("Parser returned unexpected tag name"));
   ...
   public static Either<ga.a, ga.b> b(ii<clj> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();
   ...
   public static CompletableFuture<Suggestions> a(ii<clj> $$0, SuggestionsBuilder $$1, boolean $$2) {
   ...
   private void a() throws CommandSyntaxException {
      ...
      agm $$1 = agm.a(this.h);
      Optional<? extends ig<clj>> $$2 = this.g.a(agl.a(kd.E, $$1));
   ...
   private void b() throws CommandSyntaxException {
      if (!this.i) {
         ...
         this.l = this::b;
         agm $$1 = agm.a(this.h);
         Optional<? extends ik<clj>> $$2 = this.g.a(arz.a(kd.E, $$1));
   ...
   private CompletableFuture<Suggestions> b(SuggestionsBuilder $$0) {
      return dy.a(this.g.e().map(arz::b), $$0, String.valueOf('#'));
   }

   private CompletableFuture<Suggestions> c(SuggestionsBuilder $$0) {
      return dy.a(this.g.c().map(agl::a), $$0);
   }
   ...
   public static record a(ig<clj> a, @Nullable sd b) {
   }

   public static record b(ik<clj> a, @Nullable sd b) {
   }
}
