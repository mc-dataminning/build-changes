...
public class ga {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ui.c("argument.item.tag.disallowed"));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ui.b("argument.item.id.invalid", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> ui.b("arguments.item.tag.unknown", $$0));
   ...
   private final id<cke> g;
   private final StringReader h;
   private final boolean i;
   private Either<ib<cke>, ig<cke>> j;
   @Nullable
   private rt k;
   private Function<SuggestionsBuilder, CompletableFuture<Suggestions>> l = f;

   private ga(id<cke> $$0, StringReader $$1, boolean $$2) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
   }

   public static ga.a a(id<cke> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();

      try {
         ga $$3 = new ga($$0, $$1, false);
         $$3.d();
         ib<cke> $$4 = (ib<cke>)$$3.j.left().orElseThrow(() -> new IllegalStateException("Parser returned unexpected tag name"));
   ...
   public static Either<ga.a, ga.b> b(id<cke> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();
   ...
   public static CompletableFuture<Suggestions> a(id<cke> $$0, SuggestionsBuilder $$1, boolean $$2) {
   ...
   private void a() throws CommandSyntaxException {
      ...
      afw $$1 = afw.a(this.h);
      Optional<? extends ib<cke>> $$2 = this.g.a(afv.a(jz.E, $$1));
   ...
   private void b() throws CommandSyntaxException {
      if (!this.i) {
         ...
         this.l = this::b;
         afw $$1 = afw.a(this.h);
         Optional<? extends ig<cke>> $$2 = this.g.a(arh.a(jz.E, $$1));
   ...
   private CompletableFuture<Suggestions> b(SuggestionsBuilder $$0) {
      return dy.a(this.g.e().map(arh::b), $$0, String.valueOf('#'));
   }

   private CompletableFuture<Suggestions> c(SuggestionsBuilder $$0) {
      return dy.a(this.g.c().map(afv::a), $$0);
   }
   ...
   public static record a(ib<cke> a, @Nullable rt b) {
   }

   public static record b(ig<cke> a, @Nullable rt b) {
   }
}
