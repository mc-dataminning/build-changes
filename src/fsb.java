...
public class fsb {
   ...
   private final fos g;
   final Map<UUID, fsq> h = Maps.newLinkedHashMap();
   ...
   private void a(fro $$0, int $$1, int $$2, btr $$3) {
   ...
   private void a(fro $$0, int $$1, int $$2, btr $$3, int $$4, alg[] $$5, alg[] $$6) {
      $$0.a(gqc::H, $$5[$$3.k().ordinal()], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      if ($$3.l() != btr.b.a) {
         $$0.a(gqc::H, $$6[$$3.l().ordinal() - 1], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      }
   }
   ...
   public void a(acd $$0) {
      $$0.a(new acd.b() {
         @Override
         public void a(UUID $$0, wy $$1, float $$2, btr.a $$3, btr.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fsb.this.h.put($$0, new fsq($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
         ...
         @Override
         public void a(UUID $$0, btr.a $$1, btr.b $$2) {
            fsq $$3 = fsb.this.h.get($$0);
            $$3.a($$1);
            $$3.a($$2);
         }
