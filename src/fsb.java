public class fsb extends fpl {
   private static final int a = 12235202;

   protected fsb(fnq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, fro $$8) {
   ...
   public static class a implements fqw<ka> {
      ...
      public fqt a(ka $$0, fnq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new fsb($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
