...
public class fsb {
   ...
   private final Deque<fsa> f = Queues.newArrayDeque();
   private final Set<avz> g = new HashSet<>();
      ...
      if (!this.f.isEmpty() && this.e() > 0) {
         this.f.removeIf($$0x -> {
            ...
            if ($$2 == -1) {
               ...
               this.d.add(new fsb.a<>($$0x, $$2, $$1));
               this.e.set($$2, $$2 + $$1);
               avz $$3 = $$0x.b();
               if ($$3 != null && this.g.add($$3)) {
                  this.c.ak().a(hjj.a($$3, 1.0F, 1.0F));
               }
   ...
   @Nullable
   public <T extends fsa> T a(Class<? extends T> $$0, Object $$1) {
      for (fsb.a<?> $$2 : this.d) {
   ...
   class a<T extends fsa> {
      ...
      public void c() {
         ...
         if (this.h == fsa.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(fsb.this, this.i);
         fsa.a $$1 = this.c.a();
         if ($$1 != this.h) {
         ...
         this.k = this.h == fsa.a.b && $$0 - this.f > 600L;
      }

      public void a(fpc $$0, int $$1) {
         $$0.c().a();
         $$0.c().a((float)$$1 - (float)this.c.c() * this.j, (float)(this.d * 32), 800.0F);
         this.c.a($$0, fsb.this.c.h, this.i);
         $$0.c().b();
      }
   }
}
