...
public class fsb implements frp.a {
   private final eqx a;
   private double b = Double.MIN_VALUE;
   private List<bis> c = Collections.emptyList();
   ...
   private void a(elr $$0, fog $$1, double $$2, double $$3, double $$4, bis $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aD.ifPresent($$10 -> {
   ...
   private void a(gw $$0, elr $$1, double $$2, double $$3, double $$4, fog $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      foe.a($$1, $$5.getBuffer(foo.x()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      foe.a(
         $$1,
         $$5.getBuffer(foo.x()),
         this.a.r.a_($$0).b(this.a.r, $$0, ehu.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
