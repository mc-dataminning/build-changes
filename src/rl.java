...
public class rl {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(tf.c("argument.nbt.trailing"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(tf.c("argument.nbt.expected.key"));
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(tf.c("argument.nbt.expected.value"));
   public static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(($$0, $$1) -> tf.a("argument.nbt.list.mixed", $$0, $$1));
   public static final Dynamic2CommandExceptionType e = new Dynamic2CommandExceptionType(($$0, $$1) -> tf.a("argument.nbt.array.mixed", $$0, $$1));
   public static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> tf.a("argument.nbt.array.invalid", $$0));
   ...
   public static final Codec<qr> i = Codec.STRING.comapFlatMap($$0 -> {
      try {
         return DataResult.success(new rl(new StringReader($$0)).a(), Lifecycle.stable());
   ...
   protected rk c() throws CommandSyntaxException {
      ...
      if (StringReader.isQuotedStringStart(this.u.peek())) {
         return ri.a(this.u.readQuotedString());
      } else {
