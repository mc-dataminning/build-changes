...
public class awk extends baq {
   public awk(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bbq.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bbq.s, "minecraft:jukebox");
