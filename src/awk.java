...
public class awk {
   ...
   public static SecretKey a() throws awl {
      try {
   ...
   public static KeyPair b() throws awl {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws awl {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, awk.a<T> $$3) throws awl {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws awl {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", awk::b);
   }

   public static PublicKey b(String $$0) throws awl {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", awk::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws awl {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws awl {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws awl {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws awl {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws awl {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws awl {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws awl {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws awl;
   }

   public static record b(long b, byte[] c) {
      public static final awk.b a = new awk.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(vi $$0, awk.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
