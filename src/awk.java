...
public class awk extends awj {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awk.a> s;
   private final awf t;
   private long u;
   private final amb v;

   private awk(amb $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awg.c($$2, 7, $$0.getLength());
      }
   }
