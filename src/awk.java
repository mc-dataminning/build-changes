...
public class awk {
   ...
   awk(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static awk.a a() {
      return new awk.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(awk::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public awk.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public awk a(Writer $$0) throws IOException {
         return new awk($$0, this.a);
      }
   }
}
