...
public class awk extends awp {
   ...
   private final Set<awl<?>> e = Sets.newHashSet();

   public awk(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<awl<?>> d() {
      Set<awl<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<awl<T>> a(awn<T> $$0, String $$1) {
      return Optional.ofNullable(alc.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<awn<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awl<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awl<?>>)$$3.next();
         awl<?> $$2 = (awl<?>)$$1.getKey();
      ...
      for (Entry<awn<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> alc b(awl<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(ari $$0) {
      Object2IntMap<awl<?>> $$1 = new Object2IntOpenHashMap();
