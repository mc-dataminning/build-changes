...
public class rf {
   ...
   public static aku<efk<?, ?>> a(String $$0) {
      return aku.a(mc.aL, akv.b($$0));
   }

   public static void a(qe<efk<?, ?>> $$0, aku<efk<?, ?>> $$1, efy<eij> $$2) {
      a($$0, $$1, $$2, eic.m);
   }

   public static <FC extends eic, F extends efy<FC>> void a(qe<efk<?, ?>> $$0, aku<efk<?, ?>> $$1, F $$2, FC $$3) {
      $$0.a($$1, new efk($$2, $$3));
   }
}
