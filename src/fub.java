public class fub extends fua<bzg> {
   private static final aew a = new aew("textures/entity/illager/illusioner.png");
   ...
   public void a(bzg $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      if ($$0.cd()) {
         ...
         for (int $$8 = 0; $$8 < $$6.length; $$8++) {
            $$3.a();
            $$3.a(
               $$6[$$8].c + (double)arw.b((float)$$8 + $$7 * 0.5F) * 0.025,
               $$6[$$8].d + (double)arw.b((float)$$8 + $$7 * 0.75F) * 0.0125,
               $$6[$$8].e + (double)arw.b((float)$$8 + $$7 * 0.7F) * 0.025
            );
            super.a($$0, $$1, $$2, $$3, $$4, $$5);
            $$3.b();
         }
