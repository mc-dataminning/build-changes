...
public class fub extends fuf {
   ...
   public fub(flj $$0, aul $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(foe $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gmi.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gmi.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = axk.a($$10);
      $$0.a($$0x -> gmi.P(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> gmi.P(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
   ...
   private void a(foe $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends hej {
      ...
      @Override
      public het a(aup $$0) throws IOException {
         aus $$1 = flj.Q().ae().d();

         het var4;
         try (InputStream $$2 = $$1.open(fub.a)) {
            var4 = new het(feu.a($$2), new hgp(true, true));
         }
