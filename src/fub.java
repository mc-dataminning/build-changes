...
public class fub extends ftr implements gey.a {
   ...
   public fub(gey $$0, @Nullable ftr $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aT_() {
      ...
      this.I.b(fny.a(xu.d, $$0x -> this.aP_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fnl $$0, int $$1, int $$2) {
      $$0.a(glo::B, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
