...
public class fub extends fty {
   ...
   private int J;
   private final fox K = new fox(false);

   public fub(boolean $$0, Runnable $$1) {
      super(flx.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(fns $$0) {
      $$0.a(glv::D, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
