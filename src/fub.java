...
public class fub {
   ...
   final fof c;
   private final List<fub.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fua> f = Queues.newArrayDeque();
   private final Set<awk> g = new HashSet<>();
      ...
      if (!this.f.isEmpty() && this.e() > 0) {
         this.f.removeIf($$0x -> {
            ...
            if ($$2 == -1) {
               ...
               this.d.add(new fub.a<>($$0x, $$2, $$1));
               this.e.set($$2, $$2 + $$1);
               awk $$3 = $$0x.b();
               if ($$3 != null && this.g.add($$3)) {
                  this.c.ak().a(hlr.a($$3, 1.0F, 1.0F));
               }
   ...
   @Nullable
   public <T extends fua> T a(Class<? extends T> $$0, Object $$1) {
      for (fub.a<?> $$2 : this.d) {
   ...
   class a<T extends fua> {
      ...
      public void c() {
         ...
         if (this.h == fua.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(fub.this, this.i);
         fua.a $$1 = this.c.a();
         if ($$1 != this.h) {
