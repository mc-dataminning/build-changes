...
public class beb {
   ...
   private JsonElement a(List<Pair<dhf, bel<bed>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bel)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dhf, bel<bed>> $$3 : $$0) {
         bel<bed> $$4 = (bel<bed>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dhf)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bej> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bdr.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bdz $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(beh $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         beh.b $$3 = (beh.b)$$1x.getFirst();
         beh.a $$4 = (beh.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bee> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bee>, ToDoubleFunction<bee>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bee::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bee::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bee::c));
      return $$1;
   }
}
