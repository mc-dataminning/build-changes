...
public class bxr {
   ...
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(hy.a.fieldOf("uuid").forGetter(Pair::getFirst), aoi.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bfj> j;
   @VisibleForTesting
   protected final ArrayList<bfj> c;
   private final bxr.a k;
   @VisibleForTesting
   ...
   public static Codec<bxr> a(Predicate<bfj> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(bxr::b)).apply($$1, $$1x -> new bxr($$0, $$1x))
      );
   }

   public bxr(Predicate<bfj> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new bxr.a(this);
   ...
   public void a(aif $$0, Predicate<bfj> $$1) {
      ...
      ObjectIterator<Entry<bfj>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bfj> $$6 = (Entry<bfj>)$$5.next();
         int $$7 = $$6.getIntValue();
         bfj $$8 = (bfj)$$6.getKey();
         bfj.c $$9 = $$8.dE();
   ...
   @VisibleForTesting
   protected static record a(bxr a) implements Comparator<bfj> {
