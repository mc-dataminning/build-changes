...
public class vg extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<uj> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, tv.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<uj> $$0, Codec<T> $$1, tv $$2) {
      uj $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vg a(DynamicOps<uj> $$0, Codec<T> $$1, T $$2) {
      uj $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = axa.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yf<? super vg, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yg<? super vg, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yf<? super vg, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yf<? super vg, K> $$1, yf<? super vg, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yf<? super vg, K> $$0, yf<? super vg, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yg<? super vg, K> $$1, yg<? super vg, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yg<? super vg, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yf<? super vg, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yf<? super vg, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yf<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yg<? super vg, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yg<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public esa k() {
      return new esa(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> vg a(ToIntFunction<T> $$0, T $$1) {
   ...
   public vg a(@Nullable uj $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable uj $$1) {
      if ($$1 == null) {
         $$1 = to.b;
      }

      try {
         tz.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static tm f(ByteBuf $$0) {
      uj $$1 = a($$0, tv.a(2097152L));
      if ($$1 != null && !($$1 instanceof tm)) {
   ...
   @Nullable
   public static uj a(ByteBuf $$0, tv $$1) {
      try {
         uj $$2 = tz.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public vg a(String $$0, int $$1) {
      vw.a(this.d, $$0, $$1);
      return this;
   }

   public ajt q() {
      return new ajt(this.d(32767));
   }
   ...
   public <T> ajs<T> a(ajs<? extends iy<T>> $$0) {
      ajt $$1 = this.q();
      return ajs.a($$0, $$1);
   }
   ...
   public erw v() {
      ...
      return new erw(new esa((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, axk.e($$1, 8)));
      }
   }
   ...
   public vg a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vg a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vg a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vg a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vg a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vg a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vg a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vg b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vg c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vg d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vg e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vg f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vg g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vg h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vg a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vg b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vg i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vg a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vg a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vg b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vg b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vg b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vg b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vg b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vg b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vg g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vg b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vg a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vg a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vg a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vg h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vg c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vg b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vg b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vg b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
