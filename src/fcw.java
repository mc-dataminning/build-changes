...
public class fcw {
   ...
   public void a(fdg $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fdg.a) {
            fhm.b($$1, fhm.a.a, wu.c("narrator.toast.disabled"), null);
         } else {
            fhm.b($$1, fhm.a.a, wu.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fhm.b($$1, fhm.a.a, wu.c("narrator.toast.disabled"), wu.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fcw.a("Narrator library is not active");
      }
   }
