...
public class fcw {
   ...
   public static final fcw.a bv;

   public static fcw.a a(int $$0, int $$1) {
      return $$0 == -1 ? fcw.b.b.a($$1) : fcw.b.a.a($$0);
   }

   public static fcw.a a(String $$0) {
      if (fcw.a.e.containsKey($$0)) {
         return fcw.a.e.get($$0);
      } else {
         for (fcw.b $$1 : fcw.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fcw.b b;
      private final int c;
      private final aze<xi> d;
      static final Map<String, fcw.a> e = Maps.newHashMap();

      a(String $$0, fcw.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new aze<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xi.b($$2.toUpperCase(Locale.ROOT)) : xi.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xi.b($$2) : xi.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> uf.a().b($$1) ? xi.c($$1) : xi.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fcw.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xi> g;

      private static void a(fcw.b $$0, String $$1, int $$2) {
         fcw.a $$3 = new fcw.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xi> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fcw.a a(int $$0) {
         return (fcw.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
