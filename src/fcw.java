...
public class fcw extends fda {
   ...
   private static final ahf<cun> q = cuu.b;
   ...
   @Nullable
   private static dxf a(ii<cwp> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, dmp.c);
      int $$10 = $$9 - $$2;

      Optional<ih.c<cwp>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new dxf($$10, $$11.get().a());
      }
   }

   private static List<dxf> a(ii<cwp> $$0, String $$1) {
      List<dxf> $$2 = Lists.newArrayList();
      String[] $$3 = $$1.split(",");
      int $$4 = 0;
   ...
   public static dxi a(ii<cwp> $$0, ii<cun> $$1, ii<dzl> $$2, ii<dyj> $$3, String $$4, dxi $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return dxi.a($$1, $$2, $$3);
      } else {
         List<dxf> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return dxi.a($$1, $$2, $$3);
         } else {
            ih.c<cun> $$8 = $$1.b(q);
   ...
   protected void aN_() {
      ...
      this.x = new exo(this.i, 50, 40, this.g - 100, 20, this.t);
      this.x.f(1230);
      fhy $$0 = this.r.a.n().k();
      iu $$1 = $$0.a();
      chr $$2 = $$0.g().b();
      ...
      ii<dzl> $$4 = $$1.b(ke.aF);
      ii<dyj> $$5 = $$1.b(ke.aC);
      ii<cwp> $$6 = $$1.b(ke.f).a($$2);
      this.x.a(a(this.r.m()));
      this.y = this.r.m();
      this.e(this.x);
      this.v = this.d(new fcw.a($$1, $$2));
      this.w = this.d(exf.a(vf.c("createWorld.customize.presets.select"), $$4x -> {
         dxi $$5x = a($$6, $$3, $$4, $$5, this.x.a(), this.y);
         this.r.a($$5x);
         this.f.a(this.r);
      }).a(this.g / 2 - 155, this.h - 28, 150, 20).a());
      this.d(exf.a(ve.e, $$0x -> this.f.a(this.r)).a(this.g / 2 + 5, this.h - 28, 150, 20).a());
   ...
   class a extends eyb<fcw.a.a> {
      public a(iu $$0, chr $$1) {
         super(fcw.this.f, fcw.this.g, fcw.this.h - 117, 80, 24);

         for (ih<dxg> $$2 : $$0.d(ke.az).c(ask.a)) {
            Set<cwp> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               fcw.c
                  .info(
               ...
               this.b(new fcw.a.a($$2));
            }
         }
      }

      public void a(@Nullable fcw.a.a $$0) {
         super.a($$0);
         fcw.this.c($$0 != null);
      }
      ...
      public class a extends eyb.a<fcw.a.a> {
         ...
         public a(ih<dxg> $$1) {
            this.c = $$1.a();
            this.d = $$1.e().map($$0x -> vf.c($$0x.a().f("flat_world_preset"))).orElse(fcw.a);
         }

         @Override
         public void a(ewt $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            this.a($$0, $$3, $$2, this.c.a().a());
            $$0.a(fcw.this.i, this.d, $$3 + 18 + 5, $$2 + 6, 16777215, false);
         }
         ...
         void b() {
            a.this.a(this);
            fcw.this.y = this.c.b();
            fcw.this.x.a(fcw.a(fcw.this.y));
            fcw.this.x.b(false);
         }

         private void a(ewt $$0, int $$1, int $$2, cms $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cmx($$3), $$1 + 2, $$2 + 2);
         }

         private void a(ewt $$0, int $$1, int $$2) {
            $$0.a(fcw.b, $$1, $$2, 0, 18, 18);
         }
