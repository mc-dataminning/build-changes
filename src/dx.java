...
public record dx(List<dx.c> c) {
   ...
   public <S extends dsg<?, S>> boolean a(dsf<?, S> $$0, S $$1) {
      for (dx.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(dsf<?, ?> $$0) {
      for (dx.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public dx.a a(dth<?> $$0, String $$1) {
         this.a.add(new dx.c($$0.f(), new dx.b($$1)));
         return this;
      }

      public dx.a a(dth<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public dx.a a(dth<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & azu> dx.a a(dth<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String e) implements dx.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dsg<?, ?> $$0, dth<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   interface e {
      ...
      zn<ByteBuf, dx.e> d = zl.a(dx.b.b, dx.d.b).a(Either::unwrap, $$0 -> {
         if ($$0 instanceof dx.b $$1) {
            return Either.left($$1);
         } else if ($$0 instanceof dx.d $$2) {
            return Either.right($$2);
      ...
      <T extends Comparable<T>> boolean a(dsg<?, ?> var1, dth<T> var2);
   }
}
