...
public class ceu {
   ...
   private final Map<ji<cev>, Set<cet>> c = Maps.newHashMap();
   ...
   public static Codec<ceu> a(Runnable $$0) {
      return RecordCodecBuilder.create(
         ...
         .orElseGet(ac.a("Failed to read POI section: ", a::error), () -> new ceu($$0, false, ImmutableList.of()));
   }
   ...
   public Stream<cet> a(Predicate<ji<cev>> $$0, ces.b $$1) {
      return this.c.entrySet().stream().filter($$1x -> $$0.test((ji<cev>)$$1x.getKey())).flatMap($$0x -> ((Set)$$0x.getValue()).stream()).filter($$1.a());
   }
   ...
   public void a(iz $$0) {
      cet $$1 = (cet)this.b.remove(kb.b($$0));
      if ($$1 == null) {
   ...
   public Optional<ji<cev>> d(iz $$0) {
      return this.e($$0).map(cet::g);
   }

   private Optional<cet> e(iz $$0) {
      return Optional.ofNullable((cet)this.b.get(kb.b($$0)));
   }

   public void a(Consumer<BiConsumer<iz, ji<cev>>> $$0) {
      if (!this.e) {
