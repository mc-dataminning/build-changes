...
public class drf {
   ...
   public static MapCodec<drf> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               dcn.b.lenientOptionalFieldOf("spawn_data").forGetter($$0x -> $$0x.h),
   ...
   protected long f;
   protected int g;
   protected Optional<dcn> h;
   protected Optional<ald<eql>> i;
   @Nullable
   protected bss j;
   @Nullable
   private bpc<cun> p;
   ...
   public drf(Set<UUID> $$0, Set<UUID> $$1, long $$2, long $$3, int $$4, Optional<dcn> $$5, Optional<ald<eql>> $$6) {
      this.c.addAll($$0);
      this.d.addAll($$1);
      this.e = $$2;
      this.f = $$3;
   ...
   public boolean a(drd $$0, azf $$1) {
      boolean $$2 = this.b($$0, $$1).a().b("id", 8);
      return $$2 || !$$0.b().h().d();
   }

   public boolean a(dre $$0, int $$1) {
      return this.g >= $$0.a($$1);
   }
   ...
   public boolean a(are $$0, dre $$1, int $$2) {
   ...
   public void a(are $$0, iz $$1, drd $$2) {
      boolean $$3 = ($$1.a() + $$0.Z()) % 20L != 0L;
      if (!$$3) {
         if (!$$2.i().equals(drg.f) || !$$2.e()) {
   ...
   public void a(drd $$0, are $$1) {
      this.d.stream().map($$1::a).forEach($$1x -> {
         if ($$1x != null) {
            $$1.c(3012, $$1x.dp(), drd.a.a.a());
            $$1x.a(bss.c.b);
         }
      });
      if (!$$0.d().h().d()) {
   ...
   private void a(cmv $$0, bsa $$1) {
      int $$2 = $$1.e() + 1;
      int $$3 = 18000 * $$2;
      $$0.e(bsc.E);
      $$0.b(new bsa(bsc.H, $$3, 0));
   }
   ...
   public void a(drd $$0, azf $$1, bsy<?> $$2) {
      this.b($$0, $$1).a().a("id", lp.g.b($$2).toString());
   }

   protected dcn b(drd $$0, azf $$1) {
      if (this.h.isPresent()) {
         return this.h.get();
      } else {
         bpc<dcn> $$2 = $$0.b().h();
         Optional<dcn> $$3 = $$2.d() ? this.h : $$2.b($$1).map(bpe.b::b);
         this.h = Optional.of($$3.orElseGet(dcn::new));
         $$0.j();
         return this.h.get();
      }
   }
   ...
   @Nullable
   public bss a(drd $$0, dbw $$1, drg $$2) {
      if ($$0.a($$1) && $$2.d()) {
         if (this.j == null) {
            ur $$3 = this.b($$0, $$1.E_()).a();
            if ($$3.b("id", 8)) {
               this.j = bsy.a($$3, $$1, Function.identity());
            }
         }
   ...
   public ur a(drg $$0) {
      ...
      this.h
         .ifPresent($$1x -> $$1.a("spawn_data", (vo)dcn.b.encodeStart(vf.a, $$1x).result().orElseThrow(() -> new IllegalStateException("Invalid SpawnData"))));
      return $$1;
   }
   ...
   bpc<cun> a(are $$0, dre $$1, iz $$2) {
      if (this.p != null) {
         ...
         long $$5 = a($$0, $$2);
         ObjectArrayList<cun> $$6 = $$3.a($$4, $$5);
         if ($$6.isEmpty()) {
            return bpc.b();
         } else {
            bpc.a<cun> $$7 = new bpc.a<>();
            ObjectListIterator var10 = $$6.iterator();

            while (var10.hasNext()) {
               cun $$8 = (cun)var10.next();
               $$7.a($$8.c(1), $$8.I());
            }
   ...
   private static long a(are $$0, iz $$1) {
      iz $$2 = new iz(ayx.d((float)$$1.u() / 30.0F), ayx.d((float)$$1.v() / 20.0F), ayx.d((float)$$1.w() / 30.0F));
      return $$0.C() + $$2.a();
   }
}
