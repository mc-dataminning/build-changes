...
public class fxo implements fim {
   static final Logger b = LogUtils.getLogger();
   private final fki c;
   private final fxc<fxo.b> d;

   fxo(fki $$0, fxc<fxo.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alk c, int d, int e, int[][] f) implements fxq {
      ...
      public static final MapCodec<fxo.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alk.a.fieldOf("file").forGetter(fxo.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fxo.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fxo.a::e),
                     g.fieldOf("chars").forGetter(fxo.a::f)
                  )
                  .apply($$0, fxo.a::new)
         )
         .validate(fxo.a::a);
      ...
      private static DataResult<fxo.a> a(fxo.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fxo.b $$15 = $$9.a($$12, new fxo.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fxo.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(fki $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, fki b, int c, int d, int e, int f, int g, int h) implements fil {
