...
public class fxo {
   private static final fya a = fya.t(new ajh("textures/map/map_background.png"));
   private static final fya b = fya.t(new ajh("textures/map/map_background_checkerboard.png"));
   ...
   private final ezi au;
   private cqm av = cqm.h;
   private cqm aw = cqm.h;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gcz aB;
   private final gdz aC;

   public fxo(ezi $$0, gcz $$1, gdz $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bpp $$0, cqm $$1, cqj $$2, boolean $$3, eub $$4, fxs $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, git.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private void a(eub $$0, fxs $$1, int $$2, bpj $$3) {
      gif $$4 = (gif)this.aB.<fwr>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bpj.b ? 1.0F : -1.0F;
   ...
   private void a(eub $$0, fxs $$1, int $$2, float $$3, bpj $$4, float $$5, cqm $$6) {
      float $$7 = $$4 == bpj.b ? 1.0F : -1.0F;
   ...
   private void a(eub $$0, fxs $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = aww.c($$5);
   ...
   private void a(eub $$0, fxs $$1, int $$2, cqm $$3) {
      ...
      ejy $$4 = cqt.d($$3);
      eka $$5 = cqt.a($$4, this.au.r);
      euf $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(eub $$0, fxs $$1, int $$2, float $$3, float $$4, bpj $$5) {
      boolean $$6 = $$5 != bpj.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = aww.c($$4);
   ...
   private void a(eub $$0, float $$1, bpj $$2, cqm $$3) {
   ...
   private void a(eub $$0, float $$1, bpj $$2, cqm $$3, float $$4) {
      this.b($$0, $$2, $$4);
   ...
   private void a(eub $$0, bpj $$1, float $$2) {
      int $$3 = $$1 == bpj.b ? 1 : -1;
   ...
   private void b(eub $$0, bpj $$1, float $$2) {
      int $$3 = $$1 == bpj.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, eub $$1, fxs.a $$2, fwu $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bnc $$6 = (bnc)MoreObjects.firstNonNull($$3.aJ, bnc.a);
      ...
      if ($$8.d) {
         float $$11 = $$6 == bnc.a ? $$5 : 0.0F;
         float $$12 = 1.0F - aww.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bnc.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bnc.b ? $$5 : 0.0F;
         float $$14 = 1.0F - aww.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bnc.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fxo.a a(fwu $$0) {
      cqm $$1 = $$0.eU();
      cqm $$2 = $$0.eV();
      boolean $$3 = $$1.a(cqp.ot) || $$2.a(cqp.ot);
      boolean $$4 = $$1.a(cqp.vR) || $$2.a(cqp.vR);
      if (!$$3 && !$$4) {
         return fxo.a.a;
      } else if ($$0.fs()) {
         return b($$0);
      } else {
         return a($$1) ? fxo.a.b : fxo.a.a;
      }
   }

   private static fxo.a b(fwu $$0) {
      cqm $$1 = $$0.fu();
      bnc $$2 = $$0.ft();
      if (!$$1.a(cqp.ot) && !$$1.a(cqp.vR)) {
         return $$2 == bnc.a && a($$0.eV()) ? fxo.a.b : fxo.a.a;
      } else {
         return fxo.a.a($$2);
      }
   }
   ...
   private static boolean a(cqm $$0) {
      return $$0.a(cqp.vR) && cox.d($$0);
   }

   private void a(fwr $$0, float $$1, float $$2, bnc $$3, float $$4, cqm $$5, float $$6, eub $$7, fxs $$8, int $$9) {
      if (!$$0.gx()) {
         boolean $$10 = $$3 == bnc.a;
         bpj $$11 = $$10 ? $$0.fr() : $$0.fr().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            this.a($$0, $$5, $$13 ? cqj.e : cqj.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bpj.b;
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               int $$24 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cqj.e : cqj.d, !$$23, $$7, $$8, $$9);
         }
