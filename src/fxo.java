...
public abstract class fxo<T extends cum> implements fpc, fpw, fru {
   public static final fpm a = new fpm(alz.b("recipe_book/button"), alz.b("recipe_book/button_highlighted"));
   ...
   public fxo(T $$0, List<fxo.a> $$1) {
      this.f = $$0;
      this.z = $$1;
      fxv $$2 = () -> bae.d(this.r / 30.0F);
      this.u = new fxm($$2);
      this.B = new fxp(this, $$2, $$0 instanceof csz);
   }
   ...
   private void i() {
      ...
      this.x = new foh(this.g.h, $$1 + 25, $$2 + 13, 81, 9 + 5, xv.c("itemGroup.search"));
      this.x.f(50);
      this.x.g(true);
      this.x.g(16777215);
      this.x.a($$3);
   ...
   protected abstract boolean a(cuu var1);

   public void b(@Nullable cuu $$0) {
      if ($$0 != null && this.a($$0)) {
         this.s = null;
         this.u.a();
         if (this.d()) {
   ...
   protected abstract void a(fxs var1, cpx var2);
   ...
   public void a(fnl $$0, int $$1, int $$2, float $$3) {
      if (this.d()) {
         ...
         int $$4 = this.k();
         int $$5 = this.j();
         $$0.a(glo::B, b, $$4, $$5, 1.0F, 1.0F, 147, 166, 256, 256);
         this.x.a($$0, $$1, $$2, $$3);
   ...
   public void a(fnl $$0, int $$1, int $$2, @Nullable cuu $$3) {
      if (this.d()) {
         this.B.a($$0, $$1, $$2);
   ...
   public void a(ddc $$0) {
      this.u.a();
      ddi.f $$1 = ddi.f.a(Objects.requireNonNull(this.g.s));
      this.a(this.u, $$0, $$1);
   }

   protected abstract void a(fxm var1, ddc var2, ddi.f var3);
   ...
   public static record a(cxk a, Optional<cxk> b, dcb c) {
      public a(fxu $$0) {
         this(new cxk(cxo.rq), Optional.empty(), $$0);
      }

      public a(cxg $$0, dbi $$1) {
         this(new cxk($$0), Optional.empty(), $$1);
      }

      public a(cxg $$0, cxg $$1, dbi $$2) {
         this(new cxk($$0), Optional.of(new cxk($$1)), $$2);
      }
   }
}
