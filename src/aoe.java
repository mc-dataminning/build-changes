...
public class aoe {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xj.c("commands.op.failed"));
   ...
   private static int a(ew $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if (!$$2.f($$4)) {
            $$2.a($$4);
            $$3++;
            $$0.a(() -> xj.a("commands.op.success", $$1.iterator().next().getName()), true);
         }
      }
