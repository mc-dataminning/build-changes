...
public abstract class ub {
   ...
   private static volatile ub e = c();
   ...
   private static ub c() {
      ...
      return new ub() {
         ...
         @Override
         public ayr a(xj $$0) {
            return $$1 -> $$0.a(($$1x, $$2) -> baa.c($$2, $$1x, $$1) ? Optional.empty() : xj.a, yb.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = ub.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(ayv.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract ayr a(xj var1);

   public List<ayr> a(List<xj> $$0) {
