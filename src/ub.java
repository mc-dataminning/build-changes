...
public record ub(ug d, @Nullable tx e, ue f, @Nullable tl g, tp h) {
   public static final MapCodec<ub> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ue.a.forGetter(ub::l),
               tn.a.optionalFieldOf("unsigned_content").forGetter($$0x -> Optional.ofNullable($$0x.g)),
               tp.a.optionalFieldOf("filter_mask", tp.c).forGetter(ub::n)
            )
            .apply($$0, ($$0x, $$1, $$2, $$3, $$4) -> new ub($$0x, (tx)$$1.orElse(null), $$2, (tl)$$3.orElse(null), $$4))
   );
   ...
   public static void a(asl.a $$0, ug $$1, ue $$2) throws SignatureException {
      $$0.update(Ints.toByteArray(1));
      $$1.a($$0);
      $$2.a($$0);
   }

   public boolean a(asm $$0) {
