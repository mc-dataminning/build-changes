public class gzg extends gxu<coi, hfk> {
   public gzg(gxv.a $$0) {
      super($$0);
   }

   public void a(hfk $$0, fld $$1, grn $$2, int $$3) {
      coj $$4 = $$0.b;
      if ($$4 != null) {
         $$1.a();
   ...
   public void a(coi $$0, hfk $$1, float $$2) {
      ...
      for (int $$10 = 0; $$10 < $$6; $$10++) {
         for (int $$11 = 0; $$11 < $$5; $$11++) {
            ...
            int $$14 = $$0.dz();
            int $$15 = azz.a($$0.dC() + (double)$$13);
            int $$16 = $$0.dF();
            switch ($$3) {
               case c:
                  $$14 = azz.a($$0.dA() + (double)$$12);
                  break;
               case e:
                  $$16 = azz.a($$0.dG() - (double)$$12);
                  break;
               case d:
                  $$14 = azz.a($$0.dA() - (double)$$12);
                  break;
            ...
            $$1.c[$$11 + $$10 * $$5] = gri.a($$9, new iw($$14, $$15, $$16));
         }
      }
   }

   private void a(fld $$0, flg $$1, int[] $$2, int $$3, int $$4, hkq $$5, hkq $$6) {
      fld.a $$7 = $$0.c();
   ...
   private void a(fld.a $$0, flg $$1, float $$2, float $$3, float $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, $$2, $$3, $$6).a(-1).a($$4, $$5).b(hkg.d).c($$10).b($$0, (float)$$7, (float)$$8, (float)$$9);
   }
}
