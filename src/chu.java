...
public class chu extends cjc implements btb, cjg {
   private static final ajr<Integer> b = ajv.a(chu.class, ajt.b);
   private static final ajr<Integer> c = ajv.a(chu.class, ajt.b);
   private static final ajr<Integer> d = ajv.a(chu.class, ajt.b);
   private static final List<ajr<Integer>> e = ImmutableList.of(b, c, d);
   private static final ajr<Integer> bY = ajv.a(chu.class, ajt.b);
   ...
   private int cg;
   private final aqj ch = (aqj)new aqj(this.O_(), bpk.a.f, bpk.b.a).a(true);
   private static final Predicate<bso> ci = $$0 -> !$$0.ak().a(avz.y) && $$0.fH();
   private static final cdf cj = cdf.a().a(20.0).a(ci);

   public chu(bsa<? extends chu> $$0, dax $$1) {
      super($$0, $$1);
   ...
   @Override
   protected void z() {
      this.bS.a(0, new chu.a());
      this.bS.a(2, new cal(this, 1.0, 40, 20.0F));
      this.bS.a(5, new cay(this, 1.0));
      this.bS.a(6, new bzu(this, clw.class, 8.0F));
      this.bS.a(7, new cah(this));
      this.bT.a(1, new cbe(this));
      this.bT.a(2, new cbf<>(this, bso.class, 0, false, false, ci));
   }
   ...
   @Override
   public void n_() {
      euk $$0 = this.ds().d(1.0, 0.6, 1.0);
      if (!this.dP().B && this.u(0) > 0) {
         bru $$1 = this.dP().a(this.u(0));
         if ($$1 != null) {
            double $$2 = $$0.d;
            ...
            $$0 = new euk($$0.c, $$2, $$0.e);
            euk $$3 = new euk($$1.du() - this.du(), 0.0, $$1.dA() - this.dA());
            if ($$3.i() > 9.0) {
               euk $$4 = $$3.d();
      ...
      this.g($$0);
      if ($$0.i() > 0.05) {
         this.r((float)ayd.d($$0.e, $$0.c) * (180.0F / (float)Math.PI) - 90.0F);
      }
      ...
      for (int $$6 = 0; $$6 < 2; $$6++) {
         ...
         if ($$8 != null) {
            ...
            float $$16 = (float)(ayd.d($$14, $$12) * 180.0F / (float)Math.PI) - 90.0F;
            float $$17 = (float)(-(ayd.d($$13, $$15) * 180.0F / (float)Math.PI));
   ...
   protected void Y() {
      if (this.y() > 0) {
         ...
         if ($$0 <= 0) {
            this.dP().a(this, this.du(), this.dy(), this.dA(), 7.0F, false, dax.a.c);
            if (!this.aW()) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ai >= this.ce[$$1 - 1]) {
               ...
               if ((this.dP().ak() == bpr.c || this.dP().ak() == bpr.d) && this.cf[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
                  double $$4 = ayd.a(this.ah, this.du() - 10.0, this.du() + 10.0);
                  double $$5 = ayd.a(this.ah, this.dw() - 5.0, this.dw() + 5.0);
                  double $$6 = ayd.a(this.ah, this.dA() - 10.0, this.dA() + 10.0);
               ...
               int $$7 = this.u($$1);
               if ($$7 > 0) {
                  bso $$8 = (bso)this.dP().a($$7);
                  if ($$8 != null && this.c($$8) && !(this.g((bru)$$8) > 900.0) && this.E($$8)) {
                     this.a($$1 + 1, $$8);
                  ...
                  List<bso> $$9 = this.dP().a(bso.class, cj, this, this.cK().c(20.0, 8.0, 20.0));
                  if (!$$9.isEmpty()) {
                     bso $$10 = $$9.get(this.ah.a($$9.size()));
                     this.a($$1, $$10.al());
                  }
               }
            }
         ...
         if (this.cg > 0) {
            this.cg--;
            if (this.cg == 0 && this.dP().aa().b(dat.c)) {
               boolean $$11 = false;
               int $$12 = ayd.d(this.dj() / 2.0F + 1.0F);
               int $$13 = ayd.d(this.dk());

               for (io $$14 : io.b(this.dt() - $$12, this.dv(), this.dz() - $$12, this.dt() + $$12, this.dv() + $$13, this.dz() + $$12)) {
                  drb $$15 = this.dP().a_($$14);
                  if (d($$15)) {
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      cnc $$11 = new cnc(this.dP(), this, $$8, $$9, $$10);
      $$11.c(this);
      if ($$4) {
         $$11.a(true);
      }
   ...
   public boolean a(bqn $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(avy.u) || $$0.d() instanceof chu) {
         return false;
   ...
   public static btv.a u() {
      return cjc.gv().a(btw.q, 300.0).a(btw.r, 0.6F).a(btw.j, 0.6F).a(btw.k, 40.0).a(btw.a, 4.0);
   }
   ...
   class a extends bzm {
      public a() {
         this.a(EnumSet.of(bzm.a.a, bzm.a.c, bzm.a.b));
      }
