...
public abstract class chu {
   ...
   private final iq<cmr> l = iq.a();
   public final iq<cjp> i = iq.a();
   private final List<cim> m = Lists.newArrayList();
   private cmr n = cmr.f;
   private final iq<cmr> o = iq.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cjp> v = Sets.newHashSet();
   private final List<cig> w = Lists.newArrayList();
   @Nullable
   private cih x;
   private boolean y;

   protected chu(@Nullable cjb<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cif $$0, cfb $$1, cwj $$2) {
   ...
   protected static void a(bjo $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cie $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cmr $$1 = this.i.get($$0).g();
         Supplier<cmr> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cmr $$1, Supplier<cmr> $$2) {
      cmr $$3 = this.l.get($$0);
      if (!cmr.a($$3, $$1)) {
         cmr $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cmr $$1, Supplier<cmr> $$2) {
      if (!this.y) {
         cmr $$3 = this.o.get($$0);
         if (!cmr.a($$3, $$1)) {
            cmr $$4 = $$2.get();
   ...
   public abstract cmr a(cfb var1, int var2);

   public void a(int $$0, int $$1, cid $$2, cfb $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cid $$2, cfb $$3) {
      cfa $$4 = $$3.fS();
      if ($$2 == cid.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cid.a || $$2 == cid.b) && ($$1 == 0 || $$1 == 1)) {
         cic $$16 = $$1 == 0 ? cic.a : cic.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == cic.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == cic.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == cic.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<cmr> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cmr> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cid.d && $$3.fT().d && this.g().b() && $$0 >= 0) {
         cjp $$32 = this.i.get($$0);
         if ($$32.h()) {
            cmr $$33 = $$32.g();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == cid.e && this.g().b() && $$0 >= 0) {
         cjp $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().L();
         cmr $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cid.g && $$0 >= 0) {
         cjp $$37 = this.i.get($$0);
         cmr $$38 = this.g();
         if (!$$38.b() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.L() < $$38.g(); $$42 += $$40) {
                  cjp $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cmr $$44 = $$43.g();
                     if ($$41 != 0 || $$44.L() != $$44.g()) {
                        cmr $$45 = $$43.b($$44.L(), $$38.g() - $$38.L(), $$3);
                        $$38.g($$45.L());
                     }
                  }
               }
   ...
   private boolean a(cfb $$0, cic $$1, cjp $$2, cmr $$3, cmr $$4) {
      chl $$5 = $$0.dM().I();
   ...
   public void a(int $$0, int $$1, cmr $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cmr> $$1, cmr $$2) {
   ...
   public abstract boolean a(cfb var1);

   protected boolean a(cmr $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cfb $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cjp $$0, cmr $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cmr.c($$1, $$0.g()) ? $$0.g().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }

   public static int a(Set<cjp> $$0, int $$1, cmr $$2) {
      return switch ($$1) {
         case 0 -> aui.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
   ...
   public static int a(@Nullable dgo $$0) {
      return $$0 instanceof bjo ? b((bjo)$$0) : 0;
   }

   public static int b(@Nullable bjo $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(chu $$0) {
      Table<bjo, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bjo $$0, int $$1) {
