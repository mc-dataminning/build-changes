...
public class ami {
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ey.a(
                                          ...
                                          .then(
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a(
                                                                  ...
                                                                  .then(ey.a("pink").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.a))))
                                                               .then(ey.a("blue").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.b))))
                                                            .then(ey.a("red").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.c))))
                                                         .then(ey.a("green").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.d))))
                                                      .then(ey.a("yellow").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.e))))
                                                   .then(ey.a("purple").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.f))))
                                                .then(ey.a("white").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.a.g)))
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("style")
                                                         .then(ey.a("progress").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.b.a))))
                                                      .then(ey.a("notched_6").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.b.b))))
                                                   .then(ey.a("notched_10").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.b.c))))
                                                .then(ey.a("notched_12").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.b.d))))
                                             .then(ey.a("notched_20").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsa.b.e)))
                                       ))
                                    .then(
                                       ey.a("value")
                                          .then(
   ...
   private static int d(ex $$0, alx $$1) {
      if ($$1.g().isEmpty()) {
         $$0.a(() -> wp.a("commands.bossbar.get.players.none", $$1.e()), true);
      } else {
         $$0.a(() -> wp.a("commands.bossbar.get.players.some", $$1.e(), $$1.g().size(), ws.b($$1.g(), cox::p_)), true);
      }

      return $$1.g().size();
   }

   private static int a(ex $$0, alx $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.f() == $$2) {
         if ($$2) {
            throw k.create();
         } else {
   ...
   private static int a(ex $$0, alx $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         throw h.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(ex $$0, alx $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         throw i.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(ex $$0, alx $$1, bsa.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, bsa.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, wp $$2) throws CommandSyntaxException {
   ...
   private static int a(ex $$0, alx $$1, Collection<are> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
         if ($$1.g().isEmpty()) {
            ...
            $$0.a(() -> wp.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), ws.b($$2, cox::p_)), true);
         }
   ...
   private static int a(ex $$0) {
      Collection<alx> $$1 = $$0.l().aM().b();
      if ($$1.isEmpty()) {
         $$0.a(() -> wp.c("commands.bossbar.list.bars.none"), false);
      } else {
         $$0.a(() -> wp.a("commands.bossbar.list.bars.some", $$1.size(), ws.b($$1, alx::e)), false);
      }

      return $$1.size();
   }

   private static int a(ex $$0, akv $$1, wp $$2) throws CommandSyntaxException {
      aly $$3 = $$0.l().aM();
      if ($$3.a($$1) != null) {
         throw b.create($$1.toString());
      } else {
         alx $$4 = $$3.a($$1, ws.a($$0, $$2, null, 0));
         $$0.a(() -> wp.a("commands.bossbar.create.success", $$4.e()), true);
         return $$3.b().size();
      }
   }

   private static int e(ex $$0, alx $$1) {
      aly $$2 = $$0.l().aM();
      $$1.b();
      $$2.a($$1);
   ...
   public static alx a(CommandContext<ex> $$0) throws CommandSyntaxException {
      akv $$1 = fy.a($$0, "id");
      alx $$2 = ((ex)$$0.getSource()).l().aM().a($$1);
      if ($$2 == null) {
