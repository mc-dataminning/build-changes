...
public class ami {
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ey.a(
                                          ...
                                          .then(
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a(
                                                                  ...
                                                                  .then(ey.a("pink").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.a))))
                                                               .then(ey.a("blue").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.b))))
                                                            .then(ey.a("red").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.c))))
                                                         .then(ey.a("green").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.d))))
                                                      .then(ey.a("yellow").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.e))))
                                                   .then(ey.a("purple").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.f))))
                                                .then(ey.a("white").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.a.g)))
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("style")
                                                         .then(ey.a("progress").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.b.a))))
                                                      .then(ey.a("notched_6").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.b.b))))
                                                   .then(ey.a("notched_10").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.b.c))))
                                                .then(ey.a("notched_12").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.b.d))))
                                             .then(ey.a("notched_20").executes($$0x -> a((ex)$$0x.getSource(), a($$0x), bsb.b.e)))
                                       ))
                                    .then(
                                       ey.a("value")
                                          .then(
   ...
   private static int d(ex $$0, alx $$1) {
      if ($$1.g().isEmpty()) {
         ...
         $$0.a(() -> wp.a("commands.bossbar.get.players.some", $$1.e(), $$1.g().size(), ws.b($$1.g(), coy::p_)), true);
      }
   ...
   private static int a(ex $$0, alx $$1, bsb.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, bsb.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, Collection<are> $$2) throws CommandSyntaxException {
      ...
      if (!$$3) {
         ...
         if ($$1.g().isEmpty()) {
            ...
            $$0.a(() -> wp.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), ws.b($$2, coy::p_)), true);
         }
