...
class ami extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof amh && $$1 instanceof amh && $$0.equals($$1);
   }
   ...
   private static amh a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof amh) {
         return (amh)$$0;
      } else {
