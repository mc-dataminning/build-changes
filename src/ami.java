...
public class ami {
   ...
   private static ami.b a(ag $$0, boolean $$1) {
      Optional<at> $$2 = $$0.c();
      if ($$2.isEmpty()) {
         return ami.b.b;
      } else if ($$1) {
   ...
   private static boolean a(ai $$0, Stack<ami.b> $$1, Predicate<ai> $$2, ami.a $$3) {
      boolean $$4 = $$2.test($$0);
      ami.b $$5 = a($$0.a(), $$4);
      boolean $$6 = $$4;
      $$1.push($$5);
   ...
   public static void a(ai $$0, Predicate<ai> $$1, ami.a $$2) {
      ai $$3 = $$0.d();
