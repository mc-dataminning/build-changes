...
public class ami {
   ...
   private static int d(ex $$0, alx $$1) {
      if ($$1.g().isEmpty()) {
         ...
         $$0.a(() -> wp.a("commands.bossbar.get.players.some", $$1.e(), $$1.g().size(), ws.b($$1.g(), cow::p_)), true);
      }
   ...
   private static int a(ex $$0, alx $$1, brz.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, brz.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ex $$0, alx $$1, Collection<are> $$2) throws CommandSyntaxException {
      ...
      if (!$$3) {
         ...
         if ($$1.g().isEmpty()) {
            ...
            $$0.a(() -> wp.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), ws.b($$2, cow::p_)), true);
         }
