...
public class bul extends buf {
   public static final MapCodec<bul> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bul a(float $$0, float $$1, float $$2) {
      return new bul($$0, $$1, $$2);
   }

   private bul(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
