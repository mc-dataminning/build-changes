...
public class aot extends aoo {
   static final Logger c = LogUtils.getLogger();
   private final aot.b d;
   private final String e;

   aot(String $$0, aot.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aow $$0, ahg $$1) {
   ...
   @Nullable
   private apz<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : apz.create($$1, $$2);
      }
   }
   ...
   public static class a implements app.c {
      ...
      public aov a(String $$0) {
         aot.b $$1 = new aot.b(this.a);
         return new aot($$0, $$1, this.b, "");
      }

      @Override
      public aov a(String $$0, app.a $$1) {
         aot.b $$2 = new aot.b(this.a);
         aov $$3 = new aot($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aov> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aot($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aot.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
