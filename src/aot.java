...
public class aot {
   ...
   private static int a(ex $$0, fbw $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bva> $$6) throws CommandSyntaxException {
      ard $$7 = $$0.e();
      int $$8 = $$7.G_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
   ...
   private static int a(Collection<? extends bva> $$0) {
   ...
   private static void a(fbw $$0, double $$1, ard $$2, azh $$3, double $$4, double $$5, double $$6, double $$7, int $$8, aot.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bva> $$0, ard $$1, aot.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<fde, aot.a> $$7 = Maps.newHashMap();

      for (bva $$8 : $$0) {
         aot.a $$10;
         if ($$4) {
            fde $$9 = $$8 instanceof cpr ? $$8.cq() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)ayz.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)ayz.a($$10.b) + 0.5, Set.of(), $$8.dK(), $$8.dM(), true);
