      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)ayl.a),
               String.format(Locale.ROOT, "%.2f", this.d.aR().g() / (float)ayl.c)
            );
            ...
            $$10.a("Random tick rate", () -> this.d.bc().o().a(czc.o).toString());
