...
public class aot implements aoq {
   ...
   private final Map<aor, List<Path>> g;

   aot(aol $$0, Set<String> $$1, List<Path> $$2, Map<aor, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aor $$0, ahd $$1, Consumer<Path> $$2) {
   ...
   public void a(aor $$0, String $$1, String $$2, aoq.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ahd, apu<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aoq.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aos.a($$1, $$4, $$3, $$0);
   }
   ...
   public apu<InputStream> a(aor $$0, ahd $$1) {
      return (apu<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aos.a($$5)) {
               return apu.create($$5);
            }
         }
   ...
   public <T> T a(apc<T> $$0) {
      apu<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public aqf c() {
      return $$0 -> Optional.ofNullable(this.a(aor.a, $$0)).map($$0x -> new aqa(this, $$0x));
   }
}
