...
public abstract class cqs implements cqr {
   public static final Codec<cqs> a = jd.ac.q().dispatchStable(cqs::a, Function.identity());
   private final Supplier<Set<hg<cqo>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));

   protected cqs() {
   }

   protected abstract Codec<? extends cqs> a();

   protected abstract Stream<hg<cqo>> b();
   ...
   @Nullable
   public Pair<gw, hg<cqo>> a(int $$0, int $$1, int $$2, int $$3, Predicate<hg<cqo>> $$4, arx $$5, cqx.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<gw, hg<cqo>> a(gw $$0, int $$1, int $$2, int $$3, Predicate<hg<cqo>> $$4, cqx.f $$5, cpt $$6) {
      Set<hg<cqo>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         int $$8 = Math.floorDiv($$1, $$2);
         int[] $$9 = ars.a($$0.v(), $$6.C_() + 1, $$6.aj(), $$3).toArray();
         ...
         for (gw.a $$10 : gw.a(gw.b, $$8, hc.f, hc.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = hs.a($$15);
               hg<cqo> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.ap ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               hg<cqo> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract hg<cqo> getNoiseBiome(int var1, int var2, int var3, cqx.f var4);
