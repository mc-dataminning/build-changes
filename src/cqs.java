...
public abstract class cqs extends crm implements bvd {
   private static final ajx<Boolean> h = akb.a(cqs.class, ajz.k);
   private static final ajx<Boolean> i = akb.a(cqs.class, ajz.k);
   private static final ajx<Integer> j = akb.a(cqs.class, ajz.b);
   ...
   @Nullable
   private bvd.a aN;
   private final Supplier<cwj> aO;

   public cqs(buq<? extends cqs> $$0, dgg $$1, Supplier<cwj> $$2) {
      super($$0, $$1);
      this.aO = $$2;
      this.I = true;
   }
   ...
   public static boolean a(buj $$0, buj $$1) {
   ...
   protected abstract double b(bum var1);
   ...
   protected fay a(buj $$0, bum $$1, float $$2) {
      ...
      return new fay(0.0, this.b($$1), (double)$$3).b(-this.dM() * (float) (Math.PI / 180.0));
   }
   ...
   public void l(boolean $$0) {
      ...
      this.dW().a(lt.ao, this.dB() + (double)this.ae.i(), this.dD() + 0.7, this.dH() + (double)this.ae.i(), 0.0, 0.0, 0.0);
      if (this.ae.a(20) == 0) {
         this.dW().a(this.dB(), this.dD(), this.dH(), this.aW(), this.dn(), 1.0F, 0.8F + 0.4F * this.ae.i(), false);
         this.a(ebr.O, this.cX());
      }
   }
   ...
   public void h() {
      this.aG = this.aF;
      this.aF = this.F();
      if (this.aF != cqs.a.b && this.aF != cqs.a.c) {
         this.o = 0.0F;
      } else {
         this.o++;
      }
      ...
      if (this.di()) {
         ...
         if (this.dW().C) {
            this.J();
            this.dW().a(new ahg(this.c(0), this.c(1)));
         }
      ...
      List<buj> $$5 = this.dW().a(this, this.cR().c(0.2F, -0.01F, 0.2F), buo.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dW().C && !(this.cX() instanceof cov);
   ...
   private void D() {
      if (this.dW().C) {
         ...
         this.aK = ayy.a(this.aK, 0.0F, 1.0F);
         this.aM = this.aL;
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aJ) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof cov) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   public float a(int $$0, float $$1) {
      return this.c($$0) ? ayy.b(this.m[$$0] - (float) (Math.PI / 8), this.m[$$0], $$1) : 0.0F;
   }
   ...
   @Override
   public fay cT() {
      return new fay(0.0, (double)(0.88F * this.cS()), (double)(this.dr() * 0.64F));
   }

   @Override
   public void b(buj $$0, float $$1) {
      fay $$2 = $$0.du().d(this.du()).d().c((double)$$1 - 6.0);
      fay $$3 = this.dz();
      boolean $$4 = $$3.b($$2) > 0.0;
   ...
   public float p() {
      fat $$0 = this.cR();
      fat $$1 = new fat($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = ayy.a($$1.a) - 1;
      int $$3 = ayy.c($$1.d) + 1;
      int $$4 = ayy.a($$1.b) - 1;
      int $$5 = ayy.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dwv $$16 = this.dW().a_($$11);
                     if (!($$16.b() instanceof dss) && fbp.c($$16.g(this.dW(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, fbc.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               esx $$13 = this.dW().b_($$9);
               if ($$13.a(awu.a) && $$1 < (double)((float)$$9.v() + $$13.a(this.dW(), $$9))) {
                  if (!$$13.b()) {
                     return cqs.a.c;
                  }
   ...
   private void I() {
      ...
      double $$1 = 0.0;
      this.n = 0.05F;
      if (this.aG == cqs.a.e && this.aF != cqs.a.e && this.aF != cqs.a.d) {
         this.aD = this.e(1.0);
         ...
         if (this.aF == cqs.a.a) {
            ...
            this.n = 0.9F;
         } else if (this.aF == cqs.a.c) {
            $$0 = -7.0E-4;
            this.n = 0.9F;
         } else if (this.aF == cqs.a.b) {
            $$1 = 0.01F;
            this.n = 0.45F;
         } else if (this.aF == cqs.a.e) {
            this.n = 0.9F;
         } else if (this.aF == cqs.a.d) {
            this.n = this.aE;
            if (this.cX() instanceof cov) {
               this.aE /= 2.0F;
            }
         }
   ...
   private void J() {
      if (this.ca()) {
         ...
         this.h(this.dz().b((double)(ayy.a(-this.dM() * (float) (Math.PI / 180.0)) * $$0), 0.0, (double)(ayy.b(this.dM() * (float) (Math.PI / 180.0)) * $$0)));
   ...
   protected void a(buj $$0, buj.a $$1) {
      ...
      if (!$$0.aq().a(aws.s)) {
         ...
         $$0.q($$0.cA() + this.p);
         this.c($$0);
         if ($$0 instanceof cgw && this.cZ().size() == this.t()) {
            int $$2 = $$0.ar() % 2 == 0 ? 90 : 270;
            $$0.r(((cgw)$$0).aX + (float)$$2);
            $$0.q($$0.cA() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public fay b(bvf $$0) {
      fay $$1 = a((double)(this.dr() * ayy.g), (double)$$0.dr(), $$0.dM());
      double $$2 = this.dB() + $$1.d;
      double $$3 = this.dH() + $$1.f;
      ji $$4 = ji.a($$2, this.cR().e, $$3);
      ji $$5 = $$4.e();
      if (!this.dW().z($$5)) {
         List<fay> $$6 = Lists.newArrayList();
         double $$7 = this.dW().j($$4);
         if (cra.a($$7)) {
            $$6.add(new fay($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dW().j($$5);
         if (cra.a($$8)) {
            $$6.add(new fay($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fO().iterator();

         while (var14.hasNext()) {
            bvr $$9 = (bvr)var14.next();

            for (fay $$10 : $$6) {
               if (cra.a(this.dW(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   protected void c(buj $$0) {
      $$0.r(this.dM());
      float $$1 = ayy.h($$0.dM() - this.dM());
   ...
   public bsi a(cov $$0, bsh $$1) {
      ...
      if ($$2 != bsi.e) {
         ...
         return (bsi)($$0.fY() || !(this.o < 60.0F) || !this.dW().C && !$$0.n(this) ? bsi.e : bsi.a);
      }
   }
   ...
   protected void a(double $$0, boolean $$1, dwv $$2, ji $$3) {
      ...
      if (!this.bZ()) {
         if ($$1) {
            this.k();
         } else if (!this.dW().b_(this.dw().e()).a(awu.a) && $$0 < 0.0) {
            this.Z -= (float)$$0;
         }
      }
   }
   ...
   public float a(float $$0) {
      return ayy.h($$0, this.aM, this.aL);
   }

   @Override
   protected boolean r(buj $$0) {
      return this.cZ().size() < this.t() && !this.a(awu.a);
   }
   ...
   @Override
   public bvf cX() {
      return this.da() instanceof bvf $$0 ? $$0 : super.cX();
   }
   ...
   @Override
   public boolean bo() {
      return this.aF == cqs.a.b || this.aF == cqs.a.c;
   }

   @Override
   protected final cwj u() {
      return this.aO.get();
   }

   @Override
   public final cwn dJ() {
      return new cwn(this.aO.get());
   }
