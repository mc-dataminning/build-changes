...
public record cqs(int b, int c, iq<cqh> d, Optional<cqs.a> e) {
   private static final int f = 3;
   public static final MapCodec<cqs> a = cqs.a.a
      .flatXmap(cqs::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));

   public static cqs a(Map<Character, cqh> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cqs a(Map<Character, cqh> $$0, List<String> $$1) {
      cqs.a $$2 = new cqs.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cqs> a(cqs.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      iq<cqh> $$4 = iq.a($$2 * $$3, cqh.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cqs($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(ciz $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   public static cqs b(uj $$0) {
      int $$1 = $$0.n();
      int $$2 = $$0.n();
      iq<cqh> $$3 = iq.a($$1 * $$2, cqh.a);
      $$3.replaceAll($$1x -> cqh.b($$0));
      return new cqs($$1, $$2, $$3, Optional.empty());
   }
   ...
   public static record a(Map<Character, cqh> b, List<String> c) {
      ...
      public static final MapCodec<cqs.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(atx.d(e, cqh.c).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cqs.a::new)
      );

      public Map<Character, cqh> a() {
         return this.b;
      }
