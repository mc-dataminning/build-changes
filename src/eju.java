...
public class eju {
   ...
   static class a implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         return $$0.c[it.f.d()] && !$$0.b[it.f.d()].d;
      }

      @Override
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         $$1.d = true;
         $$1.b[it.f.d()].d = true;
         return new eju.k($$0, $$1);
      }
   }

   static class b implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         if ($$0.c[it.f.d()] && !$$0.b[it.f.d()].d && $$0.c[it.b.d()] && !$$0.b[it.b.d()].d) {
            eju.v $$1 = $$0.b[it.f.d()];
            return $$1.c[it.b.d()] && !$$1.b[it.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         ...
         $$1.b[it.f.d()].d = true;
         $$1.b[it.b.d()].d = true;
         $$1.b[it.f.d()].b[it.b.d()].d = true;
         return new eju.l($$0, $$1);
      }
   }

   static class c implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         return $$0.c[it.b.d()] && !$$0.b[it.b.d()].d;
      }
      ...
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         $$1.d = true;
         $$1.b[it.b.d()].d = true;
         return new eju.m($$0, $$1);
      }
   }

   static class d implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         if ($$0.c[it.c.d()] && !$$0.b[it.c.d()].d && $$0.c[it.b.d()] && !$$0.b[it.b.d()].d) {
            eju.v $$1 = $$0.b[it.c.d()];
            return $$1.c[it.b.d()] && !$$1.b[it.b.d()].d;
         } else {
            return false;
      ...
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         ...
         $$1.b[it.c.d()].d = true;
         $$1.b[it.b.d()].d = true;
         $$1.b[it.c.d()].b[it.b.d()].d = true;
         return new eju.n($$0, $$1);
      }
   }

   static class e implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         return $$0.c[it.c.d()] && !$$0.b[it.c.d()].d;
      }

      @Override
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         eju.v $$3 = $$1;
         if (!$$1.c[it.c.d()] || $$1.b[it.c.d()].d) {
            $$3 = $$1.b[it.d.d()];
         }

         $$3.d = true;
         $$3.b[it.c.d()].d = true;
         return new eju.o($$0, $$3);
      }
   }

   static class f implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         return true;
      }
      ...
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         $$1.d = true;
         return new eju.s($$0, $$1, $$2);
      }
   }

   static class g implements eju.i {
      @Override
      public boolean a(eju.v $$0) {
         return !$$0.c[it.e.d()] && !$$0.c[it.f.d()] && !$$0.c[it.c.d()] && !$$0.c[it.d.d()] && !$$0.c[it.b.d()];
      }

      @Override
      public eju.r a(it $$0, eju.v $$1, aym $$2) {
         $$1.d = true;
         return new eju.t($$0, $$1);
      }
   }

   public static class h extends eju.r {
      ...
      private eju.v G;
      private eju.v H;
      private final List<eju.r> I = Lists.newArrayList();

      public h(aym $$0, int $$1, int $$2, it $$3) {
         super(eic.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eju.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eju.p($$3, this.G));
         this.I.add(new eju.j($$3, this.H));
         List<eju.i> $$5 = Lists.newArrayList();
         $$5.add(new eju.b());
         $$5.add(new eju.d());
         $$5.add(new eju.e());
         $$5.add(new eju.a());
         ...
         ehd $$10 = ehd.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ehd $$11 = ehd.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ehd $$12 = ehd.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eju.u($$3, $$10, $$13++));
         this.I.add(new eju.u($$3, $$11, $$13++));
         this.I.add(new eju.q($$3, $$12));
      }
      ...
      private List<eju.v> b(aym $$0) {
         eju.v[] $$1 = new eju.v[75];
         ...
         eju.v $$23 = new eju.v(1003);
         eju.v $$24 = new eju.v(1001);
         eju.v $$25 = new eju.v(1002);
         $$1[v].a(it.b, $$23);
         $$1[w].a(it.d, $$24);
         $$1[x].a(it.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[it.f.d()].d = true;
         this.H.b[it.c.d()].d = true;
         this.H.b[it.f.d()].b[it.c.d()].d = true;
         this.H.b[it.b.d()].d = true;
         this.H.b[it.f.d()].b[it.b.d()].d = true;
         this.H.b[it.c.d()].b[it.b.d()].d = true;
         this.H.b[it.f.d()].b[it.c.d()].b[it.b.d()].d = true;
         ObjectArrayList<eju.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dbu $$2, aym $$3, ehd $$4) {
         int $$5 = 24;
      ...
      private void a(dbu $$0, aym $$1, ehd $$2) {
      ...
      private void b(dbu $$0, aym $$1, ehd $$2) {
      ...
      private void c(dbu $$0, aym $$1, ehd $$2) {
      ...
      private void d(dbu $$0, aym $$1, ehd $$2) {
      ...
      private void e(dbu $$0, aym $$1, ehd $$2) {
      ...
      private void f(dbu $$0, aym $$1, ehd $$2) {
   ...
   interface i {
      boolean a(eju.v var1);

      eju.r a(it var1, eju.v var2, aym var3);
   }

   public static class j extends eju.r {
      public j(it $$0, eju.v $$1) {
         super(eic.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dbu $$0, dbs $$1, dta $$2, aym $$3, ehd $$4, dag $$5, io $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dec.ch.n(), dec.ch.n(), false);
   ...
   public static class k extends eju.r {
      public k(it $$0, eju.v $$1) {
         super(eic.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dbu $$0, dbs $$1, dta $$2, aym $$3, ehd $$4, dag $$5, io $$6) {
         eju.v $$7 = this.B.b[it.f.d()];
         eju.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[it.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[it.a.d()]);
         }
   ...
   public static class l extends eju.r {
      public l(it $$0, eju.v $$1) {
         super(eic.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eju.r {
      public m(it $$0, eju.v $$1) {
         super(eic.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dbu $$0, dbs $$1, dta $$2, aym $$3, ehd $$4, dag $$5, io $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[it.a.d()]);
         }

         eju.v $$7 = this.B.b[it.b.d()];
         if ($$7.b[it.b.d()] == null) {
   ...
   public static class n extends eju.r {
      public n(it $$0, eju.v $$1) {
         super(eic.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dbu $$0, dbs $$1, dta $$2, aym $$3, ehd $$4, dag $$5, io $$6) {
         eju.v $$7 = this.B.b[it.c.d()];
         eju.v $$8 = this.B;
         eju.v $$9 = $$7.b[it.b.d()];
         eju.v $$10 = $$8.b[it.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[it.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[it.a.d()]);
         }
   ...
   public static class o extends eju.r {
      public o(it $$0, eju.v $$1) {
         super(eic.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eju.r {
      public p(it $$0, eju.v $$1) {
         super(eic.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eju.r {
      public q(it $$0, ehd $$1) {
         super(eic.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ehp {
      protected static final drd b = dec.hZ.n();
      protected static final drd c = dec.ia.n();
      protected static final drd d = dec.ib.n();
      protected static final drd h = c;
      protected static final drd i = dec.ii.n();
      protected static final boolean j = true;
      protected static final drd k = dec.G.n();
      protected static final Set<dea> l = ImmutableSet.builder().add(dec.dO).add(dec.iC).add(dec.mW).add(k.b()).build();
      ...
      public r(eic $$0, it $$1, int $$2, ehd $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eic $$0, int $$1, it $$2, eju.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ehd a(it $$0, eju.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ehd $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dbu $$0, ehd $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  drd $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.z_() && $$11 != k) {
                        this.a($$0, dec.a.n(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(dbu $$0, ehd $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dbu $$0, ehd $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, drd $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ehd $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dbu $$0, ehd $$1, int $$2, int $$3, int $$4) {
         io $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cit $$6 = bsc.D.a((daz)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), bsu.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eju.r {
      private int a;

      public s(it $$0, eju.v $$1, aym $$2) {
         super(eic.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dbu $$0, dbs $$1, dta $$2, aym $$3, ehd $$4, dag $$5, io $$6) {
         ...
         if (this.B.b[it.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[it.a.d()] && !this.B.c[it.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eju.r {
      public t(it $$0, eju.v $$1) {
         super(eic.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eju.r {
      private int a;

      public u(it $$0, ehd $$1, int $$2) {
         super(eic.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
