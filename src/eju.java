...
public record eju(eju.a b, byte c, byte d, byte e, Optional<vu> f) {
   public static final xs<vf, eju> a = xs.a(eju.a.K, eju::c, xq.b, eju::d, xq.b, eju::e, xq.b, eju::f, vw.c, eju::g, eju::new);

   public eju(eju.a b, byte c, byte d, byte e, Optional<vu> f) {
      e = (byte)(e & 15);
      this.b = b;
      this.c = c;
      this.d = d;
   ...
   public static enum a implements axq {
      ...
      B(27, "village_desert", true, eir.w.ak, false, true),
      C(28, "village_plains", true, eir.w.ak, false, true),
      D(29, "village_savanna", true, eir.w.ak, false, true),
      E(30, "village_snowy", true, eir.w.ak, false, true),
      F(31, "village_taiga", true, eir.w.ak, false, true),
      G(32, "jungle_temple", true, eir.w.ak, false, true),
      H(33, "swamp_hut", true, eir.w.ak, false, true);

      public static final IntFunction<eju.a> I = avn.a(eju.a::a, values(), avn.a.a);
      public static final Codec<eju.a> J = axq.a(eju.a::values);
      public static final xs<ByteBuf, eju.a> K = xq.a(I, eju.a::a);
      private final int L;
