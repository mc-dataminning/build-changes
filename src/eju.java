...
public class eju {
   ...
   public eju(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public eju(ejz $$0, ejz $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static eju a(dxe $$0) {
      return new eju((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static eju a(ejz $$0) {
      return new eju($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static eju a(hx $$0, hx $$1) {
      return new eju(
   ...
   public eju a(double $$0) {
      return new eju($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public eju b(double $$0) {
      return new eju(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public eju c(double $$0) {
      return new eju(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public eju d(double $$0) {
      return new eju(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public eju e(double $$0) {
      return new eju(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public eju f(double $$0) {
      return new eju(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public eju c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public eju d(double $$0, double $$1, double $$2) {
      return new eju(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public eju f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public eju h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ejz> b(ejz $$0, ejz $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      ib $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static ejv a(Iterable<eju> $$0, ejz $$1, ejz $$2, hx $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ejv($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ib a(eju $$0, ejz $$1, double[] $$2, @Nullable ib $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, ib.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, ib.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, ib.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, ib.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, ib.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, ib.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public ejz f() {
      return new ejz(atq.d(0.5, this.a, this.d), atq.d(0.5, this.b, this.e), atq.d(0.5, this.c, this.f));
   }

   public static eju a(ejz $$0, double $$1, double $$2, double $$3) {
      return new eju($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
