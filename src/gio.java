...
public class gio {
   public static class a implements gjh<lx> {
      ...
      public gje a(lx $$0, gfw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gio.b $$8 = new gio.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gke {
      b(gfw $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * ayy.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gjq {
      private boolean b;
      private boolean F;
      private final gjg G;
      private float H;
      ...
      c(gfw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjg $$7, gjz $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gio.c $$0 = new gio.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gjh<lx> {
      ...
      public gje a(lx $$0, gfw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gio.c $$8 = new gio.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, flh.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gjc {
      ...
      private int D;
      private final gjg E;
      private final List<czc> F;
      private boolean G;

      public e(gfw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjg $$7, List<czc> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, awa.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gje $$12 = this.E.a(lt.O, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axj.b($$11) / 255.0F, (float)axj.c($$11) / 255.0F, (float)axj.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               avy $$14 = $$13 ? avz.js : avz.jr;
               this.c.a(this.g, this.h, this.i, $$14, awa.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gio.c $$10 = (gio.c)this.E.a(lt.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = ayy.d($$18, $$13, $$16) * $$0;
                  double $$20 = ayy.d($$18, $$14, $$17) * $$0;
