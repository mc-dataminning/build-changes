public class gio extends gir {
   private final gcg a;
   private final glu b = glu.j(gri.a);

   gio(gfj $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
      this.a = new gbt(fmf.Q().aS().a(gem.aB));
      this.u = 0.0F;
      this.t = 30;
   }
