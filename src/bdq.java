...
public class bdq extends bgq {
   public bdq(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bhv.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhv.D.typeName(), bjj.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bhv.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bhv.D.typeName(), "minecraft:saddle"));
