...
public class bdq extends bai {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdq::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdq::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdq::k);
         $$0 = this.a($$0, "minecraft:fox", bdq::j);
         $$0 = this.a($$0, "minecraft:item", bdq::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdq::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdq::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdq::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdq::e);
         return this.a($$0, "minecraft:piglin", bdq::d);
      });
   }
