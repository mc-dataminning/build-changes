...
public class bdq extends DataFix {
   ...
   private static void a(bdq.a $$0, Dynamic<?> $$1) {
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      return $$0.createMap($$0.asMap($$0x -> $$0x, $$0x -> {
         Optional<Boolean> $$1 = aze.a($$0x).result();
         if ($$1.isPresent()) {
   ...
   private static Dynamic<?> a(bdq.a $$0, Dynamic<?> $$1, int $$2) {
   ...
   private static <T> Dynamic<T> a(bdq.a $$0, Dynamic<T> $$1, String $$2) {
      ...
      return switch ($$2) {
         ...
         case "minecraft:banner" -> {
            ...
            if ($$7.isPresent()) {
               $$0.a("minecraft:base_color", $$1.createString(azq.a($$7.get().intValue())));
            }
   ...
   private static void a(bdq.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static Optional<Pair<String, Integer>> c(Dynamic<?> $$0) {
      return $$0.get("id").asString().apply2stable(($$0x, $$1) -> Pair.of($$0x, axw.a($$1.intValue(), 0, 255)), $$0.get("lvl").asNumber()).result();
   }

   private static void b(bdq.a $$0, Dynamic<?> $$1, int $$2) {
      b($$0, $$1, "CanDestroy", "minecraft:can_break", ($$2 & 8) != 0);
      b($$0, $$1, "CanPlaceOn", "minecraft:can_place_on", ($$2 & 16) != 0);
   }

   private static void b(bdq.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void c(bdq.a $$0, Dynamic<?> $$1, int $$2) {
      List<? extends Dynamic<?>> $$3 = $$0.a("AttributeModifiers").asList(bdq::d);
      boolean $$4 = ($$2 & 2) != 0;
      if (!$$3.isEmpty() || $$4) {
   ...
   private static Dynamic<?> d(Dynamic<?> $$0) {
      ...
      $$1 = aze.a($$0, "AttributeName", $$1, "type");
      $$1 = aze.a($$0, "Slot", $$1, "slot");
      $$1 = aze.a($$0, "UUID", $$1, "uuid");
      $$1 = aze.a($$0, "Name", $$1, "name");
      $$1 = aze.a($$0, "Amount", $$1, "amount");
      return aze.a($$0, "Operation", $$1, "operation", $$0x -> {
   ...
   private static void b(bdq.a $$0, Dynamic<?> $$1) {
   ...
   private static void c(bdq.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
      if ($$2 != null) {
   ...
   private static void d(bdq.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
   ...
   @Nullable
   private static Dynamic<?> e(bdq.a $$0, Dynamic<?> $$1) {
   ...
   private static void f(bdq.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.emptyMap();
   ...
   private static void g(bdq.a $$0, Dynamic<?> $$1) {
      ...
      if (!$$2.isEmpty() || !$$3.isEmpty()) {
         boolean $$4 = aze.a($$0.a("LodestoneTracked"), true);
         Dynamic<?> $$5 = $$1.emptyMap();
   ...
   private static void b(bdq.a $$0) {
      $$0.a("Fireworks", true, $$1 -> {
         Stream<? extends Dynamic<?>> $$2 = $$1.get("Explosions").asStream().map(bdq::f);
   ...
   private static Dynamic<?> f(Dynamic<?> $$0) {
      ...
      $$0 = aze.a($$0, "Colors", "colors");
      $$0 = aze.a($$0, "FadeColors", "fade_colors");
      $$0 = aze.a($$0, "Trail", "has_trail");
      return aze.a($$0, "Flicker", "has_twinkle");
   }
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(bfp.t), this.getOutputSchema().getType(bfp.t), $$0 -> {
         Optional<? extends Dynamic<?>> $$1 = bdq.a.a($$0).map($$0x -> {
            a($$0x, $$0x.e);
            return $$0x.a();
         });
   ...
   static class a {
      ...
      public static Optional<bdq.a> a(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(($$1, $$2) -> new bdq.a($$1, $$2.intValue(), $$0.remove("id").remove("Count")), $$0.get("Count").asNumber())
            .result();
      }
