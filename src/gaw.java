...
public class gaw implements gbc.a {
   ...
   private final ezg A;
   private final Map<ib, gaw.a> B = new HashMap<>();
   private final Map<UUID, yy.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(zj.a $$0, long $$1) {
      this.B.put($$0.a(), new gaw.a($$0, $$1));
   }

   public void a(yy.a $$0) {
      this.C.put($$0.b(), $$0);
   }
   ...
   private void b(etz $$0, fxq $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aev::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gbc.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aev::a).collect(Collectors.toSet()).toString();
      }
   }
   ...
   private void a(etz $$0, fxq $$1, zj.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(etz $$0, fxq $$1, yy.a $$2) {
      if ($$2.e() != null) {
         gbk.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(etz $$0, fxq $$1, yy.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(etz $$0, fxq $$1, String $$2, zj.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }
   ...
   private Set<String> a(zj.a $$0) {
      return this.a($$0.a()).stream().map(aev::a).collect(Collectors.toSet());
   }

   private String a(yy.a $$0, ib $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(yy.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(yy.a $$0) {
      cis $$1 = this.A.s;
   ...
   private Collection<UUID> a(ib $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(yy.a::b).collect(Collectors.toSet());
   }

   private Map<ib, List<String>> f() {
      Map<ib, List<String>> $$0 = Maps.newHashMap();

      for (yy.a $$1 : this.C.values()) {
   ...
   private void g() {
      gbc.a(this.A.ao(), 8).ifPresent($$0 -> this.D = $$0.cw());
   }

   static record a(zj.a a, long b) {
   }
}
