...
public interface gaw {
   ...
   public static record a(int d, int e, gaw.a.a f) implements gaw {
      public static final Codec<gaw.a> c = arg.a(
         RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     arg.j.fieldOf("width").forGetter(gaw.a::b), arg.j.fieldOf("height").forGetter(gaw.a::c), gaw.a.a.g.fieldOf("border").forGetter(gaw.a::d)
                  )
                  .apply($$0, gaw.a::new)
         ),
         gaw.a::a
      ...
      public static record a(int a, int b, int c, int d) {
         private static final Codec<gaw.a.a> e = arg.j.flatComapMap($$0 -> new gaw.a.a($$0, $$0, $$0, $$0), $$0 -> {
            OptionalInt $$1 = $$0.e();
            return $$1.isPresent() ? DataResult.success($$1.getAsInt()) : DataResult.error(() -> "Border has different side sizes");
         });
         private static final Codec<gaw.a.a> f = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     arg.i.fieldOf("left").forGetter(gaw.a.a::a),
                     arg.i.fieldOf("top").forGetter(gaw.a.a::b),
                     arg.i.fieldOf("right").forGetter(gaw.a.a::c),
                     arg.i.fieldOf("bottom").forGetter(gaw.a.a::d)
                  )
                  .apply($$0, gaw.a.a::new)
         );
   ...
   public static record c(int d, int e) implements gaw {
      public static final Codec<gaw.c> c = RecordCodecBuilder.create(
         $$0 -> $$0.group(arg.j.fieldOf("width").forGetter(gaw.c::b), arg.j.fieldOf("height").forGetter(gaw.c::c)).apply($$0, gaw.c::new)
      );
