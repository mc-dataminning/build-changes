...
public class gaw implements ewh, AutoCloseable {
   ...
   private static final ewa t = new ewa();
   ...
   private final List<ewi> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, ewi> C = Maps.newHashMap();
   private final int D;
   ...
   public gaw(ath $$0, String $$1, eww $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ajv $$3 = new ajv("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = axc.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(axc.a($$5, "blend", null));
         this.H = a($$0, ewf.a.a, $$6);
         this.I = a($$0, ewf.a.b, $$7);
         this.D = ewg.a();
         int $$18 = 0;
   ...
   private static ewf a(final ath $$0, ewf.a $$1, String $$2) throws IOException {
      ewf $$3 = $$1.c().get($$2);
      ewf $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         atc $$5 = $$0.getResourceOrThrow(new ajv($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = ewf.a($$1, $$2, $$6, $$5.b(), new evy() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gaw.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static ewb a(JsonObject $$0) {
      if ($$0 == null) {
         return new ewb();
      } else {
         int $$1 = 32774;
