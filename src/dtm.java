...
public class dtm implements dti, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bof<boh.b> c;
   private final dtr d;
   private final Map<czk, dtm.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dtm(dtt $$0, Path $$1, boolean $$2) {
      this.d = new dtr($$0, $$1, $$2);
      this.c = new bof<>(new boh.a(dtm.b.values().length), ac.g(), "IOWorker-" + $$0.c());
   }

   public boolean a(czk $$0, int $$1) {
      czk $$2 = new czk($$0.e - $$1, $$0.f - $$1);
      czk $$3 = new czk($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(czk $$0, @Nullable ua $$1) {
      return this.a(() -> {
         dtm.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dtm.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(czk $$0, uu $$1) {
      return this.a(() -> {
         try {
            dtm.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new boh.b(dtm.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<czk, dtm.a>> $$0 = this.e.entrySet().iterator();
         Entry<czk, dtm.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new boh.b(dtm.b.b.ordinal(), this::a));
   }

   private void a(czk $$0, dtm.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new boh.b(dtm.b.c.ordinal(), () -> $$0.a(azb.a))).join();
         this.c.close();
