...
public class dtm extends dsr implements bsk {
   public int a;
   public float b;
   public float c;
   public float d;
   ...
   public static void a(dff $$0, jh $$1, dvo $$2, dtm $$3) {
      $$3.g = $$3.f;
      $$3.i = $$3.h;
      cor $$4 = $$0.a((double)$$1.u() + 0.5, (double)$$1.v() + 0.5, (double)$$1.w() + 0.5, 3.0, false);
      if ($$4 != null) {
         double $$5 = $$4.dD() - ((double)$$1.u() + 0.5);
         double $$6 = $$4.dJ() - ((double)$$1.w() + 0.5);
         $$3.j = (float)azn.d($$6, $$5);
         $$3.f += 0.1F;
