...
public class ccr extends ccf {
   ...
   public ccr(bvp $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!cgd.a(this.a)) {
         ...
         if (this.e && this.a.dV().T()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               ezy $$2 = cgf.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.c($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<jh> $$3x = $$0.z().d($$0xx -> $$0xx.a(axn.b), this::a, $$2x, 10, cgl.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<jh> $$3 = $$0.z().d($$0x -> $$0x.a(axn.b), this::a, jh.a((ka)$$2), 10, cgl.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().j();
                     ...
                     $$4.b($$5);
                     if (this.c == null) {
                        ezy $$6 = cgc.a(this.a, 10, 7, ezy.c(this.d), (float) (Math.PI / 2));
                        if ($$6 == null) {
                           return false;
                        }
