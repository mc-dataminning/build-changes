...
public class ccr extends cda<bss> {
   ...
   protected void a(aqn $$0, bss $$1) {
      if ($$1.p_()) {
         ...
         Set<Pair<ix<cdx>, io>> $$4 = $$2.b($$0x -> $$0x.a(cdy.n), $$3, $$1.dp(), 48, cdu.b.c).collect(Collectors.toSet());
         enk $$5 = buc.a($$1, $$4);
         if ($$5 != null && $$5.j()) {
            io $$6 = $$5.l();
            Optional<ix<cdx>> $$7 = $$2.c($$6);
            if ($$7.isPresent()) {
               $$1.dS().a(cbu.w, $$6);
            }
         } else if (this.f < 5) {
