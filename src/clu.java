   ...
   public void a(arn $$0) {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new fcu($$1, this.g.dC() + $$6, $$2);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               fcu $$9 = new fcu(this.g.dA() - this.a.dA(), 0.0, this.g.dG() - this.a.dG()).d();
               fcu $$10 = new fcu((double)azk.a(this.a.dL() * (float) (Math.PI / 180.0)), 0.0, (double)(-azk.b(this.a.dL() * (float) (Math.PI / 180.0)))).d();
               float $$11 = (float)$$10.b($$9);
               float $$12 = (float)(Math.acos((double)$$11) * 180.0F / (float)Math.PI);
               $$12 += 0.5F;
               if (this.d >= 5 && $$12 >= 0.0F && $$12 < 10.0F) {
                  double $$13 = 1.0;
                  fcu $$14 = this.a.h(1.0F);
                  ...
                  fcu $$21 = new fcu($$18, $$19, $$20);
                  if (!this.a.bb()) {
                     $$0.a(null, 1017, this.a.dv(), 0);
                  }

                  cqs $$22 = new cqs($$0, this.a, $$21.d());
