...
public class fwc extends fty {
   ...
   private static final ImmutableList<dze> y = ImmutableList.copyOf(dze.values());
   private static final ImmutableList<dze> z = y.stream().filter($$0 -> $$0 != dze.d).collect(ImmutableList.toImmutableList());
   private final dwp A;
   private dpl B = dpl.a;
   private drc C = drc.a;
   private dze D = dze.d;
   ...
   private fof W;
   private fof X;
   private fom<Boolean> Y;
   private fom<dpl> Z;
   private fom<Boolean> aa;
   private fom<Boolean> ab;
   ...
   @Override
   protected void aT_() {
      this.c((fof)fof.a(xu.d, $$0x -> this.l()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
      this.c((fof)fof.a(xu.e, $$0x -> this.E()).a(this.n / 2 + 4, 210, 150, 20).a());
      this.B = this.A.k();
      this.C = this.A.t();
      this.D = this.A.v();
      this.E = this.A.w();
      this.F = this.A.E();
      this.G = this.A.F();
      this.R = this.c((fof)fof.a(xv.c("structure_block.button.save"), $$0x -> {
         if (this.A.v() == dze.a) {
            this.a(dwp.a.b);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 185, 50, 20).a());
      this.S = this.c((fof)fof.a(xv.c("structure_block.button.load"), $$0x -> {
         if (this.A.v() == dze.b) {
            this.a(dwp.a.c);
            this.m.a(null);
         }
      ...
      this.c(
         fom.<dze>a($$0x -> xv.c("structure_block.mode." + $$0x.c()))
            .a(z, y)
            .a()
            .a(this.D)
      ...
      this.X = this.c((fof)fof.a(xv.c("structure_block.button.detect_size"), $$0x -> {
         if (this.A.v() == dze.a) {
            this.a(dwp.a.d);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 120, 50, 20).a());
      this.Y = this.c(fom.b(!this.A.w()).a().a(this.n / 2 + 4 + 100, 160, 50, 20, u, ($$0x, $$1x) -> this.A.a(!$$1x)));
      this.Z = this.c(fom.<dpl>a(dpl::b).a(dpl.values()).a().a(this.B).a(this.n / 2 - 20, 185, 40, 20, xv.b("MIRROR"), ($$0x, $$1x) -> this.A.a($$1x)));
      this.aa = this.c(fom.b(this.A.E()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, w, ($$0x, $$1x) -> this.A.d($$1x)));
      this.ab = this.c(fom.b(this.A.F()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, x, ($$0x, $$1x) -> this.A.e($$1x)));
      this.T = this.c((fof)fof.a(xv.b("0"), $$0x -> {
         this.A.a(drc.a);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.U = this.c((fof)fof.a(xv.b("90"), $$0x -> {
         this.A.a(drc.b);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.V = this.c((fof)fof.a(xv.b("180"), $$0x -> {
         this.A.a(drc.c);
         this.F();
      }).a(this.n / 2 + 1 + 20, 185, 40, 20).a());
      this.W = this.c((fof)fof.a(xv.b("270"), $$0x -> {
         this.A.a(drc.d);
         this.F();
      }).a(this.n / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.H = new foo(this.p, this.n / 2 - 152, 40, 300, 20, xv.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !fwc.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.H.f(128);
      this.H.a(this.A.c());
      this.d(this.H);
      jh $$0 = this.A.f();
      this.I = new foo(this.p, this.n / 2 - 152, 80, 80, 20, xv.c("structure_block.position.x"));
      this.I.f(15);
      this.I.a(Integer.toString($$0.u()));
      this.d(this.I);
      this.J = new foo(this.p, this.n / 2 - 72, 80, 80, 20, xv.c("structure_block.position.y"));
      this.J.f(15);
      this.J.a(Integer.toString($$0.v()));
      this.d(this.J);
      this.K = new foo(this.p, this.n / 2 + 8, 80, 80, 20, xv.c("structure_block.position.z"));
      this.K.f(15);
      this.K.a(Integer.toString($$0.w()));
      this.d(this.K);
      kl $$1 = this.A.j();
      this.L = new foo(this.p, this.n / 2 - 152, 120, 80, 20, xv.c("structure_block.size.x"));
      this.L.f(15);
      this.L.a(Integer.toString($$1.u()));
      this.d(this.L);
      this.M = new foo(this.p, this.n / 2 - 72, 120, 80, 20, xv.c("structure_block.size.y"));
      this.M.f(15);
      this.M.a(Integer.toString($$1.v()));
      this.d(this.M);
      this.N = new foo(this.p, this.n / 2 + 8, 120, 80, 20, xv.c("structure_block.size.z"));
      this.N.f(15);
      this.N.a(Integer.toString($$1.w()));
      this.d(this.N);
      this.O = new foo(this.p, this.n / 2 - 152, 120, 80, 20, xv.c("structure_block.integrity.integrity"));
      this.O.f(15);
      this.O.a(this.ac.format((double)this.A.x()));
      this.d(this.O);
      this.P = new foo(this.p, this.n / 2 - 72, 120, 80, 20, xv.c("structure_block.integrity.seed"));
      this.P.f(31);
      this.P.a(Long.toString(this.A.y()));
      this.d(this.P);
      this.Q = new foo(this.p, this.n / 2 - 152, 120, 240, 20, xv.c("structure_block.custom_data"));
      this.Q.f(128);
      this.Q.a(this.A.u());
      this.d(this.Q);
      this.F();
