public class fwc extends fuk {
   ...
   protected void aR_() {
      ...
      this.d(this.E);
      this.K = this.y.j();
      this.H = this.c(foz.a(dvb.a::a).a(dvb.a.values()).a(this.K).a().a(this.n / 2 + 54, 160, 100, 20, a, ($$0x, $$1) -> this.K = $$1));
      boolean $$0 = dnp.o(this.y.m()).o().b();
      this.H.j = $$0;
      this.H.k = $$0;
      this.c(new fom(this.n / 2 - 154, 185, 100, 20, wo.a, 0.0) {
         {
            this.b();
         }
         ...
         @Override
         protected void b() {
            this.b(wp.a("jigsaw_block.levels", fwc.this.F));
         }
      ...
      this.c(foz.b(this.G).a(this.n / 2 - 50, 185, 100, 20, wp.c("jigsaw_block.keep_jigsaws"), ($$0x, $$1) -> this.G = $$1));
      this.J = this.c((fos)fos.a(wp.c("jigsaw_block.generate"), $$0x -> {
         this.m();
         this.G();
      }).a(this.n / 2 + 54, 185, 100, 20).a());
      this.I = this.c((fos)fos.a(wo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
