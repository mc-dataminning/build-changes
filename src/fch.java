...
public class fch extends eyf {
   private static final ti a = ti.c("gui.abuseReport.reason.title");
   private static final ti b = ti.c("gui.abuseReport.reason.description");
   private static final ti c = ti.c("gui.abuseReport.read_info");
   ...
   @Nullable
   fjs s;
   private final Consumer<fjs> t;

   public fch(@Nullable eyf $$0, @Nullable fjs $$1, Consumer<fjs> $$2) {
      super(a);
      this.p = $$0;
      this.s = $$1;
      this.t = $$2;
   ...
   protected void aD_() {
      ...
      this.d(esl.a(c, $$0x -> this.f.a(new ewx($$0xx -> {
            if ($$0xx) {
   ...
   public class a extends eth<fch.a.a> {
      public a(eqq $$1) {
         super($$1, fch.this.g, fch.this.h, 40, fch.this.h - 95, 18);

         for (fjs $$2 : fjs.values()) {
            this.b(new fch.a.a($$2));
         }
      }

      @Nullable
      public fch.a.a a(fjs $$0) {
      ...
      public class a extends eth.a<fch.a.a> {
         final fjs b;
         ...
         @Override
         public ti a() {
            return ti.a("gui.abuseReport.reason.narration", this.b.b(), this.b.c());
         }
