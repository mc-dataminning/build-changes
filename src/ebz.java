...
public class ebz implements ecb {
   public static final Codec<ebz> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               boz.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               boz.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               boz.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               box.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               box.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public ebz(int $$0, boz $$1, boz $$2, int $$3, int $$4, boz $$5, box $$6, box $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
