...
@Deprecated
public class ebz extends ebk<ebz.a> {
   private static final dsk a = dfj.nc.o();

   public ebz(Codec<ebz.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebm<ebz.a> $$0) {
      ja $$1 = $$0.e();
      ddb $$2 = $$0.b();
      ayo $$3 = $$0.d();
      ebz.a $$4 = $$0.f();
   ...
   public static record a(efp b, efp c) implements edo {
      public static final Codec<ebz.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(efp.a.fieldOf("fluid").forGetter(ebz.a::a), efp.a.fieldOf("barrier").forGetter(ebz.a::b)).apply($$0, ebz.a::new)
      );
