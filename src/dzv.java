...
public class dzv extends dzy<dzu> {
   public dzv(Codec<dzu> $$0) {
      super($$0);
   }

   public boolean a(dzu $$0, azg $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dzt $$0, dzu $$1, dtx $$2, Function<iz, ji<dcw>> $$3, azg $$4, dxf $$5, dbe $$6, dtw $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dzy.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dzt $$0, dzu $$1, dtx $$2, Function<iz, ji<dcw>> $$3, dxf $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dtw $$10, dzy.a $$11
   ) {
