...
public class dzv {
   ...
   static class a implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         return $$0.c[ib.f.d()] && !$$0.b[ib.f.d()].d;
      }

      @Override
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         $$1.d = true;
         $$1.b[ib.f.d()].d = true;
         return new dzv.k($$0, $$1);
      }
   }

   static class b implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         if ($$0.c[ib.f.d()] && !$$0.b[ib.f.d()].d && $$0.c[ib.b.d()] && !$$0.b[ib.b.d()].d) {
            dzv.v $$1 = $$0.b[ib.f.d()];
            return $$1.c[ib.b.d()] && !$$1.b[ib.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         ...
         $$1.b[ib.f.d()].d = true;
         $$1.b[ib.b.d()].d = true;
         $$1.b[ib.f.d()].b[ib.b.d()].d = true;
         return new dzv.l($$0, $$1);
      }
   }

   static class c implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         return $$0.c[ib.b.d()] && !$$0.b[ib.b.d()].d;
      }
      ...
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         $$1.d = true;
         $$1.b[ib.b.d()].d = true;
         return new dzv.m($$0, $$1);
      }
   }

   static class d implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         if ($$0.c[ib.c.d()] && !$$0.b[ib.c.d()].d && $$0.c[ib.b.d()] && !$$0.b[ib.b.d()].d) {
            dzv.v $$1 = $$0.b[ib.c.d()];
            return $$1.c[ib.b.d()] && !$$1.b[ib.b.d()].d;
         } else {
            return false;
      ...
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         ...
         $$1.b[ib.c.d()].d = true;
         $$1.b[ib.b.d()].d = true;
         $$1.b[ib.c.d()].b[ib.b.d()].d = true;
         return new dzv.n($$0, $$1);
      }
   }

   static class e implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         return $$0.c[ib.c.d()] && !$$0.b[ib.c.d()].d;
      }

      @Override
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         dzv.v $$3 = $$1;
         if (!$$1.c[ib.c.d()] || $$1.b[ib.c.d()].d) {
            $$3 = $$1.b[ib.d.d()];
         }

         $$3.d = true;
         $$3.b[ib.c.d()].d = true;
         return new dzv.o($$0, $$3);
      }
   }

   static class f implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         return true;
      }
      ...
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         $$1.d = true;
         return new dzv.s($$0, $$1, $$2);
      }
   }

   static class g implements dzv.i {
      @Override
      public boolean a(dzv.v $$0) {
         return !$$0.c[ib.e.d()] && !$$0.c[ib.f.d()] && !$$0.c[ib.c.d()] && !$$0.c[ib.d.d()] && !$$0.c[ib.b.d()];
      }

      @Override
      public dzv.r a(ib $$0, dzv.v $$1, atw $$2) {
         $$1.d = true;
         return new dzv.t($$0, $$1);
      }
   }

   public static class h extends dzv.r {
      ...
      private dzv.v G;
      private dzv.v H;
      private final List<dzv.r> I = Lists.newArrayList();

      public h(atw $$0, int $$1, int $$2, ib $$3) {
         super(dyd.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dzv.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dzv.p($$3, this.G));
         this.I.add(new dzv.j($$3, this.H));
         List<dzv.i> $$5 = Lists.newArrayList();
         $$5.add(new dzv.b());
         $$5.add(new dzv.d());
         $$5.add(new dzv.e());
         $$5.add(new dzv.a());
         ...
         dxe $$10 = dxe.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dxe $$11 = dxe.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dxe $$12 = dxe.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dzv.u($$3, $$10, $$13++));
         this.I.add(new dzv.u($$3, $$11, $$13++));
         this.I.add(new dzv.q($$3, $$12));
      }
      ...
      private List<dzv.v> b(atw $$0) {
         dzv.v[] $$1 = new dzv.v[75];
         ...
         dzv.v $$23 = new dzv.v(1003);
         dzv.v $$24 = new dzv.v(1001);
         dzv.v $$25 = new dzv.v(1002);
         $$1[v].a(ib.b, $$23);
         $$1[w].a(ib.d, $$24);
         $$1[x].a(ib.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ib.f.d()].d = true;
         this.H.b[ib.c.d()].d = true;
         this.H.b[ib.f.d()].b[ib.c.d()].d = true;
         this.H.b[ib.b.d()].d = true;
         this.H.b[ib.f.d()].b[ib.b.d()].d = true;
         this.H.b[ib.c.d()].b[ib.b.d()].d = true;
         this.H.b[ib.f.d()].b[ib.c.d()].b[ib.b.d()].d = true;
         ObjectArrayList<dzv.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, csz $$2, atw $$3, dxe $$4) {
         int $$5 = 24;
      ...
      private void a(csz $$0, atw $$1, dxe $$2) {
      ...
      private void b(csz $$0, atw $$1, dxe $$2) {
      ...
      private void c(csz $$0, atw $$1, dxe $$2) {
      ...
      private void d(csz $$0, atw $$1, dxe $$2) {
      ...
      private void e(csz $$0, atw $$1, dxe $$2) {
      ...
      private void f(csz $$0, atw $$1, dxe $$2) {
   ...
   interface i {
      boolean a(dzv.v var1);

      dzv.r a(ib var1, dzv.v var2, atw var3);
   }

   public static class j extends dzv.r {
      public j(ib $$0, dzv.v $$1) {
         super(dyd.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(csz $$0, csx $$1, djk $$2, atw $$3, dxe $$4, crm $$5, hx $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cvh.ch.o(), cvh.ch.o(), false);
   ...
   public static class k extends dzv.r {
      public k(ib $$0, dzv.v $$1) {
         super(dyd.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(csz $$0, csx $$1, djk $$2, atw $$3, dxe $$4, crm $$5, hx $$6) {
         dzv.v $$7 = this.B.b[ib.f.d()];
         dzv.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ib.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ib.a.d()]);
         }
   ...
   public static class l extends dzv.r {
      public l(ib $$0, dzv.v $$1) {
         super(dyd.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dzv.r {
      public m(ib $$0, dzv.v $$1) {
         super(dyd.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(csz $$0, csx $$1, djk $$2, atw $$3, dxe $$4, crm $$5, hx $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ib.a.d()]);
         }

         dzv.v $$7 = this.B.b[ib.b.d()];
         if ($$7.b[ib.b.d()] == null) {
   ...
   public static class n extends dzv.r {
      public n(ib $$0, dzv.v $$1) {
         super(dyd.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(csz $$0, csx $$1, djk $$2, atw $$3, dxe $$4, crm $$5, hx $$6) {
         dzv.v $$7 = this.B.b[ib.c.d()];
         dzv.v $$8 = this.B;
         dzv.v $$9 = $$7.b[ib.b.d()];
         dzv.v $$10 = $$8.b[ib.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ib.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ib.a.d()]);
         }
   ...
   public static class o extends dzv.r {
      public o(ib $$0, dzv.v $$1) {
         super(dyd.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dzv.r {
      public p(ib $$0, dzv.v $$1) {
         super(dyd.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dzv.r {
      public q(ib $$0, dxe $$1) {
         super(dyd.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dxq {
      protected static final dhn b = cvh.hZ.o();
      protected static final dhn c = cvh.ia.o();
      protected static final dhn d = cvh.ib.o();
      protected static final dhn h = c;
      protected static final dhn i = cvh.ii.o();
      protected static final boolean j = true;
      protected static final dhn k = cvh.G.o();
      protected static final Set<cvf> l = ImmutableSet.builder().add(cvh.dO).add(cvh.iC).add(cvh.mW).add(k.b()).build();
      ...
      public r(dyd $$0, ib $$1, int $$2, dxe $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dyd $$0, int $$1, ib $$2, dzv.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dxe a(ib $$0, dzv.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dxe $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(csz $$0, dxe $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dhn $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(csz $$0, dxe $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(csz $$0, dxe $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dhn $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dxe $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(csz $$0, dxe $$1, int $$2, int $$3, int $$4) {
         hx $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cbc $$6 = bkz.A.a((csf)$$0.D());
            if ($$6 != null) {
               $$6.b($$6.eN());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dn()), blp.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dzv.r {
      private int a;

      public s(ib $$0, dzv.v $$1, atw $$2) {
         super(dyd.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(csz $$0, csx $$1, djk $$2, atw $$3, dxe $$4, crm $$5, hx $$6) {
         ...
         if (this.B.b[ib.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ib.a.d()] && !this.B.c[ib.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends dzv.r {
      public t(ib $$0, dzv.v $$1) {
         super(dyd.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dzv.r {
      private int a;

      public u(ib $$0, dxe $$1, int $$2) {
         super(dyd.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
