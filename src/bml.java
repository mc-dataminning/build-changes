...
public class bml<E extends bjp> extends bkx<E> {
   ...
   private final bts h;
   private final int i;
   private final Function<E, apc> j;
   private Optional<Long> k = Optional.empty();
   private Optional<bml.a> l = Optional.empty();

   public bml(ToIntFunction<E> $$0, int $$1, int $$2, float $$3, bts $$4, int $$5, Function<E, apc> $$6) {
   ...
   protected void a(akq $$0, bjp $$1, long $$2) {
      bkg<?> $$3 = $$1.dN();
   ...
   protected boolean c(akq $$0, bjp $$1, long $$2) {
         ...
         if ($$3) {
            ...
            if ($$4.equals(this.l.get().a())) {
               ...
               if ($$2 - this.k.get() >= (long)this.i) {
                  ...
                  $$0.a(null, $$1, this.j.apply($$1), ape.g, 1.0F, $$1.eW());
   ...
   private ehn a(gw $$0, gw $$1) {
      double $$2 = 0.5;
      double $$3 = 0.5 * (double)arw.j((double)($$1.u() - $$0.u()));
      double $$4 = 0.5 * (double)arw.j((double)($$1.w() - $$0.w()));
