...
public abstract class bml extends blv implements blt {
   ...
   private static final bnp bA = new bnp(UUID.fromString("662A6B8D-DA3E-4C1C-8813-96EA6097278D"), "Sprinting speed boost", 0.3F, bnp.a.c);
   ...
   protected static final agm<Byte> t = agp.a(bml.class, ago.a);
   private static final agm<Float> bH = agp.a(bml.class, ago.d);
   private static final agm<Integer> bI = agp.a(bml.class, ago.b);
   private static final agm<Boolean> bJ = agp.a(bml.class, ago.k);
   private static final agm<Integer> bK = agp.a(bml.class, ago.b);
   private static final agm<Integer> bL = agp.a(bml.class, ago.b);
   private static final agm<Optional<hx>> bM = agp.a(bml.class, ago.o);
   protected static final float u = 1.74F;
   protected static final blw v = blw.c(0.2F, 0.2F);
   public static final float aE = 0.5F;
   private final bno bN;
   private final bkq bO = new bkq(this);
   private final Map<blg, bli> bP = Maps.newHashMap();
   private final iq<cmy> bQ = iq.a(2, cmy.f);
   private final iq<cmy> bR = iq.a(4, cmy.f);
   public boolean aF;
   ...
   protected bml(blz<? extends bml> $$0, ctp $$1) {
      super($$0, $$1);
      this.bN = new bno(bns.a($$0));
      this.c(this.eM());
      this.I = true;
   ...
   protected bnl.b<?> dP() {
      return bnl.a(ImmutableList.of(), ImmutableList.of());
   }
   ...
   public static bnq.a dQ() {
      return bnq.a().a(bnr.l).a(bnr.i).a(bnr.m).a(bnr.a).a(bnr.b).a(bnr.k);
   }
   ...
   protected void a(double $$0, boolean $$1, djh $$2, hx $$3) {
      ...
      if (!this.dM().B && this.ab > 3.0F && $$1 && !$$2.i()) {
         ...
         float $$11 = (float)auo.f(this.ab - 3.0F);
   ...
   public final boolean dR() {
      return this.ai().a(ask.m);
   }

   public float a(float $$0) {
      return auo.i($$0, this.cg, this.cf);
   }
         ...
         if (!this.dM().B) {
            if (this.by()) {
               ...
               if ($$1 < 0.0) {
                  ...
                  if ($$2 > 0.0) {
                     this.a(this.dN().v(), (float)Math.max(1, auo.a(-$$1 * $$2)));
                  }
               }
            }
         }

         if (this.a(asm.a) && !this.dM().a_(hx.a(this.dr(), this.dv(), this.dx())).a(cws.nd)) {
            boolean $$3 = !this.dR() && !blj.c(this) && (!$$0 || !((cfi)this).fT().a);
            if ($$3) {
   ...
   public boolean dS() {
      return this.ah % 5 == 0 && this.dp().c != 0.0 && this.dp().e != 0.0 && !this.P_() && crl.k(this) && this.dU();
   }
   ...
   protected void dT() {
      ...
      this.a(ars.wT, $$1, 0.6F + this.ag.i() * 0.4F);
   }

   protected boolean dU() {
      return this.dM().a_(this.aI()).a(ash.aM);
   }

   @Override
   protected float aL() {
      return this.dU() && crl.a(crn.l, this) > 0 ? 1.0F : super.aL();
   }

   @Override
   protected boolean c(djh $$0) {
      return !$$0.i() || this.fw();
   }
   ...
   protected void dW() {
      if (!this.bj().i()) {
         ...
         if ($$0 > 0 && this.dU()) {
            ...
            $$1.b(new bnp(d, "Soul speed boost", (double)(0.03F * (1.0F + (float)$$0 * 0.35F)), bnp.a.a));
            if (this.eg().i() < 0.04F) {
               cmy $$2 = this.c(bma.c);
               $$2.a(1, this, $$0x -> $$0x.d(bma.c));
            }
         }
      }
   }
   ...
   protected void dY() {
      if (!this.bj().i()) {
         ...
         if ($$0 > 0) {
            ...
            $$1.b(new bnp(e, "Powder snow slow", (double)$$2, bnp.a.a));
         }
      }
   }

   protected void c(hx $$0) {
      int $$1 = crl.a(crn.j, this);
      if ($$1 > 0) {
         crq.a(this, this.dM(), $$0, $$1);
      }
   ...
   protected boolean a(bma $$0) {
      return true;
   }

   public void a(bma $$0, cmy $$1, cmy $$2) {
      boolean $$3 = $$2.b() && $$1.b();
      if (!$$3 && !cmy.c($$1, $$2) && !this.am) {
         clz $$4 = clz.c_($$2);
   ...
   protected void en() {
      Iterator<blg> $$0 = this.bP.keySet().iterator();
   ...
   protected void J() {
      if (this.bP.isEmpty()) {
         ...
         Collection<bli> $$0 = this.bP.values();
         this.an.b(bJ, c($$0));
         this.an.b(bI, coy.a($$0));
         this.j(this.a(blk.n));
      }
   }
   ...
   public double B(@Nullable blv $$0) {
      double $$1 = 1.0;
      if (this.bV()) {
         $$1 *= 0.8;
      }
   ...
   public boolean c(bml $$0) {
      return $$0 instanceof cfi && this.dM().ak() == bjy.a ? false : $$0.eo();
   }

   public boolean a(bml $$0, bwz $$1) {
      return $$1.a(this, $$0);
   }
   ...
   public static boolean c(Collection<bli> $$0) {
      for (bli $$1 : $$0) {
         if ($$1.g() && !$$1.f()) {
            return false;
         }
   ...
   public boolean er() {
      if (this.dM().B) {
         ...
         Iterator<bli> $$0 = this.bP.values().iterator();
   ...
   public Collection<bli> es() {
      return this.bP.values();
   }

   public Map<blg, bli> et() {
      return this.bP;
   }
   ...
   public void c(bli $$0, @Nullable blv $$1) {
      if (this.c($$0)) {
         bli $$2 = this.bP.put($$0.c(), $$0);
         if ($$2 == null) {
            this.a($$0, $$1);
         } else {
            this.a($$0, true, $$1);
   ...
   public void c(float $$0) {
      this.an.b(bH, auo.a($$0, 0.0F, this.eM()));
   }
   ...
   public boolean a(bkt $$0, float $$1) {
      if (this.b($$0)) {
         ...
         return false;
      } else if ($$0.a(asj.j) && this.a(blk.l)) {
         return false;
      } else {
         ...
         if ($$1 > 0.0F && this.f($$0)) {
            ...
            $$4 = $$1;
            $$1 = 0.0F;
            if (!$$0.a(asj.k) && $$0.c() instanceof bml $$6) {
               this.d($$6);
            }
         ...
         if ($$0.a(asj.p) && this.ai().a(ask.l)) {
            $$1 *= 5.0F;
         }

         this.aQ.a(1.5F);
         boolean $$7 = true;
         if ((float)this.al > 10.0F && !$$0.a(asj.f)) {
            if ($$1 <= this.bi) {
               return false;
            }
         ...
         blv $$8 = $$0.d();
         if ($$8 != null) {
            if ($$8 instanceof bml $$9 && !$$0.a(asj.r)) {
               this.a($$9);
            }

            if ($$8 instanceof cfi $$10) {
               this.aZ = 100;
               this.aY = $$10;
            } else if ($$8 instanceof bzb $$11 && $$11.u()) {
               this.aZ = 100;
               if ($$11.R_() instanceof cfi $$12) {
                  this.aY = $$12;
               } else {
                  this.aY = null;
               }
         ...
         if (this instanceof ane) {
            ...
            if ($$4 > 0.0F && $$4 < 3.4028235E37F) {
               ((ane)this).a(asc.K, Math.round($$4 * 10.0F));
            }
         }
   ...
   private boolean h(bkt $$0) {
      if ($$0.a(asj.e)) {
         return false;
      } else {
         cmy $$1 = null;

         for (bka $$2 : bka.values()) {
            cmy $$3 = this.b($$2);
            if ($$3.a(cnb.vm)) {
               $$1 = $$3.p();
               $$3.h(1);
         ...
         if ($$1 != null) {
            ...
            this.c(1.0F);
            this.er();
            this.b(new bli(blk.j, 900, 1));
            this.b(new bli(blk.v, 100, 1));
            this.b(new bli(blk.l, 800, 0));
   ...
   public boolean f(bkt $$0) {
      blv $$1 = $$0.c();
      boolean $$2 = false;
      if ($$1 instanceof cfo $$3 && $$3.E() > 0) {
         $$2 = true;
      }

      if (!$$0.a(asj.d) && this.fu() && !$$2) {
         elt $$4 = $$0.h();
         if ($$4 != null) {
            elt $$5 = this.b(0.0F, this.cp());
            elt $$6 = $$4.a(this.dk());
            $$6 = new elt($$6.c, 0.0, $$6.e).d();
            return $$6.b($$5) < 0.0;
         }
      }
   ...
   private void i(cmy $$0) {
      if (!$$0.b()) {
         if (!this.aU()) {
            this.dM().a(this.dr(), this.dt(), this.dx(), ars.mN, this.db(), 0.8F, 0.8F + this.dM().z.i() * 0.4F, false);
         }
   ...
   protected void f(@Nullable bml $$0) {
      if (!this.dM().B) {
         boolean $$1 = false;
         if ($$0 instanceof cbi) {
            if (this.dM().Z().b(ctl.c)) {
               hx $$2 = this.dm();
               djh $$3 = cws.cd.o();
               if (this.dM().a_($$2).i() && $$3.a((cts)this.dM(), $$2)) {
                  this.dM().a($$2, $$3, 3);
                  $$1 = true;
               }
            }
            ...
            if (!$$1) {
               cbu $$4 = new cbu(this.dM(), this.dr(), this.dt(), this.dx(), new cmy(cnb.dv));
               this.dM().b($$4);
            }
         }
      }
   ...
   protected void ez() {
      if (this.dM() instanceof and && !this.eD() && (this.ef() || this.aZ > 0 && this.ec() && this.dM().Z().b(ctl.f))) {
         bmb.a((and)this.dM(), this.dk(), this.ee());
      }
   }
   ...
   protected void a(bkt $$0, boolean $$1) {
      ahg $$2 = this.eA();
      ehe $$3 = this.dM().o().aJ().getLootTable($$2);
      ehc.a $$4 = new ehc.a((and)this.dM()).a(ejh.a, this).a(ejh.f, this.dk()).a(ejh.c, $$0).b(ejh.d, $$0.d()).b(ejh.e, $$0.c());
      if ($$1 && this.aY != null) {
         $$4 = $$4.a(ejh.b, this.aY).a(this.aY.go());
      }
   ...
   public bml.a eG() {
      return new bml.a(ars.jD, ars.jv);
   }
   ...
   public boolean e_() {
      if (this.P_()) {
         ...
         if ($$1.a(ash.aO)) {
            ...
            return true;
         } else if ($$1.b() instanceof dfc && this.c($$0, $$1)) {
            this.cc = Optional.of($$0);
            return true;
         } else {
            return false;
   ...
   private boolean c(hx $$0, djh $$1) {
      if ($$1.c(dfc.b)) {
         djh $$2 = this.dM().a_($$0.d());
         if ($$2.a(cws.cO) && $$2.c(dav.b) == $$1.c(dfc.aE)) {
            return true;
         }
      }
   ...
   protected void eI() {
      if (!this.aU()) {
         int $$0 = auo.a(this.dr());
         int $$1 = auo.a(this.dt() - 0.2F);
         int $$2 = auo.a(this.dx());
         djh $$3 = this.dM().a_(new hx($$0, $$1, $$2));
         if (!$$3.i()) {
            dec $$4 = $$3.w();
   ...
   public int eJ() {
      return auo.a(this.b(bnr.a));
   }

   protected void b(bkt $$0, float $$1) {
   }

   protected void c(bkt $$0, float $$1) {
   }

   protected void u(float $$0) {
   }

   protected float d(bkt $$0, float $$1) {
      if (!$$0.a(asj.c)) {
         this.b($$0, $$1);
         $$1 = bkp.a($$1, (float)this.eJ(), (float)this.b(bnr.b));
      }
   ...
   protected float e(bkt $$0, float $$1) {
      if ($$0.a(asj.g)) {
         ...
         if (this.a(blk.k) && !$$0.a(asj.h)) {
            int $$2 = (this.b(blk.k).e() + 1) * 5;
            int $$3 = 25 - $$2;
            float $$4 = $$1 * (float)$$3;
            float $$5 = $$1;
            ...
            if ($$6 > 0.0F && $$6 < 3.4028235E37F) {
               if (this instanceof ane) {
                  ((ane)this).a(asc.M, Math.round($$6 * 10.0F));
               } else if ($$0.d() instanceof ane) {
                  ((ane)$$0.d()).a(asc.I, Math.round($$6 * 10.0F));
               }
            }
         }
   ...
   public final float eM() {
      return (float)this.b(bnr.l);
   }

   public final float eN() {
      return (float)this.b(bnr.k);
   }
   ...
   private int B() {
      if (blj.a(this)) {
         return 6 - (1 + blj.b(this));
      } else {
         return this.a(blk.d) ? 6 + (1 + this.b(blk.d).e()) * 2 : 6;
      }
   }
   ...
   public void b(byte $$0) {
      switch ($$0) {
         case 3:
            ...
            break;
         case 29:
            this.a(ars.vG, 1.0F, 0.8F + this.dM().z.i() * 0.4F);
            break;
         case 30:
            this.a(ars.vH, 0.8F, 0.8F + this.dM().z.i() * 0.4F);
            break;
         case 46:
            int $$2 = 128;
            ...
            for (int $$3 = 0; $$3 < 128; $$3++) {
               ...
               double $$8 = auo.d($$4, this.K, this.dr()) + (this.ag.j() - 0.5) * (double)this.dg() * 2.0;
               double $$9 = auo.d($$4, this.L, this.dt()) + this.ag.j() * (double)this.dh();
               double $$10 = auo.d($$4, this.M, this.dx()) + (this.ag.j() - 0.5) * (double)this.dg() * 2.0;
   ...
   public boolean b(cmt $$0) {
      return this.b($$1 -> $$1.a($$0));
   }

   public boolean b(Predicate<cmy> $$0) {
   ...
   public boolean b(bma $$0) {
      return !this.c($$0).b();
   }

   @Override
   public abstract Iterable<cmy> bL();

   public abstract cmy c(bma var1);

   @Override
   public abstract void a(bma var1, cmy var2);

   protected void e(cmy $$0) {
      sn $$1 = $$0.v();
      if ($$1 != null) {
         $$0.d().b($$1);
      }
   ...
   private void a(blv $$0) {
      ...
      if (this.dH()) {
         $$1 = this.dk();
      } else if (!$$0.dH() && !this.dM().a_($$0.dm()).a(ash.aI)) {
         $$1 = $$0.b(this);
      } else {
         double $$2 = Math.max(this.dt(), $$0.dt());
         $$1 = new elt(this.dr(), $$2, this.dx());
      }
   ...
   public float fa() {
      return this.a(blk.h) ? 0.1F * ((float)this.b(blk.h).e() + 1.0F) : 0.0F;
   }
   ...
   protected void fb() {
      ...
      if (this.bY()) {
         ...
         this.g(this.dp().b((double)(-auo.a($$1) * 0.2F), 0.0, (double)(auo.b($$1) * 0.2F)));
      }
   ...
   public void a(elt $$0) {
      if (this.cX()) {
         ...
         if (this.aZ() && this.ea() && !this.a($$3)) {
            ...
            elt $$8 = this.dp();
            if (this.P && this.e_()) {
               $$8 = new elt($$8.c, 0.2, $$8.e);
            }

            this.g($$8.d((double)$$5, 0.8F, (double)$$5));
            elt $$9 = this.a($$1, $$2, this.dp());
            this.g($$9);
            ...
            this.a(0.02F, $$0);
            this.a(bmr.a, this.dp());
            if (this.b(asm.b) <= this.df()) {
               this.g(this.dp().d(0.5, 0.8F, 0.5));
               elt $$11 = this.a($$1, $$2, this.dp());
               this.g($$11);
            } else {
            ...
            if ($$15 < 0.0F && $$16 > 0.0) {
               double $$21 = $$17 * (double)(-auo.a($$15)) * 0.04;
            ...
            double $$29 = $$28.d;
            if (this.a(blk.y)) {
               $$29 += (0.05 * (double)(this.b(blk.y).e() + 1) - $$28.d) * 0.2;
      ...
      this.q(this instanceof byh);
   }

   private void c(cfi $$0, elt $$1) {
      elt $$2 = this.b($$0, $$1);
      this.a($$0, $$2);
      if (this.cX()) {
         this.w(this.e($$0));
   ...
   public void q(boolean $$0) {
      float $$1 = (float)auo.g(this.dr() - this.K, $$0 ? this.dt() - this.L : 0.0, this.dx() - this.M);
      this.v($$1);
   }
   ...
   public elt a(elt $$0, float $$1) {
      ...
      this.a(bmr.a, this.dp());
      elt $$2 = this.dp();
      if ((this.P || this.bj) && (this.e_() || this.dn().a(cws.qP) && dcj.a(this))) {
         $$2 = new elt($$2.c, 0.2, $$2.e);
      }

      return $$2;
   }

   public elt a(double $$0, boolean $$1, elt $$2) {
      if (!this.aV() && !this.bY()) {
         double $$3;
   ...
   private elt j(elt $$0) {
      if (this.e_()) {
         this.n();
         float $$1 = 0.15F;
         double $$2 = auo.a($$0.c, -0.15F, 0.15F);
         double $$3 = auo.a($$0.e, -0.15F, 0.15F);
         double $$4 = Math.max($$0.d, -0.15F);
         if ($$4 < 0.0 && !this.dn().a(cws.nS) && this.fv() && this instanceof cfi) {
            $$4 = 0.0;
         }
   ...
   protected float fe() {
      return this.cN() instanceof cfi ? this.ff() * 0.1F : 0.02F;
   }
   ...
   public void l() {
      ...
      if ($$4 > 0.0025000002F) {
         ...
         float $$8 = (float)auo.d($$3, $$2) * (180.0F / (float)Math.PI) - 90.0F;
         float $$9 = auo.e(auo.g(this.dC()) - $$8);
         if (95.0F < $$9 && $$9 < 265.0F) {
            $$5 = $$8 - 180.0F;
         } else {
            $$5 = $$8;
   ...
   private void a(Map<bma, cmy> $$0) {
      cmy $$1 = $$0.get(bma.a);
      cmy $$2 = $$0.get(bma.b);
      if ($$1 != null && $$2 != null && cmy.a($$1, this.f(bma.b)) && cmy.a($$2, this.f(bma.a))) {
   ...
   private void b(Map<bma, cmy> $$0) {
      List<Pair<bma, cmy>> $$1 = Lists.newArrayListWithCapacity($$0.size());
      $$0.forEach(($$1x, $$2) -> {
         cmy $$3 = $$2.p();
         $$1.add(Pair.of($$1x, $$3));
         switch ($$1x.a()) {
   ...
   private void c(bma $$0, cmy $$1) {
      this.bQ.set($$0.b(), $$1);
   }

   protected float e(float $$0, float $$1) {
      float $$2 = auo.g($$0 - this.aU);
      this.aU += $$2 * 0.3F;
      float $$3 = auo.g(this.dC() - this.aU);
      float $$4 = this.fg();
      if (Math.abs($$3) > $$4) {
         this.aU = this.aU + ($$3 - (float)auo.j((double)$$3) * $$4);
      }
   ...
   public void d_() {
      ...
      this.H();
      elo $$8 = this.cH();
      elt $$9 = new elt((double)this.bk, (double)this.bl, (double)this.bm);
      if (this.a(blk.B) || this.a(blk.y)) {
         this.n();
      }

      label104: {
         if (this.cN() instanceof cfi $$10 && this.bx()) {
            this.c($$10, $$9);
            break label104;
         }
   ...
   private void H() {
      boolean $$0 = this.i(7);
      if ($$0 && !this.aC() && !this.bO() && !this.a(blk.y)) {
         cmy $$1 = this.c(bma.e);
         if ($$1.a(cnb.nS) && cls.d($$1)) {
            $$0 = true;
            int $$2 = this.bx + 1;
            if (!this.dM().B && $$2 % 10 == 0) {
               int $$3 = $$2 / 10;
               if ($$3 % 2 == 0) {
                  $$1.a(1, this, $$0x -> $$0x.d(bma.e));
               }
   ...
   protected void M_() {
      if (this.dM().y_()) {
         this.dM().a(dnf.a(cfi.class), this.cH(), bly.a(this)).forEach(this::D);
      } else {
         List<blv> $$0 = this.dM().a(this, this.cH(), bly.a(this));
         if (!$$0.isEmpty()) {
            int $$1 = this.dM().Z().c(ctl.u);
   ...
   protected void a(elo $$0, elo $$1) {
      elo $$2 = $$0.b($$1);
      List<blv> $$3 = this.dM().a_(this, $$2);
      if (!$$3.isEmpty()) {
         for (blv $$4 : $$3) {
            if ($$4 instanceof bml) {
               this.g((bml)$$4);
   ...
   public void a(blv $$0, int $$1) {
      if (!$$0.dH() && !this.dM().B && ($$0 instanceof cbu || $$0 instanceof cfo || $$0 instanceof bmb)) {
   ...
   public boolean E(blv $$0) {
      if ($$0.dM() != this.dM()) {
         ...
         elt $$1 = new elt(this.dr(), this.dv(), this.dx());
         elt $$2 = new elt($$0.dr(), $$0.dv(), $$0.dx());
         return $$2.f($$1) > 128.0 ? false : this.dM().a(new csy($$1, $$2, csy.a.a, csy.b.a, this)).c() == elr.a.a;
      }
   }

   @Override
   public float h(float $$0) {
      return $$0 == 1.0F ? this.aW : auo.i($$0, this.aX, this.aW);
   }
   ...
   public static elt i(elt $$0) {
      return new elt($$0.c, $$0.d, 0.0);
   }
   ...
   public bka fo() {
      return (this.an.b(t) & 2) > 0 ? bka.b : bka.a;
   }

   private void I() {
      if (this.fn()) {
         if (cmy.b(this.b(this.fo()), this.bv)) {
   ...
   private void a(cmy $$0, int $$1) {
      for (int $$2 = 0; $$2 < $$1; $$2++) {
         ...
         elt $$5 = new elt(((double)this.ag.i() - 0.5) * 0.3, $$4, 0.6);
   ...
   public boolean fu() {
      if (this.fn() && !this.bv.b()) {
         cmt $$0 = this.bv.d();
         return $$0.c(this.bv) != cos.d ? false : $$0.b(this.bv) - this.bw >= 5;
      } else {
         return false;
      }
   }
   ...
   @Override
   public boolean ca() {
      return super.ca() || !this.fw() && this.c(bmx.b);
   }
   ...
   @Override
   public blw a(bmx $$0) {
      return $$0 == bmx.c ? v : super.a($$0).a(this.dZ());
   }

   public ImmutableList<bmx> fA() {
      return ImmutableList.of(bmx.a);
   }

   public elo e(bmx $$0) {
      blw $$1 = this.a($$0);
      return new elo((double)(-$$1.a / 2.0F), 0.0, (double)(-$$1.a / 2.0F), (double)($$1.a / 2.0F), (double)$$1.b, (double)($$1.a / 2.0F));
   }

   protected boolean f(bmx $$0) {
      elo $$1 = this.a($$0).a(this.dk());
   ...
   public void b(hx $$0) {
      ...
      djh $$1 = this.dM().a_($$0);
      if ($$1.b() instanceof cwj) {
         this.dM().a($$0, $$1.a(cwj.c, Boolean.valueOf(true)), 3);
      }
   ...
   private boolean N() {
      return this.fB().map($$0 -> this.dM().a_($$0).b() instanceof cwj).orElse(false);
   }
   ...
   public void fE() {
      this.fB().filter(this.dM()::B).ifPresent($$0x -> {
         ...
         if ($$1.b() instanceof cwj) {
            ic $$2 = $$1.c(cwj.aE);
            this.dM().a($$0x, $$1.a(cwj.c, Boolean.valueOf(false)), 3);
            elt $$3 = cwj.a(this.ai(), this.dM(), $$0x, $$2, this.dC()).orElseGet(() -> {
               hx $$1x = $$0x.c();
               return new elt((double)$$1x.u() + 0.5, (double)$$1x.v() + 0.1, (double)$$1x.w() + 0.5);
            });
            elt $$4 = elt.c($$0x).d($$3).d();
            float $$5 = (float)auo.d(auo.d($$4.e, $$4.c) * 180.0F / (float)Math.PI - 90.0);
            this.a_($$3.c, $$3.d, $$3.e);
            this.r($$5);
            this.s(0.0F);
         }
   ...
   public ic fF() {
      ...
      return $$0 != null ? cwj.a(this.dM(), $$0) : null;
   }
   ...
   @Override
   protected final float a(bmx $$0, blw $$1) {
      return $$0 == bmx.c ? 0.2F : this.b($$0, $$1);
   }
   ...
   public cmy a(ctp $$0, cmy $$1) {
      if ($$1.M()) {
         $$0.a(null, this.dr(), this.dt(), this.dx(), this.d($$1), art.g, 1.0F, 1.0F + ($$0.z.i() - $$0.z.i()) * 0.4F);
         this.a($$1, $$0, this);
         if (!(this instanceof cfi) || !((cfi)this).fT().d) {
            $$1.h(1);
         }
   ...
   private void a(cmy $$0, ctp $$1, bml $$2) {
      cmt $$3 = $$0.d();
      if ($$3.u()) {
         for (Pair<bli, Float> $$5 : $$3.v().f()) {
            if (!$$1.B && $$5.getFirst() != null && $$1.z.i() < (Float)$$5.getSecond()) {
               $$2.b(new bli((bli)$$5.getFirst()));
            }
         }
      }
   }

   private static byte g(bma $$0) {
      switch ($$0) {
         case a:
            return 47;
         case b:
   ...
   public void d(bka $$0) {
      this.d($$0 == bka.a ? bma.a : bma.b);
   }

   @Override
   public elo i_() {
      if (this.c(bma.f).a(cnb.uj)) {
         float $$0 = 0.5F;
   ...
   public static bma h(cmy $$0) {
      clz $$1 = clz.c_($$0);
      return $$1 != null ? $$1.g() : bma.a;
   }

   private static bnd a(bml $$0, bma $$1) {
      return $$1 != bma.f && $$1 != bma.a && $$1 != bma.b ? bnd.a($$0, $$1, $$1x -> $$1x.b() || bmn.h($$1x) == $$1) : bnd.a($$0, $$1);
   }

   @Nullable
   private static bma r(int $$0) {
      if ($$0 == 100 + bma.f.b()) {
         return bma.f;
      } else if ($$0 == 100 + bma.e.b()) {
         return bma.e;
      } else if ($$0 == 100 + bma.d.b()) {
         return bma.d;
      } else if ($$0 == 100 + bma.c.b()) {
         return bma.c;
      } else if ($$0 == 98) {
         return bma.a;
      } else {
         return $$0 == 99 ? bma.b : null;
      }
   }
   ...
   public boolean dA() {
      if (this.P_()) {
         ...
         boolean $$0 = !this.c(bma.f).a(asp.az) && !this.c(bma.e).a(asp.az) && !this.c(bma.d).a(asp.az) && !this.c(bma.c).a(asp.az);
         return $$0 && super.dA();
      }
   }
   ...
   @Override
   public boolean cd() {
      return !this.dM().y_() && this.a(blk.x) || super.cd();
   }
   ...
   public boolean fG() {
      return this.eT().d() instanceof ckn;
   }

   @Override
   public float dG() {
      float $$0 = super.dG();
      return this.cN() instanceof cfi ? Math.max($$0, 1.0F) : $$0;
   }

   @Override
   public elt m(blv $$0) {
      return new elt(this.a($$0, this.a(this.ap()), this.dZ()).rotateY(-this.aU * (float) (Math.PI / 180.0))).e(this.dk());
   }
   ...
   protected void a(int $$0, double $$1) {
      this.aW = (float)auo.e(1.0 / (double)$$0, (double)this.aW, $$1);
   }

   public static record a(arr a, arr b) {
   }
}
