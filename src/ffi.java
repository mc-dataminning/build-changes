...
public class ffi {
   ...
   public ffi(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ffj> $$1) throws IOException {
   ...
   public List<ffj> a(Path $$0) throws IOException {
      List<ffj> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ffj> a(Path $$0, boolean $$1) throws IOException {
      List<ffj> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ffj> $$1) throws IOException {
