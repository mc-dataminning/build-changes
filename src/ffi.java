...
public class ffi implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ffi.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ffi(List<ffi.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ffi a(BufferedReader $$0) {
      return new ffi($$0.lines().flatMap($$0x -> ffi.a.a($$0x).stream()).toList());
   }

   public static record a(ffi.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ffi.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ffi.a(ffi.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ffi.a(ffi.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ffi.a(ffi.b.b, $$3));
      ...
      static ffi.a b(String $$0) {
         return new ffi.a(ffi.b.a, "glob:" + $$0);
      }

      static ffi.a c(String $$0) {
         return new ffi.a(ffi.b.a, "regex:" + $$0);
      }

      static ffi.a d(String $$0) {
         return new ffi.a(ffi.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ffi.b a = FileSystem::getPathMatcher;
      ffi.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
