...
public class fok {
   ...
   public fok(fqs $$0, cpl $$1, int $$2, fns $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, $$2 * 16, this.b.C_() + $$3 * 16, $$4 * 16);
               }
            }
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      fqs.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected fqs.b a(gu $$0) {
      int $$1 = arp.a($$0.v() - this.b.C_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = arp.b(arp.a($$0.u(), 16), this.d);
         int $$3 = arp.b(arp.a($$0.w(), 16), this.e);
