...
public class fok extends fmx<cqw> {
   private static final akn D = new akn("container/stonecutter/scroller");
   private static final akn E = new akn("container/stonecutter/scroller_disabled");
   private static final akn F = new akn("container/stonecutter/recipe_selected");
   private static final akn G = new akn("container/stonecutter/recipe_highlighted");
   private static final akn H = new akn("container/stonecutter/recipe");
   private static final akn I = new akn("textures/gui/container/stonecutter.png");
   ...
   private void b(ffn $$0, int $$1, int $$2, int $$3) {
      List<cxy<cyq>> $$4 = this.w.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.S = ayf.a(this.S - $$5, 0.0F, 1.0F);
