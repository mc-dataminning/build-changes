public class fok extends fga<fok.a> {
   static final akh a = new akh("transferable_list/select_highlighted");
   static final akh m = new akh("transferable_list/select");
   static final akh n = new akh("transferable_list/unselect_highlighted");
   static final akh o = new akh("transferable_list/unselect");
   static final akh p = new akh("transferable_list/move_up_highlighted");
   static final akh q = new akh("transferable_list/move_up");
   static final akh r = new akh("transferable_list/move_down_highlighted");
   static final akh s = new akh("transferable_list/move_down");
   static final wu u = wu.c("pack.incompatible");
   static final wu v = wu.c("pack.incompatible.confirm.title");
   private final wu w;
   final foj x;

   public fok(fde $$0, foj $$1, int $$2, int $$3, wu $$4) {
      super($$0, $$2, $$3, 33, 36);
      this.x = $$1;
      this.w = $$4;
      this.e = false;
   ...
   public static class a extends fga.a<fok.a> {
      ...
      private static axl a(fde $$0, wu $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static ffx b(fde $$0, wu $$1) {
         return ffx.a($$0.h, $$1, 157, 2);
      }
