...
public class fok extends avg<Map<String, List<fok.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<fok.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(fok.a::a),
                     Codec.LONG.fieldOf("period").forGetter(fok.a::b),
                     Codec.STRING.fieldOf("title").forGetter(fok.a::c),
                     Codec.STRING.fieldOf("message").forGetter(fok.a::d)
                  )
                  .apply($$0, fok.a::new)
         )
         .listOf()
   ...
   public fok(ale $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<fok.a>> a(avb $$0, bqj $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<fok.a>> $$0, avb $$1, bqj $$2) {
      List<fok.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<fok.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<fok.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<fok.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public fok.b a(List<fok.a> $$0, long $$1) {
         this.cancel();
         return new fok.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (fok.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> ftz.a(fof.Q().aA(), ftz.a.g, ww.a($$2.c, $$3), ww.a($$2.d, $$3)));
                  return;
               }
            }
         }
