...
public class aid {
   ...
   private static int a(du $$0, fz $$1, Collection<alr> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = $$1.a().l();
      int $$5 = $$4 * 100;
      ckj $$6 = $$1.a($$3, false);
      if ($$3 > $$5) {
         $$0.b(ui.a("commands.give.failed.toomanyitems", $$5, $$6.J()));
         return 0;
      } else {
         for (alr $$7 : $$2) {
            int $$8 = $$3;
            ...
            while ($$8 > 0) {
               ...
               if ($$11 && $$10.b()) {
                  ...
                  $$7.dL().a(null, $$7.dq(), $$7.ds(), $$7.dw(), aqd.mc, aqe.h, 0.2F, (($$7.ef().i() - $$7.ef().i()) * 0.7F + 1.0F) * 2.0F);
                  $$7.bS.d();
               } else {
                  bzq $$12 = $$7.a($$10, false);
                  if ($$12 != null) {
         ...
         if ($$2.size() == 1) {
            $$0.a(() -> ui.a("commands.give.success.single", $$3, $$6.J(), $$2.iterator().next().O_()), true);
         } else {
            $$0.a(() -> ui.a("commands.give.success.single", $$3, $$6.J(), $$2.size()), true);
         }
