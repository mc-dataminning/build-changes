...
public interface dcb extends dbb, dbi, dco, dcz.a {
   @Nullable
   dty a(int var1, int var2, dux var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dxu.a var1, int var2, int var3);

   int B_();

   dcz F_();

   default ji<dcx> t(iz $$0) {
      return this.F_().a($$0);
   }

   default Stream<dsc> c(evm $$0) {
      int $$1 = ayz.a($$0.a);
      int $$2 = ayz.a($$0.d);
      int $$3 = ayz.a($$0.b);
      int $$4 = ayz.a($$0.e);
   ...
   @Override
   default int a(iz $$0, dbj $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ji<dcx> getNoiseBiome(int $$0, int $$1, int $$2) {
      dty $$3 = this.a(jt.e($$0), jt.e($$2), dux.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ji<dcx> a(int var1, int var2, int var3);
   ...
   default dty a(int $$0, int $$1) {
      return this.a($$0, $$1, dux.n, true);
   }

   default dty a(int $$0, int $$1, dux $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbe c(int $$0, int $$1) {
   ...
   default <T> jk<T> a(ale<? extends jv<? extends T>> $$0) {
      jv<T> $$1 = this.H_().d($$0);
      return $$1.p().a(this.J());
   }
}
