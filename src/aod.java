...
public class aod {
               ...
               eq.a("template")
                  .then(
                     ((RequiredArgumentBuilder)eq.a("template", fq.a())
                           .suggests(f)
                           .executes($$0x -> a((ep)$$0x.getSource(), fq.c($$0x, "template"), iz.a(((ep)$$0x.getSource()).d()), dln.a, djx.a, 1.0F, 0)))
                        .then(
                           ((RequiredArgumentBuilder)eq.a("pos", gl.a())
                                 .executes($$0x -> a((ep)$$0x.getSource(), fq.c($$0x, "template"), gl.a($$0x, "pos"), dln.a, djx.a, 1.0F, 0)))
                              .then(
                                 ((RequiredArgumentBuilder)eq.a("rotation", gd.a())
                                       .executes(
                                          $$0x -> a((ep)$$0x.getSource(), fq.c($$0x, "template"), gl.a($$0x, "pos"), gd.a($$0x, "rotation"), djx.a, 1.0F, 0)
                                       ))
                                    .then(
   ...
   public static int a(ep $$0, ji.c<eam<?, ?>> $$1, iz $$2) throws CommandSyntaxException {
      arf $$3 = $$0.e();
      eam<?, ?> $$4 = $$1.a();
      dbg $$5 = new dbg($$2);
      a($$3, new dbg($$5.e - 1, $$5.f - 1), new dbg($$5.e + 1, $$5.f + 1));
   ...
   public static int a(ep $$0, ji<eju> $$1, alf $$2, int $$3, iz $$4) throws CommandSyntaxException {
      arf $$5 = $$0.e();
      dbg $$6 = new dbg($$4);
      a($$5, $$6, $$6);
      if (!ejo.a($$5, $$1, $$2, $$3, $$4, false)) {
         throw b.create();
      } else {
   ...
   public static int b(ep $$0, ji.c<eil> $$1, iz $$2) throws CommandSyntaxException {
      arf $$3 = $$0.e();
      eil $$4 = $$1.a();
      dua $$5 = $$3.l().g();
      eit $$6 = $$4.a($$0.v(), $$5, $$5.d(), $$3.l().i(), $$3.q(), $$3.C(), new dbg($$2), 0, $$3, $$0x -> true);
      if (!$$6.b()) {
         throw c.create();
      } else {
         eid $$7 = $$6.a();
         dbg $$8 = new dbg(kb.a($$7.h()), kb.a($$7.j()));
         dbg $$9 = new dbg(kb.a($$7.k()), kb.a($$7.m()));
         a($$3, $$8, $$9);
         dbg.a($$8, $$9).forEach($$3x -> $$6.a($$3, $$3.a(), $$5, $$3.E_(), new eid($$3x.d(), $$3.I_(), $$3x.e(), $$3x.f(), $$3.am(), $$3x.g()), $$3x));
   ...
   public static int a(ep $$0, alf $$1, iz $$2, dln $$3, djx $$4, float $$5, int $$6) throws CommandSyntaxException {
      arf $$7 = $$0.e();
      emm $$8 = $$7.q();
      ...
      if ($$9.isEmpty()) {
         ...
         eml $$12 = $$9.get();
         a($$7, new dbg($$2), new dbg($$2.a($$12.a())));
         emh $$13 = new emh().a($$4).a($$3);
         if ($$5 < 1.0F) {
            $$13.b().a(new elp($$5)).a(dqx.b((long)$$6));
         }

         boolean $$14 = $$12.a($$7, $$2, $$2, $$13, dqx.b((long)$$6), 2);
         if (!$$14) {
            throw e.create();
         } else {
   ...
   private static void a(arf $$0, dbg $$1, dbg $$2) throws CommandSyntaxException {
      if (dbg.a($$1, $$2).filter($$1x -> !$$0.p($$1x.l())).findAny().isPresent()) {
         throw gl.a.create();
      }
   }
}
