...
public class aod {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xg.c("commands.help.failed"));
                     ...
                     $$1 -> {
                        ...
                        if ($$2.getContext().getNodes().isEmpty()) {
                           ...
                           for (String $$4 : $$3.values()) {
                              ((ek)$$1.getSource()).a(() -> xg.b("/" + $$2.getReader().getString() + " " + $$4), false);
                           }
