...
public interface aod<C, I extends apx<C>> extends apx<C> {
   @aqa
   String a();

   aod<C, I> a(aod.d<I> var1);

   static <C, I extends apx<C>> Codec<aod<C, I>> a(Codec<I> $$0) {
      MutableObject<Codec<aod<C, I>>> $$1 = new MutableObject();
      ...
      Codec<a<C, I>> $$2 = RecordCodecBuilder.create(
         $$1x -> $$1x.group(
                  ...
                  aoi.a($$1::getValue).fieldOf("value").forGetter(a::b),
                  Codec.FLOAT.fieldOf("derivative").forGetter(a::c)
               )
               .apply($$1x, ($$0xx, $$1xx, $$2x) -> new a($$0xx, $$1xx, $$2x))
      );
      Codec<aod.e<C, I>> $$3 = RecordCodecBuilder.create(
         $$2x -> $$2x.group(
                  $$0.fieldOf("coordinate").forGetter(aod.e::d),
                  aoi.a($$2.listOf())
                     .fieldOf("points")
                     .forGetter(
                        $$0xx -> IntStream.range(0, $$0xx.c.length)
                              .mapToObj($$1xx -> new a($$0xx.e()[$$1xx], (aod<C, I>)$$0xx.f().get($$1xx), $$0xx.g()[$$1xx]))
                              .toList()
                     )
               )
               .apply($$2x, ($$0xx, $$1xx) -> {
                  float[] $$2xx = new float[$$1xx.size()];
                  Builder<aod<C, I>> $$3x = ImmutableList.builder();
                  ...
                  return aod.e.a((I)$$0xx, $$2xx, $$3x.build(), $$4);
               })
      );
      $$1.setValue(
         Codec.either(Codec.FLOAT, $$3)
            .xmap(
               $$0x -> (aod)$$0x.map(aod.c::new, $$0xx -> $$0xx), $$0x -> $$0x instanceof aod.c<C, I> $$1x ? Either.left($$1x.d()) : Either.right((aod.e)$$0x)
            )
      );
      return (Codec<aod<C, I>>)$$1.getValue();
   }

   static <C, I extends apx<C>> aod<C, I> a(float $$0) {
      return new aod.c<>($$0);
   }

   static <C, I extends apx<C>> aod.b<C, I> a(I $$0) {
      return new aod.b<>($$0);
   }

   static <C, I extends apx<C>> aod.b<C, I> a(I $$0, apx<Float> $$1) {
      return new aod.b<>($$0, $$1);
   }
   ...
   public static final class b<C, I extends apx<C>> {
      ...
      public aod.b<C, I> a(float $$0, float $$1) {
         return this.a($$0, new aod.c<>(this.b.a($$1)), 0.0F);
      }

      public aod.b<C, I> a(float $$0, float $$1, float $$2) {
         return this.a($$0, new aod.c<>(this.b.a($$1)), $$2);
      }

      public aod.b<C, I> a(float $$0, aod<C, I> $$1) {
         return this.a($$0, $$1, 0.0F);
      }

      private aod.b<C, I> a(float $$0, aod<C, I> $$1, float $$2) {
   ...
   @aqa
   public static record c<C, I extends apx<C>>(float b) implements aod<C, I> {
      @Override
      public float a(C $$0) {
         return this.b;
      }
   ...
   @aqa
   public static record e<C, I extends apx<C>>(I b, float[] c, List<aod<C, I>> d, float[] e, float f, float g) implements aod<C, I> {

      public e(I b, float[] c, List<aod<C, I>> d, float[] e, float f, float g) {
         a(c, d, e);
         this.b = b;
         this.c = c;
         this.d = d;
      ...
      static <C, I extends apx<C>> aod.e<C, I> a(I $$0, float[] $$1, List<aod<C, I>> $$2, float[] $$3) {
         a($$1, $$2, $$3);
         int $$4 = $$1.length - 1;
      ...
      public float a(C $$0) {
         ...
         if ($$2 < 0) {
            ...
            float $$5 = this.c[$$2 + 1];
            float $$6 = ($$1 - $$4) / ($$5 - $$4);
            apx<C> $$7 = (apx<C>)this.d.get($$2);
            apx<C> $$8 = (apx<C>)this.d.get($$2 + 1);
            float $$9 = this.e[$$2];
            float $$10 = this.e[$$2 + 1];
            float $$11 = $$7.a($$0);
            float $$12 = $$8.a($$0);
            ...
            return apa.i($$6, $$11, $$12) + $$6 * (1.0F - $$6) * apa.i($$6, $$13, $$14);
         }
      }

      private static int a(float[] $$0, float $$1) {
         return apa.a(0, $$0.length, $$2 -> $$1 < $$0[$$2]) - 1;
      }
      ...
      public String a() {
         return "Spline{coordinate="
            ...
            + this.a(this.e)
            + ", values="
            + this.d.stream().map(aod::a).collect(Collectors.joining(", ", "[", "]"))
            + "}";
      }
