...
class aod extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aoc && $$1 instanceof aoc && $$0.equals($$1);
   }
   ...
   private static aoc a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aoc) {
         return (aoc)$$0;
      } else {
