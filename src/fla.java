...
public class fla {
   ...
   public void a(fll $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fll.a) {
            frc.b($$1, frc.a.a, wp.c("narrator.toast.disabled"), null);
         } else {
            frc.b($$1, frc.a.a, wp.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         frc.b($$1, frc.a.a, wp.c("narrator.toast.disabled"), wp.c("options.narrator.notavailable"));
      }
   }
