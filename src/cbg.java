...
public abstract class cbg extends blp {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<blp> b = $$0 -> $$0 instanceof cbg;
   private int f;
   protected hx c;
   protected ic d;

   protected cbg(blt<? extends cbg> $$0, cti $$1) {
      super($$0, $$1);
      this.d = ic.d;
   }

   protected cbg(blt<? extends cbg> $$0, cti $$1, hx $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void z() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new elh($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable blp var1);
