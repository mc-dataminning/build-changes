...
public class ena {
   ...
   private final ena.a g;

   @Deprecated
   public static ena a(azh $$0, ena.a $$1) {
      return new ena($$0, $$1, false);
   }

   public static ena a(azh $$0, int $$1, double... $$2) {
      return b($$0, new ena.a($$1, new DoubleArrayList($$2)));
   }

   public static ena b(azh $$0, ena.a $$1) {
      return new ena($$0, $$1, true);
   }

   private ena(azh $$0, ena.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ena.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ena.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ena.a::b))
               .apply($$0, ena.a::new)
      );
      public static final Codec<ji<ena.a>> b = alb.a(lq.aH, a);
