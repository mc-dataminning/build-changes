...
public abstract class ena<T extends ena<T>> {
   ...
   public ena(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = emy.a();
         if ($$3 != null) {
         ...
         throw new eoj(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new eoj(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new eoj(var2.getMessage(), var2);
      }
   }
   ...
   public static ena<?> a(String $$0) {
      return new ena.b($$0, 5000, 60000);
   }

   public static ena<?> a(String $$0, int $$1, int $$2) {
      return new ena.b($$0, $$1, $$2);
   }

   public static ena<?> b(String $$0, String $$1) {
      return new ena.c($$0, $$1, 5000, 60000);
   }

   public static ena<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ena.c($$0, $$1, $$2, $$3);
   }

   public static ena<?> b(String $$0) {
      return new ena.a($$0, 5000, 60000);
   }

   public static ena<?> c(String $$0, String $$1) {
      return new ena.d($$0, $$1, 5000, 60000);
   }

   public static ena<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ena.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ena<ena.a> {
   ...
   public static class b extends ena<ena.b> {
   ...
   public static class c extends ena<ena.c> {
      ...
      public ena.c f() {
         try {
            ...
            throw new eoj(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ena<ena.d> {
      private final String c;
