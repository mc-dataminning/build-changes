...
public class dsn {
   ...
   private final Map<Character, Predicate<dsl>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsn a(char $$0, Predicate<dsl> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dsm b() {
      return new dsm(this.c());
   }

   private Predicate<dsl>[][][] c() {
      this.d();
      Predicate<dsl>[][][] $$0 = (Predicate<dsl>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsl>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
