...
public class fdt {
   public static List<fet> a(fdt.a... $$0) {
      for (fdt.a $$1 : $$0) {
         a($$1.j);
      }

      List<fet> $$2 = Lists.newArrayList();

      for (fdt.a $$3 : $$0) {
         $$2.add(new fet($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fet::a));
      return $$2;
   }
   ...
   public static List<fet> a() {
      return a(fdt.a.values());
   }
