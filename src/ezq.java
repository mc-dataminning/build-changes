...
public class ezq extends ezf implements fak {
   private static final fau d = new fau(new aiy("widget/text_field"), new aiy("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, avt> D = ($$0x, $$1x) -> avt.forward($$0x, wn.a);
   @Nullable
   private vq E;
   private long F = ac.b();

   public ezq(eys $$0, int $$1, int $$2, vq $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public ezq(eys $$0, int $$1, int $$2, int $$3, int $$4, vq $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public ezq(eys $$0, int $$1, int $$2, int $$3, int $$4, @Nullable ezq $$5, vq $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, avt> $$0) {
      this.D = $$0;
   }
   ...
   public void e(int $$0) {
      this.w = awh.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = awh.a($$0) - this.B();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.g());
      this.b(this.o.a($$3, $$2).length() + this.v, ffe.v());
   }
   ...
   public void b(eyu $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = awh.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
   ...
   public void i(int $$0) {
      this.x = awh.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = awh.a(this.v, 0, this.p.length());
      }
   }
