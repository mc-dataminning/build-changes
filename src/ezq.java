...
public class ezq implements ezo {
   private static final ahg g = new ahg("toast/tutorial");
   public static final int a = 154;
   public static final int d = 1;
   public static final int e = 3;
   public static final int f = 28;
   private final ezq.a h;
   private final vf i;
   @Nullable
   private final vf j;
   private ezo.a k = ezo.a.a;
   private long l;
   private float m;
   private float n;
   private final boolean o;

   public ezq(ezq.a $$0, vf $$1, @Nullable vf $$2, boolean $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.o = $$3;
   ...
   public ezo.a a(ewu $$0, ezp $$1, long $$2) {
      ...
      if (this.o) {
         $$0.a(3, 28, 157, 29, -1);
         float $$3 = auo.b(this.m, this.n, (float)($$2 - this.l) / 100.0F);
         int $$4;
         if (this.n >= this.m) {
            $$4 = -16755456;
         } else {
