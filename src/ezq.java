...
public class ezq extends ezt {
   ...
   static final ezq.b l = new ezq.b(854, 480);
   ...
   static enum a {
      ...
      private static final ezq.a[] e = values();
   ...
   static class b {
      ...
      static List<ezq.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ezq.b($$0, $$1), ezq.l) : ImmutableList.of(ezq.l);
      }
