...
public class ezq {
   ...
   static class b {
      static final Optional<ezq> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ezq a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezq();
      }
   }
}
