...
public interface dj<T extends Number> {
   SimpleCommandExceptionType a = new SimpleCommandExceptionType(xk.c("argument.range.empty"));
   SimpleCommandExceptionType b = new SimpleCommandExceptionType(xk.c("argument.range.swapped"));
