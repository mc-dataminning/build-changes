...
public record dj(@Nullable Float c, @Nullable Float d) {
   ...
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(uv.c("argument.range.ints"));

   public static dj a(float $$0) {
      return new dj($$0, $$0);
   }

   public static dj a(float $$0, float $$1) {
      return new dj($$0, $$1);
   }

   public static dj b(float $$0) {
      return new dj($$0, null);
   }

   public static dj c(float $$0) {
      return new dj(null, $$0);
   }
   ...
   public static dj a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (atg.b($$0)) {
         float $$1 = atg.e($$0, "value");
         return new dj($$1, $$1);
      } else {
         JsonObject $$2 = atg.m($$0, "value");
         Float $$3 = $$2.has("min") ? atg.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? atg.m($$2, "max") : null;
         return new dj($$3, $$4);
      }
   }

   public static dj a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static dj a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         throw cl.a.createWithContext($$0);
      } else {
         int $$3 = $$0.getCursor();
         Float $$4 = a(b($$0, $$1), $$2);
         Float $$5;
