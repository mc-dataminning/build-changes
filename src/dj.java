...
public class dj extends dz<dj.a> {
   ...
   public void a(ard $$0, akt<evw> $$1) {
      this.a($$0, $$1x -> $$1x.b($$1));
   }

   public static record a(Optional<bi> b, akt<evw> c) implements dz.a {
      ...
      public static aq<dj.a> a(akt<evw> $$0) {
         return ap.Q.a(new dj.a(Optional.empty(), $$0));
      }

      public boolean b(akt<evw> $$0) {
         return this.c == $$0;
      }
