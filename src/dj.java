...
public interface dj<T extends Number> {
   SimpleCommandExceptionType a = new SimpleCommandExceptionType(xv.c("argument.range.empty"));
   SimpleCommandExceptionType b = new SimpleCommandExceptionType(xv.c("argument.range.swapped"));
