...
public class dkz {
   public static <T> List<dkz.b> a(List<T> $$0, Function<T, List<jj<eqr>>> $$1, boolean $$2) {
      Object2IntMap<eqr> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eqr c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jj<eqr>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jf<eqr> $$12 : $$10.get($$11)) {
               eqr $$13 = $$12.a();
      ...
      Builder<dkz.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eqr> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dkz.b($$28));
      }
   ...
   public static record b(List<eqr> a, ToIntFunction<eqr> b) {
      b(List<eqr> $$0) {
         this($$0, ag.h($$0));
      }
   }
