...
public class dkz extends dex {
   public static final MapCodec<dkz> a = b(dkz::new);
   public static final dsy<dtf> b = dsq.ab;
   public static final dsy<dtf> c = dsq.aa;
   public static final dsy<dtf> d = dsq.ac;
   public static final dsy<dtf> e = dsq.ad;
   public static final dta f = dsq.aT;
   public static final Map<je, dsy<dtf>> g = Maps.newEnumMap(ImmutableMap.of(je.c, b, je.f, c, je.d, d, je.e, e));
   protected static final int h = 1;
   protected static final int i = 3;
   protected static final int j = 13;
   protected static final int k = 3;
   protected static final int l = 13;
   private static final ewi m = dex.a(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
   private static final Map<je, ewi> n = Maps.newEnumMap(
      ImmutableMap.of(
         je.c,
         dex.a(3.0, 0.0, 0.0, 13.0, 1.0, 13.0),
         je.d,
         dex.a(3.0, 0.0, 3.0, 13.0, 1.0, 16.0),
         je.f,
         dex.a(3.0, 0.0, 3.0, 16.0, 1.0, 13.0),
         je.e,
         dex.a(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)
      )
   );
   private static final Map<je, ewi> o = Maps.newEnumMap(
      ImmutableMap.of(
         je.c,
         ewf.a(n.get(je.c), dex.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         je.d,
         ewf.a(n.get(je.d), dex.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         je.f,
         ewf.a(n.get(je.f), dex.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         je.e,
         ewf.a(n.get(je.e), dex.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   private static final Map<dsa, ewi> F = Maps.newHashMap();
   private static final evp[] G = ac.a(new evp[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         float $$2 = (float)$$1 / 15.0F;
         float $$3 = $$2 * 0.6F + ($$2 > 0.0F ? 0.4F : 0.3F);
         float $$4 = ayx.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = ayx.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
         $$0[$$1] = new evp((double)$$3, (double)$$4, (double)$$5);
      }
   });
   ...
   public dkz(drz.d $$0) {
      super($$0);
      this.k(this.E.b().a(b, dtf.c).a(c, dtf.c).a(d, dtf.c).a(e, dtf.c).a(f, Integer.valueOf(0)));
      this.I = this.o().a(b, dtf.b).a(c, dtf.b).a(d, dtf.b).a(e, dtf.b);
   ...
   private dsa a(dbc $$0, dsa $$1, iz $$2) {
      boolean $$3 = p($$1);
   ...
   private dsa b(dbc $$0, dsa $$1, iz $$2) {
      boolean $$3 = !$$0.a_($$2.c()).g($$0, $$2);

      for (je $$4 : je.c.a) {
         if (!$$1.c(g.get($$4)).a()) {
            dtf $$5 = this.a($$0, $$2, $$4, $$3);
            $$1 = $$1.a(g.get($$4), $$5);
         }
      }
   ...
   protected void a(dsa $$0, dbx $$1, iz $$2, int $$3, int $$4) {
      ...
      for (je $$6 : je.c.a) {
         dtf $$7 = $$0.c(g.get($$6));
         if ($$7 != dtf.c && !$$1.a_($$5.a($$2, $$6)).a(this)) {
            $$5.c(je.a);
            dsa $$8 = $$1.a_($$5);
            if ($$8.a(this)) {
               iz $$9 = $$5.a($$6.g());
   ...
   private dtf a(dbc $$0, iz $$1, je $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dtf a(dbc $$0, iz $$1, je $$2, boolean $$3) {
      iz $$4 = $$1.a($$2);
      dsa $$5 = $$0.a_($$4);
      if ($$3) {
         boolean $$6 = $$5.b() instanceof dnk || this.a($$0, $$4, $$5);
         if ($$6 && m($$0.a_($$4.c()))) {
            if ($$5.d($$0, $$4, $$2.g())) {
               return dtf.a;
            }
      ...
      return !a($$5, $$2) && ($$5.g($$0, $$4) || !m($$0.a_($$4.d()))) ? dtf.c : dtf.b;
   }
   ...
   private boolean a(dbc $$0, iz $$1, dsa $$2) {
      return $$2.d($$0, $$1, je.b) || $$2.a(dez.hc);
   }
   ...
   protected static boolean m(dsa $$0) {
      return a($$0, null);
   }

   protected static boolean a(dsa $$0, @Nullable je $$1) {
      if ($$0.a(dez.cw)) {
         return true;
      } else if ($$0.a(dez.eh)) {
         je $$2 = $$0.c(dle.aE);
         ...
         return $$0.a(dez.kO) ? $$1 == $$0.c(dki.a) : $$0.m() && $$1 != null;
      }
   }
   ...
   public static int b(int $$0) {
      evp $$1 = G[$$0];
      return ayx.f((float)$$1.a(), (float)$$1.b(), (float)$$1.c());
   }

   private void a(dbw $$0, azf $$1, iz $$2, evp $$3, je $$4, je $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
   ...
   private void a(dbw $$0, iz $$1, dsa $$2, dsa $$3) {
      for (je $$4 : je.c.a) {
         iz $$5 = $$1.a($$4);
