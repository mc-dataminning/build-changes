...
public class tg extends sz<tx> {
   private static final int b = 37;
   public static final tz<tg> a = new tz.b<tg>() {
      public tg a(DataInput $$0, tj $$1) throws IOException {
         $$1.b();
      ...
      private static tg d(DataInput $$0, tj $$1) throws IOException {
         $$1.b(37L);
         byte $$2 = $$0.readByte();
         int $$3 = $$0.readInt();
         if ($$2 == 0 && $$3 > 0) {
            throw new tm("Missing type on ListTag");
         } else {
            $$1.a(4L, (long)$$3);
            tz<?> $$4 = ua.a($$2);
            List<tx> $$5 = Lists.newArrayListWithCapacity($$3);
   ...
   public tg e() {
      Iterable<tx> $$0 = (Iterable<tx>)(ua.a(this.w).d() ? this.c : Iterables.transform(this.c, tx::d));
      List<tx> $$1 = Lists.newArrayList($$0);
      return new tg($$1, this.w);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof tg && Objects.equals(this.c, ((tg)$$0).c);
   }
   ...
   @Override
   public tu.b a(tu $$0) {
      switch ($$0.a(ua.a(this.w), this.c.size())) {
         case c:
            return tu.b.c;
         case b:
            return $$0.b();
