...
public class egs implements egz.c {
   ...
   private final ObjectListIterator<egs.a> h;
   private final ObjectListIterator<etg> i;

   public static egs a(dkv $$0, dje $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<egs.a> $$4 = new ObjectArrayList(10);
      ObjectList<etg> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eso.a).forEach($$5x -> {
         eso $$6 = $$5x.h().d();
         ...
         for (esh $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof erz) {
                  ...
                  $$4.add(new egs.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new egs($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public egs(ObjectListIterator<egs.a> $$0, ObjectListIterator<etg> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = azq.g($$0, $$1, $$2);
      return azq.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = azq.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * azq.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = azq.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(erv a, eso b, int c) {
   }
}
