...
public class egs extends efx<eij> {
   public egs(Codec<eij> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efz<eij> $$0) {
      azh $$1 = $$0.d();
      ji $$2 = $$0.e();
      dhf $$3 = $$0.b();
      eij $$4 = $$0.f();
   ...
   protected boolean a(
      dhf $$0, azh $$1, eij $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dww $$0, Function<ji, dww> $$1, azh $$2, eij $$3, eij.a $$4, ji.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
