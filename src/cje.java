...
public class cje extends bss {
   private static final Logger f = LogUtils.getLogger();
   private dsa g = dez.I.o();
   public int b;
   ...
   @Nullable
   public ur d;
   protected static final akj<iz> e = akn.a(cje.class, akl.o);

   public cje(bsy<? extends cje> $$0, dbw $$1) {
      super($$0, $$1);
   }

   private cje(dbw $$0, double $$1, double $$2, double $$3, dsa $$4) {
      this(bsy.O, $$0);
      this.g = $$4;
      this.J = true;
      this.a_($$1, $$2, $$3);
   ...
   public static cje a(dbw $$0, iz $$1, dsa $$2) {
      cje $$3 = new cje($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2.b(dsq.C) ? $$2.a(dsq.C, Boolean.valueOf(false)) : $$2);
      $$0.a($$1, $$2.u().g(), 3);
      $$0.b($$3);
      return $$3;
   }
   ...
   public void l() {
      if (this.g.i()) {
         ...
         if (!this.dP().B) {
            iz $$1 = this.dp();
            boolean $$2 = this.g.b() instanceof dgj;
            boolean $$3 = $$2 && this.dP().b_($$1).a(awu.a);
            double $$4 = this.ds().g();
            if ($$2 && $$4 > 1.0) {
               evl $$5 = this.dP().a(new dbf(new evp(this.L, this.M, this.N), this.dn(), dbf.a.a, dbf.b.b, this));
               if ($$5.c() != evn.a.a && this.dP().b_($$5.a()).a(awu.a)) {
                  $$1 = $$5.a();
                  $$3 = true;
               }
            }
            ...
            if (this.aE() || $$3) {
               ...
               if (!$$6.a(dez.bQ)) {
                  if (!this.h) {
                     boolean $$7 = $$6.a(new cxz(this.dP(), $$1, je.a, cun.l, je.b));
                     boolean $$8 = dht.m(this.dP().a_($$1.d())) && (!$$2 || !$$3);
                     boolean $$9 = this.g.a((dbz)this.dP(), $$1) && !$$8;
                     if ($$7 && $$9) {
                        if (this.g.b(dsq.C) && this.dP().b_($$1).a() == enu.c) {
                           this.g = this.g.a(dsq.C, Boolean.valueOf(true));
                        }
                        ...
                        if (this.dP().a($$1, this.g, 3)) {
                           ...
                           this.ao();
                           if ($$0 instanceof dhs) {
                              ((dhs)$$0).a(this.dP(), $$1, this.g, $$6, this);
                           }
                        ...
                        } else if (this.c && this.dP().ab().b(dbs.i)) {
                           this.ao();
                           this.a($$0, $$1);
                           this.a($$0);
                        }
   ...
   public boolean a(float $$0, float $$1, brl $$2) {
      if (!this.i) {
         ...
         if ($$3 < 0) {
            ...
            Predicate<bss> $$4 = bsx.e.and(bsx.b);
            brl $$6 = this.g.b() instanceof dhs $$5 ? $$5.a(this) : this.dQ().a(this);
            float $$7 = (float)Math.min(ayx.d((float)$$3 * this.k), this.j);
   ...
   @Override
   public zv<ach> dl() {
      return new aci(this, dex.i(this.u()));
   }
