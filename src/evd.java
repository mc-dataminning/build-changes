...
public class evd implements ano, AutoCloseable {
   static final Logger b = LogUtils.getLogger();
   private static final String c = "fonts.json";
   public static final aex a = new aex("minecraft", "missing");
   private static final aeq d = aeq.a("font");
   private static final Gson e = new GsonBuilder().setPrettyPrinting().disableHtmlEscaping().create();
   private final eve f;
   private final List<ejs> g = new ArrayList<>();
   private final Map<aex, eve> h = new HashMap<>();
   private final fzf i;
   private Map<aex, aex> j = ImmutableMap.of();
   ...
   private CompletableFuture<evd.d> a(anu $$0, Executor $$1) {
      List<CompletableFuture<evd.e>> $$2 = new ArrayList<>();

      for (Entry<aex, List<ans>> $$3 : d.b($$0).entrySet()) {
         aex $$4 = d.b($$3.getKey());
   ...
   private CompletableFuture<Optional<ejs>> a(evd.a $$0, evo.a $$1, anu $$2, Executor $$3) {
   ...
   private Map<aex, List<ejs>> a(List<evd.e> $$0) {
      Map<aex, List<ejs>> $$1 = new HashMap<>();
      ard<aex, evd.e> $$2 = new ard<>();
   ...
   private static List<Pair<evd.a, evo>> a(List<ans> $$0, aex $$1) {
   ...
   static record a(aex a, String b, int c) {
      @Override
   ...
   static record b(evd.a a, Either<CompletableFuture<Optional<ejs>>, aex> b) {

      public Optional<List<ejs>> a(Function<aex, List<ejs>> $$0) {
   ...
   static record d(Map<aex, List<ejs>> a, List<ejs> b) {
   }

   static record e(aex a, List<evd.b> b, Set<aex> c) implements ard.a<aex> {
