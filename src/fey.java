...
public abstract class fey {
   ...
   private List<String> a(String $$0, fey.a $$1, String $$2) {
      int $$3 = $$1.b;
      int $$4 = 0;
      String $$5 = "";
      ...
      while ($$7.find()) {
         if (!a($$0, $$7, $$4)) {
            ...
            if ($$8 != null) {
               ...
               int $$16 = azv.c($$0.substring(0, $$7.end(1)));
   ...
   private String a(String $$0, fey.a $$1) {
   ...
   public static String a(String $$0, gml $$1) {
      if ($$1.c()) {
         return $$0;
      } else {
         int $$2 = $$0.indexOf(10);
