...
public class fey {
   ...
   public static List<fey.a> a(String $$0, fey.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fey.a> a(String $$0, List<fey.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fey.a> a(List<String> $$0, List<fey.b> $$1) {
      int $$2 = 0;
      List<fey.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fey.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fey.b a(String $$0, String $$1) {
         return new fey.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fey.b a(String $$0) {
         return new fey.b($$0);
      }
   }
}
