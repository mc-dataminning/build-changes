...
public class fey {
   ...
   public static fev a(fev $$0) {
      return $$0;
   }

   public static fev a(fev $$0, fev $$1) {
      return new fey.a($$0, $$1);
   }
   ...
   static class a implements fev {
      private final fev a;
      private final fev b;

      public a(fev $$0, fev $$1) {
         if ($$0 == $$1) {
   ...
   static record b(fev[] a) implements fev {
      b(fev[] a) {
