public abstract class fey extends ffc implements fgh, fha {
   private static final fgr a = new fgr(new akh("widget/text_field"), new akh("widget/text_field_highlighted"));
   private static final akh b = new akh("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fey(int $$0, int $$1, int $$2, int $$3, wu $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return axz.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = axz.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fer var1, int var2, int var3, float var4);
}
