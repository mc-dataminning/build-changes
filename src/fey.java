public class fey extends fel<cja> implements fhg {
   private static final ahh x = new ahh("textures/gui/container/crafting_table.png");
   private final fha y = new fha();
   private boolean z;

   public fey(cja $$0, cfp $$1, vg $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aP_() {
      ...
      this.d(new eyd(this.t + 5, this.h / 2 - 49, 20, 18, fha.a, $$0 -> {
         this.y.e();
         this.t = this.y.a(this.g, this.c);
