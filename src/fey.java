...
public class fey extends fgh {
   public static final double a = 7.0;
   private static final vs c = vs.c("chat_screen.usage");
   ...
   protected void aP_() {
      ...
      this.b = new fat(this.f.i, 4, this.h - 12, this.g - 4, 12, vs.c("chat.editBox")) {
         @Override
         protected wg aM_() {
            return super.aM_().b(fey.this.o.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.o = new fan(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
   }
   ...
   public void a(ezx $$0, int $$1, int $$2, float $$3) {
      ...
      this.o.a($$0, $$1, $$2);
      $$0.c().b();
      eyf $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.i, this.i.c($$4.g(), 210), $$1, $$2);
      } else {
         wp $$5 = this.b((double)$$1, (double)$$2);
         if ($$5 != null && $$5.i() != null) {
            $$0.a(this.i, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(fef $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fee.a, vs.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private wp b(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return axh.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
