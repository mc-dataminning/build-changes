...
public class fho extends fcz {
   ...
   private final fan o = new fan().a(10).b(20);

   public fho(Collection<app> $$0, BooleanConsumer $$1) {
      super(a);
      this.n = $$0;
      this.m = $$1;
   }
   ...
   protected void aN_() {
      ...
      fan.b $$0 = this.o.d(2);
      far $$1 = $$0.b().b();
      $$0.a(new eyl(this.e, this.i), 2, $$1);
      exy $$2 = $$0.a(new exy(b, this.i).b(true), 2, $$1);
      $$2.c(310);
      $$0.a(exe.a(c, $$0x -> this.f.a(new fho.a())).a(100).a(), 2, $$1);
      $$0.a(exe.a(ve.i, $$0x -> this.m.accept(true)).a());
      $$0.a(exe.a(ve.k, $$0x -> this.m.accept(false)).a());
      this.o.a($$1x -> {
   ...
   @Override
   protected void c() {
      fam.a(this.o, 0, 0, this.g, this.h, 0.5F, 0.5F);
   }
   ...
   class a extends fcz {
      ...
      protected void aN_() {
         super.aN_();
         this.d(exe.a(ve.k, $$0 -> this.aE_()).a(this.g / 2 - 100, this.h / 4 + 120 + 24, 200, 20).a());
         this.b = this.d(new fho.a.a(this.f, fho.this.n));
      }
      ...
      class a extends eya<fho.a.b> {
         public a(evg $$0, Collection<app> $$1) {
            ...
            for (app $$2 : $$1) {
               ...
               if (!$$3.isEmpty()) {
                  ...
                  this.b(a.this.new b($$4, $$5, exx.a(a.this.i, $$5, this.b())));
               }
            }
         }
