...
public class fho<T extends bwa> extends fep<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.X_()) {
         ...
         this.n.f = asb.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = asb.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = asb.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = asb.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = asb.b($$1 * 0.6662F) * 1.4F * $$2;
      }
