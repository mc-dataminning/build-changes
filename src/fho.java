...
public class fho {
   ...
   private static final Map<dxw.a, String> e = ac.a(new EnumMap<>(dxw.a.class), $$0 -> {
      $$0.put(dxw.a.a, "SW");
      $$0.put(dxw.a.b, "S");
      $$0.put(dxw.a.c, "OW");
      $$0.put(dxw.a.d, "O");
   ...
   private duk l;
   @Nullable
   private CompletableFuture<duk> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blw r = new blw(1);
   private final blw s = new blw(bmb.values().length);
   private final blw t = new blw(1);
   private final blw u = new blw(1);
   private final Map<blx, blw> v = Map.of(blx.a, this.s);
   private final fix w;
   private final fiz x;
   private final fiy y;
   private final fiw z;
   ...
   public fho(ffh $$0) {
      ...
      this.g = new fho.a();
      this.h = $$0.h;
      this.w = new fix(this.h, this.r);
      this.x = new fiz(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fiy(this.h, this.t);
      this.z = new fiw(this.h, this.u);
   }
   ...
   protected void c(fgt $$0) {
      List<String> $$1 = this.c();
      this.a($$0, $$1, false);
   }

   private void a(fgt $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         if ($$27.C()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqu $$37 = new bqu($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dcl.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btu> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btu.values())
   ...
   private static String a(ji<dcz> $$0) {
   ...
   private duk s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, duz.n, false).thenApply($$0x -> (duk)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eyt.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffh.Q().aO().k(), ffh.Q().aO().l(), eyt.a()),
            eyt.c(),
            eyt.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evr.a.b) {
            ...
            for (Entry<dth<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evr.a.b) {
            ...
            for (Entry<dth<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dth<?>, Comparable<?>> $$0) {
      dth<?> $$1 = $$0.getKey();
