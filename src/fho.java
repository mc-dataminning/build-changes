...
public class fho extends fhd implements fii {
   private static final fis d = new fis(new alf("widget/text_field"), new alf("widget/text_field_highlighted"));
   ...
   public fho(fgq $$0, int $$1, int $$2, xp $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fho(fgq $$0, int $$1, int $$2, int $$3, int $$4, xp $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fho(fgq $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fho $$5, xp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fne.t());
   }
   ...
   public void b(fgs $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gdx.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
