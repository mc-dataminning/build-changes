...
public class giq extends MinecraftServer {
   ...
   public giq(Thread $$0, evh $$1, egl.c $$2, aps $$3, aic $$4, ahz $$5, ann $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gip(this, this.ba(), this.h));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (ane $$1 : Lists.newArrayList(this.ae().t())) {
   ...
   @Override
   public ctl bb() {
      return this.p() ? (ctl)MoreObjects.firstNonNull(this.q, this.k.m()) : null;
   }
}
