public class giq extends gjl {
   private final gjg a;

   giq(gfd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjg $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cps $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dC();
            if (this.h > $$1) {
   ...
   public static class a implements gio<lw> {
      ...
      public gil a(lw $$0, gfd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new giq($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gio<lw> {
      ...
      public gil a(lw $$0, gfd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gil $$8 = new giq($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
