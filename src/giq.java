...
public class giq {
   ...
   public static class d implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         giq.c $$8 = new giq.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fli.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }
   ...
   public static class e extends gje {
      ...
      public e(gfy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gji $$7, List<czd> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
