public class giq<T extends chz> extends ghs<T> {
   ...
   protected int a(T $$0, io $$1) {
      return $$0.ak() == bsa.V ? Math.max(5, super.a($$0, $$1)) : super.a($$0, $$1);
   }
   ...
   public void a(T $$0, float $$1, float $$2, eys $$3, gck $$4, int $$5) {
      ...
      if (!$$10.e()) {
         ...
         if ($$13 != null) {
            ...
            eoj $$16 = ctw.a($$13, $$0.dP());
            $$3.a(0.0F, 0.0F, -1.0F);
            if ($$16 != null) {
               int $$17 = this.a($$0, 15728850, $$5);
               fdz.Q().j.j().a($$3, $$4, $$13, $$16, true, $$17);
            }
         } else {
            int $$18 = this.a($$0, 15728880, $$5);
            $$3.b(0.5F, 0.5F, 0.5F);
            this.k.a($$10, ctl.i, $$18, gnm.d, $$3, $$4, $$0.dP(), $$0.al());
         }
      }
   ...
   private int a(T $$0, int $$1, int $$2) {
      return $$0.ak() == bsa.V ? $$1 : $$2;
   }

   private gqd a(T $$0, cto $$1) {
      boolean $$2 = $$0.ak() == bsa.V;
      if ($$1.a(ctr.rU)) {
         return $$2 ? j : h;
      } else {
         return $$2 ? i : g;
   ...
   public euk a(T $$0, float $$1) {
      return new euk((double)((float)$$0.cH().j() * 0.3F), -0.25, (double)((float)$$0.cH().l() * 0.3F));
   }
   ...
   protected boolean b(T $$0) {
      if (fdz.M() && !$$0.E().e() && $$0.E().b(kb.f) && this.c.c == $$0) {
         double $$1 = this.c.b($$0);
