public class giq extends gfy<hfa> {
   ...
   public static gji a(gjg $$0) {
      gjk $$1 = new gjk();
      gjm $$2 = $$1.a();
      $$2.a("shoulders", gjh.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gje.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         gjh.c()
         ...
         gje.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         gjh.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gje.a(-2.0F, 6.9F + azm.b(0.20420352F) * 10.0F, -0.5F + azm.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", gjh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gje.a);
      gjh $$4 = gjh.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gje.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gje.a(10.0F, 4.0F, 0.0F));
   ...
   private static void a(hfa $$0, gjc $$1, int $$2) {
