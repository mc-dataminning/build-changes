...
public class emq implements dxi.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<emq> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayn<emq> a = ayn.a(f);
   private final emu g;
   private final emu h;
   private final emu i;
   ...
   public static emq a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new emq(new dyq(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private emq(emu $$0, emu $$1, emu $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public emq(azc $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         emu.a($$0, IntStream.rangeClosed(-15, 0)),
         emu.a($$0, IntStream.rangeClosed(-15, 0)),
         emu.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public emq a(azc $$0) {
      return new emq($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxi.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         emr $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(emu.b($$4 * $$13), emu.b($$5 * $$13), emu.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = emu.b($$1 * $$13);
         double $$21 = emu.b($$2 * $$13);
         double $$22 = emu.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            emr $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ayu.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
