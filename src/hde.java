...
public class hde extends MinecraftServer {
   ...
   public hde(Thread $$0, fjx $$1, etu.c $$2, auo $$3, amk $$4, amg $$5, asb $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hdd(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (arr $$1 : Lists.newArrayList(this.ag().t())) {
            if (!$$1.cI().equals(this.s)) {
               this.ag().c($$1);
            }
         }
      });
   ...
   @Override
   public dfc bd() {
      return this.r() && !this.u_() ? (dfc)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
