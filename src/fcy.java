...
public interface fcy {
   fcy a(float var1, float var2, float var3);

   fcy a(int var1, int var2, int var3, int var4);

   fcy a(float var1, float var2);

   fcy a(int var1, int var2);

   fcy b(int var1, int var2);

   fcy b(float var1, float var2, float var3);
   ...
   default fcy a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default fcy a(int $$0) {
      return this.a(axn.b($$0), axn.c($$0), axn.d($$0), axn.a($$0));
   }

   default fcy d(int $$0) {
      return this.a(axn.c($$0, -1));
   }
   ...
   default void a(fcu.a $$0, ghx $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fcu.a $$0, ghx $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      ki $$11 = $$1.e().q();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(fcs.b.b());
         ...
         for (int $$20 = 0; $$20 < $$15; $$20++) {
            ...
            int $$33 = axn.a($$16, (int)$$27, (int)$$28, (int)$$29);
            int $$34 = $$7[$$20];
   ...
   default fcy a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default fcy a(fcu.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default fcy a(fcu.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fcy a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default fcy b(fcu.a $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.a($$1, $$2, $$3, new Vector3f());
      return this.b($$4.x(), $$4.y(), $$4.z());
   }

   default fcy b(fcu.a $$0, Vector3f $$1) {
