...
public class fcy extends eyk {
   ...
   public static final aex b = new aex("textures/gui/footer_separator.png");
   public static final aex c = new aex("textures/gui/light_dirt_background.png");
   final fdh x;
   ...
   public static void a(eqv $$0, @Nullable eyk $$1) {
      a($$0, u);
      anf $$2 = new anf(new ani($$0.bb()));
      afr.c $$3 = a($$2, cqo.c);
      CompletableFuture<fdg> $$4 = afr.a(
         $$3, $$0x -> new afr.b<>(new fcy.a(new dlo(dlq.a(), duy.a($$0x.c())), $$0x.b()), $$0x.d()), ($$0x, $$1x, $$2x, $$3x) -> {
            $$0x.close();
   ...
   public void a(esf $$0, int $$1, int $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$0.a(b, 0, arx.d(this.h - 36 - 2, 2), 0.0F, 0.0F, this.g, 2, 32, 2);
   }
   ...
   void a(cqo $$0) {
      ...
      if ($$1 != null) {
         this.f.a(new fdb(this, (anf)$$1.getSecond(), $$0x -> this.a($$0x, false, this::a)));
      }
   }
   ...
   private void a(anf $$0, boolean $$1, Consumer<cqo> $$2) {
      ...
      afr.<fcy.a, fdg>a(
            ...
            $$0x -> {
               if ($$0x.c().d(je.aF).b() == 0) {
                  ...
                  fdg $$1x = this.x.k();
                  DynamicOps<JsonElement> $$2x = aev.a(JsonOps.INSTANCE, $$1x.a());
                  DataResult<JsonElement> $$3x = dlo.a($$2x, $$1x.b(), $$1x.d()).setLifecycle(Lifecycle.stable());
                  DynamicOps<JsonElement> $$4 = aev.a(JsonOps.INSTANCE, $$0x.c());
                  ...
                  return new afr.b<>(new fcy.a($$5, $$0x.b()), $$0x.d());
               }
            },
            ($$0x, $$1x, $$2x, $$3x) -> {
               $$0x.close();
   ...
   private static afr.c a(anf $$0, cqo $$1) {
      afr.d $$2 = new afr.d($$0, $$1, false, true);
