...
public class cim extends cia {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new eww($$0, this.g.dx() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.F(this.g)) {
               this.d++;
               eww $$8 = new eww(this.g.dv() - this.a.dv(), 0.0, this.g.dB() - this.a.dB()).d();
               eww $$9 = new eww((double)ayn.a(this.a.dG() * (float) (Math.PI / 180.0)), 0.0, (double)(-ayn.b(this.a.dG() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  eww $$13 = this.a.g(1.0F);
                  ...
                  eww $$20 = new eww($$17, $$18, $$19);
                  if (!this.a.aX()) {
                     this.a.dQ().a(null, 1017, this.a.dq(), 0);
                  }

                  cne $$21 = new cne(this.a.dQ(), this.a, $$20.d());
   ...
   public void a(btl $$0) {
      this.g = $$0;
      int $$1 = this.a.x();
      int $$2 = this.a.q(this.g.dv(), this.g.dx(), this.g.dB());
      int $$3 = this.g.du();
      int $$4 = this.g.dA();
      ...
      int $$9 = ayn.a(this.g.dx() + $$8);
      epk $$10 = new epk($$3, $$9, $$4);
