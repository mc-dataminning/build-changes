...
public class eet extends eew<ees> {
   public eet(Codec<ees> $$0) {
      super($$0);
   }

   public boolean a(ees $$0, azg $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eer $$0, ees $$1, dyq $$2, Function<ji, jr<dhi>> $$3, azg $$4, ecc $$5, dfm $$6, dyp $$7) {
      int $$8 = kk.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eew.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eer $$0, ees $$1, dyq $$2, Function<ji, jr<dhi>> $$3, ecc $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dyp $$10, eew.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayy.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayy.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayy.b($$13);
         $$6 += (double)(ayy.b($$12) * $$27);
         $$7 += (double)ayy.a($$13);
         $$8 += (double)(ayy.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
