...
public class eet {
   ...
   private final dhk o;
   private static final List<dkm> p = List.of(dko.l, dko.O, dko.i, dko.b, dko.k, dko.L, dko.N, dko.fz, dko.ec, dko.iR, dko.j);
   ...
   private eet(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dik>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static eet a(@Nullable eet.d $$0) {
      return $$0 == null ? null : new eet($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public eet.d a() {
      ...
      return new eet.d(this.o.ao(), this.o.ap() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static eet a(asp $$0, int $$1, int $$2) {
      dzq $$3 = $$0.a($$1, $$2);
      eet $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(ear.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jn> a(dig $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dzq $$1, int $$2, int $$3) {
      if (this.r[$$0] == Double.MAX_VALUE) {
         this.r[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.t[$$0] = this.a($$1, $$2, $$3, bae.a(this.r[$$0]));
      this.s.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dzq $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(edq.a.a)) {
         $$3 = Math.min($$0.a(edq.a.a, $$1, $$2), this.o.am());
      } else {
         $$3 = this.o.am();
      }
   ...
   private static double a(dzq $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dzq $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dzq $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.c()];
      Arrays.fill($$4, -1.0);
      jh.a $$5 = new jh.a($$1, this.o.am() + 1, $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<jq<dik>> b(dzq $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dik>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dzq $$0, jh $$1) {
      dxv $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axu.Q)) {
         ...
         return $$2.a(dko.fh) || $$2.a(dko.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, eet.a $$3) {
      if ($$1 >= kb.a(this.o.L_()) && $$1 <= kb.a(this.o.am())) {
         int $$4 = $$1 - kb.a(this.o.L_());

         for (int $$5 = 0; $$5 < this.s.size(); $$5++) {
            if (this.s.get($$5) != null) {
               jq<dik> $$6 = this.s.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, eet.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, eet.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dik> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<eet.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(eet.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(eet.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(eet.d::c)
                  )
                  .apply($$0, eet.d::new)
         )
         .validate(eet.d::a);

      private static DataResult<eet.d> a(eet.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != eet.n
            ? DataResult.error(() -> "heights has to be of length " + eet.n)
