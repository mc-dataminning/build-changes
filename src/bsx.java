...
public class bsx extends btb {
   public static final MapCodec<bsx> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bsx a(float $$0, float $$1, float $$2, float $$3) {
      return new bsx($$0, $$1, $$2, $$3);
   }

   private bsx(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(azt $$0, float $$1, float $$2, float $$3, float $$4) {
      return azk.a(azk.c($$0, $$1, $$2), $$3, $$4);
   }
