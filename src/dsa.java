...
public class dsa extends dru<dtz> {
   private static final ic[] a = ic.values();

   public dsa(Codec<dtz> $$0) {
      super($$0);
   }

   @Override
   public boolean a(drw<dtz> $$0) {
      dtz $$1 = $$0.f();
      auv $$2 = $$0.d();
      hx $$3 = $$0.e();
      cuk $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dpp $$9 = new dpp(new dor($$4.C()));
      edu $$10 = edu.a($$9, -4, 1.0);
      ...
      for (hx $$33 : hx.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<hx, Integer> $$37 : $$7) {
            $$35 += auo.f($$33.j((jb)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (hx $$38 : $$11) {
            $$36 += auo.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, cws.a.o(), $$32);
      ...
      for (hx $$44 : $$31) {
         ...
         for (ic $$46 : a) {
            ...
            djh $$48 = $$4.a_($$47);
            if ($$45.b(djx.C)) {
               $$45 = $$45.a(djx.C, Boolean.valueOf($$48.u().b()));
            }
