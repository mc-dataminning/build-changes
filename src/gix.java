...
public abstract class gix<T extends bsv> {
   ...
   public final int b(T $$0, float $$1) {
      iz $$2 = iz.a($$0.k($$1));
      return gdo.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, iz $$1) {
      return $$0.dP().a(dci.a, $$1);
   }

   protected int a(T $$0, iz $$1) {
      return $$0.bQ() ? 15 : $$0.dP().a(dci.b, $$1);
   }

   public boolean a(T $$0, ggt $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if ($$0.au) {
         return true;
         ...
         evn $$5 = $$0.h_().g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new evn($$0.du() - 2.0, $$0.dw() - 2.0, $$0.dA() - 2.0, $$0.du() + 2.0, $$0.dw() + 2.0, $$0.dA() + 2.0);
         }
   ...
   protected void a(T $$0, xp $$1, ezz $$2, gdp $$3, int $$4, float $$5) {
      ...
      if (!($$6 > 4096.0)) {
         ...
         if ($$7 != null) {
            ...
            Matrix4f $$10 = $$2.c().a();
            float $$11 = ffg.Q().m.a(0.25F);
            int $$12 = (int)($$11 * 255.0F) << 24;
            fgq $$13 = this.b();
            float $$14 = (float)(-$$13.a($$1) / 2);
            $$13.a($$1, $$14, (float)$$9, 553648127, false, $$10, $$3, $$8 ? fgq.a.b : fgq.a.a, $$12, $$4);
            if ($$8) {
               $$13.a($$1, $$14, (float)$$9, -1, false, $$10, $$3, fgq.a.a, 0, $$4);
            }
