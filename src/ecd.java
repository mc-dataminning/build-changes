...
public class ecd implements eck.c {
   ...
   private final ObjectListIterator<ecd.a> h;
   private final ObjectListIterator<eon> i;

   public static ecd a(dhc $$0, dfm $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<ecd.a> $$4 = new ObjectArrayList(10);
      ObjectList<eon> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != env.a).forEach($$5x -> {
         env $$6 = $$5x.h().d();
         ...
         for (eno $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eng) {
                  ...
                  $$4.add(new ecd.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new ecd($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public ecd(ObjectListIterator<ecd.a> $$0, ObjectListIterator<eon> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = ayy.g($$0, $$1, $$2);
      return ayy.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = ayy.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * ayy.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = ayy.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(enc a, env b, int c) {
   }
}
