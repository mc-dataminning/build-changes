...
public interface ecd {
   static ecd a(ecv $$0, dfn $$1, ecx $$2, ede $$3, int $$4, int $$5, ecd.a $$6) {
      return new ecd.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static ecd a(final ecd.a $$0) {
      return new ecd() {
         @Nullable
         @Override
         public dww a(eck.b $$0x, double $$1) {
   ...
   @Nullable
   dww a(eck.b var1, double var2);

   boolean a();

   public interface a {
      ecd.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dww b) {

      public dww a(int $$0) {
         return $$0 < this.a ? this.b : djn.a.m();
      }
   }

   public static class c implements ecd {
      ...
      private final eck p;
      private final ede q;
      private final ecd.b[] r;
      private final long[] s;
      private final ecd.a t;
      private final eck u;
      private final eck v;
      private boolean w;
      private final int x;
      ...
      c(ecv $$0, dfn $$1, ecx $$2, ede $$3, int $$4, int $$5, ecd.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dww a(eck.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            ecd.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(djn.K)) {
               this.w = false;
               return djn.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(djn.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(djn.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(eck.b $$0, MutableDouble $$1, ecd.b $$2, ecd.b $$3) {
         int $$4 = $$0.b();
         dww $$5 = $$2.a($$4);
         dww $$6 = $$3.a($$4);
         if ((!$$5.a(djn.K) || !$$6.a(djn.J)) && (!$$5.a(djn.J) || !$$6.a(djn.K))) {
      ...
      private ecd.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            ecd.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private ecd.b b(int $$0, int $$1, int $$2) {
         ecd.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               ecd.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new ecd.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, ecd.b $$3, int $$4, boolean $$5) {
         eck.e $$6 = new eck.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dhz.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new eck.e($$6, $$7, $$8)) * 10.0;
         int $$12 = ayz.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dww a(int $$0, int $$1, int $$2, ecd.b $$3, int $$4) {
         dww $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != ear.g && $$3.b != djn.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new eck.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = djn.K.m();
            }
         }
