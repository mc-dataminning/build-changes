...
public class epz extends epx {
   public static final MapCodec<epz> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  btw.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  btw.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final btw i;
   private final jj<dnc> j;

   public epz(int $$0, int $$1, int $$2, btw $$3, float $$4, btw $$5, jj<dnc> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<eob.a> a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, int $$3, iv $$4, enl $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new eob.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, int $$3, enl $$4, List<eob.a> $$5, iv.a $$6, int $$7, jb $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new eob.a($$16, 0, false));
         $$5.add(new eob.a($$16.c(2), 0, false));
      }
   }
