...
public class epz implements eqa, eqb {
   ...
   private final evd<MinecraftServer> G;
   ...
   public epz(dcb $$0, dyr $$1, epz.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iz.c,
   ...
   public static <T> epz a(Dynamic<T> $$0, dcb $$1, epz.a $$2, dyr $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new epz(
         (ur)$$0.get("Player").flatMap(ur.a::parse).result().orElse(null),
         ...
         new evd<>(evc.a, $$0.get("ScheduledEvents").asStream()),
         (ur)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dvw.a.a).resultOrPartial(f::error).orElse(dvw.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jw $$0, ur $$1, @Nullable ur $$2) {
      ...
      dyp.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vo)dvw.a.a.encodeStart(vf.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dcr.b.encodeStart(vf.a, this.g.g()).ifSuccess($$1x -> $$1.a((ur)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == epz.a.b;
   }

   @Override
   public boolean A() {
      return this.i == epz.a.c;
   }
