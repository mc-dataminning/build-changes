...
public class cjv extends bvj implements clq {
   ...
   public static final ajy<Integer> a = akc.a(cjv.class, aka.b);
   ...
   private int cu = 100;
   private float cv;
   private final etl[] cw = new etl[24];
   private final int[] cx = new int[24];
   private final etj cy = new etj();

   public cjv(bus<? extends cjv> $$0, dgi $$1) {
      super(bus.P, $$1);
         ...
         if (this.gf()) {
            ...
            if (this.dV() instanceof ard $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.v(ayz.h(this.dL()));
                  fba $$17 = $$10.a(this.dA(), this.dC(), this.dG()).d();
                  fba $$18 = new fba((double)ayz.a(this.dL() * (float) (Math.PI / 180.0)), this.dy().e, (double)(-ayz.b(this.dL() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new fba(0.0, 0.0, -1.0));
                  if (this.bY) {
            ...
            this.aX = this.dL();
            fba[] $$25 = new fba[this.cj.length];

            for (int $$26 = 0; $$26 < this.cj.length; $$26++) {
               $$25[$$26] = new fba(this.cj[$$26].dA(), this.cj[$$26].dC(), this.cj[$$26].dG());
            }
   ...
   private void a(ard $$0, List<bul> $$1) {
   ...
   private void b(ard $$0, List<bul> $$1) {
      for (bul $$2 : $$1) {
         if ($$2 instanceof bvh) {
   ...
   public boolean a(ard $$0, cjs $$1, btb $$2, float $$3) {
      if (this.ct.a().h() == ckl.j) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof cox || $$2.a(awr.y)) {
               float $$4 = this.eD();
               this.c($$0, $$2, $$3);
   ...
   protected void c(ard $$0, btb $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void el() {
      ...
      if (this.dV() instanceof ard $$4) {
         if (this.bZ > 150 && this.bZ % 5 == 0 && $$4.O().b(dge.f)) {
            bux.a($$4, this.dt(), ayz.d((float)$$3 * 0.08F));
         }
      ...
      if (this.bZ == 200 && this.dV() instanceof ard $$7) {
         if ($$7.O().b(dge.f)) {
            bux.a($$7, this.dt(), ayz.d((float)$$3 * 0.2F));
         }
   ...
   public int t() {
      if (this.cw[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dV().a(ecs.a.f, new ji($$3, 0, $$4)).v() + $$1);
            this.cw[$$0] = new etl($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      etl $$5 = new etl(ayz.a($$0), ayz.a($$1), ayz.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public etn a(int $$0, int $$1, @Nullable etl $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         etl $$4 = this.cw[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private etn a(etl $$0, etl $$1) {
      ...
      return new etn($$2, new ji($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public fba J(float $$0) {
      ...
      fba $$8;
      if ($$2 == ckl.d || $$2 == ckl.e) {
         ji $$3 = this.dV().a(ecs.a.f, efx.a(this.cs));
   ...
   public void a(ard $$0, cju $$1, ji $$2, btb $$3) {
      cox $$4;
      if ($$3.d() instanceof cox) {
         $$4 = (cox)$$3.d();
      } else {
