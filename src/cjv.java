...
public class cjv extends bvj implements clq {
   private static final Logger cc = LogUtils.getLogger();
   public static final akm<Integer> a = akq.a(cjv.class, ako.b);
   private static final cfy cd = cfy.a().a(64.0);
   ...
   private final cjs[] cj;
   public final cjs c;
   private final cjs ck;
   private final cjs cl;
   private final cjs cm;
   private final cjs cn;
   private final cjs co;
   private final cjs cp;
   private final cjs cq;
   public float d;
   public float bX;
   public boolean bY;
   public int bZ;
   ...
   private dzt cr;
   private jh cs = jh.c;
   private final ckm ct;
   private int cu = 100;
   private float cv;
   private final esh[] cw = new esh[24];
   private final int[] cx = new int[24];
   private final esf cy = new esf();

   public cjv(bus<? extends cjv> $$0, dfm $$1) {
      super(bus.O, $$1);
      this.c = new cjs(this, "head", 1.0F, 1.0F);
      this.ck = new cjs(this, "neck", 3.0F, 3.0F);
      this.cl = new cjs(this, "body", 5.0F, 3.0F);
      this.cm = new cjs(this, "tail", 2.0F, 2.0F);
      this.cn = new cjs(this, "tail", 2.0F, 2.0F);
      this.co = new cjs(this, "tail", 2.0F, 2.0F);
      this.cp = new cjs(this, "wing", 4.0F, 2.0F);
      this.cq = new cjs(this, "wing", 4.0F, 2.0F);
      this.cj = new cjs[]{this.c, this.ck, this.cl, this.cm, this.cn, this.co, this.cp, this.cq};
      this.x(this.eR());
      this.ad = true;
      this.ct = new ckm(this);
   }
   ...
   public static bwo.a q() {
      return bvj.C().a(bwp.s, 200.0);
   }

   @Override
   public boolean ba() {
      float $$0 = azm.b(this.bX * (float) (Math.PI * 2));
   ...
   public void aZ() {
      if (this.dV().C && !this.bb()) {
         this.dV().a(this.dA(), this.dC(), this.dG(), awn.ie, this.dm(), 5.0F, 0.8F + this.ae.i() * 0.3F, false);
      }
   }
   ...
   public void d_() {
      ...
      if (this.dV().C) {
         ...
         if (!this.bb() && !this.ct.a().a() && --this.cu < 0) {
            this.dV().a(this.dA(), this.dC(), this.dG(), awn.if, this.dm(), 2.5F, 0.8F + this.ae.i() * 0.3F, false);
            this.cu = 200 + this.ae.a(200);
         }
      }

      if (this.cr == null && this.dV() instanceof arp $$0) {
         dzt $$1 = $$0.E();
         ...
         if (this.fZ()) {
            ...
            if (this.dV() instanceof arp $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.v(azm.h(this.dL()));
                  ezy $$17 = $$10.a(this.dA(), this.dC(), this.dG()).d();
                  ezy $$18 = new ezy((double)azm.a(this.dL() * (float) (Math.PI / 180.0)), this.dy().e, (double)(-azm.b(this.dL() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new ezy(0.0, 0.0, -1.0));
                  if (this.bY) {
                     this.a(bvl.a, this.dy().c(0.8F));
                  } else {
            ...
            this.aW = this.dL();
            ezy[] $$25 = new ezy[this.cj.length];

            for (int $$26 = 0; $$26 < this.cj.length; $$26++) {
               $$25[$$26] = new ezy(this.cj[$$26].dA(), this.cj[$$26].dC(), this.cj[$$26].dG());
            }
            ...
            if (this.dV() instanceof arp $$33 && this.aM == 0) {
               this.a($$33, $$33.a(this, this.cp.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), buq.e));
               this.a($$33, $$33.a(this, this.cq.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), buq.e));
               this.b($$33, $$33.a(this, this.c.cR().g(1.0), buq.e));
               this.b($$33, $$33.a(this, this.ck.cR().g(1.0), buq.e));
            }

            float $$34 = azm.a(this.dL() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$35 = azm.b(this.dL() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$36 = this.gl();
   ...
   private void a(cjs $$0, double $$1, double $$2, double $$3) {
   ...
   private void gm() {
      ...
      if (this.ae.a(10) == 0) {
         List<cju> $$0 = this.dV().a(cju.class, this.cR().g(32.0));
         cju $$1 = null;
   ...
   private void a(arp $$0, List<bul> $$1) {
   ...
   private void b(arp $$0, List<bul> $$1) {
      for (bul $$2 : $$1) {
         if ($$2 instanceof bvh) {
            btb $$3 = this.dW().b((bvh)this);
            $$2.a($$0, $$3, 10.0F);
            dcf.a($$0, $$2, $$3);
         }
      }
   ...
   public boolean a(arp $$0, cjs $$1, btb $$2, float $$3) {
      if (this.ct.a().h() == ckl.j) {
         return false;
      } else {
         $$3 = this.ct.a().a($$2, $$3);
         if ($$1 != this.c) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof cou || $$2.a(axe.y)) {
               float $$4 = this.eD();
               this.c($$0, $$2, $$3);
   ...
   protected void c(arp $$0, btb $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void el() {
      ...
      if (this.dV() instanceof arp $$4) {
         if (this.bZ > 150 && this.bZ % 5 == 0 && $$4.N().b(dfi.f)) {
            bux.a($$4, this.dt(), azm.d((float)$$3 * 0.08F));
         }
      ...
      this.a(bvl.a, new ezy(0.0, 0.1F, 0.0));
      if (this.bZ == 200 && this.dV() instanceof arp $$5) {
         if ($$5.N().b(dfi.f)) {
            bux.a($$5, this.dt(), azm.d((float)$$3 * 0.2F));
         }
   ...
   public int v() {
      if (this.cw[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dV().a(ebq.a.f, new jh($$3, 0, $$4)).v() + $$1);
            this.cw[$$0] = new esh($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      esh $$5 = new esh(azm.a($$0), azm.a($$1), azm.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public esj a(int $$0, int $$1, @Nullable esh $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         esh $$4 = this.cw[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private esj a(esh $$0, esh $$1) {
      ...
      return new esj($$2, new jh($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ul $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.ct.a(ckl.a($$0.h("DragonPhase")));
      }
   ...
   public ezy J(float $$0) {
      ckf $$1 = this.ct.a();
      ckl<? extends ckf> $$2 = $$1.h();
      ezy $$8;
      if ($$2 == ckl.d || $$2 == ckl.e) {
         jh $$3 = this.dV().a(ebq.a.f, eev.a(this.cs));
   ...
   public void a(arp $$0, cju $$1, jh $$2, btb $$3) {
      cou $$4;
      if ($$3.d() instanceof cou) {
         $$4 = (cou)$$3.d();
      } else {
