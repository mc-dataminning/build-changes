...
public class ff implements ArgumentType<ff.a> {
   ...
   public static Collection<GameProfile> a(CommandContext<eq> $$0, String $$1) throws CommandSyntaxException {
      return ((ff.a)$$0.getArgument($$1, ff.a.class)).getNames((eq)$$0.getSource());
   }
   ...
   public ff.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '@') {
         ...
         hf $$2 = $$1.t();
         if ($$2.b()) {
            throw fd.c.createWithContext($$0);
         } else {
            return new ff.b($$2);
         }
      } else {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      if ($$0.getSource() instanceof ev) {
         ...
         return $$3.a($$1, $$1x -> ev.b(((ev)$$0.getSource()).q(), $$1x));
      } else {
   ...
   @FunctionalInterface
   public interface a {
      Collection<GameProfile> getNames(eq var1) throws CommandSyntaxException;
   }
