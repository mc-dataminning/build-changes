public class fdo extends fdb<cib> implements ffw {
   private static final agt x = new agt("textures/gui/container/crafting_table.png");
   private final ffq y = new ffq();
   private boolean z;

   public fdo(cib $$0, ceq $$1, vb $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aP_() {
      ...
      this.d(new ewt(this.t + 5, this.h / 2 - 49, 20, 18, ffq.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
