public class fdo extends fbo<bwq> implements fag {
   private final fee a;
   private final fee b;
   private final fee f;
   private final fee g;
   ...
   public static fek b() {
      ...
      fen $$3 = $$2.a(
         "body",
         fej.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new fei(0.0F)).a(0, 16).a(-1.5F, 1.0F, -1.0F, 3.0F, 5.0F, 2.0F, new fei(-0.2F)),
         feg.a(0.0F, 20.0F, 0.0F)
      );
   ...
   public void a(bwq $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      float $$6 = apa.b($$3 * 5.5F * (float) (Math.PI / 180.0)) * 0.1F;
      ...
      this.i.f = 1.0995574F + apa.b($$3 * 45.836624F * (float) (Math.PI / 180.0)) * (float) (Math.PI / 180.0) * 16.2F;
      this.h.f = -this.i.f;
