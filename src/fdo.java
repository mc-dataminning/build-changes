...
public class fdo {
   ...
   @Nullable
   private fdo v;
   private final List<fdo> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fdo(fdm $$0, evh $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(evt $$0, List<vk> $$1) {
   ...
   public void a(ewt $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
