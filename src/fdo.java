...
public class fdo implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fdo.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fdo(List<fdo.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fdo a(BufferedReader $$0) {
      return new fdo($$0.lines().flatMap($$0x -> fdo.a.a($$0x).stream()).toList());
   }

   public static record a(fdo.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fdo.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fdo.a(fdo.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fdo.a(fdo.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fdo.a(fdo.b.b, $$3));
      ...
      static fdo.a b(String $$0) {
         return new fdo.a(fdo.b.a, "glob:" + $$0);
      }

      static fdo.a c(String $$0) {
         return new fdo.a(fdo.b.a, "regex:" + $$0);
      }

      static fdo.a d(String $$0) {
         return new fdo.a(fdo.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fdo.b a = FileSystem::getPathMatcher;
      fdo.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
