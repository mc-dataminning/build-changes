...
public class hnx {
   ...
   public static class a extends Thread {
      private final hnx.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hnx.b $$0) throws IOException {
         super("LanServerDetector #" + hnx.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new s(hnx.b));
   ...
   public static class b {
      private final List<hnw> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hnw> a() {
         if (this.b) {
            List<hnw> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
