...
public class ain {
   ...
   private static int a(dt $$0, Collection<akt> $$1, gw $$2, float $$3) {
      aex<cpx> $$4 = $$0.e().ac();
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> tn.a("commands.spawnpoint.success.single", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.iterator().next().N_()), true);
      } else {
         $$0.a(() -> tn.a("commands.spawnpoint.success.multiple", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.size()), true);
      }
