...
public class ain {
   ...
   private static final List<aev<clk>> b = List.of(
      cll.a, cll.b, cll.c, cll.d, cll.e, cll.f, cll.g, cll.h, cll.i, cll.j, cll.k, cll.l, cll.m, cll.n, cll.o, cll.p
   );
   private static final List<aev<cli>> c = List.of(clj.a, clj.b, clj.c, clj.d, clj.e, clj.f, clj.g, clj.h, clj.i, clj.j);
   private static final ToIntFunction<aev<clk>> d = ac.e(b);
   private static final ToIntFunction<aev<cli>> e = ac.e(c);
   ...
   private static int a(dt $$0, cbu $$1) {
      cpv $$2 = $$1.dL();
      hn<clh> $$3 = hn.a();
      hq<clk> $$4 = $$2.G_().d(jc.aE);
      hq<cli> $$5 = $$2.G_().d(jc.aD);
      $$4.s()
