...
public class ain {
   ...
   private static int a(ds $$0, String $$1, @Nullable vf $$2) throws CommandSyntaxException {
   ...
   private static int b(ds $$0, String $$1, @Nullable vf $$2) throws CommandSyntaxException {
      ...
      if ($$3.a($$1)) {
         ...
         if (!$$4.isEmpty()) {
            $$0.a(() -> vf.a("commands.banip.info", $$4.size(), ge.a($$4)), true);
         }

         for (ane $$6 : $$4) {
            $$6.c.b(vf.c("multiplayer.disconnect.ip_banned"));
         }
