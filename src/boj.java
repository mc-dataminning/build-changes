...
public record boj(Instant a, String b, long c) {
   ...
   public static boj a(RecordedEvent $$0) {
      ...
      return new boj($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static boj.a a(List<boj> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<boj>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            boj $$3 = (boj)$$2x.get(0);
            boj $$4 = (boj)$$2x.get($$2x.size() - 1);
