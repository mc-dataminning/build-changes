...
public class boj {
   ...
   private boj(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static boj a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new boj($$0, $$1);
   }

   public boj.d a() throws IOException {
      boj.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new boj.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private boj.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         boj.c $$3 = boj.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new boj.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new boj.a($$0, $$3);
            }
         }
   ...
   public boj.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<boj.c> $$2 = this.a().c();
      ...
      boj.e $$4 = new boj.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, boj.c b) implements boj.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static boj.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new boj.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<boj.b> {
      private final List<boj.b> a;

      d(List<boj.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public boj.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            boj.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  boj.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public boj.d a() {
         ListIterator<boj.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               boj.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<boj.b> iterator() {
         return this.a.iterator();
      }

      public Stream<boj.b> b() {
         return this.a.stream();
      }

      public Set<boj.c> c() {
         return this.a.stream().map(boj.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, boj.c b) implements boj.b {
