...
public class drx {
   ...
   public drx(dbw $$0, iz $$1, je $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dsa $$0 = this.b.a_(this.e);
      if (!drt.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eny.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dsa $$0) {
      return $$0.a(dez.hV) || $$0.a(dez.pg);
   }

   private static boolean a(dsa $$0, dsa $$1) {
      if ($$0.a(dez.pg) && $$1.a(dez.hV)) {
         return false;
      } else {
         return $$0.a(dez.hV) && $$1.a(dez.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(iz $$0, je $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!drt.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dsa $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !drt.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!drt.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
