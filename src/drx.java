...
public class drx implements drz {
   public static final Codec<drx> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bic.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bic.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bic.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bia.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bia.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public drx(int $$0, bic $$1, bic $$2, int $$3, int $$4, bic $$5, bia $$6, bia $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
