...
public class cuu {
   ...
   public static final cuu b = new cuu(0, 0);
   ...
   public static cuu a(int $$0, int $$1) {
      return new cuu($$0 << 5, $$1 << 5);
   }

   public static cuu b(int $$0, int $$1) {
      return new cuu(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cuu $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public static Stream<cuu> a(cuu $$0, int $$1) {
      return a(new cuu($$0.e - $$1, $$0.f - $$1), new cuu($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cuu> a(final cuu $$0, final cuu $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cuu>((long)($$2 * $$3), 64) {
         @Nullable
         private cuu e;

         @Override
         public boolean tryAdvance(Consumer<? super cuu> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cuu($$0.e, $$2 + $$5);
               } else {
                  this.e = new cuu($$1 + $$4, $$2);
               }
            }
