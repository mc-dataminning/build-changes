...
public interface hg<T> extends hf<T> {
   ...
   default Stream<acp<T>> c() {
      return this.b().map(he.c::g);
   }

   Stream<hi.c<T>> d();

   default Stream<anl<T>> e() {
   ...
   public interface b {
      <T> Optional<hg.c<T>> a(acp<? extends hr<? extends T>> var1);

      default <T> hg.c<T> b(acp<? extends hr<? extends T>> $$0) {
      ...
      default hf.a a() {
         return new hf.a() {
            @Override
            public <T> Optional<hf<T>> a(acp<? extends hr<? extends T>> $$0) {
      ...
      static hg.b a(Stream<hg.c<?>> $$0) {
         final Map<acp<? extends hr<?>>, hg.c<?>> $$1 = $$0.collect(Collectors.toUnmodifiableMap(hg.c::f, $$0x -> $$0x));
         return new hg.b() {
            @Override
            public <T> Optional<hg.c<T>> a(acp<? extends hr<? extends T>> $$0) {
   ...
   public interface c<T> extends hg<T>, hh<T> {
      acp<? extends hr<? extends T>> f();

      Lifecycle g();

      default hg<T> a(caw $$0) {
         return (hg<T>)(cat.bv.contains(this.f()) ? this.a($$1 -> ((cat)$$1).a($$0)) : this);
      }
