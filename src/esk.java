public abstract class esk extends eso implements ets, euk {
   private static final euc a = new euc(new aew("widget/text_field"), new aew("widget/text_field_highlighted"));
   private static final aew b = new aew("widget/scroller");
   ...
   private int w() {
      return arw.a((int)((float)(this.g * this.g) / (float)this.x()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = arw.a($$0, 0.0, (double)this.d());
   }
