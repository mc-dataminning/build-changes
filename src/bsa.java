...
public abstract class bsa extends btk {
   private static final ajp<Boolean> ca = ajt.a(bsa.class, ajr.k);
   ...
   protected bsa(bsm<? extends bsa> $$0, dcf $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bsa a(aqm var1, bsa var2);
   ...
   protected void k() {
      if (!this.p_() && this.bS() && this.dd() instanceof coh $$0 && !$$0.b((bsg)this)) {
         this.ac();
      }
   }
