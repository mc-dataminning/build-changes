...
public abstract class cox extends bvh {
   ...
   private static final Map<bvt, buo> c = ImmutableMap.builder()
      ...
      .build();
   private static final ajy<Float> d = akc.a(cox.class, aka.d);
   private static final ajy<Integer> e = akc.a(cox.class, aka.b);
   protected static final ajy<Byte> bW = akc.a(cox.class, aka.a);
   protected static final ajy<Byte> bX = akc.a(cox.class, aka.a);
   protected static final ajy<tq> bY = akc.a(cox.class, aka.t);
   protected static final ajy<tq> bZ = akc.a(cox.class, aka.t);
   ...
   private void c(@Nullable tq $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dV().A.a(200) == 0) {
         String $$1 = $$0.l("id");
         bus.a($$1).filter($$0x -> $$0x == bus.aO).ifPresent($$0x -> {
   ...
   public void a(tq $$0) {
      ...
      this.ce.a($$0);
      this.j.b($$0);
      this.g(bwp.v).a((double)this.j.b());
      if ($$0.b("EnderItems", 9)) {
      ...
      if (this.Z_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.f() && $$0 instanceof bvh) {
               ...
               if ($$5.a()) {
                  this.dV().a(ebt.r, $$0.dt(), ebt.a.a(this));
                  if ($$2.f() && !this.j.d) {
                     this.a($$1, cwp.j);
                  }
   ...
   protected fba a(fba $$0, bvl $$1) {
      float $$2 = this.dP();
      if (!this.j.b && !($$0.e > 0.0) && ($$1 == bvl.a || $$1 == bvl.b) && this.ga() && this.I($$2)) {
         double $$3 = $$0.d;
         double $$4 = $$0.f;
         double $$5 = 0.05;
   ...
   private boolean b(double $$0, double $$1, float $$2) {
      fav $$3 = this.cR();
      return this.dV().a(this, new fav($$3.a + $$0, $$3.b - (double)$$2 - 1.0E-5F, $$3.c + $$1, $$3.d + $$0, $$3.b, $$3.f + $$1));
   }

   public void e(bul $$0) {
      if ($$0.cB()) {
         if (!$$0.v(this)) {
            float $$1 = this.fv() ? this.bC : (float)this.h(bwp.c);
            cwp $$2 = this.dZ();
            ...
            if ($$1 > 0.0F || $$4 > 0.0F) {
               ...
               if ($$7 && !$$10 && !$$8 && this.aJ()) {
                  ...
                  if ($$13 < ayz.k($$14) && this.b(bsj.a).a(awy.bG)) {
                     $$12 = true;
                  }
               }
   ...
   @Override
   public bvh.a eM() {
      return new bvh.a(awa.uR, awa.uH);
   }
   ...
   @Override
   protected bul.c bg() {
      return this.j.b || this.aJ() && this.cg() ? bul.c.a : bul.c.d;
   }
   ...
   public cwp a(but $$0) {
      if ($$0 == but.a) {
         ...
         return $$0.a() == but.a.b ? this.g.h.get($$0.b()) : cwp.j;
      }
   }
   ...
   public bvz a_(int $$0) {
      if ($$0 == 499) {
         ...
         if ($$1 >= 0 && $$1 < 4) {
            ...
            int $$2 = $$0 - 200;
            return $$2 >= 0 && $$2 < this.cb.b() ? bvz.a(this.cb, $$2) : super.a_($$0);
         }
      }
   }
   ...
   public fba u(float $$0) {
      double $$1 = 0.22 * (this.fy() == bvb.b ? -1.0 : 1.0);
