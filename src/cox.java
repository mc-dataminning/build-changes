...
public abstract class cox extends bvg {
   private static final Logger a = LogUtils.getLogger();
   public static final bva bG = bva.b;
   ...
   public static final fba bU = new fba(0.0, 0.6, 0.0);
   public static final bun bV = bun.b(0.6F, 1.8F).b(1.62F).a(bum.a().a(bul.b, bU));
   private static final Map<bvs, bun> c = ImmutableMap.builder()
      .put(bvs.a, bV)
      .put(bvs.c, aD)
      .put(bvs.b, bun.b(0.6F, 0.6F).b(0.4F))
      .put(bvs.d, bun.b(0.6F, 0.6F).b(0.4F))
      .put(bvs.e, bun.b(0.6F, 0.6F).b(0.4F))
      .put(bvs.f, bun.b(0.6F, 1.5F).b(1.27F).a(bum.a().a(bul.b, bU)))
      .put(bvs.h, bun.c(0.2F, 0.2F).b(1.62F))
      .build();
   private static final ajx<Float> d = akb.a(cox.class, ajz.d);
   private static final ajx<Integer> e = akb.a(cox.class, ajz.b);
   protected static final ajx<Byte> bW = akb.a(cox.class, ajz.a);
   protected static final ajx<Byte> bX = akb.a(cox.class, ajz.a);
   protected static final ajx<tq> bY = akb.a(cox.class, ajz.t);
   protected static final ajx<tq> bZ = akb.a(cox.class, ajz.t);
   public static final int ca = 60;
   private long f;
   final cow g = new cow(this);
   protected ctq cb = new ctq();
   public final ctf cc;
   public csc cd;
   protected cry ce = new cry();
   protected int cf;
   ...
   private boolean cD;
   private cwp cE = cwp.j;
   private final cwm cF = this.g();
   ...
   public cox(dgi $$0, ji $$1, float $$2, GameProfile $$3) {
      super(bur.bS, $$0);
      this.a_($$3.getId());
      this.cC = $$3;
      this.cc = new ctf(this.g, !$$0.C, this);
      this.cd = this.cc;
      this.b((double)$$1.u() + 0.5, (double)($$1.v() + 1), (double)$$1.w() + 0.5, $$2, 0.0F);
      this.bk = 180.0F;
   }

   public boolean a(dgi $$0, ji $$1, dgf $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == dgf.d) {
         return true;
         ...
         cwp $$3 = this.eZ();
         return $$3.f() || !$$3.b(new dxb($$0, $$1, false));
      }
   }

   public static bwn.a fX() {
      return bvg.ee().a(bwo.c, 1.0).a(bwo.v, 0.1F).a(bwo.e).a(bwo.q).a(bwo.g, 4.5).a(bwo.j, 3.0).a(bwo.f).a(bwo.C).a(bwo.z).a(bwo.t).a(bwo.D);
   }
   ...
   public void h() {
      ...
      int $$1 = 29999999;
      double $$2 = ayz.a(this.dB(), -2.9999999E7, 2.9999999E7);
      double $$3 = ayz.a(this.dH(), -2.9999999E7, 2.9999999E7);
   ...
   private void m() {
      this.a(new btp(btr.m, 200, 0, false, false, true));
   }

   private boolean c(cwl $$0) {
      for (bus $$1 : bus.i) {
         cwp $$2 = this.a($$1);
         deu $$3 = $$2.a(kv.D);
   ...
   public void d_() {
      ...
      if (this.eE() > 0.0F && !this.Z_()) {
         ...
         List<buk> $$4 = this.dW().a_(this, $$2);
         List<buk> $$5 = Lists.newArrayList();
   ...
   private void c(@Nullable tq $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dW().A.a(200) == 0) {
         String $$1 = $$0.l("id");
         bur.a($$1).filter($$0x -> $$0x == bur.aP).ifPresent($$0x -> {
            if (!chn.a(this.dW(), this)) {
               this.dW().a(null, this.dB(), this.dD(), this.dH(), chn.a(this.dW(), this.dW().A), this.dn(), 1.0F, chn.a(this.dW().A));
            }
         });
      }
   }
   ...
   public void a(int $$0, float $$1, cwp $$2) {
      this.bB = $$0;
      this.bC = $$1;
      this.bD = $$2;
      if (!this.dW().C) {
   ...
   public void a(bta $$0) {
      ...
      if ($$0 != null) {
         this.n(
            (double)(-ayz.b((this.eK() + this.dM()) * (float) (Math.PI / 180.0)) * 0.1F),
            0.1F,
            (double)(-ayz.a((this.eK() + this.dM()) * (float) (Math.PI / 180.0)) * 0.1F)
         );
      } else {
         this.n(0.0, 0.1, 0.0);
      }
   ...
   public float c(dwx $$0) {
      float $$1 = this.g.a($$0);
      if ($$1 > 1.0F) {
         $$1 += (float)this.h(bwo.t);
      }

      if (btq.a(this)) {
         $$1 *= 1.0F + (float)(btq.b(this) + 1) * 0.2F;
      }

      if (this.b(btr.d)) {
         float $$2 = switch (this.c(btr.d).e()) {
            case 0 -> 0.3F;
            case 1 -> 0.09F;
            case 2 -> 0.0027F;
            default -> 8.1E-4F;
      ...
      $$1 *= (float)this.h(bwo.f);
      if (this.a(awv.a)) {
         $$1 *= (float)this.g(bwo.C).g();
      }
   ...
   public void a(tq $$0) {
      ...
      this.ce.a($$0);
      this.j.b($$0);
      this.g(bwo.v).a((double)this.j.b());
      if ($$0.b("EnderItems", 9)) {
      ...
      if ($$0.b("current_explosion_impact_pos", 9)) {
         fba.a.parse(ue.a, $$0.c("current_explosion_impact_pos")).resultOrPartial(a::error).ifPresent($$0x -> this.cy = $$0x);
      }
   ...
   public void b(tq $$0) {
      ...
      if (this.cy != null) {
         $$0.a("current_explosion_impact_pos", (un)fba.a.encodeStart(ue.a, this.cy).getOrThrow());
      }
   ...
   public boolean a(arc $$0, bta $$1) {
      if (super.a($$0, $$1)) {
         ...
         return $$1.a(awr.o) ? !$$0.O().b(dge.K) : false;
      }
   }
   ...
   protected void c(bta $$0, float $$1) {
      this.a($$0, $$1, new bus[]{bus.c, bus.d, bus.e, bus.f});
   }

   @Override
   protected void d(bta $$0, float $$1) {
      this.a($$0, $$1, new bus[]{bus.f});
   }
   ...
   public bsj a(buk $$0, bsi $$1) {
      if (this.Z_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.f() && $$0 instanceof bvg) {
               if (this.j.d) {
                  $$2 = $$3;
               }

               bsj $$5 = $$2.a(this, (bvg)$$0, $$1);
               if ($$5.a()) {
                  this.dW().a(ebt.r, $$0.du(), ebt.a.a(this));
                  if ($$2.f() && !this.j.d) {
                     this.a($$1, cwp.j);
                  }
   ...
   protected fba a(fba $$0, bvk $$1) {
      float $$2 = this.dQ();
      if (!this.j.b && !($$0.e > 0.0) && ($$1 == bvk.a || $$1 == bvk.b) && this.ga() && this.I($$2)) {
         double $$3 = $$0.d;
         double $$4 = $$0.f;
         double $$5 = 0.05;
   ...
   private boolean b(double $$0, double $$1, float $$2) {
      fav $$3 = this.cR();
      return this.dW().a(this, new fav($$3.a + $$0, $$3.b - (double)$$2 - 1.0E-5F, $$3.c + $$1, $$3.d + $$0, $$3.b, $$3.f + $$1));
   }

   public void e(buk $$0) {
      if ($$0.cB()) {
         if (!$$0.v(this)) {
            float $$1 = this.fv() ? this.bC : (float)this.h(bwo.c);
            cwp $$2 = this.ea();
            bta $$3 = Optional.ofNullable($$2.h().a(this)).orElse(this.dX().a(this));
            float $$4 = this.a($$0, $$1, $$3) - $$1;
            float $$5 = this.H(0.5F);
            $$1 *= 0.2F + $$5 * $$5 * 0.8F;
            $$4 *= $$5;
            this.gD();
            if ($$0.aq().a(awt.H) && $$0 instanceof cpq $$6 && $$6.a(cpr.c, this, this, true)) {
               this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uD, this.dn());
               return;
            }
            ...
            if ($$1 > 0.0F || $$4 > 0.0F) {
               ...
               boolean $$8;
               if (this.cj() && $$7) {
                  this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uC, this.dn(), 1.0F, 1.0F);
                  $$8 = true;
               } else {
                  $$8 = false;
               }
               ...
               if ($$7 && !$$10 && !$$8 && this.aJ()) {
                  ...
                  if ($$13 < ayz.k($$14) && this.b(bsi.a).a(awy.bH)) {
                     $$12 = true;
                  }
               }

               float $$15 = 0.0F;
               if ($$0 instanceof bvg $$16) {
                  $$15 = $$16.eE();
               }
               ...
               if ($$18) {
                  ...
                  if ($$19 > 0.0F) {
                     if ($$0 instanceof bvg $$20) {
                        $$20.p(
                           (double)($$19 * 0.5F), (double)ayz.a(this.dM() * (float) (Math.PI / 180.0)), (double)(-ayz.b(this.dM() * (float) (Math.PI / 180.0)))
                        );
                     } else {
                        $$0.j(
                           (double)(-ayz.a(this.dM() * (float) (Math.PI / 180.0)) * $$19 * 0.5F),
                           0.1,
                           (double)(ayz.b(this.dM() * (float) (Math.PI / 180.0)) * $$19 * 0.5F)
                        );
                     }
                  ...
                  if ($$12) {
                     float $$21 = 1.0F + (float)this.h(bwo.D) * $$1;

                     for (bvg $$23 : this.dW().a(bvg.class, $$0.cR().c(1.0, 0.25, 1.0))) {
                        if ($$23 != this && $$23 != $$0 && !this.s($$23) && (!($$23 instanceof ckq) || !((ckq)$$23).x()) && this.g((buk)$$23) < 9.0) {
                           float $$24 = this.a($$23, $$21, $$3) * $$5;
                           $$23.p(0.4F, (double)ayz.a(this.dM() * (float) (Math.PI / 180.0)), (double)(-ayz.b(this.dM() * (float) (Math.PI / 180.0))));
                           $$23.a($$3, $$24);
                     ...
                     this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uF, this.dn(), 1.0F, 1.0F);
                     this.gf();
                  }
                  ...
                  if ($$10) {
                     this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uB, this.dn(), 1.0F, 1.0F);
                     this.b($$0);
                  }

                  if (!$$10 && !$$12) {
                     if ($$7) {
                        this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uE, this.dn(), 1.0F, 1.0F);
                     } else {
                        this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uG, this.dn(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  if (!this.dW().C && !$$2.f() && $$26 instanceof bvg) {
                     if ($$27) {
                        $$2.b((bvg)$$26, this);
                     }
                  ...
                  this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uD, this.dn(), 1.0F, 1.0F);
               }
            }
         }
      }
   ...
   public void gf() {
      double $$0 = (double)(-ayz.a(this.dM() * (float) (Math.PI / 180.0)));
      double $$1 = (double)ayz.b(this.dM() * (float) (Math.PI / 180.0));
   ...
   @Override
   public bvg.a eM() {
      return new bvg.a(awa.uR, awa.uH);
   }
   ...
   public void c(int $$0) {
      ...
      if ($$0 > 0 && this.cr % 5 == 0 && (float)this.k < (float)this.af - 100.0F) {
         ...
         this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.uQ, this.dn(), $$1 * 0.75F, 1.0F);
         this.k = this.af;
      }
   }
   ...
   public boolean a(ji $$0, jn $$1, cwp $$2) {
      if (this.j.e) {
         return true;
      } else {
         ji $$3 = $$0.a($$1.g());
         dxb $$4 = new dxb(this.dW(), $$3, false);
         return $$2.a($$4);
      }
   }
   ...
   protected int e(arc $$0) {
      return !$$0.O().b(dge.d) && !this.Z_() ? Math.min(this.cr * 7, 100) : 0;
   }
   ...
   @Override
   protected buk.c bg() {
      return this.j.b || this.aJ() && this.cg() ? buk.c.a : buk.c.d;
   }
   ...
   public cwp a(bus $$0) {
      if ($$0 == bus.a) {
         ...
         return $$0.a() == bus.a.b ? this.g.h.get($$0.b()) : cwp.j;
      }
   }
   ...
   public Iterable<cwp> fc() {
      return Lists.newArrayList(new cwp[]{this.eZ(), this.fa()});
   }
   ...
   private void k(tq $$0) {
      if (!this.dW().C && !$$0.g()) {
         bur.a($$0, this.dW(), buq.r).ifPresent($$0x -> {
            if ($$0x instanceof bwd) {
               ((bwd)$$0x).b(this.at);
            }
      ...
      if ($$0 == 499) {
         ...
         if ($$1 >= 0 && $$1 < 4) {
            return new bvy() {
               @Override
               public cwp a() {
                  return cox.this.cc.r().a($$1);
               }

               @Override
               public boolean a(cwp $$0) {
                  cox.this.cc.r().a($$1, $$0);
                  cox.this.cc.a(cox.this.g);
                  return true;
               }
            };
         } else if ($$0 >= 0 && $$0 < this.g.g.size()) {
            return bvy.a(this.g, $$0);
         } else {
            int $$2 = $$0 - 200;
            return $$2 >= 0 && $$2 < this.cb.b() ? bvy.a(this.cb, $$2) : super.a_($$0);
         }
      }
   }
   ...
   @Override
   public bva fy() {
      return this.al.a(bX) == 0 ? bva.a : bva.b;
   }

   public void b(bva $$0) {
      this.al.a(bX, (byte)($$0 == bva.a ? 0 : 1));
   }
   ...
   public float gC() {
      return (float)(1.0 / this.h(bwo.e) * 20.0);
   }
   ...
   public ImmutableList<bvs> fO() {
      return ImmutableList.of(bvs.a, bvs.f, bvs.d);
   }
   ...
   public cwp d(cwp $$0) {
      if (!($$0.h() instanceof cxl)) {
         ...
         if (!$$2.f()) {
            ...
            return this.j.d ? new cwp(cwt.pb) : cwp.j;
         }
      }
   }
   ...
   public fba u(float $$0) {
      double $$1 = 0.22 * (this.fy() == bva.b ? -1.0 : 1.0);
      ...
      if (this.fJ() || this.fv()) {
         ...
         return this.o($$0).e(new fba($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.cl()) {
         return this.o($$0).e(new fba($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cR().c() - 1.0;
         double $$13 = this.ci() ? -0.2 : 0.07;
         return this.o($$0).e(new fba($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean gH() {
      return this.fz() && this.fB().a(cwt.rU);
   }
   ...
   public boolean b(buk $$0, double $$1) {
      return $$0.dR() ? false : this.a($$0.cR(), $$1);
   }

   public boolean a(fav $$0, double $$1) {
      double $$2 = this.gM() + $$1;
   ...
   public boolean a(ji $$0, double $$1) {
      double $$2 = this.gL() + $$1;
      return new fav($$0).e(this.bF()) < $$2 * $$2;
   }
