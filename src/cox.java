...
public class cox extends cpi implements bur<cox.b> {
   private static final akk<Integer> i = ako.a(cox.class, akm.b);
   private static final akk<Boolean> j = ako.a(cox.class, akm.k);
   private static final akk<Boolean> k = ako.a(cox.class, akm.k);
   private static final akk<Integer> l = ako.a(cox.class, akm.b);
   ...
   public cox(btc<? extends cox> $$0, dca $$1) {
      super($$0, $$1);
      this.J = true;
   }

   public cox(dca $$0, double $$1, double $$2, double $$3) {
      this(btc.k, $$0);
      this.a_($$1, $$2, $$3);
      this.L = $$1;
      this.M = $$2;
   ...
   public static boolean a(bsw $$0, bsw $$1) {
   ...
   protected evt a(bsw $$0, bsz $$1, float $$2) {
      ...
      return new evt(0.0, this.x() == cox.b.i ? (double)($$1.b() * 0.8888889F) : (double)($$1.b() / 3.0F), (double)$$3)
   ...
   public void l() {
      this.aO = this.aN;
      this.aN = this.B();
      if (this.aN != cox.a.b && this.aN != cox.a.c) {
         this.q = 0.0F;
      } else {
         this.q++;
      }
      ...
      this.aS();
      List<bsw> $$5 = this.dP().a(this, this.cK().c(0.2F, -0.01F, 0.2F), btb.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dP().B && !(this.cQ() instanceof cmz);

         for (bsw $$7 : $$5) {
            if (!$$7.x(this)) {
               if ($$6 && this.cS().size() < this.y() && !$$7.bR() && this.b($$7) && $$7 instanceof btr && !($$7 instanceof cgj) && !($$7 instanceof cmz)) {
                  $$7.n(this);
               } else {
                  this.h($$7);
               }
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aR) {
                  ...
                  this.o($$3.c, this.a($$0 -> $$0 instanceof cmz) ? 2.7 : 0.6, $$3.e);
               }
            }
      ...
      for (int $$8 = $$3; $$8 < $$4; $$8++) {
         ...
         for (int $$10 = $$1; $$10 < $$2; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               enx $$12 = this.dP().b_($$7);
               if ($$12.a(awv.a)) {
                  $$9 = Math.max($$9, $$12.a((dbg)this.dP(), $$7));
               }
   ...
   public float v() {
      evo $$0 = this.cK();
      evo $$1 = new evo($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = ayz.a($$1.a) - 1;
      int $$3 = ayz.c($$1.d) + 1;
      int $$4 = ayz.a($$1.b) - 1;
      int $$5 = ayz.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dse $$16 = this.dP().a_($$11);
                     if (!($$16.b() instanceof doe) && ewj.c($$16.k(this.dP(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, evx.i)) {
                        $$9 += $$16.b().h();
                        $$10++;
                     }
                  }
      ...
      for (int $$9 = $$1; $$9 < $$2; $$9++) {
         for (int $$10 = $$3; $$10 < $$4; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               enx $$12 = this.dP().b_($$8);
               if ($$12.a(awv.a)) {
                  float $$13 = (float)$$10 + $$12.a((dbg)this.dP(), $$8);
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               enx $$13 = this.dP().b_($$9);
               if ($$13.a(awv.a) && $$1 < (double)((float)$$9.v() + $$13.a((dbg)this.dP(), $$9))) {
                  if (!$$13.b()) {
                     return cox.a.c;
                  }
   ...
   private void E() {
      ...
      double $$1 = 0.0;
      this.p = 0.05F;
      if (this.aO == cox.a.e && this.aN != cox.a.e && this.aN != cox.a.d) {
         this.aL = this.e(1.0);
         ...
         if (this.aN == cox.a.a) {
            ...
            this.p = 0.9F;
         } else if (this.aN == cox.a.c) {
            $$0 = -7.0E-4;
            this.p = 0.9F;
         } else if (this.aN == cox.a.b) {
            $$1 = 0.01F;
            this.p = 0.45F;
         } else if (this.aN == cox.a.e) {
            this.p = 0.9F;
         } else if (this.aN == cox.a.d) {
            this.p = this.aM;
            if (this.cQ() instanceof cmz) {
               this.aM /= 2.0F;
            }
         }
   ...
   protected void a(bsw $$0, bsw.a $$1) {
      ...
      if (!$$0.ak().a(awt.s)) {
         ...
         $$0.n($$0.cs() + this.r);
         this.c($$0);
         if ($$0 instanceof cfh && this.cS().size() == this.y()) {
            int $$2 = $$0.al() % 2 == 0 ? 90 : 270;
            $$0.o(((cfh)$$0).aY + (float)$$2);
            $$0.n($$0.cs() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public evt b(btr $$0) {
      evt $$1 = a((double)(this.dj() * ayz.g), (double)$$0.dj(), $$0.dF());
      double $$2 = this.du() + $$1.c;
      double $$3 = this.dA() + $$1.e;
      iz $$4 = iz.a($$2, this.cK().e, $$3);
      iz $$5 = $$4.d();
      if (!this.dP().z($$5)) {
         List<evt> $$6 = Lists.newArrayList();
         double $$7 = this.dP().j($$4);
         if (cpa.a($$7)) {
            $$6.add(new evt($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dP().j($$5);
         if (cpa.a($$8)) {
            $$6.add(new evt($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fI().iterator();

         while (var14.hasNext()) {
            bud $$9 = (bud)var14.next();

            for (evt $$10 : $$6) {
               if (cpa.a(this.dP(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   public void a(cox.b $$0) {
      this.ao.a(i, $$0.ordinal());
   }

   public cox.b x() {
      return cox.b.a(this.ao.a(i));
   }
   ...
   @Override
   public btr cQ() {
      return this.cT() instanceof btr $$0 ? $$0 : super.cQ();
   }
   ...
   @Override
   public boolean bj() {
      return this.aN == cox.a.b || this.aN == cox.a.c;
   }

   @Override
   public cur dC() {
      return new cur(this.ag_());
   }
   ...
   public static enum b implements azu {
      ...
      private final dfb l;
      public static final azu.a<cox.b> j = azu.a(cox.b::values);
      private static final IntFunction<cox.b> m = axp.a(Enum::ordinal, values(), axp.a.a);

      private b(final dfb $$0, final String $$1) {
         this.k = $$1;
         this.l = $$0;
      }
      ...
      public static cox.b a(int $$0) {
         return m.apply($$0);
      }

      public static cox.b a(String $$0) {
         return j.a($$0, a);
      }
   }
}
