...
public class azt {
   ...
   private static final Optional<Object> b = Optional.of(bac.a);

   private static boolean a(ym $$0, aym $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, ym $$1, aym $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, ym $$1, aym $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, ym $$1, aym $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, ym $$2, aym $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, ym $$2, ym $$3, aym $$4) {
      int $$5 = $$0.length();
      ym $$6 = $$2;
   ...
   public static boolean a(xu $$0, ym $$1, aym $$2) {
