...
public class azt {
   ...
   private static final Optional<Object> b = Optional.of(bae.a);

   private static boolean a(xl $$0, ayl $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xl $$1, ayl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xl $$1, ayl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xl $$1, ayl $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xl $$2, ayl $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xl $$2, xl $$3, ayl $$4) {
      int $$5 = $$0.length();
      xl $$6 = $$2;
   ...
   public static boolean a(wt $$0, xl $$1, ayl $$2) {
