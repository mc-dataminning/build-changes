...
public class azt extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(bdt.A.typeName(), bfc.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(bdt.y), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(bdt.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
