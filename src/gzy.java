...
public class gzy extends ui {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gzy(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gzy a(ave $$0, List<String> $$1, boolean $$2) {
      ...
      uh.a().a($$3);
      return new gzy(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<avc> $$1, Map<String, String> $$2) {
      for (avc $$3 : $$1) {
