...
public class bbv extends DataFix {
   ...
   private static final ImmutableMap<String, bbv.a> j = ImmutableMap.builder()
      .put("minecraft:village", new bbv.a(32, 8, 10387312))
      .put("minecraft:desert_pyramid", new bbv.a(32, 8, 14357617))
      .put("minecraft:igloo", new bbv.a(32, 8, 14357618))
      .put("minecraft:jungle_pyramid", new bbv.a(32, 8, 14357619))
      .put("minecraft:swamp_hut", new bbv.a(32, 8, 14357620))
      .put("minecraft:pillager_outpost", new bbv.a(32, 8, 165745296))
      .put("minecraft:monument", new bbv.a(32, 5, 10387313))
      .put("minecraft:endcity", new bbv.a(20, 11, 10387313))
      .put("minecraft:mansion", new bbv.a(80, 20, 10387319))
      .build();
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WorldGenSettings building", this.getInputSchema().getType(bat.I), $$0 -> $$0.update(DSL.remainderFinder(), bbv::a));
   }
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> a(DynamicOps<T> $$0, OptionalDynamic<T> $$1) {
      ...
      Map<String, bbv.a> $$6 = Maps.newHashMap();
      if ($$1.result().isEmpty()) {
         $$5.setTrue();
         $$6.put("minecraft:village", (bbv.a)j.get("minecraft:village"));
      }
                        ...
                        switch ($$9) {
                           ...
                           case "separation":
                              if ("oceanmonument".equals($$8)) {
                                 bbv.a $$11 = $$6.getOrDefault("minecraft:monument", (bbv.a)j.get("minecraft:monument"));
                                 int $$12 = a($$10, $$11.c, 1);
                                 $$6.put("minecraft:monument", new bbv.a($$12, $$11.c, $$11.d));
                              }
      ...
      $$7.put(
         ...
         $$1.createMap(
            $$6.entrySet().stream().collect(Collectors.toMap($$1x -> $$1.createString((String)$$1x.getKey()), $$1x -> ((bbv.a)$$1x.getValue()).a($$0)))
         )
      );
      if ($$5.isTrue()) {
         $$7.put(
   ...
   private static void a(Map<String, bbv.a> $$0, String $$1, String $$2, int $$3) {
      bbv.a $$4 = $$0.getOrDefault($$1, (bbv.a)j.get($$1));
      int $$5 = a($$2, $$4.b, $$3);
      $$0.put($$1, new bbv.a($$5, $$4.c, $$4.d));
   }

   static final class a {
      public static final Codec<bbv.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
