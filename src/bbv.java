...
public class bbv extends bgn {
   public bbv(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bhs.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bhs.s, "minecraft:jukebox");
