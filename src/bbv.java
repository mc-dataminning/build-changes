...
public class bbv extends bht {
   ...
   public bbv(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", biz.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bbv::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bbv::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      $$0 = $$0.set("color", $$0.createString(bbd.a($$0.get("Color").asInt(0))));
