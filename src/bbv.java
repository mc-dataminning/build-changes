...
public class bbv extends beo {
   public bbv(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bfp.z, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bfp.B.typeName(), bgz.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bfp.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bfp.B.typeName(), "minecraft:saddle"));
