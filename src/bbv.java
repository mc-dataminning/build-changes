...
public class bbv extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhu.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bhu.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bhu.s);
