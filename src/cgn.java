...
public class cgn {
   ...
   private final Map<jr<cgo>, Set<cgm>> c = Maps.newHashMap();
   ...
   public Stream<cgm> a(Predicate<jr<cgo>> $$0, cgl.b $$1) {
      return this.c.entrySet().stream().filter($$1x -> $$0.test((jr<cgo>)$$1x.getKey())).flatMap($$0x -> ((Set)$$0x.getValue()).stream()).filter($$1.a());
   }
   ...
   public void a(ji $$0) {
      cgm $$1 = (cgm)this.b.remove(kk.b($$0));
      if ($$1 == null) {
   ...
   public Optional<jr<cgo>> d(ji $$0) {
      return this.e($$0).map(cgm::h);
   }

   private Optional<cgm> e(ji $$0) {
      return Optional.ofNullable((cgm)this.b.get(kk.b($$0)));
   }

   public void a(Consumer<BiConsumer<ji, jr<cgo>>> $$0) {
      if (!this.e) {
