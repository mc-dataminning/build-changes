...
public class evt {
   ...
   public wc a(vk $$0, int $$1) {
      evt.e $$2 = new evt.e((float)$$1);
      return $$0.<wc>a(($$1x, $$2x) -> avi.c($$2x, $$1x, $$2) ? Optional.empty() : Optional.of($$1x), wc.a).orElse(null);
   }

   @Nullable
   public wc a(atz $$0, int $$1) {
      evt.e $$2 = new evt.e((float)$$1);
   ...
   public vk a(vk $$0, int $$1, wc $$2) {
      final evt.e $$3 = new evt.e((float)$$1);
   ...
   public void a(String $$0, int $$1, wc $$2, boolean $$3, evt.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      wc $$7 = $$2;

      while ($$5 < $$6) {
         evt.b $$8 = new evt.b((float)$$1);
         boolean $$9 = avi.a($$0, $$5, $$7, $$2, $$8);
         if ($$9) {
            $$4.accept($$7, $$5, $$6);
            break;
         }
   ...
   public void a(vk $$0, int $$1, wc $$2, BiConsumer<vk, Boolean> $$3) {
      List<evt.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new evt.c($$2x, $$1x));
         }
      ...
      while ($$6) {
         $$6 = false;
         evt.b $$9 = new evt.b((float)$$1);

         for (evt.c $$10 : $$5.a) {
            boolean $$11 = avi.a($$10.c, 0, $$10.d, $$2, $$9);
            if (!$$11) {
               int $$12 = $$9.a();
               wc $$13 = $$9.b();
               char $$14 = $$5.a($$12);
   ...
   static class a {
      ...
      public vk a(int $$0, int $$1, wc $$2) {
         eux $$3 = new eux();
         ListIterator<evt.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, wc $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = evt.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements aua {
      ...
      @Override
      public boolean accept(int $$0, wc $$1, int $$2) {
         this.b = this.b - evt.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
