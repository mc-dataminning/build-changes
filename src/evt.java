...
public class evt extends gnd {
   ...
   private Long S;
   private long T;
   private final fda U = new fda(this);

   public evt(@Nullable ewq $$0, long $$1, int $$2, evm $$3, eit $$4) {
      super(exg.a);
      this.C = $$0;
      this.D = $$1;
      this.E = $$2;
   ...
   @Override
   public void aQ_() {
      this.O = this.U.b(ezo.a(vp.k, $$0x -> this.E()).a());
      this.O.k = false;
      this.P = this.U.b(ezo.a(vp.e, $$0x -> this.H()).a());
      if (!this.N) {
         if (this.A.b == -1) {
            this.N = true;
            this.J();
         } else {
            List<ewo> $$0 = new ArrayList<>();
            if (this.C != null) {
               $$0.add(this.C);
            }

            $$0.add(new eww(this.D, this.A.b, () -> {
               if (!this.N) {
                  this.N = true;
                  this.f.execute(() -> {
                     this.f.a(this);
            ...
            this.f.a(new eve(this.A, $$0.toArray(new ewo[0])));
         }
      }
   ...
   private void E() {
      this.f.a(new eux(new ess(new ffq()), this.D));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.K) {
                              ...
                              esv $$10 = new esv($$0, this.D, this.E, $$2, this.f.W(), aa.b().c(), this.F);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              est $$7 = est.a($$6);
                              est $$8 = est.a(5368709120L);
                              if (est.b($$6, $$7).equals(est.b(5368709120L, $$8)) && $$7 != est.a) {
                                 est $$9 = est.values()[$$7.ordinal() - 1];
                                 this.a(
                                    vq.a("mco.upload.size.failure.line1", this.B.b()),
                                    vq.a("mco.upload.size.failure.line2", est.b($$6, $$9), est.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    vq.a("mco.upload.size.failure.line1", this.B.b()),
                                    vq.a("mco.upload.size.failure.line2", est.b($$6, $$7), est.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
