...
public class evt {
   ...
   public static void a(File $$0, eon $$1, Consumer<vf> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eon $$2, Consumer<vf> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eon $$2, Consumer<vf> $$3) {
      epc $$4 = a($$2);
   ...
   public static epc a(eon $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      epc $$3 = new epc($$1, $$2, false);
   ...
   public evt(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
