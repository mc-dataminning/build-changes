...
public class fpr {
   ...
   private int m;
   private boolean n;
   private final List<fpr.a> o = new ArrayList<>();
   ...
   public void a(fpc $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fpc $$0, int $$1, int $$2, fma.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }
   ...
   public void a(wp $$0, @Nullable xb $$1, @Nullable fma $$2) {
   ...
   private void b(flz $$0) {
      ...
      List<ayl> $$3 = fpv.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
   ...
   public boolean e() {
      return this.i.z instanceof fue;
   }
   ...
   public fpr.b k() {
      return new fpr.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fpr.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<flz> $$0, List<String> $$1, List<fpr.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
