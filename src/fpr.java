...
public class fpr extends fpj<cqw> implements fse {
   private float E;
   private float F;
   private final fry G = new fry();
   private boolean H;
   private boolean I;

   public fpr(cmx $$0) {
      super($$0.cc, $$0.fZ(), wz.c("container.crafting"));
      this.s = 97;
   }
   ...
   public void C() {
      if (this.l.q.f()) {
         this.l.a(new fpg(this.l.s, this.l.s.h.x(), this.l.m.I().c()));
      } else {
         this.G.h();
      }
   }
   ...
   protected void aT_() {
      if (this.l.q.f()) {
         ...
         this.c(new fiw(this.A + 104, this.n / 2 - 22, 20, 18, fry.a, $$0 -> {
            this.G.e();
            this.A = this.G.a(this.m, this.c);
   ...
   public static void a(fhx $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, btn $$9) {
   ...
   public static void a(fhx $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, btn $$7) {
      $$0.c().a();
