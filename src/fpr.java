...
public class fpr implements gbp {
   private final aey a;
   private final j b;
   private final boolean c;
   private final int d;

   public fpr(aey $$0, j $$1, boolean $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof fpr $$1) ? false : this.a.equals($$1.a) && Objects.equals(this.b, $$1.b) && this.c == $$1.c && this.d == $$1.d;
      }
   }
   ...
   public static class a implements JsonDeserializer<fpr> {
      ...
      public fpr a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         boolean $$6 = this.d($$3);
         int $$7 = this.c($$3);
         return new fpr($$4, $$5.b(), $$6, $$7);
      }

      private boolean d(JsonObject $$0) {
         return arp.a($$0, "uvlock", false);
      }

      protected gbi a(JsonObject $$0) {
         int $$1 = arp.a($$0, "x", 0);
         int $$2 = arp.a($$0, "y", 0);
         gbi $$3 = gbi.a($$1, $$2);
         if ($$3 == null) {
      ...
      protected aey b(JsonObject $$0) {
         return new aey(arp.i($$0, "model"));
      }

      protected int c(JsonObject $$0) {
         int $$1 = arp.a($$0, "weight", 1);
         if ($$1 < 1) {
