...
public class bls extends blv implements bni {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final agm<Float> f = agp.a(bls.class, ago.d);
   private static final agm<Integer> g = agp.a(bls.class, ago.b);
   private static final agm<Boolean> h = agp.a(bls.class, ago.k);
   private static final agm<jv> i = agp.a(bls.class, ago.l);
   ...
   private cow n = coz.b;
   private final List<bli> o = Lists.newArrayList();
   private final Map<blv, Integer> p = Maps.newHashMap();
   private int q = 600;
   private int r = 20;
   private int s = 20;
   private boolean t;
   ...
   public bls(blz<? extends bls> $$0, ctp $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public bls(ctp $$0, double $$1, double $$2, double $$3) {
      this(blz.c, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dM().B) {
         this.an().b(f, auo.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void x() {
      if (this.n == coz.b && this.o.isEmpty()) {
         this.an().b(g, 0);
      } else {
         this.an().b(g, coy.a(coy.a(this.n, this.o)));
      }
   }
   ...
   public void l() {
      ...
      if (this.dM().B) {
         ...
         if ($$0) {
            ...
            $$3 = auo.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ag.i() * (float) (Math.PI * 2);
            float $$9 = auo.c(this.ag.i()) * $$4;
            double $$10 = this.dr() + (double)(auo.b($$8) * $$9);
            double $$11 = this.dt();
            double $$12 = this.dx() + (double)(auo.a($$8) * $$9);
            double $$14;
            double $$15;
            double $$16;
            if ($$2.b() == jx.v) {
         ...
         if (this.ah % 5 == 0) {
            ...
            List<bli> $$24 = Lists.newArrayList();

            for (bli $$25 : this.n.a()) {
               $$24.add(new bli($$25.c(), $$25.a($$0x -> $$0x / 4), $$25.e(), $$25.f(), $$25.g()));
            }
            ...
            if ($$24.isEmpty()) {
               ...
               List<bml> $$26 = this.dM().a(bml.class, this.cH());
               if (!$$26.isEmpty()) {
                  for (bml $$27 : $$26) {
