...
public abstract class bls<R extends Runnable> implements bla, blu<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bls(String $$0) {
      this.b = $$0;
      bky.a.a(this);
   }
   ...
   @Override
   public List<bkx> bu() {
      return ImmutableList.of(bkx.a(this.b + "-pending-tasks", bkw.b, this::bw));
   }
}
