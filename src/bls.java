...
public class bls extends bkx<cbh> {
         ...
         if (this.e != null && $$2 > this.f) {
            ...
            if ($$3.i() && $$5 instanceof cvo && $$1.gx()) {
               ...
               for (int $$7 = 0; $$7 < $$6.b(); $$7++) {
                  cjf $$8 = $$6.a($$7);
                  boolean $$9 = false;
                  if (!$$8.b() && $$8.a(aqa.aU) && $$8.d() instanceof cgy $$10) {
                     dfj $$11 = $$10.e().n();
                     $$0.b(this.e, $$11);
                  ...
                  if ($$9) {
                     $$0.a(null, (double)this.e.u(), (double)this.e.v(), (double)this.e.w(), apd.fi, ape.e, 1.0F, 1.0F);
                     $$8.h(1);
                     if ($$8.b()) {
                        $$6.a($$7, cjf.b);
                     }
   ...
   protected boolean d(akq $$0, cbh $$1, long $$2) {
      return this.g < 200;
   }
}
