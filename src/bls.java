...
public class bls<E extends bja> extends bkp<E> {
   ...
   protected List<bls.a> h = Lists.newArrayList();
   protected Optional<ehd> i = Optional.empty();
   @Nullable
   protected ehd j;
   protected int k;
   protected long l;
   private final Function<E, aov> q;
   private final BiPredicate<E, gu> r;

   public bls(bgb $$0, int $$1, int $$2, float $$3, Function<E, aov> $$4) {
      this($$0, $$1, $$2, $$3, $$4, bls::a);
   }

   public static <E extends bja> boolean a(E $$0, gu $$1) {
      cpl $$2 = $$0.dK();
      gu $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(eaw.a($$2, $$1.j())) == 0.0F;
   }

   public bls(bgb $$0, int $$1, int $$2, float $$3, Function<E, aov> $$4, BiPredicate<E, gu> $$5) {
      super(ImmutableMap.of(brz.n, bsa.c, brz.R, bsa.b, brz.S, bsa.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(akk $$0, bja $$1) {
      boolean $$2 = $$1.aA() && !$$1.aX() && !$$1.bl() && !$$0.a_($$1.dk()).a(csm.pg);
      if (!$$2) {
         $$1.dM().a(brz.R, this.p.a($$0.z) / 2);
      }

      return $$2;
   }

   protected boolean b(akk $$0, bja $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.di()) && this.k > 0 && !$$1.ba() && (this.j != null || !this.h.isEmpty());
      if (!$$3 && $$1.dM().c(brz.S).isEmpty()) {
         $$1.dM().a(brz.R, this.p.a($$0.z) / 2);
         $$1.dM().b(brz.n);
      }
   ...
   protected void a(akk $$0, E $$1, long $$2) {
      ...
      int $$5 = $$3.v();
      int $$6 = $$3.w();
      this.h = gu.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         .filter($$1x -> !$$1x.equals($$3))
         .map($$1x -> new bls.a($$1x.i(), arp.c($$3.j($$1x))))
   ...
   protected void c(akk $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.f(this.j.a($$4 / $$3));
            $$1.dM().a(brz.S, true);
            $$0.a(null, $$1, this.q.apply($$1), aox.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   protected Optional<bls.a> a(akk $$0) {
      Optional<bls.a> $$1 = bfd.a($$0.z, this.h);
      $$1.ifPresent(this.h::remove);
      return $$1;
   }

   private boolean a(akk $$0, E $$1, gu $$2) {
      gu $$3 = $$1.dk();
      int $$4 = $$3.u();
      int $$5 = $$3.w();
   ...
   @Nullable
   private ehd a(bja $$0, ehd $$1, int $$2) {
      ehd $$3 = $$0.di();
      ehd $$4 = new ehd($$1.c - $$3.c, 0.0, $$1.e - $$3.e).d().a(0.5);
      $$1 = $$1.d($$4);
      ehd $$5 = $$1.d($$3);
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            for (int $$26 = 0; $$26 < $$22 - 1; $$26++) {
               ...
               double $$28 = $$23 * $$17;
               double $$29 = $$23 * $$16;
               ehd $$30 = new ehd($$3.c + $$28, $$3.d + $$27, $$3.e + $$29);
            ...
            return new ehd($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }

   private boolean a(bja $$0, bij $$1, ehd $$2, ehd $$3) {
      ehd $$4 = $$3.d($$2);
