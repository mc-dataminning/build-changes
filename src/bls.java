...
public record bls<T>(blk<StringReader> a, bli<T> b) {
   public Optional<T> a(bln<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bll.a<StringReader> $$1 = new bll.a<>();
      blw $$2 = new blw(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(blm::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bll.a<StringReader> $$2 = new bll.a<>();
      blw $$3 = new blw(this.a(), $$2, $$1);
      this.a($$3);
      List<blm<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (blm<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof blv $$7) {
               ej.a($$7.a(), $$5);
            } else {
               ej.b($$6.b().possibleValues($$3), $$5);
            }
         }
