...
public class etn {
   ...
   public void a(etn.b $$0, List<anv> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new etn.c($$0, $$1.stream().map(anv::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new etn.c(etn.b.c, ImmutableList.of());
      }

      this.b.c = new etn.a($$0);
   }
   ...
   static class c {
      private final etn.b a;
      private final List<String> b;
      @Nullable
      etn.a c;
      boolean d;

      c(etn.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
