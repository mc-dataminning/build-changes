...
public class ggm extends auy<ggm.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final alb b = alb.b("gpu_warnlist.json");
   ...
   protected ggm.a a(aus $$0, bny $$1) {
      ...
      $$1.b();
      return new ggm.a($$2, $$3, $$4);
   }

   protected void a(ggm.a $$0, aus $$1, bny $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aus $$0, bny $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, fbi.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, fbi.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, fbi.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
