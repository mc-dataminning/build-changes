...
public class ggm implements apj<ggl> {
   public ggl b(JsonObject $$0) {
      Builder<ggk> $$1 = ImmutableList.builder();
      int $$2 = auf.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = auf.a($$0, "width", -1);
      int $$9 = auf.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = auf.a($$0, "interpolate", false);
      return new ggl($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private ggk a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new ggk(auf.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = auf.m($$1, "frames[" + $$0 + "]");
         int $$3 = auf.a($$2, "time", -1);
         if ($$2.has("time")) {
