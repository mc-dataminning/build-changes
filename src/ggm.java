...
public class ggm<T extends hde> extends gfy<T> implements geo, ggi {
   public static final gjl i = new get(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public ggm(gjc $$0, Function<alg, gqk> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gjk a(gjg $$0, float $$1) {
      gjk $$2 = new gjk();
      gjm $$3 = $$2.a();
      gjm $$4 = $$3.a("head", gjh.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gje.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", gjh.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gje.a);
      $$3.a("body", gjh.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), gje.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", gjh.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gje.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", gjh.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gje.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", gjh.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gje.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", gjh.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gje.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }
   ...
   public void a(T $$0) {
      ...
      if ($$2 != ggm.a.h) {
         gem.a(this.r, $$0.u, 1.0F);
      }

      if ($$1 != ggm.a.h) {
         gem.a(this.s, $$0.u, -1.0F);
      }

      if ($$3 > 0.0F) {
         float $$10 = $$5 % 26.0F;
         bwx $$11 = $$0.L;
         float $$12 = $$11 == bwx.b && $$0.H > 0.0F ? 0.0F : $$3;
         float $$13 = $$11 == bwx.a && $$0.H > 0.0F ? 0.0F : $$3;
         if (!$$0.R) {
            if ($$10 < 14.0F) {
   ...
   private void a(T $$0, ggm.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gem.a(this.r, this.s, $$0.J, $$0.K, true);
            break;
         case g:
            gem.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, ggm.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gem.a(this.r, this.s, $$0.J, $$0.K, false);
            break;
         case g:
            gem.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   protected gjc a(bwx $$0) {
      return $$0 == bwx.a ? this.s : this.r;
   }
