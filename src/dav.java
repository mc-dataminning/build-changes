...
public class dav extends csl {
   public static final dfq a = dfp.B;
   ...
   public void a(cpl $$0, gu $$1, cpd $$2) {
      if (!$$0.B) {
         byg $$3 = new byg($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2.e());
         int $$4 = $$3.m();
   ...
   private static void a(cpl $$0, gu $$1, @Nullable biy $$2) {
      if (!$$0.B) {
         byg $$3 = new byg($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2);
         $$0.b($$3);
         $$0.a(null, $$3.dp(), $$3.dr(), $$3.dv(), aow.xL, aox.e, 1.0F, 1.0F);
         $$0.a($$2, djj.I, $$1);
      }
   }
