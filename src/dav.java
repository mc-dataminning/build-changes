...
public abstract class dav {
   ...
   public void a(bsv<?> $$0, @Nullable dbt $$1, azc $$2, iz $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bug.a($$7.get(), $$0, bto.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dwe.b($$15.getClass()),
                        new evh((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsu.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof btm $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bto.c) || !$$17.a($$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((btm)$$15).a($$0, $$0.d_($$15.dp()), bto.c, null);
                     }
   ...
   private void d(dbt $$0, iz $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dck)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dbt $$0, iz $$1, ur $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dck $$4 = dck.b.parse(vf.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dck::new);
         this.a($$0, $$1, $$4);
      }

      boolean $$5 = $$2.b("SpawnPotentials", 9);
      if ($$5) {
         ux $$6 = $$2.c("SpawnPotentials", 10);
         this.e = dck.c.parse(vf.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(boz::b);
      } else {
         this.e = boz.a(this.f != null ? this.f : new dck());
      }
   ...
   public ur a(ur $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vo)dck.b.encodeStart(vf.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vo)dck.c.encodeStart(vf.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bsp b(dbt $$0, iz $$1) {
      if (this.l == null) {
         ur $$2 = this.a($$0, $$0.E_(), $$1).a();
         if (!$$2.b("id", 8)) {
            return null;
         }

         this.l = bsv.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof btm) {
         }
      }
   ...
   protected void a(@Nullable dbt $$0, iz $$1, dck $$2) {
      this.f = $$2;
   }

   private dck a(@Nullable dbt $$0, azc $$1, iz $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bpb.b::b).orElseGet(dck::new));
         return this.f;
      }
   }

   public abstract void a(dbt var1, iz var2, int var3);
