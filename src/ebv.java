...
public class ebv {
   ...
   private final ebv.a g;

   @Deprecated
   public static ebv a(ats $$0, ebv.a $$1) {
      return new ebv($$0, $$1, false);
   }

   public static ebv a(ats $$0, int $$1, double... $$2) {
      return b($$0, new ebv.a($$1, new DoubleArrayList($$2)));
   }

   public static ebv b(ats $$0, ebv.a $$1) {
      return new ebv($$0, $$1, true);
   }

   private ebv(ats $$0, ebv.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ebv.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ebv.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ebv.a::b))
               .apply($$0, ebv.a::new)
      );
      public static final Codec<ib<ebv.a>> b = age.a(jz.az, a);
