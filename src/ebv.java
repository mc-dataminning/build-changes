...
public record ebv(ebv.a a, byte b, byte c, byte d, @Nullable tn e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements asr {
      ...
      A("red_x", true, false),
      B("village_desert", true, eas.w.ak, false, true),
      C("village_plains", true, eas.w.ak, false, true),
      D("village_savanna", true, eas.w.ak, false, true),
      E("village_snowy", true, eas.w.ak, false, true),
      F("village_taiga", true, eas.w.ak, false, true),
      G("jungle_temple", true, eas.w.ak, false, true),
      H("swamp_hut", true, eas.w.ak, false, true);

      public static final Codec<ebv.a> I = asr.a(ebv.a::values);
      ...
      public static ebv.a a(byte $$0) {
         return values()[ary.a($$0, 0, values().length - 1)];
      }
