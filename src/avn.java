...
public class avn extends avs {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<avo<?>> e = Sets.newHashSet();

   public avn(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
            this.a($$0.aE(), FileUtils.readFileToString($$1));
   ...
   private Set<avo<?>> d() {
      Set<avo<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  tx $$4 = a($$3.getAsJsonObject());
                  $$4 = azo.g.a($$0, $$4, um.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<avo<T>> a(avq<T> $$0, String $$1) {
      return Optional.ofNullable(akk.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static tx a(JsonObject $$0) {
      tx $$1 = new tx();
   ...
   protected String b() {
      Map<avq<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avo<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avo<?>>)$$3.next();
         avo<?> $$2 = (avo<?>)$$1.getKey();
      ...
      for (Entry<avq<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lq.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> akk b(avo<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aqn $$0) {
      Object2IntMap<avo<?>> $$1 = new Object2IntOpenHashMap();
