...
public class avn extends avs {
   ...
   @Override
   public void a(clw $$0, avo<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  ud $$4 = a($$3.getAsJsonObject());
                  $$4 = azj.g.a($$0, $$4, us.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<avo<T>> a(avq<T> $$0, String $$1) {
      return Optional.ofNullable(akm.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static ud a(JsonObject $$0) {
      ud $$1 = new ud();
   ...
   protected String b() {
      ...
      for (Entry<avq<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(le.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> akm b(avo<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
