...
public class avn extends axz {
   public avn(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", ayx.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(ayx.z.typeName(), baf.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(ayx.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(ayx.z.typeName(), "minecraft:saddle"));
