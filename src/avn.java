...
public class avn implements AutoCloseable {
   ...
   private avn(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static avn.a a(Path $$0) {
         return new avn.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
