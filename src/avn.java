...
public class avn extends azt {
   public avn(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bat.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bat.s, "minecraft:jukebox");
