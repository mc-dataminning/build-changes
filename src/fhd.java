...
public interface fhd {
   ...
   public static record b(int e, @Nullable xv f) implements fhd {
      public static final fhd.b c = new fhd.b(429, xv.c("mco.errorMessage.serviceBusy"));
      public static final xv d = xv.c("mco.errorMessage.retry");

      public static fhd.b a(String $$0) {
         return new fhd.b(500, xv.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fhd.b a(fiw $$0) {
         return new fhd.b(500, xv.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }
