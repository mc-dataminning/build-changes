...
public class fhd {
   ...
   private static final xo h = xo.c("chat.deleted_marker").a(n.h, n.u);
   private final ffd i;
   private final axl<String> j = new axl<>(100);
   private final List<fex> k = Lists.newArrayList();
   private final List<fex.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fhd.a> o = new ArrayList<>();

   public fhd(ffd $$0) {
      this.i = $$0;
      this.j.addAll($$0.bc().a());
   }
   ...
   public void a(fgp $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = ayx.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = ayx.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, xo.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(fgp $$0, int $$1, int $$2, fey.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fex.a $$0) {
   ...
   public void a(boolean $$0) {
      ...
      if ($$0) {
         this.j.clear();
         this.j.addAll(this.i.bc().a());
      }
   }

   public void a(xo $$0) {
      this.a($$0, null, this.i.W() ? fey.b() : fey.a());
   }

   public void a(xo $$0, @Nullable ya $$1, @Nullable fey $$2) {
      fex $$3 = new fex(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fex $$0) {
      int $$1 = ayx.a((double)this.f() / this.h());
      fey.a $$2 = $$0.a();
      if ($$2 != null) {
         $$1 -= $$2.c + 4 + 2;
      }

      List<ayj> $$3 = fhh.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fex.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fhd.a b(ya $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fex> $$2 = this.k.listIterator();
   ...
   private fex d(fex $$0) {
      return new fex($$0.b(), h, null, fey.a());
   }
   ...
   private void n() {
      ...
      for (fex $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Y && !this.l()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)ayx.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)ayx.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public yl b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         fex.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), ayx.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fey c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fex.a $$1, fey $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fey.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.l()) {
         if (!($$0 < -4.0) && !($$0 > (double)ayx.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = ayx.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof flr;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return ayx.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return ayx.a($$0 * 160.0 + 20.0);
   }
   ...
   public fhd.b k() {
      return new fhd.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fhd.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fex> $$0, List<String> $$1, List<fhd.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
