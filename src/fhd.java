...
public class fhd {
   ...
   public void a(fiw $$0, String $$1, fjt.a $$2, ewc $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fhd.b $$13 = new fhd.b($$1.trim(), this.f, $$3, $$2);
                  fhd.a $$14 = new fhd.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fhd.c $$30 = new fhd.c(this.f, $$2, $$0);
                        fhd.a $$31 = new fhd.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fja(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ewc $$2) throws IOException {
      ...
      File $$15 = new File(fme.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ewc d;
      private final fjt.a e;

      b(final String $$0, final File $$1, final ewc $$2, final fjt.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fhd.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fhd.this.b && !fhd.this.d) {
            try {
               fhd.this.e = true;
               fhd.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fhd.a.error("Error extracting archive", var3);
               fhd.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fjt.a c;
      private final fiw d;

      c(final File $$0, final fjt.a $$1, final fiw $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fhd.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fhd.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fhd.this.g);
                  fhd.this.c = true;
               } else {
                  fhd.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fhd.this.d = true;
               }
            } catch (IOException var3) {
               fhd.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fhd.this.d = true;
            }
         }
      }
