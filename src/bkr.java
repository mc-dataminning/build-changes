...
public record bkr(Instant a, String b, long c) {
   ...
   public static bkr a(RecordedEvent $$0) {
      ...
      return new bkr($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bkr.a a(List<bkr> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bkr>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bkr $$3 = (bkr)$$2x.get(0);
            bkr $$4 = (bkr)$$2x.get($$2x.size() - 1);
