...
public abstract class crw extends cso {
   private static final fby b = new fby(0.0, 0.0, 0.0);
   private static final alc<Integer> c = alg.a(crw.class, ale.b);
   private static final alc<Integer> d = alg.a(crw.class, ale.b);
   private static final alc<Boolean> h = alg.a(crw.class, ale.k);
   private static final ImmutableMap<bws, ImmutableList<Integer>> i = ImmutableMap.of(
      bws.a, ImmutableList.of(0, 1, -1), bws.f, ImmutableList.of(0, 1, -1), bws.d, ImmutableList.of(0, 1)
   );
   protected static final float a = 0.95F;
   private boolean j;
   private boolean k;
   private final cse l;
   private static final Map<dyy, Pair<kl, kl>> m = ae.a(Maps.newEnumMap(dyy.class), $$0 -> {
      kl $$1 = jm.e.q();
      kl $$2 = jm.f.q();
      kl $$3 = jm.c.q();
      kl $$4 = jm.d.q();
      ...
      kl $$7 = $$3.p();
      kl $$8 = $$4.p();
      $$0.put(dyy.a, Pair.of($$3, $$4));
      $$0.put(dyy.b, Pair.of($$1, $$2));
      $$0.put(dyy.c, Pair.of($$5, $$2));
      $$0.put(dyy.d, Pair.of($$1, $$6));
      $$0.put(dyy.e, Pair.of($$3, $$8));
      $$0.put(dyy.f, Pair.of($$7, $$4));
      $$0.put(dyy.g, Pair.of($$4, $$2));
      $$0.put(dyy.h, Pair.of($$4, $$1));
      $$0.put(dyy.i, Pair.of($$3, $$1));
      $$0.put(dyy.j, Pair.of($$3, $$2));
   });

   protected crw(bvr<?> $$0, dhi $$1) {
      super($$0, $$1);
      this.I = true;
      if (b($$1)) {
         this.l = new csl(this);
   ...
   protected crw(bvr<?> $$0, dhi $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.p($$2, $$3, $$4);
   }
   ...
   @Nullable
   public static <T extends crw> T a(dhi $$0, double $$1, double $$2, double $$3, bvr<T> $$4, bvq $$5, cxp $$6, @Nullable cpx $$7) {
      T $$8 = (T)$$4.a($$0, $$5);
      if ($$8 != null) {
         $$8.p($$1, $$2, $$3);
         bvr.a($$0, $$6, $$7).accept($$8);
         if ($$8.l() instanceof csl $$9) {
            jh $$10 = $$8.p();
            dxv $$11 = $$0.a_($$10);
            $$9.a($$10, $$11, true);
         }
   ...
   protected fby a(bvk $$0, bvn $$1, float $$2) {
      boolean $$3 = $$0 instanceof cpj || $$0 instanceof cpp;
   ...
   public fby b(bwg $$0) {
      ...
      if ($$1.o() == jm.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dW().a(csc.a(this.dW(), $$4), () -> csc.a(this.dW(), $$4.e()));
                  if (csc.a($$11)) {
                     fbt $$12 = new fbt((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b(), (double)$$8);
                     fby $$13 = fby.a($$4, $$11);
                     if (csc.a(this.dW(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            bws $$15 = (bws)var22.next();
            double $$16 = (double)$$0.a($$15).b();
            int $$17 = bae.c($$14x - (double)$$4.v() + $$16);
            double $$18 = csc.a($$4, $$17, $$0x -> this.dW().a_($$0x).g(this.dW(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   public static Pair<kl, kl> a(dyy $$0) {
      return m.get($$0);
   }
   ...
   private void a(crw $$0, double $$1, double $$2) {
      double $$3;
      double $$4;
      if (b(this.dW())) {
         $$3 = this.dz().d;
      ...
      fby $$7 = new fby($$3, 0.0, $$4).d();
      fby $$8 = new fby((double)bae.b(this.dM() * (float) (Math.PI / 180.0)), 0.0, (double)bae.a(this.dM() * (float) (Math.PI / 180.0))).d();
   ...
   public dxv t() {
      return !this.A() ? this.w() : dkm.a(this.au().a(c));
   }
