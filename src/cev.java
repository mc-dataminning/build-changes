...
public class cev extends ceu {
   ...
   private static final akg<Byte> bX = akk.a(cev.class, aki.a);
   private static final int bY = 1;
   private static final ceb bZ = ceb.b().a(4.0);
   public final bsk d = new bsk();
   public final bsk e = new bsk();
   @Nullable
   private iz ca;

   public cev(bsv<? extends cev> $$0, dbt $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   @Override
   public avv v() {
      return this.u() && this.ah.a(4) != 0 ? null : avw.bF;
   }
   ...
   public void l() {
      ...
      if (this.u()) {
         this.h(evm.b);
         this.p(this.du(), (double)ayu.a(this.dw()) + 1.0 - (double)this.dk(), this.dA());
      } else {
   ...
   protected void Z() {
      ...
      if (this.u()) {
         ...
         evm $$6 = this.ds();
         evm $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.h($$7);
         float $$8 = (float)(ayu.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = ayu.g($$8 - this.dF());
         this.bq = 0.5F;
         this.r(this.dF() + $$9);
   ...
   public static boolean b(bsv<cev> $$0, dbu $$1, bto $$2, iz $$3, azc $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
