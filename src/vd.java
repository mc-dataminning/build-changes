...
public class vd implements vl {
   ...
   public vd(String $$0, int $$1, List<String> $$2) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
   }

   public String a(vh $$0) {
      $$0.a(this);
      return this.p;
   }
   ...
   public void a(uq $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$1.append(new vd($$2, this.n + 1, this.o).a($$0.k($$3)));
            if ($$3 != $$0.size() - 1) {
   ...
   public void a(uk $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            ...
            vh $$6 = $$0.c($$5);
            this.b($$5);
            $$1.append(Strings.repeat($$2, this.n + 1)).append(a($$5)).append(d).append(" ").append(new vd($$2, this.n + 1, this.o).a($$6));
            this.b();
            if ($$4.hasNext()) {
               $$1.append(e).append($$2.isEmpty() ? " " : "\n");
            }
   ...
   protected static String a(String $$0) {
      return c.matcher($$0).matches() ? $$0 : vf.b($$0);
   }
