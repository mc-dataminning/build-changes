...
public class dkc implements djf {
   private static final djg a = new djg();
   private static final int b = 16;
   private static final float c = 2.0F;
   private final boolean d;
   private final djf.a e;
   private final arq f;
   private final ffc g;
   @Nullable
   private final bwi h;
   ...
   private final bux j;
   private final djg k;
   private final Map<crm, ffc> l = new HashMap<>();

   public dkc(arq $$0, @Nullable bwi $$1, @Nullable bux $$2, @Nullable djg $$3, ffc $$4, float $$5, boolean $$6, djf.a $$7) {
      this.f = $$0;
      this.h = $$1;
      this.i = $$5;
      this.g = $$4;
   ...
   private djg b(@Nullable bwi $$0) {
      return (djg)($$0 == null ? a : new djd($$0));
   }

   public static float a(ffc $$0, bwi $$1) {
      fex $$2 = $$1.cQ();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  ffc $$16 = new ffc($$13 + $$6, $$14, $$15 + $$7);
                  if ($$1.dU().a(new dit($$16, $$0, dit.a.a, dit.b.a, $$1)).d() == ffa.a.a) {
                     $$8++;
                  }
   ...
   private void n() {
      ...
      for (bwi $$8 : this.f.a_(this.h, new fex((double)$$1, (double)$$3, (double)$$5, (double)$$2, (double)$$4, (double)$$6))) {
         if (!$$8.a(this)) {
            double $$9 = Math.sqrt($$8.g(this.g)) / (double)$$0;
            if ($$9 <= 1.0) {
               double $$10 = $$8.dz() - this.g.d;
               double $$11 = ($$8 instanceof cns ? $$8.dB() : $$8.dD()) - this.g.e;
   ...
   private void b(List<iv> $$0) {
      for (iv $$1 : $$0) {
         if (this.f.A.a(3) == 0 && this.f.a_($$1).l() && this.f.a_($$1.e()).s()) {
            this.f.b($$1, dme.a(this.f, $$1));
         }
      }
   }

   public void i() {
      this.f.a(this.h, eft.w, this.g);
      List<iv> $$0 = this.m();
      this.n();
      if (this.o()) {
         bqq $$1 = bqp.a();
   ...
   private static void a(List<dkc.a> $$0, czn $$1, iv $$2) {
      for (dkc.a $$3 : $$0) {
         $$3.a($$1);
         if ($$1.f()) {
            return;
   ...
   private boolean o() {
      return this.e != djf.a.a;
   }

   public Map<crm, ffc> j() {
      return this.l;
   }
   ...
   public boolean g() {
      if (this.e != djf.a.d) {
         ...
         return this.h != null && this.h.an() == bwr.s ? this.f.O().c(dji.d) : true;
      }
   }

   @Override
   public boolean h() {
      boolean $$0 = this.f.O().c(dji.d);
