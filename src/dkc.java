...
public class dkc extends dfj implements dfd {
   public static final MapCodec<dkc> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ale.a(lq.aC).fieldOf("feature").forGetter($$0x -> $$0x.d), u()).apply($$0, dkc::new)
   );
   protected static final float b = 3.0F;
   protected static final ewl c = dfa.a(5.0, 0.0, 5.0, 11.0, 6.0, 11.0);
   private final ale<eam<?, ?>> d;
   ...
   public boolean a(arf $$0, iz $$1, dsd $$2, azh $$3) {
      Optional<? extends ji<eam<?, ?>>> $$4 = $$0.H_().d(lq.aC).b(this.d);
      if ($$4.isEmpty()) {
         return false;
      } else {
         $$0.a($$1, false);
