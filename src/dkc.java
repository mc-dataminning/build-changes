...
public interface dkc {
   ...
   static int a_(float $$0, int $$1) {
      ...
      return Math.max(1, 15 - arw.a($$2 * (double)$$0));
   }
   ...
   public static final class a {
      public static Codec<dkc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ...
                  arf.i.fieldOf("event_delay").orElse(0).forGetter(dkc.a::c)
               )
   ...
   public static class b implements djv {
      ...
      public void b(akq $$0, djt $$1, djt.a $$2, ehn $$3) {
         this.a.gg().b().a($$0).ifPresent($$4 -> this.a($$0, this.a.gf(), $$1, $$2, $$3, $$4));
      }

      private void a(akq $$0, dkc.a $$1, djt $$2, djt.a $$3, ehn $$4, ehn $$5) {
      ...
      private static boolean a(cpv $$0, ehn $$1, ehn $$2) {
         ehn $$3 = new ehn((double)arw.a($$1.c) + 0.5, (double)arw.a($$1.d) + 0.5, (double)arw.a($$1.e) + 0.5);
         ehn $$4 = new ehn((double)arw.a($$2.c) + 0.5, (double)arw.a($$2.d) + 0.5, (double)arw.a($$2.e) + 0.5);

         for (ha $$5 : ha.values()) {
            ehn $$6 = $$3.a($$5, 1.0E-5F);
            if ($$0.a(new cpd($$6, $$4, $$0x -> $$0x.a(aps.bp))).c() != ehl.a.b) {
               return false;
            }
         }
   ...
   public interface c {
      ...
      private static void a(akq $$0, dkc.a $$1, dkc.d $$2) {
      ...
      private static void b(akq $$0, dkc.a $$1, dkc.d $$2) {
         if ($$1.e()) {
            if ($$1.c == null) {
               $$1.a(false);
            } else {
               ...
               double $$9 = arw.d($$8, $$3.c, $$5.c);
               double $$10 = arw.d($$8, $$3.d, $$5.d);
               double $$11 = arw.d($$8, $$3.e, $$5.e);
      ...
      private static boolean a(akq $$0, dkc.a $$1, dkc.d $$2, dka $$3) {
         gw $$4 = gw.a($$3.c());
   ...
   public interface d {
      ...
      boolean a(akq var1, gw var2, djt var3, djt.a var4);

      void a(akq var1, gw var2, djt var3, @Nullable biq var4, @Nullable biq var5, float var6);
      ...
      default boolean a(djt $$0, djt.a $$1) {
         if (!$$0.a(this.c())) {
            ...
            return $$1.b() != null ? !$$1.b().a(aps.bq) : true;
         }
      }
