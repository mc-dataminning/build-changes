...
public class gnd extends MinecraftServer {
   ...
   public gnd(Thread $$0, ezg $$1, ekk.c $$2, arz $$3, akd $$4, aka $$5, app $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.at(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gnc(this, this.be(), this.g));
      this.m = $$1;
   }
   ...
   @Override
   public cww bf() {
      return this.r() ? (cww)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
}
