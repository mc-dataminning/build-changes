...
public class gnd {
   ...
   public final Map<jn, gne> c;
   @Nullable
   public final gnf d;
   public final boolean e;
   public final int f;

   public gnd(Vector3f $$0, Vector3f $$1, Map<jn, gne> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gnd(Vector3f $$0, Vector3f $$1, Map<jn, gne> $$2, @Nullable gnf $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jn, gne> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gnd> {
      ...
      public gnd a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         gnf $$6 = this.a($$3);
         Map<jn, gne> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayo.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayo.a($$3, "shade", true);
            int $$9 = 0;
            if ($$3.has("light_emission")) {
               boolean $$10 = ayo.b($$3, "light_emission");
               if ($$10) {
                  $$9 = ayo.o($$3, "light_emission");
               }
            ...
            return new gnd($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gnf a(JsonObject $$0) {
         gnf $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = ayo.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            jn.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = ayo.a($$2, "rescale", false);
            $$1 = new gnf($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = ayo.m($$0, "angle");
         if ($$1 != 0.0F && ayy.e($$1) != 22.5F && ayy.e($$1) != 45.0F) {
      ...
      private Map<jn, gne> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gne> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jn, gne> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gne> $$2 = Maps.newEnumMap(jn.class);
         JsonObject $$3 = ayo.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jn $$5 = this.a($$4.getKey());
            $$2.put($$5, (gne)$$0.deserialize($$4.getValue(), gne.class));
         }
