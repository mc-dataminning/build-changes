public class gnd<T extends cfr> extends gni<T, fts<T>> {
   private final geh a;

   public gnd(gks<T, fts<T>> $$0, geh $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(ezx $$0, gdn $$1, int $$2, boolean $$3, dsb $$4, int $$5, gqz $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(gdv.r(gox.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
