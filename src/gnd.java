...
public class gnd implements asd<gnc> {
   public gnc b(JsonObject $$0) {
      Builder<gnb> $$1 = ImmutableList.builder();
      int $$2 = axc.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = axc.a($$0, "width", -1);
      int $$9 = axc.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = axc.a($$0, "interpolate", false);
      return new gnc($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gnb a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gnb(axc.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = axc.m($$1, "frames[" + $$0 + "]");
         int $$3 = axc.a($$2, "time", -1);
         if ($$2.has("time")) {
