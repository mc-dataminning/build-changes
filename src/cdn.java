...
public class cdn {
   ...
   public static io a(ayk $$0, int $$1, int $$2) {
      int $$3 = $$0.a(2 * $$1 + 1) - $$1;
      int $$4 = $$0.a(2 * $$2 + 1) - $$2;
      int $$5 = $$0.a(2 * $$1 + 1) - $$1;
      return new io($$3, $$4, $$5);
   ...
   @Nullable
   public static io a(ayk $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      double $$7 = ayd.d($$5, $$4) - (float) (Math.PI / 2);
      double $$8 = $$7 + (double)(2.0F * $$0.i() - 1.0F) * $$6;
      double $$9 = Math.sqrt($$0.j()) * (double)ayd.g * (double)$$1;
   ...
   @Nullable
   public static euk a(bsx $$0, Supplier<io> $$1) {
      return a($$1, $$0::d);
   }

   @Nullable
   public static euk a(Supplier<io> $$0, ToDoubleFunction<io> $$1) {
      ...
      return $$3 != null ? euk.c($$3) : null;
   }

   public static io a(bsx $$0, int $$1, ayk $$2, io $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.ga() && $$1 > 1) {
         io $$6 = $$0.fX();
