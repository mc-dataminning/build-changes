...
public abstract class cdn extends bis {
   private static final aeg<Integer> c = aej.a(cdn.class, aei.b);
   private static final aeg<Integer> d = aej.a(cdn.class, aei.b);
   private static final aeg<Float> e = aej.a(cdn.class, aei.d);
   private static final aeg<Integer> f = aej.a(cdn.class, aei.b);
   private static final aeg<Integer> g = aej.a(cdn.class, aei.b);
   private static final aeg<Boolean> h = aej.a(cdn.class, aei.k);
   private static final ImmutableMap<bju, ImmutableList<Integer>> i = ImmutableMap.of(
      bju.a, ImmutableList.of(0, 1, -1), bju.f, ImmutableList.of(0, 1, -1), bju.d, ImmutableList.of(0, 1)
   );
   ...
   private double q;
   private ehp r = ehp.b;
   private static final Map<dgp, Pair<ib, ib>> s = ac.a(Maps.newEnumMap(dgp.class), $$0 -> {
      ib $$1 = hc.e.q();
      ib $$2 = hc.f.q();
      ib $$3 = hc.c.q();
      ib $$4 = hc.d.q();
      ...
      ib $$7 = $$3.o();
      ib $$8 = $$4.o();
      $$0.put(dgp.a, Pair.of($$3, $$4));
      $$0.put(dgp.b, Pair.of($$1, $$2));
      $$0.put(dgp.c, Pair.of($$5, $$2));
      $$0.put(dgp.d, Pair.of($$1, $$6));
      $$0.put(dgp.e, Pair.of($$3, $$8));
      $$0.put(dgp.f, Pair.of($$7, $$4));
      $$0.put(dgp.g, Pair.of($$4, $$2));
      $$0.put(dgp.h, Pair.of($$4, $$1));
      $$0.put(dgp.i, Pair.of($$3, $$1));
      $$0.put(dgp.j, Pair.of($$3, $$2));
   });

   protected cdn(biw<?> $$0, cpx $$1) {
      super($$0, $$1);
      this.I = true;
   }

   protected cdn(biw<?> $$0, cpx $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.e($$2, $$3, $$4);
      this.K = $$2;
      this.L = $$3;
   ...
   public static cdn a(cpx $$0, double $$1, double $$2, double $$3, cdn.a $$4) {
      if ($$4 == cdn.a.b) {
         return new cdu($$0, $$1, $$2, $$3);
      } else if ($$4 == cdn.a.c) {
         return new cdw($$0, $$1, $$2, $$3);
      } else if ($$4 == cdn.a.d) {
         return new cdz($$0, $$1, $$2, $$3);
      } else if ($$4 == cdn.a.e) {
         return new cdy($$0, $$1, $$2, $$3);
      } else if ($$4 == cdn.a.f) {
         return new cdx($$0, $$1, $$2, $$3);
      } else {
         return (cdn)($$4 == cdn.a.g ? new cdv($$0, $$1, $$2, $$3) : new cdt($$0, $$1, $$2, $$3));
      }
   }
   ...
   public ehp b(bji $$0) {
      ...
      if ($$1.o() == hc.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dL().a(cds.a(this.dL(), $$4), () -> cds.a(this.dL(), $$4.d()));
                  if (cds.a($$11)) {
                     ehk $$12 = new ehk((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b, (double)$$8);
                     ehp $$13 = ehp.a($$4, $$11);
                     if (cds.a(this.dL(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            bju $$15 = (bju)var22.next();
            double $$16 = (double)$$0.a($$15).b;
            int $$17 = ary.c($$14x - (double)$$4.v() + $$16);
            double $$18 = cds.a($$4, $$17, $$0x -> this.dL().a_($$0x).k(this.dL(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   protected float aJ() {
      ...
      return $$0.a(apu.N) ? 1.0F : super.aJ();
   }

   public void a(bhq $$0) {
      this.aj();
      if (this.dL().X().b(cpt.h)) {
         cjh $$1 = new cjh(this.q());
         if (this.ac()) {
            $$1.a(this.ad());
         }
   ...
   private static Pair<ib, ib> a(dgp $$0) {
      return s.get($$0);
   }
   ...
   public void l() {
      ...
      if (this.dL().B) {
         ...
         int $$2 = ary.a(this.ds());
         int $$3 = ary.a(this.dw());
         if (this.dL().a_(new gw($$1, $$2 - 1, $$3)).a(apu.N)) {
            $$2--;
         }
         ...
         if ($$6 * $$6 + $$7 * $$7 > 0.001) {
            this.r((float)(ary.d($$7, $$6) * 180.0 / Math.PI));
            if (this.j) {
               this.r(this.dB() + 180.0F);
            }
         }

         double $$8 = (double)ary.g(this.dB() - this.N);
         if ($$8 < -170.0 || $$8 >= 170.0) {
            this.r(this.dB() + 180.0F);
            this.j = !this.j;
         }
         ...
         this.a(this.dB(), this.dD());
         if (this.z() == cdn.a.a && this.do().i() > 0.01) {
            List<bis> $$9 = this.dL().a(this, this.cG().c(0.2F, 0.0, 0.2F), biv.a(this));
            if (!$$9.isEmpty()) {
               for (bis $$10 : $$9) {
                  if (!($$10 instanceof cbw) && !($$10 instanceof bvf) && !($$10 instanceof cdn) && !this.bO() && !$$10.bN()) {
                     $$10.n(this);
                  } else {
                     $$10.g(this);
                  }
            ...
            for (bis $$11 : this.dL().a_(this, this.cG().c(0.2F, 0.0, 0.2F))) {
               if (!this.x($$11) && $$11.bs() && $$11 instanceof cdn) {
                  $$11.g(this);
               }
            }
         }
   ...
   protected void t() {
      double $$0 = this.s();
      ehp $$1 = this.do();
      this.o(ary.a($$1.c, -$$0, $$0), $$1.d, ary.a($$1.e, -$$0, $$0));
      if (this.aA()) {
   ...
   protected void c(gw $$0, dfl $$1) {
      ...
      $$9 = new ehp($$18 * $$14 / $$16, $$9.d, $$18 * $$15 / $$16);
      this.f($$9);
      bis $$19 = this.cQ();
      if ($$19 instanceof cbw) {
         ehp $$20 = $$19.do();
         double $$21 = $$20.i();
         double $$22 = this.do().i();
      ...
      double $$34 = this.s();
      $$9 = this.do();
      this.a(bjo.a, new ehp(ary.a($$33 * $$9.c, -$$34, $$34), 0.0, ary.a($$33 * $$9.e, -$$34, $$34)));
      if ($$12.v() != 0 && ary.a(this.dq()) - $$0.u() == $$12.u() && ary.a(this.dw()) - $$0.w() == $$12.w()) {
         this.e(this.dq(), this.ds() + (double)$$12.v(), this.dw());
      } else if ($$13.v() != 0 && ary.a(this.dq()) - $$0.u() == $$13.u() && ary.a(this.dw()) - $$0.w() == $$13.w()) {
         this.e(this.dq(), this.ds() + (double)$$13.v(), this.dw());
      }

      this.v();
      ehp $$35 = this.q(this.dq(), this.ds(), this.dw());
      if ($$35 != null && $$5 != null) {
      ...
      int $$39 = ary.a(this.dq());
      int $$40 = ary.a(this.dw());
      if ($$39 != $$0.u() || $$40 != $$0.w()) {
         ehp $$41 = this.do();
         double $$42 = $$41.h();
   ...
   @Nullable
   public ehp a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ary.a($$0);
      int $$5 = ary.a($$1);
      int $$6 = ary.a($$2);
      if (this.dL().a_(new gw($$4, $$5 - 1, $$6)).a(apu.N)) {
         $$5--;
      }

      dfl $$7 = this.dL().a_(new gw($$4, $$5, $$6));
      if (csn.g($$7)) {
         dgp $$8 = $$7.c(((csn)$$7.b()).b());
         $$1 = (double)$$5;
         if ($$8.b()) {
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && ary.a($$0) - $$4 == $$10.u() && ary.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && ary.a($$0) - $$4 == $$11.u() && ary.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   @Nullable
   public ehp q(double $$0, double $$1, double $$2) {
      int $$3 = ary.a($$0);
      int $$4 = ary.a($$1);
      int $$5 = ary.a($$2);
      if (this.dL().a_(new gw($$3, $$4 - 1, $$5)).a(apu.N)) {
         $$4--;
      }

      dfl $$6 = this.dL().a_(new gw($$3, $$4, $$5));
      if (csn.g($$6)) {
         dgp $$7 = $$6.c(((csn)$$6.b()).b());
         Pair<ib, ib> $$8 = a($$7);
         ib $$9 = (ib)$$8.getFirst();
   ...
   protected void a(qy $$0) {
      if ($$0.q("CustomDisplayTile")) {
         this.c(rl.a(this.dL().a(je.e), $$0.p("DisplayState")));
            ...
            if (!this.x($$0)) {
               ...
               if ($$3 >= 1.0E-4F) {
                  ...
                  if ($$0 instanceof cdn) {
                     ...
                     ehp $$7 = new ehp($$5, 0.0, $$6).d();
                     ehp $$8 = new ehp((double)ary.b(this.dB() * (float) (Math.PI / 180.0)), 0.0, (double)ary.a(this.dB() * (float) (Math.PI / 180.0))).d();
                     ...
                     ehp $$10 = this.do();
                     ehp $$11 = $$0.do();
                     if (((cdn)$$0).z() == cdn.a.c && this.z() != cdn.a.c) {
                        this.f($$10.d(0.2, 1.0, 0.2));
                        this.j($$11.c - $$1, 0.0, $$11.e - $$2);
                        $$0.f($$11.d(0.95, 1.0, 0.95));
                     } else if (((cdn)$$0).z() != cdn.a.c && this.z() == cdn.a.c) {
   ...
   public abstract cdn.a z();

   public dfl A() {
      return !this.F() ? this.B() : csx.a(this.al().b(f));
   }
