...
public enum ha implements apr {
   ...
   public static final apr.a<ha> g = apr.a(ha::values);
   public static final Codec<ha> h = aoi.a(g, ha::a);
   private final int i;
   private final int j;
   private final int k;
   ...
   public static ha a(bfj $$0, ha.a $$1) {
      return switch ($$1) {
   ...
   public static enum a implements apr, Predicate<ha> {
      a("x") {
         @Override
      ...
      public static final apr.a<ha.a> e = apr.a(ha.a::values);
