...
public class fos implements elf, AutoCloseable {
   ...
   public fos(anx $$0, String $$1, elu $$2) throws IOException {
      this.F = $$1;
      this.M = $$2;
      aex $$3 = new aex("shaders/core/" + $$1 + ".json");
   ...
   private static eld a(final anx $$0, eld.a $$1, String $$2) throws IOException {
      eld $$3 = $$1.c().get($$2);
      eld $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         ans $$5 = $$0.getResourceOrThrow(new aex($$4));
