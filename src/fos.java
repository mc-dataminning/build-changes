public abstract class fos<T extends cpv> extends foq<T> implements fse {
   public final fru E;
   private boolean F;
   private final akr G;
   private final akr H;
   ...
   public fos(T $$0, fru $$1, cmw $$2, wz $$3, akr $$4, akr $$5, akr $$6) {
      super($$0, $$2, $$3);
      this.E = $$1;
      this.G = $$4;
      this.H = $$5;
   ...
   public void aT_() {
      ...
      this.c(new fiw(this.A + 20, this.n / 2 - 49, 20, 18, fry.a, $$0 -> {
         this.E.e();
         this.A = this.E.a(this.m, this.c);
