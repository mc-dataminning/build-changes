...
public final class j {
   ...
   public static final Codec<j> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arb.d.fieldOf("translation").forGetter($$0x -> $$0x.e),
               arb.g.fieldOf("left_rotation").forGetter($$0x -> $$0x.f),
               arb.d.fieldOf("scale").forGetter($$0x -> $$0x.g),
               arb.g.fieldOf("right_rotation").forGetter($$0x -> $$0x.h)
            )
            .apply($$0, j::new)
   );
   public static final Codec<j> b = arb.e(a, arb.h.xmap(j::new, j::c));
   private boolean d;
   @Nullable
   private Vector3f e;
   @Nullable
