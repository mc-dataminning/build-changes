...
public final class j {
   ...
   public static final Codec<j> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ayv.c.fieldOf("translation").forGetter($$0x -> $$0x.e),
               ayv.g.fieldOf("left_rotation").forGetter($$0x -> $$0x.f),
               ayv.c.fieldOf("scale").forGetter($$0x -> $$0x.g),
               ayv.g.fieldOf("right_rotation").forGetter($$0x -> $$0x.h)
            )
            .apply($$0, j::new)
   );
   public static final Codec<j> b = Codec.withAlternative(a, ayv.h.xmap(j::new, j::c));
   private boolean d;
   @Nullable
   private Vector3f e;
   @Nullable
