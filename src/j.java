...
public final class j {
   ...
   public static final Codec<j> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               axm.g.fieldOf("left_rotation").forGetter($$0x -> $$0x.f),
               axm.c.fieldOf("scale").forGetter($$0x -> $$0x.g),
               axm.g.fieldOf("right_rotation").forGetter($$0x -> $$0x.h)
            )
            .apply($$0, j::new)
   );
   public static final Codec<j> b = Codec.withAlternative(a, axm.h.xmap(j::new, j::c));
   private boolean d;
   @Nullable
   private Vector3f e;
   @Nullable
