public class brg extends bre {
   ...
   public brg(bli $$0, int $$1, int $$2, float $$3, float $$4, boolean $$5) {
      super($$0);
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a() {
      ...
      if (this.k == bre.a.b && !this.d.N().l()) {
         ...
         if ($$3 < 2.5000003E-7F) {
            ...
            this.d.aU = this.d.dD();
            this.d.aW = this.d.dD();
            float $$5 = (float)(this.h * this.d.b(bmm.m));
            if (this.d.aZ()) {
               this.d.w($$5 * this.p);
               double $$6 = Math.sqrt($$0 * $$0 + $$2 * $$2);
               if (Math.abs($$1) > 1.0E-5F || Math.abs($$6) > 1.0E-5F) {
                  float $$7 = -((float)(atm.d($$1, $$6) * 180.0F / (float)Math.PI));
                  $$7 = atm.a(atm.g($$7), (float)(-this.n), (float)this.n);
                  this.d.s(this.a(this.d.dF(), $$7, 5.0F));
               }

               float $$8 = atm.b(this.d.dF() * (float) (Math.PI / 180.0));
               float $$9 = atm.a(this.d.dF() * (float) (Math.PI / 180.0));
               this.d.bm = $$8 * $$5;
               this.d.bl = -$$9 * $$5;
            } else {
               float $$10 = Math.abs(atm.g(this.d.dD() - $$4));
               float $$11 = a($$10);
   ...
   private static float a(float $$0) {
      return 1.0F - atm.a(($$0 - 10.0F) / 50.0F, 0.0F, 1.0F);
   }
}
