...
public class brg {
   ...
   private static void a(bro $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(brj $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<brp> $$0) {
      JsonObject $$1 = new JsonObject();
      brt<brp> $$2 = brt.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(brp::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         brt<brp> $$6 = brt.a((List<brp>)$$4);
         ...
         Function<brp, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<ecx, brt<bri>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((brt)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<ecx, brt<bri>> $$3 : $$0) {
         brt<bri> $$4 = (brt<bri>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((ecx)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<brr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqv.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bre $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), brg::a));
      $$1.add("chunksWritten", this.a($$0.m(), brg::a));
      return $$1;
   }

   private JsonElement a(brl.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bre $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), brg::a));
      $$1.add("received", this.a($$0.k(), brg::a));
      return $$1;
   }

   private <T> JsonElement a(brn<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<brk> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<brk>, ToDoubleFunction<brk>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, brk::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, brk::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, brk::c));
      return $$1;
   }
}
