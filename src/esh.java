...
public class esh {
   ...
   private final List<eqf> k = Lists.newArrayList();
   private final List<eqf.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<esh.a> o = new ArrayList<>();
   ...
   public void a(erv $$0, int $$1, int $$2, int $$3) {
      if (!this.j()) {
         int $$4 = this.i();
         int $$5 = this.l.size();
         if ($$5 > 0) {
   ...
   private void a(erv $$0, int $$1, int $$2, eqg.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(eqf.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean j() {
      return this.i.m.l().c() == cbk.c;
   }
   ...
   public void a(tf $$0) {
      this.a($$0, null, this.i.U() ? eqg.b() : eqg.a());
   }

   public void a(tf $$0, @Nullable tq $$1, @Nullable eqg $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(tf $$0, @Nullable eqg $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, eqg::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(tf $$0, @Nullable tq $$1, int $$2, @Nullable eqg $$3, boolean $$4) {
      int $$5 = arp.a((double)this.e() / this.g());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<arc> $$6 = esl.a($$0, $$5, this.i.h);
      boolean $$7 = this.m();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new eqf.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private esh.a b(tq $$0) {
      int $$1 = this.i.l.e();
      ListIterator<eqf> $$2 = this.k.listIterator();
   ...
   private eqf a(eqf $$0) {
      return new eqf($$0.a(), h, null, eqg.a());
   }
   ...
   @Nullable
   public eqg c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, eqf.a $$1, eqg $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         eqg.a $$3 = $$2.f();
   ...
   private boolean m() {
      return this.i.y instanceof ewr;
   }
