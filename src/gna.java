public class gna {
   ...
   private final hem[] b = new hem[2];
   private final hem[] c = new hem[2];
   private hem d;

   protected void a() {
      this.b[0] = flh.Q().aE().b().b(djm.K.m()).d();
      this.b[1] = hgw.c.c();
      this.c[0] = flh.Q().aE().b().b(djm.J.m()).d();
      this.c[1] = hgw.d.c();
      this.d = hgw.e.c();
   }

   private static boolean a(esx $$0, esx $$1) {
      return $$1.a().a($$0.a());
   }

   private static boolean a(jn $$0, float $$1, dwv $$2) {
      fbs $$3 = $$2.a($$0.g());
      if ($$3 == fbp.a()) {
         return false;
      } else if ($$3 == fbp.b()) {
         ...
         fbs $$5 = fbp.a(0.0, 0.0, 0.0, 1.0, (double)$$1, 1.0);
         return fbp.a($$5, $$3, $$0);
      }
   }

   private static boolean b(jn $$0, float $$1, dwv $$2) {
      return a($$0, $$1, $$2);
   }
   ...
   public static boolean a(esx $$0, dwv $$1, jn $$2, esx $$3) {
      return !a($$1, $$2) && !a($$0, $$3);
   }

   public void a(dfi $$0, ji $$1, ffw $$2, dwv $$3, esx $$4) {
      boolean $$5 = $$4.a(awu.b);
      hem[] $$6 = $$5 ? this.b : this.c;
      int $$7 = $$5 ? 16777215 : gld.c($$0, $$1);
      float $$8 = (float)($$7 >> 16 & 0xFF) / 255.0F;
      float $$9 = (float)($$7 >> 8 & 0xFF) / 255.0F;
      float $$10 = (float)($$7 & 0xFF) / 255.0F;
      dwv $$11 = $$0.a_($$1.a(jn.a));
      esx $$12 = $$11.y();
      dwv $$13 = $$0.a_($$1.a(jn.b));
      esx $$14 = $$13.y();
      dwv $$15 = $$0.a_($$1.a(jn.c));
      esx $$16 = $$15.y();
      dwv $$17 = $$0.a_($$1.a(jn.d));
      esx $$18 = $$17.y();
      dwv $$19 = $$0.a_($$1.a(jn.e));
      esx $$20 = $$19.y();
      dwv $$21 = $$0.a_($$1.a(jn.f));
      esx $$22 = $$21.y();
      boolean $$23 = !a($$4, $$14);
      ...
      if ($$23 || $$24 || $$28 || $$27 || $$25 || $$26) {
         ...
         if ($$23 && !b(jn.b, Math.min(Math.min($$36, $$38), Math.min($$37, $$35)), $$13)) {
            ...
            if ($$52.d == 0.0 && $$52.f == 0.0) {
               ...
               hem $$62 = $$6[1];
               float $$63 = (float)ayy.d($$52.f, $$52.d) - (float) (Math.PI / 2);
         ...
         for (jn $$91 : jn.c.a) {
            ...
            if ($$98 && !b($$91, Math.max($$92, $$93), $$0.a_($$1.a($$91)))) {
               ...
               if (!$$5) {
                  djk $$122 = $$0.a_($$120).b();
                  if ($$122 instanceof dnb || $$122 instanceof dnw) {
                     $$121 = this.d;
                  }
               }
   ...
   private float a(dfi $$0, esw $$1, float $$2, float $$3, float $$4, ji $$5) {
      if (!($$4 >= 1.0F) && !($$3 >= 1.0F)) {
         float[] $$6 = new float[2];
         if ($$4 > 0.0F || $$3 > 0.0F) {
   ...
   private float a(dfi $$0, esw $$1, ji $$2) {
      dwv $$3 = $$0.a_($$2);
      return this.a($$0, $$1, $$2, $$3, $$3.y());
   }

   private float a(dfi $$0, esw $$1, ji $$2, dwv $$3, esx $$4) {
      if ($$1.a($$4.a())) {
         dwv $$5 = $$0.a_($$2.d());
   ...
   private void a(ffw $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3).a($$4, $$5, $$6, 1.0F).a($$7, $$8).c($$9).b(0.0F, 1.0F, 0.0F);
   }

   private int a(dfi $$0, ji $$1) {
      int $$2 = glr.a($$0, $$1);
      int $$3 = glr.a($$0, $$1.d());
      int $$4 = $$2 & 0xFF;
      int $$5 = $$3 & 0xFF;
