...
public class gna implements gng.a {
   ...
   private final fke F;
   private final Map<jh, gna.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bul $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dQ();
      });
   }

   private void b(fer $$0, gjg $$1, double $$2, double $$3, double $$4) {
      jh $$5 = jh.a($$2, $$3, $$4);
   ...
   private void a(fer $$0, gjg $$1, gna.a $$2) {
      int $$3 = 0;
   ...
   private void a(fer $$0, gjg $$1, aaq.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gnp.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fer $$0, gjg $$1, aaq.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fer $$0, gjg $$1, String $$2, gna.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gna.a $$0) {
      return this.b($$0.a).stream().map(ags::a).collect(Collectors.toSet());
   }

   private Set<String> c(gna.a $$0) {
      return this.c($$0.a).stream().map(ags::a).collect(Collectors.toSet());
   }
   ...
   private void d() {
      gng.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
