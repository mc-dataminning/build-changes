...
public class cqi extends bvk implements bxf {
   ...
   public cqi(bvr<? extends cqi> $$0, dhi $$1) {
      super($$0, $$1);
   }

   public cqi(dhi $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bwg $$6) {
      this(bvr.U, $$0);
      this.d = $$5;
      this.a($$6);
   ...
   public void h() {
      ...
      if (this.dW().C) {
         ...
         if (this.d == -8) {
            for (bwg $$8 : this.dW().a(bwg.class, this.cR().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
