...
public class eai extends eam {
   public static final Codec<eai> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               dzv.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               awe.a(ih.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, eai::new)
   );
   ...
   public eai(float $$0, int $$1, int $$2, dzv $$3, int $$4, List<ih> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(eam.a $$0, ib $$1, ih $$2) {
