...
public class eai extends eal<eah> {
   public eai(Codec<eah> $$0) {
      super($$0);
   }

   public boolean a(eah $$0, ayo $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eag $$0, eah $$1, dug $$2, Function<ja, jj<ddf>> $$3, ayo $$4, dxr $$5, dbm $$6, duf $$7) {
      int $$8 = kc.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eal.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eag $$0, eah $$1, dug $$2, Function<ja, jj<ddf>> $$3, dxr $$4, double $$5, double $$6, double $$7, float $$8, double $$9, duf $$10, eal.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayg.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayg.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayg.b($$13);
         $$6 += (double)(ayg.b($$12) * $$27);
         $$7 += (double)ayg.a($$13);
         $$8 += (double)(ayg.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
