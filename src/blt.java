...
public abstract class blt<R extends Runnable> implements blb, blv<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected blt(String $$0) {
      this.b = $$0;
      bkz.a.a(this);
   }
   ...
   @Override
   public List<bky> bu() {
      return ImmutableList.of(bky.a(this.b + "-pending-tasks", bkx.b, this::bw));
   }
}
