...
public class blt<E extends bja> extends bkq<E> {
   ...
   protected List<blt.a> h = Lists.newArrayList();
   protected Optional<ehe> i = Optional.empty();
   @Nullable
   protected ehe j;
   protected int k;
   protected long l;
   ...
   public blt(bgb $$0, int $$1, int $$2, float $$3, Function<E, aov> $$4) {
      this($$0, $$1, $$2, $$3, $$4, blt::a);
   }

   public static <E extends bja> boolean a(E $$0, gu $$1) {
      cpm $$2 = $$0.dK();
      gu $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(eax.a($$2, $$1.j())) == 0.0F;
   }

   public blt(bgb $$0, int $$1, int $$2, float $$3, Function<E, aov> $$4, BiPredicate<E, gu> $$5) {
      super(ImmutableMap.of(bsa.n, bsb.c, bsa.R, bsb.b, bsa.S, bsb.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(akk $$0, bja $$1) {
      boolean $$2 = $$1.aA() && !$$1.aX() && !$$1.bl() && !$$0.a_($$1.dk()).a(csn.pg);
      if (!$$2) {
         $$1.dM().a(bsa.R, this.p.a($$0.z) / 2);
      }
   ...
   protected void a(akk $$0, E $$1, long $$2) {
      ...
      this.h = gu.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new blt.a($$1x.i(), arp.c($$3.j($$1x))))
   ...
   protected Optional<blt.a> a(akk $$0) {
      Optional<blt.a> $$1 = bfd.a($$0.z, this.h);
   ...
   @Nullable
   private ehe a(bja $$0, ehe $$1, int $$2) {
      ehe $$3 = $$0.di();
      ehe $$4 = new ehe($$1.c - $$3.c, 0.0, $$1.e - $$3.e).d().a(0.5);
      $$1 = $$1.d($$4);
      ehe $$5 = $$1.d($$3);
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            for (int $$26 = 0; $$26 < $$22 - 1; $$26++) {
               ...
               double $$28 = $$23 * $$17;
               double $$29 = $$23 * $$16;
               ehe $$30 = new ehe($$3.c + $$28, $$3.d + $$27, $$3.e + $$29);
            ...
            return new ehe($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }

   private boolean a(bja $$0, bij $$1, ehe $$2, ehe $$3) {
      ehe $$4 = $$3.d($$2);
