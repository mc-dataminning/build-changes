...
public class fac {
   private final ImmutableList<fad> a;
   private final ImmutableMap<String, fad> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private faa e;

   public fac(ImmutableMap<String, fad> $$0) {
      this.b = $$0;
