...
public class fac {
   ...
   public static final fac.a bv;

   public static fac.a a(int $$0, int $$1) {
      return $$0 == -1 ? fac.b.b.a($$1) : fac.b.a.a($$0);
   }

   public static fac.a a(String $$0) {
      if (fac.a.e.containsKey($$0)) {
         return fac.a.e.get($$0);
      } else {
         for (fac.b $$1 : fac.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fac.b b;
      private final int c;
      private final ayi<wz> d;
      static final Map<String, fac.a> e = Maps.newHashMap();

      a(String $$0, fac.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayi<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wz.b($$2.toUpperCase(Locale.ROOT)) : wz.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wz.b($$2) : wz.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tw.a().b($$1) ? wz.c($$1) : wz.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fac.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wz> g;

      private static void a(fac.b $$0, String $$1, int $$2) {
         fac.a $$3 = new fac.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, wz> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fac.a a(int $$0) {
         return (fac.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
