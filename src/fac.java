...
public class fac extends ezu<cff> implements fbx {
   private float x;
   private float y;
   private final fbr z = new fbr();
   private boolean A;
   private boolean B;

   public fac(cbp $$0) {
      super($$0.bP, $$0.fQ(), ti.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void C() {
      if (this.f.q.g()) {
         this.f.a(new ezr(this.f.s, this.f.s.cl.x(), this.f.m.F().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aD_() {
      if (this.f.q.g()) {
         ...
         this.d(new esx(this.t + 104, this.h / 2 - 22, 20, 18, fbr.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(esa $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bjb $$9) {
   ...
   public static void a(esa $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bjb $$7) {
      $$0.c().a();
