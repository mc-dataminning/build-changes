...
public class fac extends ezu<cfq> implements fbx {
   private float x;
   private float y;
   ...
   public fac(cca $$0) {
      super($$0.bR, $$0.fS(), tl.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void D() {
      if (this.f.q.g()) {
         this.f.a(new ezr(this.f.s, this.f.s.cn.y(), this.f.m.F().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aH_() {
      if (this.f.q.g()) {
         ...
         this.d(new esw(this.t + 104, this.h / 2 - 22, 20, 18, fbr.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(erz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bjm $$9) {
   ...
   public static void a(erz $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bjm $$7) {
      $$0.c().a();
