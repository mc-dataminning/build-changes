...
public class dff {
   public static final Codec<dff> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dfd.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dfd.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               cwp.a.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final yn<wa, dff> b = yn.a(dff::a, dff::a);
   private final dfd c;
   private final Optional<dfd> d;
   private final cwp e;
   private int f;
   private final int g;
   ...
   private dff(dfd $$0, Optional<dfd> $$1, cwp $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dff(dfd $$0, cwp $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dff(dfd $$0, Optional<dfd> $$1, cwp $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dff(dfd $$0, Optional<dfd> $$1, cwp $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dff(dfd $$0, Optional<dfd> $$1, cwp $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   public cwp c() {
      return this.d.map(dfd::d).orElse(cwp.j);
   }
   ...
   private static void a(wa $$0, dff $$1) {
      dfd.b.encode($$0, $$1.d());
      cwp.h.encode($$0, $$1.f());
      dfd.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dff a(wa $$0) {
      dfd $$1 = dfd.b.decode($$0);
      cwp $$2 = cwp.h.decode($$0);
      Optional<dfd> $$3 = dfd.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dff $$11 = new dff($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
