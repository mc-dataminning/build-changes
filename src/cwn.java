...
public class cwn extends cvc implements cuw {
   public static final MapCodec<cwn> d = b(cwn::new);
   public static final int e = 7;
   public static final dhw f = dhm.av;
   private static final ekb[] a = new ekb[]{
   ...
   @Override
   public MapCodec<? extends cwn> a() {
      return d;
   }

   protected cwn(dgv.d $$0) {
      super($$0);
   ...
   public void a(crs $$0, ht $$1, dgw $$2) {
   ...
   protected int a(crs $$0) {
      return ati.a($$0.z, 2, 5);
   }

   protected static float a(cut $$0, cqy $$1, ht $$2) {
      float $$3 = 1.0F;
      ht $$4 = $$2.d();
   ...
   protected static boolean a(crv $$0, ht $$1) {
      return $$0.b($$1, 0) >= 8;
   }
