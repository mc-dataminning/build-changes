...
public abstract class cja extends bsv {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<bsv> b = $$0 -> $$0 instanceof cja;
   private int f;
   protected iz c;
   protected je d;

   protected cja(btb<? extends cja> $$0, dbz $$1) {
      super($$0, $$1);
      this.d = je.d;
   }

   protected cja(btb<? extends cja> $$0, dbz $$1, iz $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void y() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new evn($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void b(@Nullable bsv var1);
