...
public abstract class cja extends cjm {
   private static final double g = 2.0;
   private static final aim<Byte> h = aiq.a(cja.class, aio.a);
   private static final aim<Byte> i = aiq.a(cja.class, aio.a);
   ...
   protected cja(bpd<? extends cja> $$0, cxb $$1, cqm $$2) {
      super($$0, $$1);
      this.t = $$2.q();
      if ($$2.B()) {
         this.b($$2.z());
   ...
   protected cja(bpd<? extends cja> $$0, double $$1, double $$2, double $$3, cxb $$4, cqm $$5) {
      this($$0, $$4, $$5);
      this.a_($$1, $$2, $$3);
   }

   protected cja(bpd<? extends cja> $$0, bpp $$1, cxb $$2, cqm $$3) {
   ...
   public void l() {
      ...
      if (this.b && !$$0) {
         ...
         ept $$8 = this.dk();
         ept $$9 = $$8.e($$1);
         epr $$10 = this.dM().a(new cwk($$8, $$9, cwk.a.a, cwk.b.a, this));
         if ($$10.c() != epr.a.a) {
            $$9 = $$10.e();
         }
         ...
         while (!this.dH() && !this.f) {
            ...
            if ($$10 != null && $$10.c() == epr.a.c) {
               box $$12 = ((epq)$$10).a();
               box $$13 = this.af_();
               if ($$12 instanceof ciu && $$13 instanceof ciu && !((ciu)$$13).a((ciu)$$12)) {
                  $$10 = null;
                  $$11 = null;
               }
            }
   ...
   private boolean G() {
      return this.b && this.dM().b(new epo(this.dk(), this.dk()).g(0.06));
   }
   ...
   protected void a(epq $$0) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof bpp $$10) {
            if (!this.dM().B && this.C() <= 0) {
               $$10.q($$10.eQ() + 1);
            }

            if (this.p > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.g(bqw.n));
               ept $$12 = this.dp().d(1.0, 0.0, 1.0).d().a((double)this.p * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dM().B && $$5 instanceof bpp) {
               cux.a($$10, $$5);
               cux.b((bpp)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof ciu && $$5 instanceof apg && !this.aU()) {
   ...
   protected void a(epp $$0) {
      ...
      super.a($$0);
      ept $$1 = $$0.e().a(this.dr(), this.dt(), this.dx());
      this.g($$1);
      ept $$2 = $$1.d().a(0.05F);
   ...
   protected epq a(ept $$0, ept $$1) {
      return cjo.a(this.dM(), this, $$0, $$1, this.cH().b(this.dp()).g(1.0), this::b);
   }
