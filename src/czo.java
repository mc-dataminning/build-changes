...
public class czo extends csi implements czw {
   ...
   public void a(dfj $$0, akr $$1, gw $$2, asc $$3) {
      if (h($$0) != dgq.b) {
         if (h($$0) == dgq.c) {
            $$1.a($$2, $$0.a(d, dgq.a), 3);
            if (!$$0.c(f)) {
               $$1.a(null, $$2, ape.uu, apf.e, 1.0F, $$1.z.i() * 0.2F + 0.8F);
            }
         }
      } else {
         a($$1, $$2, $$0);
   ...
   public void a(@Nullable biq $$0, cpv $$1, gw $$2, dfj $$3, int $$4, int $$5) {
      ...
      $$1.a($$0, djt.L, $$2);
      if (!$$3.c(f)) {
         $$1.a(null, (double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, ape.ut, apf.e, 1.0F, $$1.z.i() * 0.2F + 0.8F);
      }
   }
