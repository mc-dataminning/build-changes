...
public class wp extends SimpleChannelInboundHandler<aac<?>> {
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xv.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof xi) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xv.c("disconnect.timeout"));
            } else {
               xv $$3 = xv.a("disconnect.genericReason", "Internal Exception: " + $$1);
               xb $$4 = this.q;
               wr $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == aad.b) {
                     aac<?> $$7 = (aac<?>)(this.l ? new ajy($$3) : new aal($$3));
                     this.a($$7, xc.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, aac<?> $$1) {
      if (this.n.isOpen()) {
         xb $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xv.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(xv.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends xb> void a(aac<T> $$0, xb $$1) {
      $$0.a((T)$$1);
   }

   private void b(xd<?> $$0, xb $$1) {
   ...
   public <T extends xb> void a(xd<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(xb $$0) {
      ...
      } else if (this.k == aad.a && $$0.a() == aad.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, aku $$2) {
      this.a($$0, $$1, ala.b, ala.d, $$2, ajo.a);
   }

   public void a(String $$0, int $$1, aju $$2) {
      this.a($$0, $$1, akb.b, akb.d, $$2, ajo.b);
   }

   public <S extends xh, C extends wm> void a(String $$0, int $$1, xd<S> $$2, xd<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ajo.c : ajo.b);
   }

   private <S extends xh, C extends wm> void a(String $$0, int $$1, xd<S> $$2, xd<C> $$3, C $$4, ajo $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<wp>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new ajp(ab.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(aac<?> $$0, @Nullable xc $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(aac<?> $$0, @Nullable xc $$1, boolean $$2) {
      this.v++;
   ...
   private void c(aac<?> $$0, @Nullable xc $$1, boolean $$2) {
   ...
   protected void c() {
      this.x = bae.h(0.75F, (float)this.v, this.x);
      this.w = bae.h(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static wp a(InetSocketAddress $$0, boolean $$1, @Nullable bod $$2) {
      wp $$3 = new wp(aad.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final wp $$2) {
   ...
   public static void a(ChannelPipeline $$0, aad $$1, boolean $$2, @Nullable wi $$3) {
      aad $$4 = $$1.a();
      boolean $$5 = $$1 == aad.a;
      boolean $$6 = $$4 == aad.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wz<ajs>(j) : new xk.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new xa<ajs>(j) : new xk.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new ww() : new xp());
   }

   private static ChannelInboundHandler a(@Nullable wi $$0, boolean $$1) {
      if (!$$1) {
         return new xo($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wu($$0) : new wv());
      }
   }

   public static void a(ChannelPipeline $$0, aad $$1) {
      a($$0, $$1, true, null);
   }

   public static wp a(SocketAddress $$0) {
      final wp $$1 = new wp(aad.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new wk($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new wl($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof wn $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new wn($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof wo $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new wo($$0));
         }
      } else {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            xb $$0 = this.k();
            xb $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               wr $$2 = Objects.requireNonNullElseGet(this.l(), () -> new wr(xv.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
