...
@Deprecated
public class ebt extends ebe<ebt.a> {
   private static final dsh a = dfh.nc.o();

   public ebt(Codec<ebt.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebg<ebt.a> $$0) {
      ja $$1 = $$0.e();
      dcz $$2 = $$0.b();
      aym $$3 = $$0.d();
      ebt.a $$4 = $$0.f();
   ...
   public static record a(efj b, efj c) implements edi {
      public static final Codec<ebt.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(efj.a.fieldOf("fluid").forGetter(ebt.a::a), efj.a.fieldOf("barrier").forGetter(ebt.a::b)).apply($$0, ebt.a::new)
      );
