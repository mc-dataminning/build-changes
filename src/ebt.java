...
public class ebt extends eay<edk> {
   public ebt(Codec<edk> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<edk> $$0) {
      azh $$1 = $$0.d();
      iz $$2 = $$0.e();
      dct $$3 = $$0.b();
      edk $$4 = $$0.f();
   ...
   protected boolean a(
      dct $$0, azh $$1, edk $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dsc $$0, Function<iz, dsc> $$1, azh $$2, edk $$3, edk.a $$4, iz.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
