...
public final class ebt extends ebw<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private ebt(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ebt $$1 && super.equals($$0)) {
   ...
   public static ebt a(String $$0, int $$1, int $$2) {
