...
public class ebt {
   ...
   private final Map<String, ebi> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public ebt(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends ebi> T a(ebi.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends ebi> T b(ebi.a $$0, String $$1) {
      ebi $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends ebi> T a(Function<qr, T> $$0, ass $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
            qr $$4 = this.a($$2, $$1, aa.b().d().c());
   ...
   public void a(String $$0, ebi $$1) {
      this.b.put($$0, $$1);
   }

   public qr a(String $$0, ass $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
