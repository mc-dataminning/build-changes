...
public class ebt {
   ...
   private final Predicate<bvk> j;
   private final asd k = (asd)new asd(xv.c("entity.minecraft.ender_dragon"), bsz.a.a, bsz.b.a).b(true).c(true);
   private final ash l;
   private final jh m;
   ...
   public ebt(ash $$0, long $$1, ebt.a $$2) {
      this($$0, $$1, $$2, jh.c);
   }

   public ebt(ash $$0, long $$1, ebt.a $$2, jh $$3) {
      this.l = $$0;
      this.m = $$3;
      this.j = bvp.a.and(bvp.a((double)$$3.u(), (double)(128 + $$3.v()), (double)$$3.w(), 192.0));
      this.x = $$2.c;
   ...
   public ebt.a b() {
      return new ebt.a(this.x, this.t, this.u, false, Optional.ofNullable(this.w), Optional.ofNullable(this.y), Optional.of(this.n));
   }
   ...
   public void c() {
      ...
      if (!this.k.g().isEmpty()) {
         this.l.m().a(asn.b, new dgo(0, 0), 9, bbk.a);
         boolean $$0 = this.n();
         if (this.x && $$0) {
            this.j();
            this.x = false;
         ...
         this.l.m().b(asn.b, new dgo(0, 0), 9, bbk.a);
      }
   }
   ...
   @Nullable
   private dya.b m() {
      dgo $$0 = new dgo(this.m);

      for (int $$1 = -8 + $$0.h; $$1 <= 8 + $$0.h; $$1++) {
         for (int $$2 = -8 + $$0.i; $$2 <= 8 + $$0.i; $$2++) {
            eaa $$3 = this.l.d($$1, $$2);

            for (dux $$4 : $$3.I().values()) {
               if ($$4 instanceof dwr) {
                  dya.b $$5 = this.o.a(this.l, $$4.aB_());
                  if ($$5 != null) {
                     jh $$6 = $$5.a(3, 3, 3).d();
                     if (this.y == null) {
                        this.y = $$6;
      ...
      jh $$7 = egv.a(this.m);
      int $$8 = this.l.a(edq.a.e, $$7).v();

      for (int $$9 = $$8; $$9 >= this.l.L_(); $$9--) {
         dya.b $$10 = this.o.a(this.l, new jh($$7.u(), $$9, $$7.w()));
         if ($$10 != null) {
            if (this.y == null) {
               this.y = $$10.a(3, 3, 3).d();
            }
   ...
   private boolean n() {
      if (this.v) {
         ...
         for (int $$1 = -8 + $$0.h; $$1 <= 8 + $$0.h; $$1++) {
            for (int $$2 = 8 + $$0.i; $$2 <= 8 + $$0.i; $$2++) {
               dzq $$3 = this.l.a($$1, $$2, ear.n, false);
               if (!($$3 instanceof eaa)) {
                  return false;
               }
   ...
   private void p() {
      ...
      for (eig.a $$0 : eig.a(this.l)) {
         this.q = this.q + this.l.a(ckt.class, $$0.f()).size();
      }
   ...
   public void a(cku $$0) {
      if ($$0.cG().equals(this.w)) {
         ...
         this.q();
         if (!this.u) {
            this.l.b(this.l.a(edq.a.e, egv.a(this.m)), dko.fO.m());
         }
   ...
   private void a(boolean $$0) {
      egv $$1 = new egv($$0);
      if (this.y == null) {
         this.y = this.l.a(edq.a.f, egv.a(this.m)).e();

         while (this.l.a_(this.y).a(dko.I) && this.y.v() > 63) {
            this.y = this.y.e();
         }
      }

      if ($$1.a(eja.m, this.l, this.l.m().g(), bam.a(), this.y)) {
         int $$2 = bae.e(4, 16);
         this.l.m().a.a(new dgo(this.y), $$2);
      }
   }
   ...
   public void a(ckt $$0, bua $$1) {
      if (this.z != null && this.B.contains($$0)) {
         ...
         this.p();
         if (this.l.a(this.w) instanceof cku $$3) {
            $$3.a(this.l, $$0, $$0.dw(), $$1);
         }
      }
   }
   ...
   public void g() {
      if (this.t && this.z == null) {
         ...
         List<ckt> $$2 = Lists.newArrayList();
         jh $$3 = $$0.b(1);

         for (jm $$4 : jm.c.a) {
            List<ckt> $$5 = this.l.a(ckt.class, new fbt($$3.a($$4, 2)));
            if ($$5.isEmpty()) {
               return;
            }
   ...
   private void a(List<ckt> $$0) {
      if (this.t && this.z == null) {
         for (dya.b $$1 = this.m(); $$1 != null; $$1 = this.m()) {
            for (int $$2 = 0; $$2 < this.o.c(); $$2++) {
               for (int $$3 = 0; $$3 < this.o.b(); $$3++) {
                  for (int $$4 = 0; $$4 < this.o.a(); $$4++) {
                     dxz $$5 = $$1.a($$2, $$3, $$4);
                     if ($$5.a().a(dko.I) || $$5.a().a(dko.fL)) {
                        this.l.b($$5.d(), dko.fN.m());
                     }
                  }
               }
            }
   ...
   public void h() {
      for (eig.a $$0 : eig.a(this.l)) {
         for (ckt $$2 : this.l.a(ckt.class, $$0.f())) {
            $$2.n(false);
            $$2.a(null);
         }
      }
   ...
   public static record a(boolean c, boolean d, boolean e, boolean f, Optional<UUID> g, Optional<jh> h, Optional<List<Integer>> i) {
      public static final Codec<ebt.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  Codec.BOOL.fieldOf("NeedsStateScanning").orElse(true).forGetter(ebt.a::a),
                  Codec.BOOL.fieldOf("DragonKilled").orElse(false).forGetter(ebt.a::b),
                  Codec.BOOL.fieldOf("PreviouslyKilled").orElse(false).forGetter(ebt.a::c),
                  Codec.BOOL.lenientOptionalFieldOf("IsRespawning", false).forGetter(ebt.a::d),
                  kk.a.lenientOptionalFieldOf("Dragon").forGetter(ebt.a::e),
                  jh.a.lenientOptionalFieldOf("ExitPortalLocation").forGetter(ebt.a::f),
                  Codec.list(Codec.INT).lenientOptionalFieldOf("Gateways").forGetter(ebt.a::g)
               )
               .apply($$0, ebt.a::new)
      );
      public static final ebt.a b = new ebt.a(true, false, false, false, Optional.empty(), Optional.empty(), Optional.empty());
