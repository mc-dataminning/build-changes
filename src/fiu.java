...
public class fiu {
   ...
   public static void a(File $$0, fbo $$1, Consumer<xd> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fbo $$2, Consumer<xd> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fbo $$2, Consumer<xd> $$3) {
      fce $$4 = a($$2);
   ...
   public static fce a(fbo $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fce $$3 = new fce($$1, $$2, false);
   ...
   public fiu(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
