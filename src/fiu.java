...
public class fiu {
   ...
   public void a(final fis $$0, final Runnable $$1) throws UnknownHostException {
      final fjp $$2 = fjp.a($$0.b);
      Optional<InetSocketAddress> $$3 = fjr.a.a($$2).map(fjo::d);
      if ($$3.isEmpty()) {
         this.a(ewt.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fjp $$1, final fis $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)sg.g.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fin($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.g = -1;
               $$2.h = tf.b($$2xx);
               $$2.d = tf.b($$3);
               $$2.c = fiu.a($$4, $$5);
