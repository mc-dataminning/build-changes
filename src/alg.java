...
public class alg {
   ...
   private alg(jy<ale> $$0, jt.a $$1, cru $$2, ey.a $$3, List<ke.a<?>> $$4, int $$5) {
   ...
   public static CompletableFuture<alg> a(aup $$0, jy<ale> $$1, List<ke.a<?>> $$2, cru $$3, ey.a $$4, int $$5, Executor $$6, Executor $$7) {
