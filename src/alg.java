...
public class alg {
   ...
   public static <D, R> CompletableFuture<R> a(alg.c $$0, alg.f<D> $$1, alg.e<D, R> $$2, Executor $$3, Executor $$4) {
      try {
         Pair<dcy, atk> $$5 = $$0.a.a();
         atk $$6 = (atk)$$5.getSecond();
         jq<akt> $$7 = akt.a();
         jq<akt> $$8 = b($$6, $$7, akt.b, akf.a);
         jx.b $$9 = $$8.b(akt.c);
         jx.b $$10 = akf.a($$6, $$9, akf.b);
         dcy $$11 = (dcy)$$5.getFirst();
   ...
   private static jx.b a(atu $$0, jq<akt> $$1, akt $$2, List<akf.c<?>> $$3) {
      jx.b $$4 = $$1.b($$2);
      return akf.a($$0, $$4, $$3);
   }

   private static jq<akt> b(atu $$0, jq<akt> $$1, akt $$2, List<akf.c<?>> $$3) {
      jx.b $$4 = a($$0, $$1, $$2, $$3);
      return $$1.a($$2, $$4);
   }

   public static record a(atu a, dcy b, jx.b c, jx.b d) {
   }
   ...
   public static record d(atf a, dcy b, boolean c, boolean d) {
      public Pair<dcy, atk> a() {
         dcy $$0 = MinecraftServer.a(this.a, this.b, this.d, this.c);
         List<asg> $$1 = this.a.g();
         atk $$2 = new atn(asi.b, $$1);
         return Pair.of($$0, $$2);
      }
   ...
   public interface e<D, R> {
      R create(atk var1, akv var2, jq<akt> var3, D var4);
   }
