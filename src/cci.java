...
public class cci extends ccm {
   ...
   private static final aee<Integer> g = aeh.a(cci.class, aeg.b);
   private static final aee<Boolean> h = aeh.a(cci.class, aeg.k);
   private int i;
   private int j;
   private int k;
   private int l;
   ...
   public cci(cbu $$0, cpv $$1, int $$2, int $$3) {
      ...
      float $$4 = $$0.dD();
      float $$5 = $$0.dB();
      float $$6 = arw.b(-$$5 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$7 = arw.a(-$$5 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$8 = -arw.b(-$$4 * (float) (Math.PI / 180.0));
      float $$9 = arw.a(-$$4 * (float) (Math.PI / 180.0));
      double $$10 = $$0.dq() - (double)$$7 * 0.3;
      double $$11 = $$0.du();
      double $$12 = $$0.dw() - (double)$$6 * 0.3;
      this.b($$10, $$11, $$12, $$5, $$4);
      ehn $$13 = new ehn((double)(-$$7), (double)arw.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
      $$13 = $$13.d(0.6 / $$14 + this.ag.a(0.5, 0.0103365), 0.6 / $$14 + this.ag.a(0.5, 0.0103365), 0.6 / $$14 + this.ag.a(0.5, 0.0103365));
      this.f($$13);
      this.r((float)(arw.d($$13.c, $$13.e) * 180.0F / (float)Math.PI));
      this.s((float)(arw.d($$13.d, $$13.h()) * 180.0F / (float)Math.PI));
      this.N = this.dB();
      this.O = this.dD();
   }
   ...
   public void a(aee<?> $$0) {
      ...
      if (h.equals($$0)) {
         this.d = this.al().b(h);
         if (this.d) {
            this.o(this.do().c, (double)(-0.4F * arw.a(this.c, 0.6F, 1.0F)), this.do().e);
         }
      }
   ...
   private void a(gw $$0) {
      ...
      if (this.j > 0) {
         ...
         if (this.l > 0) {
            ...
            double $$8 = (double)((float)arw.a(this.ds()) + 1.0F);
            ...
            this.a(apd.hQ, 0.25F, 1.0F + (this.ag.i() - this.ag.i()) * 0.4F);
         ...
         if (this.ag.i() < $$14) {
            float $$15 = arw.a(this.ag, 0.0F, 360.0F) * (float) (Math.PI / 180.0);
            float $$16 = arw.a(this.ag, 25.0F, 60.0F);
            double $$17 = this.dq() + (double)(arw.a($$15) * $$16) * 0.1;
            double $$18 = (double)((float)arw.a(this.ds()) + 1.0F);
            double $$19 = this.dw() + (double)(arw.b($$15) * $$16) * 0.1;
         ...
         if (this.k <= 0) {
            this.m = arw.a(this.ag, 0.0F, 360.0F);
            this.l = arw.a(this.ag, 20, 80);
         }
      } else {
         this.k = arw.a(this.ag, 100, 600);
   ...
   private cci.b c(gw $$0) {
      ...
      if (!$$1.i() && !$$1.a(csw.fm)) {
         eam $$2 = $$1.u();
         return $$2.a(apx.a) && $$2.b() && $$1.k(this.dL(), $$0).c() ? cci.b.b : cci.b.c;
      } else {
         return cci.b.a;
      }
   }
   ...
   public int a(cjf $$0) {
      ...
      if (!this.dL().B && $$1 != null && !this.a($$1)) {
         ...
         if (this.o != null) {
            this.c(this.o);
            al.D.a((akr)$$1, $$0, this, Collections.emptyList());
            this.dL().a(this, (byte)31);
            $$2 = this.o instanceof byn ? 3 : 5;
         } else if (this.j > 0) {
            ecw $$3 = new ecw.a((akq)this.dL()).a(efb.f, this.dj()).a(efb.i, $$0).a(efb.a, this).a((float)this.q + $$1.gn()).a(efa.f);
            ecy $$4 = this.dL().n().aH().getLootTable(eco.ai);
            List<cjf> $$5 = $$4.a($$3);
            al.D.a((akr)$$1, $$0, this, $$5);
   ...
   public vd<ww> di() {
      biq $$0 = this.v();
      return new wx(this, $$0 == null ? this.ah() : $$0.ah());
   }
