   ...
   public void a(ftk $$0) {
      if (this.e != null) {
         ...
         $$0.a($$4x -> {
            ...
            for (bro $$6x : $$1) {
               int $$7x = azz.a($$6x.a / 4.0) + 1;
               flg $$8x = $$4x.getBuffer(gry.B());
               int $$9x = ayh.f($$6x.a());
               int $$10x = ayh.a($$9x, -8355712);
               fld.a $$11x = $$0.c().c();
