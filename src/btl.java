...
public class btl extends bte {
   public static final MapCodec<btl> a = RecordCodecBuilder.mapCodec(
   ...
   private btl(float $$0, float $$1) {
      this.b = $$0;
      this.d = $$1;
   }

   public static btl b(float $$0, float $$1) {
      if ($$1 <= $$0) {
