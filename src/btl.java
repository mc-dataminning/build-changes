...
public class btl extends btb {
   ...
   public btl(bmo $$0, double $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   ...
   public boolean b() {
      ...
      if ($$0 == null) {
         ...
         return !this.a.a($$0.dm()) ? false : !($$0 instanceof cfb) || !$$0.P_() && !((cfb)$$0).f();
      }
   }
