...
public class caa extends bzo {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new ejz($$0, this.g.du() + $$5, $$1);
         }
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               ejz $$8 = new ejz(this.g.ds() - this.a.ds(), 0.0, this.g.dy() - this.a.dy()).d();
               ejz $$9 = new ejz((double)atq.a(this.a.dD() * (float) (Math.PI / 180.0)), 0.0, (double)(-atq.b(this.a.dD() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  ejz $$13 = this.a.f(1.0F);
                  ...
                  cei $$20 = new cei(this.a.dN(), this.a, $$17, $$18, $$19);
   ...
   public void a(bll $$0) {
      ...
      int $$9 = atq.a(this.g.du() + $$8);
      edk $$10 = new edk($$3, $$9, $$4);
