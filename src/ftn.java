public class ftn extends fui {
   ...
   public ftn() {
      super(wo.c("demo.help.title"));
   }

   @Override
   protected void aR_() {
      int $$0 = -16;
      this.c(fop.a(wo.c("demo.help.buy"), $$0x -> {
         $$0x.j = false;
         af.m().a(axu.f);
      }).a(this.n / 2 - 116, this.o / 2 + 62 + -16, 114, 20).a());
      this.c(fop.a(wo.c("demo.help.later"), $$0x -> {
         this.m.a(null);
         this.m.o.i();
      ...
      this.d = fpj.a(
         this.p,
         wo.a("demo.help.movementShort", $$1.v.k(), $$1.w.k(), $$1.x.k(), $$1.y.k()),
         wo.c("demo.help.movementMouse"),
         wo.a("demo.help.jump", $$1.z.k()),
         wo.a("demo.help.inventory", $$1.C.k())
      );
      this.s = fpj.a(this.p, wo.c("demo.help.fullWrapped"), 218);
   }
   ...
   public void b(fob $$0, int $$1, int $$2, float $$3) {
      ...
      int $$4 = (this.n - 248) / 2;
      int $$5 = (this.o - 166) / 2;
      $$0.a(gmf::H, a, $$4, $$5, 0.0F, 0.0F, 248, 166, 256, 256);
   }
