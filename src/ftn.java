...
public class ftn extends ftr {
   ...
   private static final aly<dic> y = dij.b;
   ...
   @Nullable
   private static emc a(jr<dke> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, ebi.c);
      int $$10 = $$9 - $$2;

      Optional<jq.c<dke>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new emc($$10, $$11.get().a());
      }
   }

   private static List<emc> a(jr<dke> $$0, String $$1) {
      List<emc> $$2 = Lists.newArrayList();
      String[] $$3 = $$1.split(",");
      int $$4 = 0;
   ...
   public static emf a(jr<dke> $$0, jr<dic> $$1, jr<eoi> $$2, jr<eng> $$3, String $$4, emf $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return emf.a($$1, $$2, $$3);
      } else {
         List<emc> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return emf.a($$1, $$2, $$3);
         } else {
            jq.c<dic> $$8 = $$1.b(y);
            ...
            if ($$6.hasNext()) {
               String $$10 = $$6.next();
               $$9 = Optional.ofNullable(alz.c($$10)).map($$0x -> aly.a(mb.aH, $$0x)).flatMap($$1::a).orElseGet(() -> {
   ...
   protected void aT_() {
      ...
      jr<eoi> $$4 = $$1.e(mb.aV);
      jr<eng> $$5 = $$1.e(mb.aS);
      jr<dke> $$6 = $$1.e(mb.f).a($$2);
      this.E.a(a(this.z.k()));
      this.F = this.z.k();
      this.d(this.E);
      this.C = this.c(new ftn.a($$1, $$2));
      this.D = this.c(fny.a(xv.c("createWorld.customize.presets.select"), $$4x -> {
         emf $$5x = a($$6, $$3, $$4, $$5, this.E.a(), this.F);
         this.z.a($$5x);
         this.m.a(this.z);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(fny.a(xu.e, $$0x -> this.m.a(this.z)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends fov<ftn.a.a> {
      public a(final ke $$0, final cso $$1) {
         super(ftn.this.m, ftn.this.n, ftn.this.o - 117, 80, 24);

         for (jq<emd> $$2 : $$0.e(mb.aP).c(axz.a)) {
      ...
      public class a extends fov.a<ftn.a.a> {
         ...
         public a(final jq<emd> $$1) {
            this.c = $$1.a();
            this.d = $$1.e().map($$0x -> xv.c($$0x.a().h("flat_world_preset"))).orElse(ftn.a);
         }

         @Override
         public void a(fnl $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            this.a($$0, $$3, $$2, this.c.a().a());
            $$0.a(ftn.this.p, this.d, $$3 + 18 + 5, $$2 + 6, 16777215, false);
         }
         ...
         private void a(fnl $$0, int $$1, int $$2, cxg $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cxk($$3), $$1 + 2, $$2 + 2);
         }

         private void a(fnl $$0, int $$1, int $$2) {
            $$0.a(glo::B, ftn.b, $$1, $$2, 18, 18);
         }
