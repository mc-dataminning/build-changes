...
public class ftn extends ftr {
   ...
   private static final IntSupplier f = () -> fmf.Q().n.a().c() ? e : d;
   ...
   public ftn(fmf $$0, avr $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fnr $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(glu.H(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(glu.H(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = ayp.a($$10);
      $$0.a($$0x -> glu.L(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> glu.L(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
   ...
   private void a(fnr $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends hbd {
      ...
      protected hbd.a b(avv $$0) {
         auk $$1 = fmf.Q().ae();
         avn<InputStream> $$2 = $$1.a(aui.a, ftn.a);
         if ($$2 == null) {
            return new hbd.a(new FileNotFoundException(ftn.a.toString()));
         } else {
            try {
               hbd.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new hbd.a(new hdi(true, true), ffr.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new hbd.a(var9);
            }
         }
      }
   }
