public class guo extends gtc<clr, hap> {
   public guo(gtd.a $$0) {
      super($$0);
   }

   public void a(hap $$0, fgr $$1, gmx $$2, int $$3) {
      cls $$4 = $$0.b;
      if ($$4 != null) {
         $$1.a();
   ...
   public void a(clr $$0, hap $$1, float $$2) {
      super.a($$0, $$1, $$2);
      jn $$3 = $$0.cN();
      cls $$4 = $$0.m().a();
      $$1.a = $$3;
      ...
      for (int $$10 = 0; $$10 < $$6; $$10++) {
         for (int $$11 = 0; $$11 < $$5; $$11++) {
            ...
            int $$14 = $$0.dy();
            int $$15 = ayz.a($$0.dB() + (double)$$13);
            int $$16 = $$0.dE();
            switch ($$3) {
               case c:
                  $$14 = ayz.a($$0.dz() + (double)$$12);
                  break;
               case e:
                  $$16 = ayz.a($$0.dF() - (double)$$12);
                  break;
               case d:
                  $$14 = ayz.a($$0.dz() - (double)$$12);
                  break;
            ...
            $$1.c[$$11 + $$10 * $$5] = gmt.a($$9, new ji($$14, $$15, $$16));
         }
      }
   }

   private void a(fgr $$0, fgv $$1, int[] $$2, int $$3, int $$4, hfr $$5, hfr $$6) {
      fgr.a $$7 = $$0.c();
   ...
   private void a(fgr.a $$0, fgv $$1, float $$2, float $$3, float $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, $$2, $$3, $$6).a(-1).a($$4, $$5).b(hfh.d).c($$10).b($$0, (float)$$7, (float)$$8, (float)$$9);
   }
}
