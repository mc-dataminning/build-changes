...
public class evb extends evg {
   ...
   public void a(dhh $$0, jh $$1, dxu $$2, @Nullable eve $$3, boolean $$4) {
      ...
      for (boolean $$7 = true; $$6.hasNext(); $$7 = false) {
         ...
         int $$11 = b($$10);
         dxu $$12 = $$0.a_($$9);
         if ($$12.a(this.a) && !$$12.c(dqq.f).equals($$11)) {
            int $$13 = 2;
            if (!$$4 || !$$7) {
               $$13 |= 128;
            }

            $$0.a($$9, $$12.b(dqq.f, Integer.valueOf($$11)), $$13);
         } else {
            $$6.remove();
         }
      }
   ...
   private static boolean a(dxu $$0, jm $$1) {
      dyr<dyy> $$2 = dqq.g.get($$1);
      return $$2 == null ? $$1 == jm.a : $$0.c($$2).a();
   }

   private static eve a(dhh $$0, @Nullable eve $$1) {
      eve $$2;
      if ($$1 != null) {
         $$2 = $$1;
      } else {
      ...
      return $$2.a(jm.b).a(eve.a.a);
   }

   private void a(dhh $$0, jh $$1, eve $$2) {
      dxu $$3 = $$0.a_($$1);
      if ($$3.a(this.a)) {
         this.a($$1, $$3.c(dqq.f), $$2);
         this.b.add($$1);
      } else {
         this.a($$0, $$1, 0, $$2, true);
      }
   ...
   private void a(jh $$0, int $$1, eve $$2) {
      this.d.compute($$0, ($$2x, $$3) -> $$3 == null ? a($$2, $$1) : a(a($$3), $$1));
   }

   private void a(dhh $$0, jh $$1, int $$2, eve $$3, boolean $$4) {
      for (jm $$5 : $$3.g()) {
         jh $$6 = $$1.a($$5);
   ...
   private void b(dhh $$0, jh $$1, int $$2, eve $$3, boolean $$4) {
      dxu $$5 = $$0.a_($$1);
      if ($$5.a(this.a)) {
         int $$6 = this.a($$1, $$5);
