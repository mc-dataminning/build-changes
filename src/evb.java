...
public class evb {
   ...
   private int j;
   private double k;
   private final ava l = new ava();
   private final ava m = new ava();
   private double n;
   private double o;
   private double p;
   private double q;
      ...
      if ($$0 == this.a.aL().i()) {
         ...
         if (this.a.aI() == null) {
            if (this.a.y == null) {
               ...
               if ($$4) {
                  $$9.w();
                  fct.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  fct.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }
            ...
            if (this.a.y != null) {
               ...
               if (this.a.s.P_()) {
                  if (this.a.l.g().a()) {
                     ...
                     float $$12 = aui.a(this.a.s.fT().a() + (float)$$10 * 0.005F, 0.0F, 0.2F);
                     this.a.s.fT().a($$12);
                  }
               } else {
   ...
   private void b(long $$0, double $$1, double $$2) {
      if ($$0 == eva.N().aL().i()) {
         ...
         if ($$3 != null && this.a.aI() == null) {
            ...
            fct.a(() -> $$3.f($$4, $$5), "mouseMoved event handler", $$3.getClass().getCanonicalName());
            if (this.h != -1 && this.k > 0.0) {
               ...
               fct.a(() -> $$3.a($$4, $$5, this.h, $$6, $$7), "mouseDragged event handler", $$3.getClass().getCanonicalName());
            }
   ...
   public void i() {
      if (this.a.az()) {
         if (!this.s) {
            ...
            eoo.a(this.a.aL().i(), 212995, this.e, this.f);
            this.a.a(null);
            this.a.w = 10000;
            this.i = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.e = (double)(this.a.aL().m() / 2);
         this.f = (double)(this.a.aL().n() / 2);
         eoo.a(this.a.aL().i(), 212993, this.e, this.f);
      }
   }
