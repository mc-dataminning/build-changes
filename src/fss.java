...
public class fss {
   ...
   private fss(int $$0, List<fsu> $$1) {
      this.a = $$1.toArray(fsu[]::new);
      this.b = $$1.size();
   }

   private List<fsu> c() {
      List<fsu> $$0 = new ArrayList<>(this.d());
