...
public class fss {
   ...
   public static fsu a(BooleanConsumer $$0, BanDetails $$1) {
      return new fsu($$0, a($$1), b($$1), aza.n, xu.m, true);
   }

   public static fsu a(Runnable $$0) {
      URI $$1 = aza.n;
      return new fsu($$2 -> {
         if ($$2) {
            ae.m().a($$1);
   ...
   public static fsu a(String $$0, Runnable $$1) {
      URI $$2 = aza.n;
      return new fsu($$2x -> {
         if ($$2x) {
            ae.m().a($$2);
