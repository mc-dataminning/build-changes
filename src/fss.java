...
public class fss extends fsh {
   private static final ftw d = new ftw(alg.b("widget/text_field"), alg.b("widget/text_field_highlighted"));
   ...
   public fss(frt $$0, int $$1, int $$2, wy $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fss(frt $$0, int $$1, int $$2, int $$3, int $$4, wy $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fss(frt $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fss $$5, wy $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fyb.t());
   }
   ...
   public void b(frv $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            ...
            $$0.a(gqk::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         boolean $$9 = this.aJ_() && (af.c() - this.F) / 300L % 2L == 0L && $$8;
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gqk.M(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
