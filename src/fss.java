public abstract class fss extends fso {
   private static final fui a = new fui(alg.b("widget/text_field"), alg.b("widget/text_field_highlighted"));
   private static final int c = 4;

   public fss(int $$0, int $$1, int $$2, int $$3, wy $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(fsh var1, int var2, int var3, float var4);
