...
public interface biv<T, F> {
   ...
   public static final class a implements biv<biv.b, Runnable> {
   ...
   public static final class c<T> implements biv<T, T> {
