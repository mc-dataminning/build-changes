...
public class biv extends bhq {
   public biv(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bit.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bko.a($$0.get("id").asString("minecraft:air"));
