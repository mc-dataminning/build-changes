...
public abstract class ddv implements eu {
   private static final SimpleDateFormat b = new SimpleDateFormat("HH:mm:ss");
   private static final xh c = xh.b("@");
   private long d = -1L;
   ...
   public xh l() {
      return this.h == null ? xg.a : this.h;
   }
   ...
   public uj a(uj $$0, jr.a $$1) {
      ...
      if (this.j != null) {
         $$0.a("CustomName", xh.a.a(this.j, $$1));
      }

      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", xh.a.a(this.h, $$1));
      }
   ...
   public void b(uj $$0, jr.a $$1) {
      this.i = $$0.l("Command");
      this.f = $$0.h("SuccessCount");
      if ($$0.b("CustomName", 8)) {
         this.b(dsg.a($$0.l("CustomName"), $$1));
      } else {
         this.b(null);
      }
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = xh.a.a($$0.l("LastOutput"), $$1);
         } catch (Throwable var4) {
            this.h = xh.b(var4.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public void a(xh $$0) {
      if (this.g) {
         this.h = xh.b("[" + b.format(new Date()) + "] ").b($$0);
         this.f();
      }
   }

   public abstract arm e();
   ...
   public abstract ezh g();

   public abstract ev i();

   @Override
   public boolean l_() {
      return this.e().ac().b(der.p) && this.g;
   }
