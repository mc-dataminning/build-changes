...
public class ayy {
   ...
   public static int f(float $$0, float $$1, float $$2) {
      return ayi.b.a(0, d($$0 * 255.0F), d($$1 * 255.0F), d($$2 * 255.0F));
   }
   ...
   public static boolean a(evq $$0, evq $$1, evl $$2) {
   ...
   public static int h(float $$0, float $$1, float $$2) {
      ...
      return ayi.b.a(0, a((int)($$8 * 255.0F), 0, 255), a((int)($$9 * 255.0F), 0, 255), a((int)($$10 * 255.0F), 0, 255));
   }
