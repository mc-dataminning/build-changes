...
public class ayy {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> aya.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> aya.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayy.d> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alk.d($$0.substring(1)).map($$0x -> new ayy.d($$0x, true)) : alk.d($$0).map($$0x -> new ayy.d($$0x, false)), ayy.d::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bap.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static final Codec<String> C = Codec.STRING
      .validate($$0 -> !alk.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayy.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayy.c<>($$0, $$1);
   }
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return ayy.a($$0, this.a::get, $$1::get);
      }

      public ayy.b<I, V> a(I $$0, V $$1) {
   ...
   public static record d(alk a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
