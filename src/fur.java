...
public class fur {
   ...
   public final Map<ic, fus> c;
   public final fut d;
   public final boolean e;

   public fur(Vector3f $$0, Vector3f $$1, Map<ic, fus> $$2, @Nullable fut $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ic, fus> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fur> {
      ...
      public fur a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         fut $$6 = this.a($$3);
         Map<ic, fus> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !auf.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = auf.a($$3, "shade", true);
            return new fur($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fut a(JsonObject $$0) {
         fut $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = auf.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ic.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = auf.a($$2, "rescale", false);
            $$1 = new fut($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = auf.m($$0, "angle");
         if ($$1 != 0.0F && aup.e($$1) != 22.5F && aup.e($$1) != 45.0F) {
      ...
      private Map<ic, fus> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fus> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ic, fus> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fus> $$2 = Maps.newEnumMap(ic.class);
         JsonObject $$3 = auf.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ic $$5 = this.a($$4.getKey());
            $$2.put($$5, (fus)$$0.deserialize($$4.getValue(), fus.class));
         }
