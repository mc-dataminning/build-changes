public class fur<T extends bsq & cjg> extends ftj<T> {
   public fur(fvw $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      cto $$6 = $$0.eX();
      if ($$0.gh() && ($$6.e() || !$$6.a(ctr.ou))) {
         float $$7 = ayd.a(this.c * (float) Math.PI);
         float $$8 = ayd.a((1.0F - (1.0F - this.c) * (1.0F - this.c)) * (float) Math.PI);
         this.n.g = 0.0F;
         this.o.g = 0.0F;
