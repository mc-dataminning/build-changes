...
public class fur implements fgp {
   static final Logger b = LogUtils.getLogger();
   private final fhq c;
   private final fuf<fur.b> d;

   fur(fhq $$0, fuf<fur.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(ale c, int d, int e, int[][] f) implements fut {
      ...
      public static final MapCodec<fur.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     ale.a.fieldOf("file").forGetter(fur.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fur.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fur.a::e),
                     g.fieldOf("chars").forGetter(fur.a::f)
                  )
                  .apply($$0, fur.a::new)
         )
         .validate(fur.a::a);
      ...
      private static DataResult<fur.a> a(fur.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fur.b $$15 = $$9.a($$12, new fur.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fur.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(fhq $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, fhq b, int c, int d, int e, int f, int g, int h) implements fgo {
