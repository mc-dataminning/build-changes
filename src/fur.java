...
public class fur<T extends cfq & bsm> extends fuk<T> {
   ...
   public static fyy c() {
      ...
      fzb $$1 = $$0.a();
      fzb $$2 = $$1.a(
         "body", fyx.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fyu.a(0.0F, 20.0F, 5.0F)
      );
      fyw $$3 = new fyw(0.001F);
      fzb $$4 = $$2.a("head", fyx.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fyu.a(0.0F, 0.0F, -9.0F));
      fyx $$5 = fyx.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fyx $$6 = fyx.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fyx $$7 = fyx.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fyu.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fyu.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fyu.a(4.0F, 0.0F, -1.0F));
      fyx $$8 = fyx.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fyx $$9 = fyx.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fyu.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fyu.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fyu.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fyu.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fyx.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fyu.a(0.0F, 0.0F, 1.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.gE()) {
         ...
         boolean $$6 = $$2 > 1.0E-5F || $$0.dM() != $$0.Q || $$0.dK() != $$0.P;
         if ($$0.bl()) {
            if ($$6) {
               this.d($$3, $$5);
            } else {
   ...
   private Vector3f a(fys $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fys $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fys $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * aym.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * aym.b($$2 * 0.9F));
