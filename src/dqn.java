...
public class dqn extends dqa<drx> {
   public dqn(Codec<drx> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dqc<drx> $$0) {
      hx $$1 = $$0.e();
      csz $$2 = $$0.b();
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? atq.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(atw $$0, csg $$1, int $$2, int $$3, hx $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, hx $$2, csg $$3, boolean $$4, double $$5, hx $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(csg $$0, hx $$1) {
      if ($$0.a_($$1.c()).a(cvh.dN)) {
         this.a($$0, $$1.c(), cvh.a.o());
      }
   }

   private void a(csg $$0, atw $$1, hx $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dhn $$13) {
   ...
   private void a(hx $$0, csg $$1, atw $$2, int $$3, int $$4, boolean $$5, boolean $$6, dhn $$7) {
      dhn $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cvh.dP) || $$8.a(cvh.dO) || $$8.a(cvh.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cvh.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cvh.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, hx $$2, int $$3, atw $$4) {
      float $$5 = 10.0F * atq.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(atw $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(atw $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dhn $$0) {
      return $$0.a(cvh.iC) || $$0.a(cvh.dP) || $$0.a(cvh.mW);
   }
   ...
   private void a(csg $$0, hx $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cvh.dN)) {
                  if (this.a((crl)$$0, $$10)) {
                     this.a($$0, $$10, cvh.a.o());
                     this.a($$0, $$10.c(), cvh.a.o());
                  } else if (c($$11)) {
                     dhn[] $$12 = new dhn[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
