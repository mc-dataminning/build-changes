...
public class hpl extends MinecraftServer {
   ...
   public hpl(Thread $$0, frd $$1, ezv.c $$2, aup $$3, amh $$4, amd $$5, asd $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hpk(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (art $$1 : Lists.newArrayList(this.ag().t())) {
   ...
   @Override
   public dju bd() {
      return this.r() && !this.v_() ? (dju)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
