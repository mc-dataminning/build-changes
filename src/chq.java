...
public class chq extends chp {
   ...
   private static final alc<Byte> bY = alg.a(chq.class, ale.a);
   private static final int bZ = 1;
   private static final cgw ca = cgw.b().a(4.0);
   public final bvb c = new bvb();
   public final bvb d = new bvb();
   @Nullable
   private jh cb;

   public chq(bvq<? extends chq> $$0, dhh $$1) {
      super($$0, $$1);
      if (!$$1.C) {
         this.x(true);
      }
   ...
   public static boolean b(bvq<chq> $$0, dhi $$1, bvp $$2, jh $$3, bam $$4) {
      if ($$3.v() >= $$1.a(edp.a.b, $$3).v()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
         int $$6 = 4;
