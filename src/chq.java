...
public class chq extends che {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new eum($$0, this.g.dw() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               eum $$8 = new eum(this.g.du() - this.a.du(), 0.0, this.g.dA() - this.a.dA()).d();
               eum $$9 = new eum((double)ayf.a(this.a.dF() * (float) (Math.PI / 180.0)), 0.0, (double)(-ayf.b(this.a.dF() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  eum $$13 = this.a.f(1.0F);
                  ...
                  cmh $$20 = new cmh(this.a.dP(), this.a, $$17, $$18, $$19);
   ...
   public void a(bsq $$0) {
      ...
      int $$9 = ayf.a(this.g.dw() + $$8);
      eni $$10 = new eni($$3, $$9, $$4);
