...
public class cla extends buk {
   private static final Logger f = LogUtils.getLogger();
   private dww g = djn.L.m();
   public int a;
   ...
   public tq c;
   public boolean d;
   protected static final ajy<ji> e = akc.a(cla.class, aka.o);

   public cla(bur<? extends cla> $$0, dgh $$1) {
      super($$0, $$1);
   }

   private cla(dgh $$0, double $$1, double $$2, double $$3, dww $$4) {
      this(bur.X, $$0);
      this.g = $$4;
      this.I = true;
      this.a_($$1, $$2, $$3);
   ...
   public static cla a(dgh $$0, ji $$1, dww $$2) {
      cla $$3 = new cla($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2.b(dxm.J) ? $$2.b(dxm.J, Boolean.valueOf(false)) : $$2);
      $$0.a($$1, $$2.y().g(), 3);
      $$0.b($$3);
      return $$3;
   }
   ...
   public void h() {
      if (this.g.l()) {
         ...
         if (this.dV() instanceof ard $$1 && (this.bL() || this.d)) {
            ji $$2 = this.dv();
            boolean $$3 = this.g.b() instanceof dkx;
            boolean $$4 = $$3 && this.dV().b_($$2).a(awv.a);
            double $$5 = this.dy().h();
            if ($$3 && $$5 > 1.0) {
               fav $$6 = this.dV().a(new dfp(new faz(this.K, this.L, this.M), this.dt(), dfp.a.a, dfp.b.b, this));
               if ($$6.d() != fax.a.a && this.dV().b_($$6.b()).a(awv.a)) {
                  $$2 = $$6.b();
                  $$4 = true;
               }
            }
            ...
            if (!this.aJ() && !$$4) {
               ...
               if (!$$7.a(djn.bX)) {
                  if (!this.h) {
                     boolean $$8 = $$7.a(new dag(this.dV(), $$2, jn.a, cwo.j, jn.b));
                     boolean $$9 = dmi.n(this.dV().a_($$2.e())) && (!$$3 || !$$4);
                     boolean $$10 = this.g.a((dgk)this.dV(), $$2) && !$$9;
                     if ($$8 && $$10) {
                        if (this.g.b(dxm.J) && this.dV().b_($$2).a() == esz.c) {
                           this.g = this.g.b(dxm.J, Boolean.valueOf(true));
                        }
                        ...
                        if (this.dV().a($$2, this.g, 3)) {
                           ...
                           this.at();
                           if ($$0 instanceof dmh) {
                              ((dmh)$$0).a(this.dV(), $$2, this.g, $$7, this);
                           }
   ...
   public boolean a(float $$0, float $$1, bta $$2) {
      if (!this.i) {
         ...
         if ($$3 < 0) {
            ...
            Predicate<buk> $$4 = bup.e.and(bup.b);
            bta $$6 = this.g.b() instanceof dmh $$5 ? $$5.a(this) : this.dW().a(this);
   ...
   public yw<abl> a(arb $$0) {
      return new abm(this, $$0, djl.j(this.p()));
   }
