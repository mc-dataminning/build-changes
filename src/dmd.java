...
public class dmd extends djv {
   public static final MapCodec<dmd> a = RecordCodecBuilder.mapCodec($$0 -> $$0.group(dmb.a.forGetter($$0x -> $$0x.e), t()).apply($$0, dmd::new));
   private final dkl e;
