...
public class dbl extends auu<dbm> implements dbf {
   ...
   private static final Map<akt<dbn>, dbl.c> b = Map.of(
      dbn.d,
   ...
   private dbm e = dbm.a;
   private Map<akt<dbn>, dbn> f = Map.of();
   private dbr.b<dce> g = dbr.b.a();
   private List<dbl.d> h = List.of();
   private Map<akt<dbe<?>>, List<dbl.d>> i = Map.of();

   public dbl(jt.a $$0) {
      this.d = $$0;
   }

   protected dbm a(aup $$0, bos $$1) {
      SortedMap<aku, dbe<?>> $$2 = new TreeMap<>();
      aut.a($$0, c, this.d.a(JsonOps.INSTANCE), dbe.a, $$2);
      List<dbj<?>> $$3 = new ArrayList<>($$2.size());
      $$2.forEach(($$1x, $$2x) -> {
         akt<dbe<?>> $$3x = akt.a(mc.bk, $$1x);
         dbj<?> $$4 = new dbj($$3x, $$2x);
         $$3.add($$4);
      });
      return dbm.a($$3);
   ...
   protected void a(dbm $$0, aup $$1, bos $$2) {
      this.e = $$0;
   ...
   public void a(crt $$0) {
      ...
      List<dbl.b> $$2 = b.entrySet().stream().map($$0x -> new dbl.b((akt<dbn>)$$0x.getKey(), (dbl.c)$$0x.getValue())).toList();
      this.e.a().forEach($$3 -> {
         dbe<?> $$4 = $$3.b();
         if (!$$4.ap_() && $$4.ao_().d()) {
   ...
   private static boolean a(crt $$0, dba $$1) {
      return $$1.a().stream().allMatch($$1x -> ((cwl)$$1x.a()).a($$0));
   }

   public <I extends dbk, T extends dbe<I>> Optional<dbj<T>> a(dbp<T> $$0, I $$1, dgi $$2, @Nullable akt<dbe<?>> $$3) {
   ...
   public Optional<dbj<?>> b(akt<dbe<?>> $$0) {
      return Optional.ofNullable(this.e.a($$0));
   }

   @Nullable
   private <T extends dbe<?>> dbj<T> a(dbp<T> $$0, akt<dbe<?>> $$1) {
      dbj<?> $$2 = this.e.a($$1);
      return (dbj<T>)($$2 != null && $$2.b().b().equals($$0) ? $$2 : null);
   }

   public Map<akt<dbn>, dbn> b() {
      return this.f;
   }
   ...
   public void a(akt<dbe<?>> $$0, Consumer<dck> $$1) {
   ...
   @VisibleForTesting
   protected static dbj<?> a(akt<dbe<?>> $$0, JsonObject $$1, jt.a $$2) {
   ...
   public static <I extends dbk, T extends dbe<I>> dbl.a<I, T> a(final dbp<T> $$0) {
      return new dbl.a<I, T>() {
         ...
         @Override
         public Optional<dbj<T>> a(I $$0x, arc $$1) {
            dbl $$2 = $$1.t();
   ...
   public interface a<I extends dbk, T extends dbe<I>> {
      Optional<dbj<T>> a(I var1, arc var2);
   }
