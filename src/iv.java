...
public class iv implements ip<FloatArgumentType, iv.a> {
   public void a(iv.a $$0, wa $$1) {
   ...
   public iv.a a(wa $$0) {
      byte $$1 = $$0.readByte();
      float $$2 = ir.a($$1) ? $$0.readFloat() : -Float.MAX_VALUE;
      float $$3 = ir.b($$1) ? $$0.readFloat() : Float.MAX_VALUE;
      return new iv.a($$2, $$3);
   }
   ...
   public iv.a a(FloatArgumentType $$0) {
      return new iv.a($$0.getMinimum(), $$0.getMaximum());
   }

   public final class a implements ip.a<FloatArgumentType> {
      final float b;
      final float c;
