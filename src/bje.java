...
public class bje {
   ...
   private JsonElement a(List<Pair<dnk, bjo<bjg>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bjo)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dnk, bjo<bjg>> $$3 : $$0) {
         bjo<bjg> $$4 = (bjo<bjg>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dnk)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bjm> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = biu.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bjc $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bjk $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bjk.b $$3 = (bjk.b)$$1x.getFirst();
         bjk.a $$4 = (bjk.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bjh> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bjh>, ToDoubleFunction<bjh>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bjh::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bjh::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bjh::c));
      return $$1;
   }
}
