...
public class bje extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(biw.D);
      Type<?> $$3 = this.getOutputSchema().getType(biw.D);
      Type<?> $$4 = bbd.a($$2, $$2, $$3);
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", $$2, $$3, $$3x -> {
         String $$4x = $$3x.getOptional($$1).<String>map(Pair::getFirst).map(bkr::a).orElse("");
         Typed<?> $$5 = bbd.a($$4, $$3x);
         if (a.contains($$4x)) {
            return af.a($$5, $$3, bje::a);
         } else {
            return b.contains($$4x) ? af.a($$5, $$3, bje::b) : bbd.a($$3, $$3x);
         }
      });
   }
