...
public class fjc implements gui {
   private static final long a = 3000L;
   private final ffw b;
   private final List<fjc.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fjc.b> e = new ArrayList<>();
   ...
   public void a(fhh $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fjc.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(gte $$0, guk $$1, float $$2) {
      if ($$1.a() != null) {
         wu $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fjc.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new ewh($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fjc.b($$3, $$2, new ewh($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(ewh a, long b) {
   }

   static class b {
      private final wu a;
      private final float b;
      private final List<fjc.a> c = new ArrayList<>();

      public b(wu $$0, float $$1, ewh $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fjc.a($$2, ac.c()));
      }
      ...
      public void b(ewh $$0) {
         ...
         this.c.add(new fjc.a($$0, ac.c()));
      }

      public boolean c(ewh $$0) {
