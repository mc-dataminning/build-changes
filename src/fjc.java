...
public class fjc extends fie {
   ...
   public fjc(fhv $$0, int $$1, int $$2, int $$3, int $$4, wz $$5, wz $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fjf($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fmg $$0) {
      $$0.a(fmf.a, wz.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   private void k() {
      double $$0 = this.c();
      fjf.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fjf.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
