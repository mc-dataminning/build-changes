...
public class eon extends evj {
   ...
   public static evj.a<eon> a() {
      return new evj.a<>(eon::new, eon::b, bbs.o);
   }

   private eon(LongSet $$0, LongSet $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static eon b(ux $$0, js.a $$1) {
      return new eon(new LongOpenHashSet($$0.o("All")), new LongOpenHashSet($$0.o("Remaining")));
   }
