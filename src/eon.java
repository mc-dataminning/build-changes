...
public enum eon {
   ...
   private eon(String... $$0) {
      this.c = $$0;
   }

   public List<apu<InputStream>> a(aoq $$0) throws IOException {
      return List.of(
   ...
   public apu<InputStream> b(aoq $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private apu<InputStream> a(aoq $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      apu<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
