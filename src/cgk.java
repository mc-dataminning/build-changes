...
public class cgk {
   ...
   private int g = awh.b(awo.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jc.a.fieldOf("uuid").forGetter(Pair::getFirst), avp.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bno> j;
   @VisibleForTesting
   protected final ArrayList<bno> c;
   private final cgk.a k;
   @VisibleForTesting
   protected final Object2IntMap<bno> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cgk> a(Predicate<bno> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cgk::b)).apply($$1, $$1x -> new cgk($$0, $$1x))
      );
   }

   public cgk(Predicate<bno> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cgk.a(this);
   ...
   public void a(aov $$0, Predicate<bno> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bno>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bno> $$6 = (Entry<bno>)$$5.next();
         int $$7 = $$6.getIntValue();
         bno $$8 = (bno)$$6.getKey();
         bno.c $$9 = $$8.dI();
   ...
   public int b(@Nullable bno $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bog> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bog).map($$0 -> (bog)$$0);
   }

   @VisibleForTesting
   protected static record a(cgk a) implements Comparator<bno> {
      public int a(bno $$0, bno $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof chh;
               boolean $$7 = $$1 instanceof chh;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
