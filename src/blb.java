...
public abstract class blb<R extends Runnable> implements bkj, bld<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected blb(String $$0) {
      this.b = $$0;
      bkh.a.a(this);
   }
   ...
   @Override
   public List<bkg> bu() {
      return ImmutableList.of(bkg.a(this.b + "-pending-tasks", bkf.b, this::bw));
   }
}
