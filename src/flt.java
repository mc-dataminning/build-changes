...
public abstract class flt extends fkt {
   private final don b;
   private doo c;
   ...
   public flt(don $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, ws.c("sign.edit"));
   }

   public flt(don $$0, boolean $$1, boolean $$2, ws $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
      this.a = djv.a($$0.n().b());
      this.d = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(ws::getString).toArray(String[]::new);
   }

   @Override
   protected void aM_() {
      this.c(feu.a(wr.d, $$0 -> this.D()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fho(() -> this.d[this.u], this::a, fho.a(this.m), fho.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   public void j() {
      fvn $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new ahp(this.b.az_(), this.r, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void a(feh var1, dpy var2);
   ...
   private void d(feh $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : gds.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gbm.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
