...
public class bdd extends DataFix {
   ...
   private static void a(bdd.a $$0, Dynamic<?> $$1) {
      ...
      if ($$0.b("minecraft:player_head")) {
         $$0.a("SkullOwner").result().ifPresent($$1x -> $$0.a("minecraft:profile", e($$1x)));
      }
   }

   private static Dynamic<?> a(bdd.a $$0, Dynamic<?> $$1, int $$2) {
      ...
      return $$1.remove("Name").remove("Lore").remove("color");
   }

   private static <T> Dynamic<T> a(bdd.a $$0, Dynamic<T> $$1, String $$2) {
      ...
      return switch ($$2) {
         ...
         case "minecraft:decorated_pot" -> {
            ...
            yield $$1.remove("sherds");
         }
         case "minecraft:banner" -> {
            $$0.a("minecraft:banner_patterns", $$1.get("patterns"));
            Optional<Number> $$6 = $$1.get("Base").asNumber().result();
            if ($$6.isPresent()) {
               $$0.a("minecraft:base_color", $$1.createString(aze.a($$6.get().intValue())));
            }

            yield $$1.remove("patterns").remove("Base");
         }
         case "minecraft:shulker_box" -> {
            List<Dynamic<T>> $$7 = $$1.get("Items")
               .asList($$0x -> $$0x.emptyMap().set("slot", $$0x.createInt($$0x.get("Slot").asInt(0))).set("item", $$0x.remove("Slot")));
            $$0.a("minecraft:container", $$1.createList($$7.stream()));
   ...
   private static void a(bdd.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
      List<? extends Dynamic<?>> $$5 = $$0.a($$2).asList(Function.identity());
      List<Pair<String, Integer>> $$6 = $$5.stream().flatMap($$0x -> a($$0x).stream()).toList();
      if (!$$6.isEmpty() || $$4) {
   ...
   private static Optional<Pair<String, Integer>> a(Dynamic<?> $$0) {
      return $$0.get("id").asString().apply2stable(($$0x, $$1) -> Pair.of($$0x, axk.a($$1.intValue(), 0, 255)), $$0.get("lvl").asNumber()).result();
   }

   private static void b(bdd.a $$0, Dynamic<?> $$1, int $$2) {
      b($$0, $$1, "CanDestroy", "minecraft:can_break", ($$2 & 8) != 0);
      b($$0, $$1, "CanPlaceOn", "minecraft:can_place_on", ($$2 & 16) != 0);
   }

   private static void b(bdd.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void c(bdd.a $$0, Dynamic<?> $$1, int $$2) {
      List<? extends Dynamic<?>> $$3 = $$0.a("AttributeModifiers").asList(bdd::b);
      boolean $$4 = ($$2 & 2) != 0;
      if (!$$3.isEmpty() || $$4) {
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      $$1 = ays.a($$0, "AttributeName", $$1, "type");
      $$1 = ays.a($$0, "Slot", $$1, "slot");
      $$1 = ays.a($$0, "UUID", $$1, "uuid");
      $$1 = ays.a($$0, "Name", $$1, "name");
      $$1 = ays.a($$0, "Amount", $$1, "amount");
      return ays.a($$0, "Operation", $$1, "operation", $$0x -> {
   ...
   private static Pair<Dynamic<?>, Dynamic<?>> c(Dynamic<?> $$0) {
   ...
   private static void b(bdd.a $$0, Dynamic<?> $$1) {
   ...
   private static void c(bdd.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
      if ($$2 != null) {
   ...
   private static void d(bdd.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
   ...
   @Nullable
   private static Dynamic<?> e(bdd.a $$0, Dynamic<?> $$1) {
   ...
   private static void f(bdd.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.emptyMap();
   ...
   private static void g(bdd.a $$0, Dynamic<?> $$1) {
      Optional<? extends Dynamic<?>> $$2 = $$0.a("LodestonePos").result();
      Optional<? extends Dynamic<?>> $$3 = $$0.a("LodestoneDimension").result();
      boolean $$4 = ays.a($$0.a("LodestoneTracked"), true);
      if ($$2.isPresent() && $$3.isPresent()) {
         Dynamic<?> $$5 = $$1.emptyMap().set("pos", $$2.get()).set("dimension", $$3.get());
         if (!$$4) {
            $$5 = $$5.set("tracked", $$1.createBoolean(false));
         }

         $$0.a("minecraft:lodestone_target", $$5);
      }
   }

   private static void a(bdd.a $$0) {
      $$0.a("Explosion", true, $$1 -> {
         $$0.a("minecraft:firework_explosion", d($$1));
         return $$1.remove("Type").remove("Colors").remove("FadeColors").remove("Trail").remove("Flicker");
      });
   }

   private static void b(bdd.a $$0) {
      $$0.a("Fireworks", true, $$1 -> {
         Stream<? extends Dynamic<?>> $$2 = $$1.get("Explosions").asStream().map(bdd::d);
   ...
   private static Dynamic<?> d(Dynamic<?> $$0) {
      ...
      $$0 = ays.a($$0, "Colors", "colors");
      $$0 = ays.a($$0, "FadeColors", "fade_colors");
      $$0 = ays.a($$0, "Trail", "has_trail");
      return ays.a($$0, "Flicker", "has_twinkle");
   }

   private static Dynamic<?> e(Dynamic<?> $$0) {
      Optional<String> $$1 = $$0.asString().result();
      if ($$1.isPresent()) {
         return $$0.emptyMap().set("name", $$0.createString($$1.get()));
      } else {
         String $$2 = $$0.get("Name").asString("");
         Optional<? extends Dynamic<?>> $$3 = $$0.get("Id").result();
         Dynamic<?> $$4 = a($$0.get("Properties"));
         Dynamic<?> $$5 = $$0.emptyMap().set("name", $$0.createString($$2));
         if ($$3.isPresent()) {
            $$5 = $$5.set("id", $$3.get());
         }
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(bfa.t), this.getOutputSchema().getType(bfa.t), $$0 -> {
         Optional<? extends Dynamic<?>> $$1 = bdd.a.a($$0).map($$0x -> {
            a($$0x, $$0x.e);
            return $$0x.a();
         });
   ...
   static class a {
      ...
      public static Optional<bdd.a> a(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(($$1, $$2) -> new bdd.a($$1, $$2.intValue(), $$0.remove("id").remove("Count")), $$0.get("Count").asNumber())
            .result();
      }
