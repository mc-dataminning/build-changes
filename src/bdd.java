...
public class bdd extends azv {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdd::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdd::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdd::k);
         $$0 = this.a($$0, "minecraft:fox", bdd::j);
         $$0 = this.a($$0, "minecraft:item", bdd::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdd::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdd::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdd::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdd::e);
         return this.a($$0, "minecraft:piglin", bdd::d);
      });
   }
