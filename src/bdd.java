...
public class bdd {
   ...
   private bdd(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bdd a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bdd($$0, $$1);
   }

   public bdd.d a() throws IOException {
      bdd.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bdd.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bdd.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bdd.c $$3 = bdd.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bdd.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bdd.a($$0, $$3);
            }
         }
   ...
   public bdd.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bdd.c> $$2 = this.a().c();
      ...
      bdd.e $$4 = new bdd.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bdd.c b) implements bdd.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bdd.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bdd.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bdd.b> {
      private final List<bdd.b> a;

      d(List<bdd.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bdd.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bdd.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bdd.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bdd.d a() {
         ListIterator<bdd.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bdd.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bdd.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bdd.b> b() {
         return this.a.stream();
      }

      public Set<bdd.c> c() {
         return this.a.stream().map(bdd.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bdd.c b) implements bdd.b {
