...
public abstract class bzk extends byx {
   ...
   public bzk(bsi $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bzk(bsi $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(byx.a.a, byx.a.c));
   }
   ...
   protected abstract boolean a(dag var1, in var2);
}
