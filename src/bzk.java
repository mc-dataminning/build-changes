...
public class bzk implements bzh {
   ...
   protected void b() {
      if (!this.a.K().l()) {
         this.a.ba = ayu.c(this.a.ba, this.a.aY, (float)this.a.ab());
      }
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(ayu.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(ayu.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   private static double b(bsp $$0) {
      return $$0 instanceof btk ? $$0.dy() : ($$0.cK().b + $$0.cK().e) / 2.0;
   }
}
