...
public class buu extends bkb implements bke<buv> {
   ...
   private static final aee<buv> ca = aeh.a(buu.class, aeg.w);
   private static final aee<Boolean> cb = aeh.a(buu.class, aeg.k);
   private static final aee<Boolean> cc = aeh.a(buu.class, aeg.k);
   private static final aee<Integer> cd = aeh.a(buu.class, aeg.b);
   ...
   public void b(qw $$0) {
      super.b($$0);
      $$0.a("variant", jb.aj.b(this.gk()).toString());
   ...
   public void a(qw $$0) {
      super.a($$0);
      buv $$1 = jb.aj.a(aew.a($$0.l("variant")));
      if ($$1 != null) {
         this.a($$1);
      }
   ...
   protected apc w() {
      if (this.s()) {
         if (this.gh()) {
            ...
            return this.ag.a(4) == 0 ? apd.dr : apd.dj;
         }
      } else {
         return apd.dk;
      }
   ...
   private void gr() {
      if ((this.gl() || this.gm()) && this.ah % 5 == 0) {
         this.a(apd.dq, 0.6F + 0.4F * (this.ag.i() - this.ag.i()), 1.0F);
      }
   ...
   public float F(float $$0) {
      return arw.i($$0, this.cj, this.ci);
   }

   public float G(float $$0) {
      return arw.i($$0, this.cl, this.ck);
   }

   @Nullable
   public buu b(akq $$0, bil $$1) {
      buu $$2 = biu.m.a((cpv)$$0);
   ...
   public bjz a(cqk $$0, bgw $$1, bjk $$2, @Nullable bjz $$3, @Nullable qw $$4) {
      $$3 = super.a($$0, $$1, $$2, $$3, $$4);
      boolean $$5 = $$0.an() > 0.9F;
      aqh<buv> $$6 = $$5 ? apt.b : apt.a;
      jb.aj.b($$6).flatMap($$1x -> $$1x.a($$0.D_())).ifPresent($$0x -> this.a((buv)$$0x.a()));
      akq $$7 = $$0.C();
      if ($$7.a().a(this.dl(), aqd.n).b()) {
         this.a(jb.aj.e(buv.k));
         this.fI();
      }
   ...
   static class b extends bqb {
      ...
      private void i() {
         ...
         ecw $$3 = new ecw.a((akq)this.a.dL()).a(efb.f, this.a.dj()).a(efb.a, this.a).a(efa.i);
         ...
         for (cjf $$5 : $$2.a($$3)) {
            this.a
               ...
               .b(
                  new byn(
                     this.a.dL(),
                     (double)$$1.u() - (double)arw.a(this.a.aU * (float) (Math.PI / 180.0)),
                     (double)$$1.v(),
                     (double)$$1.w() + (double)arw.b(this.a.aU * (float) (Math.PI / 180.0)),
                     $$5
                  )
               );
         }
