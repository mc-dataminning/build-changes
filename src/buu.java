...
public class buu extends bvb implements bww {
   private static final Logger c = LogUtils.getLogger();
   private static final int d = 5;
   private static final aks<Float> e = akw.a(buu.class, aku.d);
   private static final aks<Boolean> f = akw.a(buu.class, aku.k);
   private static final aks<lq> g = akw.a(buu.class, aku.l);
   ...
   private czf k = czf.a;
   private final Map<bvb, Integer> l = Maps.newHashMap();
   private int m = 600;
   private int n = 20;
   private int o = 20;
   private int p;
   ...
   public buu(bvi<? extends buu> $$0, dgz $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public buu(dgz $$0, double $$1, double $$2, double $$3) {
      this(bvi.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dW().C) {
         this.au().a(e, azu.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof ll $$1) {
         int $$2 = this.k.equals(czf.a) ? 0 : this.k.b();
         this.al.a(g, ll.a($$1.a(), ayf.f($$2)));
      }
   }
   ...
   private void t() {
      ...
      if (!$$0 || !this.ae.h()) {
         ...
         if ($$0) {
            ...
            $$3 = azu.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ae.i() * (float) (Math.PI * 2);
            float $$9 = azu.c(this.ae.i()) * $$4;
            double $$10 = this.dB() + (double)(azu.b($$8) * $$9);
            double $$11 = this.dD();
            double $$12 = this.dH() + (double)(azu.a($$8) * $$9);
            if ($$2.a() == ls.u) {
               if ($$0 && this.ae.h()) {
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  List<bug> $$4 = Lists.newArrayList();
                  if (this.k.e().isPresent()) {
                     for (bug $$5 : this.k.e().get().a().a()) {
                        $$4.add(new bug($$5.c(), $$5.a($$0x -> $$0x / 4), $$5.e(), $$5.f(), $$5.g()));
                     }
                  }

                  $$4.addAll(this.k.d());
                  List<bvx> $$6 = this.dW().a(bvx.class, this.cR());
                  if (!$$6.isEmpty()) {
                     for (bvx $$7 : $$6) {
   ...
   public bvx n() {
      if (this.s != null && !this.s.dR()) {
         ...
         if (this.t != null && this.dW() instanceof arx $$0) {
            this.s = $$0.a(this.t) instanceof bvx $$1 ? $$1 : null;
         }
   ...
   protected void a(um $$0) {
      ...
      if ($$0.e("potion_contents")) {
         czf.b.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> c.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(um $$0) {
      ...
      $$0.a("Radius", this.c());
      aln<vj> $$1 = this.dY().a(va.a);
      $$0.a("Particle", (vj)ls.bi.encodeStart($$1, this.e()).getOrThrow());
      if (this.t != null) {
         $$0.a("Owner", this.t);
      }

      if (!this.k.equals(czf.a)) {
         vj $$2 = (vj)czf.b.encodeStart($$1, this.k).getOrThrow();
