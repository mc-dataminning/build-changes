...
public class buu extends bvd<bla> {
   ...
   protected void a(ama $$0, bla $$1) {
      if ($$1.n_()) {
         ...
         Set<Pair<ib<bwa>, ht>> $$4 = $$2.b($$0x -> $$0x.a(bwb.n), $$3, $$1.dl(), 48, bvx.b.c).collect(Collectors.toSet());
         ecv $$5 = bmi.a($$1, $$4);
         if ($$5 != null && $$5.j()) {
            ht $$6 = $$5.l();
            Optional<ib<bwa>> $$7 = $$2.c($$6);
            if ($$7.isPresent()) {
               $$1.dN().a(btz.w, $$6);
            }
         } else if (this.f < 5) {
