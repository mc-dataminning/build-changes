...
public abstract class buj<E extends bsq> implements buk<E> {
   public static final int a = 60;
   protected final Map<cbu<?>, cbv> b;
   private buj.a c = buj.a.a;
   private long d;
   private final int e;
   private final int f;

   public buj(Map<cbu<?>, cbv> $$0) {
      this($$0, 60);
   }

   public buj(Map<cbu<?>, cbv> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public buj(Map<cbu<?>, cbv> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cbu<?>, cbv> $$1 : this.b.entrySet()) {
         cbu<?> $$2 = $$1.getKey();
         cbv $$3 = $$1.getValue();
         if (!$$0.dS().a($$2, $$3)) {
            return false;
