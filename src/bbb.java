   ...
   private <TE> TypeRewriteRule a(Type<?> $$0, ListType<TE> $$1) {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhere(
            "InjectBedBlockEntityType", this.getInputSchema().findChoiceType(bgd.s), this.getOutputSchema().findChoiceType(bgd.s), $$0x -> $$0xx -> $$0xx
         ),
         this.fixTypeEverywhereTyped(
            "BedBlockEntityInjecter",
            this.getOutputSchema().getType(bgd.c),
            $$3x -> {
