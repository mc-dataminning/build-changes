...
public class bbb extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bia.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bbb::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bbb::a);
      return this.a($$0, "minecraft:trident", bbb::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bia.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bia.B, $$1);
