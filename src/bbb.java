...
public class bbb extends bft {
   public bbb(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bgv.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bgv.s, "minecraft:piston");
