...
public class bbb extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped(this.a + " (Components)", this.getInputSchema().getType(bhm.w), this::a),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped(this.a + " (Entity)", this.getInputSchema().getType(bhm.B), this::b),
            this.fixTypeEverywhereTyped(this.a + " (Player)", this.getInputSchema().getType(bhm.b), this::b)
         }
      );
   }
