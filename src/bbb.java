...
public class bbb extends bfq {
   public bbb(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgs.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgs.s, "minecraft:jukebox");
