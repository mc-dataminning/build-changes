...
public class arr {
   ...
   public static he<cjg> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jb.i
            .b(aey.a(jc.E, new aez($$2)))
   ...
   public static he<cjg> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static he<cjg> a(JsonObject $$0, String $$1, @Nullable he<cjg> $$2) {
