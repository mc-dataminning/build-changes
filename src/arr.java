...
public record arr<T extends Comparable<T>>(T b, T c) {
   public static final Codec<arr<Integer>> a = a(Codec.INT);
   ...
   public static <T extends Comparable<T>> Codec<arr<T>> a(Codec<T> $$0) {
      return arh.a($$0, "min_inclusive", "max_inclusive", arr::a, arr::a, arr::b);
   }

   public static <T extends Comparable<T>> Codec<arr<T>> a(Codec<T> $$0, T $$1, T $$2) {
      return arh.a(
         a($$0),
         (Function<arr<T>, DataResult<arr<T>>>)($$2x -> {
   ...
   public static <T extends Comparable<T>> DataResult<arr<T>> a(T $$0, T $$1) {
      return $$0.compareTo($$1) <= 0
         ? DataResult.success(new arr($$0, $$1))
