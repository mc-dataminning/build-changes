...
public abstract class arr implements asa {
   ...
   public <T> T a(asn<T> $$0) throws IOException {
      atg<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asn<T> $$0, InputStream $$1) {
      JsonObject $$3;
