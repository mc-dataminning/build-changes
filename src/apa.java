...
public class apa {
   ...
   private static int a(ep $$0, evo $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bss> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         apa.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> xo.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
