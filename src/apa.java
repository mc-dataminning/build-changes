...
public class apa {
   ...
   public static final List<Function<String, apa.c>> a = ImmutableList.of(apb.a, aoy.a, apc.a);
   public static final List<apa.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<apa.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<eq> $$0) {
      ...
      for (apa.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<eq, ?>, apa.b>)(($$0x, $$1x) -> $$0x.then(
                           er.a("insert")
                              .then(
   ...
   private static List<uu> a(List<uu> $$0, apa.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<eq, ?> a(BiConsumer<ArgumentBuilder<eq, ?>, apa.b> $$0) {
   ...
   private static List<uu> a(CommandContext<eq> $$0, apa.c $$1) throws CommandSyntaxException {
      aoz $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<uu> b(CommandContext<eq> $$0, apa.c $$1) throws CommandSyntaxException {
      aoz $$2 = $$1.a($$0);
      fi.g $$3 = fi.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<eq> $$0, apa.c $$1, apa.a $$2, List<uu> $$3) throws CommandSyntaxException {
      aoz $$4 = $$1.a($$0);
   ...
   private static int a(eq $$0, aoz $$1, fi.g $$2) throws CommandSyntaxException {
      tx $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static uu a(fi.g $$0, aoz $$1) throws CommandSyntaxException {
   ...
   private static int b(eq $$0, aoz $$1, fi.g $$2) throws CommandSyntaxException {
      uu $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof un) {
         $$4 = aye.a(((un)$$3).j());
   ...
   private static int a(eq $$0, aoz $$1, fi.g $$2, double $$3) throws CommandSyntaxException {
      uu $$4 = a($$2, $$1);
      if (!($$4 instanceof un)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = aye.a(((un)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(eq $$0, aoz $$1) throws CommandSyntaxException {
      tx $$2 = $$1.a();
      $$0.a(() -> $$1.a((uu)$$2), false);
      return 1;
   }

   private static int a(eq $$0, aoz $$1, tx $$2) throws CommandSyntaxException {
      tx $$3 = $$1.a();
      if (fi.g.a($$2, 0)) {
         throw fi.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<eq, ?> create(apa.a var1);
   }

   public interface c {
      aoz a(CommandContext<eq> var1) throws CommandSyntaxException;
