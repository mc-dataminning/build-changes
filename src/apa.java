...
public class apa {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> xp.b("commands.spectate.not_spectator", $$0));
   ...
   private static int a(ep $$0, @Nullable bsw $$1, arg $$2) throws CommandSyntaxException {
      if ($$2 == $$1) {
         throw a.create();
      } else if ($$2.e.b() != dbx.d) {
         throw b.create($$2.O_());
         ...
         $$2.d($$1);
         if ($$1 != null) {
            $$0.a(() -> xp.a("commands.spectate.success.started", $$1.O_()), false);
         } else {
            $$0.a(() -> xp.c("commands.spectate.success.stopped"), false);
         }
