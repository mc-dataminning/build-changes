...
public class apa implements aox {
   ...
   private final Map<aoy, List<Path>> g;

   apa(aoq $$0, Set<String> $$1, List<Path> $$2, Map<aoy, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aoy $$0, ahh $$1, Consumer<Path> $$2) {
   ...
   public void a(aoy $$0, String $$1, String $$2, aox.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ahh, aqb<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aox.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aoz.a($$1, $$4, $$3, $$0);
   }
   ...
   public aqb<InputStream> a(aoy $$0, ahh $$1) {
      return (aqb<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aoz.a($$5)) {
               return aqb.create($$5);
            }
         }
   ...
   public <T> T a(apj<T> $$0) {
      aqb<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public aqm c() {
      return $$0 -> Optional.ofNullable(this.a(aoy.a, $$0)).map($$0x -> new aqh(this, $$0x));
   }
}
