...
public class ajo implements ajl {
   ...
   public void a(ajm $$0, acq $$1, Consumer<Path> $$2) {
      ...
      }).ifRight($$1x -> a.error("Invalid path {}: {}", $$1, $$1x.message()));
   }
   ...
   public void a(ajm $$0, String $$1, String $$2, ajl.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<acq, akp<InputStream>> $$6 = new HashMap<>();
   ...
   public akp<InputStream> a(ajm $$0, acq $$1) {
      return (akp<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && ajn.a($$5)) {
               return akp.create($$5);
            }
         }
         ...
         a.error("Invalid path {}: {}", $$1, $$1x.message());
         return null;
      });
   }
   ...
   public ala c() {
      return $$0 -> Optional.ofNullable(this.a(ajm.a, $$0)).map($$0x -> new akv(this, $$0x));
   }
}
