...
public class qx extends qq<rk> {
      ...
      public qx a(DataInput $$0, int $$1, ra $$2) throws IOException {
         ...
         if ($$1 > 512) {
            ...
            if ($$3 == 0 && $$4 > 0) {
               ...
               $$2.a(4L * (long)$$4);
               rm<?> $$5 = rn.a($$3);
               List<rk> $$6 = Lists.newArrayListWithCapacity($$4);
   ...
   public qx e() {
      Iterable<rk> $$0 = (Iterable<rk>)(rn.a(this.w).d() ? this.c : Iterables.transform(this.c, rk::d));
      List<rk> $$1 = Lists.newArrayList($$0);
      return new qx($$1, this.w);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof qx && Objects.equals(this.c, ((qx)$$0).c);
   }
