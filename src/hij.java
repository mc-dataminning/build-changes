...
public class hij implements him.a, AutoCloseable {
   ...
   fic[] f;
   @Nullable
   private final hij.a g;
   private final avf h;

   public hij(alg $$0, hkc $$1, fic $$2, avf $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      this.g = $$3.a(hkb.b).map($$2x -> this.a($$1, $$2.a(), $$2.b(), $$2x)).orElse(null);
      this.e = $$2;
      this.f = new fic[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hid.a(this.f, $$0);
   ...
   @Nullable
   private hij.a a(hkc $$0, int $$1, int $$2, hkb $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      int $$7 = $$3.d();
      ...
      if ($$3.a().isEmpty()) {
         ...
         for (hka $$12 : $$10) {
            $$8.add(new hij.b($$12.a(), $$12.a($$7)));
         }

         int $$13 = 0;
         IntSet $$14 = new IntOpenHashSet();

         for (Iterator<hij.b> $$15 = $$8.iterator(); $$15.hasNext(); $$13++) {
            hij.b $$16 = $$15.next();
            boolean $$17 = true;
            if ($$16.b <= 0) {
      ...
      return $$8.size() <= 1 ? null : new hij.a(List.copyOf($$8), $$4, $$3.e());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fic[] $$4) {
   ...
   class a {
      ...
      a(final List<hij.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hij.this.c;
         int $$4 = this.b($$2) * hij.this.d;
         hij.this.a($$0, $$1, $$3, $$4, hij.this.f);
      }

      public hil a() {
         return hij.this.new d(this, this.d ? hij.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fic[] b = new fic[hij.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hij.this.c >> $$0;
            int $$2 = hij.this.d >> $$0;
            this.b[$$0] = new fic($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hij.d $$2) {
         hij.a $$3 = $$2.c;
         List<hij.b> $$4 = $$3.b;
         hij.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            hij.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hij.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hij.this.f[$$2].a($$3 + ($$0.a($$1) * hij.this.c >> $$2), $$4 + ($$0.b($$1) * hij.this.d >> $$2));
      }
   ...
   class d implements hil {
      int a;
      int b;
      final hij.a c;
      @Nullable
      private final hij.c d;

      d(final hij.a $$0, @Nullable final hij.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
