public class gik {
   ...
   private final gxb[] b = new gxb[2];
   private final gxb[] c = new gxb[2];
   private gxb d;

   protected void a() {
      this.b[0] = fil.Q().aE().b().b(dhl.H.o()).e();
      this.b[1] = gzk.c.c();
      this.c[0] = fil.Q().aE().b().b(dhl.G.o()).e();
      this.c[1] = gzk.d.c();
      this.d = gzk.e.c();
   }

   private static boolean a(eqp $$0, eqp $$1) {
      return $$1.a().a($$0.a());
   }

   private static boolean a(jj $$0, float $$1, duo $$2) {
      ezm $$3 = $$2.a($$0.g());
      if ($$3 == ezj.a()) {
         return false;
      } else if ($$3 == ezj.b()) {
         ...
         ezm $$5 = ezj.a(0.0, 0.0, 0.0, 1.0, (double)$$1, 1.0);
         return ezj.a($$5, $$3, $$0);
      }
   }

   private static boolean b(jj $$0, float $$1, duo $$2) {
      return a($$0, $$1, $$2);
   }
   ...
   public static boolean a(eqp $$0, duo $$1, jj $$2, eqp $$3) {
      return !a($$1, $$2) && !a($$0, $$3);
   }

   public void a(ddi $$0, je $$1, fdi $$2, duo $$3, eqp $$4) {
      boolean $$5 = $$4.a(awz.b);
      gxb[] $$6 = $$5 ? this.b : this.c;
      int $$7 = $$5 ? 16777215 : ggm.c($$0, $$1);
      float $$8 = (float)($$7 >> 16 & 0xFF) / 255.0F;
      float $$9 = (float)($$7 >> 8 & 0xFF) / 255.0F;
      float $$10 = (float)($$7 & 0xFF) / 255.0F;
      duo $$11 = $$0.a_($$1.a(jj.a));
      eqp $$12 = $$11.y();
      duo $$13 = $$0.a_($$1.a(jj.b));
      eqp $$14 = $$13.y();
      duo $$15 = $$0.a_($$1.a(jj.c));
      eqp $$16 = $$15.y();
      duo $$17 = $$0.a_($$1.a(jj.d));
      eqp $$18 = $$17.y();
      duo $$19 = $$0.a_($$1.a(jj.e));
      eqp $$20 = $$19.y();
      duo $$21 = $$0.a_($$1.a(jj.f));
      eqp $$22 = $$21.y();
      boolean $$23 = !a($$4, $$14);
      ...
      if ($$23 || $$24 || $$28 || $$27 || $$25 || $$26) {
         ...
         if ($$23 && !b(jj.b, Math.min(Math.min($$36, $$38), Math.min($$37, $$35)), $$13)) {
            ...
            if ($$52.d == 0.0 && $$52.f == 0.0) {
               ...
               gxb $$62 = $$6[1];
               float $$63 = (float)azd.d($$52.f, $$52.d) - (float) (Math.PI / 2);
               float $$64 = azd.a($$63) * 0.25F;
               float $$65 = azd.b($$63) * 0.25F;
               float $$66 = 0.5F;
               $$54 = $$62.a(0.5F + (-$$65 - $$64));
               $$55 = $$62.c(0.5F + -$$65 + $$64);
               $$56 = $$62.a(0.5F + -$$65 + $$64);
         ...
         for (jj $$91 : jj.c.a) {
            ...
            if ($$98 && !b($$91, Math.max($$92, $$93), $$0.a_($$1.a($$91)))) {
               ...
               if (!$$5) {
                  dhj $$122 = $$0.a_($$120).b();
                  if ($$122 instanceof dkz || $$122 instanceof dlt) {
                     $$121 = this.d;
                  }
               }
   ...
   private float a(ddi $$0, eqo $$1, float $$2, float $$3, float $$4, je $$5) {
      if (!($$4 >= 1.0F) && !($$3 >= 1.0F)) {
         float[] $$6 = new float[2];
         if ($$4 > 0.0F || $$3 > 0.0F) {
   ...
   private float a(ddi $$0, eqo $$1, je $$2) {
      duo $$3 = $$0.a_($$2);
      return this.a($$0, $$1, $$2, $$3, $$3.y());
   }

   private float a(ddi $$0, eqo $$1, je $$2, duo $$3, eqp $$4) {
      if ($$1.a($$4.a())) {
         duo $$5 = $$0.a_($$2.d());
   ...
   private void a(fdi $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3).a($$4, $$5, $$6, 1.0F).a($$7, $$8).c($$9).b(0.0F, 1.0F, 0.0F);
   }

   private int a(ddi $$0, je $$1) {
      int $$2 = ghc.a($$0, $$1);
      int $$3 = ghc.a($$0, $$1.d());
      int $$4 = $$2 & 0xFF;
      int $$5 = $$3 & 0xFF;
