...
public class gik extends gim<ln> {
   private final Vector3f a;
   private final Vector3f b;

   protected gik(gga $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ln $$7, gkd $$8) {
   ...
   public static class a implements gjl<ln> {
      private final gkd a;
      ...
      public gji a(ln $$0, gga $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
