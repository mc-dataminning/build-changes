public class bvp implements bvl {
   ...
   public void a() {
      if (this.k == bvp.a.c) {
         ...
         ib $$14 = this.d.dm();
         dnb $$15 = this.d.dM().a_($$14);
         eqm $$16 = $$15.k(this.d.dM(), $$14);
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         ejc $$3 = $$2.o();
         if ($$3 != null && $$3.a(this.d.dM(), aww.a(this.d.dr() + (double)$$0), this.d.ds(), aww.a(this.d.dx() + (double)$$1)) != ejg.c) {
            return false;
         }
      }
