...
public class bvp extends bup implements bjx, bzm {
   private static final aef<Byte> b = aei.a(bvp.class, aeh.a);
   ...
   public void b_() {
      ...
      if (!this.dL().B) {
         ...
         for (int $$1 = 0; $$1 < 4; $$1++) {
            int $$2 = arx.a(this.dq() + (double)((float)($$1 % 2 * 2 - 1) * 0.25F));
            int $$3 = arx.a(this.ds());
            int $$4 = arx.a(this.dw() + (double)((float)($$1 / 2 % 2 * 2 - 1) * 0.25F));
            gw $$5 = new gw($$2, $$3, $$4);
   ...
   public void a(bjg $$0, float $$1) {
      ...
      this.a(ape.wT, 1.0F, 0.4F / (this.ef().i() * 0.4F + 0.8F));
      this.dL().b($$2);
   }
   ...
   @Override
   public void a(apf $$0) {
      this.dL().a(null, this, ape.wU, $$0, 1.0F, 1.0F);
      if (!this.dL().w_()) {
         this.w(false);
