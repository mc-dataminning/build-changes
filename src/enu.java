...
public class enu {
   ...
   public static final Codec<enu> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ae.a($$0, 6).map($$0x -> new enu($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public enu(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static enu a() {
      return new enu(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static enu a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jm $$9) {
      switch ($$9) {
         case d:
         default:
            return new enu($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new enu($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new enu($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new enu($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dgg> b() {
      ...
      int $$2 = kj.a(this.k());
      int $$3 = kj.a(this.m());
      return dgg.a(new dgg($$0, $$1), new dgg($$2, $$3));
   }
   ...
   public static Optional<enu> a(Iterable<jh> $$0) {
      Iterator<jh> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         enu $$2 = new enu($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<enu> b(Iterable<enu> $$0) {
      Iterator<enu> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         enu $$2 = $$1.next();
         enu $$3 = new enu($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   public enu b(int $$0, int $$1, int $$2) {
      return new enu(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public enu c(int $$0, int $$1, int $$2) {
      return new enu(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
