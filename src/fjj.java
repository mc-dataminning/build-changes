...
public class fjj extends hhp {
   ...
   public void aT_() {
      this.G = this.n / 2 - 150;
      this.c(fny.a(xu.k, $$0 -> this.aP_()).a((this.n - 150) / 2, g(13) - 5, 150, 20).a());
      if (this.D == null) {
         this.a(this.E);
      } else {
         this.E();
   ...
   private void E() {
      for (Entry<Integer, fii> $$0 : this.D.i.entrySet()) {
         ...
         fny $$3;
         if ($$2) {
            $$3 = fny.a(xv.c("mco.brokenworld.play"), $$1x -> this.m.a(new fjr(this.C, new flf(this.D.a, $$1, this::b)))).a(this.a($$1), g(8), 80, 20).a();
            $$3.j = !this.D.i.get($$1).m;
         } else {
            $$3 = fny.a(
                  xv.c("mco.brokenworld.download"),
                  $$1x -> this.m.a(fjx.a(this, xv.c("mco.configure.world.restore.download.question.line1"), $$1xx -> this.b($$1)))
               )
   ...
   private void a(fnl $$0, int $$1, int $$2, int $$3, int $$4, boolean $$5, String $$6, int $$7, long $$8, @Nullable String $$9, boolean $$10) {
      ...
      if ($$5) {
         ...
         $$0.a(glo::B, $$11, $$1 + 3, $$2 + 3, 0.0F, 0.0F, 74, 74, 74, 74, 74, 74, ayp.a(1.0F, $$17, $$17, $$17));
         $$0.a(glo::B, a, $$1, $$2, 80, 80);
      } else {
         int $$18 = ayp.a(1.0F, 0.56F, 0.56F, 0.56F);
         $$0.a(glo::B, $$11, $$1 + 3, $$2 + 3, 0.0F, 0.0F, 74, 74, 74, 74, 74, 74, $$18);
         $$0.a(glo::B, a, $$1, $$2, 80, 80, $$18);
      }
