...
public class bcg extends bhn {
   ...
   public bcg(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bis.s, "minecraft:banner");
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bcg::b)));
   }
