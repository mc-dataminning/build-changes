...
public class gpw extends MinecraftServer {
   ...
   public gpw(Thread $$0, fby $$1, ena.c $$2, asp $$3, akr $$4, ako $$5, aqe $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.at(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gpv(this, this.be(), this.g));
      this.m = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (apv $$1 : Lists.newArrayList(this.ah().t())) {
   ...
   @Override
   public czd bf() {
      return this.r() ? (czd)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
