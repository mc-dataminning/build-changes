...
public class ggy<T extends hdq> extends ggk<T> implements gfa, ggu {
   public static final gjx i = new gff(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public ggy(gjo $$0, Function<alg, gqx> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gjw a(gjs $$0, float $$1) {
      gjw $$2 = new gjw();
      gjy $$3 = $$2.a();
      gjy $$4 = $$3.a("head", gjt.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gjq.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", gjt.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gjq.a);
      $$3.a("body", gjt.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), gjq.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", gjt.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gjq.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", gjt.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gjq.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", gjt.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gjq.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", gjt.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gjq.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }
   ...
   public void a(T $$0) {
      ...
      if ($$2 != ggy.a.h) {
         gey.a(this.r, $$0.u, 1.0F);
      }

      if ($$1 != ggy.a.h) {
         gey.a(this.s, $$0.u, -1.0F);
      }
   ...
   private void a(T $$0, ggy.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gey.a(this.r, this.s, $$0.J, $$0.K, true);
            break;
         case g:
            gey.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, ggy.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gey.a(this.r, this.s, $$0.J, $$0.K, false);
            break;
         case g:
            gey.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   private void a(gjo $$0, boolean $$1) {
