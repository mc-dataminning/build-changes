...
public class enn {
   ...
   public enn(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public enn(ens $$0, ens $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static enn a(eaw $$0) {
      return new enn((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static enn a(ens $$0) {
      return new enn($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static enn a(hz $$0, hz $$1) {
      return new enn(
   ...
   public enn a(double $$0) {
      return new enn($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public enn b(double $$0) {
      return new enn(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public enn c(double $$0) {
      return new enn(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public enn d(double $$0) {
      return new enn(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public enn e(double $$0) {
      return new enn(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public enn f(double $$0) {
      return new enn(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public enn b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public enn c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public enn d(double $$0, double $$1, double $$2) {
      return new enn(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public enn f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public enn h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ens> b(ens $$0, ens $$1) {
   ...
   @Nullable
   public static eno a(Iterable<enn> $$0, ens $$1, ens $$2, hz $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eno($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ie a(enn $$0, ens $$1, double[] $$2, @Nullable ie $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ens f() {
      return new ens(awh.d(0.5, this.a, this.d), awh.d(0.5, this.b, this.e), awh.d(0.5, this.c, this.f));
   }

   public static enn a(ens $$0, double $$1, double $$2, double $$3) {
      return new enn($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
