...
public class bhm extends DataFix {
   ...
   private static final ImmutableMap<String, bhm.a> j = ImmutableMap.builder()
      .put("minecraft:village", new bhm.a(32, 8, 10387312))
      .put("minecraft:desert_pyramid", new bhm.a(32, 8, 14357617))
      .put("minecraft:igloo", new bhm.a(32, 8, 14357618))
      .put("minecraft:jungle_pyramid", new bhm.a(32, 8, 14357619))
      .put("minecraft:swamp_hut", new bhm.a(32, 8, 14357620))
      .put("minecraft:pillager_outpost", new bhm.a(32, 8, 165745296))
      .put("minecraft:monument", new bhm.a(32, 5, 10387313))
      .put("minecraft:endcity", new bhm.a(20, 11, 10387313))
      .put("minecraft:mansion", new bhm.a(80, 20, 10387319))
      .build();
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WorldGenSettings building", this.getInputSchema().getType(bgg.M), $$0 -> $$0.update(DSL.remainderFinder(), bhm::a));
   }
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> a(DynamicOps<T> $$0, OptionalDynamic<T> $$1) {
      ...
      Map<String, bhm.a> $$6 = Maps.newHashMap();
      if ($$1.result().isEmpty()) {
         $$5.setTrue();
         $$6.put("minecraft:village", (bhm.a)j.get("minecraft:village"));
      }
                        ...
                        switch ($$9) {
                           ...
                           case "separation":
                              if ("oceanmonument".equals($$8)) {
                                 bhm.a $$11 = $$6.getOrDefault("minecraft:monument", (bhm.a)j.get("minecraft:monument"));
                                 int $$12 = a($$10, $$11.c, 1);
                                 $$6.put("minecraft:monument", new bhm.a($$12, $$11.c, $$11.d));
                              }
      ...
      $$7.put(
         ...
         $$1.createMap(
            $$6.entrySet().stream().collect(Collectors.toMap($$1x -> $$1.createString((String)$$1x.getKey()), $$1x -> ((bhm.a)$$1x.getValue()).a($$0)))
         )
      );
      if ($$5.isTrue()) {
         $$7.put(
   ...
   private static void a(Map<String, bhm.a> $$0, String $$1, String $$2, int $$3) {
      bhm.a $$4 = $$0.getOrDefault($$1, (bhm.a)j.get($$1));
      int $$5 = a($$2, $$4.b, $$3);
      $$0.put($$1, new bhm.a($$5, $$4.c, $$4.d));
   }

   static final class a {
      public static final Codec<bhm.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
