...
public abstract class fbb<E extends fbb.a<E>> extends fay {
   protected static final int b = 6;
   private static final ajh a = new ajh("widget/scroller");
   protected final ezg c;
   protected final int d;
   private final List<E> m = new fbb.b();
   ...
   public fbb(ezg $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, vt.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   public void b(fat $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.r) {
         ...
         int $$4 = 32;
         $$0.a(fhf.d, this.B(), this.C(), (float)this.D(), (float)(this.E() + (int)this.o()), this.g, this.h, 32, 32);
      ...
      if (this.r) {
         int $$7 = 4;
         $$0.a(fxy.E(), this.B(), this.C(), this.D(), this.C() + 4, -16777216, 0, 0);
         $$0.a(fxy.E(), this.B(), this.E() - 4, this.D(), this.E(), 0, -16777216, 0);
      }
   ...
   @Nullable
   protected E a(ffk $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.i());
   }

   @Nullable
   protected E a(ffk $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fat $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public ffa.a s() {
      if (this.aJ_()) {
         ...
         return this.t != null ? ffa.a.b : ffa.a.a;
      }
   }
   ...
   protected void a(ffc $$0, E $$1) {
      List<E> $$2 = this.l();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(ffb.b, vu.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fbb.a<E>> implements fdc {
      @Deprecated
      fbb<E> a;
      ...
      public abstract void a(fat var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
