...
public class fbb {
   ...
   public void a(fcl $$0, String $$1, fdi.a $$2, eqk $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fbb.b $$13 = new fbb.b($$1.trim(), this.f, $$3, $$2);
                  fbb.a $$14 = new fbb.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fbb.c $$30 = new fbb.c(this.f, $$2, $$0);
                        fbb.a $$31 = new fbb.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fcp(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eqk $$2) throws IOException {
      ...
      File $$15 = new File(ffw.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eqk d;
      private final fdi.a e;

      b(final String $$0, final File $$1, final eqk $$2, final fdi.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fbb.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fbb.this.b && !fbb.this.d) {
            try {
               fbb.this.e = true;
               fbb.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fbb.a.error("Error extracting archive", var3);
               fbb.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fdi.a c;
      private final fcl d;

      c(final File $$0, final fdi.a $$1, final fcl $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fbb.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fbb.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fbb.this.g);
                  fbb.this.c = true;
               } else {
                  fbb.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fbb.this.d = true;
               }
            } catch (IOException var3) {
               fbb.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fbb.this.d = true;
            }
         }
      }
