...
public class fbb {
   public static List<fcd> a(fbb.a... $$0) {
      for (fbb.a $$1 : $$0) {
         a($$1.j);
      }

      List<fcd> $$2 = Lists.newArrayList();

      for (fbb.a $$3 : $$0) {
         $$2.add(new fcd($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fcd::a));
      return $$2;
   }
   ...
   public static List<fcd> a() {
      return a(fbb.a.values());
   }
