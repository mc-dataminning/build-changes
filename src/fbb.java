...
public class fbb {
   ...
   static class b {
      static final Optional<fbb> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static fbb a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fbb();
      }
   }
}
