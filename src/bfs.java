...
public class bfs extends bfw {
   public static final Codec<bfs> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bfs a(float $$0, float $$1, float $$2, float $$3) {
      return new bfs($$0, $$1, $$2, $$3);
   }

   private bfs(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(arx $$0, float $$1, float $$2, float $$3, float $$4) {
      return ars.a(ars.c($$0, $$1, $$2), $$3, $$4);
   }
