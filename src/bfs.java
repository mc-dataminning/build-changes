...
public class bfs extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhx.D.typeName(), bjl.a()));
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$2x -> {
            ...
            if ($$4.filter($$0xx -> $$0xx.equals("minecraft:white_banner")).isPresent()) {
               return $$2x.updateTyped($$2, $$0xx -> $$0xx.update(DSL.remainderFinder(), bfs::b));
            } else {
               return $$4.filter($$0xx -> $$0xx.equals("minecraft:filled_map")).isPresent()
                  ? $$2x.updateTyped($$2, $$0xx -> $$0xx.update(DSL.remainderFinder(), bfs::a))
                  : $$2x;
            }
         }
      );
   ...
   private static <T> Dynamic<T> a(Dynamic<T> $$0, Predicate<String> $$1) {
      ...
      Optional<String> $$3 = $$2.asString().result().flatMap(bam::a).filter($$1);
