...
public class bfs extends DataFix {
         ...
         ImmutableMap.of(
            ...
            a(
               ...
               DSL.taggedChoiceType(
                  ...
                  ImmutableMap.of(
                     "minecraft:fixed",
                     a("biome", $$0.getType(bgx.K)),
                     "minecraft:multi_noise",
                     DSL.list(a("biome", $$0.getType(bgx.K))),
                     "minecraft:checkerboard",
                     a("biomes", DSL.list($$0.getType(bgx.K))),
               ...
               "settings",
               DSL.or(DSL.string(), a("default_block", $$0.getType(bgx.C), "default_fluid", $$0.getType(bgx.C)))
            )
         )
      );
   ...
   protected static Type<? extends Pair<? extends Either<? extends Pair<? extends Either<?, Unit>, ? extends Pair<? extends Either<? extends List<? extends Pair<? extends Either<?, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>> a(
      ...
      return b("settings", a("biome", $$0.getType(bgx.K), "layers", DSL.list(b("block", $$0.getType(bgx.C)))));
   }
