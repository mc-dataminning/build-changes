...
public class bfs extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bbd.a(this.a("minecraft:trident", bfs::c), this.a("minecraft:arrow", bfs::a), this.a("minecraft:spectral_arrow", bfs::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfs.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(biw.D, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(biw.D, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bfs.a<?> $$1, Type<?> $$2, Type<T> $$3) {
