...
public class bfs extends DataFix {
   ...
   private static void a(bfs.a $$0, Dynamic<?> $$1) {
   ...
   private static Dynamic<?> a(bfs.a $$0, Dynamic<?> $$1, int $$2) {
      ...
      if ($$6.isPresent()) {
         $$0.a("minecraft:item_name", bam.b($$1.getOps(), $$6.get()));
      }
   ...
   private static <T> Dynamic<T> a(bfs.a $$0, Dynamic<T> $$1, String $$2) {
   ...
   private static void a(bfs.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void b(bfs.a $$0, Dynamic<?> $$1, int $$2) {
      b($$0, $$1, "CanDestroy", "minecraft:can_break", ($$2 & 8) != 0);
      b($$0, $$1, "CanPlaceOn", "minecraft:can_place_on", ($$2 & 16) != 0);
   }

   private static void b(bfs.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void c(bfs.a $$0, Dynamic<?> $$1, int $$2) {
      OptionalDynamic<?> $$3 = $$0.a("AttributeModifiers");
      if (!$$3.result().isEmpty()) {
         boolean $$4 = ($$2 & 2) != 0;
         List<? extends Dynamic<?>> $$5 = $$3.asList(bfs::d);
   ...
   private static void b(bfs.a $$0, Dynamic<?> $$1) {
   ...
   private static void c(bfs.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
      if ($$2 != null) {
   ...
   private static void d(bfs.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
   ...
   @Nullable
   private static Dynamic<?> e(bfs.a $$0, Dynamic<?> $$1) {
   ...
   private static void f(bfs.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.emptyMap();
   ...
   private static void g(bfs.a $$0, Dynamic<?> $$1) {
   ...
   private static void b(bfs.a $$0) {
      $$0.a("Fireworks", true, $$1 -> {
         Stream<? extends Dynamic<?>> $$2 = $$1.get("Explosions").asStream().map(bfs::f);
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(bhy.t), this.getOutputSchema().getType(bhy.t), $$0 -> {
         Optional<? extends Dynamic<?>> $$1 = bfs.a.a($$0).map($$0x -> {
            a($$0x, $$0x.e);
            return $$0x.a();
         });
   ...
   static class a {
      ...
      public static Optional<bfs.a> a(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(($$1, $$2) -> new bfs.a($$1, $$2.intValue(), $$0.remove("id").remove("Count")), $$0.get("Count").asNumber())
            .result();
      }
