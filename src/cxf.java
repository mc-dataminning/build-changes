...
public class cxf {
   ...
   private final cxf.a e;
   private final long f;

   public cxf(cxf.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cxf a(cxf.a $$0) {
      return new cxf($$0, this.f);
   }

   public il<cxd> a(ib $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public il<cxd> a(double $$0, double $$1, double $$2) {
      int $$3 = iw.a(awm.a($$0));
      int $$4 = iw.a(awm.a($$1));
      int $$5 = iw.a(awm.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = awi.a($$7, $$0);
      double $$10 = b($$7);
      return awm.k($$6 + $$10) + awm.k($$5 + $$9) + awm.k($$4 + $$8);
   }
   ...
   public interface a {
      il<cxd> getNoiseBiome(int var1, int var2, int var3);
   }
}
