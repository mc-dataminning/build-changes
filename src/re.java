...
public class re extends qw<rf> {
   private static final int b = 24;
   public static final rs<re> a = new rs.b<re>() {
      public re a(DataInput $$0, int $$1, rg $$2) throws IOException {
         $$2.a(24L);
         int $$3 = $$0.readInt();
         $$2.a(8L * (long)$$3);
         long[] $$4 = new long[$$3];
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof re && Arrays.equals(this.c, ((re)$$0).c);
   }
   ...
   public rf a(int $$0) {
      return rf.a(this.c[$$0]);
   }

   public rf a(int $$0, rf $$1) {
      long $$2 = this.c[$$0];
      this.c[$$0] = $$1.f();
      return rf.a($$2);
   }

   public void b(int $$0, rf $$1) {
