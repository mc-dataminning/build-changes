public class re {
   ...
   private static final azp<Float> e = azp.a;
   private static final azp<Float> f = azp.a($$0 -> $$0 < 0.0F ? $$0 : $$0 * 2.0F);
   private static final azp<Float> g = azp.a($$0 -> 1.25F - 6.25F / ($$0 + 5.0F));
   private static final azp<Float> h = azp.a($$0 -> $$0 * 2.0F);

   public static <C, I extends azp<C>> axo<C, I> a(I $$0, I $$1, I $$2, boolean $$3) {
      azp<Float> $$4 = $$3 ? f : e;
   ...
   public static <C, I extends azp<C>> axo<C, I> a(I $$0, I $$1, I $$2, I $$3, boolean $$4) {
      azp<Float> $$5 = $$4 ? g : e;
   ...
   public static <C, I extends azp<C>> axo<C, I> b(I $$0, I $$1, I $$2, I $$3, boolean $$4) {
      azp<Float> $$5 = $$4 ? h : e;
      float $$6 = 0.65F;
   ...
   private static <C, I extends azp<C>> axo<C, I> a(I $$0, I $$1, I $$2, float $$3, float $$4, float $$5, float $$6, azp<Float> $$7) {
      float $$8 = -0.5775F;
   ...
   private static <C, I extends azp<C>> axo<C, I> a(I $$0, I $$1, float $$2, float $$3, azp<Float> $$4) {
      float $$5 = dzc.a(0.4F);
      float $$6 = dzc.a(0.56666666F);
      float $$7 = ($$5 + $$6) / 2.0F;
   ...
   private static <C, I extends azp<C>> axo<C, I> a(I $$0, float $$1, azp<Float> $$2) {
      float $$3 = 0.63F * $$1;
      float $$4 = 0.3F * $$1;
      return axo.<C, I>a($$0, $$2).a(-0.01F, $$3).a(0.01F, $$4).a();
   }

   private static <C, I extends azp<C>> axo<C, I> a(I $$0, I $$1, I $$2, float $$3, boolean $$4, azp<Float> $$5) {
   ...
   private static <C, I extends azp<C>> axo<C, I> a(I $$0, float $$1, boolean $$2, azp<Float> $$3) {
   ...
   public static <C, I extends azp<C>> axo<C, I> a(
      I $$0, I $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, boolean $$8, boolean $$9, azp<Float> $$10
   ) {
      float $$11 = 0.6F;
      float $$12 = 0.5F;
      float $$13 = 0.5F;
      axo<C, I> $$14 = a($$1, ayn.i($$5, 0.6F, 1.5F), $$9, $$10);
      axo<C, I> $$15 = a($$1, ayn.i($$5, 0.6F, 1.0F), $$9, $$10);
      axo<C, I> $$16 = a($$1, $$5, $$9, $$10);
      axo<C, I> $$17 = a($$1, $$2 - 0.15F, 0.5F * $$5, ayn.i(0.5F, 0.5F, 0.5F) * $$5, 0.5F * $$5, 0.6F * $$5, 0.5F, $$10);
   ...
   private static <C, I extends azp<C>> axo<C, I> a(I $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, azp<Float> $$7) {
