...
public abstract class buc extends bvp {
   private static final akm<Boolean> bY = akq.a(buc.class, ako.k);
   ...
   protected buc(bus<? extends buc> $$0, dfm $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract buc a(arp var1, buc var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dk() instanceof cqr $$0 && !$$0.b((bul)this)) {
         this.ae();
      }
   }
