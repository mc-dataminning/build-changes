...
public abstract class buc extends bvp {
   private static final ajy<Boolean> bY = akc.a(buc.class, aka.k);
   ...
   protected buc(bus<? extends buc> $$0, dgi $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract buc a(ard var1, buc var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dk() instanceof cqu $$0 && !$$0.b((bul)this)) {
         this.ae();
      }
   }
