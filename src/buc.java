...
public class buc extends buj implements bwe {
   private static final Logger c = LogUtils.getLogger();
   private static final int d = 5;
   private static final ajx<Float> e = akb.a(buc.class, ajz.d);
   private static final ajx<Boolean> f = akb.a(buc.class, ajz.k);
   private static final ajx<lr> g = akb.a(buc.class, ajz.l);
   ...
   private cym k = cym.a;
   private final Map<buj, Integer> l = Maps.newHashMap();
   private int m = 600;
   private int n = 20;
   private int o = 20;
   private int p;
   ...
   public buc(buq<? extends buc> $$0, dgg $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public buc(dgg $$0, double $$1, double $$2, double $$3) {
      this(buq.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dW().C) {
         this.au().a(e, ayy.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof lm $$1) {
         int $$2 = this.k.equals(cym.a) ? 0 : this.k.b();
         this.al.a(g, lm.a($$1.a(), axj.f($$2)));
      }
   }
   ...
   private void t() {
      ...
      if (!$$0 || !this.ae.h()) {
         ...
         for (int $$7 = 0; $$7 < $$3; $$7++) {
            ...
            float $$9 = ayy.c(this.ae.i()) * $$4;
            double $$10 = this.dB() + (double)(ayy.b($$8) * $$9);
            double $$11 = this.dD();
            double $$12 = this.dH() + (double)(ayy.a($$8) * $$9);
            if ($$2.a() == lt.u) {
               if ($$0 && this.ae.h()) {
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  List<bto> $$4 = Lists.newArrayList();
                  if (this.k.e().isPresent()) {
                     for (bto $$5 : this.k.e().get().a().a()) {
                        $$4.add(new bto($$5.c(), $$5.a($$0x -> $$0x / 4), $$5.e(), $$5.f(), $$5.g()));
                     }
                  }

                  $$4.addAll(this.k.d());
                  List<bvf> $$6 = this.dW().a(bvf.class, this.cR());
                  if (!$$6.isEmpty()) {
                     for (bvf $$7 : $$6) {
   ...
   public bvf n() {
      if (this.s != null && !this.s.dR()) {
         ...
         if (this.t != null && this.dW() instanceof arc $$0) {
            this.s = $$0.a(this.t) instanceof bvf $$1 ? $$1 : null;
         }
   ...
   protected void a(tq $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cym.c.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> c.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(tq $$0) {
      ...
      if (!this.k.equals(cym.a)) {
         un $$2 = (un)cym.c.encodeStart($$1, this.k).getOrThrow();
