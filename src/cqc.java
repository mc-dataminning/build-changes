...
public class cqc extends cpg {
   ...
   @Nullable
   private cxf<cxt> y;
   private final List<cxf<cxt>> z;

   public cqc(int $$0, clg $$1) {
      this($$0, $$1, cop.a);
   }

   public cqc(int $$0, clg $$1, cop $$2) {
      super(cpl.v, $$0, $$1, $$2);
      this.x = $$1.l.dN();
      this.z = this.x.r().a(cxi.g);
   }
   ...
   @Override
   public void m() {
      List<cxf<cxt>> $$0 = this.x.r().b(cxi.g, this.q, this.x);
      if ($$0.isEmpty()) {
         this.r.a(0, csz.i);
      } else {
         cxf<cxt> $$1 = $$0.get(0);
         csz $$2 = $$1.b().a(this.q, this.x.H_());
         if ($$2.a(this.x.J())) {
            this.y = $$1;
            this.r.a($$1);
            this.r.a(0, $$2);
   ...
   private static OptionalInt a(cxt $$0, csz $$1) {
      if ($$0.a($$1)) {
