...
public class cqc {
   ...
   private static void b(cqb $$0, byj<cqb> $$1) {
      $$1.a(ctd.a, 0, ImmutableList.of(new cag(45, 90), new cak(), bzy.a(), cbq.a()));
   }

   private static void c(cqb $$0, byj<cqb> $$1) {
      $$1.a(ctd.b, 10, ImmutableList.of(cbm.a(cqc::a), a(), b(), cbc.a(bwr.bS, 4)));
   }

   private static void d(cqb $$0, byj<cqb> $$1) {
      $$1.a(ctd.k, 10, ImmutableList.of(cbp.a(($$1x, $$2) -> !a($$1x, (cpx)$$0, $$2)), cbf.a(1.0F), cah.a(20)), cgl.p);
   }

   private static cax<cqb> a() {
      return new cax<>(
         ImmutableList.of(
   ...
   protected static void b(cqb $$0) {
      byj<cqb> $$1 = $$0.eb();
      ctd $$2 = $$1.g().orElse(null);
      $$1.a(ImmutableList.of(ctd.k, ctd.b));
   ...
   private static boolean a(arq $$0, cpx $$1, bxj $$2) {
      return a($$0, $$1).filter($$1x -> $$1x == $$2).isPresent();
   }

   private static Optional<? extends bxj> a(arq $$0, cpx $$1) {
   ...
   protected static void a(cqb $$0, bxj $$1) {
      $$0.eb().b(cgl.F);
      $$0.eb().a(cgl.ac, $$1.cF(), 600L);
   }

   protected static void c(cqb $$0) {
      if ((double)$$0.dU().A.i() < 0.0125) {
         d($$0);
      }
   }

   private static void d(cqb $$0) {
      $$0.eb().g().ifPresent($$1 -> {
         if ($$1 == ctd.k) {
            $$0.gx();
         }
