...
public class ecz {
   ...
   private final Map<String, edh> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public ecz(@Nullable ekg $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public ta a(ta $$0) {
      ta $$1 = $$0.p("Level");
      cwi $$2 = new cwi($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(cwi.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(cwi.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable ekg $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               ta $$4 = $$2.p($$3);
               long $$5 = cwi.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ta $$14 = $$2.p($$13);
                  $$12.a(cwi.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static ecz a(ajg<cxb> $$0, @Nullable ekg $$1) {
      if ($$0 == cxb.h) {
         return new ecz(
            $$1,
         ...
         return new ecz($$1, $$2, $$2);
      } else if ($$0 == cxb.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new ecz($$1, $$3, $$3);
      } else {
