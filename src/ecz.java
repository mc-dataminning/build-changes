...
public class ecz extends ece<eeq> {
   ...
   protected boolean a(
      dds $$0, ayw $$1, eeq $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dtc $$0, Function<jd, dtc> $$1, ayw $$2, eeq $$3, eeq.a $$4, jd.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
