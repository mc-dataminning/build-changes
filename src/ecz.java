...
public class ecz {
   ...
   private static final aku<ecl> u = a("zero");
   private static final aku<ecl> v = a("y");
   private static final aku<ecl> w = a("shift_x");
   private static final aku<ecl> x = a("shift_z");
   private static final aku<ecl> y = a("overworld/base_3d_noise");
   private static final aku<ecl> z = a("nether/base_3d_noise");
   private static final aku<ecl> A = a("end/base_3d_noise");
   public static final aku<ecl> d = a("overworld/continents");
   public static final aku<ecl> e = a("overworld/erosion");
   public static final aku<ecl> f = a("overworld/ridges");
   public static final aku<ecl> g = a("overworld/ridges_folded");
   public static final aku<ecl> h = a("overworld/offset");
   public static final aku<ecl> i = a("overworld/factor");
   public static final aku<ecl> j = a("overworld/jaggedness");
   public static final aku<ecl> k = a("overworld/depth");
   private static final aku<ecl> B = a("overworld/sloped_cheese");
   public static final aku<ecl> l = a("overworld_large_biomes/continents");
   public static final aku<ecl> m = a("overworld_large_biomes/erosion");
   private static final aku<ecl> C = a("overworld_large_biomes/offset");
   private static final aku<ecl> D = a("overworld_large_biomes/factor");
   private static final aku<ecl> E = a("overworld_large_biomes/jaggedness");
   private static final aku<ecl> F = a("overworld_large_biomes/depth");
   private static final aku<ecl> G = a("overworld_large_biomes/sloped_cheese");
   private static final aku<ecl> H = a("overworld_amplified/offset");
   private static final aku<ecl> I = a("overworld_amplified/factor");
   private static final aku<ecl> J = a("overworld_amplified/jaggedness");
   private static final aku<ecl> K = a("overworld_amplified/depth");
   private static final aku<ecl> L = a("overworld_amplified/sloped_cheese");
   private static final aku<ecl> M = a("end/sloped_cheese");
   private static final aku<ecl> N = a("overworld/caves/spaghetti_roughness_function");
   private static final aku<ecl> O = a("overworld/caves/entrances");
   private static final aku<ecl> P = a("overworld/caves/noodle");
   private static final aku<ecl> Q = a("overworld/caves/pillars");
   private static final aku<ecl> R = a("overworld/caves/spaghetti_2d_thickness_modulator");
   private static final aku<ecl> S = a("overworld/caves/spaghetti_2d");

   private static aku<ecl> a(String $$0) {
   ...
   private static void a(
      qe<ecl> $$0, js<ecl> $$1, ecl $$2, jr<ecl> $$3, jr<ecl> $$4, aku<ecl> $$5, aku<ecl> $$6, aku<ecl> $$7, aku<ecl> $$8, aku<ecl> $$9, boolean $$10
   ) {
   ...
   private static ecl a(qe<ecl> $$0, aku<ecl> $$1, ecl $$2) {
      return new ecm.j($$0.a($$1, $$2));
   }

   private static ecl a(js<ecl> $$0, aku<ecl> $$1) {
