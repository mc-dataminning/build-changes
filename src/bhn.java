...
public class bhn extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bhy.y);
      Type<?> $$1 = this.getOutputSchema().getType(bhy.y);
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bjm.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bjm.a($$1.substring(0, $$2))));
