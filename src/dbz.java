...
public interface dbz extends daz, dbg, dcm, dcx.a {
   @Nullable
   dtw a(int var1, int var2, duv var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dxs.a var1, int var2, int var3);

   int B_();

   dcx F_();

   default ji<dcv> t(iz $$0) {
      return this.F_().a($$0);
   }

   default Stream<dsa> c(evk $$0) {
      int $$1 = ayx.a($$0.a);
      int $$2 = ayx.a($$0.d);
      int $$3 = ayx.a($$0.b);
      int $$4 = ayx.a($$0.e);
   ...
   @Override
   default int a(iz $$0, dbh $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ji<dcv> getNoiseBiome(int $$0, int $$1, int $$2) {
      dtw $$3 = this.a(jt.e($$0), jt.e($$2), duv.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ji<dcv> a(int var1, int var2, int var3);
   ...
   default dtw a(int $$0, int $$1) {
      return this.a($$0, $$1, duv.n, true);
   }

   default dtw a(int $$0, int $$1, duv $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbc c(int $$0, int $$1) {
      return this.a($$0, $$1, duv.c, false);
   }
   ...
   default <T> jk<T> a(ald<? extends jv<? extends T>> $$0) {
      jv<T> $$1 = this.H_().d($$0);
      return $$1.p().a(this.J());
   }
}
