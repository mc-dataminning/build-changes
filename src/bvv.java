...
public class bvv extends bjp implements cbf, dkc {
   ...
   private static final aee<Boolean> ca = aeh.a(bvv.class, aeg.k);
   private static final aee<Boolean> cb = aeh.a(bvv.class, aeg.k);
   ...
   @Override
   protected apc w() {
      return this.b(biv.a) ? apd.a : apd.b;
   }
   ...
   public void l() {
      ...
      if (this.dL().B) {
         this.ck = this.cj;
         if (this.t()) {
            this.cj = arw.a(this.cj + 1.0F, 0.0F, 5.0F);
         } else {
            this.cj = arw.a(this.cj - 1.0F, 0.0F, 5.0F);
         }
         ...
         if (this.gd()) {
            ...
            this.cm = arw.a(this.cm, 0.0F, 15.0F);
         } else {
            this.cl = 0.0F;
            this.cm = 0.0F;
            this.cn = 0.0F;
   ...
   protected bgy b(cbu $$0, bgx $$1) {
      ...
      if (this.gd() && this.l($$2) && this.gm()) {
         ...
         this.dL().a($$0, this, apd.E, ape.g, 2.0F, 1.0F);
         this.a($$0, $$2);
         return bgy.a;
      } else if ($$3.b() && !$$2.b()) {
         cjf $$4 = $$2.c(1);
         ...
         this.a(biv.a, cjf.b);
         this.dL().a($$0, this, apd.f, ape.g, 2.0F, 1.0F);
         this.a(bgx.a);
   ...
   public float E(float $$0) {
      return arw.i($$0, this.ck, this.cj) / 5.0F;
   }
   ...
   public float F(float $$0) {
      return arw.i($$0, this.cn, this.cm) / 15.0F;
   }
   ...
   class b implements dkc.d {
      ...
      public boolean a(akq $$0, gw $$1, djt $$2, djt.a $$3) {
         if (bvv.this.fT()) {
            ...
            Optional<hd> $$4 = bvv.this.dN().c(bsh.aM);
            if ($$4.isEmpty()) {
               return true;
            } else {
               hd $$5 = $$4.get();
