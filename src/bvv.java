...
public class bvv extends bvj {
   ...
   public bvv(dhh $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bvq.W, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bvv(bvq<? extends bvv> $$0, dhh $$1) {
      super($$0, $$1);
   }
   ...
   public static void a(ash $$0, fbx $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bvv($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(ash $$0, fbx $$1, int $$2) {
      fbs $$3 = fbs.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.H_().a(40);
      List<bvv> $$5 = $$0.a(ece.a(bvv.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bvv $$6 = $$5.get(0);
         $$6.i++;
         $$6.f = 0;
   ...
   private int a(asi $$0, int $$1) {
      Optional<ddx> $$2 = dea.a(ddz.z, $$0, cxo::n);
      if ($$2.isPresent()) {
         cxo $$3 = $$2.get().a();
         int $$4 = dea.c($$0.y(), $$3, $$1);
