public abstract class hom extends hoi {
   private static final float o = 0.0F;
   private static final float p = 1.2F;
   private static final float q = 0.0F;
   protected final cjn n;
   private boolean r;

   public hom(cjn $$0, awq $$1, aws $$2) {
      super($$1, $$2, hoz.t());
      this.n = $$0;
   ...
   public void q() {
      ...
      if (!this.n.dQ() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = azq.h(azq.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = azq.h(azq.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
