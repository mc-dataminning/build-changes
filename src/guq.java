...
public class guq {
   ...
   public static class a extends Thread {
      private final guq.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(guq.b $$0) throws IOException {
         super("LanServerDetector #" + guq.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(guq.b));
   ...
   public static class b {
      private final List<gup> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gup> a() {
         if (this.b) {
            List<gup> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
