...
public class hfp extends MinecraftServer {
   ...
   public hfp(Thread $$0, flz $$1, evv.c $$2, avg $$3, amy $$4, amu $$5, ass $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hfo(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   public boolean a(@Nullable dgx $$0, boolean $$1, int $$2) {
      try {
         ...
         this.p = $$2;
         this.r = new hfs(this.ae(), $$2 + "");
         this.r.start();
         this.q = $$0;
         this.ag().b($$1);
         int $$3 = this.c(this.n.t.gf());
         this.n.t.a($$3);
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (asi $$1 : Lists.newArrayList(this.ag().t())) {
   ...
   @Override
   public dgx bd() {
      return this.r() && !this.w_() ? (dgx)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
