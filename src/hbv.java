...
public class hbv implements hbo {
   ...
   private hbv(List<alz> $$0, alz $$1, Map<String, alz> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(hbu a, Supplier<IntUnaryOperator> b, alz c) implements hbo.b {
      @Nullable
      public hbe a(hbn $$0) {
         Object var3;
         try {
            ffr $$1 = this.a.a().a(this.b.get());
            return new hbe(this.c, new hcy($$1.a(), $$1.b()), $$1, avx.a);
         } catch (IllegalArgumentException | IOException var7) {
            hbv.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
