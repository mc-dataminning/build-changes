...
public class bgr extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemStack custom_name to item_name component fix", $$0, $$2x -> {
         ...
         if ($$4.filter($$0xx -> $$0xx.equals("minecraft:white_banner")).isPresent()) {
            return $$2x.updateTyped($$2, bgr::b);
         } else {
            return $$4.filter($$0xx -> $$0xx.equals("minecraft:filled_map")).isPresent() ? $$2x.updateTyped($$2, bgr::a) : $$2x;
         }
      });
   }
   ...
   private static <T> Typed<T> a(Typed<T> $$0, Predicate<String> $$1) {
      return ag.a($$0, $$0.getType(), $$1x -> {
         ...
         Optional<String> $$3 = $$2.asString().result().flatMap(bbe::d).filter($$1);
