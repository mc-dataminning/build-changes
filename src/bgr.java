...
public abstract class bgr<R extends Runnable> implements bfz, bgt<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bgr(String $$0) {
      this.b = $$0;
      bfx.a.a(this);
   }
   ...
   @Override
   public List<bfw> bk() {
      return ImmutableList.of(bfw.a(this.b + "-pending-tasks", bfv.b, this::bm));
   }
}
