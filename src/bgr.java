...
public class bgr implements bgs {
   ...
   private static final bgr j = new bgr();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bgq $$0) {
      URL $$1 = bgr.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bgq $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bgu a = new bgu(() -> bgr.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bgr.this.k && $$0.getState() == RecordingState.STOPPED) {
