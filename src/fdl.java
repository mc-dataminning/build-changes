...
public class fdl extends gvh {
   ...
   private Long Y;
   private long Z;
   private final fks aa = new fks(this);

   public fdl(@Nullable fei $$0, long $$1, int $$2, fde $$3, epy $$4) {
      super(fey.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aM_() {
      this.U = this.aa.b(fhf.a(xo.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.aa.b(fhf.a(xo.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.J();
         } else {
            List<feg> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new feo(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fcw(this.G, $$0.toArray(new feg[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fcp(new fak(new fnj()), this.J));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              fan $$10 = new fan($$0, this.J, this.K, $$2, this.m.X(), aa.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              fal $$7 = fal.a($$6);
                              fal $$8 = fal.a(5368709120L);
                              if (fal.b($$6, $$7).equals(fal.b(5368709120L, $$8)) && $$7 != fal.a) {
                                 fal $$9 = fal.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xp.a("mco.upload.size.failure.line1", this.H.b()),
                                    xp.a("mco.upload.size.failure.line2", fal.b($$6, $$9), fal.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xp.a("mco.upload.size.failure.line1", this.H.b()),
                                    xp.a("mco.upload.size.failure.line2", fal.b($$6, $$7), fal.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
