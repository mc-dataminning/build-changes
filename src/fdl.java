...
public class fdl extends fby<ciq> {
   private static final agm x = new agm("container/stonecutter/scroller");
   private static final agm y = new agm("container/stonecutter/scroller_disabled");
   private static final agm z = new agm("container/stonecutter/recipe_selected");
   private static final agm A = new agm("container/stonecutter/recipe_highlighted");
   private static final agm B = new agm("container/stonecutter/recipe");
   private static final agm C = new agm("textures/gui/container/stonecutter.png");
   ...
   private void b(eut $$0, int $$1, int $$2, int $$3) {
      List<cov<cpm>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.M = atq.a(this.M - $$5, 0.0F, 1.0F);
