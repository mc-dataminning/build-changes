...
public enum fdl {
   ...
   private fdl(final String... $$0) {
      this.c = $$0;
   }

   public List<auu<InputStream>> a(ato $$0) throws IOException {
      return List.of(
   ...
   public auu<InputStream> b(ato $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private auu<InputStream> a(ato $$0, String $$1) throws IOException {
