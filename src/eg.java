...
public class eg implements ArgumentType<eg.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vb.c("argument.player.unknown"));

   public static Collection<GameProfile> a(CommandContext<ds> $$0, String $$1) throws CommandSyntaxException {
      return ((eg.a)$$0.getArgument($$1, eg.a.class)).getNames((ds)$$0.getSource());
   }
