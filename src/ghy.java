...
public interface ghy {
   static ghy a(gie $$0, UserApiService $$1) {
      return new ghy.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, gig var2, AbuseReport var3);
   ...
   public static record b(gie a, UserApiService b) implements ghy {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, gig $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               wp $$5 = this.a(var7);
               throw new CompletionException(new ghy.a($$5, var7));
            } catch (MinecraftClientException var8) {
               wp $$7 = this.a(var8);
               throw new CompletionException(new ghy.a($$7, var8));
            }
         }, af.i());
      }
