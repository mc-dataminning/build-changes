...
public class fpa extends foq<cqb> {
   ...
   private void a(fhx $$0, @Nullable eqp $$1, @Nullable eqr $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.A;
      int $$8 = this.B;
      if ($$4 && !$$6) {
   ...
   private void a(fhx $$0, @Nullable eqp $$1, @Nullable eqr $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
