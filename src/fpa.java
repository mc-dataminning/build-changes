...
public class fpa {
   ...
   private static final Comparator<gfp> p = Comparator.<gfp>comparingInt($$0 -> -$$0.j())
      .thenComparingInt($$0 -> $$0.e() == dgx.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), fcs::b, ""))
   ...
   public xv a(gfp $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fcs.a($$0.h(), xv.b($$0.a().getName())));
   }

   private xv a(gfp $$0, yj $$1) {
      return $$0.e() == dgx.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fnl $$0, int $$1, fcx $$2, @Nullable fcp $$3) {
      List<gfp> $$4 = this.b();
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               cps $$44 = this.q.s.b($$43.getId());
               boolean $$45 = $$44 != null && gsk.b($$44);
               boolean $$46 = $$44 != null && $$44.a(cpt.g);
               foy.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45, -1);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dgx.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dgx.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fnl $$0, int $$1, int $$2, int $$3, gfp $$4) {
      alz $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(glo::B, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fcp $$0, int $$1, fpa.b $$2, int $$3, int $$4, UUID $$5, fnl $$6) {
      if ($$0.h() == fda.a.b) {
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(glo::B, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(glo::B, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(glo::B, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(glo::B, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(glo::B, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(glo::B, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
