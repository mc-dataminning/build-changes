...
public class fpa extends fgw<fpa.a> {
   static final akn a = new akn("server_list/incompatible");
   static final akn m = new akn("server_list/unreachable");
   static final akn n = new akn("server_list/ping_1");
   static final akn o = new akn("server_list/ping_2");
   static final akn p = new akn("server_list/ping_3");
   static final akn q = new akn("server_list/ping_4");
   static final akn r = new akn("server_list/ping_5");
   static final akn s = new akn("server_list/pinging_1");
   static final akn u = new akn("server_list/pinging_2");
   static final akn v = new akn("server_list/pinging_3");
   static final akn w = new akn("server_list/pinging_4");
   static final akn x = new akn("server_list/pinging_5");
   static final akn y = new akn("server_list/join_highlighted");
   static final akn z = new akn("server_list/join");
   static final akn A = new akn("server_list/move_up_highlighted");
   static final akn B = new akn("server_list/move_up");
   static final akn C = new akn("server_list/move_down_highlighted");
   static final akn D = new akn("server_list/move_down");
   ...
   public fpa(fox $$0, feb $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(List<gsb> $$0) {
      ...
      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         ...
         if ($$7 >= this.D() && $$6 <= this.F()) {
            this.c.aX().b(wx.a("multiplayer.lan.server_found", $$4.c()));
         }
      }
   }
   ...
   public abstract static class a extends fgw.a<fpa.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }
   ...
   public class d extends fpa.a {
      ...
      protected d(fox $$1, fxf $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = feb.Q();
         this.j = fld.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(ffn $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         List<axr> $$10 = this.h.h.c(this.i.d, $$4 - 32 - 2);
      ...
      protected void a(ffn $$0, int $$1, int $$2, akn $$3) {
      ...
      public boolean a(double $$0, double $$1, int $$2) {
         ...
         double $$4 = $$1 - (double)fpa.this.g(fpa.this.aF_().indexOf(this));
         if ($$3 <= 32.0) {
