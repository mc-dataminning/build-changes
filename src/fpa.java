...
public class fpa extends fos<cqt> implements fqu {
   private float D;
   private float E;
   ...
   public fpa(cmv $$0) {
      super($$0.ca, $$0.gc(), xo.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void D() {
      if (this.m.q.f()) {
         this.m.a(new foo(this.m.s, this.m.s.cz.x(), this.m.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         ...
         this.c(new fho(this.z + 104, this.o / 2 - 22, 20, 18, fqo.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.n, this.c);
   ...
   public static void a(fgp $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, btn $$9) {
   ...
   public static void a(fgp $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, btn $$7) {
      $$0.c().a();
