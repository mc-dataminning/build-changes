...
public abstract class far<T extends far<T>> {
   ...
   public far(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fap.a();
         if ($$3 != null) {
         ...
         throw new fca(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fca(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fca(var2.getMessage(), var2);
      }
   }
   ...
   public static far<?> a(String $$0) {
      return new far.b($$0, 5000, 60000);
   }

   public static far<?> a(String $$0, int $$1, int $$2) {
      return new far.b($$0, $$1, $$2);
   }

   public static far<?> b(String $$0, String $$1) {
      return new far.c($$0, $$1, 5000, 60000);
   }

   public static far<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new far.c($$0, $$1, $$2, $$3);
   }

   public static far<?> b(String $$0) {
      return new far.a($$0, 5000, 60000);
   }

   public static far<?> c(String $$0, String $$1) {
      return new far.d($$0, $$1, 5000, 60000);
   }

   public static far<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new far.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends far<far.a> {
   ...
   public static class b extends far<far.b> {
   ...
   public static class c extends far<far.c> {
      ...
      public far.c f() {
         try {
            ...
            throw new fca(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends far<far.d> {
      private final String c;
