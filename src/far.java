...
public class far {
   ...
   public far(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fas> $$1) throws IOException {
   ...
   public List<fas> a(Path $$0) throws IOException {
      List<fas> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fas> a(Path $$0, boolean $$1) throws IOException {
      List<fas> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fas> $$1) throws IOException {
