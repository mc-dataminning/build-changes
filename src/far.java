...
public class far {
   ...
   public void a(cfp $$0, esy $$1, float $$2, int $$3, int $$4) {
      chh $$5 = $$0.b(this.d);
   ...
   private void a(chh $$0, afw $$1, float $$2, esy $$3, int $$4, int $$5) {
      gaa $$6 = ero.O().a(fzz.e).apply($$1);
