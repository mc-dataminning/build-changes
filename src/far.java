...
public class far implements AutoCloseable {
   private final far.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private fat a(faj.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(faj.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, get $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, get $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.n != null && (this.i == fat.b.a || this.i == fat.b.b)) {
