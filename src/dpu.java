...
public class dpu extends djb {
   public static final MapCodec<dpu> c = b(dpu::new);
   public static final dxn d = dxm.v;
   private static final Map<dfm, List<dpu.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dgh $$0, ji $$1, boolean $$2) {
      List<dpu.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dpu.a($$1.j(), $$0.ad()));
      }
