...
public class eqa extends epr {
   ...
   private final Object2BooleanMap<ewp> n = new Object2BooleanOpenHashMap();
   private final epq[] o = new epq[iw.c.a.b()];
   ...
   public epq a() {
      ir.a $$0 = new ir.a();
      int $$1 = this.b.dA();
      dtc $$2 = this.a.a($$0.b(this.b.dz(), (double)$$1, this.b.dF()));
      if (!this.b.a($$2.u())) {
         if (this.f() && this.b.bi()) {
            while (true) {
               if (!$$2.a(dfe.al) && $$2.u() != epf.c.a(false)) {
                  $$1--;
                  break;
               }

               $$2 = this.a.a($$0.b(this.b.dz(), (double)(++$$1), this.b.dF()));
            }
         } else if (this.b.aE()) {
            $$1 = aym.a(this.b.dB() + 0.5);
         } else {
            $$0.b(this.b.dz(), this.b.dB() + 1.0, this.b.dF());

            while ($$0.v() > this.a.a().J_()) {
               $$1 = $$0.v();
               $$0.q($$0.v() - 1);
               dtc $$3 = this.a.a($$0);
               if (!$$3.i() && !$$3.a(ept.a)) {
      ...
      return this.c(new ir($$4.u(), $$1, $$4.w()));
   }

   protected epq c(ir $$0) {
      epq $$1 = this.b($$0);
   ...
   public int a(epq[] $$0, epq $$1) {
      ...
      if (this.b.a($$4) >= 0.0F && $$5 != epv.w) {
         $$3 = aym.d(Math.max(1.0F, this.b.dO()));
      }

      double $$6 = this.d(new ir($$1.a, $$1.b, $$1.c));
   ...
   protected boolean a(epq $$0, @Nullable epq $$1, @Nullable epq $$2) {
      if ($$2 == null || $$1 == null || $$2.b > $$0.b || $$1.b > $$0.b) {
         ...
         boolean $$3 = $$2.l == epv.h && $$1.l == epv.h && (double)this.b.do() < 0.5;
   ...
   private boolean b(epq $$0) {
      ewp $$1 = this.b.cP();
      ewu $$2 = new ewu((double)$$0.a - this.b.dz() + $$1.b() / 2.0, (double)$$0.b - this.b.dB() + $$1.c() / 2.0, (double)$$0.c - this.b.dF() + $$1.d() / 2.0);
      int $$3 = aym.c($$2.f() / $$1.a());
   ...
   protected double d(ir $$0) {
      dbg $$1 = this.a.a();
      return (this.f() || this.c()) && $$1.b_($$0).a(awj.a) ? (double)$$0.v() + 0.5 : a($$1, $$0);
   }

   public static double a(dbg $$0, ir $$1) {
      ir $$2 = $$1.d();
      exn $$3 = $$0.a_($$2).k($$0, $$2);
      return (double)$$2.v() + ($$3.c() ? 0.0 : $$3.c(iw.a.b));
   }
   ...
   @Nullable
   protected epq a(int $$0, int $$1, int $$2, int $$3, double $$4, iw $$5, epv $$6) {
      epq $$7 = null;
      ir.a $$8 = new ir.a();
   ...
   private double h() {
      return Math.max(1.125, (double)this.b.dO());
   }
   ...
   @Nullable
   private epq a(int $$0, int $$1, int $$2, int $$3, double $$4, iw $$5, epv $$6, ir.a $$7) {
      epq $$8 = this.a($$0, $$1 + 1, $$2, $$3 - 1, $$4, $$5, $$6);
      if ($$8 == null) {
         return null;
      } else if (this.b.do() >= 1.0F) {
         return $$8;
         ...
         double $$11 = (double)this.b.do() / 2.0;
         ewp $$12 = new ewp(
            $$9 - $$11,
            this.d($$7.b($$9, (double)($$1 + 1), $$10)) + 0.001,
            $$10 - $$11,
            $$9 + $$11,
            (double)this.b.dp() + this.d($$7.b((double)$$8.a, (double)$$8.b, (double)$$8.c)) - 0.002,
            $$10 + $$11
         );
   ...
   private epq d(int $$0, int $$1, int $$2) {
      for (int $$3 = $$1 - 1; $$3 >= this.b.dU().J_(); $$3--) {
         if ($$1 - $$3 > this.b.cC()) {
            return this.a($$0, $$3, $$2);
         }
   ...
   private boolean a(ewp $$0) {
      return this.n.computeIfAbsent($$0, $$1 -> !this.a.a().b(this.b, $$0));
   }

   protected epv b(int $$0, int $$1, int $$2) {
      return (epv)this.m.computeIfAbsent(ir.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }
   ...
   public epv a(epx $$0, int $$1, int $$2, int $$3) {
      return a($$0, new ir.a($$1, $$2, $$3));
   }

   public static epv b(bsq $$0, ir $$1) {
      return a(new epx($$0.dU(), $$0), $$1.j());
   }

   public static epv a(epx $$0, ir.a $$1) {
      int $$2 = $$1.u();
      int $$3 = $$1.v();
      int $$4 = $$1.w();
      epv $$5 = $$0.a($$2, $$3, $$4);
      if ($$5 == epv.b && $$3 >= $$0.a().J_() + 1) {
   ...
   protected static epv b(dbg $$0, ir $$1) {
      dtc $$2 = $$0.a_($$1);
      dfc $$3 = $$2.b();
      if ($$2.i()) {
         return epv.b;
      } else if ($$2.a(awe.P) || $$2.a(dfe.ge) || $$2.a(dfe.ua)) {
         return epv.e;
      } else if ($$2.a(dfe.sa)) {
         return epv.f;
      } else if ($$2.a(dfe.eE) || $$2.a(dfe.pi)) {
         return epv.q;
      } else if ($$2.a(dfe.qr)) {
         return epv.w;
      } else if ($$2.a(dfe.gu)) {
         return epv.x;
      } else if (!$$2.a(dfe.cN) && !$$2.a(dfe.tE)) {
         epe $$4 = $$2.u();
         if ($$4.a(awj.b)) {
            return epv.i;
         } else if (a($$2)) {
            return epv.o;
         } else if ($$3 instanceof dhj $$5) {
            if ($$2.c(dhj.c)) {
               return epv.r;
            } else {
            ...
            return epv.l;
         } else if ($$3 instanceof djq) {
            return epv.v;
         } else if (!$$2.a(awe.S) && !$$2.a(awe.L) && (!($$3 instanceof die) || $$2.c(die.b))) {
            if (!$$2.a(ept.a)) {
               return epv.a;
            } else {
               return $$4.a(awj.a) ? epv.j : epv.b;
            }
         } else {
            return epv.h;
         }
