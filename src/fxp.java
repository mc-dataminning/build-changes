...
public class fxp implements AutoCloseable {
   ...
   public fxp(fxj $$0, ezg $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gim(16, 16, false);
   ...
   private float b(float $$0) {
      boj $$1 = this.j.s.c(bol.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(bpo $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, aww.b(((float)$$0.ah - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            float $$5 = this.j.m.aj().c().floatValue();
            float $$6 = this.b($$0) * $$5;
            ...
            if (this.j.s.a(bol.p)) {
               $$9 = fxj.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.a(bol.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
            ...
            for (int $$15 = 0; $$15 < 16; $$15++) {
               for (int $$16 = 0; $$16 < 16; $$16++) {
                  ...
                  float $$29 = this.j.m.an().c().floatValue();
   ...
   private static void a(Vector3f $$0) {
      $$0.set(aww.a($$0.x, 0.0F, 1.0F), aww.a($$0.y, 0.0F, 1.0F), aww.a($$0.z, 0.0F, 1.0F));
   }
   ...
   public static float a(dqm $$0, int $$1) {
      float $$2 = (float)$$1 / 15.0F;
      float $$3 = $$2 / (4.0F - 3.0F * $$2);
      return aww.i($$0.s(), $$3, 1.0F);
   }
