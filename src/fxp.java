...
public class fxp {
   ...
   private static final fpm b = new fpm(alp.b("recipe_book/page_forward"), alp.b("recipe_book/page_forward_highlighted"));
   private static final fpm c = new fpm(alp.b("recipe_book/page_backward"), alp.b("recipe_book/page_backward_highlighted"));
   ...
   public void a(fnl $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      if (this.l > 1) {
         xk $$6 = xk.a("gui.recipebook.page", this.m + 1, this.l);
         int $$7 = this.g.h.a($$6);
