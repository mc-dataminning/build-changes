...
public class fxp implements fyi {
   ...
   private CompletableFuture<Optional<cna>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public fxp(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cna::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cna>> a(Optional<cna> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (axx | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cna.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cna $$0) {
      ...
      if ($$0 != null) {
         if (aa.aX) {
            cna.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cna a(UserApiService $$0) throws axx, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cnb.a $$2 = a($$1);
         return new cna(axw.a($$1.keyPair().privateKey()), new cnb($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cnb.a a(KeyPairResponse $$0) throws axx {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = axw.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cnb.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new axx(var5);
         }
      } else {
         throw new axx(new MissingException("Missing public key"));
      }
   }
}
