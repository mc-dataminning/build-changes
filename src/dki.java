...
public class dki implements dke, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bhq<bhs.b> c;
   private final dkl d;
   private final Map<crh, dki.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dki(Path $$0, boolean $$1, String $$2) {
      this.d = new dkl($$0, $$1);
      this.c = new bhq<>(new bhs.a(dki.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(crh $$0, int $$1) {
      crh $$2 = new crh($$0.e - $$1, $$0.f - $$1);
      crh $$3 = new crh($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         crh $$3 = crh.b($$0, $$1);
         BitSet $$4 = new BitSet();
         crh.a($$2, $$3).forEach($$1xx -> {
            td $$2x = new td(new tf(se.a, "DataVersion"), new tf(rz.b, "blending_data"));
            ...
            if ($$2x.d() instanceof rz $$5 && this.a($$5)) {
   ...
   private boolean a(rz $$0) {
      return $$0.b("DataVersion", 99) && $$0.h("DataVersion") >= 3441 ? $$0.b("blending_data", 10) : true;
   }

   public CompletableFuture<Void> a(crh $$0, @Nullable rz $$1) {
      return this.a(() -> {
         dki.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dki.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<rz>> a(crh $$0) {
      return this.a(() -> {
         dki.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(crh $$0, st $$1) {
      return this.a(() -> {
         try {
            dki.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bhs.b(dki.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<crh, dki.a>> $$0 = this.e.entrySet().iterator();
         Entry<crh, dki.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bhs.b(dki.b.b.ordinal(), this::a));
   }

   private void a(crh $$0, dki.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bhs.b(dki.b.c.ordinal(), () -> $$0.a(auo.a))).join();
         this.c.close();
