...
public class dki {
   public static <T> List<dki.b> a(List<T> $$0, Function<T, List<ji<epx>>> $$1, boolean $$2) {
      Object2IntMap<epx> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, epx c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<ji<epx>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (je<epx> $$12 : $$10.get($$11)) {
               epx $$13 = $$12.a();
      ...
      Builder<dki.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<epx> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dki.b($$28));
      }
   ...
   public static record b(List<epx> a, ToIntFunction<epx> b) {
      b(List<epx> $$0) {
         this($$0, af.h($$0));
      }
   }
