...
public abstract class dki {
   ...
   public static void a(ta $$0, dkk<?> $$1) {
      $$0.a("id", dkk.a($$1).toString());
   }

   public void a(cqm $$0, in.a $$1) {
      coh.a($$0, this.r(), this.d($$1));
   }
   ...
   @Nullable
   public static dki a(ib $$0, dnb $$1, ta $$2, in.a $$3) {
      String $$4 = $$2.l("id");
      ajh $$5 = ajh.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(cxb $$0, ib $$1, dnb $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
