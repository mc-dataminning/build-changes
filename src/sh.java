...
public class sh extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<rl> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, rb.a);
   }

   @Deprecated
   public <T> T a(DynamicOps<rl> $$0, Codec<T> $$1, rb $$2) {
      rl $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> sh a(DynamicOps<rl> $$0, Codec<T> $$1, T $$2) {
      rl $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = arf.a(h, this.r(), JsonElement.class);
   ...
   public <T> void a(hk<hf<T>> $$0, hf<T> $$1, sh.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> hf<T> a(hk<hf<T>> $$0, sh.a<T> $$1) {
      int $$2 = this.m();
      if ($$2 == 0) {
         return hf.a($$1.apply(this));
      } else {
         hf<T> $$3 = $$0.a($$2 - 1);
         if ($$3 == null) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, sh.a<T> $$1) {
      int $$2 = this.m();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, sh.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, sh.a<K> $$1, sh.a<V> $$2) {
      int $$3 = this.m();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(sh.a<K> $$0, sh.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, sh.b<K> $$1, sh.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, sh.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, sh.b<L> $$1, sh.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(sh.a<L> $$0, sh.a<R> $$1) {
   ...
   public ehf k() {
      return new ehf(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> sh a(ToIntFunction<T> $$0, T $$1) {
   ...
   public sh a(@Nullable rl $$0) {
      if ($$0 == null) {
         $$0 = qu.b;
      }

      try {
         rc.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   @Nullable
   public qs p() {
      rl $$0 = this.a(new rb(2097152L));
      if ($$0 != null && !($$0 instanceof qs)) {
   ...
   public rl a(rb $$0) {
      try {
         rl $$1 = rc.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return su.a(this.d, $$0);
   }

   public sh a(String $$0) {
      return this.a($$0, 32767);
   }

   public sh a(String $$0, int $$1) {
      su.a(this.d, $$0, $$1);
      return this;
   }

   public aep s() {
      return new aep(this.d(32767));
   }
   ...
   public <T> aeo<T> a(aeo<? extends hs<T>> $$0) {
      aep $$1 = this.s();
      return aeo.a($$0, $$1);
   }
   ...
   public ehb x() {
      gv $$0 = this.e();
      hb $$1 = this.b(hb.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new ehb(new ehf((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, aro.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), sh::a);
   }

   public Property B() {
      String $$0 = this.r();
      String $$1 = this.r();
      String $$2 = this.c(sh::r);
   ...
   public sh a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sh a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public sh a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sh a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sh a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sh a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sh a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public sh a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public sh b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public sh c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public sh d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public sh e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public sh f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public sh g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public sh h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public sh a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public sh b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public sh i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public sh a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public sh a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public sh b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sh b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public sh b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sh b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sh b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sh b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public sh a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sh a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public sh a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sh a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public sh a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sh a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public sh a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public sh b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public sh b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public sh b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sh b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public sh b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
   ...
   @FunctionalInterface
   public interface a<T> extends Function<sh, T> {
      default sh.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<sh, T> {
      default sh.b<Optional<T>> asOptional() {
