...
public class fda extends gvu {
   ...
   protected void aP_() {
      ...
      if (this.Q) {
         this.R = this.c(
            fhu.a(wu.c("mco.selectServer.trial"), fmi.b(this, "https://aka.ms/startjavarealmstrial")).a(this.F() - 10 - 99, this.G() - 10 - 4 - 40, 99, 20).a()
         );
      }

      this.c(fhu.a(wu.c("mco.selectServer.buy"), fmi.b(this, "https://aka.ms/BuyJavaRealms")).a(this.F() - 10 - 99, this.G() - 10 - 20, 99, 20).a());
      fig $$0 = this.c(new fig(this.D() + 4, this.E() + 4, 14, 14, B, $$0x -> this.d(), b));
      $$0.a(fjf.a(b));
      int $$1 = 142 - (this.Q ? 40 : 20);
      fie $$2 = new fie(this.F() - 10 - 100, this.E() + 10, 100, $$1, a, this.o);
      if ($$2.j()) {
         $$2.k(100 - $$2.f());
      }
   ...
   public static void a(fhh $$0, fhu $$1) {
      int $$2 = 8;
      $$0.c().a();
