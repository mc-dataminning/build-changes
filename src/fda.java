...
public class fda extends gvm {
   ...
   public fda(fnd $$0, fcd $$1, String $$2, BooleanConsumer $$3) {
      super(fff.a);
      this.Y = $$3;
      this.D = $$0;
      this.I = $$2;
   ...
   @Override
   public void aO_() {
      this.H = this.c(fhm.a(wt.e, $$0 -> this.d()).a((this.m - 200) / 2, this.n - 42, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      if (!this.P && !this.X) {
         ...
         if (this.a(this.E.a) >= 5368709120L) {
            wu $$0 = wu.a("mco.download.confirmation.oversized", fas.b(5368709120L));
            this.l.a(fdj.c(this, $$0, $$0x -> {
               this.l.a(this);
               this.G();
            }));
         } else {
   ...
   private wu F() {
      ...
      if (this.M != null) {
         ...
         $$0.add(wu.a("mco.download.speed.narration", fas.b(this.T)));
      }
   ...
   private void a(fgz $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.o, wu.a("mco.download.speed", fas.b($$1)), this.m / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
