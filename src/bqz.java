...
public class bqz extends bqs {
   public static final MapCodec<bqz> a = RecordCodecBuilder.mapCodec(
   ...
   private bqz(float $$0, float $$1) {
      this.b = $$0;
      this.d = $$1;
   }

   public static bqz b(float $$0, float $$1) {
      if ($$1 <= $$0) {
