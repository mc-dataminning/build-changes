...
public abstract class bqz<R extends Runnable> implements bqg, brf<R>, Executor {
   ...
   @Override
   public List<bqd> bw() {
      return ImmutableList.of(bqd.a(this.b + "-pending-tasks", bqc.b, this::by));
   }
