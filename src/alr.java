...
public class alr {
   ...
   private final Queue<alr.a> b = new axm<>();
   private final Object2IntLinkedOpenHashMap<alr.b> c = new Object2IntLinkedOpenHashMap();
   ...
   public synchronized void a(String $$0, Throwable $$1) {
      ...
      this.b.add(new alr.a($$2, $$0, (Class<? extends Throwable>)$$1.getClass(), $$3));

      while (this.b.size() > 8) {
         this.b.remove();
      }

      alr.b $$4 = new alr.b($$0, (Class<? extends Throwable>)$$1.getClass());
   ...
   public synchronized String a() {
      ...
      if (!this.c.isEmpty()) {
         ...
         while (var6.hasNext()) {
            Entry<alr.b> $$3 = (Entry<alr.b>)var6.next();
            $$1.append("\t\t\t")
               .append(((alr.b)$$3.getKey()).a)
               .append(":")
               .append(((alr.b)$$3.getKey()).b)
               .append(" x ")
