...
public final class alr implements Comparable<alr> {
   public static final Codec<alr> a = Codec.STRING.comapFlatMap(alr::d, alr::toString).stable();
   public static final ze<ByteBuf, alr> b = zc.p.a(alr::a, alr::toString);
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xg.c("argument.id.invalid"));
   ...
   private static alr d(String $$0, String $$1) {
      return new alr(e($$0, $$1), f($$0, $$1));
   }

   public static alr a(String $$0, String $$1) {
      return d($$0, $$1);
   }
   ...
   public static alr b(String $$0) {
      return new alr("minecraft", f("minecraft", $$0));
   }

   @Nullable
   public static alr c(String $$0) {
      return b($$0, ':');
   }

   @Nullable
   public static alr b(String $$0, String $$1) {
      return j($$0) && i($$1) ? new alr($$0, $$1) : null;
   }

   public static alr a(String $$0, char $$1) {
      int $$2 = $$0.indexOf($$1);
      if ($$2 >= 0) {
   ...
   @Nullable
   public static alr b(String $$0, char $$1) {
      int $$2 = $$0.indexOf($$1);
      if ($$2 >= 0) {
         String $$3 = $$0.substring($$2 + 1);
         if (!i($$3)) {
            ...
            String $$4 = $$0.substring(0, $$2);
            return j($$4) ? new alr($$4, $$3) : null;
         } else {
            return new alr("minecraft", $$3);
         }
      } else {
         return i($$0) ? new alr("minecraft", $$0) : null;
      }
   }

   public static DataResult<alr> d(String $$0) {
      try {
   ...
   public alr e(String $$0) {
      return new alr(this.h, f(this.h, $$0));
   }

   public alr a(UnaryOperator<String> $$0) {
      return this.e($$0.apply(this.i));
   }

   public alr f(String $$0) {
      return this.e($$0 + this.i);
   }

   public alr g(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof alr $$1) ? false : this.h.equals($$1.h) && this.i.equals($$1.i);
      }
   }
   ...
   public static alr a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
   ...
   public static alr b(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
      if ($$2.isEmpty()) {
         throw c.createWithContext($$0);
