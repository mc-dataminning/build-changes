...
public class alr implements AutoCloseable {
   ...
   private alr(URL $$0, alr.c $$1, URL $$2, alr.b $$3, URL $$4, alr.b $$5, String $$6, alr.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static alr a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = arj.a($$0);
            URI $$2 = new URI(arj.i($$1, "apiServer"));
            String $$3 = arj.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arj.a($$1, "ruleId", 1);
               String $$5 = arj.a($$1, "serverId", "");
               String $$6 = arj.a($$1, "roomId", "Java:Chat");
               int $$7 = arj.a($$1, "hashesToDrop", -1);
               int $$8 = arj.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arj.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alr.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<ald> a(GameProfile $$0, String $$1, alr.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(ald.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arj.a($$4, "response", false);
            if ($$5) {
               return ald.a($$1);
            } else {
               String $$6 = arj.a($$4, "hashed", null);
               if ($$6 == null) {
                  return ald.b($$1);
               } else {
                  JsonArray $$7 = arj.v($$4, "hashes");
                  tl $$8 = this.a($$1, $$7, $$2);
                  return new ald($$1, $$8);
               }
            }
   ...
   private tl a(String $$0, JsonArray $$1, alr.a $$2) {
      if ($$1.isEmpty()) {
         return tl.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return tl.b;
      } else {
         tl $$3 = new tl($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alr.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public alq a(GameProfile $$0) {
      return new alr.d($$0);
   }
   ...
   public interface a {
      alr.a a = ($$0, $$1) -> false;
      alr.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alr.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alr.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements alq {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bfm<Runnable> $$1 = bfm.a(alr.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         alr.this.a(this.c, alr.this.g, alr.this.h, this.d);
      }

      @Override
      public void b() {
         alr.this.a(this.c, alr.this.i, alr.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<ald>> a(List<String> $$0) {
         List<CompletableFuture<ald>> $$1 = $$0.stream().map($$0x -> alr.this.a(this.c, $$0x, alr.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<ald> a(String $$0) {
         return alr.this.a(this.c, $$0, alr.this.l, this.d);
      }
   }
