...
public class alr {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new alm(alr.this.d()));
               sm.a($$1, vf.a, null);
               int $$2 = alr.this.e.m();
               sm $$3 = (sm)($$2 > 0 ? new sx($$2) : new sm(vf.a));
               alr.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new alt(alr.this.e, $$3));
            }
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<alr.a.a> d = Lists.newArrayList();
