...
public class alr extends avf<ah> {
   private static final Logger a = LogUtils.getLogger();
   private Map<ale, ai> b = Map.of();
   private an c = new an();
   ...
   protected void a(Map<ale, ah> $$0, avb $$1, bqj $$2) {
      Builder<ale, ai> $$3 = ImmutableMap.builder();
      $$0.forEach(($$1x, $$2x) -> {
         this.a($$1x, $$2x);
