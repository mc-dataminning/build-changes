...
public class aoq {
   ...
   private static int a(ew $$0, Collection<arr> $$1, Collection<dav<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xl.a("commands.recipe.give.success.single", $$2.size(), $$1.iterator().next().S_()), true);
         } else {
   ...
   private static int b(ew $$0, Collection<arr> $$1, Collection<dav<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xl.a("commands.recipe.take.success.single", $$2.size(), $$1.iterator().next().S_()), true);
         } else {
