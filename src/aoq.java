      ...
      try {
         try {
            while (this.a) {
               ...
               int $$2 = 0;
               int $$3 = aol.b(this.l, 0, $$1);
               if ($$3 != $$1 - 4) {
                  return;
               }

               $$2 += 4;
               int $$4 = aol.b(this.l, $$2, $$1);
               $$2 += 4;
               int $$5 = aol.a(this.l, $$2);
               $$2 += 4;
               switch ($$5) {
                  case 2:
                     if (this.j) {
                        String $$7 = aol.a(this.l, $$2, $$1);
