...
public class aoq {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xc.c("commands.random.error.range_too_large"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xc.c("commands.random.error.range_too_small"));
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)el.a("random").then(a("value", false))).then(a("roll", true)))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)el.a("reset").requires($$0x -> $$0x.c(2)))
                  ...
                  .then(
                     ((RequiredArgumentBuilder)el.a("sequence", fl.a()).suggests(aoq::a).executes($$0x -> a((ek)$$0x.getSource(), fl.a($$0x, "sequence"))))
                        .then(
                           ((RequiredArgumentBuilder)el.a("seed", IntegerArgumentType.integer())
      ...
      return (LiteralArgumentBuilder<ek>)el.a($$0)
         .then(
            ((RequiredArgumentBuilder)el.a("range", fi.a()).executes($$1x -> a((ek)$$1x.getSource(), fi.b.a($$1x, "range"), null, $$1)))
               .then(
                  ((RequiredArgumentBuilder)el.a("sequence", fl.a()).suggests(aoq::a).requires($$0x -> $$0x.c(2)))
   ...
   private static int a(ek $$0, cx.d $$1, @Nullable alk $$2, boolean $$3) throws CommandSyntaxException {
      azz $$4;
      if ($$2 != null) {
         $$4 = $$0.e().a($$2);
      } else {
      ...
      if ($$8 == 0L) {
         ...
         int $$9 = azq.b($$4, $$6, $$7);
         if ($$3) {
            $$0.l().ag().a(xc.a("commands.random.roll", $$0.b(), $$9, $$6, $$7), false);
         } else {
            $$0.a(() -> xc.a("commands.random.sample.success", $$9), false);
         }
   ...
   private static int a(ek $$0, alk $$1) throws CommandSyntaxException {
      $$0.e().N().b($$1);
      $$0.a(() -> xc.a("commands.random.reset.success", xc.a($$1)), false);
      return 1;
   }

   private static int a(ek $$0, alk $$1, int $$2, boolean $$3, boolean $$4) throws CommandSyntaxException {
      $$0.e().N().a($$1, $$2, $$3, $$4);
      $$0.a(() -> xc.a("commands.random.reset.success", xc.a($$1)), false);
      return 1;
   }
   ...
   private static int a(ek $$0) {
      int $$1 = $$0.e().N().a();
      $$0.a(() -> xc.a("commands.random.reset.all.success", $$1), false);
      return $$1;
   }
   ...
   private static int a(ek $$0, int $$1, boolean $$2, boolean $$3) {
      ...
      $$4.a($$1, $$2, $$3);
      int $$5 = $$4.a();
      $$0.a(() -> xc.a("commands.random.reset.all.success", $$5), false);
      return $$5;
   }
}
