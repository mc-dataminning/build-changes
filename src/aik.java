...
public class aik {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> tf.a("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> tf.a("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> tf.a("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(dr $$0, ehc $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bii> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         aik.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> tf.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static double a(Collection<? extends bii> $$0, akk $$1, aik.a[] $$2, int $$3, boolean $$4) {
      ...
      for (bii $$8 : $$0) {
         ...
         $$8.a($$1, (double)arp.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)arp.a($$10.b) + 0.5, Set.of(), $$8.dA(), $$8.dC());
   ...
   private static aik.a[] a(aru $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aik.a[] $$6 = new aik.a[$$1];
   ...
   static class a {
      ...
      public void a(aru $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = arp.a($$0, $$1, $$3);
         this.b = arp.a($$0, $$2, $$4);
      }
   }
