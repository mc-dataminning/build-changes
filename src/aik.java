...
public class aik {
   ...
   private static ctb a(MutableInt $$0, dje $$1, dwz $$2, ib<csy> $$3, Predicate<ib<csy>> $$4) {
      return ($$5, $$6, $$7, $$8) -> {
         int $$9 = in.c($$5);
         int $$10 = in.c($$6);
         int $$11 = in.c($$7);
         ib<csy> $$12 = $$1.getNoiseBiome($$5, $$6, $$7);
   ...
   private static int a(du $$0, ht $$1, ht $$2, ib.c<csy> $$3, Predicate<ib<csy>> $$4) throws CommandSyntaxException {
      ht $$5 = a($$1);
      ht $$6 = a($$2);
      dwz $$7 = dwz.a($$5, $$6);
      int $$8 = $$7.c() * $$7.d() * $$7.e();
