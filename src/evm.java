...
public record evm(aez c, float d, float e, evm.a f, String g) implements evj {
   private static final Codec<String> h = arj.a(Codec.STRING, Codec.STRING.listOf(), $$0 -> String.join("", $$0));
   public static final MapCodec<evm> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               aez.a.fieldOf("file").forGetter(evm::c),
   ...
   private ejm a(anw $$0) throws IOException {
      ...
      try {
         ...
         try (InputStream $$3 = $$0.open(this.c.d("font/"))) {
            ...
            var5 = new ejp($$2, $$1, this.d, this.e, this.f.c, this.f.d, this.g);
         }
