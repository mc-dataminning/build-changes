...
public class evm {
   ...
   public static final evm.a bv;

   public static evm.a a(int $$0, int $$1) {
      return $$0 == -1 ? evm.b.b.a($$1) : evm.b.a.a($$0);
   }

   public static evm.a a(String $$0) {
      if (evm.a.e.containsKey($$0)) {
         return evm.a.e.get($$0);
      } else {
         for (evm.b $$1 : evm.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final evm.b b;
      private final int c;
      private final axh<wi> d;
      static final Map<String, evm.a> e = Maps.newHashMap();

      a(String $$0, evm.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new axh<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wi.b($$2.toUpperCase(Locale.ROOT)) : wi.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wi.b($$2) : wi.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tj.a().b($$1) ? wi.c($$1) : wi.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<evm.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wi> g;

      private static void a(evm.b $$0, String $$1, int $$2) {
         evm.a $$3 = new evm.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, wi> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public evm.a a(int $$0) {
         return (evm.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
