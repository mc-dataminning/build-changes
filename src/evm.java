...
public class evm {
   ...
   public evm(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public evm(evr $$0, evr $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static evm a(eic $$0) {
      return new evm((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static evm a(evr $$0) {
      return new evm($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static evm a(iz $$0, iz $$1) {
      return new evm(
   ...
   public evm a(double $$0) {
      return new evm($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public evm b(double $$0) {
      return new evm(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public evm c(double $$0) {
      return new evm(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public evm d(double $$0) {
      return new evm(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public evm e(double $$0) {
      return new evm(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public evm f(double $$0) {
      return new evm(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public evm c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public evm d(double $$0, double $$1, double $$2) {
      return new evm(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public evm f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public evm h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<evr> b(evr $$0, evr $$1) {
   ...
   @Nullable
   public static evn a(Iterable<evm> $$0, evr $$1, evr $$2, iz $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new evn($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static je a(evm $$0, evr $$1, double[] $$2, @Nullable je $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public evr f() {
      return new evr(ayz.d(0.5, this.a, this.d), ayz.d(0.5, this.b, this.e), ayz.d(0.5, this.c, this.f));
   }

   public static evm a(evr $$0, double $$1, double $$2, double $$3) {
      return new evm($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
