...
class amr implements Path {
   private static final BasicFileAttributes a = new amp() {
      @Override
   ...
   private static final BasicFileAttributes b = new amp() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amr> c = Comparator.comparing(amr::n);
   ...
   public amr(amt $$0, String $$1, @Nullable amr $$2, amu $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amr a(@Nullable amr $$0, String $$1) {
      return new amr(this.e, $$1, $$0, amu.b);
   }
   ...
   amr a(String $$0) {
      if (a(this.i)) {
         return new amr(this.e, $$0, this, this.i);
      } else if (this.i instanceof amu.a $$1) {
         amr $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amr(this.e, $$0, this, amu.a);
      } else if (this.i instanceof amu.b) {
         return new amr(this.e, $$0, this, amu.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(amu $$0) {
      return $$0 == amu.a || $$0 == amu.b;
   }
   ...
   private amr c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amr $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof amu.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public amu.a i() {
      return this.i instanceof amu.a $$0 ? $$0 : null;
   }
