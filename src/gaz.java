...
public class gaz implements gbc.a {
   private final ezg a;
   private static final int b = awg.b.a(255, 0, 155, 155);
   private static final int c = awg.b.a(255, 255, 255, 0);
   ...
   public void a(etz $$0, fxq $$1, double $$2, double $$3, double $$4) {
      ...
      for (int $$19 = this.a.r.I_(); $$19 <= this.a.r.ak(); $$19 += 2) {
      ...
      for (int $$24 = this.a.r.I_(); $$24 <= this.a.r.ak(); $$24 += 16) {
