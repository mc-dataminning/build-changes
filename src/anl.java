...
public class anl {
   ...
   public static void a(Collection<String> $$0, ed $$1) {
      $$1.l().a($$0).exceptionally($$1x -> {
         a.warn("Failed to execute reload", $$1x);
         $$1.b(wu.c("commands.reload.failure"));
         return null;
      });
   }

   private static Collection<String> a(atc $$0, eoh $$1, Collection<String> $$2) {
      $$0.a();
   ...
   public static void a(CommandDispatcher<ed> $$0) {
      $$0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)ee.a("reload").requires($$0x -> $$0x.c(2))).executes($$0x -> {
