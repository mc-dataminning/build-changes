...
public class av extends dv<av.a> {
   ...
   public void a(arh $$0, dua $$1, cvl $$2, int $$3) {
      this.a($$0, $$3x -> $$3x.a($$1, $$2, $$3));
   }

   public static record a(Optional<bg> b, Optional<jn<dgv>> c, Optional<cs> d, dh.d e) implements dv.a {
      ...
      public static ao<av.a> a(dgv $$0, cs.a $$1, dh.d $$2) {
         return an.L.a(new av.a(Optional.empty(), Optional.of($$0.s()), Optional.of($$1.b()), $$2));
      }

      public boolean a(dua $$0, cvl $$1, int $$2) {
