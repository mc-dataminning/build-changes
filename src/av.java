...
public record av(Optional<avd<dac>> b, Optional<ip<dac>> c, Optional<db> d, Optional<co> e) {
   private static final Codec<ip<dac>> f = ki.e.r().listOf().xmap(ip::a, $$0 -> $$0.a().toList());
   ...
   public Optional<avd<dac>> a() {
      return this.b;
   }

   public Optional<ip<dac>> b() {
      return this.c;
   }
   ...
   public static class a {
      private Optional<ip<dac>> a = Optional.empty();
      private Optional<avd<dac>> b = Optional.empty();
      ...
      public av.a a(dac... $$0) {
         this.a = Optional.of(ip.a(dac::r, $$0));
         return this;
      }

      public av.a a(Collection<dac> $$0) {
         this.a = Optional.of(ip.a(dac::r, $$0));
         return this;
      }

      public av.a a(avd<dac> $$0) {
