...
public class av extends cv<av.a> {
   ...
   public void a(anf $$0, byc $$1, byc $$2, @Nullable blr $$3) {
      ehf $$4 = bp.b($$0, $$1);
      ehf $$5 = bp.b($$0, $$2);
      ehf $$6 = $$3 != null ? bp.b($$0, $$3) : null;
   ...
   public static record a(Optional<bb> b, Optional<bb> c, Optional<bb> d, Optional<bb> e) implements cv.a {
      public static final Codec<av.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atx.a(bp.b, "player").forGetter(av.a::a),
                  atx.a(bp.b, "parent").forGetter(av.a::c),
                  atx.a(bp.b, "partner").forGetter(av.a::d),
                  atx.a(bp.b, "child").forGetter(av.a::e)
               )
               .apply($$0, av.a::new)
      );
