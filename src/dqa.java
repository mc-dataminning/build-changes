...
public class dqa implements dqc {
   public static final Codec<dqa> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bgf.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bgf.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bgf.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bgd.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bgd.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dqa(int $$0, bgf $$1, bgf $$2, int $$3, int $$4, bgf $$5, bgd $$6, bgd $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
