...
public class dqa implements dpv {
   public static final Codec<dqa> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jd.f.q().fieldOf("block").flatXmap(dqa::a, DataResult::success).orElse((cxo)csr.fg).forGetter($$0x -> $$0x.b),
   ...
   public final hk<csq> h;
   private final ObjectArrayList<hc> i;

   private static DataResult<cxo> a(csq $$0) {
      return $$0 instanceof cxo $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public dqa(cxo $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, hk<csq> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<hc> a(arx $$0, hc $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<hc> a(arx $$0) {
