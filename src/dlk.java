...
public class dlk {
   ...
   private static final int j = hr.a(16);
   ...
   private final cpm p;
   private static final List<csk> q = List.of(csl.l, csl.L, csl.i, csl.b, csl.k, csl.I, csl.K, csl.fl, csl.dP, csl.iA, csl.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<hf<cqi>>> t;
   ...
   public static final Codec<dlk> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlk::a, Function.identity());

   private static DataResult<dlk> a(dlk $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlk(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<hf<cqi>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hy.c($$0);
      int $$5 = hy.c($$1) - $$4;
   ...
   @Nullable
   public static dlk a(akp $$0, int $$1, int $$2) {
      dgu $$3 = $$0.a($$1, $$2);
      dlk $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dgz.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hc> a(cqe $$0, int $$1, int $$2, boolean $$3) {
      Set<hc> $$4 = EnumSet.noneOf(hc.class);
   ...
   private void a(dgu $$0, Set<hc> $$1) {
      if (!this.r) {
         if ($$1.contains(hc.a) || $$1.contains(hc.g) || $$1.contains(hc.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(hc.c) && $$1.contains(hc.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(hc.c) && $$1.contains(hc.e) && $$1.contains(hc.d)) {
   ...
   private void a(int $$0, dgu $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, aro.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dgu $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dkh.a.a)) {
         $$3 = Math.min($$0.a(dkh.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }

      int $$5 = this.p.C_();
      gv.a $$6 = new gv.a($$1, $$3, $$2);
   ...
   private static double a(dgu $$0, gv.a $$1) {
      return a($$0, (gv)$$1.c(hb.a)) ? 1.0 : -1.0;
   }

   private static double b(dgu $$0, gv.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dgu $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      gv.a $$5 = new gv.a($$1, this.p.aj(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<hf<cqi>> b(dgu $$0, int $$1, int $$2) {
      ObjectArrayList<hf<cqi>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + hr.a(this.p.C_());
         $$3.set($$4, $$0.getNoiseBiome(hr.a($$1), $$5, hr.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dgu $$0, gv $$1) {
      dey $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(apj.O)) {
         ...
         return $$2.a(csl.eU) || $$2.a(csl.eV) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dlk.a $$3) {
      if ($$1 >= hr.a(this.p.C_()) && $$1 < hr.a(this.p.aj())) {
         int $$4 = $$1 - hr.a(this.p.C_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               hf<cqi> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dlk.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlk.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, hf<cqi> var3);
   }
