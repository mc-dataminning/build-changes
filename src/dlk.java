...
public class dlk {
   public static <T> List<dlk.b> a(List<T> $$0, Function<T, List<jj<erf>>> $$1, boolean $$2) {
      Object2IntMap<erf> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, erf c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jj<erf>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jf<erf> $$12 : $$10.get($$11)) {
               erf $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && azd.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<dlk.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<erf> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dlk.b($$28));
      }
   ...
   public static record b(List<erf> a, ToIntFunction<erf> b) {
      b(List<erf> $$0) {
         this($$0, ag.h($$0));
      }
   }
