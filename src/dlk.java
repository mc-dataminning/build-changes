...
public class dlk {
   private static final dfj a = csw.hj.n();
   private static final dfj b = csw.hk.n();
   private static final dfj c = csw.iA.n();
   private static final dfj d = csw.hn.n();
   private static final dfj e = csw.hv.n();
   private static final dfj f = csw.hx.n();
   private static final dfj g = csw.hr.n();
   private static final dfj h = csw.iC.n();
   private static final dfj i = csw.dP.n();
   private final dfj j;
   private final int k;
   private final dfj[] l;
   private final dzp m;
   ...
   public dlk(dlg $$0, dfj $$1, int $$2, dlf $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dlb.P);
      this.l = a($$3.a(new aex("clay_bands")));
      this.u = $$0.a(dlb.N);
      this.v = $$0.a(dlb.O);
      this.n = $$0.a(dlb.Q);
      this.o = $$0.a(dlb.R);
   ...
   public void a(dlg $$0, cqv $$1, ht<cqt> $$2, boolean $$3, dlp $$4, final dhf $$5, dkw $$6, dlj.o $$7) {
      ...
      dlj.g $$13 = new dlj.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dlj.u $$14 = $$7.apply($$13);
      gw.a $$15 = new gw.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dks.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            hg<cqt> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cra.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dks.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   private boolean a(dfj $$0) {
      return !$$0.i() && $$0.u().c();
   }

   @Deprecated
   public Optional<dfj> a(dlj.o $$0, dms $$1, Function<gw, hg<cqt>> $$2, dhf $$3, dkw $$4, gw $$5, boolean $$6) {
      dlj.g $$7 = new dlj.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(je.ap), $$1);
      dlj.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dfj $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dhc $$0, int $$1, int $$2, int $$3, cpx $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cqt $$1, dhc $$2, gw.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(csw.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(asc $$0, dfj[] $$1, int $$2, dfj $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dfj a(int $$0, int $$1, int $$2) {
