...
public record fbo(int i, int j, fbo.a k, fbo.b l, int m) {
   public static final int a = 32;
   private static final fbo[] n = new fbo[32];
   private static final List<fbo> o = new ArrayList<>(32);
   public static final fbo b = a(0, 0, fbo.a.a, fbo.b.a, 3);
   public static final fbo c = a(1, 0, fbo.a.b, fbo.b.c, 4);
   public static final fbo d = a(2, 0, fbo.a.a, fbo.b.d, 2);
   public static final fbo e = d;
   public static final fbo f = a(3, 1, fbo.a.e, fbo.b.d, 2);
   public static final fbo g = a(4, 2, fbo.a.e, fbo.b.d, 2);
   public static final fbo h = a(5, 0, fbo.a.c, fbo.b.b, 3);

   public fbo(int i, int j, fbo.a k, fbo.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fbo a(int $$0, int $$1, fbo.a $$2, fbo.b $$3, int $$4) {
      fbo $$5 = new fbo($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fbo.b $$1) {
      return $$0 == 0 || $$1 == fbo.b.d;
   }
   ...
   @Nullable
   public static fbo a(int $$0) {
      return n[$$0];
   }

   public static Stream<fbo> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fbo.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
