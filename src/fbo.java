...
public class fbo {
   ...
   public fbo(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fbp> $$1) throws IOException {
   ...
   public List<fbp> a(Path $$0) throws IOException {
      List<fbp> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fbp> a(Path $$0, boolean $$1) throws IOException {
      List<fbp> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fbp> $$1) throws IOException {
