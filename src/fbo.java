...
public class fbo extends fac<chl> {
   private static final afw x = new afw("container/stonecutter/scroller");
   private static final afw y = new afw("container/stonecutter/scroller_disabled");
   private static final afw z = new afw("container/stonecutter/recipe_selected");
   private static final afw A = new afw("container/stonecutter/recipe_highlighted");
   private static final afw B = new afw("container/stonecutter/recipe");
   private static final afw C = new afw("textures/gui/container/stonecutter.png");
   ...
   private void b(esy $$0, int $$1, int $$2, int $$3) {
      List<cno<cof>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.M = asy.a(this.M - $$5, 0.0F, 1.0F);
