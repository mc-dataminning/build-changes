...
public class fbo {
   ...
   private void a(n $$0, wg $$1) {
      this.b.l.d().a(wg.i().b(wg.c("debug.prefix").a($$0, n.r)).b(wf.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(wg.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.ct.d("gamemode spectator");
               } else {
                  this.b.s.ct.d("gamemode " + ((cyu)MoreObjects.firstNonNull(this.b.q.i(), cyu.b)).b());
               }
            ...
            case 81:
               ...
               fdq $$3 = this.b.l.d();
               $$3.a(wg.c("debug.reload_chunks.help"));
               $$3.a(wg.c("debug.show_hitboxes.help"));
               $$3.a(wg.c("debug.copy_location.help"));
               $$3.a(wg.c("debug.clear_chat.help"));
               $$3.a(wg.c("debug.chunk_boundaries.help"));
               $$3.a(wg.c("debug.advanced_tooltips.help"));
               $$3.a(wg.c("debug.inspect.help"));
               $$3.a(wg.c("debug.profiling.help"));
               $$3.a(wg.c("debug.creative_spectator.help"));
               $$3.a(wg.c("debug.pause_focus.help"));
               $$3.a(wg.c("debug.help.help"));
               $$3.a(wg.c("debug.dump_dynamic_textures.help"));
               $$3.a(wg.c("debug.reload_resourcepacks.help"));
               $$3.a(wg.c("debug.pause.help"));
               $$3.a(wg.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               wg $$6 = wg.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new we(we.a.b, $$5.toFile().toString())));
      ...
      if ($$2 != null) {
         switch ($$2.c()) {
            case b:
               ...
               if ($$0) {
                  if ($$1) {
                     this.b.s.ct.t().a($$3, $$2x -> {
                        this.a($$5, $$3, $$2x);
                        this.a("debug.inspect.server.block");
                     });
                  } else {
                     dmf $$6 = $$4.c_($$3);
                     tm $$7 = $$6 != null ? $$6.d($$4.H_()) : null;
                     this.a($$5, $$3, $$7);
   ...
   private void a(doz $$0, ib $$1, @Nullable tm $$2) {
   ...
   private void a(ajt $$0, esa $$1, @Nullable tm $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = ub.c((uj)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = evd.a(fbp.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!evd.a(fbp.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (evd.a(fbp.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fkh) || ((fkh)$$6).o <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               fca.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aY().a() && this.b.m.u().c()) {
            boolean $$9 = $$6 == null || !($$6.aI_() instanceof fdy $$7) || !$$7.d();
            if ($$3 != 0 && $$1 == 66 && fjo.r() && $$9) {
               boolean $$10 = this.b.m.as().c() == fbr.a;
               this.b.m.as().a(fbr.a(this.b.m.as().c().a() + 1));
               this.b.m.av();
               if ($$6 instanceof fjq) {
                  ((fjq)$$6).C();
               }
         ...
         label185: {
            ...
            label144:
            if (!$$13) {
               if (this.b.y instanceof fjj $$14 && !$$14.m()) {
                  break label144;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fjo.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fjo.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", axk.f((float)$$1 / 1000.0F));
            }
