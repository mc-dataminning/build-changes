...
public class fbo {
   ...
   public static fbr a(BooleanConsumer $$0, BanDetails $$1) {
      return new fbr($$0, a($$1), b($$1), "https://aka.ms/mcjavamoderation", ve.m, true);
   }

   public static fbr a(Runnable $$0) {
   ...
   public static fbr a(String $$0, Runnable $$1) {
