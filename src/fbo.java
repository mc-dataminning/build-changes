...
public class fbo extends fbw {
   static final agt c = new agt("textures/gui/title/mojangstudios.png");
   private static final int d = ati.b.a(255, 239, 50, 61);
   private static final int e = ati.b.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> euk.N().m.a().c() ? e : d;
   ...
   public fbo(euk $$0, apo $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(evw $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         int $$9 = aty.f((1.0F - aty.a($$7 - 1.0F, 0.0F, 1.0F)) * 255.0F);
         $$0.a(fsq.C(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         $$10 = 1.0F - aty.a($$7 - 1.0F, 0.0F, 1.0F);
      } else if (this.p) {
         if (this.m.y != null && $$8 < 1.0F) {
            this.m.y.a($$0, $$1, $$2, $$3);
         }

         int $$11 = aty.c(aty.a((double)$$8, 0.15, 1.0) * 255.0);
         $$0.a(fsq.C(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         $$10 = aty.a($$8, 0.0F, 1.0F);
      } else {
         int $$13 = f.getAsInt();
         ...
         GlStateManager._clear(16384, euk.a);
         $$10 = 1.0F;
      }
      ...
      float $$25 = this.n.b();
      this.q = aty.a(this.q * 0.95F + $$25 * 0.050000012F, 0.0F, 1.0F);
      if ($$7 < 1.0F) {
         this.a($$0, $$4 / 2 - $$23, $$24 - 5, $$4 / 2 + $$23, $$24 + 5, 1.0F - aty.a($$7, 0.0F, 1.0F));
      }
   ...
   private void a(evw $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      int $$6 = aty.f((float)($$3 - $$1 - 2) * this.q);
      int $$7 = Math.round($$5 * 255.0F);
      int $$8 = ati.b.a($$7, 255, 255, 255);
   ...
   static class a extends gdh {
      ...
      protected gdh.a b(aps $$0) {
         aoj $$1 = euk.N().aa();
         apk<InputStream> $$2 = $$1.a(aoh.a, fbo.c);
         if ($$2 == null) {
            return new gdh.a(new FileNotFoundException(fbo.c.toString()));
         } else {
            try {
               gdh.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gdh.a(new gfl(true, true), eoe.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gdh.a(var9);
            }
         }
      }
   }
