...
public abstract class goc<T extends cqt, S extends gwp> extends gpj<T, S> {
   private static final alj b = alj.b("textures/entity/minecart.png");
   protected final gad a;
   private final gkj h;

   public goc(gpk.a $$0, gcj $$1) {
      super($$0);
      this.f = 0.7F;
      this.a = new gad($$0.a($$1));
      this.h = $$0.d();
   }
   ...
   public void a(S $$0, fer $$1, gjg $$2, int $$3) {
      ...
      $$1.b(-1.0F, -1.0F, 1.0F);
      this.a.a($$0);
      fev $$11 = $$2.getBuffer(this.a.a(b));
      this.a.a($$1, $$11, $$3, gyv.d);
      $$1.b();
   }

   private static <S extends gwp> void a(S $$0, fer $$1) {
      $$1.a(a.d.rotationDegrees($$0.b));
      $$1.a(a.f.rotationDegrees(-$$0.a));
      $$1.a(0.0F, 0.375F, 0.0F);
   }

   private static <S extends gwp> void b(S $$0, fer $$1) {
      double $$2 = $$0.m;
      double $$3 = $$0.n;
      double $$4 = $$0.o;
      float $$5 = $$0.a;
   ...
   public void a(T $$0, S $$1, float $$2) {
      super.a($$0, $$1, $$2);
      if ($$0.j() instanceof cri $$3) {
         a($$0, $$3, $$1, $$2);
         $$1.i = true;
      } else if ($$0.j() instanceof crj $$4) {
         a($$0, $$4, $$1, $$2);
         $$1.i = false;
      }
      ...
      $$1.e = (float)$$0.L() - $$2;
      $$1.d = $$0.N();
      $$1.f = Math.max($$0.K() - $$2, 0.0F);
      $$1.g = $$0.x();
      $$1.h = $$0.s();
   }

   private static <T extends cqt, S extends gwp> void a(T $$0, cri $$1, S $$2, float $$3) {
      if ($$1.s()) {
         $$2.j = $$1.e($$3);
         $$2.a = $$1.c($$3);
         $$2.b = $$1.d($$3);
   ...
   private static <T extends cqt, S extends gwp> void a(T $$0, crj $$1, S $$2, float $$3) {
      float $$4 = 0.3F;
      $$2.a = $$0.j($$3);
      $$2.b = $$0.k($$3);
      double $$5 = $$2.m;
      ...
      if ($$8 != null) {
         $$2.k = $$8;
         ezy $$9 = $$1.a($$5, $$6, $$7, 0.3F);
         ezy $$10 = $$1.a($$5, $$6, $$7, -0.3F);
   ...
   protected void a(S $$0, dvv $$1, fer $$2, gjg $$3, int $$4) {
      this.h.a($$1, $$2, $$3, $$4, gyv.d);
   }

   protected ezt a(T $$0) {
      ezt $$1 = super.a($$0);
      return $$0.z() ? $$1.g((double)Math.abs($$0.x()) / 16.0) : $$1;
   }
