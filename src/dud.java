...
public class dud extends dtz {
   ...
   public dud(ji $$0, dwx $$1) {
      super(dub.O, $$0, $$1);
   }

   public boolean a(long $$0, ard $$1, cox $$2, jn $$3, cwp $$4) {
      if (this.m == null) {
         this.m = $$3;
      }
      ...
      if ($$0 < this.k) {
         ...
         if (++this.i >= 10) {
            ...
            if ($$5 != $$6) {
               dwx $$7 = this.m();
               dwx $$8 = $$7.b(dxn.by, Integer.valueOf($$6));
               $$1.a(this.aA_(), $$8, 3);
            }
   ...
   private void a(ard $$0, cox $$1, cwp $$2) {
      if (this.q != null) {
         evw $$3 = $$0.p().bc().b(this.q);
         if ($$1 instanceof are $$4) {
            ap.Q.a($$4, this.q);
         }

         evu $$5 = new evu.a($$0).a(eyl.f, fba.b(this.o)).a($$1.gF()).a(eyl.a, $$1).a(eyl.i, $$2).a(eyk.i);
         ObjectArrayList<cwp> $$6 = $$3.a($$5, this.r);

         this.l = switch ($$6.size()) {
            case 0 -> cwp.j;
            case 1 -> (cwp)$$6.getFirst();
            default -> {
               a.warn("Expected max 1 loot from loot table {}, but got {}", this.q.a(), $$6.size());
               yield (cwp)$$6.getFirst();
            }
         };
         this.q = null;
         this.e();
   ...
   private void b(ard $$0, cox $$1, cwp $$2) {
      this.c($$0, $$1, $$2);
      dwx $$3 = this.m();
      $$0.c(3008, this.aA_(), djm.j($$3));
      djm $$6;
      if (this.m().b() instanceof djs $$5) {
         $$6 = $$5.b();
      } else {
         $$6 = djo.a;
      }
   ...
   private void c(ard $$0, cox $$1, cwp $$2) {
      this.a($$0, $$1, $$2);
      if (!this.l.f()) {
         double $$3 = (double)bus.aq.l();
         double $$4 = 1.0 - $$3;
         double $$5 = $$3 / 2.0;
         jn $$6 = Objects.requireNonNullElse(this.m, jn.b);
         ji $$7 = this.o.a($$6, 1);
         double $$8 = (double)$$7.u() + 0.5 * $$4 + $$5;
         double $$9 = (double)$$7.v() + 0.5 + (double)(bus.aq.m() / 2.0F);
   ...
   public void a(ard $$0) {
      if (this.i != 0 && $$0.ad() >= this.j) {
         ...
         int $$2 = this.f();
         if ($$1 != $$2) {
            $$0.a(this.aA_(), this.m().b(dxn.by, Integer.valueOf($$2)), 3);
         }
