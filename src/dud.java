...
public class dud extends dtu implements bsv {
   ...
   private ka<cwq> l = ka.a(5, cwq.j);
   int m;
   private boolean[] q;
   private cwm r;
   int s;
   protected final csp f = new csp() {
      @Override
      public int a(int $$0) {
         return switch ($$0) {
            case 0 -> dud.this.m;
   ...
   public static void a(dgj $$0, ji $$1, dwy $$2, dud $$3) {
      cwq $$4 = $$3.l.get(4);
      if ($$3.s <= 0 && $$4.a(awy.X)) {
         $$3.s = 20;
         $$4.h(1);
      ...
      if (!Arrays.equals($$9, $$3.q)) {
         ...
         for (int $$11 = 0; $$11 < djs.b.length; $$11++) {
            $$10 = $$10.b(djs.b[$$11], Boolean.valueOf($$9[$$11]));
         }
   ...
   private static boolean a(cyo $$0, ka<cwq> $$1) {
      cwq $$2 = $$1.get(3);
      if ($$2.f()) {
         return false;
      } else if (!$$0.a($$2)) {
   ...
   private static void a(dgj $$0, ji $$1, ka<cwq> $$2) {
      cwq $$3 = $$2.get(3);
      cyo $$4 = $$0.L();
      ...
      if (!$$6.f()) {
         if ($$3.f()) {
            ...
            bsh.a($$0, (double)$$1.u(), (double)$$1.v(), (double)$$1.w(), $$6);
         }
      }
   ...
   public boolean b(int $$0, cwq $$1) {
      if ($$0 == 3) {
         cyo $$2 = this.n != null ? this.n.L() : cyo.b;
         return $$2.a($$1);
      } else {
         return $$0 == 4 ? $$1.a(awy.X) : ($$1.a(cwu.ti) || $$1.a(cwu.wo) || $$1.a(cwu.wr) || $$1.a(cwu.th)) && this.a($$0).f();
      }
   }
   ...
   public boolean b(int $$0, cwq $$1, jn $$2) {
      return $$0 == 3 ? $$1.a(cwu.th) : true;
   }

   @Override
   protected csd a(int $$0, cox $$1) {
      return new csk($$0, $$1, this, this.f);
   }
}
