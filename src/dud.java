...
public abstract class dud implements dbj, ddf.a, dup, duz {
   ...
   @Nullable
   protected dzc g;
   protected final Map<dxz.a, dxz> h = Maps.newEnumMap(dxz.a.class);
   protected enl i;
   private final Map<eiq, eiy> s = Maps.newHashMap();
   private final Map<eiq, LongSet> t = Maps.newHashMap();
   protected final Map<ja, tx> j = Maps.newHashMap();
   protected final Map<ja, dpn> k = new Object2ObjectOpenHashMap();
   protected final dcf l;
   protected final duo[] m;

   public dud(dbk $$0, dva $$1, dcf $$2, jw<ddd> $$3, long $$4, @Nullable duo[] $$5, @Nullable dzc $$6) {
      this.d = $$0;
      this.f = $$1;
      this.l = $$2;
      this.m = new duo[$$2.an()];
   ...
   private static void a(jw<ddd> $$0, duo[] $$1) {
   ...
   @Nullable
   public abstract dsh a(ja var1, dsh var2, boolean var3);

   public abstract void a(dpn var1);

   public abstract void a(bsd var1);
   ...
   public Collection<Entry<dxz.a, dxz>> e() {
   ...
   public dxz a(dxz.a $$0) {
      return this.h.computeIfAbsent($$0, $$0x -> new dxz(this, $$0x));
   }

   public boolean b(dxz.a $$0) {
   ...
   public int a(dxz.a $$0, int $$1, int $$2) {
      dxz $$3 = this.h.get($$0);
      if ($$3 == null) {
         if (aa.aX && this instanceof dun) {
            n.error("Unprimed heightmap: " + $$0 + " " + $$1 + " " + $$2);
         }

         dxz.a(this, EnumSet.of($$0));
         $$3 = this.h.get($$0);
      }
   ...
   @Override
   public final void a(BiConsumer<ja, dsh> $$0) {
      this.a($$0x -> $$0x.h() != 0, $$0);
   }
   ...
   public abstract ext<dff> o();

   public abstract ext<eoa> p();

   public abstract dud.a q();
   ...
   public dyd a(Function<dud, dyd> $$0) {
      if (this.e == null) {
         this.e = $$0.apply(this);
      }
   ...
   public static record a(exr<dff> a, exr<eoa> b) {
   }
}
