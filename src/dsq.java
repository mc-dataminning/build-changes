...
public class dsq {
   ...
   private final Map<Character, Predicate<dso>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsq a(char $$0, Predicate<dso> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dso>[][][] c() {
      this.d();
      Predicate<dso>[][][] $$0 = (Predicate<dso>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dso>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
