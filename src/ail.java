...
public class ail {
   ...
   private static final Object2IntMap<Class<? extends bof>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final bof d;
   private final Int2ObjectMap<ail.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> aii<T> a(Class<? extends bof> $$0, aij<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(aii<T> $$0, T $$1) {
      ail.a<T> $$2 = new ail.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(aii<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> ail.a<T> c(aii<T> $$0) {
      this.f.readLock().lock();

      ail.a<T> $$1;
      try {
         $$1 = (ail.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(aii<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(aii<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(aii<T> $$0, T $$1, boolean $$2) {
      ail.a<T> $$3 = this.c($$0);
   ...
   public void a(List<ail.b<?>> $$0) {
      this.f.writeLock().lock();

      try {
         for (ail.b<?> $$1 : $$0) {
            ail.a<?> $$2 = (ail.a<?>)this.e.get($$1.a);
            if ($$2 != null) {
               this.a($$2, $$1);
               this.d.a($$2.a());
            }
   ...
   private <T> void a(ail.a<T> $$0, ail.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public ail.b<T> e() {
         return ail.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, aij<T> b, T c) {

      public static <T> ail.b<T> a(aii<T> $$0, T $$1) {
         aij<T> $$2 = $$0.b();
         return new ail.b<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static ail.b<?> a(vd $$0, int $$1) {
         int $$2 = $$0.l();
         aij<?> $$3 = aik.a($$2);
         if ($$3 == null) {
      ...
      private static <T> ail.b<T> a(vd $$0, int $$1, aij<T> $$2) {
         return new ail.b<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
