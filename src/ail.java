...
public class ail {
   ...
   private static int a(ds $$0, Collection<? extends aqk<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> vd.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> vd.a("commands.banlist.list", $$1.size()), false);

         for (aqk<?> $$2 : $$1) {
            $$0.a(() -> vd.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
