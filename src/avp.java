...
public class avp extends ayb {
   public avp(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", ayz.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(ayz.z.typeName(), bah.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(ayz.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(ayz.z.typeName(), "minecraft:saddle"));
