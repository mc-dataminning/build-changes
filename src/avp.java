...
public class avp extends avo {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avp.a> s;
   private final avk t;
   private long u;
   private final als v;

   private avp(als $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avl.c($$2, 7, $$0.getLength());
      }
   }
