...
public abstract class avp<T> extends avy<T> {
   ...
   public avp(@Nullable T $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0);
   ...
   protected avp(@Nullable T $$0, JsonObject $$1) {
      super($$0);
