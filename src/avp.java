...
public class avp {
   ...
   public static final Codec<Object> b = a(awa.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(avx.e($$0));
   ...
   public static final Codec<avp.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aiy.b($$0.substring(1)).map($$0x -> new avp.f($$0x, true)) : aiy.b($$0).map($$0x -> new avp.f($$0x, false)), avp.f::c
      );
   ...
   public static <F, S> avp.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new avp.b<>($$0, $$1);
   }

   public static <K, V> avp.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new avp.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof avp.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
