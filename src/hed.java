...
public class hed implements heg.a, AutoCloseable {
   ...
   feu[] f;
   @Nullable
   private final hed.a g;
   private final aur h;

   public hed(aku $$0, hfx $$1, feu $$2, aur $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      hfv $$4 = $$3.a(hfv.a).orElse(hfv.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new feu[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hdy.a(this.f, $$0);
   ...
   @Nullable
   private hed.a a(hfx $$0, int $$1, int $$2, hfv $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<hed.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new hed.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new hed.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<hed.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            hed.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new hed.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, feu[] $$4) {
   ...
   class a {
      ...
      a(final List<hed.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hed.this.c;
         int $$4 = this.b($$2) * hed.this.d;
         hed.this.a($$0, $$1, $$3, $$4, hed.this.f);
      }

      public hef a() {
         return hed.this.new d(this, this.d ? hed.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final feu[] b = new feu[hed.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hed.this.c >> $$0;
            int $$2 = hed.this.d >> $$0;
            this.b[$$0] = new feu($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hed.d $$2) {
         hed.a $$3 = $$2.c;
         List<hed.b> $$4 = $$3.b;
         hed.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, axk.a($$6, $$14, $$15));
                  }
               }
            }

            hed.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hed.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hed.this.f[$$2].a($$3 + ($$0.a($$1) * hed.this.c >> $$2), $$4 + ($$0.b($$1) * hed.this.d >> $$2));
      }
   ...
   class d implements hef {
      int a;
      int b;
      final hed.a c;
      @Nullable
      private final hed.c d;

      d(final hed.a $$0, @Nullable final hed.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
