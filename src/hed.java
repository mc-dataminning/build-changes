...
public class hed {
   ...
   private static final Set<alj> k = Sets.newHashSet();
   ...
   private final fki n;
   private boolean o;
   private final fce p = new fce();
   private final fcf q = this.p.e();
   private final hec r;
   private final hee s = new hee();
   private final hdv t = new hdv(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hed.a> w = new AtomicReference<>(hed.a.c);
   private final Map<hdb, hdv.a> x = Maps.newHashMap();
   private final Multimap<awo, hdb> y = HashMultimap.create();
   private final List<hdc> z = Lists.newArrayList();
   private final Map<hdb, Integer> A = Maps.newHashMap();
   private final Map<hdb, Integer> B = Maps.newHashMap();
   private final List<hef> C = Lists.newArrayList();
   private final List<hdc> D = Lists.newArrayList();
   private final List<hcy> E = Lists.newArrayList();

   public hed(heg $$0, fki $$1, avg $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hec($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fcd::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hed.a.c, hed.a.a)) {
               String $$2 = this.n.av().c();
               ae.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hed.a.a, hed.a.b);
                     }
                  ...
                  this.w.compareAndSet(hed.a.a, hed.a.c);
               });
            }
         }

         return this.w.compareAndSet(hed.a.b, hed.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hdb::s).forEach(this::c);
      this.D.clear();
      ...
      for (hdc $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            ezy $$3 = new ezy($$0.h(), $$0.i(), $$0.j());
            hdv.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hdb, hdv.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hdb, hdv.a> $$6 = $$5.next();
         hdv.a $$7 = $$6.getValue();
         hdb $$8 = $$6.getKey();
      ...
      Iterator<Entry<hdb, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hdb, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hdb $$13 = $$12.getKey();
            if ($$13 instanceof hdc) {
               ((hdc)$$13).q();
            }
   ...
   private static boolean d(hdb $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hdb $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hdb $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hdb $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != heg.e) {
                  if ($$3 == heg.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        ezy $$11 = new ezy($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hdb.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hdv.a> $$16 = this.t.a($$3.g() ? fce.c.b : fce.c.a);
                           hdv.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hdb $$0) {
      return azm.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hdb $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fcd::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fcd::e));
      }
   }
   ...
   public void a(fjn $$0) {
      if (this.o && $$0.h()) {
         fcg $$1 = new fcg($$0.b(), new ezy($$0.l()), new ezy($$0.m()));
