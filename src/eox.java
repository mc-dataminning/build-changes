...
public class eox extends ehu {
   ...
   private void a(tc $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         if ($$2.b("NameTagVisibility", 8)) {
            eoy.b $$8 = eoy.b.a($$2.l("NameTagVisibility"));
            if ($$8 != null) {
               $$4.a($$8);
            }
         }
         ...
         if ($$2.b("DeathMessageVisibility", 8)) {
            eoy.b $$9 = eoy.b.a($$2.l("DeathMessageVisibility"));
            if ($$9 != null) {
               $$4.b($$9);
            }
         }
         ...
         if ($$2.b("CollisionRule", 8)) {
            eoy.a $$10 = eoy.a.a($$2.l("CollisionRule"));
            if ($$10 != null) {
               $$4.a($$10);
            }
         }
   ...
   private void b(tc $$0) {
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         ...
         eoz $$4 = eoz.a($$3).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$3, eoz.b.d());
            return eoz.b;
         });
         String $$5 = $$2.l("Name");
         vq $$6 = vq.a.a($$2.l("DisplayName"));
         eoz.a $$7 = eoz.a.a($$2.l("RenderType"));
