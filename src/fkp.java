...
public class fkp extends fkq {
   ...
   public fkp(BooleanConsumer $$0, String $$1, boolean $$2) {
      this($$0, c($$2), wx.b($$1), $$1, $$2 ? ww.e : ww.g, $$2);
   }

   public fkp(BooleanConsumer $$0, wx $$1, String $$2, boolean $$3) {
      this($$0, $$1, a($$3, $$2), $$2, $$3 ? ww.e : ww.g, $$3);
   }

   public fkp(BooleanConsumer $$0, wx $$1, wx $$2, String $$3, wx $$4, boolean $$5) {
      super($$0, $$1, $$2);
   ...
   protected void a(int $$0) {
      this.c(ffz.a(this.a, $$0x -> this.c.accept(true)).a(this.n / 2 - 50 - 105, $$0, 100, 20).a());
      this.c(ffz.a(d, $$0x -> {
         this.l();
         this.c.accept(false);
      }).a(this.n / 2 - 50, $$0, 100, 20).a());
      this.c(ffz.a(this.b, $$0x -> this.c.accept(false)).a(this.n / 2 - 50 + 105, $$0, 100, 20).a());
   }
   ...
   public static void a(fly $$0, String $$1) {
      fdz $$2 = fdz.Q();
      $$2.a(new fkp($$3 -> {
         if ($$3) {
            ac.k().a($$1);
   ...
   public static ffz.c b(fly $$0, String $$1) {
      return $$2 -> a($$0, $$1);
   }
}
