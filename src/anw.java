      ...
      while (this.d.v()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)axh.a),
               String.format(Locale.ROOT, "%.2f", this.d.aQ().g() / (float)axh.c)
            );
            ...
            for (ThreadInfo $$7 : $$4) {
               if ($$7.getThreadId() == this.d.ay().getId()) {
            ...
            $$10.a("Random tick rate", () -> this.d.ba().o().a(cvn.o).toString());
            $$10.a("Level stats", () -> Streams.stream(this.d.J()).map($$0x -> $$0x.ad() + ": " + $$0x.F()).collect(Collectors.joining(",\n")));
            aja.a("Crash report:\n" + $$8.e());
            File $$11 = new File(new File(this.d.A(), "crash-reports"), "crash-" + ac.e() + "-server.txt");
            if ($$8.a($$11)) {
