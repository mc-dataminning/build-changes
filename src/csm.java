...
public class csm extends cse {
   ...
   public void g() {
      if (this.h() instanceof ash $$0) {
         this.a.bf();
         jh var11 = this.a.p();
         dxv $$3 = this.h().a_(var11);
         boolean $$4 = dkb.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(dko.hx)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dql.f));
            }
         } else {
            this.a.e($$0);
         }
   ...
   public void a(ash $$0) {
      ...
      $$10 = new fby($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bvk $$20 = this.a.da();
      fby $$22;
      ...
      $$10 = this.j();
      this.a.a(bwk.a, new fby(bae.a($$36 * $$10.d, -$$37, $$37), 0.0, bae.a($$36 * $$10.f, -$$37, $$37)));
      ...
      fby $$38 = this.d(this.a.dB(), this.a.dD(), this.a.dH());
      if ($$38 != null && $$6 != null) {
   ...
   @Nullable
   public fby a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = bae.a($$0);
      int $$5 = bae.a($$1);
      int $$6 = bae.a($$2);
   ...
   public fby d(double $$0, double $$1, double $$2) {
      ...
      dxv $$6 = this.h().a_(new jh($$3, $$4, $$5));
      if (dkb.h($$6)) {
         dyy $$7 = $$6.c(((dkb)$$6.b()).c());
         Pair<kl, kl> $$8 = crw.a($$7);
         kl $$9 = (kl)$$8.getFirst();
   ...
   @Override
   public boolean i() {
      fbt $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.D() && this.j().j() >= 0.01) {
         ...
         for (bvk $$3 : this.h().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bI() && $$3 instanceof crw) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public fby c(fby $$0) {
      return new fby(bae.a($$0.d, -0.4, 0.4), $$0.e, bae.a($$0.f, -0.4, 0.4));
   }
