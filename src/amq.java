...
class amq implements Path {
   private static final BasicFileAttributes a = new amo() {
      @Override
   ...
   private static final BasicFileAttributes b = new amo() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amq> c = Comparator.comparing(amq::n);
   ...
   public amq(ams $$0, String $$1, @Nullable amq $$2, amt $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amq a(@Nullable amq $$0, String $$1) {
      return new amq(this.e, $$1, $$0, amt.b);
   }
   ...
   amq a(String $$0) {
      if (a(this.i)) {
         return new amq(this.e, $$0, this, this.i);
      } else if (this.i instanceof amt.a $$1) {
         amq $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amq(this.e, $$0, this, amt.a);
      } else if (this.i instanceof amt.b) {
         return new amq(this.e, $$0, this, amt.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(amt $$0) {
      return $$0 == amt.a || $$0 == amt.b;
   }
   ...
   private amq c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amq $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof amt.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public amt.a i() {
      return this.i instanceof amt.a $$0 ? $$0 : null;
   }
