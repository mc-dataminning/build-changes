...
public class amq {
                           ...
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)eq.a("damageType", fo.a($$1, lq.s))
                                    .executes(
                                       $$0x -> a(
                                             ...
                                             new bri(fo.a($$0x, "damageType", lq.s))
                                          )
                                    ))
                                 .then(
                                    eq.a("at")
                                          ...
                                          eq.a("location", gs.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      fc.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bri(fo.a($$0x, "damageType", lq.s), gs.a($$0x, "location"))
                                                   )
                                             )
                                       )
                                 ))
                                       ...
                                       ((RequiredArgumentBuilder)eq.a("entity", fc.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      fc.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bri(fo.a($$0x, "damageType", lq.s), fc.a($$0x, "entity"))
                                                   )
                                             ))
                                          .then(
                                             eq.a("from")
                                                   ...
                                                   eq.a("cause", fc.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               fc.a($$0x, "target"),
                                                               FloatArgumentType.getFloat($$0x, "amount"),
                                                               new bri(fo.a($$0x, "damageType", lq.s), fc.a($$0x, "entity"), fc.a($$0x, "cause"))
                                                            )
                                                      )
                                                )
                                          )
   ...
   private static int a(ep $$0, bsp $$1, float $$2, bri $$3) throws CommandSyntaxException {
      if ($$1.a($$3, $$2)) {
         $$0.a(() -> xl.a("commands.damage.success", $$2, $$1.O_()), true);
         return 1;
      } else {
         throw a.create();
      }
