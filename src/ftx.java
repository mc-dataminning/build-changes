...
public abstract class ftx extends fqa implements fpi {
   private static final Logger a = LogUtils.getLogger();
   private static final xv b = xv.c("narrator.screen.usage");
   protected static final gkv e = new gkv(alz.b("textures/gui/title/background/panorama"));
   protected static final gln f = new gln(e);
   ...
   private final List<fqc> d = Lists.newArrayList();
   private final List<fsa> s = Lists.newArrayList();
   @Nullable
   protected fmf m;
   private boolean u;
   public int n;
   public int o;
   private final List<fpi> v = Lists.newArrayList();
   protected fnp p;
   ...
   public final void c(fnr $$0, int $$1, int $$2, float $$3) {
      this.a($$0, $$1, $$2, $$3);
      if (this.F != null) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if ($$0 == 256 && this.aH_()) {
         ...
         fsi $$3 = (fsi)(switch ($$0) {
            case 258 -> this.l();
            default -> null;
            case 262 -> this.a(fsk.d);
            case 263 -> this.a(fsk.c);
            case 264 -> this.a(fsk.b);
            case 265 -> this.a(fsk.a);
         });
         if ($$3 != null) {
            fno $$4 = super.a($$3);
            if ($$4 == null && $$3 instanceof fsi.c) {
               this.n();
               $$4 = super.a($$3);
            }
   ...
   private fsi.a a(fsk $$0) {
      return new fsi.a($$0);
   }

   protected void aG_() {
      if (this.m.aY().b()) {
         fsi.c $$0 = new fsi.c(true);
         fno $$1 = super.a($$0);
         if ($$1 != null) {
            this.a($$1);
         }
   ...
   protected void b(fqc $$0) {
      fno $$1 = fno.a(this, $$0.a(new fsi.b()));
      if ($$1 != null) {
         this.a($$1);
      }
   }
   ...
   protected <T extends fpi> T a(T $$0) {
      this.v.add($$0);
      return $$0;
   }
   ...
   public static List<xv> a(fmf $$0, cxo $$1) {
   ...
   public final void b(fmf $$0, int $$1, int $$2) {
      this.m = $$0;
      this.p = $$0.h;
      this.n = $$1;
      this.o = $$2;
   ...
   protected void a(fnr $$0, int $$1, int $$2, int $$3, int $$4) {
      a($$0, this.m.s == null ? g : c, $$1, $$2, 0.0F, 0.0F, $$3, $$4);
   }

   public static void a(fnr $$0, alz $$1, int $$2, int $$3, float $$4, float $$5, int $$6, int $$7) {
      int $$8 = 32;
      $$0.a(glu::C, $$1, $$2, $$3, $$4, $$5, $$6, $$7, 32, 32);
   }
   ...
   public static boolean r() {
      return fmf.a ? ffm.a(fmf.Q().aO().h(), 343) || ffm.a(fmf.Q().aO().h(), 347) : ffm.a(fmf.Q().aO().h(), 341) || ffm.a(fmf.Q().aO().h(), 345);
   }

   public static boolean s() {
      return ffm.a(fmf.Q().aO().h(), 340) || ffm.a(fmf.Q().aO().h(), 344);
   }

   public static boolean t() {
      return ffm.a(fmf.Q().aO().h(), 342) || ffm.a(fmf.Q().aO().h(), 346);
   }
   ...
   protected void b(fsc $$0) {
      List<fsa> $$1 = this.s.stream().filter(fsa::C).sorted(Comparator.comparingInt(fpp::I)).toList();
      ftx.b $$2 = a($$1, this.E);
      if ($$2 != null) {
         if ($$2.c.a()) {
            this.E = $$2.a;
         ...
         if ($$1.size() > 1) {
            $$0.a(fsb.b, xv.a("narrator.position.screen", $$2.b + 1, $$1.size()));
            if ($$2.c == fsa.a.c) {
               $$0.a(fsb.d, this.z());
            }
         }
   ...
   @Nullable
   public static ftx.b a(List<? extends fsa> $$0, @Nullable fsa $$1) {
      ftx.b $$2 = null;
      ftx.b $$3 = null;
      int $$4 = 0;
      ...
      for (int $$5 = $$0.size(); $$4 < $$5; $$4++) {
         ...
         if ($$7.a()) {
            if ($$6 != $$1) {
               return new ftx.b($$6, $$4, $$7);
            }

            $$3 = new ftx.b($$6, $$4, $$7);
         } else if ($$7.compareTo($$2 != null ? $$2.c : fsa.a.a) > 0) {
            $$2 = new ftx.b($$6, $$4, $$7);
         }
      }
   ...
   public void a(List<azq> $$0, fwi $$1, boolean $$2) {
      if (this.F == null || $$2) {
         this.F = new ftx.a($$0, $$1);
      }
   }

   public void d(xv $$0) {
      this.b(fpq.a(this.m, $$0));
   }

   public void a(fpq $$0, fwi $$1, boolean $$2) {
   ...
   @Override
   public fsm H() {
      return new fsm(0, 0, this.n, this.o);
   }
   ...
   static record a(List<azq> a, fwi b) {
   }

   public static class b {
      public final fsa a;
      public final int b;
      public final fsa.a c;

      public b(fsa $$0, int $$1, fsa.a $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
