...
public class ftx {
   ...
   public final Map<ic, fty> c;
   public final ftz d;
   public final boolean e;

   public ftx(Vector3f $$0, Vector3f $$1, Map<ic, fty> $$2, @Nullable ftz $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ic, fty> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<ftx> {
      ...
      public ftx a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         ftz $$6 = this.a($$3);
         Map<ic, fty> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !aty.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = aty.a($$3, "shade", true);
            return new ftx($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private ftz a(JsonObject $$0) {
         ftz $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = aty.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ic.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = aty.a($$2, "rescale", false);
            $$1 = new ftz($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = aty.m($$0, "angle");
         if ($$1 != 0.0F && aui.e($$1) != 22.5F && aui.e($$1) != 45.0F) {
      ...
      private Map<ic, fty> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fty> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ic, fty> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fty> $$2 = Maps.newEnumMap(ic.class);
         JsonObject $$3 = aty.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ic $$5 = this.a($$4.getKey());
            $$2.put($$5, (fty)$$0.deserialize($$4.getValue(), fty.class));
         }
