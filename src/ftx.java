...
public class ftx {
   ...
   public ftx(fwf $$0, cto $$1, int $$2, fte $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      fwf.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected fwf.b a(hx $$0) {
      int $$1 = aun.a($$0.v() - this.b.J_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = aun.b(aun.a($$0.u(), 16), this.d);
         int $$3 = aun.b(aun.a($$0.w(), 16), this.e);
