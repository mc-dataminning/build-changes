...
public class dvy extends dvs<dxx> {
   private static final ih[] a = ih.values();

   public dvy(Codec<dxx> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dvu<dxx> $$0) {
      dxx $$1 = $$0.f();
      axd $$2 = $$0.d();
      ib $$3 = $$0.e();
      cxw $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dtn $$9 = new dtn(new dsp($$4.C()));
      ehs $$10 = ehs.a($$9, -4, 1.0);
      ...
      for (ib $$44 : $$31) {
         ...
         for (ih $$46 : a) {
            ...
            dnb $$48 = $$4.a_($$47);
            if ($$45.b(dnr.C)) {
               $$45 = $$45.a(dnr.C, Boolean.valueOf($$48.u().b()));
            }
