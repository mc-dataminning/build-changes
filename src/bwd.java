...
public class bwd extends bwq implements bjr, bjw {
   ...
   public static final aee<Boolean> bY = aeh.a(bwd.class, aeg.k);
   public static final aee<Long> bZ = aeh.a(bwd.class, aeg.c);
   ...
   public void l() {
      ...
      if (this.cE > 0) {
         this.cE--;
         if (this.cE == 0) {
            this.dL().a(null, this.dl(), apd.cS, ape.g, 1.0F, 1.0F);
         }
      }
   ...
   protected void b(gw $$0, dfj $$1) {
      if ($$1.a(aps.bo)) {
         this.a(apd.da, 1.0F, 1.0F);
      } else {
         this.a(apd.cZ, 1.0F, 1.0F);
      }
   }
   ...
   private double a(boolean $$0, float $$1, bir $$2, float $$3) {
      ...
      if ($$8) {
         ...
         float $$15 = arw.a((float)this.gr() + $$1, 0.0F, (float)$$10);
         boolean $$16 = $$15 < (float)$$11;
         float $$17 = $$16 ? $$15 / (float)$$11 : ($$15 - (float)$$11) / (float)($$10 - $$11);
         float $$18 = $$5 - $$12 * $$6;
         $$4 += $$9 ? (double)arw.i($$17, $$16 ? $$5 : $$18, $$16 ? $$18 : $$7) : (double)arw.i($$17, $$16 ? $$7 - $$5 : $$7 - $$18, $$16 ? $$7 - $$18 : 0.0F);
      }
   ...
   private void a(biq $$0, float $$1) {
      float $$2 = $$0.co();
      float $$3 = arw.g(this.aU - $$2);
      float $$4 = arw.a(arw.g(this.aU - $$2), -$$1, $$1);
      float $$5 = $$2 + $$3 - $$4;
      $$0.n($$5);
   }
