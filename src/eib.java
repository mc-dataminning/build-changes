...
public class eib extends eie<eia> {
   public eib(Codec<eia> $$0) {
      super($$0);
   }

   public boolean a(eia $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(ehz $$0, eia $$1, ebw $$2, Function<iu, je<djy>> $$3, azv $$4, efk $$5, dic $$6, ebv $$7) {
      int $$8 = jx.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eie.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      ehz $$0, eia $$1, ebw $$2, Function<iu, je<djy>> $$3, efk $$4, double $$5, double $$6, double $$7, float $$8, double $$9, ebv $$10, eie.a $$11
   ) {
      double $$12 = 1.5 + (double)(azm.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(azm.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = azm.b($$13);
         $$6 += (double)(azm.b($$12) * $$27);
         $$7 += (double)azm.a($$13);
         $$8 += (double)(azm.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
