...
public abstract class eib<M extends ehy<M>> {
   private final cxi i;
   protected final dpj a;
   ...
   protected final Long2ObjectMap<dpb> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eib(cxi $$0, dpj $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dpb a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dpb a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dpb c(long $$0) {
      dpb $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dpb g(long $$0) {
      dpb $$1 = (dpb)this.g.get($$0);
      return $$1 != null ? $$1 : new dpb();
   }
   ...
   protected void a(eie<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dpb>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dpb> $$6 = (Entry<dpb>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dpb $$8 = (dpb)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dpb $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = je.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eib.a.a($$9, eib.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eib.b k(long $$0) {
      return eib.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eib.b c(byte $$0) {
         if ($$0 == 0) {
            return eib.b.a;
         } else {
            return a($$0) ? eib.b.c : eib.b.b;
         }
      }
   }
