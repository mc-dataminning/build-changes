...
@Deprecated
public class dvj extends duu<dvj.a> {
   private static final dme a = czh.nc.o();

   public dvj(Codec<dvj.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(duw<dvj.a> $$0) {
      ib $$1 = $$0.e();
      cwz $$2 = $$0.b();
      awt $$3 = $$0.d();
      dvj.a $$4 = $$0.f();
   ...
   public static record a(dyz b, dyz c) implements dwy {
      public static final Codec<dvj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dyz.a.fieldOf("fluid").forGetter(dvj.a::a), dyz.a.fieldOf("barrier").forGetter(dvj.a::b)).apply($$0, dvj.a::new)
      );
