...
public class dvj {
   private static final doz a = dca.hj.n();
   private static final doz b = dca.hk.n();
   private static final doz c = dca.iA.n();
   private static final doz d = dca.hn.n();
   private static final doz e = dca.hv.n();
   private static final doz f = dca.hx.n();
   private static final doz g = dca.hr.n();
   private static final doz h = dca.iC.n();
   private static final doz i = dca.dP.n();
   private final doz j;
   private final int k;
   private final doz[] l;
   private final ejv m;
   ...
   public dvj(dvf $$0, doz $$1, int $$2, dve $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dva.P);
      this.l = a($$3.a(new ajt("clay_bands")));
      this.u = $$0.a(dva.N);
      this.v = $$0.a(dva.O);
      this.n = $$0.a(dva.Q);
      this.o = $$0.a(dva.R);
   ...
   public void a(dvf $$0, czy $$1, iy<czw> $$2, boolean $$3, dvo $$4, final dqv $$5, duv $$6, dvi.o $$7) {
      ...
      dvi.g $$13 = new dvi.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dvi.u $$14 = $$7.apply($$13);
      ib.a $$15 = new ib.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dur.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            il<czw> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dad.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dur.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<doz> a(dvi.o $$0, dwr $$1, Function<ib, il<czw>> $$2, dqv $$3, duv $$4, ib $$5, boolean $$6) {
      dvi.g $$7 = new dvi.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(ks.av), $$1);
      dvi.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      doz $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dqs $$0, int $$1, int $$2, int $$3, cyz $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, czw $$1, dqs $$2, ib.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dca.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(axr $$0, doz[] $$1, int $$2, doz $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected doz a(int $$0, int $$1, int $$2) {
