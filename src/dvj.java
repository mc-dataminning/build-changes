...
public class dvj implements dvf, AutoCloseable {
   ...
   private final dvo d;
   private final Map<dbh, dvj.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvj(dvq $$0, Path $$1, boolean $$2) {
      this.d = new dvo($$0, $$1, $$2);
      this.c = new bpp<>(new bpr.a(dvj.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }
   ...
   public CompletableFuture<Void> a(dbh $$0, @Nullable us $$1) {
      return this.a(() -> {
         dvj.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvj.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dbh $$0, vm $$1) {
      return this.a(() -> {
         try {
            dvj.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bpr.b(dvj.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dbh, dvj.a>> $$0 = this.e.entrySet().iterator();
         Entry<dbh, dvj.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bpr.b(dvj.b.b.ordinal(), this::a));
   }

   private void a(dbh $$0, dvj.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bpr.b(dvj.b.c.ordinal(), () -> $$0.a(bac.a))).join();
         this.c.close();
