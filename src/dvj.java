...
public class dvj {
   ...
   private dvr<jm<ddw>> i;

   public dvj(dvq<dtc> $$0, dvr<jm<ddw>> $$1) {
      this.h = $$0;
      this.i = $$1;
      this.g();
   }
   ...
   public dvj(jz<ddw> $$0) {
      this.h = new dvq<>(dfy.q, dga.a.o(), dvq.d.d);
      this.i = new dvq<>($$0.u(), $$0.g(ded.b), dvq.d.e);
   }
   ...
   public jm<ddw> c(int $$0, int $$1, int $$2) {
      return this.i.a($$0, $$1, $$2);
   }

   public void a(ddz $$0, def.f $$1, int $$2, int $$3, int $$4) {
      dvq<jm<ddw>> $$5 = this.i.e();
      int $$6 = 4;
