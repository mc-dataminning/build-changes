...
public class bki {
   ...
   private static void a(bkq $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bkl $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dpa, bku<bkk>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bku)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dpa, bku<bkk>> $$3 : $$0) {
         bku<bkk> $$4 = (bku<bkk>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dpa)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bks> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bjx.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bkg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bki::a));
      $$1.add("chunksWritten", this.a($$0.m(), bki::a));
      return $$1;
   }

   private JsonElement a(bkn.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bkg $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bki::a));
      $$1.add("received", this.a($$0.k(), bki::a));
      return $$1;
   }

   private <T> JsonElement a(bkp<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bkm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bkm>, ToDoubleFunction<bkm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bkm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bkm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bkm::c));
      return $$1;
   }
}
