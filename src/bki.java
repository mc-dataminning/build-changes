...
public class bki implements Comparable<bki> {
   ...
   @Nullable
   private bki q;
   private final Optional<bki.a> r;

   public bki(bkg $$0) {
      this($$0, 0, 0);
   }

   public bki(bkg $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bki(bkg $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bki(bkg $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bki(bkg $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public bki(bkg $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bki $$6, Optional<bki.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bll $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bki $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(sd $$0) {
      ...
      this.r.ifPresent($$1x -> bki.a.a.encodeStart(sr.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static bki b(sd $$0) {
      String $$1 = $$0.l("id");
      bkg $$2 = kc.e.a(agm.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static bki a(bkg $$0, sd $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = bki.a.a.parse(new Dynamic(sr.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bki($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bki.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  asy.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  asy.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bki $$0) {
         ...
         float $$2 = atq.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = atq.i($$2, this.c, this.d);
      }

      public float a(bll $$0, float $$1) {
         if ($$0.dI()) {
            this.g = this.e;
         }

         return atq.i($$1, this.g, this.e);
      }
   }
}
