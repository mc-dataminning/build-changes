...
public class bjx extends bhp {
   ...
   public bjx(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bit.s, "minecraft:trial_spawner");
   }

   public Dynamic<?> a(Dynamic<uu> $$0) {
      Optional<Dynamic<uu>> $$1 = $$0.get("normal_config").result();
      if ($$1.isEmpty()) {
         return $$0;
      } else {
         Optional<Dynamic<uu>> $$2 = $$0.get("ominous_config").result();
         if ($$2.isEmpty()) {
            return $$0;
         } else {
            ale $$3 = bjx.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(ul.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<uu>, Dynamic<uu>>, ale> a = new HashMap<>();
      ...
      private static Dynamic<uu> a(tx $$0) {
         return new Dynamic(ul.a, $$0);
      }

      private static tx a(String $$0) {
         try {
            return uv.a($$0);
