...
public class bjx extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Either<?, Pair<?, Pair<?, Pair<?, Dynamic<?>>>>>>> $$0 = this.getInputSchema().getType(biz.z);
                        ...
                        $$0xxxx -> $$0xxxx.mapSecond(
                              $$0xxxxx -> $$0xxxxx.mapSecond(
                                    $$0xxxxxx -> $$0xxxxxx.mapSecond(
                                          $$0xxxxxxx -> $$0xxxxxxx.update("bold", bjx::a)
                                                .update("italic", bjx::a)
                                                .update("underlined", bjx::a)
                                                .update("strikethrough", bjx::a)
                                                .update("obfuscated", bjx::a)
                                       )
                                 )
                           )
                     )
