...
public class ejo extends ejr {
   public static final int a = 854;
   public static final int b = 480;
   static final ejo.b l = new ejo.b(854, 480);

   public ejo(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ejo.a[] e = values();
   ...
   static class b {
      ...
      static List<ejo.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ejo.b($$0, $$1), ejo.l) : ImmutableList.of(ejo.l);
      }
