...
public class ejo extends ejt {
   public static final MapCodec<ejo> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, ejo::new));
   ...
   public List<eib.a> a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, jh $$4, ehl $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ejo.a> $$13 = Lists.newArrayList();
      $$13.add(new ejo.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jh $$21 = $$4.b(azk.a($$19), $$12 - 1, azk.a($$20));
               jh $$22 = $$21.b(5);
      ...
      List<eib.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, jh $$3, jh $$4, boolean $$5, ehl $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jh $$13 = $$3.b(azk.d(0.5F + (float)$$12 * $$9), azk.d(0.5F + (float)$$12 * $$10), azk.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(doq.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, jh $$4, List<ejo.a> $$5, ehl $$6) {
      for (ejo.a $$7 : $$5) {
         int $$8 = $$7.a();
