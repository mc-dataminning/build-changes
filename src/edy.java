...
public class edy implements edi {
   public static final Codec<edy> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ehu.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               awk.b(lr.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               efj.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               efj.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dzg.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, edy::new)
   );
   ...
   public edy(jj<ehu> $$0, int $$1, int $$2, awk<dff> $$3, efj $$4, int $$5, int $$6, int $$7, int $$8, efj $$9, int $$10, int $$11, dzg $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
