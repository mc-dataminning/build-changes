...
public abstract class edy<M extends edv<M>> {
   private final ctr i;
   ...
   protected final Long2ObjectMap<dlc> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected edy(ctr $$0, dlk $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dlc a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dlc a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dlc c(long $$0) {
      dlc $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = iz.e($$0);
      dlc $$2 = this.a($$1, true);
      return $$2.a(iz.b(hx.a($$0)), iz.b(hx.b($$0)), iz.b(hx.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(iz.b(hx.a($$0)), iz.b(hx.b($$0)), iz.b(hx.c($$0)), $$1);
      iz.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(iz.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected dlc g(long $$0) {
      dlc $$1 = (dlc)this.g.get($$0);
      return $$1 != null ? $$1 : new dlc();
   }
   ...
   protected void a(eeb<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dlc $$2 = (dlc)this.g.remove($$1);
            dlc $$3 = this.d.d($$1);
            if (this.k.contains(iz.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dlc>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dlc> $$6 = (Entry<dlc>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dlc $$8 = (dlc)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dlc $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = iz.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, edy.a.a($$9, edy.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public edy.b k(long $$0) {
      return edy.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static edy.b c(byte $$0) {
         if ($$0 == 0) {
            return edy.b.a;
         } else {
            return a($$0) ? edy.b.c : edy.b.b;
         }
      }
   }
