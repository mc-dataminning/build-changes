...
public class gok implements asq<goj> {
   public goj b(JsonObject $$0) {
      Builder<goi> $$1 = ImmutableList.builder();
      int $$2 = axp.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = axp.a($$0, "width", -1);
      int $$9 = axp.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = axp.a($$0, "interpolate", false);
      return new goj($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private goi a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new goi(axp.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = axp.m($$1, "frames[" + $$0 + "]");
         int $$3 = axp.a($$2, "time", -1);
         if ($$2.has("time")) {
