...
public class asa {
   ...
   private static List<asa.b> a(final Path $$0) throws IOException {
      try {
         final List<asa.b> $$1 = new ArrayList<>();
   ...
   private static List<asa.a> a(List<asa.b> $$0) {
      List<asa.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (asa.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new asa.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<asa.a> a = Comparator.comparing(asa.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<asa.b> a = Comparator.comparing(asa.b::b).reversed();
