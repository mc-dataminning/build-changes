...
public class asa extends aru {
   ...
   private final asa.b d;
   private final String e;

   asa(asc $$0, asa.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(asf $$0, akh $$1) {
   ...
   @Nullable
   private atj<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : atj.create($$1, $$2);
      }
   }
   ...
   public static class a implements asz.c {
      ...
      @Override
      public asd a(asc $$0) {
         asa.b $$1 = new asa.b(this.a);
         return new asa($$0, $$1, "");
      }

      @Override
      public asd a(asc $$0, asz.a $$1) {
         asa.b $$2 = new asa.b(this.a);
         asd $$3 = new asa($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<asd> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  asa.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
