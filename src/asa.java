...
public abstract class asa implements asj {
   ...
   public <T> T a(asw<T> $$0) throws IOException {
      atp<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asw<T> $$0, InputStream $$1) {
      JsonObject $$3;
