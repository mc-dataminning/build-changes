...
public class sw {
   ...
   public sw(tq $$0, dmk $$1, aqt $$2, tj $$3) {
      this.a = $$0;
      this.d = $$2;
      this.o = $$3;
      this.f = $$0.f();
   ...
   public void l() {
      if (this.s == null) {
         this.F();
         ewr $$0 = this.d();
         List<bsq> $$1 = this.f().a(bsq.class, $$0.g(1.0), $$0x -> !($$0x instanceof cmv));
         $$1.forEach($$0x -> $$0x.a(bsq.c.b));
      }
   }
   ...
   public sw n() {
      ...
      this.b = this.t.az_();
      tm.a(this.b, new jd(1, 0, -1), this.t(), this.d);
