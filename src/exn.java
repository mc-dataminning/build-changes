...
public class exn {
   ...
   public exn(evh $$0) {
      ...
      this.g = new exn.a();
      this.h = $$0.h;
      this.v = new eyv(this.h, this.r);
      this.w = new eyx(this.h, this.s, () -> $$0.r.s().g());
      this.x = new eyw(this.h, this.t);
      this.y = new eyu(this.h, this.u);
   }
   ...
   protected void c(ewt $$0) {
      List<String> $$1 = this.c();
      this.a($$0, $$1, false);
   }

   private void a(ewt $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eot.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", evh.O().aM().k(), evh.O().aM().l(), eot.a()),
            eot.c(),
            eot.d()
         }
      );
