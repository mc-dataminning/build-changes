...
public class exn {
   ...
   public static final exn.a bv;

   public static exn.a a(int $$0, int $$1) {
      return $$0 == -1 ? exn.b.b.a($$1) : exn.b.a.a($$0);
   }

   public static exn.a a(String $$0) {
      if (exn.a.e.containsKey($$0)) {
         return exn.a.e.get($$0);
      } else {
         for (exn.b $$1 : exn.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final exn.b b;
      private final int c;
      private final axy<wx> d;
      static final Map<String, exn.a> e = Maps.newHashMap();

      a(String $$0, exn.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<exn.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wx> g;

      private static void a(exn.b $$0, String $$1, int $$2) {
         exn.a $$3 = new exn.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public exn.a a(int $$0) {
         return (exn.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
