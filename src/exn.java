...
public class exn extends exc {
   ...
   private final akt<evu> b;
   private final long c;
   private final jr<dtz<?>> d;

   private exn(List<eyy> $$0, akt<evu> $$1, long $$2, jr<dtz<?>> $$3) {
      super($$0);
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public cwn a(cwn $$0, evp $$1) {
      if ($$0.f()) {
         ...
         $$0.b(kv.ap, new czn(this.b, this.c));
         return $$0;
      }
   }
   ...
   public static exc.a<?> a(dtz<?> $$0, akt<evu> $$1) {
      return a($$2 -> new exn($$2, $$1, 0L, $$0.a()));
   }

   public static exc.a<?> a(dtz<?> $$0, akt<evu> $$1, long $$2) {
      return a($$3 -> new exn($$3, $$1, $$2, $$0.a()));
   }
}
