...
public class ewi {
   ...
   public static final ewi.a bv;

   public static ewi.a a(int $$0, int $$1) {
      return $$0 == -1 ? ewi.b.b.a($$1) : ewi.b.a.a($$0);
   }

   public static ewi.a a(String $$0) {
      if (ewi.a.e.containsKey($$0)) {
         return ewi.a.e.get($$0);
      } else {
         for (ewi.b $$1 : ewi.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final int c;
      private final axr<ws> d;
      static final Map<String, ewi.a> e = Maps.newHashMap();

      a(String $$0, ewi.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new axr<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? ws.b($$2.toUpperCase(Locale.ROOT)) : ws.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? ws.b($$2) : ws.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tt.a().b($$1) ? ws.c($$1) : ws.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ewi.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, ws> g;

      private static void a(ewi.b $$0, String $$1, int $$2) {
         ewi.a $$3 = new ewi.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, ws> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ewi.a a(int $$0) {
         return (ewi.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
