...
public abstract class ewi {
   ...
   public evk a() {
      if (this.c()) {
         ...
         return new evk(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
      }
   }

   public ewi b() {
      return this.c() ? ewf.a() : ewf.a(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
   }
   ...
   public abstract DoubleList a(je.a var1);

   public boolean c() {
      return this.a.a();
   }

   public ewi a(double $$0, double $$1, double $$2) {
      return (ewi)(this.c() ? ewf.a() : new evr(this.a, new ewe(this.a(je.a.a), $$0), new ewe(this.a(je.a.b), $$1), new ewe(this.a(je.a.c), $$2)));
   }

   public ewi d() {
      ewi[] $$0 = new ewi[]{ewf.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewf.b($$0[0], ewf.a($$1, $$2, $$3, $$4, $$5, $$6), evt.o));
      return $$0[0];
   }

   public void a(ewf.a $$0) {
      this.a
         .a(
   ...
   public List<evk> e() {
      List<evk> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new evk($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(je.a $$0, double $$1) {
      return ayx.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public evl a(evp $$0, evp $$1, iz $$2) {
      if (this.c()) {
         return null;
      } else {
         evp $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(je.a.a, $$4.c - (double)$$2.u()), this.a(je.a.b, $$4.d - (double)$$2.v()), this.a(je.a.c, $$4.e - (double)$$2.w()))
               ? new evl($$4, je.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : evk.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<evp> a(evp $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         evp[] $$1 = new evp[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = ayx.a($$0.a(), $$2, $$5);
            double $$9 = ayx.a($$0.b(), $$3, $$6);
            double $$10 = ayx.a($$0.c(), $$4, $$7);
   ...
   public ewi a(je $$0) {
      if (!this.c() && this != ewf.b()) {
         if (this.b != null) {
            ewi $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewi b(je $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewg(this, $$1, $$4);
      }
   }

   public double a(je.a $$0, evk $$1, double $$2) {
      return this.a(iw.a($$0, je.a.a), $$1, $$2);
   }

   protected double a(iw $$0, evk $$1, double $$2) {
      if (this.c()) {
         return $$2;
