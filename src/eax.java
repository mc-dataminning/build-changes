...
public class eax {
   ...
   static class a implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         return $$0.c[ia.f.d()] && !$$0.b[ia.f.d()].d;
      }

      @Override
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         $$1.d = true;
         $$1.b[ia.f.d()].d = true;
         return new eax.k($$0, $$1);
      }
   }

   static class b implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         if ($$0.c[ia.f.d()] && !$$0.b[ia.f.d()].d && $$0.c[ia.b.d()] && !$$0.b[ia.b.d()].d) {
            eax.v $$1 = $$0.b[ia.f.d()];
            return $$1.c[ia.b.d()] && !$$1.b[ia.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         ...
         $$1.b[ia.f.d()].d = true;
         $$1.b[ia.b.d()].d = true;
         $$1.b[ia.f.d()].b[ia.b.d()].d = true;
         return new eax.l($$0, $$1);
      }
   }

   static class c implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         return $$0.c[ia.b.d()] && !$$0.b[ia.b.d()].d;
      }
      ...
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         $$1.d = true;
         $$1.b[ia.b.d()].d = true;
         return new eax.m($$0, $$1);
      }
   }

   static class d implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         if ($$0.c[ia.c.d()] && !$$0.b[ia.c.d()].d && $$0.c[ia.b.d()] && !$$0.b[ia.b.d()].d) {
            eax.v $$1 = $$0.b[ia.c.d()];
            return $$1.c[ia.b.d()] && !$$1.b[ia.b.d()].d;
         } else {
            return false;
      ...
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         ...
         $$1.b[ia.c.d()].d = true;
         $$1.b[ia.b.d()].d = true;
         $$1.b[ia.c.d()].b[ia.b.d()].d = true;
         return new eax.n($$0, $$1);
      }
   }

   static class e implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         return $$0.c[ia.c.d()] && !$$0.b[ia.c.d()].d;
      }

      @Override
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         eax.v $$3 = $$1;
         if (!$$1.c[ia.c.d()] || $$1.b[ia.c.d()].d) {
            $$3 = $$1.b[ia.d.d()];
         }

         $$3.d = true;
         $$3.b[ia.c.d()].d = true;
         return new eax.o($$0, $$3);
      }
   }

   static class f implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         return true;
      }
      ...
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         $$1.d = true;
         return new eax.s($$0, $$1, $$2);
      }
   }

   static class g implements eax.i {
      @Override
      public boolean a(eax.v $$0) {
         return !$$0.c[ia.e.d()] && !$$0.c[ia.f.d()] && !$$0.c[ia.c.d()] && !$$0.c[ia.d.d()] && !$$0.c[ia.b.d()];
      }

      @Override
      public eax.r a(ia $$0, eax.v $$1, auf $$2) {
         $$1.d = true;
         return new eax.t($$0, $$1);
      }
   }

   public static class h extends eax.r {
      ...
      private eax.v G;
      private eax.v H;
      private final List<eax.r> I = Lists.newArrayList();

      public h(auf $$0, int $$1, int $$2, ia $$3) {
         super(dzf.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eax.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eax.p($$3, this.G));
         this.I.add(new eax.j($$3, this.H));
         List<eax.i> $$5 = Lists.newArrayList();
         $$5.add(new eax.b());
         $$5.add(new eax.d());
         $$5.add(new eax.e());
         $$5.add(new eax.a());
         ...
         dyg $$10 = dyg.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dyg $$11 = dyg.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dyg $$12 = dyg.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eax.u($$3, $$10, $$13++));
         this.I.add(new eax.u($$3, $$11, $$13++));
         this.I.add(new eax.q($$3, $$12));
      }
      ...
      private List<eax.v> b(auf $$0) {
         eax.v[] $$1 = new eax.v[75];
         ...
         eax.v $$23 = new eax.v(1003);
         eax.v $$24 = new eax.v(1001);
         eax.v $$25 = new eax.v(1002);
         $$1[v].a(ia.b, $$23);
         $$1[w].a(ia.d, $$24);
         $$1[x].a(ia.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ia.f.d()].d = true;
         this.H.b[ia.c.d()].d = true;
         this.H.b[ia.f.d()].b[ia.c.d()].d = true;
         this.H.b[ia.b.d()].d = true;
         this.H.b[ia.f.d()].b[ia.b.d()].d = true;
         this.H.b[ia.c.d()].b[ia.b.d()].d = true;
         this.H.b[ia.f.d()].b[ia.c.d()].b[ia.b.d()].d = true;
         ObjectArrayList<eax.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, ctt $$2, auf $$3, dyg $$4) {
         int $$5 = 24;
      ...
      private void a(ctt $$0, auf $$1, dyg $$2) {
      ...
      private void b(ctt $$0, auf $$1, dyg $$2) {
      ...
      private void c(ctt $$0, auf $$1, dyg $$2) {
      ...
      private void d(ctt $$0, auf $$1, dyg $$2) {
      ...
      private void e(ctt $$0, auf $$1, dyg $$2) {
      ...
      private void f(ctt $$0, auf $$1, dyg $$2) {
   ...
   interface i {
      boolean a(eax.v var1);

      eax.r a(ia var1, eax.v var2, auf var3);
   }

   public static class j extends eax.r {
      public j(ia $$0, eax.v $$1) {
         super(dzf.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(ctt $$0, ctr $$1, dkm $$2, auf $$3, dyg $$4, csf $$5, hv $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cwb.ch.o(), cwb.ch.o(), false);
   ...
   public static class k extends eax.r {
      public k(ia $$0, eax.v $$1) {
         super(dzf.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(ctt $$0, ctr $$1, dkm $$2, auf $$3, dyg $$4, csf $$5, hv $$6) {
         eax.v $$7 = this.B.b[ia.f.d()];
         eax.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ia.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ia.a.d()]);
         }
   ...
   public static class l extends eax.r {
      public l(ia $$0, eax.v $$1) {
         super(dzf.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eax.r {
      public m(ia $$0, eax.v $$1) {
         super(dzf.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(ctt $$0, ctr $$1, dkm $$2, auf $$3, dyg $$4, csf $$5, hv $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ia.a.d()]);
         }

         eax.v $$7 = this.B.b[ia.b.d()];
         if ($$7.b[ia.b.d()] == null) {
   ...
   public static class n extends eax.r {
      public n(ia $$0, eax.v $$1) {
         super(dzf.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(ctt $$0, ctr $$1, dkm $$2, auf $$3, dyg $$4, csf $$5, hv $$6) {
         eax.v $$7 = this.B.b[ia.c.d()];
         eax.v $$8 = this.B;
         eax.v $$9 = $$7.b[ia.b.d()];
         eax.v $$10 = $$8.b[ia.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ia.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ia.a.d()]);
         }
   ...
   public static class o extends eax.r {
      public o(ia $$0, eax.v $$1) {
         super(dzf.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eax.r {
      public p(ia $$0, eax.v $$1) {
         super(dzf.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eax.r {
      public q(ia $$0, dyg $$1) {
         super(dzf.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dys {
      protected static final dip b = cwb.hZ.o();
      protected static final dip c = cwb.ia.o();
      protected static final dip d = cwb.ib.o();
      protected static final dip h = c;
      protected static final dip i = cwb.ii.o();
      protected static final boolean j = true;
      protected static final dip k = cwb.G.o();
      protected static final Set<cvz> l = ImmutableSet.builder().add(cwb.dO).add(cwb.iC).add(cwb.mW).add(k.b()).build();
      ...
      public r(dzf $$0, ia $$1, int $$2, dyg $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dzf $$0, int $$1, ia $$2, eax.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dyg a(ia $$0, eax.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dyg $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(ctt $$0, dyg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dip $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(ctt $$0, dyg $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(ctt $$0, dyg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dip $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dyg $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(ctt $$0, dyg $$1, int $$2, int $$3, int $$4) {
         hv $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cbo $$6 = blj.B.a((csy)$$0.D());
            if ($$6 != null) {
               $$6.b($$6.eM());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), blz.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eax.r {
      private int a;

      public s(ia $$0, eax.v $$1, auf $$2) {
         super(dzf.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(ctt $$0, ctr $$1, dkm $$2, auf $$3, dyg $$4, csf $$5, hv $$6) {
         ...
         if (this.B.b[ia.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ia.a.d()] && !this.B.c[ia.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eax.r {
      public t(ia $$0, eax.v $$1) {
         super(dzf.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eax.r {
      private int a;

      public u(ia $$0, dyg $$1, int $$2) {
         super(dzf.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
