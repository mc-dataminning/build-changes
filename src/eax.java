...
public class eax<T> implements eaz<T> {
   ...
   private eax(jx<T> $$0, int $$1, eba<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private eax(jx<T> $$0, T[] $$1, eba<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public eaz<T> a(eba<T> $$0) {
      return new eax<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
