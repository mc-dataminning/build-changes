...
public class eax extends ebe<edp> {
   private static final dsq a = dsq.a(dfh.I);
   private final dsh b = dfh.I.o();
   private final dsh c = dfh.jF.o();
   private final dsh d = dfh.aV.o();
   private final dsh an = dfh.G.o();

   public eax(Codec<edp> $$0) {
      super($$0);
   }
   ...
   private static void b(dcz $$0, ja $$1) {
      $$0.a($$1, dfh.J.o(), 3);
      $$0.a($$1, dpp.N).ifPresent($$1x -> $$1x.a(eqk.bd, $$1.a()));
   }
}
