...
public class eax implements ebx<bva> {
   ...
   public eax(ebi $$0, ard $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = new bro($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<ebs<bva>> a(dgg $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               List<bva> $$6 = bvi.a($$5, this.d, bvh.r).collect(ImmutableList.toImmutableList());
               return new ebs<>($$0, $$6);
            }
         }, this.g::a_);
      }
   ...
   private static dgg a(tq $$0) {
      int[] $$1 = $$0.n("Position");
      return new dgg($$1[0], $$1[1]);
   }

   private static void a(tq $$0, dgg $$1) {
      $$0.a("Position", new tu(new int[]{$$1.h, $$1.i}));
   }

   private static ebs<bva> b(dgg $$0) {
      return new ebs<>($$0, ImmutableList.of());
   }

   @Override
   public void a(ebs<bva> $$0) {
      dgg $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
