...
public class eax implements azk {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eax> b = eaw.a.xmap($$0 -> new eax($$0), $$0 -> $$0.e);
   private eaw e;
   private final dzy f = new dzy(this);

   public eax(long $$0) {
      this.e = new eaw(eal.c($$0));
   }
   ...
   @Override
   public azk d() {
      return new eax(this.e.a(), this.e.a());
   }

   @Override
   public eaj e() {
      return new eax.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements eaj {
      ...
      public azk a(int $$0, int $$1, int $$2) {
         long $$3 = azc.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eax($$4, this.b);
      }

      @Override
      public azk a(String $$0) {
         eal.a $$1 = eal.a($$0);
         return new eax($$1.a(this.a, this.b));
      }

      @Override
      public azk a(long $$0) {
         return new eax($$0 ^ this.a, $$0 ^ this.b);
      }
