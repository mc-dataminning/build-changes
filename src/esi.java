...
public class esi extends esl {
   public static final int a = 854;
   public static final int b = 480;
   static final esi.b l = new esi.b(854, 480);

   public esi(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final esi.a[] e = values();
   ...
   static class b {
      ...
      static List<esi.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new esi.b($$0, $$1), esi.l) : ImmutableList.of(esi.l);
      }
