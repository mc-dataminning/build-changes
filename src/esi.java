...
public class esi extends exe {
   ...
   public esi(int $$0, int $$1, int $$2, int $$3, int $$4, exe.c $$5) {
   ...
   public void a(erg $$0) {
      this.A = new esi.b($$0, this.z);
      this.a(this.A, $$0.o);
   }

   private void a(esi.b $$0, String $$1) {
      vf $$2 = switch ($$0.c) {
         case c -> v;
         case b -> $$0.b ? w : x;
         default -> null;
   ...
   static esi.a a(erg $$0, boolean $$1, boolean $$2) {
      if ($$1 && !$$0.j && $$0.e != erg.c.c) {
         return esi.a.c;
      } else {
         return $$1 || $$2 && $$0.j ? esi.a.a : esi.a.b;
      }
   }
   ...
   public void b(ews $$0, int $$1, int $$2, float $$3) {
      if (this.A != null) {
         ...
         ahg $$7;
         if (this.A.b) {
            $$7 = etv.a(String.valueOf(this.A.h), this.A.i);
         } else if (this.A.a) {
            $$7 = a;
         ...
         $$0.a($$15, eqk.a(this.A.f, this.A.g.a()), $$4 + 40, $$5 + 80 + 2, -1);
      }
   }
   ...
   public static class b {
      ...
      public final esi.a c;

      public b(erg $$0, int $$1) {
         this.b = $$1 == 4;
         if (this.b) {
            this.d = $$0.m == erg.d.b;
            this.e = esi.y.getString();
            this.h = (long)$$0.p;
            this.i = $$0.q;
            this.a = $$0.p == -1;
            this.f = "";
