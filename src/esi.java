...
public class esi implements Comparable<esi> {
   ...
   public esi(ddw $$0, esj $$1, String $$2, boolean $$3, boolean $$4, boolean $$5, Path $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.f = $$4;
   ...
   public xr k() {
      return azz.b(this.c.c()) ? xd.c("selectWorld.versionUnknown") : xd.b(this.c.c());
   }
   ...
   public static class b extends esi {
   ...
   public static class c extends esi {
