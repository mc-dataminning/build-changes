...
public abstract class esi implements etn, euf, evw, ewb {
   ...
   private void a() {
      if (this.n != null) {
         boolean $$0 = this.h || this.aC_() && eqp.O().aU().b();
         if ($$0 != this.q) {
            if ($$0) {
               this.p = ac.b();
            }
   ...
   protected faw j() {
      return (faw)(!this.h && this.aC_() && eqp.O().aU().b() ? new fas(this) : new fay(this));
   }
   ...
   protected abstract void b(erz var1, int var2, int var3, float var4);

   protected static void a(erz $$0, erx $$1, tl $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(erz $$0, erx $$1, tl $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = asb.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = asb.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(erz $$0, erx $$1, int $$2, int $$3) {
      int $$4 = this.r() + $$2;
   ...
   public erw a(ewj $$0) {
      if (!this.i || !this.j) {
         ...
         return !this.aC_() ? erw.a(this) : null;
      }
   }
   ...
   protected void c(ewd $$0) {
      ...
      if (this.i) {
         if (this.aC_()) {
            $$0.a(ewc.d, tl.c("narration.button.usage.focused"));
         } else {
