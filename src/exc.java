...
public class exc extends gpb {
   ...
   private static final fct w = new fct(new ajh("widget/cross_button"), new ajh("widget/cross_button_highlighted"));
   ...
   protected void aO_() {
      ...
      if (this.L) {
         this.M = this.c(
            fbg.a(vu.c("mco.selectServer.trial"), ffw.b(this, "https://aka.ms/startjavarealmstrial")).a(this.I() - 10 - 99, this.J() - 10 - 4 - 40, 99, 20).a()
         );
      }

      this.c(fbg.a(vu.c("mco.selectServer.buy"), ffw.b(this, "https://aka.ms/BuyJavaRealms")).a(this.I() - 10 - 99, this.J() - 10 - 20, 99, 20).a());
      fbs $$0 = this.c(new fbs(this.E() + 4, this.H() + 4, 14, 14, w, $$0x -> this.d(), b));
      $$0.a(fcr.a(b));
      int $$1 = 142 - (this.L ? 40 : 20);
      fbq $$2 = new fbq(this.I() - 10 - 100, this.H() + 10, 100, $$1, a, this.i);
      if ($$2.j()) {
         $$2.k(100 - $$2.f());
      }
   ...
   public static void a(fat $$0, fbg $$1) {
      int $$2 = 8;
      $$0.c().a();
