...
public abstract class exc<M extends ewz<M>> {
   private final dkg i;
   protected final edo a;
   ...
   protected final Long2ObjectMap<edg> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected exc(dkg $$0, edo $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected edg a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected edg a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected edg c(long $$0) {
      edg $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected edg g(long $$0) {
      edg $$1 = (edg)this.g.get($$0);
      return $$1 != null ? $$1 : new edg();
   }
   ...
   protected void a(exf<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<edg>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<edg> $$6 = (Entry<edg>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               edg $$8 = (edg)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable edg $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jy.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, exc.a.a($$9, exc.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public exc.b l(long $$0) {
      return exc.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static exc.b c(byte $$0) {
         if ($$0 == 0) {
            return exc.b.a;
         } else {
            return a($$0) ? exc.b.c : exc.b.b;
         }
      }
   }
