...
public abstract class exc implements eyh, eyz, faq, fav {
   ...
   public exc(int $$0, int $$1, int $$2, int $$3, vf $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(ews $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(ews var1, int var2, int var3, float var4);

   protected static void a(ews $$0, ewq $$1, vf $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(ews $$0, ewq $$1, vf $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(ews $$0, ewq $$1, int $$2, int $$3) {
      int $$4 = this.B() + $$2;
   ...
   public ewp a(fbd $$0) {
      if (!this.j || !this.k) {
         ...
         return !this.aI_() ? ewp.a(this) : null;
      }
   }
   ...
   public fav.a s() {
      if (this.aI_()) {
         ...
         return this.i ? fav.a.b : fav.a.a;
      }
   }

   @Override
   public final void b(fax $$0) {
      this.a($$0);
      if (this.n != null) {
         this.n.b($$0);
      }
   ...
   protected abstract void a(fax var1);

   protected void c(fax $$0) {
      $$0.a(faw.a, this.aK_());
      if (this.j) {
         if (this.aI_()) {
            $$0.a(faw.d, vf.c("narration.button.usage.focused"));
         } else {
            $$0.a(faw.d, vf.c("narration.button.usage.hovered"));
         }
      }
   }
