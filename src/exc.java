...
public class exc implements jw {
   public static final Codec<exc> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> ad.a($$0, 3).map($$0x -> new exc((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final exc b = new exc(0.0, 0.0, 0.0);
   public final double c;
   public final double d;
   public final double e;

   public static exc a(int $$0) {
   ...
   public static exc a(kh $$0) {
      return new exc((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static exc a(kh $$0, double $$1, double $$2, double $$3) {
      return new exc((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static exc b(kh $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static exc c(kh $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static exc a(kh $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public exc(double $$0, double $$1, double $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }

   public exc(Vector3f $$0) {
      this((double)$$0.x(), (double)$$0.y(), (double)$$0.z());
   }

   public exc a(exc $$0) {
      return new exc($$0.c - this.c, $$0.d - this.d, $$0.e - this.e);
   }

   public exc d() {
      double $$0 = Math.sqrt(this.c * this.c + this.d * this.d + this.e * this.e);
      return $$0 < 1.0E-4 ? b : new exc(this.c / $$0, this.d / $$0, this.e / $$0);
   }

   public double b(exc $$0) {
      return this.c * $$0.c + this.d * $$0.d + this.e * $$0.e;
   }

   public exc c(exc $$0) {
      return new exc(this.d * $$0.e - this.e * $$0.d, this.e * $$0.c - this.c * $$0.e, this.c * $$0.d - this.d * $$0.c);
   }
   ...
   public exc a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }
   ...
   public exc b(double $$0, double $$1, double $$2) {
      return new exc(this.c + $$0, this.d + $$1, this.e + $$2);
   }
   ...
   public boolean a(exc $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.c;
      double $$4 = $$0.b() - this.d;
      double $$5 = $$0.c() - this.e;
   ...
   public exc d(double $$0, double $$1, double $$2) {
      return new exc(this.c * $$0, this.d * $$1, this.e * $$2);
   }

   public exc a(ayw $$0, float $$1) {
   ...
   public exc a(exc $$0, double $$1) {
      return new exc(ayo.d($$1, this.c, $$0.c), ayo.d($$1, this.d, $$0.d), ayo.d($$1, this.e, $$0.e));
   }

   public exc a(float $$0) {
      float $$1 = ayo.b($$0);
      float $$2 = ayo.a($$0);
      double $$3 = this.c;
   ...
   public static exc a(exb $$0) {
      return a($$0.i, $$0.j);
   }

   public static exc a(float $$0, float $$1) {
      ...
      return new exc((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public exc a(EnumSet<ji.a> $$0) {
   ...
   public exc a(ji.a $$0, double $$1) {
      double $$2 = $$0 == ji.a.a ? $$1 : this.c;
      double $$3 = $$0 == ji.a.b ? $$1 : this.d;
      double $$4 = $$0 == ji.a.c ? $$1 : this.e;
      return new exc($$2, $$3, $$4);
   }

   public exc a(ji $$0, double $$1) {
      kh $$2 = $$0.q();
      return new exc(this.c + $$1 * (double)$$2.u(), this.d + $$1 * (double)$$2.v(), this.e + $$1 * (double)$$2.w());
   }
