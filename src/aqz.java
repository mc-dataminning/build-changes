...
public interface aqz {
   aqz a = new aqz() {
      ...
      @Override
      public void a(Consumer<dir> $$0) {
      }
   };

   static aqz a(dir $$0, int $$1) {
      return new aqz.a($$0, $$1);
   }

   static void a(aqz $$0, aqz $$1, Consumer<dir> $$2, Consumer<dir> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqz.a $$4 && $$1 instanceof aqz.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dir($$10, $$11));
                     } else {
                        $$3.accept(new dir($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dir b, int c) implements aqz {
      int c() {
