...
public interface aqz {
   aqz a = new aqz() {
      ...
      @Override
      public void a(Consumer<dic> $$0) {
      }
   };

   static aqz a(dic $$0, int $$1) {
      return new aqz.a($$0, $$1);
   }

   static void a(aqz $$0, aqz $$1, Consumer<dic> $$2, Consumer<dic> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqz.a $$4 && $$1 instanceof aqz.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dic($$10, $$11));
                     } else {
                        $$3.accept(new dic($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dic b, int c) implements aqz {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqz.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqz.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
