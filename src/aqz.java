...
public class aqz implements aqv {
   private final aqx a;
   private final Long2ObjectOpenHashMap<dtw> b = new Long2ObjectOpenHashMap();
   private dae c = new dae(0, 0);
   private final int d;
   private final int e;
   private final int f;
   private boolean g;
   ...
   public dtw a(int $$0, int $$1) {
      return (dtw)this.b.get(dae.c($$0 + this.c.e - this.e, $$1 + this.c.f - this.e));
   }
}
