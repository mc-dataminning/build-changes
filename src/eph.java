...
public class eph {
   ...
   protected eph(eph.a $$0, int $$1, String $$2) {
      this.b = $$0;
      this.d = $$1;
      this.c = $$2;
   }
   ...
   public static eph a(eph.a $$0, String $$1, InputStream $$2, String $$3, epa $$4) throws IOException {
      RenderSystem.assertOnRenderThread();
      int $$5 = b($$0, $$1, $$2, $$3, $$4);
      eph $$6 = new eph($$0, $$5, $$1);
      $$0.c().put($$1, $$6);
   ...
   protected static int b(eph.a $$0, String $$1, InputStream $$2, String $$3, epa $$4) throws IOException {
   ...
   public static enum a {
      ...
      private final int e;
      private final Map<String, eph> f = Maps.newHashMap();
