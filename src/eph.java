...
public class eph {
   ...
   public eph(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<epi> $$1) throws IOException {
   ...
   public List<epi> a(Path $$0) throws IOException {
      List<epi> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<epi> a(Path $$0, boolean $$1) throws IOException {
      List<epi> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<epi> $$1) throws IOException {
