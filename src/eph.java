...
public class eph {
   ...
   public static List<eph.a> a(String $$0, eph.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<eph.a> a(String $$0, List<eph.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<eph.a> a(List<String> $$0, List<eph.b> $$1) {
      int $$2 = 0;
      List<eph.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<eph.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static eph.b a(String $$0, String $$1) {
         return new eph.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static eph.b a(String $$0) {
         return new eph.b($$0);
      }
   }
}
