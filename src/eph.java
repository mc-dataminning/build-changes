...
public class eph {
   ...
   private static final dsj.f e = ($$0, $$1, $$2) -> $$0.a(dfj.co);
   ...
   public static Optional<eph> a(dcg $$0, ja $$1, jf.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<eph> a(dcg $$0, ja $$1, Predicate<eph> $$2, jf.a $$3) {
      Optional<eph> $$4 = Optional.of(new eph($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         jf.a $$5 = $$3 == jf.a.a ? jf.a.c : jf.a.a;
         return Optional.of(new eph($$0, $$1, $$5)).filter($$2);
      }
   }

   public eph(dcg $$0, ja $$1, jf.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dsk $$0) {
      return $$0.i() || $$0.a(avw.aK) || $$0.a(dfj.ed);
   }
   ...
   public static ewf a(l.a $$0, jf.a $$1, ewf $$2, bsj $$3) {
      ...
      return new ewf($$8, $$11, $$14);
   }

   public static epg a(aqm $$0, l.a $$1, jf.a $$2, ewf $$3, bsg $$4, ewf $$5, float $$6, float $$7) {
      ja $$8 = $$1.a;
      dsk $$9 = $$0.a_($$8);
      jf.a $$10 = $$9.d(dta.H).orElse(jf.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bsj $$13 = $$4.a($$4.as());
      int $$14 = $$2 == $$10 ? 0 : 90;
      ewf $$15 = $$2 == $$10 ? $$5 : new ewf($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == jf.a.a;
      ewf $$20 = new ewf((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      ewf $$21 = a($$20, $$0, $$4, $$13);
      return new epg($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static ewf a(ewf $$0, aqm $$1, bsg $$2, bsj $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         ewf $$5 = $$0.b(0.0, $$4, 0.0);
         ewy $$6 = ewv.a(ewa.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<ewf> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<ewf> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
