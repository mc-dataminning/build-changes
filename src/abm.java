...
public class abm implements wk<yd> {
   ...
   private final Optional<abm.b> k;

   private abm(String $$0, int $$1, Optional<abm.b> $$2, Collection<String> $$3) {
      this.i = $$0;
      this.h = $$1;
      this.k = $$2;
   ...
   public abm(tu $$0) {
      ...
      this.h = $$0.readByte();
      if (b(this.h)) {
         this.k = Optional.of(new abm.b($$0));
      } else {
