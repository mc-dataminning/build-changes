...
public class wm extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vp> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, vb.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vp> $$0, Codec<T> $$1, vb $$2) {
      vp $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> wm a(DynamicOps<vp> $$0, Codec<T> $$1, T $$2) {
      vp $$3 = (vp)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zo<? super wm, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zp<? super wm, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zo<? super wm, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zo<? super wm, K> $$1, zo<? super wm, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zo<? super wm, K> $$0, zo<? super wm, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zp<? super wm, K> $$1, zp<? super wm, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zp<? super wm, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zo<? super wm, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zo<? super wm, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zo<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zp<? super wm, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zp<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public evt k() {
      return new evt(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> wm a(ToIntFunction<T> $$0, T $$1) {
   ...
   public wm a(@Nullable vp $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vp $$1) {
      if ($$1 == null) {
         $$1 = uu.b;
      }

      try {
         vf.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static us f(ByteBuf $$0) {
      vp $$1 = a($$0, vb.a(2097152L));
      if ($$1 != null && !($$1 instanceof us)) {
   ...
   @Nullable
   public static vp a(ByteBuf $$0, vb $$1) {
      try {
         vp $$2 = vf.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return xf.a(this.d, $$0);
   }

   public wm a(String $$0) {
      return this.a($$0, 32767);
   }

   public wm a(String $$0, int $$1) {
      xf.a(this.d, $$0, $$1);
      return this;
   }

   public alf q() {
      return new alf(this.d(32767));
   }
   ...
   public <T> ale<T> a(ale<? extends jv<T>> $$0) {
      alf $$1 = this.q();
      return ale.a($$0, $$1);
   }
   ...
   public evp v() {
      ...
      return new evp(new evt((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public wm a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wm a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public wm a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wm a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wm a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wm a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wm a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public wm a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public wm b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public wm c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public wm d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public wm e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public wm f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public wm g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public wm h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public wm a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public wm b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public wm i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public wm a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public wm a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public wm b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wm b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public wm b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wm b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wm b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wm b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public wm g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wm b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public wm a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wm a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public wm a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wm a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public wm a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public wm h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public wm c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public wm b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wm b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public wm b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
