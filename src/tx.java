...
public class tx extends ByteToMessageDecoder implements uc {
   private static final Logger a = LogUtils.getLogger();
   private final AttributeKey<tt.a<?>> b;

   public tx(AttributeKey<tt.a<?>> $$0) {
      this.b = $$0;
   }
   ...
   protected void decode(ChannelHandlerContext $$0, ByteBuf $$1, List<Object> $$2) throws Exception {
      ...
      if ($$3 != 0) {
         Attribute<tt.a<?>> $$4 = $$0.channel().attr(this.b);
         tt.a<?> $$5 = (tt.a<?>)$$4.get();
         tu $$6 = new tu($$1);
         int $$7 = $$6.n();
         wk<?> $$8 = $$5.a($$7, $$6);
         if ($$8 == null) {
            ...
            if ($$6.readableBytes() > 0) {
               ...
               $$2.add($$8);
               if (a.isDebugEnabled()) {
                  a.debug(ts.c, " IN: [{}:{}] {}", new Object[]{$$5.a().a(), $$7, $$8.getClass().getName()});
               }
