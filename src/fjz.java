...
public class fjz {
   public static void a(fzf $$0, fjx $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fjw>> $$6 : $$1.c().entrySet()) {
         Optional<gbm> $$7 = $$0.a($$6.getKey());
         List<fjw> $$8 = $$6.getValue();
   ...
   private static float a(fjx $$0, long $$1) {
