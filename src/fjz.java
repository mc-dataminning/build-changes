...
public enum fjz implements exy {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static eyx a(int $$0, int $$1, fjz.a $$2) {
      eyx $$3 = new eyx(eyx.a.a, $$0, $$1, false);
   ...
   private fjz(final Supplier<eyx> $$0) {
      this.c = $$0.get();
   }
