...
public class ggp implements AutoCloseable {
   private static final fcs p = new fcs();
   private static final int q = -1;
   private final List<ghz.a> r = new ArrayList<>();
   private final Object2IntMap<String> s = new Object2IntArrayMap();
   private final IntList t = new IntArrayList();
   private final List<fcv> u = new ArrayList<>();
   private final Map<String, fcv> v = new HashMap<>();
   private final int w;
   @Nullable
   public fcv a;
   @Nullable
   ...
   public static ggp a(fct $$0, fct $$1, fdj $$2) throws ghx.a {
      int $$3 = GlStateManager.glCreateProgram();
      if ($$3 <= 0) {
         throw new ghx.a("Could not create shader program (returned program ID " + $$3 + ")");
      } else {
         $$2.a($$3);
         ...
         if ($$4 == 0) {
            ...
            throw new ghx.a("Error encountered when linking program containing VS " + $$0.a() + " and FS " + $$1.a() + ". Log output: " + $$5);
         } else {
            return new ggp($$3);
         }
      }
   ...
   public void a(List<ghz.b> $$0, List<ghz.a> $$1) {
      RenderSystem.assertOnRenderThread();

      for (ghz.b $$2 : $$0) {
         String $$3 = $$2.a();
         int $$4 = fcv.a(this.w, $$3);
         if ($$4 != -1) {
            fcv $$5 = this.a($$2);
            $$5.b($$4);
            this.u.add($$5);
   ...
   public void a(fdj.c $$0, Matrix4f $$1, Matrix4f $$2, fch $$3) {
      for (int $$4 = 0; $$4 < 12; $$4++) {
      ...
      ggu $$6 = RenderSystem.getShaderFog();
      if (this.i != null) {
         this.i.a($$6.a());
      }
      ...
      if (this.m != null && ($$0 == fdj.c.a || $$0 == fdj.c.b)) {
