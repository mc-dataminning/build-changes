public class ggp extends ggf {
   ...
   public void q() {
      if (this.s.dH()) {
         ...
         if ($$0 >= 0.01F && this.s.dM().r().i()) {
            this.t = aty.a(this.t + 0.0025F, 0.0F, 1.0F);
            this.d = aty.i(aty.a($$0, 0.0F, 0.5F), 0.0F, 0.7F);
         } else {
            this.t = 0.0F;
            this.d = 0.0F;
         }
