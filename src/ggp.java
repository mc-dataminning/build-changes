...
public class ggp {
   ...
   private ggp.a l = ggp.a.c;
   @Nullable
   private byte[] m;
   private ggp.c n;
   private ggp.b o = ggp.b.a;

   public ggp(String $$0, String $$1, ggp.c $$2) {
      this.a = $$0;
      this.b = $$1;
      this.n = $$2;
   }
   ...
   public static ggp a(tq $$0) {
      ggp $$1 = new ggp($$0.l("name"), $$0.l("ip"), ggp.c.c);
      if ($$0.b("icon", 8)) {
         try {
   ...
   public boolean d() {
      return this.n == ggp.c.a;
   }

   public boolean e() {
      return this.n == ggp.c.b;
   }
