...
public class awu extends awz {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<awv<?>> e = Sets.newHashSet();

   public awu(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cor $$0, awv<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<awv<?>> d() {
      Set<awv<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  un $$4 = a($$3.getAsJsonObject());
                  $$4 = bax.g.a($$0, $$4, vc.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awv<T>> a(awx<T> $$0, String $$1) {
      return Optional.ofNullable(all.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static un a(JsonObject $$0) {
      un $$1 = new un();
   ...
   protected String b() {
      Map<awx<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awv<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awv<?>>)$$3.next();
         awv<?> $$2 = (awv<?>)$$1.getKey();
      ...
      for (Entry<awx<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lz.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> all b(awv<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(arr $$0) {
      Object2IntMap<awv<?>> $$1 = new Object2IntOpenHashMap();
