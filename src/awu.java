...
public class awu {
   ...
   public static final Codec<Object> b = a(axf.a);
   ...
   public static final Codec<awu.g> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ajv.b($$0.substring(1)).map($$0x -> new awu.g($$0x, true)) : ajv.b($$0).map($$0x -> new awu.g($$0x, false)), awu.g::c
      );
   ...
   public static final Codec<String> u = b(
      b(0, 16),
      (Function<String, DataResult<String>>)($$0 -> ayh.f($$0)
   ...
   private static final MapCodec<GameProfile> A = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jh.e.fieldOf("id").forGetter(GameProfile::getId), u.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static Codec<String> y = b(
      Codec.STRING, $$0 -> !ajv.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> awu.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new awu.b<>($$0, $$1);
   }

   public static <K, V> awu.f<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new awu.f<>($$0, $$1);
   }
   ...
   public static <T> Codec<ir<T>> b(Codec<ir<T>> $$0) {
      return b(
         $$0,
         (Function<ir<T>, DataResult<ir<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class e<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof awu.e<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record g(ajv a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
