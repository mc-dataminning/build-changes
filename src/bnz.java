...
public class bnz extends bkr {
   public bnz(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   public static SequencedMap<String, Supplier<TypeTemplate>> a(Schema $$0) {
      SequencedMap<String, Supplier<TypeTemplate>> $$1 = bnu.a($$0);
      $$1.remove("minecraft:food");
      $$1.put("minecraft:use_remainder", () -> biw.t.in($$0));
      $$1.put("minecraft:equippable", () -> DSL.optionalFields("allowed_entities", DSL.or(biw.B.in($$0), DSL.list(biw.B.in($$0)))));
      return $$1;
   }
