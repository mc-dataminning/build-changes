...
public interface bnz {
   static bnt<StringReader> a(String $$0) {
      return new bnz.b($$0);
   }

   static bnt<StringReader> a(char $$0) {
      return new bnz.a($$0);
   }

   public static record a(char a) implements bnt<StringReader> {
      @Override
      public boolean a(bnp<StringReader> $$0, bnr $$1, bnl $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bnt<StringReader> {
      @Override
      public boolean a(bnp<StringReader> $$0, bnr $$1, bnl $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
