...
public class bnz {
   ...
   private static void a(boh $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(boc $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<duw, bol<bob>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bol)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<duw, bol<bob>> $$3 : $$0) {
         bol<bob> $$4 = (bol<bob>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((duw)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<boj> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bno.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnx $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnz::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnz::a));
      return $$1;
   }
   ...
   private JsonElement c(bnx $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnz::a));
      $$1.add("received", this.a($$0.k(), bnz::a));
      return $$1;
   }

   private <T> JsonElement a(bog<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bod> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bod>, ToDoubleFunction<bod>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bod::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bod::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bod::c));
      return $$1;
   }
}
