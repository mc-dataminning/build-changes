...
public class gbx<T extends gyj> extends gbk<T> implements gag, gbt {
   public static final gev i = new gal(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public gbx(gem $$0, Function<alz, glt> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static geu a(geq $$0, float $$1) {
      geu $$2 = new geu();
      gew $$3 = $$2.a();
      gew $$4 = $$3.a("head", ger.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), geo.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", ger.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), geo.a);
      $$3.a("body", ger.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), geo.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", ger.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), geo.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", ger.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), geo.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", ger.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), geo.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", ger.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), geo.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }

   protected gbx.a a(T $$0, bvz $$1) {
      return gbx.a.a;
   }

   public void a(T $$0) {
      super.a($$0);
      gbx.a $$1 = this.a($$0, bvz.a);
      gbx.a $$2 = this.a($$0, bvz.b);
      float $$3 = $$0.B;
      boolean $$4 = $$0.J;
      ...
      if ($$2 != gbx.a.h) {
         gae.a(this.r, $$0.p, 1.0F);
      }

      if ($$1 != gbx.a.h) {
         gae.a(this.s, $$0.p, -1.0F);
      }

      if ($$3 > 0.0F) {
         float $$10 = $$5 % 26.0F;
         bvz $$11 = $$0.G;
         float $$12 = $$11 == bvz.b && $$0.C > 0.0F ? 0.0F : $$3;
         float $$13 = $$11 == bvz.a && $$0.C > 0.0F ? 0.0F : $$3;
         if (!$$0.M) {
            if ($$10 < 14.0F) {
   ...
   private void a(T $$0, gbx.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gae.a(this.r, this.s, $$0.E, $$0.F, true);
            break;
         case g:
            gae.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, gbx.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gae.a(this.r, this.s, $$0.E, $$0.F, false);
            break;
         case g:
            gae.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   private void a(gem $$0, boolean $$1) {
   ...
   protected gem a(bvz $$0) {
      return $$0 == bvz.a ? this.s : this.r;
   }
