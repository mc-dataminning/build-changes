...
public class gbx {
   ...
   public static class b extends gdn {
      b(fzf $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gcz {
      ...
      c(fzf $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gcp $$7, gdi $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gbx.c $$0 = new gbx.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gcq<lq> {
      ...
      public gcn a(lq $$0, fzf $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbx.c $$8 = new gbx.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fgo.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gcl {
      ...
      public e(fzf $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gcp $$7, List<cxl> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gcn $$12 = this.E.a(lm.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gbx.c $$10 = (gbx.c)this.E.a(lm.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
