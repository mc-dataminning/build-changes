...
public class dfl extends dje {
   ...
   protected dfl(dpx.d $$0) {
      super($$0);
      this.k(this.E.b().a(a, ir.b));
   }

   @Override
   public dpy a(cvl $$0) {
      ir $$1 = $$0.k();
      dpy $$2 = $$0.q().a_($$0.a().a($$1.g()));
   ...
   public void a(dpy $$0, czu $$1, im $$2, ayd $$3) {
      ...
      if ($$3.a(5) == 0) {
         $$1.a(kw.t, $$5 + (double)$$4.j() * $$8, $$6 + (double)$$4.k() * $$8, $$7 + (double)$$4.l() * $$8, $$3.k() * 0.005, $$3.k() * 0.005, $$3.k() * 0.005);
      }
   }
