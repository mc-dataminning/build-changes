...
public class dse extends dsj {
   public static final Codec<dse> a = drs.a.fieldOf("provider").xmap(dse::new, $$0 -> $$0.b).codec();
   private final drs b;
