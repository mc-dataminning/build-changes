...
public class qk {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a(
                                    ...
                                    .then(
                                       du.a("run")
                                          .then(
                                             ((RequiredArgumentBuilder)du.a("testName", qm.a())
                                                   .executes($$0x -> a((dt)$$0x.getSource(), qm.a($$0x, "testName"), 0)))
                                                .then(
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("runall").executes($$0x -> a((dt)$$0x.getSource(), 0, 8)))
                                          .then(
                                             ((RequiredArgumentBuilder)du.a("testClassName", qj.a())
                                                   .executes($$0x -> a((dt)$$0x.getSource(), qj.a($$0x, "testClassName"), 0, 8)))
                                                .then(
                                                   ((RequiredArgumentBuilder)du.a("rotationSteps", IntegerArgumentType.integer())
                                                         .executes(
                                                            $$0x -> a(
                                                                  (dt)$$0x.getSource(),
                                                                  qj.a($$0x, "testClassName"),
                                                                  IntegerArgumentType.getInteger($$0x, "rotationSteps"),
                                                                  8
                                                               )
                                                         ))
   ...
   private static int a(dt $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         akn $$5 = $$0.e();
         gw $$6 = gw.a($$0.d());
         gw $$7 = new gw($$6.u(), $$0.e().a(dkn.a.b, $$6).v(), $$6.w() + 3);
         qh.a($$1.toLowerCase(), $$7, new ib($$2, $$3, $$4), czc.a, $$5);
   ...
   private static int a(dt $$0, String $$1) throws CommandSyntaxException {
      ehe $$2 = (ehe)$$0.h().a(10.0, 1.0F, false);
      gw $$3 = $$2.a();
      akn $$4 = $$0.e();
      Optional<gw> $$5 = qh.a($$3, 15, $$4);
      if ($$5.isEmpty()) {
         $$5 = qh.a($$3, 200, $$4);
      }

      if ($$5.isEmpty()) {
         $$0.b(ti.b("Can't find a structure block that contains the targeted pos " + $$3));
         return 0;
      } else {
         ded $$6 = (ded)$$4.c_($$5.get());
         gw $$7 = $$3.b($$5.get());
         ...
         ti $$10 = ti.b($$8)
            .b(
               ue.a
                  .a(true)
                  .a(n.k)
                  .a(new tn(tn.a.a, ti.b("Click to copy to clipboard")))
                  .a(new tg(tg.a.f, "final BlockPos " + $$1 + " = new BlockPos(" + $$8 + ");"))
            );
         $$0.a(() -> ti.b("Position relative to " + $$9 + ": ").b($$10), false);
         aay.a($$4, new gw($$3), $$8, -2147418368, 10000);
         return 1;
      }
   }
   ...
   private static void a(akn $$0, gw $$1, @Nullable qf $$2) {
      ded $$3 = (ded)$$0.c_($$1);
      String $$4 = $$3.f();
      ql $$5 = pw.f($$4);
      pu $$6 = new pu($$5, $$3.w(), $$0);
   ...
   private static int a(dt $$0, int $$1) {
      akn $$2 = $$0.e();
      px.a($$2);
      gw $$3 = gw.a($$0.d().c, (double)$$0.e().a(dkn.a.b, gw.a($$0.d())).v(), $$0.d().e);
      px.a($$2, $$3, qa.a, ars.a($$1, 0, 1024));
      return 1;
   }

   private static int a(dt $$0, ql $$1, int $$2) {
      akn $$3 = $$0.e();
      gw $$4 = gw.a($$0.d());
      int $$5 = $$0.e().a(dkn.a.b, $$4).v();
   ...
   private static void a(ql $$0, akn $$1) {
      Consumer<akn> $$2 = pw.c($$0.e());
      if ($$2 != null) {
         $$2.accept($$1);
      }
   }
   ...
   private static int a(dt $$0, boolean $$1, int $$2, int $$3) {
      Collection<ql> $$4;
      if ($$1) {
         $$4 = pw.c().stream().filter(ql::d).collect(Collectors.toList());
      } else {
         $$4 = pw.c();
      }
   ...
   private static void a(dt $$0, Collection<ql> $$1, int $$2, int $$3) {
      gw $$4 = gw.a($$0.d());
      gw $$5 = new gw($$4.u(), $$0.e().a(dkn.a.b, $$4).v(), $$4.w() + 3);
      akn $$6 = $$0.e();
      czc $$7 = qh.a($$2);
      Collection<pu> $$8 = px.b($$1, $$5, $$7, $$6, qa.a, $$3);
      qf $$9 = new qf($$8);
      $$9.a(new qk.a($$6, $$9));
      $$9.a($$0x -> pw.a($$0x.v()));
   }
   ...
   private static int c(dt $$0, String $$1) {
      Path $$2 = Paths.get(qh.b);
      aeu $$3 = new aeu("minecraft", $$1);
      Path $$4 = $$0.e().p().a($$3, ".nbt");
      Path $$5 = mj.a(ji.a, $$4, $$1, $$2);
      if ($$5 == null) {
   ...
   private static void a(akn $$0, String $$1, n $$2) {
      $$0.a($$0x -> true).forEach($$2x -> $$2x.a(ti.b($$2 + $$1)));
   }

   static class a implements pv {
      private final akn a;
      private final qf b;
