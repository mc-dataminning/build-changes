...
public class ecr extends ecu<ecq> {
   public ecr(Codec<ecq> $$0) {
      super($$0);
   }

   public boolean a(ecq $$0, azn $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(ecp $$0, ecq $$1, dwo $$2, Function<jf, jo<dfk>> $$3, azn $$4, eaa $$5, ddp $$6, dwn $$7) {
      int $$8 = kh.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         ecu.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      ecp $$0, ecq $$1, dwo $$2, Function<jf, jo<dfk>> $$3, eaa $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dwn $$10, ecu.a $$11
   ) {
      double $$12 = 1.5 + (double)(azf.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(azf.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = azf.b($$13);
         $$6 += (double)(azf.b($$12) * $$27);
         $$7 += (double)azf.a($$13);
         $$8 += (double)(azf.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
