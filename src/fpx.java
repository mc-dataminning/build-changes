...
public class fpx extends foq<cre> {
   ...
   private int ai;
   private final fpx.a[] aj = new fpx.a[7];
   int ak;
   private boolean al;

   public fpx(cre $$0, cmw $$1, wz $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.v = 107;
   }
   ...
   protected void aT_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.aj[$$3] = this.c(new fpx.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fpx.a) {
               this.ai = ((fpx.a)$$0x).a() + this.ak;
               this.E();
            }
         }));
         $$2 += 20;
   ...
   private void a(fhx $$0, int $$1, int $$2, dbu $$3) {
      int $$4 = this.x.n();
      int $$5 = this.x.l();
      if ($$4 < 5) {
   ...
   private void a(fhx $$0, int $$1, int $$2, dbv $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fhx $$0, dbu $$1, int $$2, int $$3) {
   ...
   private void a(fhx $$0, cuq $$1, cuq $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.H() == $$1.H()) {
         $$0.a(this.o, $$1, $$3, $$4);
      } else {
   ...
   class a extends fik {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fik.c $$3) {
      ...
      public void a(fhx $$0, int $$1, int $$2) {
         if (this.i && fpx.this.x.p().size() > this.a + fpx.this.ak) {
            if ($$1 < this.D() + 20) {
               cuq $$3 = fpx.this.x.p().get(this.a + fpx.this.ak).b();
               $$0.b(fpx.this.o, $$3, $$1, $$2);
            } else if ($$1 < this.D() + 50 && $$1 > this.D() + 30) {
               cuq $$4 = fpx.this.x.p().get(this.a + fpx.this.ak).c();
               if (!$$4.e()) {
                  $$0.b(fpx.this.o, $$4, $$1, $$2);
               }
            } else if ($$1 > this.D() + 65) {
               cuq $$5 = fpx.this.x.p().get(this.a + fpx.this.ak).f();
               $$0.b(fpx.this.o, $$5, $$1, $$2);
            }
         }
      }
   }
