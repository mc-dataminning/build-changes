...
public class fpx extends fqb {
   ...
   private static final int d = axq.a(255, 239, 50, 61);
   private static final int e = axq.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> fip.Q().n.a().c() ? e : d;
   ...
   public fpx(fip $$0, aur $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fkb $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         int $$9 = azf.f((1.0F - azf.a($$7 - 1.0F, 0.0F, 1.0F)) * 255.0F);
         $$0.a(ghv.G(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         $$10 = 1.0F - azf.a($$7 - 1.0F, 0.0F, 1.0F);
      } else if (this.p) {
         if (this.m.z != null && $$8 < 1.0F) {
            this.m.z.a($$0, $$1, $$2, $$3);
         }

         int $$11 = azf.c(azf.a((double)$$8, 0.15, 1.0) * 255.0);
         $$0.a(ghv.G(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         $$10 = azf.a($$8, 0.0F, 1.0F);
      } else {
         int $$13 = f.getAsInt();
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = axq.a($$10);
      $$0.a($$0x -> ghv.K(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> ghv.K(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      int $$25 = (int)((double)$$0.b() * 0.8325);
      float $$26 = this.n.b();
      this.q = azf.a(this.q * 0.95F + $$26 * 0.050000012F, 0.0F, 1.0F);
      if ($$7 < 1.0F) {
         this.a($$0, $$4 / 2 - $$23, $$25 - 5, $$4 / 2 + $$23, $$25 + 5, 1.0F - azf.a($$7, 0.0F, 1.0F));
      }
   ...
   private void a(fkb $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      int $$6 = azf.f((float)($$3 - $$1 - 2) * this.q);
      int $$7 = Math.round($$5 * 255.0F);
      int $$8 = axq.a($$7, 255, 255, 255);
   ...
   static class a extends gwz {
      ...
      protected gwz.a b(auv $$0) {
         atl $$1 = fip.Q().ae();
         aun<InputStream> $$2 = $$1.a(atj.a, fpx.a);
         if ($$2 == null) {
            return new gwz.a(new FileNotFoundException(fpx.a.toString()));
         } else {
            try {
               gwz.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gwz.a(new gze(true, true), fci.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gwz.a(var9);
            }
         }
      }
   }
