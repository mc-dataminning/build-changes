...
public class fpx implements fqo {
   ...
   private CompletableFuture<Optional<chn>> g;
   private Instant h = Instant.EPOCH;

   public fpx(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
      this.f = $$2.resolve(d).resolve($$1 + ".json");
      this.g = CompletableFuture.<Optional<chn>>supplyAsync(() -> this.c().filter($$0x -> !$$0x.c().b().a()), ac.f()).thenCompose(this::a);
   }
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(chn::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<chn>> a(Optional<chn> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (avh | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = chn.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable chn $$0) {
      ...
      if ($$0 != null) {
         if (aa.aU) {
            chn.a.encodeStart(JsonOps.INSTANCE, $$0).result().ifPresent($$0x -> {
               try {
   ...
   private chn a(UserApiService $$0) throws avh, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cho.a $$2 = a($$1);
         return new chn(avg.a($$1.keyPair().privateKey()), new cho($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cho.a a(KeyPairResponse $$0) throws avh {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = avg.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cho.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new avh(var5);
         }
      } else {
         throw new avh(new MissingException("Missing public key"));
      }
   }
}
