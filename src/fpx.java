...
public class fpx extends cvn {
   ...
   private int Q;
   private final frf R = new frf();
   private static final Set<cou> S = Set.of(cpc.hA, cpc.hB);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(hz $$0, dlf $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(hz $$0, dlf $$1, ens $$2) {
      dlf $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         chh $$4 = this.I.s;
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.Z().a(cvj.l).a(false, null);
      } else {
         this.Z().a(cvj.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<bno> e() {
      return this.G().a();
   }
   ...
   private void a(bno $$0, bno $$1) {
      if ($$1.dH() || $$1.cZ() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof chh || this.e.c($$1)) {
         $$1.bp();
         $$1.ag++;
         $$1.t();
   ...
   @Override
   public void W() {
      this.D.m().a(vq.c("multiplayer.status.quitting"));
   }
   ...
   private cyo p() {
      if (this.I.q.j() == cvk.b) {
         coz $$0 = this.I.s.eT();
         cou $$1 = $$0.d();
         if (S.contains($$1) && $$1 instanceof cms $$2) {
            return $$2.e();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, awo $$4, @Nullable cyo $$5, hz.a $$6) {
   ...
   private void a(hz $$0, dlf $$1, jx $$2, boolean $$3) {
      if ($$1.u().c()) {
         eol $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(ie.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(hz $$0, jx $$1, eol $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, jx $$5) {
      this.a($$5, awh.d(this.z.j(), $$0, $$1), $$4, awh.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }

   @Override
   public p a(o $$0) {
      p $$1 = super.a($$0);
      $$1.a("Server brand", () -> this.I.s.cq.h());
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, @Nullable sw $$6) {
      this.I.g.a(new fsl.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
   }
   ...
   public ij<cwm> a(int $$0, int $$1, int $$2) {
      return this.I_().d(kg.at).f(cwt.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (awh.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = awh.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public ens a(ens $$0, float $$1) {
      float $$2 = this.f($$1);
      ens $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      cwo $$4 = this.G_();
      ens $$5 = avi.a($$3, ($$1x, $$2x, $$3x) -> ens.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = awh.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = awh.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new ens((double)$$7, (double)$$8, (double)$$9);
   }

   public ens h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = awh.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = awh.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new ens((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (awh.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = awh.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(hz $$0, cuy $$1) {
      eym $$2 = (eym)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(hz $$0, cuy $$1) {
      int $$2 = exh.O().m.C().c();
      if ($$2 == 0) {
   ...
   protected Map<String, ehz> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<String, ehz> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements eis {
      ...
      public a(blr $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new cvj();
   ...
   final class b implements dpe<bno> {
      public void a(bno $$0) {
      }
