...
public class fpx extends frn {
   private final float a;
   private final fri b;

   fpx(fnk $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, fri $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements fqq<jp> {
      ...
      public fqn a(jp $$0, fnk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dco.a) {
            ...
            hx $$9 = hx.a($$2, $$3, $$4);
            int $$10 = eva.N().at().a($$8, $$1, $$9);
            if ($$8.b() instanceof czf) {
               $$10 = ((czf)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new fpx($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
