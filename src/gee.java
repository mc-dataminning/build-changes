...
public class gee implements ged {
   private final ged.a a;
   private final ged.a b = ged.a(new fah(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public faq getBuffer(gel $$0) {
      if ($$0.M()) {
         faq $$1 = this.b.getBuffer($$0);
         return new gee.a($$1, this.c, this.d, this.e, this.f);
      } else {
         faq $$2 = this.a.getBuffer($$0);
         Optional<gel> $$3 = $$0.L();
         if ($$3.isPresent()) {
            faq $$4 = this.b.getBuffer($$3.get());
            gee.a $$5 = new gee.a($$4, this.c, this.d, this.e, this.f);
            return fat.a($$5, $$2);
         } else {
            return $$2;
         }
   ...
   static class a extends fal {
      ...
      a(faq $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
