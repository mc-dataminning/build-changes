public class gee extends gfq<hbh> implements geh {
   private final giu a = this.v.b("head");
   private final giu b = this.v.b("body");
   private final giu c = this.b.b("right_arm");
   private final giu d = this.b.b("left_arm");
   private final giu e = this.b.b("right_wing");
   private final giu f = this.b.b("left_wing");
   ...
   public static gja a() {
      gjc $$0 = new gjc();
      gje $$1 = $$0.a();
      gje $$2 = $$1.a("root", giz.c(), giw.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", giz.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new giy(0.0F)), giw.a(0.0F, -3.99F, 0.0F));
      gje $$3 = $$2.a(
         "body",
         giz.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new giy(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new giy(-0.2F)),
         giw.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", giz.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new giy(-0.01F)), giw.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", giz.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new giy(-0.01F)), giw.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", giz.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new giy(0.0F)), giw.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", giz.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new giy(0.0F)), giw.a(0.5F, 0.0F, 0.6F));
