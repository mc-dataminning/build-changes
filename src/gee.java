...
public class gee implements AutoCloseable {
   ...
   public gee(gdy $$0, ffw $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gpd(16, 16, false);
   ...
   private float b(float $$0) {
      brp $$1 = this.j.s.c(brr.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(btc $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.b(brr.p)) {
               $$9 = gdy.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(brr.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   public static float a(dwg $$0, int $$1) {
