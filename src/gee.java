...
public class gee extends fvr {
   private static final fvy c = new fvy(ali.b("recipe_book/tab"), ali.b("recipe_book/tab_selected"));
   private final gec.a d;
   ...
   public void a(fqo $$0, boolean $$1) {
      geg.a $$2 = $$1 ? geg.a.b : geg.a.a;

      for (geg $$4 : $$0.a(this.d.c())) {
         for (dfw $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(ftx $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(gsl::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
   ...
   public boolean a(fqo $$0) {
      List<geg> $$1 = $$0.a(this.d.c());
      this.k = false;
