public class gee {
   ...
   private final gou[] b = new gou[2];
   private final gou[] c = new gou[2];
   private gou d;

   protected void a() {
      this.b[0] = ffa.Q().aD().b().b(dew.H.n()).e();
      this.b[1] = gra.c.c();
      this.c[0] = ffa.Q().aD().b().b(dew.G.n()).e();
      this.c[1] = gra.d.c();
      this.d = gra.e.c();
   }

   private static boolean a(enq $$0, enq $$1) {
      return $$1.a().a($$0.a());
   }

   private static boolean a(daz $$0, je $$1, float $$2, iz $$3, drx $$4) {
      if ($$4.p()) {
         ewf $$5 = ewc.a(0.0, 0.0, 0.0, 1.0, (double)$$2, 1.0);
         ewf $$6 = $$4.c($$0, $$3);
         return ewc.a($$5, $$6, $$1);
      } else {
         return false;
   ...
   private static boolean a(daz $$0, iz $$1, je $$2, float $$3, drx $$4) {
      return a($$0, $$2, $$3, $$1.a($$2), $$4);
   }

   private static boolean a(daz $$0, iz $$1, drx $$2, je $$3) {
      return a($$0, $$3.g(), 1.0F, $$1, $$2);
   }

   public static boolean a(daw $$0, iz $$1, enq $$2, drx $$3, je $$4, enq $$5) {
      return !a($$0, $$1, $$3, $$4) && !a($$2, $$5);
   }

   public void a(daw $$0, iz $$1, ezx $$2, drx $$3, enq $$4) {
      boolean $$5 = $$4.a(awr.b);
      gou[] $$6 = $$5 ? this.b : this.c;
      int $$7 = $$5 ? 16777215 : gcv.c($$0, $$1);
      float $$8 = (float)($$7 >> 16 & 0xFF) / 255.0F;
      float $$9 = (float)($$7 >> 8 & 0xFF) / 255.0F;
      float $$10 = (float)($$7 & 0xFF) / 255.0F;
      drx $$11 = $$0.a_($$1.a(je.a));
      enq $$12 = $$11.u();
      drx $$13 = $$0.a_($$1.a(je.b));
      enq $$14 = $$13.u();
      drx $$15 = $$0.a_($$1.a(je.c));
      enq $$16 = $$15.u();
      drx $$17 = $$0.a_($$1.a(je.d));
      enq $$18 = $$17.u();
      drx $$19 = $$0.a_($$1.a(je.e));
      enq $$20 = $$19.u();
      drx $$21 = $$0.a_($$1.a(je.f));
      enq $$22 = $$21.u();
      boolean $$23 = !a($$4, $$14);
      ...
      if ($$23 || $$24 || $$28 || $$27 || $$25 || $$26) {
         ...
         if ($$23 && !a($$0, $$1, je.b, Math.min(Math.min($$36, $$38), Math.min($$37, $$35)), $$13)) {
            ...
            if ($$52.c == 0.0 && $$52.e == 0.0) {
               ...
               gou $$62 = $$6[1];
               float $$63 = (float)ayu.d($$52.e, $$52.c) - (float) (Math.PI / 2);
               float $$64 = ayu.a($$63) * 0.25F;
               float $$65 = ayu.b($$63) * 0.25F;
               float $$66 = 0.5F;
               $$54 = $$62.a(0.5F + (-$$65 - $$64));
               $$55 = $$62.c(0.5F + -$$65 + $$64);
               $$56 = $$62.a(0.5F + -$$65 + $$64);
         ...
         for (je $$91 : je.c.a) {
            ...
            if ($$98 && !a($$0, $$1, $$91, Math.max($$92, $$93), $$0.a_($$1.a($$91)))) {
               ...
               if (!$$5) {
                  deu $$122 = $$0.a_($$120).b();
                  if ($$122 instanceof dik || $$122 instanceof dje) {
                     $$121 = this.d;
                  }
               }
   ...
   private float a(daw $$0, enp $$1, float $$2, float $$3, float $$4, iz $$5) {
      if (!($$4 >= 1.0F) && !($$3 >= 1.0F)) {
         float[] $$6 = new float[2];
         if ($$4 > 0.0F || $$3 > 0.0F) {
   ...
   private float a(daw $$0, enp $$1, iz $$2) {
      drx $$3 = $$0.a_($$2);
      return this.a($$0, $$1, $$2, $$3, $$3.u());
   }

   private float a(daw $$0, enp $$1, iz $$2, drx $$3, enq $$4) {
      if ($$1.a($$4.a())) {
         drx $$5 = $$0.a_($$2.c());
   ...
   private void a(ezx $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3).a($$4, $$5, $$6, 1.0F).a($$7, $$8).b($$9).a(0.0F, 1.0F, 0.0F).e();
   }

   private int a(daw $$0, iz $$1) {
      int $$2 = gdh.a($$0, $$1);
      int $$3 = gdh.a($$0, $$1.c());
      int $$4 = $$2 & 0xFF;
      int $$5 = $$3 & 0xFF;
