...
public abstract class ezn<T extends ezn<T>> {
   ...
   public ezn(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ezl.a();
         if ($$3 != null) {
         ...
         throw new faw(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new faw(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new faw(var2.getMessage(), var2);
      }
   }
   ...
   public static ezn<?> a(String $$0) {
      return new ezn.b($$0, 5000, 60000);
   }

   public static ezn<?> a(String $$0, int $$1, int $$2) {
      return new ezn.b($$0, $$1, $$2);
   }

   public static ezn<?> b(String $$0, String $$1) {
      return new ezn.c($$0, $$1, 5000, 60000);
   }

   public static ezn<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ezn.c($$0, $$1, $$2, $$3);
   }

   public static ezn<?> b(String $$0) {
      return new ezn.a($$0, 5000, 60000);
   }

   public static ezn<?> c(String $$0, String $$1) {
      return new ezn.d($$0, $$1, 5000, 60000);
   }

   public static ezn<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ezn.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ezn<ezn.a> {
   ...
   public static class b extends ezn<ezn.b> {
   ...
   public static class c extends ezn<ezn.c> {
      ...
      public ezn.c f() {
         try {
            ...
            throw new faw(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ezn<ezn.d> {
      private final String c;
