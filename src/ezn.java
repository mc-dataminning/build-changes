...
public class ezn {
   private final List<ConcurrentLinkedQueue<ezm>> a = ImmutableList.of(
   ...
   public void a(ezm $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ezm> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ezm> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ezm> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ezm> j() {
