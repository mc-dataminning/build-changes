public class ezn extends fak<cep> {
   private static final aey x = new aey("container/anvil/text_field");
   private static final aey y = new aey("container/anvil/text_field_disabled");
   private static final aey z = new aey("container/anvil/error");
   private static final aey A = new aey("textures/gui/container/anvil.png");
   private static final tn B = tn.c("container.repair.expensive");
   private etb C;
   private final cbw D;

   public ezn(cep $$0, cbv $$1, tn $$2) {
      super($$0, $$1, $$2, A);
      this.D = $$1.m;
      this.l = 60;
   }
   ...
   protected void F() {
      ...
      this.C = new etb(this.i, $$0 + 62, $$1 + 24, 103, 12, tn.c("container.repair"));
      this.C.f(false);
      this.C.m(-1);
      this.C.n(-1);
      this.C.d(false);
   ...
   protected void b(esh $$0, int $$1, int $$2) {
      ...
      if ($$3 > 0) {
         ...
         if ($$3 >= 40 && !this.f.s.fS().d) {
            ...
            $$5 = tn.a("container.repair.cost", $$3);
   ...
   @Override
   public void d(esh $$0, int $$1, int $$2, float $$3) {
      this.C.a($$0, $$1, $$2, $$3);
   }
