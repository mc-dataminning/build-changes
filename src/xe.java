...
public class xe {
   public static <T extends wv> xe.b a(wx<T> $$0) {
      return a(new wt<T>($$0));
   }

   private static xe.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends wv> xe.d b(wx<T> $$0) {
      return a(new wu<T>($$0));
   }

   private static xe.d a(ChannelOutboundHandler $$0) {
