...
public class aze {
   ...
   public static jf<czu> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return mg.g.c(ali.a($$2)).orElseThrow(() -> new JsonSyntaxException("Expected " + $$1 + " to be an item, was unknown string '" + $$2 + "'"));
      } else {
         throw new JsonSyntaxException("Expected " + $$1 + " to be an item, was " + d($$0));
      }
   }

   public static jf<czu> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jf<czu> a(JsonObject $$0, String $$1, @Nullable jf<czu> $$2) {
   ...
   public static boolean a(JsonElement $$0, int $$1) {
      try {
         Streams.write($$0, new JsonWriter(Streams.writerForAppendable(new aze.a($$1))));
         return false;
