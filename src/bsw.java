...
public class bsw extends btd {
   public static final MapCodec<bsw> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  btd.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bsw a(btd $$0, int $$1, int $$2) {
      return new bsw($$0, $$1, $$2);
   }

   public bsw(btd $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
