...
public class rv implements ru {
   ...
   public void a(ro $$0) {
      ...
      tl $$3 = tl.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = tl.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(qu $$0) {
      tl $$1 = tl.b("b").a(g);
      this.t = tl.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(rb $$0) {
      this.t = tl.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(qz $$0) {
      tl $$1 = tl.b("f").a(g);
      this.t = tl.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(qx $$0) {
      tl $$1 = tl.b("d").a(g);
      this.t = tl.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(ra $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(tl.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(rd $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         tl $$5 = tl.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(rc $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new rv(this.r, this.s).a($$0.k($$3)));
         }
   ...
   protected static tl a(String $$0) {
      if (h.matcher($$0).matches()) {
         return tl.b($$0).a(d);
      } else {
         String $$1 = ro.b($$0);
         String $$2 = $$1.substring(0, 1);
         tl $$3 = tl.b($$1.substring(1, $$1.length() - 1)).a(d);
         return tl.b($$2).b($$3).f($$2);
      }
   }
