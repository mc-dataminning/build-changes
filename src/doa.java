...
public class doa extends dnn<dpk> {
   public doa(Codec<dpk> $$0) {
      super($$0);
   }
   ...
   private void a(aru $$0, cpn $$1, int $$2, int $$3, gu $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, gu $$2, cpn $$3, boolean $$4, double $$5, gu $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cpn $$0, gu $$1) {
      if ($$0.a_($$1.c()).a(csn.dN)) {
         this.a($$0, $$1.c(), csn.a.n());
      }
   }

   private void a(cpn $$0, aru $$1, gu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dfa $$13) {
   ...
   private void a(gu $$0, cpn $$1, aru $$2, int $$3, int $$4, boolean $$5, boolean $$6, dfa $$7) {
      dfa $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(csn.dP) || $$8.a(csn.dO) || $$8.a(csn.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(csn.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, csn.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dfa $$0) {
      return $$0.a(csn.iC) || $$0.a(csn.dP) || $$0.a(csn.mW);
   }
   ...
   private void a(cpn $$0, gu $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(csn.dN)) {
                  if (this.a((cos)$$0, $$10)) {
                     this.a($$0, $$10, csn.a.n());
                     this.a($$0, $$10.c(), csn.a.n());
                  } else if (c($$11)) {
                     dfa[] $$12 = new dfa[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
