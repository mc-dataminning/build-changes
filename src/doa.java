...
@Deprecated
public class doa extends dnl<doa.a> {
   private static final dey a = csl.nc.n();

   public doa(Codec<doa.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dnn<doa.a> $$0) {
      gv $$1 = $$0.e();
      cqe $$2 = $$0.b();
      art $$3 = $$0.d();
      doa.a $$4 = $$0.f();
   ...
   public static record a(drq b, drq c) implements dpp {
      public static final Codec<doa.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(drq.a.fieldOf("fluid").forGetter(doa.a::a), drq.a.fieldOf("barrier").forGetter(doa.a::b)).apply($$0, doa.a::new)
      );
