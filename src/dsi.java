...
public class dsi extends dsc<duh> {
   private static final ic[] a = ic.values();

   public dsi(Codec<duh> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dse<duh> $$0) {
      duh $$1 = $$0.f();
      auw $$2 = $$0.d();
      hx $$3 = $$0.e();
      cus $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dpx $$9 = new dpx(new doz($$4.C()));
      eec $$10 = eec.a($$9, -4, 1.0);
      ...
      for (hx $$33 : hx.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<hx, Integer> $$37 : $$7) {
            $$35 += aup.f($$33.j((jb)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (hx $$38 : $$11) {
            $$36 += aup.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, cxa.a.o(), $$32);
      ...
      for (hx $$44 : $$31) {
         ...
         for (ic $$46 : a) {
            ...
            djp $$48 = $$4.a_($$47);
            if ($$45.b(dkf.C)) {
               $$45 = $$45.a(dkf.C, Boolean.valueOf($$48.u().b()));
            }
