...
public class dsi<T> implements dsk<T> {
   ...
   private dsi(ja<T> $$0, int $$1, dsl<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dsi(ja<T> $$0, T[] $$1, dsl<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dsk<T> c() {
      return new dsi<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
