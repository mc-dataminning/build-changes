...
public class dsi {
   private static final dme a = czh.hj.o();
   private static final dme b = czh.hk.o();
   private static final dme c = czh.iA.o();
   private static final dme d = czh.hn.o();
   private static final dme e = czh.hv.o();
   private static final dme f = czh.hx.o();
   private static final dme g = czh.hr.o();
   private static final dme h = czh.iC.o();
   private static final dme i = czh.dP.o();
   private final dme j;
   private final int k;
   private final dme[] l;
   private final egu m;
   ...
   public dsi(dse $$0, dme $$1, int $$2, dsd $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(drz.P);
      this.l = a($$3.a(new ajc("clay_bands")));
      this.u = $$0.a(drz.N);
      this.v = $$0.a(drz.O);
      this.n = $$0.a(drz.Q);
      this.o = $$0.a(drz.R);
   ...
   public void a(dse $$0, cxf $$1, ix<cxd> $$2, boolean $$3, dsn $$4, final doa $$5, dru $$6, dsh.o $$7) {
      ...
      dsh.g $$13 = new dsh.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dsh.u $$14 = $$7.apply($$13);
      ib.a $$15 = new ib.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(drq.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            il<cxd> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cxk.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(drq.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   private boolean a(dme $$0) {
      return !$$0.i() && $$0.u().c();
   }

   @Deprecated
   public Optional<dme> a(dsh.o $$0, dtq $$1, Function<ib, il<cxd>> $$2, doa $$3, dru $$4, ib $$5, boolean $$6) {
      dsh.g $$7 = new dsh.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(ki.au), $$1);
      dsh.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dme $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dnx $$0, int $$1, int $$2, int $$3, cwg $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cxd $$1, dnx $$2, ib.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(czh.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(awt $$0, dme[] $$1, int $$2, dme $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dme a(int $$0, int $$1, int $$2) {
