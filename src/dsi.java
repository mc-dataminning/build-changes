...
@Deprecated
public class dsi extends drt<dsi.a> {
   private static final djg a = cwr.nc.o();

   public dsi(Codec<dsi.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(drv<dsi.a> $$0) {
      hx $$1 = $$0.e();
      cuj $$2 = $$0.b();
      auu $$3 = $$0.d();
      dsi.a $$4 = $$0.f();
   ...
   public static record a(dvy b, dvy c) implements dtx {
      public static final Codec<dsi.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dvy.a.fieldOf("fluid").forGetter(dsi.a::a), dvy.a.fieldOf("barrier").forGetter(dsi.a::b)).apply($$0, dsi.a::new)
      );
