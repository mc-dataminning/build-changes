...
public class dsi {
   ...
   public dsi(dcg $$0, ja $$1, jf $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dsl $$0 = this.b.a_(this.e);
      if (!dse.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eoo.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dsl $$0) {
      return $$0.a(dfk.hV) || $$0.a(dfk.pg);
   }

   private static boolean a(dsl $$0, dsl $$1) {
      if ($$0.a(dfk.pg) && $$1.a(dfk.hV)) {
         return false;
      } else {
         return $$0.a(dfk.hV) && $$1.a(dfk.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ja $$0, jf $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dse.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dsl $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dse.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dse.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
