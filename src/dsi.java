...
public class dsi {
   ...
   private final Map<Character, Predicate<dsg>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsi a(char $$0, Predicate<dsg> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dsh b() {
      return new dsh(this.c());
   }

   private Predicate<dsg>[][][] c() {
      this.d();
      Predicate<dsg>[][][] $$0 = (Predicate<dsg>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsg>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
