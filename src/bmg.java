...
public class bmg<E extends bjo> extends bld<E> {
   ...
   protected List<bmg.a> h = Lists.newArrayList();
   protected Optional<ehh> i = Optional.empty();
   @Nullable
   protected ehh j;
   protected int k;
   protected long l;
   private final Function<E, apf> q;
   private final BiPredicate<E, gw> r;

   public bmg(bgp $$0, int $$1, int $$2, float $$3, Function<E, apf> $$4) {
      this($$0, $$1, $$2, $$3, $$4, bmg::a);
   }

   public static <E extends bjo> boolean a(E $$0, gw $$1) {
      cqb $$2 = $$0.dL();
      gw $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(eba.a($$2, $$1.j())) == 0.0F;
   }

   public bmg(bgp $$0, int $$1, int $$2, float $$3, Function<E, apf> $$4, BiPredicate<E, gw> $$5) {
      super(ImmutableMap.of(bsn.n, bso.c, bsn.R, bso.b, bsn.S, bso.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(akt $$0, bjo $$1) {
      boolean $$2 = $$1.aA() && !$$1.aX() && !$$1.bl() && !$$0.a_($$1.dl()).a(cte.pg);
      if (!$$2) {
         $$1.dN().a(bsn.R, this.p.a($$0.z) / 2);
      }

      return $$2;
   }

   protected boolean b(akt $$0, bjo $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.dj()) && this.k > 0 && !$$1.ba() && (this.j != null || !this.h.isEmpty());
      if (!$$3 && $$1.dN().c(bsn.S).isEmpty()) {
         $$1.dN().a(bsn.R, this.p.a($$0.z) / 2);
         $$1.dN().b(bsn.n);
      }
   ...
   protected void a(akt $$0, E $$1, long $$2) {
      ...
      this.h = gw.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new bmg.a($$1x.i(), asb.c($$3.j($$1x))))
   ...
   protected void c(akt $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.f(this.j.a($$4 / $$3));
            $$1.dN().a(bsn.S, true);
            $$0.a(null, $$1, this.q.apply($$1), aph.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   protected Optional<bmg.a> a(akt $$0) {
      Optional<bmg.a> $$1 = bfr.a($$0.z, this.h);
      $$1.ifPresent(this.h::remove);
      return $$1;
   }

   private boolean a(akt $$0, E $$1, gw $$2) {
      gw $$3 = $$1.dl();
      int $$4 = $$3.u();
      int $$5 = $$3.w();
   ...
   @Nullable
   private ehh a(bjo $$0, ehh $$1, int $$2) {
      ehh $$3 = $$0.dj();
      ehh $$4 = new ehh($$1.c - $$3.c, 0.0, $$1.e - $$3.e).d().a(0.5);
      $$1 = $$1.d($$4);
      ehh $$5 = $$1.d($$3);
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            for (int $$26 = 0; $$26 < $$22 - 1; $$26++) {
               ...
               double $$28 = $$23 * $$17;
               double $$29 = $$23 * $$16;
               ehh $$30 = new ehh($$3.c + $$28, $$3.d + $$27, $$3.e + $$29);
            ...
            return new ehh($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }

   private boolean a(bjo $$0, bix $$1, ehh $$2, ehh $$3) {
      ehh $$4 = $$3.d($$2);
   ...
   public static class a extends bfq.a {
      private final gw a;
