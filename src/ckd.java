...
public class ckd extends cld {
   ...
   public ckd(int $$0, chg $$1) {
      this($$0, $$1, ckm.a);
   }

   public ckd(int $$0, chg $$1, ckm $$2) {
      super(cli.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cle l() {
      return cle.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected void a(chh $$0, coz $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dlf $$3 = $$1x.a_($$2x);
         if (!$$0.fU().d && $$3.a(atz.M) && $$0.eh().i() < 0.12F) {
            dlf $$4 = cxo.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         coz $$4 = $$0.q();
         coz $$5 = this.q.a(1);
         Map<cti, Integer> $$6 = ctj.a($$4);
         $$2 += $$0.J() + ($$5.b() ? 0 : $$5.J());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cpc.us) && !cnv.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cti, Integer> $$16 = ctj.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cti $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fU().d || $$0.a(cpc.us)) {
                        $$22 = true;
                     }
