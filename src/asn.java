...
public class asn {
   ...
   asn(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static asn.a a() {
      return new asn.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(asn::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public asn.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public asn a(Writer $$0) throws IOException {
