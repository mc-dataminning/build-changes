...
public record asn(List<asn.a> b) {
   ...
   public static record a(aye<Integer> a, String b) {
      static final Codec<asn.a> c = RecordCodecBuilder.create(
         $$0 -> $$0.group(aye.a(Codec.INT).fieldOf("formats").forGetter(asn.a::a), axu.<String>b(Codec.STRING, asn::a).fieldOf("directory").forGetter(asn.a::b))
               .apply($$0, asn.a::new)
      );
