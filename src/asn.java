...
public class asn<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return asn.this.get(this.b--);
      }

      @Override
      public void remove() {
         asn.this.remove(this.b + 1);
      }
   }
}
