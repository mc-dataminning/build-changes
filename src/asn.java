...
public class asn implements asj {
   private static final Logger c = LogUtils.getLogger();
   private final asi d;
   private final asb e;
   private final Set<String> f;
   private final List<Path> g;
   private final Map<asl, List<Path>> h;

   asn(asi $$0, asb $$1, Set<String> $$2, List<Path> $$3, Map<asl, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(asl $$0, akn $$1, Consumer<Path> $$2) {
      v.c($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(asl $$0, String $$1, String $$2, asj.a $$3) {
      v.c($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<akn, atp<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asj.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      asm.a($$1, $$4, $$3, $$0);
   }
   ...
   public atp<InputStream> a(asl $$0, akn $$1) {
      return (atp<InputStream>)v.c($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && asm.a($$5)) {
               return atp.create($$5);
            }
         }
   ...
   public <T> T a(asw<T> $$0) {
      atp<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public aua d() {
      return $$0 -> Optional.ofNullable(this.a(asl.a, $$0)).map($$0x -> new atv(this, $$0x));
   }
}
