...
public class nf implements mi {
   ...
   private final Set<akt<evw>> f;
   private final List<nf.a> g;
   private final CompletableFuture<jt.a> h;

   public nf(mk $$0, Set<akt<evw>> $$1, List<nf.a> $$2, CompletableFuture<jt.a> $$3) {
      this.e = $$0.a(mc.bg);
      this.g = $$2;
      this.f = $$1;
      this.h = $$3;
   ...
   private CompletableFuture<?> a(mg $$0, jt.a $$1) {
      ...
      Map<edh.a, aku> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().apply($$1).generate(($$3xx, $$4x) -> {
            aku $$5x = a($$3xx);
            aku $$6x = $$3.put(bsn.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      for (akt<evw> $$8 : Sets.difference(this.f, $$2.j())) {
   ...
   private static aku a(akt<evw> $$0) {
      return $$0.a();
   }
