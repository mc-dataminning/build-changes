...
public class ng implements mh {
   ...
   private final Set<aly<ewt>> f;
   private final List<ng.a> g;
   private final CompletableFuture<js.a> h;

   public ng(mj $$0, Set<aly<ewt>> $$1, List<ng.a> $$2, CompletableFuture<js.a> $$3) {
      this.e = $$0.a(mb.bg);
      this.g = $$2;
      this.f = $$1;
      this.h = $$3;
   ...
   private CompletableFuture<?> a(mf $$0, js.a $$1) {
      km<ewt> $$2 = new jy<>(mb.bg, Lifecycle.experimental());
      Map<eee.a, alz> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().apply($$1).generate(($$3xx, $$4x) -> {
            alz $$5x = a($$3xx);
            alz $$6x = $$3.put(btm.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      for (aly<ewt> $$8 : Sets.difference(this.f, $$2.j())) {
      ...
      if (!$$9.isEmpty()) {
         ...
         return CompletableFuture.allOf($$2.k().stream().map($$2x -> {
            aly<ewt> $$3x = (aly<ewt>)$$2x.getKey();
            ewt $$4x = (ewt)$$2x.getValue();
            Path $$5x = this.e.a($$3x.a());
            return mh.a($$0, $$1, ewt.d, $$4x, $$5x);
         }).toArray(CompletableFuture[]::new));
      }
   }

   private static alz a(aly<ewt> $$0) {
      return $$0.a();
   }
