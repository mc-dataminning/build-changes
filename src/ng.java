...
public class ng implements mh {
   ...
   private final Set<aly<ewu>> f;
   private final List<ng.a> g;
   private final CompletableFuture<js.a> h;

   public ng(mj $$0, Set<aly<ewu>> $$1, List<ng.a> $$2, CompletableFuture<js.a> $$3) {
      this.e = $$0.a(mb.bg);
      this.g = $$2;
      this.f = $$1;
      this.h = $$3;
   ...
   private CompletableFuture<?> a(mf $$0, js.a $$1) {
      km<ewu> $$2 = new jy<>(mb.bg, Lifecycle.experimental());
      Map<eef.a, alz> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().apply($$1).generate(($$3xx, $$4x) -> {
            alz $$5x = a($$3xx);
            alz $$6x = $$3.put(btn.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      ewv $$6 = new ewv($$4, ezi.q, $$5);

      for (aly<ewu> $$8 : Sets.difference(this.f, $$2.j())) {
         $$4.b("Missing built-in table: " + $$8.a());
      }

      $$2.c().forEach($$1x -> ((ewu)$$1x.a()).a($$6.a(((ewu)$$1x.a()).a()).a("{" + $$1x.h().a() + "}", $$1x.h())));
      ...
      if (!$$9.isEmpty()) {
         ...
         return CompletableFuture.allOf($$2.k().stream().map($$2x -> {
            aly<ewu> $$3x = (aly<ewu>)$$2x.getKey();
            ewu $$4x = (ewu)$$2x.getValue();
            Path $$5x = this.e.a($$3x.a());
            return mh.a($$0, $$1, ewu.d, $$4x, $$5x);
         }).toArray(CompletableFuture[]::new));
      }
   }

   private static alz a(aly<ewu> $$0) {
      return $$0.a();
   }
   ...
   public static record a(Function<js.a, nh> a, bbo b) {
   }
}
