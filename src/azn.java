...
public class azn implements axn {
   ...
   public azn(int $$0, int $$1) {
      this($$0, $$1, (long[])null);
   }

   public azn(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new azn.a("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   @Override
   public axn d() {
      return new azn(this.c, this.e, (long[])this.b.clone());
   }
