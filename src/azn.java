...
public class azn {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> ayp.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> ayp.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<azn.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alz.d($$0.substring(1)).map($$0x -> new azn.c($$0x, true)) : alz.d($$0).map($$0x -> new azn.c($$0x, false)), azn.c::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bbb.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static <K, V> azn.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new azn.b<>($$0, $$1);
   }
   ...
   public static record c(alz a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
