...
public final class aiz<E> implements Codec<il<E>> {
   private final ajb<? extends ix<E>> a;

   public static <E> aiz<E> a(ajb<? extends ix<E>> $$0) {
      return new aiz<>($$0);
   }

   private aiz(ajb<? extends ix<E>> $$0) {
      this.a = $$0;
   }
