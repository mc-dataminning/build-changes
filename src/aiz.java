...
public class aiz {
   ...
   private static int a(ds $$0, anf $$1) {
      GameProfile $$2 = $$1.fR();
      $$1.c.o();
      $$0.a(() -> vg.b("Switched player " + $$2.getName() + "(" + $$2.getId() + ") to config mode"), false);
      return 1;
   }
   ...
   private static int a(ds $$0, UUID $$1) {
      ...
      $$0.b(vg.b("Can't find player to unconfig"));
      return 0;
   }
}
