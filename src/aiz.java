   ...
   private static int a(du $$0, int $$1, boolean $$2) {
      ...
      for (int $$11 = $$7; $$11 <= $$8; $$11++) {
         for (int $$12 = $$9; $$12 <= $$10; $$12++) {
            cqg $$13 = new cqg($$12, $$11);
            dii $$14 = $$4.a($$12, $$11, false);
            if ($$14 != null && (!$$2 || !$$14.s())) {
      ...
      bgu<Runnable> $$16 = bgu.a(ac.f(), "worldgen-resetchunks");
      long $$17 = System.currentTimeMillis();
      int $$18 = ($$1 * 2 + 1) * ($$1 * 2 + 1);
      UnmodifiableIterator var33 = ImmutableList.of(dic.f, dic.g, dic.h, dic.i, dic.j, dic.k).iterator();

      while (var33.hasNext()) {
         dic $$19 = (dic)var33.next();
         ...
         for (int $$22 = $$6.f - $$1; $$22 <= $$6.f + $$1; $$22++) {
            for (int $$23 = $$6.e - $$1; $$23 <= $$6.e + $$1; $$23++) {
               cqg $$24 = new cqg($$23, $$22);
               dii $$25 = $$4.a($$23, $$22, false);
               if ($$25 != null && (!$$2 || !$$25.s())) {
                  List<dhx> $$26 = Lists.newArrayList();
                  int $$27 = Math.max(1, $$19.e());

                  for (int $$28 = $$24.f - $$27; $$28 <= $$24.f + $$27; $$28++) {
                     for (int $$29 = $$24.e - $$27; $$29 <= $$24.e + $$27; $$29++) {
                        dhx $$30 = $$4.a($$29, $$28, $$19.d(), true);
                        dhx $$31;
                        if ($$30 instanceof dih) {
                           $$31 = new dih(((dih)$$30).C(), true);
                        } else if ($$30 instanceof dii) {
                           $$31 = new dih((dii)$$30, true);
                        } else {
                           $$31 = $$30;
                        }
                  ...
                  $$21 = $$21.thenComposeAsync($$5x -> $$19.a($$16::a, $$3, $$4.g(), $$3.p(), $$4.a(), $$0xx -> {
                        ...
                        if ($$19 == dic.g) {
                           $$1xx.left().ifPresent($$0xxx -> dlk.a($$0xxx, dic.b));
                        }
      ...
      for (int $$35 = $$6.f - $$1; $$35 <= $$6.f + $$1; $$35++) {
         for (int $$36 = $$6.e - $$1; $$36 <= $$6.e + $$1; $$36++) {
            cqg $$37 = new cqg($$36, $$35);
            dii $$38 = $$4.a($$36, $$35, false);
            if ($$38 != null && (!$$2 || !$$38.s())) {
