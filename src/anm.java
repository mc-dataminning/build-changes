...
public class anm implements anj {
   ...
   public anm(ami $$0, List<amh> $$1) {
      this.c = List.copyOf($$1);
      Map<String, ank> $$2 = new HashMap<>();
      List<String> $$3 = $$1.stream().flatMap($$1x -> $$1x.a($$0).stream()).distinct().toList();

      for (amh $$4 : $$1) {
         ans $$5 = this.a($$4);
         Set<String> $$6 = $$4.a($$0);
         Predicate<aew> $$7 = $$5 != null ? $$1x -> $$5.b($$1x.a()) : null;
   ...
   public Map<aew, anr> b(String $$0, Predicate<aew> $$1) {
      a($$0);
      Map<aew, anr> $$2 = new TreeMap<>();

      for (ank $$3 : this.b.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<aew, List<anr>> c(String $$0, Predicate<aew> $$1) {
      a($$0);
      Map<aew, List<anr>> $$2 = new TreeMap<>();
