...
public class anm {
   ...
   public static void a(CommandDispatcher<ex> $$0, et $$1) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("locate").requires($$0x -> $$0x.c(2)))
                  .then(ey.a("structure").then(ey.a("structure", gb.a(mc.aW)).executes($$0x -> a((ex)$$0x.getSource(), gb.a($$0x, "structure", mc.aW, c))))))
               .then(ey.a("biome").then(ey.a("biome", ga.a($$1, mc.aJ)).executes($$0x -> a((ex)$$0x.getSource(), ga.a($$0x, "biome", mc.aJ))))))
            .then(ey.a("poi").then(ey.a("poi", ga.a($$1, mc.aa)).executes($$0x -> b((ex)$$0x.getSource(), ga.a($$0x, "poi", mc.aa)))))
      );
   }

   private static Optional<? extends jv.b<eoj>> a(gb.c<eoj> $$0, ke<eoj> $$1) {
      return (Optional<? extends jv.b<eoj>>)$$0.a().map($$1x -> $$1.a($$1x).map($$0xx -> jv.a($$0xx)), $$1::a);
   }

   private static int a(ex $$0, gb.c<eoj> $$1) throws CommandSyntaxException {
      ke<eoj> $$2 = $$0.e().F_().e(mc.aW);
      jv<eoj> $$3 = (jv<eoj>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      ji $$4 = ji.a((kb)$$0.d());
      ard $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(af.d);
      Pair<ji, jr<eoj>> $$7 = $$5.m().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(ex $$0, ga.c<dic> $$1) throws CommandSyntaxException {
      ji $$2 = ji.a((kb)$$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(af.d);
      Pair<ji, jr<dic>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(ex $$0, ga.c<chf> $$1) throws CommandSyntaxException {
      ji $$2 = ji.a((kb)$$0.d());
      ard $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(af.d);
      Optional<Pair<jr<chf>, ji>> $$5 = $$3.A().e($$1, $$2, 256, chc.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(ex $$0, ji $$1, Pair<ji, ? extends jr<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      ...
      wp $$10 = ws.a((wp)wp.a("chat.coordinates", $$7.u(), $$9, $$7.w()))
         .a($$2x -> $$2x.a(n.k).a(new wn.g("/tp @s " + $$7.u() + " " + $$9 + " " + $$7.w())).a(new wv.e(wp.c("chat.coordinates.tooltip"))));
