...
public class anm {
   ...
   public static void a(CommandDispatcher<ee> $$0) {
      RequiredArgumentBuilder<ee, akn> $$1 = (RequiredArgumentBuilder<ee, akn>)ef.a("sound", ff.a())
         .suggests(ic.c)
         .executes($$0x -> a((ee)$$0x.getSource(), a(((ee)$$0x.getSource()).i()), ff.c($$0x, "sound"), avj.a, ((ee)$$0x.getSource()).d(), 1.0F, 1.0F, 0.0F));
   ...
   private static LiteralArgumentBuilder<ee> a(avj $$0) {
   ...
   private static Collection<aqo> a(@Nullable aqo $$0) {
      return $$0 != null ? List.of($$0) : List.of();
   }

   private static int a(ee $$0, Collection<aqo> $$1, akn $$2, avj $$3, eum $$4, float $$5, float $$6, float $$7) throws CommandSyntaxException {
      ix<avh> $$8 = ix.a(avh.a($$2));
      double $$9 = (double)ayf.k($$8.a().a($$5));
      int $$10 = 0;
      long $$11 = $$0.e().E_().g();
      ...
      for (aqo $$12 : $$1) {
         ...
         if ($$16 > $$9) {
            ...
            $$17 = new eum($$12.du() + $$13 / $$19 * 2.0, $$12.dw() + $$14 / $$19 * 2.0, $$12.dA() + $$15 / $$19 * 2.0);
            $$18 = $$7;
         }

         $$12.c.b(new afl($$8, $$3, $$17.a(), $$17.b(), $$17.c(), $$18, $$6, $$11));
         $$10++;
      }
