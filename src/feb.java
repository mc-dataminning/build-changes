...
public abstract class feb extends fda {
   private final did b;
   private die c;
   private final String[] k;
   private final boolean l;
   protected final dkt a;
   private int m;
   private int n;
   @Nullable
   private ezx o;

   public feb(did $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, vf.c("sign.edit"));
   }

   public feb(did $$0, boolean $$1, boolean $$2, vf $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
   ...
   @Override
   protected void aN_() {
      this.d(exf.a(ve.d, $$0 -> this.E()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new ezx(() -> this.k[this.n], this::a, ezx.a(this.f), ezx.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   protected abstract void a(ewt var1, djg var2);
   ...
   private void d(ewt $$0) {
      ...
      Vector3f $$1 = this.n();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fvu.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(fto.D(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
