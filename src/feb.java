...
public class feb extends fed {
   ...
   static final feb.b l = new feb.b(854, 480);
   ...
   static enum a {
      ...
      private static final feb.a[] e = values();
   ...
   static class b {
      ...
      static List<feb.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new feb.b($$0, $$1), feb.l) : ImmutableList.of(feb.l);
      }
