...
public abstract class feb<T extends feb<T>> {
   ...
   public feb(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fdz.a();
         if ($$3 != null) {
         ...
         throw new ffi(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ffi(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ffi(var2.getMessage(), var2);
      }
   }
   ...
   public static feb<?> a(String $$0) {
      return new feb.b($$0, 5000, 60000);
   }

   public static feb<?> a(String $$0, int $$1, int $$2) {
      return new feb.b($$0, $$1, $$2);
   }

   public static feb<?> b(String $$0, String $$1) {
      return new feb.c($$0, $$1, 5000, 60000);
   }

   public static feb<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new feb.c($$0, $$1, $$2, $$3);
   }

   public static feb<?> b(String $$0) {
      return new feb.a($$0, 5000, 60000);
   }

   public static feb<?> c(String $$0, String $$1) {
      return new feb.d($$0, $$1, 5000, 60000);
   }

   public static feb<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new feb.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends feb<feb.a> {
   ...
   public static class b extends feb<feb.b> {
   ...
   public static class c extends feb<feb.c> {
      ...
      public feb.c f() {
         try {
            ...
            throw new ffi(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends feb<feb.d> {
      private final String c;
