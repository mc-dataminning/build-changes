public abstract class feb<T extends cic> extends fea<T> implements fgv {
   public final fgl x;
   private boolean y;
   private final ahg z;
   private final ahg A;
   ...
   public feb(T $$0, fgl $$1, cfh $$2, vf $$3, ahg $$4, ahg $$5, ahg $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aN_() {
      ...
      this.d(new exs(this.t + 20, this.h / 2 - 49, 20, 18, fgp.a, $$0 -> {
         this.x.e();
         this.t = this.x.a(this.g, this.c);
   ...
   protected void a(ewu $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.p.s()) {
         int $$6 = 14;
         int $$7 = auo.f(this.p.r() * 13.0F) + 1;
         $$0.a(this.A, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = auo.f(this.p.q() * 24.0F);
