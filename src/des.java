...
public class des {
   public static final Codec<des> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> ae.a($$0, 2).map($$0x -> new des($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.g, $$0.h))
      .stable();
   public static final zh<ByteBuf, des> b = new zh<ByteBuf, des>() {
      public des a(ByteBuf $$0) {
         return wg.c($$0);
      }

      public void a(ByteBuf $$0, des $$1) {
         wg.a($$0, $$1);
      }
   };
   private static final int i = 1056;
   public static final long c = c(1875066, 1875066);
   public static final des d = new des(0, 0);
   ...
   public static des a(int $$0, int $$1) {
      return new des($$0 << 5, $$1 << 5);
   }

   public static des b(int $$0, int $$1) {
      return new des(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof des $$1) ? false : this.g == $$1.g && this.h == $$1.h;
      }
   }
   ...
   public static Stream<des> a(des $$0, int $$1) {
      return a(new des($$0.g - $$1, $$0.h - $$1), new des($$0.g + $$1, $$0.h + $$1));
   }

   public static Stream<des> a(final des $$0, final des $$1) {
      int $$2 = Math.abs($$0.g - $$1.g) + 1;
      int $$3 = Math.abs($$0.h - $$1.h) + 1;
      final int $$4 = $$0.g < $$1.g ? 1 : -1;
      final int $$5 = $$0.h < $$1.h ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<des>((long)($$2 * $$3), 64) {
         @Nullable
         private des e;

         @Override
         public boolean tryAdvance(Consumer<? super des> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.g;
               ...
               if ($$1 == $$1.g) {
                  ...
                  this.e = new des($$0.g, $$2 + $$5);
               } else {
                  this.e = new des($$1 + $$4, $$2);
               }
            }
