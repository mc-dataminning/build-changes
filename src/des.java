...
public class des {
   public static final des a = new des(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<des> b = RecordCodecBuilder.create(
   ...
   public des(List<String> $$0, List<String> $$1) {
