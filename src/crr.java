...
public class crr extends css {
   ...
   public crr(int $$0, col $$1) {
      this($$0, $$1, csb.a);
   }

   public crr(int $$0, col $$1, csb $$2) {
      super(csx.i, $$0, $$1, $$2);
      this.a(this.y);
   }
   ...
   @Override
   protected cst l() {
      return cst.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   @Override
   protected boolean a(com $$0, boolean $$1) {
      return ($$0.fX() || $$0.cq >= this.y.b()) && this.y.b() > 0;
   }

   @Override
   protected void a(com $$0, cwb $$1) {
      if (!$$0.gl().d) {
         $$0.c(-this.y.b());
      }
      ...
      this.q.a(($$1x, $$2x) -> {
         dvj $$3 = $$1x.a_($$2x);
         if (!$$0.fX() && $$3.a(axa.N) && $$0.ea().i() < 0.12F) {
            dvj $$4 = dhe.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
      ...
      if (!$$0.f() && dbu.a($$0)) {
         ...
         if (!$$5.f()) {
            ...
            if ($$4.m() && $$0.b($$5)) {
               ...
               for (Entry<jq<dbs>> $$19 : $$16.b()) {
                  jq<dbs> $$20 = (jq<dbs>)$$19.getKey();
                  int $$21 = $$6.a($$20);
                  int $$22 = $$19.getIntValue();
                  $$22 = $$21 == $$22 ? $$22 + 1 : Math.max($$22, $$21);
                  dbs $$23 = $$20.a();
                  boolean $$24 = $$23.c($$0);
                  if (this.r.gl().d || $$0.a(cwf.uy)) {
                     $$24 = true;
                  }

                  for (jq<dbs> $$25 : $$6.a()) {
                     if (!$$25.equals($$20) && !dbs.a($$20, $$25)) {
                        $$24 = false;
                        $$1++;
                     }
                  }
         ...
         int $$27 = (int)azk.a($$2 + (long)$$1, 0L, 2147483647L);
         this.y.a($$27);
         if ($$1 <= 0) {
            $$4 = cwb.k;
         }
