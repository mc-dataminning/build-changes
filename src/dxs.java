...
public class dxs extends dxv<dxr> {
   public dxs(Codec<dxr> $$0) {
      super($$0);
   }

   public boolean a(dxr $$0, ayd $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dxq $$0, dxr $$1, dru $$2, Function<im, iv<dat>> $$3, ayd $$4, dvc $$5, czb $$6, drt $$7) {
      int $$8 = jo.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dxv.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dxq $$0, dxr $$1, dru $$2, Function<im, iv<dat>> $$3, dvc $$4, double $$5, double $$6, double $$7, float $$8, double $$9, drt $$10, dxv.a $$11
   ) {
      double $$12 = 1.5 + (double)(axw.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(axw.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = axw.b($$13);
         $$6 += (double)(axw.b($$12) * $$27);
         $$7 += (double)axw.a($$13);
         $$8 += (double)(axw.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
