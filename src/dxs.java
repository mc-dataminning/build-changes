...
public class dxs {
   ...
   public dxs(dhi $$0, jh $$1, jm $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dxv $$0 = this.b.a_(this.e);
      if (!dxo.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == euc.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dxv $$0) {
      return $$0.a(dko.im) || $$0.a(dko.pB);
   }

   private static boolean a(dxv $$0, dxv $$1) {
      if ($$0.a(dko.pB) && $$1.a(dko.im)) {
         return false;
      } else {
         return $$0.a(dko.im) && $$1.a(dko.pB) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jh $$0, jm $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dxo.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dxv $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dxo.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dxo.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
