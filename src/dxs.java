...
public class dxs implements dxu {
   public static final Codec<dxs> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bmh.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bmh.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bmh.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bmf.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bmf.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dxs(int $$0, bmh $$1, bmh $$2, int $$3, int $$4, bmh $$5, bmf $$6, bmf $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
