...
public class gls {
   ...
   private final dgh b;
   private final glt c;
   private final Map<ji, hio> d = new HashMap<>();

   public gls(fli $$0, dgh $$1, glt $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public void b(int $$0, ji $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.a.ak().a(hij.b(awa.vi, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 2007:
            ...
            for (int $$10 = 0; $$10 < 8; $$10++) {
               this.c.a(new lp(lt.T, new cwo(cws.wo)), $$9.d, $$9.e, $$9.f, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
         ...
         case 2003:
            ...
            for (int $$7 = 0; $$7 < 8; $$7++) {
               this.c.a(new lp(lt.T, new cwo(cws.tp)), $$4, $$5, $$6, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
         ...
         case 3006:
            ...
            if ($$36 > 0) {
               ...
               bro $$40 = bru.a(0, $$36);
               float $$41 = 0.005F;
               Supplier<faz> $$42 = () -> new faz(ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F));
               if ($$39 == 0) {
                  for (jn $$43 : jn.values()) {
         ...
         case 3007:
            for (int $$57 = 0; $$57 < 10; $$57++) {
               this.b.a(new lw($$57 * 5), (double)$$1.u() + 0.5, (double)$$1.v() + dqk.f, (double)$$1.w() + 0.5, 0.0, 0.0, 0.0);
            }

            dww $$58 = this.b.a_($$1);
            boolean $$59 = $$58.b(dxm.J) && $$58.c(dxm.J);
            if (!$$59) {
               this.b.a((double)$$1.u() + 0.5, (double)$$1.v() + dqk.f, (double)$$1.w() + 0.5, awa.wR, awb.e, 2.0F, 0.6F + this.b.A.i() * 0.4F, false);
            }
            break;
         case 3008:
            dww $$25 = djl.a($$2);
            if ($$25.b() instanceof djr $$26) {
         ...
         case 3014:
            ...
            break;
         case 3015:
            if (this.b.c_($$1) instanceof dwe $$31) {
               dwe.a.a(this.b, $$31.aA_(), $$31.m(), $$31.c(), $$2 == 0 ? lt.aL : lt.M);
               this.b.a($$1, awa.Bo, awb.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            }
            break;
         case 3016:
            dwe.a.a(this.b, $$1, $$2 == 0 ? lt.aL : lt.M);
   ...
   private void a(jr<cwu> $$0, ji $$1) {
      this.a($$1);
      cwu $$2 = $$0.a();
      avz $$3 = $$2.b().a();
      hio $$4 = hij.a($$3, faz.b($$1));
      this.d.put($$1, $$4);
      this.a.ak().a($$4);
      this.a.m.a($$2.c());
   ...
   private void a(dgh $$0, ji $$1, boolean $$2) {
      for (bvg $$4 : $$0.a(bvg.class, new fau($$1).g(3.0))) {
         $$4.a($$1, $$2);
      }
   }
}
