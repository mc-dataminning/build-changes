...
public class gls {
   ...
   private final dgi b;
   private final glt c;
   private final Map<ji, hii> d = new HashMap<>();

   public gls(flj $$0, dgi $$1, glt $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public void a(int $$0, ji $$1, int $$2) {
      switch ($$0) {
         ...
         case 1038:
            fkr $$3 = this.a.j.k();
            if ($$3.h()) {
               fba $$4 = fba.b($$1).d($$3.b()).d();
               fba $$5 = $$3.b().e($$4.c(2.0));
               if ($$0 == 1023) {
                  this.b.a($$5.d, $$5.e, $$5.f, awa.Dw, awb.f, 1.0F, 1.0F, false);
               } else if ($$0 == 1038) {
   ...
   public void b(int $$0, ji $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1021:
            ...
            break;
         case 1022:
            this.b.a($$1, awa.Do, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1024:
            this.b.a($$1, awa.Dr, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1025:
         ...
         case 1026:
            ...
            break;
         case 1027:
            this.b.a($$1, awa.EA, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1029:
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.a.ak().a(hid.b(awa.vi, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 1039:
            ...
            break;
         case 1040:
            this.b.a($$1, awa.Em, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1041:
         ...
         case 1043:
            ...
            break;
         case 1044:
            this.b.a($$1, awa.yY, awb.e, 1.0F, this.b.A.i() * 0.1F + 0.9F, false);
            break;
         case 1045:
         ...
         case 1050:
            ...
            break;
         case 1051:
            this.b.a($$1, awa.Dg, awb.e, 0.5F, 0.4F / (this.b.H_().i() * 0.4F + 0.8F), false);
            break;
         case 1500:
            dkx.a(this.b, $$1, $$2 > 0);
            break;
         ...
         case 2007:
            ...
            for (int $$10 = 0; $$10 < 8; $$10++) {
               this.c.a(new lp(lt.T, new cwp(cwt.wo)), $$9.d, $$9.e, $$9.f, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
            ...
            for (int $$15 = 0; $$15 < 100; $$15++) {
               ...
               gjg $$21 = this.c.b($$14, $$14.a().b(), $$9.d + $$18 * 0.1, $$9.e + 0.3, $$9.f + $$20 * 0.1, $$18, $$19, $$20);
               if ($$21 != null) {
            ...
            this.b.a($$1, awa.zE, awb.g, 1.0F, $$3.i() * 0.1F + 0.9F, false);
            break;
         case 2003:
            ...
            for (int $$7 = 0; $$7 < 8; $$7++) {
               this.c.a(new lp(lt.T, new cwp(cwt.tp)), $$4, $$5, $$6, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
         ...
         case 2006:
            for (int $$69 = 0; $$69 < 200; $$69++) {
               ...
               gjg $$75 = this.c.b(lt.h, false, (double)$$1.u() + $$72 * 0.1, (double)$$1.v() + 0.3, (double)$$1.w() + $$74 * 0.1, $$72, $$73, $$74);
               if ($$75 != null) {
                  $$75.c($$70);
               }
            }
         ...
         case 3002:
            if ($$2 >= 0 && $$2 < jn.a.d.length) {
               azd.a(jn.a.d[$$2], this.b, $$1, 0.125, lt.aV, bru.a(10, 19));
            } else {
               azd.a(this.b, $$1, lt.aV, bru.a(3, 5));
            }
            break;
         case 3003:
            azd.a(this.b, $$1, lt.aT, bru.a(3, 5));
            this.b.a($$1, awa.na, awb.e, 1.0F, 1.0F, false);
            break;
         case 3004:
            azd.a(this.b, $$1, lt.aU, bru.a(3, 5));
            break;
         case 3005:
            azd.a(this.b, $$1, lt.aW, bru.a(3, 5));
            break;
         case 3006:
            int $$36 = $$2 >> 6;
            if ($$36 > 0) {
               ...
               bro $$40 = bru.a(0, $$36);
               float $$41 = 0.005F;
               Supplier<fba> $$42 = () -> new fba(ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F));
               if ($$39 == 0) {
                  for (jn $$43 : jn.values()) {
         ...
         case 3007:
            for (int $$57 = 0; $$57 < 10; $$57++) {
               this.b.a(new lw($$57 * 5), (double)$$1.u() + 0.5, (double)$$1.v() + dql.f, (double)$$1.w() + 0.5, 0.0, 0.0, 0.0);
            }

            dwx $$58 = this.b.a_($$1);
            boolean $$59 = $$58.b(dxn.J) && $$58.c(dxn.J);
            if (!$$59) {
               this.b.a((double)$$1.u() + 0.5, (double)$$1.v() + dql.f, (double)$$1.w() + 0.5, awa.wR, awb.e, 2.0F, 0.6F + this.b.A.i() * 0.4F, false);
            }
            break;
         case 3008:
            dwx $$25 = djm.a($$2);
            if ($$25.b() instanceof djs $$26) {
            ...
            break;
         case 3009:
            azd.a(this.b, $$1, lt.aY, bru.a(3, 6));
            break;
         case 3011:
            dvz.a(this.b, $$1, $$3, dvz.a.a($$2).c);
            break;
         case 3012:
         ...
         case 3014:
            ...
            break;
         case 3015:
            if (this.b.c_($$1) instanceof dwf $$31) {
               dwf.a.a(this.b, $$31.aA_(), $$31.m(), $$31.c(), $$2 == 0 ? lt.aL : lt.M);
               this.b.a($$1, awa.Bp, awb.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            }
            break;
         case 3016:
            dwf.a.a(this.b, $$1, $$2 == 0 ? lt.aL : lt.M);
            this.b.a($$1, awa.Bt, awb.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            break;
         case 3017:
            dvz.b(this.b, $$1, $$3);
            break;
   ...
   private void a(jr<cwv> $$0, ji $$1) {
      this.a($$1);
      cwv $$2 = $$0.a();
      avz $$3 = $$2.b().a();
      hii $$4 = hid.a($$3, fba.b($$1));
      this.d.put($$1, $$4);
      this.a.ak().a($$4);
      this.a.m.a($$2.c());
   ...
   private void a(dgi $$0, ji $$1, boolean $$2) {
      for (bvg $$4 : $$0.a(bvg.class, new fav($$1).g(3.0))) {
         $$4.a($$1, $$2);
      }
   }
}
