...
public class anj implements AutoCloseable {
   ...
   private anj(URL $$0, anj.c $$1, URL $$2, anj.b $$3, URL $$4, anj.b $$5, String $$6, anj.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? atc.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static anj a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = atc.a($$0);
            URI $$2 = new URI(atc.i($$1, "apiServer"));
            String $$3 = atc.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = atc.a($$1, "ruleId", 1);
               String $$5 = atc.a($$1, "serverId", "");
               String $$6 = atc.a($$1, "roomId", "Java:Chat");
               int $$7 = atc.a($$1, "hashesToDrop", -1);
               int $$8 = atc.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = atc.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, anj.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<amv> a(GameProfile $$0, String $$1, anj.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(amv.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = atc.a($$4, "response", false);
            if ($$5) {
               return amv.a($$1);
            } else {
               String $$6 = atc.a($$4, "hashed", null);
               if ($$6 == null) {
                  return amv.b($$1);
               } else {
                  JsonArray $$7 = atc.v($$4, "hashes");
                  uv $$8 = this.a($$1, $$7, $$2);
                  return new amv($$1, $$8);
               }
            }
   ...
   private uv a(String $$0, JsonArray $$1, anj.a $$2) {
      if ($$1.isEmpty()) {
         return uv.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new anj.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public ani a(GameProfile $$0) {
      return new anj.d($$0);
   }
   ...
   public interface a {
      anj.a a = ($$0, $$1) -> false;
      anj.a b = ($$0, $$1) -> $$0.length() == $$1;

      static anj.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static anj.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ani {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bhq<Runnable> $$1 = bhq.a(anj.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         anj.this.a(this.c, anj.this.g, anj.this.h, this.d);
      }

      @Override
      public void b() {
         anj.this.a(this.c, anj.this.i, anj.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<amv>> a(List<String> $$0) {
         List<CompletableFuture<amv>> $$1 = $$0.stream().map($$0x -> anj.this.a(this.c, $$0x, anj.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<amv> a(String $$0) {
         return anj.this.a(this.c, $$0, anj.this.l, this.d);
      }
   }
