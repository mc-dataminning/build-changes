...
public class anj extends amq {
   ...
   private final Long2ObjectOpenHashMap<avg<anh<?>>> d = new Long2ObjectOpenHashMap();
   ...
   private avg<anh<?>> g(long $$0) {
      return (avg<anh<?>>)this.d.computeIfAbsent($$0, $$0x -> avg.a(4));
   }

   private int a(avg<anh<?>> $$0) {
   ...
   public void a(int $$0) {
      ...
      for (Pair<anh<csv>, Long> $$4 : $$1) {
         Long $$5 = (Long)$$4.getSecond();
         anh<csv> $$6 = (anh<csv>)$$4.getFirst();
         this.b($$5, $$6);
         csv $$7 = new csv($$5);
         ani<csv> $$8 = $$6.a();
         this.a($$8, $$7, $$0, $$7);
   ...
   protected int b(long $$0) {
      avg<anh<?>> $$1 = (avg<anh<?>>)this.d.get($$0);
