...
public class anj {
   ...
   private static int a(ew $$0, String $$1, @Nullable xv $$2) throws CommandSyntaxException {
   ...
   private static int b(ew $$0, String $$1, @Nullable xv $$2) throws CommandSyntaxException {
      awf $$3 = $$0.l().ag().g();
      if ($$3.a($$1)) {
         throw b.create();
      } else {
         List<asi> $$4 = $$0.l().ag().b($$1);
         awg $$5 = new awg($$1, null, $$0.c(), null, $$2 == null ? null : $$2.getString());
         $$3.a($$5);
         $$0.a(() -> xv.a("commands.banip.success", $$1, $$5.d()), true);
         if (!$$4.isEmpty()) {
            $$0.a(() -> xv.a("commands.banip.info", $$4.size(), hl.a($$4)), true);
         }

         for (asi $$6 : $$4) {
            $$6.f.a(xv.c("multiplayer.disconnect.ip_banned"));
         }
