...
public class epw {
   ...
   static class a implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
         return $$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d;
      }

      @Override
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.f.d()].d = true;
         return new epw.k($$0, $$1);
      }
   }

   static class b implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         ...
         return new epw.l($$0, $$1);
      }
   }

   static class c implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.b.d()].d = true;
         return new epw.m($$0, $$1);
      }
   }

   static class d implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         ...
         return new epw.n($$0, $$1);
      }
   }

   static class e implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[jn.c.d()].d = true;
         return new epw.o($$0, $$3);
      }
   }

   static class f implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
         return true;
      }
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         $$1.d = true;
         return new epw.s($$0, $$1, $$2);
      }
   }

   static class g implements epw.i {
      @Override
      public boolean a(epw.v $$0) {
      ...
      public epw.r a(jn $$0, epw.v $$1, azh $$2) {
         $$1.d = true;
         return new epw.t($$0, $$1);
      }
   }

   public static class h extends epw.r {
      ...
      private epw.v G;
      private epw.v H;
      private final List<epw.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, jn $$3) {
         super(eod.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<epw.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new epw.p($$3, this.G));
         this.I.add(new epw.j($$3, this.H));
         List<epw.i> $$5 = Lists.newArrayList();
         $$5.add(new epw.b());
         $$5.add(new epw.d());
         $$5.add(new epw.e());
         $$5.add(new epw.a());
         ...
         ene $$10 = ene.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ene $$11 = ene.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ene $$12 = ene.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new epw.u($$3, $$10, $$13++));
         this.I.add(new epw.u($$3, $$11, $$13++));
         this.I.add(new epw.q($$3, $$12));
      }
      ...
      private List<epw.v> b(azh $$0) {
         epw.v[] $$1 = new epw.v[75];
         ...
         epw.v $$23 = new epw.v(1003);
         epw.v $$24 = new epw.v(1001);
         epw.v $$25 = new epw.v(1002);
         $$1[v].a(jn.b, $$23);
         $$1[w].a(jn.d, $$24);
         $$1[x].a(jn.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<epw.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhg $$2, azh $$3, ene $$4) {
         int $$5 = 24;
      ...
      private void a(dhg $$0, azh $$1, ene $$2) {
      ...
      private void b(dhg $$0, azh $$1, ene $$2) {
      ...
      private void c(dhg $$0, azh $$1, ene $$2) {
      ...
      private void d(dhg $$0, azh $$1, ene $$2) {
      ...
      private void e(dhg $$0, azh $$1, ene $$2) {
      ...
      private void f(dhg $$0, azh $$1, ene $$2) {
   ...
   interface i {
      boolean a(epw.v var1);

      epw.r a(jn var1, epw.v var2, azh var3);
   }

   public static class j extends epw.r {
      public j(jn $$0, epw.v $$1) {
         super(eod.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhg $$0, dhe $$1, dyt $$2, azh $$3, ene $$4, dfo $$5, ji $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, djo.co.m(), djo.co.m(), false);
   ...
   public static class k extends epw.r {
      public k(jn $$0, epw.v $$1) {
         super(eod.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends epw.r {
      public l(jn $$0, epw.v $$1) {
         super(eod.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends epw.r {
      public m(jn $$0, epw.v $$1) {
         super(eod.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends epw.r {
      public n(jn $$0, epw.v $$1) {
         super(eod.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends epw.r {
      public o(jn $$0, epw.v $$1) {
         super(eod.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends epw.r {
      public p(jn $$0, epw.v $$1) {
         super(eod.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends epw.r {
      public q(jn $$0, ene $$1) {
         super(eod.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends enq {
      protected static final dwx b = djo.ix.m();
      protected static final dwx c = djo.iy.m();
      protected static final dwx d = djo.iz.m();
      protected static final dwx h = c;
      protected static final dwx i = djo.iG.m();
      protected static final boolean j = true;
      protected static final dwx k = djo.J.m();
      protected static final Set<djm> l = ImmutableSet.builder().add(djo.eb).add(djo.ja).add(djo.ny).add(k.b()).build();
      ...
      public r(eod $$0, jn $$1, int $$2, ene $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eod $$0, int $$1, jn $$2, epw.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ene a(jn $$0, epw.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ene $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhg $$0, ene $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dwx $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhg $$0, ene $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhg $$0, ene $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dwx $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ene $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhg $$0, ene $$1, int $$2, int $$3, int $$4) {
         ji $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clm $$6 = bur.N.a($$0.a(), buq.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dw()), buq.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends epw.r {
      private int a;

      public s(jn $$0, epw.v $$1, azh $$2) {
         super(eod.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends epw.r {
      public t(jn $$0, epw.v $$1) {
         super(eod.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends epw.r {
      private int a;

      public u(jn $$0, ene $$1, int $$2) {
         super(eod.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
