...
public class epw {
   ...
   private final Map<String, epi> b = Maps.newHashMap();
   private final DataFixer c;
   private final jl.a d;
   private final File e;

   public epw(File $$0, DataFixer $$1, jl.a $$2) {
      this.c = $$1;
      this.e = $$0;
      this.d = $$2;
   }
   ...
   public <T extends epi> T a(epi.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends epi> T b(epi.a<T> $$0, String $$1) {
      epi $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends epi> T a(BiFunction<tx, jl.a, T> $$0, azl $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
   ...
   public void a(String $$0, epi $$1) {
      this.b.put($$0, $$1);
   }

   public tx a(String $$0, azl $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
