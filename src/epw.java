...
public class epw extends LongLinkedOpenHashSet {
   private final epw.a a;

   public epw(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new epw.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azc.f(60000000);
      private static final int b = azc.f(60000000);
