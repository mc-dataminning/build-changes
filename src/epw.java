...
public class epw extends eqa implements epy {
   ...
   public epw.c a() {
      return new epw.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(eqg.b $$0, eqg $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (eqh)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(eqg $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == epz.k;
         boolean $$2 = $$0 == epz.j;
   ...
   private IntConsumer a(int $$0, eqg.a $$1) {
   ...
   private epw.b q() {
      ...
      this.k += $$5;
      this.j++;
      epw.a $$9 = new epw.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new epw.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eqg.b.a || this.q == eqg.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eqh> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eqh $$1 = (eqh)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eqh.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eqh.b.c) {
         epy.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, epy.a($$11));
         this.a($$14 + 5, epy.a($$12));
         this.a($$14 + 6, epy.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eqg a, int b, int c, eqg.b d, eqg.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eqg.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eqj $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
