...
public class epw {
   ...
   private final epw.a g;

   @Deprecated
   public static epw a(azn $$0, epw.a $$1) {
      return new epw($$0, $$1, false);
   }

   public static epw a(azn $$0, int $$1, double... $$2) {
      return b($$0, new epw.a($$1, new DoubleArrayList($$2)));
   }

   public static epw b(azn $$0, epw.a $$1) {
      return new epw($$0, $$1, true);
   }

   private epw(azn $$0, epw.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<epw.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(epw.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(epw.a::b))
               .apply($$0, epw.a::new)
      );
      public static final Codec<jo<epw.a>> b = ala.a(lw.aR, a);
