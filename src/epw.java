...
public class epw implements Comparable<epw> {
   ...
   public epw(dcb $$0, epx $$1, String $$2, boolean $$3, boolean $$4, boolean $$5, Path $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.f = $$4;
   ...
   public yc k() {
      return azu.b(this.c.c()) ? xo.c("selectWorld.versionUnknown") : xo.b(this.c.c());
   }
   ...
   public static class b extends epw {
   ...
   public static class c extends epw {
