...
public class bgc extends bgj {
   public static final Codec<bgc> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  bgj.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bgc a(bgj $$0, int $$1, int $$2) {
      return new bgc($$0, $$1, $$2);
   }

   public bgc(bgj $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Override
   public int a(ash $$0) {
      return asb.a(this.b.a($$0), this.f, this.g);
   }
