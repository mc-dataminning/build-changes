...
public class bgc extends Schema {
   ...
   protected static final HookFunction a = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bgc.a(new Dynamic($$0, $$1), bgc.c, "ArmorStand");
      }
   };

   public bgc(int $$0, Schema $$1) {
      super($$0, $$1);
   }
   ...
   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", bbw.y.in($$0)));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", bbw.y.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", bbw.y.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", bbw.y.in($$0)));
      b($$0, $$1, "Snowball");
      b($$0, $$1, "Fireball");
      b($$0, $$1, "SmallFireball");
      b($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", bbw.y.in($$0), "Potion", bbw.t.in($$0)));
      b($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", bbw.t.in($$0)));
      b($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", bbw.y.in($$0), "TileEntityData", bbw.s.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", bbw.t.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", bbw.y.in($$0), "Items", DSL.list(bbw.t.in($$0))));
      c($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", bbw.y.in($$0), "Items", DSL.list(bbw.t.in($$0))));
      c($$0, $$1, "MinecartFurnace");
      c($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", bbw.y.in($$0), bbw.B.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", bbw.y.in($$0), "Items", DSL.list(bbw.t.in($$0))));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "MobSpawner", $$1x -> bbw.B.in($$0));
      ...
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bbw.z.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bbw.w, () -> DSL.optionalFields("Riding", bbw.w.in($$0), bbw.x.in($$0)));
      $$0.registerType(false, bbw.v, () -> DSL.constType(bde.a()));
      $$0.registerType(true, bbw.x, () -> DSL.taggedChoiceLazy("id", DSL.string(), $$1));
      $$0.registerType(
         true,
         bbw.t,
         () -> DSL.hook(
               DSL.optionalFields(
                  "id",
                  DSL.or(DSL.constType(DSL.intType()), bbw.z.in($$0)),
                  "tag",
                  DSL.optionalFields(
                     "EntityTag",
                     bbw.w.in($$0),
      ...
      $$0.registerType(false, bbw.y, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(bde.a())));
      $$0.registerType(false, bbw.z, () -> DSL.constType(bde.a()));
      ...
      $$0.registerType(false, bbw.E, DSL::remainder);
      $$0.registerType(true, bbw.B, DSL::remainder);
