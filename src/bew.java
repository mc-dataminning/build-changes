...
public class bew extends DataFix {
   ...
   private static void a(bew.a $$0, Dynamic<?> $$1) {
   ...
   private static Dynamic<?> a(bew.a $$0, Dynamic<?> $$1, int $$2) {
      ...
      if ($$6.isPresent()) {
         $$0.a("minecraft:item_name", baf.b($$1.getOps(), $$6.get()));
      }
   ...
   private static <T> Dynamic<T> a(bew.a $$0, Dynamic<T> $$1, String $$2) {
      ...
      return switch ($$2) {
         ...
         case "minecraft:banner" -> {
            ...
            if ($$7.isPresent()) {
               $$0.a("minecraft:base_color", $$1.createString(bav.a($$7.get().intValue())));
            }
   ...
   private static void a(bew.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void b(bew.a $$0, Dynamic<?> $$1, int $$2) {
      b($$0, $$1, "CanDestroy", "minecraft:can_break", ($$2 & 8) != 0);
      b($$0, $$1, "CanPlaceOn", "minecraft:can_place_on", ($$2 & 16) != 0);
   }

   private static void b(bew.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void c(bew.a $$0, Dynamic<?> $$1, int $$2) {
      List<? extends Dynamic<?>> $$3 = $$0.a("AttributeModifiers").asList(bew::d);
      boolean $$4 = ($$2 & 2) != 0;
      if (!$$3.isEmpty() || $$4) {
   ...
   private static void b(bew.a $$0, Dynamic<?> $$1) {
   ...
   private static void c(bew.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
      if ($$2 != null) {
   ...
   private static void d(bew.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
   ...
   @Nullable
   private static Dynamic<?> e(bew.a $$0, Dynamic<?> $$1) {
   ...
   private static void f(bew.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.emptyMap();
   ...
   private static void g(bew.a $$0, Dynamic<?> $$1) {
   ...
   private static void b(bew.a $$0) {
      $$0.a("Fireworks", true, $$1 -> {
         Stream<? extends Dynamic<?>> $$2 = $$1.get("Explosions").asStream().map(bew::f);
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(bgx.t), this.getOutputSchema().getType(bgx.t), $$0 -> {
         Optional<? extends Dynamic<?>> $$1 = bew.a.a($$0).map($$0x -> {
            a($$0x, $$0x.e);
            return $$0x.a();
         });
   ...
   static class a {
      ...
      public static Optional<bew.a> a(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(($$1, $$2) -> new bew.a($$1, $$2.intValue(), $$0.remove("id").remove("Count")), $$0.get("Count").asNumber())
            .result();
      }
