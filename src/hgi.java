...
public class hgi {
   ...
   private final fmi n;
   private boolean o;
   private final fed p = new fed();
   private final fee q = this.p.e();
   private final hgh r;
   private final hgj s = new hgj();
   private final hga t = new hga(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hgi.a> w = new AtomicReference<>(hgi.a.c);
   private final Map<hfg, hga.a> x = Maps.newHashMap();
   private final Multimap<axg, hfg> y = HashMultimap.create();
   private final List<hfh> z = Lists.newArrayList();
   private final Map<hfg, Integer> A = Maps.newHashMap();
   private final Map<hfg, Integer> B = Maps.newHashMap();
   private final List<hgk> C = Lists.newArrayList();
   private final List<hfh> D = Lists.newArrayList();
   private final List<hfd> E = Lists.newArrayList();

   public hgi(hgl $$0, fmi $$1, avy $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hgh($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fec::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hgi.a.c, hgi.a.a)) {
               String $$2 = this.n.aw().c();
               ae.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hgi.a.a, hgi.a.b);
                     }
                  ...
                  this.w.compareAndSet(hgi.a.a, hgi.a.c);
               });
            }
         }

         return this.w.compareAndSet(hgi.a.b, hgi.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hfg::s).forEach(this::c);
      this.D.clear();
      ...
      Iterator<Entry<hfg, hga.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hfg, hga.a> $$6 = $$5.next();
         hga.a $$7 = $$6.getValue();
         hfg $$8 = $$6.getKey();
      ...
      Iterator<Entry<hfg, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hfg, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hfg $$13 = $$12.getKey();
            if ($$13 instanceof hfh) {
               ((hfh)$$13).q();
            }
   ...
   private static boolean d(hfg $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hfg $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hfg $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hfg $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hgl.e) {
                  if ($$3 == hgl.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hfg.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hga.a> $$16 = this.t.a($$3.g() ? fed.c.b : fed.c.a);
                           hga.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hfg $$0) {
      return bae.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hfg $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fec::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fec::e));
      }
   }
   ...
   public void a(fln $$0) {
      if (this.o && $$0.h()) {
         fef $$1 = new fef($$0.b(), new fbx($$0.l()), new fbx($$0.m()));
