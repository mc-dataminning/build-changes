public class bzc extends bzq {
   private static final int[] a = new int[]{0, 1, 4, 5, 6, 7};
   private final cem b;
   private final int c;
   private boolean d;

   public bzc(cem $$0, int $$1) {
      this.b = $$0;
      this.c = b($$1);
   }
   ...
   private boolean a(io $$0, int $$1, int $$2, int $$3) {
      io $$4 = $$0.b($$1 * $$3, 0, $$2 * $$3);
      return this.b.dP().b_($$4).a(awb.a) && !this.b.dP().a_($$4).d();
   }
   ...
   public void e() {
      ...
      if ($$2.d * $$2.d < 0.03F && this.b.dH() != 0.0F) {
         this.b.s(ayd.j(0.2F, this.b.dH(), 0.0F));
      } else if ($$2.f() > 1.0E-5F) {
         double $$3 = $$2.h();
