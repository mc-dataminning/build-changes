...
public class bzc {
   ...
   public static hz a(awo $$0, int $$1, int $$2) {
      int $$3 = $$0.a(2 * $$1 + 1) - $$1;
      int $$4 = $$0.a(2 * $$2 + 1) - $$2;
      int $$5 = $$0.a(2 * $$1 + 1) - $$1;
      return new hz($$3, $$4, $$5);
   ...
   @Nullable
   public static hz a(awo $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      double $$7 = awh.d($$5, $$4) - (float) (Math.PI / 2);
      double $$8 = $$7 + (double)(2.0F * $$0.i() - 1.0F) * $$6;
      double $$9 = Math.sqrt($$0.j()) * (double)awh.g * (double)$$1;
   ...
   @Nullable
   public static ens a(boo $$0, Supplier<hz> $$1) {
      return a($$1, $$0::h);
   }

   @Nullable
   public static ens a(Supplier<hz> $$0, ToDoubleFunction<hz> $$1) {
      ...
      return $$3 != null ? ens.c($$3) : null;
   }

   public static hz a(boo $$0, int $$1, awo $$2, hz $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.fS() && $$1 > 1) {
         hz $$6 = $$0.fP();
