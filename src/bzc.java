...
public class bzc extends bix implements bza {
   private static final aee<Boolean> b = aeh.a(bzc.class, aeg.k);
   private int c = 1;
   ...
   static class a extends bqb {
      ...
      public void e() {
         if (this.a.q() == null) {
            ehn $$0 = this.a.do();
            this.a.r(-((float)arw.d($$0.c, $$0.e)) * (180.0F / (float)Math.PI));
            this.a.aU = this.a.dB();
         } else {
            bjg $$1 = this.a.q();
            double $$2 = 64.0;
            if ($$1.f(this.a) < 4096.0) {
               ...
               this.a.r(-((float)arw.d($$3, $$4)) * (180.0F / (float)Math.PI));
               this.a.aU = this.a.dB();
            }
         }
      }
