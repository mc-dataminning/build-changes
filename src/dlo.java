...
public interface dlo<T extends Enum<T>> {
   int x_ = 4;

   Optional<dxv> k_(dxv var1);

   float av_();

   default void a_(dxv $$0, ash $$1, jh $$2, bam $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dxv> c(dxv $$0, ash $$1, jh $$2, bam $$3) {
      ...
      for (jh $$7 : jh.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dlo<?> $$9) {
            Enum<?> $$10 = $$9.c();
