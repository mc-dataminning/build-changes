...
public class dlo implements arx {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dlo> b = dln.a.xmap($$0 -> new dlo($$0), $$0 -> $$0.e);
   private dln e;
   private final dkp f = new dkp(this);

   public dlo(long $$0) {
      this.e = new dln(dlc.c($$0));
   }
   ...
   @Override
   public arx d() {
      return new dlo(this.e.a(), this.e.a());
   }

   @Override
   public dla e() {
      return new dlo.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dla {
      ...
      public arx a(int $$0, int $$1, int $$2) {
         long $$3 = ars.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dlo($$4, this.b);
      }

      @Override
      public arx a(String $$0) {
         dlc.a $$1 = dlc.a($$0);
         return new dlo($$1.a(this.a, this.b));
      }
