...
public class dlo {
   private static final dlo a = new dlo(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dlo.a a(int $$0, int $$1) {
         return new dlo.a(1.0, 0.0);
      }
   ...
   private static final dzj b = dzj.b(new dln(42L), nv.a);
   ...
   private final Long2ObjectOpenHashMap<dlp> h;
   private final Long2ObjectOpenHashMap<dlp> i;

   public static dlo a() {
      return a;
   }

   public static dlo a(@Nullable ala $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cpi $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dlp> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dlp> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = asb.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dlo($$2, $$3);
         }
      }
   }

   dlo(Long2ObjectOpenHashMap<dlp> $$0, Long2ObjectOpenHashMap<dlp> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dlo.a a(int $$0, int $$1) {
      int $$2 = hp.a($$0);
      int $$3 = hp.a($$1);
      double $$4 = this.a($$2, 0, $$3, dlp::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dlo.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(hp.d(cpi.a($$5x)), hp.d(cpi.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = asb.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = asb.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dlo.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dkf.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(hp.d(cpi.a($$6x)), hp.d(cpi.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = asb.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = asb.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return asb.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dlo.b $$3) {
      int $$4 = hp.e($$0);
      int $$5 = hp.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dlo.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dlp $$6 = (dlp)this.h.get(cpi.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - hp.d($$1), $$4, $$5 - hp.d($$2)) : Double.MAX_VALUE;
   }

   public crc a(crc $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         he<cqz> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private he<cqz> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<he<cqz>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(hp.d(cpi.a($$5x)), $$1, hp.d(cpi.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = asb.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = asb.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (he)$$4.getValue();
      }
   }

   public static void a(ala $$0, dgz $$1) {
      cpi $$2 = $$1.f();
      boolean $$3 = $$1.s();
      gw.a $$4 = new gw.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dkm.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dgz $$0, gw $$1) {
      dfd $$2 = $$0.a_($$1);
      if ($$2.a(apv.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cqv $$0, dhu $$1) {
      cpi $$2 = $$1.f();
      Builder<hb, dlp> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dki.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dlo.c a(@Nullable dlp $$0, Map<hb, dlp> $$1) {
      List<dlo.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dlo.c a(@Nullable hb $$0, dlp $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ha $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return asb.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dlp var1, int var2, int var3, int var4);
   }
