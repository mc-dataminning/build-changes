...
public class amj {
   ...
   public amj(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<amj.a> b(Scanner $$0) {
      ald<dip> $$1 = (ald<dip>)ams.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amj.a($$1, new fdw((double)$$2, (double)$$3, (double)$$4), new fdv($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<arp> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            arp $$2 = $$1.get(0);
            aro $$3 = this.e.J();
            ei $$4 = new ei($$2.z(), fdw.a($$3.aa()), fdv.a, $$3, 4, "", wv.a, this.e, $$2);
            ej $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(ald<dip> a, fdw b, fdv c) {
   }
}
