...
public class amj {
   ...
   private Optional<amj.a> b(Scanner $$0) {
      ald<dej> $$1 = (ald<dej>)ams.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amj.a($$1, new eyw((double)$$2, (double)$$3, (double)$$4), new eyv($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<ark> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            ark $$2 = $$1.get(0);
            arj $$3 = this.e.J();
            eu $$4 = new eu($$2, eyw.a($$3.W()), eyv.a, $$3, 4, "", xd.a, this.e, $$2);
            ev $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(ald<dej> a, eyw b, eyv c) {
   }
}
