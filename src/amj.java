...
public class amj {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vu.c("commands.recipe.give.failed"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vu.c("commands.recipe.take.failed"));
   ...
   private static int a(du $$0, Collection<apg> $$1, Collection<ctr<?>> $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vu.a("commands.recipe.give.success.single", $$2.size(), $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> vu.a("commands.recipe.give.success.multiple", $$2.size(), $$1.size()), true);
         }
   ...
   private static int b(du $$0, Collection<apg> $$1, Collection<ctr<?>> $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vu.a("commands.recipe.take.success.single", $$2.size(), $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> vu.a("commands.recipe.take.success.multiple", $$2.size(), $$1.size()), true);
         }
