...
public class atq {
   ...
   private static List<atq.b> a(final Path $$0) throws IOException {
      try {
         final List<atq.b> $$1 = new ArrayList<>();
   ...
   private static List<atq.a> a(List<atq.b> $$0) {
      List<atq.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (atq.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new atq.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<atq.a> a = Comparator.comparing(atq.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<atq.b> a = Comparator.comparing(atq.b::b).reversed();
