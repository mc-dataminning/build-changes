...
public class atq {
   ...
   public static final Codec<Object> b = a(aub.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(aty.e($$0));
   ...
   public static final Codec<atq.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ahd.b($$0.substring(1)).map($$0x -> new atq.f($$0x, true)) : ahd.b($$0).map($$0x -> new atq.f($$0x, false)), atq.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !ahd.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> atq.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new atq.b<>($$0, $$1);
   }

   public static <K, V> atq.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new atq.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof atq.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(ahd a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
