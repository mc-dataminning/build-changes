...
public class atq extends axr {
   public static final String a = "_filtered_correct";
   private static final String b = "black";
   private static final String c = tf.a.a(te.a);

   public atq(Schema $$0, String $$1, String $$2) {
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), atq::a);
   }
}
