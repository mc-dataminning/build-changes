...
public class atq extends atv {
   ...
   private final Set<atr<?>> e = Sets.newHashSet();

   public atq(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<atr<?>> d() {
      Set<atr<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<atr<T>> a(att<T> $$0, String $$1) {
   ...
   protected String b() {
      Map<att<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<atr<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<atr<?>>)$$3.next();
         atr<?> $$2 = (atr<?>)$$1.getKey();
      ...
      for (Entry<att<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> aiy b(atr<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aow $$0) {
      Object2IntMap<atr<?>> $$1 = new Object2IntOpenHashMap();
