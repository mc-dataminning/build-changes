...
public abstract class crv extends csn {
   private static final fbx b = new fbx(0.0, 0.0, 0.0);
   private static final alc<Integer> c = alg.a(crv.class, ale.b);
   private static final alc<Integer> d = alg.a(crv.class, ale.b);
   private static final alc<Boolean> h = alg.a(crv.class, ale.k);
   private static final ImmutableMap<bwr, ImmutableList<Integer>> i = ImmutableMap.of(
      bwr.a, ImmutableList.of(0, 1, -1), bwr.f, ImmutableList.of(0, 1, -1), bwr.d, ImmutableList.of(0, 1)
   );
   protected static final float a = 0.95F;
   private boolean j;
   private boolean k;
   private final csd l;
   private static final Map<dyx, Pair<kl, kl>> m = ae.a(Maps.newEnumMap(dyx.class), $$0 -> {
      kl $$1 = jm.e.q();
      kl $$2 = jm.f.q();
      kl $$3 = jm.c.q();
      kl $$4 = jm.d.q();
      ...
      kl $$7 = $$3.p();
      kl $$8 = $$4.p();
      $$0.put(dyx.a, Pair.of($$3, $$4));
      $$0.put(dyx.b, Pair.of($$1, $$2));
      $$0.put(dyx.c, Pair.of($$5, $$2));
      $$0.put(dyx.d, Pair.of($$1, $$6));
      $$0.put(dyx.e, Pair.of($$3, $$8));
      $$0.put(dyx.f, Pair.of($$7, $$4));
      $$0.put(dyx.g, Pair.of($$4, $$2));
      $$0.put(dyx.h, Pair.of($$4, $$1));
      $$0.put(dyx.i, Pair.of($$3, $$1));
      $$0.put(dyx.j, Pair.of($$3, $$2));
   });

   protected crv(bvq<?> $$0, dhh $$1) {
      super($$0, $$1);
      this.I = true;
      if (b($$1)) {
         this.l = new csk(this);
   ...
   protected crv(bvq<?> $$0, dhh $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.p($$2, $$3, $$4);
   }
   ...
   @Nullable
   public static <T extends crv> T a(dhh $$0, double $$1, double $$2, double $$3, bvq<T> $$4, bvp $$5, cxo $$6, @Nullable cpw $$7) {
      T $$8 = (T)$$4.a($$0, $$5);
      if ($$8 != null) {
         $$8.p($$1, $$2, $$3);
         bvq.a($$0, $$6, $$7).accept($$8);
         if ($$8.l() instanceof csk $$9) {
            jh $$10 = $$8.p();
            dxu $$11 = $$0.a_($$10);
            $$9.a($$10, $$11, true);
         }
   ...
   protected fbx a(bvj $$0, bvm $$1, float $$2) {
      boolean $$3 = $$0 instanceof cpi || $$0 instanceof cpo;
   ...
   public dxu t() {
      return !this.A() ? this.w() : dkl.a(this.au().a(c));
   }
