...
public interface crv extends cqv, crc, csi, css.a {
   @Nullable
   dis a(int var1, int var2, dix var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dmf.a var1, int var2, int var3);

   int B_();

   css F_();

   default ib<csq> s(ht $$0) {
      return this.F_().a($$0);
   }

   default Stream<dgw> c(ejd $$0) {
      int $$1 = ati.a($$0.a);
      int $$2 = ati.a($$0.d);
      int $$3 = ati.a($$0.b);
      int $$4 = ati.a($$0.e);
   ...
   @Override
   default int a(ht $$0, crd $$1) {
      return $$1.getColor(this.s($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ib<csq> getNoiseBiome(int $$0, int $$1, int $$2) {
      dis $$3 = this.a(in.e($$0), in.e($$2), dix.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ib<csq> a(int var1, int var2, int var3);
   ...
   default dis a(int $$0, int $$1) {
      return this.a($$0, $$1, dix.n, true);
   }

   default dis a(int $$0, int $$1, dix $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default cqy c(int $$0, int $$1) {
      return this.a($$0, $$1, dix.c, false);
   }

   default boolean y(ht $$0) {
      return this.b_($$0).a(arh.a);
   }

   default boolean d(ejd $$0) {
      int $$1 = ati.a($$0.a);
      int $$2 = ati.c($$0.d);
      int $$3 = ati.a($$0.b);
      int $$4 = ati.c($$0.e);
   ...
   default <T> id<T> a(agf<? extends io<? extends T>> $$0) {
      io<T> $$1 = this.H_().d($$0);
      return $$1.p().a(this.G());
   }
}
