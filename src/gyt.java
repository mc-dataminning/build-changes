...
public class gyt implements atu<gys> {
   public gys b(JsonObject $$0) {
      Builder<gyr> $$1 = ImmutableList.builder();
      int $$2 = ayv.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = ayv.a($$0, "width", -1);
      int $$9 = ayv.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = ayv.a($$0, "interpolate", false);
      return new gys($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gyr a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gyr(ayv.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = ayv.m($$1, "frames[" + $$0 + "]");
         int $$3 = ayv.a($$2, "time", -1);
         if ($$2.has("time")) {
