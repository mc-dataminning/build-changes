public class gyt {
   ...
   private static final float[] b = ae.a(new float[256], $$0 -> {
   ...
   public static fdr[] a(fdr[] $$0, int $$1) {
      if ($$1 + 1 <= $$0.length) {
         return $$0;
      } else {
         fdr[] $$2 = new fdr[$$1 + 1];
         ...
         for (int $$4 = 1; $$4 <= $$1; $$4++) {
            if ($$4 < $$0.length) {
               ...
               fdr $$5 = $$2[$$4 - 1];
               fdr $$6 = new fdr($$5.a() >> 1, $$5.b() >> 1, false);
               int $$7 = $$6.a();
               int $$8 = $$6.b();
   ...
   private static boolean a(fdr $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         for (int $$2 = 0; $$2 < $$0.b(); $$2++) {
            if (axx.a($$0.a($$1, $$2)) == 0) {
               return true;
   ...
   private static int a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if ($$4) {
         ...
         return axx.a($$9, $$10, $$11, $$12);
      } else {
         int $$13 = a($$0, $$1, $$2, $$3, 24);
         int $$14 = a($$0, $$1, $$2, $$3, 16);
         int $$15 = a($$0, $$1, $$2, $$3, 8);
         int $$16 = a($$0, $$1, $$2, $$3, 0);
         return axx.a($$13, $$14, $$15, $$16);
      }
   }
