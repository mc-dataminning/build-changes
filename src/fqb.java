...
public class fqb {
   private static final alb a = alb.b("advancements/title_box");
   ...
   private final ayo r;
   private final int s;
   private final List<ayo> t;
   private final fib u;
   @Nullable
   private fqb v;
   private final List<fqb> w = Lists.newArrayList();
   @Nullable
   private ai x;
   private final int y;
   private final int z;

   public fqb(fpz $$0, fib $$1, ah $$2, as $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ua.a().a($$1.h.a($$3.a(), 163));
      this.y = azc.d($$3.f() * 28.0F);
      this.z = azc.d($$3.g() * 27.0F);
      int $$4 = this.e();
      int $$5 = 29 + $$1.h.a(this.r) + $$4;
      this.t = ua.a().a(this.a(xg.a($$3.b().f(), ya.a.a($$3.e().a())), $$5));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         xd $$2 = xd.a("advancements.progress", $$0, $$0);
         return this.u.h.a($$2) + 8;
      }
   }

   private static float a(fim $$0, List<xi> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xi> a(xd $$0, int $$1) {
      fim $$2 = this.u.h.b();
      List<xi> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<xi> $$6 = $$2.b($$0, $$1 - $$5, ya.a);
   ...
   public void a(fjn $$0, int $$1, int $$2) {
      if (!this.q.j() || this.x != null && this.x.a()) {
         ...
         $$0.a(ghe::C, $$4.a(this.q.e()), $$1 + this.y + 3, $$2 + this.z, 26, 26);
   ...
   public void a(fjn $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      ...
      if (!this.t.isEmpty()) {
         if ($$9) {
            $$0.a(ghe::C, a, $$26, $$25 + 26 - $$28, this.s, $$28);
         } else {
            $$0.a(ghe::C, a, $$26, $$25, this.s, $$28);
         }
      }

      $$0.a(ghe::C, $$12.a(), 200, 26, 0, 0, $$26, $$25, $$11, 26);
      $$0.a(ghe::C, $$13.a(), 200, 26, 200 - $$24, 0, $$26 + $$11, $$25, $$24, 26);
      $$0.a(ghe::C, $$14.a(this.q.e()), $$1 + this.y + 3, $$2 + this.z, 26, 26);
      if ($$6) {
