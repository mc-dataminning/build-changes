...
public class fqb implements hju {
   private static final long a = 3000L;
   private final flj b;
   private final List<fqb.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fqb.b> e = new ArrayList<>();
   ...
   public void a(foe $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fqb.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hip $$0, hjw $$1, float $$2) {
      if ($$1.a() != null) {
         wp $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fqb.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fba($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fqb.b($$3, $$2, new fba($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fba a, long b) {
   }

   static class b {
      private final wp a;
      private final float b;
      private final List<fqb.a> c = new ArrayList<>();

      public b(wp $$0, float $$1, fba $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fqb.a($$2, af.c()));
      }
