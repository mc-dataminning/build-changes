...
public abstract class bqf extends bps {
   ...
   public bqf(bjf $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bqf(bjf $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bps.a.a, bps.a.c));
   }
   ...
   protected abstract boolean a(cpn var1, gv var2);
}
