...
public class dui implements due, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bop<bor.b> c;
   private final dun d;
   private final Map<dag, dui.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dui(dup $$0, Path $$1, boolean $$2) {
      this.d = new dun($$0, $$1, $$2);
      this.c = new bop<>(new bor.a(dui.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dag $$0, int $$1) {
      dag $$2 = new dag($$0.e - $$1, $$0.f - $$1);
      dag $$3 = new dag($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         dag $$3 = dag.b($$0, $$1);
         BitSet $$4 = new BitSet();
         dag.a($$2, $$3).forEach($$1xx -> {
            vh $$2x = new vh(new vj(ui.a, "DataVersion"), new vj(ud.b, "blending_data"));
            ...
            if ($$2x.d() instanceof ud $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(dag $$0, @Nullable ud $$1) {
      return this.a(() -> {
         dui.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dui.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dag $$0, ux $$1) {
      return this.a(() -> {
         try {
            dui.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bor.b(dui.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dag, dui.a>> $$0 = this.e.entrySet().iterator();
         Entry<dag, dui.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bor.b(dui.b.b.ordinal(), this::a));
   }

   private void a(dag $$0, dui.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bor.b(dui.b.c.ordinal(), () -> $$0.a(azh.a))).join();
         this.c.close();
