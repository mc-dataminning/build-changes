...
public class eue {
   private final ImmutableList<euf> a;
   private final ImmutableMap<String, euf> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private euc e;

   public eue(ImmutableMap<String, euf> $$0) {
      this.b = $$0;
