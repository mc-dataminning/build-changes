...
public class eue implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<eue.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public eue(List<eue.a> $$0) {
      this.c = $$0;
   }
   ...
   public static eue a(BufferedReader $$0) {
      return new eue($$0.lines().flatMap($$0x -> eue.a.a($$0x).stream()).toList());
   }

   public static record a(eue.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<eue.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new eue.a(eue.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new eue.a(eue.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new eue.a(eue.b.b, $$3));
      ...
      static eue.a b(String $$0) {
         return new eue.a(eue.b.a, "glob:" + $$0);
      }

      static eue.a c(String $$0) {
         return new eue.a(eue.b.a, "regex:" + $$0);
      }

      static eue.a d(String $$0) {
         return new eue.a(eue.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      eue.b a = FileSystem::getPathMatcher;
      eue.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
