...
public class eoy {
   ...
   public static final Codec<eoy> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> af.a($$0, 6).map($$0x -> new eoy($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public eoy(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static eoy a() {
      return new eoy(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static eoy a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jo $$9) {
      switch ($$9) {
         case d:
         default:
            return new eoy($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new eoy($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new eoy($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new eoy($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dgw> b() {
      ...
      int $$2 = kl.a(this.k());
      int $$3 = kl.a(this.m());
      return dgw.a(new dgw($$0, $$1), new dgw($$2, $$3));
   }
   ...
   public static Optional<eoy> a(Iterable<jj> $$0) {
      Iterator<jj> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eoy $$2 = new eoy($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<eoy> b(Iterable<eoy> $$0) {
      Iterator<eoy> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eoy $$2 = $$1.next();
         eoy $$3 = new eoy($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   public eoy b(int $$0, int $$1, int $$2) {
      return new eoy(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public eoy c(int $$0, int $$1, int $$2) {
      return new eoy(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
   ...
   public kn c() {
      return new kn(this.f - this.c, this.g - this.d, this.h - this.e);
   }
   ...
   public jj g() {
      return new jj(this.c + (this.f - this.c + 1) / 2, this.d + (this.g - this.d + 1) / 2, this.e + (this.h - this.e + 1) / 2);
   }
