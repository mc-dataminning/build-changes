...
public class eoy extends gfb {
   ...
   public void aH_() {
      ...
      this.d(esq.a(tl.c("mco.configure.world.buttons.done"), $$0x -> this.D()).a(this.E, h(13), this.F, 20).a());
   ...
   class a extends esm {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5) {
         ...
         this.d = (double)$$4;
         this.e = (double)$$5;
         this.c = (double)((arw.a((float)$$3, $$4, $$5) - $$4) / ($$5 - $$4));
         this.b();
      }
      ...
      public void a() {
         if (eoy.this.T.i) {
            eoy.this.Q = (int)arw.d(arw.a(this.c, 0.0, 1.0), this.d, this.e);
         }
      }
