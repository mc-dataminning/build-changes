...
public class eoy extends epc implements epa {
   ...
   public eoy.c a() {
      return new eoy.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, epi.a $$1) {
   ...
   private eoy.b q() {
      ...
      this.k += $$5;
      this.j++;
      eoy.a $$9 = new eoy.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new eoy.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == epi.b.a || this.q == epi.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<epj> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      epj $$1 = (epj)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == epj.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == epj.b.c) {
         epa.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, epa.a($$11));
         this.a($$14 + 5, epa.a($$12));
         this.a($$14 + 6, epa.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(epi a, int b, int c, epi.b d, epi.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(epi.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable epl $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
