...
public class aor {
   ...
   private static List<aor.b> a(final Path $$0) throws IOException {
      try {
         final List<aor.b> $$1 = new ArrayList<>();
   ...
   private static List<aor.a> a(List<aor.b> $$0) {
      List<aor.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (aor.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new aor.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<aor.a> a = Comparator.comparing(aor.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<aor.b> a = Comparator.comparing(aor.b::b).reversed();
