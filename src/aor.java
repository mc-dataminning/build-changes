...
public class aor {
                     ...
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)eu.a(
                                    ...
                                    .then(
                                       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("nametagVisibility")
                                                   .then(eu.a("never").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.b))))
                                                .then(eu.a("hideForOtherTeams").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.c))))
                                             .then(eu.a("hideForOwnTeam").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.d))))
                                          .then(eu.a("always").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.a)))
                                    ))
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("deathMessageVisibility")
                                                .then(eu.a("never").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.b))))
                                             .then(eu.a("hideForOtherTeams").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.c))))
                                          .then(eu.a("hideForOwnTeam").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.d))))
                                       .then(eu.a("always").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.b.a)))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("collisionRule")
                                             .then(eu.a("never").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.a.b))))
                                          .then(eu.a("pushOwnTeam").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.a.d))))
                                       .then(eu.a("pushOtherTeams").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.a.c))))
                                    .then(eu.a("always").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), eyc.a.a)))
                              ))
                           .then(
                              eu.a("prefix")
   ...
   private static int a(et $$0, exv $$1, Collection<exz> $$2) {
      eya $$3 = $$0.l().aK();
      ...
      if ($$2.size() == 1) {
         $$0.a(() -> wy.a("commands.team.join.success.single", a($$2), $$1.d()), true);
      } else {
         $$0.a(() -> wy.a("commands.team.join.success.multiple", $$2.size(), $$1.d()), true);
      }

      return $$2.size();
   }

   private static int a(et $$0, exv $$1, eyc.b $$2) throws CommandSyntaxException {
      if ($$1.j() == $$2) {
         throw i.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> wy.a("commands.team.option.nametagVisibility.success", $$1.d(), $$2.b()), true);
         return 0;
      }
   }

   private static int b(et $$0, exv $$1, eyc.b $$2) throws CommandSyntaxException {
      if ($$1.k() == $$2) {
         throw j.create();
      } else {
         $$1.b($$2);
         $$0.a(() -> wy.a("commands.team.option.deathMessageVisibility.success", $$1.d(), $$2.b()), true);
         return 0;
      }
   }

   private static int a(et $$0, exv $$1, eyc.a $$2) throws CommandSyntaxException {
      if ($$1.l() == $$2) {
         throw k.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> wy.a("commands.team.option.collisionRule.success", $$1.d(), $$2.a()), true);
         return 0;
      }
   }

   private static int a(et $$0, exv $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.i() == $$2) {
         if ($$2) {
            throw g.create();
         } else {
         ...
         $$1.b($$2);
         $$0.a(() -> wy.a("commands.team.option.seeFriendlyInvisibles." + ($$2 ? "enabled" : "disabled"), $$1.d()), true);
         return 0;
      }
   }

   private static int b(et $$0, exv $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.h() == $$2) {
         if ($$2) {
            throw e.create();
         } else {
         ...
         $$1.a($$2);
         $$0.a(() -> wy.a("commands.team.option.friendlyfire." + ($$2 ? "enabled" : "disabled"), $$1.d()), true);
         return 0;
      }
   }

   private static int a(et $$0, exv $$1, wy $$2) throws CommandSyntaxException {
      if ($$1.c().equals($$2)) {
         throw c.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> wy.a("commands.team.option.name.success", $$1.d()), true);
         return 0;
      }
   }

   private static int a(et $$0, exv $$1, n $$2) throws CommandSyntaxException {
      if ($$1.n() == $$2) {
         throw d.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> wy.a("commands.team.option.color.success", $$1.d(), $$2.g()), true);
         return 0;
      }
   }
   ...
   private static int a(et $$0, exv $$1) throws CommandSyntaxException {
      ...
      if ($$3.isEmpty()) {
         ...
         $$0.a(() -> wy.a("commands.team.empty.success", $$3.size(), $$1.d()), true);
         return $$3.size();
      }
   }

   private static int b(et $$0, exv $$1) {
      eya $$2 = $$0.l().aK();
      $$2.d($$1);
      $$0.a(() -> wy.a("commands.team.remove.success", $$1.d()), true);
      return $$2.g().size();
   }
   ...
   private static int a(et $$0, String $$1, wy $$2) throws CommandSyntaxException {
      eya $$3 = $$0.l().aK();
      if ($$3.b($$1) != null) {
         throw a.create();
      } else {
         exv $$4 = $$3.c($$1);
         $$4.a($$2);
         $$0.a(() -> wy.a("commands.team.add.success", $$4.d()), true);
         return $$3.g().size();
      }
   }

   private static int c(et $$0, exv $$1) {
      Collection<String> $$2 = $$1.g();
      if ($$2.isEmpty()) {
         $$0.a(() -> wy.a("commands.team.list.members.empty", $$1.d()), false);
      } else {
         $$0.a(() -> wy.a("commands.team.list.members.success", $$1.d(), $$2.size(), xb.a($$2)), false);
      }
   ...
   private static int a(et $$0) {
      Collection<exv> $$1 = $$0.l().aK().g();
      if ($$1.isEmpty()) {
         $$0.a(() -> wy.c("commands.team.list.teams.empty"), false);
      } else {
         $$0.a(() -> wy.a("commands.team.list.teams.success", $$1.size(), xb.b($$1, exv::d)), false);
      }

      return $$1.size();
   }

   private static int b(et $$0, exv $$1, wy $$2) {
      $$1.b($$2);
      $$0.a(() -> wy.a("commands.team.option.prefix.success", $$2), false);
      return 1;
   }

   private static int c(et $$0, exv $$1, wy $$2) {
      $$1.c($$2);
