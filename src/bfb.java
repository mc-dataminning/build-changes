...
public class bfb extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(bho.D.typeName(), bjc.a()));
      Type<Pair<String, String>> $$1 = DSL.named(bho.D.typeName(), bjc.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(bho.t),
         this.getOutputSchema().getType(bho.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(bho.D.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
