...
public class bfb extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bao.a(this.a("minecraft:trident", bfb::c), this.a("minecraft:arrow", bfb::a), this.a("minecraft:spectral_arrow", bfb::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfb.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bic.C, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bic.C, $$0);
      return a($$0, $$1, $$2, $$3);
   }
