...
public abstract class cpm implements cpn, AutoCloseable {
   public static final Codec<aeq<cpm>> g = aeq.a(jc.aH);
   public static final aeq<cpm> h = aeq.a(jc.aH, new aer("overworld"));
   public static final aeq<cpm> i = aeq.a(jc.aH, new aer("the_nether"));
   public static final aeq<cpm> j = aeq.a(jc.aH, new aer("the_end"));
   ...
   protected final List<dec> r = Lists.newArrayList();
   protected final ebf s;
   ...
   private final aeq<dij> D;
   private final he<dij> E;
   protected final ece A;
   private final Supplier<bdh> F;
   public final boolean B;
   private final dgr G;
   private final cqm H;
   private final aeq<cpm> I;
   private final hs J;
   private final bhh K;
   private long L;

   protected cpm(ece $$0, aeq<cpm> $$1, hs $$2, he<dij> $$3, Supplier<bdh> $$4, boolean $$5, boolean $$6, long $$7, int $$8) {
      this.F = $$4;
      this.A = $$0;
      this.E = $$3;
      ...
      this.H = new cqm(this, $$7);
      this.d = $$6;
      this.s = new ebd(this, $$8);
      this.J = $$2;
      this.K = new bhh($$2);
   }
   ...
   public dhh d(int $$0, int $$1) {
      return (dhh)this.a($$0, $$1, dhb.n);
   }

   @Nullable
   @Override
   public dgw a(int $$0, int $$1, dhb $$2, boolean $$3) {
      dgw $$4 = this.J().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(gu $$0, dfa $$1, int $$2) {
   ...
   public boolean a(gu $$0, boolean $$1, @Nullable bii $$2, int $$3) {
      ...
      if ($$4.i()) {
         ...
         ead $$5 = this.b_($$0);
         if (!($$4.b() instanceof csa)) {
            this.c(2001, $$0, csm.i($$4));
         }

         if ($$1) {
            dcm $$6 = $$4.t() ? this.c_($$0) : null;
            csm.a($$4, this, $$0, $$6, $$2, ciy.b);
         }

         boolean $$7 = this.a($$0, $$5.g(), 3, $$3);
         if ($$7) {
            this.a(djk.f, $$0, djk.a.a($$2, $$4));
         }
   ...
   public boolean b(gu $$0, dfa $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(gu var1, dfa var2, dfa var3, int var4);

   public void b(gu $$0, dfa $$1, dfa $$2) {
   }

   public void a(gu $$0, csm $$1) {
   }

   public void a(gu $$0, csm $$1, ha $$2) {
   }
   ...
   public dfa a_(gu $$0) {
      if (this.r($$0)) {
         ...
         dhh $$1 = this.d(hx.a($$0.u()), hx.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable bii $$0, gu $$1, aov $$2, aox $$3, float $$4, float $$5) {
      this.a($$0 instanceof cbn $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public abstract void a(@Nullable cbn var1, double var2, double var4, double var6, he<aov> var8, aox var9, float var10, float var11, long var12);

   public void a(@Nullable cbn $$0, double $$1, double $$2, double $$3, aov $$4, aox $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, jb.c.d($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cbn var1, bii var2, he<aov> var3, aox var4, float var5, float var6, long var7);

   public void a(@Nullable cbn $$0, double $$1, double $$2, double $$3, aov $$4, aox $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cbn $$0, bii $$1, aov $$2, aox $$3, float $$4, float $$5) {
   ...
   protected void P() {
      ...
      Iterator<dec> $$1 = this.r.iterator();
   ...
   public boolean m(gu $$0) {
      return this.a(cot.a($$0));
   }

   public cpe a(@Nullable bii $$0, double $$1, double $$2, double $$3, float $$4, cpm.a $$5) {
      return this.a($$0, null, null, $$1, $$2, $$3, $$4, false, $$5);
   }

   public cpe a(@Nullable bii $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, cpm.a $$6) {
      return this.a($$0, null, null, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   public cpe a(@Nullable bii $$0, @Nullable bhg $$1, @Nullable cpf $$2, ehe $$3, float $$4, boolean $$5, cpm.a $$6) {
      return this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6);
   }

   public cpe a(@Nullable bii $$0, @Nullable bhg $$1, @Nullable cpf $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, cpm.a $$8) {
      return this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8, true);
   }

   public cpe a(@Nullable bii $$0, @Nullable bhg $$1, @Nullable cpf $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, cpm.a $$8, boolean $$9) {
      cpe.a $$10 = switch ($$8) {
         case a -> cpe.a.a;
         case b -> this.a(cpi.M);
         case c -> this.X().b(cpi.c) ? this.a(cpi.N) : cpe.a.a;
         case d -> this.a(cpi.O);
      };
      cpe $$11 = new cpe(this, $$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$10);
      $$11.a();
      $$11.a($$9);
      return $$11;
   }

   private cpe.a a(cpi.e<cpi.a> $$0) {
      return this.X().b($$0) ? cpe.a.c : cpe.a.b;
   }
   ...
   public dcm c_(gu $$0) {
      if (this.r($$0)) {
         ...
         return !this.B && Thread.currentThread() != this.c ? null : this.l($$0).a($$0, dhh.b.a);
      }
   }
   ...
   public boolean a(gu $$0, bii $$1, ha $$2) {
      if (this.r($$0)) {
         ...
         dgw $$3 = this.a(hx.a($$0.u()), hx.a($$0.w()), dhb.n, false);
   ...
   public gu R() {
      ...
      if (!this.w_().a($$0)) {
         $$0 = this.a(dkj.a.e, gu.a(this.w_().a(), 0.0, this.w_().b()));
      }
   ...
   public cos c(int $$0, int $$1) {
      return this.a($$0, $$1, dhb.n, false);
   }

   @Override
   public List<bii> a(@Nullable bii $$0, egz $$1, Predicate<? super bii> $$2) {
   ...
   public <T extends bii> void a(diy<bii, T> $$0, egz $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bii> void a(diy<bii, T> $$0, egz $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      this.ad().d("getEntities");
      this.E().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   public void a(gu $$0, csm $$1, int $$2, int $$3) {
   ...
   public boolean q(gu $$0) {
      if (!this.Z()) {
         ...
         return false;
      } else if (this.a(dkj.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         cqk $$1 = this.s($$0).a();
         return $$1.a($$0) == cqk.c.b;
      }
   }

   @Nullable
   public abstract ebn a(String var1);

   public abstract void a(String var1, ebn var2);
   ...
   public abstract eid I();

   public void c(gu $$0, csm $$1) {
      for (ha $$2 : ha.c.a) {
         gu $$3 = $$0.a($$2);
         if (this.A($$3)) {
            dfa $$4 = this.a_($$3);
