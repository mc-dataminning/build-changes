...
public class eqr extends anr<Map<String, List<eqr.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<eqr.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(eqr.a::a),
                     Codec.LONG.fieldOf("period").forGetter(eqr.a::b),
                     Codec.STRING.fieldOf("title").forGetter(eqr.a::c),
                     Codec.STRING.fieldOf("message").forGetter(eqr.a::d)
                  )
                  .apply($$0, eqr.a::new)
         )
         .listOf()
   ...
   public eqr(aer $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<eqr.a>> a(anm $$0, bdh $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<eqr.a>> $$0, anm $$1, bdh $$2) {
      List<eqr.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<eqr.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<eqr.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<eqr.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public eqr.b a(List<eqr.a> $$0, long $$1) {
         this.cancel();
         return new eqr.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (eqr.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> eum.a(eql.O().ay(), eum.a.g, tf.a($$2.c, $$3), tf.a($$2.d, $$3)));
                  return;
               }
            }
         }
