...
public class eqr extends eqj {
   ...
   private final List<eqr.a> n = Lists.newArrayList();
   private final Map<cmx, eqr.a> o = Maps.newHashMap();
   private final Map<String, eqk> p = Maps.newHashMap();
   final Map<String, eql> q = Maps.newLinkedHashMap();
   private final Map<String, eqo> r = Maps.newHashMap();
   private int s;

   public static eqj.a<eqr> a() {
      return new eqj.a<>(() -> {
         throw new IllegalStateException("Should never create an empty map saved data");
      }, eqr::b, azw.j);
   }

   private eqr(int $$0, int $$1, byte $$2, boolean $$3, boolean $$4, boolean $$5, akq<dcw> $$6) {
      this.f = $$2;
      this.c = $$0;
      this.d = $$1;
      this.e = $$6;
   ...
   public static eqr a(double $$0, double $$1, byte $$2, boolean $$3, boolean $$4, akq<dcw> $$5) {
      int $$6 = 128 * (1 << $$2);
      int $$7 = ayo.a(($$0 + 64.0) / (double)$$6);
      int $$8 = ayo.a(($$1 + 64.0) / (double)$$6);
      int $$9 = $$7 * $$6 + $$6 / 2 - 64;
      int $$10 = $$8 * $$6 + $$6 / 2 - 64;
      return new eqr($$9, $$10, $$2, $$3, $$4, false, $$5);
   }

   public static eqr a(byte $$0, boolean $$1, akq<dcw> $$2) {
      return new eqr(0, 0, $$0, false, false, $$1, $$2);
   }

   public static eqr b(ub $$0, jo.a $$1) {
      ...
      for (eqk $$13 : eqk.b.parse($$11, $$0.c("banners")).resultOrPartial($$0x -> i.warn("Failed to parse map banner: '{}'", $$0x)).orElse(List.of())) {
         $$9.p.put($$13.b(), $$13);
      ...
      for (int $$15 = 0; $$15 < $$14.size(); $$15++) {
         eqo $$16 = eqo.a($$14.a($$15));
         if ($$16 != null) {
            $$9.r.put($$16.e(), $$16);
            $$9.a(eqn.b, null, "frame-" + $$16.d(), (double)$$16.b().u(), (double)$$16.b().w(), (double)$$16.c(), null);
         }
      }
   ...
   public ub a(ub $$0, jo.a $$1) {
      ...
      $$0.a("locked", this.h);
      akp<uy> $$2 = $$1.a(up.a);
      $$0.a("banners", (uy)eqk.b.encodeStart($$2, List.copyOf(this.p.values())).getOrThrow());
      uh $$3 = new uh();

      for (eqo $$4 : this.r.values()) {
         $$3.add($$4.a());
      }
   ...
   public eqr b() {
      eqr $$0 = new eqr(this.c, this.d, this.f, this.l, this.m, true, this.e);
      $$0.p.putAll(this.p);
      $$0.q.putAll(this.q);
      $$0.s = this.s;
   ...
   public void a(cmx $$0, cuq $$1) {
      ...
      for (int $$4 = 0; $$4 < this.n.size(); $$4++) {
         eqr.a $$5 = this.n.get($$4);
         String $$6 = $$5.a.ah().getString();
         if (!$$5.a.dK() && ($$5.a.fZ().b($$3) || $$1.C())) {
            if (!$$1.C() && $$5.a.dP().af() == this.e && this.l) {
               this.a(eqn.a, $$5.a.dP(), $$6, $$5.a.du(), $$5.a.dA(), (double)$$5.a.dF(), null);
            }
         } else {
            this.o.remove($$5.a);
            this.n.remove($$5);
      ...
      if ($$1.C() && this.l) {
         cja $$7 = $$1.D();
         jd $$8 = $$7.t();
         eqo $$9 = this.r.get(eqo.a($$8));
         if ($$9 != null && $$7.an() != $$9.d() && this.r.containsKey($$9.e())) {
            this.a("frame-" + $$9.d());
         }

         eqo $$10 = new eqo($$8, $$7.cI().e() * 90, $$7.an());
         this.a(eqn.b, $$0.dP(), "frame-" + $$7.an(), (double)$$8.u(), (double)$$8.w(), (double)($$7.cI().e() * 90), null);
         this.r.put($$10.e(), $$10);
      }
   ...
   public static void a(cuq $$0, jd $$1, String $$2, jm<eqm> $$3) {
   ...
   private void a(jm<eqm> $$0, @Nullable dcx $$1, String $$2, double $$3, double $$4, double $$5, @Nullable wz $$6) {
      int $$7 = 1 << this.f;
      ...
      eql $$18 = new eql($$0, $$10, $$11, $$13, Optional.ofNullable($$6));
      eql $$19 = this.q.put($$2, $$18);
      if (!$$18.equals($$19)) {
         if ($$19 != null && $$19.c().a().f()) {
            this.s--;
         }
   ...
   @Nullable
   public zg<?> a(eqp $$0, cmx $$1) {
      eqr.a $$2 = this.o.get($$1);
   ...
   private void i() {
      this.c();
      this.n.forEach(eqr.a::b);
   }

   public eqr.a a(cmx $$0) {
      eqr.a $$1 = this.o.get($$0);
      if ($$1 == null) {
         $$1 = new eqr.a($$0);
         this.o.put($$0, $$1);
         this.n.add($$1);
   ...
   public void a(dcc $$0, int $$1, int $$2) {
      Iterator<eqk> $$3 = this.p.values().iterator();
   ...
   public Collection<eqk> f() {
      return this.p.values();
   }

   public void a(jd $$0, int $$1) {
      this.a("frame-" + $$1);
      this.r.remove(eqo.a($$0));
   }
   ...
   public class a {
      ...
      private eqr.b a() {
         ...
         for (int $$5 = 0; $$5 < $$2; $$5++) {
            for (int $$6 = 0; $$6 < $$3; $$6++) {
               $$4[$$5 + $$6 * $$2] = eqr.this.g[$$0 + $$5 + ($$1 + $$6) * 128];
            }
         }

         return new eqr.b($$0, $$1, $$2, $$3, $$4);
      }
      ...
      zg<?> a(eqp $$0) {
         ...
         return $$3 == null && $$1 == null ? null : new adm($$0, eqr.this.f, eqr.this.h, $$3, $$1);
      }
   ...
   public static record b(int b, int c, int d, int e, byte[] f) {
      public static final yx<ByteBuf, Optional<eqr.b>> a = yx.a(eqr.b::a, eqr.b::a);

      private static void a(ByteBuf $$0, Optional<eqr.b> $$1) {
         if ($$1.isPresent()) {
            eqr.b $$2 = $$1.get();
            $$0.writeByte($$2.d);
            $$0.writeByte($$2.e);
      ...
      private static Optional<eqr.b> a(ByteBuf $$0) {
         ...
         if ($$1 > 0) {
            ...
            byte[] $$5 = vw.a($$0);
            return Optional.of(new eqr.b($$3, $$4, $$1, $$2, $$5));
         } else {
