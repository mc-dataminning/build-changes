...
public class aj implements Comparable<aj> {
   ...
   private static final Codec<Instant> c = azn.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static aj b(ws $$0) {
      Map<String, aq> $$1 = $$0.a(ws::p, aq::b);
      return new aj($$1);
   }
   ...
   public xv d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return xv.a("advancements.progress", $$1, $$0);
         }
      }
   }
