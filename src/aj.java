...
public class aj {
   ...
   public static aj a(JsonObject $$0, be $$1) {
      aer $$2 = new aer(arg.i($$0, "trigger"));
      al<?> $$3 = ai.a($$2);
      if ($$3 == null) {
         throw new JsonSyntaxException("Invalid criterion trigger: " + $$2);
      } else {
         am $$4 = $$3.a(arg.a($$0, "conditions", new JsonObject()), $$1);
         return new aj($$4);
      }
   }

   public static aj b(si $$0) {
      return new aj();
   }
   ...
   public static Map<String, aj> b(JsonObject $$0, be $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$0.entrySet()) {
         $$2.put($$3.getKey(), a(arg.m($$3.getValue(), "criterion"), $$1));
      }

      return $$2;
   }

   public static Map<String, aj> c(si $$0) {
      return $$0.a(si::r, aj::b);
   }

   public static void a(Map<String, aj> $$0, si $$1) {
      $$1.a($$0, si::a, ($$0x, $$1x) -> $$1x.a($$0x));
   }
