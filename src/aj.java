...
public class aj implements Comparable<aj> {
   ...
   private static final Codec<Instant> c = azd.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static aj b(wh $$0) {
      Map<String, aq> $$1 = $$0.a(wh::p, aq::b);
      return new aj($$1);
   }
   ...
   public xk d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return xk.a("advancements.progress", $$1, $$0);
         }
      }
   }
