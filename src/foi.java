...
public class foi {
   ...
   public final Map<ha, foj> c;
   public final fok d;
   public final boolean e;

   public foi(Vector3f $$0, Vector3f $$1, Map<ha, foj> $$2, @Nullable fok $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ha, foj> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<foi> {
      ...
      public foi a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         fok $$6 = this.a($$3);
         Map<ha, foj> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !arg.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = arg.a($$3, "shade", true);
            return new foi($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fok a(JsonObject $$0) {
         fok $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<ha, foj> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ha, foj> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ha, foj> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ha, foj> $$2 = Maps.newEnumMap(ha.class);
         JsonObject $$3 = arg.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ha $$5 = this.a($$4.getKey());
            $$2.put($$5, (foj)$$0.deserialize($$4.getValue(), foj.class));
         }
