...
public class foi {
   ...
   public void a(cpe $$0, fgz $$1, float $$2, int $$3, int $$4) {
      cra $$5 = $$0.b(this.d);
   ...
   private void a(cra $$0, akk $$1, float $$2, fgz $$3, int $$4, int $$5) {
      gpi $$6 = ffn.Q().a(gph.e).apply($$1);
