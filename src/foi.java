public abstract class foi extends fon {
   ...
   public void a(double $$0) {
      this.a = ayy.a($$0, 0.0, (double)this.i());
   }
   ...
   protected int k() {
      return ayy.a((int)((float)(this.h * this.h) / (float)this.n()), 32, this.h - 8);
   }
