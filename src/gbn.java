...
public class gbn implements AutoCloseable {
   ...
   public gbn(gbh $$0, fde $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gml(16, 16, false);
   ...
   private float b(float $$0) {
      bqt $$1 = this.j.s.c(bqv.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(bsa $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, axz.b(((float)$$0.ai - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.b(bqv.p)) {
               $$9 = gbh.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(bqv.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   private static void a(Vector3f $$0) {
      $$0.set(axz.a($$0.x, 0.0F, 1.0F), axz.a($$0.y, 0.0F, 1.0F), axz.a($$0.z, 0.0F, 1.0F));
   }
   ...
   public static float a(dtz $$0, int $$1) {
      float $$2 = (float)$$1 / 15.0F;
      float $$3 = $$2 / (4.0F - 3.0F * $$2);
      return axz.i($$0.s(), $$3, 1.0F);
   }
