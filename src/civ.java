...
public abstract class civ extends bsq {
   private static final Logger c = LogUtils.getLogger();
   private int d;
   protected jd b;

   protected civ(bsw<? extends civ> $$0, dcu $$1) {
      super($$0, $$1);
   }

   protected civ(bsw<? extends civ> $$0, dcu $$1, jd $$2) {
      this($$0, $$1);
      this.b = $$2;
   }
   ...
   public abstract void b(@Nullable bsq var1);
