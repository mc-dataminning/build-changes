...
public class xr {
   ...
   public static final akh b = new akh("minecraft", "default");
   @Nullable
   final xt c;
   @Nullable
   final Boolean d;
   ...
   public static class b {
      public static final MapCodec<xr> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  axh.a(xt.a, "color").forGetter($$0x -> Optional.ofNullable($$0x.c)),
                  axh.a(Codec.BOOL, "bold").forGetter($$0x -> Optional.ofNullable($$0x.d)),
                  axh.a(Codec.BOOL, "italic").forGetter($$0x -> Optional.ofNullable($$0x.e)),
                  axh.a(Codec.BOOL, "underlined").forGetter($$0x -> Optional.ofNullable($$0x.f)),
                  axh.a(Codec.BOOL, "strikethrough").forGetter($$0x -> Optional.ofNullable($$0x.g)),
                  axh.a(Codec.BOOL, "obfuscated").forGetter($$0x -> Optional.ofNullable($$0x.h)),
                  axh.a(ws.a, "clickEvent").forGetter($$0x -> Optional.ofNullable($$0x.i)),
                  axh.a(xa.a, "hoverEvent").forGetter($$0x -> Optional.ofNullable($$0x.j)),
                  axh.a(Codec.STRING, "insertion").forGetter($$0x -> Optional.ofNullable($$0x.k)),
                  axh.a(akh.a, "font").forGetter($$0x -> Optional.ofNullable($$0x.l))
               )
               .apply($$0, xr::a)
      );
