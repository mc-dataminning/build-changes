...
public class fp implements fo {
   ...
   public eif a(du $$0) {
      eie $$1 = $$0.l();
      eif $$2 = $$0.n().a($$0);
      float $$3 = asy.b(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$4 = asy.a(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$5 = asy.b(-$$1.i * (float) (Math.PI / 180.0));
      float $$6 = asy.a(-$$1.i * (float) (Math.PI / 180.0));
      float $$7 = asy.b((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      float $$8 = asy.a((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      eif $$9 = new eif((double)($$3 * $$5), (double)$$6, (double)($$4 * $$5));
      eif $$10 = new eif((double)($$3 * $$7), (double)$$8, (double)($$4 * $$7));
      eif $$11 = $$9.c($$10).a(-1.0);
      ...
      return new eif($$2.c + $$12, $$2.d + $$13, $$2.e + $$14);
   }
