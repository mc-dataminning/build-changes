...
public class fp implements ArgumentType<fp.g> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wo.c("arguments.nbtpath.node.invalid"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wo.c("arguments.nbtpath.too_deep"));
   public static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> wo.b("arguments.nbtpath.nothing_found", $$0));
   static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> wo.b("commands.data.modify.expected_list", $$0));
   static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> wo.b("commands.data.modify.invalid_index", $$0));
   ...
   public static fp.g a(CommandContext<ex> $$0, String $$1) {
      return (fp.g)$$0.getArgument($$1, fp.g.class);
   }

   public fp.g a(StringReader $$0) throws CommandSyntaxException {
      List<fp.h> $$1 = Lists.newArrayList();
      int $$2 = $$0.getCursor();
      Object2IntMap<fp.h> $$3 = new Object2IntOpenHashMap();
      boolean $$4 = true;
      ...
      return new fp.g($$0.getString().substring($$2, $$0.getCursor()), $$1.toArray(new fp.h[0]), $$3);
   }

   private static fp.h a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return (fp.h)(switch ($$0.peek()) {
   ...
   static class a implements fp.h {
      public static final fp.a a = new fp.a();
   ...
   static class b implements fp.h {
   ...
   static class c implements fp.h {
      private final int a;
   ...
   public static class g {
      ...
      private final Object2IntMap<fp.h> c;
      private final fp.h[] d;
      public static final Codec<fp.g> a = Codec.STRING.comapFlatMap($$0 -> {
         try {
            fp.g $$1 = new fp().a(new StringReader($$0));
      ...
      public static fp.g a(String $$0) throws CommandSyntaxException {
         return new fp().a(new StringReader($$0));
      }

      public g(String $$0, fp.h[] $$1, Object2IntMap<fp.h> $$2) {
         this.b = $$0;
         this.d = $$1;
         this.c = $$2;
      }
      ...
      private CommandSyntaxException a(fp.h $$0) {
         int $$1 = this.c.getInt($$0);
         return fp.c.create(this.b.substring(0, $$1));
      }
