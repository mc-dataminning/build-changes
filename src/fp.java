...
public class fp implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> xe.b("slot.only_single_allowed", $$0));

   public static fp a() {
      return new fp();
   }

   public static int a(CommandContext<eh> $$0, String $$1) {
