...
public class fjm extends hmd {
   ...
   private static final frd D = new frd(aku.b("widget/cross_button"), aku.b("widget/cross_button_highlighted"));
   ...
   protected void aR_() {
      ...
      if (this.S) {
         this.T = this.c(fpq.a(wp.c("mco.selectServer.trial"), fuf.b(this, axv.q)).a(this.G() - 10 - 99, this.H() - 10 - 4 - 40, 99, 20).a());
      }

      this.c(fpq.a(wp.c("mco.selectServer.buy"), fuf.b(this, axv.r)).a(this.G() - 10 - 99, this.H() - 10 - 20, 99, 20).a());
      fqc $$0 = this.c(new fqc(this.E() + 4, this.F() + 4, 14, 14, D, $$0x -> this.aO_(), b));
      $$0.a(frb.a(b));
      int $$1 = 142 - (this.S ? 40 : 20);
      fqa $$2 = new fqa(this.G() - 10 - 100, this.F() + 10, 100, $$1, a, this.p);
      if ($$2.q()) {
         $$2.h(94);
      }
   ...
   public static void a(fpc $$0, fpq $$1) {
      int $$2 = 8;
      $$0.c().a();
      $$0.c().a(0.0F, 0.0F, 110.0F);
      $$0.a(gnh::H, C, $$1.F() + $$1.A() - 8 - 4, $$1.G() + $$1.y() / 2 - 4, 8, 8);
      $$0.c().b();
   }
   ...
   public void b(fpc $$0, int $$1, int $$2, float $$3) {
      ...
      this.A();
      this.b($$0);
      $$0.a(gnh::H, c, this.E(), this.F(), 320, 172);
      if (!Q.isEmpty()) {
         $$0.a(gnh::H, Q.get(this.U), this.E() + 10, this.F() + 10, 0.0F, 0.0F, 195, 152, 195, 152);
      }
   }
