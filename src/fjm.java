...
public class fjm implements fjp {
   private static final alf d = new alf("toast/advancement");
   ...
   public fjp.a a(fgt $$0, fjq $$1, long $$2) {
      ...
      if ($$3 != null) {
         ...
         if (!this.f && $$2 > 0L) {
            this.f = true;
            if ($$3.e() == al.b) {
               $$1.b().aj().a(gsk.a(awa.Au, 1.0F, 1.0F));
            }
         }

         $$0.b($$3.c(), 8, 8);
         return (double)$$2 >= 5000.0 * $$1.c() ? fjp.a.b : fjp.a.a;
      } else {
         return fjp.a.b;
      }
   }
