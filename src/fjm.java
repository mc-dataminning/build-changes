...
public class fjm extends fig<cmz> {
   ...
   private int ab;
   private final fjm.a[] ac = new fjm.a[7];
   int ad;
   private boolean ae;

   public fjm(cmz $$0, cit $$1, vu $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.n = 107;
   }
   ...
   protected void aO_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.ac[$$3] = this.c(new fjm.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fjm.a) {
               this.ab = ((fjm.a)$$0x).a() + this.ad;
               this.I();
            }
         }));
         $$2 += 20;
   ...
   private void a(fav $$0, int $$1, int $$2, cvz $$3) {
      int $$4 = this.p.n();
      int $$5 = this.p.l();
      if ($$4 < 5) {
         ...
         if ($$5 >= $$6 && cii.d($$4)) {
            int $$7 = 102;
            float $$8 = 102.0F / (float)(cii.c($$4) - $$6);
   ...
   private void a(fav $$0, int $$1, int $$2, cwa $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fav $$0, cvz $$1, int $$2, int $$3) {
   ...
   private void a(fav $$0, cqm $$1, cqm $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.M() == $$1.M()) {
         $$0.a(this.i, $$1, $$3, $$4);
      } else {
   ...
   class a extends fbi {
      ...
      public a(int $$0, int $$1, int $$2, fbi.c $$3) {
      ...
      public void a(fav $$0, int $$1, int $$2) {
         if (this.i && fjm.this.p.p().size() > this.a + fjm.this.ad) {
            if ($$1 < this.B() + 20) {
               cqm $$3 = fjm.this.p.p().get(this.a + fjm.this.ad).b();
               $$0.b(fjm.this.i, $$3, $$1, $$2);
            } else if ($$1 < this.B() + 50 && $$1 > this.B() + 30) {
               cqm $$4 = fjm.this.p.p().get(this.a + fjm.this.ad).c();
               if (!$$4.b()) {
                  $$0.b(fjm.this.i, $$4, $$1, $$2);
               }
            } else if ($$1 > this.B() + 65) {
               cqm $$5 = fjm.this.p.p().get(this.a + fjm.this.ad).d();
               $$0.b(fjm.this.i, $$5, $$1, $$2);
            }
         }
      }
   }
