...
public class fjm extends hle {
   ...
   public void aR_() {
      this.a(this.J.a);
      this.c(fot.a(wp.c("mco.configure.world.subscription.extend"), $$0 -> fti.a(this, axv.a(this.J.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.J.j) {
         this.c(
            fot.a(wp.c("mco.configure.world.delete.button"), $$0 -> this.m.a(fjg.b(this, wp.c("mco.configure.world.delete.question.line1"), $$0x -> this.E())))
               .a(this.n / 2 - 100, g(10), 200, 20)
               .a()
         );
      } else if (fgf.b() && this.J.u != null) {
         this.c(new fpd(this.n / 2 - 100, g(8), 200, 46, wp.a("mco.snapshot.subscription.info", this.J.u), this.p));
      } else {
         this.c(new fpd(this.n / 2 - 100, g(8), 200, 46, H, this.p));
      }

      this.c(fot.a(wo.k, $$0 -> this.aO_()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
      ...
      (new Thread("Realms-delete-realm") {
         ...
         public void run() {
            try {
               ...
               fjm.a.error("Couldn't delete world", var2);
            }

            fjm.this.m.execute(() -> fjm.this.m.a(fjm.this.K));
         }
      }).start();
      this.m.a(this);
   }
