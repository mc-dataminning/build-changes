...
public class fjm extends fji {
   private final List<fjp> c = new ArrayList<>();
   ...
   public <T extends fjp> T a(T $$0, int $$1, int $$2) {
      return this.a($$0, $$1, $$2, this.b());
   }

   public <T extends fjp> T a(T $$0, int $$1, int $$2, fjq $$3) {
      return this.a($$0, $$1, $$2, 1, 1, $$3);
   }

   public <T extends fjp> T a(T $$0, int $$1, int $$2, Consumer<fjq> $$3) {
      return this.a($$0, $$1, $$2, 1, 1, ac.a(this.b(), $$3));
   }

   public <T extends fjp> T a(T $$0, int $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, this.b());
   }

   public <T extends fjp> T a(T $$0, int $$1, int $$2, int $$3, int $$4, fjq $$5) {
      if ($$3 < 1) {
         throw new IllegalArgumentException("Occupied rows must be at least 1");
      } else if ($$4 < 1) {
         throw new IllegalArgumentException("Occupied columns must be at least 1");
      } else {
         this.d.add(new fjm.a($$0, $$1, $$2, $$3, $$4, $$5));
         this.c.add($$0);
         return $$0;
      }
   }

   public <T extends fjp> T a(T $$0, int $$1, int $$2, int $$3, int $$4, Consumer<fjq> $$5) {
   ...
   static class a extends fji.a {
      ...
      a(fjp $$0, int $$1, int $$2, int $$3, int $$4, fjq $$5) {
         super($$0, $$5.h());
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
   ...
   public final class b {
      ...
      public <T extends fjp> T a(T $$0, int $$1) {
      ...
      public <T extends fjp> T a(T $$0, int $$1, fjq $$2) {
         int $$3 = this.c / this.b;
         int $$4 = this.c % this.b;
         if ($$4 + $$1 > this.b) {
            $$3++;
            $$4 = 0;
            this.c = ayf.d(this.c, this.b);
         }

         this.c += $$1;
         return fjm.this.a($$0, $$3, $$4, 1, $$1, $$2);
      }
