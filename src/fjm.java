...
public class fjm extends hkx {
   ...
   public void aR_() {
      this.a(this.J.a);
      this.c(fos.a(wo.c("mco.configure.world.subscription.extend"), $$0 -> fth.a(this, axv.a(this.J.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.J.j) {
         this.c(
            fos.a(wo.c("mco.configure.world.delete.button"), $$0 -> this.m.a(fjg.b(this, wo.c("mco.configure.world.delete.question.line1"), $$0x -> this.E())))
               .a(this.n / 2 - 100, g(10), 200, 20)
               .a()
         );
      } else if (fgf.b() && this.J.u != null) {
         this.c(new fpc(this.n / 2 - 100, g(8), 200, 46, wo.a("mco.snapshot.subscription.info", this.J.u), this.p));
      } else {
         this.c(new fpc(this.n / 2 - 100, g(8), 200, 46, H, this.p));
      }

      this.c(fos.a(wn.k, $$0 -> this.aO_()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
