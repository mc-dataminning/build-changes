...
public class eyp extends eys {
   public static final int a = 854;
   public static final int b = 480;
   static final eyp.b l = new eyp.b(854, 480);

   public eyp(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eyp.a[] e = values();
   ...
   static class b {
      ...
      static List<eyp.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyp.b($$0, $$1), eyp.l) : ImmutableList.of(eyp.l);
      }
