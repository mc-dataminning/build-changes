...
public class eyp {
   ...
   private static final Queue<eyp.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eyp.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eyp::a), eyn::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eyp::a), eyn::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eyp.a(this.b) + ", type=" + eyp.b(this.c) + ", severity=" + eyp.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
