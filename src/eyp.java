...
public class eyp extends eyt implements eyr {
   ...
   public eyp.c a() {
      return new eyp.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(eyz.b $$0, eyz $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (eza)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(eyz $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == eys.k;
         boolean $$2 = $$0 == eys.j;
   ...
   private IntConsumer a(int $$0, eyz.a $$1) {
   ...
   private eyp.b q() {
      ...
      this.k += $$5;
      this.j++;
      eyp.a $$9 = new eyp.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new eyp.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eyz.b.a || this.q == eyz.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eza> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eza $$1 = (eza)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eza.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eza.b.c) {
         eyr.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, eyr.a($$11));
         this.a($$14 + 5, eyr.a($$12));
         this.a($$14 + 6, eyr.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eyz a, int b, int c, eyz.b d, eyz.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eyz.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable ezc $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
