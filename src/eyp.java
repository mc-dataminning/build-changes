...
public class eyp extends eyk {
   ...
   public void a(esf $$0, int $$1, int $$2, float $$3) {
      ...
      this.p.a($$3, arx.a($$4, 0.0F, 1.0F));
      RenderSystem.enableBlend();
      $$0.a(1.0F, 1.0F, 1.0F, this.q ? (float)arx.f(arx.a($$4, 0.0F, 1.0F)) : 1.0F);
      $$0.a(l, 0, 0, this.g, this.h, 0.0F, 0.0F, 16, 128, 16, 128);
      $$0.a(1.0F, 1.0F, 1.0F, 1.0F);
      float $$5 = this.q ? arx.a($$4 - 1.0F, 0.0F, 1.0F) : 1.0F;
      this.u.a($$0, this.g, $$5);
      int $$6 = arx.f($$5 * 255.0F) << 24;
      if (($$6 & -67108864) != 0) {
         if (this.t != null) {
            this.t.a($$0, $$6);
         }
   ...
   private void c(boolean $$0) {
      if ($$0) {
         try (ecg.c $$1 = this.f.l().d("Demo_World")) {
            $$1.g();
