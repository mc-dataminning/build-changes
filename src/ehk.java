...
public final class ehk implements AutoCloseable {
   ...
   public ehk(ehk.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private ehk(ehk.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static ehk a(@Nullable ehk.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ehk a(@Nullable ehk.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new ehk($$0 == null ? ehk.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
