...
public class ehk {
   ...
   public ehk(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ehk(gw $$0, gw $$1) {
      this((double)$$0.u(), (double)$$0.v(), (double)$$0.w(), (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
   }

   public ehk(ehp $$0, ehp $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ehk a(dvc $$0) {
      return new ehk((double)$$0.g(), (double)$$0.h(), (double)$$0.i(), (double)($$0.j() + 1), (double)($$0.k() + 1), (double)($$0.l() + 1));
   }

   public static ehk a(ehp $$0) {
      return new ehk($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public ehk a(double $$0) {
      return new ehk($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ehk b(double $$0) {
      return new ehk(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ehk c(double $$0) {
      return new ehk(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ehk d(double $$0) {
      return new ehk(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ehk e(double $$0) {
      return new ehk(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ehk f(double $$0) {
      return new ehk(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ehk b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ehk c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ehk d(double $$0, double $$1, double $$2) {
      return new ehk(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ehk f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ehk h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ehp> b(ehp $$0, ehp $$1) {
   ...
   @Nullable
   public static ehl a(Iterable<ehk> $$0, ehp $$1, ehp $$2, gw $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ehl($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static hc a(ehk $$0, ehp $$1, double[] $$2, @Nullable hc $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ehp f() {
      return new ehp(ary.d(0.5, this.a, this.d), ary.d(0.5, this.b, this.e), ary.d(0.5, this.c, this.f));
   }

   public static ehk a(ehp $$0, double $$1, double $$2, double $$3) {
      return new ehk($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
