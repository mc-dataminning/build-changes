...
public class apf {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wo.c("commands.transfer.error.no_players"));
   ...
   private static int a(ex $$0, String $$1, int $$2, Collection<ard> $$3) throws CommandSyntaxException {
      if ($$3.isEmpty()) {
         throw a.create();
      } else {
         for (ard $$4 : $$3) {
         ...
         if ($$3.size() == 1) {
            $$0.a(() -> wo.a("commands.transfer.success.single", $$3.iterator().next().p_(), $$1, $$2), true);
         } else {
            $$0.a(() -> wo.a("commands.transfer.success.multiple", $$3.size(), $$1, $$2), true);
         }
