...
public class apf extends apk {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<apg<?>> e = Sets.newHashSet();

   public apf(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<apg<?>> d() {
      Set<apg<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  qu $$4 = a($$3.getAsJsonObject());
                  $$4 = asv.g.a($$0, $$4, rg.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<apg<T>> a(api<T> $$0, String $$1) {
      return Optional.ofNullable(aeu.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static qu a(JsonObject $$0) {
      qu $$1 = new qu();
   ...
   protected String b() {
      Map<api<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apg<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apg<?>>)$$3.next();
         apg<?> $$2 = (apg<?>)$$1.getKey();
      ...
      for (Entry<api<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> aeu b(apg<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(ako $$0) {
      Object2IntMap<apg<?>> $$1 = new Object2IntOpenHashMap();
