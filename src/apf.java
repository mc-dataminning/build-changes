...
public class apf {
   ...
   private static Collection<String> a(Collection<? extends bsu> $$0) {
   ...
   private static int a(ep $$0, Collection<? extends bsu> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xp.a("commands.tag.add.success.single", $$2, $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> xp.a("commands.tag.add.success.multiple", $$2, $$1.size()), true);
         }
   ...
   private static int b(ep $$0, Collection<? extends bsu> $$1, String $$2) throws CommandSyntaxException {
      int $$3 = 0;
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xp.a("commands.tag.remove.success.single", $$2, $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> xp.a("commands.tag.remove.success.multiple", $$2, $$1.size()), true);
         }
   ...
   private static int a(ep $$0, Collection<? extends bsu> $$1) {
      ...
      if ($$1.size() == 1) {
         bsu $$4 = $$1.iterator().next();
         if ($$2.isEmpty()) {
            $$0.a(() -> xp.a("commands.tag.list.single.empty", $$4.O_()), false);
         } else {
            $$0.a(() -> xp.a("commands.tag.list.single.success", $$4.O_(), $$2.size(), xs.a($$2)), false);
         }
      } else if ($$2.isEmpty()) {
         $$0.a(() -> xp.a("commands.tag.list.multiple.empty", $$1.size()), false);
      } else {
         $$0.a(() -> xp.a("commands.tag.list.multiple.success", $$1.size(), $$2.size(), xs.a($$2)), false);
      }
