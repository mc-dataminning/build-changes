...
public class ak implements Comparable<ak> {
   ...
   private static final Codec<Map<String, ar>> d = Codec.unboundedMap(Codec.STRING, c)
      .xmap(
         ...
         $$0 -> $$0.entrySet()
               ...
               .collect(Collectors.toMap(Entry::getKey, $$0x -> Objects.requireNonNull(((ar)$$0x.getValue()).d())))
      );
   public static final Codec<ak> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(d.optionalFieldOf("criteria", Map.of()).forGetter($$0x -> $$0x.e), Codec.BOOL.fieldOf("done").orElse(true).forGetter(ak::a))
            .apply($$0, ($$0x, $$1) -> new ak(new HashMap<>($$0x)))
   );
   private final Map<String, ar> e;
   private al f = al.b;

   private ak(Map<String, ar> $$0) {
      this.e = $$0;
   }
   ...
   public static ak b(vs $$0) {
      Map<String, ar> $$1 = $$0.a(vs::p, ar::b);
      return new ak($$1);
   }

   @Nullable
   public ar c(String $$0) {
      return this.e.get($$0);
   }
   ...
   public ww d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return ww.a("advancements.progress", $$1, $$0);
         }
      }
   }
   ...
   public Iterable<String> e() {
      ...
      for (Entry<String, ar> $$1 : this.e.entrySet()) {
         if (!$$1.getValue().a()) {
            $$0.add($$1.getKey());
         }
      }
   ...
   @Nullable
   public Instant g() {
      return this.e.values().stream().map(ar::d).filter(Objects::nonNull).min(Comparator.naturalOrder()).orElse(null);
   }
