...
public class chc extends cit implements cks {
   ...
   private static Optional<aeq<cpm>> c(qr $$0) {
      return cpm.g.parse(rc.a, $$0.c("LodestoneDimension")).result();
   }
   ...
   private void a(aeq<cpm> $$0, gu $$1, qr $$2) {
      $$2.a("LodestonePos", rd.a($$1));
      cpm.g.encodeStart(rc.a, $$0).resultOrPartial(d::error).ifPresent($$1x -> $$2.a("LodestoneDimension", $$1x));
