...
public class chc {
   ...
   private static void b(buq<chb> $$0) {
      $$0.a(col.a, 0, ImmutableList.of(new bvc(2.0F), new bwn(45, 90), new bwr(), new bvn(ccs.P)));
   }
         ...
         ImmutableList.of(
            ...
            Pair.of(
               ...
               new bvv(
                  ...
                  bvv.a.a,
                  bvv.b.b,
                  ImmutableList.of(Pair.of(bwz.c(0.5F), 2), Pair.of(bxo.a(0.5F, 3), 3), Pair.of(byu.a(bst::bh), 5))
               )
            )
         )
      );
