...
public abstract class dph {
   ...
   public final void c(us $$0, jk.a $$1) {
      this.a($$0, $$1);
      dph.a.a.parse($$1.a(vg.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final us d(jk.a $$0) {
      us $$1 = new us();
      this.b($$1, $$0);
      dph.a.a.encodeStart($$0.a(vg.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((us)$$1x));
      return $$1;
   }
   ...
   public static void a(us $$0, dpj<?> $$1) {
      $$0.a("id", dpj.a($$1).toString());
   }

   public void a(cup $$0, jk.a $$1) {
      us $$2 = this.e($$1);
      this.a($$2);
      csn.a($$0, this.r(), $$2);
      $$0.b(this.s());
   ...
   @Nullable
   public static dph a(iz $$0, dsc $$1, us $$2, jk.a $$3) {
      String $$4 = $$2.l("id");
      alf $$5 = alf.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(dby $$0, iz $$1, dsc $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
