...
public class aql {
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(xg.c("commands.data.merge.failed"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> xg.b("commands.data.get.invalid", $$0));
   private static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> xg.b("commands.data.get.unknown", $$0));
   private static final SimpleCommandExceptionType g = new SimpleCommandExceptionType(xg.c("commands.data.get.multiple"));
   private static final DynamicCommandExceptionType h = new DynamicCommandExceptionType($$0 -> xg.b("commands.data.modify.expected_object", $$0));
   private static final DynamicCommandExceptionType i = new DynamicCommandExceptionType($$0 -> xg.b("commands.data.modify.expected_value", $$0));
   private static final Dynamic2CommandExceptionType j = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> xg.b("commands.data.modify.invalid_substring", $$0, $$1)
   );
   public static final List<Function<String, aql.c>> a = ImmutableList.of(aqm.a, aqj.a, aqn.a);
   public static final List<aql.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<aql.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<ek> $$0) {
      ...
      for (aql.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<ek, ?>, aql.b>)(($$0x, $$1x) -> $$0x.then(
                           el.a("insert")
                              .then(
   ...
   private static List<va> a(List<va> $$0, aql.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<ek, ?> a(BiConsumer<ArgumentBuilder<ek, ?>, aql.b> $$0) {
   ...
   private static List<va> a(CommandContext<ek> $$0, aql.c $$1) throws CommandSyntaxException {
      aqk $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<va> b(CommandContext<ek> $$0, aql.c $$1) throws CommandSyntaxException {
      aqk $$2 = $$1.a($$0);
      fc.g $$3 = fc.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<ek> $$0, aql.c $$1, aql.a $$2, List<va> $$3) throws CommandSyntaxException {
      aqk $$4 = $$1.a($$0);
   ...
   private static int a(ek $$0, aqk $$1, fc.g $$2) throws CommandSyntaxException {
      ua $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static va a(fc.g $$0, aqk $$1) throws CommandSyntaxException {
   ...
   private static int b(ek $$0, aqk $$1, fc.g $$2) throws CommandSyntaxException {
      va $$3 = a($$2, $$1);
   ...
   private static int a(ek $$0, aqk $$1, fc.g $$2, double $$3) throws CommandSyntaxException {
      va $$4 = a($$2, $$1);
      if (!($$4 instanceof uq)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = azz.a(((uq)$$4).k() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(ek $$0, aqk $$1) throws CommandSyntaxException {
      ua $$2 = $$1.a();
      $$0.a(() -> $$1.a((va)$$2), false);
      return 1;
   }

   private static int a(ek $$0, aqk $$1, ua $$2) throws CommandSyntaxException {
      ua $$3 = $$1.a();
      if (fc.g.a($$2, 0)) {
         throw fc.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<ek, ?> create(aql.a var1);
   }

   public interface c {
      aqk a(CommandContext<ek> var1) throws CommandSyntaxException;
