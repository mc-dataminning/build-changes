...
public class avw extends azx {
   public static final Gson a = new GsonBuilder().registerTypeAdapter(uv.class, new JsonDeserializer<uv>() {
      public vj a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         if ($$0.isJsonPrimitive()) {
            return uv.b($$0.getAsString());
         } else if ($$0.isJsonArray()) {
            JsonArray $$3 = $$0.getAsJsonArray();
            vj $$4 = null;

            for (JsonElement $$5 : $$3) {
               vj $$6 = this.a($$5, $$5.getClass(), $$2);
               if ($$4 == null) {
                  $$4 = $$6;
               } else {
                  $$4.b($$6);
   ...
   public avw(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntitySignTextStrictJsonFix", bax.s, "Sign");
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0, String $$1) {
      ...
      return $$0.set($$1, $$0.createString(uv.a.a($$3)));
   }
