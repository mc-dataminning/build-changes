...
public class avw extends avv {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avw.a> s;
   private final avr t;
   private long u;
   private final als v;

   private avw(als $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avs.c($$2, 7, $$0.getLength());
      }
   }
