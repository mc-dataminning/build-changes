...
public class avw {
   ...
   avw(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static avw.a a() {
      return new avw.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(avw::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public avw.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public avw a(Writer $$0) throws IOException {
         return new avw($$0, this.a);
      }
   }
}
