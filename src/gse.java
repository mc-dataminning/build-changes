...
public abstract class gse<T extends bum, S extends gyl> {
   ...
   public final int a(T $$0, float $$1) {
      ji $$2 = ji.a((kb)$$0.n($$1));
      return glx.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, ji $$1) {
      return $$0.dV().a(dgs.a, $$1);
   }

   protected int a(T $$0, ji $$1) {
      return $$0.bY() ? 15 : $$0.dV().a(dgs.b, $$1);
   }

   public boolean a(T $$0, gpr $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if (!this.b($$0)) {
         return true;
      } else {
         faw $$5 = this.a($$0).g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new faw($$0.dA() - 2.0, $$0.dC() - 2.0, $$0.dG() - 2.0, $$0.dA() + 2.0, $$0.dC() + 2.0, $$0.dG() + 2.0);
         }

         if ($$1.a($$5)) {
            return true;
         } else {
            if ($$0 instanceof bvg $$6) {
               bum $$7 = $$6.D();
               if ($$7 != null) {
   ...
   private static void a(ffv $$0, glz $$1, gyl.a $$2) {
      float $$3 = 0.025F;
   ...
   protected void a(S $$0, wp $$1, ffv $$2, glz $$3, int $$4) {
      fbb $$5 = $$0.E;
      if ($$5 != null) {
         boolean $$6 = !$$0.A;
         ...
         int $$11 = (int)(flk.Q().n.a(0.25F) * 255.0F) << 24;
         $$9.a($$1, $$10, (float)$$7, -2130706433, false, $$8, $$3, $$6 ? fod.a.b : fod.a.a, $$11, $$4);
         if ($$6) {
            $$9.a($$1, $$10, (float)$$7, -1, false, $$8, $$3, fod.a.a, 0, glx.b($$4, 2));
         }
   ...
   public void a(T $$0, S $$1, float $$2) {
      ...
      if ($$8) {
         $$1.D = this.c($$0);
         $$1.E = $$0.ds().a(bun.c, 0, $$0.k($$2));
      } else {
         $$1.D = null;
      }

      $$1.A = $$0.cg();
      bum $$10 = $$0 instanceof bvg $$9 ? $$9.D() : null;
      if ($$10 != null) {
         ...
         $$15.f = $$0.dV().a(dgs.a, $$13);
         $$15.g = $$0.dV().a(dgs.a, $$14);
      } else {
         $$1.F = null;
      }
