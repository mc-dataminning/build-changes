...
public final class xw {
   ...
   public static final Codec<xw> a = Codec.STRING.comapFlatMap(xw::a, xw::b);
   private static final Map<n, xw> c = Stream.of(n.values())
      .filter(n::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new xw($$0.f(), $$0.g())));
   private static final Map<String, xw> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
   private final String f;

   private xw(int $$0, String $$1) {
      this.e = $$0 & 16777215;
      this.f = $$1;
   }
   ...
   public static DataResult<xw> a(String $$0) {
      if ($$0.startsWith("#")) {
         try {
