...
public record bnq<T>(bni<StringReader> a, bng<T> b) {
   public Optional<T> a(bnl<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bnj.a<StringReader> $$1 = new bnj.a<>();
      bnu $$2 = new bnu(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bnk::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bnj.a<StringReader> $$2 = new bnj.a<>();
      bnu $$3 = new bnu(this.a(), $$2, $$1);
      this.a($$3);
      List<bnk<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bnk<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bnt $$7) {
               ez.a($$7.a(), $$5);
            } else {
               ez.b($$6.b().possibleValues($$3), $$5);
            }
         }
