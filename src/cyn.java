...
public class cyn {
   ...
   public static final cyn b = new cyn(0, 0);
   ...
   public static cyn a(int $$0, int $$1) {
      return new cyn($$0 << 5, $$1 << 5);
   }

   public static cyn b(int $$0, int $$1) {
      return new cyn(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public static long a(id $$0) {
      return c(jg.a($$0.u()), jg.a($$0.w()));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cyn $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public id a(int $$0, int $$1, int $$2) {
      return new id(this.a($$0), $$1, this.b($$2));
   }

   public int a(int $$0) {
      return jg.a(this.e, $$0);
   }

   public int b(int $$0) {
      return jg.a(this.f, $$0);
   }

   public id c(int $$0) {
      return new id(this.b(), $$0, this.c());
   }
   ...
   public static Stream<cyn> a(cyn $$0, int $$1) {
      return a(new cyn($$0.e - $$1, $$0.f - $$1), new cyn($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cyn> a(final cyn $$0, final cyn $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cyn>((long)($$2 * $$3), 64) {
         @Nullable
         private cyn e;

         @Override
         public boolean tryAdvance(Consumer<? super cyn> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cyn($$0.e, $$2 + $$5);
               } else {
                  this.e = new cyn($$1 + $$4, $$2);
               }
            }
