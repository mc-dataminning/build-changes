...
public class ags {
                  ...
                  ((LiteralArgumentBuilder)du.a("clear").executes($$0x -> a((dt)$$0x.getSource(), ImmutableList.of(((dt)$$0x.getSource()).g()))))
                     .then(
                        ((RequiredArgumentBuilder)du.a("targets", ee.b()).executes($$0x -> a((dt)$$0x.getSource(), ee.b($$0x, "targets"))))
                           .then(du.a("effect", eq.a($$1, jc.O)).executes($$0x -> a((dt)$$0x.getSource(), ee.b($$0x, "targets"), eq.f($$0x, "effect"))))
                     )
               ))
            .then(
               du.a("give")
                  .then(
                     du.a("targets", ee.b())
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)du.a("effect", eq.a($$1, jc.O))
   ...
   private static int a(dt $$0, Collection<? extends biq> $$1, he<bib> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      bib $$6 = $$2.a();
      int $$7 = 0;
      int $$8;
      if ($$3 != null) {
   ...
   private static int a(dt $$0, Collection<? extends biq> $$1, he<bib> $$2) throws CommandSyntaxException {
      bib $$3 = $$2.a();
      int $$4 = 0;
