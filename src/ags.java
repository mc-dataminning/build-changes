...
public class ags {
   ...
   private static int a(ds $$0, Collection<? extends byo> $$1, int $$2) {
      for (byo $$3 : $$1) {
         $$3.W().ifPresent($$1x -> $$1x.a($$2));
      }

      if ($$1.size() == 1) {
         $$0.a(() -> sw.a("commands.warden_spawn_tracker.set.success.single", $$1.iterator().next().H_()), true);
      } else {
         $$0.a(() -> sw.a("commands.warden_spawn_tracker.set.success.multiple", $$1.size()), true);
      }
   ...
   private static int a(ds $$0, Collection<? extends byo> $$1) {
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> sw.a("commands.warden_spawn_tracker.clear.success.single", $$1.iterator().next().H_()), true);
      } else {
