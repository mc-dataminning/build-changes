...
public class egk extends LongLinkedOpenHashSet {
   private final egk.a a;

   public egk(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new egk.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = awh.f(60000000);
      private static final int b = awh.f(60000000);
