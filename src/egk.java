...
public class egk extends efx<ehu> {
   public egk(Codec<ehu> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efz<ehu> $$0) {
      ji $$1 = $$0.e();
      dhf $$2 = $$0.b();
   ...
   private void a(azh $$0, dgi $$1, int $$2, int $$3, ji $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ji $$2, dgi $$3, boolean $$4, double $$5, ji $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dgi $$0, ji $$1) {
      if ($$0.a_($$1.d()).a(djn.ea)) {
         this.a($$0, $$1.d(), djn.a.m());
      }
   }

   private void a(dgi $$0, azh $$1, ji $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dww $$13) {
   ...
   private void a(ji $$0, dgi $$1, azh $$2, int $$3, int $$4, boolean $$5, boolean $$6, dww $$7) {
      dww $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(djn.ec) || $$8.a(djn.eb) || $$8.a(djn.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(djn.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, djn.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dww $$0) {
      return $$0.a(djn.ja) || $$0.a(djn.ec) || $$0.a(djn.ny);
   }
   ...
   private void a(dgi $$0, ji $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(djn.ea)) {
                  if (this.a((dfm)$$0, $$10)) {
                     this.a($$0, $$10, djn.a.m());
                     this.a($$0, $$10.d(), djn.a.m());
                  } else if (c($$11)) {
                     dww[] $$12 = new dww[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
