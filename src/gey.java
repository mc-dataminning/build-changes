...
public class gey extends ggp {
   private final float a;
   private final ggk b;

   gey(gci $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, ggk $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gfs<lj> {
      ...
      public gfp a(lj $$0, gci $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.l() && $$8.o() == dok.a) {
            ...
            jh $$9 = jh.a($$2, $$3, $$4);
            int $$10 = fji.Q().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof dkz) {
               $$10 = ((dkz)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gey($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
