...
public class vl {
   ...
   public static final Codec<un> i = Codec.STRING.comapFlatMap($$0 -> {
      try {
         return DataResult.success(new vl(new StringReader($$0)).a(), Lifecycle.stable());
      } catch (CommandSyntaxException var2) {
         return DataResult.error(var2::getMessage);
      }
   }, un::toString);
   public static final Codec<un> j = Codec.withAlternative(i, un.a);
   private final StringReader v;

   public static un a(String $$0) throws CommandSyntaxException {
      return new vl(new StringReader($$0)).a();
   }

   @VisibleForTesting
   un a() throws CommandSyntaxException {
      un $$0 = this.f();
   ...
   protected vk c() throws CommandSyntaxException {
      this.v.skipWhitespace();
      int $$0 = this.v.getCursor();
      if (StringReader.isQuotedStringStart(this.v.peek())) {
         return vi.a(this.v.readQuotedString());
      } else {
   ...
   private vk b(String $$0) {
      try {
         if (q.matcher($$0).matches()) {
            return uq.a(Float.parseFloat($$0.substring(0, $$0.length() - 1)));
         }

         if (r.matcher($$0).matches()) {
            return ul.a(Byte.parseByte($$0.substring(0, $$0.length() - 1)));
         }

         if (s.matcher($$0).matches()) {
            return uv.a(Long.parseLong($$0.substring(0, $$0.length() - 1)));
         }

         if (t.matcher($$0).matches()) {
            return vf.a(Short.parseShort($$0.substring(0, $$0.length() - 1)));
         }

         if (u.matcher($$0).matches()) {
            return us.a(Integer.parseInt($$0));
         }

         if (p.matcher($$0).matches()) {
            return uo.a(Double.parseDouble($$0.substring(0, $$0.length() - 1)));
         }

         if (o.matcher($$0).matches()) {
            return uo.a(Double.parseDouble($$0));
         }
   ...
   public vk d() throws CommandSyntaxException {
      this.v.skipWhitespace();
      if (!this.v.canRead()) {
         throw c.createWithContext(this.v);
      } else {
   ...
   private vk g() throws CommandSyntaxException {
      this.a('[');
      this.v.skipWhitespace();
      if (!this.v.canRead()) {
         throw c.createWithContext(this.v);
   ...
   private vk h() throws CommandSyntaxException {
      this.a('[');
      int $$0 = this.v.getCursor();
      char $$1 = this.v.read();
      this.v.read();
   ...
   private <T extends Number> List<T> a(vm<?> $$0, vm<?> $$1) throws CommandSyntaxException {
