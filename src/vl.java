...
public class vl extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<un> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, tz.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<un> $$0, Codec<T> $$1, tz $$2) {
      un $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vl a(DynamicOps<un> $$0, Codec<T> $$1, T $$2) {
      un $$3 = (un)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }
   ...
   public static ji b(ByteBuf $$0) {
      return ji.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, ji $$1) {
      $$0.writeLong($$1.a());
   }
   ...
   public <T> vl a(ToIntFunction<T> $$0, T $$1) {
   ...
   public vl a(@Nullable un $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable un $$1) {
      if ($$1 == null) {
         $$1 = ts.b;
      }

      try {
         ud.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static tq h(ByteBuf $$0) {
      un $$1 = a($$0, tz.a(2097152L));
      if ($$1 != null && !($$1 instanceof tq)) {
   ...
   @Nullable
   public static un a(ByteBuf $$0, tz $$1) {
      try {
         un $$2 = ud.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public vl a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vl a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vl a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vl a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vl a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vl a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vl a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vl a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public vl b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vl c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vl d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vl e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vl f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vl g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vl h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vl a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vl b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vl i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vl a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vl a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vl b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vl b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vl b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vl b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vl b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vl b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vl j(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vl c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vl a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vl a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public vl a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vl a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vl a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public vl k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vl d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vl b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vl b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vl b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
