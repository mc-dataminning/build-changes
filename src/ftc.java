...
public class ftc<T extends cgr & btn> extends fsv<T> {
   ...
   public static fxg c() {
      ...
      fxj $$1 = $$0.a();
      fxj $$2 = $$1.a(
         "body", fxf.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fxc.a(0.0F, 20.0F, 5.0F)
      );
      fxe $$3 = new fxe(0.001F);
      fxj $$4 = $$2.a("head", fxf.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fxc.a(0.0F, 0.0F, -9.0F));
      fxf $$5 = fxf.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fxf $$6 = fxf.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fxf $$7 = fxf.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fxc.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fxc.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fxc.a(4.0F, 0.0F, -1.0F));
      fxf $$8 = fxf.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fxf $$9 = fxf.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fxc.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fxc.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fxc.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fxc.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fxf.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fxc.a(0.0F, 0.0F, 1.0F));
   ...
   private Vector3f a(fxa $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fxa $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fxa $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * ayz.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * ayz.b($$2 * 0.9F));
