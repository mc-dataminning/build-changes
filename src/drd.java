...
public class drd {
   ...
   final boolean g;
   private final aya<dkd> h;
   private final int i;
   private final int j;
   private final int k;
   private final int l;
   private List<drd.a> m = new ArrayList<>();
   private static final Logger n = LogUtils.getLogger();

   public drd(boolean $$0, aya<dkd> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static drd a() {
      return new drd(false, axk.bU, 10, 4, 10, 5);
   }

   public static drd b() {
      return new drd(true, axk.bV, 50, 1, 5, 10);
   }
   ...
   public void a(um $$0) {
      if ($$0.b("cursors", 9)) {
         this.m.clear();
         List<drd.a> $$1 = (List<drd.a>)drd.a.b.listOf().parse(new Dynamic(va.a, $$0.c("cursors", 10))).resultOrPartial(n::error).orElseGet(ArrayList::new);
   ...
   public void b(um $$0) {
      drd.a.b.listOf().encodeStart(va.a, this.m).resultOrPartial(n::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(jh $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new drd.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(drd.a $$0) {
      if (this.m.size() < 32) {
         this.m.add($$0);
      }
   }

   public void a(dha $$0, jh $$1, bac $$2, boolean $$3) {
      if (!this.m.isEmpty()) {
         List<drd.a> $$4 = new ArrayList<>();
         Map<jh, drd.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<drd.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  jh.a.fieldOf("pos").forGetter(drd.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(drd.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(drd.a::c),
      ...
      private boolean a(dha $$0, jh $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
         } else {
            return $$0 instanceof arx $$3 ? $$3.n($$1) : false;
         }
      }

      public void a(dha $$0, jh $$1, bac $$2, drd $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.g)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, awv.wt, aww.e, 1.0F, 1.0F);
               }
      ...
      private static dqy a(dxo $$0) {
         return $$0.b() instanceof dqy $$1 ? $$1 : dqy.u_;
      }

      private static List<kl> a(bac $$0) {
         return ae.a(c, $$0);
      }

      @Nullable
      private static jh a(dha $$0, jh $$1, bac $$2) {
         jh.a $$3 = $$1.k();
         jh.a $$4 = $$1.k();
      ...
      private static boolean a(dha $$0, jh $$1, jh $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            jh $$3 = $$2.b($$1);
      ...
      private static boolean a(dha $$0, jh $$1, jm $$2) {
         jh $$3 = $$1.a($$2);
