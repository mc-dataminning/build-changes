...
public class drd extends dpq {
   ...
   protected void b(tx $$0, jl.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (uu)cxe.a.encodeStart(ul.a, this.i).getOrThrow());
      }
   ...
   protected void a(tx $$0, jl.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         cxe.a.parse(ul.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }
   ...
   public static void a(dcg $$0, ja $$1, dsl $$2, drd $$3) {
      if ($$2.b(dmk.a) && $$2.c(dmk.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
