...
public class bss extends brt {
   ...
   public bss(cbe $$0, double $$1, int $$2, float $$3) {
      this($$0, $$1, $$2, $$2, $$3);
   }

   public bss(cbe $$0, double $$1, int $$2, int $$3, float $$4) {
      if (!($$0 instanceof bky)) {
   ...
   public void e() {
      ...
      if (--this.d == 0) {
         ...
         float $$3 = ati.a($$2, 0.1F, 1.0F);
         this.b.a(this.c, $$3);
         this.d = ati.d($$2 * (float)(this.h - this.g) + (float)this.g);
      } else if (this.d < 0) {
         this.d = ati.a(ati.d(Math.sqrt($$0) / (double)this.i, (double)this.g, (double)this.h));
      }
   }
}
