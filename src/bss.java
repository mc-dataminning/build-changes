...
public abstract class bss<R extends Runnable> implements bsb, bsy<R>, Executor {
   ...
   @Override
   public List<bry> bw() {
      return ImmutableList.of(bry.a(this.b + "-pending-tasks", brx.b, this::by));
   }
