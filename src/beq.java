...
public class beq extends bbe {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), beq::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", beq::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", beq::k);
         $$0 = this.a($$0, "minecraft:fox", beq::j);
         $$0 = this.a($$0, "minecraft:item", beq::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", beq::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", beq::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", beq::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", beq::e);
         return this.a($$0, "minecraft:piglin", beq::d);
      });
   }
