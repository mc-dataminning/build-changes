...
public record cmn(cmn.a d) {
   ...
   public static final Codec<cmn> c = cmn.a.a.xmap(cmn::new, cmn::b);

   public static cmn a(ayt $$0, UUID $$1, cmn.a $$2) throws cmn.b {
      if (!$$2.a($$0, $$1)) {
         throw new cmn.b(e);
      } else {
         return new cmn($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cmn.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  axo.o.fieldOf("expires_at").forGetter(cmn.a::b), axd.f.fieldOf("key").forGetter(cmn.a::c), axo.p.fieldOf("signature_v2").forGetter(cmn.a::d)
               )
               .apply($$0, cmn.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cmn.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
