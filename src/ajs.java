...
public interface ajs<T> {
   default void a(int $$0, int $$1, int $$2, cwi<?> $$3, Iterator<T> $$4, int $$5) {
      int $$6 = $$0;
      int $$7 = $$1;
      if ($$3.b() instanceof cwn $$9) {
         $$6 = $$9.j();
         $$7 = $$9.k();
      }
      ...
      for (int $$11 = 0; $$11 < $$1; $$11++) {
         ...
         int $$13 = axw.d((float)$$1 / 2.0F - (float)$$7 / 2.0F);
         if ($$12 && $$13 > $$11) {
            $$10 += $$0;
            $$11++;
         }
         ...
         for (int $$14 = 0; $$14 < $$0; $$14++) {
            ...
            $$13 = axw.d((float)$$0 / 2.0F - (float)$$6 / 2.0F);
            int $$15 = $$6;
            boolean $$16 = $$14 < $$6;
            if ($$12) {
               $$15 = $$13 + $$6;
