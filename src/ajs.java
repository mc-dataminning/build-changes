...
class ajs implements Path {
   ...
   ajs a(String $$0) {
      ...
      } else if (this.i instanceof ajv.a $$1) {
         ajs $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ajs(this.e, $$0, this, ajv.a);
      } else if (this.i instanceof ajv.b) {
   ...
   private ajs c(@Nullable Path $$0) {
      if ($$0 == null) {
         ...
         if ($$0 instanceof ajs $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ajv.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ajv.a i() {
      return this.i instanceof ajv.a $$0 ? $$0 : null;
   }
