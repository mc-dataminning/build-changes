...
public class ajs {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> vd.b("commands.locate.structure.not_found", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> vd.b("commands.locate.structure.invalid", $$0));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> vd.b("commands.locate.biome.not_found", $$0));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> vd.b("commands.locate.poi.not_found", $$0));
   ...
   private static Optional<? extends il.b<dyz>> a(ev.c<dyz> $$0, it<dyz> $$1) {
      return (Optional<? extends il.b<dyz>>)$$0.a().map($$1x -> $$1.b($$1x).map($$0xx -> il.a($$0xx)), $$1::b);
   }

   private static int a(ds $$0, ev.c<dyz> $$1) throws CommandSyntaxException {
      it<dyz> $$2 = $$0.e().I_().d(ke.aD);
      il<dyz> $$3 = (il<dyz>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      hx $$4 = hx.a($$0.d());
      amz $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(ac.c);
      Pair<hx, ih<dyz>> $$7 = $$5.l().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(ds $$0, eu.c<cuh> $$1) throws CommandSyntaxException {
      hx $$2 = hx.a($$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(ac.c);
      Pair<hx, ih<cuh>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(ds $$0, eu.c<bxj> $$1) throws CommandSyntaxException {
      hx $$2 = hx.a($$0.d());
      amz $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(ac.c);
      Optional<Pair<ih<bxj>, hx>> $$5 = $$3.y().e($$1, $$2, 256, bxg.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(ds $$0, hx $$1, Pair<hx, ? extends ih<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      hx $$7 = (hx)$$2.getFirst();
      int $$8 = $$4 ? aui.d(aui.c((float)$$1.j($$7))) : aui.d(a($$1.u(), $$1.w(), $$7.u(), $$7.w()));
      String $$9 = $$4 ? String.valueOf($$7.v()) : "~";
      vd $$10 = vg.a((vd)vd.a("chat.coordinates", $$7.u(), $$9, $$7.w()))
         .a($$2x -> $$2x.a(n.k).a(new vb(vb.a.d, "/tp @s " + $$7.u() + " " + $$9 + " " + $$7.w())).a(new vj(vj.a.a, vd.c("chat.coordinates.tooltip"))));
      $$0.a(() -> vd.a($$3, $$5, $$10, $$8), false);
