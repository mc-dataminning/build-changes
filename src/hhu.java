...
public abstract class hhu extends ftw {
   ...
   private final List<hht> a = Lists.newArrayList();
   ...
   protected hht a(hht $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xv l() {
      return xu.a(this.a.stream().map(hht::a).collect(Collectors.toList()));
   }
}
