...
public abstract class esg<E extends esg.a<E>> extends eud implements etn, ewb {
   protected static final int b = 6;
   private static final aeu a = new aeu("widget/scroller");
   protected final eqq c;
   protected final int d;
   private final List<E> m = new esg.b();
   protected int e;
   protected int f;
   protected int g;
   protected int h;
   ...
   public esg(eqq $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected final E a(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ars.a($$1 - (double)this.g) - this.l + (int)this.l() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void a(esa $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.s) {
         ...
         int $$4 = 32;
         $$0.a(eyf.d, this.j, this.g, (float)this.i, (float)(this.h + (int)this.l()), this.i - this.j, this.h - this.g, 32, 32);
      ...
      if (this.s) {
         int $$7 = 4;
         $$0.a(foh.D(), this.j, this.g, this.i, this.g + 4, -16777216, 0, 0);
         $$0.a(foh.D(), this.j, this.h - 4, this.i, this.h, 0, -16777216, 0);
      }
      ...
      if ($$8 > 0) {
         ...
         $$10 = ars.a($$10, 32, this.h - this.g - 8);
   ...
   public void a(double $$0) {
      this.n = ars.a($$0, 0.0, (double)this.m());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.g) {
            ...
            int $$6 = this.h - this.g;
            int $$7 = ars.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   protected void a(esa $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   protected void a(ewd $$0, E $$1) {
      ...
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(ewc.b, ti.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
   ...
   protected abstract static class a<E extends esg.a<E>> implements euf {
      @Deprecated
      esg<E> a;
      ...
      public abstract void a(esa var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
