...
public class eaj extends LongLinkedOpenHashSet {
   private final eaj.a a;

   public eaj(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eaj.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = ary.f(60000000);
      private static final int b = ary.f(60000000);
