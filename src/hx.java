...
public class hx extends jb {
   ...
   private static final int e = 1 + aup.f(aup.c(30000000));
   ...
   public static hx a(double $$0, double $$1, double $$2) {
      return new hx(aup.a($$0), aup.a($$1), aup.a($$2));
   }
   ...
   public static Iterable<hx> a(auw $$0, int $$1, hx $$2, int $$3) {
   ...
   public static Iterable<hx> a(auw $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      int $$8 = $$5 - $$2 + 1;
      int $$9 = $$6 - $$3 + 1;
      int $$10 = $$7 - $$4 + 1;
   ...
   public static Stream<hx> a(dzg $$0) {
      return a(
         Math.min($$0.h(), $$0.k()),
         Math.min($$0.i(), $$0.l()),
         Math.min($$0.j(), $$0.m()),
   ...
   public static Stream<hx> a(elx $$0) {
      return a(aup.a($$0.a), aup.a($$0.b), aup.a($$0.c), aup.a($$0.d), aup.a($$0.e), aup.a($$0.f));
   }
   ...
   public static class a extends hx {
      ...
      public hx.a b(double $$0, double $$1, double $$2) {
         return this.d(aup.a($$0), aup.a($$1), aup.a($$2));
      }
      ...
      public hx.a a(ic.a $$0, int $$1, int $$2) {
         switch ($$0) {
            case a:
               return this.d(aup.a(this.u(), $$1, $$2), this.v(), this.w());
            case b:
               return this.d(this.u(), aup.a(this.v(), $$1, $$2), this.w());
            case c:
               return this.d(this.u(), this.v(), aup.a(this.w(), $$1, $$2));
            default:
