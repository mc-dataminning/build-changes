...
public class hx extends hz {
   ...
   public static hx a(cot $$0, int $$1) {
      return new hx($$0.e, $$1, $$0.f);
   }

   public static hx a(dir $$0) {
      return a($$0.dk());
   }
   ...
   public static Stream<hx> a(cot $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.e;
      int $$5 = $$0.f;
