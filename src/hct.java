...
public class hct implements auj<hcs> {
   public hcs b(JsonObject $$0) {
      Builder<hcr> $$1 = ImmutableList.builder();
      int $$2 = azk.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = azk.a($$0, "width", -1);
      int $$9 = azk.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = azk.a($$0, "interpolate", false);
      return new hcs($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private hcr a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new hcr(azk.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = azk.m($$1, "frames[" + $$0 + "]");
         int $$3 = azk.a($$2, "time", -1);
         if ($$2.has("time")) {
