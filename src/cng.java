public class cng extends bss implements cnk {
   private static final akj<cun> b = akn.a(cng.class, akl.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public cng(bsy<? extends cng> $$0, dbw $$1) {
      super($$0, $$1);
   }

   public cng(dbw $$0, double $$1, double $$2, double $$3) {
      this(bsy.N, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void l() {
      ...
      double $$4 = $$0.h();
      this.s(cnn.d(this.P, (float)(ayx.d($$0.d, $$4) * 180.0F / (float)Math.PI)));
      this.r(cnn.d(this.O, (float)(ayx.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
      if (!this.dP().B) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         float $$7 = (float)Math.sqrt($$5 * $$5 + $$6 * $$6);
         float $$8 = (float)ayx.d($$6, $$5);
         double $$9 = ayx.d(0.0025, $$4, (double)$$7);
         double $$10 = $$0.d;
         if ($$7 < 1.0F) {
            $$9 *= 0.8;
            $$10 *= 0.8;
         ...
         $$0 = new evp(Math.cos((double)$$8) * $$9, $$10 + ((double)$$11 - $$10) * 0.015F, Math.sin((double)$$8) * $$9);
         this.h($$0);
      }
      ...
      if (!this.dP().B) {
         ...
         if (this.f > 80 && !this.dP().B) {
            ...
            this.ao();
            if (this.g) {
               this.dP().b(new cjf(this.dP(), this.du(), this.dw(), this.dA(), this.p()));
            } else {
   ...
   public void a(ur $$0) {
      if ($$0.b("Item", 10)) {
         this.a(cun.a(this.dR(), (vo)$$0.p("Item")).orElse(this.s()));
      } else {
         this.a(this.s());
      }
   }
