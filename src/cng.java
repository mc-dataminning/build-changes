...
public class cng extends bxj {
   ...
   public static final akj<Byte> bw = akn.a(cng.class, akl.a);
   public static final akj<jx> bx = akn.a(cng.class, akl.n);
   public static final akj<jx> by = akn.a(cng.class, akl.n);
   public static final akj<jx> bz = akn.a(cng.class, akl.n);
   public static final akj<jx> bA = akn.a(cng.class, akl.n);
   public static final akj<jx> bB = akn.a(cng.class, akl.n);
   public static final akj<jx> bC = akn.a(cng.class, akl.n);
   private static final Predicate<bwi> bL = $$0 -> {
      if ($$0 instanceof ctz $$1 && $$1.y()) {
         return true;
      }
   ...
   public cng(bwr<? extends cng> $$0, djm $$1) {
      super($$0, $$1);
   }

   public cng(djm $$0, double $$1, double $$2, double $$3) {
      this(bwr.f, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private boolean a(crm $$0, bws $$1, czn $$2, buf $$3) {
      czn $$4 = this.a($$1);
   ...
   public boolean a(arq $$0, bux $$1, float $$2) {
      if (this.dP()) {
         ...
         if (!$$3 && !$$4) {
            ...
            if ($$1.d() instanceof crm $$5 && !$$5.gj().e) {
               return false;
            }
   ...
   private void c(arq $$0, bux $$1) {
      czn $$2 = new czn(czr.vQ);
      $$2.b(kk.g, this.ak());
      dmr.a(this.dU(), this.du(), $$2);
      this.d($$0, $$1);
   }
   ...
   private void d(arq $$0, bux $$1) {
      ...
      for (bws $$2 : bws.j) {
         czn $$3 = this.bt.a($$2, czn.k);
         if (!$$3.f()) {
            dmr.a(this.dU(), this.du().d(), $$3);
         }
      }
   }
   ...
   public boolean v(bwi $$0) {
      if ($$0 instanceof crm $$1 && !this.dU().a($$1, this.du())) {
         return true;
      }
   ...
   public ffc o(float $$0) {
      if (this.t()) {
         fex $$1 = this.v(false).a(this.ds());
         iv $$2 = this.du();
         int $$3 = Integer.MIN_VALUE;

         for (iv $$4 : iv.c(iv.a($$1.a, $$1.b, $$1.c), iv.a($$1.d, $$1.e, $$1.f))) {
            int $$5 = Math.max(this.dU().a(djv.b, $$4), this.dU().a(djv.a, $$4));
            if ($$5 == 15) {
               return ffc.b($$4);
            }
