...
public abstract class bji extends DataFix {
   private final String a;

   public bji(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(biw.z.typeName(), bkk.a());
      if (!Objects.equals(this.getOutputSchema().getType(biw.z), $$2)) {
