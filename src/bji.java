...
public abstract class bji extends bjg implements bkc {
   private static final aee<Byte> b = aeh.a(bji.class, aeg.a);
   ...
   private final hn<cjf> bX = hn.a(2, cjf.b);
   protected final float[] bQ = new float[2];
   private final hn<cjf> bY = hn.a(4, cjf.b);
   ...
   public void a(qw $$0) {
      ...
      if ($$0.b("DeathLootTable", 8)) {
         this.cc = new aew($$0.l("DeathLootTable"));
   ...
   public void a(biq $$0, float $$1, float $$2) {
      ...
      float $$9 = (float)(arw.d($$4, $$3) * 180.0F / (float)Math.PI) - 90.0F;
      float $$10 = (float)(-(arw.d($$6, $$8) * 180.0F / (float)Math.PI));
      ...
      if ($$2.a(cji.tQ) && this.a($$0)) {
         ...
         if ($$2.d() instanceof ckk) {
            if (this.dL() instanceof akq) {
               ckk $$4 = (ckk)$$2.d();
               Optional<bji> $$5 = $$4.a($$0, this, (biu<? extends bji>)this.ag(), (akq)this.dL(), this.dj(), $$2);
   ...
   public void a(boolean $$0, boolean $$1) {
      if (this.ce != null) {
         ...
         if (!this.dL().B && $$0 && this.dL() instanceof akq) {
            ((akq)this.dL()).k().b(this, new zy(this, null));
         }
      }
   }
   ...
   public void b(biq $$0, boolean $$1) {
      this.ce = $$0;
      this.cg = null;
      if (!this.dL().B && $$1 && this.dL() instanceof akq) {
         ((akq)this.dL()).k().b(this, new zy(this, this.ce));
      }
   ...
   private void fZ() {
      if (this.cg != null && this.dL() instanceof akq) {
         if (this.cg.b("UUID")) {
            UUID $$0 = this.cg.a("UUID");
            biq $$1 = ((akq)this.dL()).a($$0);
            if ($$1 != null) {
               this.b($$1, true);
               return;
            }
   ...
   public boolean C(biq $$0) {
      ...
      if ($$4) {
         if ($$2 > 0.0F && $$0 instanceof bjg) {
            ((bjg)$$0).q((double)($$2 * 0.5F), (double)arw.a(this.dB() * (float) (Math.PI / 180.0)), (double)(-arw.b(this.dB() * (float) (Math.PI / 180.0))));
