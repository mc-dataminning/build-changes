...
public class cql {
   ...
   private final cql.a k;
   @VisibleForTesting
   protected final Object2IntMap<bwi> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cql> a(Predicate<bwi> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cql::b)).apply($$1, $$1x -> new cql($$0, $$1x))
      );
   }

   public cql(Predicate<bwi> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cql.a(this);
   ...
   @VisibleForTesting
   protected static record a(cql a) implements Comparator<bwi> {
      public int a(bwi $$0, bwi $$1) {
         if ($$0.equals($$1)) {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof crj;
               boolean $$7 = $$1 instanceof crj;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
