...
public class chl {
   ...
   public void a(chl.d $$0) {
      ...
      aew<chl> $$2 = jd.ao.c(this).orElseThrow(() -> new IllegalStateException("Unregistered creative tab: " + this));
      this.n.accept($$0, $$1);
      this.j = $$1.a;
      this.k = $$1.b;
      this.n();
   ...
   public static record d(cec a, boolean b, hi.b c) {

      public boolean a(cec $$0, boolean $$1, hi.b $$2) {
