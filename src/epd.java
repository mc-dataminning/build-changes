...
public class epd extends gfd {
   ...
   private static final tn C = tn.c("mco.upload.verifying");
   private final eow D;
   private final ecj E;
   ...
   @Nullable
   private volatile tn[] J;
   private volatile tn K = tn.c("mco.upload.preparing");
   ...
   public epd(long $$0, int $$1, eow $$2, ecj $$3) {
      super(eqp.a);
      this.F = $$0;
      this.G = $$1;
      this.D = $$2;
   ...
   @Override
   public void aH_() {
      this.Q = this.d(ess.a(tm.k, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.Q.j = false;
      this.R = this.d(ess.a(tm.e, $$0 -> this.E()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.P) {
         if (this.D.b == -1) {
            this.G();
         } else {
   ...
   private void d(esh $$0) {
      ...
      $$0.a(this.i, tn.a("mco.upload.percent", this.L), this.g / 2, 84, 16777215);
   }
   ...
   private tn F() {
      List<tn> $$0 = Lists.newArrayList();
      $$0.add(this.K);
      if (this.L != null) {
         $$0.add(tn.a("mco.upload.percent", this.L));
      }
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.K = tn.c("mco.upload.close.failure");
                  } else {
                     enm $$3 = null;
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.M) {
                              ...
                              this.K = tn.a("mco.upload.uploading", this.E.b());
                              emf $$11 = new emf($$0, this.F, this.G, $$3, this.f.V(), aa.b().c(), this.H);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    this.N = true;
                                    this.K = tn.c("mco.upload.done");
                                    this.Q.b(tm.d);
                                    epq.b($$2);
                                 } else if ($$1x.a == 400 && $$1x.b != null) {
                                    this.a(tn.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(tn.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              emd $$8 = emd.a($$7);
                              emd $$9 = emd.a(5368709120L);
                              if (emd.b($$7, $$8).equals(emd.b(5368709120L, $$9)) && $$8 != emd.a) {
                                 emd $$10 = emd.values()[$$8.ordinal() - 1];
                                 this.a(
                                    tn.a("mco.upload.size.failure.line1", this.E.b()),
                                    tn.a("mco.upload.size.failure.line2", emd.b($$7, $$10), emd.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    tn.a("mco.upload.size.failure.line1", this.E.b()),
                                    tn.a("mco.upload.size.failure.line2", emd.b($$7, $$8), emd.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(tn.a("mco.upload.failed", var21.getMessage()));
               } catch (enu var22) {
                  this.a(tn.a("mco.upload.failed", var22.a.b()));
   ...
   private void H() {
      this.K = tn.c("mco.upload.cancelled");
