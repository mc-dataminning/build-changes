...
public class fkl implements ftu {
   ...
   protected void a(fhz $$0, float $$1, int $$2, int $$3, ftv $$4) {
   ...
   private void a(fhz $$0, int $$1, int $$2, float $$3, float $$4, ftt $$5) {
      if ($$5 != ftr.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == ftr.a || !this.g.a($$1).aV_())) {
         $$1 += $$0;
      }
