...
public class fkl extends hhv implements fhv {
   ...
   private foe V;
   private int W;
   private final frt X = new frt(this);
   ...
   @Override
   public void aT_() {
      this.U = this.X.b(foe.a(xu.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(foe.a(xu.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.J();
   ...
   private void E() {
      this.m.a(new fjr(new fhc(new ftz()), this.J));
   }
   ...
   private void J() {
      ...
      fio $$1 = fio.a(this.H.g(), this.H.l().c());
