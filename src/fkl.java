...
public class fkl<T extends bym> extends fjf<T> {
   public final fnj a;
   private final fnj b;
   private final fnj f;
   private final fnj g;
   ...
   public static fnp c() {
      fnr $$0 = new fnr();
      fns $$1 = $$0.a();
      fns $$2 = $$1.a("head", fno.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fnl.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fno.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fnl.a);
      $$2.a("left_ear", fno.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fnl.a);
      $$2.a("nose", fno.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fnl.a);
      fns $$3 = $$1.a("body", fno.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fnl.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fnn $$4 = new fnn(0.001F);
      fno $$5 = fno.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fno $$6 = fno.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fnl.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fnl.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fnl.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fnl.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fno.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fnl.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fnp.a($$0, 48, 32);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      ...
      if ($$0.bX()) {
         this.b.e = 1.6755161F;
         float $$4 = $$0.E($$3);
         this.b.a(0.0F, 16.0F + $$0.E($$3), -6.0F);
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fD()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = aup.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.bX()) {
         float $$6 = aup.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.gf()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = aup.b(this.n * 0.4662F) * 0.1F;
         this.g.e = aup.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = aup.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = aup.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
