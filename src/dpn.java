...
public class dpn extends dny<drb> {
   public dpn(Codec<drb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(doa<drb> $$0) {
      cqr $$1 = $$0.b();
      drb $$2 = $$0.f();
      ase $$3 = $$0.d();
      gw $$4 = $$0.e();
      Predicate<dfl> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dfk.a::i) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(doa<drb> $$0, cqr $$1, drb $$2, ase $$3, Set<gw> $$4, int $$5, int $$6) {
      for (gw $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(cqr $$0, drb $$1, Predicate<dfl> $$2, ase $$3, gw.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dfl $$7 = $$1.c.a($$3, $$4);
         dfl $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
