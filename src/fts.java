...
public class fts extends ftw {
   ...
   private static final aly<dij> y = diq.b;
   ...
   @Nullable
   private static emj a(jr<dkl> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, ebp.c);
      int $$10 = $$9 - $$2;

      Optional<jq.c<dkl>> $$11;
      try {
   ...
   private static List<emj> a(jr<dkl> $$0, String $$1) {
   ...
   public static emm a(jr<dkl> $$0, jr<dij> $$1, jr<eop> $$2, jr<enn> $$3, String $$4, emm $$5) {
   ...
   protected void aT_() {
      ...
      this.E = new fom(this.p, 50, 40, this.n - 100, 20, this.A);
      this.E.f(1230);
      fzf $$0 = this.z.a.l().k();
      ke $$1 = $$0.a();
      css $$2 = $$0.h().b();
      ...
      jr<eop> $$4 = $$1.e(mb.aW);
      jr<enn> $$5 = $$1.e(mb.aT);
      jr<dkl> $$6 = $$1.e(mb.f).a($$2);
      this.E.a(a(this.z.k()));
      this.F = this.z.k();
      this.d(this.E);
      this.C = this.c(new fts.a($$1, $$2));
      this.D = this.c(fod.a(xv.c("createWorld.customize.presets.select"), $$4x -> {
         emm $$5x = a($$6, $$3, $$4, $$5, this.E.a(), this.F);
         this.z.a($$5x);
         this.m.a(this.z);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(fod.a(xu.e, $$0x -> this.m.a(this.z)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends fpa<fts.a.a> {
      public a(final ke $$0, final css $$1) {
         super(fts.this.m, fts.this.n, fts.this.o - 117, 80, 24);

         for (jq<emk> $$2 : $$0.e(mb.aQ).c(axz.a)) {
            Set<dkl> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               fts.c
                  .info(
               ...
               this.b(new fts.a.a($$2));
            }
         }
      }

      public void a(@Nullable fts.a.a $$0) {
         super.a($$0);
         fts.this.c($$0 != null);
      }
      ...
      public class a extends fpa.a<fts.a.a> {
         ...
         void b() {
            a.this.a(this);
            fts.this.F = this.c.b();
            fts.this.E.a(fts.a(fts.this.F));
            fts.this.E.b(false);
         }

         private void a(fnq $$0, int $$1, int $$2, cxk $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cxo($$3), $$1 + 2, $$2 + 2);
         }

         private void a(fnq $$0, int $$1, int $$2) {
            $$0.a(glt::B, fts.b, $$1, $$2, 18, 18);
         }
