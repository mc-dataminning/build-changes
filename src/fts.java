public class fts extends fsh {
   private static final ftw a = new ftw(
   ...
   public fts(fun $$0, fum $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   public void b(frv $$0, int $$1, int $$2, float $$3) {
      $$0.a(gqk::H, a.a(this.b(), this.D()), this.F(), this.G(), this.g, this.h);
      frt $$4 = foz.Q().h;
   ...
   protected void a(frv $$0, int $$1, int $$2, int $$3, int $$4) {
      fyb.a($$0, fyb.g, $$1, $$2, 0.0F, 0.0F, $$3 - $$1, $$4 - $$2);
   }
   ...
   private void b(frv $$0, frt $$1, int $$2) {
   ...
   protected void a(fwg $$0) {
      $$0.a(fwf.a, wy.a("gui.narrate.tab", this.n.a()));
   }
