...
public record cr(cl.d d, Optional<cps> e, List<cr.e<?>> f, Object2BooleanMap<aew> g, Map<aew, cr.c> h, Optional<bq> i) implements br {
   public static final int b = 100;
   public static final MapCodec<cr> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               arf.a(cl.d.d, "level", cl.d.c).forGetter(cr::b),
               cps.f.optionalFieldOf("gamemode").forGetter(cr::c),
               arf.a(cr.e.a.listOf(), "stats", List.of()).forGetter(cr::d),
               arf.a(arf.d(aew.a), "recipes", Object2BooleanMaps.emptyMap()).forGetter(cr::e),
               arf.a(Codec.unboundedMap(aew.a, cr.c.b), "advancements", Map.of()).forGetter(cr::f),
               arf.a(bq.a, "looking_at").forGetter(cr::g)
            )
            .apply($$0, cr::new)
   );
   ...
   public boolean a(biq $$0, akq $$1, @Nullable ehn $$2) {
      if (!($$0 instanceof akr $$3)) {
         ...
         while (var13.hasNext()) {
            Entry<aew> $$8 = (Entry<aew>)var13.next();
            if ($$7.b((aew)$$8.getKey()) != $$8.getBooleanValue()) {
               return false;
            }
         }
         ...
         if (!this.h.isEmpty()) {
            ...
            for (java.util.Map.Entry<aew, cr.c> $$11 : this.h.entrySet()) {
   ...
   public Object2BooleanMap<aew> e() {
      return this.g;
   }

   public Map<aew, cr.c> f() {
      return this.h;
   }
   ...
   static record a(Object2BooleanMap<String> c) implements cr.c {
      public static final Codec<cr.a> a = arf.d(Codec.STRING).xmap(cr.a::new, cr.a::a);
   ...
   public static class d {
      ...
      private final Object2BooleanMap<aew> d = new Object2BooleanOpenHashMap();
      private final Map<aew, cr.c> e = Maps.newHashMap();
      ...
      public <T> cr.d a(apm<T> $$0, he.c<T> $$1, cl.d $$2) {
         this.c.add(new cr.e<>($$0, $$1, $$2));
         return this;
      }

      public cr.d a(aew $$0, boolean $$1) {
         this.d.put($$0, $$1);
         return this;
      }
      ...
      public cr.d b(aew $$0, boolean $$1) {
         this.e.put($$0, new cr.b($$1));
         return this;
      }

      public cr.d a(aew $$0, Map<String, Boolean> $$1) {
   ...
   static record e<T>(apm<T> b, he<T> c, cl.d d, Supplier<apk<T>> e) {
      public static final Codec<cr.e<?>> a = jb.y.q().dispatch(cr.e::a, cr.e::a);

      public e(apm<T> $$0, he<T> $$1, cl.d $$2) {
         this($$0, $$1, $$2, Suppliers.memoize(() -> $$0.b($$1.a())));
      }

      private static <T> Codec<cr.e<T>> a(apm<T> $$0) {
         return RecordCodecBuilder.create(
            $$1 -> $$1.group($$0.a().r().fieldOf("stat").forGetter(cr.e::b), arf.a(cl.d.d, "value", cl.d.c).forGetter(cr.e::c))
                  .apply($$1, ($$1x, $$2) -> new cr.e<>($$0, $$1x, $$2))
         );
      }

      public boolean a(apo $$0) {
