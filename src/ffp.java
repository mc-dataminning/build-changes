...
public class ffp {
   ...
   public static void a(File $$0, eyk $$1, Consumer<xp> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eyk $$2, Consumer<xp> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eyk $$2, Consumer<xp> $$3) {
      eyz $$4 = a($$2);
   ...
   public static eyz a(eyk $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eyz $$3 = new eyz($$1, $$2, false);
   ...
   public ffp(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
