...
public class fje extends fiw<cmp> implements fkz {
   private float x;
   private float y;
   private final fkt z = new fkt();
   private boolean A;
   private boolean B;
   ...
   public void E() {
      if (this.f.q.f()) {
         this.f.a(new fit(this.f.s, this.f.s.cu.y(), this.f.m.G().c()));
      } else {
         this.z.g();
      }
   }
   ...
   protected void aO_() {
      if (this.f.q.f()) {
         ...
         this.c(new fbs(this.t + 104, this.h / 2 - 22, 20, 18, fkt.a, $$0 -> {
            this.z.e();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(fat $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bpo $$9) {
   ...
   public static void a(fat $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bpo $$7) {
      $$0.c().a();
