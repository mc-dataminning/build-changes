...
public class fje {
   ...
   private final Queue<fje.a> c = EvictingQueue.create(10);
   @Nullable
   private volatile fje.a d;
   ...
   @Nullable
   public static fje a(int $$0, boolean $$1, Set<String> $$2) {
      if ($$0 <= 0) {
         return null;
      } else {
         GLCapabilities $$3 = GL.getCapabilities();
         if ($$3.GL_KHR_debug && fjg.b) {
            fje $$4 = new fje();
            $$2.add("GL_KHR_debug");
            GL11.glEnable(37600);
            if ($$1) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create($$4::a), fjw::a), 0L);
            return $$4;
         } else if ($$3.GL_ARB_debug_output && fjg.d) {
            fje $$7 = new fje();
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create($$7::a), fjw::a), 0L);
            return $$7;
         } else {
            return null;
         }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fje.a(this.b) + ", type=" + fje.b(this.c) + ", severity=" + fje.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
