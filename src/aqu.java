...
public abstract class aqu {
   ...
   private final ara n = new ara(b);
   private final aqr o = new aqr(c);
   private final aqv p = new aqv(d);
   private final arc q = new arc(e);
   private final Map<UUID, arx> r = Maps.newHashMap();
   ...
   public aqu(MinecraftServer $$0, io<ahp> $$1, ego $$2, int $$3) {
      this.k = $$0;
      this.v = $$1;
      this.h = $$3;
      this.t = $$2;
   ...
   public void a(ug $$0, ane $$1, ans $$2) {
      ...
      sn $$8 = this.a($$1);
      ahf<cto> $$9 = $$8 != null ? dmp.a(new Dynamic(tb.a, $$8.c("Dimension"))).resultOrPartial(a::error).orElse(cto.h) : cto.h;
      and $$10 = this.k.a($$9);
      and $$11;
      if ($$10 == null) {
      ...
      ctk $$16 = $$11.Z();
      boolean $$17 = $$16.b(ctk.D);
      boolean $$18 = $$16.b(ctk.q);
      boolean $$19 = $$16.b(ctk.w);
      ...
      if ($$8 != null && $$8.b("RootVehicle", 10)) {
         ...
         blu $$25 = bly.a($$24.p("Entity"), $$11, $$1x -> !$$11.c($$1x) ? null : $$1x);
         if ($$25 != null) {
            UUID $$26;
            if ($$24.b("Attach")) {
               $$26 = $$24.a("Attach");
   ...
   protected void a(ahx $$0, ane $$1) {
      Set<emo> $$2 = Sets.newHashSet();

      for (emr $$3 : $$0.g()) {
         $$1.c.b(ack.a($$3, true));
      }

      for (emn $$4 : emn.values()) {
         emo $$5 = $$0.a($$4);
   ...
   public ane a(ane $$0, boolean $$1) {
      ...
      if ($$6.isPresent()) {
         djg $$12 = $$8.a_($$2);
         boolean $$13 = $$12.a(cwr.pl);
         els $$14 = $$6.get();
         float $$17;
         if (!$$12.a(asg.R) && !$$13) {
            $$17 = $$3;
         } else {
            els $$15 = els.c($$2).d($$14).d();
            $$17 = (float)aun.d(aun.d($$15.e, $$15.c) * 180.0F / (float)Math.PI - 90.0);
         }
      ...
      $$9.c($$9.ev());
      if ($$11) {
         $$9.c.b(new acs(arr.uB, ars.e, (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), 1.0F, 1.0F, $$8.F_().g()));
      }
   ...
   public void a(GameProfile $$0) {
      this.p.a(new aqw($$0, this.k.i(), this.p.a($$0)));
   ...
   public void a(@Nullable cfh $$0, double $$1, double $$2, double $$3, double $$4, ahf<cto> $$5, xf<?> $$6) {
   ...
   public void a(ane $$0, and $$1) {
      dkx $$2 = this.k.F().D_();
      $$0.c.b(new aai($$2));
      $$0.c.b(new aco($$1.X(), $$1.Y(), $$1.Z().b(ctk.l)));
   ...
   public aho f(ane $$0) {
      ...
      aho $$2 = this.s.get($$1);
      if ($$2 == null) {
         Path $$3 = this.k.a(egj.a).resolve($$1 + ".json");
