...
public class aqu extends ari {
   public static final aqx<edl> a = aqx.a("Unloaded level chunk");
   private static final CompletableFuture<aqx<edl>> e = CompletableFuture.completedFuture(a);
   private final djz f;
   private volatile CompletableFuture<aqx<edl>> g = e;
   private volatile CompletableFuture<aqx<edl>> h = e;
   private volatile CompletableFuture<aqx<edl>> i = e;
   private int j;
   private int k;
   private int l;
   private boolean m;
   ...
   public aqu(djc $$0, int $$1, djz $$2, exd $$3, aqu.a $$4, aqu.b $$5) {
      super($$0);
      this.f = $$2;
      this.q = $$3;
      this.r = $$4;
   ...
   public CompletableFuture<aqx<edl>> a() {
      return this.h;
   }

   public CompletableFuture<aqx<edl>> b() {
      return this.i;
   }

   public CompletableFuture<aqx<edl>> c() {
      return this.g;
   }
   ...
   public boolean a(dkg $$0, int $$1) {
      ...
      if ($$2 == null) {
         ...
         if ($$3 == null) {
            ...
            int $$5 = this.q.e();
            if ($$1 >= $$4 && $$1 <= $$5) {
               BitSet $$6 = $$0 == dkg.a ? this.p : this.o;
               int $$7 = $$1 - $$4;
               if (!$$6.get($$7)) {
                  $$6.set($$7);
                  return true;
   ...
   public void a(edl $$0) {
      if (this.i()) {
         ...
         if (!this.p.isEmpty() || !this.o.isEmpty()) {
            List<art> $$2 = this.s.a(this.d, true);
            if (!$$2.isEmpty()) {
               adl $$3 = new adl($$0.f(), this.q, this.p, this.o);
               this.a($$2, $$3);
            }
         ...
         if (this.m) {
            List<art> $$4 = this.s.a(this.d, false);
            ...
            for (int $$5 = 0; $$5 < this.n.length; $$5++) {
               ...
               if ($$6 != null) {
                  ...
                  if (!$$4.isEmpty()) {
                     ...
                     jy $$8 = jy.a($$0.f(), $$7);
                     if ($$6.size() == 1) {
                        iv $$9 = $$8.g($$6.iterator().nextShort());
                        ebe $$10 = $$1.a_($$9);
                        this.a($$4, new ace($$9, $$10));
                        this.a($$4, $$1, $$9, $$10);
                     } else {
                        edm $$11 = $$0.b($$5);
   ...
   private void a(List<art> $$0, djx $$1, iv $$2, ebe $$3) {
      if ($$3.x()) {
         this.a($$0, $$1, $$2);
      }
   }

   private void a(List<art> $$0, djx $$1, iv $$2) {
      dyc $$3 = $$1.c_($$2);
      if ($$3 != null) {
         zh<?> $$4 = $$3.ay_();
         if ($$4 != null) {
   ...
   private void a(List<art> $$0, zh<?> $$1) {
   ...
   private void a(aqw $$0, CompletableFuture<aqx<edl>> $$1, Executor $$2, arg $$3) {
      this.u.cancel(false);
   ...
   @FunctionalInterface
   public interface a {
      void onLevelChange(djc var1, IntSupplier var2, int var3, IntConsumer var4);
   }

   public interface b {
      List<art> a(djc var1, boolean var2);
   }
}
