...
public class aqu implements dbu {
   ...
   private final aym h;
   private final duv i;
   private final ewi<dea> j = new ewi<>($$0x -> this.y($$0x).o());
   private final ewi<emv> k = new ewi<>($$0x -> this.y($$0x).p());
   private final dca l;
   private final dag m;
   private final dag n;
   private final dty o;
   ...
   private static final akn s = new akn("worldgen_region_random");

   public aqu(aqn $$0, List<dsz> $$1, dty $$2, int $$3) {
      this.o = $$2;
      this.p = $$3;
      int $$4 = ayf.a(Math.sqrt((double)$$1.size()));
      if ($$4 * $$4 != $$1.size()) {
         ...
         this.i = $$0.D_();
         this.l = new dca(this, dca.a(this.f));
         this.m = $$1.get(0).f();
   ...
   @Override
   public dsz a(int $$0, int $$1) {
      return this.a($$0, $$1, dty.c);
   }
   ...
   @Nullable
   @Override
   public cly a(double $$0, double $$1, double $$2, double $$3, Predicate<brw> $$4) {
      return null;
   }
   ...
   public boolean a(io $$0, boolean $$1, @Nullable brw $$2, int $$3) {
      ...
      if ($$4.i()) {
         ...
         if ($$1) {
            doi $$5 = $$4.t() ? this.c_($$0) : null;
            dea.a($$4, (daz)this.e, $$0, $$5, $$2, ctq.i);
         }

         return this.a($$0, dec.a.n(), 3, $$3);
      }
   }
   ...
   public bpu d_(io $$0) {
      if (!this.b(jq.a($$0.u()), jq.a($$0.w()))) {
         ...
         return new bpu(this.e.ak(), this.e.Z(), 0L, this.e.ap());
      }
   }
   ...
   @Override
   public List<brw> a(@Nullable brw $$0, euh $$1, @Nullable Predicate<? super brw> $$2) {
      return Collections.emptyList();
   }
