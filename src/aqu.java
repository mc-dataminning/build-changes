...
public class aqu implements aqq.a, AutoCloseable {
   ...
   private final aqv d;
   private final bst<Runnable> e;
   private final bsq f;
   protected boolean b;

   public aqu(bst<Runnable> $$0, Executor $$1) {
      this.d = new aqv($$0.v_() + "_queue");
      this.e = $$0;
      this.f = new bsq(4, $$1, "dispatcher");
      this.b = true;
   }
   ...
   @Override
   public void onLevelChange(dhw $$0, IntSupplier $$1, int $$2, IntConsumer $$3) {
      this.f.a_(new bss.c(0, () -> {
         int $$4 = $$1.getAsInt();
         this.d.a($$4, $$0, $$2);
         $$3.accept($$2);
      }));
