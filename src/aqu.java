...
public class aqu implements AutoCloseable {
   ...
   private aqu(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static aqu.a a(Path $$0) {
         return new aqu.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
