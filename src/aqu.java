...
public class aqu {
   ...
   aqu(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static aqu.a a() {
      return new aqu.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(aqu::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public aqu.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public aqu a(Writer $$0) throws IOException {
         return new aqu($$0, this.a);
      }
   }
}
