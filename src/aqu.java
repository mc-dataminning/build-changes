...
public class aqu {
   ...
   private static List<aqu.b> a(final Path $$0) throws IOException {
      try {
         final List<aqu.b> $$1 = new ArrayList<>();
   ...
   private static List<aqu.a> a(List<aqu.b> $$0) {
      List<aqu.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (aqu.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new aqu.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<aqu.a> a = Comparator.comparing(aqu.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<aqu.b> a = Comparator.comparing(aqu.b::b).reversed();
