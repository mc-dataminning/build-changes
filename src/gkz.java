...
public class gkz {
   ...
   public static class a extends Thread {
      private final gkz.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gkz.b $$0) throws IOException {
         super("LanServerDetector #" + gkz.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gkz.b));
   ...
   public static class b {
      private final List<gky> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gky> a() {
         if (this.b) {
            List<gky> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
