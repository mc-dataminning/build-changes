...
public interface gkz {
   static gkz a(glf $$0, UserApiService $$1) {
      return new gkz.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, glh var2, AbuseReport var3);
   ...
   public static record b(glf a, UserApiService b) implements gkz {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, glh $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               wy $$5 = this.a(var7);
               throw new CompletionException(new gkz.a($$5, var7));
            } catch (MinecraftClientException var8) {
               wy $$7 = this.a(var8);
               throw new CompletionException(new gkz.a($$7, var8));
            }
         }, af.i());
      }
