...
public class gem {
   ...
   public final Map<je, gen> c;
   public final geo d;
   public final boolean e;

   public gem(Vector3f $$0, Vector3f $$1, Map<je, gen> $$2, @Nullable geo $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<je, gen> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gem> {
      ...
      public gem a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         geo $$6 = this.a($$3);
         Map<je, gen> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayp.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayp.a($$3, "shade", true);
            return new gem($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private geo a(JsonObject $$0) {
         geo $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<je, gen> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gen> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<je, gen> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gen> $$2 = Maps.newEnumMap(je.class);
         JsonObject $$3 = ayp.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            je $$5 = this.a($$4.getKey());
            $$2.put($$5, (gen)$$0.deserialize($$4.getValue(), gen.class));
         }
