...
public class grb extends gqy {
   ...
   public final gme j;
   private final axc cE;
   private final fqq cF;
   private final bas cG = new bas(20, 1280);
   private final List<hoj> cH = Lists.newArrayList();
   private int cI = 0;
   private double cJ;
   private double cK;
   private double cL;
   ...
   private int cT;
   private boolean cU;
   public gqz k = new gqz();
   private crx cV = crx.b;
   protected final frf cq;
   protected int cr;
   public float cs;
   public float ct;
   public float cu;
   ...
   public grb(frf $$0, gmd $$1, gme $$2, axc $$3, fqq $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.o());
      this.cq = $$0;
      this.j = $$2;
      this.cE = $$3;
      ...
      this.cR = $$5;
      this.cS = $$6;
      this.cH.add(new hpb(this, $$0.ak()));
      this.cH.add(new hoo(this));
      this.cH.add(new hon(this, $$0.ak(), $$1.H_()));
   }
   ...
   public boolean a(bwv $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cum) {
            this.cq.ak().a((hoz)(new hot(this, (cum)$$0, true)));
            this.cq.ak().a((hoz)(new hot(this, (cum)$$0, false)));
         }
   ...
   public void h() {
      ...
      if (this.gJ()) {
         ...
         if (!this.cV.equals(this.k.a)) {
            this.j.b(new aib(this.k.a));
            this.cV = this.k.a;
         }

         if (this.bY()) {
            this.j.b(new ahs.c(this.dL(), this.dN(), this.aH(), this.P));
            bwv $$0 = this.df();
            if ($$0 != this && $$0.dg()) {
               this.j.b(aht.a($$0));
               this.I();
   ...
   private void F() {
      ...
      if (this.y()) {
         ...
         this.cT++;
         boolean $$5 = azq.f($$0, $$1, $$2) > azq.k(2.0E-4) || this.cT >= 20;
         boolean $$6 = $$3 != 0.0 || $$4 != 0.0;
         if ($$5 && $$6) {
            this.j.b(new ahs.b(this.dt(), this.dL(), this.dN(), this.aH(), this.P));
         } else if ($$5) {
            this.j.b(new ahs.a(this.dt(), this.aH(), this.P));
         } else if ($$6) {
            this.j.b(new ahs.c(this.dL(), this.dN(), this.aH(), this.P));
         } else if (this.cO != this.aH() || this.cP != this.P) {
            this.j.b(new ahs.d(this.aH(), this.P));
         }
   ...
   @Override
   public void gg() {
      this.j.b(new ahe(ahe.a.a));
      frd.c();
   }

   @Override
   public void p() {
      this.j.b(new ahk(this.bR.l));
      this.e();
   }
   ...
   protected void f() {
      this.j.b(new aia(this, aia.a.f, azq.d(this.v() * 100.0F)));
   }

   public void i() {
      this.j.b(new aia(this, aia.a.h));
   }
   ...
   private boolean c(iw $$0) {
      ffn $$1 = this.cR();
      ffn $$2 = new ffn((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   @Override
   public bus fA() {
      return Objects.requireNonNullElse(this.cZ, bus.a);
   }
   ...
   public void a(akn<?> $$0) {
      ...
      if (aC.equals($$0)) {
         ...
         bus $$2 = (this.al.a(aC) & 2) > 0 ? bus.b : bus.a;
         if ($$1 && !this.cY) {
            this.c($$2);
         } else if (!$$1 && this.cY) {
            this.fF();
      ...
      if (am.equals($$0) && this.fJ() && !this.dd) {
         this.cq.ak().a((hoz)(new hop(this)));
      }
   }

   @Nullable
   public byg u() {
      if (this.dl() instanceof byg $$0 && $$0.a()) {
         return $$0;
      }
   ...
   public void a(dzs $$0, boolean $$1) {
      if ($$0 instanceof dzf $$2) {
         this.cq.a(new gbs($$2, $$1, this.cq.aT()));
      } else {
         this.cq.a(new gcf($$0, $$1, this.cq.aT()));
      }
   }
   ...
   private static float c(ffr $$0) {
      float $$1 = Math.abs($$0.j);
      float $$2 = Math.abs($$0.k);
      float $$3 = $$2 > $$1 ? $$1 / $$2 : $$2 / $$1;
      return azq.c(1.0F + azq.l($$3));
   }
   ...
   public void k_() {
      ...
      if (!(this.cq.z instanceof gad)) {
         this.y(this.A() == dtd.a.a);
         this.M();
      }
      ...
      boolean $$2 = this.k.c();
      crv $$3 = this.gk();
      this.cQ = !$$3.b && !this.cj() && !this.bY() && this.h(byi.f) && (this.cc() || !this.fR() && !this.h(byi.a));
      this.k.a();
      this.cq.aB().a(this.k);
      boolean $$4 = false;
      if (this.dc > 0) {
      ...
      if (this.a(axl.a)) {
         int $$6 = this.Z_() ? 10 : 1;
         this.de = azq.a(this.de + $$6, 0, 600);
      } else if (this.de > 0) {
         this.a(axl.a);
         this.de = azq.a(this.de - 10, 0, 600);
      }
   ...
   public dtd.a A() {
      return this.as == null ? dtd.a.b : this.as.a();
   }
   ...
   private void y(boolean $$0) {
      ...
      if ($$0 && this.as != null && this.as.e()) {
         if (this.cq.z != null && !this.cq.z.k() && !(this.cq.z instanceof fzj) && !(this.cq.z instanceof gai)) {
            if (this.cq.z instanceof gau) {
               this.p();
            }
         ...
         if (this.cw == 0.0F) {
            this.cq.ak().a(hou.b(awr.vx, this.ae.i() * 0.4F + 0.8F, 0.25F));
         }
      ...
      this.cw = azq.a(this.cw + $$1, 0.0F, 1.0F);
   }
   ...
   protected void f(float $$0, float $$1) {
      if (this.O()) {
         ffs $$2 = this.dt();
         ffs $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         ffs $$4 = new ffs((double)$$0, 0.0, (double)$$1);
         float $$5 = this.fo();
         float $$6 = (float)$$4.h();
         if ($$6 <= 0.001F) {
            ffr $$7 = this.k.b();
            ...
            $$4 = new ffs((double)($$8 * $$11 - $$9 * $$10), $$4.e, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.h();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         float $$12 = azq.j($$6);
         ffs $$13 = $$4.c((double)$$12);
         ffs $$14 = this.bU();
         float $$15 = (float)($$14.d * $$13.d + $$14.f * $$13.f);
         if (!($$15 < -0.15F)) {
            ffx $$16 = ffx.a(this);
            iw $$17 = iw.a(this.dA(), this.cR().e, this.dG());
            ebg $$18 = this.dV().a_($$17);
            if ($$18.b(this.dV(), $$17, $$16).c()) {
               $$17 = $$17.d();
               ebg $$19 = this.dV().a_($$17);
               if ($$19.b(this.dV(), $$17, $$16).c()) {
                  float $$20 = 7.0F;
                  float $$21 = 1.2F;
                  if (this.b(bwb.h)) {
                     $$21 += (float)(this.c(bwb.h).e() + 1) * 0.75F;
                  }

                  float $$22 = Math.max($$5 * 7.0F, 1.0F / $$12);
                  ffs $$24 = $$3.e($$13.c((double)$$22));
                  float $$25 = this.dq();
                  float $$26 = this.dr();
                  ffn $$27 = new ffn($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  ffs $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  ffs $$28 = $$13.c(new ffs(0.0, 1.0, 0.0));
                  ffs $$29 = $$28.c((double)($$25 * 0.5F));
                  ffs $$30 = $$23.d($$29);
                  ffs $$31 = $$24.d($$29);
                  ffs $$32 = $$23.e($$29);
                  ffs $$33 = $$24.e($$29);
                  Iterable<fgm> $$34 = this.dV().d(this, $$27);
                  Iterator<ffn> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean d(ffs $$0) {
      ...
      double $$2 = (double)azq.a($$1);
      double $$3 = (double)azq.b($$1);
      double $$4 = (double)this.bg * $$3 - (double)this.bi * $$2;
      double $$5 = (double)this.bi * $$3 + (double)this.bg * $$2;
      double $$6 = azq.k($$4) + azq.k($$5);
      double $$7 = azq.k($$0.d) + azq.k($$0.f);
   ...
   public float D() {
      if (!this.a(axl.a)) {
         ...
         if ((float)this.de >= 600.0F) {
            ...
            float $$2 = azq.a((float)this.de / 100.0F, 0.0F, 1.0F);
            float $$3 = (float)this.de < 100.0F ? 0.0F : azq.a(((float)this.de - 100.0F) / 500.0F, 0.0F, 1.0F);
   ...
   protected boolean gb() {
      ...
      if (this.Z_()) {
         ...
         if (!$$0 && $$1) {
            this.dV().a(this.dA(), this.dC(), this.dG(), awr.x, aws.i, 1.0F, 1.0F, false);
            this.cq.ak().a((hoz)(new hpc.b(this)));
         }

         if ($$0 && !$$1) {
            this.dV().a(this.dA(), this.dC(), this.dG(), awr.y, aws.i, 1.0F, 1.0F, false);
         }
   ...
   public ffs v(float $$0) {
      if (this.cq.n.aE().a()) {
         float $$1 = azq.h($$0 * 0.5F, this.dL(), this.N) * (float) (Math.PI / 180.0);
         float $$2 = azq.h($$0 * 0.5F, this.dN(), this.O) * (float) (Math.PI / 180.0);
         double $$3 = this.fy() == bxn.b ? -1.0 : 1.0;
         ffs $$4 = new ffs(0.39 * $$3, -0.6, 0.3);
