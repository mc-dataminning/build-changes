...
public class he implements ArgumentType<he.a> {
   ...
   public he.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         return new he.a() {
            ...
            @Override
            public Pair<all, Either<ik<ew>, Collection<ik<ew>>>> b(CommandContext<ew> $$0) throws CommandSyntaxException {
               return Pair.of($$1, Either.right(he.b($$0, $$1)));
            }

            @Override
            public Pair<all, Collection<ik<ew>>> c(CommandContext<ew> $$0) throws CommandSyntaxException {
   ...
   static ik<ew> a(CommandContext<ew> $$0, all $$1) throws CommandSyntaxException {
      return ((ew)$$0.getSource()).l().aE().a($$1).orElseThrow(() -> c.create($$1.toString()));
   }

   static Collection<ik<ew>> b(CommandContext<ew> $$0, all $$1) throws CommandSyntaxException {
   ...
   public static Pair<all, Either<ik<ew>, Collection<ik<ew>>>> b(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
      return ((he.a)$$0.getArgument($$1, he.a.class)).b($$0);
   }

   public static Pair<all, Collection<ik<ew>>> c(CommandContext<ew> $$0, String $$1) throws CommandSyntaxException {
   ...
   public interface a {
      ...
      Pair<all, Either<ik<ew>, Collection<ik<ew>>>> b(CommandContext<ew> var1) throws CommandSyntaxException;

      Pair<all, Collection<ik<ew>>> c(CommandContext<ew> var1) throws CommandSyntaxException;
   }
}
