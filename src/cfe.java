...
public abstract class cfe extends bsn {
   protected static final int ca = 6000;
   private int bY;
   @Nullable
   private UUID bZ;

   protected cfe(bsz<? extends cfe> $$0, dbx $$1) {
      super($$0, $$1);
      this.a(eol.n, 16.0F);
      this.a(eol.o, -1.0F);
   }
   ...
   public float a(iz $$0, dca $$1) {
      return $$1.a_($$0.d()).a(dfa.i) ? 10.0F : $$1.w($$0);
   }
   ...
   public static boolean b(bsz<? extends cfe> $$0, dby $$1, bts $$2, iz $$3, azg $$4) {
      boolean $$5 = bts.b($$2) || a($$1, $$3);
      return $$1.a_($$3.d()).a(awo.bW) && $$5;
   }

   protected static boolean a(dba $$0, iz $$1) {
      return $$0.b($$1, 0) > 8;
   }
   ...
   public void a(are $$0, cfe $$1, @Nullable bsn $$2) {
      ...
      $$0.a(this, (byte)18);
      if ($$0.ab().b(dbt.f)) {
         $$0.b(new bte($$0, this.du(), this.dw(), this.dA(), this.el().a(7) + 1));
      }
   }
