...
public class cvv extends cum {
   ...
   public cvv(xp $$0, xp $$1, xp $$2, xp $$3, xp $$4, List<alf> $$5, List<alf> $$6, cpl... $$7) {
      super(new cum.a().a($$7));
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static cvv a(ale<cwy> $$0, cpl... $$1) {
      return a($$0.a(), $$1);
   }

   public static cvv a(alf $$0, cpl... $$1) {
      return new cvv(l, m, xp.c(ac.a("trim_pattern", $$0)).a(a), n, o, x(), y(), $$1);
   }
