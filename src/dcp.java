...
public interface dcp {
   ...
   ym<vz, dcp> b = yk.a(mc.aG).b(dcp::a, dcp.i::b);
   ...
   public static class a implements dcp {
      ...
      public static final ym<vz, dcp.a> e = ym.a(c);
   ...
   public static record b(List<dcp> f) implements dcp {
      ...
      public static final ym<vz, dcp.b> d = ym.a(dcp.b.a(yk.a()), dcp.b::b, dcp.b::new);
   ...
   public static class c implements dcp {
      ...
      public static final ym<vz, dcp.c> e = ym.a(c);
   ...
   public static record d(jr<cwl> f) implements dcp {
      ...
      public static final ym<vz, dcp.d> d = ym.a(yk.b(mc.K), dcp.d::b, dcp.d::new);
   ...
   public static record f(cwp f) implements dcp {
      ...
      public static final ym<vz, dcp.f> d = ym.a(cwp.h, dcp.f::b, dcp.f::new);
   ...
   public static record g(dcp f, dcp g, dcp h) implements dcp {
      ...
      public static final ym<vz, dcp.g> d = ym.a(dcp.b, dcp.g::b, dcp.b, dcp.g::c, dcp.b, dcp.g::d, dcp.g::new);
   ...
   public static record h(axf<cwl> f) implements dcp {
      ...
      public static final ym<vz, dcp.h> d = ym.a(axf.c(mc.K), dcp.h::b, dcp.h::new);
   ...
   public static record i<T extends dcp>(MapCodec<T> a, ym<vz, T> b) {
   }
   ...
   public static record j(dcp f, dcp g) implements dcp {
      ...
      public static final ym<vz, dcp.j> d = ym.a(dcp.b, dcp.j::b, dcp.b, dcp.j::c, dcp.j::new);
