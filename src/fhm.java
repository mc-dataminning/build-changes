...
public abstract class fhm extends fhq implements fiv, fjo {
   private static final fjf a = new fjf(new akk("widget/text_field"), new akk("widget/text_field_highlighted"));
   ...
   protected abstract void c(fhf var1, int var2, int var3, float var4);
}
