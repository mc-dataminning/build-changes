...
public class fhm extends fhx {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = flh.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fjt.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !flh.Q().b($$4)) {
               try {
