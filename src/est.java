...
public class est extends gko {
   ...
   public est(fda $$0, erx $$1, String $$2, BooleanConsumer $$3) {
      super(euz.a);
      this.T = $$3;
      this.y = $$0;
      this.D = $$2;
   ...
   private void D() {
      if (!this.K) {
         if (!this.S && this.a(this.z.a) >= 5368709120L) {
            vf $$0 = vf.a("mco.download.confirmation.line1", eqm.b(5368709120L));
   ...
   private vf E() {
      ...
      if (this.H != null) {
         ...
         $$0.add(vf.a("mco.download.speed.narration", eqm.b(this.O)));
      }
   ...
   private void a(ewt $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, vf.a("mco.download.speed", eqm.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, 16777215, false);
      }
   }
