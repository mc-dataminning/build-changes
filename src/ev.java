...
public class ev implements fl<ev.a> {
   ...
   private static CompletableFuture<arf> a(ee $$0, xn $$1) {
      aqo $$2 = $$0.i();
      return $$2 != null && $$1.a($$2.cz()) ? $$2.X().a($$1.c()) : CompletableFuture.completedFuture(arf.a($$1.c()));
   }
