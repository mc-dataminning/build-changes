...
public class ev implements ArgumentType<ev.b> {
   ...
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(tn.c("argument.scoreHolder.empty"));
   final boolean d;
