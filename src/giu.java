...
public enum giu implements gjb {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, giu> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (giu)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static giu a(int $$0, int $$1) {
