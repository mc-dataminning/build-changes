...
public abstract class giu<T extends bsq, M extends fsw<T>> extends ghs<T> implements gjp<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gmf<T, M>> g = Lists.newArrayList();

   public giu(ght.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gmf<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, eyu $$3, gck $$4, int $$5) {
      ...
      this.f.d = $$0.bR();
      this.f.e = $$0.p_();
      float $$6 = ayf.j($$2, $$0.aZ, $$0.aY);
      float $$7 = ayf.j($$2, $$0.bb, $$0.ba);
      float $$8 = $$7 - $$6;
      if ($$0.bR() && $$0.dc() instanceof bsq $$9) {
         $$6 = ayf.j($$2, $$9.aZ, $$9.aY);
         $$8 = $$7 - $$6;
         float $$10 = ayf.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected gcs a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      akn $$4 = this.a($$0);
      if ($$2) {
         return gcs.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? gcs.r($$4) : null;
      }
   }

   public static int c(bsq $$0, float $$1) {
      return gnm.a(gnm.a($$1), gnm.a($$0.aO > 0 || $$0.aQ > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return feb.M() && $$0 != $$3.an() && $$5 && !$$0.bS();
      }
   }

   public static boolean e(bsq $$0) {
