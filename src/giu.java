...
public abstract class giu<T extends bso, M extends fsw<T>> extends ghs<T> implements gjp<T, M> {
   ...
   public void a(T $$0, float $$1, float $$2, eys $$3, gck $$4, int $$5) {
      ...
      this.f.d = $$0.bR();
      this.f.e = $$0.p_();
      float $$6 = ayd.j($$2, $$0.ba, $$0.aZ);
      float $$7 = ayd.j($$2, $$0.bc, $$0.bb);
      float $$8 = $$7 - $$6;
      if ($$0.bR() && $$0.dc() instanceof bso $$9) {
         $$6 = ayd.j($$2, $$9.ba, $$9.aZ);
         $$8 = $$7 - $$6;
         float $$10 = ayd.g($$8);
         if ($$10 < -85.0F) {
   ...
   public static int c(bso $$0, float $$1) {
      return gnm.a(gnm.a($$1), gnm.a($$0.aP > 0 || $$0.aR > 0));
   }
