...
public enum epe {
   ...
   public List<aqb<InputStream>> a(aox $$0) throws IOException {
      return List.of(
   ...
   public aqb<InputStream> b(aox $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aqb<InputStream> a(aox $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      aqb<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
