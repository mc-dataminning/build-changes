...
public class epe {
   ...
   public static List<epe.a> a(String $$0, epe.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<epe.a> a(String $$0, List<epe.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<epe.a> a(List<String> $$0, List<epe.b> $$1) {
      int $$2 = 0;
      List<epe.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<epe.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static epe.b a(String $$0, String $$1) {
         return new epe.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static epe.b a(String $$0) {
         return new epe.b($$0);
      }
   }
}
