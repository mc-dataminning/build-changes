...
public class epe {
   ...
   private final epe.a g;

   @Deprecated
   public static epe a(azk $$0, epe.a $$1) {
      return new epe($$0, $$1, false);
   }

   public static epe a(azk $$0, int $$1, double... $$2) {
      return b($$0, new epe.a($$1, new DoubleArrayList($$2)));
   }

   public static epe b(azk $$0, epe.a $$1) {
      return new epe($$0, $$1, true);
   }

   private epe(azk $$0, epe.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<epe.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(epe.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(epe.a::b))
               .apply($$0, epe.a::new)
      );
      public static final Codec<jn<epe.a>> b = akx.a(lv.aP, a);
