...
public class epr extends epx {
   public static final MapCodec<epr> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, epr::new));

   public epr(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<eob.a> a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, int $$3, iv $$4, enl $$5) {
      ...
      $$6.add(new eob.a(new iv($$14, $$16, $$15), 0, true));
      ...
      for (int $$20 = -1; $$20 <= 2; $$20++) {
         for (int $$21 = -1; $$21 <= 2; $$21++) {
            if (($$20 < 0 || $$20 > 1 || $$21 < 0 || $$21 > 1) && $$2.a(3) <= 0) {
               ...
               $$6.add(new eob.a(new iv($$11 + $$20, $$16, $$13 + $$21), 0, false));
            }
         }
      }
