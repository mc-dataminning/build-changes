...
public class ati extends atc {
   static final Logger c = LogUtils.getLogger();
   private final ati.b d;
   private final String e;

   ati(atk $$0, ati.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atn $$0, alh $$1) {
   ...
   public static class a implements auh.c {
      ...
      @Override
      public atl a(atk $$0) {
         ati.b $$1 = new ati.b(this.a);
         return new ati($$0, $$1, "");
      }

      @Override
      public atl a(atk $$0, auh.a $$1) {
         ati.b $$2 = new ati.b(this.a);
         atl $$3 = new ati($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<atl> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  ati.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
