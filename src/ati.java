...
class ati implements Path {
   private static final BasicFileAttributes a = new atg() {
      @Override
   ...
   private static final BasicFileAttributes b = new atg() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ati> c = Comparator.comparing(ati::n);
   ...
   public ati(atk $$0, String $$1, @Nullable ati $$2, atl $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ati a(@Nullable ati $$0, String $$1) {
      return new ati(this.e, $$1, $$0, atl.b);
   }
   ...
   ati a(String $$0) {
      if (a(this.i)) {
         return new ati(this.e, $$0, this, this.i);
      } else if (this.i instanceof atl.a $$1) {
         ati $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ati(this.e, $$0, this, atl.a);
      } else if (this.i instanceof atl.b) {
         return new ati(this.e, $$0, this, atl.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atl $$0) {
      return $$0 == atl.a || $$0 == atl.b;
   }
   ...
   private ati c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ati $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atl.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atl.a i() {
      return this.i instanceof atl.a $$0 ? $$0 : null;
   }
