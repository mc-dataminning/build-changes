...
public class ati extends ath {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, ati.a> s;
   private final atd t;
   private long u;
   private final ajs v;

   private ati(ajs $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == ate.c($$2, 7, $$0.getLength());
      }
   }
