...
public class ggo {
   public static final ggo a = new ggo(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));
   public final Vector3f b;
   public final Vector3f c;
   public final Vector3f d;

   public ggo(Vector3f $$0, Vector3f $$1, Vector3f $$2) {
   ...
   protected static class a implements JsonDeserializer<ggo> {
      ...
      public ggo a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         $$5.mul(0.0625F);
         $$5.set(aym.a($$5.x, -5.0F, 5.0F), aym.a($$5.y, -5.0F, 5.0F), aym.a($$5.z, -5.0F, 5.0F));
         Vector3f $$6 = this.a($$3, "scale", e);
         $$6.set(aym.a($$6.x, -4.0F, 4.0F), aym.a($$6.y, -4.0F, 4.0F), aym.a($$6.z, -4.0F, 4.0F));
         return new ggo($$4, $$5, $$6);
      }
