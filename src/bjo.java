...
public class bjo extends DataFix {
   ...
   public bjo(Schema $$0, String $$1, TypeReference $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(this.a, $$0, $$2x -> $$2x.updateTyped($$1, $$1xx -> $$1xx.update($$2, $$0xxx -> $$0xxx.mapSecond(bbi::a))));
   }
}
