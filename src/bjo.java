...
public class bjo extends bih {
   public bjo(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bjm.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = blh.a($$0.get("id").asString("minecraft:air"));
