...
public abstract class bjo extends bks {
   private static final afc<Boolean> bT = aff.a(bjo.class, afe.k);
   ...
   protected bjo(bjx<? extends bjo> $$0, cqz $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bjo a(alq var1, bjo var2);
   ...
   protected void m() {
      if (!this.n_() && this.bN() && this.cY() instanceof ceq $$0 && !$$0.a((bjt)this)) {
         this.aa();
      }
   }
