...
public class bhe extends ebr {
   ...
   private bhd b(aew $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new bhd($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<aew, bhd> $$0) {
      this.f.forEach($$0);
   }
   ...
   public static bhe a(long $$0, qw $$1) {
      bhe $$2 = new bhe($$0);
   ...
   public void a(aew $$0, int $$1, boolean $$2, boolean $$3) {
