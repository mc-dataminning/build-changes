...
public class bio {
   ...
   private bio(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bio a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bio($$0, $$1);
   }

   public bio.d a() throws IOException {
      bio.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bio.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bio.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bio.c $$3 = bio.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bio.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bio.a($$0, $$3);
            }
         }
   ...
   public bio.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bio.c> $$2 = this.a().c();
      ...
      bio.e $$4 = new bio.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bio.c b) implements bio.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bio.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bio.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bio.b> {
      private final List<bio.b> a;

      d(List<bio.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bio.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bio.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bio.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bio.d a() {
         ListIterator<bio.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bio.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bio.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bio.b> b() {
         return this.a.stream();
      }

      public Set<bio.c> c() {
         return this.a.stream().map(bio.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bio.c b) implements bio.b {
