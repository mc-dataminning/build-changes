...
public abstract class sj {
   ...
   private static volatile sj e = c();
   ...
   private static sj c() {
      ...
      return new sj() {
         ...
         @Override
         public aub a(vl $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> avk.c($$2xxx, $$1x, $$1) ? Optional.empty() : vl.a, wd.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = sj.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(auf.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract aub a(vl var1);

   public List<aub> a(List<vl> $$0) {
