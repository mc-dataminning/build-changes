...
public class cqv {
   ...
   public he<cqt> a(double $$0, double $$1, double $$2) {
      int $$3 = hp.a(arw.a($$0));
      int $$4 = hp.a(arw.a($$1));
      int $$5 = hp.a(arw.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ars.a($$7, $$0);
      double $$10 = b($$7);
      return arw.k($$6 + $$10) + arw.k($$5 + $$9) + arw.k($$4 + $$8);
   }
   ...
   public interface a {
      he<cqt> getNoiseBiome(int var1, int var2, int var3);
   }
}
