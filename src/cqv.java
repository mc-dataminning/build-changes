...
public abstract class cqv extends cpt {
   private static final int k = 9;
   private static final int l = 3;
   protected final cqe o;
   protected final cmw p;
   protected final bqm q;
   private final List<Integer> m;
   protected final crj r = new crj();
   private final int n;

   protected abstract boolean a(cmw var1, boolean var2);

   protected abstract void a(cmw var1, cuo var2);

   protected abstract boolean a(dsb var1);

   public cqv(@Nullable cra<?> $$0, int $$1, cmv $$2, cqe $$3) {
      super($$0, $$1);
      this.o = $$3;
      this.p = $$2.l;
      cqw $$4 = this.l();
   ...
   private void a(cqw $$0) {
      for (final cqw.b $$1 : $$0.c()) {
         this.a(new cro(this.q, $$1.a(), $$1.b(), $$1.c()) {
            @Override
   ...
   private void b(cqw $$0) {
      this.a(new cro(this.r, $$0.b().a(), $$0.b().b(), $$0.b().c()) {
         @Override
         public boolean a(cuo $$0) {
            return false;
         }
   ...
   private void a(cmv $$0) {
      for (int $$1 = 0; $$1 < 3; $$1++) {
         for (int $$2 = 0; $$2 < 9; $$2++) {
            this.a(new cro($$0, $$2 + $$1 * 9 + 9, 8 + $$2 * 18, 84 + $$1 * 18));
         }
      }

      for (int $$3 = 0; $$3 < 9; $$3++) {
         this.a(new cro($$0, $$3, 8 + $$3 * 18, 142));
      }
   }

   public abstract void m();

   protected abstract cqw l();
