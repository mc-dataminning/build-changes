...
public class atb {
   ...
   private static List<atb.b> a(final Path $$0) throws IOException {
      try {
         final List<atb.b> $$1 = new ArrayList<>();
   ...
   private static List<atb.a> a(List<atb.b> $$0) {
      List<atb.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (atb.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new atb.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<atb.a> a = Comparator.comparing(atb.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<atb.b> a = Comparator.comparing(atb.b::b).reversed();
