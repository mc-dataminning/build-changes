...
public class atb implements asx {
   ...
   private final Map<asz, List<Path>> h;

   atb(asw $$0, asp $$1, Set<String> $$2, List<Path> $$3, Map<asz, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(asz $$0, alb $$1, Consumer<Path> $$2) {
      v.c($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(asz $$0, String $$1, String $$2, asx.a $$3) {
      v.c($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<alb, aud<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asx.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      ata.a($$1, $$4, $$3, $$0);
   }
   ...
   public aud<InputStream> a(asz $$0, alb $$1) {
      return (aud<InputStream>)v.c($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && ata.a($$5)) {
               return aud.create($$5);
            }
         }
   ...
   public <T> T a(atk<T> $$0) {
      aud<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public auo d() {
      return $$0 -> Optional.ofNullable(this.a(asz.a, $$0)).map($$0x -> new auj(this, $$0x));
   }
}
