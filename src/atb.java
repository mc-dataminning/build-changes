...
public class atb extends asv {
   ...
   private final atb.b d;
   private final String e;

   atb(atd $$0, atb.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atg $$0, alb $$1) {
   ...
   @Nullable
   private auk<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : auk.create($$1, $$2);
      }
   }
   ...
   public static class a implements aua.c {
      ...
      @Override
      public ate a(atd $$0) {
         atb.b $$1 = new atb.b(this.a);
         return new atb($$0, $$1, "");
      }

      @Override
      public ate a(atd $$0, aua.a $$1) {
         atb.b $$2 = new atb.b(this.a);
         ate $$3 = new atb($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<ate> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  atb.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
