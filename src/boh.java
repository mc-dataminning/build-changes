...
public class boh implements boa {
   ...
   public static Set<bny> a() {
      Builder<bny> $$0 = ImmutableSet.builder();

      try {
         boh.a $$1 = new boh.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bny.a("cpu#" + $$1x, bnx.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bny.a("heap MiB", bnx.e, () -> (double)ab.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bnz.a.a());
      return $$0.build();
   }
   ...
   public static bny a(final LongSupplier $$0) {
      ...
      bny.d $$3 = new bny.d(2.0F);
      return bny.a("ticktime", bnx.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
