...
public class fdm {
   ...
   public static final fdm.a bv;

   public static fdm.a a(int $$0, int $$1) {
      return $$0 == -1 ? fdm.b.b.a($$1) : fdm.b.a.a($$0);
   }

   public static fdm.a a(String $$0) {
      if (fdm.a.e.containsKey($$0)) {
         return fdm.a.e.get($$0);
      } else {
         for (fdm.b $$1 : fdm.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fdm.b b;
      private final int c;
      private final azg<xj> d;
      static final Map<String, fdm.a> e = Maps.newHashMap();

      a(String $$0, fdm.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xj.b($$2.toUpperCase(Locale.ROOT)) : xj.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xj.b($$2) : xj.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ug.a().b($$1) ? xj.c($$1) : xj.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fdm.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xj> g;

      private static void a(fdm.b $$0, String $$1, int $$2) {
         fdm.a $$3 = new fdm.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xj> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fdm.a a(int $$0) {
         return (fdm.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
