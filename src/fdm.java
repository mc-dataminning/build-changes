...
public class fdm {
   ...
   static class b {
      static final Optional<fdm> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static fdm a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fdm();
      }
   }
}
