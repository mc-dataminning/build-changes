...
public abstract class bbz extends DataFix {
   private final String a;

   public bbz(Schema $$0, String $$1) {
      super($$0, false);
      this.a = $$1;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$1 = DSL.named(bhw.C.typeName(), bjk.a());
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$3 = this.fixTypeEverywhereTyped(
            this.a + " for block_state", this.getInputSchema().getType(bhw.u), $$0x -> $$0x.update(DSL.remainderFinder(), this::a)
         );
         TypeRewriteRule $$4 = this.fixTypeEverywhereTyped(
            this.a + " for flat_block_state",
            this.getInputSchema().getType(bhw.v),
            $$0x -> $$0x.update(
