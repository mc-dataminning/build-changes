...
public class bbz extends bhm {
   public bbz(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", biq.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(biq.s, "minecraft:piston");
