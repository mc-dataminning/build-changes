public class fua<T extends bsq> extends fub<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.A.g = (float) (-Math.PI / 6) - ayd.b($$7 * 1.2F) * $$8;
      this.a.g = (float) (Math.PI / 6) + ayd.b($$7) * $$8;
      if ($$0 instanceof ckl $$9) {
         cko $$10 = $$9.gr();
         if ($$10 == cko.e) {
            float $$11 = $$3 / 60.0F;
            this.a.g = (float) (Math.PI / 6) + (float) (Math.PI / 180.0) * ayd.a($$11 * 30.0F) * 10.0F;
            this.A.g = (float) (-Math.PI / 6) - (float) (Math.PI / 180.0) * ayd.b($$11 * 30.0F) * 10.0F;
            this.k.b = ayd.a($$11 * 10.0F);
            this.k.c = ayd.a($$11 * 40.0F) + 0.4F;
            this.n.g = (float) (Math.PI / 180.0) * (70.0F + ayd.b($$11 * 40.0F) * 10.0F);
            this.o.g = this.n.g * -1.0F;
            this.n.c = ayd.a($$11 * 40.0F) * 0.5F + 1.5F;
            this.o.c = ayd.a($$11 * 40.0F) * 0.5F + 1.5F;
            this.m.c = ayd.a($$11 * 40.0F) * 0.35F;
         } else if ($$10 == cko.a && this.c == 0.0F) {
            this.a($$0);
         } else if ($$10 == cko.b) {
   ...
   protected void a(T $$0, float $$1) {
      if (this.c > 0.0F && $$0 instanceof ckm && ((ckm)$$0).gr() == cko.a) {
