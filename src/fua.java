...
public class fua extends fue {
   ...
   private static final IntSupplier f = () -> flj.Q().n.a().c() ? e : d;
   ...
   public fua(flj $$0, aul $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   static class a extends hec {
      ...
      protected hec.a b(aup $$0) {
         atf $$1 = flj.Q().ae();
         auh<InputStream> $$2 = $$1.a(atd.a, fua.a);
         if ($$2 == null) {
            return new hec.a(new FileNotFoundException(fua.a.toString()));
         } else {
            try {
               hec.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new hec.a(new hgh(true, true), feu.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new hec.a(var9);
            }
         }
      }
   }
