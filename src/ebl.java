...
public class ebl extends eaz<edk> {
   public ebl(Codec<edk> $$0) {
      super($$0);
   }
      ...
      if (!$$3.a_($$1).a(dfc.dP)) {
            ...
            for (int $$9 = -$$8; $$9 <= $$8; $$9++) {
               ...
               for (int $$11 = -$$8; $$11 <= $$8; $$11++) {
                  ...
                  if (($$9 == 0 && $$11 == 0 || !($$10 * $$10 + $$12 * $$12 > $$7 * $$7))
                     ...
                     dsd $$13 = $$3.a_($$1.b($$9, $$6, $$11));
                     if ($$13.i() || b($$13) || $$13.a(dfc.dP) || $$13.a(dfc.dO)) {
                        this.a($$3, $$1.b($$9, $$6, $$11), dfc.iC.o());
                     }
         ...
         for (int $$15 = -$$14; $$15 <= $$14; $$15++) {
            for (int $$16 = -$$14; $$16 <= $$14; $$16++) {
               ...
               while ($$17.v() > 50) {
                  dsd $$19 = $$3.a_($$17);
                  if (!$$19.i() && !b($$19) && !$$19.a(dfc.dP) && !$$19.a(dfc.dO) && !$$19.a(dfc.iC)) {
                     break;
                  }

                  this.a($$3, $$17, dfc.iC.o());
                  $$17 = $$17.d();
                  if (--$$18 <= 0) {
                     $$17 = $$17.c($$2.a(5) + 1);
                     $$18 = $$2.a(5);
