...
@Deprecated
public class ebl extends eaw<ebl.a> {
   private static final dsa a = dez.nc.o();

   public ebl(Codec<ebl.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eay<ebl.a> $$0) {
      iz $$1 = $$0.e();
      dcr $$2 = $$0.b();
      azf $$3 = $$0.d();
      ebl.a $$4 = $$0.f();
   ...
   public static record a(efb b, efb c) implements eda {
      public static final Codec<ebl.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(efb.a.fieldOf("fluid").forGetter(ebl.a::a), efb.a.fieldOf("barrier").forGetter(ebl.a::b)).apply($$0, ebl.a::new)
      );
