...
public class ebl extends eay<ecv> {
   public ebl(Codec<ecv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<ecv> $$0) {
      iz $$1 = $$0.e();
      dct $$2 = $$0.b();
   ...
   private void a(azh $$0, dbz $$1, int $$2, int $$3, iz $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iz $$2, dbz $$3, boolean $$4, double $$5, iz $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dbz $$0, iz $$1) {
      if ($$0.a_($$1.c()).a(dfb.dN)) {
         this.a($$0, $$1.c(), dfb.a.o());
      }
   }

   private void a(dbz $$0, azh $$1, iz $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dsc $$13) {
   ...
   private void a(iz $$0, dbz $$1, azh $$2, int $$3, int $$4, boolean $$5, boolean $$6, dsc $$7) {
      dsc $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dfb.dP) || $$8.a(dfb.dO) || $$8.a(dfb.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dfb.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dfb.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dsc $$0) {
      return $$0.a(dfb.iC) || $$0.a(dfb.dP) || $$0.a(dfb.mW);
   }
   ...
   private void a(dbz $$0, iz $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dfb.dN)) {
                  if (this.a((dbe)$$0, $$10)) {
                     this.a($$0, $$10, dfb.a.o());
                     this.a($$0, $$10.c(), dfb.a.o());
                  } else if (c($$11)) {
                     dsc[] $$12 = new dsc[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
