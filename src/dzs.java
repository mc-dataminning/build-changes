...
@Deprecated
public class dzs extends dzd<dzs.a> {
   private static final dqh a = ddg.nc.n();

   public dzs(Codec<dzs.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dzf<dzs.a> $$0) {
      in $$1 = $$0.e();
      day $$2 = $$0.b();
      ayg $$3 = $$0.d();
      dzs.a $$4 = $$0.f();
   ...
   public static record a(edi b, edi c) implements ebh {
      public static final Codec<dzs.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(edi.a.fieldOf("fluid").forGetter(dzs.a::a), edi.a.fieldOf("barrier").forGetter(dzs.a::b)).apply($$0, dzs.a::new)
      );
