...
public class fkz {
   ...
   private List<fks> a(fup $$0, String $$1, int $$2) {
      float $$3 = (float)$$0.a();
      float $$4 = (float)$$0.b();
      List<fks> $$5 = Lists.newArrayList();

      for (fkz.a $$6 : this.a($$0)) {
         float $$7 = 0.0F;
         float $$8 = 0.0F;
         float $$9 = 0.0F;
         float $$10 = 0.0F;
         ...
         $$13 *= $$16;
         $$14 *= $$16;
         Map<ha, fkt> $$21 = Maps.newHashMap();
         $$21.put($$20.a(), new fkt(null, $$2, $$1, new fkv(new float[]{$$11, $$13, $$12, $$14}, 0)));
         switch ($$20) {
            case a:
   ...
   private List<fkz.a> a(fup $$0) {
      int $$1 = $$0.a();
      int $$2 = $$0.b();
      List<fkz.a> $$3 = Lists.newArrayList();
      $$0.d().forEach($$4 -> {
         for (int $$5 = 0; $$5 < $$2; $$5++) {
            for (int $$6 = 0; $$6 < $$1; $$6++) {
   ...
   private void a(fkz.b $$0, List<fkz.a> $$1, fup $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
   ...
   private void a(List<fkz.a> $$0, fkz.b $$1, int $$2, int $$3) {
      fkz.a $$4 = null;
   ...
   static class a {
      private final fkz.b a;
      private int b;
      private int c;
      private final int d;

      public a(fkz.b $$0, int $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$1;
         this.d = $$2;
