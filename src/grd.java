...
public record grd(Map<String, String> c, Set<String> d) {
   public static final grd a = new grd(Map.of(), Set.of());
   public static final Codec<grd> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(grd::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(grd::e)
            )
            .apply($$0, grd::new)
   );

   public static grd.a a() {
      return new grd.a();
   }
   ...
   public grd a(grd $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new grd($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public grd.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public grd.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public grd.a a(String $$0, int $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public grd.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public grd a() {
         return new grd(this.a.build(), this.b.build());
      }
   }
}
