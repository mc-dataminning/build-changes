...
public class grd extends MinecraftServer {
   ...
   public grd(Thread $$0, fde $$1, eob.c $$2, atc $$3, ale $$4, alb $$5, aqr $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.at(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new grc(this, this.bd(), this.g));
      this.m = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (aqi $$1 : Lists.newArrayList(this.ah().t())) {
   ...
   @Override
   public daa bf() {
      return this.r() ? (daa)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
