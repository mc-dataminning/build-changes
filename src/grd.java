...
public enum grd implements grk {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, grd> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (grd)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   private grd(final int $$0, final int $$1) {
      this.u = b($$0, $$1);
   ...
   public static grd a(int $$0, int $$1) {
