...
public abstract class grd<T extends bvh, S, ST extends gxo> extends gro<T, ST> {
   private final grn a;

   protected grd(grp.a $$0) {
      super($$0);
      this.a = $$0.a();
   }
   ...
   protected int a(T $$0, jh $$1) {
      int $$2 = c($$0);
      return $$2 != -1 ? gli.b($$2) : super.b($$0, $$1);
   }

   protected int b(T $$0, jh $$1) {
      int $$2 = c($$0);
      return $$2 != -1 ? gli.a($$2) : super.a($$0, $$1);
   }

   public void a(ST $$0, fgr $$1, glk $$2, int $$3) {
      bvh.k $$4 = $$0.b;
      if ($$4 != null) {
         if ($$0.a()) {
            float $$5 = $$0.c;
   ...
   protected abstract void a(ST var1, fgr var2, glk var3, int var4, float var5);
   ...
   public static class a extends grd<bvh.b, bvh.b.a, gxf> {
      private final gmn a;
      ...
      public void a(bvh.b $$0, gxf $$1, float $$2) {
         super.a($$0, $$1, $$2);
         $$1.a = $$0.s();
      }

      public void a(gxf $$0, fgr $$1, glk $$2, int $$3, float $$4) {
         this.a.a($$0.a.a(), $$1, $$2, $$3, hbb.d);
      }
   }

   public static class b extends grd<bvh.g, bvh.g.a, gyo> {
      private final gsn a;
      ...
      public void a(bvh.g $$0, gyo $$1, float $$2) {
         super.a($$0, $$1, $$2);
         bvh.g.a $$3 = $$0.s();
         if ($$3 != null) {
            $$1.a = $$3;
      ...
      public void a(gyo $$0, fgr $$1, glk $$2, int $$3, float $$4) {
         bvh.g.a $$5 = $$0.a;
         hdm $$6 = $$0.f;
         if ($$5 != null && $$6 != null) {
            $$1.a(a.d.rotation((float) Math.PI));
            this.a.a($$5.a(), $$5.b(), false, $$1, $$2, $$3, hbb.d, $$6);
         }
      }
   }

   public static class c extends grd<bvh.l, bvh.l.e, gzu> {
      private final fnp a;
      ...
      public void a(bvh.l $$0, gzu $$1, float $$2) {
         super.a($$0, $$1, $$2);
         $$1.a = $$0.s();
         $$1.f = $$0.a(this::a);
      }
      ...
      public void a(gzu $$0, fgr $$1, glk $$2, int $$3, float $$4) {
         bvh.l.e $$5 = $$0.a;
         byte $$6 = $$5.e();
         boolean $$7 = ($$6 & 2) != 0;
         boolean $$8 = ($$6 & 4) != 0;
         ...
         if ($$13 != 0) {
            fgv $$22 = $$2.getBuffer($$7 ? glu.o() : glu.n());
         ...
         for (bvh.l.c $$23 : $$17.a()) {
            ...
            this.a.a($$23.a(), $$24, $$15, $$11 << 24 | 16777215, $$9, $$16, $$2, $$7 ? fnp.a.b : fnp.a.c, 0, $$3);
            $$15 += (float)$$19;
         }
      }
   }
