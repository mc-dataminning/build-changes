...
public class gdw extends gbf<hac> {
   public static final geq a = new gag(Set.of("head"));
   ...
   public static gep a(gel $$0) {
      ...
      ger $$2 = $$1.a();
      float $$3 = 13.5F;
      ger $$4 = $$2.a("head", gem.c(), gej.a(-1.0F, 13.5F, -7.0F));
      $$4.a(
         "real_head",
         gem.c()
            .a(0, 0)
      ...
      $$2.a("body", gem.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, $$0), gej.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("upper_body", gem.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, $$0), gej.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      gem $$5 = gem.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0);
      $$2.a("right_hind_leg", $$5, gej.a(-2.5F, 16.0F, 7.0F));
      $$2.a("left_hind_leg", $$5, gej.a(0.5F, 16.0F, 7.0F));
      $$2.a("right_front_leg", $$5, gej.a(-2.5F, 16.0F, -4.0F));
      $$2.a("left_front_leg", $$5, gej.a(0.5F, 16.0F, -4.0F));
      ger $$6 = $$2.a("tail", gem.c(), gej.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$6.a("real_tail", gem.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0), gej.a);
      return $$1;
   }
