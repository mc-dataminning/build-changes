...
public class age {
   ...
   public static BiMap<String, aet<cpq>> a = ImmutableBiMap.of("o", cpq.h, "n", cpq.i, "e", cpq.j);
   @Nullable
   private static afw g;
   @Nullable
   private static afv h;
   ...
   private static int a(dt $$0) {
      if (h != null) {
         h.b();
         $$0.a(() -> ti.b("You have now stopped chasing"), false);
         h = null;
      }

      if (g != null) {
         g.b();
         $$0.a(() -> ti.b("You are no longer being chased"), false);
         g = null;
      }
   ...
   private static boolean b(dt $$0) {
      if (g != null) {
         $$0.b(ti.b("Chase server is already running. Stop it using /chase stop"));
         return true;
      } else if (h != null) {
         $$0.b(ti.b("You are already chasing someone. Stop it using /chase stop"));
         return true;
      } else {
         return false;
      }
   ...
   private static int a(dt $$0, String $$1, int $$2) {
      if (b($$0)) {
         ...
         g = new afw($$1, $$2, $$0.l().ac(), 100);

         try {
            g.a();
            $$0.a(() -> ti.b("Chase server is now running on port " + $$2 + ". Clients can follow you using /chase follow <ip> <port>"), false);
         } catch (IOException var4) {
            b.error("Failed to start chase server", var4);
            $$0.b(ti.b("Failed to start chase server on port " + $$2));
            g = null;
         }
