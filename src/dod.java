...
public class dod extends dnm<dpx> {
   private static final Logger a = LogUtils.getLogger();
   private static final bim<?>[] b = new bim[]{bim.aJ, bim.bp, bim.bp, bim.aS};
   private static final dez c = csm.nc.n();

   public dod(Codec<dpx> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dno<dpx> $$0) {
      Predicate<dez> $$1 = dnm.a(apl.bH);
      gu $$2 = $$0.e();
      aru $$3 = $$0.d();
      cqf $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.C_() && !$$4.a_($$23.d()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(csm.cv)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, csm.cn.n(), $$1);
                        } else {
                           this.a($$4, $$23, csm.m.n(), $$1);
                        }
                     }
                  } else if (!$$24.a(csm.cv) && !$$24.a(csm.ct)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.t($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, dvc.a($$4, $$30, csm.cv.n()), $$1);
                     ddo.a($$4, $$3, $$30, ece.d);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, csm.ct.n(), $$1);
         if ($$4.c_($$2) instanceof ddx $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
