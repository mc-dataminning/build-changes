...
public class hf implements ArgumentType<hf.a> {
   ...
   public hf.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         return new hf.a() {
            ...
            @Override
            public Pair<akv, Either<il<ex>, Collection<il<ex>>>> b(CommandContext<ex> $$0) throws CommandSyntaxException {
               return Pair.of($$1, Either.right(hf.b($$0, $$1)));
            }

            @Override
            public Pair<akv, Collection<il<ex>>> c(CommandContext<ex> $$0) throws CommandSyntaxException {
   ...
   static il<ex> a(CommandContext<ex> $$0, akv $$1) throws CommandSyntaxException {
      return ((ex)$$0.getSource()).l().aE().a($$1).orElseThrow(() -> c.create($$1.toString()));
   }

   static Collection<il<ex>> b(CommandContext<ex> $$0, akv $$1) throws CommandSyntaxException {
   ...
   public static Pair<akv, Either<il<ex>, Collection<il<ex>>>> b(CommandContext<ex> $$0, String $$1) throws CommandSyntaxException {
      return ((hf.a)$$0.getArgument($$1, hf.a.class)).b($$0);
   }

   public static Pair<akv, Collection<il<ex>>> c(CommandContext<ex> $$0, String $$1) throws CommandSyntaxException {
   ...
   public interface a {
      ...
      Pair<akv, Either<il<ex>, Collection<il<ex>>>> b(CommandContext<ex> var1) throws CommandSyntaxException;

      Pair<akv, Collection<il<ex>>> c(CommandContext<ex> var1) throws CommandSyntaxException;
   }
}
