...
public class bgu extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TaggedChoiceType<?> $$2 = this.getInputSchema().findChoiceType(bhs.s);
      OpticFinder<Pair<String, String>> $$3 = DSL.fieldFinder("id", DSL.named(bhs.D.typeName(), bjg.a()));
               ...
               $$0xx -> {
                  ...
                  return $$1x
                     ? $$0xx.set("minecraft:rarity", $$0xx.createString("uncommon"))
                        .set("minecraft:item_name", bar.b($$0xx.getOps(), "block.minecraft.ominous_banner"))
                     : $$0xx;
               }
            )
      );
