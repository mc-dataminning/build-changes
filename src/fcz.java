...
public class fcz extends fda {
   ...
   private final fat u = fat.d().a(10);
   private final vf v;
   private final exz w;
   private final exz x;
   private final egl.c y;

   public fcz(evh $$0, BooleanConsumer $$1, egl.c $$2) {
      super(c);
      this.t = $$1;
      this.v = vf.a("recover_world.message", vf.b($$2.d()).a(n.h));
      this.w = new exz(this.v, $$0.h);
      this.y = $$2;
      Exception $$3 = this.a($$2, false);
      Exception $$4 = this.a($$2, true);
      vf $$5 = vf.i().b(this.a($$2, false, $$3)).f("\n").b(this.a($$2, true, $$4));
      this.x = new exz($$5, $$0.h);
      boolean $$6 = $$3 != null && $$4 == null;
      this.u.c().b();
      this.u.a(new eym(this.e, $$0.h));
      this.u.a(this.w.b(true));
      this.u.a(this.x);
      fat $$7 = fat.e().a(5);
      $$7.a(exf.a(k, fbs.b(this, "https://aka.ms/snapshotbugs?ref=game")).b(120, 20).a());
      $$7.a(exf.a(l, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : eyq.a(m)).a()).j = $$6;
      this.u.a($$7);
      this.u.a(exf.a(ve.k, $$0x -> this.aE_()).b(120, 20).a());
      this.u.a(this::d);
   }
   ...
   private void a(evh $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new fcg(vf.c("recover_world.restoring")));
         fhs.a(this.y);
         if (this.y.l()) {
            $$0.a(new fbt(this.t, n, o, ve.j, ve.k));
         } else {
            $$0.a(new fbn(() -> this.t.accept(false), n, p));
         }
      } else {
         a.error(
   ...
   private vf a(egl.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         ...
         vt $$3 = vf.i();
         Instant $$4 = $$0.a($$1);
         vt $$5 = $$4 != null ? vf.b(fib.a.format($$4)) : vf.c("recover_world.state_entry.unknown");
