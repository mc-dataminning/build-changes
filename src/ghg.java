...
public class ghg implements gha.a {
   ...
   public void a(ezy $$0, gdo $$1, double $$2, double $$3, double $$4) {
      ...
      if (this.h == null || Duration.between(this.g, $$5).compareTo(a) > 0) {
         this.g = $$5;
         this.h = new ghg.a(this.e.r.y_(), kb.a(this.e.s.dp()), 10, this.f);
      }

      a($$0, this.h.a, this.h.c, $$1, $$2, $$3, $$4, c);
      a($$0, this.h.b, this.h.c, $$1, $$2, $$3, $$4, d);
      fac $$6 = $$1.getBuffer(gdw.C());
      a($$0, this.h.a, this.h.c, $$6, $$2, $$3, $$4, c);
      a($$0, this.h.b, this.h.c, $$6, $$2, $$3, $$4, d);
   }

   private static void a(ezy $$0, ewa $$1, kb $$2, fac $$3, double $$4, double $$5, double $$6, Vector4f $$7) {
      $$1.a(($$7x, $$8, $$9, $$10) -> {
         int $$11 = $$8 + $$2.u();
         int $$12 = $$9 + $$2.v();
         int $$13 = $$10 + $$2.w();
   ...
   private static void a(ezy $$0, ewa $$1, kb $$2, gdo $$3, double $$4, double $$5, double $$6, Vector4f $$7) {
      $$1.a(($$7x, $$8, $$9, $$10, $$11, $$12) -> {
         int $$13 = $$7x + $$2.u();
         int $$14 = $$8 + $$2.v();
         int $$15 = $$9 + $$2.w();
         ...
         int $$17 = $$11 + $$2.v();
         int $$18 = $$12 + $$2.w();
         fac $$19 = $$3.getBuffer(gdw.a(1.0));
         a($$0, $$19, $$4, $$5, $$6, $$13, $$14, $$15, $$16, $$17, $$18, $$7);
      }, true);
   }

   private static void a(ezy $$0, fac $$1, je $$2, double $$3, double $$4, double $$5, int $$6, int $$7, int $$8, Vector4f $$9) {
   ...
   private static void a(ezy $$0, fac $$1, double $$2, double $$3, double $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, Vector4f $$11) {
   ...
   static final class a {
      ...
      a(enk $$0, kb $$1, int $$2, dch $$3) {
         int $$4 = $$2 * 2 + 1;
         this.a = new evu($$4, $$4, $$4);
         this.b = new evu($$4, $$4, $$4);
