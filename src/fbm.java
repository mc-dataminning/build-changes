...
public class fbm extends fah {
   ...
   private static final asu n = asu.forward("_", vo.a.a(n.a));
   private static final asu o = asu.forward("_", vo.a.a(n.h));
   private final cdm p;
   private final clb q;
   private boolean r;
   private boolean t;
   ...
   private String x = "";
   private final exe y = new exe(this::M, this::b, this::l, this::a, $$0x -> $$0x.length() < 1024 && this.i.b($$0x, 114) <= 128);
   private final exe z = new exe(() -> this.x, $$0x -> this.x = $$0x, this::l, this::a, $$0x -> $$0x.length() < 16);
   private long A;
   private int B = -1;
   private fco C;
   private fco D;
   ...
   private final bip I;
   @Nullable
   private fbm.a J = fbm.a.a;
   private ur K = uq.a;
   private final ur L;

   public fbm(cdm $$0, clb $$1, bip $$2) {
      super(esj.a);
      this.p = $$0;
      this.q = $$1;
      this.I = $$2;
      ...
      this.L = ur.a("book.byAuthor", $$0.ab()).a(n.i);
   }
   ...
   private String l() {
      return this.f != null ? exe.b(this.f) : "";
   }
   ...
   protected void aO_() {
      this.O();
      this.F = this.d((eum)eum.a(ur.c("book.signButton"), $$0x -> {
         this.t = true;
         this.F();
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.E = this.d((eum)eum.a(uq.d, $$0x -> {
         this.f.a(null);
         this.c(false);
      }).a(this.g / 2 + 2, 196, 98, 20).a());
      this.G = this.d((eum)eum.a(ur.c("book.finalizeButton"), $$0x -> {
         if (this.t) {
            this.c(true);
            this.f.a(null);
         }
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.H = this.d((eum)eum.a(uq.e, $$0x -> {
         if (this.t) {
            this.t = false;
         }
      ...
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.C = this.d(new fco($$0 + 116, 159, true, $$0x -> this.E(), true));
      this.D = this.d(new fco($$0 + 43, 159, false, $$0x -> this.D(), true));
      this.F();
   }
   ...
   private void c(boolean $$0) {
      if (this.r) {
         this.G();
         this.e($$0);
         int $$1 = this.I == bip.a ? this.p.fS().l : 40;
         this.f.I().b(new adb($$1, this.w, $$0 ? Optional.of(this.x.trim()) : Optional.empty()));
      }
   }
   ...
   private void e(boolean $$0) {
      ...
      if ($$0) {
         this.q.a("author", su.a(this.p.fR().getName()));
   ...
   public void a(eub $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.t) {
         ...
         asu $$7 = asu.composite(asu.forward(this.x, vo.a), $$6 ? n : o);
         int $$8 = this.i.a(l);
   ...
   public void b(eub $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      $$0.a(fbn.l, (this.g - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(eub $$0, fbm.c $$1, boolean $$2) {
      if (this.u / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(eub $$0, fqm[] $$1) {
      for (fqm $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(fqp.D(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private fbm.c a(fbm.c $$0) {
      return new fbm.c($$0.a - (this.g - 192) / 2 - 36, $$0.b - 32);
   }

   private fbm.c b(fbm.c $$0) {
      return new fbm.c($$0.a + (this.g - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ac.b();
            fbm.a $$4 = this.N();
            int $$5 = $$4.a(this.i, this.a(new fbm.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.M();
      this.y.a(etd.a($$1, -1, $$0, false), etd.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            fbm.a $$5 = this.N();
            int $$6 = $$5.a(this.i, this.a(new fbm.c((int)$$0, (int)$$1)));
            this.y.c($$6, true);
            this.O();
         }
   ...
   private fbm.a Q() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<fbm.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, vo.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            fbm.c $$12 = this.b(new fbm.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new fbm.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         fbm.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new fbm.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.i.b($$0.substring($$8[$$11], $$1));
            $$10 = new fbm.c($$12, $$11 * 9);
         }

         List<fqm> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new fbm.c(0, $$23), new fbm.c($$25, $$23 + 9)));
               }
         ...
         return new fbm.a($$0, $$10, $$9, $$8, $$4.toArray(new fbm.b[0]), $$14.toArray(new fqm[0]));
      }
   }
   ...
   private fqm a(String $$0, etd $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      fbm.c $$8 = new fbm.c((int)$$1.a($$6), $$4);
      fbm.c $$9 = new fbm.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private fqm a(fbm.c $$0, fbm.c $$1) {
      fbm.c $$2 = this.b($$0);
      fbm.c $$3 = this.b($$1);
      ...
      return new fqm($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fbm.a a = new fbm.a("", new fbm.c(0, 0), true, new int[]{0}, new fbm.b[]{new fbm.b(vo.a, "", 0, 0)}, new fqm[0]);
      ...
      public a(String $$0, fbm.c $$1, boolean $$2, int[] $$3, fbm.b[] $$4, fqm[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
