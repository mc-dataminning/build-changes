...
public class fbm {
   ...
   private final List<fbo> d = Lists.newArrayListWithCapacity(20);
   @Nullable
   private fbo e;
   private final fbk f = new fbk();
   private eqm g;
   private final List<fbq> h = Lists.newArrayList();
   private List<fbp> i = ImmutableList.of();
   private etl j;
   private etl k;
   private int l;
   private int m;
   ...
   public void a(eqm $$0, int $$1, int $$2) {
      ...
      this.j = new etl($$1 + 93, $$2 + 137, 12, 17, false);
      this.j.a(b);
      this.k = new etl($$1 + 38, $$2 + 137, 12, 17, true);
      this.k.a(c);
   }
   ...
   public void a(List<fbp> $$0, boolean $$1) {
      this.i = $$0;
   ...
   public void a(erw $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      if (this.l > 1) {
   ...
   public void a(erw $$0, int $$1, int $$2) {
      if (this.g.B != null && this.e != null && !this.f.d()) {
   ...
   protected void a(Consumer<esf> $$0) {
      $$0.accept(this.j);
      $$0.accept(this.k);
      this.d.forEach($$0);
   }
