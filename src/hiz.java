...
public class hiz {
   ...
   public static class a extends Thread {
      private final hiz.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hiz.b $$0) throws IOException {
         super("LanServerDetector #" + hiz.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hiz.b));
   ...
   public static class b {
      private final List<hiy> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hiy> a() {
         if (this.b) {
            List<hiy> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
