...
public abstract class bsk extends btu {
   private static final ajv<Boolean> ca = ajz.a(bsk.class, ajx.k);
   ...
   protected bsk(bsw<? extends bsk> $$0, dcu $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bsk a(aqt var1, bsk var2);
   ...
   protected void k() {
      if (!this.o_() && this.bS() && this.dd() instanceof cot $$0 && !$$0.b((bsq)this)) {
         this.ad();
      }
   }
