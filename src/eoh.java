public abstract class eoh extends eon {
   ...
   protected eoh(epa $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, jm $$7) {
   ...
   protected boolean a(dhi $$0, eob $$1, int $$2) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$3 = 0;
   ...
   protected boolean a(dhi $$0, int $$1) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$2 = $$0.am() + 1;
