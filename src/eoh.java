...
public class eoh {
   ...
   static class a implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new eoh.k($$0, $$1);
      }
   }

   static class b implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         ...
         return new eoh.l($$0, $$1);
      }
   }

   static class c implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new eoh.m($$0, $$1);
      }
   }

   static class d implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         ...
         return new eoh.n($$0, $$1);
      }
   }

   static class e implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         ...
         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new eoh.o($$0, $$3);
      }
   }

   static class f implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
         return true;
      }
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         $$1.d = true;
         return new eoh.s($$0, $$1, $$2);
      }
   }

   static class g implements eoh.i {
      @Override
      public boolean a(eoh.v $$0) {
      ...
      public eoh.r a(jm $$0, eoh.v $$1, azs $$2) {
         $$1.d = true;
         return new eoh.t($$0, $$1);
      }
   }

   public static class h extends eoh.r {
      ...
      private eoh.v G;
      private eoh.v H;
      private final List<eoh.r> I = Lists.newArrayList();

      public h(azs $$0, int $$1, int $$2, jm $$3) {
         super(emo.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eoh.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eoh.p($$3, this.G));
         this.I.add(new eoh.j($$3, this.H));
         List<eoh.i> $$5 = Lists.newArrayList();
         $$5.add(new eoh.b());
         $$5.add(new eoh.d());
         $$5.add(new eoh.e());
         $$5.add(new eoh.a());
         ...
         elp $$10 = elp.a(this.b(1, 1, 1), this.b(23, 8, 21));
         elp $$11 = elp.a(this.b(34, 1, 1), this.b(56, 8, 21));
         elp $$12 = elp.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eoh.u($$3, $$10, $$13++));
         this.I.add(new eoh.u($$3, $$11, $$13++));
         this.I.add(new eoh.q($$3, $$12));
      }
      ...
      private List<eoh.v> b(azs $$0) {
         eoh.v[] $$1 = new eoh.v[75];
         ...
         eoh.v $$23 = new eoh.v(1003);
         eoh.v $$24 = new eoh.v(1001);
         eoh.v $$25 = new eoh.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eoh.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dfy $$2, azs $$3, elp $$4) {
         int $$5 = 24;
      ...
      private void a(dfy $$0, azs $$1, elp $$2) {
      ...
      private void b(dfy $$0, azs $$1, elp $$2) {
      ...
      private void c(dfy $$0, azs $$1, elp $$2) {
      ...
      private void d(dfy $$0, azs $$1, elp $$2) {
      ...
      private void e(dfy $$0, azs $$1, elp $$2) {
      ...
      private void f(dfy $$0, azs $$1, elp $$2) {
   ...
   interface i {
      boolean a(eoh.v var1);

      eoh.r a(jm var1, eoh.v var2, azs var3);
   }

   public static class j extends eoh.r {
      public j(jm $$0, eoh.v $$1) {
         super(emo.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dfy $$0, dfw $$1, dxg $$2, azs $$3, elp $$4, deh $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dig.ch.m(), dig.ch.m(), false);
   ...
   public static class k extends eoh.r {
      public k(jm $$0, eoh.v $$1) {
         super(emo.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eoh.r {
      public l(jm $$0, eoh.v $$1) {
         super(emo.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eoh.r {
      public m(jm $$0, eoh.v $$1) {
         super(emo.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eoh.r {
      public n(jm $$0, eoh.v $$1) {
         super(emo.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eoh.r {
      public o(jm $$0, eoh.v $$1) {
         super(emo.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eoh.r {
      public p(jm $$0, eoh.v $$1) {
         super(emo.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eoh.r {
      public q(jm $$0, elp $$1) {
         super(emo.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends emb {
      protected static final dvj b = dig.hZ.m();
      protected static final dvj c = dig.ia.m();
      protected static final dvj d = dig.ib.m();
      protected static final dvj h = c;
      protected static final dvj i = dig.ii.m();
      protected static final boolean j = true;
      protected static final dvj k = dig.G.m();
      protected static final Set<die> l = ImmutableSet.builder().add(dig.dO).add(dig.iC).add(dig.mW).add(k.b()).build();
      ...
      public r(emo $$0, jm $$1, int $$2, elp $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(emo $$0, int $$1, jm $$2, eoh.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static elp a(jm $$0, eoh.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         elp $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dfy $$0, elp $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dvj $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dfy $$0, elp $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dfy $$0, elp $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dvj $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(elp $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dfy $$0, elp $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clg $$6 = bul.D.a($$0.E(), buk.d);
            if ($$6 != null) {
               $$6.c($$6.eV());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dx()), buk.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eoh.r {
      private int a;

      public s(jm $$0, eoh.v $$1, azs $$2) {
         super(emo.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eoh.r {
      public t(jm $$0, eoh.v $$1) {
         super(emo.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eoh.r {
      private int a;

      public u(jm $$0, elp $$1, int $$2) {
         super(emo.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
