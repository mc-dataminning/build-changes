...
public class eoh implements eoe {
   @Nullable
   ...
   public eoh(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new eoh.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements eod {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / eoh.this.c;
         this.d = ($$5 + (float)$$0 + eoh.this.e) / eoh.this.c;
         this.e = (eoh.this.h - (float)$$2 + eoh.this.f) / eoh.this.c;
         this.g = $$6;
      }
      ...
      public ezz bake(Function<eof, ezz> $$0) {
         return $$0.apply(new eof() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = eoh.this.b();
               epc $$3 = new epc(epc.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, eoh.this.g, eoh.this.g, eoh.this.e, eoh.this.f, 0, 0);
