...
public class eoh {
   ...
   @Deprecated
   public static eoh a(ayw $$0, eoh.a $$1) {
      return new eoh($$0, $$1, false);
   }

   public static eoh a(ayw $$0, int $$1, double... $$2) {
      return b($$0, new eoh.a($$1, new DoubleArrayList($$2)));
   }

   public static eoh b(ayw $$0, eoh.a $$1) {
      return new eoh($$0, $$1, true);
   }

   private eoh(ayw $$0, eoh.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      ...
      public static final Codec<jm<eoh.a>> b = akn.a(lu.aP, a);
