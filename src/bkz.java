...
public class bkz extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bkz.a(new Dynamic($$0, $$1), bkz.d, bkz.a);
      }
   };
   ...
   protected static TypeTemplate a(Schema $$0) {
      return DSL.optionalFields("Equipment", DSL.list(bgd.t.in($$0)));
   }
   ...
   protected static void b(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("inTile", bgd.C.in($$0)));
   }

   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", bgd.C.in($$0)));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "Item", $$1x -> DSL.optionalFields("Item", bgd.t.in($$0)));
      $$0.registerSimple($$1, "XPOrb");
      b($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", bgd.C.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", bgd.C.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", bgd.C.in($$0)));
      b($$0, $$1, "Snowball");
      b($$0, $$1, "Fireball");
      b($$0, $$1, "SmallFireball");
      b($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", bgd.C.in($$0), "Potion", bgd.t.in($$0)));
      b($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", bgd.t.in($$0)));
      b($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", bgd.C.in($$0), "TileEntityData", bgd.s.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", bgd.t.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", bgd.C.in($$0), "Items", DSL.list(bgd.t.in($$0))));
      c($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", bgd.C.in($$0), "Items", DSL.list(bgd.t.in($$0))));
      c($$0, $$1, "MinecartFurnace");
      c($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", bgd.C.in($$0), bgd.F.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", bgd.C.in($$0), "Items", DSL.list(bgd.t.in($$0))));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", $$1x -> DSL.optionalFields("RecordItem", bgd.t.in($$0)));
      d($$0, $$1, "Trap");
      d($$0, $$1, "Dropper");
      $$0.registerSimple($$1, "Sign");
      $$0.register($$1, "MobSpawner", $$1x -> bgd.F.in($$0));
      ...
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bgd.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bgd.b, () -> DSL.optionalFields("Inventory", DSL.list(bgd.t.in($$0)), "EnderItems", DSL.list(bgd.t.in($$0))));
      $$0.registerType(
         false,
         bgd.c,
         () -> DSL.fields(
      ...
      $$0.registerType(true, bgd.s, () -> DSL.optionalFields("components", bgd.w.in($$0), DSL.taggedChoiceLazy("id", DSL.string(), $$2)));
      $$0.registerType(true, bgd.A, () -> DSL.optionalFields("Riding", bgd.A.in($$0), bgd.B.in($$0)));
      $$0.registerType(false, bgd.z, () -> DSL.constType(bhp.a()));
      $$0.registerType(true, bgd.B, () -> DSL.taggedChoiceLazy("id", DSL.string(), $$1));
      $$0.registerType(
         true,
         bgd.t,
         () -> DSL.hook(
               DSL.optionalFields(
                  "id",
                  DSL.or(DSL.constType(DSL.intType()), bgd.D.in($$0)),
                  "tag",
                  DSL.optionalFields(
                     new Pair[]{
      ...
      $$0.registerType(false, bgd.C, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(bhp.a())));
      $$0.registerType(false, bgd.D, () -> DSL.constType(bhp.a()));
      ...
      $$0.registerType(false, bgd.H, DSL::remainder);
      $$0.registerType(false, bgd.I, DSL::remainder);
      $$0.registerType(true, bgd.F, DSL::remainder);
