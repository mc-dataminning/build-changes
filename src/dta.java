...
public class dta<T extends Enum<T> & azu> extends dtf<T> {
   private final ImmutableSet<T> a;
   private final Map<String, T> b = Maps.newHashMap();

   protected dta(String $$0, Class<T> $$1, Collection<T> $$2) {
      super($$0, $$1);
   ...
   public static <T extends Enum<T> & azu> dta<T> a(String $$0, Class<T> $$1) {
      return a($$0, $$1, $$0x -> true);
   }

   public static <T extends Enum<T> & azu> dta<T> a(String $$0, Class<T> $$1, Predicate<T> $$2) {
      return a($$0, $$1, Arrays.<T>stream($$1.getEnumConstants()).filter($$2).collect(Collectors.toList()));
   }

   public static <T extends Enum<T> & azu> dta<T> a(String $$0, Class<T> $$1, T... $$2) {
      return a($$0, $$1, Lists.newArrayList($$2));
   }

   public static <T extends Enum<T> & azu> dta<T> a(String $$0, Class<T> $$1, Collection<T> $$2) {
