...
public class cch extends ccf {
   ...
   public cch(bim<? extends cch> $$0, cpm $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public cch(cpm $$0, biy $$1, bii $$2, ha.a $$3) {
      this(bim.aH, $$0);
      this.b($$1);
      gu $$4 = $$1.dk();
   ...
   public void l() {
      ...
      if (!this.dK().B) {
         ...
         if (this.c == null || !this.c.bv() || this.c instanceof cbn && this.c.G_()) {
            if (!this.aT()) {
   ...
   private void m() {
      this.ak();
      this.dK().a(djk.o, this.di(), djk.a.a(this));
   }
