...
public class cch extends cdc {
   ...
   private fba l() {
      ard $$0 = (ard)this.b.dV();
      List<coi> $$1 = $$0.a(bus.bC, this.b.cR().g(32.0), this::a);
      if ($$1.isEmpty()) {
         return null;
      } else {
         coi $$2 = $$1.get(this.b.dV().A.a($$1.size()));
         fba $$3 = $$2.dt();
   ...
   private fba m() {
      ...
      if ($$0 == null) {
         ...
         ji $$1 = this.a($$0);
         return $$1 == null ? null : cgf.a(this.b, 10, 7, fba.c($$1));
      }
   }
   ...
   private ji a(kk $$0) {
      ard $$1 = (ard)this.b.dV();
      cgl $$2 = $$1.A();
      List<ji> $$3 = $$2.c($$0x -> true, $$0.k(), 8, cgl.b.b).map(cgm::g).collect(Collectors.toList());
