...
public class afz {
   ...
   public afz(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<afz.a> b(Scanner $$0) {
      aex<cpx> $$1 = (aex<cpx>)agi.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new afz.a($$1, new ehp((double)$$2, (double)$$3, (double)$$4), new eho($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<akt> $$1 = this.e.ac().t();
         if (!$$1.isEmpty()) {
            akt $$2 = $$1.get(0);
            aks $$3 = this.e.D();
            dt $$4 = new dt($$2, ehp.a($$3.R()), eho.a, $$3, 4, "", tm.a, this.e, $$2);
            du $$5 = this.e.aC();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(aex<cpx> a, ehp b, eho c) {
   }
}
