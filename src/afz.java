...
public class afz extends IOException {
   private final List<afz.a> a = Lists.newArrayList();
   private final String b;

   public afz(String $$0) {
      this.a.add(new afz.a());
      this.b = $$0;
   }

   public afz(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new afz.a());
      this.b = $$0;
   }
   ...
   public static afz a(Exception $$0) {
      if ($$0 instanceof afz) {
         return (afz)$$0;
      } else {
