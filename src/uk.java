...
public class uk {
   ...
   private static int a(ts $$0) {
      $$0.g().a_(null, $$0.e()).stream().forEach($$0x -> $$0x.a(bvk.d.b));
      $$0.f().c($$0.g());
      ui.a($$0.e(), $$0.g());
   ...
   private static int a(ew $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         ash $$5 = $$0.e();
         jh $$6 = a($$0).e();
         ui.a($$1.toLowerCase(), $$6, new kl($$2, $$3, $$4), drc.a, $$5);
         jh $$7 = $$6.d();
         jh $$8 = $$7.b($$2 - 1, 0, $$4 - 1);
         jh.d($$7, $$8).forEach($$1x -> $$5.b($$1x, dko.I.m()));
         ui.a($$6, new jh(1, 0, -1), drc.a, $$5);
         return 0;
      } else {
   ...
   private static int a(ew $$0, String $$1) throws CommandSyntaxException {
      fbu $$2 = (fbu)$$0.h().a(10.0, 1.0F, false);
      jh $$3 = $$2.b();
      ash $$4 = $$0.e();
