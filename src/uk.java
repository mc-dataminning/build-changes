...
public class uk extends uc<ul> {
   private static final int b = 24;
   public static final vc<uk> a = new vc.b<uk>() {
      public uk a(DataInput $$0, um $$1) throws IOException {
         return new uk(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, va $$1) {
      if ($$1 instanceof ut) {
         this.c = ArrayUtils.add(this.c, $$0, ((ut)$$1).f());
         return true;
      } else {
         return false;
      }
