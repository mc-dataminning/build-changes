...
public class fup extends fum {
   ...
   private int J;
   private final fpl K = new fpl(false);

   public fup(boolean $$0, Runnable $$1) {
      super(flb.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(fof $$0) {
      $$0.a(gmj::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
