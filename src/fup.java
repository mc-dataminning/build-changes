public abstract class fup {
   ...
   protected final bpe e;

   protected fup(fsk $$0, bpe $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public void a(fsm $$0, int $$1, int $$2) {
      int $$3 = $$0.b();
      $$0.a(grc.M(), $$1, $$3 - 60, $$1 + $$2, $$3, -1873784752);
      long $$4 = 0L;
      long $$5 = 2147483647L;
      long $$6 = -2147483648L;
      ...
      $$0.a(grc.M(), $$1, $$1 + $$2 - 1, $$3 - 60, -1);
      $$0.a(grc.M(), $$1, $$1 + $$2 - 1, $$3 - 1, -1);
      $$0.b(grc.M(), $$1, $$3 - 60, $$3, -1);
      $$0.b(grc.M(), $$1 + $$2 - 1, $$3 - 60, $$3, -1);
      if ($$8 > 0) {
   ...
   protected void b(fsm $$0, int $$1, int $$2, int $$3) {
      long $$4 = this.e.a($$3);
      int $$5 = this.b((double)$$4);
      int $$6 = this.a($$4);
      $$0.a(grc.M(), $$2, $$1 - $$5, $$2 + 1, $$1, $$6);
   }

   protected void c(fsm $$0, int $$1, int $$2, int $$3) {
   }
   ...
   protected void d(fsm $$0, int $$1, int $$2, int $$3) {
   }

   protected void a(fsm $$0, String $$1, int $$2, int $$3) {
      $$0.a(grc.M(), $$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
