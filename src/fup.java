public class fup extends fug<cte> {
   ...
   protected void a(fnl $$0, float $$1, int $$2, int $$3) {
      ...
      if ($$7 > 0) {
         $$0.a(glo::B, G, 18, 4, 0, 0, $$4 + 60, $$5 + 44, $$7, 4);
      }
      ...
      if ($$8 > 0) {
         ...
         if ($$9 > 0) {
            $$0.a(glo::B, H, 9, 28, 0, 0, $$4 + 97, $$5 + 16, 9, $$9);
         }

         $$9 = K[$$8 / 2 % 7];
         if ($$9 > 0) {
            $$0.a(glo::B, I, 12, 29, 0, 29 - $$9, $$4 + 63, $$5 + 14 + 29 - $$9, 12, $$9);
         }
      }
   }
}
