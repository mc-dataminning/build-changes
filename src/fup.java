...
public class fup {
   ...
   static final ThreadLocal<fup.d> f = ThreadLocal.withInitial(fup.d::new);

   public fup(ewv $$0) {
      this.d = $$0;
   }

   public void a(cta $$0, ghb $$1, djp $$2, hx $$3, eqk $$4, eqo $$5, boolean $$6, auw $$7, long $$8, int $$9) {
      boolean $$10 = evr.N() && $$2.h() == 0 && $$1.a();
      emc $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(cta $$0, ghb $$1, djp $$2, hx $$3, eqk $$4, eqo $$5, boolean $$6, auw $$7, long $$8, int $$9) {
      ...
      for (ic $$14 : c) {
         $$7.b($$8);
         List<fuq> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || cwy.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<fuq> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(cta $$0, ghb $$1, djp $$2, hx $$3, eqk $$4, eqo $$5, boolean $$6, auw $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      hx.a $$11 = $$3.j();

      for (ic $$12 : c) {
         $$7.b($$8);
         List<fuq> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || cwy.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = ftr.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<fuq> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(cta $$0, djp $$1, hx $$2, eqk $$3, eqo $$4, List<fuq> $$5, float[] $$6, BitSet $$7, fup.b $$8, int $$9) {
      for (fuq $$10 : $$5) {
   ...
   private void a(
      cta $$0, djp $$1, hx $$2, eqo $$3, eqk.a $$4, fuq $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(cta $$0, djp $$1, hx $$2, int[] $$3, ic $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(cta $$0, djp $$1, hx $$2, int $$3, int $$4, boolean $$5, eqk $$6, eqo $$7, List<fuq> $$8, BitSet $$9) {
      for (fuq $$10 : $$8) {
         if ($$5) {
   ...
   public void a(eqk.a $$0, eqo $$1, @Nullable djp $$2, ghb $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      auw $$9 = auw.a();
      long $$10 = 42L;
   ...
   private static void a(eqk.a $$0, eqo $$1, float $$2, float $$3, float $$4, List<fuq> $$5, int $$6, int $$7) {
      for (fuq $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = aup.a($$2, 0.0F, 1.0F);
            $$10 = aup.a($$3, 0.0F, 1.0F);
            $$11 = aup.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new fup.e[]{fup.e.k, fup.e.d, fup.e.k, fup.e.j, fup.e.e, fup.e.j, fup.e.e, fup.e.d},
         new fup.e[]{fup.e.k, fup.e.c, fup.e.k, fup.e.i, fup.e.e, fup.e.i, fup.e.e, fup.e.c},
         new fup.e[]{fup.e.l, fup.e.c, fup.e.l, fup.e.i, fup.e.f, fup.e.i, fup.e.f, fup.e.c},
         new fup.e[]{fup.e.l, fup.e.d, fup.e.l, fup.e.j, fup.e.f, fup.e.j, fup.e.f, fup.e.d}
      ),
      b(
         new ic[]{ic.f, ic.e, ic.c, ic.d},
         1.0F,
         true,
         new fup.e[]{fup.e.f, fup.e.d, fup.e.f, fup.e.j, fup.e.l, fup.e.j, fup.e.l, fup.e.d},
         new fup.e[]{fup.e.f, fup.e.c, fup.e.f, fup.e.i, fup.e.l, fup.e.i, fup.e.l, fup.e.c},
         new fup.e[]{fup.e.e, fup.e.c, fup.e.e, fup.e.i, fup.e.k, fup.e.i, fup.e.k, fup.e.c},
         new fup.e[]{fup.e.e, fup.e.d, fup.e.e, fup.e.j, fup.e.k, fup.e.j, fup.e.k, fup.e.d}
      ),
      c(
         new ic[]{ic.b, ic.a, ic.f, ic.e},
         0.8F,
         true,
         new fup.e[]{fup.e.b, fup.e.k, fup.e.b, fup.e.e, fup.e.h, fup.e.e, fup.e.h, fup.e.k},
         new fup.e[]{fup.e.b, fup.e.l, fup.e.b, fup.e.f, fup.e.h, fup.e.f, fup.e.h, fup.e.l},
         new fup.e[]{fup.e.a, fup.e.l, fup.e.a, fup.e.f, fup.e.g, fup.e.f, fup.e.g, fup.e.l},
         new fup.e[]{fup.e.a, fup.e.k, fup.e.a, fup.e.e, fup.e.g, fup.e.e, fup.e.g, fup.e.k}
      ),
      d(
         new ic[]{ic.e, ic.f, ic.a, ic.b},
         0.8F,
         true,
         new fup.e[]{fup.e.b, fup.e.k, fup.e.h, fup.e.k, fup.e.h, fup.e.e, fup.e.b, fup.e.e},
         new fup.e[]{fup.e.a, fup.e.k, fup.e.g, fup.e.k, fup.e.g, fup.e.e, fup.e.a, fup.e.e},
         new fup.e[]{fup.e.a, fup.e.l, fup.e.g, fup.e.l, fup.e.g, fup.e.f, fup.e.a, fup.e.f},
         new fup.e[]{fup.e.b, fup.e.l, fup.e.h, fup.e.l, fup.e.h, fup.e.f, fup.e.b, fup.e.f}
      ),
      e(
         new ic[]{ic.b, ic.a, ic.c, ic.d},
         0.6F,
         true,
         new fup.e[]{fup.e.b, fup.e.d, fup.e.b, fup.e.j, fup.e.h, fup.e.j, fup.e.h, fup.e.d},
         new fup.e[]{fup.e.b, fup.e.c, fup.e.b, fup.e.i, fup.e.h, fup.e.i, fup.e.h, fup.e.c},
         new fup.e[]{fup.e.a, fup.e.c, fup.e.a, fup.e.i, fup.e.g, fup.e.i, fup.e.g, fup.e.c},
         new fup.e[]{fup.e.a, fup.e.d, fup.e.a, fup.e.j, fup.e.g, fup.e.j, fup.e.g, fup.e.d}
      ),
      f(
         new ic[]{ic.a, ic.b, ic.c, ic.d},
         0.6F,
         true,
         new fup.e[]{fup.e.g, fup.e.d, fup.e.g, fup.e.j, fup.e.a, fup.e.j, fup.e.a, fup.e.d},
         new fup.e[]{fup.e.g, fup.e.c, fup.e.g, fup.e.i, fup.e.a, fup.e.i, fup.e.a, fup.e.c},
         new fup.e[]{fup.e.h, fup.e.c, fup.e.h, fup.e.i, fup.e.b, fup.e.i, fup.e.b, fup.e.c},
         new fup.e[]{fup.e.h, fup.e.d, fup.e.h, fup.e.j, fup.e.b, fup.e.j, fup.e.b, fup.e.d}
      );
      ...
      final fup.e[] k;
      final fup.e[] l;
      private static final fup.a[] m = ac.a(new fup.a[6], $$0 -> {
         $$0[ic.a.d()] = a;
         $$0[ic.b.d()] = b;
         $$0[ic.c.d()] = c;
         $$0[ic.d.d()] = d;
      ...
      private a(ic[] $$0, float $$1, boolean $$2, fup.e[] $$3, fup.e[] $$4, fup.e[] $$5, fup.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(cta $$0, djp $$1, hx $$2, ic $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         djp $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         djp $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         djp $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         djp $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final fup.c[] k = ac.a(new fup.c[6], $$0 -> {
         $$0[ic.a.d()] = a;
         $$0[ic.b.d()] = b;
         $$0[ic.c.d()] = c;
         $$0[ic.d.d()] = d;
   ...
   static class d {
      ...
      public float b(djp $$0, cta $$1, hx $$2) {
         long $$3 = $$2.a();
         if (this.a) {
