public class fup<T extends cjl> extends fuk<T> implements fta, fuj {
   private final fxb a;
   private final fxb b;
   private final fxb f;
   private final fxb g;
   ...
   public static fxh b() {
      fxj $$0 = new fxj();
      fxk $$1 = $$0.a();
      fxk $$2 = $$1.a("head", fxg.c().a(0, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F), fxd.a(0.0F, 0.0F, 0.0F));
      $$2.a("hat", fxg.c().a(32, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 12.0F, 8.0F, new fxf(0.45F)), fxd.a);
      $$2.a("nose", fxg.c().a(24, 0).a(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F), fxd.a(0.0F, -2.0F, 0.0F));
      $$1.a(
         "body",
         fxg.c().a(16, 20).a(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F).a(0, 38).a(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new fxf(0.5F)),
         fxd.a(0.0F, 0.0F, 0.0F)
      );
      fxk $$3 = $$1.a(
         "arms",
         fxg.c().a(44, 22).a(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F).a(40, 38).a(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F),
         fxd.a(0.0F, 3.0F, -1.0F, -0.75F, 0.0F, 0.0F)
      );
      $$3.a("left_shoulder", fxg.c().a(44, 22).a().a(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F), fxd.a);
      ...
      $$1.a("right_arm", fxg.c().a(40, 46).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), fxd.a(-5.0F, 2.0F, 0.0F));
      $$1.a("left_arm", fxg.c().a(40, 46).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), fxd.a(5.0F, 2.0F, 0.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$6 == cjl.a.b) {
         if ($$0.eX().e()) {
            fsy.a(this.k, this.j, true, this.c, $$3);
         } else {
            fsy.a(this.j, this.k, $$0, this.c, $$3);
         }
      } else if ($$6 == cjl.a.c) {
         this.j.d = 0.0F;
         this.j.b = -5.0F;
         ...
         fsy.a(this.j, this.k, this.b, true);
      } else if ($$6 == cjl.a.f) {
         fsy.a(this.j, this.k, $$0, true);
      } else if ($$6 == cjl.a.g) {
         this.j.d = 0.0F;
         this.j.b = -5.0F;
