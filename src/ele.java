...
public class ele extends eli implements elg {
   ...
   public ele.c a() {
      return new ele.c(this.p, this.l, this.t, this.u);
   }

   public void a(ele.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   public void a(elo.b $$0, elo $$1) {
      if (this.s) {
         ...
         this.p = $$0;
         this.a($$1);
         this.m = (elp)$$1.c().get(0);
         this.n = 0;
         this.h.rewind();
      }
   }

   private void a(elo $$0) {
      if (this.o != $$0) {
         this.o = $$0;
         boolean $$1 = $$0 == elh.k;
         boolean $$2 = $$0 == elh.j;
   ...
   private IntConsumer a(int $$0, elo.a $$1) {
   ...
   private ele.b o() {
      ...
      this.j += $$5;
      this.i++;
      ele.a $$9 = new ele.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new ele.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == elo.b.a || this.p == elo.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<elp> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      elp $$1 = (elp)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == elp.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == elp.b.c) {
         elg.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, elg.a($$11));
         this.a($$14 + 5, elg.a($$12));
         this.a($$14 + 6, elg.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(elo a, int b, int c, elo.b d, elo.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(elo.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable elr $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
