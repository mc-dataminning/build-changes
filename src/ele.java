...
public final class ele extends elk {
   ...
   public static ele a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      ele $$9 = new ele($$0, $$1, $$2);
      $$9.e = $$3;
      $$9.f = $$4;
      $$9.g = $$5;
   ...
   static ele a(elk $$0, elk $$1, eln $$2, eln $$3, eln $$4, elf $$5) {
      ele $$6 = new ele($$2.size() - 1, $$3.size() - 1, $$4.size() - 1);
   ...
   protected static void a(elk $$0, elk.b $$1, boolean $$2) {
      ele $$3 = new ele($$0);
