...
public class ele implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ele.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ele(List<ele.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ele a(BufferedReader $$0) {
      return new ele($$0.lines().flatMap($$0x -> ele.a.a($$0x).stream()).toList());
   }

   public static record a(ele.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ele.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ele.a(ele.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ele.a(ele.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ele.a(ele.b.b, $$3));
      ...
      static ele.a b(String $$0) {
         return new ele.a(ele.b.a, "glob:" + $$0);
      }

      static ele.a c(String $$0) {
         return new ele.a(ele.b.a, "regex:" + $$0);
      }

      static ele.a d(String $$0) {
         return new ele.a(ele.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ele.b a = FileSystem::getPathMatcher;
      ele.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
