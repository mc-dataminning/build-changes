...
public class czq {
   ...
   public czq(boolean $$0, aqh<csv> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static czq a() {
      return new czq(false, aps.bL, 10, 4, 10, 5);
   }

   public static czq b() {
      return new czq(true, aps.bM, 50, 1, 5, 10);
   }
   ...
   public static class a {
      ...
      private boolean a(cpw $$0, gw $$1, boolean $$2) {
         if (this.e <= 0) {
            ...
            return $$0 instanceof akq $$3 ? $$3.m($$1) : false;
         }
      }
         ...
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, apd.ug, ape.e, 1.0F, 1.0F);
               }
      ...
      private static List<hy> a(asc $$0) {
         return ac.a(c, $$0);
      }
      ...
      private static boolean a(cpw $$0, gw $$1, ha $$2) {
         gw $$3 = $$1.a($$2);
