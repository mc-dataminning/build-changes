...
public interface dez<T extends Enum<T>> {
   int v_ = 4;

   Optional<drb> i_(drb var1);

   float au_();

   default void a_(drb $$0, aqm $$1, io $$2, ayk $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<drb> c(drb $$0, aqm $$1, io $$2, ayk $$3) {
      ...
      for (io $$7 : io.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dez<?> $$9) {
            Enum<?> $$10 = $$9.c();
