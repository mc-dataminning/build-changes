...
public class cez extends cey {
   ...
   private static final akj<Byte> bX = akn.a(cez.class, akl.a);
   private static final int bY = 1;
   private static final cef bZ = cef.b().a(4.0);
   public final bso d = new bso();
   public final bso e = new bso();
   @Nullable
   private iz ca;

   public cez(bsz<? extends cez> $$0, dbx $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   public void l() {
      ...
      if (this.u()) {
         this.h(evq.b);
         this.p(this.du(), (double)ayy.a(this.dw()) + 1.0 - (double)this.dk(), this.dA());
      } else {
   ...
   protected void Z() {
      ...
      if (this.u()) {
         ...
         evq $$6 = this.ds();
         evq $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.h($$7);
         float $$8 = (float)(ayy.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = ayy.g($$8 - this.dF());
         this.bq = 0.5F;
         this.r(this.dF() + $$9);
   ...
   public static boolean b(bsz<cez> $$0, dby $$1, bts $$2, iz $$3, azg $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
