...
public class dcq extends dcv implements bhb, bhc {
         ...
         switch ($$0) {
            ...
            case 1:
               if (!dcq.this.o.B && !dcq.this.l.isEmpty()) {
                  dcq.a(dcq.this.o, dcq.this.p, apd.by);
               }
      ...
      if ($$3.r >= $$10) {
         ...
         if (!$$0.B) {
            ...
            if (!$$16 && $$17) {
               ...
               for (akr $$18 : $$0.a(akr.class, new ehi((double)$$4, (double)$$5, (double)$$6, (double)$$4, (double)($$5 - 4), (double)$$6).c(10.0, 5.0, 10.0))) {
                  al.l.a($$18, $$3.n);
               }
            } else if ($$16 && !$$17) {
               a($$0, $$1, apd.bx);
   ...
   public static void a(cpv $$0, gw $$1, apc $$2) {
      $$0.a(null, $$1, $$2, ape.e, 1.0F, 1.0F);
   }
   ...
   private static void a(qw $$0, String $$1, @Nullable bib $$2) {
      if ($$2 != null) {
         aew $$3 = jb.e.b($$2);
         if ($$3 != null) {
            $$0.a($$1, $$3.toString());
   ...
   @Nullable
   private static bib a(qw $$0, String $$1) {
      if ($$0.b($$1, 8)) {
         aew $$2 = aew.a($$0.l($$1));
         return a(jb.e.a($$2));
      } else {
