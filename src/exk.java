...
public class exk extends eya {
   private static final long a = 2000L;
   private final akx b;
   private long c = -1L;
   private boolean k;
   private static final Object2IntMap<dha> l = ac.a(new Object2IntOpenHashMap(), $$0 -> {
      $$0.defaultReturnValue(0);
      $$0.put(dha.c, 5526612);
      $$0.put(dha.d, 10066329);
      $$0.put(dha.e, 6250897);
      $$0.put(dha.f, 8434258);
      $$0.put(dha.g, 13750737);
      $$0.put(dha.h, 7497737);
      $$0.put(dha.i, 3159410);
      $$0.put(dha.j, 2213376);
      $$0.put(dha.k, 13421772);
      $$0.put(dha.l, 16769184);
      $$0.put(dha.m, 15884384);
      $$0.put(dha.n, 16777215);
   });
   ...
   protected void b(evy $$0) {
      if (this.k) {
         $$0.a(evx.a, tf.c("narrator.loading.done"));
      } else {
         String $$1 = this.l();
         $$0.a(evx.a, $$1);
      }
   ...
   public static void a(erv $$0, akx $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.c();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.d();
