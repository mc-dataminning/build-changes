...
public class cfb extends cfa {
   ...
   private static final akk<Byte> bX = ako.a(cfb.class, akm.a);
   private static final int bY = 1;
   private static final ceh bZ = ceh.b().a(4.0);
   public final bsq d = new bsq();
   public final bsq e = new bsq();
   @Nullable
   private iz ca;

   public cfb(btb<? extends cfb> $$0, dbz $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   protected void Z() {
      ...
      if (this.u()) {
         ...
         evs $$6 = this.ds();
         evs $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.h($$7);
   ...
   public static boolean b(btb<cfb> $$0, dca $$1, btu $$2, iz $$3, azh $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
