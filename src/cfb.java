...
public class cfb extends blf implements bms {
   ...
   public cfb(blj<? extends cfb> $$0, csy $$1) {
      super($$0, $$1);
   }

   public cfb(csy $$0, double $$1, double $$2, double $$3, float $$4, int $$5, blv $$6) {
      this(blj.I, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   @Nullable
   public blv q() {
      if (this.i == null && this.j != null && this.dM() instanceof amp) {
         blf $$0 = ((amp)this.dM()).a(this.j);
         if ($$0 instanceof blv) {
            this.i = (blv)$$0;
         }
      }
         ...
         if (this.h) {
            ...
            if (this.g == 14) {
               for (int $$0 = 0; $$0 < 12; $$0++) {
                  ...
                  this.dM().a(jv.g, $$1, $$2 + 1.0, $$3, $$4, $$5, $$6);
               }
            }
         }
      } else if (--this.e < 0) {
         if (this.e == -8) {
            for (blv $$8 : this.dM().a(blv.class, this.cH().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.h = true;
         if (!this.aU()) {
            this.dM().a(this.dr(), this.dt(), this.dx(), arc.hX, this.db(), 1.0F, this.ag.i() * 0.2F + 0.85F, false);
         }
      }
   }
