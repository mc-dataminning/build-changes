...
public class ejz extends ejt<ely> {
   private static final jb[] a = jb.values();

   public ejz(Codec<ely> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejv<ely> $$0) {
      ely $$1 = $$0.f();
      azv $$2 = $$0.d();
      iv $$3 = $$0.e();
      dkg $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      ehm $$9 = new ehm(new ego($$4.E()));
      evy $$10 = evy.a($$9, -4, 1.0);
      ...
      for (iv $$44 : $$31) {
         ...
         for (jb $$46 : a) {
            ...
            eao $$48 = $$4.a_($$47);
            if ($$45.b(ebe.I)) {
               $$45 = $$45.b(ebe.I, Boolean.valueOf($$48.y().b()));
            }
