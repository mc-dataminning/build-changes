...
public class ejz {
   ...
   private static final Queue<ejz.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ejz.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ejz::a), ejx::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ejz::a), ejx::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ejz.a(this.b) + ", type=" + ejz.b(this.c) + ", severity=" + ejz.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
