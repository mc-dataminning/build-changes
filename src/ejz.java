...
public class ejz extends eke {
   ...
   public List<eim.a> a(dfs $$0, BiConsumer<jh, dvv> $$1, azu $$2, int $$3, jh $$4, ehw $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ejz.a> $$13 = Lists.newArrayList();
      $$13.add(new ejz.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jh $$21 = $$4.b(azm.a($$19), $$12 - 1, azm.a($$20));
               jh $$22 = $$21.b(5);
      ...
      List<eim.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dfs $$0, BiConsumer<jh, dvv> $$1, azu $$2, jh $$3, jh $$4, boolean $$5, ehw $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jh $$13 = $$3.b(azm.d(0.5F + (float)$$12 * $$9), azm.d(0.5F + (float)$$12 * $$10), azm.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dpc.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dfs $$0, BiConsumer<jh, dvv> $$1, azu $$2, int $$3, jh $$4, List<ejz.a> $$5, ehw $$6) {
      for (ejz.a $$7 : $$5) {
         int $$8 = $$7.a();
