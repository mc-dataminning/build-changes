...
public class ejz extends eka {
   public static final int a = 8;
   public static final int b = 15;
   public static final MapCodec<ejz> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ejy.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, ejz::new)
   );
   private final ejy h;

   public ejz(bro $$0, ekd $$1, Optional<ejx> $$2, ejy $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dgo $$0, BiConsumer<ji, dwx> $$1, azh $$2, ji $$3, ji $$4, eiy $$5) {
   ...
   private boolean a(dgo $$0, azh $$1, ji $$2, jn $$3, ji $$4, List<ji> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
