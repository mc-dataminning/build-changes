...
public class ejz extends ejm<elj> {
   public ejz(Codec<elj> $$0) {
      super($$0);
   }
   ...
   private void a(azv $$0, djb $$1, int $$2, int $$3, iu $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iu $$2, djb $$3, boolean $$4, double $$5, iu $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(djb $$0, iu $$1) {
      if ($$0.a_($$1.d()).a(dmh.ed)) {
         this.a($$0, $$1.d(), dmh.a.m());
      }
   }

   private void a(djb $$0, azv $$1, iu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, eah $$13) {
   ...
   private void a(iu $$0, djb $$1, azv $$2, int $$3, int $$4, boolean $$5, boolean $$6, eah $$7) {
      eah $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dmh.ef) || $$8.a(dmh.ee) || $$8.a(dmh.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dmh.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dmh.ef.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(eah $$0) {
      return $$0.a(dmh.je) || $$0.a(dmh.ef) || $$0.a(dmh.nC);
   }
   ...
   private void a(djb $$0, iu $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dmh.ed)) {
                  if (this.a((dig)$$0, $$10)) {
                     this.a($$0, $$10, dmh.a.m());
                     this.a($$0, $$10.d(), dmh.a.m());
                  } else if (c($$11)) {
                     eah[] $$12 = new eah[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
