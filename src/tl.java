...
public class tl {
   ...
   public static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(($$0, $$1) -> vf.b("argument.nbt.list.mixed", $$0, $$1));
   public static final Dynamic2CommandExceptionType e = new Dynamic2CommandExceptionType(($$0, $$1) -> vf.b("argument.nbt.array.mixed", $$0, $$1));
   public static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> vf.b("argument.nbt.array.invalid", $$0));
   ...
   public static final Codec<sn> i = Codec.STRING.comapFlatMap($$0 -> {
      try {
         return DataResult.success(new tl(new StringReader($$0)).a(), Lifecycle.stable());
   ...
   public static sn a(String $$0) throws CommandSyntaxException {
      return new tl(new StringReader($$0)).a();
   }
   ...
   private tk b(String $$0) {
      try {
         if (p.matcher($$0).matches()) {
            return sq.a(Float.parseFloat($$0.substring(0, $$0.length() - 1)));
         }

         if (q.matcher($$0).matches()) {
            return sl.a(Byte.parseByte($$0.substring(0, $$0.length() - 1)));
         }

         if (r.matcher($$0).matches()) {
            return sv.a(Long.parseLong($$0.substring(0, $$0.length() - 1)));
         }

         if (s.matcher($$0).matches()) {
            return tf.a(Short.parseShort($$0.substring(0, $$0.length() - 1)));
         }

         if (t.matcher($$0).matches()) {
            return ss.a(Integer.parseInt($$0));
         }

         if (o.matcher($$0).matches()) {
            return so.a(Double.parseDouble($$0.substring(0, $$0.length() - 1)));
         }

         if (n.matcher($$0).matches()) {
            return so.a(Double.parseDouble($$0));
         }
   ...
   private tk h() throws CommandSyntaxException {
      ...
      if (!this.u.canRead()) {
         ...
         return new su(this.a(su.a, sv.a));
      } else if ($$1 == 'I') {
         return new sr(this.a(sr.a, ss.a));
      } else {
         this.u.setCursor($$0);
   ...
   private <T extends Number> List<T> a(tm<?> $$0, tm<?> $$1) throws CommandSyntaxException {
