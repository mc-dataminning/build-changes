...
public class ekf {
   ...
   public static final ekf.a bv;

   public static ekf.a a(int $$0, int $$1) {
      return $$0 == -1 ? ekf.b.b.a($$1) : ekf.b.a.a($$0);
   }

   public static ekf.a a(String $$0) {
      if (ekf.a.e.containsKey($$0)) {
         return ekf.a.e.get($$0);
      } else {
         for (ekf.b $$1 : ekf.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ekf.b b;
      private final int c;
      private final arn<ti> d;
      static final Map<String, ekf.a> e = Maps.newHashMap();

      a(String $$0, ekf.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new arn<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? ti.b($$2.toUpperCase(Locale.ROOT)) : ti.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? ti.b($$2) : ti.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> qp.a().b($$1) ? ti.c($$1) : ti.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ekf.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, ti> g;

      private static void a(ekf.b $$0, String $$1, int $$2) {
         ekf.a $$3 = new ekf.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, ti> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ekf.a a(int $$0) {
         return (ekf.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
