...
public class avo implements AutoCloseable {
   ...
   private avo(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static avo.a a(Path $$0) {
         return new avo.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
