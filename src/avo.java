...
public class avo extends azx {
   public avo(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bax.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bax.s, "minecraft:piston");
