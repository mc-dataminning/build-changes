...
public class avo extends avt {
   ...
   private final Set<avp<?>> e = Sets.newHashSet();

   public avo(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cly $$0, avp<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<avp<?>> d() {
      Set<avp<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<avp<T>> a(avr<T> $$0, String $$1) {
      return Optional.ofNullable(akn.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<avr<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avp<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avp<?>>)$$3.next();
         avp<?> $$2 = (avp<?>)$$1.getKey();
      ...
      for (Entry<avr<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> akn b(avp<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aqo $$0) {
      Object2IntMap<avp<?>> $$1 = new Object2IntOpenHashMap();
