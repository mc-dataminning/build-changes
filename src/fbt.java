public class fbt<T extends bvk> extends fbo<T> implements fag, fbn {
   private final fee a;
   private final fee b;
   private final fee f;
   private final fee g;
   ...
   public static fek b() {
      ...
      $$1.a(
         "body",
         fej.c().a(16, 20).a(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F).a(0, 38).a(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new fei(0.5F)),
         feg.a(0.0F, 0.0F, 0.0F)
      );
      fen $$3 = $$1.a(
         "arms",
         fej.c().a(44, 22).a(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F).a(40, 38).a(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F),
