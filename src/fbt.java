...
public abstract class fbt {
   ...
   public fau a() {
      if (this.c()) {
         ...
         return new fau(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
      }
   }

   public fbt b() {
      return this.c() ? fbq.a() : fbq.a(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
   }
   ...
   public fbt a(double $$0, double $$1, double $$2) {
      return (fbt)(this.c() ? fbq.a() : new fbb(this.a, new fbp(this.a(jn.a.a), $$0), new fbp(this.a(jn.a.b), $$1), new fbp(this.a(jn.a.c), $$2)));
   }

   public fbt d() {
      fbt[] $$0 = new fbt[]{fbq.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fbq.b($$0[0], fbq.a($$1, $$2, $$3, $$4, $$5, $$6), fbd.o));
      return $$0[0];
   }

   public void a(fbq.a $$0) {
      this.a
         .a(
   ...
   public List<fau> e() {
      List<fau> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fau($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jn.a.a, $$4.d - (double)$$2.u()), this.a(jn.a.b, $$4.e - (double)$$2.v()), this.a(jn.a.c, $$4.f - (double)$$2.w()))
               ? new fav($$4, jn.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fau.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<faz> b(faz $$0) {
      if (this.c()) {
   ...
   public fbt a(jn $$0) {
      if (!this.c() && this != fbq.b()) {
         if (this.b != null) {
            fbt $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fbt b(jn $$0) {
      ...
      if (this.d($$1)) {
         ...
         fbr $$4 = new fbr(this, $$1, $$3);
         if ($$4.c()) {
            return fbq.a();
         } else {
            return (fbt)($$4.f() ? fbq.b() : $$4);
         }
      }
   }
   ...
   public double a(jn.a $$0, fau $$1, double $$2) {
      return this.a(jf.a($$0, jn.a.a), $$1, $$2);
   }

   protected double a(jf $$0, fau $$1, double $$2) {
      if (this.c()) {
         return $$2;
