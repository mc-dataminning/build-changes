public class fbt extends fbg<cgv> implements feb {
   private static final agg x = new agg("textures/gui/container/crafting_table.png");
   private final fdv y = new fdv();
   private boolean z;

   public fbt(cgv $$0, cdl $$1, ur $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aO_() {
      ...
      this.d(new euy(this.t + 5, this.h / 2 - 49, 20, 18, fdv.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
