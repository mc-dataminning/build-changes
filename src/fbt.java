public class fbt extends fai {
   private static final fbx a = new fbx(
      new ajc("widget/tab_selected"), new ajc("widget/tab"), new ajc("widget/tab_selected_highlighted"), new ajc("widget/tab_highlighted")
   );
   ...
   public fbt(fcn $$0, fcm $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   private void b(ezx $$0, ezv $$1, int $$2) {
   ...
   protected void a(fef $$0) {
      $$0.a(fee.a, vs.a("gui.narrate.tab", this.n.a()));
   }
