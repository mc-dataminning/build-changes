...
public class fbt {
   ...
   public fbt(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public fbt(fby $$0, fby $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static fbt a(eoc $$0) {
      return new fbt((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static fbt a(fby $$0) {
      return new fbt($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static fbt a(jh $$0, jh $$1) {
      return new fbt(
   ...
   public fbt a(double $$0) {
      return new fbt($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public fbt b(double $$0) {
      return new fbt(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public fbt c(double $$0) {
      return new fbt(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public fbt d(double $$0) {
      return new fbt(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public fbt e(double $$0) {
      return new fbt(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public fbt f(double $$0) {
      return new fbt(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public fbt b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public fbt c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public fbt d(double $$0, double $$1, double $$2) {
      return new fbt(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public fbt f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public fbt h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fby> b(fby $$0, fby $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fby> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fby $$6, fby $$7) {
   ...
   @Nullable
   public static fbu a(Iterable<fbt> $$0, fby $$1, fby $$2, jh $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new fbu($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jm a(fbt $$0, fby $$1, double[] $$2, @Nullable jm $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jm a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fby $$6, double[] $$7, @Nullable jm $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fby $$0, List<fbt> $$1) {
      fby $$2 = this.f();
      fby $$3 = $$2.e($$0);

      for (fbt $$4 : $$1) {
         fbt $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fby f() {
      return new fby(bae.d(0.5, this.a, this.d), bae.d(0.5, this.b, this.e), bae.d(0.5, this.c, this.f));
   }

   public fby g() {
      return new fby(bae.d(0.5, this.a, this.d), this.b, bae.d(0.5, this.c, this.f));
   }

   public fby h() {
      return new fby(this.a, this.b, this.c);
   }

   public fby i() {
      return new fby(this.d, this.e, this.f);
   }

   public static fbt a(fby $$0, double $$1, double $$2, double $$3) {
      return new fbt($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
