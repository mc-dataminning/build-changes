...
public class fbt {
   ...
   public void a(fdb $$0, String $$1, fdy.a $$2, erd $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fbt.b $$13 = new fbt.b($$1.trim(), this.f, $$3, $$2);
                  fbt.a $$14 = new fbt.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fbt.c $$30 = new fbt.c(this.f, $$2, $$0);
                        fbt.a $$31 = new fbt.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fdf(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, erd $$2) throws IOException {
      ...
      File $$15 = new File(fgm.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final erd d;
      private final fdy.a e;

      b(final String $$0, final File $$1, final erd $$2, final fdy.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fbt.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fbt.this.b && !fbt.this.d) {
            try {
               fbt.this.e = true;
               fbt.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fbt.a.error("Error extracting archive", var3);
               fbt.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fdy.a c;
      private final fdb d;

      c(final File $$0, final fdy.a $$1, final fdb $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fbt.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fbt.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fbt.this.g);
                  fbt.this.c = true;
               } else {
                  fbt.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fbt.this.d = true;
               }
            } catch (IOException var3) {
               fbt.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fbt.this.d = true;
            }
         }
      }
