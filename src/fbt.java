...
public class fbt {
   ...
   @Nullable
   private String g;
   private static final fbt.a h = new fbt.a() {
      @Nullable
      @Override
      public fbs a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fbw.a(this.d, "Get capabilities")) {
         ...
         if (fbw.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fbw.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fbw.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fbs a(fbt.c $$0) {
      return ($$0 == fbt.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fbt.a {
      private final int a;
      private final Set<fbs> b = Sets.newIdentityHashSet();
      ...
      public fbs a() {
         if (this.b.size() >= this.a) {
            if (ab.aV) {
               fbt.a.warn("Maximum sound pool size {} reached", this.a);
            }
