...
public class eim extends ehr<ekd> {
   public eim(Codec<ekd> $$0) {
      super($$0);
   }
   ...
   protected boolean a(
      dio $$0, azs $$1, ekd $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dym $$0, Function<jj, dym> $$1, azs $$2, ekd $$3, ekd.a $$4, jj.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
   ...
   protected static boolean a(azs $$0, float $$1) {
      if ($$1 <= 0.0F) {
         return true;
      } else {
