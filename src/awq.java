...
public class awq implements AutoCloseable {
   ...
   private awq(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static awq.a a(Path $$0) {
         return new awq.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
