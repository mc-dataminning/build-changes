...
public class awq extends awv {
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  uj $$4 = a($$3.getAsJsonObject());
                  $$4 = bas.g.a($$0, $$4, uy.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awr<T>> a(awt<T> $$0, String $$1) {
      return Optional.ofNullable(alh.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static uj a(JsonObject $$0) {
      uj $$1 = new uj();
   ...
   protected String b() {
      ...
      for (Entry<awt<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lx.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> alh b(awr<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
