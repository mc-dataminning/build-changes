...
public class aib {
   ...
   private static int a(ds $$0, Collection<? extends aqa<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> vb.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> vb.a("commands.banlist.list", $$1.size()), false);

         for (aqa<?> $$2 : $$1) {
            $$0.a(() -> vb.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
