...
public class egp extends egv<eix> {
   public egp(Codec<eix> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egx<eix> $$0) {
      dif $$1 = $$0.b();
      jh $$2 = $$0.e();
      eix $$3 = $$0.f();
      bam $$4 = $$0.d();
   ...
   private void a(dif $$0, bam $$1, jh $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, eix $$9) {
      Optional<edf> $$10 = edf.a($$0, $$2, $$9.b, egq::c, egq::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dhk)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dhk)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               egq.a($$0, $$2.h($$11.getAsInt() - 1), jm.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               egq.a($$0, $$2.h($$17.getAsInt() + 1), jm.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dhk $$0, jh $$1) {
      return $$0.a_($$1).a(dkn.K);
   }

   private int a(bam $$0, int $$1, int $$2, float $$3, int $$4, eix $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dif $$0, jh $$1) {
      dxu $$2 = $$0.a_($$1);
      if (!$$2.a(dkn.J) && !$$2.a(dkn.sP) && !$$2.a(dkn.sO)) {
         if ($$0.a_($$1.d()).y().a(aya.a)) {
            return false;
         } else {
            for (jm $$3 : jm.c.a) {
               if (!this.a((dhi)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dhi)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private void a(dif $$0, jh $$1, int $$2, jm $$3) {
      jh.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, eix $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
