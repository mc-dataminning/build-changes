...
public class eqq extends eqt {
   ...
   static final eqq.b l = new eqq.b(854, 480);

   public eqq(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eqq.a[] e = values();
   ...
   static class b {
      ...
      static List<eqq.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eqq.b($$0, $$1), eqq.l) : ImmutableList.of(eqq.l);
      }
