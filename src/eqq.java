...
public class eqq {
   public static List<ers> a(eqq.a... $$0) {
      for (eqq.a $$1 : $$0) {
         a($$1.j);
      }

      List<ers> $$2 = Lists.newArrayList();

      for (eqq.a $$3 : $$0) {
         $$2.add(new ers($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(ers::a));
      return $$2;
   }
   ...
   public static List<ers> a() {
      return a(eqq.a.values());
   }
