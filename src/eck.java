...
public class eck implements ecl, ecm {
   ...
   public eck(cpz $$0, dlq $$1, eck.a $$2, Lifecycle $$3) {
      this(
         null,
         aa.b().d().c(),
         null,
   ...
   public static <T> eck a(Dynamic<T> $$0, DataFixer $$1, int $$2, @Nullable qw $$3, cpz $$4, eci $$5, eck.a $$6, dlq $$7, Lifecycle $$8) {
   ...
   private void N() {
      if (!this.r && this.s != null) {
         if (this.q < aa.b().d().c()) {
            ...
            this.s = ata.b.a(this.p, this.s, this.q);
         }
   ...
   @Override
   public boolean B() {
      return this.h == eck.a.b;
   }

   @Override
   public boolean C() {
      return this.h == eck.a.c;
   }
