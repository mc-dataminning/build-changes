...
public class eck extends eay<edy> {
   ...
   private static boolean d(dce $$0, iz $$1) {
      return $$0.a($$1, $$0x -> $$0x.a(dfb.ff));
   }

   public static boolean b(dce $$0, iz $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(awp.O));
   }

   private static void b(dcg $$0, iz $$1, dsc $$2) {
      $$0.a($$1, $$2, 19);
   }

   public static boolean c(dce $$0, iz $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(awp.cn));
   }

   private boolean a(dct $$0, azh $$1, iz $$2, BiConsumer<iz, dsc> $$3, BiConsumer<iz, dsc> $$4, eeo.b $$5, edy $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.I_() + 1 && $$13 <= $$0.am()) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<eeo.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   private int a(dce $$0, int $$1, iz $$2, edy $$3) {
      iz.a $$4 = new iz.a();
   ...
   @Override
   public final boolean a(eba<edy> $$0) {
      final dct $$1 = $$0.b();
      azh $$2 = $$0.d();
      iz $$3 = $$0.e();
      edy $$4 = $$0.f();
      ...
      BiConsumer<iz, dsc> $$9 = ($$2x, $$3x) -> {
         $$5.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      BiConsumer<iz, dsc> $$10 = ($$2x, $$3x) -> {
         $$6.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      eeo.b $$11 = new eeo.b() {
         @Override
         public void a(iz $$0, dsc $$1x) {
            $$7.add($$0.i());
            $$1.a($$0, $$1, 19);
         }
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            efu.a $$14 = new efu.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return eic.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            ewa $$5x = a($$1, $$4x, $$6, $$8, $$5);
            emk.a($$1, 3, $$5x, $$4x.h(), $$4x.i(), $$4x.j());
            return true;
         }).orElse(false);
      } else {
         return false;
   ...
   private static ewa a(dbz $$0, eic $$1, Set<iz> $$2, Set<iz> $$3, Set<iz> $$4) {
      ewa $$5 = new evu($$1.d(), $$1.e(), $$1.f());
      int $$6 = 7;
      ...
      while (true) {
         while ($$11 >= 7 || !$$7.get($$11).isEmpty()) {
            ...
            if ($$1.b($$13)) {
               if ($$11 != 0) {
                  dsc $$14 = $$0.a_($$13);
                  b($$0, $$13, $$14.a(dss.aC, Integer.valueOf($$11)));
               }
