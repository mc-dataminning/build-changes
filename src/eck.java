...
public class eck implements azv {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eck> b = ecj.a.xmap($$0 -> new eck($$0), $$0 -> $$0.e);
   private ecj e;
   private final ebl f = new ebl(this);

   public eck(long $$0) {
      this.e = new ecj(eby.c($$0));
   }
   ...
   @Override
   public azv d() {
      return new eck(this.e.a(), this.e.a());
   }

   @Override
   public ebw e() {
      return new eck.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements ebw {
      ...
      public azv a(int $$0, int $$1, int $$2) {
         long $$3 = azn.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eck($$4, this.b);
      }

      @Override
      public azv a(String $$0) {
         eby.a $$1 = eby.a($$0);
         return new eck($$1.a(this.a, this.b));
      }

      @Override
      public azv a(long $$0) {
         return new eck($$0 ^ this.a, $$0 ^ this.b);
      }
