...
public class dex {
   ...
   public dex(cpm $$0, gu $$1, ha $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dfa $$0 = this.b.a_(this.e);
      if (!det.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eai.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dfa $$0) {
      return $$0.a(csn.hV) || $$0.a(csn.pg);
   }

   private static boolean a(dfa $$0, dfa $$1) {
      if ($$0.a(csn.pg) && $$1.a(csn.hV)) {
         return false;
      } else {
         return $$0.a(csn.hV) && $$1.a(csn.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(gu $$0, ha $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!det.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dfa $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !det.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!det.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
