...
public abstract class gjz<T extends btq, M extends fub<T>> extends gix<T> implements gku<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gnk<T, M>> g = Lists.newArrayList();

   public gjz(giy.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gnk<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   @Nullable
   protected gdx a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      alf $$4 = this.a($$0);
      if ($$2) {
         return gdx.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? gdx.r($$4) : null;
      }
   }

   public static int c(btq $$0, float $$1) {
      return gor.a(gor.a($$1), gor.a($$0.aO > 0 || $$0.aQ > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return ffg.M() && $$0 != $$3.an() && $$5 && !$$0.bS();
      }
   }

   public static boolean e(btq $$0) {
      if ($$0 instanceof cmy || $$0.ag()) {
         String $$1 = n.a($$0.af().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cmy) || ((cmy)$$0).a(cmz.a);
         }
      }
