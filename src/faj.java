...
public class faj {
   ...
   public void a(fbt $$0, String $$1, fcp.a $$2, epu $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  faj.b $$13 = new faj.b($$1.trim(), this.f, $$3, $$2);
                  faj.a $$14 = new faj.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        faj.c $$30 = new faj.c(this.f, $$2, $$0);
                        faj.a $$31 = new faj.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fbx(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epu $$2) throws IOException {
      ...
      File $$15 = new File(ffd.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final epu $$2, final fcp.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((faj.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !faj.this.b && !faj.this.d) {
            try {
               faj.this.e = true;
               faj.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               faj.a.error("Error extracting archive", var3);
               faj.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fcp.a c;
      private final fbt d;

      c(final File $$0, final fcp.a $$1, final fbt $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((faj.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !faj.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, faj.this.g);
                  faj.this.c = true;
               } else {
                  faj.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  faj.this.d = true;
               }
            } catch (IOException var3) {
               faj.a.error("Error copying resourcepack file: {}", var3.getMessage());
               faj.this.d = true;
            }
         }
      }
