public class faj extends eyk {
   ...
   private void E() {
      this.f.J().b(new acr(this.n.p(), new aew(this.o.a()), new aew(this.p.a()), new aew(this.q.a()), this.s.a(), this.y));
   }

   private void F() {
      this.f.J().b(new abw(this.n.p(), this.t, this.u));
   }
   ...
   protected void aH_() {
      ...
      this.d(new esm(this.g / 2 - 154, 180, 100, 20, tk.a, 0.0) {
         ...
         @Override
         protected void a() {
            faj.this.t = arw.a(arw.b(0.0, 7.0, this.c));
         }
      });
   ...
   private void G() {
      boolean $$0 = aew.i(this.o.a()) && aew.i(this.p.a()) && aew.i(this.q.a());
      this.w.i = $$0;
      this.x.i = $$0;
   }
