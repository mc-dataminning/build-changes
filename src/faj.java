...
public class faj<T extends bss & bfx> extends fad<T> {
   ...
   public static fek c() {
      ...
      fen $$1 = $$0.a();
      fen $$2 = $$1.a(
         "body", fej.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), feg.a(0.0F, 20.0F, 5.0F)
      );
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.ge()) {
         ...
         boolean $$6 = $$2 > 1.0E-5F || $$0.dA() != $$0.N || $$0.dy() != $$0.M;
         if ($$0.aY()) {
            if ($$6) {
               this.d($$3, $$5);
            } else {
