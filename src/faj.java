...
public class faj extends fan implements fal {
   ...
   public faj.c a() {
      return new faj.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, fat.a $$1) {
   ...
   private faj.b q() {
      ...
      this.k += $$5;
      this.j++;
      faj.a $$9 = new faj.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new faj.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fat.b.a || this.q == fat.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fau> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fau $$1 = (fau)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fau.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fau.b.c) {
         fal.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, fal.a($$11));
         this.a($$14 + 5, fal.a($$12));
         this.a($$14 + 6, fal.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fat a, int b, int c, fat.b d, fat.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(fat.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable faw $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
