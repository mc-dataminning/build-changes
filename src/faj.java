...
public class faj extends fab<cfm> implements fce {
   private float x;
   private float y;
   private final fby z = new fby();
   private boolean A;
   private boolean B;

   public faj(cbw $$0) {
      super($$0.bR, $$0.fR(), tn.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void D() {
      if (this.f.q.g()) {
         this.f.a(new ezy(this.f.s, this.f.s.cn.x(), this.f.m.F().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aH_() {
      if (this.f.q.g()) {
         ...
         this.d(new ete(this.t + 104, this.h / 2 - 22, 20, 18, fby.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(esh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bji $$9) {
   ...
   public static void a(esh $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bji $$7) {
      $$0.c().a();
