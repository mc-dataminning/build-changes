...
public class bdj implements bdk {
   ...
   private static final bdj j = new bdj();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bdi $$0) {
      URL $$1 = bdj.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bdi $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bdm a = new bdm(() -> bdj.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bdj.this.k && $$0.getState() == RecordingState.STOPPED) {
