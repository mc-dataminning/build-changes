...
public class csv extends dfi implements cpu {
   ...
   private final hg.c<csv> b = jd.f.f(this);
   public static final hm<dfj> o = new hm<>();
   ...
   public static boolean j(dfj $$0) {
      return $$0.b() instanceof cxc || $$0.a(csw.hW) || $$0.a(csw.ef) || $$0.a(csw.eg) || $$0.a(csw.fa) || $$0.a(csw.dV) || $$0.a(apt.aQ);
   }
   ...
   public static boolean a(dfj $$0, cpb $$1, gw $$2, hc $$3, gw $$4) {
      dfj $$5 = $$1.a_($$4);
      if ($$0.a($$5, $$3)) {
         return false;
      } else if ($$5.p()) {
   ...
   public static boolean c(cpb $$0, gw $$1) {
      return $$0.a_($$1).a($$0, $$1, hc.b, dax.c);
   }

   public static boolean a(cpy $$0, gw $$1, hc $$2) {
      dfj $$3 = $$0.a_($$1);
      return $$2 == hc.a && $$3.a(apt.aY) ? false : $$3.a($$0, $$1, $$2, dax.b);
   }

   public static boolean a(eig $$0, hc $$1) {
      eig $$2 = $$0.a($$1);
      return a($$2);
   }
   ...
   public static List<cjf> a(dfj $$0, akr $$1, gw $$2, @Nullable dcv $$3) {
      ecw.a $$4 = new ecw.a($$1).a(efb.f, ehn.b($$2)).a(efb.i, cjf.b).b(efb.h, $$3);
      return $$0.a($$4);
   }

   public static List<cjf> a(dfj $$0, akr $$1, gw $$2, @Nullable dcv $$3, @Nullable biq $$4, cjf $$5) {
   ...
   public static void c(dfj $$0, cpv $$1, gw $$2) {
      if ($$1 instanceof akr) {
         a($$0, (akr)$$1, $$2, null).forEach($$2x -> a($$1, $$2, $$2x));
         $$0.a((akr)$$1, $$2, cjf.b, true);
      }
   }

   public static void a(dfj $$0, cpw $$1, gw $$2, @Nullable dcv $$3) {
      if ($$1 instanceof akr) {
         a($$0, (akr)$$1, $$2, $$3).forEach($$2x -> a((cpv)((akr)$$1), $$2, $$2x));
         $$0.a((akr)$$1, $$2, cjf.b, true);
      }
   }
   ...
   public static void a(dfj $$0, cpv $$1, gw $$2, @Nullable dcv $$3, @Nullable biq $$4, cjf $$5) {
      if ($$1 instanceof akr) {
         a($$0, (akr)$$1, $$2, $$3, $$4, $$5).forEach($$2x -> a($$1, $$2, $$2x));
         $$0.a((akr)$$1, $$2, $$5, true);
      }
   }
   ...
   public static void a(cpv $$0, gw $$1, cjf $$2) {
      ...
      double $$4 = (double)$$1.u() + 0.5 + arx.a($$0.z, -0.25, 0.25);
      double $$5 = (double)$$1.v() + 0.5 + arx.a($$0.z, -0.25, 0.25) - $$3;
      double $$6 = (double)$$1.w() + 0.5 + arx.a($$0.z, -0.25, 0.25);
      a($$0, () -> new byn($$0, $$4, $$5, $$6, $$2), $$2);
   }

   public static void a(cpv $$0, gw $$1, hc $$2, cjf $$3) {
      int $$4 = $$2.j();
      int $$5 = $$2.k();
      int $$6 = $$2.l();
      double $$7 = (double)biu.ad.k() / 2.0;
      double $$8 = (double)biu.ad.l() / 2.0;
      double $$9 = (double)$$1.u() + 0.5 + ($$4 == 0 ? arx.a($$0.z, -0.25, 0.25) : (double)$$4 * (0.5 + $$7));
      double $$10 = (double)$$1.v() + 0.5 + ($$5 == 0 ? arx.a($$0.z, -0.25, 0.25) : (double)$$5 * (0.5 + $$8)) - $$8;
      double $$11 = (double)$$1.w() + 0.5 + ($$6 == 0 ? arx.a($$0.z, -0.25, 0.25) : (double)$$6 * (0.5 + $$7));
      double $$12 = $$4 == 0 ? arx.a($$0.z, -0.1, 0.1) : (double)$$4 * 0.1;
      double $$13 = $$5 == 0 ? arx.a($$0.z, 0.0, 0.1) : (double)$$5 * 0.1 + 0.1;
      double $$14 = $$6 == 0 ? arx.a($$0.z, -0.1, 0.1) : (double)$$6 * 0.1;
   ...
   protected void a(akr $$0, gw $$1, int $$2) {
      if ($$0.X().b(cpr.g)) {
         biw.a($$0, ehn.b($$1), $$2);
      }
   }
   ...
   protected void a(akr $$0, gw $$1, cjf $$2, bgd $$3) {
      if (cnq.a(cns.v, $$2) == 0) {
         int $$4 = $$3.a($$0.z);
         if ($$4 > 0) {
            this.a($$0, $$1, $$4);
