...
public class eis {
   ...
   private final Map<String, eja> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public eis(@Nullable eqe $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tx a(tx $$0) {
      tx $$1 = $$0.p("Level");
      dbn $$2 = new dbn($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dbn.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dbn.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable eqe $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            tx $$2 = new tx();

            try {
               $$2 = $$0.a($$1, azo.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               tx $$4 = $$2.p($$3);
               long $$5 = dbn.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tx $$14 = $$2.p($$13);
                  $$12.a(dbn.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static eis a(akj<dcg> $$0, @Nullable eqe $$1) {
      if ($$0 == dcg.h) {
         return new eis(
            $$1,
         ...
         return new eis($$1, $$2, $$2);
      } else if ($$0 == dcg.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eis($$1, $$3, $$3);
      } else {
