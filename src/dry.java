...
public class dry {
   ...
   private final List<drw> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dry.a l = new dry.d(5.999997E7F);
   public static final dry.c e = new dry.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public in b(double $$0, double $$1, double $$2) {
      return in.a(axz.a($$0, this.e(), this.g()), $$1, axz.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(brh $$0, etk $$1) {
      double $$2 = Math.max(axz.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dry.a)($$0 == $$1 ? new dry.d($$1) : new dry.b($$0, $$1, $$2));
   ...
   public dry.c t() {
      return new dry.c(this);
   }

   public void a(dry.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dry.a {
      ...
      @Override
      public double a() {
         return axz.a(dry.this.a() - this.e() / 2.0, (double)(-dry.this.k), (double)dry.this.k);
      }

      @Override
      public double c() {
         return axz.a(dry.this.b() - this.e() / 2.0, (double)(-dry.this.k), (double)dry.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? axz.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public drx i() {
         return this.c < this.b ? drx.b : drx.a;
      }
      ...
      @Override
      public dry.a l() {
         return (dry.a)(this.g() <= 0L ? dry.this.new d(this.c) : this);
      }
      ...
      public eui m() {
         return euf.a(
            euf.c,
            euf.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ett.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dry.c a(DynamicLike<?> $$0, dry.c $$1) {
         double $$2 = axz.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = axz.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dry.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dry.a {
      ...
      private void n() {
         this.c = axz.a(dry.this.a() - this.b / 2.0, (double)(-dry.this.k), (double)dry.this.k);
         this.d = axz.a(dry.this.b() - this.b / 2.0, (double)(-dry.this.k), (double)dry.this.k);
         this.e = axz.a(dry.this.a() + this.b / 2.0, (double)(-dry.this.k), (double)dry.this.k);
         this.f = axz.a(dry.this.b() + this.b / 2.0, (double)(-dry.this.k), (double)dry.this.k);
         this.g = euf.a(
            euf.c,
            euf.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ett.e
