...
public abstract class dcl {
   ...
   public static void a(qr $$0, dcn<?> $$1) {
      $$0.a("id", dcn.a($$1).toString());
   }

   public void e(cix $$0) {
      cgq.a($$0, this.u(), this.o());
   }
   ...
   @Nullable
   public static dcl a(gu $$0, dez $$1, qr $$2) {
      String $$3 = $$2.l("id");
      aer $$4 = aer.a($$3);
      if ($$4 == null) {
   ...
   protected static void a(cpl $$0, gu $$1, dez $$2) {
      $$0.p($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
