...
public class ayu {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axw.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axw.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayu.d> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alg.d($$0.substring(1)).map($$0x -> new ayu.d($$0x, true)) : alg.d($$0).map($$0x -> new ayu.d($$0x, false)), ayu.d::c
      );
   ...
   public static <K, V> ayu.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayu.c<>($$0, $$1);
   }
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return ayu.a($$0, this.a::get, $$1::get);
      }

      public ayu.b<I, V> a(I $$0, V $$1) {
   ...
   public static record d(alg a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
