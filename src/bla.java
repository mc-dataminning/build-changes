...
public class bla extends bkk {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:commandblock_minecart", $$1x -> DSL.optionalFields("DisplayState", biw.u.in($$0)));
      a($$0, $$1, "minecraft:cow");
      a($$0, $$1, "minecraft:creeper");
      $$0.register($$1, "minecraft:donkey", $$1x -> DSL.optionalFields("Items", DSL.list(biw.t.in($$0)), "SaddleItem", biw.t.in($$0), bkl.a($$0)));
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carriedBlockState", biw.u.in($$0), bkl.a($$0)));
      ...
      $$0.register($$1, "minecraft:horse", $$1x -> DSL.optionalFields("ArmorItem", biw.t.in($$0), "SaddleItem", biw.t.in($$0), bkl.a($$0)));
      ...
      $$0.register($$1, "minecraft:mule", $$1x -> DSL.optionalFields("Items", DSL.list(biw.t.in($$0)), "SaddleItem", biw.t.in($$0), bkl.a($$0)));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", $$1x -> DSL.optionalFields("SaddleItem", biw.t.in($$0), bkl.a($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", $$1x -> DSL.optionalFields("DisplayState", biw.u.in($$0), biw.F.in($$0)));
      ...
      $$0.register($$1, "minecraft:zombie_horse", $$1x -> DSL.optionalFields("SaddleItem", biw.t.in($$0), bkl.a($$0)));
      a($$0, $$1, "minecraft:zombie_pigman");
      $$0.register($$1, "minecraft:zombie_villager", $$1x -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(biw.x.in($$0))), bkl.a($$0)));
      return $$1;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:mob_spawner", $$1x -> biw.F.in($$0));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      $$0.registerType(false, biw.a, DSL::remainder);
      $$0.registerType(false, biw.J, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         biw.b,
         () -> DSL.optionalFields(
      ...
      $$0.registerType(true, biw.B, () -> DSL.taggedChoiceLazy("id", a(), $$1));
      $$0.registerType(
         true,
         biw.t,
         () -> DSL.hook(
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields(
               "entities",
               DSL.list(DSL.optionalFields("nbt", biw.A.in($$0))),
               "blocks",
      ...
      $$0.registerType(false, biw.D, () -> DSL.constType(a()));
      $$0.registerType(false, biw.u, DSL::remainder);
      $$0.registerType(false, biw.v, DSL::remainder);
      Supplier<TypeTemplate> $$3 = () -> DSL.compoundList(biw.D.in($$0), DSL.constType(DSL.intType()));
      $$0.registerType(
         false,
         biw.g,
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  new Pair[]{
                     Pair.of("minecraft:mined", DSL.compoundList(biw.C.in($$0), DSL.constType(DSL.intType()))),
                     ...
                     Pair.of("minecraft:killed", DSL.compoundList(biw.z.in($$0), DSL.constType(DSL.intType()))),
                     Pair.of("minecraft:killed_by", DSL.compoundList(biw.z.in($$0), DSL.constType(DSL.intType()))),
      ...
      $$0.registerType(
         false, biw.o, () -> DSL.optionalFields("data", DSL.optionalFields("Objectives", DSL.list(biw.H.in($$0)), "Teams", DSL.list(biw.I.in($$0))))
      );
      $$0.registerType(false, biw.n, () -> DSL.optionalFields("data", DSL.optionalFields("Features", DSL.compoundList(biw.G.in($$0)))));
      $$0.registerType(false, biw.G, DSL::remainder);
      Map<String, Supplier<TypeTemplate>> $$4 = bkz.a($$0);
      $$0.registerType(false, biw.H, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), bkz.c, bkz.d));
      $$0.registerType(false, biw.I, DSL::remainder);
      $$0.registerType(true, biw.F, () -> DSL.optionalFields("SpawnPotentials", DSL.list(DSL.fields("Entity", biw.A.in($$0))), "SpawnData", biw.A.in($$0)));
      $$0.registerType(
         false,
         biw.p,
         () -> DSL.optionalFields(
               "minecraft:adventure/adventuring_time",
               DSL.optionalFields("criteria", DSL.compoundList(biw.K.in($$0), DSL.constType(DSL.string()))),
               "minecraft:adventure/kill_a_mob",
               DSL.optionalFields("criteria", DSL.compoundList(biw.z.in($$0), DSL.constType(DSL.string()))),
      ...
      $$0.registerType(false, biw.K, () -> DSL.constType(a()));
      $$0.registerType(false, biw.z, () -> DSL.constType(a()));
      $$0.registerType(false, biw.q, DSL::remainder);
      $$0.registerType(false, biw.M, DSL::remainder);
      $$0.registerType(false, biw.r, () -> DSL.optionalFields("Entities", DSL.list(biw.A.in($$0))));
