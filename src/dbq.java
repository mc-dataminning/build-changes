...
public record dbq(int d) implements dci {
   public static final Codec<dbq> a = ayu.i.xmap(dbq::new, dbq::a);
   public static final yw<ByteBuf, dbq> b = yw.a(yu.g, dbq::a, dbq::new);
   public static final int c = -6265536;

   public static int a(czd $$0, int $$1) {
      dbq $$2 = $$0.a(kj.K);
      return $$2 != null ? axw.f($$2.a()) : $$1;
   }

   public static czd a(czd $$0, List<cyc> $$1) {
      if (!$$0.a(axk.bP)) {
         return czd.k;
      } else {
         czd $$2 = $$0.c(1);
