...
public class fhk {
   ...
   private static final Map<dxs.a, String> e = ac.a(new EnumMap<>(dxs.a.class), $$0 -> {
      $$0.put(dxs.a.a, "SW");
      $$0.put(dxs.a.b, "S");
      $$0.put(dxs.a.c, "OW");
      $$0.put(dxs.a.d, "O");
   ...
   private dug l;
   @Nullable
   private CompletableFuture<dug> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bls r = new bls(1);
   private final bls s = new bls(blx.values().length);
   private final bls t = new bls(1);
   private final bls u = new bls(1);
   private final Map<blt, bls> v = Map.of(blt.a, this.s);
   private final fit w;
   private final fiv x;
   private final fiu y;
   private final fis z;
   ...
   public fhk(ffd $$0) {
      ...
      this.g = new fhk.a();
      this.h = $$0.h;
      this.w = new fit(this.h, this.r);
      this.x = new fiv(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fiu(this.h, this.t);
      this.z = new fis(this.h, this.u);
   }
   ...
   protected void c(fgp $$0) {
      List<String> $$1 = this.c();
      this.a($$0, $$1, false);
   }

   private void a(fgp $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayx.g($$15.dF()), ayx.g($$15.dH())));
         dug $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dcf.a, $$14);
            int $$30 = this.f.r.a(dcf.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dug $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dxs.a $$33 : dxs.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqq $$37 = new bqq($$23.al(), $$23.aa(), $$36, $$35);
   ...
   private static String a(ji<dcv> $$0) {
   ...
   private dbw r() {
      return (dbw)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private dug s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, duv.n, false).thenApply($$0x -> (dug)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eyp.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffd.Q().aO().k(), ffd.Q().aO().l(), eyp.a()),
            eyp.c(),
            eyp.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evn.a.b) {
            ...
            for (Entry<dtd<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evn.a.b) {
            ...
            for (Entry<dtd<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dtd<?>, Comparable<?>> $$0) {
      dtd<?> $$1 = $$0.getKey();
