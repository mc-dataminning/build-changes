...
public abstract class fhk<T extends fhk<T>> {
   ...
   public fhk(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fhi.a();
         if ($$3 != null) {
         ...
         throw new fjc(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fjc(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fjc(var2.getMessage(), var2);
      }
   }
   ...
   public static fhk<?> a(String $$0) {
      return new fhk.b($$0, 5000, 60000);
   }

   public static fhk<?> a(String $$0, int $$1, int $$2) {
      return new fhk.b($$0, $$1, $$2);
   }

   public static fhk<?> b(String $$0, String $$1) {
      return new fhk.c($$0, $$1, 5000, 60000);
   }

   public static fhk<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fhk.c($$0, $$1, $$2, $$3);
   }

   public static fhk<?> b(String $$0) {
      return new fhk.a($$0, 5000, 60000);
   }

   public static fhk<?> c(String $$0, String $$1) {
      return new fhk.d($$0, $$1, 5000, 60000);
   }

   public static fhk<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fhk.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fhk<fhk.a> {
   ...
   public static class b extends fhk<fhk.b> {
   ...
   public static class c extends fhk<fhk.c> {
      ...
      public fhk.c f() {
         try {
            ...
            throw new fjc(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fhk<fhk.d> {
      private final String c;
