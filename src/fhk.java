...
public class fhk {
   ...
   public void a(dcx $$0, btj $$1, boolean $$2, boolean $$3, float $$4) {
      this.f = true;
      this.g = $$0;
      this.h = $$1;
      this.q = $$2;
      this.t = $$4;
      if ($$1.bW() && $$1.dg() instanceof cps $$5 && $$5.m() instanceof cqa $$6 && $$6.t()) {
         eye $$7 = $$5.m($$1).d($$5.dq()).d($$1.l($$5)).e(new eye(0.0, (double)azc.h($$4, this.s, this.r), 0.0));
         this.a($$1.i($$4), $$1.h($$4));
         this.a($$6.e($$4).e($$7));
      } else {
         this.a($$1.i($$4), $$1.h($$4));
         this.a(
            azc.d((double)$$4, $$1.L, $$1.dx()), azc.d((double)$$4, $$1.M, $$1.dz()) + (double)azc.h($$4, this.s, this.r), azc.d((double)$$4, $$1.N, $$1.dD())
         );
      }
      ...
      if ($$2) {
         ...
         float $$9 = $$1 instanceof buf $$8 ? $$8.ef() : 1.0F;
         this.a(-this.a(4.0F * $$9), 0.0F, 0.0F);
      } else if ($$1 instanceof buf && ((buf)$$1).fL()) {
         jj $$10 = ((buf)$$1).fN();
   ...
   private float a(float $$0) {
      ...
      for (int $$2 = 0; $$2 < 8; $$2++) {
         ...
         eye $$6 = this.i.b((double)($$3 * 0.1F), (double)($$4 * 0.1F), (double)($$5 * 0.1F));
         eye $$7 = $$6.e(new eye(this.k).c((double)(-$$0)));
         eyc $$8 = this.g.a(new dda($$6, $$7, dda.a.c, dda.b.a, this.h));
         if ($$8.c() != eyc.a.a) {
   ...
   protected void a(float $$0, float $$1, float $$2) {
      ...
      this.a(new eye(this.i.d + (double)$$3.x, this.i.e + (double)$$3.y, this.i.f + (double)$$3.z));
   }
   ...
   public fhk.a j() {
      fib $$0 = fib.Q();
      double $$1 = (double)$$0.aO().l() / (double)$$0.aO().m();
      double $$2 = Math.tan((double)((float)$$0.n.aj().c().intValue() * (float) (Math.PI / 180.0)) / 2.0) * 0.05F;
      double $$3 = $$2 * $$1;
      eye $$4 = new eye(this.k).c(0.05F);
      eye $$5 = new eye(this.m).c($$3);
      eye $$6 = new eye(this.l).c($$2);
      return new fhk.a($$4, $$5, $$6);
   }
   ...
   public eqd k() {
      if (!this.f) {
         ...
         eqb $$0 = this.g.b_(this.j);
         if ($$0.a(awy.a) && this.i.e < (double)((float)this.j.v() + $$0.a(this.g, this.j))) {
            return eqd.b;
         } else {
            fhk.a $$1 = this.j();

            for (eye $$3 : Arrays.asList($$1.a, $$1.a(), $$1.b(), $$1.c(), $$1.d())) {
               eye $$4 = this.i.e($$3);
               je $$5 = je.a((jx)$$4);
               eqb $$6 = this.g.b_($$5);
               if ($$6.a(awy.b)) {
