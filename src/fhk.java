...
public interface fhk {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new fhk.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new fhk.d($$0, $$1);
      }
   }

   public static record a(String d) implements fhk {
   ...
   public static record b(int e, @Nullable xv f) implements fhk {
      public static final fhk.b c = new fhk.b(429, xv.c("mco.errorMessage.serviceBusy"));
      public static final xv d = xv.c("mco.errorMessage.retry");

      public static fhk.b a(String $$0) {
         return new fhk.b(500, xv.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fhk.b a(fjd $$0) {
         return new fhk.b(500, xv.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static fhk.b a(int $$0) {
         return new fhk.b($$0, d);
      }

      public static fhk.b b(int $$0) {
         return new fhk.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements fhk {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements fhk {
      @Override
      public int a() {
         return this.c;
      }
