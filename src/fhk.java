...
public class fhk {
   ...
   @Nullable
   private String g;
   private static final fhk.a h = new fhk.a() {
      @Nullable
      @Override
      public fhj a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fhn.a(this.d, "Get capabilities")) {
         ...
         if (fhn.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fhn.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fhn.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fhj a(fhk.c $$0) {
      return ($$0 == fhk.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fhk.a {
      private final int a;
      private final Set<fhj> b = Sets.newIdentityHashSet();
      ...
      public fhj a() {
         if (this.b.size() >= this.a) {
            if (ac.aV) {
               fhk.a.warn("Maximum sound pool size {} reached", this.a);
            }
