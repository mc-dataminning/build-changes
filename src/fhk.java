...
public class fhk extends fhc<clg> implements fjf {
   private float x;
   private float y;
   private final fiz z = new fiz();
   private boolean A;
   private boolean B;
   ...
   public void E() {
      if (this.f.q.f()) {
         this.f.a(new fgz(this.f.s, this.f.s.cq.y(), this.f.m.G().c()));
      } else {
         this.z.g();
      }
   }
   ...
   protected void aQ_() {
      if (this.f.q.f()) {
         ...
         this.c(new faa(this.t + 104, this.h / 2 - 22, 20, 18, fiz.a, $$0 -> {
            this.z.e();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(ezb $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, boi $$9) {
   ...
   public static void a(ezb $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, boi $$7) {
      $$0.c().a();
