...
public interface ege {
   static ege a(egw $$0, dir $$1, egy $$2, ehf $$3, int $$4, int $$5, ege.a $$6) {
      return new ege.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static ege a(final ege.a $$0) {
      return new ege() {
         @Nullable
         @Override
         public eat a(egl.b $$0x, double $$1) {
   ...
   @Nullable
   eat a(egl.b var1, double var2);

   boolean a();

   public interface a {
      ege.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, eat b) {

      public eat a(int $$0) {
         return $$0 < this.a ? this.b : dmt.a.m();
      }
   }

   public static class c implements ege {
      ...
      private final egl p;
      private final ehf q;
      private final ege.b[] r;
      private final long[] s;
      private final ege.a t;
      private final egl u;
      private final egl v;
      private boolean w;
      private final int x;
      ...
      c(egw $$0, dir $$1, egy $$2, ehf $$3, int $$4, int $$5, ege.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public eat a(egl.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            ege.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dmt.K)) {
               this.w = false;
               return dmt.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dmt.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dmt.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(egl.b $$0, MutableDouble $$1, ege.b $$2, ege.b $$3) {
         int $$4 = $$0.b();
         eat $$5 = $$2.a($$4);
         eat $$6 = $$3.a($$4);
         if ((!$$5.a(dmt.K) || !$$6.a(dmt.J)) && (!$$5.a(dmt.J) || !$$6.a(dmt.K))) {
      ...
      private ege.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            ege.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private ege.b b(int $$0, int $$1, int $$2) {
         ege.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               ege.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new ege.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, ege.b $$3, int $$4, boolean $$5) {
         egl.e $$6 = new egl.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dlf.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new egl.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azm.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private eat a(int $$0, int $$1, int $$2, ege.b $$3, int $$4) {
         eat $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != eeq.g && $$3.b != dmt.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new egl.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dmt.K.m();
            }
         }
