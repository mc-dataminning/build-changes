...
public class ege extends efy<eid> {
   private static final jn[] a = jn.values();

   public ege(Codec<eid> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ega<eid> $$0) {
      eid $$1 = $$0.f();
      azh $$2 = $$0.d();
      ji $$3 = $$0.e();
      dhg $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      edr $$9 = new edr(new ect($$4.E()));
      esc $$10 = esc.a($$9, -4, 1.0);
      ...
      for (ji $$44 : $$31) {
         ...
         for (jn $$46 : a) {
            ...
            dwx $$48 = $$4.a_($$47);
            if ($$45.b(dxn.J)) {
               $$45 = $$45.b(dxn.J, Boolean.valueOf($$48.y().b()));
            }
