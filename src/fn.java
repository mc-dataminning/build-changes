...
public class fn implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ws.b("team.notFound", $$0));

   public static fn a() {
      return new fn();
   }

   public static eue a(CommandContext<ec> $$0, String $$1) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return $$0.getSource() instanceof eh ? eh.b(((eh)$$0.getSource()).r(), $$1) : Suggestions.empty();
   }
