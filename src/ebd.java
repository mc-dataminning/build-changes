...
public class ebd extends eax<edc> {
   private static final je[] a = je.values();

   public ebd(Codec<edc> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eaz<edc> $$0) {
      edc $$1 = $$0.f();
      azg $$2 = $$0.d();
      iz $$3 = $$0.e();
      dcs $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dys $$9 = new dys(new dxu($$4.C()));
      emx $$10 = emx.a($$9, -4, 1.0);
      ...
      for (iz $$33 : iz.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<iz, Integer> $$37 : $$7) {
            $$35 += ayy.f($$33.j((kd)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }
      ...
      for (iz $$44 : $$31) {
         ...
         for (je $$46 : a) {
            ...
            dsb $$48 = $$4.a_($$47);
            if ($$45.b(dsr.C)) {
               $$45 = $$45.a(dsr.C, Boolean.valueOf($$48.u().b()));
            }
