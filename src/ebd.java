...
public class ebd implements ebk.c {
   ...
   private final ObjectListIterator<ebd.a> h;
   private final ObjectListIterator<enl> i;

   public static ebd a(dgi $$0, des $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<ebd.a> $$4 = new ObjectArrayList(10);
      ObjectList<enl> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != emt.a).forEach($$5x -> {
         emt $$6 = $$5x.h().d();
         ...
         for (emm $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eme) {
                  ...
                  $$4.add(new ebd.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new ebd($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public ebd(ObjectListIterator<ebd.a> $$0, ObjectListIterator<enl> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(ema a, emt b, int c) {
   }
}
