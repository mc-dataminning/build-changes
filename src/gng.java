...
public class gng {
   ...
   public final Map<jn, gnh> c;
   @Nullable
   public final gni d;
   public final boolean e;
   public final int f;

   public gng(Vector3f $$0, Vector3f $$1, Map<jn, gnh> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gng(Vector3f $$0, Vector3f $$1, Map<jn, gnh> $$2, @Nullable gni $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jn, gnh> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gng> {
      ...
      public gng a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !ayp.c($$3, "shade")) {
            ...
            return new gng($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gni a(JsonObject $$0) {
         gni $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jn, gnh> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gnh> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jn, gnh> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jn, gnh> $$2 = Maps.newEnumMap(jn.class);
         JsonObject $$3 = ayp.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jn $$5 = this.a($$4.getKey());
            $$2.put($$5, (gnh)$$0.deserialize($$4.getValue(), gnh.class));
         }
