...
public final class gng {
   ...
   private static final gng c = new gng(HostAndPort.fromParts("server.invalid", 25565));

   public gng(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gng(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gng a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gng($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gng ? this.b.equals(((gng)$$0).b) : false;
      }
   }
