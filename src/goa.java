public class goa implements gnw<dvb> {
   private final gso a;
   ...
   public void a(dvb $$0, float $$1, fgs $$2, gll $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.m().c(dyl.bw);
         if ($$6 > 0) {
            jm $$7 = $$0.c();
            if ($$7 != null) {
               ...
               if (!$$8.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = glh.a($$0.i(), $$0.m(), $$0.aB_().a($$7));
                  this.a.a($$8, cxn.i, $$11, hbc.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
