...
public class dfn {
   public static final Codec<dfn> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> af.a($$0, 2).map($$0x -> new dfn($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.h, $$0.i))
      .stable();
   public static final yn<ByteBuf, dfn> b = new yn<ByteBuf, dfn>() {
      public dfn a(ByteBuf $$0) {
         return vl.c($$0);
      }

      public void a(ByteBuf $$0, dfn $$1) {
         vl.a($$0, $$1);
      }
   };
   private static final int j = 1056;
   public static final long c = c(1875066, 1875066);
   private static final int k = (32 + dzr.a.a(dzs.n).c().b() + 1) * 2;
   public static final int d = kk.a(ji.f) - k;
   public static final dfn e = new dfn(0, 0);
   ...
   public static dfn a(int $$0, int $$1) {
      return new dfn($$0 << 5, $$1 << 5);
   }

   public static dfn b(int $$0, int $$1) {
      return new dfn(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dfn $$1) ? false : this.h == $$1.h && this.i == $$1.i;
      }
   }
   ...
   public static Stream<dfn> a(dfn $$0, int $$1) {
      return a(new dfn($$0.h - $$1, $$0.i - $$1), new dfn($$0.h + $$1, $$0.i + $$1));
   }

   public static Stream<dfn> a(final dfn $$0, final dfn $$1) {
      int $$2 = Math.abs($$0.h - $$1.h) + 1;
      int $$3 = Math.abs($$0.i - $$1.i) + 1;
      final int $$4 = $$0.h < $$1.h ? 1 : -1;
      final int $$5 = $$0.i < $$1.i ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dfn>((long)($$2 * $$3), 64) {
         @Nullable
         private dfn e;

         @Override
         public boolean tryAdvance(Consumer<? super dfn> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
               ...
               if ($$1 == $$1.h) {
                  ...
                  this.e = new dfn($$0.h, $$2 + $$5);
               } else {
                  this.e = new dfn($$1 + $$4, $$2);
               }
            }
