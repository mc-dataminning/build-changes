...
public interface dfn extends dgk {
   int g = 16;
   ...
   default faw a(dfp $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dwx $$2 = this.a_($$1);
         fba $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new faw($$0x.a(), jn.a($$3.d, $$3.e, $$3.f), ji.a((kb)$$0x.a()), false) : null;
      }, $$0x -> {
         fba $$1 = $$0x.b().d($$0x.a());
         return faw.a($$0x.a(), jn.a($$1.d, $$1.e, $$1.f), ji.a((kb)$$0x.a()));
      });
   }
   ...
   @Nullable
   default faw a(fba $$0, fba $$1, ji $$2, fbu $$3, dwx $$4) {
      faw $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         faw $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(fbu $$0, Supplier<fbu> $$1) {
      if (!$$0.c()) {
         return $$0.c(jn.a.b);
      } else {
   ...
   static <T, C> T a(fba $$0, fba $$1, C $$2, BiFunction<C, ji, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<ji> a(fba $$0, fba $$1, fav $$2) {
      fba $$3 = $$1.d($$0);
   ...
   private static void a(Set<ji> $$0, fba $$1, fba $$2, fav $$3) {
      fba $$4 = $$2.d($$1);
      int $$5 = ayz.a($$1.d);
      int $$6 = ayz.a($$1.e);
      int $$7 = ayz.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<fba> $$18 = fav.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            fba $$19 = $$18.get();
