...
public class gsq extends gti<clt, gyv, gci> {
   ...
   private static final gmh k = gmh.g(b);

   public gsq(gsc.a $$0) {
      this($$0, 0.5F, gfb.aZ);
   }

   protected gsq(gsc.a $$0, float $$1, gfa $$2) {
      super($$0, new gci($$0.a($$2)), $$1);
   }

   public boolean a(clt $$0, gpo $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gq()) {
            bvg $$5 = $$0.gr();
            if ($$5 != null) {
               fba $$6 = this.a($$5, (double)$$5.ds() * 0.5, 1.0F);
   ...
   private fba a(bvg $$0, double $$1, float $$2) {
      double $$3 = ayz.d((double)$$2, $$0.aa, $$0.dB());
      double $$4 = ayz.d((double)$$2, $$0.ab, $$0.dD()) + $$1;
      double $$5 = ayz.d((double)$$2, $$0.ac, $$0.dH());
      return new fba($$3, $$4, $$5);
   }

   public void a(gyv $$0, ffu $$1, glx $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fba $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(ffy $$0, ffu.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hea.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(clt $$0, gyv $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.m($$2);
   ...
   @Nullable
   private static buk a(clt $$0) {
      buk $$1 = flj.Q().ao();
      return (buk)($$0.gq() ? $$0.gr() : $$1);
   }
}
