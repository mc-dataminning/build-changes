...
public class fcm extends gvb {
   ...
   public fcm(fmy $$0, fbq $$1, String $$2, BooleanConsumer $$3) {
      super(fes.a);
      this.Z = $$3;
      this.E = $$0;
      this.J = $$2;
   ...
   private void C() {
      if (!this.Q) {
         if (!this.Y && this.a(this.F.a) >= 5368709120L) {
            xl $$0 = xl.a("mco.download.confirmation.line1", faf.b(5368709120L));
            xl $$1 = xl.c("mco.download.confirmation.line2");
            this.m.a(new fcp($$0x -> {
               this.Y = true;
               this.m.a(this);
               this.F();
   ...
   private xl D() {
      ...
      if (this.N != null) {
         ...
         $$0.add(xl.a("mco.download.speed.narration", faf.b(this.U)));
      }
   ...
   private void a(fgm $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.p, xl.a("mco.download.speed", faf.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
