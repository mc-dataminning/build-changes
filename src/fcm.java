...
public abstract class fcm {
   ...
   public fbn a() {
      if (this.c()) {
         ...
         return new fbn(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
      }
   }

   public fcm b() {
      return this.c() ? fcj.a() : fcj.a(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
   }
   ...
   public fcm a(double $$0, double $$1, double $$2) {
      return (fcm)(this.c() ? fcj.a() : new fbu(this.a, new fci(this.a(jm.a.a), $$0), new fci(this.a(jm.a.b), $$1), new fci(this.a(jm.a.c), $$2)));
   }

   public fcm d() {
      fcm[] $$0 = new fcm[]{fcj.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fcj.b($$0[0], fcj.a($$1, $$2, $$3, $$4, $$5, $$6), fbw.o));
      return $$0[0];
   }
   ...
   public List<fbn> e() {
      List<fbn> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fbn($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jm.a.a, $$4.d - (double)$$2.u()), this.a(jm.a.b, $$4.e - (double)$$2.v()), this.a(jm.a.c, $$4.f - (double)$$2.w()))
               ? new fbo($$4, jm.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fbn.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fbs> b(fbs $$0) {
      if (this.c()) {
   ...
   public fcm a(jm $$0) {
      if (!this.c() && this != fcj.b()) {
         if (this.b != null) {
            fcm $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fcm b(jm $$0) {
      ...
      if (this.d($$1)) {
         ...
         fck $$4 = new fck(this, $$1, $$3);
         if ($$4.c()) {
            return fcj.a();
         } else {
            return (fcm)($$4.f() ? fcj.b() : $$4);
         }
      }
   }
   ...
   public double a(jm.a $$0, fbn $$1, double $$2) {
      return this.a(je.a($$0, jm.a.a), $$1, $$2);
   }

   protected double a(je $$0, fbn $$1, double $$2) {
      if (this.c()) {
         return $$2;
