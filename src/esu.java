...
public class esu {
   ...
   public static final esu.a bv;

   public static esu.a a(int $$0, int $$1) {
      return $$0 == -1 ? esu.b.b.a($$1) : esu.b.a.a($$0);
   }

   public static esu.a a(String $$0) {
      if (esu.a.e.containsKey($$0)) {
         return esu.a.e.get($$0);
      } else {
         for (esu.b $$1 : esu.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final esu.b b;
      private final int c;
      private final awr<vu> d;
      static final Map<String, esu.a> e = Maps.newHashMap();

      a(String $$0, esu.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<esu.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vu> g;

      private static void a(esu.b $$0, String $$1, int $$2) {
         esu.a $$3 = new esu.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public esu.a a(int $$0) {
         return (esu.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
