...
public class esu extends esj implements etn {
   private static final etx d = new etx(new aeu("widget/text_field"), new aeu("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, arf> D = ($$0x, $$1x) -> arf.forward($$0x, ue.a);
   @Nullable
   private ti E;
   private long F = ac.b();

   public esu(ery $$0, int $$1, int $$2, ti $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public esu(ery $$0, int $$1, int $$2, int $$3, int $$4, ti $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public esu(ery $$0, int $$1, int $$2, int $$3, int $$4, @Nullable esu $$5, ti $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, arf> $$0) {
      this.D = $$0;
   }
   ...
   protected tv aA_() {
      ti $$0 = this.m();
      return ti.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void k(int $$0) {
      this.w = ars.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ars.a($$0) - this.r();
      if (this.s) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, eyf.q());
   }
   ...
   public void b(esa $$0, int $$1, int $$2, float $$3) {
      if (this.v()) {
         ...
         boolean $$9 = this.ay_() && (ac.b() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.s ? this.r() + 4 : this.r();
         int $$11 = this.s ? this.t() + (this.g - 8) / 2 : this.t();
         int $$12 = $$10;
         int $$13 = ars.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if (this.E != null && $$7.isEmpty() && !this.ay_()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(foh.D(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = ars.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ars.a(this.v, 0, this.p.length());
      }
   }
