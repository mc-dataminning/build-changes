...
public class esu {
   ...
   public void a(eue $$0, String $$1, eva.a $$2, eis $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  esu.b $$13 = new esu.b($$1.trim(), this.f, $$3, $$2);
                  esu.a $$14 = new esu.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        esu.c $$30 = new esu.c(this.f, $$2, $$0);
                        esu.a $$31 = new esu.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eui(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eis $$2) throws IOException {
      ...
      File $$15 = new File(exo.P().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eis d;
      private final eva.a e;

      b(String $$0, File $$1, eis $$2, eva.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((esu.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !esu.this.b && !esu.this.d) {
            try {
               esu.this.e = true;
               esu.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               esu.a.error("Error extracting archive", var3);
               esu.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eva.a c;
      private final eue d;

      c(File $$0, eva.a $$1, eue $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((esu.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !esu.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, esu.this.g);
                  esu.this.c = true;
               } else {
                  esu.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  esu.this.d = true;
               }
            } catch (IOException var3) {
               esu.a.error("Error copying resourcepack file: {}", var3.getMessage());
               esu.this.d = true;
            }
         }
      }
