...
public class esu extends eso<esu.a> {
   protected esu(dzg $$0) {
      super(dgs.a, $$0, new esu.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dyy g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kk.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dyy(15) : new dyy();
         }
      }
   }

   private static dyy a(dyy $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends esl<esu.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dyy> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public esu.a a() {
         return new esu.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
