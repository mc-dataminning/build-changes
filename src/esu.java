...
public class esu {
   ...
   public Optional<jh> a(jh $$0, boolean $$1, dxl $$2) {
      cgl $$3 = this.n.z();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cgp.r), $$0, $$4, cgl.b.c)
         .map(cgm::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dwl.H))
   ...
   public Optional<l.a> a(jh $$0, jm.a $$1) {
      ...
      jh $$6 = null;
      dxl $$7 = this.n.E_();
      int $$8 = Math.min(this.n.al(), this.n.K_() + this.n.l() - 1);
      int $$9 = 1;
      jh.a $$10 = $$0.k();

      for (jh.a $$11 : jh.a($$0, 16, jm.f, jm.d)) {
         int $$12 = Math.min($$8, this.n.a(ebq.a.e, $$11.u(), $$11.w()));
         if ($$7.a($$11) && $$7.a($$11.c($$2, 1))) {
            ...
            for (int $$13 = $$12; $$13 >= this.n.K_(); $$13--) {
               ...
               if (this.a($$11)) {
                  ...
                  while ($$13 > this.n.K_() && this.a($$11.c(jm.a))) {
                     $$13--;
                  }
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new jh($$0.u() - $$2.j() * 1, azm.a($$0.v(), $$17, $$18), $$0.w() - $$2.l() * 1).j();
         $$4 = $$7.b($$4);
         jm $$19 = $$2.h();
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dis.co.m(), 3);
            }
         }
      }

      dvv $$26 = dis.ed.m().b(dnt.b, $$1);
