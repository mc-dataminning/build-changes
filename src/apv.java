...
public class apv {
   ...
   private static void a(apz $$0, apa $$1, dol $$2) {
      $$0.b(new abu($$2, $$1.z_(), null, null));
      cvl $$3 = $$2.f();
      aes.a($$1, $$3);
   }

   private List<dol> a(aok $$0, cvl $$1) {
      int $$2 = awm.d(this.i);
      List<dol> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : awm.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
