...
public interface apv {
   apv a = new apv() {
      ...
      @Override
      public void a(Consumer<czk> $$0) {
      }
   };

   static apv a(czk $$0, int $$1) {
      return new apv.a($$0, $$1);
   }

   static void a(apv $$0, apv $$1, Consumer<czk> $$2, Consumer<czk> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof apv.a $$4 && $$1 instanceof apv.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new czk($$10, $$11));
                     } else {
                        $$3.accept(new czk($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(czk b, int c) implements apv {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(apv.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return apv.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
