...
public class fiq implements fjg {
   ...
   private CompletableFuture<Optional<cbw>> g;
   private Instant h = Instant.EPOCH;

   public fiq(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
      this.f = $$2.resolve(d).resolve($$1 + ".json");
      this.g = CompletableFuture.<Optional<cbw>>supplyAsync(() -> this.c().filter($$0x -> !$$0x.c().b().a()), ac.f()).thenCompose(this::a);
   }
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cbw::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cbw>> a(Optional<cbw> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (aqx | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cbw.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cbw $$0) {
      ...
      if ($$0 != null) {
         if (aa.aT) {
            cbw.a.encodeStart(JsonOps.INSTANCE, $$0).result().ifPresent($$0x -> {
               try {
   ...
   private cbw a(UserApiService $$0) throws aqx, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cbx.a $$2 = a($$1);
         return new cbw(aqw.a($$1.keyPair().privateKey()), new cbx($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cbx.a a(KeyPairResponse $$0) throws aqx {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = aqw.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cbx.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new aqx(var5);
         }
      } else {
         throw new aqx(new MissingException());
      }
   }
}
