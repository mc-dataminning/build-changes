...
public class fiq implements fjg {
   ...
   private CompletableFuture<Optional<cbw>> a(Optional<cbw> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (aqy | MinecraftClientException | IOException var3) {
   ...
   private cbw a(UserApiService $$0) throws aqy, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cbx.a $$2 = a($$1);
         return new cbw(aqx.a($$1.keyPair().privateKey()), new cbx($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cbx.a a(KeyPairResponse $$0) throws aqy {
      KeyPair $$1 = $$0.keyPair();
      if (!Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         ...
         throw new aqy(new MissingException());
      }
   }
}
