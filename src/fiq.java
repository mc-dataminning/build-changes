public class fiq extends fkc<cbe> {
   public fiq(fmp $$0) {
      super($$0);
   }
   ...
   public static fmv a(fmt $$0) {
      fmx $$1 = fkc.a($$0, 0.0F);
      fmy $$2 = $$1.a();
      $$2.a("head", fmu.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fmr.a(0.0F, 1.0F, 0.0F));
      $$2.a("hat", fmu.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), fmr.a(0.0F, 1.0F, 0.0F));
      $$2.a("right_leg", fmu.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0.a(-0.1F)), fmr.a(-1.9F, 11.0F, 0.0F));
      $$2.a("left_leg", fmu.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0.a(-0.1F)), fmr.a(1.9F, 11.0F, 0.0F));
