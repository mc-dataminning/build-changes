...
public record ai(Optional<alr> c, Optional<av> d, an e, Map<String, ar<?>> f, am g, boolean h, Optional<xg> i) {
   ...
   public static final Codec<ai> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  alr.a.optionalFieldOf("parent").forGetter(ai::b),
      ...
      .validate(ai::a);
   public static final ze<wp, ai> b = ze.a(ai::a, ai::b);

   public ai(Optional<alr> $$0, Optional<av> $$1, an $$2, Map<String, ar<?>> $$3, am $$4, boolean $$5) {
   ...
   private static xg a(av $$0) {
      xg $$1 = $$0.a();
      o $$2 = $$0.e().a();
      xg $$3 = xj.a($$1.f(), yd.a.a($$2)).f("\n").b($$0.b());
      xg $$4 = $$1.f().a($$1x -> $$1x.a(new xm.e($$3)));
      return xj.a($$4).a($$2);
   }

   public static xg a(aj $$0) {
      return $$0.b().h().orElseGet(() -> xg.b($$0.a().toString()));
   }

   private void a(wp $$0) {
      $$0.a(this.c, vy::a);
      av.b.a(zc::a).encode($$0, this.d);
      this.g.a($$0);
      $$0.a(this.h);
   }

   private static ai b(wp $$0) {
      return new ai($$0.b(vy::q), (Optional<av>)av.b.a(zc::a).decode($$0), an.b, Map.of(), new am($$0), $$0.readBoolean());
   }
   ...
   public static class a {
      ...
      public ai.a a(dak $$0, xg $$1, xg $$2, @Nullable alr $$3, ap $$4, boolean $$5, boolean $$6, boolean $$7) {
         return this.a(new av($$0, $$1, $$2, Optional.ofNullable($$3).map(ix::new), $$4, $$5, $$6, $$7));
      }

      public ai.a a(dki $$0, xg $$1, xg $$2, @Nullable alr $$3, ap $$4, boolean $$5, boolean $$6, boolean $$7) {
         return this.a(new av(new dak($$0.h()), $$1, $$2, Optional.ofNullable($$3).map(ix::new), $$4, $$5, $$6, $$7));
      }
