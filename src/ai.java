...
public class ai {
   ...
   public static final cc b = a(new cc(new acq("player_killed_entity")));
   public static final cc c = a(new cc(new acq("entity_killed_player")));
   ...
   public static final cq p = a(new cq(new acq("location")));
   public static final cq q = a(new cq(new acq("slept_in_bed")));
   ...
   public static final cq w = a(new cq(new acq("tick")));
   public static final dc x = a(new dc());
   public static final ca y = a(new ca(new acq("placed_block")));
   public static final az z = a(new az());
   public static final bh A = a(new bh());
   public static final dg B = a(new dg());
   public static final bg C = a(new bg(new acq("nether_travel")));
   ...
   public static final cq H = a(new cq(new acq("hero_of_the_village")));
   public static final cq I = a(new cq(new acq("voluntary_exile")));
   public static final cw J = a(new cw());
   public static final as K = a(new as());
   public static final dd L = a(new dd());
   public static final ca M = a(new ca(new acq("item_used_on_block")));
   public static final ci N = a(new ci());
   public static final cm O = a(new cm(new acq("thrown_item_picked_up_by_entity")));
   public static final cm P = a(new cm(new acq("thrown_item_picked_up_by_player")));
   ...
   public static final bg U = a(new bg(new acq("fall_from_height")));
   public static final bg V = a(new bg(new acq("ride_entity_in_lava")));
   public static final cc W = a(new cc(new acq("kill_mob_near_sculk_catalyst")));
   public static final ca X = a(new ca(new acq("allay_drop_item_on_block")));
   public static final cq Y = a(new cq(new acq("avoid_vibration")));
