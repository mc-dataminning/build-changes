...
public class sl extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<rn> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, rd.a);
   }

   @Deprecated
   public <T> T a(DynamicOps<rn> $$0, Codec<T> $$1, rd $$2) {
      rn $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> sl a(DynamicOps<rn> $$0, Codec<T> $$1, T $$2) {
      rn $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = arj.a(h, this.r(), JsonElement.class);
   ...
   public <T> void a(hl<hg<T>> $$0, hg<T> $$1, sl.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> hg<T> a(hl<hg<T>> $$0, sl.a<T> $$1) {
      int $$2 = this.m();
      if ($$2 == 0) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, sl.a<T> $$1) {
      int $$2 = this.m();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, sl.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, sl.a<K> $$1, sl.a<V> $$2) {
      int $$3 = this.m();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(sl.a<K> $$0, sl.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, sl.b<K> $$1, sl.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, sl.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, sl.b<L> $$1, sl.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(sl.a<L> $$0, sl.a<R> $$1) {
   ...
   public ehi k() {
      return new ehi(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> sl a(ToIntFunction<T> $$0, T $$1) {
   ...
   public sl a(@Nullable rn $$0) {
      if ($$0 == null) {
         $$0 = qw.b;
      }

      try {
         re.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   @Nullable
   public qu p() {
      rn $$0 = this.a(new rd(2097152L));
      if ($$0 != null && !($$0 instanceof qu)) {
   ...
   public rn a(rd $$0) {
      try {
         rn $$1 = re.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public sl a(String $$0, int $$1) {
      sy.a(this.d, $$0, $$1);
      return this;
   }

   public aeu s() {
      return new aeu(this.d(32767));
   }
   ...
   public <T> aet<T> a(aet<? extends ht<T>> $$0) {
      aeu $$1 = this.s();
      return aet.a($$0, $$1);
   }
   ...
   public ehe x() {
      ...
      return new ehe(new ehi((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ars.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), sl::a);
   }

   public Property B() {
      String $$0 = this.r();
      String $$1 = this.r();
      String $$2 = this.c(sl::r);
   ...
   public sl a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sl a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public sl a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sl a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sl a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sl a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public sl a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public sl a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public sl b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public sl c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public sl d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public sl e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public sl f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public sl g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public sl h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public sl a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public sl b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public sl i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public sl a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public sl a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public sl b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sl b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public sl b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sl b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public sl b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public sl b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public sl a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sl a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public sl a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sl a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public sl a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public sl a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public sl a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public sl b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public sl b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public sl b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public sl b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public sl b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
   ...
   @FunctionalInterface
   public interface a<T> extends Function<sl, T> {
      default sl.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<sl, T> {
      default sl.b<Optional<T>> asOptional() {
