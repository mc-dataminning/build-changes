...
public class cqb extends cou {
   ...
   public cqb(vq $$0, vq $$1, vq $$2, vq $$3, vq $$4, List<aiy> $$5, List<aiy> $$6) {
      super(new cou.a());
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static cqb a(aix<crd> $$0) {
      return a($$0.a());
   }

   public static cqb a(aiy $$0) {
      return new cqb(f, g, vq.c(ac.a("trim_pattern", $$0)).a(a), h, i, A(), B());
   }

   public static cqb h() {
      return new cqb(j, k, e, r, s, C(), D());
   }
