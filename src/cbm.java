...
public class cbm<T extends ckd & ckh> extends cam {
   private final T a;
   ...
   public cbm(T $$0, double $$1, int $$2, float $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3 * $$3;
   ...
   protected boolean h() {
      return this.a.b(cut.ov);
   }

   @Override
   public boolean c() {
      return (this.b() || !this.a.N().l()) && this.h();
   }
