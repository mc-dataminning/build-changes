...
public abstract class cbm extends blv {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<blv> b = $$0 -> $$0 instanceof cbm;
   private int f;
   protected hx c;
   protected ic d;

   protected cbm(blz<? extends cbm> $$0, ctp $$1) {
      super($$0, $$1);
      this.d = ic.d;
   }

   protected cbm(blz<? extends cbm> $$0, ctp $$1, hx $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void z() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new elo($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable blv var1);
