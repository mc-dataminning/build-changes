...
public abstract class cbm extends biy {
   ...
   private static final adz<Float> e = aec.a(cbm.class, aeb.d);
   private static final adz<Integer> f = aec.a(cbm.class, aeb.b);
   protected static final adz<Byte> bK = aec.a(cbm.class, aeb.a);
   protected static final adz<Byte> bL = aec.a(cbm.class, aeb.a);
   protected static final adz<qr> bM = aec.a(cbm.class, aeb.s);
   protected static final adz<qr> bN = aec.a(cbm.class, aeb.s);
   private long ck;
   private final cbl cl = new cbl(this);
   protected cfm bO = new cfm();
   public final cfc bP;
   public ced bQ;
   protected cdz bR = new cdz();
   protected int bS;
   public float bT;
   public float bU;
   public int bV;
   ...
   private boolean cq;
   private cix cr = cix.b;
   private final cit cs = this.k();
   private Optional<hd> ct = Optional.empty();
   @Nullable
   public cca ci;
   protected float cj;

   public cbm(cpl $$0, gu $$1, float $$2, GameProfile $$3) {
      super(bim.bt, $$0);
      this.a_($$3.getId());
      this.cp = $$3;
      this.bP = new cfc(this.cl, !$$0.B, this);
      this.bQ = this.bP;
      this.b((double)$$1.u() + 0.5, (double)($$1.v() + 1), (double)$$1.w() + 0.5, $$2, 0.0F);
      this.bg = 180.0F;
   }

   public boolean a(cpl $$0, gu $$1, cpi $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == cpi.d) {
         return true;
         ...
         cix $$3 = this.eR();
         return $$3.b() || !$$3.b($$0.B_().d(jc.e), new dfd($$0, $$1, false));
      }
   }

   public static bkd.a fF() {
      return biy.dO().a(bke.f, 1.0).a(bke.d, 0.1F).a(bke.h).a(bke.k);
   }
   ...
   public void b_() {
      ...
      if (this.dK().ai() == bgn.a && this.dK().X().b(cph.j)) {
   ...
   private void c(@Nullable qr $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dK().z.a(200) == 0) {
         ...
         bim.a($$1).filter($$0x -> $$0x == bim.at).ifPresent($$0x -> {
            if (!buz.a(this.dK(), this)) {
               this.dK().a(null, this.dp(), this.dr(), this.dv(), buz.a(this.dK(), this.dK().z), this.da(), 1.0F, buz.a(this.dK().z));
            }
         });
      }
   }
   ...
   public void a(bhg $$0) {
      ...
      if ($$0 != null) {
         this.o(
            (double)(-arp.b((this.eC() + this.dA()) * (float) (Math.PI / 180.0)) * 0.1F),
            0.1F,
            (double)(-arp.a((this.eC() + this.dA()) * (float) (Math.PI / 180.0)) * 0.1F)
         );
      } else {
         this.o(0.0, 0.1, 0.0);
      }
   ...
   @Nullable
   public byf a(cix $$0, boolean $$1) {
      return this.a($$0, false, $$1);
   }

   @Nullable
   public byf a(cix $$0, boolean $$1, boolean $$2) {
      if ($$0.b()) {
         return null;
      } else {
         if (this.dK().B) {
         ...
         byf $$4 = new byf(this.dK(), this.dp(), $$3, this.dv(), $$0);
         $$4.b(40);
         if ($$2) {
            $$4.c(this.cv());
         }
   ...
   public void a(qr $$0) {
      ...
      this.bR.a($$0);
      this.cn.b($$0);
      this.a(bke.d).a((double)this.cn.b());
      if ($$0.b("EnderItems", 9)) {
   ...
   public boolean b(bhg $$0) {
      if (super.b($$0)) {
         ...
         return !this.dK().X().b(cph.C);
      } else if ($$0.a(apn.m)) {
         return !this.dK().X().b(cph.D);
      } else if ($$0.a(apn.i)) {
         return !this.dK().X().b(cph.E);
      } else {
         return $$0.a(apn.o) ? !this.dK().X().b(cph.F) : false;
      }
   }
   ...
   public void a(int $$0, coj $$1, int $$2, int $$3, boolean $$4, boolean $$5) {
   }
      ...
      if (this.G_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.b() && $$0 instanceof biy) {
               ...
               if ($$5.a()) {
                  this.dK().a(djj.r, $$0.di(), djj.a.a(this));
                  if ($$2.b() && !this.cn.d) {
                     this.a($$1, cix.b);
                  }
   ...
   public void d(bii $$0) {
      if ($$0.cp()) {
         if (!$$0.u(this)) {
            ...
            float $$2;
            if ($$0 instanceof biy) {
               $$2 = cng.a(this.eR(), ((biy)$$0).eQ());
            } else {
               $$2 = cng.a(this.eR(), bjd.a);
            }
            ...
            if ($$1 > 0.0F || $$2 > 0.0F) {
               ...
               if ($$16) {
                  ...
                  if ($$9) {
                     float $$17 = 1.0F + cng.a(this) * $$1;

                     for (biy $$19 : this.dK().a(biy.class, $$0.cG().c(1.0, 0.25, 1.0))) {
                        if ($$19 != this && $$19 != $$0 && !this.s($$19) && (!($$19 instanceof bxv) || !((bxv)$$19).t()) && this.f($$19) < 9.0) {
   ...
   public void s(boolean $$0) {
      float $$1 = 0.25F + (float)cng.g(this) * 0.05F;
      if ($$0) {
         $$1 += 0.75F;
      }

      if (this.ag.i() < $$1) {
         this.gl().a(cja.uy, 100);
         this.fr();
   ...
   public Either<cbm.a, asp> a(gu $$0) {
      this.b($$0);
      this.cm = 0;
   ...
   public static Optional<ehd> a(akk $$0, gu $$1, float $$2, boolean $$3, boolean $$4) {
      dez $$5 = $$0.a_($$1);
      csl $$6 = $$5.b();
      if ($$6 instanceof cys && ($$3 || $$5.c(cys.c) > 0) && cys.a($$0)) {
         Optional<ehd> $$7 = cys.a(bim.bt, $$0, $$1);
         if (!$$3 && !$$4 && $$7.isPresent()) {
            $$0.a($$1, $$5.a(cys.c, Integer.valueOf($$5.c(cys.c) - 1)), 3);
         }

         return $$7;
      } else if ($$6 instanceof cse && cse.a($$0)) {
         return cse.a(bim.bt, $$0, $$1, $$5.c(cse.aC), $$2);
      } else if (!$$3) {
         ...
         dez $$9 = $$0.a_($$1.c());
         boolean $$10 = $$9.b().a($$9);
         return $$8 && $$10 ? Optional.of(new ehd((double)$$1.u() + 0.5, (double)$$1.v() + 0.1, (double)$$1.w() + 0.5)) : Optional.empty();
      }
   }
   ...
   public int a(Collection<cma<?>> $$0) {
      return 0;
   }

   public void a(cma<?> $$0, List<cix> $$1) {
   }

   public void a(aer[] $$0) {
   }

   public int b(Collection<cma<?>> $$0) {
      return 0;
   }
      ...
      if (this.bN()) {
         ...
         if ($$3 > 0) {
            ...
            if ($$4 instanceof cdd) {
               ...
               this.a(apg.y, $$3);
            } else if ($$4 instanceof bva) {
               this.a(apg.z, $$3);
            } else if ($$4 instanceof bwi) {
               this.a(apg.A, $$3);
            } else if ($$4 instanceof bzn) {
               this.a(apg.D, $$3);
            }
         }
      }
   ...
   public boolean a(gu $$0, ha $$1, cix $$2) {
      if (this.cn.e) {
         return true;
      } else {
         gu $$3 = $$0.a($$1.g());
         dfd $$4 = new dfd(this.dK(), $$3, false);
   ...
   public cix c(bin $$0) {
      if ($$0 == bin.a) {
         ...
         return $$0.a() == bin.a.b ? this.cl.j.get($$0.b()) : cix.b;
      }
   }
   ...
   public Iterable<cix> bJ() {
      return Lists.newArrayList(new cix[]{this.eR(), this.eS()});
   }
   ...
   public bjq a_(int $$0) {
      if ($$0 >= 0 && $$0 < this.cl.i.size()) {
         return bjq.a(this.cl, $$0);
      } else {
         int $$1 = $$0 - 200;
         return $$1 >= 0 && $$1 < this.bO.b() ? bjq.a(this.bO, $$1) : super.a_($$0);
      }
   }
   ...
   public float gj() {
      return (float)(1.0 / this.b(bke.h) * 20.0);
   }
   ...
   public cix g(cix $$0) {
      if (!($$0.d() instanceof cjn)) {
         ...
         if (!$$2.b()) {
            ...
            return this.cn.d ? new cix(cja.nH) : cix.b;
         }
      }
   }
   ...
   public ehd q(float $$0) {
      ...
      if (this.fu() || this.fh()) {
         ...
         return this.l($$0).e(new ehd($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.bZ()) {
         return this.l($$0).e(new ehd($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cG().c() - 1.0;
         double $$13 = this.bW() ? -0.2 : 0.07;
         return this.l($$0).e(new ehd($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean go() {
      return this.fl() && this.fn().a(cja.qj);
   }
