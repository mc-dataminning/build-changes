...
public class ews {
   ...
   public static final ews.a bv;

   public static ews.a a(int $$0, int $$1) {
      return $$0 == -1 ? ews.b.b.a($$1) : ews.b.a.a($$0);
   }

   public static ews.a a(String $$0) {
      if (ews.a.e.containsKey($$0)) {
         return ews.a.e.get($$0);
      } else {
         for (ews.b $$1 : ews.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final int c;
      private final axu<wu> d;
      static final Map<String, ews.a> e = Maps.newHashMap();

      a(String $$0, ews.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new axu<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> tv.a().b($$1) ? wu.c($$1) : wu.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ews.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wu> g;

      private static void a(ews.b $$0, String $$1, int $$2) {
         ews.a $$3 = new ews.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, wu> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ews.a a(int $$0) {
         return (ews.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
