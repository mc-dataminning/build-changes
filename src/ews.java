public abstract class ews extends eww implements eyb, eyt {
   private static final eyl a = new eyl(new ahd("widget/text_field"), new ahd("widget/text_field_highlighted"));
   private static final ahd b = new ahd("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public ews(int $$0, int $$1, int $$2, int $$3, vd $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return aui.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = aui.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(ewm $$0, int $$1, int $$2, int $$3, int $$4) {
      ahd $$5 = a.a(this.A(), this.aI_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(ewm var1, int var2, int var3, float var4);
}
