...
public class ews {
   ...
   public ews(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ewt> $$1) throws IOException {
   ...
   public List<ewt> a(Path $$0) throws IOException {
      List<ewt> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ewt> a(Path $$0, boolean $$1) throws IOException {
      List<ewt> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ewt> $$1) throws IOException {
