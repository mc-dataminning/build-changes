...
public class ews {
   ...
   private static final Comparator<emp> K = Comparator.comparing(emp::d).reversed().thenComparing(emp::c, String.CASE_INSENSITIVE_ORDER);
   ...
   public float a = 1.0F;
   private int af;
   private cmx ag = cmx.f;
   private final exn ah;
   private final eyn ai;
   private final ezd aj;
   private final eyg ak;
   private final exe al;
   private int am;
   @Nullable
   private vf an;
   @Nullable
   ...
   public ews(evh $$0, fzk $$1) {
      this.X = $$0;
      this.Y = $$1;
      this.ah = new exn($$0);
      this.aj = new ezd($$0);
      this.Z = new exg($$0);
      this.ak = new eyg($$0, this);
      this.al = new exe($$0);
      this.ai = new eyn($$0);
      this.a();
   }
   ...
   public void a(ewt $$0, float $$1) {
      ...
      float $$4 = this.X.at();
      this.aA = aun.i(0.5F * $$4, this.aA, 1.125F);
      if (this.X.m.ax().a()) {
         if (this.X.s.gq()) {
            this.b($$0, this.aA);
         } else {
            this.aA = 0.5F;
            cmx $$5 = this.X.s.fS().e(3);
            if ($$5.a(cwr.ee.k())) {
               this.a($$0, H, 1.0F);
            }
         }
      ...
      float $$6 = aun.i($$1, this.X.s.cx, this.X.s.cw);
      if ($$6 > 0.0F && !this.X.s.a(blj.i)) {
         this.c($$0, $$6);
      }
      ...
      if (this.X.s.fW() > 0) {
         ...
         $$0.a(fto.C(), 0, 0, this.aw, this.ax, $$11);
         this.X.aG().c();
      }
      ...
      if (!this.X.m.Z) {
         if (this.ab != null && this.ac > 0) {
            ...
            if ($$13 > 8) {
               ...
               int $$14 = 16777215;
               if (this.ad) {
                  $$14 = aun.h($$12 / 50.0F, 0.7F, 0.6F) & 16777215;
               }
         ...
         emo $$27 = $$24 != null ? $$24 : $$23.a(emn.b);
         if ($$27 != null) {
            this.a($$0, $$27);
         }

         RenderSystem.enableBlend();
         int $$28 = aun.a(this.X.n.e() * (double)$$2.o() / (double)$$2.m());
         int $$29 = aun.a(this.X.n.f() * (double)$$2.p() / (double)$$2.n());
         this.X.aG().a("chat");
   ...
   private void a(ewt $$0, ewr $$1, int $$2, int $$3, int $$4) {
      int $$5 = this.X.m.b(0.0F);
      if ($$5 != 0) {
         int $$6 = -$$3 / 2;
         $$0.a($$6 - 2, $$2 - 2, $$6 + $$3 + 2, $$2 + 9 + 2, atx.b.a($$5, $$4));
      }
   }

   private void d(ewt $$0) {
      evl $$1 = this.X.m;
      if ($$1.ax().a()) {
         if (this.X.q.l() != ctl.d || this.a(this.X.v)) {
            if (this.ah.d() && !this.X.s.gi() && !$$1.S().c()) {
               eus $$2 = this.X.j.m();
               eqa $$3 = RenderSystem.getModelViewStack();
               $$3.a();
               $$3.a($$0.c().c().a());
               ...
               if (this.X.m.B().c() == eur.b) {
                  float $$5 = this.X.s.B(0.0F);
                  boolean $$6 = false;
                  if (this.X.u != null && this.X.u instanceof bmk && $$5 >= 1.0F) {
                     $$6 = this.X.s.gl() > 5.0F;
                     $$6 &= this.X.u.bx();
                  }
   ...
   private boolean a(@Nullable elq $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == elq.a.c) {
         return ((elp)$$0).a() instanceof bkd;
      } else if ($$0.c() == elq.a.b) {
         hx $$1 = ((elo)$$0).a();
         cto $$2 = this.X.r;
   ...
   protected void a(ewt $$0) {
      Collection<blh> $$1 = this.X.s.es();
      if (!$$1.isEmpty()) {
         if (this.X.y instanceof fer $$2 && $$2.J()) {
            return;
         }
         ...
         for (blh $$7 : Ordering.natural().reverse().sortedCopy($$1)) {
            blf $$8 = $$7.c();
            if ($$7.h()) {
               int $$9 = this.aw;
               int $$10 = 1;
               ...
               if ($$7.f()) {
                  ...
                  if ($$7.a(200)) {
                     int $$12 = $$7.d();
                     int $$13 = 10 - $$12 / 20;
                     $$11 = aun.a((float)$$12 / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F)
                        + aun.b((float)$$12 * (float) Math.PI / 5.0F) * aun.a((float)$$13 / 10.0F * 0.25F, 0.0F, 0.25F);
                  }
               }
   ...
   public void a(bmv $$0, ewt $$1, int $$2) {
      this.X.aG().a("jumpBar");
      float $$3 = this.X.s.u();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   public void c(ewt $$0) {
      ...
      if (this.X.r.X() >= 120500L) {
         ...
         $$1 = vf.a("demo.remainingTime", avk.a((int)(120500L - this.X.r.X()), this.X.r.s().f()));
      }
   ...
   @Nullable
   private cfh m() {
      return this.X.am() instanceof cfh $$0 ? $$0 : null;
   }
   ...
   private void e(ewt $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$9 = this.aw / 2 + 91;
         int $$10 = this.ax - 39;
         float $$11 = Math.max((float)$$1.b(bnq.l), (float)Math.max($$5, $$2));
         int $$12 = aun.f($$1.fk());
         int $$13 = aun.f(($$11 + (float)$$12) / 2.0F / 10.0F);
         ...
         if ($$1.a(asl.a) || $$33 < $$32) {
            int $$34 = this.a($$22) - 1;
            $$16 -= $$34 * 10;
            int $$35 = aun.c((double)($$33 - 2) * 10.0 / (double)$$32);
            int $$36 = aun.c((double)$$33 * 10.0 / (double)$$32) - $$35;
   ...
   private void a(ewt $$0, cfh $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      ews.b $$11 = ews.b.a($$1);
      boolean $$12 = $$1.dM().B_().n();
      int $$13 = aun.c((double)$$6 / 2.0);
      int $$14 = aun.c((double)$$9 / 2.0);
      int $$15 = $$13 * 2;
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, ews.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == ews.b.d ? $$11 : ews.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(ewt $$0, ews.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void f(ewt $$0) {
      bmk $$1 = this.n();
      if ($$1 != null) {
         int $$2 = this.a($$1);
         if ($$2 != 0) {
   ...
   private void a(ewt $$0, ahg $$1, float $$2) {
   ...
   private void b(ewt $$0, float $$1) {
      ...
      $$0.a(fto.C(), 0, $$10, this.aw, this.ax, -90, -16777216);
      $$0.a(fto.C(), 0, 0, this.aw, $$8, -90, -16777216);
      $$0.a(fto.C(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(fto.C(), $$9, $$8, this.aw, $$10, -90, -16777216);
   }

   private void a(blu $$0) {
      hx $$1 = hx.a($$0.dr(), $$0.dv(), $$0.dx());
      float $$2 = ftf.a($$0.dM().E_(), $$0.dM().A($$1));
      float $$3 = aun.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(ewt $$0, @Nullable blu $$1) {
      dkx $$2 = this.X.r.D_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(ewt $$0, int $$1, int $$2, float $$3, cfh $$4, cmx $$5, int $$6) {
      if (!$$5.b()) {
         float $$7 = (float)$$5.K() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
   ...
   private void p() {
      ...
      this.az = this.ay;
      this.ay = aun.i(0.2F, this.ay, $$1 ? 1.0F : 0.0F);
   }
   ...
   private void g(ewt $$0) {
      if (this.X.m.ac().c() && (this.ay > 0.0F || this.az > 0.0F)) {
         int $$1 = aun.d(255.0F * aun.a(aun.i(this.X.as(), this.az, this.ay), 0.0F, 1.0F));
         if ($$1 > 8) {
            ewr $$2 = this.f();
            int $$3 = $$2.a(M);
