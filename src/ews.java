...
public class ews implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ews.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ews(List<ews.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ews a(BufferedReader $$0) {
      return new ews($$0.lines().flatMap($$0x -> ews.a.a($$0x).stream()).toList());
   }

   public static record a(ews.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ews.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ews.a(ews.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ews.a(ews.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ews.a(ews.b.b, $$3));
      ...
      static ews.a b(String $$0) {
         return new ews.a(ews.b.a, "glob:" + $$0);
      }

      static ews.a c(String $$0) {
         return new ews.a(ews.b.a, "regex:" + $$0);
      }

      static ews.a d(String $$0) {
         return new ews.a(ews.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ews.b a = FileSystem::getPathMatcher;
      ews.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
