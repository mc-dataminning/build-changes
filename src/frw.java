...
public class frw extends frv implements vi, zv {
   private static final Logger i = LogUtils.getLogger();
   private final GameProfile j;
   private clf k;
   private final iz.b l;
   private final fsl m = new fsl();
   @Nullable
   private fse n;

   public frw(ezg $$0, us $$1, fsc $$2) {
      super($$0, $$1, $$2);
      this.j = $$2.a();
      this.l = $$2.c();
      this.k = $$2.d();
   ...
   public void a(zw $$0) {
      ...
      this.b.a(aey.b.bind(vf.a($$1)), new frz(this.a, this.b, new fsc(this.j, this.e, $$1, this.k, this.d, this.c, this.f, this.h)));
      this.b.a(aad.a);
