...
public class gda implements gdt {
   ...
   private CompletableFuture<Optional<cow>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gda(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cow::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cow>> a(Optional<cow> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (ayl | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cow.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cow $$0) {
      ...
      if ($$0 != null) {
         if (ab.aU) {
            cow.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cow a(UserApiService $$0) throws ayl, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cox.a $$2 = a($$1);
         return new cow(ayk.a($$1.keyPair().privateKey()), new cox($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cox.a a(KeyPairResponse $$0) throws ayl {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = ayk.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cox.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new ayl(var5);
         }
      } else {
         throw new ayl(new MissingException("Missing public key"));
      }
   }
}
