...
public class gda {
   ...
   public static class a extends Thread {
      private final gda.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gda.b $$0) throws IOException {
         super("LanServerDetector #" + gda.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gda.b));
   ...
   public static class b {
      private final List<gcz> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gcz> a() {
         if (this.b) {
            List<gcz> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
