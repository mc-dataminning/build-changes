...
public class fyq {
   ...
   public final Map<ih, fyr> c;
   public final fys d;
   public final boolean e;

   public fyq(Vector3f $$0, Vector3f $$1, Map<ih, fyr> $$2, @Nullable fys $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ih, fyr> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fyq> {
      private static final boolean a = true;

      public fyq a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         fys $$6 = this.a($$3);
         Map<ih, fyr> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !awm.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = awm.a($$3, "shade", true);
            return new fyq($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fys a(JsonObject $$0) {
         fys $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<ih, fyr> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, fyr> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ih, fyr> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, fyr> $$2 = Maps.newEnumMap(ih.class);
         JsonObject $$3 = awm.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ih $$5 = this.a($$4.getKey());
            $$2.put($$5, (fyr)$$0.deserialize($$4.getValue(), fyr.class));
         }
