...
public class fyq extends fyn {
   ...
   private int J;
   private final ftm K = new ftm(false);

   public fyq(boolean $$0, Runnable $$1) {
      super(fpf.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(fsh $$0) {
      $$0.a(gqx::J, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
