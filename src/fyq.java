...
public class fyq implements fyw.a {
   ...
   private final exh A;
   private final Map<hz, fyq.a> B = new HashMap<>();
   private final Map<UUID, yu.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(zf.a $$0, long $$1) {
      this.B.put($$0.a(), new fyq.a($$0, $$1));
   }

   public void a(yu.a $$0) {
      this.C.put($$0.b(), $$0);
   }
   ...
   private void a(esa $$0, fvl $$1) {
      ...
      for (hz $$3 : this.B.keySet()) {
         if ($$2.a($$3, 30.0)) {
            a($$0, $$1, $$3);
         }
      }

      Map<hz, Set<UUID>> $$4 = this.d();
   ...
   private Map<hz, Set<UUID>> d() {
      Map<hz, Set<UUID>> $$0 = Maps.newHashMap();
      this.C.values().forEach($$1 -> $$1.j().forEach($$2 -> $$0.computeIfAbsent($$2, $$0xxx -> Sets.newHashSet()).add($$1.b())));
      return $$0;
   }

   private void b(esa $$0, fvl $$1) {
      Map<hz, Set<UUID>> $$2 = Maps.newHashMap();
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aeo::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         fyw.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aeo::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(esa $$0, fvl $$1, hz $$2) {
      float $$3 = 0.05F;
      fyw.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(esa $$0, fvl $$1, hz $$2, List<String> $$3) {
      float $$4 = 0.05F;
      fyw.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(esa $$0, fvl $$1, zf.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(esa $$0, fvl $$1, yu.a $$2) {
      if ($$2.e() != null) {
         fze.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(esa $$0, fvl $$1, yu.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(esa $$0, fvl $$1, String $$2, zf.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(esa $$0, fvl $$1, String $$2, hz $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      fyw.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(esa $$0, fvl $$1, it $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      hz $$9 = hz.a($$2);
      ...
      float $$13 = 0.5F;
      fyw.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(zf.a $$0) {
      return this.a($$0.a()).stream().map(aeo::a).collect(Collectors.toSet());
   }

   private String a(yu.a $$0, hz $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(yu.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(yu.a $$0) {
      chh $$1 = this.A.s;
      hz $$2 = hz.a($$1.dr(), $$0.d().b(), $$1.dx());
      hz $$3 = hz.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(hz $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(yu.a::b).collect(Collectors.toSet());
   }

   private Map<hz, List<String>> f() {
      Map<hz, List<String>> $$0 = Maps.newHashMap();

      for (yu.a $$1 : this.C.values()) {
   ...
   private void g() {
      fyw.a(this.A.am(), 8).ifPresent($$0 -> this.D = $$0.cw());
   }

   static record a(zf.a a, long b) {
   }
}
