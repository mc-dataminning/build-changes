...
public abstract class fyq<B extends ghd.a<?>> extends fuk {
   ...
   protected fyq(wo $$0, fuk $$1, ghh $$2, B $$3) {
      super($$0);
      this.x = $$1;
      this.y = $$2;
      this.A = $$3;
   ...
   protected void F() {
      ...
      $$0.a(fos.a(wn.k, $$0x -> this.aO_()).a(120).a());
   ...
   private void I() {
      this.M();
      this.m.a(ftw.a(E, C, wn.d, () -> this.m.a(null)));
   }
   ...
   private void a(wo $$0) {
      wo $$1 = $$0.f().a(n.m);
      this.m.a(ftw.a(F, $$1, wn.k, () -> this.m.a(this)));
   }
