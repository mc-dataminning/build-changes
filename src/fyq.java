...
public class fyq extends fzj<gwm> {
   private final gcl[] a;
   private final gcl b;
   ...
   public static gcr a() {
      gct $$0 = new gct();
      gcv $$1 = $$0.a();
      $$1.a("head", gcq.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), gcn.a);
      float $$2 = 0.0F;
      gcq $$3 = gcq.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = azm.b($$2) * 9.0F;
         float $$6 = -2.0F + azm.b((float)($$4 * 2) * 0.25F);
         float $$7 = azm.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, gcn.a($$5, $$6, $$7));
         $$2++;
      }
   ...
   public void a(gwm $$0) {
      ...
      for (int $$2 = 0; $$2 < 4; $$2++) {
         this.a[$$2].c = -2.0F + azm.b(((float)($$2 * 2) + $$0.p) * 0.25F);
      ...
      for (int $$3 = 4; $$3 < 8; $$3++) {
         this.a[$$3].c = 2.0F + azm.b(((float)($$3 * 2) + $$0.p) * 0.25F);
      ...
      for (int $$4 = 8; $$4 < 12; $$4++) {
         this.a[$$4].c = 11.0F + azm.b(((float)$$4 * 1.5F + $$0.p) * 0.5F);
