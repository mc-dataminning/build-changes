...
public class fyq {
   ...
   private fyq(int $$0, List<fys> $$1) {
      this.a = $$1.toArray(fys[]::new);
      this.b = $$1.size();
   }

   private List<fys> c() {
      List<fys> $$0 = new ArrayList<>(this.d());
