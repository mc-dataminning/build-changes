...
public interface aqy {
   aqy a = new aqy() {
      ...
      @Override
      public void a(Consumer<deh> $$0) {
      }
   };

   static aqy a(deh $$0, int $$1) {
      return new aqy.a($$0, $$1);
   }

   static void a(aqy $$0, aqy $$1, Consumer<deh> $$2, Consumer<deh> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqy.a $$4 && $$1 instanceof aqy.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new deh($$10, $$11));
                     } else {
                        $$3.accept(new deh($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(deh b, int c) implements aqy {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqy.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqy.a(this.b.g, this.b.h, this.c, $$0, $$1, $$2);
      }
