...
public class aqy {
   ...
   public static final Codec<tf> b = a(tf.a::a, tf.a::c);
   public static final Codec<tf> c = Codec.STRING.flatXmap($$0 -> {
      try {
         return DataResult.success(tf.a.a($$0));
   ...
   public static final Codec<Quaternionf> g = c(e, f.xmap(Quaternionf::new, AxisAngle4f::new));
   ...
   public static final Codec<aqy.e> o = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aer.b($$0.substring(1)).map($$0x -> new aqy.e($$0x, true)) : aer.b($$0).map($$0x -> new aqy.e($$0x, false)), aqy.e::c
      );
   ...
   private static final Codec<Property> x = RecordCodecBuilder.create(
      $$0 -> $$0.group(
   ...
   @VisibleForTesting
   public static final Codec<PropertyMap> s = Codec.either(Codec.unboundedMap(Codec.STRING, Codec.STRING.listOf()), x.listOf()).xmap($$0 -> {
   ...
   private static final MapCodec<GameProfile> y = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(hy.c.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
            .apply($$0, GameProfile::new)
   );
   public static final Codec<GameProfile> t = RecordCodecBuilder.create(
      $$0 -> $$0.group(y.forGetter(Function.identity()), s.optionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties))
            .apply($$0, ($$0x, $$1) -> {
   ...
   public static Codec<String> w = a(
      Codec.STRING, $$0 -> !aer.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <T> Codec<T> c(Codec<T> $$0, Codec<? extends T> $$1) {
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof aqy.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record e(aer a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
   ...
   static final class f<F, S> implements Codec<Either<F, S>> {
      private final Codec<F> a;
      private final Codec<S> b;

      public f(Codec<F> $$0, Codec<S> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
