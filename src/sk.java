...
public class sk {
   ...
   public <T extends dtz> T b(ji $$0) {
      dtz $$1 = this.a().c_(this.j($$0));
      if ($$1 == null) {
   ...
   public void a(Class $$0) {
      fav $$1 = this.j();
      List<bul> $$2 = this.a().a($$0, $$1.g(1.0), $$0x -> !($$0x instanceof cox));
      $$2.forEach($$0x -> $$0x.c(this.a()));
   }

   public clc a(cwl $$0, fba $$1) {
      ard $$2 = this.a();
      fba $$3 = this.a($$1);
      clc $$4 = new clc($$2, $$3.d, $$3.e, $$3.f, new cwp($$0, 1));
      $$4.n(0.0, 0.0, 0.0);
      $$2.b($$4);
      return $$4;
   }

   public clc a(cwl $$0, float $$1, float $$2, float $$3) {
      return this.a($$0, new fba((double)$$1, (double)$$2, (double)$$3));
   }

   public clc a(cwl $$0, ji $$1) {
      return this.a($$0, (float)$$1.u(), (float)$$1.v(), (float)$$1.w());
   }

   public <E extends bul> E a(bus<E> $$0, ji $$1) {
      return this.a($$0, fba.c($$1));
   }

   public <E extends bul> E a(bus<E> $$0, fba $$1) {
      ard $$2 = this.a();
      E $$3 = $$0.a($$2, bur.d);
      if ($$3 == null) {
   ...
   public <E extends bul> E a(bus<E> $$0, int $$1, int $$2, int $$3, double $$4) {
      ...
      if ($$5.isEmpty()) {
         ...
         fba $$6 = this.a(new fba((double)$$1, (double)$$2, (double)$$3));
         $$5.sort(($$1x, $$2x) -> {
            double $$3x = $$1x.dt().f($$6);
            double $$4x = $$2x.dt().f($$6);
   ...
   public <E extends bul> List<E> b(bus<E> $$0, int $$1, int $$2, int $$3, double $$4) {
      return this.a($$0, fba.c(new ji($$1, $$2, $$3)), $$4);
   }

   public <E extends bul> List<E> a(bus<E> $$0, fba $$1, double $$2) {
      ard $$3 = this.a();
      fba $$4 = this.a($$1);
      fav $$5 = this.a.e();
      fav $$6 = new fav($$4.b(-$$2, -$$2, -$$2), $$4.b($$2, $$2, $$2));
   ...
   public <E extends bvj> E b(bus<E> $$0, ji $$1) {
      E $$2 = (E)this.a($$0, $$1);
      $$2.gl();
      return $$2;
   }
   ...
   public <E extends bvj> E b(bus<E> $$0, fba $$1) {
      E $$2 = (E)this.a($$0, $$1);
      $$2.gl();
      return $$2;
   }
   ...
   public <E extends bvj> E b(bus<E> $$0, float $$1, float $$2, float $$3) {
      return this.b($$0, new fba((double)$$1, (double)$$2, (double)$$3));
   }

   public void a(bvj $$0, float $$1, float $$2, float $$3) {
      fba $$4 = this.a(new fba((double)$$1, (double)$$2, (double)$$3));
      $$0.b($$4.d, $$4.e, $$4.f, $$0.dL(), $$0.dN());
   }

   public sp a(bvj $$0, ji $$1, float $$2) {
      return this.g().a(2, () -> {
         etn $$3 = $$0.P().a(this.j($$1), 0);
         $$0.P().a($$3, (double)$$2);
      });
   }
   ...
   public void d(ji $$0) {
      this.a($$0, this.a(dgf.b));
   }

   public void a(ji $$0, cox $$1) {
      ji $$2 = this.j($$0);
      this.a($$0, $$1, new faw(fba.b($$2), jn.c, $$2, true));
   }

   public void a(ji $$0, cox $$1, faw $$2) {
      ji $$3 = this.j($$0);
      dwx $$4 = this.a().a_($$3);
      bsj $$5 = bsj.a;
   ...
   public cox a(final dgf $$0) {
      return new cox(this.a(), ji.c, 0.0F, new GameProfile(UUID.randomUUID(), "test-mock-player")) {
         @Override
         public boolean Z_() {
            return $$0 == dgf.d;
         }
   ...
   public void a(int $$0, int $$1, int $$2, djm $$3) {
      this.a(new ji($$0, $$1, $$2), $$3);
   }

   public void a(int $$0, int $$1, int $$2, dwx $$3) {
      this.a(new ji($$0, $$1, $$2), $$3);
   }
   ...
   public void a(djm $$0, int $$1, int $$2, int $$3) {
   ...
   public void b(djm $$0, int $$1, int $$2, int $$3) {
      this.b($$0, new ji($$1, $$2, $$3));
   }

   public void b(djm $$0, ji $$1) {
      this.a($$1, $$2 -> !this.a($$1).a($$0), "Did not expect " + $$0.f().getString());
   }

   public void c(djm $$0, int $$1, int $$2, int $$3) {
      this.c($$0, new ji($$1, $$2, $$3));
   }

   public void c(djm $$0, ji $$1) {
      this.b(() -> this.a($$0, $$1));
   }

   public void a(ji $$0, Predicate<djm> $$1, String $$2) {
      this.a($$0, $$1, () -> $$2);
   }

   public void a(ji $$0, Predicate<djm> $$1, Supplier<String> $$2) {
      this.b($$0, $$1x -> $$1.test($$1x.b()), $$2);
   }

   public <T extends Comparable<T>> void a(ji $$0, dxz<T> $$1, T $$2) {
      dwx $$3 = this.a($$0);
      boolean $$4 = $$3.b($$1);
   ...
   public <T extends Comparable<T>> void a(ji $$0, dxz<T> $$1, Predicate<T> $$2, String $$3) {
      this.b($$0, $$2x -> {
         if (!$$2x.b($$1)) {
            return false;
         } else {
   ...
   public void b(ji $$0, Predicate<dwx> $$1, Supplier<String> $$2) {
      dwx $$3 = this.a($$0);
      if (!$$1.test($$3)) {
   ...
   public <T extends dtz> void c(ji $$0, Predicate<T> $$1, Supplier<String> $$2) {
      T $$3 = this.b($$0);
      if (!$$1.test($$3)) {
         throw new se($$2.get(), this.j($$0), $$0, this.a.p());
      }
   ...
   public void c(bus<?> $$0, ji $$1) {
      ji $$2 = this.j($$1);
      List<? extends bul> $$3 = this.a().a($$0, new fav($$2), bul::bL);
      if ($$3.isEmpty()) {
         throw new se("Expected " + $$0.j(), $$2, $$1, this.a.p());
      }
   }

   public void a(bus<?> $$0, fav $$1) {
      fav $$2 = this.a($$1);
   ...
   public void a(bus<?> $$0, ji $$1, int $$2, double $$3) {
      ji $$4 = this.j($$1);
   ...
   public void a(bus<?> $$0, ji $$1, double $$2) {
   ...
   public <T extends bul> List<T> b(bus<T> $$0, ji $$1, double $$2) {
      ji $$3 = this.j($$1);
      return this.a().a($$0, new fav($$3).g($$2), bul::bL);
   }
   ...
   public void a(bul $$0, ji $$1) {
      ji $$2 = this.j($$1);
      List<? extends bul> $$3 = this.a().a($$0.aq(), new fav($$2), bul::bL);
      $$3.stream().filter($$1x -> $$1x == $$0).findFirst().orElseThrow(() -> new se("Expected " + $$0.aq().j(), $$2, $$1, this.a.p()));
   }

   public void a(cwl $$0, ji $$1, double $$2, int $$3) {
      ji $$4 = this.j($$1);
      List<clc> $$5 = this.a().a(bus.aq, new fav($$4).g($$2), bul::bL);
      int $$6 = 0;
   ...
   public void a(cwl $$0, ji $$1, double $$2) {
      ji $$3 = this.j($$1);

      for (bul $$5 : this.a().a(bus.aq, new fav($$3).g($$2), bul::bL)) {
         clc $$6 = (clc)$$5;
         if ($$6.l().h().equals($$0)) {
            return;
         }
   ...
   public void b(cwl $$0, ji $$1, double $$2) {
      ji $$3 = this.j($$1);
   ...
   public void a(cwl $$0) {
      for (bul $$2 : this.a().a(bus.aq, this.j(), bul::bL)) {
         clc $$3 = (clc)$$2;
         if ($$3.l().h().equals($$0)) {
            return;
         }
   ...
   public <E extends bul, T> void a(ji $$0, bus<E> $$1, Predicate<E> $$2) {
      ji $$3 = this.j($$0);
      List<E> $$4 = this.a().a($$1, new fav($$3), bul::bL);
      if ($$4.isEmpty()) {
   ...
   public <E extends bul, T> void a(ji $$0, bus<E> $$1, Function<? super E, T> $$2, @Nullable T $$3) {
      ji $$4 = this.j($$0);
      List<E> $$5 = this.a().a($$1, new fav($$4), bul::bL);
      if ($$5.isEmpty()) {
   ...
   public <E extends bvh> void a(ji $$0, bus<E> $$1, cwl $$2) {
      ji $$3 = this.j($$0);
      List<E> $$4 = this.a().a($$1, new fav($$3), bul::bL);
      if ($$4.isEmpty()) {
   ...
   public <E extends bul & cog> void b(ji $$0, bus<E> $$1, cwl $$2) {
      ji $$3 = this.j($$0);
      List<E> $$4 = this.a().a($$1, new fav($$3), $$0x -> ((bul)$$0x).bL());
      if ($$4.isEmpty()) {
   ...
   public void a(long $$0, ji $$1, cwl $$2) {
      this.a($$0, () -> this.a($$1, $$2));
   }
   ...
   public <E extends bul, T> void b(ji $$0, bus<E> $$1, Function<E, T> $$2, T $$3) {
      this.b(() -> this.a($$0, $$1, $$2, $$3));
   }

   public void a(bul $$0, fav $$1, String $$2) {
      if (!$$1.d(this.b($$0.dt()))) {
         this.a($$2);
      }
   }
   ...
   public void a(bvh $$0, jr<bto> $$1, int $$2) {
      btq $$3 = $$0.c($$1);
      if ($$3 == null || $$3.e() != $$2) {
         int $$4 = $$2 + 1;
   ...
   public ji j(ji $$0) {
      ji $$1 = this.a.d();
      ji $$2 = $$1.a((km)$$0);
      return ero.a($$2, dol.a, this.a.u(), $$1);
   }

   public ji k(ji $$0) {
      ji $$1 = this.a.d();
      dqe $$2 = this.a.u().a(dqe.c);
      ji $$3 = ero.a($$0, dol.a, $$2, $$1);
      return $$3.b($$1);
   }
   ...
   public fba a(fba $$0) {
      fba $$1 = fba.a(this.a.d());
      return ero.a($$1.e($$0), dol.a, this.a.u(), this.a.d());
   }

   public fba b(fba $$0) {
      fba $$1 = fba.a(this.a.d());
      return ero.a($$0.d($$1), dol.a, this.a.u(), this.a.d());
   }
   ...
   private fav l() {
      ...
      switch ($$1) {
         case d:
         case b:
            return new fav(0.0, 0.0, 0.0, $$0.d(), $$0.c(), $$0.b());
         default:
            return new fav(0.0, 0.0, 0.0, $$0.b(), $$0.c(), $$0.d());
      }
   }

   public void a(Consumer<ji> $$0) {
      fav $$1 = this.l().a(1.0, 1.0, 1.0);
      ji.a.b($$1).forEach($$0);
   }
   ...
   public void a(cox $$0, cwp $$1, ji $$2, jn $$3) {
      ji $$4 = this.j($$2.a($$3));
      faw $$5 = new faw(fba.b($$4), $$3, $$4, false);
      dai $$6 = new dai($$0, bsj.a, $$5);
      $$1.a($$6);
   }

   public void a(aku<dhk> $$0) {
      fav $$1 = this.j();
