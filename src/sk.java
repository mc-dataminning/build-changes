...
public class sk {
   ...
   public static final sk.a a = ($$0, $$1) -> Stream.of(new sq($$0, dtg.a, $$1, tg.a()));
   ...
   public static sv.b a(int $$0) {
      return $$1 -> {
         Map<jf<tl>, List<sq>> $$2 = $$1.stream().filter(Objects::nonNull).collect(Collectors.groupingBy($$0xx -> $$0xx.v().d()));
         return $$2.entrySet().stream().flatMap($$1x -> {
            jf<tl> $$2x = (jf<tl>)$$1x.getKey();
   ...
   public static sj a(Collection<sq> $$0, jf<tl> $$1, int $$2) {
      return new sj($$2, $$0, $$1);
   }
