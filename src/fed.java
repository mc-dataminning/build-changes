...
public enum fed implements esb {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static eta a(int $$0, int $$1, fed.a $$2) {
      eta $$3 = new eta(eta.a.a, $$0, $$1, false);
