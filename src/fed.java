...
public class fed {
   ...
   static class b {
      static final Optional<fed> a = Optional.ofNullable(a());
      ...
      private static fed a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fed();
      }
   }
}
