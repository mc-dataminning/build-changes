...
public class fed {
   ...
   public fed(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public fed(fei $$0, fei $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static fed a(eql $$0) {
      return new fed((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static fed a(fei $$0) {
      return new fed($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static fed a(iu $$0, iu $$1) {
      return new fed(
   ...
   public fed a(double $$0) {
      return new fed($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public fed b(double $$0) {
      return new fed(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public fed c(double $$0) {
      return new fed(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public fed d(double $$0) {
      return new fed(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public fed e(double $$0) {
      return new fed(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public fed f(double $$0) {
      return new fed(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public fed b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public fed c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public fed d(double $$0, double $$1, double $$2) {
      return new fed(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public fed f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public fed h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fei> b(fei $$0, fei $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fei> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fei $$6, fei $$7) {
   ...
   @Nullable
   public static fee a(Iterable<fed> $$0, fei $$1, fei $$2, iu $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new fee($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ja a(fed $$0, fei $$1, double[] $$2, @Nullable ja $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static ja a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fei $$6, double[] $$7, @Nullable ja $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fei $$0, List<fed> $$1) {
      fei $$2 = this.f();
      fei $$3 = $$2.e($$0);

      for (fed $$4 : $$1) {
         fed $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fei f() {
      return new fei(azm.d(0.5, this.a, this.d), azm.d(0.5, this.b, this.e), azm.d(0.5, this.c, this.f));
   }

   public fei g() {
      return new fei(azm.d(0.5, this.a, this.d), this.b, azm.d(0.5, this.c, this.f));
   }

   public fei h() {
      return new fei(this.a, this.b, this.c);
   }

   public fei i() {
      return new fei(this.d, this.e, this.f);
   }

   public static fed a(fei $$0, double $$1, double $$2, double $$3) {
      return new fed($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
