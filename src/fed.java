...
public class fed {
   ...
   @Nullable
   private String g;
   private static final fed.a h = new fed.a() {
      @Nullable
      @Override
      public fec a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (feg.a(this.d, "Get capabilities")) {
         ...
         if (feg.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  feg.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !feg.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fec a(fed.c $$0) {
      return ($$0 == fed.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fed.a {
      private final int a;
      private final Set<fec> b = Sets.newIdentityHashSet();
      ...
      public fec a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fed.a.warn("Maximum sound pool size {} reached", this.a);
            }
