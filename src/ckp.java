...
public class ckp extends bwd implements cmk {
   private static final Logger cd = LogUtils.getLogger();
   public static final alc<Integer> a = alg.a(ckp.class, ale.b);
   private static final cgs ce = cgs.a().a(64.0);
   ...
   private final ckm[] ck;
   public final ckm c;
   private final ckm cl;
   private final ckm cm;
   private final ckm cn;
   private final ckm co;
   private final ckm cp;
   private final ckm cq;
   private final ckm cr;
   public float d;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private ebl cs;
   private jh ct = jh.c;
   private final clg cu;
   private int cv = 100;
   private float cw;
   private final eub[] cx = new eub[24];
   private final int[] cy = new int[24];
   private final etz cz = new etz();

   public ckp(bvm<? extends ckp> $$0, dha $$1) {
      super(bvm.Q, $$1);
      this.c = new ckm(this, "head", 1.0F, 1.0F);
      this.cl = new ckm(this, "neck", 3.0F, 3.0F);
      this.cm = new ckm(this, "body", 5.0F, 3.0F);
      this.cn = new ckm(this, "tail", 2.0F, 2.0F);
      this.co = new ckm(this, "tail", 2.0F, 2.0F);
      this.cp = new ckm(this, "tail", 2.0F, 2.0F);
      this.cq = new ckm(this, "wing", 4.0F, 2.0F);
      this.cr = new ckm(this, "wing", 4.0F, 2.0F);
      this.ck = new ckm[]{this.c, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.x(this.eR());
      this.ad = true;
      this.cu = new clg(this);
   }
   ...
   public void aZ() {
      if (this.dV().C && !this.bb()) {
         this.dV().a(this.dA(), this.dC(), this.dG(), axf.iw, this.dm(), 5.0F, 0.8F + this.ae.i() * 0.3F, false);
      }
   }
   ...
   public void d_() {
      ...
      if (this.dV().C) {
         ...
         if (!this.bb() && !this.cu.a().a() && --this.cv < 0) {
            this.dV().a(this.dA(), this.dC(), this.dG(), axf.ix, this.dm(), 2.5F, 0.8F + this.ae.i() * 0.3F, false);
         ...
         if (this.fZ()) {
            ...
            if (this.dV() instanceof ash $$7) {
               ...
               if ($$10 != null) {
                  ...
                  this.v(bae.h(this.dL()));
                  fbs $$17 = $$10.a(this.dA(), this.dC(), this.dG()).d();
                  fbs $$18 = new fbs((double)bae.a(this.dL() * (float) (Math.PI / 180.0)), this.dy().e, (double)(-bae.b(this.dL() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$22 = 0.06F;
                  this.a(0.06F * ($$19 * $$21 + (1.0F - $$21)), new fbs(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(bwf.a, this.dy().c(0.8F));
                  } else {
            ...
            this.aX = this.dL();
            fbs[] $$25 = new fbs[this.ck.length];

            for (int $$26 = 0; $$26 < this.ck.length; $$26++) {
               $$25[$$26] = new fbs(this.ck[$$26].dA(), this.ck[$$26].dC(), this.ck[$$26].dG());
            }
            ...
            if (this.dV() instanceof ash $$33 && this.aN == 0) {
               this.a($$33, $$33.a(this, this.cq.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bvk.e));
               this.a($$33, $$33.a(this, this.cr.cR().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bvk.e));
               this.b($$33, $$33.a(this, this.c.cR().g(1.0), bvk.e));
               this.b($$33, $$33.a(this, this.cl.cR().g(1.0), bvk.e));
            }
   ...
   private void gl() {
      ...
      if (this.ae.a(10) == 0) {
         List<cko> $$0 = this.dV().a(cko.class, this.cR().g(32.0));
         cko $$1 = null;
   ...
   private void a(ash $$0, List<bvf> $$1) {
   ...
   private void b(ash $$0, List<bvf> $$1) {
      for (bvf $$2 : $$1) {
         if ($$2 instanceof bwb) {
            btv $$3 = this.dW().b((bwb)this);
            $$2.a($$0, $$3, 10.0F);
            ddt.a($$0, $$2, $$3);
         }
      }
   ...
   public boolean a(ash $$0, ckm $$1, btv $$2, float $$3) {
      if (this.cu.a().h() == clf.j) {
         return false;
      } else {
         $$3 = this.cu.a().a($$2, $$3);
         if ($$1 != this.c) {
         ...
         if ($$3 < 0.01F) {
            ...
            if ($$2.d() instanceof cps || $$2.a(axw.y)) {
               float $$4 = this.eD();
               this.c($$0, $$2, $$3);
   ...
   protected void c(ash $$0, btv $$1, float $$2) {
      super.a($$0, $$1, $$2);
   }
   ...
   protected void el() {
      ...
      if (this.dV() instanceof ash $$4) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$4.N().b(dgw.f)) {
            bvr.a($$4, this.dt(), bae.d((float)$$3 * 0.08F));
         }
      ...
      this.a(bwf.a, new fbs(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dV() instanceof ash $$5) {
         if ($$5.N().b(dgw.f)) {
            bvr.a($$5, this.dt(), bae.d((float)$$3 * 0.2F));
         }
   ...
   public int t() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dV().a(edi.a.f, new jh($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eub($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eub $$5 = new eub(bae.a($$0), bae.a($$1), bae.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eud a(int $$0, int $$1, @Nullable eub $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eub $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eud a(eub $$0, eub $$1) {
      List<eub> $$2 = Lists.newArrayList();
      eub $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eud($$2, new jh($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ux $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(clf.a($$0.h("DragonPhase")));
      }
   ...
   public fbs J(float $$0) {
      ...
      fbs $$8;
      if ($$2 == clf.d || $$2 == clf.e) {
         jh $$3 = this.dV().a(edi.a.f, egn.a(this.ct));
   ...
   public void a(ash $$0, cko $$1, jh $$2, btv $$3) {
      cps $$4;
      if ($$3.d() instanceof cps) {
         $$4 = (cps)$$3.d();
      } else {
