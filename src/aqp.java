...
public abstract class aqp<T> extends aqy<T> {
   ...
   public aqp(@Nullable T $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0);
   ...
   protected aqp(@Nullable T $$0, JsonObject $$1) {
      super($$0);
