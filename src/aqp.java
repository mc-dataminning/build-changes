...
public interface aqp {
   aqp a = new aqp() {
      ...
      @Override
      public void a(Consumer<dba> $$0) {
      }
   };

   static aqp a(dba $$0, int $$1) {
      return new aqp.a($$0, $$1);
   }

   static void a(aqp $$0, aqp $$1, Consumer<dba> $$2, Consumer<dba> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqp.a $$4 && $$1 instanceof aqp.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dba($$10, $$11));
                     } else {
                        $$3.accept(new dba($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dba b, int c) implements aqp {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqp.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqp.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
