...
public class aqp<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqp.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqp.this.remove(this.b + 1);
      }
   }
}
