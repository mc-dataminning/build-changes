...
public class aqp extends enw implements AutoCloseable {
   public static final int a = 1000;
   private static final Logger d = LogUtils.getLogger();
   private final boz<Runnable> e;
   private final ObjectList<Pair<aqp.a, Runnable>> f = new ObjectArrayList();
   private final apt g;
   private final boy<apw.a<Runnable>> h;
   private final int i = 1000;
   private final AtomicBoolean j = new AtomicBoolean();

   public aqp(dut $$0, apt $$1, boolean $$2, boz<Runnable> $$3, boy<apw.a<Runnable>> $$4) {
      super($$0, true, $$2);
      this.g = $$1;
      this.h = $$4;
      this.e = $$3;
   ...
   protected void a(dbm $$0) {
      this.a($$0.e, $$0.f, () -> 0, aqp.a.a, ac.a((Runnable)(() -> {
         super.b($$0, false);
         super.a($$0, false);

         for (int $$1 = this.d(); $$1 < this.e(); $$1++) {
            super.a(dco.b, kc.a($$0, $$1), null);
            super.a(dco.a, kc.a($$0, $$1), null);
         }
   ...
   private void a(int $$0, int $$1, aqp.a $$2, Runnable $$3) {
      this.a($$0, $$1, this.g.c(dbm.c($$0, $$1)), $$2, $$3);
   }
   ...
   public CompletableFuture<dug> a(dug $$0, boolean $$1) {
      dbm $$2 = $$0.f();
   ...
   public CompletableFuture<dug> b(dug $$0, boolean $$1) {
      dbm $$2 = $$0.f();
      $$0.b(false);
      this.a($$2.e, $$2.f, aqp.a.a, ac.a((Runnable)(() -> {
         if (!$$1) {
