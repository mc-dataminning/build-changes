...
public abstract class gqt<T extends cqw, S extends gzl> extends gsb<T, S> {
   private static final aku b = aku.b("textures/entity/minecart.png");
   protected final gcu a;
   private final gnb h;

   public gqt(gsc.a $$0, gfa $$1) {
      super($$0);
      this.f = 0.7F;
   ...
   public void a(S $$0, ffu $$1, glx $$2, int $$3) {
      ...
      this.a.a($$1, $$11, $$3, hea.d);
      $$1.b();
   }

   private static <S extends gzl> void a(S $$0, ffu $$1) {
      $$1.a(a.d.rotationDegrees($$0.b));
      $$1.a(a.f.rotationDegrees(-$$0.a));
      $$1.a(0.0F, 0.375F, 0.0F);
   }

   private static <S extends gzl> void b(S $$0, ffu $$1) {
      double $$2 = $$0.r;
      double $$3 = $$0.s;
      double $$4 = $$0.t;
      float $$5 = $$0.a;
   ...
   private static <T extends cqw, S extends gzl> void a(T $$0, crl $$1, S $$2, float $$3) {
      if ($$1.t()) {
         $$2.j = $$1.e($$3);
         $$2.a = $$1.c($$3);
         $$2.b = $$1.d($$3);
   ...
   private static <T extends cqw, S extends gzl> void a(T $$0, crm $$1, S $$2, float $$3) {
      float $$4 = 0.3F;
      $$2.a = $$0.j($$3);
      $$2.b = $$0.k($$3);
      double $$5 = $$2.r;
   ...
   protected void a(S $$0, dwx $$1, ffu $$2, glx $$3, int $$4) {
      this.h.a($$1, $$2, $$3, $$4, hea.d);
   }
