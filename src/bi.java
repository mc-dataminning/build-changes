...
public record bi(cm.c b, cm.c c, cm.c d, cm.c e, cm.c f) {
   public static final Codec<bi> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               awe.a(cm.c.d, "x", cm.c.c).forGetter(bi::a),
               awe.a(cm.c.d, "y", cm.c.c).forGetter(bi::b),
               awe.a(cm.c.d, "z", cm.c.c).forGetter(bi::c),
               awe.a(cm.c.d, "horizontal", cm.c.c).forGetter(bi::d),
               awe.a(cm.c.d, "absolute", cm.c.c).forGetter(bi::e)
            )
            .apply($$0, bi::new)
   );
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      float $$7 = (float)($$1 - $$4);
      float $$8 = (float)($$2 - $$5);
      if (!this.b.d((double)aww.e($$6)) || !this.c.d((double)aww.e($$7)) || !this.d.d((double)aww.e($$8))) {
         return false;
      } else {
