...
public class ab {
   ...
   @Deprecated
   public static final int b = 3824;
   @Deprecated
   public static final String c = "april2024";
   @Deprecated
   public static final String d = "24w14potato";
   @Deprecated
   ...
   static {
      ...
      CommandSyntaxException.BUILT_IN_EXCEPTIONS = new eb();
   }
}
