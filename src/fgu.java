...
public class fgu {
   ...
   public static void a(File $$0, ezo $$1, Consumer<xe> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ezo $$2, Consumer<xe> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ezo $$2, Consumer<xe> $$3) {
      fad $$4 = a($$2);
      ...
      ad.g().execute(() -> {
         try {
            $$4.a($$6);
            xe $$3x = xe.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new xc(xc.a.b, $$6.getAbsolutePath())));
            $$3.accept(xe.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(xe.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static fad a(ezo $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fad $$3 = new fad($$1, $$2, false);
   ...
   public fgu(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
