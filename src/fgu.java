...
public abstract class fgu<E extends fgu.a<E>> extends fgr {
   protected static final int b = 6;
   private static final alb a = new alb("widget/scroller");
   private static final alb m = new alb("widget/scroller_background");
   private static final alb n = new alb("textures/gui/menu_list_background.png");
   private static final alb o = new alb("textures/gui/inworld_menu_list_background.png");
   protected final ffa c;
   protected final int d;
   private final List<E> p = new fgu.b();
   ...
   public fgu(ffa $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xk.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayu.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aF_().get($$7) : null;
   }

   public void a(int $$0, fkm $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(fgm $$0) {
      RenderSystem.enableBlend();
      alb $$1 = this.c.r == null ? fmy.h : fmy.j;
      alb $$2 = this.c.r == null ? fmy.i : fmy.k;
   ...
   public void a(double $$0) {
      this.q = ayu.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = ayu.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fld $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fld $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fgm $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public fkt.a t() {
      if (this.aJ_()) {
         ...
         return this.v != null ? fkt.a.b : fkt.a.a;
      }
   }
   ...
   protected void a(fkv $$0, E $$1) {
      List<E> $$2 = this.aF_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fku.b, xl.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fgu.a<E>> implements fiv {
      @Deprecated
      fgu<E> a;
      ...
      public abstract void a(fgm var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
