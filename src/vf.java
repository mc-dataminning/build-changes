...
public class vf {
   public static <T extends uw> vf.b a(uy<T> $$0) {
      return a(new uu<T>($$0));
   }

   private static vf.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends uw> vf.d b(uy<T> $$0) {
      return a(new uv<T>($$0));
   }

   private static vf.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof xx)) {
            $$0.fireChannelRead($$1);
         } else {
