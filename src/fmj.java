...
public final class fmj<T> {
   ...
   public static final fmj.b<Boolean> b = ($$0, $$1) -> $$1 ? wo.b : wo.c;
   ...
   public static <T> fmj.l<T> a(wp $$0) {
      return $$1 -> frb.a($$0);
   }

   public static <T extends azc> fmj.b<T> b() {
      return ($$0, $$1) -> $$1.d();
   }
   ...
   public fpo a(fmk $$0, int $$1, int $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, $$0x -> {
      });
   }

   public fpo a(fmk $$0, int $$1, int $$2, int $$3, Consumer<T> $$4) {
   ...
   public static record a<T>(List<T> a, List<T> b, BooleanSupplier c, fmj.d.a<T> d, Codec<T> e) implements fmj.d<T> {
      @Override
      public fpx.c<T> a() {
         return fpx.c.a(this.c, this.a, this.b);
      }
   ...
   public static record c(int a, IntSupplier b, int c) implements fmj.g, fmj.j<Integer> {
      ...
      @Override
      public fpx.c<Integer> a() {
         return fpx.c.a(IntStream.range(this.a, this.b() + 1).boxed().toList());
      }
   ...
   interface d<T> extends fmj.n<T> {
      ...
      @Override
      default Function<fmj<T>, fpo> a(fmj.l<T> $$0, fmk $$1, int $$2, int $$3, int $$4, Consumer<T> $$5) {
         return $$6 -> fpx.a($$6.e).a(this.a()).a($$0).a($$6.k).a($$2, $$3, $$4, 20, $$6.j, ($$3xx, $$4xx) -> {
               this.e().set($$6, (T)$$4xx);
               $$1.az();
               $$5.accept((T)$$4xx);
            });
   ...
   public static final class i<N> extends fpi {
   ...
   interface k<T> extends fmj.n<T> {
      ...
      @Override
      default Function<fmj<T>, fpo> a(fmj.l<T> $$0, fmk $$1, int $$2, int $$3, int $$4, Consumer<T> $$5) {
         return $$6 -> new fmj.i<>($$1, $$2, $$3, $$4, 20, $$6, this, $$0, $$5, this.aP_());
      }
   }
   ...
   interface n<T> {
      Function<fmj<T>, fpo> a(fmj.l<T> var1, fmk var2, int var3, int var4, int var5, Consumer<T> var6);
