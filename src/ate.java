...
public class ate implements AutoCloseable {
   ...
   private ate(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ate.a a(Path $$0) {
         return new ate.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
