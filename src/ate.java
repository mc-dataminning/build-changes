...
public class ate extends atd {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, ate.a> s;
   private final asz t;
   private long u;
   private final ajo v;

   private ate(ajo $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == ata.c($$2, 7, $$0.getLength());
      }
   }
