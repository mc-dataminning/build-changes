...
public class ate<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return ate.this.get(this.b--);
      }

      @Override
      public void remove() {
         ate.this.remove(this.b + 1);
      }
   }
}
