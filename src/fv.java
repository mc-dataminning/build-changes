...
public class fv implements ArgumentType<fv.a> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tm.a("arguments.function.tag.unknown", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> tm.a("arguments.function.unknown", $$0));
   ...
   public fv.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '#') {
         ...
         return new fv.a() {
            ...
            @Override
            public Pair<aex, Either<dp, Collection<dp>>> b(CommandContext<dt> $$0) throws CommandSyntaxException {
   ...
   static dp a(CommandContext<dt> $$0, aex $$1) throws CommandSyntaxException {
      return ((dt)$$0.getSource()).l().aA().a($$1).orElseThrow(() -> c.create($$1.toString()));
   }

   static Collection<dp> b(CommandContext<dt> $$0, aex $$1) throws CommandSyntaxException {
   ...
   public static Pair<aex, Either<dp, Collection<dp>>> b(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
   ...
   public interface a {
      ...
      Pair<aex, Either<dp, Collection<dp>>> b(CommandContext<dt> var1) throws CommandSyntaxException;
   }
}
