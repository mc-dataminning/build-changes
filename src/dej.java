...
public class dej extends dek {
   ...
   public float a(float $$0) {
      return arw.a(((float)this.g + $$0) / 200.0F, 0.0F, 1.0F);
   }

   public float b(float $$0) {
      return 1.0F - arw.a(((float)this.h - $$0) / 40.0F, 0.0F, 1.0F);
   }
   ...
   private static gw a(akq $$0, gw $$1) {
      ehn $$2 = b($$0, $$1);
      dhq $$3 = a((cpv)$$0, $$2);
      gw $$4 = a($$3);
      if ($$4 == null) {
         ...
         $$0.G_().c(jc.as).flatMap($$0x -> $$0x.b(oq.e)).ifPresent($$2x -> ((dnj)$$2x.a()).a($$0, $$0.k().g(), asc.a($$5.a()), $$5));
         $$4 = $$5;
      } else {
   ...
   private static ehn b(akq $$0, gw $$1) {
   ...
   private static boolean a(akq $$0, ehn $$1) {
   ...
   private static dhq a(cpv $$0, ehn $$1) {
      return $$0.d(arw.a($$1.c / 16.0), arw.a($$1.e / 16.0));
   }
   ...
   private static void a(akq $$0, gw $$1, dpz $$2) {
