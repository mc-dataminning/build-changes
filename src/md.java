...
public class md implements km {
   ...
   public CompletableFuture<?> a(kk $$0) {
      ...
      Consumer<cou> $$6 = $$4::add;
      new mb($$2, $$5, $$6).a();
      new mc($$5).a();
      List<cyo> $$7 = kf.e.g().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
