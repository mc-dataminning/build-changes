...
public interface hp<T> {
   ...
   hr<T> a(@Nullable ua var1, CommandDispatcher<T> var2) throws eg;
   ...
   static <T extends ef<T>> hp<T> a(akh $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hq<T> $$4 = new hq<>();
   ...
   static <T extends ef<T>> hg<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hi.c<>($$2.getString(), $$4.get());
      }
   }
}
