...
public class ema extends emf {
   ...
   public List<ekl.a> a(dhn $$0, BiConsumer<jh, dxu> $$1, bam $$2, int $$3, jh $$4, ejv $$5) {
      ...
      List<ekl.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dhn $$0, BiConsumer<jh, dxu> $$1, bam $$2, jh $$3, jh $$4, boolean $$5, ejv $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ...
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dra.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dhn $$0, BiConsumer<jh, dxu> $$1, bam $$2, int $$3, jh $$4, List<ema.a> $$5, ejv $$6) {
      for (ema.a $$7 : $$5) {
         int $$8 = $$7.a();
