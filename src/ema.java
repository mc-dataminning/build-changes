...
public class ema extends emf {
   public static final MapCodec<ema> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, ema::new));
   ...
   public List<ekk.a> a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, ji $$4, eju $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ema.a> $$13 = Lists.newArrayList();
      $$13.add(new ema.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ji $$21 = $$4.b(ayz.a($$19), $$12 - 1, ayz.a($$20));
               ji $$22 = $$21.b(5);
      ...
      List<ekk.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, ji $$3, ji $$4, boolean $$5, eju $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ji $$13 = $$3.b(ayz.d(0.5F + (float)$$12 * $$9), ayz.d(0.5F + (float)$$12 * $$10), ayz.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dqv.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, ji $$4, List<ema.a> $$5, eju $$6) {
      for (ema.a $$7 : $$5) {
         int $$8 = $$7.a();
