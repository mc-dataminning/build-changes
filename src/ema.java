...
public class ema {
   ...
   static class b {
      static final Optional<ema> a = Optional.ofNullable(a());
      ...
      private static ema a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ema();
      }
   }
}
