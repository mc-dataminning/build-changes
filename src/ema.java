...
public abstract class ema<T extends ema<T>> {
   ...
   public ema(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ely.a();
         if ($$3 != null) {
         ...
         throw new enj(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new enj(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new enj(var2.getMessage(), var2);
      }
   }
   ...
   public static ema<?> a(String $$0) {
      return new ema.b($$0, 5000, 60000);
   }

   public static ema<?> a(String $$0, int $$1, int $$2) {
      return new ema.b($$0, $$1, $$2);
   }

   public static ema<?> c(String $$0, String $$1) {
      return new ema.c($$0, $$1, 5000, 60000);
   }

   public static ema<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ema.c($$0, $$1, $$2, $$3);
   }

   public static ema<?> b(String $$0) {
      return new ema.a($$0, 5000, 60000);
   }

   public static ema<?> d(String $$0, String $$1) {
      return new ema.d($$0, $$1, 5000, 60000);
   }

   public static ema<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ema.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ema<ema.a> {
   ...
   public static class b extends ema<ema.b> {
   ...
   public static class c extends ema<ema.c> {
      ...
      public ema.c f() {
         try {
            ...
            throw new enj(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ema<ema.d> {
      private final String c;
