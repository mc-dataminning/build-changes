...
public class brv {
   ...
   private static void a(bsd $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bry $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bse> $$0) {
      JsonObject $$1 = new JsonObject();
      bsi<bse> $$2 = bsi.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bse::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bsi<bse> $$6 = bsi.a((List<bse>)$$4);
         ...
         Function<bse, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<eec, bsi<brx>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bsi)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ag.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<eec, bsi<brx>> $$3 : $$0) {
         bsi<brx> $$4 = (bsi<brx>)$$3.getSecond();
         JsonObject $$5 = ag.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((eec)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<bsg> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = brk.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(brt $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), brv::a));
      $$1.add("chunksWritten", this.a($$0.m(), brv::a));
      return $$1;
   }

   private JsonElement a(bsa.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(brt $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), brv::a));
      $$1.add("received", this.a($$0.k(), brv::a));
      return $$1;
   }

   private <T> JsonElement a(bsc<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<brz> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<brz>, ToDoubleFunction<brz>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, brz::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, brz::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, brz::c));
      return $$1;
   }
}
