...
public class gkk implements ajb {
   ...
   private final AtomicReference<gkk.a> l = new AtomicReference<>(gkk.a.a);

   public gkk(vr $$0, fpo $$1, @Nullable gla $$2, @Nullable fyn $$3, boolean $$4, @Nullable Duration $$5, Consumer<wy> $$6, @Nullable gle $$7) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(gkk.a $$0) {
      gkk.a $$1 = this.l.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(ajg $$0) {
      ...
      this.f
         .a(
            abj.d,
            new gkj(this.b, this.f, new gkq($$1, this.b.u().a(this.g, this.h, this.i), gko.a().a(), cuv.h, null, this.c, this.d, this.j, null, Map.of(), aly.a))
         );
      this.f.a(ajn.a);
      this.f.a(abj.b);
   ...
   public void a(vt $$0) {
      ...
      if (this.c != null && this.c.e()) {
         this.b.a(new hpt(this.d, $$1, $$0.a()));
      } else {
         this.b.a(new fxu(this.d, $$1, $$0));
      }
   }
   ...
   static enum a {
      ...
      private a(final wy $$0, final Set<gkk.a> $$1) {
         this.e = $$0;
         this.f = $$1;
      }
   }
