...
public class edf implements eda {
   public static final Codec<edf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               lp.e.q().fieldOf("block").flatXmap(edf::a, DataResult::success).orElse((djx)dez.fg).forGetter($$0x -> $$0x.b),
   ...
   public final jm<dex> h;
   private final ObjectArrayList<je> i;

   private static DataResult<djx> a(dex $$0) {
      return $$0 instanceof djx $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public edf(djx $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jm<dex> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<je> a(azf $$0, je $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<je> a(azf $$0) {
