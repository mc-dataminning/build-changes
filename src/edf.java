...
public class edf implements ede {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<edf> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dxt.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dxv.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dxu.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bqb.b(1, 20).fieldOf("outer_wall_distance").orElse(bqh.a(4, 5)).forGetter($$0x -> $$0x.i),
               bqb.b(1, 20).fieldOf("distribution_points").orElse(bqh.a(3, 4)).forGetter($$0x -> $$0x.j),
               bqb.b(0, 10).fieldOf("point_offset").orElse(bqh.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public edf(dxt $$0, dxv $$1, dxu $$2, double $$3, double $$4, boolean $$5, bqb $$6, bqb $$7, bqb $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
