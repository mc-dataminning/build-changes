...
public class gmk {
   ...
   public void a(dhh $$0, gli $$1, int $$2, float $$3, fbx $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = fmf.N() ? 10 : 5;
         List<gmk.a> $$7 = new ArrayList<>();
         List<gmk.a> $$8 = new ArrayList<>();
   ...
   private void a(dhh $$0, int $$1, float $$2, fbx $$3, int $$4, List<gmk.a> $$5, List<gmk.a> $$6) {
      int $$7 = bae.a($$3.d);
      int $$8 = bae.a($$3.e);
      int $$9 = bae.a($$3.f);
      jh.a $$10 = new jh.a();
   ...
   private void a(gli $$0, fbx $$1, int $$2, float $$3, List<gmk.a> $$4, List<gmk.a> $$5) {
      $$0.c();
      fgt $$6 = fgt.b();
   ...
   private gmk.a a(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      int $$8 = $$1 & 131071;
      int $$9 = $$2 * $$2 * 3121 + $$2 * 45238971 + $$5 * $$5 * 418711 + $$5 * 13761 & 0xFF;
      float $$10 = 3.0F + $$0.i();
      float $$11 = -((float)($$8 + $$9) + $$7) / 32.0F * $$10;
      float $$12 = $$11 % 32.0F;
      return new gmk.a($$2, $$5, $$3, $$4, 0.0F, $$12, $$6);
   }

   private gmk.a b(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      float $$8 = (float)$$1 + $$7;
      float $$9 = (float)($$0.j() + (double)($$8 * 0.01F * (float)$$0.k()));
      float $$10 = (float)($$0.j() + (double)($$8 * (float)$$0.k() * 0.001F));
      float $$11 = -((float)($$1 & 511) + $$7) / 512.0F;
      int $$12 = gli.a((gli.a($$6) * 3 + 15) / 4, (gli.b($$6) * 3 + 15) / 4);
      return new gmk.a($$2, $$5, $$3, $$4, $$9, $$11 + $$10, $$12);
   }

   private void a(fgt $$0, List<gmk.a> $$1, fbx $$2, float $$3, int $$4, float $$5) {
      fgm $$6 = $$0.a(fgw.c.h, fgp.d);
   ...
   public void a(gfj $$0, flo $$1, int $$2, arz $$3) {
      float $$4 = $$0.d(1.0F) / (fmf.N() ? 1.0F : 2.0F);
      if (!($$4 <= 0.0F)) {
