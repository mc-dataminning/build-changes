...
public class gmk {
   public static class a implements gnd<mb> {
      ...
      public gna a(mb $$0, gjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gmk.b $$8 = new gmk.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends goa {
      b(gjr $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azm.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gnm {
      private boolean b;
      private boolean F;
      private final gnc G;
      private float H;
      ...
      c(gjr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gnc $$7, gnv $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gmk.c $$0 = new gmk.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gnd<mb> {
      ...
      public gna a(mb $$0, gjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gmk.c $$8 = new gmk.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fos.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gmy {
      ...
      public e(gjr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gnc $$7, List<dbm> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, awo.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gna $$12 = this.E.a(lx.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axw.b($$11) / 255.0F, (float)axw.c($$11) / 255.0F, (float)axw.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               awm $$14 = $$13 ? awn.jt : awn.js;
               this.c.a(this.g, this.h, this.i, $$14, awo.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gmk.c $$10 = (gmk.c)this.E.a(lx.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azm.d($$18, $$13, $$16) * $$0;
                  double $$20 = azm.d($$18, $$14, $$17) * $$0;
