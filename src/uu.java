...
public class uu extends um<uv> {
   private static final int b = 24;
   public static final vm<uu> a = new vm.b<uu>() {
      public uu a(DataInput $$0, uw $$1) throws IOException {
         return new uu(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, vk $$1) {
      if ($$1 instanceof vd) {
         this.c = ArrayUtils.add(this.c, $$0, ((vd)$$1).f());
         return true;
      } else {
         return false;
      }
