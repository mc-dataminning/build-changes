...
public class uu extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<tx> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, tj.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<tx> $$0, Codec<T> $$1, tj $$2) {
      tx $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> uu a(DynamicOps<tx> $$0, Codec<T> $$1, T $$2) {
      tx $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = awm.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, xt<? super uu, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, xu<? super uu, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(xt<? super uu, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, xt<? super uu, K> $$1, xt<? super uu, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(xt<? super uu, K> $$0, xt<? super uu, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, xu<? super uu, K> $$1, xu<? super uu, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, xu<? super uu, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(xt<? super uu, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(xt<? super uu, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, xt<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, xu<? super uu, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, xu<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, xu<? super uu, L> $$1, xu<? super uu, R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.encode(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(xt<? super uu, L> $$0, xt<? super uu, R> $$1) {
   ...
   public <T> uu a(ToIntFunction<T> $$0, T $$1) {
   ...
   public uu a(@Nullable tx $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable tx $$1) {
      if ($$1 == null) {
         $$1 = tc.b;
      }

      try {
         tn.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ta f(ByteBuf $$0) {
      tx $$1 = a($$0, tj.a(2097152L));
      if ($$1 != null && !($$1 instanceof ta)) {
   ...
   @Nullable
   public static tx a(ByteBuf $$0, tj $$1) {
      try {
         tx $$2 = tn.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public uu a(String $$0, int $$1) {
      vk.a(this.d, $$0, $$1);
      return this;
   }

   public ajh q() {
      return new ajh(this.d(32767));
   }
   ...
   public <T> ajg<T> a(ajg<? extends iy<T>> $$0) {
      ajh $$1 = this.q();
      return ajg.a($$0, $$1);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, aww.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), uu::a);
   }

   public Property z() {
      String $$0 = this.p();
      String $$1 = this.p();
      String $$2 = this.c(uu::p);
   ...
   public uu a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public uu a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public uu a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public uu a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public uu a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public uu a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public uu a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public uu a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public uu b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public uu c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public uu d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public uu e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public uu f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public uu g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public uu h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public uu a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public uu b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public uu i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public uu a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public uu a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public uu b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public uu b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public uu b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public uu b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public uu b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public uu b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public uu g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public uu b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public uu a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public uu a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public uu a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public uu h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public uu c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public uu b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public uu b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public uu b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
