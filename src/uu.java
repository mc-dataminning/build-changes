...
public class uu implements uz {
   ...
   public void a(ty $$0) {
      ...
      for (String $$2 : $$1) {
         ...
         this.b.append(a($$2)).append(':').append(new uu().a($$0.c($$2)));
      }
   ...
   protected static String a(String $$0) {
      return a.matcher($$0).matches() ? $$0 : ut.b($$0);
   }
