...
public class awg extends awf {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awg.a> s;
   private final awb t;
   private long u;
   private final alx v;

   private awg(alx $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awc.c($$2, 7, $$0.getLength());
      }
   }
