...
public class awg extends awl {
   ...
   public awg(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cmx $$0, awh<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<awh<?>> d() {
      Set<awh<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  us $$4 = a($$3.getAsJsonObject());
                  $$4 = bag.g.a($$0, $$4, vh.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awh<T>> a(awj<T> $$0, String $$1) {
      return Optional.ofNullable(alf.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static us a(JsonObject $$0) {
      us $$1 = new us();
   ...
   protected String b() {
      Map<awj<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awh<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awh<?>>)$$3.next();
         awh<?> $$2 = (awh<?>)$$1.getKey();
      ...
      for (Entry<awj<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> alf b(awh<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(arg $$0) {
      Object2IntMap<awh<?>> $$1 = new Object2IntOpenHashMap();
