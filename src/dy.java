...
public abstract class dy<T extends dy.a> implements ar<T> {
   private final Map<alx, Set<ar.a<T>>> a = Maps.newIdentityHashMap();

   @Override
   public final void a(alx $$0, ar.a<T> $$1) {
      this.a.computeIfAbsent($$0, $$0x -> Sets.newHashSet()).add($$1);
   }

   @Override
   public final void b(alx $$0, ar.a<T> $$1) {
   ...
   @Override
   public final void a(alx $$0) {
      this.a.remove($$0);
   }

   protected void a(ary $$0, Predicate<T> $$1) {
      alx $$2 = $$0.S();
