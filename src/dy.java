...
public record dy(List<dy.c> c) {
   ...
   public <S extends dsj<?, S>> boolean a(dsi<?, S> $$0, S $$1) {
      for (dy.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(dsi<?, ?> $$0) {
      for (dy.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public dy.a a(dtk<?> $$0, String $$1) {
         this.a.add(new dy.c($$0.f(), new dy.b($$1)));
         return this;
      }

      public dy.a a(dtk<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public dy.a a(dtk<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & ayz> dy.a a(dtk<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String e) implements dy.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dsj<?, ?> $$0, dtk<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(dsj<?, ?> var1, dtk<T> var2);
   }
}
