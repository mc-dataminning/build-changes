...
public class gdt implements ezx, AutoCloseable {
   ...
   private final List<fad> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, fad> l = Maps.newHashMap();
   private final int m;
   ...
   public gdt(atz $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, faa.a.a, $$6);
         this.t = a($$0, faa.a.b, $$7);
         this.m = fab.a();
         fab.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = fad.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezy a(atz $$0, faa.a $$1, String $$2) throws IOException {
      faa $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezy)) {
   ...
   public static ezw a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezw();
      } else {
         int $$1 = 32774;
