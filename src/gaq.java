...
public class gaq implements amu<gap> {
   public gap b(JsonObject $$0) {
      ...
      int $$8 = aro.a($$0, "width", -1);
      int $$9 = aro.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = aro.a($$0, "interpolate", false);
   ...
   private gao a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gao(aro.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = aro.m($$1, "frames[" + $$0 + "]");
         int $$3 = aro.a($$2, "time", -1);
         if ($$2.has("time")) {
