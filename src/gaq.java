...
public class gaq extends gbk<gyr> {
   private final gem[] a;
   private final gem b;
   ...
   public static ges a() {
      geu $$0 = new geu();
      gew $$1 = $$0.a();
      $$1.a("head", ger.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), geo.a);
      float $$2 = 0.0F;
      ger $$3 = ger.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = bae.b($$2) * 9.0F;
         float $$6 = -2.0F + bae.b((float)($$4 * 2) * 0.25F);
         float $$7 = bae.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, geo.a($$5, $$6, $$7));
         $$2++;
      }
