...
public class gaq implements gbj {
   ...
   private CompletableFuture<Optional<cnr>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gaq(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cnr::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cnr>> a(Optional<cnr> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (ayb | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cnr.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cnr $$0) {
      ...
      if ($$0 != null) {
         if (ab.aW) {
            cnr.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cnr a(UserApiService $$0) throws ayb, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cns.a $$2 = a($$1);
         return new cnr(aya.a($$1.keyPair().privateKey()), new cns($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cns.a a(KeyPairResponse $$0) throws ayb {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = aya.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cns.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new ayb(var5);
         }
      } else {
         throw new ayb(new MissingException("Missing public key"));
      }
   }
}
