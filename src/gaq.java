...
public class gaq extends fsy<gaq.a> {
   ...
   private final gam N;
   private final List<gaq.d> O = Lists.newArrayList();
   private final gaq.a P = new gaq.b();
   private final List<gaq.c> Q = Lists.newArrayList();

   public gaq(gam $$0, fos $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable gaq.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(gkh $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new gaq.d(this.N, $$0.a($$1)));
      }

      this.c();
   }

   public void a(List<hnb> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (hnb $$2 : $$0) {
         this.Q.add(new gaq.c(this.N, $$2));
      }

      this.c();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         gaq.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fsy.a<gaq.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends gaq.a {
      private final fos a = fos.Q();

      @Override
      public void a(fro $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.b(this.a.h, gaq.G, this.a.z.n / 2 - this.a.h.a(gaq.G) / 2, $$10, -1);
         String $$11 = fxj.a(af.c());
   ...
   public static class c extends gaq.a {
      ...
      protected final hnb b;
      private long g;

      protected c(gam $$0, hnb $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = fos.Q();
      }
   ...
   public class d extends gaq.a {
      ...
      protected d(final gam $$1, final gkg $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = fos.Q();
         this.j = fxe.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fro $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            gaq.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == ab.b().e() ? gkg.b.e : gkg.b.d);
         ...
         wy $$15 = (wy)(this.i.g() == gkg.b.d ? this.i.h.f().a(n.m) : this.i.c);
         ...
         if (this.h.n.ac().c() || $$8) {
            ...
            if (this.e()) {
               if ($$18 < 32 && $$18 > 16) {
                  $$0.a(gqc::H, gaq.y, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gqc::H, gaq.z, $$3, $$2, 32, 32);
               }
            }

            if ($$1 > 0) {
               if ($$18 < 16 && $$19 < 16) {
                  $$0.a(gqc::H, gaq.A, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gqc::H, gaq.B, $$3, $$2, 32, 32);
               }
            }

            if ($$1 < this.g.G().c() - 1) {
               if ($$18 < 16 && $$19 > 16) {
                  $$0.a(gqc::H, gaq.C, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gqc::H, gaq.D, $$3, $$2, 32, 32);
               }
            }
         }
      }
      ...
      protected void a(fro $$0, int $$1, int $$2, alg $$3) {
         $$0.a(gqc::H, $$3, $$1, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
      }
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               gaq.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)gaq.this.u();
         double $$4 = $$1 - (double)gaq.this.d(gaq.this.aD_().indexOf(this));
         if ($$3 <= 32.0) {
