...
public class gaq implements amt<gap> {
   public gap b(JsonObject $$0) {
      Builder<gao> $$1 = ImmutableList.builder();
      int $$2 = arn.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = arn.a($$0, "width", -1);
      int $$9 = arn.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = arn.a($$0, "interpolate", false);
      return new gap($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gao a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gao(arn.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = arn.m($$1, "frames[" + $$0 + "]");
         int $$3 = arn.a($$2, "time", -1);
         if ($$2.has("time")) {
