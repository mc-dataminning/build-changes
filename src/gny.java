public class gny implements gnp<dvl> {
   public static final hdn a = new hdn(hbd.d, alz.b("entity/enchanting_table_book"));
   private final gao b;

   public gny(gnq.a $$0) {
      this.b = new gao($$0.a(geg.G));
   }

   public void a(dvl $$0, float $$1, fgl $$2, gle $$3, int $$4, int $$5) {
      $$2.a();
      $$2.a(0.5F, 0.75F, 0.5F);
      float $$6 = (float)$$0.a + $$1;
