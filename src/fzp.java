...
public class fzp extends fum {
   ...
   private final fsi s = new fsi(this);
   private final fum u;
   private final aua v;
   ...
   public fzp(fum $$0, aua $$1, Consumer<aua> $$2) {
      super(a);
      this.u = $$0;
      this.v = $$1;
      this.w = $$2;
   ...
   protected void aR_() {
      this.s.a(a, this.p);
      fsm $$0 = this.s.c(fsm.d());
      $$0.a(new fpo(b, this.p).d(310), $$0x -> $$0x.e(15));
      fzu.a $$1 = fzu.a(299).a(2, true).b(4);
      this.x.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.x.getBoolean($$1x), $$1xx -> this.x.put($$1x, $$1xx)).a($$1x.c()));
      fsj $$2 = $$1.a().a();
      this.y = new fzp.a($$2, 310, 130);
      $$0.a(this.y);
      fsm $$3 = this.s.b(fsm.e().a(8));
      $$3.a(fou.a(wo.d, $$0x -> this.m()).a());
      $$3.a(fou.a(wo.e, $$0x -> this.aO_()).a());
      this.s.a($$1x -> {
   ...
   public class a extends fok {
      private final List<fos> a = new ArrayList<>();
      private final fsj c;

      public a(final fsj $$1, final int $$2, final int $$3) {
         super(0, 0, $$2, $$3, wo.a);
         this.c = $$1;
         $$1.a(this::a);
      }
      ...
      @Override
      public ftb b(fsz $$0) {
         return new ftb(this.F(), this.G(), this.g, this.n());
      }
      ...
      @Override
      public Collection<? extends fsp> L() {
         return this.a;
      }
   }
}
