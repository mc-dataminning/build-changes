public class fzp extends fzr<ccn, fkl<ccn>> {
   private static final ahg a = new ahg("textures/entity/slime/magmacube.png");

   public fzp(fyl.a $$0) {
      super($$0, new fkl<>($$0.a(fmu.ax)), 0.25F);
   }
   ...
   public void a(ccn $$0, float $$1, float $$2, epz $$3, ftf $$4, int $$5) {
      this.d = 0.25F * (float)$$0.gf();
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   protected void a(ccn $$0, epz $$1, float $$2) {
      int $$3 = $$0.gf();
