...
public class fzp extends fuk {
   ...
   private static final ToIntFunction<aku<dgh>> b = af.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(dgh.i, -13408734);
      $$0.put(dgh.j, -10075085);
      $$0.put(dgh.k, -8943531);
   ...
   @Nullable
   public static fzp a(fli $$0, BooleanConsumer $$1, DataFixer $$2, eve.c $$3, boolean $$4) {
      try {
         fzw $$5 = $$0.x();
         aua $$6 = aud.a($$3);
   ...
   private fzp(BooleanConsumer $$0, DataFixer $$1, eve.c $$2, dgl $$3, boolean $$4, kf $$5) {
