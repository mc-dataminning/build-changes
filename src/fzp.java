...
public class fzp extends qm {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private fzp(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static fzp a(anm $$0, List<String> $$1, boolean $$2) {
      ...
      return new fzp(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<ank> $$1, Map<String, String> $$2) {
      for (ank $$3 : $$1) {
