public class fzp extends fzc<cvs> {
   ...
   protected void a(cwz $$0, int $$1, int $$2, cvn $$3) {
      if ($$0 instanceof cvt && !$$0.h() && !this.L.V_()) {
         switch ($$3) {
            case a:
               if (this.z.e($$1)) {
                  this.a($$1);
   ...
   @Override
   public void a(fsh $$0, cwz $$1) {
      if ($$1 instanceof cvt $$2 && this.z.e($$1.d)) {
         this.a($$0, $$2);
         return;
      }
   ...
   private void a(fsh $$0, cvt $$1) {
      $$0.a(gqx::H, G, $$1.e - 1, $$1.f - 1, 18, 18);
   }
   ...
   public void a(fsh $$0, int $$1, int $$2, float $$3) {
      ...
      this.d($$0);
      this.a($$0, $$1, $$2);
      if (this.B instanceof cvt && !this.z.e(this.B.d) && this.z.g().f() && !this.B.h() && !this.L.V_()) {
         $$0.a(this.p, K, $$1, $$2);
      }
   }
