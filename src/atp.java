...
public class atp extends axo {
   public static final Gson a = new GsonBuilder().registerTypeAdapter(te.class, new JsonDeserializer<te>() {
   ...
   public atp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntitySignTextStrictJsonFix", aym.s, "Sign");
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0, String $$1) {
      ...
      return $$0.set($$1, $$0.createString(te.a.a($$3)));
   }
