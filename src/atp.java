...
class atp implements Path {
   private static final BasicFileAttributes a = new atn() {
      @Override
   ...
   private static final BasicFileAttributes b = new atn() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atp> c = Comparator.comparing(atp::n);
   ...
   public atp(atr $$0, String $$1, @Nullable atp $$2, ats $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atp a(@Nullable atp $$0, String $$1) {
      return new atp(this.e, $$1, $$0, ats.b);
   }
   ...
   atp a(String $$0) {
      if (a(this.i)) {
         return new atp(this.e, $$0, this, this.i);
      } else if (this.i instanceof ats.a $$1) {
         atp $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atp(this.e, $$0, this, ats.a);
      } else if (this.i instanceof ats.b) {
         return new atp(this.e, $$0, this, ats.a);
      } else {
   ...
   private atp c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atp $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ats.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ats.a i() {
      return this.i instanceof ats.a $$0 ? $$0 : null;
   }
