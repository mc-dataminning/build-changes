...
public class atp {
   public static final Codec<atp> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(asq.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), asq.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, atp::new)
   );
   ...
   private final Predicate<agg> f;

   private atp(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
