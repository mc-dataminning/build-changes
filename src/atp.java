...
public class atp {
   ...
   public static CompletableFuture<?> a(File $$0, URL $$1, Map<String, String> $$2, int $$3, @Nullable aue $$4, Proxy $$5) {
      return CompletableFuture.supplyAsync(() -> {
         HttpURLConnection $$6 = null;
         InputStream $$7 = null;
         OutputStream $$8 = null;
         if ($$4 != null) {
            $$4.b(vb.c("resourcepack.downloading"));
            $$4.c(vb.c("resourcepack.requesting"));
         }
         ...
         try {
            ...
            if ($$4 != null) {
               $$4.c(vb.a("resourcepack.progress", String.format(Locale.ROOT, "%.2f", $$11 / 1000.0F / 1000.0F)));
            }
