...
public class atp extends FileSystem {
   private static final Set<String> b = Set.of("basic");
   public static final String a = "/";
   private static final Splitter c = Splitter.on('/');
   private final FileStore d;
   private final FileSystemProvider e = new ato();
   private final atn f;

   atp(String $$0, atp.b $$1) {
      this.d = new atm($$0);
      this.f = a($$1, this, "", null);
   }

   private static atn a(atp.b $$0, atp $$1, String $$2, @Nullable atn $$3) {
      Object2ObjectOpenHashMap<String, atn> $$4 = new Object2ObjectOpenHashMap();
      atn $$5 = new atn($$1, $$2, $$3, new atq.a($$4));
      $$0.b.forEach(($$3x, $$4x) -> $$4.put($$3x, new atn($$1, $$3x, $$5, new atq.b($$4x))));
   ...
   public static atp.a c() {
      return new atp.a();
   }

   public static class a {
      private final atp.b a = new atp.b();

      public atp.a a(List<String> $$0, String $$1, Path $$2) {
         atp.b $$3 = this.a;

         for (String $$4 : $$0) {
            $$3 = $$3.a.computeIfAbsent($$4, $$0x -> new atp.b());
         }
      ...
      public atp.a a(List<String> $$0, Path $$1) {
         if ($$0.isEmpty()) {
   ...
   static record b(Map<String, atp.b> a, Map<String, Path> b) {
