...
public class atp extends axu {
   public atp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", ays.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(ays.s, "minecraft:jukebox");
