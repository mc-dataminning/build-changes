...
public class rk {
   ...
   private hv b;
   private final amp c;
   private final Collection<rl> d = Lists.newArrayList();
   private final int e;
   private final Collection<ro> f = Lists.newCopyOnWriteArrayList();
   ...
   public void b() {
      if (!this.l()) {
         ...
         if (this.k || rx.b(this.s).b().allMatch($$0x -> this.c.e($$0x.l()))) {
            this.k = true;
            if (this.i > 0) {
               this.i--;
            } else {
   ...
   private void C() {
      ...
      if (this.l >= 0L) {
         ...
         if (this.l > (long)this.e) {
            if (this.f.isEmpty()) {
               this.a(new rr("Didn't succeed or fail within " + this.a.c() + " ticks"));
            } else {
               this.f.forEach($$0x -> $$0x.b(this.l));
               if (this.r == null) {
                  this.a(new rr("No sequences finished"));
               }
            }
         } else {
   ...
   public ekw g() {
      dhr $$0 = this.E();
      return $$0 == null ? null : rx.a($$0);
   }

   @Nullable
   private dhr E() {
      return (dhr)this.c.c_(this.b);
   }
   ...
   public void n() {
      if (this.r == null) {
         this.F();
         ekw $$0 = this.g();
         List<blf> $$1 = this.h().a(blf.class, $$0.g(1.0), $$0x -> !($$0x instanceof cer));
         $$1.forEach($$0x -> $$0x.a(blf.c.b));
      }
   }
   ...
   public void b(hv $$0) {
      this.s = rx.a(this, $$0, this.v(), this.c);
      this.b = this.s.aB_();
      rx.a(this.b, new hv(1, 0, -1), this.v(), this.c);
