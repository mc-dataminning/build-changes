...
public class rk implements rp {
   ...
   public void a(qs $$0) {
      ...
      for (String $$2 : $$1) {
         ...
         this.b.append(a($$2)).append(':').append(new rk().a($$0.c($$2)));
      }
   ...
   protected static String a(String $$0) {
      return a.matcher($$0).matches() ? $$0 : rj.b($$0);
   }
