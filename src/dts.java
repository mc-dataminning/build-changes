...
public class dts implements dtr {
   ...
   public static final Codec<dts> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dog.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               doi.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               doh.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bja.b(1, 20).fieldOf("outer_wall_distance").orElse(bjg.a(4, 5)).forGetter($$0x -> $$0x.i),
               bja.b(1, 20).fieldOf("distribution_points").orElse(bjg.a(3, 4)).forGetter($$0x -> $$0x.j),
               bja.b(0, 10).fieldOf("point_offset").orElse(bjg.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dts(dog $$0, doi $$1, doh $$2, double $$3, double $$4, boolean $$5, bja $$6, bja $$7, bja $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
