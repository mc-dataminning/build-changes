...
public class dts extends dtv<dtr> {
   public dts(Codec<dtr> $$0) {
      super($$0);
   }

   public boolean a(dtr $$0, awt $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dtq $$0, dtr $$1, doa $$2, Function<ib, il<cxd>> $$3, awt $$4, drc $$5, cvl $$6, dnz $$7) {
      int $$8 = jd.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dtv.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dtq $$0, dtr $$1, doa $$2, Function<ib, il<cxd>> $$3, drc $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dnz $$10, dtv.a $$11
   ) {
      double $$12 = 1.5 + (double)(awm.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(awm.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = awm.b($$13);
         $$6 += (double)(awm.b($$12) * $$27);
         $$7 += (double)awm.a($$13);
         $$8 += (double)(awm.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
