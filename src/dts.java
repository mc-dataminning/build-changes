...
public class dts {
   ...
   private final List<dtq> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dts.a l = new dts.d(5.999997E7F);
   public static final dts.c d = new dts.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(evl $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public iz b(double $$0, double $$1, double $$2) {
      return iz.a(ayy.a($$0, this.e(), this.g()), $$1, ayy.a($$2, this.f(), this.h()));
   }

   public double a(bst $$0) {
   ...
   public boolean a(bst $$0, evl $$1) {
      double $$2 = Math.max(ayy.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dts.a)($$0 == $$1 ? new dts.d($$1) : new dts.b($$0, $$1, $$2));
   ...
   public dts.c t() {
      return new dts.c(this);
   }

   public void a(dts.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dts.a {
      ...
      @Override
      public double a() {
         return ayy.a(dts.this.a() - this.e() / 2.0, (double)(-dts.this.k), (double)dts.this.k);
      }

      @Override
      public double c() {
         return ayy.a(dts.this.b() - this.e() / 2.0, (double)(-dts.this.k), (double)dts.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ayy.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dtr i() {
         return this.c < this.b ? dtr.b : dtr.a;
      }
      ...
      @Override
      public dts.a l() {
         return (dts.a)(this.g() <= 0L ? dts.this.new d(this.c) : this);
      }
      ...
      public ewj m() {
         return ewg.a(
            ewg.c,
            ewg.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evu.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dts.c a(DynamicLike<?> $$0, dts.c $$1) {
         double $$2 = ayy.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ayy.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dts.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dts.a {
      ...
      private void n() {
         this.c = ayy.a(dts.this.a() - this.b / 2.0, (double)(-dts.this.k), (double)dts.this.k);
         this.d = ayy.a(dts.this.b() - this.b / 2.0, (double)(-dts.this.k), (double)dts.this.k);
         this.e = ayy.a(dts.this.a() + this.b / 2.0, (double)(-dts.this.k), (double)dts.this.k);
         this.f = ayy.a(dts.this.b() + this.b / 2.0, (double)(-dts.this.k), (double)dts.this.k);
         this.g = ewg.a(
            ewg.c,
            ewg.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evu.e
