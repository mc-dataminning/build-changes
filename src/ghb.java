...
public final class ghb {
   ...
   private static final ghb c = new ghb(HostAndPort.fromParts("server.invalid", 25565));

   public ghb(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private ghb(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static ghb a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new ghb($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof ghb ? this.b.equals(((ghb)$$0).b) : false;
      }
   }
