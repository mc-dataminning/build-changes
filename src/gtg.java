...
public class gtg {
   ...
   public static class a extends Thread {
      private final gtg.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gtg.b $$0) throws IOException {
         super("LanServerDetector #" + gtg.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gtg.b));
   ...
   public static class b {
      private final List<gtf> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gtf> a() {
         if (this.b) {
            List<gtf> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
