...
public abstract class gtg<T extends bvi, S extends gzl, M extends gcc<? super S>> extends gse<T, S> implements guc<S, M> {
   private static final float a = 0.1F;
   protected M h;
   protected final hbn i;
   protected final List<gwu<S, M>> j = Lists.newArrayList();

   public gtg(gsf.a $$0, M $$1, float $$2) {
      super($$0);
      this.i = $$0.b();
      this.h = $$1;
      this.f = $$2;
   ...
   protected final boolean a(gwu<S, M> $$0) {
      return this.j.add($$0);
   }
   ...
   public void a(S $$0, ffv $$1, glz $$2, int $$3) {
      ...
      boolean $$7 = this.d($$0);
      boolean $$8 = !$$7 && !$$0.an;
      gmj $$9 = this.a($$0, $$7, $$8, $$0.ao);
      if ($$9 != null) {
         ffz $$10 = $$2.getBuffer($$9);
         int $$11 = a($$0, this.c($$0));
   ...
   @Nullable
   protected gmj a(S $$0, boolean $$1, boolean $$2, boolean $$3) {
      akv $$4 = this.b($$0);
      if ($$2) {
         return gmj.i($$4);
      } else if ($$1) {
         ...
         return $$3 ? gmj.s($$4) : null;
      }
   }

   public static int a(gzl $$0, float $$1) {
      return hej.a(hej.a($$1), hej.a($$0.am));
   }
   ...
   protected void a(S $$0, ffv $$1, float $$2, float $$3) {
      if (this.a($$0)) {
   ...
   public void a(T $$0, S $$1, float $$2) {
      ...
      label48: {
         ...
         $$1.am = $$0.aN > 0 || $$0.aP > 0;
         cwq $$5 = $$0.a(buu.f);
         if ($$5.h() instanceof cuw $$6 && $$6.d() instanceof dij $$7) {
            $$1.au = $$7.b();
            $$1.av = $$5.a(kv.ag);
            $$1.as.b();
            break label48;
   ...
   private static float a(bvi $$0, float $$1, float $$2) {
      if ($$0.dk() instanceof bvi $$3) {
