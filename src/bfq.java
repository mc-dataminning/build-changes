...
public class bfq extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bit.D);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         bbb.a(this.a("minecraft:trident", bfq::c), this.a("minecraft:arrow", bfq::a), this.a("minecraft:spectral_arrow", bfq::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfq.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bit.D, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bit.D, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bfq.a<?> $$1, Type<?> $$2, Type<T> $$3) {
