...
public abstract class bsv extends bsw {
   static final Logger p = LogUtils.getLogger();
   public static final int b = -1;
   private static final akk<Integer> q = ako.a(bsv.class, akm.b);
   private static final akk<Integer> r = ako.a(bsv.class, akm.b);
   private static final akk<Integer> s = ako.a(bsv.class, akm.b);
   private static final akk<Vector3f> t = ako.a(bsv.class, akm.D);
   private static final akk<Vector3f> u = ako.a(bsv.class, akm.D);
   private static final akk<Quaternionf> v = ako.a(bsv.class, akm.E);
   private static final akk<Quaternionf> aF = ako.a(bsv.class, akm.E);
   private static final akk<Byte> aG = ako.a(bsv.class, akm.a);
   private static final akk<Integer> aH = ako.a(bsv.class, akm.b);
   private static final akk<Float> aI = ako.a(bsv.class, akm.d);
   private static final akk<Float> aJ = ako.a(bsv.class, akm.d);
   private static final akk<Float> aK = ako.a(bsv.class, akm.d);
   private static final akk<Float> aL = ako.a(bsv.class, akm.d);
   private static final akk<Float> aM = ako.a(bsv.class, akm.d);
   private static final akk<Integer> aN = ako.a(bsv.class, akm.b);
   ...
   protected void a(us $$0) {
      ...
      if ($$0.b("billboard", 8)) {
         bsv.a.e.decode(vg.a, $$0.c("billboard")).resultOrPartial(ac.a("Display entity", p::error)).ifPresent($$0x -> this.a((bsv.a)$$0x.getFirst()));
      }
   ...
   protected void b(us $$0) {
      ...
      bsv.a.e.encodeStart(vg.a, this.w()).ifSuccess($$1x -> $$0.a("billboard", $$1x));
   ...
   public void a(double $$0, double $$1, double $$2, float $$3, float $$4, int $$5) {
      int $$6 = this.v();
      this.aZ = new bsv.j($$6, $$0, $$1, $$2, (double)$$3, (double)$$4);
   }
   ...
   private void a(bsv.a $$0) {
      this.ao.a(aG, $$0.a());
   }

   private bsv.a w() {
      return bsv.a.f.apply(this.ao.a(aG));
   }
   ...
   private void G() {
      ...
      if ($$0 != 0.0F && $$1 != 0.0F) {
         ...
         double $$4 = this.dw();
         double $$5 = this.dA();
         this.aV = new evo($$3 - (double)$$2, $$4, $$5 - (double)$$2, $$3 + (double)$$2, $$4 + (double)$$1, $$5 + (double)$$2);
      } else {
         this.au = true;
      }
   }
   ...
   private bsv.k H() {
      return new bsv.k(bsv.e.constant(a(this.ao)), this.w(), this.y(), bsv.d.constant(this.A()), bsv.d.constant(this.B()), this.D());
   }

   private bsv.k a(bsv.k $$0, float $$1) {
      j $$2 = $$0.a.get($$1);
      float $$3 = $$0.d.get($$1);
      float $$4 = $$0.e.get($$1);
      return new bsv.k(new bsv.m($$2, a(this.ao)), this.w(), this.y(), new bsv.h($$3, this.A()), new bsv.h($$4, this.B()), this.D());
   }
   ...
   public static enum a implements azu {
      ...
      public static final Codec<bsv.a> e = azu.a(bsv.a::values);
      public static final IntFunction<bsv.a> f = axp.a(bsv.a::a, values(), axp.a.a);
   ...
   public static class b extends bsv {
      public static final String p = "block_state";
      private static final akk<dse> q = ako.a(bsv.b.class, akm.i);
      @Nullable
      private bsv.b.a r;

      public b(btc<?> $$0, dca $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(boolean $$0, float $$1) {
         this.r = new bsv.b.a(this.u());
      }

      public static record a(dse a) {
      }
   }

   static record c(int a, int b) implements bsv.f {
      @Override
   ...
   public static class g extends bsv {
      private static final String p = "item";
      private static final String q = "item_display";
      private static final akk<cur> r = ako.a(bsv.g.class, akm.h);
      private static final akk<Byte> s = ako.a(bsv.g.class, akm.a);
      private final buj t = buj.a(this::u, this::a);
      @Nullable
      private bsv.g.a u;

      public g(btc<?> $$0, dca $$1) {
         super($$0, $$1);
      }
      ...
      private cuo v() {
         return cuo.k.apply(this.ao.a(s));
      }
      ...
      protected void a(us $$0) {
         super.a($$0);
         if ($$0.e("item")) {
            this.a(cur.a(this.dR(), (vp)$$0.p("item")).orElse(cur.l));
         } else {
            this.a(cur.l);
         }

         if ($$0.b("item_display", 8)) {
            cuo.j.decode(vg.a, $$0.c("item_display")).resultOrPartial(ac.a("Display entity", bsv.p::error)).ifPresent($$0x -> this.a((cuo)$$0x.getFirst()));
         }
      }
      ...
      protected void b(us $$0) {
         ...
         cuo.j.encodeStart(vg.a, this.v()).ifSuccess($$1 -> $$0.a("item_display", $$1));
      }

      @Override
      public buj a_(int $$0) {
         return $$0 == 0 ? this.t : buj.a;
      }
      ...
      protected void a(boolean $$0, float $$1) {
         cur $$2 = this.u();
         $$2.a(this);
         this.u = new bsv.g.a($$2, this.v());
      }

      public static record a(cur a, cuo b) {
      }
   }

   static record h(float a, float b) implements bsv.d {
      @Override
   ...
   static record i(int a, int b) implements bsv.f {
      @Override
      public int get(float $$0) {
   ...
   public static record k(bsv.e<j> a, bsv.a b, int c, bsv.d d, bsv.d e, int f) {
   }

   public static class l extends bsv {
      ...
      private static final akk<xp> aN = ako.a(bsv.l.class, akm.f);
      private static final akk<Integer> aO = ako.a(bsv.l.class, akm.b);
      private static final akk<Integer> aP = ako.a(bsv.l.class, akm.b);
      private static final akk<Byte> aQ = ako.a(bsv.l.class, akm.a);
      private static final akk<Byte> aR = ako.a(bsv.l.class, akm.a);
      ...
      protected void a(us $$0) {
         ...
         Optional<bsv.l.a> $$2 = bsv.l.a.d.decode(vg.a, $$0.c("alignment")).resultOrPartial(ac.a("Display entity", bsv.p::error)).map(Pair::getFirst);
         if ($$2.isPresent()) {
            $$1 = switch ((bsv.l.a)$$2.get()) {
               case a -> $$1;
               case b -> (byte)($$1 | 8);
               case c -> (byte)($$1 | 16);
            };
         ...
         if ($$0.b("text", 8)) {
            ...
            try {
               ...
               bsv.p.warn("Failed to parse display entity text {}", $$3, var8);
            }
         }
      }
      ...
      protected void b(us $$0) {
         ...
         bsv.l.a.d.encodeStart(vg.a, a($$1)).ifSuccess($$1x -> $$0.a("alignment", $$1x));
      }
      ...
      private bsv.l.e z() {
         return new bsv.l.e(this.u(), this.v(), bsv.f.constant(this.w()), bsv.f.constant(this.x()), this.y());
      }

      private bsv.l.e a(bsv.l.e $$0, float $$1) {
         int $$2 = $$0.d.get($$1);
         int $$3 = $$0.c.get($$1);
         return new bsv.l.e(this.u(), this.v(), new bsv.i($$3, this.w()), new bsv.c($$2, this.x()), this.y());
      }

      public bsv.l.b a(bsv.l.d $$0) {
         if (this.aT == null) {
            if (this.aU != null) {
               this.aT = $$0.split(this.aU.a(), this.aU.b());
            } else {
               this.aT = new bsv.l.b(List.of(), 0);
            }
         }
      ...
      public static bsv.l.a a(byte $$0) {
         if (($$0 & 8) != 0) {
            return bsv.l.a.b;
         } else {
            return ($$0 & 16) != 0 ? bsv.l.a.c : bsv.l.a.a;
         }
      }
      ...
      public static enum a implements azu {
         ...
         public static final Codec<bsv.l.a> d = azu.a(bsv.l.a::values);
      ...
      public static record b(List<bsv.l.c> a, int b) {
      }
      ...
      @FunctionalInterface
      public interface d {
         bsv.l.b split(xp var1, int var2);
      }

      public static record e(xp a, int b, bsv.f c, bsv.f d, byte e) {
      }
   }

   static record m(j a, j b) implements bsv.e<j> {
      public j a(float $$0) {
