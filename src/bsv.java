...
public interface bsv<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements bsv<bsv.c> {
   ...
   public static final class b implements bsv<Runnable> {
      private final Queue<Runnable> a;
