...
public abstract class bsv {
   ...
   public bsv(bjo $$0, cqb $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = asb.a($$0.b(bks.g) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract eax a(int var1);
   ...
   @Nullable
   public final eav a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(gw.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eav a(Stream<gw> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eav a(Set<gw> $$0, int $$1) {
   ...
   @Nullable
   protected eav a(Set<gw> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.b(bks.g));
   }

   @Nullable
   protected eav a(Set<gw> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         cqo $$7 = new cqo(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         eav $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ad().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eav $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            ehh $$0 = this.b();
            ehh $$1 = this.c.a(this.a);
            if ($$0.d > $$1.d && !this.a.aA() && asb.a($$0.c) == asb.a($$1.c) && asb.a($$0.e) == asb.a($$1.e)) {
               this.c.a();
            }
         }

         abc.a(this.b, this.a, this.c, this.l);
         if (!this.l()) {
            ehh $$2 = this.c.a(this.a);
   ...
   protected double a(ehh $$0) {
      gw $$1 = gw.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : eba.a(this.b, $$1);
   }
   ...
   private boolean c(ehh $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ehh $$1 = ehh.c(this.c.g());
         if (!$$0.a((ho)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ehh $$2 = ehh.c(this.c.d(this.c.f() + 1));
            ehh $$3 = $$1.d($$0);
            ehh $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void R_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eat $$1 = this.c.a($$0);
            eat $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dfd $$3 = this.b.a_(new gw($$1.a, $$1.b, $$1.c));
            if ($$3.a(apv.bk)) {
   ...
   public boolean b(ear $$0) {
      return $$0 != ear.n && $$0 != ear.p && $$0 != ear.d;
   }

   protected static boolean a(bjo $$0, ehh $$1, ehh $$2, boolean $$3) {
      ehh $$4 = new ehh($$2.c, $$2.d + (double)$$0.dg() * 0.5, $$2.e);
      return $$0.dL().a(new cpk($$1, $$4, cpk.a.a, $$3 ? cpk.b.c : cpk.b.a, $$0)).c() == ehf.a.a;
   }
   ...
   public boolean b(gw $$0) {
      if (this.m) {
         ...
         eat $$1 = this.c.d();
         ehh $$2 = new ehh(((double)$$1.a + this.a.dq()) / 2.0, ((double)$$1.b + this.a.ds()) / 2.0, ((double)$$1.c + this.a.dw()) / 2.0);
