...
public class ftt extends ftx {
   ...
   protected void aT_() {
      ...
      this.E = new fon(this.p, 50, 40, this.n - 100, 20, this.A);
      this.E.f(1230);
      fzg $$0 = this.z.a.l().k();
      ke $$1 = $$0.a();
      css $$2 = $$0.h().b();
      ...
      this.F = this.z.k();
      this.d(this.E);
      this.C = this.c(new ftt.a($$1, $$2));
      this.D = this.c(foe.a(xv.c("createWorld.customize.presets.select"), $$4x -> {
         emm $$5x = a($$6, $$3, $$4, $$5, this.E.a(), this.F);
         this.z.a($$5x);
         this.m.a(this.z);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(foe.a(xu.e, $$0x -> this.m.a(this.z)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends fpb<ftt.a.a> {
      public a(final ke $$0, final css $$1) {
         super(ftt.this.m, ftt.this.n, ftt.this.o - 117, 80, 24);
         ...
         for (jq<emk> $$2 : $$0.e(mb.aQ).c(axz.a)) {
            ...
            if (!$$3.isEmpty()) {
               ...
               this.b(new ftt.a.a($$2));
            }
         }
      }

      public void a(@Nullable ftt.a.a $$0) {
         super.a($$0);
         ftt.this.c($$0 != null);
      }
      ...
      public class a extends fpb.a<ftt.a.a> {
         ...
         public a(final jq<emk> $$1) {
            this.c = $$1.a();
            this.d = $$1.e().map($$0x -> xv.c($$0x.a().h("flat_world_preset"))).orElse(ftt.a);
         }

         @Override
         public void a(fnr $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            this.a($$0, $$3, $$2, this.c.a().a());
            $$0.a(ftt.this.p, this.d, $$3 + 18 + 5, $$2 + 6, 16777215, false);
         }
         ...
         void b() {
            a.this.a(this);
            ftt.this.F = this.c.b();
            ftt.this.E.a(ftt.a(ftt.this.F));
            ftt.this.E.b(false);
         }

         private void a(fnr $$0, int $$1, int $$2, cxk $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cxo($$3), $$1 + 2, $$2 + 2);
         }

         private void a(fnr $$0, int $$1, int $$2) {
            $$0.a(glu::C, ftt.b, $$1, $$2, 18, 18);
         }
