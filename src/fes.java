...
public class fes {
   ...
   public fes(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public fes(fex $$0, fex $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static fes a(era $$0) {
      return new fes((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static fes a(fex $$0) {
      return new fes($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static fes a(iv $$0, iv $$1) {
      return new fes(
   ...
   public fes a(double $$0) {
      return new fes($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public fes b(double $$0) {
      return new fes(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public fes c(double $$0) {
      return new fes(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public fes d(double $$0) {
      return new fes(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public fes e(double $$0) {
      return new fes(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public fes f(double $$0) {
      return new fes(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public fes b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public fes c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public fes d(double $$0, double $$1, double $$2) {
      return new fes(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public fes f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public fes h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fex> b(fex $$0, fex $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fex> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fex $$6, fex $$7) {
   ...
   @Nullable
   public static fet a(Iterable<fes> $$0, fex $$1, fex $$2, iv $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new fet($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jb a(fes $$0, fex $$1, double[] $$2, @Nullable jb $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jb a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fex $$6, double[] $$7, @Nullable jb $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fex $$0, List<fes> $$1) {
      fex $$2 = this.f();
      fex $$3 = $$2.e($$0);

      for (fes $$4 : $$1) {
         fes $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fex f() {
      return new fex(azm.d(0.5, this.a, this.d), azm.d(0.5, this.b, this.e), azm.d(0.5, this.c, this.f));
   }

   public fex g() {
      return new fex(azm.d(0.5, this.a, this.d), this.b, azm.d(0.5, this.c, this.f));
   }

   public fex h() {
      return new fex(this.a, this.b, this.c);
   }

   public fex i() {
      return new fex(this.d, this.e, this.f);
   }

   public static fes a(fex $$0, double $$1, double $$2, double $$3) {
      return new fes($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
   ...
   public static class a {
      ...
      public fes a() {
         return new fes((double)this.a, (double)this.b, (double)this.c, (double)this.d, (double)this.e, (double)this.f);
      }
   }
}
