...
public enum fes implements bai {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bai.a<fes> t = bai.a(fes::values);
   public static final IntFunction<fes> u = aya.a(fes::a, values(), aya.a.a);
   private final int v;
   private final String w;

   private fes(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
