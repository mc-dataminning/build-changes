...
public class fes extends fdy<ciu> {
   ...
   protected void aN_() {
      super.aN_();
      this.M = new fjd(this.f.aP().a(fmu.m));
   }
   ...
   private void d(ews $$0, int $$1, int $$2, float $$3) {
      ...
      this.M.a(0.0F, $$8, $$9, $$4);
      eqd $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, gec.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      eov.b();
   }
