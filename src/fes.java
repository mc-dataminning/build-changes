...
public class fes {
   ...
   public void a(ffc $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == ffc.a) {
            fjh.b($$1, fjh.a.a, xl.c("narrator.toast.disabled"), null);
         } else {
            fjh.b($$1, fjh.a.a, xl.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fjh.b($$1, fjh.a.a, xl.c("narrator.toast.disabled"), xl.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fes.a("Narrator library is not active");
      }
   }
