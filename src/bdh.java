...
public class bdh {
   ...
   private bdh(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bdh a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bdh($$0, $$1);
   }

   public bdh.d a() throws IOException {
      bdh.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bdh.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bdh.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bdh.c $$3 = bdh.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bdh.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bdh.a($$0, $$3);
            }
         }
   ...
   public bdh.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bdh.c> $$2 = this.a().c();
      ...
      bdh.e $$4 = new bdh.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bdh.c b) implements bdh.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bdh.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bdh.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bdh.b> {
      private final List<bdh.b> a;

      d(List<bdh.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bdh.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bdh.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bdh.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bdh.d a() {
         ListIterator<bdh.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bdh.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bdh.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bdh.b> b() {
         return this.a.stream();
      }

      public Set<bdh.c> c() {
         return this.a.stream().map(bdh.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bdh.c b) implements bdh.b {
