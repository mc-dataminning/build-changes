...
public interface bly<T, F> {
   ...
   public static final class a implements bly<bly.b, Runnable> {
   ...
   public static final class c<T> implements bly<T, T> {
