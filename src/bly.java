...
public class bly {
   ...
   private bly(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bly a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bly($$0, $$1);
   }

   public bly.d a() throws IOException {
      bly.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bly.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bly.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bly.c $$3 = bly.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bly.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bly.a($$0, $$3);
            }
         }
   ...
   public bly.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bly.c> $$2 = this.a().c();
      ...
      bly.e $$4 = new bly.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bly.c b) implements bly.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bly.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bly.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bly.b> {
      private final List<bly.b> a;

      d(List<bly.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bly.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bly.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bly.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bly.d a() {
         ListIterator<bly.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bly.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bly.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bly.b> b() {
         return this.a.stream();
      }

      public Set<bly.c> c() {
         return this.a.stream().map(bly.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bly.c b) implements bly.b {
