...
public class ov implements oo {
   ...
   public ov(op $$0, daw.a<?> $$1, dad $$2, def $$3, int $$4) {
      this.b = $$0;
      this.h = $$1;
      this.c = $$3.q();
      this.d = $$2;
   ...
   public static ov a(dad $$0, op $$1, def $$2) {
      return new ov($$1, dbe::new, $$0, $$2, 1);
   }

   public static ov a(dad $$0, op $$1, def $$2, int $$3) {
      return new ov($$1, dbe::new, $$0, $$2, $$3);
   }
   ...
   public void a(oq $$0, alc $$1) {
      ...
      this.f.forEach($$2::a);
      daw $$3 = this.h.create(Objects.requireNonNullElse(this.g, ""), this.d, new cvp(this.c, this.e));
