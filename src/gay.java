...
public class gay extends fys {
   ...
   protected void aO_() {
      ...
      int $$2 = $$1 ? 3 : 2;
      int $$3 = a($$2);
      this.w = new ftj(this.p, $$0, 40, 316, 20, wy.c("test_instance_block.test_id"));
      this.w.f(128);
      ...
      this.c(this.w);
      this.A = new ftk($$0, 70, 316, 8 * 9, wy.b(""), this.p);
      this.c(this.A);
      ka $$5 = this.v.t();
      int $$6 = 0;
      this.x = new ftj(this.p, this.a($$6++, 5), 160, a(5), 20, wy.c("structure_block.size.x"));
      this.x.f(15);
      this.c(this.x);
      this.y = new ftj(this.p, this.a($$6++, 5), 160, a(5), 20, wy.c("structure_block.size.y"));
      this.y.f(15);
      this.c(this.y);
      this.z = new ftj(this.p, this.a($$6++, 5), 160, a(5), 20, wy.c("structure_block.size.z"));
      this.z.f(15);
      this.c(this.z);
      this.a($$5);
      this.E = this.c(fth.<dtl>a(gay::a).a(dtl.values()).a(this.v.u()).a().a(this.a($$6++, 5), 160, a(5), 20, d, ($$0x, $$1x) -> this.m()));
      this.D = this.c(fth.b(!this.v.s()).a().a(this.a($$6++, 5), 160, a(5), 20, c));
      $$6 = 0;
      this.c(fta.a(wy.c("test_instance.action.reset"), $$0x -> {
         this.a(aiq.a.d);
         this.m.a(null);
      }).a(this.a($$6++, $$2), 185, $$3, 20).a());
      this.B = this.c(fta.a(wy.c("test_instance.action.save"), $$0x -> {
         this.a(aiq.a.e);
         this.m.a(null);
      }).a(this.a($$6++, $$2), 185, $$3, 20).a());
      if ($$1) {
         this.C = this.c(fta.a(wy.b("Export Structure"), $$0x -> {
            this.a(aiq.a.f);
            this.m.a(null);
         }).a(this.a($$6++, $$2), 185, $$3, 20).a());
      }

      this.c(fta.a(wy.c("test_instance.action.run"), $$0x -> {
         this.a(aiq.a.g);
         this.m.a(null);
      }).a(this.a(0, 3), 210, a(3), 20).a());
      this.c(fta.a(wx.d, $$0x -> this.E()).a(this.a(1, 3), 210, a(3), 20).a());
      this.c(fta.a(wx.e, $$0x -> this.F()).a(this.a(2, 3), 210, a(3), 20).a());
      this.c(true);
   }

   private void m() {
      boolean $$0 = this.E.a() == dtl.a && alg.c(this.w.a()) != null;
      this.B.j = $$0;
      if (this.C != null) {
         this.C.j = $$0;
      }
