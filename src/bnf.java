...
public class bnf extends bnk {
   public static final Codec<bnf> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bnf a(float $$0, float $$1, int $$2, int $$3) {
      return new bnf($$0, $$1, $$2, $$3);
   }

   private bnf(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(axt $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)axm.a(axm.c($$0, $$1, $$2), $$3, $$4);
   }
