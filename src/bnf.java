...
public class bnf extends bmv {
   ...
   public boolean a() {
      ...
      if ($$0 - this.k < 20L) {
         ...
         if ($$1 == null) {
            ...
            return this.d != null ? true : this.a($$1) >= this.a.i($$1.dn(), $$1.dp(), $$1.dt());
         }
      }
   }
   ...
   public boolean b() {
      ...
      if ($$0 == null) {
         ...
         return !this.a.a($$0.di()) ? false : !($$0 instanceof byo) || !$$0.G_() && !((byo)$$0).f();
      }
   }
   ...
   public void e() {
      ...
      if ($$0 != null) {
         ...
         if ((this.c || this.a.K().a($$0))
            && this.h <= 0
            && (this.e == 0.0 && this.f == 0.0 && this.g == 0.0 || $$0.i(this.e, this.f, this.g) >= 1.0 || this.a.ec().i() < 0.05F)) {
            this.e = $$0.dn();
            this.f = $$0.dp();
            this.g = $$0.dt();
   ...
   protected double a(bfz $$0) {
      return (double)(this.a.dd() * 2.0F * this.a.dd() * 2.0F + $$0.dd());
   }
}
