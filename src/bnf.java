...
public abstract class bnf extends bxx implements bms {
   protected static final agm<Byte> bT = agp.a(bnf.class, ago.a);
   protected static final agm<Optional<UUID>> bU = agp.a(bnf.class, ago.q);
   private boolean bW;

   protected bnf(bly<? extends bnf> $$0, cto $$1) {
      super($$0, $$1);
      this.w();
   }
   ...
   @Override
   public void a(bks $$0) {
      if (!this.dM().B && this.dM().Z().b(ctk.n) && this.R_() instanceof ane) {
         this.R_().a(this.eK().a());
      }
