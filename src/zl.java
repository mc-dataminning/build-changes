...
public class zl<B extends ByteBuf, V, T> implements zm<B, V> {
   ...
   private final List<zl.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   zl(Function<V, ? extends T> $$0, List<zl.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public static class a<B extends ByteBuf, V, T> {
      private final List<zl.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
   ...
   static record b<B, V, T>(zm<? super B, ? extends V> a, T b) {
   }
}
