...
public class fea extends fec {
   public static final int a = 854;
   public static final int b = 480;
   static final fea.b l = new fea.b(854, 480);

   public fea(int $$0, int $$1) {
      super(true);
      this.e($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final fea.a[] e = values();
   ...
   static class b {
      ...
      static List<fea.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fea.b($$0, $$1), fea.l) : ImmutableList.of(fea.l);
      }
