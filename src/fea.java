...
public class fea implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fea.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fea(List<fea.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fea a(BufferedReader $$0) {
      return new fea($$0.lines().flatMap($$0x -> fea.a.a($$0x).stream()).toList());
   }

   public static record a(fea.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fea.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fea.a(fea.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fea.a(fea.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fea.a(fea.b.b, $$3));
      ...
      static fea.a b(String $$0) {
         return new fea.a(fea.b.a, "glob:" + $$0);
      }

      static fea.a c(String $$0) {
         return new fea.a(fea.b.a, "regex:" + $$0);
      }

      static fea.a d(String $$0) {
         return new fea.a(fea.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fea.b a = FileSystem::getPathMatcher;
      fea.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
