public abstract class fea<T extends cib> extends fdz<T> implements fgu {
   public final fgk x;
   private boolean y;
   private final ahg z;
   private final ahg A;
   ...
   public fea(T $$0, fgk $$1, cfg $$2, vf $$3, ahg $$4, ahg $$5, ahg $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aN_() {
      ...
      this.d(new exr(this.t + 20, this.h / 2 - 49, 20, 18, fgo.a, $$0 -> {
         this.x.e();
         this.t = this.x.a(this.g, this.c);
