...
public class ges {
   ...
   public gel a(Vector3f $$0, Vector3f $$1, gen $$2, goz $$3, je $$4, gri $$5, @Nullable geo $$6, boolean $$7, alf $$8) {
      gep $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ayz.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ayz.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ayz.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ayz.i($$11, $$9.a[3], $$13);
      ...
      return new gel($$14, $$2.c, $$15, $$3, $$7);
   }

   public static gep a(gep $$0, je $$1, j $$2, alf $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ayz.b($$23), ayz.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new gep(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(gep $$0, goz $$1, je $$2, float[] $$3, j $$4, @Nullable geo $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, je $$2, gep $$3, float[] $$4, goz $$5, j $$6, @Nullable geo $$7, boolean $$8) {
      gdf.b $$9 = gdf.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, goz $$3, gep $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable geo $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
