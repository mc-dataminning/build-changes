...
public class anc {
   ...
   private static int a(ep $$0, Collection<? extends bst> $$1, ji<brz> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      brz $$6 = $$2.a();
      int $$7 = 0;
      int $$8;
      if ($$3 != null) {
      ...
      for (bst $$13 : $$1) {
         if ($$13 instanceof bto) {
            bsb $$14 = new bsb($$2, $$8, $$4, false, $$5);
            if (((bto)$$13).b($$14, $$0.f())) {
               $$7++;
            }
         }
      ...
      if ($$7 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xo.a("commands.effect.give.success.single", $$6.e(), $$1.iterator().next().O_(), $$8 / 20), true);
         } else {
            $$0.a(() -> xo.a("commands.effect.give.success.multiple", $$6.e(), $$1.size(), $$8 / 20), true);
         }
   ...
   private static int a(ep $$0, Collection<? extends bst> $$1) throws CommandSyntaxException {
      int $$2 = 0;

      for (bst $$3 : $$1) {
         if ($$3 instanceof bto && ((bto)$$3).ew()) {
            $$2++;
         }
      }
      ...
      if ($$2 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xo.a("commands.effect.clear.everything.success.single", $$1.iterator().next().O_()), true);
         } else {
   ...
   private static int a(ep $$0, Collection<? extends bst> $$1, ji<brz> $$2) throws CommandSyntaxException {
      brz $$3 = $$2.a();
      int $$4 = 0;

      for (bst $$5 : $$1) {
         if ($$5 instanceof bto && ((bto)$$5).e($$2)) {
            $$4++;
         }
      }
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> xo.a("commands.effect.clear.specific.success.single", $$3.e(), $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> xo.a("commands.effect.clear.specific.success.multiple", $$3.e(), $$1.size()), true);
         }
