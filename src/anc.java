...
public class anc {
   ...
   private static int a(et $$0, Collection<? extends bto> $$1, jn<bst> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      bst $$6 = $$2.a();
      int $$7 = 0;
      int $$8;
      if ($$3 != null) {
      ...
      for (bto $$13 : $$1) {
         if ($$13 instanceof buk) {
            bsv $$14 = new bsv($$2, $$8, $$4, false, $$5);
            if (((buk)$$13).b($$14, $$0.f())) {
               $$7++;
            }
         }
   ...
   private static int a(et $$0, Collection<? extends bto> $$1) throws CommandSyntaxException {
      int $$2 = 0;

      for (bto $$3 : $$1) {
         if ($$3 instanceof buk && ((buk)$$3).ew()) {
            $$2++;
         }
      }
   ...
   private static int a(et $$0, Collection<? extends bto> $$1, jn<bst> $$2) throws CommandSyntaxException {
      bst $$3 = $$2.a();
      int $$4 = 0;

      for (bto $$5 : $$1) {
         if ($$5 instanceof buk && ((buk)$$5).e($$2)) {
            $$4++;
         }
      }
