...
public class anc {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eq.a(
                                       ...
                                       .then(eq.a("at").then(eq.a("targets", fc.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bsp $$2x : fc.c($$0x, "targets")) {
                                             $$1x.add(((ep)$$0x.getSource()).a((arb)$$2x.dP()).a($$2x.dn()).a($$2x.bM()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eq.a("positioned")
                                       ...
                                       .then(eq.a("over").then(eq.a("heightmap", ff.a()).redirect($$2, $$0x -> {
                                          evm $$1x = ((ep)$$0x.getSource()).d();
                                          arb $$2x = ((ep)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kb.b($$3), kb.b($$4))) {
                                             throw gl.a.create();
                                          } else {
                                             int $$5 = $$2x.a(ff.a($$0x, "heightmap"), ayu.a($$3), ayu.a($$4));
                                             return ((ep)$$0x.getSource()).a(new evm($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         eq.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)eq.a("id", fq.a())
                     .suggests(amm.a)
                     .then(eq.a("value").redirect($$0, $$1x -> a((ep)$$1x.getSource(), amm.a($$1x), true, $$2))))
                  .then(eq.a("max").redirect($$0, $$1x -> a((ep)$$1x.getSource(), amm.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             eq.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         fh.a($$2xx, "path"),
                                                         $$1xxx -> uw.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          eq.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      fh.a($$2xx, "path"),
                                                      $$1xxx -> uu.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       eq.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   fh.a($$2xx, "path"),
                                                   $$1xxx -> vj.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    eq.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                fh.a($$2xx, "path"),
                                                $$1xxx -> uz.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 eq.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             fh.a($$2xx, "path"),
                                             $$1xxx -> us.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              eq.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          fh.a($$2xx, "path"),
                                          $$1xxx -> up.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static ep a(ep $$0, Collection<ewp> $$1, ewi $$2, boolean $$3) {
      ewq $$4 = $$0.l().aK();
      return $$0.a(($$4x, $$5) -> {
         for (ewp $$6 : $$1) {
            ewo $$7 = $$4.c($$6, $$2);
   ...
   private static ep a(ep $$0, amb $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ep a(ep $$0, apq $$1, fh.g $$2, IntFunction<vo> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            ur $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(arb $$0, iz $$1) {
      dba $$2 = new dba($$1);
      dud $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == aqu.d && $$0.c($$2.a());
   }
                                          ...
                                          eq.a("pos", gl.a())
                                             .then(
                                                a(
                                                   ...
                                                   eq.a("block", gh.a($$3)),
                                                   $$2,
                                                   $$0x -> gh.a($$0x, "block").test(new dsb(((ep)$$0x.getSource()).e(), gl.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     eq.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)eq.a("entities", fc.b()).fork($$0, $$1x -> a($$1x, $$2, !fc.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (anc.b)($$0x -> fc.c($$0x, "entities").size())))
                        )
                  ))
               .then(eq.a("predicate").then(a($$0, eq.a("predicate", fr.c($$3)).suggests(f), $$2, $$0x -> a((ep)$$0x.getSource(), fr.c($$0x, "predicate"))))))
            .then(eq.a("function").then(eq.a("name", gx.a()).suggests(anh.b).fork($$0, new anc.d($$2)))))
         .then(
                                 ...
                                 eq.a("slots", fy.a())
                                    .then(
                                       ((RequiredArgumentBuilder)eq.a("item_predicate", hb.a($$3))
                                          ...
                                          .executes(a($$2, (anc.b)($$0x -> a(fc.b($$0x, "entities"), fy.a($$0x, "slots"), hb.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              eq.a("slots", fy.a())
                                 .then(
                                    ((RequiredArgumentBuilder)eq.a("item_predicate", hb.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (anc.b)($$0x -> a((ep)$$0x.getSource(), gl.a($$0x, "pos"), fy.a($$0x, "slots"), hb.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)eq.a("path", fh.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fh.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (anc.b)($$1xx -> a($$4.a($$1xx), fh.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bsp> $$0, crl $$1, Predicate<cuk> $$2) {
      int $$3 = 0;
   ...
   private static int a(ep $$0, iz $$1, crl $$2, Predicate<cuk> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bqi $$5 = anm.a($$0, $$1, anm.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<ep> a(boolean $$0, anc.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ep)$$1x.getSource()).a(() -> xl.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ep)$$1x.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(apq $$0, fh.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ep> $$0, anc.e $$1) throws CommandSyntaxException {
      ewp $$2 = fu.a($$0, "target");
      ewi $$3 = fj.a($$0, "targetObjective");
      ewp $$4 = fu.a($$0, "source");
      ewi $$5 = fj.a($$0, "sourceObjective");
      ewq $$6 = ((ep)$$0.getSource()).l().aK();
      ewm $$7 = $$6.d($$2, $$3);
      ewm $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ep> $$0, de.d $$1) throws CommandSyntaxException {
      ewp $$2 = fu.a($$0, "target");
      ewi $$3 = fj.a($$0, "targetObjective");
      ewq $$4 = ((ep)$$0.getSource()).l().aK();
      ewm $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ep $$0, ji<etn> $$1) {
      arb $$2 = $$0.e();
      eqg $$3 = new eqg.a($$2).a(esz.f, $$0.d()).b(esz.a, $$0.f()).a(esy.d);
      eqd $$4 = new eqd.a($$3).a(Optional.empty());
      $$4.b(eqd.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<ep, ?> a(CommandNode<ep> $$0, ArgumentBuilder<ep, ?> $$1, boolean $$2, anc.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ep)$$2x.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ep> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ep)$$0.getSource()).a(() -> xl.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ep> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ep)$$0.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(arb $$0, iz $$1, iz $$2, iz $$3, boolean $$4) throws CommandSyntaxException {
      ehx $$5 = ehx.a($$1, $$2);
      ehx $$6 = ehx.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ep> a(Function<bsp, Optional<bsp>> $$0) {
      return $$1 -> {
         ep $$2 = (ep)$$1.getSource();
         bsp $$3 = $$2.f();
   ...
   private static RedirectModifier<ep> b(Function<bsp, Stream<bsp>> $$0) {
      return $$1 -> {
         ep $$2 = (ep)$$1.getSource();
         bsp $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<ep> a(CommandNode<ep> $$0, LiteralArgumentBuilder<ep> $$1) {
      return (LiteralArgumentBuilder<ep>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              eq.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bsp, Optional<bsp>>)($$0x -> $$0x instanceof bts $$1x ? Optional.ofNullable($$1x.P_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              eq.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<bsp, Optional<bsp>>)($$0x -> $$0x instanceof btm $$1x ? Optional.ofNullable($$1x.gf()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           eq.a("target")
                              .fork($$0, a((Function<bsp, Optional<bsp>>)($$0x -> $$0x instanceof bui $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
                        ))
                     .then(
                        eq.a("attacker")
                           .fork($$0, a((Function<bsp, Optional<bsp>>)($$0x -> $$0x instanceof bsm $$1x ? Optional.ofNullable($$1x.T_()) : Optional.empty())))
                     ))
                  .then(eq.a("vehicle").fork($$0, a((Function<bsp, Optional<bsp>>)($$0x -> Optional.ofNullable($$0x.dc()))))))
               .then(eq.a("controller").fork($$0, a((Function<bsp, Optional<bsp>>)($$0x -> Optional.ofNullable($$0x.cQ()))))))
            .then(
               eq.a("origin").fork($$0, a((Function<bsp, Optional<bsp>>)($$0x -> $$0x instanceof buj $$1x ? Optional.ofNullable($$1x.s()) : Optional.empty())))
            ))
         .then(eq.a("passengers").fork($$0, b((Function<bsp, Stream<bsp>>)($$0x -> $$0x.cS().stream()))));
   }

   private static ep a(ep $$0, ji.c<bsv<?>> $$1) throws CommandSyntaxException {
      bsp $$2 = apa.a($$0, $$1, $$0.d(), new ur(), true);
      return $$0.a($$2);
   }

   public static <T extends er<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable ur $$5, hp<T> $$6, anc.a<T, Collection<ib<T>>> $$7, hj $$8
   ) {
   ...
   static class d implements hm.a<ep> {
      ...
      public void a(ep $$0, List<ep> $$1, ContextChain<ep> $$2, hj $$3, hp<ep> $$4) {
         anc.a($$0, $$1, anh::a, this.a, $$2, null, $$4, $$0x -> gx.a($$0x, "name"), $$3);
      }
   }
