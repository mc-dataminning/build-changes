...
public class anc {
   ...
   private static String a(long $$0) {
      return String.format("%.1f", (float)$$0 / (float)axh.b);
   }
   ...
   private static int a(du $$0) {
      ...
      if ($$1.a()) {
         $$0.a(() -> vq.c("commands.tick.status.sprinting"), false);
         $$0.a(() -> vq.a("commands.tick.query.rate.sprinting", $$4, $$2), false);
      } else {
         if ($$1.l()) {
      ...
      $$0.a(() -> vq.a("commands.tick.query.percentiles", $$7, $$8, $$9, $$6.length), false);
      return (int)$$3;
   }
   ...
   private static int a(du $$0, int $$1) {
      ...
      $$0.a(() -> vq.c("commands.tick.status.sprinting"), true);
      return 1;
   }
   ...
   private static int a(du $$0, boolean $$1) {
      ...
      $$2.a($$1);
      if ($$1) {
         $$0.a(() -> vq.c("commands.tick.status.frozen"), true);
      } else {
         $$0.a(() -> vq.c("commands.tick.status.running"), true);
      }
   ...
   private static int b(du $$0, int $$1) {
      ...
      if ($$3) {
         ...
         $$0.b(vq.c("commands.tick.step.fail"));
      }
   ...
   private static int b(du $$0) {
      ...
      if ($$2) {
         ...
         $$0.b(vq.c("commands.tick.step.stop.fail"));
         return 0;
      }
   }
   ...
   private static int c(du $$0) {
      ...
      if ($$2) {
         ...
         $$0.b(vq.c("commands.tick.sprint.stop.fail"));
         return 0;
      }
   }
}
