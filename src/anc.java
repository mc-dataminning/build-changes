...
public class anc {
   ...
   private static Optional<? extends jb.b<ehj>> a(fi.c<ehj> $$0, jk<ehj> $$1) {
      return (Optional<? extends jb.b<ehj>>)$$0.a().map($$1x -> $$1.b($$1x).map($$0xx -> jb.a($$0xx)), $$1::b);
   }

   private static int a(ee $$0, fi.c<ehj> $$1) throws CommandSyntaxException {
      jk<ehj> $$2 = $$0.e().H_().d(lf.aJ);
      jb<ehj> $$3 = (jb<ehj>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      io $$4 = io.a($$0.d());
      aqm $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(ac.d);
      Pair<io, ix<ehj>> $$7 = $$5.l().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(ee $$0, fh.c<dbw> $$1) throws CommandSyntaxException {
      io $$2 = io.a($$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(ac.d);
      Pair<io, ix<dbw>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(ee $$0, fh.c<cdv> $$1) throws CommandSyntaxException {
      io $$2 = io.a($$0.d());
      aqm $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(ac.d);
      Optional<Pair<ix<cdv>, io>> $$5 = $$3.y().e($$1, $$2, 256, cds.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(ee $$0, io $$1, Pair<io, ? extends ix<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      io $$7 = (io)$$2.getFirst();
      int $$8 = $$4 ? ayd.d(ayd.c((float)$$1.j($$7))) : ayd.d(a($$1.u(), $$1.w(), $$7.u(), $$7.w()));
