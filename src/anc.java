...
public class anc {
   ...
   final List<ts> g = Collections.synchronizedList(Lists.newArrayList());

   public anc(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new amx(anc.this.d()));
               ts.a($$1, wl.a, null);
               int $$2 = anc.this.e.m();
               ts $$3 = (ts)($$2 > 0 ? new ud($$2) : new ts(wl.a));
               anc.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new ane(anc.this.e, $$3));
            }
            ...
            if (!$$1.l()) {
               if ($$1.k()) {
                  try {
                     ...
                     ur $$3 = ur.b("Internal server error");
                     $$1.a(new wp($$3), ub.a(() -> $$1.a($$3)));
                     $$1.o();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<anc.a.a> d = Lists.newArrayList();
