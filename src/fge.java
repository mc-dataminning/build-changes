public class fge<T extends bzk> extends ffm<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      float $$7 = 16.0F;
      this.g.g = arx.b($$6) * 16.0F * (float) (Math.PI / 180.0);
      this.h.g = arx.b($$6) * 16.0F * (float) (Math.PI / 180.0);
      this.i.g = -this.g.g;
      this.j.g = -this.h.g;
      this.k.e = -(5.0F + arx.b($$6 * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
      this.l.e = -(5.0F + arx.b($$6 * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
   }
}
