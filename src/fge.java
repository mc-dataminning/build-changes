...
public class fge extends fgo {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fjx.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fik.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fjx.Q().b($$4)) {
               try {
