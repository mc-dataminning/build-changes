...
public class ait {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ui.c("commands.playsound.failed"));

   public static void a(CommandDispatcher<du> $$0) {
      RequiredArgumentBuilder<du, afw> $$1 = dv.a("sound", eu.a()).suggests(hj.c);
   ...
   private static LiteralArgumentBuilder<du> a(aqe $$0) {
   ...
   private static int a(du $$0, Collection<alr> $$1, afw $$2, aqe $$3, eif $$4, float $$5, float $$6, float $$7) throws CommandSyntaxException {
      ib<aqc> $$8 = ib.a(aqc.a($$2));
      double $$9 = (double)asy.k($$8.a().a($$5));
      int $$10 = 0;
      long $$11 = $$0.f().E_().g();
      ...
      for (alr $$12 : $$1) {
         ...
         if ($$16 > $$9) {
            ...
            $$17 = new eif($$12.dq() + $$13 / $$19 * 2.0, $$12.ds() + $$14 / $$19 * 2.0, $$12.dw() + $$15 / $$19 * 2.0);
            $$18 = $$7;
         }

         $$12.c.b(new abl($$8, $$3, $$17.a(), $$17.b(), $$17.c(), $$18, $$6, $$11));
         $$10++;
      }
      ...
      if ($$10 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> ui.a("commands.playsound.success.single", ui.a($$2), $$1.iterator().next().O_()), true);
         } else {
            $$0.a(() -> ui.a("commands.playsound.success.multiple", ui.a($$2), $$1.size()), true);
         }
