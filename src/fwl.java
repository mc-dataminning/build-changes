public class fwl extends fux<cud> {
   private static final aku G = aku.b("container/stonecutter/scroller");
   private static final aku H = aku.b("container/stonecutter/scroller_disabled");
   private static final aku I = aku.b("container/stonecutter/recipe_selected");
   private static final aku J = aku.b("container/stonecutter/recipe_highlighted");
   private static final aku K = aku.b("container/stonecutter/recipe");
   private static final aku L = aku.b("textures/gui/container/stonecutter.png");
   ...
   protected void a(fob $$0, float $$1, int $$2, int $$3) {
      ...
      aku $$7 = this.H() ? G : H;
      $$0.a(gmf::H, $$7, $$4 + 119, $$5 + 15 + $$6, 12, 15);
      int $$8 = this.C + 52;
      int $$9 = this.D + 14;
      int $$10 = this.X + 12;
      this.a($$0, $$2, $$3, $$8, $$9, $$10);
      ...
      if (this.Y) {
         ...
         for (int $$7 = this.X; $$7 < $$5 && $$7 < $$6.d(); $$7++) {
            ...
            if ($$1 >= $$9 && $$1 < $$9 + 16 && $$2 >= $$10 && $$2 < $$10 + 18) {
               baj $$11 = dco.a(this.m.s);
               dcn $$12 = $$6.e().get($$7).c().b();
   ...
   private void a(fob $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      for (int $$6 = this.X; $$6 < $$5 && $$6 < this.z.n(); $$6++) {
         ...
         $$0.a(gmf::H, $$11, $$8, $$10 - 1, 16, 18);
      }
   }

   private void a(fob $$0, int $$1, int $$2, int $$3) {
      dbp.b<dcc> $$4 = this.z.m();
      baj $$5 = dco.a(this.m.s);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (super.a($$0, $$1, $$2, $$3)) {
         ...
         if (this.H()) {
            ...
            this.V = ayy.a(this.V - $$5, 0.0F, 1.0F);
