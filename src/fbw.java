...
public class fbw implements aem<cmg>, ets, euk, ewg, fcb {
   public static final euc a = new euc(new aex("recipe_book/button"), new aex("recipe_book/button_highlighted"));
   private static final euc i = new euc(
      new aex("recipe_book/filter_enabled"),
      new aex("recipe_book/filter_disabled"),
      new aex("recipe_book/filter_enabled_highlighted"),
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (!this.g() || this.h.s.M_()) {
         ...
         this.o();
         return true;
      } else if (this.t.aD_() && this.t.v() && $$0 != 256) {
         return true;
      } else if (this.h.m.K.a($$0, $$1) && !this.t.aD_()) {
         this.z = true;
         this.t.b_(true);
         return true;
      } else {
