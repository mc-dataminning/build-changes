...
public class fbw implements Comparable<fbw> {
   private static final Map<String, fbw> h = Maps.newHashMap();
   private static final Map<evm.a, fbw> i = Maps.newHashMap();
   ...
   private final evm.a m;
   private final String n;
   private evm.a o;
   private boolean p;
   private int q;

   public static void a(evm.a $$0) {
      fbw $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(evm.a $$0, boolean $$1) {
      fbw $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fbw $$0 : h.values()) {
         if ($$0.o.a() == evm.b.a && $$0.o.b() != evm.bv.b()) {
            $$0.a(evm.a(fby.Q().aO().i(), $$0.o.b()));
         }
      }
   }
   ...
   public fbw(String $$0, int $$1, String $$2) {
      this($$0, evm.b.a, $$1, $$2);
   }

   public fbw(String $$0, evm.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(evm.a $$0) {
      this.o = $$0;
   }

   public int a(fbw $$0) {
      return this.n.equals($$0.n) ? gmx.a(this.l).compareTo(gmx.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<wi> a(String $$0) {
      fbw $$1 = h.get($$0);
      return $$1 == null ? () -> wi.c($$0) : $$1::k;
   }
   ...
   public boolean j() {
      return this.o.equals(evm.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == evm.bv.b() ? this.o.a() == evm.b.b && this.o.b() == $$1 : this.o.a() == evm.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == evm.b.c && this.o.b() == $$0;
   }
