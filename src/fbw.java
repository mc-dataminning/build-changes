...
public class fbw {
   ...
   public void a(cge $$0, eub $$1, float $$2, int $$3, int $$4) {
      chz $$5 = $$0.b(this.d);
   ...
   private void a(chz $$0, agg $$1, float $$2, eub $$3, int $$4, int $$5) {
      gbh $$6 = esr.N().a(gbg.e).apply($$1);
