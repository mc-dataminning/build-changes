...
public class efh extends eff {
   public static final MapCodec<efh> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  boz.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  boz.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final boz i;
   private final jb<ddy> j;

   public efh(int $$0, int $$1, int $$2, boz $$3, float $$4, boz $$5, jb<ddy> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<edn.a> a(dbd $$0, BiConsumer<io, drb> $$1, ayk $$2, int $$3, io $$4, ecx $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new edn.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dbd $$0, BiConsumer<io, drb> $$1, ayk $$2, int $$3, ecx $$4, List<edn.a> $$5, io.a $$6, int $$7, it $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new edn.a($$16, 0, false));
         $$5.add(new edn.a($$16.c(2), 0, false));
      }
   }
