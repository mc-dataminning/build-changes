...
public record efh(aex b) implements efp {
   private static final Logger c = LogUtils.getLogger();
   public static final Codec<efh> a = RecordCodecBuilder.create($$0 -> $$0.group(aex.a.fieldOf("name").forGetter(efh::c)).apply($$0, efh::new));
