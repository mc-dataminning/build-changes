...
public class eam extends dzz<ebw> {
   public eam(Codec<ebw> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eab<ebw> $$0) {
      io $$1 = $$0.e();
      dbu $$2 = $$0.b();
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? ayf.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(aym $$0, dba $$1, int $$2, int $$3, io $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, io $$2, dba $$3, boolean $$4, double $$5, io $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dba $$0, io $$1) {
      if ($$0.a_($$1.c()).a(dec.dN)) {
         this.a($$0, $$1.c(), dec.a.n());
      }
   }

   private void a(dba $$0, aym $$1, io $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, drd $$13) {
   ...
   private void a(io $$0, dba $$1, aym $$2, int $$3, int $$4, boolean $$5, boolean $$6, drd $$7) {
      drd $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dec.dP) || $$8.a(dec.dO) || $$8.a(dec.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dec.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dec.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, io $$2, int $$3, aym $$4) {
      float $$5 = 10.0F * ayf.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private static boolean c(drd $$0) {
      return $$0.a(dec.iC) || $$0.a(dec.dP) || $$0.a(dec.mW);
   }
   ...
   private void a(dba $$0, io $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dec.dN)) {
                  if (this.a((daf)$$0, $$10)) {
                     this.a($$0, $$10, dec.a.n());
                     this.a($$0, $$10.c(), dec.a.n());
                  } else if (c($$11)) {
                     drd[] $$12 = new drd[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
