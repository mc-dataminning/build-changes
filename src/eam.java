...
public class eam implements eat.c {
   ...
   private final ObjectListIterator<eam.a> h;
   private final ObjectListIterator<emu> i;

   public static eam a(dfq $$0, deb $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<eam.a> $$4 = new ObjectArrayList(10);
      ObjectList<emu> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != emc.a).forEach($$5x -> {
         emc $$6 = $$5x.h().d();
         ...
         for (elv $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eln) {
                  ...
                  $$4.add(new eam.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new eam($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public eam(ObjectListIterator<eam.a> $$0, ObjectListIterator<emu> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = azj.g($$0, $$1, $$2);
      return azj.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = azj.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * azj.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = azj.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(elj a, emc b, int c) {
   }
}
