...
@Deprecated
public class eam extends dzx<eam.a> {
   private static final drb a = dea.nc.n();

   public eam(Codec<eam.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dzz<eam.a> $$0) {
      io $$1 = $$0.e();
      dbs $$2 = $$0.b();
      ayk $$3 = $$0.d();
      eam.a $$4 = $$0.f();
   ...
   public static record a(eec b, eec c) implements ecb {
      public static final Codec<eam.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eec.a.fieldOf("fluid").forGetter(eam.a::a), eec.a.fieldOf("barrier").forGetter(eam.a::b)).apply($$0, eam.a::new)
      );
