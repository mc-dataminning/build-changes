...
public class evj {
   ...
   private static final Queue<evj.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile evj.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(evj::a), evh::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(evj::a), evh::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + evj.a(this.b) + ", type=" + evj.b(this.c) + ", severity=" + evj.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
