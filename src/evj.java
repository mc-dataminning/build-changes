...
public class evj implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<evj.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public evj(List<evj.a> $$0) {
      this.c = $$0;
   }
   ...
   public static evj a(BufferedReader $$0) {
      return new evj($$0.lines().flatMap($$0x -> evj.a.a($$0x).stream()).toList());
   }

   public static record a(evj.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<evj.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new evj.a(evj.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new evj.a(evj.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new evj.a(evj.b.b, $$3));
      ...
      static evj.a b(String $$0) {
         return new evj.a(evj.b.a, "glob:" + $$0);
      }

      static evj.a c(String $$0) {
         return new evj.a(evj.b.a, "regex:" + $$0);
      }

      static evj.a d(String $$0) {
         return new evj.a(evj.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      evj.b a = FileSystem::getPathMatcher;
      evj.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
