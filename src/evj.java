...
public class evj {
   ...
   private final evj.a g;

   @Deprecated
   public static evj a(azv $$0, evj.a $$1) {
      return new evj($$0, $$1, false);
   }

   public static evj a(azv $$0, int $$1, double... $$2) {
      return b($$0, new evj.a($$1, new DoubleArrayList($$2)));
   }

   public static evj b(azv $$0, evj.a $$1) {
      return new evj($$0, $$1, true);
   }

   private evj(azv $$0, evj.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<evj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(evj.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(evj.a::b))
               .apply($$0, evj.a::new)
      );
      public static final Codec<je<evj.a>> b = alc.a(mg.aX, a);
