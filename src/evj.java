...
public class evj {
   ...
   public evj(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evk> $$1) throws IOException {
   ...
   public List<evk> a(Path $$0) throws IOException {
      List<evk> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evk> a(Path $$0, boolean $$1) throws IOException {
      List<evk> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evk> $$1) throws IOException {
