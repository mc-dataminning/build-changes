...
public class bus extends bur {
   ...
   public static final int c = asb.f(2.4166098F);
   private static final aef<Byte> d = aei.a(bus.class, aeh.a);
   private static final int e = 1;
   private static final bty bS = bty.b().a(4.0);
   @Nullable
   private gw bT;

   public bus(bja<? extends bus> $$0, cqb $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   @Override
   public apf w() {
      return this.t() && this.ag.a(4) != 0 ? null : apg.bq;
   }
   ...
   public void l() {
      ...
      if (this.t()) {
         this.f(ehh.b);
         this.p(this.dq(), (double)asb.a(this.ds()) + 1.0 - (double)this.dg(), this.dw());
      } else {
   ...
   protected void X() {
      ...
      if (this.t()) {
         ...
         ehh $$6 = this.do();
         ehh $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.f($$7);
         float $$8 = (float)(asb.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = asb.g($$8 - this.dB());
         this.bm = 0.5F;
         this.r(this.dB() + $$9);
   ...
   public static boolean b(bja<bus> $$0, cqc $$1, bjq $$2, gw $$3, ash $$4) {
      if ($$3.v() >= $$1.y_()) {
         return false;
      } else {
         int $$5 = $$1.z($$3);
