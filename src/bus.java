...
public class bus extends bvm {
   private static final adz<gu> d = aec.a(bus.class, aeb.n);
   private static final adz<Boolean> e = aec.a(bus.class, aeb.k);
   private static final adz<Integer> bT = aec.a(bus.class, aeb.b);
   static final btl bU = btl.b().a(10.0).d();
   public static final int b = 4800;
   private static final int bV = 2400;
   public static final Predicate<byg> c = $$0 -> !$$0.r() && $$0.bv() && $$0.aX();

   public bus(bim<? extends bus> $$0, cpm $$1) {
      super($$0, $$1);
   ...
   @Override
   protected void w() {
      this.bO.a(0, new bpf(this));
      this.bO.a(0, new bre(this));
      this.bO.a(1, new bus.a(this));
      this.bO.a(2, new bus.b(this, 4.0));
      this.bO.a(4, new bqs(this, 1.0, 10));
      this.bO.a(4, new bqp(this));
      this.bO.a(5, new bqc(this, cbn.class, 6.0F));
      this.bO.a(5, new bpk(this, 10));
      this.bO.a(6, new bqe(this, 1.2F, true));
      this.bO.a(8, new bus.c());
      this.bO.a(8, new bpp(this));
      this.bO.a(9, new bpb<>(this, byx.class, 8.0F, 1.0, 1.0));
      this.bP.a(1, new brm(this, byx.class).a());
   }

   public static bke.a fZ() {
      return bja.x().a(bkf.a, 10.0).a(bkf.d, 1.2F).a(bkf.f, 3.0);
   }
   ...
   static class a extends bpu {
      ...
      public void e() {
         ...
         if (this.a.ga() || this.a.H().l()) {
            ehe $$1 = ehe.b(this.a.p());
            ehe $$2 = btp.a(this.a, 16, 1, $$1, (float) (Math.PI / 8));
            if ($$2 == null) {
               $$2 = btp.a(this.a, 8, 4, $$1, (float) (Math.PI / 2));
            }

            if ($$2 != null) {
               gu $$3 = gu.a($$2);
               if (!$$0.b_($$3).a(apq.a) || !$$0.a_($$3).a($$0, $$3, eat.b)) {
                  $$2 = btp.a(this.a, 8, 5, $$1, (float) (Math.PI / 2));
               }
            }
   ...
   static class b extends bpu {
      ...
      @Override
      public boolean a() {
         this.c = this.a.dK().a(bus.bU, this.a);
   ...
   class c extends bpu {
      ...
      @Override
      public boolean a() {
         if (this.b > bus.this.ah) {
            return false;
         } else {
            List<byg> $$0 = bus.this.dK().a(byg.class, bus.this.cG().c(8.0, 8.0, 8.0), bus.c);
            return !$$0.isEmpty() || !bus.this.c(bin.a).b();
         }
      }
      ...
      @Override
      public void d() {
         ciy $$0 = bus.this.c(bin.a);
         if (!$$0.b()) {
            this.a($$0);
            bus.this.a(bin.a, ciy.b);
            this.b = bus.this.ah + bus.this.ag.a(100);
         }
      }
      ...
      private void a(ciy $$0) {
         if (!$$0.b()) {
            double $$1 = bus.this.dt() - 0.3F;
            byg $$2 = new byg(bus.this.dK(), bus.this.dp(), $$1, bus.this.dv(), $$0);
            $$2.b(40);
            $$2.c(bus.this.cv());
            float $$3 = 0.3F;
            float $$4 = bus.this.ag.i() * (float) (Math.PI * 2);
            float $$5 = 0.02F * bus.this.ag.i();
            $$2.o(
               (double)(0.3F * -arp.a(bus.this.dA() * (float) (Math.PI / 180.0)) * arp.b(bus.this.dC() * (float) (Math.PI / 180.0)) + arp.b($$4) * $$5),
               (double)(0.3F * arp.a(bus.this.dC() * (float) (Math.PI / 180.0)) * 1.5F),
               (double)(0.3F * arp.b(bus.this.dA() * (float) (Math.PI / 180.0)) * arp.b(bus.this.dC() * (float) (Math.PI / 180.0)) + arp.a($$4) * $$5)
            );
            bus.this.dK().b($$2);
         }
      }
