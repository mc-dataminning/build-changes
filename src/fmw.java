...
public class fmw extends fnb {
   ...
   protected void aM_() {
      ...
      this.c(new fij(0, this.G ? 40 : 10, this.n, 9, this.l, this.p));
   }
   ...
   private void D() {
      ...
      $$1.a(this.a(v, () -> new fnq(this.m.s.cz.p(), this)));
      $$1.a(this.a(w, () -> new fnk(this, this.m.s.j())));
      ...
      $$1.a(this.a(z, () -> new fms(this, this.m.m)));
      if (this.m.U() && !this.m.V().r()) {
         $$1.a(this.a(A, () -> new fnc(this)));
      } else {
         $$1.a(this.a(B, () -> new frk(this)));
      }

      xo $$2 = this.m.T() ? C : xn.p;
      this.H = $$1.a(fhc.a($$2, $$0x -> {
         $$0x.j = false;
         this.m.aZ().a(this.m, this, this::E, true);
      }).a(204).a(), 2);
      $$0.a();
      fkn.a($$0, 0, 0, this.n, this.o, 0.5F, 0.25F);
      $$0.a(this::c);
   }
   ...
   private fhc a(xo $$0, Supplier<fnb> $$1) {
      return fhc.a($$0, $$1x -> this.m.a($$1.get())).a(98).a();
   }

   private fhc a(xo $$0, String $$1) {
      return fhc.a($$0, fls.b(this, $$1)).a(98).a();
   }
}
