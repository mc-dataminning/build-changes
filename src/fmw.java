...
public class fmw {
   ...
   public static List<fmw.a> a(String $$0, fmw.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fmw.a> a(String $$0, List<fmw.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fmw.a> a(List<String> $$0, List<fmw.b> $$1) {
      int $$2 = 0;
      List<fmw.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fmw.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fmw.b a(String $$0, String $$1) {
         return new fmw.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fmw.b a(String $$0) {
         return new fmw.b($$0);
      }
   }
}
