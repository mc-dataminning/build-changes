...
public class dca {
   public static final int a = ji.a(8);
   private static final int b = 2;
   private static final int c = 4;
   private static final int d = 3;
   private final dca.a e;
   private final long f;

   public dca(dca.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dca a(dca.a $$0) {
      return new dca($$0, this.f);
   }

   public ix<dby> a(io $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ix<dby> a(double $$0, double $$1, double $$2) {
      int $$3 = ji.a(ayf.a($$0));
      int $$4 = ji.a(ayf.a($$1));
      int $$5 = ji.a(ayf.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = aya.a($$7, $$0);
      double $$10 = b($$7);
      return ayf.k($$6 + $$10) + ayf.k($$5 + $$9) + ayf.k($$4 + $$8);
   }
   ...
   public interface a {
      ix<dby> getNoiseBiome(int var1, int var2, int var3);
   }
}
