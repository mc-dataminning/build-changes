...
public interface dca extends dba, dbh, dcn, dcy.a {
   @Nullable
   dtx a(int var1, int var2, duw var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dxt.a var1, int var2, int var3);

   int B_();

   dcy F_();

   default ji<dcw> t(iz $$0) {
      return this.F_().a($$0);
   }

   default Stream<dsb> c(evl $$0) {
      int $$1 = ayy.a($$0.a);
      int $$2 = ayy.a($$0.d);
      int $$3 = ayy.a($$0.b);
      int $$4 = ayy.a($$0.e);
   ...
   @Override
   default int a(iz $$0, dbi $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ji<dcw> getNoiseBiome(int $$0, int $$1, int $$2) {
      dtx $$3 = this.a(jt.e($$0), jt.e($$2), duw.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ji<dcw> a(int var1, int var2, int var3);
   ...
   default dtx a(int $$0, int $$1) {
      return this.a($$0, $$1, duw.n, true);
   }

   default dtx a(int $$0, int $$1, duw $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbd c(int $$0, int $$1) {
