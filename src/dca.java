...
public abstract class dca implements dbz {
   public static final Codec<dca> a = le.ab.q().dispatchStable(dca::a, Function.identity());
   private final Supplier<Set<ix<dbw>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<ix<dbw>> b();
   ...
   @Nullable
   public Pair<io, ix<dbw>> a(int $$0, int $$1, int $$2, int $$3, Predicate<ix<dbw>> $$4, ayk $$5, dcf.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<io, ix<dbw>> a(io $$0, int $$1, int $$2, int $$3, Predicate<ix<dbw>> $$4, dcf.f $$5, dba $$6) {
      Set<ix<dbw>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         int $$8 = Math.floorDiv($$1, $$2);
         int[] $$9 = ayd.a($$0.v(), $$6.I_() + 1, $$6.al(), $$3).toArray();
         ...
         for (io.a $$10 : io.a(io.c, $$8, it.f, it.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = ji.a($$15);
               ix<dbw> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.as ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               ix<dbw> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract ix<dbw> getNoiseBiome(int var1, int var2, int var3, dcf.f var4);
