...
public class gcj implements AutoCloseable {
   ...
   private float b(float $$0) {
      bre $$1 = this.j.s.c(brg.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(bsq $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, ayf.b(((float)$$0.ai - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.b(brg.p)) {
               $$9 = gcd.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(brg.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   private static void a(Vector3f $$0) {
      $$0.set(ayf.a($$0.x, 0.0F, 1.0F), ayf.a($$0.y, 0.0F, 1.0F), ayf.a($$0.z, 0.0F, 1.0F));
   }
   ...
   public static float a(duv $$0, int $$1) {
      float $$2 = (float)$$1 / 15.0F;
      float $$3 = $$2 / (4.0F - 3.0F * $$2);
      return ayf.i($$0.s(), $$3, 1.0F);
   }
