public class gcj extends gcb<gyx> {
   public static final gfm a = gfm.scaling(2.35F);
   ...
   private final gfd m;
   private final gfd n;
   private final gfd[] o = new gfd[12];
   private final gfd[] p;
   ...
   public static gfj a() {
      ...
      gfi $$3 = gfi.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gff.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", gfi.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gff.a(0.0F, 0.0F, -8.25F));
      gfn $$11 = $$2.a("tail0", gfi.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gff.a);
      gfn $$12 = $$11.a("tail1", gfi.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gff.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", gfi.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gff.a(0.5F, 0.5F, 6.0F));
