...
public class exl extends gpb {
   ...
   private Long S;
   private long T;
   private final fet U = new fet(this);

   public exl(@Nullable eyi $$0, long $$1, int $$2, exe $$3, ekl $$4) {
      super(eyy.a);
      this.C = $$0;
      this.D = $$1;
      this.E = $$2;
   ...
   @Override
   public void aO_() {
      this.O = this.U.b(fbg.a(vt.k, $$0x -> this.E()).a());
      this.O.k = false;
      this.P = this.U.b(fbg.a(vt.e, $$0x -> this.H()).a());
      if (!this.N) {
         if (this.A.b == -1) {
            this.N = true;
            this.J();
         } else {
            List<eyg> $$0 = new ArrayList<>();
            if (this.C != null) {
               $$0.add(this.C);
            }

            $$0.add(new eyo(this.D, this.A.b, () -> {
               if (!this.N) {
                  this.N = true;
                  this.f.execute(() -> {
                     this.f.a(this);
            ...
            this.f.a(new eww(this.A, $$0.toArray(new eyg[0])));
         }
      }
   ...
   private void E() {
      this.f.a(new ewp(new euk(new fhk()), this.D));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.K) {
                              ...
                              eun $$10 = new eun($$0, this.D, this.E, $$2, this.f.X(), aa.b().c(), this.B.l().c(), this.F);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              eul $$7 = eul.a($$6);
                              eul $$8 = eul.a(5368709120L);
                              if (eul.b($$6, $$7).equals(eul.b(5368709120L, $$8)) && $$7 != eul.a) {
                                 eul $$9 = eul.values()[$$7.ordinal() - 1];
                                 this.a(
                                    vu.a("mco.upload.size.failure.line1", this.B.b()),
                                    vu.a("mco.upload.size.failure.line2", eul.b($$6, $$9), eul.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    vu.a("mco.upload.size.failure.line1", this.B.b()),
                                    vu.a("mco.upload.size.failure.line2", eul.b($$6, $$7), eul.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
