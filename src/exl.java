public abstract class exl extends exp implements eyu, ezm {
   private static final eze a = new eze(new ahh("widget/text_field"), new ahh("widget/text_field_highlighted"));
   private static final ahh b = new ahh("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public exl(int $$0, int $$1, int $$2, int $$3, vg $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return aup.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = aup.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(exe $$0, int $$1, int $$2, int $$3, int $$4) {
      ahh $$5 = a.a(this.A(), this.aK_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(exe var1, int var2, int var3, float var4);
}
