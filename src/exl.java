...
public class exl extends LongLinkedOpenHashSet {
   private final exl.a a;

   public exl(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new exl.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azq.f(60000000);
      private static final int b = azq.f(60000000);
