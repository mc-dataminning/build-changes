...
public class gao implements gac.a {
   private final eyk a;
   private double b = Double.MIN_VALUE;
   private List<bof> c = Collections.emptyList();
   ...
   public void a(etd $$0, fwq $$1, double $$2, double $$3, double $$4) {
      ...
      if ($$5 - this.b > 1.0E8) {
         this.b = $$5;
         bof $$6 = this.a.j.m().g();
         this.c = ImmutableList.copyOf($$6.dJ().a_($$6, $$6.cE().g(16.0)));
      }
   ...
   private void a(etd $$0, fwq $$1, double $$2, double $$3, double $$4, bof $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aC.ifPresent($$10 -> {
   ...
   private void a(ib $$0, etd $$1, double $$2, double $$3, double $$4, fwq $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      fwo.a($$1, $$5.getBuffer(fwy.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      fwo.a(
         $$1,
         $$5.getBuffer(fwy.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, epa.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
