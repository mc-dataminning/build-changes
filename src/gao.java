...
public class gao {
   public static class a implements gbh<lm> {
      ...
      public gbe a(lm $$0, fxx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gao.b $$8 = new gao.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gce {
      b(fxx $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gbq {
      ...
      c(fxx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbg $$7, gbz $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gao.c $$0 = new gao.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gbh<lm> {
      ...
      public gbe a(lm $$0, fxx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gao.c $$8 = new gao.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, ffh.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gbc {
      ...
      private int D;
      private final gbg E;
      private final List<cxk> F;
      private boolean G;

      public e(fxx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbg $$7, List<cxk> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gbe $$12 = this.E.a(li.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gao.c $$10 = (gao.c)this.E.a(li.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
