...
public class byo<E extends bvo> extends bwz<E> {
   ...
   protected void a(ard $$0, bvo $$1, long $$2) {
      bwi<?> $$3 = $$1.eb();
   ...
   protected boolean c(ard $$0, bvo $$1, long $$2) {
      return this.l.isPresent() && this.l.get().c().bL();
   }

   protected void d(ard $$0, E $$1, long $$2) {
      if (!this.l.isEmpty()) {
         $$1.eb().a(cek.m, new cen(this.l.get().a(), this.g, 0));
         $$1.eb().a(cek.n, new bxk(this.l.get().c(), true));
         ...
         if ($$3) {
            ...
            if ($$4.equals(this.l.get().a())) {
               ...
               if ($$2 - this.k.get() >= (long)this.i) {
                  $$1.eb().a(cek.W, this.a($$4, this.l.get().b()));
   ...
   private boolean a(bvo $$0, ji $$1) {
      return $$0.P().a($$1) && $$0.a(etu.b($$0, $$1)) == 0.0F;
   }

   private void b(bvo $$0, bvg $$1) {
      this.k = Optional.empty();
      this.l = this.a($$0, $$1).map($$1x -> new byo.a($$1x, $$1.dv(), $$1));
   }
