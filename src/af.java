...
public class af {
   ...
   private final Map<aer, ae> b = Maps.newHashMap();
   ...
   public void a(Map<aer, ae.a> $$0) {
      Map<aer, ae.a> $$1 = Maps.newHashMap($$0);

      while (!$$1.isEmpty()) {
         boolean $$2 = false;
         Iterator<Entry<aer, ae.a>> $$3 = $$1.entrySet().iterator();

         while ($$3.hasNext()) {
            Entry<aer, ae.a> $$4 = $$3.next();
            aer $$5 = $$4.getKey();
            ae.a $$6 = $$4.getValue();
            if ($$6.a(this.b::get)) {
               ae $$7 = $$6.b($$5);
         ...
         if (!$$2) {
            for (Entry<aer, ae.a> $$8 : $$1.entrySet()) {
