...
public class gdu extends fyn {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<alf<djh>> b = ag.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(djh.i, -13408734);
      $$0.put(djh.j, -10075085);
      $$0.put(djh.k, -8943531);
   ...
   @Nullable
   public static gdu a(fpo $$0, BooleanConsumer $$1, DataFixer $$2, ezc.c $$3, boolean $$4) {
      try {
         geb $$5 = $$0.x();
         aun $$6 = auq.a($$3);
   ...
   private gdu(BooleanConsumer $$0, DataFixer $$1, ezc.c $$2, ezi $$3, boolean $$4, jt $$5) {
