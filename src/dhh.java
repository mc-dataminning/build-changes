...
public abstract class dhh implements dhi, AutoCloseable {
   public static final Codec<aly<dhh>> h = aly.a(mb.be);
   public static final aly<dhh> i = aly.a(mb.be, alz.b("overworld"));
   public static final aly<dhh> j = aly.a(mb.be, alz.b("the_nether"));
   public static final aly<dhh> k = aly.a(mb.be, alz.b("the_end"));
   ...
   protected final List<dwr> s = Lists.newArrayList();
   protected final evd t;
   private final List<dwr> a = Lists.newArrayList();
   private boolean b;
   ...
   private final jq<ebp> E;
   protected final ewj B;
   public final boolean C;
   private final dzk F;
   private final dil G;
   private final aly<dhh> H;
   private final ke I;
   private final bua J;
   private long K;

   protected dhh(ewj $$0, aly<dhh> $$1, ke $$2, jq<ebp> $$3, boolean $$4, boolean $$5, long $$6, int $$7) {
      this.B = $$0;
      this.E = $$3;
      final ebp $$8 = $$3.a();
      this.H = $$1;
   ...
   public dzz d(int $$0, int $$1) {
      return (dzz)this.a($$0, $$1, eaq.n);
   }

   @Nullable
   @Override
   public dzp a(int $$0, int $$1, eaq $$2, boolean $$3) {
      dzp $$4 = this.R().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(jh $$0, dxu $$1, int $$2) {
   ...
   public boolean b(jh $$0, dxu $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(jh var1, dxu var2, dxu var3, int var4);
   ...
   @Override
   public void a(jm $$0, jh $$1, jh $$2, dxu $$3, int $$4, int $$5) {
   ...
   public dxu a_(jh $$0) {
      if (this.s($$0)) {
         ...
         dzz $$1 = this.d(kj.a($$0.u()), kj.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable bvj $$0, jh $$1, axe $$2, axg $$3, float $$4, float $$5) {
      this.a($$0 instanceof cpw $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public abstract void a(@Nullable cpw var1, double var2, double var4, double var6, jq<axe> var8, axg var9, float var10, float var11, long var12);

   public void a(@Nullable cpw $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, ma.b.e($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cpw var1, bvj var2, jq<axe> var3, axg var4, float var5, float var6, long var7);

   public void a(@Nullable cpw $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 1.0F, 1.0F);
   }

   public void a(@Nullable cpw $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cpw $$0, double $$1, double $$2, double $$3, jq<axe> $$4, axg $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cpw $$0, bvj $$1, axe $$2, axg $$3, float $$4, float $$5) {
   ...
   protected void W() {
      ...
      Iterator<dwr> $$1 = this.s.iterator();
      boolean $$2 = this.t().i();
   ...
   public <T extends bvj> void a(Consumer<T> $$0, T $$1) {
      try {
         $$0.accept($$1);
   ...
   public boolean n(jh $$0) {
      return this.a(dgn.a($$0));
   }

   public void a(@Nullable bvj $$0, double $$1, double $$2, double $$3, float $$4, dhh.a $$5) {
      this.a($$0, dgz.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvj $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, dhh.a $$6) {
      this.a($$0, dgz.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvj $$0, @Nullable btz $$1, @Nullable dha $$2, fbx $$3, float $$4, boolean $$5, dhh.a $$6) {
      this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvj $$0, @Nullable btz $$1, @Nullable dha $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, dhh.a $$8) {
   ...
   public duw c_(jh $$0) {
      if (this.s($$0)) {
         ...
         return !this.C && Thread.currentThread() != this.c ? null : this.m($$0).a($$0, dzz.b.a);
      }
   }
   ...
   public boolean a(jh $$0, bvj $$1, jm $$2) {
      if (this.s($$0)) {
         return false;
      } else {
         dzp $$3 = this.a(kj.a($$0.u()), kj.a($$0.w()), eaq.n, false);
         return $$3 == null ? false : $$3.a_($$0).a(this, $$0, $$1, $$2);
      }
   }

   public boolean a(jh $$0, bvj $$1) {
   ...
   public jh Y() {
      jh $$0 = this.B.a();
      if (!this.F_().a($$0)) {
         $$0 = this.a(edp.a.e, jh.a(this.F_().a(), 0.0, this.F_().b()));
      }
   ...
   public dgm c(int $$0, int $$1) {
      return this.a($$0, $$1, eaq.n, false);
   }

   @Override
   public List<bvj> a(@Nullable bvj $$0, fbs $$1, Predicate<? super bvj> $$2) {
      bpr.a().f("getEntities");
      List<bvj> $$3 = Lists.newArrayList();
      this.G().a($$1, $$3x -> {
         if ($$3x != $$0 && $$2.test($$3x)) {
            $$3.add($$3x);
         }

         if ($$3x instanceof ckt) {
            for (ckq $$4 : ((ckt)$$3x).x()) {
               if ($$3x != $$0 && $$2.test($$4)) {
                  $$3.add($$4);
               }
   ...
   public <T extends bvj> void a(ece<bvj, T> $$0, fbs $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bvj> void a(ece<bvj, T> $$0, fbs $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      bpr.a().f("getEntities");
      this.G().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   @Nullable
   public abstract bvj a(int var1);
   ...
   public boolean r(jh $$0) {
      if (!this.af()) {
         ...
         return false;
      } else if (this.a(edp.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         dij $$1 = this.t($$0).a();
         return $$1.a($$0, this.O()) == dij.c.b;
      }
   }
   ...
   public abstract fdc Q();

   public void c(jh $$0, dkl $$1) {
      for (jm $$2 : jm.c.a) {
         jh $$3 = $$0.a($$2);
         if (this.B($$3)) {
            dxu $$4 = this.a_($$3);
   ...
   public abstract czm K();

   public abstract dvu L();
   ...
   public static enum a implements bba {
      ...
      public static final Codec<dhh.a> f = bba.a(dhh.a::values);
