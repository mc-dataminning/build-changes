...
public class dmk extends ddq {
   ...
   public static final MapCodec<dmk> d = RecordCodecBuilder.mapCodec($$0 -> $$0.group(c.forGetter($$0x -> $$0x.e), u()).apply($$0, dmk::new));
