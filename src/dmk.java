...
public class dmk {
   ...
   private final Map<Character, Predicate<dmi>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dmk a(char $$0, Predicate<dmi> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dmj b() {
      return new dmj(this.c());
   }

   private Predicate<dmi>[][][] c() {
      this.d();
      Predicate<dmi>[][][] $$0 = (Predicate<dmi>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dmi>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
