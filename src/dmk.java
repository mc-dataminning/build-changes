...
public class dmk {
   ...
   static Codec<dmk> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               cqk.a.listOf().optionalFieldOf("items_to_eject", List.of()).forGetter($$0x -> $$0x.g),
   ...
   private long f;
   private final List<cqk> g = new ObjectArrayList();
   private long h;
   private int i;
   boolean c;

   dmk(Set<UUID> $$0, long $$1, List<cqk> $$2, int $$3) {
      this.e.addAll($$0);
      this.f = $$1;
      this.g.addAll($$2);
      this.i = $$3;
   ...
   cqk f() {
      return this.g.isEmpty() ? cqk.h : Objects.requireNonNullElse(this.g.get(this.g.size() - 1), cqk.h);
   }
   ...
   cqk g() {
      if (this.g.isEmpty()) {
         ...
         this.i();
         return Objects.requireNonNullElse(this.g.remove(this.g.size() - 1), cqk.h);
      }
   }
