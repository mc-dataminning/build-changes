...
public class fbx implements kb {
   public static final Codec<fbx> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> af.a($$0, 3).map($$0x -> new fbx((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final yn<ByteBuf, fbx> b = new yn<ByteBuf, fbx>() {
   ...
   public static fbx a(km $$0) {
      return new fbx((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static fbx a(km $$0, double $$1, double $$2, double $$3) {
      return new fbx((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static fbx b(km $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static fbx c(km $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static fbx a(km $$0, double $$1) {
   ...
   public fbx a(fbx $$0, double $$1) {
      return new fbx(ayz.d($$1, this.d, $$0.d), ayz.d($$1, this.e, $$0.e), ayz.d($$1, this.f, $$0.f));
   }
