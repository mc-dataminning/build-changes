...
public class fbx {
   ...
   private static final euc b = new euc(new aew("recipe_book/page_forward"), new aew("recipe_book/page_forward_highlighted"));
   private static final euc c = new euc(new aew("recipe_book/page_backward"), new aew("recipe_book/page_backward_highlighted"));
