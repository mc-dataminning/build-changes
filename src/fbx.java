...
public class fbx {
   ...
   @Nullable
   private String g;
   private static final fbx.a h = new fbx.a() {
      @Nullable
      @Override
      public fbw a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fca.a(this.d, "Get capabilities")) {
         ...
         if (fca.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fca.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fca.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fbw a(fbx.c $$0) {
      return ($$0 == fbx.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fbx.a {
      private final int a;
      private final Set<fbw> b = Sets.newIdentityHashSet();
      ...
      public fbw a() {
         if (this.b.size() >= this.a) {
            if (ab.aV) {
               fbx.a.warn("Maximum sound pool size {} reached", this.a);
            }
