...
public class aku extends IOException {
   private final List<aku.a> a = Lists.newArrayList();
   private final String b;

   public aku(String $$0) {
      this.a.add(new aku.a());
      this.b = $$0;
   }

   public aku(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new aku.a());
      this.b = $$0;
   }
   ...
   public static aku a(Exception $$0) {
      if ($$0 instanceof aku) {
         return (aku)$$0;
      } else {
