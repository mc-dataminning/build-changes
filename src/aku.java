...
public class aku extends cca {
   ...
   public final akv e;
   private final afh co;
   private final apm cp;
   ...
   private akh cR = akh.a;
   private aey<cqb> cS = cqb.h;
   @Nullable
   private gw cT;
   private boolean cU;
   private float cV;
   private final alx cW;
   private boolean cX;
   private boolean cY;
   private cbg cZ = new cbg(0, 0, 0);
   private final cfe da = new cfe() {
      @Override
      public void a(cer $$0, hn<cjl> $$1, cjl $$2, int[] $$3) {
         aku.this.c.b(new xr($$0.j, $$0.k(), $$1, $$2));
      ...
      public void a(cer $$0, int $$1, cjl $$2) {
         aku.this.c.b(new xt($$0.j, $$0.k(), $$1, $$2));
      }

      @Override
      public void a(cer $$0, cjl $$1) {
         aku.this.c.b(new xt(-1, $$0.k(), -1, $$1));
      }
      ...
      private void b(cer $$0, int $$1, int $$2) {
         aku.this.c.b(new xs($$0.j, $$1, $$2));
      }
   };
   private final cfd db = new cfd() {
      @Override
      public void a(cer $$0, int $$1, cjl $$2) {
         cgj $$3 = $$0.b($$1);
         if (!($$3 instanceof cgf)) {
            if ($$3.d == aku.this.fS()) {
               al.e.a(aku.this, aku.this.fS(), $$2);
            }
         }
      }
   ...
   public aku(MinecraftServer $$0, akt $$1, GameProfile $$2, aki $$3) {
      super($$1, $$1.R(), $$1.S(), $$2);
      this.cW = $$0.a(this);
      this.e = $$0.b(this);
      this.d = $$0;
      this.cp = $$0.ac().a((cca)this);
      this.co = $$0.ac().f(this);
      this.t(1.0F);
      this.e($$1);
      this.a($$3);
   ...
   private void e(akt $$0) {
      gw $$1 = $$0.R();
      if ($$0.C_().g() && $$0.n().aT().m() != cpy.c) {
         int $$2 = Math.max(0, this.d.a($$0));
         int $$3 = asb.a($$0.B_().b((double)$$1.u(), (double)$$1.w()));
         if ($$3 < $$2) {
            $$2 = $$3;
         }
         ...
         for (int $$9 = 0; $$9 < $$6; $$9++) {
            ...
            int $$11 = $$10 % ($$2 * 2 + 1);
            int $$12 = $$10 / ($$2 * 2 + 1);
            gw $$13 = ako.a($$0, $$1.u() + $$11 - $$2, $$1.w() + $$12 - $$2);
            if ($$13 != null) {
               this.a($$13, 0.0F, 0.0F);
               if ($$0.g(this)) {
                  break;
   ...
   public void a(qw $$0) {
      ...
      if ($$0.b("warden_spawn_tracker", 10)) {
         cbg.a.parse(new Dynamic(ri.a, $$0.c("warden_spawn_tracker"))).resultOrPartial(b::error).ifPresent($$0x -> this.cZ = $$0x);
      }

      if ($$0.b("enteredNetherPosition", 10)) {
         qw $$1 = $$0.p("enteredNetherPosition");
         this.cO = new ehh($$1.k("x"), $$1.k("y"), $$1.k("z"));
      }
      ...
      if ($$0.b("SpawnX", 99) && $$0.b("SpawnY", 99) && $$0.b("SpawnZ", 99)) {
         ...
         if ($$0.e("SpawnDimension")) {
            this.cS = cqb.g.parse(ri.a, $$0.c("SpawnDimension")).resultOrPartial(b::error).orElse(cqb.h);
         }
      }
   }
   ...
   public void b(qw $$0) {
      super.b($$0);
      cbg.a.encodeStart(ri.a, this.cZ).resultOrPartial(b::error).ifPresent($$1 -> $$0.a("warden_spawn_tracker", $$1));
      this.k($$0);
      ...
      if (this.cT != null) {
         ...
         aez.a.encodeStart(ri.a, this.cS.a()).resultOrPartial(b::error).ifPresent($$1 -> $$0.a("SpawnDimension", $$1));
      }
   }
   ...
   public void a(int $$0) {
      ...
      float $$2 = ($$1 - 1.0F) / $$1;
      this.ch = asb.a((float)$$0 / $$1, 0.0F, $$2);
      this.cz = -1;
   }
   ...
   public void m() {
      try {
         ...
         if (this.eu() != this.cw || this.cx != this.bT.a() || this.bT.e() == 0.0F != this.cy) {
            this.c.b(new aad(this.eu(), this.bT.a(), this.bT.e()));
            this.cw = this.eu();
            this.cx = this.bT.a();
         ...
         if (this.eu() + this.fk() != this.cq) {
            ...
            this.a(eij.f, asb.f(this.cq));
         }

         if (this.bT.a() != this.cr) {
            this.cr = this.bT.a();
            this.a(eij.g, asb.f((float)this.cr));
         }

         if (this.ch() != this.cs) {
            this.cs = this.ch();
            this.a(eij.h, asb.f((float)this.cs));
         }

         if (this.eI() != this.ct) {
            this.ct = this.eI();
            this.a(eij.i, asb.f((float)this.ct));
         }

         if (this.cg != this.cv) {
            this.cv = this.cg;
            this.a(eij.j, asb.f((float)this.cv));
         }

         if (this.cf != this.cu) {
            this.cu = this.cf;
            this.a(eij.k, asb.f((float)this.cu));
         }

         if (this.cg != this.cz) {
            this.cz = this.cg;
            this.c.b(new aac(this.ch, this.cg, this.cf));
         }
   ...
   public void a(bhu $$0) {
      this.a(djn.p);
      boolean $$1 = this.dL().X().b(cpx.m);
      if ($$1) {
         tl $$2 = this.eJ().a();
         this.c.a(new yz(this.ah(), $$2), sv.a(() -> {
            int $$1x = 256;
            String $$2x = $$2.a(256);
            tl $$3x = tl.a("death.attack.message_too_long", tl.b($$2x).a(n.o));
            tl $$4x = tl.a("death.attack.even_more_magic", this.N_()).a($$1xx -> $$1xx.a(new tr(tr.a.a, $$3x)));
            return new yz(this.ah(), $$4x);
         }));
         eii $$3 = this.cf();
         if ($$3 == null || $$3.k() == eii.b.a) {
            this.d.ac().a($$2, false);
         } else if ($$3.k() == eii.b.c) {
            this.d.ac().a(this, $$2);
         } else if ($$3.k() == eii.b.d) {
         ...
         this.c.b(new yz(this.ah(), tk.a));
      }

      this.gg();
      if (this.dL().X().b(cpx.J)) {
         this.gs();
      }
   ...
   private void gs() {
      ehc $$0 = new ehc(this.dl()).c(32.0, 10.0, 32.0);
      this.dL().a(bjo.class, $$0, biz.f).stream().filter($$0x -> $$0x instanceof bjt).forEach($$0x -> ((bjt)$$0x).a_((cca)this));
   }
   ...
   public void a(biw $$0, int $$1, bhu $$2) {
      if ($$0 != this) {
         ...
         String $$3 = this.cx();
         String $$4 = $$0.cx();
         this.gh().a(eij.e, $$3, eif::a);
         if ($$0 instanceof cca) {
            this.a(apq.Q);
            this.gh().a(eij.d, $$3, eif::a);
         } else {
            this.a(apq.O);
         }
   ...
   private void a(String $$0, String $$1, eij[] $$2) {
      eie $$3 = this.gh().g($$1);
      if ($$3 != null) {
         int $$4 = $$3.n().b();
         if ($$4 >= 0 && $$4 < $$2.length) {
            this.gh().a($$2[$$4], $$0, eif::a);
         }
      }
   }
   ...
   public boolean a(bhu $$0, float $$1) {
      if (this.b($$0)) {
         ...
         boolean $$2 = this.d.l() && this.gt() && $$0.a(apx.m);
         if (!$$2 && this.cA > 0 && !$$0.a(apx.d)) {
            return false;
         } else {
            biw $$3 = $$0.d();
            if ($$3 instanceof cca $$4 && !this.a($$4)) {
               return false;
            }

            if ($$3 instanceof ccg $$5 && $$5.v() instanceof cca $$7 && !this.a($$7)) {
               return false;
            }
   ...
   protected ebd a(akt $$0) {
      ebd $$1 = super.a($$0);
      if ($$1 != null && this.dL().ac() == cqb.h && $$0.ac() == cqb.j) {
         ehh $$2 = $$1.a.b(0.0, -1.0, 0.0);
         return new ebd($$2, ehh.b, 90.0F, 0.0F);
      } else {
         return $$1;
      }
   }
   ...
   public biw b(akt $$0) {
      ...
      akt $$1 = this.x();
      aey<cqb> $$2 = $$1.ac();
      if ($$2 == cqb.j && $$0.ac() == cqb.h) {
         this.ae();
         this.x().a(this, biw.c.e);
         if (!this.f) {
            this.f = true;
            this.c.b(new yc(yc.e, this.cG ? 0.0F : 1.0F));
            this.cG = true;
         }
         ...
         ebx $$3 = $$0.z_();
         this.c.b(new zh(this.d($$0), (byte)3));
         this.c.b(new xj($$3.s(), $$3.t()));
         aoj $$4 = this.d.ac();
         $$4.d(this);
         $$1.a(this, biw.c.e);
         this.dI();
   ...
   protected Optional<l.a> a(akt $$0, gw $$1, boolean $$2, dgu $$3) {
      ...
      if ($$4.isPresent()) {
         ...
         ha.a $$5 = this.dL().a_(this.ax).d(cye.b).orElse(ha.a.a);
   ...
   private void f(akt $$0) {
      aey<cqb> $$1 = $$0.ac();
      aey<cqb> $$2 = this.dL().ac();
      al.v.a(this, $$1, $$2);
      if ($$1 == cqb.i && $$2 == cqb.h && this.cO != null) {
         al.C.a(this, this.cO);
      }
   ...
   public Either<cca.a, atc> a(gw $$0) {
      ha $$1 = this.dL().a_($$0).c(cww.aE);
      if (this.fD() || !this.bv()) {
         return Either.left(cca.a.e);
      } else if (!this.dL().C_().j()) {
         return Either.left(cca.a.a);
      } else if (!this.a($$0, $$1)) {
         return Either.left(cca.a.c);
      } else if (this.b($$0, $$1)) {
         return Either.left(cca.a.d);
      } else {
         this.a(this.dL().ac(), $$0, this.dB(), false, true);
         if (this.dL().N()) {
            return Either.left(cca.a.b);
         } else {
            if (!this.f()) {
               double $$2 = 8.0;
               double $$3 = 5.0;
               ehh $$4 = ehh.c($$0);
               List<bzo> $$5 = this.dL()
                  .a(bzo.class, new ehc($$4.a() - 8.0, $$4.b() - 5.0, $$4.c() - 8.0, $$4.a() + 8.0, $$4.b() + 5.0, $$4.c() + 8.0), $$0x -> $$0x.f(this));
               if (!$$5.isEmpty()) {
                  return Either.left(cca.a.f);
               }
            }

            Either<cca.a, atc> $$6 = super.a($$0).ifRight($$0x -> {
               this.a(apq.ap);
               al.q.a(this);
            });
            if (!this.x().d()) {
   ...
   public void a(deh $$0, boolean $$1) {
      this.c.b(new xg(this.dL(), $$0.p()));
      this.c.b(new yt($$0.p(), $$1));
   }
   ...
   public OptionalInt a(@Nullable bhh $$0) {
      if ($$0 == null) {
         ...
         this.gu();
         cer $$1 = $$0.createMenu(this.dd, this.fS(), this);
         if ($$1 == null) {
            if (this.M_()) {
   ...
   public void a(bww $$0, bgx $$1) {
      ...
      this.bS = new cfp(this.dd, this.fS(), $$1, $$0);
      this.a(this.bS);
   }
   ...
   @Override
   public void a(ddj $$0) {
      this.c.b(xe.a($$0, dcz::o));
   }

   @Override
   public void q() {
      this.c.b(new xq(this.bS.j));
      this.r();
   }
   ...
   public void a(ed.a $$0, ehh $$1) {
      super.a($$0, $$1);
      this.c.b(new zc($$0, $$1.c, $$1.d, $$1.e));
   }

   public void a(ed.a $$0, biw $$1, ed.a $$2) {
      ehh $$3 = $$2.a($$1);
      super.a($$0, $$3);
      this.c.b(new zc($$0, $$1, $$2));
   }
   ...
   public void a(aku $$0, boolean $$1) {
      ...
      if ($$1) {
         ...
         this.r($$0.fN());
         this.ax = $$0.ax;
      } else if (this.dL().X().b(cpx.d) || $$0.M_()) {
         this.fS().a($$0.fS());
         this.cf = $$0.cf;
         this.cg = $$0.cg;
         this.ch = $$0.ch;
   ...
   public void b(double $$0, double $$1, double $$2) {
      this.c.a($$0, $$1, $$2, this.dB(), this.dD(), bka.g);
   }

   @Override
   public void c(double $$0, double $$1, double $$2) {
      this.c.a(this.dq() + $$0, this.ds() + $$1, this.dw() + $$2, this.dB(), this.dD(), bka.f);
   }

   @Override
   public boolean a(akt $$0, double $$1, double $$2, double $$3, Set<bka> $$4, float $$5, float $$6) {
      cpi $$7 = new cpi(gw.a($$1, $$2, $$3));
      $$0.k().a(aky.g, $$7, 1, this.ah());
      this.aa();
      if (this.fD()) {
         this.a(true, true);
      }
   ...
   @Override
   public void a(biw $$0) {
      this.x().k().a(this, new xa($$0, 4));
   }

   @Override
   public void b(biw $$0) {
      this.x().k().a(this, new xa($$0, 5));
   }
   ...
   @Override
   public boolean M_() {
      return this.e.b() == cpy.d;
   }

   @Override
   public boolean f() {
      return this.e.b() == cpy.b;
   }
   ...
   public aki z() {
      int $$0 = this.al().b(bM);
      bjg $$1 = bjg.d.apply(this.al().b(bN));
      return new aki(this.cM, this.cL, this.cB, this.cC, $$0, $$1, this.cX, this.cY);
   }
   ...
   private boolean v(boolean $$0) {
      return this.cB == cby.c ? $$0 : true;
   }

   private boolean gv() {
      return this.cB == cby.a;
   }
   ...
   public void a(aea $$0) {
      this.c.b(new zl($$0.a(), $$0.d().map(aea.a::a), $$0.e()));
   }
   ...
   public biw I() {
      return (biw)(this.cE == null ? this : this.cE);
   }

   @Override
   public void c(@Nullable biw $$0) {
      biw $$1 = this.I();
      this.cE = (biw)($$0 == null ? this : $$0);
      if ($$1 != this.cE) {
         if (this.cE.dL() instanceof akt $$2) {
   ...
   public void a(akt $$0, double $$1, double $$2, double $$3, float $$4, float $$5) {
      this.c(this);
      this.aa();
      if ($$0 == this.dL()) {
         this.c.a($$1, $$2, $$3, $$4, $$5);
   ...
   public void a(aey<cqb> $$0, @Nullable gw $$1, float $$2, boolean $$3, boolean $$4) {
      if ($$1 != null) {
   ...
   public void a(apf $$0, aph $$1, float $$2, float $$3) {
      this.c.b(new aao(jb.c.d($$0), $$1, this.dq(), this.ds(), this.dw(), $$2, $$3, this.ag.g()));
   }
   ...
   @Nullable
   private static cpy a(@Nullable qw $$0, String $$1) {
      return $$0 != null && $$0.b($$1, 99) ? cpy.a($$0.h($$1)) : null;
   }

   private cpy b(@Nullable cpy $$0) {
      cpy $$1 = this.d.aW();
      if ($$1 != null) {
         return $$1;
      } else {
   ...
   public void a(double $$0, double $$1) {
      this.cl = (float)(asb.d($$1, $$0) * 180.0F / (float)Math.PI - (double)this.dB());
      this.c.b(new ye(this));
   }
   ...
   public aba d(akt $$0) {
      return new aba($$0.aa(), $$0.ac(), crb.a($$0.A()), this.e.b(), this.e.c(), $$0.af(), $$0.z(), this.gr(), this.at());
   }
}
