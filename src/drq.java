...
public class drq {
   private static final drq a = new drq(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public drq.a a(int $$0, int $$1) {
         return new drq.a(1.0, 0.0);
      }
   ...
   private static final efs b = efs.b(new drp(42L), pl.a);
   ...
   private final Long2ObjectOpenHashMap<drr> h;
   private final Long2ObjectOpenHashMap<drr> i;

   public static drq a() {
      return a;
   }

   public static drq a(@Nullable apc $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cuu $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<drr> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<drr> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = awh.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new drq($$2, $$3);
         }
      }
   }

   drq(Long2ObjectOpenHashMap<drr> $$0, Long2ObjectOpenHashMap<drr> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public drq.a a(int $$0, int $$1) {
      int $$2 = iu.a($$0);
      int $$3 = iu.a($$1);
      double $$4 = this.a($$2, 0, $$3, drr::a);
      if ($$4 != Double.MAX_VALUE) {
         return new drq.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(iu.d(cuu.a($$5x)), iu.d(cuu.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = awh.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = awh.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new drq.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dqh.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(iu.d(cuu.a($$6x)), iu.d(cuu.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = awh.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = awh.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return awh.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, drq.b $$3) {
      int $$4 = iu.e($$0);
      int $$5 = iu.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(drq.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      drr $$6 = (drr)this.h.get(cuu.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - iu.d($$1), $$4, $$5 - iu.d($$2)) : Double.MAX_VALUE;
   }

   public cwp a(cwp $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ij<cwm> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ij<cwm> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ij<cwm>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(iu.d(cuu.a($$5x)), $$1, iu.d(cuu.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = awh.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = awh.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ij)$$4.getValue();
      }
   }

   public static void a(apc $$0, dnb $$1) {
      cuu $$2 = $$1.f();
      boolean $$3 = $$1.s();
      hz.a $$4 = new hz.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dqo.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dnb $$0, hz $$1) {
      dlf $$2 = $$0.a_($$1);
      if ($$2.a(atz.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cwi $$0, dnw $$1) {
      cuu $$2 = $$1.f();
      Builder<ig, drr> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dqk.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static drq.c a(@Nullable drr $$0, Map<ig, drr> $$1) {
      List<drq.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static drq.c a(@Nullable ig $$0, drr $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ie $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return awh.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(drr var1, int var2, int var3, int var4);
   }
