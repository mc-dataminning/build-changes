...
public abstract class exb<T extends exb<T>> {
   ...
   public exb(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ewz.a();
         if ($$3 != null) {
         ...
         throw new eyk(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new eyk(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new eyk(var2.getMessage(), var2);
      }
   }
   ...
   public static exb<?> a(String $$0) {
      return new exb.b($$0, 5000, 60000);
   }

   public static exb<?> a(String $$0, int $$1, int $$2) {
      return new exb.b($$0, $$1, $$2);
   }

   public static exb<?> b(String $$0, String $$1) {
      return new exb.c($$0, $$1, 5000, 60000);
   }

   public static exb<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new exb.c($$0, $$1, $$2, $$3);
   }

   public static exb<?> b(String $$0) {
      return new exb.a($$0, 5000, 60000);
   }

   public static exb<?> c(String $$0, String $$1) {
      return new exb.d($$0, $$1, 5000, 60000);
   }

   public static exb<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new exb.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends exb<exb.a> {
   ...
   public static class b extends exb<exb.b> {
   ...
   public static class c extends exb<exb.c> {
      ...
      public exb.c f() {
         try {
            ...
            throw new eyk(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends exb<exb.d> {
      private final String c;
