...
public class exb {
   ...
   public static List<exb.a> a(String $$0, exb.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<exb.a> a(String $$0, List<exb.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<exb.a> a(List<String> $$0, List<exb.b> $$1) {
      int $$2 = 0;
      List<exb.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<exb.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static exb.b a(String $$0, String $$1) {
         return new exb.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static exb.b a(String $$0) {
         return new exb.b($$0);
      }
   }
}
