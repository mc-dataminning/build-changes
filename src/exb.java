...
public abstract class exb extends exd {
   ...
   public exb(int $$0, int $$1, int $$2, int $$3, vf $$4, double $$5) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
   }
   ...
   public void a(fay $$0) {
      ...
      if (this.j) {
         if (this.aI_()) {
            $$0.a(fax.d, vf.c("narration.slider.usage.focused"));
         } else {
            $$0.a(fax.d, vf.c("narration.slider.usage.hovered"));
         }
      }
   }
