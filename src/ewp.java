...
public class ewp {
   ...
   private static final Map<dny.a, String> e = ac.a(new EnumMap<>(dny.a.class), $$0 -> {
      $$0.put(dny.a.a, "SW");
      $$0.put(dny.a.b, "S");
      $$0.put(dny.a.c, "OW");
      $$0.put(dny.a.d, "O");
   ...
   private dkw l;
   @Nullable
   private CompletableFuture<dkw> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final auh r = new auh();
   private final auh s = new auh();
   private final auh t = new auh();
   private final auh u = new auh();
   private final exx v;
   private final exz w;
   private final exy x;
   private final exw y;
   ...
   public ewp(euk $$0) {
      ...
      this.g = new ewp.a();
      this.h = $$0.h;
      this.v = new exx(this.h, this.r);
      this.w = new exz(this.h, this.s, () -> $$0.r.r().g());
      this.x = new exy(this.h, this.t);
      this.y = new exw(this.h, this.u);
   }
   ...
   private void a(evw $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.au()) {
         ...
         csy $$23 = this.p();
         LongSet $$24 = (LongSet)($$23 instanceof amp ? ((amp)$$23).v() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, ix.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, aty.g($$15.dC()), aty.g($$15.dE())));
         dkw $$27 = this.r();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(cth.a, $$14);
            int $$30 = this.f.r.a(cth.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dkw $$31 = this.q();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dny.a $$33 : dny.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.J_() && $$14.v() < this.f.r.ak()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ao();
                  long $$36 = $$31.u();
                  bjj $$37 = new bjj($$23.aj(), $$23.X(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            ctj.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bly> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bly.values())
   ...
   private static String a(ie<ctx> $$0) {
   ...
   private csy p() {
      return (csy)DataFixUtils.orElse(Optional.ofNullable(this.f.S()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ad()))), this.f.r);
   }
   ...
   private dkw q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, dkq.n, false).thenApply($$0x -> (dkw)$$0x.map($$0xx -> (dkw)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", enw.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", euk.N().aL().k(), euk.N().aL().l(), enw.a()),
            enw.c(),
            enw.d()
         }
      );
      if (this.f.au()) {
         ...
         if (this.i.c() == ekz.a.b) {
            ...
            $$4.add(String.valueOf(kb.e.b($$6.b())));
            UnmodifiableIterator var12 = $$6.C().entrySet().iterator();

            while (var12.hasNext()) {
               Entry<djs<?>, Comparable<?>> $$7 = (Entry<djs<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ekz.a.b) {
            ...
            $$4.add(String.valueOf(kb.c.b($$9.a())));
            UnmodifiableIterator var17 = $$9.C().entrySet().iterator();

            while (var17.hasNext()) {
               Entry<djs<?>, Comparable<?>> $$10 = (Entry<djs<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(kb.g.b($$11.ai())));
         }
   ...
   private String a(Entry<djs<?>, Comparable<?>> $$0) {
      djs<?> $$1 = $$0.getKey();
