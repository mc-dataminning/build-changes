...
public class ewp extends ewi {
   private final boolean a;
   private final Long2ObjectMap<ewm> l = new Long2ObjectOpenHashMap();
   ...
   public int a(ewh[] $$0, ewh $$1) {
      int $$2 = 0;
      Map<ja, ewh> $$3 = Maps.newEnumMap(ja.class);

      for (ja $$4 : ja.values()) {
         ewh $$5 = this.a($$1.a + $$4.j(), $$1.b + $$4.k(), $$1.c + $$4.l());
         $$3.put($$4, $$5);
         if (this.a($$5)) {
            $$0[$$2++] = $$5;
         }
      ...
      for (ja $$6 : ja.c.a) {
         ...
         if (b($$3.get($$6)) && b($$3.get($$7))) {
            ewh $$8 = this.a($$1.a + $$6.j() + $$7.j(), $$1.b, $$1.c + $$6.l() + $$7.l());
            if (this.a($$8)) {
               $$0[$$2++] = $$8;
            }
         }
   ...
   private static boolean b(@Nullable ewh $$0) {
   ...
   protected ewm b(int $$0, int $$1, int $$2) {
      return (ewm)this.l.computeIfAbsent(iu.a($$0, $$1, $$2), $$3 -> this.a(this.b, $$0, $$1, $$2));
   }
