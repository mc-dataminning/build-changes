...
public class mv implements mh {
   ...
   public mv(mj $$0, CompletableFuture<js.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
      ...
      return this.e
         .thenCompose(
            $$2 -> {
               ...
               aln<JsonElement> $$4 = $$2.a(JsonOps.INSTANCE);
               $$2.d(mb.f)
                  .c()
                  .forEach(
                     $$2x -> {
                        JsonObject $$3x = new JsonObject();
                        dxp<dkd, dxo> $$4x = ((dkd)$$2x.a()).l();
                        if (!$$4x.d().isEmpty()) {
                        ...
                        $$3x.add("states", $$9);
                        String $$14 = $$2x.g();
                        JsonElement $$15 = (JsonElement)dke.a
                           .codec()
                           .encodeStart($$4, (dkd)$$2x.a())
