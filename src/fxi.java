...
public class fxi implements etm, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final etk c = new etk();
   ...
   private final List<ets> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ets> l = Maps.newHashMap();
   private final int m;
   ...
   public fxi(aso $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, etp.a.a, $$6);
         this.t = a($$0, etp.a.b, $$7);
         this.m = etq.a();
         etq.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ets.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static etn a(aso $$0, etp.a $$1, String $$2) throws IOException {
      etp $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof etn)) {
   ...
   public static etl a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new etl();
      } else {
         int $$1 = 32774;
