...
public class cnn extends cnr {
   ...
   private static final akk<Integer> g = ako.a(cnn.class, akm.b);
   private static final akk<Boolean> h = ako.a(cnn.class, akm.k);
   private int i;
   private int j;
   private int k;
   private int l;
   ...
   @Nullable
   private bsw o;
   private cnn.a p = cnn.a.a;
   private final int q;
   private final int r;

   private cnn(btc<? extends cnn> $$0, dca $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.au = true;
      this.q = Math.max(0, $$2);
      this.r = Math.max(0, $$3);
   ...
   public cnn(btc<? extends cnn> $$0, dca $$1) {
      this($$0, $$1, 0, 0);
   }

   public cnn(cmz $$0, dca $$1, int $$2, int $$3) {
      this(btc.bz, $$1, $$2, $$3);
      this.c($$0);
      float $$4 = $$0.dH();
      float $$5 = $$0.dF();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      evt $$13 = new evt((double)(-$$7), (double)ayz.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
   ...
   public void l() {
      ...
      if ($$0 == null) {
         ...
         this.J();
         if (this.p == cnn.a.a && (this.aE() || this.Q)) {
            this.h(evt.b);
         }
   ...
   private boolean a(cmz $$0) {
      cur $$1 = $$0.eX();
      cur $$2 = $$0.eY();
      boolean $$3 = $$1.a(cuu.qV);
      boolean $$4 = $$2.a(cuu.qV);
   ...
   protected boolean b(bsw $$0) {
      return super.b($$0) || $$0.bD() && $$0 instanceof cjj;
   }
   ...
   private boolean b(iz $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cnn.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case a:
               if ($$1 == cnn.b.c) {
                  return false;
   ...
   private cnn.b a(iz $$0, iz $$1) {
      return iz.d($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cnn.b.c).orElse(cnn.b.c);
   }

   private cnn.b c(iz $$0) {
      dse $$1 = this.dP().a_($$0);
      if (!$$1.i() && !$$1.a(dfd.fm)) {
         enx $$2 = $$1.u();
         return $$2.a(awv.a) && $$2.b() && $$1.k(this.dP(), $$0).c() ? cnn.b.b : cnn.b.c;
      } else {
         return cnn.b.a;
      }
   }
   ...
   public int a(cur $$0) {
      ...
      if (!this.dP().B && $$1 != null && !this.a($$1)) {
         ...
         if (this.o != null) {
            ...
            $$2 = this.o instanceof cjj ? 3 : 5;
         } else if (this.j > 0) {
            eqn $$3 = new eqn.a((arf)this.dP()).a(etg.f, this.dn()).a(etg.i, $$0).a(etg.a, this).a((float)this.q + $$1.gy()).a(etf.f);
            eqp $$4 = this.dP().o().be().b(eqg.aC);
            List<cur> $$5 = $$4.a($$3);
            am.E.a((arg)$$1, $$0, this, $$5);

            for (cur $$6 : $$5) {
               cjj $$7 = new cjj(this.dP(), this.du(), this.dw(), this.dA(), $$6);
               ...
               this.dP().b($$7);
               $$1.dP().b(new bth($$1.dP(), $$1.du(), $$1.dw() + 0.5, $$1.dA() + 0.5, this.ah.a(6) + 1));
               if ($$6.a(awy.aP)) {
                  $$1.a(awk.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dP().B && this.o instanceof cmz && ((cmz)this.o).g()) {
         this.d(this.o);
      }
   ...
   protected void d(bsw $$0) {
      bsw $$1 = this.s();
      if ($$1 != null) {
         evt $$2 = new evt($$1.du() - this.du(), $$1.dw() - this.dw(), $$1.dA() - this.dA()).a(0.1);
         $$0.h($$0.ds().e($$2));
      }
   }
   ...
   public cmz u() {
      bsw $$0 = this.s();
      return $$0 instanceof cmz ? (cmz)$$0 : null;
   }
