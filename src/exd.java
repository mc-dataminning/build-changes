...
public class exd {
   private final List<ConcurrentLinkedQueue<exc>> a = ImmutableList.of(
   ...
   public void a(exc $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<exc> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<exc> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<exc> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<exc> j() {
