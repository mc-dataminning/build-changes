...
public class exd extends eym {
   public static final double a = 7.0;
   private static final tn c = tn.c("chat_screen.usage");
   ...
   protected void aH_() {
      ...
      this.b = new etb(this.f.i, 4, this.h - 12, this.g - 4, 12, tn.c("chat.editBox")) {
         @Override
         protected ua aE_() {
            return super.aE_().b(exd.this.o.e());
         }
      };
      this.b.l(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new esv(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
      this.c(this.b);
   }
   ...
   public void a(esh $$0, int $$1, int $$2, float $$3) {
      ...
      super.a($$0, $$1, $$2, $$3);
      this.o.a($$0, $$1, $$2);
      eqs $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.i, this.i.c($$4.g(), 210), $$1, $$2);
      } else {
         uj $$5 = this.a((double)$$1, (double)$$2);
         if ($$5 != null && $$5.i() != null) {
            $$0.a(this.i, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(ewk $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(ewj.a, tn.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private uj a(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return ass.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
