...
public class exd {
   ...
   private final exd.a g;

   @Deprecated
   public static exd a(bai $$0, exd.a $$1) {
      return new exd($$0, $$1, false);
   }

   public static exd a(bai $$0, int $$1, double... $$2) {
      return b($$0, new exd.a($$1, new DoubleArrayList($$2)));
   }

   public static exd b(bai $$0, exd.a $$1) {
      return new exd($$0, $$1, true);
   }

   private exd(bai $$0, exd.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<exd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(exd.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(exd.a::b))
               .apply($$0, exd.a::new)
      );
      public static final Codec<jg<exd.a>> b = aln.a(mi.aY, a);
