...
public class ehz {
   ...
   static class a implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         return $$0.c[ij.f.d()] && !$$0.b[ij.f.d()].d;
      }

      @Override
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         $$1.d = true;
         $$1.b[ij.f.d()].d = true;
         return new ehz.k($$0, $$1);
      }
   }

   static class b implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         if ($$0.c[ij.f.d()] && !$$0.b[ij.f.d()].d && $$0.c[ij.b.d()] && !$$0.b[ij.b.d()].d) {
            ehz.v $$1 = $$0.b[ij.f.d()];
            return $$1.c[ij.b.d()] && !$$1.b[ij.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         ...
         $$1.b[ij.f.d()].d = true;
         $$1.b[ij.b.d()].d = true;
         $$1.b[ij.f.d()].b[ij.b.d()].d = true;
         return new ehz.l($$0, $$1);
      }
   }

   static class c implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         return $$0.c[ij.b.d()] && !$$0.b[ij.b.d()].d;
      }
      ...
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         $$1.d = true;
         $$1.b[ij.b.d()].d = true;
         return new ehz.m($$0, $$1);
      }
   }

   static class d implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         if ($$0.c[ij.c.d()] && !$$0.b[ij.c.d()].d && $$0.c[ij.b.d()] && !$$0.b[ij.b.d()].d) {
            ehz.v $$1 = $$0.b[ij.c.d()];
            return $$1.c[ij.b.d()] && !$$1.b[ij.b.d()].d;
         } else {
            return false;
      ...
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         ...
         $$1.b[ij.c.d()].d = true;
         $$1.b[ij.b.d()].d = true;
         $$1.b[ij.c.d()].b[ij.b.d()].d = true;
         return new ehz.n($$0, $$1);
      }
   }

   static class e implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         return $$0.c[ij.c.d()] && !$$0.b[ij.c.d()].d;
      }

      @Override
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         ehz.v $$3 = $$1;
         if (!$$1.c[ij.c.d()] || $$1.b[ij.c.d()].d) {
            $$3 = $$1.b[ij.d.d()];
         }

         $$3.d = true;
         $$3.b[ij.c.d()].d = true;
         return new ehz.o($$0, $$3);
      }
   }

   static class f implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         return true;
      }
      ...
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         $$1.d = true;
         return new ehz.s($$0, $$1, $$2);
      }
   }

   static class g implements ehz.i {
      @Override
      public boolean a(ehz.v $$0) {
         return !$$0.c[ij.e.d()] && !$$0.c[ij.f.d()] && !$$0.c[ij.c.d()] && !$$0.c[ij.d.d()] && !$$0.c[ij.b.d()];
      }

      @Override
      public ehz.r a(ij $$0, ehz.v $$1, axt $$2) {
         $$1.d = true;
         return new ehz.t($$0, $$1);
      }
   }

   public static class h extends ehz.r {
      ...
      private ehz.v G;
      private ehz.v H;
      private final List<ehz.r> I = Lists.newArrayList();

      public h(axt $$0, int $$1, int $$2, ij $$3) {
         super(egh.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ehz.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ehz.p($$3, this.G));
         this.I.add(new ehz.j($$3, this.H));
         List<ehz.i> $$5 = Lists.newArrayList();
         $$5.add(new ehz.b());
         $$5.add(new ehz.d());
         $$5.add(new ehz.e());
         $$5.add(new ehz.a());
         ...
         efi $$10 = efi.a(this.b(1, 1, 1), this.b(23, 8, 21));
         efi $$11 = efi.a(this.b(34, 1, 1), this.b(56, 8, 21));
         efi $$12 = efi.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ehz.u($$3, $$10, $$13++));
         this.I.add(new ehz.u($$3, $$11, $$13++));
         this.I.add(new ehz.q($$3, $$12));
      }
      ...
      private List<ehz.v> b(axt $$0) {
         ehz.v[] $$1 = new ehz.v[75];
         ...
         ehz.v $$23 = new ehz.v(1003);
         ehz.v $$24 = new ehz.v(1001);
         ehz.v $$25 = new ehz.v(1002);
         $$1[v].a(ij.b, $$23);
         $$1[w].a(ij.d, $$24);
         $$1[x].a(ij.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ij.f.d()].d = true;
         this.H.b[ij.c.d()].d = true;
         this.H.b[ij.f.d()].b[ij.c.d()].d = true;
         this.H.b[ij.b.d()].d = true;
         this.H.b[ij.f.d()].b[ij.b.d()].d = true;
         this.H.b[ij.c.d()].b[ij.b.d()].d = true;
         this.H.b[ij.f.d()].b[ij.c.d()].b[ij.b.d()].d = true;
         ObjectArrayList<ehz.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dab $$2, axt $$3, efi $$4) {
         int $$5 = 24;
      ...
      private void a(dab $$0, axt $$1, efi $$2) {
      ...
      private void b(dab $$0, axt $$1, efi $$2) {
      ...
      private void c(dab $$0, axt $$1, efi $$2) {
      ...
      private void d(dab $$0, axt $$1, efi $$2) {
      ...
      private void e(dab $$0, axt $$1, efi $$2) {
      ...
      private void f(dab $$0, axt $$1, efi $$2) {
   ...
   interface i {
      boolean a(ehz.v var1);

      ehz.r a(ij var1, ehz.v var2, axt var3);
   }

   public static class j extends ehz.r {
      public j(ij $$0, ehz.v $$1) {
         super(egh.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dab $$0, czz $$1, drf $$2, axt $$3, efi $$4, cyn $$5, id $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dcj.ch.n(), dcj.ch.n(), false);
   ...
   public static class k extends ehz.r {
      public k(ij $$0, ehz.v $$1) {
         super(egh.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dab $$0, czz $$1, drf $$2, axt $$3, efi $$4, cyn $$5, id $$6) {
         ehz.v $$7 = this.B.b[ij.f.d()];
         ehz.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ij.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ij.a.d()]);
         }
   ...
   public static class l extends ehz.r {
      public l(ij $$0, ehz.v $$1) {
         super(egh.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ehz.r {
      public m(ij $$0, ehz.v $$1) {
         super(egh.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dab $$0, czz $$1, drf $$2, axt $$3, efi $$4, cyn $$5, id $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ij.a.d()]);
         }

         ehz.v $$7 = this.B.b[ij.b.d()];
         if ($$7.b[ij.b.d()] == null) {
   ...
   public static class n extends ehz.r {
      public n(ij $$0, ehz.v $$1) {
         super(egh.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dab $$0, czz $$1, drf $$2, axt $$3, efi $$4, cyn $$5, id $$6) {
         ehz.v $$7 = this.B.b[ij.c.d()];
         ehz.v $$8 = this.B;
         ehz.v $$9 = $$7.b[ij.b.d()];
         ehz.v $$10 = $$8.b[ij.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ij.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ij.a.d()]);
         }
   ...
   public static class o extends ehz.r {
      public o(ij $$0, ehz.v $$1) {
         super(egh.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ehz.r {
      public p(ij $$0, ehz.v $$1) {
         super(egh.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ehz.r {
      public q(ij $$0, efi $$1) {
         super(egh.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends efu {
      protected static final dpi b = dcj.hZ.n();
      protected static final dpi c = dcj.ia.n();
      protected static final dpi d = dcj.ib.n();
      protected static final dpi h = c;
      protected static final dpi i = dcj.ii.n();
      protected static final boolean j = true;
      protected static final dpi k = dcj.G.n();
      protected static final Set<dch> l = ImmutableSet.builder().add(dcj.dO).add(dcj.iC).add(dcj.mW).add(k.b()).build();
      ...
      public r(egh $$0, ij $$1, int $$2, efi $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(egh $$0, int $$1, ij $$2, ehz.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static efi a(ij $$0, ehz.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         efi $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dab $$0, efi $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dpi $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dab $$0, efi $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dab $$0, efi $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dpi $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(efi $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dab $$0, efi $$1, int $$2, int $$3, int $$4) {
         id $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cgv $$6 = bqg.D.a((czg)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eO());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bqx.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ehz.r {
      private int a;

      public s(ij $$0, ehz.v $$1, axt $$2) {
         super(egh.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dab $$0, czz $$1, drf $$2, axt $$3, efi $$4, cyn $$5, id $$6) {
         ...
         if (this.B.b[ij.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ij.a.d()] && !this.B.c[ij.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends ehz.r {
      public t(ij $$0, ehz.v $$1) {
         super(egh.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ehz.r {
      private int a;

      public u(ij $$0, efi $$1, int $$2) {
         super(egh.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
