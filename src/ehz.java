...
public enum ehz implements ash {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ash.a<ehz> t = ash.a(ehz::values);
   public static final IntFunction<ehz> u = aqk.a(ehz::a, values(), aqk.a.a);
   private final int v;
   private final String w;

   private ehz(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
