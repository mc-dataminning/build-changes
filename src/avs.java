...
public class avs implements AutoCloseable {
   ...
   private avs(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static avs.a a(Path $$0) {
         return new avs.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
