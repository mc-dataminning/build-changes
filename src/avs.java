...
public class avs extends azt {
   public static final Gson a = new GsonBuilder().registerTypeAdapter(ur.class, new JsonDeserializer<ur>() {
      public vf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         if ($$0.isJsonPrimitive()) {
            return ur.b($$0.getAsString());
         } else if ($$0.isJsonArray()) {
            JsonArray $$3 = $$0.getAsJsonArray();
            vf $$4 = null;

            for (JsonElement $$5 : $$3) {
               vf $$6 = this.a($$5, $$5.getClass(), $$2);
               if ($$4 == null) {
                  $$4 = $$6;
               } else {
                  $$4.b($$6);
   ...
   public avs(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntitySignTextStrictJsonFix", bat.s, "Sign");
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0, String $$1) {
      ...
      return $$0.set($$1, $$0.createString(ur.a.a($$3)));
   }
