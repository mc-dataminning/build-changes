...
public class avs extends avr {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avs.a> s;
   private final avn t;
   private long u;
   private final alv v;

   private avs(alv $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avo.c($$2, 7, $$0.getLength());
      }
   }
