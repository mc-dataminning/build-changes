...
public class eur extends euu {
   public static final int a = 854;
   public static final int b = 480;
   static final eur.b l = new eur.b(854, 480);

   public eur(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eur.a[] e = values();
   ...
   static class b {
      ...
      static List<eur.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eur.b($$0, $$1), eur.l) : ImmutableList.of(eur.l);
      }
