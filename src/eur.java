...
public class eur implements eus {
   private static final aeu a = new aeu("toast/system");
   ...
   public eur(eur.a $$0, ti $$1, @Nullable ti $$2) {
      this($$0, $$1, a($$2), Math.max(160, 30 + Math.max(eqq.O().h.a($$1), $$2 == null ? 0 : eqq.O().h.a($$2))));
   }

   public static eur a(eqq $$0, eur.a $$1, ti $$2, ti $$3) {
      ery $$4 = $$0.h;
      List<arf> $$5 = $$4.c($$3, 200);
      int $$6 = Math.max(200, $$5.stream().mapToInt($$4::a).max().orElse(200));
      return new eur($$1, $$2, $$5, $$6 + 30);
   }

   private eur(eur.a $$0, ti $$1, List<arf> $$2, int $$3) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.l = $$3;
   ...
   private static ImmutableList<arf> a(@Nullable ti $$0) {
   ...
   public void a(ti $$0, @Nullable ti $$1) {
      this.h = $$0;
      this.i = a($$1);
      this.k = true;
   }
   ...
   public static void a(eut $$0, eur.a $$1, ti $$2, @Nullable ti $$3) {
      $$0.a(new eur($$1, $$2, $$3));
   }

   public static void b(eut $$0, eur.a $$1, ti $$2, @Nullable ti $$3) {
   ...
   public static void a(eqq $$0, String $$1) {
      a($$0.ay(), eur.a.e, ti.c("selectWorld.access_failure"), ti.b($$1));
   }

   public static void b(eqq $$0, String $$1) {
      a($$0.ay(), eur.a.e, ti.c("selectWorld.delete_failure"), ti.b($$1));
   }

   public static void c(eqq $$0, String $$1) {
      a($$0.ay(), eur.a.f, ti.c("pack.copyFailure"), ti.b($$1));
   }
