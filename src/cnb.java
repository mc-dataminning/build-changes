...
public class cnb {
   ...
   public boolean a(cyv<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cyv<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cnb.a($$0).a($$2, $$1);
   }

   public int a(cyx<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cyx<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cnb.a($$0.b()).b($$1, $$2);
   }

   public static cup a(int $$0) {
      return $$0 == 0 ? cup.l : new cup(cuk.b($$0));
   }
   ...
   class a {
      private final cyv<?> b;
      private final List<cys> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public a(final cyv<?> $$0) {
         this.b = $$0;
         this.c.addAll($$0.a());
         this.c.removeIf(cys::c);
         this.d = this.c.size();
         this.e = this.a();
