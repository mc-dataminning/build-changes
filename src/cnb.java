...
public class cnb extends cok implements cop {
   private static final akj<Integer> a = akn.a(cnb.class, akl.b);
   private static final akj<Integer> b = akn.a(cnb.class, akl.b);
   private static final akj<Integer> c = akn.a(cnb.class, akl.b);
   private static final List<akj<Integer>> d = ImmutableList.of(a, b, c);
   private static final akj<Integer> bG = akn.a(cnb.class, akl.b);
   ...
   public cnb(bwr<? extends cnb> $$0, djh $$1) {
      super($$0, $$1);
   ...
   public void k_() {
      ...
      if (!this.dU().C && this.c(0) > 0) {
         ...
         if ($$1 != null) {
            ...
            $$0 = new fex($$0.d, $$2, $$0.f);
            fex $$3 = new fex($$1.dz() - this.dz(), 0.0, $$1.dF() - this.dF());
            if ($$3.j() > 9.0) {
               fex $$4 = $$3.d();
   ...
   protected void a(arq $$0) {
      if (this.t() > 0) {
         ...
         if ($$1 <= 0) {
            $$0.a(this, this.dz(), this.dD(), this.dF(), 7.0F, false, djh.a.c);
            if (!this.aZ()) {
               $$0.b(1023, this.du(), 0);
            }
         }
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      fex $$11 = new fex($$8, $$9, $$10);
      cst $$12 = new cst(this.dU(), this, $$11.d());
      $$12.c(this);
      if ($$4) {
         $$12.a(true);
      }
   ...
   public boolean a(arq $$0, bux $$1, float $$2) {
      if (this.a($$0, $$1)) {
         return false;
      } else if ($$1.a(axd.t) || $$1.d() instanceof cnb) {
         return false;
         ...
         if (this.x()) {
            bwi $$3 = $$1.c();
            if ($$3 instanceof crr || $$3 instanceof csx) {
               return false;
            }
         }
   ...
   public static byo.a m() {
      return cok.gw().a(byp.s, 300.0).a(byp.v, 0.6F).a(byp.l, 0.6F).a(byp.m, 40.0).a(byp.a, 4.0);
   }
