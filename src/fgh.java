...
public class fgh implements AutoCloseable {
   private static final int a = -1;
   private final alz b;
   private int c;

   private fgh(int $$0, alz $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fgh a(alz $$0, fgh.a $$1, String $$2) throws gmc.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gmc.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fgh($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fgh.a[] c = values();
