...
public class fgh {
   ...
   public void a(fia $$0, String $$1, fix.a $$2, evf $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fgh.b $$13 = new fgh.b($$1.trim(), this.f, $$3, $$2);
                  fgh.a $$14 = new fgh.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fgh.c $$30 = new fgh.c(this.f, $$2, $$0);
                        fgh.a $$31 = new fgh.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fie(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, evf $$2) throws IOException {
      ...
      File $$15 = new File(flj.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final evf d;
      private final fix.a e;

      b(final String $$0, final File $$1, final evf $$2, final fix.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fgh.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fgh.this.b && !fgh.this.d) {
            try {
               fgh.this.e = true;
               fgh.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fgh.a.error("Error extracting archive", var3);
               fgh.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      c(final File $$0, final fix.a $$1, final fia $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fgh.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fgh.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fgh.this.g);
                  fgh.this.c = true;
               } else {
                  fgh.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fgh.this.d = true;
               }
            } catch (IOException var3) {
               fgh.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fgh.this.d = true;
            }
         }
      }
