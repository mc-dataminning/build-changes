...
public class fgh implements Comparable<fgh> {
   private static final Map<String, fgh> h = Maps.newHashMap();
   private static final Map<ezx.a, fgh> i = Maps.newHashMap();
   ...
   private final ezx.a m;
   private final String n;
   private ezx.a o;
   private boolean p;
   private int q;

   public static void a(ezx.a $$0) {
      fgh $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(ezx.a $$0, boolean $$1) {
      fgh $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fgh $$0 : h.values()) {
         if ($$0.o.a() == ezx.b.a && $$0.o.b() != ezx.bv.b()) {
            $$0.a(ezx.a(fgj.Q().aP().i(), $$0.o.b()));
         }
      }
   }
   ...
   public fgh(String $$0, int $$1, String $$2) {
      this($$0, ezx.b.a, $$1, $$2);
   }

   public fgh(String $$0, ezx.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(ezx.a $$0) {
      this.o = $$0;
   }

   public int a(fgh $$0) {
      return this.n.equals($$0.n) ? gse.a(this.l).compareTo(gse.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(fgh $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(ezx.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == ezx.bv.b() ? this.o.a() == ezx.b.b && this.o.b() == $$1 : this.o.a() == ezx.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == ezx.b.c && this.o.b() == $$0;
   }
