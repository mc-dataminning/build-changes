...
public class fgh {
   public static List<fhs> a(fgh.a... $$0) {
      for (fgh.a $$1 : $$0) {
         a($$1.j);
      }

      List<fhs> $$2 = Lists.newArrayList();

      for (fgh.a $$3 : $$0) {
         $$2.add(new fhs($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fhs::a));
      return $$2;
   }
   ...
   public static List<fhs> a() {
      return a(fgh.a.values());
   }
