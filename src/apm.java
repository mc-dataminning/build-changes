...
public class apm extends apr {
   ...
   private final Set<apn<?>> e = Sets.newHashSet();

   public apm(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<apn<?>> d() {
      Set<apn<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<apn<T>> a(app<T> $$0, String $$1) {
      return Optional.ofNullable(aez.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<app<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apn<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apn<?>>)$$3.next();
         apn<?> $$2 = (apn<?>)$$1.getKey();
      ...
      for (Entry<app<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> aez b(apn<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(aku $$0) {
      Object2IntMap<apn<?>> $$1 = new Object2IntOpenHashMap();
