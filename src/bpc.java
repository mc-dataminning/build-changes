...
public class bpc {
   ...
   private static void a(bpf $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dya, bpo<bpe>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bpo)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dya, bpo<bpe>> $$3 : $$0) {
         bpo<bpe> $$4 = (bpo<bpe>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dya)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpm> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bor.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bpa $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bpc::a));
      $$1.add("chunksWritten", this.a($$0.m(), bpc::a));
      return $$1;
   }
   ...
   private JsonElement c(bpa $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bpc::a));
      $$1.add("received", this.a($$0.k(), bpc::a));
      return $$1;
   }

   private <T> JsonElement a(bpj<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bpg> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bpg>, ToDoubleFunction<bpg>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bpg::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bpg::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bpg::c));
      return $$1;
   }
}
