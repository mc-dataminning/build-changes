...
public class bpc extends bpg {
   public static final MapCodec<bpc> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bpc a(float $$0, float $$1, float $$2, float $$3) {
      return new bpc($$0, $$1, $$2, $$3);
   }

   private bpc(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
