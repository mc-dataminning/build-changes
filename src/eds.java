...
public class eds {
   private static final eds a = new eds(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eds.a a(int $$0, int $$1) {
         return new eds.a(1.0, 0.0);
      }
   ...
   private static final esa b = esa.b(new edr(42L), qi.a);
   ...
   private final Long2ObjectOpenHashMap<edt> h;
   private final Long2ObjectOpenHashMap<edt> i;

   public static eds a() {
      return a;
   }

   public static eds a(@Nullable ark $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dfm $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<edt> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<edt> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayy.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eds($$2, $$3);
         }
      }
   }

   eds(Long2ObjectOpenHashMap<edt> $$0, Long2ObjectOpenHashMap<edt> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eds.a a(int $$0, int $$1) {
      int $$2 = kc.a($$0);
      int $$3 = kc.a($$1);
      double $$4 = this.a($$2, 0, $$3, edt::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eds.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dfm.a($$5x)), kc.d(dfm.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = (double)ayy.f((float)($$2 - $$5xx), (float)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
   ...
   public double a(ecj.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kc.d(dfm.a($$6x)), kc.d(dfm.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, eds.b $$3) {
      int $$4 = kc.e($$0);
      int $$5 = kc.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eds.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      edt $$6 = (edt)this.h.get(dfm.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kc.d($$1), $$4, $$5 - kc.d($$2)) : Double.MAX_VALUE;
   }

   public dhl a(dhl $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jr<dhi> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jr<dhi> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jr<dhi>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dfm.a($$5x)), $$1, kc.d(dfm.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = (double)ayy.f((float)($$0 - $$4xx), (float)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
   ...
   public static void a(ark $$0, dyq $$1) {
      dfm $$2 = $$1.f();
      boolean $$3 = $$1.u();
      ji.a $$4 = new ji.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ecq.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dyq $$0, ji $$1) {
      dwv $$2 = $$0.a_($$1);
      if ($$2.a(awo.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dhe $$0, dzk $$1) {
      dfm $$2 = $$1.f();
      Builder<jo, edt> $$3 = ImmutableMap.builder();
   ...
   public static eds.c a(@Nullable edt $$0, Map<jo, edt> $$1) {
      List<eds.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eds.c a(@Nullable jo $$0, edt $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jn $$4 : $$0.a()) {
   ...
   interface b {
      double get(edt var1, int var2, int var3, int var4);
   }
