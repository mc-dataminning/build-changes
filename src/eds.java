...
public class eds implements edc {
   public static final Codec<eds> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eho.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               efd.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               efd.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dzb.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, eds::new)
   );
   ...
   public eds(ji<eho> $$0, int $$1, int $$2, axf<dez> $$3, efd $$4, int $$5, int $$6, int $$7, int $$8, efd $$9, int $$10, int $$11, dzb $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
