...
public class bin extends biq implements bkd {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final aee<Float> f = aeh.a(bin.class, aeg.d);
   private static final aee<Integer> g = aeh.a(bin.class, aeg.b);
   private static final aee<Boolean> h = aeh.a(bin.class, aeg.k);
   private static final aee<it> i = aeh.a(bin.class, aeg.l);
   ...
   private clc n = clf.b;
   private final List<bid> o = Lists.newArrayList();
   private final Map<biq, Integer> p = Maps.newHashMap();
   private int q = 600;
   private int r = 20;
   private int s = 20;
   private boolean t;
   ...
   public bin(biu<? extends bin> $$0, cpv $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public bin(cpv $$0, double $$1, double $$2, double $$3) {
      this(biu.c, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dL().B) {
         this.al().b(f, arw.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   public void l() {
      ...
      if (this.dL().B) {
         ...
         if ($$0) {
            ...
            $$3 = arw.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ag.i() * (float) (Math.PI * 2);
            float $$9 = arw.c(this.ag.i()) * $$4;
            double $$10 = this.dq() + (double)(arw.b($$8) * $$9);
            double $$11 = this.ds();
            double $$12 = this.dw() + (double)(arw.a($$8) * $$9);
            double $$14;
            double $$15;
            double $$16;
            if ($$2.b() == iv.v) {
         ...
         if (this.ah % 5 == 0) {
            ...
            List<bid> $$24 = Lists.newArrayList();

            for (bid $$25 : this.n.a()) {
               $$24.add(new bid($$25.c(), $$25.a($$0x -> $$0x / 4), $$25.e(), $$25.f(), $$25.g()));
            }
   ...
   @Nullable
   public bjg s() {
      if (this.aF == null && this.aG != null && this.dL() instanceof akq) {
         biq $$0 = ((akq)this.dL()).a(this.aG);
         if ($$0 instanceof bjg) {
            this.aF = (bjg)$$0;
         }
      }
