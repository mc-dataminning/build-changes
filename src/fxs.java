...
public class fxs extends fxr implements abp, xc {
   private static final Logger j = LogUtils.getLogger();
   private final GameProfile k;
   private cpk l;
   private final jw.b m;
   private final fyh n = new fyh();
   @Nullable
   private fya o;
   @Nullable
   protected fhe.b i;

   public fxs(ffe $$0, wj $$1, fxy $$2) {
      super($$0, $$1, $$2);
      this.k = $$2.a();
      this.m = $$2.c();
      this.l = $$2.d();
   ...
   public void a(abq $$0) {
      ...
      this.b.a(agu.b.bind(wz.a($$1)), new fxv(this.a, this.b, new fxy(this.k, this.e, $$1, this.l, this.d, this.c, this.f, this.h, this.i)));
      this.b.a(aby.a);
