...
public class fxs implements fph, fqb {
   ...
   public fxs(fya $$0, boolean $$1) {
      this.l = $$0;
      this.m = $$1;
   }

   public void a(fxx $$0, bbp $$1, boolean $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      this.j = $$0;
      List<ddj> $$8 = $$0.a(fxx.a.b);
      List<ddj> $$9 = $$2 ? Collections.emptyList() : $$0.a(fxx.a.c);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         ...
         if (this.m) {
            this.f.add(new fxs.c($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         } else {
            this.f.add(new fxs.a($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         }
      }
   ...
   public void a(fnq $$0, int $$1, int $$2, float $$3) {
      if (this.g) {
         ...
         int $$7 = 4;
         $$0.a(glt::B, b, this.h, this.i, $$5 * 25 + 8, $$6 * 25 + 8);
   ...
   class a extends fxs.b {
      ...
      private static List<fxs.b.a> a(ddi $$0, bbp $$1) {
         List<fxs.b.a> $$2 = new ArrayList<>();
   ...
   abstract class b extends fob {
      final ddk b;
      private final boolean c;
      private final List<fxs.b.a> d;

      public b(final int $$0, final int $$1, final ddk $$2, final boolean $$3, final List<fxs.b.a> $$4) {
      ...
      protected static fxs.b.a a(int $$0, int $$1, List<cxo> $$2) {
         return new fxs.b.a(3 + $$0 * 7, 3 + $$1 * 7, $$2);
      }
