...
public class fxs extends fxi implements giy.a {
   ...
   private static final ww F = ww.c("advancements.sad_label");
   private static final ww G = ww.c("advancements.empty");
   private static final ww H = ww.c("gui.advancements");
   private final fve I = new fve(this);
   @Nullable
   private final fxi J;
   private final giy K;
   private final Map<ai, fxo> L = Maps.newLinkedHashMap();
   @Nullable
   private fxo M;
   private boolean N;
   ...
   public fxs(giy $$0, @Nullable fxi $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aN_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fxo $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(frq.a(wv.d, $$0x -> this.aK_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(frc $$0, int $$1, int $$2) {
      $$0.a(gpn::H, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fxo $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fxo $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(frc $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(aj $$0) {
      fxo $$1 = fxo.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
