...
public class fqv {
   ...
   public void a(fqv.b $$0, Matrix4f $$1, fgp $$2, int $$3) {
      yh $$4 = $$0.f();
      boolean $$5 = $$4.d();
      float $$6 = $$0.a();
      float $$7 = $$0.b();
   ...
   private void a(boolean $$0, float $$1, float $$2, Matrix4f $$3, fgp $$4, int $$5, boolean $$6, int $$7) {
      this.a($$0, $$1, $$2, 0.0F, $$3, $$4, $$5, $$6, $$7);
   }

   private void a(boolean $$0, float $$1, float $$2, float $$3, Matrix4f $$4, fgp $$5, int $$6, boolean $$7, int $$8) {
      float $$9 = $$1 + this.g;
      float $$10 = $$1 + this.h;
      float $$11 = $$2 + this.i;
      float $$12 = $$2 + this.j;
   ...
   private void a(fqv.a $$0, float $$1, float $$2, int $$3, fgp $$4, int $$5, Matrix4f $$6) {
   ...
   public static record b(float a, float b, int c, int d, fqv e, yh f, float g, float h) {
      boolean i() {
         return this.d() != 0;
      }
   }
