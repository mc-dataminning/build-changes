...
public class fqv {
   ...
   private static final Map<eel.a, String> e = Maps.newEnumMap(Map.of(eel.a.a, "SW", eel.a.b, "S", eel.a.c, "OW", eel.a.d, "O", eel.a.e, "M", eel.a.f, "ML"));
   private final fnd f;
   private final fqv.a g;
   private final fpx h;
   private fcs i;
   private fcs j;
   @Nullable
   ...
   private eat l;
   @Nullable
   private CompletableFuture<eat> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bol r = new bol(1);
   private final bol s = new bol(boq.values().length);
   private final bol t = new bol(1);
   private final bol u = new bol(1);
   private final Map<bom, bol> v = Map.of(bom.a, this.s);
   private final fse w;
   private final fsh x;
   private final fsf y;
   private final fsd z;
   ...
   public fqv(fnd $$0) {
      ...
      this.g = new fqv.a();
      this.h = $$0.h;
      this.w = new fse(this.h, this.r);
      this.x = new fsh(this.h, this.s, () -> $$0.s.u().g());
      this.y = new fsf(this.h, this.t);
      this.z = new fsd(this.h, this.u);
      this.A = new fsg(this.h);
   }
   ...
   private void a(fpz $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dhp $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arn ? ((arn)$$23).y() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.h, kl.a($$14.v()), $$22.i, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azk.h($$15.dL()), azk.h($$15.dN())));
         eat $$27 = this.u();
         if ($$27.E()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().q().a($$14, 0);
            int $$29 = this.f.s.a(dhy.a, $$14);
            int $$30 = this.f.s.a(dhy.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            eat $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (eel.a $$33 : eel.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.as();
                  long $$36 = $$31.w();
                  bto $$37 = new bto($$23.an(), $$23.af(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dia.d $$44 = $$39.o();
            if ($$44 != null) {
               Object2IntMap<bwu> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bwu.values())
   ...
   private static String a(js<dis> $$0) {
   ...
   private dhp s() {
      return (dhp)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.aj()))), this.f.s);
   }
   ...
   private eat t() {
      if (this.m == null) {
         ...
         this.m = $$0.m().b(this.k.h, this.k.i, ebk.n, false).thenApply($$0x -> (eat)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fgh.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fnd.Q().aO().k(), fnd.Q().aO().l(), fgh.a()),
            fgh.c(),
            fgh.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == fcs.a.b) {
            ...
            $$4.add(String.valueOf(md.e.b($$6.b())));

            for (Entry<dzp<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == fcs.a.b) {
            ...
            $$4.add(String.valueOf(md.c.b($$9.a())));

            for (Entry<dzp<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(md.f.b($$11.aq())));
         }
   ...
   private String a(Entry<dzp<?>, Comparable<?>> $$0) {
      dzp<?> $$1 = $$0.getKey();
