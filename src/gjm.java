public class gjm extends gjc {
   gjm(gfi $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, gjl $$8) {
   ...
   public static class a implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjm($$1, $$2, $$3, $$4, $$5, $$6, $$7, ayp.a(255, 204, 31, 102), this.a);
      }
   }
   ...
   public static class b implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjm($$1, $$2, $$3, $$4, $$5, $$6, $$7, ayp.a(255, 255, 255, 255), this.a);
      }
   }
}
