public class cro {
   ...
   private void b(int $$0, float $$1) {
      this.a = azn.a($$0 + this.a, 0, 20);
      this.b = azn.a($$1 + this.b, 0.0F, (float)this.a);
   }
   ...
   public void a(cor $$0) {
      ...
      boolean $$2 = $$0.dY().ac().b(dfb.k);
      if ($$2 && this.b > 0.0F && $$0.gx() && this.a >= 20) {
         this.d++;
         if (this.d >= 10) {
         ...
         this.d++;
         if (this.d >= 80) {
            if ($$0.eH() > 10.0F || $$1 == bse.d || $$0.eH() > 1.0F && $$1 == bse.c) {
               $$0.a($$0.dZ().j(), 1.0F);
            }
