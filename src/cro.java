...
public class cro {
   public static final cro a = new cro(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<cro> b = RecordCodecBuilder.create(
   ...
   public cro(List<String> $$0, List<String> $$1) {
