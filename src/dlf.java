...
public class dlf {
   private static final dfe a = csr.hj.n();
   private static final dfe b = csr.hk.n();
   private static final dfe c = csr.iA.n();
   private static final dfe d = csr.hn.n();
   private static final dfe e = csr.hv.n();
   private static final dfe f = csr.hx.n();
   private static final dfe g = csr.hr.n();
   private static final dfe h = csr.iC.n();
   private static final dfe i = csr.dP.n();
   private final dfe j;
   private final int k;
   private final dfe[] l;
   private final dzk m;
   ...
   public dlf(dlb $$0, dfe $$1, int $$2, dla $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dkw.P);
      this.l = a($$3.a(new aeu("clay_bands")));
      this.u = $$0.a(dkw.N);
      this.v = $$0.a(dkw.O);
      this.n = $$0.a(dkw.Q);
      this.o = $$0.a(dkw.R);
   ...
   public void a(dlb $$0, cqq $$1, ht<cqo> $$2, boolean $$3, dlk $$4, final dha $$5, dkr $$6, dle.o $$7) {
      ...
      dle.g $$13 = new dle.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dle.u $$14 = $$7.apply($$13);
      gw.a $$15 = new gw.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dkn.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            hg<cqo> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cqv.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dkn.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dfe> a(dle.o $$0, dmn $$1, Function<gw, hg<cqo>> $$2, dha $$3, dkr $$4, gw $$5, boolean $$6) {
      dle.g $$7 = new dle.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(je.ap), $$1);
      dle.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dfe $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dgx $$0, int $$1, int $$2, int $$3, cps $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cqo $$1, dgx $$2, gw.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(csr.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(arx $$0, dfe[] $$1, int $$2, dfe $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dfe a(int $$0, int $$1, int $$2) {
