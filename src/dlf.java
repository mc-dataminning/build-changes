...
public interface dlf<T extends Enum<T>> {
   int x_ = 4;

   Optional<dxo> k_(dxo var1);

   float av_();

   default void a_(dxo $$0, arx $$1, jh $$2, bac $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dxo> c(dxo $$0, arx $$1, jh $$2, bac $$3) {
      ...
      for (jh $$7 : jh.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dlf<?> $$9) {
            Enum<?> $$10 = $$9.c();
