...
public class dys {
   ...
   private final Map<Character, Predicate<dyq>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dys a(char $$0, Predicate<dyq> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dyq>[][][] c() {
      this.d();
      Predicate<dyq>[][][] $$0 = (Predicate<dyq>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dyq>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
