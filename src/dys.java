...
public class dys {
   ...
   private final dbv p;
   private static final List<deu> q = List.of(dew.l, dew.L, dew.i, dew.b, dew.k, dew.I, dew.K, dew.fl, dew.dP, dew.iA, dew.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ji<dcs>>> t;
   ...
   public static final Codec<dys> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dys::a, Function.identity());

   private static DataResult<dys> a(dys $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dys(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ji<dcs>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kb.c($$0);
      int $$5 = kb.c($$1) - $$4;
   ...
   @Nullable
   public static dys a(ari $$0, int $$1, int $$2) {
      dtt $$3 = $$0.a($$1, $$2);
      dys $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dus.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jf> a(dco $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dtt $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayu.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dtt $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxp.a.a)) {
         $$3 = Math.min($$0.a(dxp.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(dtt $$0, iz.a $$1) {
      return a($$0, (iz)$$1.c(je.a)) ? 1.0 : -1.0;
   }

   private static double b(dtt $$0, iz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dtt $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ji<dcs>> b(dtt $$0, int $$1, int $$2) {
      ObjectArrayList<ji<dcs>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dtt $$0, iz $$1) {
      drx $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awl.O)) {
         ...
         return $$2.a(dew.eT) || $$2.a(dew.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dys.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dys.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ji<dcs> var3);
   }
