...
public class ehb extends ego<eil> {
   public ehb(Codec<eil> $$0) {
      super($$0);
   }
   ...
   private void a(bam $$0, dhb $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dhb $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dhb $$0, bam $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dxn $$13) {
   ...
   private void a(jh $$0, dhb $$1, bam $$2, int $$3, int $$4, boolean $$5, boolean $$6, dxn $$7) {
      dxn $$8 = $$1.a_($$0);
   ...
   private static boolean c(dxn $$0) {
      return $$0.a(dkg.iT) || $$0.a(dkg.ec) || $$0.a(dkg.nr);
   }
   ...
   private void a(dhb $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
            ...
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dkg.ea)) {
                  if (this.a((dgf)$$0, $$10)) {
                     ...
                     dxn[] $$12 = new dxn[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
