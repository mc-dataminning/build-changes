...
public class ehb {
   ...
   private static final Queue<ehb.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ehb.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ehb::a), egz::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ehb::a), egz::a), 0L);
         }
      }
   }
