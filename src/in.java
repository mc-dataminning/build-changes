...
public interface in<T> extends Iterable<ij<T>> {
   ...
   Either<auo<T>, List<ij<T>>> c();

   Optional<ij<T>> a(awo var1);
   ...
   @Deprecated
   @VisibleForTesting
   static <T> in.c<T> a(im<T> $$0, auo<T> $$1) {
      return new in.c<>($$0, $$1);
   }
   ...
   public static class a<T> extends in.b<T> {
      ...
      @Override
      public Either<auo<T>, List<ij<T>>> c() {
         return Either.right(this.a);
      }

      @Override
      public Optional<auo<T>> d() {
