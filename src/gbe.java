...
public class gbe implements exi, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final exg c = new exg();
   private static final boolean d = true;
   private static gbe e;
   ...
   private final List<exo> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, exo> l = Maps.newHashMap();
   private final int m;
   ...
   public gbe(atu $$0, String $$1) throws IOException {
      akh $$2 = new akh("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      atp $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = axp.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = axp.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(axp.a($$5, "blend", null));
         this.s = a($$0, exl.a.a, $$6);
         this.t = a($$0, exl.a.b, $$7);
         this.m = exm.a();
         exm.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = exo.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static exj a(atu $$0, exl.a $$1, String $$2) throws IOException {
      exl $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof exj)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         exj $$7;
         if ($$3 == null) {
            akh $$4 = new akh("shaders/program/" + $$2 + $$1.b());
            atp $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static exh a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new exh();
      } else {
         int $$1 = 32774;
