...
public class evn implements ejm {
   ...
   public static class b implements evj {
      public static final MapCodec<evn.b> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(aez.a.fieldOf("hex_file").forGetter($$0x -> $$0x.c), evn.g.a.listOf().fieldOf("size_overrides").forGetter($$0x -> $$0x.d))
               .apply($$0, evn.b::new)
      );
      private final aez c;
      private final List<evn.g> d;

      private b(aez $$0, List<evn.g> $$1) {
         this.c = $$0;
         this.d = $$1;
      }
   ...
   static record d(evn.f a, int b, int c) implements ejl {
      ...
      public evd bake(Function<ejn, evd> $$0) {
         return $$0.apply(new ejn() {
            ...
            public void a(int $$0, int $$1) {
               ...
               $$2.rewind();
               GlStateManager.upload(0, $$0, $$1, d.this.c(), 16, ekk.a.a, $$2, MemoryUtil::memFree);
            }
   ...
   static record g(int b, int c, evn.c d) {
      private static final Codec<evn.g> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(arj.w.fieldOf("from").forGetter(evn.g::a), arj.w.fieldOf("to").forGetter(evn.g::b), evn.c.a.forGetter(evn.g::c))
               .apply($$0, evn.g::new)
      );
      public static final Codec<evn.g> a = arj.a(
         e,
