...
public class apu {
   ...
   public static final List<Function<String, apu.c>> a = ImmutableList.of(apv.a, aps.a, apw.a);
   public static final List<apu.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<apu.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<ep> $$0) {
      ...
      for (apu.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<ep, ?>, apu.b>)(($$0x, $$1x) -> $$0x.then(
                           eq.a("insert")
                              .then(
   ...
   private static List<vo> a(List<vo> $$0, apu.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<ep, ?> a(BiConsumer<ArgumentBuilder<ep, ?>, apu.b> $$0) {
   ...
   private static List<vo> a(CommandContext<ep> $$0, apu.c $$1) throws CommandSyntaxException {
      apt $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<vo> b(CommandContext<ep> $$0, apu.c $$1) throws CommandSyntaxException {
      apt $$2 = $$1.a($$0);
      fh.g $$3 = fh.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<ep> $$0, apu.c $$1, apu.a $$2, List<vo> $$3) throws CommandSyntaxException {
      apt $$4 = $$1.a($$0);
   ...
   private static int a(ep $$0, apt $$1, fh.g $$2) throws CommandSyntaxException {
      ur $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static vo a(fh.g $$0, apt $$1) throws CommandSyntaxException {
   ...
   private static int b(ep $$0, apt $$1, fh.g $$2) throws CommandSyntaxException {
      vo $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof vh) {
         $$4 = ayx.a(((vh)$$3).j());
   ...
   private static int a(ep $$0, apt $$1, fh.g $$2, double $$3) throws CommandSyntaxException {
      vo $$4 = a($$2, $$1);
      if (!($$4 instanceof vh)) {
   ...
   private static int a(ep $$0, apt $$1) throws CommandSyntaxException {
      ur $$2 = $$1.a();
      $$0.a(() -> $$1.a((vo)$$2), false);
      return 1;
   }

   private static int a(ep $$0, apt $$1, ur $$2) throws CommandSyntaxException {
      ur $$3 = $$1.a();
      if (fh.g.a($$2, 0)) {
         throw fh.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<ep, ?> create(apu.a var1);
   }

   public interface c {
      apt a(CommandContext<ep> var1) throws CommandSyntaxException;
