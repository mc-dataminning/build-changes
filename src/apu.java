...
public class apu {
   ...
   final List<uo> g = Collections.synchronizedList(Lists.newArrayList());

   public apu(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (apu.this.e.am()) {
                  $$1.addLast("legacy_query", new app(apu.this.d()));
               }

               uo.a($$1, xy.a, null);
               int $$2 = apu.this.e.m();
               uo $$3 = (uo)($$2 > 0 ? new va($$2) : new uo(xy.a));
               apu.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new apw(apu.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     vq $$3 = vq.b("Internal server error");
                     $$1.a(new yf($$3), ux.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<apu.a.a> d = Lists.newArrayList();
