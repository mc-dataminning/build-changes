...
public class bfi implements bfb {
   ...
   public static Set<bez> a() {
      Builder<bez> $$0 = ImmutableSet.builder();

      try {
         bfi.a $$1 = new bfi.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bez.a("cpu#" + $$1x, bey.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bez.a("heap MiB", bey.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bfa.a.a());
      return $$0.build();
   }
   ...
   public static bez a(final LongSupplier $$0) {
      ...
      bez.d $$3 = new bez.d(2.0F);
      return bez.a("ticktime", bey.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
