...
public interface bfi<Msg> extends AutoCloseable {
   ...
   default <Source> CompletableFuture<Source> b(Function<? super bfi<Source>, ? extends Msg> $$0) {
   ...
   default <Source> CompletableFuture<Source> c(Function<? super bfi<Either<Source, Exception>>, ? extends Msg> $$0) {
      CompletableFuture<Source> $$1 = new CompletableFuture<>();
