...
public class gfe extends gfa implements acr, xj {
   ...
   private gfd s;
   private gfd.a t;
   private final Map<UUID, gfp> u = Maps.newHashMap();
   private final Set<gfp> v = new ReferenceOpenHashSet();
   private final gey w;
   private final gfh x;
   ...
   private gff D = new gff(Map.of(), dcl.b.a());
   private final UUID E = UUID.randomUUID();
   private Set<aly<dha>> F;
   ...
   private yi O = yi.a();
   @Nullable
   private CompletableFuture<Optional<cpu>> P;
   @Nullable
   private ars Q;
   private final gex R = new gex();
   private final gfo S;
   private final gfj T;
   @Nullable
   private gfm U;
   ...
   private final fcx Y = new fcx();
   private final gfv Z = new gfv();

   public gfe(flz $$0, wp $$1, gfi $$2) {
      super($$0, $$1, $$2);
      this.r = $$2.a();
      this.G = $$2.c();
      this.H = $$2.d();
      this.w = new gey($$0, this.e);
      this.x = new gfh(this, $$0);
      this.S = new gfo(this, $$0.aQ().m());
      this.T = new gfj(this, $$0.aQ());
      if ($$2.i() != null) {
         $$0.m.d().a($$2.i());
      }

      this.I = czi.a(this.H);
      this.J = dvn.a($$2.c(), this.H);
   }
   ...
   public void a(aej $$0) {
      aaf.a($$0, this, this.a);
      this.a.r = new gfn(this.a, this);
      ahh $$1 = $$0.m();
      List<aly<dha>> $$2 = Lists.newArrayList($$0.f());
      ...
      boolean $$6 = $$1.g();
      int $$7 = $$1.j();
      gfd.a $$8 = new gfd.a(btb.c, $$0.e(), $$6);
      this.t = $$8;
      this.s = new gfd(this, $$8, $$3, $$4, this.z, this.A, this.a.f, $$5, $$1.c(), $$7);
      this.a.a(this.s, ftp.a.c);
      if (this.a.t == null) {
         this.a.t = this.a.r.a(this.s, new axq(), new flk());
         this.a.t.v(-180.0F);
         if (this.a.V() != null) {
   ...
   private bvf b(acs $$0) {
      ...
      if ($$1 == bvm.bS) {
         ...
         if ($$2 == null) {
            ...
            return new gkb(this.s, $$2.a());
         }
      } else {
         return $$1.a(this.s, bvl.r);
      }
   }

   private void a(bvf $$0) {
      if ($$0 instanceof crr $$1) {
         this.a.ak().a((hfb)(new heu($$1)));
      } else if ($$0 instanceof cht $$2) {
         boolean $$3 = $$2.ad_();
         heo $$4;
         if ($$3) {
            $$4 = new hem($$2);
   ...
   public void a(act $$0) {
      ...
      double $$2 = $$0.f();
      double $$3 = $$0.g();
      bvf $$4 = new bvr(this.s, $$1, $$2, $$3, $$0.h());
      $$4.f($$1, $$2, $$3);
      $$4.v(0.0F);
      $$4.w(0.0F);
      $$4.e($$0.b());
   ...
   public void a(aha $$0) {
      ...
      if ($$1 == null) {
         ...
         boolean $$2 = $$0.f().contains(bwp.a) || $$0.f().contains(bwp.b) || $$0.f().contains(bwp.c);
   ...
   public void a(aem $$0) {
      ...
      if ($$1 != null) {
         if ($$1.di()) {
            ajm $$2 = $$1.ap();
            fbs $$3 = $$2.a((long)$$0.b(), (long)$$0.e(), (long)$$0.f());
            $$2.e($$3);
         } else {
            if ($$0.j()) {
               ajm $$4 = $$1.ap();
               fbs $$5 = $$4.a((long)$$0.b(), (long)$$0.e(), (long)$$0.f());
               $$4.e($$5);
   ...
   public void a(aen $$0) {
      aaf.a($$0, this, this.a);
      bvf $$1 = $$0.a(this.s);
      if ($$1 instanceof crr $$2) {
         if (!$$1.di() && $$2.l() instanceof csg $$4) {
            $$4.e.addAll($$0.e());
         }
      }
   }
   ...
   private static boolean a(bwo $$0, Set<bwp> $$1, bvf $$2, boolean $$3) {
      bwo $$4 = bwo.b($$2);
      bwo $$5 = bwo.a($$4, $$0, $$1);
      ...
      if ($$3 && !$$6) {
         ...
         $$2.v($$5.c());
         $$2.w($$5.d());
         bwo $$7 = new bwo($$2.bC(), fbs.c, $$2.N, $$2.O);
         bwo $$8 = bwo.a($$7, $$0, $$1);
         $$2.c($$8.a(), $$8.c(), $$8.d());
         return false;
      }
   ...
   private void a(dzs $$0, int $$1, int $$2) {
      ete $$3 = this.s.h().p();
      dzt[] $$4 = $$0.d();
      dgg $$5 = $$0.f();
   ...
   public void a(agu $$0) {
      ...
      this.b.a(acg.d, new gfb(this.a, this.b, new gfi(this.r, this.e, this.G, this.H, this.d, this.c, this.f, this.h, $$1, this.i, this.j)));
      this.b(aia.a);
      this.b.a(acg.b);
   }
   ...
   public void a(agz $$0) {
      ...
      if ($$1 != null) {
         if ($$1 instanceof bvr) {
            this.s.a($$1.dA(), $$1.dC(), $$1.dG(), axf.ja, axg.h, 0.1F, (this.B.i() - this.B.i()) * 0.35F + 0.9F, false);
         } else {
            this.s.a($$1.dA(), $$1.dC(), $$1.dG(), axf.nT, axg.h, 0.2F, (this.B.i() - this.B.i()) * 1.4F + 2.0F, false);
         }

         this.a.g.a(new gif(this.a.aq(), this.a.aR(), this.s, $$1, $$2));
   ...
   public void a(agc $$0) {
      aaf.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof bvz $$2) {
         $$2.e_($$0.e());
      }
   }

   private static cxk a(cps $$0) {
   ...
   public void a(adv $$0) {
      ...
      if ($$1 != null) {
         switch ($$0.b()) {
            case 21:
               this.a.ak().a((hfb)(new het((cmo)$$1)));
               break;
            case 35:
               int $$2 = 40;
               this.a.g.a($$1, ls.al, 30);
               this.s.a($$1.dA(), $$1.dC(), $$1.dG(), axf.zX, $$1.dm(), 1.0F, 1.0F, false);
               if ($$1 == this.a.t) {
                  this.a.j.a(a((cps)this.a.t));
               }
               break;
            case 63:
               this.a.ak().a((hfb)(new hex((ckj)$$1)));
               break;
            default:
               $$1.b($$0.b());
         }
   ...
   public void a(afk $$0) {
      ...
      aly<dha> $$5 = $$4.dV().ah();
      boolean $$6 = $$2 != $$5;
      ftp.a $$7 = this.a($$4.eE(), $$2, $$5);
      if ($$6) {
         Map<evh, evj> $$8 = this.s.k();
         boolean $$9 = $$1.f();
         boolean $$10 = $$1.g();
         int $$11 = $$1.j();
         gfd.a $$12 = new gfd.a(this.t.q(), this.t.l(), $$10);
         this.t = $$12;
         this.s = new gfd(this, $$12, $$2, $$3, this.z, this.A, this.a.f, $$9, $$1.c(), $$11);
         this.s.a($$8);
         this.a.a(this.s, $$7);
      }
   ...
   private ftp.a a(boolean $$0, aly<dha> $$1, aly<dha> $$2) {
      ftp.a $$3 = ftp.a.c;
      if (!$$0) {
         if ($$1 == dha.j || $$2 == dha.j) {
            $$3 = ftp.a.a;
         } else if ($$1 == dha.k || $$2 == dha.k) {
            $$3 = ftp.a.b;
         }
      }
   ...
   public void a(aea $$0) {
      ...
      if (this.s.a($$0.f()) instanceof cjw $$2) {
         gka $$3 = this.a.t;
         int $$4 = $$0.e();
         btl $$5 = new btl(cjw.v($$4));
         ctz $$6 = new ctz($$0.b(), $$3.gg(), $$5, $$2, $$4);
         $$3.cd = $$6;
         this.a.a(new fvg($$6, $$3.gg(), $$2, $$4));
      }
   }
   ...
   public void a(aer $$0) {
      aaf.a($$0, this, this.a);
      jh $$1 = $$0.b();
      if (this.s.c_($$1) instanceof dwc $$2) {
         this.a.t.a($$2, $$0.e());
      } else {
   ...
   public void a(acy $$0) {
      ...
      this.a.s.a($$1, $$0.e()).ifPresent($$1x -> {
         ...
         if ($$1x instanceof duz && this.a.z instanceof fur) {
            ((fur)this.a.z).G();
         }
      });
   }
   ...
   public void a(age $$0) {
      aaf.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof bwb $$2) {
         $$0.e().forEach($$1 -> $$2.a((bvn)$$1.getFirst(), (cxk)$$1.getSecond()));
      }
   }
   ...
   public void a(adz $$0) {
      ...
      if ($$2 == adz.b) {
         ...
         this.s.a($$1, $$1.dA(), $$1.dC(), $$1.dG(), axf.vo, axg.g, 1.0F, 1.0F);
      } else if ($$2 == adz.l) {
         this.s.a(ls.q, $$1.dA(), $$1.dC(), $$1.dG(), 0.0, 0.0, 0.0);
         if ($$4 == 1) {
            this.s.a($$1, $$1.dA(), $$1.dC(), $$1.dG(), axf.ij, axg.f, 1.0F, 1.0F);
         }
      } else if ($$2 == adz.m) {
         this.a.t.b($$3 == 0.0F);
      } else if ($$2 == adz.n) {
   ...
   private void a(gka $$0, gfd $$1, ftp.a $$2) {
      this.U = new gfm($$0, $$1, this.a.f);
   ...
   public void a(ahf $$0) {
      ...
      if ($$1 instanceof bwb) {
         jq<bui> $$2 = $$0.e();
         buk $$3 = new buk($$2, $$0.g(), $$0.f(), $$0.i(), $$0.h(), $$0.j(), null);
         if (!$$0.k()) {
            $$3.k();
         }
   ...
   public void a(aat $$0) {
      ...
      $$1.forEach(kd.a::d);
      this.J = dvn.a(this.G, this.H);
      List<cxk> $$3 = List.copyOf(cwa.e().l());
      this.Z.a($$3);
   }
   ...
   public void a(aex $$0) {
      ...
      if ($$1 == this.a.t) {
         if (this.a.t.t()) {
            this.a.a(new fsv($$0.e(), this.s.j().l()));
         } else {
            this.a.t.ge();
         }
      }
   ...
   public void a(afo $$0) {
      ...
      if (this.c != null) {
         this.c.d = $$0.b();
         $$0.e().map(gfs::b).ifPresent(this.c::a);
         gft.b(this.c);
      }
   }
   ...
   public void a(afi $$0) {
      aaf.a($$0, this, this.a);
      if ($$0.a(this.s) instanceof bwb $$1) {
         $$1.d($$0.e());
      }
   }
   ...
   public void a(aez $$0) {
      ...
      for (aez.b $$1 : $$0.f()) {
         gfp $$2 = new gfp(Objects.requireNonNull($$1.b()), this.F());
   ...
   private void a(aez.a $$0, aez.b $$1, gfp $$2) {
      switch ($$0) {
         case b:
            this.a($$1, $$2);
            break;
   ...
   public void a(aeo $$0) {
      ...
      bvf $$1 = this.a.t.dg();
      if ($$1 != this.a.t && $$1.di()) {
         fbs $$2 = new fbs($$0.b(), $$0.e(), $$0.f());
         fbs $$3 = new fbs($$1.R_(), $$1.S_(), $$1.g_());
         if ($$2.f($$3) > 1.0E-5F) {
            $$1.f_();
   ...
   public void a(agi $$0) {
      ...
      String $$1 = $$0.b();
      if ($$0.f() == 0) {
         this.Y.a($$1, fda.b, $$0.e(), $$0.g(), false, $$0.h().orElse(null));
      } else {
         fcp $$2 = this.Y.a($$1);
         if ($$2 != null) {
            if ($$0.f() == 1) {
   ...
   public void a(agl $$0) {
      ...
      $$4.ifPresent($$1x -> {
         ...
         $$2.a($$1x.c());
         $$2.a($$1x.b());
         fcz.b $$2x = fcz.b.a($$1x.d());
         if ($$2x != null) {
            $$2.a($$2x);
         }

         fcz.a $$3x = fcz.a.a($$1x.e());
         if ($$3x != null) {
            $$2.a($$3x);
         }
   ...
   private void a(int $$0, int $$1, aei $$2, boolean $$3) {
      ...
      this.a($$0, $$1, $$4, dhj.a, $$5, $$6, $$7, $$3);
      BitSet $$8 = $$2.d();
      BitSet $$9 = $$2.e();
      Iterator<byte[]> $$10 = $$2.f().iterator();
      this.a($$0, $$1, $$4, dhj.b, $$8, $$9, $$10, $$3);
   ...
   public void a(afd $$0) {
      aaf.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof cqa $$2) {
         $$2.c = $$0.e();
      }
   }
   ...
   private void a(int $$0, int $$1, ete $$2, dhj $$3, BitSet $$4, BitSet $$5, Iterator<byte[]> $$6, boolean $$7) {
      for (int $$8 = 0; $$8 < $$2.c(); $$8++) {
         int $$9 = $$2.d() + $$8;
         boolean $$10 = $$4.get($$8);
         boolean $$11 = $$5.get($$8);
         if ($$10 || $$11) {
            $$2.a($$3, kj.a($$0, $$9, $$1), $$10 ? new dzn((byte[])$$6.next().clone()) : new dzn());
            if ($$7) {
               this.s.c($$0, $$9, $$1);
            }
         }
   ...
   public Collection<gfp> l() {
      return this.v;
   }

   public Collection<gfp> m() {
   ...
   @Nullable
   public gfp a(String $$0) {
      for (gfp $$1 : this.u.values()) {
