...
public class bno implements bnp {
   ...
   public boolean a(bnn $$0) {
      URL $$1 = bno.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnn $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnr a = new bnr(() -> bno.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bno.this.l && $$0.getState() == RecordingState.STOPPED) {
