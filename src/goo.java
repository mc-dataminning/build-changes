...
public class goo extends gnn<bum, gun> {
   public goo(gno.a $$0) {
      super($$0);
   }

   public void a(gun $$0, fdi $$1, ghl $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bum $$0, gun $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(bum $$0) {
      return false;
   }
}
