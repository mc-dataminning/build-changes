...
public interface jw extends jk.a {
   ...
   <E> Optional<jv<E>> c(ala<? extends jv<? extends E>> var1);

   @Override
   default <T> Optional<jk.b<T>> a(ala<? extends jv<? extends T>> $$0) {
      return this.c($$0).map(jv::p);
   }

   default <E> jv<E> d(ala<? extends jv<? extends E>> $$0) {
   ...
   @Override
   default Stream<ala<? extends jv<?>>> a() {
   ...
   static jw.b a(final jv<? extends jv<?>> $$0) {
      return new jw.b() {
         @Override
         public <T> Optional<jv<T>> c(ala<? extends jv<? extends T>> $$0x) {
            jv<jv<T>> $$1 = (jv<jv<T>>)$$0;
            return $$1.e((ala<jv<T>>)$$0);
         }
   ...
   public static class c implements jw {
      private final Map<? extends ala<? extends jv<?>>, ? extends jv<?>> c;

      public c(List<? extends jv<?>> $$0) {
         this.c = $$0.stream().collect(Collectors.toUnmodifiableMap(jv::c, $$0x -> $$0x));
      }

      public c(Map<? extends ala<? extends jv<?>>, ? extends jv<?>> $$0) {
         this.c = Map.copyOf($$0);
      }
      ...
      @Override
      public <E> Optional<jv<E>> c(ala<? extends jv<? extends E>> $$0) {
   ...
   public static record d<T>(ala<? extends jv<T>> a, jv<T> b) {

      private static <T, R extends jv<? extends T>> jw.d<T> a(Entry<? extends ala<? extends jv<?>>, R> $$0) {
         return a((ala<? extends jv<?>>)$$0.getKey(), $$0.getValue());
      }

      private static <T> jw.d<T> a(ala<? extends jv<?>> $$0, jv<?> $$1) {
         return new jw.d<>((ala<? extends jv<T>>)$$0, (jv<T>)$$1);
      }
