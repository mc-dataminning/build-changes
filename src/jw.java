...
public class jw {
   ...
   static <T> ji.b<T> a(final alq<? extends jt<? extends T>> $$0, final Lifecycle $$1, jj<T> $$2, final Map<alq<T>, jg.c<T>> $$3) {
      return new jw.e<T>($$2) {
         @Override
         public alq<? extends jt<? extends T>> g() {
            return $$0;
         }
   ...
   public <T> jw a(alq<? extends jt<T>> $$0, Lifecycle $$1, jw.i<T> $$2) {
      this.a.add(new jw.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> jw a(alq<? extends jt<T>> $$0, jw.i<T> $$1) {
   ...
   private static ji.a a(jw.m $$0, ju $$1, Stream<ji.b<?>> $$2) {
      record a<T>(ji.b<T> a, alp.b<T> b) {
         public static <T> a<T> a(ji.b<T> $$0) {
            return new a<>(new jw.d<>($$0, $$0), alp.b.a($$0));
         }

         public static <T> a<T> a(jw.m $$0, ji.b<T> $$1) {
            return new a<>(new jw.d<>($$0.a(), $$1), new alp.b<>($$0.a(), $$1, $$1.h()));
         }
      }

      final Map<alq<? extends jt<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new ji.a() {
         ...
         <T> Optional<a<T>> f(alq<? extends jt<? extends T>> $$0) {
   ...
   private ji.a a(ju $$0, ji.a $$1, iy.a $$2, Map<alq<? extends jt<?>>, jw.j<?>> $$3, ji.a $$4) {
      jw.m $$5 = new jw.m();
   ...
   private <T> ji.b<T> a(jj<T> $$0, iy.a $$1, alq<? extends jt<? extends T>> $$2, ji.a $$3, ji.a $$4, MutableObject<ji.a> $$5) {
      iy<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<alq<T>, jg.c<T>> $$7 = new HashMap<>();
         ji.b<T> $$8 = $$3.e($$2);
         $$8.c().forEach($$5x -> {
            alq<T> $$6x = $$5x.h();
   ...
   public jw.g a(ju $$0, ji.a $$1, iy.a $$2) {
      jw.b $$3 = this.b($$0);
      Map<alq<? extends jt<?>>, jw.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<alq<? extends jt<?>>> $$5 = $$0.b().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(jw.m a, jw.l b, Map<alr, jh<?>> c, Map<alq<?>, jw.h<?>> d, List<RuntimeException> e) {

      public static jw.b a(ju $$0, Stream<alq<? extends jt<?>>> $$1) {
         jw.m $$2 = new jw.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         jw.l $$4 = new jw.l($$2);
         Builder<alr, jh<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> qi<T> a() {
         return new qi<T>() {
            @Override
            public jg.c<T> a(alq<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jh<S> a(alq<? extends jt<? extends S>> $$0) {
      ...
      public void c() {
         for (alq<Object> $$0 : this.b.a.keySet()) {
   ...
   abstract static class c<T> implements jh<T> {
      ...
      @Override
      public Optional<jk.c<T>> a(ayc<T> $$0) {
   ...
   static class f<T> extends jg.c<T> {
      ...
      protected f(jj<T> $$0, @Nullable alq<T> $$1) {
   ...
   static record j<T>(alq<? extends jt<? extends T>> a, Lifecycle b, Map<alq<T>, jw.n<T>> c) {

      public ji.b<T> a(jw.m $$0) {
         Map<alq<T>, jg.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            jw.n<T> $$2 = (jw.n<T>)$$1x.getValue();
            jg.c<T> $$3 = $$2.b().orElseGet(() -> jg.c.a($$0.a(), (alq<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(alq<? extends jt<T>> a, Lifecycle b, jw.i<T> c) {
      void b(jw.b $$0) {
         this.c.run($$0.a());
      }

      public jw.j<T> a(jw.b $$0) {
         Map<alq<T>, jw.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<alq<?>, jw.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<alq<?>, jw.h<?>> $$3 = $$2.next();
            alq<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               jw.h<T> $$6 = (jw.h<T>)$$3.getValue();
               jg.c<T> $$7 = (jg.c<T>)$$0.b.a.remove($$4);
               $$1.put((alq<T>)$$4, new jw.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends jw.c<Object> {
      final Map<alq<Object>, jg.c<Object>> a = new HashMap<>();
