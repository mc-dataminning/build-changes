...
public class fs implements ArgumentType<cwt> {
   ...
   public static cwt a(CommandContext<ei> $$0, String $$1) {
      return (cwt)$$0.getArgument($$1, cwt.class);
   }

   public cwt a(StringReader $$0) throws CommandSyntaxException {
