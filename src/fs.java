...
public class fs implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> xa.b("slot.only_single_allowed", $$0));

   public static fs a() {
      return new fs();
   }

   public static int a(CommandContext<ej> $$0, String $$1) {
