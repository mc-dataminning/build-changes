...
public class fs<T> implements ArgumentType<fs.c<T>> {
   ...
   public fs(el $$0, ala<? extends jv<T>> $$1) {
      this.e = $$1;
      this.d = $$0.b($$1);
   }

   public static <T> fs<T> a(el $$0, ala<? extends jv<T>> $$1) {
      return new fs<>($$0, $$1);
   }

   public static <T> fs.c<T> a(CommandContext<ep> $$0, String $$1, ala<jv<T>> $$2) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      eu.a(this.d.e().map(axb::b), $$1, "#");
      return eu.a(this.d.c().map(ala::a), $$1);
   }
   ...
   static record b<T>(ji.c<T> a) implements fs.c<T> {
      ...
      @Override
      public <E> Optional<fs.c<E>> a(ala<? extends jv<E>> $$0) {
   ...
   public interface c<T> extends Predicate<ji<T>> {
      ...
      <E> Optional<fs.c<E>> a(ala<? extends jv<E>> var1);
