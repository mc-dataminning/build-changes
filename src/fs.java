...
public class fs {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ti.c("argument.pos.missing.double"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(ti.c("argument.pos.missing.int"));
