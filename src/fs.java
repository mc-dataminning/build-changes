...
public class fs implements ArgumentType<fs.a> {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xi.c("arguments.operation.invalid"));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xi.c("arguments.operation.div0"));
   ...
   @FunctionalInterface
   public interface a {
      void apply(faq var1, faq var2) throws CommandSyntaxException;
   }
   ...
   interface b extends fs.a {
      ...
      @Override
      default void apply(faq $$0, faq $$1) throws CommandSyntaxException {
