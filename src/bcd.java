...
public class bcd extends bhm {
   public bcd(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", biq.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(biq.s, "minecraft:jukebox");
