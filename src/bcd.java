...
public class bcd extends ayx {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcd::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcd::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcd::k);
         $$0 = this.a($$0, "minecraft:fox", bcd::j);
         $$0 = this.a($$0, "minecraft:item", bcd::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcd::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcd::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcd::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcd::e);
         return this.a($$0, "minecraft:piglin", bcd::d);
      });
   }
