...
public class bcd extends bex {
   public bcd(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bfy.z, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bfy.B.typeName(), bhj.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bfy.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bfy.B.typeName(), "minecraft:saddle"));
