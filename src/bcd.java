...
public class bcd extends bah {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "biomes",
                        DSL.optionalFields("palette", DSL.list(ayz.G.in($$0))),
                        "block_states",
                        DSL.optionalFields("palette", DSL.list(ayz.u.in($$0)))
                     )
                  ),
                  "Structures",
      ...
      $$0.registerType(false, ayz.H, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         ayz.I,
         () -> DSL.fields(
                           ...
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 ...
                                 DSL.taggedChoiceLazy(
                                    ...
                                    ImmutableMap.of(
                                       ...
                                       (Supplier<TypeTemplate>)() -> DSL.or(DSL.fields("preset", ayz.H.in($$0)), DSL.list(DSL.fields("biome", ayz.G.in($$0)))),
