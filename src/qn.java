...
public abstract class qn {
   ...
   private static volatile qn e = c();
   ...
   private static qn c() {
      ...
      return new qn() {
         ...
         @Override
         public ara a(ti $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> ase.c($$2xxx, $$1x, $$1) ? Optional.empty() : ti.a, ua.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = qn.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(arf.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract ara a(ti var1);

   public List<ara> a(List<ti> $$0) {
