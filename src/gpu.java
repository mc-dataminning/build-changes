...
public class gpu extends avi<Optional<gpu.b>> implements AutoCloseable {
   ...
   private gpu.a o = gpu.a.b;
   @Nullable
   private fpa p;
   @Nullable
   private gpu.b q;
   private final fkb r = new fkb(fhm.b);
   private boolean s;

   protected Optional<gpu.b> a(avd $$0, bqq $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gpu.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gpu.b> $$0, avd $$1, bqq $$2) {
   ...
   public void a(int $$0, fpa $$1, float $$2, fex $$3, float $$4) {
      if (this.q != null) {
         ...
         if (this.l || $$14 != this.m || $$15 != this.n || $$7 != this.o || $$1 != this.p) {
            ...
            this.o = $$7;
            this.p = $$1;
            fjx $$19 = this.a(fka.b(), $$14, $$15, $$1, $$7, $$18);
            if ($$19 != null) {
               this.r.a();
               this.r.a($$19);
               fkb.b();
   ...
   private void a(gqx $$0, float $$1, float $$2, float $$3) {
   ...
   @Nullable
   private fjx a(fka $$0, int $$1, int $$2, fpa $$3, gpu.a $$4, gqx $$5) {
      float $$6 = 0.8F;
      ...
      fju $$11 = $$0.a($$5.X(), $$5.W());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fpa.c);
      return $$11.a();
   }

   private void a(gpu.a $$0, fju $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(fju $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(gpu.a $$0, fju $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
