   ...
   public void a(ffu $$0, gly $$1, double $$2, double $$3, double $$4) {
      ...
      $$5.dV().a(bus.r, $$5.cR().g(100.0), $$0x -> true).forEach($$6 -> {
         ...
         $$7.map(zy.a::d).map($$1xx -> $$5.dV().a($$1xx)).map($$0xx -> $$0xx.o(this.h.av().a(true))).ifPresent($$6x -> {
            ...
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(gmi.a(2.0)), $$7x, 4.0F, c);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(gmi.a(2.0)), $$7x, 8.0F, d);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(gmi.a(2.0)), $$7x, 24.0F, e);
         });
         $$7.map(zy.a::e).ifPresent($$6x -> {
            a($$0, $$1, $$2, $$3, $$4, $$6.dt(), $$6x.b(), a);
            gpz.a($$0, $$1, fav.a(fba.a($$6x)).d(-$$2, -$$3, -$$4), 1.0F, 0.0F, 0.0F, 1.0F);
         });
      });
   }

   private static void a(ffu $$0, gly $$1, double $$2, double $$3, double $$4, fba $$5, fba $$6, int $$7) {
      ffy $$8 = $$1.getBuffer(gmi.a(2.0));
