...
public class aoi {
   ...
   private static int a(ep $$0, bsp $$1, bsp $$2) throws CommandSyntaxException {
      bsp $$3 = $$1.dc();
      if ($$3 != null) {
         ...
         $$0.a(() -> xl.a("commands.ride.mount.success", $$1.O_(), $$2.O_()), true);
         return 1;
      }
   }

   private static int a(ep $$0, bsp $$1) throws CommandSyntaxException {
      bsp $$2 = $$1.dc();
      if ($$2 == null) {
         throw a.create($$1.O_());
      } else {
         $$1.ac();
         $$0.a(() -> xl.a("commands.ride.dismount.success", $$1.O_(), $$2.O_()), true);
         return 1;
      }
   }
}
