...
public class aoi implements AutoCloseable {
   ...
   private aoi(URL $$0, aoi.c $$1, URL $$2, aoi.b $$3, URL $$4, aoi.b $$5, String $$6, aoi.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   void a(GameProfile $$0, URL $$1, aoi.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<anu> a(GameProfile $$0, String $$1, aoi.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(anu.a) : CompletableFuture.supplyAsync(() -> {
   ...
   private vj a(String $$0, JsonArray $$1, aoi.a $$2) {
      if ($$1.isEmpty()) {
         return vj.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return vj.b;
      } else {
         vj $$3 = new vj($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aoi.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public aoh a(GameProfile $$0) {
      return new aoi.d($$0);
   }
   ...
   public interface a {
      aoi.a a = ($$0, $$1) -> false;
      aoi.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aoi.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aoi.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements aoh {
      ...
      @Override
      public void a() {
         aoi.this.a(this.c, aoi.this.g, aoi.this.h, this.d);
      }

      @Override
      public void b() {
         aoi.this.a(this.c, aoi.this.i, aoi.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<anu>> a(List<String> $$0) {
         List<CompletableFuture<anu>> $$1 = $$0.stream().map($$0x -> aoi.this.a(this.c, $$0x, aoi.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<anu> a(String $$0) {
         return aoi.this.a(this.c, $$0, aoi.this.l, this.d);
      }
   }
