public class cuy extends ctn {
   ...
   public cuy(int $$0, cqh $$1) {
      this($$0, $$1, new cpr($$1.k));
   }

   public cuy(int $$0, cqh $$1, dgm $$2) {
      super(cuw.t, $$0);
      this.x = $$2;
      this.y = new cux($$2);
      this.a(new cvk(this.y, 0, 136, 37));
      this.a(new cvk(this.y, 1, 162, 37));
      this.a(new cuz($$1.k, $$2, this.y, 2, 220, 37));
      this.c($$1, 108, 84);
   }
   ...
   private void r() {
      if (!this.x.gx()) {
         bvs $$0 = (bvs)this.x;
         $$0.dV().a($$0.dA(), $$0.dC(), $$0.dG(), this.x.gt(), awl.g, 1.0F, 1.0F, false);
      }
   }
   ...
   public void a(cqi $$0) {
      ...
      this.x.a(null);
      if (!this.x.gx()) {
         if (!$$0.bK() || $$0 instanceof aro && ((aro)$$0).u()) {
            cxy $$1 = this.y.b(0);
            if (!$$1.f()) {
               $$0.a($$1, false);
            }
   ...
   private void a(int $$0, dgl $$1) {
      for (int $$2 = 3; $$2 < 39; $$2++) {
         cxy $$3 = this.k.get($$2).g();
         if (!$$3.f() && $$1.a($$3)) {
            cxy $$4 = this.y.a($$0);
            if ($$4.f() || cxy.c($$3, $$4)) {
               int $$5 = $$3.k();
