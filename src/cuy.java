...
public class cuy {
   ...
   private final cuy.a e;
   private final long f;

   public cuy(cuy.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cuy a(cuy.a $$0) {
      return new cuy($$0, this.f);
   }

   public ih<cuw> a(hx $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ih<cuw> a(double $$0, double $$1, double $$2) {
      int $$3 = is.a(aup.a($$0));
      int $$4 = is.a(aup.a($$1));
      int $$5 = is.a(aup.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = aul.a($$7, $$0);
      double $$10 = b($$7);
      return aup.k($$6 + $$10) + aup.k($$5 + $$9) + aup.k($$4 + $$8);
   }
   ...
   public interface a {
      ih<cuw> getNoiseBiome(int var1, int var2, int var3);
   }
}
