...
public class cuy {
   ...
   public static final cuy b = new cuy(0, 0);
   ...
   public static cuy a(int $$0, int $$1) {
      return new cuy($$0 << 5, $$1 << 5);
   }

   public static cuy b(int $$0, int $$1) {
      return new cuy(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof cuy $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public hz a(int $$0, int $$1, int $$2) {
      return new hz(this.a($$0), $$1, this.b($$2));
   }

   public int a(int $$0) {
      return jb.a(this.e, $$0);
   }

   public int b(int $$0) {
      return jb.a(this.f, $$0);
   }

   public hz c(int $$0) {
      return new hz(this.b(), $$0, this.c());
   }
   ...
   public static Stream<cuy> a(cuy $$0, int $$1) {
      return a(new cuy($$0.e - $$1, $$0.f - $$1), new cuy($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<cuy> a(final cuy $$0, final cuy $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<cuy>((long)($$2 * $$3), 64) {
         @Nullable
         private cuy e;

         @Override
         public boolean tryAdvance(Consumer<? super cuy> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new cuy($$0.e, $$2 + $$5);
               } else {
                  this.e = new cuy($$1 + $$4, $$2);
               }
            }
