...
public class nm implements lx {
   ...
   public CompletableFuture<?> a(lv $$0) {
      ...
      Consumer<ctv> $$6 = $$4::add;
      new nk($$2, $$5, $$6).a();
      new nl($$5).a();
      List<dff> $$7 = lq.e.h().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
