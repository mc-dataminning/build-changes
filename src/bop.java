...
public class bop implements boq {
   ...
   private static final bop k = new bop();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(boo $$0) {
      URL $$1 = bop.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, boo $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bos a = new bos(() -> bop.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bop.this.l && $$0.getState() == RecordingState.STOPPED) {
