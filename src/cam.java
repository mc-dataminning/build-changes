...
public class cam extends caa {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new elb($$0, this.g.dt() + $$5, $$1);
         }
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               elb $$8 = new elb(this.g.dr() - this.a.dr(), 0.0, this.g.dx() - this.a.dx()).d();
               elb $$9 = new elb((double)aty.a(this.a.dC() * (float) (Math.PI / 180.0)), 0.0, (double)(-aty.b(this.a.dC() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  elb $$13 = this.a.f(1.0F);
                  ...
                  cfa $$20 = new cfa(this.a.dM(), this.a, $$17, $$18, $$19);
   ...
   public void a(blv $$0) {
      ...
      int $$9 = aty.a(this.g.dt() + $$8);
      eem $$10 = new eem($$3, $$9, $$4);
