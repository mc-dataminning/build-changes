...
public final class mn {
   ...
   private static final Comparator<doc.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<doc.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(doc.a::toString).collect(Collectors.joining(","));
   }
