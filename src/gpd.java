public class gpd extends gml {
   private static final int a = 12235202;

   protected gpd(gkl $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gop $$8) {
   ...
   public static class a implements gnx<mc> {
      ...
      public gnu a(mc $$0, gkl $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new gpd($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
