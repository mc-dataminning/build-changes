...
public class gpd implements gpk.a {
   ...
   private final fmf w;
   private final Map<jh, gpd.a> x = new HashMap<>();
   private final Map<UUID, abb.a> y = new HashMap<>();
   @Nullable
   private UUID z;
   ...
   public void a(abm.a $$0, long $$1) {
      this.x.put($$0.a(), new gpd.a($$0, $$1));
   }
   ...
   private void c() {
      long $$0 = this.w.s.ac() - 20L;
      this.x.entrySet().removeIf($$1 -> $$1.getValue().b() < $$0);
   }

   private void a(fgr $$0, glk $$1) {
      jh $$2 = this.e().c();
   ...
   private void b(fgr $$0, glk $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         ...
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gpk.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static void a(fgr $$0, glk $$1, jh $$2) {
      float $$3 = 0.05F;
      gpk.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fgr $$0, glk $$1, jh $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gpk.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fgr $$0, glk $$1, abm.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(fgr $$0, glk $$1, abb.a $$2) {
      if ($$2.e() != null) {
         gpt.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(fgr $$0, glk $$1, abb.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(fgr $$0, glk $$1, String $$2, abm.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(fgr $$0, glk $$1, String $$2, jh $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gpk.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fgr $$0, glk $$1, ka $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      jh $$9 = jh.a($$2);
      ...
      float $$13 = 0.5F;
      gpk.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Collection<UUID> a(jh $$0) {
      return this.y.values().stream().filter($$1 -> $$1.a($$0)).map(abb.a::b).collect(Collectors.toSet());
   }

   private Map<jh, List<String>> f() {
      Map<jh, List<String>> $$0 = Maps.newHashMap();

      for (abb.a $$1 : this.y.values()) {
   ...
   private void g() {
      gpk.a(this.w.ao(), 8).ifPresent($$0 -> this.z = $$0.cG());
   }

   static record a(abm.a a, long b) {
   }
}
