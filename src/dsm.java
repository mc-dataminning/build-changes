...
public class dsm {
   ...
   private boolean a(iu $$0) {
      return dlu.a(this.a, $$0) || dlu.a(this.a, $$0.d()) || dlu.a(this.a, $$0.e());
   }
   ...
   private dsm b(iu $$0) {
      eah $$2 = this.a.a_($$0);
      if (dlu.h($$2)) {
         return new dsm(this.a, $$0, $$2);
      } else {
         iu $$1 = $$0.d();
         $$2 = this.a.a_($$1);
         if (dlu.h($$2)) {
            return new dsm(this.a, $$1, $$2);
         } else {
            $$1 = $$0.e();
            $$2 = this.a.a_($$1);
            return dlu.h($$2) ? new dsm(this.a, $$1, $$2) : null;
         }
      }
   }

   private boolean a(dsm $$0) {
      return this.c($$0.b);
   }
   ...
   private boolean b(dsm $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dsm $$0) {
      this.f.add($$0.b);
      iu $$1 = this.b.f();
      iu $$2 = this.b.g();
      iu $$3 = this.b.h();
   ...
   public dsm a(boolean $$0, boolean $$1, ebl $$2) {
      iu $$3 = this.b.f();
      iu $$4 = this.b.g();
      iu $$5 = this.b.h();
      iu $$6 = this.b.i();
