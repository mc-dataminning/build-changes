...
public class fvk implements asb, AutoCloseable {
   ...
   @Nullable
   private fpx u;
   private final fvz v = new fvz();
   private final ObjectArrayList<fyl.b> w = new ObjectArrayList(10000);
   ...
   @Nullable
   private esd D;
   private final fvv E = new fvv(100);
   private int F;
   ...
   private final Map<hz, gkh> I = Maps.newHashMap();
   @Nullable
   private eqm J;
   @Nullable
   private fvp K;
   ...
   public fvk(exh $$0, gar $$1, fxl $$2, fvs $$3) {
      this.q = $$0;
      this.r = $$1;
      this.s = $$2;
      this.t = $$3;
   ...
   private void a(fvl $$0, float $$1, double $$2, double $$3, double $$4) {
   ...
   public void a() {
      ...
      try {
         this.K = new fvp(this.q.Y(), this.q.Z(), this.q.g(), $$0);
   ...
   private void y() {
      ...
      try {
         fvp $$1 = new fvp(this.q.Y(), this.q.Z(), this.q.g(), $$0);
   ...
   public void f() {
      if (this.u != null) {
         ...
         this.u.g();
         if (this.ae == null) {
            this.ae = new fyl(this.u, this, ac.f(), this.t);
         } else {
            this.ae.a(this.u);
         }
         ...
         this.y = new fwd(this.ae, this.u, this.q.m.aA(), this);
         this.v.a(this.y);
         this.w.clear();
         bno $$0 = this.q.am();
         if ($$0 != null) {
   ...
   private void a(ews $$0, fyp $$1, boolean $$2, boolean $$3) {
      ens $$4 = $$0.b();
   ...
   public static fyp a(fyp $$0) {
      return new fyp($$0).a(8);
   }

   private void b(fyp $$0) {
      if (!exh.O().br()) {
   ...
   private void a(Matrix4f $$0, Matrix4f $$1, double $$2, double $$3, double $$4, fyp $$5) {
      this.ak = $$5;
   ...
   public void a(esa $$0, float $$1, long $$2, boolean $$3, ews $$4, fvf $$5, fvl $$6, Matrix4f $$7) {
      bmf $$8 = this.q.r.s();
      float $$9 = $$8.i() ? $$1 : 1.0F;
      ...
      if (this.aj) {
         this.a($$15, $$7, $$11.c, $$11.d, $$11.e, $$16 ? new fyp($$15, $$7) : $$17);
         this.aj = false;
      }

      $$10.b("clear");
      fve.a($$4, $$9, this.q.r, this.q.m.aA(), $$5.b($$9));
      fve.b();
      ...
      $$10.b("sky");
      RenderSystem.setShader(fvf::p);
      this.a($$0, $$7, $$9, $$4, $$20, () -> fve.a($$4, fve.d.a, $$19, $$20, $$9));
      $$10.b("fog");
      fve.a($$4, fve.d.b, Math.max($$19, 32.0F), $$20, $$9);
      $$10.b("terrain_setup");
      this.a($$4, $$17, $$16, this.q.s.P_());
      $$10.b("compile_sections");
      this.c($$4);
      $$10.b("terrain");
      this.a(fvu.c(), $$0, $$12, $$13, $$14, $$7);
      this.a(fvu.d(), $$0, $$12, $$13, $$14, $$7);
      this.a(fvu.e(), $$0, $$12, $$13, $$14, $$7);
      if (this.u.d().e()) {
         eqw.a($$0.c().a());
      } else {
         eqw.b($$0.c().a());
         ...
         if (!$$31.isEmpty()) {
            for (dit $$32 : $$31) {
               ...
               if ($$35 != null && !$$35.isEmpty()) {
                  ...
                  if ($$36 >= 0) {
                     esa.a $$37 = $$0.c();
                     ese $$38 = new esb(this.t.d().getBuffer(giz.l.get($$36)), $$37.a(), $$37.b(), 1.0F);
                     $$34 = $$2x -> {
      ...
      while (var43.hasNext()) {
         ...
         if (!($$43 * $$43 + $$44 * $$44 + $$45 * $$45 > 1024.0)) {
            ...
            if ($$46 != null && !$$46.isEmpty()) {
               ...
               esa.a $$48 = $$0.c();
               ese $$49 = new esb(this.t.d().getBuffer(giz.l.get($$47)), $$48.a(), $$48.b(), 1.0F);
      ...
      if (this.Q != null) {
         ...
         this.L.a(this.q.g());
         $$10.b("translucent");
         this.a(fvu.f(), $$0, $$12, $$13, $$14, $$7);
         $$10.b("string");
         this.a(fvu.t(), $$0, $$12, $$13, $$14, $$7);
         this.N.b(exh.a);
         this.N.a(this.q.g());
         fvt.aL.a();
         $$10.b("particles");
   ...
   private void a(bno $$0, double $$1, double $$2, double $$3, float $$4, esa $$5, fvm $$6) {
   ...
   private void a(fvu $$0, esa $$1, double $$2, double $$3, double $$4, Matrix4f $$5) {
      ...
      boolean $$15 = $$0 != fvu.f();
      ObjectListIterator<fyl.b> $$16 = this.w.listIterator($$15 ? 0 : this.w.size());
      fwa $$17 = RenderSystem.getShader();
      ...
      while ($$15 ? $$16.hasNext() : $$16.hasPrevious()) {
         fyl.b $$21 = $$15 ? (fyl.b)$$16.next() : (fyl.b)$$16.previous();
         if (!$$21.d().a($$0)) {
            esd $$22 = $$21.a($$0);
            hz $$23 = $$21.f();
            if ($$20 != null) {
   ...
   private void a(esa $$0, fvm $$1, ews $$2) {
   ...
   public void a(esa $$0, Matrix4f $$1, float $$2, ews $$3, boolean $$4, Runnable $$5) {
      ...
      if (!$$4) {
         ...
         if ($$6 != egr.c && $$6 != egr.a && !this.b($$3)) {
            if (this.q.r.d().c() == fvb.d.c) {
               this.b($$0);
            } else if (this.q.r.d().c() == fvb.d.b) {
   ...
   private void c(ews $$0) {
      ...
      fyk $$2 = new fyk();
      hz $$3 = $$0.c();
      List<fyl.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.w.iterator();

      while (var6.hasNext()) {
         fyl.b $$5 = (fyl.b)var6.next();
         jb $$6 = jb.a($$5.f());
         if ($$5.h() && $$1.a($$6)) {
            boolean $$7 = false;
   ...
   @Nullable
   private fta b(jx $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private fta b(jx $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      ews $$9 = this.q.j.m();
      exm $$10 = this.a($$2);
      if ($$1) {
   ...
   public void b(int $$0, hz $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.q.ai().a(gkc.b(atk.ua, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 2007:
            ...
            for (int $$15 = 0; $$15 < 100; $$15++) {
               ...
               fta $$21 = this.b($$14, $$14.b().c(), $$9.c + $$18 * 0.1, $$9.d + 0.3, $$9.e + $$20 * 0.1, $$18, $$19, $$20);
               if ($$21 != null) {
         ...
         case 2006:
            for (int $$64 = 0; $$64 < 200; $$64++) {
               ...
               fta $$70 = this.b(jz.i, false, (double)$$1.u() + $$67 * 0.1, (double)$$1.v() + 0.3, (double)$$1.w() + $$69 * 0.1, $$67, $$68, $$69);
               if ($$70 != null) {
                  $$70.c($$65);
               }
            }
         ...
         case 3009:
            ...
            break;
         case 3010:
            awk.a(this.u, $$1, jz.aV, blf.a(3, 6));
            break;
         case 3011:
            dkp.a(this.u, $$1, $$3);
            break;
