...
public class fvk extends fvi {
   ...
   public fvk(boolean $$0) {
      this($$0, null);
   }

   public fvk(boolean $$0, @Nullable fqh $$1) {
      super(b);
      this.y = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fqh(false));
   }
   ...
   protected void aR_() {
      ...
      $$3 = this.a($$3, 24);
      fqv $$4 = this.c(fpu.a(20, $$0x -> this.m.a(new fyi(this, this.m.n, this.m.ah())), true));
      int var10001 = this.n / 2 - 124;
      $$3 += 36;
      $$4.c(var10001, $$3);
      this.c(fpq.a(wp.c("menu.options"), $$0x -> this.m.a(new fyl(this, this.m.n))).a(this.n / 2 - 100, $$3, 98, 20).a());
      this.c(fpq.a(wp.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3, 98, 20).a());
      fqv $$5 = this.c(fpu.b(20, $$0x -> this.m.a(new fyf(this, this.m.n)), true));
      $$5.c(this.n / 2 + 104, $$3);
      this.c(new fqo($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new fuk(this)), this.p));
      if (this.w == null) {
         this.w = new fjz();
      }
   ...
   private int a(int $$0, int $$1) {
      if (ab.aU) {
         this.c(fpq.a(wp.b("Create Test World"), $$0x -> gah.b(this.m, this)).a(this.n / 2 - 100, $$0 += $$1, 200, 20).a());
      }
   ...
   private int b(int $$0, int $$1) {
      this.c(fpq.a(wp.c("menu.singleplayer"), $$0x -> this.m.a(new gap(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      wp $$2 = this.E();
      boolean $$3 = $$2 == null;
      frb $$4 = $$2 != null ? frb.a($$2) : null;
      int var6;
      this.c(fpq.a(wp.c("menu.multiplayer"), $$0x -> {
         fvi $$1x = (fvi)(this.m.n.u ? new fxy(this) : new fxz(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, var6 = $$0 + $$1, 200, 20).a($$4).a()).j = $$3;
      this.c(fpq.a(wp.c("menu.online"), $$0x -> this.m.a(new fhc(this))).a(this.n / 2 - 100, $$0 = var6 + $$1, 200, 20).a($$4).a()).j = $$3;
      return $$0;
   }
   ...
   private int c(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fpq.a(wp.c("menu.playdemo"), $$1x -> {
         if ($$2) {
            this.m.x().a("Demo_World", () -> this.m.a(this));
         } else {
            this.m.x().a("Demo_World", MinecraftServer.d, eem.b, enz::a, this);
         }
