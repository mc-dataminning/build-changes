...
public abstract class cke extends ckd {
   ...
   protected cke(bta<? extends cke> $$0, dby $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bS.a(4, new cke.a<>(this, 0.7, 0.595));
   }
   ...
   public bui a(dcn $$0, bqs $$1, btt $$2, @Nullable bui $$3) {
      if ($$2 != btt.p && $$2 != btt.h && $$2 != btt.d && $$0.E_().i() < 0.06F && this.gr()) {
         this.c = true;
      }

      if (this.gu()) {
         this.a(btb.f, coi.a(this.dR().b(lq.d)));
         this.a(btb.f, 2.0F);
      }
   ...
   public static boolean b(bta<? extends cke> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      return $$1.a(dch.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends cke> extends can {
      ...
      public void e() {
         ...
         if ($$1.l()) {
            ...
            if (this.b.gz() && $$2.isEmpty()) {
               ...
               evr $$3 = evr.c(this.b.gs());
               evr $$4 = this.b.dn();
               evr $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).a(0.4).e($$3);
               evr $$6 = $$3.d($$4).d().a(10.0).e($$4);
               iz $$7 = iz.a($$6);
               $$7 = this.b.dP().a(dxu.a.f, $$7);
      ...
      private List<cke> h() {
         return this.b.dP().a(cke.class, this.b.cK().g(16.0), $$0 -> $$0.gx() && !$$0.t(this.b));
      }
