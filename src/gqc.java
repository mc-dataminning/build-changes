...
public abstract class gqc<T extends crn, S extends gyr> extends grk<T, S> {
   private static final alp b = alp.b("textures/entity/minecart.png");
   protected final gcb a;
   private final gmj h;

   public gqc(grl.a $$0, geh $$1) {
      super($$0);
      this.f = 0.7F;
      this.a = new gcb($$0.a($$1));
      this.h = $$0.d();
   }
   ...
   public void a(S $$0, fgl $$1, glg $$2, int $$3) {
      ...
      float $$8 = $$0.e;
      if ($$8 > 0.0F) {
         $$1.a(a.b.rotationDegrees(azu.a($$8) * $$8 * $$0.f / 10.0F * (float)$$0.d));
      }
      ...
      this.a.a($$1, $$11, $$3, hax.d);
      $$1.b();
   }

   private static <S extends gyr> void a(S $$0, fgl $$1) {
      $$1.a(a.d.rotationDegrees($$0.b));
      $$1.a(a.f.rotationDegrees(-$$0.a));
      $$1.a(0.0F, 0.375F, 0.0F);
   }

   private static <S extends gyr> void b(S $$0, fgl $$1) {
      double $$2 = $$0.m;
      double $$3 = $$0.n;
      double $$4 = $$0.o;
      float $$5 = $$0.a;
   ...
   public void a(T $$0, S $$1, float $$2) {
      super.a($$0, $$1, $$2);
      if ($$0.l() instanceof csc $$3) {
         a($$0, $$3, $$1, $$2);
         $$1.i = true;
      } else if ($$0.l() instanceof csd $$4) {
         a($$0, $$4, $$1, $$2);
         $$1.i = false;
      }
   ...
   private static <T extends crn, S extends gyr> void a(T $$0, csc $$1, S $$2, float $$3) {
      if ($$1.t()) {
         $$2.j = $$1.e($$3);
         $$2.a = $$1.c($$3);
         $$2.b = $$1.d($$3);
   ...
   private static <T extends crn, S extends gyr> void a(T $$0, csd $$1, S $$2, float $$3) {
      float $$4 = 0.3F;
      $$2.a = $$0.j($$3);
      $$2.b = $$0.k($$3);
      double $$5 = $$2.m;
      ...
      if ($$8 != null) {
         $$2.k = $$8;
         fbr $$9 = $$1.a($$5, $$6, $$7, 0.3F);
         fbr $$10 = $$1.a($$5, $$6, $$7, -0.3F);
   ...
   protected void a(S $$0, dxo $$1, fgl $$2, glg $$3, int $$4) {
      this.h.a($$1, $$2, $$3, $$4, hax.d);
   }
