...
public class edi {
   ...
   private double j;
   int k = 29999984;
   private edi.a l = new edi.e(5.999997E7F);
   public static final edi.d d = new edi.d(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public fgc c(double $$0, double $$1, double $$2) {
      return new fgc(azz.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azz.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public List<edi.b> c(double $$0, double $$1) {
      edi.b[] $$2 = new edi.b[]{
         new edi.b(jc.c, $$1 - this.f()), new edi.b(jc.d, this.h() - $$1), new edi.b(jc.e, $$0 - this.e()), new edi.b(jc.f, this.g() - $$0)
      };
      return Arrays.stream($$2).sorted(Comparator.comparingDouble($$0x -> $$0x.b)).toList();
   }

   public boolean a(bxe $$0, ffx $$1) {
      double $$2 = Math.max(azz.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (edi.a)($$0 == $$1 ? new edi.e($$1) : new edi.c($$0, $$1, $$2));
   ...
   class c implements edi.a {
      ...
      @Override
      public double a() {
         return azz.a(edi.this.a() - this.e() / 2.0, (double)(-edi.this.k), (double)edi.this.k);
      }

      @Override
      public double c() {
         return azz.a(edi.this.b() - this.e() / 2.0, (double)(-edi.this.k), (double)edi.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azz.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public edh i() {
         return this.c < this.b ? edh.b : edh.a;
      }
      ...
      @Override
      public edi.a l() {
         return (edi.a)(this.g() <= 0L ? edi.this.new e(this.c) : this);
      }
      ...
      public fgw m() {
         return fgt.a(
            fgt.c,
            fgt.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fgg.e
         );
      }
   }
   ...
   public static class d {
      ...
      public static edi.d a(DynamicLike<?> $$0, edi.d $$1) {
         double $$2 = azz.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azz.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new edi.d($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class e implements edi.a {
      ...
      private void n() {
         this.c = azz.a(edi.this.a() - this.b / 2.0, (double)(-edi.this.k), (double)edi.this.k);
         this.d = azz.a(edi.this.b() - this.b / 2.0, (double)(-edi.this.k), (double)edi.this.k);
         this.e = azz.a(edi.this.a() + this.b / 2.0, (double)(-edi.this.k), (double)edi.this.k);
         this.f = azz.a(edi.this.b() + this.b / 2.0, (double)(-edi.this.k), (double)edi.this.k);
         this.g = fgt.a(
            fgt.c,
            fgt.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fgg.e
