...
public class edi implements edd {
   public static final Codec<edi> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               lp.e.q().fieldOf("block").flatXmap(edi::a, DataResult::success).orElse((dka)dfc.fg).forGetter($$0x -> $$0x.b),
   ...
   public final jm<dfa> h;
   private final ObjectArrayList<je> i;

   private static DataResult<dka> a(dfa $$0) {
      return $$0 instanceof dka $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public edi(dka $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jm<dfa> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
