...
public class edi {
   private static final dwv a = djm.hG.m();
   private static final dwv b = djm.hH.m();
   private static final dwv c = djm.iY.m();
   private static final dwv d = djm.hK.m();
   private static final dwv e = djm.hS.m();
   private static final dwv f = djm.hU.m();
   private static final dwv g = djm.hO.m();
   private static final dwv h = djm.ja.m();
   private static final dwv i = djm.ec.m();
   private final dwv j;
   private final int k;
   private final dwv[] l;
   private final esa m;
   ...
   public edi(ede $$0, dwv $$1, int $$2, edd $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(ecz.P);
   ...
   public void a(ede $$0, dhk $$1, ke<dhi> $$2, boolean $$3, edn $$4, final dyq $$5, ecu $$6, edh.o $$7) {
      ...
      edh.g $$13 = new edh.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      edh.u $$14 = $$7.apply($$13);
      ji.a $$15 = new ji.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(ecq.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            jr<dhi> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dhp.C)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(ecq.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dwv> a(edh.o $$0, eer $$1, Function<ji, jr<dhi>> $$2, dyq $$3, ecu $$4, ji $$5, boolean $$6) {
      edh.g $$7 = new edh.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().e(mc.aI), $$1);
      edh.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dwv $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dyn $$0, int $$1, int $$2, int $$3, dgi $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dhi $$1, dyn $$2, ji.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(djm.J) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azg $$0, dwv[] $$1, int $$2, dwv $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dwv a(int $$0, int $$1, int $$2) {
