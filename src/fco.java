...
public class fco {
   ...
   public static final fco.a bv;

   public static fco.a a(int $$0, int $$1) {
      return $$0 == -1 ? fco.b.b.a($$1) : fco.b.a.a($$0);
   }

   public static fco.a a(String $$0) {
      if (fco.a.e.containsKey($$0)) {
         return fco.a.e.get($$0);
      } else {
         for (fco.b $$1 : fco.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fco.b b;
      private final int c;
      private final azd<xh> d;
      static final Map<String, fco.a> e = Maps.newHashMap();

      a(String $$0, fco.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azd<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xh.b($$2.toUpperCase(Locale.ROOT)) : xh.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xh.b($$2) : xh.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ue.a().b($$1) ? xh.c($$1) : xh.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fco.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xh> g;

      private static void a(fco.b $$0, String $$1, int $$2) {
         fco.a $$3 = new fco.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xh> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fco.a a(int $$0) {
         return (fco.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
