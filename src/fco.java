...
public enum fco implements bba {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bba.a<fco> t = bba.a(fco::values);
   public static final IntFunction<fco> u = ayv.a(fco::a, values(), ayv.a.a);
   private final int v;
   private final String w;

   private fco(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
