public class gcs extends gdn {
   private final gdi a;

   gcs(fzf $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gdi $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cmx $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dv();
            if (this.h > $$1) {
               this.h = this.h + ($$1 - this.h) * 0.2;
               this.k = this.k + ($$0.dr().d - this.k) * 0.2;
   ...
   public static class a implements gcq<lq> {
      ...
      public gcn a(lq $$0, fzf $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gcs($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gcq<lq> {
      ...
      public gcn a(lq $$0, fzf $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gcn $$8 = new gcs($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
