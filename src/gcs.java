public class gcs<T extends byk> extends gcx<T, fjp<T>> {
   private final fua a;

   public gcs(gah<T, fjp<T>> $$0, fua $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(eqa $$0, ftg $$1, int $$2, boolean $$3, djg $$4, int $$5, ggm $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(fto.r(gel.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
