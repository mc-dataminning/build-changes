...
public class gqm extends gnv<chk, gwj, fzx> {
   private static final Map<chk.a, all> a = ae.a(Maps.newEnumMap(chk.a.class), $$0 -> {
      $$0.put(chk.a.a, all.b("textures/entity/panda/panda.png"));
      $$0.put(chk.a.b, all.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(chk.a.c, all.b("textures/entity/panda/worried_panda.png"));
      $$0.put(chk.a.d, all.b("textures/entity/panda/playful_panda.png"));
      $$0.put(chk.a.e, all.b("textures/entity/panda/brown_panda.png"));
      $$0.put(chk.a.f, all.b("textures/entity/panda/weak_panda.png"));
      $$0.put(chk.a.g, all.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gqm(gpa.a $$0) {
      super($$0, new fzx($$0.a(gcb.bp)), new fzx($$0.a(gcb.bq)), 0.9F);
      this.a(new gtj(this, $$0.b()));
   }

   public all a(gwj $$0) {
      return a.getOrDefault($$0.a, a.get(chk.a.a));
   }
   ...
   public void a(chk $$0, gwj $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.gJ();
      $$1.b = $$0.q() > 0;
      $$1.c = $$0.t();
   ...
   protected void a(gwj $$0, fek $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.k > 0.0F) {
         float $$4 = azn.i($$0.k);
         int $$5 = azn.d($$0.k);
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(azn.h($$24, $$0.V, $$0.V + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(azn.h($$26, $$0.V, $$0.V + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? azn.h($$3, $$0, $$1) : $$0;
   }
}
