...
public class gqm implements gpy.a {
   private final fli a;
   ...
   private void a(fft $$0, glx $$1, double $$2, double $$3, double $$4, buk $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.ax.ifPresent($$10 -> {
   ...
   private void a(ji $$0, fft $$1, double $$2, double $$3, double $$4, glx $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gpy.a(
         $$1,
         $$5.getBuffer(gmh.y()),
         this.a.s.a_($$0).b(this.a.s, $$0, fbe.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
