...
public class gqm implements ato<gql> {
   public gql b(JsonObject $$0) {
      Builder<gqk> $$1 = ImmutableList.builder();
      ...
      return new gql($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gqk a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gqk(ayp.g($$1, "frames[" + $$0 + "]"));
