...
public class hje extends ts {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private hje(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static hje a(avb $$0, List<String> $$1, boolean $$2) {
      ...
      tr.a().a($$3);
      return new hje(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<auz> $$1, Map<String, String> $$2) {
      for (auz $$3 : $$1) {
