...
public class hje extends MinecraftServer {
   ...
   public hje(Thread $$0, flk $$1, evg.c $$2, aua $$3, alu $$4, alq $$5, aro $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hjd(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dgg bd() {
      return this.r() && !this.w_() ? (dgg)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
