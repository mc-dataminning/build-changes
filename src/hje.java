...
public class hje {
   ...
   public static class a extends Thread {
      private final hje.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hje.b $$0) throws IOException {
         super("LanServerDetector #" + hje.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hje.b));
   ...
   public static class b {
      private final List<hjd> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hjd> a() {
         if (this.b) {
            List<hjd> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
