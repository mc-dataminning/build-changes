...
public abstract class evr extends euq {
   private final dav b;
   private daw c;
   ...
   public evr(dav $$0, boolean $$1, boolean $$2, sw $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = cwn.a($$0.q().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(sw::getString).toArray(String[]::new);
   }

   @Override
   protected void b() {
      this.d(epi.a(sv.d, $$0 -> this.C()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new erq(() -> this.k[this.n], this::a, erq.a(this.f), erq.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
