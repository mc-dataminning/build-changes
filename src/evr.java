...
public class evr {
   ...
   @Deprecated
   public static evr a(azv $$0, evr.a $$1) {
      return new evr($$0, $$1, false);
   }

   public static evr a(azv $$0, int $$1, double... $$2) {
      return b($$0, new evr.a($$1, new DoubleArrayList($$2)));
   }

   public static evr b(azv $$0, evr.a $$1) {
      return new evr($$0, $$1, true);
   }

   private evr(azv $$0, evr.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<evr.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(evr.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(evr.a::b))
               .apply($$0, evr.a::new)
      );
      public static final Codec<je<evr.a>> b = alc.a(mg.aY, a);
