...
public class evr extends gnd {
   ...
   public void aQ_() {
      this.a(this.C.a);
      this.c(ezo.a(vq.c("mco.configure.world.subscription.extend"), $$0 -> fed.a(this, ave.a(this.C.b, this.f.W().b()))).a(this.g / 2 - 100, g(6), 200, 20).a());
      if (this.C.j) {
         this.c(ezo.a(vq.c("mco.configure.world.delete.button"), $$0 -> {
            vq $$1 = vq.c("mco.configure.world.delete.question.line1");
            vq $$2 = vq.c("mco.configure.world.delete.question.line2");
            this.f.a(new evd(this::c, evd.a.a, $$1, $$2, true));
         }).a(this.g / 2 - 100, g(10), 200, 20).a());
      } else if (ess.b() && this.C.s != null) {
         this.c(new ezy(this.g / 2 - 100, g(8), 200, 46, vq.a("mco.snapshot.subscription.info", this.C.s), this.i).a(-6250336));
      } else {
         this.c(new ezy(this.g / 2 - 100, g(8), 200, 46, A, this.i).a(-6250336));
      }

      this.c(ezo.a(vp.k, $$0 -> this.d()).a(this.g / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  evr.a.error("Couldn't delete world", var2);
               }

               evr.this.f.execute(() -> evr.this.f.a(evr.this.D));
            }
         }).start();
      }
