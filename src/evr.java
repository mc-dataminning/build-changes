...
public class evr {
   ...
   public static void a(File $$0, eol $$1, Consumer<vf> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eol $$2, Consumer<vf> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eol $$2, Consumer<vf> $$3) {
      epa $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            vf $$3x = vf.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new vd(vd.a.b, $$6.getAbsolutePath())));
            $$3.accept(vf.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(vf.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static epa a(eol $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      epa $$3 = new epa($$1, $$2, false);
   ...
   public evr(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
