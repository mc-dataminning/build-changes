...
public class evr extends eod {
   ...
   private void a(uj $$0, iz.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            evs.b $$9 = evs.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            evs.b $$10 = evs.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            evs.a $$11 = evs.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(uj $$0, iz.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         evt $$5 = evt.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, evt.b.d());
            return evt.b;
         });
         String $$6 = $$3.l("Name");
         wx $$7 = wx.a.a($$3.l("DisplayName"), $$1);
         evt.a $$8 = evt.a.a($$3.l("RenderType"));
