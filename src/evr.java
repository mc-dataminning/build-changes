...
public class evr implements js {
   public static final Codec<evr> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> ac.a($$0, 3).map($$0x -> new evr((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final evr b = new evr(0.0, 0.0, 0.0);
   ...
   public static evr a(kd $$0) {
      return new evr((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static evr a(kd $$0, double $$1, double $$2, double $$3) {
      return new evr((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static evr b(kd $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static evr c(kd $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static evr a(kd $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public evr(double $$0, double $$1, double $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }

   public evr(Vector3f $$0) {
      this((double)$$0.x(), (double)$$0.y(), (double)$$0.z());
   }

   public evr a(evr $$0) {
      return new evr($$0.c - this.c, $$0.d - this.d, $$0.e - this.e);
   }

   public evr d() {
      double $$0 = Math.sqrt(this.c * this.c + this.d * this.d + this.e * this.e);
      return $$0 < 1.0E-4 ? b : new evr(this.c / $$0, this.d / $$0, this.e / $$0);
   }

   public double b(evr $$0) {
      return this.c * $$0.c + this.d * $$0.d + this.e * $$0.e;
   }

   public evr c(evr $$0) {
      return new evr(this.d * $$0.e - this.e * $$0.d, this.e * $$0.c - this.c * $$0.e, this.c * $$0.d - this.d * $$0.c);
   }
   ...
   public evr a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }
   ...
   public evr b(double $$0, double $$1, double $$2) {
      return new evr(this.c + $$0, this.d + $$1, this.e + $$2);
   }
   ...
   public boolean a(evr $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.c;
      double $$4 = $$0.b() - this.d;
      double $$5 = $$0.c() - this.e;
   ...
   public evr d(double $$0, double $$1, double $$2) {
      return new evr(this.c * $$0, this.d * $$1, this.e * $$2);
   }

   public evr a(azh $$0, float $$1) {
   ...
   public evr a(evr $$0, double $$1) {
      return new evr(ayz.d($$1, this.c, $$0.c), ayz.d($$1, this.d, $$0.d), ayz.d($$1, this.e, $$0.e));
   }
   ...
   public static evr a(evq $$0) {
      return a($$0.i, $$0.j);
   }

   public static evr a(float $$0, float $$1) {
      ...
      return new evr((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public evr a(EnumSet<je.a> $$0) {
   ...
   public evr a(je.a $$0, double $$1) {
      double $$2 = $$0 == je.a.a ? $$1 : this.c;
      double $$3 = $$0 == je.a.b ? $$1 : this.d;
      double $$4 = $$0 == je.a.c ? $$1 : this.e;
      return new evr($$2, $$3, $$4);
   }

   public evr a(je $$0, double $$1) {
      kd $$2 = $$0.q();
      return new evr(this.c + $$1 * (double)$$2.u(), this.d + $$1 * (double)$$2.v(), this.e + $$1 * (double)$$2.w());
   }
