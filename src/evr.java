...
public record evr(aex c, float d, float e, evr.a f, String g) implements evo {
   private static final Codec<String> h = arg.a(Codec.STRING, Codec.STRING.listOf(), $$0 -> String.join("", $$0));
   public static final MapCodec<evr> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               aex.a.fieldOf("file").forGetter(evr::c),
