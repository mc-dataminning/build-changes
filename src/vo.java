...
public class vo extends SimpleChannelInboundHandler<zc<?>> {
   ...
   private static final wd<aiw> j = aiv.b;
   private final zd k;
   private volatile boolean l = true;
   private final Queue<Consumer<vo>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
   private SocketAddress o;
   @Nullable
   private volatile wb p;
   @Nullable
   private volatile wb q;
   @Nullable
   private vq r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(wv.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof wi) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(wv.c("disconnect.timeout"));
            } else {
               wv $$3 = wv.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wb $$4 = this.q;
               vq $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == zd.b) {
                     zc<?> $$7 = (zc<?>)(this.l ? new ajc($$3) : new zl($$3));
                     this.a($$7, wc.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zc<?> $$1) {
      if (this.n.isOpen()) {
         wb $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(wv.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(wv.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wb> void a(zc<T> $$0, wb $$1) {
      $$0.a((T)$$1);
   }

   private void b(wd<?> $$0, wb $$1) {
   ...
   public <T extends wb> void a(wd<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wb $$0) {
      ...
      } else if (this.k == zd.a && $$0.a() == zd.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, ajy $$2) {
      this.a($$0, $$1, ake.b, ake.d, $$2, ais.a);
   }

   public void a(String $$0, int $$1, aiy $$2) {
      this.a($$0, $$1, ajf.b, ajf.d, $$2, ais.b);
   }

   public <S extends wh, C extends vl> void a(String $$0, int $$1, wd<S> $$2, wd<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ais.c : ais.b);
   }

   private <S extends wh, C extends vl> void a(String $$0, int $$1, wd<S> $$2, wd<C> $$3, C $$4, ais $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<vo>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new ait(ab.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zc<?> $$0, @Nullable wc $$1) {
      this.a($$0, $$1, true);
   }

   public void a(zc<?> $$0, @Nullable wc $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zc<?> $$0, @Nullable wc $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zc<?> $$0, @Nullable wc $$1, boolean $$2) {
   ...
   public static vo a(InetSocketAddress $$0, boolean $$1, @Nullable bol $$2) {
      vo $$3 = new vo(zd.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final vo $$2) {
   ...
   public static void a(ChannelPipeline $$0, zd $$1, boolean $$2, @Nullable vh $$3) {
      zd $$4 = $$1.a();
      boolean $$5 = $$1 == zd.a;
      boolean $$6 = $$4 == zd.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new vz<aiw>(j) : new wk.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wa<aiw>(j) : new wk.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new vv() : new wp());
   }

   private static ChannelInboundHandler a(@Nullable vh $$0, boolean $$1) {
      if (!$$1) {
         return new wo($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new vw($$0) : new vu());
      }
   }

   public static void a(ChannelPipeline $$0, zd $$1) {
      a($$0, $$1, true, null);
   }

   public static vo a(SocketAddress $$0) {
      final vo $$1 = new vo(zd.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vj($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new vk($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof vm $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new vm($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof vn $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new vn($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof vm) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof vn) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wb $$0 = this.k();
            wb $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               vq $$2 = Objects.requireNonNullElseGet(this.l(), () -> new vq(wv.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
