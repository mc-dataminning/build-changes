public class cby extends bii implements ccc {
   private static final adz<ciy> b = aec.a(cby.class, aeb.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public cby(bim<? extends cby> $$0, cpm $$1) {
      super($$0, $$1);
   }

   public cby(cpm $$0, double $$1, double $$2, double $$3) {
      this(bim.K, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   public void l() {
      ...
      double $$4 = $$0.h();
      this.s(ccf.d(this.O, (float)(arp.d($$0.d, $$4) * 180.0F / (float)Math.PI)));
      this.r(ccf.d(this.N, (float)(arp.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
      if (!this.dK().B) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         ...
         $$0 = new ehe(Math.cos((double)$$8) * $$9, $$10 + ((double)$$11 - $$10) * 0.015F, Math.sin((double)$$8) * $$9);
         this.f($$0);
      }
      ...
      if (!this.dK().B) {
         ...
         if (this.f > 80 && !this.dK().B) {
            ...
            this.ak();
            if (this.g) {
               this.dK().b(new byg(this.dK(), this.dp(), this.dr(), this.dv(), this.j()));
            } else {
