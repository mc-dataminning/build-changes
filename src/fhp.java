...
public class fhp extends fia {
   private static final Logger b = LogUtils.getLogger();
   public Map<Long, List<ProfileResult>> a = Map.of();

   public static fhp a(String $$0) {
      fhp $$1 = new fhp();
      ...
      try {
         ...
         if (ayp.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fjw.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = flk.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fjw.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !flk.Q().b($$4)) {
               try {
