...
public class fhp {
   ...
   public static List<fhp.a> a(String $$0, fhp.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fhp.a> a(String $$0, List<fhp.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fhp.a> a(List<String> $$0, List<fhp.b> $$1) {
      int $$2 = 0;
      List<fhp.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fhp.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fhp.b a(String $$0, String $$1) {
         return new fhp.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fhp.b a(String $$0) {
         return new fhp.b($$0);
      }
   }
}
