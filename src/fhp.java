...
public abstract class fhp<E extends fhp.a<E>> extends fhm {
   protected static final int b = 6;
   private static final akk a = new akk("widget/scroller");
   private static final akk m = new akk("widget/scroller_background");
   private static final akk n = new akk("textures/gui/menu_list_background.png");
   private static final akk o = new akk("textures/gui/inworld_menu_list_background.png");
   protected final ffw c;
   protected final int d;
   private final List<E> p = new fhp.b();
   ...
   public fhp(ffw $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wt.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected boolean e(int $$0) {
      return Objects.equals(this.h(), this.aG_().get($$0));
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayg.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aG_().get($$7) : null;
   }
   ...
   protected void a(fhh $$0) {
      RenderSystem.enableBlend();
      akk $$1 = this.c.r == null ? fnl.g : fnl.i;
      akk $$2 = this.c.r == null ? fnl.h : fnl.j;
      $$0.a($$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a($$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
      RenderSystem.disableBlend();
   }

   protected void b(fhh $$0) {
      RenderSystem.enableBlend();
      akk $$1 = this.c.r == null ? n : o;
      $$0.a($$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
      RenderSystem.disableBlend();
   }

   protected void c(fhh $$0) {
      $$0.c(this.D(), this.E(), this.F(), this.G());
   }

   protected void e(E $$0) {
      this.b((double)(this.aG_().indexOf($$0) * this.d + this.d / 2 - this.h / 2));
   }

   protected void f(E $$0) {
      int $$1 = this.g(this.aG_().indexOf($$0));
   ...
   public void a(double $$0) {
      this.q = ayg.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = ayg.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fly $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fly $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
      };
      if (!this.aG_().isEmpty() && $$3 != 0) {
         int $$4;
         if ($$2 == null) {
            $$4 = $$3 > 0 ? 0 : this.aG_().size() - 1;
         } else {
            $$4 = this.aG_().indexOf($$2) + $$3;
         }
   ...
   protected void a(fhh $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public flo.a u() {
      if (this.aK_()) {
         ...
         return this.v != null ? flo.a.b : flo.a.a;
      }
   }
   ...
   protected void a(flq $$0, E $$1) {
      List<E> $$2 = this.aG_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(flp.b, wu.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fhp.a<E>> implements fjq {
      @Deprecated
      fhp<E> a;
      ...
      public abstract void a(fhh var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
