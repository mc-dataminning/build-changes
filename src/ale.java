...
public final class ale<E> implements Codec<jp<E>> {
   private final alg<? extends kc<E>> a;

   public static <E> ale<E> a(alg<? extends kc<E>> $$0) {
      return new ale<>($$0);
   }

   private ale(alg<? extends kc<E>> $$0) {
      this.a = $$0;
   }
