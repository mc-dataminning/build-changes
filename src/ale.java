...
public class ale<E> implements Codec<jk<E>> {
   private final alj<? extends jt<E>> a;
   private final Codec<jg<E>> b;
   private final Codec<List<jg<E>>> c;
   private final Codec<Either<axv<E>, List<jg<E>>>> d;

   private static <E> Codec<List<jg<E>>> a(Codec<jg<E>> $$0, boolean $$1) {
      Codec<List<jg<E>>> $$2 = $$0.listOf().validate(ayy.b(jg::f));
      return $$1 ? $$2 : ayy.c($$0, $$2);
   }

   public static <E> Codec<jk<E>> a(alj<? extends jt<E>> $$0, Codec<jg<E>> $$1, boolean $$2) {
      return new ale<>($$0, $$1, $$2);
   }

   private ale(alj<? extends jt<E>> $$0, Codec<jg<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(axv.b($$0), this.c);
   }

   public <T> DataResult<Pair<jk<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof ali<T> $$2) {
   ...
   private static <E> DataResult<jk<E>> a(jh<E> $$0, axv<E> $$1) {
      return $$0.a($$1)
