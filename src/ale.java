...
public final class ale implements Comparable<ale> {
   ...
   public static final yu<ByteBuf, ale> b = ys.o.a(ale::a, ale::toString);
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(ww.c("argument.id.invalid"));
