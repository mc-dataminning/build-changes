...
public interface ale {
   ale a = new ale() {
      ...
      @Override
      public void a(Consumer<cqg> $$0) {
      }
   };

   static ale a(cqg $$0, int $$1) {
      return new ale.a($$0, $$1);
   }

   static void a(ale $$0, ale $$1, Consumer<cqg> $$2, Consumer<cqg> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof ale.a $$4 && $$1 instanceof ale.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cqg($$10, $$11));
                     } else {
                        $$3.accept(new cqg($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cqg b, int c) implements ale {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(ale.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return ale.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
