...
public final class ale<E> implements Codec<jq<E>> {
   private final alh<? extends kd<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> ale<E> a(alh<? extends kd<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> ale<E> a(alh<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new ale<>($$0, $$1, $$2);
   }

   private ale(alh<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
