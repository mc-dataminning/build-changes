...
public abstract class fno implements xi {
   private static final vf g = vf.c("disconnect.lost");
   private static final Logger h = LogUtils.getLogger();
   protected final evh a;
   protected final ug b;
   @Nullable
   protected final foc c;
   @Nullable
   protected String d;
   protected final gjq e;
   @Nullable
   protected final fda f;
   private final List<fno.a> i = new ArrayList<>();

   protected fno(evh $$0, ug $$1, fnv $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   public void a(xo $$0) {
      ...
      if ($$2 == null) {
         ...
         String $$3 = $$0.e();
         boolean $$4 = $$0.f();
         if (this.c != null && this.c.b() != foc.a.c && (!$$4 || this.c.b() != foc.a.b)) {
            this.a.ac().a($$1, $$2, $$3);
         } else {
            this.a($$1, $$2, $$3, $$4, $$0.g());
         }
   ...
   protected void g() {
      Iterator<fno.a> $$0 = this.i.iterator();
   ...
   protected fda b(vf $$0) {
      fda $$1 = Objects.requireNonNullElseGet(this.f, () -> new ffy(new fdf()));
      return (fda)(this.c != null && this.c.e() ? new gkk($$1, g, $$0) : new fcc($$1, g, $$0));
   }
   ...
   private void a(xf<? extends us> $$0, BooleanSupplier $$1, Duration $$2) {
      if ($$1.getAsBoolean()) {
         ...
         this.i.add(new fno.a($$0, $$1, ac.b() + $$2.toMillis()));
      }
   }
