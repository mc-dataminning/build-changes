...
public class fno extends fmb<cqf> {
   private static final akh D = new akh("container/stonecutter/scroller");
   private static final akh E = new akh("container/stonecutter/scroller_disabled");
   private static final akh F = new akh("container/stonecutter/recipe_selected");
   private static final akh G = new akh("container/stonecutter/recipe_highlighted");
   private static final akh H = new akh("container/stonecutter/recipe");
   private static final akh I = new akh("textures/gui/container/stonecutter.png");
   ...
   private void b(fer $$0, int $$1, int $$2, int $$3) {
      List<cxf<cxx>> $$4 = this.w.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.S = axz.a(this.S - $$5, 0.0F, 1.0F);
