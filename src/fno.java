...
public class fno {
   private static final ale a = new ale("advancements/title_box");
   ...
   private final ayj r;
   private final int s;
   private final List<ayj> t;
   private final ffd u;
   @Nullable
   private fno v;
   private final List<fno> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fno(fnm $$0, ffd $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = um.a().a($$1.h.a($$3.a(), 163));
      this.y = ayx.d($$3.f() * 28.0F);
      this.z = ayx.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = um.a().a(this.a(xr.a($$3.b().f(), yl.a.a($$3.e().a())), $$7));
   ...
   private static float a(ffo $$0, List<xt> $$1) {
