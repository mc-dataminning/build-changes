...
public record hja(List<alg> d, alg e, Map<String, alg> f, String g) implements hiu {
   static final Logger h = LogUtils.getLogger();
   public static final String b = "_";
   public static final MapCodec<hja> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.list(alg.a).fieldOf("textures").forGetter(hja::b),
               alg.a.fieldOf("palette_key").forGetter(hja::c),
               Codec.unboundedMap(Codec.STRING, alg.a).fieldOf("permutations").forGetter(hja::d),
               Codec.STRING.optionalFieldOf("separator", "_").forGetter(hja::e)
            )
            .apply($$0, hja::new)
   );

   public hja(List<alg> $$0, alg $$1, Map<String, alg> $$2) {
      this($$0, $$1, $$2, "_");
   }
   ...
   static record a(hiz a, Supplier<IntUnaryOperator> b, alg c) implements hiu.b {
      @Nullable
      public hij a(hit $$0) {
         Object var3;
         try {
            fic $$1 = this.a.a().a(this.b.get());
            return new hij(this.c, new hkc($$1.a(), $$1.b()), $$1, avf.a);
         } catch (IllegalArgumentException | IOException var7) {
            hja.h.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
