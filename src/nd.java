...
public class nd implements kf {
   private static final Logger d = LogUtils.getLogger();
   private final kh e;
   private final CompletableFuture<id.b> f;

   public nd(kh $$0, CompletableFuture<id.b> $$1) {
      this.f = $$1;
      this.e = $$0;
   }
   ...
   public CompletableFuture<?> a(kd $$0) {
      return this.f.thenCompose($$1 -> {
         DynamicOps<JsonElement> $$2 = afu.a(JsonOps.INSTANCE, $$1);
         return CompletableFuture.allOf(afr.a.stream().flatMap($$3 -> this.a($$0, $$1, $$2, (afr.b<?>)$$3).stream()).toArray(CompletableFuture[]::new));
      });
   }

   private <T> Optional<CompletableFuture<?>> a(kd $$0, id.b $$1, DynamicOps<JsonElement> $$2, afr.b<T> $$3) {
      afv<? extends io<T>> $$4 = $$3.a();
      return $$1.a($$4).map($$4x -> {
