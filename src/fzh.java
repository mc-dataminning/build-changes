...
public class fzh extends fuk {
   ...
   protected void aR_() {
      ...
      $$0.a(fos.a(wo.i, $$0x -> this.u.accept(true)).a());
      $$0.a(fos.a(wo.k, $$0x -> this.u.accept(false)).a());
      this.w.a($$1x -> {
   ...
   class a extends fuk {
      ...
      protected void aR_() {
         ...
         this.c.b(fos.a(wo.k, $$0 -> this.aO_()).a());
         this.c.a($$1 -> {
      ...
      class a extends fpo<fzh.a.b> {
         public a(final fli $$0, final Collection<atx> $$1) {
            super($$0, a.this.n, a.this.c.d(), a.this.c.c(), (9 + 2) * 3);

            for (atx $$2 : $$1) {
               String $$3 = cru.a(cru.g, $$2.e());
               if (!$$3.isEmpty()) {
      ...
      class b extends fpo.a<fzh.a.b> {
         ...
         b(final wp $$0, final wp $$1, final fpl $$2) {
            this.b = $$0;
            this.c = $$1;
            this.d = $$2;
         }
