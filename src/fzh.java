public class fzh extends fyk<cbt> {
   ...
   public void a(cbt $$0, float $$1, float $$2, epz $$3, ftf $$4, int $$5) {
      $$3.a();
      cmx $$6 = $$0.q();
      int $$7 = $$6.b() ? 187 : cms.a($$6.d()) + $$6.k();
      this.n.b((long)$$7);
      ggl $$8 = this.m.a($$6, $$0.dM(), null, $$0.aj());
      boolean $$9 = $$8.b();
      int $$10 = this.a($$6);
      float $$11 = 0.25F;
      float $$12 = aun.a(((float)$$0.s() + $$2) / 10.0F + $$0.b) * 0.1F + 0.1F;
      float $$13 = $$8.f().a(cmu.h).d.y();
      ...
      for (int $$21 = 0; $$21 < $$10; $$21++) {
         ...
         this.m.a($$6, cmu.h, false, $$3, $$4, $$5, gec.d, $$8);
         $$3.b();
         if (!$$9) {
