...
public record bg<T, P extends Predicate<T>>(Optional<be<T, P>> a, Optional<bf<T, P>> b, Optional<cw.d> c) implements Predicate<Iterable<T>> {
   public static <T, P extends Predicate<T>> Codec<bg<T, P>> a(Codec<P> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(
                  ...
                  cw.d.d.optionalFieldOf("size").forGetter(bg::c)
               )
               .apply($$1, bg::new)
      );
   }
