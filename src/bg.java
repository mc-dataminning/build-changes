...
public record bg(ck.c b, ck.c c, ck.c d, ck.c e, ck.c f) {
   public static final Codec<bg> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               atw.a(ck.c.d, "x", ck.c.c).forGetter(bg::a),
               atw.a(ck.c.d, "y", ck.c.c).forGetter(bg::b),
               atw.a(ck.c.d, "z", ck.c.c).forGetter(bg::c),
               atw.a(ck.c.d, "horizontal", ck.c.c).forGetter(bg::d),
               atw.a(ck.c.d, "absolute", ck.c.c).forGetter(bg::e)
            )
            .apply($$0, bg::new)
   );
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      float $$7 = (float)($$1 - $$4);
      float $$8 = (float)($$2 - $$5);
      if (!this.b.d((double)auo.e($$6)) || !this.c.d((double)auo.e($$7)) || !this.d.d((double)auo.e($$8))) {
         return false;
      } else {
