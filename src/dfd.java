...
public class dfd extends cwj {
   public static final MapCodec<dfd> a = b(dfd::new);
   public static final djr b = dbw.f;
   public static final djr c = dbw.b;
   public static final djr d = dbw.c;
   public static final djr e = dbw.d;
   public static final djr f = dbw.e;
   public static final Map<ic, djr> g = dbw.h.entrySet().stream().filter($$0 -> $$0.getKey() != ic.a).collect(ac.a());
   protected static final float h = 1.0F;
   private static final emf i = cwj.a(0.0, 15.0, 0.0, 16.0, 16.0, 16.0);
   private static final emf j = cwj.a(0.0, 0.0, 0.0, 1.0, 16.0, 16.0);
   private static final emf k = cwj.a(15.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   private static final emf l = cwj.a(0.0, 0.0, 0.0, 16.0, 16.0, 1.0);
   private static final emf m = cwj.a(0.0, 0.0, 15.0, 16.0, 16.0, 16.0);
   private final Map<dja, emf> n;
   ...
   public dfd(diz.d $$0) {
      ...
      this.n = ImmutableMap.copyOf(this.E.a().stream().collect(Collectors.toMap(Function.identity(), dfd::h)));
   }
   ...
   private boolean b(cso $$0, hx $$1, ic $$2) {
      if ($$2 == ic.a) {
         return false;
      } else {
         hx $$3 = $$1.a($$2);
   ...
   public static boolean a(cso $$0, hx $$1, ic $$2) {
      return dbi.a($$0, $$2, $$1, $$0.a_($$1));
   }

   private dja i(dja $$0, cso $$1, hx $$2) {
      hx $$3 = $$2.c();
      if ($$0.c(b)) {
         ...
         if ($$3.a(4) == 0) {
            ...
            if ($$4.o().d() && !$$0.c(a($$4))) {
               ...
               if ($$2.v() > $$1.J_()) {
                  ...
                  dja $$18 = $$1.a_($$17);
                  if ($$18.i() || $$18.a(this)) {
                     dja $$19 = $$18.i() ? this.o() : $$18;
                     dja $$20 = this.a($$0, $$19, $$3);
                     if ($$19 != $$20 && this.p($$20)) {
                        $$1.a($$17, $$20, 2);
                     }
                  }
   ...
   private dja a(dja $$0, dja $$1, aup $$2) {
      for (ic $$3 : ic.c.a) {
         if ($$2.h()) {
            djr $$4 = a($$3);
            if ($$0.c($$4)) {
