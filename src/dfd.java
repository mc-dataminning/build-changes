...
public class dfd extends cuu {
   ...
   private static eig[] a(boolean $$0) {
      return Arrays.stream(ha.values()).map($$1 -> a($$1, $$0)).toArray(eig[]::new);
   }

   private static eig a(ha $$0, boolean $$1) {
      switch ($$0) {
         case a:
         default:
   ...
   public dfd(dfi.d $$0) {
      super($$0);
      this.k(this.C.b().a(a, ha.c).a(b, dgl.a).a(c, Boolean.valueOf(false)));
   }
