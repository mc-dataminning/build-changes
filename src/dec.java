...
public class dec extends ddy implements bhh {
   ...
   private hn<cjf> s = hn.a(27, cjf.b);
   private int t;
   ...
   public void d_(cbu $$0) {
      if (!this.q && !$$0.M_()) {
         ...
         if (this.t == 1) {
            ...
            this.o.a(null, this.p, apd.va, ape.e, 0.5F, this.o.z.i() * 0.1F + 0.9F);
         }
      }
   }
   ...
   public void c(cbu $$0) {
      if (!this.q && !$$0.M_()) {
         ...
         if (this.t <= 0) {
            ...
            this.o.a(null, this.p, apd.uZ, ape.e, 0.5F, this.o.z.i() * 0.1F + 0.9F);
         }
      }
   }
