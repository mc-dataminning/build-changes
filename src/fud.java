...
public class fud implements fui.a {
   ...
   private final eti A;
   private final Map<hx, fud.a> B = new HashMap<>();
   private final Map<UUID, xe.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(xo.a $$0, long $$1) {
      this.B.put($$0.a(), new fud.a($$0, $$1));
   }

   public void a(xe.a $$0) {
      this.C.put($$0.b(), $$0);
   }
   ...
   private void b(eob $$0, fqz $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(acn::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         fui.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(acn::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(eob $$0, fqz $$1, hx $$2) {
      float $$3 = 0.05F;
      fui.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(eob $$0, fqz $$1, hx $$2, List<String> $$3) {
      float $$4 = 0.05F;
      fui.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(eob $$0, fqz $$1, xo.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(eob $$0, fqz $$1, xe.a $$2) {
      if ($$2.e() != null) {
         fuq.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(eob $$0, fqz $$1, xe.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(eob $$0, fqz $$1, String $$2, xo.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(eob $$0, fqz $$1, String $$2, hx $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      fui.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(eob $$0, fqz $$1, iq $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      hx $$9 = hx.a($$2);
      ...
      float $$13 = 0.5F;
      fui.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(xo.a $$0) {
      return this.a($$0.a()).stream().map(acn::a).collect(Collectors.toSet());
   }

   private String a(xe.a $$0, hx $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(xe.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(xe.a $$0) {
      cdz $$1 = this.A.s;
      hx $$2 = hx.a($$1.ds(), $$0.d().b(), $$1.dy());
      hx $$3 = hx.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(hx $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(xe.a::b).collect(Collectors.toSet());
   }

   private Map<hx, List<String>> f() {
      Map<hx, List<String>> $$0 = Maps.newHashMap();

      for (xe.a $$1 : this.C.values()) {
   ...
   private void g() {
      fui.a(this.A.al(), 8).ifPresent($$0 -> this.D = $$0.cw());
   }

   static record a(xo.a a, long b) {
   }
}
