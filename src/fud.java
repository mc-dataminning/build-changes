public class fud extends fua {
   private final ftv a;
   private static final int b = 8;

   protected fud(fpx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, ftv $$8) {
      ...
      this.l += $$6;
      this.D *= 0.75F * $$7;
      this.t = (int)(8.0F / awh.b(this.r, 0.5F, 1.0F) * $$7);
   ...
   public static class a implements ftd<kc> {
      ...
      public fta a(kc $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fud($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
