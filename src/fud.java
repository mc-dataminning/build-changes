...
public class fud implements hom {
   private static final long a = 3000L;
   private final fpo b;
   private final List<fud.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fud.b> e = new ArrayList<>();
   ...
   public void a(fsh $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fud.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hnh $$0, hoo $$1, float $$2) {
      if ($$1.a() != null) {
         wy $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fud.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fex($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fud.b($$3, $$2, new fex($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fex a, long b) {
   }

   static class b {
      private final wy a;
      private final float b;
      private final List<fud.a> c = new ArrayList<>();

      public b(wy $$0, float $$1, fex $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fud.a($$2, ag.c()));
      }
