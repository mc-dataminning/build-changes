...
public abstract class fud<T extends bjb, M extends fey<T>> extends ftb<T> implements fux<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<fxk<T, M>> g = Lists.newArrayList();

   public fud(ftc.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(fxk<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, elk $$3, fnz $$4, int $$5) {
      ...
      this.f.d = $$0.bN();
      this.f.e = $$0.i_();
      float $$6 = ars.j($$2, $$0.aV, $$0.aU);
      float $$7 = ars.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bN() && $$0.cY() instanceof bjb $$9) {
         $$6 = ars.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = ars.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected foh a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      aeu $$4 = this.a($$0);
      if ($$2) {
         return foh.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? foh.q($$4) : null;
      }
   }

   public static int c(bjb $$0, float $$1) {
      return fyq.a(fyq.a($$1), fyq.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected void a(T $$0, elk $$1, float $$2) {
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return eqq.K() && $$0 != $$3.am() && $$5 && !$$0.bO();
      }
   }

   public static boolean e(bjb $$0) {
      if ($$0 instanceof cbp || $$0.ac()) {
         String $$1 = n.a($$0.ab().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cbp) || ((cbp)$$0).a(cbq.a);
         }
      }
