...
public class fud {
   ...
   private final xv h;
   private final fuf i;
   private final Map<ah, fuf> j = Maps.newLinkedHashMap();
   private double k;
   private double l;
   ...
   public fud(fmf $$0, fuh $$1, fue $$2, int $$3, ai $$4, at $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void b(fnr $$0, int $$1, int $$2) {
      if (!this.r) {
      ...
      for (int $$8 = -1; $$8 <= 15; $$8++) {
         for (int $$9 = -1; $$9 <= 8; $$9++) {
            $$0.a(glu::C, $$3, $$6 + 16 * $$8, $$7 + 16 * $$9, 0.0F, 0.0F, 16, 16, 16, 16);
         }
      }
   ...
   @Nullable
   public static fud a(fmf $$0, fuh $$1, int $$2, ai $$3) {
      Optional<at> $$4 = $$3.a().c();
      if ($$4.isEmpty()) {
         return null;
      } else {
         for (fue $$5 : fue.values()) {
            if ($$2 < $$5.a()) {
               return new fud($$0, $$1, $$5, $$2, $$3, $$4.get());
            }
   ...
   public void a(ai $$0) {
      Optional<at> $$1 = $$0.a().c();
      if (!$$1.isEmpty()) {
         fuf $$2 = new fuf(this, this.a, $$0, $$1.get());
         this.a($$2, $$0.b());
      }
   }

   private void a(fuf $$0, ah $$1) {
      this.j.put($$1, $$0);
      int $$2 = $$0.d();
      int $$3 = $$2 + 28;
      int $$4 = $$0.c();
