...
public class bvx extends bwf implements byc {
   private static final int c = 5;
   private static final akj<Float> d = akn.a(bvx.class, akl.d);
   private static final akj<Boolean> e = akn.a(bvx.class, akl.k);
   private static final akj<lv> f = akn.a(bvx.class, akl.l);
   ...
   private final Map<bwf, Integer> m = Maps.newHashMap();
   private int n = 600;
   private int o = 20;
   private int p = 20;
   private int q;
   ...
   public bvx(bwo<? extends bvx> $$0, dja $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public bvx(dja $$0, double $$1, double $$2, double $$3) {
      this(bwo.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof lq $$1) {
         int $$2 = this.k.equals(daz.a) ? 0 : this.k.b();
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  List<bxe> $$5 = this.dV().a(bxe.class, this.cR());
                  if (!$$5.isEmpty()) {
                     for (bxe $$6 : $$5) {
                        if (!this.m.containsKey($$6) && $$6.fL() && !$$4.stream().noneMatch($$6::b)) {
   ...
   public bxe o() {
      if (this.t != null && !this.t.dQ()) {
         ...
         if (this.u != null && this.dV() instanceof arq $$0) {
            this.t = $$0.b(this.u) instanceof bxe $$1 ? $$1 : null;
         }
   ...
   protected void a(tz $$0) {
      ...
      this.a($$0.<daz>a("potion_contents", daz.c, $$1).orElse(daz.a));
   ...
   protected void b(tz $$0) {
      ...
      if (!this.k.equals(daz.a)) {
         $$0.a("potion_contents", daz.c, $$1, this.k);
      }
