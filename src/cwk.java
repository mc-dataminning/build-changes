public class cwk extends cuj implements cvg {
   ...
   public bqu<cuo> a(dbx $$0, cmw $$1, bqs $$2) {
      if (!$$0.x_()) {
         evq $$3 = $$1.bx().e($$1.bN().a(0.8F));
         if (!$$0.a_(iz.a($$3)).r()) {
            $$3 = $$1.bx().e($$1.bN().a(0.05F));
         }

         cog $$4 = new cog($$1, $$0, $$3.a(), $$3.b(), $$3.c());
   ...
   public cno a(dbx $$0, js $$1, cuo $$2, je $$3) {
      ...
      return new cog($$0, $$1.a(), $$1.b(), $$1.c(), $$5, $$6, $$7);
   }
   ...
   @Override
   public cvg.a c() {
      return cvg.a.a().a(($$0, $$1) -> dhd.a($$0, 1.0, evq.b)).a(6.6666665F).b(1.0F).a();
   }
}
