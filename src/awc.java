...
public class awc extends ata {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), awc::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", awc::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", awc::k);
         $$0 = this.a($$0, "minecraft:fox", awc::j);
         $$0 = this.a($$0, "minecraft:item", awc::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", awc::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", awc::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", awc::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", awc::e);
         return this.a($$0, "minecraft:piglin", awc::d);
      });
   }
