...
public class dxc {
   ...
   private final Map<Character, Predicate<dxa>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dxc a(char $$0, Predicate<dxa> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dxb b() {
      return new dxb(this.c());
   }

   private Predicate<dxa>[][][] c() {
      this.d();
      Predicate<dxa>[][][] $$0 = (Predicate<dxa>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxa>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
