...
public class dxc extends dvs<dyq> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<dxc.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new dxc.b());

   public dxc(Codec<dyq> $$0) {
      super($$0);
   }

   public static List<dxc.a> a(cxw $$0) {
      axd $$1 = axd.a($$0.C());
      long $$2 = $$1.g() & 65535L;
      return (List<dxc.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(dvu<dyq> $$0) {
      dyq $$1 = $$0.f();
      cxw $$2 = $$0.b();
      axd $$3 = $$0.d();
      ib $$4 = $$0.e();
   ...
   private void a(cxq $$0, axd $$1, dyq $$2, dxc.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dnb $$18 = dae.eW
                        .o()
                        .a(dec.a, Boolean.valueOf($$16 && $$11 != -2))
                        .a(dec.c, Boolean.valueOf($$16 && $$11 != 2))
                        .a(dec.d, Boolean.valueOf($$17 && $$10 != -2))
                        .a(dec.b, Boolean.valueOf($$17 && $$10 != 2));
      ...
      if ($$19 != null) {
         ...
         $$0.b($$19);
         ib $$20 = $$19.dm();
         this.a($$0, $$20.d(), dae.F.o());
         this.a($$0, $$20, ddc.a($$0, $$20));
      }
   }

   public static class a {
      public static final Codec<dxc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new epo((double)($$0 - $$2), (double)dqo.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)dqo.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<dxc.a>> {
      public List<dxc.a> a(Long $$0) {
         IntArrayList $$1 = ac.a(IntStream.range(0, 10), axd.a($$0));
         List<dxc.a> $$2 = Lists.newArrayList();
