...
public class dxc<T> implements dxe<T> {
   ...
   private dxc(jt<T> $$0, int $$1, dxf<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dxc(jt<T> $$0, T[] $$1, dxf<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dxe<T> a(dxf<T> $$0) {
      return new dxc<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
