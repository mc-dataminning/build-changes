...
public class dxc {
   ...
   private static final int j = jh.a(16);
   ...
   private final daf p;
   private static final List<dde> q = List.of(ddg.l, ddg.L, ddg.i, ddg.b, ddg.k, ddg.I, ddg.K, ddg.fl, ddg.dP, ddg.iA, ddg.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<iw<dbc>>> t;
   ...
   public static final Codec<dxc> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   private dxc(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<iw<dbc>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jp.c($$0);
      int $$5 = jp.c($$1) - $$4;
   ...
   @Nullable
   public static dxc a(aqo $$0, int $$1, int $$2) {
      dsd $$3 = $$0.a($$1, $$2);
      dxc $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dtc.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<it> a(day $$0, int $$1, int $$2, boolean $$3) {
      Set<it> $$4 = EnumSet.noneOf(it.class);
   ...
   private void a(dsd $$0, Set<it> $$1) {
      if (!this.r) {
         if ($$1.contains(it.a) || $$1.contains(it.g) || $$1.contains(it.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(it.c) && $$1.contains(it.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(it.c) && $$1.contains(it.e) && $$1.contains(it.d)) {
   ...
   private void a(int $$0, dsd $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, axz.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dsd $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dvz.a.a)) {
         $$3 = Math.min($$0.a(dvz.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }

      int $$5 = this.p.I_();
      in.a $$6 = new in.a($$1, $$3, $$2);
   ...
   private static double a(dsd $$0, in.a $$1) {
      return a($$0, (in)$$1.c(is.a)) ? 1.0 : -1.0;
   }

   private static double b(dsd $$0, in.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dsd $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      in.a $$5 = new in.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<iw<dbc>> b(dsd $$0, int $$1, int $$2) {
      ObjectArrayList<iw<dbc>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + jh.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(jh.a($$1), $$5, jh.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dsd $$0, in $$1) {
      dqh $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avr.O)) {
         ...
         return $$2.a(ddg.eT) || $$2.a(ddg.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dxc.a $$3) {
      if ($$1 >= jh.a(this.p.I_()) && $$1 < jh.a(this.p.al())) {
         int $$4 = $$1 - jh.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               iw<dbc> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dxc.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dxc.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, iw<dbc> var3);
   }
