...
public class dxc extends dxf<dxb> {
   public dxc(Codec<dxb> $$0) {
      super($$0);
   }

   public boolean a(dxb $$0, axt $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dxa $$0, dxb $$1, dre $$2, Function<id, in<daf>> $$3, axt $$4, dum $$5, cyn $$6, drd $$7) {
      int $$8 = jg.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dxf.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dxa $$0, dxb $$1, dre $$2, Function<id, in<daf>> $$3, dum $$4, double $$5, double $$6, double $$7, float $$8, double $$9, drd $$10, dxf.a $$11
   ) {
      double $$12 = 1.5 + (double)(axm.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(axm.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = axm.b($$13);
         $$6 += (double)(axm.b($$12) * $$27);
         $$7 += (double)axm.a($$13);
         $$8 += (double)(axm.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
