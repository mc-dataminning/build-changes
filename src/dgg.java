...
public interface dgg<T extends Enum<T>> {
   int v_ = 4;

   Optional<dsh> i_(dsh var1);

   float au_();

   default void a_(dsh $$0, aqk $$1, ja $$2, aym $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dsh> c(dsh $$0, aqk $$1, ja $$2, aym $$3) {
      ...
      for (ja $$7 : ja.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dgg<?> $$9) {
            Enum<?> $$10 = $$9.c();
