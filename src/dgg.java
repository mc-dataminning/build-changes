...
public class dgg {
   public static final Codec<dgg> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> af.a($$0, 2).map($$0x -> new dgg($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.h, $$0.i))
      .stable();
   public static final yn<ByteBuf, dgg> b = new yn<ByteBuf, dgg>() {
      public dgg a(ByteBuf $$0) {
         return vl.c($$0);
      }

      public void a(ByteBuf $$0, dgg $$1) {
         vl.a($$0, $$1);
      }
   };
   private static final int j = 1056;
   public static final long c = c(1875066, 1875066);
   private static final int k = (32 + eam.a.a(ean.n).c().b() + 1) * 2;
   public static final int d = kk.a(ji.f) - k;
   public static final dgg e = new dgg(0, 0);
   ...
   public static dgg a(int $$0, int $$1) {
      return new dgg($$0 << 5, $$1 << 5);
   }

   public static dgg b(int $$0, int $$1) {
      return new dgg(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dgg $$1) ? false : this.h == $$1.h && this.i == $$1.i;
      }
   }
   ...
   public static Stream<dgg> a(dgg $$0, int $$1) {
      return a(new dgg($$0.h - $$1, $$0.i - $$1), new dgg($$0.h + $$1, $$0.i + $$1));
   }

   public static Stream<dgg> a(final dgg $$0, final dgg $$1) {
      int $$2 = Math.abs($$0.h - $$1.h) + 1;
      int $$3 = Math.abs($$0.i - $$1.i) + 1;
      final int $$4 = $$0.h < $$1.h ? 1 : -1;
      final int $$5 = $$0.i < $$1.i ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dgg>((long)($$2 * $$3), 64) {
         @Nullable
         private dgg e;

         @Override
         public boolean tryAdvance(Consumer<? super dgg> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
               ...
               if ($$1 == $$1.h) {
                  ...
                  this.e = new dgg($$0.h, $$2 + $$5);
               } else {
                  this.e = new dgg($$1 + $$4, $$2);
               }
            }
