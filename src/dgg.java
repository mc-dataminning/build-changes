...
public class dgg {
   public static final Codec<dgg> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> ae.a($$0, 2).map($$0x -> new dgg($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.g, $$0.h))
      .stable();
   public static final zt<ByteBuf, dgg> b = new zt<ByteBuf, dgg>() {
   ...
   public static final dgg d = new dgg(0, 0);
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dgg $$1) ? false : this.g == $$1.g && this.h == $$1.h;
      }
   }
   ...
   public static Stream<dgg> a(dgg $$0, int $$1) {
      return a(new dgg($$0.g - $$1, $$0.h - $$1), new dgg($$0.g + $$1, $$0.h + $$1));
   }
