...
public class ast extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(aym.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", ast::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", ast::a);
      return this.a($$0, "minecraft:trident", ast::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(aym.x, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(aym.x, $$1);
