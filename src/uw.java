...
public class uw implements tm {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = arj.a(arj.b, uw::b);
   private static final Codec<Object> e = Codec.either(d, tn.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof tl $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<uw> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               arj.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, uw::a)
   );
   public static final tm.a<uw> c = new tm.a<>(b, "translatable");
   private static final tq f = tq.e("%");
   private static final tq g = tq.e("null");
   ...
   @Nullable
   private qr k;
   private List<tq> l = ImmutableList.of();
   ...
   private static uw a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new uw($$0, $$1.orElse(null), a($$2));
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            ...
            this.l = ImmutableList.of(tq.e($$1));
         }
      }
   }
   ...
   private tq a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof tl) {
            ...
            return $$1 == null ? g : tq.e($$1.toString());
         }
      } else {
         throw new ux(this, $$0);
      }
   ...
   public tz a(@Nullable dt $$0, @Nullable biw $$1, int $$2) throws CommandSyntaxException {
      ...
      return tz.a(new uw(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof uw $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
