...
public class dpg<T> implements dpo<T> {
   private final iq<T> a;
   private final avt<T> b;
   private final dpp<T> c;
   private final int d;

   public dpg(iq<T> $$0, int $$1, dpp<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dpg(iq<T> $$0, int $$1, dpp<T> $$2) {
      this($$0, $$1, $$2, avt.c(1 << $$1));
   }

   private dpg(iq<T> $$0, int $$1, dpp<T> $$2, avt<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dpo<T> c() {
      return new dpg<>(this.a, this.d, this.c, this.b.c());
   }
}
