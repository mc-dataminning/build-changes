...
public abstract class dpg {
   ...
   public final void c(ur $$0, jk.a $$1) {
      this.a($$0, $$1);
      dpg.a.a.parse($$1.a(vf.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final ur d(jk.a $$0) {
      ur $$1 = new ur();
      this.b($$1, $$0);
      dpg.a.a.encodeStart($$0.a(vf.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((ur)$$1x));
      return $$1;
   }
   ...
   public static void a(ur $$0, dpi<?> $$1) {
      $$0.a("id", dpi.a($$1).toString());
   }

   public void a(cuo $$0, jk.a $$1) {
      ur $$2 = this.e($$1);
      this.a($$2);
      csm.a($$0, this.r(), $$2);
      $$0.b(this.s());
   ...
   @Nullable
   public static dpg a(iz $$0, dsb $$1, ur $$2, jk.a $$3) {
      String $$4 = $$2.l("id");
      ale $$5 = ale.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(dbx $$0, iz $$1, dsb $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
