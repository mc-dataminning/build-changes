...
public class akb<C extends bpp> implements aka<Integer> {
   ...
   public void a(aqo $$0, @Nullable cxy<? extends cxw<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.I().b($$1)) {
         this.b = $$0.gc();
         if (this.b() || $$0.f()) {
            this.a.a();
            $$0.gc().a(this.a);
            this.c.a(this.a);
            if (this.a.a((cxw<?>)$$1.b(), null)) {
               this.a($$1, $$2);
            } else {
               this.a();
               $$0.c.b(new adp($$0.cb.j, $$1));
            }
   ...
   protected void a(cxy<? extends cxw<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            ctq $$3 = this.c.b($$2).g().s();
            if (!$$3.e()) {
               int $$4 = this.b.e($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (ctq $$5 : $$0) {
                     if (ctq.b($$5, $$3) && $$5.I() != $$5.j() && $$5.I() + $$3.I() <= $$5.j()) {
                        $$5.g($$3.I());
                        $$3.e(0);
                        break;
                     }
