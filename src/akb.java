...
public class akb {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vd.c("commands.playsound.failed"));

   public static void a(CommandDispatcher<ds> $$0) {
      RequiredArgumentBuilder<ds, ahd> $$1 = dt.a("sound", et.a()).suggests(hn.c);

      for (arn $$2 : arn.values()) {
         $$1.then(a($$2));
      }
   ...
   private static LiteralArgumentBuilder<ds> a(arn $$0) {
   ...
   private static int a(ds $$0, Collection<ana> $$1, ahd $$2, arn $$3, elm $$4, float $$5, float $$6, float $$7) throws CommandSyntaxException {
      ih<arl> $$8 = ih.a(arl.a($$2));
      double $$9 = (double)aui.k($$8.a().a($$5));
      int $$10 = 0;
      long $$11 = $$0.e().F_().g();
      ...
      for (ana $$12 : $$1) {
         ...
         if ($$16 > $$9) {
            ...
            $$17 = new elm($$12.dr() + $$13 / $$19 * 2.0, $$12.dt() + $$14 / $$19 * 2.0, $$12.dx() + $$15 / $$19 * 2.0);
            $$18 = $$7;
         }

         $$12.c.b(new acp($$8, $$3, $$17.a(), $$17.b(), $$17.c(), $$18, $$6, $$11));
         $$10++;
      }
      ...
      if ($$10 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vd.a("commands.playsound.success.single", vd.a($$2), $$1.iterator().next().Q_()), true);
         } else {
            $$0.a(() -> vd.a("commands.playsound.success.multiple", vd.a($$2), $$1.size()), true);
         }
