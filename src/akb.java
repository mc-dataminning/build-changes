...
public class akb {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vf.c("commands.particle.failed"));
   ...
   private static int a(ds $$0, jv $$1, els $$2, els $$3, float $$4, int $$5, boolean $$6, Collection<ane> $$7) throws CommandSyntaxException {
      ...
      if ($$8 == 0) {
         ...
         $$0.a(() -> vf.a("commands.particle.success", kd.j.b($$1.b()).toString()), true);
         return $$8;
      }
   }
}
