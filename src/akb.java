...
public class akb {
   ...
   public static <T> ajx<T> a(Class<? extends aka> $$0, ajy<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> akb.b<T> b(ajx<T> $$0) {
      return (akb.b<T>)this.e[$$0.a()];
   }
   ...
   public <T> void a(ajx<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(ajx<T> $$0, T $$1, boolean $$2) {
      akb.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(akb.b<T> $$0, akb.c<?> $$1) {
   ...
   public static class a {
      private final aka a;
      private final akb.b<?>[] b;

      public a(aka $$0) {
         this.a = $$0;
         this.b = new akb.b[akb.c.b($$0.getClass())];
      }

      public <T> akb.a a(ajx<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public akb.c<T> e() {
         return akb.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, ajy<T> b, T c) {

      public static <T> akb.c<T> a(ajx<T> $$0, T $$1) {
         ajy<T> $$2 = $$0.b();
         return new akb.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static akb.c<?> a(vz $$0, int $$1) {
         int $$2 = $$0.l();
         ajy<?> $$3 = ajz.a($$2);
         if ($$3 == null) {
      ...
      private static <T> akb.c<T> a(vz $$0, int $$1, ajy<T> $$2) {
         return new akb.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
