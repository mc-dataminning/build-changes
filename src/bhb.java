...
public class bhb implements bgu {
   ...
   public static Set<bgs> a() {
      Builder<bgs> $$0 = ImmutableSet.builder();

      try {
         bhb.a $$1 = new bhb.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bgs.a("cpu#" + $$1x, bgr.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bgs.a("heap MiB", bgr.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bgt.a.a());
      return $$0.build();
   }
   ...
   public static bgs a(final LongSupplier $$0) {
      ...
      bgs.d $$3 = new bgs.d(2.0F);
      return bgs.a("ticktime", bgr.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
