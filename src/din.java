...
public class din {
   ...
   public static final Codec<din> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(din::a, Function.identity());
   ...
   private din(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<he<cnk>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hx.c($$0);
      int $$5 = hx.c($$1) - $$4;
   ...
   private int a(ddx $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dhk.a.a)) {
         $$3 = Math.min($$0.a(dhk.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }
   ...
   private List<he<cnk>> b(ddx $$0, int $$1, int $$2) {
      ObjectArrayList<he<cnk>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(ddx $$0, gu $$1) {
      ...
      if ($$2.i()) {
         ...
         return $$2.a(cpo.eU) || $$2.a(cpo.eV) ? false : !$$2.k($$0, $$1).b();
      }
   }
   ...
   protected void a(int $$0, int $$1, din.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, din.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, he<cnk> var3);
   }
