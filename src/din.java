...
public class din {
   ...
   private double j;
   int k = 29999984;
   private din.a l = new din.d(5.999997E7F);
   public static final din.c e = new din.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public ht b(double $$0, double $$1, double $$2) {
      return ht.a(ati.a($$0, this.e(), this.g()), $$1, ati.a($$2, this.f(), this.h()));
   }

   public double a(bki $$0) {
   ...
   public boolean a(bki $$0, ejd $$1) {
      double $$2 = Math.max(ati.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (din.a)($$0 == $$1 ? new din.d($$1) : new din.b($$0, $$1, $$2));
   ...
   class b implements din.a {
      ...
      @Override
      public double a() {
         return ati.a(din.this.a() - this.e() / 2.0, (double)(-din.this.k), (double)din.this.k);
      }

      @Override
      public double c() {
         return ati.a(din.this.b() - this.e() / 2.0, (double)(-din.this.k), (double)din.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ati.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dim i() {
         return this.c < this.b ? dim.b : dim.a;
      }
      ...
      @Override
      public din.a l() {
         return (din.a)(this.g() <= 0L ? din.this.new d(this.c) : this);
      }
      ...
      public ekb m() {
         return ejy.a(
            ejy.c,
            ejy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ejm.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static din.c a(DynamicLike<?> $$0, din.c $$1) {
         double $$2 = ati.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ati.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new din.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements din.a {
      ...
      private void n() {
         this.c = ati.a(din.this.a() - this.b / 2.0, (double)(-din.this.k), (double)din.this.k);
         this.d = ati.a(din.this.b() - this.b / 2.0, (double)(-din.this.k), (double)din.this.k);
         this.e = ati.a(din.this.a() + this.b / 2.0, (double)(-din.this.k), (double)din.this.k);
         this.f = ati.a(din.this.b() + this.b / 2.0, (double)(-din.this.k), (double)din.this.k);
         this.g = ejy.a(
            ejy.c,
            ejy.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ejm.e
