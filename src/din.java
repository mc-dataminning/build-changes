...
public class din extends diq<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected din(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof din $$1 && super.equals($$0)) {
   ...
   public static din a(String $$0, int $$1, int $$2) {
      return new din($$0, $$1, $$2);
   }
