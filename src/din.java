...
public abstract class din implements dim {
   public static final Codec<din> a = ma.Z.q().dispatchStable(din::a, Function.identity());
   private final Supplier<Set<jq<dij>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<jq<dij>> b();
   ...
   @Nullable
   public Pair<jh, jq<dij>> a(int $$0, int $$1, int $$2, int $$3, Predicate<jq<dij>> $$4, bam $$5, dis.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<jh, jq<dij>> a(jh $$0, int $$1, int $$2, int $$3, Predicate<jq<dij>> $$4, dis.f $$5, dhk $$6) {
      Set<jq<dij>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         ...
         for (jh.a $$10 : jh.a(jh.c, $$8, jm.f, jm.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = kb.a($$15);
               jq<dij> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = ab.ar ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               jq<dij> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract jq<dij> getNoiseBiome(int var1, int var2, int var3, dis.f var4);
