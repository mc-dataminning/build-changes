...
public class box implements boq {
   ...
   public box(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<boo> a() {
      Builder<boo> $$0 = ImmutableSet.builder();

      try {
         box.a $$1 = new box.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> boo.a("cpu#" + $$1x, bon.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(boo.a("heap MiB", bon.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bop.a.a());
      return $$0.build();
   }
   ...
   public static boo a(final LongSupplier $$0) {
      ...
      boo.d $$3 = new boo.d(2.0F);
      return boo.a("ticktime", bon.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
