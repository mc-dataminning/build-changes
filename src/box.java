...
public record box<T>(bop<StringReader> a, bon<T> b) {
   public Optional<T> a(bos<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      boq.a<StringReader> $$1 = new boq.a<>();
      bpb $$2 = new bpb(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bor::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      boq.a<StringReader> $$2 = new boq.a<>();
      bpb $$3 = new bpb(this.a(), $$2, $$1);
      this.a($$3);
      List<bor<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bor<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bpa $$7) {
               fb.a($$7.a(), $$5);
            } else {
