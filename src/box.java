...
public abstract class box<R extends Runnable> implements bof, boz<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected box(String $$0) {
      this.b = $$0;
      bod.a.a(this);
   }
   ...
   @Override
   public List<boc> bw() {
      return ImmutableList.of(boc.a(this.b + "-pending-tasks", bob.b, this::by));
   }
}
