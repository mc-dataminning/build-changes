...
public class chf {
   ...
   private static final bqe i = bqe.a(5, 16);
   private static final float j = 1.0F;
   private static final float k = 1.25F;
   private static final float l = 1.25F;
   private static final float m = 2.0F;
   private static final float n = 1.25F;
   private static final bqe o = bqe.a(600, 1200);
   public static final int c = 5;
   public static final int d = 5;
   public static final float e = 3.5714288F;
   private static final bqe p = bqe.a(600, 6000);
   private static final bqe q = bqe.a(100, 300);
   private static final cef r = cef.a().a($$0 -> !$$0.ak().equals(bsz.X) && $$0.dP().C_().a($$0.cK()));
   private static final float s = 3.0F;
   public static final int f = 4;
   public static final float g = 2.5F;
   public static final float h = 1.0F;

   protected static void a(che $$0, azg $$1) {
      $$0.dS().a(ccs.S, o.a($$1));
      $$0.dS().a(ccs.V, p.a($$1));
   }
   ...
   private static void b(buq<che> $$0) {
      $$0.a(col.a, 0, ImmutableList.of(new byb(0.8F), new bvc(2.0F), new bwn(45, 90), new bwr(), new bvn(ccs.P), new bvn(ccs.S), new bvn(ccs.V)));
   }
   ...
   private static void d(buq<che> $$0) {
      $$0.a(
         col.q,
         ImmutableList.of(Pair.of(0, new bwi(o, avz.ld)), Pair.of(1, new bwk<>(o, 5, 5, 3.5714288F, $$0x -> $$0x.gA() ? avz.kY : avz.kO))),
   ...
   private static void e(buq<che> $$0) {
      $$0.a(
         ...
         ImmutableList.of(
            ...
            Pair.of(1, new bww<>($$0x -> $$0x.gA() ? q.a() : p.a(), 4, 7, 1.25F, r, 20, $$0x -> $$0x.gA() ? avz.la : avz.kQ))
         ),
   ...
   public static void a(che $$0) {
      $$0.dS().a(ImmutableList.of(col.r, col.q, col.b));
   }
