...
public class chf extends cgw {
   private static final ajy<ji> cb = akc.a(chf.class, aka.o);
   private static final ajy<Boolean> cc = akc.a(chf.class, aka.k);
   private static final ajy<Integer> cd = akc.a(chf.class, aka.b);
   ...
   public chf(bur<? extends chf> $$0, dgh $$1) {
      super($$0, $$1);
   ...
   @Nullable
   public chf b(ard $$0, bub $$1) {
      return bur.H.a($$0, buq.e);
   }
   ...
   protected void E() {
      ...
      this.bS.a(5, new ccm(this, cow.class, 6.0F));
   ...
   public static bwn.a gs() {
      return bvi.F().a(bwo.s, 10.0).a(bwo.v, 1.2F).a(bwo.c, 3.0);
   }
   ...
   static class a extends cce {
      ...
      public void a() {
         ...
         if (this.a.gt() || this.a.P().k()) {
            faz $$1 = faz.b(this.a.p());
            faz $$2 = cgb.a(this.a, 16, 1, $$1, (float) (Math.PI / 8));
            if ($$2 == null) {
            ...
            if ($$2 != null) {
               ji $$3 = ji.a((kb)$$2);
               if (!$$0.b_($$3).a(awv.a) || !$$0.a_($$3).a(etn.b)) {
   ...
   class c extends cce {
      ...
      public boolean b() {
         if (this.b > chf.this.af) {
            ...
            List<clb> $$0 = chf.this.dV().a(clb.class, chf.this.cR().c(8.0, 8.0, 8.0), chf.bZ);
      ...
      @Override
      public void e() {
         cwo $$0 = chf.this.a(bus.a);
         if (!$$0.f()) {
            this.a($$0);
            chf.this.a(bus.a, cwo.j);
      ...
      private void a(cwo $$0) {
         if (!$$0.f()) {
            double $$1 = chf.this.dE() - 0.3F;
            clb $$2 = new clb(chf.this.dV(), chf.this.dA(), $$1, chf.this.dG(), $$0);
            $$2.b(40);
            $$2.b(chf.this);
            float $$3 = 0.3F;
            ...
            $$2.n(
               (double)(0.3F * -ayz.a(chf.this.dL() * (float) (Math.PI / 180.0)) * ayz.b(chf.this.dN() * (float) (Math.PI / 180.0)) + ayz.b($$4) * $$5),
               (double)(0.3F * ayz.a(chf.this.dN() * (float) (Math.PI / 180.0)) * 1.5F),
               (double)(0.3F * ayz.b(chf.this.dL() * (float) (Math.PI / 180.0)) * ayz.b(chf.this.dN() * (float) (Math.PI / 180.0)) + ayz.a($$4) * $$5)
            );
            chf.this.dV().b($$2);
         }
      }
