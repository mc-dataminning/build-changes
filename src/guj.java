...
public class guj {
   ...
   public static class a extends Thread {
      private final guj.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(guj.b $$0) throws IOException {
         super("LanServerDetector #" + guj.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(guj.b));
   ...
   public static class b {
      private final List<gui> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gui> a() {
         if (this.b) {
            List<gui> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
