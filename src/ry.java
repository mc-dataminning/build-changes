...
public abstract class ry {
   ...
   private static volatile ry e = c();
   ...
   private static ry c() {
      ...
      return new ry() {
         ...
         @Override
         public atc a(va $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> auj.c($$2xxx, $$1x, $$1) ? Optional.empty() : va.a, vs.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = ry.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(atg.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract atc a(va var1);

   public List<atc> a(List<va> $$0) {
