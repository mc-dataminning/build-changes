...
public class am {
   public static final Codec<ap<?>> a = le.ap.q();
   ...
   public static final dd g = a("recipe_unlocked", new dd());
   ...
   public static final ds n = a("used_ender_eye", new ds());
   public static final dm o = a("summoned_entity", new dm());
   ...
   public static final dr t = a("villager_trade", new dr());
   ...
   public static final dp y = a("tame_animal", new dp());
   ...
   public static final dt C = a("used_totem", new dt());
   ...
   public static final de G = a("shot_crossbow", new de());
   ...
   public static final dh K = a("slide_down_block", new dh());
   public static final au L = a("bee_nest_destroyed", new au());
   public static final dq M = a("target_hit", new dq());
   ...
   public static final dk U = a("started_riding", new dk());
   public static final cq V = a("lightning_strike", new cq());
   public static final du W = a("using_item", new du());
   ...
   public static final dc ac = a("recipe_crafted", new dc());
   public static final dc ad = a("crafter_recipe_crafted", new dc());
   public static final bv ae = a("fall_after_explosion", new bv());

   private static <T extends ap<?>> T a(String $$0, T $$1) {
      return jk.a(le.ap, $$0, $$1);
   }

   public static ap<?> a(jk<ap<?>> $$0) {
      return b;
   }
}
