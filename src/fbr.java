...
public class fbr extends fbg implements fcl {
   private static final fcv d = new fcv(new ajh("widget/text_field"), new ajh("widget/text_field_highlighted"));
   ...
   public fbr(fat $$0, int $$1, int $$2, vu $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fbr(fat $$0, int $$1, int $$2, int $$3, int $$4, vu $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fbr(fat $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fbr $$5, vu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fhh.v());
   }
   ...
   public void b(fav $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fya.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
