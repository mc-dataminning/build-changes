...
public class fbr implements aej<cmb>, etn, euf, ewb, fbw {
   public static final etx a = new etx(new aeu("recipe_book/button"), new aeu("recipe_book/button_highlighted"));
   private static final etx i = new etx(
      new aeu("recipe_book/filter_enabled"),
      new aeu("recipe_book/filter_disabled"),
      new aeu("recipe_book/filter_enabled_highlighted"),
      new aeu("recipe_book/filter_disabled_highlighted")
   );
   protected static final aeu b = new aeu("textures/gui/recipe_book.png");
   private static final ti j = ti.c("gui.recipebook.search_hint").a(n.u).a(n.h);
   public static final int c = 147;
   public static final int d = 166;
   private static final int k = 86;
   private static final ti l = ti.c("gui.recipebook.toggleRecipes.craftable");
   private static final ti m = ti.c("gui.recipebook.toggleRecipes.all");
   private int n;
   private int o;
   private int p;
   ...
   public void a(int $$0, int $$1, eqq $$2, boolean $$3, cfq<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void e() {
      ...
      this.t = new esu(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, ti.c("itemGroup.search"));
      this.t.l(50);
      this.t.g(true);
      this.t.m(16777215);
      this.t.a($$2);
   ...
   private void c(boolean $$0) {
      ...
      String $$3 = this.t.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fbv> $$4 = new ObjectLinkedOpenHashSet(this.h.a(gct.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(esa $$0, int $$1, int $$2, int $$3, int $$4) {
      cja $$5 = null;
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, eyf.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(esa $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.g() && !this.h.s.G_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.bQ.j, $$3, eyf.q());
               if (!this.r()) {
                  this.b(false);
               }
            }
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (!this.g() || this.h.s.G_()) {
         ...
         this.o();
         return true;
      } else if (this.t.ay_() && this.t.v() && $$0 != 256) {
         return true;
      } else if (this.h.m.K.a($$0, $$1) && !this.t.ay_()) {
         this.z = true;
         this.t.b_(true);
         return true;
      } else {
   ...
   public void a(cmf<?> $$0, List<cfy> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cmb.a($$2), $$1.get(0).f, $$1.get(0).g);
