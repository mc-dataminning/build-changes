...
public class ca extends cx<ca.a> {
   ...
   public void a(aox $$0, chk $$1, cpd $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(aox $$0, chk $$1, cpd $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bc> b, ca.a.a c, List<cc> d) implements cx.a {
      public static final Codec<ca.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avq.a(br.b, "player").forGetter(ca.a::a),
                  avq.a(ca.a.a.a, "slots", ca.a.a.b).forGetter(ca.a::b),
                  avq.a(cc.a.listOf(), "items", List.of()).forGetter(ca.a::c)
               )
               .apply($$0, ca.a::new)
      );
      ...
      public boolean a(chk $$0, cpd $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
      ...
      public static record a(cm.d c, cm.d d, cm.d e) {
         public static final Codec<ca.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     avq.a(cm.d.d, "occupied", cm.d.c).forGetter(ca.a.a::a),
                     avq.a(cm.d.d, "full", cm.d.c).forGetter(ca.a.a::b),
                     avq.a(cm.d.d, "empty", cm.d.c).forGetter(ca.a.a::c)
                  )
                  .apply($$0, ca.a.a::new)
         );
