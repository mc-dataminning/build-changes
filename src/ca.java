...
public class ca extends cx<ca.a> {
   ...
   public void a(aow $$0, chg $$1, coz $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(aow $$0, chg $$1, coz $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bc> b, ca.a.a c, List<cc> d) implements cx.a {
      public static final Codec<ca.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avp.a(br.b, "player").forGetter(ca.a::a),
                  avp.a(ca.a.a.a, "slots", ca.a.a.b).forGetter(ca.a::b),
                  avp.a(cc.a.listOf(), "items", List.of()).forGetter(ca.a::c)
               )
               .apply($$0, ca.a::new)
      );
      ...
      public static an<ca.a> a(cvm... $$0) {
         cc[] $$1 = new cc[$$0.length];

         for (int $$2 = 0; $$2 < $$0.length; $$2++) {
            $$1[$$2] = new cc(Optional.empty(), Optional.of(in.a($$0[$$2].j().i())), cm.d.c, cm.d.c, List.of(), List.of(), Optional.empty(), Optional.empty());
         }

         return a($$1);
      }

      public boolean a(chg $$0, coz $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
      ...
      public static record a(cm.d c, cm.d d, cm.d e) {
         public static final Codec<ca.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     avp.a(cm.d.d, "occupied", cm.d.c).forGetter(ca.a.a::a),
                     avp.a(cm.d.d, "full", cm.d.c).forGetter(ca.a.a::b),
                     avp.a(cm.d.d, "empty", cm.d.c).forGetter(ca.a.a::c)
                  )
                  .apply($$0, ca.a.a::new)
         );
