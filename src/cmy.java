...
public abstract class cmy extends cnk {
   private static final double f = 2.0;
   private static final akg<Byte> g = akk.a(cmy.class, aki.a);
   private static final akg<Byte> h = akk.a(cmy.class, aki.a);
   ...
   protected boolean b;
   protected int c;
   public cmy.a d = cmy.a.a;
   public int e;
   private int m;
   private double n = 2.0;
   private int o;
   private avv p = this.u();
   @Nullable
   private IntOpenHashSet q;
   @Nullable
   private List<bsp> r;
   private cuk s = this.x();

   protected cmy(bsv<? extends cmy> $$0, dbt $$1) {
      super($$0, $$1);
   }

   protected cmy(bsv<? extends cmy> $$0, dbt $$1, cuk $$2) {
      this($$0, $$1);
      this.s = $$2.s();
      this.b($$2.a(km.f));
      azx $$3 = $$2.c(km.t);
   ...
   protected cmy(bsv<? extends cmy> $$0, double $$1, double $$2, double $$3, dbt $$4, cuk $$5) {
      this($$0, $$4, $$5);
      this.a_($$1, $$2, $$3);
   }

   protected cmy(bsv<? extends cmy> $$0, btk $$1, dbt $$2, cuk $$3) {
   ...
   public void l() {
      ...
      if (this.P == 0.0F && this.O == 0.0F) {
         double $$2 = $$1.h();
         this.r((float)(ayu.d($$1.c, $$1.e) * 180.0F / (float)Math.PI));
         this.s((float)(ayu.d($$1.d, $$2) * 180.0F / (float)Math.PI));
         this.O = this.dF();
         this.P = this.dH();
      }
      ...
      if (this.b && !$$0) {
         ...
         evm $$8 = this.dn();
         evm $$9 = $$8.e($$1);
         evk $$10 = this.dP().a(new dbc($$8, $$9, dbc.a.a, dbc.b.a, this));
         if ($$10.c() != evk.a.a) {
            $$9 = $$10.e();
         }
         ...
         while (!this.dK()) {
            ...
            if ($$10 != null && $$10.c() == evk.a.c) {
               bsp $$12 = ((evj)$$10).a();
               bsp $$13 = this.s();
               if ($$12 instanceof cms && $$13 instanceof cms && !((cms)$$13).a((cms)$$12)) {
                  $$10 = null;
                  $$11 = null;
               }
            }
         ...
         double $$22 = $$1.h();
         if ($$0) {
            this.r((float)(ayu.d(-$$15, -$$17) * 180.0F / (float)Math.PI));
         } else {
            this.r((float)(ayu.d($$15, $$17) * 180.0F / (float)Math.PI));
         }

         this.s((float)(ayu.d($$16, $$22) * 180.0F / (float)Math.PI));
   ...
   private boolean H() {
      return this.b && this.dP().b(new evh(this.dn(), this.dn()).g(0.06));
   }
   ...
   protected void a(evj $$0) {
      ...
      int $$3 = ayu.c(ayu.a((double)$$2 * this.n, 0.0, 2.147483647E9));
      if (this.D() > 0) {
         if (this.q == null) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof btk $$10) {
            if (!this.dP().B && this.D() <= 0) {
               $$10.q($$10.eT() + 1);
            }

            if (this.o > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.g(bus.n));
               evm $$12 = this.ds().d(1.0, 0.0, 1.0).d().a((double)this.o * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dP().B && $$5 instanceof btk) {
               czw.a($$10, $$5);
               czw.b((btk)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof cms && $$5 instanceof arc && !this.aW()) {
               ((arc)$$5).c.b(new adl(adl.h, 0.0F));
            }
            ...
            if (!this.dP().B && $$5 instanceof arc $$13) {
   ...
   protected void a(evi $$0) {
      ...
      super.a($$0);
      evm $$1 = $$0.e().a(this.du(), this.dw(), this.dA());
      this.h($$1);
      evm $$2 = $$1.d().a(0.05F);
   ...
   protected evj a(evm $$0, evm $$1) {
      return cnm.a(this.dP(), this, $$0, $$1, this.cK().b(this.ds()).g(1.0), this::b);
   }
   ...
   public void a(ur $$0) {
      ...
      this.d = cmy.a.a($$0.f("pickup"));
      this.a($$0.q("crit"));
      this.a($$0.f("PierceLevel"));
      if ($$0.b("SoundEvent", 8)) {
         this.p = lp.b.b(new alb($$0.l("SoundEvent"))).orElse(this.u());
      }

      this.q($$0.q("ShotFromCrossbow"));
      if ($$0.b("item", 10)) {
         this.a(cuk.a(this.dR(), (vo)$$0.p("item")).orElse(this.x()));
      } else {
         this.a(this.x());
      }
   }
   ...
   public void c(@Nullable bsp $$0) {
      super.c($$0);
      if ($$0 instanceof cms && this.d == cmy.a.a) {
         this.d = cmy.a.b;
      }
   }
   ...
   @Override
   public buc a_(int $$0) {
      return $$0 == 0 ? buc.a(this::y, this::a) : super.a_($$0);
   }
