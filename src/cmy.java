...
public record cmy(cmy.a d) {
   ...
   public static cmy a(azk $$0, UUID $$1, cmy.a $$2) throws cmy.b {
      if (!$$2.a($$0, $$1)) {
         throw new cmy.b(e);
      } else {
         return new cmy($$2);
   ...
   public azk a() {
      return azk.a(this.d.c, "SHA256withRSA");
   }
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cmy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayf.o.fieldOf("expires_at").forGetter(cmy.a::b), axv.f.fieldOf("key").forGetter(cmy.a::c), ayf.p.fieldOf("signature_v2").forGetter(cmy.a::d)
               )
               .apply($$0, cmy.a::new)
      );
