...
public class cmy implements bqp, brb {
   ...
   public final jr<cur> h = jr.a(36, cur.l);
   public final jr<cur> i = jr.a(4, cur.l);
   public final jr<cur> j = jr.a(1, cur.l);
   private final List<jr<cur>> n = ImmutableList.of(this.h, this.i, this.j);
   public int k;
   public final cmz l;
   private int o;
   ...
   public cur f() {
      return d(this.k) ? this.h.get(this.k) : cur.l;
   }
   ...
   private boolean a(cur $$0, cur $$1) {
      return !$$0.e() && cur.c($$0, $$1) && $$0.k() && $$0.I() < this.e_($$0);
   }
   ...
   public int c(cur $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         if (!this.h.get($$1).e() && cur.c($$0, this.h.get($$1))) {
            return $$1;
         }
      }
   ...
   public int d(cur $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         cur $$2 = this.h.get($$1);
         if (!this.h.get($$1).e() && cur.c($$0, this.h.get($$1)) && !this.h.get($$1).m() && !$$2.B() && !$$2.b(km.g)) {
            return $$1;
         }
      }
   ...
   public int a(Predicate<cur> $$0, int $$1, bqp $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
      $$3 += bqq.a(this, $$0, $$1 - $$3, $$4);
      $$3 += bqq.a($$2, $$0, $$1 - $$3, $$4);
      cur $$5 = this.l.cb.g();
      $$3 += bqq.a($$5, $$0, $$1 - $$3, $$4);
      if ($$5.e()) {
   ...
   public cur a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).e() ? bqq.a($$2, $$0, $$1) : cur.l;
   }
   ...
   public void b(uy $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         us $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cur $$4 = cur.a(this.l.dR(), (vp)$$2).orElse(cur.l);
   ...
   public cur a(boolean $$0) {
      cur $$1 = this.f();
      return $$1.e() ? cur.l : this.a(this.k, $$0 ? $$1.I() : 1);
   }
}
