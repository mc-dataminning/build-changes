...
public abstract class cmy extends cmx {
   ...
   protected cmy(bvr<? extends cmy> $$0, dhi $$1) {
      super($$0, $$1);
   }
   ...
   protected void B() {
      super.B();
      this.bT.a(4, new cmy.a<>(this, 0.7, 0.595));
   }
   ...
   public bwz a(dhz $$0, bth $$1, bvq $$2, @Nullable bwz $$3) {
      if ($$2 != bvq.p && $$2 != bvq.h && $$2 != bvq.d && $$0.H_().i() < 0.06F && this.go()) {
         this.b = true;
      }

      if (this.gr()) {
         this.a(bvs.f, crk.a(this.dY().e(mb.d)));
         this.a(bvs.f, 2.0F);
      }
   ...
   public static boolean b(bvr<? extends cmy> $$0, dhj $$1, bvq $$2, jh $$3, bam $$4) {
      return $$1.a(dhr.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends cmy> extends cde {
      ...
      public void a() {
         ...
         if ($$1.m()) {
            ...
            if (this.b.gw() && $$2.isEmpty()) {
               ...
               fby $$3 = fby.c(this.b.gp());
               fby $$4 = this.b.du();
               fby $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).c(0.4).e($$3);
               fby $$6 = $$3.d($$4).d().c(10.0).e($$4);
               jh $$7 = jh.a((ka)$$6);
               $$7 = this.b.dW().a(edq.a.f, $$7);
      ...
      private List<cmy> h() {
         return this.b.dW().a(cmy.class, this.b.cR().g(16.0), $$0 -> $$0.gu() && !$$0.u(this.b));
      }
