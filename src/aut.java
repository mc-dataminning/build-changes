...
public class aut extends DataFix {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$4x -> $$4x.updateTyped(
               ...
               $$3xx -> {
                  ...
                  MutableObject<Supplier<auw.a>> $$14 = new MutableObject((Supplier<auw.a>)() -> null);
                  $$3xx = $$3xx.updateTyped(
                     $$2,
                     $$6,
                     $$7x -> {
                  ...
                  return $$3xx.update(DSL.remainderFinder(), $$5xx -> {
                     ...
                     return a($$5xx, $$8, $$9.booleanValue(), "minecraft:noise".equals($$7), (Supplier<auw.a>)$$14.getValue());
                  });
               }
            )
      );
   ...
   private static Dynamic<?> a(Dynamic<?> $$0, boolean $$1, boolean $$2, boolean $$3, Supplier<auw.a> $$4) {
      $$0 = $$0.remove("Biomes");
      if (!$$1) {
         return a($$0, 16, 0);
      } else if ($$2) {
