...
public class enb implements dxs.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<enb> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axx<enb> a = axx.a(f);
   private final enf g;
   private final enf h;
   private final enf i;
   ...
   public static enb a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new enb(new dza(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private enb(enf $$0, enf $$1, enf $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public enb(aym $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         enf.a($$0, IntStream.rangeClosed(-15, 0)),
         enf.a($$0, IntStream.rangeClosed(-15, 0)),
         enf.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public enb a(aym $$0) {
      return new enb($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxs.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         enc $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(enf.b($$4 * $$13), enf.b($$5 * $$13), enf.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = enf.b($$1 * $$13);
         double $$21 = enf.b($$2 * $$13);
         double $$22 = enf.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            enc $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aye.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
