...
public class bjc {
   ...
   private bjc(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bjc a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bjc($$0, $$1);
   }

   public bjc.d a() throws IOException {
      bjc.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bjc.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bjc.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bjc.c $$3 = bjc.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bjc.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bjc.a($$0, $$3);
            }
         }
   ...
   public bjc.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bjc.c> $$2 = this.a().c();
      ...
      bjc.e $$4 = new bjc.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bjc.c b) implements bjc.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bjc.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bjc.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bjc.b> {
      private final List<bjc.b> a;

      d(List<bjc.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bjc.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bjc.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bjc.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bjc.d a() {
         ListIterator<bjc.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bjc.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bjc.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bjc.b> b() {
         return this.a.stream();
      }

      public Set<bjc.c> c() {
         return this.a.stream().map(bjc.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bjc.c b) implements bjc.b {
