...
public class bjc extends biw {
   ...
   public bjc(cqb $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bja.J, $$0);
      this.e($$1, $$2, $$3);
   ...
   public bjc(bja<? extends bjc> $$0, cqb $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         ehh $$0 = new ehh(this.k.dq() - this.dq(), this.k.ds() + (double)this.k.cH() / 2.0 - this.ds(), this.k.dw() - this.dw());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void t() {
      ...
      if (this.dL() instanceof akt) {
         for (bjc $$1 : this.dL().a(djb.a(bjc.class), this.cG().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(akt $$0, ehh $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bjc($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(akt $$0, ehh $$1, int $$2) {
      ehc $$3 = ehc.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.D_().a(40);
      List<bjc> $$5 = $$0.a(djb.a(bjc.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bjc $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bjc $$0) {
      return $$0 != this && a($$0, this.ah(), this.i);
   }

   private static boolean a(bjc $$0, int $$1, int $$2) {
      return !$$0.dG() && ($$0.ah() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bjc $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cca $$0, int $$1) {
      Entry<bjb, cjl> $$2 = cnw.a(cny.L, $$0, cjl::j);
      if ($$2 != null) {
         cjl $$3 = $$2.getValue();
