...
public class ahn {
               ...
               ds.a("template")
                  .then(
                     ((RequiredArgumentBuilder)ds.a("template", eq.a())
                           .suggests(f)
                           .executes($$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), gu.a(((dr)$$0x.getSource()).d()), cyx.a, cxg.a, 1.0F, 0)))
                        .then(
                           ((RequiredArgumentBuilder)ds.a("pos", fi.a())
                                 .executes($$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), fi.a($$0x, "pos"), cyx.a, cxg.a, 1.0F, 0)))
                              .then(
                                 ((RequiredArgumentBuilder)ds.a("rotation", fa.a())
                                       .executes(
                                          $$0x -> a((dr)$$0x.getSource(), eq.e($$0x, "template"), fi.a($$0x, "pos"), fa.a($$0x, "rotation"), cxg.a, 1.0F, 0)
                                       ))
                                    .then(
   ...
   public static int a(dr $$0, he.c<dmz<?, ?>> $$1, gu $$2) throws CommandSyntaxException {
      akk $$3 = $$0.e();
      dmz<?, ?> $$4 = $$1.a();
      cos $$5 = new cos($$2);
      a($$3, new cos($$5.e - 1, $$5.f - 1), new cos($$5.e + 1, $$5.f + 1));
   ...
   public static int a(dr $$0, he<dwh> $$1, aer $$2, int $$3, gu $$4) throws CommandSyntaxException {
      akk $$5 = $$0.e();
      if (!dwb.a($$5, $$1, $$2, $$3, $$4, false)) {
         throw b.create();
      } else {
   ...
   public static int b(dr $$0, he.c<duy> $$1, gu $$2) throws CommandSyntaxException {
      akk $$3 = $$0.e();
      duy $$4 = $$1.a();
      dgw $$5 = $$3.k().g();
      dvg $$6 = $$4.a($$0.v(), $$5, $$5.c(), $$3.k().i(), $$3.p(), $$3.A(), new cos($$2), 0, $$3, $$0x -> true);
      if (!$$6.b()) {
         throw c.create();
      } else {
         duq $$7 = $$6.a();
         cos $$8 = new cos(hx.a($$7.g()), hx.a($$7.i()));
         cos $$9 = new cos(hx.a($$7.j()), hx.a($$7.l()));
         a($$3, $$8, $$9);
         cos.a($$8, $$9).forEach($$3x -> $$6.a($$3, $$3.a(), $$5, $$3.y_(), new duq($$3x.d(), $$3.C_(), $$3x.e(), $$3x.f(), $$3.aj(), $$3x.g()), $$3x));
   ...
   public static int a(dr $$0, aer $$1, gu $$2, cyx $$3, cxg $$4, float $$5, int $$6) throws CommandSyntaxException {
      akk $$7 = $$0.e();
      dys $$8 = $$7.p();
      ...
      if ($$9.isEmpty()) {
         ...
         dyr $$12 = $$9.get();
         a($$7, new cos($$2), new cos($$2.a($$12.a())));
         dyn $$13 = new dyn().a($$4).a($$3);
         if ($$5 < 1.0F) {
            $$13.b().a(new dxv($$5)).a(ddy.b((long)$$6));
         }

         boolean $$14 = $$12.a($$7, $$2, $$2, $$13, ddy.b((long)$$6), 2);
         if (!$$14) {
            throw e.create();
         } else {
   ...
   private static void a(akk $$0, cos $$1, cos $$2) throws CommandSyntaxException {
      if (cos.a($$1, $$2).filter($$1x -> !$$0.o($$1x.l())).findAny().isPresent()) {
         throw fi.a.create();
      }
   }
}
