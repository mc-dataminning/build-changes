...
public class gtf {
   ...
   static final ThreadLocal<gtf.d> f = ThreadLocal.withInitial(gtf.d::new);

   public gtf(fsf $$0) {
      this.d = $$0;
   }

   public void a(diy $$0, List<gtm> $$1, ebe $$2, iv $$3, flo $$4, flr $$5, boolean $$6, int $$7) {
      if (!$$1.isEmpty()) {
         boolean $$8 = frd.P() && $$2.k() == 0 && $$1.getFirst().a();
         $$4.a($$2.a($$3));
   ...
   public void b(diy $$0, List<gtm> $$1, ebe $$2, iv $$3, flo $$4, flr $$5, boolean $$6, int $$7) {
      ...
      for (gtm $$12 : $$1) {
         for (jb $$13 : c) {
            List<gtg> $$14 = $$12.a($$13);
            if (!$$14.isEmpty() && (!$$6 || dnc.a($$2, $$0.a_($$11.a($$3, $$13)), $$13))) {
               this.a($$0, $$2, $$3, $$4, $$5, $$14, $$8, $$9, $$10, $$7);
            }
         }

         List<gtg> $$15 = $$12.a(null);
         if (!$$15.isEmpty()) {
   ...
   public void c(diy $$0, List<gtm> $$1, ebe $$2, iv $$3, flo $$4, flr $$5, boolean $$6, int $$7) {
   ...
   private void a(diy $$0, ebe $$1, iv $$2, flo $$3, flr $$4, List<gtg> $$5, float[] $$6, BitSet $$7, gtf.b $$8, int $$9) {
      for (gtg $$10 : $$5) {
   ...
   private void a(diy $$0, ebe $$1, iv $$2, flr $$3, flo.a $$4, gtg $$5, float[] $$6, int[] $$7, int $$8) {
      float $$10;
      float $$11;
      float $$12;
      if ($$5.a()) {
   ...
   private void a(diy $$0, ebe $$1, iv $$2, int[] $$3, jb $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(diy $$0, ebe $$1, iv $$2, int $$3, int $$4, boolean $$5, flo $$6, flr $$7, List<gtg> $$8, BitSet $$9) {
      for (gtg $$10 : $$8) {
         if ($$5) {
   ...
   public void a(flo.a $$0, flr $$1, gtn $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      for (gtm $$8 : $$2.a(azx.a(42L))) {
         for (jb $$9 : c) {
   ...
   private static void a(flo.a $$0, flr $$1, float $$2, float $$3, float $$4, List<gtg> $$5, int $$6, int $$7) {
      for (gtg $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.a()) {
            $$9 = azo.a($$2, 0.0F, 1.0F);
            $$10 = azo.a($$3, 0.0F, 1.0F);
            $$11 = azo.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gtf.e[]{gtf.e.k, gtf.e.d, gtf.e.k, gtf.e.j, gtf.e.e, gtf.e.j, gtf.e.e, gtf.e.d},
         new gtf.e[]{gtf.e.k, gtf.e.c, gtf.e.k, gtf.e.i, gtf.e.e, gtf.e.i, gtf.e.e, gtf.e.c},
         new gtf.e[]{gtf.e.l, gtf.e.c, gtf.e.l, gtf.e.i, gtf.e.f, gtf.e.i, gtf.e.f, gtf.e.c},
         new gtf.e[]{gtf.e.l, gtf.e.d, gtf.e.l, gtf.e.j, gtf.e.f, gtf.e.j, gtf.e.f, gtf.e.d}
      ),
      b(
         new jb[]{jb.f, jb.e, jb.c, jb.d},
         1.0F,
         true,
         new gtf.e[]{gtf.e.f, gtf.e.d, gtf.e.f, gtf.e.j, gtf.e.l, gtf.e.j, gtf.e.l, gtf.e.d},
         new gtf.e[]{gtf.e.f, gtf.e.c, gtf.e.f, gtf.e.i, gtf.e.l, gtf.e.i, gtf.e.l, gtf.e.c},
         new gtf.e[]{gtf.e.e, gtf.e.c, gtf.e.e, gtf.e.i, gtf.e.k, gtf.e.i, gtf.e.k, gtf.e.c},
         new gtf.e[]{gtf.e.e, gtf.e.d, gtf.e.e, gtf.e.j, gtf.e.k, gtf.e.j, gtf.e.k, gtf.e.d}
      ),
      c(
         new jb[]{jb.b, jb.a, jb.f, jb.e},
         0.8F,
         true,
         new gtf.e[]{gtf.e.b, gtf.e.k, gtf.e.b, gtf.e.e, gtf.e.h, gtf.e.e, gtf.e.h, gtf.e.k},
         new gtf.e[]{gtf.e.b, gtf.e.l, gtf.e.b, gtf.e.f, gtf.e.h, gtf.e.f, gtf.e.h, gtf.e.l},
         new gtf.e[]{gtf.e.a, gtf.e.l, gtf.e.a, gtf.e.f, gtf.e.g, gtf.e.f, gtf.e.g, gtf.e.l},
         new gtf.e[]{gtf.e.a, gtf.e.k, gtf.e.a, gtf.e.e, gtf.e.g, gtf.e.e, gtf.e.g, gtf.e.k}
      ),
      d(
         new jb[]{jb.e, jb.f, jb.a, jb.b},
         0.8F,
         true,
         new gtf.e[]{gtf.e.b, gtf.e.k, gtf.e.h, gtf.e.k, gtf.e.h, gtf.e.e, gtf.e.b, gtf.e.e},
         new gtf.e[]{gtf.e.a, gtf.e.k, gtf.e.g, gtf.e.k, gtf.e.g, gtf.e.e, gtf.e.a, gtf.e.e},
         new gtf.e[]{gtf.e.a, gtf.e.l, gtf.e.g, gtf.e.l, gtf.e.g, gtf.e.f, gtf.e.a, gtf.e.f},
         new gtf.e[]{gtf.e.b, gtf.e.l, gtf.e.h, gtf.e.l, gtf.e.h, gtf.e.f, gtf.e.b, gtf.e.f}
      ),
      e(
         new jb[]{jb.b, jb.a, jb.c, jb.d},
         0.6F,
         true,
         new gtf.e[]{gtf.e.b, gtf.e.d, gtf.e.b, gtf.e.j, gtf.e.h, gtf.e.j, gtf.e.h, gtf.e.d},
         new gtf.e[]{gtf.e.b, gtf.e.c, gtf.e.b, gtf.e.i, gtf.e.h, gtf.e.i, gtf.e.h, gtf.e.c},
         new gtf.e[]{gtf.e.a, gtf.e.c, gtf.e.a, gtf.e.i, gtf.e.g, gtf.e.i, gtf.e.g, gtf.e.c},
         new gtf.e[]{gtf.e.a, gtf.e.d, gtf.e.a, gtf.e.j, gtf.e.g, gtf.e.j, gtf.e.g, gtf.e.d}
      ),
      f(
         new jb[]{jb.a, jb.b, jb.c, jb.d},
         0.6F,
         true,
         new gtf.e[]{gtf.e.g, gtf.e.d, gtf.e.g, gtf.e.j, gtf.e.a, gtf.e.j, gtf.e.a, gtf.e.d},
         new gtf.e[]{gtf.e.g, gtf.e.c, gtf.e.g, gtf.e.i, gtf.e.a, gtf.e.i, gtf.e.a, gtf.e.c},
         new gtf.e[]{gtf.e.h, gtf.e.c, gtf.e.h, gtf.e.i, gtf.e.b, gtf.e.i, gtf.e.b, gtf.e.c},
         new gtf.e[]{gtf.e.h, gtf.e.d, gtf.e.h, gtf.e.j, gtf.e.b, gtf.e.j, gtf.e.b, gtf.e.d}
      );
      ...
      final gtf.e[] k;
      final gtf.e[] l;
      private static final gtf.a[] m = ag.a(new gtf.a[6], $$0 -> {
         $$0[jb.a.d()] = a;
         $$0[jb.b.d()] = b;
         $$0[jb.c.d()] = c;
         $$0[jb.d.d()] = d;
      ...
      private a(final jb[] $$0, final float $$1, final boolean $$2, final gtf.e[] $$3, final gtf.e[] $$4, final gtf.e[] $$5, final gtf.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(diy $$0, ebe $$1, iv $$2, jb $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         ebe $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         ebe $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         ebe $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         ebe $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gtf.c[] k = ag.a(new gtf.c[6], $$0 -> {
         $$0[jb.a.d()] = a;
         $$0[jb.b.d()] = b;
         $$0[jb.c.d()] = c;
         $$0[jb.d.d()] = d;
   ...
   static class d {
      ...
      public float b(ebe $$0, diy $$1, iv $$2) {
         long $$3 = $$2.a();
         if (this.a) {
