public class gtf extends gtg<dzb> {
   ...
   public void a(dzb $$0, float $$1, fjj $$2, gqa $$3, int $$4, int $$5, feq $$6) {
      if ($$0.a() || $$0.c()) {
         float $$7 = $$0.a() ? $$0.a($$1) : $$0.b($$1);
         double $$8 = $$0.a() ? (double)$$0.i().ao() : 50.0;
         $$7 = azm.a($$7 * (float) Math.PI);
         int $$9 = azm.a((double)$$7 * $$8);
         int $$10 = $$0.a() ? cyb.c.d() : cyb.k.d();
         long $$11 = $$0.i().ae();
         gsi.a($$2, $$3, c, $$1, $$7, $$11, -$$9, $$9 * 2, $$10, 0.15F, 0.175F);
      }
