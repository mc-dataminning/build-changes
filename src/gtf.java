...
public abstract class gtf<T extends bvh, S extends gzk, M extends gcb<? super S>> extends gsd<T, S> implements gub<S, M> {
   private static final float a = 0.1F;
   protected M h;
   protected final hbm i;
   protected final List<gwt<S, M>> j = Lists.newArrayList();

   public gtf(gse.a $$0, M $$1, float $$2) {
      super($$0);
      this.i = $$0.b();
      this.h = $$1;
      this.f = $$2;
   ...
   protected final boolean a(gwt<S, M> $$0) {
      return this.j.add($$0);
   }
   ...
   @Nullable
   protected gmi a(S $$0, boolean $$1, boolean $$2, boolean $$3) {
      akv $$4 = this.b($$0);
      if ($$2) {
         return gmi.i($$4);
      } else if ($$1) {
         ...
         return $$3 ? gmi.s($$4) : null;
      }
   }

   public static int a(gzk $$0, float $$1) {
      return hei.a(hei.a($$1), hei.a($$0.am));
   }
