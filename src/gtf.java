...
public class gtf extends gse<bvh, gzk> {
   public gtf(gsf.a $$0) {
      super($$0);
   }

   public void a(gzk $$0, ffv $$1, glz $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvh $$0, gzk $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bvh $$0) {
      return false;
   }
}
