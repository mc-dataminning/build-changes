...
public class drv {
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(clt.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(clt.c($$0, $$1))) {
               return true;
            }
         }
   ...
   public static drv a(acp<cmm> $$0, @Nullable dyu $$1) {
      if ($$0 == cmm.h) {
         ...
         return new drv($$1, $$2, $$2);
      } else if ($$0 == cmm.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new drv($$1, $$3, $$3);
      } else {
