public class btj extends cgg {
   private static final akk<Integer> cc = ako.a(btj.class, akm.b);

   public btj(btc<? extends btj> $$0, dca $$1) {
      super($$0, $$1);
   }
   ...
   public static boolean a(btc<? extends btr> $$0, dcp $$1, btv $$2, iz $$3, azh $$4) {
      return $$3.v() <= $$1.z_() - 33 && $$1.b($$3, 0) == 0 && $$1.a_($$3).a(dfd.G);
   }
}
