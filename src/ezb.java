public class ezb extends ezy<cef> {
   ...
   protected void E() {
      ...
      this.C = new esp(this.i, $$0 + 62, $$1 + 24, 103, 12, tf.c("container.repair"));
      this.C.f(false);
      this.C.m(-1);
      this.C.n(-1);
      this.C.d(false);
   ...
   @Override
   public void d(erv $$0, int $$1, int $$2, float $$3) {
      this.C.a($$0, $$1, $$2, $$3);
   }
