...
public class ezb {
   ...
   public static final ezb.a bv;

   public static ezb.a a(int $$0, int $$1) {
      return $$0 == -1 ? ezb.b.b.a($$1) : ezb.b.a.a($$0);
   }

   public static ezb.a a(String $$0) {
      if (ezb.a.e.containsKey($$0)) {
         return ezb.a.e.get($$0);
      } else {
         for (ezb.b $$1 : ezb.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ezb.b b;
      private final int c;
      private final axy<wu> d;
      static final Map<String, ezb.a> e = Maps.newHashMap();

      a(String $$0, ezb.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new axy<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wu.b($$2.toUpperCase(Locale.ROOT)) : wu.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wu.b($$2) : wu.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ts.a().b($$1) ? wu.c($$1) : wu.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ezb.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wu> g;

      private static void a(ezb.b $$0, String $$1, int $$2) {
         ezb.a $$3 = new ezb.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, wu> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ezb.a a(int $$0) {
         return (ezb.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
