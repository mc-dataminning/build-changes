...
public class ezb extends eym implements fiu.a {
   private static final aey p = new aey("textures/gui/advancements/window.png");
   ...
   private static final tn w = tn.c("advancements.sad_label");
   private static final tn x = tn.c("advancements.empty");
   private static final tn y = tn.c("gui.advancements");
   private final fiu z;
   private final Map<af, eyx> A = Maps.newLinkedHashMap();
   @Nullable
   private eyx B;
   private boolean C;
   ...
   protected void aH_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         eyx $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(esh $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (eyx $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (eyx $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      eyx $$1 = eyx.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
