...
public abstract class cvc {
   ...
   private final jo<czk> n = jo.a();
   public final jo<cwz> k = jo.a();
   private final List<cvw> o = Lists.newArrayList();
   private czk p = czk.k;
   private final jo<czk> q = jo.a();
   ...
   private int v = -1;
   private int w;
   private final Set<cwz> x = Sets.newHashSet();
   private final List<cvq> y = Lists.newArrayList();
   @Nullable
   private cvr z;
   private boolean A;

   protected cvc(@Nullable cwl<?> $$0, int $$1) {
      this.u = $$0;
      this.l = $$1;
   }
   ...
   protected void b(btz $$0, int $$1, int $$2) {
      for (int $$3 = 0; $$3 < 3; $$3++) {
         for (int $$4 = 0; $$4 < 9; $$4++) {
            this.a(new cwz($$0, $$4 + ($$3 + 1) * 9, $$1 + $$4 * 18, $$2 + $$3 * 18));
         }
      }
   }
   ...
   protected static boolean a(cvp $$0, crj $$1, dmm $$2) {
   ...
   protected static void a(cvo $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.k.size(); $$0++) {
         czk $$1 = this.k.get($$0).g();
         Supplier<czk> $$2 = Suppliers.memoize($$1::v);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, czk $$1, Supplier<czk> $$2) {
      czk $$3 = this.n.get($$0);
      if (!czk.a($$3, $$1)) {
         czk $$4 = $$2.get();
         this.n.set($$0, $$4);
   ...
   private void b(int $$0, czk $$1, Supplier<czk> $$2) {
      if (!this.A) {
         czk $$3 = this.q.get($$0);
         if (!czk.a($$3, $$1)) {
            czk $$4 = $$2.get();
   ...
   public abstract czk b(crj var1, int var2);

   public void a(int $$0, int $$1) {
      if ($$0 >= 0 && $$0 < this.k.size()) {
         czk $$2 = this.k.get($$0).g();
         cxz.a($$2, $$1);
      }
   }

   public void a(int $$0, int $$1, cvn $$2, crj $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cvn $$2, crj $$3) {
      cri $$4 = $$3.gi();
      if ($$2 == cvn.f) {
         int $$5 = this.w;
         this.w = d($$1);
         ...
         this.f();
      } else if (($$2 == cvn.a || $$2 == cvn.b) && ($$1 == 0 || $$1 == 1)) {
         cvm $$16 = $$1 == 0 ? cvm.a : cvm.b;
         if ($$0 == -999) {
            if (!this.g().f()) {
               if ($$16 == cvm.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.f()) {
                  if (!$$21.f()) {
                     int $$22 = $$16 == cvm.a ? $$21.M() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.f()) {
                     int $$23 = $$16 == cvm.a ? $$20.M() : ($$20.M() + 1) / 2;
                     Optional<czk> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<czk> $$26 = $$19.a($$20.M(), $$21.k() - $$21.M(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.M());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cvn.d && $$3.fU() && this.g().f() && $$0 >= 0) {
         cwz $$32 = this.k.get($$0);
         if ($$32.h()) {
            czk $$33 = $$32.g();
            this.b($$33.c($$33.k()));
         }
      } else if ($$2 == cvn.e && this.g().f() && $$0 >= 0) {
         cwz $$34 = this.k.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().M();
         if (!$$3.gm()) {
            return;
         ...
         czk $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
         $$3.g($$36);
         if ($$1 == 1) {
            while (!$$36.f() && czk.b($$34.g(), $$36)) {
               if (!$$3.gm()) {
                  return;
               }
         ...
         if (!$$38.f() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.k.size() && $$38.M() < $$38.k(); $$42 += $$40) {
                  cwz $$43 = this.k.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     czk $$44 = $$43.g();
                     if ($$41 != 0 || $$44.M() != $$44.k()) {
                        czk $$45 = $$43.b($$44.M(), $$38.k() - $$38.M(), $$3);
                        $$38.g($$45.M());
                     }
                  }
               }
   ...
   private boolean a(crj $$0, cvm $$1, cwz $$2, czk $$3, czk $$4) {
      cut $$5 = $$0.dU().K();
   ...
   private static void a(crj $$0, czk $$1) {
      boolean $$2;
      boolean var10000;
      label27: {
         $$2 = $$0.dP() && $$0.dQ() != bwi.d.e;
   ...
   public void a(int $$0, int $$1, czk $$2) {
      this.b($$0).f($$2);
      this.t = $$1;
   }

   public void a(int $$0, List<czk> $$1, czk $$2) {
   ...
   public abstract boolean b(crj var1);

   protected boolean a(czk $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, crj $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cwz $$0, czk $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && czk.c($$1, $$0.g()) ? $$0.g().M() + ($$2 ? 0 : $$1.M()) <= $$1.k() : $$3;
   }

   public static int a(Set<cwz> $$0, int $$1, czk $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dxm $$0) {
