...
public class cvc extends cuu {
   ...
   public void b() {
      if (this.c() instanceof aru $$0) {
         this.a.be();
         iw var11 = this.a.j();
         ebg $$3 = this.c().a_(var11);
         boolean $$4 = dmt.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(dng.hI)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dth.d));
            }
         } else {
            this.a.e($$0);
         }
         ...
         if ($$5 * $$5 + $$6 * $$6 > 0.001) {
            this.b((float)(azq.d($$6, $$5) * 180.0 / Math.PI));
            if (this.a.m()) {
               this.b(this.k() + 180.0F);
            }
         }

         double $$7 = (double)azq.h(this.k() - this.a.N);
         if ($$7 < -170.0 || $$7 >= 170.0) {
            this.b(this.k() + 180.0F);
            this.a.b(!this.a.m());
         }
   ...
   public void a(aru $$0) {
      ...
      $$10 = this.e();
      Pair<kb, kb> $$12 = cum.a($$11);
      kb $$13 = (kb)$$12.getFirst();
      kb $$14 = (kb)$$12.getSecond();
      ...
      $$10 = new ffs($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bwv $$20 = this.a.cZ();
      ffs $$22;
      if (this.a.cZ() instanceof arv $$21) {
         $$22 = $$21.ag();
      } else {
         $$22 = ffs.c;
      }

      if ($$20 instanceof crz && $$22.h() > 0.0) {
         ffs $$24 = $$22.d();
         double $$25 = this.e().j();
         if ($$24.h() > 0.0 && $$25 < 0.01) {
      ...
      $$10 = this.e();
      this.a.a(bya.a, new ffs(azq.a($$36 * $$10.d, -$$37, $$37), 0.0, azq.a($$36 * $$10.f, -$$37, $$37)));
      if ($$13.v() != 0 && azq.a(this.a.dA()) - $$1.u() == $$13.u() && azq.a(this.a.dG()) - $$1.w() == $$13.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$13.v(), this.a.dG());
      } else if ($$14.v() != 0 && azq.a(this.a.dA()) - $$1.u() == $$14.u() && azq.a(this.a.dG()) - $$1.w() == $$14.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$14.v(), this.a.dG());
      }

      this.a(this.a.a(this.e()));
      ffs $$38 = this.d(this.a.dA(), this.a.dC(), this.a.dG());
      if ($$38 != null && $$6 != null) {
      ...
      int $$42 = azq.a(this.a.dA());
      int $$43 = azq.a(this.a.dG());
      if ($$42 != $$1.u() || $$43 != $$1.w()) {
         ffs $$44 = this.e();
         double $$45 = $$44.i();
   ...
   @Nullable
   public ffs a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = azq.a($$0);
      int $$5 = azq.a($$1);
      int $$6 = azq.a($$2);
      if (this.c().a_(new iw($$4, $$5 - 1, $$6)).a(axg.P)) {
         $$5--;
      }

      ebg $$7 = this.c().a_(new iw($$4, $$5, $$6));
      if (dmt.h($$7)) {
         eck $$8 = $$7.c(((dmt)$$7.b()).c());
         $$1 = (double)$$5;
         if ($$8.b()) {
         ...
         Pair<kb, kb> $$9 = cum.a($$8);
         kb $$10 = (kb)$$9.getFirst();
         kb $$11 = (kb)$$9.getSecond();
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && azq.a($$0) - $$4 == $$10.u() && azq.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && azq.a($$0) - $$4 == $$11.u() && azq.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   public ffs d(double $$0, double $$1, double $$2) {
      ...
      int $$4 = azq.a($$1);
      int $$5 = azq.a($$2);
      if (this.c().a_(new iw($$3, $$4 - 1, $$5)).a(axg.P)) {
         $$4--;
      }

      ebg $$6 = this.c().a_(new iw($$3, $$4, $$5));
      if (dmt.h($$6)) {
         eck $$7 = $$6.c(((dmt)$$6.b()).c());
         Pair<kb, kb> $$8 = cum.a($$7);
         kb $$9 = (kb)$$8.getFirst();
         kb $$10 = (kb)$$8.getSecond();
   ...
   @Override
   public boolean d() {
      ffn $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.y() && this.e().j() >= 0.01) {
         ...
         for (bwv $$3 : this.c().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bG() && $$3 instanceof cum) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public ffs c(ffs $$0) {
      return !Double.isNaN($$0.d) && !Double.isNaN($$0.e) && !Double.isNaN($$0.f) ? new ffs(azq.a($$0.d, -0.4, 0.4), $$0.e, azq.a($$0.f, -0.4, 0.4)) : ffs.c;
   }
