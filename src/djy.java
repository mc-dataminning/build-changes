...
public class djy<T> implements dka<T> {
   ...
   private djy(il<T> $$0, int $$1, dkb<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private djy(il<T> $$0, T[] $$1, dkb<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dka<T> c() {
      return new djy<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
