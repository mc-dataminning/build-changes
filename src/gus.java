public class gus implements gun<dyh> {
   private final gzg a;
   ...
   public void a(dyh $$0, float $$1, flo $$2, gsa $$3, int $$4, int $$5, ffq $$6) {
      if ($$0.i() != null) {
         int $$7 = $$0.m().c(ebu.by);
         if ($$7 > 0) {
            jb $$8 = $$0.c();
            if ($$8 != null) {
               ...
               if (!$$9.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$12 = grv.a($$0.i(), $$0.m(), $$0.aB_().a($$8));
                  this.a.a($$9, czw.i, $$12, hkq.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
