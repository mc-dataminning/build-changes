...
public class aje implements AutoCloseable {
   ...
   private aje(URL $$0, aje.c $$1, URL $$2, aje.b $$3, URL $$4, aje.b $$5, String $$6, aje.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static aje a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            ...
            URI $$2 = new URI(aor.i($$1, "apiServer"));
            String $$3 = aor.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = aor.a($$1, "ruleId", 1);
   ...
   void a(GameProfile $$0, URL $$1, aje.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<aiu> a(GameProfile $$0, String $$1, aje.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(aiu.a) : CompletableFuture.supplyAsync(() -> {
   ...
   private sz a(String $$0, JsonArray $$1, aje.a $$2) {
      if ($$1.isEmpty()) {
         return sz.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aje.e($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      aje.a a = ($$0, $$1) -> false;
      aje.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aje.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aje.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ajd {
      ...
      public CompletableFuture<List<aiu>> a(List<String> $$0) {
         List<CompletableFuture<aiu>> $$1 = $$0.stream().map($$0x -> aje.this.a(this.c, $$0x, aje.this.l, this.d)).collect(ImmutableList.toImmutableList());
