...
public class aje {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(uv.c("commands.op.failed"));
   ...
   private static int a(du $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if (!$$2.f($$4)) {
            $$2.a($$4);
            $$3++;
            $$0.a(() -> uv.a("commands.op.success", $$1.iterator().next().getName()), true);
         }
      }
