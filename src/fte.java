...
public class fte extends fst {
   private static final fui d = new fui(alg.b("widget/text_field"), alg.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayy> D = ($$0x, $$1x) -> ayy.forward($$0x, xv.a);
   @Nullable
   private wy E;
   private long F = ag.c();

   public fte(fsf $$0, int $$1, int $$2, wy $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fte(fsf $$0, int $$1, int $$2, int $$3, int $$4, wy $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fte(fsf $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fte $$5, wy $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azm.a($$0) - this.F();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fyn.t());
   }
   ...
   public void b(fsh $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            alg $$4 = d.a(this.E(), this.aJ_());
            $$0.a(gqx::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gqx.M(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   private void a(fsh $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$1 < $$3) {
         int $$5 = $$1;
         $$1 = $$3;
         $$3 = $$5;
