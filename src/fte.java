public class fte extends fuk {
   ...
   public fte(Runnable $$0, fte.a $$1, wo $$2, wo $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, a, $$4);
   }

   public fte(Runnable $$0, fte.a $$1, wo $$2, wo $$3, wo $$4, boolean $$5) {
      super($$2);
      this.u = $$0;
      this.b = $$1;
      this.v = $$3;
   ...
   protected void aR_() {
      ...
      int $$0 = (this.x.a() + 1) * 9;
      this.y = fou.a(wo.c("selectWorld.backupEraseCache"), this.p).a(this.n / 2 - 155 + 80, 76 + $$0).a();
      if (this.w) {
         this.c(this.y);
      }
      ...
      this.c(fos.a(wn.e, $$0x -> this.u.run()).a(this.n / 2 - 155 + 80, 124 + $$0, 150, 20).a());
   }
