...
public class dig {
   ...
   private boolean a(id $$0) {
      return dbw.a(this.a, $$0) || dbw.a(this.a, $$0.c()) || dbw.a(this.a, $$0.d());
   }
   ...
   private dig b(id $$0) {
      dpi $$2 = this.a.a_($$0);
      if (dbw.g($$2)) {
         return new dig(this.a, $$0, $$2);
      } else {
         id $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (dbw.g($$2)) {
            return new dig(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return dbw.g($$2) ? new dig(this.a, $$1, $$2) : null;
         }
      }
   }

   private boolean a(dig $$0) {
      return this.c($$0.b);
   }

   private boolean c(id $$0) {
   ...
   private boolean b(dig $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dig $$0) {
      this.f.add($$0.b);
      id $$1 = this.b.e();
      id $$2 = this.b.f();
      id $$3 = this.b.g();
   ...
   public dig a(boolean $$0, boolean $$1, dqm $$2) {
      id $$3 = this.b.e();
      id $$4 = this.b.f();
      id $$5 = this.b.g();
      id $$6 = this.b.h();
