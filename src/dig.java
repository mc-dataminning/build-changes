...
public interface dig extends djc {
   int g = 16;
   ...
   default fem a(dii $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         eah $$2 = this.a_($$1);
         feq $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new fem($$0x.a(), ja.a($$3.d, $$3.e, $$3.f), iu.a((jo)$$0x.a()), false) : null;
      }, $$0x -> {
         feq $$1 = $$0x.b().d($$0x.a());
         return fem.a($$0x.a(), ja.a($$1.d, $$1.e, $$1.f), iu.a((jo)$$0x.a()));
      });
   }
   ...
   @Nullable
   default fem a(feq $$0, feq $$1, iu $$2, ffk $$3, eah $$4) {
      fem $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         fem $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(ffk $$0, Supplier<ffk> $$1) {
      if (!$$0.c()) {
         return $$0.c(ja.a.b);
      } else {
   ...
   static <T, C> T a(feq $$0, feq $$1, C $$2, BiFunction<C, iu, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<iu> a(feq $$0, feq $$1, fel $$2) {
      feq $$3 = $$1.d($$0);
   ...
   private static void a(Set<iu> $$0, feq $$1, feq $$2, fel $$3) {
      feq $$4 = $$2.d($$1);
      int $$5 = azm.a($$1.d);
      int $$6 = azm.a($$1.e);
      int $$7 = azm.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<feq> $$18 = fel.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            feq $$19 = $$18.get();
