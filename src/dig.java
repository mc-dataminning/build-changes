...
public class dig {
   ...
   public static dia a(akq $$0, buf $$1, cpc $$2, qw $$3) {
      ...
      dhj $$11 = $$0.k();
      eab $$12 = $$11.p();
      hq<cqt> $$13 = $$0.G_().d(jc.ap);
      Codec<dhz<he<cqt>>> $$14 = a($$13);
      boolean $$15 = false;
      ...
      for (int $$16 = 0; $$16 < $$7.size(); $$16++) {
         ...
         if ($$19 >= 0 && $$19 < $$9.length) {
            ...
            dhz<he<cqt>> $$22;
            if ($$17.b("biomes", 10)) {
               $$22 = (dhz<he<cqt>>)$$14.parse(ri.a, $$17.p("biomes")).promotePartial($$2x -> a($$2, $$18, $$2x)).getOrThrow(false, i::error);
            } else {
         ...
         if ($$26 || $$27) {
            ...
            if ($$26) {
               $$12.a(cqe.b, hw.a($$2, $$18), new dhl($$17.m("BlockLight")));
            }

            if ($$27) {
               $$12.a(cqe.a, hw.a($$2, $$18), new dhl($$17.m("SkyLight")));
            }
         }
      }
      ...
      dhf $$34;
      if ($$29 == dhk.a.b) {
         eiu<csv> $$32 = eiu.a($$3.c("block_ticks", 10), $$0x -> jb.f.b(aew.a($$0x)), $$2);
         eiu<eal> $$33 = eiu.a($$3.c("fluid_ticks", 10), $$0x -> jb.d.b(aew.a($$0x)), $$2);
         $$34 = new dhq($$0.C(), $$2, $$5, $$32, $$33, $$28, $$9, a($$0, $$3), $$30);
      } else {
         eix<csv> $$35 = eix.a($$3.c("block_ticks", 10), $$0x -> jb.f.b(aew.a($$0x)), $$2);
         eix<eal> $$36 = eix.a($$3.c("fluid_ticks", 10), $$0x -> jb.d.b(aew.a($$0x)), $$2);
   ...
   private static Codec<dhz<he<cqt>>> a(hq<cqt> $$0) {
      return dhy.b($$0.t(), $$0.r(), dhy.d.e, $$0.f(cra.b));
   }

   public static qw a(akq $$0, dhf $$1) {
      cpc $$2 = $$1.f();
      qw $$3 = rj.g(new qw());
      $$3.a("xPos", $$2.e);
      $$3.a("yPos", $$1.al());
      ...
      rc $$8 = new rc();
      eab $$9 = $$0.k().a();
      hq<cqt> $$10 = $$0.G_().d(jc.ap);
      Codec<dhz<he<cqt>>> $$11 = a($$10);
      boolean $$12 = $$1.v();

      for (int $$13 = $$9.d(); $$13 < $$9.e(); $$13++) {
         int $$14 = $$1.f($$13);
         boolean $$15 = $$14 >= 0 && $$14 < $$7.length;
         dhl $$16 = $$9.a(cqe.b).a(hw.a($$2, $$13));
         dhl $$17 = $$9.a(cqe.a).a(hw.a($$2, $$13));
   ...
   private static qw a(dvy $$0, cpc $$1, Map<dvi, dvq> $$2, Map<dvi, LongSet> $$3) {
      qw $$4 = new qw();
      qw $$5 = new qw();
      hq<dvi> $$6 = $$0.b().d(jc.az);
   ...
   private static Map<dvi, dvq> a(dvy $$0, qw $$1, long $$2) {
      Map<dvi, dvq> $$3 = Maps.newHashMap();
      hq<dvi> $$4 = $$0.b().d(jc.az);
      qw $$5 = $$1.p("starts");
   ...
   private static Map<dvi, LongSet> a(hr $$0, cpc $$1, qw $$2) {
