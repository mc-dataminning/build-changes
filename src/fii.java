...
public abstract class fii<E extends fii.a<E>> extends fif {
   protected static final int b = 6;
   private static final akt a = new akt("widget/scroller");
   private static final akt m = new akt("widget/scroller_background");
   private static final akt n = new akt("textures/gui/menu_list_background.png");
   private static final akt o = new akt("textures/gui/inworld_menu_list_background.png");
   protected final fgj c;
   protected final int d;
   private final List<E> p = new fii.b();
   ...
   public fii(fgj $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xd.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = aym.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aE_().get($$7) : null;
   }

   public void a(int $$0, fma $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(fia $$0) {
      RenderSystem.enableBlend();
      akt $$1 = this.c.r == null ? fon.h : fon.j;
      akt $$2 = this.c.r == null ? fon.i : fon.k;
   ...
   public void a(double $$0) {
      this.q = aym.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = aym.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fmr $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fmr $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fmh.a t() {
      if (this.aI_()) {
         ...
         return this.v != null ? fmh.a.b : fmh.a.a;
      }
   }
   ...
   protected void a(fmj $$0, E $$1) {
      List<E> $$2 = this.aE_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fmi.b, xe.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fii.a<E>> implements fkj {
      @Deprecated
      fii<E> a;
      ...
      public abstract void a(fia var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
