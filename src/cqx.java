...
public class cqx extends crj<cqm> {
   ...
   private static final btd[] F = new btd[]{btd.f, btd.e, btd.d, btd.c};
   private final cqm G = new cry(this, 2, 2);
   private final crm H = new crm();
   public final boolean D;
   private final cmz I;

   public cqx(cmy $$0, boolean $$1, final cmz $$2) {
      super(null, 0);
      this.D = $$1;
      this.I = $$2;
      this.a(new crn($$0.l, this.G, this.H, 0, 154, 28));

      for (int $$3 = 0; $$3 < 2; $$3++) {
         for (int $$4 = 0; $$4 < 2; $$4++) {
            this.a(new crr(this.G, $$4 + $$3 * 2, 98 + $$4 * 18, 18 + $$3 * 18));
         }
      }

      for (int $$5 = 0; $$5 < 4; $$5++) {
         final btd $$6 = F[$$5];
         this.a(new crr($$0, 39 - $$5, 8, 8 + $$5 * 18) {
            @Override
            ...
            public boolean a(cmz $$0) {
               cur $$1 = this.g();
               return !$$1.e() && !$$0.f() && dad.f($$1) ? false : super.a($$0);
            }

            @Override
            public Pair<alf, alf> c() {
               return Pair.of(cqx.x, cqx.E[$$6.b()]);
            }
         });
      }
      ...
      for (int $$7 = 0; $$7 < 3; $$7++) {
         for (int $$8 = 0; $$8 < 9; $$8++) {
            this.a(new crr($$0, $$8 + ($$7 + 1) * 9, 8 + $$8 * 18, 84 + $$7 * 18));
         }
      }

      for (int $$9 = 0; $$9 < 9; $$9++) {
         this.a(new crr($$0, $$9, 8 + $$9 * 18, 142));
      }

      this.a(new crr($$0, 40, 77, 62) {
         @Override
         public void a(cur $$0, cur $$1) {
            cqx.a($$2, btd.b, $$0, $$1);
            super.a($$0, $$1);
         ...
         @Override
         public Pair<alf, alf> c() {
            return Pair.of(cqx.x, cqx.C);
         }
      });
   }

   static void a(cmz $$0, btd $$1, cur $$2, cur $$3) {
      $$0.a($$1, $$3, $$2);
   }
   ...
   @Override
   public void a(bqp $$0) {
      cqn.a(this, this.I.dP(), this.I, this.G, this.H);
   }
   ...
   public cur a(cmz $$0, int $$1) {
      ...
      if ($$3.h()) {
         ...
         } else if ($$5.a() == btd.a.b && !this.i.get(8 - $$5.b()).h()) {
            int $$6 = 8 - $$5.b();
            if (!this.a($$4, $$6, $$6 + 1, false)) {
               return cur.l;
            }
         } else if ($$5 == btd.b && !this.i.get(45).h()) {
