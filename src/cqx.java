...
public class cqx extends crb {
   private static final Logger a = LogUtils.getLogger();
   private final azs b = azs.a();
   private boolean c;
   private int d;
   private static final int e = 10;
   private static final akg<Integer> f = akk.a(cqx.class, aki.b);
   private static final akg<Boolean> g = akk.a(cqx.class, aki.k);
   private int h;
   private int i;
   private int j;
   private int k;
   ...
   @Nullable
   private bvs n;
   private cqx.a o = cqx.a.a;
   private final int p;
   private final int q;

   private cqx(bwb<? extends cqx> $$0, dhp $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.p = Math.max(0, $$2);
      this.q = Math.max(0, $$3);
   }

   public cqx(bwb<? extends cqx> $$0, dhp $$1) {
      this($$0, $$1, 0, 0);
   }

   public cqx(cqi $$0, dhp $$1, int $$2, int $$3) {
      this(bwb.bS, $$1, $$2, $$3);
      this.c($$0);
      float $$4 = $$0.dN();
      float $$5 = $$0.dL();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      fcu $$13 = new fcu((double)(-$$7), (double)azk.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.g();
   ...
   public void h() {
      ...
      if ($$0 == null) {
         ...
         this.aK();
         this.A();
         if (this.o == cqx.a.a && (this.aJ() || this.P)) {
            this.i(fcu.c);
         }
   ...
   private boolean a(cqi $$0) {
      cxy $$1 = $$0.fa();
      cxy $$2 = $$0.fb();
      boolean $$3 = $$1.a(cyc.rW);
      boolean $$4 = $$2.a(cyc.rW);
   ...
   private void m() {
      fcs $$0 = crd.a(this, this::b);
      this.b($$0);
   }

   @Override
   protected boolean b(bvs $$0) {
      return super.b($$0) || $$0.bK() && $$0 instanceof cmn;
   }
   ...
   private void a(jj $$0) {
      ...
      if (this.i > 0) {
         ...
         if (this.k > 0) {
            ...
            dym $$10 = $$1.a_(jj.a($$7, $$8 - 1.0, $$9));
            if ($$10.a(dkw.J)) {
               if (this.ae.i() < 0.15F) {
                  $$1.a(lv.d, $$7, $$8 - 0.1F, $$9, 1, (double)$$5, 0.1, (double)$$6, 0.0);
               }

               float $$11 = $$5 * 0.04F;
               float $$12 = $$6 * 0.04F;
               $$1.a(lv.E, $$7, $$8, $$9, 0, (double)$$12, 0.01, (double)(-$$11), 1.0);
               $$1.a(lv.E, $$7, $$8, $$9, 0, (double)(-$$12), 0.01, (double)$$11, 1.0);
            }
         } else {
            this.a(awk.jx, 0.25F, 1.0F + (this.ae.i() - this.ae.i()) * 0.4F);
            double $$13 = this.dC() + 0.5;
            $$1.a(lv.d, this.dA(), $$13, this.dG(), (int)(1.0F + this.dq() * 20.0F), (double)this.dq(), 0.0, (double)this.dq(), 0.2F);
            $$1.a(lv.E, this.dA(), $$13, this.dG(), (int)(1.0F + this.dq() * 20.0F), (double)this.dq(), 0.0, (double)this.dq(), 0.2F);
         ...
         if (this.ae.i() < $$14) {
            ...
            dym $$20 = $$1.a_(jj.a($$17, $$18 - 1.0, $$19));
            if ($$20.a(dkw.J)) {
               $$1.a(lv.ap, $$17, $$18, $$19, 2 + this.ae.a(2), 0.1F, 0.0, 0.1F, 0.0);
            }
         }
   ...
   private boolean b(jj $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cqx.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case a:
               if ($$1 == cqx.b.c) {
                  return false;
   ...
   private cqx.b a(jj $$0, jj $$1) {
      return jj.d($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cqx.b.c).orElse(cqx.b.c);
   }

   private cqx.b c(jj $$0) {
      dym $$1 = this.dV().a_($$0);
      if (!$$1.l() && !$$1.a(dkw.fB)) {
         eut $$2 = $$1.y();
         return $$2.a(axf.a) && $$2.b() && $$1.g(this.dV(), $$0).c() ? cqx.b.b : cqx.b.c;
      } else {
         return cqx.b.a;
      }
   }
   ...
   public int a(cxy $$0) {
      ...
      if (!this.dV().C && $$1 != null && !this.a($$1)) {
         ...
         if (this.n != null) {
            this.d(this.n);
            ap.E.a((aro)$$1, $$0, this, Collections.emptyList());
            this.dV().a(this, (byte)31);
            $$2 = this.n instanceof cmn ? 3 : 5;
         } else if (this.i > 0) {
            exo $$3 = new exo.a((arn)this.dV()).a(faf.f, this.dt()).a(faf.i, $$0).a(faf.a, this).a((float)this.p + $$1.eg()).a(fae.f);
            exq $$4 = this.dV().p().bc().b(exh.am);
            List<cxy> $$5 = $$4.a($$3);
            ap.E.a((aro)$$1, $$0, this, $$5);

            for (cxy $$6 : $$5) {
               cmn $$7 = new cmn(this.dV(), this.dA(), this.dC(), this.dG(), $$6);
               ...
               this.dV().b($$7);
               $$1.dV().b(new bwg($$1.dV(), $$1.dA(), $$1.dC() + 0.5, $$1.dG() + 0.5, this.ae.a(6) + 1));
               if ($$6.a(axi.aT)) {
                  $$1.a(awu.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dV().C && this.n instanceof cqi $$1 && $$1.gg()) {
         this.d(this.n);
      }
   ...
   protected void d(bvs $$0) {
      bvs $$1 = this.q();
      if ($$1 != null) {
         fcu $$2 = new fcu($$1.dA() - this.dA(), $$1.dC() - this.dC(), $$1.dG() - this.dG()).c(0.1);
         $$0.i($$0.dy().e($$2));
      }
   }
   ...
   @Nullable
   public cqi g() {
      return this.q() instanceof cqi $$1 ? $$1 : null;
   }
   ...
   public zc<abr> a(arl $$0) {
      bvs $$1 = this.q();
      return new abs(this, $$0, $$1 == null ? this.ar() : $$1.ar());
   }
