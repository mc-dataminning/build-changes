...
public class egc extends egh {
   ...
   public List<eep.a> a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, int $$3, iz $$4, edz $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<egc.a> $$13 = Lists.newArrayList();
      $$13.add(new egc.a($$4.b($$12), $$11));
      ...
      List<eep.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, iz $$3, iz $$4, boolean $$5, edz $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ...
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlm.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, int $$3, iz $$4, List<egc.a> $$5, edz $$6) {
      for (egc.a $$7 : $$5) {
         int $$8 = $$7.a();
