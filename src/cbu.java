...
public class cbu {
   ...
   public static bzx<byn> a(float $$0) {
      ...
      return cdj.a(
         (Function<cdj.b<byn>, ? extends App<cdj.c<byn>, cdm<byn>>>)($$3 -> $$3.group($$3.c(chh.n), $$3.c(chh.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.ae() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cjh $$7 = $$4x.A();
                        Optional<iw> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cjl.n), $$5.dv(), 48, cjh.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dv()) <= 4.0)) {
                           ...
                           Set<Pair<jg<cjk>, iw>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cjl.n), $$10, $$5.dv(), 48, cjh.b.c).collect(Collectors.toSet());
                           eyo $$12 = bzp.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              iw $$13 = $$12.l();
                              Optional<jg<cjk>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new chk($$13, $$0, 1));
                                 agx.c($$4x, $$13);
                              }
