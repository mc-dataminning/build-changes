...
public abstract class cbu extends bjg {
   ...
   private static final aef<Float> e = aei.a(cbu.class, aeh.d);
   private static final aef<Integer> f = aei.a(cbu.class, aeh.b);
   protected static final aef<Byte> bM = aei.a(cbu.class, aeh.a);
   protected static final aef<Byte> bN = aei.a(cbu.class, aeh.a);
   protected static final aef<qx> bO = aei.a(cbu.class, aeh.s);
   protected static final aef<qx> bP = aei.a(cbu.class, aeh.s);
   private long cm;
   ...
   public boolean a(cpv $$0, gw $$1, cps $$2) {
      if (!$$2.f()) {
         ...
         cjf $$3 = this.eS();
         return $$3.b() || !$$3.b($$0.G_().d(je.e), new dfn($$0, $$1, false));
      }
   }
   ...
   public void l() {
      ...
      int $$0 = 29999999;
      double $$1 = arx.a(this.dq(), -2.9999999E7, 2.9999999E7);
      double $$2 = arx.a(this.dw(), -2.9999999E7, 2.9999999E7);
   ...
   protected boolean fK() {
      this.ce = this.a(apy.a);
      return this.ce;
   }

   private void s() {
      cjf $$0 = this.c(biv.f);
      if ($$0.a(cji.nC) && !this.a(apy.a)) {
   ...
   public void b_() {
      ...
      this.c(this.gi());
      this.c(this.gj());
      if (!this.dL().B && (this.ab > 0.5F || this.aY()) || this.cp.b || this.fC() || this.aA) {
         this.gf();
      }
   }

   private void c(@Nullable qx $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dL().z.a(200) == 0) {
         String $$1 = $$0.l("id");
         biu.a($$1).filter($$0x -> $$0x == biu.at).ifPresent($$0x -> {
            if (!bvh.a(this.dL(), this)) {
               this.dL().a(null, this.dq(), this.ds(), this.dw(), bvh.a(this.dL(), this.dL().z), this.db(), 1.0F, bvh.a(this.dL().z));
            }
         });
      }
   }
   ...
   public void a(bho $$0) {
      ...
      if ($$0 != null) {
         this.o(
            (double)(-arx.b((this.eD() + this.dB()) * (float) (Math.PI / 180.0)) * 0.1F),
            0.1F,
            (double)(-arx.a((this.eD() + this.dB()) * (float) (Math.PI / 180.0)) * 0.1F)
         );
      } else {
         this.o(0.0, 0.1, 0.0);
      }
   ...
   public byn a(cjf $$0, boolean $$1, boolean $$2) {
      if ($$0.b()) {
         ...
         if ($$1) {
            ...
            $$4.o((double)(-arx.a($$6) * $$5), 0.2F, (double)(arx.b($$6) * $$5));
         } else {
            float $$7 = 0.3F;
            float $$8 = arx.a(this.dD() * (float) (Math.PI / 180.0));
            float $$9 = arx.b(this.dD() * (float) (Math.PI / 180.0));
   ...
   public void a(qx $$0) {
      ...
      if ($$0.b("LastDeathLocation", 10)) {
         this.a(hf.a.parse(ri.a, $$0.c("LastDeathLocation")).resultOrPartial(b::error));
      }
   }
   ...
   public void b(qx $$0) {
      super.b($$0);
      rj.g($$0);
      $$0.a("Inventory", this.cn.a(new rd()));
      ...
      this.gq().flatMap($$0x -> hf.a.encodeStart(ri.a, $$0x).resultOrPartial(b::error)).ifPresent($$1 -> $$0.a("LastDeathLocation", $$1));
   }
   ...
   public boolean b(bho $$0) {
      if (super.b($$0)) {
         ...
         return $$0.a(apv.o) ? !this.dL().X().b(cpr.F) : false;
      }
   }
   ...
   protected void f(bho $$0, float $$1) {
      if (!this.b($$0)) {
         ...
         if ($$3 > 0.0F && $$3 < 3.4028235E37F) {
            this.a(apo.L, Math.round($$3 * 10.0F));
         }
         ...
         if (var7 != 0.0F) {
            ...
            if (var7 < 3.4028235E37F) {
               this.a(apo.J, Math.round(var7 * 10.0F));
            }
   ...
   private boolean y() {
      return this.aB() || this.ab < this.dF() && !this.dL().a(this, this.cH().d(0.0, (double)(this.ab - this.dF()), 0.0));
   }
      ...
      if ($$0.cq()) {
         if (!$$0.u(this)) {
            ...
            if ($$1 > 0.0F || $$2 > 0.0F) {
               ...
               $$7 += cnq.c(this);
               if (this.bY() && $$5) {
                  this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.sq, this.db(), 1.0F, 1.0F);
                  $$7++;
                  $$6 = true;
               }

               boolean $$8 = $$5 && this.ab > 0.0F && !this.aB() && !this.c_() && !this.aY() && !this.a(bif.o) && !this.bO() && $$0 instanceof bjg;
               $$8 = $$8 && !this.bY();
               if ($$8) {
                  $$1 *= 1.5F;
               }
               ...
               if ($$5 && !$$8 && !$$6 && this.aB() && $$10 < (double)this.fe()) {
                  cjf $$11 = this.b(bgx.a);
               ...
               if ($$16) {
                  if ($$7 > 0) {
                     if ($$0 instanceof bjg) {
                        ((bjg)$$0)
                           .q(
                              (double)((float)$$7 * 0.5F),
                              (double)arx.a(this.dB() * (float) (Math.PI / 180.0)),
                              (double)(-arx.b(this.dB() * (float) (Math.PI / 180.0)))
                           );
                     } else {
                        $$0.j(
                           (double)(-arx.a(this.dB() * (float) (Math.PI / 180.0)) * (float)$$7 * 0.5F),
                           0.1,
                           (double)(arx.b(this.dB() * (float) (Math.PI / 180.0)) * (float)$$7 * 0.5F)
                        );
                     }
                  ...
                  if ($$9) {
                     ...
                     for (bjg $$19 : this.dL().a(bjg.class, $$0.cH().c(1.0, 0.25, 1.0))) {
                        if ($$19 != this && $$19 != $$0 && !this.s($$19) && (!($$19 instanceof byd) || !((byd)$$19).y()) && this.f($$19) < 9.0) {
                           $$19.q(0.4F, (double)arx.a(this.dB() * (float) (Math.PI / 180.0)), (double)(-arx.b(this.dB() * (float) (Math.PI / 180.0))));
                           $$19.a(this.dM().a(this), $$17);
                        }
                     }

                     this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.st, this.db(), 1.0F, 1.0F);
                     this.fO();
                  }

                  if ($$0 instanceof aks && $$0.T) {
                     ((aks)$$0).c.b(new aaa($$0));
                     $$0.T = false;
                     $$0.f($$15);
                  }
                  ...
                  if ($$8) {
                     this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.sp, this.db(), 1.0F, 1.0F);
                     this.a($$0);
                  }

                  if (!$$8 && !$$9) {
                     if ($$5) {
                        this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.ss, this.db(), 1.0F, 1.0F);
                     } else {
                        this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.su, this.db(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  if ($$0 instanceof bjg) {
                     ...
                     this.a(apo.G, Math.round($$22 * 10.0F));
                     if ($$14 > 0) {
                        $$0.g($$14 * 4);
                     }

                     if (this.dL() instanceof akr && $$22 > 2.0F) {
                        int $$23 = (int)((double)$$22 * 0.5);
                        ((akr)this.dL()).a(ix.h, $$0.dq(), $$0.e(0.5), $$0.dw(), $$23, 0.1, 0.0, 0.1, 0.2);
                     }
                  }

                  this.A(0.1F);
               } else {
                  this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.sr, this.db(), 1.0F, 1.0F);
                  if ($$13) {
                     $$0.az();
                  }
               }
   ...
   public void fO() {
      double $$0 = (double)(-arx.a(this.dB() * (float) (Math.PI / 180.0)));
      double $$1 = (double)arx.b(this.dB() * (float) (Math.PI / 180.0));
      if (this.dL() instanceof akr) {
         ((akr)this.dL()).a(ix.ad, this.dq() + $$0, this.e(0.5), this.dw() + $$1, 0, $$0, 0.0, $$1, 0.0);
      }
   }
   ...
   public static Optional<ehn> a(akr $$0, gw $$1, float $$2, boolean $$3, boolean $$4) {
      dfj $$5 = $$0.a_($$1);
      csv $$6 = $$5.b();
   ...
   public void r(double $$0, double $$1, double $$2) {
      if (!this.bO()) {
         if (this.bZ()) {
            ...
            if ($$1 > 0.0) {
               this.a(apo.u, (int)Math.round($$1 * 100.0));
            }
         } else if (this.aB()) {
   ...
   public boolean a(float $$0, float $$1, bho $$2) {
      if (this.cp.c) {
         ...
         if ($$0 >= 2.0F) {
            this.a(apo.t, (int)Math.round((double)$$0 * 100.0));
         }
   ...
   public boolean fW() {
      if (!this.aB() && !this.fv() && !this.aY() && !this.a(bif.y)) {
         cjf $$0 = this.c(biv.e);
   ...
   @Override
   public bjg.a eF() {
      return new bjg.a(ape.sF, ape.sv);
   }
   ...
   public void d(int $$0) {
      ...
      this.cg = arx.a(this.cg + $$0, 0, Integer.MAX_VALUE);
   ...
   public void c(int $$0) {
      ...
      if ($$0 > 0 && this.cf % 5 == 0 && (float)this.cq < (float)this.ah - 100.0F) {
         ...
         this.dL().a(null, this.dq(), this.ds(), this.dw(), ape.sE, this.db(), $$1 * 0.75F, 1.0F);
         this.cq = this.ah;
      }
   }
   ...
   public boolean a(gw $$0, hc $$1, cjf $$2) {
      if (this.cp.e) {
         return true;
      } else {
         gw $$3 = $$0.a($$1.g());
   ...
   @Override
   protected biq.b aV() {
      return this.cp.b || this.aB() && this.bV() ? biq.b.a : biq.b.d;
   }
   ...
   public boolean h(qx $$0) {
      if (this.bO() || !this.aB() || this.aY() || this.aA) {
         return false;
      } else if (this.gi().g()) {
         this.i($$0);
         this.cm = this.dL().V();
   ...
   @Override
   public boolean br() {
      return !this.M_() && super.br();
   }

   @Override
   public boolean bZ() {
      return !this.cp.b && !this.M_() && super.bZ();
   }
   ...
   @Override
   public tl N_() {
      ty $$0 = eik.a(this.cg(), this.ac());
      return this.a($$0);
   }

   private ty a(ty $$0) {
      String $$1 = this.fQ().getName();
      return $$0.a($$1x -> $$1x.a(new tj(tj.a.d, "/tell " + $$1 + " ")).a(this.cG()).a($$1));
   }
   ...
   public float B(float $$0) {
      return arx.a(((float)this.aP + $$0) / this.gk(), 0.0F, 1.0F);
   }
   ...
   @Override
   protected float aK() {
      return !this.cp.b && !this.fv() ? super.aK() : 1.0F;
   }
   ...
   public cjf a(cpv $$0, cjf $$1) {
      this.gb().a($$1.d(), $$1);
      this.b(apo.c.b($$1.d()));
      $$0.a(null, this.dq(), this.ds(), this.dw(), ape.sx, apf.h, 0.5F, $$0.z.i() * 0.1F + 0.9F);
   ...
   public ehn q(float $$0) {
      ...
      float $$3 = arx.i($$0, this.aV, this.aU) * (float) (Math.PI / 180.0);
      if (this.fv() || this.fi()) {
         ehn $$4 = this.f($$0);
         ehn $$5 = this.do();
         double $$6 = $$5.i();
   ...
   protected float fd() {
      if (this.cp.b && !this.bO()) {
         return this.bY() ? this.cp.a() * 2.0F : this.cp.a();
      } else {
