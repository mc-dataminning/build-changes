public class cbu extends cci {
   private static final int[] a = new int[]{0, 1, 4, 5, 6, 7};
   private final chf b;
   private final int c;
   private boolean d;

   public cbu(chf $$0, int $$1) {
      this.b = $$0;
      this.c = b($$1);
   }
   ...
   private boolean a(ji $$0, int $$1, int $$2, int $$3) {
      ji $$4 = $$0.b($$1 * $$3, 0, $$2 * $$3);
      return this.b.dW().b_($$4).a(awv.a) && !this.b.dW().a_($$4).d();
   }
   ...
   public void a() {
      ...
      if ($$2.e * $$2.e < 0.03F && this.b.dO() != 0.0F) {
         this.b.w(ayz.i(0.2F, this.b.dO(), 0.0F));
      } else if ($$2.g() > 1.0E-5F) {
         double $$3 = $$2.i();
