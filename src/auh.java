...
public class auh extends aug {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, auh.a> s;
   private final auc t;
   private long u;
   private final akl v;

   private auh(akl $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aud.c($$2, 7, $$0.getLength());
      }
   }
