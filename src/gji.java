public class gji extends gjq {
   private static final bam a = bam.a();
   private final gjl b;
   private float F = 1.0F;

   gji(gfi $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjl $$7) {
   ...
   public static class a implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gji($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }

   public static class b implements git<ll> {
      private final gjl a;
      ...
      public giq a(ll $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         giq $$8 = new gji($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.a($$0.b(), $$0.c(), $$0.d());
         $$8.e($$0.e());
         return $$8;
      }
