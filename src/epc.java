...
public class epc {
   ...
   private static final Queue<epc.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile epc.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(epc::a), epa::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(epc::a), epa::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + epc.a(this.b) + ", type=" + epc.b(this.c) + ", severity=" + epc.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
