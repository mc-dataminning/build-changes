...
public final class epc implements AutoCloseable {
   ...
   public epc(int $$0, int $$1, boolean $$2) {
      this(epc.a.a, $$0, $$1, $$2);
   }

   public epc(epc.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private epc(epc.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static epc a(InputStream $$0) throws IOException {
      return a(epc.a.a, $$0);
   }

   public static epc a(@Nullable epc.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static epc a(ByteBuffer $$0) throws IOException {
      return a(epc.a.a, $$0);
   }

   public static epc a(byte[] $$0) throws IOException {
   ...
   public static epc a(@Nullable epc.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new epc($$0 == null ? epc.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public epc a(IntUnaryOperator $$0) {
      if (this.c != epc.a.a) {
         ...
         this.j();
         epc $$1 = new epc(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void b(int $$0, int $$1, int $$2) {
      if (this.c != epc.a.a) {
         ...
         int $$3 = this.a($$0, $$1);
         float $$4 = (float)aty.a.a($$2) / 255.0F;
         float $$5 = (float)aty.a.d($$2) / 255.0F;
         float $$6 = (float)aty.a.c($$2) / 255.0F;
         float $$7 = (float)aty.a.b($$2) / 255.0F;
         float $$8 = (float)aty.a.a($$3) / 255.0F;
         float $$9 = (float)aty.a.d($$3) / 255.0F;
         float $$10 = (float)aty.a.c($$3) / 255.0F;
         float $$11 = (float)aty.a.b($$3) / 255.0F;
         float $$13 = 1.0F - $$4;
         float $$14 = $$4 * $$4 + $$8 * $$13;
         float $$15 = $$5 * $$4 + $$9 * $$13;
         float $$16 = $$6 * $$4 + $$10 * $$13;
         ...
         this.a($$0, $$1, aty.a.a($$18, $$19, $$20, $$21));
      }
   }
      ...
      if (this.c != epc.a.a) {
         ...
         for (int $$1 = 0; $$1 < this.b(); $$1++) {
            for (int $$2 = 0; $$2 < this.a(); $$2++) {
               int $$3 = this.a($$2, $$1);
               $$0[$$2 + $$1 * this.a()] = aty.b.a(aty.a.a($$3), aty.a.b($$3), aty.a.c($$3), aty.a.d($$3));
            }
         }
   ...
   public void a(epc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, epc $$4) {
      this.j();
      if ($$4.c() != this.c) {
