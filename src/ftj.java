...
public class ftj implements epv, AutoCloseable {
   ...
   private final List<eqb> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, eqb> l = Maps.newHashMap();
   private final int m;
   ...
   public ftj(aqj $$0, String $$1) throws IOException {
      ahh $$2 = new ahh("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      aqh $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.p = a(auf.a($$5, "blend", null));
         this.s = a($$0, epy.a.a, $$6);
         this.t = a($$0, epy.a.b, $$7);
         this.m = epz.a();
         epz.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = eqb.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static epw a(aqj $$0, epy.a $$1, String $$2) throws IOException {
      epy $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof epw)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         epw $$7;
         if ($$3 == null) {
            ahh $$4 = new ahh("shaders/program/" + $$2 + $$1.b());
            aqh $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static epu a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new epu();
      } else {
         int $$1 = 32774;
