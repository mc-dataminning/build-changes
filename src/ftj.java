...
public class ftj<T extends bso> extends frr<T> implements frv, fte {
   ...
   public ftj(fvw $$0, Function<akm, gcs> $$1) {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.n.e = ayd.b($$1 * 0.6662F + (float) Math.PI) * 2.0F * $$2 * 0.5F / $$8;
      this.o.e = ayd.b($$1 * 0.6662F) * 2.0F * $$2 * 0.5F / $$8;
      this.n.g = 0.0F;
      this.o.g = 0.0F;
      this.p.e = ayd.b($$1 * 0.6662F) * 1.4F * $$2 / $$8;
      this.q.e = ayd.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2 / $$8;
      this.p.f = 0.005F;
      this.q.f = -0.005F;
      this.p.g = 0.005F;
      this.q.g = -0.005F;
      ...
      this.n.f = 0.0F;
      this.o.f = 0.0F;
      boolean $$9 = $$0.fu() == bsi.b;
      if ($$0.fv()) {
         boolean $$10 = $$0.fw() == bpt.a;
         if ($$10 == $$9) {
            this.a($$0);
         } else {
            this.b($$0);
      ...
      if (this.u > 0.0F) {
         ...
         if (!$$0.fv()) {
            if ($$12 < 14.0F) {
               ...
               this.n.e = ayd.i($$14, this.n.e, 0.0F);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = ayd.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, (float) Math.PI + 1.8707964F * this.a($$12) / this.a(14.0F));
               this.n.g = ayd.i($$14, this.n.g, (float) Math.PI - 1.8707964F * this.a($$12) / this.a(14.0F));
            } else if ($$12 >= 14.0F && $$12 < 22.0F) {
               float $$16 = ($$12 - 14.0F) / 8.0F;
               this.o.e = this.a($$15, this.o.e, (float) (Math.PI / 2) * $$16);
               this.n.e = ayd.i($$14, this.n.e, (float) (Math.PI / 2) * $$16);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = ayd.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, 5.012389F - 1.8707964F * $$16);
               this.n.g = ayd.i($$14, this.n.g, 1.2707963F + 1.8707964F * $$16);
            } else if ($$12 >= 22.0F && $$12 < 26.0F) {
               float $$17 = ($$12 - 22.0F) / 4.0F;
               this.o.e = this.a($$15, this.o.e, (float) (Math.PI / 2) - (float) (Math.PI / 2) * $$17);
               this.n.e = ayd.i($$14, this.n.e, (float) (Math.PI / 2) - (float) (Math.PI / 2) * $$17);
               this.o.f = this.a($$15, this.o.f, (float) Math.PI);
               this.n.f = ayd.i($$14, this.n.f, (float) Math.PI);
               this.o.g = this.a($$15, this.o.g, (float) Math.PI);
               this.n.g = ayd.i($$14, this.n.g, (float) Math.PI);
            }
         }

         float $$18 = 0.3F;
         float $$19 = 0.33333334F;
         this.q.e = ayd.i(this.u, this.q.e, 0.3F * ayd.b($$1 * 0.33333334F + (float) Math.PI));
         this.p.e = ayd.i(this.u, this.p.e, 0.3F * ayd.b($$1 * 0.33333334F));
      }
   ...
   private void a(T $$0) {
      switch (this.s) {
         ...
         case j:
            ...
            break;
         case h:
            this.n.e = ayd.a(this.k.e - 1.9198622F - ($$0.ca() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
            this.n.f = this.k.f - (float) (Math.PI / 12);
            break;
         case i:
            this.n.e = ayd.a(this.k.e, -1.2F, 1.2F) - 1.4835298F;
   ...
   private void b(T $$0) {
      switch (this.r) {
         ...
         case j:
            ...
            break;
         case h:
            this.o.e = ayd.a(this.k.e - 1.9198622F - ($$0.ca() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
            this.o.f = this.k.f + (float) (Math.PI / 12);
            break;
         case i:
            this.o.e = ayd.a(this.k.e, -1.2F, 1.2F) - 1.4835298F;
            this.o.f = this.k.f + (float) (Math.PI / 6);
      }
   }

   private void a(fvw $$0, boolean $$1) {
      $$0.e = $$0.e * 0.5F - 0.9424779F + ayd.a(this.k.e, (float) (-Math.PI * 4.0 / 9.0), 0.43633232F);
      $$0.f = ($$1 ? -30.0F : 30.0F) * (float) (Math.PI / 180.0) + ayd.a(this.k.f, (float) (-Math.PI / 6), (float) (Math.PI / 6));
   }
   ...
   protected void a(T $$0, float $$1) {
      if (!(this.c <= 0.0F)) {
         ...
         fvw $$3 = this.a($$2);
         float $$4 = this.c;
         this.m.f = ayd.a(ayd.c($$4) * (float) (Math.PI * 2)) * 0.2F;
         if ($$2 == bsi.a) {
            this.m.f *= -1.0F;
         }

         this.n.d = ayd.a(this.m.f) * 5.0F;
         this.n.b = -ayd.b(this.m.f) * 5.0F;
         this.o.d = -ayd.a(this.m.f) * 5.0F;
         this.o.b = ayd.b(this.m.f) * 5.0F;
         ...
         $$4 *= $$4;
         $$4 = 1.0F - $$4;
         float $$5 = ayd.a($$4 * (float) Math.PI);
         float $$6 = ayd.a(this.c * (float) Math.PI) * -(this.k.e - 0.7F) * 0.75F;
         $$3.e -= $$5 * 1.2F + $$6;
         $$3.f = $$3.f + this.m.f * 2.0F;
         $$3.g = $$3.g + ayd.a(this.c * (float) Math.PI) * -0.4F;
      }
   }
