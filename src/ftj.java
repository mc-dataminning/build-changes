...
public class ftj implements AutoCloseable {
   private static final String a = "minecraft:main";
   private final eom b;
   private final aqh c;
   private final String d;
   private final List<ftk> e = Lists.newArrayList();
   private final Map<String, eom> f = Maps.newHashMap();
   private final List<eom> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public ftj(gen $$0, aqh $$1, eom $$2, ahg $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gen $$0, ahg $$1) throws IOException, JsonSyntaxException {
      aqf $$2 = this.c.getResourceOrThrow($$1);

      try {
         try (Reader $$3 = $$2.e()) {
            JsonObject $$4 = aud.a($$3);
            if (aud.d($$4, "targets")) {
   ...
   private void a(JsonElement $$0) throws ahj {
      if (aud.a($$0)) {
         ...
         JsonObject $$1 = aud.m($$0, "target");
         String $$2 = aud.i($$1, "name");
         int $$3 = aud.a($$1, "width", this.i);
         int $$4 = aud.a($$1, "height", this.j);
   ...
   private void a(gen $$0, JsonElement $$1) throws IOException {
      JsonObject $$2 = aud.m($$1, "pass");
      String $$3 = aud.i($$2, "name");
      String $$4 = aud.i($$2, "intarget");
      String $$5 = aud.i($$2, "outtarget");
      eom $$6 = this.b($$4);
      eom $$7 = this.b($$5);
      if ($$6 == null) {
         ...
         ftk $$8 = this.a($$3, $$6, $$7);
         JsonArray $$9 = aud.a($$2, "auxtargets", null);
         if ($$9 != null) {
            int $$10 = 0;

            for (JsonElement $$11 : $$9) {
               try {
                  JsonObject $$12 = aud.m($$11, "auxtarget");
                  String $$13 = aud.i($$12, "name");
                  String $$14 = aud.i($$12, "id");
                  boolean $$15;
                  String $$16;
                  ...
                  if ($$19 == null) {
                     ...
                     $$0.a($$20);
                     gdx $$21 = $$0.b($$20);
                     int $$22 = aud.o($$12, "width");
                     int $$23 = aud.o($$12, "height");
                     boolean $$24 = aud.k($$12, "bilinear");
                     if ($$24) {
         ...
         JsonArray $$27 = aud.a($$2, "uniforms", null);
         if ($$27 != null) {
            int $$28 = 0;
   ...
   private void b(JsonElement $$0) throws ahj {
      ...
      String $$2 = aud.i($$1, "name");
      epr $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
         ...
         for (JsonElement $$7 : aud.v($$1, "values")) {
            try {
               $$4[$$5] = aud.e($$7, "value");
   ...
   public eom a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      eom $$3 = new eon($$1, $$2, true, evh.a);
   ...
   public ftk a(String $$0, eom $$1, eom $$2) throws IOException {
      ftk $$3 = new ftk(this.c, $$0, $$1, $$2);
   ...
   @Nullable
   private eom b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
