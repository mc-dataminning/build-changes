...
public class ftj extends ftr {
   ...
   public ftj(xv $$0, xv $$1, URI $$2, Runnable $$3) {
      super($$0);
      this.s = $$1;
      this.u = $$2;
      this.v = $$3;
   ...
   public static ftr a(Runnable $$0) {
      return new ftj(a, b, aza.p, $$0);
   }

   public static ftr b(Runnable $$0) {
      return new ftj(c, d, aza.p, $$0);
   }
   ...
   protected void aT_() {
      ...
      frm $$2 = new frm().a(5);
      frm.b $$3 = $$2.d(3);
      $$3.a(fny.a(xu.n, $$0x -> ae.m().a(this.u)).b(120, 20).a());
      $$3.a(fny.a(xu.o, $$0x -> this.m.p.a(this.u.toString())).b(120, 20).a());
      $$3.a(fny.a(xu.k, $$0x -> this.aP_()).b(120, 20).a());
      $$0.a($$2);
      this.c();
      this.w.a(this::c);
   }
