...
public enum eid implements ask {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ask.a<eid> t = ask.a(eid::values);
   public static final IntFunction<eid> u = aqn.a(eid::a, values(), aqn.a.a);
   private final int v;
   private final String w;

   private eid(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
