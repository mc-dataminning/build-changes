...
@Deprecated
public class dsc extends drn<dsc.a> {
   private static final dja a = cwl.nc.o();

   public dsc(Codec<dsc.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(drp<dsc.a> $$0) {
      hx $$1 = $$0.e();
      cud $$2 = $$0.b();
      aup $$3 = $$0.d();
      dsc.a $$4 = $$0.f();
   ...
   public static record a(dvs b, dvs c) implements dtr {
      public static final Codec<dsc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dvs.a.fieldOf("fluid").forGetter(dsc.a::a), dvs.a.fieldOf("barrier").forGetter(dsc.a::b)).apply($$0, dsc.a::new)
      );
