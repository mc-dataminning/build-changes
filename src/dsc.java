...
public class dsc<T> implements dsk<T> {
   private final ja<T> a;
   private final awt<T> b;
   private final dsl<T> c;
   private final int d;

   public dsc(ja<T> $$0, int $$1, dsl<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dsc(ja<T> $$0, int $$1, dsl<T> $$2) {
      this($$0, $$1, $$2, awt.c(1 << $$1));
   }

   private dsc(ja<T> $$0, int $$1, dsl<T> $$2, awt<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dsk<T> c() {
      return new dsc<>(this.a, this.d, this.c, this.b.c());
   }
}
