...
public class gbo extends ftw<gbo.a> {
   ...
   private final gbk N;
   private final List<gbo.d> O = Lists.newArrayList();
   private final gbo.a P = new gbo.b();
   private final List<gbo.c> Q = Lists.newArrayList();

   public gbo(gbk $$0, fpt $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable gbo.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(glg $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new gbo.d(this.N, $$0.a($$1)));
      }

      this.c();
   }

   public void a(List<hod> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (hod $$2 : $$0) {
         this.Q.add(new gbo.c(this.N, $$2));
      }

      this.c();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         gbo.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends ftw.a<gbo.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends gbo.a {
      private final fpt a = fpt.Q();

      @Override
      public void a(fsm $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.b(this.a.h, gbo.G, this.a.z.n / 2 - this.a.h.a(gbo.G) / 2, $$10, -1);
         String $$11 = fyh.a(ag.c());
   ...
   public static class c extends gbo.a {
      ...
      protected final hod b;
      private long g;

      protected c(gbk $$0, hod $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = fpt.Q();
      }
   ...
   public class d extends gbo.a {
      ...
      protected d(final gbk $$1, final glf $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = fpt.Q();
         this.j = fyc.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fsm $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            gbo.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == ac.b().e() ? glf.b.e : glf.b.d);
         ...
         wy $$15 = (wy)(this.i.g() == glf.b.d ? this.i.h.f().a(o.m) : this.i.c);
         ...
         if (this.h.n.ac().c() || $$8) {
            ...
            if (this.e()) {
               if ($$18 < 32 && $$18 > 16) {
                  $$0.a(grc::H, gbo.y, $$3, $$2, 32, 32);
               } else {
                  $$0.a(grc::H, gbo.z, $$3, $$2, 32, 32);
               }
            }

            if ($$1 > 0) {
               if ($$18 < 16 && $$19 < 16) {
                  $$0.a(grc::H, gbo.A, $$3, $$2, 32, 32);
               } else {
                  $$0.a(grc::H, gbo.B, $$3, $$2, 32, 32);
               }
            }

            if ($$1 < this.g.G().c() - 1) {
               if ($$18 < 16 && $$19 > 16) {
                  $$0.a(grc::H, gbo.C, $$3, $$2, 32, 32);
               } else {
                  $$0.a(grc::H, gbo.D, $$3, $$2, 32, 32);
               }
            }
         }
      }
      ...
      protected void a(fsm $$0, int $$1, int $$2, alg $$3) {
         $$0.a(grc::H, $$3, $$1, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
      }
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               gbo.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)gbo.this.u();
         double $$4 = $$1 - (double)gbo.this.d(gbo.this.aE_().indexOf(this));
         if ($$3 <= 32.0) {
