...
public class gbo extends gcd {
   ...
   gbo(fxw $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   private void a(fad $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
   ...
   public static class a implements gbg<ll> {
      private final gby a;
      ...
      public gbd a(ll $$0, fxw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbo $$8 = new gbo($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
