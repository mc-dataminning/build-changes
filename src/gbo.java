...
public class gbo implements gbc.a {
   private final ezg a;
   private double b = Double.MIN_VALUE;
   private List<bow> c = Collections.emptyList();
   ...
   private void a(etz $$0, fxq $$1, double $$2, double $$3, double $$4, bow $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aD.ifPresent($$10 -> {
   ...
   private void a(ib $$0, etz $$1, double $$2, double $$3, double $$4, fxq $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      fxo.a($$1, $$5.getBuffer(fxy.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      fxo.a(
         $$1,
         $$5.getBuffer(fxy.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, epw.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
