...
public class gbo implements gbr.a, AutoCloseable {
   ...
   emx[] f;
   @Nullable
   private final gbo.a g;
   private final apj h;

   public gbo(agi $$0, gdh $$1, emx $$2, apj $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gdf $$4 = $$3.a(gdf.a).orElse(gdf.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new emx[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gbj.a(this.f, $$0);
   ...
   @Nullable
   private gbo.a a(gdh $$0, int $$1, int $$2, gdf $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gbo.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gbo.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gbo.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gbo.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gbo.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gbo.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, emx[] $$4) {
   ...
   class a {
      ...
      a(List<gbo.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gbo.this.c;
         int $$4 = this.b($$2) * gbo.this.d;
         gbo.this.a($$0, $$1, $$3, $$4, gbo.this.f);
      }

      public gbq a() {
         return gbo.this.new d(this, this.d ? gbo.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final emx[] b = new emx[gbo.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gbo.this.c >> $$0;
            int $$2 = gbo.this.d >> $$0;
            this.b[$$0] = new emx($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gbo.d $$2) {
         gbo.a $$3 = $$2.d;
         List<gbo.b> $$4 = $$3.b;
         gbo.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gbo.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gbo.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gbo.this.f[$$2].a($$3 + ($$0.a($$1) * gbo.this.c >> $$2), $$4 + ($$0.b($$1) * gbo.this.d >> $$2));
      }
   ...
   class d implements gbq {
      int b;
      int c;
      final gbo.a d;
      @Nullable
      private final gbo.c e;

      d(gbo.a $$0, @Nullable gbo.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
