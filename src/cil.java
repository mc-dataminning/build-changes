...
public class cil extends eef<cin, cin.a> {
   public static final int a = 6;
   public static final int b = 1;
   private final cil.a d;
   private final LongSet e = new LongOpenHashSet();

   public cil(eee $$0, Path $$1, DataFixer $$2, boolean $$3, jt $$4, edt $$5, djj $$6) {
      super(new eeh($$0, $$1, $$2, $$3, bbb.q), cin.a.a, cin::a, cin.a::a, cin::new, $$4, $$5, $$6);
      this.d = new cil.a();
   }
   ...
   public Stream<cim> b(Predicate<jf<cio>> $$0, iv $$1, int $$2, cil.b $$3) {
      ...
      return dio.a(new dio($$1), $$4).flatMap($$2x -> this.a($$0, $$2x, $$3)).filter($$2x -> {
         iv $$3x = $$2x.g();
   ...
   @bav
   public Stream<cim> a(Predicate<jf<cio>> $$0, dio $$1, cil.b $$2) {
   ...
   private void a(ecw $$0, jy $$1, BiConsumer<iv, jf<cio>> $$2) {
      $$1.t().forEach($$2x -> {
         eao $$3 = $$0.a(jy.b($$2x.u()), jy.b($$2x.v()), jy.b($$2x.w()));
         cip.a($$3).ifPresent($$2xx -> $$2.accept($$2x, $$2xx));
      });
   }

   public void a(djk $$0, iv $$1, int $$2) {
      jy.a(new dio($$1), Math.floorDiv($$2, 16), this.c.aq(), this.c.ar())
         ...
         .forEach($$1x -> $$0.a($$1x.h, $$1x.i, edm.c));
   }
