public abstract class cil extends cid {
   protected cil(bnw<? extends cil> $$0, cvr $$1) {
      super($$0, $$1);
   }

   protected cil(bnw<? extends cil> $$0, double $$1, double $$2, double $$3, cvr $$4) {
      this($$0, $$4);
      this.a_($$1, $$2, $$3);
   }

   protected cil(bnw<? extends cil> $$0, boi $$1, cvr $$2) {
   ...
   public void l() {
      ...
      if ($$0.c() == enx.a.b) {
         ...
         if ($$3.a(cyu.ed)) {
            ...
            dix $$4 = this.dM().c_($$2);
            if ($$4 instanceof dkm && dkm.a(this)) {
               dkm.a(this.dM(), $$2, $$3, this, (dkm)$$4);
            }
