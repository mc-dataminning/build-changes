...
public class cil {
   ...
   private static void b(bwj<cik> $$0) {
      $$0.a(cqo.p, ImmutableList.of(Pair.of(0, new cim()), Pair.of(1, bxm.a(bxc::a, cel.N))), ImmutableSet.of(Pair.of(cel.N, cem.a)), ImmutableSet.of(cel.N));
   }

   private static void c(bwj<cik> $$0) {
      $$0.a(cqo.k, 0, ImmutableList.of(bzp.a(cik::a), bzf.a(cil::b), byh.a(20), bxm.a(bxc::a, cel.o)), cel.o);
   }

   private static void d(bwj<cik> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new byg(45, 90), new byk(), cin.a(), new bxg(cel.P)));
   }
   ...
   private static Optional<? extends bvh> a(ard $$0, cik $$1) {
