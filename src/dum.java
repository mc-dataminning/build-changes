...
public class dum extends dsy {
   ...
   public dum(jh $$0, dvv $$1) {
      super(dta.p, $$0, $$1);
   }

   public static void a(final ame $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, ame $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, ame $$1, BooleanSupplier $$2) {
   ...
   protected void b(ul $$0, js.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vi)czl.a.encodeStart(uz.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", xj.a.a(this.m, $$1));
      }
   }
   ...
   protected void a(ul $$0, js.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         czl.a.parse(uz.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = alj.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dfm $$0, jh $$1, dvv $$2, dum $$3) {
      if ($$2.b(dps.a) && $$2.c(dps.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
