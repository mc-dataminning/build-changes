...
public class dum extends dtz<dvw> {
   public dum(Codec<dvw> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? awi.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(awp $$0, cvs $$1, int $$2, int $$3, hz $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, hz $$2, cvs $$3, boolean $$4, double $$5, hz $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cvs $$0, hz $$1) {
      if ($$0.a_($$1.c()).a(cyu.dN)) {
         this.a($$0, $$1.c(), cyu.a.o());
      }
   }

   private void a(cvs $$0, awp $$1, hz $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dlj $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, hz.c, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, hz.c, $$7, $$1);
      if ($$14 < 0.0) {
         hz $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(hz $$0, cvs $$1, awp $$2, int $$3, int $$4, boolean $$5, boolean $$6, dlj $$7) {
      dlj $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cyu.dP) || $$8.a(cyu.dO) || $$8.a(cyu.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cyu.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cyu.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, hz $$2, int $$3, awp $$4) {
      float $$5 = 10.0F * awi.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, hz $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(awp $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(awp $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dlj $$0) {
      return $$0.a(cyu.iC) || $$0.a(cyu.dP) || $$0.a(cyu.mW);
   }
   ...
   private void a(cvs $$0, hz $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cyu.dN)) {
                  if (this.a((cux)$$0, $$10)) {
                     this.a($$0, $$10, cyu.a.o());
                     this.a($$0, $$10.c(), cyu.a.o());
                  } else if (c($$11)) {
                     dlj[] $$12 = new dlj[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
