...
public class dum extends dvg implements cst {
   ...
   private ka<cwo> n = ka.a(9, cwo.j);
   private int r = 0;
   protected final csn k = new csn() {
   ...
   protected csb a(int $$0, cov $$1) {
      return new csr($$0, $$1, this, this.k);
   }
   ...
   private boolean a(int $$0, cwo $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            cwo $$4 = this.a($$3);
            if ($$4.f() || $$4.M() < $$0 && cwo.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(dgh $$0, ji $$1, dww $$2, dum $$3) {
      int $$4 = $$3.r - 1;
      if ($$4 >= 0) {
         $$3.r = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.b(dle.b, Boolean.valueOf(false)), 3);
         }
      }
   }
