...
public class fhy {
   ...
   private static final Comparator<exz> K = Comparator.comparing(exz::d).reversed().thenComparing(exz::c, String.CASE_INSENSITIVE_ORDER);
   ...
   private final fiu af;
   private final fju ag;
   private final fkl ah;
   private final fjn ai;
   private final fil aj;
   private int ak;
   @Nullable
   private wz al;
   @Nullable
   ...
   public fhy(fgo $$0) {
      ...
      this.ah = new fkl($$0);
      this.X = new fin($$0);
      this.ai = new fjn($$0, this);
      this.aj = new fil($$0);
      this.ag = new fju($$0);
      this.a();
      fib $$1 = new fib().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.aj.a($$0x));
      fib $$2 = new fib().a(this::o).a(($$0x, $$1x) -> {
         if (this.af.d()) {
            this.af.a($$0x);
         }
   ...
   private void d(fhz $$0, fgf $$1) {
      if (this.W.s.gc() > 0) {
         this.W.aH().a("sleep");
         float $$2 = (float)this.W.s.gc();
         float $$3 = $$2 / 100.0F;
         if ($$3 > 1.0F) {
         ...
         $$0.a(gfh.F(), 0, 0, $$0.a(), $$0.b(), $$4);
         this.W.aH().c();
      }
   }

   private void e(fhz $$0, fgf $$1) {
      fhx $$2 = this.f();
   ...
   private void h(fhz $$0, fgf $$1) {
      eyg $$2 = this.W.r.M();
      exy $$3 = null;
      eyb $$4 = $$2.e(this.W.s.cB());
      if ($$4 != null) {
         exx $$5 = exx.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      exy $$6 = $$3 != null ? $$3 : $$2.a(exx.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fhz $$0, fgf $$1) {
      eyg $$2 = this.W.r.M();
      exy $$3 = $$2.a(exx.a);
   ...
   private void j(fhz $$0, fgf $$1) {
      fgs $$2 = this.W.m;
      if ($$2.aB().a()) {
         if (this.W.q.j() != dct.d || this.a(this.W.v)) {
            RenderSystem.enableBlend();
            if (this.af.d() && !this.W.s.go() && !$$2.V().c()) {
               ffy $$3 = this.W.j.l();
   ...
   private boolean a(@Nullable exa $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == exa.a.c) {
         return ((ewz)$$0).a() instanceof bqv;
      } else if ($$0.c() == exa.a.b) {
         jd $$1 = ((ewy)$$0).a();
         dcw $$2 = this.W.r;
   ...
   private void k(fhz $$0, fgf $$1) {
      Collection<brz> $$2 = this.W.s.et();
      if (!$$2.isEmpty()) {
         if (this.W.y instanceof fpl $$3 && $$3.G()) {
            return;
         }
   ...
   private void a(bty $$0, fhz $$1, int $$2) {
      this.W.aH().a("jumpBar");
      float $$3 = this.W.s.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   private static void a(fhz $$0, cmx $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eK();
      if ($$6 > 0) {
         RenderSystem.enableBlend();
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fhz $$0, cmx $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fhy.b $$11 = fhy.b.a($$1);
      boolean $$12 = $$1.dO().A_().l();
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fhy.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fhy.b.d ? $$11 : fhy.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fhz $$0, fhy.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      RenderSystem.enableBlend();
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
      RenderSystem.disableBlend();
   }

   private void a(fhz $$0, cmx $$1, int $$2, int $$3) {
      cpq $$4 = $$1.gi();
      int $$5 = $$4.a();
      RenderSystem.enableBlend();
   ...
   private void a(fhz $$0, akr $$1, float $$2) {
      RenderSystem.disableDepthTest();
   ...
   private void a(fhz $$0, float $$1) {
      ...
      RenderSystem.disableBlend();
      $$0.a(gfh.F(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gfh.F(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gfh.F(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gfh.F(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bsr $$0) {
      jd $$1 = jd.a($$0.dt(), $$0.dx(), $$0.dz());
      float $$2 = gey.a($$0.dO().D_(), $$0.dO().A($$1));
      float $$3 = ayo.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(fhz $$0, @Nullable bsr $$1) {
      dut $$2 = this.W.r.C_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(fhz $$0, int $$1, int $$2, fgf $$3, cmx $$4, cuq $$5, int $$6) {
      if (!$$5.e()) {
