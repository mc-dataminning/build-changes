...
public class dfz extends dgc<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dfz(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dfz $$1 && super.equals($$0)) {
   ...
   public static dfz a(String $$0, int $$1, int $$2) {
      return new dfz($$0, $$1, $$2);
   }
