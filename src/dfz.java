...
public interface dfz<T extends Enum<T>> {
   int v_ = 4;

   Optional<dsb> i_(dsb var1);

   float at_();

   default void a_(dsb $$0, are $$1, iz $$2, azg $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dsb> c(dsb $$0, are $$1, iz $$2, azg $$3) {
      ...
      for (iz $$7 : iz.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dfz<?> $$9) {
            Enum<?> $$10 = $$9.c();
