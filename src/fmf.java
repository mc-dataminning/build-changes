...
public class fmf {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.i.d("gamemode " + ((dhf)MoreObjects.firstNonNull(this.b.r.i(), dhf.b)).b());
               }
   ...
   private void a(dxv $$0, jh $$1, @Nullable ux $$2) {
   ...
   private void a(alz $$0, fby $$1, @Nullable ux $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = ffn.a(fmg.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!ffn.a(fmg.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ffn.a(fmg.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ae.c();
            this.e = ae.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxj) || ((fxj)$$6).u <= ae.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
         ...
         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aM_() instanceof foo) || !((foo)$$6.aM_()).c();
            if ($$7) {
               if (fty.r() && $$1 == 66 && this.b.aZ().a() && this.b.n.w().c()) {
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof ftt $$14 && !$$14.l()) {
                  break label153;
               }
