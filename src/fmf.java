...
public class fmf extends flu {
   private static final fnj d = new fnj(all.b("widget/text_field"), all.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayz> D = ($$0x, $$1x) -> ayz.forward($$0x, yi.a);
   @Nullable
   private xl E;
   private long F = ae.c();

   public fmf(flh $$0, int $$1, int $$2, xl $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fmf(flh $$0, int $$1, int $$2, int $$3, int $$4, xl $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fmf(flh $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fmf $$5, xl $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, ayz> $$0) {
      this.D = $$0;
   }
   ...
   public void e(int $$0) {
      this.w = azn.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azn.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, frp.t());
   }
   ...
   public void b(flj $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.f()) {
            all $$4 = d.a(this.C(), this.aM_());
            $$0.a(gjh::B, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         boolean $$9 = this.aM_() && (ae.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = azn.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gjh.G(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = azn.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = azn.a(this.v, 0, this.p.length());
      }
   }
