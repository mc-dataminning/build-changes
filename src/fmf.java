...
public class fmf extends fnj {
   ...
   protected void aP_() {
      ...
      this.b = new fib(this.l.i, 4, this.n - 12, this.m - 4, 12, wu.c("chat.editBox")) {
         @Override
         protected xi aM_() {
            return super.aM_().b(fmf.this.v.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.v = new fhv(this.l, this, this.b, this.o, false, false, 1, 10, true, -805306368);
      this.v.b(false);
      this.v.d();
   }
   ...
   public void a(fhf $$0, int $$1, int $$2, float $$3) {
      ...
      this.v.a($$0, $$1, $$2);
      $$0.c().b();
      ffo $$4 = this.l.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(flo $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fln.a, wu.a("chat_screen.message", $$1));
      }
   }
