...
public class gmv {
   public static final gmv a = new gmv(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));
   public final Vector3f b;
   public final Vector3f c;
   public final Vector3f d;

   public gmv(Vector3f $$0, Vector3f $$1, Vector3f $$2) {
   ...
   protected static class a implements JsonDeserializer<gmv> {
