...
public class dnz extends diy {
   ...
   public static boolean a(@Nullable bvh $$0, dgi $$1, ji $$2, dwx $$3, cwp $$4) {
      if (!$$3.c(d)) {
         if (!$$1.C) {
            b($$0, $$1, $$2, $$3, $$4);
         }
   ...
   private static void b(@Nullable bvh $$0, dgi $$1, ji $$2, dwx $$3, cwp $$4) {
   ...
   public static void a(@Nullable bul $$0, dgi $$1, ji $$2, dwx $$3, boolean $$4) {
