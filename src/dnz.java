...
public class dnz extends dnm<dpj> {
   public dnz(Codec<dpj> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? arp.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(aru $$0, cpm $$1, int $$2, int $$3, gu $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, gu $$2, cpm $$3, boolean $$4, double $$5, gu $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cpm $$0, gu $$1) {
      if ($$0.a_($$1.c()).a(csm.dN)) {
         this.a($$0, $$1.c(), csm.a.n());
      }
   }

   private void a(cpm $$0, aru $$1, gu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dez $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, gu.b, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, gu.b, $$7, $$1);
      if ($$14 < 0.0) {
         gu $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(gu $$0, cpm $$1, aru $$2, int $$3, int $$4, boolean $$5, boolean $$6, dez $$7) {
      dez $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(csm.dP) || $$8.a(csm.dO) || $$8.a(csm.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(csm.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, csm.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, gu $$2, int $$3, aru $$4) {
      float $$5 = 10.0F * arp.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(aru $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(aru $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dez $$0) {
      return $$0.a(csm.iC) || $$0.a(csm.dP) || $$0.a(csm.mW);
   }

   private boolean a(cor $$0, gu $$1) {
      return $$0.a_($$1.d()).i();
   }

   private void a(cpm $$0, gu $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(csm.dN)) {
                  if (this.a((cor)$$0, $$10)) {
                     this.a($$0, $$10, csm.a.n());
                     this.a($$0, $$10.c(), csm.a.n());
                  } else if (c($$11)) {
                     dez[] $$12 = new dez[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
