...
public class dnz {
   ...
   private static final int j = ir.a(16);
   ...
   private final csh p;
   private static final List<cvf> q = List.of(cvh.l, cvh.L, cvh.i, cvh.b, cvh.k, cvh.I, cvh.K, cvh.fl, cvh.dP, cvh.iA, cvh.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ig<ctd>>> t;
   ...
   public static final Codec<dnz> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dnz::a, Function.identity());

   private static DataResult<dnz> a(dnz $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dnz(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ig<ctd>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = iy.c($$0);
      int $$5 = iy.c($$1) - $$4;
   ...
   @Nullable
   public static dnz a(amp $$0, int $$1, int $$2) {
      djj $$3 = $$0.a($$1, $$2);
      dnz $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(djo.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ic> a(csz $$0, int $$1, int $$2, boolean $$3) {
      Set<ic> $$4 = EnumSet.noneOf(ic.class);
   ...
   private void a(djj $$0, Set<ic> $$1) {
      if (!this.r) {
         if ($$1.contains(ic.a) || $$1.contains(ic.g) || $$1.contains(ic.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(ic.c) && $$1.contains(ic.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(ic.c) && $$1.contains(ic.e) && $$1.contains(ic.d)) {
   ...
   private void a(int $$0, djj $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, atq.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(djj $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dmw.a.a)) {
         $$3 = Math.min($$0.a(dmw.a.a, $$1, $$2) + 1, this.p.ak());
      } else {
         $$3 = this.p.ak();
      }
   ...
   private static double a(djj $$0, hx.a $$1) {
      return a($$0, (hx)$$1.c(ib.a)) ? 1.0 : -1.0;
   }

   private static double b(djj $$0, hx.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(djj $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      hx.a $$5 = new hx.a($$1, this.p.ak(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<ig<ctd>> b(djj $$0, int $$1, int $$2) {
      ObjectArrayList<ig<ctd>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + ir.a(this.p.J_());
         $$3.set($$4, $$0.getNoiseBiome(ir.a($$1), $$5, ir.a($$2)));
      }

      return $$3;
   }

   private static boolean a(djj $$0, hx $$1) {
      dhn $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(ark.O)) {
         ...
         return $$2.a(cvh.eT) || $$2.a(cvh.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dnz.a $$3) {
      if ($$1 >= ir.a(this.p.J_()) && $$1 < ir.a(this.p.ak())) {
         int $$4 = $$1 - ir.a(this.p.J_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               ig<ctd> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dnz.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dnz.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ig<ctd> var3);
   }
