...
public class cag {
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> a(col $$0, float $$1) {
      return ImmutableList.of(
         ...
         new Pair[]{
            ...
            Pair.of(6, bwt.a($$0.c(), cel.c, cel.d, true, Optional.empty(), ($$0x, $$1x) -> true)),
            Pair.of(7, new bxs($$1)),
            Pair.of(8, cam.a($$1)),
            Pair.of(10, bwt.a($$0x -> $$0x.a(cgp.n), cel.b, false, Optional.of((byte)14), cag::a)),
   ...
   private static boolean a(ard $$0, ji $$1) {
      dwx $$2 = $$0.a_($$1);
      return $$2.a(awp.T) && !$$2.c(djf.c);
   }

   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> b(col $$0, float $$1) {
      cal $$2;
      if ($$0 == col.g) {
         $$2 = new cak();
      } else {
         ...
         Pair.of(
            ...
            new byx(
               ImmutableList.of(
                  ...
                  Pair.of(new bxv(), $$0 == col.g ? 2 : 5),
                  Pair.of(new cac(), $$0 == col.g ? 4 : 7)
               )
            )
         ),
         Pair.of(10, new bzi(400, 1600)),
         Pair.of(10, bzc.a(bus.bR, 4)),
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> a(float $$0) {
      return ImmutableList.of(
         ...
         Pair.of(
            ...
            new byx(
               ...
               ImmutableList.of(
                  Pair.of(bxx.a(bus.bC, 8, cel.q, $$0, 2), 2),
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> c(col $$0, float $$1) {
      return ImmutableList.of(
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> d(col $$0, float $$1) {
      return ImmutableList.of(
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> e(col $$0, float $$1) {
      return ImmutableList.of(
         Pair.of(
            2,
            new byx(
               ImmutableList.of(
                  Pair.of(bxx.a(bus.bC, 8, cel.q, $$1, 2), 2),
                  Pair.of(bxx.a(bus.bC, 8, buc::X_, buc::X_, cel.r, $$1, 2), 1),
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> f(col $$0, float $$1) {
      float $$2 = $$1 * 1.5F;
      return ImmutableList.of(
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> g(col $$0, float $$1) {
      return ImmutableList.of(
         Pair.of(0, byw.a()),
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> h(col $$0, float $$1) {
      return ImmutableList.of(
   ...
   public static ImmutableList<Pair<Integer, ? extends bxb<? super coi>>> i(col $$0, float $$1) {
      int $$2 = 2;
      ...
      return Pair.of(
         ...
         new byx(
            ImmutableList.of(
               ...
               Pair.of(byz.a(bus.bC, 8.0F), 2),
               Pair.of(byz.a(bus.bR, 8.0F), 2),
   ...
   private static Pair<Integer, bxb<bvh>> b() {
      return Pair.of(5, new byx(ImmutableList.of(Pair.of(byz.a(bus.bC, 8.0F), 2), Pair.of(byz.a(bus.bR, 8.0F), 2), Pair.of(new bxk(30, 60), 8))));
   }

   private static boolean a(ard $$0, bvh $$1) {
      cqk $$2 = $$0.d($$1.dv());
      return $$2 != null && $$2.u() && !$$2.e() && !$$2.f();
   }

   private static boolean b(ard $$0, bvh $$1) {
      cqk $$2 = $$0.d($$1.dv());
      return $$2 != null && $$2.e();
   }
}
