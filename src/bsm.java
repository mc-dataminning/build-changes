...
public class bsm implements bsj {
   ...
   public void a(double $$0, double $$1, double $$2) {
      this.a($$0, $$1, $$2, (float)this.a.fI(), (float)this.a.ab());
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(aup.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(aup.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   private static double b(blw $$0) {
      return $$0 instanceof bmo ? $$0.du() : ($$0.cH().b + $$0.cH().e) / 2.0;
   }
}
