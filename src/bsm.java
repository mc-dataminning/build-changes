...
public abstract class bsm extends btw {
   private static final akj<Boolean> bY = akn.a(bsm.class, akl.k);
   ...
   protected bsm(bsy<? extends bsm> $$0, dbw $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bsm a(are var1, bsm var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof cot $$0 && !$$0.b((bss)this)) {
         this.ac();
      }
   }
