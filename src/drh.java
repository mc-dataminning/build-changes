...
public class drh {
   ...
   private final Map<Character, Predicate<drf>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public drh a(char $$0, Predicate<drf> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public drg b() {
      return new drg(this.c());
   }

   private Predicate<drf>[][][] c() {
      this.d();
      Predicate<drf>[][][] $$0 = (Predicate<drf>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<drf>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
