...
public class gqr {
   ...
   public static gqk a(Vector3f $$0, Vector3f $$1, gqm $$2, hhz $$3, ja $$4, hkp $$5, @Nullable gqn $$6, boolean $$7, int $$8) {
      gqo $$9 = $$2.d();
      if ($$5.b()) {
         $$9 = a($$2.d(), $$4, $$5.a());
      }
      ...
      return new gqk($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gqo a(gqo $$0, ja $$1, j $$2) {
      ...
      return new gqo(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private static int[] a(gqo $$0, hhz $$1, ja $$2, float[] $$3, j $$4, @Nullable gqn $$5) {
      int[] $$6 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, ja $$2, gqo $$3, float[] $$4, hhz $$5, j $$6, @Nullable gqn $$7) {
      goq.b $$8 = goq.a($$2).a($$1);
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hhz $$3, gqo $$4) {
      int $$5 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable gqn $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
