...
public class gqr {
   ...
   public gqr(gth $$0, div $$1, int $$2, gpn $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
      this.h = jx.a(this.g + 1, 0, this.g + 1);
   }

   protected void a(gth $$0) {
      if (!fos.Q().bx()) {
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, jx.b($$2, $$3 + this.b.aq(), $$4));
               }
            }
         }
      }
   ...
   @Nullable
   protected gth.b a(iu $$0) {
      return this.a(jx.c($$0));
   }

   @Nullable
   protected gth.b a(long $$0) {
      int $$1 = jx.b($$0);
      int $$2 = jx.c($$0);
      int $$3 = jx.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gth.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.aq();
