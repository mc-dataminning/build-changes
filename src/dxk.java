...
public class dxk {
   ...
   static class a implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
         return $$0.c[hc.f.d()] && !$$0.b[hc.f.d()].d;
      }

      @Override
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         $$1.d = true;
         $$1.b[hc.f.d()].d = true;
         return new dxk.k($$0, $$1);
      }
   }

   static class b implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         ...
         return new dxk.l($$0, $$1);
      }
   }

   static class c implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         $$1.d = true;
         $$1.b[hc.b.d()].d = true;
         return new dxk.m($$0, $$1);
      }
   }

   static class d implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         ...
         return new dxk.n($$0, $$1);
      }
   }

   static class e implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         ...
         $$3.d = true;
         $$3.b[hc.c.d()].d = true;
         return new dxk.o($$0, $$3);
      }
   }

   static class f implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
         return true;
      }
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         $$1.d = true;
         return new dxk.s($$0, $$1, $$2);
      }
   }

   static class g implements dxk.i {
      @Override
      public boolean a(dxk.v $$0) {
      ...
      public dxk.r a(hc $$0, dxk.v $$1, asc $$2) {
         $$1.d = true;
         return new dxk.t($$0, $$1);
      }
   }

   public static class h extends dxk.r {
      ...
      private dxk.v G;
      private dxk.v H;
      private final List<dxk.r> I = Lists.newArrayList();

      public h(asc $$0, int $$1, int $$2, hc $$3) {
         super(dvz.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxk.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxk.p($$3, this.G));
         this.I.add(new dxk.j($$3, this.H));
         List<dxk.i> $$5 = Lists.newArrayList();
         $$5.add(new dxk.b());
         $$5.add(new dxk.d());
         $$5.add(new dxk.e());
         $$5.add(new dxk.a());
         ...
         dva $$10 = dva.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dva $$11 = dva.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dva $$12 = dva.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxk.u($$3, $$10, $$13++));
         this.I.add(new dxk.u($$3, $$11, $$13++));
      ...
      private List<dxk.v> b(asc $$0) {
         dxk.v[] $$1 = new dxk.v[75];
         ...
         dxk.v $$23 = new dxk.v(1003);
         dxk.v $$24 = new dxk.v(1001);
         dxk.v $$25 = new dxk.v(1002);
         $$1[v].a(hc.b, $$23);
         $$1[w].a(hc.d, $$24);
         $$1[x].a(hc.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dxk.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqp $$2, asc $$3, dva $$4) {
         int $$5 = 24;
      ...
      private void a(cqp $$0, asc $$1, dva $$2) {
      ...
      private void b(cqp $$0, asc $$1, dva $$2) {
      ...
      private void c(cqp $$0, asc $$1, dva $$2) {
      ...
      private void d(cqp $$0, asc $$1, dva $$2) {
      ...
      private void e(cqp $$0, asc $$1, dva $$2) {
      ...
      private void f(cqp $$0, asc $$1, dva $$2) {
   ...
   interface i {
      boolean a(dxk.v var1);

      dxk.r a(hc var1, dxk.v var2, asc var3);
   }

   public static class j extends dxk.r {
      public j(hc $$0, dxk.v $$1) {
      ...
      public void a(cqp $$0, cqn $$1, dhg $$2, asc $$3, dva $$4, cpc $$5, gw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csw.ch.n(), csw.ch.n(), false);
   ...
   public static class k extends dxk.r {
      public k(hc $$0, dxk.v $$1) {
   ...
   public static class l extends dxk.r {
      public l(hc $$0, dxk.v $$1) {
   ...
   public static class m extends dxk.r {
      public m(hc $$0, dxk.v $$1) {
   ...
   public static class n extends dxk.r {
      public n(hc $$0, dxk.v $$1) {
   ...
   public static class o extends dxk.r {
      public o(hc $$0, dxk.v $$1) {
   ...
   public static class p extends dxk.r {
      public p(hc $$0, dxk.v $$1) {
   ...
   public static class q extends dxk.r {
      public q(hc $$0, dva $$1) {
         super(dvz.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvm {
      protected static final dfj b = csw.hZ.n();
      protected static final dfj c = csw.ia.n();
      protected static final dfj d = csw.ib.n();
      protected static final dfj h = c;
      protected static final dfj i = csw.ii.n();
      protected static final boolean j = true;
      protected static final dfj k = csw.G.n();
      protected static final Set<csv> l = ImmutableSet.builder().add(csw.dO).add(csw.iC).add(csw.mW).add(k.b()).build();
      ...
      public r(dvz $$0, hc $$1, int $$2, dva $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvz $$0, int $$1, hc $$2, dxk.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dva a(hc $$0, dxk.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dva $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void a(cqp $$0, dva $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqp $$0, dva $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dfj $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dva $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqp $$0, dva $$1, int $$2, int $$3, int $$4) {
         gw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            byx $$6 = biu.A.a((cpv)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dl()), bjk.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dxk.r {
      private int a;

      public s(hc $$0, dxk.v $$1, asc $$2) {
         super(dvz.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dxk.r {
      public t(hc $$0, dxk.v $$1) {
   ...
   public static class u extends dxk.r {
      private int a;

      public u(hc $$0, dva $$1, int $$2) {
         super(dvz.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
