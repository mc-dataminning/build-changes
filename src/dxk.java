...
public class dxk {
   ...
   static class a implements dxk.i {
      ...
      @Override
      public dxk.r a(ha $$0, dxk.v $$1, asc $$2) {
         $$1.d = true;
         $$1.b[ha.f.d()].d = true;
   ...
   public static class h extends dxk.r {
      ...
      public h(asc $$0, int $$1, int $$2, ha $$3) {
   ...
   interface i {
      ...
      dxk.r a(ha var1, dxk.v var2, asc var3);
   }

   public static class j extends dxk.r {
      public j(ha $$0, dxk.v $$1) {
   ...
   protected abstract static class r extends dvm {
      ...
      public r(dvz $$0, ha $$1, int $$2, dva $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvz $$0, int $$1, ha $$2, dxk.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dva a(ha $$0, dxk.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
