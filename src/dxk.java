...
public class dxk {
   ...
   public dxk(dha $$0, jh $$1, jm $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dxn $$0 = this.b.a_(this.e);
      if (!dxg.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == etu.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dxn $$0) {
      return $$0.a(dkg.im) || $$0.a(dkg.pB);
   }

   private static boolean a(dxn $$0, dxn $$1) {
      if ($$0.a(dkg.pB) && $$1.a(dkg.im)) {
         return false;
      } else {
         return $$0.a(dkg.im) && $$1.a(dkg.pB) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jh $$0, jm $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dxg.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dxn $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dxg.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dxg.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
