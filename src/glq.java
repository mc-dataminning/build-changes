...
public class glq implements glw.a {
   ...
   private final fja F;
   private final Map<jg, glq.a> G = Maps.newHashMap();
   private final Map<UUID, aao.a> H = Maps.newHashMap();
   @Nullable
   private UUID I;
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         btz $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dS();
      });
   }

   private void b(fdt $$0, ghw $$1, double $$2, double $$3, double $$4) {
      jg $$5 = jg.a($$2, $$3, $$4);
   ...
   private void a(fdt $$0, ghw $$1, glq.a $$2) {
      int $$3 = 0;
   ...
   private void a(fdt $$0, ghw $$1, aao.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gmf.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fdt $$0, ghw $$1, aao.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fdt $$0, ghw $$1, String $$2, glq.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(glq.a $$0) {
      return this.b($$0.a).stream().map(agq::a).collect(Collectors.toSet());
   }

   private Set<String> c(glq.a $$0) {
      return this.c($$0.a).stream().map(agq::a).collect(Collectors.toSet());
   }
   ...
   private boolean c(aao.a $$0) {
      coh $$1 = this.F.t;
      jg $$2 = jg.a($$1.dC(), $$0.h().b(), $$1.dI());
      jg $$3 = jg.a((jz)$$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(jg $$0) {
      return this.H.values().stream().filter($$1 -> $$1.a($$0)).map(aao.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(jg $$0) {
      return this.H.values().stream().filter($$1 -> $$1.b($$0)).map(aao.a::a).collect(Collectors.toSet());
   }

   private Map<jg, List<String>> c() {
      Map<jg, List<String>> $$0 = Maps.newHashMap();

      for (aao.a $$1 : this.H.values()) {
         for (jg $$2 : Iterables.concat($$1.q(), $$1.r())) {
   ...
   private void d() {
      glw.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cH());
   }
