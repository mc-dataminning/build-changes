public abstract class glq<T extends brw & btd, M extends fsw<T>> extends gmf<T, M> {
   ...
   public void a(eyu $$0, gck $$1, int $$2, T $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      if ($$3.a()) {
         ...
         $$11.a($$3, $$4, $$5, $$6);
         this.c().a($$11);
         eyy $$12 = $$1.getBuffer(gcs.b(this.a(), this.a($$10) % 1.0F, $$10 * 0.01F % 1.0F));
         $$11.a($$3, $$4, $$5, $$7, $$8, $$9);
