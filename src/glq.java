...
public interface glq {
   static glq a(glw $$0, UserApiService $$1) {
      return new glq.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, gly var2, AbuseReport var3);
   ...
   public static record b(glw a, UserApiService b) implements glq {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, gly $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               wy $$5 = this.a(var7);
               throw new CompletionException(new glq.a($$5, var7));
            } catch (MinecraftClientException var8) {
               wy $$7 = this.a(var8);
               throw new CompletionException(new glq.a($$7, var8));
            }
         }, ag.i());
      }
