...
public class glq {
   ...
   public static void a(flz $$0, fgl $$1) {
      cps $$2 = $$0.t;
      if (!$$2.ad) {
         dxn $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static void a(hbe $$0, fgl $$1) {
   ...
   private static void b(flz $$0, fgl $$1) {
      RenderSystem.setShader(gko.h);
      RenderSystem.setShaderTexture(0, a);
      jh $$2 = jh.a($$0.t.dA(), $$0.t.dE(), $$0.t.dG());
      float $$3 = glc.a($$0.t.dV().G_(), $$0.t.dV().A($$2));
   ...
   private static void c(flz $$0, fgl $$1) {
      RenderSystem.setShader(gko.i);
