...
public class cnm {
   ...
   public static OptionalInt a(arm $$0, jg $$1, arn $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.ad().map(cnm::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<cnm> $$4 = $$3.stream().flatMap($$0x -> $$0x.ad().stream()).max(Comparator.comparingInt(cnm::c));
            if ($$4.isPresent()) {
               cnm $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(arm $$0, jg $$1) {
      ezc $$2 = ezc.a(ezh.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(cnk.class, $$2).isEmpty();
   }

   private static List<arn> b(arm $$0, jg $$1) {
      ezh $$2 = ezh.b($$1);
      return $$0.a($$1x -> !$$1x.R_() && $$1x.dv().a((jz)$$2, 16.0) && $$1x.bM());
   }
