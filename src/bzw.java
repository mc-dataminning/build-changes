...
public class bzw extends bzi implements bkd {
   ...
   public static final int c = arx.f((float) (Math.PI * 5.0 / 4.0));
   protected static final aef<Byte> d = aei.a(bzw.class, aeh.a);
      ...
      public void a() {
         if (this.k == bpe.a.b) {
            ...
            if ($$1 < bzw.this.cG().a()) {
               ...
               if (bzw.this.q() == null) {
                  ehn $$2 = bzw.this.do();
                  bzw.this.r(-((float)arx.d($$2.c, $$2.e)) * (180.0F / (float)Math.PI));
                  bzw.this.aU = bzw.this.dB();
               } else {
                  double $$3 = bzw.this.q().dq() - bzw.this.dq();
                  double $$4 = bzw.this.q().dw() - bzw.this.dw();
                  bzw.this.r(-((float)arx.d($$3, $$4)) * (180.0F / (float)Math.PI));
                  bzw.this.aU = bzw.this.dB();
               }
            }
         }
