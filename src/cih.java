...
public class cih {
   ...
   private static void b(bwi<cig> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzt(0.8F), new cih.b(2.0F), new byf(45, 90), new byj() {
         @Override
   ...
   private static void d(bwi<cig> $$0) {
      $$0.a(cqo.g, ImmutableList.of(Pair.of(0, new cih.a())), Set.of(Pair.of(cek.G, cel.a), Pair.of(cek.Z, cel.b)));
   }

   public static void a(cig $$0) {
      $$0.ec().a(ImmutableList.of(cqo.g, cqo.b));
   }
   ...
   public static class a extends bwz<cig> {
      ...
      protected void a(arc $$0, cig $$1, long $$2) {
         super.c($$0, $$1, $$2);
         if (this.f > 0) {
            this.f--;
         }
      ...
      private int a(cig $$0) {
         return cig.a.c.b() + $$0.dZ().a(100, 400);
      }

      protected boolean a(arc $$0, cig $$1) {
         return $$1.aJ();
      }

      protected boolean b(arc $$0, cig $$1, long $$2) {
         return $$1.gq().a();
      }

      protected void c(arc $$0, cig $$1, long $$2) {
         $$1.gr();
      }

      protected void d(arc $$0, cig $$1, long $$2) {
         if (!$$1.gB()) {
            $$1.gs();
         }
      }
