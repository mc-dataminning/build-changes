...
public record coz(coz.a d) {
   ...
   public static final Codec<coz> c = coz.a.a.xmap(coz::new, coz::b);

   public static coz a(azm $$0, UUID $$1, coz.a $$2) throws coz.b {
      if (!$$2.a($$0, $$1)) {
         throw new coz.b(e);
      } else {
         return new coz($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<coz.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayi.q.fieldOf("expires_at").forGetter(coz.a::b), axx.f.fieldOf("key").forGetter(coz.a::c), ayi.r.fieldOf("signature_v2").forGetter(coz.a::d)
               )
               .apply($$0, coz.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof coz.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
