...
public class coz {
   ...
   private int g = bae.b(bam.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kk.a.fieldOf("uuid").forGetter(Pair::getFirst), azn.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bvk> j;
   @VisibleForTesting
   protected final ArrayList<bvk> c;
   private final coz.a k;
   @VisibleForTesting
   protected final Object2IntMap<bvk> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<coz> a(Predicate<bvk> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(coz::b)).apply($$1, $$1x -> new coz($$0, $$1x))
      );
   }

   public coz(Predicate<bvk> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new coz.a(this);
   ...
   public void a(ash $$0, Predicate<bvk> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bvk>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bvk> $$6 = (Entry<bvk>)$$5.next();
         int $$7 = $$6.getIntValue();
         bvk $$8 = (bvk)$$6.getKey();
         bvk.d $$9 = $$8.dS();
   ...
   public int b(@Nullable bvk $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bwg> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bwg).map($$0 -> (bwg)$$0);
   }

   @VisibleForTesting
   protected static record a(coz a) implements Comparator<bvk> {
      public int a(bvk $$0, bvk $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cpx;
               boolean $$7 = $$1 instanceof cpx;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
