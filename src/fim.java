...
public abstract class fim {
   ...
   public fim(int $$0, int $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static void a(fod $$0, List<fim> $$1, fol<?> $$2, int $$3, int $$4, int $$5, int $$6) {
      for (fim $$7 : $$1) {
         if ($$2.a() > $$7.a()) {
            $$7.a($$0, $$3, $$4, $$5, $$6);
         }
   ...
   public static void a(fol<?> $$0, fpo.a<?> $$1, List<fim> $$2, int $$3, double $$4, double $$5) {
