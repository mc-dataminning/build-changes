...
public class fim extends fix {
   private static final Logger b = LogUtils.getLogger();
   public Map<Long, List<ProfileResult>> a = Map.of();

   public static fim a(String $$0) {
      fim $$1 = new fim();
      ...
      try {
         ...
         if (azu.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fkt.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fkt.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fmg.Q().b($$4)) {
               try {
