...
public class fim implements acz {
   ...
   public fim(sg $$0, eql $$1, @Nullable fix $$2, @Nullable eya $$3, boolean $$4, @Nullable Duration $$5, Consumer<tf> $$6) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void a(adb $$0) {
      ...
      GameProfile $$1 = $$0.a();
      this.f.a(new adj());
      this.f.a(new fil(this.b, this.f, new fir($$1, this.b.u().a(this.g, this.h, this.i), fip.a().a(), cdw.g, null, this.c, this.d)));
   ...
   public void a(tf $$0) {
      if (this.c != null && this.c.e()) {
         this.b.a(new gen(this.d, te.q, $$0));
      } else {
         this.b.a(new exc(this.d, te.q, $$0));
      }
   }
