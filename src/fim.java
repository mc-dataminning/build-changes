...
public class fim extends fho {
   ...
   public fim(fhf $$0, int $$1, int $$2, int $$3, int $$4, wu $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fip($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(flq $$0) {
      $$0.a(flp.a, wu.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   protected void c(fhh $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aK_()) {
         $$0.a(this.m, (wz)this.n, this.D() + this.a(), this.E() + this.a(), this.g - this.b(), -857677600);
      } else {
         int $$5 = this.o.d();
   ...
   private void k() {
      double $$0 = this.c();
      fip.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fip.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
