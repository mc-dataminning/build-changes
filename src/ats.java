...
public class ats extends aud<ats.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public ats(atx $$0, List<atr> $$1, Executor $$2, Executor $$3, CompletableFuture<azh> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         AtomicLong $$6 = new AtomicLong();
         AtomicLong $$7 = new AtomicLong();
         bmd $$8 = new bmd(ac.c, () -> 0, false);
         bmd $$9 = new bmd(ac.c, () -> 0, false);
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new ats.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<ats.a> a(List<ats.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
   ...
   public static class a {
      ...
      a(String $$0, bmj $$1, bmj $$2, AtomicLong $$3, AtomicLong $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
