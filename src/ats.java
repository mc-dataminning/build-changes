...
public class ats implements ato {
   ...
   private final Map<atq, List<Path>> h;

   ats(atn $$0, atg $$1, Set<String> $$2, List<Path> $$3, Map<atq, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(atq $$0, alj $$1, Consumer<Path> $$2) {
      v.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(atq $$0, String $$1, String $$2, ato.a $$3) {
      v.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<alj, auu<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(ato.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      atr.a($$1, $$4, $$3, $$0);
   }
   ...
   public avg d() {
      return $$0 -> Optional.ofNullable(this.a(atq.a, $$0)).map($$0x -> new avb(this, $$0x));
   }
}
