...
public class fvx extends fvn<cvb> {
   ...
   private final fvc aa = new fvc(0);
   private final fvc ab = new fvc(1);
   private final fvc ac = new fvc(2);
   @Nullable
   private clp ad;

   public fvx(cvb $$0, cpv $$1, xv $$2) {
   ...
   protected void a(fnq $$0, float $$1, int $$2, int $$3) {
      ...
      fvm.a($$0, (float)(this.C + 141), (float)(this.D + 75), 25.0F, V, W, null, this.ad);
   }
   ...
   @Override
   protected void c(fnq $$0, int $$1, int $$2) {
      if (this.K()) {
         $$0.a(glt::B, G, $$1 + 65, $$2 + 46, 28, 21);
      }
   }

   private void d(fnq $$0, int $$1, int $$2) {
