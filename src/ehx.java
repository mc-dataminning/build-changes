...
public class ehx implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ehx.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ehx(List<ehx.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ehx a(BufferedReader $$0) {
      return new ehx($$0.lines().flatMap($$0x -> ehx.a.a($$0x).stream()).toList());
   }

   public static record a(ehx.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ehx.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ehx.a(ehx.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ehx.a(ehx.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ehx.a(ehx.b.b, $$3));
      ...
      static ehx.a b(String $$0) {
         return new ehx.a(ehx.b.a, "glob:" + $$0);
      }

      static ehx.a c(String $$0) {
         return new ehx.a(ehx.b.a, "regex:" + $$0);
      }

      static ehx.a d(String $$0) {
         return new ehx.a(ehx.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ehx.b a = FileSystem::getPathMatcher;
      ehx.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
