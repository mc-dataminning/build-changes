...
public abstract class ehx {
   ...
   public egz a() {
      if (this.c()) {
         ...
         return new egz(this.b(ha.a.a), this.b(ha.a.b), this.b(ha.a.c), this.c(ha.a.a), this.c(ha.a.b), this.c(ha.a.c));
      }
   }

   public ehx b() {
      return this.c() ? ehu.a() : ehu.a(this.b(ha.a.a), this.b(ha.a.b), this.b(ha.a.c), this.c(ha.a.a), this.c(ha.a.b), this.c(ha.a.c));
   }
   ...
   public ehx a(double $$0, double $$1, double $$2) {
      return (ehx)(this.c() ? ehu.a() : new ehg(this.a, new eht(this.a(ha.a.a), $$0), new eht(this.a(ha.a.b), $$1), new eht(this.a(ha.a.c), $$2)));
   }

   public ehx d() {
      ehx[] $$0 = new ehx[]{ehu.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ehu.b($$0[0], ehu.a($$1, $$2, $$3, $$4, $$5, $$6), ehi.o));
      return $$0[0];
   }

   public void a(ehu.a $$0) {
      this.a
         .a(
   ...
   public List<egz> e() {
      ...
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new egz($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ha.a.a, $$4.c - (double)$$2.u()), this.a(ha.a.b, $$4.d - (double)$$2.v()), this.a(ha.a.c, $$4.e - (double)$$2.w()))
               ? new eha($$4, ha.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : egz.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<ehe> a(ehe $$0) {
      if (this.c()) {
   ...
   public ehx a(ha $$0) {
      if (!this.c() && this != ehu.b()) {
         if (this.b != null) {
            ehx $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ehx b(ha $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ehv(this, $$1, $$4);
      }
   }

   public double a(ha.a $$0, egz $$1, double $$2) {
      return this.a(gs.a($$0, ha.a.a), $$1, $$2);
   }

   protected double a(gs $$0, egz $$1, double $$2) {
      if (this.c()) {
         return $$2;
