public class foo extends fob<cql> implements fqw {
   private static final alf D = new alf("textures/gui/container/crafting_table.png");
   private final fqq E = new fqq();
   private boolean F;

   public foo(cql $$0, cmw $$1, xp $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aM_() {
      ...
      this.c(new fhq(this.z + 5, this.o / 2 - 49, 20, 18, fqq.a, $$0 -> {
         this.E.e();
         this.z = this.E.a(this.n, this.c);
