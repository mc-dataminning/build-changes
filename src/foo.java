...
public class foo {
   ...
   final fke c;
   private final List<foo.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fon> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends fon> T a(Class<? extends T> $$0, Object $$1) {
      for (foo.a<?> $$2 : this.d) {
   ...
   class a<T extends fon> {
      ...
      public void c() {
         ...
         if (this.f == -1L) {
            this.f = $$0;
            this.h.a(foo.this.c.ak());
         }

         if (this.h == fon.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(foo.this, this.i);
         fon.a $$1 = this.c.a();
         if ($$1 != this.h) {
         ...
         this.k = this.h == fon.a.b && $$0 - this.f > 600L;
      }

      public void a(flq $$0, int $$1) {
         $$0.c().a();
         $$0.c().a((float)$$1 - (float)this.c.b() * this.j, (float)(this.d * 32), 800.0F);
         this.c.a($$0, foo.this.c.h, this.i);
         $$0.c().b();
      }
   }
}
