public class foo extends foc<cqj> {
   ...
   protected void a(crq $$0, int $$1, int $$2, cqe $$3) {
      if ($$0 instanceof cqk && !$$0.h() && !this.I.N_()) {
         switch ($$3) {
            case a:
               if (this.w.e($$1)) {
                  this.a($$1);
   ...
   @Override
   public void a(fgs $$0, crq $$1) {
      if ($$1 instanceof cqk $$2 && this.w.e($$1.d)) {
         this.a($$0, $$2);
         return;
      }
   ...
   public void a(fgs $$0, int $$1, int $$2, float $$3) {
      ...
      this.c($$0);
      this.a($$0, $$1, $$2);
      if (this.y instanceof cqk && !this.w.e(this.y.d) && this.w.g().e() && !this.y.h() && !this.I.N_()) {
         $$0.a(this.p, H, $$1, $$2);
      }
   }
