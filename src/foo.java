...
public class foo extends fod {
   private static final fpt d = new fpt(alz.b("widget/text_field"), alz.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, azq> D = ($$0x, $$1x) -> azq.forward($$0x, ys.a);
   @Nullable
   private xv E;
   private long F = ae.c();

   public foo(fnq $$0, int $$1, int $$2, xv $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public foo(fnq $$0, int $$1, int $$2, int $$3, int $$4, xv $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public foo(fnq $$0, int $$1, int $$2, int $$3, int $$4, @Nullable foo $$5, xv $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, azq> $$0) {
      this.D = $$0;
   }
   ...
   protected yj aR_() {
      xv $$0 = this.z();
      return xv.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = bae.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = bae.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fty.s());
   }
   ...
   public void b(fns $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            alz $$4 = d.a(this.C(), this.aN_());
            $$0.a(glv::C, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         boolean $$9 = this.aN_() && (ae.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = bae.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(glv.H(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = bae.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = bae.a(this.v, 0, this.p.length());
      }
   }
