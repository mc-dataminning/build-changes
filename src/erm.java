...
public class erm extends erp {
   ...
   static final erm.b l = new erm.b(854, 480);

   public erm(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final erm.a[] e = values();
   ...
   static class b {
      ...
      static List<erm.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new erm.b($$0, $$1), erm.l) : ImmutableList.of(erm.l);
      }
