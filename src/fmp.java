...
public class fmp extends fmx {
   ...
   private static final IntSupplier f = () -> fff.Q().m.a().c() ? e : d;
   ...
   public fmp(fff $$0, aul $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fgr $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gdw.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gdw.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, fff.a);
         $$10 = 1.0F;
      }
   ...
   private void a(fgr $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends gos {
      ...
      protected gos.a b(aup $$0) {
         atf $$1 = fff.Q().ad();
         auh<InputStream> $$2 = $$1.a(atd.a, fmp.c);
         if ($$2 == null) {
            return new gos.a(new FileNotFoundException(fmp.c.toString()));
         } else {
            try {
               gos.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gos.a(new gqw(true, true), eyz.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gos.a(var9);
            }
         }
      }
   }
