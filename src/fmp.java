...
public class fmp {
   ...
   public ya a(ya $$0, int $$1, ys $$2) {
      final fmp.e $$3 = new fmp.e((float)$$1);
      return $$0.a(new ya.b<ya>() {
         private final flt b = new flt();
   ...
   public void a(String $$0, int $$1, ys $$2, boolean $$3, fmp.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      ys $$7 = $$2;

      while ($$5 < $$6) {
         fmp.b $$8 = new fmp.b((float)$$1);
   ...
   static class a {
      ...
      public ya a(int $$0, int $$1, ys $$2) {
         flt $$3 = new flt();
         ListIterator<fmp.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, ys $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = fmp.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements azr {
      ...
      @Override
      public boolean accept(int $$0, ys $$1, int $$2) {
         this.b = this.b - fmp.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
