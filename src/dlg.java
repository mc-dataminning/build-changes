...
public class dlg extends dki {
   ...
   public int c(int $$0) {
      this.e++;
      return this.d instanceof dki $$1 ? $$1.c($$0) : (int)(this.d.g() >>> 64 - $$0);
   }
   ...
   public static art a(int $$0, int $$1, long $$2, long $$3) {
      return art.a($$2 + (long)($$0 * $$0 * 4987142) + (long)($$0 * 5947611) + (long)($$1 * $$1) * 4392871L + (long)($$1 * 389711) ^ $$3);
   }
   ...
   public static enum a {
      ...
      private final LongFunction<art> c;

      private a(LongFunction<art> $$0) {
         this.c = $$0;
      }
