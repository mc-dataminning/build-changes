...
public class hfv extends MinecraftServer {
   ...
   public hfv(Thread $$0, fmf $$1, ewc.c $$2, avg $$3, amy $$4, amu $$5, ass $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hfu(this, this.bb(), this.g));
      this.n = $$1;
   }
