...
public class bit extends bja {
   public static final Codec<bit> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  bja.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bit a(bja $$0, int $$1, int $$2) {
      return new bit($$0, $$1, $$2);
   }

   public bit(bja $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Override
   public int a(aup $$0) {
      return aui.a(this.b.a($$0), this.f, this.g);
   }
