...
public class bit extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getOutputSchema().getType(bhx.c);
      ...
      if (!($$1.findFieldType("TileEntities") instanceof ListType<?> $$3)) {
         ...
         Type<?> $$5 = this.getInputSchema().getType(bhx.c);
         ...
         if (!($$8 instanceof ListType)) {
            ...
            return TypeRewriteRule.seq(
               new baw(this.getOutputSchema(), "AddTrappedChestFix", bhx.s).makeRule(),
               this.fixTypeEverywhereTyped("Trapped Chest fix", $$5, $$4x -> $$4x.updateTyped($$6, $$3xx -> {
                     ...
                     if ($$4xx.isEmpty()) {
                        ...
                        for (Typed<?> $$7x : $$5x) {
                           bit.a $$8x = new bit.a($$7x, this.getInputSchema());
                           if (!$$8x.b()) {
                        ...
                        TaggedChoiceType<String> $$14 = this.getInputSchema().findChoiceType(bhx.s);
                        return $$3xx.updateTyped($$4, $$4xxx -> $$4xxx.updateTyped($$14.finder(), $$4xxxx -> {
                              ...
                              return $$6x.contains(bge.a($$6xx, $$7xx, $$8xx)) ? $$4xxxx.update($$14.finder(), $$0xxxxx -> $$0xxxxx.mapFirst($$0xxxxxx -> {
