...
public class cyl {
   ...
   private boolean a(gu $$0) {
      return csc.a(this.a, $$0) || csc.a(this.a, $$0.c()) || csc.a(this.a, $$0.d());
   }
   ...
   private cyl b(gu $$0) {
      dfa $$2 = this.a.a_($$0);
      if (csc.g($$2)) {
         return new cyl(this.a, $$0, $$2);
      } else {
         gu $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (csc.g($$2)) {
            return new cyl(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return csc.g($$2) ? new cyl(this.a, $$1, $$2) : null;
         }
      }
   }
   ...
   private boolean b(cyl $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(cyl $$0) {
      this.f.add($$0.b);
      gu $$1 = this.b.e();
      gu $$2 = this.b.f();
      gu $$3 = this.b.g();
   ...
   public cyl a(boolean $$0, boolean $$1, dge $$2) {
      gu $$3 = this.b.e();
      gu $$4 = this.b.f();
      gu $$5 = this.b.g();
      gu $$6 = this.b.h();
