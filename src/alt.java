...
public class alt {
   ...
   public static record a(aup a, dhe b, jt.a c, kf.b d) {
   }
   ...
   public static record d(aua a, dhe b, boolean c, boolean d) {
      public Pair<dhe, auf> a() {
         dhe $$0 = MinecraftServer.a(this.a, this.b, this.d, this.c);
         List<atc> $$1 = this.a.h();
