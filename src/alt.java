...
public class alt {
   ...
   private static void a(final Set<String> $$0) {
      final tv $$1 = tv.a();
      dkf $$2 = new dkf(cvu.e.a());
      $$2.a(new dkf.c() {
         @Override
         public <T extends dkf.g<T>> void a(dkf.e<T> $$0x, dkf.f<T> $$1x) {
            if (!$$1.b($$0.b())) {
               $$0.add($$0.a());
            }
         }
   ...
   private static void d() {
      if (d.isDebugEnabled()) {
         ...
         System.setErr(new aly("STDERR", System.err));
         System.setOut(new aly("STDOUT", a));
      }
   }
