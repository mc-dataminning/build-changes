...
public class alt implements auj {
   private static final Logger a = LogUtils.getLogger();
   private static final aky b = new aky("functions", ".mcfunction");
   private volatile Map<alf, ib<ep>> c = ImmutableMap.of();
   private final axg<ib<ep>> d = new axg<>(this::a, "tags/functions");
   private volatile Map<alf, Collection<ib<ep>>> e = Map.of();
   private final int f;
   ...
   public Iterable<alf> b() {
      return this.e.keySet();
   }

   public alt(int $$0, CommandDispatcher<ep> $$1) {
      this.f = $$0;
      this.g = $$1;
   }
   ...
   public CompletableFuture<Void> a(auj.a $$0, aup $$1, bnk $$2, bnk $$3, Executor $$4, Executor $$5) {
      ...
      CompletableFuture<Map<alf, CompletableFuture<ib<ep>>>> $$7 = CompletableFuture.<Map<alf, aun>>supplyAsync(() -> b.a($$1), $$4).thenCompose($$1x -> {
         ...
         ep $$3x = new ep(eo.a, evt.b, evs.a, null, this.f, "", xo.a, null, null);
      ...
      return $$6.thenCombine($$7, Pair::of).thenCompose($$0::a).thenAcceptAsync($$0x -> {
         Map<alf, CompletableFuture<ib<ep>>> $$1x = (Map<alf, CompletableFuture<ib<ep>>>)$$0x.getSecond();
         Builder<alf, ib<ep>> $$2x = ImmutableMap.builder();
         ...
         this.c = $$2x.build();
         this.e = this.d.a((Map<alf, List<axg.a>>)$$0x.getFirst());
      }, $$5);
   }
