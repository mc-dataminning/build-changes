...
public class alt {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> wg.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(wg.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> wg.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType a = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wg.b("commands.execute.function.instantiationFailure", $$0, $$1)
   );
   private static final SuggestionProvider<du> f = ($$0, $$1) -> {
      ene $$2 = ((du)$$0.getSource()).l().aM();
      return dz.a($$2.a(eng.a), $$1);
   };
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a(
                                       ...
                                       .then(dv.a("at").then(dv.a("targets", eh.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bpv $$2x : eh.c($$0x, "targets")) {
                                             $$1x.add(((du)$$0x.getSource()).a((aps)$$2x.dM()).a($$2x.dk()).a($$2x.bJ()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("positioned")
                                       ...
                                       .then(dv.a("over").then(dv.a("heightmap", ek.a()).redirect($$2, $$0x -> {
                                          esa $$1x = ((du)$$0x.getSource()).d();
                                          aps $$2x = ((du)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(je.b($$3), je.b($$4))) {
                                             throw fo.a.create();
                                          } else {
                                             int $$5 = $$2x.a(ek.a($$0x, "heightmap"), axk.a($$3), axk.a($$4));
                                             return ((du)$$0x.getSource()).a(new esa($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
               ...
               .then(dv.a("summon").then(dv.a("entity", et.a($$1, ks.u)).suggests(hr.d).redirect($$2, $$0x -> a((du)$$0x.getSource(), et.e($$0x, "entity"))))))
            .then(a($$2, dv.a("on")))
      );
   }
         ...
         dv.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)dv.a("id", ev.a())
                     .suggests(ald.a)
                     .then(dv.a("value").redirect($$0, $$1x -> a((du)$$1x.getSource(), ald.a($$1x), true, $$2))))
                  .then(dv.a("max").redirect($$0, $$1x -> a((du)$$1x.getSource(), ald.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             dv.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         em.a($$2xx, "path"),
                                                         $$1xxx -> tr.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          dv.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      em.a($$2xx, "path"),
                                                      $$1xxx -> tp.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       dv.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   em.a($$2xx, "path"),
                                                   $$1xxx -> ue.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    dv.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                em.a($$2xx, "path"),
                                                $$1xxx -> tu.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 dv.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             em.a($$2xx, "path"),
                                             $$1xxx -> tn.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              dv.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          em.a($$2xx, "path"),
                                          $$1xxx -> tk.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static du a(du $$0, Collection<etd> $$1, esw $$2, boolean $$3) {
      ete $$4 = $$0.l().aK();
      return $$0.a(($$4x, $$5) -> {
         for (etd $$6 : $$1) {
            etc $$7 = $$4.c($$6, $$2);
   ...
   private static du a(du $$0, aks $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static du a(du $$0, aoh $$1, em.g $$2, IntFunction<uj> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            tm $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(aps $$0, ib $$1) {
      cye $$2 = new cye($$1);
      drf $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == apl.d && $$0.c($$2.a());
   }
                                       ...
                                       dv.a("pos", fo.a())
                                          .then(
                                             a(
                                                ...
                                                dv.a("block", fk.a($$3)),
                                                $$2,
                                                $$0x -> fk.a($$0x, "block").test(new dpd(((du)$$0x.getSource()).e(), fo.a($$0x, "pos"), true))
                                             )
                                          )
                                    )
                              ))
                                    ...
                                    .then(
                                       dv.a("pos", fo.a())
                                          .then(
                                             a(
                                                $$0,
                                                dv.a("biome", ew.a($$3, ks.av)),
                                                $$2,
                                                $$0x -> ew.a($$0x, "biome", ks.av).test(((du)$$0x.getSource()).e().t(fo.a($$0x, "pos")))
                                             )
                                          )
                                    )
                              ))
                                             ...
                                             dv.a(">=")
                                                .then(
                                                   dv.a("source", ey.a())
                                                      .suggests(ey.a)
                                                      .then(
                                                         a($$0, dv.a("sourceObjective", eo.a()), $$2, $$0x -> a($$0x, (alt.e)(($$0xx, $$1x) -> $$0xx >= $$1x)))
                                                      )
                                                )
                                          ))
                  ...
                  dv.a("entity")
                     .then(
                        ((RequiredArgumentBuilder)dv.a("entities", eh.b()).fork($$0, $$1x -> a($$1x, $$2, !eh.c($$1x, "entities").isEmpty())))
                           .executes(a($$2, (alt.b)($$0x -> eh.c($$0x, "entities").size())))
                     )
               ))
            .then(dv.a("predicate").then(a($$0, dv.a("predicate", ev.a()).suggests(f), $$2, $$0x -> a((du)$$0x.getSource(), ev.c($$0x, "predicate"))))))
         .then(dv.a("function").then(dv.a("name", fz.a()).suggests(aly.b).fork($$0, new alt.d($$2))));
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)dv.a("path", em.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), em.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (alt.b)($$1xx -> a($$4.a($$1xx), em.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static Command<du> a(boolean $$0, alt.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((du)$$1x.getSource()).a(() -> wg.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((du)$$1x.getSource()).a(() -> wg.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(aoh $$0, em.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<du> $$0, alt.e $$1) throws CommandSyntaxException {
      etd $$2 = ey.a($$0, "target");
      esw $$3 = eo.a($$0, "targetObjective");
      etd $$4 = ey.a($$0, "source");
      esw $$5 = eo.a($$0, "sourceObjective");
      ete $$6 = ((du)$$0.getSource()).l().aK();
      eta $$7 = $$6.d($$2, $$3);
      eta $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<du> $$0, cm.d $$1) throws CommandSyntaxException {
      etd $$2 = ey.a($$0, "target");
      esw $$3 = eo.a($$0, "targetObjective");
      ete $$4 = ((du)$$0.getSource()).l().aK();
      eta $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(du $$0, eqc $$1) {
      aps $$2 = $$0.e();
      enh $$3 = new enh.a($$2).a(epo.f, $$0.d()).b(epo.a, $$0.f()).a(epn.d);
      enb $$4 = new enb.a($$3).a(Optional.empty());
      $$4.b(enb.a($$1));
      return $$1.test($$4);
   }
   ...
   private static ArgumentBuilder<du, ?> a(CommandNode<du> $$0, ArgumentBuilder<du, ?> $$1, boolean $$2, alt.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((du)$$2x.getSource()).a(() -> wg.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<du> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((du)$$0.getSource()).a(() -> wg.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<du> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((du)$$0.getSource()).a(() -> wg.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(aps $$0, ib $$1, ib $$2, ib $$3, boolean $$4) throws CommandSyntaxException {
      eez $$5 = eez.a($$1, $$2);
      eez $$6 = eez.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<du> a(Function<bpv, Optional<bpv>> $$0) {
      return $$1 -> {
         du $$2 = (du)$$1.getSource();
         bpv $$3 = $$2.f();
   ...
   private static RedirectModifier<du> b(Function<bpv, Stream<bpv>> $$0) {
      return $$1 -> {
         du $$2 = (du)$$1.getSource();
         bpv $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<du> a(CommandNode<du> $$0, LiteralArgumentBuilder<du> $$1) {
      return (LiteralArgumentBuilder<du>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              dv.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bpv, Optional<bpv>>)($$0x -> $$0x instanceof bqv $$1x ? Optional.ofNullable($$1x.P_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              dv.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<bpv, Optional<bpv>>)($$0x -> $$0x instanceof bqq $$1x ? Optional.ofNullable($$1x.gc()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           dv.a("target")
                              .fork($$0, a((Function<bpv, Optional<bpv>>)($$0x -> $$0x instanceof brl $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
                        ))
                     .then(
                        dv.a("attacker")
                           .fork($$0, a((Function<bpv, Optional<bpv>>)($$0x -> $$0x instanceof bps $$1x ? Optional.ofNullable($$1x.T_()) : Optional.empty())))
                     ))
                  .then(dv.a("vehicle").fork($$0, a((Function<bpv, Optional<bpv>>)($$0x -> Optional.ofNullable($$0x.cZ()))))))
               .then(dv.a("controller").fork($$0, a((Function<bpv, Optional<bpv>>)($$0x -> Optional.ofNullable($$0x.cN()))))))
            .then(
               dv.a("origin").fork($$0, a((Function<bpv, Optional<bpv>>)($$0x -> $$0x instanceof brm $$1x ? Optional.ofNullable($$1x.u()) : Optional.empty())))
            ))
         .then(dv.a("passengers").fork($$0, b((Function<bpv, Stream<bpv>>)($$0x -> $$0x.cP().stream()))));
   }

   private static du a(du $$0, il.c<bqb<?>> $$1) throws CommandSyntaxException {
      bpv $$2 = anr.a($$0, $$1, $$0.d(), new tm(), true);
      return $$0.a($$2);
   }

   public static <T extends dw<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable tm $$5, gt<T> $$6, alt.a<T, Collection<hf<T>>> $$7, gn $$8
   ) {
   ...
   static class d implements gq.a<du> {
      ...
      public void a(du $$0, List<du> $$1, ContextChain<du> $$2, gn $$3, gt<du> $$4) {
         alt.a($$0, $$1, aly::a, this.a, $$2, null, $$4, $$0x -> fz.a($$0x, "name"), $$3);
      }
   }
