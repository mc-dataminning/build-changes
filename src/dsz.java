...
public class dsz extends dte {
   ...
   public List<drm.a> a(cqb $$0, BiConsumer<gw, dfj> $$1, asc $$2, int $$3, gw $$4, dqw $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = arx.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, arx.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               gw $$21 = $$4.b(arx.a($$19), $$12 - 1, arx.a($$20));
               gw $$22 = $$21.b(5);
   ...
   private boolean a(cqb $$0, BiConsumer<gw, dfj> $$1, asc $$2, gw $$3, gw $$4, boolean $$5, dqw $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            gw $$13 = $$3.b(arx.d(0.5F + (float)$$12 * $$9), arx.d(0.5F + (float)$$12 * $$10), arx.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
