...
public class dsz extends dke {
   public static final MapCodec<dsz> a = b(dsz::new);
   public static final int b = 2;
   public static final int c = 1;
   public static final int d = 4;
   private static final fcm g = dke.a(3.0, 0.0, 3.0, 12.0, 7.0, 12.0);
   private static final fcm h = dke.a(1.0, 0.0, 1.0, 15.0, 7.0, 15.0);
   public static final dym e = dyd.aF;
   public static final dym f = dyd.aE;
   ...
   private void a(dha $$0, dxn $$1, jh $$2, bvf $$3, int $$4) {
      if ($$1.a(dkg.mA) && $$0 instanceof ash $$5 && this.a($$5, $$3) && $$0.A.a($$4) == 0) {
         this.a($$5, $$2, $$1);
      }
   }
   ...
   protected void b(dxn $$0, ash $$1, jh $$2, bam $$3) {
      if (this.a($$1) && a($$1, $$2)) {
         int $$4 = $$0.c(e);
         if ($$4 < 2) {
            $$1.a(null, $$2, axf.AH, axg.e, 0.7F, 0.9F + $$3.i() * 0.2F);
            $$1.a($$2, $$0.b(e, Integer.valueOf($$4 + 1)), 2);
            $$1.a(ecj.c, $$2, ecj.a.a($$0));
         } else {
            $$1.a(null, $$2, axf.AI, axg.e, 0.7F, 0.9F + $$3.i() * 0.2F);
            $$1.a($$2, false);
            $$1.a(ecj.f, $$2, ecj.a.a($$0));

            for (int $$5 = 0; $$5 < $$0.c(f); $$5++) {
               $$1.c(2001, $$2, dke.j($$0));
               cit $$6 = bvm.bB.a($$1, bvl.e);
               if ($$6 != null) {
                  $$6.c_(-24000);
                  $$6.h($$2);
   ...
   public static boolean b(dgf $$0, jh $$1) {
   ...
   private boolean a(ash $$0, bvf $$1) {
      if ($$1 instanceof cit || $$1 instanceof chm) {
         return false;
      } else {
         return !($$1 instanceof bwb) ? false : $$1 instanceof cps || $$0.N().b(dgw.c);
      }
   }
}
