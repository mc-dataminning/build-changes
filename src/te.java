...
class te implements ss {
   ...
   private void a(sp $$0, su $$1, boolean $$2) {
      tf $$3 = $$0.B();
   ...
   public static void a(sp $$0, String $$1) {
      b($$0).ifPresent($$0x -> $$0x.w());
      b($$0, $$1);
   }

   private static void b(sp $$0, String $$1) {
      a($$0.g(), n.k, $$1);
      ta.b($$0);
   }

   protected static void a(sp $$0, Throwable $$1) {
      ww $$3;
   ...
   protected static void b(sp $$0, Throwable $$1) {
   ...
   private static Optional<dyi> b(sp $$0) {
      aro $$1 = $$0.g();
      Optional<iu> $$2 = Optional.ofNullable($$0.c());
      return $$2.flatMap($$1x -> $$1.a($$1x, dwp.U));
   }

   protected static void a(aro $$0, n $$1, String $$2) {
      $$0.a($$0x -> true).forEach($$2x -> $$2x.a(ww.b($$2).a($$1)));
   }

   private static void a(aro $$0, iu $$1, String $$2) {
      agk.a($$0, $$1, $$2, -2130771968, Integer.MAX_VALUE);
   }
}
