...
public class etd {
   ...
   public vo a(uw $$0, int $$1) {
      etd.e $$2 = new etd.e((float)$$1);
      return $$0.<vo>a(($$1x, $$2x) -> aua.c($$2x, $$1x, $$2) ? Optional.empty() : Optional.of($$1x), vo.a).orElse(null);
   }

   @Nullable
   public vo a(asu $$0, int $$1) {
      etd.e $$2 = new etd.e((float)$$1);
   ...
   public uw a(uw $$0, int $$1, vo $$2) {
      final etd.e $$3 = new etd.e((float)$$1);
      return $$0.a(new uw.b<uw>() {
         private final esh c = new esh();
   ...
   public void a(String $$0, int $$1, vo $$2, boolean $$3, etd.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      vo $$7 = $$2;

      while ($$5 < $$6) {
         etd.b $$8 = new etd.b((float)$$1);
         boolean $$9 = aua.a($$0, $$5, $$7, $$2, $$8);
         if ($$9) {
            $$4.accept($$7, $$5, $$6);
            break;
         }
   ...
   public void a(uw $$0, int $$1, vo $$2, BiConsumer<uw, Boolean> $$3) {
      List<etd.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new etd.c($$2x, $$1x));
         }
      ...
      while ($$6) {
         $$6 = false;
         etd.b $$9 = new etd.b((float)$$1);

         for (etd.c $$10 : $$5.a) {
            boolean $$11 = aua.a($$10.c, 0, $$10.d, $$2, $$9);
            if (!$$11) {
               int $$12 = $$9.a();
               vo $$13 = $$9.b();
               char $$14 = $$5.a($$12);
   ...
   static class a {
      ...
      public uw a(int $$0, int $$1, vo $$2) {
         esh $$3 = new esh();
         ListIterator<etd.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, vo $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = etd.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements asv {
      ...
      @Override
      public boolean accept(int $$0, vo $$1, int $$2) {
         this.b = this.b - etd.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
