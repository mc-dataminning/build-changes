public abstract class etd extends eth implements eum, eve {
   private static final euw a = new euw(new afw("widget/text_field"), new afw("widget/text_field_highlighted"));
   private static final afw b = new afw("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean l;

   public etd(int $$0, int $$1, int $$2, int $$3, ui $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int v() {
      return asy.a((int)((float)(this.g * this.g) / (float)this.w()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = asy.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(esy $$0, int $$1, int $$2, int $$3, int $$4) {
      afw $$5 = a.a(this.aJ_(), this.aG_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(esy var1, int var2, int var3, float var4);
}
