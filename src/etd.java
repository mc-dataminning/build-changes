...
public class etd extends gko {
   ...
   private static final eys w = new eys(new ahg("widget/cross_button"), new ahg("widget/cross_button_highlighted"));
   ...
   protected void aN_() {
      ...
      if (this.L) {
         this.M = this.d(
            exf.a(vf.c("mco.selectServer.trial"), fbs.b(this, "https://aka.ms/startjavarealmstrial")).a(this.H() - 10 - 99, this.I() - 10 - 4 - 40, 99, 20).a()
         );
      }

      this.d(exf.a(vf.c("mco.selectServer.buy"), fbs.b(this, "https://aka.ms/BuyJavaRealms")).a(this.H() - 10 - 99, this.I() - 10 - 20, 99, 20).a());
      exr $$0 = this.d(new exr(this.D() + 4, this.E() + 4, 14, 14, w, $$0x -> this.aE_(), b));
      $$0.a(eyq.a(b));
      int $$1 = 142 - (this.L ? 40 : 20);
      exp $$2 = new exp(this.H() - 10 - 100, this.E() + 10, 100, $$1, a, this.i);
      if ($$2.j()) {
         $$2.l(100 - $$2.f());
      }
   ...
   public static void a(ewt $$0, exf $$1) {
      int $$2 = 8;
      $$0.c().a();
