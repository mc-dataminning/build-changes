...
public class etd {
   ...
   static class a implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         return $$0.c[ja.f.d()] && !$$0.b[ja.f.d()].d;
      }

      @Override
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[ja.f.d()].d = true;
         return new etd.k($$0, $$1);
      }
   }

   static class b implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         if ($$0.c[ja.f.d()] && !$$0.b[ja.f.d()].d && $$0.c[ja.b.d()] && !$$0.b[ja.b.d()].d) {
            etd.v $$1 = $$0.b[ja.f.d()];
            return $$1.c[ja.b.d()] && !$$1.b[ja.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         ...
         $$1.b[ja.f.d()].d = true;
         $$1.b[ja.b.d()].d = true;
         $$1.b[ja.f.d()].b[ja.b.d()].d = true;
         return new etd.l($$0, $$1);
      }
   }

   static class c implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         return $$0.c[ja.b.d()] && !$$0.b[ja.b.d()].d;
      }
      ...
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[ja.b.d()].d = true;
         return new etd.m($$0, $$1);
      }
   }

   static class d implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         if ($$0.c[ja.c.d()] && !$$0.b[ja.c.d()].d && $$0.c[ja.b.d()] && !$$0.b[ja.b.d()].d) {
            etd.v $$1 = $$0.b[ja.c.d()];
            return $$1.c[ja.b.d()] && !$$1.b[ja.b.d()].d;
         } else {
            return false;
      ...
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         ...
         $$1.b[ja.c.d()].d = true;
         $$1.b[ja.b.d()].d = true;
         $$1.b[ja.c.d()].b[ja.b.d()].d = true;
         return new etd.n($$0, $$1);
      }
   }

   static class e implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         return $$0.c[ja.c.d()] && !$$0.b[ja.c.d()].d;
      }

      @Override
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         etd.v $$3 = $$1;
         if (!$$1.c[ja.c.d()] || $$1.b[ja.c.d()].d) {
            $$3 = $$1.b[ja.d.d()];
         }

         $$3.d = true;
         $$3.b[ja.c.d()].d = true;
         return new etd.o($$0, $$3);
      }
   }

   static class f implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         return true;
      }
      ...
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         $$1.d = true;
         return new etd.s($$0, $$1, $$2);
      }
   }

   static class g implements etd.i {
      @Override
      public boolean a(etd.v $$0) {
         return !$$0.c[ja.e.d()] && !$$0.c[ja.f.d()] && !$$0.c[ja.c.d()] && !$$0.c[ja.d.d()] && !$$0.c[ja.b.d()];
      }

      @Override
      public etd.r a(ja $$0, etd.v $$1, azv $$2) {
         $$1.d = true;
         return new etd.t($$0, $$1);
      }
   }

   public static class h extends etd.r {
      ...
      private etd.v G;
      private etd.v H;
      private final List<etd.r> I = Lists.newArrayList();

      public h(azv $$0, int $$1, int $$2, ja $$3) {
         super(erk.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<etd.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new etd.p($$3, this.G));
         this.I.add(new etd.j($$3, this.H));
         List<etd.i> $$5 = Lists.newArrayList();
         $$5.add(new etd.b());
         $$5.add(new etd.d());
         $$5.add(new etd.e());
         $$5.add(new etd.a());
         ...
         eql $$10 = eql.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eql $$11 = eql.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eql $$12 = eql.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new etd.u($$3, $$10, $$13++));
         this.I.add(new etd.u($$3, $$11, $$13++));
         this.I.add(new etd.q($$3, $$12));
      }
      ...
      private List<etd.v> b(azv $$0) {
         etd.v[] $$1 = new etd.v[75];
         ...
         etd.v $$23 = new etd.v(1003);
         etd.v $$24 = new etd.v(1001);
         etd.v $$25 = new etd.v(1002);
         $$1[v].a(ja.b, $$23);
         $$1[w].a(ja.d, $$24);
         $$1[x].a(ja.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ja.f.d()].d = true;
         this.H.b[ja.c.d()].d = true;
         this.H.b[ja.f.d()].b[ja.c.d()].d = true;
         this.H.b[ja.b.d()].d = true;
         this.H.b[ja.f.d()].b[ja.b.d()].d = true;
         this.H.b[ja.c.d()].b[ja.b.d()].d = true;
         this.H.b[ja.f.d()].b[ja.c.d()].b[ja.b.d()].d = true;
         ObjectArrayList<etd.v> $$26 = new ObjectArrayList();
      ...
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         int $$7 = Math.max($$0.P(), 64) - this.f.i();
      ...
      private void a(boolean $$0, int $$1, dju $$2, azv $$3, eql $$4) {
         int $$5 = 24;
      ...
      private void a(dju $$0, azv $$1, eql $$2) {
      ...
      private void b(dju $$0, azv $$1, eql $$2) {
      ...
      private void c(dju $$0, azv $$1, eql $$2) {
      ...
      private void d(dju $$0, azv $$1, eql $$2) {
      ...
      private void e(dju $$0, azv $$1, eql $$2) {
      ...
      private void f(dju $$0, azv $$1, eql $$2) {
   ...
   interface i {
      boolean a(etd.v var1);

      etd.r a(ja var1, etd.v var2, azv var3);
   }

   public static class j extends etd.r {
      public j(ja $$0, etd.v $$1) {
         super(erk.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dmc.cp.m(), dmc.cp.m(), false);
   ...
   public static class k extends etd.r {
      public k(ja $$0, etd.v $$1) {
         super(erk.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         etd.v $$7 = this.B.b[ja.f.d()];
         etd.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ja.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ja.a.d()]);
         }
   ...
   public static class l extends etd.r {
      public l(ja $$0, etd.v $$1) {
         super(erk.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends etd.r {
      public m(ja $$0, etd.v $$1) {
         super(erk.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ja.a.d()]);
         }

         etd.v $$7 = this.B.b[ja.b.d()];
         if ($$7.b[ja.b.d()] == null) {
   ...
   public static class n extends etd.r {
      public n(ja $$0, etd.v $$1) {
         super(erk.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         etd.v $$7 = this.B.b[ja.c.d()];
         etd.v $$8 = this.B;
         etd.v $$9 = $$7.b[ja.b.d()];
         etd.v $$10 = $$8.b[ja.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ja.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ja.a.d()]);
         }
   ...
   public static class o extends etd.r {
      public o(ja $$0, etd.v $$1) {
         super(erk.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends etd.r {
      public p(ja $$0, etd.v $$1) {
         super(erk.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends etd.r {
      public q(ja $$0, eql $$1) {
         super(erk.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eqx {
      protected static final dzz b = dmc.iy.m();
      protected static final dzz c = dmc.iz.m();
      protected static final dzz d = dmc.iA.m();
      protected static final dzz h = c;
      protected static final dzz i = dmc.iH.m();
      protected static final boolean j = true;
      protected static final dzz k = dmc.J.m();
      protected static final Set<dma> l = ImmutableSet.builder().add(dmc.ec).add(dmc.jb).add(dmc.nz).add(k.b()).build();
      ...
      public r(erk $$0, ja $$1, int $$2, eql $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(erk $$0, int $$1, ja $$2, etd.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eql a(ja $$0, etd.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eql $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dju $$0, eql $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dzz $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.P() && $$11 != k) {
      ...
      protected void a(dju $$0, eql $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dju $$0, eql $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dzz $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eql $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dju $$0, eql $$1, int $$2, int $$3, int $$4) {
         iu $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cno $$6 = bwm.M.a($$0.a(), bwl.d);
            if ($$6 != null) {
               $$6.c($$6.eT());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bwl.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends etd.r {
      private int a;

      public s(ja $$0, etd.v $$1, azv $$2) {
         super(erk.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dju $$0, djr $$1, ebx $$2, azv $$3, eql $$4, dic $$5, iu $$6) {
         ...
         if (this.B.b[ja.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ja.a.d()] && !this.B.c[ja.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends etd.r {
      public t(ja $$0, etd.v $$1) {
         super(erk.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends etd.r {
      private int a;

      public u(ja $$0, eql $$1, int $$2) {
         super(erk.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
