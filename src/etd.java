...
public abstract class etd extends eso {
   ...
   public static etd a(int $$0, int $$1, aew $$2, int $$3, int $$4) {
      return new etd.b(0, 0, $$0, $$1, $$2, $$3, $$4);
   }

   public static etd a(int $$0, int $$1, aew $$2) {
   ...
   static class a extends etd {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, aew $$4) {
         super($$0, $$1, $$2, $$3);
         this.a = $$4;
      }
   ...
   static class b extends etd {
      ...
      public b(int $$0, int $$1, int $$2, int $$3, aew $$4, int $$5, int $$6) {
         super($$0, $$1, $$2, $$3);
         this.a = $$4;
         this.b = $$5;
         this.c = $$6;
