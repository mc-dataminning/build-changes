...
public class etd extends esf {
   ...
   public etd(ery $$0, int $$1, int $$2, int $$3, int $$4, ti $$5, ti $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new etg($$0, $$3 - this.b());
      this.o.a(this::w);
   }
   ...
   @Override
   public void a(ewd $$0) {
      $$0.a(ewc.a, ti.a("gui.narrate.editBox", this.m(), this.v()));
   }
   ...
   protected void a(esa $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         ti $$2 = ti.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void w() {
      double $$0 = this.c();
      etg.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         etg.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
