...
public class dyr {
   private static final dyr a = new dyr(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dyr.a a(int $$0, int $$1) {
         return new dyr.a(1.0, 0.0);
      }
   ...
   private static final emt b = emt.b(new dyq(42L), rg.a);
   ...
   private final Long2ObjectOpenHashMap<dys> h;
   private final Long2ObjectOpenHashMap<dys> i;

   public static dyr a() {
      return a;
   }

   public static dyr a(@Nullable ari $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dba $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dys> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dys> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayu.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dyr($$2, $$3);
         }
      }
   }

   dyr(Long2ObjectOpenHashMap<dys> $$0, Long2ObjectOpenHashMap<dys> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dyr.a a(int $$0, int $$1) {
      int $$2 = jt.a($$0);
      int $$3 = jt.a($$1);
      double $$4 = this.a($$2, 0, $$3, dys::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dyr.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jt.d(dba.a($$5x)), jt.d(dba.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = ayu.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = ayu.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dyr.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dxi.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jt.d(dba.a($$6x)), jt.d(dba.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = ayu.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = ayu.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return ayu.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dyr.b $$3) {
      int $$4 = jt.e($$0);
      int $$5 = jt.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dyr.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dys $$6 = (dys)this.h.get(dba.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jt.d($$1), $$4, $$5 - jt.d($$2)) : Double.MAX_VALUE;
   }

   public dcv a(dcv $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ji<dcs> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ji<dcs> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ji<dcs>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jt.d(dba.a($$5x)), $$1, jt.d(dba.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = ayu.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = ayu.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ji)$$4.getValue();
      }
   }

   public static void a(ari $$0, dtt $$1) {
      dba $$2 = $$1.f();
      boolean $$3 = $$1.s();
      iz.a $$4 = new iz.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dxp.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dtt $$0, iz $$1) {
      drx $$2 = $$0.a_($$1);
      if ($$2.a(awl.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(dco $$0, dun $$1) {
      dba $$2 = $$1.f();
      Builder<jf, dys> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dxl.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dyr.c a(@Nullable dys $$0, Map<jf, dys> $$1) {
      List<dyr.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dyr.c a(@Nullable jf $$0, dys $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (je $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return ayu.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dys var1, int var2, int var3, int var4);
   }
