...
public class dyr extends dyv {
   public static final Codec<dyr> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               dye.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               avq.a(ie.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, dyr::new)
   );
   ...
   protected final dye e;
   protected final int f;
   protected final List<ie> g;

   public dyr(float $$0, int $$1, int $$2, dye $$3, int $$4, List<ie> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(dyv.a $$0, hz $$1, ie $$2) {
