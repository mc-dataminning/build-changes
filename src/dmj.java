...
public class dmj extends dmr<dmi> {
   public dmj(Codec<dmi> $$0) {
      super($$0);
   }

   public boolean a(dmi $$0, ash $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dmm $$0, dmi $$1, dgz $$2, Function<gw, he<cqz>> $$3, ash $$4, djy $$5, cpi $$6, dgy $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private void a(
      ...
      for (int $$20 = $$12; $$20 < $$13; $$20++) {
         double $$21 = 1.5 + (double)(asb.a((float)$$20 * (float) Math.PI / (float)$$13) * $$9);
         double $$22 = $$21 * $$14;
         $$21 *= (double)$$1.c.e.a($$16);
         $$22 = this.a($$1, $$16, $$22, (float)$$13, (float)$$20);
         float $$23 = asb.b($$11);
         float $$24 = asb.a($$11);
         $$6 += (double)(asb.b($$10) * $$23);
         $$7 += (double)$$24;
         $$8 += (double)(asb.a($$10) * $$23);
         $$11 *= 0.7F;
         $$11 += $$19 * 0.05F;
         $$10 += $$18 * 0.05F;
         $$19 *= 0.8F;
   ...
   private float[] a(dmm $$0, dmi $$1, ash $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(dmi $$0, ash $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - asb.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)asb.b($$1, 0.75F, 1.0F);
   }

   private boolean a(dmm $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
