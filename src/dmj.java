...
public class dmj extends dmm<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dmj(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dmj $$1 && super.equals($$0)) {
   ...
   public static dmj a(String $$0, int $$1, int $$2) {
      return new dmj($$0, $$1, $$2);
   }
