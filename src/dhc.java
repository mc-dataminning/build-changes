...
public class dhc extends dhs implements cik {
   ...
   private iq<cmr> r = iq.a(9, cmr.f);
   private int s = 0;
   protected final cie l = new cie() {
   ...
   public dhc(hx $$0, dja $$1) {
      super(dgq.P, $$0, $$1);
   }

   @Override
   protected vd l() {
      return vd.c("container.crafter");
   }

   @Override
   protected chu a(int $$0, cfa $$1) {
      return new cii($$0, $$1, this, this.l);
   }
   ...
   private boolean a(int $$0, cmr $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            cmr $$4 = this.a($$3);
            if ($$4.b() || $$4.L() < $$0 && cmr.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(cti $$0, hx $$1, dja $$2, dhc $$3) {
      int $$4 = $$3.s - 1;
      if ($$4 >= 0) {
         $$3.s = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.a(cyc.b, Boolean.valueOf(false)), 3);
         }
      }
   }
