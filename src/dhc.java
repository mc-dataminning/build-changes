...
public class dhc {
   ...
   private double j;
   int k = 29999984;
   private dhc.a l = new dhc.d(5.999997E7F);
   public static final dhc.c e = new dhc.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public gw b(double $$0, double $$1, double $$2) {
      return gw.a(ary.a($$0, this.e(), this.g()), $$1, ary.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bis $$0, ehk $$1) {
      double $$2 = Math.max(ary.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dhc.a)($$0 == $$1 ? new dhc.d($$1) : new dhc.b($$0, $$1, $$2));
   ...
   class b implements dhc.a {
      ...
      @Override
      public double a() {
         return ary.a(dhc.this.a() - this.e() / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
      }

      @Override
      public double c() {
         return ary.a(dhc.this.b() - this.e() / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ary.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dhb i() {
         return this.c < this.b ? dhb.b : dhb.a;
      }
      ...
      @Override
      public dhc.a l() {
         return (dhc.a)(this.g() <= 0L ? dhc.this.new d(this.c) : this);
      }
      ...
      public eii m() {
         return eif.a(
            eif.c,
            eif.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eht.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dhc.c a(DynamicLike<?> $$0, dhc.c $$1) {
         double $$2 = ary.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ary.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dhc.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dhc.a {
      ...
      private void n() {
         this.c = ary.a(dhc.this.a() - this.b / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
         this.d = ary.a(dhc.this.b() - this.b / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
         this.e = ary.a(dhc.this.a() + this.b / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
         this.f = ary.a(dhc.this.b() + this.b / 2.0, (double)(-dhc.this.k), (double)dhc.this.k);
         this.g = eif.a(
            eif.c,
            eif.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eht.e
