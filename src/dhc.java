...
public class dhc extends dgc {
   private final boolean a;
   private final boolean b;
   private final Optional<Float> c;
   private final Optional<jv<djn>> d;

   public dhc(boolean $$0, boolean $$1, Optional<Float> $$2, Optional<jv<djn>> $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
