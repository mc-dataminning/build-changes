...
public class gfv {
   ...
   static final ThreadLocal<gfv.d> f = ThreadLocal.withInitial(gfv.d::new);

   public gfv(fhq $$0) {
      this.d = $$0;
   }

   public void a(dbz $$0, gsm $$1, dtc $$2, jd $$3, fbi $$4, fbm $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      boolean $$10 = fgo.P() && $$2.h() == 0 && $$1.a();
      exc $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(dbz $$0, gsm $$1, dtc $$2, jd $$3, fbi $$4, fbm $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      ...
      $$7.b($$8);
      List<gfw> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dbz $$0, gsm $$1, dtc $$2, jd $$3, fbi $$4, fbm $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jd.a $$11 = $$3.k();

      for (ji $$12 : c) {
         $$7.b($$8);
         List<gfw> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
      ...
      $$7.b($$8);
      List<gfw> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dbz $$0, dtc $$1, jd $$2, fbi $$3, fbm $$4, List<gfw> $$5, float[] $$6, BitSet $$7, gfv.b $$8, int $$9) {
      for (gfw $$10 : $$5) {
   ...
   private void a(
      dbz $$0, dtc $$1, jd $$2, fbm $$3, fbi.a $$4, gfw $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dbz $$0, dtc $$1, jd $$2, int $$3, int $$4, boolean $$5, fbi $$6, fbm $$7, List<gfw> $$8, BitSet $$9) {
      for (gfw $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fbi.a $$0, fbm $$1, @Nullable dtc $$2, gsm $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      ayw $$9 = ayw.a();
      long $$10 = 42L;
   ...
   private static void a(fbi.a $$0, fbm $$1, float $$2, float $$3, float $$4, List<gfw> $$5, int $$6, int $$7) {
      for (gfw $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gfv.e[]{gfv.e.k, gfv.e.d, gfv.e.k, gfv.e.j, gfv.e.e, gfv.e.j, gfv.e.e, gfv.e.d},
         new gfv.e[]{gfv.e.k, gfv.e.c, gfv.e.k, gfv.e.i, gfv.e.e, gfv.e.i, gfv.e.e, gfv.e.c},
         new gfv.e[]{gfv.e.l, gfv.e.c, gfv.e.l, gfv.e.i, gfv.e.f, gfv.e.i, gfv.e.f, gfv.e.c},
         new gfv.e[]{gfv.e.l, gfv.e.d, gfv.e.l, gfv.e.j, gfv.e.f, gfv.e.j, gfv.e.f, gfv.e.d}
      ),
      b(
         new ji[]{ji.f, ji.e, ji.c, ji.d},
         1.0F,
         true,
         new gfv.e[]{gfv.e.f, gfv.e.d, gfv.e.f, gfv.e.j, gfv.e.l, gfv.e.j, gfv.e.l, gfv.e.d},
         new gfv.e[]{gfv.e.f, gfv.e.c, gfv.e.f, gfv.e.i, gfv.e.l, gfv.e.i, gfv.e.l, gfv.e.c},
         new gfv.e[]{gfv.e.e, gfv.e.c, gfv.e.e, gfv.e.i, gfv.e.k, gfv.e.i, gfv.e.k, gfv.e.c},
         new gfv.e[]{gfv.e.e, gfv.e.d, gfv.e.e, gfv.e.j, gfv.e.k, gfv.e.j, gfv.e.k, gfv.e.d}
      ),
      c(
         new ji[]{ji.b, ji.a, ji.f, ji.e},
         0.8F,
         true,
         new gfv.e[]{gfv.e.b, gfv.e.k, gfv.e.b, gfv.e.e, gfv.e.h, gfv.e.e, gfv.e.h, gfv.e.k},
         new gfv.e[]{gfv.e.b, gfv.e.l, gfv.e.b, gfv.e.f, gfv.e.h, gfv.e.f, gfv.e.h, gfv.e.l},
         new gfv.e[]{gfv.e.a, gfv.e.l, gfv.e.a, gfv.e.f, gfv.e.g, gfv.e.f, gfv.e.g, gfv.e.l},
         new gfv.e[]{gfv.e.a, gfv.e.k, gfv.e.a, gfv.e.e, gfv.e.g, gfv.e.e, gfv.e.g, gfv.e.k}
      ),
      d(
         new ji[]{ji.e, ji.f, ji.a, ji.b},
         0.8F,
         true,
         new gfv.e[]{gfv.e.b, gfv.e.k, gfv.e.h, gfv.e.k, gfv.e.h, gfv.e.e, gfv.e.b, gfv.e.e},
         new gfv.e[]{gfv.e.a, gfv.e.k, gfv.e.g, gfv.e.k, gfv.e.g, gfv.e.e, gfv.e.a, gfv.e.e},
         new gfv.e[]{gfv.e.a, gfv.e.l, gfv.e.g, gfv.e.l, gfv.e.g, gfv.e.f, gfv.e.a, gfv.e.f},
         new gfv.e[]{gfv.e.b, gfv.e.l, gfv.e.h, gfv.e.l, gfv.e.h, gfv.e.f, gfv.e.b, gfv.e.f}
      ),
      e(
         new ji[]{ji.b, ji.a, ji.c, ji.d},
         0.6F,
         true,
         new gfv.e[]{gfv.e.b, gfv.e.d, gfv.e.b, gfv.e.j, gfv.e.h, gfv.e.j, gfv.e.h, gfv.e.d},
         new gfv.e[]{gfv.e.b, gfv.e.c, gfv.e.b, gfv.e.i, gfv.e.h, gfv.e.i, gfv.e.h, gfv.e.c},
         new gfv.e[]{gfv.e.a, gfv.e.c, gfv.e.a, gfv.e.i, gfv.e.g, gfv.e.i, gfv.e.g, gfv.e.c},
         new gfv.e[]{gfv.e.a, gfv.e.d, gfv.e.a, gfv.e.j, gfv.e.g, gfv.e.j, gfv.e.g, gfv.e.d}
      ),
      f(
         new ji[]{ji.a, ji.b, ji.c, ji.d},
         0.6F,
         true,
         new gfv.e[]{gfv.e.g, gfv.e.d, gfv.e.g, gfv.e.j, gfv.e.a, gfv.e.j, gfv.e.a, gfv.e.d},
         new gfv.e[]{gfv.e.g, gfv.e.c, gfv.e.g, gfv.e.i, gfv.e.a, gfv.e.i, gfv.e.a, gfv.e.c},
         new gfv.e[]{gfv.e.h, gfv.e.c, gfv.e.h, gfv.e.i, gfv.e.b, gfv.e.i, gfv.e.b, gfv.e.c},
         new gfv.e[]{gfv.e.h, gfv.e.d, gfv.e.h, gfv.e.j, gfv.e.b, gfv.e.j, gfv.e.b, gfv.e.d}
      );
      ...
      final gfv.e[] k;
      final gfv.e[] l;
      private static final gfv.a[] m = ad.a(new gfv.a[6], $$0 -> {
         $$0[ji.a.d()] = a;
         $$0[ji.b.d()] = b;
         $$0[ji.c.d()] = c;
         $$0[ji.d.d()] = d;
      ...
      private a(final ji[] $$0, final float $$1, final boolean $$2, final gfv.e[] $$3, final gfv.e[] $$4, final gfv.e[] $$5, final gfv.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gfv.c[] k = ad.a(new gfv.c[6], $$0 -> {
         $$0[ji.a.d()] = a;
         $$0[ji.b.d()] = b;
         $$0[ji.c.d()] = c;
         $$0[ji.d.d()] = d;
