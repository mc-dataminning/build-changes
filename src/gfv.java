...
public abstract class gfv implements zc {
   ...
   protected gfv(fli $$0, vi $$1, ggd $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   protected fuk b(vk $$0) {
      ...
      return (fuk)(this.c != null && this.c.e() ? new hla($$1, k, $$0.a()) : new ftr($$1, k, $$0));
   }
   ...
   private fuk a(UUID $$0, URL $$1, String $$2, boolean $$3, @Nullable wp $$4) {
      fuk $$5 = this.a.z;
   ...
   class b extends fti {
      ...
      b(final fli $$0, @Nullable final fuk $$1, final List<gfv.b.a> $$2, final boolean $$3, @Nullable final wp $$4) {
         super(
            $$5 -> {
               $$0.a($$1);
               hhq $$6 = $$0.af();
               if ($$5) {
                  ...
                  $$6.h();
                  if ($$3) {
                     gfv.this.b.a(wp.c("multiplayer.requiredTexturePrompt.disconnect"));
            ...
            gfv.a($$3 ? wp.c("multiplayer.requiredTexturePrompt.line2").a(n.o, n.r) : wp.c("multiplayer.texturePrompt.line2"), $$4),
            $$3 ? wo.i : wo.f,
            $$3 ? wo.p : wo.g
         );
         this.s = $$2;
      ...
      public gfv.b a(fli $$0, UUID $$1, URL $$2, String $$3, boolean $$4, @Nullable wp $$5) {
