...
public class gfv {
   ...
   public static class a extends Thread {
      private final gfv.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gfv.b $$0) throws IOException {
         super("LanServerDetector #" + gfv.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gfv.b));
   ...
   public static class b {
      ...
      @Nullable
      public synchronized List<gfu> a() {
         if (this.b) {
            List<gfu> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
