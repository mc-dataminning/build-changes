...
public class cnl extends cnp {
   ...
   public cnl(cmx $$0, dcw $$1, int $$2, int $$3) {
      ...
      double $$10 = $$0.dt() - (double)$$7 * 0.3;
      double $$11 = $$0.dx();
      double $$12 = $$0.dz() - (double)$$6 * 0.3;
      this.b($$10, $$11, $$12, $$5, $$4);
      exc $$13 = new exc((double)(-$$7), (double)ayo.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
   ...
   public void a(ajw<?> $$0) {
      if (g.equals($$0)) {
         int $$1 = this.ar().a(g);
         this.o = $$1 > 0 ? this.dO().a($$1 - 1) : null;
      }

      if (h.equals($$0)) {
         this.d = this.ar().a(h);
         if (this.d) {
            this.n(this.dr().c, (double)(-0.4F * ayo.a(this.c, 0.6F, 1.0F)), this.dr().e);
         }
      }
   ...
   public void l() {
      ...
      if ($$0 == null) {
         ...
         if (this.p == cnl.a.a) {
            ...
            if (this.p == cnl.a.c) {
               exc $$5 = this.dr();
               double $$6 = this.dv() + $$5.d - (double)$$2.v() - (double)$$1;
               if (Math.abs($$6) < 0.01) {
                  $$6 += Math.signum($$6) * 0.1;
               }
   ...
   private boolean a(cmx $$0) {
      ...
      if (!$$0.dJ() && $$0.bE() && ($$3 || $$4) && !(this.g($$0) > 1024.0)) {
         return false;
      } else {
         this.aq();
         return true;
   ...
   private void a(jd $$0) {
      ...
      int $$2 = 1;
      jd $$3 = $$0.d();
      if (this.ah.i() < 0.25F && this.dO().r($$3)) {
         $$2++;
      }

      if (this.ah.i() < 0.5F && !this.dO().h($$3)) {
         $$2--;
      }
      ...
      if (this.j > 0) {
         ...
         if (this.l > 0) {
            ...
            float $$5 = ayo.a($$4);
            float $$6 = ayo.b($$4);
            double $$7 = this.dt() + (double)($$5 * (float)this.l * 0.1F);
            double $$8 = (double)((float)ayo.a(this.dv()) + 1.0F);
            double $$9 = this.dz() + (double)($$6 * (float)this.l * 0.1F);
            ...
            double $$13 = this.dv() + 0.5;
            $$1.a(lm.d, this.dt(), $$13, this.dz(), (int)(1.0F + this.dj() * 20.0F), (double)this.dj(), 0.0, (double)this.dj(), 0.2F);
            $$1.a(lm.E, this.dt(), $$13, this.dz(), (int)(1.0F + this.dj() * 20.0F), (double)this.dj(), 0.0, (double)this.dj(), 0.2F);
         ...
         if (this.ah.i() < $$14) {
            ...
            double $$17 = this.dt() + (double)(ayo.a($$15) * $$16) * 0.1;
            double $$18 = (double)((float)ayo.a(this.dv()) + 1.0F);
            double $$19 = this.dz() + (double)(ayo.b($$15) * $$16) * 0.1;
   ...
   private cnl.b c(jd $$0) {
      ...
      if (!$$1.i() && !$$1.a(dga.fm)) {
         epe $$2 = $$1.u();
         return $$2.a(awk.a) && $$2.b() && $$1.k(this.dO(), $$0).c() ? cnl.b.b : cnl.b.c;
      } else {
         return cnl.b.a;
      }
   }
   ...
   public int a(cuq $$0) {
      cmx $$1 = this.t();
      if (!this.dO().B && $$1 != null && !this.a($$1)) {
         int $$2 = 0;
         if (this.o != null) {
            this.d(this.o);
            an.E.a((aqv)$$1, $$0, this, Collections.emptyList());
            this.dO().a(this, (byte)31);
            $$2 = this.o instanceof cjh ? 3 : 5;
         } else if (this.j > 0) {
            eru $$3 = new eru.a((aqu)this.dO()).a(eun.f, this.dm()).a(eun.i, $$0).a(eun.a, this).a((float)this.q + $$1.gu()).a(eum.f);
            erw $$4 = this.dO().o().be().b(ern.aC);
            List<cuq> $$5 = $$4.a($$3);
            an.E.a((aqv)$$1, $$0, this, $$5);

            for (cuq $$6 : $$5) {
               cjh $$7 = new cjh(this.dO(), this.dt(), this.dv(), this.dz(), $$6);
               double $$8 = $$1.dt() - this.dt();
               double $$9 = $$1.dv() - this.dv();
               double $$10 = $$1.dz() - this.dz();
               double $$11 = 0.1;
               $$7.n($$8 * 0.1, $$9 * 0.1 + Math.sqrt(Math.sqrt($$8 * $$8 + $$9 * $$9 + $$10 * $$10)) * 0.08, $$10 * 0.1);
               this.dO().b($$7);
               $$1.dO().b(new btc($$1.dO(), $$1.dt(), $$1.dv() + 0.5, $$1.dz() + 0.5, this.ah.a(6) + 1));
               if ($$6.a(awn.aP)) {
                  $$1.a(avz.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dO().B && this.o instanceof cmx && ((cmx)this.o).g()) {
         this.d(this.o);
      }
   ...
   protected void d(bsr $$0) {
      bsr $$1 = this.s();
      if ($$1 != null) {
         exc $$2 = new exc($$1.dt() - this.dt(), $$1.dv() - this.dv(), $$1.dz() - this.dz()).a(0.1);
         $$0.i($$0.dr().e($$2));
      }
   }
   ...
   public void a(abv $$0) {
      ...
      if (this.t() == null) {
         int $$1 = $$0.p();
         b.error("Failed to recreate fishing hook on client. {} (id: {}) is not a valid owner.", this.dO().a($$1), $$1);
         this.ap();
      }
   }
