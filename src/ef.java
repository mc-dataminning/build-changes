...
public record ef(List<ef.c> c) {
   ...
   public <S extends dwy<?, S>> boolean a(dwx<?, S> $$0, S $$1) {
      for (ef.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(dwx<?, ?> $$0) {
      for (ef.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public ef.a a(dxy<?> $$0, String $$1) {
         this.a.add(new ef.c($$0.f(), new ef.b($$1)));
         return this;
      }

      public ef.a a(dxy<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public ef.a a(dxy<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & azv> ef.a a(dxy<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String e) implements ef.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dwy<?, ?> $$0, dxy<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(dwy<?, ?> var1, dxy<T> var2);
   }
}
