...
public record ef(List<ef.c> c) {
   ...
   public <S extends dwx<?, S>> boolean a(dww<?, S> $$0, S $$1) {
      for (ef.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(dww<?, ?> $$0) {
      for (ef.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public ef.a a(dxx<?> $$0, String $$1) {
         this.a.add(new ef.c($$0.f(), new ef.b($$1)));
         return this;
      }

      public ef.a a(dxx<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public ef.a a(dxx<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & azu> ef.a a(dxx<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String e) implements ef.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dwx<?, ?> $$0, dxx<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(dwx<?, ?> var1, dxx<T> var2);
   }
}
