...
public interface dfo extends dgl {
   int g = 16;
   ...
   default fax a(dfq $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dwy $$2 = this.a_($$1);
         fbb $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new fax($$0x.a(), jn.a($$3.d, $$3.e, $$3.f), ji.a((kb)$$0x.a()), false) : null;
      }, $$0x -> {
         fbb $$1 = $$0x.b().d($$0x.a());
         return fax.a($$0x.a(), jn.a($$1.d, $$1.e, $$1.f), ji.a((kb)$$0x.a()));
      });
   }
   ...
   @Nullable
   default fax a(fbb $$0, fbb $$1, ji $$2, fbv $$3, dwy $$4) {
      fax $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         fax $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(fbv $$0, Supplier<fbv> $$1) {
      if (!$$0.c()) {
         return $$0.c(jn.a.b);
      } else {
   ...
   static <T, C> T a(fbb $$0, fbb $$1, C $$2, BiFunction<C, ji, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<ji> a(fbb $$0, fbb $$1, faw $$2) {
      fbb $$3 = $$1.d($$0);
   ...
   private static void a(Set<ji> $$0, fbb $$1, fbb $$2, faw $$3) {
      fbb $$4 = $$2.d($$1);
      int $$5 = ayz.a($$1.d);
      int $$6 = ayz.a($$1.e);
      int $$7 = ayz.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<fbb> $$18 = faw.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            fbb $$19 = $$18.get();
