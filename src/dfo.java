...
public class dfo {
   ...
   @Nullable
   @VisibleForTesting
   public dfo.b a(cpy $$0, gw $$1, ha $$2, ha $$3) {
      LoadingCache<gw, dfn> $$4 = a($$0, false);
      return this.a($$1, $$2, $$3, $$4);
   }

   @Nullable
   private dfo.b a(gw $$0, ha $$1, ha $$2, LoadingCache<gw, dfn> $$3) {
   ...
   public static class b {
      ...
      public b(gw $$0, ha $$1, ha $$2, LoadingCache<gw, dfn> $$3, int $$4, int $$5, int $$6) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
