...
public class fdn implements AutoCloseable {
   ...
   public fdn(fdl $$0, fdm $$1, ByteBuffer $$2) {
   ...
   public fdn.a a(int $$0, int $$1) {
      if (this.f) {
         ...
         return $$2 == null ? null : new fdn.a(this.d.h, $$2);
      }
   }
