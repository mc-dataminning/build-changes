...
public class fdn {
   private static final ahg a = new ahg("advancements/title_box");
   ...
   private final atz r;
   private final int s;
   private final List<atz> t;
   private final evg u;
   @Nullable
   private fdn v;
   private final List<fdn> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fdn(fdl $$0, evg $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = si.a().a($$1.h.a($$3.a(), 163));
      this.y = aun.d($$3.f() * 28.0F);
      this.z = aun.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = si.a().a(this.a(vi.a($$3.b().f(), wc.a.a($$3.e().a())), $$7));
   ...
   private static float a(evs $$0, List<vk> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<vk> a(vf $$0, int $$1) {
      evs $$2 = this.u.h.b();
      List<vk> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<vk> $$6 = $$2.b($$0, $$1 - $$5, wc.a);
   ...
   public void a(ews $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
