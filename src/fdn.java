...
public class fdn {
   ...
   fdn(List<fdo> $$0, List<String> $$1, IntList $$2, int $$3) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      this.e = $$0.stream().mapToInt(fdo::a).reduce(0, ($$0x, $$1x) -> $$0x | $$1x);
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof fdn $$1 && this.e == $$1.e && this.d == $$1.d && this.c.equals($$1.c) && Arrays.equals(this.f, $$1.f)) {
            return true;
         }
   ...
   public static class a {
      private final Builder<String, fdo> a = ImmutableMap.builder();
      ...
      public fdn a() {
         ImmutableMap<String, fdo> $$0 = this.a.buildOrThrow();
         ImmutableList<fdo> $$1 = $$0.values().asList();
         ImmutableList<String> $$2 = $$0.keySet().asList();
         return new fdn($$1, $$2, this.b, this.c);
      }
   }
