public class fdn extends fex<bvo> implements fdp {
   private final fhn a;
   private final fhn b;
   private final fhn f;
   private final fhn g;
   ...
   public static fht b() {
      fhv $$0 = new fhv();
      fhw $$1 = $$0.a();
      fhw $$2 = $$1.a("root", fhs.c(), fhp.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", fhs.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new fhr(0.0F)), fhp.a(0.0F, -3.99F, 0.0F));
      fhw $$3 = $$2.a(
         "body",
         fhs.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new fhr(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new fhr(-0.2F)),
         fhp.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", fhs.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fhr(-0.01F)), fhp.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", fhs.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new fhr(-0.01F)), fhp.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", fhs.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fhr(0.0F)), fhp.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", fhs.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new fhr(0.0F)), fhp.a(0.5F, 0.0F, 0.6F));
      return fht.a($$0, 32, 32);
   }

   public void a(bvo $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
