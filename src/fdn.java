...
public class fdn<T> implements fdm<T> {
   private static final Comparator<fdl<?>> a = ($$0, $$1) -> fdq.b.compare($$0.b(), $$1.b());
   ...
   private final BiConsumer<fdl<T>, fdq<T>> i = ($$0x, $$1) -> {
      if ($$1.equals($$0x.b())) {
         this.b($$1);
      }
   };

   public fdn(LongPredicate $$0) {
      this.b = $$0;
   }

   public void a(dgo $$0, fdl<T> $$1) {
      long $$2 = $$0.a();
      this.c.put($$2, $$1);
      fdq<T> $$3 = $$1.b();
      if ($$3 != null) {
   ...
   private void a(long $$0, int $$1, bpt $$2) {
      this.a($$0);
   ...
   private void b(fdq<T> $$0) {
      this.d.put(dgo.a($$0.b()), $$0.c());
   }

   private void a(Queue<fdl<T>> $$0, fdl<T> $$1, long $$2, int $$3) {
      if (this.a($$3)) {
         fdl<T> $$4 = $$0.peek();
         fdq<T> $$5 = $$4 != null ? $$4.b() : null;

         while (this.a($$3)) {
            fdq<T> $$6 = $$1.b();
            if ($$6 == null || $$6.c() > $$2 || $$5 != null && fdq.b.compare($$6, $$5) > 0) {
               break;
            }
   ...
   public boolean a(jh $$0, T $$1) {
      fdl<T> $$2 = (fdl<T>)this.c.get(dgo.a($$0));
   ...
   public boolean b(jh $$0, T $$1) {
      this.d();
      return this.h.contains(fdq.a($$1, $$0));
   }
   ...
   private void a(eoc $$0, fdn.a<T> $$1) {
   ...
   public void a(eoc $$0, kl $$1) {
      this.a(this, $$0, $$1);
   }

   public void a(fdn<T> $$0, eoc $$1, kl $$2) {
      List<fdq<T>> $$3 = new ArrayList<>();
      Predicate<fdq<T>> $$4 = $$1x -> $$1.b($$1x.b());
      $$0.g.stream().filter($$4).forEach($$3::add);
      $$0.f.stream().filter($$4).forEach($$3::add);
      $$0.a($$1, ($$2x, $$3x) -> $$3x.d().filter($$4).forEach($$3::add));
      LongSummaryStatistics $$5 = $$3.stream().mapToLong(fdq::e).summaryStatistics();
      long $$6 = $$5.getMin();
      long $$7 = $$5.getMax();
      $$3.forEach($$3x -> this.a(new fdq<>((T)$$3x.a(), $$3x.b().a($$2), $$3x.c(), $$3x.d(), $$3x.e() - $$6 + $$7 + 1L)));
   }

   @Override
   public int a() {
      return this.c.values().stream().mapToInt(fds::a).sum();
   }

   @FunctionalInterface
   interface a<T> {
      void accept(long var1, fdl<T> var3);
   }
}
