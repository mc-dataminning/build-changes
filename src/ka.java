...
public abstract class ka implements kd {
   ...
   protected final Map<aew, ecy.a> f;
   ...
   protected ka(Set<cja> $$0, cec $$1) {
      this($$0, $$1, new HashMap<>());
   }

   protected ka(Set<cja> $$0, cec $$1, Map<aew, ecy.a> $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
   }
            ...
            ecx.a()
               .a(
                  (edj.a<?>)this.a(
                     ...
                     edg.a($$0)
                        .a($$1)
                        .a(ha.values(), $$1x -> eeo.a(egi.a(1.0F), true).a(efo.a($$0).a(da.a.a().a(cxt.b($$1x), true))))
