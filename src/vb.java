...
public class vb extends uw<vc> {
   ...
   public static final vw<vb> a = new vw.b<vb>() {
      public vb a(DataInput $$0, vg $$1) throws IOException {
         return new vb(d($$0, $$1));
      }
      ...
      private static int[] d(DataInput $$0, vg $$1) throws IOException {
         $$1.b(24L);
         int $$2 = $$0.readInt();
         $$1.a(4L, (long)$$2);
         int[] $$3 = new int[$$2];
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof vb && Arrays.equals(this.c, ((vb)$$0).c);
   }
   ...
   public vc a(int $$0, vc $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return vc.a($$2);
   }

   public void b(int $$0, vc $$1) {
   ...
   public boolean b(int $$0, vu $$1) {
      if ($$1 instanceof vn) {
         this.c = ArrayUtils.add(this.c, $$0, ((vn)$$1).g());
         return true;
      } else {
         return false;
      }
