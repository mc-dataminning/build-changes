...
public class vb implements va {
   ...
   private static final wy z = wy.b("L").a(i);
   private static final wy A = wy.b("f").a(i);
   private static final wy B = wy.b("d").a(i);
   private static final wy C = wy.b("B").a(i);
   private final String D;
   private int E;
   private int F;
   private final xm G = wy.i();
   ...
   public void a(uu $$0) {
      ...
      wy $$3 = wy.b($$1.substring(1, $$1.length() - 1)).a(g);
      this.G.f($$2).b($$3).f($$2);
   }

   @Override
   public void a(tx $$0) {
      this.G.b(wy.b(String.valueOf($$0.l())).a(h)).b(w);
   }

   @Override
   public void a(ur $$0) {
      this.G.b(wy.b(String.valueOf($$0.l())).a(h)).b(x);
   }

   @Override
   public void a(ue $$0) {
      this.G.b(wy.b(String.valueOf($$0.l())).a(h));
   }

   @Override
   public void a(uh $$0) {
      this.G.b(wy.b(String.valueOf($$0.l())).a(h)).b(z);
   }

   @Override
   public void a(uc $$0) {
      this.G.b(wy.b(String.valueOf($$0.k())).a(h)).b(A);
   }

   @Override
   public void a(ua $$0) {
      this.G.b(wy.b(String.valueOf($$0.j())).a(h)).b(B);
   }
   ...
   public void a(tw $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         xm $$3 = wy.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(C);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   public void a(ud $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         this.G.f(" ").b(wy.b(String.valueOf($$1[$$2])).a(h));
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
      }
   ...
   public void a(ug $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         wy $$3 = wy.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(z);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   protected static wy a(String $$0) {
      if (j.matcher($$0).matches()) {
         return wy.b($$0).a(f);
      } else {
         String $$1 = uu.b($$0);
         String $$2 = $$1.substring(0, 1);
         wy $$3 = wy.b($$1.substring(1, $$1.length() - 1)).a(f);
         return wy.b($$2).b($$3).f($$2);
      }
   }
