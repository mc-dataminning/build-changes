...
public interface boi {
   static boc<StringReader> a(String $$0) {
      return new boi.b($$0);
   }

   static boc<StringReader> a(char $$0) {
      return new boi.a($$0);
   }

   public static record a(char a) implements boc<StringReader> {
      @Override
      public boolean a(bny<StringReader> $$0, boa $$1, bnu $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements boc<StringReader> {
      @Override
      public boolean a(bny<StringReader> $$0, boa $$1, bnu $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
