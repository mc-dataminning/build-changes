...
public class boi implements boj {
   ...
   private static final boi k = new boi();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(boh $$0) {
      URL $$1 = boi.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, boh $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bol a = new bol(() -> boi.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == boi.this.l && $$0.getState() == RecordingState.STOPPED) {
