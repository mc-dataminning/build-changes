...
public record boi(Instant a, String b, long c) {
   ...
   public static boi a(RecordedEvent $$0) {
      ...
      return new boi($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static boi.a a(List<boi> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<boi>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            boi $$3 = (boi)$$2x.get(0);
            boi $$4 = (boi)$$2x.get($$2x.size() - 1);
