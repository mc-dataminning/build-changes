...
public class fye implements fyx {
   ...
   private CompletableFuture<Optional<cmn>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public fye(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cmn::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cmn>> a(Optional<cmn> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (axe | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cmn.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cmn $$0) {
      ...
      if ($$0 != null) {
         if (aa.aU) {
            cmn.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cmn a(UserApiService $$0) throws axe, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cmo.a $$2 = a($$1);
         return new cmn(axd.a($$1.keyPair().privateKey()), new cmo($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cmo.a a(KeyPairResponse $$0) throws axe {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = axd.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cmo.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new axe(var5);
         }
      } else {
         throw new axe(new MissingException("Missing public key"));
      }
   }
}
