...
public class fye implements fpt, fqn {
   ...
   public fye(fym $$0, boolean $$1) {
      this.l = $$0;
      this.m = $$1;
   }

   public void a(fyj $$0, baj $$1, boolean $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      this.j = $$0;
      List<dci> $$8 = $$0.a(fyj.a.b);
      List<dci> $$9 = $$2 ? Collections.emptyList() : $$0.a(fyj.a.c);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      float $$17 = (float)($$6 + 50);
      if ($$16 > $$17) {
         this.i = (int)((float)this.i - $$7 * (float)ayy.f(($$16 - $$17) / $$7));
      }

      float $$18 = (float)this.i;
      float $$19 = (float)($$6 - 100);
      if ($$18 < $$19) {
         this.i = (int)((float)this.i - $$7 * (float)ayy.f(($$18 - $$19) / $$7));
      }
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         dci $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.h + 4 + 25 * ($$20 % $$12);
         int $$24 = this.i + 5 + 25 * ($$20 / $$12);
         if (this.m) {
            this.f.add(new fye.c($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         } else {
            this.f.add(new fye.a($$23, $$24, $$22.a(), $$22.b(), $$1, $$21));
         }
      }
   ...
   public void a(fob $$0, int $$1, int $$2, float $$3) {
      if (this.g) {
         ...
         int $$6 = ayy.f((float)this.f.size() / (float)$$4);
         int $$7 = 4;
         $$0.a(gmf::H, b, this.h, this.i, $$5 * 25 + 8, $$6 * 25 + 8);
   ...
   class a extends fye.b {
      ...
      public a(final int $$0, final int $$1, final dcj $$2, final dch $$3, final baj $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<fye.b.a> a(dch $$0, baj $$1) {
         List<fye.b.a> $$2 = new ArrayList<>();
   ...
   abstract class b extends fon {
      final dcj b;
      private final boolean c;
      private final List<fye.b.a> d;

      public b(final int $$0, final int $$1, final dcj $$2, final boolean $$3, final List<fye.b.a> $$4) {
      ...
      protected static fye.b.a a(int $$0, int $$1, List<cwn> $$2) {
         return new fye.b.a(3 + $$0 * 7, 3 + $$1 * 7, $$2);
      }
      ...
      public void b(fob $$0, int $$1, int $$2, float $$3) {
         $$0.a(gmf::H, this.b(this.c), this.F(), this.G(), this.g, this.h);
         float $$4 = (float)(this.F() + 2);
         float $$5 = (float)(this.G() + 2);
         float $$6 = 150.0F;

         for (fye.b.a $$7 : this.d) {
            $$0.c().a();
            $$0.c().a($$4 + (float)$$7.a, $$5 + (float)$$7.b, 150.0F);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0F, -8.0F, 0.0F);
            $$0.a($$7.a(fye.this.l.currentIndex()), 0, 0);
            $$0.c().b();
         }
      }

      protected static record a(int a, int b, List<cwn> c) {

         public a(int a, int b, List<cwn> c) {
            if (c.isEmpty()) {
   ...
   class c extends fye.b {
      ...
      public c(final int $$0, final int $$1, final dcj $$2, final dch $$3, final baj $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<fye.b.a> a(dch $$0, baj $$1) {
         if ($$0 instanceof dcg $$2) {
            List<cwn> $$3 = $$2.b().a($$1);
            if (!$$3.isEmpty()) {
