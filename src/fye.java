...
public class fye extends fyb {
   ...
   private int J;
   private final fta K = new fta(false);

   public fye(boolean $$0, Runnable $$1) {
      super(fop.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(frv $$0) {
      $$0.a(gqk::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
