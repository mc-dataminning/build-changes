...
public class fye implements etp, AutoCloseable {
   ...
   private static final eti t = new eti();
   ...
   private final List<etq> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, etq> C = Maps.newHashMap();
   private final int D;
   ...
   public fye(asr $$0, String $$1, eue $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         this.H = a($$0, etn.a.a, $$6);
         this.I = a($$0, etn.a.b, $$7);
         this.D = eto.a();
         int $$18 = 0;
   ...
   private static etn a(final asr $$0, etn.a $$1, String $$2) throws IOException {
      etn $$3 = $$1.c().get($$2);
      etn $$8;
      if ($$3 == null) {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        fye.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static etj a(JsonObject $$0) {
      if ($$0 == null) {
         return new etj();
      } else {
         int $$1 = 32774;
