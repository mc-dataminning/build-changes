...
public class fye extends fxu implements gjm.a {
   ...
   private final fvq I = new fvq(this);
   @Nullable
   private final fxu J;
   private final gjm K;
   private final Map<ai, fya> L = Maps.newLinkedHashMap();
   @Nullable
   private fya M;
   private boolean N;
   ...
   public fye(gjm $$0, @Nullable fxu $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aN_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fya $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(fsc.a(wx.d, $$0x -> this.aK_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fro $$0, int $$1, int $$2) {
      $$0.a(gqc::H, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fya $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fya $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fro $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(aj $$0) {
      fya $$1 = fya.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
