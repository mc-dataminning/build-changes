...
public class fyd extends ftr {
   private static final xk a = xk.c("gui.abuseReport.reason.title");
   private static final xk b = xk.c("gui.abuseReport.reason.description");
   private static final xk c = xk.c("gui.abuseReport.read_info");
   ...
   @Nullable
   ggm x;
   private final Consumer<ggm> y;
   final frn z = new frn(this);
   final ggn A;

   public fyd(@Nullable ftr $$0, @Nullable ggm $$1, ggn $$2, Consumer<ggm> $$3) {
      super(a);
      this.v = $$0;
      this.x = $$1;
      this.y = $$3;
   ...
   protected void aT_() {
      ...
      $$2.a(fny.a(c, fso.b(this, ayq.m)).a());
      $$2.a(fny.a(xj.d, $$0x -> {
         fyd.a.a $$1x = this.w.g();
         if ($$1x != null) {
            this.y.accept($$1x.b());
   ...
   public class a extends fov<fyd.a.a> {
      public a(final flz $$1) {
         ...
         for (ggm $$2 : ggm.values()) {
            if (!ggm.a(fyd.this.A).contains($$2)) {
      ...
      public class a extends fov.a<fyd.a.a> {
         ...
         @Override
         public xk a() {
            return xk.a("gui.abuseReport.reason.narration", this.b.b(), this.b.c());
         }
