public class fyd extends fzj<gut> implements fyg {
   private final gcl a = this.v.b("head");
   private final gcl b = this.v.b("body");
   private final gcl c = this.b.b("right_arm");
   private final gcl d = this.b.b("left_arm");
   private final gcl e = this.b.b("right_wing");
   private final gcl f = this.b.b("left_wing");
   ...
   public static gcr a() {
      gct $$0 = new gct();
      gcv $$1 = $$0.a();
      gcv $$2 = $$1.a("root", gcq.c(), gcn.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", gcq.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new gcp(0.0F)), gcn.a(0.0F, -3.99F, 0.0F));
      gcv $$3 = $$2.a(
         "body",
         gcq.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new gcp(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new gcp(-0.2F)),
         gcn.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", gcq.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gcp(-0.01F)), gcn.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", gcq.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gcp(-0.01F)), gcn.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", gcq.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gcp(0.0F)), gcn.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", gcq.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gcp(0.0F)), gcn.a(0.5F, 0.0F, 0.6F));
