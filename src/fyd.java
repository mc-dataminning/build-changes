public class fyd extends fpq<fyd.a> {
   ...
   public fyd(flk $$0, fyc $$1, int $$2, int $$3, wp $$4) {
   ...
   public static class a extends fpq.a<fyd.a> {
      ...
      private static ayl a(flk $$0, wp $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fpn b(flk $$0, wp $$1) {
         return fpn.a($$0.h, 157, 2, $$1);
      }
      ...
      public void a(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(gmj::H, this.f.a(), $$3, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
         ayl $$12 = this.g;
         fpn $$13 = this.h;
         if (this.d() && (this.a.n.ac().c() || $$8 || this.e.p() == this && this.e.aM_())) {
            ...
            if (this.f.o()) {
               if ($$14 < 32) {
                  $$0.a(gmj::H, fyd.a, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gmj::H, fyd.m, $$3, $$2, 32, 32);
               }
            } else {
               if (this.f.p()) {
                  if ($$14 < 16) {
                     $$0.a(gmj::H, fyd.n, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gmj::H, fyd.o, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.q()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 < 16) {
                     $$0.a(gmj::H, fyd.p, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gmj::H, fyd.q, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.r()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 > 16) {
                     $$0.a(gmj::H, fyd.r, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gmj::H, fyd.s, $$3, $$2, 32, 32);
                  }
               }
            }
         }
