public class fyd implements fxm<dkh> {
   public fyd(fxn.a $$0) {
   }

   public void a(dkh $$0, float $$1, esa $$2, fvm $$3, int $$4, int $$5) {
      if (exh.O().s.gq() || exh.O().s.P_()) {
         ...
         if ($$7.u() >= 1 && $$7.v() >= 1 && $$7.w() >= 1) {
            if ($$0.x() == dmp.a || $$0.x() == dmp.b) {
               ...
               float $$35 = 0.9F;
               float $$36 = 0.5F;
               ese $$37 = $$3.getBuffer(fvu.w());
               if ($$0.x() == dmp.a || $$0.H()) {
                  fvk.a($$2, $$37, $$30, $$10, $$31, $$32, $$11, $$33, 0.9F, 0.9F, 0.9F, 1.0F, 0.5F, 0.5F, 0.5F);
               }
   ...
   private void a(dkh $$0, ese $$1, hz $$2, esa $$3) {
      ...
      for (hz $$7 : hz.a($$6, $$6.a($$0.k()).b(-1, -1, -1))) {
         ...
         if ($$9 || $$13) {
            ...
            if ($$9) {
               fvk.a($$3, $$1, $$15, $$16, $$17, $$18, $$19, $$20, 0.5F, 0.5F, 1.0F, 1.0F, 0.5F, 0.5F, 1.0F);
            } else if ($$10) {
               fvk.a($$3, $$1, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 0.75F, 0.75F, 1.0F, 1.0F, 0.75F, 0.75F);
            } else if ($$11) {
               fvk.a($$3, $$1, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F);
            } else if ($$12) {
               fvk.a($$3, $$1, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F);
            }
         }
      }
   }
