...
public class bum {
   private final Map<bul, List<fba>> a;

   bum(Map<bul, List<fba>> $$0) {
      this.a = $$0;
   }
   ...
   public bum a(float $$0, float $$1, float $$2) {
      Map<bul, List<fba>> $$3 = new EnumMap<>(bul.class);

      for (Entry<bul, List<fba>> $$4 : this.a.entrySet()) {
   ...
   @Nullable
   public fba a(bul $$0, int $$1, float $$2) {
      List<fba> $$3 = this.a.get($$0);
      return $$1 >= 0 && $$1 < $$3.size() ? a($$3.get($$1), $$2) : null;
   }

   public fba b(bul $$0, int $$1, float $$2) {
      fba $$3 = this.a($$0, $$1, $$2);
      if ($$3 == null) {
   ...
   public fba c(bul $$0, int $$1, float $$2) {
      List<fba> $$3 = this.a.get($$0);
      if ($$3.isEmpty()) {
   ...
   public static class a {
      private final Map<bul, List<fba>> a = new EnumMap<>(bul.class);
