...
public class bum extends bul {
   ...
   public static final int c = arw.f(2.4166098F);
   private static final aee<Byte> d = aeh.a(bum.class, aeg.a);
   ...
   @Override
   public apc w() {
      return this.t() && this.ag.a(4) != 0 ? null : apd.bq;
   }
   ...
   public void l() {
      ...
      if (this.t()) {
         this.f(ehn.b);
         this.p(this.dq(), (double)arw.a(this.ds()) + 1.0 - (double)this.dg(), this.dw());
      } else {
   ...
   protected void X() {
      ...
      if (this.t()) {
         ...
         this.f($$7);
         float $$8 = (float)(arw.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = arw.g($$8 - this.dB());
         this.bm = 0.5F;
         this.r(this.dB() + $$9);
