...
public class oa {
   public static final aev<dwr> a = ny.a("village/savanna/town_centers");
   private static final aev<dwr> b = ny.a("village/savanna/terminators");
   private static final aev<dwr> c = ny.a("village/savanna/zombie/terminators");
   ...
   public static void a(nr<dwr> $$0) {
      ...
      ny.a($$0, "village/savanna/trees", new dwr($$10, ImmutableList.of(Pair.of(dwp.a($$2), 1)), dwr.a.b));
      ny.a(
         $$0,
