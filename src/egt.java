...
public class egt extends egw {
   public static final MapCodec<egt> a = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(egt::new, $$0 -> $$0.d);
   ...
   public void a(egw.a $$0) {
      ...
      if (!($$1.i() >= this.d)) {
         ...
         if (!$$5.isEmpty()) {
            ...
            if (!$$6.isEmpty()) {
               $$0.a($$6.get(), dfy.pe.o().a(dfq.b, b));
               $$0.a().a($$6.get(), dqh.H).ifPresent($$1x -> {
                  int $$2x = 2 + $$1.a(2);

                  for (int $$3x = 0; $$3x < $$2x; $$3x++) {
                     $$1x.a(dqc.c.a($$1.a(599)));
                  }
               });
            }
         }
