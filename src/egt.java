...
public class egt {
   ...
   public egt(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<egu> $$1) throws IOException {
   ...
   public List<egu> a(Path $$0) throws IOException {
      List<egu> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<egu> a(Path $$0, boolean $$1) throws IOException {
      List<egu> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<egu> $$1) throws IOException {
