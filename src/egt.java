...
public class egt extends efy<eik> {
   ...
   protected boolean a(
      dhg $$0, azh $$1, eik $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dwx $$0, Function<ji, dwx> $$1, azh $$2, eik $$3, eik.a $$4, ji.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
