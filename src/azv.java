...
public class azv {
   public static final Codec<azv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(ayv.p.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), ayv.p.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, azv::new)
   );
