...
public class cnu {
   public static <T> List<cnu.b> a(List<T> $$0, Function<T, List<hi<dre>>> $$1, boolean $$2) {
      Object2IntMap<dre> $$3 = new Object2IntOpenHashMap();
      ...
      for (T $$8 : $$0) {
         ...
         List<hi<dre>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (he<dre> $$12 : $$10.get($$11)) {
               dre $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && aoq.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<cnu.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<dre> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cnu.b($$28));
      }
   ...
   public static record b(List<dre> a, ToIntFunction<dre> b) {
      b(List<dre> $$0) {
