...
public class eaz extends LongLinkedOpenHashSet {
   private final eaz.a a;

   public eaz(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eaz.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = asy.f(60000000);
      private static final int b = asy.f(60000000);
