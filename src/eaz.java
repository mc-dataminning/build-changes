...
public class eaz {
   ...
   private final Map<Character, Predicate<eax>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public eaz a(char $$0, Predicate<eax> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public eay b() {
      return new eay(this.c());
   }

   private Predicate<eax>[][][] c() {
      this.d();
      Predicate<eax>[][][] $$0 = (Predicate<eax>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<eax>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
