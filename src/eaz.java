...
public final class eaz extends ebc<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private eaz(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof eaz $$1 && super.equals($$0)) {
   ...
   public static eaz a(String $$0, int $$1, int $$2) {
      return new eaz($$0, $$1, $$2);
   }
