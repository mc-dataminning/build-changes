public class cbj implements cbf {
   ...
   public void a() {
      if (this.k == cbj.a.c) {
         ...
         ji $$14 = this.d.dv();
         dwy $$15 = this.d.dV().a_($$14);
         fbv $$16 = $$15.g(this.d.dV(), $$14);
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         etn $$3 = $$2.n();
         if ($$3 != null && $$3.a(this.d, ji.a(this.d.dA() + (double)$$0, (double)this.d.dB(), this.d.dG() + (double)$$1)) != etr.c) {
            return false;
         }
      }
