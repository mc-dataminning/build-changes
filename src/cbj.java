public class cbj extends cbh {
   ...
   public cbj(bvi $$0, int $$1, int $$2, float $$3, float $$4, boolean $$5) {
      super($$0);
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a() {
      ...
      if (this.k == cbh.a.b && !this.d.P().k()) {
         ...
         if ($$3 < 2.5000003E-7F) {
            ...
            this.d.aX = this.d.dL();
            this.d.aZ = this.d.dL();
            float $$5 = (float)(this.h * this.d.h(bwo.v));
            if (this.d.bj()) {
               this.d.C($$5 * this.p);
               double $$6 = Math.sqrt($$0 * $$0 + $$2 * $$2);
               if (Math.abs($$1) > 1.0E-5F || Math.abs($$6) > 1.0E-5F) {
                  float $$7 = -((float)(ayz.d($$1, $$6) * 180.0F / (float)Math.PI));
                  $$7 = ayz.a(ayz.h($$7), (float)(-this.n), (float)this.n);
                  this.d.w(this.a(this.d.dN(), $$7, 5.0F));
               }

               float $$8 = ayz.b(this.d.dN() * (float) (Math.PI / 180.0));
               float $$9 = ayz.a(this.d.dN() * (float) (Math.PI / 180.0));
               this.d.bp = $$8 * $$5;
               this.d.bo = -$$9 * $$5;
            } else {
               float $$10 = Math.abs(ayz.h(this.d.dL() - $$4));
               float $$11 = a($$10);
