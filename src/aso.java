...
public class aso<K> implements il<K> {
   ...
   private aso(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> aso<A> c(int $$0) {
      return new aso((int)((float)$$0 / 0.8F));
   }
   ...
   private int d(@Nullable K $$0) {
      return (atq.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public aso<K> c() {
      return new aso<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
