...
public abstract class aso implements AutoCloseable {
   ...
   protected aso(URL $$0, aso.b $$1, aso.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? ayt.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static aso a(aqa $$0) {
      String $$1 = $$0.R;
      if (baa.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<arz> a(GameProfile $$0, String $$1, aso.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arz.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract arz a(String var1, aso.a var2, JsonObject var3);

   protected xh a(String $$0, JsonArray $$1, aso.a $$2) {
      if ($$1.isEmpty()) {
         return xh.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xh.b;
      } else {
         xh $$3 = new xh($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aso.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      aso.a a = ($$0, $$1) -> false;
      aso.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aso.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aso.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements asp {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bqi<Runnable> $$2 = bqi.a(aso.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a;
      }

      @Override
      public CompletableFuture<List<arz>> a(List<String> $$0) {
         List<CompletableFuture<arz>> $$1 = $$0.stream().map($$0x -> aso.this.a(this.b, $$0x, aso.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return ad.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arz> a(String $$0) {
         return aso.this.a(this.b, $$0, aso.this.f, this.c);
      }
   }
