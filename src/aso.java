...
public class aso extends ata {
   ...
   private aso(URL $$0, ata.b $$1, URL $$2, aso.a $$3, URL $$4, aso.a $$5, String $$6, ata.a $$7, ExecutorService $$8) {
      super($$0, $$1, $$7, $$8);
      this.c = $$2;
      this.d = $$3;
      this.e = $$4;
   ...
   public static ata a(String $$0) {
      try {
         ...
         URI $$2 = new URI(aze.i($$1, "apiServer"));
         String $$3 = aze.i($$1, "apiKey");
         if ($$3.isEmpty()) {
            throw new IllegalArgumentException("Missing API key");
         } else {
            int $$4 = aze.a($$1, "ruleId", 1);
            String $$5 = aze.a($$1, "serverId", "");
            String $$6 = aze.a($$1, "roomId", "Java:Chat");
            int $$7 = aze.a($$1, "hashesToDrop", -1);
            int $$8 = aze.a($$1, "maxConcurrentRequests", 7);
            JsonObject $$9 = aze.a($$1, "endpoints", null);
   ...
   public atb a(GameProfile $$0) {
      return new ata.c($$0) {
         @Override
         public void a() {
            aso.this.a(this.b, aso.this.c, aso.this.d, this.c);
         }

         @Override
         public void b() {
            aso.this.a(this.b, aso.this.e, aso.this.f, this.c);
         }
      };
   }

   void a(GameProfile $$0, URL $$1, aso.a $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   protected asl a(String $$0, ata.a $$1, JsonObject $$2) {
      boolean $$3 = aze.a($$2, "response", false);
      if ($$3) {
         return asl.a($$0);
      } else {
         String $$4 = aze.a($$2, "hashed", null);
         if ($$4 == null) {
            return asl.b($$0);
         } else {
            JsonArray $$5 = aze.v($$2, "hashes");
            xe $$6 = this.a($$0, $$5, $$1);
            return new asl($$0, $$6);
         }
      }
