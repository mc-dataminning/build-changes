...
public abstract class aso implements asx {
   ...
   public <T> T a(atk<T> $$0) throws IOException {
      aud<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(atk<T> $$0, InputStream $$1) {
      JsonObject $$3;
