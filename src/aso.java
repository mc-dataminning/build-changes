...
public class aso implements AutoCloseable {
   ...
   private aso(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static aso.a a(Path $$0) {
         return new aso.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
