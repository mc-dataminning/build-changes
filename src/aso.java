...
public class aso {
   ...
   private static boolean a(uh $$0, ark $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, uh $$1, ark $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, uh $$1, ark $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, uh $$1, ark $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, uh $$2, ark $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, uh $$2, uh $$3, ark $$4) {
      int $$5 = $$0.length();
      uh $$6 = $$2;
   ...
   public static boolean a(tp $$0, uh $$1, ark $$2) {
