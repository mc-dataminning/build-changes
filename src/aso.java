...
public class aso {
   ...
   final List<wb> g = Collections.synchronizedList(Lists.newArrayList());

   public aso(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (aso.this.e.am()) {
                  $$1.addLast("legacy_query", new ash(aso.this.d()));
               }

               wb.a($$1, zp.a, false, null);
               int $$2 = aso.this.e.o();
               wb $$3 = (wb)($$2 > 0 ? new wr($$2) : new wb(zp.a));
               aso.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new asq(aso.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xh $$3 = xh.b("Internal server error");
                     $$1.a(new zx($$3), wo.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<aso.a.a> d = Lists.newArrayList();
