...
public class ffw implements AutoCloseable {
   private final fdn a;
   private final fdo b;
   @Nullable
   private fdo c = null;
   ...
   public ffw(fdn $$0) {
      ...
      this.b = new fdo(fdm.a, $$0, 0);
      this.d = GlStateManager._glGenVertexArrays();
   }

   public static ffw a(ffy.c $$0, ffy $$1, Consumer<ffx> $$2) {
      ffo $$3 = ffv.b().a($$0, $$1);
      $$2.accept($$3);
      ffw $$4 = new ffw(fdn.b);
      $$4.a();
   ...
   public void a(ffq.a $$0) {
      ...
      label46: {
         try {
            ...
            this.c = new fdo(fdm.b, this.a, $$0.a());
            this.f = null;
         } catch (Throwable var6) {
            if ($$0 != null) {
               try {
   ...
   private ffy a(ffs.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(ffs.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
         if (this.c != null) {
            this.c.close();
         }

         this.c = new fdo(fdm.b, this.a, $$1);
         return null;
      } else {
