...
public class ffw {
   public static void a(fui<?> $$0, ffu $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fft>> $$6 : $$1.c().entrySet()) {
         Optional<fwz> $$7 = $$0.a($$6.getKey());
         List<fft> $$8 = $$6.getValue();
   ...
   private static float a(ffu $$0, long $$1) {
