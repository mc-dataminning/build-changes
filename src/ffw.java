...
public class ffw extends ffy {
   public static final int a = 854;
   public static final int b = 480;
   static final ffw.b l = new ffw.b(854, 480);

   public ffw(int $$0, int $$1) {
      super(true);
      this.e($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final ffw.a[] e = values();
   ...
   static class b {
      ...
      static List<ffw.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ffw.b($$0, $$1), ffw.l) : ImmutableList.of(ffw.l);
      }
