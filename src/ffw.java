...
public class ffw {
   ...
   public void a(ffw.b $$0, List<asg> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ffw.c($$0, $$1.stream().map(asg::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ffw.c(ffw.b.c, ImmutableList.of());
      }

      this.b.c = new ffw.a($$0);
   }
   ...
   static class c {
      private final ffw.b a;
      private final List<String> b;
      @Nullable
      ffw.a c;
      boolean d;

      c(ffw.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
