...
public class ffw<T extends bil> extends fdw<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if (this.p != 3) {
         ...
         if (this.p == 2) {
            this.h.e = ars.b($$1 * 0.6662F) * $$2;
            this.i.e = ars.b($$1 * 0.6662F + 0.3F) * $$2;
            this.j.e = ars.b($$1 * 0.6662F + (float) Math.PI + 0.3F) * $$2;
            this.k.e = ars.b($$1 * 0.6662F + (float) Math.PI) * $$2;
            this.m.e = 1.7278761F + (float) (Math.PI / 10) * ars.b($$1) * $$2;
         } else {
            this.h.e = ars.b($$1 * 0.6662F) * $$2;
            this.i.e = ars.b($$1 * 0.6662F + (float) Math.PI) * $$2;
            this.j.e = ars.b($$1 * 0.6662F + (float) Math.PI) * $$2;
            this.k.e = ars.b($$1 * 0.6662F) * $$2;
            if (this.p == 1) {
               this.m.e = 1.7278761F + (float) (Math.PI / 4) * ars.b($$1) * $$2;
            } else {
               this.m.e = 1.7278761F + 0.47123894F * ars.b($$1) * $$2;
            }
         }
      }
   }
