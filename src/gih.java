public class gih extends ggw<chm> {
   public gih(ggx.a $$0) {
      super($$0);
   }

   public void a(chm $$0, float $$1, float $$2, exx $$3, gbo $$4, int $$5) {
      $$3.a();
      $$3.a(a.d.rotationDegrees(180.0F - $$1));
      chn $$6 = $$0.p().a();
      float $$7 = 0.0625F;
      $$3.b(0.0625F, 0.0625F, 0.0625F);
      eyb $$8 = $$4.getBuffer(gbw.c(this.a($$0)));
      gnx $$9 = fde.Q().aF();
   ...
   private void a(exx $$0, eyb $$1, chm $$2, int $$3, int $$4, gmy $$5, gmy $$6) {
      exx.a $$7 = $$0.c();
      ...
      for (int $$27 = 0; $$27 < $$23; $$27++) {
         for (int $$28 = 0; $$28 < $$24; $$28++) {
            ...
            int $$33 = $$2.dr();
            int $$34 = axz.a($$2.du() + (double)(($$31 + $$32) / 2.0F / 16.0F));
            int $$35 = $$2.dx();
            is $$36 = $$2.cF();
            if ($$36 == is.c) {
               $$33 = axz.a($$2.ds() + (double)(($$29 + $$30) / 2.0F / 16.0F));
            }

            if ($$36 == is.e) {
               $$35 = axz.a($$2.dy() - (double)(($$29 + $$30) / 2.0F / 16.0F));
            }
            ...
            int $$37 = gbm.a($$2.dN(), new in($$33, $$34, $$35));
   ...
   private void a(exx.a $$0, eyb $$1, float $$2, float $$3, float $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, $$2, $$3, $$6).a(255, 255, 255, 255).a($$4, $$5).c(gmp.d).b($$10).b($$0, (float)$$7, (float)$$8, (float)$$9).e();
   }
}
