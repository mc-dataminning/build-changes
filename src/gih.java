public class gih extends gkg {
   ...
   gih(gfy $$0, double $$1, double $$2, double $$3, esx $$4) {
      super($$0, $$1, $$2, $$3);
      this.b(0.01F, 0.01F);
      this.u = 0.06F;
      this.b = $$4;
   ...
   public static gkg g(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      gih $$8 = new gih.g($$1, $$2, $$3, $$4, esz.a, lt.az);
      $$8.u = 0.01F;
   ...
   public static gkg n(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      ...
      gih $$9 = new gih.f($$1, $$2, $$3, $$4, esz.a, $$8);
      $$9.u = 0.005F;
   ...
   public static gkg o(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      gih.b $$8 = new gih.b($$1, $$2, $$3, $$4, esz.a, lt.aH);
      $$8.a = true;
      $$8.u *= 0.01F;
      $$8.t = 100;
   ...
   public static gkg p(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      gih $$8 = new gih.e($$1, $$2, $$3, $$4, esz.a, lt.aI);
      $$8.a = true;
      $$8.u = 0.01F;
      $$8.a(0.51171875F, 0.03125F, 0.890625F);
      return $$8;
   ...
   static class a extends gih.b {
      a(gfy $$0, double $$1, double $$2, double $$3, esx $$4, lr $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
   ...
   static class b extends gih {
      ...
      b(gfy $$0, double $$1, double $$2, double $$3, esx $$4, lr $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
         this.u *= 0.02F;
         this.t = 40;
   ...
   static class c extends gih {
      c(gfy $$0, double $$1, double $$2, double $$3, esx $$4) {
         super($$0, $$1, $$2, $$3, $$4);
   ...
   static class d extends gih.e {
      d(gfy $$0, double $$1, double $$2, double $$3, esx $$4, lr $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
      ...
      protected void i() {
         if (this.m) {
            ...
            avz $$0 = this.g() == esz.e ? awa.hS : awa.hT;
   ...
   static class e extends gih.f {
      ...
      e(gfy $$0, double $$1, double $$2, double $$3, esx $$4, lr $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
      }
   ...
   static class f extends gih {
      f(gfy $$0, double $$1, double $$2, double $$3, esx $$4) {
         this($$0, $$1, $$2, $$3, $$4, (int)(64.0 / (Math.random() * 0.8 + 0.2)));
      }

      f(gfy $$0, double $$1, double $$2, double $$3, esx $$4, int $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.t = $$5;
      }
   ...
   static class g extends gih.e {
      g(gfy $$0, double $$1, double $$2, double $$3, esx $$4, lr $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
