...
public class cnx extends cnv implements bxz {
   private static final int b = 50;
   private static final int c = 70;
   private static final akj<Boolean> d = akn.a(cnx.class, akl.k);
   public static final String a = "sheared";

   public static byo.a gt() {
      return cnv.j().a(byp.s, 16.0);
   }

   public cnx(bwr<? extends cnx> $$0, djm $$1) {
      super($$0, $$1);
   }
   ...
   private void d(arq $$0, czn $$1) {
      this.a($$0, ezp.aQ, $$1, ($$0x, $$1x) -> this.a($$0x, $$1x, this.dq()));
   }
