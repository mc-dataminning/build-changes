...
public class cnx {
   ...
   @VisibleForTesting
   protected final ArrayList<buk> c;
   private final cnx.a k;
   @VisibleForTesting
   protected final Object2IntMap<buk> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cnx> a(Predicate<buk> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cnx::b)).apply($$1, $$1x -> new cnx($$0, $$1x))
      );
   }

   public cnx(Predicate<buk> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cnx.a(this);
   ...
   public void a(ard $$0, Predicate<buk> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<buk>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<buk> $$6 = (Entry<buk>)$$5.next();
         int $$7 = $$6.getIntValue();
         buk $$8 = (buk)$$6.getKey();
         buk.d $$9 = $$8.dR();
   ...
   public int b(@Nullable buk $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bvg> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bvg).map($$0 -> (bvg)$$0);
   }

   @VisibleForTesting
   protected static record a(cnx a) implements Comparator<buk> {
      public int a(buk $$0, buk $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cow;
               boolean $$7 = $$1 instanceof cow;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
