...
public class cnx extends cnu {
   public cnx(bsy<? extends cnx> $$0, dbw $$1) {
      super($$0, $$1);
   }

   public cnx(dbw $$0, btn $$1) {
      super(bsy.G, $$1, $$0);
   }
      ...
      if (!this.dP().B && !this.dK()) {
         ...
         if ($$2 instanceof arf $$3) {
            if ($$3.c.c() && $$3.dP() == this.dP() && !$$3.fL()) {
               if (this.ah.i() < 0.05F && this.dP().ab().b(dbs.e)) {
                  cjs $$4 = bsy.I.a(this.dP());
                  if ($$4 != null) {
   ...
   public void l() {
      bss $$0 = this.s();
      if ($$0 instanceof arf && !$$0.bD() && this.dP().ab().b(dbs.Y)) {
         this.ao();
      } else {
         super.l();
      }
