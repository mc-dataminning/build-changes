...
public class gpk extends goj<buz, gvk> {
   public gpk(gok.a $$0) {
      super($$0);
   }

   public void a(gvk $$0, feb $$1, gih $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(buz $$0, gvk $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(buz $$0) {
      return false;
   }
}
