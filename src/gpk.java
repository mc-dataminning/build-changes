...
public class gpk implements gpn.a, AutoCloseable {
   ...
   ezp[] f;
   @Nullable
   private final gpk.a g;
   private final aty h;

   public gpk(akk $$0, grd $$1, ezp $$2, aty $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      grb $$4 = $$3.a(grb.a).orElse(grb.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ezp[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gpf.a(this.f, $$0);
   ...
   @Nullable
   private gpk.a a(grd $$0, int $$1, int $$2, grb $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gpk.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gpk.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gpk.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gpk.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gpk.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gpk.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ezp[] $$4) {
   ...
   class a {
      ...
      a(final List<gpk.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gpk.this.c;
         int $$4 = this.b($$2) * gpk.this.d;
         gpk.this.a($$0, $$1, $$3, $$4, gpk.this.f);
      }

      public gpm a() {
         return gpk.this.new d(this, this.d ? gpk.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ezp[] b = new ezp[gpk.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gpk.this.c >> $$0;
            int $$2 = gpk.this.d >> $$0;
            this.b[$$0] = new ezp($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gpk.d $$2) {
         gpk.a $$3 = $$2.c;
         List<gpk.b> $$4 = $$3.b;
         gpk.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gpk.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gpk.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gpk.this.f[$$2].a($$3 + ($$0.a($$1) * gpk.this.c >> $$2), $$4 + ($$0.b($$1) * gpk.this.d >> $$2));
      }
   ...
   class d implements gpm {
      int a;
      int b;
      final gpk.a c;
      @Nullable
      private final gpk.c d;

      d(final gpk.a $$0, @Nullable final gpk.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
