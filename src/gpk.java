...
public class gpk implements gpd {
   ...
   private gpk(List<alf> $$0, alf $$1, Map<String, alf> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(gpj a, Supplier<IntUnaryOperator> b, alf c) implements gpd.b {
      @Nullable
      public got a(gpc $$0) {
         Object var3;
         try {
            eyz $$1 = this.a.a().a(this.b.get());
            return new got(this.c, new gqm($$1.a(), $$1.b()), $$1, aur.a);
         } catch (IllegalArgumentException | IOException var7) {
            gpk.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
