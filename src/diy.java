...
public interface diy extends dhy, dif, djn, dka.a {
   @Nullable
   ebw a(int var1, int var2, ecx var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(efy.a var1, int var2, int var3);

   default int b(efy.a $$0, iu $$1) {
   ...
   default je<djy> u(iu $$0) {
      return this.D_().a($$0);
   }

   default Stream<dzz> c(fed $$0) {
      int $$1 = azm.a($$0.a);
      int $$2 = azm.a($$0.d);
      int $$3 = azm.a($$0.b);
      int $$4 = azm.a($$0.e);
   ...
   @Override
   default int a(iu $$0, dig $$1) {
      return $$1.getColor(this.u($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default je<djy> getNoiseBiome(int $$0, int $$1, int $$2) {
      ebw $$3 = this.a(jp.e($$0), jp.e($$2), ecx.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   je<djy> a(int var1, int var2, int var3);
   ...
   default ebw a(int $$0, int $$1) {
      return this.a($$0, $$1, ecx.n, true);
   }

   default ebw a(int $$0, int $$1, ecx $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dib c(int $$0, int $$1) {
