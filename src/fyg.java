...
public class fyg extends fys {
   private static final long a = 2000L;
   private final ase b;
   private long c = -1L;
   private boolean d;
   private static final Object2IntMap<edr> s = ag.a(new Object2IntOpenHashMap(), $$0 -> {
      $$0.defaultReturnValue(0);
      $$0.put(edr.c, 5526612);
      $$0.put(edr.d, 10066329);
      $$0.put(edr.e, 6250897);
      $$0.put(edr.f, 8434258);
      $$0.put(edr.g, 13750737);
      $$0.put(edr.h, 7497737);
      $$0.put(edr.i, 3159410);
      $$0.put(edr.j, 2213376);
      $$0.put(edr.k, 13421772);
      $$0.put(edr.l, 16769184);
      $$0.put(edr.m, 15884384);
      $$0.put(edr.n, 16777215);
   });
   ...
   protected void b(fwx $$0) {
      if (this.d) {
         $$0.a(fww.a, wy.c("narrator.loading.done"));
      } else {
         $$0.a(fww.a, this.m());
      }
   }
   ...
   public static void a(fsm $$0, ase $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.d();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.e();
