...
public class fyg implements fpv, fqp {
   ...
   public void a(fyl $$0, bak $$1, boolean $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      this.j = $$0;
      List<dcj> $$8 = $$0.a(fyl.a.b);
      List<dcj> $$9 = $$2 ? Collections.emptyList() : $$0.a(fyl.a.c);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         dcj $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
   ...
   class a extends fyg.b {
      ...
      public a(final int $$0, final int $$1, final dck $$2, final dci $$3, final bak $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<fyg.b.a> a(dci $$0, bak $$1) {
   ...
   abstract class b extends fop {
      ...
      public b(final int $$0, final int $$1, final dck $$2, final boolean $$3, final List<fyg.b.a> $$4) {
      ...
      protected static fyg.b.a a(int $$0, int $$1, List<cwo> $$2) {
      ...
      protected static record a(int a, int b, List<cwo> c) {

         public a(int a, int b, List<cwo> c) {
            if (c.isEmpty()) {
   ...
   class c extends fyg.b {
      ...
      public c(final int $$0, final int $$1, final dck $$2, final dci $$3, final bak $$4, final boolean $$5) {
         super($$0, $$1, $$2, $$5, a($$3, $$4));
      }

      private static List<fyg.b.a> a(dci $$0, bak $$1) {
         if ($$0 instanceof dch $$2) {
            List<cwo> $$3 = $$2.b().a($$1);
            if (!$$3.isEmpty()) {
