...
public class aco implements zh<abw> {
   public static final yy<vw, aco> a = zh.a(aco::a, aco::new);
   ...
   private final int i;
   private final List<aco.b> j;

   public aco(RootCommandNode<eo> $$0) {
   ...
   private static void a(List<aco.b> $$0, BiPredicate<aco.b, IntSet> $$1) {
   ...
   private static void a(List<aco.b> $$0) {
      a($$0, aco.b::a);
      a($$0, aco.b::b);
   }
   ...
   private static List<aco.b> a(Object2IntMap<CommandNode<eo>> $$0) {
      ObjectArrayList<aco.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static aco.b b(vw $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      aco.e $$4 = a($$0, $$1);
      return new aco.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static aco.e a(vw $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static aco.b a(CommandNode<eo> $$0, Object2IntMap<CommandNode<eo>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<eo> a(ef $$0) {
      return (RootCommandNode<eo>)new aco.d($$0, this.j).a(this.i);
   }

   static class a implements aco.e {
      ...
      @Nullable
      private static ali a(@Nullable SuggestionProvider<eo> $$0) {
         return $$0 != null ? ik.a($$0) : null;
      }

      a(String $$0, ig.a<?> $$1, @Nullable ali $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(vw $$0, ig.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends ig.a<A>> void a(vw $$0, ig<A, T> $$1, ig.a<A> $$2) {
         $$0.c(mg.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable aco.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements aco.e {
      private final String a;
