...
public class ckc extends ciw implements bxz, cop {
   ...
   protected void D() {
      ...
      this.bD.a(3, new cen(this, crj.class, 6.0F));
      this.bD.a(4, new cfa(this));
      this.bE.a(1, new cfy<>(this, bxl.class, 10, true, false, ($$0, $$1) -> $$0 instanceof coc));
   }
   ...
   public void k_() {
      ...
      if (this.dU() instanceof arq $$0) {
         ...
         for (int $$2 = 0; $$2 < 4; $$2++) {
            ...
            iv $$6 = new iv($$3, $$4, $$5);
            if (this.dU().a_($$6).l() && $$1.a((djk)this.dU(), $$6)) {
               this.dU().b($$6, $$1);
               this.dU().a(efo.i, $$6, efo.a.a(this, $$1));
            }
         }
      }
   }
   ...
   public void a(bxj $$0, float $$1) {
      ...
      if (this.dU() instanceof arq $$6) {
         czk $$7 = new czk(czo.rs);
         cse.a(new csj($$6, this, $$7), $$6, $$7, $$4x -> $$4x.c($$2, $$3 + $$5 - $$4x.dB(), $$4, 1.6F, 12.0F));
      }
   ...
   public void a(arq $$0, awo $$1, czk $$2) {
      ...
      this.w(false);
      this.a($$0, ezk.aU, $$2, ($$0x, $$1x) -> this.a($$0x, $$1x, this.cR()));
   }
   ...
   @Override
   public fex cS() {
      return new fex(0.0, (double)(0.75F * this.cR()), (double)(this.dp() * 0.4F));
   }
}
