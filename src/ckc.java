...
public class ckc extends cjq {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new ezn($$0, this.g.dE() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.G(this.g)) {
               this.d++;
               ezn $$8 = new ezn(this.g.dC() - this.a.dC(), 0.0, this.g.dI() - this.a.dI()).d();
               ezn $$9 = new ezn((double)azk.a(this.a.dN() * (float) (Math.PI / 180.0)), 0.0, (double)(-azk.b(this.a.dN() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  ezn $$13 = this.a.g(1.0F);
                  ...
                  ezn $$20 = new ezn($$17, $$18, $$19);
                  if (!this.a.bc()) {
                     this.a.dX().a(null, 1017, this.a.dx(), 0);
                  }

                  cox $$21 = new cox(this.a.dX(), this.a, $$20.d());
   ...
   public void a(bva $$0) {
      ...
      int $$9 = azk.a(this.g.dE() + $$8);
      erw $$10 = new erw($$3, $$9, $$4);
