...
public abstract class ckc extends ckb {
   ...
   protected ckc(bsy<? extends ckc> $$0, dbw $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bS.a(4, new ckc.a<>(this, 0.7, 0.595));
   }
   ...
   public bug a(dcl $$0, bqq $$1, btr $$2, @Nullable bug $$3) {
      if ($$2 != btr.p && $$2 != btr.h && $$2 != btr.d && $$0.E_().i() < 0.06F && this.gr()) {
         this.c = true;
      }

      if (this.gu()) {
         this.a(bsz.f, cog.a(this.dR().b(lq.d)));
         this.a(bsz.f, 2.0F);
      }
   ...
   public static boolean b(bsy<? extends ckc> $$0, dbx $$1, btr $$2, iz $$3, azf $$4) {
      return $$1.a(dcf.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends ckc> extends cal {
      ...
      public void e() {
         ...
         if ($$1.l()) {
            ...
            if (this.b.gz() && $$2.isEmpty()) {
               ...
               evp $$3 = evp.c(this.b.gs());
               evp $$4 = this.b.dn();
               evp $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).a(0.4).e($$3);
               evp $$6 = $$3.d($$4).d().a(10.0).e($$4);
               iz $$7 = iz.a($$6);
               $$7 = this.b.dP().a(dxs.a.f, $$7);
      ...
      private List<ckc> h() {
         return this.b.dP().a(ckc.class, this.b.cK().g(16.0), $$0 -> $$0.gx() && !$$0.t(this.b));
      }
