...
public class ewv {
   ...
   public ewv(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ewv(exa $$0, exa $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ewv a(ejh $$0) {
      return new ewv((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ewv a(exa $$0) {
      return new ewv($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static ewv a(jd $$0, jd $$1) {
      return new ewv(
   ...
   public ewv a(double $$0) {
      return new ewv($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ewv b(double $$0) {
      return new ewv(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ewv c(double $$0) {
      return new ewv(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ewv d(double $$0) {
      return new ewv(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ewv e(double $$0) {
      return new ewv(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ewv f(double $$0) {
      return new ewv(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ewv b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ewv c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ewv d(double $$0, double $$1, double $$2) {
      return new ewv(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ewv f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ewv h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<exa> b(exa $$0, exa $$1) {
   ...
   @Nullable
   public static eww a(Iterable<ewv> $$0, exa $$1, exa $$2, jd $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eww($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ji a(ewv $$0, exa $$1, double[] $$2, @Nullable ji $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public exa f() {
      return new exa(ayo.d(0.5, this.a, this.d), ayo.d(0.5, this.b, this.e), ayo.d(0.5, this.c, this.f));
   }

   public static ewv a(exa $$0, double $$1, double $$2, double $$3) {
      return new ewv($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
