...
public class ewv {
   ...
   public void a(eyf $$0, String $$1, ezb.a $$2, emr $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  ewv.b $$13 = new ewv.b($$1.trim(), this.f, $$3, $$2);
                  ewv.a $$14 = new ewv.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        ewv.c $$30 = new ewv.c(this.f, $$2, $$0);
                        ewv.a $$31 = new ewv.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eyj(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, emr $$2) throws IOException {
      ...
      File $$15 = new File(fbp.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final emr d;
      private final ezb.a e;

      b(String $$0, File $$1, emr $$2, ezb.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((ewv.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !ewv.this.b && !ewv.this.d) {
            try {
               ewv.this.e = true;
               ewv.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               ewv.a.error("Error extracting archive", var3);
               ewv.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((ewv.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !ewv.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, ewv.this.g);
                  ewv.this.c = true;
               } else {
                  ewv.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  ewv.this.d = true;
               }
            } catch (IOException var3) {
               ewv.a.error("Error copying resourcepack file: {}", var3.getMessage());
               ewv.this.d = true;
            }
         }
      }
