...
public class exu {
   ...
   @Nullable
   private String g;
   private static final exu.a h = new exu.a() {
      @Nullable
      @Override
      public ext a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (exx.a(this.d, "Get capabilities")) {
         ...
         if (exx.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  exx.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !exx.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ext a(exu.c $$0) {
      return ($$0 == exu.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements exu.a {
      private final int a;
      private final Set<ext> b = Sets.newIdentityHashSet();
      ...
      public ext a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               exu.a.warn("Maximum sound pool size {} reached", this.a);
            }
