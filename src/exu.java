...
public class exu extends exo<exu.a> {
   protected exu(eea $$0) {
      super(dks.a, $$0, new exu.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected eds g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && jz.c($$0) < $$2) {
            ...
            return this.j($$0) ? new eds(15) : new eds();
         }
      }
   }

   private static eds a(eds $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends exl<exu.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<eds> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public exu.a a() {
         return new exu.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
