...
public class exu {
   ...
   public exu(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<exv> $$1) throws IOException {
   ...
   public List<exv> a(Path $$0) throws IOException {
      List<exv> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<exv> a(Path $$0, boolean $$1) throws IOException {
      List<exv> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<exv> $$1) throws IOException {
