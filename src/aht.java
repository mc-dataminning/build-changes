...
public class aht {
   ...
   private static int a(dt $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2 != null) {
         int $$3 = $$2.l();
         if ($$1 > $$3) {
            $$0.b(ti.b("Sorry, the max bad omen level you can set is " + $$3));
         } else {
            int $$4 = $$2.m();
            $$2.a($$1);
            $$0.a(() -> ti.b("Changed village's bad omen level from " + $$4 + " to " + $$1), false);
         }
      } else {
         $$0.b(ti.b("No raid found here"));
      }
   ...
   private static int b(dt $$0) {
      $$0.a(() -> ti.b("Spawned a raid captain"), false);
      ccx $$1 = bip.ay.a((cpq)$$0.e());
      if ($$1 == null) {
         $$0.b(ti.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(biq.f, ccw.s());
         $$1.e($$0.d().c, $$0.d().d, $$0.d().e);
         $$1.a($$0.e(), $$0.e().d_(gw.a($$0.d())), bjf.n, null, null);
         $$0.e().a_($$1);
         return 1;
      }
   }

   private static int a(dt $$0, @Nullable ti $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         akn $$2 = $$0.e();
         ehi $$3 = $$0.d().b(5.0, 0.0, 0.0);
         $$2.a(null, $$3.c, $$3.d, $$3.e, aoz.tp, apa.g, 2.0F, 1.0F, $$2.z.g());
      }
   ...
   private static int b(dt $$0, int $$1) throws CommandSyntaxException {
      ...
      gw $$3 = $$2.dk();
      if ($$2.x().d($$3)) {
         $$0.b(ti.b("Raid already started close by"));
         return -1;
      } else {
         ccy $$4 = $$2.x().x();
         ccw $$5 = $$4.a($$2);
         if ($$5 != null) {
            $$5.a($$1);
            $$4.c();
            $$0.a(() -> ti.b("Created a raid in your local village"), false);
         } else {
            $$0.b(ti.b("Failed to create a raid in your local village"));
         }
   ...
   private static int c(dt $$0) throws CommandSyntaxException {
      ...
      if ($$3 != null) {
         $$3.n();
         $$0.a(() -> ti.b("Stopped raid"), false);
         return 1;
      } else {
         $$0.b(ti.b("No raid here"));
         return -1;
      }
   }
   ...
   private static int d(dt $$0) throws CommandSyntaxException {
      ...
      if ($$1 != null) {
         ...
         $$3.append(" / ");
         $$3.append($$1.g());
         $$0.a(() -> ti.b($$3.toString()), false);
         return 1;
      } else {
         $$0.b(ti.b("Found no started raids"));
         return 0;
      }
   }

   @Nullable
   private static ccw a(ako $$0) {
      return $$0.x().c($$0.dk());
   }
}
