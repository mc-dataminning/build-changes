...
public abstract class fmh extends flu {
   ...
   public void a(elt $$0, eqg $$1, float $$2) {
      ehn $$3 = $$1.b();
      float $$4 = (float)(arx.d((double)$$2, this.d, this.g) - $$3.a());
      float $$5 = (float)(arx.d((double)$$2, this.e, this.h) - $$3.b());
      float $$6 = (float)(arx.d((double)$$2, this.f, this.i) - $$3.c());
      Quaternionf $$7;
      if (this.z == 0.0F) {
         $$7 = $$1.f();
      } else {
         $$7 = new Quaternionf($$1.f());
         $$7.rotateZ(arx.i($$2, this.A, this.z));
      }
