...
public class fmh extends flz {
   private static final Logger a = LogUtils.getLogger();
   private static final akn b = new akn("textures/misc/credits_vignette.png");
   private static final wx c = wx.b("============").a(n.p);
   ...
   private int F;
   private final fgr G = new fgr(false);

   public fmh(boolean $$0, Runnable $$1) {
      super(fdt.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fmh.a $$1) {
      try (Reader $$2 = this.m.ab().openAsReader(new akn($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : axv.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(wx.b($$4).a(n.o), true);
         this.a(c, true);
         this.D();
         this.D();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(wx.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(wx.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.y.addAll(this.m.h.c(wx.b($$0), 256));
   }

   private void a(wx $$0, boolean $$1) {
      if ($$1) {
