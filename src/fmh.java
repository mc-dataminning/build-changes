...
public class fmh<T extends cbw & bov> extends fma<T> {
   ...
   public static fql c() {
      ...
      fqo $$1 = $$0.a();
      fqo $$2 = $$1.a(
         "body", fqk.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fqh.a(0.0F, 20.0F, 5.0F)
      );
      fqj $$3 = new fqj(0.001F);
      fqo $$4 = $$2.a("head", fqk.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fqh.a(0.0F, 0.0F, -9.0F));
      fqk $$5 = fqk.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fqk $$6 = fqk.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fqk $$7 = fqk.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fqh.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fqh.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fqh.a(4.0F, 0.0F, -1.0F));
      fqk $$8 = fqk.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fqk $$9 = fqk.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fqh.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fqh.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fqh.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fqh.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fqk.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fqh.a(0.0F, 0.0F, 1.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.gr()) {
         ...
         boolean $$6 = $$2 > 1.0E-5F || $$0.dB() != $$0.N || $$0.dz() != $$0.M;
         if ($$0.bc()) {
            if ($$6) {
               this.d($$3, $$5);
            } else {
   ...
   private Vector3f a(fqf $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fqf $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fqf $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * awm.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * awm.b($$2 * 0.9F));
