...
public class bzt extends bzw {
   private final bta a;
   private final Predicate<bta> b;
   @Nullable
   private bta c;
   ...
   public bzt(bta $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<bta> $$0 = this.a.dP().a(bta.class, this.a.cK().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bta $$1 : $$0) {
            if (!$$1.ch()) {
               this.c = $$1;
