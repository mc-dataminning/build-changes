...
public class bzt extends cba implements bll, cbe {
   private static final afm<Integer> b = afp.a(bzt.class, afo.b);
   private static final afm<Integer> c = afp.a(bzt.class, afo.b);
   private static final afm<Integer> d = afp.a(bzt.class, afo.b);
   private static final List<afm<Integer>> e = ImmutableList.of(b, c, d);
   private static final afm<Integer> bT = afp.a(bzt.class, afo.b);
   ...
   private int cb;
   private final alx cc = (alx)new alx(this.O_(), big.a.f, big.b.a).a(true);
   private static final Predicate<bky> cd = $$0 -> $$0.eR() != bld.b && $$0.fz();
   private static final bvk ce = bvk.a().a(20.0).a(cd);

   public bzt(bkm<? extends bzt> $$0, crs $$1) {
      super($$0, $$1);
   ...
   @Override
   public void c_() {
      eji $$0 = this.do().d(1.0, 0.6, 1.0);
      if (!this.dL().B && this.t(0) > 0) {
         bki $$1 = this.dL().a(this.t(0));
         if ($$1 != null) {
            double $$2 = $$0.d;
            ...
            $$0 = new eji($$0.c, $$2, $$0.e);
            eji $$3 = new eji($$1.dq() - this.dq(), 0.0, $$1.dw() - this.dw());
            if ($$3.i() > 9.0) {
               eji $$4 = $$3.d();
      ...
      this.f($$0);
      if ($$0.i() > 0.05) {
         this.r((float)ati.d($$0.e, $$0.c) * (180.0F / (float)Math.PI) - 90.0F);
      }
      ...
      for (int $$6 = 0; $$6 < 2; $$6++) {
         ...
         if ($$8 != null) {
            ...
            float $$16 = (float)(ati.d($$14, $$12) * 180.0F / (float)Math.PI) - 90.0F;
            float $$17 = (float)(-(ati.d($$13, $$15) * 180.0F / (float)Math.PI));
   ...
   protected void X() {
      if (this.y() > 0) {
         ...
         if ($$0 <= 0) {
            this.dL().a(this, this.dq(), this.du(), this.dw(), 7.0F, false, crs.a.c);
            if (!this.aS()) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ah >= this.bZ[$$1 - 1]) {
               ...
               if ((this.dL().ai() == bin.c || this.dL().ai() == bin.d) && this.ca[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
                  double $$4 = ati.a(this.ag, this.dq() - 10.0, this.dq() + 10.0);
                  double $$5 = ati.a(this.ag, this.ds() - 5.0, this.ds() + 5.0);
                  double $$6 = ati.a(this.ag, this.dw() - 10.0, this.dw() + 10.0);
               ...
               int $$7 = this.t($$1);
               if ($$7 > 0) {
                  bky $$8 = (bky)this.dL().a($$7);
                  if ($$8 != null && this.c($$8) && !(this.f((bki)$$8) > 900.0) && this.E($$8)) {
                     this.a($$1 + 1, $$8);
                  ...
                  List<bky> $$9 = this.dL().a(bky.class, ce, this, this.cG().c(20.0, 8.0, 20.0));
                  if (!$$9.isEmpty()) {
                     bky $$10 = $$9.get(this.ag.a($$9.size()));
                     this.a($$1, $$10.ah());
                  }
               }
            }
         ...
         if (this.cb > 0) {
            this.cb--;
            if (this.cb == 0 && this.dL().X().b(cro.c)) {
               int $$11 = ati.a(this.ds());
               int $$12 = ati.a(this.dq());
               int $$13 = ati.a(this.dw());
               boolean $$14 = false;
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      cer $$11 = new cer(this.dL(), this, $$8, $$9, $$10);
      $$11.b(this);
      if ($$4) {
         $$11.a(true);
      }
   ...
   public boolean a(bjg $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(are.t) || $$0.d() instanceof bzt) {
         return false;
      } else if (this.y() > 0 && !$$0.a(are.d)) {
         return false;
      } else {
         if (this.a()) {
            bki $$2 = $$0.c();
         ...
         bki $$3 = $$0.d();
         if ($$3 != null && !($$3 instanceof cdm) && $$3 instanceof bky && ((bky)$$3).eR() == this.eR()) {
            return false;
         } else {
            if (this.cb <= 0) {
               this.cb = 20;
   ...
   public static bmd.a t() {
      return cba.gk().a(bme.l, 300.0).a(bme.m, 0.6F).a(bme.f, 0.6F).a(bme.g, 40.0).a(bme.a, 4.0);
   }
   ...
   class a extends brt {
      public a() {
         this.a(EnumSet.of(brt.a.a, brt.a.c, brt.a.b));
      }
