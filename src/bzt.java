...
public class bzt extends bzm {
   ...
   public boolean a() {
      if (!this.a.gc() && !this.a.hb()) {
         List<bru> $$0 = this.a.dP().a(this.a, this.a.cK().c(9.0, 4.0, 9.0), $$0x -> {
            bsa<?> $$1x = $$0x.ak();
            return $$1x == bsa.an || $$1x == bsa.be;
         });
         cgl $$1 = null;
   ...
   public void e() {
      if (this.a.hb()) {
         if (!(this.a.ge() instanceof cia)) {
            cgl $$0 = this.a.hc();
            double $$1 = (double)this.a.f($$0);
            float $$2 = 2.0F;
            euk $$3 = new euk($$0.du() - this.a.du(), $$0.dw() - this.a.dw(), $$0.dA() - this.a.dA()).d().a(Math.max($$1 - 2.0, 0.0));
