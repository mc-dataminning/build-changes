...
public class bhd {
   ...
   private JsonElement a(List<Pair<dlb, bhn<bhf>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bhn)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dlb, bhn<bhf>> $$3 : $$0) {
         bhn<bhf> $$4 = (bhn<bhf>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dlb)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bhl> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bgt.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bhb $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bhj $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bhj.b $$3 = (bhj.b)$$1x.getFirst();
         bhj.a $$4 = (bhj.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bhg> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bhg>, ToDoubleFunction<bhg>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bhg::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bhg::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bhg::c));
      return $$1;
   }
}
