...
public class eel extends LongLinkedOpenHashSet {
   private final eel.a a;

   public eel(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eel.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = aun.f(60000000);
      private static final int b = aun.f(60000000);
