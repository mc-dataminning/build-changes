...
public class eel {
   ...
   private final dhc o;
   private static final List<dke> p = List.of(dkg.l, dkg.O, dkg.i, dkg.b, dkg.k, dkg.L, dkg.N, dkg.fz, dkg.ec, dkg.iR, dkg.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jq<dic>>> s;
   private final transient double[][] t;

   private eel(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dic>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static eel a(@Nullable eel.d $$0) {
      return $$0 == null ? null : new eel($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public eel.d a() {
      ...
      return new eel.d(this.o.ao(), this.o.ap() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static eel a(asp $$0, int $$1, int $$2) {
      dzi $$3 = $$0.a($$1, $$2);
      eel $$4 = $$3.s();
      if ($$4 != null && !$$3.k().d(eaj.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jn> a(dhy $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dzi $$1, int $$2, int $$3) {
   ...
   private int a(dzi $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(edi.a.a)) {
         $$3 = Math.min($$0.a(edi.a.a, $$1, $$2), this.o.am());
      } else {
         $$3 = this.o.am();
      }
   ...
   private static double a(dzi $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dzi $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dzi $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jq<dic>> b(dzi $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dic>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dzi $$0, jh $$1) {
      dxn $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axu.Q)) {
   ...
   protected void a(int $$0, int $$1, eel.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, eel.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dic> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<eel.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(eel.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(eel.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(eel.d::c)
                  )
                  .apply($$0, eel.d::new)
         )
         .validate(eel.d::a);

      private static DataResult<eel.d> a(eel.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != eel.n
            ? DataResult.error(() -> "heights has to be of length " + eel.n)
