...
public class bng {
   ...
   private static void a(bno $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnj $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvx, bns<bni>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bns)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvx, bns<bni>> $$3 : $$0) {
         bns<bni> $$4 = (bns<bni>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dvx)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnq> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bmv.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bne $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bng::a));
      $$1.add("chunksWritten", this.a($$0.m(), bng::a));
      return $$1;
   }

   private JsonElement a(bnl.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bne $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bng::a));
      $$1.add("received", this.a($$0.k(), bng::a));
      return $$1;
   }

   private <T> JsonElement a(bnn<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bnk> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bnk>, ToDoubleFunction<bnk>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bnk::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bnk::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bnk::c));
      return $$1;
   }
}
