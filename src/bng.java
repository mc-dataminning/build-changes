...
public abstract class bng<R extends Runnable> implements bmo, bni<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bng(String $$0) {
      this.b = $$0;
      bmm.a.a(this);
   }
   ...
   @Override
   public List<bml> bu() {
      return ImmutableList.of(bml.a(this.b + "-pending-tasks", bmk.b, this::bw));
   }
}
