...
public class chy extends chm {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new evz($$0, this.g.dw() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.F(this.g)) {
               this.d++;
               evz $$8 = new evz(this.g.du() - this.a.du(), 0.0, this.g.dA() - this.a.dA()).d();
               evz $$9 = new evz((double)aye.a(this.a.dF() * (float) (Math.PI / 180.0)), 0.0, (double)(-aye.b(this.a.dF() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  evz $$13 = this.a.g(1.0F);
                  ...
                  cmq $$20 = new cmq(this.a.dP(), this.a, $$17, $$18, $$19);
   ...
   public void a(bsy $$0) {
      ...
      int $$9 = aye.a(this.g.dw() + $$8);
      eon $$10 = new eon($$3, $$9, $$4);
