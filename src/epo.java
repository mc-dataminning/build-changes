...
public abstract class epo {
   ...
   public eoq a() {
      if (this.c()) {
         ...
         return new eoq(this.b(ih.a.a), this.b(ih.a.b), this.b(ih.a.c), this.c(ih.a.a), this.c(ih.a.b), this.c(ih.a.c));
      }
   }

   public epo b() {
      return this.c() ? epl.a() : epl.a(this.b(ih.a.a), this.b(ih.a.b), this.b(ih.a.c), this.c(ih.a.a), this.c(ih.a.b), this.c(ih.a.c));
   }
   ...
   public epo a(double $$0, double $$1, double $$2) {
      return (epo)(this.c() ? epl.a() : new eox(this.a, new epk(this.a(ih.a.a), $$0), new epk(this.a(ih.a.b), $$1), new epk(this.a(ih.a.c), $$2)));
   }

   public epo d() {
      epo[] $$0 = new epo[]{epl.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = epl.b($$0[0], epl.a($$1, $$2, $$3, $$4, $$5, $$6), eoz.o));
      return $$0[0];
   }
   ...
   public List<eoq> e() {
      List<eoq> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new eoq($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(ih.a $$0, double $$1) {
      return awm.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public eor a(eov $$0, eov $$1, ib $$2) {
      if (this.c()) {
         return null;
      } else {
         eov $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ih.a.a, $$4.c - (double)$$2.u()), this.a(ih.a.b, $$4.d - (double)$$2.v()), this.a(ih.a.c, $$4.e - (double)$$2.w()))
               ? new eor($$4, ih.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : eoq.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<eov> a(eov $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         eov[] $$1 = new eov[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = awm.a($$0.a(), $$2, $$5);
            double $$9 = awm.a($$0.b(), $$3, $$6);
            double $$10 = awm.a($$0.c(), $$4, $$7);
   ...
   public epo a(ih $$0) {
      if (!this.c() && this != epl.b()) {
         if (this.b != null) {
            epo $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private epo b(ih $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new epm(this, $$1, $$4);
      }
   }

   public double a(ih.a $$0, eoq $$1, double $$2) {
      return this.a(hz.a($$0, ih.a.a), $$1, $$2);
   }

   protected double a(hz $$0, eoq $$1, double $$2) {
      if (this.c()) {
         return $$2;
