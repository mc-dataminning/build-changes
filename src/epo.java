...
public class epo extends eps implements epq {
   ...
   public epo.c a() {
      return new epo.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(epy.b $$0, epy $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (epz)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(epy $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == epr.k;
         boolean $$2 = $$0 == epr.j;
   ...
   private IntConsumer a(int $$0, epy.a $$1) {
   ...
   private epo.b q() {
      ...
      this.k += $$5;
      this.j++;
      epo.a $$9 = new epo.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new epo.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == epy.b.a || this.q == epy.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<epz> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      epz $$1 = (epz)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == epz.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == epz.b.c) {
         epq.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, epq.a($$11));
         this.a($$14 + 5, epq.a($$12));
         this.a($$14 + 6, epq.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(epy a, int b, int c, epy.b d, epy.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(epy.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eqb $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
