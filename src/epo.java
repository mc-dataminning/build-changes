...
public class epo {
   ...
   public epo(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public epo(ept $$0, ept $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static epo a(ecw $$0) {
      return new epo((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static epo a(ept $$0) {
      return new epo($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static epo a(ib $$0, ib $$1) {
      return new epo(
   ...
   public epo a(double $$0) {
      return new epo($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public epo b(double $$0) {
      return new epo(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public epo c(double $$0) {
      return new epo(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public epo d(double $$0) {
      return new epo(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public epo e(double $$0) {
      return new epo(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public epo f(double $$0) {
      return new epo(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public epo b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public epo c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public epo d(double $$0, double $$1, double $$2) {
      return new epo(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public epo f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public epo h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ept> b(ept $$0, ept $$1) {
   ...
   @Nullable
   public static epp a(Iterable<epo> $$0, ept $$1, ept $$2, ib $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new epp($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ih a(epo $$0, ept $$1, double[] $$2, @Nullable ih $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ept f() {
      return new ept(aww.d(0.5, this.a, this.d), aww.d(0.5, this.b, this.e), aww.d(0.5, this.c, this.f));
   }

   public static epo a(ept $$0, double $$1, double $$2, double $$3) {
      return new epo($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
