...
public class dkt {
   ...
   private final int j;
   private final int k;
   private List<dkt.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public dkt(boolean $$0, awl<ddy> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static dkt a() {
      return new dkt(false, avw.bS, 10, 4, 10, 5);
   }

   public static dkt b() {
      return new dkt(true, avw.bT, 50, 1, 5, 10);
   }
   ...
   public void a(ud $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<dkt.a> $$1 = (List<dkt.a>)dkt.a.b.listOf().parse(new Dynamic(ur.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(ud $$0) {
      dkt.a.b.listOf().encodeStart(ur.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(io $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dkt.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dkt.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(day $$0, io $$1, ayk $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<dkt.a> $$4 = new ArrayList<>();
         Map<io, dkt.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dkt.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  io.a.fieldOf("pos").forGetter(dkt.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dkt.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dkt.a::c),
      ...
      private boolean a(day $$0, io $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(day $$0, io $$1, ayk $$2, dkt $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, avh.vQ, avi.e, 1.0F, 1.0F);
               }
      ...
      private static dko a(drb $$0) {
         return $$0.b() instanceof dko $$1 ? $$1 : dko.s_;
      }

      private static List<js> a(ayk $$0) {
         return ac.a(c, $$0);
      }

      @Nullable
      private static io a(day $$0, io $$1, ayk $$2) {
         io.a $$3 = $$1.j();
         io.a $$4 = $$1.j();
      ...
      private static boolean a(day $$0, io $$1, io $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            io $$3 = $$2.b($$1);
      ...
      private static boolean a(day $$0, io $$1, it $$2) {
         io $$3 = $$1.a($$2);
