...
public class gw implements ArgumentType<gs> {
   ...
   public static eyv a(CommandContext<eu> $$0, String $$1) {
      eyw $$2 = ((gs)$$0.getArgument($$1, gs.class)).a((eu)$$0.getSource());
      return new eyv((float)$$2.d, (float)$$2.f);
   }
