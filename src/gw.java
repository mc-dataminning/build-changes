...
public class gw implements ArgumentType<gw.d> {
   ...
   static final Map<alg, gw.a> i = Stream.of(new gw.a(h, $$0 -> true, cw.d.d.map($$0 -> $$1 -> $$0.d($$1.M()))))
   ...
   public gw.d a(StringReader $$0) throws CommandSyntaxException {
      return ag.a(this.k.a($$0))::test;
   }
   ...
   static class b implements gr.b<Predicate<czk>, gw.a, gw.c> {
      ...
      public gw.a g(ImmutableStringReader $$0, alg $$1) throws CommandSyntaxException {
         gw.a $$2 = gw.i.get($$1);
         if ($$2 != null) {
            return $$2;
         } else {
            kj<?> $$3 = this.c.a(alf.a(mh.r, $$1)).map(jf::a).orElseThrow(() -> gw.d.createWithContext($$0, $$1));
            return gw.a.a($$0, $$1, $$3);
         }
      }
      ...
      public gw.c h(ImmutableStringReader $$0, alg $$1) throws CommandSyntaxException {
         gw.c $$2 = gw.j.get($$1);
