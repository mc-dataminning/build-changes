...
public class cef {
   ...
   public cef a(@Nullable Predicate<bto> $$0) {
      this.g = $$0;
      return this;
   }

   public boolean a(@Nullable bto $$0, bto $$1) {
      if ($$0 == $$1) {
         return false;
      } else if (!$$1.eu()) {
         return false;
         ...
         if ($$0 == null) {
            ...
            if (this.e && $$0 instanceof btq $$5 && !$$5.M().a($$1)) {
               return false;
            }
         }
