...
public class cef extends cfd {
   ...
   public cef(int $$0, cbl $$1) {
      this($$0, $$1, ceo.a);
   }

   public cef(int $$0, cbl $$1, ceo $$2) {
      super(cfi.h, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cfe l() {
      return cfe.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   @Override
   protected boolean a(cbm $$0, boolean $$1) {
      return ($$0.fR().d || $$0.cd >= this.w.b()) && this.w.b() > 0;
   }

   @Override
   protected void a(cbm $$0, cix $$1) {
      if (!$$0.fR().d) {
         $$0.c(-this.w.b());
      }
      ...
      this.o.a(($$1x, $$2x) -> {
         dez $$3 = $$1x.a_($$2x);
         if (!$$0.fR().d && $$3.a(apl.M) && $$0.ee().i() < 0.12F) {
            dez $$4 = crm.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cix $$4 = $$0.p();
         cix $$5 = this.q.a(1);
         Map<cne, Integer> $$6 = cng.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cja.tC) && !cht.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cne, Integer> $$16 = cng.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cne $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fR().d || $$0.a(cja.tC)) {
                        $$22 = true;
                     }
