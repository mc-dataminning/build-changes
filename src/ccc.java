...
public abstract class ccc {
   ...
   public ccc(bss $$0, daz $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = ayf.a($$0.g(bty.k) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract enm a(int var1);
   ...
   @Nullable
   public final enk a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(io.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public enk a(Stream<io> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public enk a(Set<io> $$0, int $$1) {
   ...
   @Nullable
   protected enk a(Set<io> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(bty.k));
   }

   @Nullable
   protected enk a(Set<io> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         dbm $$7 = new dbm(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         enk $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.af().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable enk $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            if ($$0.d > $$1.d && !this.a.aE() && ayf.a($$0.c) == ayf.a($$1.c) && ayf.a($$0.e) == ayf.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(eum $$0) {
      io $$1 = io.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ens.a(this.b, $$1);
   }
   ...
   private boolean c(eum $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         eum $$1 = eum.c(this.c.g());
         if (!$$0.a((jh)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            eum $$2 = eum.c(this.c.d(this.c.f() + 1));
            eum $$3 = $$1.d($$0);
            eum $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void S_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eni $$1 = this.c.a($$0);
            eni $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            drd $$3 = this.b.a_(new io($$1.a, $$1.b, $$1.c));
            if ($$3.a(avx.bl)) {
   ...
   public boolean b(enn $$0) {
      return $$0 != enn.n && $$0 != enn.p && $$0 != enn.d;
   }

   protected static boolean a(bss $$0, eum $$1, eum $$2, boolean $$3) {
      eum $$4 = new eum($$2.c, $$2.d + (double)$$0.dk() * 0.5, $$2.e);
      return $$0.dP().a(new dai($$1, $$4, dai.a.a, $$3 ? dai.b.c : dai.b.a, $$0)).c() == euk.a.a;
   }
   ...
   public boolean b(io $$0) {
      if (this.m) {
         ...
         eni $$1 = this.c.d();
         eum $$2 = new eum(((double)$$1.a + this.a.du()) / 2.0, ((double)$$1.b + this.a.dw()) / 2.0, ((double)$$1.c + this.a.dA()) / 2.0);
