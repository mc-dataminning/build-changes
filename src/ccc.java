...
public interface ccc extends cct {
   void b(boolean var1);

   void a(bml var1, cmy var2, cga var3, float var4);
   ...
   default void b(bml $$0, float $$1) {
      bka $$2 = cgb.a($$0, cnb.vM);
      cmy $$3 = $$0.b($$2);
      if ($$0.b(cnb.vM)) {
         clg.a($$0.dM(), $$0, $$2, $$3, $$1, (float)(14 - $$0.dM().ak().a() * 4));
      }

      this.a();
   }

   default void a(bml $$0, bml $$1, cga $$2, float $$3, float $$4) {
      double $$5 = $$1.dr() - $$0.dr();
      double $$6 = $$1.dx() - $$0.dx();
      double $$7 = Math.sqrt($$5 * $$5 + $$6 * $$6);
      double $$8 = $$1.e(0.3333333333333333) - $$2.dt() + $$7 * 0.2F;
      Vector3f $$9 = this.a($$0, new elt($$5, $$8, $$6), $$3);
      $$2.c((double)$$9.x(), (double)$$9.y(), (double)$$9.z(), $$4, (float)(14 - $$0.dM().ak().a() * 4));
      $$0.a(ars.fR, 1.0F, 1.0F / ($$0.eg().i() * 0.4F + 0.8F));
   }

   default Vector3f a(bml $$0, elt $$1, float $$2) {
