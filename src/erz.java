...
public class erz implements ecl.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<erz> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ays<erz> a = ays.a(f);
   private final esd g;
   private final esd h;
   private final esd i;
   ...
   public static erz a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new erz(new edt(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private erz(esd $$0, esd $$1, esd $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public erz(azh $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         esd.a($$0, IntStream.rangeClosed(-15, 0)),
         esd.a($$0, IntStream.rangeClosed(-15, 0)),
         esd.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public erz a(azh $$0) {
      return new erz($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(ecl.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         esa $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(esd.b($$4 * $$13), esd.b($$5 * $$13), esd.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = esd.b($$1 * $$13);
         double $$21 = esd.b($$2 * $$13);
         double $$22 = esd.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            esa $$24 = this.g.a($$19);
            if ($$24 != null) {
