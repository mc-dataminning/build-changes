...
public class erz {
   ...
   public static void a(File $$0, ekt $$1, Consumer<ui> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ekt $$2, Consumer<ui> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ekt $$2, Consumer<ui> $$3) {
      eli $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            ui $$3x = ui.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new ug(ug.a.b, $$6.getAbsolutePath())));
            $$3.accept(ui.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(ui.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eli a(ekt $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eli $$3 = new eli($$1, $$2, false);
   ...
   public erz(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
