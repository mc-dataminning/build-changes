...
public class rs {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(tm.c("argument.nbt.trailing"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(tm.c("argument.nbt.expected.key"));
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(tm.c("argument.nbt.expected.value"));
   public static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(($$0, $$1) -> tm.a("argument.nbt.list.mixed", $$0, $$1));
   public static final Dynamic2CommandExceptionType e = new Dynamic2CommandExceptionType(($$0, $$1) -> tm.a("argument.nbt.array.mixed", $$0, $$1));
   public static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> tm.a("argument.nbt.array.invalid", $$0));
   ...
   public static final Codec<qy> i = Codec.STRING.comapFlatMap($$0 -> {
      try {
         return DataResult.success(new rs(new StringReader($$0)).a(), Lifecycle.stable());
   ...
   public static qy a(String $$0) throws CommandSyntaxException {
      return new rs(new StringReader($$0)).a();
   }
   ...
   protected rr c() throws CommandSyntaxException {
      this.u.skipWhitespace();
      int $$0 = this.u.getCursor();
      if (StringReader.isQuotedStringStart(this.u.peek())) {
         return rp.a(this.u.readQuotedString());
      } else {
   ...
   private rr b(String $$0) {
      try {
         ...
         if (s.matcher($$0).matches()) {
            return rm.a(Short.parseShort($$0.substring(0, $$0.length() - 1)));
         }
   ...
   public rr d() throws CommandSyntaxException {
      this.u.skipWhitespace();
      if (!this.u.canRead()) {
         throw c.createWithContext(this.u);
      } else {
   ...
   protected rr e() throws CommandSyntaxException {
   ...
   private rr g() throws CommandSyntaxException {
      this.a('[');
      this.u.skipWhitespace();
      if (!this.u.canRead()) {
         throw c.createWithContext(this.u);
   ...
   private rr h() throws CommandSyntaxException {
      this.a('[');
      int $$0 = this.u.getCursor();
      char $$1 = this.u.read();
      this.u.read();
   ...
   private <T extends Number> List<T> a(rt<?> $$0, rt<?> $$1) throws CommandSyntaxException {
