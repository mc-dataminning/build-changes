...
public class rs implements rr {
   ...
   public void a(rl $$0) {
      ...
      ti $$3 = ti.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = ti.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(qs $$0) {
      ti $$1 = ti.b("b").a(g);
      this.t = ti.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(qz $$0) {
      this.t = ti.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(qx $$0) {
      ti $$1 = ti.b("f").a(g);
      this.t = ti.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(qv $$0) {
      ti $$1 = ti.b("d").a(g);
      this.t = ti.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(qr $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         tv $$5 = ti.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(qy $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(ti.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(rb $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         ti $$5 = ti.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(ra $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new rs(this.r, this.s).a($$0.k($$3)));
         }
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            tv $$6 = ti.b(Strings.repeat(this.r, this.s + 1));
            $$6.b(new rs(this.r, this.s + 1).a($$0.k($$5)));
            if ($$5 != $$0.size() - 1) {
   ...
   public void a(qu $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            tv $$6 = ti.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new rs(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static ti a(String $$0) {
      if (h.matcher($$0).matches()) {
         return ti.b($$0).a(d);
      } else {
         String $$1 = rl.b($$0);
         String $$2 = $$1.substring(0, 1);
         ti $$3 = ti.b($$1.substring(1, $$1.length() - 1)).a(d);
         return ti.b($$2).b($$3).f($$2);
      }
   }
