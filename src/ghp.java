...
public class ghp {
   private static final gig a = gig.t(alh.b("textures/map/map_background.png"));
   private static final gig b = gig.t(alh.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fja au;
   private final gxb av = new gxb();
   private cvx aw = cvx.k;
   private cvx ax = cvx.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gnx aC;
   private final gox aD;

   public ghp(fja $$0, gnx $$1, gox $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(buv $$0, cvx $$1, cvv $$2, boolean $$3, fdt $$4, ghw $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dX(), $$6, gxj.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = azj.a($$1, 0.0F, 1.0F);
      return -azj.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(fdt $$0, ghw $$1, int $$2, bup $$3) {
      gtf $$4 = (gtf)this.aC.<ggp>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bup.b ? 1.0F : -1.0F;
      ...
      alh $$6 = this.au.t.b().a();
      if ($$3 == bup.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(coi.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(coi.c));
      }

      $$0.b();
   }

   private void a(fdt $$0, ghw $$1, int $$2, float $$3, bup $$4, float $$5, cvx $$6) {
      float $$7 = $$4 == bup.b ? 1.0F : -1.0F;
      ...
      float $$8 = azj.c($$5);
      float $$9 = azj.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * azj.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * azj.a($$5 * (float) Math.PI);
   ...
   private void a(fdt $$0, ghw $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = azj.c($$5);
      float $$7 = -0.2F * azj.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * azj.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = azj.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.aw);
   }

   private void a(fdt $$0, ghw $$1, int $$2, cvx $$3) {
      ...
      esw $$4 = $$3.a(kt.K);
      esy $$5 = cwk.a($$4, this.au.s);
      fdx $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fdt $$0, ghw $$1, int $$2, float $$3, float $$4, bup $$5) {
      boolean $$6 = $$5 != bup.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azj.c($$4);
      float $$9 = -0.3F * azj.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * azj.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * azj.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = azj.a($$4 * $$4 * (float) Math.PI);
      float $$13 = azj.a($$8 * (float) Math.PI);
      ...
      gtf $$15 = (gtf)this.aC.<ggp>a($$14);
      alh $$16 = $$14.b().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(coi.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(coi.c));
      }
   }

   private void a(fdt $$0, float $$1, bup $$2, cvx $$3, coh $$4) {
      float $$5 = (float)$$4.fE() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((buv)$$4);
      if ($$6 < 0.8F) {
         float $$7 = azj.e(azj.b($$5 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$7, 0.0F);
      }
   ...
   private void a(fdt $$0, float $$1, bup $$2, cvx $$3, coh $$4, float $$5) {
      this.b($$0, $$2, $$5);
      float $$6 = (float)($$4.fE() % 10);
      float $$7 = $$6 - $$1 + 1.0F;
      ...
      float $$12 = -15.0F;
      int $$13 = 2;
      float $$14 = -15.0F + 75.0F * azj.b($$8 * 2.0F * (float) Math.PI);
      if ($$2 != bup.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(fdt $$0, bup $$1, float $$2) {
      int $$3 = $$1 == bup.b ? 1 : -1;
      float $$4 = azj.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = azj.a(azj.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(fdt $$0, bup $$1, float $$2) {
      int $$3 = $$1 == bup.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fdt $$1, ghw.a $$2, ggs $$3, int $$4) {
      float $$5 = $$3.D($$0);
      brx $$6 = (brx)MoreObjects.firstNonNull($$3.aG, brx.a);
      float $$7 = $$3.j($$0);
      ghp.a $$8 = a($$3);
      float $$9 = azj.h($$0, $$3.cE, $$3.cC);
      float $$10 = azj.h($$0, $$3.cD, $$3.cB);
      $$1.a(a.b.rotationDegrees(($$3.h($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.i($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == brx.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azj.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, brx.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == brx.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azj.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, brx.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static ghp.a a(ggs $$0) {
      cvx $$1 = $$0.fb();
      cvx $$2 = $$0.fc();
      boolean $$3 = $$1.a(cwb.ow) || $$2.a(cwb.ow);
      boolean $$4 = $$1.a(cwb.vX) || $$2.a(cwb.vX);
      if (!$$3 && !$$4) {
         return ghp.a.a;
      } else if ($$0.fB()) {
         return b($$0);
      } else {
         return a($$1) ? ghp.a.b : ghp.a.a;
      }
   }

   private static ghp.a b(ggs $$0) {
      cvx $$1 = $$0.fD();
      brx $$2 = $$0.fC();
      if (!$$1.a(cwb.ow) && !$$1.a(cwb.vX)) {
         return $$2 == brx.a && a($$0.fc()) ? ghp.a.b : ghp.a.a;
      } else {
         return ghp.a.a($$2);
      }
   }
   ...
   private static boolean a(cvx $$0) {
      return $$0.a(cwb.vX) && cuo.g($$0);
   }

   private void a(ggp $$0, float $$1, float $$2, brx $$3, float $$4, cvx $$5, float $$6, fdt $$7, ghw $$8, int $$9) {
      if (!$$0.gI()) {
         boolean $$10 = $$3 == brx.a;
         bup $$11 = $$10 ? $$0.fA() : $$0.fA().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cq()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fB() && $$0.fE() > 0 && $$0.fC() == $$3) {
               ...
               float $$15 = (float)$$5.a((buv)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cuo.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = azj.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * azj.a(azj.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * azj.a(azj.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * azj.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cvv.e : cvv.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bup.b;
            if ($$0.fB() && $$0.fE() > 0 && $$0.fC() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((buv)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((buv)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * azj.a(azj.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * azj.a(azj.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * azj.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cvv.e : cvv.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.C()) {
         this.ay = azj.a(this.ay - 0.4F, 0.0F, 1.0F);
         this.aA = azj.a(this.aA - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.H(1.0F);
         this.ay = this.ay + azj.a((this.aw == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + azj.a((float)(this.ax == $$2 ? 1 : 0) - this.aA, -0.4F, 0.4F);
      }
