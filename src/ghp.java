...
public class ghp {
   ...
   public void a(final ghn $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final giq $$3 = giq.a($$0.b);
      Optional<InetSocketAddress> $$4 = gis.a.a($$3).map(gip::d);
      if ($$4.isEmpty()) {
         this.a(fuh.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final giq $$1, final ghn $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vi.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new ghg($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(ghn.b.d);
               $$2.h = wp.b($$2xx);
               $$2.d = wp.b($$3);
               $$2.c = ghp.a($$4, $$5);
