...
public class ghp extends avg<Optional<ghp.b>> implements AutoCloseable {
   ...
   private ghp.a o = ghp.a.b;
   @Nullable
   private fiu p;
   @Nullable
   private ghp.b q;
   private final fee r = new fee(fee.a.a);
   private boolean s;

   protected Optional<ghp.b> a(avb $$0, bon $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new ghp.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<ghp.b> $$0, avb $$1, bon $$2) {
   ...
   public void a(int $$0, fiu $$1, float $$2, Matrix4f $$3, Matrix4f $$4, ezn $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            fea $$21 = this.a(fed.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
         ...
         if (!this.s) {
            RenderSystem.setShaderColor(axv.h(axv.b($$0)), axv.h(axv.c($$0)), axv.h(axv.d($$0)), 1.0F);
            if ($$1 == fiu.c) {
               this.a(gir.x(), $$3, $$4, $$18, $$7, $$19);
            }
   ...
   private void a(gir $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      ghq $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fea a(fed $$0, int $$1, int $$2, fiu $$3, ghp.a $$4, gir $$5) {
      float $$6 = 0.8F;
      int $$7 = axv.a(0.8F, 1.0F, 1.0F, 1.0F);
      int $$8 = axv.a(0.8F, 0.9F, 0.9F, 0.9F);
      int $$9 = axv.a(0.8F, 0.7F, 0.7F, 0.7F);
      int $$10 = axv.a(0.8F, 0.8F, 0.8F, 0.8F);
      fdw $$11 = $$0.a($$5.O(), $$5.N());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fiu.c);
      return $$11.a();
   }

   private void a(ghp.a $$0, fdw $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
         ...
         for (int $$13 = -32; $$13 <= 32; $$13++) {
            for (int $$14 = -32; $$14 <= 32; $$14++) {
               ...
               if ($$17 != 0L) {
                  int $$18 = a($$17);
                  if ($$8) {
                     this.a($$0, $$1, axv.a($$4, $$18), axv.a($$5, $$18), axv.a($$6, $$18), axv.a($$7, $$18), $$14, $$13, $$17);
                  } else {
                     this.a($$1, axv.a($$5, $$18), $$14, $$13);
                  }
               }
            }
         }
   ...
   private void a(fdw $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(ghp.a $$0, fdw $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
