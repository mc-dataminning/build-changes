...
public class ghp {
   ...
   public static class a extends Thread {
      private final ghp.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(ghp.b $$0) throws IOException {
         super("LanServerDetector #" + ghp.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(ghp.b));
   ...
   public static class b {
      private final List<gho> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gho> a() {
         if (this.b) {
            List<gho> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
