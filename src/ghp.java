...
public class ghp {
   ...
   public ghp(gkd $$0, dds $$1, int $$2, ggr $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, $$2 * 16, this.b.G_() + $$3 * 16, $$4 * 16);
               }
            }
         }
      }
      ...
      for (int $$4 = 0; $$4 < this.d; $$4++) {
         ...
         for (int $$8 = 0; $$8 < this.e; $$8++) {
            ...
            for (int $$12 = 0; $$12 < this.c; $$12++) {
               int $$13 = this.b.G_() + $$12 * 16;
               gkd.b $$14 = this.f[this.a($$4, $$12, $$8)];
               je $$15 = $$14.f();
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      int $$5 = Math.floorMod($$1 - this.b.ap(), this.c);
      int $$6 = Math.floorMod($$2, this.e);
      gkd.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected gkd.b a(je $$0) {
      int $$1 = azc.a($$0.v() - this.b.G_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = azc.b(azc.a($$0.u(), 16), this.d);
         int $$3 = azc.b(azc.a($$0.w(), 16), this.e);
