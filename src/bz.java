...
public class bz {
   ...
   public static final bz.b<cij.e> g = a("axolotl", bz.b.a(cij.e.f, $$0 -> $$0 instanceof cij $$1 ? Optional.of($$1.gp()) : Optional.empty()));
   ...
   public static final bz.b<chr.g> j = a("rabbit", bz.b.a(chr.g.h, $$0 -> $$0 instanceof chr $$1 ? Optional.of($$1.gp()) : Optional.empty()));
   public static final bz.b<cjk> k = a("horse", bz.b.a(cjk.h, $$0 -> $$0 instanceof cjd $$1 ? Optional.of($$1.p()) : Optional.empty()));
   public static final bz.b<cje.d> l = a("llama", bz.b.a(cje.d.e, $$0 -> $$0 instanceof cje $$1 ? Optional.of($$1.gC()) : Optional.empty()));
   public static final bz.b<coo> m = a("villager", bz.b.a(mb.w.q(), $$0 -> $$0 instanceof cok $$1 ? Optional.of($$1.a()) : Optional.empty()));
   public static final bz.b<chn.b> n = a("parrot", bz.b.a(chn.b.f, $$0 -> $$0 instanceof chn $$1 ? Optional.of($$1.gD()) : Optional.empty()));
   public static final bz.b<chs.a> o = a("salmon", bz.b.a(chs.a.d, $$0 -> $$0 instanceof chs $$1 ? Optional.of($$1.gx()) : Optional.empty()));
   public static final bz.b<chx.b> p = a("tropical_fish", bz.b.a(chx.b.m, $$0 -> $$0 instanceof chx $$1 ? Optional.of($$1.gz()) : Optional.empty()));
   public static final bz.a<ckx> q = a("painting", bz.a.a(mc.X, $$0 -> $$0 instanceof ckw $$1 ? Optional.of($$1.s()) : Optional.empty()));
   public static final bz.a<chb> r = a("cat", bz.a.a(mc.l, $$0 -> $$0 instanceof cha $$1 ? Optional.of($$1.gB()) : Optional.empty()));
   public static final bz.a<chi> s = a("frog", bz.a.a(mc.F, $$0 -> $$0 instanceof cir $$1 ? Optional.of($$1.x()) : Optional.empty()));
   public static final bz.a<cib> t = a("wolf", bz.a.a(mc.m, $$0 -> $$0 instanceof cia $$1 ? Optional.of($$1.gC()) : Optional.empty()));
   ...
   public static class a<V> {
      ...
      public static <V> bz.a<V> a(akt<? extends ke<V>> $$0, Function<buk, Optional<jr<V>>> $$1) {
         return new bz.a<>($$0, $$1);
      }

      public a(akt<? extends ke<V>> $$0, Function<buk, Optional<jr<V>>> $$1) {
         this.b = $$1;
