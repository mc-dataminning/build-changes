...
public class dbe {
   ...
   private boolean a(hx $$0) {
      return cuu.a(this.a, $$0) || cuu.a(this.a, $$0.c()) || cuu.a(this.a, $$0.d());
   }
   ...
   private dbe b(hx $$0) {
      dhn $$2 = this.a.a_($$0);
      if (cuu.g($$2)) {
         return new dbe(this.a, $$0, $$2);
      } else {
         hx $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (cuu.g($$2)) {
            return new dbe(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return cuu.g($$2) ? new dbe(this.a, $$1, $$2) : null;
         }
      }
   }
   ...
   private boolean b(dbe $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dbe $$0) {
      this.f.add($$0.b);
      hx $$1 = this.b.e();
      hx $$2 = this.b.f();
      hx $$3 = this.b.g();
   ...
   public dbe a(boolean $$0, boolean $$1, dir $$2) {
      hx $$3 = this.b.e();
      hx $$4 = this.b.f();
      hx $$5 = this.b.g();
      hx $$6 = this.b.h();
