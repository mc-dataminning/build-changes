...
public class dbe {
   public static final Codec<dbe> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dbc.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dbc.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               cud.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final ys<wf, dbe> b = ys.a(dbe::a, dbe::a);
   private final dbc c;
   private final Optional<dbc> d;
   private final cud e;
   private int f;
   private final int g;
   ...
   private dbe(dbc $$0, Optional<dbc> $$1, cud $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dbe(dbc $$0, cud $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dbe(dbc $$0, Optional<dbc> $$1, cud $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dbe(dbc $$0, Optional<dbc> $$1, cud $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dbe(dbc $$0, Optional<dbc> $$1, cud $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   public cud c() {
      return this.d.map(dbc::d).orElse(cud.l);
   }
   ...
   private static void a(wf $$0, dbe $$1) {
      dbc.b.encode($$0, $$1.d());
      cud.i.encode($$0, $$1.f());
      dbc.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dbe a(wf $$0) {
      dbc $$1 = dbc.b.decode($$0);
      cud $$2 = cud.i.decode($$0);
      Optional<dbc> $$3 = dbc.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dbe $$11 = new dbe($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
