...
public class dbe {
   ...
   public static final dbe b = new dbe(0, 0);
   ...
   public static dbe a(int $$0, int $$1) {
      return new dbe($$0 << 5, $$1 << 5);
   }

   public static dbe b(int $$0, int $$1) {
      return new dbe(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dbe $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public static Stream<dbe> a(dbe $$0, int $$1) {
      return a(new dbe($$0.e - $$1, $$0.f - $$1), new dbe($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<dbe> a(final dbe $$0, final dbe $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dbe>((long)($$2 * $$3), 64) {
         @Nullable
         private dbe e;

         @Override
         public boolean tryAdvance(Consumer<? super dbe> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new dbe($$0.e, $$2 + $$5);
               } else {
                  this.e = new dbe($$1 + $$4, $$2);
               }
            }
