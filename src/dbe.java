...
public interface dbe extends dca {
   @Nullable
   dph c_(iz var1);
   ...
   default evn a(dbg $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dsc $$2 = this.a_($$1);
         evr $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new evn($$0x.a(), je.a($$3.c, $$3.d, $$3.e), iz.a($$0x.a()), false) : null;
      }, $$0x -> {
         evr $$1 = $$0x.b().d($$0x.a());
         return evn.a($$0x.a(), je.a($$1.c, $$1.d, $$1.e), iz.a($$0x.a()));
      });
   }
   ...
   @Nullable
   default evn a(evr $$0, evr $$1, iz $$2, ewk $$3, dsc $$4) {
      evn $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         evn $$6 = $$4.m(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(ewk $$0, Supplier<ewk> $$1) {
      if (!$$0.c()) {
         return $$0.c(je.a.b);
      } else {
   ...
   static <T, C> T a(evr $$0, evr $$1, C $$2, BiFunction<C, iz, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
