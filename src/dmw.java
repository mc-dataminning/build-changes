...
public class dmw {
   ...
   private final List<dmu> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dmw.a l = new dmw.d(5.999997E7F);
   public static final dmw.c e = new dmw.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public hz b(double $$0, double $$1, double $$2) {
      return hz.a(awh.a($$0, this.e(), this.g()), $$1, awh.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bno $$0, enn $$1) {
      double $$2 = Math.max(awh.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dmw.a)($$0 == $$1 ? new dmw.d($$1) : new dmw.b($$0, $$1, $$2));
   ...
   public dmw.c t() {
      return new dmw.c(this);
   }

   public void a(dmw.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dmw.a {
      ...
      @Override
      public double a() {
         return awh.a(dmw.this.a() - this.e() / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
      }

      @Override
      public double c() {
         return awh.a(dmw.this.b() - this.e() / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? awh.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dmv i() {
         return this.c < this.b ? dmv.b : dmv.a;
      }
      ...
      @Override
      public dmw.a l() {
         return (dmw.a)(this.g() <= 0L ? dmw.this.new d(this.c) : this);
      }
      ...
      public eol m() {
         return eoi.a(
            eoi.c,
            eoi.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            enw.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dmw.c a(DynamicLike<?> $$0, dmw.c $$1) {
         double $$2 = awh.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = awh.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dmw.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dmw.a {
      ...
      private void n() {
         this.c = awh.a(dmw.this.a() - this.b / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
         this.d = awh.a(dmw.this.b() - this.b / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
         this.e = awh.a(dmw.this.a() + this.b / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
         this.f = awh.a(dmw.this.b() + this.b / 2.0, (double)(-dmw.this.k), (double)dmw.this.k);
         this.g = eoi.a(
            eoi.c,
            eoi.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            enw.e
