...
public class bhr extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bic.y);
      Type<?> $$1 = this.getOutputSchema().getType(bic.y);
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bju.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bju.a($$1.substring(0, $$2))));
