...
public abstract class bhr<R extends Runnable> implements bgz, bht<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bhr(String $$0) {
      this.b = $$0;
      bgx.a.a(this);
   }
   ...
   @Override
   public List<bgw> bp() {
      return ImmutableList.of(bgw.a(this.b + "-pending-tasks", bgv.b, this::br));
   }
}
