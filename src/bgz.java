...
public class bgz extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.a(this.getInputSchema().getTypeRaw(biq.z), $$0);
   }
   ...
   private <C, H extends Pair<String, ?>> TypeRewriteRule a(Type<C> $$0, Type<H> $$1) {
      ...
      if (!$$2.equals(this.getInputSchema().getType(biq.z))) {
         throw new IllegalStateException("Text component type did not match, expected " + $$2 + " but got " + this.getInputSchema().getType(biq.z));
      } else {
