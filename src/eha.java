...
public class eha {
   private static final eha a = new eha(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eha.a a(int $$0, int $$1) {
         return new eha.a(1.0, 0.0);
      }
   ...
   private static final evj b = evj.b(new egz(42L), ql.a);
   ...
   private final Long2ObjectOpenHashMap<ehb> h;
   private final Long2ObjectOpenHashMap<ehb> i;

   public static eha a() {
      return a;
   }

   public static eha a(@Nullable ary $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dic $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<ehb> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<ehb> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azm.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eha($$2, $$3);
         }
      }
   }

   eha(Long2ObjectOpenHashMap<ehb> $$0, Long2ObjectOpenHashMap<ehb> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eha.a a(int $$0, int $$1) {
      int $$2 = jp.a($$0);
      int $$3 = jp.a($$1);
      double $$4 = this.a($$2, 0, $$3, ehb::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eha.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jp.d(dic.a($$5x)), jp.d(dic.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(efr.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jp.d(dic.a($$6x)), jp.d(dic.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, eha.b $$3) {
      int $$4 = jp.e($$0);
      int $$5 = jp.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eha.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      ehb $$6 = (ehb)this.h.get(dic.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jp.d($$1), $$4, $$5 - jp.d($$2)) : Double.MAX_VALUE;
   }

   public dkb a(dkb $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         je<djy> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private je<djy> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<je<djy>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jp.d(dic.a($$5x)), $$1, jp.d(dic.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(ary $$0, ebw $$1) {
      dic $$2 = $$1.f();
      boolean $$3 = $$1.u();
      iu.a $$4 = new iu.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(efy.a.e, $$16, $$17)) + 1;
   ...
   private static void a(ebw $$0, iu $$1) {
      dzz $$2 = $$0.a_($$1);
      if ($$2.a(axc.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dju $$0, ecq $$1) {
      dic $$2 = $$1.f();
      Builder<jb, ehb> $$3 = ImmutableMap.builder();
   ...
   public static eha.c a(@Nullable ehb $$0, Map<jb, ehb> $$1) {
      List<eha.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eha.c a(@Nullable jb $$0, ehb $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ja $$4 : $$0.a()) {
   ...
   interface b {
      double get(ehb var1, int var2, int var3, int var4);
   }
