...
public class eha {
   ...
   public eha(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public eha(gv $$0, gv $$1) {
      this((double)$$0.u(), (double)$$0.v(), (double)$$0.w(), (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
   }

   public eha(ehf $$0, ehf $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static eha a(dup $$0) {
      return new eha((double)$$0.g(), (double)$$0.h(), (double)$$0.i(), (double)($$0.j() + 1), (double)($$0.k() + 1), (double)($$0.l() + 1));
   }

   public static eha a(ehf $$0) {
      return new eha($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public eha a(double $$0) {
      return new eha($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public eha b(double $$0) {
      return new eha(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public eha c(double $$0) {
      return new eha(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public eha d(double $$0) {
      return new eha(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public eha e(double $$0) {
      return new eha(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public eha f(double $$0) {
      return new eha(this.a, this.b, this.c, this.d, this.e, $$0);
   }

   public double a(hb.a $$0) {
   ...
   public eha b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public eha c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public eha d(double $$0, double $$1, double $$2) {
      return new eha(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public eha f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public eha h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ehf> b(ehf $$0, ehf $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      hb $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static ehb a(Iterable<eha> $$0, ehf $$1, ehf $$2, gv $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ehb($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static hb a(eha $$0, ehf $$1, double[] $$2, @Nullable hb $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, hb.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, hb.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, hb.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, hb.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, hb.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, hb.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public ehf f() {
      return new ehf(aro.d(0.5, this.a, this.d), aro.d(0.5, this.b, this.e), aro.d(0.5, this.c, this.f));
   }

   public static eha a(ehf $$0, double $$1, double $$2, double $$3) {
      return new eha($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
