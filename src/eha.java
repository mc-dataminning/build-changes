...
public class eha implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<eha.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public eha(List<eha.a> $$0) {
      this.c = $$0;
   }
   ...
   public static eha a(BufferedReader $$0) {
      return new eha($$0.lines().flatMap($$0x -> eha.a.a($$0x).stream()).toList());
   }

   public static record a(eha.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<eha.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new eha.a(eha.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new eha.a(eha.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new eha.a(eha.b.b, $$3));
      ...
      static eha.a b(String $$0) {
         return new eha.a(eha.b.a, "glob:" + $$0);
      }

      static eha.a c(String $$0) {
         return new eha.a(eha.b.a, "regex:" + $$0);
      }

      static eha.a d(String $$0) {
         return new eha.a(eha.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      eha.b a = FileSystem::getPathMatcher;
      eha.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
