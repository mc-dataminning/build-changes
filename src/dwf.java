...
public abstract class dwf {
   public static final Codec<dwf> b = jd.S.q().dispatch(dwf::e, dwg::codec);
   ...
   protected static <S extends dwf> P5<Mu<S>, ib, dwf.c, Float, Integer, Optional<dwf.a>> a(Instance<S> $$0) {
      return $$0.group(
         ib.v(16).optionalFieldOf("locate_offset", ib.g).forGetter(dwf::f),
         ...
         arg.i.fieldOf("salt").forGetter(dwf::i),
         dwf.a.a.optionalFieldOf("exclusion_zone").forGetter(dwf::j)
      );
   }

   protected dwf(ib $$0, dwf.c $$1, float $$2, int $$3, Optional<dwf.a> $$4) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   @Deprecated
   public static record a(hg<dvo> b, int c) {
      public static final Codec<dwf.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(aet.a(je.aB, dvo.a, false).fieldOf("other_set").forGetter(dwf.a::a), Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(dwf.a::b))
               .apply($$0, dwf.a::new)
      );
