...
public class dwf extends dtz {
   ...
   public static final class a {
      ...
      private static void a(dgi $$0, fba $$1, cox $$2) {
         azh $$3 = $$0.A;
         fba $$4 = $$1.a($$2.du().b(0.0, (double)($$2.ds() / 2.0F), 0.0));
         int $$5 = ayz.a($$3, 2, 5);
      ...
      private static void a(dgi $$0, ji $$1, dwj $$2) {
         if (a($$2)) {
            azh $$3 = $$0.H_();
            if ($$3.i() <= 0.02F) {
               $$0.a($$1, awa.Bq, awb.e, $$3.i() * 0.25F + 0.75F, $$3.i() + 0.5F, false);
            }
         }
      }
   ...
   public static final class b {
      ...
      public static void a(arc $$0, ji $$1, dwx $$2, dwh $$3, dwi $$4, dwj $$5) {
         dwk $$6 = $$2.c(dsm.b);
         if (a($$0.ad(), $$6)) {
            a($$0, $$6, $$3, $$5, $$1);
         }
      ...
      public static void a(arc $$0, ji $$1, dwx $$2, dwh $$3, dwi $$4, dwj $$5, cox $$6, cwp $$7) {
         dwk $$8 = $$2.c(dsm.b);
         if (a($$3, $$8)) {
            if (!a($$3, $$7)) {
               a($$0, $$4, $$1, awa.Bz);
      ...
      static void a(arc $$0, ji $$1, dwx $$2, dwx $$3, dwh $$4, dwj $$5) {
         dwk $$6 = $$2.c(dsm.b);
         dwk $$7 = $$3.c(dsm.b);
         $$0.a($$1, $$3, 3);
      ...
      static void a(arc $$0, dwk $$1, dwh $$2, dwj $$3, ji $$4) {
         if (!a($$2, $$1)) {
            $$3.a(cwp.j);
         } else {
      ...
      private static cwp a(arc $$0, ji $$1, akt<evw> $$2) {
         evw $$3 = $$0.p().bc().b($$2);
      ...
      private static void a(arc $$0, dwx $$1, ji $$2, dwh $$3, dwi $$4, dwj $$5, List<cwp> $$6) {
         $$4.a($$6);
         $$5.a($$4.f());
         $$4.b($$0.ad() + 14L);
      ...
      private static List<cwp> a(arc $$0, dwh $$1, ji $$2, cox $$3, cwp $$4) {
         evw $$5 = $$0.p().bc().b($$1.b());
      ...
      private static void a(arc $$0, dwi $$1, ji $$2, avz $$3) {
         if ($$0.ad() >= $$1.a() + 15L) {
            $$0.a(null, $$2, $$3, awb.e);
            $$1.a($$0.ad());
         }
