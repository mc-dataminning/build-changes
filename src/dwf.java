...
public class dwf extends duq {
   ...
   public dwf(jh $$0, dxo $$1) {
      super(dus.q, $$0, $$1);
   }

   public static void a(final amk $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, amk $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, amk $$1, BooleanSupplier $$2) {
   ...
   protected void b(um $$0, js.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vj)daf.a.encodeStart(va.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", xk.a.a(this.m, $$1));
      }
   }
   ...
   protected void a(um $$0, js.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         daf.a.parse(va.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = alp.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dgz $$0, jh $$1, dxo $$2, dwf $$3) {
      if ($$2.b(drk.a) && $$2.c(drk.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
   ...
   public static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && bar.f($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
