...
public class dwf {
   ...
   private final List<dwd> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dwf.a l = new dwf.d(5.999997E7F);
   public static final dwf.c d = new dwf.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(je $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(eys $$0) {
   ...
   public je b(double $$0, double $$1, double $$2) {
      return je.a((jx)this.c($$0, $$1, $$2));
   }
   ...
   public eys c(double $$0, double $$1, double $$2) {
      return new eys(azd.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azd.a($$2, this.f(), this.h() - 1.0E-5F));
   }

   public double a(bto $$0) {
      return this.b($$0.dx(), $$0.dD());
   }
   ...
   public boolean a(bto $$0, eyn $$1) {
      double $$2 = Math.max(azd.a($$1.b(), $$1.d()), 1.0);
      return this.a($$0) < $$2 * 2.0 && this.a($$0.dx(), $$0.dD(), $$2);
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dwf.a)($$0 == $$1 ? new dwf.d($$1) : new dwf.b($$0, $$1, $$2));
   ...
   public dwf.c t() {
      return new dwf.c(this);
   }

   public void a(dwf.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dwf.a {
      ...
      @Override
      public double a() {
         return azd.a(dwf.this.a() - this.e() / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
      }

      @Override
      public double c() {
         return azd.a(dwf.this.b() - this.e() / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azd.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dwe i() {
         return this.c < this.b ? dwe.b : dwe.a;
      }
      ...
      @Override
      public dwf.a l() {
         return (dwf.a)(this.g() <= 0L ? dwf.this.new d(this.c) : this);
      }
      ...
      public ezm m() {
         return ezj.a(
            ezj.c,
            ezj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eyw.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dwf.c a(DynamicLike<?> $$0, dwf.c $$1) {
         double $$2 = azd.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azd.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dwf.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dwf.a {
      ...
      private void n() {
         this.c = azd.a(dwf.this.a() - this.b / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
         this.d = azd.a(dwf.this.b() - this.b / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
         this.e = azd.a(dwf.this.a() + this.b / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
         this.f = azd.a(dwf.this.b() + this.b / 2.0, (double)(-dwf.this.k), (double)dwf.this.k);
         this.g = ezj.a(
            ezj.c,
            ezj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eyw.e
