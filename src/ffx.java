...
public class ffx {
   ...
   public static void a(File $$0, eys $$1, Consumer<wu> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eys $$2, Consumer<wu> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eys $$2, Consumer<wu> $$3) {
      ezh $$4 = a($$2);
   ...
   public static ezh a(eys $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ezh $$3 = new ezh($$1, $$2, false);
   ...
   public ffx(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
