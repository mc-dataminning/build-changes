...
public class ffx {
   ...
   public ffx(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ffx(fgc $$0, fgc $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static ffx a(esf $$0) {
      return new ffx((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ffx a(fgc $$0) {
      return new ffx($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static ffx a(iw $$0, iw $$1) {
      return new ffx(
   ...
   public ffx a(double $$0) {
      return new ffx($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ffx b(double $$0) {
      return new ffx(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ffx c(double $$0) {
      return new ffx(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ffx d(double $$0) {
      return new ffx(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ffx e(double $$0) {
      return new ffx(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ffx f(double $$0) {
      return new ffx(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ffx b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ffx c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ffx d(double $$0, double $$1, double $$2) {
      return new ffx(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ffx f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ffx h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fgc> b(fgc $$0, fgc $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fgc> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fgc $$6, fgc $$7) {
   ...
   @Nullable
   public static ffy a(Iterable<ffx> $$0, fgc $$1, fgc $$2, iw $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ffy($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jc a(ffx $$0, fgc $$1, double[] $$2, @Nullable jc $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jc a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fgc $$6, double[] $$7, @Nullable jc $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fgc $$0, List<ffx> $$1) {
      fgc $$2 = this.f();
      fgc $$3 = $$2.e($$0);

      for (ffx $$4 : $$1) {
         ffx $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fgc f() {
      return new fgc(azz.d(0.5, this.a, this.d), azz.d(0.5, this.b, this.e), azz.d(0.5, this.c, this.f));
   }

   public fgc g() {
      return new fgc(azz.d(0.5, this.a, this.d), this.b, azz.d(0.5, this.c, this.f));
   }
   ...
   public fgc i() {
      return new fgc(this.d, this.e, this.f);
   }

   public static ffx a(fgc $$0, double $$1, double $$2, double $$3) {
      return new ffx($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
   ...
   public static class a {
      ...
      public ffx a() {
         return new ffx((double)this.a, (double)this.b, (double)this.c, (double)this.d, (double)this.e, (double)this.f);
      }
   }
}
