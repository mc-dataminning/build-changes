...
public class byr extends bzb implements bjf {
   private static final UUID c = UUID.fromString("020E0DFB-87AE-4653-9556-831010E291A0");
   private static final bkd d = new bkd(c, "Attacking speed boost", 0.15F, bkd.a.a);
   private static final int e = 400;
   private static final int bT = 600;
   private static final adz<Optional<dfa>> bU = aec.a(byr.class, aeb.j);
   private static final adz<Boolean> bV = aec.a(byr.class, aeb.k);
   private static final adz<Boolean> bW = aec.a(byr.class, aeb.k);
   ...
   public byr(bim<? extends byr> $$0, cpm $$1) {
      super($$0, $$1);
      this.t(1.0F);
      this.a(eao.j, -1.0F);
   }
   ...
   protected void w() {
      ...
      this.bO.a(10, new byr.b(this));
      this.bO.a(11, new byr.d(this));
      this.bP.a(1, new byr.c(this, this::a_));
      this.bP.a(2, new brm(this));
      this.bP.a(3, new brn<>(this, bys.class, true, false));
      this.bP.a(4, new brt<>(this, false));
   }

   public static bke.a p() {
      return bzb.gf().a(bkf.a, 40.0).a(bkf.d, 0.3F).a(bkf.f, 7.0).a(bkf.b, 64.0);
   }
   ...
   boolean g(cbn $$0) {
      ...
      if ($$1.a(csn.ef.k())) {
         ...
         ehe $$2 = $$0.f(1.0F).d();
         ehe $$3 = new ehe(this.dp() - $$0.dp(), this.dt() - $$0.dt(), this.dv() - $$0.dv());
         double $$4 = $$3.f();
         $$3 = $$3.d();
         double $$5 = $$2.b($$3);
   ...
   boolean a(bii $$0) {
      ehe $$1 = new ehe(this.dp() - $$0.dp(), this.e(0.5) - $$0.dt(), this.dv() - $$0.dv());
      $$1 = $$1.d();
      double $$2 = 16.0;
   ...
   private boolean r(double $$0, double $$1, double $$2) {
      ...
      if ($$5 && !$$6) {
         ...
         if ($$8) {
            this.dK().a(djk.R, $$7, djk.a.a(this));
            if (!this.aS()) {
   ...
   protected void a(bhg $$0, int $$1, boolean $$2) {
      ...
      dfa $$3 = this.fZ();
      if ($$3 != null) {
         ciy $$4 = new ciy(cjb.ou);
         $$4.a(cnj.v, 1);
         ecn.a $$5 = new ecn.a((akk)this.dK()).a(ees.f, this.di()).a(ees.i, $$4).b(ees.a, this);
   ...
   public boolean a(bhg $$0, float $$1) {
      if (this.b($$0)) {
         ...
         if (!$$0.a(apn.j) && !$$2) {
            ...
            boolean $$3 = $$2 && this.a($$0, (ccq)$$0.c(), $$1);
   ...
   private boolean a(bhg $$0, ccq $$1, float $$2) {
      ciy $$3 = $$1.j();
      ckv $$4 = ckx.d($$3);
      List<bhv> $$5 = ckx.a($$3);
      boolean $$6 = $$4 == cky.c && $$5.isEmpty();
   ...
   static class a extends bpu {
      ...
      public boolean a() {
         ...
         if (!(this.b instanceof cbn)) {
            ...
            return $$0 > 256.0 ? false : this.a.g((cbn)this.b);
         }
      }
   ...
   static class b extends bpu {
      ...
      public boolean a() {
         if (this.a.fZ() == null) {
            ...
            return !this.a.dK().X().b(cpi.c) ? false : this.a.ee().a(b(2000)) == 0;
         }
      }
      ...
      public void e() {
         ...
         dfa $$9 = this.a.fZ();
         if ($$9 != null) {
            $$9 = csm.b($$9, this.a.dK(), $$5);
            if (this.a($$1, $$5, $$9, $$6, $$8, $$7)) {
               $$1.a($$5, $$9, 3);
               $$1.a(djk.i, $$5, djk.a.a(this.a, $$9));
               this.a.d(null);
            }
         }
      }

      private boolean a(cpm $$0, gu $$1, dfa $$2, dfa $$3, dfa $$4, gu $$5) {
         return $$3.i() && !$$4.i() && !$$4.a(csn.F) && $$4.r($$0, $$5) && $$2.a((cpp)$$0, $$1) && $$0.a_(this.a, egz.a(ehe.a($$1))).isEmpty();
      }
   }
   ...
   static class c extends brn<cbn> {
      ...
      private int l;
      private final btl m;
      private final btl n = btl.a().d();
      private final Predicate<biy> o;

      public c(byr $$0, @Nullable Predicate<biy> $$1) {
         super($$0, cbn.class, 10, false, false, $$1);
         this.i = $$0;
         this.o = $$1x -> ($$0.g((cbn)$$1x) || $$0.a_($$1x)) && !$$0.z($$1x);
         this.m = btl.a().a(this.l()).a(this.o);
      }
   ...
   static class d extends bpu {
      ...
      public boolean a() {
         if (this.a.fZ() != null) {
            ...
            return !this.a.dK().X().b(cpi.c) ? false : this.a.ee().a(b(20)) == 0;
         }
      }
      ...
      public void e() {
         ...
         gu $$5 = new gu($$2, $$3, $$4);
         dfa $$6 = $$1.a_($$5);
         ehe $$7 = new ehe((double)this.a.do() + 0.5, (double)$$3 + 0.5, (double)this.a.du() + 0.5);
         ehe $$8 = new ehe((double)$$2 + 0.5, (double)$$3 + 0.5, (double)$$4 + 0.5);
         eha $$9 = $$1.a(new cov($$7, $$8, cov.a.b, cov.b.a, this.a));
         boolean $$10 = $$9.a().equals($$5);
         if ($$6.a(apl.ak) && $$10) {
            $$1.a($$5, false);
            $$1.a(djk.f, $$5, djk.a.a(this.a, $$6));
            this.a.d($$6.b().n());
         }
      }
   }
