...
public record byr(byr.a d) {
   ...
   public static byr a(apj $$0, UUID $$1, byr.a $$2, Duration $$3) throws byr.b {
      if ($$2.a($$3)) {
         throw new byr.b(a);
      } else if (!$$2.a($$0, $$1)) {
         throw new byr.b(e);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<byr.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  aoi.m.fieldOf("expires_at").forGetter(byr.a::b), anz.f.fieldOf("key").forGetter(byr.a::c), aoi.n.fieldOf("signature_v2").forGetter(byr.a::d)
               )
               .apply($$0, byr.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof byr.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
