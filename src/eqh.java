...
public class eqh {
   ...
   public void a(eqr $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == eqr.a) {
            eur.b($$1, eur.a.b, tl.c("narrator.toast.disabled"), null);
         } else {
            eur.b($$1, eur.a.b, tl.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         eur.b($$1, eur.a.b, tl.c("narrator.toast.disabled"), tl.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new eqh.a("Narrator library is not active");
      }
   }
