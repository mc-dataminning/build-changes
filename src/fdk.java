...
public final class fdk implements AutoCloseable {
   ...
   public fdk(int $$0, int $$1, boolean $$2) {
      this(fdk.a.a, $$0, $$1, $$2);
   }

   public fdk(fdk.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private fdk(fdk.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static fdk a(InputStream $$0) throws IOException {
      return a(fdk.a.a, $$0);
   }

   public static fdk a(@Nullable fdk.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fdk a(ByteBuffer $$0) throws IOException {
      return a(fdk.a.a, $$0);
   }

   public static fdk a(byte[] $$0) throws IOException {
   ...
   public static fdk a(@Nullable fdk.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new fdk($$0 == null ? fdk.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
   ...
   public fdk a(IntUnaryOperator $$0) {
      if (this.d != fdk.a.a) {
         ...
         this.j();
         fdk $$1 = new fdk(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (foz.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(fdk $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fdk $$4) {
      this.j();
      if ($$4.c() != this.d) {
