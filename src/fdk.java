...
public class fdk extends gvg {
   ...
   private Long Y;
   private long Z;
   private final fkr aa = new fkr(this);

   public fdk(@Nullable feh $$0, long $$1, int $$2, fdd $$3, epx $$4) {
      super(fex.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aM_() {
      this.U = this.aa.b(fhe.a(xo.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.aa.b(fhe.a(xo.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.J();
         } else {
            List<fef> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fen(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fcv(this.G, $$0.toArray(new fef[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fco(new faj(new fni()), this.J));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              fam $$10 = new fam($$0, this.J, this.K, $$2, this.m.X(), aa.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              fak $$7 = fak.a($$6);
                              fak $$8 = fak.a(5368709120L);
                              if (fak.b($$6, $$7).equals(fak.b(5368709120L, $$8)) && $$7 != fak.a) {
                                 fak $$9 = fak.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xp.a("mco.upload.size.failure.line1", this.H.b()),
                                    xp.a("mco.upload.size.failure.line2", fak.b($$6, $$9), fak.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xp.a("mco.upload.size.failure.line1", this.H.b()),
                                    xp.a("mco.upload.size.failure.line2", fak.b($$6, $$7), fak.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
