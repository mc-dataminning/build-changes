...
public record fdk(int i, int j, fdk.a k, fdk.b l, int m) {
   public static final int a = 32;
   private static final fdk[] n = new fdk[32];
   private static final List<fdk> o = new ArrayList<>(32);
   public static final fdk b = a(0, 0, fdk.a.a, fdk.b.a, 3);
   public static final fdk c = a(1, 0, fdk.a.b, fdk.b.c, 4);
   public static final fdk d = a(2, 0, fdk.a.a, fdk.b.d, 2);
   public static final fdk e = d;
   public static final fdk f = a(3, 1, fdk.a.e, fdk.b.d, 2);
   public static final fdk g = a(4, 2, fdk.a.e, fdk.b.d, 2);
   public static final fdk h = a(5, 0, fdk.a.c, fdk.b.b, 3);

   public fdk(int i, int j, fdk.a k, fdk.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fdk a(int $$0, int $$1, fdk.a $$2, fdk.b $$3, int $$4) {
      fdk $$5 = new fdk($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fdk.b $$1) {
      return $$0 == 0 || $$1 == fdk.b.d;
   }
   ...
   @Nullable
   public static fdk a(int $$0) {
      return n[$$0];
   }

   public static Stream<fdk> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fdk.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
