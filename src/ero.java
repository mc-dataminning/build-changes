...
public class ero {
   ...
   public Optional<je> a(je $$0, boolean $$1, dwf $$2) {
      cfn $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cfr.r), $$0, $$4, cfn.b.c)
         .map(cfo::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dve.H))
   ...
   public Optional<l.a> a(je $$0, jj.a $$1) {
      ...
      for (je.a $$11 : je.a($$0, 16, jj.f, jj.d)) {
         int $$12 = Math.min($$8, this.n.a(eak.a.e, $$11.u(), $$11.w()));
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new je($$0.u() - $$2.j() * 1, azd.a($$0.v(), $$17, $$18), $$0.w() - $$2.l() * 1).j();
         $$4 = $$7.b($$4);
         jj $$19 = $$2.h();
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dhl.co.o(), 3);
            }
         }
      }

      duo $$26 = dhl.ed.o().b(dmn.b, $$1);
