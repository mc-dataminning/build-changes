...
public class ero {
   private final List<ConcurrentLinkedQueue<ern>> a = ImmutableList.of(
   ...
   public void a(ern $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<ern> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<ern> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<ern> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<ern> j() {
