...
public class ero extends erp {
   ...
   private ero(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   public static ero a(String $$0) {
      try {
         ...
         String $$3 = etm.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = etm.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = etm.a("worldClosed", $$2, false);
               String $$7 = etm.b("token", $$2, null);
               return new ero($$6, $$7, $$5);
            }
         }
