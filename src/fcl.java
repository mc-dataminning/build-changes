...
public class fcl extends fct {
   ...
   private static final IntSupplier f = () -> evg.O().m.a().c() ? e : d;
   ...
   public fcl(evg $$0, aqd $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(ews $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(ftn.C(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(ftn.C(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, evg.a);
         $$10 = 1.0F;
      }
   ...
   private void a(ews $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends gee {
      ...
      protected gee.a b(aqh $$0) {
         aoy $$1 = evg.O().ab();
         apz<InputStream> $$2 = $$1.a(aow.a, fcl.c);
         if ($$2 == null) {
            return new gee.a(new FileNotFoundException(fcl.c.toString()));
         } else {
            try {
               gee.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gee.a(new ggh(true, true), epa.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gee.a(var9);
            }
         }
      }
   }
