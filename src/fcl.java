...
public class fcl {
   ...
   private static final Queue<fcl.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fcl.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fcl::a), fci::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fcl::a), fci::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fcl.a(this.b) + ", type=" + fcl.b(this.c) + ", severity=" + fcl.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
