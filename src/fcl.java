...
public abstract class fcl {
   ...
   public fbm a() {
      if (this.c()) {
         ...
         return new fbm(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
      }
   }

   public fcl b() {
      return this.c() ? fci.a() : fci.a(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
   }
   ...
   public fcl a(double $$0, double $$1, double $$2) {
      return (fcl)(this.c() ? fci.a() : new fbt(this.a, new fch(this.a(jm.a.a), $$0), new fch(this.a(jm.a.b), $$1), new fch(this.a(jm.a.c), $$2)));
   }

   public fcl d() {
      fcl[] $$0 = new fcl[]{fci.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fci.b($$0[0], fci.a($$1, $$2, $$3, $$4, $$5, $$6), fbv.o));
      return $$0[0];
   }
   ...
   public List<fbm> e() {
      List<fbm> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fbm($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(jm.a $$0, double $$1) {
      return azu.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public fbn a(fbr $$0, fbr $$1, jh $$2) {
      if (this.c()) {
         return null;
      } else {
         fbr $$3 = $$1.d($$0);
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jm.a.a, $$4.d - (double)$$2.u()), this.a(jm.a.b, $$4.e - (double)$$2.v()), this.a(jm.a.c, $$4.f - (double)$$2.w()))
               ? new fbn($$4, jm.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fbm.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fbr> b(fbr $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         fbr[] $$1 = new fbr[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = azu.a($$0.a(), $$2, $$5);
            double $$9 = azu.a($$0.b(), $$3, $$6);
            double $$10 = azu.a($$0.c(), $$4, $$7);
   ...
   public fcl a(jm $$0) {
      if (!this.c() && this != fci.b()) {
         if (this.b != null) {
            fcl $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fcl b(jm $$0) {
      ...
      if (this.d($$1)) {
         ...
         fcj $$4 = new fcj(this, $$1, $$3);
         if ($$4.c()) {
            return fci.a();
         } else {
            return (fcl)($$4.f() ? fci.b() : $$4);
         }
      }
   }
   ...
   public double a(jm.a $$0, fbm $$1, double $$2) {
      return this.a(je.a($$0, jm.a.a), $$1, $$2);
   }

   protected double a(je $$0, fbm $$1, double $$2) {
      if (this.c()) {
         return $$2;
