...
public class feh<T extends bvy & bje> extends feb<T> {
   ...
   public static fii c() {
      ...
      fil $$1 = $$0.a();
      fil $$2 = $$1.a(
         "body", fih.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fie.a(0.0F, 20.0F, 5.0F)
      );
      fig $$3 = new fig(0.001F);
      fil $$4 = $$2.a("head", fih.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fie.a(0.0F, 0.0F, -9.0F));
      fih $$5 = fih.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fih $$6 = fih.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fih $$7 = fih.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fie.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fie.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fie.a(4.0F, 0.0F, -1.0F));
      fih $$8 = fih.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fih $$9 = fih.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fie.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fie.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fie.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fie.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fih.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fie.a(0.0F, 0.0F, 1.0F));
   ...
   private Vector3f a(fic $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fic $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fic $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * arw.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * arw.b($$2 * 0.9F));
