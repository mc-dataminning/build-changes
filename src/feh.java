...
public class feh extends fdy<cig> {
   ...
   protected void a(ews $$0, float $$1, int $$2, int $$3) {
      ...
      cmx $$6 = this.p.b(1).g();
      boolean $$7 = $$6.a(cna.uc);
      boolean $$8 = $$6.a(cna.qL);
      boolean $$9 = $$6.a(cna.fS);
      cmx $$10 = this.p.b(0).g();
      boolean $$11 = false;
      Integer $$12;
      ega $$13;
   ...
   private void a(ews $$0, @Nullable Integer $$1, @Nullable ega $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.t;
      int $$8 = this.u;
      if ($$4 && !$$6) {
   ...
   private void a(ews $$0, @Nullable Integer $$1, @Nullable ega $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
