...
public class gcp extends gcl {
   ...
   public gcp(fxt $$0, GameProfile $$1) {
      super($$0, $$1);
      this.ag = true;
   }
   ...
   public void n_() {
      ...
      if (this.cz > 0) {
         this.i(new evp((this.g.c - this.ds().c) / (double)this.cz, (this.g.d - this.ds().d) / (double)this.cz, (this.g.e - this.ds().e) / (double)this.cz));
         this.cz--;
      }
