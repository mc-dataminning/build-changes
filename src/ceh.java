public abstract class ceh extends ceq {
   protected bxw d;
   protected iv e = iv.c;
   protected boolean f;
   private boolean a;
   ...
   protected boolean h() {
      if (!this.f) {
         ...
         ebe $$0 = this.d.dV().a_(this.e);
         if (!($$0.b() instanceof dpj)) {
            this.f = false;
            return false;
         } else {
            return $$0.c(dpj.e);
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         ebe $$1 = this.d.dV().a_(this.e);
         if ($$1.b() instanceof dpj) {
            ((dpj)$$1.b()).a(this.d, this.d.dV(), $$1, this.e, $$0);
         }
      }
   }
