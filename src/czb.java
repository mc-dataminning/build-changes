...
public record czb(int c, int d, jr<cyq> e, Optional<czb.a> f) {
   private static final int g = 3;
   public static final MapCodec<czb> a = czb.a.a
      .flatXmap(czb::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final zm<wz, czb> b = zm.a(czb::a, czb::b);

   public static czb a(Map<Character, cyq> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static czb a(Map<Character, cyq> $$0, List<String> $$1) {
      czb.a $$2 = new czb.a($$0, $$1);
      return (czb)a($$2).getOrThrow();
   }

   private static DataResult<czb> a(czb.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      jr<cyq> $$4 = jr.a($$2 * $$3, cyq.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new czb($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cqi $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static czb b(wz $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jr<cyq> $$3 = jr.a($$1 * $$2, cyq.a);
      $$3.replaceAll($$1x -> cyq.b.decode($$0));
      return new czb($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<czb.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cyq> b, List<String> c) {
      ...
      public static final MapCodec<czb.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(ayf.b(e, cyq.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, czb.a::new)
      );

      public Map<Character, cyq> a() {
         return this.b;
      }
