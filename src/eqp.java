...
public class eqp {
   ...
   private void a(n $$0, ti $$1) {
      this.b.l.d().a(ti.h().b(ti.c("debug.prefix").a($$0, n.r)).b(th.u).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(ti.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cl.d("gamemode spectator");
               } else {
                  this.b.s.cl.d("gamemode " + ((cpn)MoreObjects.firstNonNull(this.b.q.k(), cpn.b)).b());
               }
            ...
            case 81:
               ...
               esm $$3 = this.b.l.d();
               $$3.a(ti.c("debug.reload_chunks.help"));
               $$3.a(ti.c("debug.show_hitboxes.help"));
               $$3.a(ti.c("debug.copy_location.help"));
               $$3.a(ti.c("debug.clear_chat.help"));
               $$3.a(ti.c("debug.chunk_boundaries.help"));
               $$3.a(ti.c("debug.advanced_tooltips.help"));
               $$3.a(ti.c("debug.inspect.help"));
               $$3.a(ti.c("debug.profiling.help"));
               $$3.a(ti.c("debug.creative_spectator.help"));
               $$3.a(ti.c("debug.pause_focus.help"));
               $$3.a(ti.c("debug.help.help"));
               $$3.a(ti.c("debug.dump_dynamic_textures.help"));
               $$3.a(ti.c("debug.reload_resourcepacks.help"));
               $$3.a(ti.c("debug.pause.help"));
               $$3.a(ti.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.Y().a($$5);
               ti $$6 = ti.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new tg(tg.a.b, $$5.toFile().toString())));
   ...
   private void a(boolean $$0, boolean $$1) {
      ...
      if ($$2 != null) {
         switch ($$2.c()) {
            case b:
               gw $$3 = ((ehe)$$2).a();
               dfe $$4 = this.b.s.dK().a_($$3);
               if ($$0) {
                  if ($$1) {
                     this.b.s.cl.t().a($$3, $$2x -> {
                        this.a($$4, $$3, $$2x);
                        this.a("debug.inspect.server.block");
                     });
                  } else {
                     dcq $$5 = this.b.s.dK().c_($$3);
                     qu $$6 = $$5 != null ? $$5.o() : null;
                     this.a($$4, $$3, $$6);
   ...
   private void a(dfe $$0, gw $$1, @Nullable qu $$2) {
   ...
   private void a(aeu $$0, ehi $$1, @Nullable qu $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = rg.c((rn)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aM().i()) {
         boolean $$5 = ekf.a(eqq.O().aM().i(), 292);
         if (this.d > 0L) {
            if (!ekf.a(eqq.O().aM().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ekf.a(eqq.O().aM().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof eyy) || ((eyy)$$6).k <= ac.b() - 20L)) {
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               erb.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aV().a() && this.b.m.r().c()) {
            boolean $$7 = $$6 == null || !($$6.t() instanceof esu) || !((esu)$$6.t()).e();
            if ($$3 != 0 && $$1 == 66 && eyf.p() && $$7) {
               boolean $$8 = this.b.m.ao().c() == eqs.a;
               this.b.m.ao().a(eqs.a(this.b.m.ao().c().a() + 1));
               if ($$6 instanceof eyh) {
                  ((eyh)$$6).l();
               }
      ...
      if ($$0 == this.b.aM().i()) {
         ...
         if ($$3 != null && this.b.aJ() == null) {
            if (Character.charCount($$1) == 1) {
               eyf.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  eyf.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", ars.f((float)$$1 / 1000.0F));
            }
