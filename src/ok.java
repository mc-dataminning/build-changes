...
public final class ok {
   ...
   private static final Comparator<dyw.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dyw.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dyw.a::toString).collect(Collectors.joining(","));
   }
