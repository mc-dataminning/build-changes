...
public class ok {
   ...
   public alf a(dez $$0, BiConsumer<alf, Supplier<JsonElement>> $$1) {
      return this.B.a($$0, this.A, $$1);
   }

   public alf a(dez $$0, String $$1, BiConsumer<alf, Supplier<JsonElement>> $$2) {
      return this.B.a($$0, $$1, this.A, $$2);
   }

   private static ok.a a(Function<dez, oi> $$0, og $$1) {
   ...
   public interface a {
      ...
      default alf create(dez $$0, BiConsumer<alf, Supplier<JsonElement>> $$1) {
         return this.get($$0).a($$0, $$1);
      }

      default alf createWithSuffix(dez $$0, String $$1, BiConsumer<alf, Supplier<JsonElement>> $$2) {
