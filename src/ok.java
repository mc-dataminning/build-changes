...
public final class ok {
   ...
   private static final Comparator<dyp.a<?>> b = Comparator.comparing($$0 -> $$0.a().f());
   private final List<dyp.a<?>> c;
   ...
   public String b() {
      return this.c.stream().sorted(b).map(dyp.a::toString).collect(Collectors.joining(","));
   }
