...
public class ok implements nz {
   ...
   private ok(oa $$0, jr<cwm> $$1, dbb $$2, dbb $$3) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public static ok a(oa $$0, dbb $$1, dbb $$2, cwm $$3) {
   ...
   public void a(ob $$0, aku<dbf<?>> $$1) {
      ...
      this.f.forEach($$2::a);
      dch $$3 = new dch(Objects.requireNonNullElse(this.g, ""), nz.a(this.b), this.d, this.e, this.c);
