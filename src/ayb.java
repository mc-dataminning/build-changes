...
public class ayb extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(baa.z.typeName(), bbi.a()));
      Type<Pair<String, String>> $$1 = DSL.named(baa.z.typeName(), bbi.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(baa.t),
         this.getOutputSchema().getType(baa.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(baa.z.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
