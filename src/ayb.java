...
public class ayb {
   ...
   public static SecretKey a() throws ayc {
      try {
   ...
   public static KeyPair b() throws ayc {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws ayc {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, ayb.a<T> $$3) throws ayc {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws ayc {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", ayb::b);
   }

   public static PublicKey b(String $$0) throws ayc {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", ayb::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws ayc {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws ayc {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws ayc {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws ayc {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws ayc {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws ayc {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws ayc {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws ayc;
   }

   public static record b(long b, byte[] c) {
      public static final ayb.b a = new ayb.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(wa $$0, ayb.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
