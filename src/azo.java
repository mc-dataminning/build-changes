...
public class azo {
   public static final Codec<azo> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(ayo.o.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), ayo.o.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, azo::new)
   );
   ...
   private azo(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
