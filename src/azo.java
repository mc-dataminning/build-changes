...
public class azo extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfa.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bfa.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bfa.s);
