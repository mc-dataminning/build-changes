...
public class azo extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bfy.z), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", azo::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", azo::a);
      return this.a($$0, "minecraft:trident", azo::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bfy.z, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bfy.z, $$1);
