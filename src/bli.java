...
public class bli implements Comparable<bli> {
   ...
   @Nullable
   private bli q;
   private final Optional<bli.a> r;

   public bli(blg $$0) {
      this($$0, 0, 0);
   }

   public bli(blg $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bli(blg $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bli(blg $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bli(blg $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public bli(blg $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bli $$6, Optional<bli.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bml $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bli $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(sn $$0) {
      ...
      this.r.ifPresent($$1x -> bli.a.a.encodeStart(tb.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static bli b(sn $$0) {
      String $$1 = $$0.l("id");
      blg $$2 = kd.d.a(ahg.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static bli a(blg $$0, sn $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = bli.a.a.parse(new Dynamic(tb.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bli($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bli.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atw.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  atw.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bli $$0) {
         ...
         float $$2 = auo.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = auo.i($$2, this.c, this.d);
      }

      public float a(bml $$0, float $$1) {
         if ($$0.dH()) {
            this.g = this.e;
         }

         return auo.i($$1, this.g, this.e);
      }
   }
}
