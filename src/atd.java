...
public class atd extends atp {
   ...
   private atd(URL $$0, atp.b $$1, URL $$2, atd.a $$3, URL $$4, atd.a $$5, String $$6, atp.a $$7, ExecutorService $$8) {
      super($$0, $$1, $$7, $$8);
      this.c = $$2;
      this.d = $$3;
      this.e = $$4;
   ...
   public static atp a(String $$0) {
      try {
         ...
         URI $$2 = new URI(azu.i($$1, "apiServer"));
         String $$3 = azu.i($$1, "apiKey");
         if ($$3.isEmpty()) {
            throw new IllegalArgumentException("Missing API key");
         } else {
            int $$4 = azu.a($$1, "ruleId", 1);
            String $$5 = azu.a($$1, "serverId", "");
            String $$6 = azu.a($$1, "roomId", "Java:Chat");
            int $$7 = azu.a($$1, "hashesToDrop", -1);
            int $$8 = azu.a($$1, "maxConcurrentRequests", 7);
            JsonObject $$9 = azu.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, atd.a $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   protected ata a(String $$0, atp.a $$1, JsonObject $$2) {
      boolean $$3 = azu.a($$2, "response", false);
      if ($$3) {
         return ata.a($$0);
      } else {
         String $$4 = azu.a($$2, "hashed", null);
         if ($$4 == null) {
            return ata.b($$0);
         } else {
            JsonArray $$5 = azu.v($$2, "hashes");
            xz $$6 = this.a($$0, $$5, $$1);
            return new ata($$0, $$6);
         }
      }
