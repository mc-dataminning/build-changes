...
public class atd extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(ayx.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", atd::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", atd::a);
      return this.a($$0, "minecraft:trident", atd::a);
   }
