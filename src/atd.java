...
public class atd {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (atd.this.e.am()) {
                  $$1.addLast("legacy_query", new asw(atd.this.d()));
               }

               vv.a($$1, zp.a, false, null);
               int $$2 = atd.this.e.o();
               vv $$3 = (vv)($$2 > 0 ? new wo($$2) : new vv(zp.a));
               atd.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new atf(atd.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xg $$3 = xg.b("Internal server error");
                     $$1.a(new zz($$3), wl.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<atd.a.a> d = Lists.newArrayList();
