...
public class atd extends atc {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, atd.a> s;
   private final asy t;
   private long u;
   private final ajo v;

   private atd(ajo $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == asz.c($$2, 7, $$0.getLength());
      }
   }
