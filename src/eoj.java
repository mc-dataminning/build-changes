...
public class eoj extends eom {
   ...
   static final eoj.b l = new eoj.b(854, 480);

   public eoj(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eoj.a[] e = values();
   ...
   static class b {
      ...
      static List<eoj.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eoj.b($$0, $$1), eoj.l) : ImmutableList.of(eoj.l);
      }
