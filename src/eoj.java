...
public class eoj implements eoe {
   protected static final eoe a = new eoj(false, -Double.MAX_VALUE, cpd.h, $$0 -> false, null) {
      @Override
      public boolean a(eos $$0, hz $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected eoj(boolean $$0, double $$1, cpd $$2, Predicate<egw> $$3, @Nullable bnq $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected eoj(bnq $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bnq.bW ()Z
      // 05: aload 1
      // 06: invokevirtual bnq.dt ()D
      // 09: aload 1
      // 0a: instanceof boi
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast boi
      // 14: invokevirtual boi.eT ()Lcpd;
      // 17: goto 1d
      // 1a: getstatic cpd.h Lcpd;
      // 1d: aload 1
      // 1e: instanceof boi
      // 21: ifeq 35
      // 24: aload 1
      ...
      // 2c: pop
      // 2d: invokedynamic test (Lboi;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, boi.a (Legw;)Z, (Legw;)Z ]
      // 32: goto 3a
      // 35: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, eoj.a (Legw;)Z, (Legw;)Z ]
      // 3a: aload 1
      // 3b: invokespecial eoj.<init> (ZDLcpd;Ljava/util/function/Predicate;Lbnq;)V
      // 3e: return
   }
