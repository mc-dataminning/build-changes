...
public class eoj {
   ...
   public void a(ept $$0, String $$1, eqp.a $$2, een $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eoj.b $$13 = new eoj.b($$1.trim(), this.f, $$3, $$2);
                  eoj.a $$14 = new eoj.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eoj.c $$30 = new eoj.c(this.f, $$2, $$0);
                        eoj.a $$31 = new eoj.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new epx(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, een $$2) throws IOException {
      ...
      File $$15 = new File(etd.N().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, een $$2, eqp.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eoj.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eoj.this.b && !eoj.this.d) {
            try {
               eoj.this.e = true;
               eoj.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eoj.a.error("Error extracting archive", var3);
               eoj.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eqp.a c;
      private final ept d;

      c(File $$0, eqp.a $$1, ept $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eoj.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eoj.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eoj.this.g);
                  eoj.this.c = true;
               } else {
                  eoj.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eoj.this.d = true;
               }
            } catch (IOException var3) {
               eoj.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eoj.this.d = true;
            }
         }
      }
