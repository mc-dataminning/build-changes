...
public class ger {
   ...
   public gek a(Vector3f $$0, Vector3f $$1, gem $$2, goy $$3, je $$4, grh $$5, @Nullable gen $$6, boolean $$7, ale $$8) {
      geo $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ayy.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ayy.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ayy.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ayy.i($$11, $$9.a[3], $$13);
      ...
      return new gek($$14, $$2.c, $$15, $$3, $$7);
   }

   public static geo a(geo $$0, je $$1, j $$2, ale $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ayy.b($$23), ayy.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new geo(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(geo $$0, goy $$1, je $$2, float[] $$3, j $$4, @Nullable gen $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, je $$2, geo $$3, float[] $$4, goy $$5, j $$6, @Nullable gen $$7, boolean $$8) {
      gde.b $$9 = gde.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, goy $$3, geo $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gen $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
