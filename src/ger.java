...
public class ger implements gek<dos> {
   public static final gpz a = new gpz(gnu.e, new akm("entity/conduit/base"));
   public static final gpz b = new gpz(gnu.e, new akm("entity/conduit/cage"));
   public static final gpz c = new gpz(gnu.e, new akm("entity/conduit/wind"));
   public static final gpz d = new gpz(gnu.e, new akm("entity/conduit/wind_vertical"));
   public static final gpz e = new gpz(gnu.e, new akm("entity/conduit/open_eye"));
   public static final gpz f = new gpz(gnu.e, new akm("entity/conduit/closed_eye"));
   private final fvw g;
   private final fvw h;
   private final fvw i;
   private final fvw j;
   ...
   public void a(dos $$0, float $$1, eys $$2, gck $$3, int $$4, int $$5) {
      float $$6 = (float)$$0.a + $$1;
      if (!$$0.c()) {
         float $$7 = $$0.a(0.0F);
         eyw $$8 = a.a($$3, gcs::c);
         ...
         float $$10 = ayd.a($$6 * 0.1F) / 2.0F + 0.5F;
         $$10 = $$10 * $$10 + $$10;
         $$2.a();
