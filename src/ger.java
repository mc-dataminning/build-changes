...
public class ger implements fac, AutoCloseable {
   ...
   private static final ezv t = new ezv();
   ...
   private final List<fad> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, fad> C = Maps.newHashMap();
   private final int D;
   ...
   public ger(atz $$0, String $$1, far $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = axw.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(axw.a($$5, "blend", null));
         this.H = a($$0, faa.a.a, $$6);
         this.I = a($$0, faa.a.b, $$7);
         this.D = fab.a();
         int $$18 = 0;
   ...
   private static faa a(final atz $$0, faa.a $$1, String $$2) throws IOException {
      faa $$3 = $$1.c().get($$2);
      faa $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         atu $$5 = $$0.getResourceOrThrow(new akk($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = faa.a($$1, $$2, $$6, $$5.b(), new ezt() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        ger.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static ezw a(JsonObject $$0) {
      if ($$0 == null) {
         return new ezw();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (axw.a($$0, "func")) {
            $$1 = ezw.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (axw.a($$0, "srcrgb")) {
            $$2 = ezw.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (axw.a($$0, "dstrgb")) {
            $$3 = ezw.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (axw.a($$0, "srcalpha")) {
            $$4 = ezw.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (axw.a($$0, "dstalpha")) {
            $$5 = ezw.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new ezw($$2, $$3, $$4, $$5, $$1) : new ezw($$2, $$3, $$1);
         }
      }
   }
   ...
   @Nullable
   public fad a(String $$0) {
      RenderSystem.assertOnRenderThread();
      return this.C.get($$0);
   }

   public ezv b(String $$0) {
      RenderSystem.assertOnGameThread();
      fad $$1 = this.a($$0);
      return (ezv)($$1 == null ? t : $$1);
   }
