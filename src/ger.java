...
public class ger extends auj<ger.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final akr b = akr.b("gpu_warnlist.json");
   ...
   protected ger.a a(aue $$0, bnf $$1) {
      ...
      $$1.b();
      return new ger.a($$2, $$3, $$4);
   }

   protected void a(ger.a $$0, aue $$1, bnf $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aue $$0, bnf $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, faa.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, faa.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, faa.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
