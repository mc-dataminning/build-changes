public class ghq implements ggz<drx> {
   public ghq(gha.a $$0) {
   }

   public void a(drx $$0, float $$1, fbi $$2, gez $$3, int $$4, int $$5) {
      if (fgo.Q().s.gv() || fgo.Q().s.R_()) {
         jd $$6 = $$0.f();
         kh $$7 = $$0.j();
         if ($$7.u() >= 1 && $$7.v() >= 1 && $$7.w() >= 1) {
            if ($$0.v() == dum.a || $$0.v() == dum.b) {
               ...
               float $$36 = 0.5F;
               if ($$0.v() == dum.a || $$0.F()) {
                  fbm $$37 = $$3.getBuffer(gfh.y());
                  gex.a($$2, $$37, $$30, $$10, $$31, $$32, $$11, $$33, 0.9F, 0.9F, 0.9F, 1.0F, 0.5F, 0.5F, 0.5F);
               }
   ...
   private void a(drx $$0, gez $$1, fbi $$2) {
      dcc $$3 = $$0.i();
      fbm $$4 = $$1.getBuffer(gfh.y());
      jd $$5 = $$0.aD_();
      jd $$6 = tn.c($$0);
      ...
      for (jd $$7 : jd.c($$6, $$6.a($$0.j()).b(-1, -1, -1))) {
         ...
         if ($$9 || $$13) {
            ...
            if ($$9) {
               gex.a($$2, $$4, $$15, $$16, $$17, $$18, $$19, $$20, 0.5F, 0.5F, 1.0F, 1.0F, 0.5F, 0.5F, 1.0F);
            } else if ($$10) {
               gex.a($$2, $$4, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 0.75F, 0.75F, 1.0F, 1.0F, 0.75F, 0.75F);
            } else if ($$11) {
               gex.a($$2, $$4, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F);
            } else if ($$12) {
               gex.a($$2, $$4, $$15, $$16, $$17, $$18, $$19, $$20, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F);
            }
         }
      }
   }

   private void a(drx $$0, fbm $$1, fbi $$2) {
      dcc $$3 = $$0.i();
      if ($$3 != null) {
         jd $$4 = $$0.aD_();
         jd $$5 = tn.c($$0);
         kh $$6 = $$0.j();
         exl $$7 = new exf($$6.u(), $$6.v(), $$6.w());
         ...
         $$7.a(($$4x, $$5x, $$6x, $$7x) -> {
            ...
            gex.a($$2, $$1, $$4x, $$9, $$10, $$11, $$12, $$13, $$14, 0.75F, 0.75F, 1.0F, 0.2F);
         });
      }
   }
