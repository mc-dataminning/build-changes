...
public class duc {
   ...
   static class a implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
         return $$0.c[ha.f.d()] && !$$0.b[ha.f.d()].d;
      }

      @Override
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         $$1.d = true;
         $$1.b[ha.f.d()].d = true;
         return new duc.k($$0, $$1);
      }
   }

   static class b implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         ...
         return new duc.l($$0, $$1);
      }
   }

   static class c implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         $$1.d = true;
         $$1.b[ha.b.d()].d = true;
         return new duc.m($$0, $$1);
      }
   }

   static class d implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         ...
         return new duc.n($$0, $$1);
      }
   }

   static class e implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         ...
         $$3.d = true;
         $$3.b[ha.c.d()].d = true;
         return new duc.o($$0, $$3);
      }
   }

   static class f implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
         return true;
      }
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         $$1.d = true;
         return new duc.s($$0, $$1, $$2);
      }
   }

   static class g implements duc.i {
      @Override
      public boolean a(duc.v $$0) {
      ...
      public duc.r a(ha $$0, duc.v $$1, apf $$2) {
         $$1.d = true;
         return new duc.t($$0, $$1);
      }
   }

   public static class h extends duc.r {
      ...
      private duc.v G;
      private duc.v H;
      private final List<duc.r> I = Lists.newArrayList();

      public h(apf $$0, int $$1, int $$2, ha $$3) {
         super(dsr.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<duc.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new duc.p($$3, this.G));
         this.I.add(new duc.j($$3, this.H));
         List<duc.i> $$5 = Lists.newArrayList();
         $$5.add(new duc.b());
         $$5.add(new duc.d());
         $$5.add(new duc.e());
         $$5.add(new duc.a());
         ...
         drs $$10 = drs.a(this.b(1, 1, 1), this.b(23, 8, 21));
         drs $$11 = drs.a(this.b(34, 1, 1), this.b(56, 8, 21));
         drs $$12 = drs.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new duc.u($$3, $$10, $$13++));
         this.I.add(new duc.u($$3, $$11, $$13++));
         this.I.add(new duc.q($$3, $$12));
      }
      ...
      private List<duc.v> b(apf $$0) {
         duc.v[] $$1 = new duc.v[75];
         ...
         duc.v $$23 = new duc.v(1003);
         duc.v $$24 = new duc.v(1001);
         duc.v $$25 = new duc.v(1002);
         $$1[v].a(ha.b, $$23);
         $$1[w].a(ha.d, $$24);
         $$1[x].a(ha.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<duc.v> $$26 = new ObjectArrayList();
   ...
   interface i {
      boolean a(duc.v var1);

      duc.r a(ha var1, duc.v var2, apf var3);
   }

   public static class j extends duc.r {
      public j(ha $$0, duc.v $$1) {
   ...
   public static class k extends duc.r {
      public k(ha $$0, duc.v $$1) {
   ...
   public static class l extends duc.r {
      public l(ha $$0, duc.v $$1) {
   ...
   public static class m extends duc.r {
      public m(ha $$0, duc.v $$1) {
   ...
   public static class n extends duc.r {
      public n(ha $$0, duc.v $$1) {
   ...
   public static class o extends duc.r {
      public o(ha $$0, duc.v $$1) {
   ...
   public static class p extends duc.r {
      public p(ha $$0, duc.v $$1) {
   ...
   public static class q extends duc.r {
      public q(ha $$0, drs $$1) {
         super(dsr.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dse {
      ...
      protected static final Set<cpn> l = ImmutableSet.builder().add(cpo.dO).add(cpo.iC).add(cpo.mW).add(k.b()).build();
      ...
      protected r(dsr $$0, int $$1, ha $$2, duc.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static drs a(ha $$0, duc.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         drs $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
   ...
   public static class s extends duc.r {
      private int a;

      public s(ha $$0, duc.v $$1, apf $$2) {
   ...
   public static class t extends duc.r {
      public t(ha $$0, duc.v $$1) {
   ...
   public static class u extends duc.r {
      private int a;
