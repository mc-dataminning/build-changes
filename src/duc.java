...
public class duc {
   ...
   private double j;
   int k = 29999984;
   private duc.a l = new duc.d(5.999997E7F);
   public static final duc.c d = new duc.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(ewc $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public ja b(double $$0, double $$1, double $$2) {
      return ja.a(ayg.a($$0, this.e(), this.g()), $$1, ayg.a($$2, this.f(), this.h()));
   }

   public double a(bsh $$0) {
      return this.b($$0.dw(), $$0.dC());
   }
   ...
   public boolean a(bsh $$0, ewc $$1) {
      double $$2 = Math.max(ayg.a($$1.b(), $$1.d()), 1.0);
      return this.a($$0) < $$2 * 2.0 && this.a($$0.dw(), $$0.dC(), $$2);
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (duc.a)($$0 == $$1 ? new duc.d($$1) : new duc.b($$0, $$1, $$2));
   ...
   public duc.c t() {
      return new duc.c(this);
   }

   public void a(duc.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements duc.a {
      ...
      @Override
      public double a() {
         return ayg.a(duc.this.a() - this.e() / 2.0, (double)(-duc.this.k), (double)duc.this.k);
      }

      @Override
      public double c() {
         return ayg.a(duc.this.b() - this.e() / 2.0, (double)(-duc.this.k), (double)duc.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ayg.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dub i() {
         return this.c < this.b ? dub.b : dub.a;
      }
      ...
      @Override
      public duc.a l() {
         return (duc.a)(this.g() <= 0L ? duc.this.new d(this.c) : this);
      }
      ...
      public exa m() {
         return ewx.a(
            ewx.c,
            ewx.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewl.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static duc.c a(DynamicLike<?> $$0, duc.c $$1) {
         double $$2 = ayg.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ayg.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new duc.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements duc.a {
      ...
      private void n() {
         this.c = ayg.a(duc.this.a() - this.b / 2.0, (double)(-duc.this.k), (double)duc.this.k);
         this.d = ayg.a(duc.this.b() - this.b / 2.0, (double)(-duc.this.k), (double)duc.this.k);
         this.e = ayg.a(duc.this.a() + this.b / 2.0, (double)(-duc.this.k), (double)duc.this.k);
         this.f = ayg.a(duc.this.b() + this.b / 2.0, (double)(-duc.this.k), (double)duc.this.k);
         this.g = ewx.a(
            ewx.c,
            ewx.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewl.e
