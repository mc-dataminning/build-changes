...
public class iw {
   private static final Map<ali, SuggestionProvider<fb>> e = Maps.newHashMap();
   private static final ali f = ali.b("ask_server");
   public static final SuggestionProvider<fb> a = a(f, ($$0, $$1) -> ((fb)$$0.getSource()).a($$0));
   public static final SuggestionProvider<ew> b = a(ali.b("all_recipes"), ($$0, $$1) -> fb.a(((fb)$$0.getSource()).t(), $$1));
   public static final SuggestionProvider<ew> c = a(ali.b("available_sounds"), ($$0, $$1) -> fb.a(((fb)$$0.getSource()).s(), $$1));
   public static final SuggestionProvider<ew> d = a(
      ali.b("summonable_entities"),
      ($$0, $$1) -> fb.a(ly.f.s().filter($$1x -> $$1x.a(((fb)$$0.getSource()).w()) && $$1x.c()), $$1, bul::a, $$0x -> xi.c(ae.a("entity", bul.a($$0x))))
   );

   public static <S extends fb> SuggestionProvider<S> a(ali $$0, SuggestionProvider<fb> $$1) {
      if (e.containsKey($$0)) {
   ...
   public static SuggestionProvider<fb> a(ali $$0) {
      return e.getOrDefault($$0, a);
   }

   public static ali a(SuggestionProvider<fb> $$0) {
   ...
   protected static class a implements SuggestionProvider<fb> {
      ...
      public a(ali $$0, SuggestionProvider<fb> $$1) {
         this.a = $$1;
         this.b = $$0;
      }
