...
public class iw {
   ...
   static <T> ij.c<T> a(final ahg<? extends it<? extends T>> $$0, final Lifecycle $$1, final Map<ahg<T>, ih.c<T>> $$2) {
      return new ij.c<T>() {
         @Override
         ...
         @Override
         public Optional<il.c<T>> a(asx<T> $$0x) {
   ...
   public <T> iw a(ahg<? extends it<T>> $$0, Lifecycle $$1, iw.g<T> $$2) {
      this.a.add(new iw.i<>($$0, $$1, $$2));
      return this;
   }

   public <T> iw a(ahg<? extends it<T>> $$0, iw.g<T> $$1) {
   ...
   private ij.b a(iu $$0, ij.b $$1, hy.a $$2, Map<ahg<? extends it<?>>, iw.h<?>> $$3, ij.b $$4) {
      iw.b $$5 = new iw.b();
   ...
   private <T> ij.c<T> a(ik<T> $$0, hy.a $$1, ahg<? extends it<? extends T>> $$2, ij.b $$3, ij.b $$4, MutableObject<ij.b> $$5) {
      hy<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<ahg<T>, ih.c<T>> $$7 = new HashMap<>();
         ij.c<T> $$8 = $$3.b($$2);
         $$8.b().forEach($$5x -> {
            ahg<T> $$6x = $$5x.h();
   ...
   public iw.e a(iu $$0, ij.b $$1, hy.a $$2) {
      iw.a $$3 = this.b($$0);
      Map<ahg<? extends it<?>>, iw.h<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<ahg<? extends it<?>>> $$5 = $$0.a().collect(Collectors.toUnmodifiableSet());
   ...
   static record a(iw.b a, iw.j b, Map<ahh, ii<?>> c, Map<ahg<?>, iw.f<?>> d, List<RuntimeException> e) {

      public static iw.a a(iu $$0, Stream<ahg<? extends it<?>>> $$1) {
         iw.b $$2 = new iw.b();
         List<RuntimeException> $$3 = new ArrayList<>();
         iw.j $$4 = new iw.j($$2);
         Builder<ahh, ii<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> pf<T> a() {
         return new pf<T>() {
            ...
            @Override
            public <S> ii<S> a(ahg<? extends it<? extends S>> $$0) {
      ...
      public void c() {
         for (ahg<Object> $$0 : this.b.a.keySet()) {
   ...
   static class d<T> extends ih.c<T> {
      ...
      protected d(ik<T> $$0, @Nullable ahg<T> $$1) {
   ...
   static record h<T>(ahg<? extends it<? extends T>> a, Lifecycle b, Map<ahg<T>, iw.k<T>> c) {

      public ij.c<T> a(iw.b $$0) {
         Map<ahg<T>, ih.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            iw.k<T> $$2x = (iw.k<T>)$$1x.getValue();
            ih.c<T> $$3 = $$2x.b().orElseGet(() -> ih.c.a($$0.a(), (ahg<T>)$$1x.getKey()));
            $$3.b($$2x.a().a());
            return $$3;
         }));
   ...
   static record i<T>(ahg<? extends it<T>> a, Lifecycle b, iw.g<T> c) {
      void b(iw.a $$0) {
         this.c.run($$0.a());
      }

      public iw.h<T> a(iw.a $$0) {
         Map<ahg<T>, iw.k<T>> $$1 = new HashMap<>();
         Iterator<Entry<ahg<?>, iw.f<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<ahg<?>, iw.f<?>> $$3 = $$2.next();
            ahg<?> $$4 = $$3.getKey();
            if ($$4.b(this.a)) {
               iw.f<T> $$6 = (iw.f<T>)$$3.getValue();
               ih.c<T> $$7 = (ih.c<T>)$$0.b.a.remove($$4);
               $$1.put((ahg<T>)$$4, new iw.k<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class j extends iw.c<Object> {
      final Map<ahg<Object>, ih.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<ih.c<Object>> a(ahg<Object> $$0) {
