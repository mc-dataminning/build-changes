...
public class ekm {
   ...
   public static final ekm.a bv;

   public static ekm.a a(int $$0, int $$1) {
      return $$0 == -1 ? ekm.b.b.a($$1) : ekm.b.a.a($$0);
   }

   public static ekm.a a(String $$0) {
      if (ekm.a.e.containsKey($$0)) {
         return ekm.a.e.get($$0);
      } else {
         for (ekm.b $$1 : ekm.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ekm.b b;
      private final int c;
      private final art<tn> d;
      static final Map<String, ekm.a> e = Maps.newHashMap();

      a(String $$0, ekm.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new art<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? tn.b($$2.toUpperCase(Locale.ROOT)) : tn.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? tn.b($$2) : tn.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> qt.a().b($$1) ? tn.c($$1) : tn.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ekm.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, tn> g;

      private static void a(ekm.b $$0, String $$1, int $$2) {
         ekm.a $$3 = new ekm.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, tn> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ekm.a a(int $$0) {
         return (ekm.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
