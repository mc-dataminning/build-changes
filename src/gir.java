...
public abstract class gir {
   ...
   protected gir(gfj $$0, double $$1, double $$2, double $$3) {
      this.c = $$0;
      this.b(0.2F, 0.2F);
      this.c($$1, $$2, $$3);
      this.d = $$1;
   ...
   public gir(gfj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      this($$0, $$1, $$2, $$3);
   ...
   protected int a(float $$0) {
      ...
      return this.c.B($$1) ? glg.a(this.c, $$1) : 0;
   }
   ...
   public static record a(float b, float c, float d, float e) {
      public static final gir.a a = new gir.a(1.0F, 1.0F, 0.0F, 1.0F);
