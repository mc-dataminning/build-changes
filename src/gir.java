...
public class gir extends MinecraftServer {
   ...
   public gir(Thread $$0, evi $$1, egm.c $$2, apt $$3, aic $$4, ahz $$5, ann $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new giq(this, this.ba(), this.h));
      this.n = $$1;
   }
   ...
   @Override
   public ctm bb() {
      return this.p() ? (ctm)MoreObjects.firstNonNull(this.q, this.k.m()) : null;
   }
}
