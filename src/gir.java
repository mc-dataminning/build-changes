...
public class gir {
   ...
   public static class a extends Thread {
      private final gir.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gir.b $$0) throws IOException {
         super("LanServerDetector #" + gir.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gir.b));
   ...
   public static class b {
      private final List<giq> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<giq> a() {
         if (this.b) {
            List<giq> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
