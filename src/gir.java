public class gir extends gki {
   ...
   protected gir(gga $$0, double $$1, double $$2, double $$3, gkd $$4, float $$5, float $$6, boolean $$7, boolean $$8, float $$9, float $$10) {
      super($$0, $$1, $$2, $$3);
   ...
   public static class a implements gjl<lx> {
      ...
      public gji a(lx $$0, gga $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gir($$1, $$2, $$3, $$4, this.a, 0.25F, 2.0F, false, true, 1.0F, 0.0F);
      }
   }
   ...
   public static class b implements gjl<lx> {
      ...
      public gji a(lx $$0, gga $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gir($$1, $$2, $$3, $$4, this.a, 0.07F, 10.0F, true, false, 2.0F, 0.021F);
      }
   }
}
