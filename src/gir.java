...
public class gir {
   public static class a implements gjk<lx> {
      ...
      public gjh a(lx $$0, gfz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gir.b $$8 = new gir.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gkh {
      b(gfz $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gjt {
      ...
      c(gfz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjj $$7, gkc $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gir.c $$0 = new gir.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gjk<lx> {
      ...
      public gjh a(lx $$0, gfz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gir.c $$8 = new gir.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, flj.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gjf {
      ...
      private int D;
      private final gjj E;
      private final List<cze> F;
      private boolean G;

      public e(gfz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjj $$7, List<cze> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gjh $$12 = this.E.a(lt.O, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gir.c $$10 = (gir.c)this.E.a(lt.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
