...
public class bfj extends bbl {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfj::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfj::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfj::k);
         $$0 = this.a($$0, "minecraft:fox", bfj::j);
         $$0 = this.a($$0, "minecraft:item", bfj::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfj::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfj::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfj::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfj::e);
         return this.a($$0, "minecraft:piglin", bfj::d);
      });
   }
