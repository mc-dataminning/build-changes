...
public class bfj<T> implements beo, bfi<T>, AutoCloseable, Runnable {
   private static final Logger a = LogUtils.getLogger();
   private static final int b = 1;
   private static final int c = 2;
   private final AtomicInteger d = new AtomicInteger(0);
   private final bfl<? super T, ? extends Runnable> e;
   private final Executor f;
   private final String g;

   public static bfj<Runnable> a(Executor $$0, String $$1) {
      return new bfj<>(new bfl.c<>(new ConcurrentLinkedQueue<>()), $$0, $$1);
   }

   public bfj(bfl<? super T, ? extends Runnable> $$0, Executor $$1, String $$2) {
      this.f = $$1;
      this.e = $$0;
      this.g = $$2;
      bem.a.a(this);
