...
public interface bfj<T, F> {
   ...
   public static final class a implements bfj<bfj.b, Runnable> {
   ...
   public static final class c<T> implements bfj<T, T> {
