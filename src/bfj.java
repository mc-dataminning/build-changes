...
public class bfj {
   ...
   private JsonElement a(List<Pair<dic, bft<bfl>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bft)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dic, bft<bfl>> $$3 : $$0) {
         bft<bfl> $$4 = (bft<bfl>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dic)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bfr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bez.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bfh $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bfp $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bfp.b $$3 = (bfp.b)$$1x.getFirst();
         bfp.a $$4 = (bfp.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bfm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bfm>, ToDoubleFunction<bfm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bfm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bfm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bfm::c));
      return $$1;
   }
}
