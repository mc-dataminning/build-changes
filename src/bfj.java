...
public abstract class bfj<R extends Runnable> implements ber, bfl<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bfj(String $$0) {
      this.b = $$0;
      bep.a.a(this);
   }
   ...
   @Override
   public List<beo> bk() {
      return ImmutableList.of(beo.a(this.b + "-pending-tasks", ben.b, this::bm));
   }
}
