   ...
   public void a(fkm $$0) {
      if (this.e != null) {
         ...
         $$0.a($$4x -> {
            ...
            for (bom $$6x : $$1) {
               int $$7x = azj.a($$6x.a / 4.0) + 1;
               fdx $$8x = $$4x.getBuffer(gig.C());
               int $$9x = axu.f($$6x.a());
