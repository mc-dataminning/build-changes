...
public interface kp<T> {
   ...
   public static class a<T> {
      ...
      public kp.a<T> a(yx<? super wk, T> $$0) {
         this.b = $$0;
         return this;
      }
      ...
      public kp<T> b() {
         yx<? super wk, T> $$0 = Objects.requireNonNullElseGet(this.b, () -> yv.d(Objects.requireNonNull(this.a, "Missing Codec for component")));
      ...
      static class a<T> implements kp<T> {
         ...
         a(@Nullable Codec<T> $$0, yx<? super wk, T> $$1) {
            this.e = $$0;
            this.f = $$1;
         }
