...
public abstract class ckg extends ckf {
   ...
   protected ckg(btc<? extends ckg> $$0, dca $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bS.a(4, new ckg.a<>(this, 0.7, 0.595));
   }
   ...
   public buk a(dcp $$0, bqu $$1, btv $$2, @Nullable buk $$3) {
      if ($$2 != btv.p && $$2 != btv.h && $$2 != btv.d && $$0.E_().i() < 0.06F && this.gr()) {
         this.c = true;
      }

      if (this.gu()) {
         this.a(btd.f, cok.a(this.dR().b(lq.d)));
         this.a(btd.f, 2.0F);
      }
   ...
   public static boolean b(btc<? extends ckg> $$0, dcb $$1, btv $$2, iz $$3, azh $$4) {
   ...
   public static class a<T extends ckg> extends cap {
      ...
      public void e() {
         ...
         if ($$1.l()) {
            ...
            if (this.b.gz() && $$2.isEmpty()) {
               ...
               evt $$3 = evt.c(this.b.gs());
               evt $$4 = this.b.dn();
               evt $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).a(0.4).e($$3);
               evt $$6 = $$3.d($$4).d().a(10.0).e($$4);
               iz $$7 = iz.a($$6);
               $$7 = this.b.dP().a(dxw.a.f, $$7);
      ...
      private List<ckg> h() {
         return this.b.dP().a(ckg.class, this.b.cK().g(16.0), $$0 -> $$0.gx() && !$$0.t(this.b));
      }
