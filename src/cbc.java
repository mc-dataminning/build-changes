...
public abstract class cbc extends cap {
   ...
   public cbc(bua $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cbc(bua $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cap.a.a, cap.a.c));
   }
   ...
   protected abstract boolean a(dcd var1, iz var2);
}
