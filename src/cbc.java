...
public class cbc extends ccj implements bms, ccn {
   private static final agj<Integer> b = agm.a(cbc.class, agl.b);
   private static final agj<Integer> c = agm.a(cbc.class, agl.b);
   private static final agj<Integer> d = agm.a(cbc.class, agl.b);
   private static final List<agj<Integer>> e = ImmutableList.of(b, c, d);
   private static final agj<Integer> bT = agm.a(cbc.class, agl.b);
   ...
   private int cb;
   private final amw cc = (amw)new amw(this.Q_(), bjl.a.f, bjl.b.a).a(true);
   private static final Predicate<bmf> cd = $$0 -> $$0.eS() != bmk.b && $$0.fz();
   private static final bwt ce = bwt.a().a(20.0).a(cd);

   public cbc(blt<? extends cbc> $$0, cti $$1) {
      super($$0, $$1);
   ...
   @Override
   protected void B() {
      this.bO.a(0, new cbc.a());
      this.bO.a(2, new bua(this, 1.0, 40, 20.0F));
      this.bO.a(5, new bun(this, 1.0));
      this.bO.a(6, new btj(this, cfb.class, 8.0F));
      this.bO.a(7, new btw(this));
      this.bP.a(1, new but(this));
      this.bP.a(2, new buu<>(this, bmf.class, 0, false, false, cd));
   }
   ...
   @Override
   public void d_() {
      elm $$0 = this.dp().d(1.0, 0.6, 1.0);
      if (!this.dM().B && this.t(0) > 0) {
         blp $$1 = this.dM().a(this.t(0));
         if ($$1 != null) {
            double $$2 = $$0.d;
            ...
            $$0 = new elm($$0.c, $$2, $$0.e);
            elm $$3 = new elm($$1.dr() - this.dr(), 0.0, $$1.dx() - this.dx());
            if ($$3.i() > 9.0) {
               elm $$4 = $$3.d();
      ...
      this.g($$0);
      if ($$0.i() > 0.05) {
         this.r((float)aui.d($$0.e, $$0.c) * (180.0F / (float)Math.PI) - 90.0F);
      }
      ...
      for (int $$6 = 0; $$6 < 2; $$6++) {
         ...
         if ($$8 != null) {
            ...
            float $$16 = (float)(aui.d($$14, $$12) * 180.0F / (float)Math.PI) - 90.0F;
            float $$17 = (float)(-(aui.d($$13, $$15) * 180.0F / (float)Math.PI));
   ...
   protected void Z() {
      if (this.A() > 0) {
         ...
         if ($$0 <= 0) {
            this.dM().a(this, this.dr(), this.dv(), this.dx(), 7.0F, false, cti.a.c);
            if (!this.aU()) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ah >= this.bZ[$$1 - 1]) {
               ...
               if ((this.dM().ak() == bjs.c || this.dM().ak() == bjs.d) && this.ca[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
                  double $$4 = aui.a(this.ag, this.dr() - 10.0, this.dr() + 10.0);
                  double $$5 = aui.a(this.ag, this.dt() - 5.0, this.dt() + 5.0);
                  double $$6 = aui.a(this.ag, this.dx() - 10.0, this.dx() + 10.0);
               ...
               int $$7 = this.t($$1);
               if ($$7 > 0) {
                  bmf $$8 = (bmf)this.dM().a($$7);
                  if ($$8 != null && this.c($$8) && !(this.f((blp)$$8) > 900.0) && this.E($$8)) {
                     this.a($$1 + 1, $$8);
                  ...
                  List<bmf> $$9 = this.dM().a(bmf.class, ce, this, this.cH().c(20.0, 8.0, 20.0));
                  if (!$$9.isEmpty()) {
                     bmf $$10 = $$9.get(this.ag.a($$9.size()));
                     this.a($$1, $$10.aj());
                  }
               }
            }
         ...
         if (this.cb > 0) {
            this.cb--;
            if (this.cb == 0 && this.dM().Z().b(cte.c)) {
               int $$11 = aui.a(this.dt());
               int $$12 = aui.a(this.dr());
               int $$13 = aui.a(this.dx());
               boolean $$14 = false;
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      cgh $$11 = new cgh(this.dM(), this, $$8, $$9, $$10);
      $$11.b(this);
      if ($$4) {
         $$11.a(true);
      }
   ...
   public boolean a(bkn $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(asd.u) || $$0.d() instanceof cbc) {
         return false;
      } else if (this.A() > 0 && !$$0.a(asd.e)) {
         return false;
      } else {
         if (this.a()) {
            blp $$2 = $$0.c();
         ...
         blp $$3 = $$0.d();
         if ($$3 != null && !($$3 instanceof cfb) && $$3 instanceof bmf && ((bmf)$$3).eS() == this.eS()) {
            return false;
         } else {
            if (this.cb <= 0) {
               this.cb = 20;
   ...
   public static bnk.a w() {
      return ccj.gk().a(bnl.l, 300.0).a(bnl.m, 0.6F).a(bnl.f, 0.6F).a(bnl.g, 40.0).a(bnl.a, 4.0);
   }
   ...
   class a extends btb {
      public a() {
         this.a(EnumSet.of(btb.a.a, btb.a.c, btb.a.b));
      }
