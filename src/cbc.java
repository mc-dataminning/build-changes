...
public abstract class cbc extends bil implements cbf, cbg, cos {
   private static final aef<Integer> bV = aei.a(cbc.class, aeh.b);
   ...
   public void a(cot $$0) {
      ...
      this.bI = -this.O();
      this.b($$0);
      if (this.bX instanceof aks) {
         al.s.a((aks)this.bX, this, $$0.d());
      }
   }
   ...
   protected apd w(boolean $$0) {
      return $$0 ? ape.yN : ape.yL;
   }

   public void gi() {
      this.a(ape.yI, this.eV(), this.eW());
   }
