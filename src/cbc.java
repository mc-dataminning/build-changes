...
public class cbc extends caq {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new elt($$0, this.g.dt() + $$5, $$1);
         }
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               elt $$8 = new elt(this.g.dr() - this.a.dr(), 0.0, this.g.dx() - this.a.dx()).d();
               elt $$9 = new elt((double)auo.a(this.a.dC() * (float) (Math.PI / 180.0)), 0.0, (double)(-auo.b(this.a.dC() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  elt $$13 = this.a.f(1.0F);
                  ...
                  cfr $$20 = new cfr(this.a.dM(), this.a, $$17, $$18, $$19);
   ...
   public void a(bml $$0) {
      ...
      int $$9 = auo.a(this.g.dt() + $$8);
      efe $$10 = new efe($$3, $$9, $$4);
