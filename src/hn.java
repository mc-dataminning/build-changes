...
public class hn {
   ...
   public static final BiConsumer<fba, List<? extends buk>> k = ($$0, $$1) -> $$1.sort(($$1x, $$2) -> Doubles.compare($$1x.f($$0), $$2.f($$0)));
   public static final BiConsumer<fba, List<? extends buk>> l = ($$0, $$1) -> $$1.sort(($$1x, $$2) -> Doubles.compare($$2.f($$0), $$1x.f($$0)));
   public static final BiConsumer<fba, List<? extends buk>> m = ($$0, $$1) -> Collections.shuffle($$1);
   ...
   private eo K = eo.a;
   private eo L = eo.a;
   private final List<Predicate<buk>> M = new ArrayList<>();
   private BiConsumer<fba, List<? extends buk>> N = hm.b;
   private boolean O;
   @Nullable
   private String P;
   private int Q;
   ...
   private void I() {
      if (this.K != eo.a) {
         this.M.add(this.a(this.K, buk::dO));
      }

      if (this.L != eo.a) {
         this.M.add(this.a(this.L, buk::dM));
      }
   ...
   private Predicate<buk> a(eo $$0, ToDoubleFunction<buk> $$1) {
   ...
   public BiConsumer<fba, List<? extends buk>> s() {
      return this.N;
   }

   public void a(BiConsumer<fba, List<? extends buk>> $$0) {
      this.N = $$0;
   }
