...
public class can {
   ...
   @Nullable
   public static ept a(bpx $$0, Supplier<ib> $$1) {
      return a($$1, $$0::h);
   }

   @Nullable
   public static ept a(Supplier<ib> $$0, ToDoubleFunction<ib> $$1) {
      ...
      return $$3 != null ? ept.c($$3) : null;
   }

   public static ib a(bpx $$0, int $$1, axd $$2, ib $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.fZ() && $$1 > 1) {
         ib $$6 = $$0.fW();
