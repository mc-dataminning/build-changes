...
public class cjo extends bvc implements clj {
   private static final Logger cc = LogUtils.getLogger();
   public static final akl<Integer> b = akp.a(cjo.class, akn.b);
   private static final cfr cd = cfr.a().a(64.0);
   ...
   public final cjm c = new cjm();
   private final cjl[] cj;
   public final cjl d;
   private final cjl ck;
   private final cjl cl;
   private final cjl cm;
   private final cjl cn;
   private final cjl co;
   private final cjl cp;
   private final cjl cq;
   public float e;
   public float bX;
   public boolean bY;
   public int bZ;
   ...
   private dzi cr;
   private jh cs = jh.c;
   private final ckf ct;
   private int cu = 100;
   private float cv;
   private final erw[] cw = new erw[24];
   private final int[] cx = new int[24];
   private final eru cy = new eru();

   public cjo(bul<? extends cjo> $$0, dfb $$1) {
      super(bul.F, $$1);
      this.d = new cjl(this, "head", 1.0F, 1.0F);
      this.ck = new cjl(this, "neck", 3.0F, 3.0F);
      this.cl = new cjl(this, "body", 5.0F, 3.0F);
      this.cm = new cjl(this, "tail", 2.0F, 2.0F);
      this.cn = new cjl(this, "tail", 2.0F, 2.0F);
      this.co = new cjl(this, "tail", 2.0F, 2.0F);
      this.cp = new cjl(this, "wing", 4.0F, 2.0F);
      this.cq = new cjl(this, "wing", 4.0F, 2.0F);
      this.cj = new cjl[]{this.d, this.ck, this.cl, this.cm, this.cn, this.co, this.cp, this.cq};
      this.x(this.eV());
      this.ae = true;
      this.ct = new ckf(this);
   }
   ...
   public static bwh.a t() {
      return bvc.E().a(bwi.s, 200.0);
   }

   @Override
   public boolean bb() {
      float $$0 = azk.b(this.bX * (float) (Math.PI * 2));
      float $$1 = azk.b(this.e * (float) (Math.PI * 2));
   ...
   public void ba() {
      if (this.dX().C && !this.bc()) {
         this.dX().a(this.dC(), this.dE(), this.dI(), awl.ie, this.dn(), 5.0F, 0.8F + this.af.i() * 0.3F, false);
      }
   }
   ...
   public void n_() {
      ...
      if (this.dX().C) {
         ...
         if (!this.bc() && !this.ct.a().a() && --this.cu < 0) {
            this.dX().a(this.dC(), this.dE(), this.dI(), awl.if, this.dn(), 2.5F, 0.8F + this.af.i() * 0.3F, false);
            this.cu = 200 + this.af.a(200);
         }
      }

      if (this.cr == null && this.dX() instanceof arn $$0) {
         dzi $$1 = $$0.D();
      ...
      if (this.eH()) {
         ...
         this.dX().a(lr.w, this.dC() + (double)$$2, this.dE() + 2.0 + (double)$$3, this.dI() + (double)$$4, 0.0, 0.0, 0.0);
      } else {
         this.gu();
         ezn $$5 = this.dA();
         ...
         if (this.gh()) {
            ...
            if (this.dX().C) {
               ...
               if ($$8 != null) {
                  ...
                  if ($$14 > 0.0) {
                     $$10 = azk.a($$10 / $$14, (double)(-$$13), (double)$$13);
                  }

                  this.h(this.dA().b(0.0, $$10 * 0.01, 0.0));
                  this.v(azk.h(this.dN()));
                  ezn $$15 = $$8.a(this.dC(), this.dE(), this.dI()).d();
                  ezn $$16 = new ezn((double)azk.a(this.dN() * (float) (Math.PI / 180.0)), this.dA().e, (double)(-azk.b(this.dN() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$17 = Math.max(((float)$$16.b($$15) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$9) > 1.0E-5F || Math.abs($$11) > 1.0E-5F) {
                     float $$18 = azk.a(azk.h(180.0F - (float)azk.d($$9, $$11) * (180.0F / (float)Math.PI) - this.dN()), -50.0F, 50.0F);
                     this.ca *= 0.8F;
                  ...
                  float $$20 = 0.06F;
                  this.a(0.06F * ($$17 * $$19 + (1.0F - $$19)), new ezn(0.0, 0.0, -1.0));
                  if (this.bY) {
                     this.a(bve.a, this.dA().c(0.8F));
                  } else {
            ...
            this.aX = this.dN();
            ezn[] $$23 = new ezn[this.cj.length];

            for (int $$24 = 0; $$24 < this.cj.length; $$24++) {
               $$23[$$24] = new ezn(this.cj[$$24].dC(), this.cj[$$24].dE(), this.cj[$$24].dI());
            }
            ...
            if (this.dX() instanceof arn $$31 && this.aN == 0) {
               this.a($$31, $$31.a(this, this.cp.cS().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), buj.e));
               this.a($$31, $$31.a(this, this.cq.cS().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), buj.e));
               this.b($$31.a(this, this.d.cS().g(1.0), buj.e));
               this.b($$31.a(this, this.ck.cS().g(1.0), buj.e));
            }

            float $$32 = azk.a(this.dN() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$33 = azk.b(this.dN() * (float) (Math.PI / 180.0) - this.ca * 0.01F);
            float $$34 = this.gt();
   ...
   private void a(cjl $$0, double $$1, double $$2, double $$3) {
   ...
   private void gu() {
      ...
      if (this.af.a(10) == 0) {
         List<cjn> $$0 = this.dX().a(cjn.class, this.cS().g(32.0));
         cjn $$1 = null;
   ...
   private void a(arn $$0, List<bue> $$1) {
   ...
   private void b(List<bue> $$0) {
      for (bue $$1 : $$0) {
         if ($$1 instanceof bva) {
            bsu $$2 = this.dY().b((bva)this);
            $$1.a($$2, 10.0F);
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dvj $$13 = this.dX().a_($$12);
               if (!$$13.l() && !$$13.a(axa.aE)) {
                  if (this.dX().ac().b(dex.c) && !$$13.a(axa.aD)) {
   ...
   public boolean a(cjl $$0, bsu $$1, float $$2) {
      if (this.ct.a().i() == cke.j) {
         return false;
      } else {
         $$2 = this.ct.a().a($$1, $$2);
         if ($$0 != this.d) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof com || $$1.a(axc.y)) {
               float $$3 = this.eG();
               this.g($$1, $$2);
   ...
   protected boolean g(bsu $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void en() {
      ...
      if (this.bZ >= 180 && this.bZ <= 200) {
         ...
         float $$2 = (this.af.i() - 0.5F) * 8.0F;
         this.dX().a(lr.v, this.dC() + (double)$$0, this.dE() + 2.0 + (double)$$1, this.dI() + (double)$$2, 0.0, 0.0, 0.0);
      }

      boolean $$3 = this.dX().ac().b(dex.f);
      int $$4 = 500;
      ...
      if (this.dX() instanceof arn) {
         if (this.bZ > 150 && this.bZ % 5 == 0 && $$3) {
            buq.a((arn)this.dX(), this.dv(), azk.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bve.a, new ezn(0.0, 0.1F, 0.0));
      if (this.bZ == 200 && this.dX() instanceof arn) {
         if ($$3) {
            buq.a((arn)this.dX(), this.dv(), azk.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cw[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(73, this.dX().a(ebf.a.f, new jh($$3, 0, $$4)).v() + $$1);
            this.cw[$$0] = new erw($$3, $$9, $$4);
         }
   ...
   public int q(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      erw $$5 = new erw(azk.a($$0), azk.a($$1), azk.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public ery a(int $$0, int $$1, @Nullable erw $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         erw $$4 = this.cw[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private ery a(erw $$0, erw $$1) {
      List<erw> $$2 = Lists.newArrayList();
      erw $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new ery($$2, new jh($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(uk $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.ct.a(cke.a($$0.h("DragonPhase")));
      }
   ...
   public ezn J(float $$0) {
      cjy $$1 = this.ct.a();
      cke<? extends cjy> $$2 = $$1.i();
      ezn $$8;
      if ($$2 == cke.d || $$2 == cke.e) {
         jh $$3 = this.dX().a(ebf.a.f, eek.a(this.cs));
   ...
   public void a(cjn $$0, jh $$1, bsu $$2) {
      com $$3;
      if ($$2.d() instanceof com) {
         $$3 = (com)$$2.d();
      } else {
