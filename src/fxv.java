...
public class fxv extends fpk {
   private static final fpr c = new fpr(alz.b("recipe_book/tab"), alz.b("recipe_book/tab_selected"));
   private final fxt.a d;
   ...
   public void a(flp $$0, boolean $$1) {
      fxx.a $$2 = $$1 ? fxx.a.b : fxx.a.a;

      for (fxx $$4 : $$0.a(this.d.c())) {
         for (ddj $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(fnq $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(glt::B, $$5, $$6, this.E(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
   ...
   public boolean a(flp $$0) {
      List<fxx> $$1 = $$0.a(this.d.c());
      this.k = false;
