...
public class fio extends dhe {
   ...
   public fio(fis $$0, int $$1) {
      this.e = $$0;
      this.b = new dhh($$0, new cox(0, 0), $$0.B_().d(je.ap).f(cqv.b));
      this.c = new dzw(this, true, $$0.x_().g());
   ...
   private static boolean a(@Nullable dhl $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         cox $$3 = $$0.f();
   ...
   @Nullable
   public dhl b(int $$0, int $$1, dhf $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dhl $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dhl a(int $$0, int $$1, sl $$2, qu $$3, Consumer<yc.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dhl $$6 = this.d.b.get($$5);
         cox $$7 = new cox($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dhl(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   public void a(cpz $$0, hz $$1) {
      eqq.O().f.b($$1.a(), $$1.b(), $$1.c());
   }

   final class a {
      final AtomicReferenceArray<dhl> b;
      final int c;
      private final int d;
      volatile int e;
      volatile int f;
      ...
      protected void a(int $$0, @Nullable dhl $$1) {
         dhl $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.g--;
            fio.this.e.a($$2);
         }
      ...
      protected dhl a(int $$0, dhl $$1, @Nullable dhl $$2) {
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.f - $$2; $$3 <= this.f + $$2; $$3++) {
               for (int $$4 = this.e - $$2; $$4 <= this.e + $$2; $$4++) {
                  dhl $$5 = fio.this.d.b.get(fio.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     cox $$6 = $$5.f();
