...
public class fio {
   ...
   private static final Map<dyv.a, String> e = ad.a(new EnumMap<>(dyv.a.class), $$0 -> {
      $$0.put(dyv.a.a, "SW");
      $$0.put(dyv.a.b, "S");
      $$0.put(dyv.a.c, "OW");
      $$0.put(dyv.a.d, "O");
   ...
   private dvg l;
   @Nullable
   private CompletableFuture<dvg> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blq r = new blq(1);
   private final blq s = new blq(blv.values().length);
   private final blq t = new blq(1);
   private final blq u = new blq(1);
   private final Map<blr, blq> v = Map.of(blr.a, this.s);
   private final fjx w;
   private final fjz x;
   private final fjy y;
   private final fjw z;
   ...
   public fio(fgi $$0) {
      ...
      this.g = new fio.a();
      this.h = $$0.h;
      this.w = new fjx(this.h, this.r);
      this.x = new fjz(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fjy(this.h, this.t);
      this.z = new fjw(this.h, this.u);
   }
   ...
   private void a(fht $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.av()) {
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayn.g($$15.dG()), ayn.g($$15.dI())));
         dvg $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(ddd.a, $$14);
            int $$30 = this.f.r.a(ddd.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dvg $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dyv.a $$33 : dyv.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqo $$37 = new bqo($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            ddf.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bto> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bto.values())
   ...
   private static String a(jm<ddu> $$0) {
   ...
   private dcu r() {
      return (dcu)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private dvg s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dvx.n, false).thenApply($$0x -> (dvg)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ezw.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fgi.Q().aM().l(), fgi.Q().aM().m(), ezw.a()),
            ezw.c(),
            ezw.d()
         }
      );
      if (this.f.av()) {
         ...
         if (this.i.c() == ewu.a.b) {
            ...
            for (Entry<dud<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ewu.a.b) {
            ...
            for (Entry<dud<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dud<?>, Comparable<?>> $$0) {
      dud<?> $$1 = $$0.getKey();
