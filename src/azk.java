...
public class azk implements AutoCloseable {
   ...
   private azk(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static azk.a a(Path $$0) {
         return new azk.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
