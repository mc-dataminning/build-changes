...
public class azk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bbv.x);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", azk::c), this.a("minecraft:arrow", azk::a), this.a("minecraft:spectral_arrow", azk::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, azk.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bbv.x, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bbv.x, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, azk.a<?> $$1, Type<?> $$2, Type<T> $$3) {
