...
public class azk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bfs.z), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", azk::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", azk::a);
      return this.a($$0, "minecraft:trident", azk::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bfs.z, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bfs.z, $$1);
