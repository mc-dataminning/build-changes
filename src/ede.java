...
public class ede implements edd {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<ede> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dxs.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dxu.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dxt.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bqa.b(1, 20).fieldOf("outer_wall_distance").orElse(bqg.a(4, 5)).forGetter($$0x -> $$0x.i),
               bqa.b(1, 20).fieldOf("distribution_points").orElse(bqg.a(3, 4)).forGetter($$0x -> $$0x.j),
               bqa.b(0, 10).fieldOf("point_offset").orElse(bqg.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public ede(dxs $$0, dxu $$1, dxt $$2, double $$3, double $$4, boolean $$5, bqa $$6, bqa $$7, bqa $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
