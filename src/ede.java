...
public class ede<T> implements edg<T> {
   ...
   private ede(jk<T> $$0, int $$1, edh<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private ede(jk<T> $$0, T[] $$1, edh<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public edg<T> a(edh<T> $$0) {
      return new ede<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
