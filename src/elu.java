...
public class elu extends elz {
   ...
   public List<ekf.a> a(dhf $$0, BiConsumer<jh, dxo> $$1, bac $$2, int $$3, jh $$4, ejp $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azu.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azu.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<elu.a> $$13 = Lists.newArrayList();
      $$13.add(new elu.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jh $$21 = $$4.b(azu.a($$19), $$12 - 1, azu.a($$20));
               jh $$22 = $$21.b(5);
      ...
      List<ekf.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dhf $$0, BiConsumer<jh, dxo> $$1, bac $$2, jh $$3, jh $$4, boolean $$5, ejp $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jh $$13 = $$3.b(azu.d(0.5F + (float)$$12 * $$9), azu.d(0.5F + (float)$$12 * $$10), azu.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dqu.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dhf $$0, BiConsumer<jh, dxo> $$1, bac $$2, int $$3, jh $$4, List<elu.a> $$5, ejp $$6) {
      for (elu.a $$7 : $$5) {
         int $$8 = $$7.a();
