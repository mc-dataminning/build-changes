...
public class elu implements AutoCloseable {
   private final elu.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private elw a(elm.a $$0, ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(elm.a $$0, ByteBuffer $$1) {
      if (!$$0.m()) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, fou $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, fou $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == elw.b.a || this.i == elw.b.b)) {
