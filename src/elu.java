...
public class elu implements PathMatcher {
   ...
   public static elu a(BufferedReader $$0) {
      return new elu($$0.lines().flatMap($$0x -> elu.a.a($$0x).stream()).toList());
   }

   public static record a(elu.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<elu.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new elu.a(elu.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new elu.a(elu.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new elu.a(elu.b.b, $$3));
      ...
      static elu.a b(String $$0) {
         return new elu.a(elu.b.a, "glob:" + $$0);
      }

      static elu.a c(String $$0) {
         return new elu.a(elu.b.a, "regex:" + $$0);
      }

      static elu.a d(String $$0) {
         return new elu.a(elu.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      elu.b a = FileSystem::getPathMatcher;
      elu.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
