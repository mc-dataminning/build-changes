...
public class cxc extends cwl {
   ...
   private static eur a(dgi $$0, int $$1, int $$2, int $$3, boolean $$4, boolean $$5, akt<dgi> $$6) {
   ...
   public void a(dgi $$0, buk $$1, eut $$2) {
      if ($$0.ai() == $$2.e && $$1 instanceof cox) {
         int $$3 = 1 << $$2.f;
         int $$4 = $$2.c;
         int $$5 = $$2.d;
         int $$6 = ayz.a($$1.dB() - (double)$$4) / $$3 + 64;
         int $$7 = ayz.a($$1.dH() - (double)$$5) / $$3 + 64;
         int $$8 = 128 / $$3;
         if ($$0.G_().h()) {
            $$8 /= 2;
         }
   ...
   public static void a(arc $$0, cwp $$1) {
      eut $$2 = b($$1, $$0);
      if ($$2 != null) {
         if ($$0.ai() == $$2.e) {
            int $$3 = 1 << $$2.f;
