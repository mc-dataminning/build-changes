...
public class azc extends awb {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), azc::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", azc::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", azc::k);
         $$0 = this.a($$0, "minecraft:fox", azc::j);
         $$0 = this.a($$0, "minecraft:item", azc::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", azc::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", azc::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", azc::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", azc::e);
         return this.a($$0, "minecraft:piglin", azc::d);
      });
   }
