...
public class azc {
   ...
   public static jf<czj> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static jf<czj> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jf<czj> a(JsonObject $$0, String $$1, @Nullable jf<czj> $$2) {
   ...
   public static boolean a(JsonElement $$0, int $$1) {
      try {
         Streams.write($$0, new JsonWriter(Streams.writerForAppendable(new azc.a($$1))));
         return false;
