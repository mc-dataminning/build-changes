...
public class azc {
   ...
   public static SecretKey a() throws azd {
      try {
   ...
   public static KeyPair b() throws azd {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws azd {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, azc.a<T> $$3) throws azd {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws azd {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", azc::b);
   }

   public static PublicKey b(String $$0) throws azd {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", azc::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws azd {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws azd {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws azd {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws azd {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws azd {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws azd {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws azd {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws azd;
   }

   public static record b(long b, byte[] c) {
      public static final azc.b a = new azc.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(ws $$0, azc.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
