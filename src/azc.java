...
public abstract class azc extends DataFix {
   private final String a;

   public azc(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(ays.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(ays.x);
      Type<Pair<String, String>> $$2 = DSL.named(ays.v.typeName(), baa.a());
      if (!Objects.equals(this.getOutputSchema().getType(ays.v), $$2)) {
