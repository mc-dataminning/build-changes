public abstract class bpn extends bpw {
   protected bjd d;
   protected gw e = gw.b;
   protected boolean f;
   private boolean a;
   ...
   protected boolean h() {
      if (!this.f) {
         ...
         dfe $$0 = this.d.dK().a_(this.e);
         if (!($$0.b() instanceof cus)) {
            this.f = false;
            return false;
         } else {
            return $$0.c(cus.b);
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         dfe $$1 = this.d.dK().a_(this.e);
         if ($$1.b() instanceof cus) {
            ((cus)$$1.b()).a(this.d, this.d.dK(), $$1, this.e, $$0);
         }
      }
   }
