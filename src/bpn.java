...
public class bpn {
   ...
   private static void a(bpv $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bpq $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bpw> $$0) {
      JsonObject $$1 = new JsonObject();
      bqa<bpw> $$2 = bqa.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bpw::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bqa<bpw> $$6 = bqa.a((List<bpw>)$$4);
         ...
         Function<bpw, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<dzt, bqa<bpp>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqa)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dzt, bqa<bpp>> $$3 : $$0) {
         bqa<bpp> $$4 = (bqa<bpp>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dzt)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<bpy> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bpc.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bpl $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bpn::a));
      $$1.add("chunksWritten", this.a($$0.m(), bpn::a));
      return $$1;
   }

   private JsonElement a(bps.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bpl $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bpn::a));
      $$1.add("received", this.a($$0.k(), bpn::a));
      return $$1;
   }

   private <T> JsonElement a(bpu<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bpr> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bpr>, ToDoubleFunction<bpr>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bpr::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bpr::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bpr::c));
      return $$1;
   }
}
