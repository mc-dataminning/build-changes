...
public abstract class dmh {
   public static dmh.b a(int $$0, int $$1) {
      return new dmh.b($$0 - 1, $$1 + 1);
   }

   public static dmh.b b(int $$0, int $$1) {
      return new dmh.b($$0, $$1);
   }

   public static dmh a(int $$0) {
      return new dmh.c($$0, false);
   }

   public static dmh b(int $$0) {
      return new dmh.c($$0 + 1, false);
   }

   public static dmh c(int $$0) {
      return new dmh.c($$0, true);
   }

   public static dmh d(int $$0) {
      return new dmh.c($$0 - 1, true);
   }
   ...
   public static dmh a(OptionalInt $$0, OptionalInt $$1) {
   ...
   public dmh a(OptionalInt $$0) {
      return a($$0, this.b());
   }

   public dmh b(OptionalInt $$0) {
      return a(this.c(), $$0);
   }

   public static Optional<dmh> a(csg $$0, ht $$1, int $$2, Predicate<dhi> $$3, Predicate<dhi> $$4) {
      ht.a $$5 = $$1.j();
      if (!$$0.a($$1, $$3)) {
   ...
   private static OptionalInt a(csg $$0, int $$1, Predicate<dhi> $$2, Predicate<dhi> $$3, ht.a $$4, int $$5, hx $$6) {
      $$4.q($$5);
   ...
   public static final class a extends dmh {
      static final dmh.a a = new dmh.a();
