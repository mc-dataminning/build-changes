...
public class dlp {
   ...
   private final int j;
   private final int k;
   private List<dlp.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public dlp(boolean $$0, axb<deu> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static dlp a() {
      return new dlp(false, awl.bS, 10, 4, 10, 5);
   }

   public static dlp b() {
      return new dlp(true, awl.bT, 50, 1, 5, 10);
   }
   ...
   public void a(ur $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<dlp.a> $$1 = (List<dlp.a>)dlp.a.b.listOf().parse(new Dynamic(vf.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(ur $$0) {
      dlp.a.b.listOf().encodeStart(vf.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(iz $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dlp.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dlp.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(dbu $$0, iz $$1, azc $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<dlp.a> $$4 = new ArrayList<>();
         Map<iz, dlp.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dlp.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  iz.a.fieldOf("pos").forGetter(dlp.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dlp.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dlp.a::c),
      ...
      private boolean a(dbu $$0, iz $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
         } else {
            return $$0 instanceof arb $$3 ? $$3.n($$1) : false;
         }
      }

      public void a(dbu $$0, iz $$1, azc $$2, dlp $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, avw.vQ, avx.e, 1.0F, 1.0F);
               }
      ...
      private static dlk a(drx $$0) {
         return $$0.b() instanceof dlk $$1 ? $$1 : dlk.s_;
      }

      private static List<kd> a(azc $$0) {
         return ac.a(c, $$0);
      }

      @Nullable
      private static iz a(dbu $$0, iz $$1, azc $$2) {
         iz.a $$3 = $$1.j();
         iz.a $$4 = $$1.j();
      ...
      private static boolean a(dbu $$0, iz $$1, iz $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            iz $$3 = $$2.b($$1);
      ...
      private static boolean a(dbu $$0, iz $$1, je $$2) {
         iz $$3 = $$1.a($$2);
