...
public class dlp {
   ...
   private final cqd p;
   private static final List<ctc> q = List.of(cte.l, cte.L, cte.i, cte.b, cte.k, cte.I, cte.K, cte.fl, cte.dP, cte.iA, cte.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<he<cqz>>> t;
   ...
   public static final Codec<dlp> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlp::a, Function.identity());

   private static DataResult<dlp> a(dlp $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlp(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<he<cqz>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hw.c($$0);
      int $$5 = hw.c($$1) - $$4;
   ...
   @Nullable
   public static dlp a(ala $$0, int $$1, int $$2) {
      dgz $$3 = $$0.a($$1, $$2);
      dlp $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dhe.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hb> a(cqv $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dgz $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, asb.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dgz $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dkm.a.a)) {
         $$3 = Math.min($$0.a(dkm.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }
   ...
   private static double a(dgz $$0, gw.a $$1) {
      return a($$0, (gw)$$1.c(ha.a)) ? 1.0 : -1.0;
   }

   private static double b(dgz $$0, gw.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dgz $$0, int $$1, int $$2, int $$3) {
   ...
   private List<he<cqz>> b(dgz $$0, int $$1, int $$2) {
      ObjectArrayList<he<cqz>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dgz $$0, gw $$1) {
      dfd $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(apv.O)) {
         ...
         return $$2.a(cte.eT) || $$2.a(cte.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dlp.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlp.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, he<cqz> var3);
   }
