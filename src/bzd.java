...
public class bzd {
   public static bxa<bvo> a(cek<ji> $$0, float $$1, int $$2, boolean $$3) {
      return a($$0, $$1, $$2, $$3, faz::c);
   }

   public static byk<bvo> b(cek<? extends buk> $$0, float $$1, int $$2, boolean $$3) {
      return a($$0, $$1, $$2, $$3, buk::dt);
   }

   private static <T> byk<bvo> a(cek<T> $$0, float $$1, int $$2, boolean $$3, Function<T, faz> $$4) {
      return cam.a(
         (Function<cam.b<bvo>, ? extends App<cam.c<bvo>, cap<bvo>>>)($$5 -> $$5.group($$5.a(cek.m), $$5.b($$0)).apply($$5, ($$5x, $$6) -> ($$7, $$8, $$9) -> {
                  ...
                  if ($$10.isPresent() && !$$3) {
                     ...
                     faz $$11 = $$8.dt();
                     faz $$12 = $$4.apply($$5.b($$6));
                     if (!$$11.a((kb)$$12, (double)$$2)) {
                        return false;
                     } else {
                        if ($$10.isPresent() && $$10.get().b() == $$1) {
                           faz $$13 = $$10.get().a().a().d($$11);
                           faz $$14 = $$12.d($$11);
                           if ($$13.b($$14) < 0.0) {
                              return false;
                           }
