...
public class gzu extends gxc<ckd, hfw, giy> {
   private static final Map<ckd.a, ali> a = Maps.newEnumMap(
      Map.of(
         ckd.a.a,
         ali.b("textures/entity/panda/panda.png"),
         ckd.a.b,
         ali.b("textures/entity/panda/lazy_panda.png"),
         ckd.a.c,
         ali.b("textures/entity/panda/worried_panda.png"),
         ckd.a.d,
         ali.b("textures/entity/panda/playful_panda.png"),
         ckd.a.e,
         ali.b("textures/entity/panda/brown_panda.png"),
         ckd.a.f,
         ali.b("textures/entity/panda/weak_panda.png"),
         ckd.a.g,
         ali.b("textures/entity/panda/aggressive_panda.png")
      )
   );

   public gzu(gyi.a $$0) {
      super($$0, new giy($$0.a(gld.bZ)), new giy($$0.a(gld.ca)), 0.9F);
      this.a(new hcs(this));
   }

   public ali a(hfw $$0) {
      return a.getOrDefault($$0.a, a.get(ckd.a.a));
   }
   ...
   protected void a(hfw $$0, flo $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.l > 0.0F) {
         float $$4 = azo.i($$0.l);
         int $$5 = azo.d($$0.l);
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(azo.h($$24, $$0.ab, $$0.ab + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(azo.h($$26, $$0.ab, $$0.ab + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? azo.h($$3, $$0, $$1) : $$0;
   }
}
