      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)azu.a),
               String.format(Locale.ROOT, "%.2f", this.d.aQ().g() / (float)azu.c)
            );
            ...
            $$10.a("Random tick rate", () -> this.d.bb().o().a(dbp.o).toString());
