...
public class djc {
   public static <T> List<djc.b> a(List<T> $$0, Function<T, List<jw<eok>>> $$1, boolean $$2) {
      Object2IntMap<eok> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eok c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jw<eok>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (js<eok> $$12 : $$10.get($$11)) {
               eok $$13 = $$12.a();
      ...
      Builder<djc.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eok> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new djc.b($$28));
      }
   ...
   public static record b(List<eok> a, ToIntFunction<eok> b) {
      b(List<eok> $$0) {
         this($$0, af.h($$0));
      }
   }
