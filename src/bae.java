...
public class bae extends ber {
   public bae(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bfs.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bfs.s, "minecraft:jukebox");
