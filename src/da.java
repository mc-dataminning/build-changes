...
public record da(List<da.c> b) {
   ...
   public <S extends dhk<?, S>> boolean a(dhj<?, S> $$0, S $$1) {
      for (da.c $$2 : this.b) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(dhj<?, ?> $$0) {
      for (da.c $$1 : this.b) {
   ...
   public void a(dhj<?, ?> $$0, Consumer<String> $$1) {
   ...
   public static class a {
      ...
      public da.a a(dil<?> $$0, String $$1) {
         this.a.add(new da.c($$0.f(), new da.b($$1)));
         return this;
      }

      public da.a a(dil<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public da.a a(dil<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & aug> da.a a(dil<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String c) implements da.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dhk<?, ?> $$0, dil<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   static record d(Optional<String> c, Optional<String> d) implements da.e {
      public static final Codec<da.d> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(asu.a(Codec.STRING, "min").forGetter(da.d::a), asu.a(Codec.STRING, "max").forGetter(da.d::b)).apply($$0, da.d::new)
      );
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(dhk<?, ?> var1, dil<T> var2);
   }
}
