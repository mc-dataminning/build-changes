...
public class aus extends auy {
   ...
   private final Set<aut<?>> e = Sets.newHashSet();

   public aus(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<aut<?>> d() {
      Set<aut<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  tm $$4 = a($$3.getAsJsonObject());
                  $$4 = ayq.g.a($$0, $$4, ub.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<aut<T>> a(auv<T> $$0, String $$1) {
      return Optional.ofNullable(ajt.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static tm a(JsonObject $$0) {
      tm $$1 = new tm();
   ...
   protected String b() {
      Map<auv<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aut<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aut<?>>)$$3.next();
         aut<?> $$2 = (aut<?>)$$1.getKey();
      ...
      for (Entry<auv<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(kr.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> ajt b(aut<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(apt $$0) {
      Object2IntMap<aut<?>> $$1 = new Object2IntOpenHashMap();
