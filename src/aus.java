...
public class aus {
   ...
   private static final Optional<Object> b = Optional.of(avc.a);

   private static boolean a(vy $$0, atl $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, vy $$1, atl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, vy $$1, atl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, vy $$1, atl $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, vy $$2, atl $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, vy $$2, vy $$3, atl $$4) {
      int $$5 = $$0.length();
      vy $$6 = $$2;
   ...
   public static boolean a(vg $$0, vy $$1, atl $$2) {
