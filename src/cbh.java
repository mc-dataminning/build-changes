...
public class cbh extends cbc implements bjv, cbj {
   ...
   private static final aef<cbi> ca = aei.a(cbh.class, aeh.t);
   ...
   public static final Map<bsh<hf>, BiPredicate<cbh, hg<bui>>> bY = ImmutableMap.of(
      bsh.b,
      (BiPredicate<cbh, hg>)($$0, $$1) -> $$1.a(buj.n),
      bsh.c,
      (BiPredicate<cbh, hg>)($$0, $$1) -> $$0.go().b().b().test($$1),
      bsh.d,
      (BiPredicate<cbh, hg>)($$0, $$1) -> cbk.a.test($$1),
      bsh.e,
      (BiPredicate<cbh, hg>)($$0, $$1) -> $$1.a(buj.o)
   );
   ...
   protected void X() {
      ...
      if (this.cm != null && this.dL() instanceof akr) {
         ((akr)this.dL()).a(buc.e, this.cm, this);
         this.dL().a(this, (byte)14);
         this.cm = null;
      }

      if (!this.fT() && this.ag.a(100) == 0) {
         cdb $$0 = ((akr)this.dL()).c(this.dl());
         if ($$0 != null && $$0.v() && !$$0.a()) {
   ...
   public void a(bsh<hf> $$0) {
      if (this.dL() instanceof akr) {
         MinecraftServer $$1 = ((akr)this.dL()).n();
         this.bz.c($$0).ifPresent($$2 -> {
            akr $$3 = $$1.a($$2.a());
            if ($$3 != null) {
               buf $$4 = $$3.w();
               Optional<hg<bui>> $$5 = $$4.c($$2.b());
               BiPredicate<cbh, hg<bui>> $$6 = bY.get($$0);
   ...
   public void a(akr $$0, cbh $$1, long $$2) {
