...
public class dsl<T> implements dst<T> {
   private final jb<T> a;
   private final aww<T> b;
   private final dsu<T> c;
   private final int d;

   public dsl(jb<T> $$0, int $$1, dsu<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dsl(jb<T> $$0, int $$1, dsu<T> $$2) {
      this($$0, $$1, $$2, aww.c(1 << $$1));
   }

   private dsl(jb<T> $$0, int $$1, dsu<T> $$2, aww<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dst<T> c() {
      return new dsl<>(this.a, this.d, this.c, this.b.c());
   }
}
