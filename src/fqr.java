...
public class fqr implements fqp {
   private static final alz h = alz.b("toast/tutorial");
   public static final int a = 154;
   public static final int e = 1;
   public static final int f = 3;
   public static final int g = 28;
   private final fqr.a i;
   private final xv j;
   @Nullable
   private final xv k;
   private fqp.a l = fqp.a.a;
   private long m;
   private float n;
   private float o;
   ...
   public fqr(fqr.a $$0, xv $$1, @Nullable xv $$2, boolean $$3, int $$4) {
      this.i = $$0;
      this.j = $$1;
      this.k = $$2;
      this.p = $$3;
   ...
   public fqr(fqr.a $$0, xv $$1, @Nullable xv $$2, boolean $$3) {
      this($$0, $$1, $$2, $$3, 0);
   }
