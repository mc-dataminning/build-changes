...
public class fqr {
   ...
   private static final Comparator<ghk> p = Comparator.<ghk>comparingInt($$0 -> -$$0.k())
   ...
   private wp t;
   private boolean u;
   private final Map<UUID, fqr.a> v = new Object2ObjectOpenHashMap();

   public fqr(fmg $$0, fpb $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public wp a(ghk $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fcx.a($$0.h(), wp.b($$0.a().getName())));
   }

   private wp a(ghk $$0, xd $$1) {
   ...
   public void a(fpc $$0, int $$1, fdc $$2, @Nullable fcu $$3) {
      List<ghk> $$4 = this.b();
      List<fqr.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               cpr $$44 = this.q.s.a($$43.getId());
               boolean $$45 = $$44 != null && gue.b($$44);
               fqp.a($$0, $$41.g().a(), $$39, $$40, 8, $$41.j(), $$45, -1);
               $$39 += 9;
            }
   ...
   protected void a(fpc $$0, int $$1, int $$2, int $$3, ghk $$4) {
      aku $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(gnh::H, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fcu $$0, int $$1, fqr.b $$2, int $$3, int $$4, UUID $$5, fpc $$6) {
      if ($$0.h() == fdf.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fpc $$4, int $$5) {
      fqr.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fqr.a($$5));
      $$6.a($$5, (long)this.r.e());
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(gnh::H, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(gnh::H, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(gnh::H, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(gnh::H, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(gnh::H, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(gnh::H, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
