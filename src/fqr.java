...
public class fqr implements fij, fjc {
   ...
   private final List<fqr.a> n = Lists.newArrayList();
   private boolean o;
   private int p;
   private int q;
   private ffh r;
   ...
   public void a(ffh $$0, fqw $$1, int $$2, int $$3, int $$4, int $$5, float $$6) {
      this.r = $$0;
      this.s = $$1;
      if ($$0.s.cb instanceof cpx) {
         this.w = true;
      }

      boolean $$7 = $$0.s.m().a((crj<?>)$$0.s.cb);
      List<cyz<?>> $$8 = $$1.b(true);
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         ...
         if (this.w) {
            this.n.add(new fqr.b($$23, $$24, $$22, $$21));
         } else {
            this.n.add(new fqr.a($$23, $$24, $$22, $$21));
         }
      }
   ...
   class a extends fhe implements aks<cyu> {
      final cyz<?> c;
      private final boolean d;
      protected final List<fqr.a.a> a = Lists.newArrayList();
      ...
      public void a(Iterator<cyu> $$0, int $$1, int $$2, int $$3, int $$4) {
         cur[] $$5 = $$0.next().a();
         if ($$5.length != 0) {
            this.a.add(new fqr.a.a(3 + $$4 * 7, 3 + $$3 * 7, $$5));
         }
      }
      ...
      public void b(fgt $$0, int $$1, int $$2, float $$3) {
         ...
         if (this.d) {
            if (fqr.this.w) {
               $$4 = this.A() ? fqr.c : fqr.d;
            } else {
               $$4 = this.A() ? fqr.e : fqr.f;
            }
         } else if (fqr.this.w) {
            $$4 = this.A() ? fqr.g : fqr.h;
         } else {
            $$4 = this.A() ? fqr.i : fqr.j;
         }
         ...
         for (fqr.a.a $$8 : this.a) {
            $$0.c().a();
            $$0.c().a((double)$$8.b, (double)$$8.c, 0.0);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0, -8.0, 0.0);
            if ($$8.a.length > 0) {
               $$0.a($$8.a[ayz.d(fqr.this.v / 30.0F) % $$8.a.length], 0, 0);
            }
      ...
      protected class a {
         ...
         public a(final int $$1, final int $$2, final cur[] $$3) {
            this.b = $$1;
            this.c = $$2;
            this.a = $$3;
         }
   ...
   class b extends fqr.a {
      ...
      protected void a(cyz<?> $$0) {
         cyu $$1 = $$0.b().a().get(0);
         cur[] $$2 = $$1.a();
         this.a.add(new fqr.a.a(10, 10, $$2));
      }
   }
}
