...
public class fqr extends fly {
   ...
   public fqr(fly $$0, ath $$1, Consumer<ath> $$2) {
      super(a);
      this.r = $$0;
      this.s = $$1;
      this.u = $$2;
   ...
   protected void aM_() {
      this.d.a(a, this.p);
      fjq $$0 = this.d.c(fjq.d());
      $$0.a(new fgt(b, this.p).d(310), $$0x -> $$0x.e(15));
      fqv.a $$1 = fqv.a(310).a(2, true).b(4);
      this.v.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.v.getBoolean($$1x), $$1xx -> this.v.put($$1x, $$1xx)).a($$1x.c()));
      $$1.a($$0::a);
      fjq $$2 = this.d.b(fjq.e().a(8));
      $$2.a(ffz.a(ww.d, $$0x -> this.m()).a());
      $$2.a(ffz.a(ww.e, $$0x -> this.d()).a());
      this.d.a($$1x -> {
   ...
   private void m() {
      ...
      this.s.a($$0.stream().map(ate::g).toList());
