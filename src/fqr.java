...
public class fqr {
   ...
   final fmg c;
   private final List<fqr.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fqq> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends fqq> T a(Class<? extends T> $$0, Object $$1) {
      for (fqr.a<?> $$2 : this.d) {
   ...
   class a<T extends fqq> {
      ...
      public void c() {
         ...
         if (this.f == -1L) {
            this.f = $$0;
            this.h.a(fqr.this.c.ak());
         }

         if (this.h == fqq.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(fqr.this, this.i);
         fqq.a $$1 = this.c.a();
         if ($$1 != this.h) {
         ...
         this.k = this.h == fqq.a.b && $$0 - this.f > 600L;
      }

      public void a(fns $$0, int $$1) {
         $$0.c().a();
         $$0.c().a((float)$$1 - (float)this.c.b() * this.j, (float)(this.d * 32), 800.0F);
         this.c.a($$0, fqr.this.c.h, this.i);
         $$0.c().b();
      }
   }
}
