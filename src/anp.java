...
public class anp extends aoa<anp.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public anp(anu $$0, List<ano> $$1, Executor $$2, Executor $$3, CompletableFuture<asx> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new anp.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<anp.a> a(List<anp.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
