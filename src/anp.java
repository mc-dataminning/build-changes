...
public class anp {
   ...
   public static void a(CommandDispatcher<ed> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ee.a("save-all").requires($$0x -> $$0x.c(4)))
               .executes($$0x -> a((ed)$$0x.getSource(), false)))
            .then(ee.a("flush").executes($$0x -> a((ed)$$0x.getSource(), true)))
      );
   }
