...
public class gtu {
   ...
   private int u;
   private long v;
   private final AtomicReference<gtu.a> w = new AtomicReference<>(gtu.a.c);
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(exv::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gtu.a.c, gtu.a.a)) {
               String $$2 = this.n.at().c();
               ac.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gtu.a.a, gtu.a.b);
                     }
                  ...
                  this.w.compareAndSet(gtu.a.a, gtu.a.c);
               });
            }
         }

         return this.w.compareAndSet(gtu.a.b, gtu.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(gsp::s).forEach(this::c);
      this.D.clear();
      ...
      for (gsq $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            evt $$3 = new evt($$0.h(), $$0.i(), $$0.j());
            gtm.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<gsp, gtm.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gsp, gtm.a> $$6 = $$5.next();
         gtm.a $$7 = $$6.getValue();
         gsp $$8 = $$6.getKey();
      ...
      Iterator<Entry<gsp, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gsp, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gsp $$13 = $$12.getKey();
            if ($$13 instanceof gsq) {
               ((gsq)$$13).q();
            }
   ...
   private static boolean d(gsp $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gsp $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gsp $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gsp $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gtx.d) {
                  if ($$3 == gtx.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        evt $$11 = new evt($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != gsp.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<gtm.a> $$16 = this.t.a($$3.g() ? exw.c.b : exw.c.a);
                           gtm.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aX) {
   ...
   private float g(gsp $$0) {
      return ayz.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gsp $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(exv::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(exv::e));
      }
   }
   ...
   public void a(fes $$0) {
      if (this.o && $$0.h()) {
         exy $$1 = new exy($$0.b(), new evt($$0.l()), new evt($$0.m()));
