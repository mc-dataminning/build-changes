...
public class gtu {
   ...
   public static class a extends Thread {
      private final gtu.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gtu.b $$0) throws IOException {
         super("LanServerDetector #" + gtu.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gtu.b));
   ...
   public static class b {
      private final List<gtt> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gtt> a() {
         if (this.b) {
            List<gtt> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
