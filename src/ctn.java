...
public abstract class ctn extends cuh implements bxc {
   private static final akj<Boolean> h = akn.a(ctn.class, akl.k);
   private static final akj<Boolean> i = akn.a(ctn.class, akl.k);
   private static final akj<Integer> j = akn.a(ctn.class, akl.b);
   ...
   private float n;
   private float o;
   private final bwz p = new bwz(this, 3);
   private boolean q;
   private boolean r;
   private boolean s;
   private boolean t;
   ...
   @Nullable
   private bxc.a aH;
   private final Supplier<cyz> aI;

   public ctn(bwo<? extends ctn> $$0, dja $$1, Supplier<cyz> $$2) {
      super($$0, $$1);
      this.aI = $$2;
      this.I = true;
   }
   ...
   public static boolean a(bwf $$0, bwf $$1) {
   ...
   protected abstract double b(bwi var1);
   ...
   protected feq a(bwf $$0, bwi $$1, float $$2) {
      ...
      return new feq(0.0, this.b($$1), (double)$$3).b(-this.dL() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      this.aA = this.az;
      this.az = this.x();
      if (this.az != ctn.a.b && this.az != ctn.a.c) {
         this.n = 0.0F;
      } else {
         this.n++;
      }
      ...
      List<bwf> $$5 = this.dV().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bwm.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dV().C && !(this.cW() instanceof crc);
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aD) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof crc) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   @Override
   public feq cT() {
      return new feq(0.0, (double)(0.88F * this.cS()), (double)(this.dq() * 0.64F));
   }

   @Override
   public void b(bwf $$0, float $$1) {
      feq $$2 = $$0.dt().d(this.dt()).d().c((double)$$1 - 6.0);
      feq $$3 = this.dy();
      boolean $$4 = $$3.b($$2) > 0.0;
   ...
   public float j() {
      fel $$0 = this.cR();
      fel $$1 = new fel($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = azm.a($$1.a) - 1;
      int $$3 = azm.c($$1.d) + 1;
      int $$4 = azm.a($$1.b) - 1;
      int $$5 = azm.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     eah $$16 = this.dV().a_($$11);
                     if (!($$16.b() instanceof dvz) && ffh.c($$16.g(this.dV(), $$11).a($$11), $$8, feu.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
   ...
   private void F() {
      ...
      double $$1 = 0.0;
      float $$2 = 0.05F;
      if (this.aA == ctn.a.e && this.az != ctn.a.e && this.az != ctn.a.d) {
         this.u = this.e(1.0);
         ...
         if (this.az == ctn.a.a) {
            ...
            $$2 = 0.9F;
         } else if (this.az == ctn.a.c) {
            $$0 = -7.0E-4;
            $$2 = 0.9F;
         } else if (this.az == ctn.a.b) {
            $$1 = 0.01F;
            $$2 = 0.45F;
         } else if (this.az == ctn.a.e) {
            $$2 = 0.9F;
         } else if (this.az == ctn.a.d) {
            $$2 = this.ay;
            if (this.cW() instanceof crc) {
               this.ay /= 2.0F;
            }
         }
   ...
   protected void a(bwf $$0, bwf.b $$1) {
      ...
      if (!$$0.aq().a(axf.s)) {
         ...
         $$0.r($$0.cA() + this.o);
         this.c($$0);
         if ($$0 instanceof ciu && this.cY().size() == this.n()) {
            int $$2 = $$0.ar() % 2 == 0 ? 90 : 270;
            $$0.s(((ciu)$$0).aV + (float)$$2);
            $$0.r($$0.cA() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public feq b(bxe $$0) {
      feq $$1 = a((double)(this.dq() * azm.g), (double)$$0.dq(), $$0.dL());
      double $$2 = this.dA() + $$1.d;
      double $$3 = this.dG() + $$1.f;
      iu $$4 = iu.a($$2, this.cR().e, $$3);
      iu $$5 = $$4.e();
      if (!this.dV().A($$5)) {
         List<feq> $$6 = Lists.newArrayList();
         double $$7 = this.dV().j($$4);
         if (ctv.a($$7)) {
            $$6.add(new feq($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dV().j($$5);
         if (ctv.a($$8)) {
            $$6.add(new feq($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fO().iterator();

         while (var14.hasNext()) {
            bxq $$9 = (bxq)var14.next();

            for (feq $$10 : $$6) {
               if (ctv.a(this.dV(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   public bud a(crc $$0, buc $$1) {
      ...
      if ($$2 != bud.e) {
         ...
         return (bud)($$0.fY() || !(this.n < 60.0F) || !this.dV().C && !$$0.n(this) ? bud.e : bud.a);
      }
   }
   ...
   @Override
   public bxe cW() {
      return this.cZ() instanceof bxe $$0 ? $$0 : super.cW();
   }
   ...
   @Override
   public boolean bn() {
      return this.az == ctn.a.b || this.az == ctn.a.c;
   }

   @Override
   protected final cyz o() {
      return this.aI.get();
   }

   @Override
   public final czd dI() {
      return new czd(this.aI.get());
   }
