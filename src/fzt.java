...
public class fzt extends fzq {
   private static final alr a = alr.b("textures/misc/credits_vignette.png");
   private static final Logger b = LogUtils.getLogger();
   private static final xg c = xg.b("============").a(o.p);
   private static final String d = "           ";
   private static final String s = "" + o.p + o.q + o.k + o.l;
   private static final float u = 5.0F;
   private static final float v = 15.0F;
   private static final alr w = alr.b("texts/end.txt");
   private static final alr x = alr.b("texts/credits.json");
   private static final alr y = alr.b("texts/postcredits.txt");
   ...
   private int J;
   private final fup K = new fup(false);

   public fzt(boolean $$0, Runnable $$1) {
      super(fqh.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : azo.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(xg.b($$4).a(o.o), true);
         this.a(c, true);
         this.F();
         this.F();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(xg.b($$12).a(o.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(xg.b("           ").f($$15).a(o.p), false);
               }
   ...
   private void a(String $$0) {
      this.C.addAll(this.m.h.c(xg.b($$0), 256));
   }

   private void a(xg $$0, boolean $$1) {
      if ($$1) {
   ...
   private void c(ftk $$0) {
      $$0.a(gry::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
