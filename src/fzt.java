...
public class fzt extends ath<fzt.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final ajt b = new ajt("gpu_warnlist.json");
   ...
   protected fzt.a a(atc $$0, bko $$1) {
      ...
      $$1.b();
      return new fzt.a($$2, $$3, $$4);
   }

   protected void a(fzt.a $$0, atc $$1, bko $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(atc $$0, bko $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, evb.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, evb.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, evb.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
