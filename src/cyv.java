...
public record cyv(float d, cwr e, jr<avz> f, boolean g, List<dab> h) {
   ...
   public static final Codec<cyv> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               cwr.k.optionalFieldOf("animation", cwr.b).forGetter(cyv::d),
   ...
   public static final ym<vz, cyv> c = ym.a(yk.l, cyv::c, cwr.l, cyv::d, avz.d, cyv::e, yk.b, cyv::f, dab.e.a(yk.a()), cyv::g, cyv::new);

   public bsj a(bvg $$0, cwp $$1, bsi $$2) {
      if (!this.a($$0, $$1)) {
         return bsj.d;
      } else {
         boolean $$3 = this.a() > 0;
         if ($$3) {
            ...
            cwp $$4 = this.a($$0.dW(), $$0, $$1);
            return bsj.c.a($$4);
         }
      }
   }

   public cwp a(dgi $$0, bvg $$1, cwp $$2) {
      azh $$3 = $$1.dZ();
      this.a($$3, $$1, $$2, 16);
   ...
   public void a(azh $$0, bvg $$1, cwp $$2, int $$3) {
