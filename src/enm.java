...
public abstract class enm<M extends eng<M>, S extends enj<M>> implements eni {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = enm.a.a(1);
   private static final int g = 512;
   protected static final je[] d = je.values();
   protected final dul e;
   protected final S f;
   ...
   private final iz.a k = new iz.a();
   private static final int l = 2;
   private final long[] m = new long[2];
   private final duk[] n = new duk[2];

   protected enm(dul $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(dbe $$0, iz $$1, dsc $$2, dsc $$3) {
      return $$3 == $$2 ? false : $$3.b($$0, $$1) != $$2.b($$0, $$1) || $$3.h() != $$2.h() || $$3.g() || $$2.g();
   }

   public static int a(dbe $$0, dsc $$1, iz $$2, dsc $$3, iz $$4, je $$5, int $$6) {
      boolean $$7 = a($$1);
      boolean $$8 = a($$3);
      if ($$7 && $$8) {
         return $$6;
      } else {
         ewk $$9 = $$7 ? ewh.a() : $$1.c($$0, $$2);
         ewk $$10 = $$8 ? ewh.a() : $$3.c($$0, $$4);
         return ewh.b($$9, $$10, $$5) ? 16 : $$6;
      }
   }

   public static ewk a(dbe $$0, iz $$1, dsc $$2, je $$3) {
      return a($$2) ? ewh.a() : $$2.a($$0, $$1, $$3);
   }
   ...
   protected dsc c(iz $$0) {
      int $$1 = kb.a($$0.u());
      int $$2 = kb.a($$0.w());
      duk $$3 = this.a($$1, $$2);
      return $$3 == null ? dfb.F.o() : $$3.a_($$0);
   }

   protected int a(dsc $$0, iz $$1) {
      return Math.max(1, $$0.b(this.e.q(), $$1));
   }

   protected boolean a(long $$0, dsc $$1, long $$2, dsc $$3, je $$4) {
      ewk $$5 = this.a($$1, $$0, $$4);
      ewk $$6 = this.a($$3, $$2, $$4.g());
      return ewh.b($$5, $$6);
   }

   protected ewk a(dsc $$0, long $$1, je $$2) {
      return a(this.e.q(), this.k.f($$1), $$0, $$2);
   }

   @Nullable
   protected duk a(int $$0, int $$1) {
      long $$2 = dbf.c($$0, $$1);
   ...
   public void a(long $$0, @Nullable dud $$1) {
      this.f.a($$0, $$1);
   }

   public void b(dbf $$0, boolean $$1) {
      this.f.c(kb.b($$0.e, $$0.f), $$1);
   }
   ...
   public static class a {
      ...
      public static long a(int $$0, je $$1) {
         long $$2 = c(1008L, $$1);
         return a($$2, $$0);
      }
      ...
      public static long a(int $$0, boolean $$1, je $$2) {
         long $$3 = c(1008L, $$2);
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static long b(int $$0, boolean $$1, je $$2) {
         long $$3 = 0L;
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static boolean a(long $$0, je $$1) {
      ...
      private static long b(long $$0, je $$1) {
         return $$0 | 1L << $$1.ordinal() + 4;
      }

      private static long c(long $$0, je $$1) {
         return $$0 & ~(1L << $$1.ordinal() + 4);
      }
   }
}
