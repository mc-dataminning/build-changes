...
public class enm {
   ...
   static class a implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
         return $$0.c[jj.f.d()] && !$$0.b[jj.f.d()].d;
      }

      @Override
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         $$1.d = true;
         $$1.b[jj.f.d()].d = true;
         return new enm.k($$0, $$1);
      }
   }

   static class b implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         ...
         return new enm.l($$0, $$1);
      }
   }

   static class c implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         $$1.d = true;
         $$1.b[jj.b.d()].d = true;
         return new enm.m($$0, $$1);
      }
   }

   static class d implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         ...
         return new enm.n($$0, $$1);
      }
   }

   static class e implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         ...
         $$3.d = true;
         $$3.b[jj.c.d()].d = true;
         return new enm.o($$0, $$3);
      }
   }

   static class f implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
         return true;
      }
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         $$1.d = true;
         return new enm.s($$0, $$1, $$2);
      }
   }

   static class g implements enm.i {
      @Override
      public boolean a(enm.v $$0) {
      ...
      public enm.r a(jj $$0, enm.v $$1, azl $$2) {
         $$1.d = true;
         return new enm.t($$0, $$1);
      }
   }

   public static class h extends enm.r {
      ...
      private enm.v G;
      private enm.v H;
      private final List<enm.r> I = Lists.newArrayList();

      public h(azl $$0, int $$1, int $$2, jj $$3) {
         super(elt.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<enm.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new enm.p($$3, this.G));
         this.I.add(new enm.j($$3, this.H));
         List<enm.i> $$5 = Lists.newArrayList();
         $$5.add(new enm.b());
         $$5.add(new enm.d());
         $$5.add(new enm.e());
         $$5.add(new enm.a());
         ...
         eku $$10 = eku.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eku $$11 = eku.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eku $$12 = eku.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new enm.u($$3, $$10, $$13++));
         this.I.add(new enm.u($$3, $$11, $$13++));
         this.I.add(new enm.q($$3, $$12));
      }
      ...
      private List<enm.v> b(azl $$0) {
         enm.v[] $$1 = new enm.v[75];
         ...
         enm.v $$23 = new enm.v(1003);
         enm.v $$24 = new enm.v(1001);
         enm.v $$25 = new enm.v(1002);
         $$1[v].a(jj.b, $$23);
         $$1[w].a(jj.d, $$24);
         $$1[x].a(jj.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<enm.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dfd $$2, azl $$3, eku $$4) {
         int $$5 = 24;
      ...
      private void a(dfd $$0, azl $$1, eku $$2) {
      ...
      private void b(dfd $$0, azl $$1, eku $$2) {
      ...
      private void c(dfd $$0, azl $$1, eku $$2) {
      ...
      private void d(dfd $$0, azl $$1, eku $$2) {
      ...
      private void e(dfd $$0, azl $$1, eku $$2) {
      ...
      private void f(dfd $$0, azl $$1, eku $$2) {
   ...
   interface i {
      boolean a(enm.v var1);

      enm.r a(jj var1, enm.v var2, azl var3);
   }

   public static class j extends enm.r {
      public j(jj $$0, enm.v $$1) {
         super(elt.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dfd $$0, dfb $$1, dwl $$2, azl $$3, eku $$4, ddm $$5, je $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dhl.ch.o(), dhl.ch.o(), false);
   ...
   public static class k extends enm.r {
      public k(jj $$0, enm.v $$1) {
         super(elt.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends enm.r {
      public l(jj $$0, enm.v $$1) {
         super(elt.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends enm.r {
      public m(jj $$0, enm.v $$1) {
         super(elt.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends enm.r {
      public n(jj $$0, enm.v $$1) {
         super(elt.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends enm.r {
      public o(jj $$0, enm.v $$1) {
         super(elt.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends enm.r {
      public p(jj $$0, enm.v $$1) {
         super(elt.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends enm.r {
      public q(jj $$0, eku $$1) {
         super(elt.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends elg {
      protected static final duo b = dhl.hZ.o();
      protected static final duo c = dhl.ia.o();
      protected static final duo d = dhl.ib.o();
      protected static final duo h = c;
      protected static final duo i = dhl.ii.o();
      protected static final boolean j = true;
      protected static final duo k = dhl.G.o();
      protected static final Set<dhj> l = ImmutableSet.builder().add(dhl.dO).add(dhl.iC).add(dhl.mW).add(k.b()).build();
      ...
      public r(elt $$0, jj $$1, int $$2, eku $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(elt $$0, int $$1, jj $$2, enm.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eku a(jj $$0, enm.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eku $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dfd $$0, eku $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  duo $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dfd $$0, eku $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dfd $$0, eku $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, duo $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eku $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dfd $$0, eku $$1, int $$2, int $$3, int $$4) {
         je $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            ckp $$6 = btv.D.a($$0.E(), btu.d);
            if ($$6 != null) {
               $$6.c($$6.eQ());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.ds()), btu.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends enm.r {
      private int a;

      public s(jj $$0, enm.v $$1, azl $$2) {
         super(elt.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends enm.r {
      public t(jj $$0, enm.v $$1) {
         super(elt.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends enm.r {
      private int a;

      public u(jj $$0, eku $$1, int $$2) {
         super(elt.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
