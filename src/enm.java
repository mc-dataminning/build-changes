...
public class enm extends enn {
   ...
   private enm(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   public static enm a(String $$0) {
      try {
         ...
         String $$3 = epk.a("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = epk.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = epk.a("worldClosed", $$2, false);
               String $$7 = epk.a("token", $$2, null);
               return new enm($$6, $$7, $$5);
            }
         }
