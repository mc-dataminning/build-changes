...
public abstract class enm {
   ...
   public static final Codec<jr<enm>> b = akq.a(mc.aU, a);
   ...
   public enu a(jr<enm> $$0, akt<dgi> $$1, kf $$2, dyt $$3, dho $$4, edg $$5, erp $$6, long $$7, dfo $$8, int $$9, dgk $$10, Predicate<jr<dhk>> $$11) {
   ...
   public static record c(jv<dhk> b, Map<bvj, ent> c, eco.a d, enx e) {
      ...
      public static final MapCodec<enm.c> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  ...
                  Codec.simpleMap(bvj.i, ent.a, azv.a(bvj.values())).fieldOf("spawn_overrides").forGetter(enm.c::b),
      ...
      public static class a {
         ...
         private Map<bvj, ent> b = enm.c.f.c;
         ...
         public enm.c.a a(Map<bvj, ent> $$0) {
            this.b = $$0;
            return this;
         }
