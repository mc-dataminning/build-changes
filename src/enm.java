...
public final class enm extends enk<enn.a, enn> {
   private static final long g = enk.a.a(15);
   private static final long h = enk.a.a(15, je.b);
   private static final long i = enk.a.a(15, false, je.b);
   ...
   private int a(int $$0, int $$1, int $$2) {
      end $$3 = this.b(kb.a($$0), kb.a($$1));
      return $$3 == null ? $$2 : $$3.a(kb.b($$0), kb.b($$1));
   }

   @Nullable
   private end b(int $$0, int $$1) {
      dui $$2 = this.e.c($$0, $$1);
         ...
         if (enk.a.a($$1, $$5)) {
            ...
            if (this.f.b(kb.e($$6))) {
               ...
               if ($$8 > $$7) {
                  ...
                  if ($$10 > $$7) {
                     if ($$3 == null) {
                        $$3 = enk.a.b($$1) ? dez.a.o() : this.c(this.j.f($$0));
                     }

                     if (!this.a($$0, $$3, $$6, $$9, $$5)) {
                        this.f.a($$6, $$10);
                        if ($$10 > 1) {
                           this.c($$6, enk.a.a($$10, a($$9), $$5.g()));
                        }
         ...
         if (enk.a.a($$1, $$4)) {
            ...
            if (this.f.b(kb.e($$5))) {
               ...
               if ($$6 != 0) {
                  if ($$6 <= $$3 - 1) {
                     this.f.a($$5, 0);
                     this.b($$5, enk.a.a($$6, $$4.g()));
                     this.a($$5, $$4, $$6, false, $$2);
                  } else {
                     this.c($$5, enk.a.b($$6, false, $$4.g()));
                  }
               }
            }
         }
               ...
               if (!this.f.b(kb.b($$8, $$10, $$9))) {
                  ...
                  for (int $$13 = 15; $$13 >= 0; $$13--) {
                     ...
                     if ($$3) {
                        this.f.a($$14, $$2);
                        if ($$2 > 1) {
                           this.c($$14, enk.a.a($$2, true, $$1.g()));
                        }
                     } else {
                        this.f.a($$14, 0);
                        this.b($$14, enk.a.a($$2, $$1.g()));
                     }
                  }
   ...
   public void a(dbd $$0, boolean $$1) {
      super.a($$0, $$1);
      if ($$1) {
         end $$2 = Objects.requireNonNullElse(this.b($$0.e, $$0.f), this.k);
         int $$3 = $$2.a() - 1;
         int $$4 = kb.a($$3) + 1;
         long $$5 = kb.b($$0.e, $$0.f);
         int $$6 = this.f.m($$5);
   ...
   public void b(dbd $$0) {
      ...
      end $$3 = Objects.requireNonNullElse(this.b($$0.e, $$0.f - 1), this.k);
      end $$4 = Objects.requireNonNullElse(this.b($$0.e, $$0.f + 1), this.k);
      end $$5 = Objects.requireNonNullElse(this.b($$0.e - 1, $$0.f), this.k);
      end $$6 = Objects.requireNonNullElse(this.b($$0.e + 1, $$0.f), this.k);
      int $$7 = this.f.m($$1);
      int $$8 = this.f.c();
      int $$9 = kb.c($$0.e);
      int $$10 = kb.c($$0.f);
                  ...
                  if ($$19 <= $$15) {
                     ...
                     for (int $$25 = $$15; $$25 >= Math.max($$14, $$19); $$25--) {
                        ...
                        if ($$25 == $$19 || $$25 < $$24) {
                           ...
                           this.c($$26, enk.a.a($$25 == $$19, $$25 < $$20, $$25 < $$21, $$25 < $$22, $$25 < $$23));
                        }
                     }
