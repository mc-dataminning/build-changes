...
public class cf extends cx<cf.a> {
   ...
   public void a(aox $$0, bnq $$1, bmp $$2) {
      ejc $$3 = br.b($$0, $$1);
   ...
   public static record a(Optional<bc> b, Optional<bc> c, Optional<bg> d) implements cx.a {
      public static final Codec<cf.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(avq.a(br.b, "player").forGetter(cf.a::a), avq.a(br.b, "entity").forGetter(cf.a::e), avq.a(bg.a, "killing_blow").forGetter(cf.a::f))
               .apply($$0, cf.a::new)
      );
      ...
      public boolean a(aox $$0, ejc $$1, bmp $$2) {
