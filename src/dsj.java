...
public class dsj {
   ...
   private final Map<Character, Predicate<dsh>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsj a(char $$0, Predicate<dsh> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dsi b() {
      return new dsi(this.c());
   }

   private Predicate<dsh>[][][] c() {
      this.d();
      Predicate<dsh>[][][] $$0 = (Predicate<dsh>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsh>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
