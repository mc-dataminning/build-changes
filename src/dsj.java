...
@Deprecated
public class dsj extends dru<dsj.a> {
   private static final djh a = cws.nc.o();

   public dsj(Codec<dsj.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(drw<dsj.a> $$0) {
      hx $$1 = $$0.e();
      cuk $$2 = $$0.b();
      auv $$3 = $$0.d();
      dsj.a $$4 = $$0.f();
   ...
   public static record a(dvz b, dvz c) implements dty {
      public static final Codec<dsj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dvz.a.fieldOf("fluid").forGetter(dsj.a::a), dvz.a.fieldOf("barrier").forGetter(dsj.a::b)).apply($$0, dsj.a::new)
      );
