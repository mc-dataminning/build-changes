...
public class dsj extends djm {
   ...
   private void a(dgi $$0, dwx $$1, ji $$2, bul $$3, int $$4) {
      if ($$1.a(djo.mH) && $$0 instanceof ard $$5 && this.a($$5, $$3) && $$0.A.a($$4) == 0) {
         this.a($$5, $$2, $$1);
      }
   }
   ...
   private boolean a(ard $$0, bul $$1) {
      if ($$1 instanceof chz || $$1 instanceof cgs) {
         return false;
      } else {
         return !($$1 instanceof bvh) ? false : $$1 instanceof cox || $$0.O().b(dge.c);
      }
   }
}
