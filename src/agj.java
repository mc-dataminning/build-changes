...
public final class agj<E> implements Codec<ig<E>> {
   private final agl<? extends is<E>> a;

   public static <E> agj<E> a(agl<? extends is<E>> $$0) {
      return new agj<>($$0);
   }

   private agj(agl<? extends is<E>> $$0) {
      this.a = $$0;
   }
