...
public abstract class fgf extends ffe {
   private final dkc b;
   private dkd c;
   ...
   public fgf(dkc $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, vq.c("sign.edit"));
   }

   public fgf(dkc $$0, boolean $$1, boolean $$2, vq $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
   ...
   @Override
   protected void aQ_() {
      this.d(ezh.a(vp.d, $$0 -> this.H()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new fca(() -> this.k[this.n], this::a, fca.a(this.f), fca.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   protected abstract void a(eyu var1, dlf var2);
