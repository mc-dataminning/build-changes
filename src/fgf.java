...
public class fgf {
   ...
   public void a(fhy $$0, String $$1, fiv.a $$2, evd $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fgf.b $$13 = new fgf.b($$1.trim(), this.f, $$3, $$2);
                  fgf.a $$14 = new fgf.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fgf.c $$30 = new fgf.c(this.f, $$2, $$0);
                        fgf.a $$31 = new fgf.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fic(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, evd $$2) throws IOException {
      ...
      File $$15 = new File(flh.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final evd d;
      private final fiv.a e;

      b(final String $$0, final File $$1, final evd $$2, final fiv.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fgf.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fgf.this.b && !fgf.this.d) {
            try {
               fgf.this.e = true;
               fgf.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fgf.a.error("Error extracting archive", var3);
               fgf.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fiv.a c;
      private final fhy d;

      c(final File $$0, final fiv.a $$1, final fhy $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fgf.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fgf.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fgf.this.g);
                  fgf.this.c = true;
               } else {
                  fgf.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fgf.this.d = true;
               }
            } catch (IOException var3) {
               fgf.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fgf.this.d = true;
            }
         }
      }
