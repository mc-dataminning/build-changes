...
public class fgf {
   ...
   private fgf(String $$0, @Nullable String[] $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public xl a() {
      if (!haa.a(this.c)) {
         ...
         return this.d == null ? xl.c(this.c) : xl.a(this.c, this.d);
      }
   }

   public static fgf a(JsonObject $$0) {
      String $$1 = fik.a("translationKey", $$0);
