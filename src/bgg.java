...
public class bgg extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bgr.y);
      Type<?> $$1 = this.getOutputSchema().getType(bgr.y);
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         ...
         ub $$4 = a($$1.substring($$2));
         if ($$4 != null) {
            $$3 = $$3.set("tag", new Dynamic(up.a, $$4).convert($$0.getOps()));
         }
      }
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bid.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bid.a($$1.substring(0, $$2))));
   ...
   private <T> Dynamic<T> g(Dynamic<T> $$0, String $$1) {
      try {
         ...
         $$2.expect(' ');
         int $$6 = $$2.readInt();
         Dynamic<T> $$7 = $$0.createIntList(IntStream.of(ayo.d($$3), ayo.d($$4), ayo.d($$5)));
