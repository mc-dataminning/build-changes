public class aqv extends arg {
   ...
   public void a() {
      ...
      if ($$0 % 24000L == 500L) {
         if ($$1 <= 6L) {
            if ($$1 == 6L) {
               this.d.c.b(new ado(ado.g, 104.0F));
            } else {
         ...
         if ($$0 == 100L) {
            this.d.c.b(new ado(ado.g, 101.0F));
         } else if ($$0 == 175L) {
            this.d.c.b(new ado(ado.g, 102.0F));
         } else if ($$0 == 250L) {
            this.d.c.b(new ado(ado.g, 103.0F));
         }
