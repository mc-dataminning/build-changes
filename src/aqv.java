...
public class aqv<K> implements hj<K> {
   ...
   private aqv(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> aqv<A> c(int $$0) {
      return new aqv((int)((float)$$0 / 0.8F));
   }
   ...
   private int d(@Nullable K $$0) {
      return (arw.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public aqv<K> c() {
      return new aqv<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
