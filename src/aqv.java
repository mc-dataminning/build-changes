...
class aqv implements Path {
   private static final BasicFileAttributes a = new aqt() {
      @Override
   ...
   private static final BasicFileAttributes b = new aqt() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aqv> c = Comparator.comparing(aqv::n);
   ...
   public aqv(aqx $$0, String $$1, @Nullable aqv $$2, aqy $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aqv a(@Nullable aqv $$0, String $$1) {
      return new aqv(this.e, $$1, $$0, aqy.b);
   }
   ...
   aqv a(String $$0) {
      if (a(this.i)) {
         return new aqv(this.e, $$0, this, this.i);
      } else if (this.i instanceof aqy.a $$1) {
         aqv $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aqv(this.e, $$0, this, aqy.a);
      } else if (this.i instanceof aqy.b) {
         return new aqv(this.e, $$0, this, aqy.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aqy $$0) {
      return $$0 == aqy.a || $$0 == aqy.b;
   }
   ...
   private aqv c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aqv $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aqy.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aqy.a i() {
      return this.i instanceof aqy.a $$0 ? $$0 : null;
   }
