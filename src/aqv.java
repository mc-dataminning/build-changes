...
public class aqv extends aqu {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aqv.a> s;
   private final aqq t;
   private long u;
   private final ahj v;

   private aqv(ahj $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aqr.c($$2, 7, $$0.getLength());
      }
   }
