...
public class few {
   ...
   public void a(ffg $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == ffg.a) {
            fjl.b($$1, fjl.a.a, xo.c("narrator.toast.disabled"), null);
         } else {
            fjl.b($$1, fjl.a.a, xo.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fjl.b($$1, fjl.a.a, xo.c("narrator.toast.disabled"), xo.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new few.a("Narrator library is not active");
      }
   }
