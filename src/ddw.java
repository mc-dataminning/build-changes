...
public class ddw {
   ...
   private final ddw.a e;
   private final long f;

   public ddw(ddw.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public ddw a(ddw.a $$0) {
      return new ddw($$0, this.f);
   }

   public jm<ddu> a(jd $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jm<ddu> a(double $$0, double $$1, double $$2) {
      int $$3 = jx.a(ayn.a($$0));
      int $$4 = jx.a(ayn.a($$1));
      int $$5 = jx.a(ayn.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ayi.a($$7, $$0);
      double $$10 = b($$7);
      return ayn.k($$6 + $$10) + ayn.k($$5 + $$9) + ayn.k($$4 + $$8);
   }
   ...
   public interface a {
      jm<ddu> getNoiseBiome(int var1, int var2, int var3);
   }
}
