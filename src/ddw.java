...
public class ddw extends dcv implements bgp, bhb {
   ...
   public int i() {
      ...
      return arw.d($$0 * 14.0F) + (this.f() ? 1 : 0);
   }

   private cjf b(cjf $$0, @Nullable cbu $$1) {
      if (this.o instanceof akq && $$0.a(cji.th)) {
         clb.a($$0, this.a($$1), $$1);
      }
   ...
   private dt a(@Nullable cbu $$0) {
      ...
      ehn $$5 = ehn.b(this.p);
      return new dt(ds.a, $$5, ehm.a, (akq)this.o, 2, $$1, $$2, this.o.n(), $$0);
   }
   ...
   public void a(qw $$0) {
      ...
      this.i = clb.k(this.g);
      this.h = arw.a($$0.h("Page"), 0, this.i - 1);
   }
