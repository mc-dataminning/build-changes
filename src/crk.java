...
public class crk extends bwd implements bya {
   ...
   public crk(bwm<? extends crk> $$0, div $$1) {
      super($$0, $$1);
   }

   public crk(div $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bxc $$6) {
      this(bwm.T, $$0);
      this.d = $$5;
      this.a($$6);
   ...
   public void h() {
      ...
      if (this.dV().C) {
         ...
         if (this.d == -8) {
            for (bxc $$8 : this.dV().a(bxc.class, this.cR().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.g = true;
         if (!this.bb()) {
            this.dV().a(this.dA(), this.dC(), this.dG(), awn.iX, this.dm(), 1.0F, this.ae.i() * 0.2F + 0.85F, false);
         }
      }
   }
