...
public class crk extends cqw {
   ...
   public crk(bur<? extends crk> $$0, dgi $$1) {
      super($$0, $$1);
   }
   ...
   protected void a(@Nullable bta $$0, double $$1) {
      if (this.dW() instanceof arc $$2) {
         double $$3 = Math.min(Math.sqrt($$1), 5.0);
         $$2.a(this, $$0, null, this.dB(), this.dD(), this.dH(), (float)((double)this.l + (double)this.m * this.ae.j() * 1.5 * $$3), false, dgi.a.d);
         this.at();
      }
   }
   ...
   public void v() {
      ...
      if (!this.dW().C) {
         ...
         if (!this.bb()) {
            this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.An, awb.e, 1.0F, 1.0F);
         }
      }
   }
   ...
   public float a(dga $$0, dfn $$1, ji $$2, dwx $$3, esz $$4, float $$5) {
      return !this.B() || !$$3.a(awp.P) && !$$1.a_($$2.d()).a(awp.P) ? super.a($$0, $$1, $$2, $$3, $$4, $$5) : 0.0F;
   }

   @Override
   public boolean a(dga $$0, dfn $$1, ji $$2, dwx $$3, float $$4) {
      return !this.B() || !$$3.a(awp.P) && !$$1.a_($$2.d()).a(awp.P) ? super.a($$0, $$1, $$2, $$3, $$4) : false;
   }
