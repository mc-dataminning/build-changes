...
public class crk {
   ...
   private int g = azz.b(bai.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ka.a.fieldOf("uuid").forGetter(Pair::getFirst), azg.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bxe> j;
   @VisibleForTesting
   protected final ArrayList<bxe> c;
   private final crk.a k;
   @VisibleForTesting
   protected final Object2IntMap<bxe> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<crk> a(Predicate<bxe> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(crk::b)).apply($$1, $$1x -> new crk($$0, $$1x))
      );
   }

   public crk(Predicate<bxe> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new crk.a(this);
   ...
   public void a(asb $$0, Predicate<bxe> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bxe>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bxe> $$6 = (Entry<bxe>)$$5.next();
         int $$7 = $$6.getIntValue();
         bxe $$8 = (bxe)$$6.getKey();
         bxe.d $$9 = $$8.dR();
   ...
   public int b(@Nullable bxe $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<byf> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof byf).map($$0 -> (byf)$$0);
   }

   @VisibleForTesting
   protected static record a(crk a) implements Comparator<bxe> {
      public int a(bxe $$0, bxe $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof csi;
               boolean $$7 = $$1 instanceof csi;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
