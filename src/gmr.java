...
public class gmr {
   ...
   public final Map<jm, gms> c;
   public final gmt d;
   public final boolean e;
   public final int f;

   public gmr(Vector3f $$0, Vector3f $$1, Map<jm, gms> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gmr(Vector3f $$0, Vector3f $$1, Map<jm, gms> $$2, @Nullable gmt $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gms> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gmr> {
      ...
      public gmr a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !azu.c($$3, "shade")) {
            ...
            return new gmr($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gmt a(JsonObject $$0) {
         gmt $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jm, gms> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gms> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gms> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gms> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = azu.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gms)$$0.deserialize($$4.getValue(), gms.class));
         }
