...
public class gmr {
   private static final gnh a = gnh.u(aku.b("textures/map/map_background.png"));
   private static final gnh b = gnh.u(aku.b("textures/map/map_background_checkerboard.png"));
   ...
   private final hfa av = new hfa();
   private cxh aw = cxh.k;
   private cxh ax = cxh.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gtb aC;
   private final gub aD;
   private final hcl aE;

   public gmr(fmg $$0, gtb $$1, gub $$2, hcl $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bvy $$0, cxh $$1, cxf $$2, boolean $$3, fgr $$4, gmx $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dU(), $$6, hfh.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fgr $$0, gmx $$1, int $$2, bvr $$3) {
      gyk $$4 = (gyk)this.aC.<gls>a(this.au.t);
      $$0.a();
      ...
      aku $$6 = this.au.t.c().a();
      if ($$3 == bvr.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cps.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cps.c));
      }

      $$0.b();
   }

   private void a(fgr $$0, gmx $$1, int $$2, float $$3, bvr $$4, float $$5, cxh $$6) {
   ...
   private void a(fgr $$0, gmx $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayz.c($$5);
   ...
   private void a(fgr $$0, gmx $$1, int $$2, cxh $$3) {
      ...
      evo $$4 = $$3.a(kv.M);
      evq $$5 = cxu.a($$4, this.au.s);
      fgv $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fgr $$0, gmx $$1, int $$2, float $$3, float $$4, bvr $$5) {
      boolean $$6 = $$5 != bvr.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayz.c($$4);
      ...
      gyk $$15 = (gyk)this.aC.<gls>a($$14);
      aku $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cps.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cps.c));
      }
   }

   private void a(fgr $$0, float $$1, bvr $$2, cxh $$3, cpr $$4) {
      float $$5 = (float)$$4.fE() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bvy)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fgr $$0, float $$1, bvr $$2, cxh $$3, cpr $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fgr $$0, bvr $$1, float $$2) {
      int $$3 = $$1 == bvr.b ? 1 : -1;
   ...
   private void b(fgr $$0, bvr $$1, float $$2) {
      int $$3 = $$1 == bvr.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fgr $$1, gmx.a $$2, glv $$3, int $$4) {
      float $$5 = $$3.E($$0);
      bsx $$6 = (bsx)MoreObjects.firstNonNull($$3.aJ, bsx.a);
      float $$7 = $$3.k($$0);
      gmr.a $$8 = a($$3);
      float $$9 = ayz.h($$0, $$3.cu, $$3.cs);
      float $$10 = ayz.h($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.i($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.j($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bsx.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ayz.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, bsx.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bsx.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ayz.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, bsx.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gmr.a a(glv $$0) {
      cxh $$1 = $$0.eZ();
      cxh $$2 = $$0.fa();
      boolean $$3 = $$1.a(cxl.pc) || $$2.a(cxl.pc);
      boolean $$4 = $$1.a(cxl.wX) || $$2.a(cxl.wX);
      if (!$$3 && !$$4) {
         return gmr.a.a;
      } else if ($$0.fB()) {
         return b($$0);
      } else {
         return a($$1) ? gmr.a.b : gmr.a.a;
      }
   }

   private static gmr.a b(glv $$0) {
      cxh $$1 = $$0.fD();
      bsx $$2 = $$0.fC();
      if (!$$1.a(cxl.pc) && !$$1.a(cxl.wX)) {
         return $$2 == bsx.a && a($$0.fa()) ? gmr.a.b : gmr.a.a;
      } else {
         return gmr.a.a($$2);
      }
   }
   ...
   private static boolean a(cxh $$0) {
      return $$0.a(cxl.wX) && cvz.g($$0);
   }

   private void a(gls $$0, float $$1, float $$2, bsx $$3, float $$4, cxh $$5, float $$6, fgr $$7, gmx $$8, int $$9) {
      if (!$$0.gJ()) {
         boolean $$10 = $$3 == bsx.a;
         bvr $$11 = $$10 ? $$0.fA() : $$0.fA().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.co()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fB() && $$0.fE() > 0 && $$0.fC() == $$3) {
               ...
               float $$15 = (float)$$5.a((bvy)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cvz.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? cxf.e : cxf.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bvr.b;
            int $$21 = $$20 ? 1 : -1;
            if ($$0.fB() && $$0.fE() > 0 && $$0.fC() == $$3) {
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$22 = (float)$$5.a((bvy)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
                     float $$23 = $$22 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$21 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$21 * -9.785F));
                     float $$27 = (float)$$5.a((bvy)$$0) - ((float)$$0.fE() - $$1 + 1.0F);
                     float $$28 = $$27 / 10.0F;
                     if ($$28 > 1.0F) {
                        $$28 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$20 ? cxf.e : cxf.d, !$$20, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, fgr $$2, int $$3, bvr $$4) {
   ...
   private boolean a(cxh $$0, cxh $$1) {
      return cxh.a($$0, $$1) ? true : !this.aE.a($$1);
   }
