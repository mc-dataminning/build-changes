...
public class ebk {
   ...
   public Optional<l.a> a(gw $$0, boolean $$1, dhc $$2) {
      buh $$3 = this.n.w();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<bui> $$5 = $$3.b($$0x -> $$0x.a(bul.r), $$0, $$4, buh.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<bui>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dgb.H))
         .findFirst();
      return $$5.map($$0x -> {
         gw $$1x = $$0x.f();
         this.n.k().a(akx.f, new cpe($$1x), 3, $$1x);
         dfl $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dgb.H), 21, hc.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(gw $$0, hc.a $$1) {
      ...
      for (gw.a $$10 : gw.a($$0, 16, hc.f, hc.d)) {
         int $$11 = Math.min($$8, this.n.a(dku.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new gw($$0.u(), ary.a($$0.v(), $$17, $$18), $$0.w()).i();
         hc $$19 = $$2.h();
         if (!$$7.a($$4)) {
            return Optional.empty();
         }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, csy.co.n(), 3);
            }
         }
      }

      dfl $$26 = csy.ee.n().a(cxz.a, $$1);
