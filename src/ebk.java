...
public class ebk extends eay<edj> {
      ...
      if (!$$3.a_($$1).a(dfb.dP)) {
            ...
            for (int $$9 = -$$8; $$9 <= $$8; $$9++) {
               ...
               for (int $$11 = -$$8; $$11 <= $$8; $$11++) {
                  ...
                  if (($$9 == 0 && $$11 == 0 || !($$10 * $$10 + $$12 * $$12 > $$7 * $$7))
                     ...
                     dsc $$13 = $$3.a_($$1.b($$9, $$6, $$11));
                     if ($$13.i() || b($$13) || $$13.a(dfb.dP) || $$13.a(dfb.dO)) {
                        this.a($$3, $$1.b($$9, $$6, $$11), dfb.iC.o());
                     }
         ...
         for (int $$15 = -$$14; $$15 <= $$14; $$15++) {
            for (int $$16 = -$$14; $$16 <= $$14; $$16++) {
               ...
               while ($$17.v() > 50) {
                  dsc $$19 = $$3.a_($$17);
                  if (!$$19.i() && !b($$19) && !$$19.a(dfb.dP) && !$$19.a(dfb.dO) && !$$19.a(dfb.iC)) {
                     break;
                  }

                  this.a($$3, $$17, dfb.iC.o());
                  $$17 = $$17.d();
                  if (--$$18 <= 0) {
                     $$17 = $$17.c($$2.a(5) + 1);
                     $$18 = $$2.a(5);
