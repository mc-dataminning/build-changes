...
public class bpt implements bpy {
   ...
   private final Map<String, bpt.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, brk>> o = new ObjectArraySet();

   public bpt(LongSupplier $$0, IntSupplier $$1, BooleanSupplier $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> bpz.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         if ($$2 > a && !this.n.getAsBoolean()) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> bpz.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bpt.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bpt.a());
      }
   ...
   @Override
   public bpz d() {
      return new bpw(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }
   ...
   public static class a implements bqc {
