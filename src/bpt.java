...
public class bpt implements bpm {
   ...
   public bpt(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<bpk> a() {
      Builder<bpk> $$0 = ImmutableSet.builder();

      try {
         bpt.a $$1 = new bpt.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bpk.a("cpu#" + $$1x, bpj.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bpk.a("heap MiB", bpj.e, () -> (double)ac.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bpl.a.a());
      return $$0.build();
   }
   ...
   public static bpk a(final LongSupplier $$0) {
      ...
      bpk.d $$3 = new bpk.d(2.0F);
      return bpk.a("ticktime", bpj.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
