...
public class dic {
   public static final Codec<dic> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> af.a($$0, 2).map($$0x -> new dic($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.h, $$0.i))
      .stable();
   public static final yw<ByteBuf, dic> b = new yw<ByteBuf, dic>() {
      public dic a(ByteBuf $$0) {
         return vu.c($$0);
      }

      public void a(ByteBuf $$0, dic $$1) {
         vu.a($$0, $$1);
      }
   };
   private static final int j = 1056;
   public static final long c = c(1875066, 1875066);
   private static final int k = (32 + ecw.a.a(ecx.n).c().b() + 1) * 2;
   public static final int d = jx.a(iu.f) - k;
   public static final dic e = new dic(0, 0);
   ...
   public static dic a(int $$0, int $$1) {
      return new dic($$0 << 5, $$1 << 5);
   }

   public static dic b(int $$0, int $$1) {
      return new dic(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dic $$1) ? false : this.h == $$1.h && this.i == $$1.i;
      }
   }
   ...
   public static Stream<dic> a(dic $$0, int $$1) {
      return a(new dic($$0.h - $$1, $$0.i - $$1), new dic($$0.h + $$1, $$0.i + $$1));
   }

   public static Stream<dic> a(final dic $$0, final dic $$1) {
      int $$2 = Math.abs($$0.h - $$1.h) + 1;
      int $$3 = Math.abs($$0.i - $$1.i) + 1;
      final int $$4 = $$0.h < $$1.h ? 1 : -1;
      final int $$5 = $$0.i < $$1.i ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dic>((long)($$2 * $$3), 64) {
         @Nullable
         private dic e;

         @Override
         public boolean tryAdvance(Consumer<? super dic> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
               ...
               if ($$1 == $$1.h) {
                  ...
                  this.e = new dic($$0.h, $$2 + $$5);
               } else {
                  this.e = new dic($$1 + $$4, $$2);
               }
            }
