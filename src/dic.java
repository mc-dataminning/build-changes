...
public final class dic {
   ...
   public static final Codec<jq<dic>> c = alv.a(mb.aH, a);
   public static final Codec<ju<dic>> d = kf.a(mb.aH, a);
   private static final esu f = new esu(new eeh(new edj(1234L)), ImmutableList.of(0));
   static final esu g = new esu(new eeh(new edj(3456L)), ImmutableList.of(-2, -1, 0));
   @Deprecated(
      forRemoval = true
   )
   public static final esu e = new esu(new eeh(new edj(2345L)), ImmutableList.of(0));
   ...
   public boolean a(dhd $$0, jh $$1, boolean $$2) {
      if (this.c($$1, $$0.O())) {
         return false;
      } else {
         if ($$0.d($$1.v()) && $$0.a(dhj.b, $$1) < 10) {
            dxn $$3 = $$0.a_($$1);
            etp $$4 = $$0.b_($$1);
            if ($$4.a() == etq.c && $$3.b() instanceof dow) {
               if (!$$2) {
                  return true;
               }
   ...
   public static enum c implements bba {
      ...
      public static final Codec<dic.c> d = bba.a(dic.c::values);
   ...
   public static enum d implements bba {
      ...
      public static final Codec<dic.d> c = bba.a(dic.d::values);
