public class eua extends esq {
   private static final eue a = new eue(
      new aey("widget/tab_selected"), new aey("widget/tab"), new aey("widget/tab_selected_highlighted"), new aey("widget/tab_highlighted")
   );
   ...
   public eua(eut $$0, eus $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   private void b(esh $$0, esf $$1, int $$2) {
   ...
   protected void a(ewk $$0) {
      $$0.a(ewj.a, tn.a("gui.narrate.tab", this.n.a()));
   }
