...
public enum eua implements ayq {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ayq.a<eua> t = ayq.a(eua::values);
   public static final IntFunction<eua> u = awn.a(eua::a, values(), awn.a.a);
   private final int v;
   private final String w;

   private eua(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
