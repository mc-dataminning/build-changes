...
public class enk implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<enk.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public enk(List<enk.a> $$0) {
      this.c = $$0;
   }
   ...
   public static enk a(BufferedReader $$0) {
      return new enk($$0.lines().flatMap($$0x -> enk.a.a($$0x).stream()).toList());
   }

   public static record a(enk.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<enk.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new enk.a(enk.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new enk.a(enk.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new enk.a(enk.b.b, $$3));
      ...
      static enk.a b(String $$0) {
         return new enk.a(enk.b.a, "glob:" + $$0);
      }

      static enk.a c(String $$0) {
         return new enk.a(enk.b.a, "regex:" + $$0);
      }

      static enk.a d(String $$0) {
         return new enk.a(enk.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      enk.b a = FileSystem::getPathMatcher;
      enk.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
