...
public abstract class enk<M extends enh<M>> {
   private final dci i;
   ...
   protected final Long2ObjectMap<due> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected enk(dci $$0, dum $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected due a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected due a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected due c(long $$0) {
      due $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected due g(long $$0) {
      due $$1 = (due)this.g.get($$0);
      return $$1 != null ? $$1 : new due();
   }
   ...
   protected void a(enn<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<due>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<due> $$6 = (Entry<due>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               due $$8 = (due)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable due $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kb.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, enk.a.a($$9, enk.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public enk.b k(long $$0) {
      return enk.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static enk.b c(byte $$0) {
         if ($$0 == 0) {
            return enk.b.a;
         } else {
            return a($$0) ? enk.b.c : enk.b.b;
         }
      }
   }
