public abstract class enk extends enq {
   ...
   protected enk(eod $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, jn $$7) {
      super($$0, 0, enq.a($$1, $$2, $$3, $$7, $$4, $$5, $$6));
      this.a = $$4;
      this.b = $$5;
      this.c = $$6;
      this.a($$7);
   ...
   protected boolean a(dgj $$0, ene $$1, int $$2) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$3 = 0;
   ...
   protected boolean a(dgj $$0, int $$1) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$2 = $$0.an() + 1;
