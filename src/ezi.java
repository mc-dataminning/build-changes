...
public abstract class ezi<T extends cel> extends eyk implements fam<T> {
   public static final aew a = new aew("textures/gui/container/inventory.png");
   ...
   private void a(esf $$0, cgd $$1) {
      ...
      if ($$4.b() && $$1.c()) {
         Pair<aew, aew> $$12 = $$1.b();
         if ($$12 != null) {
            fze $$13 = this.f.a((aew)$$12.getFirst()).apply((aew)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
            ...
            if ($$2 == 0 || $$2 == 1) {
               ...
               if ($$7 != -1 && !this.F.b() && $$9) {
                  ...
                  if (this.p.g().b()) {
                     ...
                     this.a(this.A, this.A.e, $$2, ceu.a);
                     this.G = arw.a($$0 - (double)$$4);
                     this.H = arw.a($$1 - (double)$$5);
                     this.B = this.A;
                     this.J = this.F;
                     this.I = ac.b();
                  }
