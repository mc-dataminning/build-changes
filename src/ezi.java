...
public class ezi {
   public static final ze<ByteBuf, ezi> a = zc.a(ezi::a, ezi::i);
   private static final ezi[] b = ag.a(() -> {
      ezi[] $$0 = new ezi[48];
      a(new ezi(jc.b, jc.c, ezi.a.a), $$0);
      return $$0;
   });
   private final jc c;
   private final jc d;
   private final jc e;
   private final ezi.a f;
   private final int g;
   ...
   private final Map<ezi.a, ezi> m = new EnumMap<>(ezi.a.class);

   private ezi(jc $$0, jc $$1, ezi.a $$2) {
      this.c = $$0;
      this.d = $$1;
      this.f = $$2;
      this.g = b($$0, $$1, $$2);
   ...
   public static ezi a(jc $$0, jc $$1, ezi.a $$2) {
      return b[b($$0, $$1, $$2)];
   }
   ...
   public static ezi a(bai $$0) {
      return ag.a(b, $$0);
   }

   private static ezi a(ezi $$0, ezi[] $$1) {
      if ($$1[$$0.i()] != null) {
         return $$1[$$0.i()];
      } else {
         $$1[$$0.i()] = $$0;

         for (ezi.a $$2 : ezi.a.values()) {
            $$0.m.put($$2, a(new ezi($$0.c, $$0.d, $$2), $$1));
         }
   ...
   @VisibleForTesting
   protected static int b(jc $$0, jc $$1, ezi.a $$2) {
      if ($$0.o() == $$1.o()) {
