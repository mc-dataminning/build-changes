...
public class ezi {
   ...
   public ezi(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ezi(ezn $$0, ezn $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static ezi a(elp $$0) {
      return new ezi((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ezi a(ezn $$0) {
      return new ezi($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static ezi a(jh $$0, jh $$1) {
      return new ezi(
   ...
   public ezi a(double $$0) {
      return new ezi($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ezi b(double $$0) {
      return new ezi(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ezi c(double $$0) {
      return new ezi(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ezi d(double $$0) {
      return new ezi(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ezi e(double $$0) {
      return new ezi(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ezi f(double $$0) {
      return new ezi(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ezi b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ezi c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ezi d(double $$0, double $$1, double $$2) {
      return new ezi(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ezi f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ezi h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ezn> b(ezn $$0, ezn $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<ezn> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ezn $$6, ezn $$7) {
   ...
   @Nullable
   public static ezj a(Iterable<ezi> $$0, ezn $$1, ezn $$2, jh $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ezj($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jm a(ezi $$0, ezn $$1, double[] $$2, @Nullable jm $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jm a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ezn $$6, double[] $$7, @Nullable jm $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(ezn $$0, List<ezi> $$1) {
      ezn $$2 = this.f();
      ezn $$3 = $$2.e($$0);

      for (ezi $$4 : $$1) {
         ezi $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public ezn f() {
      return new ezn(azk.d(0.5, this.a, this.d), azk.d(0.5, this.b, this.e), azk.d(0.5, this.c, this.f));
   }

   public ezn g() {
      return new ezn(azk.d(0.5, this.a, this.d), this.b, azk.d(0.5, this.c, this.f));
   }

   public ezn h() {
      return new ezn(this.a, this.b, this.c);
   }

   public ezn i() {
      return new ezn(this.d, this.e, this.f);
   }

   public static ezi a(ezn $$0, double $$1, double $$2, double $$3) {
      return new ezi($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
