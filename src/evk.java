...
public class evk implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<evk.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public evk(List<evk.a> $$0) {
      this.c = $$0;
   }
   ...
   public static evk a(BufferedReader $$0) {
      return new evk($$0.lines().flatMap($$0x -> evk.a.a($$0x).stream()).toList());
   }

   public static record a(evk.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<evk.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new evk.a(evk.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new evk.a(evk.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new evk.a(evk.b.b, $$3));
      ...
      static evk.a b(String $$0) {
         return new evk.a(evk.b.a, "glob:" + $$0);
      }

      static evk.a c(String $$0) {
         return new evk.a(evk.b.a, "regex:" + $$0);
      }

      static evk.a d(String $$0) {
         return new evk.a(evk.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      evk.b a = FileSystem::getPathMatcher;
      evk.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
