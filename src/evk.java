...
public class evk {
   ...
   public void a(evk.b $$0, List<aoq> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new evk.c($$0, $$1.stream().map(aoq::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new evk.c(evk.b.c, ImmutableList.of());
      }

      this.b.c = new evk.a($$0);
   }
   ...
   static class c {
      private final evk.b a;
      private final List<String> b;
      @Nullable
      evk.a c;
      boolean d;

      c(evk.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
