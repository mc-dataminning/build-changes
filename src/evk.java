...
public class evk implements evl, evm {
   ...
   public evk(dgn $$0, edr $$1, evk.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ji.c,
   ...
   public static <T> evk a(Dynamic<T> $$0, dgn $$1, evk.a $$2, edr $$3, Lifecycle $$4) {
      ...
      return new evk(
         ...
         new fao<>(fan.a, $$0.get("ScheduledEvents").asStream()),
         (tq)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(eaw.a.a).resultOrPartial(f::error).orElse(eaw.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(kf $$0, tq $$1, @Nullable tq $$2) {
      ...
      edp.a($$4, this.h, $$0).resultOrPartial(af.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (un)eaw.a.a.encodeStart(ue.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dhg.b.encodeStart(ue.a, this.g.g()).ifSuccess($$1x -> $$1.a((tq)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == evk.a.b;
   }

   @Override
   public boolean A() {
      return this.i == evk.a.c;
   }
