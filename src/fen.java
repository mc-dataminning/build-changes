...
public class fen {
   ...
   public fen(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<feo> $$1) throws IOException {
   ...
   public List<feo> a(Path $$0) throws IOException {
      List<feo> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<feo> a(Path $$0, boolean $$1) throws IOException {
      List<feo> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<feo> $$1) throws IOException {
