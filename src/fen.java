public class fen extends fea<cis> implements fgv {
   private static final ahg x = new ahg("textures/gui/container/crafting_table.png");
   private final fgp y = new fgp();
   private boolean z;

   public fen(cis $$0, cfh $$1, vf $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aN_() {
      ...
      this.d(new exs(this.t + 5, this.h / 2 - 49, 20, 18, fgp.a, $$0 -> {
         this.y.e();
         this.t = this.y.a(this.g, this.c);
