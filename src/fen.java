...
public class fen {
   ...
   private static final Queue<fen.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fen.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fen::a), fek::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fen::a), fek::a), 0L);
         }
      }
   }
