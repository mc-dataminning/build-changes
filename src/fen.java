...
public class fen implements AutoCloseable {
   ...
   public fen(fel $$0, fem $$1, ByteBuffer $$2) {
   ...
   public fen.a a(int $$0, int $$1) {
      if (this.f) {
         ...
         return $$2 == null ? null : new fen.a(this.d.h, $$2);
      }
   }
