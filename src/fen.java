...
public class fen {
   ...
   public static final fen.a bv;

   public static fen.a a(int $$0, int $$1) {
      return $$0 == -1 ? fen.b.b.a($$1) : fen.b.a.a($$0);
   }

   public static fen.a a(String $$0) {
      if (fen.a.e.containsKey($$0)) {
         return fen.a.e.get($$0);
      } else {
         for (fen.b $$1 : fen.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fen.b b;
      private final int c;
      private final ays<wo> d;
      static final Map<String, fen.a> e = Maps.newHashMap();

      a(String $$0, fen.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ays<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? wo.b($$2.toUpperCase(Locale.ROOT)) : wo.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? wo.b($$2) : wo.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tl.a().b($$1) ? wo.c($$1) : wo.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fen.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wo> g;

      private static void a(fen.b $$0, String $$1, int $$2) {
         fen.a $$3 = new fen.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, wo> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fen.a a(int $$0) {
         return (fen.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
