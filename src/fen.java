...
public class fen implements fek {
   @Nullable
   private ByteBuffer b;
   @Nullable
   private FT_Face c;
   final float d;
   private final fqo<fen.b> e = new fqo<>(fen.b[]::new, fen.b[][]::new);

   public fen(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$12 = frb.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fej a(int $$0, FT_Face $$1, int $$2) {
      int $$3 = FreeType.FT_Load_Glyph($$1, $$2, 4194312);
      if ($$3 != 0) {
         frb.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
      ...
      if ($$4 == null) {
         ...
         float $$5 = frb.a($$4.advance());
         FT_Bitmap $$6 = $$4.bitmap();
         int $$7 = $$4.bitmap_left();
         int $$8 = $$4.bitmap_top();
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (fej)($$9 > 0 && $$10 > 0 ? new fen.a((float)$$7, (float)$$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (frb.a) {
            frb.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
      ...
      public fqv bake(Function<fel, fqv> $$0) {
         return $$0.apply(new fel() {
            ...
            public void a(int $$0, int $$1) {
               FT_Face $$2 = fen.this.b();
               ffl $$3 = new ffl(ffl.a.d, a.this.b, a.this.c, false);
               if ($$3.a($$2, a.this.g)) {
