...
public class vz implements vy {
   ...
   private static final xv v = xv.b("<...>").a(n.h);
   ...
   public void a(vs $$0) {
      ...
      xv $$3 = xv.b($$1.substring(1, $$1.length() - 1)).a(g);
      this.G.f($$2).b($$3).f($$2);
   }

   @Override
   public void a(uv $$0) {
      this.G.b(xv.b(String.valueOf($$0.l())).a(h)).b(w);
   }

   @Override
   public void a(vp $$0) {
      this.G.b(xv.b(String.valueOf($$0.l())).a(h)).b(x);
   }

   @Override
   public void a(vc $$0) {
      this.G.b(xv.b(String.valueOf($$0.l())).a(h));
   }

   @Override
   public void a(vf $$0) {
      this.G.b(xv.b(String.valueOf($$0.l())).a(h)).b(z);
   }

   @Override
   public void a(va $$0) {
      this.G.b(xv.b(String.valueOf($$0.k())).a(h)).b(A);
   }

   @Override
   public void a(uy $$0) {
      this.G.b(xv.b(String.valueOf($$0.j())).a(h)).b(B);
   }
   ...
   public void a(uu $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         yj $$3 = xv.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(C);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   public void a(vb $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         this.G.f(" ").b(xv.b(String.valueOf($$1[$$2])).a(h));
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
      }
   ...
   public void a(ve $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         xv $$3 = xv.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(z);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   protected static xv a(String $$0) {
      if (j.matcher($$0).matches()) {
         return xv.b($$0).a(f);
      } else {
         String $$1 = vs.b($$0);
         String $$2 = $$1.substring(0, 1);
         xv $$3 = xv.b($$1.substring(1, $$1.length() - 1)).a(f);
         return xv.b($$2).b($$3).f($$2);
      }
   }
