...
public class agb {
                                                ...
                                                ((RequiredArgumentBuilder)du.a("advancement", es.a())
                                                      ...
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               ee.f($$0x, "targets"),
                                                               agb.a.a,
                                                               a($$0x, es.a($$0x, "advancement"), agb.b.a)
                                                            )
                                                      ))
                                                   .then(
                                       ...
                                       du.a("from")
                                          .then(
                                             du.a("advancement", es.a())
                                                .suggests(a)
                                                .executes(
                                                   $$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.a, a($$0x, es.a($$0x, "advancement"), agb.b.c))
                                                )
                                          )
                                    ))
                                 .then(
                                    du.a("until")
                                       .then(
                                          du.a("advancement", es.a())
                                             .suggests(a)
                                             .executes(
                                                $$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.a, a($$0x, es.a($$0x, "advancement"), agb.b.d))
                                             )
                                       )
                                 ))
                              .then(
                                 du.a("through")
                                    .then(
                                       du.a("advancement", es.a())
                                          .suggests(a)
                                          .executes(
                                             $$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.a, a($$0x, es.a($$0x, "advancement"), agb.b.b))
                                          )
                                    )
                              ))
                           .then(
                              du.a("everything").executes($$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.a, ((dt)$$0x.getSource()).l().az().b()))
                           )
                     )
               ))
            .then(
                                       ...
                                       du.a("only")
                                          .then(
                                             ((RequiredArgumentBuilder)du.a("advancement", es.a())
                                                   ...
                                                   .executes(
                                                      $$0x -> a(
                                                            (dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.b, a($$0x, es.a($$0x, "advancement"), agb.b.a)
                                                         )
                                                   ))
                                                .then(
                                                   du.a("criterion", StringArgumentType.greedyString())
                                    ...
                                    du.a("from")
                                       .then(
                                          du.a("advancement", es.a())
                                             .suggests(a)
                                             .executes(
                                                $$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.b, a($$0x, es.a($$0x, "advancement"), agb.b.c))
                                             )
                                       )
                                 ))
                              .then(
                                 du.a("until")
                                    .then(
                                       du.a("advancement", es.a())
                                          .suggests(a)
                                          .executes(
                                             $$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.b, a($$0x, es.a($$0x, "advancement"), agb.b.d))
                                          )
                                    )
                              ))
                           .then(
                              du.a("through")
                                 .then(
                                    du.a("advancement", es.a())
                                       .suggests(a)
                                       .executes($$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.b, a($$0x, es.a($$0x, "advancement"), agb.b.b)))
                                 )
                           ))
                        .then(du.a("everything").executes($$0x -> a((dt)$$0x.getSource(), ee.f($$0x, "targets"), agb.a.b, ((dt)$$0x.getSource()).l().az().b())))
                  )
            )
      );
   }

   private static int a(dt $$0, Collection<aks> $$1, agb.a $$2, Collection<af> $$3) {
      int $$4 = 0;
   ...
   private static int a(dt $$0, Collection<aks> $$1, agb.a $$2, af $$3, String $$4) {
      int $$5 = 0;
      ae $$6 = $$3.b();
   ...
   private static List<af> a(CommandContext<dt> $$0, af $$1, agb.b $$2) {
   ...
   static enum a {
      a("grant") {
         @Override
         protected boolean a(aks $$0, af $$1) {
            ah $$2 = $$0.O().b($$1);
            if ($$2.a()) {
               return false;
            } else {
         ...
         @Override
         protected boolean a(aks $$0, af $$1, String $$2) {
            return $$0.O().a($$1, $$2);
         }
      },
      b("revoke") {
      ...
      public int a(aks $$0, Iterable<af> $$1) {
         int $$2 = 0;
      ...
      protected abstract boolean a(aks var1, af var2);

      protected abstract boolean a(aks var1, af var2, String var3);
