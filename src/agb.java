...
public class agb {
   ...
   private static int a(dt $$0, Collection<? extends anx<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> ti.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> ti.a("commands.banlist.list", $$1.size()), false);

         for (anx<?> $$2 : $$1) {
            $$0.a(() -> ti.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
