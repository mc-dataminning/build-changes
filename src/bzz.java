...
public abstract class bzz extends bzm {
   ...
   public bzz(bsx $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bzz(bsx $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bzm.a.a, bzm.a.c));
   }
   ...
   protected abstract boolean a(dba var1, io var2);
}
