...
public class dwi {
   ...
   public static dwi a(apf $$0, IntStream $$1) {
      return new dwi($$0, a(new IntRBTreeSet($$1.boxed().collect(ImmutableList.toImmutableList()))), false);
   }

   @Deprecated
   public static dwi a(apf $$0, int $$1, DoubleList $$2) {
      return new dwi($$0, Pair.of($$1, $$2), false);
   }
   ...
   protected dwi(apf $$0, Pair<Integer, DoubleList> $$1, boolean $$2) {
