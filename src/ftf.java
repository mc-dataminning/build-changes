public class ftf extends fua {
   private final ftv a;

   ftf(fpx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ftv $$7) {
   ...
   public static class a implements ftd<kc> {
      ...
      public fta a(kc $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ftf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements ftd<kc> {
      ...
      public fta a(kc $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fta $$8 = new ftf($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
