...
public class ftf implements anu {
   private static final fom e = fom.n(new aew("textures/misc/shadow.png"));
   ...
   private static void a(elp $$0, elt $$1, biq $$2, float $$3) {
      ...
      if ($$2 instanceof bxh) {
         double $$5 = -arw.d((double)$$3, $$2.ac, $$2.dq());
         double $$6 = -arw.d((double)$$3, $$2.ad, $$2.ds());
         double $$7 = -arw.d((double)$$3, $$2.ae, $$2.dw());

         for (bxf $$8 : ((bxh)$$2).fZ()) {
            $$0.a();
            double $$9 = $$5 + arw.d((double)$$3, $$8.ac, $$8.dq());
            double $$10 = $$6 + arw.d((double)$$3, $$8.ad, $$8.ds());
            double $$11 = $$7 + arw.d((double)$$3, $$8.ae, $$8.dw());
            $$0.a($$9, $$10, $$11);
   ...
   private static void a(elp $$0, foe $$1, biq $$2, float $$3, float $$4, cpy $$5, float $$6) {
      ...
      double $$9 = arw.d((double)$$4, $$2.ac, $$2.dq());
      double $$10 = arw.d((double)$$4, $$2.ad, $$2.ds());
      double $$11 = arw.d((double)$$4, $$2.ae, $$2.dw());
      float $$12 = Math.min($$3 / 0.5F, $$7);
      int $$13 = arw.a($$9 - (double)$$7);
      int $$14 = arw.a($$9 + (double)$$7);
      int $$15 = arw.a($$10 - (double)$$12);
      int $$16 = arw.a($$10);
      int $$17 = arw.a($$11 - (double)$$7);
      int $$18 = arw.a($$11 + (double)$$7);
      elp.a $$19 = $$0.c();
