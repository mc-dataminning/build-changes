public class ftf extends fsi<bye> {
   ...
   public void a(bye $$0, float $$1, float $$2, elh $$3, fng $$4, int $$5) {
      $$3.a();
      ciw $$6 = $$0.j();
      int $$7 = $$6.b() ? 187 : cir.a($$6.d()) + $$6.k();
      this.n.b((long)$$7);
      gah $$8 = this.m.a($$6, $$0.dK(), null, $$0.ah());
      boolean $$9 = $$8.b();
      int $$10 = this.a($$6);
      float $$11 = 0.25F;
      float $$12 = aro.a(((float)$$0.m() + $$2) / 10.0F + $$0.b) * 0.1F + 0.1F;
      float $$13 = $$8.f().a(cit.h).d.y();
      ...
      for (int $$21 = 0; $$21 < $$10; $$21++) {
         ...
         this.m.a($$6, cit.h, false, $$3, $$4, $$5, fxx.d, $$8);
         $$3.b();
         if (!$$9) {
