...
public class dyu {
   ...
   private final Map<String, Long2ObjectMap<sl>> e = Maps.newHashMap();
   private final Map<String, dzc> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public dyu(@Nullable ega $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public sl a(sl $$0) {
      sl $$1 = $$0.p("Level");
      csp $$2 = new csp($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(csp.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(csp.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private sl a(sl $$0, csp $$1) {
      sl $$2 = $$0.p("Level");
      sl $$3 = $$2.p("Structures");
      sl $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<sl> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable ega $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            sl $$2 = new sl();

            try {
               $$2 = $$0.a($$1, avq.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               sl $$4 = $$2.p($$3);
               long $$5 = csp.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               sr $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  sl $$14 = $$2.p($$13);
                  $$12.a(csp.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static dyu a(ahc<cti> $$0, @Nullable ega $$1) {
      if ($$0 == cti.h) {
         return new dyu(
            $$1,
         ...
         return new dyu($$1, $$2, $$2);
      } else if ($$0 == cti.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new dyu($$1, $$3, $$3);
      } else {
