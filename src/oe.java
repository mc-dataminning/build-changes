...
public class oe implements mh {
   ...
   public CompletableFuture<?> a(mf $$0) {
      ...
      Consumer<cxl> $$6 = $$4::add;
      new ob($$2, $$5, $$6).a();
      new od($$5).a();
      List<dkm> $$7 = ma.e.k().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
