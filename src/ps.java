...
public class ps {
   ...
   private gv b;
   private final aki c;
   private final Collection<pt> d = Lists.newArrayList();
   private final int e;
   private final Collection<pw> f = Lists.newCopyOnWriteArrayList();
   ...
   private void A() {
      ...
      if (this.i >= 0L) {
         ...
         if (this.i > (long)this.e) {
            if (this.f.isEmpty()) {
               this.a(new pz("Didn't succeed or fail within " + this.a.c() + " ticks"));
            } else {
               this.f.forEach($$0x -> $$0x.b(this.i));
               if (this.n == null) {
                  this.a(new pz("No sequences finished"));
               }
            }
         } else {
   ...
   public eha f() {
      ddx $$0 = this.C();
      return $$0 == null ? null : qf.a($$0);
   }

   @Nullable
   private ddx C() {
      return (ddx)this.c.c_(this.b);
   }
   ...
   public void a(gv $$0, int $$1) {
      this.o = qf.a(this.t(), $$0, this.u(), $$1, this.c, false);
      this.b = this.o.p();
      this.o.a(this.c());
      qf.a(this.b, new gv(1, 0, -1), this.u(), this.c);
