...
public abstract class ps<T> implements mo {
   ...
   private final Map<alr, axz> i = Maps.newLinkedHashMap();

   protected ps(mq $$0, alq<? extends jt<T>> $$1, CompletableFuture<ji.a> $$2) {
      this($$0, $$1, $$2, CompletableFuture.completedFuture(ps.c.empty()));
   }

   protected ps(mq $$0, alq<? extends jt<T>> $$1, CompletableFuture<ji.a> $$2, CompletableFuture<ps.c<T>> $$3) {
      this.e = $$0.b($$1);
      this.f = $$1;
      this.h = $$3;
      this.d = $$2;
      ...
      return this.b()
         ...
         .thenCompose(
            $$1 -> {
               ...
               Predicate<alr> $$3 = $$1x -> $$2.a(alq.a(this.f, $$1x)).isPresent();
               Predicate<alr> $$4 = $$1x -> this.i.containsKey($$1x) || $$1.b.contains(ayc.a(this.f, $$1x));
               return CompletableFuture.allOf(
                  this.i
                     ...
                     .map(
                        $$4x -> {
                           alr $$5 = (alr)$$4x.getKey();
                           axz $$6 = (axz)$$4x.getValue();
                           List<aya> $$7 = $$6.b();
                           List<aya> $$8 = $$7.stream().filter($$2xx -> !$$2xx.a($$3, $$4)).toList();
                           if (!$$8.isEmpty()) {
                              ...
                              Path $$9 = this.e.a($$5);
                              return mo.a($$0, $$1.a, ayb.a, new ayb($$7, false), $$9);
                           }
                        }
                     )
   ...
   protected ps.b<T> b(ayc<T> $$0) {
      axz $$1 = this.c($$0);
      return new ps.b<>($$1);
   }

   protected axz c(ayc<T> $$0) {
      return this.i.computeIfAbsent($$0.b(), $$0x -> axz.a());
   }
   ...
   protected static class b<T> {
      ...
      public final ps.b<T> a(List<alq<T>> $$0) {
         for (alq<T> $$1 : $$0) {
            this.a.a($$1.a());
         }
      ...
      public ps.b<T> a(alr $$0) {
         this.a.b($$0);
         return this;
      }

      public ps.b<T> b(ayc<T> $$0) {
         this.a.c($$0.b());
         return this;
      }

      public ps.b<T> b(alr $$0) {
         this.a.d($$0);
         return this;
      }
   }
   ...
   public interface c<T> extends Function<ayc<T>, Optional<axz>> {
      ...
      default boolean contains(ayc<T> $$0) {
