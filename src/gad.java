...
public class gad extends fze<cwf> {
   private float G;
   private float H;
   private boolean I;
   private final fzv J;
   ...
   public gad(crj $$0) {
      super($$0.bQ, new gci($$0.bQ), $$0.gi(), wy.c("container.crafting"));
      this.v = 97;
      this.J = new fzv(this);
   }
   ...
   public void E() {
      super.E();
      if (this.m.t.fU()) {
         this.m.a(new fzs(this.m.t, this.m.t.j.y(), this.m.n.L().c()));
      }
   }
   ...
   @Override
   protected fxb G() {
      return new fxb(this.C + 104, this.o / 2 - 22);
   }
   ...
   protected void a(fsh $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(gqx::H, a, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      a($$0, $$4 + 26, $$5 + 8, $$4 + 75, $$5 + 78, 30, 0.0625F, this.G, this.H, this.m.t);
   }

   public static void a(fsh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bxj $$9) {
   ...
   public static void a(fsh $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bxj $$7) {
      $$0.c().a();
