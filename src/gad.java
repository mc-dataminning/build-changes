...
public final class gad {
   ...
   private static final gad c = new gad(HostAndPort.fromParts("server.invalid", 25565));

   public gad(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gad(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gad a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gad($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gad ? this.b.equals(((gad)$$0).b) : false;
      }
   }
