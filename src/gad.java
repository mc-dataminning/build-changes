...
public class gad extends qp {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gad(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gad a(anp $$0, List<String> $$1, boolean $$2) {
      ...
      return new gad(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<ann> $$1, Map<String, String> $$2) {
      for (ann $$3 : $$1) {
