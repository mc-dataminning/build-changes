...
public class heb extends hdp {
   private final List<heb.a> b;
   private final Map<dxu, BitSet> c = new Reference2ObjectOpenHashMap();

   private static hdl a(List<heb.a> $$0) {
      if ($$0.isEmpty()) {
   ...
   public static record a(Predicate<dxu> a, hdl b) {
   }
}
