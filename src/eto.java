...
public class eto {
   ...
   public static void a(File $$0, emi $$1, Consumer<ur> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, emi $$2, Consumer<ur> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, emi $$2, Consumer<ur> $$3) {
      emx $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            ur $$3x = ur.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new up(up.a.b, $$6.getAbsolutePath())));
            $$3.accept(ur.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(ur.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static emx a(emi $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      emx $$3 = new emx($$1, $$2, false);
   ...
   public eto(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
