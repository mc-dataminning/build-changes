...
public interface gdx {
   static gdx a(ged $$0, UserApiService $$1) {
      return new gdx.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, gef var2, AbuseReport var3);
   ...
   public static record b(ged a, UserApiService b) implements gdx {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, gef $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               xl $$5 = this.a(var7);
               throw new CompletionException(new gdx.a($$5, var7));
            } catch (MinecraftClientException var8) {
               xl $$7 = this.a(var8);
               throw new CompletionException(new gdx.a($$7, var8));
            }
         }, ae.h());
      }
