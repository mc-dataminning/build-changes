...
public class gdx extends aub<gdx.a> {
   ...
   protected gdx.a a(atw $$0, bmu $$1) {
      ...
      $$1.b();
      return new gdx.a($$2, $$3, $$4);
   }

   protected void a(gdx.a $$0, atw $$1, bmu $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(atw $$0, bmu $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ezf.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ezf.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ezf.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
