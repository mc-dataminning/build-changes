public class gdx extends gbh<hac> {
   ...
   public static gep a(gen $$0) {
      ger $$1 = new ger();
      get $$2 = $$1.a();
      $$2.a("shoulders", geo.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gel.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         geo.c()
         ...
         gel.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         geo.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gel.a(-2.0F, 6.9F + azu.b(0.20420352F) * 10.0F, -0.5F + azu.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", geo.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gel.a);
      geo $$4 = geo.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gel.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gel.a(10.0F, 4.0F, 0.0F));
