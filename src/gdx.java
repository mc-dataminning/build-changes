...
public class gdx implements ezj, AutoCloseable {
   ...
   public gdx(auo $$0, String $$1, ezy $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      alb $$3 = new alb("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = ayk.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(ayk.a($$5, "blend", null));
         this.H = a($$0, ezh.a.a, $$6);
         this.I = a($$0, ezh.a.b, $$7);
         this.D = ezi.a();
         int $$18 = 0;
   ...
   private static ezh a(final auo $$0, ezh.a $$1, String $$2) throws IOException {
      ezh $$3 = $$1.c().get($$2);
      ezh $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         auj $$5 = $$0.getResourceOrThrow(new alb($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = ezh.a($$1, $$2, $$6, $$5.b(), new eza() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gdx.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static ezd a(JsonObject $$0) {
      if ($$0 == null) {
         return new ezd();
      } else {
         int $$1 = 32774;
