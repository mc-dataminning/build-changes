...
public class awf extends awk {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<awg<?>> e = Sets.newHashSet();

   public awf(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<awg<?>> d() {
      Set<awg<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<awg<T>> a(awi<T> $$0, String $$1) {
      return Optional.ofNullable(ale.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<awi<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awg<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awg<?>>)$$3.next();
         awg<?> $$2 = (awg<?>)$$1.getKey();
      ...
      for (Entry<awi<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> ale b(awg<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(arf $$0) {
      Object2IntMap<awg<?>> $$1 = new Object2IntOpenHashMap();
