...
public class aqn extends aqh {
   ...
   private final aqn.b d;
   private final String e;

   aqn(String $$0, aqn.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aqq $$0, aiy $$1) {
   ...
   @Nullable
   private art<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : art.create($$1, $$2);
      }
   }
   ...
   public static class a implements arj.c {
      ...
      public aqp a(String $$0) {
         aqn.b $$1 = new aqn.b(this.a);
         return new aqn($$0, $$1, this.b, "");
      }

      @Override
      public aqp a(String $$0, arj.a $$1) {
         aqn.b $$2 = new aqn.b(this.a);
         aqp $$3 = new aqn($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aqp> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aqn($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aqn.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
