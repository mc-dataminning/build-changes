...
public enum fby {
   ...
   private fby(final String... $$0) {
      this.c = $$0;
   }

   public List<aul<InputStream>> a(atf $$0) throws IOException {
      return List.of(
   ...
   public aul<InputStream> b(atf $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aul<InputStream> a(atf $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      aul<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
