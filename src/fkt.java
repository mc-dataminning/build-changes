public abstract class fkt extends fkx {
   private static final fmm a = new fmm(alh.b("widget/text_field"), alh.b("widget/text_field_highlighted"));
   private static final alh b = alh.b("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fkt(int $$0, int $$1, int $$2, int $$3, xh $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return azj.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = azj.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fkm var1, int var2, int var3, float var4);
}
