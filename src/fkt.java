...
public class fkt extends fki {
   private static final flx d = new flx(alc.b("widget/text_field"), alc.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayp> D = ($$0x, $$1x) -> ayp.forward($$0x, ya.a);
   @Nullable
   private xd E;
   private long F = ad.c();

   public fkt(fjv $$0, int $$1, int $$2, xd $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fkt(fjv $$0, int $$1, int $$2, int $$3, int $$4, xd $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fkt(fjv $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fkt $$5, xd $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, ayp> $$0) {
      this.D = $$0;
   }
   ...
   protected xr aO_() {
      xd $$0 = this.z();
      return xd.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = azd.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azd.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fqd.t());
   }
   ...
   public void b(fjx $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.f()) {
            alc $$4 = d.a(this.C(), this.aM_());
            $$0.a(ghq::B, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         boolean $$9 = this.aM_() && (ad.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = azd.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if (this.E != null && $$7.isEmpty() && !this.aM_()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(ghq.G(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = azd.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = azd.a(this.v, 0, this.p.length());
      }
   }
