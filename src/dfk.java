...
public class dfk {
   ...
   private final Map<Character, Predicate<dfi>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dfk a(char $$0, Predicate<dfi> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dfj b() {
      return new dfj(this.c());
   }

   private Predicate<dfi>[][][] c() {
      this.d();
      Predicate<dfi>[][][] $$0 = (Predicate<dfi>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dfi>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
