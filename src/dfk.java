...
public abstract class dfk {
   ...
   public void a(but<?> $$0, @Nullable dgj $$1, azh $$2, ji $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bwe.a($$7.get(), $$0, bus.c, $$13, $$0.H_())) {
                     continue;
                  }

                  bum $$15 = but.a($$6, $$0, bus.c, $$3x -> {
                  ...
                  int $$16 = $$0.a(
                        ebi.b($$15.getClass()),
                        new faw((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bur.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof bvk $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bus.c) || !$$17.a((dgm)$$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((bvk)$$15).a($$0, $$0.d_($$15.dv()), bus.c, null);
                     }
   ...
   private void d(dgj $$0, ji $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dhd)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dgj $$0, ji $$1, tq $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dhd $$4 = dhd.b.parse(ue.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dhd::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dhd.c.parse(ue.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bqt::b);
      } else {
         this.e = bqt.a(this.f != null ? this.f : new dhd());
      }
   ...
   public tq a(tq $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (un)dhd.b.encodeStart(ue.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (un)dhd.c.encodeStart(ue.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bum b(dgj $$0, ji $$1) {
      if (this.l == null) {
         ...
         this.l = but.a($$2, $$0, bus.c, Function.identity());
         if ($$2.f() == 1 && this.l instanceof bvk) {
         }
      }
   ...
   protected void a(@Nullable dgj $$0, ji $$1, dhd $$2) {
      this.f = $$2;
   }

   private dhd a(@Nullable dgj $$0, azh $$1, ji $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bqv.b::b).orElseGet(dhd::new));
         return this.f;
      }
   }

   public abstract void a(dgj var1, ji var2, int var3);
