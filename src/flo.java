public class flo extends flu {
   ...
   public void a(elt $$0, eqg $$1, float $$2) {
      ...
      $$3 *= $$3;
      double $$4 = arw.d((double)$$2, this.E.ac, this.E.dq());
      double $$5 = arw.d((double)$$2, this.E.ad, (this.E.ds() + this.E.du()) / 2.0);
      double $$6 = arw.d((double)$$2, this.E.ae, this.E.dw());
      double $$7 = arw.d((double)$$3, this.D.dq(), $$4);
      double $$8 = arw.d((double)$$3, this.D.ds(), $$5);
      double $$9 = arw.d((double)$$3, this.D.dw(), $$6);
      foe.a $$10 = this.b.b();
      ehn $$11 = $$1.b();
