public class flo extends flw {
   private static final art a = art.a();
   private final flr b;

   flo(fie $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flr $$7) {
   ...
   public void a() {
      ...
      if (this.g()) {
         ...
         this.e(aro.i(0.05F, this.y, 1.0F));
      }
   }
   ...
   public static class a implements fkz<iz> {
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkw $$8 = new flo($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.e(0.15F);
   ...
   public static class b implements fkz<iz> {
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new flo($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class e implements fkz<iz> {
      private final flr a;
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flo $$8 = new flo($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
