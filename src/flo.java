...
public class flo {
   ...
   public void a(flo.b $$0, List<atb> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new flo.c($$0, $$1.stream().map(atb::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new flo.c(flo.b.c, ImmutableList.of());
      }

      this.b.c = new flo.a($$0);
   }
   ...
   static class c {
      private final flo.b a;
      private final List<String> b;
      @Nullable
      flo.a c;
      boolean d;

      c(flo.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
