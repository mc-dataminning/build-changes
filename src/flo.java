...
public class flo extends fmy {
   public static final double a = 7.0;
   private static final xl c = xl.c("chat_screen.usage");
   ...
   protected void aN_() {
      ...
      this.b = new fhi(this.m.i, 4, this.o - 12, this.n - 4, 12, xl.c("chat.editBox")) {
         @Override
         protected xz aL_() {
            return super.aL_().b(flo.this.v.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.v = new fhc(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.v.b(false);
      this.v.d();
   }
   ...
   public void a(fgm $$0, int $$1, int $$2, float $$3) {
      ...
      this.v.a($$0, $$1, $$2);
      $$0.c().b();
      fev $$4 = this.m.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.p, this.p.c($$4.g(), 210), $$1, $$2);
      } else {
         yi $$5 = this.b((double)$$1, (double)$$2);
         if ($$5 != null && $$5.i() != null) {
            $$0.a(this.p, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(fkv $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fku.a, xl.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private yi b(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return azq.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
