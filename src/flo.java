...
public class flo extends auu<Map<String, List<flo.a>>> implements AutoCloseable {
   ...
   public flo(aku $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<flo.a>> a(aup $$0, bos $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<flo.a>> $$0, aup $$1, bos $$2) {
      ...
      public void run() {
         ...
         for (flo.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> frb.a(flj.Q().aA(), frb.a.g, wo.a($$2.c, $$3), wo.a($$2.d, $$3)));
                  return;
               }
            }
         }
