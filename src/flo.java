...
public class flo extends auu<Map<String, List<flo.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<flo.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(flo.a::a),
                     Codec.LONG.fieldOf("period").forGetter(flo.a::b),
                     Codec.STRING.fieldOf("title").forGetter(flo.a::c),
                     Codec.STRING.fieldOf("message").forGetter(flo.a::d)
                  )
                  .apply($$0, flo.a::new)
         )
         .listOf()
   ...
   public flo(akv $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<flo.a>> a(aup $$0, bot $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<flo.a>> $$0, aup $$1, bot $$2) {
      List<flo.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<flo.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<flo.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<flo.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public flo.b a(List<flo.a> $$0, long $$1) {
         this.cancel();
         return new flo.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (flo.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> frc.a(flj.Q().aA(), frc.a.g, wp.a($$2.c, $$3), wp.a($$2.d, $$3)));
                  return;
               }
            }
         }
