...
public class flo extends fne {
   ...
   @Nullable
   private fhd z;
   private final fks A = new fks(this, this.m(), 33);

   public flo(ffk $$0, Runnable $$1) {
      super(a);
      this.s = $$0;
      this.x = $$1;
      this.r = new fhw(true);
   ...
   @Override
   public void aM_() {
      fkw $$0 = this.A.c(fkw.d());
      $$0.c().b().a(4);
      this.y = $$0.a(new fhq(this.n, this.l, this.p), $$0x -> $$0x.a(8));
      this.z = this.s.as().a(this.s);
      this.z.j = this.u;
      $$0.a(this.z);
      $$0.a(fhj.b(150, $$0x -> this.a(new flp(this, this.m.m)), false));
      $$0.a(fhj.a(150, $$0x -> this.a(new fmn(this, this.m.m, this.m.ag())), false));
      this.A.b(fhf.a(xo.j, $$0x -> this.d()).a());
      this.A.a(this::c);
      this.c();
   }
