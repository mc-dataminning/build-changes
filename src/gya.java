public abstract class gya<M extends gef> extends gxs<hav, M> {
   private final gdv a;
   private final aku b;
   private final gya.a c;

   public gya(gue<?, hav, M> $$0, gdv $$1, aku $$2, gya.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(hav var1);
   ...
   private void a(fgr $$0, gmx $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hfh.d);
   }
