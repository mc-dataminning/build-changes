...
public class fqy implements ajx<cyd>, fip, fji, flg, frd {
   public static final fiz a = new fiz(new akk("recipe_book/button"), new akk("recipe_book/button_highlighted"));
   ...
   private int o;
   private int p;
   protected final fqw e = new fqw();
   private final List<fra> q = Lists.newArrayList();
   @Nullable
   private fra r;
   protected fis f;
   protected cqs<?, ?> g;
   ...
   private String u = "";
   private ffa v;
   private final fqz w = new fqz();
   private final cml x = new cml();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, ffn $$2, boolean $$3, cqs<?, ?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fhv(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, wu.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fis($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (ffv $$3 : ffv.a(this.g.t())) {
         this.q.add(new fra($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fix.a(this.c()) : fix.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<frc> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<frc> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         fye $$4 = this.h.L();
         if ($$4 != null) {
            ObjectSet<frc> $$5 = new ObjectLinkedOpenHashSet($$4.B().b().search($$3.toLowerCase(Locale.ROOT)));
   ...
   public void a(fgz $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.f()) {
         this.w.a($$0, $$3, $$4);
         this.b($$0, $$1, $$2, $$3, $$4);
      }
   ...
   private void b(fgz $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fnd.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fgz $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cd.j, $$3, fnd.t());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   @Override
   public flg.a u() {
      return this.A ? flg.a.b : flg.a.a;
   }

   @Override
   public void b(fli $$0) {
      List<flg> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.C()) {
            $$1.add($$1x);
         }
