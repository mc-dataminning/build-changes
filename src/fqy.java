...
public class fqy implements hkt {
   private static final long a = 3000L;
   private final fmg b;
   private final List<fqy.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fqy.b> e = new ArrayList<>();
   ...
   public void a(fpc $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fqy.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hjo $$0, hkv $$1, float $$2) {
      if ($$1.a() != null) {
         wp $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fqy.b $$4 : this.c) {
         ...
         this.c.add(new fqy.b($$3, $$2, new fbx($$0.h(), $$0.i(), $$0.j())));
      }
   }
   ...
   static class b {
      ...
      private final List<fqy.a> c = new ArrayList<>();

      public b(wp $$0, float $$1, fbx $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fqy.a($$2, af.c()));
      }
