...
public class axb extends axg {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<axc<?>> e = Sets.newHashSet();

   public axb(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cpo $$0, axc<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<axc<?>> d() {
      Set<axc<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  um $$4 = a($$3.getAsJsonObject());
                  $$4 = bbi.g.a($$0, $$4, vb.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<axc<T>> a(axe<T> $$0, String $$1) {
      return Optional.ofNullable(alp.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static um a(JsonObject $$0) {
      um $$1 = new um();
   ...
   protected String b() {
      Map<axe<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<axc<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<axc<?>>)$$3.next();
         axc<?> $$2 = (axc<?>)$$1.getKey();
      ...
      for (Entry<axe<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> alp b(axc<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(ary $$0) {
      Object2IntMap<axc<?>> $$1 = new Object2IntOpenHashMap();
