...
public class gdj extends auu<gdj.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final alf b = new alf("gpu_warnlist.json");
   ...
   protected gdj.a a(aup $$0, bnj $$1) {
      ...
      $$1.b();
      return new gdj.a($$2, $$3, $$4);
   }

   protected void a(gdj.a $$0, aup $$1, bnj $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aup $$0, bnj $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eys.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eys.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eys.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
