...
public class gdj extends gde<cbb, fod<cbb>> {
   private static final Map<cbb.a, ajc> a = ac.a(Maps.newEnumMap(cbb.a.class), $$0 -> {
      $$0.put(cbb.a.a, new ajc("textures/entity/panda/panda.png"));
      $$0.put(cbb.a.b, new ajc("textures/entity/panda/lazy_panda.png"));
      $$0.put(cbb.a.c, new ajc("textures/entity/panda/worried_panda.png"));
      $$0.put(cbb.a.d, new ajc("textures/entity/panda/playful_panda.png"));
      $$0.put(cbb.a.e, new ajc("textures/entity/panda/brown_panda.png"));
      $$0.put(cbb.a.f, new ajc("textures/entity/panda/weak_panda.png"));
      $$0.put(cbb.a.g, new ajc("textures/entity/panda/aggressive_panda.png"));
   });

   public gdj(gby.a $$0) {
      super($$0, new fod<>($$0.a(fqe.aB)), 0.9F);
      this.a(new ggf(this, $$0.d()));
   }

   public ajc a(cbb $$0) {
      return a.getOrDefault($$0.gx(), a.get(cbb.a.a));
   }

   protected void a(cbb $$0, etd $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bW > 0) {
         int $$6 = $$0.bW;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(awm.i($$25, $$0.dB(), $$0.dB() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(awm.i($$27, $$0.dB(), $$0.dB() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? awm.i($$3, $$0, $$1) : $$0;
   }
}
