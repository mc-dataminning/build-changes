...
public class fgq {
   ...
   private static final Comparator<ewo> K = Comparator.comparing(ewo::d).reversed().thenComparing(ewo::c, String.CASE_INSENSITIVE_ORDER);
   ...
   public float a = 1.0F;
   private int ae;
   private cup af = cup.l;
   private final fhm ag;
   private final fim ah;
   private final fjd ai;
   private final fif aj;
   private final fhd ak;
   private int al;
   @Nullable
   private xp am;
   @Nullable
   ...
   public fgq(fff $$0) {
      ...
      this.ai = new fjd($$0);
      this.Y = new fhf($$0);
      this.aj = new fif($$0, this);
      this.ak = new fhd($$0);
      this.ah = new fim($$0);
      this.a();
      fgt $$1 = new fgt().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ak.a($$0x));
      fgt $$2 = new fgt().a(this::o).a(($$0x, $$1x) -> {
         if (this.ag.d()) {
            this.ag.a($$0x);
         }
   ...
   public void a(fgr $$0, float $$1) {
      RenderSystem.enableDepthTest();
      this.ax.a($$0, $$1);
      RenderSystem.disableDepthTest();
   }

   private void c(fgr $$0, float $$1) {
      if (fff.N()) {
         this.a($$0, this.X.an());
      }
      ...
      if ($$4 > 0.0F && !this.X.s.b(bse.i)) {
         this.q($$0, $$4);
      }
   }

   private void d(fgr $$0, float $$1) {
      if (this.X.s.gg() > 0) {
         this.X.aI().a("sleep");
         ...
         $$0.a(gdw.E(), 0, 0, $$0.a(), $$0.b(), $$4);
         this.X.aI().c();
      }
   }

   private void e(fgr $$0, float $$1) {
      fgp $$2 = this.f();
   ...
   private void h(fgr $$0, float $$1) {
      ewv $$2 = this.X.r.M();
      ewn $$3 = null;
      ewq $$4 = $$2.e(this.X.s.cB());
      if ($$4 != null) {
         ewm $$5 = ewm.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      ewn $$6 = $$3 != null ? $$3 : $$2.a(ewm.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fgr $$0, float $$1) {
      ewv $$2 = this.X.r.M();
      ewn $$3 = $$2.a(ewm.a);
   ...
   private void a(fgr $$0, fgp $$1, int $$2, int $$3, int $$4) {
   ...
   private void j(fgr $$0, float $$1) {
      ffj $$2 = this.X.m;
      if ($$2.aA().a()) {
         if (this.X.q.j() != dbv.d || this.a(this.X.v)) {
            ...
            if (this.ag.d() && !this.X.s.gs() && !$$2.V().c()) {
               ...
               if (this.X.m.D().c() == fep.b) {
                  float $$6 = this.X.s.D(0.0F);
                  boolean $$7 = false;
                  if (this.X.u != null && this.X.u instanceof btp && $$6 >= 1.0F) {
                     $$7 = this.X.s.gv() > 5.0F;
                     $$7 &= this.X.u.bD();
                  }
   ...
   private boolean a(@Nullable evp $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == evp.a.c) {
         return ((evo)$$0).a() instanceof bqy;
      } else if ($$0.c() == evp.a.b) {
         iz $$1 = ((evn)$$0).a();
         dby $$2 = this.X.r;
   ...
   private void k(fgr $$0, float $$1) {
      Collection<bsc> $$2 = this.X.s.ex();
      if (!$$2.isEmpty()) {
         if (this.X.y instanceof fou $$3 && $$3.K()) {
            return;
         }
         ...
         for (bsc $$8 : Ordering.natural().reverse().sortedCopy($$2)) {
            ji<bsa> $$9 = $$8.c();
            if ($$8.h()) {
               int $$10 = $$0.a();
               int $$11 = 1;
   ...
   private void a(bua $$0, fgr $$1, int $$2) {
      this.X.aI().a("jumpBar");
      float $$3 = this.X.s.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   @Nullable
   private cmx n() {
      return this.X.an() instanceof cmx $$0 ? $$0 : null;
   }
   ...
   private void b(fgr $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$7 = $$0.a() / 2 + 91;
         int $$8 = $$0.b() - 39;
         float $$9 = Math.max((float)$$1.g(bux.q), (float)Math.max($$5, $$2));
         int $$10 = ayz.f($$1.fs());
   ...
   private static void a(fgr $$0, cmx $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eO();
      if ($$6 > 0) {
         RenderSystem.enableBlend();
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fgr $$0, cmx $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fgq.b $$11 = fgq.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fgq.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fgq.b.d ? $$11 : fgq.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fgr $$0, fgq.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      RenderSystem.enableBlend();
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
      RenderSystem.disableBlend();
   }

   private void a(fgr $$0, cmx $$1, int $$2, int $$3) {
      cpq $$4 = $$1.gm();
      int $$5 = $$4.a();
      RenderSystem.enableBlend();
   ...
   private void a(fgr $$0, alf $$1, float $$2) {
      RenderSystem.disableDepthTest();
   ...
   private void p(fgr $$0, float $$1) {
      ...
      RenderSystem.disableBlend();
      $$0.a(gdw.E(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gdw.E(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gdw.E(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gdw.E(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bsu $$0) {
      iz $$1 = iz.a($$0.du(), $$0.dy(), $$0.dA());
      float $$2 = gdn.a($$0.dP().D_(), $$0.dP().A($$1));
      float $$3 = ayz.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(fgr $$0, @Nullable bsu $$1) {
      dtt $$2 = this.X.r.C_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(fgr $$0, int $$1, int $$2, float $$3, cmx $$4, cup $$5, int $$6) {
      if (!$$5.e()) {
         float $$7 = (float)$$5.H() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
