...
public class fgq<T extends bxs> extends ffx<T> {
   private final fiw a;
   private final fiw b;
   private final fiw f;
   private final fiw g;
   ...
   public static fjc a(fja $$0) {
      ...
      $$2.a(
         ...
         fiy.a(0.0F, 7.0F, -6.0F)
      );
      $$2.a("body", fjb.c().a(29, 0).a(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, $$0), fiy.a(0.0F, 5.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("right_chest", fjb.c().a(45, 28).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fiy.a(-8.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      $$2.a("left_chest", fjb.c().a(45, 41).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fiy.a(5.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      int $$3 = 4;
      int $$4 = 14;
      fjb $$5 = fjb.c().a(29, 29).a(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, $$0);
      $$2.a("right_hind_leg", $$5, fiy.a(-3.5F, 10.0F, 6.0F));
      $$2.a("left_hind_leg", $$5, fiy.a(3.5F, 10.0F, 6.0F));
      $$2.a("right_front_leg", $$5, fiy.a(-3.5F, 10.0F, -5.0F));
      $$2.a("left_front_leg", $$5, fiy.a(3.5F, 10.0F, -5.0F));
      return fjc.a($$1, 128, 64);
   }
