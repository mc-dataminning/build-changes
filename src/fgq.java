...
public class fgq {
   ...
   private final ffe d;
   private final ezx e;
   private final gdn.a f;
   private final fgq.a g = new fgq.a();
   private final fgr h;
   private boolean i;

   private fgq(ffe $$0, ezx $$1, gdn.a $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.h = $$0.aH();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3) {
      this.a(gdv.D(), $$0, $$1, $$2, $$3);
   }

   public void a(gdv $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$2 < $$1) {
         int $$5 = $$1;
         $$1 = $$2;
         $$2 = $$5;
   ...
   public void b(int $$0, int $$1, int $$2, int $$3) {
      this.b(gdv.D(), $$0, $$1, $$2, $$3);
   }

   public void b(gdv $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$3 < $$2) {
         int $$5 = $$2;
         $$2 = $$3;
         $$3 = $$5;
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new flj($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a(gdv.D(), $$0, $$1, $$2, $$3, $$4, $$5);
   }

   public void a(gdv $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, 0, $$5);
   }

   public void a(gdv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      ...
      float $$10 = (float)ayi.b.a($$6) / 255.0F;
      float $$11 = (float)ayi.b.b($$6) / 255.0F;
      float $$12 = (float)ayi.b.c($$6) / 255.0F;
      float $$13 = (float)ayi.b.d($$6) / 255.0F;
      fab $$14 = this.f.getBuffer($$0);
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a(gdv.D(), $$0, $$1, $$2, $$3, $$5, $$6, $$4);
   }

   public void a(gdv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      fab $$8 = this.f.getBuffer($$0);
      this.a($$8, $$1, $$2, $$3, $$4, $$7, $$5, $$6);
      this.g();
   }

   private void a(fab $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      float $$8 = (float)ayi.b.a($$6) / 255.0F;
      float $$9 = (float)ayi.b.b($$6) / 255.0F;
      float $$10 = (float)ayi.b.c($$6) / 255.0F;
      float $$11 = (float)ayi.b.d($$6) / 255.0F;
      float $$12 = (float)ayi.b.a($$7) / 255.0F;
      float $$13 = (float)ayi.b.b($$7) / 255.0F;
      float $$14 = (float)ayi.b.c($$7) / 255.0F;
      float $$15 = (float)ayi.b.d($$7) / 255.0F;
   ...
   public void b(gdv $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      Matrix4f $$6 = this.e.c().a();
      fab $$7 = this.f.getBuffer($$0);
   ...
   public void a(fgo $$0, String $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.b($$1) / 2, $$3, $$4);
   }

   public void a(fgo $$0, xo $$1, int $$2, int $$3, int $$4) {
      ayk $$5 = $$1.g();
      this.b($$0, $$5, $$2 - $$0.a($$5) / 2, $$3, $$4);
   }

   public void a(fgo $$0, ayk $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(fgo $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgo $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fgo.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(fgo $$0, ayk $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgo $$0, ayk $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fgo.a.a, 0, 15728880);
      this.g();
      return $$6;
   }

   public int b(fgo $$0, xo $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fgo $$0, xo $$1, int $$2, int $$3, int $$4, boolean $$5) {
      return this.a($$0, $$1.g(), $$2, $$3, $$4, $$5);
   }

   public void a(fgo $$0, xt $$1, int $$2, int $$3, int $$4, int $$5) {
      for (ayk $$6 : $$0.c($$1, $$4)) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, goy $$5) {
      this.a($$5, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, goy $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   public void a(ale $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      goy $$6 = this.h.a($$0);
      gqq $$7 = this.h.a($$6);
      if ($$7 instanceof gqq.b) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5);
      } else if ($$7 instanceof gqq.c $$8) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5, 0, 0, $$8.b(), $$8.c(), $$8.b(), $$8.c());
      } else if ($$7 instanceof gqq.a $$9) {
   ...
   private void a(goy $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      if ($$8 != 0 && $$9 != 0) {
         this.a(
            $$0.i(),
            $$5,
   ...
   private void a(goy $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      if ($$4 != 0 && $$5 != 0) {
   ...
   private void a(goy $$0, gqq.a $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      gqq.a.a $$7 = $$1.d();
   ...
   private void a(goy $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, int $$11) {
      if ($$4 > 0 && $$5 > 0) {
         if ($$8 > 0 && $$9 > 0) {
   ...
   public void a(bto $$0, cuo $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dP(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable bto $$0, @Nullable dbx $$1, cuo $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 0);
   }

   private void a(@Nullable bto $$0, @Nullable dbx $$1, cuo $$2, int $$3, int $$4, int $$5, int $$6) {
      if (!$$2.e()) {
         gqz $$7 = this.d.ar().a($$2, $$1, $$0, $$5);
         this.e.a();
         ...
         try {
            ...
            this.d.ar().a($$2, cul.g, false, this.e, this.d(), 15728880, gop.d, $$7);
            this.e();
            if ($$8) {
               eyt.d();
            }
   ...
   public void a(fgo $$0, cuo $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(fgo $$0, cuo $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.e()) {
         this.e.a();
         if ($$1.I() != 1 || $$4 != null) {
         ...
         if ($$1.p()) {
            ...
            int $$8 = $$2 + 2;
            int $$9 = $$3 + 13;
            this.a(gdv.E(), $$8, $$9, $$8 + 13, $$9 + 2, -16777216);
            this.a(gdv.E(), $$8, $$9, $$8 + $$6, $$9 + 1, $$7 | 0xFF000000);
         }

         gcp $$10 = this.d.s;
         float $$11 = $$10 == null ? 0.0F : $$10.gx().a($$1.g(), this.d.at());
         if ($$11 > 0.0F) {
            int $$12 = $$3 + ayy.d(16.0F * (1.0F - $$11));
            int $$13 = $$12 + ayy.f(16.0F * $$11);
            this.a(gdv.E(), $$2, $$12, $$2 + 16, $$13, Integer.MAX_VALUE);
         }
   ...
   public void b(fgo $$0, cuo $$1, int $$2, int $$3) {
      this.a($$0, fnc.a(this.d, $$1), $$1.b(), $$2, $$3);
   }

   public void a(fgo $$0, List<xo> $$1, Optional<cry> $$2, int $$3, int $$4) {
      List<fpu> $$5 = $$1.stream().map(xo::g).map(fpu::a).collect(ac.b());
      $$2.ifPresent($$1x -> $$5.add($$5.isEmpty() ? 0 : 1, fpu.a($$1x)));
      this.a($$0, $$5, $$3, $$4, fpw.a);
   }

   public void a(fgo $$0, xo $$1, int $$2, int $$3) {
      this.b($$0, List.of($$1.g()), $$2, $$3);
   }

   public void a(fgo $$0, List<xo> $$1, int $$2, int $$3) {
      this.b($$0, Lists.transform($$1, xo::g), $$2, $$3);
   }

   public void b(fgo $$0, List<? extends ayk> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(fpu::a).collect(Collectors.toList()), $$2, $$3, fpw.a);
   }

   public void a(fgo $$0, List<ayk> $$1, fpv $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(fpu::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(fgo $$0, List<fpu> $$1, int $$2, int $$3, fpv $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
         ...
         this.e.a();
         int $$14 = 400;
         this.a(() -> fpy.a(this, $$12, $$13, $$9, $$10, 400));
   ...
   public void a(fgo $$0, @Nullable yl $$1, int $$2, int $$3) {
      if ($$1 != null && $$1.i() != null) {
         xu $$4 = $$1.i();
         xu.c $$5 = $$4.a(xu.a.b);
         if ($$5 != null) {
   ...
   static class a {
      private final Deque<flj> a = new ArrayDeque<>();

      public flj a(flj $$0) {
         flj $$1 = this.a.peekLast();
         if ($$1 != null) {
            flj $$2 = Objects.requireNonNullElse($$0.b($$1), flj.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
