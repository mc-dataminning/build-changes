...
public class fgq {
   ...
   public void a(evi $$0, int $$1, int $$2) {
      ...
      this.j = new eym($$1 + 93, $$2 + 137, 12, 17, false);
      this.j.a(b);
      this.k = new eym($$1 + 38, $$2 + 137, 12, 17, true);
      this.k.a(c);
   }
   ...
   public void a(List<fgt> $$0, boolean $$1) {
      this.i = $$0;
   ...
   public void a(ewu $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      if (this.l > 1) {
   ...
   protected void a(Consumer<exe> $$0) {
      $$0.accept(this.j);
      $$0.accept(this.k);
      this.d.forEach($$0);
   }
