...
public class fgq extends exc {
   ...
   public List<vf> e() {
      ...
      List<vf> $$1 = Lists.newArrayList(fcz.a(evg.O(), $$0));
      if (this.q.a(this.p.a(this.o)).size() > 1) {
         $$1.add(n);
      }
   ...
   public void a(fax $$0) {
      ...
      $$0.a(faw.a, vf.a("narration.recipe", $$1.y()));
      if (this.q.a(this.p.a(this.o)).size() > 1) {
         $$0.a(faw.d, vf.c("narration.button.usage.hovered"), vf.c("narration.recipe.usage.more"));
      } else {
