...
public class fgq {
   ...
   public static List<fgq.a> a(String $$0, fgq.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fgq.a> a(String $$0, List<fgq.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fgq.a> a(List<String> $$0, List<fgq.b> $$1) {
      int $$2 = 0;
      List<fgq.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fgq.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fgq.b a(String $$0, String $$1) {
         return new fgq.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fgq.b a(String $$0) {
         return new fgq.b($$0);
      }
   }
}
