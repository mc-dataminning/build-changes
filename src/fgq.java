...
public class fgq extends ffl {
   ...
   private static final avu n = avu.forward("_", wn.a.a(n.a));
   private static final avu o = avu.forward("_", wn.a.a(n.h));
   private final chl p;
   private final cpd q;
   private boolean r;
   private boolean t;
   ...
   private String x = "";
   private final fch y = new fch(this::Q, this::b, this::o, this::a, $$0x -> $$0x.length() < 1024 && this.i.b($$0x, 114) <= 128);
   private final fch z = new fch(() -> this.x, $$0x -> this.x = $$0x, this::o, this::a, $$0x -> $$0x.length() < 16);
   private long A;
   private int B = -1;
   private fhs C;
   private fhs D;
   ...
   private final blv I;
   @Nullable
   private fgq.a J = fgq.a.a;
   private vq K = vp.a;
   private final vq L;

   public fgq(chl $$0, cpd $$1, blv $$2) {
      super(exg.a);
      this.p = $$0;
      this.q = $$1;
      this.I = $$2;
   ...
   private String o() {
      return this.f != null ? fch.b(this.f) : "";
   }
   ...
   protected void aQ_() {
      this.S();
      this.F = this.c((ezo)ezo.a(vq.c("book.signButton"), $$0x -> {
         this.t = true;
         this.J();
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.E = this.c((ezo)ezo.a(vp.d, $$0x -> {
         this.f.a(null);
         this.c(false);
      }).a(this.g / 2 + 2, 196, 98, 20).a());
      this.G = this.c((ezo)ezo.a(vq.c("book.finalizeButton"), $$0x -> {
         if (this.t) {
            this.c(true);
            this.f.a(null);
         }
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.H = this.c((ezo)ezo.a(vp.e, $$0x -> {
         if (this.t) {
            this.t = false;
         }
      ...
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.C = this.c(new fhs($$0 + 116, 159, true, $$0x -> this.I(), true));
      this.D = this.c(new fhs($$0 + 43, 159, false, $$0x -> this.H(), true));
      this.J();
   }
   ...
   private void c(boolean $$0) {
      if (this.r) {
         this.K();
         this.e($$0);
         int $$1 = this.I == blv.a ? this.p.fT().l : 40;
         this.f.K().b(new afj($$1, this.w, $$0 ? Optional.of(this.x.trim()) : Optional.empty()));
      }
   }
   ...
   public void a(ezb $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.t) {
         ...
         avu $$7 = avu.composite(avu.forward(this.x, wn.a), $$6 ? n : o);
         int $$8 = this.i.a(l);
   ...
   public void b(ezb $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      $$0.a(fgr.l, (this.g - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(ezb $$0, fgq.c $$1, boolean $$2) {
      if (this.u / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(ezb $$0, fvy[] $$1) {
      for (fvy $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(fwb.D(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private fgq.c a(fgq.c $$0) {
      return new fgq.c($$0.a - (this.g - 192) / 2 - 36, $$0.b - 32);
   }

   private fgq.c b(fgq.c $$0) {
      return new fgq.c($$0.a + (this.g - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ac.b();
            fgq.a $$4 = this.R();
            int $$5 = $$4.a(this.i, this.a(new fgq.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.Q();
      this.y.a(eya.a($$1, -1, $$0, false), eya.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            fgq.a $$5 = this.R();
            int $$6 = $$5.a(this.i, this.a(new fgq.c((int)$$0, (int)$$1)));
            this.y.c($$6, true);
            this.S();
         }
   ...
   private fgq.a U() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<fgq.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, wn.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            fgq.c $$12 = this.b(new fgq.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new fgq.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         fgq.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new fgq.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.i.b($$0.substring($$8[$$11], $$1));
            $$10 = new fgq.c($$12, $$11 * 9);
         }

         List<fvy> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new fgq.c(0, $$23), new fgq.c($$25, $$23 + 9)));
               }
         ...
         return new fgq.a($$0, $$10, $$9, $$8, $$4.toArray(new fgq.b[0]), $$14.toArray(new fvy[0]));
      }
   }
   ...
   private fvy a(String $$0, eya $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      fgq.c $$8 = new fgq.c((int)$$1.a($$6), $$4);
      fgq.c $$9 = new fgq.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private fvy a(fgq.c $$0, fgq.c $$1) {
      fgq.c $$2 = this.b($$0);
      fgq.c $$3 = this.b($$1);
      ...
      return new fvy($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fgq.a a = new fgq.a("", new fgq.c(0, 0), true, new int[]{0}, new fgq.b[]{new fgq.b(wn.a, "", 0, 0)}, new fvy[0]);
      ...
      public a(String $$0, fgq.c $$1, boolean $$2, int[] $$3, fgq.b[] $$4, fvy[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
