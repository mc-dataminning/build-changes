...
public class bdl extends bac {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdl::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdl::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdl::k);
         $$0 = this.a($$0, "minecraft:fox", bdl::j);
         $$0 = this.a($$0, "minecraft:item", bdl::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdl::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdl::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdl::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdl::e);
         return this.a($$0, "minecraft:piglin", bdl::d);
      });
   }
