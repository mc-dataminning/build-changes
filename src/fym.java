...
public class fym {
   ...
   public void a(final fyk $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final fzn $$3 = fzn.a($$0.b);
      Optional<InetSocketAddress> $$4 = fzp.a.a($$3).map(fzm::d);
      if ($$4.isEmpty()) {
         this.a(flx.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fzn $$1, final fyk $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)wk.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fyd($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(fyk.b.d);
               $$2.h = xp.b($$2xx);
               $$2.d = xp.b($$3);
               $$2.c = fym.a($$4, $$5);
