...
public class fym extends ftr {
   private static final xk a = xk.c("telemetry_info.screen.title");
   private static final xk b = xk.c("telemetry_info.screen.description").b(-4539718);
   private static final xk c = xk.c("telemetry_info.button.privacy_statement");
   private static final xk d = xk.c("telemetry_info.button.give_feedback");
   private static final xk s = xk.c("telemetry_info.button.show_data");
   private static final xk u = xk.c("telemetry_info.opt_in.description");
