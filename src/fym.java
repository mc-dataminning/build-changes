...
public abstract class fym extends fxu {
   protected final dyl a;
   private dym c;
   private final String[] d;
   private final boolean s;
   protected final ebn b;
   private int u;
   private int v;
   @Nullable
   private fux w;

   public fym(dyl $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wy.c("sign.edit"));
   }

   public fym(dyl $$0, boolean $$1, boolean $$2, wy $$3) {
      super($$3);
      this.a = $$0;
      this.c = $$0.a($$1);
      this.s = $$1;
   ...
   @Override
   protected void aN_() {
      this.c(fsc.a(wx.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.w = new fux(() -> this.d[this.v], this::a, fux.a(this.m), fux.c(this.m), $$0 -> this.m.h.b($$0) <= this.a.c());
   }
   ...
   public void aE_() {
      gjs $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new ain(this.a.aw_(), this.s, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void c(fro var1);
   ...
   private void e(fro $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : gry.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.v && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gqc.N(), $$21, $$7, $$22, $$7 + this.a.a(), -16776961);
            }
         }
      }
   }
