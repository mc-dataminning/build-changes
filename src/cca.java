...
public abstract class cca extends ccm {
   ...
   private static final aee<Byte> g = aeh.a(cca.class, aeg.a);
   private static final aee<Byte> h = aeh.a(cca.class, aeg.a);
   ...
   public void l() {
      ...
      if (this.O == 0.0F && this.N == 0.0F) {
         double $$2 = $$1.h();
         this.r((float)(arw.d($$1.c, $$1.e) * 180.0F / (float)Math.PI));
         this.s((float)(arw.d($$1.d, $$2) * 180.0F / (float)Math.PI));
         this.N = this.dB();
         this.O = this.dD();
      }
      ...
      if (this.b && !$$0) {
         ...
         double $$21 = $$1.h();
         if ($$0) {
            this.r((float)(arw.d(-$$14, -$$16) * 180.0F / (float)Math.PI));
         } else {
            this.r((float)(arw.d($$14, $$16) * 180.0F / (float)Math.PI));
         }

         this.s((float)(arw.d($$15, $$21) * 180.0F / (float)Math.PI));
   ...
   protected void a(ehk $$0) {
      ...
      int $$3 = arw.c(arw.a((double)$$2 * this.n, 0.0, 2.147483647E9));
      if (this.B() > 0) {
         if (this.q == null) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof bjg $$10) {
            ...
            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof cbu && $$5 instanceof akr && !this.aS()) {
               ((akr)$$5).c.b(new yb(yb.g, 0.0F));
            }
            ...
            if (!this.dL().B && $$5 instanceof akr $$13) {
   ...
   public void a(qw $$0) {
      ...
      if ($$0.b("SoundEvent", 8)) {
         this.p = jb.c.b(new aew($$0.l("SoundEvent"))).orElse(this.s());
      }
