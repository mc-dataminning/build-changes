...
public class cca {
   ...
   private int g = asy.b(ate.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(iv.a.fieldOf("uuid").forGetter(Pair::getFirst), asg.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bjt> j;
   @VisibleForTesting
   protected final ArrayList<bjt> c;
   private final cca.a k;
   @VisibleForTesting
   protected final Object2IntMap<bjt> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cca> a(Predicate<bjt> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cca::b)).apply($$1, $$1x -> new cca($$0, $$1x))
      );
   }

   public cca(Predicate<bjt> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cca.a(this);
   ...
   public void a(alq $$0, Predicate<bjt> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bjt>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bjt> $$6 = (Entry<bjt>)$$5.next();
         int $$7 = $$6.getIntValue();
         bjt $$8 = (bjt)$$6.getKey();
         bjt.c $$9 = $$8.dH();
   ...
   public int b(@Nullable bjt $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bkj> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bkj).map($$0 -> (bkj)$$0);
   }

   @VisibleForTesting
   protected static record a(cca a) implements Comparator<bjt> {
      public int a(bjt $$0, bjt $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof ccx;
               boolean $$7 = $$1 instanceof ccx;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
