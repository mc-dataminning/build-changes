...
public abstract class cgm {
   ...
   private final il<clj> l = il.a();
   public final il<cih> i = il.a();
   private final List<che> m = Lists.newArrayList();
   private clj n = clj.b;
   private final il<clj> o = il.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cih> v = Sets.newHashSet();
   private final List<cgy> w = Lists.newArrayList();
   @Nullable
   private cgz x;
   private boolean y;

   protected cgm(@Nullable cht<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cgx $$0, cdu $$1, cva $$2) {
   ...
   protected static void a(biq $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cgw $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected che a(che $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(cgw $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(che.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         clj $$1 = this.i.get($$0).f();
         Supplier<clj> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, clj $$1, Supplier<clj> $$2) {
      clj $$3 = this.l.get($$0);
      if (!clj.a($$3, $$1)) {
         clj $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, clj $$1, Supplier<clj> $$2) {
      if (!this.y) {
         clj $$3 = this.o.get($$0);
         if (!clj.a($$3, $$1)) {
            clj $$4 = $$2.get();
   ...
   public abstract clj a(cdu var1, int var2);

   public void a(int $$0, int $$1, cgv $$2, cdu $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cgv $$2, cdu $$3) {
      cdt $$4 = $$3.fT();
      if ($$2 == cgv.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cgv.a || $$2 == cgv.b) && ($$1 == 0 || $$1 == 1)) {
         cgu $$16 = $$1 == 0 ? cgu.a : cgu.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == cgu.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == cgu.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == cgu.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<clj> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<clj> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cgv.d && $$3.fU().d && this.g().b() && $$0 >= 0) {
         cih $$32 = this.i.get($$0);
         if ($$32.g()) {
            clj $$33 = $$32.f();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == cgv.e && this.g().b() && $$0 >= 0) {
         cih $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.f().L();
         clj $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cgv.g && $$0 >= 0) {
         cih $$37 = this.i.get($$0);
         clj $$38 = this.g();
         if (!$$38.b() && (!$$37.g() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.L() < $$38.g(); $$42 += $$40) {
                  cih $$43 = this.i.get($$42);
                  if ($$43.g() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     clj $$44 = $$43.f();
                     if ($$41 != 0 || $$44.L() != $$44.g()) {
                        clj $$45 = $$43.b($$44.L(), $$38.g() - $$38.L(), $$3);
                        $$38.g($$45.L());
                     }
                  }
               }
   ...
   private boolean a(cdu $$0, cgu $$1, cih $$2, clj $$3, clj $$4) {
      cgd $$5 = $$0.dN().H();
   ...
   protected void a(cdu $$0, biq $$1) {
      if (!$$0.bx() || $$0 instanceof amf && ((amf)$$0).v()) {
         for (int $$2 = 0; $$2 < $$1.b(); $$2++) {
            $$0.a($$1.b($$2), false);
         }
      } else {
   ...
   public void a(int $$0, int $$1, clj $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<clj> $$1, clj $$2) {
   ...
   public abstract boolean a(cdu var1);

   protected boolean a(clj $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cdu $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cih $$0, clj $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.g();
      return !$$3 && clj.c($$1, $$0.f()) ? $$0.f().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }

   public static int a(Set<cih> $$0, int $$1, clj $$2) {
      return switch ($$1) {
         case 0 -> atm.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
   ...
   public static int a(@Nullable dfd $$0) {
      return $$0 instanceof biq ? b((biq)$$0) : 0;
   }

   public static int b(@Nullable biq $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cgm $$0) {
      Table<biq, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(biq $$0, int $$1) {
