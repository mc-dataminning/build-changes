...
public abstract class dbw {
   ...
   public void a(bsw<?> $$0, @Nullable dcu $$1, ayv $$2, jd $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bui.a($$7.get(), $$0, btp.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dxk.b($$15.getClass()),
                        new ewr((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsv.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof btn $$17) {
                     ...
                     if ($$18) {
                        ((btn)$$15).a($$0, $$0.d_($$15.dq()), btp.c, null);
                     }
   ...
   private void d(dcu $$0, jd $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (ddm)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dcu $$0, jd $$1, ua $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         ddm $$4 = ddm.b.parse(uo.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(ddm::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = ddm.c.parse(uo.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bpa::b);
      } else {
         this.e = bpa.a(this.f != null ? this.f : new ddm());
      }
   ...
   public ua a(ua $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (ux)ddm.b.encodeStart(uo.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (ux)ddm.c.encodeStart(uo.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bsq b(dcu $$0, jd $$1) {
      if (this.l == null) {
         ...
         this.l = bsw.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof btn) {
         }
      }
   ...
   protected void a(@Nullable dcu $$0, jd $$1, ddm $$2) {
      this.f = $$2;
   }

   private ddm a(@Nullable dcu $$0, ayv $$1, jd $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bpc.b::b).orElseGet(ddm::new));
         return this.f;
      }
   }

   public abstract void a(dcu var1, jd var2, int var3);
