...
public class gqa extends goz<bvd, gwa> {
   public gqa(gpa.a $$0) {
      super($$0);
   }

   public void a(gwa $$0, fek $$1, gix $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvd $$0, gwa $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(bvd $$0) {
      return false;
   }
}
