...
public abstract class arz implements asi {
   ...
   public <T> T a(asv<T> $$0) throws IOException {
      ato<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asv<T> $$0, InputStream $$1) {
      JsonObject $$3;
