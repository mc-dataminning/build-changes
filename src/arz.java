...
public class arz extends ase {
   ...
   private final Set<asa<?>> e = Sets.newHashSet();

   public arz(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<asa<?>> d() {
      Set<asa<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  so $$4 = a($$3.getAsJsonObject());
                  $$4 = avx.g.a($$0, $$4, td.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<asa<T>> a(asc<T> $$0, String $$1) {
      return Optional.ofNullable(ahh.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static so a(JsonObject $$0) {
      so $$1 = new so();
   ...
   protected String b() {
      Map<asc<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<asa<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<asa<?>>)$$3.next();
         asa<?> $$2 = (asa<?>)$$1.getKey();
      ...
      for (Entry<asc<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> ahh b(asa<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(anf $$0) {
      Object2IntMap<asa<?>> $$1 = new Object2IntOpenHashMap();
