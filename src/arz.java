...
public class arz {
   ...
   public boolean a(dgw $$0) {
      if ($$0 == this.b) {
         ...
         this.a($$0, this.e);
         this.d.x();
         this.d.g.ag().a(new aeo(aeo.a.c, this.d));
         this.c.f();
         if ($$0 == dgw.b) {
            this.d.gN();
         }
   ...
   protected void a(dgw $$0, @Nullable dgw $$1) {
      this.e = $$1;
      this.b = $$0;
      $$0.a(this.d.gj());
   }
   ...
   private float a(dxo $$0, jh $$1, int $$2) {
      int $$3 = this.i - $$2;
   ...
   public void a(jh $$0, aih.a $$1, jm $$2, int $$3, int $$4) {
      if (!this.d.a($$0, 1.0)) {
         this.a($$0, false, $$4, "too far");
      } else if ($$0.v() > $$3) {
         this.d.f.b(new acp($$0, this.c.a_($$0)));
         ...
         if ($$1 == aih.a.a) {
            ...
            dxo $$6 = this.c.a_($$0);
            if (!$$6.l()) {
               dds.a(this.c, this.d.eZ(), this.d, this.d, bvj.a, fbr.b($$0), $$6, $$0x -> this.d.a($$0x, bvj.a));
               $$6.a(this.c, $$0, this.d);
            ...
            if (!$$6.l() && $$5 >= 1.0F) {
               ...
               if (this.f) {
                  this.d.f.b(new acp(this.h, this.c.a_(this.h)));
   ...
   public boolean a(jh $$0) {
      ...
      if (!this.d.eZ().h().a($$1, this.c, $$0, this.d)) {
         ...
         duq $$2 = this.c.c_($$0);
         dkd $$3 = $$1.b();
         if ($$3 instanceof dnm && !this.d.gG()) {
            this.c.a($$0, $$1, $$1, 3);
            return false;
         } else if (this.d.a(this.c, $$0, this.b)) {
            return false;
         } else {
            dxo $$4 = $$3.a(this.c, $$0, $$1, (cpo)this.d);
   ...
   public bta a(ary $$0, dgz $$1, cxg $$2, bsz $$3) {
      if (this.b == dgw.d) {
         return bta.e;
      } else if ($$0.gE().a($$2)) {
         return bta.e;
         ...
         if ($$8 == $$2 && $$8.M() == $$4 && $$8.a((bvx)$$0) <= 0 && $$8.o() == $$5) {
            return $$6;
         } else if ($$6 instanceof bta.a && $$8.a((bvx)$$0) > 0 && !$$0.fz()) {
            return $$6;
         } else {
            if ($$2 != $$8) {
               $$0.a($$3, $$8);
   ...
   public bta a(ary $$0, dgz $$1, cxg $$2, bsz $$3, fbn $$4) {
      jh $$5 = $$4.b();
      dxo $$6 = $$1.a_($$5);
      if (!$$6.b().a($$1.K())) {
         return bta.d;
      } else if (this.b == dgw.d) {
         btc $$7 = $$6.c($$1, $$5);
         if ($$7 != null) {
            $$0.a($$7);
            return bta.c;
         ...
         cxg $$10 = $$2.v();
         if (!$$9) {
            bta $$11 = $$6.a($$0.b($$3), $$1, $$0, $$3, $$4);
            if ($$11.a()) {
               ao.N.a($$0, $$5, $$10);
               return $$11;
            }

            if ($$11 instanceof bta.f && $$3 == bsz.a) {
               bta $$12 = $$6.a($$1, $$0, $$4);
               if ($$12.a()) {
                  ao.O.a($$0, $$5);
                  return $$12;
