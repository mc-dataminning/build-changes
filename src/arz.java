...
public class arz implements AutoCloseable {
   ...
   public static arz a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = ayd.a($$0);
            URI $$2 = new URI(ayd.i($$1, "apiServer"));
            String $$3 = ayd.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = ayd.a($$1, "ruleId", 1);
               String $$5 = ayd.a($$1, "serverId", "");
               String $$6 = ayd.a($$1, "roomId", "Java:Chat");
               int $$7 = ayd.a($$1, "hashesToDrop", -1);
               int $$8 = ayd.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = ayd.a($$1, "endpoints", null);
   ...
   CompletableFuture<arl> a(GameProfile $$0, String $$1, arz.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arl.a) : CompletableFuture.supplyAsync(() -> {
         ...
         try {
            ...
            boolean $$5 = ayd.a($$4, "response", false);
            if ($$5) {
               return arl.a($$1);
            } else {
               String $$6 = ayd.a($$4, "hashed", null);
               if ($$6 == null) {
                  return arl.b($$1);
               } else {
                  JsonArray $$7 = ayd.v($$4, "hashes");
                  xc $$8 = this.a($$1, $$7, $$2);
                  return new arl($$1, $$8);
               }
            }
   ...
   private xc a(String $$0, JsonArray $$1, arz.a $$2) {
      if ($$1.isEmpty()) {
         return xc.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xc.b;
      } else {
         xc $$3 = new xc($$0.length());
   ...
   class d implements ary {
      ...
      d(final GameProfile $$0) {
         this.c = $$0;
         bpj<Runnable> $$1 = bpj.a(arz.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }
