...
public class arz implements AutoCloseable {
   ...
   private arz(URL $$0, arz.c $$1, URL $$2, arz.b $$3, URL $$4, arz.b $$5, String $$6, arz.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static arz a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = ayc.a($$0);
            URI $$2 = new URI(ayc.i($$1, "apiServer"));
            String $$3 = ayc.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = ayc.a($$1, "ruleId", 1);
               String $$5 = ayc.a($$1, "serverId", "");
               String $$6 = ayc.a($$1, "roomId", "Java:Chat");
               int $$7 = ayc.a($$1, "hashesToDrop", -1);
               int $$8 = ayc.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = ayc.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, arz.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<arl> a(GameProfile $$0, String $$1, arz.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arl.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = ayc.a($$4, "response", false);
            if ($$5) {
               return arl.a($$1);
            } else {
               String $$6 = ayc.a($$4, "hashed", null);
               if ($$6 == null) {
                  return arl.b($$1);
               } else {
                  JsonArray $$7 = ayc.v($$4, "hashes");
                  xi $$8 = this.a($$1, $$7, $$2);
                  return new arl($$1, $$8);
               }
            }
   ...
   private xi a(String $$0, JsonArray $$1, arz.a $$2) {
      if ($$1.isEmpty()) {
         return xi.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xi.b;
      } else {
         xi $$3 = new xi($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new arz.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public ary a(GameProfile $$0) {
      return new arz.d($$0);
   }
   ...
   public interface a {
      arz.a a = ($$0, $$1) -> false;
      arz.a b = ($$0, $$1) -> $$0.length() == $$1;

      static arz.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static arz.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ary {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bot<Runnable> $$1 = bot.a(arz.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         arz.this.a(this.c, arz.this.g, arz.this.h, this.d);
      }

      @Override
      public void b() {
         arz.this.a(this.c, arz.this.i, arz.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<arl>> a(List<String> $$0) {
         List<CompletableFuture<arl>> $$1 = $$0.stream().map($$0x -> arz.this.a(this.c, $$0x, arz.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ad.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arl> a(String $$0) {
         return arz.this.a(this.c, $$0, arz.this.l, this.d);
      }
   }
