...
public class arz {
   ...
   arz(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static arz.a a() {
      return new arz.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(arz::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public arz.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public arz a(Writer $$0) throws IOException {
         return new arz($$0, this.a);
      }
   }
}
