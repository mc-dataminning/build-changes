...
public class fgt extends fgk<ckl> {
   ...
   protected void a(ezb $$0, float $$1, int $$2, int $$3) {
      ...
      cpd $$6 = this.p.b(1).g();
      boolean $$7 = $$6.a(cpg.uf);
      boolean $$8 = $$6.a(cpg.qN);
      boolean $$9 = $$6.a(cpg.fS);
      cpd $$10 = this.p.b(0).g();
      boolean $$11 = false;
      Integer $$12;
      eig $$13;
   ...
   private void a(ezb $$0, @Nullable Integer $$1, @Nullable eig $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.t;
      int $$8 = this.u;
      if ($$4 && !$$6) {
   ...
   private void a(ezb $$0, @Nullable Integer $$1, @Nullable eig $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
