...
public class cph extends coo {
   ...
   private static final akj<Boolean> bM = akn.a(cph.class, akl.k);
   private static final akj<Integer> bN = akn.a(cph.class, akl.b);
   private static final akj<Boolean> bO = akn.a(cph.class, akl.k);
   ...
   public cph(bwr<? extends cph> $$0, djm $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   protected void D() {
      this.bD.a(4, new cph.a(this, 1.0, 3));
   ...
   protected void m() {
      ...
      this.bE.a(1, new cfx(this).a(cpj.class));
   ...
   public static byo.a gu() {
      return coo.gw().a(byp.m, 35.0).a(byp.v, 0.23F).a(byp.c, 3.0).a(byp.a, 2.0).a(byp.A);
   }
   ...
   protected void b(bwr<? extends cph> $$0) {
      this.a($$0, bwc.a(this, true, true), $$0x -> $$0x.J($$0x.dU().d_($$0x.du()).d()));
   }

   @VisibleForTesting
   public boolean a(arq $$0, cqy $$1) {
      cpi $$2 = $$1.a(bwr.bQ, bwc.a($$1, true, true), $$2x -> {
         $$2x.a($$0, $$0.d_($$2x.du()), bwq.i, new cph.b(false, true));
         $$2x.a($$1.gB());
         $$2x.a($$1.gN().d());
         $$2x.a($$1.gu().a());
         $$2x.s($$1.t());
   ...
   public boolean a(arq $$0, bux $$1, float $$2) {
      if (!super.a($$0, $$1, $$2)) {
         ...
         if ($$3 != null && $$0.an() == bud.d && (double)this.ae.i() < this.h(byp.A) && $$0.O().c(dji.f)) {
            int $$4 = azm.a(this.dz());
            int $$5 = azm.a(this.dB());
            int $$6 = azm.a(this.dF());
            bwr<? extends cph> $$7 = this.an();
            cph $$8 = $$7.a($$0, bwq.j);
            if ($$8 == null) {
               return true;
            }
   ...
   @Override
   public bwr<? extends cph> an() {
      return (bwr<? extends cph>)super.an();
   }
   ...
   public boolean a(arq $$0, bxj $$1) {
      ...
      if (($$0.an() == bud.c || $$0.an() == bud.d) && $$1 instanceof cqy $$3) {
   ...
   public boolean c(arq $$0, czn $$1) {
      return $$1.a(czr.so) ? false : super.c($$0, $$1);
   }
   ...
   public byb a(dkd $$0, bue $$1, bwq $$2, @Nullable byb $$3) {
      ...
      if ($$3 == null) {
         $$3 = new cph.b(a($$4), true);
      }

      if ($$3 instanceof cph.b $$6) {
         if ($$6.a) {
            this.a(true);
            if ($$6.b) {
               if ((double)$$4.i() < 0.05) {
   ...
   class a extends cfh {
      ...
      public void a(djn $$0, iv $$1) {
         $$0.a(null, $$1, awn.Ex, awo.f, 0.5F, 0.9F + cph.this.ae.i() * 0.2F);
      }
