...
public class fce extends euj {
   ...
   private void a(tw $$0, jt.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            fcf.b $$9 = fcf.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            fcf.b $$10 = fcf.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            fcf.a $$11 = fcf.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(tw $$0, jt.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         fcg $$5 = fcg.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, fcg.b.d());
            return fcg.b;
         });
         String $$6 = $$3.l("Name");
         wo $$7 = wo.a.a($$3.l("DisplayName"), $$1);
         fcg.a $$8 = fcg.a.a($$3.l("RenderType"));
