...
public class fce extends eye {
   static final aez a = new aez("icon/checkmark");
   ...
   private fce.a o;
   final fjo.a p;
   private final Consumer<fjo.a> q;
   private fcd s;

   public fce(@Nullable eye $$0, fjv $$1, fjo.a $$2, Consumer<fjo.a> $$3) {
      super(b);
      this.k = $$0;
      this.l = $$1;
      this.p = $$2.d();
   ...
   protected void aH_() {
      ...
      this.n = etd.a(this.i, c, this.g - 16);
      this.o = new fce.a(this.f, (this.n.a() + 1) * 9);
      this.e(this.o);
      this.d(esk.a(tk.k, $$0 -> this.az_()).a(this.g / 2 - 155, this.h - 32, 150, 20).a());
      this.m = this.d(esk.a(tk.d, $$0 -> {
   ...
   public class a extends etg<fce.a.b> implements fcd.a {
      @Nullable
      private fce.a.c m;

      public a(eqp $$1, int $$2) {
      ...
      public void a(double $$0) {
         double $$1 = this.l();
         super.a($$0);
         if ((float)this.m() > 1.0E-5F && $$0 <= 1.0E-5F && !asb.b($$0, $$1)) {
            fce.this.D();
         }
      }

      @Override
      public void a(int $$0, fjk.a $$1) {
      ...
      private void a(fjk.a $$0, boolean $$1) {
      ...
      public int d() {
         return asb.e(this.h - this.g, this.d);
      }
      ...
      public abstract class b extends etg.a<fce.a.b> {
         @Override
         public tl a() {
            return tk.a;
         }
      ...
      public class d extends fce.a.b {
         ...
         private final tl i;
         @Nullable
         private final List<arn> j;
         @Nullable
         private final eqk.a k;
         @Nullable
         private final List<arn> l;
         private final boolean m;
         private final boolean n;

         public d(int $$1, tl $$2, tl $$3, @Nullable eqk $$4, boolean $$5, boolean $$6) {
            this.g = $$1;
            this.k = x.a($$4, eqk::f);
            this.l = $$4 != null && $$4.g() != null ? fce.this.i.c($$4.g(), a.this.b()) : null;
            this.m = $$5;
            this.n = $$6;
            tq $$7 = fce.this.i.a($$2, this.f() - fce.this.i.a(tk.t));
            if ($$2 != $$7) {
               this.h = tq.a($$7, tk.t);
         ...
         public void a(erz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            int $$10 = $$3 + this.g();
            int $$11 = $$2 + 1 + ($$5 - 9) / 2;
            $$0.b(fce.this.i, qr.a().a(this.h), $$10, $$11, this.m ? -1 : -1593835521);
            if (this.j != null && $$8) {
               fce.this.b(this.j);
            }
         ...
         private void a(erz $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
            if (this.k != null) {
         ...
         private void a(erz $$0, int $$1, int $$2, int $$3) {
            int $$5 = $$1 + ($$3 - 8) / 2;
