...
public class fce extends gty {
   ...
   public void aN_() {
      this.a(this.I.a);
      this.c(fga.a(wx.c("mco.configure.world.subscription.extend"), $$0 -> fkq.a(this, axb.a(this.I.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.I.j) {
         this.c(fga.a(wx.c("mco.configure.world.delete.button"), $$0 -> {
            wx $$1 = wx.c("mco.configure.world.delete.question.line1");
            wx $$2 = wx.c("mco.configure.world.delete.question.line2");
            this.m.a(new fbq(this::c, fbq.a.a, $$1, $$2, true));
         }).a(this.n / 2 - 100, g(10), 200, 20).a());
      } else if (ezf.b() && this.I.s != null) {
         this.c(new fgk(this.n / 2 - 100, g(8), 200, 46, wx.a("mco.snapshot.subscription.info", this.I.s), this.p).a(-6250336));
      } else {
         this.c(new fgk(this.n / 2 - 100, g(8), 200, 46, G, this.p).a(-6250336));
      }

      this.c(fga.a(ww.k, $$0 -> this.d()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  fce.a.error("Couldn't delete world", var2);
               }

               fce.this.m.execute(() -> fce.this.m.a(fce.this.J));
            }
         }).start();
      }
