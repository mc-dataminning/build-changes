...
public class fce {
   ...
   @Nullable
   private String g;
   private static final fce.a h = new fce.a() {
      @Nullable
      @Override
      public fcd a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fch.a(this.d, "Get capabilities")) {
         ...
         if (fch.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fch.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fch.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fcd a(fce.c $$0) {
      return ($$0 == fce.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fce.a {
      private final int a;
      private final Set<fcd> b = Sets.newIdentityHashSet();
      ...
      public fcd a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fce.a.warn("Maximum sound pool size {} reached", this.a);
            }
