...
public class dwl {
   ...
   public static Optional<dvi.b> a(dvi.a $$0, he<dwr> $$1, Optional<aew> $$2, int $$3, gw $$4, boolean $$5, Optional<dks.a> $$6, int $$7) {
      hr $$8 = $$0.a();
      dhg $$9 = $$0.b();
      dzc $$10 = $$0.e();
      cpx $$11 = $$0.i();
   ...
   private static Optional<gw> a(dwp $$0, aew $$1, gw $$2, czh $$3, dzc $$4, dlr $$5) {
      List<dzb.c> $$6 = $$0.a($$4, $$2, $$3, $$5);
      Optional<gw> $$7 = Optional.empty();

      for (dzb.c $$8 : $$6) {
         aew $$9 = aew.a($$8.c().l("name"));
         if ($$1.equals($$9)) {
            $$7 = Optional.of($$8.a());
            break;
         }
   ...
   private static void a(dlg $$0, int $$1, boolean $$2, dhg $$3, dzc $$4, cpx $$5, asc $$6, hq<dwr> $$7, dve $$8, List<dve> $$9, eig $$10) {
   ...
   public static boolean a(akq $$0, he<dwr> $$1, aew $$2, int $$3, gw $$4, boolean $$5) {
      dhg $$6 = $$0.k().g();
      dzc $$7 = $$0.p();
      cqn $$8 = $$0.a();
      asc $$9 = $$0.D_();
   ...
   static final class b {
      ...
      b(hq<dwr> $$0, int $$1, dhg $$2, dzc $$3, List<? super dve> $$4, asc $$5) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
      ...
      void a(dve $$0, MutableObject<eig> $$1, int $$2, boolean $$3, cpx $$4, dlg $$5) {
         ...
         for (dzb.c $$14 : $$6.a(this.d, $$7, $$8, this.f)) {
            ...
            int $$19 = -1;
            aev<dwr> $$20 = a($$14);
            Optional<? extends he<dwr>> $$21 = this.a.b($$20);
            if ($$21.isEmpty()) {
               dwl.a.warn("Empty or non-existent pool: {}", $$20.a());
            } else {
               he<dwr> $$22 = (he<dwr>)$$21.get();
                           ...
                           if ($$3 && $$31.d() <= 16) {
                              $$33 = $$30.stream().mapToInt($$1x -> {
                                 if (!$$31.b($$1x.a().a(cwu.h($$1x.b())))) {
                                    ...
                                    aev<dwr> $$2x = a($$1x);
                                    Optional<? extends he<dwr>> $$3x = this.a.b($$2x);
                                    Optional<he<dwr>> $$4x = $$3x.map($$0xx -> ((dwr)$$0xx.a()).a());
      ...
      private static aev<dwr> a(dzb.c $$0) {
         return aev.a(jc.aC, new aew($$0.c().l("pool")));
      }
   }
}
