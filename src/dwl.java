...
public class dwl extends duw {
   ...
   protected void b(ux $$0, js.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vu)dan.a.encodeStart(vl.a, this.i).getOrThrow());
      }
   ...
   protected void a(ux $$0, js.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         dan.a.parse(vl.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }
   ...
   public static void a(dhh $$0, jh $$1, dxu $$2, dwl $$3) {
      if ($$2.b(drq.a) && $$2.c(drq.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
