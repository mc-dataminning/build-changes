...
public interface axz<C, I extends azy<C>> extends azy<C> {
                  ...
                  ayf.a($$2.listOf())
                     ...
                     .forGetter(
                        $$0xx -> IntStream.range(0, $$0xx.c.length)
                              .mapToObj($$1xx -> new a($$0xx.e()[$$1xx], (axz<C, I>)$$0xx.f().get($$1xx), $$0xx.g()[$$1xx]))
                              .toList()
                     )
               )
               .apply($$2x, ($$0xx, $$1xx) -> {
                  float[] $$2xx = new float[$$1xx.size()];
                  Builder<axz<C, I>> $$3x = ImmutableList.builder();
                  ...
                  return axz.e.a((I)$$0xx, $$2xx, $$3x.build(), $$4);
               })
      );
      $$1.setValue(
         Codec.either(Codec.FLOAT, $$3)
            .xmap(
               $$0x -> (axz)$$0x.map(axz.c::new, $$0xx -> $$0xx), $$0x -> $$0x instanceof axz.c<C, I> $$1x ? Either.left($$1x.d()) : Either.right((axz.e)$$0x)
            )
      );
   ...
   public static final class b<C, I extends azy<C>> {
      ...
      public axz.b<C, I> a(float $$0, float $$1) {
         return this.a($$0, new axz.c<>(this.b.a($$1)), 0.0F);
      }

      public axz.b<C, I> a(float $$0, float $$1, float $$2) {
         return this.a($$0, new axz.c<>(this.b.a($$1)), $$2);
      }

      public axz.b<C, I> a(float $$0, axz<C, I> $$1) {
         return this.a($$0, $$1, 0.0F);
      }

      private axz.b<C, I> a(float $$0, axz<C, I> $$1, float $$2) {
      ...
      public axz<C, I> a() {
         if (this.c.isEmpty()) {
            ...
            return axz.e.a(this.a, this.c.toFloatArray(), ImmutableList.copyOf(this.d), this.e.toFloatArray());
         }
      }
   }
   ...
   public static record e<C, I extends azy<C>>(I b, float[] c, List<axz<C, I>> d, float[] e, float f, float g) implements axz<C, I> {
      ...
      public String a() {
         return "Spline{coordinate="
            ...
            + this.a(this.e)
            + ", values="
            + this.d.stream().map(axz::a).collect(Collectors.joining(", ", "[", "]"))
            + "}";
      }
