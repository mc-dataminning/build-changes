...
public class axz {
   ...
   axz(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static axz.a a() {
      return new axz.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(axz::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public axz.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public axz a(Writer $$0) throws IOException {
         return new axz($$0, this.a);
      }
   }
}
