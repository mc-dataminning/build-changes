...
public class axz<T> extends AbstractList<T> implements azi<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axz.this.get(this.b--);
      }

      @Override
      public void remove() {
         axz.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azi<T> {
      private final axz<T> b;

      public b(final axz<T> $$0) {
         this.b = $$0;
      }
