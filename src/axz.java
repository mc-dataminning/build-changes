...
public class axz extends DataFix {
   ...
   private Typed<?> a(Typed<?> $$0) {
      ...
      return $$0.update($$1.finder(), $$2, $$1x -> {
         int $$2x = (Integer)$$1x.map($$0xx -> (Integer)((Either)$$0xx.getSecond()).map($$0xxx -> $$0xxx, axz::a), $$1xx -> {
         ...
         return Either.left(Pair.of(bbw.u.typeName(), axa.b($$2x << 4 | $$3x)));
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, String $$2, String $$3) {
      ...
      return $$0.update($$4.finder(), $$5, $$2x -> {
         int $$3x = (Integer)((Either)$$2x.getSecond()).map($$0xx -> $$0xx, axz::a);
         int $$4x = $$6.get($$2).asInt(0) & 15;
         return Pair.of(bbw.u.typeName(), axa.b($$3x << 4 | $$4x));
