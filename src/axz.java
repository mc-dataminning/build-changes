...
public class axz {
   ...
   private static final ayg q = ayg.b();
   ...
   public static int a(ayg $$0, int $$1, int $$2) {
      return $$1 >= $$2 ? $$1 : $$0.a($$2 - $$1 + 1) + $$1;
   }

   public static float a(ayg $$0, float $$1, float $$2) {
      return $$1 >= $$2 ? $$1 : $$0.i() * ($$2 - $$1) + $$1;
   }

   public static double a(ayg $$0, double $$1, double $$2) {
   ...
   public static int f(float $$0, float $$1, float $$2) {
      return axj.b.a(0, d($$0 * 255.0F), d($$1 * 255.0F), d($$2 * 255.0F));
   }
   ...
   public static boolean a(etp $$0, etp $$1, etk $$2) {
   ...
   public static int h(float $$0, float $$1, float $$2) {
      ...
      return axj.b.a(0, a((int)($$8 * 255.0F), 0, 255), a((int)($$9 * 255.0F), 0, 255), a((int)($$10 * 255.0F), 0, 255));
   }
   ...
   public static double l(double $$0) {
      return $$0 + (2.0 * ayg.a((long)a($$0 * 3000.0)).j() - 1.0) * 1.0E-7 / 2.0;
   }
   ...
   public static int b(ayg $$0, int $$1, int $$2) {
      return $$0.a($$2 - $$1 + 1) + $$1;
   }

   public static float b(ayg $$0, float $$1, float $$2) {
      return $$0.i() * ($$2 - $$1) + $$1;
   }

   public static float c(ayg $$0, float $$1, float $$2) {
