...
public class axz extends auy {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), axz::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", axz::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", axz::k);
         $$0 = this.a($$0, "minecraft:fox", axz::j);
         $$0 = this.a($$0, "minecraft:item", axz::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", axz::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", axz::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", axz::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", axz::e);
         return this.a($$0, "minecraft:piglin", axz::d);
      });
   }
