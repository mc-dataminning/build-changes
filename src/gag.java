...
public class gag extends gai<lc> {
   private final Vector3f a;
   private final Vector3f b;

   protected gag(fxw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, lc $$7, gby $$8) {
   ...
   public static class a implements gbg<lc> {
      private final gby a;
      ...
      public gbd a(lc $$0, fxw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
