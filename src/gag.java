...
public class gag extends frt {
   private static final fsa c = new fsa(ald.b("recipe_book/tab"), ald.b("recipe_book/tab_selected"));
   private final gae.a d;
   ...
   public void a(fmo $$0, boolean $$1) {
      gai.a $$2 = $$1 ? gai.a.b : gai.a.a;

      for (gai $$4 : $$0.a(this.d.c())) {
         for (dds $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(fpz $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         ald $$5 = this.a.a(true, this.b);
         int $$6 = this.F();
         if (this.b) {
            $$6 -= 2;
         }

         $$0.a(goi::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
