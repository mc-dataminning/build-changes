...
public class fdr {
   ...
   public void a(fez $$0, String $$1, ffw.a $$2, esv $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fdr.b $$13 = new fdr.b($$1.trim(), this.f, $$3, $$2);
                  fdr.a $$14 = new fdr.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fdr.c $$30 = new fdr.c(this.f, $$2, $$0);
                        fdr.a $$31 = new fdr.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ffd(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, esv $$2) throws IOException {
      ...
      File $$15 = new File(fil.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final esv d;
      private final ffw.a e;

      b(final String $$0, final File $$1, final esv $$2, final ffw.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fdr.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fdr.this.b && !fdr.this.d) {
            try {
               fdr.this.e = true;
               fdr.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fdr.a.error("Error extracting archive", var3);
               fdr.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final ffw.a c;
      private final fez d;

      c(final File $$0, final ffw.a $$1, final fez $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fdr.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fdr.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fdr.this.g);
                  fdr.this.c = true;
               } else {
                  fdr.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fdr.this.d = true;
               }
            } catch (IOException var3) {
               fdr.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fdr.this.d = true;
            }
         }
      }
