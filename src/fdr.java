...
public class fdr {
   ...
   public void a(feb $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == feb.a) {
            fih.b($$1, fih.a.a, wx.c("narrator.toast.disabled"), null);
         } else {
            fih.b($$1, fih.a.a, wx.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fih.b($$1, fih.a.a, wx.c("narrator.toast.disabled"), wx.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fdr.a("Narrator library is not active");
      }
   }
