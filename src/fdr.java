...
public class fdr extends fdb implements fnn.a {
   ...
   private final fnn z;
   private final Map<af, fdn> A = Maps.newLinkedHashMap();
   @Nullable
   private fdn B;
   private boolean C;
   ...
   protected void aN_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         fdn $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(ewu $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (fdn $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (fdn $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      fdn $$1 = fdn.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
