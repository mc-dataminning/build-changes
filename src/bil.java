...
public class bil extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Fix Arrow stored weapon", $$0, $$1, baz.a(this.a("minecraft:arrow"), this.a("minecraft:spectral_arrow")));
   }

   private Function<Typed<?>, Typed<?>> a(String $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(biq.D, $$0);
      Type<?> $$2 = this.getOutputSchema().getChoiceType(biq.D, $$0);
      return a($$0, $$1, $$2);
   }
