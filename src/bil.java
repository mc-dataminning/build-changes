...
public class bil extends DataFix {
   ...
   public static int a(int $$0) {
      return b[azc.a($$0 - 1, 0, b.length - 1)];
   }
   ...
   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(bhk.B, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(bhk.B), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
