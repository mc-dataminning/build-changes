...
public class bil extends DataFix {
   ...
   @Nullable
   private static bil.a a(String $$0) {
      if (b.contains($$0)) {
         return null;
      } else {
         String $$1 = c.get($$0);
         if ($$1 != null) {
            return new bil.a("minecraft:custom", $$1);
         } else {
            ...
            if ($$2 < 0) {
               ...
               if ("stat.mineBlock".equals($$3)) {
                  ...
                  return new bil.a("minecraft:mined", $$4);
               } else {
                  String $$5 = f.get($$3);
                  if ($$5 != null) {
   ...
   private TypeRewriteRule a() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhx.g);
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getInputSchema().getType(bhx.H);
      Type<?> $$1 = this.getOutputSchema().getType(bhx.H);
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         ...
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> (Dynamic)DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
               if (a.contains($$0xxx)) {
                  ...
                  bil.a $$1xx = a($$0xxx);
                  return $$1xx == null ? "dummy" : bka.b($$1xx.a) + ":" + bka.b($$1xx.b);
               }
