...
public abstract class bil extends bjp {
   private static final aef<Boolean> bT = aei.a(bil.class, aeh.k);
   ...
   protected bil(biu<? extends bil> $$0, cpv $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bil a(akr var1, bil var2);
