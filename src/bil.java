...
public abstract class bil<R extends Runnable> implements bht, bin<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bil(String $$0) {
      this.b = $$0;
      bhr.a.a(this);
   }
   ...
   @Override
   public List<bhq> bp() {
      return ImmutableList.of(bhq.a(this.b + "-pending-tasks", bhp.b, this::br));
   }
}
