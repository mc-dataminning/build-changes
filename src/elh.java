...
public class elh {
   ...
   public elh(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public elh(elm $$0, elm $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static elh a(dyr $$0) {
      return new elh((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static elh a(elm $$0) {
      return new elh($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static elh a(hx $$0, hx $$1) {
      return new elh(
   ...
   public elh a(double $$0) {
      return new elh($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public elh b(double $$0) {
      return new elh(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public elh c(double $$0) {
      return new elh(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public elh d(double $$0) {
      return new elh(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public elh e(double $$0) {
      return new elh(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public elh f(double $$0) {
      return new elh(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public elh b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public elh c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public elh d(double $$0, double $$1, double $$2) {
      return new elh(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public elh f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public elh h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<elm> b(elm $$0, elm $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      ic $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static eli a(Iterable<elh> $$0, elm $$1, elm $$2, hx $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eli($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ic a(elh $$0, elm $$1, double[] $$2, @Nullable ic $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, ic.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, ic.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, ic.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, ic.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, ic.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, ic.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public elm f() {
      return new elm(aui.d(0.5, this.a, this.d), aui.d(0.5, this.b, this.e), aui.d(0.5, this.c, this.f));
   }

   public static elh a(elm $$0, double $$1, double $$2, double $$3) {
      return new elh($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
