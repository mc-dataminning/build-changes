...
public class elh {
   ...
   static class a implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
         return $$0.c[jf.f.d()] && !$$0.b[jf.f.d()].d;
      }

      @Override
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         $$1.d = true;
         $$1.b[jf.f.d()].d = true;
         return new elh.k($$0, $$1);
      }
   }

   static class b implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         ...
         return new elh.l($$0, $$1);
      }
   }

   static class c implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         $$1.d = true;
         $$1.b[jf.b.d()].d = true;
         return new elh.m($$0, $$1);
      }
   }

   static class d implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         ...
         return new elh.n($$0, $$1);
      }
   }

   static class e implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         ...
         $$3.d = true;
         $$3.b[jf.c.d()].d = true;
         return new elh.o($$0, $$3);
      }
   }

   static class f implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
         return true;
      }
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         $$1.d = true;
         return new elh.s($$0, $$1, $$2);
      }
   }

   static class g implements elh.i {
      @Override
      public boolean a(elh.v $$0) {
      ...
      public elh.r a(jf $$0, elh.v $$1, ayo $$2) {
         $$1.d = true;
         return new elh.t($$0, $$1);
      }
   }

   public static class h extends elh.r {
      ...
      private elh.v G;
      private elh.v H;
      private final List<elh.r> I = Lists.newArrayList();

      public h(ayo $$0, int $$1, int $$2, jf $$3) {
         super(ejo.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<elh.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new elh.p($$3, this.G));
         this.I.add(new elh.j($$3, this.H));
         List<elh.i> $$5 = Lists.newArrayList();
         $$5.add(new elh.b());
         $$5.add(new elh.d());
         $$5.add(new elh.e());
         $$5.add(new elh.a());
         ...
         eip $$10 = eip.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eip $$11 = eip.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eip $$12 = eip.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new elh.u($$3, $$10, $$13++));
         this.I.add(new elh.u($$3, $$11, $$13++));
         this.I.add(new elh.q($$3, $$12));
      }
      ...
      private List<elh.v> b(ayo $$0) {
         elh.v[] $$1 = new elh.v[75];
         ...
         elh.v $$23 = new elh.v(1003);
         elh.v $$24 = new elh.v(1001);
         elh.v $$25 = new elh.v(1002);
         $$1[v].a(jf.b, $$23);
         $$1[w].a(jf.d, $$24);
         $$1[x].a(jf.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<elh.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, ddc $$2, ayo $$3, eip $$4) {
         int $$5 = 24;
      ...
      private void a(ddc $$0, ayo $$1, eip $$2) {
      ...
      private void b(ddc $$0, ayo $$1, eip $$2) {
      ...
      private void c(ddc $$0, ayo $$1, eip $$2) {
      ...
      private void d(ddc $$0, ayo $$1, eip $$2) {
      ...
      private void e(ddc $$0, ayo $$1, eip $$2) {
      ...
      private void f(ddc $$0, ayo $$1, eip $$2) {
   ...
   interface i {
      boolean a(elh.v var1);

      elh.r a(jf var1, elh.v var2, ayo var3);
   }

   public static class j extends elh.r {
      public j(jf $$0, elh.v $$1) {
         super(ejo.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(ddc $$0, dda $$1, dui $$2, ayo $$3, eip $$4, dbn $$5, ja $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfk.ch.o(), dfk.ch.o(), false);
   ...
   public static class k extends elh.r {
      public k(jf $$0, elh.v $$1) {
         super(ejo.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends elh.r {
      public l(jf $$0, elh.v $$1) {
         super(ejo.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends elh.r {
      public m(jf $$0, elh.v $$1) {
         super(ejo.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends elh.r {
      public n(jf $$0, elh.v $$1) {
         super(ejo.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends elh.r {
      public o(jf $$0, elh.v $$1) {
         super(ejo.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends elh.r {
      public p(jf $$0, elh.v $$1) {
         super(ejo.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends elh.r {
      public q(jf $$0, eip $$1) {
         super(ejo.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ejb {
      protected static final dsl b = dfk.hZ.o();
      protected static final dsl c = dfk.ia.o();
      protected static final dsl d = dfk.ib.o();
      protected static final dsl h = c;
      protected static final dsl i = dfk.ii.o();
      protected static final boolean j = true;
      protected static final dsl k = dfk.G.o();
      protected static final Set<dfi> l = ImmutableSet.builder().add(dfk.dO).add(dfk.iC).add(dfk.mW).add(k.b()).build();
      ...
      public r(ejo $$0, jf $$1, int $$2, eip $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ejo $$0, int $$1, jf $$2, elh.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eip a(jf $$0, elh.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eip $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(ddc $$0, eip $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsl $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(ddc $$0, eip $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(ddc $$0, eip $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsl $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eip $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(ddc $$0, eip $$1, int $$2, int $$3, int $$4) {
         ja $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjg $$6 = bsn.D.a((dcg)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eP());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dr()), btg.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends elh.r {
      private int a;

      public s(jf $$0, elh.v $$1, ayo $$2) {
         super(ejo.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends elh.r {
      public t(jf $$0, elh.v $$1) {
         super(ejo.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends elh.r {
      private int a;

      public u(jf $$0, eip $$1, int $$2) {
         super(ejo.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
