...
public class dsu extends dsz {
   ...
   public List<drh.a> a(cpw $$0, BiConsumer<gw, dfe> $$1, arx $$2, int $$3, gw $$4, dqr $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ars.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ars.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dsu.a> $$13 = Lists.newArrayList();
      $$13.add(new dsu.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               gw $$21 = $$4.b(ars.a($$19), $$12 - 1, ars.a($$20));
               gw $$22 = $$21.b(5);
      ...
      List<drh.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cpw $$0, BiConsumer<gw, dfe> $$1, arx $$2, gw $$3, gw $$4, boolean $$5, dqr $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            gw $$13 = $$3.b(ars.d(0.5F + (float)$$12 * $$9), ars.d(0.5F + (float)$$12 * $$10), ars.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(czb.g, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cpw $$0, BiConsumer<gw, dfe> $$1, arx $$2, int $$3, gw $$4, List<dsu.a> $$5, dqr $$6) {
      for (dsu.a $$7 : $$5) {
         int $$8 = $$7.a();
