...
public class bat extends axt {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bat::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bat::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bat::k);
         $$0 = this.a($$0, "minecraft:fox", bat::j);
         $$0 = this.a($$0, "minecraft:item", bat::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bat::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bat::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bat::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bat::e);
         return this.a($$0, "minecraft:piglin", bat::d);
      });
   }
