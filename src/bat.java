...
public class bat extends bft {
   ...
   public bat(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bgv.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bat::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bat::b)));
   }
