...
public class bat extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bho.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bat::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bat::a);
      return this.a($$0, "minecraft:trident", bat::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bho.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bho.B, $$1);
