...
public class awa extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bbw.y), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", awa::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", awa::a);
      return this.a($$0, "minecraft:trident", awa::a);
   }
