...
public class awa<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return awa.this.get(this.b--);
      }

      @Override
      public void remove() {
         awa.this.remove(this.b + 1);
      }
   }
}
