...
public class gmm {
   ...
   public final Map<jm, gmn> c;
   public final gmo d;
   public final boolean e;
   public final int f;

   public gmm(Vector3f $$0, Vector3f $$1, Map<jm, gmn> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gmm(Vector3f $$0, Vector3f $$1, Map<jm, gmn> $$2, @Nullable gmo $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gmn> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gmm> {
      private static final boolean a = true;
      private static final int b = 0;

      public gmm a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gmo $$6 = this.a($$3);
         Map<jm, gmn> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !azu.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = azu.a($$3, "shade", true);
            int $$9 = 0;
            if ($$3.has("light_emission")) {
               boolean $$10 = azu.b($$3, "light_emission");
               if ($$10) {
                  $$9 = azu.o($$3, "light_emission");
               }
            ...
            return new gmm($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gmo a(JsonObject $$0) {
         gmo $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = azu.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            jm.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = azu.a($$2, "rescale", false);
            $$1 = new gmo($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = azu.m($$0, "angle");
         if ($$1 != 0.0F && bae.e($$1) != 22.5F && bae.e($$1) != 45.0F) {
      ...
      private Map<jm, gmn> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmn> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gmn> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmn> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = azu.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gmn)$$0.deserialize($$4.getValue(), gmn.class));
         }
