...
public class gmm {
   ...
   public void a(gpp $$0, List<gpl.b> $$1, List<gpl.b> $$2) {
   ...
   public void a(boolean $$0, fkq $$1, gpp $$2, List<gpl.b> $$3, LongOpenHashSet $$4) {
      faz $$5 = $$1.b();
   ...
   private void a(boolean $$0, fkq $$1, faz $$2, LongOpenHashSet $$3) {
      this.e = false;
   ...
   private void a(boolean $$0, gpp $$1, List<gpl.b> $$2, faz $$3, LongOpenHashSet $$4) {
      gmm.b $$5 = this.h.get();
      this.a($$5);
      if (!$$5.b.b.isEmpty()) {
   ...
   private void a(gmm.b $$0) {
      ...
      while ($$1.hasNext()) {
         long $$2 = $$1.nextLong();
         List<gpl.b> $$3 = (List<gpl.b>)$$0.a.c.get($$2);
         if ($$3 != null && $$3.get(0).a()) {
            $$0.b.b.addAll($$3);
            $$0.a.c.remove($$2);
         }
   ...
   private void a(gmm.a $$0, dfn $$1) {
      $$0.a.add(dfn.c($$1.h - 1, $$1.i));
      $$0.a.add(dfn.c($$1.h, $$1.i - 1));
      $$0.a.add(dfn.c($$1.h + 1, $$1.i));
      $$0.a.add(dfn.c($$1.h, $$1.i + 1));
      $$0.a.add(dfn.c($$1.h - 1, $$1.i - 1));
      $$0.a.add(dfn.c($$1.h - 1, $$1.i + 1));
      $$0.a.add(dfn.c($$1.h + 1, $$1.i - 1));
      $$0.a.add(dfn.c($$1.h + 1, $$1.i + 1));
   }

   private void a(fkq $$0, Queue<gmm.d> $$1) {
      ji $$2 = $$0.c();
      long $$3 = kk.c($$2);
      int $$4 = kk.c($$3);
      gpl.b $$5 = this.g.a($$3);
      if ($$5 == null) {
         ...
         for (int $$13 = -$$9; $$13 <= $$9; $$13++) {
            for (int $$14 = -$$9; $$14 <= $$9; $$14++) {
               gpl.b $$15 = this.g.a(kk.b($$13 + $$11, $$8, $$14 + $$12));
   ...
   private void a(gmm.c $$0, faz $$1, Queue<gmm.d> $$2, boolean $$3, Consumer<gpl.b> $$4, LongOpenHashSet $$5) {
      int $$6 = 16;
         ...
         for (jn $$13 : b) {
            ...
            if ($$14 != null && (!$$3 || !$$10.a($$13.g()))) {
               ...
               if ($$3 && $$12) {
                  ...
                  faz $$20 = new faz((double)$$19.u(), (double)$$19.v(), (double)$$19.w());
                  faz $$21 = $$1.d($$20).d().c(d);
                  boolean $$22 = true;
                  ...
                  while ($$1.d($$20).h() > 3600.0) {
                     ...
                     gpl.b $$24 = this.g.a(ji.a($$20.d, $$20.e, $$20.f));
               ...
               if ($$25 != null) {
                  ...
                  if ($$14.a()) {
                     ...
                     $$0.a.a($$14, $$26);
                     ((List)$$0.c.computeIfAbsent(dfn.a($$14.f()), $$0x -> new ArrayList())).add($$14);
                  }
               }
            }
         }
   ...
   @Nullable
   private gpl.b a(long $$0, gpl.b $$1, jn $$2) {
      long $$3 = $$1.a($$2);
      if (!this.a($$0, $$3)) {
         return null;
      } else {
   ...
   static record a(LongSet a, BlockingQueue<gpl.b> b) {
   ...
   static class c {
      ...
      public final gly b;
      public final Long2ObjectMap<List<gpl.b>> c;
   ...
   public static class d {
      @bag
      protected final gpl.b a;
      private byte c;
      byte d;
      @bag
      public final int b;

      d(gpl.b $$0, @Nullable jn $$1, int $$2) {
         this.a = $$0;
         if ($$1 != null) {
            this.b($$1);
         }
   ...
   static class e {
      ...
      public void a(gpl.b $$0, gmm.d $$1) {
         this.a[$$0.b] = $$1;
      }

      @Nullable
      public gmm.d a(gpl.b $$0) {
         int $$1 = $$0.b;
