...
public class bii extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bit.y);
      Type<?> $$1 = this.getOutputSchema().getType(bit.y);
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bko.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bko.a($$1.substring(0, $$2))));
