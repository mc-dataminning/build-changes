...
public class bii extends bil implements bjy {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final aec<Float> f = aef.a(bii.class, aee.d);
   private static final aec<Integer> g = aef.a(bii.class, aee.b);
   private static final aec<Boolean> h = aef.a(bii.class, aee.k);
   private static final aec<iv> i = aef.a(bii.class, aee.l);
   ...
   private ckx n = cla.b;
   private final List<bhy> o = Lists.newArrayList();
   private final Map<bil, Integer> p = Maps.newHashMap();
   private int q = 600;
   private int r = 20;
   private int s = 20;
   private boolean t;
   ...
   public bii(bip<? extends bii> $$0, cpq $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public bii(cpq $$0, double $$1, double $$2, double $$3) {
      this(bip.c, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dK().B) {
         this.al().b(f, ars.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void w() {
      if (this.n == cla.b && this.o.isEmpty()) {
         this.al().b(g, 0);
      } else {
         this.al().b(g, ckz.a(ckz.a(this.n, this.o)));
      }
   }
   ...
   public void l() {
      ...
      if (this.dK().B) {
         ...
         if ($$0) {
            ...
            $$3 = ars.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ag.i() * (float) (Math.PI * 2);
            float $$9 = ars.c(this.ag.i()) * $$4;
            double $$10 = this.dp() + (double)(ars.b($$8) * $$9);
            double $$11 = this.dr();
            double $$12 = this.dv() + (double)(ars.a($$8) * $$9);
            double $$14;
            double $$15;
            double $$16;
            if ($$2.b() == ix.v) {
         ...
         if (this.ah % 5 == 0) {
            ...
            List<bhy> $$24 = Lists.newArrayList();

            for (bhy $$25 : this.n.a()) {
               $$24.add(new bhy($$25.c(), $$25.a($$0x -> $$0x / 4), $$25.e(), $$25.f(), $$25.g()));
            }
            ...
            if ($$24.isEmpty()) {
               ...
               List<bjb> $$26 = this.dK().a(bjb.class, this.cG());
               if (!$$26.isEmpty()) {
                  for (bjb $$27 : $$26) {
   ...
   @Nullable
   public bjb s() {
      if (this.aF == null && this.aG != null && this.dK() instanceof akn) {
         bil $$0 = ((akn)this.dK()).a(this.aG);
         if ($$0 instanceof bjb) {
            this.aF = (bjb)$$0;
         }
      }
