...
public interface dcz<T extends Enum<T>> {
   int v_ = 4;

   Optional<doz> j_(doz var1);

   float av_();

   default void a_(doz $$0, aps $$1, ib $$2, axr $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<doz> c(doz $$0, aps $$1, ib $$2, axr $$3) {
      ...
      for (ib $$7 : ib.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dcz<?> $$9) {
            Enum<?> $$10 = $$9.c();
