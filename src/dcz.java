...
public final class dcz {
   ...
   private static final enc f = new enc(new dyv(new dxx(1234L)), ImmutableList.of(0));
   static final enc g = new enc(new dyv(new dxx(3456L)), ImmutableList.of(-2, -1, 0));
   @Deprecated(
      forRemoval = true
   )
   public static final enc e = new enc(new dyv(new dxx(2345L)), ImmutableList.of(0));
   ...
   public boolean a(dcd $$0, iz $$1, boolean $$2) {
      if (this.c($$1)) {
         return false;
      } else {
         if ($$1.v() >= $$0.I_() && $$1.v() < $$0.am() && $$0.a(dcj.b, $$1) < 10) {
            dse $$3 = $$0.a_($$1);
            enx $$4 = $$0.b_($$1);
            if ($$4.a() == eny.c && $$3.b() instanceof djr) {
               if (!$$2) {
                  return true;
               }
   ...
   public boolean b(dcd $$0, iz $$1) {
      if (this.c($$1)) {
         ...
         if ($$1.v() >= $$0.I_() && $$1.v() < $$0.am() && $$0.a(dcj.b, $$1) < 10) {
            dse $$2 = $$0.a_($$1);
            if (($$2.i() || $$2.a(dfd.dN)) && dfd.dN.o().a($$0, $$1)) {
               return true;
            }
         }
   ...
   public static enum c implements azu {
      ...
      public static final Codec<dcz.c> d = azu.a(dcz.c::values);
   ...
   public static enum d implements azu {
      ...
      public static final Codec<dcz.d> c = azu.a(dcz.d::values);
