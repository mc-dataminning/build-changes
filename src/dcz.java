...
public class dcz {
   ...
   public dcz a(dcz.a $$0) {
      return new dcz($$0, this.f);
   }

   public ji<dcx> a(iz $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ji<dcx> a(double $$0, double $$1, double $$2) {
      int $$3 = jt.a(ayz.a($$0));
      int $$4 = jt.a(ayz.a($$1));
      int $$5 = jt.a(ayz.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      ji<dcx> getNoiseBiome(int var1, int var2, int var3);
   }
}
