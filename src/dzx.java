...
public class dzx extends LongLinkedOpenHashSet {
   private final dzx.a a;

   public dzx(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new dzx.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = arp.f(60000000);
      private static final int b = arp.f(60000000);
