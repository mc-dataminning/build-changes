...
public class dzx<T> implements eaf<T> {
   private final jv<T> a;
   private final azb<T> b;
   private final eag<T> c;
   private final int d;

   public dzx(jv<T> $$0, int $$1, eag<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dzx(jv<T> $$0, int $$1, eag<T> $$2) {
      this($$0, $$1, $$2, azb.c(1 << $$1));
   }

   private dzx(jv<T> $$0, int $$1, eag<T> $$2, azb<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public eaf<T> a(eag<T> $$0) {
      return new dzx<>(this.a, this.d, $$0, this.b.b());
   }
}
