...
public class dzx extends eaa<dzw> {
   public dzx(Codec<dzw> $$0) {
      super($$0);
   }

   public boolean a(dzw $$0, azh $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dzv $$0, dzw $$1, dtz $$2, Function<iz, ji<dcy>> $$3, azh $$4, dxh $$5, dbg $$6, dty $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eaa.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dzv $$0, dzw $$1, dtz $$2, Function<iz, ji<dcy>> $$3, dxh $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dty $$10, eaa.a $$11
   ) {
