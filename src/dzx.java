...
public class dzx<T> implements dzz<T> {
   ...
   private dzx(jv<T> $$0, int $$1, eaa<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dzx(jv<T> $$0, T[] $$1, eaa<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dzz<T> a(eaa<T> $$0) {
      return new dzx<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
