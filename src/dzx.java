...
public abstract class dzx<M extends dzr<M>, S extends dzu<M>> implements dzt {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = dzx.a.a(1);
   private static final int g = 512;
   protected static final ha[] d = ha.values();
   protected final dhn e;
   protected final S f;
   ...
   private final dhm[] n = new dhm[2];

   protected dzx(dhn $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(cph $$0, gw $$1, dfd $$2, dfd $$3) {
      return $$3 == $$2 ? false : $$3.b($$0, $$1) != $$2.b($$0, $$1) || $$3.h() != $$2.h() || $$3.g() || $$2.g();
   }

   public static int a(cph $$0, dfd $$1, gw $$2, dfd $$3, gw $$4, ha $$5, int $$6) {
      boolean $$7 = a($$1);
      boolean $$8 = a($$3);
      if ($$7 && $$8) {
         return $$6;
      } else {
         eia $$9 = $$7 ? ehx.a() : $$1.c($$0, $$2);
         eia $$10 = $$8 ? ehx.a() : $$3.c($$0, $$4);
         return ehx.b($$9, $$10, $$5) ? 16 : $$6;
      }
   }

   public static eia a(cph $$0, gw $$1, dfd $$2, ha $$3) {
      return a($$2) ? ehx.a() : $$2.a($$0, $$1, $$3);
   }
   ...
   protected dfd c(gw $$0) {
      int $$1 = hw.a($$0.u());
      int $$2 = hw.a($$0.w());
      dhm $$3 = this.a($$1, $$2);
      return $$3 == null ? cte.F.o() : $$3.a_($$0);
   }

   protected int a(dfd $$0, gw $$1) {
      return Math.max(1, $$0.b(this.e.q(), $$1));
   }

   protected boolean a(long $$0, dfd $$1, long $$2, dfd $$3, ha $$4) {
      eia $$5 = this.a($$1, $$0, $$4);
      eia $$6 = this.a($$3, $$2, $$4.g());
      return ehx.b($$5, $$6);
   }

   protected eia a(dfd $$0, long $$1, ha $$2) {
      return a(this.e.q(), this.k.f($$1), $$0, $$2);
   }

   @Nullable
   protected dhm a(int $$0, int $$1) {
      long $$2 = cpi.c($$0, $$1);
   ...
   public void a(long $$0, @Nullable dhf $$1) {
      this.f.a($$0, $$1);
   }

   public void b(cpi $$0, boolean $$1) {
      this.f.c(hw.b($$0.e, $$0.f), $$1);
   }
