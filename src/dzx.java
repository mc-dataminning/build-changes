...
public class dzx extends dzr<dzx.a> {
   protected dzx(dhk $$0) {
      super(cpv.a, $$0, new dzx.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dhc g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && hx.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dhc(15) : new dhc();
         }
      }
   }

   private static dhc a(dhc $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends dzo<dzx.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dhc> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public dzx.a a() {
         return new dzx.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
