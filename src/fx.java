...
public class fx implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> xp.b("slot.only_single_allowed", $$0));

   public static fx a() {
      return new fx();
   }

   public static int a(CommandContext<ep> $$0, String $$1) {
