...
public class cas extends cal {
   ...
   public boolean a() {
      if (!this.a.gd() && !this.a.hc()) {
         List<bss> $$0 = this.a.dP().a(this.a, this.a.cK().c(9.0, 4.0, 9.0), $$0x -> {
            bsy<?> $$1x = $$0x.ak();
            return $$1x == bsy.an || $$1x == bsy.be;
         });
         chk $$1 = null;
   ...
   public void e() {
      if (this.a.hc()) {
         if (!(this.a.gf() instanceof ciz)) {
            chk $$0 = this.a.hd();
            double $$1 = (double)this.a.f($$0);
            float $$2 = 2.0F;
            evp $$3 = new evp($$0.du() - this.a.du(), $$0.dw() - this.a.dw(), $$0.dA() - this.a.dA()).d().a(Math.max($$1 - 2.0, 0.0));
            this.a.K().a(this.a.du() + $$3.c, this.a.dw() + $$3.d, this.a.dA() + $$3.e, this.b);
         }
      }
   }

   private boolean a(chk $$0, int $$1) {
      if ($$1 > 8) {
         return false;
      } else if ($$0.hc()) {
