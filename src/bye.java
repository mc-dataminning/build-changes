...
public class bye extends big implements bju {
   private static final adx<ciw> c = aea.a(bye.class, adz.h);
   ...
   public bye(bik<? extends bye> $$0, cpk $$1) {
      super($$0, $$1);
      this.b = this.ag.i() * (float) Math.PI * 2.0F;
      this.r(this.ag.i() * 360.0F);
   }

   public bye(cpk $$0, double $$1, double $$2, double $$3, ciw $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$0.z.j() * 0.2 - 0.1, 0.2, $$0.z.j() * 0.2 - 0.1);
   }

   public bye(cpk $$0, double $$1, double $$2, double $$3, ciw $$4, double $$5, double $$6, double $$7) {
      this(bik.ad, $$0);
      this.e($$1, $$2, $$3);
      this.o($$5, $$6, $$7);
      this.a($$4);
   ...
   @Override
   public boolean aV() {
      return this.j().a(apr.aB);
   }

   @Nullable
   @Override
   public big v() {
      return this.j != null && this.dK() instanceof aki $$0 ? $$0.a(this.j) : null;
   }
   ...
   public void l() {
      if (this.j().b()) {
         ...
         if (this.aX() && this.b(apo.a) > (double)$$1) {
            this.y();
         } else if (this.bl() && this.b(apo.b) > (double)$$1) {
            this.z();
         } else if (!this.aT()) {
         ...
         boolean $$4 = aro.a(this.K) != aro.a(this.dp()) || aro.a(this.L) != aro.a(this.dr()) || aro.a(this.M) != aro.a(this.dv());
         int $$5 = $$4 ? 2 : 40;
   ...
   private void A() {
      if (this.B()) {
         for (bye $$1 : this.dK().a(bye.class, this.cG().c(0.5, 0.0, 0.5), $$0 -> $$0 != this && $$0.B())) {
            if ($$1.B()) {
               this.a($$1);
               if (this.dF()) {
                  break;
   ...
   public static ciw a(ciw $$0, ciw $$1, int $$2) {
   ...
   private static void a(bye $$0, ciw $$1, ciw $$2) {
      ciw $$3 = a($$1, $$2, 64);
      $$0.a($$3);
   }

   private static void a(bye $$0, ciw $$1, bye $$2, ciw $$3) {
      a($$0, $$1, $$3);
   ...
   public boolean a(bhe $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if (!this.j().b() && this.j().a(ciz.ty) && $$0.a(apl.l)) {
         return false;
   ...
   public te ab() {
      te $$0 = this.ad();
      return (te)($$0 != null ? $$0 : te.c(this.j().q()));
   }
