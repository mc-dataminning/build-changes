public class cfp extends cer {
   private final bgx k;
   private final bww l;

   public cfp(int $$0, cbz $$1, bgx $$2, final bww $$3) {
      super(null, $$0);
      this.k = $$2;
      this.l = $$3;
      int $$4 = 3;
      $$2.d_($$1.m);
      int $$5 = -18;
      this.a(new cgj($$2, 0, 8, 18) {
         @Override
         public boolean a(cjl $$0) {
            return $$0.a(cjo.mZ) && !this.f() && $$3.g();
         }
      ...
      if (this.a($$3)) {
         for (int $$6 = 0; $$6 < 3; $$6++) {
            for (int $$7 = 0; $$7 < ((bwv)$$3).gm(); $$7++) {
               this.a(new cgj($$2, 2 + $$7 + $$6 * ((bwv)$$3).gm(), 80 + $$7 * 18, 18 + $$6 * 18));
            }
         }
      }
      ...
      for (int $$8 = 0; $$8 < 3; $$8++) {
         for (int $$9 = 0; $$9 < 9; $$9++) {
            this.a(new cgj($$1, $$9 + $$8 * 9 + 9, 8 + $$9 * 18, 102 + $$8 * 18 + -18));
         }
      }

      for (int $$10 = 0; $$10 < 9; $$10++) {
         this.a(new cgj($$1, $$10, 8 + $$10 * 18, 142));
      }
   }
   ...
   private boolean a(bww $$0) {
      return $$0 instanceof bwv && ((bwv)$$0).t();
   }
