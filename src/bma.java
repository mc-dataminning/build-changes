...
public class bma {
   ...
   private bma(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bma a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bma($$0, $$1);
   }

   public bma.d a() throws IOException {
      bma.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bma.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bma.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bma.c $$3 = bma.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bma.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bma.a($$0, $$3);
            }
         }
   ...
   public bma.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bma.c> $$2 = this.a().c();
      ...
      bma.e $$4 = new bma.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bma.c b) implements bma.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bma.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bma.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bma.b> {
      private final List<bma.b> a;

      d(List<bma.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bma.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bma.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bma.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bma.d a() {
         ListIterator<bma.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bma.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bma.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bma.b> b() {
         return this.a.stream();
      }

      public Set<bma.c> c() {
         return this.a.stream().map(bma.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bma.c b) implements bma.b {
