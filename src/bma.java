...
public class bma<E extends bji> extends bkx<E> {
   ...
   protected int k;
   protected long l;
   private final Function<E, apc> q;
   private final BiPredicate<E, gw> r;

   public bma(bgj $$0, int $$1, int $$2, float $$3, Function<E, apc> $$4) {
   ...
   public bma(bgj $$0, int $$1, int $$2, float $$3, Function<E, apc> $$4, BiPredicate<E, gw> $$5) {
   ...
   protected boolean b(akq $$0, bji $$1, long $$2) {
   ...
   protected void a(akq $$0, E $$1, long $$2) {
      ...
      this.h = gw.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new bma.a($$1x.i(), arw.c($$3.j($$1x))))
   ...
   protected void c(akq $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.f(this.j.a($$4 / $$3));
            $$1.dN().a(bsh.S, true);
            $$0.a(null, $$1, this.q.apply($$1), ape.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   private boolean a(akq $$0, E $$1, gw $$2) {
      gw $$3 = $$1.dl();
      int $$4 = $$3.u();
      int $$5 = $$3.w();
