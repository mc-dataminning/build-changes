...
public class gnc implements gmx.a {
   private final fjx a;
   ...
   public void a(fek $$0, gix $$1, double $$2, double $$3, double $$4) {
      ...
      for (jh $$8 : jh.c($$6.b(-10, -10, -10), $$6.b(10, 10, 10))) {
         ...
         int $$11 = azn.g($$10, 0.9F, 0.9F);
         long $$12 = kj.e($$8.a());
         if ($$7.add($$12)) {
            gmx.a(
               $$0,
               $$1,
               $$5.P().p().a(dfo.a, kj.a($$12)),
         ...
         if ($$9 != 15) {
            gmx.a($$0, $$1, String.valueOf($$9), (double)$$8.u() + 0.5, (double)$$8.v() + 0.25, (double)$$8.w() + 0.5, $$11);
         }
      }
   }
}
