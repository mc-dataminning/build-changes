...
public class gnc implements gng.a {
   private final fke a;
   private static final int b = axx.a(255, 0, 155, 155);
   private static final int c = axx.a(255, 255, 255, 0);
   ...
   public void a(fer $$0, gjg $$1, double $$2, double $$3, double $$4) {
      bul $$5 = this.a.j.k().g();
      float $$6 = (float)((double)this.a.s.K_() - $$3);
      float $$7 = (float)((double)(this.a.s.al() + 1) - $$3);
      des $$8 = $$5.dx();
      float $$9 = (float)((double)$$8.d() - $$2);
      float $$10 = (float)((double)$$8.e() - $$4);
      fev $$11 = $$1.getBuffer(gjq.a(1.0));
      Matrix4f $$12 = $$0.c().a();
      ...
      for (int $$19 = this.a.s.K_(); $$19 <= this.a.s.al() + 1; $$19 += 2) {
      ...
      for (int $$24 = this.a.s.K_(); $$24 <= this.a.s.al() + 1; $$24 += 16) {
