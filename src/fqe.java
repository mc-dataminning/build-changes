...
public class fqe {
   public static void a(ghg $$0, fqc $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fqb>> $$6 : $$1.c().entrySet()) {
         Optional<gjo> $$7 = $$0.a($$6.getKey());
         List<fqb> $$8 = $$6.getValue();
   ...
   private static float a(fqc $$0, long $$1) {
