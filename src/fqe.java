...
public class fqe {
   ...
   public fpx a(Vector3f $$0, Vector3f $$1, fpz $$2, gaa $$3, hx $$4, gcj $$5, @Nullable fqa $$6, boolean $$7, afw $$8) {
      fqb $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = asy.i($$11, $$9.a[0], $$12);
      $$9.a[2] = asy.i($$11, $$9.a[2], $$12);
      $$9.a[1] = asy.i($$11, $$9.a[1], $$13);
      $$9.a[3] = asy.i($$11, $$9.a[3], $$13);
      ...
      return new fpx($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fqb a(fqb $$0, hx $$1, j $$2, afw $$3) {
      Matrix4f $$4 = hs.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(asy.b($$23), asy.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fqb(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fqb $$0, gaa $$1, hx $$2, float[] $$3, j $$4, @Nullable fqa $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[hx.values().length];
      $$2[fos.a.f] = $$0.x() / 16.0F;
      $$2[fos.a.e] = $$0.y() / 16.0F;
      $$2[fos.a.d] = $$0.z() / 16.0F;
      $$2[fos.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, hx $$2, fqb $$3, float[] $$4, gaa $$5, j $$6, @Nullable fqa $$7, boolean $$8) {
      fos.b $$9 = fos.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gaa $$3, fqb $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fqa $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static hx a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? hx.b : $$7;
      }
   }

   private void a(int[] $$0, hx $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[hx.values().length];
      $$3[fos.a.f] = 999.0F;
      $$3[fos.a.e] = 999.0F;
      $$3[fos.a.d] = 999.0F;
      $$3[fos.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (asy.a($$13, $$18) && asy.a($$14, $$19) && asy.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
