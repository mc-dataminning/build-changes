...
public class fqe extends cvr {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dpj e = new dpj();
   private final dpp<bnq> f = new dpp<>(bnq.class, new fqe.b());
   private final fqf D;
   private final fvr E;
   private final fqe.a F;
   private final fvi G;
   private final bmh H;
   private final exo I = exo.P();
   final List<fus> J = Lists.newArrayList();
   private final Map<String, eig> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<cvc, eyt> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(fvf.a, new eyt($$0xx -> this.b($$0xx, fvf.a)));
      $$0x.put(fvf.b, new eyt($$0xx -> this.b($$0xx, fvf.b)));
      $$0x.put(fvf.c, new eyt($$0xx -> this.b($$0xx, fvf.c)));
   });
   private final fqa O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final frn R = new frn();
   private static final Set<coy> S = Set.of(cpg.hA, cpg.hB);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(hz $$0, dlj $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(hz $$0, dlj $$1, enz $$2) {
      dlj $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         chl $$4 = this.I.s;
   ...
   public fqe(fqf $$0, fqe.a $$1, aix<cvr> $$2, ij<dov> $$3, int $$4, int $$5, Supplier<bin> $$6, fvr $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.w(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fqa(this, $$4);
      this.H = new bmh();
      this.F = $$1;
      this.E = $$7;
      this.G = fvi.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.Z().a(cvn.l).a(false, null);
      } else {
         this.Z().a(cvn.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<bnq> e() {
      return this.G().a();
   }
   ...
   private void a(bnq $$0, bnq $$1) {
      if ($$1.dH() || $$1.cZ() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof chl || this.e.c($$1)) {
         $$1.bp();
         $$1.ag++;
         $$1.t();
   ...
   @Override
   public void W() {
      this.D.l().a(vq.c("multiplayer.status.quitting"));
   }
   ...
   private cys p() {
      if (this.I.q.j() == cvo.b) {
         cpd $$0 = this.I.s.eT();
         coy $$1 = $$0.d();
         if (S.contains($$1) && $$1 instanceof cmw $$2) {
            return $$2.e();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, awp $$4, @Nullable cys $$5, hz.a $$6) {
      ...
      if ($$5 == $$10.b()) {
         this.a(new jr(jz.d, $$10), (double)$$7 + 0.5, (double)$$8 + 0.5, (double)$$9 + 0.5, 0.0, 0.0, 0.0);
      }
   ...
   private void a(hz $$0, dlj $$1, jx $$2, boolean $$3) {
      if ($$1.u().c()) {
         eos $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(ie.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(hz $$0, jx $$1, eos $$2, double $$3) {
      this.a((double)$$0.u() + $$2.b(ie.a.a), (double)$$0.u() + $$2.c(ie.a.a), (double)$$0.w() + $$2.b(ie.a.c), (double)$$0.w() + $$2.c(ie.a.c), $$3, $$1);
   }

   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, jx $$5) {
      this.a($$5, awi.d(this.z.j(), $$0, $$1), $$4, awi.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }

   @Override
   public p a(o $$0) {
      p $$1 = super.a($$0);
      $$1.a("Server brand", () -> this.I.s.cq.g());
   ...
   public void a(@Nullable chl $$0, bnq $$1, ij<atk> $$2, atm $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.aj().a((gko)(new gkf($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bnq $$0, atk $$1, atm $$2, float $$3, float $$4) {
      this.I.aj().a((gko)(new gkf($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, atk $$3, atm $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.I.j.m().b().c($$0, $$1, $$2);
      gkj $$10 = new gkj($$3, $$4, $$5, $$6, awp.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, @Nullable sw $$6) {
      this.I.g.a(new fst.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
   }
   ...
   public ij<cwq> a(int $$0, int $$1, int $$2) {
      return this.I_().d(kg.at).f(cwx.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (awi.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = awi.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public enz a(enz $$0, float $$1) {
      float $$2 = this.f($$1);
      enz $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      cws $$4 = this.G_();
      enz $$5 = avj.a($$3, ($$1x, $$2x, $$3x) -> enz.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = awi.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = awi.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new enz((double)$$7, (double)$$8, (double)$$9);
   }

   public enz h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = awi.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = awi.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new enz((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (awi.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = awi.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(hz $$0, cvc $$1) {
      eyt $$2 = (eyt)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(hz $$0, cvc $$1) {
      int $$2 = exo.P().m.C().c();
      if ($$2 == 0) {
         ...
         int $$5 = 0;
         int $$6 = 0;
         ib $$7 = new ib($$0.u() - $$2, $$0.v(), $$0.w() - $$2, $$0.u() + $$2, $$0.v(), $$0.w() + $$2);
         hz.a $$8 = new hz.a();
   ...
   protected Map<String, eig> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<String, eig> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements eiz {
      ...
      public a(blt $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new cvn();
   ...
   final class b implements dpl<bnq> {
      public void a(bnq $$0) {
      }
