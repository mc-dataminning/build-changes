...
public class fqe {
   public static class a implements fqw<ka> {
      ...
      public fqt a(ka $$0, fnq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqe.b $$8 = new fqe.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends frt {
      b(fnq $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * aun.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends frf {
      private boolean b;
      private boolean F;
      private final fqv G;
      private float H;
      ...
      c(fnq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fqv $$7, fro $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fqe.c $$0 = new fqe.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fqw<ka> {
      ...
      public fqt a(ka $$0, fnq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqe.c $$8 = new fqe.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, evg.O().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fqr {
      private int a;
      private final fqv b;
      private st D;
      private boolean E;

      public e(fnq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fqv $$7, @Nullable sn $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, ars.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            sn $$7 = this.D.a($$6);
            cmb.a $$8 = cmb.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            fqt $$17 = this.b.a(jx.L, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               arq $$19 = $$18 ? arr.io : arr.in;
               this.c.a(this.g, this.h, this.i, $$19, ars.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fqe.c $$10 = (fqe.c)this.b.a(jx.C, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = aun.d($$18, $$13, $$16) * $$0;
                  double $$20 = aun.d($$18, $$14, $$17) * $$0;
