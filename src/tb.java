...
public class tb {
   ...
   public static faw a(dvs $$0) {
      return faw.a(b($$0));
   }

   public static enf b(dvs $$0) {
      ji $$1 = c($$0);
      ji $$2 = a($$1, $$0.j(), $$0.s());
      return enf.a($$1, $$2);
   }

   public static ji c(dvs $$0) {
      return $$0.aA_().a((km)$$0.f());
   }

   public static void a(ji $$0, ji $$1, dqf $$2, ard $$3) {
      ji $$4 = erp.a($$0.a((km)$$1), dom.a, $$2, $$0);
      $$3.b($$4, djp.gi.m());
      duk $$5 = (duk)$$3.c_($$4);
      $$5.b().a("test runclosest");
      ji $$6 = erp.a($$4.b(0, 0, -1), dom.a, $$2, $$4);
      $$3.b($$6, djp.dZ.m().a($$2));
   }

   public static void a(String $$0, ji $$1, km $$2, dqf $$3, ard $$4) {
      enf $$5 = b($$1.d(), $$2, $$3);
      a($$5, $$4);
      $$4.b($$1, djp.pC.m());
      dvs $$6 = (dvs)$$4.c_($$1);
   ...
   public static ji a(sl $$0, ji $$1, dqf $$2, ard $$3) {
   ...
   public static dvs b(sl $$0, ji $$1, dqf $$2, ard $$3) {
      km $$4 = $$3.r().b(akv.a($$0.t())).orElseThrow(() -> new IllegalStateException("Missing test structure: " + $$0.t())).a();
      enf $$5 = b($$1, $$4, $$2);
      ji $$6 = a($$0, $$1, $$2, $$3);
      b($$5, $$3);
   ...
   public static void a(faw $$0, ard $$1, boolean $$2) {
   ...
   public static void a(faw $$0, ard $$1) {
      ji $$2 = ji.a($$0.a, $$0.b, $$0.c).b(-1, 0, -1);
      ji $$3 = ji.a($$0.d, $$0.e, $$0.f);
      ji.d($$2, $$3).forEach($$3x -> {
         boolean $$4 = $$3x.u() == $$2.u() || $$3x.u() == $$3.u() || $$3x.w() == $$2.w() || $$3x.w() == $$3.w();
         boolean $$5 = $$3x.v() == $$3.v();
         if ($$1.a_($$3x).a(djp.iu) && ($$4 || $$5)) {
            $$1.b($$3x, djp.a.m());
         }
      });
   }

   private static void b(enf $$0, ard $$1) {
      $$0.b().forEach($$1x -> $$1.a($$1x.h, $$1x.i, true));
   }

   public static void a(enf $$0, ard $$1) {
      int $$2 = $$0.i() - 1;
      enf $$3 = new enf($$0.h() - 2, $$0.i() - 3, $$0.j() - 3, $$0.k() + 3, $$0.l() + 20, $$0.m() + 3);
      ji.a($$3).forEach($$2x -> a($$2, $$2x, $$1));
      $$1.n().a($$3);
      $$1.a($$3);
      faw $$4 = faw.a($$3);
      List<bum> $$5 = $$1.a(bum.class, $$4, $$0x -> !($$0x instanceof coy));
      $$5.forEach(bum::at);
   }

   public static ji a(ji $$0, km $$1, dqf $$2) {
      ji $$3 = $$0.a($$1).b(-1, -1, -1);
      return erp.a($$3, dom.a, $$2, $$0);
   }

   public static enf b(ji $$0, km $$1, dqf $$2) {
      ji $$3 = a($$0, $$1, $$2);
      enf $$4 = enf.a($$0, $$3);
   ...
   public static Stream<ji> a(ji $$0, int $$1, ard $$2, String $$3) {
      return c($$0, $$1, $$2).map($$1x -> (dvs)$$2.c_($$1x)).filter(Objects::nonNull).filter($$1x -> Objects.equals($$1x.c(), $$3)).map(dua::aA_).map(ji::j);
   }

   public static Stream<ji> c(ji $$0, int $$1, ard $$2) {
      enf $$3 = d($$0, $$1, $$2);
      return ji.a($$3).filter($$1x -> $$2.a_($$1x).a(djp.pC)).map(ji::j);
   }

   private static dvs c(sl $$0, ji $$1, dqf $$2, ard $$3) {
      $$3.b($$1, djp.pC.m());
      dvs $$4 = (dvs)$$3.c_($$1);
      $$4.a(dyh.b);
      $$4.a($$2);
   ...
   private static enf d(ji $$0, int $$1, ard $$2) {
      ji $$3 = ji.a((double)$$0.u(), (double)$$2.a(ect.a.b, $$0).v(), (double)$$0.w());
      return new enf($$3).c($$1, 10, $$1);
   }

   public static Stream<ji> a(ji $$0, bum $$1, ard $$2) {
      int $$3 = 200;
      fbb $$4 = $$1.bF();
      fbb $$5 = $$4.e($$1.bT().c(200.0));
      return c($$0, 200, $$2)
         .map($$1x -> $$2.a($$1x, duc.v))
