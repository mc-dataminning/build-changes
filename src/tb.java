...
public class tb {
   ...
   private static final Map<String, Consumer<aqn>> c = Maps.newHashMap();
   private static final Map<String, Consumer<aqn>> d = Maps.newHashMap();
   ...
   private static <T extends Annotation> void a(Method $$0, Class<T> $$1, Function<T, String> $$2, Map<String, Consumer<aqn>> $$3) {
      T $$4 = $$0.getAnnotation($$1);
      if ($$4 != null) {
         String $$5 = $$2.apply($$4);
         Consumer<aqn> $$6 = $$3.putIfAbsent($$5, (Consumer<aqn>)d($$0));
         if ($$6 != null) {
   ...
   public static Consumer<aqn> c(String $$0) {
      return c.getOrDefault($$0, $$0x -> {
      });
   }

   public static Consumer<aqn> d(String $$0) {
