...
public class tb {
   ...
   private jf c;
   private final arj d;
   private final Collection<tc> e = Lists.newArrayList();
   private final int f;
   private final Collection<tf> g = Lists.newCopyOnWriteArrayList();
   ...
   public tb(tv $$0, doa $$1, arj $$2, to $$3) {
      this.a = $$0;
      this.d = $$2;
      this.o = $$3;
      this.f = $$0.f();
   ...
   public void a(te $$0) {
      if (!this.j()) {
         ...
         if (this.l || tr.b(this.t).b().allMatch($$0x -> this.d.f($$0x.l()))) {
            this.l = true;
            if (this.D()) {
               this.E();
               if (this.j()) {
   ...
   private void E() {
      ...
      if (this.m >= 0L) {
         ...
         if (this.m > (long)this.f) {
            if (this.g.isEmpty()) {
               this.a(new ti("Didn't succeed or fail within " + this.a.f() + " ticks"));
            } else {
               this.g.forEach($$0x -> $$0x.b(this.m));
               if (this.s == null) {
                  this.a(new ti("No sequences finished"));
               }
            }
         } else {
   ...
   public void l() {
      if (this.s == null) {
         this.G();
         eyr $$0 = this.d();
         List<btr> $$1 = this.f().a(btr.class, $$0.g(1.0), $$0x -> !($$0x instanceof cnx));
         $$1.forEach($$0x -> $$0x.a(btr.c.b));
      }
   }
   ...
   public tb n() {
      jf $$0 = this.C();
      this.t = tr.b(this, $$0, this.t(), this.d);
      this.b = this.t.aC_();
      tr.a(this.b, new jf(1, 0, -1), this.t(), this.d);
      tr.a(this.d(), this.d, !this.a.l());
   ...
   public tb B() {
      tb $$0 = new tb(this.a, this.r, this.d, this.z());
      if (this.c != null) {
         $$0.b(this.c);
      }
