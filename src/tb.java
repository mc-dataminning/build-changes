...
public class tb {
   ...
   public static void a(ji $$0, ji $$1, dqe $$2, arc $$3) {
   ...
   public static void a(String $$0, ji $$1, km $$2, dqe $$3, arc $$4) {
      ene $$5 = b($$1.d(), $$2, $$3);
      a($$5, $$4);
      $$4.b($$1, djo.pC.m());
      dvr $$6 = (dvr)$$4.c_($$1);
   ...
   public static ji a(sl $$0, ji $$1, dqe $$2, arc $$3) {
   ...
   public static dvr b(sl $$0, ji $$1, dqe $$2, arc $$3) {
      km $$4 = $$3.r().b(aku.a($$0.t())).orElseThrow(() -> new IllegalStateException("Missing test structure: " + $$0.t())).a();
      ene $$5 = b($$1, $$4, $$2);
      ji $$6 = a($$0, $$1, $$2, $$3);
      b($$5, $$3);
   ...
   public static void a(fav $$0, arc $$1, boolean $$2) {
   ...
   public static void a(fav $$0, arc $$1) {
   ...
   private static void b(ene $$0, arc $$1) {
      $$0.b().forEach($$1x -> $$1.a($$1x.h, $$1x.i, true));
   }

   public static void a(ene $$0, arc $$1) {
      int $$2 = $$0.i() - 1;
      ...
      $$1.a($$3);
      fav $$4 = fav.a($$3);
      List<buk> $$5 = $$1.a(buk.class, $$4, $$0x -> !($$0x instanceof cox));
      $$5.forEach(buk::at);
   }
   ...
   private static dvr c(sl $$0, ji $$1, dqe $$2, arc $$3) {
      $$3.b($$1, djo.pC.m());
      dvr $$4 = (dvr)$$3.c_($$1);
      $$4.a(dyg.b);
      $$4.a($$2);
   ...
   private static ene d(ji $$0, int $$1, arc $$2) {
      ji $$3 = ji.a((double)$$0.u(), (double)$$2.a(ecs.a.b, $$0).v(), (double)$$0.w());
      return new ene($$3).c($$1, 10, $$1);
   }

   public static Stream<ji> a(ji $$0, buk $$1, arc $$2) {
      int $$3 = 200;
      fba $$4 = $$1.bF();
