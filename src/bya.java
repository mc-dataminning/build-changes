...
public abstract class bya extends bil {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<bil> b = $$0 -> $$0 instanceof bya;
   private int f;
   protected gw c;
   protected hc d;

   protected bya(bip<? extends bya> $$0, cpq $$1) {
      super($$0, $$1);
      this.d = hc.d;
   }

   protected bya(bip<? extends bya> $$0, cpq $$1, gw $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void s() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new ehd($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable bil var1);
