...
public abstract class bga extends DataFix {
   private final String a;

   public bga(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bfp.z);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bfp.z);
      Type<Pair<String, String>> $$2 = DSL.named(bfp.x.typeName(), bgz.a());
      if (!Objects.equals(this.getOutputSchema().getType(bfp.x), $$2)) {
