...
public class bga extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(bjb.L));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(bjb.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(bjb.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(bjb.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(bjb.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(bjb.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(bjb.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(bjb.s);
      Type<?> $$9 = this.getOutputSchema().getType(bjb.s);
