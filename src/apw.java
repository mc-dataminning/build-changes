...
public class apw {
   ...
   private static int a(ew $$0, Collection<? extends cor> $$1, int $$2) {
      for (cor $$3 : $$1) {
         $$3.ad().ifPresent($$1x -> $$1x.a($$2));
      }

      if ($$1.size() == 1) {
         $$0.a(() -> xl.a("commands.warden_spawn_tracker.set.success.single", $$1.iterator().next().S_()), true);
      } else {
   ...
   private static int a(ew $$0, Collection<? extends cor> $$1) {
      for (cor $$2 : $$1) {
         $$2.ad().ifPresent(cnv::b);
      }

      if ($$1.size() == 1) {
         $$0.a(() -> xl.a("commands.warden_spawn_tracker.clear.success.single", $$1.iterator().next().S_()), true);
      } else {
