...
public class apw extends apv {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, apw.a> s;
   private final apr t;
   private long u;
   private final agm v;

   private apw(agm $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aps.c($$2, 7, $$0.getLength());
      }
   }
