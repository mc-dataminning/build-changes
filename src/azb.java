...
public class azb {
   ...
   private static final Optional<Object> b = Optional.of(azk.a);

   private static boolean a(xr $$0, axt $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xr $$1, axt $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xr $$1, axt $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xr $$1, axt $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xr $$2, axt $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xr $$2, xr $$3, axt $$4) {
      int $$5 = $$0.length();
      xr $$6 = $$2;
   ...
   public static boolean a(wz $$0, xr $$1, axt $$2) {
