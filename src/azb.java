...
public class azb extends awa {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), azb::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", azb::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", azb::k);
         $$0 = this.a($$0, "minecraft:fox", azb::j);
         $$0 = this.a($$0, "minecraft:item", azb::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", azb::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", azb::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", azb::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", azb::e);
         return this.a($$0, "minecraft:piglin", azb::d);
      });
   }
