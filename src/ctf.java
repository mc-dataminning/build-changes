...
public abstract class ctf extends csb {
   private static final int m = 9;
   private static final int n = 3;
   private static final int o = 0;
   protected final cso q;
   protected final cow r;
   protected final bsc s;
   protected final ctt t = new ctt() {
      @Override
      public void e() {
         ctf.this.a(this);
      }
   ...
   protected boolean a(cow $$0, boolean $$1) {
      return true;
   }

   protected abstract void a(cow var1, cwo var2);

   protected abstract boolean a(dww var1);

   public ctf(@Nullable ctk<?> $$0, int $$1, cov $$2, cso $$3, ctg $$4) {
      super($$0, $$1);
      this.q = $$3;
      this.r = $$2.k;
      this.s = this.e($$4.d());
   ...
   private void a(ctg $$0) {
      for (final ctg.b $$1 : $$0.c()) {
         this.a(new cty(this.s, $$1.a(), $$1.b(), $$1.c()) {
            @Override
   ...
   private void b(ctg $$0) {
      this.a(new cty(this.t, $$0.b().a(), $$0.b().b(), $$0.b().c()) {
         @Override
         public boolean a(cwo $$0) {
            return false;
         }
