...
public abstract class dua implements dbg, ddb.a, dum, duw {
   ...
   @Nullable
   protected dya e;
   protected final dux f;
   @Nullable
   protected dyz g;
   protected final Map<dxw.a, dxw> h = Maps.newEnumMap(dxw.a.class);
   protected enh i;
   private final Map<eim, eiu> s = Maps.newHashMap();
   private final Map<eim, LongSet> t = Maps.newHashMap();
   protected final Map<iz, us> j = Maps.newHashMap();
   protected final Map<iz, dpj> k = new Object2ObjectOpenHashMap();
   protected final dcc l;
   protected final dul[] m;

   public dua(dbh $$0, dux $$1, dcc $$2, jv<dcz> $$3, long $$4, @Nullable dul[] $$5, @Nullable dyz $$6) {
      this.d = $$0;
      this.f = $$1;
      this.l = $$2;
      this.m = new dul[$$2.an()];
   ...
   private static void a(jv<dcz> $$0, dul[] $$1) {
   ...
   @Nullable
   public abstract dse a(iz var1, dse var2, boolean var3);

   public abstract void a(dpj var1);

   public abstract void a(bsw var1);
   ...
   public Collection<Entry<dxw.a, dxw>> e() {
   ...
   public dxw a(dxw.a $$0) {
      return this.h.computeIfAbsent($$0, $$0x -> new dxw(this, $$0x));
   }

   public boolean b(dxw.a $$0) {
   ...
   public int a(dxw.a $$0, int $$1, int $$2) {
      dxw $$3 = this.h.get($$0);
      if ($$3 == null) {
         if (aa.aX && this instanceof duk) {
            n.error("Unprimed heightmap: " + $$0 + " " + $$1 + " " + $$2);
         }

         dxw.a(this, EnumSet.of($$0));
         $$3 = this.h.get($$0);
      }
   ...
   @Override
   public final void a(BiConsumer<iz, dse> $$0) {
      this.a($$0x -> $$0x.h() != 0, $$0);
   }
   ...
   public abstract exn<dfb> o();

   public abstract exn<enw> p();

   public abstract dua.a q();
   ...
   public dya a(Function<dua, dya> $$0) {
      if (this.e == null) {
         this.e = $$0.apply(this);
      }
   ...
   public static record a(exl<dfb> a, exl<enw> b) {
   }
}
