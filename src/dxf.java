...
public class dxf implements dxm.c {
   ...
   private final ObjectListIterator<dxf.a> h;
   private final ObjectListIterator<ejk> i;

   public static dxf a(dcp $$0, dbd $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<dxf.a> $$4 = new ObjectArrayList(10);
      ObjectList<ejk> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eit.a).forEach($$5x -> {
         eit $$6 = $$5x.h().d();
         ...
         for (eim $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eie) {
                  ...
                  $$4.add(new dxf.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new dxf($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public dxf(ObjectListIterator<dxf.a> $$0, ObjectListIterator<ejk> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = ayx.g($$0, $$1, $$2);
      return ayx.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = ayx.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * ayx.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = ayx.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(eia a, eit b, int c) {
   }
}
