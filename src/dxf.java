...
public class dxf extends dxk {
   public static final Codec<dxf> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dxf::new));
   ...
   public List<dvs.a> a(cud $$0, BiConsumer<hx, djp> $$1, auw $$2, int $$3, hx $$4, dvc $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = aup.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, aup.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dxf.a> $$13 = Lists.newArrayList();
      $$13.add(new dxf.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               hx $$21 = $$4.b(aup.a($$19), $$12 - 1, aup.a($$20));
               hx $$22 = $$21.b(5);
      ...
      List<dvs.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cud $$0, BiConsumer<hx, djp> $$1, auw $$2, hx $$3, hx $$4, boolean $$5, dvc $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            hx $$13 = $$3.b(aup.d(0.5F + (float)$$12 * $$9), aup.d(0.5F + (float)$$12 * $$10), aup.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(ddj.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cud $$0, BiConsumer<hx, djp> $$1, auw $$2, int $$3, hx $$4, List<dxf.a> $$5, dvc $$6) {
      for (dxf.a $$7 : $$5) {
         int $$8 = $$7.a();
