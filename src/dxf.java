...
public class dxf {
   ...
   static class a implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
         return $$0.c[hc.f.d()] && !$$0.b[hc.f.d()].d;
      }

      @Override
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         $$1.d = true;
         $$1.b[hc.f.d()].d = true;
         return new dxf.k($$0, $$1);
      }
   }

   static class b implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         ...
         return new dxf.l($$0, $$1);
      }
   }

   static class c implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         $$1.d = true;
         $$1.b[hc.b.d()].d = true;
         return new dxf.m($$0, $$1);
      }
   }

   static class d implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         ...
         return new dxf.n($$0, $$1);
      }
   }

   static class e implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         ...
         $$3.d = true;
         $$3.b[hc.c.d()].d = true;
         return new dxf.o($$0, $$3);
      }
   }

   static class f implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
         return true;
      }
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         $$1.d = true;
         return new dxf.s($$0, $$1, $$2);
      }
   }

   static class g implements dxf.i {
      @Override
      public boolean a(dxf.v $$0) {
      ...
      public dxf.r a(hc $$0, dxf.v $$1, arx $$2) {
         $$1.d = true;
         return new dxf.t($$0, $$1);
      }
   }

   public static class h extends dxf.r {
      ...
      private dxf.v G;
      private dxf.v H;
      private final List<dxf.r> I = Lists.newArrayList();

      public h(arx $$0, int $$1, int $$2, hc $$3) {
         super(dvu.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxf.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxf.p($$3, this.G));
         this.I.add(new dxf.j($$3, this.H));
         List<dxf.i> $$5 = Lists.newArrayList();
         $$5.add(new dxf.b());
         $$5.add(new dxf.d());
         $$5.add(new dxf.e());
         $$5.add(new dxf.a());
         ...
         duv $$10 = duv.a(this.b(1, 1, 1), this.b(23, 8, 21));
         duv $$11 = duv.a(this.b(34, 1, 1), this.b(56, 8, 21));
         duv $$12 = duv.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxf.u($$3, $$10, $$13++));
         this.I.add(new dxf.u($$3, $$11, $$13++));
         this.I.add(new dxf.q($$3, $$12));
      }
      ...
      private List<dxf.v> b(arx $$0) {
         dxf.v[] $$1 = new dxf.v[75];
         ...
         dxf.v $$23 = new dxf.v(1003);
         dxf.v $$24 = new dxf.v(1001);
         dxf.v $$25 = new dxf.v(1002);
         $$1[v].a(hc.b, $$23);
         $$1[w].a(hc.d, $$24);
         $$1[x].a(hc.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dxf.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqk $$2, arx $$3, duv $$4) {
         int $$5 = 24;
      ...
      private void a(cqk $$0, arx $$1, duv $$2) {
      ...
      private void b(cqk $$0, arx $$1, duv $$2) {
      ...
      private void c(cqk $$0, arx $$1, duv $$2) {
      ...
      private void d(cqk $$0, arx $$1, duv $$2) {
      ...
      private void e(cqk $$0, arx $$1, duv $$2) {
      ...
      private void f(cqk $$0, arx $$1, duv $$2) {
   ...
   interface i {
      boolean a(dxf.v var1);

      dxf.r a(hc var1, dxf.v var2, arx var3);
   }

   public static class j extends dxf.r {
      public j(hc $$0, dxf.v $$1) {
         super(dvu.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqk $$0, cqi $$1, dhb $$2, arx $$3, duv $$4, cox $$5, gw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csr.ch.n(), csr.ch.n(), false);
   ...
   public static class k extends dxf.r {
      public k(hc $$0, dxf.v $$1) {
         super(dvu.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dxf.r {
      public l(hc $$0, dxf.v $$1) {
         super(dvu.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dxf.r {
      public m(hc $$0, dxf.v $$1) {
         super(dvu.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dxf.r {
      public n(hc $$0, dxf.v $$1) {
         super(dvu.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dxf.r {
      public o(hc $$0, dxf.v $$1) {
         super(dvu.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dxf.r {
      public p(hc $$0, dxf.v $$1) {
         super(dvu.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dxf.r {
      public q(hc $$0, duv $$1) {
         super(dvu.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvh {
      protected static final dfe b = csr.hZ.n();
      protected static final dfe c = csr.ia.n();
      protected static final dfe d = csr.ib.n();
      protected static final dfe h = c;
      protected static final dfe i = csr.ii.n();
      protected static final boolean j = true;
      protected static final dfe k = csr.G.n();
      protected static final Set<csq> l = ImmutableSet.builder().add(csr.dO).add(csr.iC).add(csr.mW).add(k.b()).build();
      ...
      public r(dvu $$0, hc $$1, int $$2, duv $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvu $$0, int $$1, hc $$2, dxf.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static duv a(hc $$0, dxf.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         duv $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqk $$0, duv $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dfe $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cqk $$0, duv $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqk $$0, duv $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dfe $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(duv $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqk $$0, duv $$1, int $$2, int $$3, int $$4) {
         gw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            bys $$6 = bip.A.a((cpq)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eK());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dk()), bjf.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dxf.r {
      private int a;

      public s(hc $$0, dxf.v $$1, arx $$2) {
         super(dvu.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dxf.r {
      public t(hc $$0, dxf.v $$1) {
         super(dvu.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dxf.r {
      private int a;

      public u(hc $$0, duv $$1, int $$2) {
         super(dvu.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
