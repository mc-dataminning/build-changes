...
public class agw {
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("positioned")
                                       ...
                                       .then(du.a("over").then(du.a("heightmap", eh.a()).redirect($$2, $$0x -> {
                                          ...
                                          akr $$2x = ((dt)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(hz.b($$3), hz.b($$4))) {
                                             throw fk.a.create();
                                          } else {
                                             int $$5 = $$2x.a(eh.a($$0x, "heightmap"), arx.a($$3), arx.a($$4));
         ...
         du.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)du.a("id", es.a())
                     .suggests(agg.a)
                     .then(du.a("value").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agg.a($$1x), true, $$2))))
                  .then(du.a("max").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agg.a($$1x), false, $$2)))
            )
      );
   ...
   private static dt a(dt $$0, afv $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4, $$5) -> {
         int $$6 = $$3 ? $$5 : ($$4 ? 1 : 0);
         if ($$2) {
            $$1.a($$6);
   ...
   private static boolean a(akr $$0, gw $$1) {
      cpc $$2 = new cpc($$1);
      dhq $$3 = $$0.k().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == akk.d && $$0.c($$2.a());
   }
               ...
               du.a("entity")
                  .then(
                     ((RequiredArgumentBuilder)du.a("entities", ee.b()).fork($$0, $$1x -> a($$1x, $$2, !ee.c($$1x, "entities").isEmpty())))
                        .executes(a($$2, (agw.a)($$0x -> ee.c($$0x, "entities").size())))
                  )
            ))
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)du.a("path", ej.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), ej.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (agw.a)($$1xx -> a($$4.a($$1xx), ej.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static Command<dt> a(boolean $$0, agw.a $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
   ...
   private static int a(ajh $$0, ej.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }
   ...
   private static OptionalInt a(akr $$0, gw $$1, gw $$2, gw $$3, boolean $$4) throws CommandSyntaxException {
      dva $$5 = dva.a($$1, $$2);
