...
public class eko {
   ...
   static class a implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
         return $$0.c[je.f.d()] && !$$0.b[je.f.d()].d;
      }

      @Override
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         $$1.d = true;
         $$1.b[je.f.d()].d = true;
         return new eko.k($$0, $$1);
      }
   }

   static class b implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         ...
         return new eko.l($$0, $$1);
      }
   }

   static class c implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         $$1.d = true;
         $$1.b[je.b.d()].d = true;
         return new eko.m($$0, $$1);
      }
   }

   static class d implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         ...
         return new eko.n($$0, $$1);
      }
   }

   static class e implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         ...
         $$3.d = true;
         $$3.b[je.c.d()].d = true;
         return new eko.o($$0, $$3);
      }
   }

   static class f implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
         return true;
      }
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         $$1.d = true;
         return new eko.s($$0, $$1, $$2);
      }
   }

   static class g implements eko.i {
      @Override
      public boolean a(eko.v $$0) {
      ...
      public eko.r a(je $$0, eko.v $$1, azc $$2) {
         $$1.d = true;
         return new eko.t($$0, $$1);
      }
   }

   public static class h extends eko.r {
      ...
      private eko.v G;
      private eko.v H;
      private final List<eko.r> I = Lists.newArrayList();

      public h(azc $$0, int $$1, int $$2, je $$3) {
         super(eiw.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eko.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eko.p($$3, this.G));
         this.I.add(new eko.j($$3, this.H));
         List<eko.i> $$5 = Lists.newArrayList();
         $$5.add(new eko.b());
         $$5.add(new eko.d());
         $$5.add(new eko.e());
         $$5.add(new eko.a());
         ...
         ehx $$10 = ehx.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ehx $$11 = ehx.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ehx $$12 = ehx.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eko.u($$3, $$10, $$13++));
         this.I.add(new eko.u($$3, $$11, $$13++));
         this.I.add(new eko.q($$3, $$12));
      }
      ...
      private List<eko.v> b(azc $$0) {
         eko.v[] $$1 = new eko.v[75];
         ...
         eko.v $$23 = new eko.v(1003);
         eko.v $$24 = new eko.v(1001);
         eko.v $$25 = new eko.v(1002);
         $$1[v].a(je.b, $$23);
         $$1[w].a(je.d, $$24);
         $$1[x].a(je.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eko.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dco $$2, azc $$3, ehx $$4) {
         int $$5 = 24;
      ...
      private void a(dco $$0, azc $$1, ehx $$2) {
      ...
      private void b(dco $$0, azc $$1, ehx $$2) {
      ...
      private void c(dco $$0, azc $$1, ehx $$2) {
      ...
      private void d(dco $$0, azc $$1, ehx $$2) {
      ...
      private void e(dco $$0, azc $$1, ehx $$2) {
      ...
      private void f(dco $$0, azc $$1, ehx $$2) {
   ...
   interface i {
      boolean a(eko.v var1);

      eko.r a(je var1, eko.v var2, azc var3);
   }

   public static class j extends eko.r {
      public j(je $$0, eko.v $$1) {
         super(eiw.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dco $$0, dcm $$1, dtu $$2, azc $$3, ehx $$4, dba $$5, iz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dew.ch.n(), dew.ch.n(), false);
   ...
   public static class k extends eko.r {
      public k(je $$0, eko.v $$1) {
         super(eiw.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eko.r {
      public l(je $$0, eko.v $$1) {
         super(eiw.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eko.r {
      public m(je $$0, eko.v $$1) {
         super(eiw.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eko.r {
      public n(je $$0, eko.v $$1) {
         super(eiw.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eko.r {
      public o(je $$0, eko.v $$1) {
         super(eiw.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eko.r {
      public p(je $$0, eko.v $$1) {
         super(eiw.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eko.r {
      public q(je $$0, ehx $$1) {
         super(eiw.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eij {
      protected static final drx b = dew.hZ.n();
      protected static final drx c = dew.ia.n();
      protected static final drx d = dew.ib.n();
      protected static final drx h = c;
      protected static final drx i = dew.ii.n();
      protected static final boolean j = true;
      protected static final drx k = dew.G.n();
      protected static final Set<deu> l = ImmutableSet.builder().add(dew.dO).add(dew.iC).add(dew.mW).add(k.b()).build();
      ...
      public r(eiw $$0, je $$1, int $$2, ehx $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eiw $$0, int $$1, je $$2, eko.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ehx a(je $$0, eko.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ehx $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dco $$0, ehx $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  drx $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dco $$0, ehx $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dco $$0, ehx $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, drx $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ehx $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dco $$0, ehx $$1, int $$2, int $$3, int $$4) {
         iz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjn $$6 = bsv.D.a((dbt)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), bto.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eko.r {
      private int a;

      public s(je $$0, eko.v $$1, azc $$2) {
         super(eiw.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eko.r {
      public t(je $$0, eko.v $$1) {
         super(eiw.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eko.r {
      private int a;

      public u(je $$0, ehx $$1, int $$2) {
         super(eiw.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
