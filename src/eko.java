...
public class eko extends eku {
   public static final MapCodec<eko> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ekb.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayh.b(jn.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, eko::new)
   );
   ...
   public eko(float $$0, int $$1, int $$2, ekb $$3, int $$4, List<jn> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(eku.a $$0, ji $$1, jn $$2) {
