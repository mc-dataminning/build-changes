...
public class eko implements ekp, ekq {
   ...
   private final epe<MinecraftServer> G;
   ...
   public eko(cxd $$0, dtk $$1, eko.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ib.c,
   ...
   public static <T> eko a(Dynamic<T> $$0, cxd $$1, eko.a $$2, dtk $$3, Lifecycle $$4) {
      ...
      return new eko(
         ...
         new epe<>(epd.a, $$0.get("ScheduledEvents").asStream()),
         (ta)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dqp.a.a).resultOrPartial(f::error).orElse(dqp.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(iz $$0, ta $$1, @Nullable ta $$2) {
      ...
      $$1.a("Version", $$3);
      tp.f($$1);
      DynamicOps<tx> $$4 = ajf.a(to.a, $$0);
      dti.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dqp.a.a.encodeStart(to.a, this.y), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<tx> $$5 = cxt.b.encodeStart(to.a, this.g.g());
   ...
   @Override
   public boolean z() {
      return this.i == eko.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eko.a.c;
   }
