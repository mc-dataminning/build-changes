...
public final class glr {
   ...
   private static final glr c = new glr(HostAndPort.fromParts("server.invalid", 25565));

   public glr(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private glr(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static glr a(String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            return $$1.getHost().isEmpty() ? c : new glr($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof glr ? this.b.equals(((glr)$$0).b) : false;
      }
   }
