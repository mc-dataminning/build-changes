...
public class glr {
   private static final gmh a = gmh.u(aku.b("textures/map/map_background.png"));
   private static final gmh b = gmh.u(aku.b("textures/map/map_background_checkerboard.png"));
   ...
   private float aA;
   private float aB;
   private final gsa aC;
   private final gta aD;

   public glr(flj $$0, gsa $$1, gta $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(bvg $$0, cwp $$1, cwn $$2, boolean $$3, ffu $$4, glx $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dW(), $$6, hea.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(ffu $$0, glx $$1, int $$2, bva $$3) {
      gxj $$4 = (gxj)this.aC.<gks>a(this.au.t);
      $$0.a();
   ...
   private void a(ffu $$0, glx $$1, int $$2, float $$3, bva $$4, float $$5, cwp $$6) {
   ...
   private void a(ffu $$0, glx $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayz.c($$5);
   ...
   private void a(ffu $$0, glx $$1, int $$2, cwp $$3) {
   ...
   private void a(ffu $$0, glx $$1, int $$2, float $$3, float $$4, bva $$5) {
      boolean $$6 = $$5 != bva.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayz.c($$4);
   ...
   private void a(ffu $$0, float $$1, bva $$2, cwp $$3, cox $$4) {
   ...
   private void a(ffu $$0, float $$1, bva $$2, cwp $$3, cox $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(ffu $$0, bva $$1, float $$2) {
      int $$3 = $$1 == bva.b ? 1 : -1;
   ...
   private void b(ffu $$0, bva $$1, float $$2) {
      int $$3 = $$1 == bva.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, ffu $$1, glx.a $$2, gkv $$3, int $$4) {
      float $$5 = $$3.D($$0);
   ...
   private void a(gks $$0, float $$1, float $$2, bsi $$3, float $$4, cwp $$5, float $$6, ffu $$7, glx $$8, int $$9) {
      if (!$$0.gH()) {
         boolean $$10 = $$3 == bsi.a;
         ...
         if ($$5.f()) {
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               ...
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((bvg)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((bvg)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$23 ? cwn.e : cwn.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.D()) {
         ...
         float $$3 = $$0.H(1.0F);
         this.ay = this.ay + ayz.a((this.aw == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + ayz.a((float)(this.ax == $$2 ? 1 : 0) - this.aA, -0.4F, 0.4F);
      }
