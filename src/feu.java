...
public class feu implements AutoCloseable {
   ...
   public void a(feo.a $$0) {
      ...
      label46: {
         try {
            ...
            this.c = new fcm(fck.b, this.a, $$0.a());
            this.f = null;
         } catch (Throwable var6) {
            if ($$0 != null) {
               try {
   ...
   private few a(feq.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(feq.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
         if (this.c != null) {
            this.c.close();
         }

         this.c = new fcm(fck.b, this.a, $$1);
         return null;
      } else {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, @Nullable gip $$2) {
      if ($$2 != null) {
         RenderSystem.assertOnRenderThread();
         $$2.a(this.i, $$0, $$1, fke.Q().aO());
         $$2.b();
         this.c();
         $$2.a();
      }
