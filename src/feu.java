...
public abstract class feu<T extends feu<T>> {
   ...
   public feu(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fes.a();
         if ($$3 != null) {
         ...
         throw new fgb(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fgb(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fgb(var2.getMessage(), var2);
      }
   }
   ...
   public static feu<?> a(String $$0) {
      return new feu.b($$0, 5000, 60000);
   }

   public static feu<?> a(String $$0, int $$1, int $$2) {
      return new feu.b($$0, $$1, $$2);
   }

   public static feu<?> b(String $$0, String $$1) {
      return new feu.c($$0, $$1, 5000, 60000);
   }

   public static feu<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new feu.c($$0, $$1, $$2, $$3);
   }

   public static feu<?> b(String $$0) {
      return new feu.a($$0, 5000, 60000);
   }

   public static feu<?> c(String $$0, String $$1) {
      return new feu.d($$0, $$1, 5000, 60000);
   }

   public static feu<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new feu.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends feu<feu.a> {
   ...
   public static class b extends feu<feu.b> {
   ...
   public static class c extends feu<feu.c> {
      ...
      public feu.c f() {
         try {
            ...
            throw new fgb(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends feu<feu.d> {
      private final String c;
