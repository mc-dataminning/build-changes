...
public class feu extends fea<civ> {
   ...
   protected void aN_() {
      super.aN_();
      this.M = new fjf(this.f.aP().a(fmw.m));
   }
   ...
   private void d(ewu $$0, int $$1, int $$2, float $$3) {
      float $$4 = auo.i($$3, this.D, this.C);
      float $$5 = auo.i($$3, this.z, this.y);
      eox.c();
      $$0.c().a();
      ...
      float $$8 = auo.a(auo.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = auo.a(auo.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.M.a(0.0F, $$8, $$9, $$4);
      eqf $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, gee.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      eox.b();
   }
