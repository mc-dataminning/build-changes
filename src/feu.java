...
public class feu implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<feu.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public feu(List<feu.a> $$0) {
      this.c = $$0;
   }
   ...
   public static feu a(BufferedReader $$0) {
      return new feu($$0.lines().flatMap($$0x -> feu.a.a($$0x).stream()).toList());
   }

   public static record a(feu.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<feu.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new feu.a(feu.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new feu.a(feu.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new feu.a(feu.b.b, $$3));
      ...
      static feu.a b(String $$0) {
         return new feu.a(feu.b.a, "glob:" + $$0);
      }

      static feu.a c(String $$0) {
         return new feu.a(feu.b.a, "regex:" + $$0);
      }

      static feu.a d(String $$0) {
         return new feu.a(feu.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      feu.b a = FileSystem::getPathMatcher;
      feu.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
