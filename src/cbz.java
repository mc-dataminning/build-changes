...
public class cbz extends cce implements ccb {
   private static final adz<cix> b = aec.a(cbz.class, aeb.h);
   private static final adz<OptionalInt> c = aec.a(cbz.class, aeb.u);
   private static final adz<Boolean> d = aec.a(cbz.class, aeb.k);
   private int e;
   private int f;
   @Nullable
   private biy g;

   public cbz(bim<? extends cbz> $$0, cpl $$1) {
      super($$0, $$1);
   }

   public cbz(cpl $$0, double $$1, double $$2, double $$3, cix $$4) {
      super(bim.M, $$0);
      this.e = 0;
      this.e($$1, $$2, $$3);
      int $$5 = 1;
   ...
   public cbz(cpl $$0, @Nullable bii $$1, double $$2, double $$3, double $$4, cix $$5) {
      this($$0, $$2, $$3, $$4, $$5);
      this.b($$1);
   }

   public cbz(cpl $$0, cix $$1, biy $$2) {
      this($$0, $$2, $$2.dp(), $$2.dr(), $$2.dv(), $$1);
      this.an.b(c, OptionalInt.of($$2.ah()));
      this.g = $$2;
   }

   public cbz(cpl $$0, cix $$1, double $$2, double $$3, double $$4, boolean $$5) {
      this($$0, $$2, $$3, $$4, $$1);
      this.an.b(d, $$5);
   }

   public cbz(cpl $$0, cix $$1, bii $$2, double $$3, double $$4, double $$5, boolean $$6) {
      this($$0, $$1, $$3, $$4, $$5, $$6);
      this.b($$2);
   }
      ...
      if ($$0 > 0.0F) {
         ...
         for (biy $$7 : this.dK().a(biy.class, this.cG().g(5.0))) {
            if ($$7 != this.g && !(this.f($$7) > 25.0)) {
               ...
               for (int $$9 = 0; $$9 < 2; $$9++) {
                  ehd $$10 = new ehd($$7.dp(), $$7.e(0.5 * (double)$$9), $$7.dv());
                  ehb $$11 = this.dK().a(new cou($$5, $$10, cou.a.a, cou.b.a, this));
                  if ($$11.c() == ehb.a.a) {
                     $$8 = true;
                     break;
                  }
