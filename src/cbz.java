...
public class cbz extends bil implements bjy {
   ...
   public cbz(bip<? extends cbz> $$0, cpq $$1) {
      super($$0, $$1);
   }

   public cbz(cpq $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bjb $$6) {
      this(bip.H, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   @Nullable
   public bjb j() {
      if (this.i == null && this.j != null && this.dK() instanceof akn) {
         bil $$0 = ((akn)this.dK()).a(this.j);
         if ($$0 instanceof bjb) {
            this.i = (bjb)$$0;
         }
      }
         ...
         if (this.h) {
            ...
            if (this.g == 14) {
               for (int $$0 = 0; $$0 < 12; $$0++) {
                  ...
                  this.dK().a(ix.g, $$1, $$2 + 1.0, $$3, $$4, $$5, $$6);
               }
            }
         }
      } else if (--this.e < 0) {
         if (this.e == -8) {
            for (bjb $$8 : this.dK().a(bjb.class, this.cG().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.h = true;
         if (!this.aS()) {
            this.dK().a(this.dp(), this.dr(), this.dv(), aoz.hu, this.da(), 1.0F, this.ag.i() * 0.2F + 0.85F, false);
         }
      }
   }
