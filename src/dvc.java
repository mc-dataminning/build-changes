...
public class dvc implements duy, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bpi<bpk.b> c;
   private final dvh d;
   private final Map<dba, dvc.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvc(dvj $$0, Path $$1, boolean $$2) {
      this.d = new dvh($$0, $$1, $$2);
      this.c = new bpi<>(new bpk.a(dvc.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dba $$0, int $$1) {
      dba $$2 = new dba($$0.e - $$1, $$0.f - $$1);
      dba $$3 = new dba($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dba $$0, @Nullable ur $$1) {
      return this.a(() -> {
         dvc.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvc.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dba $$0, vl $$1) {
      return this.a(() -> {
         try {
            dvc.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bpk.b(dvc.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dba, dvc.a>> $$0 = this.e.entrySet().iterator();
         Entry<dba, dvc.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bpk.b(dvc.b.b.ordinal(), this::a));
   }

   private void a(dba $$0, dvc.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bpk.b(dvc.b.c.ordinal(), () -> $$0.a(azx.a))).join();
         this.c.close();
