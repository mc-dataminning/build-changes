...
public class det extends cys {
   public static final MapCodec<det> a = b(det::new);
   public static final dmh<dmo> b = dlz.ab;
   public static final dmh<dmo> c = dlz.aa;
   public static final dmh<dmo> d = dlz.ac;
   public static final dmh<dmo> e = dlz.ad;
   public static final dmj f = dlz.aT;
   public static final Map<ie, dmh<dmo>> g = Maps.newEnumMap(ImmutableMap.of(ie.c, b, ie.f, c, ie.d, d, ie.e, e));
   protected static final int h = 1;
   protected static final int i = 3;
   protected static final int j = 13;
   protected static final int k = 3;
   protected static final int l = 13;
   private static final eos m = cys.a(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
   private static final Map<ie, eos> n = Maps.newEnumMap(
      ImmutableMap.of(
         ie.c,
         cys.a(3.0, 0.0, 0.0, 13.0, 1.0, 13.0),
         ie.d,
         cys.a(3.0, 0.0, 3.0, 13.0, 1.0, 16.0),
         ie.f,
         cys.a(3.0, 0.0, 3.0, 16.0, 1.0, 13.0),
         ie.e,
         cys.a(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)
      )
   );
   private static final Map<ie, eos> o = Maps.newEnumMap(
      ImmutableMap.of(
         ie.c,
         eop.a(n.get(ie.c), cys.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         ie.d,
         eop.a(n.get(ie.d), cys.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         ie.f,
         eop.a(n.get(ie.f), cys.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         ie.e,
         eop.a(n.get(ie.e), cys.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   private static final Map<dlj, eos> F = Maps.newHashMap();
   private static final enz[] G = ac.a(new enz[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         float $$2 = (float)$$1 / 15.0F;
         float $$3 = $$2 * 0.6F + ($$2 > 0.0F ? 0.4F : 0.3F);
         float $$4 = awi.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = awi.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
         $$0[$$1] = new enz((double)$$3, (double)$$4, (double)$$5);
      }
   });
   ...
   public det(dli.d $$0) {
      super($$0);
      this.k(this.E.b().a(b, dmo.c).a(c, dmo.c).a(d, dmo.c).a(e, dmo.c).a(f, Integer.valueOf(0)));
      this.I = this.o().a(b, dmo.b).a(c, dmo.b).a(d, dmo.b).a(e, dmo.b);
   ...
   private dlj a(cux $$0, dlj $$1, hz $$2) {
      boolean $$3 = p($$1);
   ...
   private dlj b(cux $$0, dlj $$1, hz $$2) {
      boolean $$3 = !$$0.a_($$2.c()).g($$0, $$2);

      for (ie $$4 : ie.c.a) {
         if (!$$1.c(g.get($$4)).a()) {
            dmo $$5 = this.a($$0, $$2, $$4, $$3);
            $$1 = $$1.a(g.get($$4), $$5);
         }
      }
   ...
   protected void a(dlj $$0, cvs $$1, hz $$2, int $$3, int $$4) {
      ...
      for (ie $$6 : ie.c.a) {
         dmo $$7 = $$0.c(g.get($$6));
         if ($$7 != dmo.c && !$$1.a_($$5.a($$2, $$6)).a(this)) {
            $$5.c(ie.a);
            dlj $$8 = $$1.a_($$5);
            if ($$8.a(this)) {
               hz $$9 = $$5.a($$6.g());
   ...
   private dmo a(cux $$0, hz $$1, ie $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dmo a(cux $$0, hz $$1, ie $$2, boolean $$3) {
      hz $$4 = $$1.a($$2);
      dlj $$5 = $$0.a_($$4);
      if ($$3) {
         boolean $$6 = $$5.b() instanceof dhe || this.a($$0, $$4, $$5);
         if ($$6 && m($$0.a_($$4.c()))) {
            if ($$5.d($$0, $$4, $$2.g())) {
               return dmo.a;
            }
      ...
      return !a($$5, $$2) && ($$5.g($$0, $$4) || !m($$0.a_($$4.d()))) ? dmo.c : dmo.b;
   }
   ...
   private boolean a(cux $$0, hz $$1, dlj $$2) {
      return $$2.d($$0, $$1, ie.b) || $$2.a(cyu.hc);
   }
   ...
   protected static boolean m(dlj $$0) {
      return a($$0, null);
   }

   protected static boolean a(dlj $$0, @Nullable ie $$1) {
      if ($$0.a(cyu.cw)) {
         return true;
      } else if ($$0.a(cyu.eh)) {
         ie $$2 = $$0.c(dey.aE);
         ...
         return $$0.a(cyu.kO) ? $$1 == $$0.c(dec.a) : $$0.m() && $$1 != null;
      }
   }
   ...
   public static int b(int $$0) {
      enz $$1 = G[$$0];
      return awi.f((float)$$1.a(), (float)$$1.b(), (float)$$1.c());
   }

   private void a(cvr $$0, awp $$1, hz $$2, enz $$3, ie $$4, ie $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
   ...
   private void a(cvr $$0, hz $$1, dlj $$2, dlj $$3) {
      for (ie $$4 : ie.c.a) {
         hz $$5 = $$1.a($$4);
