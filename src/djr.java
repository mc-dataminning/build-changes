...
public interface djr<T extends Enum<T>> {
   int x_ = 4;

   Optional<dvv> k_(dvv var1);

   float au_();

   default void a_(dvv $$0, arp $$1, jh $$2, azu $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dvv> c(dvv $$0, arp $$1, jh $$2, azu $$3) {
      ...
      for (jh $$7 : jh.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof djr<?> $$9) {
            Enum<?> $$10 = $$9.c();
