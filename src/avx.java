...
public interface avx {
   ...
   avx b = NumberFormat.getIntegerInstance(Locale.US)::format;
   avx c = $$0 -> a.format((double)$$0 * 0.1);
   avx d = $$0 -> {
   ...
   avx f = $$0 -> DurationFormatUtils.formatDurationHMS(Math.round((double)$$0 * 50.0));
