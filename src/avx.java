...
public class avx extends asv {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), avx::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", avx::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", avx::k);
         $$0 = this.a($$0, "minecraft:fox", avx::j);
         $$0 = this.a($$0, "minecraft:item", avx::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", avx::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", avx::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", avx::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", avx::e);
         return this.a($$0, "minecraft:piglin", avx::d);
      });
   }
