...
public class avx extends avw {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avx.a> s;
   private final avs t;
   private long u;
   private final alt v;

   private avx(alt $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avt.c($$2, 7, $$0.getLength());
      }
   }
