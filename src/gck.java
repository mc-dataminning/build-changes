...
public class gck extends MinecraftServer {
   ...
   public gck(Thread $$0, eqm $$1, ebx.c $$2, amx $$3, afm $$4, afj $$5, aku $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.as(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gcj(this, this.aW(), this.i));
      this.p = $$1;
   }
   ...
   public boolean a(@Nullable cpj $$0, boolean $$1, int $$2) {
      try {
         ...
         this.r = $$2;
         this.t = new gcn(this.aa(), $$2 + "");
         this.t.start();
         this.s = $$0;
         this.ac().b($$1);
         int $$3 = this.c(this.p.v.fP());
         this.p.v.a($$3);
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (akl $$1 : Lists.newArrayList(this.ac().t())) {
   ...
   @Override
   public cpj aX() {
      return this.p() ? (cpj)MoreObjects.firstNonNull(this.s, this.m.m()) : null;
   }
}
