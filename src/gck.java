public class gck extends fzu {
   private static final int a = 12235202;

   protected gck(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gbx $$8) {
   ...
   public static class a implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new gck($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
