...
public class doq {
   ...
   private final List<doo> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private doq.a l = new doq.d(5.999997E7F);
   public static final doq.c e = new doq.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (doq.a)($$0 == $$1 ? new doq.d($$1) : new doq.b($$0, $$1, $$2));
   ...
   public doq.c t() {
      return new doq.c(this);
   }

   public void a(doq.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements doq.a {
      ...
      @Override
      public double a() {
         return aww.a(doq.this.a() - this.e() / 2.0, (double)(-doq.this.k), (double)doq.this.k);
      }

      @Override
      public double c() {
         return aww.a(doq.this.b() - this.e() / 2.0, (double)(-doq.this.k), (double)doq.this.k);
      }
      ...
      @Override
      public dop i() {
         return this.c < this.b ? dop.b : dop.a;
      }
      ...
      @Override
      public doq.a l() {
         return (doq.a)(this.g() <= 0L ? doq.this.new d(this.c) : this);
      }
      ...
      public eqk m() {
         return eqh.a(
            eqh.c,
            eqh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            epv.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static doq.c a(DynamicLike<?> $$0, doq.c $$1) {
         ...
         return new doq.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements doq.a {
      ...
      private void n() {
         this.c = aww.a(doq.this.a() - this.b / 2.0, (double)(-doq.this.k), (double)doq.this.k);
         this.d = aww.a(doq.this.b() - this.b / 2.0, (double)(-doq.this.k), (double)doq.this.k);
         this.e = aww.a(doq.this.a() + this.b / 2.0, (double)(-doq.this.k), (double)doq.this.k);
         this.f = aww.a(doq.this.b() + this.b / 2.0, (double)(-doq.this.k), (double)doq.this.k);
         this.g = eqh.a(
            eqh.c,
            eqh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            epv.e
