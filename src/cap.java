...
public class cap extends cbk {
   private static final int i = 2;
   private static final int j = 32;
   private static final int k = 10;
   private static final int l = 7;

   public cap(bty $$0, double $$1) {
      super($$0, $$1, 240, false);
   }
   ...
   @Nullable
   private evr k() {
      return cen.a(this.b, 10, 7);
   }

   @Nullable
   private evr l() {
      arf $$0 = (arf)this.b.dP();
      List<cmk> $$1 = $$0.a(bta.bj, this.b.cK().g(32.0), this::a);
      if ($$1.isEmpty()) {
         return null;
      } else {
         cmk $$2 = $$1.get(this.b.dP().z.a($$1.size()));
         evr $$3 = $$2.dn();
         return cen.a(this.b, 10, 7, $$3);
      }
   }
   ...
   private evr m() {
      ...
      if ($$0 == null) {
         ...
         iz $$1 = this.a($$0);
         return $$1 == null ? null : cen.a(this.b, 10, 7, evr.c($$1));
      }
   }
   ...
   private iz a(kb $$0) {
      arf $$1 = (arf)this.b.dP();
      cet $$2 = $$1.y();
      List<iz> $$3 = $$2.c($$0x -> true, $$0.q(), 8, cet.b.b).map(ceu::f).collect(Collectors.toList());
