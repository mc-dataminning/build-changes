...
public class cap {
   ...
   private final cap.a k;
   @VisibleForTesting
   protected final Object2IntMap<bii> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cap> a(Predicate<bii> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cap::b)).apply($$1, $$1x -> new cap($$0, $$1x))
      );
   }

   public cap(Predicate<bii> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cap.a(this);
   ...
   @VisibleForTesting
   protected static record a(cap a) implements Comparator<bii> {
      public int a(bii $$0, bii $$1) {
         if ($$0.equals($$1)) {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cbm;
               boolean $$7 = $$1 instanceof cbm;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
