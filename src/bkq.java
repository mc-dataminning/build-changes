...
public class bkq extends big {
   private static final Logger c = LogUtils.getLogger();

   public bkq(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bjm.s, "minecraft:trial_spawner");
   }
   ...
   public Dynamic<?> a(Dynamic<va> $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         if ($$2.isEmpty()) {
            ...
            alr $$3 = bkq.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   static final class a {
      public static final Map<Pair<Dynamic<va>, Dynamic<va>>, alr> a = new HashMap<>();

      private a() {
      }

      private static void a(alr $$0, String $$1, String $$2) {
         try {
            ua $$3 = a($$1);
            ua $$4 = a($$2);
            ua $$5 = $$3.l().a($$4);
      ...
      static {
         ...
         a(
            alr.b("trial_chamber/melee/husk"),
         ...
         a(
            alr.b("trial_chamber/melee/spider"),
         ...
         a(
            alr.b("trial_chamber/melee/zombie"),
         ...
         a(
            alr.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            alr.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            alr.b("trial_chamber/ranged/stray"),
         ...
         a(
            alr.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            alr.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            alr.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            alr.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            alr.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            alr.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            alr.b("trial_chamber/small_melee/slime"),
