...
public abstract class bkq<E extends biy> implements bkr<E> {
   public static final int a = 60;
   protected final Map<bsa<?>, bsb> b;
   private bkq.a c = bkq.a.a;
   private long d;
   private final int e;
   private final int f;

   public bkq(Map<bsa<?>, bsb> $$0) {
      this($$0, 60);
   }

   public bkq(Map<bsa<?>, bsb> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bkq(Map<bsa<?>, bsb> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<bsa<?>, bsb> $$1 : this.b.entrySet()) {
         bsa<?> $$2 = $$1.getKey();
         bsb $$3 = $$1.getValue();
         if (!$$0.dM().a($$2, $$3)) {
            return false;
