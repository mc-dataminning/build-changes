...
public class bkq {
   ...
   public static bky<bjp> a(Predicate<hg<bui>> $$0, bsh<hf> $$1, boolean $$2, Optional<Byte> $$3) {
      return a($$0, $$1, $$1, $$2, $$3);
   }

   public static bky<bjp> a(Predicate<hg<bui>> $$0, bsh<hf> $$1, bsh<hf> $$2, boolean $$3, Optional<Byte> $$4) {
      int $$5 = 5;
      int $$6 = 20;
      ...
      bmh<bjp> $$9 = boj.a(
         (Function<boj.b<bjp>, ? extends App<boj.c<bjp>, bom<bjp>>>)($$6x -> $$6x.group($$6x.c($$2)).apply($$6x, $$5xx -> ($$6xx, $$7x, $$8x) -> {
                  if ($$3 && $$7x.m_()) {
                     ...
                     Set<Pair<hg<bui>, gw>> $$11 = $$9x.c($$0, $$10, $$7x.dl(), 48, buf.b.a).limit(5L).collect(Collectors.toSet());
                     ebb $$12 = a($$7x, $$11);
                     if ($$12 != null && $$12.j()) {
                        gw $$13 = $$12.l();
   ...
   @Nullable
   public static ebb a(bji $$0, Set<Pair<hg<bui>, gw>> $$1) {
      if ($$1.isEmpty()) {
         return null;
      } else {
         ...
         for (Pair<hg<bui>, gw> $$4 : $$1) {
            $$3 = Math.max($$3, ((bui)((hg)$$4.getFirst()).a()).c());
