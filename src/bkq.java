...
public class bkq {
   ...
   private bkq(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bkq a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bkq($$0, $$1);
   }

   public bkq.d a() throws IOException {
      bkq.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bkq.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bkq.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bkq.c $$3 = bkq.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bkq.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bkq.a($$0, $$3);
            }
         }
   ...
   public bkq.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bkq.c> $$2 = this.a().c();
      ...
      bkq.e $$4 = new bkq.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bkq.c b) implements bkq.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bkq.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bkq.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bkq.b> {
      private final List<bkq.b> a;

      d(List<bkq.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bkq.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bkq.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bkq.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bkq.d a() {
         ListIterator<bkq.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bkq.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bkq.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bkq.b> b() {
         return this.a.stream();
      }

      public Set<bkq.c> c() {
         return this.a.stream().map(bkq.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bkq.c b) implements bkq.b {
