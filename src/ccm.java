...
public abstract class ccm extends biq implements bkd {
   ...
   public biq v() {
      if (this.c != null && !this.c.dG()) {
         return this.c;
      } else if (this.b != null && this.dL() instanceof akq) {
         this.c = ((akq)this.dL()).a(this.b);
         return this.c;
      } else {
         return null;
      }
   ...
   public void c(double $$0, double $$1, double $$2, float $$3, float $$4) {
      ...
      this.f($$5);
      double $$6 = $$5.h();
      this.r((float)(arw.d($$5.c, $$5.e) * 180.0F / (float)Math.PI));
      this.s((float)(arw.d($$5.d, $$6) * 180.0F / (float)Math.PI));
      this.N = this.dB();
      this.O = this.dD();
   }

   public void a(biq $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      float $$6 = -arw.a($$2 * (float) (Math.PI / 180.0)) * arw.b($$1 * (float) (Math.PI / 180.0));
      float $$7 = -arw.a(($$1 + $$3) * (float) (Math.PI / 180.0));
      float $$8 = arw.b($$2 * (float) (Math.PI / 180.0)) * arw.b($$1 * (float) (Math.PI / 180.0));
   ...
   public void l(double $$0, double $$1, double $$2) {
      ...
      if (this.O == 0.0F && this.N == 0.0F) {
         ...
         this.s((float)(arw.d($$1, $$3) * 180.0F / (float)Math.PI));
         this.r((float)(arw.d($$0, $$2) * 180.0F / (float)Math.PI));
         this.O = this.dD();
         this.N = this.dB();
   ...
   protected void H() {
      ehn $$0 = this.do();
      double $$1 = $$0.h();
      this.s(d(this.O, (float)(arw.d($$0.d, $$1) * 180.0F / (float)Math.PI)));
      this.r(d(this.N, (float)(arw.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
   }
   ...
   protected static float d(float $$0, float $$1) {
      ...
      return arw.i(0.2F, $$0, $$1);
   }

   @Override
   public vd<ww> di() {
      biq $$0 = this.v();
      return new wx(this, $$0 == null ? 0 : $$0.ah());
   }
