...
public class epi {
   ...
   public Optional<l.a> a(ja $$0, boolean $$1, duc $$2) {
      ceg $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<ceh> $$5 = $$3.b($$0x -> $$0x.a(cek.r), $$0, $$4, ceg.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<ceh>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dtb.H))
         .findFirst();
      return $$5.map($$0x -> {
         ja $$1x = $$0x.f();
         this.n.l().a(aqr.e, new dbn($$1x), 3, $$1x);
         dsl $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dtb.H), 21, jf.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(ja $$0, jf.a $$1) {
      ...
      for (ja.a $$10 : ja.a($$0, 16, jf.f, jf.d)) {
         int $$11 = Math.min($$8, this.n.a(dyg.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new ja($$0.u(), ayg.a($$0.v(), $$17, $$18), $$0.w()).i();
         jf $$19 = $$2.h();
         if (!$$7.a($$4)) {
            return Optional.empty();
         }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, dfk.co.o(), 3);
            }
         }
      }

      dsl $$26 = dfk.ed.o().a(dkm.b, $$1);
