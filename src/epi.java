...
public class epi {
   ...
   public static List<epi.a> a(String $$0, epi.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<epi.a> a(String $$0, List<epi.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<epi.a> a(List<String> $$0, List<epi.b> $$1) {
      int $$2 = 0;
      List<epi.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<epi.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static epi.b a(String $$0, String $$1) {
         return new epi.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static epi.b a(String $$0) {
         return new epi.b($$0);
      }
   }
}
