...
public class epi {
   private static final epi[] an = new epi[64];
   ...
   public static final epi ak = new epi(62, 14865562);
   public final int al;
   public final int am;
   ...
   public int a(epi.a $$0) {
      if (this == a) {
         ...
         int $$1 = $$0.f;
         int $$2 = (this.al >> 16 & 0xFF) * $$1 / 255;
         int $$3 = (this.al >> 8 & 0xFF) * $$1 / 255;
         int $$4 = (this.al & 0xFF) * $$1 / 255;
         return 0xFF000000 | $$4 << 16 | $$3 << 8 | $$2;
      }
   }

   public static epi a(int $$0) {
      Preconditions.checkPositionIndex($$0, an.length, "material id");
      return c($$0);
   }
