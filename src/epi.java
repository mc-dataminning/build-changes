...
public class epi {
   private final ImmutableList<epj> a;
   private final ImmutableMap<String, epj> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private epg e;

   public epi(ImmutableMap<String, epj> $$0) {
      this.b = $$0;
