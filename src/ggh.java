...
public class ggh implements fcf, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final fcd c = new fcd();
   ...
   private final List<fcl> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, fcl> l = Maps.newHashMap();
   private final int m;
   ...
   public ggh(auv $$0, String $$1) throws IOException {
      alb $$2 = alb.b("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      auq $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = ays.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = ays.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(ays.a($$5, "blend", null));
         this.s = a($$0, fci.a.a, $$6);
         this.t = a($$0, fci.a.b, $$7);
         this.m = fcj.a();
         fcj.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = fcl.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static fcg a(auv $$0, fci.a $$1, String $$2) throws IOException {
      fci $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof fcg)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         fcg $$7;
         if ($$3 == null) {
            alb $$4 = alb.b("shaders/program/" + $$2 + $$1.b());
            auq $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static fce a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new fce();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (ays.a($$0, "func")) {
            $$1 = fce.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (ays.a($$0, "srcrgb")) {
            $$2 = fce.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (ays.a($$0, "dstrgb")) {
            $$3 = fce.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (ays.a($$0, "srcalpha")) {
            $$4 = fce.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (ays.a($$0, "dstalpha")) {
            $$5 = fce.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new fce($$2, $$3, $$4, $$5, $$1) : new fce($$2, $$3, $$1);
         }
      }
   }
