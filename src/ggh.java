...
public enum ggh implements ggo {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, ggh> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (ggh)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static ggh a(int $$0, int $$1) {
      return r.get(b(aui.b($$0, 360), aui.b($$1, 360)));
   }
