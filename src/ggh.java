public class ggh extends ghn<hdj> {
   public static final float a = 1.8849558F;
   public static final gla b = gla.scaling(0.5F);
   private final gkr c;
   private final gkr d;
   private final gkr e;
   private final gkr f;
   ...
   public static gkx a() {
      ...
      glb $$1 = $$0.a();
      glb $$2 = $$1.a(
         "body", gkw.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), gkt.a(0.0F, 20.0F, 5.0F)
      );
      gkv $$3 = new gkv(0.001F);
      glb $$4 = $$2.a("head", gkw.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), gkt.a(0.0F, 0.0F, -9.0F));
      gkw $$5 = gkw.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      gkw $$6 = gkw.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      gkw $$7 = gkw.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, gkt.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, gkt.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, gkt.a(4.0F, 0.0F, -1.0F));
      gkw $$8 = gkw.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      gkw $$9 = gkw.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, gkt.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, gkt.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, gkt.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, gkt.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", gkw.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), gkt.a(0.0F, 0.0F, 1.0F));
   ...
   private void b(float $$0, float $$1) {
      if (!($$1 <= 1.0E-5F)) {
         ...
         this.j.f += $$6;
         this.c.f += $$6;
         float $$7 = (0.6F - 0.08F * ($$3 * $$3 + 2.0F * azz.a($$2))) * $$1;
         this.k.e += $$7;
         this.l.f -= $$7;
         this.m.f += $$7;
   ...
   private void a(float $$0, float $$1, float $$2) {
      if (!($$2 <= 1.0E-5F)) {
         ...
         this.l.f += $$7;
         this.m.f -= $$7;
         this.c.f = this.c.f + 0.3F * azz.b($$3 * 0.9F) * $$2;
