public class ggh implements ggd<dpt> {
   private final gkk a;
   ...
   public void a(dpt $$0, float $$1, fam $$2, ged $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.n().c(dta.bv);
         if ($$6 > 0) {
            jf $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.e()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = geb.a($$0.i(), $$0.n(), $$0.az_().a($$7));
                  this.a.a($$8, ctz.i, $$11, gpf.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
