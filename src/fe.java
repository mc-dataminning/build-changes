...
public class fe implements ArgumentType<fgk> {
   ...
   public static fgk a(CommandContext<ej> $$0, String $$1) {
      return (fgk)$$0.getArgument($$1, fgk.class);
   }

   public fgk a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      List<String> $$2 = Lists.newArrayList(fgk.c());
