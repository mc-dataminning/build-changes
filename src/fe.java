...
public class fe implements ArgumentType<fe.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xp.c("argument.player.unknown"));

   public static Collection<GameProfile> a(CommandContext<ep> $$0, String $$1) throws CommandSyntaxException {
      return ((fe.a)$$0.getArgument($$1, fe.a.class)).getNames((ep)$$0.getSource());
   }
   ...
   public fe.a a(StringReader $$0) throws CommandSyntaxException {
      if ($$0.canRead() && $$0.peek() == '@') {
         ...
         he $$2 = $$1.t();
         if ($$2.b()) {
            throw fc.c.createWithContext($$0);
         } else {
            return new fe.b($$2);
         }
      } else {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      if ($$0.getSource() instanceof eu) {
         ...
         return $$3.a($$1, $$1x -> eu.b(((eu)$$0.getSource()).q(), $$1x));
      } else {
   ...
   @FunctionalInterface
   public interface a {
      Collection<GameProfile> getNames(ep var1) throws CommandSyntaxException;
   }
   ...
   public static class b implements fe.a {
      ...
      @Override
      public Collection<GameProfile> getNames(ep $$0) throws CommandSyntaxException {
         List<arg> $$1 = this.a.d($$0);
         if ($$1.isEmpty()) {
            throw fc.e.create();
         } else {
