...
public class fe implements ArgumentType<fe.b> {
   ...
   public static fe.b a(hg<cpn> $$0, StringReader $$1) throws CommandSyntaxException {
   ...
   public static Predicate<dcf> a(CommandContext<ds> $$0, String $$1) throws CommandSyntaxException {
      return (Predicate<dcf>)$$0.getArgument($$1, fe.b.class);
   }
   ...
   public interface b extends Predicate<dcf> {
      boolean a();
   }
