...
public class su {
   ...
   public static enum a {
      ...
      private static final Map<String, su.a> g = Arrays.stream(values()).collect(Collectors.toMap(su.a::b, $$0 -> (su.a)$$0));
