...
public interface eth {
   eth a(double var1, double var3, double var5);

   eth a(int var1, int var2, int var3, int var4);

   eth a(float var1, float var2);

   eth a(int var1, int var2);

   eth b(int var1, int var2);

   eth a(float var1, float var2, float var3);
   ...
   default eth a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default eth a(int $$0) {
      return this.a(avw.b.b($$0), avw.b.c($$0), avw.b.d($$0), avw.b.a($$0));
   }
   ...
   default void a(etd.a $$0, fxn $$1, float $$2, float $$3, float $$4, int $$5, int $$6) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, new int[]{$$5, $$5, $$5, $$5}, $$6, false);
   }

   default void a(etd.a $$0, fxn $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(etb.j.b());
   ...
   default eth a(etd.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default eth a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default eth b(etd.a $$0, float $$1, float $$2, float $$3) {
