...
public class eth {
   ...
   private void a(n $$0, uv $$1) {
      this.b.l.d().a(uv.i().b(uv.c("debug.prefix").a($$0, n.r)).b(uu.u).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(uv.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((csc)MoreObjects.firstNonNull(this.b.q.k(), csc.b)).b());
               }
            ...
            case 81:
               ...
               evf $$3 = this.b.l.d();
               $$3.a(uv.c("debug.reload_chunks.help"));
               $$3.a(uv.c("debug.show_hitboxes.help"));
               $$3.a(uv.c("debug.copy_location.help"));
               $$3.a(uv.c("debug.clear_chat.help"));
               $$3.a(uv.c("debug.chunk_boundaries.help"));
               $$3.a(uv.c("debug.advanced_tooltips.help"));
               $$3.a(uv.c("debug.inspect.help"));
               $$3.a(uv.c("debug.profiling.help"));
               $$3.a(uv.c("debug.creative_spectator.help"));
               $$3.a(uv.c("debug.pause_focus.help"));
               $$3.a(uv.c("debug.help.help"));
               $$3.a(uv.c("debug.dump_dynamic_textures.help"));
               $$3.a(uv.c("debug.reload_resourcepacks.help"));
               $$3.a(uv.c("debug.pause.help"));
               $$3.a(uv.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.X().a($$5);
               uv $$6 = uv.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new ut(ut.a.b, $$5.toFile().toString())));
            ...
            case b:
               ...
               if ($$0) {
                  if ($$1) {
                     ...
                     dfi $$5 = this.b.s.dN().c_($$3);
                     sd $$6 = $$5 != null ? $$5.q() : null;
                     this.a($$4, $$3, $$6);
   ...
   private void a(dhn $$0, hx $$1, @Nullable sd $$2) {
   ...
   private void a(agm $$0, ejz $$1, @Nullable sd $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = ss.c((ta)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aL().i()) {
         boolean $$5 = emw.a(eti.N().aL().i(), 292);
         if (this.d > 0L) {
            if (!emw.a(eti.N().aL().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (emw.a(eti.N().aL().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fbt) || ((fbt)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aL().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               ett.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aU().a() && this.b.m.s().c()) {
            boolean $$7 = $$6 == null || !($$6.t() instanceof evn) || !((evn)$$6.t()).e();
            if ($$3 != 0 && $$1 == 66 && faz.p() && $$7) {
               boolean $$8 = this.b.m.ap().c() == etk.a;
               this.b.m.ap().a(etk.a(this.b.m.ap().c().a() + 1));
               if ($$6 instanceof fbb) {
                  ((fbb)$$6).l();
               }
         ...
         if (this.b.y == null || this.b.y instanceof fau $$10 && !$$10.l()) {
            emw.a $$11 = emw.a($$1, $$2);
            if ($$3 == 0) {
               etg.a($$11, false);
               if ($$1 == 292) {
      ...
      if ($$0 == this.b.aL().i()) {
         ...
         if ($$3 != null && this.b.aI() == null) {
            if (Character.charCount($$1) == 1) {
               faz.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  faz.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", atq.f((float)$$1 / 1000.0F));
            }
