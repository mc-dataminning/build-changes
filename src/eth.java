public class eth {
   ...
   private int a(dzq $$0, int $$1, int $$2, int $$3) {
      int $$4 = kj.c($$0.h($$1) + 1);
   ...
   public boolean a(dgn $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dgn $$0, int $$1, int $$2, jh $$3, dxv $$4, jh $$5, dxv $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dgn $$0, jh $$1, dxv $$2) {
      jh.a $$3 = this.e.g($$1);
