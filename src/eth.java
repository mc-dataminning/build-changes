...
public class eth {
   private static final aer b = new aer("icon/ping_unknown");
   private static final aer c = new aer("icon/ping_1");
   private static final aer d = new aer("icon/ping_2");
   private static final aer e = new aer("icon/ping_3");
   private static final aer f = new aer("icon/ping_4");
   private static final aer g = new aer("icon/ping_5");
   private static final aer h = new aer("hud/heart/container_blinking");
   private static final aer i = new aer("hud/heart/container");
   private static final aer j = new aer("hud/heart/full_blinking");
   private static final aer k = new aer("hud/heart/half_blinking");
   private static final aer l = new aer("hud/heart/absorbing_full_blinking");
   ...
   public void a(boolean $$0) {
      if (this.u != $$0) {
         ...
         this.u = $$0;
         if ($$0) {
            tf $$1 = th.a(this.b(), tf.b(", "), this::a);
            this.q.aV().c(tf.a("multiplayer.player.list.narration", $$1));
         }
      }
   }
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, erv $$4, int $$5) {
      ...
      if ($$7 > 0) {
         int $$10 = arp.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
            float $$11 = arp.a((float)$$5 / 20.0F, 0.0F, 1.0F);
