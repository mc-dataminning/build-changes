...
public class env {
   ...
   private static final Queue<env.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile env.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(env::a), ent::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(env::a), ent::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + env.a(this.b) + ", type=" + env.b(this.c) + ", severity=" + env.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
