...
public final class env extends eob {
   ...
   public static env a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      env $$9 = new env($$0, $$1, $$2);
      $$9.e = $$3;
      $$9.f = $$4;
      $$9.g = $$5;
   ...
   static env a(eob $$0, eob $$1, eoe $$2, eoe $$3, eoe $$4, enw $$5) {
      env $$6 = new env($$2.size() - 1, $$3.size() - 1, $$4.size() - 1);
   ...
   protected static void a(eob $$0, eob.b $$1, boolean $$2) {
      env $$3 = new env($$0);
