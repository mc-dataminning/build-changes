...
public class env {
   ...
   @Nullable
   private String g;
   private static final env.a h = new env.a() {
      @Nullable
      @Override
      public enu a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (enz.a(this.d, "Get capabilities")) {
         ...
         if (enz.a(this.d, "Create context")) {
            ...
            int $$5 = this.i();
            int $$6 = aun.a((int)aun.c((float)$$5), 2, 8);
            int $$7 = aun.a($$5 - $$6, 8, 255);
            this.i = new env.b($$7);
            this.j = new env.b($$6);
   ...
   @Nullable
   public enu a(env.c $$0) {
      return ($$0 == env.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements env.a {
      private final int a;
      private final Set<enu> b = Sets.newIdentityHashSet();
      ...
      public enu a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               env.a.warn("Maximum sound pool size {} reached", this.a);
            }
