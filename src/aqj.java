...
public abstract class aqj {
   ...
   static final int b = apz.a(aqk.d);
   private static final int c = 4;
   final Long2ObjectMap<ObjectSet<aqu>> d = new Long2ObjectOpenHashMap();
   final Long2ObjectOpenHashMap<azf<aqx<?>>> e = new Long2ObjectOpenHashMap();
   private final aqj.a f = new aqj.a();
   private final aqj.b g = new aqj.b(8);
   private final aqz h = new aqz();
   private final aqj.c i = new aqj.c(32);
   final Set<apy> j = Sets.newHashSet();
   final aqd k;
   final bpi<aqd.a<Runnable>> l;
   final bpi<aqd.b> m;
   ...
   protected aqj(Executor $$0, Executor $$1) {
      bpi<Runnable> $$2 = bpi.a("player ticket throttler", $$1::execute);
      aqd $$3 = new aqd(ImmutableList.of($$2), $$0, 4);
      this.k = $$3;
      this.l = $$3.a($$2, true);
      this.m = $$3.a($$2);
      this.o = $$1;
   ...
   protected void a() {
      this.p++;
      ObjectIterator<Entry<azf<aqx<?>>>> $$0 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$0.hasNext()) {
         Entry<azf<aqx<?>>> $$1 = (Entry<azf<aqx<?>>>)$$0.next();
         Iterator<aqx<?>> $$2 = ((azf)$$1.getValue()).iterator();
         boolean $$3 = false;
         ...
         if ($$3) {
            this.f.b($$1.getLongKey(), a((azf<aqx<?>>)$$1.getValue()), false);
         }

         if (((azf)$$1.getValue()).isEmpty()) {
            $$0.remove();
         }
      }
   }

   private static int a(azf<aqx<?>> $$0) {
      return !$$0.isEmpty() ? $$0.b().b() : apz.b + 1;
   }

   protected abstract boolean a(long var1);

   @Nullable
   protected abstract apy b(long var1);

   @Nullable
   protected abstract apy a(long var1, int var3, @Nullable apy var4, int var5);

   public boolean a(aqa $$0) {
      this.g.a();
      this.h.a();
      this.i.a();
         ...
         if (!this.n.isEmpty()) {
            ...
            while ($$3.hasNext()) {
               ...
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == aqy.c)) {
                  ...
                  CompletableFuture<aqb<dvg>> $$6 = $$5.b();
                  $$6.thenAccept($$1x -> this.o.execute(() -> this.m.a(aqd.a(() -> {
                        }, $$4, false))));
               }
            }
   ...
   public <T> void c(aqy<T> $$0, dcb $$1, int $$2, T $$3) {
      aqx<T> $$4 = new aqx<>($$0, apz.a(aqk.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.a($$5, $$4);
      this.h.a($$5, $$4);
   }

   public <T> void d(aqy<T> $$0, dcb $$1, int $$2, T $$3) {
      aqx<T> $$4 = new aqx<>($$0, apz.a(aqk.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.b($$5, $$4);
      this.h.b($$5, $$4);
   ...
   private azf<aqx<?>> g(long $$0) {
      return (azf<aqx<?>>)this.e.computeIfAbsent($$0, $$0x -> azf.a(4));
   }

   protected void a(dcb $$0, boolean $$1) {
      aqx<dcb> $$2 = new aqx<>(aqy.d, aqa.c, $$0);
      long $$3 = $$0.a();
      if ($$1) {
         this.a($$3, $$2);
         this.h.a($$3, $$2);
   ...
   private int g() {
      return Math.max(0, apz.a(aqk.d) - this.q);
   }

   public boolean c(long $$0) {
      return apz.d(this.h.c($$0));
   }

   public boolean d(long $$0) {
      return apz.e(this.h.c($$0));
   }

   protected String e(long $$0) {
      azf<aqx<?>> $$1 = (azf<aqx<?>>)this.e.get($$0);
   ...
   private void a(String $$0) {
      try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
         ...
         while (var3.hasNext()) {
            ...
            dcb $$3 = new dcb($$2.getLongKey());

            for (aqx<?> $$4 : (azf)$$2.getValue()) {
   ...
   public void e() {
      ImmutableSet<aqy<?>> $$0 = ImmutableSet.of(aqy.g, aqy.f);
      ObjectIterator<Entry<azf<aqx<?>>>> $$1 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$1.hasNext()) {
         Entry<azf<aqx<?>>> $$2 = (Entry<azf<aqx<?>>>)$$1.next();
         Iterator<aqx<?>> $$3 = ((azf)$$2.getValue()).iterator();
         boolean $$4 = false;
         ...
         if ($$4) {
            this.f.b($$2.getLongKey(), a((azf<aqx<?>>)$$2.getValue()), false);
         }

         if (((azf)$$2.getValue()).isEmpty()) {
            $$1.remove();
         }
      }
   }
   ...
   class a extends aqe {
      private static final int b = apz.b + 1;
      ...
      protected int b(long $$0) {
         azf<aqx<?>> $$1 = (azf<aqx<?>>)aqj.this.e.get($$0);
         if ($$1 == null) {
   ...
   class b extends aqe {
      ...
      private boolean d(long $$0) {
         ObjectSet<aqu> $$1 = (ObjectSet<aqu>)aqj.this.d.get($$0);
      ...
      private void a(String $$0) {
         try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
            ...
            aqj.a.error("Failed to dump chunks to {}", $$0, var9);
         }
      }
   }

   class c extends aqj.b {
      private int g;
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            aqx<?> $$4 = new aqx<>(aqy.c, aqj.b, new dcb($$0));
            if ($$3) {
               aqj.this.l.a(aqd.a(() -> aqj.this.o.execute(() -> {
                     if (this.c(this.c($$0))) {
                        aqj.this.a($$0, $$4);
                        aqj.this.n.add($$0);
                     } else {
               ...
               aqj.this.m.a(aqd.a(() -> aqj.this.o.execute(() -> aqj.this.b($$0, $$4)), $$0, true));
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  aqj.this.k.onLevelChange(new dcb($$1), () -> this.h.get($$1), $$3, $$1x -> {
