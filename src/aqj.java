...
public class aqj extends aqo {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<aqk<?>> e = Sets.newHashSet();

   public aqj(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(ccx $$0, aqk<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<aqk<?>> d() {
      Set<aqk<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  rt $$4 = a($$3.getAsJsonObject());
                  $$4 = aud.g.a($$0, $$4, sg.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<aqk<T>> a(aqm<T> $$0, String $$1) {
      return Optional.ofNullable(afw.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static rt a(JsonObject $$0) {
      rt $$1 = new rt();
   ...
   protected String b() {
      Map<aqm<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aqk<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aqk<?>>)$$3.next();
         aqk<?> $$2 = (aqk<?>)$$1.getKey();
      ...
      for (Entry<aqm<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> afw b(aqk<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(alr $$0) {
      Object2IntMap<aqk<?>> $$1 = new Object2IntOpenHashMap();
