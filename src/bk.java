...
public class bk extends cx<bk.a> {
   ...
   public void a(apt $$0, @Nullable bpv $$1) {
      enb $$2 = $$1 != null ? br.b($$0, $$1) : null;
   ...
   public static record a(Optional<bc> b, Optional<cn> c, Optional<bc> d) implements cx.a {
      public static final Codec<bk.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(aws.a(br.b, "player").forGetter(bk.a::a), aws.a(cn.a, "effects").forGetter(bk.a::b), aws.a(br.b, "source").forGetter(bk.a::c))
               .apply($$0, bk.a::new)
      );
      ...
      public boolean a(apt $$0, @Nullable enb $$1) {
         return this.c.isPresent() && !this.c.get().a((bqo)$$0) ? false : !this.d.isPresent() || $$1 != null && this.d.get().a($$1);
      }
