...
public class dlu {
   ...
   public static dlu a(@Nullable aky $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cpc $$1 = $$0.a();
   ...
   public dlu.a a(int $$0, int $$1) {
      ...
      if ($$4 != Double.MAX_VALUE) {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(hs.d(cpc.a($$5x)), hs.d(cpc.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = arx.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = arx.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
   ...
   public double a(dkl.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(hs.d(cpc.a($$6x)), hs.d(cpc.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = arx.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = arx.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return arx.d($$10, $$9, $$1);
         }
      }
   }
   ...
   public cqw a(cqw $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         hg<cqt> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private hg<cqt> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<hg<cqt>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(hs.d(cpc.a($$5x)), $$1, hs.d(cpc.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = arx.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = arx.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (hg)$$4.getValue();
      }
   }

   public static void a(aky $$0, dhf $$1) {
      cpc $$2 = $$1.f();
      boolean $$3 = $$1.s();
      gw.a $$4 = new gw.a();
   ...
   public static void a(cqp $$0, dia $$1) {
      cpc $$2 = $$1.f();
      Builder<hd, dlv> $$3 = ImmutableMap.builder();
   ...
   public static dlu.c a(@Nullable dlv $$0, Map<hd, dlv> $$1) {
   ...
   private static dlu.c a(@Nullable hd $$0, dlv $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (hc $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return arx.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
