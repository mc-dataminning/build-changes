...
public class gax extends gay {
   ...
   public gax(fwr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, drb $$7) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, io.a($$1, $$2, $$3));
   }

   public gax(fwr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, drb $$7, io $$8) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.a = $$8;
      this.a(fdz.Q().ap().a().a($$7));
      this.u = 1.0F;
      this.v = 0.6F;
      this.w = 0.6F;
      this.x = 0.6F;
      if (!$$7.a(dea.i)) {
         int $$9 = fdz.Q().aw().a($$7, $$0, $$8, 0);
   ...
   static gax a(kp $$0, fwr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      drb $$8 = $$0.b();
      return !$$8.i() && !$$8.a(dea.bQ) && $$8.z() ? new gax($$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8) : null;
   }
