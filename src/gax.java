...
public abstract class gax extends gaf {
   protected final dzs a;
   private dzt c;
   private final String[] d;
   private final boolean s;
   protected final ecu b;
   private int u;
   private int v;
   @Nullable
   private fxi w;

   public gax(dzs $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, xc.c("sign.edit"));
   }

   public gax(dzs $$0, boolean $$1, boolean $$2, xc $$3) {
      super($$3);
      this.a = $$0;
      this.c = $$0.a($$1);
      this.s = $$1;
      this.b = duo.a($$0.m().b());
      this.d = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(xc::getString).toArray(String[]::new);
   }

   @Override
   protected void aS_() {
      this.c(fun.a(xb.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.w = new fxi(() -> this.d[this.v], this::a, fxi.a(this.m), fxi.c(this.m), $$0 -> this.m.h.b($$0) <= this.a.c());
   }
   ...
   public void aJ_() {
      gme $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new air(this.a.aB_(), this.s, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void c(ftz var1);
   ...
   private void e(ftz $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : guj.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.v && $$4 >= 0) {
            ...
            if ($$3 && $$4 < $$14.length()) {
               $$0.a($$16, $$7 - 1, $$16 + 1, $$7 + this.a.a(), aya.f($$2));
            }
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gsn.I(), $$21, $$7, $$22, $$7 + this.a.a(), -16776961);
            }
         }
      }
   }
