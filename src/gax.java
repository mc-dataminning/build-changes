...
public class gax {
   ...
   public final Map<ih, gay> c;
   public final gaz d;
   public final boolean e;

   public gax(Vector3f $$0, Vector3f $$1, Map<ih, gay> $$2, @Nullable gaz $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ih, gay> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gax> {
      private static final boolean a = true;

      public gax a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gaz $$6 = this.a($$3);
         Map<ih, gay> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !axa.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = axa.a($$3, "shade", true);
            return new gax($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gaz a(JsonObject $$0) {
         gaz $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = axa.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ih.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = axa.a($$2, "rescale", false);
            $$1 = new gaz($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = axa.m($$0, "angle");
         if ($$1 != 0.0F && axk.e($$1) != 22.5F && axk.e($$1) != 45.0F) {
      ...
      private Map<ih, gay> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, gay> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ih, gay> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, gay> $$2 = Maps.newEnumMap(ih.class);
         JsonObject $$3 = axa.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ih $$5 = this.a($$4.getKey());
            $$2.put($$5, (gay)$$0.deserialize($$4.getValue(), gay.class));
         }
