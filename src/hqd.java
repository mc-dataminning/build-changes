...
public abstract class hqd extends fys {
   ...
   private final List<hqc> a = Lists.newArrayList();
   ...
   protected hqc a(hqc $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public wy m() {
      return wx.a(this.a.stream().map(hqc::a).collect(Collectors.toList()));
   }
}
