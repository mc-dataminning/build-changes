...
public class bny {
   ...
   private static void a(bog $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bob $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<duv, bok<boa>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bok)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<duv, bok<boa>> $$3 : $$0) {
         bok<boa> $$4 = (bok<boa>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((duv)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<boi> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnn.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnw $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bny::a));
      $$1.add("chunksWritten", this.a($$0.m(), bny::a));
      return $$1;
   }
   ...
   private JsonElement c(bnw $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bny::a));
      $$1.add("received", this.a($$0.k(), bny::a));
      return $$1;
   }

   private <T> JsonElement a(bof<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<boc> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<boc>, ToDoubleFunction<boc>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, boc::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, boc::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, boc::c));
      return $$1;
   }
}
