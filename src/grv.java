...
public class grv implements atd<gru> {
   public gru b(JsonObject $$0) {
      Builder<grt> $$1 = ImmutableList.builder();
      int $$2 = aye.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = aye.a($$0, "width", -1);
      int $$9 = aye.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = aye.a($$0, "interpolate", false);
      return new gru($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private grt a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new grt(aye.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = aye.m($$1, "frames[" + $$0 + "]");
         int $$3 = aye.a($$2, "time", -1);
         if ($$2.has("time")) {
