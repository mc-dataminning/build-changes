public abstract class grv extends grr {
   private static final float o = 0.0F;
   private static final float p = 1.2F;
   private static final float q = 0.0F;
   protected final cfb n;
   private boolean r;

   public grv(cfb $$0, avv $$1, avx $$2) {
      super($$1, $$2, gsi.t());
      this.n = $$0;
   ...
   public void q() {
      ...
      if (!this.n.dK() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = ayu.i(ayu.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = ayu.i(ayu.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
