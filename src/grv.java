...
public class grv {
   private static final gsn a = gsn.u(alk.b("textures/map/map_background.png"));
   private static final gsn b = gsn.u(alk.b("textures/map/map_background_checkerboard.png"));
   ...
   private final frf au;
   private final hkl av = new hkl();
   private daa aw = daa.k;
   private daa ax = daa.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gyi aC;
   private final gzi aD;
   private final hhs aE;

   public grv(frf $$0, gyi $$1, gzi $$2, hhs $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bxw $$0, daa $$1, czy $$2, flq $$3, gsc $$4, int $$5) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$0.dV(), $$5, hks.d, $$0.ao() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = azq.a($$1, 0.0F, 1.0F);
      return -azq.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(flq $$0, gsc $$1, int $$2, bxn $$3) {
      hdr $$4 = (hdr)this.aC.<gqy>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bxn.b ? 1.0F : -1.0F;
      ...
      alk $$6 = this.au.t.c().a();
      if ($$3 == bxn.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(csb.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(csb.c));
      }

      $$0.b();
   }

   private void a(flq $$0, gsc $$1, int $$2, float $$3, bxn $$4, float $$5, daa $$6) {
      float $$7 = $$4 == bxn.b ? 1.0F : -1.0F;
      ...
      float $$8 = azq.c($$5);
      float $$9 = azq.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * azq.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * azq.a($$5 * (float) Math.PI);
   ...
   private void a(flq $$0, gsc $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = azq.c($$5);
      float $$7 = -0.2F * azq.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * azq.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = azq.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.aw);
   }

   private void a(flq $$0, gsc $$1, int $$2, daa $$3) {
      ...
      ezj $$4 = $$3.a(kl.M);
      ezl $$5 = dan.a($$4, this.au.s);
      flt $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(flq $$0, gsc $$1, int $$2, float $$3, float $$4, bxn $$5) {
      boolean $$6 = $$5 != bxn.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azq.c($$4);
      float $$9 = -0.3F * azq.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * azq.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * azq.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = azq.a($$4 * $$4 * (float) Math.PI);
      float $$13 = azq.a($$8 * (float) Math.PI);
      ...
      hdr $$15 = (hdr)this.aC.<gqy>a($$14);
      alk $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(csb.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(csb.c));
      }
   }

   private void a(flq $$0, float $$1, bxn $$2, daa $$3, crz $$4) {
      float $$5 = (float)$$4.fC() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bxw)$$4);
      if ($$6 < 0.8F) {
         float $$7 = azq.e(azq.b($$5 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$7, 0.0F);
      }
   ...
   private void a(flq $$0, float $$1, bxn $$2, daa $$3, crz $$4, float $$5) {
      this.b($$0, $$2, $$5);
      ...
      float $$12 = -15.0F;
      int $$13 = 2;
      float $$14 = -15.0F + 75.0F * azq.b($$8 * 2.0F * (float) Math.PI);
      if ($$2 != bxn.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(flq $$0, bxn $$1, float $$2) {
      int $$3 = $$1 == bxn.b ? 1 : -1;
      float $$4 = azq.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = azq.a(azq.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(flq $$0, bxn $$1, float $$2) {
      int $$3 = $$1 == bxn.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, flq $$1, gsc.a $$2, grb $$3, int $$4) {
      float $$5 = $$3.D($$0);
      bus $$6 = (bus)MoreObjects.firstNonNull($$3.aJ, bus.a);
      float $$7 = $$3.k($$0);
      grv.a $$8 = a($$3);
      float $$9 = azq.h($$0, $$3.cv, $$3.ct);
      float $$10 = azq.h($$0, $$3.cu, $$3.cs);
      $$1.a(a.b.rotationDegrees(($$3.i($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.j($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bus.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azq.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, bus.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bus.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azq.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, bus.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static grv.a a(grb $$0) {
      daa $$1 = $$0.fb();
      daa $$2 = $$0.fc();
      boolean $$3 = $$1.a(dae.pj) || $$2.a(dae.pj);
      boolean $$4 = $$1.a(dae.xg) || $$2.a(dae.xg);
      if (!$$3 && !$$4) {
         return grv.a.a;
      } else if ($$0.fz()) {
         return b($$0);
      } else {
         return a($$1) ? grv.a.b : grv.a.a;
      }
   }

   private static grv.a b(grb $$0) {
      daa $$1 = $$0.fB();
      bus $$2 = $$0.fA();
      if (!$$1.a(dae.pj) && !$$1.a(dae.xg)) {
         return $$2 == bus.a && a($$0.fc()) ? grv.a.b : grv.a.a;
      } else {
         return grv.a.a($$2);
      }
   }
   ...
   private static boolean a(daa $$0) {
      return $$0.a(dae.xg) && cyt.g($$0);
   }

   private void a(gqy $$0, float $$1, float $$2, bus $$3, float $$4, daa $$5, float $$6, flq $$7, gsc $$8, int $$9) {
      if (!$$0.gH()) {
         boolean $$10 = $$3 == bus.a;
         bxn $$11 = $$10 ? $$0.fy() : $$0.fy().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.co()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3 && !$$12) {
               ...
               float $$15 = (float)$$5.a((bxw)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cyt.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = azq.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
            ...
            this.a($$0, $$5, $$13 ? czy.e : czy.d, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bxn.b;
            int $$21 = $$20 ? 1 : -1;
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$22 = (float)$$5.a((bxw)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$23 = $$22 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$21 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$21 * -9.785F));
                     float $$27 = (float)$$5.a((bxw)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$28 = $$27 / 10.0F;
                     if ($$28 > 1.0F) {
                        $$28 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$20 ? czy.e : czy.d, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, flq $$2, int $$3, bxn $$4) {
      float $$5 = -0.4F * azq.a(azq.c($$0) * (float) Math.PI);
      float $$6 = 0.2F * azq.a(azq.c($$0) * (float) (Math.PI * 2));
      float $$7 = -0.2F * azq.a($$0 * (float) Math.PI);
      $$2.a((float)$$3 * $$5, $$6, $$7);
      this.b($$2, $$4, $$1);
      this.a($$2, $$4, $$0);
   }
   ...
   private boolean a(daa $$0, daa $$1) {
      return daa.a($$0, $$1) ? true : !this.aE.a($$1);
   }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ay = azq.a(this.ay - 0.4F, 0.0F, 1.0F);
         this.aA = azq.a(this.aA - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.H(1.0F);
         float $$4 = this.aw != $$1 ? 0.0F : $$3 * $$3 * $$3;
         float $$5 = this.ax != $$2 ? 0.0F : 1.0F;
         this.ay = this.ay + azq.a($$4 - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + azq.a($$5 - this.aA, -0.4F, 0.4F);
      }
