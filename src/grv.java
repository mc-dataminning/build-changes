...
public record grv(alg a, j b, boolean c, int d) implements hln {
   @Override
   public j a() {
      return this.b;
   }
   ...
   public static class a implements JsonDeserializer<grv> {
      @VisibleForTesting
      ...
      public grv a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         alg $$4 = this.b($$3);
         hky $$5 = this.a($$3);
         boolean $$6 = this.d($$3);
         int $$7 = this.c($$3);
         return new grv($$4, $$5.a(), $$6, $$7);
      }
