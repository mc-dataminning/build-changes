...
public class buy extends bum {
   ...
   public buy(dgj $$0, double $$1, double $$2, double $$3, int $$4) {
      this(but.V, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public buy(but<? extends buy> $$0, dgj $$1) {
      super($$0, $$1);
   }
   ...
   public void h() {
      ...
      if (this.j != null) {
         fbb $$0 = new fbb(this.j.dA() - this.dA(), this.j.dC() + (double)this.j.cS() / 2.0 - this.dC(), this.j.dG() - this.dG());
         double $$1 = $$0.h();
         if ($$1 < 64.0) {
      ...
      if (this.aJ()) {
         this.i(new fbb(this.dy().d, -$$3 * 0.4, this.dy().f));
      }
   ...
   private void p() {
      ...
      if (this.dV() instanceof ard) {
         for (buy $$1 : this.dV().a(ebi.a(buy.class), this.cR().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(ard $$0, fbb $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new buy($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(ard $$0, fbb $$1, int $$2) {
      faw $$3 = faw.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.H_().a(40);
      List<buy> $$5 = $$0.a(ebi.a(buy.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         buy $$6 = $$5.get(0);
         $$6.i++;
         $$6.f = 0;
   ...
   private boolean a(buy $$0) {
      return $$0 != this && a($$0, this.ar(), this.h);
   }

   private static boolean a(buy $$0, int $$1, int $$2) {
      return !$$0.dQ() && ($$0.ar() - $$1) % 40 == 0 && $$0.h == $$2;
   }

   private void b(buy $$0) {
      this.i = this.i + $$0.i;
   ...
   private int a(are $$0, int $$1) {
      Optional<dcz> $$2 = ddc.a(ddb.z, $$0, cwq::n);
      if ($$2.isPresent()) {
         cwq $$3 = $$2.get().a();
         int $$4 = ddc.c($$0.y(), $$3, $$1);
