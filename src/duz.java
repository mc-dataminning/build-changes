...
public class duz extends dvq {
   public static final Codec<duz> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(dvs.a.fieldOf("delegate").forGetter($$0x -> $$0x.b), bdc.e.fieldOf("limit").forGetter($$0x -> $$0x.c)).apply($$0, duz::new)
   );
   private final dvq b;
   private final bdc c;
         ...
         if ($$3.size() != $$4.size()) {
            ...
            if ($$7 < 1) {
               ...
               while ($$9.hasNext() && $$10 < $$7) {
                  ...
                  dvt.c $$12 = $$3.get($$11);
                  dvt.c $$13 = $$4.get($$11);
                  dvt.c $$14 = this.b.a($$0, $$1, $$2, $$12, $$13, $$5);
