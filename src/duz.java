...
public class duz extends dvd {
   public static final Codec<duz> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, duz::new));

   public duz(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<dtl.a> a(csg $$0, BiConsumer<ht, dhi> $$1, ats $$2, int $$3, ht $$4, dsv $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new dtl.a(new ht($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new dtl.a(new ht($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
