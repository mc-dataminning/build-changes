...
public class ece implements ecf, ecg {
   ...
   private final egu<MinecraftServer> K;
   ...
   public ece(cqf $$0, dlk $$1, ece.a $$2, Lifecycle $$3) {
      this(
         null,
         aa.b().d().c(),
         null,
   ...
   public static <T> ece a(Dynamic<T> $$0, DataFixer $$1, int $$2, @Nullable qw $$3, cqf $$4, ecc $$5, ece.a $$6, dlk $$7, Lifecycle $$8) {
      ...
      return new ece(
         ...
         (UUID)$$0.get("WanderingTraderId").read(hx.a).result().orElse(null),
         ...
         new egu<>(egt.a, $$0.get("ScheduledEvents").asStream()),
         (qw)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dip.a.a).resultOrPartial(e::error).orElse(dip.a.b),
         $$4,
         $$7,
         $$6,
         $$8
   ...
   @Override
   public qw a(hr $$0, @Nullable qw $$1) {
      this.N();
      if ($$1 == null) {
         $$1 = this.s;
      }
   ...
   private void a(hr $$0, qw $$1, @Nullable qw $$2) {
      ...
      $$1.a("Version", $$3);
      rj.g($$1);
      DynamicOps<rq> $$4 = aex.a(ri.a, $$0);
      dli.a($$4, this.g, $$0).resultOrPartial(ac.a("WorldGenSettings: ", e::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dip.a.a.encodeStart(ri.a, this.C), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<rq> $$5 = cqu.b.encodeStart(ri.a, this.f.g());
      $$5.get().ifLeft($$1x -> $$1.a((qw)$$1x)).ifRight($$0x -> e.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.D != null) {
   ...
   private static rc a(Set<String> $$0) {
      rc $$1 = new rc();
   ...
   private void N() {
      if (!this.r && this.s != null) {
         if (this.q < aa.b().d().c()) {
            ...
            this.s = atg.b.a(this.p, this.s, this.q);
         }
   ...
   @Override
   public boolean B() {
      return this.h == ece.a.b;
   }

   @Override
   public boolean C() {
      return this.h == ece.a.c;
   }
