...
public class ece {
   ...
   private final Map<String, ebt> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public ece(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends ebt> T a(ebt.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends ebt> T b(ebt.a $$0, String $$1) {
      ebt $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends ebt> T a(Function<qy, T> $$0, atc $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
   ...
   public void a(String $$0, ebt $$1) {
      this.b.put($$0, $$1);
   }

   public qy a(String $$0, atc $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
