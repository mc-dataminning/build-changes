...
public class gnb {
   ...
   static final ThreadLocal<gnb.d> f = ThreadLocal.withInitial(gnb.d::new);

   public gnb(fmj $$0) {
      this.d = $$0;
   }

   public void a(dfi $$0, hgm $$1, dwv $$2, ji $$3, ffs $$4, ffw $$5, boolean $$6, azg $$7, long $$8, int $$9) {
      boolean $$10 = flh.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(dfi $$0, hgm $$1, dwv $$2, ji $$3, ffs $$4, ffw $$5, boolean $$6, azg $$7, long $$8, int $$9) {
      ...
      for (jn $$14 : c) {
         $$7.b($$8);
         List<gnc> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || djk.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gnc> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dfi $$0, hgm $$1, dwv $$2, ji $$3, ffs $$4, ffw $$5, boolean $$6, azg $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      ji.a $$11 = $$3.k();

      for (jn $$12 : c) {
         $$7.b($$8);
         List<gnc> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || djk.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = glr.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gnc> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dfi $$0, dwv $$1, ji $$2, ffs $$3, ffw $$4, List<gnc> $$5, float[] $$6, BitSet $$7, gnb.b $$8, int $$9) {
      for (gnc $$10 : $$5) {
   ...
   private void a(
      dfi $$0, dwv $$1, ji $$2, ffw $$3, ffs.a $$4, gnc $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dfi $$0, dwv $$1, ji $$2, int[] $$3, jn $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dfi $$0, dwv $$1, ji $$2, int $$3, int $$4, boolean $$5, ffs $$6, ffw $$7, List<gnc> $$8, BitSet $$9) {
      for (gnc $$10 : $$8) {
         if ($$5) {
   ...
   public void a(ffs.a $$0, ffw $$1, @Nullable dwv $$2, hgm $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azg $$9 = azg.a();
      long $$10 = 42L;
   ...
   private static void a(ffs.a $$0, ffw $$1, float $$2, float $$3, float $$4, List<gnc> $$5, int $$6, int $$7) {
      for (gnc $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gnb.e[]{gnb.e.k, gnb.e.d, gnb.e.k, gnb.e.j, gnb.e.e, gnb.e.j, gnb.e.e, gnb.e.d},
         new gnb.e[]{gnb.e.k, gnb.e.c, gnb.e.k, gnb.e.i, gnb.e.e, gnb.e.i, gnb.e.e, gnb.e.c},
         new gnb.e[]{gnb.e.l, gnb.e.c, gnb.e.l, gnb.e.i, gnb.e.f, gnb.e.i, gnb.e.f, gnb.e.c},
         new gnb.e[]{gnb.e.l, gnb.e.d, gnb.e.l, gnb.e.j, gnb.e.f, gnb.e.j, gnb.e.f, gnb.e.d}
      ),
      b(
         new jn[]{jn.f, jn.e, jn.c, jn.d},
         1.0F,
         true,
         new gnb.e[]{gnb.e.f, gnb.e.d, gnb.e.f, gnb.e.j, gnb.e.l, gnb.e.j, gnb.e.l, gnb.e.d},
         new gnb.e[]{gnb.e.f, gnb.e.c, gnb.e.f, gnb.e.i, gnb.e.l, gnb.e.i, gnb.e.l, gnb.e.c},
         new gnb.e[]{gnb.e.e, gnb.e.c, gnb.e.e, gnb.e.i, gnb.e.k, gnb.e.i, gnb.e.k, gnb.e.c},
         new gnb.e[]{gnb.e.e, gnb.e.d, gnb.e.e, gnb.e.j, gnb.e.k, gnb.e.j, gnb.e.k, gnb.e.d}
      ),
      c(
         new jn[]{jn.b, jn.a, jn.f, jn.e},
         0.8F,
         true,
         new gnb.e[]{gnb.e.b, gnb.e.k, gnb.e.b, gnb.e.e, gnb.e.h, gnb.e.e, gnb.e.h, gnb.e.k},
         new gnb.e[]{gnb.e.b, gnb.e.l, gnb.e.b, gnb.e.f, gnb.e.h, gnb.e.f, gnb.e.h, gnb.e.l},
         new gnb.e[]{gnb.e.a, gnb.e.l, gnb.e.a, gnb.e.f, gnb.e.g, gnb.e.f, gnb.e.g, gnb.e.l},
         new gnb.e[]{gnb.e.a, gnb.e.k, gnb.e.a, gnb.e.e, gnb.e.g, gnb.e.e, gnb.e.g, gnb.e.k}
      ),
      d(
         new jn[]{jn.e, jn.f, jn.a, jn.b},
         0.8F,
         true,
         new gnb.e[]{gnb.e.b, gnb.e.k, gnb.e.h, gnb.e.k, gnb.e.h, gnb.e.e, gnb.e.b, gnb.e.e},
         new gnb.e[]{gnb.e.a, gnb.e.k, gnb.e.g, gnb.e.k, gnb.e.g, gnb.e.e, gnb.e.a, gnb.e.e},
         new gnb.e[]{gnb.e.a, gnb.e.l, gnb.e.g, gnb.e.l, gnb.e.g, gnb.e.f, gnb.e.a, gnb.e.f},
         new gnb.e[]{gnb.e.b, gnb.e.l, gnb.e.h, gnb.e.l, gnb.e.h, gnb.e.f, gnb.e.b, gnb.e.f}
      ),
      e(
         new jn[]{jn.b, jn.a, jn.c, jn.d},
         0.6F,
         true,
         new gnb.e[]{gnb.e.b, gnb.e.d, gnb.e.b, gnb.e.j, gnb.e.h, gnb.e.j, gnb.e.h, gnb.e.d},
         new gnb.e[]{gnb.e.b, gnb.e.c, gnb.e.b, gnb.e.i, gnb.e.h, gnb.e.i, gnb.e.h, gnb.e.c},
         new gnb.e[]{gnb.e.a, gnb.e.c, gnb.e.a, gnb.e.i, gnb.e.g, gnb.e.i, gnb.e.g, gnb.e.c},
         new gnb.e[]{gnb.e.a, gnb.e.d, gnb.e.a, gnb.e.j, gnb.e.g, gnb.e.j, gnb.e.g, gnb.e.d}
      ),
      f(
         new jn[]{jn.a, jn.b, jn.c, jn.d},
         0.6F,
         true,
         new gnb.e[]{gnb.e.g, gnb.e.d, gnb.e.g, gnb.e.j, gnb.e.a, gnb.e.j, gnb.e.a, gnb.e.d},
         new gnb.e[]{gnb.e.g, gnb.e.c, gnb.e.g, gnb.e.i, gnb.e.a, gnb.e.i, gnb.e.a, gnb.e.c},
         new gnb.e[]{gnb.e.h, gnb.e.c, gnb.e.h, gnb.e.i, gnb.e.b, gnb.e.i, gnb.e.b, gnb.e.c},
         new gnb.e[]{gnb.e.h, gnb.e.d, gnb.e.h, gnb.e.j, gnb.e.b, gnb.e.j, gnb.e.b, gnb.e.d}
      );
      ...
      final gnb.e[] k;
      final gnb.e[] l;
      private static final gnb.a[] m = af.a(new gnb.a[6], $$0 -> {
         $$0[jn.a.d()] = a;
         $$0[jn.b.d()] = b;
         $$0[jn.c.d()] = c;
         $$0[jn.d.d()] = d;
      ...
      private a(final jn[] $$0, final float $$1, final boolean $$2, final gnb.e[] $$3, final gnb.e[] $$4, final gnb.e[] $$5, final gnb.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dfi $$0, dwv $$1, ji $$2, jn $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dwv $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dwv $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dwv $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dwv $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gnb.c[] k = af.a(new gnb.c[6], $$0 -> {
         $$0[jn.a.d()] = a;
         $$0[jn.b.d()] = b;
         $$0[jn.c.d()] = c;
         $$0[jn.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dwv $$0, dfi $$1, ji $$2) {
         long $$3 = $$2.a();
         if (this.a) {
