...
public class gnb implements gna {
   ...
   private float a(ctq $$0, fwr $$1, int $$2, brw $$3) {
   ...
   private float a(int $$0, long $$1) {
      ...
      return ayf.b((float)$$2, 1.0F);
   }

   private float a(brw $$0, long $$1, io $$2) {
      double $$3 = this.a($$0, $$2);
      double $$4 = this.a($$0);
      if ($$0 instanceof cly $$5 && $$5.g() && $$5.dP().s().i()) {
         if (this.c.a($$1)) {
            this.c.a($$1, 0.5 - ($$4 - 0.25));
         }

         double $$6 = $$3 + this.c.a;
         return ayf.b((float)$$6, 1.0F);
      }

      double $$7 = 0.5 - ($$4 - 0.25 - $$3);
      return ayf.b((float)$$7, 1.0F);
   }

   @Nullable
   private fwr a(brw $$0, @Nullable fwr $$1) {
      return $$1 == null && $$0.dP() instanceof fwr ? (fwr)$$0.dP() : $$1;
   }

   private boolean a(brw $$0, @Nullable iw $$1) {
      return $$1 != null && $$1.a() == $$0.dP().ae() && !($$1.b().b($$0.dn()) < 1.0E-5F);
   }

   private double a(brw $$0, io $$1) {
      eum $$2 = eum.b($$1);
      return Math.atan2($$2.c() - $$0.dA(), $$2.a() - $$0.du()) / (float) (Math.PI * 2);
   }

   private double a(brw $$0) {
      return ayf.c((double)($$0.dG() / 360.0F), 1.0);
   }
   ...
   public interface a {
      @Nullable
      iw getPos(fwr var1, ctq var2, brw var3);
   }
