...
public abstract class avf<T> extends avg<Map<ali, T>> {
   private static final Logger a = LogUtils.getLogger();
   private final DynamicOps<JsonElement> b;
   private final Codec<T> c;
   private final String d;

   protected avf(js.a $$0, Codec<T> $$1, String $$2) {
      this($$0.a(JsonOps.INSTANCE), $$1, $$2);
   }

   protected avf(Codec<T> $$0, String $$1) {
      this(JsonOps.INSTANCE, $$0, $$1);
   }

   private avf(DynamicOps<JsonElement> $$0, Codec<T> $$1, String $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }

   protected Map<ali, T> a(avb $$0, bon $$1) {
      Map<ali, T> $$2 = new HashMap<>();
      a($$0, this.d, this.b, this.c, $$2);
      return $$2;
   }

   public static <T> void a(avb $$0, String $$1, DynamicOps<JsonElement> $$2, Codec<T> $$3, Map<ali, T> $$4) {
      alb $$5 = alb.a($$1);

      for (Entry<ali, auz> $$6 : $$5.a($$0).entrySet()) {
         ali $$7 = $$6.getKey();
         ali $$8 = $$5.b($$7);
