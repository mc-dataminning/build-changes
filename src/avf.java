...
public class avf extends avk {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<avg<?>> e = Sets.newHashSet();

   public avf(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<avg<?>> d() {
      Set<avg<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  ty $$4 = a($$3.getAsJsonObject());
                  $$4 = azc.g.a($$0, $$4, un.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<avg<T>> a(avi<T> $$0, String $$1) {
      return Optional.ofNullable(akf.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static ty a(JsonObject $$0) {
      ty $$1 = new ty();
   ...
   protected String b() {
      Map<avi<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avg<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avg<?>>)$$3.next();
         avg<?> $$2 = (avg<?>)$$1.getKey();
      ...
      for (Entry<avi<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lc.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> akf b(avg<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aqf $$0) {
      Object2IntMap<avg<?>> $$1 = new Object2IntOpenHashMap();
