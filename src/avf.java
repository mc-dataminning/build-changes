...
public class avf extends axr {
   public avf(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", ayp.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(ayp.z.typeName(), azx.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(ayp.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(ayp.z.typeName(), "minecraft:saddle"));
