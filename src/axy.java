...
public class axy<T> extends AbstractList<T> implements azi<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axy.this.get(this.b--);
      }

      @Override
      public void remove() {
         axy.this.remove(this.b + 1);
      }
   }
