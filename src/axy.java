...
public class axy {
   ...
   axy(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(axy::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public axy.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public axy a(Writer $$0) throws IOException {
         return new axy($$0, this.a);
      }
   }
}
