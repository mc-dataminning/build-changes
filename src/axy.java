...
public class axy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("Rename ItemStack Attributes", $$0, $$1x -> $$1x.updateTyped($$1, axy::a)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("Rename Entity Attributes", this.getInputSchema().getType(bdn.y), axy::b),
            this.fixTypeEverywhereTyped("Rename Player Attributes", this.getInputSchema().getType(bdn.b), axy::b)
         }
      );
   }
      ...
      return $$0.update(
         ...
         $$0x -> $$0x.update(
               ...
               $$0xx -> (Dynamic)DataFixUtils.orElse(
                     $$0xx.asStreamOpt().result().map($$0xxx -> $$0xxx.map($$0xxxx -> $$0xxxx.update("AttributeName", axy::a))).map($$0xx::createList), $$0xx
                  )
            )
      );
   }
   ...
   private static Typed<?> b(Typed<?> $$0) {
      return $$0.update(
         ...
         $$0x -> $$0x.update(
               "Attributes",
               $$0xx -> (Dynamic)DataFixUtils.orElse(
                     $$0xx.asStreamOpt().result().map($$0xxx -> $$0xxx.map($$0xxxx -> $$0xxxx.update("Name", axy::a))).map($$0xx::createList), $$0xx
                  )
            )
      );
   }
