...
public class epp implements ead.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<epp> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayw<epp> a = ayw.a(f);
   private final ept g;
   private final ept h;
   private final ept i;
   ...
   public static epp a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new epp(new ebl(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private epp(ept $$0, ept $$1, ept $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public epp(azl $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ept.a($$0, IntStream.rangeClosed(-15, 0)),
         ept.a($$0, IntStream.rangeClosed(-15, 0)),
         ept.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public epp a(azl $$0) {
      return new epp($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(ead.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         epq $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ept.b($$4 * $$13), ept.b($$5 * $$13), ept.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ept.b($$1 * $$13);
         double $$21 = ept.b($$2 * $$13);
         double $$22 = ept.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            epq $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return azd.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
