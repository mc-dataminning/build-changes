...
public class epp {
   ...
   public static List<epp.a> a(String $$0, epp.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<epp.a> a(String $$0, List<epp.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<epp.a> a(List<String> $$0, List<epp.b> $$1) {
      int $$2 = 0;
      List<epp.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<epp.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static epp.b a(String $$0, String $$1) {
         return new epp.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static epp.b a(String $$0) {
         return new epp.b($$0);
      }
   }
}
