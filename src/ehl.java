...
public class ehl extends efz<eiz> {
   ...
   private static boolean d(dgp $$0, ji $$1) {
      return $$0.a($$1, $$0x -> $$0x.a(djp.ft));
   }

   public static boolean b(dgp $$0, ji $$1) {
      return $$0.a($$1, $$0x -> $$0x.l() || $$0x.a(awp.Q));
   }

   private static void b(dgr $$0, ji $$1, dwy $$2) {
      $$0.a($$1, $$2, 19);
   }

   public static boolean c(dgp $$0, ji $$1) {
      return $$0.a($$1, $$0x -> $$0x.l() || $$0x.a(awp.cq));
   }

   private boolean a(dhh $$0, azh $$1, ji $$2, BiConsumer<ji, dwy> $$3, BiConsumer<ji, dwy> $$4, ejp.b $$5, eiz $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.L_() + 1 && $$13 <= $$0.an() + 1) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<ejp.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   private int a(dgp $$0, int $$1, ji $$2, eiz $$3) {
      ji.a $$4 = new ji.a();
   ...
   @Override
   public final boolean a(egb<eiz> $$0) {
      final dhh $$1 = $$0.b();
      azh $$2 = $$0.d();
      ji $$3 = $$0.e();
      eiz $$4 = $$0.f();
      ...
      BiConsumer<ji, dwy> $$9 = ($$2x, $$3x) -> {
         $$5.add($$2x.j());
         $$1.a($$2x, $$3x, 19);
      };
      BiConsumer<ji, dwy> $$10 = ($$2x, $$3x) -> {
         $$6.add($$2x.j());
         $$1.a($$2x, $$3x, 19);
      };
      ejp.b $$11 = new ejp.b() {
         @Override
         public void a(ji $$0, dwy $$1x) {
            $$7.add($$0.j());
            $$1.a($$0, $$1, 19);
         }
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            ekx.a $$14 = new ekx.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return enf.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            fbk $$5x = a($$1, $$4x, $$6, $$8, $$5);
            erp.a($$1, 3, $$5x, $$4x.h(), $$4x.i(), $$4x.j());
            return true;
         }).orElse(false);
      } else {
         return false;
   ...
   private static fbk a(dgk $$0, enf $$1, Set<ji> $$2, Set<ji> $$3, Set<ji> $$4) {
      fbk $$5 = new fbe($$1.d(), $$1.e(), $$1.f());
      int $$6 = 7;
      ...
      while (true) {
         while ($$11 >= 7 || !$$7.get($$11).isEmpty()) {
            ...
            if ($$1.b($$13)) {
               if ($$11 != 0) {
                  dwy $$14 = $$0.a_($$13);
                  b($$0, $$13, $$14.b(dxo.aF, Integer.valueOf($$11)));
               }
