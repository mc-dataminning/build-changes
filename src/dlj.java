...
public class dlj {
   ...
   @SafeVarargs
   public static dlj.f a(aev<cqt>... $$0) {
      return a(List.of($$0));
   }

   private static dlj.c a(List<aev<cqt>> $$0) {
      return new dlj.c($$0);
   }

   public static dlj.f a(aev<dzp.a> $$0, double $$1) {
      return a($$0, $$1, Double.MAX_VALUE);
   }

   public static dlj.f a(aev<dzp.a> $$0, double $$1, double $$2) {
      return new dlj.l($$0, $$1, $$2);
   }

   public static dlj.f a(String $$0, dlm $$1, dlm $$2) {
      return new dlj.y(new aew($$0), $$1, $$2);
   }
   ...
   static <A> Codec<? extends A> a(hq<Codec<? extends A>> $$0, String $$1, arq<? extends A> $$2) {
      return hq.a($$0, $$1, $$2.a());
   }
   ...
   static enum a implements dlj.f {
      ...
      static final arq<dlj.a> c = arq.a(MapCodec.unit(a));

      @Override
      public arq<? extends dlj.f> a() {
         return c;
      }
   ...
   static record aa(dlm a, int c, boolean d) implements dlj.f {
      static final arq<dlj.aa> e = arq.a(
   ...
   static enum b implements dlj.o {
      ...
      static final arq<dlj.b> c = arq.a(MapCodec.unit(a));

      @Override
      public arq<? extends dlj.o> a() {
         return c;
      }
   ...
   static final class c implements dlj.f {
      static final arq<dlj.c> a = arq.a(aev.a(jc.ap).listOf().fieldOf("biome_is").xmap(dlj::a, $$0 -> $$0.c));
      private final List<aev<cqt>> c;
      final Predicate<aev<cqt>> d;
   ...
   static record d(dfj a, dlj.r c) implements dlj.o {
      static final arq<dlj.d> d = arq.a(dfj.b.xmap(dlj.d::new, dlj.d::b).fieldOf("result_state"));
   ...
   public interface f extends Function<dlj.g, dlj.e> {
      Codec<dlj.f> b = jb.ae.q().dispatch($$0 -> $$0.a().a(), Function.identity());

      static Codec<? extends dlj.f> a(hq<Codec<? extends dlj.f>> $$0) {
   ...
   protected static final class g {
      ...
      final dhf k;
      private final dkw l;
      private final Function<gw, he<cqt>> m;
      final dlp n;
      ...
      protected g(dlk $$0, dlg $$1, dhf $$2, dkw $$3, Function<gw, he<cqt>> $$4, hq<cqt> $$5, dlp $$6) {
         this.e = $$0;
         this.j = $$1;
         this.k = $$2;
         this.l = $$3;
   ...
   static enum h implements dlj.f {
      ...
      static final arq<dlj.h> c = arq.a(MapCodec.unit(a));
   ...
   static record l(aev<dzp.a> a, double c, double d) implements dlj.f {
      static final arq<dlj.l> e = arq.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     aev.a(jc.ax).fieldOf("noise").forGetter(dlj.l::b),
   ...
   static record n(dlj.f a) implements dlj.f {
      static final arq<dlj.n> c = arq.a(dlj.f.b.xmap(dlj.n::new, dlj.n::b).fieldOf("invert"));
   ...
   public interface o extends Function<dlj.g, dlj.u> {
      Codec<dlj.o> b = jb.af.q().dispatch($$0 -> $$0.a().a(), Function.identity());

      static Codec<? extends dlj.o> a(hq<Codec<? extends dlj.o>> $$0) {
   ...
   static record q(List<dlj.o> a) implements dlj.o {
      static final arq<dlj.q> c = arq.a(dlj.o.b.listOf().xmap(dlj.q::new, dlj.q::b).fieldOf("sequence"));
   ...
   static enum s implements dlj.f {
      ...
      static final arq<dlj.s> c = arq.a(MapCodec.unit(a));
   ...
   static record t(int a, boolean c, int d, dud e) implements dlj.f {
      static final arq<dlj.t> f = arq.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
      ...
      public dlj.e a(final dlj.g $$0) {
         ...
         class a extends dlj.k {
            ...
            protected boolean a() {
               ...
               int $$2 = t.this.d == 0 ? 0 : (int)arw.b(this.c.a(), -1.0, 1.0, 0.0, (double)t.this.d);
   ...
   static enum v implements dlj.f {
      ...
      static final arq<dlj.v> c = arq.a(MapCodec.unit(a));
   ...
   static record x(dlj.f a, dlj.o c) implements dlj.o {
      static final arq<dlj.x> d = arq.a(
         RecordCodecBuilder.mapCodec(
   ...
   static record y(aew a, dlm c, dlm d) implements dlj.f {
      static final arq<dlj.y> e = arq.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     aew.a.fieldOf("random_name").forGetter(dlj.y::b),
         ...
         class a extends dlj.k {
            ...
            protected boolean a() {
               ...
               if ($$0 <= $$1) {
                  ...
                  double $$1 = arw.b((double)$$0, (double)$$1, (double)$$2, 1.0, 0.0);
   ...
   static record z(int a, int c, boolean d) implements dlj.f {
      static final arq<dlj.z> e = arq.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
