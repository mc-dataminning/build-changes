...
public class ajq {
   static final Dynamic3CommandExceptionType a = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> vf.b("commands.item.target.not_a_container", $$0, $$1, $$2)
   );
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> vf.b("commands.item.source.not_a_container", $$0, $$1, $$2)
   );
   static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> vf.b("commands.item.target.no_such_slot", $$0));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> vf.b("commands.item.source.no_such_slot", $$0));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> vf.b("commands.item.target.no_changes", $$0));
   ...
   private static int a(ds $$0, Collection<? extends blv> $$1, int $$2, cmy $$3) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         if ($$4.size() == 1) {
            $$0.a(() -> vf.a("commands.item.entity.set.success.single", $$4.iterator().next().Q_(), $$3.J()), true);
         } else {
            $$0.a(() -> vf.a("commands.item.entity.set.success.multiple", $$4.size(), $$3.J()), true);
         }
