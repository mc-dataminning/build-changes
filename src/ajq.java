...
public final class ajq<E> implements Codec<il<E>> {
   private final ajs<? extends iy<E>> a;

   public static <E> ajq<E> a(ajs<? extends iy<E>> $$0) {
      return new ajq<>($$0);
   }

   private ajq(ajs<? extends iy<E>> $$0) {
      this.a = $$0;
   }
