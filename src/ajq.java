...
public class ajq {
   ...
   private static int a(du $$0, Pair<agg, Either<gx<du>, Collection<gx<du>>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.f().V() + (long)$$2;
         agg $$5 = (agg)$$1.getFirst();
         eiv<MinecraftServer> $$6 = $$0.m().aT().K().u();
