...
public class bjw implements bjx {
   ...
   private static final bjw k = new bjw();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bjv $$0) {
      URL $$1 = bjw.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bjv $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bjz a = new bjz(() -> bjw.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bjw.this.l && $$0.getState() == RecordingState.STOPPED) {
