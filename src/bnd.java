...
public class bnd<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bnd(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bnd<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bne<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bne<T> $$0 = bne.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bne<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bnd.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bnd.this.c.position();
               }
