...
public class dvr extends dvs {
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      this.g = $$0.i("Age");
      uf.a($$0, "exit_portal").filter(dgh::l).ifPresent($$0x -> this.i = $$0x);
      this.j = $$0.q("ExactTeleport");
   }

   public static void a(dgh $$0, ji $$1, dww $$2, dvr $$3) {
      $$3.g++;
      if ($$3.c()) {
         $$3.h--;
      }
   ...
   public static void b(dgh $$0, ji $$1, dww $$2, dvr $$3) {
      boolean $$4 = $$3.b();
      boolean $$5 = $$3.c();
      $$3.g++;
      if ($$5) {
   ...
   public static void c(dgh $$0, ji $$1, dww $$2, dvr $$3) {
      if (!$$0.C) {
         $$3.h = 40;
         $$0.a($$1, $$2.b(), 1, 0);
         a($$0, $$1, $$2);
   ...
   @Nullable
   public faz a(ard $$0, ji $$1) {
      if (this.i == null && $$0.ai() == dgh.k) {
         ji $$2 = b($$0, $$1);
         $$2 = $$2.b(10);
      ...
      if (this.i != null) {
         ji $$3 = this.j ? this.i : a((dgh)$$0, this.i);
         return $$3.c();
      } else {
         return null;
      }
   ...
   private static ji a(dgh $$0, ji $$1) {
   ...
   private static ji b(ard $$0, ji $$1) {
      ...
      if ($$4 == null) {
         ...
         $$0.K_().a(mc.aL).flatMap($$0x -> $$0x.a(re.f)).ifPresent($$2x -> ((efj)$$2x.a()).a($$0, $$0.m().g(), azh.a($$5.a()), $$5));
         $$4 = $$5;
      } else {
   ...
   private static faz c(ard $$0, ji $$1) {
      faz $$2 = new faz((double)$$1.u(), 0.0, (double)$$1.w()).d();
      int $$3 = 1024;
      faz $$4 = $$2.c(1024.0);
   ...
   private static boolean a(ard $$0, faz $$1) {
      return a((dgh)$$0, $$1).a() == -1;
   }

   private static ji a(dfm $$0, ji $$1, int $$2, boolean $$3) {
      ji $$4 = null;
   ...
   private static dzb a(dgh $$0, faz $$1) {
      return $$0.d(ayz.a($$1.d / 16.0), ayz.a($$1.f / 16.0));
   }

   @Nullable
   private static ji a(dzb $$0) {
      dfn $$1 = $$0.f();
      ...
      for (ji $$7 : ji.c($$2, $$4)) {
         ...
         ji $$9 = $$7.d();
         ji $$10 = $$7.b(2);
         if ($$8.a(djn.fU) && !$$0.a_($$9).m($$0, $$9) && !$$0.a_($$10).m($$0, $$10)) {
   ...
   private static void a(ard $$0, ji $$1, eia $$2) {
      efx.M.a($$2, $$0, $$0.m().g(), azh.a(), $$1);
   }

   @Override
   public boolean a(jn $$0) {
      return djl.a(this.m(), this.o.a_(this.aA_().a($$0)), $$0);
   }
