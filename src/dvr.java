...
public class dvr extends dtz {
   ...
   public void a(dyg $$0) {
      this.l = $$0;
      dwx $$1 = this.n.a_(this.aA_());
      if ($$1.a(djo.pC)) {
         this.n.a(this.aA_(), $$1.b(drp.b, $$0), 2);
      }
   }
   ...
   private Stream<ji> a(ji $$0, ji $$1) {
      return ji.d($$0, $$1)
         .filter($$0x -> this.n.a_($$0x).a(djo.pC))
         .map(this.n::c_)
   ...
   public boolean b(boolean $$0) {
      if (this.e == null) {
         ...
         $$4.a(this.n, $$1, this.i, !this.m, djo.lp);
         $$4.a(this.f);
         if ($$0) {
            try {
               return $$3.c(this.e);
   ...
   public boolean B() {
      if (this.l == dyg.b && !this.n.C && this.e != null) {
         ard $$0 = (ard)this.n;
         erp $$1 = $$0.r();
