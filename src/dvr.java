...
public class dvr implements dwq<bsg> {
   ...
   private final boz<Runnable> g;

   public dvr(dwb $$0, aqm $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = boz.a($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<dwl<bsg>> a(dbm $$0) {
      return this.f.contains($$0.a()) ? CompletableFuture.completedFuture(b($$0)) : this.e.a($$0).thenApplyAsync($$1 -> {
         if ($$1.isEmpty()) {
            ...
            List<bsg> $$6 = bsm.a($$5, this.d).collect(ImmutableList.toImmutableList());
            return new dwl<>($$0, $$6);
         }
      }, this.g::a);
   }

   private static dbm a(tx $$0) {
      int[] $$1 = $$0.n("Position");
      return new dbm($$1[0], $$1[1]);
   }

   private static void a(tx $$0, dbm $$1) {
      $$0.a("Position", new ub(new int[]{$$1.e, $$1.f}));
   }

   private static dwl<bsg> b(dbm $$0) {
      return new dwl<>($$0, ImmutableList.of());
   }

   @Override
   public void a(dwl<bsg> $$0) {
      dbm $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
            this.e.a($$1, null);
