...
public class dvr {
   ...
   private final List<dvp> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dvr.a l = new dvr.d(5.999997E7F);
   public static final dvr.c d = new dvr.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(je $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(eye $$0) {
   ...
   public eye c(double $$0, double $$1, double $$2) {
      return new eye(azc.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azc.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public boolean a(btj $$0, exz $$1) {
      double $$2 = Math.max(azc.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dvr.a)($$0 == $$1 ? new dvr.d($$1) : new dvr.b($$0, $$1, $$2));
   ...
   class b implements dvr.a {
      ...
      @Override
      public double a() {
         return azc.a(dvr.this.a() - this.e() / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
      }

      @Override
      public double c() {
         return azc.a(dvr.this.b() - this.e() / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azc.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dvq i() {
         return this.c < this.b ? dvq.b : dvq.a;
      }
      ...
      @Override
      public dvr.a l() {
         return (dvr.a)(this.g() <= 0L ? dvr.this.new d(this.c) : this);
      }
      ...
      public eyx m() {
         return eyu.a(
            eyu.c,
            eyu.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eyi.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dvr.c a(DynamicLike<?> $$0, dvr.c $$1) {
         double $$2 = azc.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azc.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dvr.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dvr.a {
      ...
      private void n() {
         this.c = azc.a(dvr.this.a() - this.b / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
         this.d = azc.a(dvr.this.b() - this.b / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
         this.e = azc.a(dvr.this.a() + this.b / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
         this.f = azc.a(dvr.this.b() + this.b / 2.0, (double)(-dvr.this.k), (double)dvr.this.k);
         this.g = eyu.a(
            eyu.c,
            eyu.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eyi.e
