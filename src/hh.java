...
public class hh {
   static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> xj.b("argument.item.id.invalid", $$0));
   static final DynamicCommandExceptionType g = new DynamicCommandExceptionType($$0 -> xj.b("arguments.item.component.unknown", $$0));
   static final Dynamic2CommandExceptionType h = new Dynamic2CommandExceptionType(($$0, $$1) -> xj.b("arguments.item.component.malformed", $$0, $$1));
   static final SimpleCommandExceptionType i = new SimpleCommandExceptionType(xj.c("arguments.item.component.expected"));
   static final DynamicCommandExceptionType j = new DynamicCommandExceptionType($$0 -> xj.b("arguments.item.component.repeated", $$0));
   private static final DynamicCommandExceptionType k = new DynamicCommandExceptionType($$0 -> xj.b("arguments.item.malformed", $$0));
   ...
   public hh.a a(StringReader $$0) throws CommandSyntaxException {
      final MutableObject<jq<cwi>> $$1 = new MutableObject();
      final kr.a $$2 = kr.a();
      this.a($$0, new hh.d() {
         @Override
         public void a(jq<cwi> $$0) {
            $$1.setValue($$0);
         }
      ...
      jq<cwi> $$3 = Objects.requireNonNull((jq<cwi>)$$1.getValue(), "Parser gave no item");
      kr $$4 = $$2.a();
      a($$0, $$3, $$4);
      return new hh.a($$3, $$4);
   }

   private static void a(StringReader $$0, jq<cwi> $$1, kr $$2) throws CommandSyntaxException {
      kq $$3 = kv.a($$1.a().g(), $$2);
      DataResult<bas> $$4 = cwm.a($$3);
   ...
   public static record a(jq<cwi> a, kr b) {
   }
   ...
   class b {
      ...
      private void b() throws CommandSyntaxException {
         ...
         alj $$1 = alj.a(this.b);
         this.c.a(hh.this.m.a(ali.a(ma.K, $$1)).orElseThrow(() -> {
            this.b.setCursor($$0);
      ...
      private CompletableFuture<Suggestions> d(SuggestionsBuilder $$0) {
         return fb.a(hh.this.m.c_().map(ali::a), $$0);
      }
      ...
      private CompletableFuture<Suggestions> a(SuggestionsBuilder $$0, String $$1) {
         ...
         fb.a(lz.ao.k(), $$2, $$0x -> ((ali)$$0x.getKey()).a(), $$2x -> {
            kt<?> $$3 = (kt<?>)$$2x.getValue();
            if ($$3.b() != null) {
               alj $$4 = ((ali)$$2x.getKey()).a();
               $$0.suggest($$4 + $$1);
            }
         });
         return $$0.buildFuture();
