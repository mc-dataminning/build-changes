...
public interface hh<T> {
   ...
   hj<T> a(@Nullable to var1, CommandDispatcher<T> var2) throws dy;
   ...
   static <T extends dx<T>> hh<T> a(ajv $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hi<T> $$4 = new hi<>();
   ...
   static <T extends dx<T>> gy<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new ha.c<>($$2.getString(), $$4.get());
      }
   }
}
