...
public class hh {
   private static final Map<String, hh.b> i = Maps.newHashMap();
   ...
   private static void a(String $$0, hh.a $$1, Predicate<hg> $$2, wu $$3) {
      i.put($$0, new hh.b($$1, $$2, $$3));
   }
      ...
      if (i.isEmpty()) {
         a("name", $$0 -> {
            ...
            if ($$0.w() && !$$2) {
               ...
               $$0.a($$2x -> $$2x.ag().getString().equals($$3) != $$2);
            }
         ...
         a("x_rotation", $$0 -> $$0.a(eh.a($$0.g(), true, ayg::g)), $$0 -> $$0.k() == eh.a, wu.c("argument.entity.options.x_rotation.description"));
         a("y_rotation", $$0 -> $$0.b(eh.a($$0.g(), true, ayg::g)), $$0 -> $$0.l() == eh.a, wu.c("argument.entity.options.y_rotation.description"));
         a("limit", $$0 -> {
            int $$1 = $$0.g().getCursor();
            int $$2 = $$0.g().readInt();
            if ($$2 < 1) {
         ...
         a("sort", $$0 -> {
            ...
            $$0.a(($$0x, $$1x) -> ev.b(Arrays.asList("nearest", "furthest", "random", "arbitrary"), $$0x));
         ...
         a("type", $$0 -> {
            $$0.a(($$1x, $$2x) -> {
               ev.a(lq.f.f(), $$1x, String.valueOf('!'));
               ev.a(lq.f.k().map(awm::b), $$1x, "!#");
               if (!$$0.F()) {
                  ev.a(lq.f.f(), $$1x);
                  ev.a(lq.f.k().map(awm::b), $$1x, String.valueOf('#'));
               }
            ...
            if ($$0.F() && !$$2) {
               ...
               if ($$0.f()) {
                  awm<bsm<?>> $$3 = awm.a(lr.z, akk.a($$0.g()));
                  $$0.a($$2x -> $$2x.al().a($$3) != $$2);
               } else {
                  akk $$4 = akk.a($$0.g());
                  bsm<?> $$5 = lq.f.b($$4).orElseThrow(() -> {
                     $$0.g().setCursor($$1);
                     return h.createWithContext($$0.g(), $$4.toString());
                  });
                  if (Objects.equals(bsm.by, $$5) && !$$2) {
                     $$0.a(false);
                  }

                  $$0.a($$2x -> Objects.equals($$5, $$2x.al()) != $$2);
                  if (!$$2) {
                     $$0.a($$5);
                  }
               }
         ...
         a("tag", $$0 -> {
            boolean $$1 = $$0.e();
            String $$2 = $$0.g().readUnquotedString();
            $$0.a($$2x -> "".equals($$2) ? $$2x.an().isEmpty() != $$1 : $$2x.an().contains($$2) != $$1);
         ...
         a("advancements", $$0 -> {
            StringReader $$1 = $$0.g();
            Map<akk, Predicate<ah>> $$2 = Maps.newHashMap();
            $$1.expect('{');
            $$1.skipWhitespace();
            ...
            if (!$$2.isEmpty()) {
               $$0.a($$1x -> {
                  if (!($$1x instanceof aqn $$2x)) {
                     ...
                     for (Entry<akk, Predicate<ah>> $$6x : $$2.entrySet()) {
         ...
         a("predicate", $$0 -> {
            boolean $$1 = $$0.e();
            akj<euf> $$2 = akj.a(lr.bd, akk.a($$0.g()));
            $$0.a($$2x -> {
               if (!($$2x.dQ() instanceof aqm)) {
                  return false;
               } else {
                  aqm $$3 = (aqm)$$2x.dQ();
                  Optional<euf> $$4 = $$3.o().bf().b().a(lr.bd, $$2).map(jj::a);
                  if ($$4.isEmpty()) {
                     return false;
                  } else {
                     eqx $$5 = new eqx.a($$3).a(etq.a, $$2x).a(etq.f, $$2x.do()).a(etp.e);
   ...
   public static hh.a a(hg $$0, String $$1, int $$2) throws CommandSyntaxException {
      hh.b $$3 = i.get($$1);
      if ($$3 != null) {
         if ($$3.b.test($$0)) {
            return $$3.a;
   ...
   public static void a(hg $$0, SuggestionsBuilder $$1) {
      String $$2 = $$1.getRemaining().toLowerCase(Locale.ROOT);

      for (Entry<String, hh.b> $$3 : i.entrySet()) {
   ...
   public interface a {
      void handle(hg var1) throws CommandSyntaxException;
   }

   static record b(hh.a a, Predicate<hg> b, wu c) {
   }
}
