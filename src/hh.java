...
public class hh {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, hf.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends hf.a<A>> void a(JsonObject $$0, hf<A, T> $$1, hf.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", jy.x.b($$2.a()).toString());
