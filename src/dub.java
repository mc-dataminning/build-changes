...
public class dub extends duc {
   ...
   public static final Codec<dub> c = RecordCodecBuilder.create(
      $$0 -> a($$0).and(dua.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, dub::new)
   );
   private final dua h;

   public dub(big $$0, duf $$1, Optional<dtz> $$2, dua $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(csl $$0, BiConsumer<hx, dhn> $$1, atw $$2, hx $$3, hx $$4, dta $$5) {
   ...
   private boolean a(csl $$0, atw $$1, hx $$2, ib $$3, hx $$4, List<hx> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<hx> a(hx $$0, ib $$1, atw $$2, hx $$3) {
      hx $$4 = $$0.d();
      hx $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
