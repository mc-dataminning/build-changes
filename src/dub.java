...
public class dub {
   ...
   private double j;
   int k = 29999984;
   private dub.a l = new dub.d(5.999997E7F);
   public static final dub.c d = new dub.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dub.a)($$0 == $$1 ? new dub.d($$1) : new dub.b($$0, $$1, $$2));
   ...
   class b implements dub.a {
      ...
      @Override
      public double a() {
         return ayg.a(dub.this.a() - this.e() / 2.0, (double)(-dub.this.k), (double)dub.this.k);
      }

      @Override
      public double c() {
         return ayg.a(dub.this.b() - this.e() / 2.0, (double)(-dub.this.k), (double)dub.this.k);
      }
      ...
      @Override
      public dua i() {
         return this.c < this.b ? dua.b : dua.a;
      }
      ...
      @Override
      public dub.a l() {
         return (dub.a)(this.g() <= 0L ? dub.this.new d(this.c) : this);
      }
      ...
      public ewy m() {
         return ewv.a(
            ewv.c,
            ewv.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewj.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dub.c a(DynamicLike<?> $$0, dub.c $$1) {
         ...
         return new dub.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dub.a {
      ...
      private void n() {
         this.c = ayg.a(dub.this.a() - this.b / 2.0, (double)(-dub.this.k), (double)dub.this.k);
         this.d = ayg.a(dub.this.b() - this.b / 2.0, (double)(-dub.this.k), (double)dub.this.k);
         this.e = ayg.a(dub.this.a() + this.b / 2.0, (double)(-dub.this.k), (double)dub.this.k);
         this.f = ayg.a(dub.this.b() + this.b / 2.0, (double)(-dub.this.k), (double)dub.this.k);
         this.g = ewv.a(
            ewv.c,
            ewv.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ewj.e
