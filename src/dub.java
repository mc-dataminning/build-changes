...
public class dub extends duf {
   public static final Codec<dub> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               dto.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               asq.a(hx.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, dub::new)
   );
   ...
   protected final dto e;
   protected final int f;
   protected final List<hx> g;

   public dub(float $$0, int $$1, int $$2, dto $$3, int $$4, List<hx> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(duf.a $$0, ht $$1, hx $$2) {
