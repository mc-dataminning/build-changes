...
public class gra implements asv<gqz> {
   public gqz b(JsonObject $$0) {
      Builder<gqy> $$1 = ImmutableList.builder();
      int $$2 = axw.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = axw.a($$0, "width", -1);
      int $$9 = axw.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = axw.a($$0, "interpolate", false);
      return new gqz($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gqy a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gqy(axw.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = axw.m($$1, "frames[" + $$0 + "]");
         int $$3 = axw.a($$2, "time", -1);
         if ($$2.has("time")) {
