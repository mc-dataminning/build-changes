...
public class dmy {
   ...
   public dmy(cxb $$0, ib $$1, ih $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dnb $$0 = this.b.a_(this.e);
      if (!dmu.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eiu.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dnb $$0) {
      return $$0.a(dae.hV) || $$0.a(dae.pg);
   }

   private static boolean a(dnb $$0, dnb $$1) {
      if ($$0.a(dae.pg) && $$1.a(dae.hV)) {
         return false;
      } else {
         return $$0.a(dae.hV) && $$1.a(dae.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ib $$0, ih $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dmu.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dnb $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dmu.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dmu.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
