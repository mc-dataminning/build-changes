...
public abstract class fom<E extends fom.a<E>> extends foj {
   ...
   private final List<E> n = new fom.b();
   ...
   public fom(flj $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wo.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fom(flj $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(foe $$0) {
      akv $$1 = this.c.s == null ? ful.h : ful.j;
      akv $$2 = this.c.s == null ? ful.i : ful.k;
      $$0.a(gmi::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gmi::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(foe $$0) {
      akv $$1 = this.c.s == null ? a : m;
      $$0.a(gmi::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }
   ...
   @Override
   public Optional<fqq> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fsy $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fsy $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fso.a w() {
      if (this.aM_()) {
         ...
         return this.q != null ? fso.a.b : fso.a.a;
      }
   }
   ...
   protected void a(fsq $$0, E $$1) {
      List<E> $$2 = this.aH_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fsp.b, wp.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fom.a<E>> implements fqq {
      @Deprecated
      fom<E> a;
      ...
      public abstract void a(foe var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
