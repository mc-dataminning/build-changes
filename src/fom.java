...
public class fom extends fob {
   private static final fpr d = new fpr(alz.b("widget/text_field"), alz.b("widget/text_field_highlighted"));
   ...
   public fom(fno $$0, int $$1, int $$2, xv $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fom(fno $$0, int $$1, int $$2, int $$3, int $$4, xv $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fom(fno $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fom $$5, xv $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, ftw.s());
   }
   ...
   public void b(fnq $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            ...
            $$0.a(glt::B, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(glt.H(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
