public class fom extends foa<cpx> {
   ...
   protected void a(cre $$0, int $$1, int $$2, cps $$3) {
      if ($$0 instanceof cpy && !$$0.h() && !this.I.N_()) {
         switch ($$3) {
            case a:
               if (this.w.e($$1)) {
                  this.a($$1);
   ...
   @Override
   public void a(fhh $$0, cre $$1) {
      if ($$1 instanceof cpy $$2 && this.w.e($$1.d)) {
         this.a($$0, $$2);
         return;
      }
   ...
   public void a(fhh $$0, int $$1, int $$2, float $$3) {
      ...
      this.c($$0);
      this.a($$0, $$1, $$2);
      if (this.y instanceof cpy && !this.w.e(this.y.d) && this.w.g().e() && !this.y.h() && !this.I.N_()) {
         $$0.a(this.o, H, $$1, $$2);
      }
   }
