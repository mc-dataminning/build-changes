public abstract class fom extends foi {
   private static final fqd a = new fqd(aku.b("widget/text_field"), aku.b("widget/text_field_highlighted"));
   private static final int c = 4;

   public fom(int $$0, int $$1, int $$2, int $$3, wo $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(fob var1, int var2, int var3, float var4);
