...
public interface fom {
   static fom a(fot $$0, UserApiService $$1) {
      return new fom.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, fov var2, AbuseReport var3);
   ...
   public static record b(fot a, UserApiService b) implements fom {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, fov $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               vf $$5 = this.a(var7);
               throw new CompletionException(new fom.a($$5, var7));
            } catch (MinecraftClientException var8) {
               vf $$7 = this.a(var8);
               throw new CompletionException(new fom.a($$7, var8));
            }
         }, ac.g());
      }
