...
public abstract class fom extends fol {
   ...
   private static final BiFunction<aew, Boolean, fom> bk = ac.a(($$0, $$1) -> {
   ...
   private static final Function<aew, fom> bl = ac.b($$0 -> {
   ...
   private static final Function<aew, fom> bm = ac.b($$0 -> {
   ...
   private static final BiFunction<aew, Boolean, fom> bn = ac.a(($$0, $$1) -> {
   ...
   private static final BiFunction<aew, Boolean, fom> bo = ac.a(($$0, $$1) -> {
   ...
   private static final Function<aew, fom> bt = ac.b($$0 -> {
   ...
   private static final Function<aew, fom> bF = ac.b($$0 -> {
      fol.n $$1 = new fol.n($$0, false, false);
      return a("crumbling", eln.j, elu.b.h, 256, false, true, fom.b.a().a(W).a($$1).a(g).a(aD).a(aG).a(false));
   });
   private static final Function<aew, fom> bG = ac.b(
   ...
   private static final Function<aew, fom> bL = ac.b(
   ...
   private static final Function<aew, fom> bN = ac.b(
   ...
   private static fom.a a(String $$0, aew $$1, boolean $$2) {
   ...
   public static fom a(aew $$0) {
      return bg.apply($$0);
   }

   public static fom b(aew $$0) {
      return a("armor_decal_cutout_no_cull", $$0, true);
   }

   public static fom c(aew $$0) {
      return bh.apply($$0);
   }

   public static fom d(aew $$0) {
      return bi.apply($$0);
   }

   public static fom a(aew $$0, boolean $$1) {
      return bj.apply($$0, $$1);
   }

   public static fom e(aew $$0) {
      return a($$0, true);
   }

   public static fom b(aew $$0, boolean $$1) {
      return bk.apply($$0, $$1);
   }

   public static fom f(aew $$0) {
      return b($$0, true);
   }

   public static fom g(aew $$0) {
      return bl.apply($$0);
   }

   public static fom h(aew $$0) {
      return bm.apply($$0);
   }

   public static fom c(aew $$0, boolean $$1) {
      return bn.apply($$0, $$1);
   }

   public static fom i(aew $$0) {
      return c($$0, true);
   }

   public static fom d(aew $$0, boolean $$1) {
      return bo.apply($$0, $$1);
   }

   public static fom j(aew $$0) {
      return d($$0, true);
   }

   public static fom k(aew $$0) {
      return bp.apply($$0);
   }

   public static fom e(aew $$0, boolean $$1) {
      return bq.apply($$0, $$1);
   }

   public static fom l(aew $$0) {
      return br.apply($$0);
   }

   public static fom m(aew $$0) {
      return bs.apply($$0);
   }

   public static fom n(aew $$0) {
      return bt.apply($$0);
   }

   public static fom o(aew $$0) {
      return bu.apply($$0);
   }

   public static fom p(aew $$0) {
      return bv.apply($$0);
   }

   public static fom a(aew $$0, float $$1, float $$2) {
      return a(
         "energy_swirl",
         eln.k,
         elu.b.h,
   ...
   public static fom r(aew $$0) {
      return bF.apply($$0);
   }

   public static fom s(aew $$0) {
      return bG.apply($$0);
   }
   ...
   public static fom t(aew $$0) {
      return bI.apply($$0);
   }

   public static fom u(aew $$0) {
      return bJ.apply($$0);
   }

   public static fom v(aew $$0) {
      return bK.apply($$0);
   }

   public static fom w(aew $$0) {
      return bL.apply($$0);
   }
   ...
   static final class a extends fom {
      static final BiFunction<aew, fol.c, fom> aY = ac.a(
