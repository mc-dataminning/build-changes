...
public class fom {
   ...
   public fom(fmf $$0) {
      ...
      this.g = new fom.a();
      this.h = $$0.h;
      this.w = new fpw(this.h, this.r);
      this.x = new fpz(this.h, this.s, () -> $$0.s.t().g());
      this.y = new fpx(this.h, this.t);
      this.z = new fpv(this.h, this.u);
      this.A = new fpy(this.h);
   }
   ...
   private void a(fnr $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fmf.Q().aO().k(), fmf.Q().aO().l(), ffk.a()),
            ffk.c(),
            ffk.d()
         }
      );
