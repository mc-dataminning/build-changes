public class fmv extends fnq {
   private final fnl a;

   fmv(fjr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fnl $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         ccx $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.ds();
            if (this.h > $$1) {
   ...
   public static class b implements fmt<jv> {
      ...
      public fmq a(jv $$0, fjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fmq $$8 = new fmv($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
