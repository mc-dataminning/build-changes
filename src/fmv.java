...
public class fmv {
   public static void a(gcg $$0, fmt $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fms>> $$6 : $$1.c().entrySet()) {
         Optional<gen> $$7 = $$0.a($$6.getKey());
         List<fms> $$8 = $$6.getValue();
   ...
   private static float a(fmt $$0, long $$1) {
