...
public class fow {
   public static void a(gfz $$0, fou $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fot>> $$6 : $$1.c().entrySet()) {
         Optional<gig> $$7 = $$0.a($$6.getKey());
         List<fot> $$8 = $$6.getValue();
   ...
   private static float a(fou $$0, long $$1) {
