...
public class fow implements aky {
   ...
   public <T extends bfj> fox<? super T> a(T $$0) {
      if ($$0 instanceof fiv) {
         ...
         return (fox<? super T>)($$2 != null ? $$2 : this.i.get("default"));
      } else {
         return (fox<? super T>)this.h.get($$0.ae());
      }
   }
   ...
   public <E extends bfj> void a(E $$0, double $$1, double $$2, double $$3, float $$4, float $$5, eij $$6, fjx $$7, int $$8) {
      ...
      try {
         ...
         $$6.a(-$$10.a(), -$$10.b(), -$$10.c());
         if (this.d.K().c() && this.q && $$9.d > 0.0F && !$$0.cb()) {
            double $$14 = this.a($$0.dn(), $$0.dp(), $$0.dt());
   ...
   private static void a(eij $$0, ein $$1, bfj $$2, float $$3) {
      ...
      $$1.a($$14, (float)($$13.c * 2.0), (float)((double)$$2.cF() + $$13.d * 2.0), (float)($$13.e * 2.0))
         .a(0, 0, 255, 255)
         .a($$15, (float)$$13.c, (float)$$13.d, (float)$$13.e)
         .e();
   }
   ...
   private static void a(eij.a $$0, ein $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7) {
      ...
      $$1.a($$8.x(), $$8.y(), $$8.z(), 1.0F, 1.0F, 1.0F, $$2, $$6, $$7, fum.d, 15728880, 0.0F, 1.0F, 0.0F);
   }
