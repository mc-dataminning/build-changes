...
public class fow {
   ...
   public void a(din $$0, bwi $$1, boolean $$2, boolean $$3, float $$4) {
      this.f = true;
      this.g = $$0;
      this.h = $$1;
      this.q = $$2;
      this.t = $$4;
      if ($$1.bX() && $$1.dj() instanceof cud $$5 && $$5.f() instanceof cul $$6 && $$6.o()) {
         fex $$7 = $$5.m($$1).d($$5.ds()).d($$1.l($$5)).e(new fex(0.0, (double)azm.h($$4, this.s, this.r), 0.0));
         this.a($$1.j($$4), $$1.i($$4));
         this.a($$6.e($$4).e($$7));
      } else {
         this.a($$1.j($$4), $$1.i($$4));
   ...
   private float a(float $$0) {
      ...
      for (int $$2 = 0; $$2 < 8; $$2++) {
         ...
         fex $$6 = this.i.b((double)($$3 * 0.1F), (double)($$4 * 0.1F), (double)($$5 * 0.1F));
         fex $$7 = $$6.e(new fex(this.k).c((double)(-$$0)));
         fev $$8 = this.g.a(new diq($$6, $$7, diq.a.c, diq.b.a, this.h));
         if ($$8.d() != fev.a.a) {
   ...
   protected void a(float $$0, float $$1, float $$2) {
      ...
      this.a(new fex(this.i.d + (double)$$3.x, this.i.e + (double)$$3.y, this.i.f + (double)$$3.z));
   }
   ...
   public fow.a j() {
      ...
      double $$3 = $$2 * $$1;
      fex $$4 = new fex(this.k).c(0.05F);
      fex $$5 = new fex(this.m).c($$3);
      fex $$6 = new fex(this.l).c($$2);
      return new fow.a($$4, $$5, $$6);
   }
   ...
   public ewx k() {
      if (!this.f) {
         ...
         ewv $$0 = this.g.b_(this.j);
         if ($$0.a(axh.a) && this.i.e < (double)((float)this.j.v() + $$0.a(this.g, this.j))) {
            return ewx.b;
         } else {
            fow.a $$1 = this.j();

            for (fex $$3 : Arrays.asList($$1.a, $$1.a(), $$1.b(), $$1.c(), $$1.d())) {
               fex $$4 = this.i.e($$3);
               iv $$5 = iv.a((jp)$$4);
               ewv $$6 = this.g.b_($$5);
               if ($$6.a(axh.b)) {
