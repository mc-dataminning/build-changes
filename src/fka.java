...
public class fka extends hhw {
   ...
   private final CompletableFuture<Boolean> D = fhc.a().thenApply($$0 -> $$0.a() == fhc.b.a);
   @Nullable
   private fkp.c E;
   @Nullable
   private fka.a F;
   ...
   private final fka.a K = new fka.a() {
      @Override
      public fkp.c a(fjh $$0) {
         fkp.c $$1 = $$0.a.a();
         fka.this.a($$0, $$1);
         fka.this.b($$0, $$1);
         return $$1;
   ...
   private final fka.a L = new fka.a() {
      @Override
      public fkp.c a(fjh $$0) {
         fkp.c $$1 = $$0.a.a();
         fka.this.b($$0, $$1);
   ...
   private boolean G() {
      return this.m.z instanceof fua;
   }
   ...
   private void c(fns $$0) {
      ...
      int $$6 = $$4 - 3;
      if (J) {
         $$0.a(glv::C, a, $$6 - 12, $$5 + 3, 10, 10);
         $$6 -= 16;
      }

      if (this.F != null && this.F.a()) {
         if (I) {
            $$0.a(glv::C, b, $$6 - 14, $$5 + 1, 14, 14);
            $$6 -= 16;
         }

         if ($$1 != 0) {
            $$0.a(glv::C, c, $$6 - 14, $$5 + 1, 14, 14);
            $$6 -= 16;
         }

         if (H) {
            $$0.a(glv::C, C, $$6 - 10, $$5 + 4, 8, 8);
         }
      }
   }

   void a(fjh $$0, fkp.c $$1) {
