   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xg.b($$2.toUpperCase(Locale.ROOT)) : xg.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xg.b($$2) : xg.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tv.a().b($$1) ? xg.c($$1) : xg.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fka.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xg> g;
      ...
      private b(final String $$0, final BiFunction<Integer, String, xg> $$1) {
         this.f = $$0;
         this.g = $$1;
      }
