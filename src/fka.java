...
public class fka {
   ...
   public static List<fka.a> a(String $$0, fka.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fka.a> a(String $$0, List<fka.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fka.a> a(List<String> $$0, List<fka.b> $$1) {
      int $$2 = 0;
      List<fka.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fka.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fka.b a(String $$0, String $$1) {
         return new fka.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fka.b a(String $$0) {
         return new fka.b($$0);
      }
   }
}
