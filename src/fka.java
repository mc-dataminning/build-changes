...
public class fka {
   ...
   public static final fka.a bv;

   public static fka.a a(int $$0, int $$1) {
      return $$0 == -1 ? fka.b.b.a($$1) : fka.b.a.a($$0);
   }

   public static fka.a a(String $$0) {
      if (fka.a.e.containsKey($$0)) {
         return fka.a.e.get($$0);
      } else {
         for (fka.b $$1 : fka.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fka.b b;
      private final int c;
      private final azi<xa> d;
      static final Map<String, fka.a> e = Maps.newHashMap();

      a(String $$0, fka.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azi<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xa.b($$2.toUpperCase(Locale.ROOT)) : xa.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xa.b($$2) : xa.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tu.a().b($$1) ? xa.c($$1) : xa.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fka.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xa> g;

      private static void a(fka.b $$0, String $$1, int $$2) {
         fka.a $$3 = new fka.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xa> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fka.a a(int $$0) {
         return (fka.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
