...
public class dmn {
   ...
   private final crb p;
   private static final List<cua> q = List.of(cuc.l, cuc.L, cuc.i, cuc.b, cuc.k, cuc.I, cuc.K, cuc.fl, cuc.dP, cuc.iA, cuc.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ib<crx>>> t;
   ...
   public static final Codec<dmn> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   private dmn(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ib<crx>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = iu.c($$0);
      int $$5 = iu.c($$1) - $$4;
   ...
   @Nullable
   public static dmn a(alx $$0, int $$1, int $$2) {
      dhx $$3 = $$0.a($$1, $$2);
      dmn $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dic.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hy> a(crt $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dhx $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, asy.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dhx $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dlk.a.a)) {
         $$3 = Math.min($$0.a(dlk.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }
   ...
   private static double a(dhx $$0, ht.a $$1) {
      return a($$0, (ht)$$1.c(hx.a)) ? 1.0 : -1.0;
   }

   private static double b(dhx $$0, ht.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dhx $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ib<crx>> b(dhx $$0, int $$1, int $$2) {
      ObjectArrayList<ib<crx>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dhx $$0, ht $$1) {
      dgb $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(aqs.O)) {
         ...
         return $$2.a(cuc.eT) || $$2.a(cuc.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dmn.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dmn.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ib<crx> var3);
   }
