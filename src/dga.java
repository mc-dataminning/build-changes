...
public interface dga<T extends Enum<T>> {
   int v_ = 4;

   Optional<dsc> i_(dsc var1);

   float at_();

   default void a_(dsc $$0, arf $$1, iz $$2, azh $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dsc> c(dsc $$0, arf $$1, iz $$2, azh $$3) {
      ...
      for (iz $$7 : iz.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dga<?> $$9) {
            Enum<?> $$10 = $$9.c();
