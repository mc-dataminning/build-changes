...
public class dga extends dgd<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dga(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dga $$1 && super.equals($$0)) {
   ...
   public static dga a(String $$0, int $$1, int $$2) {
      return new dga($$0, $$1, $$2);
   }
