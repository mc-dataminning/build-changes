...
public class ecl extends eaw<edz> {
   public ecl(Codec<edz> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eay<edz> $$0) {
      dcr $$1 = $$0.b();
      edz $$2 = $$0.f();
      azf $$3 = $$0.d();
      iz $$4 = $$0.e();
      Predicate<dsa> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, drz.a::i) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(eay<edz> $$0, dcr $$1, edz $$2, azf $$3, Set<iz> $$4, int $$5, int $$6) {
      for (iz $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(dcr $$0, edz $$1, Predicate<dsa> $$2, azf $$3, iz.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dsa $$7 = $$1.c.a($$3, $$4);
         dsa $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
