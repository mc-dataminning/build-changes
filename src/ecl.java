...
public abstract class ecl<M extends eci<M>> {
   private final cso i;
   ...
   protected final Long2ObjectMap<djp> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected ecl(cso $$0, djx $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected djp a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected djp a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected djp c(long $$0) {
      djp $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = iy.e($$0);
      djp $$2 = this.a($$1, true);
      return $$2.a(iy.b(hx.a($$0)), iy.b(hx.b($$0)), iy.b(hx.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(iy.b(hx.a($$0)), iy.b(hx.b($$0)), iy.b(hx.c($$0)), $$1);
      iy.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(iy.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected djp g(long $$0) {
      djp $$1 = (djp)this.g.get($$0);
      return $$1 != null ? $$1 : new djp();
   }
   ...
   protected void a(eco<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            djp $$2 = (djp)this.g.remove($$1);
            djp $$3 = this.d.d($$1);
            if (this.k.contains(iy.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<djp>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<djp> $$6 = (Entry<djp>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               djp $$8 = (djp)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable djp $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = iy.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, ecl.a.a($$9, ecl.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public ecl.b k(long $$0) {
      return ecl.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static ecl.b c(byte $$0) {
         if ($$0 == 0) {
            return ecl.b.a;
         } else {
            return a($$0) ? ecl.b.c : ecl.b.b;
         }
      }
   }
