...
public class ecl {
   private static final ecl a = new ecl(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public ecl.a a(int $$0, int $$1) {
         return new ecl.a(1.0, 0.0);
      }
   ...
   private static final eqr b = eqr.b(new eck(42L), rf.a);
   ...
   private final Long2ObjectOpenHashMap<ecm> h;
   private final Long2ObjectOpenHashMap<ecm> i;

   public static ecl a() {
      return a;
   }

   public static ecl a(@Nullable ary $$0) {
      if ($$0 == null) {
         return a;
      } else {
         del $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<ecm> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<ecm> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azn.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new ecl($$2, $$3);
         }
      }
   }

   ecl(Long2ObjectOpenHashMap<ecm> $$0, Long2ObjectOpenHashMap<ecm> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public ecl.a a(int $$0, int $$1) {
      int $$2 = kb.a($$0);
      int $$3 = kb.a($$1);
      double $$4 = this.a($$2, 0, $$3, ecm::a);
      if ($$4 != Double.MAX_VALUE) {
         return new ecl.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(del.a($$5x)), kb.d(del.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = (double)azn.f((float)($$2 - $$5xx), (float)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = azn.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new ecl.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(ebc.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kb.d(del.a($$6x)), kb.d(del.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = azn.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = azn.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return azn.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, ecl.b $$3) {
      int $$4 = kb.e($$0);
      int $$5 = kb.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(ecl.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      ecm $$6 = (ecm)this.h.get(del.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kb.d($$1), $$4, $$5 - kb.d($$2)) : Double.MAX_VALUE;
   }

   public dgk a(dgk $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jq<dgh> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jq<dgh> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jq<dgh>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(del.a($$5x)), $$1, kb.d(del.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = (double)azn.f((float)($$0 - $$4xx), (float)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = azn.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (jq)$$4.getValue();
      }
   }

   public static void a(ary $$0, dxj $$1) {
      del $$2 = $$1.f();
      boolean $$3 = $$1.r();
      jh.a $$4 = new jh.a();
            ...
            if ($$0.a($$2.g + $$11.j(), $$2.h + $$11.l()).r() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ebj.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dxj $$0, jh $$1) {
      dvo $$2 = $$0.a_($$1);
      if ($$2.a(axd.P)) {
         $$0.e($$1);
      }
   ...
   public static void a(dgd $$0, dyd $$1) {
      del $$2 = $$1.f();
      Builder<jn, ecm> $$3 = ImmutableMap.builder();
   ...
   public static ecl.c a(@Nullable ecm $$0, Map<jn, ecm> $$1) {
      List<ecl.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static ecl.c a(@Nullable jn $$0, ecm $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jm $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return azn.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(ecm var1, int var2, int var3, int var4);
   }
