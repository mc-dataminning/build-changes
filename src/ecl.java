...
public record ecl(ecl.a a, byte b, byte c, byte d, @Nullable ui e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements atr {
      ...
      A("red_x", true, false),
      B("village_desert", true, ebi.w.ak, false, true),
      C("village_plains", true, ebi.w.ak, false, true),
      D("village_savanna", true, ebi.w.ak, false, true),
      E("village_snowy", true, ebi.w.ak, false, true),
      F("village_taiga", true, ebi.w.ak, false, true),
      G("jungle_temple", true, ebi.w.ak, false, true),
      H("swamp_hut", true, ebi.w.ak, false, true);

      public static final Codec<ecl.a> I = atr.a(ecl.a::values);
      ...
      public static ecl.a a(byte $$0) {
         return values()[asy.a($$0, 0, values().length - 1)];
      }
