...
public abstract class bql extends cbe implements bpw {
   protected static final aim<Byte> bX = aiq.a(bql.class, aio.a);
   protected static final aim<Optional<UUID>> bY = aiq.a(bql.class, aio.q);
   private boolean ca;

   protected bql(bpd<? extends bql> $$0, cxb $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(bnw $$0) {
      if (!this.dM().B && this.dM().Z().b(cwx.n) && this.P_() instanceof apg) {
         this.P_().a(this.eM().a());
      }
