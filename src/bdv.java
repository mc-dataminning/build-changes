...
public class bdv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         azy.a(this.a("minecraft:trident", bdv::c), this.a("minecraft:arrow", bdv::a), this.a("minecraft:spectral_arrow", bdv::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bdv.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bgr.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bgr.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bdv.a<?> $$1, Type<?> $$2, Type<T> $$3) {
