...
public class bdv extends ban {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdv::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdv::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdv::k);
         $$0 = this.a($$0, "minecraft:fox", bdv::j);
         $$0 = this.a($$0, "minecraft:item", bdv::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdv::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdv::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdv::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdv::e);
         return this.a($$0, "minecraft:piglin", bdv::d);
      });
   }
