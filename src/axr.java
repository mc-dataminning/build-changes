...
public record axr<T extends Comparable<T>>(T b, T c) {
   public static final Codec<axr<Integer>> a = a(Codec.INT);
   ...
   public static <T extends Comparable<T>> Codec<axr<T>> a(Codec<T> $$0) {
      return axh.a($$0, "min_inclusive", "max_inclusive", axr::a, axr::a, axr::b);
   }

   public static <T extends Comparable<T>> Codec<axr<T>> a(Codec<T> $$0, T $$1, T $$2) {
      return axh.b(
         a($$0),
         (Function<axr<T>, DataResult<axr<T>>>)($$2x -> {
   ...
   public static <T extends Comparable<T>> DataResult<axr<T>> a(T $$0, T $$1) {
      return $$0.compareTo($$1) <= 0
         ? DataResult.success(new axr($$0, $$1))
