...
public class axr {
   ...
   private axr(all $$0, boolean $$1, boolean $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }

   private axr(ayw.c $$0, boolean $$1) {
      this.c = $$0.a();
      this.d = $$0.b();
      this.e = $$1;
   }
   ...
   private ayw.c a() {
      return new ayw.c(this.c, this.d);
   }

   public static axr a(all $$0) {
      return new axr($$0, false, true);
   }

   public static axr b(all $$0) {
      return new axr($$0, false, false);
   }

   public static axr c(all $$0) {
      return new axr($$0, true, true);
   }

   public static axr d(all $$0) {
   ...
   public boolean a(Predicate<all> $$0, Predicate<all> $$1) {
