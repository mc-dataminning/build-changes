...
public abstract class cwz implements cxa, AutoCloseable {
   public static final Codec<ajg<cwz>> g = ajg.a(kj.aN);
   public static final ajg<cwz> h = ajg.a(kj.aN, new ajh("overworld"));
   public static final ajg<cwz> i = ajg.a(kj.aN, new ajh("the_nether"));
   public static final ajg<cwz> j = ajg.a(kj.aN, new ajh("the_end"));
   ...
   protected final List<dlx> r = Lists.newArrayList();
   protected final ejp s;
   private final List<dlx> a = Lists.newArrayList();
   private boolean b;
   ...
   private final il<dqm> D;
   protected final ekr A;
   private final Supplier<bjq> E;
   public final boolean B;
   private final doq F;
   private final cya G;
   private final ajg<cwz> H;
   private final iz I;
   private final bnw J;
   private long K;

   protected cwz(ekr $$0, ajg<cwz> $$1, iz $$2, il<dqm> $$3, Supplier<bjq> $$4, boolean $$5, boolean $$6, long $$7, int $$8) {
      this.E = $$4;
      this.A = $$0;
      this.D = $$3;
      final dqm $$9 = $$3.a();
      ...
      this.G = new cya(this, $$7);
      this.d = $$6;
      this.s = new ejn(this, $$8);
      this.I = $$2;
      this.J = new bnw($$2);
   }
   ...
   public dpg d(int $$0, int $$1) {
      return (dpg)this.a($$0, $$1, dpa.n);
   }

   @Nullable
   @Override
   public dov a(int $$0, int $$1, dpa $$2, boolean $$3) {
      dov $$4 = this.L().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(ib $$0, dmz $$1, int $$2) {
   ...
   public boolean a(ib $$0, boolean $$1, @Nullable bow $$2, int $$3) {
      ...
      if ($$4.i()) {
         ...
         ein $$5 = this.b_($$0);
         if (!($$4.b() instanceof czn)) {
            this.c(2001, $$0, daa.i($$4));
         }

         if ($$1) {
            dkg $$6 = $$4.t() ? this.c_($$0) : null;
            daa.a($$4, this, $$0, $$6, $$2, cqk.h);
         }

         boolean $$7 = this.a($$0, $$5.g(), 3, $$3);
         if ($$7) {
            this.a(drn.f, $$0, drn.a.a($$2, $$4));
         }
   ...
   public boolean b(ib $$0, dmz $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(ib var1, dmz var2, dmz var3, int var4);
   ...
   public dmz a_(ib $$0) {
      if (this.s($$0)) {
         ...
         dpg $$1 = this.d(je.a($$0.u()), je.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable bow $$0, ib $$1, atx $$2, atz $$3, float $$4, float $$5) {
      this.a($$0 instanceof cis $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public abstract void a(@Nullable cis var1, double var2, double var4, double var6, il<atx> var8, atz var9, float var10, float var11, long var12);

   public void a(@Nullable cis $$0, double $$1, double $$2, double $$3, atx $$4, atz $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, ki.b.e($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cis var1, bow var2, il<atx> var3, atz var4, float var5, float var6, long var7);

   public void a(@Nullable cis $$0, double $$1, double $$2, double $$3, atx $$4, atz $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 1.0F, 1.0F);
   }

   public void a(@Nullable cis $$0, double $$1, double $$2, double $$3, atx $$4, atz $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cis $$0, bow $$1, atx $$2, atz $$3, float $$4, float $$5) {
   ...
   protected void R() {
      ...
      Iterator<dlx> $$1 = this.r.iterator();
      boolean $$2 = this.s().i();
   ...
   public <T extends bow> void a(Consumer<T> $$0, T $$1) {
      try {
         $$0.accept($$1);
   ...
   public boolean n(ib $$0) {
      return this.a(cwg.a($$0));
   }

   public cwr a(@Nullable bow $$0, double $$1, double $$2, double $$3, float $$4, cwz.a $$5) {
      return this.a($$0, cwr.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, kc.x, kc.w, aty.jT);
   }

   public cwr a(@Nullable bow $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, cwz.a $$6) {
      return this.a($$0, cwr.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, kc.x, kc.w, aty.jT);
   }

   public cwr a(@Nullable bow $$0, @Nullable bnv $$1, @Nullable cws $$2, epr $$3, float $$4, boolean $$5, cwz.a $$6) {
      return this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, kc.x, kc.w, aty.jT);
   }

   public cwr a(@Nullable bow $$0, @Nullable bnv $$1, @Nullable cws $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, cwz.a $$8) {
      return this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8, kc.x, kc.w, aty.jT);
   }
   ...
   public cwr a(
      ...
      cwr.a $$13 = switch ($$8) {
         case a -> cwr.a.a;
         case b -> this.a(cwv.Q);
         case c -> this.Z().b(cwv.c) ? this.a(cwv.R) : cwr.a.a;
         case d -> this.a(cwv.S);
         case e -> cwr.a.d;
      };
      cwr $$14 = new cwr(this, $$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$13, $$10, $$11, $$12);
      $$14.c();
      $$14.a($$9);
      return $$14;
   }

   private cwr.a a(cwv.e<cwv.a> $$0) {
      return this.Z().b($$0) ? cwr.a.c : cwr.a.b;
   }
   ...
   public dkg c_(ib $$0) {
      if (this.s($$0)) {
         ...
         return !this.B && Thread.currentThread() != this.c ? null : this.m($$0).a($$0, dpg.b.a);
      }
   }
   ...
   public boolean a(ib $$0, bow $$1, ih $$2) {
      if (this.s($$0)) {
         return false;
      } else {
         dov $$3 = this.a(je.a($$0.u()), je.a($$0.w()), dpa.n, false);
         return $$3 == null ? false : $$3.a_($$0).a(this, $$0, $$1, $$2);
      }
   }

   public boolean a(ib $$0, bow $$1) {
   ...
   public ib T() {
      ib $$0 = this.A.a();
      if (!this.C_().a($$0)) {
         $$0 = this.a(dsm.a.e, ib.a(this.C_().a(), 0.0, this.C_().b()));
      }
   ...
   public cwf c(int $$0, int $$1) {
      return this.a($$0, $$1, dpa.n, false);
   }

   @Override
   public List<bow> a(@Nullable bow $$0, epm $$1, Predicate<? super bow> $$2) {
      this.ae().d("getEntities");
      List<bow> $$3 = Lists.newArrayList();
      this.G().a($$1, $$3x -> {
         if ($$3x != $$0 && $$2.test($$3x)) {
            $$3.add($$3x);
         }

         if ($$3x instanceof cdx) {
            for (cdv $$4 : ((cdx)$$3x).gj()) {
               if ($$3x != $$0 && $$2.test($$4)) {
                  $$3.add($$4);
               }
   ...
   public <T extends bow> void a(drb<bow, T> $$0, epm $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bow> void a(drb<bow, T> $$0, epm $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      this.ae().d("getEntities");
      this.G().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   @Nullable
   public abstract bow a(int var1);
   ...
   public boolean r(ib $$0) {
      if (!this.ab()) {
         ...
         return false;
      } else if (this.a(dsm.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         cxy $$1 = this.t($$0).a();
         return $$1.a($$0) == cxy.c.b;
      }
   }

   @Nullable
   public abstract ejy a(ejw var1);

   public abstract void a(ejw var1, ejy var2);

   public abstract ejw v();
   ...
   public abstract eqv K();

   public void c(ib $$0, daa $$1) {
      for (ih $$2 : ih.c.a) {
         ib $$3 = $$0.a($$2);
         if (this.B($$3)) {
            dmz $$4 = this.a_($$3);
   ...
   public bna d_(ib $$0) {
      ...
      return new bna(this.aj(), this.Y(), $$1, $$2);
   }
