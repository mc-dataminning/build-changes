...
public class ecw implements edd.c {
   ...
   private final ObjectListIterator<ecw.a> h;
   private final ObjectListIterator<epg> i;

   public static ecw a(dhv $$0, dgf $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<ecw.a> $$4 = new ObjectArrayList(10);
      ObjectList<epg> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eoo.a).forEach($$5x -> {
         eoo $$6 = $$5x.h().d();
         ...
         for (eoh $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof enz) {
                  ...
                  $$4.add(new ecw.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new ecw($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public ecw(ObjectListIterator<ecw.a> $$0, ObjectListIterator<epg> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = azu.g($$0, $$1, $$2);
      return azu.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = azu.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * azu.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = azu.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(env a, eoo b, int c) {
   }
}
