...
public class ecw {
   ...
   private final List<ecu> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private ecw.a l = new ecw.e(5.999997E7F);
   public static final ecw.d d = new ecw.d(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public ffq c(double $$0, double $$1, double $$2) {
      return new ffq(azo.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azo.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public List<ecw.b> c(double $$0, double $$1) {
      ecw.b[] $$2 = new ecw.b[]{
         new ecw.b(jb.c, $$1 - this.f()), new ecw.b(jb.d, this.h() - $$1), new ecw.b(jb.e, $$0 - this.e()), new ecw.b(jb.f, this.g() - $$0)
      };
      return Arrays.stream($$2).sorted(Comparator.comparingDouble($$0x -> $$0x.b)).toList();
   }

   public boolean a(bwt $$0, ffl $$1) {
      double $$2 = Math.max(azo.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (ecw.a)($$0 == $$1 ? new ecw.e($$1) : new ecw.c($$0, $$1, $$2));
   ...
   class c implements ecw.a {
      ...
      @Override
      public double a() {
         return azo.a(ecw.this.a() - this.e() / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
      }

      @Override
      public double c() {
         return azo.a(ecw.this.b() - this.e() / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? azo.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public ecv i() {
         return this.c < this.b ? ecv.b : ecv.a;
      }
      ...
      @Override
      public ecw.a l() {
         return (ecw.a)(this.g() <= 0L ? ecw.this.new e(this.c) : this);
      }
      ...
      public fgk m() {
         return fgh.a(
            fgh.c,
            fgh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ffu.e
         );
      }
   }
   ...
   public static class d {
      ...
      public static ecw.d a(DynamicLike<?> $$0, ecw.d $$1) {
         double $$2 = azo.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = azo.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new ecw.d($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class e implements ecw.a {
      ...
      private void n() {
         this.c = azo.a(ecw.this.a() - this.b / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
         this.d = azo.a(ecw.this.b() - this.b / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
         this.e = azo.a(ecw.this.a() + this.b / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
         this.f = azo.a(ecw.this.b() + this.b / 2.0, (double)(-ecw.this.k), (double)ecw.this.k);
         this.g = fgh.a(
            fgh.c,
            fgh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ffu.e
