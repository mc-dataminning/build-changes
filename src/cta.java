...
public record cta(int c, int d, iu<csp> e, Optional<cta.a> f) {
   private static final int g = 3;
   public static final MapCodec<cta> a = cta.a.a
      .flatXmap(cta::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final xq<vd, cta> b = xq.a(cta::a, cta::b);

   public static cta a(Map<Character, csp> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cta a(Map<Character, csp> $$0, List<String> $$1) {
      cta.a $$2 = new cta.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cta> a(cta.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      iu<csp> $$4 = iu.a($$2 * $$3, csp.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cta($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(clk $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cta b(vd $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      iu<csp> $$3 = iu.a($$1 * $$2, csp.a);
      $$3.replaceAll($$1x -> csp.b.decode($$0));
      return new cta($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cta.a> d() {
      return this.f;
   }

   public static record a(Map<Character, csp> b, List<String> c) {
      ...
      public static final MapCodec<cta.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(avu.d(e, csp.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cta.a::new)
      );

      public Map<Character, csp> a() {
         return this.b;
      }
