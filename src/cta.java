...
public abstract class cta extends col {
   protected static final akj<Boolean> c = akn.a(cta.class, akl.k);
   static final Predicate<cno> a = $$0 -> !$$0.o() && $$0.bI() && czk.a($$0.f(), csz.a($$0.dW().f(mh.aF)));
   @Nullable
   protected csz d;
   private int b;
   private boolean bG;
   ...
   protected cta(bwr<? extends cta> $$0, djh $$1) {
      super($$0, $$1);
   }
   ...
   protected void D() {
      super.D();
      this.bD.a(1, new cta.b<>(this));
      this.bD.a(3, new cez<>(this));
      this.bD.a(4, new cta.d(this, 1.05F, 1));
      this.bD.a(5, new cta.c(this));
   }
   ...
   public boolean gF() {
      czk $$0 = this.a(bws.f);
      boolean $$1 = !$$0.f() && czk.a($$0, csz.a(this.dW().f(mh.aF)));
      boolean $$2 = this.gu();
      return $$1 && $$2;
   }
   ...
   protected void a(arq $$0, cno $$1) {
      ...
      if (this.gH() && !$$3 && czk.a($$2, csz.a(this.dW().f(mh.aF)))) {
         bws $$4 = bws.f;
         czk $$5 = this.a($$4);
   ...
   protected static class a extends cef {
      ...
      public void d() {
         ...
         for (cta $$1 : a(this.b).a(cta.class, this.a, this.b, this.b.cQ().c(8.0, 8.0, 8.0))) {
            $$1.g(this.b.f());
         }
      }
      ...
      public void e() {
         ...
         bxj $$0 = this.b.f();
         if ($$0 != null) {
            for (cta $$2 : a(this.b).a(cta.class, this.a, this.b, this.b.cQ().c(8.0, 8.0, 8.0))) {
               $$2.g($$0);
               $$2.v(true);
            }
   ...
   public class b<T extends cta> extends cef {
      private final T b;
      ...
      public boolean b() {
         if (this.h()) {
            ...
            double $$1 = cta.this.h(byp.m);

            for (cno $$3 : this.b.dU().a(cno.class, this.b.cQ().c($$1, 8.0, $$1), cta.a)) {
               long $$4 = this.c.getOrDefault($$3.ao(), Long.MIN_VALUE);
               if (cta.this.dU().ae() < $$4) {
                  $$0.put($$3.ao(), $$4);
               } else {
                  exj $$5 = this.b.O().a($$3, 1);
                  if ($$5 != null && $$5.j()) {
                     this.d = $$5;
                     this.e = $$3;
                     return true;
                  ...
                  $$0.put($$3.ao(), cta.this.dU().ae() + 600L);
               }
            }
      ...
      private boolean h() {
         if (!this.b.gH()) {
            ...
            return true;
         } else if (czk.a(this.b.a(bws.f), csz.a(this.b.dW().f(mh.aF)))) {
            return true;
         } else {
            cta $$0 = cta.this.d.b(this.b.gI());
            return $$0 != null && $$0.bI();
         }
      }
   ...
   static class d extends cef {
      ...
      public void a() {
         if (this.a.O().k()) {
            fex $$0 = fex.c(this.c);
            fex $$1 = cic.a(this.a, 16, 7, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
