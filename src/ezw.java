public class ezw extends ezk<cfc> implements fce {
   private static final aey x = new aey("textures/gui/container/crafting_table.png");
   private final fby y = new fby();
   private boolean z;

   public ezw(cfc $$0, cbv $$1, tn $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aH_() {
      ...
      this.d(new ete(this.t + 5, this.h / 2 - 49, 20, 18, fby.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
