...
public class ezw extends ezd<cfj> {
   private static final aez[] E = new aez[]{
      new aez("container/enchanting_table/level_1"), new aez("container/enchanting_table/level_2"), new aez("container/enchanting_table/level_3")
   };
   private static final aez[] F = new aez[]{
      new aez("container/enchanting_table/level_1_disabled"),
      new aez("container/enchanting_table/level_2_disabled"),
      new aez("container/enchanting_table/level_3_disabled")
   };
   private static final aez G = new aez("container/enchanting_table/enchantment_slot_disabled");
   private static final aez H = new aez("container/enchanting_table/enchantment_slot_highlighted");
   private static final aez I = new aez("container/enchanting_table/enchantment_slot");
   private static final aez J = new aez("textures/gui/container/enchanting_table.png");
   private static final aez K = new aez("textures/entity/enchanting_table_book.png");
   ...
   private void d(erz $$0, int $$1, int $$2, float $$3) {
      float $$4 = asb.i($$3, this.D, this.C);
      float $$5 = asb.i($$3, this.z, this.y);
      ekf.c();
      $$0.c().a();
      ...
      float $$8 = asb.a(asb.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = asb.a(asb.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.M.a(0.0F, $$8, $$9, $$4);
      eln $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, fyr.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      ekf.b();
   }
