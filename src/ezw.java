...
public class ezw extends ezz<ezw.b> {
   private static final aew x = new aew("container/creative_inventory/scroller");
   private static final aew y = new aew("container/creative_inventory/scroller_disabled");
   private static final aew[] z = new aew[]{
      new aew("container/creative_inventory/tab_top_unselected_1"),
      new aew("container/creative_inventory/tab_top_unselected_2"),
      new aew("container/creative_inventory/tab_top_unselected_3"),
      new aew("container/creative_inventory/tab_top_unselected_4"),
      new aew("container/creative_inventory/tab_top_unselected_5"),
      new aew("container/creative_inventory/tab_top_unselected_6"),
      new aew("container/creative_inventory/tab_top_unselected_7")
   };
   private static final aew[] A = new aew[]{
      new aew("container/creative_inventory/tab_top_selected_1"),
      new aew("container/creative_inventory/tab_top_selected_2"),
      new aew("container/creative_inventory/tab_top_selected_3"),
      new aew("container/creative_inventory/tab_top_selected_4"),
      new aew("container/creative_inventory/tab_top_selected_5"),
      new aew("container/creative_inventory/tab_top_selected_6"),
      new aew("container/creative_inventory/tab_top_selected_7")
   };
   private static final aew[] B = new aew[]{
      new aew("container/creative_inventory/tab_bottom_unselected_1"),
      new aew("container/creative_inventory/tab_bottom_unselected_2"),
      new aew("container/creative_inventory/tab_bottom_unselected_3"),
      new aew("container/creative_inventory/tab_bottom_unselected_4"),
      new aew("container/creative_inventory/tab_bottom_unselected_5"),
      new aew("container/creative_inventory/tab_bottom_unselected_6"),
      new aew("container/creative_inventory/tab_bottom_unselected_7")
   };
   private static final aew[] C = new aew[]{
      new aew("container/creative_inventory/tab_bottom_selected_1"),
      new aew("container/creative_inventory/tab_bottom_selected_2"),
      new aew("container/creative_inventory/tab_bottom_selected_3"),
      new aew("container/creative_inventory/tab_bottom_selected_4"),
      new aew("container/creative_inventory/tab_bottom_selected_5"),
      new aew("container/creative_inventory/tab_bottom_selected_6"),
      new aew("container/creative_inventory/tab_bottom_selected_7")
   };
   ...
   private boolean V;
   private boolean W;
   private final Set<aqh<cja>> X = new HashSet<>();
   ...
   private void a(cec $$0, boolean $$1, hg.b $$2) {
      if (chm.a($$0, $$1, $$2)) {
         for (chl $$3 : chm.d()) {
   ...
   protected void a(esf $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(new aew("textures/gui/container/creative_inventory/tab_" + O.c()), this.t, this.u, 0, 0, this.c, this.k);
      this.R.a($$0, $$2, $$3, $$1);
      int $$5 = this.t + 175;
      int $$6 = this.u + 18;
      int $$7 = $$6 + 112;
   ...
   protected void a(esf $$0, chl $$1) {
      ...
      $$0.a($$7[arw.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static class b extends cel {
      ...
      protected float e(int $$0) {
         return arw.a((float)$$0 / (float)this.l(), 0.0F, 1.0F);
      }

      protected float a(float $$0, double $$1) {
         return arw.a($$0 - (float)($$1 / (double)this.l()), 0.0F, 1.0F);
      }
