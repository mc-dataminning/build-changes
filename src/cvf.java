...
public abstract class cvf implements dt {
   private static final SimpleDateFormat b = new SimpleDateFormat("HH:mm:ss");
   private static final vs c = vs.b("@");
   private long d = -1L;
   ...
   public vs l() {
      return this.h == null ? vr.a : this.h;
   }

   public sy a(sy $$0) {
      $$0.a("Command", this.i);
      $$0.a("SuccessCount", this.f);
      $$0.a("CustomName", vs.a.a(this.j));
      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", vs.a.a(this.h));
      }
   ...
   public void b(sy $$0) {
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = vs.a.a($$0.l("LastOutput"));
         } catch (Throwable var3) {
            this.h = vs.b(var3.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public void a(vs $$0) {
      if (this.g) {
         this.h = vs.b("[" + b.format(new Date()) + "] ").b($$0);
         this.f();
      }
   }

   public abstract apa e();
   ...
   public abstract eov g();

   public abstract du i();

   @Override
   public boolean l_() {
      return this.e().Z().b(cwa.p) && this.g;
   }
