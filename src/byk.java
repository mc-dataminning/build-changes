...
public class byk extends bkl implements cad {
   private static final Logger bY = LogUtils.getLogger();
   public static final afc<Integer> b = aff.a(byk.class, afe.b);
   private static final buv bZ = buv.a().a(64.0);
   ...
   public int d = -1;
   private final byi[] cf;
   public final byi e;
   private final byi cg;
   private final byi ch;
   private final byi ci;
   private final byi cj;
   private final byi ck;
   private final byi cl;
   private final byi cm;
   public float bS;
   public float bT;
   public boolean bU;
   public int bV;
   ...
   private djn cn;
   private ht co = ht.b;
   private final bzb cp;
   private int cq = 100;
   private float cr;
   private final ebr[] cs = new ebr[24];
   private final int[] ct = new int[24];
   private final ebo cu = new ebo();

   public byk(bjx<? extends byk> $$0, cqz $$1) {
      super(bjx.C, $$1);
      this.e = new byi(this, "head", 1.0F, 1.0F);
      this.cg = new byi(this, "neck", 3.0F, 3.0F);
      this.ch = new byi(this, "body", 5.0F, 3.0F);
      this.ci = new byi(this, "tail", 2.0F, 2.0F);
      this.cj = new byi(this, "tail", 2.0F, 2.0F);
      this.ck = new byi(this, "tail", 2.0F, 2.0F);
      this.cl = new byi(this, "wing", 4.0F, 2.0F);
      this.cm = new byi(this, "wing", 4.0F, 2.0F);
      this.cf = new byi[]{this.e, this.cg, this.ch, this.ci, this.cj, this.ck, this.cl, this.cm};
      this.c(this.eL());
      this.af = true;
      this.at = true;
      this.cp = new bzb(this);
   }
   ...
   public static blo.a t() {
      return bkl.A().a(blp.l, 200.0);
   }

   @Override
   public boolean aR() {
      float $$0 = asy.b(this.bT * (float) (Math.PI * 2));
      float $$1 = asy.b(this.bS * (float) (Math.PI * 2));
   ...
   public void aQ() {
      if (this.dL().B && !this.aS()) {
         this.dL().a(this.dq(), this.ds(), this.dw(), aqd.gY, this.da(), 5.0F, 0.8F + this.ag.i() * 0.3F, false);
      }
   }
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = asy.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = asy.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
   ...
   public void c_() {
      ...
      if (this.dL().B) {
         ...
         if (!this.aS() && !this.cp.a().a() && --this.cq < 0) {
            this.dL().a(this.dq(), this.ds(), this.dw(), aqd.gZ, this.da(), 2.5F, 0.8F + this.ag.i() * 0.3F, false);
            this.cq = 200 + this.ag.a(200);
         }
      }

      if (this.cn == null && this.dL() instanceof alq $$0) {
         djn $$1 = $$0.B();
         ...
         if (this.fU()) {
            ...
            if (this.dL().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = asy.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.f(this.do().b(0.0, $$11 * 0.01, 0.0));
                  this.r(asy.g(this.dB()));
                  eif $$16 = $$9.a(this.dq(), this.ds(), this.dw()).d();
                  eif $$17 = new eif((double)asy.a(this.dB() * (float) (Math.PI / 180.0)), this.do().d, (double)(-asy.b(this.dB() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = asy.a(asy.g(180.0F - (float)asy.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dB()), -50.0F, 50.0F);
                     this.bW *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new eif(0.0, 0.0, -1.0));
                  if (this.bU) {
                     this.a(bkp.a, this.do().a(0.8F));
                  } else {
            ...
            this.aU = this.dB();
            eif[] $$24 = new eif[this.cf.length];

            for (int $$25 = 0; $$25 < this.cf.length; $$25++) {
               $$24[$$25] = new eif(this.cf[$$25].dq(), this.cf[$$25].ds(), this.cf[$$25].dw());
            }
            ...
            if (!this.dL().B && this.aK == 0) {
               this.b(this.dL().a(this, this.cl.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bjw.e));
               this.b(this.dL().a(this, this.cm.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bjw.e));
               this.c(this.dL().a(this, this.e.cG().g(1.0), bjw.e));
               this.c(this.dL().a(this, this.cg.cG().g(1.0), bjw.e));
            }

            float $$32 = asy.a(this.dB() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$33 = asy.b(this.dB() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$34 = this.gd();
   ...
   private void a(byi $$0, double $$1, double $$2, double $$3) {
   ...
   private void ge() {
      ...
      if (this.ag.a(10) == 0) {
         List<byj> $$0 = this.dL().a(byj.class, this.cG().g(32.0));
         byj $$1 = null;
   ...
   private void b(List<bjt> $$0) {
      ...
      for (bjt $$3 : $$0) {
         if ($$3 instanceof bkj) {
            ...
            if (!this.cp.a().a() && ((bkj)$$3).eh() < $$3.ah - 2) {
               $$3.a(this.dM().b((bkj)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bjt> $$0) {
      for (bjt $$1 : $$0) {
         if ($$1 instanceof bkj) {
            $$1.a(this.dM().b((bkj)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dgb $$13 = this.dL().a_($$12);
               if (!$$13.i() && !$$13.a(aqs.aC)) {
                  if (this.dL().X().b(cqv.c) && !$$13.a(aqs.aB)) {
   ...
   public boolean a(byi $$0, bir $$1, float $$2) {
      if (this.cp.a().i() == bza.j) {
         return false;
      } else {
         $$2 = this.cp.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof ccx || $$1.a(aqu.y)) {
               float $$3 = this.eu();
               this.g($$1, $$2);
   ...
   protected boolean g(bir $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void ea() {
      ...
      if (this.dL() instanceof alq) {
         if (this.bV > 150 && this.bV % 5 == 0 && $$3) {
            bjz.a((alq)this.dL(), this.dj(), asy.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bkp.a, new eif(0.0, 0.1F, 0.0));
      if (this.bV == 200 && this.dL() instanceof alq) {
         if ($$3) {
            bjz.a((alq)this.dL(), this.dj(), asy.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cs[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$4;
            if ($$0 < 12) {
               $$3 = asy.d(60.0F * asy.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
               $$4 = asy.d(60.0F * asy.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
            } else if ($$0 < 20) {
               int $$2 = $$0 - 12;
               $$3 = asy.d(40.0F * asy.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$4 = asy.d(40.0F * asy.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$1 += 10;
            } else {
               int var7 = $$0 - 20;
               $$3 = asy.d(20.0F * asy.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
               $$4 = asy.d(20.0F * asy.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
            }

            int $$9 = Math.max(this.dL().z_() + 10, this.dL().a(dlk.a.f, new ht($$3, 0, $$4)).v() + $$1);
            this.cs[$$0] = new ebr($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      ebr $$5 = new ebr(asy.a($$0), asy.a($$1), asy.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public ebt a(int $$0, int $$1, @Nullable ebr $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         ebr $$4 = this.cs[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private ebt a(ebr $$0, ebr $$1) {
      List<ebr> $$2 = Lists.newArrayList();
      ebr $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new ebt($$2, new ht($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(rt $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cp.a(bza.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      byu $$3 = this.cp.a();
      bza<? extends byu> $$4 = $$3.i();
      double $$7;
      if ($$4 == bza.d || $$4 == bza.e) {
         ht $$5 = this.dL().a(dlk.a.f, don.a(this.co));
   ...
   public eif D(float $$0) {
      byu $$1 = this.cp.a();
      bza<? extends byu> $$2 = $$1.i();
      eif $$8;
      if ($$2 == bza.d || $$2 == bza.e) {
         ht $$3 = this.dL().a(dlk.a.f, don.a(this.co));
   ...
   public void a(byj $$0, ht $$1, bir $$2) {
      ccx $$3;
      if ($$2.d() instanceof ccx) {
         $$3 = (ccx)$$2.d();
      } else {
