...
public class cpc {
   ...
   public static OptionalInt a(ash $$0, jh $$1, asi $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.ac().map(cpc::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<cpc> $$4 = $$3.stream().flatMap($$0x -> $$0x.ac().stream()).max(Comparator.comparingInt(cpc::c));
            if ($$4.isPresent()) {
               cpc $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(ash $$0, jh $$1) {
      fbt $$2 = fbt.a(fby.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(cpa.class, $$2).isEmpty();
   }
