...
public class axw<T> extends AbstractList<T> implements azf<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axw.this.get(this.b--);
      }

      @Override
      public void remove() {
         axw.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azf<T> {
      private final axw<T> b;

      public b(final axw<T> $$0) {
         this.b = $$0;
      }
