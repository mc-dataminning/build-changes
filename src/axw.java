...
public class axw<K> implements jw<K> {
   ...
   private axw(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> axw<A> c(int $$0) {
      return new axw((int)((float)$$0 / 0.8F));
   }
   ...
   public axw<K> b() {
      return new axw<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
