...
public class hjc extends MinecraftServer {
   ...
   public hjc(Thread $$0, fli $$1, eve.c $$2, aua $$3, alu $$4, alq $$5, aro $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hjb(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dge bd() {
      return this.r() && !this.w_() ? (dge)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
