...
public class hjc implements hiy {
   ...
   private final die e;
   private final azh f;
   private final Object2ObjectArrayMap<dic, hjc.a> g = new Object2ObjectArrayMap();
   ...
   @Override
   public void a() {
      this.g.values().removeIf(hix::m);
      dic $$0 = this.e.a(this.c.dz(), this.c.dB(), this.c.dF()).a();
      if ($$0 != this.k) {
         this.k = $$0;
         this.h = $$0.m();
         this.i = $$0.n();
         this.g.values().forEach(hjc.a::o);
         ...
         .ifPresent(
            $$0x -> {
               ...
               if (this.j >= 1.0F) {
                  ...
                  double $$12 = $$11 + $$0x.d();
                  hjj $$13 = hjj.a($$0x.a().a(), this.f, this.c.dz() + $$8 / $$11 * $$12, this.c.dD() + $$9 / $$11 * $$12, this.c.dF() + $$10 / $$11 * $$12);
                  this.d.a($$13);
                  this.j = 0.0F;
               } else {
