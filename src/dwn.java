...
public class dwn extends dvs<dye> {
   public dwn(Codec<dye> $$0) {
      super($$0);
   }
   ...
   protected boolean a(
      cxw $$0, axd $$1, dye $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dnb $$0, Function<ib, dnb> $$1, axd $$2, dye $$3, dye.a $$4, ib.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
