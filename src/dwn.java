...
public class dwn {
   ...
   public static final Codec<dwn> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ac.a($$0, 6).map($$0x -> new dwn($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public dwn(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static dwn a() {
      return new dwn(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static dwn a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, hx $$9) {
      switch ($$9) {
         case d:
         default:
            return new dwn($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new dwn($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new dwn($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new dwn($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }

   public boolean a(dwn $$0) {
   ...
   public static Optional<dwn> a(Iterable<ht> $$0) {
      Iterator<ht> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         dwn $$2 = new dwn($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<dwn> b(Iterable<dwn> $$0) {
      Iterator<dwn> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         dwn $$2 = $$1.next();
         dwn $$3 = new dwn($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   @Deprecated
   public dwn a(int $$0, int $$1, int $$2) {
      this.c += $$0;
      this.d += $$1;
      this.e += $$2;
      this.f += $$0;
   ...
   public dwn b(int $$0, int $$1, int $$2) {
      return new dwn(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }

   public dwn a(int $$0) {
      return new dwn(this.g() - $$0, this.h() - $$0, this.i() - $$0, this.j() + $$0, this.k() + $$0, this.l() + $$0);
   }
   ...
   public iw b() {
      return new iw(this.f - this.c, this.g - this.d, this.h - this.e);
   }
   ...
   public ht f() {
      return new ht(this.c + (this.f - this.c + 1) / 2, this.d + (this.g - this.d + 1) / 2, this.e + (this.h - this.e + 1) / 2);
   }
