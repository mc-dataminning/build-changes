...
public class dwn extends dne {
   ...
   public static final MapCodec<dwn> b = RecordCodecBuilder.mapCodec($$0 -> $$0.group(a.forGetter($$0x -> $$0x.c), t()).apply($$0, dwn::new));
   protected final md c;

   @Override
   public MapCodec<? extends dwn> a() {
      return b;
   }

   protected dwn(md $$0, ebp.d $$1) {
      super($$1);
      this.c = $$0;
   }
