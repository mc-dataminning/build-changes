...
public final class dwn extends dwq<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dwn(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dwn $$1 && super.equals($$0)) {
   ...
   public static dwn a(String $$0, int $$1, int $$2) {
