...
public class etb {
   ...
   @Deprecated
   public static etb a(bam $$0, IntStream $$1) {
      return new etb($$0, a(new IntRBTreeSet($$1.boxed().collect(ImmutableList.toImmutableList()))), false);
   }

   @Deprecated
   public static etb a(bam $$0, int $$1, DoubleList $$2) {
      return new etb($$0, Pair.of($$1, $$2), false);
   }

   public static etb b(bam $$0, IntStream $$1) {
      return a($$0, $$1.boxed().collect(ImmutableList.toImmutableList()));
   }

   public static etb a(bam $$0, List<Integer> $$1) {
      return new etb($$0, a(new IntRBTreeSet($$1)), true);
   }

   public static etb a(bam $$0, int $$1, double $$2, double... $$3) {
      DoubleArrayList $$4 = new DoubleArrayList($$3);
      $$4.add(0, $$2);
      return new etb($$0, Pair.of($$1, $$4), true);
   }

   public static etb b(bam $$0, int $$1, DoubleList $$2) {
      return new etb($$0, Pair.of($$1, $$2), true);
   }
   ...
   protected etb(bam $$0, Pair<Integer, DoubleList> $$1, boolean $$2) {
      ...
      if ($$2) {
         ...
         for (int $$6 = 0; $$6 < $$3; $$6++) {
            if (this.d.getDouble($$6) != 0.0) {
               int $$7 = this.c + $$6;
               this.b[$$6] = new esy($$5.a("octave_" + $$7));
            }
         }
      } else {
         esy $$8 = new esy($$0);
