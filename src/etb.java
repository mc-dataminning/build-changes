...
public class etb {
   ...
   private final ert c;
   private final List<etb.a> d = Lists.newArrayList();
   private String e;
   private int f;
   private int g;
   private boolean h;
   ...
   public etb.a e() {
      return new etb.a(Math.min(this.g, this.f), Math.max(this.g, this.f));
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = arp.a($$0);
      int $$3 = arp.a($$1 / 9.0);
      etb.a $$4 = this.d.get(arp.a($$3, 0, this.d.size() - 1));
   ...
   private void o() {
      ...
      if (this.e.isEmpty()) {
         ...
         this.c.b().a(this.e, this.j, ub.a, false, ($$0, $$1, $$2) -> this.d.add(new etb.a($$1, $$2)));
         if (this.e.charAt(this.e.length() - 1) == '\n') {
            this.d.add(new etb.a(this.e.length(), this.e.length()));
         }
      }
   }
   ...
   protected static record a(int a, int b) {
      static final etb.a c = new etb.a(0, 0);
   }
}
