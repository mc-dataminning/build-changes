...
public class etb extends esq implements etu {
   private static final eue d = new eue(new aey("widget/text_field"), new aey("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, arl> D = ($$0x, $$1x) -> arl.forward($$0x, uj.a);
   @Nullable
   private tn E;
   private long F = ac.b();

   public etb(esf $$0, int $$1, int $$2, tn $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public etb(esf $$0, int $$1, int $$2, int $$3, int $$4, tn $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public etb(esf $$0, int $$1, int $$2, int $$3, int $$4, @Nullable etb $$5, tn $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, arl> $$0) {
      this.D = $$0;
   }
   ...
   protected ua aE_() {
      tn $$0 = this.m();
      return tn.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void k(int $$0) {
      this.w = ary.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ary.a($$0) - this.r();
      if (this.s) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, eym.q());
   }
   ...
   public void b(esh $$0, int $$1, int $$2, float $$3) {
      if (this.v()) {
         ...
         int $$12 = $$10;
         int $$13 = ary.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(foo.D(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = ary.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ary.a(this.v, 0, this.p.length());
      }
   }
