...
public class gbp implements gbf {
   ...
   protected final Map<ha, List<fpb>> b;
   ...
   public gbp(List<fpb> $$0, Map<ha, List<fpb>> $$1, boolean $$2, boolean $$3, boolean $$4, fze $$5, fpn $$6, fpl $$7) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$4;
   ...
   public static class a {
      ...
      private final Map<ha, List<fpb>> b = Maps.newEnumMap(ha.class);
      private final fpl c;
