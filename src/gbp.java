...
public class gbp extends gce {
   ...
   gbp(fxx $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   private void a(fae $$0, Vector3f $$1, float $$2, float $$3, int $$4) {
   ...
   public static class a implements gbh<ll> {
      private final gbz a;
      ...
      public gbe a(ll $$0, fxx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbp $$8 = new gbp($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
