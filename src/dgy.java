...
public class dgy {
   public static <T> List<dgy.b> a(List<T> $$0, Function<T, List<ju<elm>>> $$1, boolean $$2) {
      Object2IntMap<elm> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, elm c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<ju<elm>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jq<elm> $$12 : $$10.get($$11)) {
               elm $$13 = $$12.a();
      ...
      Builder<dgy.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<elm> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dgy.b($$28));
      }
   ...
   public static record b(List<elm> a, ToIntFunction<elm> b) {
      b(List<elm> $$0) {
         this($$0, ae.h($$0));
      }
   }
