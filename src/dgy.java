...
public class dgy implements dga {
   private static final dgb a = new dgb();
   private static final int b = 16;
   private static final float c = 2.0F;
   private final boolean d;
   private final dga.a e;
   private final arc f;
   private final fba g;
   @Nullable
   private final buk h;
   ...
   private final bta j;
   private final dgb k;
   private final Map<cox, fba> l = new HashMap<>();

   public dgy(arc $$0, @Nullable buk $$1, @Nullable bta $$2, @Nullable dgb $$3, fba $$4, float $$5, boolean $$6, dga.a $$7) {
      this.f = $$0;
      this.h = $$1;
      this.i = $$5;
      this.g = $$4;
   ...
   private dgb b(@Nullable buk $$0) {
      return (dgb)($$0 == null ? a : new dfy($$0));
   }

   public static float a(fba $$0, buk $$1) {
      fav $$2 = $$1.cR();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  fba $$16 = new fba($$13 + $$6, $$14, $$15 + $$7);
                  if ($$1.dW().a(new dfq($$16, $$0, dfq.a.a, dfq.b.a, $$1)).d() == fay.a.a) {
                     $$8++;
                  }
   ...
   private void n() {
      ...
      for (buk $$8 : this.f.a_(this.h, new fav((double)$$1, (double)$$3, (double)$$5, (double)$$2, (double)$$4, (double)$$6))) {
         if (!$$8.a(this)) {
            double $$9 = Math.sqrt($$8.f(this.g)) / (double)$$0;
            if ($$9 <= 1.0) {
               double $$10 = $$8.dB() - this.g.d;
               double $$11 = ($$8 instanceof clc ? $$8.dD() : $$8.dF()) - this.g.e;
   ...
   private void b(List<ji> $$0) {
      for (ji $$1 : $$0) {
         if (this.f.A.a(3) == 0 && this.f.a_($$1).l() && this.f.a_($$1.e()).s()) {
            this.f.b($$1, diz.a(this.f, $$1));
         }
      }
   }

   public void i() {
      this.f.a(this.h, ebt.w, this.g);
      List<ji> $$0 = this.m();
      this.n();
      if (this.o()) {
         bos $$1 = bor.a();
   ...
   private static void a(List<dgy.a> $$0, cwp $$1, ji $$2) {
      for (dgy.a $$3 : $$0) {
         $$3.a($$1);
         if ($$1.f()) {
            return;
   ...
   private boolean o() {
      return this.e != dga.a.a;
   }

   public Map<cox, fba> j() {
      return this.l;
   }
   ...
   public boolean g() {
      if (this.e != dga.a.d) {
         ...
         return this.h != null && this.h.aq() == bur.s ? this.f.O().b(dge.c) : true;
      }
   }

   @Override
   public boolean h() {
      boolean $$0 = this.f.O().b(dge.c);
      boolean $$1 = this.h == null || !this.h.bj();
      boolean $$2 = this.h == null || this.h.aq() != bur.s && this.h.aq() != bur.bH;
