...
public class dgy implements dga {
   ...
   public dgy(ard $$0, @Nullable bul $$1, @Nullable btb $$2, @Nullable dgb $$3, fba $$4, float $$5, boolean $$6, dga.a $$7) {
      this.f = $$0;
      this.h = $$1;
      this.i = $$5;
      this.g = $$4;
   ...
   private dgb b(@Nullable bul $$0) {
      return (dgb)($$0 == null ? a : new dfy($$0));
   }

   public static float a(fba $$0, bul $$1) {
      fav $$2 = $$1.cR();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  if ($$1.dV().a(new dfq($$16, $$0, dfq.a.a, dfq.b.a, $$1)).d() == fay.a.a) {
                     $$8++;
                  }
   ...
   private void n() {
      ...
      for (bul $$8 : this.f.a_(this.h, new fav((double)$$1, (double)$$3, (double)$$5, (double)$$2, (double)$$4, (double)$$6))) {
         if (!$$8.a(this)) {
   ...
   public boolean g() {
      if (this.e != dga.a.d) {
         ...
         return this.h != null && this.h.aq() == bus.s ? this.f.O().b(dge.c) : true;
      }
   }
   ...
   public boolean h() {
      ...
      boolean $$2 = this.h == null || this.h.aq() != bus.s && this.h.aq() != bus.bG;
