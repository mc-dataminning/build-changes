...
public record dgy(alg d) implements dgo {
   private static final Logger e = LogUtils.getLogger();
   public static final MapCodec<dgy> a = RecordCodecBuilder.mapCodec($$0 -> $$0.group(alg.a.fieldOf("function").forGetter(dgy::b)).apply($$0, dgy::new));
