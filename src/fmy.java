...
public abstract class fmy extends fly {
   private final dpq b;
   private dpr c;
   ...
   public fmy(dpq $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wx.c("sign.edit"));
   }

   public fmy(dpq $$0, boolean $$1, boolean $$2, wx $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
   ...
   @Override
   protected void aM_() {
      this.c(ffz.a(ww.d, $$0 -> this.D()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fit(() -> this.d[this.u], this::a, fit.a(this.m), fit.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   public void j() {
      fws $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new ahw(this.b.az_(), this.r, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void a(ffm var1, drb var2);
