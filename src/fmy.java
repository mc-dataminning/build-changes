...
public class fmy extends fnd {
   ...
   protected void aO_() {
      ...
      this.c(new fit(0, this.G ? 40 : 10, this.m, 9, this.k, this.o));
   }
   ...
   private void E() {
      ...
      $$1.a(this.a(v, () -> new fnn(this.l.s.cB.p(), this)));
      $$1.a(this.a(w, () -> new fnh(this, this.l.s.j())));
      ...
      $$1.a(this.a(z, () -> new fqe(this, this.l.m)));
      if (this.l.U() && !this.l.V().r()) {
         $$1.a(this.a(A, () -> new fne(this)));
      } else {
         $$1.a(this.a(B, () -> new fru(this)));
      }

      wu $$2 = this.l.T() ? C : wt.p;
      this.H = $$1.a(fhm.a($$2, $$0x -> {
         $$0x.j = false;
         this.l.aZ().a(this.l, this, this::F, true);
      }).a(204).a(), 2);
      $$0.a();
      fkx.a($$0, 0, 0, this.m, this.n, 0.5F, 0.25F);
      $$0.a(this::c);
   }
   ...
   private fhm a(wu $$0, Supplier<fnd> $$1) {
      return fhm.a($$0, $$1x -> this.l.a($$1.get())).a(98).a();
   }

   private fhm a(wu $$0, String $$1) {
      return fhm.a($$0, fma.b(this, $$1)).a(98).a();
   }
}
