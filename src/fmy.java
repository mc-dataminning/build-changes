...
public enum fmy implements fan {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fbp a(int $$0, int $$1, fmy.a $$2) {
      fbp $$3 = new fbp(fbp.a.a, $$0, $$1, false);
   ...
   private fmy(final Supplier<fbp> $$0) {
      this.c = $$0.get();
   }
