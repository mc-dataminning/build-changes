...
public class fmy extends fnc {
   ...
   private static final ald<dcw> x = ddd.b;
   ...
   @Nullable
   private static egj a(jj<dey> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, dvt.c);
      int $$10 = $$9 - $$2;

      Optional<ji.c<dey>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new egj($$10, $$11.get().a());
      }
   }

   private static List<egj> a(jj<dey> $$0, String $$1) {
      List<egj> $$2 = Lists.newArrayList();
      String[] $$3 = $$1.split(",");
      int $$4 = 0;
   ...
   public static egm a(jj<dey> $$0, jj<dcw> $$1, jj<eip> $$2, jj<ehn> $$3, String $$4, egm $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return egm.a($$1, $$2, $$3);
      } else {
         List<egj> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return egm.a($$1, $$2, $$3);
         } else {
            ji.c<dcw> $$8 = $$1.b(x);
   ...
   protected void aM_() {
      ...
      this.D = new fhm(this.p, 50, 40, this.n - 100, 20, this.z);
      this.D.f(1230);
      frz $$0 = this.y.a.m().k();
      jw $$1 = $$0.a();
      cpk $$2 = $$0.g().b();
      ...
      jj<eip> $$4 = $$1.b(lq.aL);
      jj<ehn> $$5 = $$1.b(lq.aI);
      jj<dey> $$6 = $$1.b(lq.f).a($$2);
      this.D.a(a(this.y.l()));
      this.E = this.y.l();
      this.d(this.D);
      this.B = this.c(new fmy.a($$1, $$2));
      this.C = this.c(fhd.a(xo.c("createWorld.customize.presets.select"), $$4x -> {
         egm $$5x = a($$6, $$3, $$4, $$5, this.D.a(), this.E);
         this.y.a($$5x);
         this.m.a(this.y);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(fhd.a(xn.e, $$0x -> this.m.a(this.y)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends fhz<fmy.a.a> {
      public a(final jw $$0, final cpk $$1) {
         super(fmy.this.m, fmy.this.n, fmy.this.o - 117, 80, 24);

         for (ji<egk> $$2 : $$0.d(lq.aF).c(awt.a)) {
            Set<dey> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               fmy.c
                  .info(
      ...
      public class a extends fhz.a<fmy.a.a> {
         ...
         void b() {
            a.this.a(this);
            fmy.this.E = this.c.b();
            fmy.this.D.a(fmy.a(fmy.this.E));
            fmy.this.D.b(false);
         }

         private void a(fgq $$0, int $$1, int $$2, cuj $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
