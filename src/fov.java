...
public class fov extends foa<cqd> {
   ...
   protected void aP_() {
      super.aP_();
      this.S = new fty(this.l.aP().a(fxp.r));
   }
   ...
   protected void a(fhh $$0, float $$1, int $$2, int $$3) {
      ...
      for (int $$7 = 0; $$7 < 3; $$7++) {
         ...
         if ($$10 == 0) {
            ...
            wz $$13 = fou.a().a(this.o, $$12);
            int $$14 = 6839882;
            if (($$6 < $$7 + 1 || this.l.s.cr < $$10) && !this.l.s.gb().d) {
               RenderSystem.enableBlend();
               $$0.a(M, $$8, $$5 + 14 + 19 * $$7, 108, 19);
   ...
   private void d(fhh $$0, int $$1, int $$2, float $$3) {
      float $$4 = ayg.i($$3, this.J, this.I);
      float $$5 = ayg.i($$3, this.F, this.E);
      ezk.e();
      $$0.c().a();
      ...
      float $$8 = ayg.a(ayg.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = ayg.a(ayg.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.S.a(0.0F, $$8, $$9, $$4);
      fas $$10 = $$0.d().getBuffer(this.S.a(Q));
      this.S.a($$0.c(), $$10, 15728880, gph.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      ezk.d();
   }
   ...
   public void a(fhh $$0, int $$1, int $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      this.a($$0, $$1, $$2);
      boolean $$4 = this.l.s.gb().d;
      int $$5 = this.w.l();

      for (int $$6 = 0; $$6 < 3; $$6++) {
         int $$7 = this.w.k[$$6];
         Optional<jj.c<czm>> $$8 = this.l.r.H_().d(lr.aK).c(this.w.l[$$6]);
         if (!$$8.isEmpty()) {
            int $$9 = this.w.m[$$6];
            int $$10 = $$6 + 1;
            if (this.a(60, 14 + 19 * $$6, 108, 17, (double)$$1, (double)$$2) && $$7 > 0 && $$9 >= 0 && $$8 != null) {
               List<wu> $$11 = Lists.newArrayList();
               $$11.add(wu.a("container.enchant.clue", czm.a($$8.get(), $$9)).a(n.p));
               if (!$$4) {
                  $$11.add(wt.a);
                  if (this.l.s.cr < $$7) {
