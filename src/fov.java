...
public class fov extends foa<cqn> {
   ...
   protected void aM_() {
      super.aM_();
      this.S = new fth(this.m.aR().a(fwy.r));
   }
   ...
   private void d(fgq $$0, int $$1, int $$2, float $$3) {
      float $$4 = ayy.i($$3, this.J, this.I);
      float $$5 = ayy.i($$3, this.F, this.E);
      eyt.e();
      $$0.c().a();
      ...
      float $$8 = ayy.a(ayy.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = ayy.a(ayy.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.S.a(0.0F, $$8, $$9, $$4);
      fab $$10 = $$0.d().getBuffer(this.S.a(Q));
      this.S.a($$0.c(), $$10, 15728880, gop.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      eyt.d();
   }
