...
public abstract class fov extends fod {
   private final drs b;
   private drt c;
   ...
   public fov(drs $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wz.c("sign.edit"));
   }

   public fov(drs $$0, boolean $$1, boolean $$2, wz $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.s = $$1;
   ...
   @Override
   protected void aT_() {
      this.c(fim.a(wy.d, $$0 -> this.D()).a(this.m / 2 - 100, this.n / 4 + 144, 200, 20).a());
      this.w = new flg(() -> this.r[this.v], this::a, flg.a(this.l), flg.c(this.l), $$0 -> this.l.h.b($$0) <= this.b.c());
   }
   ...
   protected abstract void a(fhz var1, dtc var2);
   ...
   private void d(fhz $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : ghn.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.r.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.v && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gfh.G(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
