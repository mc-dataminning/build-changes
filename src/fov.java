...
public enum fov implements fci {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fdk a(int $$0, int $$1, fov.a $$2) {
      fdk $$3 = new fdk(fdk.a.a, $$0, $$1, false);
   ...
   private fov(final Supplier<fdk> $$0) {
      this.c = $$0.get();
   }
