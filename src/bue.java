...
public class bue extends bul implements bwg {
   ...
   private static final ajy<Float> e = akc.a(bue.class, aka.d);
   private static final ajy<Boolean> f = akc.a(bue.class, aka.k);
   private static final ajy<lr> g = akc.a(bue.class, aka.l);
   ...
   public bue(bus<? extends bue> $$0, dgi $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public bue(dgi $$0, double $$1, double $$2, double $$3) {
      this(bus.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public bvh n() {
      if (this.s != null && !this.s.dQ()) {
         ...
         if (this.t != null && this.dV() instanceof ard $$0) {
            this.s = $$0.a(this.t) instanceof bvh $$1 ? $$1 : null;
         }
