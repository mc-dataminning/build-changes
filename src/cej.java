...
public class cej {
   ...
   public static iz a(azc $$0, int $$1, int $$2) {
      int $$3 = $$0.a(2 * $$1 + 1) - $$1;
      int $$4 = $$0.a(2 * $$2 + 1) - $$2;
      int $$5 = $$0.a(2 * $$1 + 1) - $$1;
      return new iz($$3, $$4, $$5);
   ...
   @Nullable
   public static iz a(azc $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      double $$7 = ayu.d($$5, $$4) - (float) (Math.PI / 2);
      double $$8 = $$7 + (double)(2.0F * $$0.i() - 1.0F) * $$6;
      double $$9 = Math.sqrt($$0.j()) * (double)ayu.g * (double)$$1;
   ...
   @Nullable
   public static evm a(btt $$0, Supplier<iz> $$1) {
      return a($$1, $$0::d);
   }

   @Nullable
   public static evm a(Supplier<iz> $$0, ToDoubleFunction<iz> $$1) {
      ...
      return $$3 != null ? evm.c($$3) : null;
   }

   public static iz a(btt $$0, int $$1, azc $$2, iz $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.gb() && $$1 > 1) {
         iz $$6 = $$0.fY();
