...
public class eso {
   ...
   private static final Map<dki.a, String> e = ac.a(new EnumMap<>(dki.a.class), $$0 -> {
      $$0.put(dki.a.a, "SW");
      $$0.put(dki.a.b, "S");
      $$0.put(dki.a.c, "OW");
      $$0.put(dki.a.d, "O");
   ...
   private void a(erv $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         if ($$20.C()) {
            ...
            int $$22 = this.f.r.a(cpu.a, $$7);
            int $$23 = this.f.r.a(cpu.b, $$7);
   ...
   private static String a(he<cqj> $$0) {
   ...
   private cpl p() {
      return (cpl)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ac()))), this.f.r);
   }
   ...
   private dhg q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, dha.n, false).thenApply($$0x -> (dhg)$$0x.map($$0xx -> (dhg)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ejy.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", eql.O().aM().k(), eql.O().aM().l(), ejy.a()),
            ejy.c(),
            ejy.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == ehb.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dgc<?>, Comparable<?>> $$7 = (Entry<dgc<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ehb.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dgc<?>, Comparable<?>> $$10 = (Entry<dgc<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dgc<?>, Comparable<?>> $$0) {
      dgc<?> $$1 = $$0.getKey();
