...
public abstract class eso implements ets, euk, ewb, ewg {
   ...
   private void a() {
      if (this.n != null) {
         boolean $$0 = this.h || this.aC_() && eqv.O().aU().b();
         if ($$0 != this.q) {
            if ($$0) {
               this.p = ac.b();
            }
   ...
   protected fbb j() {
      return (fbb)(!this.h && this.aC_() && eqv.O().aU().b() ? new fax(this) : new fbd(this));
   }
   ...
   protected static void a(esf $$0, esd $$1, tl $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      ...
      if ($$9 > $$11) {
         ...
         double $$16 = arw.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = arw.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }
