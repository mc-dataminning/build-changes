...
public abstract class eso<M extends esl<M>> {
   private final dgs i;
   protected final dzg a;
   ...
   protected final Long2ObjectMap<dyy> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eso(dgs $$0, dzg $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dyy a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dyy a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dyy c(long $$0) {
      dyy $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dyy g(long $$0) {
      dyy $$1 = (dyy)this.g.get($$0);
      return $$1 != null ? $$1 : new dyy();
   }
   ...
   protected void a(esr<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dyy>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dyy> $$6 = (Entry<dyy>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dyy $$8 = (dyy)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dyy $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kk.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eso.a.a($$9, eso.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eso.b l(long $$0) {
      return eso.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eso.b c(byte $$0) {
         if ($$0 == 0) {
            return eso.b.a;
         } else {
            return a($$0) ? eso.b.c : eso.b.b;
         }
      }
   }
