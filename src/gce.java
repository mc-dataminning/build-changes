...
public class gce {
   ...
   public gce(Runnable $$0, Function<auk, alg> $$1, aun $$2, Consumer<aun> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<gce.a> a() {
      return this.c.stream().map($$0 -> new gce.d($$0));
   }

   public Stream<gce.a> b() {
      return this.b.stream().map($$0 -> new gce.c($$0));
   }
   ...
   abstract class b implements gce.a {
      private final auk b;
      ...
      @Override
      public alg a() {
         return gce.this.d.apply(this.b);
      }
