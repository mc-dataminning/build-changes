...
public class dql implements dpv {
   public static final Codec<dql> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               duh.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               aqd.b(je.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               drw.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               drw.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dlu.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dql::new)
   );
   ...
   public dql(hg<duh> $$0, int $$1, int $$2, aqd<csq> $$3, drw $$4, int $$5, int $$6, int $$7, int $$8, drw $$9, int $$10, int $$11, dlu $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
