...
public class dql {
   ...
   final boolean g;
   private final axf<djl> h;
   private final int i;
   private final int j;
   private final int k;
   private final int l;
   private List<dql.a> m = new ArrayList<>();
   private static final Logger n = LogUtils.getLogger();

   public dql(boolean $$0, axf<djl> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static dql a() {
      return new dql(false, awp.bU, 10, 4, 10, 5);
   }

   public static dql b() {
      return new dql(true, awp.bV, 50, 1, 5, 10);
   }
   ...
   public void a(tq $$0) {
      if ($$0.b("cursors", 9)) {
         this.m.clear();
         List<dql.a> $$1 = (List<dql.a>)dql.a.b.listOf().parse(new Dynamic(ue.a, $$0.c("cursors", 10))).resultOrPartial(n::error).orElseGet(ArrayList::new);
   ...
   public void b(tq $$0) {
      dql.a.b.listOf().encodeStart(ue.a, this.m).resultOrPartial(n::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(ji $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dql.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dql.a $$0) {
      if (this.m.size() < 32) {
         this.m.add($$0);
      }
   }

   public void a(dgi $$0, ji $$1, azh $$2, boolean $$3) {
      if (!this.m.isEmpty()) {
         List<dql.a> $$4 = new ArrayList<>();
         Map<ji, dql.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dql.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ji.a.fieldOf("pos").forGetter(dql.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dql.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dql.a::c),
      ...
      private boolean a(dgi $$0, ji $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dgi $$0, ji $$1, azh $$2, dql $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.g)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static dqg a(dww $$0) {
         return $$0.b() instanceof dqg $$1 ? $$1 : dqg.u_;
      }
      ...
      @Nullable
      private static ji a(dgi $$0, ji $$1, azh $$2) {
         ji.a $$3 = $$1.k();
         ji.a $$4 = $$1.k();
      ...
      private static boolean a(dgi $$0, ji $$1, ji $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            ji $$3 = $$2.b($$1);
      ...
      private static boolean a(dgi $$0, ji $$1, jn $$2) {
         ji $$3 = $$1.a($$2);
