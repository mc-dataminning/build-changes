...
public class dql extends dju {
   public static final MapCodec<dql> c = b(dql::new);
   public static final dye d = dyd.r;
   private static final Map<dgf, List<dql.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dha $$0, jh $$1, boolean $$2) {
      List<dql.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dql.a($$1.j(), $$0.ac()));
      }
