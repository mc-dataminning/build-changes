...
public class exf implements Comparable<exf> {
   private static final Map<String, exf> h = Maps.newHashMap();
   private static final Map<eqv.a, exf> i = Maps.newHashMap();
   ...
   public static void a(eqv.a $$0, boolean $$1) {
      exf $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (exf $$0 : h.values()) {
         if ($$0.o.a() == eqv.b.a && $$0.o.b() != eqv.bv.b()) {
            $$0.a(eqv.a(exh.O().aM().i(), $$0.o.b()));
         }
      }
   }
   ...
   public exf(String $$0, int $$1, String $$2) {
      this($$0, eqv.b.a, $$1, $$2);
   }

   public exf(String $$0, eqv.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public boolean j() {
      return this.o.equals(eqv.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == eqv.bv.b() ? this.o.a() == eqv.b.b && this.o.b() == $$1 : this.o.a() == eqv.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == eqv.b.c && this.o.b() == $$0;
   }
