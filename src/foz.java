...
public class foz extends fon {
   private static final fqd d = new fqd(aku.b("widget/text_field"), aku.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayk> D = ($$0x, $$1x) -> ayk.forward($$0x, xl.a);
   @Nullable
   private wo E;
   private long F = af.c();

   public foz(fnz $$0, int $$1, int $$2, wo $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public foz(fnz $$0, int $$1, int $$2, int $$3, int $$4, wo $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public foz(fnz $$0, int $$1, int $$2, int $$3, int $$4, @Nullable foz $$5, wo $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   protected xc d() {
      wo $$0 = this.B();
      return wo.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayy.a($$0) - this.F();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fui.t());
   }
   ...
   public void b(fob $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            aku $$4 = d.a(this.E(), this.aM_());
            $$0.a(gmf::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gmf.L(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   private void a(fob $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$1 < $$3) {
         int $$5 = $$1;
         $$1 = $$3;
         $$3 = $$5;
