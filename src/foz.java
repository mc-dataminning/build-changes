...
public class foz extends fqd {
   ...
   protected void aR_() {
      ...
      this.b = new fkt(this.m.i, 4, this.o - 12, this.n - 4, 12, xd.c("chat.editBox")) {
         @Override
         protected xr aO_() {
            return super.aO_().b(foz.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fkn(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(fjx $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fif $$4 = this.m.m.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(foh $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fog.a, xd.a("chat_screen.message", $$1));
      }
   }
   ...
   public String a(String $$0) {
      return baa.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
