...
public class foz extends fod {
   ...
   private String E = "";
   private final flg F = new flg(this::P, this::b, this::m, this::a, $$0x -> $$0x.length() < 1024 && this.o.b($$0x, 114) <= 128);
   private final flg G = new flg(() -> this.E, $$0x -> this.E = $$0x, this::m, this::a, $$0x -> $$0x.length() < 16);
   private long H;
   private int I = -1;
   private fqb J;
   private fqb K;
   ...
   private final bqq P;
   @Nullable
   private foz.a Q = foz.a.a;
   private wz R = wy.a;
   private final wz S;

   public foz(cmx $$0, cuq $$1, bqq $$2) {
      super(fgg.a);
      this.x = $$0;
      this.y = $$1;
      this.P = $$2;
      cya $$3 = $$1.a(kq.I);
      if ($$3 != null) {
         $$3.a(fgo.Q().aQ()).forEach(this.D::add);
      }
   ...
   private String m() {
      return this.l != null ? flg.b(this.l) : "";
   }
   ...
   protected void aT_() {
      this.R();
      this.M = this.c((fim)fim.a(wz.c("book.signButton"), $$0x -> {
         this.A = true;
         this.F();
      }).a(this.m / 2 - 100, 196, 98, 20).a());
      this.L = this.c((fim)fim.a(wy.d, $$0x -> {
         this.l.a(null);
         this.c(false);
      }).a(this.m / 2 + 2, 196, 98, 20).a());
      this.N = this.c((fim)fim.a(wz.c("book.finalizeButton"), $$0x -> {
         if (this.A) {
            this.c(true);
            this.l.a(null);
         }
      }).a(this.m / 2 - 100, 196, 98, 20).a());
      this.O = this.c((fim)fim.a(wy.e, $$0x -> {
         if (this.A) {
            this.A = false;
         }
      ...
      int $$0 = (this.m - 192) / 2;
      int $$1 = 2;
      this.J = this.c(new fqb($$0 + 116, 159, true, $$0x -> this.E(), true));
      this.K = this.c(new fqb($$0 + 43, 159, false, $$0x -> this.D(), true));
      this.F();
   }
   ...
   private void c(boolean $$0) {
      if (this.z) {
         this.G();
         this.J();
         int $$1 = this.P == bqq.a ? this.x.fY().k : 40;
   ...
   public void b(fhz $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(fpa.s, (this.m - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(fhz $$0, foz.c $$1, boolean $$2) {
      if (this.B / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(fhz $$0, gfe[] $$1) {
      for (gfe $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(gfh.G(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private foz.c a(foz.c $$0) {
      return new foz.c($$0.a - (this.m - 192) / 2 - 36, $$0.b - 32);
   }

   private foz.c b(foz.c $$0) {
      return new foz.c($$0.a + (this.m - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ad.c();
            foz.a $$4 = this.Q();
            int $$5 = $$4.a(this.o, this.a(new foz.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.P();
      this.F.a(fgz.a($$1, -1, $$0, false), fgz.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            foz.a $$5 = this.Q();
            int $$6 = $$5.a(this.o, this.a(new foz.c((int)$$0, (int)$$1)));
            this.F.c($$6, true);
            this.R();
         }
   ...
   private foz.a T() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<foz.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, xw.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            foz.c $$12 = this.b(new foz.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new foz.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         foz.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new foz.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.o.b($$0.substring($$8[$$11], $$1));
            $$10 = new foz.c($$12, $$11 * 9);
         }

         List<gfe> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new foz.c(0, $$23), new foz.c($$25, $$23 + 9)));
               }
         ...
         return new foz.a($$0, $$10, $$9, $$8, $$4.toArray(new foz.b[0]), $$14.toArray(new gfe[0]));
      }
   }
   ...
   private gfe a(String $$0, fgz $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      foz.c $$8 = new foz.c((int)$$1.a($$6), $$4);
      foz.c $$9 = new foz.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private gfe a(foz.c $$0, foz.c $$1) {
      foz.c $$2 = this.b($$0);
      foz.c $$3 = this.b($$1);
      ...
      return new gfe($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final foz.a a = new foz.a("", new foz.c(0, 0), true, new int[]{0}, new foz.b[]{new foz.b(xw.a, "", 0, 0)}, new gfe[0]);
      ...
      public a(String $$0, foz.c $$1, boolean $$2, int[] $$3, foz.b[] $$4, gfe[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
