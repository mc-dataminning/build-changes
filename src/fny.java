...
public class fny extends anz<fny.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final aex b = new aex("gpu_warnlist.json");
   ...
   protected void a(fny.a $$0, anu $$1, bdp $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(anu $$0, bdp $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
