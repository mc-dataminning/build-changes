...
public class fny extends any<fny.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final aew b = new aew("gpu_warnlist.json");
   ...
   protected fny.a a(ant $$0, bdp $$1) {
      ...
      $$1.b();
      return new fny.a($$2, $$3, $$4);
   }

   protected void a(fny.a $$0, ant $$1, bdp $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(ant $$0, bdp $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eki.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eki.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eki.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
