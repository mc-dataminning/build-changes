enum fhu {
   a(
      ...
      new fhu.a(new ajh("advancements/tab_above_left"), new ajh("advancements/tab_above_middle"), new ajh("advancements/tab_above_right")),
      28,
      32,
      8
   ),
   b(
      ...
      new fhu.a(new ajh("advancements/tab_below_left"), new ajh("advancements/tab_below_middle"), new ajh("advancements/tab_below_right")),
      28,
      32,
      8
   ),
   c(
      ...
      new fhu.a(new ajh("advancements/tab_left_top"), new ajh("advancements/tab_left_middle"), new ajh("advancements/tab_left_bottom")),
      32,
      28,
      5
   ),
   d(
      ...
      new fhu.a(new ajh("advancements/tab_right_top"), new ajh("advancements/tab_right_middle"), new ajh("advancements/tab_right_bottom")),
      32,
      28,
      5
   );

   private final fhu.a e;
   private final fhu.a f;
   private final int g;
   private final int h;
   private final int i;

   private fhu(fhu.a $$0, fhu.a $$1, int $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public void a(fav $$0, int $$1, int $$2, boolean $$3, int $$4) {
      fhu.a $$5 = $$3 ? this.e : this.f;
      ajh $$6;
      if ($$4 == 0) {
         $$6 = $$5.a();
      } else if ($$4 == this.i - 1) {
   ...
   public void a(fav $$0, int $$1, int $$2, int $$3, cqm $$4) {
      int $$5 = $$1 + this.a($$3);
      int $$6 = $$2 + this.b($$3);
      switch (this) {
         case a:
