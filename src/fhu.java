...
public abstract class fhu {
   ...
   public void d(int $$0, int $$1) {
      ...
      gpj $$2 = Objects.requireNonNull(RenderSystem.setShader(gpk.a), "Blit shader not loaded");
      $$2.a("InSampler", this.i);
      fjm $$3 = RenderSystem.getQuadVertices();
      $$3.a();
      $$3.a(RenderSystem.getModelViewMatrix(), RenderSystem.getProjectionMatrix(), RenderSystem.getShader());
      fjm.b();
