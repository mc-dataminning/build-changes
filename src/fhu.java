...
public class fhu {
   ...
   private static final Map<dxz.a, String> e = ac.a(new EnumMap<>(dxz.a.class), $$0 -> {
      $$0.put(dxz.a.a, "SW");
      $$0.put(dxz.a.b, "S");
      $$0.put(dxz.a.c, "OW");
      $$0.put(dxz.a.d, "O");
   ...
   private dun l;
   @Nullable
   private CompletableFuture<dun> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bld r = new bld(1);
   private final bld s = new bld(bli.values().length);
   private final bld t = new bld(1);
   private final bld u = new bld(1);
   private final Map<ble, bld> v = Map.of(ble.a, this.s);
   private final fjd w;
   private final fjf x;
   private final fje y;
   private final fjc z;
   ...
   public fhu(ffn $$0) {
      ...
      this.g = new fhu.a();
      this.h = $$0.h;
      this.w = new fjd(this.h, this.r);
      this.x = new fjf(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fje(this.h, this.t);
      this.z = new fjc(this.h, this.u);
   }
   ...
   private void a(fgz $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         dcd $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof aqk ? ((aqk)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, aye.g($$15.dF()), aye.g($$15.dH())));
         dun $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dcm.a, $$14);
            int $$30 = this.f.r.a(dcm.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dun $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dxz.a $$33 : dxz.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqb $$37 = new bqb($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dco.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btb> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btb.values())
   ...
   private static String a(jj<ddd> $$0) {
   ...
   private dcd r() {
      return (dcd)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private dun s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dvc.n, false).thenApply($$0x -> (dun)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eyz.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffn.Q().aO().k(), ffn.Q().aO().l(), eyz.a()),
            eyz.c(),
            eyz.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evx.a.b) {
            ...
            for (Entry<dtk<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evx.a.b) {
            ...
            for (Entry<dtk<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lq.f.b($$11.ak())));
         }
   ...
   private String a(Entry<dtk<?>, Comparable<?>> $$0) {
      dtk<?> $$1 = $$0.getKey();
