...
public class fhu {
   ...
   private static final Queue<fhu.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fhu.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fhu::a), fhr::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fhu::a), fhr::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fhu.a(this.b) + ", type=" + fhu.b(this.c) + ", severity=" + fhu.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
