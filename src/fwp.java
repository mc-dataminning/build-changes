...
public class fwp {
   ...
   static final ThreadLocal<fwp.d> f = ThreadLocal.withInitial(fwp.d::new);

   public fwp(eys $$0) {
      this.d = $$0;
   }

   public void a(cuu $$0, gjb $$1, dlj $$2, hz $$3, esh $$4, esl $$5, boolean $$6, awp $$7, long $$8, int $$9) {
      boolean $$10 = exo.O() && $$2.h() == 0 && $$1.a();
      enz $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(cuu $$0, gjb $$1, dlj $$2, hz $$3, esh $$4, esl $$5, boolean $$6, awp $$7, long $$8, int $$9) {
      ...
      for (ie $$14 : c) {
         $$7.b($$8);
         List<fwq> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || cys.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<fwq> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(cuu $$0, gjb $$1, dlj $$2, hz $$3, esh $$4, esl $$5, boolean $$6, awp $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      hz.a $$11 = $$3.j();

      for (ie $$12 : c) {
         $$7.b($$8);
         List<fwq> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || cys.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = fvr.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<fwq> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(cuu $$0, dlj $$1, hz $$2, esh $$3, esl $$4, List<fwq> $$5, float[] $$6, BitSet $$7, fwp.b $$8, int $$9) {
      for (fwq $$10 : $$5) {
   ...
   private void a(
      cuu $$0, dlj $$1, hz $$2, esl $$3, esh.a $$4, fwq $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(cuu $$0, dlj $$1, hz $$2, int[] $$3, ie $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(cuu $$0, dlj $$1, hz $$2, int $$3, int $$4, boolean $$5, esh $$6, esl $$7, List<fwq> $$8, BitSet $$9) {
      for (fwq $$10 : $$8) {
         if ($$5) {
   ...
   public void a(esh.a $$0, esl $$1, @Nullable dlj $$2, gjb $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      awp $$9 = awp.a();
      long $$10 = 42L;
   ...
   private static void a(esh.a $$0, esl $$1, float $$2, float $$3, float $$4, List<fwq> $$5, int $$6, int $$7) {
      for (fwq $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = awi.a($$2, 0.0F, 1.0F);
            $$10 = awi.a($$3, 0.0F, 1.0F);
            $$11 = awi.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new fwp.e[]{fwp.e.k, fwp.e.d, fwp.e.k, fwp.e.j, fwp.e.e, fwp.e.j, fwp.e.e, fwp.e.d},
         new fwp.e[]{fwp.e.k, fwp.e.c, fwp.e.k, fwp.e.i, fwp.e.e, fwp.e.i, fwp.e.e, fwp.e.c},
         new fwp.e[]{fwp.e.l, fwp.e.c, fwp.e.l, fwp.e.i, fwp.e.f, fwp.e.i, fwp.e.f, fwp.e.c},
         new fwp.e[]{fwp.e.l, fwp.e.d, fwp.e.l, fwp.e.j, fwp.e.f, fwp.e.j, fwp.e.f, fwp.e.d}
      ),
      b(
         new ie[]{ie.f, ie.e, ie.c, ie.d},
         1.0F,
         true,
         new fwp.e[]{fwp.e.f, fwp.e.d, fwp.e.f, fwp.e.j, fwp.e.l, fwp.e.j, fwp.e.l, fwp.e.d},
         new fwp.e[]{fwp.e.f, fwp.e.c, fwp.e.f, fwp.e.i, fwp.e.l, fwp.e.i, fwp.e.l, fwp.e.c},
         new fwp.e[]{fwp.e.e, fwp.e.c, fwp.e.e, fwp.e.i, fwp.e.k, fwp.e.i, fwp.e.k, fwp.e.c},
         new fwp.e[]{fwp.e.e, fwp.e.d, fwp.e.e, fwp.e.j, fwp.e.k, fwp.e.j, fwp.e.k, fwp.e.d}
      ),
      c(
         new ie[]{ie.b, ie.a, ie.f, ie.e},
         0.8F,
         true,
         new fwp.e[]{fwp.e.b, fwp.e.k, fwp.e.b, fwp.e.e, fwp.e.h, fwp.e.e, fwp.e.h, fwp.e.k},
         new fwp.e[]{fwp.e.b, fwp.e.l, fwp.e.b, fwp.e.f, fwp.e.h, fwp.e.f, fwp.e.h, fwp.e.l},
         new fwp.e[]{fwp.e.a, fwp.e.l, fwp.e.a, fwp.e.f, fwp.e.g, fwp.e.f, fwp.e.g, fwp.e.l},
         new fwp.e[]{fwp.e.a, fwp.e.k, fwp.e.a, fwp.e.e, fwp.e.g, fwp.e.e, fwp.e.g, fwp.e.k}
      ),
      d(
         new ie[]{ie.e, ie.f, ie.a, ie.b},
         0.8F,
         true,
         new fwp.e[]{fwp.e.b, fwp.e.k, fwp.e.h, fwp.e.k, fwp.e.h, fwp.e.e, fwp.e.b, fwp.e.e},
         new fwp.e[]{fwp.e.a, fwp.e.k, fwp.e.g, fwp.e.k, fwp.e.g, fwp.e.e, fwp.e.a, fwp.e.e},
         new fwp.e[]{fwp.e.a, fwp.e.l, fwp.e.g, fwp.e.l, fwp.e.g, fwp.e.f, fwp.e.a, fwp.e.f},
         new fwp.e[]{fwp.e.b, fwp.e.l, fwp.e.h, fwp.e.l, fwp.e.h, fwp.e.f, fwp.e.b, fwp.e.f}
      ),
      e(
         new ie[]{ie.b, ie.a, ie.c, ie.d},
         0.6F,
         true,
         new fwp.e[]{fwp.e.b, fwp.e.d, fwp.e.b, fwp.e.j, fwp.e.h, fwp.e.j, fwp.e.h, fwp.e.d},
         new fwp.e[]{fwp.e.b, fwp.e.c, fwp.e.b, fwp.e.i, fwp.e.h, fwp.e.i, fwp.e.h, fwp.e.c},
         new fwp.e[]{fwp.e.a, fwp.e.c, fwp.e.a, fwp.e.i, fwp.e.g, fwp.e.i, fwp.e.g, fwp.e.c},
         new fwp.e[]{fwp.e.a, fwp.e.d, fwp.e.a, fwp.e.j, fwp.e.g, fwp.e.j, fwp.e.g, fwp.e.d}
      ),
      f(
         new ie[]{ie.a, ie.b, ie.c, ie.d},
         0.6F,
         true,
         new fwp.e[]{fwp.e.g, fwp.e.d, fwp.e.g, fwp.e.j, fwp.e.a, fwp.e.j, fwp.e.a, fwp.e.d},
         new fwp.e[]{fwp.e.g, fwp.e.c, fwp.e.g, fwp.e.i, fwp.e.a, fwp.e.i, fwp.e.a, fwp.e.c},
         new fwp.e[]{fwp.e.h, fwp.e.c, fwp.e.h, fwp.e.i, fwp.e.b, fwp.e.i, fwp.e.b, fwp.e.c},
         new fwp.e[]{fwp.e.h, fwp.e.d, fwp.e.h, fwp.e.j, fwp.e.b, fwp.e.j, fwp.e.b, fwp.e.d}
      );
      ...
      final fwp.e[] k;
      final fwp.e[] l;
      private static final fwp.a[] m = ac.a(new fwp.a[6], $$0 -> {
         $$0[ie.a.d()] = a;
         $$0[ie.b.d()] = b;
         $$0[ie.c.d()] = c;
         $$0[ie.d.d()] = d;
      ...
      private a(ie[] $$0, float $$1, boolean $$2, fwp.e[] $$3, fwp.e[] $$4, fwp.e[] $$5, fwp.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(cuu $$0, dlj $$1, hz $$2, ie $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dlj $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dlj $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dlj $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dlj $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final fwp.c[] k = ac.a(new fwp.c[6], $$0 -> {
         $$0[ie.a.d()] = a;
         $$0[ie.b.d()] = b;
         $$0[ie.c.d()] = c;
         $$0[ie.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dlj $$0, cuu $$1, hz $$2) {
         long $$3 = $$2.a();
         if (this.a) {
