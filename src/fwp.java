public class fwp extends fvb<cug> {
   private static final akv G = akv.b("container/stonecutter/scroller");
   private static final akv H = akv.b("container/stonecutter/scroller_disabled");
   private static final akv I = akv.b("container/stonecutter/recipe_selected");
   private static final akv J = akv.b("container/stonecutter/recipe_highlighted");
   private static final akv K = akv.b("container/stonecutter/recipe");
   private static final akv L = akv.b("textures/gui/container/stonecutter.png");
   ...
   protected void a(fof $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(gmj::H, L, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      int $$6 = (int)(41.0F * this.V);
      akv $$7 = this.H() ? G : H;
      $$0.a(gmj::H, $$7, $$4 + 119, $$5 + 15 + $$6, 12, 15);
      int $$8 = this.C + 52;
      int $$9 = this.D + 14;
      int $$10 = this.X + 12;
      this.a($$0, $$2, $$3, $$8, $$9, $$10);
      ...
      if (this.Y) {
         ...
         for (int $$7 = this.X; $$7 < $$5 && $$7 < $$6.d(); $$7++) {
            ...
            if ($$1 >= $$9 && $$1 < $$9 + 16 && $$2 >= $$10 && $$2 < $$10 + 18) {
               bak $$11 = dcr.a(this.m.s);
               dcq $$12 = $$6.e().get($$7).c().b();
   ...
   private void a(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      for (int $$6 = this.X; $$6 < $$5 && $$6 < this.z.n(); $$6++) {
         ...
         $$0.a(gmj::H, $$11, $$8, $$10 - 1, 16, 18);
      }
   }

   private void a(fof $$0, int $$1, int $$2, int $$3) {
      dbs.b<dcf> $$4 = this.z.m();
      bak $$5 = dcr.a(this.m.s);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (super.a($$0, $$1, $$2, $$3)) {
         ...
         if (this.H()) {
            ...
            this.V = ayz.a(this.V - $$5, 0.0F, 1.0F);
