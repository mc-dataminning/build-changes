...
public class fwp {
   ...
   public static fwr a(BooleanConsumer $$0, BanDetails $$1) {
      return new fwr($$0, a($$1), b($$1), ayh.n, wx.m, true);
   }

   public static fwr a(Runnable $$0) {
      URI $$1 = ayh.n;
      return new fwr($$2 -> {
         if ($$2) {
            af.n().a($$1);
   ...
   public static fwr a(String $$0, Runnable $$1) {
      URI $$2 = ayh.n;
      return new fwr($$2x -> {
         if ($$2x) {
            af.n().a($$2);
