...
public class fwp extends ful {
   ...
   private fot W;
   private fot X;
   private fpa<Boolean> Y;
   private fpa<dol> Z;
   private fpa<Boolean> aa;
   private fpa<Boolean> ab;
   ...
   @Override
   protected void aR_() {
      this.c((fot)fot.a(wo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
      this.c((fot)fot.a(wo.e, $$0x -> this.E()).a(this.n / 2 + 4, 210, 150, 20).a());
      this.B = this.A.k();
      this.C = this.A.s();
      this.D = this.A.u();
      this.E = this.A.v();
      this.F = this.A.D();
      this.G = this.A.E();
      this.R = this.c((fot)fot.a(wp.c("structure_block.button.save"), $$0x -> {
         if (this.A.u() == dyg.a) {
            this.a(dvr.a.b);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 185, 50, 20).a());
      this.S = this.c((fot)fot.a(wp.c("structure_block.button.load"), $$0x -> {
         if (this.A.u() == dyg.b) {
            this.a(dvr.a.c);
            this.m.a(null);
         }
      ...
      this.c(
         fpa.<dyg>a($$0x -> wp.c("structure_block.mode." + $$0x.c()))
            .a(z, y)
            .a()
            .a(this.D)
      ...
      this.X = this.c((fot)fot.a(wp.c("structure_block.button.detect_size"), $$0x -> {
         if (this.A.u() == dyg.a) {
            this.a(dvr.a.d);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 120, 50, 20).a());
      this.Y = this.c(fpa.b(!this.A.v()).a().a(this.n / 2 + 4 + 100, 160, 50, 20, u, ($$0x, $$1x) -> this.A.a(!$$1x)));
      this.Z = this.c(fpa.<dol>a(dol::b).a(dol.values()).a().a(this.B).a(this.n / 2 - 20, 185, 40, 20, wp.b("MIRROR"), ($$0x, $$1x) -> this.A.a($$1x)));
      this.aa = this.c(fpa.b(this.A.D()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, w, ($$0x, $$1x) -> this.A.d($$1x)));
      this.ab = this.c(fpa.b(this.A.E()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, x, ($$0x, $$1x) -> this.A.e($$1x)));
      this.T = this.c((fot)fot.a(wp.b("0"), $$0x -> {
         this.A.a(dqe.a);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.U = this.c((fot)fot.a(wp.b("90"), $$0x -> {
         this.A.a(dqe.b);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.V = this.c((fot)fot.a(wp.b("180"), $$0x -> {
         this.A.a(dqe.c);
         this.F();
      }).a(this.n / 2 + 1 + 20, 185, 40, 20).a());
      this.W = this.c((fot)fot.a(wp.b("270"), $$0x -> {
         this.A.a(dqe.d);
         this.F();
      }).a(this.n / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.H = new fpc(this.p, this.n / 2 - 152, 40, 300, 20, wp.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !fwp.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.H.f(128);
      this.H.a(this.A.c());
      this.d(this.H);
      ji $$0 = this.A.f();
      this.I = new fpc(this.p, this.n / 2 - 152, 80, 80, 20, wp.c("structure_block.position.x"));
      this.I.f(15);
      this.I.a(Integer.toString($$0.u()));
      this.d(this.I);
      this.J = new fpc(this.p, this.n / 2 - 72, 80, 80, 20, wp.c("structure_block.position.y"));
      this.J.f(15);
      this.J.a(Integer.toString($$0.v()));
      this.d(this.J);
      this.K = new fpc(this.p, this.n / 2 + 8, 80, 80, 20, wp.c("structure_block.position.z"));
      this.K.f(15);
      this.K.a(Integer.toString($$0.w()));
      this.d(this.K);
      km $$1 = this.A.j();
      this.L = new fpc(this.p, this.n / 2 - 152, 120, 80, 20, wp.c("structure_block.size.x"));
      this.L.f(15);
      this.L.a(Integer.toString($$1.u()));
      this.d(this.L);
      this.M = new fpc(this.p, this.n / 2 - 72, 120, 80, 20, wp.c("structure_block.size.y"));
      this.M.f(15);
      this.M.a(Integer.toString($$1.v()));
      this.d(this.M);
      this.N = new fpc(this.p, this.n / 2 + 8, 120, 80, 20, wp.c("structure_block.size.z"));
      this.N.f(15);
      this.N.a(Integer.toString($$1.w()));
      this.d(this.N);
      this.O = new fpc(this.p, this.n / 2 - 152, 120, 80, 20, wp.c("structure_block.integrity.integrity"));
      this.O.f(15);
      this.O.a(this.ac.format((double)this.A.w()));
      this.d(this.O);
      this.P = new fpc(this.p, this.n / 2 - 72, 120, 80, 20, wp.c("structure_block.integrity.seed"));
      this.P.f(31);
      this.P.a(Long.toString(this.A.x()));
      this.d(this.P);
      this.Q = new fpc(this.p, this.n / 2 - 152, 120, 240, 20, wp.c("structure_block.custom_data"));
      this.Q.f(128);
      this.Q.a(this.A.t());
      this.d(this.Q);
      this.F();
