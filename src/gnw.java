...
public class gnw {
   ...
   public gnw(gql $$0, dgz $$1, int $$2, gmt $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, kk.b($$2, $$3 + this.b.aq(), $$4));
               }
            }
         }
      }
   ...
   @Nullable
   protected gql.b a(ji $$0) {
      return this.a(kk.c($$0));
   }

   @Nullable
   protected gql.b a(long $$0) {
      int $$1 = kk.b($$0);
      int $$2 = kk.c($$0);
      int $$3 = kk.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gql.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.aq();
