...
public class ayj extends bct {
   public ayj(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bdt.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bdt.s, "minecraft:piston");
