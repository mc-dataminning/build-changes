...
public class ayj implements AutoCloseable {
   ...
   private ayj(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayj.a a(Path $$0) {
         return new ayj.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
