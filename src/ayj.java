...
public class ayj<K> implements jv<K> {
   ...
   private ayj(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> ayj<A> c(int $$0) {
      return new ayj((int)((float)$$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (azm.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public ayj<K> b() {
      return new ayj<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
