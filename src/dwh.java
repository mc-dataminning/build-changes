...
public class dwh extends dus {
   ...
   public dwh(ji $$0, dxq $$1) {
      super(duu.q, $$0, $$1);
   }

   public static void a(final alp $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, alp $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, alp $$1, BooleanSupplier $$2) {
   ...
   protected void b(tq $$0, jt.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (un)dae.a.encodeStart(ue.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", (un)wr.a.encodeStart($$1.a(ue.a), this.m).getOrThrow());
      }
   }
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         dae.a.parse(ue.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = aku.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dgz $$0, ji $$1, dxq $$2, dwh $$3) {
      if ($$2.b(drm.a) && $$2.c(drm.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
   ...
   public static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && azw.f($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
