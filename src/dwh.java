...
public class dwh extends dvq<dyb> {
   private static final Logger a = LogUtils.getLogger();
   private static final bpc<?>[] b = new bpc[]{bpc.aM, bpc.bt, bpc.bt, bpc.aV};
   private static final dmz c = dac.nc.o();

   public dwh(Codec<dyb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dvs<dyb> $$0) {
      Predicate<dmz> $$1 = dvq.a(aun.bI);
      ib $$2 = $$0.e();
      axd $$3 = $$0.d();
      cxu $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.I_() && !$$4.a_($$23.d()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(dac.cv)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, dac.cn.o(), $$1);
                        } else {
                           this.a($$4, $$23, dac.m.o(), $$1);
                        }
                     }
                  } else if (!$$24.a(dac.cv) && !$$24.a(dac.ct)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.u($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, edg.a($$4, $$30, dac.cv.o()), $$1);
                     bnk.a($$4, $$3, $$30, eks.d);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, dac.ct.o(), $$1);
         if ($$4.c_($$2) instanceof dlt $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
