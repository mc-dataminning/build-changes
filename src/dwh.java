...
public class dwh {
   ...
   private final dwh.a g;

   @Deprecated
   public static dwh a(apf $$0, dwh.a $$1) {
      return new dwh($$0, $$1, false);
   }

   public static dwh a(apf $$0, int $$1, double... $$2) {
      return b($$0, new dwh.a($$1, new DoubleArrayList($$2)));
   }

   public static dwh b(apf $$0, dwh.a $$1) {
      return new dwh($$0, $$1, true);
   }

   private dwh(apf $$0, dwh.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<dwh.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(dwh.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(dwh.a::b))
               .apply($$0, dwh.a::new)
      );
      public static final Codec<he<dwh.a>> b = acm.a(jc.ax, a);
