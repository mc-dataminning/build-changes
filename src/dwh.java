...
public class dwh implements dxg<bsq> {
   ...
   private final bpj<Runnable> g;

   public dwh(dwr $$0, aqt $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = bpj.a($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<dxb<bsq>> a(dcb $$0) {
      return this.f.contains($$0.a()) ? CompletableFuture.completedFuture(b($$0)) : this.e.a($$0).thenApplyAsync($$1 -> {
         if ($$1.isEmpty()) {
            ...
            List<bsq> $$6 = bsw.a($$5, this.d).collect(ImmutableList.toImmutableList());
            return new dxb<>($$0, $$6);
         }
      }, this.g::a);
   }

   private static dcb a(ua $$0) {
      int[] $$1 = $$0.n("Position");
      return new dcb($$1[0], $$1[1]);
   }

   private static void a(ua $$0, dcb $$1) {
      $$0.a("Position", new ue(new int[]{$$1.e, $$1.f}));
   }

   private static dxb<bsq> b(dcb $$0) {
      return new dxb<>($$0, ImmutableList.of());
   }

   @Override
   public void a(dxb<bsq> $$0) {
      dcb $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
            this.e.a($$1, null);
