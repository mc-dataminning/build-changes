...
public class ewx extends epd {
   ...
   private void a(uy $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            ewy.b $$9 = ewy.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            ewy.b $$10 = ewy.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            ewy.a $$11 = ewy.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(uy $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         ewz $$5 = ewz.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, ewz.b.d());
            return ewz.b;
         });
         String $$6 = $$3.l("Name");
         xp $$7 = xp.a.a($$3.l("DisplayName"), $$1);
         ewz.a $$8 = ewz.a.a($$3.l("RenderType"));
