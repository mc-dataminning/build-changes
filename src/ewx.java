...
public class ewx {
   ...
   public ewx(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ewx(exc $$0, exc $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ewx a(ejj $$0) {
      return new ewx((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ewx a(exc $$0) {
      return new ewx($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static ewx a(jd $$0, jd $$1) {
      return new ewx(
   ...
   public ewx a(double $$0) {
      return new ewx($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ewx b(double $$0) {
      return new ewx(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ewx c(double $$0) {
      return new ewx(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ewx d(double $$0) {
      return new ewx(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ewx e(double $$0) {
      return new ewx(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ewx f(double $$0) {
      return new ewx(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ewx b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ewx c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ewx d(double $$0, double $$1, double $$2) {
      return new ewx(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ewx f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ewx h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<exc> b(exc $$0, exc $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      ji $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static ewy a(Iterable<ewx> $$0, exc $$1, exc $$2, jd $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ewy($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ji a(ewx $$0, exc $$1, double[] $$2, @Nullable ji $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, ji.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, ji.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, ji.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, ji.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, ji.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, ji.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public exc f() {
      return new exc(ayo.d(0.5, this.a, this.d), ayo.d(0.5, this.b, this.e), ayo.d(0.5, this.c, this.f));
   }

   public exc g() {
      return new exc(ayo.d(0.5, this.a, this.d), this.b, ayo.d(0.5, this.c, this.f));
   }
   ...
   public exc i() {
      return new exc(this.d, this.e, this.f);
   }

   public static ewx a(exc $$0, double $$1, double $$2, double $$3) {
      return new ewx($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
