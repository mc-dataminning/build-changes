...
public class ewx {
   public static List<exz> a(ewx.a... $$0) {
      for (ewx.a $$1 : $$0) {
         a($$1.j);
      }

      List<exz> $$2 = Lists.newArrayList();

      for (ewx.a $$3 : $$0) {
         $$2.add(new exz($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(exz::a));
      return $$2;
   }
   ...
   public static List<exz> a() {
      return a(ewx.a.values());
   }
