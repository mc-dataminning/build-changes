...
public class gpm implements gpf {
   static final Logger c = LogUtils.getLogger();
   public static final MapCodec<gpm> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.list(alf.a).fieldOf("textures").forGetter($$0x -> $$0x.d),
               alf.a.fieldOf("palette_key").forGetter($$0x -> $$0x.f),
               Codec.unboundedMap(Codec.STRING, alf.a).fieldOf("permutations").forGetter($$0x -> $$0x.e)
            )
            .apply($$0, gpm::new)
   );
   private final List<alf> d;
   private final Map<String, alf> e;
   private final alf f;

   private gpm(List<alf> $$0, alf $$1, Map<String, alf> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   public void a(aup $$0, gpf.a $$1) {
      ...
      for (alf $$4 : this.d) {
         ...
         if ($$6.isEmpty()) {
            ...
            gpl $$7 = new gpl($$5, $$6.get(), $$3.size());

            for (Entry<String, Supplier<IntUnaryOperator>> $$8 : $$3.entrySet()) {
               alf $$9 = $$4.e("_" + $$8.getKey());
               $$1.a($$9, new gpm.a($$7, $$8.getValue(), $$9));
            }
         }
      }
   }
      ...
      if ($$1.length != $$0.length) {
         ...
         return $$1x -> {
            ...
            if ($$2x == 0) {
               ...
               int $$3x = ayj.a.e($$1x);
               int $$4x = $$2.getOrDefault($$3x, ayj.a.f($$3x));
               int $$5 = ayj.a.a($$4x);
               return ayj.a.a($$2x * $$5 / 255, $$4x);
            }
         };
      }
   }

   public static int[] a(aup $$0, alf $$1) {
   ...
   static record a(gpl a, Supplier<IntUnaryOperator> b, alf c) implements gpf.b {
      @Nullable
      public gov a(gpe $$0) {
         Object var3;
         try {
            ezb $$1 = this.a.a().a(this.b.get());
            return new gov(this.c, new gqo($$1.a(), $$1.b()), $$1, aur.a);
         } catch (IllegalArgumentException | IOException var7) {
            gpm.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
