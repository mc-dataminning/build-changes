...
public class gqk extends gpj<bvg, gwl> {
   public gqk(gpk.a $$0) {
      super($$0);
   }

   public void a(gwl $$0, fer $$1, gjg $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvg $$0, gwl $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bvg $$0) {
      return false;
   }
}
