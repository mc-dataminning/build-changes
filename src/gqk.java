...
public class gqk {
   private static final grc a = grc.u(alg.b("textures/map/map_background.png"));
   private static final grc b = grc.u(alg.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fpt au;
   private final hiz av = new hiz();
   private czn aw = czn.k;
   private czn ax = czn.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gww aC;
   private final gxw aD;
   private final hgg aE;

   public gqk(fpt $$0, gww $$1, gxw $$2, hgg $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bxj $$0, czn $$1, czl $$2, fkd $$3, gqr $$4, int $$5) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$0.dU(), $$5, hjg.d, $$0.ao() + $$2.ordinal());
      }
   }
   ...
   private void a(fkd $$0, gqr $$1, int $$2, bxa $$3) {
      hcf $$4 = (hcf)this.aC.<gpl>a(this.au.t);
      $$0.a();
      ...
      alg $$6 = this.au.t.c().a();
      if ($$3 == bxa.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cro.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cro.c));
      }

      $$0.b();
   }

   private void a(fkd $$0, gqr $$1, int $$2, float $$3, bxa $$4, float $$5, czn $$6) {
   ...
   private void a(fkd $$0, gqr $$1, int $$2, czn $$3) {
      ...
      eyt $$4 = $$3.a(kk.M);
      eyv $$5 = daa.a($$4, this.au.s);
      fkh $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fkd $$0, gqr $$1, int $$2, float $$3, float $$4, bxa $$5) {
      boolean $$6 = $$5 != bxa.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azm.c($$4);
      ...
      hcf $$15 = (hcf)this.aC.<gpl>a($$14);
      alg $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cro.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cro.c));
      }
   }

   private void a(fkd $$0, float $$1, bxa $$2, czn $$3, crm $$4) {
   ...
   private void a(fkd $$0, float $$1, bxa $$2, czn $$3, crm $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fkd $$0, bxa $$1, float $$2) {
      int $$3 = $$1 == bxa.b ? 1 : -1;
   ...
   private void b(fkd $$0, bxa $$1, float $$2) {
      int $$3 = $$1 == bxa.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fkd $$1, gqr.a $$2, gpo $$3, int $$4) {
      float $$5 = $$3.D($$0);
   ...
   @VisibleForTesting
   static gqk.a a(gpo $$0) {
      czn $$1 = $$0.fa();
      czn $$2 = $$0.fb();
      boolean $$3 = $$1.a(czr.pj) || $$2.a(czr.pj);
      boolean $$4 = $$1.a(czr.xg) || $$2.a(czr.xg);
      if (!$$3 && !$$4) {
         return gqk.a.a;
      } else if ($$0.fy()) {
         return b($$0);
      } else {
         return a($$1) ? gqk.a.b : gqk.a.a;
      }
   }

   private static gqk.a b(gpo $$0) {
      czn $$1 = $$0.fA();
      buf $$2 = $$0.fz();
      if (!$$1.a(czr.pj) && !$$1.a(czr.xg)) {
         return $$2 == buf.a && a($$0.fb()) ? gqk.a.b : gqk.a.a;
      } else {
         return gqk.a.a($$2);
      }
   }
   ...
   private static boolean a(czn $$0) {
      return $$0.a(czr.xg) && cyg.g($$0);
   }

   private void a(gpl $$0, float $$1, float $$2, buf $$3, float $$4, czn $$5, float $$6, fkd $$7, gqr $$8, int $$9) {
      if (!$$0.gG()) {
         boolean $$10 = $$3 == buf.a;
         ...
         if ($$5.f()) {
            ...
            this.a($$0, $$5, $$13 ? czl.e : czl.d, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bxa.b;
            int $$21 = $$20 ? 1 : -1;
            ...
            this.a($$0, $$5, $$20 ? czl.e : czl.d, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, fkd $$2, int $$3, bxa $$4) {
   ...
   private boolean a(czn $$0, czn $$1) {
      return czn.a($$0, $$1) ? true : !this.aE.a($$1);
   }
