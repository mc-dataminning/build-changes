...
public class gqk {
   ...
   public gqk(hkh $$0, hki $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(hit $$0, fjy $$1, gqm $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fkc $$6 = $$2.getBuffer(gqx.u($$0.a));
      ...
      for (hit.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fsf.a.a, Integer.MIN_VALUE, $$4, false);
               $$1.b();
            }
   ...
   public void a(eyo $$0, eyq $$1, hit $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
