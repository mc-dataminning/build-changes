...
public class aoo {
   ...
   private static int a(ex $$0, ji $$1, go $$2, aoo.b $$3, @Nullable Predicate<dxa> $$4) throws CommandSyntaxException {
      ard $$5 = $$0.e();
      if ($$4 != null && !$$4.test(new dxa($$5, $$1, true))) {
         throw a.create();
      } else {
         boolean $$6;
         if ($$3 == aoo.b.b) {
   ...
   public interface a {
      @Nullable
      go filter(end var1, ji var2, go var3, ard var4);
   }
