...
class aoo extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aon && $$1 instanceof aon && $$0.equals($$1);
   }
   ...
   private static aon a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aon) {
         return (aon)$$0;
      } else {
