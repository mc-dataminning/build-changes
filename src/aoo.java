...
public class aoo extends aok {
   ...
   private final aoo.b d;
   private final String e;

   aoo(String $$0, aoo.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aor $$0, ahd $$1) {
   ...
   @Nullable
   private apu<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : apu.create($$1, $$2);
      }
   }
   ...
   public static class a implements apk.c {
      ...
      public aoq a(String $$0) {
         aoo.b $$1 = new aoo.b(this.a);
         return new aoo($$0, $$1, this.b, "");
      }

      @Override
      public aoq a(String $$0, apk.a $$1) {
         aoo.b $$2 = new aoo.b(this.a);
         aoq $$3 = new aoo($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aoq> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aoo($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aoo.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
