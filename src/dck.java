...
public abstract class dck extends dcp implements bhh, cfx, cgg {
   ...
   protected hn<cjf> m = hn.a(3, cjf.b);
   int u;
   int v;
   int w;
   int x;
   ...
   private final Object2IntOpenHashMap<aew> y = new Object2IntOpenHashMap();
   ...
   private static void a(Map<cja, Integer> $$0, aqh<cja> $$1, int $$2) {
      for (he<cja> $$3 : jb.i.c($$1)) {
         if (!b($$3.a())) {
            $$0.put($$3.a(), $$2);
         }
      }
   ...
   private static boolean a(hr $$0, @Nullable cmk<?> $$1, hn<cjf> $$2, int $$3) {
      if (!$$2.get(0).b() && $$1 != null) {
         cjf $$4 = $$1.b().a($$0);
         if ($$4.b()) {
            return false;
   ...
   private static boolean b(hr $$0, @Nullable cmk<?> $$1, hn<cjf> $$2, int $$3) {
      if ($$1 != null && a($$0, $$1, $$2, $$3)) {
         cjf $$4 = $$2.get(0);
         cjf $$5 = $$1.b().a($$0);
         cjf $$6 = $$2.get(2);
   ...
   public boolean b(int $$0, cjf $$1, ha $$2) {
      return $$2 == ha.a && $$0 == 1 ? $$1.a(cji.pL) || $$1.a(cji.pK) : true;
   }
   ...
   public List<cmk<?>> a(akq $$0, ehn $$1) {
      List<cmk<?>> $$2 = Lists.newArrayList();
      ObjectIterator var4 = this.y.object2IntEntrySet().iterator();

      while (var4.hasNext()) {
         Entry<aew> $$3 = (Entry<aew>)var4.next();
         $$0.q().a((aew)$$3.getKey()).ifPresent($$4 -> {
            $$2.add((cmk<?>)$$4);
   ...
   private static void a(akq $$0, ehn $$1, int $$2, float $$3) {
      int $$4 = arw.d((float)$$2 * $$3);
      float $$5 = arw.h((float)$$2 * $$3);
