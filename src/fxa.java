...
public class fxa extends fuk {
   ...
   protected void aR_() {
      ...
      this.c(this.s);
      this.z = this.c(fos.a(wp.c("selectServer.select"), $$0 -> this.m()).a(100).a());
      fos $$1 = this.c(fos.a(wp.c("selectServer.direct"), $$0 -> {
         this.B = new ggn(hfz.a("selectServer.defaultName"), "", ggn.c.c);
         this.m.a(new ftq(this, this::h, this.B));
      }).a(100).a());
      fos $$2 = this.c(fos.a(wp.c("selectServer.add"), $$0 -> {
         this.B = new ggn(hfz.a("selectServer.defaultName"), "", ggn.c.c);
         this.m.a(new fts(this, this::g, this.B));
      }).a(100).a());
      this.y = this.c(fos.a(wp.c("selectServer.edit"), $$0 -> {
         fxe.a $$1x = this.s.p();
      ...
      this.A = this.c(fos.a(wp.c("selectServer.delete"), $$0 -> {
         fxe.a $$1x = this.s.p();
         if ($$1x instanceof fxe.d) {
      ...
      fos $$3 = this.c(fos.a(wp.c("selectServer.refresh"), $$0 -> this.H()).a(74).a());
      fos $$4 = this.c(fos.a(wo.k, $$0 -> this.aO_()).a(74).a());
      fsk $$5 = fsk.d();
