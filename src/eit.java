...
public class eit extends eiy {
   ...
   public List<ehg.a> a(dem $$0, BiConsumer<je, duo> $$1, azl $$2, int $$3, je $$4, egq $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azd.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azd.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eit.a> $$13 = Lists.newArrayList();
      $$13.add(new eit.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               je $$21 = $$4.b(azd.a($$19), $$12 - 1, azd.a($$20));
               je $$22 = $$21.b(5);
      ...
      List<ehg.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dem $$0, BiConsumer<je, duo> $$1, azl $$2, je $$3, je $$4, boolean $$5, egq $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            je $$13 = $$3.b(azd.d(0.5F + (float)$$12 * $$9), azd.d(0.5F + (float)$$12 * $$10), azd.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dnw.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dem $$0, BiConsumer<je, duo> $$1, azl $$2, int $$3, je $$4, List<eit.a> $$5, egq $$6) {
      for (eit.a $$7 : $$5) {
         int $$8 = $$7.a();
