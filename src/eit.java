...
public class eit implements eis {
   ...
   public static final Codec<eit> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               edf.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               edh.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               edg.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bsj.b(1, 20).fieldOf("outer_wall_distance").orElse(bsp.a(4, 5)).forGetter($$0x -> $$0x.i),
               bsj.b(1, 20).fieldOf("distribution_points").orElse(bsp.a(3, 4)).forGetter($$0x -> $$0x.j),
               bsj.b(0, 10).fieldOf("point_offset").orElse(bsp.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public eit(edf $$0, edh $$1, edg $$2, double $$3, double $$4, boolean $$5, bsj $$6, bsj $$7, bsj $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
