...
public class bfc extends bbf {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfc::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfc::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfc::k);
         $$0 = this.a($$0, "minecraft:fox", bfc::j);
         $$0 = this.a($$0, "minecraft:item", bfc::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfc::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfc::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfc::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfc::e);
         return this.a($$0, "minecraft:piglin", bfc::d);
      });
   }
