...
public class bfc extends DataFix {
   private static final Int2ObjectMap<String> a = ad.a(new Int2ObjectOpenHashMap(), $$0 -> {
   ...
   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = a($$0, "Id", "id");
      $$0 = azu.a($$0, "Ambient", "ambient");
      $$0 = azu.a($$0, "Amplifier", "amplifier");
      $$0 = azu.a($$0, "Duration", "duration");
      $$0 = azu.a($$0, "ShowParticles", "show_particles");
      $$0 = azu.a($$0, "ShowIcon", "show_icon");
      Optional<Dynamic<T>> $$1 = $$0.get("HiddenEffect").result().map(bfc::a);
      return azu.a($$0, "HiddenEffect", "hidden_effect", $$1);
   }

   private static <T> Dynamic<T> b(Dynamic<T> $$0, String $$1, String $$2) {
      Optional<Dynamic<T>> $$3 = $$0.get($$1).asStreamOpt().result().map($$1x -> $$0.createList($$1x.map(bfc::a)));
      return azu.a($$0, $$1, $$2, $$3);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0, Dynamic<T> $$1) {
      $$1 = a($$0, "EffectId", $$1, "id");
      Optional<Dynamic<T>> $$2 = $$0.get("EffectDuration").result();
      return azu.a($$1, "EffectDuration", "duration", $$2);
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getInputSchema().getType(bgf.s);
      return this.fixTypeEverywhereTyped("BlockEntityMobEffectIdFix", $$0, $$0x -> this.a($$0x, bgf.s, "minecraft:beacon", $$0xx -> {
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getInputSchema().getType(bgf.z);
      return this.fixTypeEverywhereTyped("EntityMobEffectIdFix", $$0, $$0x -> {
         $$0x = this.a($$0x, bgf.z, "minecraft:mooshroom", bfc::c);
         $$0x = this.a($$0x, bgf.z, "minecraft:arrow", bfc::d);
         $$0x = this.a($$0x, bgf.z, "minecraft:area_effect_cloud", bfc::e);
         return $$0x.update(DSL.remainderFinder(), bfc::f);
      });
   }

   private TypeRewriteRule c() {
      Type<?> $$0 = this.getInputSchema().getType(bgf.b);
      return this.fixTypeEverywhereTyped("PlayerMobEffectIdFix", $$0, $$0x -> $$0x.update(DSL.remainderFinder(), bfc::f));
   }

   private static <T> Dynamic<T> g(Dynamic<T> $$0) {
      Optional<Dynamic<T>> $$1 = $$0.get("Effects").asStreamOpt().result().map($$1x -> $$0.createList($$1x.map(bfc::b)));
      return azu.a($$0, "Effects", "effects", $$1);
   }

   private TypeRewriteRule d() {
      OpticFinder<Pair<String, String>> $$0 = DSL.fieldFinder("id", DSL.named(bgf.B.typeName(), bhp.a()));
      ...
      return this.fixTypeEverywhereTyped("ItemStackMobEffectIdFix", $$1, $$2x -> {
         ...
         if ($$3.isPresent()) {
            ...
            if ($$4.equals("minecraft:suspicious_stew")) {
               return $$2x.updateTyped($$2, $$0xx -> $$0xx.update(DSL.remainderFinder(), bfc::g));
            }
