...
public class bfc implements bev {
   ...
   public static Set<bet> a() {
      Builder<bet> $$0 = ImmutableSet.builder();

      try {
         bfc.a $$1 = new bfc.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bet.a("cpu#" + $$1x, bes.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bet.a("heap MiB", bes.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(beu.a.a());
      return $$0.build();
   }
   ...
   public static bet a(final LongSupplier $$0) {
      ...
      bet.d $$3 = new bet.d(2.0F);
      return bet.a("ticktime", bes.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
