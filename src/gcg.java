public class gcg extends ftr<gcg.a> {
   ...
   public gcg(fpo $$0, gcf $$1, int $$2, int $$3, wy $$4) {
   ...
   public static class a extends ftr.a<gcg.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final gcg e;
      protected final fpo a;
      private final gce.a f;
      private final ayy g;
      private final fto h;
      private final ayy i;
      private final fto j;

      public a(fpo $$0, gcg $$1, gce.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static ayy a(fpo $$0, wy $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fto b(fpo $$0, wy $$1) {
         return fto.a($$0.h, 157, 2, $$1);
      }
      ...
      public void a(fsh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(gqx::H, this.f.a(), $$3, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
         ayy $$12 = this.g;
         fto $$13 = this.h;
         if (this.d() && (this.a.n.ac().c() || $$8 || this.e.p() == this && this.e.aJ_())) {
            ...
            if (this.f.o()) {
               if ($$14 < 32) {
                  $$0.a(gqx::H, gcg.a, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gqx::H, gcg.m, $$3, $$2, 32, 32);
               }
            } else {
               if (this.f.p()) {
                  if ($$14 < 16) {
                     $$0.a(gqx::H, gcg.n, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gqx::H, gcg.o, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.q()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 < 16) {
                     $$0.a(gqx::H, gcg.p, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gqx::H, gcg.q, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.r()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 > 16) {
                     $$0.a(gqx::H, gcg.r, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gqx::H, gcg.s, $$3, $$2, 32, 32);
                  }
               }
            }
         }
