...
public class gcg {
   ...
   private gcg(int $$0, List<gci> $$1) {
      this.a = $$1.toArray(gci[]::new);
      this.b = $$1.size();
   }

   private List<gci> c() {
      List<gci> $$0 = new ArrayList<>(this.d());
