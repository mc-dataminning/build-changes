...
public class gcg {
   private static final gcs a = gcs.t(new akn("textures/map/map_background.png"));
   private static final gcs b = gcs.t(new akn("textures/map/map_background_checkerboard.png"));
   ...
   private final feb au;
   private ctq av = ctq.i;
   private ctq aw = ctq.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   ...
   public gcg(feb $$0, ghr $$1, gir $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bsq $$0, ctq $$1, ctn $$2, boolean $$3, eyu $$4, gck $$5, int $$6) {
      if (!$$1.e()) {
   ...
   private float a(float $$0) {
      ...
      $$1 = ayf.a($$1, 0.0F, 1.0F);
      return -ayf.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(eyu $$0, gck $$1, int $$2, bsk $$3) {
      gmy $$4 = (gmy)this.aB.<gbj>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bsk.b ? 1.0F : -1.0F;
   ...
   private void a(eyu $$0, gck $$1, int $$2, float $$3, bsk $$4, float $$5, ctq $$6) {
      float $$7 = $$4 == bsk.b ? 1.0F : -1.0F;
      ...
      float $$8 = ayf.c($$5);
      float $$9 = ayf.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * ayf.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * ayf.a($$5 * (float) Math.PI);
   ...
   private void a(eyu $$0, gck $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayf.c($$5);
      float $$7 = -0.2F * ayf.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * ayf.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = ayf.a($$6 * (float) Math.PI);
   ...
   private void a(eyu $$0, gck $$1, int $$2, ctq $$3) {
      ...
      eoj $$4 = $$3.a(kb.A);
      eol $$5 = cty.a($$4, this.au.r);
      eyy $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(eyu $$0, gck $$1, int $$2, float $$3, float $$4, bsk $$5) {
      boolean $$6 = $$5 != bsk.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayf.c($$4);
      float $$9 = -0.3F * ayf.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * ayf.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * ayf.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = ayf.a($$4 * $$4 * (float) Math.PI);
      float $$13 = ayf.a($$8 * (float) Math.PI);
   ...
   private void a(eyu $$0, float $$1, bsk $$2, ctq $$3) {
      float $$4 = (float)this.au.s.fy() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.u();
      if ($$5 < 0.8F) {
         float $$6 = ayf.e(ayf.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(eyu $$0, float $$1, bsk $$2, ctq $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * ayf.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bsk.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(eyu $$0, bsk $$1, float $$2) {
      int $$3 = $$1 == bsk.b ? 1 : -1;
      float $$4 = ayf.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = ayf.a(ayf.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(eyu $$0, bsk $$1, float $$2) {
      int $$3 = $$1 == bsk.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, eyu $$1, gck.a $$2, gbm $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bpv $$6 = (bpv)MoreObjects.firstNonNull($$3.aK, bpv.a);
      float $$7 = ayf.i($$0, $$3.P, $$3.dH());
      gcg.a $$8 = a($$3);
      float $$9 = ayf.i($$0, $$3.cG, $$3.cE);
      float $$10 = ayf.i($$0, $$3.cF, $$3.cD);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bpv.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ayf.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bpv.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bpv.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ayf.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bpv.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   static gcg.a a(gbm $$0) {
      ctq $$1 = $$0.eX();
      ctq $$2 = $$0.eY();
      boolean $$3 = $$1.a(ctt.ou) || $$2.a(ctt.ou);
      boolean $$4 = $$1.a(ctt.vT) || $$2.a(ctt.vT);
      if (!$$3 && !$$4) {
         return gcg.a.a;
      } else if ($$0.fv()) {
         return b($$0);
   ...
   private static gcg.a b(gbm $$0) {
      ctq $$1 = $$0.fx();
      bpv $$2 = $$0.fw();
      if (!$$1.a(ctt.ou) && !$$1.a(ctt.vT)) {
         return $$2 == bpv.a && a($$0.eY()) ? gcg.a.b : gcg.a.a;
      } else {
         return gcg.a.a($$2);
      }
   }
   ...
   private static boolean a(ctq $$0) {
      return $$0.a(ctt.vT) && csd.j($$0);
   }

   private void a(gbj $$0, float $$1, float $$2, bpv $$3, float $$4, ctq $$5, float $$6, eyu $$7, gck $$8, int $$9) {
      if (!$$0.gA()) {
         boolean $$10 = $$3 == bpv.a;
         bsk $$11 = $$10 ? $$0.fu() : $$0.fu().e();
         $$7.a();
         if ($$5.e()) {
            if ($$10 && !$$0.ch()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fv() && $$0.fy() > 0 && $$0.fw() == $$3) {
               ...
               float $$16 = $$15 / (float)csd.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = ayf.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * ayf.a(ayf.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * ayf.a(ayf.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * ayf.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? ctn.e : ctn.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bsk.b;
            if ($$0.fv() && $$0.fy() > 0 && $$0.fw() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * ayf.a(ayf.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * ayf.a(ayf.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * ayf.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? ctn.e : ctn.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = ayf.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = ayf.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + ayf.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + ayf.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
