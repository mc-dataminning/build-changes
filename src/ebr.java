...
public class ebr {
   ...
   private double j;
   int k = 29999984;
   private ebr.a l = new ebr.d(5.999997E7F);
   public static final ebr.c d = new ebr.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(iu $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(fei $$0) {
   ...
   public fei c(double $$0, double $$1, double $$2) {
      return new fei(azm.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azm.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (ebr.a)($$0 == $$1 ? new ebr.d($$1) : new ebr.b($$0, $$1, $$2));
   ...
   class b implements ebr.a {
      ...
      @Override
      public double a() {
         return azm.a(ebr.this.a() - this.e() / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
      }

      @Override
      public double c() {
         return azm.a(ebr.this.b() - this.e() / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
      }
      ...
      @Override
      public ebq i() {
         return this.c < this.b ? ebq.b : ebq.a;
      }
      ...
      @Override
      public ebr.a l() {
         return (ebr.a)(this.g() <= 0L ? ebr.this.new d(this.c) : this);
      }
      ...
      public ffc m() {
         return fez.a(
            fez.c,
            fez.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fem.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static ebr.c a(DynamicLike<?> $$0, ebr.c $$1) {
         ...
         return new ebr.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements ebr.a {
      ...
      private void n() {
         this.c = azm.a(ebr.this.a() - this.b / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
         this.d = azm.a(ebr.this.b() - this.b / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
         this.e = azm.a(ebr.this.a() + this.b / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
         this.f = azm.a(ebr.this.b() + this.b / 2.0, (double)(-ebr.this.k), (double)ebr.this.k);
         this.g = fez.a(
            fez.c,
            fez.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fem.e
