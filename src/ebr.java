...
public class ebr extends ebl<edq> {
   private static final jf[] a = jf.values();

   public ebr(Codec<edq> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebn<edq> $$0) {
      edq $$1 = $$0.f();
      ayo $$2 = $$0.d();
      ja $$3 = $$0.e();
      ddc $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dzf $$9 = new dzf(new dyh($$4.C()));
      enm $$10 = enm.a($$9, -4, 1.0);
      ...
      for (ja $$44 : $$31) {
         ...
         for (jf $$46 : a) {
            ...
            dsl $$48 = $$4.a_($$47);
            if ($$45.b(dtb.C)) {
               $$45 = $$45.a(dtb.C, Boolean.valueOf($$48.u().b()));
            }
