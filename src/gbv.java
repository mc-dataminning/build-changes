...
public class gbv extends fti {
   private static final ftp c = new ftp(alg.b("recipe_book/tab"), alg.b("recipe_book/tab_selected"));
   private final gbt.a d;
   ...
   public void a(foc $$0, boolean $$1) {
      gbx.a $$2 = $$1 ? gbx.a.b : gbx.a.a;

      for (gbx $$4 : $$0.a(this.d.c())) {
         for (dew $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(fro $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(gqc::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
