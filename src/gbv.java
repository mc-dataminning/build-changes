public class gbv extends gdu {
   ...
   gbv(fzn $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gdp $$7) {
      super($$0, $$1, $$2, $$3);
      this.B = 0.96F;
      this.j = $$4;
      this.k = $$5;
      this.l = $$6;
      this.v = aym.a(this.r, 0.7176471F, 0.8745098F);
      this.w = aym.a(this.r, 0.0F, 0.0F);
      this.x = aym.a(this.r, 0.8235294F, 0.9764706F);
      this.D *= 0.75F;
