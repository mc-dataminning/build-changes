...
public class gbv {
   public static class a implements gco<lq> {
      ...
      public gcl a(lq $$0, fzd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbv.b $$8 = new gbv.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gdl {
      b(fzd $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * ayo.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gcx {
      private boolean b;
      private boolean F;
      private final gcn G;
      private float H;
      ...
      c(fzd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gcn $$7, gdg $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gbv.c $$0 = new gbv.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gco<lq> {
      ...
      public gcl a(lq $$0, fzd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbv.c $$8 = new gbv.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fgm.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gcj {
      ...
      private int D;
      private final gcn E;
      private final List<cxl> F;
      private boolean G;

      public e(fzd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gcn $$7, List<cxl> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gcl $$12 = this.E.a(lm.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axy.b.b($$11) / 255.0F, (float)axy.b.c($$11) / 255.0F, (float)axy.b.d($$11) / 255.0F);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gbv.c $$10 = (gbv.c)this.E.a(lm.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = ayo.d($$18, $$13, $$16) * $$0;
                  double $$20 = ayo.d($$18, $$14, $$17) * $$0;
