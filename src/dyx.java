...
public class dyx {
   ...
   private final dca p;
   private static final List<dez> q = List.of(dfb.l, dfb.L, dfb.i, dfb.b, dfb.k, dfb.I, dfb.K, dfb.fl, dfb.dP, dfb.iA, dfb.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ji<dcx>>> t;
   ...
   public static final Codec<dyx> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dyx::a, Function.identity());

   private static DataResult<dyx> a(dyx $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dyx(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ji<dcx>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kb.c($$0);
      int $$5 = kb.c($$1) - $$4;
   ...
   @Nullable
   public static dyx a(arm $$0, int $$1, int $$2) {
      dty $$3 = $$0.a($$1, $$2);
      dyx $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dux.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jf> a(dct $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dty $$1, int $$2, int $$3) {
   ...
   private int a(dty $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxu.a.a)) {
         $$3 = Math.min($$0.a(dxu.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(dty $$0, iz.a $$1) {
      return a($$0, (iz)$$1.c(je.a)) ? 1.0 : -1.0;
   }

   private static double b(dty $$0, iz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dty $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ji<dcx>> b(dty $$0, int $$1, int $$2) {
      ObjectArrayList<ji<dcx>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dty $$0, iz $$1) {
      dsc $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awp.O)) {
         ...
         return $$2.a(dfb.eT) || $$2.a(dfb.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dyx.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dyx.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ji<dcx> var3);
   }
