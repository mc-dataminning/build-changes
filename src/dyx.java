...
public class dyx extends dza<dyw> {
   public dyx(Codec<dyw> $$0) {
      super($$0);
   }

   public boolean a(dyw $$0, aym $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dyv $$0, dyw $$1, dsz $$2, Function<io, ix<dby>> $$3, aym $$4, dwh $$5, dag $$6, dsy $$7) {
      int $$8 = jq.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dza.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dyv $$0, dyw $$1, dsz $$2, Function<io, ix<dby>> $$3, dwh $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dsy $$10, dza.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayf.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayf.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayf.b($$13);
         $$6 += (double)(ayf.b($$12) * $$27);
         $$7 += (double)ayf.a($$13);
         $$8 += (double)(ayf.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
