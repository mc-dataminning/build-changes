...
public class dyx {
   private static final dyx a = new dyx(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dyx.a a(int $$0, int $$1) {
         return new dyx.a(1.0, 0.0);
      }
   ...
   private static final emz b = emz.b(new dyw(42L), rg.a);
   ...
   private final Long2ObjectOpenHashMap<dyy> h;
   private final Long2ObjectOpenHashMap<dyy> i;

   public static dyx a() {
      return a;
   }

   public static dyx a(@Nullable arm $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dbg $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dyy> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dyy> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayz.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dyx($$2, $$3);
         }
      }
   }

   dyx(Long2ObjectOpenHashMap<dyy> $$0, Long2ObjectOpenHashMap<dyy> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dyx.a a(int $$0, int $$1) {
      int $$2 = jt.a($$0);
      int $$3 = jt.a($$1);
      double $$4 = this.a($$2, 0, $$3, dyy::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dyx.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jt.d(dbg.a($$5x)), jt.d(dbg.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(dxo.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jt.d(dbg.a($$6x)), jt.d(dbg.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, dyx.b $$3) {
      int $$4 = jt.e($$0);
      int $$5 = jt.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dyx.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dyy $$6 = (dyy)this.h.get(dbg.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jt.d($$1), $$4, $$5 - jt.d($$2)) : Double.MAX_VALUE;
   }

   public ddb a(ddb $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ji<dcy> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ji<dcy> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ji<dcy>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jt.d(dbg.a($$5x)), $$1, jt.d(dbg.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(arm $$0, dtz $$1) {
      dbg $$2 = $$1.f();
      boolean $$3 = $$1.s();
      iz.a $$4 = new iz.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dxv.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dtz $$0, iz $$1) {
      dsd $$2 = $$0.a_($$1);
      if ($$2.a(awp.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(dcu $$0, dut $$1) {
      dbg $$2 = $$1.f();
      Builder<jf, dyy> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dxr.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dyx.c a(@Nullable dyy $$0, Map<jf, dyy> $$1) {
      List<dyx.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dyx.c a(@Nullable jf $$0, dyy $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (je $$4 : $$0.a()) {
   ...
   interface b {
      double get(dyy var1, int var2, int var3, int var4);
   }
