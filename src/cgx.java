...
public abstract class cgx extends bub {
   ...
   protected cgx(bur<? extends cgx> $$0, dgh $$1) {
      super($$0, $$1);
      this.a(etp.n, 16.0F);
      this.a(etp.o, -1.0F);
   }
   ...
   public float a(ji $$0, dgk $$1) {
      return $$1.a_($$0.e()).a(djn.i) ? 10.0F : $$1.w($$0);
   }
   ...
   public static boolean b(bur<? extends cgx> $$0, dgi $$1, buq $$2, ji $$3, azh $$4) {
      boolean $$5 = buq.b($$2) || a($$1, $$3);
      return $$1.a_($$3.e()).a(awp.bY) && $$5;
   }

   protected static boolean a(dfj $$0, ji $$1) {
      return $$0.b($$1, 0) > 8;
   }
   ...
   public abstract boolean j(cwo var1);
   ...
   public void a(ard $$0, cgx $$1, @Nullable bub $$2) {
      ...
      $$0.a(this, (byte)18);
      if ($$0.O().b(dgd.f)) {
         $$0.b(new buw($$0, this.dA(), this.dC(), this.dG(), this.dY().a(7) + 1));
      }
   }
