...
public class bar extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bhv.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bar::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bar::a);
      return this.a($$0, "minecraft:trident", bar::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bhv.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bhv.B, $$1);
