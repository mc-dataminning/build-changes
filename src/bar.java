...
public class bar extends bdh {
   public bar(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", beh.y, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(beh.A.typeName(), bfq.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(beh.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(beh.A.typeName(), "minecraft:saddle"));
