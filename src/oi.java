...
public class oi {
   ...
   public static oi a(dez $$0) {
      alf $$1 = G($$0);
      return b($$1);
   }

   public static oi b(dez $$0) {
      alf $$1 = G($$0);
      return a($$1);
   }
   ...
   public static oi f(dez $$0) {
      return d(oj.t, G($$0));
   }

   public static oi g(dez $$0) {
   ...
   public static oi h(dez $$0) {
      return d(oj.y, G($$0));
   }

   public static oi a(dez $$0, dez $$1) {
      return new oi().a(oj.y, G($$0)).a(oj.z, G($$1));
   }

   public static oi i(dez $$0) {
      return d(oj.u, G($$0));
   }

   public static oi j(dez $$0) {
      return d(oj.x, G($$0));
   }
   ...
   public static oi b(dez $$0, dez $$1) {
   ...
   public static oi t(dez $$0) {
      return new oi().a(oj.f, a($$0, "_top")).a(oj.e, a($$0, "_bottom"));
   }

   public static oi u(dez $$0) {
   ...
   public static oi v(dez $$0) {
      return new oi().a(oj.C, a($$0, "_0"));
   }

   public static oi w(dez $$0) {
      return new oi().a(oj.C, a($$0, "_1"));
   }

   public static oi x(dez $$0) {
      return new oi().a(oj.D, G($$0));
   }

   public static oi y(dez $$0) {
   ...
   public static oi a(dez $$0, String $$1, String $$2) {
      return new oi().a(oj.i, a($$0, $$1)).a(oj.f, a($$0, $$2)).a(oj.e, a($$0, "_bottom"));
   }

   public static oi a(dez $$0, String $$1, String $$2, String $$3, String $$4) {
      return new oi().a(oj.g, a($$0, $$1)).a(oj.i, a($$0, $$2)).a(oj.f, a($$0, $$3)).a(oj.e, a($$0, $$4));
   }

   public static oi a(cuk $$0) {
      return new oi().a(oj.c, c($$0));
   }

   public static oi z(dez $$0) {
   ...
   public static oi c(dez $$0, dez $$1) {
      return new oi()
         .a(oj.c, a($$0, "_front"))
         .a(oj.o, G($$1))
         .a(oj.n, a($$0, "_top"))
   ...
   public static oi d(dez $$0, dez $$1) {
      return new oi()
         .a(oj.c, a($$0, "_front"))
         .a(oj.o, G($$1))
         .a(oj.n, a($$0, "_top"))
   ...
   public static oi a(String $$0) {
      return new oi()
         .a(oj.c, a(dfb.mg, $$0 + "_north"))
         .a(oj.e, a(dfb.mg, $$0 + "_bottom"))
         .a(oj.f, a(dfb.mg, $$0 + "_top"))
         .a(oj.j, a(dfb.mg, $$0 + "_north"))
         .a(oj.k, a(dfb.mg, $$0 + "_south"))
         .a(oj.l, a(dfb.mg, $$0 + "_east"))
         .a(oj.m, a(dfb.mg, $$0 + "_west"));
   }
   ...
   public static oi a(dez $$0, boolean $$1) {
      return new oi()
         .a(oj.c, a(dfb.eg, "_side"))
         .a(oj.e, a(dfb.eg, "_bottom"))
         .a(oj.f, a(dfb.eg, "_top"))
         .a(oj.i, a(dfb.eg, "_side"))
         .a(oj.L, a($$0, $$1 ? "_lit" : ""));
   }

   public static oi j(alf $$0) {
      return new oi()
         .a(oj.c, a(dfb.ft, "_side"))
         .a(oj.i, a(dfb.ft, "_side"))
         .a(oj.f, a(dfb.ft, "_top"))
         .a(oj.e, a(dfb.ft, "_bottom"))
         .a(oj.M, a(dfb.ft, "_inner"))
         .a(oj.N, $$0);
   }
   ...
   public static oi a(boolean $$0) {
      ...
      return new oi()
         .a(oj.c, a(dfb.qV, "_bottom"))
         .a(oj.i, a(dfb.qV, "_side"))
         .a(oj.f, a(dfb.qV, "_top"))
         .a(oj.O, a(dfb.qV, $$1 + "_inner_top"))
         .a(oj.e, a(dfb.qV, "_bottom"));
   }

   public static oi b(cuk $$0) {
   ...
   public static alf G(dez $$0) {
      alf $$1 = lp.e.b($$0);
      return $$1.d("block/");
   }

   public static alf a(dez $$0, String $$1) {
      alf $$2 = lp.e.b($$0);
      return $$2.a((UnaryOperator<String>)($$1x -> "block/" + $$1x + $$1));
   }

   public static alf c(cuk $$0) {
      alf $$1 = lp.h.b($$0);
      return $$1.d("item/");
   }

   public static alf a(cuk $$0, String $$1) {
      alf $$2 = lp.h.b($$0);
