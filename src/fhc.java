...
public class fhc {
   ...
   private final ffe g;
   final Map<UUID, fhr> h = Maps.newLinkedHashMap();
   ...
   private void a(fgq $$0, int $$1, int $$2, bqj $$3) {
   ...
   private void a(fgq $$0, int $$1, int $$2, bqj $$3, int $$4, ale[] $$5, ale[] $$6) {
   ...
   public void a(acr $$0) {
      $$0.a(new acr.b() {
         @Override
         public void a(UUID $$0, xo $$1, float $$2, bqj.a $$3, bqj.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fhc.this.h.put($$0, new fhr($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
         ...
         @Override
         public void a(UUID $$0, bqj.a $$1, bqj.b $$2) {
            fhr $$3 = fhc.this.h.get($$0);
            $$3.a($$1);
            $$3.a($$2);
         }
