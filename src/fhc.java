...
public abstract class fhc implements fih, fja, fkt, fky {
   ...
   private int f;
   private boolean m;
   private final fis n = new fis();

   public fhc(int $$0, int $$1, int $$2, int $$3, xp $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fgr $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fgr var1, int var2, int var3, float var4);

   protected static void a(fgr $$0, fgp $$1, xp $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fgr $$0, fgp $$1, xp $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fgr $$0, fgp $$1, int $$2, int $$3) {
      int $$4 = this.C() + $$2;
   ...
   public fky.a t() {
      if (this.aH_()) {
         ...
         return this.i ? fky.a.b : fky.a.a;
      }
   }

   @Override
   public final void b(fla $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fla var1);

   protected void c(fla $$0) {
      $$0.a(fkz.a, this.aJ_());
      if (this.j) {
         if (this.aH_()) {
            $$0.a(fkz.d, xp.c("narration.button.usage.focused"));
         } else {
