...
public final class fkd {
   ...
   private static final fkd c = new fkd(HostAndPort.fromParts("server.invalid", 25565));

   public fkd(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fkd(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fkd a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fkd($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fkd ? this.b.equals(((fkd)$$0).b) : false;
      }
   }
