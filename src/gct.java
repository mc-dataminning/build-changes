...
public class gct extends MinecraftServer {
   ...
   public gct(Thread $$0, eql $$1, ebw.c $$2, amx $$3, afm $$4, afj $$5, aku $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gcs(this, this.aV(), this.i));
      this.p = $$1;
   }
   ...
   @Override
   public cpi aW() {
      return this.p() ? (cpi)MoreObjects.firstNonNull(this.s, this.m.m()) : null;
   }
}
