...
public class gct implements aod<gcs> {
   public gcs b(JsonObject $$0) {
      Builder<gcr> $$1 = ImmutableList.builder();
      int $$2 = asy.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = asy.a($$0, "width", -1);
      int $$9 = asy.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = asy.a($$0, "interpolate", false);
      return new gcs($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gcr a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gcr(asy.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = asy.m($$1, "frames[" + $$0 + "]");
         int $$3 = asy.a($$2, "time", -1);
         if ($$2.has("time")) {
