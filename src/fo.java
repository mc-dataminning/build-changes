...
public class fo implements ArgumentType<fm> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vb.c("argument.rotation.incomplete"));

   public static fo a() {
      return new fo();
   }

   public static fm a(CommandContext<ds> $$0, String $$1) {
