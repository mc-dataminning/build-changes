...
public class fsf implements akg<cyv>, fjq, fkj, fmh, fsk {
   public static final fka a = new fka(new akt("recipe_book/button"), new akt("recipe_book/button_highlighted"));
   private static final fka i = new fka(
      new akt("recipe_book/filter_enabled"),
      new akt("recipe_book/filter_disabled"),
      new akt("recipe_book/filter_enabled_highlighted"),
      new akt("recipe_book/filter_disabled_highlighted")
   );
   protected static final akt b = new akt("textures/gui/recipe_book.png");
   ...
   private static final xe l = xe.c("gui.recipebook.toggleRecipes.craftable");
   private static final xe m = xe.c("gui.recipebook.toggleRecipes.all");
   private int n;
   private int o;
   private int p;
   protected final fsd e = new fsd();
   private final List<fsh> q = Lists.newArrayList();
   @Nullable
   private fsh r;
   protected fjt f;
   protected cqw<?> g;
   ...
   public void a(int $$0, int $$1, fgj $$2, boolean $$3, cqw<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      int $$1 = (this.p - 166) / 2;
      this.x.a();
      this.h.s.gl().a(this.x);
      this.g.a(this.x);
      String $$2 = this.s != null ? this.s.a() : "";
      this.s = new fiw(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, xe.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fjt($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (fgs $$3 : fgs.a(this.g.t())) {
         this.q.add(new fsh($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fjy.a(this.c()) : fjy.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fsj> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fsj> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fsj> $$4 = new ObjectLinkedOpenHashSet(this.h.a(guy.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   public void h() {
      ...
      if (this.f()) {
         if (this.y != this.h.s.gl().l()) {
            this.m();
            this.y = this.h.s.gl().l();
         }
      }
   }
   ...
   private void b(fia $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fon.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fia $$0, int $$1, int $$2, boolean $$3, float $$4) {
      this.e.a($$0, this.h, $$1, $$2, $$3, $$4);
   }

   @Override
   public boolean a(double $$0, double $$1, int $$2) {
      if (this.f() && !this.h.s.O_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cq.j, $$3, fon.s());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public boolean a(char $$0, int $$1) {
      if (this.z) {
         return false;
      } else if (!this.f() || this.h.s.O_()) {
         return false;
      } else if (this.s.a($$0, $$1)) {
         this.o();
         return true;
      } else {
         return fkj.super.a($$0, $$1);
      }
   }
   ...
   public void a(czc<?> $$0, List<cre> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cyv.a($$2), $$1.get(0).f, $$1.get(0).g);
   ...
   protected void j() {
      if (this.h.L() != null) {
         ...
         this.h.L().b(new ahr($$0, $$1, $$2));
      }
   }

   @Override
   public fmh.a t() {
      return this.A ? fmh.a.b : fmh.a.a;
   }

   @Override
   public void b(fmj $$0) {
      List<fmh> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.B()) {
            $$1.add($$1x);
         }
