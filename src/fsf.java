...
public class fsf extends fqs<csz> {
   private static final alc G = alc.b("container/stonecutter/scroller");
   private static final alc H = alc.b("container/stonecutter/scroller_disabled");
   private static final alc I = alc.b("container/stonecutter/recipe_selected");
   private static final alc J = alc.b("container/stonecutter/recipe_highlighted");
   private static final alc K = alc.b("container/stonecutter/recipe");
   private static final alc L = alc.b("textures/gui/container/stonecutter.png");
   ...
   protected void a(fjx $$0, float $$1, int $$2, int $$3) {
      ...
      alc $$7 = this.G() ? G : H;
      $$0.a(ghq::B, $$7, $$4 + 119, $$5 + 15 + $$6, 12, 15);
      int $$8 = this.C + 52;
      int $$9 = this.D + 14;
      int $$10 = this.X + 12;
      this.a($$0, $$2, $$3, $$8, $$9, $$10);
   ...
   private void a(fjx $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      for (int $$6 = this.X; $$6 < $$5 && $$6 < this.z.n(); $$6++) {
         ...
         $$0.a(ghq::B, $$11, $$8, $$10 - 1, 16, 18);
      }
   }

   private void b(fjx $$0, int $$1, int $$2, int $$3) {
      List<daj<dbe>> $$4 = this.z.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.G()) {
         ...
         this.V = azd.a(this.V - $$5, 0.0F, 1.0F);
