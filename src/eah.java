...
public class eah {
   ...
   @Deprecated
   public static eah a(ate $$0, eah.a $$1) {
      return new eah($$0, $$1, false);
   }

   public static eah a(ate $$0, int $$1, double... $$2) {
      return b($$0, new eah.a($$1, new DoubleArrayList($$2)));
   }

   public static eah b(ate $$0, eah.a $$1) {
      return new eah($$0, $$1, true);
   }

   private eah(ate $$0, eah.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eah.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eah.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eah.a::b))
               .apply($$0, eah.a::new)
      );
      public static final Codec<ib<eah.a>> b = afs.a(jz.ay, a);
