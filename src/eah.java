...
public class eah extends eam {
   public static final Codec<eah> a = dzv.a.fieldOf("provider").xmap(eah::new, $$0 -> $$0.b).codec();
   private final dzv b;
