...
public class fil extends fhf {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   public static final fil.a k = new fil.a() {
      @Override
      public int a() {
         return 0;
      }
   ...
   protected void o() {
      this.c(fbg.a(vt.d, $$0 -> this.d()).a(this.g / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.w = this.c(new fjm($$0 + 116, 159, true, $$0x -> this.J(), this.y));
      this.x = this.c(new fjm($$0 + 43, 159, false, $$0x -> this.I(), this.y));
      this.L();
   }
   ...
   public static void a(ta $$0, Consumer<String> $$1) {
      ...
      if (ezg.Q().aS() && $$0.b("filtered_pages", 10)) {
   ...
   public interface a {
      ...
      static fil.a a(cqk $$0) {
         if ($$0.a(cqn.tY)) {
            return new fil.c($$0);
         } else {
            return (fil.a)($$0.a(cqn.tX) ? new fil.b($$0) : fil.k);
         }
      }
   }

   public static class b implements fil.a {
      ...
      private static List<String> b(cqk $$0) {
         ta $$1 = $$0.w();
         return (List<String>)($$1 != null ? fil.a($$1) : ImmutableList.of());
      }
   ...
   public static class c implements fil.a {
      private final List<String> a;
      ...
      private static List<String> b(cqk $$0) {
         ta $$1 = $$0.w();
         return (List<String>)($$1 != null && csg.a($$1) ? fil.a($$1) : ImmutableList.of(vu.a.a(vu.c("book.invalid.tag").a(n.e))));
      }
