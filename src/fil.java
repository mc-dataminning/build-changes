...
public class fil implements gtt {
   private static final long a = 3000L;
   private final ffe b;
   private final List<fil.a> c = Lists.newArrayList();
   private boolean d;
   private final List<fil.a> e = new ArrayList<>();
   ...
   public void a(fgq $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fil.a> $$10 = this.e.iterator();
            ...
            for (fil.a $$12 : this.e) {
               ...
               int $$24 = ayy.d(ayy.b(255.0F, 75.0F, (float)(ac.c() - $$12.b()) / (float)(3000.0 * $$9)));
   ...
   @Override
   public void a(gsm $$0, gtv $$1, float $$2) {
      if ($$1.a() != null) {
         xo $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fil.a $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.a(new evq($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fil.a($$3, $$2, new evq($$0.h(), $$0.i(), $$0.j())));
      }
   }
