...
public class aex implements zv<ach> {
   public static final zm<wl, aex> a = zv.a(aex::a, aex::new);
   private static final int b = 12;
   private final kb c;
   private final short[] d;
   private final dsb[] e;

   public aex(kb $$0, ShortSet $$1, dui $$2) {
      this.c = $$0;
      int $$3 = $$1.size();
      this.d = new short[$$3];
      this.e = new dsb[$$3];
   ...
   private void a(wl $$0) {
      ...
      for (int $$1 = 0; $$1 < this.d.length; $$1++) {
         $$0.a((long)dey.i(this.e[$$1]) << 12 | (long)this.d[$$1]);
      }
   }
   ...
   public void a(BiConsumer<iz, dsb> $$0) {
      iz.a $$1 = new iz.a();
