...
public class dmq implements dms {
   public static final Codec<dmq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bdc.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bdc.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bdc.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bda.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bda.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
