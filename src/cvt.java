...
public class cvt extends cuk {
   ...
   public cvt(xp $$0, xp $$1, xp $$2, xp $$3, xp $$4, List<alf> $$5, List<alf> $$6, cpj... $$7) {
      super(new cuk.a().a($$7));
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static cvt a(ale<cww> $$0, cpj... $$1) {
      return a($$0.a(), $$1);
   }

   public static cvt a(alf $$0, cpj... $$1) {
      return new cvt(l, m, xp.c(ac.a("trim_pattern", $$0)).a(a), n, o, x(), y(), $$1);
   }

   public static cvt h() {
      return new cvt(p, q, k, r, s, z(), A());
   }
