...
public abstract class cjf extends cje {
   @Nullable
   private io b;
   private boolean c;
   private boolean d;

   protected cjf(bsc<? extends cjf> $$0, daz $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bS.a(4, new cjf.a<>(this, 0.7, 0.595));
   }
   ...
   public btj a(dbo $$0, bpu $$1, bsu $$2, @Nullable btj $$3) {
      if ($$2 != bsu.p && $$2 != bsu.h && $$2 != bsu.d && $$0.E_().i() < 0.06F && this.gq()) {
         this.c = true;
      }

      if (this.gt()) {
         this.a(bsd.f, cnj.a(this.dR().b(lf.d)));
         this.a(bsd.f, 2.0F);
      }
   ...
   public static boolean b(bsc<? extends cjf> $$0, dba $$1, bsu $$2, io $$3, aym $$4) {
      return $$1.a(dbi.b, $$3) > 8 ? false : c($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public static class a<T extends cjf> extends bzo {
      ...
      public void e() {
         ...
         if ($$1.l()) {
            ...
            if (this.b.gy() && $$2.isEmpty()) {
               ...
               eum $$3 = eum.c(this.b.gr());
               eum $$4 = this.b.dn();
               eum $$5 = $$4.d($$3);
               $$3 = $$5.b(90.0F).a(0.4).e($$3);
               eum $$6 = $$3.d($$4).d().a(10.0).e($$4);
               io $$7 = io.a($$6);
               $$7 = this.b.dP().a(dwv.a.f, $$7);
      ...
      private List<cjf> h() {
         return this.b.dP().a(cjf.class, this.b.cK().g(16.0), $$0 -> $$0.gw() && !$$0.t(this.b));
      }
