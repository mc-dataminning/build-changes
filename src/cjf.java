...
public final class cjf {
   public static final Codec<cjf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jb.i.q().fieldOf("id").forGetter(cjf::d),
   ...
   private cjf(cpu $$0, int $$1, Optional<qw> $$2) {
      this($$0, $$1);
      $$2.ifPresent(this::c);
   }

   public cjf(he<cja> $$0, int $$1) {
      this($$0.a(), $$1);
   }
   ...
   public boolean a(Predicate<he<cja>> $$0) {
      return $$0.test(this.d().j());
   }

   public boolean a(he<cja> $$0) {
      return this.d().j() == $$0;
   }

   public boolean a(hi<cja> $$0) {
      return $$0.a(this.e());
   }
   ...
   public bgy a(clp $$0) {
      ...
      if ($$1 != null && !$$1.fS().e && !this.a($$0.q().G_().d(jc.e), $$3)) {
         return bgy.d;
      } else {
         cja $$4 = this.d();
         bgy $$5 = $$4.a($$0);
   ...
   public boolean a(int $$0, asc $$1, @Nullable akr $$2) {
      if (!this.i()) {
         return false;
      } else {
         if ($$0 > 0) {
   ...
   public <T extends bjg> void a(int $$0, T $$1, Consumer<T> $$2) {
      if (!$$1.dL().B && (!($$1 instanceof cbu) || !((cbu)$$1).fS().d)) {
         if (this.i()) {
            if (this.a($$0, $$1.ef(), $$1 instanceof akr ? (akr)$$1 : null)) {
               $$2.accept($$1);
               cja $$3 = this.d();
               this.h(1);
               if ($$1 instanceof cbu) {
   ...
   public static void a(List<tl> $$0, rc $$1) {
      for (int $$2 = 0; $$2 < $$1.size(); $$2++) {
         qw $$3 = $$1.a($$2);
         jb.g.b(cnq.b($$3)).ifPresent($$2x -> $$0.add($$2x.d(cnq.a($$3))));
      }
   }
      ...
      if (this.u() && this.v.b("AttributeModifiers", 9)) {
         ...
         for (int $$3 = 0; $$3 < $$2.size(); $$3++) {
            ...
            if (!$$4.b("Slot", 8) || $$4.l("Slot").equals($$0.e())) {
               Optional<bkh> $$5 = jb.v.b(aew.a($$4.l("AttributeName")));
               if (!$$5.isEmpty()) {
                  bkk $$6 = bkk.a($$4);
   ...
   public boolean a(hq<csv> $$0, dfn $$1) {
      if (this.y == null) {
   ...
   public boolean b(hq<csv> $$0, dfn $$1) {
      if (this.x == null) {
