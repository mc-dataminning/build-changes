...
public class eta {
   ...
   public eta(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public eta(etf $$0, etf $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static eta a(efy $$0) {
      return new eta((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static eta a(etf $$0) {
      return new eta($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static eta a(im $$0, im $$1) {
      return new eta(
   ...
   public eta a(double $$0) {
      return new eta($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public eta b(double $$0) {
      return new eta(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public eta c(double $$0) {
      return new eta(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public eta d(double $$0) {
      return new eta(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public eta e(double $$0) {
      return new eta(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public eta f(double $$0) {
      return new eta(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public eta b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public eta c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public eta d(double $$0, double $$1, double $$2) {
      return new eta(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public eta f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public eta h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<etf> b(etf $$0, etf $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      ir $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static etb a(Iterable<eta> $$0, etf $$1, etf $$2, im $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new etb($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ir a(eta $$0, etf $$1, double[] $$2, @Nullable ir $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, ir.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, ir.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, ir.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, ir.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, ir.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, ir.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public etf f() {
      return new etf(axw.d(0.5, this.a, this.d), axw.d(0.5, this.b, this.e), axw.d(0.5, this.c, this.f));
   }

   public static eta a(etf $$0, double $$1, double $$2, double $$3) {
      return new eta($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
