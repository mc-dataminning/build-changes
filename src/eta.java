...
public final class eta implements AutoCloseable {
   ...
   public eta(int $$0, int $$1, boolean $$2) {
      this(eta.a.a, $$0, $$1, $$2);
   }

   public eta(eta.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private eta(eta.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static eta a(InputStream $$0) throws IOException {
      return a(eta.a.a, $$0);
   }

   public static eta a(@Nullable eta.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static eta a(ByteBuffer $$0) throws IOException {
      return a(eta.a.a, $$0);
   }

   public static eta a(byte[] $$0) throws IOException {
   ...
   public static eta a(@Nullable eta.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new eta($$0 == null ? eta.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public eta a(IntUnaryOperator $$0) {
      if (this.c != eta.a.a) {
         ...
         this.j();
         eta $$1 = new eta(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void a(FT_Face $$0, int $$1) {
      if (this.c.a() != 1) {
         ...
         feh.a(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph");
   ...
   public void a(eta $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, eta $$4) {
      this.j();
      if ($$4.c() != this.c) {
