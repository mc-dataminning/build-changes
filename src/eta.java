...
public abstract class eta<T extends eta<T>> {
   ...
   public eta(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = esy.a();
         if ($$3 != null) {
         ...
         throw new euj(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new euj(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new euj(var2.getMessage(), var2);
      }
   }
   ...
   public static eta<?> a(String $$0) {
      return new eta.b($$0, 5000, 60000);
   }

   public static eta<?> a(String $$0, int $$1, int $$2) {
      return new eta.b($$0, $$1, $$2);
   }

   public static eta<?> b(String $$0, String $$1) {
      return new eta.c($$0, $$1, 5000, 60000);
   }

   public static eta<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eta.c($$0, $$1, $$2, $$3);
   }

   public static eta<?> b(String $$0) {
      return new eta.a($$0, 5000, 60000);
   }

   public static eta<?> c(String $$0, String $$1) {
      return new eta.d($$0, $$1, 5000, 60000);
   }

   public static eta<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eta.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eta<eta.a> {
   ...
   public static class b extends eta<eta.b> {
   ...
   public static class c extends eta<eta.c> {
      ...
      public eta.c f() {
         try {
            ...
            throw new euj(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eta<eta.d> {
      private final String c;
