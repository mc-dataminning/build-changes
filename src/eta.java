...
public class eta {
   ...
   private static final Map<dku.a, String> e = ac.a(new EnumMap<>(dku.a.class), $$0 -> {
      $$0.put(dku.a.a, "SW");
      $$0.put(dku.a.b, "S");
      $$0.put(dku.a.c, "OW");
      $$0.put(dku.a.d, "O");
   ...
   private dhs l;
   @Nullable
   private CompletableFuture<dhs> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final asg r = new asg();
   private final asg s = new asg();
   private final asg t = new asg();
   private final asg u = new asg();
   private final euh v;
   private final euj w;
   private final eui x;
   private final eug y;
   ...
   public eta(eqx $$0) {
      ...
      this.g = new eta.a();
      this.h = $$0.h;
      this.v = new euh(this.h, this.r);
      this.w = new euj(this.h, this.s);
      this.x = new eui(this.h, this.t);
      this.y = new eug(this.h, this.u);
   }
   ...
   private void a(esh $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cpx $$16 = this.p();
         LongSet $$17 = (LongSet)($$16 instanceof aks ? ((aks)$$16).u() : LongSets.EMPTY_SET);
         ...
         $$18.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$9, $$14, ary.g($$8.dB()), ary.g($$8.dD())));
         dhs $$20 = this.r();
         if ($$20.C()) {
            $$18.add("Waiting for chunk...");
         } else {
            int $$21 = this.f.r.i().p().a($$7, 0);
            int $$22 = this.f.r.a(cqg.a, $$7);
            int $$23 = this.f.r.a(cqg.b, $$7);
            $$18.add("Client Light: " + $$21 + " (" + $$22 + " sky, " + $$23 + " block)");
            dhs $$24 = this.q();
            StringBuilder $$25 = new StringBuilder("CH");

            for (dku.a $$26 : dku.a.values()) {
               if ($$26.b()) {
            ...
            if ($$7.v() >= this.f.r.H_() && $$7.v() < this.f.r.aj()) {
               ...
               if ($$24 != null) {
                  float $$28 = $$16.an();
                  long $$29 = $$24.u();
                  bgy $$30 = new bgy($$16.ai(), $$16.W(), $$29, $$28);
         ...
         if ($$31 != null) {
            ...
            cqi.d $$37 = $$32.n();
            if ($$37 != null) {
               Object2IntMap<bjl> $$38 = $$37.b();
               int $$39 = $$37.a();
               $$18.add(
                  "SC: "
                     + $$39
                     + ", "
                     + Stream.of(bjl.values())
   ...
   private static String a(hg<cqv> $$0) {
   ...
   private cpx p() {
      return (cpx)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ac()))), this.f.r);
   }
   ...
   private dhs q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, dhm.n, false).thenApply($$0x -> (dhs)$$0x.map($$0xx -> (dhs)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ekk.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", eqx.O().aM().k(), eqx.O().aM().l(), ekk.a()),
            ekk.c(),
            ekk.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == ehn.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dgo<?>, Comparable<?>> $$7 = (Entry<dgo<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ehn.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dgo<?>, Comparable<?>> $$10 = (Entry<dgo<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dgo<?>, Comparable<?>> $$0) {
      dgo<?> $$1 = $$0.getKey();
