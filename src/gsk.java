...
public class gsk implements atc<gsj> {
   public gsj b(JsonObject $$0) {
      Builder<gsi> $$1 = ImmutableList.builder();
      int $$2 = ayc.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = ayc.a($$0, "width", -1);
      int $$9 = ayc.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = ayc.a($$0, "interpolate", false);
      return new gsj($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gsi a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gsi(ayc.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = ayc.m($$1, "frames[" + $$0 + "]");
         int $$3 = ayc.a($$2, "time", -1);
         if ($$2.has("time")) {
