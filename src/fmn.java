...
public class fmn extends fmv {
   static final ale c = new ale("textures/gui/title/mojangstudios.png");
   private static final int d = ayh.b.a(255, 239, 50, 61);
   private static final int e = ayh.b.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> ffd.Q().m.a().c() ? e : d;
   ...
   public fmn(ffd $$0, auk $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fgp $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         int $$9 = ayx.f((1.0F - ayx.a($$7 - 1.0F, 0.0F, 1.0F)) * 255.0F);
         $$0.a(gdu.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         $$10 = 1.0F - ayx.a($$7 - 1.0F, 0.0F, 1.0F);
      } else if (this.p) {
         if (this.m.y != null && $$8 < 1.0F) {
            this.m.y.a($$0, $$1, $$2, $$3);
         }

         int $$11 = ayx.c(ayx.a((double)$$8, 0.15, 1.0) * 255.0);
         $$0.a(gdu.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         $$10 = ayx.a($$8, 0.0F, 1.0F);
      } else {
         int $$13 = f.getAsInt();
         ...
         GlStateManager._clear(16384, ffd.a);
         $$10 = 1.0F;
      }
      ...
      float $$25 = this.n.b();
      this.q = ayx.a(this.q * 0.95F + $$25 * 0.050000012F, 0.0F, 1.0F);
      if ($$7 < 1.0F) {
         this.a($$0, $$4 / 2 - $$23, $$24 - 5, $$4 / 2 + $$23, $$24 + 5, 1.0F - ayx.a($$7, 0.0F, 1.0F));
      }
   ...
   private void a(fgp $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      int $$6 = ayx.f((float)($$3 - $$1 - 2) * this.q);
      int $$7 = Math.round($$5 * 255.0F);
      int $$8 = ayh.b.a($$7, 255, 255, 255);
   ...
   static class a extends goq {
      ...
      protected goq.a b(auo $$0) {
         ate $$1 = ffd.Q().ad();
         aug<InputStream> $$2 = $$1.a(atc.a, fmn.c);
         if ($$2 == null) {
            return new goq.a(new FileNotFoundException(fmn.c.toString()));
         } else {
            try {
               goq.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new goq.a(new gqu(true, true), eyx.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new goq.a(var9);
            }
         }
      }
   }
