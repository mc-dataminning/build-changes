...
public class fmn extends fmk {
   ...
   private final epz cD;
   private final List<gbd> cE = Lists.newArrayList();
   private int cF = 0;
   private double cG;
   private double cH;
   private double cI;
   ...
   public fmn(eqm $$0, fii $$1, fij $$2, aph $$3, epz $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.p());
      this.cn = $$0;
      this.cl = $$2;
      this.cC = $$3;
      ...
      this.cN = $$5;
      this.cO = $$6;
      this.cE.add(new gbv(this, $$0.ai()));
      this.cE.add(new gbi(this));
      this.cE.add(new gbh(this, $$0.ai(), $$1.z_()));
   }
   ...
   public boolean a(bii $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cde) {
            this.cn.ai().a((gbt)(new gbn(this, (cde)$$0, true)));
            this.cn.ai().a((gbt)(new gbn(this, (cde)$$0, false)));
         }
   ...
   private boolean i(gu $$0) {
      egz $$1 = this.cG();
      egz $$2 = new egz((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   public void a(ddu $$0, boolean $$1) {
      if ($$0 instanceof ddi $$2) {
         this.cn.a(new ezt($$2, $$1, this.cn.aQ()));
      } else {
         this.cn.a(new fag($$0, $$1, this.cn.aQ()));
      }
   }
   ...
   public void b_() {
      ...
      float $$3 = arp.a(0.3F + cnh.b(this), 0.0F, 1.0F);
      this.cm.a(this.t(), $$3);
      ...
      if (this.cm.g && !$$10 && !$$0 && !this.fR().b && !this.bN() && !this.j_()) {
         ciy $$11 = this.c(bin.e);
         if ($$11.a(cjb.nh) && chs.d($$11) && this.fV()) {
      ...
      super.b_();
      if (this.aA() && this.fR().b && !this.cn.t.j()) {
         this.fR().b = false;
         this.w();
      }
   }
   ...
   private void D() {
      ...
      float $$0 = 0.0F;
      if (this.av) {
         if (this.cn.B != null && !this.cn.B.j() && !(this.cn.B instanceof ewy)) {
            if (this.cn.B instanceof eyx) {
               this.q();
            }
         ...
         if (this.ct == 0.0F) {
            this.cn.ai().a(gbo.b(aow.sW, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected void f(float $$0, float $$1) {
      if (this.E()) {
         ehe $$2 = this.di();
         ehe $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         ehe $$4 = new ehe((double)$$0, 0.0, (double)$$1);
         float $$5 = this.fd();
         float $$6 = (float)$$4.g();
         if ($$6 <= 0.001F) {
            ehd $$7 = this.cm.a();
            ...
            $$4 = new ehe((double)($$8 * $$11 - $$9 * $$10), $$4.d, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.g();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         if (!($$15 < -0.15F)) {
            ...
            if ($$18.b(this.dK(), $$17, $$16).c()) {
               ...
               if ($$19.b(this.dK(), $$17, $$16).c()) {
                  ...
                  ehe $$24 = $$3.e($$13.a((double)$$22));
                  float $$25 = this.df();
                  float $$26 = this.dg();
                  egz $$27 = new egz($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  ehe $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  ehe $$28 = $$13.c(new ehe(0.0, 1.0, 0.0));
                  ehe $$29 = $$28.a((double)($$25 * 0.5F));
                  ehe $$30 = $$23.d($$29);
                  ehe $$31 = $$24.d($$29);
                  ehe $$32 = $$23.e($$29);
                  ehe $$33 = $$24.e($$29);
                  Iterable<ehx> $$34 = this.dK().d(this, $$27);
                  Iterator<egz> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean fJ() {
      ...
      if (this.G_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.cn.ai().a((gbt)(new gbw.b(this)));
         }
