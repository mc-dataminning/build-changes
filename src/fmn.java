...
public class fmn {
   ...
   public static void a(File $$0, ffb $$1, Consumer<xv> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ffb $$2, Consumer<xv> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ffb $$2, Consumer<xv> $$3) {
      ffr $$4 = a($$2);
   ...
   public static ffr a(ffb $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ffr $$3 = new ffr($$1, $$2, false);
   ...
   public fmn(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
