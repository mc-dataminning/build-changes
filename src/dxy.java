...
public class dxy extends dxr implements btx {
   private static final int a = 2;
   private static final int b = 4;
   private final jo<czn> c = jo.a(4, czn.k);
   private final int[] d = new int[4];
   private final int[] e = new int[4];

   public dxy(iv $$0, eat $$1) {
      super(dxt.H, $$0, $$1);
   }

   public static void a(arq $$0, iv $$1, eat $$2, dxy $$3, del.a<dex, ddp> $$4) {
      boolean $$5 = false;
      ...
      for (int $$6 = 0; $$6 < $$3.c.size(); $$6++) {
         ...
         if (!$$7.f()) {
            ...
            if ($$3.d[$$6] >= $$3.e[$$6]) {
               dex $$8 = new dex($$7);
               czn $$9 = $$4.a($$8, $$0).map($$2x -> ((ddp)$$2x.b()).a($$8, $$0.F_())).orElse($$7);
               if ($$9.a($$0.K())) {
                  buc.a($$0, (double)$$1.u(), (double)$$1.v(), (double)$$1.w(), $$9);
                  $$3.c.set($$6, czn.k);
                  $$0.a($$1, $$2, $$2, 3);
                  $$0.a(eft.c, $$1, eft.a.a($$2));
               }
            }
         }
      }
   ...
   public static void a(djm $$0, iv $$1, eat $$2, dxy $$3) {
      boolean $$4 = false;
   ...
   public static void b(djm $$0, iv $$1, eat $$2, dxy $$3) {
      azv $$4 = $$0.A;
      if ($$4.i() < 0.11F) {
         for (int $$5 = 0; $$5 < $$4.a(2) + 2; $$5++) {
            dnh.a($$0, $$1, $$2.c(dnh.c), false);
         }
      }
   ...
   public boolean a(arq $$0, @Nullable bxj $$1, czn $$2) {
      for (int $$3 = 0; $$3 < this.c.size(); $$3++) {
         czn $$4 = this.c.get($$3);
         if ($$4.f()) {
            Optional<dej<ddp>> $$5 = $$0.t().a(dep.e, new dex($$2), $$0);
            if ($$5.isEmpty()) {
               return false;
            }
            ...
            $$0.a(eft.c, this.ax_(), eft.a.a($$1, this.m()));
            this.f();
            return true;
         }
      }
   ...
   protected void a(kf $$0) {
      super.a($$0);
      $$0.a(kk.ap, dcf.a).a(this.c());
   }

   @Override
   protected void a(kh.a $$0) {
      super.a($$0);
      $$0.a(kk.ap, dcf.a(this.c()));
   }
