...
public class dxy {
   ...
   private static final int j = ji.a(16);
   ...
   private final dbb p;
   private static final List<dea> q = List.of(dec.l, dec.L, dec.i, dec.b, dec.k, dec.I, dec.K, dec.fl, dec.dP, dec.iA, dec.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ix<dby>>> t;
   ...
   public static final Codec<dxy> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dxy::a, Function.identity());

   private static DataResult<dxy> a(dxy $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dxy(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ix<dby>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jq.c($$0);
      int $$5 = jq.c($$1) - $$4;
   ...
   @Nullable
   public static dxy a(aqu $$0, int $$1, int $$2) {
      dsz $$3 = $$0.a($$1, $$2);
      dxy $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dty.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<iu> a(dbu $$0, int $$1, int $$2, boolean $$3) {
      Set<iu> $$4 = EnumSet.noneOf(iu.class);
   ...
   private void a(dsz $$0, Set<iu> $$1) {
      if (!this.r) {
         if ($$1.contains(iu.a) || $$1.contains(iu.g) || $$1.contains(iu.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(iu.c) && $$1.contains(iu.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(iu.c) && $$1.contains(iu.e) && $$1.contains(iu.d)) {
   ...
   private void a(int $$0, dsz $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayf.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dsz $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dwv.a.a)) {
         $$3 = Math.min($$0.a(dwv.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }

      int $$5 = this.p.I_();
      io.a $$6 = new io.a($$1, $$3, $$2);
   ...
   private static double a(dsz $$0, io.a $$1) {
      return a($$0, (io)$$1.c(it.a)) ? 1.0 : -1.0;
   }

   private static double b(dsz $$0, io.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dsz $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      io.a $$5 = new io.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<ix<dby>> b(dsz $$0, int $$1, int $$2) {
      ObjectArrayList<ix<dby>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + ji.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(ji.a($$1), $$5, ji.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dsz $$0, io $$1) {
      drd $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avx.O)) {
         ...
         return $$2.a(dec.eT) || $$2.a(dec.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dxy.a $$3) {
      if ($$1 >= ji.a(this.p.I_()) && $$1 < ji.a(this.p.al())) {
         int $$4 = $$1 - ji.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               ix<dby> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dxy.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dxy.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ix<dby> var3);
   }
