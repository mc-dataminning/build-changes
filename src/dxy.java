...
public class dxy<T> implements dyg<T> {
   private final jv<T> a;
   private final ayj<T> b;
   private final dyh<T> c;
   private final int d;

   public dxy(jv<T> $$0, int $$1, dyh<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dxy(jv<T> $$0, int $$1, dyh<T> $$2) {
      this($$0, $$1, $$2, ayj.c(1 << $$1));
   }

   private dxy(jv<T> $$0, int $$1, dyh<T> $$2, ayj<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public dyg<T> a(dyh<T> $$0) {
      return new dxy<>(this.a, this.d, $$0, this.b.b());
   }
}
