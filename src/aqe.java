      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)bag.a),
               String.format(Locale.ROOT, "%.2f", this.d.aP().g() / (float)bag.c)
            );
            ...
            $$4.a("Random tick rate", () -> this.d.ba().o().a(def.o).toString());
