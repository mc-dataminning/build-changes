...
public abstract class aqe {
   ...
   static final int b = apu.a(aqf.d);
   private static final int c = 4;
   final Long2ObjectMap<ObjectSet<aqn>> d = new Long2ObjectOpenHashMap();
   final Long2ObjectOpenHashMap<ayu<aqq<?>>> e = new Long2ObjectOpenHashMap();
   private final aqe.a f = new aqe.a();
   private final aqe.b g = new aqe.b(8);
   private final aqs h = new aqs();
   private final aqe.c i = new aqe.c(32);
   final Set<apt> j = Sets.newHashSet();
   final apy k;
   final bom<apy.a<Runnable>> l;
   final bom<apy.b> m;
   ...
   protected aqe(Executor $$0, Executor $$1) {
      bom<Runnable> $$2 = bom.a("player ticket throttler", $$1::execute);
      apy $$3 = new apy(ImmutableList.of($$2), $$0, 4);
      this.k = $$3;
      this.l = $$3.a($$2, true);
      this.m = $$3.a($$2);
      this.o = $$1;
   ...
   protected void a() {
      this.p++;
      ObjectIterator<Entry<ayu<aqq<?>>>> $$0 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$0.hasNext()) {
         Entry<ayu<aqq<?>>> $$1 = (Entry<ayu<aqq<?>>>)$$0.next();
         Iterator<aqq<?>> $$2 = ((ayu)$$1.getValue()).iterator();
         boolean $$3 = false;
         ...
         if ($$3) {
            this.f.b($$1.getLongKey(), a((ayu<aqq<?>>)$$1.getValue()), false);
         }

         if (((ayu)$$1.getValue()).isEmpty()) {
            $$0.remove();
         }
      }
   }

   private static int a(ayu<aqq<?>> $$0) {
      return !$$0.isEmpty() ? $$0.b().b() : apu.a + 1;
   }

   protected abstract boolean a(long var1);

   @Nullable
   protected abstract apt b(long var1);

   @Nullable
   protected abstract apt a(long var1, int var3, @Nullable apt var4, int var5);
         ...
         if (!this.n.isEmpty()) {
            ...
            while ($$3.hasNext()) {
               ...
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == aqr.c)) {
                  ...
                  CompletableFuture<apw<dth>> $$6 = $$5.b();
                  $$6.thenAccept($$1x -> this.o.execute(() -> this.m.a(apy.a(() -> {
                        }, $$4, false))));
               }
            }
   ...
   public <T> void c(aqr<T> $$0, dae $$1, int $$2, T $$3) {
      aqq<T> $$4 = new aqq<>($$0, apu.a(aqf.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.a($$5, $$4);
      this.h.a($$5, $$4);
   }

   public <T> void d(aqr<T> $$0, dae $$1, int $$2, T $$3) {
      aqq<T> $$4 = new aqq<>($$0, apu.a(aqf.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.b($$5, $$4);
      this.h.b($$5, $$4);
   ...
   private ayu<aqq<?>> g(long $$0) {
      return (ayu<aqq<?>>)this.e.computeIfAbsent($$0, $$0x -> ayu.a(4));
   }

   protected void a(dae $$0, boolean $$1) {
      aqq<dae> $$2 = new aqq<>(aqr.d, apv.c, $$0);
      long $$3 = $$0.a();
      if ($$1) {
         this.a($$3, $$2);
         this.h.a($$3, $$2);
   ...
   private int g() {
      return Math.max(0, apu.a(aqf.d) - this.q);
   }

   public boolean c(long $$0) {
      return apu.c(this.h.c($$0));
   }

   public boolean d(long $$0) {
      return apu.d(this.h.c($$0));
   }

   protected String e(long $$0) {
      ayu<aqq<?>> $$1 = (ayu<aqq<?>>)this.e.get($$0);
   ...
   private void a(String $$0) {
      try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
         ...
         while (var3.hasNext()) {
            ...
            dae $$3 = new dae($$2.getLongKey());

            for (aqq<?> $$4 : (ayu)$$2.getValue()) {
   ...
   public void e() {
      ImmutableSet<aqr<?>> $$0 = ImmutableSet.of(aqr.h, aqr.g, aqr.e);
      ObjectIterator<Entry<ayu<aqq<?>>>> $$1 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$1.hasNext()) {
         Entry<ayu<aqq<?>>> $$2 = (Entry<ayu<aqq<?>>>)$$1.next();
         Iterator<aqq<?>> $$3 = ((ayu)$$2.getValue()).iterator();
         boolean $$4 = false;
         ...
         if ($$4) {
            this.f.b($$2.getLongKey(), a((ayu<aqq<?>>)$$2.getValue()), false);
         }

         if (((ayu)$$2.getValue()).isEmpty()) {
            $$1.remove();
         }
      }
   }
   ...
   class a extends apz {
      private static final int b = apu.a + 1;
      ...
      protected int b(long $$0) {
         ayu<aqq<?>> $$1 = (ayu<aqq<?>>)aqe.this.e.get($$0);
         if ($$1 == null) {
   ...
   class b extends apz {
      ...
      private boolean d(long $$0) {
         ObjectSet<aqn> $$1 = (ObjectSet<aqn>)aqe.this.d.get($$0);
      ...
      private void a(String $$0) {
         try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
            ...
            aqe.a.error("Failed to dump chunks to {}", $$0, var9);
         }
      }
   }

   class c extends aqe.b {
      private int g;
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            aqq<?> $$4 = new aqq<>(aqr.c, aqe.b, new dae($$0));
            if ($$3) {
               aqe.this.l.a(apy.a(() -> aqe.this.o.execute(() -> {
                     if (this.c(this.c($$0))) {
                        aqe.this.a($$0, $$4);
                        aqe.this.n.add($$0);
                     } else {
               ...
               aqe.this.m.a(apy.a(() -> aqe.this.o.execute(() -> aqe.this.b($$0, $$4)), $$0, true));
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  aqe.this.k.onLevelChange(new dae($$1), () -> this.h.get($$1), $$3, $$1x -> {
