...
public class ftq {
   ...
   public static void a(evh $$0, eqa $$1) {
      cfh $$2 = $$0.s;
      if (!$$2.af) {
         djg $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static void a(gem $$0, eqa $$1) {
   ...
   private static void b(evh $$0, eqa $$1) {
      RenderSystem.setShader(fsz::s);
      RenderSystem.setShaderTexture(0, a);
      epv $$2 = eqc.b().d();
      hx $$3 = hx.a($$0.s.dr(), $$0.s.dv(), $$0.s.dx());
      float $$4 = ftf.a($$0.s.dM().E_(), $$0.s.dM().A($$3));
   ...
   private static void c(evh $$0, eqa $$1) {
      epv $$2 = eqc.b().d();
      RenderSystem.setShader(fsz::r);
