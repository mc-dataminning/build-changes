...
public class ftq extends fui {
   ...
   public ftq(fui $$0, BooleanConsumer $$1, ggl $$2) {
   ...
   @Override
   protected void aR_() {
      this.v = new foz(this.p, this.n / 2 - 100, 66, 200, 20, wo.c("addServer.enterName"));
      this.v.a(this.s.a);
      this.v.b($$0 -> this.E());
      this.d(this.v);
      this.u = new foz(this.p, this.n / 2 - 100, 106, 200, 20, wo.c("addServer.enterIp"));
      this.u.f(128);
      this.u.a(this.s.b);
      this.u.b($$0 -> this.E());
      this.d(this.u);
      ...
      this.c = this.c(fop.a(wo.c("addServer.add"), $$0 -> this.m()).a(this.n / 2 - 100, this.o / 4 + 96 + 18, 200, 20).a());
      this.c(fop.a(wn.e, $$0 -> this.d.accept(false)).a(this.n / 2 - 100, this.o / 4 + 120 + 18, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      this.c.j = gho.b(this.u.a()) && !this.v.a().isEmpty();
   }
