...
public class ftq extends ftr {
   ...
   public ftq(flz $$0, BooleanConsumer $$1, evv.c $$2) {
      super(c);
      this.A = $$1;
      ...
      this.B.a(this.E);
      frr $$7 = frr.e().a(5);
      $$7.a(fny.a(d, fso.b(this, aza.j)).b(120, 20).a());
      $$7.a(fny.a(s, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : fpk.a(u)).a()).j = $$6;
      this.B.a($$7);
      this.B.a(fny.a(xu.k, $$0x -> this.aP_()).b(120, 20).a());
      this.B.a(this::c);
   }
   ...
   private void a(flz $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new ftc(xv.c("recover_world.restoring")));
         fyt.a(this.F);
         if (this.F.n()) {
            $$0.a(new fsp(this.A, v, w, xu.j, xu.k));
         } else {
   ...
   private xv a(evv.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         return xv.i();
      } else {
         yj $$3 = xv.i();
         Instant $$4 = $$0.a($$1);
         yj $$5 = $$4 != null ? xv.b(fze.a.format($$4)) : xv.c("recover_world.state_entry.unknown");
   ...
   @Nullable
   private Exception a(evv.c $$0, boolean $$1) {
      try {
         if (!$$1) {
            $$0.a($$0.h());
         } else {
