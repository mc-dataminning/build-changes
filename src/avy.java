...
public class avy {
   ...
   public static ij<coy> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static ij<coy> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ij<coy> a(JsonObject $$0, String $$1, @Nullable ij<coy> $$2) {
