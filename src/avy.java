...
public class avy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bbv.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", avy::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", avy::a);
      return this.a($$0, "minecraft:trident", avy::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bbv.x, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bbv.x, $$1);
