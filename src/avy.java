...
public class avy {
   ...
   private static void a(DataFixerBuilder $$0) {
      ...
      Schema $$16 = $$0.addSchema(501, bfv::new);
      $$0.addFixer(new awe($$16, "Add 1.10 entities fix", bbw.y));
      ...
      Schema $$19 = $$0.addSchema(700, bfw::new);
      $$0.addFixer(new aye($$19, true));
      Schema $$20 = $$0.addSchema(701, bfx::new);
      $$0.addFixer(new ayy($$20, true));
      Schema $$21 = $$0.addSchema(702, bfy::new);
      $$0.addFixer(new azf($$21, true));
      Schema $$22 = $$0.addSchema(703, bfz::new);
      $$0.addFixer(new ayj($$22, true));
      Schema $$23 = $$0.addSchema(704, bga::new);
      $$0.addFixer(new awq($$23, true));
      Schema $$24 = $$0.addSchema(705, bgb::new);
      ...
      $$0.addFixer(new awe($$48, "Add DUMMY block entity", bbw.s));
      $$0.addFixer(new axr($$48, true));
      Schema $$49 = $$0.addSchema(1470, bdw::new);
      $$0.addFixer(new awe($$49, "Add 1.13 entities fix", bbw.y));
      Schema $$50 = $$0.addSchema(1474, c);
      $$0.addFixer(new axs($$50, false));
      $$0.addFixer(
         awz.a($$50, "Colorless shulker block fixer", $$0x -> Objects.equals(bde.a($$0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : $$0x)
      );
      $$0.addFixer(
      ...
      $$0.addFixer(awz.a($$51, "Flowing fixer", a(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
      Schema $$52 = $$0.addSchema(1480, c);
      $$0.addFixer(awz.a($$52, "Rename coral blocks", a(bca.a)));
      $$0.addFixer(azy.a($$52, "Rename coral items", a(bca.a)));
      Schema $$53 = $$0.addSchema(1481, bdx::new);
      $$0.addFixer(new awe($$53, "Add conduit", bbw.s));
      ...
      $$0.addFixer(awz.a($$58, "Rename kelp/kelptop", a(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
      ...
      $$0.addFixer(new baw($$58, false, "Command block minecart custom name fix", bbw.y, "minecraft:commandblock_minecart") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), ayd::a);
         }
      ...
      $$0.addFixer(awz.a($$59, "Rename melon_block", a("minecraft:melon_block", "minecraft:melon")));
      $$0.addFixer(
         azy.a(
            $$59,
      ...
      $$0.addFixer(new aws($$63, false));
      Schema $$64 = $$0.addSchema(1501, c);
      $$0.addFixer(new awf($$64, false));
      Schema $$65 = $$0.addSchema(1502, c);
      $$0.addFixer(new bay($$65, "Recipes fix", bbw.G, a(bbt.a)));
      Schema $$66 = $$0.addSchema(1506, c);
      $$0.addFixer(new ban($$66, false));
      Schema $$67 = $$0.addSchema(1510, bea::new);
      $$0.addFixer(awz.a($$67, "Block renamening fix", a(aza.b)));
      $$0.addFixer(azy.a($$67, "Item renamening fix", a(aza.c)));
      $$0.addFixer(new bay($$67, "Recipes renamening fix", bbw.G, a(bbu.a)));
      ...
      $$0.addFixer(new awe($$83, "Add campfire", bbw.s));
      ...
      $$0.addFixer(new awe($$86, "Add Wandering Trader and Trader Llama", bbw.y));
      Schema $$87 = $$0.addSchema(1931, bej::new);
      $$0.addFixer(new awe($$87, "Added Fox", bbw.y));
      ...
      $$0.addFixer(new awe($$95, "Added Bee and Bee Stinger", bbw.y));
      $$0.addFixer(new awe($$95, "Add beehive", bbw.s));
      $$0.addFixer(new bay($$95, "Rename sugar recipe", bbw.G, a("minecraft:sugar", "sugar_from_sugar_cane")));
      $$0.addFixer(new awg($$95, false, "Rename sugar recipe advancement", a("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      ...
      $$0.addFixer(awz.a($$97, "Rename bee_hive block to beehive", $$98));
      ...
      $$0.addFixer(new awe($$102, "Added Hoglin", bbw.y));
      Schema $$103 = $$0.addSchema(2503, c);
      $$0.addFixer(new bcv($$103, false));
      $$0.addFixer(new awg($$103, false, "Composter category change", a("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      Schema $$104 = $$0.addSchema(2505, ben::new);
      $$0.addFixer(new awe($$104, "Added Piglin", bbw.y));
      ...
      $$0.addFixer(new awe($$111, "Added Strider", bbw.y));
      Schema $$112 = $$0.addSchema(2522, beq::new);
      $$0.addFixer(new awe($$112, "Added Zoglin", bbw.y));
      Schema $$113 = $$0.addSchema(2523, c);
      $$0.addFixer(new awh($$113));
      Schema $$114 = $$0.addSchema(2527, c);
      $$0.addFixer(new awk($$114));
      ...
      $$0.addFixer(new bda($$122, "add types to WorldGenData", bbw.J));
      Schema $$123 = $$0.addSchema(2552, c);
      $$0.addFixer(new bay($$123, "Nether biome rename", bbw.H, a("minecraft:nether", "minecraft:nether_wastes")));
      Schema $$124 = $$0.addSchema(2553, c);
      $$0.addFixer(new bay($$124, "Biomes fix", bbw.H, a(awj.a)));
      ...
      $$0.addFixer(new awe($$126, "Added Piglin Brute", bbw.y));
      Schema $$127 = $$0.addSchema(2571, bet::new);
      $$0.addFixer(new awe($$127, "Added Goat", bbw.y));
      ...
      $$0.addFixer(awz.a($$129, "Renamed grass path block to dirt path", a("minecraft:grass_path", "minecraft:dirt_path")));
      Schema $$130 = $$0.addSchema(2684, beu::new);
      $$0.addFixer(new awe($$130, "Added Sculk Sensor", bbw.s));
      Schema $$131 = $$0.addSchema(2686, bev::new);
      $$0.addFixer(new awe($$131, "Added Axolotl", bbw.y));
      Schema $$132 = $$0.addSchema(2688, bew::new);
      $$0.addFixer(new awe($$132, "Added Glow Squid", bbw.y));
      $$0.addFixer(new awe($$132, "Added Glow Item Frame", bbw.y));
      ...
      $$0.addFixer(awz.a($$133, "Renamed copper blocks to new oxidized terms", a($$134)));
      ...
      $$0.addFixer(awz.a($$135, "Rename copper blocks suffixes", a($$136)));
      Schema $$137 = $$0.addSchema(2693, c);
      $$0.addFixer(new awd($$137, bbw.J, "has_increased_height_already", false));
      ...
      $$0.addFixer(awz.a($$138, "Renamed grimstone blocks to deepslate", a($$139)));
      ...
      $$0.addFixer(new awa($$142));
      Schema $$143 = $$0.addSchema(2704, bex::new);
      $$0.addFixer(new awe($$143, "Added Goat", bbw.y));
      Schema $$144 = $$0.addSchema(2707, bey::new);
      $$0.addFixer(new awe($$144, "Added Marker", bbw.y));
      $$0.addFixer(new awd($$144, bbw.J, "has_increased_height_already", true));
      ...
      $$0.addFixer(
         awz.a($$146, "Rename azalea_leaves_flowers items", a(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves")))
      );
      Schema $$147 = $$0.addSchema(2825, c);
      $$0.addFixer(new awd($$147, bbw.J, "has_increased_height_already", false));
      ...
      $$0.addFixer(new bay($$151, "Caves and Cliffs biome renames", bbw.H, a(axe.a)));
      ...
      $$0.addFixer(new bay($$154, "Remove Deep Warm Ocean", bbw.H, a("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      $$0.addFixer(new awe($$159, "Added Sculk Catalyst", bbw.s));
      Schema $$160 = $$0.addSchema(3077, c);
      $$0.addFixer(new axh($$160));
      Schema $$161 = $$0.addSchema(3078, bfd::new);
      $$0.addFixer(new awe($$161, "Added Frog", bbw.y));
      $$0.addFixer(new awe($$161, "Added Tadpole", bbw.y));
      $$0.addFixer(new awe($$161, "Added Sculk Shrieker", bbw.s));
      Schema $$162 = $$0.addSchema(3081, bfe::new);
      $$0.addFixer(new awe($$162, "Added Warden", bbw.y));
      Schema $$163 = $$0.addSchema(3082, bff::new);
      $$0.addFixer(new awe($$163, "Added Chest Boat", bbw.y));
      Schema $$164 = $$0.addSchema(3083, bfg::new);
      $$0.addFixer(new awe($$164, "Added Allay", bbw.y));
      ...
      $$0.addFixer(new azd($$166, "Change cat variant type", bbw.y, "minecraft:cat", "CatType", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      $$0.addFixer(new azd($$168, "Change frog variant type", bbw.y, "minecraft:frog", "Variant", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      $$0.addFixer(new bcq($$172, "Rename british shorthair", bbw.y, "minecraft:cat", $$173));
      $$0.addFixer(
         new axt(
      ...
      $$0.addFixer(new awm($$174));
      Schema $$175 = $$0.addSchema(3201, c);
      $$0.addFixer(new bbl($$175));
      Schema $$176 = $$0.addSchema(3202, bfh::new);
      $$0.addFixer(new awe($$176, "Added Hanging Sign", bbw.s));
      Schema $$177 = $$0.addSchema(3203, bfi::new);
      $$0.addFixer(new awe($$177, "Added Camel", bbw.y));
      Schema $$178 = $$0.addSchema(3204, bfj::new);
      $$0.addFixer(new awe($$178, "Added Chiseled Bookshelf", bbw.s));
      ...
      $$0.addFixer(new awe($$183, "Added displays", bbw.y));
      Schema $$184 = $$0.addSchema(3326, bfl::new);
      $$0.addFixer(new awe($$184, "Added Sniffer", bbw.y));
      Schema $$185 = $$0.addSchema(3327, bfm::new);
      $$0.addFixer(new awe($$185, "Archaeology", bbw.s));
      Schema $$186 = $$0.addSchema(3328, bfn::new);
      $$0.addFixer(new awe($$186, "Added interaction", bbw.y));
      Schema $$187 = $$0.addSchema(3438, bfo::new);
      $$0.addFixer(awt.a($$187, "Rename Suspicious Sand to Brushable Block", a("minecraft:suspicious_sand", "minecraft:brushable_block")));
      ...
      $$0.addFixer(new awe($$187, "Added calibrated sculk sensor", bbw.s));
      Schema $$188 = $$0.addSchema(3439, c);
      $$0.addFixer(new awv($$188, "Updated sign text format for Signs", "minecraft:sign"));
      $$0.addFixer(new awv($$188, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema $$189 = $$0.addSchema(3440, c);
      $$0.addFixer(new bay($$189, "Replace experimental 1.20 overworld", bbw.I, a("minecraft:overworld_update_1_20", "minecraft:overworld")));
      $$0.addFixer(new azi($$189, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema $$190 = $$0.addSchema(3441, c);
      $$0.addFixer(new awl($$190));
      ...
      $$0.addFixer(new awe($$200, "Added Crafter", bbw.s));
      ...
      $$0.addFixer(new awe($$203, "Added Breeze", bbw.y));
      $$0.addFixer(new awe($$203, "Added Trial Spawner", bbw.s));
      Schema $$204 = $$0.addSchema(3692, c);
      UnaryOperator<String> $$205 = a(Map.of("minecraft:grass", "minecraft:short_grass"));
      $$0.addFixer(awz.a($$204, "Rename grass block to short_grass", $$205));
      $$0.addFixer(azy.a($$204, "Rename grass item to short_grass", $$205));
      Schema $$206 = $$0.addSchema(3799, bfu::new);
      $$0.addFixer(new awe($$206, "Added Armadillo", bbw.y));
      Schema $$207 = $$0.addSchema(3800, c);
      UnaryOperator<String> $$208 = a(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      $$0.addFixer(azy.a($$207, "Rename scute item to turtle_scute", $$208));
   }
