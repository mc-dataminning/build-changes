...
public class ue extends um {
   ...
   public static final uv<ue> a = new uv.a<ue>() {
      public ue a(DataInput $$0, uf $$1) throws IOException {
         return ue.a(d($$0, $$1));
      }
   ...
   public static ue a(long $$0) {
      return $$0 >= -128L && $$0 <= 1024L ? ue.a.a[(int)$$0 - -128] : new ue($$0);
   }
