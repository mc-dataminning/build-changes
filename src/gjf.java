...
public class gjf {
   ...
   public gjf(hab $$0, hac $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(gyn $$0, fer $$1, gjg $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fev $$6 = $$2.getBuffer(gjq.t($$0.a));
      ...
      for (gyn.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, flo.a.a, Integer.MIN_VALUE, $$4);
               $$1.b();
            }
   ...
   public void a(etn $$0, etp $$1, gyn $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
