...
public class gjf extends MinecraftServer {
   ...
   public gjf(Thread $$0, evr $$1, egv.c $$2, apu $$3, aid $$4, aia $$5, ano $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gje(this, this.ba(), this.h));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (anf $$1 : Lists.newArrayList(this.ae().t())) {
   ...
   @Override
   public ctu bb() {
      return this.p() ? (ctu)MoreObjects.firstNonNull(this.q, this.k.m()) : null;
   }
}
