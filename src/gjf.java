...
public class gjf extends giz<cet, ftv<cet>> {
   private static final Map<cet.a, akm> a = ac.a(Maps.newEnumMap(cet.a.class), $$0 -> {
      $$0.put(cet.a.a, new akm("textures/entity/panda/panda.png"));
      $$0.put(cet.a.b, new akm("textures/entity/panda/lazy_panda.png"));
      $$0.put(cet.a.c, new akm("textures/entity/panda/worried_panda.png"));
      $$0.put(cet.a.d, new akm("textures/entity/panda/playful_panda.png"));
      $$0.put(cet.a.e, new akm("textures/entity/panda/brown_panda.png"));
      $$0.put(cet.a.f, new akm("textures/entity/panda/weak_panda.png"));
      $$0.put(cet.a.g, new akm("textures/entity/panda/aggressive_panda.png"));
   });
   ...
   public akm a(cet $$0) {
      return a.getOrDefault($$0.gB(), a.get(cet.a.a));
   }

   protected void a(cet $$0, eys $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bZ > 0) {
         int $$6 = $$0.bZ;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ayd.i($$25, $$0.dH(), $$0.dH() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(ayd.i($$27, $$0.dH(), $$0.dH() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ayd.i($$3, $$0, $$1) : $$0;
   }
}
