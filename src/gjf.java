public class gjf extends gix<cnm> {
   ...
   public void a(cnm $$0, float $$1, float $$2, ezz $$3, gdp $$4, int $$5) {
      cmy $$6 = $$0.u();
      if ($$6 != null) {
         $$3.a();
         $$3.a();
   ...
   private evs a(cmy $$0, float $$1, float $$2) {
      int $$3 = $$0.fu() == btk.b ? 1 : -1;
      cuq $$4 = $$0.eX();
      if (!$$4.a(cut.qV)) {
         $$3 = -$$3;
      }

      if (this.c.d.aA().a() && $$0 == ffg.Q().s) {
         double $$12 = 960.0 / (double)this.c.d.ah().c().intValue();
         evs $$13 = this.c.b.j().a((float)$$3 * 0.525F, -0.1F).a($$12).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.j($$2).e($$13);
      } else {
   ...
   private static void a(fad $$0, ezz.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(255, 255, 255, 255).a((float)$$5, (float)$$6).c(gor.d).b($$2).b($$1, 0.0F, 1.0F, 0.0F).e();
   }

   private static void a(float $$0, float $$1, float $$2, fad $$3, ezz.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
