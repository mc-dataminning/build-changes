...
public class duu<T> implements duw<T> {
   ...
   private duu(jo<T> $$0, int $$1, dux<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private duu(jo<T> $$0, T[] $$1, dux<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public duw<T> c() {
      return new duu<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
