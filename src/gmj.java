...
public class gmj {
   ...
   public void a(dhh $$0, glh $$1, int $$2, float $$3, fbx $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = fme.N() ? 10 : 5;
         List<gmj.a> $$7 = new ArrayList<>();
         List<gmj.a> $$8 = new ArrayList<>();
   ...
   private void a(dhh $$0, int $$1, float $$2, fbx $$3, int $$4, List<gmj.a> $$5, List<gmj.a> $$6) {
      int $$7 = bae.a($$3.d);
      int $$8 = bae.a($$3.e);
      int $$9 = bae.a($$3.f);
      jh.a $$10 = new jh.a();
   ...
   private void a(glh $$0, fbx $$1, int $$2, float $$3, List<gmj.a> $$4, List<gmj.a> $$5) {
      $$0.c();
      fgs $$6 = fgs.b();
      RenderSystem.disableCull();
      RenderSystem.enableBlend();
      RenderSystem.enableDepthTest();
      RenderSystem.depthMask(fme.O());
   ...
   private gmj.a a(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      int $$8 = $$1 & 131071;
      int $$9 = $$2 * $$2 * 3121 + $$2 * 45238971 + $$5 * $$5 * 418711 + $$5 * 13761 & 0xFF;
      float $$10 = 3.0F + $$0.i();
      float $$11 = -((float)($$8 + $$9) + $$7) / 32.0F * $$10;
      float $$12 = $$11 % 32.0F;
      return new gmj.a($$2, $$5, $$3, $$4, 0.0F, $$12, $$6);
   }

   private gmj.a b(bam $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      float $$8 = (float)$$1 + $$7;
      float $$9 = (float)($$0.j() + (double)($$8 * 0.01F * (float)$$0.k()));
      float $$10 = (float)($$0.j() + (double)($$8 * (float)$$0.k() * 0.001F));
      float $$11 = -((float)($$1 & 511) + $$7) / 512.0F;
      int $$12 = glh.a((glh.a($$6) * 3 + 15) / 4, (glh.b($$6) * 3 + 15) / 4);
      return new gmj.a($$2, $$5, $$3, $$4, $$9, $$11 + $$10, $$12);
   }

   private void a(fgs $$0, List<gmj.a> $$1, fbx $$2, float $$3, int $$4, float $$5) {
      fgl $$6 = $$0.a(fgv.c.h, fgo.d);
   ...
   public void a(gfi $$0, fln $$1, int $$2, arz $$3) {
      float $$4 = $$0.d(1.0F) / (fme.N() ? 1.0F : 2.0F);
      if (!($$4 <= 0.0F)) {
         ...
         for (int $$9 = 0; $$9 < $$8; $$9++) {
            int $$10 = $$5.a(21) - 10;
            int $$11 = $$5.a(21) - 10;
            jh $$12 = $$0.a(edp.a.e, $$6.b($$10, 0, $$11));
            if ($$12.v() > $$0.L_() && $$12.v() <= $$6.v() + 10 && $$12.v() >= $$6.v() - 10 && this.a($$0, $$12) == dij.c.b) {
               $$7 = $$12.e();
               if ($$3 == arz.c) {
                  break;
               }
               ...
               lq $$21 = !$$16.a(aya.b) && !$$15.a(dkn.le) && !dla.h($$15) ? ls.ae : ls.af;
         ...
         if ($$7 != null && $$5.a(3) < this.g++) {
            this.g = 0;
            if ($$7.v() > $$6.v() + 1 && $$0.a(edp.a.e, $$6).v() > bae.d((float)$$6.v())) {
               $$0.a($$7, axf.CD, axg.d, 0.1F, 0.5F, false);
            } else {
               $$0.a($$7, axf.CC, axg.d, 0.2F, 1.0F, false);
            }
         }
      }
   }

   private dij.c a(dhh $$0, jh $$1) {
