...
public class gmj {
   ...
   static final ThreadLocal<gmj.d> f = ThreadLocal.withInitial(gmj.d::new);

   public gmj(fnb $$0) {
      this.d = $$0;
   }

   public void a(dgc $$0, hdg $$1, dxn $$2, jh $$3, fgl $$4, fgp $$5, boolean $$6, bam $$7, long $$8, int $$9) {
   ...
   public void b(dgc $$0, hdg $$1, dxn $$2, jh $$3, fgl $$4, fgp $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      ...
      $$7.b($$8);
      List<gml> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dgc $$0, hdg $$1, dxn $$2, jh $$3, fgl $$4, fgp $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jh.a $$11 = $$3.k();

      for (jm $$12 : c) {
         $$7.b($$8);
         List<gml> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
      ...
      $$7.b($$8);
      List<gml> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dgc $$0, dxn $$1, jh $$2, fgl $$3, fgp $$4, List<gml> $$5, float[] $$6, BitSet $$7, gmj.b $$8, int $$9) {
      for (gml $$10 : $$5) {
   ...
   private void a(
      dgc $$0, dxn $$1, jh $$2, fgp $$3, fgl.a $$4, gml $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dgc $$0, dxn $$1, jh $$2, int[] $$3, jm $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dgc $$0, dxn $$1, jh $$2, int $$3, int $$4, boolean $$5, fgl $$6, fgp $$7, List<gml> $$8, BitSet $$9) {
      for (gml $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fgl.a $$0, fgp $$1, @Nullable dxn $$2, hdg $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      bam $$9 = bam.a();
      long $$10 = 42L;
   ...
   private static void a(fgl.a $$0, fgp $$1, float $$2, float $$3, float $$4, List<gml> $$5, int $$6, int $$7) {
      for (gml $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gmj.e[]{gmj.e.k, gmj.e.d, gmj.e.k, gmj.e.j, gmj.e.e, gmj.e.j, gmj.e.e, gmj.e.d},
         new gmj.e[]{gmj.e.k, gmj.e.c, gmj.e.k, gmj.e.i, gmj.e.e, gmj.e.i, gmj.e.e, gmj.e.c},
         new gmj.e[]{gmj.e.l, gmj.e.c, gmj.e.l, gmj.e.i, gmj.e.f, gmj.e.i, gmj.e.f, gmj.e.c},
         new gmj.e[]{gmj.e.l, gmj.e.d, gmj.e.l, gmj.e.j, gmj.e.f, gmj.e.j, gmj.e.f, gmj.e.d}
      ),
      b(
         new jm[]{jm.f, jm.e, jm.c, jm.d},
         1.0F,
         true,
         new gmj.e[]{gmj.e.f, gmj.e.d, gmj.e.f, gmj.e.j, gmj.e.l, gmj.e.j, gmj.e.l, gmj.e.d},
         new gmj.e[]{gmj.e.f, gmj.e.c, gmj.e.f, gmj.e.i, gmj.e.l, gmj.e.i, gmj.e.l, gmj.e.c},
         new gmj.e[]{gmj.e.e, gmj.e.c, gmj.e.e, gmj.e.i, gmj.e.k, gmj.e.i, gmj.e.k, gmj.e.c},
         new gmj.e[]{gmj.e.e, gmj.e.d, gmj.e.e, gmj.e.j, gmj.e.k, gmj.e.j, gmj.e.k, gmj.e.d}
      ),
      c(
         new jm[]{jm.b, jm.a, jm.f, jm.e},
         0.8F,
         true,
         new gmj.e[]{gmj.e.b, gmj.e.k, gmj.e.b, gmj.e.e, gmj.e.h, gmj.e.e, gmj.e.h, gmj.e.k},
         new gmj.e[]{gmj.e.b, gmj.e.l, gmj.e.b, gmj.e.f, gmj.e.h, gmj.e.f, gmj.e.h, gmj.e.l},
         new gmj.e[]{gmj.e.a, gmj.e.l, gmj.e.a, gmj.e.f, gmj.e.g, gmj.e.f, gmj.e.g, gmj.e.l},
         new gmj.e[]{gmj.e.a, gmj.e.k, gmj.e.a, gmj.e.e, gmj.e.g, gmj.e.e, gmj.e.g, gmj.e.k}
      ),
      d(
         new jm[]{jm.e, jm.f, jm.a, jm.b},
         0.8F,
         true,
         new gmj.e[]{gmj.e.b, gmj.e.k, gmj.e.h, gmj.e.k, gmj.e.h, gmj.e.e, gmj.e.b, gmj.e.e},
         new gmj.e[]{gmj.e.a, gmj.e.k, gmj.e.g, gmj.e.k, gmj.e.g, gmj.e.e, gmj.e.a, gmj.e.e},
         new gmj.e[]{gmj.e.a, gmj.e.l, gmj.e.g, gmj.e.l, gmj.e.g, gmj.e.f, gmj.e.a, gmj.e.f},
         new gmj.e[]{gmj.e.b, gmj.e.l, gmj.e.h, gmj.e.l, gmj.e.h, gmj.e.f, gmj.e.b, gmj.e.f}
      ),
      e(
         new jm[]{jm.b, jm.a, jm.c, jm.d},
         0.6F,
         true,
         new gmj.e[]{gmj.e.b, gmj.e.d, gmj.e.b, gmj.e.j, gmj.e.h, gmj.e.j, gmj.e.h, gmj.e.d},
         new gmj.e[]{gmj.e.b, gmj.e.c, gmj.e.b, gmj.e.i, gmj.e.h, gmj.e.i, gmj.e.h, gmj.e.c},
         new gmj.e[]{gmj.e.a, gmj.e.c, gmj.e.a, gmj.e.i, gmj.e.g, gmj.e.i, gmj.e.g, gmj.e.c},
         new gmj.e[]{gmj.e.a, gmj.e.d, gmj.e.a, gmj.e.j, gmj.e.g, gmj.e.j, gmj.e.g, gmj.e.d}
      ),
      f(
         new jm[]{jm.a, jm.b, jm.c, jm.d},
         0.6F,
         true,
         new gmj.e[]{gmj.e.g, gmj.e.d, gmj.e.g, gmj.e.j, gmj.e.a, gmj.e.j, gmj.e.a, gmj.e.d},
         new gmj.e[]{gmj.e.g, gmj.e.c, gmj.e.g, gmj.e.i, gmj.e.a, gmj.e.i, gmj.e.a, gmj.e.c},
         new gmj.e[]{gmj.e.h, gmj.e.c, gmj.e.h, gmj.e.i, gmj.e.b, gmj.e.i, gmj.e.b, gmj.e.c},
         new gmj.e[]{gmj.e.h, gmj.e.d, gmj.e.h, gmj.e.j, gmj.e.b, gmj.e.j, gmj.e.b, gmj.e.d}
      );
      ...
      final gmj.e[] k;
      final gmj.e[] l;
      private static final gmj.a[] m = ae.a(new gmj.a[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
      ...
      private a(final jm[] $$0, final float $$1, final boolean $$2, final gmj.e[] $$3, final gmj.e[] $$4, final gmj.e[] $$5, final gmj.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dgc $$0, dxn $$1, jh $$2, jm $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dxn $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dxn $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dxn $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dxn $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gmj.c[] k = ae.a(new gmj.c[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dxn $$0, dgc $$1, jh $$2) {
         long $$3 = $$2.a();
         if (this.a) {
