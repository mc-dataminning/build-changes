...
public class gmj {
   ...
   public gmj(goy $$0, dhi $$1, int $$2, glh $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, kj.b($$2, $$3 + this.b.ao(), $$4));
               }
            }
         }
      }
   ...
   @Nullable
   protected goy.b a(jh $$0) {
      return this.a(kj.c($$0));
   }

   @Nullable
   protected goy.b a(long $$0) {
      int $$1 = kj.b($$0);
      int $$2 = kj.c($$0);
      int $$3 = kj.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private goy.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.ao();
