...
public class gmj {
   ...
   public static void a(fli $$0, fft $$1, glx $$2) {
      cow $$3 = $$0.t;
      if (!$$3.ad) {
         dww $$4 = a($$3);
         if ($$4 != null) {
   ...
   private static void a(her $$0, fft $$1, glx $$2) {
      float $$3 = 0.1F;
   ...
   private static void b(fli $$0, fft $$1, glx $$2) {
      ji $$3 = ji.a($$0.t.dA(), $$0.t.dE(), $$0.t.dG());
      float $$4 = glv.a($$0.t.dV().G_(), $$0.t.dV().A($$3));
   ...
   private static void a(fft $$0, glx $$1) {
      her $$2 = hhb.b.c();
      ffx $$3 = $$1.getBuffer(gmh.E($$2.i()));
      float $$4 = $$2.c();
      float $$5 = $$2.d();
      float $$6 = ($$4 + $$5) / 2.0F;
      float $$7 = $$2.g();
