...
public class gmj {
   ...
   private gmj(int $$0, List<gml> $$1) {
      this.a = $$1.toArray(gml[]::new);
      this.b = $$1.size();
   }

   private List<gml> c() {
      List<gml> $$0 = new ArrayList<>(this.d());
