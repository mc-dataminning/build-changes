...
public abstract class grp<T extends bvk, S extends gxv> {
   protected static final float c = 0.025F;
   public static final int d = 24;
   protected final gro e;
   private final fnq a;
   protected float f;
   protected float g = 1.0F;
   private final S b = this.d();

   protected grp(grq.a $$0) {
      this.e = $$0.a();
      this.a = $$0.j();
   }
   ...
   public final int a(T $$0, float $$1) {
      jh $$2 = jh.a((ka)$$0.n($$1));
      return glj.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, jh $$1) {
      return $$0.dW().a(dhr.a, $$1);
   }

   protected int a(T $$0, jh $$1) {
      return $$0.bY() ? 15 : $$0.dW().a(dhr.b, $$1);
   }

   public boolean a(T $$0, gpc $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if (!this.b($$0)) {
         return true;
      } else {
         fbt $$5 = this.a($$0).g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new fbt($$0.dB() - 2.0, $$0.dD() - 2.0, $$0.dH() - 2.0, $$0.dB() + 2.0, $$0.dD() + 2.0, $$0.dH() + 2.0);
         }

         if ($$1.a($$5)) {
            return true;
         } else {
            if ($$0 instanceof bwe $$6) {
               bvk $$7 = $$6.A();
               if ($$7 != null) {
   ...
   private static void a(fgs $$0, gll $$1, gxv.a $$2) {
      float $$3 = 0.025F;
   ...
   protected void a(S $$0, xv $$1, fgs $$2, gll $$3, int $$4) {
      fby $$5 = $$0.z;
      if ($$5 != null) {
         boolean $$6 = !$$0.v;
         ...
         $$9.a($$1, $$10, (float)$$7, -2130706433, false, $$8, $$3, $$6 ? fnq.a.b : fnq.a.a, $$11, $$4);
         if ($$6) {
            $$9.a($$1, $$10, (float)$$7, -1, false, $$8, $$3, fnq.a.a, 0, glj.b($$4, 2));
         }
   ...
   public void a(T $$0, S $$1, float $$2) {
      $$1.m = bae.d((double)$$2, $$0.aa, $$0.dB());
      $$1.n = bae.d((double)$$2, $$0.ab, $$0.dD());
      $$1.o = bae.d((double)$$2, $$0.ac, $$0.dH());
      $$1.u = $$0.cp();
      $$1.p = (float)$$0.af + $$2;
      $$1.q = $$0.dr();
      $$1.r = $$0.ds();
      $$1.s = $$0.cS();
      if ($$0.bZ() && $$0.dl() instanceof crw $$3 && $$3.l() instanceof csl $$4 && $$4.t()) {
         double $$5 = bae.d((double)$$2, $$3.aa, $$3.dB());
         double $$6 = bae.d((double)$$2, $$3.ab, $$3.dD());
         double $$7 = bae.d((double)$$2, $$3.ac, $$3.dH());
         $$1.x = $$4.e($$2).d(new fby($$5, $$6, $$7));
      } else {
         $$1.x = null;
      }
      ...
      if ($$8) {
         $$1.y = this.c($$0);
         $$1.z = $$0.dt().a(bvl.c, 0, $$0.k($$2));
      } else {
         $$1.y = null;
      }

      $$1.v = $$0.cg();
      bvk $$10 = $$0 instanceof bwe $$9 ? $$9.A() : null;
      if ($$10 != null) {
         ...
         $$15.f = $$0.dW().a(dhr.a, $$13);
         $$15.g = $$0.dW().a(dhr.a, $$14);
      } else {
         $$1.A = null;
      }
