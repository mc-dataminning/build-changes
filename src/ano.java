...
public class ano {
   ...
   private static int a(ew $$0, Collection<asi> $$1, Predicate<cxp> $$2) throws CommandSyntaxException {
      return a($$0, $$1, $$2, -1);
   }

   private static int a(ew $$0, Collection<asi> $$1, Predicate<cxp> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = 0;
