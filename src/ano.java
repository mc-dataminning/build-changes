...
public class ano {
   ...
   private static int b(ee $$0) {
      ...
      cnk $$1 = bsc.aC.a((daz)$$0.e());
      if ($$1 == null) {
         $$0.b(wx.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(bsd.f, cnj.a($$0.v().b(lf.d)));
         $$1.a_($$0.d().c, $$0.d().d, $$0.d().e);
         $$1.a($$0.e(), $$0.e().d_(io.a($$0.d())), bsu.n, null);
         $$0.e().a_($$1);
         return 1;
      }
   }
   ...
   private static int a(ee $$0, @Nullable wx $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         aqn $$2 = $$0.e();
         eum $$3 = $$0.d().b(5.0, 0.0, 0.0);
         $$2.a(null, $$3.c, $$3.d, $$3.e, avi.uZ, avj.g, 2.0F, 1.0F, $$2.z.g());
      }
