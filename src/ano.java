...
class ano implements Path {
   private static final BasicFileAttributes a = new anm() {
      @Override
   ...
   private static final BasicFileAttributes b = new anm() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ano> c = Comparator.comparing(ano::n);
   ...
   public ano(anq $$0, String $$1, @Nullable ano $$2, anr $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ano a(@Nullable ano $$0, String $$1) {
      return new ano(this.e, $$1, $$0, anr.b);
   }
   ...
   ano a(String $$0) {
      if (a(this.i)) {
         return new ano(this.e, $$0, this, this.i);
      } else if (this.i instanceof anr.a $$1) {
         ano $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ano(this.e, $$0, this, anr.a);
      } else if (this.i instanceof anr.b) {
         return new ano(this.e, $$0, this, anr.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(anr $$0) {
      return $$0 == anr.a || $$0 == anr.b;
   }
   ...
   private ano c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ano $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof anr.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public anr.a i() {
      return this.i instanceof anr.a $$0 ? $$0 : null;
   }
