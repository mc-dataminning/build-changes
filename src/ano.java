...
public class ano {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> xl.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(xl.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> xl.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType a = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> xl.b("commands.execute.function.instantiationFailure", $$0, $$1)
   );
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a(
                                       ...
                                       .then(ex.a("at").then(ex.a("targets", fj.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bui $$2x : fj.c($$0x, "targets")) {
                                             $$1x.add(((ew)$$0x.getSource()).a((arq)$$2x.dY()).a($$2x.dw()).a($$2x.bW()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("positioned")
                                          ...
                                          .then(ex.a("as").then(ex.a("targets", fj.b()).fork($$2, $$0x -> {
                                             ...
                                             for (bui $$2x : fj.c($$0x, "targets")) {
                                                $$1x.add(((ew)$$0x.getSource()).a($$2x.dw()));
                                             }

                                             return $$1x;
                                          }))))
                                       .then(ex.a("over").then(ex.a("heightmap", fm.a()).redirect($$2, $$0x -> {
                                          ezr $$1x = ((ew)$$0x.getSource()).d();
                                          arq $$2x = ((ew)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kj.b($$3), kj.b($$4))) {
                                             throw gs.a.create();
                                          } else {
                                             int $$5 = $$2x.a(fm.a($$0x, "heightmap"), azn.a($$3), azn.a($$4));
                                             return ((ew)$$0x.getSource()).a(new ezr($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)ex.a("rotated")
                                    ...
                                    .then(ex.a("as").then(ex.a("targets", fj.b()).fork($$2, $$0x -> {
                                       ...
                                       for (bui $$2x : fj.c($$0x, "targets")) {
                                          $$1x.add(((ew)$$0x.getSource()).a($$2x.bW()));
                                       }
         ...
         ex.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)ex.a("id", fx.a())
                     .suggests(amy.a)
                     .then(ex.a("value").redirect($$0, $$1x -> a((ew)$$1x.getSource(), amy.a($$1x), true, $$2))))
                  .then(ex.a("max").redirect($$0, $$1x -> a((ew)$$1x.getSource(), amy.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             ex.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         fo.a($$2xx, "path"),
                                                         $$1xxx -> us.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          ex.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      fo.a($$2xx, "path"),
                                                      $$1xxx -> uq.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       ex.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   fo.a($$2xx, "path"),
                                                   $$1xxx -> vf.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    ex.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                fo.a($$2xx, "path"),
                                                $$1xxx -> uv.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 ex.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             fo.a($$2xx, "path"),
                                             $$1xxx -> uo.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              ex.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          fo.a($$2xx, "path"),
                                          $$1xxx -> ul.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static ew a(ew $$0, Collection<fav> $$1, fao $$2, boolean $$3) {
      faw $$4 = $$0.l().aJ();
      return $$0.a(($$4x, $$5) -> {
         for (fav $$6 : $$1) {
            fau $$7 = $$4.c($$6, $$2);
   ...
   private static ew a(ew $$0, amn $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ew a(ew $$0, aqb $$1, fo.g $$2, IntFunction<vk> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            un $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(arq $$0, jh $$1) {
      del $$2 = new del($$1);
      dxt $$3 = $$0.l().a($$2.g, $$2.h);
      return $$3 == null ? false : $$3.C() == arg.d && $$0.c($$2.a());
   }
                                          ...
                                          ex.a("pos", gs.a())
                                             .then(
                                                a(
                                                   ...
                                                   ex.a("block", go.a($$3)),
                                                   $$2,
                                                   $$0x -> go.a($$0x, "block").test(new dvs(((ew)$$0x.getSource()).e(), gs.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     ex.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)ex.a("entities", fj.b()).fork($$0, $$1x -> a($$1x, $$2, !fj.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (ano.b)($$0x -> fj.c($$0x, "entities").size())))
                        )
                  ))
               .then(ex.a("predicate").then(a($$0, ex.a("predicate", fy.c($$3)).suggests(f), $$2, $$0x -> a((ew)$$0x.getSource(), fy.c($$0x, "predicate"))))))
            .then(ex.a("function").then(ex.a("name", he.a()).suggests(ant.b).fork($$0, new ano.d($$2)))))
         .then(
                                 ...
                                 ex.a("slots", gf.a())
                                    .then(
                                       ((RequiredArgumentBuilder)ex.a("item_predicate", hi.a($$3))
                                          ...
                                          .executes(a($$2, (ano.b)($$0x -> a(fj.b($$0x, "entities"), gf.a($$0x, "slots"), hi.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              ex.a("slots", gf.a())
                                 .then(
                                    ((RequiredArgumentBuilder)ex.a("item_predicate", hi.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (ano.b)($$0x -> a((ew)$$0x.getSource(), gs.a($$0x, "pos"), gf.a($$0x, "slots"), hi.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)ex.a("path", fo.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fo.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (ano.b)($$1xx -> a($$4.a($$1xx), fo.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bui> $$0, ctq $$1, Predicate<cwf> $$2) {
      int $$3 = 0;
   ...
   private static int a(ew $$0, jh $$1, ctq $$2, Predicate<cwf> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bsa $$5 = any.a($$0, $$1, any.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<ew> a(boolean $$0, ano.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ew)$$1x.getSource()).a(() -> xl.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ew)$$1x.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(aqb $$0, fo.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ew> $$0, ano.e $$1) throws CommandSyntaxException {
      fav $$2 = gb.a($$0, "target");
      fao $$3 = fq.a($$0, "targetObjective");
      fav $$4 = gb.a($$0, "source");
      fao $$5 = fq.a($$0, "sourceObjective");
      faw $$6 = ((ew)$$0.getSource()).l().aJ();
      fas $$7 = $$6.d($$2, $$3);
      fas $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ew> $$0, dj.d $$1) throws CommandSyntaxException {
      fav $$2 = gb.a($$0, "target");
      fao $$3 = fq.a($$0, "targetObjective");
      faw $$4 = ((ew)$$0.getSource()).l().aJ();
      fas $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ew $$0, jq<exr> $$1) {
      arq $$2 = $$0.e();
      euj $$3 = new euj.a($$2).a(exc.f, $$0.d()).b(exc.a, $$0.f()).a(exb.d);
      eug $$4 = new eug.a($$3).a(Optional.empty());
      $$4.b(eug.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<ew, ?> a(CommandNode<ew> $$0, ArgumentBuilder<ew, ?> $$1, boolean $$2, ano.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ew)$$2x.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ew> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ew)$$0.getSource()).a(() -> xl.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ew> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ew)$$0.getSource()).a(() -> xl.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(arq $$0, jh $$1, jh $$2, jh $$3, boolean $$4) throws CommandSyntaxException {
      elt $$5 = elt.a($$1, $$2);
      elt $$6 = elt.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ew> a(Function<bui, Optional<bui>> $$0) {
      return $$1 -> {
         ew $$2 = (ew)$$1.getSource();
         bui $$3 = $$2.f();
         return (Collection)($$3 == null ? List.of() : $$0.apply($$3).filter($$0xx -> !$$0xx.dT()).map($$1x -> List.of($$2.a($$1x))).orElse(List.of()));
      };
   }

   private static RedirectModifier<ew> b(Function<bui, Stream<bui>> $$0) {
      return $$1 -> {
         ew $$2 = (ew)$$1.getSource();
         bui $$3 = $$2.f();
         return $$3 == null ? List.of() : $$0.apply($$3).filter($$0xx -> !$$0xx.dT()).map($$2::a).toList();
      };
   }
   ...
   private static LiteralArgumentBuilder<ew> a(CommandNode<ew> $$0, LiteralArgumentBuilder<ew> $$1) {
      return (LiteralArgumentBuilder<ew>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              ex.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bui, Optional<bui>>)($$0x -> $$0x instanceof bvl $$1x ? Optional.ofNullable($$1x.T_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              ex.a("leasher")
                                 .fork(
                                    $$0, a((Function<bui, Optional<bui>>)($$0x -> $$0x instanceof bvc $$1x ? Optional.ofNullable($$1x.C()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           ex.a("target")
                              .fork($$0, a((Function<bui, Optional<bui>>)($$0x -> $$0x instanceof bwc $$1x ? Optional.ofNullable($$1x.m()) : Optional.empty())))
                        ))
                     .then(
                        ex.a("attacker")
                           .fork($$0, a((Function<bui, Optional<bui>>)($$0x -> $$0x instanceof buc $$1x ? Optional.ofNullable($$1x.Z_()) : Optional.empty())))
                     ))
                  .then(ex.a("vehicle").fork($$0, a((Function<bui, Optional<bui>>)($$0x -> Optional.ofNullable($$0x.dm()))))))
               .then(ex.a("controller").fork($$0, a((Function<bui, Optional<bui>>)($$0x -> Optional.ofNullable($$0x.cZ()))))))
            .then(
               ex.a("origin").fork($$0, a((Function<bui, Optional<bui>>)($$0x -> $$0x instanceof bwd $$1x ? Optional.ofNullable($$1x.s()) : Optional.empty())))
            ))
         .then(ex.a("passengers").fork($$0, b((Function<bui, Stream<bui>>)($$0x -> $$0x.db().stream()))));
   }

   private static ew a(ew $$0, jq.c<bup<?>> $$1) throws CommandSyntaxException {
      bui $$2 = apl.a($$0, $$1, $$0.d(), new un(), true);
      return $$0.a($$2);
   }

   public static <T extends ey<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable un $$5, hx<T> $$6, ano.a<T, Collection<ik<T>>> $$7, hr $$8
   ) {
   ...
   static class d implements hu.a<ew> {
      ...
      public void a(ew $$0, List<ew> $$1, ContextChain<ew> $$2, hr $$3, hx<ew> $$4) {
         ano.a($$0, $$1, ant::a, this.a, $$2, null, $$4, $$0x -> he.a($$0x, "name"), $$3);
      }
   }
