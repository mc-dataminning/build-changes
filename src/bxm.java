...
public class bxm extends bwz<bvo> {
   ...
   protected boolean a(ard $$0, bvo $$1, long $$2) {
      return this.b($$1).isPresent() && !$$1.eb().a(cek.r) && !$$1.eb().a(cek.Z);
   }
   ...
   protected void c(ard $$0, bvo $$1, long $$2) {
      bwi<?> $$3 = $$1.eb();
      $$3.a(cek.P, 100);
      $$3.a(cek.R, false);
      $$3.b(cek.m);
   ...
   protected void d(ard $$0, bvo $$1, long $$2) {
      cow $$3 = this.b($$1).get();
      bwi<?> $$4 = $$1.eb();
