...
public class bwv extends bxc {
   private static final int g = 240;
   private final Predicate<bnx> h;
   protected int a;
   protected int b = -1;
   protected int c = -1;

   public bwv(bqq $$0, Predicate<bnx> $$1) {
      super($$0);
      this.h = $$1;
   }

   public bwv(bqq $$0, int $$1, Predicate<bnx> $$2) {
      this($$0, $$2);
      this.c = $$1;
   }
   ...
   public boolean a() {
      if (!super.a()) {
         ...
         return !this.d.dM().aa().b(cyt.c) ? false : this.a(this.d.dM().ak()) && !this.h();
      }
   }
   ...
   public void e() {
      ...
      if (this.a == this.f() && this.a(this.d.dM().ak())) {
         ...
         this.d.dM().c(2001, this.e, dby.i(this.d.dM().a_(this.e)));
      }
   }

   private boolean a(bnx $$0) {
