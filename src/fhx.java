...
public class fhx {
   ...
   public static final fhx.a bv;

   public static fhx.a a(int $$0, int $$1) {
      return $$0 == -1 ? fhx.b.b.a($$1) : fhx.b.a.a($$0);
   }

   public static fhx.a a(String $$0) {
      if (fhx.a.e.containsKey($$0)) {
         return fhx.a.e.get($$0);
      } else {
         for (fhx.b $$1 : fhx.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fhx.b b;
      private final int c;
      private final azg<wy> d;
      static final Map<String, fhx.a> e = Maps.newHashMap();

      a(String $$0, fhx.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<fhx.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wy> g;

      private static void a(fhx.b $$0, String $$1, int $$2) {
         fhx.a $$3 = new fhx.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fhx.a a(int $$0) {
         return (fhx.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
