...
public abstract class dhm implements dhl {
   public static final Codec<dhm> a = mb.Z.q().dispatchStable(dhm::a, Function.identity());
   private final Supplier<Set<jr<dhi>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<jr<dhi>> b();
   ...
   @Nullable
   public Pair<ji, jr<dhi>> a(int $$0, int $$1, int $$2, int $$3, Predicate<jr<dhi>> $$4, azg $$5, dhr.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<ji, jr<dhi>> a(ji $$0, int $$1, int $$2, int $$3, Predicate<jr<dhi>> $$4, dhr.f $$5, dgj $$6) {
      Set<jr<dhi>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         int $$8 = Math.floorDiv($$1, $$2);
         int[] $$9 = ayy.a($$0.v(), $$6.L_() + 1, $$6.an() + 1, $$3).toArray();
         ...
         for (ji.a $$10 : ji.a(ji.c, $$8, jn.f, jn.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = kc.a($$15);
               jr<dhi> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = ab.ar ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               jr<dhi> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract jr<dhi> getNoiseBiome(int var1, int var2, int var3, dhr.f var4);
