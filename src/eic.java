...
public class eic implements eib {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<eic> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eco.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               ecq.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               ecp.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
   ...
   public eic(eco $$0, ecq $$1, ecp $$2, double $$3, double $$4, boolean $$5, bro $$6, bro $$7, bro $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
