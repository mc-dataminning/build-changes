...
public enum eic implements asu {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final asu.a<eic> t = asu.a(eic::values);
   public static final IntFunction<eic> u = aqu.a(eic::a, values(), aqu.a.a);
   private final int v;
   private final String w;

   private eic(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
