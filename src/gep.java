...
public class gep implements fat, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final far c = new far();
   private static final boolean d = true;
   private static gep e;
   ...
   private final List<faz> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, faz> l = Maps.newHashMap();
   private final int m;
   ...
   public gep(auh $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, faw.a.a, $$6);
         this.t = a($$0, faw.a.b, $$7);
         this.m = fax.a();
         fax.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = faz.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static fau a(auh $$0, faw.a $$1, String $$2) throws IOException {
      faw $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof fau)) {
   ...
   public static fas a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new fas();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (aye.a($$0, "func")) {
            $$1 = fas.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (aye.a($$0, "srcrgb")) {
            $$2 = fas.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (aye.a($$0, "dstrgb")) {
            $$3 = fas.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (aye.a($$0, "srcalpha")) {
            $$4 = fas.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (aye.a($$0, "dstalpha")) {
            $$5 = fas.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new fas($$2, $$3, $$4, $$5, $$1) : new fas($$2, $$3, $$1);
         }
      }
   }
