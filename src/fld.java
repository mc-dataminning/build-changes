...
public final class fld {
   ...
   private static final fld c = new fld(HostAndPort.fromParts("server.invalid", 25565));

   public fld(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fld(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fld a(String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            return $$1.getHost().isEmpty() ? c : new fld($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fld ? this.b.equals(((fld)$$0).b) : false;
      }
   }
