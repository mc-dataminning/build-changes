...
public class fld extends flo {
      ...
      try {
         ...
         if (azc.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fnk.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = foz.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fnk.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !foz.Q().b($$4)) {
               try {
