...
public class eyd extends exe {
   ...
   static record b(jr<btn> b, ezw c) {
      public static final Codec<eyd.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(btn.a.fieldOf("type").forGetter(eyd.b::a), ezx.a.fieldOf("duration").forGetter(eyd.b::b)).apply($$0, eyd.b::new)
      );
