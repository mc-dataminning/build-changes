...
public class ekw extends ekx {
   ...
   public static final MapCodec<ekw> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ekv.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, ekw::new)
   );
   private final ekv h;

   public ekw(bsn $$0, ela $$1, Optional<eku> $$2, ekv $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dhn $$0, BiConsumer<jh, dxu> $$1, bam $$2, jh $$3, jh $$4, ejv $$5) {
   ...
   private boolean a(dhn $$0, bam $$1, jh $$2, jm $$3, jh $$4, List<jh> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
