...
public class fxw extends dbz {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dwj e = new dwj();
   private final dwp<bsv> f = new dwp<>(bsv.class, new fxw.b());
   private final fxx D;
   private final gdn E;
   private final fxw.a F;
   private final gde G;
   private final brg H;
   private final ffg I = ffg.Q();
   final List<gco> J = Lists.newArrayList();
   private final Map<epj, epl> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<dbk, fgk> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gdb.a, new fgk($$0xx -> this.b($$0xx, gdb.a)));
      $$0x.put(gdb.b, new fgk($$0xx -> this.b($$0xx, gdb.b)));
      $$0x.put(gdb.c, new fgk($$0xx -> this.b($$0xx, gdb.c)));
   });
   private final fxs O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final fzi R = new fzi();
   ...
   public void b(iz $$0, dsd $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(iz $$0, dsd $$1, evs $$2) {
      dsd $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cmy $$4 = this.I.s;
   ...
   public fxw(fxx $$0, fxw.a $$1, ale<dbz> $$2, ji<dvv> $$3, int $$4, int $$5, Supplier<bnj> $$6, gdn $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.v(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fxs(this, $$4);
      this.H = new brg();
      this.F = $$1;
      this.E = $$7;
      this.G = gde.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.ab().a(dbv.l).a(false, null);
      } else {
         this.ab().a(dbv.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<bsv> e() {
      return this.G().a();
   }
   ...
   private void a(bsv $$0, bsv $$1) {
      if ($$1.dK() || $$1.dc() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof cmy || this.e.c($$1)) {
         $$1.bu();
         $$1.ai++;
         $$1.t();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azh $$4, @Nullable dfa $$5, iz.a $$6) {
   ...
   private void a(iz $$0, dsd $$1, lg $$2, boolean $$3) {
      if ($$1.u().c()) {
         ewl $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(je.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(iz $$0, lg $$1, ewl $$2, double $$3) {
   ...
   public void a(@Nullable cmy $$0, bsv $$1, ji<avz> $$2, awb $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.aj().a((gso)(new gsf($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bsv $$0, avz $$1, awb $$2, float $$3, float $$4) {
      this.I.aj().a((gso)(new gsf($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avz $$3, awb $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      gsj $$10 = new gsj($$3, $$4, $$5, $$6, azh.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<cxj> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.I.g.a(new gan.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
      }
   }
   ...
   public ji<dcy> a(int $$0, int $$1, int $$2) {
      return this.H_().d(lq.az).g(ddf.b);
   }
   ...
   public evs a(evs $$0, float $$1) {
      float $$2 = this.f($$1);
      evs $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      dda $$4 = this.F_();
      evs $$5 = axz.a($$3, ($$1x, $$2x, $$3x) -> evs.a($$4.a($$1x, $$2x, $$3x).a().a()));
      ...
      return new evs((double)$$7, (double)$$8, (double)$$9);
   }

   public evs h(float $$0) {
      float $$1 = this.f($$0);
      ...
      return new evs((double)$$3, (double)$$4, (double)$$5);
   }
   ...
   public int a(iz $$0, dbk $$1) {
      fgk $$2 = (fgk)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(iz $$0, dbk $$1) {
      int $$2 = ffg.Q().m.E().c();
      if ($$2 == 0) {
   ...
   protected Map<epj, epl> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<epj, epl> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements eqe {
      ...
      public a(bqs $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new dbv();
   ...
   final class b implements dwl<bsv> {
      public void a(bsv $$0) {
      }
