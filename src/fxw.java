...
public class fxw extends fya {
   ...
   private final Map<dms, fxw.a> l;

   public fxw(fxn.a $$0) {
      super($$0);
      this.l = dms.a().collect(ImmutableMap.toImmutableMap($$0x -> $$0x, $$1 -> new fxw.a($$0.a(fpb.b($$1)))));
   }
