...
public class emh extends emf {
   public static final MapCodec<emh> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bsd.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  bsd.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
   ...
   private final bsd i;
   private final jv<dke> j;

   public emh(int $$0, int $$1, int $$2, bsd $$3, float $$4, bsd $$5, jv<dke> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<ekk.a> a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, ji $$4, eju $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new ekk.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dhf $$0, BiConsumer<ji, dxq> $$1, azh $$2, int $$3, eju $$4, List<ekk.a> $$5, ji.a $$6, int $$7, jn $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new ekk.a($$16, 0, false));
         $$5.add(new ekk.a($$16.c(2), 0, false));
      }
   }
