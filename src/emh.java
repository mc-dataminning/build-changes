...
public class emh implements eme {
   @Nullable
   ...
   public emh(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new emh.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements emd {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / emh.this.c;
         this.d = ($$5 + (float)$$0 + emh.this.e) / emh.this.c;
         this.e = (emh.this.h - (float)$$2 + emh.this.f) / emh.this.c;
         this.g = $$6;
      }
      ...
      public exx bake(Function<emf, exx> $$0) {
         return $$0.apply(new emf() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = emh.this.b();
               enc $$3 = new enc(enc.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, emh.this.g, emh.this.g, emh.this.e, emh.this.f, 0, 0);
