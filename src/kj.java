...
public final class kj {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ad.a($$0, 4).map(kj::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final zf<ByteBuf, UUID> g = new zf<ByteBuf, UUID>() {
