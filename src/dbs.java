...
public class dbs implements dat {
   ...
   public List<dcj> g() {
      return List.of(
         new dcn(this.c.a(), this.c.b(), this.c.c().stream().map($$0 -> $$0.<dcp>map(dba::c).orElse(dcp.c.c)).toList(), new dcp.f(this.d), new dcp.d(cwt.fc))
      );
   }
   ...
   public static class a implements dbo<dbs> {
      ...
      public static final yn<wa, dbs> x = yn.a(dbs.a::a, dbs.a::a);
      ...
      private static void a(wa $$0, dbs $$1) {
         $$0.a($$1.e);
         $$0.a($$1.f);
         dbt.c.encode($$0, $$1.c);
         cwp.h.encode($$0, $$1.d);
