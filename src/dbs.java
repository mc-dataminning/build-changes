...
public class dbs {
   ...
   private final Map<cmz, evt> r = Maps.newHashMap();

   public static brp a(dca $$0, @Nullable bsw $$1) {
      return $$0.aj().d($$1, b($$1));
   }

   public dbs(dca $$0, @Nullable bsw $$1, double $$2, double $$3, double $$4, float $$5, List<iz> $$6, dbs.a $$7, lg $$8, lg $$9, ji<avz> $$10) {
      this($$0, $$1, a($$0, $$1), null, $$2, $$3, $$4, $$5, false, $$7, $$8, $$9, $$10);
      this.q.addAll($$6);
   }

   public dbs(dca $$0, @Nullable bsw $$1, double $$2, double $$3, double $$4, float $$5, boolean $$6, dbs.a $$7, List<iz> $$8) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7);
      this.q.addAll($$8);
   }

   public dbs(dca $$0, @Nullable bsw $$1, double $$2, double $$3, double $$4, float $$5, boolean $$6, dbs.a $$7) {
   ...
   private dbt a(@Nullable bsw $$0) {
      return (dbt)($$0 == null ? a : new dbq($$0));
   }

   public static float a(evt $$0, bsw $$1) {
      evo $$2 = $$1.cK();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  evt $$16 = new evt($$13 + $$6, $$14, $$15 + $$7);
                  if ($$1.dP().a(new dbj($$16, $$0, dbj.a.a, dbj.b.a, $$1)).c() == evr.a.a) {
                     $$8++;
                  }
   ...
   public evt b() {
      return new evt(this.g, this.h, this.i);
   }

   public void c() {
      this.f.a(this.j, dwx.w, new evt(this.g, this.h, this.i));
      ...
      List<bsw> $$25 = this.f.a_(this.j, new evo((double)$$19, (double)$$21, (double)$$23, (double)$$20, (double)$$22, (double)$$24));
      evt $$26 = new evt(this.g, this.h, this.i);
      ...
      for (bsw $$27 : $$25) {
         if (!$$27.a(this)) {
            ...
            if ($$28 <= 1.0) {
               ...
               double $$30 = ($$27 instanceof cjk ? $$27.dw() : $$27.dy()) - this.h;
               ...
               if ($$32 != 0.0) {
                  ...
                  $$30 *= $$35;
                  $$31 *= $$35;
                  evt $$37 = new evt($$29, $$30, $$31);
                  $$27.h($$27.ds().e($$37));
                  if ($$27 instanceof cmz) {
                     cmz $$38 = (cmz)$$27;
   ...
   public void a(boolean $$0) {
      ...
      if ($$1) {
         ...
         List<Pair<cur, iz>> $$4 = new ArrayList<>();
         ...
         for (Pair<cur, iz> $$6 : $$4) {
            dfb.a(this.f, (iz)$$6.getSecond(), (cur)$$6.getFirst());
         }
      ...
      if (this.c) {
         ...
         while (var7.hasNext()) {
            ...
            if (this.e.a(3) == 0 && this.f.a_($$7).i() && this.f.a_($$7.d()).i(this.f, $$7.d())) {
               this.f.b($$7, deo.a(this.f, $$7));
            }
         }
      }
   }

   private static void a(List<Pair<cur, iz>> $$0, cur $$1, iz $$2) {
      for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
         Pair<cur, iz> $$4 = $$0.get($$3);
         cur $$5 = (cur)$$4.getFirst();
         if (cjj.a($$5, $$1)) {
            $$0.set($$3, Pair.of(cjj.a($$5, $$1, 16), (iz)$$4.getSecond()));
            if ($$1.e()) {
               return;
            }
         }
   ...
   public boolean d() {
      return this.d != dbs.a.a;
   }

   public Map<cmz, evt> e() {
      return this.r;
   }

   @Nullable
   private static btr b(@Nullable bsw $$0) {
      if ($$0 == null) {
         return null;
      } else if ($$0 instanceof cjk $$1) {
         return $$1.p();
      } else if ($$0 instanceof btr) {
         return (btr)$$0;
      } else {
