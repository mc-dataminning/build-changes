...
public class hoc extends MinecraftServer {
   ...
   public hoc(Thread $$0, fpt $$1, ezh.c $$2, aun $$3, amf $$4, amb $$5, asb $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hob(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public djj bd() {
      return this.r() && !this.r_() ? (djj)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
