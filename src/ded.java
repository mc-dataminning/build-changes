...
public record ded(lr d, ded.a e, ded.a f, ded.c g, ded.c h, brm i) implements ddq {
   public static final MapCodec<ded> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               brm.c.optionalFieldOf("speed", brk.a).forGetter(ded::h)
            )
            .apply($$0, ded::new)
   );
   ...
   public static ded.c b(float $$0) {
      return new ded.c($$0, brk.a);
   }

   public static ded.c a(brm $$0) {
   ...
   public static record c(float b, brm c) {
      public static final MapCodec<ded.c> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(Codec.FLOAT.optionalFieldOf("movement_scale", 0.0F).forGetter(ded.c::a), brm.c.optionalFieldOf("base", brk.a).forGetter(ded.c::b))
               .apply($$0, ded.c::new)
      );
