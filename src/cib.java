...
public class cib extends cia {
   ...
   private static final ajs<ctq> g = ajw.a(cib.class, aju.h);
   private static final ajs<Integer> h = ajw.a(cib.class, aju.b);
   public static final int e = 8;
   private float i = 1.0F;
   private boolean j;

   public cib(bsc<? extends cib> $$0, daz $$1) {
      super($$0, $$1);
   }

   public cib(daz $$0, io $$1, it $$2) {
      this(bsc.ai, $$0, $$1, $$2);
   }

   public cib(bsc<? extends cib> $$0, daz $$1, io $$2, it $$3) {
      super($$0, $$1, $$2);
      this.a($$3);
   }
   ...
   protected void y() {
      if (this.d != null) {
         ...
         $$5 /= 32.0;
         $$6 /= 32.0;
         this.a(new euh($$1 - $$4, $$2 - $$5, $$3 - $$6, $$1 + $$4, $$2 + $$5, $$3 + $$6));
      }
   }
   ...
   public boolean z() {
      if (this.j) {
         ...
         drd $$0 = this.dP().a_(this.c.a(this.d.g()));
         return $$0.e() || this.d.o().d() && dgc.m($$0) ? this.dP().a(this, this.cK(), b).isEmpty() : false;
      }
   }
   ...
   public boolean a(bqp $$0, float $$1) {
      if (this.j) {
         return !$$0.a(avz.e) && !$$0.g() ? false : super.a($$0, $$1);
      } else if (this.b($$0)) {
         return false;
      } else if (!$$0.a(avz.m) && !this.E().e()) {
         if (!this.dP().B) {
            this.b($$0.d(), false);
            this.a(dvw.c, $$0.d());
   ...
   private void b(@Nullable brw $$0, boolean $$1) {
      if (!this.j) {
         ctq $$2 = this.E();
         this.a(ctq.i);
   ...
   private void c(ctq $$0) {
      eoj $$1 = this.G();
      if ($$1 != null) {
         eol $$2 = cty.a($$1, this.dP());
         if ($$2 != null) {
            $$2.a(this.c, this.al());
            $$2.a(true);
         }
   ...
   public void a(ud $$0) {
      ...
      if ($$0.b("Item", 10)) {
         ud $$1 = $$0.p("Item");
         $$2 = ctq.a(this.dR(), (va)$$1).orElse(ctq.i);
      } else {
         $$2 = ctq.i;
      }
   ...
   public float dG() {
      ...
      return (float)ayf.b(180 + $$0.e() * 90 + this.I() * 45 + $$1);
   }
}
