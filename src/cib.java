...
public class cib {
   ...
   @Nullable
   public static feq a(bxm $$0, Supplier<iu> $$1) {
      return a($$1, $$0::c);
   }

   @Nullable
   public static feq a(Supplier<iu> $$0, ToDoubleFunction<iu> $$1) {
      ...
      return $$3 != null ? feq.c($$3) : null;
   }

   public static iu a(bxm $$0, int $$1, azv $$2, iu $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.gf() && $$1 > 1) {
         iu $$6 = $$0.gc();
