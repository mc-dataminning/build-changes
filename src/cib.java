...
public class cib extends btr implements cjv {
   private static final Logger cd = LogUtils.getLogger();
   public static final akk<Integer> b = ako.a(cib.class, akm.b);
   private static final ceg ce = ceg.a().a(64.0);
   ...
   public int d = -1;
   private final chz[] ck;
   public final chz e;
   private final chz cl;
   private final chz cm;
   private final chz cn;
   private final chz co;
   private final chz cp;
   private final chz cq;
   private final chz cr;
   public float bX;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private dvx cs;
   private iz ct = iz.c;
   private final cis cu;
   private int cv = 100;
   private float cw;
   private final eoh[] cx = new eoh[24];
   private final int[] cz = new int[24];
   private final eof cA = new eof();

   public cib(bta<? extends cib> $$0, dby $$1) {
      super(bta.F, $$1);
      this.e = new chz(this, "head", 1.0F, 1.0F);
      this.cl = new chz(this, "neck", 3.0F, 3.0F);
      this.cm = new chz(this, "body", 5.0F, 3.0F);
      this.cn = new chz(this, "tail", 2.0F, 2.0F);
      this.co = new chz(this, "tail", 2.0F, 2.0F);
      this.cp = new chz(this, "tail", 2.0F, 2.0F);
      this.cq = new chz(this, "wing", 4.0F, 2.0F);
      this.cr = new chz(this, "wing", 4.0F, 2.0F);
      this.ck = new chz[]{this.e, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.t(this.eR());
      this.ag = true;
      this.au = true;
      this.cu = new cis(this);
   }
         ...
         if (this.gg()) {
            ...
            if (this.dP().B) {
               ...
               if ($$9 != null) {
                  ...
                  this.r(ayz.g(this.dF()));
                  evr $$16 = $$9.a(this.du(), this.dw(), this.dA()).d();
                  evr $$17 = new evr((double)ayz.a(this.dF() * (float) (Math.PI / 180.0)), this.ds().d, (double)(-ayz.b(this.dF() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new evr(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(btu.a, this.ds().a(0.8F));
                  } else {
            ...
            this.aY = this.dF();
            evr[] $$24 = new evr[this.ck.length];

            for (int $$25 = 0; $$25 < this.ck.length; $$25++) {
               $$24[$$25] = new evr(this.ck[$$25].du(), this.ck[$$25].dw(), this.ck[$$25].dA());
            }
            ...
            if (!this.dP().B && this.aO == 0) {
               this.b(this.dP().a(this, this.cq.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsz.e));
               this.b(this.dP().a(this, this.cr.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsz.e));
               this.c(this.dP().a(this, this.e.cK().g(1.0), bsz.e));
               this.c(this.dP().a(this, this.cl.cK().g(1.0), bsz.e));
            }
   ...
   private void a(chz $$0, double $$1, double $$2, double $$3) {
   ...
   private void gq() {
      ...
      if (this.ah.a(10) == 0) {
         List<cia> $$0 = this.dP().a(cia.class, this.cK().g(32.0));
         cia $$1 = null;
   ...
   private void b(List<bsu> $$0) {
      ...
      for (bsu $$3 : $$0) {
         if ($$3 instanceof btp) {
            ...
            if (!this.cu.a().a() && ((btp)$$3).en() < $$3.ai - 2) {
               $$3.a(this.dQ().b((btp)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bsu> $$0) {
      for (bsu $$1 : $$0) {
         if ($$1 instanceof btp) {
            $$1.a(this.dQ().b((btp)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dsc $$13 = this.dP().a_($$12);
               if (!$$13.i() && !$$13.a(awp.aD)) {
                  if (this.dP().ab().b(dbu.c) && !$$13.a(awp.aC)) {
   ...
   public boolean a(chz $$0, brn $$1, float $$2) {
      if (this.cu.a().i() == cir.j) {
         return false;
      } else {
         $$2 = this.cu.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cmx || $$1.a(awr.z)) {
               float $$3 = this.eA();
               this.g($$1, $$2);
   ...
   protected boolean g(brn $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void eg() {
      ...
      if (this.dP() instanceof arf) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$3) {
            btf.a((arf)this.dP(), this.dn(), ayz.d((float)$$4 * 0.08F));
         }
      ...
      this.a(btu.a, new evr(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dP() instanceof arf) {
         if ($$3) {
            btf.a((arf)this.dP(), this.dn(), ayz.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(this.dP().z_() + 10, this.dP().a(dxu.a.f, new iz($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eoh($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eoh $$5 = new eoh(ayz.a($$0), ayz.a($$1), ayz.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eoj a(int $$0, int $$1, @Nullable eoh $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eoh $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eoj a(eoh $$0, eoh $$1) {
      ...
      return new eoj($$2, new iz($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(us $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(cir.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      cil $$3 = this.cu.a();
      cir<? extends cil> $$4 = $$3.i();
      double $$7;
      if ($$4 == cir.d || $$4 == cir.e) {
         iz $$5 = this.dP().a(dxu.a.f, eax.a(this.ct));
   ...
   public evr F(float $$0) {
      cil $$1 = this.cu.a();
      cir<? extends cil> $$2 = $$1.i();
      evr $$8;
      if ($$2 == cir.d || $$2 == cir.e) {
         iz $$3 = this.dP().a(dxu.a.f, eax.a(this.ct));
   ...
   public void a(cia $$0, iz $$1, brn $$2) {
      cmx $$3;
