...
public class crj extends cqv {
   ...
   public crj(bur<? extends crj> $$0, dgh $$1) {
      super($$0, $$1);
   }
   ...
   public boolean a(ard $$0, bta $$1, float $$2) {
      if ($$1.c() instanceof cpp $$4 && $$4.bY()) {
         bta $$5 = this.dW().d(this, $$1.d());
         this.a($$5, $$4.dy().h());
      }
   ...
   protected void a(@Nullable bta $$0, double $$1) {
      if (this.dV() instanceof ard $$2) {
         ...
         $$2.a(this, $$0, null, this.dA(), this.dC(), this.dG(), (float)((double)this.l + (double)this.m * this.ae.j() * 1.5 * $$3), false, dgh.a.d);
         this.at();
      }
   }
