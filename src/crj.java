...
public class crj extends crb {
   ...
   @Override
   public float d() {
      return this.f > 0 ? (float)this.k : this.n();
   }

   @Override
   public float e() {
      return this.f > 0 ? (float)this.j : this.o();
   }

   @Override
   public void a(double $$0, double $$1, double $$2) {
      this.l = new ezy($$0, $$1, $$2);
      this.a(this.l);
   }
   ...
   public void f() {
      if (this.g() instanceof arp $$0) {
         this.a.bf();
         jh var11 = this.a.n();
         dvv $$3 = this.g().a_(var11);
         boolean $$4 = dif.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(dis.hh)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dom.f));
            }
         } else {
            this.a.e($$0);
         }
         ...
         this.a.aK();
         this.a(0.0F);
         double $$5 = this.a.K - this.k();
         double $$6 = this.a.M - this.m();
         if ($$5 * $$5 + $$6 * $$6 > 0.001) {
         ...
         double $$7 = (double)azm.h(this.o() - this.a.N);
         if ($$7 < -170.0 || $$7 >= 170.0) {
            this.b(this.o() + 180.0F);
            this.a.b(!this.a.q());
         }
   ...
   public void a(arp $$0) {
      ...
      $$10 = new ezy($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bul $$20 = this.a.da();
      ezy $$22;
      if (this.a.da() instanceof arq $$21) {
         $$22 = $$21.aj();
      } else {
         $$22 = ezy.c;
      }

      if ($$20 instanceof cou && $$22.h() > 0.0) {
         ezy $$24 = $$22.d();
         double $$25 = this.i().j();
         if ($$24.h() > 0.0 && $$25 < 0.01) {
            this.a(this.i().b($$22.d * 0.001, 0.0, $$22.f * 0.001));
            $$8 = false;
         }
      }
      ...
      $$10 = this.i();
      this.a.a(bvl.a, new ezy(azm.a($$36 * $$10.d, -$$37, $$37), 0.0, azm.a($$36 * $$10.f, -$$37, $$37)));
      ...
      ezy $$38 = this.d(this.a.dA(), this.a.dC(), this.a.dG());
      if ($$38 != null && $$6 != null) {
   ...
   @Nullable
   public ezy a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = azm.a($$0);
      int $$5 = azm.a($$1);
      int $$6 = azm.a($$2);
      if (this.g().a_(new jh($$4, $$5 - 1, $$6)).a(axc.O)) {
         $$5--;
      }

      dvv $$7 = this.g().a_(new jh($$4, $$5, $$6));
      if (dif.h($$7)) {
         dwy $$8 = $$7.c(((dif)$$7.b()).c());
         $$1 = (double)$$5;
         if ($$8.b()) {
   ...
   public ezy d(double $$0, double $$1, double $$2) {
      ...
      int $$4 = azm.a($$1);
      int $$5 = azm.a($$2);
      if (this.g().a_(new jh($$3, $$4 - 1, $$5)).a(axc.O)) {
         $$4--;
      }

      dvv $$6 = this.g().a_(new jh($$3, $$4, $$5));
      if (dif.h($$6)) {
         dwy $$7 = $$6.c(((dif)$$6.b()).c());
         Pair<kl, kl> $$8 = cqt.a($$7);
         kl $$9 = (kl)$$8.getFirst();
   ...
   @Override
   public boolean h() {
      ezt $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.A() && this.i().j() >= 0.01) {
         ...
         for (bul $$3 : this.g().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bI() && $$3 instanceof cqt) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public jm p() {
      return this.a.q() ? this.a.cO().g().h() : this.a.cO().h();
   }

   @Override
   public ezy c(ezy $$0) {
      return new ezy(azm.a($$0.d, -0.4, 0.4), $$0.e, azm.a($$0.f, -0.4, 0.4));
   }
