...
public final class crj {
   ...
   private final aew<cqt>[][] C = new aew[][]{{cra.X, cra.V, cra.T, cra.R, cra.P}, {cra.W, cra.U, cra.S, cra.Q, cra.P}};
   private final aew<cqt>[][] D = new aew[][]{
   ...
   private final aew<cqt>[][] E = new aew[][]{
   ...
   private final aew<cqt>[][] F = new aew[][]{
   ...
   private final aew<cqt>[][] G = new aew[][]{
   ...
   private final aew<cqt>[][] H = new aew[][]{
   ...
   protected void a(Consumer<Pair<crc.d, aew<cqt>>> $$0) {
      if (aa.aq) {
         this.b($$0);
      } else {
         this.c($$0);
   ...
   private void b(Consumer<Pair<crc.d, aew<cqt>>> $$0) {
      hi.b $$1 = mj.a();
      hh<dkl> $$2 = $$1.b(je.at);
   ...
   private void c(Consumer<Pair<crc.d, aew<cqt>>> $$0) {
   ...
   private void d(Consumer<Pair<crc.d, aew<cqt>>> $$0) {
   ...
   private void a(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1) {
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         crc.b $$3 = this.p[$$2];

         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            crc.b $$5 = this.q[$$4];
            aew<cqt> $$6 = this.a($$2, $$4, $$1);
            aew<cqt> $$7 = this.b($$2, $$4, $$1);
            aew<cqt> $$8 = this.c($$2, $$4, $$1);
            aew<cqt> $$9 = this.e($$2, $$4, $$1);
            aew<cqt> $$10 = this.h($$2, $$4, $$1);
            aew<cqt> $$11 = this.a($$2, $$4, $$1, $$10);
            aew<cqt> $$12 = this.f($$2, $$4, $$1);
   ...
   private void b(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1) {
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         crc.b $$3 = this.p[$$2];
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            aew<cqt> $$9 = this.e($$2, $$4, $$1);
            aew<cqt> $$10 = this.h($$2, $$4, $$1);
            aew<cqt> $$11 = this.a($$2, $$4, $$1, $$6);
            aew<cqt> $$12 = this.g($$2, $$4, $$1);
            aew<cqt> $$13 = this.f($$2, $$4, $$1);
   ...
   private void c(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1) {
      ...
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            aew<cqt> $$7 = this.b($$2, $$4, $$1);
            aew<cqt> $$8 = this.c($$2, $$4, $$1);
            aew<cqt> $$9 = this.h($$2, $$4, $$1);
            aew<cqt> $$10 = this.e($$2, $$4, $$1);
            aew<cqt> $$11 = this.a($$2, $$4);
            aew<cqt> $$12 = this.a($$2, $$4, $$1, $$6);
            aew<cqt> $$13 = this.d($$2, $$4, $$1);
            aew<cqt> $$14 = this.g($$2, $$4, $$1);
   ...
   private void d(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1) {
      this.a($$0, this.o, this.o, this.x, crc.b.a(this.r[0], this.r[2]), $$1, 0.0F, cra.O);
      this.a($$0, crc.b.a(this.p[1], this.p[2]), this.o, crc.b.a(this.z, this.B), this.r[6], $$1, 0.0F, cra.g);
      this.a($$0, crc.b.a(this.p[3], this.p[4]), this.o, crc.b.a(this.z, this.B), this.r[6], $$1, 0.0F, cra.h);
      ...
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            aew<cqt> $$7 = this.b($$2, $$4, $$1);
            aew<cqt> $$8 = this.c($$2, $$4, $$1);
            aew<cqt> $$9 = this.a($$2, $$4);
            aew<cqt> $$10 = this.a($$2, $$4, $$1, $$6);
            aew<cqt> $$11 = this.d($$2, $$4, $$1);
   ...
   private void e(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1) {
   ...
   private aew<cqt> a(int $$0, int $$1, crc.b $$2) {
      if ($$2.b() < 0L) {
         return this.D[$$0][$$1];
      } else {
         aew<cqt> $$3 = this.E[$$0][$$1];
         return $$3 == null ? this.D[$$0][$$1] : $$3;
      }
   }

   private aew<cqt> b(int $$0, int $$1, crc.b $$2) {
      return $$0 == 4 ? this.a($$1, $$2) : this.a($$0, $$1, $$2);
   }

   private aew<cqt> c(int $$0, int $$1, crc.b $$2) {
      return $$0 == 0 ? this.g($$0, $$1, $$2) : this.b($$0, $$1, $$2);
   }

   private aew<cqt> a(int $$0, int $$1, crc.b $$2, aew<cqt> $$3) {
      return $$0 > 1 && $$1 < 4 && $$2.b() >= 0L ? cra.w : $$3;
   }

   private aew<cqt> d(int $$0, int $$1, crc.b $$2) {
      aew<cqt> $$3 = $$2.b() >= 0L ? this.a($$0, $$1, $$2) : this.a($$0, $$1);
      return this.a($$0, $$1, $$2, $$3);
   }

   private aew<cqt> a(int $$0, int $$1) {
      if ($$0 == 0) {
         return cra.N;
      } else {
   ...
   private aew<cqt> a(int $$0, crc.b $$1) {
      if ($$0 < 2) {
   ...
   private aew<cqt> e(int $$0, int $$1, crc.b $$2) {
      if ($$2.b() >= 0L) {
         aew<cqt> $$3 = this.G[$$0][$$1];
         if ($$3 != null) {
            return $$3;
         }
      }
   ...
   private aew<cqt> f(int $$0, int $$1, crc.b $$2) {
      if ($$0 <= 2) {
   ...
   private aew<cqt> g(int $$0, int $$1, crc.b $$2) {
      if ($$0 >= 3) {
         return this.e($$0, $$1, $$2);
      } else {
   ...
   private aew<cqt> h(int $$0, int $$1, crc.b $$2) {
      aew<cqt> $$3 = this.H[$$0][$$1];
      return $$3 == null ? this.a($$0, $$1, $$2) : $$3;
   }

   private void a(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1, crc.b $$2, crc.b $$3, crc.b $$4, crc.b $$5, float $$6, aew<cqt> $$7) {
      $$0.accept(Pair.of(crc.a($$1, $$2, $$3, $$4, crc.b.a(0.0F), $$5, $$6), $$7));
      $$0.accept(Pair.of(crc.a($$1, $$2, $$3, $$4, crc.b.a(1.0F), $$5, $$6), $$7));
   }

   private void b(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1, crc.b $$2, crc.b $$3, crc.b $$4, crc.b $$5, float $$6, aew<cqt> $$7) {
      $$0.accept(Pair.of(crc.a($$1, $$2, $$3, $$4, crc.b.a(0.2F, 0.9F), $$5, $$6), $$7));
   }

   private void c(Consumer<Pair<crc.d, aew<cqt>>> $$0, crc.b $$1, crc.b $$2, crc.b $$3, crc.b $$4, crc.b $$5, float $$6, aew<cqt> $$7) {
