...
public class gpe implements gpk.a {
   ...
   private final fmf F;
   private final Map<jh, gpe.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bvj $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dR();
      });
   }

   private void b(fgr $$0, glk $$1, double $$2, double $$3, double $$4) {
      jh $$5 = jh.a($$2, $$3, $$4);
   ...
   private void a(fgr $$0, glk $$1, gpe.a $$2) {
      int $$3 = 0;
   ...
   private void a(fgr $$0, glk $$1, abc.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gpt.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fgr $$0, glk $$1, abc.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fgr $$0, glk $$1, String $$2, gpe.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      gpk.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
