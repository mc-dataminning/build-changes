...
public class gpe {
   ...
   static final jo[] c = jo.values();
   private final fof d;
   private static final int e = 100;
   static final ThreadLocal<gpe.d> f = ThreadLocal.withInitial(gpe.d::new);

   public gpe(fof $$0) {
      this.d = $$0;
   }

   public void a(dgs $$0, his $$1, dym $$2, jj $$3, fho $$4, fhs $$5, boolean $$6, azs $$7, long $$8, int $$9) {
      boolean $$10 = fnd.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(dgs $$0, his $$1, dym $$2, jj $$3, fho $$4, fhs $$5, boolean $$6, azs $$7, long $$8, int $$9) {
      ...
      for (jo $$14 : c) {
         $$7.b($$8);
         List<gpf> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dku.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gpf> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dgs $$0, his $$1, dym $$2, jj $$3, fho $$4, fhs $$5, boolean $$6, azs $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jj.a $$11 = $$3.k();

      for (jo $$12 : c) {
         $$7.b($$8);
         List<gpf> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dku.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = gnu.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gpf> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dgs $$0, dym $$1, jj $$2, fho $$3, fhs $$4, List<gpf> $$5, float[] $$6, BitSet $$7, gpe.b $$8, int $$9) {
      for (gpf $$10 : $$5) {
   ...
   private void a(
      dgs $$0, dym $$1, jj $$2, fhs $$3, fho.a $$4, gpf $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dgs $$0, dym $$1, jj $$2, int[] $$3, jo $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dgs $$0, dym $$1, jj $$2, int $$3, int $$4, boolean $$5, fho $$6, fhs $$7, List<gpf> $$8, BitSet $$9) {
      for (gpf $$10 : $$8) {
         if ($$5) {
            this.a($$0, $$1, $$2, $$10.b(), $$10.e(), null, $$9);
            jj $$11 = $$9.get(0) ? $$2.a($$10.e()) : $$2;
            $$3 = gnu.a($$0, $$1, $$11);
         }
   ...
   public void a(fho.a $$0, fhs $$1, @Nullable dym $$2, his $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azs $$9 = azs.a();
      long $$10 = 42L;
   ...
   private static void a(fho.a $$0, fhs $$1, float $$2, float $$3, float $$4, List<gpf> $$5, int $$6, int $$7) {
      for (gpf $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = azk.a($$2, 0.0F, 1.0F);
            $$10 = azk.a($$3, 0.0F, 1.0F);
            $$11 = azk.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         new jo[]{jo.e, jo.f, jo.c, jo.d},
         0.5F,
         true,
         new gpe.e[]{gpe.e.k, gpe.e.d, gpe.e.k, gpe.e.j, gpe.e.e, gpe.e.j, gpe.e.e, gpe.e.d},
         new gpe.e[]{gpe.e.k, gpe.e.c, gpe.e.k, gpe.e.i, gpe.e.e, gpe.e.i, gpe.e.e, gpe.e.c},
         new gpe.e[]{gpe.e.l, gpe.e.c, gpe.e.l, gpe.e.i, gpe.e.f, gpe.e.i, gpe.e.f, gpe.e.c},
         new gpe.e[]{gpe.e.l, gpe.e.d, gpe.e.l, gpe.e.j, gpe.e.f, gpe.e.j, gpe.e.f, gpe.e.d}
      ),
      b(
         new jo[]{jo.f, jo.e, jo.c, jo.d},
         1.0F,
         true,
         new gpe.e[]{gpe.e.f, gpe.e.d, gpe.e.f, gpe.e.j, gpe.e.l, gpe.e.j, gpe.e.l, gpe.e.d},
         new gpe.e[]{gpe.e.f, gpe.e.c, gpe.e.f, gpe.e.i, gpe.e.l, gpe.e.i, gpe.e.l, gpe.e.c},
         new gpe.e[]{gpe.e.e, gpe.e.c, gpe.e.e, gpe.e.i, gpe.e.k, gpe.e.i, gpe.e.k, gpe.e.c},
         new gpe.e[]{gpe.e.e, gpe.e.d, gpe.e.e, gpe.e.j, gpe.e.k, gpe.e.j, gpe.e.k, gpe.e.d}
      ),
      c(
         new jo[]{jo.b, jo.a, jo.f, jo.e},
         0.8F,
         true,
         new gpe.e[]{gpe.e.b, gpe.e.k, gpe.e.b, gpe.e.e, gpe.e.h, gpe.e.e, gpe.e.h, gpe.e.k},
         new gpe.e[]{gpe.e.b, gpe.e.l, gpe.e.b, gpe.e.f, gpe.e.h, gpe.e.f, gpe.e.h, gpe.e.l},
         new gpe.e[]{gpe.e.a, gpe.e.l, gpe.e.a, gpe.e.f, gpe.e.g, gpe.e.f, gpe.e.g, gpe.e.l},
         new gpe.e[]{gpe.e.a, gpe.e.k, gpe.e.a, gpe.e.e, gpe.e.g, gpe.e.e, gpe.e.g, gpe.e.k}
      ),
      d(
         new jo[]{jo.e, jo.f, jo.a, jo.b},
         0.8F,
         true,
         new gpe.e[]{gpe.e.b, gpe.e.k, gpe.e.h, gpe.e.k, gpe.e.h, gpe.e.e, gpe.e.b, gpe.e.e},
         new gpe.e[]{gpe.e.a, gpe.e.k, gpe.e.g, gpe.e.k, gpe.e.g, gpe.e.e, gpe.e.a, gpe.e.e},
         new gpe.e[]{gpe.e.a, gpe.e.l, gpe.e.g, gpe.e.l, gpe.e.g, gpe.e.f, gpe.e.a, gpe.e.f},
         new gpe.e[]{gpe.e.b, gpe.e.l, gpe.e.h, gpe.e.l, gpe.e.h, gpe.e.f, gpe.e.b, gpe.e.f}
      ),
      e(
         new jo[]{jo.b, jo.a, jo.c, jo.d},
         0.6F,
         true,
         new gpe.e[]{gpe.e.b, gpe.e.d, gpe.e.b, gpe.e.j, gpe.e.h, gpe.e.j, gpe.e.h, gpe.e.d},
         new gpe.e[]{gpe.e.b, gpe.e.c, gpe.e.b, gpe.e.i, gpe.e.h, gpe.e.i, gpe.e.h, gpe.e.c},
         new gpe.e[]{gpe.e.a, gpe.e.c, gpe.e.a, gpe.e.i, gpe.e.g, gpe.e.i, gpe.e.g, gpe.e.c},
         new gpe.e[]{gpe.e.a, gpe.e.d, gpe.e.a, gpe.e.j, gpe.e.g, gpe.e.j, gpe.e.g, gpe.e.d}
      ),
      f(
         new jo[]{jo.a, jo.b, jo.c, jo.d},
         0.6F,
         true,
         new gpe.e[]{gpe.e.g, gpe.e.d, gpe.e.g, gpe.e.j, gpe.e.a, gpe.e.j, gpe.e.a, gpe.e.d},
         new gpe.e[]{gpe.e.g, gpe.e.c, gpe.e.g, gpe.e.i, gpe.e.a, gpe.e.i, gpe.e.a, gpe.e.c},
         new gpe.e[]{gpe.e.h, gpe.e.c, gpe.e.h, gpe.e.i, gpe.e.b, gpe.e.i, gpe.e.b, gpe.e.c},
         new gpe.e[]{gpe.e.h, gpe.e.d, gpe.e.h, gpe.e.j, gpe.e.b, gpe.e.j, gpe.e.b, gpe.e.d}
      );
      ...
      final gpe.e[] k;
      final gpe.e[] l;
      private static final gpe.a[] m = af.a(new gpe.a[6], $$0 -> {
         $$0[jo.a.d()] = a;
         $$0[jo.b.d()] = b;
         $$0[jo.c.d()] = c;
         $$0[jo.d.d()] = d;
      ...
      private a(final jo[] $$0, final float $$1, final boolean $$2, final gpe.e[] $$3, final gpe.e[] $$4, final gpe.e[] $$5, final gpe.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dgs $$0, dym $$1, jj $$2, jo $$3, float[] $$4, BitSet $$5, boolean $$6) {
         jj $$7 = $$5.get(0) ? $$2.a($$3) : $$2;
         gpe.a $$8 = gpe.a.a($$3);
         jj.a $$9 = new jj.a();
         gpe.d $$10 = gpe.f.get();
         $$9.a($$7, $$8.g[0]);
         ...
         dym $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dym $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dym $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dym $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gpe.c[] k = af.a(new gpe.c[6], $$0 -> {
         $$0[jo.a.d()] = a;
         $$0[jo.b.d()] = b;
         $$0[jo.c.d()] = c;
         $$0[jo.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dym $$0, dgs $$1, jj $$2) {
         long $$3 = $$2.a();
         if (this.a) {
   ...
   protected static enum e {
      ...
      private e(final jo $$0, final boolean $$1) {
         this.m = $$0.d() + ($$1 ? gpe.c.length : 0);
      }
   }
}
