...
public abstract class gpe extends fhh {
   ...
   private final List<gpc> a = Lists.newArrayList();
   ...
   protected gpc a(gpc $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public vu o() {
      return vt.a(this.a.stream().map(gpc::a).collect(Collectors.toList()));
   }
}
