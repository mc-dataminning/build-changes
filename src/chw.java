...
public class chw {
   ...
   private static void b(buq<chv> $$0) {
      $$0.a(col.a, 0, ImmutableList.of(new byb(0.8F), new bvc<chv>(2.0F) {
         protected void a(are $$0, chv $$1, long $$2) {
            chw.b($$1);
            super.b($$0, $$1, $$2);
         }
   ...
   private static void c(buq<chv> $$0) {
      $$0.a(col.v, ImmutableList.of(Pair.of(0, new chw.e())), Set.of(Pair.of(ccs.Z, cct.b), Pair.of(ccs.aR, cct.a), Pair.of(ccs.m, cct.a)));
   }
   ...
   private static void e(buq<chv> $$0) {
      $$0.a(
         ...
         ImmutableList.of(
            ...
            Pair.of(1, new bvu($$0x -> 1.25F, $$0x -> $$0x.p_() ? 2.5 : 3.5) {
               @Override
   ...
   static void a(chv $$0) {
      $$0.dS().a(ImmutableList.of(col.z, col.v, col.b));
   }
   ...
   static class a extends bvh<chv> {
      ...
      protected boolean a(are $$0, chv $$1) {
         return $$1.gq();
      }

      protected boolean a(are $$0, chv $$1, long $$2) {
         return $$1.dS().c(ccs.aS).isPresent() && $$1.gy() && !$$1.gu();
      }

      protected void b(are $$0, chv $$1, long $$2) {
         $$1.a(chv.a.f);
      }

      protected void c(are $$0, chv $$1, long $$2) {
         boolean $$3 = this.a($$2);
         if ($$3) {
            $$1.dS().a(ccs.aG, bab.a, 9600L);
         } else {
            chw.b($$1);
         }
      }
   ...
   static class c extends bvh<chv> {
      ...
      protected boolean a(are $$0, chv $$1, long $$2) {
         return $$1.dS().c(ccs.aS).isPresent();
      }
   ...
   static class e extends bvh<chv> {
      ...
      protected boolean a(are $$0, chv $$1, long $$2) {
         if (!$$1.gq()) {
            ...
            Optional<iz> $$3 = $$1.dS().c(ccs.m).map(ccv::a).map(bwv::b);
            Optional<iz> $$4 = $$1.dS().c(ccs.aR);
   ...
   static class f extends bvh<chv> {
      ...
      protected void c(are $$0, chv $$1, long $$2) {
         ...
         if ($$3) {
            $$1.gx().ifPresent($$1x -> {
               $$1.dS().a(ccs.aR, $$1x);
               $$1.dS().a(ccs.m, new ccv($$1x, 1.25F, 0));
            });
         }
      }
   }
