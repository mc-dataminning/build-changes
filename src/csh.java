...
public class csh extends cse {
   ...
   public csh(bwr<? extends csh> $$0, djh $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public csh(djh $$0, bxj $$1, bwi $$2, jb.a $$3) {
      this(bwr.bd, $$0);
      this.c($$1);
      fex $$4 = $$1.cQ().f();
   ...
   public void h() {
      ...
      if (!this.dU().C) {
         ...
         if (this.b == null || !this.b.bI() || this.b instanceof crj && this.b.V_()) {
            this.bd();
         } else {
   ...
   private void g() {
      this.aq();
      this.dU().a(efo.o, this.ds(), efo.a.a(this));
   }
