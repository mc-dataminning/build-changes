...
public class csh extends crp {
   ...
   public csh(int $$0, col $$1) {
      this($$0, $$1, csb.a);
   }

   public csh(int $$0, col $$1, csb $$2) {
      super(csx.m, $$0, 3, 3);
      this.y = $$2;
      this.z = $$1.k;
   ...
   protected static void a(cro $$0, dfb $$1, com $$2, csg $$3, ctg $$4, @Nullable dar<daf> $$5) {
      if (!$$1.C) {
         dae $$6 = $$3.aC_();
         aro $$7 = (aro)$$2;
         cwb $$8 = cwb.k;
         Optional<dar<daf>> $$9 = $$1.o().aI().a(dav.a, $$6, $$1, $$5);
         if ($$9.isPresent()) {
            dar<daf> $$10 = $$9.get();
            daf $$11 = $$10.b();
            if ($$4.a($$1, $$7, $$10)) {
