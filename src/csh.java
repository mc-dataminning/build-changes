...
public class csh extends csc {
   ...
   public csh(int $$0, bsd $$1) {
      this($$0, $$1, new cty(3), csp.a);
   }

   public csh(int $$0, bsd $$1, cso $$2, csp $$3) {
      super(ctl.j, $$0);
      a($$2, 3);
      this.x = $$2;
      this.w = $$3;
   ...
   public static int a(@Nullable jr<bto> $$0) {
      return $$0 == null ? 0 : mb.d.t().a($$0) + 1;
   }

   @Nullable
   public static jr<bto> e(int $$0) {
   ...
   public void a(Optional<jr<bto>> $$0, Optional<jr<bto>> $$1) {
      if (this.v.h()) {
