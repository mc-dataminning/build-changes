public class goq extends gog {
   goq(gkl $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, gop $$8) {
   ...
   public static class a implements gnx<mc> {
      ...
      public gnu a(mc $$0, gkl $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new goq($$1, $$2, $$3, $$4, $$5, $$6, $$7, axw.a(255, 204, 31, 102), this.a);
      }
   }
   ...
   public static class b implements gnx<mc> {
      ...
      public gnu a(mc $$0, gkl $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new goq($$1, $$2, $$3, $$4, $$5, $$6, $$7, axw.a(255, 255, 255, 255), this.a);
      }
   }
}
