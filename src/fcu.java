...
public class fcu extends gvg {
   ...
   public fcu(BooleanConsumer $$0, fcu.a $$1, xp $$2, xp $$3, boolean $$4) {
      super(fex.a);
      this.a = $$0;
      this.B = $$1;
      this.C = $$2;
   ...
   public void aM_() {
      if (this.E) {
         this.c(fhe.a(xo.f, $$0 -> this.a.accept(true)).a(this.n / 2 - 105, g(8), 100, 20).a());
         this.c(fhe.a(xo.g, $$0 -> this.a.accept(false)).a(this.n / 2 + 5, g(8), 100, 20).a());
      } else {
         this.c(fhe.a(xo.h, $$0 -> this.a.accept(true)).a(this.n / 2 - 50, g(8), 100, 20).a());
      }
   }
