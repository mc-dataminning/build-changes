...
public class fcu extends esk {
   ...
   private fcu.a c(boolean $$0) {
      fcu.b $$1 = new fcu.b(this.w());
      List<gdz> $$2 = new ArrayList<>(gdz.g());
      $$2.sort(Comparator.comparing(gdz::d));
      if (!$$0) {
         $$2.removeIf(gdz::d);
      }
   ...
   static class b {
      ...
      public fcu.a a() {
         this.b.a();
         return new fcu.a(this.b, this.c);
      }
   }
}
