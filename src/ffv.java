...
public class ffv implements AutoCloseable {
   ...
   public ffv(fdm $$0) {
      ...
      this.b = new fdn(fdl.a, $$0, 0);
      this.d = GlStateManager._glGenVertexArrays();
   }

   public static ffv a(ffx.c $$0, ffx $$1, Consumer<ffw> $$2) {
      ffn $$3 = ffu.b().a($$0, $$1);
      $$2.accept($$3);
      ffv $$4 = new ffv(fdm.b);
      $$4.a();
   ...
   public void a(ffp.a $$0) {
      ...
      label46: {
         try {
            ...
            this.c = new fdn(fdl.b, this.a, $$0.a());
            this.f = null;
         } catch (Throwable var6) {
            if ($$0 != null) {
               try {
   ...
   private ffx a(ffr.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(ffr.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
         if (this.c != null) {
            this.c.close();
         }

         this.c = new fdn(fdl.b, this.a, $$1);
         return null;
      } else {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, @Nullable glf $$2) {
      if ($$2 != null) {
         RenderSystem.assertOnRenderThread();
         $$2.a(this.i, $$0, $$1, flh.Q().aO());
         $$2.b();
         this.c();
         $$2.a();
      }
