...
public abstract class ffv<E extends ffv.a<E>> extends ffs {
   protected static final int b = 6;
   private static final akn a = new akn("widget/scroller");
   private static final akn m = new akn("widget/scroller_background");
   private static final akn n = new akn("textures/gui/menu_list_background.png");
   private static final akn o = new akn("textures/gui/inworld_menu_list_background.png");
   protected final feb c;
   protected final int d;
   private final List<E> p = new ffv.b();
   ...
   public ffv(feb $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, ww.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayf.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aF_().get($$7) : null;
   }

   public void a(int $$0, fjn $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(ffn $$0) {
      RenderSystem.enableBlend();
      akn $$1 = this.c.r == null ? flz.h : flz.j;
      akn $$2 = this.c.r == null ? flz.i : flz.k;
   ...
   public void a(double $$0) {
      this.q = ayf.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = ayf.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fke $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fke $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void c(ffn $$0, int $$1, int $$2, float $$3) {
      int $$4 = this.r();
      int $$5 = this.b();
      int $$6 = this.d - 4;
      int $$7 = this.l();
   ...
   protected void a(ffn $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public fju.a t() {
      if (this.aJ_()) {
         ...
         return this.v != null ? fju.a.b : fju.a.a;
      }
   }
   ...
   protected void a(fjw $$0, E $$1) {
      List<E> $$2 = this.aF_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fjv.b, wx.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends ffv.a<E>> implements fhw {
      @Deprecated
      ffv<E> a;
      ...
      public abstract void a(ffn var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
