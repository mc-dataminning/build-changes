...
public class gfp extends si {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gfp(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gfp a(aqh $$0, List<String> $$1, boolean $$2) {
      ...
      return new gfp(ImmutableMap.copyOf($$3), $$2);
   }
