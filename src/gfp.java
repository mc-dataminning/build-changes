...
public class gfp implements ggj {
   ...
   private CompletableFuture<Optional<cox>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gfp(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cox::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cox>> a(Optional<cox> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cox.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cox $$0) {
      ...
      if ($$0 != null) {
         if (ab.aU) {
            cox.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cox a(UserApiService $$0) throws axx, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         coy.a $$2 = a($$1);
         return new cox(axw.a($$1.keyPair().privateKey()), new coy($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static coy.a a(KeyPairResponse $$0) throws axx {
      KeyPair $$1 = $$0.keyPair();
