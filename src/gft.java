...
public class gft {
   ...
   public boolean a(jh $$0) {
      if (this.b.t.a(this.b.s, $$0, this.j)) {
         ...
         if (!this.b.t.eZ().h().a($$2, $$1, $$0, this.b.t)) {
            ...
            dkl $$3 = $$2.b();
            if ($$3 instanceof dnu && !this.b.t.gG()) {
               return false;
            } else if ($$2.l()) {
               return false;
            } else {
   ...
   public boolean b(jh $$0, jm $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.l()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               dsb $$4 = $$3.A();
               this.b.ak().a(new hfc($$4.f(), axg.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, hfh.t(), $$0));
            }
   ...
   public bti a(gkg $$0, bth $$1, fbt $$2) {
      this.m();
   ...
   private bti b(gkg $$0, bth $$1, fbt $$2) {
      jh $$3 = $$2.b();
      cxo $$4 = $$0.b($$1);
      if (this.j == dhe.d) {
         return bti.c;
   ...
   public gkg a(gfj $$0, axq $$1, flq $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public gkg a(gfj $$0, axq $$1, flq $$2, boolean $$3, boolean $$4) {
      return new gkg(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }
   ...
   public void a(cxo $$0) {
      boolean $$1 = this.b.z instanceof fum && !(this.b.z instanceof fvc);
   ...
   public boolean g() {
      return this.b.t.bZ() && this.b.t.dl() instanceof bvy;
   }
