...
public class gft implements ggn {
   ...
   private CompletableFuture<Optional<cpa>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gft(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cpa::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cpa>> a(Optional<cpa> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cpa.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cpa $$0) {
      ...
      if ($$0 != null) {
         if (ab.aU) {
            cpa.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cpa a(UserApiService $$0) throws axy, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cpb.a $$2 = a($$1);
         return new cpa(axx.a($$1.keyPair().privateKey()), new cpb($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cpb.a a(KeyPairResponse $$0) throws axy {
      KeyPair $$1 = $$0.keyPair();
