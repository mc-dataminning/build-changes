...
public class gft {
   ...
   static final ThreadLocal<gft.d> f = ThreadLocal.withInitial(gft.d::new);

   public gft(fho $$0) {
      this.d = $$0;
   }

   public void a(dbz $$0, gsk $$1, dtc $$2, jd $$3, fbg $$4, fbk $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      boolean $$10 = fgm.P() && $$2.h() == 0 && $$1.a();
      exa $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(dbz $$0, gsk $$1, dtc $$2, jd $$3, fbg $$4, fbk $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      ...
      for (ji $$14 : c) {
         $$7.b($$8);
         List<gfu> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dfy.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<gfu> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dbz $$0, gsk $$1, dtc $$2, jd $$3, fbg $$4, fbk $$5, boolean $$6, ayw $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jd.a $$11 = $$3.k();

      for (ji $$12 : c) {
         $$7.b($$8);
         List<gfu> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dfy.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = gev.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gfu> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dbz $$0, dtc $$1, jd $$2, fbg $$3, fbk $$4, List<gfu> $$5, float[] $$6, BitSet $$7, gft.b $$8, int $$9) {
      for (gfu $$10 : $$5) {
   ...
   private void a(
      dbz $$0, dtc $$1, jd $$2, fbk $$3, fbg.a $$4, gfu $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dbz $$0, dtc $$1, jd $$2, int[] $$3, ji $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dbz $$0, dtc $$1, jd $$2, int $$3, int $$4, boolean $$5, fbg $$6, fbk $$7, List<gfu> $$8, BitSet $$9) {
      for (gfu $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fbg.a $$0, fbk $$1, @Nullable dtc $$2, gsk $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      ayw $$9 = ayw.a();
      long $$10 = 42L;
   ...
   private static void a(fbg.a $$0, fbk $$1, float $$2, float $$3, float $$4, List<gfu> $$5, int $$6, int $$7) {
      for (gfu $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = ayo.a($$2, 0.0F, 1.0F);
            $$10 = ayo.a($$3, 0.0F, 1.0F);
            $$11 = ayo.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gft.e[]{gft.e.k, gft.e.d, gft.e.k, gft.e.j, gft.e.e, gft.e.j, gft.e.e, gft.e.d},
         new gft.e[]{gft.e.k, gft.e.c, gft.e.k, gft.e.i, gft.e.e, gft.e.i, gft.e.e, gft.e.c},
         new gft.e[]{gft.e.l, gft.e.c, gft.e.l, gft.e.i, gft.e.f, gft.e.i, gft.e.f, gft.e.c},
         new gft.e[]{gft.e.l, gft.e.d, gft.e.l, gft.e.j, gft.e.f, gft.e.j, gft.e.f, gft.e.d}
      ),
      b(
         new ji[]{ji.f, ji.e, ji.c, ji.d},
         1.0F,
         true,
         new gft.e[]{gft.e.f, gft.e.d, gft.e.f, gft.e.j, gft.e.l, gft.e.j, gft.e.l, gft.e.d},
         new gft.e[]{gft.e.f, gft.e.c, gft.e.f, gft.e.i, gft.e.l, gft.e.i, gft.e.l, gft.e.c},
         new gft.e[]{gft.e.e, gft.e.c, gft.e.e, gft.e.i, gft.e.k, gft.e.i, gft.e.k, gft.e.c},
         new gft.e[]{gft.e.e, gft.e.d, gft.e.e, gft.e.j, gft.e.k, gft.e.j, gft.e.k, gft.e.d}
      ),
      c(
         new ji[]{ji.b, ji.a, ji.f, ji.e},
         0.8F,
         true,
         new gft.e[]{gft.e.b, gft.e.k, gft.e.b, gft.e.e, gft.e.h, gft.e.e, gft.e.h, gft.e.k},
         new gft.e[]{gft.e.b, gft.e.l, gft.e.b, gft.e.f, gft.e.h, gft.e.f, gft.e.h, gft.e.l},
         new gft.e[]{gft.e.a, gft.e.l, gft.e.a, gft.e.f, gft.e.g, gft.e.f, gft.e.g, gft.e.l},
         new gft.e[]{gft.e.a, gft.e.k, gft.e.a, gft.e.e, gft.e.g, gft.e.e, gft.e.g, gft.e.k}
      ),
      d(
         new ji[]{ji.e, ji.f, ji.a, ji.b},
         0.8F,
         true,
         new gft.e[]{gft.e.b, gft.e.k, gft.e.h, gft.e.k, gft.e.h, gft.e.e, gft.e.b, gft.e.e},
         new gft.e[]{gft.e.a, gft.e.k, gft.e.g, gft.e.k, gft.e.g, gft.e.e, gft.e.a, gft.e.e},
         new gft.e[]{gft.e.a, gft.e.l, gft.e.g, gft.e.l, gft.e.g, gft.e.f, gft.e.a, gft.e.f},
         new gft.e[]{gft.e.b, gft.e.l, gft.e.h, gft.e.l, gft.e.h, gft.e.f, gft.e.b, gft.e.f}
      ),
      e(
         new ji[]{ji.b, ji.a, ji.c, ji.d},
         0.6F,
         true,
         new gft.e[]{gft.e.b, gft.e.d, gft.e.b, gft.e.j, gft.e.h, gft.e.j, gft.e.h, gft.e.d},
         new gft.e[]{gft.e.b, gft.e.c, gft.e.b, gft.e.i, gft.e.h, gft.e.i, gft.e.h, gft.e.c},
         new gft.e[]{gft.e.a, gft.e.c, gft.e.a, gft.e.i, gft.e.g, gft.e.i, gft.e.g, gft.e.c},
         new gft.e[]{gft.e.a, gft.e.d, gft.e.a, gft.e.j, gft.e.g, gft.e.j, gft.e.g, gft.e.d}
      ),
      f(
         new ji[]{ji.a, ji.b, ji.c, ji.d},
         0.6F,
         true,
         new gft.e[]{gft.e.g, gft.e.d, gft.e.g, gft.e.j, gft.e.a, gft.e.j, gft.e.a, gft.e.d},
         new gft.e[]{gft.e.g, gft.e.c, gft.e.g, gft.e.i, gft.e.a, gft.e.i, gft.e.a, gft.e.c},
         new gft.e[]{gft.e.h, gft.e.c, gft.e.h, gft.e.i, gft.e.b, gft.e.i, gft.e.b, gft.e.c},
         new gft.e[]{gft.e.h, gft.e.d, gft.e.h, gft.e.j, gft.e.b, gft.e.j, gft.e.b, gft.e.d}
      );
      ...
      final gft.e[] k;
      final gft.e[] l;
      private static final gft.a[] m = ad.a(new gft.a[6], $$0 -> {
         $$0[ji.a.d()] = a;
         $$0[ji.b.d()] = b;
         $$0[ji.c.d()] = c;
         $$0[ji.d.d()] = d;
      ...
      private a(final ji[] $$0, final float $$1, final boolean $$2, final gft.e[] $$3, final gft.e[] $$4, final gft.e[] $$5, final gft.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dbz $$0, dtc $$1, jd $$2, ji $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dtc $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dtc $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dtc $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dtc $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gft.c[] k = ad.a(new gft.c[6], $$0 -> {
         $$0[ji.a.d()] = a;
         $$0[ji.b.d()] = b;
         $$0[ji.c.d()] = c;
         $$0[ji.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dtc $$0, dbz $$1, jd $$2) {
         long $$3 = $$2.a();
         if (this.a) {
