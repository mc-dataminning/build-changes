...
public class fci implements fcd {
   protected static final fcd a = new fci(false, -Double.MAX_VALUE, cxp.j, $$0 -> false, null) {
      @Override
      public boolean a(fcs $$0, jh $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected fci(boolean $$0, double $$1, cxp $$2, Predicate<etx> $$3, @Nullable bvk $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected fci(bvk $$0, boolean $$1) {
      ...
      // 38: pop
      // 39: invokedynamic test (Lbwg;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, bwg.a (Letx;)Z, (Letx;)Z ]
      // 3e: goto 46
      // 41: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, fci.a (Letx;)Z, (Letx;)Z ]
      // 46: aload 1
      // 47: invokespecial fci.<init> (ZDLcxp;Ljava/util/function/Predicate;Lbvk;)V
      // 4a: return
   }
