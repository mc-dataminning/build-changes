...
public class fci extends gve {
   ...
   public void aM_() {
      this.C.a(a, this.p);
      this.D = this.C.c(new fci.a(this.m));
   ...
   private xo a(String $$0) {
      try {
         return fdf.a.get(Integer.parseInt($$0)).b();
   ...
   private xo b(String $$0) {
      try {
         return fdf.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends fhy<fci.b> {
      public a(final ffd $$0) {
         super($$0, fci.this.n, fci.this.C.d(), fci.this.C.c(), 36);
         if (fci.this.B.e != null) {
            fci.this.B.e.forEach(($$0x, $$1) -> this.b(fci.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends fhy.a<fci.b> {
      ...
      public void a(fgp $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fci.this.p, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(fci.this.p, fci.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
