...
public final class fci implements AutoCloseable {
   ...
   public fci(int $$0, int $$1, boolean $$2) {
      this(fci.a.a, $$0, $$1, $$2);
   }

   public fci(fci.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private fci(fci.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static fci a(InputStream $$0) throws IOException {
      return a(fci.a.a, $$0);
   }

   public static fci a(@Nullable fci.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fci a(ByteBuffer $$0) throws IOException {
      return a(fci.a.a, $$0);
   }

   public static fci a(byte[] $$0) throws IOException {
   ...
   public static fci a(@Nullable fci.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new fci($$0 == null ? fci.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public fci a(IntUnaryOperator $$0) {
      if (this.c != fci.a.a) {
         ...
         this.j();
         fci $$1 = new fci(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fnq.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(fci $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fci $$4) {
      this.j();
      if ($$4.c() != this.c) {
