...
public class acx {
   ...
   public acx(dzd $$0) {
      ...
      for (Entry<ji, dua> $$2 : $$0.I().entrySet()) {
   ...
   static class a {
      ...
      private a(int $$0, int $$1, duc<?> $$2, @Nullable tq $$3) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
         this.f = $$3;
   ...
   @FunctionalInterface
   public interface b {
      void accept(ji var1, duc<?> var2, @Nullable tq var3);
   }
}
