...
public class acx implements zs<ace> {
   public static final zj<wl, acx> a = zs.a(acx::a, acx::new);
   ...
   public acx(RootCommandNode<eu> $$0) {
   ...
   private static List<acx.b> a(Object2IntMap<CommandNode<eu>> $$0) {
   ...
   @Nullable
   private static acx.e a(wl $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static acx.b a(CommandNode<eu> $$0, Object2IntMap<CommandNode<eu>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<eu> a(el $$0) {
      return (RootCommandNode<eu>)new acx.d($$0, this.j).a(this.i);
   }
   ...
   static class a implements acx.e {
      ...
      @Nullable
      private static alb a(@Nullable SuggestionProvider<eu> $$0) {
         return $$0 != null ? io.a($$0) : null;
      }

      a(String $$0, ik.a<?> $$1, @Nullable alb $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
