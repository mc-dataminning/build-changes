...
public class ggi implements gfw.a {
   ...
   private List<bru> c = Collections.emptyList();
   ...
   private void a(eys $$0, gck $$1, double $$2, double $$3, double $$4, bru $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aE.ifPresent($$10 -> {
   ...
   private void a(io $$0, eys $$1, double $$2, double $$3, double $$4, gck $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gci.a(
         $$1,
         $$5.getBuffer(gcs.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, eup.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
