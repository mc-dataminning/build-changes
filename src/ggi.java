...
public interface ggi {
   static ggi a(ggo $$0, UserApiService $$1) {
      return new ggi.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, ggq var2, AbuseReport var3);
   ...
   public static record b(ggo a, UserApiService b) implements ggi {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, ggq $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               xv $$5 = this.a(var7);
               throw new CompletionException(new ggi.a($$5, var7));
            } catch (MinecraftClientException var8) {
               xv $$7 = this.a(var8);
               throw new CompletionException(new ggi.a($$7, var8));
            }
         }, ae.h());
      }
