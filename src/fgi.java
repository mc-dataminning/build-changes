...
public class fgi {
   public static List<fht> a(fgi.a... $$0) {
      for (fgi.a $$1 : $$0) {
         a($$1.j);
      }

      List<fht> $$2 = Lists.newArrayList();

      for (fgi.a $$3 : $$0) {
         $$2.add(new fht($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fht::a));
      return $$2;
   }
   ...
   public static List<fht> a() {
      return a(fgi.a.values());
   }
