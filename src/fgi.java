...
public class fgi<T extends bii> extends fex<T> {
   private static final int a = 7;
   private final fhn b;
   private final fhn[] f = new fhn[7];
   private final fhn[] g = new fhn[3];
   ...
   public static fht b() {
      ...
      for (int $$4 = 0; $$4 < 7; $$4++) {
         $$1.a(
            b($$4),
            fhs.c().a(i[$$4][0], i[$$4][1]).a((float)h[$$4][0] * -0.5F, 0.0F, (float)h[$$4][2] * -0.5F, (float)h[$$4][0], (float)h[$$4][1], (float)h[$$4][2]),
            fhp.a(0.0F, (float)(24 - h[$$4][1]), $$3)
         );
         $$2[$$4] = $$3;
         if ($$4 < 6) {
      ...
      $$1.a(a(0), fhs.c().a(20, 0).a(-5.0F, 0.0F, (float)h[2][2] * -0.5F, 10.0F, 8.0F, (float)h[2][2]), fhp.a(0.0F, 16.0F, $$2[2]));
      $$1.a(a(1), fhs.c().a(20, 11).a(-3.0F, 0.0F, (float)h[4][2] * -0.5F, 6.0F, 4.0F, (float)h[4][2]), fhp.a(0.0F, 20.0F, $$2[4]));
      $$1.a(a(2), fhs.c().a(20, 18).a(-3.0F, 0.0F, (float)h[4][2] * -0.5F, 6.0F, 5.0F, (float)h[1][2]), fhp.a(0.0F, 19.0F, $$2[1]));
