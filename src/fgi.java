...
public enum fgi {
   ...
   private fgi(final String... $$0) {
      this.c = $$0;
   }

   public List<aur<InputStream>> a(atm $$0) throws IOException {
      return List.of(
   ...
   public aur<InputStream> b(atm $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aur<InputStream> a(atm $$0, String $$1) throws IOException {
