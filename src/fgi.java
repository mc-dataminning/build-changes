...
public class fgi extends ffx implements fhc {
   private static final fhm d = new fhm(new akm("widget/text_field"), new akm("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axq> D = ($$0x, $$1x) -> axq.forward($$0x, xu.a);
   @Nullable
   private wx E;
   private long F = ac.c();

   public fgi(ffk $$0, int $$1, int $$2, wx $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fgi(ffk $$0, int $$1, int $$2, int $$3, int $$4, wx $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fgi(ffk $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fgi $$5, wx $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void e(int $$0) {
      this.w = ayd.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayd.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fly.s());
   }
   ...
   public void b(ffm $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aI_() && (ac.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.C() + 4 : this.C();
         int $$11 = this.r ? this.D() + (this.h - 8) / 2 : this.D();
         int $$12 = $$10;
         int $$13 = ayd.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
   ...
   public void i(int $$0) {
      this.x = ayd.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = ayd.a(this.v, 0, this.p.length());
      }
   }
