...
public class chs<U extends chr<?>> {
   ...
   public static final chs<chh<cko>> k = a("armadillo_scare_detected", () -> new chh<>(5, cko::i, cko::gF, cgl.H, 80));
   ...
   public static final chs<cht> q = a("axolotl_temptations", () -> new cht(cks.a()));
   public static final chs<cht> r = a("goat_temptations", () -> new cht(cli.a()));
   public static final chs<cht> s = a("frog_temptations", () -> new cht(cla.a()));
   public static final chs<cht> t = a("camel_temptations", () -> new cht(ckx.b()));
   public static final chs<cht> u = a("armadillo_temptations", () -> new cht(ckp.b()));
   ...
   public static final chs<cht> y = a("sniffer_temptations", () -> new cht(cmc.a()));
