...
public class fik {
   ...
   @Nullable
   private String g;
   private static final fik.a h = new fik.a() {
      @Nullable
      @Override
      public fij a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fin.a(this.d, "Get capabilities")) {
         ...
         if (fin.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fin.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fin.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fij a(fik.c $$0) {
      return ($$0 == fik.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fik.a {
      private final int a;
      private final Set<fij> b = Sets.newIdentityHashSet();
