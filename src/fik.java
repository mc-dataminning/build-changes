...
public class fik extends fiv {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fme.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fkr.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fme.Q().b($$4)) {
               try {
