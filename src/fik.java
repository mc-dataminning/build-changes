...
public abstract class fik implements va {
   ...
   @Nullable
   protected final eya f;
   private final List<fik.a> i = new ArrayList<>();

   protected fik(eql $$0, sg $$1, fir $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   public void a(vf $$0) {
      ...
      if ($$1 == null) {
         ...
         String $$2 = $$0.d();
         boolean $$3 = $$0.e();
         if (this.c != null && this.c.b() == fix.a.a) {
            this.a(vl.a.d);
            this.a(this.a.ac().a($$1, $$2, true));
         } else if (this.c != null && this.c.b() != fix.a.c && (!$$3 || this.c.b() != fix.a.b)) {
            this.a(vl.a.b);
            if ($$3) {
   ...
   protected void g() {
      Iterator<fik.a> $$0 = this.i.iterator();
   ...
   protected eya b(tf $$0) {
      eya $$1 = Objects.requireNonNullElseGet(this.f, () -> new faw(new eyf()));
      return (eya)(this.c != null && this.c.e() ? new gen($$1, g, $$0) : new exc($$1, g, $$0));
   }
   ...
   private void a(ux<? extends ss> $$0, BooleanSupplier $$1, Duration $$2) {
      if ($$1.getAsBoolean()) {
         ...
         this.i.add(new fik.a($$0, $$1, ac.b() + $$2.toMillis()));
      }
   }
