...
public class fik extends fhm {
   ...
   public fik(fhd $$0, int $$1, int $$2, int $$3, int $$4, wu $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fin($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(flo $$0) {
      $$0.a(fln.a, wu.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   protected void c(fhf $$0, int $$1, int $$2, float $$3) {
      String $$4 = this.o.c();
      if ($$4.isEmpty() && !this.aK_()) {
         $$0.a(this.m, this.n, this.D() + this.a(), this.E() + this.a(), this.g - this.b(), -857677600);
      } else {
         int $$5 = this.o.d();
         boolean $$6 = this.aK_() && (ac.c() - this.p) / 300L % 2L == 0L;
         boolean $$7 = $$5 < $$4.length();
         int $$8 = 0;
         int $$9 = 0;
         int $$10 = this.E() + this.a();

         for (fin.a $$11 : this.o.h()) {
   ...
   protected void a(fhf $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         wu $$2 = wu.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      fin.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fin.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
