...
public class eqg {
   ...
   public void a(erq $$0, String $$1, esm.a $$2, egf $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eqg.b $$13 = new eqg.b($$1.trim(), this.f, $$3, $$2);
                  eqg.a $$14 = new eqg.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eqg.c $$30 = new eqg.c(this.f, $$2, $$0);
                        eqg.a $$31 = new eqg.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eru(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, egf $$2) throws IOException {
      ...
      File $$15 = new File(eva.N().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, egf $$2, esm.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eqg.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eqg.this.b && !eqg.this.d) {
            try {
               eqg.this.e = true;
               eqg.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eqg.a.error("Error extracting archive", var3);
               eqg.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final esm.a c;
      private final erq d;

      c(File $$0, esm.a $$1, erq $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eqg.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eqg.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eqg.this.g);
                  eqg.this.c = true;
               } else {
                  eqg.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eqg.this.d = true;
               }
            } catch (IOException var3) {
               eqg.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eqg.this.d = true;
            }
         }
      }
