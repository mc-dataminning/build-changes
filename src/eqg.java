...
public class eqg {
   private final ImmutableList<eqh> a;
   private final ImmutableMap<String, eqh> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private eqe e;

   public eqg(ImmutableMap<String, eqh> $$0) {
      this.b = $$0;
