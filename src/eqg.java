...
public class eqg implements eqh, eqi {
   ...
   private final evm<MinecraftServer> G;
   ...
   public eqg(dch $$0, dyx $$1, eqg.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ja.c,
   ...
   public static <T> eqg a(Dynamic<T> $$0, dch $$1, eqg.a $$2, dyx $$3, Lifecycle $$4) {
      ...
      return new eqg(
         ...
         new evm<>(evl.a, $$0.get("ScheduledEvents").asStream()),
         (tx)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dwc.a.a).resultOrPartial(f::error).orElse(dwc.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jx $$0, tx $$1, @Nullable tx $$2) {
      ...
      dyv.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (uu)dwc.a.a.encodeStart(ul.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dcy.b.encodeStart(ul.a, this.g.g()).ifSuccess($$1x -> $$1.a((tx)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == eqg.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eqg.a.c;
   }
