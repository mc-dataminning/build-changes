...
public class eqg {
   ...
   public void a(cpb $$0, biq $$1, boolean $$2, boolean $$3, float $$4) {
      ...
      this.m = $$2;
      this.a($$1.h($$4), $$1.g($$4));
      this.b(arw.d((double)$$4, $$1.K, $$1.dq()), arw.d((double)$$4, $$1.L, $$1.ds()) + (double)arw.i($$4, this.o, this.n), arw.d((double)$$4, $$1.M, $$1.dw()));
      if ($$2) {
         if ($$3) {
   ...
   public eao k() {
      if (!this.b) {
         ...
         if ($$0.a(apx.a) && this.e.d < (double)((float)this.f.v() + $$0.a(this.c, this.f))) {
            return eao.b;
         } else {
            eqg.a $$1 = this.j();
