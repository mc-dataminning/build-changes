...
public class wg implements uw {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = asy.a(asy.b, wg::b);
   private static final Codec<Object> e = Codec.either(d, ux.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof uv $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<wg> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               asy.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, wg::a)
   );
   public static final uw.a<wg> c = new uw.a<>(b, "translatable");
   private static final va f = va.e("%");
   private static final va g = va.e("null");
   ...
   @Nullable
   private ry k;
   private List<va> l = ImmutableList.of();
   ...
   private static wg a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new wg($$0, $$1.orElse(null), a($$2));
   }

   public wg(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<va> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (wh var4) {
            this.l = ImmutableList.of(va.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<va> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new wh(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private va a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof uv) {
            ...
            return $$1 == null ? g : va.e($$1.toString());
         }
      } else {
         throw new wh(this, $$0);
      }
   ...
   public vj a(@Nullable du $$0, @Nullable bkv $$1, int $$2) throws CommandSyntaxException {
      ...
      return vj.a(new wg(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof wg $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
