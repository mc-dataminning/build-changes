...
public class wg extends ByteBuf {
   ...
   public <T> T a(DynamicOps<vi> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, uu.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vi> $$0, Codec<T> $$1, uu $$2) {
      vi $$3 = this.a($$2);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zi<? super wg, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zj<? super wg, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zi<? super wg, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zi<? super wg, K> $$1, zi<? super wg, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zi<? super wg, K> $$0, zi<? super wg, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zj<? super wg, K> $$1, zj<? super wg, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zj<? super wg, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zi<? super wg, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zi<? super wg, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zi<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zj<? super wg, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zj<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static des c(ByteBuf $$0) {
      return new des($$0.readLong());
   }

   public static void a(ByteBuf $$0, des $$1) {
      $$0.writeLong($$1.a());
   }
   ...
   public static ezy f(ByteBuf $$0) {
      return new ezy($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, ezy $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public static void a(ByteBuf $$0, @Nullable vi $$1) {
      ...
      try {
         uy.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ul h(ByteBuf $$0) {
      vi $$1 = a($$0, uu.a(2097152L));
      if ($$1 != null && !($$1 instanceof ul)) {
   ...
   @Nullable
   public static vi a(ByteBuf $$0, uu $$1) {
      try {
         vi $$2 = uy.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public <T> ali<T> a(ali<? extends kd<T>> $$0) {
      alj $$1 = this.q();
      return ali.a($$0, $$1);
   }
   ...
   public ezu v() {
      ...
      return new ezu(new ezy((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5, $$6);
   }
