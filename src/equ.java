...
public class equ {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((cps)MoreObjects.firstNonNull(this.b.q.k(), cps.b)).b());
               }
   ...
   private void a(dfj $$0, gw $$1, @Nullable qw $$2) {
   ...
   private void a(aew $$0, ehn $$1, @Nullable qw $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aM().i()) {
         boolean $$5 = ekk.a(eqv.O().aM().i(), 292);
         if (this.d > 0L) {
            if (!ekk.a(eqv.O().aM().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ekk.a(eqv.O().aM().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof ezd) || ((ezd)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aM().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               erg.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aV().a() && this.b.m.r().c()) {
            boolean $$7 = $$6 == null || !($$6.t() instanceof esz) || !((esz)$$6.t()).e();
            if ($$3 != 0 && $$1 == 66 && eyk.p() && $$7) {
               boolean $$8 = this.b.m.ao().c() == eqx.a;
               this.b.m.ao().a(eqx.a(this.b.m.ao().c().a() + 1));
               if ($$6 instanceof eym) {
                  ((eym)$$6).l();
               }
         ...
         if (this.b.y == null || this.b.y instanceof eyf $$10 && !$$10.l()) {
            ekk.a $$11 = ekk.a($$1, $$2);
            if ($$3 == 0) {
               eqt.a($$11, false);
               if ($$1 == 292) {
      ...
      if ($$0 == this.b.aM().i()) {
         ...
         if ($$3 != null && this.b.aJ() == null) {
            if (Character.charCount($$1) == 1) {
               eyk.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  eyk.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", arw.f((float)$$1 / 1000.0F));
            }
