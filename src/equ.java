...
public class equ extends ghw {
   ...
   private final equ.a E;
   @Nullable
   private volatile uv F;
   private volatile uv G = uv.c("mco.download.preparing");
   @Nullable
   ...
   public equ(faz $$0, epy $$1, String $$2, BooleanConsumer $$3) {
      super(eta.a);
      this.T = $$3;
      this.y = $$0;
      this.D = $$2;
      this.z = $$1;
      this.E = new equ.a();
      this.A = uv.c("mco.download.title");
      this.B = RateLimiter.create(0.1F);
   }

   @Override
   public void aQ_() {
      this.C = this.d(eve.a(uu.e, $$0 -> {
         this.I = true;
         this.E();
   ...
   private void C() {
      if (!this.K) {
         if (!this.S && this.a(this.z.a) >= 5368709120L) {
            uv $$0 = uv.a("mco.download.confirmation.line1", eon.b(5368709120L));
            uv $$1 = uv.c("mco.download.confirmation.line2");
            this.f.a(new eqx($$0x -> {
               this.S = true;
               this.f.a(this);
               this.F();
   ...
   private uv D() {
      ...
      $$0.add(this.G);
      if (this.H != null) {
         $$0.add(uv.a("mco.download.percent", this.H));
         $$0.add(uv.a("mco.download.speed.narration", eon.b(this.O)));
      }
   ...
   private void d(eut $$0) {
      ...
      $$0.a(this.i, uv.a("mco.download.percent", this.H), this.g / 2, 84, 16777215);
   }
   ...
   private void a(eut $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, uv.a("mco.download.speed", eon.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, 16777215, false);
      }
   }
         ...
         try {
            try {
               if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                  this.G = uv.c("mco.download.failed");
                  return;
               }
               ...
               this.G = uv.a("mco.download.downloading", this.D);
               eoo $$0 = new eoo();
               $$0.a(this.z.a);
               ...
               while (!$$0.b()) {
                  if ($$0.c()) {
                     $$0.a();
                     this.F = uv.c("mco.download.failed");
                     this.C.b(uu.d);
                     return;
                  }
                  ...
                  if ($$0.d()) {
                     if (!this.L) {
                        this.G = uv.c("mco.download.extracting");
                     }
   ...
   private void G() {
      this.G = uv.c("mco.download.cancelled");
   }
