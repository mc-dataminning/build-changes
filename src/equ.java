...
public class equ {
   ...
   static class a implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new equ.k($$0, $$1);
      }
   }

   static class b implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         ...
         return new equ.l($$0, $$1);
      }
   }

   static class c implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new equ.m($$0, $$1);
      }
   }

   static class d implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         ...
         return new equ.n($$0, $$1);
      }
   }

   static class e implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         ...
         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new equ.o($$0, $$3);
      }
   }

   static class f implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
         return true;
      }
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         $$1.d = true;
         return new equ.s($$0, $$1, $$2);
      }
   }

   static class g implements equ.i {
      @Override
      public boolean a(equ.v $$0) {
      ...
      public equ.r a(jm $$0, equ.v $$1, bam $$2) {
         $$1.d = true;
         return new equ.t($$0, $$1);
      }
   }

   public static class h extends equ.r {
      ...
      private equ.v G;
      private equ.v H;
      private final List<equ.r> I = Lists.newArrayList();

      public h(bam $$0, int $$1, int $$2, jm $$3) {
         super(epb.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<equ.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new equ.p($$3, this.G));
         this.I.add(new equ.j($$3, this.H));
         List<equ.i> $$5 = Lists.newArrayList();
         $$5.add(new equ.b());
         $$5.add(new equ.d());
         $$5.add(new equ.e());
         $$5.add(new equ.a());
         ...
         eoc $$10 = eoc.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eoc $$11 = eoc.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eoc $$12 = eoc.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new equ.u($$3, $$10, $$13++));
         this.I.add(new equ.u($$3, $$11, $$13++));
         this.I.add(new equ.q($$3, $$12));
      }
      ...
      private List<equ.v> b(bam $$0) {
         equ.v[] $$1 = new equ.v[75];
         ...
         equ.v $$23 = new equ.v(1003);
         equ.v $$24 = new equ.v(1001);
         equ.v $$25 = new equ.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<equ.v> $$26 = new ObjectArrayList();
      ...
      public void a(dig $$0, die $$1, dzr $$2, bam $$3, eoc $$4, dgo $$5, jh $$6) {
         int $$7 = Math.max($$0.O(), 64) - this.f.i();
      ...
      private void a(boolean $$0, int $$1, dig $$2, bam $$3, eoc $$4) {
         int $$5 = 24;
      ...
      private void a(dig $$0, bam $$1, eoc $$2) {
      ...
      private void b(dig $$0, bam $$1, eoc $$2) {
      ...
      private void c(dig $$0, bam $$1, eoc $$2) {
      ...
      private void d(dig $$0, bam $$1, eoc $$2) {
      ...
      private void e(dig $$0, bam $$1, eoc $$2) {
      ...
      private void f(dig $$0, bam $$1, eoc $$2) {
   ...
   interface i {
      boolean a(equ.v var1);

      equ.r a(jm var1, equ.v var2, bam var3);
   }

   public static class j extends equ.r {
      public j(jm $$0, equ.v $$1) {
         super(epb.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dig $$0, die $$1, dzr $$2, bam $$3, eoc $$4, dgo $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dko.co.m(), dko.co.m(), false);
   ...
   public static class k extends equ.r {
      public k(jm $$0, equ.v $$1) {
         super(epb.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends equ.r {
      public l(jm $$0, equ.v $$1) {
         super(epb.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends equ.r {
      public m(jm $$0, equ.v $$1) {
         super(epb.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends equ.r {
      public n(jm $$0, equ.v $$1) {
         super(epb.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends equ.r {
      public o(jm $$0, equ.v $$1) {
         super(epb.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends equ.r {
      public p(jm $$0, equ.v $$1) {
         super(epb.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends equ.r {
      public q(jm $$0, eoc $$1) {
         super(epb.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eoo {
      protected static final dxv b = dko.iq.m();
      protected static final dxv c = dko.ir.m();
      protected static final dxv d = dko.is.m();
      protected static final dxv h = c;
      protected static final dxv i = dko.iz.m();
      protected static final boolean j = true;
      protected static final dxv k = dko.J.m();
      protected static final Set<dkm> l = ImmutableSet.builder().add(dko.eb).add(dko.iT).add(dko.nr).add(k.b()).build();
      ...
      public r(epb $$0, jm $$1, int $$2, eoc $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(epb $$0, int $$1, jm $$2, equ.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eoc a(jm $$0, equ.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eoc $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dig $$0, eoc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dxv $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.O() && $$11 != k) {
      ...
      protected void a(dig $$0, eoc $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dig $$0, eoc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dxv $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eoc $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dig $$0, eoc $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cmm $$6 = bvr.N.a($$0.a(), bvq.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dw()), bvq.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends equ.r {
      private int a;

      public s(jm $$0, equ.v $$1, bam $$2) {
         super(epb.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends equ.r {
      public t(jm $$0, equ.v $$1) {
         super(epb.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends equ.r {
      private int a;

      public u(jm $$0, eoc $$1, int $$2) {
         super(epb.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
