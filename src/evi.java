...
public class evi implements eji {
   ...
   static void a(IntBuffer $$0, evi.f $$1, int $$2, int $$3) {
      for (int $$4 = 0; $$4 < 16; $$4++) {
         int $$5 = $$1.a($$4);
         a($$0, $$5, $$2, $$3);
      }
   ...
   @VisibleForTesting
   static void a(InputStream $$0, evi.h $$1) throws IOException {
      int $$2 = 0;
   ...
   static record a(byte[] a) implements evi.f {
      @Override
      public int a(int $$0) {
         return this.a[$$0] << 24;
      }

      static evi.f a(int $$0, ByteList $$1) {
         byte[] $$2 = new byte[16];
         int $$3 = 0;
   ...
   public static class b implements eve {
      public static final MapCodec<evi.b> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(aer.a.fieldOf("hex_file").forGetter($$0x -> $$0x.c), evi.g.a.listOf().fieldOf("size_overrides").forGetter($$0x -> $$0x.d))
               .apply($$0, evi.b::new)
      );
      private final aer c;
      private final List<evi.g> d;

      private b(aer $$0, List<evi.g> $$1) {
         this.c = $$0;
         this.d = $$1;
      }
      ...
      private evi a(InputStream $$0) throws IOException {
         eus<evi.f> $$1 = new eus<>(evi.f[]::new, evi.f[][]::new);
         evi.h $$2 = $$1::a;
         ...
         try (ZipInputStream $$3 = new ZipInputStream($$0)) {
            ...
            while (($$4 = $$3.getNextEntry()) != null) {
               String $$5 = $$4.getName();
               if ($$5.endsWith(".hex")) {
                  evi.a.info("Found {}, loading", $$5);
                  evi.a(new aqz($$3), $$2);
               }
            }

            eus<evi.d> $$6 = new eus<>(evi.d[]::new, evi.d[][]::new);
   ...
   public static record c(int c, int d) {
      public static final MapCodec<evi.c> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(Codec.INT.fieldOf("left").forGetter(evi.c::b), Codec.INT.fieldOf("right").forGetter(evi.c::c)).apply($$0, evi.c::new)
      );
      public static final Codec<evi.c> b = a.codec();
   ...
   static record e(int[] a, int b) implements evi.f {
      ...
      static evi.f b(int $$0, ByteList $$1) {
         int[] $$2 = new int[16];
         int $$3 = 0;
         int $$4 = 0;
         ...
         return new evi.e($$2, 24);
      }

      public static evi.f a(int $$0, ByteList $$1) {
         int[] $$2 = new int[16];
         int $$3 = 0;
         int $$4 = 0;
   ...
   static record g(int b, int c, evi.c d) {
      private static final Codec<evi.g> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(aqy.v.fieldOf("from").forGetter(evi.g::a), aqy.v.fieldOf("to").forGetter(evi.g::b), evi.c.a.forGetter(evi.g::c))
               .apply($$0, evi.g::new)
      );
      public static final Codec<evi.g> a = aqy.a(
         e,
         (Function<evi.g, DataResult<evi.g>>)($$0 -> $$0.b >= $$0.c
   ...
   @FunctionalInterface
   public interface h {
      void accept(int var1, evi.f var2);
   }

   static record i(short[] a) implements evi.f {
      @Override
      public int a(int $$0) {
         return this.a[$$0] << 16;
      }
