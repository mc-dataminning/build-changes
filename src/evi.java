...
public class evi implements evj, evk {
   ...
   private final fam<MinecraftServer> G;
   ...
   public evi(dgl $$0, edp $$1, evi.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ji.c,
   ...
   public static <T> evi a(Dynamic<T> $$0, dgl $$1, evi.a $$2, edp $$3, Lifecycle $$4) {
      ...
      return new evi(
         ...
         new fam<>(fal.a, $$0.get("ScheduledEvents").asStream()),
         (tq)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(eau.a.a).resultOrPartial(f::error).orElse(eau.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(kf $$0, tq $$1, @Nullable tq $$2) {
      ...
      edn.a($$4, this.h, $$0).resultOrPartial(af.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (un)eau.a.a.encodeStart(ue.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dhe.b.encodeStart(ue.a, this.g.g()).ifSuccess($$1x -> $$1.a((tq)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == evi.a.b;
   }

   @Override
   public boolean A() {
      return this.i == evi.a.c;
   }
