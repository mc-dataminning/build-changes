...
public class evi {
   ...
   public evi(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evj> $$1) throws IOException {
   ...
   public List<evj> a(Path $$0) throws IOException {
      List<evj> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evj> a(Path $$0, boolean $$1) throws IOException {
      List<evj> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evj> $$1) throws IOException {
