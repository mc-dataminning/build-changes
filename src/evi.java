...
public class evi {
   ...
   @Nullable
   private String g;
   private static final evi.a h = new evi.a() {
      @Nullable
      @Override
      public evh a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (evm.a(this.d, "Get capabilities")) {
         ...
         if (evm.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  evm.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !evm.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public evh a(evi.c $$0) {
      return ($$0 == evi.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements evi.a {
      private final int a;
      private final Set<evh> b = Sets.newIdentityHashSet();
      ...
      public evh a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               evi.a.warn("Maximum sound pool size {} reached", this.a);
            }
