...
public abstract class den {
   ...
   public void a(bus<?> $$0, @Nullable dfm $$1, azu $$2, jh $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bwd.a($$7.get(), $$0, bur.c, $$13, $$0.G_())) {
                     continue;
                  }

                  bul $$15 = bus.a($$6, $$0, bur.c, $$3x -> {
                  ...
                  int $$16 = $$0.a(
                        eaf.b($$15.getClass()),
                        new ezt((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        buq.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof bvj $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bur.c) || !$$17.a((dfp)$$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((bvj)$$15).a($$0, $$0.d_($$15.dv()), bur.c, null);
                     }
   ...
   private void d(dfm $$0, jh $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dgg)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dfm $$0, jh $$1, ul $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dgg $$4 = dgg.b.parse(uz.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dgg::new);
         this.a($$0, $$1, $$4);
      }

      boolean $$5 = $$2.b("SpawnPotentials", 9);
      if ($$5) {
         ur $$6 = $$2.c("SpawnPotentials", 10);
         this.e = dgg.c.parse(uz.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bqs::b);
      } else {
         this.e = bqs.a(this.f != null ? this.f : new dgg());
      }
   ...
   public ul a(ul $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vi)dgg.b.encodeStart(uz.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vi)dgg.c.encodeStart(uz.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bul b(dfm $$0, jh $$1) {
      if (this.l == null) {
         ul $$2 = this.a($$0, $$0.G_(), $$1).a();
         if (!$$2.b("id", 8)) {
            return null;
         }

         this.l = bus.a($$2, $$0, bur.c, Function.identity());
         if ($$2.f() == 1 && this.l instanceof bvj) {
         }
      }
   ...
   protected void a(@Nullable dfm $$0, jh $$1, dgg $$2) {
      this.f = $$2;
   }

   private dgg a(@Nullable dfm $$0, azu $$1, jh $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bqu.b::b).orElseGet(dgg::new));
         return this.f;
      }
   }

   public abstract void a(dfm var1, jh var2, int var3);
