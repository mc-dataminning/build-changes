...
public class afu implements zp<ace> {
   public static final zg<wt, afu> a = zp.a(afu::a, afu::new);
   ...
   public static class b {
      ...
      public b(wt $$0) {
         ...
         this.e = $$0.d(40);
         this.f = $$0.b(n.class);
         this.b = xk.d.decode($$0);
         this.c = xk.d.decode($$0);
      }
