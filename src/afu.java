...
public class afu extends akn {
   private final aew h;
   private final Set<UUID> i = Sets.newHashSet();
   private int j;
   private int k = 100;

   public afu(aew $$0, tl $$1) {
   ...
   public void a(int $$0) {
      this.j = $$0;
      this.a(arw.a((float)$$0 / (float)this.k, 0.0F, 1.0F));
   }

   public void b(int $$0) {
      this.k = $$0;
      this.a(arw.a((float)this.j / (float)$$0, 0.0F, 1.0F));
   }
   ...
   public boolean a(Collection<akr> $$0) {
      Set<UUID> $$1 = Sets.newHashSet();
      Set<akr> $$2 = Sets.newHashSet();
   ...
   public static afu a(qw $$0, aew $$1) {
      afu $$2 = new afu($$1, tl.a.a($$0.l("Name")));
      $$2.d($$0.q("Visible"));
      $$2.a($$0.h("Value"));
      $$2.b($$0.h("Max"));
