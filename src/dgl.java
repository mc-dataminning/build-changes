...
public interface dgl extends dfk, dfr, dha, dhm.a {
   @Nullable
   dys a(int var1, int var2, dzt var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(ecs.a var1, int var2, int var3);

   int E_();

   dhm I_();

   default jr<dhk> t(ji $$0) {
      return this.I_().a($$0);
   }

   default Stream<dwx> c(fav $$0) {
      int $$1 = ayz.a($$0.a);
      int $$2 = ayz.a($$0.d);
      int $$3 = ayz.a($$0.b);
      int $$4 = ayz.a($$0.e);
   ...
   @Override
   default int a(ji $$0, dfs $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default jr<dhk> getNoiseBiome(int $$0, int $$1, int $$2) {
      dys $$3 = this.a(kc.e($$0), kc.e($$2), dzt.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   jr<dhk> a(int var1, int var2, int var3);
   ...
   default dys a(int $$0, int $$1) {
      return this.a($$0, $$1, dzt.n, true);
   }

   default dys a(int $$0, int $$1, dzt $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dfn c(int $$0, int $$1) {
