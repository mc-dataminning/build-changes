...
public class dgl extends dgo<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dgl(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dgl $$1 && super.equals($$0)) {
   ...
   public static dgl a(String $$0, int $$1, int $$2) {
      return new dgl($$0, $$1, $$2);
   }
