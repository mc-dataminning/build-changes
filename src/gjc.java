public class gjc extends gix<btg> {
   ...
   protected int a(btg $$0, iz $$1) {
      return ayz.a(super.a($$0, $$1) + 7, 0, 15);
   }

   public void a(btg $$0, float $$1, float $$2, ezz $$3, gdp $$4, int $$5) {
      $$3.a();
      int $$6 = $$0.s();
   ...
   private static void a(fad $$0, ezz.a $$1, float $$2, float $$3, int $$4, int $$5, int $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3, 0.0F).a($$4, $$5, $$6, 128).a($$7, $$8).c(gor.d).b($$9).b($$1, 0.0F, 1.0F, 0.0F).e();
   }
