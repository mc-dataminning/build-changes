...
public class dlm {
   ...
   private final cpo p;
   private static final List<csm> q = List.of(csn.l, csn.L, csn.i, csn.b, csn.k, csn.I, csn.K, csn.fl, csn.dP, csn.iA, csn.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<he<cqk>>> t;
   ...
   public static final Codec<dlm> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlm::a, Function.identity());

   private static DataResult<dlm> a(dlm $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlm(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<he<cqk>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hx.c($$0);
      int $$5 = hx.c($$1) - $$4;
   ...
   @Nullable
   public static dlm a(akr $$0, int $$1, int $$2) {
      dgw $$3 = $$0.a($$1, $$2);
      dlm $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dhb.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hb> a(cqg $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dgw $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, arp.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dgw $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dkj.a.a)) {
         $$3 = Math.min($$0.a(dkj.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }

      int $$5 = this.p.C_();
      gu.a $$6 = new gu.a($$1, $$3, $$2);
   ...
   private static double a(dgw $$0, gu.a $$1) {
      return a($$0, (gu)$$1.c(ha.a)) ? 1.0 : -1.0;
   }

   private static double b(dgw $$0, gu.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dgw $$0, int $$1, int $$2, int $$3) {
   ...
   private List<he<cqk>> b(dgw $$0, int $$1, int $$2) {
      ObjectArrayList<he<cqk>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dgw $$0, gu $$1) {
      dfa $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(apl.O)) {
         ...
         return $$2.a(csn.eU) || $$2.a(csn.eV) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dlm.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlm.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, he<cqk> var3);
   }
