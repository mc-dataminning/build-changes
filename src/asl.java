...
public class asl implements AutoCloseable {
   ...
   private asl(URL $$0, asl.c $$1, URL $$2, asl.b $$3, URL $$4, asl.b $$5, String $$6, asl.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   void a(GameProfile $$0, URL $$1, asl.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<arx> a(GameProfile $$0, String $$1, asl.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arx.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = ayp.a($$4, "response", false);
            if ($$5) {
               return arx.a($$1);
            } else {
               String $$6 = ayp.a($$4, "hashed", null);
               if ($$6 == null) {
                  return arx.b($$1);
               } else {
                  JsonArray $$7 = ayp.v($$4, "hashes");
                  xt $$8 = this.a($$1, $$7, $$2);
                  return new arx($$1, $$8);
               }
            }
   ...
   private xt a(String $$0, JsonArray $$1, asl.a $$2) {
      if ($$1.isEmpty()) {
         return xt.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xt.b;
      } else {
         xt $$3 = new xt($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asl.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public ask a(GameProfile $$0) {
      return new asl.d($$0);
   }
   ...
   public interface a {
      asl.a a = ($$0, $$1) -> false;
      asl.a b = ($$0, $$1) -> $$0.length() == $$1;

      static asl.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static asl.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements ask {
      ...
      d(final GameProfile $$0) {
         this.c = $$0;
         bpp<Runnable> $$1 = bpp.a(asl.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         asl.this.a(this.c, asl.this.g, asl.this.h, this.d);
      }

      @Override
      public void b() {
         asl.this.a(this.c, asl.this.i, asl.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<arx>> a(List<String> $$0) {
         List<CompletableFuture<arx>> $$1 = $$0.stream().map($$0x -> asl.this.a(this.c, $$0x, asl.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arx> a(String $$0) {
         return asl.this.a(this.c, $$0, asl.this.l, this.d);
      }
   }
