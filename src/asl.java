...
public abstract class asl implements AutoCloseable {
   ...
   protected asl(URL $$0, asl.b $$1, asl.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected CompletableFuture<arw> a(GameProfile $$0, String $$1, asl.a $$2, Executor $$3) {
   ...
   protected abstract arw a(String var1, asl.a var2, JsonObject var3);

   protected wt a(String $$0, JsonArray $$1, asl.a $$2) {
      if ($$1.isEmpty()) {
         return wt.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return wt.b;
      } else {
         wt $$3 = new wt($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asl.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   protected class c implements asm {
      ...
      public CompletableFuture<List<arw>> a(List<String> $$0) {
         List<CompletableFuture<arw>> $$1 = $$0.stream().map($$0x -> asl.this.a(this.b, $$0x, asl.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return af.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arw> a(String $$0) {
         return asl.this.a(this.b, $$0, asl.this.f, this.c);
      }
   }
