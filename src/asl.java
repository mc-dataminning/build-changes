...
public class asl {
   ...
   private static void a(asq $$0, arn $$1, dxp $$2) {
      $$0.b(new adq($$2, $$1.z_(), null, null));
      deh $$3 = $$2.f();
      ags.a($$1, $$3);
   }

   private List<dxp> a(aqt $$0, deh $$1) {
      int $$2 = azk.d(this.i);
      List<dxp> $$4;
