...
class asl implements Path {
   private static final BasicFileAttributes a = new asj() {
      @Override
   ...
   private static final BasicFileAttributes b = new asj() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<asl> c = Comparator.comparing(asl::n);
   ...
   public asl(asn $$0, String $$1, @Nullable asl $$2, aso $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private asl a(@Nullable asl $$0, String $$1) {
      return new asl(this.e, $$1, $$0, aso.b);
   }
   ...
   asl a(String $$0) {
      if (a(this.i)) {
         return new asl(this.e, $$0, this, this.i);
      } else if (this.i instanceof aso.a $$1) {
         asl $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new asl(this.e, $$0, this, aso.a);
      } else if (this.i instanceof aso.b) {
         return new asl(this.e, $$0, this, aso.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aso $$0) {
      return $$0 == aso.a || $$0 == aso.b;
   }
   ...
   private asl c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof asl $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aso.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aso.a i() {
      return this.i instanceof aso.a $$0 ? $$0 : null;
   }
