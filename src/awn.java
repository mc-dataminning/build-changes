...
public class awn<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return awn.this.get(this.b--);
      }

      @Override
      public void remove() {
         awn.this.remove(this.b + 1);
      }
   }
}
