...
public class awn extends atl {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), awn::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", awn::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", awn::k);
         $$0 = this.a($$0, "minecraft:fox", awn::j);
         $$0 = this.a($$0, "minecraft:item", awn::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", awn::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", awn::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", awn::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", awn::e);
         return this.a($$0, "minecraft:piglin", awn::d);
      });
   }
