...
public class bam extends bfn {
   ...
   public bam(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bgr.s, "minecraft:banner");
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bam::b)));
   }
