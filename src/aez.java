...
public class aez implements Comparable<aez> {
   public static final Codec<aez> a = Codec.STRING.comapFlatMap(aez::b, aez::toString).stable();
   ...
   protected aez(String $$0, String $$1, @Nullable aez.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public aez(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private aez(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static aez a(String $$0, char $$1) {
      return new aez(b($$0, $$1));
   }
   ...
   @Nullable
   public static aez a(String $$0, String $$1) {
      try {
         return new aez($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<aez> b(String $$0) {
      try {
         return DataResult.success(new aez($$0));
      } catch (z var2) {
   ...
   public aez c(String $$0) {
      return new aez(this.f, d(this.f, $$0), null);
   }

   public aez a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public aez d(String $$0) {
      return this.c($$0 + this.g);
   }

   public aez e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof aez $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static aez a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<aez>, JsonSerializer<aez> {
      public aez a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new aez(arr.a($$0, "location"));
      }

      public JsonElement a(aez $$0, Type $$1, JsonSerializationContext $$2) {
