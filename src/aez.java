...
public class aez extends IOException {
   private final List<aez.a> a = Lists.newArrayList();
   private final String b;

   public aez(String $$0) {
      this.a.add(new aez.a());
      this.b = $$0;
   }

   public aez(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new aez.a());
      this.b = $$0;
   }
   ...
   public static aez a(Exception $$0) {
      if ($$0 instanceof aez) {
         return (aez)$$0;
      } else {
