...
public final class ali<E> implements Codec<jq<E>> {
   private final alk<? extends kd<E>> a;

   public static <E> ali<E> a(alk<? extends kd<E>> $$0) {
      return new ali<>($$0);
   }

   private ali(alk<? extends kd<E>> $$0) {
      this.a = $$0;
   }
