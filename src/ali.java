...
public final class ali implements Comparable<ali> {
   ...
   public static final zg<ByteBuf, ali> b = ze.m.a(ali::a, ali::toString);
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xi.c("argument.id.invalid"));
   ...
   public static class a implements JsonDeserializer<ali>, JsonSerializer<ali> {
      public ali a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return ali.a(aza.a($$0, "location"));
      }

      public JsonElement a(ali $$0, Type $$1, JsonSerializationContext $$2) {
