...
public class blh implements bla {
   ...
   public blh(LongSupplier $$0, boolean $$1) {
      this.b.add(a($$0));
      if ($$1) {
         this.b.addAll(a());
      }
   ...
   public static Set<bky> a() {
      Builder<bky> $$0 = ImmutableSet.builder();

      try {
         blh.a $$1 = new blh.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bky.a("cpu#" + $$1x, bkx.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bky.a("heap MiB", bkx.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bkz.a.a());
      return $$0.build();
   }
   ...
   public static bky a(final LongSupplier $$0) {
      ...
      bky.d $$3 = new bky.d(2.0F);
      return bky.a("ticktime", bkx.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
