...
public class blh implements Comparable<blh> {
   ...
   @Nullable
   private blh q;
   private final Optional<blh.a> r;

   public blh(blf $$0) {
      this($$0, 0, 0);
   }

   public blh(blf $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public blh(blf $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public blh(blf $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public blh(blf $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public blh(blf $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable blh $$6, Optional<blh.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bmk $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof blh $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(sn $$0) {
      ...
      this.r.ifPresent($$1x -> blh.a.a.encodeStart(tb.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static blh b(sn $$0) {
      String $$1 = $$0.l("id");
      blf $$2 = kd.d.a(ahg.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static blh a(blf $$0, sn $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = blh.a.a.parse(new Dynamic(tb.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new blh($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<blh.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atv.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  atv.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(blh $$0) {
         ...
         float $$2 = aun.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = aun.i($$2, this.c, this.d);
      }

      public float a(bmk $$0, float $$1) {
         if ($$0.dH()) {
            this.g = this.e;
         }

         return aun.i($$1, this.g, this.e);
      }
   }
}
