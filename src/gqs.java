...
public class gqs implements gqv.a, AutoCloseable {
   ...
   public gqs(akt $$0, gsl $$1, fad $$2, auf $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gsj $$4 = $$3.a(gsj.a).orElse(gsj.e);
   ...
   @Nullable
   private gqs.a a(gsl $$0, int $$1, int $$2, gsj $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gqs.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gqs.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gqs.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gqs.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gqs.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gqs.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fad[] $$4) {
   ...
   class a {
      ...
      a(List<gqs.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gqs.this.c;
         int $$4 = this.b($$2) * gqs.this.d;
         gqs.this.a($$0, $$1, $$3, $$4, gqs.this.f);
      }

      public gqu a() {
         return gqs.this.new d(this, this.d ? gqs.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fad[] b = new fad[gqs.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gqs.this.c >> $$0;
            int $$2 = gqs.this.d >> $$0;
            this.b[$$0] = new fad($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gqs.d $$2) {
         gqs.a $$3 = $$2.d;
         List<gqs.b> $$4 = $$3.b;
         gqs.b $$5 = $$4.get($$2.b);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     int $$16 = this.a($$6, $$14 >> 24 & 0xFF, $$15 >> 24 & 0xFF);
                     int $$17 = this.a($$6, $$14 >> 16 & 0xFF, $$15 >> 16 & 0xFF);
                     int $$18 = this.a($$6, $$14 >> 8 & 0xFF, $$15 >> 8 & 0xFF);
                     int $$19 = this.a($$6, $$14 & 0xFF, $$15 & 0xFF);
                     this.b[$$9].a($$13, $$12, $$16 << 24 | $$17 << 16 | $$18 << 8 | $$19);
                  }
               }
            }

            gqs.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gqs.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gqs.this.f[$$2].a($$3 + ($$0.a($$1) * gqs.this.c >> $$2), $$4 + ($$0.b($$1) * gqs.this.d >> $$2));
      }
   ...
   class d implements gqu {
      int b;
      int c;
      final gqs.a d;
      @Nullable
      private final gqs.c e;

      d(gqs.a $$0, @Nullable gqs.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
