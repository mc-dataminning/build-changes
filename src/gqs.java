...
public class gqs implements gqy.a {
   ...
   private final fmg F;
   private final Map<ji, gqs.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bva $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dP();
      });
   }

   private void b(fgr $$0, gmx $$1, double $$2, double $$3, double $$4) {
      ji $$5 = ji.a($$2, $$3, $$4);
   ...
   private void a(fgr $$0, gmx $$1, gqs.a $$2) {
      int $$3 = 0;
   ...
   private void a(fgr $$0, gmx $$1, zw.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         grh.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fgr $$0, gmx $$1, zw.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fgr $$0, gmx $$1, String $$2, gqs.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      gqy.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cF());
   }
