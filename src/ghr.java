public class ghr extends ghd {
   private static final int a = 12235202;

   protected ghr(gfd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gjg $$8) {
   ...
   public static class a implements gio<lw> {
      ...
      public gil a(lw $$0, gfd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ghr($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.0F, this.a);
      }
   }
}
