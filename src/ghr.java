...
public abstract class ghr extends fau {
   ...
   private final List<ghp> a = Lists.newArrayList();
   ...
   protected ghp a(ghp $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public ur l() {
      return uq.a(this.a.stream().map(ghp::a).collect(Collectors.toList()));
   }
}
