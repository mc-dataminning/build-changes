public abstract class ghr<T extends cmy> extends gir<T> {
   public ghr(gis.a $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, ezt $$3, gdj $$4, int $$5) {
      ...
      $$3.a(-4.0F, 0.0F, 0.0F);
      ezx $$18 = $$4.getBuffer(gdr.d(this.a($$0)));
      ezt.a $$19 = $$3.c();
   ...
   public void a(ezt.a $$0, ezx $$1, int $$2, int $$3, int $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, (float)$$2, (float)$$3, (float)$$4).a(255, 255, 255, 255).a($$5, $$6).c(gol.d).b($$10).b($$0, (float)$$7, (float)$$9, (float)$$8).e();
   }
}
