...
public class ghr implements atx {
   private static final gcs e = gcs.n(new akm("textures/misc/shadow.png"));
   private static final float f = 32.0F;
   private static final float g = 0.5F;
   private Map<bsa<?>, ghs<?>> h = ImmutableMap.of();
   private Map<gov.a, ghs<? extends clw>> i = Map.of();
   public final gnw a;
   private dax j;
   public fdk b;
   ...
   public <E extends bru> int a(E $$0, float $$1) {
      return this.a($$0).b($$0, $$1);
   }

   public ghr(fdz $$0, gnw $$1, gir $$2, gde $$3, ffk $$4, fed $$5, fvs $$6) {
      this.a = $$1;
      this.l = $$2;
   ...
   public <T extends bru> ghs<? super T> a(T $$0) {
      if ($$0 instanceof gbj $$1) {
         gov.a $$2 = $$1.b().e();
         ghs<? extends clw> $$3 = this.i.get($$2);
   ...
   public void a(dax $$0, fdk $$1, bru $$2) {
      this.j = $$0;
      this.b = $$1;
      this.k = $$1.f();
      this.c = $$2;
   ...
   public <E extends bru> boolean a(E $$0, gfo $$1, double $$2, double $$3, double $$4) {
      ghs<? super E> $$5 = this.a($$0);
      return $$5.a($$0, $$1, $$2, $$3, $$4);
   }

   public <E extends bru> void a(E $$0, double $$1, double $$2, double $$3, float $$4, float $$5, eys $$6, gck $$7, int $$8) {
      ...
      try {
         ...
         $$9.a($$0, $$4, $$5, $$6, $$7, $$8);
         if ($$0.cy()) {
            this.a($$6, $$7, $$0, ayd.a(ayd.h, this.k, new Quaternionf()));
         }
   ...
   private static void a(eys $$0, eyw $$1, bru $$2, float $$3) {
      euf $$4 = $$2.cK().d(-$$2.du(), -$$2.dw(), -$$2.dA());
      gci.a($$0, $$1, $$4, 1.0F, 1.0F, 1.0F, 1.0F);
      if ($$2 instanceof cha) {
         double $$5 = -ayd.d((double)$$3, $$2.ad, $$2.du());
         double $$6 = -ayd.d((double)$$3, $$2.ae, $$2.dw());
         double $$7 = -ayd.d((double)$$3, $$2.af, $$2.dA());

         for (cgy $$8 : ((cha)$$2).gl()) {
            $$0.a();
            double $$9 = $$5 + ayd.d((double)$$3, $$8.ad, $$8.du());
            double $$10 = $$6 + ayd.d((double)$$3, $$8.ae, $$8.dw());
            double $$11 = $$7 + ayd.d((double)$$3, $$8.af, $$8.dA());
            $$0.a($$9, $$10, $$11);
   ...
   private void a(eys $$0, gck $$1, bru $$2, Quaternionf $$3) {
      gnv $$4 = gqb.a.c();
      gnv $$5 = gqb.b.c();
      $$0.a();
      float $$6 = $$2.dj() * 1.4F;
      ...
      float $$11 = 0.0F;
      int $$12 = 0;
      eyw $$13 = $$1.getBuffer(gcz.i());

      for (eys.a $$14 = $$0.c(); $$9 > 0.0F; $$12++) {
         gnv $$15 = $$12 % 2 == 0 ? $$4 : $$5;
         float $$16 = $$15.c();
         float $$17 = $$15.g();
         float $$18 = $$15.d();
   ...
   private static void a(eys.a $$0, eyw $$1, float $$2, float $$3, float $$4, float $$5, float $$6) {
      $$1.a($$0, $$2, $$3, $$4).a(255, 255, 255, 255).a($$5, $$6).a(0, 10).b(240).b($$0, 0.0F, 1.0F, 0.0F).e();
   }

   private static void a(eys $$0, gck $$1, bru $$2, float $$3, float $$4, dba $$5, float $$6) {
      double $$7 = ayd.d((double)$$4, $$2.ad, $$2.du());
      double $$8 = ayd.d((double)$$4, $$2.ae, $$2.dw());
      double $$9 = ayd.d((double)$$4, $$2.af, $$2.dA());
      float $$10 = Math.min($$3 / 0.5F, $$6);
      int $$11 = ayd.a($$7 - (double)$$6);
      int $$12 = ayd.a($$7 + (double)$$6);
      int $$13 = ayd.a($$8 - (double)$$10);
      int $$14 = ayd.a($$8);
      int $$15 = ayd.a($$9 - (double)$$6);
      int $$16 = ayd.a($$9 + (double)$$6);
      eys.a $$17 = $$0.c();
      eyw $$18 = $$1.getBuffer(e);
      io.a $$19 = new io.a();
   ...
   private static void a(eys.a $$0, eyw $$1, dsx $$2, dba $$3, io $$4, double $$5, double $$6, double $$7, float $$8, float $$9) {
      io $$10 = $$4.d();
      drb $$11 = $$2.a_($$10);
      if ($$11.l() != dke.a && $$3.A($$4) > 3) {
         if ($$11.r($$2, $$10)) {
            evd $$12 = $$11.j($$2, $$10);
            if (!$$12.c()) {
   ...
   private static void a(eys.a $$0, eyw $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7) {
