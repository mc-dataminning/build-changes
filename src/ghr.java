...
public final class ghr {
   ...
   private static final ghr c = new ghr(HostAndPort.fromParts("server.invalid", 25565));

   public ghr(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private ghr(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static ghr a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new ghr($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof ghr ? this.b.equals(((ghr)$$0).b) : false;
      }
   }
