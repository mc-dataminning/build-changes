...
public class bgd extends DataFix {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bfp.F);
      Type<?> $$1 = this.getInputSchema().getType(bfp.F);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bgz.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bfp.g);
      Type<?> $$1 = this.getInputSchema().getType(bfp.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bgz.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
