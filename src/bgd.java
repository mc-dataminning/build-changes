...
public class bgd {
   ...
   private bgd(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bgd a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bgd($$0, $$1);
   }

   public bgd.d a() throws IOException {
      bgd.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bgd.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bgd.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bgd.c $$3 = bgd.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bgd.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bgd.a($$0, $$3);
            }
         }
   ...
   public bgd.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bgd.c> $$2 = this.a().c();
      ...
      bgd.e $$4 = new bgd.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bgd.c b) implements bgd.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bgd.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bgd.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bgd.b> {
      private final List<bgd.b> a;

      d(List<bgd.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bgd.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bgd.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bgd.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bgd.d a() {
         ListIterator<bgd.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bgd.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bgd.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bgd.b> b() {
         return this.a.stream();
      }

      public Set<bgd.c> c() {
         return this.a.stream().map(bgd.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bgd.c b) implements bgd.b {
