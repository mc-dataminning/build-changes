...
public enum eik implements asr {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final asr.a<eik> t = asr.a(eik::values);
   public static final IntFunction<eik> u = aqt.a(eik::a, values(), aqt.a.a);
   private final int v;
   private final String w;

   private eik(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
