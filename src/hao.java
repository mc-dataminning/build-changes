...
@FunctionalInterface
public interface hao<T> {
   static <T> hao<T> empty() {
      return $$0 -> List.of();
   }

   static <T> hao<T> plainText(List<T> $$0, Function<T, Stream<String>> $$1) {
      ...
      // 06: ifeq 0d
      // 09: invokestatic hao.empty ()Lhao;
      // 0c: areturn
      // 0d: new hap
      // 10: dup
      // 11: invokespecial hap.<init> ()V
      // 14: astore 2
      // 15: aload 0
      ...
      // 38: aload 2
      // 39: aload 4
      // 3b: invokedynamic accept (Lhap;Ljava/lang/Object;)Ljava/util/function/Consumer; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)V, hao.a (Lhap;Ljava/lang/Object;Ljava/lang/String;)V, (Ljava/lang/String;)V ]
      // 40: invokeinterface java/util/stream/Stream.forEach (Ljava/util/function/Consumer;)V 2
      // 45: goto 1c
      // 48: aload 2
      // 49: invokevirtual hap.a ()V
      // 4c: aload 2
      // 4d: dup
      // 4e: invokestatic java/util/Objects.requireNonNull (Ljava/lang/Object;)Ljava/lang/Object;
      // 51: pop
      // 52: invokedynamic search (Lhap;)Lhao; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/String;)Ljava/util/List;, hap.a (Ljava/lang/String;)Ljava/util/List;, (Ljava/lang/String;)Ljava/util/List; ]
      // 57: areturn
   }
