...
public class fqg implements fzs {
   ...
   protected void a(fns $$0, float $$1, int $$2, int $$3, fzt $$4) {
      int $$5 = ayp.a($$1);
      $$0.a(glv::C, a, $$2 - 91, $$3, 182, 22, $$5);
      if ($$4.a() >= 0) {
         $$0.a(glv::C, b, $$2 - 91 - 1 + $$4.a() * 20, $$3 - 1, 24, 23, $$5);
      }
   ...
   private void a(fns $$0, int $$1, int $$2, float $$3, float $$4, fzr $$5) {
      if ($$5 != fzp.a) {
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fzp.a || !this.g.a($$1).aV_())) {
         $$1 += $$0;
      }
