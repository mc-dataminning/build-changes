...
public class fqg implements AutoCloseable {
   ...
   public fqg(fqa $$0, esr $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gau(16, 16, false);
   ...
   private float a(bky $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, ati.b(((float)$$0.ah - $$2) * (float) Math.PI * 0.025F) * $$3);
   }

   public void a(float $$0) {
      if (this.g) {
         this.g = false;
         this.j.aF().a("lightTex");
         fkw $$1 = this.j.r;
         if ($$1 != null) {
            float $$2 = $$1.g(1.0F);
            float $$3;
            ...
            if (this.j.s.a(bjx.p)) {
               $$9 = fqa.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.a(bjx.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   private static void a(Vector3f $$0) {
      $$0.set(ati.a($$0.x, 0.0F, 1.0F), ati.a($$0.y, 0.0F, 1.0F), ati.a($$0.z, 0.0F, 1.0F));
   }
   ...
   public static float a(dkf $$0, int $$1) {
      float $$2 = (float)$$1 / 15.0F;
      float $$3 = $$2 / (4.0F - 3.0F * $$2);
      return ati.i($$0.s(), $$3, 1.0F);
   }
