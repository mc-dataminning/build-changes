...
public class ame extends are {
   private final alc h;
   private final Set<UUID> i = Sets.newHashSet();
   private int j;
   private int k = 100;

   public ame(alc $$0, xd $$1) {
      super($$1, brf.a.g, brf.b.a);
      this.h = $$0;
      this.a(0.0F);
   }
   ...
   public void a(int $$0) {
      this.j = $$0;
      this.a(azd.a((float)$$0 / (float)this.k, 0.0F, 1.0F));
   }

   public void b(int $$0) {
      this.k = $$0;
      this.a(azd.a((float)this.j / (float)$$0, 0.0F, 1.0F));
   }
   ...
   public boolean a(Collection<ari> $$0) {
      Set<UUID> $$1 = Sets.newHashSet();
      Set<ari> $$2 = Sets.newHashSet();
   ...
   public static ame a(uf $$0, alc $$1, jp.a $$2) {
      ame $$3 = new ame($$1, xd.a.a($$0.l("Name"), $$2));
      $$3.d($$0.q("Visible"));
      $$3.a($$0.h("Value"));
      $$3.b($$0.h("Max"));
      $$3.a(brf.a.a($$0.l("Color")));
      $$3.a(brf.b.a($$0.l("Overlay")));
