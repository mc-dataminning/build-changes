...
public class ame {
   ...
   private static ame.b a(af $$0, boolean $$1) {
      Optional<as> $$2 = $$0.c();
      if ($$2.isEmpty()) {
         return ame.b.b;
      } else if ($$1) {
   ...
   private static boolean a(ah $$0, Stack<ame.b> $$1, Predicate<ah> $$2, ame.a $$3) {
      boolean $$4 = $$2.test($$0);
      ame.b $$5 = a($$0.a(), $$4);
      boolean $$6 = $$4;
      $$1.push($$5);
   ...
   public static void a(ah $$0, Predicate<ah> $$1, ame.a $$2) {
      ah $$3 = $$0.d();
