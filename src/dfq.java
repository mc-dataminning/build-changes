...
public final class dfq {
   ...
   public static final MapCodec<dfq> b = dfq.a.a
      .flatXmap(dfq::a, $$0 -> $$0.h.<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final ze<wp, dfq> c = ze.a(zc.h, $$0 -> $$0.e, zc.h, $$0 -> $$0.f, dex.b.a(zc.a()), $$0 -> $$0.g, dfq::a);
   private final int e;
   private final int f;
   private final List<Optional<dex>> g;
   private final Optional<dfq.a> h;
   private final int i;
   private final boolean j;

   public dfq(int $$0, int $$1, List<Optional<dex>> $$2, Optional<dfq.a> $$3) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   private static dfq a(Integer $$0, Integer $$1, List<Optional<dex>> $$2) {
      return new dfq($$0, $$1, $$2, Optional.empty());
   }

   public static dfq a(Map<Character, dex> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static dfq a(Map<Character, dex> $$0, List<String> $$1) {
      dfq.a $$2 = new dfq.a($$0, $$1);
      return (dfq)a($$2).getOrThrow();
   }

   private static DataResult<dfq> a(dfq.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      List<Optional<dex>> $$4 = new ArrayList<>($$2 * $$3);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new dfq($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(dep $$0, boolean $$1) {
   ...
   public static record a(Map<Character, dex> b, List<String> c) {
      ...
      public static final MapCodec<dfq.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(azg.b(e, dex.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, dfq.a::new)
      );
