...
public interface dzi {
   static dzi a(eaa $$0, dcy $$1, eac $$2, eaj $$3, int $$4, int $$5, dzi.a $$6) {
      return new dzi.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static dzi a(final dzi.a $$0) {
      return new dzi() {
         @Nullable
         @Override
         public dua a(dzp.b $$0x, double $$1) {
   ...
   @Nullable
   dua a(dzp.b var1, double var2);

   boolean a();

   public interface a {
      dzi.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dua b) {

      public dua a(int $$0) {
         return $$0 < this.a ? this.b : dgx.a.o();
      }
   }

   public static class c implements dzi {
      ...
      private static final double k = a(azc.h(10), azc.h(12));
      private final eaa l;
      private final dzp m;
      private final dzp n;
      private final dzp o;
      private final dzp p;
      private final eaj q;
      private final dzi.b[] r;
      private final long[] s;
      private final dzi.a t;
      private final dzp u;
      private final dzp v;
      private boolean w;
      private final int x;
      ...
      c(eaa $$0, dcy $$1, eac $$2, eaj $$3, int $$4, int $$5, dzi.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dua a(dzp.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            dzi.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dgx.H)) {
               this.w = false;
               return dgx.H.o();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dgx.G) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dgx.H)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(dzp.b $$0, MutableDouble $$1, dzi.b $$2, dzi.b $$3) {
         int $$4 = $$0.b();
         dua $$5 = $$2.a($$4);
         dua $$6 = $$3.a($$4);
         if ((!$$5.a(dgx.H) || !$$6.a(dgx.G)) && (!$$5.a(dgx.G) || !$$6.a(dgx.H))) {
      ...
      private dzi.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            dzi.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private dzi.b b(int $$0, int $$1, int $$2) {
         dzi.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               dzi.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new dzi.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, dzi.b $$3, int $$4, boolean $$5) {
         dzp.e $$6 = new dzp.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dfj.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
            int $$10 = 64;
            double $$11 = $$5 ? azc.a((double)$$9, 0.0, 64.0, 1.0, 0.0) : 0.0;
            double $$12 = azc.a(this.n.a($$6), -1.0, 1.0);
            double $$13 = azc.b($$11, 1.0, 0.0, -0.3, 0.8);
            double $$14 = azc.b($$11, 1.0, 0.0, -0.8, 0.4);
            $$7 = $$12 - $$14;
            $$8 = $$12 - $$13;
         }
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new dzp.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azc.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dua a(int $$0, int $$1, int $$2, dzi.b $$3, int $$4) {
         dua $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != dxw.g && $$3.b != dgx.H.o()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new dzp.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dgx.H.o();
            }
         }
