...
public class dzi {
   private static final dzi a = new dzi(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dzi.a a(int $$0, int $$1) {
         return new dzi.a(1.0, 0.0);
      }
   ...
   private static final enm b = enm.b(new dzh(42L), qq.a);
   ...
   private final Long2ObjectOpenHashMap<dzj> h;
   private final Long2ObjectOpenHashMap<dzj> i;

   public static dzi a() {
      return a;
   }

   public static dzi a(@Nullable aqt $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dbn $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dzj> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dzj> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayg.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dzi($$2, $$3);
         }
      }
   }

   dzi(Long2ObjectOpenHashMap<dzj> $$0, Long2ObjectOpenHashMap<dzj> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dzi.a a(int $$0, int $$1) {
      int $$2 = ju.a($$0);
      int $$3 = ju.a($$1);
      double $$4 = this.a($$2, 0, $$3, dzj::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dzi.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(ju.d(dbn.a($$5x)), ju.d(dbn.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(dxz.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(ju.d(dbn.a($$6x)), ju.d(dbn.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, dzi.b $$3) {
      int $$4 = ju.e($$0);
      int $$5 = ju.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dzi.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dzj $$6 = (dzj)this.h.get(dbn.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - ju.d($$1), $$4, $$5 - ju.d($$2)) : Double.MAX_VALUE;
   }

   public ddj a(ddj $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jj<ddg> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jj<ddg> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jj<ddg>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(ju.d(dbn.a($$5x)), $$1, ju.d(dbn.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(aqt $$0, duh $$1) {
      dbn $$2 = $$1.f();
      boolean $$3 = $$1.s();
      ja.a $$4 = new ja.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dyg.a.e, $$16, $$17)) + 1;
   ...
   private static void a(duh $$0, ja $$1) {
      dsl $$2 = $$0.a_($$1);
      if ($$2.a(avw.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(ddc $$0, dvb $$1) {
      dbn $$2 = $$1.f();
      Builder<jg, dzj> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dyc.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dzi.c a(@Nullable dzj $$0, Map<jg, dzj> $$1) {
      List<dzi.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dzi.c a(@Nullable jg $$0, dzj $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jf $$4 : $$0.a()) {
   ...
   interface b {
      double get(dzj var1, int var2, int var3, int var4);
   }
