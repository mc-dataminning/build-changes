...
public class dzi {
   ...
   private static final int j = ju.a(16);
   ...
   private final dch p;
   private static final List<dfh> q = List.of(dfj.l, dfj.L, dfj.i, dfj.b, dfj.k, dfj.I, dfj.K, dfj.fl, dfj.dP, dfj.iA, dfj.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<jj<ddf>>> t;
   ...
   public static final Codec<dzi> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dzi::a, Function.identity());

   private static DataResult<dzi> a(dzi $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dzi(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<jj<ddf>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kc.c($$0);
      int $$5 = kc.c($$1) - $$4;
   ...
   @Nullable
   public static dzi a(aqt $$0, int $$1, int $$2) {
      dug $$3 = $$0.a($$1, $$2);
      dzi $$4 = $$3.t();
      if ($$4 != null && !$$3.k().d(dvh.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jg> a(ddb $$0, int $$1, int $$2, boolean $$3) {
      Set<jg> $$4 = EnumSet.noneOf(jg.class);
   ...
   private void a(dug $$0, Set<jg> $$1) {
      if (!this.r) {
         if ($$1.contains(jg.a) || $$1.contains(jg.g) || $$1.contains(jg.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(jg.c) && $$1.contains(jg.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(jg.c) && $$1.contains(jg.e) && $$1.contains(jg.d)) {
   ...
   private void a(int $$0, dug $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayg.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dug $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dyf.a.a)) {
         $$3 = Math.min($$0.a(dyf.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }

      int $$5 = this.p.I_();
      ja.a $$6 = new ja.a($$1, $$3, $$2);
   ...
   private static double a(dug $$0, ja.a $$1) {
      return a($$0, (ja)$$1.c(jf.a)) ? 1.0 : -1.0;
   }

   private static double b(dug $$0, ja.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dug $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      ja.a $$5 = new ja.a($$1, this.p.am(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<jj<ddf>> b(dug $$0, int $$1, int $$2) {
      ObjectArrayList<jj<ddf>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + ju.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(ju.a($$1), $$5, ju.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dug $$0, ja $$1) {
      dsk $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avw.O)) {
         ...
         return $$2.a(dfj.eT) || $$2.a(dfj.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dzi.a $$3) {
      if ($$1 >= ju.a(this.p.I_()) && $$1 < ju.a(this.p.am())) {
         int $$4 = $$1 - ju.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               jj<ddf> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dzi.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dzi.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, jj<ddf> var3);
   }
