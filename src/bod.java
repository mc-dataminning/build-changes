...
public record bod<T>(bnv<StringReader> a, bnt<T> b) {
   public Optional<T> a(bny<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bnw.a<StringReader> $$1 = new bnw.a<>();
      boh $$2 = new boh(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bnx::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bnw.a<StringReader> $$2 = new bnw.a<>();
      boh $$3 = new boh(this.a(), $$2, $$1);
      this.a($$3);
      List<bnx<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bnx<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bog $$7) {
               fb.a($$7.a(), $$5);
            } else {
