...
public record cq(ck.d d, Optional<ctl> e, List<cq.e<?>> f, Object2BooleanMap<ahg> g, Map<ahg, cq.c> h, Optional<bp> i) implements bq {
   ...
   public boolean a(blu $$0, and $$1, @Nullable els $$2) {
      if (!($$0 instanceof ane $$3)) {
         ...
         while (var13.hasNext()) {
            Entry<ahg> $$8 = (Entry<ahg>)var13.next();
            if ($$7.b((ahg)$$8.getKey()) != $$8.getBooleanValue()) {
               return false;
            }
         }
         ...
         if (!this.h.isEmpty()) {
            ...
            for (java.util.Map.Entry<ahg, cq.c> $$11 : this.h.entrySet()) {
   ...
   public Object2BooleanMap<ahg> e() {
      return this.g;
   }

   public Map<ahg, cq.c> f() {
      return this.h;
   }
   ...
   public static class d {
      ...
      public cq.d b(ahg $$0, boolean $$1) {
         this.e.put($$0, new cq.b($$1));
         return this;
      }

      public cq.d a(ahg $$0, Map<String, Boolean> $$1) {
