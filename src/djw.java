...
public class djw implements djs, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bhj<bhl.b> c;
   private final djz d;
   private final Map<cqz, djw.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected djw(Path $$0, boolean $$1, String $$2) {
      this.d = new djz($$0, $$1);
      this.c = new bhj<>(new bhl.a(djw.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(cqz $$0, int $$1) {
      cqz $$2 = new cqz($$0.e - $$1, $$0.f - $$1);
      cqz $$3 = new cqz($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(cqz $$0, @Nullable rz $$1) {
      return this.a(() -> {
         djw.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new djw.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<rz>> a(cqz $$0) {
      return this.a(() -> {
         djw.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(cqz $$0, st $$1) {
      return this.a(() -> {
         try {
            djw.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bhl.b(djw.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cqz, djw.a>> $$0 = this.e.entrySet().iterator();
         Entry<cqz, djw.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bhl.b(djw.b.b.ordinal(), this::a));
   }

   private void a(cqz $$0, djw.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bhl.b(djw.b.c.ordinal(), () -> $$0.a(auj.a))).join();
         this.c.close();
