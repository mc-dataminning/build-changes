...
public class eip implements eiq, eir {
   ...
   private final enf<MinecraftServer> G;
   ...
   public eip(cvr $$0, drm $$1, eip.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         hz.c,
   ...
   public static <T> eip a(Dynamic<T> $$0, cvr $$1, eip.a $$2, drm $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new eip(
         (sw)sw.a.parse($$0.get("Player").orElseEmptyMap()).result().orElse(null),
         $$0.get("WasModded").asBoolean(false),
         new hz($$0.get("SpawnX").asInt(0), $$0.get("SpawnY").asInt(0), $$0.get("SpawnZ").asInt(0)),
         ...
         (UUID)$$0.get("WanderingTraderId").read(jc.a).result().orElse(null),
         ...
         new enf<>(ene.a, $$0.get("ScheduledEvents").asStream()),
         (sw)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dor.a.a).resultOrPartial(f::error).orElse(dor.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public sw a(iw $$0, @Nullable sw $$1) {
      if ($$1 == null) {
         $$1 = this.o;
      }
   ...
   private void a(iw $$0, sw $$1, @Nullable sw $$2) {
      ...
      $$1.a("Version", $$3);
      tl.g($$1);
      DynamicOps<tt> $$4 = aiw.a(tk.a, $$0);
      drk.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dor.a.a.encodeStart(tk.a, this.y), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<tt> $$5 = cwh.b.encodeStart(tk.a, this.g.g());
      $$5.get().ifLeft($$1x -> $$1.a((sw)$$1x)).ifRight($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   private static tc a(Set<String> $$0) {
      tc $$1 = new tc();
      $$0.stream().map(tr::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean z() {
      return this.i == eip.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eip.a.c;
   }
