...
public class eip {
   ...
   static class a implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         return $$0.c[ir.f.d()] && !$$0.b[ir.f.d()].d;
      }

      @Override
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         $$1.d = true;
         $$1.b[ir.f.d()].d = true;
         return new eip.k($$0, $$1);
      }
   }

   static class b implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         if ($$0.c[ir.f.d()] && !$$0.b[ir.f.d()].d && $$0.c[ir.b.d()] && !$$0.b[ir.b.d()].d) {
            eip.v $$1 = $$0.b[ir.f.d()];
            return $$1.c[ir.b.d()] && !$$1.b[ir.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         ...
         $$1.b[ir.f.d()].d = true;
         $$1.b[ir.b.d()].d = true;
         $$1.b[ir.f.d()].b[ir.b.d()].d = true;
         return new eip.l($$0, $$1);
      }
   }

   static class c implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         return $$0.c[ir.b.d()] && !$$0.b[ir.b.d()].d;
      }
      ...
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         $$1.d = true;
         $$1.b[ir.b.d()].d = true;
         return new eip.m($$0, $$1);
      }
   }

   static class d implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         if ($$0.c[ir.c.d()] && !$$0.b[ir.c.d()].d && $$0.c[ir.b.d()] && !$$0.b[ir.b.d()].d) {
            eip.v $$1 = $$0.b[ir.c.d()];
            return $$1.c[ir.b.d()] && !$$1.b[ir.b.d()].d;
         } else {
            return false;
      ...
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         ...
         $$1.b[ir.c.d()].d = true;
         $$1.b[ir.b.d()].d = true;
         $$1.b[ir.c.d()].b[ir.b.d()].d = true;
         return new eip.n($$0, $$1);
      }
   }

   static class e implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         return $$0.c[ir.c.d()] && !$$0.b[ir.c.d()].d;
      }

      @Override
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         eip.v $$3 = $$1;
         if (!$$1.c[ir.c.d()] || $$1.b[ir.c.d()].d) {
            $$3 = $$1.b[ir.d.d()];
         }

         $$3.d = true;
         $$3.b[ir.c.d()].d = true;
         return new eip.o($$0, $$3);
      }
   }

   static class f implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         return true;
      }
      ...
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         $$1.d = true;
         return new eip.s($$0, $$1, $$2);
      }
   }

   static class g implements eip.i {
      @Override
      public boolean a(eip.v $$0) {
         return !$$0.c[ir.e.d()] && !$$0.c[ir.f.d()] && !$$0.c[ir.c.d()] && !$$0.c[ir.d.d()] && !$$0.c[ir.b.d()];
      }

      @Override
      public eip.r a(ir $$0, eip.v $$1, ayd $$2) {
         $$1.d = true;
         return new eip.t($$0, $$1);
      }
   }

   public static class h extends eip.r {
      ...
      private eip.v G;
      private eip.v H;
      private final List<eip.r> I = Lists.newArrayList();

      public h(ayd $$0, int $$1, int $$2, ir $$3) {
         super(egx.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eip.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eip.p($$3, this.G));
         this.I.add(new eip.j($$3, this.H));
         List<eip.i> $$5 = Lists.newArrayList();
         $$5.add(new eip.b());
         $$5.add(new eip.d());
         $$5.add(new eip.e());
         $$5.add(new eip.a());
         ...
         efy $$10 = efy.a(this.b(1, 1, 1), this.b(23, 8, 21));
         efy $$11 = efy.a(this.b(34, 1, 1), this.b(56, 8, 21));
         efy $$12 = efy.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eip.u($$3, $$10, $$13++));
         this.I.add(new eip.u($$3, $$11, $$13++));
         this.I.add(new eip.q($$3, $$12));
      }
      ...
      private List<eip.v> b(ayd $$0) {
         eip.v[] $$1 = new eip.v[75];
         ...
         eip.v $$23 = new eip.v(1003);
         eip.v $$24 = new eip.v(1001);
         eip.v $$25 = new eip.v(1002);
         $$1[v].a(ir.b, $$23);
         $$1[w].a(ir.d, $$24);
         $$1[x].a(ir.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ir.f.d()].d = true;
         this.H.b[ir.c.d()].d = true;
         this.H.b[ir.f.d()].b[ir.c.d()].d = true;
         this.H.b[ir.b.d()].d = true;
         this.H.b[ir.f.d()].b[ir.b.d()].d = true;
         this.H.b[ir.c.d()].b[ir.b.d()].d = true;
         this.H.b[ir.f.d()].b[ir.c.d()].b[ir.b.d()].d = true;
         ObjectArrayList<eip.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dap $$2, ayd $$3, efy $$4) {
         int $$5 = 24;
      ...
      private void a(dap $$0, ayd $$1, efy $$2) {
      ...
      private void b(dap $$0, ayd $$1, efy $$2) {
      ...
      private void c(dap $$0, ayd $$1, efy $$2) {
      ...
      private void d(dap $$0, ayd $$1, efy $$2) {
      ...
      private void e(dap $$0, ayd $$1, efy $$2) {
      ...
      private void f(dap $$0, ayd $$1, efy $$2) {
   ...
   interface i {
      boolean a(eip.v var1);

      eip.r a(ir var1, eip.v var2, ayd var3);
   }

   public static class j extends eip.r {
      public j(ir $$0, eip.v $$1) {
         super(egx.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dap $$0, dan $$1, drv $$2, ayd $$3, efy $$4, czb $$5, im $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dcx.ch.n(), dcx.ch.n(), false);
   ...
   public static class k extends eip.r {
      public k(ir $$0, eip.v $$1) {
         super(egx.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dap $$0, dan $$1, drv $$2, ayd $$3, efy $$4, czb $$5, im $$6) {
         eip.v $$7 = this.B.b[ir.f.d()];
         eip.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ir.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ir.a.d()]);
         }
   ...
   public static class l extends eip.r {
      public l(ir $$0, eip.v $$1) {
         super(egx.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eip.r {
      public m(ir $$0, eip.v $$1) {
         super(egx.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dap $$0, dan $$1, drv $$2, ayd $$3, efy $$4, czb $$5, im $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ir.a.d()]);
         }

         eip.v $$7 = this.B.b[ir.b.d()];
         if ($$7.b[ir.b.d()] == null) {
   ...
   public static class n extends eip.r {
      public n(ir $$0, eip.v $$1) {
         super(egx.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dap $$0, dan $$1, drv $$2, ayd $$3, efy $$4, czb $$5, im $$6) {
         eip.v $$7 = this.B.b[ir.c.d()];
         eip.v $$8 = this.B;
         eip.v $$9 = $$7.b[ir.b.d()];
         eip.v $$10 = $$8.b[ir.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ir.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ir.a.d()]);
         }
   ...
   public static class o extends eip.r {
      public o(ir $$0, eip.v $$1) {
         super(egx.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eip.r {
      public p(ir $$0, eip.v $$1) {
         super(egx.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eip.r {
      public q(ir $$0, efy $$1) {
         super(egx.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends egk {
      protected static final dpy b = dcx.hZ.n();
      protected static final dpy c = dcx.ia.n();
      protected static final dpy d = dcx.ib.n();
      protected static final dpy h = c;
      protected static final dpy i = dcx.ii.n();
      protected static final boolean j = true;
      protected static final dpy k = dcx.G.n();
      protected static final Set<dcv> l = ImmutableSet.builder().add(dcx.dO).add(dcx.iC).add(dcx.mW).add(k.b()).build();
      ...
      public r(egx $$0, ir $$1, int $$2, efy $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(egx $$0, int $$1, ir $$2, eip.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static efy a(ir $$0, eip.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         efy $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dap $$0, efy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dpy $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dap $$0, efy $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dap $$0, efy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dpy $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(efy $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dap $$0, efy $$1, int $$2, int $$3, int $$4) {
         im $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            chg $$6 = bqr.D.a((czu)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eP());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dn()), bri.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eip.r {
      private int a;

      public s(ir $$0, eip.v $$1, ayd $$2) {
         super(egx.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dap $$0, dan $$1, drv $$2, ayd $$3, efy $$4, czb $$5, im $$6) {
         ...
         if (this.B.b[ir.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ir.a.d()] && !this.B.c[ir.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eip.r {
      public t(ir $$0, eip.v $$1) {
         super(egx.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eip.r {
      private int a;

      public u(ir $$0, efy $$1, int $$2) {
         super(egx.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
