...
public class eip implements eik {
   protected static final eik a = new eip(false, -Double.MAX_VALUE, ckj.b, $$0 -> false, null) {
      @Override
      public boolean a(eiy $$0, ht $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected eip(boolean $$0, double $$1, ckj $$2, Predicate<ebe> $$3, @Nullable bjt $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected eip(bjt $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bjt.bV ()Z
      // 05: aload 1
      // 06: invokevirtual bjt.ds ()D
      // 09: aload 1
      // 0a: instanceof bkj
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast bkj
      // 14: invokevirtual bkj.eS ()Lckj;
      // 17: goto 1d
      // 1a: getstatic ckj.b Lckj;
      // 1d: aload 1
      // 1e: instanceof bkj
      // 21: ifeq 35
      // 24: aload 1
      ...
      // 2c: pop
      // 2d: invokedynamic test (Lbkj;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, bkj.a (Lebe;)Z, (Lebe;)Z ]
      // 32: goto 3a
      // 35: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, eip.a (Lebe;)Z, (Lebe;)Z ]
      // 3a: aload 1
      // 3b: invokespecial eip.<init> (ZDLckj;Ljava/util/function/Predicate;Lbjt;)V
      // 3e: return
   }
