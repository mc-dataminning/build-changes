...
public class eip {
   private final eip.a a;
   private final eip.b b;
   private final int c;
   private final int d;
   private final int e;

   public eip(int $$0, eip.a $$1, eip.b $$2, int $$3) {
      if (this.a($$0, $$2)) {
         this.b = $$2;
         this.a = $$1;
         this.c = $$0;
   ...
   private boolean a(int $$0, eip.b $$1) {
      return $$0 == 0 || $$1 == eip.b.d;
   }

   public final eip.a a() {
      return this.a;
   }

   public final eip.b b() {
      return this.b;
   }
   ...
   public static enum b {
      ...
      private final eip.b.b h;
      private final eip.b.a i;

      private b(String $$0, eip.b.b $$1, eip.b.a $$2) {
         this.g = $$0;
         this.h = $$1;
         this.i = $$2;
      }
