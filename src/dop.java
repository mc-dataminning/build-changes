...
public class dop extends dny<dqj> {
   private static final Logger a = LogUtils.getLogger();
   private static final biw<?>[] b = new biw[]{biw.aJ, biw.bp, biw.bp, biw.aS};
   private static final dfl c = csy.nc.n();

   public dop(Codec<dqj> $$0) {
      super($$0);
   }

   @Override
   public boolean a(doa<dqj> $$0) {
      Predicate<dfl> $$1 = dny.a(apu.bH);
      gw $$2 = $$0.e();
      ase $$3 = $$0.d();
      cqr $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.H_() && !$$4.a_($$23.d()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(csy.cv)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, csy.cn.n(), $$1);
                        } else {
                           this.a($$4, $$23, csy.m.n(), $$1);
                        }
                     }
                  } else if (!$$24.a(csy.cv) && !$$24.a(csy.ct)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.t($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, dvo.a($$4, $$30, csy.cv.n()), $$1);
                     dea.a($$4, $$3, $$30, ecq.d);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, csy.ct.n(), $$1);
         if ($$4.c_($$2) instanceof dej $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
