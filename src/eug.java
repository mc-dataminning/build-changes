...
public class eug {
   private final ImmutableList<euh> a;
   private final ImmutableMap<String, euh> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private eue e;

   public eug(ImmutableMap<String, euh> $$0) {
      this.b = $$0;
