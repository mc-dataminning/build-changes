...
public class amw {
   ...
   private static int a(ee $$0, go $$1, Collection<aqo> $$2, int $$3) throws CommandSyntaxException {
      ctq $$4 = $$1.a(1, false);
      int $$5 = $$4.j();
      int $$6 = $$5 * 100;
      if ($$3 > $$6) {
         ...
         for (aqo $$7 : $$2) {
            ...
            while ($$8 > 0) {
               ...
               if ($$11 && $$10.e()) {
                  ...
                  $$7.dP().a(null, $$7.du(), $$7.dw(), $$7.dA(), avi.nC, avj.h, 0.2F, (($$7.el().i() - $$7.el().i()) * 0.7F + 1.0F) * 2.0F);
                  $$7.cb.d();
               } else {
                  cii $$12 = $$7.a($$10, false);
                  if ($$12 != null) {
