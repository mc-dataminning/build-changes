...
public abstract class amw implements wu {
   private static final Logger d = LogUtils.getLogger();
   public static final int a = 15000;
   private static final ur e = ur.c("disconnect.timeout");
   ...
   public amw(MinecraftServer $$0, ts $$1, amp $$2) {
      this.b = $$0;
      this.c = $$1;
      this.f = ac.b();
      this.i = $$2.b();
   ...
   public void a(wz $$0) {
      wm.a($$0, this, this.b);
      if ($$0.a() == wz.a.b && this.b.T()) {
         d.info("Disconnecting {} due to resource pack rejection", this.j().getName());
         this.b(ur.c("multiplayer.requiredTexturePrompt.disconnect"));
      }
   }
   ...
   public void b(ur $$0) {
      this.c.a(new wp($$0), ub.a(() -> this.c.a($$0)));
      this.c.o();
      this.b.h(this.c::p);
   }
   ...
   protected amp a(alp $$0) {
      return new amp(this.j(), this.i, $$0);
   }
}
