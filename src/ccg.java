...
public abstract class ccg extends ccs {
   private static final double f = 2.0;
   private static final aef<Byte> g = aei.a(ccg.class, aeh.a);
   private static final aef<Byte> h = aei.a(ccg.class, aeh.a);
   ...
   protected boolean b;
   protected int c;
   public ccg.a d = ccg.a.a;
   public int e;
   private int m;
   private double n = 2.0;
   private int o;
   private apf p = this.s();
   @Nullable
   private IntOpenHashSet q;
   @Nullable
   private List<biw> r;

   protected ccg(bja<? extends ccg> $$0, cqb $$1) {
      super($$0, $$1);
   }

   protected ccg(bja<? extends ccg> $$0, double $$1, double $$2, double $$3, cqb $$4) {
      this($$0, $$4);
      this.e($$1, $$2, $$3);
   }

   protected ccg(bja<? extends ccg> $$0, bjm $$1, cqb $$2) {
   ...
   public void l() {
      ...
      if (this.O == 0.0F && this.N == 0.0F) {
         double $$2 = $$1.h();
         this.r((float)(asb.d($$1.c, $$1.e) * 180.0F / (float)Math.PI));
         this.s((float)(asb.d($$1.d, $$2) * 180.0F / (float)Math.PI));
         this.N = this.dB();
         this.O = this.dD();
      }
      ...
      if (this.b && !$$0) {
         ...
         ehh $$8 = this.dj();
         ehh $$9 = $$8.e($$1);
         ehf $$10 = this.dL().a(new cpk($$8, $$9, cpk.a.a, cpk.b.a, this));
         if ($$10.c() != ehf.a.a) {
            $$9 = $$10.e();
         }
         ...
         while (!this.dG()) {
            ...
            if ($$10 != null && $$10.c() == ehf.a.c) {
               biw $$12 = ((ehe)$$10).a();
               biw $$13 = this.v();
               if ($$12 instanceof cca && $$13 instanceof cca && !((cca)$$13).a((cca)$$12)) {
                  $$10 = null;
                  $$11 = null;
               }
            }
         ...
         double $$21 = $$1.h();
         if ($$0) {
            this.r((float)(asb.d(-$$14, -$$16) * 180.0F / (float)Math.PI));
         } else {
            this.r((float)(asb.d($$14, $$16) * 180.0F / (float)Math.PI));
         }

         this.s((float)(asb.d($$15, $$21) * 180.0F / (float)Math.PI));
         ...
         if (this.aX()) {
            for (int $$24 = 0; $$24 < 4; $$24++) {
               float $$25 = 0.25F;
               this.dL().a(iv.e, $$18 - $$14 * 0.25, $$19 - $$15 * 0.25, $$20 - $$16 * 0.25, $$14, $$15, $$16);
            }
   ...
   private boolean F() {
      return this.b && this.dL().b(new ehc(this.dj(), this.dj()).g(0.06));
   }
   ...
   protected void a(ehe $$0) {
      ...
      int $$3 = asb.c(asb.a((double)$$2 * this.n, 0.0, 2.147483647E9));
      if (this.B() > 0) {
         if (this.q == null) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof bjm $$10) {
            if (!this.dL().B && this.B() <= 0) {
               $$10.p($$10.eN() + 1);
            }

            if (this.o > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.b(bks.i));
               ehh $$12 = this.do().d(1.0, 0.0, 1.0).d().a((double)this.o * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dL().B && $$5 instanceof bjm) {
               cnw.a($$10, $$5);
               cnw.b((bjm)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof cca && $$5 instanceof aku && !this.aS()) {
               ((aku)$$5).c.b(new yc(yc.g, 0.0F));
            }
            ...
            if (!this.dL().B && $$5 instanceof aku $$13) {
   ...
   protected void a(ehd $$0) {
      ...
      super.a($$0);
      ehh $$1 = $$0.e().a(this.dq(), this.ds(), this.dw());
      this.f($$1);
      ehh $$2 = $$1.d().a(0.05F);
   ...
   protected ehe a(ehh $$0, ehh $$1) {
      return cct.a(this.dL(), this, $$0, $$1, this.cG().b(this.do()).g(1.0), this::a);
   }
   ...
   public void a(qw $$0) {
      ...
      if ($$0.b("inBlockState", 10)) {
         this.l = rj.a(this.dL().a(jc.e), $$0.p("inBlockState"));
      }
      ...
      this.d = ccg.a.a($$0.f("pickup"));
      this.a($$0.q("crit"));
      this.a($$0.f("PierceLevel"));
      if ($$0.b("SoundEvent", 8)) {
         this.p = jb.c.b(new aez($$0.l("SoundEvent"))).orElse(this.s());
      }
   ...
   public void b(@Nullable biw $$0) {
      super.b($$0);
      if ($$0 instanceof cca) {
         this.d = ((cca)$$0).fT().d ? ccg.a.c : ccg.a.b;
      }
   }
