...
public class eif extends eik {
   public static final MapCodec<eif> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, eif::new));
   ...
   public List<egs.a> a(ddy $$0, BiConsumer<je, dua> $$1, azk $$2, int $$3, je $$4, egc $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azc.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azc.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eif.a> $$13 = Lists.newArrayList();
      $$13.add(new eif.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               je $$21 = $$4.b(azc.a($$19), $$12 - 1, azc.a($$20));
               je $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  je $$27 = new je($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new eif.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<egs.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(ddy $$0, BiConsumer<je, dua> $$1, azk $$2, je $$3, je $$4, boolean $$5, egc $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         je $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            je $$13 = $$3.b(azc.d(0.5F + (float)$$12 * $$9), azc.d(0.5F + (float)$$12 * $$10), azc.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dni.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(ddy $$0, BiConsumer<je, dua> $$1, azk $$2, int $$3, je $$4, List<eif.a> $$5, egc $$6) {
      for (eif.a $$7 : $$5) {
         int $$8 = $$7.a();
         je $$9 = new je($$4.u(), $$8, $$4.w());
