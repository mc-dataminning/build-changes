...
public class eif {
   private static final eif a = new eif(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eif.a a(int $$0, int $$1) {
         return new eif.a(1.0, 0.0);
      }
   ...
   private static final ewr b = ewr.b(new eie(42L), ql.a);
   ...
   private final Long2ObjectOpenHashMap<eig> h;
   private final Long2ObjectOpenHashMap<eig> i;

   public static eif a() {
      return a;
   }

   public static eif a(@Nullable asa $$0) {
      if ($$0 == null) {
         return a;
      } else {
         djc $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<eig> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<eig> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azo.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eif($$2, $$3);
         }
      }
   }

   eif(Long2ObjectOpenHashMap<eig> $$0, Long2ObjectOpenHashMap<eig> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eif.a a(int $$0, int $$1) {
      int $$2 = jq.a($$0);
      int $$3 = jq.a($$1);
      double $$4 = this.a($$2, 0, $$3, eig::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eif.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jq.d(djc.a($$5x)), jq.d(djc.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = (double)azo.f((float)($$2 - $$5xx), (float)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = azo.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new eif.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(egw.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jq.d(djc.a($$6x)), jq.d(djc.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = azo.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = azo.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return azo.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, eif.b $$3) {
      int $$4 = jq.e($$0);
      int $$5 = jq.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eif.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      eig $$6 = (eig)this.h.get(djc.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jq.d($$1), $$4, $$5 - jq.d($$2)) : Double.MAX_VALUE;
   }

   public dld a(dld $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jf<dla> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jf<dla> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jf<dla>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jq.d(djc.a($$5x)), $$1, jq.d(djc.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = (double)azo.f((float)($$0 - $$4xx), (float)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = azo.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (jf)$$4.getValue();
      }
   }

   public static void a(asa $$0, edb $$1) {
      djc $$2 = $$1.f();
      boolean $$3 = $$1.u();
      iv.a $$4 = new iv.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ehd.a.e, $$16, $$17)) + 1;
   ...
   private static void a(edb $$0, iv $$1) {
      ebe $$2 = $$0.a_($$1);
      if ($$2.a(axe.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dkw $$0, edv $$1) {
      djc $$2 = $$1.f();
      Builder<jc, eig> $$3 = ImmutableMap.builder();
   ...
   public static eif.c a(@Nullable eig $$0, Map<jc, eig> $$1) {
      List<eif.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eif.c a(@Nullable jc $$0, eig $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jb $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return azo.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(eig var1, int var2, int var3, int var4);
   }
