...
public class fmm {
   ...
   public void a(fmm.b $$0, List<aug> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fmm.c($$0, $$1.stream().map(aug::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fmm.c(fmm.b.c, ImmutableList.of());
      }

      this.b.c = new fmm.a($$0);
   }
   ...
   static class c {
      private final fmm.b a;
      private final List<String> b;
      @Nullable
      fmm.a c;
      boolean d;

      c(fmm.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
