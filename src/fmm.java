...
public class fmm extends fmb {
   private static final fnq d = new fnq(alj.b("widget/text_field"), alj.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayy> D = ($$0x, $$1x) -> ayy.forward($$0x, yg.a);
   @Nullable
   private xj E;
   private long F = ae.c();

   public fmm(flo $$0, int $$1, int $$2, xj $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fmm(flo $$0, int $$1, int $$2, int $$3, int $$4, xj $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fmm(flo $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fmm $$5, xj $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, ayy> $$0) {
      this.D = $$0;
   }
   ...
   protected xx aN_() {
      xj $$0 = this.z();
      return xj.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = azm.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azm.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, frw.t());
   }
   ...
   public void b(flq $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.f()) {
            alj $$4 = d.a(this.C(), this.aL_());
            $$0.a(gjq::B, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         boolean $$9 = this.aL_() && (ae.c() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.D() + 4 : this.D();
         int $$11 = this.r ? this.E() + (this.h - 8) / 2 : this.E();
         int $$12 = $$10;
         int $$13 = azm.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if (this.E != null && $$7.isEmpty() && !this.aL_()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gjq.G(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = azm.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = azm.a(this.v, 0, this.p.length());
      }
   }
