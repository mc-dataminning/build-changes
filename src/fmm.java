...
public class fmm {
   ...
   public static void a(File $$0, ffa $$1, Consumer<xv> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ffa $$2, Consumer<xv> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ffa $$2, Consumer<xv> $$3) {
      ffq $$4 = a($$2);
      ...
      ae.h().execute(() -> {
         try {
            $$4.a($$6);
            xv $$3x = xv.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new xt(xt.a.b, $$6.getAbsolutePath())));
            $$3.accept(xv.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(xv.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static ffq a(ffa $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ffq $$3 = new ffq($$1, $$2, false);
   ...
   public fmm(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
