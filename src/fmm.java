...
public class fmm {
   private static final akn a = new akn("advancements/title_box");
   ...
   private final axr r;
   private final int s;
   private final List<axr> t;
   private final feb u;
   @Nullable
   private fmm v;
   private final List<fmm> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fmm(fmk $$0, feb $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ty.a().a($$1.h.a($$3.a(), 163));
      this.y = ayf.d($$3.f() * 28.0F);
      this.z = ayf.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = ty.a().a(this.a(xa.a($$3.b().f(), xu.a.a($$3.e().a())), $$7));
   ...
   private static float a(fem $$0, List<xc> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xc> a(wx $$0, int $$1) {
      fem $$2 = this.u.h.b();
      List<xc> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<xc> $$6 = $$2.b($$0, $$1 - $$5, xu.a);
