...
public class bxl extends bxc {
   ...
   public void b() {
      ...
      if (this.e % 2 == 0 && this.e < 10) {
         ...
         for (int $$4 = 0; $$4 < 8; $$4++) {
            ...
            for (int $$8 = 0; $$8 < 6; $$8++) {
               this.a.dK().a(iv.i, $$5, $$6, $$7, -$$0.c * 0.08F * (double)$$8, -$$0.d * 0.6F, -$$0.e * 0.08F * (double)$$8);
            }
   ...
   public void c() {
      ...
      if (this.e >= 200) {
         ...
         ehd $$0 = new ehd(this.a.e.dp() - this.a.dp(), 0.0, this.a.e.dv() - this.a.dv()).d();
         float $$1 = 5.0F;
         ...
         $$5 = (double)(arp.a($$5) + 1);
         this.g = new bif(this.a.dK(), $$2, $$5, $$3);
         this.g.a(this.a);
         this.g.a(5.0F);
         this.g.b(200);
         this.g.a(iv.i);
         this.g.a(new bhv(bhx.g));
         this.a.dK().b(this.g);
      }
   }
