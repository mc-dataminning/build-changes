...
public class dzm {
   private static final dtc a = dfe.id.n();
   private static final dtc b = dfe.ie.n();
   private static final dtc c = dfe.ju.n();
   private static final dtc d = dfe.ih.n();
   private static final dtc e = dfe.ip.n();
   private static final dtc f = dfe.ir.n();
   private static final dtc g = dfe.il.n();
   private static final dtc h = dfe.jw.n();
   private static final dtc i = dfe.eD.n();
   private final dtc j;
   private final int k;
   private final dtc[] l;
   private final eoh m;
   ...
   public dzm(dzi $$0, dtc $$1, int $$2, dzh $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dzd.P);
      this.l = a($$3.a(new akt("clay_bands")));
      this.u = $$0.a(dzd.N);
      this.v = $$0.a(dzd.O);
      this.n = $$0.a(dzd.Q);
      this.o = $$0.a(dzd.R);
   ...
   public void a(dzi $$0, ddb $$1, jn<dcz> $$2, boolean $$3, dzr $$4, final duy $$5, dyy $$6, dzl.o $$7) {
      final ir.a $$8 = new ir.a();
      final dbh $$9 = $$5.g();
      int $$10 = $$9.d();
      int $$11 = $$9.e();
      duv $$12 = new duv() {
      ...
      dzl.g $$13 = new dzl.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dzl.u $$14 = $$7.apply($$13);
      ir.a $$15 = new ir.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dyu.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ja<dcz> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(ddg.G)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dyu.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dtc> a(dzl.o $$0, eau $$1, Function<ir, ja<dcz>> $$2, duy $$3, dyy $$4, ir $$5, boolean $$6) {
      dzl.g $$7 = new dzl.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(li.az), $$1);
      dzl.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
   ...
   private void a(duv $$0, int $$1, int $$2, int $$3, dcc $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dcz $$1, duv $$2, ir.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dfe.al) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(ayt $$0, dtc[] $$1, int $$2, dtc $$3) {
      int $$4 = $$0.a(6, 15);
