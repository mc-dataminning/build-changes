public class dzm {
   ...
   private int a(dgv $$0, int $$1, int $$2, int $$3) {
      int $$4 = hx.c($$0.g($$1) + 1);
   ...
   public boolean a(cor $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(cor $$0, int $$1, int $$2, gu $$3, dez $$4, gu $$5, dez $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(cor $$0, gu $$1, dez $$2) {
      gu.a $$3 = this.e.g($$1);
   ...
   private static boolean a(cor $$0, gu $$1, dez $$2, gu $$3, dez $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         ehw $$5 = dzt.a($$0, $$1, $$2, ha.a);
         ehw $$6 = dzt.a($$0, $$3, $$4, ha.b);
         return eht.b($$5, $$6);
      }
   }
