...
public final class dzm extends dzp<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dzm(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dzm $$1 && super.equals($$0)) {
   ...
   public static dzm a(String $$0, int $$1, int $$2) {
