public class bpe implements bpa {
   ...
   public void a() {
      if (this.k == bpe.a.c) {
         ...
         $$2 *= $$4;
         $$3 *= $$4;
         float $$5 = arw.a(this.d.dB() * (float) (Math.PI / 180.0));
         float $$6 = arw.b(this.d.dB() * (float) (Math.PI / 180.0));
         float $$7 = $$2 * $$6 - $$3 * $$5;
         float $$8 = $$3 * $$6 + $$2 * $$5;
         if (!this.b($$7, $$8)) {
            this.i = 1.0F;
         ...
         float $$13 = (float)(arw.d($$10, $$9) * 180.0F / (float)Math.PI) - 90.0F;
         ...
         if ($$11 > (double)this.d.dF() && $$9 * $$9 + $$10 * $$10 < (double)Math.max(1.0F, this.d.df())
            || !$$16.c() && this.d.ds() < $$16.c(ha.a.b) + (double)$$14.v() && !$$15.a(aps.p) && !$$15.a(aps.S)) {
            this.d.K().a();
            this.k = bpe.a.d;
         }
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         eba $$3 = $$2.o();
         if ($$3 != null && $$3.a(this.d.dL(), arw.a(this.d.dq() + (double)$$0), this.d.dr(), arw.a(this.d.dw() + (double)$$1)) != eax.c) {
            return false;
         }
      }
