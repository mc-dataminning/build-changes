...
public abstract class bpe<C, V> implements boy<StringReader, V>, bpf {
   private final bos<alz> b;
   protected final C a;

   protected bpe(bos<alz> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(box<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
