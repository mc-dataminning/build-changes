...
public class bpe extends bow {
   ...
   public bpe(cwz $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bpc.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bpe(bpc<? extends bpe> $$0, cwz $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         epr $$0 = new epr(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void s() {
      ...
      if (this.dM() instanceof apf) {
         for (bpe $$1 : this.dM().a(drb.a(bpe.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(apf $$0, epr $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bpe($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(apf $$0, epr $$1, int $$2) {
      epm $$3 = epm.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bpe> $$5 = $$0.a(drb.a(bpe.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bpe $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bpe $$0) {
      return $$0 != this && a($$0, this.aj(), this.i);
   }

   private static boolean a(bpe $$0, int $$1, int $$2) {
      return !$$0.dH() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bpe $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cis $$0, int $$1) {
      Entry<bpd, cqk> $$2 = cuv.a(cux.L, $$0, cqk::k);
      if ($$2 != null) {
         cqk $$3 = $$2.getValue();
