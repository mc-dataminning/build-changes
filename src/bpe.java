...
public record bpe(Instant a, String b, long c) {
   ...
   public static bpe a(RecordedEvent $$0) {
      ...
      return new bpe($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bpe.a a(List<bpe> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bpe>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bpe $$3 = (bpe)$$2x.get(0);
            bpe $$4 = (bpe)$$2x.get($$2x.size() - 1);
