...
public class gly {
   ...
   public gly(kk $$0, int $$1, int $$2, int $$3) {
      ...
      int $$12 = $$7.w() - $$6;
      int $$13 = $$12 + $$5 * 16 - 1;
      this.a = new gly.b(new ene($$8, $$10, $$12, $$9, $$11, $$13));
   }

   public boolean a(gpk.b $$0) {
      return this.a.a($$0);
   }

   public void a(gly.e $$0, gpo $$1, int $$2) {
   ...
   class b implements gly.d {
      ...
      @Override
      public void a(gly.e $$0, boolean $$1, gpo $$2, int $$3, int $$4, boolean $$5) {
         boolean $$6 = $$1;
         if (!$$1) {
            int $$7 = $$2.a(this.c);
            $$1 = $$7 == -2;
   ...
   public interface d {
      void a(gly.e var1, boolean var2, gpo var3, int var4, int var5, boolean var6);
