...
public class awi extends awf {
   private static final Logger d = LogUtils.getLogger();
   private final ServerSocket e;
   private final String f;
   private final List<awh> g = Lists.newArrayList();
   private final ama h;

   private awi(ama $$0, ServerSocket $$1, String $$2) {
      super("RCON Listener");
      this.h = $$0;
      this.e = $$1;
      this.f = $$2;
