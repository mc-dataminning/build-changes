...
public class awi extends awh {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awi.a> s;
   private final awd t;
   private long u;
   private final alz v;

   private awi(alz $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awe.c($$2, 7, $$0.getLength());
      }
   }
