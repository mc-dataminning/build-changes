...
public class fdw extends fdx {
   private static final vq k = vq.c("chat.copy");
   private static final vq l = vq.c("chat.link.warning");
   private final String m;
   private final boolean n;

   public fdw(BooleanConsumer $$0, String $$1, boolean $$2) {
      this($$0, c($$2), vq.b($$1), $$1, $$2 ? vp.e : vp.g, $$2);
   }

   public fdw(BooleanConsumer $$0, vq $$1, String $$2, boolean $$3) {
      this($$0, $$1, a($$3, $$2), $$2, $$3 ? vp.e : vp.g, $$3);
   }

   public fdw(BooleanConsumer $$0, vq $$1, vq $$2, String $$3, vq $$4, boolean $$5) {
      super($$0, $$1, $$2);
   ...
   protected void a(int $$0) {
      this.d(ezh.a(this.a, $$0x -> this.c.accept(true)).a(this.g / 2 - 50 - 105, $$0, 100, 20).a());
      this.d(ezh.a(k, $$0x -> {
         this.n();
         this.c.accept(false);
      }).a(this.g / 2 - 50, $$0, 100, 20).a());
      this.d(ezh.a(this.b, $$0x -> this.c.accept(false)).a(this.g / 2 - 50 + 105, $$0, 100, 20).a());
   }
   ...
   public static ezh.c b(ffe $$0, String $$1) {
      return $$2 -> a($$0, $$1);
   }
}
