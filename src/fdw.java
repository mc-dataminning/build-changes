...
public abstract class fdw<E extends bil> extends fey<E> {
   ...
   protected fdw(boolean $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      this(foh::e, $$0, $$1, $$2, $$3, $$4, $$5);
   }

   protected fdw(Function<aeu, foh> $$0, boolean $$1, float $$2, float $$3, float $$4, float $$5, float $$6) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.f = $$3;
