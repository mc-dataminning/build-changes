...
public class fdw implements fdt {
   ...
   private FT_Face c;
   final float d;
   private final fri<fdw.b> e = new fri<>(fdw.b[]::new, fdw.b[][]::new);
   ...
   public fdw(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      ...
      try {
         FT_Vector $$12 = frv.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fds a(int $$0, FT_Face $$1, int $$2) {
      ...
      if ($$3 != 0) {
         frv.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (frv.a) {
            frv.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
