...
public class fdw {
   ...
   public static List<fdw.a> a(String $$0, fdw.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fdw.a> a(String $$0, List<fdw.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fdw.a> a(List<String> $$0, List<fdw.b> $$1) {
      int $$2 = 0;
      List<fdw.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fdw.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fdw.b a(String $$0, String $$1) {
         return new fdw.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fdw.b a(String $$0) {
         return new fdw.b($$0);
      }
   }
}
