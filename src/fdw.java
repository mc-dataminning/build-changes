...
public class fdw implements fdt {
   @Nullable
   private ByteBuffer b;
   @Nullable
   private FT_Face c;
   final float d;
   private final frh<fdw.b> e = new frh<>(fdw.b[]::new, fdw.b[][]::new);

   public fdw(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
   ...
   private fds a(int $$0, FT_Face $$1, int $$2) {
      ...
      if ($$4 == null) {
         ...
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (fds)($$9 > 0 && $$10 > 0 ? new fdw.a((float)$$7, (float)$$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
      ...
      public fro bake(Function<fdu, fro> $$0) {
         return $$0.apply(new fdu() {
            ...
            public void a(int $$0, int $$1) {
               FT_Face $$2 = fdw.this.b();
               feu $$3 = new feu(feu.a.d, a.this.b, a.this.c, false);
               if ($$3.a($$2, a.this.g)) {
