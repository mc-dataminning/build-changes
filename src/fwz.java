...
public class fwz implements fxe.a {
   ...
   private final evr J;
   private final Map<hx, fwz.a> K = Maps.newHashMap();
   private final Map<UUID, xy.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         blw $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dG();
      });
   }

   private void b(eqk $$0, ftt $$1, double $$2, double $$3, double $$4) {
      hx $$5 = hx.a($$2, $$3, $$4);
   ...
   private void a(eqk $$0, ftt $$1, fwz.a $$2) {
      int $$3 = 0;
   ...
   private void a(eqk $$0, ftt $$1, xy.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         fxm.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(eqk $$0, ftt $$1, xy.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(eqk $$0, ftt $$1, String $$2, fwz.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(fwz.a $$0) {
      return this.b($$0.a).stream().map(adi::a).collect(Collectors.toSet());
   }

   private Set<String> c(fwz.a $$0) {
      return this.c($$0.a).stream().map(adi::a).collect(Collectors.toSet());
   }

   private boolean b(xy.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(xy.a $$0) {
      cfq $$1 = this.J.s;
      hx $$2 = hx.a($$1.dq(), $$0.h().b(), $$1.dw());
      hx $$3 = hx.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(hx $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(xy.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(hx $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(xy.a::a).collect(Collectors.toSet());
   }

   private Map<hx, List<String>> c() {
      Map<hx, List<String>> $$0 = Maps.newHashMap();

      for (xy.a $$1 : this.L.values()) {
   ...
   private void d() {
      fxe.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cw());
   }
