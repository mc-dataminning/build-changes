...
public class fph {
   ...
   public static List<fph.a> a(String $$0, fph.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fph.a> a(String $$0, List<fph.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fph.a> a(List<String> $$0, List<fph.b> $$1) {
      int $$2 = 0;
      List<fph.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fph.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fph.b a(String $$0, String $$1) {
         return new fph.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fph.b a(String $$0) {
         return new fph.b($$0);
      }
   }
}
