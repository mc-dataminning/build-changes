...
public class fph implements hgf {
   private static final long a = 3000L;
   private final flz b;
   private final List<fph.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fph.b> e = new ArrayList<>();
   ...
   public void a(fnl $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fph.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hfb $$0, hgh $$1, float $$2) {
      if ($$1.a() != null) {
         xv $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fph.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fbs($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fph.b($$3, $$2, new fbs($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fbs a, long b) {
   }

   static class b {
      private final xv a;
      private final float b;
      private final List<fph.a> c = new ArrayList<>();

      public b(xv $$0, float $$1, fbs $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fph.a($$2, ae.c()));
      }
