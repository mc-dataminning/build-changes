...
public class fph {
   public static class a implements fpz<jy> {
      ...
      public fpw a(jy $$0, fmt $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fph.b $$8 = new fph.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends fqw {
      b(fmt $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * aty.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fqi {
      private boolean b;
      private boolean F;
      private final fpy G;
      private float H;
      ...
      c(fmt $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fpy $$7, fqr $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fph.c $$0 = new fph.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fpz<jy> {
      ...
      public fpw a(jy $$0, fmt $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fph.c $$8 = new fph.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, euk.N().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fpu {
      private int a;
      private final fpy b;
      private sp D;
      private boolean E;

      public e(fmt $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fpy $$7, @Nullable sj $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, ard.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            sj $$7 = this.D.a($$6);
            cll.a $$8 = cll.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            fpw $$17 = this.b.a(jv.L, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               arb $$19 = $$18 ? arc.io : arc.in;
               this.c.a(this.g, this.h, this.i, $$19, ard.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fph.c $$10 = (fph.c)this.b.a(jv.C, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = aty.d($$18, $$13, $$16) * $$0;
                  double $$20 = aty.d($$18, $$14, $$17) * $$0;
