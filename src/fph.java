...
public class fph {
   ...
   public static void a(File $$0, fhu $$1, Consumer<wy> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fhu $$2, Consumer<wy> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fhu $$2, Consumer<wy> $$3) {
      fik $$4 = a($$2);
   ...
   public static fik a(fhu $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fik $$3 = new fik($$1, $$2, false);
   ...
   public fph(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
