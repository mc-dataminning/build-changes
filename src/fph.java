...
public class fph implements hgi {
   ...
   @Override
   public void a(hfd $$0, hgk $$1, float $$2) {
      if ($$1.a() != null) {
         xk $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fph.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fbr($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fph.b($$3, $$2, new fbr($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fbr a, long b) {
   }
