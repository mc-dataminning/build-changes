public class gbz extends gca<gyj> {
   ...
   public static gfi a() {
      ...
      for (int $$3 = 0; $$3 < 4; $$3++) {
         $$1.a(
            a($$3),
            gfh.c().a(c[$$3][0], c[$$3][1]).a((float)b[$$3][0] * -0.5F, 0.0F, (float)b[$$3][2] * -0.5F, (float)b[$$3][0], (float)b[$$3][1], (float)b[$$3][2]),
            gfe.a(0.0F, (float)(24 - b[$$3][1]), $$2)
         );
         if ($$3 < 3) {
