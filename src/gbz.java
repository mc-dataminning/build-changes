...
public abstract class gbz {
   private static final Object2ObjectMap<akm, gbz> a = ac.a(new Object2ObjectArrayMap(), $$0 -> {
      gbz.c $$1 = new gbz.c();
      $$0.defaultReturnValue($$1);
      $$0.put(dur.e, $$1);
      $$0.put(dur.f, new gbz.b());
      $$0.put(dur.g, new gbz.a());
   });
   ...
   public float[] a(float $$0, float $$1) {
      float $$2 = 0.4F;
      float $$3 = ayd.b($$0 * (float) (Math.PI * 2)) - 0.0F;
      float $$4 = -0.0F;
      if ($$3 >= -0.4F && $$3 <= 0.4F) {
         float $$5 = ($$3 - -0.0F) / 0.4F * 0.5F + 0.5F;
         float $$6 = 1.0F - (1.0F - ayd.a($$5 * (float) Math.PI)) * 0.99F;
         $$6 *= $$6;
   ...
   public abstract euk a(euk var1, float var2);
