public class gbz extends fzj<gya> {
   ...
   public static gcr a(gcp $$0) {
      gct $$1 = new gct();
      gcv $$2 = $$1.a();
      $$2.a("shoulders", gcq.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gcn.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         gcq.c()
         ...
         gcn.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         gcq.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gcn.a(-2.0F, 6.9F + azm.b(0.20420352F) * 10.0F, -0.5F + azm.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", gcq.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gcn.a);
      gcq $$4 = gcq.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gcn.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gcn.a(10.0F, 4.0F, 0.0F));
   ...
   private static void a(gya $$0, gcl $$1, int $$2) {
