...
public abstract class bhh extends DataFix {
   private final String a;

   public bhh(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bgw.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bgw.B);
      Type<Pair<String, String>> $$2 = DSL.named(bgw.z.typeName(), bih.a());
      if (!Objects.equals(this.getOutputSchema().getType(bgw.z), $$2)) {
