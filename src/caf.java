public abstract class caf extends cao {
   protected bts d;
   protected iz e = iz.c;
   protected boolean f;
   private boolean a;
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         dsd $$1 = this.d.dP().a_(this.e);
         if ($$1.b() instanceof dhg) {
            ((dhg)$$1.b()).a(this.d, this.d.dP(), $$1, this.e, $$0);
         }
      }
   }
