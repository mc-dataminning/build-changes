...
public class agf {
   ...
   private static int a(dt $$0, Collection<? extends aod<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> tn.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> tn.a("commands.banlist.list", $$1.size()), false);

         for (aod<?> $$2 : $$1) {
            $$0.a(() -> tn.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
