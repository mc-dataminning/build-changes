...
public class agf {
   private static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> ti.a("clear.failed.single", $$0));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ti.a("clear.failed.multiple", $$0));
   ...
   private static int a(dt $$0, Collection<ako> $$1, Predicate<cja> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = 0;
      ...
      if ($$4 == 0) {
         ...
         if ($$3 == 0) {
            if ($$1.size() == 1) {
               $$0.a(() -> ti.a("commands.clear.test.single", $$6, $$1.iterator().next().H_()), true);
            } else {
               $$0.a(() -> ti.a("commands.clear.test.multiple", $$6, $$1.size()), true);
            }
         } else if ($$1.size() == 1) {
            $$0.a(() -> ti.a("commands.clear.success.single", $$6, $$1.iterator().next().H_()), true);
         } else {
            $$0.a(() -> ti.a("commands.clear.success.multiple", $$6, $$1.size()), true);
         }
