...
public class bdu extends bam {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bdu::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bdu::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bdu::k);
         $$0 = this.a($$0, "minecraft:fox", bdu::j);
         $$0 = this.a($$0, "minecraft:item", bdu::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bdu::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bdu::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bdu::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bdu::e);
         return this.a($$0, "minecraft:piglin", bdu::d);
      });
   }
