...
public class bdu implements bdv {
   ...
   private static final bdu j = new bdu();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bdt $$0) {
      URL $$1 = bdu.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bdt $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bdx a = new bdx(() -> bdu.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bdu.this.k && $$0.getState() == RecordingState.STOPPED) {
