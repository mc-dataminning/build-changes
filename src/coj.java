...
public class coj extends coo {
   ...
   private static final akj<Boolean> a = akn.a(coj.class, akl.k);
   private static final akj<Integer> d = akn.a(coj.class, akl.b);
   private float bG;
   private float bH;
   private float bI;
   private float bJ;
   ...
   public coj(bwr<? extends coj> $$0, djm $$1) {
      super($$0, $$1);
      this.by = 10;
      this.a(exr.j, 0.0F);
      this.bA = new coj.c(this);
      this.bG = this.ae.i();
      this.bH = this.bG;
   }
   ...
   protected void D() {
      ...
      this.bD.a(4, new coj.a(this));
      this.bD.a(5, $$0);
      this.bD.a(7, this.c);
      this.bD.a(8, new cen(this, crm.class, 8.0F));
      this.bD.a(8, new cen(this, coj.class, 12.0F, 0.01F));
      this.bD.a(9, new cfa(this));
      this.c.a(EnumSet.of(cef.a.a, cef.a.b));
      $$0.a(EnumSet.of(cef.a.a, cef.a.b));
      this.bE.a(1, new cfy<>(this, bxj.class, 10, true, false, new coj.b(this)));
   }

   public static byo.a q() {
      return coo.gw().a(byp.c, 6.0).a(byp.v, 0.5).a(byp.s, 30.0);
   }
   ...
   public static boolean b(bwr<? extends coj> $$0, djn $$1, bwq $$2, iv $$3, azv $$4) {
   ...
   static class b implements chy.a {
      ...
      public boolean test(@Nullable bxj $$0, arq $$1) {
         return ($$0 instanceof crm || $$0 instanceof ckd || $$0 instanceof cko) && $$0.g(this.a) > 9.0;
      }
   }
