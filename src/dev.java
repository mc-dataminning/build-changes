...
public class dev {
   ...
   private final dev.a e;
   private final long f;

   public dev(dev.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dev a(dev.a $$0) {
      return new dev($$0, this.f);
   }

   public jn<det> a(je $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jn<det> a(double $$0, double $$1, double $$2) {
      int $$3 = jy.a(azc.a($$0));
      int $$4 = jy.a(azc.a($$1));
      int $$5 = jy.a(azc.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ayx.a($$7, $$0);
      double $$10 = b($$7);
      return azc.k($$6 + $$10) + azc.k($$5 + $$9) + azc.k($$4 + $$8);
   }
   ...
   public interface a {
      jn<det> getNoiseBiome(int var1, int var2, int var3);
   }
}
