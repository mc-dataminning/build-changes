...
public class ty extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<ta> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, sm.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<ta> $$0, Codec<T> $$1, sm $$2) {
      ta $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> ty a(DynamicOps<ta> $$0, Codec<T> $$1, T $$2) {
      ta $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = atg.a(h, this.s(), JsonElement.class);
   ...
   public <T> void a(il<ig<T>> $$0, ig<T> $$1, ty.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> ig<T> a(il<ig<T>> $$0, ty.a<T> $$1) {
      int $$2 = this.n();
      if ($$2 == 0) {
         return ig.a($$1.apply(this));
      } else {
         ig<T> $$3 = $$0.a($$2 - 1);
         if ($$3 == null) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, ty.a<T> $$1) {
      int $$2 = this.n();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, ty.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, ty.a<K> $$1, ty.a<V> $$2) {
      int $$3 = this.n();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(ty.a<K> $$0, ty.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, ty.b<K> $$1, ty.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, ty.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, ty.b<L> $$1, ty.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(ty.a<L> $$0, ty.a<R> $$1) {
   ...
   public ejz k() {
      return new ejz(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public uv l() {
      return this.a(sr.a, ux.a, sm.a(2097152L));
   }

   public uv m() {
      return this.a(sr.a, ux.a);
   }

   public ty a(uv $$0) {
      return this.a(sr.a, ux.a, $$0);
   }
   ...
   public <T> ty a(ToIntFunction<T> $$0, T $$1) {
   ...
   public ty a(@Nullable ta $$0) {
      if ($$0 == null) {
         $$0 = sf.b;
      }

      try {
         sq.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   @Nullable
   public sd q() {
      ta $$0 = this.a(sm.a(2097152L));
      if ($$0 != null && !($$0 instanceof sd)) {
   ...
   public ta a(sm $$0) {
      try {
         ta $$1 = sq.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public ty a(String $$0, int $$1) {
      ul.a(this.d, $$0, $$1);
      return this;
   }

   public agm t() {
      return new agm(this.d(32767));
   }
   ...
   public <T> agl<T> a(agl<? extends is<T>> $$0) {
      agm $$1 = this.t();
      return agl.a($$0, $$1);
   }
   ...
   public ejv y() {
      hx $$0 = this.e();
      ib $$1 = this.b(ib.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new ejv(new ejz((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, atq.e($$1, 8)));
      }
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), ty::a);
   }

   public Property C() {
      String $$0 = this.s();
      String $$1 = this.s();
      String $$2 = this.c(ty::s);
   ...
   public ty a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ty a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public ty a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ty a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ty a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ty a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ty a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public ty a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public ty b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public ty c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public ty d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public ty e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public ty f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public ty g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public ty h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public ty a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public ty b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public ty i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public ty a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public ty a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public ty b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ty b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public ty b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ty b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ty b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ty b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public ty a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ty a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public ty a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public ty a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public ty a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ty a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public ty a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public ty b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public ty b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public ty b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public ty b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public ty b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
   ...
   @FunctionalInterface
   public interface a<T> extends Function<ty, T> {
      default ty.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<ty, T> {
      default ty.b<Optional<T>> asOptional() {
