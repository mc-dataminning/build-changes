...
public abstract class bxb<E extends bvi> implements bxc<E> {
   public static final int a = 60;
   protected final Map<cem<?>, cen> b;
   private bxb.a c = bxb.a.a;
   private long d;
   private final int e;
   private final int f;

   public bxb(Map<cem<?>, cen> $$0) {
      this($$0, 60);
   }

   public bxb(Map<cem<?>, cen> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bxb(Map<cem<?>, cen> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cem<?>, cen> $$1 : this.b.entrySet()) {
         cem<?> $$2 = $$1.getKey();
         cen $$3 = $$1.getValue();
         if (!$$0.eb().a($$2, $$3)) {
            return false;
