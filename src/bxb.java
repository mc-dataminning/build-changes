...
public class bxb {
   ...
   public static hx a(aup $$0, int $$1, int $$2) {
      int $$3 = $$0.a(2 * $$1 + 1) - $$1;
      int $$4 = $$0.a(2 * $$2 + 1) - $$2;
      int $$5 = $$0.a(2 * $$1 + 1) - $$1;
      return new hx($$3, $$4, $$5);
   ...
   @Nullable
   public static hx a(aup $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      double $$7 = aui.d($$5, $$4) - (float) (Math.PI / 2);
      double $$8 = $$7 + (double)(2.0F * $$0.i() - 1.0F) * $$6;
      double $$9 = Math.sqrt($$0.j()) * (double)aui.g * (double)$$1;
   ...
   @Nullable
   public static elm a(bmo $$0, Supplier<hx> $$1) {
      return a($$1, $$0::h);
   }

   @Nullable
   public static elm a(Supplier<hx> $$0, ToDoubleFunction<hx> $$1) {
      ...
      return $$3 != null ? elm.c($$3) : null;
   }

   public static hx a(bmo $$0, int $$1, aup $$2, hx $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.fQ() && $$1 > 1) {
         hx $$6 = $$0.fN();
