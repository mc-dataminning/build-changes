...
public class gcn implements AutoCloseable {
   ...
   private final Map<String, exe> f = Maps.newHashMap();
   private final List<exe> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public gcn(gnw $$0, atz $$1, exe $$2, akm $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gnw $$0, akm $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(JsonElement $$0) throws akp {
      if (axu.a($$0)) {
         ...
         if (this.f.containsKey($$2)) {
            throw new akp($$2 + " is already defined");
         }
   ...
   private void a(gnw $$0, JsonElement $$1) throws IOException {
      ...
      if ($$6 == null) {
         throw new akp("Input target '" + $$4 + "' does not exist");
      } else if ($$7 == null) {
         throw new akp("Output target '" + $$5 + "' does not exist");
      } else {
         ...
         if ($$10 != null) {
            ...
            for (JsonElement $$12 : $$10) {
               try {
                  ...
                  if ($$20 == null) {
                     if ($$16) {
                        throw new akp("Render target '" + $$17 + "' can't be used as depth buffer");
                     }

                     akm $$21 = new akm("textures/effect/" + $$17 + ".png");
                     this.c.getResource($$21).orElseThrow(() -> new akp("Render target or texture '" + $$17 + "' does not exist"));
   ...
   private void b(JsonElement $$0) throws akp {
      ...
      String $$2 = axu.i($$1, "name");
      eyj $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
         throw new akp("Uniform '" + $$2 + "' does not exist");
      } else {
         float[] $$4 = new float[4];
         int $$5 = 0;
   ...
   public gco a(String $$0, exe $$1, exe $$2, boolean $$3) throws IOException {
   ...
   @Nullable
   private exe b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
