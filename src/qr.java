...
public class qr implements rk {
   public static final Codec<qr> a = Codec.PASSTHROUGH.comapFlatMap($$0 -> {
      rk $$1 = (rk)$$0.convert(rc.a).getValue();
      return $$1 instanceof qr ? DataResult.success((qr)$$1) : DataResult.error(() -> "Not a compound tag: " + $$1);
   }, $$0 -> new Dynamic(rc.a, $$0));
   ...
   public static final rm<qr> b = new rm.b<qr>() {
      public qr a(DataInput $$0, int $$1, ra $$2) throws IOException {
         ...
         if ($$1 > 512) {
            ...
            Map<String, rk> $$3 = Maps.newHashMap();
   ...
   public int a() {
      ...
      for (Entry<String, rk> $$1 : this.x.entrySet()) {
   ...
   public byte[] m(String $$0) {
      try {
         ...
         throw new y(this.a($$0, qo.a, var3));
      }
   ...
   public qx c(String $$0, int $$1) {
      try {
         ...
         throw new y(this.a($$0, qx.a, var4));
      }
   ...
   public qr h() {
      Map<String, rk> $$0 = Maps.newHashMap(Maps.transformValues(this.x, rk::d));
      return new qr($$0);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof qr && Objects.equals(this.x, ((qr)$$0).x);
   }
