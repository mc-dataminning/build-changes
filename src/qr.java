...
public class qr extends qt<qs> {
   private static final int b = 24;
   public static final rp<qr> a = new rp.b<qr>() {
      public qr a(DataInput $$0, int $$1, rd $$2) throws IOException {
         $$2.a(24L);
         int $$3 = $$0.readInt();
         $$2.a(1L * (long)$$3);
         byte[] $$4 = new byte[$$3];
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof qr && Arrays.equals(this.c, ((qr)$$0).c);
   }
   ...
   public qs a(int $$0) {
      return qs.a(this.c[$$0]);
   }

   public qs a(int $$0, qs $$1) {
      byte $$2 = this.c[$$0];
      this.c[$$0] = $$1.i();
      return qs.a($$2);
   }

   public void b(int $$0, qs $$1) {
   ...
   public boolean b(int $$0, rn $$1) {
      if ($$1 instanceof rh) {
         this.c = ArrayUtils.add(this.c, $$0, ((rh)$$1).i());
         return true;
      } else {
         return false;
      }
