...
public class aos extends aor {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aos.a> s;
   private final aon t;
   private long u;
   private final afk v;

   private aos(afk $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aoo.c($$2, 7, $$0.getLength());
      }
   }
