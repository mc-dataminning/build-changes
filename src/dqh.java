...
public class dqh extends dph {
   ...
   private ale<ejt> j = ale.a(lq.aM, new alf("empty"));
   private dqh.a k = dqh.a.a;
   private String l = "minecraft:air";
   private int m;
   private int q;

   public dqh(iz $$0, dsc $$1) {
      super(dpj.F, $$0, $$1);
   }
   ...
   protected void a(us $$0, jk.a $$1) {
      ...
      this.k = dqh.a.a($$0.l("joint")).orElseGet(() -> djb.m(this.n()).o().d() ? dqh.a.b : dqh.a.a);
   ...
   public void a(arf $$0, int $$1, boolean $$2) {
      iz $$3 = this.ay_().a(this.n().c(djb.b).a());
      jv<ejt> $$4 = $$0.H_().d(lq.aM);
      ji<ejt> $$5 = $$4.g(this.j);
      ejn.a($$0, $$5, this.i, $$1, $$3, $$2);
   }
   ...
   public static enum a implements azu {
      ...
      public static Optional<dqh.a> a(String $$0) {
