...
public class dqh {
   ...
   private dqh b(jh $$0) {
      dxn $$2 = this.a.a_($$0);
      if (djt.h($$2)) {
         return new dqh(this.a, $$0, $$2);
      } else {
         jh $$1 = $$0.d();
         $$2 = this.a.a_($$1);
         if (djt.h($$2)) {
            return new dqh(this.a, $$1, $$2);
         } else {
            $$1 = $$0.e();
            $$2 = this.a.a_($$1);
            return djt.h($$2) ? new dqh(this.a, $$1, $$2) : null;
         }
      }
   }
   ...
   public dqh a(boolean $$0, boolean $$1, dyq $$2) {
      jh $$3 = this.b.f();
      jh $$4 = this.b.g();
      jh $$5 = this.b.h();
      jh $$6 = this.b.i();
