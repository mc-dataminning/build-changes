...
public class gip extends MinecraftServer {
   ...
   public gip(Thread $$0, evg $$1, egl.c $$2, aps $$3, aic $$4, ahz $$5, ann $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gio(this, this.ba(), this.h));
      this.n = $$1;
   }
