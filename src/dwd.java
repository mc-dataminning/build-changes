...
public class dwd {
   ...
   private static final int j = iy.a(16);
   ...
   private final czi p;
   private static final List<dch> q = List.of(dcj.l, dcj.L, dcj.i, dcj.b, dcj.k, dcj.I, dcj.K, dcj.fl, dcj.dP, dcj.iA, dcj.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<in<daf>>> t;
   ...
   public static final Codec<dwd> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dwd::a, Function.identity());
   ...
   private dwd(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<in<daf>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jg.c($$0);
      int $$5 = jg.c($$1) - $$4;
   ...
   @Nullable
   public static dwd a(aqb $$0, int $$1, int $$2) {
      dre $$3 = $$0.a($$1, $$2);
      dwd $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dsd.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ik> a(dab $$0, int $$1, int $$2, boolean $$3) {
      Set<ik> $$4 = EnumSet.noneOf(ik.class);
   ...
   private void a(dre $$0, Set<ik> $$1) {
      if (!this.r) {
         if ($$1.contains(ik.a) || $$1.contains(ik.g) || $$1.contains(ik.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(ik.c) && $$1.contains(ik.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(ik.c) && $$1.contains(ik.e) && $$1.contains(ik.d)) {
   ...
   private void a(int $$0, dre $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, axm.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dre $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dva.a.a)) {
         $$3 = Math.min($$0.a(dva.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }

      int $$5 = this.p.I_();
      id.a $$6 = new id.a($$1, $$3, $$2);
   ...
   private static double a(dre $$0, id.a $$1) {
      return a($$0, (id)$$1.c(ij.a)) ? 1.0 : -1.0;
   }

   private static double b(dre $$0, id.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dre $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      id.a $$5 = new id.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<in<daf>> b(dre $$0, int $$1, int $$2) {
      ObjectArrayList<in<daf>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + iy.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(iy.a($$1), $$5, iy.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dre $$0, id $$1) {
      dpi $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(ave.O)) {
         ...
         return $$2.a(dcj.eT) || $$2.a(dcj.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dwd.a $$3) {
      if ($$1 >= iy.a(this.p.I_()) && $$1 < iy.a(this.p.al())) {
         int $$4 = $$1 - iy.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               in<daf> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dwd.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dwd.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, in<daf> var3);
   }
