...
public class dwd extends dwg<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dwd(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dwd $$1 && super.equals($$0)) {
   ...
   public static dwd a(String $$0, int $$1, int $$2) {
      return new dwd($$0, $$1, $$2);
   }
