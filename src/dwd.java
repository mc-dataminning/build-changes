...
public class dwd extends dwe {
   ...
   public static final Codec<dwd> c = RecordCodecBuilder.create(
      $$0 -> a($$0).and(dwc.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, dwd::new)
   );
   private final dwc h;

   public dwd(bjh $$0, dwh $$1, Optional<dwb> $$2, dwc $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(cud $$0, BiConsumer<hx, djp> $$1, auw $$2, hx $$3, hx $$4, dvc $$5) {
   ...
   private boolean a(cud $$0, auw $$1, hx $$2, ic $$3, hx $$4, List<hx> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<hx> a(hx $$0, ic $$1, auw $$2, hx $$3) {
      hx $$4 = $$0.d();
      hx $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
