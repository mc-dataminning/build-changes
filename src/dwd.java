...
public class dwd extends dwf {
   public static final Codec<dwd> a = arg.<dwd>a(
   ...
   public dwd(ib $$0, dwf.c $$1, float $$2, int $$3, Optional<dwf.a> $$4, int $$5, int $$6, dwe $$7) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
      this.d = $$6;
      this.e = $$7;
   ...
   public dwd(int $$0, int $$1, dwe $$2, int $$3) {
      this(ib.g, dwf.c.a, 1.0F, $$3, Optional.empty(), $$0, $$1, $$2);
   }
