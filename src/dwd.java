...
public class dwd extends dvq<dxn> {
   public dwd(Codec<dxn> $$0) {
      super($$0);
   }
   ...
   private void a(axd $$0, cxa $$1, int $$2, int $$3, ib $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ib $$2, cxa $$3, boolean $$4, double $$5, ib $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cxa $$0, ib $$1) {
      if ($$0.a_($$1.c()).a(dac.dN)) {
         this.a($$0, $$1.c(), dac.a.o());
      }
   }

   private void a(cxa $$0, axd $$1, ib $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dmz $$13) {
   ...
   private void a(ib $$0, cxa $$1, axd $$2, int $$3, int $$4, boolean $$5, boolean $$6, dmz $$7) {
      dmz $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dac.dP) || $$8.a(dac.dO) || $$8.a(dac.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dac.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dac.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dmz $$0) {
      return $$0.a(dac.iC) || $$0.a(dac.dP) || $$0.a(dac.mW);
   }
   ...
   private void a(cxa $$0, ib $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dac.dN)) {
                  if (this.a((cwf)$$0, $$10)) {
                     this.a($$0, $$10, dac.a.o());
                     this.a($$0, $$10.c(), dac.a.o());
                  } else if (c($$11)) {
                     dmz[] $$12 = new dmz[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
