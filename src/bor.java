...
public abstract class bor extends bpw {
   private static final aim<Boolean> bX = aiq.a(bor.class, aio.k);
   ...
   protected bor(bpc<? extends bor> $$0, cwz $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bor a(apf var1, bor var2);
   ...
   protected void k() {
      if (!this.o_() && this.bO() && this.cZ() instanceof ckp $$0 && !$$0.b((bow)this)) {
         this.ac();
      }
   }
