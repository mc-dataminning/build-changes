...
public class bor extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bou.a(new Dynamic($$0, $$1), bor.a, bou.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bix.s.typeName()) ? super.getChoiceType($$0, bks.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bix.s, () -> DSL.optionalFields("components", bix.w.in($$0), DSL.taggedChoiceLazy("id", bks.a(), $$2)));
