...
public class bmc<E extends bjk> extends bkz<E> {
   ...
   protected List<bmc.a> h = Lists.newArrayList();
   protected Optional<ehp> i = Optional.empty();
   @Nullable
   protected ehp j;
   protected int k;
   protected long l;
   private final Function<E, ape> q;
   private final BiPredicate<E, gw> r;

   public bmc(bgl $$0, int $$1, int $$2, float $$3, Function<E, ape> $$4) {
      this($$0, $$1, $$2, $$3, $$4, bmc::a);
   }

   public static <E extends bjk> boolean a(E $$0, gw $$1) {
      cpx $$2 = $$0.dL();
      gw $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(ebi.a($$2, $$1.j())) == 0.0F;
   }

   public bmc(bgl $$0, int $$1, int $$2, float $$3, Function<E, ape> $$4, BiPredicate<E, gw> $$5) {
      super(ImmutableMap.of(bsj.n, bsk.c, bsj.R, bsk.b, bsj.S, bsk.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(aks $$0, bjk $$1) {
      boolean $$2 = $$1.aA() && !$$1.aX() && !$$1.bl() && !$$0.a_($$1.dl()).a(csy.pg);
      if (!$$2) {
         $$1.dN().a(bsj.R, this.p.a($$0.z) / 2);
      }

      return $$2;
   }

   protected boolean b(aks $$0, bjk $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.dj()) && this.k > 0 && !$$1.ba() && (this.j != null || !this.h.isEmpty());
      if (!$$3 && $$1.dN().c(bsj.S).isEmpty()) {
         $$1.dN().a(bsj.R, this.p.a($$0.z) / 2);
         $$1.dN().b(bsj.n);
      }
   ...
   protected void a(aks $$0, E $$1, long $$2) {
      ...
      this.h = gw.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new bmc.a($$1x.i(), ary.c($$3.j($$1x))))
   ...
   protected void c(aks $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.f(this.j.a($$4 / $$3));
            $$1.dN().a(bsj.S, true);
            $$0.a(null, $$1, this.q.apply($$1), apg.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   protected Optional<bmc.a> a(aks $$0) {
      Optional<bmc.a> $$1 = bfn.a($$0.z, this.h);
      $$1.ifPresent(this.h::remove);
      return $$1;
   }

   private boolean a(aks $$0, E $$1, gw $$2) {
      gw $$3 = $$1.dl();
      int $$4 = $$3.u();
      int $$5 = $$3.w();
   ...
   @Nullable
   private ehp a(bjk $$0, ehp $$1, int $$2) {
      ehp $$3 = $$0.dj();
      ehp $$4 = new ehp($$1.c - $$3.c, 0.0, $$1.e - $$3.e).d().a(0.5);
      $$1 = $$1.d($$4);
      ehp $$5 = $$1.d($$3);
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            for (int $$26 = 0; $$26 < $$22 - 1; $$26++) {
               ...
               double $$28 = $$23 * $$17;
               double $$29 = $$23 * $$16;
               ehp $$30 = new ehp($$3.c + $$28, $$3.d + $$27, $$3.e + $$29);
            ...
            return new ehp($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }

   private boolean a(bjk $$0, bit $$1, ehp $$2, ehp $$3) {
      ehp $$4 = $$3.d($$2);
   ...
   public static class a extends bfm.a {
      private final gw a;
