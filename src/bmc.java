...
public class bmc {
   ...
   private bmc(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bmc a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bmc($$0, $$1);
   }

   public bmc.d a() throws IOException {
      bmc.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bmc.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bmc.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bmc.c $$3 = bmc.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bmc.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bmc.a($$0, $$3);
            }
         }
   ...
   public bmc.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bmc.c> $$2 = this.a().c();
      ...
      bmc.e $$4 = new bmc.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bmc.c b) implements bmc.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bmc.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bmc.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bmc.b> {
      private final List<bmc.b> a;

      d(List<bmc.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bmc.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bmc.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bmc.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bmc.d a() {
         ListIterator<bmc.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bmc.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bmc.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bmc.b> b() {
         return this.a.stream();
      }

      public Set<bmc.c> c() {
         return this.a.stream().map(bmc.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bmc.c b) implements bmc.b {
