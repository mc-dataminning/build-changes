...
public class brd extends epe {
   ...
   public static epe.a<brd> a(long $$0) {
      return new epe.a<>(() -> new brd($$0), ($$1, $$2) -> a($$0, $$1), bag.m);
   }
   ...
   private brc b(alf $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new brc($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<alf, brc> $$0) {
      this.f.forEach($$0);
   }
   ...
   public us a(us $$0, jk.a $$1) {
      ...
      us $$2 = new us();
      this.f.forEach(($$1x, $$2x) -> $$2.a($$1x.toString(), (vp)brc.a.encodeStart(vg.a, $$2x).result().orElseThrow()));
      $$0.a("sequences", $$2);
      return $$0;
   }
   ...
   public static brd a(long $$0, us $$1) {
      brd $$2 = new brd($$0);
      ...
      for (String $$5 : $$3.e()) {
         try {
            brc $$6 = (brc)((Pair)brc.a.decode(vg.a, $$3.c($$5)).result().get()).getFirst();
            $$2.f.put(new alf($$5), $$6);
   ...
   class a implements azh {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return $$0 instanceof brd.a $$1 ? this.c.equals($$1.c) : false;
         }
      }
   }
}
