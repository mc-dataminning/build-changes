public class fvs extends ful<cum> {
   ...
   private int ak;
   private final fvs.a[] al = new fvs.a[7];
   int am;
   private boolean an;

   public fvs(cum $$0, cpv $$1, xv $$2) {
      super($$0, $$1, $$2);
      this.s = 276;
      this.x = 107;
   }
   ...
   protected void aT_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.al[$$3] = this.c(new fvs.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fvs.a) {
               this.ak = ((fvs.a)$$0x).a() + this.am;
               this.G();
            }
         }));
         $$2 += 20;
   ...
   protected void a(fnq $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(glt::B, P, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 512, 256);
      dgf $$6 = this.z.p();
      if (!$$6.isEmpty()) {
         int $$7 = this.ak;
         if ($$7 < 0 || $$7 >= $$6.size()) {
         ...
         dge $$8 = $$6.get($$7);
         if ($$8.r()) {
            $$0.a(glt::B, G, this.C + 83 + 99, this.D + 35, 28, 21);
         }
      }
   }

   private void a(fnq $$0, int $$1, int $$2, dge $$3) {
      int $$4 = this.z.n();
      int $$5 = this.z.l();
      if ($$4 < 5) {
         $$0.a(glt::B, H, $$1 + 136, $$2 + 16, 102, 5);
         int $$6 = cpj.b($$4);
         if ($$5 >= $$6 && cpj.d($$4)) {
            int $$7 = 102;
            float $$8 = 102.0F / (float)(cpj.c($$4) - $$6);
            int $$9 = Math.min(bae.d($$8 * (float)($$5 - $$6)), 102);
            $$0.a(glt::B, I, 102, 5, 0, 0, $$1 + 136, $$2 + 16, $$9, 5);
            int $$10 = this.z.m();
            if ($$10 > 0) {
               int $$11 = Math.min(bae.d((float)$$10 * $$8), 102 - $$9);
               $$0.a(glt::B, J, 102, 5, $$9, 0, $$1 + 136 + $$9, $$2 + 16, $$11, 5);
            }
         }
      }
   }

   private void a(fnq $$0, int $$1, int $$2, dgf $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
         ...
         $$0.a(glt::B, K, $$1 + 94, $$2 + 18 + $$8, 6, 27);
      } else {
         $$0.a(glt::B, L, $$1 + 94, $$2 + 18, 6, 27);
      }
   }
   ...
   private void a(fnq $$0, dge $$1, int $$2, int $$3) {
      if ($$1.r()) {
         $$0.a(glt::B, M, $$2 + 5 + 35 + 20, $$3 + 3, 10, 9);
      } else {
         $$0.a(glt::B, N, $$2 + 5 + 35 + 20, $$3 + 3, 10, 9);
      }
   }

   private void a(fnq $$0, cxo $$1, cxo $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.L() == $$1.L()) {
         $$0.a(this.p, $$1, $$3, $$4);
      } else {
   ...
   class a extends fod {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fod.c $$3) {
      ...
      public void a(fnq $$0, int $$1, int $$2) {
         if (this.i && fvs.this.z.p().size() > this.a + fvs.this.am) {
            if ($$1 < this.D() + 20) {
               cxo $$3 = fvs.this.z.p().get(this.a + fvs.this.am).b();
               $$0.b(fvs.this.p, $$3, $$1, $$2);
            } else if ($$1 < this.D() + 50 && $$1 > this.D() + 30) {
               cxo $$4 = fvs.this.z.p().get(this.a + fvs.this.am).c();
               if (!$$4.f()) {
                  $$0.b(fvs.this.p, $$4, $$1, $$2);
               }
            } else if ($$1 > this.D() + 65) {
               cxo $$5 = fvs.this.z.p().get(this.a + fvs.this.am).f();
               $$0.b(fvs.this.p, $$5, $$1, $$2);
            }
         }
      }
   }
