...
public class fvs extends fvi implements ggt.a {
   ...
   private final fvi J;
   private final ggt K;
   private final Map<ai, fvo> L = Maps.newLinkedHashMap();
   @Nullable
   private fvo M;
   private boolean N;
   ...
   public fvs(ggt $$0, @Nullable fvi $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aR_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fvo $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(fpq.a(wo.d, $$0x -> this.aO_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fpc $$0, int $$1, int $$2) {
      $$0.a(gnh::H, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fvo $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fvo $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fpc $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(aj $$0) {
      fvo $$1 = fvo.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
