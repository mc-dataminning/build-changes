...
public class cjd {
   ...
   private int g = axm.b(axt.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jh.a.fieldOf("uuid").forGetter(Pair::getFirst), awu.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bqa> j;
   @VisibleForTesting
   protected final ArrayList<bqa> c;
   private final cjd.a k;
   @VisibleForTesting
   protected final Object2IntMap<bqa> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cjd> a(Predicate<bqa> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cjd::b)).apply($$1, $$1x -> new cjd($$0, $$1x))
      );
   }

   public cjd(Predicate<bqa> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cjd.a(this);
   ...
   public void a(apu $$0, Predicate<bqa> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bqa>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bqa> $$6 = (Entry<bqa>)$$5.next();
         int $$7 = $$6.getIntValue();
         bqa $$8 = (bqa)$$6.getKey();
         bqa.c $$9 = $$8.dI();
   ...
   public int b(@Nullable bqa $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bqt> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bqt).map($$0 -> (bqt)$$0);
   }

   @VisibleForTesting
   protected static record a(cjd a) implements Comparator<bqa> {
      public int a(bqa $$0, bqa $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cka;
               boolean $$7 = $$1 instanceof cka;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
