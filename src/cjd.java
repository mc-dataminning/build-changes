...
public class cjd extends cjb implements bwg<cjk> {
   private static final ajx<Integer> bY = akb.a(cjd.class, ajz.b);
   private static final bun bZ = bur.am.n().a(bum.a().a(bul.a, 0.0F, bur.am.m() + 0.125F, 0.0F)).a(0.5F);

   public cjd(bur<? extends cjd> $$0, dgi $$1) {
      super($$0, $$1);
   }
