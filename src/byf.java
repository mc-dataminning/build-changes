...
public class byf extends bji {
   ...
   private static final bit bR = new bit(0.0F, 0.0F, true);
   private static final bit bS = biw.d.n().a(0.5F);
   ...
   public static final aeg<Byte> bC = aej.a(byf.class, aei.a);
   public static final aeg<hy> bD = aej.a(byf.class, aei.m);
   public static final aeg<hy> bE = aej.a(byf.class, aei.m);
   public static final aeg<hy> bF = aej.a(byf.class, aei.m);
   public static final aeg<hy> bG = aej.a(byf.class, aei.m);
   public static final aeg<hy> bH = aej.a(byf.class, aei.m);
   public static final aeg<hy> bI = aej.a(byf.class, aei.m);
   private static final Predicate<bis> bX = $$0 -> $$0 instanceof cdn && ((cdn)$$0).z() == cdn.a.a;
   private final hp<cjh> bY = hp.a(2, cjh.b);
   private final hp<cjh> bZ = hp.a(4, cjh.b);
   private boolean ca;
   public long bJ;
   private int cb;
   private hy cc = bL;
   ...
   public byf(biw<? extends byf> $$0, cpx $$1) {
      super($$0, $$1);
      this.t(0.0F);
   }

   public byf(cpx $$0, double $$1, double $$2, double $$3) {
      this(biw.d, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   @Override
   protected void fh() {
      for (bis $$1 : this.dL().a(this, this.cG(), bX)) {
         if (this.f($$1) <= 0.2) {
            $$1.g(this);
         }
      }
   ...
   private bix j(ehp $$0) {
      ...
      if ($$3 >= 0.1 && $$3 < 0.1 + ($$2 ? 0.8 : 0.45) && this.b($$4)) {
         $$1 = bix.c;
      } else if ($$3 >= 0.9 + ($$2 ? 0.3 : 0.0) && $$3 < 0.9 + ($$2 ? 1.0 : 0.7) && this.b(bix.e)) {
         $$1 = bix.e;
      } else if ($$3 >= 0.4 && $$3 < 0.4 + ($$2 ? 1.0 : 0.8) && this.b(bix.d)) {
         $$1 = bix.d;
      } else if ($$3 >= 1.6 && this.b(bix.f)) {
         $$1 = bix.f;
      } else if (!this.b(bix.a) && this.b(bix.b)) {
         $$1 = bix.b;
      }
   ...
   private boolean e(bix $$0) {
      return (this.cb & 1 << $$0.d()) != 0 || $$0.a() == bix.a.a && !this.t();
   }

   private boolean a(cbw $$0, bix $$1, cjh $$2, bgz $$3) {
      cjh $$4 = this.c($$1);
   ...
   public boolean a(bhq $$0, float $$1) {
      if (this.dL().B || this.dG()) {
         ...
         return false;
      } else if ($$0.a(apw.v) && this.eu() > 0.5F) {
         this.g($$0, 4.0F);
         return false;
      } else {
         boolean $$2 = $$0.c() instanceof ccc;
         boolean $$3 = $$2 && ((ccc)$$0.c()).B() > 0;
         boolean $$4 = "player".equals($$0.e());
         if (!$$4 && !$$2) {
            return false;
         } else {
            if ($$0.d() instanceof cbw $$5 && !$$5.fS().e) {
               return false;
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 32) {
         if (this.dL().B) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apf.an, this.da(), 0.3F, 1.0F, false);
            this.bJ = this.dL().V();
         }
      } else {
         super.b($$0);
   ...
   private void h(bhq $$0) {
      cjh $$1 = new cjh(cjk.tL);
      if (this.ac()) {
         $$1.a(this.ad());
      }

      csx.a(this.dL(), this.dl(), $$1);
      this.i($$0);
   }

   private void i(bhq $$0) {
      this.L();
      this.g($$0);
   ...
   private void L() {
      this.dL().a(null, this.dq(), this.ds(), this.dw(), apf.al, this.da(), 1.0F, 1.0F);
   }
   ...
   public boolean u(bis $$0) {
      return $$0 instanceof cbw && !this.dL().a((cbw)$$0, this.dl());
   }
   ...
   @Override
   public bji.a eF() {
      return new bji.a(apf.am, apf.am);
   }
   ...
   public ehp k(float $$0) {
      if (this.y()) {
         ehk $$1 = this.v(false).a(this.dj());
         gw $$2 = this.dl();
         int $$3 = Integer.MIN_VALUE;

         for (gw $$4 : gw.a(gw.a($$1.a, $$1.b, $$1.c), gw.a($$1.d, $$1.e, $$1.f))) {
            int $$5 = Math.max(this.dL().a(cqg.b, $$4), this.dL().a(cqg.a, $$4));
            if ($$5 == 15) {
               return ehp.b($$4);
            }
