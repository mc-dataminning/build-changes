public class fmq extends fmk {
   protected fmq(fin $$0, double $$1, double $$2, double $$3) {
   ...
   public void a() {
      ...
      if (this.t-- <= 0) {
         ...
         double $$1 = Math.max(
            this.c.a_($$0).k(this.c, $$0).b(ha.a.b, this.g - (double)$$0.u(), this.i - (double)$$0.w()), (double)this.c.b_($$0).a((cor)this.c, $$0)
         );
