...
public class bmn {
   ...
   public static bkr<bjh> a(float $$0) {
      Long2LongMap $$1 = new Long2LongOpenHashMap();
      MutableLong $$2 = new MutableLong(0L);
      return boc.a(
         (Function<boc.b<bjh>, ? extends App<boc.c<bjh>, bof<bjh>>>)($$3 -> $$3.group($$3.c(bsa.m), $$3.c(bsa.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.V() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        bty $$7 = $$4x.w();
                        Optional<gu> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(buc.n), $$5.dk(), 48, bty.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dk()) <= 4.0)) {
                           ...
                           Set<Pair<he<bub>, gu>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(buc.n), $$10, $$5.dk(), 48, bty.b.c).collect(Collectors.toSet());
                           eas $$12 = bkj.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              gu $$13 = $$12.l();
                              Optional<he<bub>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new bsd($$13, $$0, 1));
                                 aav.c($$4x, $$13);
                              }
