...
public class bmn implements bmo {
   ...
   private static final bmn k = new bmn();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bmm $$0) {
      URL $$1 = bmn.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bmm $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bmq a = new bmq(() -> bmn.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmn.this.l && $$0.getState() == RecordingState.STOPPED) {
