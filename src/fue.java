...
public class fue extends fpt {
   ...
   @Nullable
   gcd x;
   private final Consumer<gcd> y;
   final fno z = new fno(this);
   final gce A;

   public fue(@Nullable fpt $$0, @Nullable gcd $$1, gce $$2, Consumer<gcd> $$3) {
      super(a);
      this.v = $$0;
      this.x = $$1;
      this.y = $$3;
   ...
   protected void aT_() {
      this.z.a(a, this.p);
      fns $$0 = this.z.c(fns.d().a(4));
      this.w = $$0.a(new fue.a(this.m));
      fue.a.a $$1 = x.a(this.x, this.w::a);
      this.w.a($$1);
      $$0.a(fnt.b(this.J()));
      fns $$2 = this.z.b(fns.e().a(8));
      $$2.a(fka.a(c, fop.b(this, axy.m)).a());
      $$2.a(fka.a(xc.d, $$0x -> {
         fue.a.a $$1x = this.w.h();
         if ($$1x != null) {
            this.y.accept($$1x.b());
   ...
   public class a extends fkw<fue.a.a> {
      public a(final fib $$1) {
         super($$1, fue.this.n, fue.this.K(), fue.this.z.c(), 18);

         for (gcd $$2 : gcd.values()) {
            if (!gcd.a(fue.this.A).contains($$2)) {
      ...
      public void a(@Nullable fue.a.a $$0) {
         super.a($$0);
         fue.this.x = $$0 != null ? $$0.b() : null;
      }

      public class a extends fkw.a<fue.a.a> {
         final gcd b;

         public a(final gcd $$1) {
            this.b = $$1;
         }
         ...
         public void a(fjn $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            int $$10 = $$3 + 1;
            int $$11 = $$2 + ($$5 - 9) / 2 + 1;
            $$0.b(fue.this.p, this.b.b(), $$10, $$11, -1);
         }
