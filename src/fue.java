...
public class fue extends fua {
   ...
   fue(fpx $$0, double $$1, double $$2, double $$3, dpt $$4, int $$5) {
   ...
   public static class a implements ftd<kd> {
      private final ftv a;
      ...
      public fta a(kd $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fue $$8 = new fue($$1, $$2, $$3, $$4, $$0.c(), $$0.d());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
