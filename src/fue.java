...
public class fue {
   ...
   public final Map<ic, fuf> c;
   public final fug d;
   public final boolean e;

   public fue(Vector3f $$0, Vector3f $$1, Map<ic, fuf> $$2, @Nullable fug $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ic, fuf> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fue> {
      ...
      public fue a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         fug $$6 = this.a($$3);
         Map<ic, fuf> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !aud.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = aud.a($$3, "shade", true);
            return new fue($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fug a(JsonObject $$0) {
         fug $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<ic, fuf> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fuf> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ic, fuf> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ic, fuf> $$2 = Maps.newEnumMap(ic.class);
         JsonObject $$3 = aud.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ic $$5 = this.a($$4.getKey());
            $$2.put($$5, (fuf)$$0.deserialize($$4.getValue(), fuf.class));
         }
