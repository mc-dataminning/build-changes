...
public abstract class ewl {
   ...
   public evn a() {
      if (this.c()) {
         ...
         return new evn(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
      }
   }

   public ewl b() {
      return this.c() ? ewi.a() : ewi.a(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
   }
   ...
   public ewl a(double $$0, double $$1, double $$2) {
      return (ewl)(this.c() ? ewi.a() : new evu(this.a, new ewh(this.a(je.a.a), $$0), new ewh(this.a(je.a.b), $$1), new ewh(this.a(je.a.c), $$2)));
   }

   public ewl d() {
      ewl[] $$0 = new ewl[]{ewi.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewi.b($$0[0], ewi.a($$1, $$2, $$3, $$4, $$5, $$6), evw.o));
      return $$0[0];
   }
   ...
   public List<evn> e() {
      List<evn> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new evn($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(je.a.a, $$4.c - (double)$$2.u()), this.a(je.a.b, $$4.d - (double)$$2.v()), this.a(je.a.c, $$4.e - (double)$$2.w()))
               ? new evo($$4, je.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : evn.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<evs> a(evs $$0) {
      if (this.c()) {
   ...
   public ewl a(je $$0) {
      if (!this.c() && this != ewi.b()) {
         if (this.b != null) {
            ewl $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewl b(je $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewj(this, $$1, $$4);
      }
   }

   public double a(je.a $$0, evn $$1, double $$2) {
      return this.a(iw.a($$0, je.a.a), $$1, $$2);
   }

   protected double a(iw $$0, evn $$1, double $$2) {
      if (this.c()) {
         return $$2;
