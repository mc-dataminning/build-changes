...
public class cfx extends cfr {
   ...
   private void j() {
      if (this.c == null || this.c.c()) {
         int $$0 = this.a.y();
         im $$1 = this.a.dN().a(dvq.a.f, dyt.a(this.a.r()));
         ckl $$2 = this.a.dN().a(b, this.a, (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
         int $$4;
         if ($$2 != null) {
            etf $$3 = new etf($$2.ds(), 0.0, $$2.dy()).d();
            $$4 = this.a.r(-$$3.c * 40.0, 105.0, -$$3.e * 40.0);
         } else {
            $$4 = this.a.r(40.0, (double)$$1.v(), 0.0);
         }

         emd $$6 = new emd($$1.u(), $$1.v(), $$1.w());
