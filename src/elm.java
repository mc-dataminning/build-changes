...
public class elm {
   ...
   private final Map<String, Long2ObjectMap<uj>> e = Maps.newHashMap();
   private final Map<String, elu> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public elm(@Nullable ete $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public uj a(uj $$0) {
      uj $$1 = $$0.p("Level");
      deb $$2 = new deb($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(deb.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(deb.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private uj a(uj $$0, deb $$1) {
      uj $$2 = $$0.p("Level");
      uj $$3 = $$2.p("Structures");
      uj $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<uj> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable ete $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            uj $$2 = new uj();

            try {
               $$2 = $$0.a($$1, bas.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               uj $$4 = $$2.p($$3);
               long $$5 = deb.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               up $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  uj $$14 = $$2.p($$13);
                  $$12.a(deb.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static elm a(alg<dev> $$0, @Nullable ete $$1) {
      if ($$0 == dev.i) {
         return new elm(
            $$1,
         ...
         return new elm($$1, $$2, $$2);
      } else if ($$0 == dev.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new elm($$1, $$3, $$3);
      } else {
