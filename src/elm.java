...
public class elm extends LongLinkedOpenHashSet {
   private final elm.a a;

   public elm(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new elm.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = axw.f(60000000);
      private static final int b = axw.f(60000000);
