...
public class dgu {
   ...
   private final int j;
   private final int k;
   private List<dgu.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public dgu(boolean $$0, avd<daa> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static dgu a() {
      return new dgu(false, aun.bM, 10, 4, 10, 5);
   }

   public static dgu b() {
      return new dgu(true, aun.bN, 50, 1, 5, 10);
   }
   ...
   public void a(ta $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<dgu.a> $$1 = (List<dgu.a>)dgu.a.b.listOf().parse(new Dynamic(to.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(ta $$0) {
      dgu.a.b.listOf().encodeStart(to.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(ib $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dgu.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dgu.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(cxa $$0, ib $$1, axd $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<dgu.a> $$4 = new ArrayList<>();
         Map<ib, dgu.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dgu.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ib.a.fieldOf("pos").forGetter(dgu.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dgu.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dgu.a::c),
      ...
      private boolean a(cxa $$0, ib $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(cxa $$0, ib $$1, axd $$2, dgu $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, aty.vp, atz.e, 1.0F, 1.0F);
               }
      ...
      private static dgp a(dmz $$0) {
         return $$0.b() instanceof dgp $$1 ? $$1 : dgp.s_;
      }
      ...
      @Nullable
      private static ib a(cxa $$0, ib $$1, axd $$2) {
         ib.a $$3 = $$1.j();
         ib.a $$4 = $$1.j();
      ...
      private static boolean a(cxa $$0, ib $$1, ib $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            ib $$3 = $$2.b($$1);
      ...
      private static boolean a(cxa $$0, ib $$1, ih $$2) {
         ib $$3 = $$1.a($$2);
