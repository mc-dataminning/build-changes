...
public class dgu {
   public static final dgu a = new dgu(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<dgu> b = RecordCodecBuilder.create(
   ...
   public dgu(List<String> $$0, List<String> $$1) {
