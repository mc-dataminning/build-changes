...
public class fie extends fhg {
   ...
   public fie(fgx $$0, int $$1, int $$2, int $$3, int $$4, wu $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fih($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fli $$0) {
      $$0.a(flh.a, wu.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   protected void c(fgz $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aJ_()) {
         ...
         int $$5 = this.o.d();
         boolean $$6 = this.aJ_() && (ac.c() - this.p) / 300L % 2L == 0L;
         boolean $$7 = $$5 < $$4.length();
         int $$8 = 0;
         int $$9 = 0;
         int $$10 = this.E() + this.a();

         for (fih.a $$11 : this.o.h()) {
   ...
   private void k() {
      double $$0 = this.c();
      fih.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fih.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
