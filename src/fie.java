...
public abstract class fie {
   ...
   public fie(@Nullable String $$0, boolean $$1) {
   ...
   public void b(int $$0, int $$1) {
      ...
      if ($$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2) {
         ...
         if (this.h) {
            this.k = new fjr(() -> this.g + " / Depth", fjs.c, $$0, $$1, 1);
            this.k.a(fjq.a, false);
            this.k.a(fjp.b);
         }

         this.j = new fjr(() -> this.g + " / Color", fjs.a, $$0, $$1, 1);
         this.j.a(fjp.b);
         this.a(fjq.a, true);
   ...
   private void a(fjq $$0, boolean $$1) {
      if (this.j == null) {
   ...
   public void e() {
      RenderSystem.assertOnRenderThread();
      RenderSystem.getQuadVertices().a(gqx.Q(), $$0 -> $$0.a("InSampler", this.j));
   }
