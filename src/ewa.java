...
public class ewa {
   public static void a(fkf<?> $$0, evy $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<evx>> $$6 : $$1.c().entrySet()) {
         Optional<fmw> $$7 = $$0.a($$6.getKey());
         List<evx> $$8 = $$6.getValue();
   ...
   private static float a(evy $$0, long $$1) {
