...
public class ewa implements ewb, ewc {
   ...
   private final fbe<MinecraftServer> G;
   ...
   public ewa(dhd $$0, eeh $$1, ewa.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         jh.c,
   ...
   public static <T> ewa a(Dynamic<T> $$0, dhd $$1, ewa.a $$2, eeh $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new ewa(
         (um)$$0.get("Player").flatMap(um.a::parse).result().orElse(null),
         ...
         new fbe<>(fbd.a, $$0.get("ScheduledEvents").asStream()),
         (um)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(ebm.a.a).resultOrPartial(f::error).orElse(ebm.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public um a(ke $$0, @Nullable um $$1) {
      if ($$1 == null) {
         $$1 = this.o;
      }
   ...
   private void a(ke $$0, um $$1, @Nullable um $$2) {
      ...
      $$1.a("Version", $$3);
      vb.e($$1);
      DynamicOps<vj> $$4 = $$0.a(va.a);
      eef.a($$4, this.h, $$0).resultOrPartial(ae.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vj)ebm.a.a.encodeStart(va.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dhw.b.encodeStart(va.a, this.g.g()).ifSuccess($$1x -> $$1.a((um)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   private static us a(Set<String> $$0) {
      us $$1 = new us();
      $$0.stream().map(vh::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean z() {
      return this.i == ewa.a.b;
   }

   @Override
   public boolean A() {
      return this.i == ewa.a.c;
   }
