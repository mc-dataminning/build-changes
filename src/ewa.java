public abstract class ewa {
   ...
   protected final etz d;
   protected final atq e;

   protected ewa(etz $$0, atq $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public void a(eub $$0, int $$1, int $$2) {
      int $$3 = $$0.b();
      $$0.a(fqp.C(), $$1, $$3 - 60, $$1 + $$2, $$3, -1873784752);
      long $$4 = 0L;
      long $$5 = 2147483647L;
      long $$6 = -2147483648L;
      ...
      for (int $$9 = 0; $$9 < $$8; $$9++) {
         ...
         int $$13 = this.a($$11);
         $$0.a(fqp.C(), $$10, $$3 - $$12, $$10 + 1, $$3, $$13);
      }

      $$0.a(fqp.C(), $$1, $$1 + $$2 - 1, $$3 - 60, -1);
      $$0.a(fqp.C(), $$1, $$1 + $$2 - 1, $$3 - 1, -1);
      $$0.b(fqp.C(), $$1, $$3 - 60, $$3, -1);
      $$0.b(fqp.C(), $$1 + $$2 - 1, $$3 - 60, $$3, -1);
      if ($$8 > 0) {
   ...
   protected void a(eub $$0, String $$1, int $$2, int $$3) {
      $$0.a(fqp.C(), $$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
   ...
   protected int a(double $$0, double $$1, int $$2, double $$3, int $$4, double $$5, int $$6) {
      $$0 = ati.a($$0, $$1, $$5);
      return $$0 < $$3 ? ass.b.a((float)($$0 / ($$3 - $$1)), $$2, $$4) : ass.b.a((float)(($$0 - $$3) / ($$5 - $$3)), $$4, $$6);
   }
}
