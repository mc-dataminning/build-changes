...
public class ewa {
   private static final agi b = new agi("icon/ping_unknown");
   private static final agi c = new agi("icon/ping_1");
   private static final agi d = new agi("icon/ping_2");
   private static final agi e = new agi("icon/ping_3");
   private static final agi f = new agi("icon/ping_4");
   private static final agi g = new agi("icon/ping_5");
   private static final agi h = new agi("hud/heart/container_blinking");
   private static final agi i = new agi("hud/heart/container");
   private static final agi j = new agi("hud/heart/full_blinking");
   private static final agi k = new agi("hud/heart/half_blinking");
   private static final agi l = new agi("hud/heart/absorbing_full_blinking");
   private static final agi m = new agi("hud/heart/full");
   private static final agi n = new agi("hud/heart/absorbing_half_blinking");
   private static final agi o = new agi("hud/heart/half");
   private static final Comparator<fls> p = Comparator.<fls>comparingInt($$0 -> $$0.e() == crx.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), ekr::b, ""))
   ...
   private ur t;
   private boolean u;
   private final Map<UUID, ewa.a> v = new Object2ObjectOpenHashMap();

   public ewa(etd $$0, eun $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public ur a(fls $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, ekr.a($$0.h(), ur.b($$0.a().getName())));
   }

   private ur a(fls $$0, vf $$1) {
      return $$0.e() == crx.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(euo $$0, int $$1, ekt $$2, @Nullable ekq $$3) {
      List<fls> $$4 = this.b();
      int $$5 = 0;
      int $$6 = 0;
      ...
      for (int $$28 = 0; $$28 < $$10; $$28++) {
         ...
         if ($$28 < $$4.size()) {
            ...
            GameProfile $$34 = $$33.a();
            if ($$13) {
               cdu $$35 = this.q.r.b($$34.getId());
               boolean $$36 = $$35 != null && fwy.e($$35);
               boolean $$37 = $$35 != null && $$35.a(cdv.g);
               evy.a($$0, $$33.g().a(), $$31, $$32, 8, $$37, $$36);
               $$31 += 9;
            }

            $$0.b(this.q.h, this.a($$33), $$31, $$32, $$33.e() == crx.d ? -1862270977 : -1);
            if ($$3 != null && $$33.e() != crx.d) {
               int $$38 = $$31 + $$5 + 1;
               int $$39 = $$38 + $$14;
               if ($$39 - $$38 > 5) {
   ...
   protected void a(euo $$0, int $$1, int $$2, int $$3, fls $$4) {
      agi $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
   ...
   private void a(ekq $$0, int $$1, String $$2, int $$3, int $$4, UUID $$5, euo $$6) {
      int $$7 = $$0.a().c($$2, $$0).b();
      if ($$0.f() == ekw.a.b) {
         this.a($$1, $$3, $$4, $$5, $$6, $$7);
      } else {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, euo $$4, int $$5) {
      ewa.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new ewa.a($$5));
      $$6.a($$5, (long)this.r.e());
      int $$7 = atm.e(Math.max($$5, $$6.a()), 2);
      int $$8 = Math.max($$5, Math.max($$6.a(), 20)) / 2;
      boolean $$9 = $$6.a((long)this.r.e());
      if ($$7 > 0) {
         int $$10 = atm.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
            float $$11 = atm.a((float)$$5 / 20.0F, 0.0F, 1.0F);
