...
public class ewa extends evu<ewa.a> {
   protected ewa(ecj $$0) {
      super(dje.a, $$0, new ewa.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected ecb g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && jx.c($$0) < $$2) {
            ...
            return this.j($$0) ? new ecb(15) : new ecb();
         }
      }
   }
   ...
   protected static final class a extends evr<ewa.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<ecb> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public ewa.a a() {
         return new ewa.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
