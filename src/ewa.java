...
public class ewa implements egl.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ewa> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azf<ewa> a = azf.a(f);
   private final ewe g;
   private final ewe h;
   private final ewe i;
   ...
   public static ewa a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ewa(new eht(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ewa(ewe $$0, ewe $$1, ewe $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ewa(azv $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ewe.a($$0, IntStream.rangeClosed(-15, 0)),
         ewe.a($$0, IntStream.rangeClosed(-15, 0)),
         ewe.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ewa a(azv $$0) {
      return new ewa($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(egl.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ewb $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ewe.b($$4 * $$13), ewe.b($$5 * $$13), ewe.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ewe.b($$1 * $$13);
         double $$21 = ewe.b($$2 * $$13);
         double $$22 = ewe.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ewb $$24 = this.g.a($$19);
            if ($$24 != null) {
