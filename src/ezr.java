...
public class ezr extends ezi<cer> {
   private static final aew x = new aew("container/cartography_table/error");
   private static final aew y = new aew("container/cartography_table/scaled_map");
   private static final aew z = new aew("container/cartography_table/duplicated_map");
   private static final aew A = new aew("container/cartography_table/map");
   private static final aew B = new aew("container/cartography_table/locked");
   private static final aew C = new aew("textures/gui/container/cartography_table.png");
