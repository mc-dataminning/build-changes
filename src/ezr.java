...
public class ezr extends eyy<cev> {
   ...
   protected void aC_() {
      super.aC_();
      this.M = new fec(this.f.aP().a(fhr.m));
   }
   ...
   private void d(erv $$0, int $$1, int $$2, float $$3) {
      ...
      this.M.a(0.0F, $$8, $$9, $$4);
      elj $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, fyl.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      ekb.b();
   }
