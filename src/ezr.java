...
public class ezr extends ezv implements ezt {
   ...
   public ezr.c a() {
      return new ezr.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, fab.a $$1) {
   ...
   private ezr.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezr.a $$9 = new ezr.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezr.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fab.b.a || this.q == fab.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fac> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fac $$1 = (fac)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fac.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fac.b.c) {
         ezt.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezt.a($$11));
         this.a($$14 + 5, ezt.a($$12));
         this.a($$14 + 6, ezt.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fab a, int b, int c, fab.b d, fab.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezr.a c;
      private boolean d;

      b(final int $$1, final ezr.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(fab.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fae $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
