...
public class ezr {
   ...
   static class b {
      static final Optional<ezr> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ezr a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezr();
      }
   }
}
