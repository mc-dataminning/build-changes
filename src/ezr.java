...
public class ezr {
   ...
   public static void a(File $$0, esl $$1, Consumer<vu> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, esl $$2, Consumer<vu> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, esl $$2, Consumer<vu> $$3) {
      eta $$4 = a($$2);
   ...
   public static eta a(esl $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eta $$3 = new eta($$1, $$2, false);
   ...
   public ezr(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
