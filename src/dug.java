...
public class dug implements duc, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bon<bop.b> c;
   private final dul d;
   private final Map<dae, dug.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dug(dun $$0, Path $$1, boolean $$2) {
      this.d = new dul($$0, $$1, $$2);
      this.c = new bon<>(new bop.a(dug.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dae $$0, int $$1) {
      dae $$2 = new dae($$0.e - $$1, $$0.f - $$1);
      dae $$3 = new dae($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dae $$0, @Nullable ud $$1) {
      return this.a(() -> {
         dug.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dug.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dae $$0, ux $$1) {
      return this.a(() -> {
         try {
            dug.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bop.b(dug.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dae, dug.a>> $$0 = this.e.entrySet().iterator();
         Entry<dae, dug.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bop.b(dug.b.b.ordinal(), this::a));
   }

   private void a(dae $$0, dug.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bop.b(dug.b.c.ordinal(), () -> $$0.a(azf.a))).join();
         this.c.close();
