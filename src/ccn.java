...
public abstract class ccn {
   ...
   public ccn(btd $$0, dcf $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = ayg.a($$0.g(buj.m) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract eox a(int var1);
   ...
   @Nullable
   public final eov a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(ja.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eov a(Stream<ja> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eov a(Set<ja> $$0, int $$1) {
   ...
   @Nullable
   protected eov a(Set<ja> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(buj.m));
   }

   @Nullable
   protected eov a(Set<ja> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         ja $$5 = $$2 ? this.a.dq().c() : this.a.dq();
         int $$6 = (int)($$4 + (float)$$1);
         dcs $$7 = new dcs(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         eov $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ag().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eov $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            if ($$0.d > $$1.d && !this.a.aF() && ayg.a($$0.c) == ayg.a($$1.c) && ayg.a($$0.e) == ayg.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(ewf $$0) {
      ja $$1 = ja.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : epd.a(this.b, $$1);
   }
   ...
   private boolean c(ewf $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ewf $$1 = ewf.c(this.c.g());
         if (!$$0.a((jt)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ewf $$2 = ewf.c(this.c.d(this.c.f() + 1));
            ewf $$3 = $$1.d($$0);
            ewf $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void S_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eot $$1 = this.c.a($$0);
            eot $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dsk $$3 = this.b.a_(new ja($$1.a, $$1.b, $$1.c));
            if ($$3.a(avw.bl)) {
   ...
   public boolean b(eoy $$0) {
      return $$0 != eoy.n && $$0 != eoy.p && $$0 != eoy.d;
   }

   protected static boolean a(btd $$0, ewf $$1, ewf $$2, boolean $$3) {
      ewf $$4 = new ewf($$2.c, $$2.d + (double)$$0.dl() * 0.5, $$2.e);
      return $$0.dQ().a(new dbo($$1, $$4, dbo.a.a, $$3 ? dbo.b.c : dbo.b.a, $$0)).c() == ewd.a.a;
   }
   ...
   public boolean b(ja $$0) {
      if (this.m) {
         ...
         eot $$1 = this.c.d();
         ewf $$2 = new ewf(((double)$$1.a + this.a.dv()) / 2.0, ((double)$$1.b + this.a.dx()) / 2.0, ((double)$$1.c + this.a.dB()) / 2.0);
