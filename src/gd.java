...
public class gd implements gc {
   ...
   public eum a(ee $$0) {
      eul $$1 = $$0.k();
      eum $$2 = $$0.m().a($$0);
      float $$3 = ayf.b(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$4 = ayf.a(($$1.j + 90.0F) * (float) (Math.PI / 180.0));
      float $$5 = ayf.b(-$$1.i * (float) (Math.PI / 180.0));
      float $$6 = ayf.a(-$$1.i * (float) (Math.PI / 180.0));
      float $$7 = ayf.b((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      float $$8 = ayf.a((-$$1.i + 90.0F) * (float) (Math.PI / 180.0));
      eum $$9 = new eum((double)($$3 * $$5), (double)$$6, (double)($$4 * $$5));
      eum $$10 = new eum((double)($$3 * $$7), (double)$$8, (double)($$4 * $$7));
      eum $$11 = $$9.c($$10).a(-1.0);
      ...
      return new eum($$2.c + $$12, $$2.d + $$13, $$2.e + $$14);
   }
