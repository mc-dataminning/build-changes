...
public class bxv extends bxp {
   ...
   private void j() {
      if (this.c == null || this.c.c()) {
         int $$0 = this.a.y();
         gw $$1 = this.a.dL().a(dkm.a.f, dnp.a(this.a.s()));
         cca $$2 = this.a.dL().a(b, this.a, (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
         int $$4;
         if ($$2 != null) {
            ehh $$3 = new ehh($$2.dq(), 0.0, $$2.dw()).d();
            $$4 = this.a.r(-$$3.c * 40.0, 105.0, -$$3.e * 40.0);
         } else {
            $$4 = this.a.r(40.0, (double)$$1.v(), 0.0);
         }

         eat $$6 = new eat($$1.u(), $$1.v(), $$1.w());
