...
public class enw {
   ...
   @Nullable
   private String g;
   private static final enw.a h = new enw.a() {
      @Nullable
      @Override
      public env a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (eoa.a(this.d, "Get capabilities")) {
         ...
         if (eoa.a(this.d, "Create context")) {
            ...
            int $$5 = this.i();
            int $$6 = auo.a((int)auo.c((float)$$5), 2, 8);
            int $$7 = auo.a($$5 - $$6, 8, 255);
            this.i = new enw.b($$7);
            this.j = new enw.b($$6);
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !eoa.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public env a(enw.c $$0) {
      return ($$0 == enw.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements enw.a {
      private final int a;
      ...
      public env a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               enw.a.warn("Maximum sound pool size {} reached", this.a);
            }
