...
public class enw extends eoa implements eny {
   ...
   public enw.c a() {
      return new enw.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, eog.a $$1) {
   ...
   private enw.b q() {
      ...
      this.k += $$5;
      this.j++;
      enw.a $$9 = new enw.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new enw.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eog.b.a || this.q == eog.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eoh> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eoh $$1 = (eoh)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eoh.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eoh.b.c) {
         eny.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, eny.a($$11));
         this.a($$14 + 5, eny.a($$12));
         this.a($$14 + 6, eny.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eog a, int b, int c, eog.b d, eog.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eog.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eoj $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
