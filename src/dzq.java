...
public abstract class dzq<M extends dzn<M>> {
   private final cpu i;
   ...
   protected final Long2ObjectMap<dhb> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected dzq(cpu $$0, dhj $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dhb a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dhb a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dhb c(long $$0) {
      dhb $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dhb g(long $$0) {
      dhb $$1 = (dhb)this.g.get($$0);
      return $$1 != null ? $$1 : new dhb();
   }
   ...
   protected void a(dzt<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dhb>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dhb> $$6 = (Entry<dhb>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dhb $$8 = (dhb)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dhb $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = hx.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, dzq.a.a($$9, dzq.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public dzq.b k(long $$0) {
      return dzq.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static dzq.b c(byte $$0) {
         if ($$0 == 0) {
            return dzq.b.a;
         } else {
            return a($$0) ? dzq.b.c : dzq.b.b;
         }
      }
   }
