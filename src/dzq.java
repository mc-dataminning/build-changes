public class dzq {
   ...
   private int a(dgz $$0, int $$1, int $$2, int $$3) {
      int $$4 = hw.c($$0.g($$1) + 1);
   ...
   public boolean a(cph $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(cph $$0, int $$1, int $$2, gw $$3, dfd $$4, gw $$5, dfd $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(cph $$0, gw $$1, dfd $$2) {
      gw.a $$3 = this.e.g($$1);
   ...
   private static boolean a(cph $$0, gw $$1, dfd $$2, gw $$3, dfd $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         eia $$5 = dzx.a($$0, $$1, $$2, ha.a);
         eia $$6 = dzx.a($$0, $$3, $$4, ha.b);
         return ehx.b($$5, $$6);
      }
   }
