...
public class etg implements AutoCloseable {
   private final etg.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private eti a(esy.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(esy.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, fxe $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, fxe $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.n != null && (this.i == eti.b.a || this.i == eti.b.b)) {
