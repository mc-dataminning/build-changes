public class etg {
   ...
   private int a(dzm $$0, int $$1, int $$2, int $$3) {
      int $$4 = kk.c($$0.h($$1) + 1);
   ...
   public boolean a(dgf $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dgf $$0, int $$1, int $$2, ji $$3, dxq $$4, ji $$5, dxq $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dgf $$0, ji $$1, dxq $$2) {
      ji.a $$3 = this.e.g($$1);
