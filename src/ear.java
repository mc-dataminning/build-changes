...
public interface ear {
   static ear a(ebj $$0, deh $$1, ebl $$2, ebs $$3, int $$4, int $$5, ear.a $$6) {
      return new ear.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static ear a(final ear.a $$0) {
      return new ear() {
         @Nullable
         @Override
         public dvj a(eay.b $$0x, double $$1) {
   ...
   @Nullable
   dvj a(eay.b var1, double var2);

   boolean a();

   public interface a {
      ear.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dvj b) {

      public dvj a(int $$0) {
         return $$0 < this.a ? this.b : dig.a.m();
      }
   }

   public static class c implements ear {
      ...
      private final eay p;
      private final ebs q;
      private final ear.b[] r;
      private final long[] s;
      private final ear.a t;
      private final eay u;
      private final eay v;
      private boolean w;
      private final int x;
      ...
      c(ebj $$0, deh $$1, ebl $$2, ebs $$3, int $$4, int $$5, ear.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dvj a(eay.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            ear.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dig.H)) {
               this.w = false;
               return dig.H.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dig.G) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dig.H)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(eay.b $$0, MutableDouble $$1, ear.b $$2, ear.b $$3) {
         int $$4 = $$0.b();
         dvj $$5 = $$2.a($$4);
         dvj $$6 = $$3.a($$4);
         if ((!$$5.a(dig.H) || !$$6.a(dig.G)) && (!$$5.a(dig.G) || !$$6.a(dig.H))) {
      ...
      private ear.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            ear.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private ear.b b(int $$0, int $$1, int $$2) {
         ear.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               ear.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new ear.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, ear.b $$3, int $$4, boolean $$5) {
         eay.e $$6 = new eay.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dgs.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new eay.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azk.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dvj a(int $$0, int $$1, int $$2, ear.b $$3, int $$4) {
         dvj $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != dzf.g && $$3.b != dig.H.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new eay.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dig.H.m();
            }
         }
