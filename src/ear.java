...
public class ear extends eay<edj> {
   private static final dsl a = dsl.a(dfb.I);
   private final dsc b = dfb.I.o();
   private final dsc c = dfb.jF.o();
   private final dsc d = dfb.aV.o();
   private final dsc an = dfb.G.o();

   public ear(Codec<edj> $$0) {
      super($$0);
   }
   ...
   private static void b(dct $$0, iz $$1) {
      $$0.a($$1, dfb.J.o(), 3);
      $$0.a($$1, dpj.N).ifPresent($$1x -> $$1x.a(eqe.bd, $$1.a()));
   }
}
