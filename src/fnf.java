...
public class fnf extends fne {
   ...
   protected void aM_() {
      ...
      this.y = $$0.u_();
      this.z = $$0.bb().m();
      this.c(fhm.a(dbw::e).a(dbw.a, dbw.d, dbw.b, dbw.c).a(this.y).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.y = $$1x));
      this.c(fhm.b(this.z).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.z = $$1x));
      fhf $$1 = fhf.a(xp.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         xp $$2;
      ...
      this.B = new fho(this.p, this.n / 2 - 75, 160, 150, 20, xp.c("lanServer.port"));
      this.B.b($$1x -> {
         xp $$2 = this.a($$1x);
      ...
      this.c(this.B);
      this.c($$1);
      this.c(fhf.a(xo.e, $$0x -> this.d()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
