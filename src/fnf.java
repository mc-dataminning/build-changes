...
public class fnf extends anr<fnf.a> {
   ...
   protected fnf.a a(anm $$0, bdh $$1) {
      ...
      $$1.b();
      return new fnf.a($$2, $$3, $$4);
   }

   protected void a(fnf.a $$0, anm $$1, bdh $$2) {
      this.c = $$0.a();
   }
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ejz.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ejz.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ejz.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
