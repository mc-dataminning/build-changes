...
public class fnf implements fnd.a {
   private static final float a = 0.02F;
   private final Map<gu, fnf.a> b = Maps.newHashMap();

   public void a(gu $$0, int $$1, String $$2, int $$3) {
      this.b.put($$0, new fnf.a($$1, $$2, ac.b() + (long)$$3));
   }
   ...
   public void a(eij $$0, fjx $$1, double $$2, double $$3, double $$4) {
      long $$5 = ac.b();
      this.b.entrySet().removeIf($$1x -> $$5 > ((fnf.a)$$1x.getValue()).c);
      this.b.forEach(($$2x, $$3x) -> this.a($$0, $$1, $$2x, $$3x));
   }

   private void a(eij $$0, fjx $$1, gu $$2, fnf.a $$3) {
