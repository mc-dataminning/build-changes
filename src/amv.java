...
public class amv {
   ...
   private static int a(ex $$0, Collection<? extends buk> $$1, jr<btn> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      ...
      if ($$7 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.effect.give.success.single", $$6.e(), $$1.iterator().next().p_(), $$8 / 20), true);
         } else {
            $$0.a(() -> wp.a("commands.effect.give.success.multiple", $$6.e(), $$1.size(), $$8 / 20), true);
         }
   ...
   private static int a(ex $$0, Collection<? extends buk> $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.effect.clear.everything.success.single", $$1.iterator().next().p_()), true);
         } else {
   ...
   private static int a(ex $$0, Collection<? extends buk> $$1, jr<btn> $$2) throws CommandSyntaxException {
      ...
      if ($$4 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.effect.clear.specific.success.single", $$3.e(), $$1.iterator().next().p_()), true);
         } else {
            $$0.a(() -> wp.a("commands.effect.clear.specific.success.multiple", $$3.e(), $$1.size()), true);
         }
