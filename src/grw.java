public class grw extends gro<cql, gyc> {
   private static final alz a = alz.b("textures/entity/fishing_hook.png");
   private static final glu b = glu.f(a);
   ...
   public boolean a(cql $$0, gpb $$1, double $$2, double $$3, double $$4) {
      return super.a($$0, $$1, $$2, $$3, $$4) && $$0.m() != null;
   }

   public void a(gyc $$0, fgr $$1, glk $$2, int $$3) {
      $$1.a();
      $$1.a();
      $$1.b(0.5F, 0.5F, 0.5F);
      $$1.a(this.e.b());
   ...
   private fbx a(cpw $$0, float $$1, float $$2) {
      int $$3 = $$0.fy() == bvz.b ? 1 : -1;
      cxo $$4 = $$0.eZ();
      if (!$$4.a(cxs.rJ)) {
         $$3 = -$$3;
      }

      if (this.e.d.aE().a() && $$0 == fmf.Q().t) {
   ...
   private static void a(fgv $$0, fgr.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(hbb.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }
