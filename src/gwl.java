public abstract class gwl<M extends gcp> extends gwd<gze, M> {
   private final gcf a;
   private final alz b;
   private final gwl.a c;

   public gwl(gsp<?, gze, M> $$0, gcf $$1, alz $$2, gwl.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(gze var1);
   ...
   private void a(fgq $$0, glj $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hba.d);
   }
