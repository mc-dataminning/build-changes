public class gwl extends gwg<bwt, hcr> {
   private static final alg a = alg.b("textures/entity/experience_orb.png");
   private static final gqk g = gqk.i(a);
   ...
   public void a(hcr $$0, fjj $$1, gqa $$2, int $$3) {
      $$1.a();
      int $$4 = $$0.a;
   ...
   private static void a(fjn $$0, fjj.a $$1, float $$2, float $$3, int $$4, int $$5, int $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3, 0.0F).a($$4, $$5, $$6, 128).a($$7, $$8).b(hin.d).c($$9).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(bwt $$0, hcr $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.g();
   }
}
