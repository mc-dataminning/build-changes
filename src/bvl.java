...
public class bvl extends bur implements bke<bvl.g> {
   ...
   private static final aef<Integer> cb = aei.a(bvl.class, aeh.b);
   private static final aex cc = new aex("killer_bunny");
   ...
   private void c(double $$0, double $$1) {
      this.r((float)(arx.d($$1 - this.dw(), $$0 - this.dq()) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   public boolean C(biq $$0) {
      if (this.gd() == bvl.g.g) {
         this.a(ape.tl, 1.0F, (this.ag.i() - this.ag.i()) * 0.2F + 1.0F);
   ...
   public static boolean c(biu<bvl> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      return $$1.a_($$3.d()).a(apt.bV) && a((coy)$$1, $$3);
   }
   ...
   public static enum g implements asp {
      ...
      private static final IntFunction<bvl.g> i = aqs.a(bvl.g::a, values(), a);
