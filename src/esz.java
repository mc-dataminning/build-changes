...
public class esz {
   ...
   @Deprecated
   public static esz a(bam $$0, esz.a $$1) {
      return new esz($$0, $$1, false);
   }

   public static esz a(bam $$0, int $$1, double... $$2) {
      return b($$0, new esz.a($$1, new DoubleArrayList($$2)));
   }

   public static esz b(bam $$0, esz.a $$1) {
      return new esz($$0, $$1, true);
   }

   private esz(bam $$0, esz.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      ...
      public static final Codec<jq<esz.a>> b = alv.a(mb.aS, a);
