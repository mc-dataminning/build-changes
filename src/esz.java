...
public class esz extends eso implements ets {
   private static final euc d = new euc(new aex("widget/text_field"), new aex("widget/text_field_highlighted"));
   ...
   public void a(BiFunction<String, Integer, ark> $$0) {
      this.D = $$0;
   }
   ...
   public void k(int $$0) {
      this.w = arx.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = arx.a($$0) - this.r();
      if (this.s) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, eyk.q());
   }
   ...
   public void b(esf $$0, int $$1, int $$2, float $$3) {
      if (this.v()) {
         ...
         boolean $$9 = this.aD_() && (ac.b() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.s ? this.r() + 4 : this.r();
         int $$11 = this.s ? this.t() + (this.g - 8) / 2 : this.t();
         int $$12 = $$10;
         int $$13 = arx.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if (this.E != null && $$7.isEmpty() && !this.aD_()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fom.D(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = arx.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = arx.a(this.v, 0, this.p.length());
      }
   }
