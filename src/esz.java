...
public class esz extends esb {
   ...
   public esz(eru $$0, int $$1, int $$2, int $$3, int $$4, tf $$5, tf $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new etc($$0, $$3 - this.b());
      this.o.a(this::v);
   }
   ...
   @Override
   public void a(evx $$0) {
      $$0.a(evw.a, tf.a("gui.narrate.editBox", this.l(), this.u()));
   }
   ...
   private void v() {
      double $$0 = this.c();
      etc.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         etc.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
