...
public class esz extends eso implements ets {
   private static final euc d = new euc(new aew("widget/text_field"), new aew("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, arj> D = ($$0x, $$1x) -> arj.forward($$0x, uh.a);
   @Nullable
   private tl E;
   private long F = ac.b();
   ...
   public void a(BiFunction<String, Integer, arj> $$0) {
      this.D = $$0;
   }
   ...
   public void k(int $$0) {
      this.w = arw.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void b(esf $$0, int $$1, int $$2, float $$3) {
      if (this.v()) {
         ...
         int $$12 = $$10;
         int $$13 = arw.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
   ...
   public void o(int $$0) {
      this.x = arw.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = arw.a(this.v, 0, this.p.length());
      }
   }
