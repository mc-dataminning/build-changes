...
public class esz implements eta, etb {
   ...
   private final eyf<MinecraftServer> G;
   ...
   public esz(dek $$0, ebi $$1, esz.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         je.c,
   ...
   public static <T> esz a(Dynamic<T> $$0, dek $$1, esz.a $$2, ebi $$3, Lifecycle $$4) {
      ...
      return new esz(
         ...
         new eyf<>(eye.a, $$0.get("ScheduledEvents").asStream()),
         (uf)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dyn.a.a).resultOrPartial(f::error).orElse(dyn.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(kb $$0, uf $$1, @Nullable uf $$2) {
      ...
      ebg.a($$4, this.h, $$0).resultOrPartial(ad.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vc)dyn.a.a.encodeStart(ut.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dfc.b.encodeStart(ut.a, this.g.g()).ifSuccess($$1x -> $$1.a((uf)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == esz.a.b;
   }

   @Override
   public boolean A() {
      return this.i == esz.a.c;
   }
