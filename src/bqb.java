...
public abstract class bqb<C, V> implements bpv<StringReader, V>, bqc {
   private final bpp<alg> b;
   protected final C a;

   protected bqb(bpp<alg> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(bpu<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
