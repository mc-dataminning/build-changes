...
public class bqb extends bqd {
   ...
   public bqb(bkd $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dL();
      this.h = $$1;
      this.i = $$0.L();
   ...
   private boolean a(gw $$0) {
      eaz $$1 = ebi.a(this.g, $$0.j());
      if ($$1 != eaz.c) {
         return false;
      } else {
         dfl $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof cxe) {
            return false;
         } else {
            gw $$3 = $$0.b(this.e.dl());
