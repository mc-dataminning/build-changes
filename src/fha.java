...
public abstract class fha extends fhe implements fij, fjc {
   private static final fit a = new fit(new alf("widget/text_field"), new alf("widget/text_field_highlighted"));
   private static final alf b = new alf("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fha(int $$0, int $$1, int $$2, int $$3, xp $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return ayz.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = ayz.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fgt var1, int var2, int var3, float var4);
}
