...
public class fha {
   public static class a implements fhp<iy> {
      ...
      public fhm a(iy $$0, few $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fha.b $$8 = new fha.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends fim {
   ...
   static class c extends fhy {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fha.c $$0 = new fha.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fhp<iy> {
      ...
      public fhm a(iy $$0, few $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fha.c $$8 = new fha.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, enn.N().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fhk {
      private int a;
      private final fho b;
      private qx D;
      private boolean E;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, ami.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fha.c $$10 = (fha.c)this.b.a(iv.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
