...
public class fha extends fgf {
   public static final float b = 4.5F;
   private static final Vector3f c = new Vector3f(1.0F, 1.0F, 1.0F);
   private static final int k = 16;
   private static final int l = 16;
   private final aiy m = new aiy("textures/gui/hanging_signs/" + this.a.b() + ".png");

   public fha(dkc $$0, boolean $$1, boolean $$2) {
      super($$0, $$1, $$2, vq.c("hanging_sign.edit"));
   }
