...
public class fha {
   ...
   private final ffa i;
   private final axi<String> j = new axi<>(100);
   private final List<feu> k = Lists.newArrayList();
   private final List<feu.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fha.a> o = new ArrayList<>();
   ...
   public void a(fgm $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = ayu.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = ayu.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, xl.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(fgm $$0, int $$1, int $$2, fev.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(feu.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.m.m().c() == cmq.c;
   }
   ...
   public void a(xl $$0) {
      this.a($$0, null, this.i.W() ? fev.b() : fev.a());
   }

   public void a(xl $$0, @Nullable xx $$1, @Nullable fev $$2) {
      feu $$3 = new feu(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(feu $$0) {
      int $$1 = ayu.a((double)this.f() / this.h());
      fev.a $$2 = $$0.a();
      if ($$2 != null) {
         $$1 -= $$2.c + 4 + 2;
      }

      List<ayg> $$3 = fhe.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new feu.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fha.a b(xx $$0) {
      int $$1 = this.i.l.e();
      ListIterator<feu> $$2 = this.k.listIterator();
   ...
   private feu d(feu $$0) {
      return new feu($$0.b(), h, null, fev.a());
   }
   ...
   private void n() {
      ...
      for (feu $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Y && !this.l()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)ayu.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)ayu.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public yi b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         feu.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), ayu.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fev c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, feu.a $$1, fev $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fev.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.l()) {
         if (!($$0 < -4.0) && !($$0 > (double)ayu.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = ayu.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof flo;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return ayu.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return ayu.a($$0 * 160.0 + 20.0);
   }
   ...
   public fha.b k() {
      return new fha.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fha.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<feu> $$0, List<String> $$1, List<fha.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
