...
public class fha {
   ...
   public static List<fha.a> a(String $$0, fha.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fha.a> a(String $$0, List<fha.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fha.a> a(List<String> $$0, List<fha.b> $$1) {
      int $$2 = 0;
      List<fha.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fha.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fha.b a(String $$0, String $$1) {
         return new fha.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fha.b a(String $$0) {
         return new fha.b($$0);
      }
   }
}
