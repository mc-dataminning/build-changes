...
public class fha {
   private static final akm b = new akm("icon/ping_unknown");
   private static final akm c = new akm("icon/ping_1");
   private static final akm d = new akm("icon/ping_2");
   private static final akm e = new akm("icon/ping_3");
   private static final akm f = new akm("icon/ping_4");
   private static final akm g = new akm("icon/ping_5");
   private static final akm h = new akm("hud/heart/container_blinking");
   private static final akm i = new akm("hud/heart/container");
   private static final akm j = new akm("hud/heart/full_blinking");
   private static final akm k = new akm("hud/heart/half_blinking");
   private static final akm l = new akm("hud/heart/absorbing_full_blinking");
   private static final akm m = new akm("hud/heart/full");
   private static final akm n = new akm("hud/heart/absorbing_half_blinking");
   private static final akm o = new akm("hud/heart/half");
   private static final Comparator<fxc> p = Comparator.<fxc>comparingInt($$0 -> $$0.e() == dau.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), evj::b, ""))
   ...
   private wx t;
   private boolean u;
   private final Map<UUID, fha.a> v = new Object2ObjectOpenHashMap();

   public fha(fdz $$0, ffl $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public wx a(fxc $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, evj.a($$0.h(), wx.b($$0.a().getName())));
   }

   private wx a(fxc $$0, xl $$1) {
      return $$0.e() == dau.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(boolean $$0) {
      if (this.u != $$0) {
         ...
         if ($$0) {
            ...
            this.q.aZ().c(wx.a("multiplayer.player.list.narration", $$1));
         }
      }
   }
   ...
   public void a(ffm $$0, int $$1, evo $$2, @Nullable evg $$3) {
      List<fxc> $$4 = this.b();
      List<fha.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               clw $$44 = this.q.r.b($$43.getId());
               boolean $$45 = $$44 != null && giu.e($$44);
               boolean $$46 = $$44 != null && $$44.a(clx.g);
               fgy.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dau.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dau.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(ffm $$0, int $$1, int $$2, int $$3, fxc $$4) {
      akm $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
   ...
   private void a(evg $$0, int $$1, fha.b $$2, int $$3, int $$4, UUID $$5, ffm $$6) {
      if ($$0.h() == evr.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, ffm $$4, int $$5) {
      fha.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fha.a($$5));
      $$6.a($$5, (long)this.r.e());
      int $$7 = ayd.e(Math.max($$5, $$6.a()), 2);
      int $$8 = Math.max($$5, Math.max($$6.a(), 20)) / 2;
      boolean $$9 = $$6.a((long)this.r.e());
      if ($$7 > 0) {
         int $$10 = ayd.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
            float $$11 = ayd.a((float)$$5 / 20.0F, 0.0F, 1.0F);
