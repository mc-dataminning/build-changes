...
public abstract class fgl<T extends fgl<T>> {
   ...
   public fgl(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fgj.a();
         if ($$3 != null) {
         ...
         throw new fid(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fid(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fid(var2.getMessage(), var2);
      }
   }
   ...
   public static fgl<?> a(String $$0) {
      return new fgl.b($$0, 5000, 60000);
   }

   public static fgl<?> a(String $$0, int $$1, int $$2) {
      return new fgl.b($$0, $$1, $$2);
   }

   public static fgl<?> b(String $$0, String $$1) {
      return new fgl.c($$0, $$1, 5000, 60000);
   }

   public static fgl<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fgl.c($$0, $$1, $$2, $$3);
   }

   public static fgl<?> b(String $$0) {
      return new fgl.a($$0, 5000, 60000);
   }

   public static fgl<?> c(String $$0, String $$1) {
      return new fgl.d($$0, $$1, 5000, 60000);
   }

   public static fgl<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fgl.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fgl<fgl.a> {
   ...
   public static class b extends fgl<fgl.b> {
   ...
   public static class c extends fgl<fgl.c> {
      ...
      public fgl.c f() {
         try {
            ...
            throw new fid(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fgl<fgl.d> {
      private final String c;
