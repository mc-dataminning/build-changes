...
public class fgl {
   ...
   static class b {
      static final Optional<fgl> a = Optional.ofNullable(a());
      ...
      private static fgl a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fgl();
      }
   }
}
