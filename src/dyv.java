...
public class dyv implements azh {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dyv> b = dyu.a.xmap($$0 -> new dyv($$0), $$0 -> $$0.e);
   private dyu e;
   private final dxw f = new dxw(this);

   public dyv(long $$0) {
      this.e = new dyu(dyj.c($$0));
   }
   ...
   @Override
   public azh d() {
      return new dyv(this.e.a(), this.e.a());
   }

   @Override
   public dyh e() {
      return new dyv.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dyh {
      ...
      public azh a(int $$0, int $$1, int $$2) {
         long $$3 = ayz.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dyv($$4, this.b);
      }

      @Override
      public azh a(String $$0) {
         dyj.a $$1 = dyj.a($$0);
         return new dyv($$1.a(this.a, this.b));
      }
