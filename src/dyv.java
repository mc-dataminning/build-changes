...
public class dyv extends dyy<dyu> {
   public dyv(Codec<dyu> $$0) {
      super($$0);
   }

   public boolean a(dyu $$0, ayk $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dyt $$0, dyu $$1, dsx $$2, Function<io, ix<dbw>> $$3, ayk $$4, dwf $$5, dae $$6, dsw $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dyy.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dyt $$0, dyu $$1, dsx $$2, Function<io, ix<dbw>> $$3, dwf $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dsw $$10, dyy.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayd.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayd.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayd.b($$13);
         $$6 += (double)(ayd.b($$12) * $$27);
         $$7 += (double)ayd.a($$13);
         $$8 += (double)(ayd.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
