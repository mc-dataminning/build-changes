...
public class dyv extends dza {
   public static final Codec<dyv> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dyv::new));
   ...
   public List<dxi.a> a(cvt $$0, BiConsumer<hz, dlf> $$1, awo $$2, int $$3, hz $$4, dws $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = awh.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, awh.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dyv.a> $$13 = Lists.newArrayList();
      $$13.add(new dyv.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               hz $$21 = $$4.b(awh.a($$19), $$12 - 1, awh.a($$20));
               hz $$22 = $$21.b(5);
      ...
      List<dxi.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cvt $$0, BiConsumer<hz, dlf> $$1, awo $$2, hz $$3, hz $$4, boolean $$5, dws $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            hz $$13 = $$3.b(awh.d(0.5F + (float)$$12 * $$9), awh.d(0.5F + (float)$$12 * $$10), awh.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dez.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cvt $$0, BiConsumer<hz, dlf> $$1, awo $$2, int $$3, hz $$4, List<dyv.a> $$5, dws $$6) {
      for (dyv.a $$7 : $$5) {
         int $$8 = $$7.a();
