...
public class dyv extends dxf {
   ...
   protected void a(tz $$0, jg.a $$1) {
      super.a($$0, $$1);
      this.a($$0.<dcd>a("profile", dcd.a).orElse(null));
   ...
   public static void a(dja $$0, iu $$1, eah $$2, dyv $$3) {
      if ($$2.b(dtr.a) && $$2.c(dtr.a)) {
         $$3.k = true;
         $$3.j++;
      } else {
         $$3.k = false;
