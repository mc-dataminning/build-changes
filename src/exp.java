...
public enum exp implements azg {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azg.a<exp> t = azg.a(exp::values);
   public static final IntFunction<exp> u = axd.a(exp::a, values(), axd.a.a);
   private final int v;
   private final String w;

   private exp(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
