...
public class exp extends exi {
   private final boolean a;
   private final Long2ObjectMap<exm> l = new Long2ObjectOpenHashMap();

   public exp(boolean $$0) {
      this.a = $$0;
   }
   ...
   public int a(exh[] $$0, exh $$1) {
      int $$2 = 0;
      Map<jb, exh> $$3 = Maps.newEnumMap(jb.class);

      for (jb $$4 : jb.values()) {
         exh $$5 = this.a($$1.a + $$4.j(), $$1.b + $$4.k(), $$1.c + $$4.l());
         $$3.put($$4, $$5);
         if (this.a($$5)) {
            $$0[$$2++] = $$5;
         }
      ...
      for (jb $$6 : jb.c.a) {
         ...
         if (b($$3.get($$6)) && b($$3.get($$7))) {
            exh $$8 = this.a($$1.a + $$6.j() + $$7.j(), $$1.b, $$1.c + $$6.l() + $$7.l());
            if (this.a($$8)) {
               $$0[$$2++] = $$8;
            }
         }
   ...
   private static boolean b(@Nullable exh $$0) {
   ...
   protected exm b(int $$0, int $$1, int $$2) {
      return (exm)this.l.computeIfAbsent(iv.a($$0, $$1, $$2), $$3 -> this.a(this.b, $$0, $$1, $$2));
   }
