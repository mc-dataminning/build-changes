...
public class ajp {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ui.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ui.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> ui.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(du $$0, eie $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bjt> $$6) throws CommandSyntaxException {
      alq $$7 = $$0.f();
      int $$8 = $$7.I_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         ajp.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> ui.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bjt> $$0) {
      Set<ejg> $$1 = Sets.newHashSet();
   ...
   private static void a(eie $$0, double $$1, alq $$2, ate $$3, double $$4, double $$5, double $$6, double $$7, int $$8, ajp.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bjt> $$0, alq $$1, ajp.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ejg, ajp.a> $$7 = Maps.newHashMap();

      for (bjt $$8 : $$0) {
         ajp.a $$10;
         if ($$4) {
            ejg $$9 = $$8 instanceof ccx ? $$8.cf() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)asy.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)asy.a($$10.b) + 0.5, Set.of(), $$8.dB(), $$8.dD());
   ...
   private static ajp.a[] a(ate $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      ajp.a[] $$6 = new ajp.a[$$1];
   ...
   static class a {
      ...
      public boolean b(cqf $$0, int $$1) {
         ht $$2 = ht.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dgb $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(aqs.aJ);
      }

      public void a(ate $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = asy.a($$0, $$1, $$3);
         this.b = asy.a($$0, $$2, $$4);
      }
   }
