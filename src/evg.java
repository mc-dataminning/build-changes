...
public class evg implements efr.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<evg> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azf<evg> a = azf.a(f);
   private final evk g;
   private final evk h;
   private final evk i;
   ...
   public static evg a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new evg(new egz(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private evg(evk $$0, evk $$1, evk $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public evg(azv $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         evk.a($$0, IntStream.rangeClosed(-15, 0)),
         evk.a($$0, IntStream.rangeClosed(-15, 0)),
         evk.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public evg a(azv $$0) {
      return new evg($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(efr.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         evh $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(evk.b($$4 * $$13), evk.b($$5 * $$13), evk.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = evk.b($$1 * $$13);
         double $$21 = evk.b($$2 * $$13);
         double $$22 = evk.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            evh $$24 = this.g.a($$19);
            if ($$24 != null) {
