...
public class evg extends aqh<Map<String, List<evg.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<evg.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(evg.a::a),
                     Codec.LONG.fieldOf("period").forGetter(evg.a::b),
                     Codec.STRING.fieldOf("title").forGetter(evg.a::c),
                     Codec.STRING.fieldOf("message").forGetter(evg.a::d)
                  )
                  .apply($$0, evg.a::new)
         )
         .listOf()
   ...
   public evg(ahd $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<evg.a>> a(aqc $$0, bgm $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<evg.a>> $$0, aqc $$1, bgm $$2) {
      List<evg.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<evg.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<evg.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<evg.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public evg.b a(List<evg.a> $$0, long $$1) {
         this.cancel();
         return new evg.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (evg.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> ezf.a(eva.N().ax(), ezf.a.g, vd.a($$2.c, $$3), vd.a($$2.d, $$3)));
                  return;
               }
            }
         }
