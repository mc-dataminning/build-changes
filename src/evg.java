...
public class evg {
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aM().i()) {
         boolean $$5 = eov.a(evh.O().aM().i(), 292);
         if (this.d > 0L) {
            if (!eov.a(evh.O().aM().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eov.a(evh.O().aM().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fdu) || ((fdu)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aM().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               evs.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aV().a() && this.b.m.s().c()) {
            boolean $$9 = $$6 == null || !($$6.aH_() instanceof exo $$7) || !$$7.d();
            if ($$3 != 0 && $$1 == 66 && fda.s() && $$9) {
               boolean $$10 = this.b.m.ap().c() == evj.a;
               this.b.m.ap().a(evj.a(this.b.m.ap().c().a() + 1));
               this.b.m.as();
               if ($$6 instanceof fdc) {
                  ((fdc)$$6).n();
               }
         ...
         label185: {
            ...
            label144:
            if (!$$13) {
               if (this.b.y instanceof fcv $$14 && !$$14.n()) {
                  break label144;
               }
      ...
      if ($$0 == this.b.aM().i()) {
         ...
         if ($$3 != null && this.b.aJ() == null) {
            if (Character.charCount($$1) == 1) {
               fda.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fda.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
