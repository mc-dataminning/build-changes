...
public class evg {
   ...
   public evg(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evh> $$1) throws IOException {
   ...
   public List<evh> a(Path $$0) throws IOException {
      List<evh> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evh> a(Path $$0, boolean $$1) throws IOException {
      List<evh> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evh> $$1) throws IOException {
