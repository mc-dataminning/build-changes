...
public class cgh extends cfg {
   private static final akk<iz> bZ = ako.a(cgh.class, akm.o);
   private static final akk<Boolean> cb = ako.a(cgh.class, akm.k);
   private static final akk<Boolean> cc = ako.a(cgh.class, akm.k);
   private static final akk<iz> cd = ako.a(cgh.class, akm.o);
   private static final akk<Boolean> ce = ako.a(cgh.class, akm.k);
   private static final akk<Boolean> cf = ako.a(cgh.class, akm.k);
   private static final float cg = 0.3F;
   private static final bsy ch = btb.bh.n().a(bsx.a().a(bsw.a, 0.0F, btb.bh.m(), -0.25F)).a(0.3F);
   int ci;
   public static final Predicate<btq> bY = $$0 -> $$0.p_() && !$$0.be();

   public cgh(btb<? extends cgh> $$0, dbz $$1) {
      super($$0, $$1);
      this.a(eon.j, 0.0F);
      this.a(eon.t, -1.0F);
      this.a(eon.s, -1.0F);
      this.a(eon.r, -1.0F);
      this.bP = new cgh.e(this);
   }
   ...
   public static boolean c(btb<cgh> $$0, dca $$1, btu $$2, iz $$3, azh $$4) {
      return $$3.v() < $$1.z_() + 4 && dns.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void z() {
      this.bS.a(0, new cgh.f(this, 1.2));
      this.bS.a(1, new cgh.a(this, 1.0));
      this.bS.a(1, new cgh.d(this, 1.0));
      this.bS.a(2, new cbw(this, 1.1, $$0 -> $$0.a(awy.av), false));
      this.bS.a(3, new cgh.c(this, 1.0));
      this.bS.a(4, new cgh.b(this, 1.0));
      this.bS.a(7, new cgh.i(this, 1.0));
      this.bS.a(8, new caw(this, cmy.class, 8.0F));
      this.bS.a(9, new cgh.h(this, 1.0, 100));
   }

   public static bux.a y() {
      return bts.A().a(buy.q, 30.0).a(buy.r, 0.25).a(buy.v, 1.0);
   }
   ...
   protected cdc b(dbz $$0) {
      return new cgh.g(this, $$0);
   }

   @Nullable
   @Override
   public bsp a(arf $$0, bsp $$1) {
      return btb.bh.a((dbz)$$0);
   }
   ...
   public void n_() {
      ...
      if (this.bD() && this.u() && this.ci >= 1 && this.ci % 5 == 0) {
         iz $$0 = this.dp();
         if (dns.a(this.dP(), $$0)) {
            this.dP().c(2001, $$0, dfa.i(this.dP().a_($$0.d())));
            this.a(dww.u);
         }
      }
   }
   ...
   static class a extends caa {
      ...
      protected void g() {
         ...
         if (this.b.ab().b(dbv.f)) {
            this.b.b(new btg(this.b, this.a.du(), this.a.dw(), this.a.dA(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends cao {
      ...
      public void e() {
         ...
         if (this.a.K().l()) {
            evs $$2 = evs.c($$0);
            evs $$3 = cel.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = cel.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dP().a_(iz.a($$3)).a(dfc.G)) {
               $$3 = cel.a(this.a, 16, 5, $$2, (float) (Math.PI / 2));
            }
   ...
   static class d extends cbb {
      ...
      public void e() {
         ...
         if (!this.g.be() && this.m()) {
            if (this.g.ci < 1) {
               ...
               iz $$2 = this.e.c();
               dsd $$3 = dfc.mf.o().a(dns.f, Integer.valueOf(this.g.ah.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(dww.i, $$2, dww.a.a(this.g, $$3));
               this.g.w(false);
               this.g.x(false);
               this.g.t(600);
            }
      ...
      @Override
      protected boolean a(dcc $$0, iz $$1) {
         return !$$0.u($$1.c()) ? false : dns.b($$0, $$1);
      }
   }

   static class e extends bzr {
      private final cgh l;
      ...
      public void a() {
         ...
         if (this.k == bzr.a.b && !this.l.K().l()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aY = this.l.dF();
               float $$5 = (float)(this.h * this.l.g(buy.r));
   ...
   static class g extends ccz {
      ...
      public boolean a(iz $$0) {
         if (this.a instanceof cgh $$1 && $$1.gy()) {
            return this.b.a_($$0).a(dfc.G);
         }
   ...
   static class h extends cbl {
      private final cgh i;

      h(cgh $$0, double $$1, int $$2) {
         super($$0, $$1, $$2);
         this.i = $$0;
      }
   ...
   static class i extends cao {
      ...
      public void e() {
         if (this.a.K().l()) {
            evs $$0 = evs.c(this.a.gw());
            evs $$1 = cel.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
