...
public class bbo extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhv.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bhv.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bhv.s);
