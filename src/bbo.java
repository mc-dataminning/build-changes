...
public class bbo extends bgf {
   public bbo(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bhk.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bhk.s, "minecraft:jukebox");
