...
public class gqf {
   private static final gqx a = gqx.u(alg.b("textures/map/map_background.png"));
   private static final gqx b = gqx.u(alg.b("textures/map/map_background_checkerboard.png"));
   ...
   private final hit av = new hit();
   private czk aw = czk.k;
   private czk ax = czk.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gwr aC;
   private final gxr aD;
   private final hga aE;

   public gqf(fpo $$0, gwr $$1, gxr $$2, hga $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bxj $$0, czk $$1, czi $$2, fjy $$3, gqm $$4, int $$5) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$0.dU(), $$5, hja.d, $$0.ao() + $$2.ordinal());
      }
   }
   ...
   private void a(fjy $$0, gqm $$1, int $$2, bxa $$3) {
      hbz $$4 = (hbz)this.aC.<gpg>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bxa.b ? 1.0F : -1.0F;
      ...
      alg $$6 = this.au.t.c().a();
      if ($$3 == bxa.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(crl.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(crl.c));
      }

      $$0.b();
   }

   private void a(fjy $$0, gqm $$1, int $$2, float $$3, bxa $$4, float $$5, czk $$6) {
      float $$7 = $$4 == bxa.b ? 1.0F : -1.0F;
   ...
   private void a(fjy $$0, gqm $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = azm.c($$5);
   ...
   private void a(fjy $$0, gqm $$1, int $$2, czk $$3) {
      ...
      eyo $$4 = $$3.a(kk.M);
      eyq $$5 = czx.a($$4, this.au.s);
      fkc $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fjy $$0, gqm $$1, int $$2, float $$3, float $$4, bxa $$5) {
      boolean $$6 = $$5 != bxa.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azm.c($$4);
      ...
      hbz $$15 = (hbz)this.aC.<gpg>a($$14);
      alg $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(crl.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(crl.c));
      }
   }

   private void a(fjy $$0, float $$1, bxa $$2, czk $$3, crj $$4) {
      float $$5 = (float)$$4.fB() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bxj)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fjy $$0, float $$1, bxa $$2, czk $$3, crj $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fjy $$0, bxa $$1, float $$2) {
      int $$3 = $$1 == bxa.b ? 1 : -1;
   ...
   private void b(fjy $$0, bxa $$1, float $$2) {
      int $$3 = $$1 == bxa.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fjy $$1, gqm.a $$2, gpj $$3, int $$4) {
      float $$5 = $$3.D($$0);
      buf $$6 = (buf)MoreObjects.firstNonNull($$3.aJ, buf.a);
      float $$7 = $$3.k($$0);
      gqf.a $$8 = a($$3);
      ...
      if ($$8.d) {
         float $$11 = $$6 == buf.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azm.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, buf.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == buf.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azm.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, buf.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gqf.a a(gpj $$0) {
      czk $$1 = $$0.fa();
      czk $$2 = $$0.fb();
      boolean $$3 = $$1.a(czo.pj) || $$2.a(czo.pj);
      boolean $$4 = $$1.a(czo.xg) || $$2.a(czo.xg);
      if (!$$3 && !$$4) {
         return gqf.a.a;
      } else if ($$0.fy()) {
         return b($$0);
      } else {
         return a($$1) ? gqf.a.b : gqf.a.a;
      }
   }

   private static gqf.a b(gpj $$0) {
      czk $$1 = $$0.fA();
      buf $$2 = $$0.fz();
      if (!$$1.a(czo.pj) && !$$1.a(czo.xg)) {
         return $$2 == buf.a && a($$0.fb()) ? gqf.a.b : gqf.a.a;
      } else {
         return gqf.a.a($$2);
      }
   }
   ...
   private static boolean a(czk $$0) {
      return $$0.a(czo.xg) && cyd.g($$0);
   }

   private void a(gpg $$0, float $$1, float $$2, buf $$3, float $$4, czk $$5, float $$6, fjy $$7, gqm $$8, int $$9) {
      if (!$$0.gG()) {
         boolean $$10 = $$3 == buf.a;
         bxa $$11 = $$10 ? $$0.fx() : $$0.fx().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cn()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fy() && $$0.fB() > 0 && $$0.fz() == $$3 && !$$12) {
               ...
               float $$15 = (float)$$5.a((bxj)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cyd.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? czi.e : czi.d, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bxa.b;
            int $$21 = $$20 ? 1 : -1;
            if ($$0.fy() && $$0.fB() > 0 && $$0.fz() == $$3) {
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$22 = (float)$$5.a((bxj)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
                     float $$23 = $$22 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$21 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$21 * -9.785F));
                     float $$27 = (float)$$5.a((bxj)$$0) - ((float)$$0.fB() - $$1 + 1.0F);
                     float $$28 = $$27 / 10.0F;
                     if ($$28 > 1.0F) {
                        $$28 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$20 ? czi.e : czi.d, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, fjy $$2, int $$3, bxa $$4) {
   ...
   private boolean a(czk $$0, czk $$1) {
      return czk.a($$0, $$1) ? true : !this.aE.a($$1);
   }
