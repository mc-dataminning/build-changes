...
public abstract class gqf<T extends crv, S extends gyu> extends grn<T, S> {
   private static final alz b = alz.b("textures/entity/minecart.png");
   protected final gce a;
   private final gmm h;

   public gqf(gro.a $$0, gek $$1) {
      super($$0);
      this.f = 0.7F;
      this.a = new gce($$0.a($$1));
      this.h = $$0.d();
   }
   ...
   public void a(S $$0, fgq $$1, glj $$2, int $$3) {
      ...
      $$1.b(-1.0F, -1.0F, 1.0F);
      this.a.a($$0);
      fgu $$11 = $$2.getBuffer(this.a.a(b));
      this.a.a($$1, $$11, $$3, hba.d);
      $$1.b();
   }

   private static <S extends gyu> void a(S $$0, fgq $$1) {
      $$1.a(a.d.rotationDegrees($$0.b));
      $$1.a(a.f.rotationDegrees(-$$0.a));
      $$1.a(0.0F, 0.375F, 0.0F);
   }

   private static <S extends gyu> void b(S $$0, fgq $$1) {
      double $$2 = $$0.m;
      double $$3 = $$0.n;
      double $$4 = $$0.o;
      float $$5 = $$0.a;
   ...
   private static <T extends crv, S extends gyu> void a(T $$0, csk $$1, S $$2, float $$3) {
      if ($$1.t()) {
         $$2.j = $$1.e($$3);
         $$2.a = $$1.c($$3);
         $$2.b = $$1.d($$3);
   ...
   private static <T extends crv, S extends gyu> void a(T $$0, csl $$1, S $$2, float $$3) {
      float $$4 = 0.3F;
      $$2.a = $$0.j($$3);
      $$2.b = $$0.k($$3);
      double $$5 = $$2.m;
   ...
   protected void a(S $$0, dxu $$1, fgq $$2, glj $$3, int $$4) {
      this.h.a($$1, $$2, $$3, $$4, hba.d);
   }
