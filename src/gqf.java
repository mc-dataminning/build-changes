...
public class gqf {
   ...
   public void a(ffu $$0, gpo $$1, glx $$2, double $$3, double $$4, double $$5) {
      gly $$6 = this.a.f.x().c();
      MutableInt $$7 = new MutableInt(0);
      $$6.a(($$6x, $$7x, $$8, $$9) -> this.a($$6x, $$0, $$2, $$3, $$4, $$5, $$8, $$7x, $$7, $$9), $$1, 32);
   }

   private void a(gly.d $$0, ffu $$1, glx $$2, double $$3, double $$4, double $$5, int $$6, boolean $$7, MutableInt $$8, boolean $$9) {
      fav $$10 = $$0.b();
      double $$11 = $$10.b();
      ...
      if ($$12 == 1L) {
         ...
         double $$15 = $$10.f().f;
         int $$16 = $$9 ? -16711936 : -1;
         gpx.a($$1, $$2, String.valueOf($$8.getValue()), $$13, $$14, $$15, $$16, 0.3F);
      }

      ffy $$17 = $$2.getBuffer(gmh.y());
      long $$18 = $$12 + 5L;
