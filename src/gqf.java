...
public class gqf implements gqi.a, AutoCloseable {
   ...
   faj[] f;
   @Nullable
   private final gqf.a g;
   private final aug h;

   public gqf(akr $$0, gry $$1, faj $$2, aug $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      grw $$4 = $$3.a(grw.a).orElse(grw.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new faj[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gqa.a(this.f, $$0);
   ...
   @Nullable
   private gqf.a a(gry $$0, int $$1, int $$2, grw $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gqf.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gqf.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gqf.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gqf.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gqf.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gqf.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, faj[] $$4) {
   ...
   class a {
      ...
      a(final List<gqf.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gqf.this.c;
         int $$4 = this.b($$2) * gqf.this.d;
         gqf.this.a($$0, $$1, $$3, $$4, gqf.this.f);
      }

      public gqh a() {
         return gqf.this.new d(this, this.d ? gqf.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final faj[] b = new faj[gqf.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gqf.this.c >> $$0;
            int $$2 = gqf.this.d >> $$0;
            this.b[$$0] = new faj($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gqf.d $$2) {
         gqf.a $$3 = $$2.c;
         List<gqf.b> $$4 = $$3.b;
         gqf.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gqf.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gqf.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gqf.this.f[$$2].a($$3 + ($$0.a($$1) * gqf.this.c >> $$2), $$4 + ($$0.b($$1) * gqf.this.d >> $$2));
      }
   ...
   class d implements gqh {
      int a;
      int b;
      final gqf.a c;
      @Nullable
      private final gqf.c d;

      d(final gqf.a $$0, @Nullable final gqf.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
