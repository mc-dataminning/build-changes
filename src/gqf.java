...
public class gqf extends un {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gqf(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gqf a(aup $$0, List<String> $$1, boolean $$2) {
      ...
      return new gqf(ImmutableMap.copyOf($$3), $$2);
   }
