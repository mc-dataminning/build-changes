...
public class gsd extends gsv<cms, gyh, gbt> {
   ...
   private static final glu k = glu.g(b);

   public gsd(grp.a $$0) {
      this($$0, 0.5F, gem.aW);
   }

   protected gsd(grp.a $$0, float $$1, gel $$2) {
      super($$0, new gbt($$0.a($$2)), $$1);
   }

   public boolean a(cms $$0, gpb $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gp()) {
            bwf $$5 = $$0.gq();
            if ($$5 != null) {
               fbx $$6 = this.a($$5, (double)$$5.ds() * 0.5, 1.0F);
   ...
   public void a(gyh $$0, fgr $$1, glk $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fbx $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fgv $$0, fgr.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hbb.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cms $$0, gyh $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.m($$2);
