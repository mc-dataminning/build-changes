...
public abstract class bbn extends DataFix {
   private final String a;

   public bbn(Schema $$0, String $$1) {
      super($$0, false);
      this.a = $$1;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$1 = DSL.named(bgv.C.typeName(), big.a());
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$3 = this.fixTypeEverywhereTyped(
            this.a + " for block_state", this.getInputSchema().getType(bgv.u), $$0x -> $$0x.update(DSL.remainderFinder(), this::a)
         );
         TypeRewriteRule $$4 = this.fixTypeEverywhereTyped(
            this.a + " for flat_block_state",
            this.getInputSchema().getType(bgv.v),
            $$0x -> $$0x.update(
