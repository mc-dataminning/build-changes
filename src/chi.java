...
public class chi implements dgu {
   ...
   public int a(ash $$0, boolean $$1, boolean $$2) {
      if (!$$0.U() && $$1) {
         float $$3 = $$0.f(0.0F);
         if ((double)$$3 == 0.5) {
            this.c = $$0.A.a(10) == 0 ? chi.a.b : chi.a.c;
         }
   ...
   private void b(ash $$0) {
      fby $$1 = this.a($$0, new jh(this.f, this.g, this.h));
      if ($$1 != null) {
         cnq $$2;
         try {
            $$2 = new cnq($$0);
            $$2.a($$0, $$0.d_($$2.dw()), bvq.h, null);
   ...
   @Nullable
   private fby a(ash $$0, jh $$1) {
      for (int $$2 = 0; $$2 < 10; $$2++) {
         int $$3 = $$1.u() + $$0.A.a(16) - 8;
         int $$4 = $$1.w() + $$0.A.a(16) - 8;
         int $$5 = $$0.a(edq.a.b, $$3, $$4);
         jh $$6 = new jh($$3, $$5, $$4);
         if ($$0.c($$6) && cmx.b(bvr.bO, $$0, bvq.h, $$6, $$0.A)) {
            return fby.c($$6);
         }
      }
