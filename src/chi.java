...
public class chi extends che {
   ...
   private void j() {
      if (this.c != null && this.c.c()) {
         io $$0 = this.a.dP().a(dwv.a.f, new io(dzy.a(this.a.s())));
         ...
         cly $$2 = this.a.dP().a(b, this.a, (double)$$0.u(), (double)$$0.v(), (double)$$0.w());
         double $$3;
         if ($$2 != null) {
            $$3 = $$0.b($$2.dn()) / 512.0;
         } else {
   ...
   @Override
   public void a(chb $$0, io $$1, bqp $$2, @Nullable cly $$3) {
