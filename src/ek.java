...
public class ek implements ArgumentType<eif> {
   ...
   public static eif a(CommandContext<dr> $$0, String $$1) {
      return (eif)$$0.getArgument($$1, eif.class);
   }

   public eif a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      List<String> $$2 = Lists.newArrayList(eif.c());
