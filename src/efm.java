...
public class efm implements azs {
   ...
   @Override
   public azs d() {
      return new efm(this.e.a(), this.e.a());
   }

   @Override
   public eey e() {
      return new efm.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements eey {
      ...
      public azs a(int $$0, int $$1, int $$2) {
         long $$3 = azk.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new efm($$4, this.b);
      }

      @Override
      public azs a(String $$0) {
         efa.a $$1 = efa.a($$0);
         return new efm($$1.a(this.a, this.b));
      }

      @Override
      public azs a(long $$0) {
         return new efm($$0 ^ this.a, $$0 ^ this.b);
      }
