...
public class aw extends cu<aw.a> {
   ...
   public aw.a a(JsonObject $$0, Optional<ba> $$1, be $$2) {
      aeq<cpm> $$3 = $$0.has("from") ? aeq.a(jc.aH, new aer(arg.i($$0, "from"))) : null;
      aeq<cpm> $$4 = $$0.has("to") ? aeq.a(jc.aH, new aer(arg.i($$0, "to"))) : null;
      return new aw.a($$1, $$3, $$4);
   }

   public void a(akl $$0, aeq<cpm> $$1, aeq<cpm> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static class a extends ar {
      @Nullable
      private final aeq<cpm> a;
      @Nullable
      private final aeq<cpm> b;

      public a(Optional<ba> $$0, @Nullable aeq<cpm> $$1, @Nullable aeq<cpm> $$2) {
         super(aw.a, $$0);
         this.a = $$1;
         this.b = $$2;
      }
      ...
      public static aw.a a(aeq<cpm> $$0, aeq<cpm> $$1) {
         return new aw.a(Optional.empty(), $$0, $$1);
      }

      public static aw.a a(aeq<cpm> $$0) {
         return new aw.a(Optional.empty(), null, $$0);
      }

      public static aw.a b(aeq<cpm> $$0) {
         return new aw.a(Optional.empty(), $$0, null);
      }

      public boolean b(aeq<cpm> $$0, aeq<cpm> $$1) {
