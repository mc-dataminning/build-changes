...
public class aw extends de<aw.a> {
   @Override
   public Codec<aw.a> a() {
      return aw.a.a;
   }

   public void a(aqi $$0, cdp $$1, cdp $$2, @Nullable brb $$3) {
      eol $$4 = br.b($$0, $$1);
      eol $$5 = br.b($$0, $$2);
      eol $$6 = $$3 != null ? br.b($$0, $$3) : null;
      this.a($$0, $$3x -> $$3x.a($$4, $$5, $$6));
   }

   public static record a(Optional<bc> b, Optional<bc> c, Optional<bc> d, Optional<bc> e) implements de.a {
      public static final Codec<aw.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  axh.a(br.b, "player").forGetter(aw.a::a),
                  axh.a(br.b, "parent").forGetter(aw.a::c),
                  axh.a(br.b, "partner").forGetter(aw.a::d),
                  axh.a(br.b, "child").forGetter(aw.a::e)
               )
               .apply($$0, aw.a::new)
      );
