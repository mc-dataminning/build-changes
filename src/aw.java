...
public class aw extends cx<aw.a> {
   ...
   public void a(aow $$0, bzt $$1, bzt $$2, @Nullable bnj $$3) {
      eiv $$4 = br.b($$0, $$1);
      eiv $$5 = br.b($$0, $$2);
      eiv $$6 = $$3 != null ? br.b($$0, $$3) : null;
   ...
   public static record a(Optional<bc> b, Optional<bc> c, Optional<bc> d, Optional<bc> e) implements cx.a {
      public static final Codec<aw.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avp.a(br.b, "player").forGetter(aw.a::a),
                  avp.a(br.b, "parent").forGetter(aw.a::c),
                  avp.a(br.b, "partner").forGetter(aw.a::d),
                  avp.a(br.b, "child").forGetter(aw.a::e)
               )
               .apply($$0, aw.a::new)
      );
