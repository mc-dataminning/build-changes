public class fra extends frv {
   private final frq a;

   fra(fns $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, frq $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cfi $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dt();
            if (this.h > $$1) {
   ...
   public static class a implements fqy<ka> {
      ...
      public fqv a(ka $$0, fns $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fra($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fqy<ka> {
      ...
      public fqv a(ka $$0, fns $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqv $$8 = new fra($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
