public class fra extends fiq<fra.a> {
   ...
   public fra(ffw $$0, fqz $$1, int $$2, int $$3, wu $$4) {
      super($$0, $$2, $$3, 33, 36);
      this.x = $$1;
      this.w = $$4;
      this.e = false;
   ...
   public static class a extends fiq.a<fra.a> {
      ...
      private static axs a(ffw $$0, wu $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fin b(ffw $$0, wu $$1) {
         return fin.a($$0.h, $$1, 157, 2);
      }
