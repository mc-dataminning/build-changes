...
public abstract class fra extends fqn {
   protected float D;
   private final Quaternionf a = new Quaternionf();

   protected fra(fnk $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }

   protected fra(fnk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }
   ...
   public void a(epx $$0, eul $$1, float $$2) {
      elm $$3 = $$1.b();
      float $$4 = (float)(aui.d((double)$$2, this.d, this.g) - $$3.a());
      float $$5 = (float)(aui.d((double)$$2, this.e, this.h) - $$3.b());
      float $$6 = (float)(aui.d((double)$$2, this.f, this.i) - $$3.c());
      this.p().setRotation(this.a, $$1, $$2);
      if (this.z != 0.0F) {
         this.a.rotateZ(aui.i($$2, this.A, this.z));
      }
   ...
   public interface a {
      fra.a a = ($$0, $$1, $$2) -> $$0.set($$1.f());
      fra.a b = ($$0, $$1, $$2) -> $$0.set(0.0F, $$1.f().y, 0.0F, $$1.f().w);

      void setRotation(Quaternionf var1, eul var2, float var3);
   }
}
