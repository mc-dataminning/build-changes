...
public class afm {
   private static final tn a = tn.c("commands.debug.function.noRecursion");
   private static final aey b = new aey("tick");
   private static final aey c = new aey("load");
   ...
   public afm(MinecraftServer $$0, afl $$1) {
      this.d = $$0;
      this.h = $$1;
      this.b($$1);
   }
   ...
   private void a(Collection<dp> $$0, aey $$1) {
   ...
   public int a(dp $$0, dt $$1, @Nullable afm.c $$2, @Nullable qy $$3) throws dv {
      dp $$4 = $$0.a($$3, this.b(), $$1);
      if (this.e != null) {
         if ($$2 != null) {
   ...
   public Iterable<aey> e() {
      return this.h.a().keySet();
   }

   public Iterable<aey> f() {
      return this.h.b();
   }
   ...
   class a {
      private int b;
      @Nullable
      private final afm.c c;
      private final Deque<afm.b> d = Queues.newArrayDeque();
      private final List<afm.b> e = Lists.newArrayList();
      boolean f = false;
      ...
      void a(dp $$0, dt $$1) {
         ...
         if (this.d.size() + this.e.size() < $$2) {
            this.e.add(new afm.b($$3, this.b, new dp.e($$0)));
         }
      }

      private dt a(dt $$0) {
         IntConsumer $$1 = $$0.p();
         return $$1 instanceof afm.a.a ? $$0 : $$0.a(new afm.a.a($$1));
      }
      ...
      int b(dp $$0, dt $$1) {
         ...
         for (int $$6 = $$5.length - 1; $$6 >= 0; $$6--) {
            this.d.push(new afm.b($$3, 0, $$5[$$6]));
         }

         while (!this.d.isEmpty()) {
            try {
               afm.b $$7 = this.d.removeFirst();
               afm.this.d.aM().a($$7::toString);
               this.b = $$7.b;
               $$7.a(afm.this, this.d, $$2, this.c);
               if (!this.f) {
                  if (!this.e.isEmpty()) {
   ...
   public static class b {
      ...
      public void a(afm $$0, Deque<afm.b> $$1, int $$2, @Nullable afm.c $$3) {
         try {
   ...
   public interface c {
      ...
      void a(int var1, aey var2, int var3);
   }
}
