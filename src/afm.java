...
public class afm {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("commands.publish.failed"));
   ...
   public static void a(CommandDispatcher<ds> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a("publish").requires($$0x -> $$0x.c(4)))
               .executes($$0x -> a((ds)$$0x.getSource(), aos.a(), false, null)))
            .then(
               ((RequiredArgumentBuilder)dt.a("allowCommands", BoolArgumentType.bool())
                     .executes($$0x -> a((ds)$$0x.getSource(), aos.a(), BoolArgumentType.getBool($$0x, "allowCommands"), null)))
                  .then(
                     ((RequiredArgumentBuilder)dt.a("gamemode", ed.a())
                           .executes($$0x -> a((ds)$$0x.getSource(), aos.a(), BoolArgumentType.getBool($$0x, "allowCommands"), ed.a($$0x, "gamemode"))))
                        .then(
