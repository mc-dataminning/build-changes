...
public class afm implements aac<acr> {
   public static final zt<ws, afm> a = aac.a(afm::a, afm::new);
   private static final int b = 12;
   private final kj c;
   private final short[] d;
   private final dxu[] e;

   public afm(kj $$0, ShortSet $$1, eaa $$2) {
      this.c = $$0;
      int $$3 = $$1.size();
      this.d = new short[$$3];
      this.e = new dxu[$$3];
   ...
   private void a(ws $$0) {
      ...
      for (int $$1 = 0; $$1 < this.d.length; $$1++) {
         $$0.a((long)dkl.j(this.e[$$1]) << 12 | (long)this.d[$$1]);
      }
   }
   ...
   public void a(BiConsumer<jh, dxu> $$0) {
      jh.a $$1 = new jh.a();
