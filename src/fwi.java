...
public class fwi {
   ...
   static final ThreadLocal<fwi.d> f = ThreadLocal.withInitial(fwi.d::new);

   public fwi(eyl $$0) {
      this.d = $$0;
   }

   public void a(cuq $$0, giu $$1, dlf $$2, hz $$3, esa $$4, ese $$5, boolean $$6, awo $$7, long $$8, int $$9) {
   ...
   public void b(cuq $$0, giu $$1, dlf $$2, hz $$3, esa $$4, ese $$5, boolean $$6, awo $$7, long $$8, int $$9) {
      ...
      $$7.b($$8);
      List<fwj> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(cuq $$0, giu $$1, dlf $$2, hz $$3, esa $$4, ese $$5, boolean $$6, awo $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      hz.a $$11 = $$3.j();

      for (ie $$12 : c) {
         $$7.b($$8);
         List<fwj> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
      ...
      $$7.b($$8);
      List<fwj> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(cuq $$0, dlf $$1, hz $$2, esa $$3, ese $$4, List<fwj> $$5, float[] $$6, BitSet $$7, fwi.b $$8, int $$9) {
      for (fwj $$10 : $$5) {
   ...
   private void a(
      cuq $$0, dlf $$1, hz $$2, ese $$3, esa.a $$4, fwj $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(cuq $$0, dlf $$1, hz $$2, int $$3, int $$4, boolean $$5, esa $$6, ese $$7, List<fwj> $$8, BitSet $$9) {
      for (fwj $$10 : $$8) {
         if ($$5) {
   ...
   public void a(esa.a $$0, ese $$1, @Nullable dlf $$2, giu $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      awo $$9 = awo.a();
      long $$10 = 42L;
   ...
   private static void a(esa.a $$0, ese $$1, float $$2, float $$3, float $$4, List<fwj> $$5, int $$6, int $$7) {
      for (fwj $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new fwi.e[]{fwi.e.k, fwi.e.d, fwi.e.k, fwi.e.j, fwi.e.e, fwi.e.j, fwi.e.e, fwi.e.d},
         new fwi.e[]{fwi.e.k, fwi.e.c, fwi.e.k, fwi.e.i, fwi.e.e, fwi.e.i, fwi.e.e, fwi.e.c},
         new fwi.e[]{fwi.e.l, fwi.e.c, fwi.e.l, fwi.e.i, fwi.e.f, fwi.e.i, fwi.e.f, fwi.e.c},
         new fwi.e[]{fwi.e.l, fwi.e.d, fwi.e.l, fwi.e.j, fwi.e.f, fwi.e.j, fwi.e.f, fwi.e.d}
      ),
      b(
         new ie[]{ie.f, ie.e, ie.c, ie.d},
         1.0F,
         true,
         new fwi.e[]{fwi.e.f, fwi.e.d, fwi.e.f, fwi.e.j, fwi.e.l, fwi.e.j, fwi.e.l, fwi.e.d},
         new fwi.e[]{fwi.e.f, fwi.e.c, fwi.e.f, fwi.e.i, fwi.e.l, fwi.e.i, fwi.e.l, fwi.e.c},
         new fwi.e[]{fwi.e.e, fwi.e.c, fwi.e.e, fwi.e.i, fwi.e.k, fwi.e.i, fwi.e.k, fwi.e.c},
         new fwi.e[]{fwi.e.e, fwi.e.d, fwi.e.e, fwi.e.j, fwi.e.k, fwi.e.j, fwi.e.k, fwi.e.d}
      ),
      c(
         new ie[]{ie.b, ie.a, ie.f, ie.e},
         0.8F,
         true,
         new fwi.e[]{fwi.e.b, fwi.e.k, fwi.e.b, fwi.e.e, fwi.e.h, fwi.e.e, fwi.e.h, fwi.e.k},
         new fwi.e[]{fwi.e.b, fwi.e.l, fwi.e.b, fwi.e.f, fwi.e.h, fwi.e.f, fwi.e.h, fwi.e.l},
         new fwi.e[]{fwi.e.a, fwi.e.l, fwi.e.a, fwi.e.f, fwi.e.g, fwi.e.f, fwi.e.g, fwi.e.l},
         new fwi.e[]{fwi.e.a, fwi.e.k, fwi.e.a, fwi.e.e, fwi.e.g, fwi.e.e, fwi.e.g, fwi.e.k}
      ),
      d(
         new ie[]{ie.e, ie.f, ie.a, ie.b},
         0.8F,
         true,
         new fwi.e[]{fwi.e.b, fwi.e.k, fwi.e.h, fwi.e.k, fwi.e.h, fwi.e.e, fwi.e.b, fwi.e.e},
         new fwi.e[]{fwi.e.a, fwi.e.k, fwi.e.g, fwi.e.k, fwi.e.g, fwi.e.e, fwi.e.a, fwi.e.e},
         new fwi.e[]{fwi.e.a, fwi.e.l, fwi.e.g, fwi.e.l, fwi.e.g, fwi.e.f, fwi.e.a, fwi.e.f},
         new fwi.e[]{fwi.e.b, fwi.e.l, fwi.e.h, fwi.e.l, fwi.e.h, fwi.e.f, fwi.e.b, fwi.e.f}
      ),
      e(
         new ie[]{ie.b, ie.a, ie.c, ie.d},
         0.6F,
         true,
         new fwi.e[]{fwi.e.b, fwi.e.d, fwi.e.b, fwi.e.j, fwi.e.h, fwi.e.j, fwi.e.h, fwi.e.d},
         new fwi.e[]{fwi.e.b, fwi.e.c, fwi.e.b, fwi.e.i, fwi.e.h, fwi.e.i, fwi.e.h, fwi.e.c},
         new fwi.e[]{fwi.e.a, fwi.e.c, fwi.e.a, fwi.e.i, fwi.e.g, fwi.e.i, fwi.e.g, fwi.e.c},
         new fwi.e[]{fwi.e.a, fwi.e.d, fwi.e.a, fwi.e.j, fwi.e.g, fwi.e.j, fwi.e.g, fwi.e.d}
      ),
      f(
         new ie[]{ie.a, ie.b, ie.c, ie.d},
         0.6F,
         true,
         new fwi.e[]{fwi.e.g, fwi.e.d, fwi.e.g, fwi.e.j, fwi.e.a, fwi.e.j, fwi.e.a, fwi.e.d},
         new fwi.e[]{fwi.e.g, fwi.e.c, fwi.e.g, fwi.e.i, fwi.e.a, fwi.e.i, fwi.e.a, fwi.e.c},
         new fwi.e[]{fwi.e.h, fwi.e.c, fwi.e.h, fwi.e.i, fwi.e.b, fwi.e.i, fwi.e.b, fwi.e.c},
         new fwi.e[]{fwi.e.h, fwi.e.d, fwi.e.h, fwi.e.j, fwi.e.b, fwi.e.j, fwi.e.b, fwi.e.d}
      );
      ...
      final fwi.e[] k;
      final fwi.e[] l;
      private static final fwi.a[] m = ac.a(new fwi.a[6], $$0 -> {
         $$0[ie.a.d()] = a;
         $$0[ie.b.d()] = b;
         $$0[ie.c.d()] = c;
         $$0[ie.d.d()] = d;
      ...
      private a(ie[] $$0, float $$1, boolean $$2, fwi.e[] $$3, fwi.e[] $$4, fwi.e[] $$5, fwi.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final fwi.c[] k = ac.a(new fwi.c[6], $$0 -> {
         $$0[ie.a.d()] = a;
         $$0[ie.b.d()] = b;
         $$0[ie.c.d()] = c;
         $$0[ie.d.d()] = d;
