...
public class fwi extends fwf {
   private static final ald a = ald.b("textures/misc/credits_vignette.png");
   private static final Logger b = LogUtils.getLogger();
   private static final wv c = wv.b("============").a(n.p);
   private static final String d = "           ";
   private static final String s = "" + n.p + n.q + n.k + n.l;
   private static final float u = 5.0F;
   private static final float v = 15.0F;
   private static final ald w = ald.b("texts/end.txt");
   private static final ald x = ald.b("texts/credits.json");
   private static final ald y = ald.b("texts/postcredits.txt");
   ...
   private int J;
   private final fre K = new fre(false);

   public fwi(boolean $$0, Runnable $$1) {
      super(fmu.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : aza.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(wv.b($$4).a(n.o), true);
         this.a(c, true);
         this.F();
         this.F();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(wv.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(wv.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.C.addAll(this.m.h.c(wv.b($$0), 256));
   }

   private void a(wv $$0, boolean $$1) {
      if ($$1) {
   ...
   private void c(fpz $$0) {
      $$0.a(goi::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
