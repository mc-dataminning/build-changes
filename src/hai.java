...
public class hai implements hah {
   public static final int a = 0;
   private final hai.b c = new hai.b();
   private final hai.b d = new hai.b();
   public final hai.a b;
   ...
   private float a(cxk $$0, gfd $$1, int $$2, bvf $$3) {
   ...
   private float a(bvf $$0, long $$1, jh $$2) {
      double $$3 = this.a($$0, $$2);
      double $$4 = this.a($$0);
      if ($$0 instanceof cps $$5 && $$5.c() && $$5.dV().t().i()) {
         if (this.c.a($$1)) {
   ...
   @Nullable
   private gfd a(bvf $$0, @Nullable gfd $$1) {
      return $$1 == null && $$0.dV() instanceof gfd ? (gfd)$$0.dV() : $$1;
   }

   private boolean a(bvf $$0, @Nullable jp $$1) {
      return $$1 != null && $$1.a() == $$0.dV().ah() && !($$1.b().b($$0.dt()) < 1.0E-5F);
   }

   private double a(bvf $$0, jh $$1) {
      fbs $$2 = fbs.b($$1);
      return Math.atan2($$2.c() - $$0.dG(), $$2.a() - $$0.dA()) / (float) (Math.PI * 2);
   }

   private double a(bvf $$0) {
      return bae.c((double)($$0.dM() / 360.0F), 1.0);
   }
   ...
   public interface a {
      @Nullable
      jp getPos(gfd var1, cxk var2, bvf var3);
   }
