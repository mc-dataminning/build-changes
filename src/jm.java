...
public enum jm implements baj {
   ...
   private jm(final int $$0, final int $$1, final int $$2, final String $$3, final jm.b $$4, final jm.a $$5, final kl $$6) {
      this.k = $$0;
      this.m = $$2;
      this.l = $$1;
      this.n = $$3;
   ...
   private static jm[] a(jm $$0, jm $$1, jm $$2) {
      return new jm[]{$$0, $$1, $$2, $$2.g(), $$1.g(), $$0.g()};
   }

   public static jm a(Matrix4f $$0, jm $$1) {
      kl $$2 = $$1.q();
      Vector4f $$3 = $$0.transform(new Vector4f((float)$$2.u(), (float)$$2.v(), (float)$$2.w(), 0.0F));
      return a($$3.x(), $$3.y(), $$3.z());
   }

   public static Collection<jm> a(azv $$0) {
      return ae.b(values(), $$0);
   }

   public static Stream<jm> a() {
      return Stream.of(s);
   }

   public static float a(jm $$0) {
      return switch ($$0) {
         case c -> 180.0F;
         case d -> 0.0F;
         case e -> 90.0F;
   ...
   public static jm a(bui $$0, jm.a $$1) {
      return switch ($$1) {
   ...
   @Nullable
   public static jm a(@Nullable String $$0) {
      return g.a($$0);
   }

   public static jm a(int $$0) {
      return t[azn.a($$0 % t.length)];
   }

   public static jm b(int $$0) {
      return u[azn.a($$0 % u.length)];
   }

   public static jm a(double $$0) {
      return b(azn.a($$0 / 90.0 + 0.5) & 3);
   }
   ...
   public static jm b(azv $$0) {
      return ae.a(s, $$0);
   }

   public static jm a(double $$0, double $$1, double $$2) {
      return a((float)$$0, (float)$$1, (float)$$2);
   }

   public static jm a(float $$0, float $$1, float $$2) {
      jm $$3 = c;
   ...
   public static jm a(ezr $$0) {
      return a($$0.d, $$0.e, $$0.f);
   }

   @Nullable
   @Contract("_,_,_,!null->!null;_,_,_,_->_")
   public static jm a(int $$0, int $$1, int $$2, @Nullable jm $$3) {
      int $$4 = Math.abs($$0);
      int $$5 = Math.abs($$1);
      int $$6 = Math.abs($$2);
      if ($$4 > $$6 && $$4 > $$5) {
   ...
   public static jm a(kl $$0, @Nullable jm $$1) {
   ...
   public static enum a implements baj, Predicate<jm> {
      a("x") {
         @Override
      ...
      public static final baj.a<jm.a> e = baj.a(jm.a::values);
      ...
      public static jm.a a(azv $$0) {
         return ae.a(d, $$0);
      }

      public boolean a(@Nullable jm $$0) {
   ...
   public static enum c implements Iterable<jm>, Predicate<jm> {
      a(new jm[]{jm.c, jm.f, jm.d, jm.e}, new jm.a[]{jm.a.a, jm.a.c}),
      b(new jm[]{jm.b, jm.a}, new jm.a[]{jm.a.b});

      private final jm[] c;
      private final jm.a[] d;

      private c(final jm[] $$0, final jm.a[] $$1) {
         this.c = $$0;
         this.d = $$1;
      }
