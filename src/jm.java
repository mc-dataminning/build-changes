...
public enum jm implements bag {
   ...
   public static final bag.a<jm> g = bag.a(jm::values);
   public static final Codec<jm> h = g.validate(jm::b);
   public static final IntFunction<jm> i = ayb.a(jm::d, values(), ayb.a.b);
   public static final zg<ByteBuf, jm> j = ze.a(i, jm::d);
   private final int k;
   private final int l;
   private final int m;
   ...
   public static Collection<jm> a(azs $$0) {
   ...
   public static jm a(bue $$0, jm.a $$1) {
      return switch ($$1) {
   ...
   public static enum a implements bag, Predicate<jm> {
      a("x") {
         @Override
      ...
      public static final bag.a<jm.a> e = bag.a(jm.a::values);
