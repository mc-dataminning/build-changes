...
public abstract class cos extends cpf {
   private static final evq c = new evq(0.0, 0.0, 0.0);
   private static final akj<Integer> d = akn.a(cos.class, akl.b);
   private static final akj<Integer> e = akn.a(cos.class, akl.b);
   private static final akj<Boolean> i = akn.a(cos.class, akl.k);
   ...
   private double r;
   private evq s = evq.b;
   private static final Map<dtf, Pair<kd, kd>> t = ac.a(Maps.newEnumMap(dtf.class), $$0 -> {
      kd $$1 = je.e.q();
      kd $$2 = je.f.q();
      kd $$3 = je.c.q();
      kd $$4 = je.d.q();
      ...
      kd $$7 = $$3.o();
      kd $$8 = $$4.o();
      $$0.put(dtf.a, Pair.of($$3, $$4));
      $$0.put(dtf.b, Pair.of($$1, $$2));
      $$0.put(dtf.c, Pair.of($$5, $$2));
      $$0.put(dtf.d, Pair.of($$1, $$6));
      $$0.put(dtf.e, Pair.of($$3, $$8));
      $$0.put(dtf.f, Pair.of($$7, $$4));
      $$0.put(dtf.g, Pair.of($$4, $$2));
      $$0.put(dtf.h, Pair.of($$4, $$1));
      $$0.put(dtf.i, Pair.of($$3, $$1));
      $$0.put(dtf.j, Pair.of($$3, $$2));
   });

   protected cos(bsz<?> $$0, dbx $$1) {
      super($$0, $$1);
      this.J = true;
   }

   protected cos(bsz<?> $$0, dbx $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.a_($$2, $$3, $$4);
      this.L = $$2;
      this.M = $$3;
   ...
   public static cos a(are $$0, double $$1, double $$2, double $$3, cos.a $$4, cuo $$5, @Nullable cmw $$6) {
      cos $$7 = (cos)(switch ($$4) {
         case b -> new coz($$0, $$1, $$2, $$3);
         case c -> new cpb($$0, $$1, $$2, $$3);
         case d -> new cpe($$0, $$1, $$2, $$3);
         case e -> new cpd($$0, $$1, $$2, $$3);
         case f -> new cpc($$0, $$1, $$2, $$3);
         case g -> new cpa($$0, $$1, $$2, $$3);
         default -> new coy($$0, $$1, $$2, $$3);
      });
      bsz.<cos>a($$0, $$5, $$6).accept($$7);
      return $$7;
   }
   ...
   protected evq a(bst $$0, bsw $$1, float $$2) {
      boolean $$3 = $$0 instanceof cmj || $$0 instanceof cmp;
   ...
   public evq b(bto $$0) {
      ...
      if ($$1.o() == je.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dP().a(cox.a(this.dP(), $$4), () -> cox.a(this.dP(), $$4.d()));
                  if (cox.a($$11)) {
                     evl $$12 = new evl((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b(), (double)$$8);
                     evq $$13 = evq.a($$4, $$11);
                     if (cox.a(this.dP(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            ...
            double $$18 = cox.a($$4, $$17, $$0x -> this.dP().a_($$0x).k(this.dP(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   protected float aN() {
      ...
      return $$0.a(awo.N) ? 1.0F : super.aN();
   }
   ...
   private static Pair<kd, kd> a(dtf $$0) {
      return t.get($$0);
   }
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         int $$1 = ayy.a(this.dw());
         int $$2 = ayy.a(this.dA());
         if (this.dP().a_(new iz($$0, $$1 - 1, $$2)).a(awo.N)) {
            $$1--;
         }
         ...
         if ($$5 * $$5 + $$6 * $$6 > 0.001) {
            this.r((float)(ayy.d($$6, $$5) * 180.0 / Math.PI));
            if (this.k) {
               this.r(this.dF() + 180.0F);
            }
         }

         double $$7 = (double)ayy.g(this.dF() - this.O);
         if ($$7 < -170.0 || $$7 >= 170.0) {
            this.r(this.dF() + 180.0F);
            this.k = !this.k;
         }
         ...
         this.a(this.dF(), this.dH());
         if (this.v() == cos.a.a && this.ds().i() > 0.01) {
            List<bst> $$8 = this.dP().a(this, this.cK().c(0.2F, 0.0, 0.2F), bsy.a(this));
            if (!$$8.isEmpty()) {
               for (bst $$9 : $$8) {
                  if (!($$9 instanceof cmw) && !($$9 instanceof cfq) && !($$9 instanceof cos) && !this.bS() && !$$9.bR()) {
                     $$9.n(this);
                  } else {
                     $$9.h(this);
                  }
            ...
            for (bst $$10 : this.dP().a_(this, this.cK().c(0.2F, 0.0, 0.2F))) {
               if (!this.x($$10) && $$10.bA() && $$10 instanceof cos) {
                  $$10.h(this);
               }
            }
         }
   ...
   protected void s() {
      double $$0 = this.p();
      evq $$1 = this.ds();
      this.o(ayy.a($$1.c, -$$0, $$0), $$1.d, ayy.a($$1.e, -$$0, $$0));
      if (this.aE()) {
   ...
   protected void c(iz $$0, dsb $$1) {
      ...
      $$9 = new evq($$18 * $$14 / $$16, $$9.d, $$18 * $$15 / $$16);
      this.h($$9);
      bst $$19 = this.cT();
      if ($$19 instanceof cmw) {
         evq $$20 = $$19.ds();
         double $$21 = $$20.i();
         double $$22 = this.ds().i();
      ...
      double $$34 = this.p();
      $$9 = this.ds();
      this.a(btt.a, new evq(ayy.a($$33 * $$9.c, -$$34, $$34), 0.0, ayy.a($$33 * $$9.e, -$$34, $$34)));
      if ($$12.v() != 0 && ayy.a(this.du()) - $$0.u() == $$12.u() && ayy.a(this.dA()) - $$0.w() == $$12.w()) {
         this.a_(this.du(), this.dw() + (double)$$12.v(), this.dA());
      } else if ($$13.v() != 0 && ayy.a(this.du()) - $$0.u() == $$13.u() && ayy.a(this.dA()) - $$0.w() == $$13.w()) {
         this.a_(this.du(), this.dw() + (double)$$13.v(), this.dA());
      }

      this.u();
      evq $$35 = this.q(this.du(), this.dw(), this.dA());
      if ($$35 != null && $$5 != null) {
      ...
      int $$39 = ayy.a(this.du());
      int $$40 = ayy.a(this.dA());
      if ($$39 != $$0.u() || $$40 != $$0.w()) {
         evq $$41 = this.ds();
         double $$42 = $$41.h();
   ...
   @Nullable
   public evq a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ayy.a($$0);
      int $$5 = ayy.a($$1);
      int $$6 = ayy.a($$2);
      if (this.dP().a_(new iz($$4, $$5 - 1, $$6)).a(awo.N)) {
         $$5--;
      }

      dsb $$7 = this.dP().a_(new iz($$4, $$5, $$6));
      if (den.g($$7)) {
         dtf $$8 = $$7.c(((den)$$7.b()).c());
         $$1 = (double)$$5;
         if ($$8.b()) {
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && ayy.a($$0) - $$4 == $$10.u() && ayy.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && ayy.a($$0) - $$4 == $$11.u() && ayy.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   @Nullable
   public evq q(double $$0, double $$1, double $$2) {
      int $$3 = ayy.a($$0);
      int $$4 = ayy.a($$1);
      int $$5 = ayy.a($$2);
      if (this.dP().a_(new iz($$3, $$4 - 1, $$5)).a(awo.N)) {
         $$4--;
      }

      dsb $$6 = this.dP().a_(new iz($$3, $$4, $$5));
      if (den.g($$6)) {
         dtf $$7 = $$6.c(((den)$$6.b()).c());
         Pair<kd, kd> $$8 = a($$7);
         kd $$9 = (kd)$$8.getFirst();
            ...
            if (!this.x($$0)) {
               ...
               if ($$3 >= 1.0E-4F) {
                  ...
                  if ($$0 instanceof cos) {
                     ...
                     evq $$7 = new evq($$5, 0.0, $$6).d();
                     evq $$8 = new evq((double)ayy.b(this.dF() * (float) (Math.PI / 180.0)), 0.0, (double)ayy.a(this.dF() * (float) (Math.PI / 180.0))).d();
                     ...
                     evq $$10 = this.ds();
                     evq $$11 = $$0.ds();
                     if (((cos)$$0).v() == cos.a.c && this.v() != cos.a.c) {
                        this.h($$10.d(0.2, 1.0, 0.2));
                        this.j($$11.c - $$1, 0.0, $$11.e - $$2);
                        $$0.h($$11.d(0.95, 1.0, 0.95));
                     } else if (((cos)$$0).v() != cos.a.c && this.v() == cos.a.c) {
   ...
   public abstract cos.a v();

   public dsb w() {
      return !this.A() ? this.x() : dey.a(this.ap().a(d));
   }
