...
public class cos extends cok {
   ...
   public float a(iv $$0, djk $$1) {
      return dqq.o($$1.a_($$0.e())) ? 10.0F : super.a($$0, $$1);
   }

   public static boolean b(bwr<cos> $$0, dji $$1, bwq $$2, iv $$3, azv $$4) {
      if (!c($$0, $$1, $$2, $$3, $$4)) {
         return false;
      } else if (bwq.a($$2)) {
         return true;
      } else {
         crj $$5 = $$1.a((double)$$3.u() + 0.5, (double)$$3.v() + 0.5, (double)$$3.w() + 0.5, 5.0, true);
         return $$5 == null;
      }
   }
   ...
   static class a extends cfc {
      ...
      public boolean b() {
         if (this.b.f() != null) {
            ...
            azv $$0 = this.b.dX();
            if (a(this.b).O().c(djd.d) && $$0.a(b(10)) == 0) {
               this.i = jb.b($$0);
               iv $$1 = iv.a(this.b.dz(), this.b.dB() + 0.5, this.b.dF()).a(this.i);
               eao $$2 = this.b.dU().a_($$1);
               if (dqq.o($$2)) {
                  this.j = true;
                  return true;
               }
