...
public abstract class cos {
   ...
   public void a(bip<?> $$0, @Nullable cpq $$1, arx $$2, gw $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  gw $$13 = gw.a($$10, $$11, $$12);
                  if ($$4.b().isPresent()) {
                     if (!$$7.get().f().d() && $$0.ai() == bgq.a) {
                        continue;
                     }

                     cqh.a $$14 = $$4.b().get();
                     if (!$$14.a().a($$0.a(cpz.b, $$13)) || !$$14.b().a($$0.a(cpz.a, $$13))) {
                        continue;
                     }
                  } else if (!bjv.a($$7.get(), $$0, bjf.c, $$13, $$0.y_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        $$15.getClass(),
                        new ehd((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o)
                     )
                     .size();
                  if ($$16 >= this.m) {
                  ...
                  if ($$15 instanceof bjd $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bjf.c) || !$$17.a($$0)) {
                        continue;
                     }

                     if ($$4.a().f() == 1 && $$4.a().b("id", 8)) {
                        ((bjd)$$15).a($$0, $$0.d_($$15.dk()), bjf.c, null, null);
                     }
                  }
   ...
   private void c(cpq $$0, gw $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (cqh)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable cpq $$0, gw $$1, qu $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         cqh $$4 = cqh.b.parse(rf.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(cqh::new);
         this.a($$0, $$1, $$4);
      }

      boolean $$5 = $$2.b("SpawnPotentials", 9);
      if ($$5) {
         ra $$6 = $$2.c("SpawnPotentials", 10);
         this.e = cqh.c.parse(rf.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bfd::b);
      } else {
         this.e = bfd.a(this.f != null ? this.f : new cqh());
      }
   ...
   public qu a(qu $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (rn)cqh.b.encodeStart(rf.a, this.f).result().orElseThrow(() -> new IllegalStateException("Invalid SpawnData")));
      }

      $$0.a("SpawnPotentials", (rn)cqh.c.encodeStart(rf.a, this.e).result().orElseThrow());
      return $$0;
   }

   @Nullable
   public bil a(cpq $$0, arx $$1, gw $$2) {
      if (this.l == null) {
         qu $$3 = this.b($$0, $$1, $$2).a();
         if (!$$3.b("id", 8)) {
            return null;
         ...
         this.l = bip.a($$3, $$0, Function.identity());
         if ($$3.f() == 1 && this.l instanceof bjd) {
         }
      }
   ...
   protected void a(@Nullable cpq $$0, gw $$1, cqh $$2) {
      this.f = $$2;
   }

   private cqh b(@Nullable cpq $$0, arx $$1, gw $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bff.b::b).orElseGet(cqh::new));
         return this.f;
      }
   }

   public abstract void a(cpq var1, gw var2, int var3);
