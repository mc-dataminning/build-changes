...
public class hl<T> {
   ...
   private hs.b a(int $$0, int $$1) {
      return new hs.c(a(this.b.subList($$0, $$1).stream())).c();
   }
   ...
   private static Map<aeq<? extends hr<?>>, hr<?>> a(Stream<? extends hs> $$0) {
      Map<aeq<? extends hr<?>>, hr<?>> $$1 = new HashMap<>();
