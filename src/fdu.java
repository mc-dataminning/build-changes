public class fdu<T extends buv> extends fbo<T> {
   ...
   public static fek a(fei $$0) {
      ...
      $$2.a(
         ...
         feg.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         fej.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         feg.a(-2.0F, 6.9F + apa.b(0.20420352F) * 10.0F, -0.5F + apa.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", fej.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), feg.a);
      fej $$4 = fej.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, feg.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, feg.a(10.0F, 4.0F, 0.0F));
   ...
   private static <T extends buv> void a(T $$0, fee $$1, int $$2) {
      $$1.f = ($$0.b($$2) - $$0.aV) * (float) (Math.PI / 180.0);
