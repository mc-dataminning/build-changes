...
public class fdu {
   ...
   public static List<fdu.a> a(String $$0, fdu.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fdu.a> a(String $$0, List<fdu.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fdu.a> a(List<String> $$0, List<fdu.b> $$1) {
      int $$2 = 0;
      List<fdu.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fdu.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fdu.b a(String $$0, String $$1) {
         return new fdu.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fdu.b a(String $$0) {
         return new fdu.b($$0);
      }
   }
}
