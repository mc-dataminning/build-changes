...
public class fdu<T extends bul> extends fdm<T> {
   ...
   public static fht c() {
      ...
      fhv $$1 = new fhv();
      fhw $$2 = $$1.a();
      fhw $$3 = $$2.a("bone", fhs.c(), fhp.a(0.0F, 19.0F, 0.0F));
      fhw $$4 = $$3.a("body", fhs.c().a(0, 0).a(-3.5F, -4.0F, -5.0F, 7.0F, 7.0F, 10.0F), fhp.a);
      $$4.a("stinger", fhs.c().a(26, 7).a(0.0F, -1.0F, 5.0F, 0.0F, 1.0F, 2.0F), fhp.a);
      $$4.a("left_antenna", fhs.c().a(2, 0).a(1.5F, -2.0F, -3.0F, 1.0F, 2.0F, 3.0F), fhp.a(0.0F, -2.0F, -5.0F));
      $$4.a("right_antenna", fhs.c().a(2, 3).a(-2.5F, -2.0F, -3.0F, 1.0F, 2.0F, 3.0F), fhp.a(0.0F, -2.0F, -5.0F));
      fhr $$5 = new fhr(0.001F);
      $$3.a("right_wing", fhs.c().a(0, 18).a(-9.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F, $$5), fhp.a(-1.5F, -4.0F, -3.0F, 0.0F, -0.2618F, 0.0F));
      $$3.a("left_wing", fhs.c().a(0, 18).a().a(0.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F, $$5), fhp.a(1.5F, -4.0F, -3.0F, 0.0F, 0.2618F, 0.0F));
      $$3.a("front_legs", fhs.c().a("front_legs", -5.0F, 0.0F, 0.0F, 7, 2, 0, 26, 1), fhp.a(1.5F, 3.0F, -2.0F));
      $$3.a("middle_legs", fhs.c().a("middle_legs", -5.0F, 0.0F, 0.0F, 7, 2, 0, 26, 3), fhp.a(1.5F, 3.0F, 0.0F));
      $$3.a("back_legs", fhs.c().a("back_legs", -5.0F, 0.0F, 0.0F, 7, 2, 0, 26, 5), fhp.a(1.5F, 3.0F, 2.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if (this.u > 0.0F) {
         this.l.e = ffl.a(this.l.e, 3.0915928F, this.u);
      }
   }
