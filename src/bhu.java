...
public class bhu extends bgo {
   public bhu(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bhs.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bjg.a($$0.get("id").asString("minecraft:air"));
