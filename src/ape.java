...
public class ape {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ww.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> ww.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> ww.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ei $$0, fdv $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bwa> $$6) throws CommandSyntaxException {
      aro $$7 = $$0.e();
      int $$8 = $$7.G_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         $$0.a(
            () -> ww.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bwa> $$0) {
      Set<ffd> $$1 = Sets.newHashSet();
   ...
   private static void a(fdv $$0, double $$1, aro $$2, azt $$3, double $$4, double $$5, double $$6, double $$7, int $$8, ape.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bwa> $$0, aro $$1, ape.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ffd, ape.a> $$7 = Maps.newHashMap();

      for (bwa $$8 : $$0) {
         ape.a $$10;
         if ($$4) {
            ffd $$9 = $$8 instanceof cqs ? $$8.cr() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
   ...
   private static ape.a[] a(azt $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      ape.a[] $$6 = new ape.a[$$1];
   ...
   static class a {
      ...
      public boolean b(dhv $$0, int $$1) {
         iu $$2 = iu.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dzo $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.n() && !$$3.a(axa.aN);
      }

      public void a(azt $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = azk.a($$0, $$1, $$3);
         this.b = azk.a($$0, $$2, $$4);
      }
   }
