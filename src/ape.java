...
public class ape {
                     ...
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)eu.a(
                                    ...
                                    .then(
                                       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("nametagVisibility")
                                                   .then(eu.a("never").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.b))))
                                                .then(eu.a("hideForOtherTeams").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.c))))
                                             .then(eu.a("hideForOwnTeam").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.d))))
                                          .then(eu.a("always").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.a)))
                                    ))
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("deathMessageVisibility")
                                                .then(eu.a("never").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.b))))
                                             .then(eu.a("hideForOtherTeams").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.c))))
                                          .then(eu.a("hideForOwnTeam").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.d))))
                                       .then(eu.a("always").executes($$0x -> b((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.b.a)))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("collisionRule")
                                             .then(eu.a("never").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.a.b))))
                                          .then(eu.a("pushOwnTeam").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.a.d))))
                                       .then(eu.a("pushOtherTeams").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.a.c))))
                                    .then(eu.a("always").executes($$0x -> a((et)$$0x.getSource(), gf.a($$0x, "team"), ezz.a.a)))
                              ))
                           .then(
                              eu.a("prefix")
   ...
   private static int a(et $$0, ezs $$1, Collection<ezw> $$2) {
      ezx $$3 = $$0.l().aJ();
   ...
   private static int a(et $$0, ezs $$1, ezz.b $$2) throws CommandSyntaxException {
      if ($$1.j() == $$2) {
         throw i.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(et $$0, ezs $$1, ezz.b $$2) throws CommandSyntaxException {
      if ($$1.k() == $$2) {
         throw j.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(et $$0, ezs $$1, ezz.a $$2) throws CommandSyntaxException {
      if ($$1.l() == $$2) {
         throw k.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(et $$0, ezs $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.i() == $$2) {
         if ($$2) {
            throw g.create();
         } else {
   ...
   private static int b(et $$0, ezs $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.h() == $$2) {
         if ($$2) {
            throw e.create();
         } else {
   ...
   private static int a(et $$0, ezs $$1, xd $$2) throws CommandSyntaxException {
      if ($$1.c().equals($$2)) {
         throw c.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(et $$0, ezs $$1, n $$2) throws CommandSyntaxException {
      if ($$1.n() == $$2) {
         throw d.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(et $$0, ezs $$1) throws CommandSyntaxException {
      ezx $$2 = $$0.l().aJ();
   ...
   private static int b(et $$0, ezs $$1) {
      ezx $$2 = $$0.l().aJ();
      $$2.d($$1);
   ...
   private static int c(et $$0, ezs $$1) {
   ...
   private static int a(et $$0) {
      Collection<ezs> $$1 = $$0.l().aJ().g();
      if ($$1.isEmpty()) {
         $$0.a(() -> xd.c("commands.team.list.teams.empty"), false);
      } else {
         $$0.a(() -> xd.a("commands.team.list.teams.success", $$1.size(), xg.b($$1, ezs::d)), false);
      }

      return $$1.size();
   }

   private static int b(et $$0, ezs $$1, xd $$2) {
      $$1.b($$2);
      $$0.a(() -> xd.a("commands.team.option.prefix.success", $$2), false);
      return 1;
   }

   private static int c(et $$0, ezs $$1, xd $$2) {
      $$1.c($$2);
