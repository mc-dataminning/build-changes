...
class ape implements Path {
   private static final BasicFileAttributes a = new apc() {
      @Override
   ...
   private static final BasicFileAttributes b = new apc() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ape> c = Comparator.comparing(ape::n);
   ...
   public ape(apg $$0, String $$1, @Nullable ape $$2, aph $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ape a(@Nullable ape $$0, String $$1) {
      return new ape(this.e, $$1, $$0, aph.b);
   }
   ...
   ape a(String $$0) {
      if (a(this.i)) {
         return new ape(this.e, $$0, this, this.i);
      } else if (this.i instanceof aph.a $$1) {
         ape $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ape(this.e, $$0, this, aph.a);
      } else if (this.i instanceof aph.b) {
         return new ape(this.e, $$0, this, aph.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aph $$0) {
      return $$0 == aph.a || $$0 == aph.b;
   }
   ...
   private ape c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ape $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aph.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aph.a i() {
      return this.i instanceof aph.a $$0 ? $$0 : null;
   }
