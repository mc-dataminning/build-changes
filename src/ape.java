...
class ape extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof apd && $$1 instanceof apd && $$0.equals($$1);
   }
   ...
   private static apd a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof apd) {
         return (apd)$$0;
      } else {
