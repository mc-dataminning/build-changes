...
public class ape {
   ...
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(wz.a("commands.worldborder.set.failed.big", 5.999997E7F));
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(wz.a("commands.worldborder.set.failed.far", 2.9999984E7));
                                 ...
                                 .then(
                                    ((RequiredArgumentBuilder)eu.a("distance", DoubleArgumentType.doubleArg(-5.999997E7F, 5.999997E7F))
                                          .executes(
                                             $$0x -> a(
                                                   (et)$$0x.getSource(),
                                                   ((et)$$0x.getSource()).e().C_().i() + DoubleArgumentType.getDouble($$0x, "distance"),
                                                   0L
                                                )
                                          ))
                                       .then(
                                          eu.a("time", IntegerArgumentType.integer(0))
                                             .executes(
                                                $$0x -> a(
                                                      (et)$$0x.getSource(),
                                                      ((et)$$0x.getSource()).e().C_().i() + DoubleArgumentType.getDouble($$0x, "distance"),
                                                      ((et)$$0x.getSource()).e().C_().j() + (long)IntegerArgumentType.getInteger($$0x, "time") * 1000L
                                                   )
                                             )
                                       )
                                 )
   ...
   private static int a(et $$0, float $$1) throws CommandSyntaxException {
      ...
      if ($$2.n() == (double)$$1) {
         ...
         $$2.b((double)$$1);
         $$0.a(() -> wz.a("commands.worldborder.damage.buffer.success", String.format(Locale.ROOT, "%.2f", $$1)), true);
         return (int)$$1;
      }
   }
   ...
   private static int b(et $$0, float $$1) throws CommandSyntaxException {
      ...
      if ($$2.o() == (double)$$1) {
         ...
         $$2.c((double)$$1);
         $$0.a(() -> wz.a("commands.worldborder.damage.amount.success", String.format(Locale.ROOT, "%.2f", $$1)), true);
         return (int)$$1;
      }
   }
   ...
   private static int a(et $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2.q() == $$1) {
         ...
         $$2.b($$1);
         $$0.a(() -> wz.a("commands.worldborder.warning.time.success", $$1), true);
         return $$1;
      }
   }
   ...
   private static int b(et $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2.r() == $$1) {
         ...
         $$2.c($$1);
         $$0.a(() -> wz.a("commands.worldborder.warning.distance.success", $$1), true);
         return $$1;
      }
   }
   ...
   private static int a(et $$0) {
      double $$1 = $$0.l().I().C_().i();
      $$0.a(() -> wz.a("commands.worldborder.get", String.format(Locale.ROOT, "%.0f", $$1)), false);
      return ayo.a($$1 + 0.5);
   }
   ...
   private static int a(et $$0, exb $$1) throws CommandSyntaxException {
      ...
      if ($$2.a() == (double)$$1.i && $$2.b() == (double)$$1.j) {
         ...
         $$0.a(() -> wz.a("commands.worldborder.center.success", String.format(Locale.ROOT, "%.2f", $$1.i), String.format(Locale.ROOT, "%.2f", $$1.j)), true);
         return 0;
      } else {
         throw e.create();
      }
   ...
   private static int a(et $$0, double $$1, long $$2) throws CommandSyntaxException {
      ...
      if ($$4 == $$1) {
         ...
         if ($$2 > 0L) {
            $$3.a($$4, $$1, $$2);
            if ($$1 > $$4) {
               $$0.a(() -> wz.a("commands.worldborder.set.grow", String.format(Locale.ROOT, "%.1f", $$1), Long.toString($$2 / 1000L)), true);
            } else {
               $$0.a(() -> wz.a("commands.worldborder.set.shrink", String.format(Locale.ROOT, "%.1f", $$1), Long.toString($$2 / 1000L)), true);
            }
         } else {
            $$3.a($$1);
            $$0.a(() -> wz.a("commands.worldborder.set.immediate", String.format(Locale.ROOT, "%.1f", $$1)), true);
         }
