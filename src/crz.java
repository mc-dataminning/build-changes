...
public class crz {
   ...
   private final crz.a e;
   private final long f;

   public crz(crz.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public crz a(crz.a $$0) {
      return new crz($$0, this.f);
   }

   public ib<crx> a(ht $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ib<crx> a(double $$0, double $$1, double $$2) {
      int $$3 = in.a(asy.a($$0));
      int $$4 = in.a(asy.a($$1));
      int $$5 = in.a(asy.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = asu.a($$7, $$0);
      double $$10 = b($$7);
      return asy.k($$6 + $$10) + asy.k($$5 + $$9) + asy.k($$4 + $$8);
   }
   ...
   public interface a {
      ib<crx> getNoiseBiome(int var1, int var2, int var3);
   }
}
