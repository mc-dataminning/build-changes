...
public abstract class crz extends bxw {
   public static final bxn bu = bxn.b;
   ...
   public static final ffs bI = new ffs(0.0, 0.6, 0.0);
   public static final bwy bJ = bwy.b(0.6F, 1.8F).b(1.62F).a(bwx.a().a(bww.b, bI));
   private static final Map<byi, bwy> b = ImmutableMap.builder()
      .put(byi.a, bJ)
      .put(byi.c, aD)
      .put(byi.b, bwy.b(0.6F, 0.6F).b(0.4F))
      .put(byi.d, bwy.b(0.6F, 0.6F).b(0.4F))
      .put(byi.e, bwy.b(0.6F, 0.6F).b(0.4F))
      .put(byi.f, bwy.b(0.6F, 1.5F).b(1.27F).a(bwx.a().a(bww.b, bI)))
      .put(byi.h, bwy.c(0.2F, 0.2F).b(1.62F))
      .build();
   private static final akn<Float> c = akr.a(crz.class, akp.d);
   private static final akn<Integer> d = akr.a(crz.class, akp.b);
   protected static final akn<Byte> bK = akr.a(crz.class, akp.a);
   protected static final akn<Byte> bL = akr.a(crz.class, akp.a);
   protected static final akn<ua> bM = akr.a(crz.class, akp.t);
   protected static final akn<ua> bN = akr.a(crz.class, akp.t);
   ...
   private long cs;
   final cry ct;
   protected cxg bP = new cxg();
   public final cwv bQ;
   public cvs bR;
   protected cvo bS = new cvo();
   protected int bT;
   ...
   private boolean cz;
   private daa cA = daa.k;
   private final czx cB = this.g();
   ...
   public crz(djz $$0, iw $$1, float $$2, GameProfile $$3) {
      super(bxe.bT, $$0);
      this.a_($$3.getId());
      this.cy = $$3;
      this.ct = new cry(this, this.bt);
      this.bQ = new cwv(this.ct, !$$0.C, this);
      this.bR = this.bQ;
   ...
   public boolean a(djz $$0, iw $$1, djw $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == djw.d) {
         return true;
         ...
         daa $$3 = this.fb();
         return $$3.f() || !$$3.b(new ebk($$0, $$1, false));
      }
   }

   public static bzb.a fX() {
      return bxw.ee().a(bzc.c, 1.0).a(bzc.v, 0.1F).a(bzc.e).a(bzc.q).a(bzc.g, 4.5).a(bzc.j, 3.0).a(bzc.f).a(bzc.C).a(bzc.z).a(bzc.t).a(bzc.D);
   }
   ...
   public void h() {
      ...
      int $$1 = 29999999;
      double $$2 = azq.a(this.dA(), -2.9999999E7, 2.9999999E7);
      double $$3 = azq.a(this.dG(), -2.9999999E7, 2.9999999E7);
   ...
   private void m() {
      this.a(new bvz(bwb.m, 200, 0, false, false, true));
   }

   private boolean c(czw $$0) {
      for (bxf $$1 : bxf.j) {
         daa $$2 = this.a($$1);
         dij $$3 = $$2.a(kl.D);
   ...
   private byi t() {
      if (this.fR()) {
         ...
         return this.cc() && !this.cw.b ? byi.f : byi.a;
      }
   }

   protected boolean h(byi $$0) {
   ...
   public void k_() {
      ...
      if (this.eG() > 0.0F && !this.Z_()) {
         ...
         List<bwv> $$4 = this.dV().a_(this, $$2);
         List<bwv> $$5 = Lists.newArrayList();
   ...
   private void c(ua $$0) {
      if (!$$0.j() && !$$0.b("Silent", false)) {
         if (this.dV().A.a(200) == 0) {
            bxe<?> $$1 = $$0.<bxe<?>>a("id", bxe.a).orElse(null);
            if ($$1 == bxe.aP && !ckg.a(this.dV(), this)) {
               this.dV().a(null, this.dA(), this.dC(), this.dG(), ckg.a(this.dV(), this.dV().A), this.dm(), 1.0F, ckg.a(this.dV().A));
            }
         }
      }
   }
   ...
   public void a(int $$0, float $$1, daa $$2) {
      this.bp = $$0;
      this.bq = $$1;
      this.br = $$2;
      if (!this.dV().C) {
   ...
   public void a(bvk $$0) {
      super.a($$0);
      this.av();
      if (!this.Z_() && this.dV() instanceof aru $$1) {
         this.b($$1, $$0);
      }

      if ($$0 != null) {
         this.n(
            (double)(-azq.b((this.eM() + this.dL()) * (float) (Math.PI / 180.0)) * 0.1F),
            0.1F,
            (double)(-azq.a((this.eM() + this.dL()) * (float) (Math.PI / 180.0)) * 0.1F)
         );
      } else {
         this.n(0.0, 0.1, 0.0);
      }
   ...
   @Nullable
   public coe a(daa $$0, boolean $$1) {
      return this.a($$0, false, $$1);
   }

   public float c(ebg $$0) {
      float $$1 = this.ct.g().a($$0);
      if ($$1 > 1.0F) {
         $$1 += (float)this.h(bzc.t);
      }

      if (bwa.a(this)) {
         $$1 *= 1.0F + (float)(bwa.b(this) + 1) * 0.2F;
      }

      if (this.b(bwb.d)) {
         float $$2 = switch (this.c(bwb.d).e()) {
            case 0 -> 0.3F;
            case 1 -> 0.09F;
            case 2 -> 0.0027F;
            default -> 8.1E-4F;
      ...
      $$1 *= (float)this.h(bzc.f);
      if (this.a(axl.a)) {
         $$1 *= (float)this.g(bzc.C).g();
      }
   ...
   public void a(ua $$0) {
      ...
      this.bS.a($$0);
      this.cw.b($$0);
      this.g(bzc.v).a((double)this.cw.b());
      ...
      this.cm = $$0.<ffs>a("current_explosion_impact_pos", ffs.a).orElse(null);
   ...
   public void b(ua $$0) {
      ...
      $$0.b("current_explosion_impact_pos", ffs.a, this.cm);
   ...
   public boolean a(aru $$0, bvk $$1) {
      if (super.a($$0, $$1)) {
         ...
         return $$1.a(axh.o) ? !$$0.O().c(djv.L) : false;
      }
   }
   ...
   protected void c(bvk $$0, float $$1) {
      this.a($$0, $$1, new bxf[]{bxf.c, bxf.d, bxf.e, bxf.f});
   }

   @Override
   protected void d(bvk $$0, float $$1) {
      this.a($$0, $$1, new bxf[]{bxf.f});
   }
   ...
   protected void c(aru $$0, bvk $$1, float $$2) {
      if (!this.a($$0, $$1)) {
         ...
         if ($$4 > 0.0F && $$4 < 3.4028235E37F) {
            this.a(axb.L, Math.round($$4 * 10.0F));
         }
         ...
         if (var8 != 0.0F) {
            ...
            if (var8 < 3.4028235E37F) {
               this.a(axb.J, Math.round(var8 * 10.0F));
            }
   ...
   public but a(bwv $$0, bus $$1) {
      if (this.Z_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.f() && $$0 instanceof bxw) {
               if (this.fV()) {
                  $$2 = $$3;
               }

               but $$5 = $$2.a(this, (bxw)$$0, $$1);
               if ($$5.a()) {
                  this.dV().a(egg.r, $$0.dt(), egg.a.a(this));
                  if ($$2.f() && !this.fV()) {
                     this.a($$1, daa.k);
                  }
   ...
   protected ffs a(ffs $$0, bya $$1) {
      float $$2 = this.dP();
      if (!this.cw.b && !($$0.e > 0.0) && ($$1 == bya.a || $$1 == bya.b) && this.ga() && this.I($$2)) {
         double $$3 = $$0.d;
         double $$4 = $$0.f;
         double $$5 = 0.05;
   ...
   private boolean q(double $$0, double $$1, double $$2) {
      ffn $$3 = this.cR();
      return this.dV().a(this, new ffn($$3.a + 1.0E-7 + $$0, $$3.b - $$2 - 1.0E-7, $$3.c + 1.0E-7 + $$1, $$3.d - 1.0E-7 + $$0, $$3.b, $$3.f - 1.0E-7 + $$1));
   }

   public void e(bwv $$0) {
      if ($$0.cB()) {
         if (!$$0.v(this)) {
            float $$1 = this.fv() ? this.bq : (float)this.h(bzc.c);
            daa $$2 = this.dZ();
            bvk $$3 = Optional.ofNullable($$2.h().a(this)).orElse(this.dW().a(this));
            float $$4 = this.a($$0, $$1, $$3) - $$1;
            float $$5 = this.H(0.5F);
            $$1 *= 0.2F + $$5 * $$5 * 0.8F;
            $$4 *= $$5;
            this.gE();
            if ($$0.an().a(axj.H) && $$0 instanceof csu $$6 && $$6.a(csv.c, this, this, true)) {
               this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uR, this.dm());
               return;
            }
            ...
            if ($$1 > 0.0F || $$4 > 0.0F) {
               ...
               boolean $$8;
               if (this.ci() && $$7) {
                  this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uQ, this.dm(), 1.0F, 1.0F);
                  $$8 = true;
               } else {
                  $$8 = false;
               }
               ...
               $$1 += $$2.h().a($$0, $$1, $$3);
               boolean $$10 = $$7 && this.Z > 0.0 && !this.aH() && !this.d_() && !this.bi() && !this.b(bwb.o) && !this.bY() && $$0 instanceof bxw && !this.ci();
               if ($$10) {
                  $$1 *= 1.5F;
               }
               ...
               if ($$7 && !$$10 && !$$8 && this.aH()) {
                  ...
                  if ($$13 < azq.k($$14) && this.b(bus.a).a(axo.bI)) {
                     $$12 = true;
                  }
               }

               float $$15 = 0.0F;
               if ($$0 instanceof bxw $$16) {
                  $$15 = $$16.eG();
               }
               ...
               if ($$18) {
                  ...
                  if ($$19 > 0.0F) {
                     if ($$0 instanceof bxw $$20) {
                        $$20.p(
                           (double)($$19 * 0.5F), (double)azq.a(this.dL() * (float) (Math.PI / 180.0)), (double)(-azq.b(this.dL() * (float) (Math.PI / 180.0)))
                        );
                     } else {
                        $$0.i(
                           (double)(-azq.a(this.dL() * (float) (Math.PI / 180.0)) * $$19 * 0.5F),
                           0.1,
                           (double)(azq.b(this.dL() * (float) (Math.PI / 180.0)) * $$19 * 0.5F)
                        );
                     }
                  ...
                  if ($$12) {
                     float $$21 = 1.0F + (float)this.h(bzc.D) * $$1;

                     for (bxw $$23 : this.dV().a(bxw.class, $$0.cR().c(1.0, 0.25, 1.0))) {
                        if ($$23 != this && $$23 != $$0 && !this.s($$23)) {
                           if ($$23 instanceof cnt) {
                              cnt $$24 = (cnt)$$23;
                              if ($$24.t()) {
                                 continue;
                              }
                           ...
                           if (this.g($$23) < 9.0) {
                              ...
                              djz var22 = this.dV();
                              if (var22 instanceof aru) {
                                 aru $$26 = (aru)var22;
                                 if ($$23.a($$26, $$3, $$25)) {
                                    $$23.p(0.4F, (double)azq.a(this.dL() * (float) (Math.PI / 180.0)), (double)(-azq.b(this.dL() * (float) (Math.PI / 180.0))));
                                    dgp.a($$26, (bwv)$$23, $$3);
                                 }
                              }
                           }
                     ...
                     this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uT, this.dm(), 1.0F, 1.0F);
                     this.gf();
                  }

                  if ($$0 instanceof arv && $$0.T) {
                     ((arv)$$0).f.b(new afj($$0));
                     $$0.T = false;
                     $$0.i($$17);
                  }
                  ...
                  if ($$10) {
                     this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uP, this.dm(), 1.0F, 1.0F);
                     this.b($$0);
                  }

                  if (!$$10 && !$$12) {
                     if ($$7) {
                        this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uS, this.dm(), 1.0F, 1.0F);
                     } else {
                        this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uU, this.dm(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  boolean $$28 = false;
                  if (this.dV() instanceof aru $$29) {
                     if ($$27 instanceof bxw $$30) {
                        $$28 = $$2.a($$30, this);
                     }
                  ...
                  if (!this.dV().C && !$$2.f() && $$27 instanceof bxw) {
                     if ($$28) {
                        $$2.b((bxw)$$27, this);
                     }
                  ...
                  if ($$0 instanceof bxw) {
                     float $$31 = $$15 - ((bxw)$$0).eG();
                     this.a(axb.G, Math.round($$31 * 10.0F));
                     if (this.dV() instanceof aru && $$31 > 2.0F) {
                        int $$32 = (int)((double)$$31 * 0.5);
                        ((aru)this.dV()).a(lz.g, $$0.dA(), $$0.e(0.5), $$0.dG(), $$32, 0.1, 0.0, 0.1, 0.2);
                     }
                  }

                  this.G(0.1F);
               } else {
                  this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.uR, this.dm(), 1.0F, 1.0F);
               }
            }
         }
      }
   ...
   public void gf() {
      double $$0 = (double)(-azq.a(this.dL() * (float) (Math.PI / 180.0)));
      double $$1 = (double)azq.b(this.dL() * (float) (Math.PI / 180.0));
      if (this.dV() instanceof aru) {
         ((aru)this.dV()).a(lz.am, this.dA() + $$0, this.e(0.5), this.dG() + $$1, 0, $$0, 0.0, $$1, 0.0);
      }
   }
   ...
   public void a(daa $$0, daa $$1, cwc $$2) {
   }
   ...
   public boolean a(double $$0, float $$1, bvk $$2) {
      if (this.cw.c) {
         ...
         if ($$0 >= 2.0) {
            this.a(axb.t, (int)Math.round($$0 * 100.0));
         }
   ...
   @Override
   public bxw.a eO() {
      return new bxw.a(awr.vf, awr.uV);
   }
   ...
   public void d(int $$0) {
      ...
      this.cg = azq.a(this.cg + $$0, 0, Integer.MAX_VALUE);
   ...
   public void c(int $$0) {
      ...
      if ($$0 > 0 && this.cf % 5 == 0 && (float)this.cx < (float)this.af - 100.0F) {
         ...
         this.dV().a(null, this.dA(), this.dC(), this.dG(), awr.ve, this.dm(), $$1 * 0.75F, 1.0F);
         this.cx = this.af;
      }
   }
   ...
   public boolean a(iw $$0, jc $$1, daa $$2) {
      if (this.cw.e) {
         return true;
      } else {
         iw $$3 = $$0.a($$1.g());
         ebk $$4 = new ebk(this.dV(), $$3, false);
         return $$2.a($$4);
      }
   }
   ...
   protected int e(aru $$0) {
      return !$$0.O().c(djv.e) && !this.Z_() ? Math.min(this.cf * 7, 100) : 0;
   }
   ...
   @Override
   protected bwv.c bf() {
      return this.cw.b || this.aH() && this.cf() ? bwv.c.a : bwv.c.d;
   }
   ...
   private void d(ua $$0) {
      if (!this.dV().C && !$$0.j()) {
         bxe.a($$0, this.dV(), bxd.r).ifPresent($$0x -> {
            if ($$0x instanceof bys $$1) {
               $$1.i(this);
            }
   ...
   @Override
   public xc m_() {
      xq $$0 = fgs.a(this.cq(), this.ai());
      return this.a($$0);
   }

   private xq a(xq $$0) {
      String $$1 = this.gi().getName();
      return $$0.a($$1x -> $$1x.a(new xa.g("/tell " + $$1 + " ")).a(this.cQ()).a($$1));
   }
      ...
      if ($$0 == 499) {
         ...
         if ($$1 >= 0 && $$1 < 4) {
            return new byn() {
               @Override
               public daa a() {
                  return crz.this.bQ.r().a($$1);
               }

               @Override
               public boolean a(daa $$0) {
                  crz.this.bQ.r().a($$1, $$0);
                  crz.this.bQ.a(crz.this.ct);
                  return true;
               }
            };
         } else if ($$0 >= 0 && $$0 < this.ct.i().size()) {
            return byn.a(this.ct, $$0);
         } else {
            int $$2 = $$0 - 200;
            return $$2 >= 0 && $$2 < this.bP.b() ? byn.a(this.bP, $$2) : super.a_($$0);
         }
      }
   }
   ...
   @Override
   public bxn fy() {
      return this.al.a(bL) == 0 ? bxn.a : bxn.b;
   }

   public void b(bxn $$0) {
      this.al.a(bL, (byte)($$0 == bxn.a ? 0 : 1));
   }
   ...
   public float gD() {
      return (float)(1.0 / this.h(bzc.e) * 20.0);
   }

   public float H(float $$0) {
      return azq.a(((float)this.aS + $$0) / this.gD(), 0.0F, 1.0F);
   }
   ...
   public ImmutableList<byi> fO() {
      return ImmutableList.of(byi.a, byi.f, byi.d);
   }
   ...
   public daa d(daa $$0) {
      if (!($$0.h() instanceof dav)) {
         ...
         if (!$$2.f()) {
            ...
            return this.fV() ? new daa(dae.pk) : daa.k;
         }
      }
   }
   ...
   public ffs v(float $$0) {
      double $$1 = 0.22 * (this.fy() == bxn.b ? -1.0 : 1.0);
      float $$2 = azq.h($$0 * 0.5F, this.dN(), this.O) * (float) (Math.PI / 180.0);
      float $$3 = azq.h($$0, this.aW, this.aV) * (float) (Math.PI / 180.0);
      if (this.fJ() || this.fv()) {
         ffs $$4 = this.h($$0);
         ffs $$5 = this.dy();
         double $$6 = $$5.j();
         ...
         return this.p($$0).e(new ffs($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.ck()) {
         return this.p($$0).e(new ffs($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cR().c() - 1.0;
         double $$13 = this.ch() ? -0.2 : 0.07;
         return this.p($$0).e(new ffs($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean gH() {
      return this.fz() && this.fB().a(dae.sf);
   }
   ...
   public boolean b(bwv $$0, double $$1) {
      return $$0.dQ() ? false : this.a($$0.cR(), $$1);
   }

   public boolean a(ffn $$0, double $$1) {
      double $$2 = this.gM() + $$1;
   ...
   public boolean a(iw $$0, double $$1) {
      double $$2 = this.gL() + $$1;
      return new ffn($$0).e(this.bD()) < $$2 * $$2;
   }
   ...
   public static enum a {
      a,
      b(xc.c("block.minecraft.bed.no_sleep")),
      c(xc.c("block.minecraft.bed.too_far_away")),
      d(xc.c("block.minecraft.bed.obstructed")),
      e,
      f(xc.c("block.minecraft.bed.not_safe"));
