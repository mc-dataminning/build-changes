...
public class dac extends cyu {
   ...
   public dac(wy $$0, wy $$1, wy $$2, wy $$3, List<alg> $$4, List<alg> $$5, cyu.a $$6) {
      super($$6);
      this.N = $$0;
      this.O = $$1;
      this.P = $$2;
   ...
   public static dac a(cyu.a $$0) {
      return new dac(p, q, r, s, o(), p(), $$0);
   }

   public static dac b(cyu.a $$0) {
      return new dac(t, u, v, w, q(), r(), $$0);
   }
