...
public class bdw implements bdx {
   ...
   private static final bdw j = new bdw();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bdv $$0) {
      URL $$1 = bdw.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bdv $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bdz a = new bdz(() -> bdw.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bdw.this.k && $$0.getState() == RecordingState.STOPPED) {
