...
public class bdw extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(biz.F.typeName(), bku.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(biz.D), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(biz.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
