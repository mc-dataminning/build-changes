...
public class bdw extends bgy {
   public bdw(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bic.C, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bic.E.typeName(), bju.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bic.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bic.E.typeName(), "minecraft:saddle"));
