...
public class cxv extends dbn {
   public static final MapCodec<cxv> b = b(cxv::new);
   ...
   protected cxv(dhm.d $$0) {
      super($$0);
      this.k(this.E.b().a(a, ib.b));
   }

   @Override
   public dhn a(cnw $$0) {
      ib $$1 = $$0.k();
      dhn $$2 = $$0.q().a_($$0.a().a($$1.g()));
   ...
   public void a(dhn $$0, csf $$1, hx $$2, atw $$3) {
      ...
      if ($$3.a(5) == 0) {
         $$1.a(jw.u, $$5 + (double)$$4.j() * $$8, $$6 + (double)$$4.k() * $$8, $$7 + (double)$$4.l() * $$8, $$3.k() * 0.005, $$3.k() * 0.005, $$3.k() * 0.005);
      }
   }
