...
public class esx implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<esx.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public esx(List<esx.a> $$0) {
      this.c = $$0;
   }
   ...
   public static esx a(BufferedReader $$0) {
      return new esx($$0.lines().flatMap($$0x -> esx.a.a($$0x).stream()).toList());
   }

   public static record a(esx.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<esx.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new esx.a(esx.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new esx.a(esx.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new esx.a(esx.b.b, $$3));
      ...
      static esx.a b(String $$0) {
         return new esx.a(esx.b.a, "glob:" + $$0);
      }

      static esx.a c(String $$0) {
         return new esx.a(esx.b.a, "regex:" + $$0);
      }

      static esx.a d(String $$0) {
         return new esx.a(esx.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      esx.b a = FileSystem::getPathMatcher;
      esx.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
