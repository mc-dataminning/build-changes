...
public class esx extends api<Map<String, List<esx.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<esx.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(esx.a::a),
                     Codec.LONG.fieldOf("period").forGetter(esx.a::b),
                     Codec.STRING.fieldOf("title").forGetter(esx.a::c),
                     Codec.STRING.fieldOf("message").forGetter(esx.a::d)
                  )
                  .apply($$0, esx.a::new)
         )
         .listOf()
   ...
   public esx(agg $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<esx.a>> a(apd $$0, bfh $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<esx.a>> $$0, apd $$1, bfh $$2) {
      List<esx.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<esx.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<esx.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<esx.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public esx.b a(List<esx.a> $$0, long $$1) {
         this.cancel();
         return new esx.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (esx.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> ewt.a(esr.N().ax(), ewt.a.g, ur.a($$2.c, $$3), ur.a($$2.d, $$3)));
                  return;
               }
            }
         }
