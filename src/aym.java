...
public class aym extends bct {
   public aym(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bdt.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bdt.s, "minecraft:jukebox");
