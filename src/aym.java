...
public class aym {
   ...
   public static final Codec<Vector4f> d = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ad.a($$0, 4).map($$0x -> new Vector4f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3))),
         $$0 -> List.of($$0.x(), $$0.y(), $$0.z(), $$0.w())
      );
   public static final Codec<Quaternionf> e = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ad.a($$0, 4).map($$0x -> new Quaternionf((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3)).normalize()),
         $$0 -> List.of($$0.x, $$0.y, $$0.z, $$0.w)
      );
   ...
   public static Codec<Matrix4f> h = Codec.FLOAT.listOf().comapFlatMap($$0 -> ad.a($$0, 16).map($$0x -> {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> axo.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.BYTE
      .flatComapMap(
         UnsignedBytes::toInt,
         $$0 -> $$0 > 255 ? DataResult.error(() -> "Unsigned byte was too large: " + $$0 + " > 255") : DataResult.success($$0.byteValue())
      );
   public static final Codec<Integer> k = a(0, Integer.MAX_VALUE, $$0 -> "Value must be non-negative: " + $$0);
   public static final Codec<Integer> l = a(1, Integer.MAX_VALUE, $$0 -> "Value must be positive: " + $$0);
   public static final Codec<Float> m = a(0.0F, Float.MAX_VALUE, $$0 -> "Value must be non-negative: " + $$0);
   public static final Codec<Float> n = b(0.0F, Float.MAX_VALUE, $$0 -> "Value must be positive: " + $$0);
   public static final Codec<Pattern> o = Codec.STRING.comapFlatMap($$0 -> {
      try {
   ...
   public static final Codec<Instant> p = a(DateTimeFormatter.ISO_INSTANT).xmap(Instant::from, Function.identity());
   public static final Codec<byte[]> q = Codec.STRING.comapFlatMap($$0 -> {
      try {
   ...
   public static final Codec<String> r = Codec.STRING
      .comapFlatMap($$0 -> DataResult.success(StringEscapeUtils.unescapeJava($$0)), StringEscapeUtils::escapeJava);
   public static final Codec<aym.c> s = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alc.d($$0.substring(1)).map($$0x -> new aym.c($$0x, true)) : alc.d($$0).map($$0x -> new aym.c($$0x, false)), aym.c::c
      );
   public static final Function<Optional<Long>, OptionalLong> t = $$0 -> $$0.map(OptionalLong::of).orElseGet(OptionalLong::empty);
   public static final Function<OptionalLong, Optional<Long>> u = $$0 -> $$0.isPresent() ? Optional.of($$0.getAsLong()) : Optional.empty();
   public static final Codec<BitSet> v = Codec.LONG_STREAM.xmap($$0 -> BitSet.valueOf($$0.toArray()), $$0 -> Arrays.stream($$0.toLongArray()));
   private static final Codec<Property> C = RecordCodecBuilder.create(
      $$0 -> $$0.group(
   ...
   public static final Codec<PropertyMap> w = Codec.either(Codec.unboundedMap(Codec.STRING, Codec.STRING.listOf()), C.listOf()).xmap($$0 -> {
   ...
   public static final Codec<String> x = Codec.string(0, 16)
      .validate($$0 -> baa.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> D = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kh.e.fieldOf("id").forGetter(GameProfile::getId), x.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   public static final Codec<GameProfile> y = RecordCodecBuilder.create(
      $$0 -> $$0.group(D.forGetter(Function.identity()), w.lenientOptionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties))
            .apply($$0, ($$0x, $$1) -> {
               $$1.forEach(($$1x, $$2) -> $$0x.getProperties().put($$1x, $$2));
               return $$0x;
            })
   );
   public static final Codec<String> z = Codec.STRING
      .validate($$0 -> $$0.isEmpty() ? DataResult.error(() -> "Expected non-empty string") : DataResult.success($$0));
   public static final Codec<Integer> A = Codec.STRING.comapFlatMap($$0 -> {
      int[] $$1 = $$0.codePoints().toArray();
      return $$1.length != 1 ? DataResult.error(() -> "Expected one codepoint, got: " + $$0) : DataResult.success($$1[0]);
   }, Character::toString);
   public static Codec<String> B = Codec.STRING
      .validate($$0 -> !alc.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> aym.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new aym.b<>($$0, $$1);
   }
   ...
   public static <T> Codec<jr<T>> b(Codec<jr<T>> $$0) {
      return $$0.validate(
   ...
   public static record b<K, V>(Codec<K> a, Codec<V> b) implements Codec<Map<K, V>>, BaseMapCodec<K, V> {
   ...
   public static record c(alc a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
