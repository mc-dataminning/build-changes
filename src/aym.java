...
public class aym extends avl {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), aym::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", aym::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", aym::k);
         $$0 = this.a($$0, "minecraft:fox", aym::j);
         $$0 = this.a($$0, "minecraft:item", aym::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", aym::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", aym::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", aym::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", aym::e);
         return this.a($$0, "minecraft:piglin", aym::d);
      });
   }
