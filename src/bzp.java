public class bzp implements bzl {
   ...
   public void a() {
      if (this.k == bzp.a.c) {
         ...
         $$2 *= $$4;
         $$3 *= $$4;
         float $$5 = ayy.a(this.d.dF() * (float) (Math.PI / 180.0));
         float $$6 = ayy.b(this.d.dF() * (float) (Math.PI / 180.0));
         float $$7 = $$2 * $$6 - $$3 * $$5;
         float $$8 = $$3 * $$6 + $$2 * $$5;
         if (!this.b($$7, $$8)) {
            this.i = 1.0F;
         ...
         iz $$14 = this.d.dp();
         dsb $$15 = this.d.dP().a_($$14);
         ewj $$16 = $$15.k(this.d.dP(), $$14);
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         eoh $$3 = $$2.o();
         if ($$3 != null && $$3.a(this.d, iz.a(this.d.du() + (double)$$0, (double)this.d.dv(), this.d.dA() + (double)$$1)) != eol.c) {
            return false;
         }
      }
