...
public class bnc {
   ...
   private static void a(bnk $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnf $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dty, bno<bne>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bno)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dty, bno<bne>> $$3 : $$0) {
         bno<bne> $$4 = (bno<bne>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dty)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnm> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bmr.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bna $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnc::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnc::a));
      return $$1;
   }

   private JsonElement a(bnh.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bna $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnc::a));
      $$1.add("received", this.a($$0.k(), bnc::a));
      return $$1;
   }

   private <T> JsonElement a(bnj<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bng> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bng>, ToDoubleFunction<bng>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bng::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bng::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bng::c));
      return $$1;
   }
}
