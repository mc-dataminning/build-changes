...
public class bnc {
   ...
   private bnc(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bnc a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bnc($$0, $$1);
   }

   public bnc.d a() throws IOException {
      bnc.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bnc.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bnc.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bnc.c $$3 = bnc.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bnc.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bnc.a($$0, $$3);
            }
         }
   ...
   public bnc.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bnc.c> $$2 = this.a().c();
      ...
      bnc.e $$4 = new bnc.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bnc.c b) implements bnc.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bnc.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bnc.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bnc.b> {
      private final List<bnc.b> a;

      d(List<bnc.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bnc.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bnc.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bnc.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bnc.d a() {
         ListIterator<bnc.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bnc.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bnc.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bnc.b> b() {
         return this.a.stream();
      }

      public Set<bnc.c> c() {
         return this.a.stream().map(bnc.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bnc.c b) implements bnc.b {
