...
public class bxz extends bxa<bvj> {
   ...
   protected boolean c(ard $$0, bvj $$1, long $$2) {
   ...
   private void a(bvj $$0, ji $$1) {
      $$0.eb().a(cel.m, new ceo($$1, this.g, 0));
   }

   private boolean b(ard $$0, bvj $$1) {
      return this.c($$0, $$1) || this.a($$1).isPresent();
   }

   private boolean c(ard $$0, bvj $$1) {
      ji $$2 = $$1.dv();
      ji $$3 = $$2.e();
      return this.a($$0, $$2) || this.a($$0, $$3);
   }

   private boolean d(ard $$0, bvj $$1) {
   ...
   private Optional<ji> a(bvj $$0) {
      return $$0.eb().c(cel.w);
   }

   private boolean e(ard $$0, bvj $$1) {
      return !this.c($$0, $$1) && this.i <= 0;
   }

   private boolean f(ard $$0, bvj $$1) {
