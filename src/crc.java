public class crc extends cps {
   ...
   public crc(int $$0, cmu $$1) {
      this($$0, $$1, new cmf($$1.l));
   }

   public crc(int $$0, cmu $$1, dbr $$2) {
      super(cra.t, $$0);
      this.v = $$2;
      this.w = new crb($$2);
   ...
   private void r() {
      if (!this.v.gu()) {
         bsq $$0 = (bsq)this.v;
         $$0.dQ().a($$0.dv(), $$0.dx(), $$0.dB(), this.v.gq(), avp.g, 1.0F, 1.0F, false);
      }
   }
