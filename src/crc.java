...
public class crc {
   ...
   public static OptionalInt a(ars $$0, iv $$1, art $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.Z().map(crc::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<crc> $$4 = $$3.stream().flatMap($$0x -> $$0x.Z().stream()).max(Comparator.comparingInt(crc::c));
            if ($$4.isPresent()) {
               crc $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(ars $$0, iv $$1) {
      ffl $$2 = ffl.a(ffq.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(cra.class, $$2).isEmpty();
   }

   private static List<art> b(ars $$0, iv $$1) {
      ffq $$2 = ffq.b($$1);
      return $$0.a($$1x -> !$$1x.Z_() && $$1x.dt().a((jp)$$2, 16.0) && $$1x.bJ());
   }
