...
public class crc {
   ...
   public static boolean a(dfr $$0, bvh $$1, fav $$2) {
      for (fbu $$4 : $$0.e($$1, $$2)) {
         if (!$$4.c()) {
            return false;
         }
   ...
   public static boolean a(dfr $$0, fba $$1, bvh $$2, bvt $$3) {
   ...
   @Nullable
   public static fba a(bus<?> $$0, dfr $$1, ji $$2, boolean $$3) {
      if ($$3 && $$0.a($$1.a_($$2))) {
         return null;
      } else {
         ...
         if (!a($$4)) {
            ...
            if ($$0 != bus.bR || !$$1.a_($$2).a(awp.ct) && !$$1.a_($$2.d()).a(awp.ct)) {
