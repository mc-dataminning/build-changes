...
public class crc implements diu {
   ...
   private void a(arq $$0, crb $$1, int $$2) {
      iv $$3 = this.a($$0, $$1.du(), $$2);
      if ($$3 != null) {
         clt $$4 = bwr.by.a($$0, $$3, bwq.h);
         if ($$4 != null) {
            $$4.a_($$1, true);
         }
      }
