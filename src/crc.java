...
public class crc {
   ...
   public static record b(long b, long c) {
      public static final Codec<crc.b> a = arg.a(
   ...
   static class g {
      ...
      private static crc.g.a a(List<crc.d> $$0, crc.f $$1, int $$2, int $$3) {
         double $$4 = arx.k(2500.0);
         int $$5 = 2;
         long $$6 = (long)((double)arx.k(10000.0F) * Math.pow((double)(arx.a((long)$$2) + arx.a((long)$$3)) / $$4, 2.0));
         crc.h $$7 = $$1.a(hs.a($$2), 0, hs.a($$3));
