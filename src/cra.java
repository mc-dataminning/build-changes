...
public class cra extends cpv {
   ...
   private final cqg p;
   final cqn q = cqn.a();
   private List<ji<doy>> r = List.of();
   Runnable s = () -> {
   };
   private final jj<doy> t;
   final crq u;
   final crq v;
   private final crq w;
   private final crq x;
   long y;
   private final bqo z = new bre(3) {
      @Override
      public void e() {
         super.e();
         cra.this.a(this);
   ...
   public cra(int $$0, cmx $$1) {
      this($$0, $$1, cqg.a);
   }

   public cra(int $$0, cmx $$1, final cqg $$2) {
      super(crc.s, $$0);
      this.p = $$2;
   ...
   private List<ji<doy>> c(cuq $$0) {
      if ($$0.e()) {
         return this.t.a(awn.a).<List<ji<doy>>>map(ImmutableList::copyOf).orElse(ImmutableList.of());
      } else {
         return $$0.g() instanceof csm $$1 ? this.t.a($$1.b()).<List<ji<doy>>>map(ImmutableList::copyOf).orElse(ImmutableList.of()) : List.of();
      }
   }
   ...
   private void a(ji<doy> $$0) {
      ...
      if (!$$1.e() && !$$2.e()) {
         $$3 = $$1.c(1);
         ctj $$4 = ((ctk)$$2.g()).c();
         $$3.a(km.X, doz.a, $$2x -> new doz.a().a($$2x).a($$0, $$4).a());
      }
