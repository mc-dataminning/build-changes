...
public class ip implements ig<StringArgumentType, ip.a> {
   ...
   public ip.a a(StringArgumentType $$0) {
      return new ip.a($$0.getType());
   }

   public final class a implements ig.a<StringArgumentType> {
      final StringType b;
      ...
      public StringArgumentType a(ef $$0) {
      ...
      @Override
      public ig<StringArgumentType, ?> a() {
         return ip.this;
      }
   }
}
