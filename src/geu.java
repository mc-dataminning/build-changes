...
public class geu extends gda<gzj> {
   private static final int a = 7;
   private final ggc[] b = new ggc[7];
   private final ggc[] c = new ggc[3];
   ...
   public static ggi a() {
      ...
      for (int $$4 = 0; $$4 < 7; $$4++) {
         $$1.a(
            b($$4),
            ggh.c().a(e[$$4][0], e[$$4][1]).a((float)d[$$4][0] * -0.5F, 0.0F, (float)d[$$4][2] * -0.5F, (float)d[$$4][0], (float)d[$$4][1], (float)d[$$4][2]),
            gge.a(0.0F, (float)(24 - d[$$4][1]), $$3)
         );
         $$2[$$4] = $$3;
         if ($$4 < 6) {
      ...
      $$1.a(a(0), ggh.c().a(20, 0).a(-5.0F, 0.0F, (float)d[2][2] * -0.5F, 10.0F, 8.0F, (float)d[2][2]), gge.a(0.0F, 16.0F, $$2[2]));
      $$1.a(a(1), ggh.c().a(20, 11).a(-3.0F, 0.0F, (float)d[4][2] * -0.5F, 6.0F, 4.0F, (float)d[4][2]), gge.a(0.0F, 20.0F, $$2[4]));
      $$1.a(a(2), ggh.c().a(20, 18).a(-3.0F, 0.0F, (float)d[4][2] * -0.5F, 6.0F, 5.0F, (float)d[1][2]), gge.a(0.0F, 19.0F, $$2[1]));
