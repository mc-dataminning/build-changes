...
public class geu extends gey {
   ...
   private static final eum k = new eum(0.0, -0.32F, 0.073F);
   private final Map<dsq, geu.a> l;

   public geu(gel.a $$0) {
      super($$0);
      this.l = dsq.a().collect(ImmutableMap.toImmutableMap($$0x -> $$0x, $$1 -> new geu.a($$0.a(fvv.b($$1)))));
   }
