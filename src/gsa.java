public abstract class gsa extends grw {
   private static final float o = 0.0F;
   private static final float p = 1.2F;
   private static final float q = 0.0F;
   protected final cfg n;
   private boolean r;

   public gsa(cfg $$0, avz $$1, awb $$2) {
      super($$1, $$2, gsn.t());
      this.n = $$0;
   ...
   public void q() {
      ...
      if (!this.n.dK() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = ayz.i(ayz.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = ayz.i(ayz.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
