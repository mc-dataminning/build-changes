...
public class gsa extends MinecraftServer {
   ...
   public gsa(Thread $$0, fdz $$1, eov.c $$2, ath $$3, alj $$4, alg $$5, aqw $$6) {
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (aqn $$1 : Lists.newArrayList(this.ah().t())) {
   ...
   @Override
   public dau bf() {
      return this.r() ? (dau)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
