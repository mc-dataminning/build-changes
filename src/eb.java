...
public class eb extends dz<eb.a> {
   ...
   public void a(ard $$0, dwv $$1) {
      this.a($$0, $$1x -> $$1x.a($$1));
   }

   public static record a(Optional<bi> b, Optional<jr<djk>> c, Optional<ef> d) implements dz.a {
      ...
      private static DataResult<eb.a> a(eb.a $$0) {
         return $$0.c
            .<DataResult<eb.a>>flatMap(
               $$1 -> $$0.d.<String>flatMap($$1x -> $$1x.a(((djk)$$1.a()).l())).map($$1x -> DataResult.error(() -> "Block" + $$1 + " has no property " + $$1x))
            )
            .orElseGet(() -> DataResult.success($$0));
      }

      public static aq<eb.a> a(djk $$0) {
