...
public class eb extends dz<eb.a> {
   ...
   public void a(are $$0, dwy $$1) {
      this.a($$0, $$1x -> $$1x.a($$1));
   }

   public static record a(Optional<bi> b, Optional<jr<djn>> c, Optional<ef> d) implements dz.a {
      public static final Codec<eb.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     bx.b.optionalFieldOf("player").forGetter(eb.a::a),
                     mb.e.r().optionalFieldOf("block").forGetter(eb.a::b),
      ...
      private static DataResult<eb.a> a(eb.a $$0) {
         return $$0.c
            .<DataResult<eb.a>>flatMap(
               $$1 -> $$0.d.<String>flatMap($$1x -> $$1x.a(((djn)$$1.a()).l())).map($$1x -> DataResult.error(() -> "Block" + $$1 + " has no property " + $$1x))
            )
            .orElseGet(() -> DataResult.success($$0));
      }

      public static aq<eb.a> a(djn $$0) {
