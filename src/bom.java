...
public abstract class bom<R extends Runnable> implements bnu, boo<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bom(String $$0) {
      this.b = $$0;
      bns.a.a(this);
   }
   ...
   @Override
   public List<bnr> bu() {
      return ImmutableList.of(bnr.a(this.b + "-pending-tasks", bnq.b, this::bw));
   }
}
