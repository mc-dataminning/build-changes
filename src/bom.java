...
public class bom {
   ...
   public static bmq<blh> a(float $$0) {
      Long2LongMap $$1 = new Long2LongOpenHashMap();
      MutableLong $$2 = new MutableLong(0L);
      return bqb.a(
         (Function<bqb.b<blh>, ? extends App<bqb.c<blh>, bqe<blh>>>)($$3 -> $$3.group($$3.c(btz.m), $$3.c(btz.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.V() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        bvx $$7 = $$4x.w();
                        Optional<ht> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(bwb.n), $$5.dl(), 48, bvx.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dl()) <= 4.0)) {
                           ...
                           Set<Pair<ib<bwa>, ht>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(bwb.n), $$10, $$5.dl(), 48, bvx.b.c).collect(Collectors.toSet());
                           ecv $$12 = bmi.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ht $$13 = $$12.l();
                              Optional<ib<bwa>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new buc($$13, $$0, 1));
                                 aci.c($$4x, $$13);
                              }
