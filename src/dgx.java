...
public class dgx extends dmz {
   ...
   protected static final ext e = dfy.a(3.0, 0.0, 3.0, 13.0, 16.0, 13.0);
   private static final Map<Integer, ext> i = Maps.newHashMap(
      ImmutableMap.of(
         0,
   ...
   private boolean a(cmx $$0, eww $$1, drs $$2, cuq $$3) {
   ...
   public dtc a(cyd $$0) {
      ...
      return this.o().a(c, Boolean.valueOf($$7)).a(b, Integer.valueOf($$10)).a(f, Boolean.valueOf($$2.a() == epd.c));
   }
