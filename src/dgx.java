...
public class dgx implements dhe.c {
   ...
   private final ObjectListIterator<dgx.a> h;
   private final ObjectListIterator<dtc> i;

   public static dgx a(cne $$0, clt $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<dgx.a> $$4 = new ObjectArrayList(10);
      ObjectList<dtc> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != dsl.a).forEach($$5x -> {
         dsl $$6 = $$5x.h().d();
         ...
         for (dse $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof drw) {
                  ...
                  $$4.add(new dgx.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new dgx($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public dgx(ObjectListIterator<dgx.a> $$0, ObjectListIterator<dtc> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(drs a, dsl b, int c) {
   }
}
