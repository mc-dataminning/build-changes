...
public abstract class cav extends cai {
   ...
   public cav(btt $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cav(btt $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cai.a.a, cai.a.c));
   }
   ...
   protected abstract boolean a(dbw var1, iz var2);
}
