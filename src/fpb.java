...
public class fpb extends fot<cqu> implements fqv {
   private float D;
   private float E;
   ...
   public void E() {
      if (this.m.q.f()) {
         this.m.a(new fop(this.m.s, this.m.s.cz.x(), this.m.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         ...
         this.c(new fhp(this.z + 104, this.o / 2 - 22, 20, 18, fqp.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.n, this.c);
   ...
   public static void a(fgq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bto $$9) {
   ...
   public static void a(fgq $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bto $$7) {
      $$0.c().a();
