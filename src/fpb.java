...
public class fpb extends fop {
   private static final fqf d = new fqf(aku.b("widget/text_field"), aku.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayl> D = ($$0x, $$1x) -> ayl.forward($$0x, xl.a);
   @Nullable
   private wo E;
   private long F = af.c();

   public fpb(fob $$0, int $$1, int $$2, wo $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fpb(fob $$0, int $$1, int $$2, int $$3, int $$4, wo $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fpb(fob $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fpb $$5, wo $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fuk.t());
   }
   ...
   public void b(fod $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            ...
            $$0.a(gmh::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gmh.L(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   private void a(fod $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$1 < $$3) {
         int $$5 = $$1;
         $$1 = $$3;
         $$3 = $$5;
