public class fpb extends fpj {
   ...
   fpb(flj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fpe $$7) {
   ...
   public void a() {
      ...
      if (this.g()) {
         ...
         this.e(atm.i(0.05F, this.y, 1.0F));
      }
   }
   ...
   public static class a implements fol<jv> {
      ...
      public foi a(jv $$0, flj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         foi $$8 = new fpb($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.e(0.15F);
   ...
   public static class b implements fol<jv> {
      ...
      public foi a(jv $$0, flj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fpb($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class e implements fol<jv> {
      ...
      public foi a(jv $$0, flj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fpb $$8 = new fpb($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
