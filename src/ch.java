...
public class ch extends cv<ch.a> {
   ...
   public void a(anf $$0, bmn $$1, List<blw> $$2) {
      List<ehf> $$3 = $$2.stream().map($$1x -> bp.b($$0, $$1x)).collect(Collectors.toList());
      ehf $$4 = bp.b($$0, $$1);
   ...
   public static record a(Optional<bb> b, Optional<bb> c, Optional<bb> d) implements cv.a {
      public static final Codec<ch.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atx.a(bp.b, "player").forGetter(ch.a::a), atx.a(bp.b, "lightning").forGetter(ch.a::b), atx.a(bp.b, "bystander").forGetter(ch.a::c))
               .apply($$0, ch.a::new)
      );
      ...
      public boolean a(ehf $$0, List<ehf> $$1) {
