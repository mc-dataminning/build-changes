...
public record ch(Optional<jb<ctl>> b, ct.d c, jz d, Map<ci.a<?>, ci> e) {
   ...
   public static class a {
      private Optional<jb<ctl>> a = Optional.empty();
      ...
      public ch.a a(day... $$0) {
         this.a = Optional.of(jb.a($$0x -> $$0x.r().o(), $$0));
         return this;
      }

      public ch.a a(awm<ctl> $$0) {
