...
public record ch(cl.d c, Optional<bq> d) implements br {
   public static final MapCodec<ch> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(arb.a(cl.d.d, "blocks_set_on_fire", cl.d.c).forGetter(ch::b), arb.a(bq.a, "entity_struck").forGetter(ch::c)).apply($$0, ch::new)
   );
   ...
   public boolean a(bil $$0, akn $$1, @Nullable ehi $$2) {
      return !($$0 instanceof bja $$3) ? false : this.c.d($$3.m()) && (this.d.isEmpty() || $$3.o().anyMatch($$2x -> this.d.get().a($$1, $$2, $$2x)));
   }
