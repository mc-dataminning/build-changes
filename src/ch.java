...
public record ch(cl.d c, Optional<bq> d) implements br {
   public static final MapCodec<ch> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(arh.a(cl.d.d, "blocks_set_on_fire", cl.d.c).forGetter(ch::b), arh.a(bq.a, "entity_struck").forGetter(ch::c)).apply($$0, ch::new)
   );
   ...
   public boolean a(bis $$0, aks $$1, @Nullable ehp $$2) {
      return !($$0 instanceof bjh $$3) ? false : this.c.d($$3.s()) && (this.d.isEmpty() || $$3.t().anyMatch($$2x -> this.d.get().a($$1, $$2, $$2x)));
   }
