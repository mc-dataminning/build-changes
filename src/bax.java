...
public class bax extends bah {
   public bax(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   protected static void a(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> bai.a($$0));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:arrow", $$1x -> DSL.optionalFields("inBlockState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:bat");
      a($$0, $$1, "minecraft:blaze");
      $$0.registerSimple($$1, "minecraft:boat");
      a($$0, $$1, "minecraft:cave_spider");
      $$0.register($$1, "minecraft:chest_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0), "Items", DSL.list(ayz.t.in($$0))));
      a($$0, $$1, "minecraft:chicken");
      $$0.register($$1, "minecraft:commandblock_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:cow");
      a($$0, $$1, "minecraft:creeper");
      $$0.register($$1, "minecraft:donkey", $$1x -> DSL.optionalFields("Items", DSL.list(ayz.t.in($$0)), "SaddleItem", ayz.t.in($$0), bai.a($$0)));
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carriedBlockState", ayz.u.in($$0), bai.a($$0)));
      ...
      $$0.register($$1, "minecraft:falling_block", $$1x -> DSL.optionalFields("BlockState", ayz.u.in($$0), "TileEntityData", ayz.s.in($$0)));
      $$0.registerSimple($$1, "minecraft:fireball");
      $$0.register($$1, "minecraft:fireworks_rocket", $$1x -> DSL.optionalFields("FireworksItem", ayz.t.in($$0)));
      $$0.register($$1, "minecraft:furnace_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:ghast");
      a($$0, $$1, "minecraft:giant");
      a($$0, $$1, "minecraft:guardian");
      $$0.register($$1, "minecraft:hopper_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0), "Items", DSL.list(ayz.t.in($$0))));
      $$0.register($$1, "minecraft:horse", $$1x -> DSL.optionalFields("ArmorItem", ayz.t.in($$0), "SaddleItem", ayz.t.in($$0), bai.a($$0)));
      a($$0, $$1, "minecraft:husk");
      $$0.registerSimple($$1, "minecraft:illusion_illager");
      $$0.register($$1, "minecraft:item", $$1x -> DSL.optionalFields("Item", ayz.t.in($$0)));
      $$0.register($$1, "minecraft:item_frame", $$1x -> DSL.optionalFields("Item", ayz.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:mooshroom");
      $$0.register($$1, "minecraft:mule", $$1x -> DSL.optionalFields("Items", DSL.list(ayz.t.in($$0)), "SaddleItem", ayz.t.in($$0), bai.a($$0)));
      a($$0, $$1, "minecraft:ocelot");
      $$0.registerSimple($$1, "minecraft:painting");
      $$0.registerSimple($$1, "minecraft:parrot");
      a($$0, $$1, "minecraft:pig");
      a($$0, $$1, "minecraft:polar_bear");
      $$0.register($$1, "minecraft:potion", $$1x -> DSL.optionalFields("Potion", ayz.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", $$1x -> DSL.optionalFields("SaddleItem", ayz.t.in($$0), bai.a($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0), ayz.B.in($$0)));
      $$0.register($$1, "minecraft:spectral_arrow", $$1x -> DSL.optionalFields("inBlockState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:spider");
      a($$0, $$1, "minecraft:squid");
      a($$0, $$1, "minecraft:stray");
      $$0.registerSimple($$1, "minecraft:tnt");
      $$0.register($$1, "minecraft:tnt_minecart", $$1x -> DSL.optionalFields("DisplayState", ayz.u.in($$0)));
      a($$0, $$1, "minecraft:vex");
      $$0.register(
         $$1,
         "minecraft:villager",
      ...
      $$0.register($$1, "minecraft:zombie_horse", $$1x -> DSL.optionalFields("SaddleItem", ayz.t.in($$0), bai.a($$0)));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:jukebox", $$1x -> DSL.optionalFields("RecordItem", ayz.t.in($$0)));
      b($$0, $$1, "minecraft:dispenser");
      b($$0, $$1, "minecraft:dropper");
      $$0.registerSimple($$1, "minecraft:sign");
      $$0.register($$1, "minecraft:mob_spawner", $$1x -> ayz.B.in($$0));
      $$0.register($$1, "minecraft:piston", $$1x -> DSL.optionalFields("blockState", ayz.u.in($$0)));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, ayz.F, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         ayz.b,
         () -> DSL.optionalFields(
      ...
      $$0.registerType(true, ayz.s, () -> DSL.taggedChoiceLazy("id", a(), $$2));
      $$0.registerType(true, ayz.w, () -> DSL.optionalFields("Passengers", DSL.list(ayz.w.in($$0)), ayz.x.in($$0)));
      $$0.registerType(true, ayz.x, () -> DSL.taggedChoiceLazy("id", a(), $$1));
      $$0.registerType(
         true,
         ayz.t,
         () -> DSL.hook(
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields(
               "entities",
               DSL.list(DSL.optionalFields("nbt", ayz.w.in($$0))),
               "blocks",
               DSL.list(DSL.optionalFields("nbt", ayz.s.in($$0))),
               "palette",
               DSL.list(ayz.u.in($$0))
            )
      );
      $$0.registerType(false, ayz.y, () -> DSL.constType(a()));
      $$0.registerType(false, ayz.z, () -> DSL.constType(a()));
      $$0.registerType(false, ayz.u, DSL::remainder);
      Supplier<TypeTemplate> $$3 = () -> DSL.compoundList(ayz.z.in($$0), DSL.constType(DSL.intType()));
      $$0.registerType(
         false,
         ayz.g,
         () -> DSL.optionalFields(
               ...
               DSL.optionalFields(
                  "minecraft:mined",
                  DSL.compoundList(ayz.y.in($$0), DSL.constType(DSL.intType())),
                  "minecraft:crafted",
                  $$3.get(),
                  "minecraft:used",
                  $$3.get(),
                  ...
                  DSL.optionalFields(
                     ...
                     $$3.get(),
                     "minecraft:killed",
                     DSL.compoundList(ayz.v.in($$0), DSL.constType(DSL.intType())),
                     "minecraft:killed_by",
                     DSL.compoundList(ayz.v.in($$0), DSL.constType(DSL.intType())),
                     "minecraft:custom",
      ...
      Map<String, Supplier<TypeTemplate>> $$4 = baw.a($$0);
      $$0.registerType(false, ayz.D, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), baw.c, baw.d));
      $$0.registerType(false, ayz.E, DSL::remainder);
      $$0.registerType(true, ayz.B, () -> DSL.optionalFields("SpawnPotentials", DSL.list(DSL.fields("Entity", ayz.w.in($$0))), "SpawnData", ayz.w.in($$0)));
      $$0.registerType(
         false,
         ayz.p,
         () -> DSL.optionalFields(
               "minecraft:adventure/adventuring_time",
               DSL.optionalFields("criteria", DSL.compoundList(ayz.G.in($$0), DSL.constType(DSL.string()))),
               "minecraft:adventure/kill_a_mob",
               DSL.optionalFields("criteria", DSL.compoundList(ayz.v.in($$0), DSL.constType(DSL.string()))),
      ...
      $$0.registerType(false, ayz.G, () -> DSL.constType(a()));
      $$0.registerType(false, ayz.v, () -> DSL.constType(a()));
