...
public class bax extends bfn {
   public bax(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgr.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgr.s, "minecraft:jukebox");
