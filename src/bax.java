...
public class bax extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bhs.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bax::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bax::a);
      return this.a($$0, "minecraft:trident", bax::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bhs.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bhs.B, $$1);
