...
public abstract class bax extends DataFix {
   ...
   public bax(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(ban.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(ban.x);
      Type<Pair<String, String>> $$2 = DSL.named(ban.v.typeName(), bbv.a());
      if (!Objects.equals(this.getOutputSchema().getType(ban.v), $$2)) {
