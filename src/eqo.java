...
public class eqo implements Comparable<eqo> {
   private static final Map<String, eqo> h = Maps.newHashMap();
   private static final Map<ekf.a, eqo> i = Maps.newHashMap();
   ...
   private final ekf.a m;
   private final String n;
   private ekf.a o;
   private boolean p;
   private int q;

   public static void a(ekf.a $$0) {
      eqo $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(ekf.a $$0, boolean $$1) {
      eqo $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (eqo $$0 : h.values()) {
         if ($$0.o.a() == ekf.b.a && $$0.o.b() != ekf.bv.b()) {
            $$0.a(ekf.a(eqq.O().aM().i(), $$0.o.b()));
         }
      }
   }
   ...
   public eqo(String $$0, int $$1, String $$2) {
      this($$0, ekf.b.a, $$1, $$2);
   }

   public eqo(String $$0, ekf.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(ekf.a $$0) {
      this.o = $$0;
   }

   public int a(eqo $$0) {
      return this.n.equals($$0.n) ? gaf.a(this.l).compareTo(gaf.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<ti> a(String $$0) {
      eqo $$1 = h.get($$0);
      return $$1 == null ? () -> ti.c($$0) : $$1::k;
   }

   public boolean b(eqo $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(ekf.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == ekf.bv.b() ? this.o.a() == ekf.b.b && this.o.b() == $$1 : this.o.a() == ekf.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == ekf.b.c && this.o.b() == $$0;
   }
