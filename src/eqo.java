...
public enum eqo implements axq {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final axq.a<eqo> t = axq.a(eqo::values);
   public static final IntFunction<eqo> u = avn.a(eqo::a, values(), avn.a.a);
   private final int v;
