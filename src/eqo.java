...
public class eqo extends eqz {
   private static final Logger c = LogUtils.getLogger();
   public long a;
   public List<UUID> b;

   public static eqo a(JsonObject $$0) {
      eqo $$1 = new eqo();

      try {
         $$1.a = esw.a("serverId", $$0, -1L);
         String $$2 = esw.b("playerList", $$0, null);
         if ($$2 != null) {
   ...
   private static List<UUID> a(JsonArray $$0) {
      ...
      for (JsonElement $$2 : $$0) {
         if ($$2.isJsonObject()) {
            UUID $$3 = esw.a("playerId", $$2.getAsJsonObject(), null);
            if ($$3 != null) {
               $$1.add($$3);
            }
         }
