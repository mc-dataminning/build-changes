...
public class eqo implements ebc.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eqo> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azg<eqo> a = azg.a(f);
   private final eqs g;
   private final eqs h;
   private final eqs i;
   ...
   public static eqo a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eqo(new eck(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eqo(eqs $$0, eqs $$1, eqs $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eqo(azv $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eqs.a($$0, IntStream.rangeClosed(-15, 0)),
         eqs.a($$0, IntStream.rangeClosed(-15, 0)),
         eqs.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eqo a(azv $$0) {
      return new eqo($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(ebc.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eqp $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eqs.b($$4 * $$13), eqs.b($$5 * $$13), eqs.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eqs.b($$1 * $$13);
         double $$21 = eqs.b($$2 * $$13);
         double $$22 = eqs.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eqp $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return azn.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
