...
public class eqo implements eqp, eqq {
   ...
   private final evu<MinecraftServer> G;
   ...
   public eqo(dck $$0, dze $$1, eqo.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ja.c,
   ...
   public static <T> eqo a(Dynamic<T> $$0, dck $$1, eqo.a $$2, dze $$3, Lifecycle $$4) {
      ...
      return new eqo(
         ...
         new evu<>(evt.a, $$0.get("ScheduledEvents").asStream()),
         (tx)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dwj.a.a).resultOrPartial(f::error).orElse(dwj.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jx $$0, tx $$1, @Nullable tx $$2) {
      ...
      dzc.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (uu)dwj.a.a.encodeStart(ul.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      ddb.b.encodeStart(ul.a, this.g.g()).ifSuccess($$1x -> $$1.a((tx)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == eqo.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eqo.a.c;
   }
