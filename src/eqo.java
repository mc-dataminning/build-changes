...
public class eqo {
   ...
   private final Map<String, eqw> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public eqo(@Nullable eyh $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tz a(tz $$0) {
      tz $$1 = $$0.p("Level");
      dic $$2 = new dic($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.h, $$2.i)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dic.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dic.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable eyh $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            tz $$2 = new tz();

            try {
               $$2 = $$0.a($$1, bbb.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               tz $$4 = $$2.p($$3);
               long $$5 = dic.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               uf $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if ($$11.a().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tz $$14 = $$2.p($$13);
                  $$12.a(dic.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static eqo a(alf<div> $$0, @Nullable eyh $$1) {
      if ($$0 == div.i) {
         return new eqo(
            $$1,
         ...
         return new eqo($$1, $$2, $$2);
      } else if ($$0 == div.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eqo($$1, $$3, $$3);
      } else {
