...
public class gjh {
   ...
   public static class a extends Thread {
      ...
      public a(gjh.b $$0) throws IOException {
         super("LanServerDetector #" + gjh.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gjh.b));
   ...
   public static class b {
      private final List<gjg> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gjg> a() {
         if (this.b) {
            List<gjg> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
