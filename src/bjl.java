...
public class bjl extends DataFix {
   ...
   public bjl(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(biw.H);
      Type<?> $$1 = this.getInputSchema().getType(biw.H);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bkk.a());
   ...
   private TypeRewriteRule b() {
      ...
      OpticFinder<String> $$4 = bkk.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
