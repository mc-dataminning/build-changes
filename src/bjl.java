...
public class bjl extends bje {
   public static final Codec<bjl> a = RecordCodecBuilder.create(
   ...
   private bjl(float $$0, float $$1) {
      this.b = $$0;
      this.d = $$1;
   }

   public static bjl b(float $$0, float $$1) {
      if ($$1 <= $$0) {
