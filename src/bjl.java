...
public abstract class bjl extends DataFix {
   private final String a;

   public bjl(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bix.B.typeName(), bks.a());
      if (!Objects.equals(this.getOutputSchema().getType(bix.B), $$2)) {
