...
public class bjl extends bhp {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "biomes",
                        DSL.optionalFields("palette", DSL.list(bgd.K.in($$0))),
                        "block_states",
                        DSL.optionalFields("palette", DSL.list(bgd.u.in($$0)))
                     )
                  ),
                  "Structures",
      ...
      $$0.registerType(false, bgd.L, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         bgd.M,
         () -> DSL.fields(
                           ...
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 ...
                                 DSL.taggedChoiceLazy(
                                    ...
                                    ImmutableMap.of(
                                       ...
                                       (Supplier<TypeTemplate>)() -> DSL.or(DSL.fields("preset", bgd.L.in($$0)), DSL.list(DSL.fields("biome", bgd.K.in($$0)))),
