...
public class bd extends cv<bd.a> {
   ...
   public void a(ane $$0, cdh $$1, ceu $$2) {
      egv $$3 = bp.b($$0, $$1);
      egv $$4 = bp.b($$0, $$2);
   ...
   public static record a(Optional<bb> b, Optional<bb> c, Optional<bb> d) implements cv.a {
      public static final Codec<bd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atv.a(bp.b, "player").forGetter(bd.a::a), atv.a(bp.b, "zombie").forGetter(bd.a::c), atv.a(bp.b, "villager").forGetter(bd.a::d))
               .apply($$0, bd.a::new)
      );
