...
public class enh {
   ...
   public enh(@Nullable euz $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tq a(tq $$0) {
      tq $$1 = $$0.p("Level");
      dfo $$2 = new dfo($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.h, $$2.i)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dfo.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dfo.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable euz $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               tq $$4 = $$2.p($$3);
               long $$5 = dfo.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tq $$14 = $$2.p($$13);
                  $$12.a(dfo.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static enh a(akt<dgi> $$0, @Nullable euz $$1) {
      if ($$0 == dgi.i) {
         return new enh(
            $$1,
         ...
         return new enh($$1, $$2, $$2);
      } else if ($$0 == dgi.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new enh($$1, $$3, $$3);
      } else {
