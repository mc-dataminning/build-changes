...
public class enh implements dxy.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<enh> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axz<enh> a = axz.a(f);
   private final enl g;
   private final enl h;
   private final enl i;
   ...
   public static enh a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new enh(new dzg(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private enh(enl $$0, enl $$1, enl $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public enh(ayo $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         enl.a($$0, IntStream.rangeClosed(-15, 0)),
         enl.a($$0, IntStream.rangeClosed(-15, 0)),
         enl.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public enh a(ayo $$0) {
      return new enh($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxy.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eni $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(enl.b($$4 * $$13), enl.b($$5 * $$13), enl.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = enl.b($$1 * $$13);
         double $$21 = enl.b($$2 * $$13);
         double $$22 = enl.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eni $$24 = this.g.a($$19);
            if ($$24 != null) {
