public class enh {
   ...
   private int a(dua $$0, int $$1, int $$2, int $$3) {
      int $$4 = kb.c($$0.g($$1) + 1);
   ...
   private boolean a(dbg $$0, int $$1, int $$2, iz $$3, dse $$4, iz $$5, dse $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dbg $$0, iz $$1, dse $$2) {
      iz.a $$3 = this.e.g($$1);
   ...
   private static boolean a(dbg $$0, iz $$1, dse $$2, iz $$3, dse $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         ewm $$5 = eno.a($$0, $$1, $$2, je.a);
         ewm $$6 = eno.a($$0, $$3, $$4, je.b);
         return ewj.b($$5, $$6);
      }
   }
