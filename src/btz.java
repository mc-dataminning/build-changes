...
public abstract class btz extends bvm {
   private static final ako<Boolean> bY = aks.a(btz.class, akq.k);
   ...
   protected btz(bup<? extends btz> $$0, dff $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract btz a(arq var1, btz var2);
   ...
   protected void k() {
      if (!this.p_() && this.cb() && this.dm() instanceof cqq $$0 && !$$0.c(this)) {
         this.af();
      }
   }
