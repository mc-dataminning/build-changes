...
public class aow extends chh {
   private static final Logger b = LogUtils.getLogger();
   private static final int cq = 32;
   private static final int cr = 10;
   private static final int cs = 25;
   public static final double c = 1.0;
   private static final bpj ct = new bpj(UUID.fromString("736565d2-e1a7-403d-a3f8-1aeb3e302542"), "Creative block interaction range modifier", 0.5, bpj.a.a);
   private static final bpj cu = new bpj(UUID.fromString("98491ef6-97b1-4584-ae82-71a8cc85cf73"), "Creative entity interaction range modifier", 2.0, bpj.a.a);
   public apu d;
   public final MinecraftServer e;
   public final aox f;
   private final ajg cw;
   private final atq cx;
   ...
   private aoj cZ = aoj.a;
   private aix<cvn> da = cvn.h;
   @Nullable
   private hz db;
   private boolean dc;
   private float dd;
   private final apz de;
   private boolean df;
   private boolean dg;
   private cgn dh = new cgn(0, 0, 0);
   private final cko di = new cko() {
      @Override
      public void a(ckb $$0, is<coz> $$1, coz $$2, int[] $$3) {
         aow.this.d.b(new abb($$0.j, $$0.k(), $$1, $$2));
      ...
      public void a(ckb $$0, int $$1, coz $$2) {
         aow.this.d.b(new abd($$0.j, $$0.k(), $$1, $$2));
      }

      @Override
      public void a(ckb $$0, coz $$1) {
         aow.this.d.b(new abd(-1, $$0.k(), -1, $$1));
      }
      ...
      private void b(ckb $$0, int $$1, int $$2) {
         aow.this.d.b(new abc($$0.j, $$1, $$2));
      }
   };
   private final ckn dj = new ckn() {
      @Override
      public void a(ckb $$0, int $$1, coz $$2) {
         clw $$3 = $$0.b($$1);
         if (!($$3 instanceof cls)) {
            if ($$3.d == aow.this.fT()) {
               am.f.a(aow.this, aow.this.fT(), $$2);
            }
         }
      }
   ...
   public aow(MinecraftServer $$0, aov $$1, GameProfile $$2, aok $$3) {
      super($$1, $$1.T(), $$1.U(), $$2);
      this.de = $$0.a(this);
      this.f = $$0.b(this);
      this.e = $$0;
      this.cx = $$0.ae().a((chh)this);
      this.cw = $$0.ae().f(this);
      this.e($$1);
      this.a($$3);
   }

   private void e(aov $$0) {
      hz $$1 = $$0.T();
      if ($$0.E_().g() && $$0.o().aY().k() != cvk.c) {
         int $$2 = Math.max(0, this.e.a($$0));
         int $$3 = awh.a($$0.D_().b((double)$$1.u(), (double)$$1.w()));
         if ($$3 < $$2) {
            $$2 = $$3;
         }
         ...
         for (int $$9 = 0; $$9 < $$6; $$9++) {
            ...
            int $$11 = $$10 % ($$2 * 2 + 1);
            int $$12 = $$10 / ($$2 * 2 + 1);
            hz $$13 = aoq.a($$0, $$1.u() + $$11 - $$2, $$1.w() + $$12 - $$2);
            if ($$13 != null) {
               this.a($$13, 0.0F, 0.0F);
               if ($$0.g(this)) {
                  break;
   ...
   public void a(sw $$0) {
      ...
      if ($$0.b("warden_spawn_tracker", 10)) {
         cgn.a.parse(new Dynamic(tk.a, $$0.c("warden_spawn_tracker"))).resultOrPartial(b::error).ifPresent($$0x -> this.dh = $$0x);
      }

      if ($$0.b("enteredNetherPosition", 10)) {
         sw $$1 = $$0.p("enteredNetherPosition");
         this.cW = new ens($$1.k("x"), $$1.k("y"), $$1.k("z"));
      }

      this.cO = $$0.q("seenCredits");
      if ($$0.b("recipeBook", 10)) {
         this.cP.a($$0.p("recipeBook"), this.e.aG());
      }
      ...
      if ($$0.b("SpawnX", 99) && $$0.b("SpawnY", 99) && $$0.b("SpawnZ", 99)) {
         ...
         if ($$0.e("SpawnDimension")) {
            this.da = cvn.g.parse(tk.a, $$0.c("SpawnDimension")).resultOrPartial(b::error).orElse(cvn.h);
         }
      }
   }
   ...
   public void b(sw $$0) {
      super.b($$0);
      cgn.a.encodeStart(tk.a, this.dh).resultOrPartial(b::error).ifPresent($$1 -> $$0.a("warden_spawn_tracker", $$1));
      this.k($$0);
   ...
   public void a(int $$0) {
      ...
      float $$2 = ($$1 - 1.0F) / $$1;
      this.cl = awh.a((float)$$0 / $$1, 0.0F, $$2);
      this.cH = -1;
   }
   ...
   public void m() {
      try {
         ...
         if (this.ew() + this.fk() != this.cy) {
            ...
            this.a(eoz.g, awh.f(this.cy));
         }

         if (this.bX.a() != this.cz) {
            this.cz = this.bX.a();
            this.a(eoz.h, awh.f((float)this.cz));
         }

         if (this.ci() != this.cA) {
            this.cA = this.ci();
            this.a(eoz.i, awh.f((float)this.cA));
         }

         if (this.eK() != this.cB) {
            this.cB = this.eK();
            this.a(eoz.j, awh.f((float)this.cB));
         }

         if (this.ck != this.cD) {
            this.cD = this.ck;
            this.a(eoz.k, awh.f((float)this.cD));
         }

         if (this.cj != this.cC) {
            this.cC = this.cj;
            this.a(eoz.l, awh.f((float)this.cC));
         }
   ...
   private void gw() {
      enn $$0 = new enn(this.dm()).c(32.0, 10.0, 32.0);
      this.dM().a(boi.class, $$0, bnt.f).stream().filter($$0x -> $$0x instanceof bom).forEach($$0x -> ((bom)$$0x).a_((chh)this));
   }
   ...
   public void a(bno $$0, int $$1, bmn $$2) {
      if ($$0 != this) {
         super.a($$0, $$1, $$2);
         this.t($$1);
         this.gi().a(eoz.f, this, eou::b);
         if ($$0 instanceof chh) {
            this.a(atu.Q);
            this.gi().a(eoz.e, this, eou::b);
         } else {
            this.a(atu.O);
         }
   ...
   private void a(eov $$0, eov $$1, eoz[] $$2) {
      eor $$3 = this.gi().e($$1.cy());
      if ($$3 != null) {
         int $$4 = $$3.n().b();
         if ($$4 >= 0 && $$4 < $$2.length) {
            this.gi().a($$2[$$4], $$0, eou::b);
         }
      }
   }
   ...
   public boolean a(bmn $$0, float $$1) {
      if (this.b($$0)) {
         ...
         boolean $$2 = this.e.l() && this.gx() && $$0.a(aub.n);
         if (!$$2 && this.cI > 0 && !$$0.a(aub.e)) {
            return false;
         } else {
            bno $$3 = $$0.d();
            if ($$3 instanceof chh $$4 && !this.a($$4)) {
               return false;
            }

            if ($$3 instanceof chn $$5 && $$5.w() instanceof chh $$7 && !this.a($$7)) {
               return false;
            }
   ...
   protected ehm a(aov $$0) {
      ehm $$1 = super.a($$0);
      if ($$1 != null && this.dM().ae() == cvn.h && $$0.ae() == cvn.j) {
         ens $$2 = $$1.a.b(0.0, -1.0, 0.0);
         return new ehm($$2, ens.b, 90.0F, 0.0F);
      } else {
         return $$1;
      }
   }
   ...
   public bno b(aov $$0) {
      ...
      aov $$1 = this.z();
      aix<cvn> $$2 = $$1.ae();
      if ($$2 == cvn.j && $$0.ae() == cvn.h) {
         this.ag();
         this.z().a(this, bno.c.e);
         if (!this.g) {
            this.g = true;
   ...
   protected Optional<l.a> a(aov $$0, hz $$1, boolean $$2, dmw $$3) {
      ...
      if ($$4.isPresent()) {
         ...
         ie.a $$5 = this.dM().a_(this.aw).d(ddr.b).orElse(ie.a.a);
   ...
   private void f(aov $$0) {
      aix<cvn> $$1 = $$0.ae();
      aix<cvn> $$2 = this.dM().ae();
      am.w.a(this, $$1, $$2);
      if ($$1 == cvn.i && $$2 == cvn.h && this.cW != null) {
         am.D.a(this, this.cW);
      }
   ...
   public Either<chh.a, axk> a(hz $$0) {
      ie $$1 = this.dM().a_($$0).c(dcj.aE);
      if (this.fD() || !this.bx()) {
         return Either.left(chh.a.e);
      } else if (!this.dM().E_().j()) {
         return Either.left(chh.a.a);
      } else if (!this.a($$0, $$1)) {
         return Either.left(chh.a.c);
      } else if (this.b($$0, $$1)) {
         return Either.left(chh.a.d);
      } else {
         this.a(this.dM().ae(), $$0, this.dC(), false, true);
         if (this.dM().P()) {
            return Either.left(chh.a.b);
         } else {
            if (!this.f()) {
               double $$2 = 8.0;
               double $$3 = 5.0;
               ens $$4 = ens.c($$0);
               List<cen> $$5 = this.dM()
                  .a(cen.class, new enn($$4.a() - 8.0, $$4.b() - 5.0, $$4.c() - 8.0, $$4.a() + 8.0, $$4.b() + 5.0, $$4.c() + 8.0), $$0x -> $$0x.f(this));
               if (!$$5.isEmpty()) {
                  return Either.left(chh.a.f);
               }
            }

            Either<chh.a, axk> $$6 = super.a($$0).ifRight($$0x -> {
               this.a(atu.ap);
               am.r.a(this);
            });
            if (!this.z().d()) {
   ...
   public OptionalInt a(@Nullable bly $$0) {
      if ($$0 == null) {
         ...
         this.gy();
         ckb $$1 = $$0.createMenu(this.dl, this.fT(), this);
         if ($$1 == null) {
            if (this.P_()) {
   ...
   public void a(cbv $$0, bln $$1) {
      ...
      this.bW = new clb(this.dl, this.fT(), $$1, $$0);
      this.a(this.bW);
   }
   ...
   public void b(double $$0, double $$1, double $$2) {
      if (!this.bO() && !s($$0, $$1, $$2)) {
         if (this.bZ()) {
            ...
            if ($$1 > 0.0) {
               this.a(atu.u, (int)Math.round($$1 * 100.0));
            }
         } else if (this.aC()) {
   ...
   private void r(double $$0, double $$1, double $$2) {
      if (this.bO() && !s($$0, $$1, $$2)) {
         ...
         if ($$4 instanceof cja) {
            ...
            this.a(atu.y, $$3);
         } else if ($$4 instanceof cak) {
            this.a(atu.z, $$3);
         } else if ($$4 instanceof cbv) {
            this.a(atu.A, $$3);
         } else if ($$4 instanceof cfa) {
            this.a(atu.D, $$3);
         }
      }
   }
   ...
   public void a(List<aiy> $$0) {
      List<csd<?>> $$1 = $$0.stream().flatMap($$0x -> this.e.aG().a($$0x).stream()).collect(Collectors.toList());
      this.a($$1);
   }
   ...
   public void a(eg.a $$0, bno $$1, eg.a $$2) {
      ens $$3 = $$2.a($$1);
      super.a($$0, $$3);
   ...
   public void a(aow $$0, boolean $$1) {
      ...
      if ($$1) {
         ...
         this.s($$0.fN());
         this.aw = $$0.aw;
      } else if (this.dM().Z().b(cvj.d) || $$0.P_()) {
         this.fT().a($$0.fT());
         this.cj = $$0.cj;
         this.ck = $$0.ck;
         this.cl = $$0.cl;
   ...
   public void c(double $$0, double $$1, double $$2) {
      this.d.a($$0, $$1, $$2, this.dC(), this.dE(), bot.g);
   }

   @Override
   public void d(double $$0, double $$1, double $$2) {
      this.d.a(this.dr() + $$0, this.dt() + $$1, this.dx() + $$2, this.dC(), this.dE(), bot.f);
   }

   @Override
   public boolean a(aov $$0, double $$1, double $$2, double $$3, Set<bot> $$4, float $$5, float $$6) {
      cuu $$7 = new cuu(hz.a($$1, $$2, $$3));
      $$0.l().a(apa.g, $$7, 1, this.aj());
      this.ac();
      if (this.fD()) {
         this.a(true, true);
      }
   ...
   @Override
   public boolean P_() {
      return this.f.b() == cvk.d;
   }

   @Override
   public boolean f() {
      return this.f.b() == cvk.b;
   }
   ...
   public aok B() {
      int $$0 = this.an().b(bQ);
      boa $$1 = boa.d.apply(this.an().b(bR));
      return new aok(this.cU, this.cT, this.cJ, this.cK, $$0, $$1, this.df, this.dg);
   }
   ...
   private boolean u(boolean $$0) {
      return this.cJ == chf.c ? $$0 : true;
   }

   private boolean gz() {
      return this.cJ == chf.a;
   }
   ...
   public bno K() {
      return (bno)(this.cM == null ? this : this.cM);
   }

   @Override
   public void c(@Nullable bno $$0) {
      bno $$1 = this.K();
      this.cM = (bno)($$0 == null ? this : $$0);
      if ($$1 != this.cM) {
         if (this.cM.dM() instanceof aov $$2) {
   ...
   public void a(aov $$0, double $$1, double $$2, double $$3, float $$4, float $$5) {
      this.c(this);
      this.ac();
      if ($$0 == this.dM()) {
         this.d.a($$1, $$2, $$3, $$4, $$5);
   ...
   public void a(aix<cvn> $$0, @Nullable hz $$1, float $$2, boolean $$3, boolean $$4) {
      if ($$1 != null) {
   ...
   @Nullable
   private static cvk a(@Nullable sw $$0, String $$1) {
      return $$0 != null && $$0.b($$1, 99) ? cvk.a($$0.h($$1)) : null;
   }

   private cvk b(@Nullable cvk $$0) {
      cvk $$1 = this.e.bb();
      if ($$1 != null) {
         return $$1;
      } else {
   ...
   public void a(double $$0, double $$1) {
      this.cp = (float)(awh.d($$1, $$0) * 180.0F / (float)Math.PI - (double)this.dC());
   ...
   public aen d(aov $$0) {
      return new aen($$0.ac(), $$0.ae(), cwo.a($$0.C()), this.f.b(), this.f.c(), $$0.ah(), $$0.B(), this.gs(), this.av());
   }
}
