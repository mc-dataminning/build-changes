...
public class aow {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xj.c("commands.schedule.same_tick"));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> xj.b("commands.schedule.cleared.failure", $$0));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xj.b("commands.schedule.macro"));
   ...
   private static int a(ew $$0, Pair<alj, Either<ik<ew>, Collection<ik<ew>>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.e().ab() + (long)$$2;
         alj $$5 = (alj)$$1.getFirst();
         ezl<MinecraftServer> $$6 = $$0.l().aZ().I().s();
         ...
         if ($$7.isPresent()) {
            ...
            $$6.a($$8, $$4, new ezh($$5));
            $$0.a(() -> xj.a("commands.schedule.created.function", xj.a($$5), $$2, $$4), true);
         } else {
            String $$9 = "#" + $$5;
            if ($$3) {
               $$6.a($$9);
            ...
            $$6.a($$9, $$4, new ezi($$5));
            $$0.a(() -> xj.a("commands.schedule.created.tag", xj.a($$5), $$2, $$4), true);
         }
   ...
   private static int a(ew $$0, String $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         $$0.a(() -> xj.a("commands.schedule.cleared.success", $$2, $$1), true);
         return $$2;
      }
   }
}
