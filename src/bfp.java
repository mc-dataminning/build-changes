...
public class bfp extends bfj {
   ...
   public void l() {
      ...
      if (this.k != null) {
         eei $$0 = new eei(this.k.dn() - this.dn(), this.k.dp() + (double)this.k.cF() / 2.0 - this.dp(), this.k.dt() - this.dt());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
      ...
      this.f(this.dl().d((double)$$3, 0.98, (double)$$3));
      if (this.ay()) {
   ...
   private void o() {
      if (this.k == null || this.k.f(this) > 64.0) {
         this.k = this.dI().a(this, 8.0);
      }

      if (this.dI() instanceof aif) {
         for (bfp $$1 : this.dI().a(dfz.a(bfp.class), this.cE().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }
   ...
   private static boolean b(aif $$0, eei $$1, int $$2) {
      eed $$3 = eed.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.y_().a(40);
      List<bfp> $$5 = $$0.a(dfz.a(bfp.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bfp $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bfp $$0) {
      return $$0 != this && a($$0, this.af(), this.i);
   }
   ...
   private int a(byo $$0, int $$1) {
      Entry<bfo, cfz> $$2 = cki.a(ckk.L, $$0, cfz::j);
      if ($$2 != null) {
         cfz $$3 = $$2.getValue();
