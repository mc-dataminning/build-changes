...
public class bfp<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bfp(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bfp<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bfq<T> a() throws IOException {
      if (this.d.get() <= 0) {
         ...
         final bfq<T> $$0 = bfq.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bfq<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bfp.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bfp.this.c.position();
               }
