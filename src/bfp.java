...
public class bfp extends DataFix {
   ...
   private static void a(bfp.a $$0, Dynamic<?> $$1) {
      ...
      $$0.a("BlockEntityTag", false, $$1x -> {
         String $$2x = bji.a($$1x.get("id").asString(""));
         $$1x = a($$0, $$1x, $$2x);
   ...
   private static Dynamic<?> a(bfp.a $$0, Dynamic<?> $$1, int $$2) {
      ...
      if ($$6.isPresent()) {
         $$0.a("minecraft:item_name", bas.b($$1.getOps(), $$6.get()));
      }
   ...
   private static <T> Dynamic<T> a(bfp.a $$0, Dynamic<T> $$1, String $$2) {
      ...
      return switch ($$2) {
         ...
         case "minecraft:banner" -> {
            ...
            if ($$7.isPresent()) {
               $$0.a("minecraft:base_color", $$1.createString(bbl.a($$7.get().intValue())));
            }
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(bhu.t), this.getOutputSchema().getType(bhu.t), $$0 -> {
