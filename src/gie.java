...
public class gie {
   ...
   public gie(gkt $$0, deg $$1, int $$2, ghc $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
      this.h = kg.a(this.g + 1, 0, this.g + 1);
   }

   protected void a(gkt $$0) {
      if (!fil.Q().by()) {
         ...
         for (int $$2 = 0; $$2 < this.d; $$2++) {
            for (int $$3 = 0; $$3 < this.c; $$3++) {
               for (int $$4 = 0; $$4 < this.e; $$4++) {
                  int $$5 = this.a($$2, $$3, $$4);
                  this.f[$$5] = $$0.new b($$5, kg.b($$2, $$3 + this.b.ap(), $$4));
               }
            }
         }
      }
   ...
   @Nullable
   protected gkt.b a(je $$0) {
      return this.a(kg.c($$0));
   }

   @Nullable
   protected gkt.b a(long $$0) {
      int $$1 = kg.b($$0);
      int $$2 = kg.c($$0);
      int $$3 = kg.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gkt.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.ap();
