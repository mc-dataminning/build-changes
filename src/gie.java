...
public class gie implements gik.a {
   ...
   private final fgm A;
   private final Map<jd, gie.a> B = new HashMap<>();
   private final Map<UUID, aaf.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(aaq.a $$0, long $$1) {
      this.B.put($$0.a(), new gie.a($$0, $$1));
   }
   ...
   private void b(fbg $$0, gex $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(age::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gik.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(age::a).collect(Collectors.toSet()).toString();
      }
   }
   ...
   private void a(fbg $$0, gex $$1, aaq.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(fbg $$0, gex $$1, aaf.a $$2) {
      if ($$2.e() != null) {
         gis.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(fbg $$0, gex $$1, aaf.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(fbg $$0, gex $$1, String $$2, aaq.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }
   ...
   private Set<String> a(aaq.a $$0) {
      return this.a($$0.a()).stream().map(age::a).collect(Collectors.toSet());
   }

   private String a(aaf.a $$0, jd $$1) {
   ...
   private boolean c(aaf.a $$0) {
      cmx $$1 = this.A.s;
      jd $$2 = jd.a($$1.du(), $$0.d().b(), $$1.dA());
      jd $$3 = jd.a((jw)$$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(jd $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(aaf.a::b).collect(Collectors.toSet());
   }

   private Map<jd, List<String>> f() {
      Map<jd, List<String>> $$0 = Maps.newHashMap();

      for (aaf.a $$1 : this.C.values()) {
   ...
   private void g() {
      gik.a(this.A.an(), 8).ifPresent($$0 -> this.D = $$0.cA());
   }

   static record a(aaq.a a, long b) {
   }
}
