...
public class gie {
   ...
   public ghx a(Vector3f $$0, Vector3f $$1, ghz $$2, gwk $$3, jj $$4, gyy $$5, @Nullable gia $$6, boolean $$7, int $$8) {
      gib $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      $$9.a[0] = azc.h($$11, $$9.a[0], $$12);
      $$9.a[2] = azc.h($$11, $$9.a[2], $$12);
      $$9.a[1] = azc.h($$11, $$9.a[1], $$13);
      $$9.a[3] = azc.h($$11, $$9.a[3], $$13);
      ...
      return new ghx($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gib a(gib $$0, jj $$1, j $$2) {
      ...
      Vector3f $$24 = $$23.transform(new Vector3f(azc.b($$22), azc.a($$22), 0.0F));
      int $$25 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$24.y(), (double)$$24.x())) / 90.0)) * 90, 360);
      return new gib(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gib $$0, gwk $$1, jj $$2, float[] $$3, j $$4, @Nullable gia $$5) {
      int[] $$6 = new int[32];
   ...
   private void a(int[] $$0, int $$1, jj $$2, gib $$3, float[] $$4, gwk $$5, j $$6, @Nullable gia $$7) {
      ggi.b $$8 = ggi.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gwk $$3, gib $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gia $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, jj $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (azc.a($$13, $$18) && azc.a($$14, $$19) && azc.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
