...
public class eyx implements AutoCloseable {
   ...
   private eyz a(eyp.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(eyp.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, gcy $$2) {
      ...
      if ($$2.n != null && (this.i == eyz.b.a || this.i == eyz.b.b)) {
