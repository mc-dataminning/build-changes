...
public class eyx extends eyb {
   ...
   private eyx(List<ezx> $$0, Optional<wp> $$1, Optional<ewo.b> $$2, eyx.a $$3) {
      super($$0);
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public static UnaryOperator<wp> a(ewo $$0, @Nullable ewo.b $$1) {
      if ($$1 != null) {
         bva $$2 = $$0.c($$1.a());
         if ($$2 != null) {
            ex $$3 = $$2.d($$0.d()).a(2);
   ...
   public static eyb.a<?> a(wp $$0, eyx.a $$1) {
      return a($$2 -> new eyx($$2, Optional.of($$0), Optional.empty(), $$1));
   }

   public static eyb.a<?> a(wp $$0, eyx.a $$1, ewo.b $$2) {
   ...
   public static enum a implements azv {
      ...
      public static final Codec<eyx.a> c = azv.a(eyx.a::values);
