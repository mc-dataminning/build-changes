...
public class eyx {
   private static final aew a = new aew("advancements/title_box");
   ...
   private final arj r;
   private final int s;
   private final List<arj> t;
   private final eqv u;
   @Nullable
   private eyx v;
   private final List<eyx> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public eyx(eyv $$0, eqv $$1, ag $$2, aq $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = qr.a().a($$1.h.a($$3.a(), 163));
      this.y = arw.d($$3.f() * 28.0F);
      this.z = arw.d($$3.g() * 27.0F);
      int $$4 = $$2.a().g().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = qr.a().a(this.a(tn.a($$3.b().e(), uh.a.a($$3.e().b())), $$7));
