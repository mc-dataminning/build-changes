...
public class eyx {
   ...
   public eyx(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eyy> $$1) throws IOException {
   ...
   public List<eyy> a(Path $$0) throws IOException {
      List<eyy> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eyy> a(Path $$0, boolean $$1) throws IOException {
      List<eyy> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eyy> $$1) throws IOException {
