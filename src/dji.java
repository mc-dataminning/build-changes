...
public class dji implements djm {
   ...
   private final akk f;
   private final int g;
   private final dji.a h;

   public dji(akk $$0, int $$1, dji.a $$2) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
   }
   ...
   public boolean a(djj $$0, ehd $$1, djj.a $$2, djm.a $$3) {
      ...
      try {
         Iterator<djl> $$5 = this.b.iterator();
   ...
   private static Optional<ehd> a(akk $$0, ehd $$1, djl $$2) {
      Optional<ehd> $$3 = $$2.a().a($$0);
      if ($$3.isEmpty()) {
