...
public abstract class bkd extends blh {
   private static final afm<Boolean> bT = afp.a(bkd.class, afo.k);
   ...
   protected bkd(bkm<? extends bkd> $$0, crs $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bkd a(ama var1, bkd var2);
   ...
   protected void m() {
      if (!this.n_() && this.bN() && this.cY() instanceof cff $$0 && !$$0.a((bki)this)) {
         this.aa();
      }
   }
