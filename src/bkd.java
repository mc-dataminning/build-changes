...
public class bkd implements Comparable<bkd> {
   ...
   @Nullable
   private bkd q;
   private final Optional<bkd.a> r;

   public bkd(bkb $$0) {
      this($$0, 0, 0);
   }

   public bkd(bkb $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bkd(bkb $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bkd(bkb $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bkd(bkb $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public bkd(bkb $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bkd $$6, Optional<bkd.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(blg $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bkd $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(rz $$0) {
      ...
      this.r.ifPresent($$1x -> bkd.a.a.encodeStart(sn.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static bkd b(rz $$0) {
      String $$1 = $$0.l("id");
      bkb $$2 = jy.e.a(agi.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static bkd a(bkb $$0, rz $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = bkd.a.a.parse(new Dynamic(sn.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bkd($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bkd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  asu.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  asu.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bkd $$0) {
         ...
         float $$2 = atm.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = atm.i($$2, this.c, this.d);
      }

      public float a(blg $$0, float $$1) {
         if ($$0.dI()) {
            this.g = this.e;
         }

         return atm.i($$1, this.g, this.e);
      }
   }
}
