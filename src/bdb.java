...
public class bdb extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfs.z);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bdb::c), this.a("minecraft:arrow", bdb::a), this.a("minecraft:spectral_arrow", bdb::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bdb.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bfs.z, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bfs.z, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bdb.a<?> $$1, Type<?> $$2, Type<T> $$3) {
