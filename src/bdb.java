...
public class bdb extends DataFix {
   ...
   private Dynamic<?> b(Dynamic<?> $$0) {
      ...
      return $$1.isPresent() && $$1.get().get("Sections").asStreamOpt().result().isPresent() ? $$0.set("Level", new bdb.e((Dynamic<?>)$$1.get()).a()) : $$0;
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(biq.c);
      Type<?> $$1 = this.getOutputSchema().getType(biq.c);
   ...
   public static enum b {
      a(bdb.b.b.b, bdb.b.a.b),
      b(bdb.b.b.a, bdb.b.a.b),
      c(bdb.b.b.b, bdb.b.a.c),
      d(bdb.b.b.a, bdb.b.a.c),
      e(bdb.b.b.b, bdb.b.a.a),
      f(bdb.b.b.a, bdb.b.a.a);

      private final bdb.b.a g;
      private final bdb.b.b h;

      private b(final bdb.b.b $$0, final bdb.b.a $$1) {
         this.g = $$1;
         this.h = $$0;
      }
   ...
   static class d {
      ...
      public void a(int $$0, Dynamic<?> $$1) {
         if (this.h.add($$1)) {
            this.c.add("%%FILTER_ME%%".equals(bdb.a($$1)) ? bdb.c.t : $$1);
         }

         this.i[$$0] = bdb.a(this.b, $$1);
      }
      ...
      public int b(int $$0) {
         if (!this.e) {
            ...
            bdb.a $$2 = this.d.get("Data").asByteBufferOpt().map($$0x -> new bdb.a(DataFixUtils.toArray($$0x))).result().orElseGet(bdb.a::new);
            bdb.a $$3 = this.d.get("Add").asByteBufferOpt().map($$0x -> new bdb.a(DataFixUtils.toArray($$0x))).result().orElseGet(bdb.a::new);
            this.h.add(bdb.c.t);
            bdb.a(this.b, bdb.c.t);
            this.c.add(bdb.c.t);
   ...
   static final class e {
      private int a;
      private final bdb.d[] b = new bdb.d[16];
      ...
      public e(Dynamic<?> $$0) {
         ...
         $$0.get("TileEntities").asStreamOpt().ifSuccess($$0x -> $$0x.forEach($$0xx -> {
               ...
               if (this.f.put($$4x, $$0xx) != null) {
                  bdb.i.warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", new Object[]{this.d, this.e, $$1x, $$2x, $$3x});
               }
            }));
         boolean $$1 = $$0.get("convertedFromAlphaFormat").asBoolean(false);
         $$0.get("Sections").asStreamOpt().ifSuccess($$0x -> $$0x.forEach($$0xx -> {
               bdb.d $$1x = new bdb.d($$0xx);
               this.a = $$1x.b(this.a);
               this.b[$$1x.a] = $$1x;
            }));
                  ...
                  switch ($$3.getIntKey()) {
                     case 2:
                        ...
                        while (var30.hasNext()) {
                           ...
                           $$5 |= $$4;
                           Dynamic<?> $$6 = this.a($$5);
                           if ("minecraft:grass_block".equals(bdb.a($$6))) {
                              String $$7 = bdb.a(this.a(a($$5, bdb.b.b)));
                     ...
                     case 3:
                        ...
                        while (var29.hasNext()) {
                           ...
                           $$8 |= $$4;
                           Dynamic<?> $$9 = this.a($$8);
                           if ("minecraft:podzol".equals(bdb.a($$9))) {
                              String $$10 = bdb.a(this.a(a($$8, bdb.b.b)));
                     ...
                     case 25:
                        ...
                        while (var28.hasNext()) {
                           ...
                           if ($$15 != null) {
                              ...
                              this.a($$14, bdb.c.p.getOrDefault($$16, bdb.c.p.get("false0")));
                           }
                        }
                        break;
                     case 26:
                        ...
                        while (var27.hasNext()) {
                           ...
                           if ($$18 != null) {
                              ...
                              if ($$20 != 14 && $$20 >= 0 && $$20 < 16) {
                                 String $$21 = bdb.a($$19, "facing") + bdb.a($$19, "occupied") + bdb.a($$19, "part") + $$20;
                                 if (bdb.c.r.containsKey($$21)) {
                                    this.a($$17, bdb.c.r.get($$21));
                                 }
                              }
                           }
                        }
                     ...
                     case 197:
                        ...
                        while (var26.hasNext()) {
                           ...
                           if (bdb.a($$40).endsWith("_door")) {
                              Dynamic<?> $$41 = this.a($$39);
                              if ("lower".equals(bdb.a($$41, "half"))) {
                                 int $$42 = a($$39, bdb.b.b);
                                 Dynamic<?> $$43 = this.a($$42);
                                 String $$44 = bdb.a($$41);
                                 if ($$44.equals(bdb.a($$43))) {
                                    String $$45 = bdb.a($$41, "facing");
                                    String $$46 = bdb.a($$41, "open");
                                    String $$47 = $$1 ? "left" : bdb.a($$43, "hinge");
                                    String $$48 = $$1 ? "false" : bdb.a($$43, "powered");
                                    this.a($$39, bdb.c.o.get($$44 + $$45 + "lower" + $$47 + $$46 + $$48));
                                    this.a($$42, bdb.c.o.get($$44 + $$45 + "upper" + $$47 + $$46 + $$48));
                                 }
                              }
                           }
                        }
                     ...
                     case 86:
                        ...
                        while (var25.hasNext()) {
                           ...
                           if ("minecraft:carved_pumpkin".equals(bdb.a($$28))) {
                              String $$29 = bdb.a(this.a(a($$27, bdb.b.a)));
                     ...
                     case 110:
                        ...
                        while (var24.hasNext()) {
                           ...
                           if ("minecraft:mycelium".equals(bdb.a($$12))) {
                              String $$13 = bdb.a(this.a(a($$11, bdb.b.b)));
                     ...
                     case 140:
                        ...
                        while (var23.hasNext()) {
                           ...
                           if ($$31 != null) {
                              ...
                              this.a($$30, bdb.c.m.getOrDefault($$32, bdb.c.m.get("minecraft:air0")));
                           }
                        }
                        break;
                     case 144:
                        ...
                        while (var22.hasNext()) {
                           ...
                           if ($$34 != null) {
                              ...
                              String $$36 = bdb.a(this.a($$33), "facing");
                              String $$38;
                              ...
                              $$34.remove("facing");
                              $$34.remove("Rot");
                              this.a($$33, bdb.c.n.getOrDefault($$38, bdb.c.n.get("0north")));
                           }
                        }
                        break;
                     case 175:
                        ...
                        while (var21.hasNext()) {
                           ...
                           if ("upper".equals(bdb.a($$50, "half"))) {
                              Dynamic<?> $$51 = this.a(a($$49, bdb.b.a));
                              String $$52 = bdb.a($$51);
                              switch ($$52) {
                     ...
                     case 177:
                        ...
                        while (var10.hasNext()) {
                           ...
                           if ($$23 != null) {
                              ...
                              if ($$25 != 15 && $$25 >= 0 && $$25 < 16) {
                                 String $$26 = bdb.a($$24, $$3.getIntKey() == 176 ? "rotation" : "facing") + "_" + $$25;
                                 if (bdb.c.s.containsKey($$26)) {
                                    this.a($$22, bdb.c.s.get($$26));
                                 }
                              }
                           }
                        }
      ...
      public static int a(int $$0, bdb.b $$1) {
         int var10000;
         switch ($$1.b()) {
            case a:
               int $$2 = ($$0 & 15) + $$1.a().a();
      ...
      public Dynamic<?> a(int $$0) {
         if ($$0 >= 0 && $$0 <= 65535) {
            bdb.d $$1 = this.d($$0);
            return $$1 == null ? bdb.c.t : $$1.a($$0 & 4095);
         } else {
            return bdb.c.t;
         }
      }
