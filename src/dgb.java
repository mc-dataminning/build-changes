...
public abstract class dgb {
   ...
   public void a(bvi<?> $$0, @Nullable dgz $$1, azh $$2, ji $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bwu.a($$7.get(), $$0, bvh.c, $$13, $$0.C_())) {
                     continue;
                  }

                  bva $$15 = bvi.a($$6, $$0, bvh.c, $$3x -> {
                  ...
                  if ($$15 instanceof bwa $$17) {
                     ...
                     if ($$18) {
                        ((bwa)$$15).a($$0, $$0.d_($$15.du()), bvh.c, null);
                     }
   ...
   public void a(@Nullable dgz $$0, ji $$1, tq $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dht $$4 = dht.b.parse(ue.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dht::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dht.c.parse(ue.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(brj::a);
      } else {
         this.e = brj.a(this.f != null ? this.f : new dht());
      }
   ...
   public tq a(tq $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (un)dht.b.encodeStart(ue.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (un)dht.c.encodeStart(ue.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bva b(dgz $$0, ji $$1) {
      if (this.l == null) {
         tq $$2 = this.a($$0, $$0.C_(), $$1).a();
         if (!$$2.b("id", 8)) {
            return null;
         }

         this.l = bvi.a($$2, $$0, bvh.c, Function.identity());
         if ($$2.f() == 1 && this.l instanceof bwa) {
         }
      }
   ...
   protected void a(@Nullable dgz $$0, ji $$1, dht $$2) {
      this.f = $$2;
   }

   private dht a(@Nullable dgz $$0, azh $$1, ji $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.a($$1).orElseGet(dht::new));
         return this.f;
      }
   }

   public abstract void a(dgz var1, ji var2, int var3);
