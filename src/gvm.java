...
public class gvm implements gvq.a {
   private final fqq a;
   private static final int b = ayh.a(255, 0, 155, 155);
   private static final int c = ayh.a(255, 255, 255, 0);
   ...
   public void a(fld $$0, grn $$1, double $$2, double $$3, double $$4) {
      ...
      for (int $$19 = this.a.s.K_(); $$19 <= this.a.s.ao() + 1; $$19 += 2) {
      ...
      for (int $$24 = this.a.s.K_(); $$24 <= this.a.s.ao() + 1; $$24 += 16) {
