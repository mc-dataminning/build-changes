...
public class kf extends kh {
   ...
   kf(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }

   public static kf a(int $$0, int $$1, int $$2) {
      return new kf($$0, $$1, $$2);
   }

   public static kf a(jd $$0) {
   ...
   public static kf a(jw $$0) {
      return new kf(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static kf a(long $$0) {
   ...
   public jd g(short $$0) {
      return new jd(this.d($$0), this.e($$0), this.f($$0));
   }
   ...
   public static long e(long $$0) {
      return b(a(jd.a($$0)), a(jd.b($$0)), a(jd.c($$0)));
   }
   ...
   public kf d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new kf(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }

   public Stream<jd> t() {
      return jd.a(this.d(), this.e(), this.f(), this.g(), this.h(), this.i());
   }

   public static Stream<kf> a(kf $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<kf> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<kf>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final jf a = new jf($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super kf> $$0x) {
            if (this.a.a()) {
               $$0.accept(new kf(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
   ...
   public static void a(jd $$0, LongConsumer $$1) {
      a($$0.u(), $$0.v(), $$0.w(), $$1);
   }

   public static void a(long $$0, LongConsumer $$1) {
      a(jd.a($$0), jd.b($$0), jd.c($$0), $$1);
   }
