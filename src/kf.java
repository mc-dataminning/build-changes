...
public interface kf extends jt.a {
   ...
   @Override
   <E> Optional<ke<E>> a(aku<? extends ke<? extends E>> var1);

   default <E> ke<E> e(aku<? extends ke<? extends E>> $$0) {
   ...
   static kf.b a(final ke<? extends ke<?>> $$0) {
      return new kf.b() {
         @Override
         public <T> Optional<ke<T>> a(aku<? extends ke<? extends T>> $$0x) {
            ke<ke<T>> $$1 = (ke<ke<T>>)$$0;
            return $$1.f((aku<ke<T>>)$$0);
         }
   ...
   public static class c implements kf {
      ...
      public c(Map<? extends aku<? extends ke<?>>, ? extends ke<?>> $$0) {
         this.c = Map.copyOf($$0);
      }
      ...
      @Override
      public <E> Optional<ke<E>> a(aku<? extends ke<? extends E>> $$0) {
   ...
   public static record d<T>(aku<? extends ke<T>> a, ke<T> b) {

      private static <T, R extends ke<? extends T>> kf.d<T> a(Entry<? extends aku<? extends ke<?>>, R> $$0) {
         return a((aku<? extends ke<?>>)$$0.getKey(), $$0.getValue());
      }

      private static <T> kf.d<T> a(aku<? extends ke<?>> $$0, ke<?> $$1) {
         return new kf.d<>((aku<? extends ke<T>>)$$0, (ke<T>)$$1);
      }
