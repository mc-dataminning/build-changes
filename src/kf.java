...
public interface kf {
   ...
   CompletableFuture<?> a(kd var1);

   String a();

   static <T> CompletableFuture<?> a(kd $$0, Codec<T> $$1, T $$2, Path $$3) {
      JsonElement $$4 = ac.a($$1.encodeStart(JsonOps.INSTANCE, $$2), IllegalStateException::new);
      return a($$0, $$4, $$3);
   }

   static CompletableFuture<?> a(kd $$0, JsonElement $$1, Path $$2) {
   ...
   @FunctionalInterface
   public interface a<T extends kf> {
      T create(kh var1);
   }
}
