...
public enum gan implements gau {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, gan> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (gan)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static gan a(int $$0, int $$1) {
      return r.get(b(arp.b($$0, 360), arp.b($$1, 360)));
   }
