...
public class gan extends gar<ccm> {
   ...
   private static final fvt i = fvt.e(g);
   private static final fvt j = fvt.l(g);
   private static final fvt k = fvt.p(h);
   private static final fvt l = fvt.k(a);
   private static final float m = (float)(Math.sqrt(3.0) / 2.0);
   private final gan.a n;

   public gan(gas.a $$0) {
      super($$0);
      this.d = 0.5F;
      this.n = new gan.a($$0.a(fpb.V));
   }

   public void a(ccm $$0, float $$1, float $$2, esa $$3, fvl $$4, int $$5) {
      $$3.a();
      ...
      if ($$0.bV > 0) {
         ...
         ese $$10 = $$4.getBuffer(fvt.o(f));
         this.n.a($$3, $$10, $$5, ggk.d, 1.0F, 1.0F, 1.0F, $$9);
         ese $$11 = $$4.getBuffer(j);
         this.n.a($$3, $$11, $$5, ggk.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      } else {
         ese $$12 = $$4.getBuffer(i);
         this.n.a($$3, $$12, $$5, ggk.a(0.0F, $$8), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      ese $$13 = $$4.getBuffer(k);
      this.n.a($$3, $$13, $$5, ggk.d, 1.0F, 1.0F, 1.0F, 1.0F);
      if ($$0.bV > 0) {
         float $$14 = ((float)$$0.bV + $$2) / 200.0F;
         float $$15 = Math.min($$14 > 0.8F ? ($$14 - 0.8F) / 0.2F : 0.0F, 1.0F);
         awo $$16 = awo.a(432L);
         ese $$17 = $$4.getBuffer(fvt.s());
         $$3.a();
         $$3.a(0.0F, -1.0F, -2.0F);
      ...
      if ($$0.bX != null) {
         ...
         a($$23, $$24 + gam.a($$0.bX, $$2), $$25, $$2, $$0.ag, $$3, $$4, $$5);
         $$3.b();
      }
   ...
   public static void a(float $$0, float $$1, float $$2, float $$3, int $$4, esa $$5, fvl $$6, int $$7) {
      ...
      for (int $$20 = 1; $$20 <= 8; $$20++) {
         ...
         $$10.a($$18, $$14 * 0.2F, $$15 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$16, $$11).c(ggk.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$14, $$15, $$9).a(255, 255, 255, 255).a($$16, $$12).c(ggk.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21, $$22, $$9).a(255, 255, 255, 255).a($$23, $$12).c(ggk.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$10.a($$18, $$21 * 0.2F, $$22 * 0.2F, 0.0F).a(0, 0, 0, 255).a($$23, $$11).c(ggk.d).b($$7).a($$19, 0.0F, -1.0F, 0.0F).e();
         $$14 = $$21;
         $$15 = $$22;
         $$16 = $$23;
      }
