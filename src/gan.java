...
public class gan implements evy, AutoCloseable {
   ...
   private static final evr t = new evr();
   ...
   private final List<evz> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, evz> C = Maps.newHashMap();
   private final int D;
   ...
   public gan(atf $$0, String $$1, ewn $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      ajt $$3 = new ajt("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = axa.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(axa.a($$5, "blend", null));
         this.H = a($$0, evw.a.a, $$6);
         this.I = a($$0, evw.a.b, $$7);
         this.D = evx.a();
         int $$18 = 0;
   ...
   private static evw a(final atf $$0, evw.a $$1, String $$2) throws IOException {
      evw $$3 = $$1.c().get($$2);
      evw $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         ata $$5 = $$0.getResourceOrThrow(new ajt($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = evw.a($$1, $$2, $$6, $$5.b(), new evp() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gan.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public static evs a(JsonObject $$0) {
      if ($$0 == null) {
         return new evs();
      } else {
         int $$1 = 32774;
