public class cwl extends cuk implements cvh {
   ...
   public bqv<cup> a(dby $$0, cmx $$1, bqt $$2) {
      if (!$$0.x_()) {
         evr $$3 = $$1.bx().e($$1.bN().a(0.8F));
         if (!$$0.a_(iz.a($$3)).r()) {
            $$3 = $$1.bx().e($$1.bN().a(0.05F));
         }

         coh $$4 = new coh($$1, $$0, $$3.a(), $$3.b(), $$3.c());
   ...
   public cnp a(dby $$0, js $$1, cup $$2, je $$3) {
      ...
      return new coh($$0, $$1.a(), $$1.b(), $$1.c(), $$5, $$6, $$7);
   }
   ...
   @Override
   public cvh.a c() {
      return cvh.a.a().a(($$0, $$1) -> dhe.a($$0, 1.0, evr.b)).a(6.6666665F).b(1.0F).a();
   }
}
