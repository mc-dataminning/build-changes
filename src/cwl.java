...
public class cwl {
   private final Map<akv, cwl.a> a = Maps.newHashMap();
   private int b;
   ...
   public float a(cwo $$0, float $$1) {
      akv $$2 = this.b($$0);
      cwl.a $$3 = this.a.get($$2);
      if ($$3 != null) {
   ...
   public void a() {
      this.b++;
      if (!this.a.isEmpty()) {
         Iterator<Entry<akv, cwl.a>> $$0 = this.a.entrySet().iterator();

         while ($$0.hasNext()) {
            Entry<akv, cwl.a> $$1 = $$0.next();
   ...
   public void a(akv $$0, int $$1) {
      this.a.put($$0, new cwl.a(this.b, this.b + $$1));
      this.b($$0, $$1);
   }
