...
public class bjf extends bhy {
   public bjf(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bjd.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bky.a($$0.get("id").asString("minecraft:air"));
