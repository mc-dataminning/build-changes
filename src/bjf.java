...
public class bjf extends biq {
   ...
   public void l() {
      ...
      if (this.f == 2) {
         if (this.dL().w_()) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.mu, ape.d, 10000.0F, 0.8F + this.ag.i() * 0.2F, false);
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.mt, ape.d, 2.0F, 0.5F + this.ag.i() * 0.2F, false);
         } else {
            bgv $$0 = this.dL().ai();
            if ($$0 == bgv.c || $$0 == bgv.d) {
               this.b(4);
      ...
      if (this.f < 0) {
         if (this.g == 0) {
            if (this.dL() instanceof akq) {
               ...
               for (akr $$2 : ((akq)this.dL()).a($$0 -> $$0.e(this) < 256.0F)) {
                  al.S.a($$2, this, $$1);
               }
            }
