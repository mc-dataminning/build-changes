...
public class eez extends efa {
   ...
   public static final MapCodec<eez> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(eey.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, eez::new)
   );
   private final eey h;

   public eez(bpz $$0, efd $$1, Optional<eex> $$2, eey $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dce $$0, BiConsumer<iz, dsc> $$1, azh $$2, iz $$3, iz $$4, edy $$5) {
   ...
   private boolean a(dce $$0, azh $$1, iz $$2, je $$3, iz $$4, List<iz> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
