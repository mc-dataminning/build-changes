...
public abstract class dnl extends dnw<dqh> {
   ...
   public boolean a(dny<dqh> $$0) {
      ...
      cqp $$2 = $$0.b();
      gw $$3 = $$0.e();
      Optional<csv> $$4 = jb.f.b(aps.ap).flatMap($$1x -> $$1x.a($$1)).map(he::a);
   ...
   protected boolean b(cpw $$0, asc $$1, gw $$2, dfj $$3) {
      gw $$4 = $$2.c();
      dfj $$5 = $$0.a_($$2);
      if (($$5.a(csw.G) || $$5.a(aps.as)) && $$0.a_($$4).a(csw.G)) {
         $$0.a($$2, $$3, 3);
         if ($$1.i() < 0.25F) {
            jb.f.b(aps.as).flatMap($$1x -> $$1x.a($$1)).map(he::a).ifPresent($$2x -> $$0.a($$4, $$2x.n(), 2));
         } else if ($$1.i() < 0.05F) {
         ...
         for (ha $$6 : ha.c.a) {
            if ($$1.i() < 0.2F) {
               gw $$7 = $$2.a($$6);
               if ($$0.a_($$7).a(csw.G)) {
                  jb.f.b(aps.aq).flatMap($$1x -> $$1x.a($$1)).map(he::a).ifPresent($$3x -> {
                     dfj $$4x = $$3x.n();
                     if ($$4x.b(csh.a)) {
                        $$4x = $$4x.a(csh.a, $$6);
                     }
