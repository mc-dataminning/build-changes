...
public class aka {
   ...
   static final axg c = new axg();
   private final ajz d;
   private final aka.b<?>[] e;
   private boolean f;
   ...
   public static <T> ajw<T> a(Class<? extends ajz> $$0, ajx<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> aka.b<T> b(ajw<T> $$0) {
      return (aka.b<T>)this.e[$$0.a()];
   }

   public <T> T a(ajw<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(ajw<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(ajw<T> $$0, T $$1, boolean $$2) {
      aka.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(aka.b<T> $$0, aka.c<?> $$1) {
   ...
   public static class a {
      private final ajz a;
      private final aka.b<?>[] b;

      public a(ajz $$0) {
         this.a = $$0;
         this.b = new aka.b[aka.c.b($$0.getClass())];
      }

      public <T> aka.a a(ajw<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public aka.c<T> e() {
         return aka.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, ajx<T> b, T c) {

      public static <T> aka.c<T> a(ajw<T> $$0, T $$1) {
         ajx<T> $$2 = $$0.b();
         return new aka.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static aka.c<?> a(wk $$0, int $$1) {
         int $$2 = $$0.l();
         ajx<?> $$3 = ajy.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aka.c<T> a(wk $$0, int $$1, ajx<T> $$2) {
         return new aka.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
