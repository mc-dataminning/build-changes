...
public record aka(xd b, Optional<aka.b> c, Optional<aka.c> d, Optional<aka.a> e, boolean f) {
   public static final Codec<aka> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               xf.a.lenientOptionalFieldOf("description", xc.a).forGetter(aka::a),
   ...
   public static record b(int b, int c, List<GameProfile> d) {
      private static final Codec<GameProfile> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(kh.d.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
