...
public class fyo {
   ...
   public final Map<ih, fyp> c;
   public final fyq d;
   public final boolean e;

   public fyo(Vector3f $$0, Vector3f $$1, Map<ih, fyp> $$2, @Nullable fyq $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ih, fyp> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fyo> {
      private static final boolean a = true;

      public fyo a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         fyq $$6 = this.a($$3);
         Map<ih, fyp> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !awm.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = awm.a($$3, "shade", true);
            return new fyo($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fyq a(JsonObject $$0) {
         fyq $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = awm.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ih.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = awm.a($$2, "rescale", false);
            $$1 = new fyq($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = awm.m($$0, "angle");
         if ($$1 != 0.0F && aww.e($$1) != 22.5F && aww.e($$1) != 45.0F) {
      ...
      private Map<ih, fyp> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, fyp> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ih, fyp> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ih, fyp> $$2 = Maps.newEnumMap(ih.class);
         JsonObject $$3 = awm.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ih $$5 = this.a($$4.getKey());
            $$2.put($$5, (fyp)$$0.deserialize($$4.getValue(), fyp.class));
         }
