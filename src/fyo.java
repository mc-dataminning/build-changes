...
public class fyo extends fys {
   ...
   private static final alf<dkp> y = dkw.b;
   ...
   @Nullable
   private static epn a(jg<dmr> $$0, String $$1, int $$2) {
      ...
      int $$9 = Math.min($$2 + $$5, eeq.c);
      int $$10 = $$9 - $$2;

      Optional<jf.c<dmr>> $$11;
      try {
      ...
      if ($$11.isEmpty()) {
         ...
         return new epn($$10, $$11.get().a());
      }
   }

   private static List<epn> a(jg<dmr> $$0, String $$1) {
      List<epn> $$2 = Lists.newArrayList();
      String[] $$3 = $$1.split(",");
      int $$4 = 0;
   ...
   public static epq a(jg<dmr> $$0, jg<dkp> $$1, jg<ert> $$2, jg<eqr> $$3, String $$4, epq $$5) {
      Iterator<String> $$6 = Splitter.on(';').split($$4).iterator();
      if (!$$6.hasNext()) {
         return epq.a($$1, $$2, $$3);
      } else {
         List<epn> $$7 = a($$0, $$6.next());
         if ($$7.isEmpty()) {
            return epq.a($$1, $$2, $$3);
         } else {
            jf.c<dkp> $$8 = $$1.b(y);
   ...
   protected void aO_() {
      ...
      this.E = new ftj(this.p, 50, 40, this.n - 100, 20, this.A);
      this.E.f(1230);
      ged $$0 = this.z.a.m().k();
      jt $$1 = $$0.a();
      cuw $$2 = $$0.h().b();
      ...
      jg<ert> $$4 = $$1.f(mh.bd);
      jg<eqr> $$5 = $$1.f(mh.bb);
      jg<dmr> $$6 = $$1.f(mh.i).a($$2);
      this.E.a(a(this.z.l()));
      this.F = this.z.l();
      this.d(this.E);
      this.C = this.c(new fyo.a($$1, $$2));
      this.D = this.c(fta.a(wy.c("createWorld.customize.presets.select"), $$4x -> {
         epq $$5x = a($$6, $$3, $$4, $$5, this.E.a(), this.F);
         this.z.a($$5x);
         this.m.a(this.z);
      }).a(this.n / 2 - 155, this.o - 28, 150, 20).a());
      this.c(fta.a(wx.e, $$0x -> this.m.a(this.z)).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   ...
   class a extends ftw<fyo.a.a> {
      public a(final jt $$0, final cuw $$1) {
         super(fyo.this.m, fyo.this.n, fyo.this.o - 117, 80, 24);

         for (jf<epo> $$2 : $$0.f(mh.aS).c(axg.a)) {
            Set<dmr> $$3 = $$2.a().b().e().stream().map($$0x -> $$0x.b().b()).filter($$1x -> !$$1x.a($$1)).collect(Collectors.toSet());
            if (!$$3.isEmpty()) {
               fyo.c
                  .info(
               ...
               this.b(new fyo.a.a($$2));
            }
         }
      }

      public void a(@Nullable fyo.a.a $$0) {
         super.a($$0);
         fyo.this.c($$0 != null);
      }
      ...
      public class a extends ftw.a<fyo.a.a> {
         ...
         void b() {
            a.this.a(this);
            fyo.this.F = this.c.b();
            fyo.this.E.a(fyo.a(fyo.this.F));
            fyo.this.E.b(false);
         }

         private void a(fsm $$0, int $$1, int $$2, czj $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new czn($$3), $$1 + 2, $$2 + 2);
         }

         private void a(fsm $$0, int $$1, int $$2) {
            $$0.a(grc::H, fyo.b, $$1, $$2, 18, 18);
         }
