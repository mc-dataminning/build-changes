...
public class fyo {
   ...
   static final ThreadLocal<fyo.d> f = ThreadLocal.withInitial(fyo.d::new);

   public fyo(fam $$0) {
      this.d = $$0;
   }

   public void a(cwe $$0, glc $$1, dnb $$2, ib $$3, eub $$4, euf $$5, boolean $$6, axd $$7, long $$8, int $$9) {
      boolean $$10 = ezi.P() && $$2.h() == 0 && $$1.a();
      ept $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(cwe $$0, glc $$1, dnb $$2, ib $$3, eub $$4, euf $$5, boolean $$6, axd $$7, long $$8, int $$9) {
      ...
      for (ih $$14 : c) {
         $$7.b($$8);
         List<fyp> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dac.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<fyp> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(cwe $$0, glc $$1, dnb $$2, ib $$3, eub $$4, euf $$5, boolean $$6, axd $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      ib.a $$11 = $$3.j();

      for (ih $$12 : c) {
         $$7.b($$8);
         List<fyp> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dac.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = fxq.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<fyp> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(cwe $$0, dnb $$1, ib $$2, eub $$3, euf $$4, List<fyp> $$5, float[] $$6, BitSet $$7, fyo.b $$8, int $$9) {
      for (fyp $$10 : $$5) {
   ...
   private void a(
      cwe $$0, dnb $$1, ib $$2, euf $$3, eub.a $$4, fyp $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(cwe $$0, dnb $$1, ib $$2, int[] $$3, ih $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(cwe $$0, dnb $$1, ib $$2, int $$3, int $$4, boolean $$5, eub $$6, euf $$7, List<fyp> $$8, BitSet $$9) {
      for (fyp $$10 : $$8) {
         if ($$5) {
   ...
   public void a(eub.a $$0, euf $$1, @Nullable dnb $$2, glc $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      axd $$9 = axd.a();
      long $$10 = 42L;
   ...
   private static void a(eub.a $$0, euf $$1, float $$2, float $$3, float $$4, List<fyp> $$5, int $$6, int $$7) {
      for (fyp $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new fyo.e[]{fyo.e.k, fyo.e.d, fyo.e.k, fyo.e.j, fyo.e.e, fyo.e.j, fyo.e.e, fyo.e.d},
         new fyo.e[]{fyo.e.k, fyo.e.c, fyo.e.k, fyo.e.i, fyo.e.e, fyo.e.i, fyo.e.e, fyo.e.c},
         new fyo.e[]{fyo.e.l, fyo.e.c, fyo.e.l, fyo.e.i, fyo.e.f, fyo.e.i, fyo.e.f, fyo.e.c},
         new fyo.e[]{fyo.e.l, fyo.e.d, fyo.e.l, fyo.e.j, fyo.e.f, fyo.e.j, fyo.e.f, fyo.e.d}
      ),
      b(
         new ih[]{ih.f, ih.e, ih.c, ih.d},
         1.0F,
         true,
         new fyo.e[]{fyo.e.f, fyo.e.d, fyo.e.f, fyo.e.j, fyo.e.l, fyo.e.j, fyo.e.l, fyo.e.d},
         new fyo.e[]{fyo.e.f, fyo.e.c, fyo.e.f, fyo.e.i, fyo.e.l, fyo.e.i, fyo.e.l, fyo.e.c},
         new fyo.e[]{fyo.e.e, fyo.e.c, fyo.e.e, fyo.e.i, fyo.e.k, fyo.e.i, fyo.e.k, fyo.e.c},
         new fyo.e[]{fyo.e.e, fyo.e.d, fyo.e.e, fyo.e.j, fyo.e.k, fyo.e.j, fyo.e.k, fyo.e.d}
      ),
      c(
         new ih[]{ih.b, ih.a, ih.f, ih.e},
         0.8F,
         true,
         new fyo.e[]{fyo.e.b, fyo.e.k, fyo.e.b, fyo.e.e, fyo.e.h, fyo.e.e, fyo.e.h, fyo.e.k},
         new fyo.e[]{fyo.e.b, fyo.e.l, fyo.e.b, fyo.e.f, fyo.e.h, fyo.e.f, fyo.e.h, fyo.e.l},
         new fyo.e[]{fyo.e.a, fyo.e.l, fyo.e.a, fyo.e.f, fyo.e.g, fyo.e.f, fyo.e.g, fyo.e.l},
         new fyo.e[]{fyo.e.a, fyo.e.k, fyo.e.a, fyo.e.e, fyo.e.g, fyo.e.e, fyo.e.g, fyo.e.k}
      ),
      d(
         new ih[]{ih.e, ih.f, ih.a, ih.b},
         0.8F,
         true,
         new fyo.e[]{fyo.e.b, fyo.e.k, fyo.e.h, fyo.e.k, fyo.e.h, fyo.e.e, fyo.e.b, fyo.e.e},
         new fyo.e[]{fyo.e.a, fyo.e.k, fyo.e.g, fyo.e.k, fyo.e.g, fyo.e.e, fyo.e.a, fyo.e.e},
         new fyo.e[]{fyo.e.a, fyo.e.l, fyo.e.g, fyo.e.l, fyo.e.g, fyo.e.f, fyo.e.a, fyo.e.f},
         new fyo.e[]{fyo.e.b, fyo.e.l, fyo.e.h, fyo.e.l, fyo.e.h, fyo.e.f, fyo.e.b, fyo.e.f}
      ),
      e(
         new ih[]{ih.b, ih.a, ih.c, ih.d},
         0.6F,
         true,
         new fyo.e[]{fyo.e.b, fyo.e.d, fyo.e.b, fyo.e.j, fyo.e.h, fyo.e.j, fyo.e.h, fyo.e.d},
         new fyo.e[]{fyo.e.b, fyo.e.c, fyo.e.b, fyo.e.i, fyo.e.h, fyo.e.i, fyo.e.h, fyo.e.c},
         new fyo.e[]{fyo.e.a, fyo.e.c, fyo.e.a, fyo.e.i, fyo.e.g, fyo.e.i, fyo.e.g, fyo.e.c},
         new fyo.e[]{fyo.e.a, fyo.e.d, fyo.e.a, fyo.e.j, fyo.e.g, fyo.e.j, fyo.e.g, fyo.e.d}
      ),
      f(
         new ih[]{ih.a, ih.b, ih.c, ih.d},
         0.6F,
         true,
         new fyo.e[]{fyo.e.g, fyo.e.d, fyo.e.g, fyo.e.j, fyo.e.a, fyo.e.j, fyo.e.a, fyo.e.d},
         new fyo.e[]{fyo.e.g, fyo.e.c, fyo.e.g, fyo.e.i, fyo.e.a, fyo.e.i, fyo.e.a, fyo.e.c},
         new fyo.e[]{fyo.e.h, fyo.e.c, fyo.e.h, fyo.e.i, fyo.e.b, fyo.e.i, fyo.e.b, fyo.e.c},
         new fyo.e[]{fyo.e.h, fyo.e.d, fyo.e.h, fyo.e.j, fyo.e.b, fyo.e.j, fyo.e.b, fyo.e.d}
      );
      ...
      final fyo.e[] k;
      final fyo.e[] l;
      private static final fyo.a[] m = ac.a(new fyo.a[6], $$0 -> {
         $$0[ih.a.d()] = a;
         $$0[ih.b.d()] = b;
         $$0[ih.c.d()] = c;
         $$0[ih.d.d()] = d;
      ...
      private a(ih[] $$0, float $$1, boolean $$2, fyo.e[] $$3, fyo.e[] $$4, fyo.e[] $$5, fyo.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(cwe $$0, dnb $$1, ib $$2, ih $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dnb $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dnb $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dnb $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dnb $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final fyo.c[] k = ac.a(new fyo.c[6], $$0 -> {
         $$0[ih.a.d()] = a;
         $$0[ih.b.d()] = b;
         $$0[ih.c.d()] = c;
         $$0[ih.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dnb $$0, cwe $$1, ib $$2) {
         long $$3 = $$2.a();
         if (this.a) {
