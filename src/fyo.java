...
public class fyo {
   ...
   private fyo(int $$0, List<fyq> $$1) {
      this.a = $$1.toArray(fyq[]::new);
      this.b = $$1.size();
   }

   private List<fyq> c() {
      List<fyq> $$0 = new ArrayList<>(this.d());
