...
public class fyo implements fyr.a, AutoCloseable {
   ...
   ekg[] f;
   @Nullable
   private final fyo.a g;
   private final ano h;

   public fyo(aer $$0, gah $$1, ekg $$2, ano $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gaf $$4 = $$3.a(gaf.a).orElse(gaf.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ekg[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fyj.a(this.f, $$0);
   ...
   @Nullable
   private fyo.a a(gah $$0, int $$1, int $$2, gaf $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fyo.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fyo.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fyo.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fyo.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fyo.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fyo.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ekg[] $$4) {
   ...
   class a {
      ...
      a(List<fyo.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fyo.this.c;
         int $$4 = this.b($$2) * fyo.this.d;
         fyo.this.a($$0, $$1, $$3, $$4, fyo.this.f);
      }

      public fyq a() {
         return fyo.this.new d(this, this.d ? fyo.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ekg[] b = new ekg[fyo.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fyo.this.c >> $$0;
            int $$2 = fyo.this.d >> $$0;
            this.b[$$0] = new ekg($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fyo.d $$2) {
         fyo.a $$3 = $$2.d;
         List<fyo.b> $$4 = $$3.b;
         fyo.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fyo.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fyo.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fyo.this.f[$$2].a($$3 + ($$0.a($$1) * fyo.this.c >> $$2), $$4 + ($$0.b($$1) * fyo.this.d >> $$2));
      }
   ...
   class d implements fyq {
      int b;
      int c;
      final fyo.a d;
      @Nullable
      private final fyo.c e;

      d(fyo.a $$0, @Nullable fyo.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
