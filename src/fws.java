...
public class fws extends fpc<fws.a> {
   ...
   private final fwo N;
   private final List<fws.d> O = Lists.newArrayList();
   private final fws.a P = new fws.b();
   private final List<fws.c> Q = Lists.newArrayList();

   public fws(fwo $$0, fmg $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable fws.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(gga $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new fws.d(this.N, $$0.a($$1)));
      }

      this.c();
   }

   public void a(List<hfx> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (hfx $$2 : $$0) {
         this.Q.add(new fws.c(this.N, $$2));
      }

      this.c();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         fws.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fpc.a<fws.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fws.a {
      private final fmg a = fmg.Q();

      @Override
      public void a(fns $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fws.G, this.a.z.n / 2 - this.a.h.a(fws.G) / 2, $$10, 16777215, false);
         String $$11 = ftn.a(ae.c());
   ...
   public static class c extends fws.a {
   ...
   public class d extends fws.a {
      ...
      protected d(final fwo $$1, final gfz $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = fmg.Q();
         this.j = fti.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fns $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            fws.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == ab.b().e() ? gfz.b.e : gfz.b.d);
         ...
         xv $$15 = (xv)(this.i.g() == gfz.b.d ? this.i.h.f().a(n.m) : this.i.c);
         ...
         if (this.h.n.ac().c() || $$8) {
            ...
            if (this.e()) {
               if ($$18 < 32 && $$18 > 16) {
                  $$0.a(glv::C, fws.y, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glv::C, fws.z, $$3, $$2, 32, 32);
               }
            }

            if ($$1 > 0) {
               if ($$18 < 16 && $$19 < 16) {
                  $$0.a(glv::C, fws.A, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glv::C, fws.B, $$3, $$2, 32, 32);
               }
            }

            if ($$1 < this.g.G().c() - 1) {
               if ($$18 < 16 && $$19 > 16) {
                  $$0.a(glv::C, fws.C, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glv::C, fws.D, $$3, $$2, 32, 32);
               }
            }
         }
      }
      ...
      protected void a(fns $$0, int $$1, int $$2, alz $$3) {
         $$0.a(glv::C, $$3, $$1, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
      }
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fws.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fws.this.s();
         double $$4 = $$1 - (double)fws.this.e(fws.this.aI_().indexOf(this));
         if ($$3 <= 32.0) {
