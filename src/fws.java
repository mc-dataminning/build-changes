...
public class fws implements fwu {
   ...
   private static boolean a(List<cwo> $$0, int $$1) {
      return $$0.size() >= $$1;
   }

   private int a(List<cwo> $$0) {
      return this.r.b().skip((long)$$0.size()).mapToInt(cwo::M).sum();
   }

   private void a(int $$0, int $$1, int $$2, List<cwo> $$3, int $$4, fob $$5, fod $$6) {
      int $$7 = $$3.size() - $$0;
