public class fws<T extends cix> extends ful<T> {
   ...
   public static fxi a(fxg $$0) {
      fxk $$1 = new fxk();
      fxl $$2 = $$1.a();
      $$2.a("shoulders", fxh.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), fxe.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         fxh.c()
         ...
         fxe.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         fxh.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         fxe.a(-2.0F, 6.9F + ayz.b(0.20420352F) * 10.0F, -0.5F + ayz.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", fxh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fxe.a);
      fxh $$4 = fxh.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, fxe.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, fxe.a(10.0F, 4.0F, 0.0F));
   ...
   private static <T extends cix> void a(T $$0, fxc $$1, int $$2) {
