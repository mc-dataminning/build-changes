...
public class fzm {
   ...
   public boolean a(jd $$0) {
      if (this.b.s.a(this.b.r, $$0, this.j)) {
         ...
         if (!this.b.s.eU().g().a($$2, $$1, $$0, this.b.s)) {
            ...
            dfy $$3 = $$2.b();
            if ($$3 instanceof djg && !this.b.s.gw()) {
               return false;
            } else if ($$2.i()) {
               return false;
            } else {
   ...
   public boolean b(jd $$0, ji $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.i()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               dnm $$4 = $$3.w();
               this.b.aj().a(new gtt($$4.f(), avq.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, gty.t(), $$0));
            }
   ...
   public bqr a(gdz $$0, bqq $$1, eww $$2) {
      this.m();
   ...
   private bqr b(gdz $$0, bqq $$1, eww $$2) {
      jd $$3 = $$2.a();
      cuq $$4 = $$0.b($$1);
      if (this.j == dct.d) {
         return bqr.a;
   ...
   public gdz a(fzd $$0, awa $$1, ffy $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public gdz a(fzd $$0, awa $$1, ffy $$2, boolean $$3, boolean $$4) {
      return new gdz(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }
   ...
   public bqr a(cmx $$0, bsr $$1, ewx $$2, bqq $$3) {
      this.m();
      exa $$4 = $$2.e().a($$1.du(), $$1.dw(), $$1.dA());
   ...
   public boolean g() {
      return this.b.s.bS() && this.b.s.dd() instanceof btf;
   }
