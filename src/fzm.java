...
public abstract class fzm<T extends bmk, M extends fjv<T>> extends fyk<T> implements gag<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gcw<T, M>> g = Lists.newArrayList();

   public fzm(fyl.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gcw<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   @Nullable
   protected ftn a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      ahg $$4 = this.a($$0);
      if ($$2) {
         return ftn.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? ftn.r($$4) : null;
      }
   }

   public static int c(bmk $$0, float $$1) {
      return gec.a(gec.a($$1), gec.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected void a(T $$0, epz $$1, float $$2, float $$3, float $$4) {
      if (this.a($$0)) {
