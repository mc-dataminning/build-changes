...
public class bhk {
   ...
   private JsonElement a(List<Pair<dlq, bhu<bhm>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bhu)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dlq, bhu<bhm>> $$3 : $$0) {
         bhu<bhm> $$4 = (bhu<bhm>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dlq)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bhs> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bha.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bhi $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bhq $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bhq.b $$3 = (bhq.b)$$1x.getFirst();
         bhq.a $$4 = (bhq.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bhn> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bhn>, ToDoubleFunction<bhn>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bhn::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bhn::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bhn::c));
      return $$1;
   }
}
