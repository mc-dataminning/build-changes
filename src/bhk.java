...
public class bhk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bhv.y);
      Type<?> $$1 = this.getOutputSchema().getType(bhv.y);
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bjj.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bjj.a($$1.substring(0, $$2))));
