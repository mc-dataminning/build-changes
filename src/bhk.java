...
public class bhk {
   ...
   public static bhs<bgi> a(Predicate<he<brc>> $$0, bpb<hd> $$1, bpb<hd> $$2, boolean $$3, Optional<Byte> $$4) {
      int $$5 = 5;
      int $$6 = 20;
      MutableLong $$7 = new MutableLong(0L);
      Long2ObjectMap<bhk.a> $$8 = new Long2ObjectOpenHashMap();
      bjb<bgi> $$9 = bld.a(
         (Function<bld.b<bgi>, ? extends App<bld.c<bgi>, blg<bgi>>>)($$6x -> $$6x.group($$6x.c($$2)).apply($$6x, $$5xx -> ($$6xx, $$7x, $$8x) -> {
                  if ($$3 && $$7x.h_()) {
                     return false;
                     ...
                     bqz $$9x = $$6xx.w();
                     $$8.long2ObjectEntrySet().removeIf($$1xxxx -> !((bhk.a)$$1xxxx.getValue()).b($$8x));
                     Predicate<gu> $$10 = $$2xxxx -> {
                        bhk.a $$3xxxx = (bhk.a)$$8.get($$2xxxx.a());
                        if ($$3xxxx == null) {
                           return true;
                        } else if (!$$3xxxx.c($$8x)) {
                           return false;
                     ...
                     Set<Pair<he<brc>, gu>> $$11 = $$9x.c($$0, $$10, $$7x.di(), 48, bqz.b.a).limit(5L).collect(Collectors.toSet());
                     dxt $$12 = a($$7x, $$11);
                     if ($$12 != null && $$12.j()) {
                        gu $$13 = $$12.m();
                        ...
                        for (Pair<he<brc>, gu> $$14 : $$11) {
                           $$8.computeIfAbsent(((gu)$$14.getSecond()).a(), $$2xxxx -> new bhk.a($$6xx.z, $$8x));
                        }
                     }
      ...
      return $$2 == $$1 ? $$9 : bld.a((Function<bld.b<bgi>, ? extends App<bld.c<bgi>, blg<bgi>>>)($$2x -> $$2x.group($$2x.c($$1)).apply($$2x, $$1xx -> $$9)));
   }
