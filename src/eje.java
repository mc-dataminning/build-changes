...
public class eje implements eiz {
   public static final Codec<eje> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ma.e.q().fieldOf("block").flatXmap(eje::a, DataResult::success).orElse((dpn)dkn.fu).forGetter($$0x -> $$0x.b),
   ...
   public final ju<dkl> h;
   private final ObjectArrayList<jm> i;

   private static DataResult<dpn> a(dkl $$0) {
      return $$0 instanceof dpn $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public eje(dpn $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, ju<dkl> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
