...
public class eje extends ejm<elx> {
   private static final eaq a = eaq.a(dmh.L);
   private final eah b = dmh.L.m();
   private final eah c = dmh.ki.m();
   private final eah d = dmh.bc.m();
   private final eah ao = dmh.J.m();

   public eje(Codec<elx> $$0) {
      super($$0);
   }
   ...
   private static void b(djz $$0, iu $$1) {
      $$0.a($$1, dmh.M.m(), 3);
      $$0.a($$1, dxh.O).ifPresent($$1x -> $$1x.a(ezd.aX, $$1.a()));
   }
}
