...
public class edh extends edm {
   ...
   public List<ebu.a> a(czm $$0, BiConsumer<id, dpi> $$1, axt $$2, int $$3, id $$4, ebe $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = axm.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, axm.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<edh.a> $$13 = Lists.newArrayList();
      $$13.add(new edh.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               id $$21 = $$4.b(axm.a($$19), $$12 - 1, axm.a($$20));
               id $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  id $$27 = new id($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new edh.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<ebu.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(czm $$0, BiConsumer<id, dpi> $$1, axt $$2, id $$3, id $$4, boolean $$5, ebe $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         id $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            id $$13 = $$3.b(axm.d(0.5F + (float)$$12 * $$9), axm.d(0.5F + (float)$$12 * $$10), axm.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dis.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(czm $$0, BiConsumer<id, dpi> $$1, axt $$2, int $$3, id $$4, List<edh.a> $$5, ebe $$6) {
      for (edh.a $$7 : $$5) {
         int $$8 = $$7.a();
         id $$9 = new id($$4.u(), $$8, $$4.w());
