...
public class fdc {
   ...
   private static final Queue<fdc.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fdc.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fdc::a), fcz::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fdc::a), fcz::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fdc.a(this.b) + ", type=" + fdc.b(this.c) + ", severity=" + fdc.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
