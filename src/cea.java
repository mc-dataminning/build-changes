...
public interface cea extends cer {
   void b(boolean var1);

   void a(bog var1, coz var2, chz var3, float var4);
   ...
   default void b(bog $$0, float $$1) {
      blt $$2 = cib.a($$0, cpc.vP);
      coz $$3 = $$0.b($$2);
      if ($$0.b(cpc.vP)) {
         cnh.a($$0.dM(), $$0, $$2, $$3, $$1, (float)(14 - $$0.dM().ak().a() * 4));
      }

      this.a();
   }

   default void a(bog $$0, bog $$1, chz $$2, float $$3, float $$4) {
      double $$5 = $$1.dr() - $$0.dr();
      double $$6 = $$1.dx() - $$0.dx();
      double $$7 = Math.sqrt($$5 * $$5 + $$6 * $$6);
      double $$8 = $$1.e(0.3333333333333333) - $$2.dt() + $$7 * 0.2F;
      Vector3f $$9 = this.a($$0, new ens($$5, $$8, $$6), $$3);
      $$2.c((double)$$9.x(), (double)$$9.y(), (double)$$9.z(), $$4, (float)(14 - $$0.dM().ak().a() * 4));
      $$0.a(atk.gg, 1.0F, 1.0F / ($$0.eh().i() * 0.4F + 0.8F));
   }

   default Vector3f a(bog $$0, ens $$1, float $$2) {
