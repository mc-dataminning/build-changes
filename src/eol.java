...
public class eol {
   ...
   static class a implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new eol.k($$0, $$1);
      }
   }

   static class b implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         if ($$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d && $$0.c[jm.b.d()] && !$$0.b[jm.b.d()].d) {
            eol.v $$1 = $$0.b[jm.f.d()];
            return $$1.c[jm.b.d()] && !$$1.b[jm.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         ...
         $$1.b[jm.f.d()].d = true;
         $$1.b[jm.b.d()].d = true;
         $$1.b[jm.f.d()].b[jm.b.d()].d = true;
         return new eol.l($$0, $$1);
      }
   }

   static class c implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         return $$0.c[jm.b.d()] && !$$0.b[jm.b.d()].d;
      }
      ...
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new eol.m($$0, $$1);
      }
   }

   static class d implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         if ($$0.c[jm.c.d()] && !$$0.b[jm.c.d()].d && $$0.c[jm.b.d()] && !$$0.b[jm.b.d()].d) {
            eol.v $$1 = $$0.b[jm.c.d()];
            return $$1.c[jm.b.d()] && !$$1.b[jm.b.d()].d;
         } else {
            return false;
      ...
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         ...
         $$1.b[jm.c.d()].d = true;
         $$1.b[jm.b.d()].d = true;
         $$1.b[jm.c.d()].b[jm.b.d()].d = true;
         return new eol.n($$0, $$1);
      }
   }

   static class e implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         return $$0.c[jm.c.d()] && !$$0.b[jm.c.d()].d;
      }

      @Override
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         eol.v $$3 = $$1;
         if (!$$1.c[jm.c.d()] || $$1.b[jm.c.d()].d) {
            $$3 = $$1.b[jm.d.d()];
         }

         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new eol.o($$0, $$3);
      }
   }

   static class f implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         return true;
      }
      ...
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         $$1.d = true;
         return new eol.s($$0, $$1, $$2);
      }
   }

   static class g implements eol.i {
      @Override
      public boolean a(eol.v $$0) {
         return !$$0.c[jm.e.d()] && !$$0.c[jm.f.d()] && !$$0.c[jm.c.d()] && !$$0.c[jm.d.d()] && !$$0.c[jm.b.d()];
      }

      @Override
      public eol.r a(jm $$0, eol.v $$1, azv $$2) {
         $$1.d = true;
         return new eol.t($$0, $$1);
      }
   }

   public static class h extends eol.r {
      ...
      private eol.v G;
      private eol.v H;
      private final List<eol.r> I = Lists.newArrayList();

      public h(azv $$0, int $$1, int $$2, jm $$3) {
         super(ems.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eol.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eol.p($$3, this.G));
         this.I.add(new eol.j($$3, this.H));
         List<eol.i> $$5 = Lists.newArrayList();
         $$5.add(new eol.b());
         $$5.add(new eol.d());
         $$5.add(new eol.e());
         $$5.add(new eol.a());
         ...
         elt $$10 = elt.a(this.b(1, 1, 1), this.b(23, 8, 21));
         elt $$11 = elt.a(this.b(34, 1, 1), this.b(56, 8, 21));
         elt $$12 = elt.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eol.u($$3, $$10, $$13++));
         this.I.add(new eol.u($$3, $$11, $$13++));
         this.I.add(new eol.q($$3, $$12));
      }
      ...
      private List<eol.v> b(azv $$0) {
         eol.v[] $$1 = new eol.v[75];
         ...
         eol.v $$23 = new eol.v(1003);
         eol.v $$24 = new eol.v(1001);
         eol.v $$25 = new eol.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jm.f.d()].d = true;
         this.H.b[jm.c.d()].d = true;
         this.H.b[jm.f.d()].b[jm.c.d()].d = true;
         this.H.b[jm.b.d()].d = true;
         this.H.b[jm.f.d()].b[jm.b.d()].d = true;
         this.H.b[jm.c.d()].b[jm.b.d()].d = true;
         this.H.b[jm.f.d()].b[jm.c.d()].b[jm.b.d()].d = true;
         ObjectArrayList<eol.v> $$26 = new ObjectArrayList();
      ...
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         int $$7 = Math.max($$0.N(), 64) - this.f.i();
      ...
      private void a(boolean $$0, int $$1, dgd $$2, azv $$3, elt $$4) {
         int $$5 = 24;
      ...
      private void a(dgd $$0, azv $$1, elt $$2) {
      ...
      private void b(dgd $$0, azv $$1, elt $$2) {
      ...
      private void c(dgd $$0, azv $$1, elt $$2) {
      ...
      private void d(dgd $$0, azv $$1, elt $$2) {
      ...
      private void e(dgd $$0, azv $$1, elt $$2) {
      ...
      private void f(dgd $$0, azv $$1, elt $$2) {
   ...
   interface i {
      boolean a(eol.v var1);

      eol.r a(jm var1, eol.v var2, azv var3);
   }

   public static class j extends eol.r {
      public j(jm $$0, eol.v $$1) {
         super(ems.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dil.ch.m(), dil.ch.m(), false);
   ...
   public static class k extends eol.r {
      public k(jm $$0, eol.v $$1) {
         super(ems.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         eol.v $$7 = this.B.b[jm.f.d()];
         eol.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jm.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jm.a.d()]);
         }
   ...
   public static class l extends eol.r {
      public l(jm $$0, eol.v $$1) {
         super(ems.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eol.r {
      public m(jm $$0, eol.v $$1) {
         super(ems.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jm.a.d()]);
         }

         eol.v $$7 = this.B.b[jm.b.d()];
         if ($$7.b[jm.b.d()] == null) {
   ...
   public static class n extends eol.r {
      public n(jm $$0, eol.v $$1) {
         super(ems.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         eol.v $$7 = this.B.b[jm.c.d()];
         eol.v $$8 = this.B;
         eol.v $$9 = $$7.b[jm.b.d()];
         eol.v $$10 = $$8.b[jm.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jm.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jm.a.d()]);
         }
   ...
   public static class o extends eol.r {
      public o(jm $$0, eol.v $$1) {
         super(ems.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eol.r {
      public p(jm $$0, eol.v $$1) {
         super(ems.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eol.r {
      public q(jm $$0, elt $$1) {
         super(ems.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends emf {
      protected static final dvo b = dil.hZ.m();
      protected static final dvo c = dil.ia.m();
      protected static final dvo d = dil.ib.m();
      protected static final dvo h = c;
      protected static final dvo i = dil.ii.m();
      protected static final boolean j = true;
      protected static final dvo k = dil.G.m();
      protected static final Set<dij> l = ImmutableSet.builder().add(dil.dO).add(dil.iC).add(dil.mW).add(k.b()).build();
      ...
      public r(ems $$0, jm $$1, int $$2, elt $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ems $$0, int $$1, jm $$2, eol.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static elt a(jm $$0, eol.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         elt $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dgd $$0, elt $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dvo $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.N() && $$11 != k) {
                        this.a($$0, dil.a.m(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(dgd $$0, elt $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dgd $$0, elt $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dvo $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(elt $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dgd $$0, elt $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clk $$6 = bup.D.a($$0.E(), buo.d);
            if ($$6 != null) {
               $$6.c($$6.eW());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dy()), buo.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eol.r {
      private int a;

      public s(jm $$0, eol.v $$1, azv $$2) {
         super(ems.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dgd $$0, dgb $$1, dxk $$2, azv $$3, elt $$4, del $$5, jh $$6) {
         ...
         if (this.B.b[jm.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jm.a.d()] && !this.B.c[jm.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eol.r {
      public t(jm $$0, eol.v $$1) {
         super(ems.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eol.r {
      private int a;

      public u(jm $$0, elt $$1, int $$2) {
         super(ems.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
