...
public class eol {
   private final List<ConcurrentLinkedQueue<eok>> a = ImmutableList.of(
   ...
   public void a(eok $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eok> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eok> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eok> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eok> j() {
