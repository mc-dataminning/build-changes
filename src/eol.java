...
public class eol {
   ...
   private static final Queue<eol.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eol.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eol::a), eoj::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eol::a), eoj::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eol.a(this.b) + ", type=" + eol.b(this.c) + ", severity=" + eol.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
