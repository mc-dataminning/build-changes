...
public class gef {
   ...
   public gef(ggo $$0, dby $$1, int $$2, gdm $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      ggo.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected ggo.b a(iz $$0) {
      int $$1 = ayz.a($$0.v() - this.b.I_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = ayz.b(ayz.a($$0.u(), 16), this.d);
         int $$3 = ayz.b(ayz.a($$0.w(), 16), this.e);
