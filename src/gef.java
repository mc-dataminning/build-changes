...
public class gef implements gei.a, AutoCloseable {
   ...
   epa[] f;
   @Nullable
   private final gef.a g;
   private final aqj h;

   public gef(ahg $$0, gfx $$1, epa $$2, aqj $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gfv $$4 = $$3.a(gfv.a).orElse(gfv.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new epa[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gea.a(this.f, $$0);
   ...
   @Nullable
   private gef.a a(gfx $$0, int $$1, int $$2, gfv $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gef.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gef.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gef.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gef.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gef.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gef.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, epa[] $$4) {
   ...
   class a {
      ...
      a(List<gef.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gef.this.c;
         int $$4 = this.b($$2) * gef.this.d;
         gef.this.a($$0, $$1, $$3, $$4, gef.this.f);
      }

      public geh a() {
         return gef.this.new d(this, this.d ? gef.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final epa[] b = new epa[gef.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gef.this.c >> $$0;
            int $$2 = gef.this.d >> $$0;
            this.b[$$0] = new epa($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gef.d $$2) {
         gef.a $$3 = $$2.d;
         List<gef.b> $$4 = $$3.b;
         gef.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gef.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gef.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gef.this.f[$$2].a($$3 + ($$0.a($$1) * gef.this.c >> $$2), $$4 + ($$0.b($$1) * gef.this.d >> $$2));
      }
   ...
   class d implements geh {
      int b;
      int c;
      final gef.a d;
      @Nullable
      private final gef.c e;

      d(gef.a $$0, @Nullable gef.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
