...
public class gef {
   ...
   static final ThreadLocal<gef.d> f = ThreadLocal.withInitial(gef.d::new);

   public gef(fgd $$0) {
      this.d = $$0;
   }

   public void a(daw $$0, gqv $$1, drx $$2, iz $$3, ezt $$4, ezx $$5, boolean $$6, azc $$7, long $$8, int $$9) {
      boolean $$10 = ffa.P() && $$2.h() == 0 && $$1.a();
      evm $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(daw $$0, gqv $$1, drx $$2, iz $$3, ezt $$4, ezx $$5, boolean $$6, azc $$7, long $$8, int $$9) {
      ...
      for (je $$14 : c) {
         $$7.b($$8);
         List<geg> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || deu.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<geg> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(daw $$0, gqv $$1, drx $$2, iz $$3, ezt $$4, ezx $$5, boolean $$6, azc $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      iz.a $$11 = $$3.j();

      for (je $$12 : c) {
         $$7.b($$8);
         List<geg> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || deu.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = gdh.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<geg> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(daw $$0, drx $$1, iz $$2, ezt $$3, ezx $$4, List<geg> $$5, float[] $$6, BitSet $$7, gef.b $$8, int $$9) {
      for (geg $$10 : $$5) {
   ...
   private void a(
      daw $$0, drx $$1, iz $$2, ezx $$3, ezt.a $$4, geg $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(daw $$0, drx $$1, iz $$2, int[] $$3, je $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(daw $$0, drx $$1, iz $$2, int $$3, int $$4, boolean $$5, ezt $$6, ezx $$7, List<geg> $$8, BitSet $$9) {
      for (geg $$10 : $$8) {
         if ($$5) {
   ...
   public void a(ezt.a $$0, ezx $$1, @Nullable drx $$2, gqv $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azc $$9 = azc.a();
      long $$10 = 42L;
   ...
   private static void a(ezt.a $$0, ezx $$1, float $$2, float $$3, float $$4, List<geg> $$5, int $$6, int $$7) {
      for (geg $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = ayu.a($$2, 0.0F, 1.0F);
            $$10 = ayu.a($$3, 0.0F, 1.0F);
            $$11 = ayu.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gef.e[]{gef.e.k, gef.e.d, gef.e.k, gef.e.j, gef.e.e, gef.e.j, gef.e.e, gef.e.d},
         new gef.e[]{gef.e.k, gef.e.c, gef.e.k, gef.e.i, gef.e.e, gef.e.i, gef.e.e, gef.e.c},
         new gef.e[]{gef.e.l, gef.e.c, gef.e.l, gef.e.i, gef.e.f, gef.e.i, gef.e.f, gef.e.c},
         new gef.e[]{gef.e.l, gef.e.d, gef.e.l, gef.e.j, gef.e.f, gef.e.j, gef.e.f, gef.e.d}
      ),
      b(
         new je[]{je.f, je.e, je.c, je.d},
         1.0F,
         true,
         new gef.e[]{gef.e.f, gef.e.d, gef.e.f, gef.e.j, gef.e.l, gef.e.j, gef.e.l, gef.e.d},
         new gef.e[]{gef.e.f, gef.e.c, gef.e.f, gef.e.i, gef.e.l, gef.e.i, gef.e.l, gef.e.c},
         new gef.e[]{gef.e.e, gef.e.c, gef.e.e, gef.e.i, gef.e.k, gef.e.i, gef.e.k, gef.e.c},
         new gef.e[]{gef.e.e, gef.e.d, gef.e.e, gef.e.j, gef.e.k, gef.e.j, gef.e.k, gef.e.d}
      ),
      c(
         new je[]{je.b, je.a, je.f, je.e},
         0.8F,
         true,
         new gef.e[]{gef.e.b, gef.e.k, gef.e.b, gef.e.e, gef.e.h, gef.e.e, gef.e.h, gef.e.k},
         new gef.e[]{gef.e.b, gef.e.l, gef.e.b, gef.e.f, gef.e.h, gef.e.f, gef.e.h, gef.e.l},
         new gef.e[]{gef.e.a, gef.e.l, gef.e.a, gef.e.f, gef.e.g, gef.e.f, gef.e.g, gef.e.l},
         new gef.e[]{gef.e.a, gef.e.k, gef.e.a, gef.e.e, gef.e.g, gef.e.e, gef.e.g, gef.e.k}
      ),
      d(
         new je[]{je.e, je.f, je.a, je.b},
         0.8F,
         true,
         new gef.e[]{gef.e.b, gef.e.k, gef.e.h, gef.e.k, gef.e.h, gef.e.e, gef.e.b, gef.e.e},
         new gef.e[]{gef.e.a, gef.e.k, gef.e.g, gef.e.k, gef.e.g, gef.e.e, gef.e.a, gef.e.e},
         new gef.e[]{gef.e.a, gef.e.l, gef.e.g, gef.e.l, gef.e.g, gef.e.f, gef.e.a, gef.e.f},
         new gef.e[]{gef.e.b, gef.e.l, gef.e.h, gef.e.l, gef.e.h, gef.e.f, gef.e.b, gef.e.f}
      ),
      e(
         new je[]{je.b, je.a, je.c, je.d},
         0.6F,
         true,
         new gef.e[]{gef.e.b, gef.e.d, gef.e.b, gef.e.j, gef.e.h, gef.e.j, gef.e.h, gef.e.d},
         new gef.e[]{gef.e.b, gef.e.c, gef.e.b, gef.e.i, gef.e.h, gef.e.i, gef.e.h, gef.e.c},
         new gef.e[]{gef.e.a, gef.e.c, gef.e.a, gef.e.i, gef.e.g, gef.e.i, gef.e.g, gef.e.c},
         new gef.e[]{gef.e.a, gef.e.d, gef.e.a, gef.e.j, gef.e.g, gef.e.j, gef.e.g, gef.e.d}
      ),
      f(
         new je[]{je.a, je.b, je.c, je.d},
         0.6F,
         true,
         new gef.e[]{gef.e.g, gef.e.d, gef.e.g, gef.e.j, gef.e.a, gef.e.j, gef.e.a, gef.e.d},
         new gef.e[]{gef.e.g, gef.e.c, gef.e.g, gef.e.i, gef.e.a, gef.e.i, gef.e.a, gef.e.c},
         new gef.e[]{gef.e.h, gef.e.c, gef.e.h, gef.e.i, gef.e.b, gef.e.i, gef.e.b, gef.e.c},
         new gef.e[]{gef.e.h, gef.e.d, gef.e.h, gef.e.j, gef.e.b, gef.e.j, gef.e.b, gef.e.d}
      );
      ...
      final gef.e[] k;
      final gef.e[] l;
      private static final gef.a[] m = ac.a(new gef.a[6], $$0 -> {
         $$0[je.a.d()] = a;
         $$0[je.b.d()] = b;
         $$0[je.c.d()] = c;
         $$0[je.d.d()] = d;
      ...
      private a(final je[] $$0, final float $$1, final boolean $$2, final gef.e[] $$3, final gef.e[] $$4, final gef.e[] $$5, final gef.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(daw $$0, drx $$1, iz $$2, je $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         drx $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         drx $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         drx $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         drx $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gef.c[] k = ac.a(new gef.c[6], $$0 -> {
         $$0[je.a.d()] = a;
         $$0[je.b.d()] = b;
         $$0[je.c.d()] = c;
         $$0[je.d.d()] = d;
   ...
   static class d {
      ...
      public float b(drx $$0, daw $$1, iz $$2) {
         long $$3 = $$2.a();
         if (this.a) {
