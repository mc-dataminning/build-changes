...
public class app extends ChannelInboundHandlerAdapter {
   ...
   private static String a(ajn $$0) {
      return String.format(Locale.ROOT, "%s§%d§%d", $$0.ae(), $$0.L(), $$0.M());
   }

   private static String b(ajn $$0) {
      return String.format(Locale.ROOT, "§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, $$0.K(), $$0.ae(), $$0.L(), $$0.M());
   }
