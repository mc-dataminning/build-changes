...
public class ber extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      CompoundListType<String, ?> $$0 = DSL.compoundList(DSL.string(), this.getInputSchema().getType(bfp.E));
   ...
   private <SF> TypeRewriteRule a(CompoundListType<String, SF> $$0) {
      ...
      Type<?> $$2 = this.getInputSchema().getType(bfp.E);
      ...
      return TypeRewriteRule.seq(
         ...
         this.fixTypeEverywhereTyped(
            ...
            $$0x -> $$0x.update(
                  DSL.remainderFinder(),
                  $$0xx -> $$0xx.update(
                        "id", $$0xxx -> Objects.equals(bgz.a($$0xxx.asString("")), "minecraft:new_village") ? $$0xxx.createString("minecraft:village") : $$0xxx
                     )
               )
         )
      );
