...
public class ber extends bbd {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), ber::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", ber::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", ber::k);
         $$0 = this.a($$0, "minecraft:fox", ber::j);
         $$0 = this.a($$0, "minecraft:item", ber::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", ber::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", ber::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", ber::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", ber::e);
         return this.a($$0, "minecraft:piglin", ber::d);
      });
   }
