...
public class dth {
   ...
   @Nullable
   @VisibleForTesting
   public dth.b a(dcz $$0, jd $$1, ji $$2, ji $$3) {
      LoadingCache<jd, dtg> $$4 = a($$0, false);
      return this.a($$1, $$2, $$3, $$4);
   }

   @Nullable
   private dth.b a(jd $$0, ji $$1, ji $$2, LoadingCache<jd, dtg> $$3) {
   ...
   @Nullable
   public dth.b a(dcz $$0, jd $$1) {
      LoadingCache<jd, dtg> $$2 = a($$0, false);
   ...
   public static LoadingCache<jd, dtg> a(dcz $$0, boolean $$1) {
   ...
   static class a extends CacheLoader<jd, dtg> {
      private final dcz a;
      private final boolean b;

      public a(dcz $$0, boolean $$1) {
         this.a = $$0;
         this.b = $$1;
      }
   ...
   public static class b {
      ...
      private final ji b;
      private final ji c;
      private final LoadingCache<jd, dtg> d;
      private final int e;
      private final int f;
      private final int g;

      public b(jd $$0, ji $$1, ji $$2, LoadingCache<jd, dtg> $$3, int $$4, int $$5, int $$6) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
