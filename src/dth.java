...
public abstract class dth<T extends Comparable<T>> {
   ...
   private final Codec<dth.a<T>> e = this.d.xmap(this::b, dth.a::b);

   protected dth(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dth.a<T> b(T $$0) {
      return new dth.a<>(this, $$0);
   }

   public dth.a<T> a(dsg<?, ?> $$0) {
      return new dth.a<>(this, $$0.c(this));
   }

   public Stream<dth.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dth<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dsg<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.a(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dth<T> a, T b) {
      public a(dth<T> a, T b) {
         if (!a.a().contains(b)) {
