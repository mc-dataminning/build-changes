...
public class djh<T> implements djj<T> {
   ...
   private djh(ih<T> $$0, int $$1, djk<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private djh(ih<T> $$0, T[] $$1, djk<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public djj<T> c() {
      return new djh<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
