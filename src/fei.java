...
public class fei implements jo {
   public static final Codec<fei> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> af.a($$0, 3).map($$0x -> new fei((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final yw<ByteBuf, fei> b = new yw<ByteBuf, fei>() {
      public fei a(ByteBuf $$0) {
         return vu.f($$0);
      }

      public void a(ByteBuf $$0, fei $$1) {
         vu.a($$0, $$1);
      }
   };
   public static final fei c = new fei(0.0, 0.0, 0.0);
   ...
   public static fei a(jz $$0) {
      return new fei((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static fei a(jz $$0, double $$1, double $$2, double $$3) {
      return new fei((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static fei b(jz $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static fei c(jz $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static fei a(jz $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public fei(double $$0, double $$1, double $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
   }

   public fei(Vector3f $$0) {
   ...
   public fei a(fei $$0) {
      return new fei($$0.d - this.d, $$0.e - this.e, $$0.f - this.f);
   }

   public fei d() {
      double $$0 = Math.sqrt(this.d * this.d + this.e * this.e + this.f * this.f);
      return $$0 < 1.0E-5F ? c : new fei(this.d / $$0, this.e / $$0, this.f / $$0);
   }

   public double b(fei $$0) {
      return this.d * $$0.d + this.e * $$0.e + this.f * $$0.f;
   }

   public fei c(fei $$0) {
      return new fei(this.e * $$0.f - this.f * $$0.e, this.f * $$0.d - this.d * $$0.f, this.d * $$0.e - this.e * $$0.d);
   }
   ...
   public fei a(double $$0) {
      return this.a($$0, $$0, $$0);
   }

   public fei a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }

   public fei b(double $$0) {
      return this.b($$0, $$0, $$0);
   }
   ...
   public fei b(double $$0, double $$1, double $$2) {
      return new fei(this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public boolean a(fei $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.d;
      double $$4 = $$0.b() - this.e;
      double $$5 = $$0.c() - this.f;
   ...
   public fei d(double $$0, double $$1, double $$2) {
      return new fei(this.d * $$0, this.e * $$1, this.f * $$2);
   }

   public fei f() {
      return new fei(this.d, 0.0, this.f);
   }

   public fei a(azv $$0, float $$1) {
   ...
   public fei a(fei $$0, double $$1) {
      return new fei(azm.d($$1, this.d, $$0.d), azm.d($$1, this.e, $$0.e), azm.d($$1, this.f, $$0.f));
   }
   ...
   public static fei a(feh $$0) {
      return a($$0.i, $$0.j);
   }

   public static fei a(float $$0, float $$1) {
      ...
      return new fei((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public fei a(EnumSet<ja.a> $$0) {
      double $$1 = $$0.contains(ja.a.a) ? (double)azm.a(this.d) : this.d;
      double $$2 = $$0.contains(ja.a.b) ? (double)azm.a(this.e) : this.e;
      double $$3 = $$0.contains(ja.a.c) ? (double)azm.a(this.f) : this.f;
      return new fei($$1, $$2, $$3);
   }
   ...
   public fei a(ja.a $$0, double $$1) {
      double $$2 = $$0 == ja.a.a ? $$1 : this.d;
      double $$3 = $$0 == ja.a.b ? $$1 : this.e;
      double $$4 = $$0 == ja.a.c ? $$1 : this.f;
      return new fei($$2, $$3, $$4);
   }

   public fei a(ja $$0, double $$1) {
      jz $$2 = $$0.q();
      return new fei(this.d + $$1 * (double)$$2.u(), this.e + $$1 * (double)$$2.v(), this.f + $$1 * (double)$$2.w());
   }
