...
public class fei implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fei.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fei(List<fei.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fei a(BufferedReader $$0) {
      return new fei($$0.lines().flatMap($$0x -> fei.a.a($$0x).stream()).toList());
   }

   public static record a(fei.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fei.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fei.a(fei.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fei.a(fei.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fei.a(fei.b.b, $$3));
      ...
      static fei.a b(String $$0) {
         return new fei.a(fei.b.a, "glob:" + $$0);
      }

      static fei.a c(String $$0) {
         return new fei.a(fei.b.a, "regex:" + $$0);
      }

      static fei.a d(String $$0) {
         return new fei.a(fei.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fei.b a = FileSystem::getPathMatcher;
      fei.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
