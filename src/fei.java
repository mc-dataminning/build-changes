...
public class fei {
   ...
   public void a(chu $$0, ewm $$1, float $$2, int $$3, int $$4) {
      cjp $$5 = $$0.b(this.d);
   ...
   private void a(cjp $$0, ahd $$1, float $$2, ewm $$3, int $$4, int $$5) {
      gef $$6 = eva.N().a(gee.e).apply($$1);
