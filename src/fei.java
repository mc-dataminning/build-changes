...
public class fei extends fdz<cig> {
   ...
   private void a(ewt $$0, @Nullable Integer $$1, @Nullable ega $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.t;
      int $$8 = this.u;
      if ($$4 && !$$6) {
   ...
   private void a(ewt $$0, @Nullable Integer $$1, @Nullable ega $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
