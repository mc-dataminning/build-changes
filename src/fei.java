public class fei extends fdx {
   private final dhe m;
   private exl<dhe.a> n;
   private exl<Boolean> o;
   private exl<Boolean> p;
   ...
   protected void aN_() {
      ...
      this.o = this.d(
         exl.a(vf.c("advMode.mode.conditional"), vf.c("advMode.mode.unconditional"))
            .a()
            .a(this.r)
            .a(this.g / 2 - 50, 165, 100, 20, vf.c("advMode.type"), ($$0, $$1) -> this.r = $$1)
      );
      this.p = this.d(
         exl.a(vf.c("advMode.mode.autoexec.bat"), vf.c("advMode.mode.redstoneTriggered"))
            .a()
            .a(this.t)
