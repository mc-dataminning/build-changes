...
public record tw<S>(List<tw.a<S>> a) {
   public static <S> tw<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<tw.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<tw.a<S>> $$2 = new ArrayList<>();
