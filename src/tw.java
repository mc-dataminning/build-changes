...
public abstract class tw {
   ...
   private static volatile tw e = c();
   ...
   private static tw c() {
      ...
      return new tw() {
         ...
         @Override
         public aya a(xe $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> azj.c($$2xxx, $$1x, $$1) ? Optional.empty() : xe.a, xw.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = tw.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(aye.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract aya a(xe var1);

   public List<aya> a(List<xe> $$0) {
