...
public class ckn extends cle {
   ...
   public bix a(cnt $$0) {
      ...
      if (!$$1.B) {
         ...
         eju $$3 = $$0.l();
         hx $$4 = $$0.k();
         ceh $$5 = new ceh($$1, $$0.o(), $$3.c + (double)$$4.j() * 0.15, $$3.d + (double)$$4.k() * 0.15, $$3.e + (double)$$4.l() * 0.15, $$2);
         $$1.b($$5);
         $$2.h(1);
      }
   ...
   public static void a(clj $$0, byte $$1) {
   ...
   public static enum a {
      ...
      private static final IntFunction<ckn.a> f = asf.a(ckn.a::a, values(), asf.a.a);
      private final int g;
