...
public class ckn extends clw implements cma {
   private static final ajx<Integer> a = akb.a(ckn.class, ajz.b);
   private static final ajx<Integer> b = akb.a(ckn.class, ajz.b);
   private static final ajx<Integer> c = akb.a(ckn.class, ajz.b);
   private static final List<ajx<Integer>> d = ImmutableList.of(a, b, c);
   private static final ajx<Integer> bY = akb.a(ckn.class, ajz.b);
   ...
   private int cg;
   private final aqy ch = (aqy)new aqy(this.p_(), bry.a.f, bry.b.a).a(true);
   private static final cfw.a ci = ($$0, $$1) -> !$$0.aq().a(aws.y) && $$0.fM();
   private static final cfw cj = cfw.a().a(20.0).a(ci);

   public ckn(buq<? extends ckn> $$0, dgg $$1) {
      super($$0, $$1);
   ...
   @Override
   public void d_() {
      fay $$0 = this.dz().d(1.0, 0.6, 1.0);
      if (!this.dW().C && this.c(0) > 0) {
         buj $$1 = this.dW().a(this.c(0));
         if ($$1 != null) {
            double $$2 = $$0.e;
            ...
            $$0 = new fay($$0.d, $$2, $$0.f);
            fay $$3 = new fay($$1.dB() - this.dB(), 0.0, $$1.dH() - this.dH());
            if ($$3.j() > 9.0) {
               fay $$4 = $$3.d();
      ...
      this.h($$0);
      if ($$0.j() > 0.05) {
         this.v((float)ayy.d($$0.f, $$0.d) * (180.0F / (float)Math.PI) - 90.0F);
      }
      ...
      for (int $$6 = 0; $$6 < 2; $$6++) {
         ...
         if ($$8 != null) {
            ...
            float $$16 = (float)(ayy.d($$14, $$12) * 180.0F / (float)Math.PI) - 90.0F;
            float $$17 = (float)(-(ayy.d($$13, $$15) * 180.0F / (float)Math.PI));
   ...
   protected void a(arc $$0) {
      if (this.gp() > 0) {
         ...
         if ($$1 <= 0) {
            $$0.a(this, this.dB(), this.dF(), this.dH(), 7.0F, false, dgg.a.c);
            if (!this.bb()) {
               $$0.b(1023, this.dw(), 0);
            }
         }
         ...
         for (int $$2 = 1; $$2 < 3; $$2++) {
            if (this.af >= this.ce[$$2 - 1]) {
               ...
               if (($$0.am() == bsf.c || $$0.am() == bsf.d) && this.cf[$$2 - 1]++ > 15) {
                  float $$3 = 10.0F;
                  float $$4 = 5.0F;
                  double $$5 = ayy.a(this.ae, this.dB() - 10.0, this.dB() + 10.0);
                  double $$6 = ayy.a(this.ae, this.dD() - 5.0, this.dD() + 5.0);
                  double $$7 = ayy.a(this.ae, this.dH() - 10.0, this.dH() + 10.0);
               ...
               if ($$8 > 0) {
                  bvf $$9 = (bvf)$$0.a($$8);
                  if ($$9 != null && this.c($$9) && !(this.g((buj)$$9) > 900.0) && this.E($$9)) {
                     this.a($$2 + 1, $$9);
                  ...
                  List<bvf> $$10 = $$0.a(bvf.class, cj, this, this.cR().c(20.0, 8.0, 20.0));
                  if (!$$10.isEmpty()) {
                     bvf $$11 = $$10.get(this.ae.a($$10.size()));
                     this.a($$2, $$11.ar());
                  }
               }
            }
         ...
         if (this.cg > 0) {
            this.cg--;
            if (this.cg == 0 && $$0.O().b(dgc.c)) {
               boolean $$12 = false;
               int $$13 = ayy.d(this.dr() / 2.0F + 1.0F);
               int $$14 = ayy.d(this.ds());
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      cqc $$12 = new cqc(this.dW(), this, $$11.d());
      $$12.c(this);
      if ($$4) {
         $$12.a(true);
      }
   ...
   public boolean a(arc $$0, bsz $$1, float $$2) {
      if (this.a($$0, $$1)) {
         return false;
      } else if ($$1.a(awq.t) || $$1.d() instanceof ckn) {
         return false;
      } else if (this.gp() > 0 && !$$1.a(awq.d)) {
         return false;
      } else {
         if (this.gq()) {
            buj $$3 = $$1.c();
            if ($$3 instanceof cpc || $$3 instanceof cqg) {
               return false;
            }
         }

         buj $$4 = $$1.d();
         if ($$4 != null && $$4.aq().a(aws.y)) {
            return false;
         } else {
            if (this.cg <= 0) {
               this.cg = 20;
   ...
   public static bwm.a p() {
      return clw.gu().a(bwn.s, 300.0).a(bwn.v, 0.6F).a(bwn.l, 0.6F).a(bwn.m, 40.0).a(bwn.a, 4.0);
   }
   ...
   class a extends ccd {
      public a() {
         this.a(EnumSet.of(ccd.a.a, ccd.a.c, ccd.a.b));
      }

      @Override
      public boolean b() {
         return ckn.this.gp() > 0;
      }
   }
}
