...
public class hjm {
   ...
   private static final Set<aku> k = Sets.newHashSet();
   ...
   private final fll n;
   private boolean o;
   private final fdf p = new fdf();
   private final fdg q = this.p.e();
   private final hjl r;
   private final hjn s = new hjn();
   private final hjd t = new hjd(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hjm.a> w = new AtomicReference<>(hjm.a.c);
   private final Map<hij, hjd.a> x = Maps.newHashMap();
   private final Multimap<awa, hij> y = HashMultimap.create();
   private final List<hik> z = Lists.newArrayList();
   private final Map<hij, Integer> A = Maps.newHashMap();
   private final Map<hij, Integer> B = Maps.newHashMap();
   private final List<hjo> C = Lists.newArrayList();
   private final List<hik> D = Lists.newArrayList();
   private final List<hig> E = Lists.newArrayList();

   public hjm(hjp $$0, fll $$1, aur $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hjl($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fde::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hjm.a.c, hjm.a.a)) {
               String $$2 = this.n.aw().c();
               af.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hjm.a.a, hjm.a.b);
                     }
                  ...
                  this.w.compareAndSet(hjm.a.a, hjm.a.c);
               });
            }
         }

         return this.w.compareAndSet(hjm.a.b, hjm.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hij::s).forEach(this::c);
      this.D.clear();
      ...
      for (hik $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            fay $$3 = new fay($$0.h(), $$0.i(), $$0.j());
            hjd.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hij, hjd.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hij, hjd.a> $$6 = $$5.next();
         hjd.a $$7 = $$6.getValue();
         hij $$8 = $$6.getKey();
      ...
      Iterator<Entry<hij, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hij, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hij $$13 = $$12.getKey();
            if ($$13 instanceof hik) {
               ((hik)$$13).q();
            }
   ...
   private static boolean d(hij $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hij $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hij $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hij $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hjp.e) {
                  if ($$3 == hjp.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        fay $$11 = new fay($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hij.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hjd.a> $$16 = this.t.a($$3.g() ? fdf.c.b : fdf.c.a);
                           hjd.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hij $$0) {
      return ayy.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hij $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fde::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fde::e));
      }
   }
   ...
   public void a(fkp $$0) {
      if (this.o && $$0.h()) {
         fdh $$1 = new fdh($$0.b(), new fay($$0.l()), new fay($$0.m()));
