...
public class fsh {
   ...
   public boolean a(ib $$0) {
      if (this.b.s.a(this.b.r, $$0, this.j)) {
         ...
         if (!this.b.s.eU().d().a($$2, $$1, $$0, this.b.s)) {
            ...
            daa $$3 = $$2.b();
            if ($$3 instanceof ddi && !this.b.s.gw()) {
               return false;
            } else if ($$2.i()) {
               return false;
            } else {
               $$3.a($$1, $$0, $$2, (cis)this.b.s);
               ein $$4 = $$1.b_($$0);
   ...
   public boolean b(ib $$0, ih $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.i()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               dhm $$4 = $$3.w();
               this.b.ak().a(new gmh($$4.f(), atz.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, gmm.t(), $$0));
            }
   ...
   private boolean b(ib $$0) {
      cqk $$1 = this.b.s.eU();
      return $$0.equals(this.d) && cqk.c($$1, this.e);
   }
   ...
   public bnc a(fws $$0, bnb $$1, epn $$2) {
      this.m();
      if (!this.b.r.C_().a($$2.a())) {
         return bnc.e;
      } else {
         MutableObject<bnc> $$3 = new MutableObject();
         this.a(this.b.r, $$4 -> {
            $$3.setValue(this.b($$0, $$1, $$2));
            return new agu($$1, $$2, $$4);
         });
         return (bnc)$$3.getValue();
      }
   }

   private bnc b(fws $$0, bnb $$1, epn $$2) {
      ib $$3 = $$2.a();
      cqk $$4 = $$0.b($$1);
      if (this.j == cww.d) {
         return bnc.a;
         ...
         if (!$$6) {
            ...
            bne $$8 = $$7.a($$0.b($$1), this.b.r, $$0, $$1, $$2);
            if ($$8.a()) {
               return $$8.b();
            }

            if ($$8 == bne.d && $$1 == bnb.a) {
               bnc $$9 = $$7.a(this.b.r, $$0, $$2);
               if ($$9.a()) {
                  return $$9;
               }
            }
   ...
   public bnc a(cis $$0, bnb $$1) {
      if (this.j == cww.d) {
         ...
         MutableObject<bnc> $$2 = new MutableObject();
         this.a(this.b.r, $$3 -> {
            agv $$4 = new agv($$1, $$3);
            cqk $$5 = $$0.b($$1);
            if ($$0.gu().a($$5.d())) {
         ...
         return (bnc)$$2.getValue();
      }
   }

   public fws a(fry $$0, auj $$1, eyt $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public fws a(fry $$0, auj $$1, eyt $$2, boolean $$3, boolean $$4) {
      return new fws(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }

   public void a(cis $$0, bow $$1) {
      this.m();
   ...
   public bnc a(cis $$0, bow $$1, bnb $$2) {
      this.m();
      this.c.b(aft.a($$1, $$0.bS(), $$2));
      return this.j == cww.d ? bnc.d : $$0.a($$1, $$2);
   }

   public bnc a(cis $$0, bow $$1, epo $$2, bnb $$3) {
      this.m();
      epr $$4 = $$2.e().a($$1.dr(), $$1.dt(), $$1.dx());
      this.c.b(aft.a($$1, $$0.bS(), $$3, $$4));
      return this.j == cww.d ? bnc.d : $$1.a($$0, $$4, $$3);
   }

   public void a(int $$0, int $$1, int $$2, clx $$3, cis $$4) {
      clo $$5 = $$4.bZ;
      if ($$0 != $$5.j) {
         ...
         iu<cnj> $$6 = $$5.i;
         int $$7 = $$6.size();
         List<cqk> $$8 = Lists.newArrayListWithCapacity($$7);
         ...
         $$5.a($$1, $$2, $$3, $$4);
         Int2ObjectMap<cqk> $$10 = new Int2ObjectOpenHashMap();
   ...
   public void a(int $$0, ctp<?> $$1, boolean $$2) {
   ...
   public boolean g() {
      return this.b.s.bO() && this.b.s.cZ() instanceof bph;
   }
