...
public class fsh extends fse {
   ...
   public final fnr cn;
   private final asc cF;
   private final eut cG;
   private final List<ghi> cH = Lists.newArrayList();
   private int cI = 0;
   private double cJ;
   private double cK;
   private double cL;
   ...
   public fsh(evg $$0, fnq $$1, fnr $$2, asc $$3, eut $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.q());
      this.cp = $$0;
      this.cn = $$2;
      this.cF = $$3;
      ...
      this.cQ = $$5;
      this.cR = $$6;
      this.cH.add(new gia(this, $$0.ai()));
      this.cH.add(new ghn(this));
      this.cH.add(new ghm(this, $$0.ai(), $$1.G_()));
   }
   ...
   public boolean a(blu $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cgz) {
            this.cp.ai().a((ghy)(new ghs(this, (cgz)$$0, true)));
            this.cp.ai().a((ghy)(new ghs(this, (cgz)$$0, false)));
         }
   ...
   private void D() {
      ...
      if (this.w()) {
         ...
         this.cS++;
         boolean $$7 = aun.f($$2, $$3, $$4) > aun.k(2.0E-4) || this.cS >= 20;
   ...
   protected void h() {
      this.cn.b(new aen(this, aen.a.f, aun.d(this.u() * 100.0F)));
   }
   ...
   private boolean i(hx $$0) {
      eln $$1 = this.cH();
      eln $$2 = new eln((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   @Override
   public bjz fo() {
      return Objects.requireNonNullElse(this.cX, bjz.a);
   }
   ...
   public void a(agm<?> $$0) {
      ...
      if (t.equals($$0)) {
         ...
         bjz $$2 = (this.an.b(t) & 2) > 0 ? bjz.b : bjz.a;
         if ($$1 && !this.cW) {
            this.c($$2);
         } else if (!$$1 && this.cW) {
            this.ft();
      ...
      if (ao.equals($$0) && this.fw() && !this.db) {
         this.cp.ai().a((ghy)(new gho(this)));
      }
   }

   @Nullable
   public bmv q() {
      if (this.da() instanceof bmv $$0 && $$0.a()) {
         return $$0;
      }
   ...
   public void a(did $$0, boolean $$1) {
      if ($$0 instanceof dhr $$2) {
         this.cp.a(new fev($$2, $$1, this.cp.aQ()));
      } else {
         this.cp.a(new ffi($$0, $$1, this.cp.aQ()));
      }
   }
   ...
   public void d_() {
      ...
      boolean $$1 = this.co.h;
      boolean $$2 = this.M();
      this.cP = !this.fT().b && !this.bZ() && !this.bO() && this.g(bmw.f) && (this.bS() || !this.fD() && !this.g(bmw.a));
      float $$3 = aun.a(0.3F + crk.b(this), 0.0F, 1.0F);
      this.co.a(this.v(), $$3);
      ...
      if (this.co.g && !$$10 && !$$0 && !this.fT().b && !this.bO() && !this.e_()) {
         cmx $$11 = this.c(blz.e);
         if ($$11.a(cna.nS) && clr.d($$11) && this.fX()) {
      ...
      if (this.a(asl.a)) {
         int $$12 = this.P_() ? 10 : 1;
         this.dc = aun.a(this.dc + $$12, 0, 600);
      } else if (this.dc > 0) {
         this.a(asl.a);
         this.dc = aun.a(this.dc - 10, 0, 600);
      }
   ...
   private void G() {
      ...
      float $$0 = 0.0F;
      if (this.av) {
         if (this.cp.y != null && !this.cp.y.k() && !(this.cp.y instanceof fby)) {
            if (this.cp.y instanceof fdy) {
               this.r();
            }
         ...
         if (this.cw == 0.0F) {
            this.cp.ai().a(ght.b(arr.tM, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }

         $$0 = 0.0125F;
         this.av = false;
      } else if (this.a(blj.i) && !this.b(blj.i).a(60)) {
         $$0 = 0.006666667F;
      } else if (this.cw > 0.0F) {
         $$0 = -0.05F;
      }

      this.cw = aun.a(this.cw + $$0, 0.0F, 1.0F);
      this.L();
   }
   ...
   protected void f(float $$0, float $$1) {
      if (this.H()) {
         els $$2 = this.dk();
         els $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         els $$4 = new els((double)$$0, 0.0, (double)$$1);
         float $$5 = this.ff();
         float $$6 = (float)$$4.g();
         if ($$6 <= 0.001F) {
            elr $$7 = this.co.a();
            ...
            $$4 = new els((double)($$8 * $$11 - $$9 * $$10), $$4.d, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.g();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         float $$12 = aun.i($$6);
         els $$13 = $$4.a((double)$$12);
         els $$14 = this.bH();
         float $$15 = (float)($$14.c * $$13.c + $$14.e * $$13.e);
         if (!($$15 < -0.15F)) {
            elx $$16 = elx.a(this);
            hx $$17 = hx.a(this.dr(), this.cH().e, this.dx());
            djg $$18 = this.dM().a_($$17);
            if ($$18.b(this.dM(), $$17, $$16).c()) {
               $$17 = $$17.c();
               djg $$19 = this.dM().a_($$17);
               if ($$19.b(this.dM(), $$17, $$16).c()) {
                  float $$20 = 7.0F;
                  float $$21 = 1.2F;
                  if (this.a(blj.h)) {
                     $$21 += (float)(this.b(blj.h).e() + 1) * 0.75F;
                  }

                  float $$22 = Math.max($$5 * 7.0F, 1.0F / $$12);
                  els $$24 = $$3.e($$13.a((double)$$22));
                  float $$25 = this.dg();
                  float $$26 = this.dh();
                  eln $$27 = new eln($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  els $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  els $$28 = $$13.c(new els(0.0, 1.0, 0.0));
                  els $$29 = $$28.a((double)($$25 * 0.5F));
                  els $$30 = $$23.d($$29);
                  els $$31 = $$24.d($$29);
                  els $$32 = $$23.e($$29);
                  els $$33 = $$24.e($$29);
                  Iterable<eml> $$34 = this.dM().d(this, $$27);
                  Iterator<eln> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean c(els $$0) {
      ...
      double $$2 = (double)aun.a($$1);
      double $$3 = (double)aun.b($$1);
      double $$4 = (double)this.bk * $$3 - (double)this.bm * $$2;
      double $$5 = (double)this.bm * $$3 + (double)this.bk * $$2;
      double $$6 = aun.k($$4) + aun.k($$5);
      double $$7 = aun.k($$0.c) + aun.k($$0.e);
   ...
   private boolean K() {
      return !this.bY() && this.M() && this.N() && !this.fn() && !this.a(blj.o) && (!this.bO() || this.c(this.cZ())) && !this.fw();
   }

   private boolean c(blu $$0) {
      return $$0.dF() && $$0.cX();
   }
   ...
   public float C() {
      if (!this.a(asl.a)) {
         ...
         if ((float)this.dc >= 600.0F) {
            ...
            float $$2 = aun.a((float)this.dc / 100.0F, 0.0F, 1.0F);
            float $$3 = (float)this.dc < 100.0F ? 0.0F : aun.a(((float)this.dc - 100.0F) / 500.0F, 0.0F, 1.0F);
   ...
   protected boolean fL() {
      ...
      if (this.P_()) {
         ...
         if (!$$0 && $$1) {
            this.dM().a(this.dr(), this.dt(), this.dx(), arr.x, ars.i, 1.0F, 1.0F, false);
            this.cp.ai().a((ghy)(new gib.b(this)));
         }

         if ($$0 && !$$1) {
            this.dM().a(this.dr(), this.dt(), this.dx(), arr.y, ars.i, 1.0F, 1.0F, false);
         }
   ...
   public els q(float $$0) {
      if (this.cp.m.ax().a()) {
         float $$1 = aun.i($$0 * 0.5F, this.dC(), this.N) * (float) (Math.PI / 180.0);
         float $$2 = aun.i($$0 * 0.5F, this.dE(), this.O) * (float) (Math.PI / 180.0);
         double $$3 = this.fm() == bme.b ? -1.0 : 1.0;
         els $$4 = new els(0.39 * $$3, -0.6, 0.3);
