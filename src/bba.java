...
public class bba extends DataFix {
   ...
   public bba(Schema $$0, String $$1, UnaryOperator<String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   protected TypeRewriteRule makeRule() {
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped(this.a + " (Components)", this.getInputSchema().getType(bhk.w), this::a),
         new TypeRewriteRule[]{
   ...
   private Dynamic<?> a(Dynamic<?> $$0) {
      return ban.a($$0, "id", this.b);
   }

   private Dynamic<?> b(Dynamic<?> $$0) {
      return ban.a($$0, "type", this.b);
   }
}
