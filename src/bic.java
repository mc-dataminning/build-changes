...
public class bic extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bin.y);
      Type<?> $$1 = this.getOutputSchema().getType(bin.y);
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         ...
         um $$4 = a($$1.substring($$2));
         if ($$4 != null) {
            $$3 = $$3.set("tag", new Dynamic(va.a, $$4).convert($$0.getOps()));
         }
      }
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bkb.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bkb.a($$1.substring(0, $$2))));
   ...
   private <T> Dynamic<T> g(Dynamic<T> $$0, String $$1) {
      try {
         ...
         $$2.expect(' ');
         int $$6 = $$2.readInt();
         Dynamic<T> $$7 = $$0.createIntList(IntStream.of(azu.d($$3), azu.d($$4), azu.d($$5)));
