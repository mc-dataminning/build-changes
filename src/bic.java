...
public class bic {
   ...
   public static final TypeReference A = a("entity_name");
   public static final TypeReference B = a("entity_tree");
   public static final TypeReference C = a("entity");
   public static final TypeReference D = a("block_name");
   public static final TypeReference E = a("item_name");
   public static final TypeReference F = a("game_event_name");
   public static final TypeReference G = a("untagged_spawner");
   public static final TypeReference H = a("structure_feature");
   public static final TypeReference I = a("objective");
   public static final TypeReference J = a("team");
   public static final TypeReference K = a("recipe");
   public static final TypeReference L = a("biome");
   public static final TypeReference M = a("multi_noise_biome_source_parameter_list");
   public static final TypeReference N = a("world_gen_settings");
