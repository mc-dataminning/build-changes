...
public record cm(Map<he<bib>, cm.b> b) {
   ...
   public boolean a(Map<bib, bid> $$0) {
      for (Entry<he<bib>, cm.b> $$1 : this.b.entrySet()) {
   ...
   public static class a {
      private final Builder<he<bib>, cm.b> a = ImmutableMap.builder();
   ...
   public static record b(cl.d b, cl.d c, Optional<Boolean> d, Optional<Boolean> e) {
      public static final Codec<cm.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  arf.a(cl.d.d, "amplifier", cl.d.c).forGetter(cm.b::a),
                  arf.a(cl.d.d, "duration", cl.d.c).forGetter(cm.b::b),
                  arf.a(Codec.BOOL, "ambient").forGetter(cm.b::c),
                  arf.a(Codec.BOOL, "visible").forGetter(cm.b::d)
               )
               .apply($$0, cm.b::new)
      );
