...
public class anx extends ant {
   ...
   private final anx.b d;
   private final String e;

   anx(String $$0, anx.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aoa $$0, agm $$1) {
   ...
   @Nullable
   private apd<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : apd.create($$1, $$2);
      }
   }
   ...
   public static class a implements aot.c {
      ...
      public anz a(String $$0) {
         anx.b $$1 = new anx.b(this.a);
         return new anx($$0, $$1, this.b, "");
      }

      @Override
      public anz a(String $$0, aot.a $$1) {
         anx.b $$2 = new anx.b(this.a);
         anz $$3 = new anx($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<anz> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new anx($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  anx.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
