...
public class anx {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ww.b("commands.locate.structure.not_found", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> ww.b("commands.locate.structure.invalid", $$0));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> ww.b("commands.locate.biome.not_found", $$0));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> ww.b("commands.locate.poi.not_found", $$0));
   ...
   public static void a(CommandDispatcher<ei> $$0, ee $$1) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ej.a("locate").requires($$0x -> $$0x.c(2)))
                  .then(ej.a("structure").then(ej.a("structure", fm.a(mg.bc)).executes($$0x -> a((ei)$$0x.getSource(), fm.a($$0x, "structure", mg.bc, c))))))
   ...
   private static Optional<? extends ji.b<eqi>> a(fm.c<eqi> $$0, jr<eqi> $$1) {
      return (Optional<? extends ji.b<eqi>>)$$0.a().map($$1x -> $$1.a($$1x).map($$0xx -> ji.a($$0xx)), $$1::a);
   }

   private static int a(ei $$0, fm.c<eqi> $$1) throws CommandSyntaxException {
      jr<eqi> $$2 = $$0.e().F_().f(mg.bc);
      ji<eqi> $$3 = (ji<eqi>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      iu $$4 = iu.a((jo)$$0.d());
      aro $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(af.d);
      Pair<iu, je<eqi>> $$7 = $$5.m().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(ei $$0, fl.c<djs> $$1) throws CommandSyntaxException {
      iu $$2 = iu.a((jo)$$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(af.d);
      Pair<iu, je<djs>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(ei $$0, fl.c<cie> $$1) throws CommandSyntaxException {
      iu $$2 = iu.a((jo)$$0.d());
      aro $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(af.d);
      Optional<Pair<je<cie>, iu>> $$5 = $$3.A().e($$1, $$2, 256, cib.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(ei $$0, iu $$1, Pair<iu, ? extends je<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      ...
      ww $$10 = wz.a((ww)ww.a("chat.coordinates", $$7.u(), $$9, $$7.w()))
         .a($$2x -> $$2x.a(n.k).a(new wu.g("/tp @s " + $$7.u() + " " + $$9 + " " + $$7.w())).a(new xc.e(ww.c("chat.coordinates.tooltip"))));
      $$0.a(() -> ww.a($$3, $$5, $$10, $$8), false);
