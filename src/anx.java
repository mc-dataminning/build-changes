...
public class anx {
   ...
   final List<ue> g = Collections.synchronizedList(Lists.newArrayList());

   public anx(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new ans(anx.this.d()));
               ue.a($$1, xe.a, null);
               int $$2 = anx.this.e.m();
               ue $$3 = (ue)($$2 > 0 ? new up($$2) : new ue(xe.a));
               anx.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new anz(anx.this.e, $$3));
            }
            ...
            if (!$$1.l()) {
               if ($$1.k()) {
                  try {
                     ...
                     vd $$3 = vd.b("Internal server error");
                     $$1.a(new xi($$3), un.a(() -> $$1.a($$3)));
                     $$1.o();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<anx.a.a> d = Lists.newArrayList();
