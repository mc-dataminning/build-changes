...
public class anx {
   ...
   private static ArgumentBuilder<eq, ?> a(em $$0, ArgumentBuilder<eq, ?> $$1, anx.a $$2) {
   ...
   private static CompletableFuture<Suggestions> a(eq $$0, Collection<exc> $$1, SuggestionsBuilder $$2) {
   ...
   private static int a(eq $$0, exc $$1, ewv $$2) throws CommandSyntaxException {
      exd $$3 = $$0.l().aK();
      ewz $$4 = $$3.d($$1, $$2);
      if ($$4 == null) {
   ...
   private static int a(eq $$0, Collection<exc> $$1, ewv $$2, fm.a $$3, Collection<exc> $$4, ewv $$5) throws CommandSyntaxException {
      exd $$6 = $$0.l().aK();
      int $$7 = 0;
   ...
   private static int a(eq $$0, Collection<exc> $$1, ewv $$2) throws CommandSyntaxException {
      if ($$2.c() != exg.c) {
         throw e.create();
      } else {
         exd $$3 = $$0.l().aK();
   ...
   private static int b(eq $$0, Collection<exc> $$1, ewv $$2) {
      exd $$3 = $$0.l().aK();
   ...
   private static int a(eq $$0, Collection<exc> $$1, ewv $$2, int $$3) {
      exd $$4 = $$0.l().aK();
   ...
   private static int a(eq $$0, Collection<exc> $$1, ewv $$2, @Nullable wu $$3) {
      exd $$4 = $$0.l().aK();
   ...
   private static int a(eq $$0, Collection<exc> $$1, ewv $$2, @Nullable yk $$3) {
      exd $$4 = $$0.l().aK();
   ...
   private static int b(eq $$0, Collection<exc> $$1, ewv $$2, int $$3) {
      exd $$4 = $$0.l().aK();
      int $$5 = 0;
   ...
   private static int c(eq $$0, Collection<exc> $$1, ewv $$2, int $$3) {
      exd $$4 = $$0.l().aK();
      int $$5 = 0;
   ...
   private static int a(eq $$0) {
      Collection<exc> $$1 = $$0.l().aK().e();
      if ($$1.isEmpty()) {
         $$0.a(() -> wu.c("commands.scoreboard.players.list.empty"), false);
      } else {
         $$0.a(() -> wu.a("commands.scoreboard.players.list.success", $$1.size(), wx.b($$1, exc::hb)), false);
      }

      return $$1.size();
   }

   private static int a(eq $$0, exc $$1) {
      Object2IntMap<ewv> $$2 = $$0.l().aK().c($$1);
      if ($$2.isEmpty()) {
         ...
         Object2IntMaps.fastForEach(
            $$2, $$1x -> $$0.a(() -> wu.a("commands.scoreboard.players.list.entity.entry", ((ewv)$$1x.getKey()).g(), $$1x.getIntValue()), false)
         );
      }
   ...
   private static int a(eq $$0, ewu $$1) throws CommandSyntaxException {
      exd $$2 = $$0.l().aK();
      if ($$2.a($$1) == null) {
         throw b.create();
      } else {
   ...
   private static int a(eq $$0, ewu $$1, ewv $$2) throws CommandSyntaxException {
      exd $$3 = $$0.l().aK();
      if ($$3.a($$1) == $$2) {
         throw c.create();
      } else {
   ...
   private static int a(eq $$0, ewv $$1, wu $$2) {
      if (!$$1.d().equals($$2)) {
         $$1.a($$2);
   ...
   private static int a(eq $$0, ewv $$1, boolean $$2) {
      if ($$1.e() != $$2) {
         $$1.a($$2);
         if ($$2) {
   ...
   private static int a(eq $$0, ewv $$1, @Nullable yk $$2) {
      $$1.b($$2);
      if ($$2 != null) {
   ...
   private static int a(eq $$0, ewv $$1, exg.a $$2) {
      if ($$1.h() != $$2) {
         $$1.a($$2);
   ...
   private static int a(eq $$0, ewv $$1) {
      exd $$2 = $$0.l().aK();
      $$2.j($$1);
   ...
   private static int a(eq $$0, String $$1, exg $$2, wu $$3) throws CommandSyntaxException {
      exd $$4 = $$0.l().aK();
      if ($$4.a($$1) != null) {
         throw a.create();
      } else {
   ...
   private static int b(eq $$0) {
      Collection<ewv> $$1 = $$0.l().aK().c();
      if ($$1.isEmpty()) {
         $$0.a(() -> wu.c("commands.scoreboard.objectives.list.empty"), false);
      } else {
         $$0.a(() -> wu.a("commands.scoreboard.objectives.list.success", $$1.size(), wx.b($$1, ewv::g)), false);
      }
