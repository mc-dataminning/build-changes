...
public class ary extends asd {
   ...
   private final Set<arz<?>> e = Sets.newHashSet();

   public ary(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<arz<?>> d() {
      Set<arz<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<arz<T>> a(asb<T> $$0, String $$1) {
   ...
   protected String b() {
      Map<asb<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<arz<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<arz<?>>)$$3.next();
         arz<?> $$2 = (arz<?>)$$1.getKey();
      ...
      for (Entry<asb<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> ahg b(arz<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(ane $$0) {
      Object2IntMap<arz<?>> $$1 = new Object2IntOpenHashMap();
