...
public class ary {
   public static final Codec<ary> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(arb.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), arb.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, ary::new)
   );
   ...
   private final Predicate<aeu> f;

   private ary(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
