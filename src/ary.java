...
public class ary<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return ary.this.get(this.b--);
      }

      @Override
      public void remove() {
         ary.this.remove(this.b + 1);
      }
   }
}
