...
class ary implements Path {
   private static final BasicFileAttributes a = new arw() {
      @Override
   ...
   private static final BasicFileAttributes b = new arw() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<ary> c = Comparator.comparing(ary::n);
   ...
   public ary(asa $$0, String $$1, @Nullable ary $$2, asb $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private ary a(@Nullable ary $$0, String $$1) {
      return new ary(this.e, $$1, $$0, asb.b);
   }
   ...
   ary a(String $$0) {
      if (a(this.i)) {
         return new ary(this.e, $$0, this, this.i);
      } else if (this.i instanceof asb.a $$1) {
         ary $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new ary(this.e, $$0, this, asb.a);
      } else if (this.i instanceof asb.b) {
         return new ary(this.e, $$0, this, asb.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(asb $$0) {
      return $$0 == asb.a || $$0 == asb.b;
   }
   ...
   private ary c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof ary $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof asb.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public asb.a i() {
      return this.i instanceof asb.a $$0 ? $$0 : null;
   }
