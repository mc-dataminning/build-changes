...
public class ce extends dz<ce.a> {
   ...
   public void a(ard $$0, cwn $$1, cpk $$2, Collection<cwn> $$3) {
      evp $$4 = bx.b($$0, (buj)($$2.s() != null ? $$2.s() : $$2));
   ...
   public static record a(Optional<bi> b, Optional<cv> c, Optional<bi> d, Optional<cv> e) implements dz.a {
      ...
      public boolean a(cwn $$0, evp $$1, Collection<cwn> $$2) {
         if (this.c.isPresent() && !this.c.get().a($$0)) {
            ...
            if (this.e.isPresent()) {
               boolean $$3 = false;
               buj $$4 = $$1.c(eyj.a);
               if ($$4 instanceof cla $$5 && this.e.get().a($$5.l())) {
                  $$3 = true;
               }
