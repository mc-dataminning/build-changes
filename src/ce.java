...
public class ce extends ds<ce.a> {
   ...
   public void a(aqn $$0, cmk $$1, cud $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(aqn $$0, cmk $$1, cud $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bf> b, ce.a.a c, List<cp> d) implements ds.a {
      ...
      public boolean a(cmk $$0, cud $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
