...
public class ce extends cx<ce.a> {
   ...
   public void a(aow $$0, Collection<bno> $$1) {
      List<eiv> $$2 = Lists.newArrayList();
      Set<bnu<?>> $$3 = Sets.newHashSet();
   ...
   public static record a(Optional<bc> b, List<bc> c, cm.d d) implements cx.a {
      public static final Codec<ce.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avp.a(br.b, "player").forGetter(ce.a::a),
                  avp.a(br.b.listOf(), "victims", List.of()).forGetter(ce.a::b),
                  avp.a(cm.d.d, "unique_entity_types", cm.d.c).forGetter(ce.a::c)
               )
               .apply($$0, ce.a::new)
      );
      ...
      public boolean a(Collection<eiv> $$0, int $$1) {
         if (!this.c.isEmpty()) {
            List<eiv> $$2 = Lists.newArrayList($$0);

            for (bc $$3 : this.c) {
               boolean $$4 = false;
               Iterator<eiv> $$5 = $$2.iterator();
