...
public class ce extends dr<ce.a> {
   ...
   public void a(arf $$0, cmv $$1, cuo $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(arf $$0, cmv $$1, cuo $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bf> b, ce.a.a c, List<cp> d) implements dr.a {
      ...
      public boolean a(cmv $$0, cuo $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
