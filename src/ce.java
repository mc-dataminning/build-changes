...
public class ce extends dr<ce.a> {
   ...
   public void a(arc $$0, cmr $$1, cuk $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(arc $$0, cmr $$1, cuk $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bf> b, ce.a.a c, List<cp> d) implements dr.a {
      ...
      public boolean a(cmr $$0, cuk $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
