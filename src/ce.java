...
public class ce extends dj<ce.a> {
   ...
   public void a(arp $$0, cys $$1, cri $$2, Collection<cys> $$3) {
      eyn $$4 = bx.b($$0, (bwa)($$2.j() != null ? $$2.j() : $$2));
   ...
   public static record a(Optional<bi> b, Optional<cl> c, Optional<bi> d, Optional<cl> e) implements dj.a {
      ...
      public boolean a(cys $$0, eyn $$1, Collection<cys> $$2) {
         if (this.c.isPresent() && !this.c.get().a($$0)) {
            ...
            if (this.e.isPresent()) {
               boolean $$3 = false;
               bwa $$4 = $$1.c(fbh.a);
               if ($$4 instanceof cmx $$5 && this.e.get().a($$5.f())) {
                  $$3 = true;
               }
