...
public class bks {
   ...
   private bks(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bks a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bks($$0, $$1);
   }

   public bks.d a() throws IOException {
      bks.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bks.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bks.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bks.c $$3 = bks.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bks.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bks.a($$0, $$3);
            }
         }
   ...
   public bks.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bks.c> $$2 = this.a().c();
      ...
      bks.e $$4 = new bks.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bks.c b) implements bks.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bks.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bks.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bks.b> {
      private final List<bks.b> a;

      d(List<bks.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bks.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bks.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bks.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bks.d a() {
         ListIterator<bks.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bks.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bks.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bks.b> b() {
         return this.a.stream();
      }

      public Set<bks.c> c() {
         return this.a.stream().map(bks.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bks.c b) implements bks.b {
