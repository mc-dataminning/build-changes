...
public class cyc {
   ...
   private final cyc.a e;
   private final long f;

   public cyc(cyc.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cyc a(cyc.a $$0) {
      return new cyc($$0, this.f);
   }

   public il<cya> a(ib $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public il<cya> a(double $$0, double $$1, double $$2) {
      int $$3 = iw.a(aww.a($$0));
      int $$4 = iw.a(aww.a($$1));
      int $$5 = iw.a(aww.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      il<cya> getNoiseBiome(int var1, int var2, int var3);
   }
}
