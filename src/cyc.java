...
public record cyc(int c, int d, jg<cxr> e, Optional<cyc.a> f) {
   private static final int g = 3;
   public static final MapCodec<cyc> a = cyc.a.a
      .flatXmap(cyc::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final yv<wi, cyc> b = yv.a(cyc::a, cyc::b);

   public static cyc a(Map<Character, cxr> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cyc a(Map<Character, cxr> $$0, List<String> $$1) {
      cyc.a $$2 = new cyc.a($$0, $$1);
      return (cyc)a($$2).getOrThrow();
   }

   private static DataResult<cyc> a(cyc.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      jg<cxr> $$4 = jg.a($$2 * $$3, cxr.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cyc($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cpj $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cyc b(wi $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jg<cxr> $$3 = jg.a($$1 * $$2, cxr.a);
      $$3.replaceAll($$1x -> cxr.b.decode($$0));
      return new cyc($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cyc.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cxr> b, List<String> c) {
      ...
      public static final MapCodec<cyc.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(axm.b(e, cxr.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cyc.a::new)
      );

      public Map<Character, cxr> a() {
         return this.b;
      }
