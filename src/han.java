...
public class han implements ham {
   ...
   private final han.b c = new han.b();
   private final han.b d = new han.b();
   public final han.a b;
   ...
   private float a(cxo $$0, gfi $$1, int $$2, bvj $$3) {
   ...
   private float a(bvj $$0, long $$1, jh $$2) {
      double $$3 = this.a($$0, $$2);
      double $$4 = this.a($$0);
      if ($$0 instanceof cpw $$5 && $$5.c() && $$5.dV().t().i()) {
         if (this.c.a($$1)) {
   ...
   @Nullable
   private gfi a(bvj $$0, @Nullable gfi $$1) {
      return $$1 == null && $$0.dV() instanceof gfi ? (gfi)$$0.dV() : $$1;
   }
   ...
   public interface a {
      @Nullable
      jp getPos(gfi var1, cxo var2, bvj var3);
   }
