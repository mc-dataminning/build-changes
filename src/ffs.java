...
public class ffs {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cB.d("gamemode " + ((dcc)MoreObjects.firstNonNull(this.b.q.i(), dcc.b)).b());
               }
   ...
   private void a(dsk $$0, ja $$1, @Nullable tx $$2) {
   ...
   private void a(akk $$0, ewf $$1, @Nullable tx $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = ezh.a(fft.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!ezh.a(fft.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ezh.a(fft.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.c();
            this.e = ac.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fqs) || ((fqs)$$6).s <= ac.c() - 20L)) {
            if (this.b.m.Q.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.N.a($$1, $$2)) {
               ...
               fgd.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aJ_() instanceof fib) || !((fib)$$6.aJ_()).c();
            if ($$7) {
               if (fnj.s() && $$1 == 66 && this.b.aX().a() && this.b.m.u().c()) {
                  boolean $$8 = this.b.m.as().c() == ffv.a;
                  this.b.m.as().a(ffv.a(this.b.m.as().c().a() + 1));
                  this.b.m.av();
                  if ($$6 instanceof fmb $$9) {
                     $$9.h();
                  }

                  if ($$6 instanceof fqf $$10) {
                     $$10.F();
                  }
         ...
         label191: {
            ...
            label151:
            if (!$$13) {
               if (this.b.y instanceof fne $$14 && !$$14.m()) {
                  break label151;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fnj.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fnj.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
