...
public final class ffs implements AutoCloseable {
   ...
   public ffs(int $$0, int $$1, boolean $$2) {
      this(ffs.a.a, $$0, $$1, $$2);
   }

   public ffs(ffs.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private ffs(ffs.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static ffs a(InputStream $$0) throws IOException {
      return a(ffs.a.a, $$0);
   }

   public static ffs a(@Nullable ffs.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ffs a(ByteBuffer $$0) throws IOException {
      return a(ffs.a.a, $$0);
   }

   public static ffs a(byte[] $$0) throws IOException {
   ...
   public static ffs a(@Nullable ffs.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new ffs($$0 == null ? ffs.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
   ...
   public ffs a(IntUnaryOperator $$0) {
      if (this.d != ffs.a.a) {
         ...
         this.j();
         ffs $$1 = new ffs(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fri.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(ffs $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ffs $$4) {
      this.j();
      if ($$4.c() != this.d) {
