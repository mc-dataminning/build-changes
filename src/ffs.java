public class ffs<T extends bvd> extends ffm<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.h.e = -1.5F * arx.e($$1, 13.0F) * $$2;
      this.i.e = 1.5F * arx.e($$1, 13.0F) * $$2;
      this.h.f = 0.0F;
      this.i.f = 0.0F;
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      int $$4 = $$0.y();
      if ($$4 > 0) {
         this.f.e = -2.0F + 1.5F * arx.e((float)$$4 - $$3, 10.0F);
         this.g.e = -2.0F + 1.5F * arx.e((float)$$4 - $$3, 10.0F);
      } else {
         int $$5 = $$0.gd();
         if ($$5 > 0) {
            this.f.e = -0.8F + 0.025F * arx.e((float)$$5, 70.0F);
            this.g.e = 0.0F;
         } else {
            this.f.e = (-0.2F + 1.5F * arx.e($$1, 13.0F)) * $$2;
            this.g.e = (-0.2F - 1.5F * arx.e($$1, 13.0F)) * $$2;
         }
      }
   }
