...
public class ffs implements AutoCloseable {
   private final ffq.a a;
   @Nullable
   private ffq.a b;
   private final ffs.a c;

   public ffs(ffq.a $$0, ffs.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, ffy $$2) {
      int $$3 = $$2.a(ffz.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public ffs.b a(ffq $$0, fgb $$1) {
      if (this.c.d() != ffy.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         ffs.b $$3 = new ffs.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(ffy a, int b, int c, ffy.c d, ffy.b e) {
   }

   public static record b(Vector3f[] a, ffy.b b) {
      @Nullable
      public ffq.a a(ffq $$0, fgb $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, ffy.b $$1) {
