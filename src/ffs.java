...
public class ffs {
   ...
   public xu a(xu $$0, int $$1, ym $$2) {
      final ffs.e $$3 = new ffs.e((float)$$1);
      return $$0.a(new xu.b<xu>() {
         private final fex b = new fex();
   ...
   public void a(String $$0, int $$1, ym $$2, boolean $$3, ffs.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      ym $$7 = $$2;

      while ($$5 < $$6) {
         ffs.b $$8 = new ffs.b((float)$$1);
   ...
   public void a(xu $$0, int $$1, ym $$2, BiConsumer<xu, Boolean> $$3) {
      List<ffs.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new ffs.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public xu a(int $$0, int $$1, ym $$2) {
         fex $$3 = new fex();
         ListIterator<ffs.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, ym $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = ffs.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements aym {
      ...
      @Override
      public boolean accept(int $$0, ym $$1, int $$2) {
         this.b = this.b - ffs.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
