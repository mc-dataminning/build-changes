...
public class ffs implements ffr {
   public static final MapCodec<ffs> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.INT.optionalFieldOf("Score", 0).forGetter(ffs::a),
               Codec.BOOL.optionalFieldOf("Locked", false).forGetter(ffs::b),
   ...
   private ffs(int $$0, boolean $$1, Optional<wy> $$2, Optional<yo> $$3) {
      this.b = $$0;
      this.c = $$1;
