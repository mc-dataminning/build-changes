...
public class ffs {
   ...
   public ffs(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fft> $$1) throws IOException {
   ...
   public List<fft> a(Path $$0) throws IOException {
      List<fft> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fft> a(Path $$0, boolean $$1) throws IOException {
      List<fft> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fft> $$1) throws IOException {
