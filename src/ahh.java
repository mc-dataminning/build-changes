...
public class ahh {
   ...
   public ahh(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<ahh.a> b(Scanner $$0) {
      agf<crs> $$1 = (agf<crs>)ahq.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new ahh.a($$1, new eji((double)$$2, (double)$$3, (double)$$4), new ejh($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<amb> $$1 = this.e.ac().t();
         if (!$$1.isEmpty()) {
            amb $$2 = $$1.get(0);
            ama $$3 = this.e.D();
            du $$4 = new du($$2, eji.a($$3.R()), ejh.a, $$3, 4, "", uq.a, this.e, $$2);
            dv $$5 = this.e.aC();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(agf<crs> a, eji b, ejh c) {
   }
}
