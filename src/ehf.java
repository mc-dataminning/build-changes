...
public abstract class ehf {
   public static ehf.b a(int $$0, int $$1) {
      return new ehf.b($$0 - 1, $$1 + 1);
   }

   public static ehf.b b(int $$0, int $$1) {
      return new ehf.b($$0, $$1);
   }

   public static ehf a(int $$0) {
      return new ehf.c($$0, false);
   }

   public static ehf b(int $$0) {
      return new ehf.c($$0 + 1, false);
   }

   public static ehf c(int $$0) {
      return new ehf.c($$0, true);
   }

   public static ehf d(int $$0) {
      return new ehf.c($$0 - 1, true);
   }
   ...
   public static ehf a(OptionalInt $$0, OptionalInt $$1) {
   ...
   public ehf a(OptionalInt $$0) {
      return a($$0, this.b());
   }

   public ehf b(OptionalInt $$0) {
      return a(this.c(), $$0);
   }

   public static Optional<ehf> a(dkp $$0, iw $$1, int $$2, Predicate<ebq> $$3, Predicate<ebq> $$4) {
      iw.a $$5 = $$1.k();
      if (!$$0.a($$1, $$3)) {
   ...
   private static OptionalInt a(dkp $$0, int $$1, Predicate<ebq> $$2, Predicate<ebq> $$3, iw.a $$4, int $$5, jc $$6) {
      $$4.q($$5);
   ...
   public static final class a extends ehf {
      static final ehf.a a = new ehf.a();
