...
public class ehf extends ehn {
   ...
   private final List<eil> i = Lists.newArrayList();
   private final elk j;

   public ehf(elk $$0, eiq $$1, io $$2, int $$3, dkl $$4, ehb $$5) {
      super(eia.ad, 0, $$5);
      this.j = $$0;
      this.a = $$1;
      this.b = $$2;
   ...
   public ehf(ehz $$0, ud $$1) {
      ...
      this.c = dkl.valueOf($$1.l("rotation"));
      this.f = this.a.a(this.j, this.b, this.c);
      uj $$3 = $$1.c("junctions", 10);
      this.i.clear();
      $$3.forEach($$1x -> this.i.add(eil.a(new Dynamic($$2, $$1x))));
   }
   ...
   protected void a(ehz $$0, ud $$1) {
      ...
      DynamicOps<va> $$2 = $$0.b().a(ur.a);
      eiq.e.encodeStart($$2, this.a).resultOrPartial(d::error).ifPresent($$1x -> $$1.a("pool_element", $$1x));
   ...
   public void a(dbs $$0, dbq $$1, dsy $$2, ayk $$3, ehb $$4, io $$5, boolean $$6) {
