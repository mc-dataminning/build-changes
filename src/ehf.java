...
public class ehf implements egp {
   public static final Codec<ehf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               elb.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               axq.b(lz.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               eiq.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               eiq.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               ecm.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, ehf::new)
   );
   ...
   public ehf(jq<elb> $$0, int $$1, int $$2, axq<die> $$3, eiq $$4, int $$5, int $$6, int $$7, int $$8, eiq $$9, int $$10, int $$11, ecm $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
