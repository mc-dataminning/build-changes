public class gae extends gbl<gwy> implements gah {
   private final gen a = this.v.b("head");
   private final gen b = this.v.b("body");
   private final gen c = this.b.b("right_arm");
   private final gen d = this.b.b("left_arm");
   private final gen e = this.b.b("right_wing");
   private final gen f = this.b.b("left_wing");
   ...
   public static get a() {
      gev $$0 = new gev();
      gex $$1 = $$0.a();
      gex $$2 = $$1.a("root", ges.c(), gep.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", ges.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new ger(0.0F)), gep.a(0.0F, -3.99F, 0.0F));
      gex $$3 = $$2.a(
         "body",
         ges.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new ger(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new ger(-0.2F)),
         gep.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", ges.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new ger(-0.01F)), gep.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", ges.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new ger(-0.01F)), gep.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", ges.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new ger(0.0F)), gep.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", ges.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new ger(0.0F)), gep.a(0.5F, 0.0F, 0.6F));
