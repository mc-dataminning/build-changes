...
public class gae {
   private static final gaq a = gaq.t(new ajv("textures/map/map_background.png"));
   private static final gaq b = gaq.t(new ajv("textures/map/map_background_checkerboard.png"));
   ...
   private final fby au;
   private crs av = crs.i;
   private crs aw = crs.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gfp aB;
   private final ggp aC;

   public gae(fby $$0, gfp $$1, ggp $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bqt $$0, crs $$1, crp $$2, boolean $$3, ewr $$4, gai $$5, int $$6) {
      if (!$$1.d()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, glj.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = axm.a($$1, 0.0F, 1.0F);
      return -axm.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(ewr $$0, gai $$1, int $$2, bqn $$3) {
      gkv $$4 = (gkv)this.aB.<fzh>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bqn.b ? 1.0F : -1.0F;
   ...
   private void a(ewr $$0, gai $$1, int $$2, float $$3, bqn $$4, float $$5, crs $$6) {
      float $$7 = $$4 == bqn.b ? 1.0F : -1.0F;
      ...
      float $$8 = axm.c($$5);
      float $$9 = axm.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * axm.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * axm.a($$5 * (float) Math.PI);
   ...
   private void a(ewr $$0, gai $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = axm.c($$5);
      float $$7 = -0.2F * axm.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * axm.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = axm.a($$6 * (float) Math.PI);
   ...
   private void a(ewr $$0, gai $$1, int $$2, crs $$3) {
      ...
      emm $$4 = $$3.a(jr.s);
      emo $$5 = crz.a($$4, this.au.r);
      ewv $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(ewr $$0, gai $$1, int $$2, float $$3, float $$4, bqn $$5) {
      boolean $$6 = $$5 != bqn.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = axm.c($$4);
      float $$9 = -0.3F * axm.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * axm.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * axm.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = axm.a($$4 * $$4 * (float) Math.PI);
      float $$13 = axm.a($$8 * (float) Math.PI);
   ...
   private void a(ewr $$0, float $$1, bqn $$2, crs $$3) {
      float $$4 = (float)this.au.s.fv() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.t();
      if ($$5 < 0.8F) {
         float $$6 = axm.e(axm.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(ewr $$0, float $$1, bqn $$2, crs $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * axm.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bqn.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(ewr $$0, bqn $$1, float $$2) {
      int $$3 = $$1 == bqn.b ? 1 : -1;
      float $$4 = axm.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = axm.a(axm.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(ewr $$0, bqn $$1, float $$2) {
      int $$3 = $$1 == bqn.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, ewr $$1, gai.a $$2, fzk $$3, int $$4) {
      float $$5 = $$3.z($$0);
      boe $$6 = (boe)MoreObjects.firstNonNull($$3.aJ, boe.a);
      float $$7 = axm.i($$0, $$3.O, $$3.dE());
      gae.a $$8 = a($$3);
      float $$9 = axm.i($$0, $$3.cD, $$3.cB);
      float $$10 = axm.i($$0, $$3.cC, $$3.cA);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == boe.a ? $$5 : 0.0F;
         float $$12 = 1.0F - axm.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, boe.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == boe.b ? $$5 : 0.0F;
         float $$14 = 1.0F - axm.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, boe.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gae.a a(fzk $$0) {
      crs $$1 = $$0.eU();
      crs $$2 = $$0.eV();
      boolean $$3 = $$1.a(crv.ot) || $$2.a(crv.ot);
      boolean $$4 = $$1.a(crv.vR) || $$2.a(crv.vR);
      if (!$$3 && !$$4) {
         return gae.a.a;
      } else if ($$0.fs()) {
         return b($$0);
      } else {
         return a($$1) ? gae.a.b : gae.a.a;
      }
   }

   private static gae.a b(fzk $$0) {
      crs $$1 = $$0.fu();
      boe $$2 = $$0.ft();
      if (!$$1.a(crv.ot) && !$$1.a(crv.vR)) {
         return $$2 == boe.a && a($$0.eV()) ? gae.a.b : gae.a.a;
      } else {
         return gae.a.a($$2);
      }
   }
   ...
   private static boolean a(crs $$0) {
      return $$0.a(crv.vR) && cqf.j($$0);
   }

   private void a(fzh $$0, float $$1, float $$2, boe $$3, float $$4, crs $$5, float $$6, ewr $$7, gai $$8, int $$9) {
      if (!$$0.gx()) {
         boolean $$10 = $$3 == boe.a;
         bqn $$11 = $$10 ? $$0.fr() : $$0.fr().e();
         $$7.a();
         if ($$5.d()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               ...
               float $$16 = $$15 / (float)cqf.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = axm.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * axm.a(axm.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * axm.a(axm.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * axm.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? crp.e : crp.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bqn.b;
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * axm.a(axm.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * axm.a(axm.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * axm.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? crp.e : crp.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = axm.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = axm.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + axm.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + axm.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
