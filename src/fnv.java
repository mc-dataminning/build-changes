...
public class fnv {
   private static final foh a = foh.s(new aeu("textures/map/map_background.png"));
   private static final foh b = foh.s(new aeu("textures/map/map_background_checkerboard.png"));
   ...
   private final eqq au;
   private cja av = cja.b;
   private cja aw = cja.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fta aB;
   private final fua aC;

   public fnv(eqq $$0, fta $$1, fua $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bjb $$0, cja $$1, cix $$2, boolean $$3, elk $$4, fnz $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dK(), $$6, fyq.d, $$0.ah() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = ars.a($$1, 0.0F, 1.0F);
      return -ars.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(elk $$0, fnz $$1, int $$2, biv $$3) {
      fyc $$4 = (fyc)this.aB.<fmy>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == biv.b ? 1.0F : -1.0F;
   ...
   private void a(elk $$0, fnz $$1, int $$2, float $$3, biv $$4, float $$5, cja $$6) {
      float $$7 = $$4 == biv.b ? 1.0F : -1.0F;
      ...
      float $$8 = ars.c($$5);
      float $$9 = ars.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * ars.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * ars.a($$5 * (float) Math.PI);
   ...
   private void a(elk $$0, fnz $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ars.c($$5);
      float $$7 = -0.2F * ars.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * ars.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = ars.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(elk $$0, fnz $$1, int $$2, cja $$3) {
      ...
      Integer $$4 = cjh.d($$3);
      ebr $$5 = cjh.a($$4, this.au.r);
      elo $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(elk $$0, fnz $$1, int $$2, float $$3, float $$4, biv $$5) {
      boolean $$6 = $$5 != biv.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ars.c($$4);
      float $$9 = -0.3F * ars.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * ars.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * ars.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = ars.a($$4 * $$4 * (float) Math.PI);
      float $$13 = ars.a($$8 * (float) Math.PI);
   ...
   private void a(elk $$0, float $$1, biv $$2, cja $$3) {
      float $$4 = (float)this.au.s.fo() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = ars.e(ars.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(elk $$0, float $$1, biv $$2, cja $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * ars.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != biv.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(elk $$0, biv $$1, float $$2) {
      int $$3 = $$1 == biv.b ? 1 : -1;
      float $$4 = ars.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = ars.a(ars.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(elk $$0, biv $$1, float $$2) {
      int $$3 = $$1 == biv.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, elk $$1, fnz.a $$2, fnb $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bgs $$6 = (bgs)MoreObjects.firstNonNull($$3.aG, bgs.a);
      float $$7 = ars.i($$0, $$3.O, $$3.dC());
      fnv.a $$8 = a($$3);
      float $$9 = ars.i($$0, $$3.cs, $$3.cq);
      float $$10 = ars.i($$0, $$3.cr, $$3.cp);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bgs.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ars.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bgs.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bgs.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ars.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bgs.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fnv.a a(fnb $$0) {
      cja $$1 = $$0.eR();
      cja $$2 = $$0.eS();
      boolean $$3 = $$1.a(cjd.nG) || $$2.a(cjd.nG);
      boolean $$4 = $$1.a(cjd.uZ) || $$2.a(cjd.uZ);
      if (!$$3 && !$$4) {
         return fnv.a.a;
      } else if ($$0.fl()) {
         return b($$0);
      } else {
         return a($$1) ? fnv.a.b : fnv.a.a;
      }
   }

   private static fnv.a b(fnb $$0) {
      cja $$1 = $$0.fn();
      bgs $$2 = $$0.fm();
      if (!$$1.a(cjd.nG) && !$$1.a(cjd.uZ)) {
         return $$2 == bgs.a && a($$0.eS()) ? fnv.a.b : fnv.a.a;
      } else {
         return fnv.a.a($$2);
      }
   }
   ...
   private static boolean a(cja $$0) {
      return $$0.a(cjd.uZ) && chi.d($$0);
   }

   private void a(fmy $$0, float $$1, float $$2, bgs $$3, float $$4, cja $$5, float $$6, elk $$7, fnz $$8, int $$9) {
      if (!$$0.go()) {
         boolean $$10 = $$3 == bgs.a;
         biv $$11 = $$10 ? $$0.fk() : $$0.fk().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.cd()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               ...
               float $$16 = $$15 / (float)chi.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = ars.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * ars.a(ars.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * ars.a(ars.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * ars.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cix.e : cix.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == biv.b;
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * ars.a(ars.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * ars.a(ars.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * ars.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cix.e : cix.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.x()) {
         this.ax = ars.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = ars.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + ars.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + ars.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
