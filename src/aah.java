...
public class aah implements xx<aag> {
   ...
   public aah(bnq $$0, int $$1) {
      this($$0.aj(), $$0.cw(), $$0.dr(), $$0.dt(), $$0.dx(), $$0.dE(), $$0.dC(), $$0.ai(), $$1, $$0.dp(), (double)$$0.cp());
   }

   public aah(bnq $$0, int $$1, hz $$2) {
      this($$0.aj(), $$0.cw(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dE(), $$0.dC(), $$0.ai(), $$1, $$0.dp(), (double)$$0.cp());
   }

   public aah(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, bnw<?> $$7, int $$8, enz $$9, double $$10) {
      this.d = $$0;
      this.e = $$1;
      this.g = $$2;
      this.h = $$3;
      this.i = $$4;
      this.m = (byte)awi.d($$5 * 256.0F / 360.0F);
      this.n = (byte)awi.d($$6 * 256.0F / 360.0F);
      this.o = (byte)awi.a($$10 * 256.0 / 360.0);
      this.f = $$7;
      this.p = $$8;
      this.j = (int)(awi.a($$9.c, -3.9, 3.9) * 8000.0);
      this.k = (int)(awi.a($$9.d, -3.9, 3.9) * 8000.0);
      this.l = (int)(awi.a($$9.e, -3.9, 3.9) * 8000.0);
   }
