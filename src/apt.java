...
public class apt {
   ...
   public static final List<Function<String, apt.c>> a = ImmutableList.of(apu.a, apr.a, apv.a);
   public static final List<apt.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<apt.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<et> $$0) {
      ...
      for (apt.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<et, ?>, apt.b>)(($$0x, $$1x) -> $$0x.then(
                           eu.a("insert")
                              .then(
   ...
   private static List<vc> a(List<vc> $$0, apt.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<et, ?> a(BiConsumer<ArgumentBuilder<et, ?>, apt.b> $$0) {
   ...
   private static List<vc> a(CommandContext<et> $$0, apt.c $$1) throws CommandSyntaxException {
      aps $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<vc> b(CommandContext<et> $$0, apt.c $$1) throws CommandSyntaxException {
      aps $$2 = $$1.a($$0);
      fl.g $$3 = fl.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<et> $$0, apt.c $$1, apt.a $$2, List<vc> $$3) throws CommandSyntaxException {
      aps $$4 = $$1.a($$0);
   ...
   private static int a(et $$0, aps $$1, fl.g $$2) throws CommandSyntaxException {
      uf $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static vc a(fl.g $$0, aps $$1) throws CommandSyntaxException {
   ...
   private static int b(et $$0, aps $$1, fl.g $$2) throws CommandSyntaxException {
      vc $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof uv) {
         $$4 = azd.a(((uv)$$3).j());
   ...
   private static int a(et $$0, aps $$1, fl.g $$2, double $$3) throws CommandSyntaxException {
      vc $$4 = a($$2, $$1);
      if (!($$4 instanceof uv)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = azd.a(((uv)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(et $$0, aps $$1) throws CommandSyntaxException {
      uf $$2 = $$1.a();
      $$0.a(() -> $$1.a((vc)$$2), false);
      return 1;
   }

   private static int a(et $$0, aps $$1, uf $$2) throws CommandSyntaxException {
      uf $$3 = $$1.a();
      if (fl.g.a($$2, 0)) {
         throw fl.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<et, ?> create(apt.a var1);
   }

   public interface c {
      aps a(CommandContext<et> var1) throws CommandSyntaxException;
