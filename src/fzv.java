...
public class fzv {
   ...
   private void a(fsh $$0, int $$1, int $$2, Iterable<bvm> $$3, boolean $$4) {
      int $$5 = this.c.D;

      for (bvm $$6 : $$3) {
         if ($$4) {
            $$0.a(gqx::H, a, $$1, $$5, 120, 32);
         } else {
            $$0.a(gqx::H, b, $$1, $$5, 32, 32);
         }
   ...
   private void b(fsh $$0, int $$1, int $$2, Iterable<bvm> $$3, boolean $$4) {
      hkj $$5 = this.d.aG();
      int $$6 = this.c.D;
      ...
      for (bvm $$7 : $$3) {
         jf<bvk> $$8 = $$7.c();
         hjk $$9 = $$5.a($$8);
         $$0.a(gqx::H, $$9, $$1 + ($$4 ? 6 : 7), $$6 + 7, 18, 18);
         $$6 += $$2;
      }
   }

   private void a(fsh $$0, int $$1, int $$2, Iterable<bvm> $$3) {
      int $$4 = this.c.D;
