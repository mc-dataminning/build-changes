...
public class fzv {
   private static final gah a = gah.t(new ajt("textures/map/map_background.png"));
   private static final gah b = gah.t(new ajt("textures/map/map_background_checkerboard.png"));
   ...
   private final fbp au;
   private crj av = crj.i;
   private crj aw = crj.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gfg aB;
   private final ggg aC;

   public fzv(fbp $$0, gfg $$1, ggg $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bqo $$0, crj $$1, crg $$2, boolean $$3, ewi $$4, fzz $$5, int $$6) {
      if (!$$1.d()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, gla.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = axk.a($$1, 0.0F, 1.0F);
      return -axk.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(ewi $$0, fzz $$1, int $$2, bqi $$3) {
      gkm $$4 = (gkm)this.aB.<fyy>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bqi.b ? 1.0F : -1.0F;
   ...
   private void a(ewi $$0, fzz $$1, int $$2, float $$3, bqi $$4, float $$5, crj $$6) {
      float $$7 = $$4 == bqi.b ? 1.0F : -1.0F;
      ...
      float $$8 = axk.c($$5);
      float $$9 = axk.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * axk.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * axk.a($$5 * (float) Math.PI);
   ...
   private void a(ewi $$0, fzz $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = axk.c($$5);
      float $$7 = -0.2F * axk.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * axk.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = axk.a($$6 * (float) Math.PI);
   ...
   private void a(ewi $$0, fzz $$1, int $$2, crj $$3) {
      ...
      emd $$4 = $$3.a(jp.s);
      emf $$5 = crq.a($$4, this.au.r);
      ewm $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
      ...
      if ($$5 != null) {
         this.au.j.k().a($$0, $$1, $$4, $$5, false, $$2);
      }
   }

   private void a(ewi $$0, fzz $$1, int $$2, float $$3, float $$4, bqi $$5) {
      boolean $$6 = $$5 != bqi.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = axk.c($$4);
      float $$9 = -0.3F * axk.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * axk.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * axk.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = axk.a($$4 * $$4 * (float) Math.PI);
      float $$13 = axk.a($$8 * (float) Math.PI);
   ...
   private void a(ewi $$0, float $$1, bqi $$2, crj $$3) {
      float $$4 = (float)this.au.s.fv() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.t();
      if ($$5 < 0.8F) {
         float $$6 = axk.e(axk.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(ewi $$0, float $$1, bqi $$2, crj $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * axk.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bqi.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(ewi $$0, bqi $$1, float $$2) {
      int $$3 = $$1 == bqi.b ? 1 : -1;
      float $$4 = axk.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = axk.a(axk.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(ewi $$0, bqi $$1, float $$2) {
      int $$3 = $$1 == bqi.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, ewi $$1, fzz.a $$2, fzb $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bnz $$6 = (bnz)MoreObjects.firstNonNull($$3.aJ, bnz.a);
      float $$7 = axk.i($$0, $$3.O, $$3.dE());
      fzv.a $$8 = a($$3);
      float $$9 = axk.i($$0, $$3.cB, $$3.cz);
      float $$10 = axk.i($$0, $$3.cA, $$3.cx);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bnz.a ? $$5 : 0.0F;
         float $$12 = 1.0F - axk.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bnz.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bnz.b ? $$5 : 0.0F;
         float $$14 = 1.0F - axk.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bnz.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fzv.a a(fzb $$0) {
      crj $$1 = $$0.eU();
      crj $$2 = $$0.eV();
      boolean $$3 = $$1.a(crm.ot) || $$2.a(crm.ot);
      boolean $$4 = $$1.a(crm.vR) || $$2.a(crm.vR);
      if (!$$3 && !$$4) {
         return fzv.a.a;
      } else if ($$0.fs()) {
         return b($$0);
      } else {
         return a($$1) ? fzv.a.b : fzv.a.a;
      }
   }

   private static fzv.a b(fzb $$0) {
      crj $$1 = $$0.fu();
      bnz $$2 = $$0.ft();
      if (!$$1.a(crm.ot) && !$$1.a(crm.vR)) {
         return $$2 == bnz.a && a($$0.eV()) ? fzv.a.b : fzv.a.a;
      } else {
         return fzv.a.a($$2);
      }
   }
   ...
   private static boolean a(crj $$0) {
      return $$0.a(crm.vR) && cpw.j($$0);
   }

   private void a(fyy $$0, float $$1, float $$2, bnz $$3, float $$4, crj $$5, float $$6, ewi $$7, fzz $$8, int $$9) {
      if (!$$0.gx()) {
         boolean $$10 = $$3 == bnz.a;
         bqi $$11 = $$10 ? $$0.fr() : $$0.fr().e();
         $$7.a();
         if ($$5.d()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               ...
               float $$15 = (float)$$5.t() - ((float)this.au.s.fv() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cpw.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = axk.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * axk.a(axk.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * axk.a(axk.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * axk.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? crg.e : crg.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bqi.b;
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.u()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.t() - ((float)this.au.s.fv() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.t() - ((float)this.au.s.fv() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * axk.a(axk.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * axk.a(axk.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * axk.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? crg.e : crg.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = axk.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = axk.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + axk.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + axk.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
