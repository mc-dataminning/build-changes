...
public class hkw implements hkz.a, AutoCloseable {
   ...
   fki[] f;
   @Nullable
   private final hkw.a g;
   private final avj h;

   public hkw(alk $$0, hmq $$1, fki $$2, avj $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      this.g = $$3.a(hmp.b).map($$2x -> this.a($$1, $$2.a(), $$2.b(), $$2x)).orElse(null);
      this.e = $$2;
      this.f = new fki[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hkq.a(this.f, $$0);
   ...
   @Nullable
   private hkw.a a(hmq $$0, int $$1, int $$2, hmp $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      int $$7 = $$3.d();
      ...
      if ($$3.a().isEmpty()) {
         ...
         for (hmo $$12 : $$10) {
            $$8.add(new hkw.b($$12.a(), $$12.a($$7)));
         }

         int $$13 = 0;
         IntSet $$14 = new IntOpenHashSet();

         for (Iterator<hkw.b> $$15 = $$8.iterator(); $$15.hasNext(); $$13++) {
            hkw.b $$16 = $$15.next();
            boolean $$17 = true;
            if ($$16.b <= 0) {
      ...
      return $$8.size() <= 1 ? null : new hkw.a(List.copyOf($$8), $$4, $$3.e());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fki[] $$4, flj $$5) {
   ...
   class a {
      ...
      a(final List<hkw.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2, flj $$3) {
         int $$4 = this.a($$2) * hkw.this.c;
         int $$5 = this.b($$2) * hkw.this.d;
         hkw.this.a($$0, $$1, $$4, $$5, hkw.this.f, $$3);
      }

      public hky a() {
         return hkw.this.new d(this, this.d ? hkw.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fki[] b = new fki[hkw.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hkw.this.c >> $$0;
            int $$2 = hkw.this.d >> $$0;
            this.b[$$0] = new fki($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hkw.d $$2, flj $$3) {
         hkw.a $$4 = $$2.c;
         List<hkw.b> $$5 = $$4.b;
         hkw.b $$6 = $$5.get($$2.a);
         ...
         if ($$8 != $$9) {
            for (int $$10 = 0; $$10 < this.b.length; $$10++) {
               int $$11 = hkw.this.c >> $$10;
               int $$12 = hkw.this.d >> $$10;

               for (int $$13 = 0; $$13 < $$12; $$13++) {
                  for (int $$14 = 0; $$14 < $$11; $$14++) {
                     int $$15 = this.a($$4, $$8, $$10, $$14, $$13);
                     int $$16 = this.a($$4, $$9, $$10, $$14, $$13);
                     this.b[$$10].b($$14, $$13, aya.a($$7, $$15, $$16));
                  }
               }
            }

            hkw.this.a($$0, $$1, 0, 0, this.b, $$3);
         }
      }

      private int a(hkw.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hkw.this.f[$$2].a($$3 + ($$0.a($$1) * hkw.this.c >> $$2), $$4 + ($$0.b($$1) * hkw.this.d >> $$2));
      }
   ...
   class d implements hky {
      int a;
      int b;
      final hkw.a c;
      @Nullable
      private final hkw.c d;

      d(final hkw.a $$0, @Nullable final hkw.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
