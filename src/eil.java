...
public class eil extends eit<eik> {
   public eil(Codec<eik> $$0) {
      super($$0);
   }

   public boolean a(eik $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eio $$0, eik $$1, ecl $$2, Function<iv, jf<dkk>> $$3, azv $$4, efz $$5, dio $$6, eck $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private float[] a(eio $$0, eik $$1, azv $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(eik $$0, azv $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - azm.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)azm.b($$1, 0.75F, 1.0F);
   }

   private boolean a(eio $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
