...
public class eil {
   ...
   private final Map<String, eit> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public eil(@Nullable epw $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tx a(tx $$0) {
      tx $$1 = $$0.p("Level");
      dbk $$2 = new dbk($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dbk.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dbk.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable epw $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               tx $$4 = $$2.p($$3);
               long $$5 = dbk.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tx $$14 = $$2.p($$13);
                  $$12.a(dbk.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static eil a(akj<dcd> $$0, @Nullable epw $$1) {
      if ($$0 == dcd.h) {
         return new eil(
            $$1,
         ...
         return new eil($$1, $$2, $$2);
      } else if ($$0 == dcd.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eil($$1, $$3, $$3);
      } else {
