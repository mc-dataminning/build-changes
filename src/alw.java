...
public class alw extends als {
   static final Logger c = LogUtils.getLogger();
   private final alw.b d;
   private final String e;

   alw(String $$0, alw.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(alz $$0, aep $$1) {
   ...
   @Nullable
   private anc<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : anc.create($$1, $$2);
      }
   }
   ...
   public static class a implements ams.c {
      ...
      @Override
      public aly a(String $$0) {
         alw.b $$1 = new alw.b(this.a);
         return new alw($$0, $$1, this.b, "");
      }

      @Override
      public aly a(String $$0, ams.a $$1) {
         alw.b $$2 = new alw.b(this.a);
         aly $$3 = new alw($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aly> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new alw($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  alw.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
