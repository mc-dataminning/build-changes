...
public class alw {
   ...
   public alw(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<alw.a> b(Scanner $$0) {
      aks<dca> $$1 = (aks<dca>)amf.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new alw.a($$1, new ewu((double)$$2, (double)$$3, (double)$$4), new ewt($$6, $$5)));
      }
   }
   ...
   private void b(String $$0) {
      this.e.execute(() -> {
         ...
         if (!$$1.isEmpty()) {
            aqu $$2 = $$1.get(0);
            aqt $$3 = this.e.I();
            eh $$4 = new eh($$2, ewu.a($$3.V()), ewt.a, $$3, 4, "", xd.a, this.e, $$2);
            ei $$5 = this.e.aH();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(aks<dca> a, ewu b, ewt c) {
   }
}
