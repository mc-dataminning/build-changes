...
public class alw implements AutoCloseable {
   ...
   private alw(URL $$0, alw.c $$1, URL $$2, alw.b $$3, URL $$4, alw.b $$5, String $$6, alw.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? aro.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static alw a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = aro.a($$0);
            URI $$2 = new URI(aro.i($$1, "apiServer"));
            String $$3 = aro.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = aro.a($$1, "ruleId", 1);
               String $$5 = aro.a($$1, "serverId", "");
               String $$6 = aro.a($$1, "roomId", "Java:Chat");
               int $$7 = aro.a($$1, "hashesToDrop", -1);
               int $$8 = aro.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = aro.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alw.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<ali> a(GameProfile $$0, String $$1, alw.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(ali.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = aro.a($$4, "response", false);
            if ($$5) {
               return ali.a($$1);
            } else {
               String $$6 = aro.a($$4, "hashed", null);
               if ($$6 == null) {
                  return ali.b($$1);
               } else {
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alw.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public alv a(GameProfile $$0) {
      return new alw.d($$0);
   }
   ...
   public interface a {
      alw.a a = ($$0, $$1) -> false;
      alw.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alw.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alw.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements alv {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bfr<Runnable> $$1 = bfr.a(alw.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         alw.this.a(this.c, alw.this.g, alw.this.h, this.d);
      }

      @Override
      public void b() {
         alw.this.a(this.c, alw.this.i, alw.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<ali>> a(List<String> $$0) {
         List<CompletableFuture<ali>> $$1 = $$0.stream().map($$0x -> alw.this.a(this.c, $$0x, alw.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<ali> a(String $$0) {
         return alw.this.a(this.c, $$0, alw.this.l, this.d);
      }
   }
