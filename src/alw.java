...
public interface alw {
   alw a = new alw() {
      ...
      @Override
      public void a(Consumer<crm> $$0) {
      }
   };

   static alw a(crm $$0, int $$1) {
      return new alw.a($$0, $$1);
   }

   static void a(alw $$0, alw $$1, Consumer<crm> $$2, Consumer<crm> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof alw.a $$4 && $$1 instanceof alw.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new crm($$10, $$11));
                     } else {
                        $$3.accept(new crm($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(crm b, int c) implements alw {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(alw.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return alw.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
