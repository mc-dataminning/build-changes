...
public interface bob {
   static bnv<StringReader> a(String $$0) {
      return new bob.b($$0);
   }

   static bnv<StringReader> a(char $$0) {
      return new bob.a($$0);
   }

   public static record a(char a) implements bnv<StringReader> {
      @Override
      public boolean a(bnr<StringReader> $$0, bnt $$1, bnn $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bnv<StringReader> {
      @Override
      public boolean a(bnr<StringReader> $$0, bnt $$1, bnn $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
