...
public class bob {
   ...
   private static void a(boj $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(boe $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<duy, bon<bod>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bon)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<duy, bon<bod>> $$3 : $$0) {
         bon<bod> $$4 = (bon<bod>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((duy)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bol> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnq.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnz $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bob::a));
      $$1.add("chunksWritten", this.a($$0.m(), bob::a));
      return $$1;
   }

   private JsonElement a(bog.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bnz $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bob::a));
      $$1.add("received", this.a($$0.k(), bob::a));
      return $$1;
   }

   private <T> JsonElement a(boi<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bof> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bof>, ToDoubleFunction<bof>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bof::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bof::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bof::c));
      return $$1;
   }
}
