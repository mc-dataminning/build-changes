...
public final class yc {
   ...
   public static final Codec<yc> a = Codec.STRING.comapFlatMap(yc::a, yc::b);
   private static final Map<n, yc> c = Stream.of(n.values())
      .filter(n::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new yc($$0.f(), $$0.g())));
   private static final Map<String, yc> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
   private final String f;

   private yc(int $$0, String $$1) {
      this.e = $$0 & 16777215;
      this.f = $$1;
   }
   ...
   public static DataResult<yc> a(String $$0) {
      if ($$0.startsWith("#")) {
         try {
