...
public class dvt extends dvu {
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      this.g = $$0.i("Age");
      uf.a($$0, "exit_portal").filter(dgj::l).ifPresent($$0x -> this.i = $$0x);
      this.j = $$0.q("ExactTeleport");
   }

   public static void a(dgj $$0, ji $$1, dwy $$2, dvt $$3) {
      $$3.g++;
      if ($$3.c()) {
         $$3.h--;
      }
   ...
   public static void b(dgj $$0, ji $$1, dwy $$2, dvt $$3) {
      boolean $$4 = $$3.b();
      boolean $$5 = $$3.c();
      $$3.g++;
      if ($$5) {
   ...
   public static void c(dgj $$0, ji $$1, dwy $$2, dvt $$3) {
      if (!$$0.C) {
         $$3.h = 40;
         $$0.a($$1, $$2.b(), 1, 0);
         a($$0, $$1, $$2);
   ...
   @Nullable
   public fbb a(ard $$0, ji $$1) {
      if (this.i == null && $$0.ai() == dgj.k) {
         ji $$2 = b($$0, $$1);
         $$2 = $$2.b(10);
      ...
      if (this.i != null) {
         ji $$3 = this.j ? this.i : a((dgj)$$0, this.i);
         return $$3.c();
      } else {
         return null;
      }
   ...
   private static ji a(dgj $$0, ji $$1) {
   ...
   private static ji b(ard $$0, ji $$1) {
      ...
      if ($$4 == null) {
         ...
         $$0.K_().a(mc.aL).flatMap($$0x -> $$0x.a(re.f)).ifPresent($$2x -> ((efl)$$2x.a()).a($$0, $$0.m().g(), azh.a($$5.a()), $$5));
         $$4 = $$5;
      } else {
   ...
   private static fbb c(ard $$0, ji $$1) {
      fbb $$2 = new fbb((double)$$1.u(), 0.0, (double)$$1.w()).d();
      int $$3 = 1024;
      fbb $$4 = $$2.c(1024.0);
   ...
   private static boolean a(ard $$0, fbb $$1) {
      return a((dgj)$$0, $$1).a() == -1;
   }

   private static ji a(dfo $$0, ji $$1, int $$2, boolean $$3) {
      ji $$4 = null;
   ...
   private static dzd a(dgj $$0, fbb $$1) {
      return $$0.d(ayz.a($$1.d / 16.0), ayz.a($$1.f / 16.0));
   }

   @Nullable
   private static ji a(dzd $$0) {
      dfp $$1 = $$0.f();
      ...
      for (ji $$7 : ji.c($$2, $$4)) {
         ...
         ji $$9 = $$7.d();
         ji $$10 = $$7.b(2);
         if ($$8.a(djp.fU) && !$$0.a_($$9).m($$0, $$9) && !$$0.a_($$10).m($$0, $$10)) {
   ...
   private static void a(ard $$0, ji $$1, eic $$2) {
      efz.M.a($$2, $$0, $$0.m().g(), azh.a(), $$1);
   }

   @Override
   public boolean a(jn $$0) {
      return djn.a(this.m(), this.n.a_(this.aA_().a($$0)), $$0);
   }
