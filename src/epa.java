...
public class epa extends epe {
   public static final MapCodec<epa> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, epa::new));

   public epa(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<enj.a> a(djn $$0, BiConsumer<iv, eao> $$1, azv $$2, int $$3, iv $$4, emt $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new enj.a(new iv($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new enj.a(new iv($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
