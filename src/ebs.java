...
public class ebs {
   ...
   private final Map<String, ebh> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public ebs(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends ebh> T a(ebh.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends ebh> T b(ebh.a $$0, String $$1) {
      ebh $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends ebh> T a(Function<qr, T> $$0, ass $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
