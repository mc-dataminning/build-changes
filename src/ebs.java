...
public abstract class ebs<O, S> {
   ...
   private static final Function<Entry<ect<?>, Comparable<?>>, String> a = new Function<Entry<ect<?>, Comparable<?>>, String>() {
      public String a(@Nullable Entry<ect<?>, Comparable<?>> $$0) {
         if ($$0 == null) {
            return "<NULL>";
         } else {
            ect<?> $$1 = $$0.getKey();
      ...
      private <T extends Comparable<T>> String a(ect<T> $$0, Comparable<?> $$1) {
         return $$0.b((T)$$1);
      }
   };
   protected final O d;
   ...
   protected ebs(O $$0, Reference2ObjectArrayMap<ect<?>, Comparable<?>> $$1, MapCodec<S> $$2) {
      this.d = $$0;
      this.f = $$1;
      this.e = $$2;
   }

   public <T extends Comparable<T>> S a(ect<T> $$0) {
   ...
   public boolean b(ect<?> $$0) {
      return this.f.containsKey($$0);
   }

   public <T extends Comparable<T>> T c(ect<T> $$0) {
   ...
   public <T extends Comparable<T>> Optional<T> d(ect<T> $$0) {
      return Optional.ofNullable(this.e($$0));
   }

   public <T extends Comparable<T>> T a(ect<T> $$0, T $$1) {
      return Objects.requireNonNullElse(this.e($$0), $$1);
   }

   @Nullable
   private <T extends Comparable<T>> T e(ect<T> $$0) {
      Comparable<?> $$1 = (Comparable<?>)this.f.get($$0);
      return $$1 == null ? null : $$0.g().cast($$1);
   }

   public <T extends Comparable<T>, V extends T> S b(ect<T> $$0, V $$1) {
   ...
   public <T extends Comparable<T>, V extends T> S c(ect<T> $$0, V $$1) {
      Comparable<?> $$2 = (Comparable<?>)this.f.get($$0);
      return (S)($$2 == null ? this : this.a($$0, $$1, $$2));
   }

   private <T extends Comparable<T>, V extends T> S a(ect<T> $$0, V $$1, Comparable<?> $$2) {
      if ($$2.equals($$1)) {
         return (S)this;
      } else {
         int $$3 = $$0.a((T)$$1);
   ...
   public void a(Map<Map<ect<?>, Comparable<?>>, S> $$0) {
      if (this.g != null) {
         throw new IllegalStateException();
      } else {
         Map<ect<?>, S[]> $$1 = new Reference2ObjectArrayMap(this.f.size());
         ObjectIterator var3 = this.f.entrySet().iterator();

         while (var3.hasNext()) {
            Entry<ect<?>, Comparable<?>> $$2 = (Entry<ect<?>, Comparable<?>>)var3.next();
            ect<?> $$3 = $$2.getKey();
   ...
   private Map<ect<?>, Comparable<?>> d(ect<?> $$0, Comparable<?> $$1) {
      Map<ect<?>, Comparable<?>> $$2 = new Reference2ObjectArrayMap(this.f);
      $$2.put($$0, $$1);
      return $$2;
   }
   ...
   protected static <O, S extends ebs<O, S>> Codec<S> a(Codec<O> $$0, Function<O, S> $$1) {
