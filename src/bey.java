...
public class bey extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bap.a(this.a("minecraft:trident", bey::c), this.a("minecraft:arrow", bey::a), this.a("minecraft:spectral_arrow", bey::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bey.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhy.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhy.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bey.a<?> $$1, Type<?> $$2, Type<T> $$3) {
