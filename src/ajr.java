...
public class ajr {
   ...
   private static int a(du $$0, String $$1, eke $$2) throws CommandSyntaxException {
      ekh $$3 = $$0.m().aF();
      if (!$$3.b($$1, $$2)) {
   ...
   private static int a(du $$0, Collection<String> $$1, eke $$2, ep.a $$3, Collection<String> $$4, eke $$5) throws CommandSyntaxException {
      ekh $$6 = $$0.m().aF();
      int $$7 = 0;
   ...
   private static int a(du $$0, Collection<String> $$1, eke $$2) throws CommandSyntaxException {
      if ($$2.c() != ekk.b) {
         throw e.create();
      } else {
         ekh $$3 = $$0.m().aF();
   ...
   private static int b(du $$0, Collection<String> $$1, eke $$2) {
      ekh $$3 = $$0.m().aF();
   ...
   private static int a(du $$0, Collection<String> $$1, eke $$2, int $$3) {
      ekh $$4 = $$0.m().aF();
   ...
   private static int b(du $$0, Collection<String> $$1, eke $$2, int $$3) {
      ekh $$4 = $$0.m().aF();
      int $$5 = 0;
   ...
   private static int c(du $$0, Collection<String> $$1, eke $$2, int $$3) {
      ekh $$4 = $$0.m().aF();
      int $$5 = 0;
   ...
   private static int a(du $$0, String $$1) {
      ...
      if ($$2.isEmpty()) {
         ...
         for (Entry<eke, ekg> $$3 : $$2.entrySet()) {
   ...
   private static int a(du $$0, ekd $$1) throws CommandSyntaxException {
      ekh $$2 = $$0.m().aF();
      if ($$2.a($$1) == null) {
         throw b.create();
      } else {
   ...
   private static int a(du $$0, ekd $$1, eke $$2) throws CommandSyntaxException {
      ekh $$3 = $$0.m().aF();
      if ($$3.a($$1) == $$2) {
         throw c.create();
      } else {
   ...
   private static int a(du $$0, eke $$1, ur $$2) {
      if (!$$1.d().equals($$2)) {
         $$1.a($$2);
   ...
   private static int a(du $$0, eke $$1, ekk.a $$2) {
      if ($$1.f() != $$2) {
         $$1.a($$2);
   ...
   private static int a(du $$0, eke $$1) {
      ekh $$2 = $$0.m().aF();
      $$2.j($$1);
   ...
   private static int a(du $$0, String $$1, ekk $$2, ur $$3) throws CommandSyntaxException {
      ekh $$4 = $$0.m().aF();
      if ($$4.b($$1) != null) {
         throw a.create();
      } else {
   ...
   private static int b(du $$0) {
      Collection<eke> $$1 = $$0.m().aF().c();
      if ($$1.isEmpty()) {
         $$0.a(() -> ur.c("commands.scoreboard.objectives.list.empty"), false);
      } else {
         $$0.a(() -> ur.a("commands.scoreboard.objectives.list.success", $$1.size(), uu.b($$1, eke::e)), false);
      }
