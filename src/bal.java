...
public class bal extends bfa {
   public bal(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgd.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgd.s, "minecraft:jukebox");
