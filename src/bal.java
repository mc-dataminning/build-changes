...
public class bal extends bez {
   public bal(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bga.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bga.s, "minecraft:jukebox");
