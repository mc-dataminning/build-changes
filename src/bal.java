...
public class bal extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bgx.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bal::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bal::a);
      return this.a($$0, "minecraft:trident", bal::a);
   }
