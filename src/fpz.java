public class fpz extends fon {
   private static final fqd a = new fqd(
   ...
   public fpz(fqu $$0, fqt $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   public void b(fob $$0, int $$1, int $$2, float $$3) {
      $$0.a(gmf::H, a.a(this.b(), this.D()), this.F(), this.G(), this.g, this.h);
      fnz $$4 = flh.Q().h;
   ...
   protected void a(fob $$0, int $$1, int $$2, int $$3, int $$4) {
      fui.a($$0, fui.g, $$1, $$2, 0.0F, 0.0F, $$3 - $$1, $$4 - $$2);
   }
   ...
   private void b(fob $$0, fnz $$1, int $$2) {
   ...
   protected void a(fsn $$0) {
      $$0.a(fsm.a, wo.a("gui.narrate.tab", this.n.a()));
   }
