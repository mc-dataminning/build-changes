...
public class fpz implements fqe<dcl> {
   ...
   public void a(dcl $$0, float $$1, elp $$2, foe $$3, int $$4, int $$5) {
      ...
      this.g.e = (-0.0125F + 0.01F * arx.b((float) (Math.PI * 2) * $$16)) * (float) Math.PI;
      this.g.c = -32.0F;
   ...
   public static void a(elp $$0, foe $$1, int $$2, int $$3, fic $$4, gbi $$5, boolean $$6, List<Pair<hg<dcm>, cht>> $$7) {
      a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, false);
   }

   public static void a(elp $$0, foe $$1, int $$2, int $$3, fic $$4, gbi $$5, boolean $$6, List<Pair<hg<dcm>, cht>> $$7, boolean $$8) {
      $$4.a($$0, $$5.a($$1, fom::c, $$8), $$2, $$3);

      for (int $$9 = 0; $$9 < 17 && $$9 < $$7.size(); $$9++) {
         Pair<hg<dcm>, cht> $$10 = $$7.get($$9);
