...
public class gii implements gih {
   public static final int a = 0;
   private final gii.b c = new gii.b();
   private final gii.b d = new gii.b();
   public final gii.a b;
   ...
   private float a(cqm $$0, fsa $$1, int $$2, box $$3) {
   ...
   private float a(box $$0, long $$1, ib $$2) {
      double $$3 = this.a($$0, $$2);
      double $$4 = this.a($$0);
      if ($$0 instanceof ciu $$5 && $$5.g() && $$5.dM().s().i()) {
         if (this.c.a($$1)) {
   ...
   @Nullable
   private fsa a(box $$0, @Nullable fsa $$1) {
      return $$1 == null && $$0.dM() instanceof fsa ? (fsa)$$0.dM() : $$1;
   }

   private boolean a(box $$0, @Nullable ik $$1) {
      return $$1 != null && $$1.a() == $$0.dM().ad() && !($$1.b().b($$0.dk()) < 1.0E-5F);
   }

   private double a(box $$0, ib $$1) {
      ept $$2 = ept.b($$1);
   ...
   public interface a {
      @Nullable
      ik getPos(fsa var1, cqm var2, box var3);
   }
