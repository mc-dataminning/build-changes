...
public class cen {
   ...
   public static iz a(azg $$0, int $$1, int $$2) {
      int $$3 = $$0.a(2 * $$1 + 1) - $$1;
      int $$4 = $$0.a(2 * $$2 + 1) - $$2;
      int $$5 = $$0.a(2 * $$1 + 1) - $$1;
      return new iz($$3, $$4, $$5);
   ...
   @Nullable
   public static iz a(azg $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
   ...
   @Nullable
   public static evq a(btx $$0, Supplier<iz> $$1) {
      return a($$1, $$0::d);
   }

   @Nullable
   public static evq a(Supplier<iz> $$0, ToDoubleFunction<iz> $$1) {
      ...
      return $$3 != null ? evq.c($$3) : null;
   }

   public static iz a(btx $$0, int $$1, azg $$2, iz $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.gb() && $$1 > 1) {
         iz $$6 = $$0.fY();
