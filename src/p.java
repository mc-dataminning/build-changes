...
public class p {
   ...
   public static String a(dix $$0, double $$1, double $$2, double $$3) {
      return String.format(Locale.ROOT, "%.2f,%.2f,%.2f - %s", $$1, $$2, $$3, a($$0, iu.a($$1, $$2, $$3)));
   }

   public static String a(dix $$0, iu $$1) {
      return a($$0, $$1.u(), $$1.v(), $$1.w());
   }

   public static String a(dix $$0, int $$1, int $$2, int $$3) {
   ...
   public static void a(p $$0, dix $$1, iu $$2, @Nullable dzz $$3) {
      if ($$3 != null) {
