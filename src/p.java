...
public class p {
   ...
   public static String a(dgk $$0, double $$1, double $$2, double $$3) {
      return String.format(Locale.ROOT, "%.2f,%.2f,%.2f - %s", $$1, $$2, $$3, a($$0, ji.a($$1, $$2, $$3)));
   }

   public static String a(dgk $$0, ji $$1) {
      return a($$0, $$1.u(), $$1.v(), $$1.w());
   }

   public static String a(dgk $$0, int $$1, int $$2, int $$3) {
   ...
   public static void a(p $$0, dgk $$1, ji $$2, @Nullable dwx $$3) {
      if ($$3 != null) {
