...
public class epx {
   ...
   static class a implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
         return $$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d;
      }

      @Override
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.f.d()].d = true;
         return new epx.k($$0, $$1);
      }
   }

   static class b implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         ...
         return new epx.l($$0, $$1);
      }
   }

   static class c implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.b.d()].d = true;
         return new epx.m($$0, $$1);
      }
   }

   static class d implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         ...
         return new epx.n($$0, $$1);
      }
   }

   static class e implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[jn.c.d()].d = true;
         return new epx.o($$0, $$3);
      }
   }

   static class f implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
         return true;
      }
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         $$1.d = true;
         return new epx.s($$0, $$1, $$2);
      }
   }

   static class g implements epx.i {
      @Override
      public boolean a(epx.v $$0) {
      ...
      public epx.r a(jn $$0, epx.v $$1, azh $$2) {
         $$1.d = true;
         return new epx.t($$0, $$1);
      }
   }

   public static class h extends epx.r {
      ...
      private epx.v G;
      private epx.v H;
      private final List<epx.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, jn $$3) {
         super(eoe.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<epx.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new epx.p($$3, this.G));
         this.I.add(new epx.j($$3, this.H));
         List<epx.i> $$5 = Lists.newArrayList();
         $$5.add(new epx.b());
         $$5.add(new epx.d());
         $$5.add(new epx.e());
         $$5.add(new epx.a());
         ...
         enf $$10 = enf.a(this.b(1, 1, 1), this.b(23, 8, 21));
         enf $$11 = enf.a(this.b(34, 1, 1), this.b(56, 8, 21));
         enf $$12 = enf.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new epx.u($$3, $$10, $$13++));
         this.I.add(new epx.u($$3, $$11, $$13++));
         this.I.add(new epx.q($$3, $$12));
      }
      ...
      private List<epx.v> b(azh $$0) {
         epx.v[] $$1 = new epx.v[75];
         ...
         epx.v $$23 = new epx.v(1003);
         epx.v $$24 = new epx.v(1001);
         epx.v $$25 = new epx.v(1002);
         $$1[v].a(jn.b, $$23);
         $$1[w].a(jn.d, $$24);
         $$1[x].a(jn.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<epx.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhh $$2, azh $$3, enf $$4) {
         int $$5 = 24;
      ...
      private void a(dhh $$0, azh $$1, enf $$2) {
      ...
      private void b(dhh $$0, azh $$1, enf $$2) {
      ...
      private void c(dhh $$0, azh $$1, enf $$2) {
      ...
      private void d(dhh $$0, azh $$1, enf $$2) {
      ...
      private void e(dhh $$0, azh $$1, enf $$2) {
      ...
      private void f(dhh $$0, azh $$1, enf $$2) {
   ...
   interface i {
      boolean a(epx.v var1);

      epx.r a(jn var1, epx.v var2, azh var3);
   }

   public static class j extends epx.r {
      public j(jn $$0, epx.v $$1) {
         super(eoe.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhh $$0, dhf $$1, dyu $$2, azh $$3, enf $$4, dfp $$5, ji $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, djp.co.m(), djp.co.m(), false);
   ...
   public static class k extends epx.r {
      public k(jn $$0, epx.v $$1) {
         super(eoe.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends epx.r {
      public l(jn $$0, epx.v $$1) {
         super(eoe.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends epx.r {
      public m(jn $$0, epx.v $$1) {
         super(eoe.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends epx.r {
      public n(jn $$0, epx.v $$1) {
         super(eoe.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends epx.r {
      public o(jn $$0, epx.v $$1) {
         super(eoe.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends epx.r {
      public p(jn $$0, epx.v $$1) {
         super(eoe.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends epx.r {
      public q(jn $$0, enf $$1) {
         super(eoe.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends enr {
      protected static final dwy b = djp.ix.m();
      protected static final dwy c = djp.iy.m();
      protected static final dwy d = djp.iz.m();
      protected static final dwy h = c;
      protected static final dwy i = djp.iG.m();
      protected static final boolean j = true;
      protected static final dwy k = djp.J.m();
      protected static final Set<djn> l = ImmutableSet.builder().add(djp.eb).add(djp.ja).add(djp.ny).add(k.b()).build();
      ...
      public r(eoe $$0, jn $$1, int $$2, enf $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eoe $$0, int $$1, jn $$2, epx.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static enf a(jn $$0, epx.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         enf $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhh $$0, enf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dwy $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhh $$0, enf $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhh $$0, enf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dwy $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(enf $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhh $$0, enf $$1, int $$2, int $$3, int $$4) {
         ji $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clo $$6 = but.M.a($$0.a(), bus.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bus.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends epx.r {
      private int a;

      public s(jn $$0, epx.v $$1, azh $$2) {
         super(eoe.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends epx.r {
      public t(jn $$0, epx.v $$1) {
         super(eoe.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends epx.r {
      private int a;

      public u(jn $$0, enf $$1, int $$2) {
         super(eoe.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
