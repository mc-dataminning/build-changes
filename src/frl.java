...
public class frl {
   ...
   public fre a(Vector3f $$0, Vector3f $$1, frg $$2, gbh $$3, hx $$4, gdq $$5, @Nullable frh $$6, boolean $$7, agg $$8) {
      fri $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ati.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ati.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ati.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ati.i($$11, $$9.a[3], $$13);
      ...
      return new fre($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fri a(fri $$0, hx $$1, j $$2, agg $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ati.b($$23), ati.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fri(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fri $$0, gbh $$1, hx $$2, float[] $$3, j $$4, @Nullable frh $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, hx $$2, fri $$3, float[] $$4, gbh $$5, j $$6, @Nullable frh $$7, boolean $$8) {
      fpy.b $$9 = fpy.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gbh $$3, fri $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable frh $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, hx $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (ati.a($$13, $$18) && ati.a($$14, $$19) && ati.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
