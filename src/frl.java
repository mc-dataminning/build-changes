...
public class frl implements frp.a {
   ...
   private final eqx J;
   private final Map<gw, frl.a> K = Maps.newHashMap();
   private final Map<UUID, vw.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bis $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dG();
      });
   }

   private void b(elr $$0, fog $$1, double $$2, double $$3, double $$4) {
      gw $$5 = gw.a($$2, $$3, $$4);
   ...
   private void a(elr $$0, fog $$1, frl.a $$2) {
      int $$3 = 0;
   ...
   private void a(elr $$0, fog $$1, vw.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         frx.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(elr $$0, fog $$1, vw.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(elr $$0, fog $$1, String $$2, frl.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(frl.a $$0) {
      return this.b($$0.a).stream().map(abc::a).collect(Collectors.toSet());
   }

   private Set<String> c(frl.a $$0) {
      return this.c($$0.a).stream().map(abc::a).collect(Collectors.toSet());
   }

   private boolean b(vw.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(vw.a $$0) {
      cbw $$1 = this.J.s;
   ...
   private Collection<UUID> b(gw $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(vw.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(gw $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(vw.a::a).collect(Collectors.toSet());
   }

   private Map<gw, List<String>> c() {
      Map<gw, List<String>> $$0 = Maps.newHashMap();

      for (vw.a $$1 : this.L.values()) {
   ...
   private void d() {
      frp.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
