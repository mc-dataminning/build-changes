...
public class exz {
   ...
   private static final Map<doy.a, String> e = ac.a(new EnumMap<>(doy.a.class), $$0 -> {
      $$0.put(doy.a.a, "SW");
      $$0.put(doy.a.b, "S");
      $$0.put(doy.a.c, "OW");
      $$0.put(doy.a.d, "O");
   ...
   private dlw l;
   @Nullable
   private CompletableFuture<dlw> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final auz r = new auz();
   private final auz s = new auz();
   private final auz t = new auz();
   private final auz u = new auz();
   private final ezh v;
   private final ezj w;
   private final ezi x;
   private final ezg y;
   ...
   public exz(evr $$0) {
      ...
      this.g = new exz.a();
      this.h = $$0.h;
      this.v = new ezh(this.h, this.r);
      this.w = new ezj(this.h, this.s, () -> $$0.r.s().g());
      this.x = new ezi(this.h, this.t);
      this.y = new ezg(this.h, this.u);
   }
   ...
   private void a(exe $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         ctx $$23 = this.p();
         LongSet $$24 = (LongSet)($$23 instanceof ane ? ((ane)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.am().dq(), this.f.am().ds(), this.f.am().dw()));
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, aup.g($$15.dB()), aup.g($$15.dD())));
         dlw $$27 = this.r();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(cug.a, $$14);
            int $$30 = this.f.r.a(cug.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dlw $$31 = this.q();
            StringBuilder $$32 = new StringBuilder("CH");

            for (doy.a $$33 : doy.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.J_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  bka $$37 = new bka($$23.ak(), $$23.Y(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            cui.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bmr> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bmr.values())
   ...
   private static String a(ih<cuw> $$0) {
   ...
   private ctx p() {
      return (ctx)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private dlw q() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dlq.n, false).thenApply($$0x -> (dlw)$$0x.map($$0xx -> (dlw)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", epd.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", evr.O().aM().k(), evr.O().aM().l(), epd.a()),
            epd.c(),
            epd.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == ema.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dks<?>, Comparable<?>> $$7 = (Entry<dks<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ema.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dks<?>, Comparable<?>> $$10 = (Entry<dks<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dks<?>, Comparable<?>> $$0) {
      dks<?> $$1 = $$0.getKey();
