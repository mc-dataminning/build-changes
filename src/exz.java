...
public class exz {
   ...
   public static List<exz.a> a(String $$0, exz.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<exz.a> a(String $$0, List<exz.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<exz.a> a(List<String> $$0, List<exz.b> $$1) {
      int $$2 = 0;
      List<exz.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<exz.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static exz.b a(String $$0, String $$1) {
         return new exz.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static exz.b a(String $$0) {
         return new exz.b($$0);
      }
   }
}
