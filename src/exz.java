...
public enum exz implements emd {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static enc a(int $$0, int $$1, exz.a $$2) {
      enc $$3 = new enc(enc.a.a, $$0, $$1, false);
