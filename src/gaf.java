...
public class gaf {
   ...
   CompletableFuture<gae> a(GameProfile $$0, gaf.c $$1) {
      ...
      CompletableFuture<aew> $$10 = $$9 != null ? this.d.a($$9) : CompletableFuture.completedFuture(null);
      MinecraftProfileTexture $$11 = $$1.c();
      CompletableFuture<aew> $$12 = $$11 != null ? this.e.a($$11) : CompletableFuture.completedFuture(null);
   ...
   static class b {
      ...
      public CompletableFuture<aew> a(MinecraftProfileTexture $$0) {
         String $$1 = $$0.getHash();
         CompletableFuture<aew> $$2 = this.d.get($$1);
         if ($$2 == null) {
            $$2 = this.b($$0);
            this.d.put($$1, $$2);
         }
