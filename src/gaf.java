...
public class gaf extends gah<lc> {
   private final Vector3f a;
   private final Vector3f b;

   protected gaf(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, lc $$7, gbx $$8) {
   ...
   public static class a implements gbf<lc> {
      private final gbx a;
      ...
      public gbc a(lc $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
