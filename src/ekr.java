...
public class ekr {
   ...
   public ekr(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eks> $$1) throws IOException {
   ...
   public List<eks> a(Path $$0) throws IOException {
      List<eks> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eks> a(Path $$0, boolean $$1) throws IOException {
      List<eks> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eks> $$1) throws IOException {
