...
public class ekr {
   ...
   static class a implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
         return $$0.c[je.f.d()] && !$$0.b[je.f.d()].d;
      }

      @Override
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         $$1.d = true;
         $$1.b[je.f.d()].d = true;
         return new ekr.k($$0, $$1);
      }
   }

   static class b implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         ...
         return new ekr.l($$0, $$1);
      }
   }

   static class c implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         $$1.d = true;
         $$1.b[je.b.d()].d = true;
         return new ekr.m($$0, $$1);
      }
   }

   static class d implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         ...
         return new ekr.n($$0, $$1);
      }
   }

   static class e implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         ...
         $$3.d = true;
         $$3.b[je.c.d()].d = true;
         return new ekr.o($$0, $$3);
      }
   }

   static class f implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
         return true;
      }
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         $$1.d = true;
         return new ekr.s($$0, $$1, $$2);
      }
   }

   static class g implements ekr.i {
      @Override
      public boolean a(ekr.v $$0) {
      ...
      public ekr.r a(je $$0, ekr.v $$1, azf $$2) {
         $$1.d = true;
         return new ekr.t($$0, $$1);
      }
   }

   public static class h extends ekr.r {
      ...
      private ekr.v G;
      private ekr.v H;
      private final List<ekr.r> I = Lists.newArrayList();

      public h(azf $$0, int $$1, int $$2, je $$3) {
         super(eiz.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ekr.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ekr.p($$3, this.G));
         this.I.add(new ekr.j($$3, this.H));
         List<ekr.i> $$5 = Lists.newArrayList();
         $$5.add(new ekr.b());
         $$5.add(new ekr.d());
         $$5.add(new ekr.e());
         $$5.add(new ekr.a());
         ...
         eia $$10 = eia.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eia $$11 = eia.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eia $$12 = eia.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ekr.u($$3, $$10, $$13++));
         this.I.add(new ekr.u($$3, $$11, $$13++));
         this.I.add(new ekr.q($$3, $$12));
      }
      ...
      private List<ekr.v> b(azf $$0) {
         ekr.v[] $$1 = new ekr.v[75];
         ...
         ekr.v $$23 = new ekr.v(1003);
         ekr.v $$24 = new ekr.v(1001);
         ekr.v $$25 = new ekr.v(1002);
         $$1[v].a(je.b, $$23);
         $$1[w].a(je.d, $$24);
         $$1[x].a(je.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ekr.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcr $$2, azf $$3, eia $$4) {
         int $$5 = 24;
      ...
      private void a(dcr $$0, azf $$1, eia $$2) {
      ...
      private void b(dcr $$0, azf $$1, eia $$2) {
      ...
      private void c(dcr $$0, azf $$1, eia $$2) {
      ...
      private void d(dcr $$0, azf $$1, eia $$2) {
      ...
      private void e(dcr $$0, azf $$1, eia $$2) {
      ...
      private void f(dcr $$0, azf $$1, eia $$2) {
   ...
   interface i {
      boolean a(ekr.v var1);

      ekr.r a(je var1, ekr.v var2, azf var3);
   }

   public static class j extends ekr.r {
      public j(je $$0, ekr.v $$1) {
         super(eiz.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcr $$0, dcp $$1, dtx $$2, azf $$3, eia $$4, dbd $$5, iz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dez.ch.o(), dez.ch.o(), false);
   ...
   public static class k extends ekr.r {
      public k(je $$0, ekr.v $$1) {
         super(eiz.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ekr.r {
      public l(je $$0, ekr.v $$1) {
         super(eiz.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ekr.r {
      public m(je $$0, ekr.v $$1) {
         super(eiz.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ekr.r {
      public n(je $$0, ekr.v $$1) {
         super(eiz.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ekr.r {
      public o(je $$0, ekr.v $$1) {
         super(eiz.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ekr.r {
      public p(je $$0, ekr.v $$1) {
         super(eiz.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ekr.r {
      public q(je $$0, eia $$1) {
         super(eiz.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eim {
      protected static final dsa b = dez.hZ.o();
      protected static final dsa c = dez.ia.o();
      protected static final dsa d = dez.ib.o();
      protected static final dsa h = c;
      protected static final dsa i = dez.ii.o();
      protected static final boolean j = true;
      protected static final dsa k = dez.G.o();
      protected static final Set<dex> l = ImmutableSet.builder().add(dez.dO).add(dez.iC).add(dez.mW).add(k.b()).build();
      ...
      public r(eiz $$0, je $$1, int $$2, eia $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eiz $$0, int $$1, je $$2, ekr.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eia a(je $$0, ekr.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eia $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcr $$0, eia $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsa $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dcr $$0, eia $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcr $$0, eia $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsa $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eia $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcr $$0, eia $$1, int $$2, int $$3, int $$4) {
         iz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjq $$6 = bsy.D.a((dbw)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
   ...
   public static class s extends ekr.r {
      private int a;

      public s(je $$0, ekr.v $$1, azf $$2) {
         super(eiz.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ekr.r {
      public t(je $$0, ekr.v $$1) {
         super(eiz.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ekr.r {
      private int a;

      public u(je $$0, eia $$1, int $$2) {
         super(eiz.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
