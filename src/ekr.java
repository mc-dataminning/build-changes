...
public class ekr implements dvj.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ekr> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axq<ekr> a = axq.a(f);
   private final ekv g;
   private final ekv h;
   private final ekv i;
   ...
   public static ekr a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ekr(new dwr(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ekr(ekv $$0, ekv $$1, ekv $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ekr(ayd $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ekv.a($$0, IntStream.rangeClosed(-15, 0)),
         ekv.a($$0, IntStream.rangeClosed(-15, 0)),
         ekv.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ekr a(ayd $$0) {
      return new ekr($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dvj.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eks $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ekv.b($$4 * $$13), ekv.b($$5 * $$13), ekv.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ekv.b($$1 * $$13);
         double $$21 = ekv.b($$2 * $$13);
         double $$22 = ekv.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eks $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return axw.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
