...
public class anf {
   ...
   private static int a(ek $$0, arv $$1) {
      GameProfile $$2 = $$1.gi();
      $$1.f.n();
      $$0.a(() -> xc.b("Switched player " + $$2.getName() + "(" + $$2.getId() + ") to config mode"), false);
      return 1;
   }
   ...
   private static int a(ek $$0, UUID $$1) {
      ...
      $$0.b(xc.b("Can't find player to unconfig"));
      return 0;
   }
}
