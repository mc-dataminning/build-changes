...
public class anf {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a(
                                       ...
                                       .then(eu.a("at").then(eu.a("targets", fg.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bto $$2x : fg.c($$0x, "targets")) {
                                             $$1x.add(((et)$$0x.getSource()).a((arh)$$2x.dS()).a($$2x.dq()).a($$2x.bR()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("positioned")
                                       ...
                                       .then(eu.a("over").then(eu.a("heightmap", fj.a()).redirect($$2, $$0x -> {
                                          eys $$1x = ((et)$$0x.getSource()).d();
                                          arh $$2x = ((et)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kg.b($$3), kg.b($$4))) {
                                             throw gp.a.create();
                                          } else {
                                             int $$5 = $$2x.a(fj.a($$0x, "heightmap"), azd.a($$3), azd.a($$4));
                                             return ((et)$$0x.getSource()).a(new eys($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         eu.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)eu.a("id", fu.a())
                     .suggests(amp.a)
                     .then(eu.a("value").redirect($$0, $$1x -> a((et)$$1x.getSource(), amp.a($$1x), true, $$2))))
                  .then(eu.a("max").redirect($$0, $$1x -> a((et)$$1x.getSource(), amp.a($$1x), false, $$2)))
            )
      );
   ...
   private static et a(et $$0, Collection<ezw> $$1, ezp $$2, boolean $$3) {
      ezx $$4 = $$0.l().aJ();
      return $$0.a(($$4x, $$5) -> {
         for (ezw $$6 : $$1) {
            ezv $$7 = $$4.c($$6, $$2);
   ...
   private static et a(et $$0, ame $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static et a(et $$0, aps $$1, fl.g $$2, IntFunction<vc> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            uf $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(arh $$0, je $$1) {
      ddm $$2 = new ddm($$1);
      dwu $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.C() == aqx.d && $$0.c($$2.a());
   }
                                          ...
                                          eu.a("pos", gp.a())
                                             .then(
                                                a(
                                                   ...
                                                   eu.a("block", gl.a($$3)),
                                                   $$2,
                                                   $$0x -> gl.a($$0x, "block").test(new dus(((et)$$0x.getSource()).e(), gp.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                                       ...
                                       .then(
                                          eu.a("pos", gp.a())
                                             .then(
                                                a(
                                                   $$0,
                                                   eu.a("biome", fw.a($$3, lv.aG)),
                                                   $$2,
                                                   $$0x -> fw.a($$0x, "biome", lv.aG).test(((et)$$0x.getSource()).e().t(gp.a($$0x, "pos")))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     eu.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)eu.a("entities", fg.b()).fork($$0, $$1x -> a($$1x, $$2, !fg.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (anf.b)($$0x -> fg.c($$0x, "entities").size())))
                        )
                  ))
               .then(eu.a("predicate").then(a($$0, eu.a("predicate", fv.c($$3)).suggests(f), $$2, $$0x -> a((et)$$0x.getSource(), fv.c($$0x, "predicate"))))))
            .then(eu.a("function").then(eu.a("name", hb.a()).suggests(ank.b).fork($$0, new anf.d($$2)))))
         .then(
                                 ...
                                 eu.a("slots", gc.a())
                                    .then(
                                       ((RequiredArgumentBuilder)eu.a("item_predicate", hf.a($$3))
                                          ...
                                          .executes(a($$2, (anf.b)($$0x -> a(fg.b($$0x, "entities"), gc.a($$0x, "slots"), hf.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              eu.a("slots", gc.a())
                                 .then(
                                    ((RequiredArgumentBuilder)eu.a("item_predicate", hf.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (anf.b)($$0x -> a((et)$$0x.getSource(), gp.a($$0x, "pos"), gc.a($$0x, "slots"), hf.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)eu.a("path", fl.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fl.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (anf.b)($$1xx -> a($$4.a($$1xx), fl.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bto> $$0, csu $$1, Predicate<cvp> $$2) {
      int $$3 = 0;
   ...
   private static int a(et $$0, je $$1, csu $$2, Predicate<cvp> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bri $$5 = anp.a($$0, $$1, anp.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<et> a(boolean $$0, anf.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
   ...
   private static int a(aps $$0, fl.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<et> $$0, anf.e $$1) throws CommandSyntaxException {
      ezw $$2 = fy.a($$0, "target");
      ezp $$3 = fn.a($$0, "targetObjective");
      ezw $$4 = fy.a($$0, "source");
      ezp $$5 = fn.a($$0, "sourceObjective");
      ezx $$6 = ((et)$$0.getSource()).l().aJ();
      ezt $$7 = $$6.d($$2, $$3);
      ezt $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<et> $$0, dh.d $$1) throws CommandSyntaxException {
      ezw $$2 = fy.a($$0, "target");
      ezp $$3 = fn.a($$0, "targetObjective");
      ezx $$4 = ((et)$$0.getSource()).l().aJ();
      ezt $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(et $$0, jn<ews> $$1) {
      arh $$2 = $$0.e();
      etk $$3 = new etk.a($$2).a(ewd.f, $$0.d()).b(ewd.a, $$0.f()).a(ewc.d);
      eth $$4 = new eth.a($$3).a(Optional.empty());
      $$4.b(eth.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<et, ?> a(CommandNode<et> $$0, ArgumentBuilder<et, ?> $$1, boolean $$2, anf.c $$3) {
   ...
   private static OptionalInt a(arh $$0, je $$1, je $$2, je $$3, boolean $$4) throws CommandSyntaxException {
      eku $$5 = eku.a($$1, $$2);
      eku $$6 = eku.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<et> a(Function<bto, Optional<bto>> $$0) {
      return $$1 -> {
         et $$2 = (et)$$1.getSource();
         bto $$3 = $$2.f();
   ...
   private static RedirectModifier<et> b(Function<bto, Stream<bto>> $$0) {
      return $$1 -> {
         et $$2 = (et)$$1.getSource();
         bto $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<et> a(CommandNode<et> $$0, LiteralArgumentBuilder<et> $$1) {
      return (LiteralArgumentBuilder<et>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              eu.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bto, Optional<bto>>)($$0x -> $$0x instanceof bur $$1x ? Optional.ofNullable($$1x.R_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              eu.a("leasher")
                                 .fork(
                                    $$0, a((Function<bto, Optional<bto>>)($$0x -> $$0x instanceof bui $$1x ? Optional.ofNullable($$1x.C()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           eu.a("target")
                              .fork($$0, a((Function<bto, Optional<bto>>)($$0x -> $$0x instanceof bvh $$1x ? Optional.ofNullable($$1x.m()) : Optional.empty())))
                        ))
                     .then(
                        eu.a("attacker")
                           .fork($$0, a((Function<bto, Optional<bto>>)($$0x -> $$0x instanceof btk $$1x ? Optional.ofNullable($$1x.X_()) : Optional.empty())))
                     ))
                  .then(eu.a("vehicle").fork($$0, a((Function<bto, Optional<bto>>)($$0x -> Optional.ofNullable($$0x.dg()))))))
               .then(eu.a("controller").fork($$0, a((Function<bto, Optional<bto>>)($$0x -> Optional.ofNullable($$0x.cU()))))))
            .then(
               eu.a("origin").fork($$0, a((Function<bto, Optional<bto>>)($$0x -> $$0x instanceof bvi $$1x ? Optional.ofNullable($$1x.s()) : Optional.empty())))
            ))
         .then(eu.a("passengers").fork($$0, b((Function<bto, Stream<bto>>)($$0x -> $$0x.cW().stream()))));
   }

   private static et a(et $$0, jn.c<btv<?>> $$1) throws CommandSyntaxException {
      bto $$2 = apc.a($$0, $$1, $$0.d(), new uf(), true);
      return $$0.a($$2);
   }

   public static <T extends ev<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable uf $$5, hu<T> $$6, anf.a<T, Collection<ih<T>>> $$7, ho $$8
   ) {
   ...
   static class d implements hr.a<et> {
      ...
      public void a(et $$0, List<et> $$1, ContextChain<et> $$2, ho $$3, hu<et> $$4) {
         anf.a($$0, $$1, ank::a, this.a, $$2, null, $$4, $$0x -> hb.a($$0x, "name"), $$3);
      }
   }
