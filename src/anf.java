...
public class anf {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vq.c("commands.transfer.error.no_players"));
   ...
   private static int a(du $$0, String $$1, int $$2, Collection<aox> $$3) throws CommandSyntaxException {
      if ($$3.isEmpty()) {
         throw a.create();
      } else {
         for (aox $$4 : $$3) {
         ...
         if ($$3.size() == 1) {
            $$0.a(() -> vq.a("commands.transfer.success.single", $$3.iterator().next().Q_(), $$1, $$2), true);
         } else {
            $$0.a(() -> vq.a("commands.transfer.success.multiple", $$3.size(), $$1, $$2), true);
         }
