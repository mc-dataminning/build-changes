...
public class anf extends anb {
   static final Logger c = LogUtils.getLogger();
   private final anf.b d;
   private final String e;

   anf(String $$0, anf.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(ani $$0, afw $$1) {
   ...
   @Nullable
   private aol<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aol.create($$1, $$2);
      }
   }
   ...
   public static class a implements aob.c {
      ...
      @Override
      public anh a(String $$0) {
         anf.b $$1 = new anf.b(this.a);
         return new anf($$0, $$1, this.b, "");
      }

      @Override
      public anh a(String $$0, aob.a $$1) {
         anf.b $$2 = new anf.b(this.a);
         anh $$3 = new anf($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<anh> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new anf($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  anf.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
