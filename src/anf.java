...
public class anf {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> xo.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(xo.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> xo.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eq.a(
                                       ...
                                       .then(eq.a("at").then(eq.a("targets", fc.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bss $$2x : fc.c($$0x, "targets")) {
                                             $$1x.add(((ep)$$0x.getSource()).a((are)$$2x.dP()).a($$2x.dn()).a($$2x.bM()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eq.a("positioned")
                                       ...
                                       .then(eq.a("over").then(eq.a("heightmap", ff.a()).redirect($$2, $$0x -> {
                                          evp $$1x = ((ep)$$0x.getSource()).d();
                                          are $$2x = ((ep)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kb.b($$3), kb.b($$4))) {
                                             throw gl.a.create();
                                          } else {
                                             int $$5 = $$2x.a(ff.a($$0x, "heightmap"), ayx.a($$3), ayx.a($$4));
                                             return ((ep)$$0x.getSource()).a(new evp($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         eq.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)eq.a("id", fq.a())
                     .suggests(amp.a)
                     .then(eq.a("value").redirect($$0, $$1x -> a((ep)$$1x.getSource(), amp.a($$1x), true, $$2))))
                  .then(eq.a("max").redirect($$0, $$1x -> a((ep)$$1x.getSource(), amp.a($$1x), false, $$2)))
            )
      );
   ...
   private static ep a(ep $$0, Collection<ews> $$1, ewl $$2, boolean $$3) {
      ewt $$4 = $$0.l().aK();
      return $$0.a(($$4x, $$5) -> {
         for (ews $$6 : $$1) {
            ewr $$7 = $$4.c($$6, $$2);
   ...
   private static ep a(ep $$0, ame $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ep a(ep $$0, apt $$1, fh.g $$2, IntFunction<vo> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            ur $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(are $$0, iz $$1) {
      dbd $$2 = new dbd($$1);
      dug $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == aqx.d && $$0.c($$2.a());
   }
                                          ...
                                          eq.a("pos", gl.a())
                                             .then(
                                                a(
                                                   ...
                                                   eq.a("block", gh.a($$3)),
                                                   $$2,
                                                   $$0x -> gh.a($$0x, "block").test(new dse(((ep)$$0x.getSource()).e(), gl.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     eq.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)eq.a("entities", fc.b()).fork($$0, $$1x -> a($$1x, $$2, !fc.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (anf.b)($$0x -> fc.c($$0x, "entities").size())))
                        )
                  ))
               .then(eq.a("predicate").then(a($$0, eq.a("predicate", fr.c($$3)).suggests(f), $$2, $$0x -> a((ep)$$0x.getSource(), fr.c($$0x, "predicate"))))))
            .then(eq.a("function").then(eq.a("name", gx.a()).suggests(ank.b).fork($$0, new anf.d($$2)))))
         .then(
                                 ...
                                 eq.a("slots", fy.a())
                                    .then(
                                       ((RequiredArgumentBuilder)eq.a("item_predicate", hb.a($$3))
                                          ...
                                          .executes(a($$2, (anf.b)($$0x -> a(fc.b($$0x, "entities"), fy.a($$0x, "slots"), hb.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              eq.a("slots", fy.a())
                                 .then(
                                    ((RequiredArgumentBuilder)eq.a("item_predicate", hb.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (anf.b)($$0x -> a((ep)$$0x.getSource(), gl.a($$0x, "pos"), fy.a($$0x, "slots"), hb.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)eq.a("path", fh.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fh.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (anf.b)($$1xx -> a($$4.a($$1xx), fh.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bss> $$0, cro $$1, Predicate<cun> $$2) {
      int $$3 = 0;
   ...
   private static int a(ep $$0, iz $$1, cro $$2, Predicate<cun> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bql $$5 = anp.a($$0, $$1, anp.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<ep> a(boolean $$0, anf.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ep)$$1x.getSource()).a(() -> xo.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ep)$$1x.getSource()).a(() -> xo.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(apt $$0, fh.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ep> $$0, anf.e $$1) throws CommandSyntaxException {
      ews $$2 = fu.a($$0, "target");
      ewl $$3 = fj.a($$0, "targetObjective");
      ews $$4 = fu.a($$0, "source");
      ewl $$5 = fj.a($$0, "sourceObjective");
      ewt $$6 = ((ep)$$0.getSource()).l().aK();
      ewp $$7 = $$6.d($$2, $$3);
      ewp $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ep> $$0, de.d $$1) throws CommandSyntaxException {
      ews $$2 = fu.a($$0, "target");
      ewl $$3 = fj.a($$0, "targetObjective");
      ewt $$4 = ((ep)$$0.getSource()).l().aK();
      ewp $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ep $$0, ji<etq> $$1) {
      are $$2 = $$0.e();
      eqj $$3 = new eqj.a($$2).a(etc.f, $$0.d()).b(etc.a, $$0.f()).a(etb.d);
      eqg $$4 = new eqg.a($$3).a(Optional.empty());
      $$4.b(eqg.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<ep, ?> a(CommandNode<ep> $$0, ArgumentBuilder<ep, ?> $$1, boolean $$2, anf.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ep)$$2x.getSource()).a(() -> xo.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ep> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ep)$$0.getSource()).a(() -> xo.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ep> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ep)$$0.getSource()).a(() -> xo.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(are $$0, iz $$1, iz $$2, iz $$3, boolean $$4) throws CommandSyntaxException {
      eia $$5 = eia.a($$1, $$2);
      eia $$6 = eia.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ep> a(Function<bss, Optional<bss>> $$0) {
      return $$1 -> {
         ep $$2 = (ep)$$1.getSource();
         bss $$3 = $$2.f();
   ...
   private static RedirectModifier<ep> b(Function<bss, Stream<bss>> $$0) {
      return $$1 -> {
         ep $$2 = (ep)$$1.getSource();
         bss $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<ep> a(CommandNode<ep> $$0, LiteralArgumentBuilder<ep> $$1) {
      return (LiteralArgumentBuilder<ep>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              eq.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bss, Optional<bss>>)($$0x -> $$0x instanceof btv $$1x ? Optional.ofNullable($$1x.P_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              eq.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<bss, Optional<bss>>)($$0x -> $$0x instanceof btp $$1x ? Optional.ofNullable($$1x.gf()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           eq.a("target")
                              .fork($$0, a((Function<bss, Optional<bss>>)($$0x -> $$0x instanceof bul $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
                        ))
                     .then(
                        eq.a("attacker")
                           .fork($$0, a((Function<bss, Optional<bss>>)($$0x -> $$0x instanceof bsp $$1x ? Optional.ofNullable($$1x.T_()) : Optional.empty())))
                     ))
                  .then(eq.a("vehicle").fork($$0, a((Function<bss, Optional<bss>>)($$0x -> Optional.ofNullable($$0x.dc()))))))
               .then(eq.a("controller").fork($$0, a((Function<bss, Optional<bss>>)($$0x -> Optional.ofNullable($$0x.cQ()))))))
            .then(
               eq.a("origin").fork($$0, a((Function<bss, Optional<bss>>)($$0x -> $$0x instanceof bum $$1x ? Optional.ofNullable($$1x.s()) : Optional.empty())))
            ))
         .then(eq.a("passengers").fork($$0, b((Function<bss, Stream<bss>>)($$0x -> $$0x.cS().stream()))));
   }

   private static ep a(ep $$0, ji.c<bsy<?>> $$1) throws CommandSyntaxException {
      bss $$2 = apd.a($$0, $$1, $$0.d(), new ur(), true);
      return $$0.a($$2);
   }

   public static <T extends er<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable ur $$5, hp<T> $$6, anf.a<T, Collection<ib<T>>> $$7, hj $$8
   ) {
   ...
   static class d implements hm.a<ep> {
      ...
      public void a(ep $$0, List<ep> $$1, ContextChain<ep> $$2, hj $$3, hp<ep> $$4) {
         anf.a($$0, $$1, ank::a, this.a, $$2, null, $$4, $$0x -> gx.a($$0x, "name"), $$3);
      }
   }
