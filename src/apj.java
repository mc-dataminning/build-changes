...
public class apj {
   ...
   private static int a(ep $$0, String $$1, int $$2, Collection<arc> $$3) throws CommandSyntaxException {
      if ($$3.isEmpty()) {
         throw a.create();
      } else {
         for (arc $$4 : $$3) {
         ...
         if ($$3.size() == 1) {
            $$0.a(() -> xl.a("commands.transfer.success.single", $$3.iterator().next().O_(), $$1, $$2), true);
         } else {
