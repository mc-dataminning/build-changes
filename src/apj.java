...
public class apj extends apo {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<apk<?>> e = Sets.newHashSet();

   public apj(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<apk<?>> d() {
      Set<apk<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<apk<T>> a(apm<T> $$0, String $$1) {
      return Optional.ofNullable(aew.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static qw a(JsonObject $$0) {
      qw $$1 = new qw();
   ...
   protected String b() {
      Map<apm<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apk<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apk<?>>)$$3.next();
         apk<?> $$2 = (apk<?>)$$1.getKey();
      ...
      for (Entry<apm<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> aew b(apk<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(akr $$0) {
      Object2IntMap<apk<?>> $$1 = new Object2IntOpenHashMap();
