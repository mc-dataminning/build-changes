...
public final class apj<T> implements Comparable<apj<?>> {
   private final apk<T> a;
   private final int b;
   private final T c;
   private long d;

   protected apj(apk<T> $$0, int $$1, T $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof apj<?> $$1) ? false : this.b == $$1.b && Objects.equals(this.a, $$1.a) && Objects.equals(this.c, $$1.c);
      }
   }
