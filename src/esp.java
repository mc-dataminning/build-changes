...
public class esp extends gkp {
   ...
   public esp(fdb $$0, long $$1, boolean $$2) {
   ...
   public void aN_() {
      this.z = this.g / 2 - 150;
      this.d(exg.a(ve.k, $$0 -> this.aE_()).a((this.g - 150) / 2, g(13) - 5, 150, 20).a());
      if (this.w == null) {
         this.a(this.x);
      } else {
         this.D();
   ...
   private void D() {
      for (Entry<Integer, erp> $$0 : this.w.i.entrySet()) {
         int $$1 = $$0.getKey();
         boolean $$2 = $$1 != this.w.n || this.w.m == eri.d.b;
         exg $$3;
         if ($$2) {
            $$3 = exg.a(vf.c("mco.brokenworld.play"), $$1x -> this.f.a(new esy(this.v, new eup(this.w.a, $$1, this::e)))).a(this.a($$1), g(8), 80, 20).a();
            $$3.j = !this.w.i.get($$1).n;
         } else {
            $$3 = exg.a(vf.c("mco.brokenworld.download"), $$1x -> {
   ...
   public void a(ewu $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.w != null) {
         for (Entry<Integer, erp> $$5 : this.w.i.entrySet()) {
   ...
   public void e() {
      new Thread(() -> {
         eqr $$0 = eqr.a();
         if (this.w.e == eri.c.a) {
            this.f.execute(() -> this.f.a(new esy(this, new euj(this.w, this, true, this.f))));
         } else {
            try {
               eri $$1 = $$0.a(this.x);
               this.f.execute(() -> eqm.a($$1, this));
            } catch (ese var3) {
   ...
   private void b(int $$0) {
      ...
      try {
         ery $$2 = $$1.b(this.w.a, $$0);
         esu $$3 = new esu(this, $$2, this.w.a($$0), $$1x -> {
            if ($$1x) {
               this.A.add($$0);
               this.q();
               this.D();
   ...
   private boolean E() {
      return this.w != null && this.w.m == eri.d.b;
   }

   private void a(ewu $$0, int $$1, int $$2, int $$3, int $$4, boolean $$5, String $$6, int $$7, long $$8, @Nullable String $$9, boolean $$10) {
      ahg $$11;
      if ($$10) {
         $$11 = esk.a;
      } else if ($$9 != null && $$8 != -1L) {
         $$11 = etx.a(String.valueOf($$8), $$9);
      } else if ($$7 == 1) {
         $$11 = esk.b;
      } else if ($$7 == 2) {
         $$11 = esk.c;
         ...
         $$11 = etx.a(String.valueOf(this.w.p), this.w.q);
      }

      if (!$$5) {
         $$0.a(0.56F, 0.56F, 0.56F, 1.0F);
      } else if ($$5) {
         float $$17 = 0.9F + 0.1F * auo.b((float)this.B * 0.2F);
         $$0.a($$17, $$17, $$17, 1.0F);
      }
