...
public class esp {
   public static List<etr> a(esp.a... $$0) {
      for (esp.a $$1 : $$0) {
         a($$1.j);
      }

      List<etr> $$2 = Lists.newArrayList();

      for (esp.a $$3 : $$0) {
         $$2.add(new etr($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(etr::a));
      return $$2;
   }
   ...
   public static List<etr> a() {
      return a(esp.a.values());
   }
