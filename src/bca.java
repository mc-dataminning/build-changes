...
public abstract class bca extends DataFix {
   private final String a;

   public bca(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bbq.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bbq.x);
      Type<Pair<String, String>> $$2 = DSL.named(bbq.v.typeName(), bcy.a());
      if (!Objects.equals(this.getOutputSchema().getType(bbq.v), $$2)) {
