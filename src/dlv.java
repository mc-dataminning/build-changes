...
public class dlv {
   ...
   private static final int j = hp.a(16);
   ...
   private final cpx p;
   private static final List<csv> q = List.of(csw.l, csw.L, csw.i, csw.b, csw.k, csw.I, csw.K, csw.fl, csw.dP, csw.iA, csw.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<he<cqt>>> t;
   ...
   public static final Codec<dlv> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlv::a, Function.identity());

   private static DataResult<dlv> a(dlv $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlv(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<he<cqt>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hw.c($$0);
      int $$5 = hw.c($$1) - $$4;
   ...
   @Nullable
   public static dlv a(akx $$0, int $$1, int $$2) {
      dhf $$3 = $$0.a($$1, $$2);
      dlv $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dhk.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hb> a(cqp $$0, int $$1, int $$2, boolean $$3) {
      Set<hb> $$4 = EnumSet.noneOf(hb.class);
   ...
   private void a(dhf $$0, Set<hb> $$1) {
      if (!this.r) {
         if ($$1.contains(hb.a) || $$1.contains(hb.g) || $$1.contains(hb.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(hb.c) && $$1.contains(hb.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(hb.c) && $$1.contains(hb.e) && $$1.contains(hb.d)) {
   ...
   private void a(int $$0, dhf $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, arw.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dhf $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dks.a.a)) {
         $$3 = Math.min($$0.a(dks.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }

      int $$5 = this.p.H_();
      gw.a $$6 = new gw.a($$1, $$3, $$2);
   ...
   private static double a(dhf $$0, gw.a $$1) {
      return a($$0, (gw)$$1.c(ha.a)) ? 1.0 : -1.0;
   }

   private static double b(dhf $$0, gw.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dhf $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      gw.a $$5 = new gw.a($$1, this.p.aj(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<he<cqt>> b(dhf $$0, int $$1, int $$2) {
      ObjectArrayList<he<cqt>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + hp.a(this.p.H_());
         $$3.set($$4, $$0.getNoiseBiome(hp.a($$1), $$5, hp.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dhf $$0, gw $$1) {
      dfj $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(aps.O)) {
         ...
         return $$2.a(csw.eU) || $$2.a(csw.eV) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dlv.a $$3) {
      if ($$1 >= hp.a(this.p.H_()) && $$1 < hp.a(this.p.aj())) {
         int $$4 = $$1 - hp.a(this.p.H_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               he<cqt> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dlv.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlv.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, he<cqt> var3);
   }
