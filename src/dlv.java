...
public class dlv implements ase {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dlv> b = dlu.a.xmap($$0 -> new dlv($$0), $$0 -> $$0.e);
   private dlu e;
   private final dkw f = new dkw(this);

   public dlv(long $$0) {
      this.e = new dlu(dlj.c($$0));
   }
   ...
   @Override
   public ase d() {
      return new dlv(this.e.a(), this.e.a());
   }

   @Override
   public dlh e() {
      return new dlv.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dlh {
      ...
      @Override
      public ase a(int $$0, int $$1, int $$2) {
         long $$3 = ary.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dlv($$4, this.b);
      }

      @Override
      public ase a(String $$0) {
         dlj.a $$1 = dlj.a($$0);
         return new dlv($$1.a(this.a, this.b));
      }
