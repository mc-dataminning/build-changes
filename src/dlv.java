...
public class dlv {
   ...
   private final List<List<hg<cqt>>> t;
   ...
   private dlv(int $$0, int $$1, Optional<double[]> $$2) {
      ...
      this.u = new double[o][];
      ObjectArrayList<List<hg<cqt>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hz.c($$0);
      int $$5 = hz.c($$1) - $$4;
   ...
   @Nullable
   public static dlv a(aky $$0, int $$1, int $$2) {
      dhf $$3 = $$0.a($$1, $$2);
      dlv $$4 = $$3.t();
   ...
   public static Set<hd> a(cqp $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dhf $$1, int $$2, int $$3) {
      ...
      this.u[$$0] = this.a($$1, $$2, $$3, arx.a(this.s[$$0]));
   ...
   private List<hg<cqt>> b(dhf $$0, int $$1, int $$2) {
      ObjectArrayList<hg<cqt>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   protected interface a {
      void consume(int var1, int var2, hg<cqt> var3);
   }
