...
public class bcs extends bfn {
   public bcs(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bgr.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bgr.D.typeName(), bid.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bgr.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bgr.D.typeName(), "minecraft:saddle"));
