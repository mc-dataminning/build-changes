...
public class bcs extends azm {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcs::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcs::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcs::k);
         $$0 = this.a($$0, "minecraft:fox", bcs::j);
         $$0 = this.a($$0, "minecraft:item", bcs::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcs::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcs::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcs::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcs::e);
         return this.a($$0, "minecraft:piglin", bcs::d);
      });
   }
