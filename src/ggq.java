...
public class ggq {
   ...
   private CompletableFuture<his<cwp>> d = CompletableFuture.completedFuture(his.empty());
   private CompletableFuture<his<cwp>> e = CompletableFuture.completedFuture(his.empty());
   private CompletableFuture<his<fyl>> f = CompletableFuture.completedFuture(his.empty());
   ...
   public void a(List<cwp> $$0) {
      this.a(c, () -> {
         ...
         this.e = CompletableFuture.supplyAsync(() -> new hio<>($$0xxx -> $$0xxx.j().map(axf::b), $$0), af.g());
         $$1.cancel(true);
      });
   }
      ...
      this.a(
         ...
         () -> {
            ...
            this.d = CompletableFuture.supplyAsync(
               () -> new hin<>($$2xx -> a(Stream.of($$2xx), $$2, $$3), $$0xxx -> $$0xxx.i().e().map(akt::a).stream(), $$1), af.g()
            );
            $$4.cancel(true);
         }
      );
