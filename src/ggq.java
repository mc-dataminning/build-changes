...
public class ggq implements ggv.a {
   ...
   private final ffa J;
   private final Map<iz, ggq.a> K = Maps.newHashMap();
   private final Map<UUID, aaq.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsp $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dK();
      });
   }

   private void b(ezt $$0, gdj $$1, double $$2, double $$3, double $$4) {
      iz $$5 = iz.a($$2, $$3, $$4);
   ...
   private void a(ezt $$0, gdj $$1, ggq.a $$2) {
      int $$3 = 0;
   ...
   private void a(ezt $$0, gdj $$1, aaq.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghd.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(ezt $$0, gdj $$1, aaq.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(ezt $$0, gdj $$1, String $$2, ggq.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(ggq.a $$0) {
      return this.b($$0.a).stream().map(ago::a).collect(Collectors.toSet());
   }

   private Set<String> c(ggq.a $$0) {
      return this.c($$0.a).stream().map(ago::a).collect(Collectors.toSet());
   }
   ...
   private Collection<UUID> b(iz $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(aaq.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(iz $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(aaq.a::a).collect(Collectors.toSet());
   }

   private Map<iz, List<String>> c() {
      Map<iz, List<String>> $$0 = Maps.newHashMap();

      for (aaq.a $$1 : this.L.values()) {
   ...
   private void d() {
      ggv.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cz());
   }
