...
public class eof extends eoq {
   ...
   public eog a() {
      ...
      if (this.f() && this.b.be()) {
         ...
         for (dsb $$2 = this.a.a($$1); $$2.a(dfa.G); $$2 = this.a.a($$1)) {
            $$1.b(this.b.du(), (double)(++$$0), this.b.dA());
         }
      } else {
         $$0 = ayy.a(this.b.dw() + 0.5);
      }
   ...
   private boolean b(@Nullable eog $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eog $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   protected eol b(int $$0, int $$1, int $$2) {
      return (eol)this.l.computeIfAbsent(iz.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }

   @Override
   public eol a(eon $$0, int $$1, int $$2, int $$3) {
      eol $$4 = $$0.a($$1, $$2, $$3);
      if ($$4 == eol.b && $$2 >= $$0.a().I_() + 1) {
         iz $$5 = new iz($$1, $$2 - 1, $$3);
         eol $$6 = $$0.a($$5.u(), $$5.v(), $$5.w());
         if ($$6 == eol.o || $$6 == eol.i) {
            $$4 = eol.o;
         } else if ($$6 == eol.q) {
            $$4 = eol.q;
            ...
            $$4 = $$6 != eol.c && $$6 != eol.b && $$6 != eol.j ? eol.c : eol.b;
         }
      }
   ...
   private Iterable<iz> a(btq $$0) {
      ...
      if (!$$2) {
         ...
         evl $$6 = $$1.c($$4, $$5, $$3);
         return iz.a($$0.el(), 10, ayy.a($$6.a), ayy.a($$6.b), ayy.a($$6.c), ayy.a($$6.d), ayy.a($$6.e), ayy.a($$6.f));
      }
   }
}
