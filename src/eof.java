...
public class eof {
   ...
   @Nullable
   private String g;
   private static final eof.a h = new eof.a() {
      @Nullable
      @Override
      public eoe a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (eoj.a(this.d, "Get capabilities")) {
         ...
         if (eoj.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  eoj.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !eoj.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eoe a(eof.c $$0) {
      return ($$0 == eof.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eof.a {
      private final int a;
      private final Set<eoe> b = Sets.newIdentityHashSet();
      ...
      public eoe a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               eof.a.warn("Maximum sound pool size {} reached", this.a);
            }
