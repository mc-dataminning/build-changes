...
public class eof {
   ...
   @Deprecated
   public static eof a(ayw $$0, eof.a $$1) {
      return new eof($$0, $$1, false);
   }

   public static eof a(ayw $$0, int $$1, double... $$2) {
      return b($$0, new eof.a($$1, new DoubleArrayList($$2)));
   }

   public static eof b(ayw $$0, eof.a $$1) {
      return new eof($$0, $$1, true);
   }

   private eof(ayw $$0, eof.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eof.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eof.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eof.a::b))
               .apply($$0, eof.a::new)
      );
      public static final Codec<jm<eof.a>> b = akn.a(lu.aP, a);
