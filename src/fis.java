...
public class fis {
   ...
   public fis(fgm $$0) {
      ...
      this.g = new fis.a();
      this.h = $$0.h;
      this.w = new fkb(this.h, this.r);
      this.x = new fkd(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fkc(this.h, this.t);
      this.z = new fka(this.h, this.u);
   }
   ...
   private void a(fhx $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.av()) {
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayo.g($$15.dF()), ayo.g($$15.dH())));
         dvi $$27 = this.t();
         if ($$27.C()) {
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", faa.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fgm.Q().aM().l(), fgm.Q().aM().m(), faa.a()),
            faa.c(),
            faa.d()
         }
      );
