...
public class fis extends hkx {
   ...
   public fis(fuk $$0, long $$1, boolean $$2) {
   ...
   public void aR_() {
      this.G = this.n / 2 - 150;
      this.c(fos.a(wn.k, $$0 -> this.aO_()).a((this.n - 150) / 2, g(13) - 5, 150, 20).a());
      if (this.D == null) {
         this.a(this.E);
      } else {
         this.E();
   ...
   private void E() {
      for (Entry<Integer, fhr> $$0 : this.D.i.entrySet()) {
         ...
         fos $$3;
         if ($$2) {
            $$3 = fos.a(wo.c("mco.brokenworld.play"), $$1x -> this.m.a(new fja(this.C, new fko(this.D.a, $$1, this::b)))).a(this.a($$1), g(8), 80, 20).a();
            $$3.j = !this.D.i.get($$1).m;
         } else {
            $$3 = fos.a(
                  wo.c("mco.brokenworld.download"),
                  $$1x -> this.m.a(fjg.a(this, wo.c("mco.configure.world.restore.download.question.line1"), $$1xx -> this.b($$1)))
               )
