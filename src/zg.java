...
public class zg implements xw {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = azn.b.validate(zg::b);
   private static final Codec<Object> e = Codec.either(d, xx.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xv $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<zg> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xw.a<zg> c = new xw.a<>(b, "translatable");
   private static final ya f = ya.e("%");
   private static final ya g = ya.e("null");
   ...
   @Nullable
   private us k;
   private List<ya> l = ImmutableList.of();
   ...
   private static zg a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new zg($$0, $$1.orElse(null), a($$2));
   }

   public zg(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<ya> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (zh var4) {
            this.l = ImmutableList.of(ya.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<ya> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new zh(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private ya a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xv) {
            ...
            return $$1 == null ? g : ya.e($$1.toString());
         }
      } else {
         throw new zh(this, $$0);
      }
   ...
   public yj a(@Nullable ew $$0, @Nullable bvj $$1, int $$2) throws CommandSyntaxException {
      ...
      return yj.a(new zg(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof zg $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
