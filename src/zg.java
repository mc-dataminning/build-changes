...
public class zg<T extends wa, B extends ByteBuf> {
   ...
   private static <L extends wa> wc<L> a(vt $$0, zc $$1, Consumer<zg<L, vu>> $$2) {
      zg<L, vu> $$3 = new zg<>($$0, $$1);
      $$2.accept($$3);
      return $$3.a(vu::new);
   }

   public static <T extends wg> wc<T> a(vt $$0, Consumer<zg<T, vu>> $$1) {
      return a($$0, zc.a, $$1);
   }

   public static <T extends vp> wc<T> b(vt $$0, Consumer<zg<T, vu>> $$1) {
      return a($$0, zc.b, $$1);
   }

   private static <L extends wa, B extends ByteBuf> wc.a<L, B> b(vt $$0, zc $$1, Consumer<zg<L, B>> $$2) {
      zg<L, B> $$3 = new zg<>($$0, $$1);
      $$2.accept($$3);
      return $$3.a();
   }

   public static <T extends wg, B extends ByteBuf> wc.a<T, B> c(vt $$0, Consumer<zg<T, B>> $$1) {
      return b($$0, zc.a, $$1);
   }

   public static <T extends vp, B extends ByteBuf> wc.a<T, B> d(vt $$0, Consumer<zg<T, B>> $$1) {
      return b($$0, zc.b, $$1);
   }
   ...
   static record b<L extends wa>(vt a, zc b, ys<ByteBuf, zb<? super L>> c, @Nullable za d) implements wc<L> {
   }
}
