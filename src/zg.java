...
public class zg implements wu<yo> {
   ...
   private final int h;
   private final List<zg.b> i;

   public zg(RootCommandNode<dw> $$0) {
   ...
   private static void a(List<zg.b> $$0, BiPredicate<zg.b, IntSet> $$1) {
   ...
   private static void a(List<zg.b> $$0) {
      a($$0, zg.b::a);
      a($$0, zg.b::b);
   }
   ...
   private static List<zg.b> a(Object2IntMap<CommandNode<dw>> $$0) {
      ObjectArrayList<zg.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static zg.b b(ue $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.n() : 0;
      zg.e $$4 = a($$0, $$1);
      return new zg.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static zg.e a(ue $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.s();
         int $$4 = $$0.n();
         ...
         if ($$5 == null) {
            ...
            hh.a<?> $$6 = $$5.b($$0);
            agt $$7 = ($$1 & 16) != 0 ? $$0.t() : null;
            return new zg.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.s();
         return new zg.c($$8);
   ...
   private static zg.b a(CommandNode<dw> $$0, Object2IntMap<CommandNode<dw>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<dw> a(dn $$0) {
      return (RootCommandNode<dw>)new zg.d($$0, this.i).a(this.h);
   }
   ...
   static class a implements zg.e {
      ...
      @Nullable
      private static agt a(@Nullable SuggestionProvider<dw> $$0) {
         return $$0 != null ? hl.a($$0) : null;
      }

      a(String $$0, hh.a<?> $$1, @Nullable agt $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      public a(ArgumentCommandNode<dw, ?> $$0) {
         this($$0.getName(), hi.b($$0.getType()), a($$0.getCustomSuggestions()));
      }
      ...
      private static <A extends ArgumentType<?>> void a(ue $$0, hh.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends hh.a<A>> void a(ue $$0, hh<A, T> $$1, hh.a<A> $$2) {
         $$0.c(kb.w.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable zg.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements zg.e {
      private final String a;
