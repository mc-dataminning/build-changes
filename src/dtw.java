...
public class dtw extends dty {
   ...
   private static void a(dgh $$0, ji $$1, dww $$2, dtw $$3, dtw.a $$4) {
      if ($$3.b) {
         $$3.a++;
      }
   ...
   public static void a(dgh $$0, ji $$1, dww $$2, dtw $$3) {
      a($$0, $$1, $$2, $$3, dtw::b);
   }

   public static void b(dgh $$0, ji $$1, dww $$2, dtw $$3) {
      a($$0, $$1, $$2, $$3, dtw::a);
   }
   ...
   private static void a(dgh $$0, ji $$1, List<bvg> $$2) {
      $$2.stream().filter($$1x -> a($$1, $$1x)).forEach(dtw::a);
   }

   private static void b(dgh $$0, ji $$1, List<bvg> $$2) {
   ...
   @FunctionalInterface
   interface a {
      void run(dgh var1, ji var2, List<bvg> var3);
   }
}
