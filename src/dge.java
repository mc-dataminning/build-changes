...
public class dge extends dgh<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dge(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dge $$1 && super.equals($$0)) {
   ...
   public static dge a(String $$0, int $$1, int $$2) {
      return new dge($$0, $$1, $$2);
   }
