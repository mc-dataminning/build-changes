...
public class dge {
   ...
   public static final zt<xg, dge> b = zt.a(dge::a, dge::a);
   private final dgc c;
   private final Optional<dgc> d;
   private final cxo e;
   private int f;
   private final int g;
   ...
   private dge(dgc $$0, Optional<dgc> $$1, cxo $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dge(dgc $$0, cxo $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dge(dgc $$0, Optional<dgc> $$1, cxo $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dge(dgc $$0, Optional<dgc> $$1, cxo $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dge(dgc $$0, Optional<dgc> $$1, cxo $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   public static dge a(xg $$0) {
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dge $$11 = new dge($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
