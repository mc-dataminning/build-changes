...
public class bqe extends bqh {
   ...
   public bqe(bjo $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<bjo> $$0 = this.a.dL().a(bjo.class, this.a.cG().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bjo $$1 : $$0) {
            if (!$$1.cd()) {
               this.c = $$1;
