...
public class blc implements Comparable<blc> {
   ...
   @Nullable
   private blc q;
   private final Optional<blc.a> r;

   public blc(bla $$0) {
      this($$0, 0, 0);
   }

   public blc(bla $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public blc(bla $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public blc(bla $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public blc(bla $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public blc(bla $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable blc $$6, Optional<blc.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bmf $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof blc $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(sl $$0) {
      ...
      this.r.ifPresent($$1x -> blc.a.a.encodeStart(sz.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static blc b(sl $$0) {
      String $$1 = $$0.l("id");
      bla $$2 = kd.d.a(ahd.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static blc a(bla $$0, sl $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = blc.a.a.parse(new Dynamic(sz.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new blc($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<blc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atq.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  atq.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(blc $$0) {
         ...
         float $$2 = aui.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = aui.i($$2, this.c, this.d);
      }

      public float a(bmf $$0, float $$1) {
         if ($$0.dH()) {
            this.g = this.e;
         }

         return aui.i($$1, this.g, this.e);
      }
   }
}
