...
public class blc {
   ...
   private blc(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blc a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blc($$0, $$1);
   }

   public blc.d a() throws IOException {
      blc.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blc.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blc.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blc.c $$3 = blc.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blc.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blc.a($$0, $$3);
            }
         }
   ...
   public blc.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blc.c> $$2 = this.a().c();
      ...
      blc.e $$4 = new blc.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blc.c b) implements blc.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blc.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blc.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blc.b> {
      private final List<blc.b> a;

      d(List<blc.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blc.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blc.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blc.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blc.d a() {
         ListIterator<blc.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blc.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blc.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blc.b> b() {
         return this.a.stream();
      }

      public Set<blc.c> c() {
         return this.a.stream().map(blc.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blc.c b) implements blc.b {
