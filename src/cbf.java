...
public abstract class cbf {
   ...
   protected static boolean a(cbq $$0, byo $$1, cpn $$2) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         ...
         Supplier<cfz> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void b(int $$0, int $$1, cbo $$2, byo $$3) {
      byn $$4 = $$3.fN();
      if ($$2 == cbo.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cbo.a || $$2 == cbo.b) && ($$1 == 0 || $$1 == 1)) {
         cbn $$16 = $$1 == 0 ? cbn.a : cbn.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == cbn.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == cbn.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == cbn.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<cfz> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cfz> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cbo.d && $$3.fO().d && this.g().b() && $$0 >= 0) {
         ccx $$32 = this.i.get($$0);
         if ($$32.f()) {
            cfz $$33 = $$32.e();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == cbo.e && this.g().b() && $$0 >= 0) {
         ccx $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.e().L();
         cfz $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cbo.g && $$0 >= 0) {
         ccx $$37 = this.i.get($$0);
         cfz $$38 = this.g();
   ...
   public static boolean a(@Nullable ccx $$0, cfz $$1, boolean $$2) {
      ...
      return !$$3 && cfz.c($$1, $$0.e()) ? $$0.e().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }
   ...
   public static int a(@Nullable czn $$0) {
      return $$0 instanceof bdq ? b((bdq)$$0) : 0;
   }
   ...
   public void a(cbf $$0) {
      Table<bdq, Integer, Integer> $$1 = HashBasedTable.create();
