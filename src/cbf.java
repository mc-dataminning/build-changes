...
public class cbf implements cbc {
   ...
   public void a(double $$0, double $$1, double $$2) {
      this.a($$0, $$1, $$2, (float)this.a.ad(), (float)this.a.aa());
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(ayy.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(ayy.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }

   private static double b(buj $$0) {
      return $$0 instanceof bvf ? $$0.dF() : ($$0.cR().b + $$0.cR().e) / 2.0;
   }
}
