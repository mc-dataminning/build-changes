...
public class fbk extends fau implements fle.a {
   private static final agi p = new agi("textures/gui/advancements/window.png");
   ...
   private final fle z;
   private final Map<af, fbg> A = Maps.newLinkedHashMap();
   @Nullable
   private fbg B;
   private boolean C;
   ...
   protected void aP_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         fbg $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(euo $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (fbg $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (fbg $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      fbg $$1 = fbg.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
