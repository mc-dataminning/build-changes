...
public class fbk {
   ...
   public static final fbk.a bv;

   public static fbk.a a(int $$0, int $$1) {
      return $$0 == -1 ? fbk.b.b.a($$1) : fbk.b.a.a($$0);
   }

   public static fbk.a a(String $$0) {
      if (fbk.a.e.containsKey($$0)) {
         return fbk.a.e.get($$0);
      } else {
         for (fbk.b $$1 : fbk.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fbk.b b;
      private final int c;
      private final ayw<xd> d;
      static final Map<String, fbk.a> e = Maps.newHashMap();

      a(String $$0, fbk.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayw<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<fbk.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xd> g;

      private static void a(fbk.b $$0, String $$1, int $$2) {
         fbk.a $$3 = new fbk.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fbk.a a(int $$0) {
         return (fbk.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
