...
public class fbk implements fbf {
   ...
   protected fbk(boolean $$0, double $$1, cwp $$2, Predicate<esz> $$3, @Nullable buk $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected fbk(buk $$0, boolean $$1) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual buk.ch ()Z
      // 05: aload 1
      // 06: invokevirtual buk.dD ()D
      // 09: aload 1
      // 0a: instanceof bvg
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast bvg
      // 14: invokevirtual bvg.eZ ()Lcwp;
      // 17: goto 1d
      ...
      // 38: pop
      // 39: invokedynamic test (Lbvg;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, bvg.a (Lesz;)Z, (Lesz;)Z ]
      // 3e: goto 46
      ...
      // 46: aload 1
      // 47: invokespecial fbk.<init> (ZDLcwp;Ljava/util/function/Predicate;Lbuk;)V
      // 4a: return
   }
