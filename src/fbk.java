...
public interface fbk {
   fbk a(float var1, float var2, float var3);

   fbk a(int var1, int var2, int var3, int var4);

   fbk a(float var1, float var2);

   fbk a(int var1, int var2);

   fbk b(int var1, int var2);

   fbk b(float var1, float var2, float var3);
   ...
   default fbk a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(fbg.a $$0, gfu $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fbg.a $$0, gfu $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      kh $$11 = $$1.e().q();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(fbe.b.b());
   ...
   default fbk a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default fbk a(fbg.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default fbk a(fbg.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fbk a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default fbk b(fbg.a $$0, float $$1, float $$2, float $$3) {
