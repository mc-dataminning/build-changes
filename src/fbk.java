...
public class fbk extends etm<fbk.a> {
   static final aex a = new aex("server_list/incompatible");
   static final aex m = new aex("server_list/unreachable");
   static final aex n = new aex("server_list/ping_1");
   static final aex o = new aex("server_list/ping_2");
   static final aex p = new aex("server_list/ping_3");
   static final aex q = new aex("server_list/ping_4");
   static final aex s = new aex("server_list/ping_5");
   static final aex t = new aex("server_list/pinging_1");
   static final aex u = new aex("server_list/pinging_2");
   static final aex v = new aex("server_list/pinging_3");
   static final aex w = new aex("server_list/pinging_4");
   static final aex x = new aex("server_list/pinging_5");
   static final aex y = new aex("server_list/join_highlighted");
   static final aex z = new aex("server_list/join");
   static final aex A = new aex("server_list/move_up_highlighted");
   static final aex B = new aex("server_list/move_up");
   static final aex C = new aex("server_list/move_down_highlighted");
   static final aex D = new aex("server_list/move_down");
   ...
   private final List<fbk.c> R = Lists.newArrayList();

   public fbk(fbg $$0, eqv $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      super($$1, $$2, $$3, $$4, $$5, $$6);
      this.O = $$0;
   }
   ...
   public void a(fji $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.P.add(new fbk.d(this.O, $$0.a($$1)));
      }

      this.e();
   }

   public void a(List<gde> $$0) {
      int $$1 = $$0.size() - this.R.size();
      this.R.clear();

      for (gde $$2 : $$0) {
         this.R.add(new fbk.c(this.O, $$2));
      }

      this.e();

      for (int $$3 = this.R.size() - $$1; $$3 < this.R.size(); $$3++) {
         fbk.c $$4 = this.R.get($$3);
   ...
   public abstract static class a extends etm.a<fbk.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fbk.a {
      private final eqv a = eqv.O();

      @Override
      public void a(esf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fbk.H, this.a.y.g / 2 - this.a.h.a(fbk.H) / 2, $$10, 16777215, false);
         String $$11 = exv.a(ac.b());
   ...
   public class d extends fbk.a {
      ...
      protected d(fbg $$1, fjh $$2) {
         this.e = $$1;
         this.g = $$2;
         this.f = eqv.O();
         this.h = exp.b(this.f.Y(), $$2.b);
      }
      ...
      public void a(esf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         List<ark> $$11 = this.f.h.c(this.g.d, $$4 - 32 - 2);
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fbk.E.error("Invalid icon for server {} ({})", new Object[]{this.g.a, this.g.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fbk.this.o();
         double $$4 = $$1 - (double)fbk.this.h(fbk.this.i().indexOf(this));
         if ($$3 <= 32.0) {
