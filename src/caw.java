...
public class caw extends caq {
   ...
   private void j() {
      if (this.c == null || this.c.c()) {
         int $$0 = this.a.A();
         hx $$1 = this.a.dM().a(doq.a.f, drt.a(this.a.u()));
         cfi $$2 = this.a.dM().a(b, this.a, (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
         int $$4;
         if ($$2 != null) {
            elt $$3 = new elt($$2.dr(), 0.0, $$2.dx()).d();
            $$4 = this.a.r(-$$3.c * 40.0, 105.0, -$$3.e * 40.0);
         } else {
            $$4 = this.a.r(40.0, (double)$$1.v(), 0.0);
         }

         efe $$6 = new efe($$1.u(), $$1.v(), $$1.w());
