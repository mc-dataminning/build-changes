...
public class agu {
   private static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> tl.b("commands.difficulty.failure", $$0));

   public static void a(CommandDispatcher<dt> $$0) {
      LiteralArgumentBuilder<dt> $$1 = du.a("difficulty");

      for (bhb $$2 : bhb.values()) {
      ...
      $$0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.requires($$0x -> $$0x.c(2))).executes($$0x -> {
         bhb $$1x = ((dt)$$0x.getSource()).e().ai();
         ((dt)$$0x.getSource()).a(() -> tl.a("commands.difficulty.query", $$1x.b()), false);
         return $$1x.a();
      }));
   }

   public static int a(dt $$0, bhb $$1) throws CommandSyntaxException {
