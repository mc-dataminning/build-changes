...
public class eve implements Comparable<eve> {
   ...
   public eve(dgk $$0, evf $$1, String $$2, boolean $$3, boolean $$4, boolean $$5, Path $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.f = $$4;
   ...
   public xc k() {
      return azv.b(this.c.c()) ? wo.c("selectWorld.versionUnknown") : wo.b(this.c.c());
   }
   ...
   public static class b extends eve {
   ...
   public static class c extends eve {
