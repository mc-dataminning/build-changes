...
public class eve implements AutoCloseable {
      ...
      $$1.forEach($$2x -> {
         for (ejs $$3x : $$0) {
            ...
            if ($$4 != null) {
               $$3.add($$3x);
               if ($$4 != evk.b) {
                  ((IntList)this.j.computeIfAbsent(arw.f($$4.a(false)), $$0xx -> new IntArrayList())).add($$2x);
               }
               break;
            }
         }
   ...
   public evi a(ejr $$0) {
      IntList $$1 = (IntList)this.j.get(arw.f($$0.a(false)));
