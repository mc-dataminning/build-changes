...
public class hjd implements hjg<String> {
   ...
   private static final MapCodec<hjd.a> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final hjg.a<hjd, String> c = hjg.a.a(f.flatXmap(hjd::a, $$0 -> DataResult.success($$0.g)), b);
   private final hjd.a g;
   private final DateFormat h;
   private long i;
   private String j = "";

   private hjd(hjd.a $$0, DateFormat $$1) {
      this.g = $$0;
      this.h = $$1;
   }

   public static hjd a(String $$0, String $$1, Optional<TimeZone> $$2) {
      return (hjd)a(new hjd.a($$0, $$1, $$2)).getOrThrow($$0x -> new IllegalStateException("Failed to validate format: " + $$0x));
   }

   private static DataResult<hjd> a(hjd.a $$0) {
      ...
      return DataResult.success(new hjd($$0, $$3));
   }
