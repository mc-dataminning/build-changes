...
public class hjd extends MinecraftServer {
   ...
   public hjd(Thread $$0, flj $$1, evf.c $$2, aua $$3, alu $$4, alq $$5, aro $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hjc(this, this.bb(), this.g));
      this.n = $$1;
   }
