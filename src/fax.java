...
public class fax extends faz {
   ...
   static final fax.b l = new fax.b(854, 480);

   public fax(int $$0, int $$1) {
      super(true);
      this.d($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final fax.a[] e = values();
   ...
   static class b {
      ...
      static List<fax.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fax.b($$0, $$1), fax.l) : ImmutableList.of(fax.l);
      }
