...
public class fax extends fah implements fkr.a {
   private static final agg p = new agg("textures/gui/advancements/window.png");
   ...
   private static final ur w = ur.c("advancements.sad_label");
   private static final ur x = ur.c("advancements.empty");
   private static final ur y = ur.c("gui.advancements");
   private final fkr z;
   private final Map<af, fat> A = Maps.newLinkedHashMap();
   @Nullable
   private fat B;
   private boolean C;
   ...
   protected void aO_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         fat $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(eub $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (fat $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (fat $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      fat $$1 = fat.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
