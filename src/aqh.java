...
public class aqh<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqh.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqh.this.remove(this.b + 1);
      }
   }
}
