...
public class dtt {
   ...
   private final List<dtr> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dtt.a l = new dtt.d(5.999997E7F);
   public static final dtt.c d = new dtt.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dtt.a)($$0 == $$1 ? new dtt.d($$1) : new dtt.b($$0, $$1, $$2));
   ...
   class b implements dtt.a {
      ...
      @Override
      public double a() {
         return ayz.a(dtt.this.a() - this.e() / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dtt.this.b() - this.e() / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
      }
      ...
      @Override
      public dts i() {
         return this.c < this.b ? dts.b : dts.a;
      }
      ...
      @Override
      public dtt.a l() {
         return (dtt.a)(this.g() <= 0L ? dtt.this.new d(this.c) : this);
      }
      ...
      public ewk m() {
         return ewh.a(
            ewh.c,
            ewh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evv.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dtt.c a(DynamicLike<?> $$0, dtt.c $$1) {
         ...
         return new dtt.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dtt.a {
      ...
      private void n() {
         this.c = ayz.a(dtt.this.a() - this.b / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
         this.d = ayz.a(dtt.this.b() - this.b / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
         this.e = ayz.a(dtt.this.a() + this.b / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
         this.f = ayz.a(dtt.this.b() + this.b / 2.0, (double)(-dtt.this.k), (double)dtt.this.k);
         this.g = ewh.a(
            ewh.c,
            ewh.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evv.e
