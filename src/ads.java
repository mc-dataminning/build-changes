...
public class ads implements yw<abl> {
   public static final yn<wa, ads> a = yw.a(ads::a, ads::new);
   private final EnumSet<ads.a> b;
   private final List<ads.b> c;

   public ads(EnumSet<ads.a> $$0, Collection<are> $$1) {
      this.b = $$0;
      this.c = $$1.stream().map(ads.b::new).toList();
   }

   public ads(ads.a $$0, are $$1) {
      this.b = EnumSet.of($$0);
      this.c = List.of(new ads.b($$1));
   }

   public static ads a(Collection<are> $$0) {
   ...
   public static enum a {
      ...
      public interface a {
         void read(ads.c var1, wa var2);
      }

      public interface b {
         void write(wa var1, ads.b var2);
      }
   }

   public static record b(UUID a, @Nullable GameProfile b, boolean c, int d, dgw e, @Nullable wp f, boolean g, int h, @Nullable xg.a i) {

      b(are $$0) {
         this($$0.cF(), $$0.gk(), true, $$0.f.k(), $$0.h.b(), $$0.O(), $$0.a(cps.g), $$0.P(), x.a($$0.ad(), xg::a));
      }
   }
