...
public class ehg extends ehl {
   public static final MapCodec<ehg> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, ehg::new));
   ...
   public List<eft.a> a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, int $$3, jd $$4, efd $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayo.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayo.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ehg.a> $$13 = Lists.newArrayList();
      $$13.add(new ehg.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jd $$21 = $$4.b(ayo.a($$19), $$12 - 1, ayo.a($$20));
               jd $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  jd $$27 = new jd($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new ehg.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<eft.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, jd $$3, jd $$4, boolean $$5, efd $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         jd $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jd $$13 = $$3.b(ayo.d(0.5F + (float)$$12 * $$9), ayo.d(0.5F + (float)$$12 * $$10), ayo.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dml.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, int $$3, jd $$4, List<ehg.a> $$5, efd $$6) {
      for (ehg.a $$7 : $$5) {
         int $$8 = $$7.a();
         jd $$9 = new jd($$4.u(), $$8, $$4.w());
