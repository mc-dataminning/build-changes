...
public class avr extends azx {
   public avr(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bax.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bax.s, "minecraft:jukebox");
