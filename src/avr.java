...
public class avr {
   protected final Set<akq> a = Sets.newHashSet();
   protected final Set<akq> b = Sets.newHashSet();
   private final avs c = new avs();
