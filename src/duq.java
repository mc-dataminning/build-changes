...
public class duq extends dut<dup> {
   public duq(Codec<dup> $$0) {
      super($$0);
   }

   public boolean a(dup $$0, axd $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(duo $$0, dup $$1, dox $$2, Function<ib, il<cya>> $$3, axd $$4, dsa $$5, cwi $$6, dow $$7) {
      int $$8 = je.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dut.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      duo $$0, dup $$1, dox $$2, Function<ib, il<cya>> $$3, dsa $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dow $$10, dut.a $$11
   ) {
      double $$12 = 1.5 + (double)(aww.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(aww.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = aww.b($$13);
         $$6 += (double)(aww.b($$12) * $$27);
         $$7 += (double)aww.a($$13);
         $$8 += (double)(aww.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
