...
public class fnq {
   ...
   private final xp h;
   private final fns i;
   private final Map<af, fns> j = Maps.newLinkedHashMap();
   private double k;
   private double l;
   ...
   public fnq(ffh $$0, fnu $$1, fnr $$2, int $$3, ag $$4, ar $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void b(fgt $$0, int $$1, int $$2) {
      if (!this.r) {
   ...
   @Nullable
   public static fnq a(ffh $$0, fnu $$1, int $$2, ag $$3) {
      Optional<ar> $$4 = $$3.a().c();
      if ($$4.isEmpty()) {
         return null;
      } else {
         for (fnr $$5 : fnr.values()) {
            if ($$2 < $$5.a()) {
               return new fnq($$0, $$1, $$5, $$2, $$3, $$4.get());
            }
   ...
   public void a(ag $$0) {
      Optional<ar> $$1 = $$0.a().c();
      if (!$$1.isEmpty()) {
         fns $$2 = new fns(this, this.a, $$0, $$1.get());
         this.a($$2, $$0.b());
      }
   }

   private void a(fns $$0, af $$1) {
      this.j.put($$1, $$0);
      int $$2 = $$0.d();
      int $$3 = $$2 + 28;
      int $$4 = $$0.c();
