...
public class fnq extends cto {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dnd e = new dnd();
   private final dnj<blu> f = new dnj<>(blu.class, new fnq.b());
   private final fnr D;
   private final ftd E;
   private final fnq.a F;
   private final fsu G;
   private final bkk H;
   private final evg I = evg.O();
   final List<fse> J = Lists.newArrayList();
   private emw K = new emw();
   private final Map<String, ega> L = Maps.newHashMap();
   private static final long M = 16777215L;
   private int N;
   private final Object2ObjectArrayMap<csz, ewk> O = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(fsr.a, new ewk($$0xx -> this.b($$0xx, fsr.a)));
      $$0x.put(fsr.b, new ewk($$0xx -> this.b($$0xx, fsr.b)));
      $$0x.put(fsr.c, new ewk($$0xx -> this.b($$0xx, fsr.c)));
   });
   private final fnm P;
   private final Deque<Runnable> Q = Queues.newArrayDeque();
   private int R;
   private final foy S = new foy();
   ...
   public fnq(fnr $$0, fnq.a $$1, ahf<cto> $$2, ih<dmp> $$3, int $$4, int $$5, Supplier<bgr> $$6, ftd $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.f(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.P = new fnm(this, $$4);
      this.H = new bkk();
      this.F = $$1;
      this.E = $$7;
      this.G = fsu.a($$3.a());
   ...
   public void a(@Nullable cfh $$0, blu $$1, ih<arq> $$2, ars $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.ai().a((ghy)(new ghp($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(blu $$0, arq $$1, ars $$2, float $$3, float $$4) {
      this.I.ai().a((ghy)(new ghp($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, arq $$3, ars $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      ght $$10 = new ght($$3, $$4, $$5, $$6, auu.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, @Nullable sn $$6) {
      this.I.g.a(new fqe.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
   }
