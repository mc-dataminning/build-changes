...
public class fnq extends hpw {
   ...
   public void aO_() {
      this.a(this.J.a);
      this.c(fsv.a(wy.c("mco.configure.world.subscription.extend"), $$0 -> fxk.a(this, ayh.a(this.J.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.J.j) {
         this.c(
            fsv.a(wy.c("mco.configure.world.delete.button"), $$0 -> this.m.a(fnk.b(this, wy.c("mco.configure.world.delete.question.line1"), $$0x -> this.E())))
               .a(this.n / 2 - 100, g(10), 200, 20)
               .a()
         );
      } else if (fkj.b() && this.J.u != null) {
         this.c(new ftf(this.n / 2 - 100, g(8), 200, 46, wy.a("mco.snapshot.subscription.info", this.J.u), this.p));
      } else {
         this.c(new ftf(this.n / 2 - 100, g(8), 200, 46, H, this.p));
      }

      this.c(fsv.a(wx.k, $$0 -> this.aL_()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
      ...
      (new Thread("Realms-delete-realm") {
         ...
         public void run() {
            try {
               ...
               fnq.a.error("Couldn't delete world", var2);
            }

            fnq.this.m.execute(() -> fnq.this.m.a(fnq.this.K));
         }
      }).start();
      this.m.a(this);
   }
