...
public class fnq {
   ...
   @Nullable
   private fnq v;
   private final List<fnq> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fnq(fno $$0, fff $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(ffq $$0, List<xu> $$1) {
   ...
   public void a(fgr $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
   ...
   public void a(fgr $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
