...
public class fnq implements afm {
   ...
   @Nullable
   private String i;
   private final AtomicReference<fnq.a> j = new AtomicReference<>(fnq.a.a);

   public fnq(ug $$0, evh $$1, @Nullable foc $$2, @Nullable fda $$3, boolean $$4, @Nullable Duration $$5, Consumer<vf> $$6) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(fnq.a $$0) {
      fnq.a $$1 = this.j.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(afo $$0) {
      ...
      GameProfile $$1 = $$0.a();
      this.f.a(new afw());
      this.f.a(new fnp(this.b, this.f, new fnv($$1, this.b.t().a(this.g, this.h, this.i), fnt.a().a(), cht.h, null, this.c, this.d)));
   ...
   public void a(vf $$0) {
      if (this.c != null && this.c.e()) {
         this.b.a(new gkk(this.d, ve.q, $$0));
      } else {
         this.b.a(new fcc(this.d, ve.q, $$0));
      }
   }
