...
public class auo extends auc<GameProfile> {
   public auo(@Nullable GameProfile $$0) {
      this($$0, null, null, null, null);
   }

   public auo(@Nullable GameProfile $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
