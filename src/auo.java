...
class auo implements Path {
   private static final BasicFileAttributes a = new aum() {
      @Override
   ...
   private static final BasicFileAttributes b = new aum() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<auo> c = Comparator.comparing(auo::n);
   ...
   public auo(auq $$0, String $$1, @Nullable auo $$2, aur $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private auo a(@Nullable auo $$0, String $$1) {
      return new auo(this.e, $$1, $$0, aur.b);
   }
   ...
   auo a(String $$0) {
      if (a(this.i)) {
         return new auo(this.e, $$0, this, this.i);
      } else if (this.i instanceof aur.a $$1) {
         auo $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new auo(this.e, $$0, this, aur.a);
      } else if (this.i instanceof aur.b) {
         return new auo(this.e, $$0, this, aur.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aur $$0) {
      return $$0 == aur.a || $$0 == aur.b;
   }
   ...
   private auo c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof auo $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aur.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aur.a i() {
      return this.i instanceof aur.a $$0 ? $$0 : null;
   }
