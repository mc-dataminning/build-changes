...
public class gzq implements atz<gzp> {
   public gzp b(JsonObject $$0) {
      Builder<gzo> $$1 = ImmutableList.builder();
      int $$2 = aza.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = aza.a($$0, "width", -1);
      int $$9 = aza.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = aza.a($$0, "interpolate", false);
      return new gzp($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gzo a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gzo(aza.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = aza.m($$1, "frames[" + $$0 + "]");
         int $$3 = aza.a($$2, "time", -1);
         if ($$2.has("time")) {
