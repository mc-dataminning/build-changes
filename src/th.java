...
public abstract class th {
   ...
   private static volatile th e = c();
   ...
   private static th c() {
      ...
      return new th() {
         ...
         @Override
         public aww a(wl $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> ayd.c($$2xxx, $$1x, $$1) ? Optional.empty() : wl.a, xd.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = th.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(axa.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract aww a(wl var1);

   public List<aww> a(List<wl> $$0) {
