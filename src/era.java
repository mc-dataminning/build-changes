...
public class era {
   ...
   public static void a(File $$0, ejv $$1, Consumer<tl> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ejv $$2, Consumer<tl> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ejv $$2, Consumer<tl> $$3) {
      ekk $$4 = a($$2);
   ...
   public static ekk a(ejv $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ekk $$3 = new ekk($$1, $$2, false);
   ...
   public era(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
