...
public class era {
   ...
   public void a(era.b $$0, List<amd> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new era.c($$0, $$1.stream().map(amd::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new era.c(era.b.c, ImmutableList.of());
      }

      this.b.c = new era.a($$0);
   }
   ...
   static class c {
      private final era.b a;
      private final List<String> b;
      @Nullable
      era.a c;
      boolean d;

      c(era.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
