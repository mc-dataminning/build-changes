...
public class cb extends ds<cb.a> {
   ...
   public void a(aqn $$0, cud $$1, cmz $$2, Collection<cud> $$3) {
      eqw $$4 = bu.b($$0, (bsh)($$2.v() != null ? $$2.v() : $$2));
   ...
   public static record a(Optional<bf> b, Optional<cp> c, Optional<bf> d, Optional<cp> e) implements ds.a {
      ...
      public boolean a(cud $$0, eqw $$1, Collection<cud> $$2) {
         if (this.c.isPresent() && !this.c.get().a($$0)) {
            ...
            if (this.e.isPresent()) {
               boolean $$3 = false;
               bsh $$4 = $$1.c(ets.a);
               if ($$4 instanceof civ $$5 && this.e.get().a($$5.p())) {
                  $$3 = true;
               }
