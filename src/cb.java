...
public record cb(Optional<aqj<cjc>> b, Optional<hk<cjc>> c, cl.d d, cl.d e, List<bl> f, List<bl> g, Optional<hg<cle>> h, Optional<cn> i) {
   private static final Codec<hk<cjc>> j = jd.i.r().listOf().xmap(hk::a, $$0 -> $$0.a().toList());
   public static final Codec<cb> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arh.a(aqj.a(je.D), "tag").forGetter(cb::b),
               arh.a(j, "items").forGetter(cb::c),
               arh.a(cl.d.d, "count", cl.d.c).forGetter(cb::d),
               arh.a(cl.d.d, "durability", cl.d.c).forGetter(cb::e),
               arh.a(bl.a.listOf(), "enchantments", List.of()).forGetter(cb::f),
               arh.a(bl.a.listOf(), "stored_enchantments", List.of()).forGetter(cb::g),
               arh.a(jd.j.r(), "potion").forGetter(cb::h),
               arh.a(cn.a, "nbt").forGetter(cb::i)
            )
            .apply($$0, cb::new)
   );
   ...
   public boolean a(cjh $$0) {
      if (this.b.isPresent() && !$$0.a(this.b.get())) {
         ...
         if (!this.g.isEmpty()) {
            Map<cnq, Integer> $$3 = cns.a(cid.d($$0));
         ...
         return !this.h.isPresent() || this.h.get().a() == clg.d($$0);
      }
   }
   ...
   public static class a {
      ...
      private Optional<hk<cjc>> c = Optional.empty();
      private Optional<aqj<cjc>> d = Optional.empty();
      private cl.d e = cl.d.c;
      private cl.d f = cl.d.c;
      private Optional<hg<cle>> g = Optional.empty();
