...
public class cb extends df<cb.a> {
   ...
   public void a(aqo $$0, clx $$1, ctq $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(aqo $$0, clx $$1, ctq $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bc> b, cb.a.a c, List<ch> d) implements df.a {
      ...
      public static an<cb.a> a(day... $$0) {
         ch[] $$1 = new ch[$$0.length];

         for (int $$2 = 0; $$2 < $$0.length; $$2++) {
            $$1[$$2] = new ch(Optional.of(jb.a($$0[$$2].r().o())), ct.d.c, jz.c, Map.of());
         }

         return a($$1);
      }

      public boolean a(clx $$0, ctq $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
