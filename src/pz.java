...
public class pz {
   ...
   public static Collection<pw> a(Collection<pr> $$0, gw $$1, czh $$2, akq $$3, qc $$4, int $$5) {
      ps $$6 = new ps($$0, $$1, $$2, $$3, $$4, $$5);
      $$6.b();
      return $$6.a();
   }

   public static Collection<pw> b(Collection<qn> $$0, gw $$1, czh $$2, akq $$3, qc $$4, int $$5) {
   ...
   public static Collection<pr> a(Collection<qn> $$0) {
      ...
      return $$1.entrySet().stream().flatMap($$0x -> {
         ...
         Consumer<akq> $$2 = py.c($$1x);
         Consumer<akq> $$3 = py.d($$1x);
   ...
   public static void a(akq $$0, gw $$1, qc $$2, int $$3) {
      $$2.a();
      gw $$4 = $$1.b(-$$3, 0, -$$3);
      gw $$5 = $$1.b($$3, 0, $$3);
