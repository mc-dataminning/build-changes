...
public class fri implements frn.a {
   ...
   private void b(elp $$0, foe $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aba::a).collect(Collectors.toSet());
         int $$5 = 1;
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aba::a).collect(Collectors.toSet()).toString();
      }
   }
   ...
   private Set<String> a(wd.a $$0) {
      return this.a($$0.a()).stream().map(aba::a).collect(Collectors.toSet());
   }
