...
public class fri {
   ...
   private final fpx c;
   private final List<fri.a> d = Lists.newArrayList();
   private String e;
   private int f;
   private int g;
   private boolean h;
   ...
   public fri.a e() {
      return new fri.a(Math.min(this.g, this.f), Math.max(this.g, this.f));
   }
   ...
   public fri.a c(int $$0) {
      return this.d.get(azk.a($$0, 0, this.d.size() - 1));
   }

   public void a(frz $$0, int $$1) {
      switch ($$0) {
         case a:
            this.f = $$1;
            break;
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azk.a($$0);
      int $$3 = azk.a($$1 / 9.0);
      fri.a $$4 = this.d.get(azk.a($$3, 0, this.d.size() - 1));
   ...
   private void o() {
      ...
      if (this.e.isEmpty()) {
         ...
         this.c.b().a(this.e, this.j, xs.a, false, ($$0, $$1, $$2) -> this.d.add(new fri.a($$1, $$2)));
         if (this.e.charAt(this.e.length() - 1) == '\n') {
            this.d.add(new fri.a(this.e.length(), this.e.length()));
         }
      }
   }
   ...
   protected static record a(int a, int b) {
      static final fri.a c = new fri.a(0, 0);
   }
}
