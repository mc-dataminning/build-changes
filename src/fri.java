...
public class fri implements auj, AutoCloseable {
   ...
   private final Map<aku, frk> h = new HashMap<>();
   private final hek i;
   @Nullable
   ...
   private static fdt.a d() {
      return new fdt.a(new frg(), frj.a.b);
   }
   ...
   private CompletableFuture<fri.d> a(aup $$0, Executor $$1) {
      ...
      return af.d($$2)
         .thenCompose(
            $$1x -> {
               List<CompletableFuture<Optional<fdt>>> $$2x = $$1x.stream().flatMap(fri.e::d).collect(af.b());
               fdt.a $$3x = d();
               $$2x.add(CompletableFuture.completedFuture(Optional.of($$3x.a())));
               return af.d($$2x)
                  .thenCompose(
                     $$3xx -> {
                        Map<aku, List<fdt.a>> $$4x = this.a($$1x);
   ...
   private CompletableFuture<Optional<fdt>> a(fri.a $$0, frv.b $$1, aup $$2, Executor $$3) {
   ...
   private Map<aku, List<fdt.a>> a(List<fri.e> $$0) {
      Map<aku, List<fdt.a>> $$1 = new HashMap<>();
      aye<aku, fri.e> $$2 = new aye<>();
   ...
   private static Set<frj> b(fln $$0) {
   ...
   private static List<Pair<fri.a, frv.a>> a(List<aun> $$0, aku $$1) {
   ...
   static record b(fri.a a, frj.a b, Either<CompletableFuture<Optional<fdt>>, aku> c) {

      public Optional<List<fdt.a>> a(Function<aku, List<fdt.a>> $$0) {
   ...
   static record d(Map<aku, List<fdt.a>> a, List<fdt> b) {
   }

   static record e(aku a, List<fri.b> b, Set<aku> c) implements aye.a<aku> {
      ...
      public void a(fri.a $$0, frj.a $$1, CompletableFuture<Optional<fdt>> $$2) {
