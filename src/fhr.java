...
public class fhr extends fhz {
   ...
   public static fhr a(dgf $$0, bsg $$1, boolean $$2, String $$3, String $$4) {
   ...
   public String a(int $$0) {
      if (azw.h(this.n)) {
         return this.m ? hfq.a("mco.configure.world.slot.empty") : this.b($$0);
      } else {
         return this.n;
      }
   }
   ...
   public String b(int $$0) {
      return hfq.a("mco.configure.world.slot", $$0);
   }
