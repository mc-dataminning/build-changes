...
public class fhr {
   ...
   private final vu h;
   private final fht i;
   private final Map<af, fht> j = Maps.newLinkedHashMap();
   private double k;
   private double l;
   ...
   public fhr(ezg $$0, fhv $$1, fhs $$2, int $$3, ag $$4, ar $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void b(fat $$0, int $$1, int $$2) {
      if (!this.r) {
   ...
   @Nullable
   public static fhr a(ezg $$0, fhv $$1, int $$2, ag $$3) {
      Optional<ar> $$4 = $$3.a().c();
      if ($$4.isEmpty()) {
         return null;
      } else {
         for (fhs $$5 : fhs.values()) {
            if ($$2 < $$5.a()) {
               return new fhr($$0, $$1, $$5, $$2, $$3, $$4.get());
            }
   ...
   public void a(ag $$0) {
      Optional<ar> $$1 = $$0.a().c();
      if (!$$1.isEmpty()) {
         fht $$2 = new fht(this, this.a, $$0, $$1.get());
         this.a($$2, $$0.b());
      }
   }

   private void a(fht $$0, af $$1) {
      this.j.put($$1, $$0);
      int $$2 = $$0.d();
      int $$3 = $$2 + 28;
      int $$4 = $$0.c();
