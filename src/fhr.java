...
public enum fhr implements evp {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static ewo a(int $$0, int $$1, fhr.a $$2) {
      ewo $$3 = new ewo(ewo.a.a, $$0, $$1, false);
