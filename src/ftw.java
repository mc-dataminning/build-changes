public class ftw extends ftm {
   ftw(fpx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, ftv $$8) {
   ...
   public static class a implements ftd<kc> {
      ...
      public fta a(kc $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ftw($$1, $$2, $$3, $$4, $$5, $$6, $$7, avr.b.a(255, 204, 31, 102), this.a);
      }
   }
   ...
   public static class b implements ftd<kc> {
      ...
      public fta a(kc $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ftw($$1, $$2, $$3, $$4, $$5, $$6, $$7, avr.b.a(255, 255, 255, 255), this.a);
      }
   }
}
