...
public abstract class ftw implements fvb, fvv, fxo, fxt {
   ...
   private int f;
   private boolean m;
   private final fvm n = new fvm();

   public ftw(int $$0, int $$1, int $$2, int $$3, xg $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(ftk $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   public static xu a_(xg $$0) {
      return xg.a("gui.narrate.button", $$0);
   }

   protected abstract void b(ftk var1, int var2, int var3, float var4);

   protected static void a(ftk $$0, fti $$1, xg $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(ftk $$0, fti $$1, xg $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = azz.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.e();
      } else {
         int $$17 = azz.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(ftk $$0, fti $$1, int $$2, int $$3) {
      int $$4 = this.F() + $$2;
   ...
   public static void b(hpt $$0) {
      $$0.a(hoi.a(awy.Bv, 1.0F));
   }
   ...
   @Override
   public final void b(fxv $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fxv var1);
