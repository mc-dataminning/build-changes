...
public class fuw extends ful {
   private static final fwa d = new fwa(alk.b("widget/text_field"), alk.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, azc> D = ($$0x, $$1x) -> azc.forward($$0x, xz.a);
   @Nullable
   private xc E;
   private long F = ag.c();

   public fuw(ftx $$0, int $$1, int $$2, xc $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fuw(ftx $$0, int $$1, int $$2, int $$3, int $$4, xc $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fuw(ftx $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fuw $$5, xc $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, azc> $$0) {
      this.D = $$0;
   }
   ...
   protected xq d() {
      xc $$0 = this.B();
      return xc.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = azq.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azq.a($$0) - this.F();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, gaf.t());
   }
   ...
   public void b(ftz $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            alk $$4 = d.a(this.E(), this.aN_());
            $$0.a(gsn::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         int $$12 = $$10;
         int $$13 = azq.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gsn.G(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   private void a(ftz $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$1 < $$3) {
         int $$5 = $$1;
         $$1 = $$3;
         $$3 = $$5;
   ...
   public void o(int $$0) {
      this.x = azq.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = azq.a(this.v, 0, this.p.length());
      }
   }
