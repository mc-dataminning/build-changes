public class fuw extends fun<ctj> {
   ...
   protected void a(fns $$0, float $$1, int $$2, int $$3) {
      ...
      if ($$7 > 0) {
         $$0.a(glv::C, G, 18, 4, 0, 0, $$4 + 60, $$5 + 44, $$7, 4);
      }
      ...
      if ($$8 > 0) {
         ...
         if ($$9 > 0) {
            $$0.a(glv::C, H, 9, 28, 0, 0, $$4 + 97, $$5 + 16, 9, $$9);
         }

         $$9 = K[$$8 / 2 % 7];
         if ($$9 > 0) {
            $$0.a(glv::C, I, 12, 29, 0, 29 - $$9, $$4 + 63, $$5 + 14 + 29 - $$9, 12, $$9);
         }
      }
   }
}
