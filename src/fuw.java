public class fuw extends fuk {
   private final dvg u;
   private fok<dvg.a> v;
   private fok<Boolean> w;
   private fok<Boolean> x;
   ...
   protected void aT_() {
      ...
      this.w = this.c(
         fok.a(xv.c("advMode.mode.conditional"), xv.c("advMode.mode.unconditional"))
            .a()
            .a(this.z)
            .a(this.n / 2 - 50, 165, 100, 20, xv.c("advMode.type"), ($$0, $$1) -> this.z = $$1)
      );
      this.x = this.c(
         fok.a(xv.c("advMode.mode.autoexec.bat"), xv.c("advMode.mode.redstoneTriggered"))
            .a()
            .a(this.A)
