...
public class fuw extends fty<bji, fgh<bji>> {
   private static final Map<biu<?>, aew> a = ImmutableMap.of(
      biu.aw,
      new aew("textures/entity/piglin/piglin.png"),
      biu.bs,
      new aew("textures/entity/piglin/zombified_piglin.png"),
      biu.ax,
      new aew("textures/entity/piglin/piglin_brute.png")
   );
