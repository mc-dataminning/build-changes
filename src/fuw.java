...
public class fuw extends fug<fuw.b> {
   ...
   private boolean ac;
   private boolean ad;
   private final Set<ayk<cxg>> ae = new HashSet<>();
   private final boolean af;
   private final fuz ag;

   public fuw(gka $$0, cso $$1, boolean $$2) {
      super(new fuw.b($$0), $$0.gg(), xu.a);
      $$0.cd = this.z;
      this.u = 136;
      this.s = 195;
      this.af = $$2;
   ...
   private void a(cso $$0, boolean $$1, js.a $$2) {
      gfe $$3 = this.m.L();
      if (this.a($$3 != null ? $$3.D() : null, $$0, $$1, $$2)) {
         for (cvz $$4 : cwa.d()) {
            Collection<cxk> $$5 = $$4.l();
            if ($$4 == V) {
               if ($$4.k() == cvz.h.a && $$5.isEmpty()) {
                  this.a(cwa.b());
               } else {
                  this.a($$5);
               }
   ...
   private boolean a(@Nullable gfv $$0, cso $$1, boolean $$2, js.a $$3) {
      if (!cwa.a($$1, $$2, $$3)) {
         return false;
      } else {
         if ($$0 != null) {
            List<cxk> $$4 = List.copyOf(cwa.e().l());
            $$0.a($$3, $$4);
            $$0.a($$4);
         }
   ...
   private void a(Collection<cxk> $$0) {
   ...
   @Override
   protected void a(@Nullable cuu $$0, int $$1, int $$2, cti $$3) {
      if (this.a($$0)) {
         this.Y.c(false);
         this.Y.i(0);
      }
      ...
      boolean $$4 = $$3 == cti.b;
      $$3 = $$1 == -999 && $$3 == cti.a ? cti.e : $$3;
      if ($$3 != cti.e || this.m.t.gj()) {
         this.a($$0, $$3);
         if ($$0 == null && V.k() != cvz.h.b && $$3 != cti.f) {
            ...
            if ($$0 == this.aa && $$4) {
               for (int $$5 = 0; $$5 < this.m.t.cc.c().size(); $$5++) {
                  this.m.t.cc.b($$5).f(cxk.k);
                  this.m.r.a(cxk.k, $$5);
               }
            } else if (V.k() == cvz.h.b) {
               if ($$0 == this.aa) {
                  this.z.b(cxk.k);
               } else if ($$3 == cti.e && $$0 != null && $$0.h()) {
                  cxk $$6 = $$0.a($$2 == 0 ? 1 : $$0.g().k());
                  cxk $$7 = $$0.g();
                  this.m.t.a($$6, true);
                  this.m.r.a($$6);
                  this.m.r.a($$7, ((fuw.c)$$0).a.d);
               } else if ($$3 == cti.e && $$1 == -999 && !this.z.g().f()) {
                  this.m.t.a(this.z.g(), true);
                  this.m.r.a(this.z.g());
                  this.z.b(cxk.k);
               } else {
               ...
               cxk $$13 = $$0 == null ? cxk.k : this.z.b($$0.d).g();
               this.z.a($$0 == null ? $$1 : $$0.d, $$2, $$3, this.m.t);
               if (csx.d($$2) == 2) {
                  for (int $$14 = 0; $$14 < 9; $$14++) {
                     this.m.r.a(this.z.b(45 + $$14).g(), 36 + $$14);
                  }
               } else if ($$0 != null && cpr.d($$0.i()) && V.k() != cvz.h.b) {
                  if ($$3 == cti.e && !$$13.f() && !this.z.g().f()) {
                     int $$15 = $$2 == 0 ? 1 : $$13.L();
                     cxk $$16 = $$13.c($$15);
                     $$13.h($$15);
                     this.m.t.a($$16, true);
   ...
   private boolean a(@Nullable cuu $$0) {
      return $$0 != null && $$0.c == S;
   }
   ...
   protected void aT_() {
      if (this.m.r.f()) {
         super.aT_();
         this.Y = new foh(this.p, this.C + 82, this.D + 6, 80, 9, xv.c("itemGroup.search"));
         this.Y.f(50);
         this.Y.d(false);
         this.Y.g(false);
         this.Y.g(16777215);
   ...
   private void a(cvz $$0) {
      ...
      if (V.k() == cvz.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.k.size(); $$10++) {
            ...
            cuu $$26 = new fuw.c($$9.k.get($$10), $$10, $$14, $$15);
            this.z.k.add($$26);
         }

         this.aa = new cuu(S, 0, 173, 112);
   ...
   public void a(fnl $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.aa != null && V.k() == cvz.h.b && this.a(this.aa.e, this.aa.f, 16, 16, (double)$$1, (double)$$2)) {
         $$0.a(this.p, T, $$1, $$2);
      }
   ...
   public List<xv> a(cxk $$0) {
      ...
      boolean $$2 = V.k() == cvz.h.a;
      boolean $$3 = V.k() == cvz.h.d;
      czc.a $$4 = this.m.n.m ? czc.a.b : czc.a.a;
      czc $$5 = $$1 ? $$4.c() : $$4;
      List<xv> $$6 = $$0.a(cxg.b.a(this.m.s), this.m.t, $$5);
      if ($$2 && $$1) {
         return $$6;
      } else {
   ...
   protected void a(fnl $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(glo::B, V.c(), this.C, this.D, 0.0F, 0.0F, this.s, this.u, 256, 256);
      this.Y.a($$0, $$2, $$3, $$1);
      int $$5 = this.C + 175;
      int $$6 = this.D + 18;
      int $$7 = $$6 + 112;
      if (V.e()) {
         alz $$8 = this.K() ? G : H;
         $$0.a(glo::B, $$8, $$5, $$6 + (int)((float)($$7 - $$6 - 17) * this.W), 12, 15);
      }
   ...
   protected boolean a(cvz $$0, double $$1, double $$2) {
      int $$3 = this.b($$0);
      int $$4 = this.c($$0);
      return $$1 >= (double)$$3 && $$1 <= (double)($$3 + 26) && $$2 >= (double)$$4 && $$2 <= (double)($$4 + 32);
   }

   protected boolean a(fnl $$0, cvz $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(fnl $$0, cvz $$1) {
      boolean $$2 = $$1 == V;
      boolean $$3 = $$1.g() == cvz.f.a;
      int $$4 = $$1.f();
      ...
      $$0.a(glo::B, $$7[bae.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static class b extends csx {
      public final jz<cxk> m = jz.a();
      private final csx n;
   ...
   static class c extends cuu {
      ...
      public c(cuu $$0, int $$1, int $$2, int $$3) {
         super($$0.c, $$1, $$2, $$3);
         this.a = $$0;
      }
