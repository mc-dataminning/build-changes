...
public class eaa implements dzz {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<eaa> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               duo.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               duq.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dup.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bnf.b(1, 20).fieldOf("outer_wall_distance").orElse(bnl.a(4, 5)).forGetter($$0x -> $$0x.i),
               bnf.b(1, 20).fieldOf("distribution_points").orElse(bnl.a(3, 4)).forGetter($$0x -> $$0x.j),
               bnf.b(0, 10).fieldOf("point_offset").orElse(bnl.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public eaa(duo $$0, duq $$1, dup $$2, double $$3, double $$4, boolean $$5, bnf $$6, bnf $$7, bnf $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
