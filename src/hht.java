...
public class hht implements hhw.a, AutoCloseable {
   ...
   fhq[] f;
   @Nullable
   private final hht.a g;
   private final avd h;

   public hht(ale $$0, hjm $$1, fhq $$2, avd $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      this.g = $$3.a(hjl.b).map($$2x -> this.a($$1, $$2.a(), $$2.b(), $$2x)).orElse(null);
      this.e = $$2;
      this.f = new fhq[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hhn.a(this.f, $$0);
   ...
   @Nullable
   private hht.a a(hjm $$0, int $$1, int $$2, hjl $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      int $$7 = $$3.d();
      ...
      if ($$3.a().isEmpty()) {
         ...
         for (hjk $$12 : $$10) {
            $$8.add(new hht.b($$12.a(), $$12.a($$7)));
         }

         int $$13 = 0;
         IntSet $$14 = new IntOpenHashSet();

         for (Iterator<hht.b> $$15 = $$8.iterator(); $$15.hasNext(); $$13++) {
            hht.b $$16 = $$15.next();
            boolean $$17 = true;
            if ($$16.b <= 0) {
      ...
      return $$8.size() <= 1 ? null : new hht.a(List.copyOf($$8), $$4, $$3.e());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fhq[] $$4) {
   ...
   class a {
      ...
      a(final List<hht.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hht.this.c;
         int $$4 = this.b($$2) * hht.this.d;
         hht.this.a($$0, $$1, $$3, $$4, hht.this.f);
      }

      public hhv a() {
         return hht.this.new d(this, this.d ? hht.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fhq[] b = new fhq[hht.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hht.this.c >> $$0;
            int $$2 = hht.this.d >> $$0;
            this.b[$$0] = new fhq($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hht.d $$2) {
         hht.a $$3 = $$2.c;
         List<hht.b> $$4 = $$3.b;
         hht.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            hht.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hht.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hht.this.f[$$2].a($$3 + ($$0.a($$1) * hht.this.c >> $$2), $$4 + ($$0.b($$1) * hht.this.d >> $$2));
      }
   ...
   class d implements hhv {
      int a;
      int b;
      final hht.a c;
      @Nullable
      private final hht.c d;

      d(final hht.a $$0, @Nullable final hht.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
