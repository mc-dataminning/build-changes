...
public class bjb extends biq implements bio, bkc {
   ...
   private static final aee<Float> c = aeh.a(bjb.class, aeg.d);
   private static final aee<Float> d = aeh.a(bjb.class, aeg.d);
   private static final aee<Boolean> e = aeh.a(bjb.class, aeg.k);
   ...
   static record a(UUID b, long c) {
      public static final Codec<bjb.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(hx.a.fieldOf("player").forGetter(bjb.a::a), Codec.LONG.fieldOf("timestamp").forGetter(bjb.a::b)).apply($$0, bjb.a::new)
      );
