...
public class bjb extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(bit.D);
      Type<?> $$3 = this.getOutputSchema().getType(bit.D);
      Type<?> $$4 = bbb.a($$2, $$2, $$3);
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", $$2, $$3, $$3x -> {
         String $$4x = $$3x.getOptional($$1).<String>map(Pair::getFirst).map(bko::a).orElse("");
         Typed<?> $$5 = bbb.a($$4, $$3x);
         if (a.contains($$4x)) {
            return af.a($$5, $$3, bjb::a);
         } else {
            return b.contains($$4x) ? af.a($$5, $$3, bjb::b) : bbb.a($$3, $$3x);
         }
      });
   }
