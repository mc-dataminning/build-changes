...
public class bjb extends bjf {
   ...
   public static bjb a(float $$0, float $$1, float $$2, float $$3) {
      return new bjb($$0, $$1, $$2, $$3);
   }

   private bjb(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(auw $$0, float $$1, float $$2, float $$3, float $$4) {
      return aup.a(aup.c($$0, $$1, $$2), $$3, $$4);
   }
