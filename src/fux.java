...
public class fux {
   ...
   public fuq a(Vector3f $$0, Vector3f $$1, fus $$2, gfb $$3, ic $$4, ghj $$5, @Nullable fut $$6, boolean $$7, ahh $$8) {
      fuu $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = aup.i($$11, $$9.a[0], $$12);
      $$9.a[2] = aup.i($$11, $$9.a[2], $$12);
      $$9.a[1] = aup.i($$11, $$9.a[1], $$13);
      $$9.a[3] = aup.i($$11, $$9.a[3], $$13);
      ...
      return new fuq($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fuu a(fuu $$0, ic $$1, j $$2, ahh $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(aup.b($$23), aup.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fuu(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fuu $$0, gfb $$1, ic $$2, float[] $$3, j $$4, @Nullable fut $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ic $$2, fuu $$3, float[] $$4, gfb $$5, j $$6, @Nullable fut $$7, boolean $$8) {
      ftk.b $$9 = ftk.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gfb $$3, fuu $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fut $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ic $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (aup.a($$13, $$18) && aup.a($$14, $$19) && aup.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
