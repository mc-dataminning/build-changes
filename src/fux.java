...
public class fux extends fun<ctk> {
   ...
   private final hau M = new hau();

   public fux(ctk $$0, cpw $$1, xv $$2) {
      super($$0, $$1, $$2);
      this.w -= 2;
   }
   ...
   protected void a(fns $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(glv::C, L, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      cxp $$6 = this.z.b(1).g();
      boolean $$7 = $$6.a(cxt.uZ);
      boolean $$8 = $$6.a(cxt.rm);
      boolean $$9 = $$6.a(cxt.gg);
      cxp $$10 = this.z.b(0).g();
      evp $$11 = $$10.a(ku.L);
      boolean $$12 = false;
      evr $$13;
      if ($$11 != null) {
         $$13 = cyc.a($$11, this.m.s);
         if ($$13 != null) {
            if ($$13.h) {
               $$12 = true;
               if ($$8 || $$9) {
                  $$0.a(glv::C, G, $$4 + 35, $$5 + 31, 28, 21);
               }
            }
   ...
   private void a(fns $$0, @Nullable evp $$1, @Nullable evr $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.C;
      int $$8 = this.D;
      if ($$4 && !$$6) {
         $$0.a(glv::C, H, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 85, $$8 + 31, 0.226F);
      } else if ($$3) {
         $$0.a(glv::C, I, $$7 + 67 + 16, $$8 + 13, 50, 66);
         this.a($$0, $$1, $$2, $$7 + 86, $$8 + 16, 0.34F);
         $$0.c().a();
         $$0.c().a(0.0F, 0.0F, 1.0F);
         $$0.a(glv::C, I, $$7 + 67, $$8 + 13 + 16, 50, 66);
         this.a($$0, $$1, $$2, $$7 + 70, $$8 + 32, 0.34F);
         $$0.c().b();
      } else if ($$5) {
         $$0.a(glv::C, J, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 71, $$8 + 17, 0.45F);
         $$0.c().a();
         $$0.c().a(0.0F, 0.0F, 1.0F);
         $$0.a(glv::C, K, $$7 + 118, $$8 + 60, 10, 14);
         $$0.c().b();
      } else {
         $$0.a(glv::C, J, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 71, $$8 + 17, 0.45F);
   ...
   private void a(fns $$0, @Nullable evp $$1, @Nullable evr $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
