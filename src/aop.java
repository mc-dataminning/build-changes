...
public class aop extends aoo {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aop.a> s;
   private final aok t;
   private long u;
   private final afh v;

   private aop(afh $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aol.c($$2, 7, $$0.getLength());
      }
   }
