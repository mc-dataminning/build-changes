...
public class aop {
                                             ...
                                             ((RequiredArgumentBuilder)ef.a("facingEntity", er.a())
                                                   .executes(
                                                      $$0x -> a(
                                                            ...
                                                            gh.b($$0x, "location"),
                                                            null,
                                                            new aop.b(er.a($$0x, "facingEntity"), eq.a.a)
                                                         )
                                                   ))
                                                .then(
                                                   ef.a("facingAnchor", eq.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               gh.b($$0x, "location"),
                                                               null,
                                                               new aop.b(er.a($$0x, "facingEntity"), eq.a($$0x, "facingAnchor"))
                                                            )
                                                      )
                                                )
                                          )
                                    ...
                                    ef.a("facingLocation", gh.a())
                                       .executes(
                                          $$0x -> a(
                                                ...
                                                gh.b($$0x, "location"),
                                                null,
                                                new aop.c(gh.a($$0x, "facingLocation"))
                                             )
                                       )
                                 )
                           )
   ...
   private static int a(ee $$0, Collection<? extends bru> $$1, bru $$2) throws CommandSyntaxException {
      for (bru $$3 : $$1) {
         a($$0, $$3, (aqm)$$2.dP(), $$2.du(), $$2.dw(), $$2.dA(), EnumSet.noneOf(btc.class), $$2.dF(), $$2.dH(), null);
      }
   ...
   private static int a(ee $$0, Collection<? extends bru> $$1, aqm $$2, gc $$3, @Nullable gc $$4, @Nullable aop.a $$5) throws CommandSyntaxException {
      euk $$6 = $$3.a($$0);
      euj $$7 = $$4 == null ? null : $$4.b($$0);
      Set<btc> $$8 = EnumSet.noneOf(btc.class);
      if ($$3.a()) {
         $$8.add(btc.a);
      }
   ...
   private static void a(ee $$0, bru $$1, aqm $$2, double $$3, double $$4, double $$5, Set<btc> $$6, float $$7, float $$8, @Nullable aop.a $$9) throws CommandSyntaxException {
      io $$10 = io.a($$3, $$4, $$5);
      if (!dax.l($$10)) {
         throw a.create();
      } else {
         ...
         if ($$1.a($$2, $$3, $$4, $$5, $$6, $$11, $$12)) {
            ...
            if (!($$1 instanceof bso $$13) || !$$13.fE()) {
               $$1.g($$1.ds().d(1.0, 0.0, 1.0));
               $$1.d(true);
            }

            if ($$1 instanceof bsx $$14) {
               $$14.K().n();
            }
         }
      }
   ...
   @FunctionalInterface
   interface a {
      void perform(ee var1, bru var2);
   }

   static record b(bru a, eq.a b) implements aop.a {
      @Override
      public void perform(ee $$0, bru $$1) {
   ...
   static record c(euk a) implements aop.a {
      @Override
      public void perform(ee $$0, bru $$1) {
         $$1.a($$0.m(), this.a);
      }
