...
public class aop {
   ...
   private static ArgumentBuilder<et, ?> a(ep $$0, ArgumentBuilder<et, ?> $$1, aop.a $$2) {
   ...
   private static CompletableFuture<Suggestions> a(et $$0, Collection<ezh> $$1, SuggestionsBuilder $$2) {
   ...
   private static int a(et $$0, ezh $$1, eza $$2) throws CommandSyntaxException {
      ezi $$3 = $$0.l().aJ();
      eze $$4 = $$3.d($$1, $$2);
      if ($$4 == null) {
         throw f.create($$2.b(), $$1.he());
      } else {
         $$0.a(() -> xd.a("commands.scoreboard.players.get.success", $$1.he(), $$4.a(), $$2.g()), false);
         return $$4.a();
      }
   }
   ...
   private static int a(et $$0, Collection<ezh> $$1, eza $$2, fp.a $$3, Collection<ezh> $$4, eza $$5) throws CommandSyntaxException {
      ezi $$6 = $$0.l().aJ();
      int $$7 = 0;
   ...
   private static int a(et $$0, Collection<ezh> $$1, eza $$2) throws CommandSyntaxException {
      if ($$2.c() != ezl.c) {
         throw e.create();
      } else {
         ezi $$3 = $$0.l().aJ();
   ...
   private static int b(et $$0, Collection<ezh> $$1, eza $$2) {
      ezi $$3 = $$0.l().aJ();
   ...
   private static int a(et $$0, Collection<ezh> $$1, eza $$2, int $$3) {
      ezi $$4 = $$0.l().aJ();
   ...
   private static int a(et $$0, Collection<ezh> $$1, eza $$2, @Nullable xd $$3) {
      ezi $$4 = $$0.l().aJ();
   ...
   private static int a(et $$0, Collection<ezh> $$1, eza $$2, @Nullable yt $$3) {
      ezi $$4 = $$0.l().aJ();
   ...
   private static int b(et $$0, Collection<ezh> $$1, eza $$2, int $$3) {
      ezi $$4 = $$0.l().aJ();
      int $$5 = 0;
   ...
   private static int c(et $$0, Collection<ezh> $$1, eza $$2, int $$3) {
      ezi $$4 = $$0.l().aJ();
      int $$5 = 0;
   ...
   private static int a(et $$0) {
      Collection<ezh> $$1 = $$0.l().aJ().e();
      if ($$1.isEmpty()) {
         $$0.a(() -> xd.c("commands.scoreboard.players.list.empty"), false);
      } else {
         $$0.a(() -> xd.a("commands.scoreboard.players.list.success", $$1.size(), xg.b($$1, ezh::he)), false);
      }

      return $$1.size();
   }

   private static int a(et $$0, ezh $$1) {
      Object2IntMap<eza> $$2 = $$0.l().aJ().c($$1);
      if ($$2.isEmpty()) {
         $$0.a(() -> xd.a("commands.scoreboard.players.list.entity.empty", $$1.he()), false);
      } else {
         $$0.a(() -> xd.a("commands.scoreboard.players.list.entity.success", $$1.he(), $$2.size()), false);
         Object2IntMaps.fastForEach(
            $$2, $$1x -> $$0.a(() -> xd.a("commands.scoreboard.players.list.entity.entry", ((eza)$$1x.getKey()).g(), $$1x.getIntValue()), false)
         );
      }
   ...
   private static int a(et $$0, eyz $$1) throws CommandSyntaxException {
      ezi $$2 = $$0.l().aJ();
      if ($$2.a($$1) == null) {
         throw b.create();
      } else {
   ...
   private static int a(et $$0, eyz $$1, eza $$2) throws CommandSyntaxException {
      ezi $$3 = $$0.l().aJ();
      if ($$3.a($$1) == $$2) {
         throw c.create();
      } else {
   ...
   private static int a(et $$0, eza $$1, xd $$2) {
      if (!$$1.d().equals($$2)) {
         $$1.a($$2);
   ...
   private static int a(et $$0, eza $$1, boolean $$2) {
      if ($$1.e() != $$2) {
         $$1.a($$2);
         if ($$2) {
   ...
   private static int a(et $$0, eza $$1, @Nullable yt $$2) {
      $$1.b($$2);
      if ($$2 != null) {
   ...
   private static int a(et $$0, eza $$1, ezl.a $$2) {
      if ($$1.h() != $$2) {
         $$1.a($$2);
   ...
   private static int a(et $$0, eza $$1) {
      ezi $$2 = $$0.l().aJ();
      $$2.j($$1);
   ...
   private static int a(et $$0, String $$1, ezl $$2, xd $$3) throws CommandSyntaxException {
      ezi $$4 = $$0.l().aJ();
      if ($$4.a($$1) != null) {
         throw a.create();
      } else {
   ...
   private static int b(et $$0) {
      Collection<eza> $$1 = $$0.l().aJ().c();
      if ($$1.isEmpty()) {
         $$0.a(() -> xd.c("commands.scoreboard.objectives.list.empty"), false);
      } else {
         $$0.a(() -> xd.a("commands.scoreboard.objectives.list.success", $$1.size(), xg.b($$1, eza::g)), false);
      }
