...
public class dfb implements dex, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bcq<bcs.b> c;
   private final dfe d;
   private final Map<clt, dfb.a> e = Maps.newLinkedHashMap();
   ...
   protected dfb(Path $$0, boolean $$1, String $$2) {
      this.d = new dfe($$0, $$1);
      this.c = new bcq<>(new bcs.a(dfb.b.values().length), ac.g(), "IOWorker-" + $$2);
   }
   ...
   public CompletableFuture<Void> a(clt $$0, @Nullable qr $$1) {
      return this.a(() -> {
         dfb.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dfb.a($$1));
         $$2.a = $$1;
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bcs.b(dfb.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<clt, dfb.a>> $$0 = this.e.entrySet().iterator();
         Entry<clt, dfb.a> $$1 = $$0.next();
         $$0.remove();
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bcs.b(dfb.b.c.ordinal(), () -> $$0.a(apz.a))).join();
         this.c.close();
