...
public class ekp extends ekv {
   public static final MapCodec<ekp> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ekc.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
   ...
   protected final ekc e;
   protected final int f;
   protected final List<jn> g;

   public ekp(float $$0, int $$1, int $$2, ekc $$3, int $$4, List<jn> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(ekv.a $$0, ji $$1, jn $$2) {
