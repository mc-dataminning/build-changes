...
public abstract class ekp<M extends ekm<M>> {
   private final czp i;
   protected final drr a;
   ...
   protected final Long2ObjectMap<drj> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected ekp(czp $$0, drr $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected drj a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected drj a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected drj c(long $$0) {
      drj $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = jg.e($$0);
      drj $$2 = this.a($$1, true);
      return $$2.a(jg.b(id.a($$0)), jg.b(id.b($$0)), jg.b(id.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(jg.b(id.a($$0)), jg.b(id.b($$0)), jg.b(id.c($$0)), $$1);
      jg.a($$0, this.f::add);
   }
   ...
   protected void a(eks<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            drj $$2 = (drj)this.g.remove($$1);
            drj $$3 = this.d.d($$1);
            if (this.k.contains(jg.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<drj>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<drj> $$6 = (Entry<drj>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               drj $$8 = (drj)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable drj $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jg.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, ekp.a.a($$9, ekp.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public ekp.b k(long $$0) {
      return ekp.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static ekp.b c(byte $$0) {
         if ($$0 == 0) {
            return ekp.b.a;
         } else {
            return a($$0) ? ekp.b.c : ekp.b.b;
         }
      }
   }
