...
public class cmb extends cms {
   ...
   public bka a(cpi $$0) {
      ...
      if (!$$1.B) {
         ...
         els $$3 = $$0.l();
         ic $$4 = $$0.k();
         cfu $$5 = new cfu($$1, $$0.o(), $$3.c + (double)$$4.j() * 0.15, $$3.d + (double)$$4.k() * 0.15, $$3.e + (double)$$4.l() * 0.15, $$2);
         $$1.b($$5);
         $$2.h(1);
      }
   ...
   public static void a(cmx $$0, byte $$1) {
   ...
   public static enum a {
      ...
      private static final IntFunction<cmb.a> f = atf.a(cmb.a::a, values(), atf.a.a);
      private final int g;
