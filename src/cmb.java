...
public class cmb {
   ...
   @VisibleForTesting
   protected final ArrayList<bsv> c;
   private final cmb.a k;
   @VisibleForTesting
   protected final Object2IntMap<bsv> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cmb> a(Predicate<bsv> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cmb::b)).apply($$1, $$1x -> new cmb($$0, $$1x))
      );
   }

   public cmb(Predicate<bsv> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cmb.a(this);
   ...
   public void a(arf $$0, Predicate<bsv> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsv>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsv> $$6 = (Entry<bsv>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsv $$8 = (bsv)$$6.getKey();
         bsv.c $$9 = $$8.dL();
   ...
   public int b(@Nullable bsv $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btq> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btq).map($$0 -> (btq)$$0);
   }

   @VisibleForTesting
   protected static record a(cmb a) implements Comparator<bsv> {
      public int a(bsv $$0, bsv $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cmy;
               boolean $$7 = $$1 instanceof cmy;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
