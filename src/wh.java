...
public class wh extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vj> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, uv.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vj> $$0, Codec<T> $$1, uv $$2) {
      vj $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> wh a(DynamicOps<vj> $$0, Codec<T> $$1, T $$2) {
      vj $$3 = (vj)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = azk.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zj<? super wh, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zk<? super wh, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zj<? super wh, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zj<? super wh, K> $$1, zj<? super wh, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zj<? super wh, K> $$0, zj<? super wh, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zk<? super wh, K> $$1, zk<? super wh, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zk<? super wh, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zj<? super wh, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zj<? super wh, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zj<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zk<? super wh, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zk<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static jh b(ByteBuf $$0) {
      return jh.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, jh $$1) {
      $$0.writeLong($$1.a());
   }

   public dgf f() {
      return new dgf(this.readLong());
   }
   ...
   public static dgf c(ByteBuf $$0) {
      return new dgf($$0.readLong());
   }

   public static void a(ByteBuf $$0, dgf $$1) {
      $$0.writeLong($$1.a());
   }

   public kj g() {
      return kj.a(this.readLong());
   }
   ...
   public static fbr f(ByteBuf $$0) {
      return new fbr($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, fbr $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public <T> wh a(ToIntFunction<T> $$0, T $$1) {
   ...
   public wh a(@Nullable vj $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vj $$1) {
      if ($$1 == null) {
         $$1 = uo.b;
      }

      try {
         uz.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static um h(ByteBuf $$0) {
      vj $$1 = a($$0, uv.a(2097152L));
      if ($$1 != null && !($$1 instanceof um)) {
   ...
   @Nullable
   public static vj a(ByteBuf $$0, uv $$1) {
      try {
         vj $$2 = uz.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return xa.a(this.d, $$0);
   }

   public wh a(String $$0) {
      return this.a($$0, 32767);
   }

   public wh a(String $$0, int $$1) {
      xa.a(this.d, $$0, $$1);
      return this;
   }

   public alp q() {
      return alp.a(this.d(32767));
   }
   ...
   public <T> alo<T> a(alo<? extends kd<T>> $$0) {
      alp $$1 = this.q();
      return alo.a($$0, $$1);
   }
   ...
   public fbn v() {
      ...
      return new fbn(new fbr((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5, $$6);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, azu.e($$1, 8)));
      }
   }
   ...
   public wh a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wh a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public wh a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wh a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wh a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wh a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wh a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public wh a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public wh b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public wh c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public wh d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public wh e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public wh f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public wh g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public wh h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public wh a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public wh b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public wh i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public wh a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public wh a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public wh b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wh b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public wh b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wh b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wh b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wh b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public wh j(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wh c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public wh a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wh a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public wh a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wh a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public wh a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public wh k(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public wh d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public wh b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wh b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public wh b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
