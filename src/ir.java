...
public class ir {
   ...
   public <T> ir a(agh<? extends io<T>> $$0, Lifecycle $$1, ir.e<T> $$2) {
      this.a.add(new ir.g<>($$0, $$1, $$2));
      return this;
   }

   public <T> ir a(agh<? extends io<T>> $$0, ir.e<T> $$1) {
   ...
   public id.b a(ip $$0, id.b $$1) {
      ir.a $$2 = this.b($$0);
      Map<agh<? extends io<?>>, ir.f<?>> $$3 = new HashMap<>();
   ...
   static record a(ir.b a, ir.h b, Map<agi, ic<?>> c, Map<agh<?>, ir.d<?>> d, List<RuntimeException> e) {

      public static ir.a a(ip $$0, Stream<agh<? extends io<?>>> $$1) {
         ir.b $$2 = new ir.b();
         List<RuntimeException> $$3 = new ArrayList<>();
         ir.h $$4 = new ir.h($$2);
         Builder<agi, ic<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> ov<T> a() {
         return new ov<T>() {
            @Override
            public ib.c<T> a(agh<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> ic<S> a(agh<? extends io<? extends S>> $$0) {
      ...
      public void b() {
         for (agh<Object> $$0 : this.b.a.keySet()) {
      ...
      public void a(id.b $$0) {
         Map<agi, Optional<? extends id<Object>>> $$1 = new HashMap<>();
         Iterator<Entry<agh<Object>, ib.c<Object>>> $$2 = this.b.a.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<agh<Object>, ib.c<Object>> $$3 = $$2.next();
            agh<Object> $$4 = $$3.getKey();
            ib.c<Object> $$5 = $$3.getValue();
            $$1.computeIfAbsent($$4.b(), $$1x -> $$0.a(agh.a($$1x))).flatMap($$1x -> $$1x.a($$4)).ifPresent($$2x -> {
               $$5.b($$2x.a());
               $$2.remove();
            });
         }
      ...
      public Stream<ir.f<?>> d() {
         return this.b.a.keySet().stream().map(agh::b).distinct().map($$0 -> new ir.f(agh.a($$0), Lifecycle.stable(), Map.of()));
      }
   ...
   static record f<T>(agh<? extends io<? extends T>> a, Lifecycle b, Map<agh<T>, ir.i<T>> c) {

      public id.c<T> a() {
         return new id.c<T>() {
            private final Map<agh<T>, ib.c<T>> b = f.this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$0x -> {
               ir.i<T> $$1 = (ir.i<T>)$$0x.getValue();
               ib.c<T> $$2 = $$1.b().orElseGet(() -> ib.c.a(this, (agh<T>)$$0x.getKey()));
               $$2.b($$1.a().a());
               return $$2;
            }));
      ...
      public agh<? extends io<? extends T>> b() {
         return this.a;
      }
      ...
      public Map<agh<T>, ir.i<T>> d() {
         return this.c;
      }
   }

   static record g<T>(agh<? extends io<T>> a, Lifecycle b, ir.e<T> c) {
      void b(ir.a $$0) {
         this.c.run($$0.a());
      }

      public ir.f<T> a(ir.a $$0) {
         Map<agh<T>, ir.i<T>> $$1 = new HashMap<>();
         Iterator<Entry<agh<?>, ir.d<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<agh<?>, ir.d<?>> $$3 = $$2.next();
            agh<?> $$4 = $$3.getKey();
            if ($$4.b(this.a)) {
               ir.d<T> $$6 = (ir.d<T>)$$3.getValue();
               ib.c<T> $$7 = (ib.c<T>)$$0.b.a.remove($$4);
               $$1.put((agh<T>)$$4, new ir.i<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class h extends ir.c<Object> {
      final Map<agh<Object>, ib.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<ib.c<Object>> a(agh<Object> $$0) {
