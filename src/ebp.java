...
public class ebp extends eay<edj> {
   private static final Logger a = LogUtils.getLogger();
   private static final bta<?>[] b = new bta[]{bta.aN, bta.bu, bta.bu, bta.aW};
   private static final dsc c = dfb.nc.o();

   public ebp(Codec<edj> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<edj> $$0) {
      Predicate<dsc> $$1 = eay.a(awp.bO);
      iz $$2 = $$0.e();
      azh $$3 = $$0.d();
      dct $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.I_() && !$$4.a_($$23.d()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(dfb.cv)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, dfb.cn.o(), $$1);
                        } else {
                           this.a($$4, $$23, dfb.m.o(), $$1);
                        }
                     }
                  } else if (!$$24.a(dfb.cv) && !$$24.a(dfb.ct)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.u($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, eio.a($$4, $$30, dfb.cv.o()), $$1);
                     brc.a($$4, $$3, $$30, eqe.d);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, dfb.ct.o(), $$1);
         if ($$4.c_($$2) instanceof dqv $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
