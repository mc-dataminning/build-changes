...
@Deprecated
public class ebp extends eba<ebp.a> {
   private static final dse a = dfd.nc.o();

   public ebp(Codec<ebp.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebc<ebp.a> $$0) {
      iz $$1 = $$0.e();
      dcv $$2 = $$0.b();
      azh $$3 = $$0.d();
      ebp.a $$4 = $$0.f();
   ...
   public static record a(eff b, eff c) implements ede {
      public static final Codec<ebp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eff.a.fieldOf("fluid").forGetter(ebp.a::a), eff.a.fieldOf("barrier").forGetter(ebp.a::b)).apply($$0, ebp.a::new)
      );
