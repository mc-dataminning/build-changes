...
public class ebp {
   ...
   private final Predicate<bva> j;
   private final aqz k = (aqz)new aqz(wp.c("entity.minecraft.ender_dragon"), bso.a.a, bso.b.a).b(true).c(true);
   private final ard l;
   private final ji m;
   ...
   public ebp(ard $$0, long $$1, ebp.a $$2) {
      this($$0, $$1, $$2, ji.c);
   }

   public ebp(ard $$0, long $$1, ebp.a $$2, ji $$3) {
      this.l = $$0;
      this.m = $$3;
   ...
   public ebp.a b() {
      return new ebp.a(this.x, this.t, this.u, false, Optional.ofNullable(this.w), Optional.ofNullable(this.y), Optional.of(this.n));
   }
   ...
   public void c() {
      ...
      if (!this.k.g().isEmpty()) {
         this.l.m().a(ark.c, new dgg(0, 0), 9);
         boolean $$0 = this.n();
         if (this.x && $$0) {
            this.j();
            this.x = false;
         ...
         this.l.m().b(ark.c, new dgg(0, 0), 9);
      }
   }
   ...
   private dxv.b m() {
      ...
      for (int $$1 = -8 + $$0.h; $$1 <= 8 + $$0.h; $$1++) {
         for (int $$2 = -8 + $$0.i; $$2 <= 8 + $$0.i; $$2++) {
            ...
            for (dus $$4 : $$3.I().values()) {
               if ($$4 instanceof dwm) {
                  dxv.b $$5 = this.o.a(this.l, $$4.aA_());
                  if ($$5 != null) {
                     ji $$6 = $$5.a(3, 3, 3).d();
                     if (this.y == null) {
                        this.y = $$6;
      ...
      ji $$7 = egt.a(this.m);
      int $$8 = this.l.a(edo.a.e, $$7).v();

      for (int $$9 = $$8; $$9 >= this.l.G_(); $$9--) {
         dxv.b $$10 = this.o.a(this.l, new ji($$7.u(), $$9, $$7.w()));
         if ($$10 != null) {
            if (this.y == null) {
               this.y = $$10.a(3, 3, 3).d();
            }
   ...
   private boolean n() {
      if (this.v) {
         ...
         for (int $$1 = -8 + $$0.h; $$1 <= 8 + $$0.h; $$1++) {
            for (int $$2 = 8 + $$0.i; $$2 <= 8 + $$0.i; $$2++) {
               dzm $$3 = this.l.a($$1, $$2, ean.n, false);
               if (!($$3 instanceof dzw)) {
                  return false;
               }
   ...
   public void a(ckp $$0) {
      if ($$0.cF().equals(this.w)) {
         ...
         this.q();
         if (!this.u) {
            this.l.b(this.l.a(edo.a.e, egt.a(this.m)), dkg.fV.m());
         }
   ...
   private void a(ji $$0) {
      this.l.c(3000, $$0, 0);
      this.l.F_().a(mc.aM).flatMap($$0x -> $$0x.a(re.d)).ifPresent($$1 -> $$1.a().a(this.l, this.l.m().g(), azh.a(), $$0));
   }

   private void a(boolean $$0) {
      egt $$1 = new egt($$0);
      if (this.y == null) {
         this.y = this.l.a(edo.a.f, egt.a(this.m)).e();
      ...
      if ($$1.a(eiy.m, this.l, this.l.m().g(), azh.a(), this.y)) {
         int $$2 = ayz.e(4, 16);
   ...
   public void a(cko $$0, btp $$1) {
      if (this.z != null && this.B.contains($$0)) {
         ...
         this.p();
         if (this.l.b(this.w) instanceof ckp $$3) {
            $$3.a(this.l, $$0, $$0.du(), $$1);
         }
      }
   }
   ...
   public void g() {
      if (this.t && this.z == null) {
         ...
         for (jn $$4 : jn.c.a) {
            List<cko> $$5 = this.l.a(cko.class, new fbs($$3.a($$4, 2)));
            if ($$5.isEmpty()) {
               return;
            }
   ...
   private void a(List<cko> $$0) {
      if (this.t && this.z == null) {
         for (dxv.b $$1 = this.m(); $$1 != null; $$1 = this.m()) {
            for (int $$2 = 0; $$2 < this.o.c(); $$2++) {
               for (int $$3 = 0; $$3 < this.o.b(); $$3++) {
                  for (int $$4 = 0; $$4 < this.o.a(); $$4++) {
                     dxu $$5 = $$1.a($$2, $$3, $$4);
                     if ($$5.a().a(dkg.I) || $$5.a().a(dkg.fS)) {
                        this.l.b($$5.d(), dkg.fU.m());
                     }
                  }
               }
            }
   ...
   public static record a(boolean c, boolean d, boolean e, boolean f, Optional<UUID> g, Optional<ji> h, Optional<List<Integer>> i) {
      public static final Codec<ebp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  Codec.BOOL.fieldOf("NeedsStateScanning").orElse(true).forGetter(ebp.a::a),
                  Codec.BOOL.fieldOf("DragonKilled").orElse(false).forGetter(ebp.a::b),
                  Codec.BOOL.fieldOf("PreviouslyKilled").orElse(false).forGetter(ebp.a::c),
                  Codec.BOOL.lenientOptionalFieldOf("IsRespawning", false).forGetter(ebp.a::d),
                  kl.a.lenientOptionalFieldOf("Dragon").forGetter(ebp.a::e),
                  ji.a.lenientOptionalFieldOf("ExitPortalLocation").forGetter(ebp.a::f),
                  Codec.list(Codec.INT).lenientOptionalFieldOf("Gateways").forGetter(ebp.a::g)
               )
               .apply($$0, ebp.a::new)
      );
      public static final ebp.a b = new ebp.a(true, false, false, false, Optional.empty(), Optional.empty(), Optional.empty());
