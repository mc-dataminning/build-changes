...
public class ebp {
   ...
   static class a implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
         return $$0.c[ic.f.d()] && !$$0.b[ic.f.d()].d;
      }

      @Override
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         $$1.d = true;
         $$1.b[ic.f.d()].d = true;
         return new ebp.k($$0, $$1);
      }
   }

   static class b implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         ...
         return new ebp.l($$0, $$1);
      }
   }

   static class c implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         $$1.d = true;
         $$1.b[ic.b.d()].d = true;
         return new ebp.m($$0, $$1);
      }
   }

   static class d implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         ...
         return new ebp.n($$0, $$1);
      }
   }

   static class e implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         ...
         $$3.d = true;
         $$3.b[ic.c.d()].d = true;
         return new ebp.o($$0, $$3);
      }
   }

   static class f implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
         return true;
      }
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         $$1.d = true;
         return new ebp.s($$0, $$1, $$2);
      }
   }

   static class g implements ebp.i {
      @Override
      public boolean a(ebp.v $$0) {
      ...
      public ebp.r a(ic $$0, ebp.v $$1, auv $$2) {
         $$1.d = true;
         return new ebp.t($$0, $$1);
      }
   }

   public static class h extends ebp.r {
      ...
      private ebp.v G;
      private ebp.v H;
      private final List<ebp.r> I = Lists.newArrayList();

      public h(auv $$0, int $$1, int $$2, ic $$3) {
         super(dzx.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ebp.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ebp.p($$3, this.G));
         this.I.add(new ebp.j($$3, this.H));
         List<ebp.i> $$5 = Lists.newArrayList();
         $$5.add(new ebp.b());
         $$5.add(new ebp.d());
         $$5.add(new ebp.e());
         $$5.add(new ebp.a());
         ...
         dyy $$10 = dyy.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dyy $$11 = dyy.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dyy $$12 = dyy.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ebp.u($$3, $$10, $$13++));
         this.I.add(new ebp.u($$3, $$11, $$13++));
         this.I.add(new ebp.q($$3, $$12));
      }
      ...
      private List<ebp.v> b(auv $$0) {
         ebp.v[] $$1 = new ebp.v[75];
         ...
         ebp.v $$23 = new ebp.v(1003);
         ebp.v $$24 = new ebp.v(1001);
         ebp.v $$25 = new ebp.v(1002);
         $$1[v].a(ic.b, $$23);
         $$1[w].a(ic.d, $$24);
         $$1[x].a(ic.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ebp.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cuk $$2, auv $$3, dyy $$4) {
         int $$5 = 24;
      ...
      private void a(cuk $$0, auv $$1, dyy $$2) {
      ...
      private void b(cuk $$0, auv $$1, dyy $$2) {
      ...
      private void c(cuk $$0, auv $$1, dyy $$2) {
      ...
      private void d(cuk $$0, auv $$1, dyy $$2) {
      ...
      private void e(cuk $$0, auv $$1, dyy $$2) {
      ...
      private void f(cuk $$0, auv $$1, dyy $$2) {
   ...
   interface i {
      boolean a(ebp.v var1);

      ebp.r a(ic var1, ebp.v var2, auv var3);
   }

   public static class j extends ebp.r {
      public j(ic $$0, ebp.v $$1) {
         super(dzx.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cuk $$0, cui $$1, dle $$2, auv $$3, dyy $$4, csw $$5, hx $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cws.ch.o(), cws.ch.o(), false);
   ...
   public static class k extends ebp.r {
      public k(ic $$0, ebp.v $$1) {
         super(dzx.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ebp.r {
      public l(ic $$0, ebp.v $$1) {
         super(dzx.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ebp.r {
      public m(ic $$0, ebp.v $$1) {
         super(dzx.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ebp.r {
      public n(ic $$0, ebp.v $$1) {
         super(dzx.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ebp.r {
      public o(ic $$0, ebp.v $$1) {
         super(dzx.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ebp.r {
      public p(ic $$0, ebp.v $$1) {
         super(dzx.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ebp.r {
      public q(ic $$0, dyy $$1) {
         super(dzx.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dzk {
      protected static final djh b = cws.hZ.o();
      protected static final djh c = cws.ia.o();
      protected static final djh d = cws.ib.o();
      protected static final djh h = c;
      protected static final djh i = cws.ii.o();
      protected static final boolean j = true;
      protected static final djh k = cws.G.o();
      protected static final Set<cwq> l = ImmutableSet.builder().add(cws.dO).add(cws.iC).add(cws.mW).add(k.b()).build();
      ...
      public r(dzx $$0, ic $$1, int $$2, dyy $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dzx $$0, int $$1, ic $$2, ebp.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dyy a(ic $$0, ebp.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dyy $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cuk $$0, dyy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  djh $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cuk $$0, dyy $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cuk $$0, dyy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, djh $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dyy $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cuk $$0, dyy $$1, int $$2, int $$3, int $$4) {
         hx $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cce $$6 = blz.B.a((ctp)$$0.E());
            if ($$6 != null) {
               $$6.b($$6.eM());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bmp.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ebp.r {
      private int a;

      public s(ic $$0, ebp.v $$1, auv $$2) {
         super(dzx.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ebp.r {
      public t(ic $$0, ebp.v $$1) {
         super(dzx.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ebp.r {
      private int a;

      public u(ic $$0, dyy $$1, int $$2) {
         super(dzx.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
