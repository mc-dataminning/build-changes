...
public record gim(Map<String, String> c, Set<String> d) {
   public static final gim a = new gim(Map.of(), Set.of());
   public static final Codec<gim> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gim::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gim::e)
            )
            .apply($$0, gim::new)
   );
   ...
   public gim a(gim $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gim($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gim.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gim.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gim.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gim a() {
         return new gim(this.a.build(), this.b.build());
      }
   }
}
