...
public class biu extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         "RaidRenamesDataFix", this.getInputSchema().getType(biz.l), $$0 -> $$0.update(DSL.remainderFinder(), $$0x -> $$0x.update("data", biu::a))
      );
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Raids", "raids", $$0x -> $$0x.createList($$0x.asStream().map(biu::b)))
