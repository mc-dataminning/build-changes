...
public class biu<E extends bgb> extends bhr<E> {
   ...
   protected List<biu.a> h = Lists.newArrayList();
   ...
   public static <E extends bgb> boolean a(E $$0, gu $$1) {
      cmm $$2 = $$0.dI();
      gu $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(dxy.a($$2, $$1.j())) == 0.0F;
   }

   public biu(bdi $$0, int $$1, int $$2, float $$3, Function<E, amg> $$4, BiPredicate<E, gu> $$5) {
      super(ImmutableMap.of(bpb.n, bpc.c, bpb.R, bpc.b, bpb.S, bpc.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(aif $$0, bgb $$1) {
      boolean $$2 = $$1.ay() && !$$1.aV() && !$$1.bi() && !$$0.a_($$1.di()).a(cpo.pg);
      if (!$$2) {
         $$1.dK().a(bpb.R, this.p.a($$0.z) / 2);
      }
   ...
   protected boolean b(aif $$0, bgb $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.dg()) && this.k > 0 && !$$1.aY() && (this.j != null || !this.h.isEmpty());
   ...
   protected void a(aif $$0, E $$1, long $$2) {
      ...
      this.h = gu.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new biu.a($$1x.i(), apa.c($$3.j($$1x))))
   ...
   protected void c(aif $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.p(true);
            double $$3 = this.j.f();
            double $$4 = $$3 + (double)$$1.eV();
            $$1.f(this.j.a($$4 / $$3));
            $$1.dK().a(bpb.S, true);
            $$0.a(null, $$1, this.q.apply($$1), ami.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   protected Optional<biu.a> a(aif $$0) {
      Optional<biu.a> $$1 = bck.a($$0.z, this.h);
   ...
   private eei a(bgb $$0, eei $$1, int $$2) {
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            return new eei($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }
   ...
   public static class a extends bcj.a {
      private final gu a;
