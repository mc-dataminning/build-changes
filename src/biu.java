...
public class biu<T extends biq> implements cdz, djh<biq, T> {
   ...
   private final he.c<biu<?>> bx = jb.h.f(this);
   ...
   public static aew a(biu<?> $$0) {
      return jb.h.b($$0);
   }

   public static Optional<biu<?>> a(String $$0) {
      return jb.h.b(aew.a($$0));
   }
   ...
   @Nullable
   public T a(akq $$0, @Nullable cjf $$1, @Nullable cbu $$2, gw $$3, bjk $$4, boolean $$5, boolean $$6) {
      Consumer<T> $$8;
      qw $$7;
      if ($$1 != null) {
         $$7 = $$1.v();
   ...
   public static <T extends biq> Consumer<T> a(akq $$0, cjf $$1, @Nullable cbu $$2) {
      return a($$0x -> {
      }, $$0, $$1, $$2);
   }

   public static <T extends biq> Consumer<T> a(Consumer<T> $$0, akq $$1, cjf $$2, @Nullable cbu $$3) {
   ...
   public static <T extends biq> Consumer<T> b(Consumer<T> $$0, akq $$1, cjf $$2, @Nullable cbu $$3) {
      qw $$4 = $$2.v();
      return $$4 != null ? $$0.andThen($$3x -> a($$1, $$3, $$3x, $$4)) : $$0;
   }

   @Nullable
   public T a(akq $$0, gw $$1, bjk $$2) {
      return this.a($$0, (qw)null, null, $$1, $$2, false, false);
   }

   @Nullable
   public T a(akq $$0, @Nullable qw $$1, @Nullable Consumer<T> $$2, gw $$3, bjk $$4, boolean $$5, boolean $$6) {
   ...
   @Nullable
   public T b(akq $$0, @Nullable qw $$1, @Nullable Consumer<T> $$2, gw $$3, bjk $$4, boolean $$5, boolean $$6) {
      T $$7 = this.a((cpv)$$0);
      if ($$7 == null) {
         return null;
      } else {
         ...
         $$7.b((double)$$3.u() + 0.5, (double)$$3.v() + $$8, (double)$$3.w() + 0.5, arw.g($$0.z.i() * 360.0F), 0.0F);
   ...
   protected static double a(cpy $$0, gw $$1, boolean $$2, ehi $$3) {
      ...
      return 1.0 + eid.a(ha.a.b, $$3, $$5, $$2 ? -2.0 : -1.0);
   }

   public static void a(cpv $$0, @Nullable cbu $$1, @Nullable biq $$2, @Nullable qw $$3) {
   ...
   public static Optional<biq> a(qw $$0, cpv $$1) {
   ...
   public static Optional<biu<?>> a(qw $$0) {
      return jb.h.b(new aew($$0.l("id")));
   }

   @Nullable
   public static biq a(qw $$0, cpv $$1, Function<biq, biq> $$2) {
   ...
   public static Stream<biq> a(final List<? extends rq> $$0, final cpv $$1) {
      ...
      return StreamSupport.stream(new Spliterator<biq>() {
         ...
         public boolean tryAdvance(Consumer<? super biq> $$0x) {
            return $$2.tryAdvance($$2xx -> biu.a((qw)$$2xx, $$1, $$1xxxx -> {
                  $$0.accept($$1xxxx);
                  return $$1xxxx;
               }));
         }
   ...
   private static Optional<biq> b(qw $$0, cpv $$1) {
      try {
         return a($$0, $$1);
   ...
   public boolean a(aqh<biu<?>> $$0) {
      return this.bx.a($$0);
   }

   public boolean a(hi<biu<?>> $$0) {
      return $$0.a(this.bx);
   }
