...
public class aum implements auj {
   private static final Logger a = LogUtils.getLogger();
   private final Map<String, auk> c;
   private final List<atf> d;

   public aum(ath $$0, List<atf> $$1) {
      this.d = List.copyOf($$1);
      Map<String, auk> $$2 = new HashMap<>();
      List<String> $$3 = $$1.stream().flatMap($$1x -> $$1x.a($$0).stream()).distinct().toList();

      for (atf $$4 : $$1) {
         aus $$5 = this.a($$4);
         Set<String> $$6 = $$4.a($$0);
         Predicate<alc> $$7 = $$5 != null ? $$1x -> $$5.b($$1x.a()) : null;
   ...
   public Map<alc, aur> b(String $$0, Predicate<alc> $$1) {
      a($$0);
      Map<alc, aur> $$2 = new TreeMap<>();

      for (auk $$3 : this.c.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<alc, List<aur>> c(String $$0, Predicate<alc> $$1) {
      a($$0);
      Map<alc, List<aur>> $$2 = new TreeMap<>();
