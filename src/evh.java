...
public class evh {
   ...
   public evh(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<evi> $$1) throws IOException {
   ...
   public List<evi> a(Path $$0) throws IOException {
      List<evi> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<evi> a(Path $$0, boolean $$1) throws IOException {
      List<evi> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<evi> $$1) throws IOException {
