...
public enum evh implements ayz {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ayz.a<evh> t = ayz.a(evh::values);
   public static final IntFunction<evh> u = aww.a(evh::a, values(), aww.a.a);
   private final int v;
