...
public class evh implements evi, evj {
   ...
   private final fal<MinecraftServer> G;
   ...
   public evh(dgk $$0, edo $$1, evh.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ji.c,
   ...
   public static <T> evh a(Dynamic<T> $$0, dgk $$1, evh.a $$2, edo $$3, Lifecycle $$4) {
      ...
      return new evh(
         ...
         new fal<>(fak.a, $$0.get("ScheduledEvents").asStream()),
         (tq)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(eat.a.a).resultOrPartial(f::error).orElse(eat.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(kf $$0, tq $$1, @Nullable tq $$2) {
      ...
      edm.a($$4, this.h, $$0).resultOrPartial(af.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (un)eat.a.a.encodeStart(ue.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dhd.b.encodeStart(ue.a, this.g.g()).ifSuccess($$1x -> $$1.a((tq)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == evh.a.b;
   }

   @Override
   public boolean A() {
      return this.i == evh.a.c;
   }
