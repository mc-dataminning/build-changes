...
public class evh {
   ...
   private static final Map<dmr.a, String> e = ac.a(new EnumMap<>(dmr.a.class), $$0 -> {
      $$0.put(dmr.a.a, "SW");
      $$0.put(dmr.a.b, "S");
      $$0.put(dmr.a.c, "OW");
      $$0.put(dmr.a.d, "O");
   ...
   private djp l;
   @Nullable
   private CompletableFuture<djp> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final atu r = new atu();
   private final atu s = new atu();
   private final atu t = new atu();
   private final atu u = new atu();
   private final ewp v;
   private final ewr w;
   private final ewq x;
   private final ewo y;
   ...
   public evh(etd $$0) {
      ...
      this.g = new evh.a();
      this.h = $$0.h;
      this.v = new ewp(this.h, this.r);
      this.w = new ewr(this.h, this.s, () -> $$0.r.r().g());
      this.x = new ewq(this.h, this.t);
      this.y = new ewo(this.h, this.u);
   }
   ...
   private void a(euo $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.au()) {
         ...
         csa $$23 = this.p();
         LongSet $$24 = (LongSet)($$23 instanceof ame ? ((ame)$$23).v() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, iu.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, atm.g($$15.dD()), atm.g($$15.dF())));
         djp $$27 = this.r();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(csj.a, $$14);
            int $$30 = this.f.r.a(csj.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            djp $$31 = this.q();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dmr.a $$33 : dmr.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.ak()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ao();
                  long $$36 = $$31.u();
                  biv $$37 = new biv($$23.aj(), $$23.X(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            csl.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<blj> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(blj.values())
   ...
   private static String a(ib<csy> $$0) {
   ...
   private csa p() {
      return (csa)DataFixUtils.orElse(Optional.ofNullable(this.f.S()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ad()))), this.f.r);
   }
   ...
   private djp q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, djj.n, false).thenApply($$0x -> (djp)$$0x.map($$0xx -> (djp)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", emp.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", etd.N().aL().k(), etd.N().aL().l(), emp.a()),
            emp.c(),
            emp.d()
         }
      );
      if (this.f.au()) {
         ...
         if (this.i.c() == ejs.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dil<?>, Comparable<?>> $$7 = (Entry<dil<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ejs.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dil<?>, Comparable<?>> $$10 = (Entry<dil<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(jy.h.b($$11.ai())));
         }
   ...
   private String a(Entry<dil<?>, Comparable<?>> $$0) {
      dil<?> $$1 = $$0.getKey();
