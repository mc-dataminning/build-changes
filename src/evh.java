...
public class evh {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((ctm)MoreObjects.firstNonNull(this.b.q.k(), ctm.b)).b());
               }
   ...
   private void a(djh $$0, hx $$1, @Nullable sn $$2) {
   ...
   private void a(ahg $$0, elt $$1, @Nullable sn $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aM().i()) {
         boolean $$5 = eow.a(evi.O().aM().i(), 292);
         if (this.d > 0L) {
            if (!eow.a(evi.O().aM().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eow.a(evi.O().aM().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fdv) || ((fdv)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aM().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               evt.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aW().a() && this.b.m.s().c()) {
            boolean $$9 = $$6 == null || !($$6.aH_() instanceof exp $$7) || !$$7.d();
            if ($$3 != 0 && $$1 == 66 && fdb.s() && $$9) {
               boolean $$10 = this.b.m.ap().c() == evk.a;
               this.b.m.ap().a(evk.a(this.b.m.ap().c().a() + 1));
               this.b.m.as();
               if ($$6 instanceof fdd) {
                  ((fdd)$$6).n();
               }
         ...
         label185: {
            ...
            label144:
            if (!$$13) {
               if (this.b.y instanceof fcw $$14 && !$$14.n()) {
                  break label144;
               }
      ...
      if ($$0 == this.b.aM().i()) {
         ...
         if ($$3 != null && this.b.aJ() == null) {
            if (Character.charCount($$1) == 1) {
               fdb.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fdb.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", auo.f((float)$$1 / 1000.0F));
            }
