...
public class bkk extends DataFix {
   ...
   public static int a(int $$0) {
      return b[azo.a($$0 - 1, 0, b.length - 1)];
   }

   public bkk(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(bjb.D, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(bjb.D), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
