...
public class bkk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Either<?, Pair<?, Pair<?, Pair<?, Dynamic<?>>>>>>> $$0 = this.getInputSchema().getType(bjm.z);
                        ...
                        $$0xxxx -> $$0xxxx.mapSecond(
                              $$0xxxxx -> $$0xxxxx.mapSecond(
                                    $$0xxxxxx -> $$0xxxxxx.mapSecond(
                                          $$0xxxxxxx -> $$0xxxxxxx.update("bold", bkk::a)
                                                .update("italic", bkk::a)
                                                .update("underlined", bkk::a)
                                                .update("strikethrough", bkk::a)
                                                .update("obfuscated", bkk::a)
                                       )
                                 )
                           )
                     )
