public class ebq {
   ...
   private int a(dis $$0, int $$1, int $$2, int $$3) {
      int $$4 = iu.c($$0.g($$1) + 1);
   ...
   public boolean a(cqy $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(cqy $$0, int $$1, int $$2, ht $$3, dgw $$4, ht $$5, dgw $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(cqy $$0, ht $$1, dgw $$2) {
      ht.a $$3 = this.e.g($$1);
   ...
   private static boolean a(cqy $$0, ht $$1, dgw $$2, ht $$3, dgw $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         ekb $$5 = ebx.a($$0, $$1, $$2, hx.a);
         ekb $$6 = ebx.a($$0, $$3, $$4, hx.b);
         return ejy.b($$5, $$6);
      }
   }
