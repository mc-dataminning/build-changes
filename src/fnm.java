         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.f - $$2; $$3 <= this.f + $$2; $$3++) {
               for (int $$4 = this.e - $$2; $$4 <= this.e + $$2; $$4++) {
                  dln $$5 = fnm.this.d.b.get(fnm.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     csv $$6 = $$5.f();
            ...
            fnm.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
