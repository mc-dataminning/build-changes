public class fnm extends fpj {
   ...
   fnm(flj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fpe $$7) {
      super($$0, $$1, $$2, $$3);
      this.B = 0.96F;
      this.j = $$4;
      this.k = $$5;
      this.l = $$6;
      this.v = atm.a(this.r, 0.7176471F, 0.8745098F);
      this.w = atm.a(this.r, 0.0F, 0.0F);
      this.x = atm.a(this.r, 0.8235294F, 0.9764706F);
      this.D *= 0.75F;
   ...
   public static class a implements fol<jv> {
      ...
      public foi a(jv $$0, flj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fnm($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
}
