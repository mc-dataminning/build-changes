...
public class fnm extends fnl {
   ...
   protected void aP_() {
      ...
      this.y = $$0.u_();
      this.z = $$0.bc().m();
      this.c(fib.a(dcd::e).a(dcd.a, dcd.d, dcd.b, dcd.c).a(this.y).a(this.m / 2 - 155, 100, 150, 20, q, ($$0x, $$1x) -> this.y = $$1x));
      this.c(fib.b(this.z).a(this.m / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.z = $$1x));
      fhu $$1 = fhu.a(wu.c("lanServer.start"), $$1x -> {
         this.l.a(null);
         wu $$2;
      ...
      this.B = new fid(this.o, this.m / 2 - 75, 160, 150, 20, wu.c("lanServer.port"));
      this.B.b($$1x -> {
         wu $$2 = this.a($$1x);
      ...
      this.c(this.B);
      this.c($$1);
      this.c(fhu.a(wt.e, $$0x -> this.d()).a(this.m / 2 + 5, this.n - 28, 150, 20).a());
   }
