public class gdd extends gbk<gzn> {
   ...
   private static geu c() {
      geu $$0 = new geu();
      gew $$1 = $$0.a();
      $$1.a("lid", ger.c().a(0, 0).a(-8.0F, -16.0F, -8.0F, 16.0F, 12.0F, 16.0F), geo.a(0.0F, 24.0F, 0.0F));
      $$1.a("base", ger.c().a(0, 28).a(-8.0F, -8.0F, -8.0F, 16.0F, 8.0F, 16.0F), geo.a(0.0F, 24.0F, 0.0F));
      return $$0;
   }

   public static ges a() {
      geu $$0 = c();
      $$0.a().a("head", ger.c().a(0, 52).a(-3.0F, 0.0F, -3.0F, 6.0F, 6.0F, 6.0F), geo.a(0.0F, 12.0F, 0.0F));
