...
public class gdd implements ezi, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final ezg c = new ezg();
   private static final boolean d = true;
   private static gdd e;
   ...
   private final List<ezo> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezo> l = Maps.newHashMap();
   private final int m;
   ...
   public gdd(aur $$0, String $$1) throws IOException {
      ale $$2 = new ale("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      aum $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = ayo.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = ayo.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(ayo.a($$5, "blend", null));
         this.s = a($$0, ezl.a.a, $$6);
         this.t = a($$0, ezl.a.b, $$7);
         this.m = ezm.a();
         ezm.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezo.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezj a(aur $$0, ezl.a $$1, String $$2) throws IOException {
      ezl $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezj)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         ezj $$7;
         if ($$3 == null) {
            ale $$4 = new ale("shaders/program/" + $$2 + $$1.b());
            aum $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static ezh a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezh();
      } else {
         int $$1 = 32774;
