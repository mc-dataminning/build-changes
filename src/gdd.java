public class gdd extends gaq<gzv> {
   public gdd(gfd $$0) {
      super($$0);
   }
   ...
   public void a(gzv $$0) {
      ...
      if ($$3 == cnn.e) {
         ...
         gat.a(this.r, this.s, this.o, $$0.e == bvb.b);
      } else if ($$3 == cnn.c) {
         gat.a(this.r, this.s, $$0.c, $$0.K, $$0.e == bvb.b);
      } else if ($$3 == cnn.d) {
         this.o.e = 0.5F;
         this.o.f = 0.0F;
         if ($$0.e == bvb.a) {
   ...
   protected void a(gzv $$0, float $$1) {
      float $$2 = $$0.H;
      if ($$2 > 0.0F && $$0.d == cnn.a) {
         gat.a(this.r, this.s, $$0.e, $$2, $$0.u);
      } else {
         super.a($$0, $$1);
      }
   }

   private void b(gzv $$0) {
      if ($$0.e == bvb.a) {
         this.s.e = -1.8F;
      } else {
         this.r.e = -1.8F;
