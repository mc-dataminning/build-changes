...
public class gdd extends dxu {
   ...
   public gdd(gdh $$0, int $$1) {
      this.e = $$0;
      this.b = new dxw($$0, new des(0, 0), $$0.J_().e(ma.aG).b(dgv.b));
      this.c = new erk(this, true, $$0.F_().g());
      this.d = new gdd.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dya $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         des $$3 = $$0.f();
   ...
   @Nullable
   public dya b(int $$0, int $$1, dyr $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dya $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dya a(int $$0, int $$1, wg $$2, ul $$3, Consumer<adq.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dya $$6 = this.d.b.get($$5);
         des $$7 = new des($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dya(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dya> b;
      ...
      void a(int $$0, @Nullable dya $$1) {
         dya $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gdd.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dya $$5 = gdd.this.d.b.get(gdd.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     des $$6 = $$5.f();
            ...
            gdd.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
