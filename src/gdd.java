...
public class gdd {
   ...
   private final eqp n;
   private boolean o;
   private final ejb p = new ejb();
   private final ejc q = this.p.e();
   private final gdc r;
   private final gde s = new gde();
   private final gcz t = new gcz(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<gdd.a> w = new AtomicReference<>(gdd.a.c);
   private final Map<gcc, gcz.a> x = Maps.newHashMap();
   private final Multimap<aox, gcc> y = HashMultimap.create();
   private final List<gcd> z = Lists.newArrayList();
   private final Map<gcc, Integer> A = Maps.newHashMap();
   private final Map<gcc, Integer> B = Maps.newHashMap();
   private final List<gdf> C = Lists.newArrayList();
   private final List<gcd> D = Lists.newArrayList();
   private final List<gbz> E = Lists.newArrayList();

   public gdd(gdg $$0, eqp $$1, anp $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new gdc($$2);
   }
   ...
   public void c() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(eja::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean i() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gdd.a.c, gdd.a.a)) {
               String $$2 = this.n.ap().c();
               ac.g().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gdd.a.a, gdd.a.b);
                     }
                  ...
                  this.w.compareAndSet(gdd.a.a, gdd.a.c);
               });
            }
         }

         return this.w.compareAndSet(gdd.a.b, gdd.a.c);
      }
   }
   ...
   private void j() {
      this.u++;
      this.D.stream().filter(gcc::s).forEach(this::c);
      this.D.clear();
      ...
      for (gcd $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            ehd $$3 = new ehd($$0.h(), $$0.i(), $$0.j());
            gcz.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<gcc, gcz.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gcc, gcz.a> $$6 = $$5.next();
         gcz.a $$7 = $$6.getValue();
         gcc $$8 = $$6.getKey();
      ...
      Iterator<Entry<gcc, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gcc, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gcc $$13 = $$12.getKey();
            if ($$13 instanceof gcd) {
               ((gcd)$$13).q();
            }
   ...
   private static boolean d(gcc $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gcc $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gcc $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gcc $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gdg.d) {
                  if ($$3 == gdg.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        ehd $$11 = new ehd($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           boolean $$12 = $$10 || $$9 == gcc.a.a || this.q.a().g($$11) < (double)($$5 * $$5);
                           if ($$12) {
                              for (gdf $$13 : this.C) {
                                 $$13.a($$0, $$1);
                              }
                        ...
                        if (this.q.b() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<gcz.a> $$16 = this.t.a($$3.g() ? ejb.c.b : ejb.c.a);
                           gcz.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aS) {
   ...
   private float g(gcc $$0) {
      return arp.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gcc $$0) {
   ...
   public void d() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eja::d));
      }
   }

   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eja::e));
      }
   }
