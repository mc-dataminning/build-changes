...
public class bms {
   ...
   private static void a(bna $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bmv $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dtc, bne<bmu>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bne)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dtc, bne<bmu>> $$3 : $$0) {
         bne<bmu> $$4 = (bne<bmu>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dtc)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnc> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bmh.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bmq $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bms::a));
      $$1.add("chunksWritten", this.a($$0.m(), bms::a));
      return $$1;
   }

   private JsonElement a(bmx.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bmq $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bms::a));
      $$1.add("received", this.a($$0.k(), bms::a));
      return $$1;
   }

   private <T> JsonElement a(bmz<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bmw> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bmw>, ToDoubleFunction<bmw>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bmw::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bmw::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bmw::c));
      return $$1;
   }
}
