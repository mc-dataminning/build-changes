...
public class dgi extends dha implements dhq {
   public static final MapCodec<dgi> a = b(dgi::new);
   public static final dsz<dsu> b = dsr.bd;
   ...
   public dgi(dsa.d $$0) {
      super($$0);
      this.k(this.E.b().a(aE, je.c).a(d, Boolean.valueOf(false)).a(b, dsu.a));
   }
   ...
   public dsb a(dsb $$0, je $$1, dsb $$2, dby $$3, iz $$4, iz $$5) {
      return $$1 == je.a && !this.b($$3, $$5, $$2) ? dfa.a.o() : super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   @Override
   protected int a(dbd $$0, iz $$1, dsb $$2) {
      dpg $$3 = $$0.c_($$1);
      return $$3 instanceof dpr ? ((dpr)$$3).b() : 0;
   }

   private int e(dbx $$0, iz $$1, dsb $$2) {
      int $$3 = this.b($$0, $$1, $$2);
      if ($$3 == 0) {
         return 0;
      } else {
         int $$4 = this.a((dcn)$$0, $$1, $$2);
         if ($$4 > $$3) {
            return 0;
         } else {
            return $$2.c(b) == dsu.b ? $$3 - $$4 : $$3;
         }
      }
   }
   ...
   protected boolean a(dbx $$0, iz $$1, dsb $$2) {
      ...
      if ($$3 == 0) {
         ...
         int $$4 = this.a((dcn)$$0, $$1, $$2);
         return $$3 > $$4 ? true : $$3 == $$4 && $$2.c(b) == dsu.a;
      }
   }
   ...
   @Nullable
   private ciz a(dbx $$0, je $$1, iz $$2) {
      List<ciz> $$3 = $$0.a(
         ciz.class,
         new evl((double)$$2.u(), (double)$$2.v(), (double)$$2.w(), (double)($$2.u() + 1), (double)($$2.v() + 1), (double)($$2.w() + 1)),
         $$1x -> $$1x != null && $$1x.cH() == $$1
      );
   ...
   protected bqt a(dsb $$0, dbx $$1, iz $$2, cmw $$3, evm $$4) {
      if (!$$3.gd().e) {
         ...
         $$0 = $$0.a(b);
         float $$5 = $$0.c(b) == dsu.b ? 0.55F : 0.5F;
   ...
   protected void c(dbx $$0, iz $$1, dsb $$2) {
      if (!$$0.P().b($$1, this)) {
         int $$3 = this.e($$0, $$1, $$2);
         dpg $$4 = $$0.c_($$1);
         int $$5 = $$4 instanceof dpr ? ((dpr)$$4).b() : 0;
         if ($$3 != $$5 || $$2.c(d) != this.a($$0, $$1, $$2)) {
            exl $$6 = this.b($$0, $$1, $$2) ? exl.c : exl.d;
            $$0.a($$1, this, 2, $$6);
         }
      }
   }

   private void f(dbx $$0, iz $$1, dsb $$2) {
      int $$3 = this.e($$0, $$1, $$2);
      dpg $$4 = $$0.c_($$1);
      int $$5 = 0;
      if ($$4 instanceof dpr $$6) {
         $$5 = $$6.b();
         $$6.a($$3);
      }
