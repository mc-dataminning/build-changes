...
public abstract class dgi implements dgj, AutoCloseable {
   public static final Codec<aku<dgi>> h = aku.a(mc.be);
   public static final aku<dgi> i = aku.a(mc.be, akv.b("overworld"));
   public static final aku<dgi> j = aku.a(mc.be, akv.b("the_nether"));
   public static final aku<dgi> k = aku.a(mc.be, akv.b("the_end"));
   ...
   private final dyn F;
   private final dhm G;
   private final aku<dgi> H;
   private final kf I;
   private final btc J;
   private long K;

   protected dgi(evm $$0, aku<dgi> $$1, kf $$2, jr<eas> $$3, boolean $$4, boolean $$5, long $$6, int $$7) {
      this.B = $$0;
      this.E = $$3;
      final eas $$8 = $$3.a();
      this.H = $$1;
   ...
   public void a(@Nullable bul $$0, ji $$1, avz $$2, awb $$3, float $$4, float $$5) {
   ...
   public abstract void a(@Nullable cox var1, bul var2, jr<avz> var3, awb var4, float var5, float var6, long var7);
   ...
   public void a(@Nullable cox $$0, bul $$1, avz $$2, awb $$3, float $$4, float $$5) {
   ...
   public void a(@Nullable bul $$0, double $$1, double $$2, double $$3, float $$4, dgi.a $$5) {
      this.a($$0, dga.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable bul $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, dgi.a $$6) {
      this.a($$0, dga.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable bul $$0, @Nullable btb $$1, @Nullable dgb $$2, fba $$3, float $$4, boolean $$5, dgi.a $$6) {
      this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable bul $$0, @Nullable btb $$1, @Nullable dgb $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, dgi.a $$8) {
   ...
   public boolean a(ji $$0, bul $$1, jn $$2) {
      if (this.s($$0)) {
         return false;
      } else {
   ...
   @Override
   public List<bul> a(@Nullable bul $$0, fav $$1, Predicate<? super bul> $$2) {
      bos.a().f("getEntities");
   ...
   public <T extends bul> void a(ebh<bul, T> $$0, fav $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bul> void a(ebh<bul, T> $$0, fav $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      bos.a().f("getEntities");
      this.H().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   public abstract Collection<cjs> s();
   ...
   public bsi d_(ji $$0) {
      ...
      return new bsi(this.am(), this.ae(), $$1, $$2);
   }
