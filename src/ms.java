...
public class ms implements lx {
   ...
   private final Set<akj<eqz>> f;
   private final List<ms.a> g;
   private final CompletableFuture<jl.a> h;

   public ms(lz $$0, Set<akj<eqz>> $$1, List<ms.a> $$2, CompletableFuture<jl.a> $$3) {
   ...
   private CompletableFuture<?> a(lv $$0, jl.a $$1) {
      kf<eqz> $$2 = new jr<>(lr.bb, Lifecycle.experimental());
      Map<dyu.a, akk> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().apply($$1).generate(($$3xx, $$4x) -> {
            akk $$5x = a($$3xx);
            akk $$6x = $$3.put(bqm.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      era $$6 = new era($$4, etp.q, $$5);

      for (akj<eqz> $$8 : Sets.difference(this.f, $$2.g())) {
         $$4.b("Missing built-in table: " + $$8.a());
      }

      $$2.i().forEach($$1x -> ((eqz)$$1x.a()).a($$6.a(((eqz)$$1x.a()).a()).a("{" + $$1x.h().a() + "}", $$1x.h())));
      ...
      if (!$$9.isEmpty()) {
         ...
         return CompletableFuture.allOf($$2.h().stream().map($$2x -> {
            akj<eqz> $$3x = (akj<eqz>)$$2x.getKey();
            eqz $$4x = (eqz)$$2x.getValue();
            Path $$5x = this.e.a($$3x.a());
            return lx.a($$0, $$1, eqz.d, $$4x, $$5x);
         }).toArray(CompletableFuture[]::new));
      }
   }

   private static akk a(akj<eqz> $$0) {
      return $$0.a();
   }
   ...
   public static record a(Function<jl.a, mt> a, eto b) {
   }
}
