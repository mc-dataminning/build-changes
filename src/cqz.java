...
public class cqz {
   ...
   private final Optional<he<apc>> j;
   private final Optional<cqr> k;
   private final Optional<cqq> l;
   private final Optional<apa> m;
   ...
   public static class a {
      ...
      private Optional<he<apc>> i = Optional.empty();
      private Optional<cqr> j = Optional.empty();
      private Optional<cqq> k = Optional.empty();
      private Optional<apa> l = Optional.empty();
