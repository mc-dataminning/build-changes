...
public class cqz {
   ...
   private int g = azo.b(azx.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jz.a.fieldOf("uuid").forGetter(Pair::getFirst), ayw.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bwt> j;
   @VisibleForTesting
   protected final ArrayList<bwt> c;
   private final cqz.a k;
   @VisibleForTesting
   protected final Object2IntMap<bwt> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cqz> a(Predicate<bwt> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cqz::b)).apply($$1, $$1x -> new cqz($$0, $$1x))
      );
   }

   public cqz(Predicate<bwt> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cqz.a(this);
   ...
   public void a(ars $$0, Predicate<bwt> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bwt>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bwt> $$6 = (Entry<bwt>)$$5.next();
         int $$7 = $$6.getIntValue();
         bwt $$8 = (bwt)$$6.getKey();
         bwt.d $$9 = $$8.dR();
   ...
   public int b(@Nullable bwt $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bxu> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bxu).map($$0 -> (bxu)$$0);
   }

   @VisibleForTesting
   protected static record a(cqz a) implements Comparator<bwt> {
      public int a(bwt $$0, bwt $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof crx;
               boolean $$7 = $$1 instanceof crx;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
