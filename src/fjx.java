...
public class fjx<T extends byh> extends fis<T> {
   public final fmv a;
   private final fmv b;
   private final fmv f;
   private final fmv g;
   ...
   public static fnb c() {
      fnd $$0 = new fnd();
      fne $$1 = $$0.a();
      fne $$2 = $$1.a("head", fna.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fmx.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fna.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fmx.a);
      $$2.a("left_ear", fna.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fmx.a);
      $$2.a("nose", fna.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fmx.a);
      fne $$3 = $$1.a("body", fna.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fmx.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fmz $$4 = new fmz(0.001F);
      fna $$5 = fna.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fna $$6 = fna.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fmx.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fmx.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fmx.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fmx.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fna.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fmx.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fnb.a($$0, 48, 32);
   }
