...
public class fjx implements AutoCloseable {
   ...
   public fjx(fjv.a $$0, fjx.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fkd $$2) {
      int $$3 = $$2.a(fke.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fjx.b a(fjv $$0, fkg $$1) {
      if (this.c.d() != fkd.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fjx.b $$3 = new fjx.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fkd a, int b, int c, fkd.c d, fkd.b e) {
   }

   public static record b(Vector3f[] a, fkd.b b) {
      @Nullable
      public fjv.a a(fjv $$0, fkg $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fkd.b $$1) {
