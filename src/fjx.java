...
public class fjx {
   private static final Map<String, fjx.a> a = Maps.newHashMap();
   ...
   private static akv b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            akv $$4 = heg.c();
            a.put($$0, new fjx.a($$1, $$4));
            return $$4;
         } else {
            akv $$5 = akv.a("realms", "dynamic/" + $$0);
            fli.Q().aa().a($$5, new hee($$3));
            a.put($$0, new fjx.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static fet a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return fet.a($$2.put($$1).flip());
