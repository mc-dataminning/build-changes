...
public class gwk extends gvj<bwy, hco> {
   public gwk(gvk.a $$0) {
      super($$0);
   }

   public void a(hco $$0, fiq $$1, gpd $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bwy $$0, hco $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bwy $$0) {
      return false;
   }
}
