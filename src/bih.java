...
public abstract class bih extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bhv.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bhv.B);
      Type<Pair<String, String>> $$2 = DSL.named(bhv.z.typeName(), bjj.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhv.z), $$2)) {
