...
public class ur extends um<us> {
   private static final int b = 24;
   public static final vm<ur> a = new vm.b<ur>() {
      public ur a(DataInput $$0, uw $$1) throws IOException {
         return new ur(d($$0, $$1));
      }
      ...
      private static int[] d(DataInput $$0, uw $$1) throws IOException {
         $$1.b(24L);
         int $$2 = $$0.readInt();
         $$1.a(4L, (long)$$2);
         int[] $$3 = new int[$$2];
   ...
   public boolean b(int $$0, vk $$1) {
      if ($$1 instanceof vd) {
         this.c = ArrayUtils.add(this.c, $$0, ((vd)$$1).g());
         return true;
      } else {
         return false;
      }
