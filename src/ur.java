...
public class ur implements vo {
   ...
   public static final vq<ur> b = new vq.b<ur>() {
      public ur a(DataInput $$0, va $$1) throws IOException {
         $$1.b();
      ...
      private static ur d(DataInput $$0, va $$1) throws IOException {
         $$1.b(48L);
         Map<String, vo> $$2 = Maps.newHashMap();

         byte $$3;
         while (($$3 = $$0.readByte()) != 0) {
            String $$4 = e($$0, $$1);
            vo $$5 = ur.a(vr.a($$3), $$4, $$0, $$1);
            if ($$2.put($$4, $$5) == null) {
               $$1.b(36L);
            }
         }
      ...
      private static String e(DataInput $$0, va $$1) throws IOException {
         String $$2 = $$0.readUTF();
         $$1.b(28L);
   ...
   public int a() {
      ...
      for (Entry<String, vo> $$1 : this.x.entrySet()) {
   ...
   public UUID a(String $$0) {
      return vg.a(this.c($$0));
   }

   public boolean b(String $$0) {
      vo $$1 = this.c($$0);
      return $$1 != null && $$1.c() == uv.a && ((uv)$$1).g().length == 4;
   }
   ...
   public byte[] m(String $$0) {
      try {
         if (this.b($$0, 7)) {
            return ((uo)this.x.get($$0)).e();
         }
      } catch (ClassCastException var3) {
         throw new y(this.a($$0, uo.a, var3));
      }
   ...
   public int[] n(String $$0) {
      try {
         ...
         throw new y(this.a($$0, uv.a, var3));
      }
   ...
   public long[] o(String $$0) {
      try {
         if (this.b($$0, 12)) {
            return ((uy)this.x.get($$0)).g();
         }
      } catch (ClassCastException var3) {
         throw new y(this.a($$0, uy.a, var3));
      }

      return new long[0];
   }

   public ur p(String $$0) {
      try {
         if (this.b($$0, 10)) {
            return (ur)this.x.get($$0);
         }
      } catch (ClassCastException var3) {
   ...
   public ux c(String $$0, int $$1) {
      try {
         if (this.d($$0) == 9) {
            ux $$2 = (ux)this.x.get($$0);
            if (!$$2.isEmpty() && $$2.f() != $$1) {
               return new ux();
            }
         ...
         throw new y(this.a($$0, ux.a, var4));
      }
   ...
   private o a(String $$0, vq<?> $$1, ClassCastException $$2) {
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof ur && Objects.equals(this.x, ((ur)$$0).x);
   }
   ...
   private static void a(String $$0, vo $$1, DataOutput $$2) throws IOException {
      $$2.writeByte($$1.b());
      if ($$1.b() != 0) {
         $$2.writeUTF($$0);
         $$1.a($$2);
   ...
   static vo a(vq<?> $$0, String $$1, DataInput $$2, va $$3) {
      try {
         return $$0.c($$2, $$3);
