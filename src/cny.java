...
public class cny {
   ...
   public void a(ard $$0, Predicate<bul> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
   ...
   @VisibleForTesting
   protected static record a(cny a) implements Comparator<bul> {
