...
public class cny extends cpe implements cop {
   public static final float a = 0.03F;
   boolean bJ;
   protected final cgv b;
   protected final cgs c;

   public cny(bwr<? extends cny> $$0, djh $$1) {
      super($$0, $$1);
      this.bA = new cny.d(this);
      this.a(exm.j, 0.0F);
   ...
   public static byo.a j() {
      return cpe.gu().a(byp.B, 1.0);
   }

   @Override
   protected void m() {
      this.bD.a(1, new cny.c(this, 1.0));
      this.bD.a(2, new cny.f(this, 1.0, 40, 10.0F));
      this.bD.a(2, new cny.a(this, 1.0, false));
      this.bD.a(5, new cny.b(this, 1.0));
      this.bD.a(6, new cny.e(this, 1.0, this.dU().P()));
      this.bD.a(7, new cfc(this, 1.0));
      this.bE.a(1, new cfx(this, cny.class).a(cpg.class));
      this.bE.a(2, new cfy<>(this, crj.class, 10, true, false, ($$0, $$1) -> this.i($$0)));
      this.bE.a(3, new cfy<>(this, cqq.class, false));
      this.bE.a(3, new cfy<>(this, cjp.class, true));
      this.bE.a(3, new cfy<>(this, ckr.class, true, false));
   ...
   public static boolean a(bwr<cny> $$0, djy $$1, bwq $$2, iv $$3, azv $$4) {
   ...
   protected void a(azv $$0, bue $$1) {
      if ((double)$$0.i() > 0.9) {
         int $$2 = $$0.a(16);
         if ($$2 < 10) {
            this.a(bws.a, new czk(czo.xd));
         } else {
            this.a(bws.a, new czk(czo.sd));
         }
      }
   }
   ...
   protected boolean a(czk $$0, czk $$1, bws $$2) {
      return $$1.a(czo.xe) ? false : super.a($$0, $$1, $$2);
   }
   ...
   public void a(bxj $$0, float $$1) {
      czk $$2 = this.fa();
      czk $$3 = $$2.a(czo.xd) ? $$2 : new czk(czo.xd);
      css $$4 = new css(this.dU(), this, $$3);
      double $$5 = $$0.dz() - this.dz();
      double $$6 = $$0.e(0.3333333333333333) - $$4.dB();
      double $$7 = $$0.dF() - this.dF();
      double $$8 = Math.sqrt($$5 * $$5 + $$7 * $$7);
      if (this.dU() instanceof arq $$9) {
         cse.a($$4, $$9, $$3, $$5, $$6 + $$8 * 0.2F, $$7, 1.6F, (float)(14 - this.dU().an().a() * 4));
      }
   ...
   static class a extends cfu {
      ...
      public a(cny $$0, double $$1, boolean $$2) {
         super($$0, $$1, $$2);
         this.b = $$0;
      }
   ...
   static class e extends cef {
      ...
      public void a() {
         if (this.a.dB() < (double)(this.c - 1) && (this.a.O().k() || this.a.gt())) {
            fex $$0 = cic.a(this.a, 4, 8, new fex(this.a.dz(), (double)(this.c - 1), this.a.dF()), (float) (Math.PI / 2));
            if ($$0 == null) {
               this.d = true;
               return;
            }
   ...
   static class f extends cfe {
      ...
      public f(cop $$0, double $$1, int $$2, float $$3) {
         super($$0, $$1, $$2, $$3);
         this.a = (cny)$$0;
      }
      ...
      @Override
      public boolean b() {
         return super.b() && this.a.fa().a(czo.xd);
      }
