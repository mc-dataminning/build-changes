...
public class ftu extends ftp<bux, ffj<bux>> {
   private static final Map<bux.a, aep> a = ac.a(Maps.newEnumMap(bux.a.class), $$0 -> {
      $$0.put(bux.a.a, new aep("textures/entity/panda/panda.png"));
      $$0.put(bux.a.b, new aep("textures/entity/panda/lazy_panda.png"));
      $$0.put(bux.a.c, new aep("textures/entity/panda/worried_panda.png"));
      $$0.put(bux.a.d, new aep("textures/entity/panda/playful_panda.png"));
      $$0.put(bux.a.e, new aep("textures/entity/panda/brown_panda.png"));
      $$0.put(bux.a.f, new aep("textures/entity/panda/weak_panda.png"));
      $$0.put(bux.a.g, new aep("textures/entity/panda/aggressive_panda.png"));
   });

   public ftu(fsj.a $$0) {
      super($$0, new ffj<>($$0.a(fhi.az)), 0.9F);
      this.a(new fwn(this, $$0.d()));
   }

   public aep a(bux $$0) {
      return a.getOrDefault($$0.gl(), a.get(bux.a.a));
   }

   protected void a(bux $$0, elh $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(aro.i($$24, $$0.dC(), $$0.dC() + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(aro.i($$26, $$0.dC(), $$0.dC() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? aro.i($$3, $$0, $$1) : $$0;
   }
}
