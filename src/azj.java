...
public class azj {
   ...
   private static final Optional<Object> b = Optional.of(azs.a);

   private static boolean a(xw $$0, ayb $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xw $$1, ayb $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xw $$1, ayb $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xw $$1, ayb $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xw $$2, ayb $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xw $$2, xw $$3, ayb $$4) {
      int $$5 = $$0.length();
      xw $$6 = $$2;
   ...
   public static boolean a(xe $$0, xw $$1, ayb $$2) {
