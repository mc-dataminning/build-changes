...
public abstract class azj extends DataFix {
   private final String a;

   public azj(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(ayz.v.typeName(), bah.a());
      if (!Objects.equals(this.getOutputSchema().getType(ayz.v), $$2)) {
