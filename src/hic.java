public class hic extends hhs {
   ...
   public void q() {
      if (this.s.dR()) {
         ...
         boolean $$1 = !this.s.cq() && this.s.l() instanceof crj;
         if ($$0 >= 0.01F && this.s.dW().u().i() && !$$1) {
            this.t = ayy.a(this.t + 0.0025F, 0.0F, 1.0F);
            this.d = ayy.h(ayy.a($$0, 0.0F, 0.5F), 0.0F, 0.7F);
         } else {
            this.t = 0.0F;
            this.d = 0.0F;
         }
