...
public class bur {
   ...
   private final List<bup> d = Lists.newArrayList();
   private final bxe e;
   private int f;
   private int g;
   private int h;
   ...
   public void a(buu $$0, float $$1) {
      this.c();
      buz $$2 = buz.a(this.e);
      bup $$3 = new bup($$0, $$1, $$2, (float)this.e.Z);
      this.d.add($$3);
      this.f = this.e.af;
      this.j = true;
   ...
   private static boolean a(buu $$0) {
      return $$0.d() instanceof bxe;
   }

   private wy a(bwf $$0, wy $$1, String $$2, String $$3) {
      czd $$5 = $$0 instanceof bxe $$4 ? $$4.fb() : czd.k;
      return !$$5.f() && $$5.c(kj.g) ? wy.a($$2, this.e.m_(), $$1, $$5.K()) : wy.a($$3, this.e.m_(), $$1);
   }

   private wy a(bup $$0, @Nullable bwf $$1) {
      buu $$2 = $$0.a();
      if (!$$2.a(axd.m) && !$$2.a(axd.s)) {
         ...
         buz $$3 = Objects.requireNonNullElse($$0.c(), buz.a);
         return wy.a($$3.a(), this.e.m_());
      }
   }

   @Nullable
   private static wy a(@Nullable bwf $$0) {
   ...
   public wy a() {
      if (this.d.isEmpty()) {
         ...
         bup $$0 = this.d.get(this.d.size() - 1);
         buu $$1 = $$0.a();
         bup $$2 = this.d();
         buy $$3 = $$1.k().e();
         if ($$3 == buy.b && $$2 != null) {
