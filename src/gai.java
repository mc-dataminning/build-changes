...
public class gai extends qr {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gai(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gai a(ant $$0, List<String> $$1, boolean $$2) {
      ...
      return new gai(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<anr> $$1, Map<String, String> $$2) {
      for (anr $$3 : $$1) {
