...
public enum gai implements gap {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, gai> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (gai)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static gai a(int $$0, int $$1) {
      return r.get(b(aro.b($$0, 360), aro.b($$1, 360)));
   }
