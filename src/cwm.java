...
public class cwm {
   private final Map<aku, cwm.a> a = Maps.newHashMap();
   private int b;
   ...
   public float a(cwp $$0, float $$1) {
      aku $$2 = this.b($$0);
      cwm.a $$3 = this.a.get($$2);
      if ($$3 != null) {
   ...
   public void a() {
      this.b++;
      if (!this.a.isEmpty()) {
         Iterator<Entry<aku, cwm.a>> $$0 = this.a.entrySet().iterator();

         while ($$0.hasNext()) {
            Entry<aku, cwm.a> $$1 = $$0.next();
   ...
   public void a(aku $$0, int $$1) {
      this.a.put($$0, new cwm.a(this.b, this.b + $$1));
      this.b($$0, $$1);
   }
