...
public class bou implements bov {
   ...
   private static final bou k = new bou();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bot $$0) {
      URL $$1 = bou.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bot $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final box a = new box(() -> bou.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bou.this.l && $$0.getState() == RecordingState.STOPPED) {
