...
public class vu extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<uw> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, ui.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<uw> $$0, Codec<T> $$1, ui $$2) {
      uw $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> vu a(DynamicOps<uw> $$0, Codec<T> $$1, T $$2) {
      uw $$3 = (uw)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = azc.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yx<? super vu, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yy<? super vu, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yx<? super vu, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yx<? super vu, K> $$1, yx<? super vu, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yx<? super vu, K> $$0, yx<? super vu, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yy<? super vu, K> $$1, yy<? super vu, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yy<? super vu, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yx<? super vu, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yx<? super vu, T> $$0) {
      return a(this, $$0);
   }
   ...
   public <T> void a(@Nullable T $$0, yy<? super vu, T> $$1) {
      a(this, $$0, $$1);
   }
   ...
   public vu a(@Nullable uw $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable uw $$1) {
      if ($$1 == null) {
         $$1 = ub.b;
      }
   ...
   @Nullable
   public static uw a(ByteBuf $$0, ui $$1) {
      try {
         uw $$2 = um.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, azm.e($$1, 8)));
      }
   }
