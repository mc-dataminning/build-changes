...
public class vu extends ByteBuf {
   ...
   @Deprecated
   public <T> vu a(DynamicOps<ux> $$0, Codec<T> $$1, T $$2) {
      ux $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = axp.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yt<? super vu, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yu<? super vu, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yt<? super vu, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yt<? super vu, K> $$1, yt<? super vu, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yt<? super vu, K> $$0, yt<? super vu, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yu<? super vu, K> $$1, yu<? super vu, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yu<? super vu, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yt<? super vu, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yt<? super vu, T> $$0) {
      return a(this, $$0);
   }
   ...
   public <T> void a(@Nullable T $$0, yu<? super vu, T> $$1) {
      a(this, $$0, $$1);
   }
   ...
   public static in b(ByteBuf $$0) {
      return in.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, in $$1) {
      $$0.writeLong($$1.a());
   }

   public czk f() {
      return new czk(this.readLong());
   }
   ...
   public etp k() {
      return new etp(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> vu a(ToIntFunction<T> $$0, T $$1) {
   ...
   public vu a(String $$0, int $$1) {
      wk.a(this.d, $$0, $$1);
      return this;
   }

   public akh q() {
      return new akh(this.d(32767));
   }
   ...
   public <T> akg<T> a(akg<? extends jj<T>> $$0) {
      akh $$1 = this.q();
      return akg.a($$0, $$1);
   }
   ...
   public etl v() {
      in $$0 = this.e();
      is $$1 = this.b(is.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new etl(new etp((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, axz.e($$1, 8)));
      }
   }
   ...
   public vu a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vu a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public vu a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vu a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vu a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vu a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public vu a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vu b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public vu c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public vu d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public vu e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public vu f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public vu g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public vu h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public vu a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public vu b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public vu i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public vu a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public vu a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public vu b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vu b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public vu b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vu b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public vu b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public vu b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public vu g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vu b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public vu a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vu a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public vu a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public vu h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public vu c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public vu b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public vu b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public vu b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
