...
public class vu implements vt {
   ...
   private static final xp s = xp.b("<...>").a(n.h);
   ...
   private vu(String $$0, int $$1, int $$2) {
      this.t = $$0;
      this.u = $$1;
      this.v = $$2;
   }
   ...
   public void a(vn $$0) {
      ...
      xp $$3 = xp.b($$1.substring(1, $$1.length() - 1)).a(f);
      this.w = xp.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(uq $$0) {
      xp $$1 = xp.b("b").a(h);
      this.w = xp.b(String.valueOf($$0.l())).b($$1).a(g);
   }
   ...
   @Override
   public void a(ux $$0) {
      this.w = xp.b(String.valueOf($$0.l())).a(g);
   }
   ...
   public void a(uv $$0) {
      xp $$1 = xp.b("f").a(h);
      this.w = xp.b(String.valueOf($$0.k())).b($$1).a(g);
   }

   @Override
   public void a(ut $$0) {
      xp $$1 = xp.b("d").a(h);
      this.w = xp.b(String.valueOf($$0.j())).b($$1).a(g);
   }
   ...
   public void a(up $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         yd $$5 = xp.b(String.valueOf($$3[$$4])).a(g);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(k);
         }
   ...
   public void a(uw $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(xp.b(String.valueOf($$3[$$4])).a(g));
         if ($$4 != $$3.length - 1) {
            $$2.f(k);
         }
      }
   ...
   public void a(uz $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         xp $$5 = xp.b(String.valueOf($$3[$$4])).a(g);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(k);
         }
   ...
   public void a(us $$0) {
      if ($$0.g()) {
         ...
         while ($$5.hasNext()) {
            String $$6 = $$5.next();
            yd $$7 = xp.b($$4).b(a($$6)).f(j).f(" ").b(this.a($$0.c($$6), true));
            if ($$5.hasNext()) {
               $$7.f(k).f(this.t.isEmpty() ? " " : "\n");
            }
   ...
   private xp a(vp $$0, boolean $$1) {
      return new vu(this.t, $$1 ? this.u + 1 : this.u, this.v + 1).a($$0);
   }

   protected static xp a(String $$0) {
      if (i.matcher($$0).matches()) {
         return xp.b($$0).a(e);
      } else {
         String $$1 = vn.b($$0);
         String $$2 = $$1.substring(0, 1);
         xp $$3 = xp.b($$1.substring(1, $$1.length() - 1)).a(e);
         return xp.b($$2).b($$3).f($$2);
      }
   }
