...
public interface eda {
   static eda a(eds $$0, dgg $$1, edu $$2, eeb $$3, int $$4, int $$5, eda.a $$6) {
      return new eda.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static eda a(final eda.a $$0) {
      return new eda() {
         @Nullable
         @Override
         public dxq a(edh.b $$0x, double $$1) {
   ...
   @Nullable
   dxq a(edh.b var1, double var2);

   boolean a();

   public interface a {
      eda.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dxq b) {
   ...
   public static class c implements eda {
      ...
      private final edh p;
      private final eeb q;
      private final eda.b[] r;
      private final long[] s;
      private final eda.a t;
      private final edh u;
      private final edh v;
      private boolean w;
      private final int x;
      ...
      c(eds $$0, dgg $$1, edu $$2, eeb $$3, int $$4, int $$5, eda.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dxq a(edh.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            eda.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dkg.K)) {
               this.w = false;
               return dkg.K.m();
            } else {
      ...
      private double a(edh.b $$0, MutableDouble $$1, eda.b $$2, eda.b $$3) {
         int $$4 = $$0.b();
         dxq $$5 = $$2.a($$4);
         dxq $$6 = $$3.a($$4);
      ...
      private eda.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            eda.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private eda.b b(int $$0, int $$1, int $$2) {
         eda.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               eda.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new eda.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, eda.b $$3, int $$4, boolean $$5) {
         edh.e $$6 = new edh.e($$0, $$1, $$2);
         double $$7;
         double $$8;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new edh.e($$6, $$7, $$8)) * 10.0;
         int $$12 = ayz.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dxq a(int $$0, int $$1, int $$2, eda.b $$3, int $$4) {
         dxq $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != ebm.g && $$3.b != dkg.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new edh.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dkg.K.m();
            }
         }
