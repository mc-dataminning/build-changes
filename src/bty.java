...
public abstract class bty extends cer implements btj {
   protected static final ajp<Byte> ca = ajt.a(bty.class, ajr.a);
   protected static final ajp<Optional<UUID>> cb = ajt.a(bty.class, ajr.r);
   private boolean cd;

   protected bty(bsm<? extends bty> $$0, dcf $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(bqz $$0) {
      if (!this.dQ().B && this.dQ().ab().b(dcb.n) && this.P_() instanceof aqn) {
         this.P_().a(this.eM().a());
      }
