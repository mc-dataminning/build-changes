...
public class ehs {
   ...
   private final ehs.a g;

   @Deprecated
   public static ehs a(axd $$0, ehs.a $$1) {
      return new ehs($$0, $$1, false);
   }

   public static ehs a(axd $$0, int $$1, double... $$2) {
      return b($$0, new ehs.a($$1, new DoubleArrayList($$2)));
   }

   public static ehs b(axd $$0, ehs.a $$1) {
      return new ehs($$0, $$1, true);
   }

   private ehs(axd $$0, ehs.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ehs.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ehs.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ehs.a::b))
               .apply($$0, ehs.a::new)
      );
      public static final Codec<il<ehs.a>> b = ajd.a(kj.aC, a);
