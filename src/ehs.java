...
public class ehs implements ehn {
   protected static final ehn a = new ehs(false, -Double.MAX_VALUE, cja.b, $$0 -> false, null) {
      @Override
      public boolean a(eib $$0, gw $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected ehs(boolean $$0, double $$1, cja $$2, Predicate<eah> $$3, @Nullable bil $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected ehs(bil $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bil.bV ()Z
      // 05: aload 1
      // 06: invokevirtual bil.dr ()D
      // 09: aload 1
      // 0a: instanceof bjb
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast bjb
      // 14: invokevirtual bjb.eR ()Lcja;
      // 17: goto 1d
      // 1a: getstatic cja.b Lcja;
      // 1d: aload 1
      // 1e: instanceof bjb
      // 21: ifeq 35
      // 24: aload 1
