...
public class dmo extends dmr<dmn> {
   public dmo(Codec<dmn> $$0) {
      super($$0);
   }

   public boolean a(dmn $$0, ash $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dmm $$0, dmn $$1, dgz $$2, Function<gw, he<cqz>> $$3, ash $$4, djy $$5, cpi $$6, dgy $$7) {
      int $$8 = hw.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dmr.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dmm $$0, dmn $$1, dgz $$2, Function<gw, he<cqz>> $$3, djy $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dgy $$10, dmr.a $$11
   ) {
      double $$12 = 1.5 + (double)(asb.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(asb.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = asb.b($$13);
         $$6 += (double)(asb.b($$12) * $$27);
         $$7 += (double)asb.a($$13);
         $$8 += (double)(asb.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
