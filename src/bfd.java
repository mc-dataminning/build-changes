...
public class bfd extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(biz.F.typeName(), bku.a()));
      ...
      return this.fixTypeEverywhereTyped("ItemStack bucket_entity_data variants to separate components", $$0, $$2x -> {
         ...
         return switch ($$3) {
            case "minecraft:salmon_bucket" -> $$2x.updateTyped($$2, bfd::c);
            case "minecraft:axolotl_bucket" -> $$2x.updateTyped($$2, bfd::b);
            case "minecraft:tropical_fish_bucket" -> $$2x.updateTyped($$2, bfd::a);
            case "minecraft:painting" -> $$2x.updateTyped($$2, $$0xx -> ag.a($$0xx, $$0xx.getType(), bfd::a));
            default -> $$2x;
         };
      });
   }
