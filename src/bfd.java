...
public abstract class bfd extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Pair<String, String>> $$0 = DSL.named(bhm.D.typeName(), biz.a());
      if (!Objects.equals(this.getInputSchema().getType(bhm.D), $$0)) {
