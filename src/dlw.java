...
public class dlw {
   private static final dlw a = new dlw(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dlw.a a(int $$0, int $$1) {
         return new dlw.a(1.0, 0.0);
      }
   ...
   private static final dzr b = dzr.b(new dlv(42L), nx.a);
   ...
   private final Long2ObjectOpenHashMap<dlx> h;
   private final Long2ObjectOpenHashMap<dlx> i;

   public static dlw a() {
      return a;
   }

   public static dlw a(@Nullable akz $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cpe $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dlx> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dlx> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ary.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dlw($$2, $$3);
         }
      }
   }

   dlw(Long2ObjectOpenHashMap<dlx> $$0, Long2ObjectOpenHashMap<dlx> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dlw.a a(int $$0, int $$1) {
      int $$2 = hs.a($$0);
      int $$3 = hs.a($$1);
      double $$4 = this.a($$2, 0, $$3, dlx::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dlw.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(hs.d(cpe.a($$5x)), hs.d(cpe.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = ary.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = ary.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dlw.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dkn.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(hs.d(cpe.a($$6x)), hs.d(cpe.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = ary.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = ary.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return ary.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dlw.b $$3) {
      int $$4 = hs.e($$0);
      int $$5 = hs.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dlw.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dlx $$6 = (dlx)this.h.get(cpe.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - hs.d($$1), $$4, $$5 - hs.d($$2)) : Double.MAX_VALUE;
   }

   public cqy a(cqy $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         hg<cqv> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private hg<cqv> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<hg<cqv>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(hs.d(cpe.a($$5x)), $$1, hs.d(cpe.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = ary.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = ary.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (hg)$$4.getValue();
      }
   }

   public static void a(akz $$0, dhh $$1) {
      cpe $$2 = $$1.f();
      boolean $$3 = $$1.s();
      gw.a $$4 = new gw.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dku.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dhh $$0, gw $$1) {
      dfl $$2 = $$0.a_($$1);
      if ($$2.a(apu.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cqr $$0, dic $$1) {
      cpe $$2 = $$1.f();
      Builder<hd, dlx> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dkq.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dlw.c a(@Nullable dlx $$0, Map<hd, dlx> $$1) {
      List<dlw.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dlw.c a(@Nullable hd $$0, dlx $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (hc $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return ary.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dlx var1, int var2, int var3, int var4);
   }
