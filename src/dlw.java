...
public class dlw {
   ...
   private final int j;
   private final int k;
   private List<dlw.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public dlw(boolean $$0, axf<dfb> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public void a(us $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<dlw.a> $$1 = (List<dlw.a>)dlw.a.b.listOf().parse(new Dynamic(vg.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(us $$0) {
      dlw.a.b.listOf().encodeStart(vg.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(iz $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dlw.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dlw.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(dcb $$0, iz $$1, azh $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<dlw.a> $$4 = new ArrayList<>();
         Map<iz, dlw.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dlw.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  iz.a.fieldOf("pos").forGetter(dlw.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dlw.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dlw.a::c),
      ...
      private boolean a(dcb $$0, iz $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dcb $$0, iz $$1, azh $$2, dlw $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static dlr a(dse $$0) {
         return $$0.b() instanceof dlr $$1 ? $$1 : dlr.s_;
      }
      ...
      @Nullable
      private static iz a(dcb $$0, iz $$1, azh $$2) {
         iz.a $$3 = $$1.j();
         iz.a $$4 = $$1.j();
      ...
      private static boolean a(dcb $$0, iz $$1, iz $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            iz $$3 = $$2.b($$1);
      ...
      private static boolean a(dcb $$0, iz $$1, je $$2) {
         iz $$3 = $$1.a($$2);
