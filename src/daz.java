...
public abstract class daz {
   ...
   public void a(bsz<?> $$0, @Nullable dbx $$1, azg $$2, iz $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!buk.a($$7.get(), $$0, bts.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dwi.b($$15.getClass()),
                        new evl((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsy.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof btq $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bts.c) || !$$17.a($$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((btq)$$15).a($$0, $$0.d_($$15.dp()), bts.c, null);
                     }
   ...
   private void d(dbx $$0, iz $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dco)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dbx $$0, iz $$1, ur $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dco $$4 = dco.b.parse(vf.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dco::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dco.c.parse(vf.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bpd::b);
      } else {
         this.e = bpd.a(this.f != null ? this.f : new dco());
      }
   ...
   public ur a(ur $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vo)dco.b.encodeStart(vf.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vo)dco.c.encodeStart(vf.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bst b(dbx $$0, iz $$1) {
      if (this.l == null) {
         ...
         this.l = bsz.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof btq) {
         }
      }
   ...
   protected void a(@Nullable dbx $$0, iz $$1, dco $$2) {
      this.f = $$2;
   }

   private dco a(@Nullable dbx $$0, azg $$1, iz $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bpf.b::b).orElseGet(dco::new));
         return this.f;
      }
   }

   public abstract void a(dbx var1, iz var2, int var3);
