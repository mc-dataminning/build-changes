...
public class to {
   ...
   private iz c;
   private final arf d;
   private final Collection<tp> e = Lists.newArrayList();
   private final int f;
   private final Collection<ts> g = Lists.newCopyOnWriteArrayList();
   ...
   public to(ui $$0, dlo $$1, arf $$2, ub $$3) {
      this.a = $$0;
      this.d = $$2;
      this.o = $$3;
      this.f = $$0.f();
   ...
   public void a(tr $$0) {
      if (!this.j()) {
         ...
         if (this.l || ue.b(this.t).b().allMatch($$0x -> this.d.f($$0x.l()))) {
            this.l = true;
            if (this.C()) {
               this.D();
               if (this.j()) {
   ...
   private void D() {
      ...
      if (this.m >= 0L) {
         ...
         if (this.m > (long)this.f) {
            if (this.g.isEmpty()) {
               this.a(new tv("Didn't succeed or fail within " + this.a.f() + " ticks"));
            } else {
               this.g.forEach($$0x -> $$0x.b(this.m));
               if (this.s == null) {
                  this.a(new tv("No sequences finished"));
               }
            }
         } else {
   ...
   public void l() {
      if (this.s == null) {
         this.F();
         evo $$0 = this.d();
         List<bsw> $$1 = this.f().a(bsw.class, $$0.g(1.0), $$0x -> !($$0x instanceof cmz));
         $$1.forEach($$0x -> $$0x.a(bsw.c.b));
      }
   }
   ...
   public to n() {
      iz $$0 = this.G();
      this.t = ue.a(this, $$0, this.t(), this.d);
      this.b = this.t.ay_();
      ue.a(this.b, new iz(1, 0, -1), this.t(), this.d);
      ue.a(this.d(), this.d, !this.a.l());
   ...
   public to B() {
      to $$0 = new to(this.a, this.r, this.d, this.z());
      if (this.c != null) {
         $$0.b(this.c);
      }
