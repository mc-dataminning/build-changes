...
public class bvd extends buh {
   private static final adz<Integer> e = aec.a(bvd.class, aeb.b);
   int bT;
   int bU;
   private static final Predicate<biy> bV = $$0 -> $$0 instanceof cbn && ((cbn)$$0).f() ? false : $$0.ag() == bim.f || $$0.eQ() != bjd.e;
   static final btl bW = btl.b().e().d().a(bV);
   public static final int b = 0;
   public static final int c = 1;
   public static final int d = 2;

   public bvd(bim<? extends bvd> $$0, cpm $$1) {
      super($$0, $$1);
      this.e_();
   }
   ...
   @Override
   public ciy b() {
      return new ciy(cjb.pR);
   }

   @Override
   protected void w() {
      super.w();
      this.bO.a(1, new bvd.a(this));
   }
   ...
   static class a extends bpu {
      ...
      @Override
      public boolean a() {
         List<biy> $$0 = this.a.dK().a(biy.class, this.a.cG().g(2.0), $$0x -> bvd.bW.a(this.a, $$0x));
         return !$$0.isEmpty();
      }
