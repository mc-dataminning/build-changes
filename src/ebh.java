...
public final class ebh extends ebk<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private ebh(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ebh $$1 && super.equals($$0)) {
   ...
   public static ebh a(String $$0, int $$1, int $$2) {
      return new ebh($$0, $$1, $$2);
   }
