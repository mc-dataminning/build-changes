...
public abstract class cei extends cdv {
   ...
   public cei(bxh $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cei(bxh $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cdv.a.a, cdv.a.c));
   }
   ...
   protected abstract boolean a(dis var1, iu var2);
}
