...
public class bkt implements bku {
   ...
   private static final bkt k = new bkt();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bks $$0) {
      URL $$1 = bkt.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bks $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bkw a = new bkw(() -> bkt.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bkt.this.l && $$0.getState() == RecordingState.STOPPED) {
