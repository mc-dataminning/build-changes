...
public class bkt extends bkx {
   public static final Codec<bkt> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bkt a(float $$0, float $$1, float $$2, float $$3) {
      return new bkt($$0, $$1, $$2, $$3);
   }

   private bkt(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(awo $$0, float $$1, float $$2, float $$3, float $$4) {
      return awh.a(awh.c($$0, $$1, $$2), $$3, $$4);
   }
