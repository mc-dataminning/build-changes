...
public class eln implements AutoCloseable {
   ...
   private elp a(elf.a $$0, ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(elf.a $$0, ByteBuffer $$1) {
      if (!$$0.m()) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, fom $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, fom $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == elp.b.a || this.i == elp.b.b)) {
