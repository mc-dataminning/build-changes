...
public class giy {
   ...
   public gir a(Vector3f $$0, Vector3f $$1, git $$2, gxg $$3, jk $$4, gzu $$5, @Nullable giu $$6, boolean $$7, int $$8) {
      giv $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      $$9.a[0] = azf.h($$11, $$9.a[0], $$12);
      $$9.a[2] = azf.h($$11, $$9.a[2], $$12);
      $$9.a[1] = azf.h($$11, $$9.a[1], $$13);
      $$9.a[3] = azf.h($$11, $$9.a[3], $$13);
      ...
      return new gir($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static giv a(giv $$0, jk $$1, j $$2) {
      Matrix4f $$3 = je.a($$2, $$1).c();
      float $$4 = $$0.a($$0.c(0));
      float $$5 = $$0.b($$0.c(0));
      ...
      Vector3f $$24 = $$23.transform(new Vector3f(azf.b($$22), azf.a($$22), 0.0F));
      int $$25 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$24.y(), (double)$$24.x())) / 90.0)) * 90, 360);
      return new giv(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(giv $$0, gxg $$1, jk $$2, float[] $$3, j $$4, @Nullable giu $$5) {
      int[] $$6 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[jk.values().length];
      $$2[ggy.a.f] = $$0.x() / 16.0F;
      $$2[ggy.a.e] = $$0.y() / 16.0F;
      $$2[ggy.a.d] = $$0.z() / 16.0F;
      $$2[ggy.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, jk $$2, giv $$3, float[] $$4, gxg $$5, j $$6, @Nullable giu $$7) {
      ggy.b $$8 = ggy.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gxg $$3, giv $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable giu $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static jk a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? jk.b : $$7;
      }
   }

   private void a(int[] $$0, jk $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[jk.values().length];
      $$3[ggy.a.f] = 999.0F;
      $$3[ggy.a.e] = 999.0F;
      $$3[ggy.a.d] = 999.0F;
      $$3[ggy.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (azf.a($$13, $$18) && azf.a($$14, $$19) && azf.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
