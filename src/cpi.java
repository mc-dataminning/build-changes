...
public class cpi extends bul implements bwg {
   ...
   public cpi(bus<? extends cpi> $$0, dgi $$1) {
      super($$0, $$1);
   }

   public cpi(dgi $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bvh $$6) {
      this(bus.T, $$0);
      this.d = $$5;
      this.a($$6);
