...
public abstract class cpi {
   ...
   private final js<cud> l = js.a();
   public final js<cre> i = js.a();
   private final List<cqb> m = Lists.newArrayList();
   private cud n = cud.l;
   private final js<cud> o = js.a();
   ...
   private final List<cpv> w = Lists.newArrayList();
   @Nullable
   private cpw x;
   private boolean y;

   protected cpi(@Nullable cqq<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cpu $$0, cml $$1, dfi $$2) {
   ...
   protected static void a(bqa $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cpt $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cqb a(cqb $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(cpt $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cqb.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cud $$1 = this.i.get($$0).g();
         Supplier<cud> $$2 = Suppliers.memoize($$1::s);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cud $$1, Supplier<cud> $$2) {
      cud $$3 = this.l.get($$0);
      if (!cud.a($$3, $$1)) {
         cud $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cud $$1, Supplier<cud> $$2) {
      if (!this.y) {
         cud $$3 = this.o.get($$0);
         if (!cud.a($$3, $$1)) {
            cud $$4 = $$2.get();
   ...
   public abstract cud b(cml var1, int var2);

   public void a(int $$0, int $$1, cps $$2, cml $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cps $$2, cml $$3) {
      cmk $$4 = $$3.ga();
      if ($$2 == cps.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cps.a || $$2 == cps.b) && ($$1 == 0 || $$1 == 1)) {
         cpr $$16 = $$1 == 0 ? cpr.a : cpr.b;
         if ($$0 == -999) {
            if (!this.g().e()) {
               if ($$16 == cpr.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.e()) {
                  if (!$$21.e()) {
                     int $$22 = $$16 == cpr.a ? $$21.H() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.e()) {
                     int $$23 = $$16 == cpr.a ? $$20.H() : ($$20.H() + 1) / 2;
                     Optional<cud> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cud> $$26 = $$19.a($$20.H(), $$21.j() - $$21.H(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.H());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cps.d && $$3.fN() && this.g().e() && $$0 >= 0) {
         cre $$32 = this.i.get($$0);
         if ($$32.h()) {
            cud $$33 = $$32.g();
            this.b($$33.c($$33.j()));
         }
      } else if ($$2 == cps.e && this.g().e() && $$0 >= 0) {
         cre $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().H();
         cud $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cps.g && $$0 >= 0) {
         cre $$37 = this.i.get($$0);
         cud $$38 = this.g();
   ...
   private boolean a(cml $$0, cpr $$1, cre $$2, cud $$3, cud $$4) {
      coz $$5 = $$0.dR().J();
   ...
   public void a(int $$0, int $$1, cud $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cud> $$1, cud $$2) {
   ...
   public abstract boolean b(cml var1);

   protected boolean a(cud $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cml $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cre $$0, cud $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cud.c($$1, $$0.g()) ? $$0.g().H() + ($$2 ? 0 : $$1.H()) <= $$1.j() : $$3;
   }

   public static int a(Set<cre> $$0, int $$1, cud $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dpq $$0) {
      return $$0 instanceof bqa ? b((bqa)$$0) : 0;
   }

   public static int b(@Nullable bqa $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cpi $$0) {
      Table<bqa, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bqa $$0, int $$1) {
