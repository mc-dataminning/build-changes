...
public class elf {
   ...
   static class a implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         return $$0.c[jf.f.d()] && !$$0.b[jf.f.d()].d;
      }

      @Override
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         $$1.d = true;
         $$1.b[jf.f.d()].d = true;
         return new elf.k($$0, $$1);
      }
   }

   static class b implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         if ($$0.c[jf.f.d()] && !$$0.b[jf.f.d()].d && $$0.c[jf.b.d()] && !$$0.b[jf.b.d()].d) {
            elf.v $$1 = $$0.b[jf.f.d()];
            return $$1.c[jf.b.d()] && !$$1.b[jf.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         ...
         $$1.b[jf.f.d()].d = true;
         $$1.b[jf.b.d()].d = true;
         $$1.b[jf.f.d()].b[jf.b.d()].d = true;
         return new elf.l($$0, $$1);
      }
   }

   static class c implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         return $$0.c[jf.b.d()] && !$$0.b[jf.b.d()].d;
      }
      ...
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         $$1.d = true;
         $$1.b[jf.b.d()].d = true;
         return new elf.m($$0, $$1);
      }
   }

   static class d implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         if ($$0.c[jf.c.d()] && !$$0.b[jf.c.d()].d && $$0.c[jf.b.d()] && !$$0.b[jf.b.d()].d) {
            elf.v $$1 = $$0.b[jf.c.d()];
            return $$1.c[jf.b.d()] && !$$1.b[jf.b.d()].d;
         } else {
            return false;
      ...
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         ...
         $$1.b[jf.c.d()].d = true;
         $$1.b[jf.b.d()].d = true;
         $$1.b[jf.c.d()].b[jf.b.d()].d = true;
         return new elf.n($$0, $$1);
      }
   }

   static class e implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         return $$0.c[jf.c.d()] && !$$0.b[jf.c.d()].d;
      }

      @Override
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         elf.v $$3 = $$1;
         if (!$$1.c[jf.c.d()] || $$1.b[jf.c.d()].d) {
            $$3 = $$1.b[jf.d.d()];
         }

         $$3.d = true;
         $$3.b[jf.c.d()].d = true;
         return new elf.o($$0, $$3);
      }
   }

   static class f implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         return true;
      }
      ...
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         $$1.d = true;
         return new elf.s($$0, $$1, $$2);
      }
   }

   static class g implements elf.i {
      @Override
      public boolean a(elf.v $$0) {
         return !$$0.c[jf.e.d()] && !$$0.c[jf.f.d()] && !$$0.c[jf.c.d()] && !$$0.c[jf.d.d()] && !$$0.c[jf.b.d()];
      }

      @Override
      public elf.r a(jf $$0, elf.v $$1, ayo $$2) {
         $$1.d = true;
         return new elf.t($$0, $$1);
      }
   }

   public static class h extends elf.r {
      ...
      private elf.v G;
      private elf.v H;
      private final List<elf.r> I = Lists.newArrayList();

      public h(ayo $$0, int $$1, int $$2, jf $$3) {
         super(ejn.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<elf.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new elf.p($$3, this.G));
         this.I.add(new elf.j($$3, this.H));
         List<elf.i> $$5 = Lists.newArrayList();
         $$5.add(new elf.b());
         $$5.add(new elf.d());
         $$5.add(new elf.e());
         $$5.add(new elf.a());
         ...
         eio $$10 = eio.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eio $$11 = eio.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eio $$12 = eio.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new elf.u($$3, $$10, $$13++));
         this.I.add(new elf.u($$3, $$11, $$13++));
         this.I.add(new elf.q($$3, $$12));
      }
      ...
      private List<elf.v> b(ayo $$0) {
         elf.v[] $$1 = new elf.v[75];
         ...
         elf.v $$23 = new elf.v(1003);
         elf.v $$24 = new elf.v(1001);
         elf.v $$25 = new elf.v(1002);
         $$1[v].a(jf.b, $$23);
         $$1[w].a(jf.d, $$24);
         $$1[x].a(jf.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jf.f.d()].d = true;
         this.H.b[jf.c.d()].d = true;
         this.H.b[jf.f.d()].b[jf.c.d()].d = true;
         this.H.b[jf.b.d()].d = true;
         this.H.b[jf.f.d()].b[jf.b.d()].d = true;
         this.H.b[jf.c.d()].b[jf.b.d()].d = true;
         this.H.b[jf.f.d()].b[jf.c.d()].b[jf.b.d()].d = true;
         ObjectArrayList<elf.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, ddb $$2, ayo $$3, eio $$4) {
         int $$5 = 24;
      ...
      private void a(ddb $$0, ayo $$1, eio $$2) {
      ...
      private void b(ddb $$0, ayo $$1, eio $$2) {
      ...
      private void c(ddb $$0, ayo $$1, eio $$2) {
      ...
      private void d(ddb $$0, ayo $$1, eio $$2) {
      ...
      private void e(ddb $$0, ayo $$1, eio $$2) {
      ...
      private void f(ddb $$0, ayo $$1, eio $$2) {
   ...
   interface i {
      boolean a(elf.v var1);

      elf.r a(jf var1, elf.v var2, ayo var3);
   }

   public static class j extends elf.r {
      public j(jf $$0, elf.v $$1) {
         super(ejn.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(ddb $$0, dcz $$1, duh $$2, ayo $$3, eio $$4, dbm $$5, ja $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfj.ch.o(), dfj.ch.o(), false);
   ...
   public static class k extends elf.r {
      public k(jf $$0, elf.v $$1) {
         super(ejn.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(ddb $$0, dcz $$1, duh $$2, ayo $$3, eio $$4, dbm $$5, ja $$6) {
         elf.v $$7 = this.B.b[jf.f.d()];
         elf.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jf.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jf.a.d()]);
         }
   ...
   public static class l extends elf.r {
      public l(jf $$0, elf.v $$1) {
         super(ejn.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends elf.r {
      public m(jf $$0, elf.v $$1) {
         super(ejn.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(ddb $$0, dcz $$1, duh $$2, ayo $$3, eio $$4, dbm $$5, ja $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jf.a.d()]);
         }

         elf.v $$7 = this.B.b[jf.b.d()];
         if ($$7.b[jf.b.d()] == null) {
   ...
   public static class n extends elf.r {
      public n(jf $$0, elf.v $$1) {
         super(ejn.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(ddb $$0, dcz $$1, duh $$2, ayo $$3, eio $$4, dbm $$5, ja $$6) {
         elf.v $$7 = this.B.b[jf.c.d()];
         elf.v $$8 = this.B;
         elf.v $$9 = $$7.b[jf.b.d()];
         elf.v $$10 = $$8.b[jf.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jf.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jf.a.d()]);
         }
   ...
   public static class o extends elf.r {
      public o(jf $$0, elf.v $$1) {
         super(ejn.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends elf.r {
      public p(jf $$0, elf.v $$1) {
         super(ejn.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends elf.r {
      public q(jf $$0, eio $$1) {
         super(ejn.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eja {
      protected static final dsk b = dfj.hZ.o();
      protected static final dsk c = dfj.ia.o();
      protected static final dsk d = dfj.ib.o();
      protected static final dsk h = c;
      protected static final dsk i = dfj.ii.o();
      protected static final boolean j = true;
      protected static final dsk k = dfj.G.o();
      protected static final Set<dfh> l = ImmutableSet.builder().add(dfj.dO).add(dfj.iC).add(dfj.mW).add(k.b()).build();
      ...
      public r(ejn $$0, jf $$1, int $$2, eio $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ejn $$0, int $$1, jf $$2, elf.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eio a(jf $$0, elf.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eio $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(ddb $$0, eio $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsk $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.z_() && $$11 != k) {
                        this.a($$0, dfj.a.o(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(ddb $$0, eio $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(ddb $$0, eio $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsk $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eio $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(ddb $$0, eio $$1, int $$2, int $$3, int $$4) {
         ja $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjf $$6 = bsm.D.a((dcf)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eO());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dq()), btf.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends elf.r {
      private int a;

      public s(jf $$0, elf.v $$1, ayo $$2) {
         super(ejn.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(ddb $$0, dcz $$1, duh $$2, ayo $$3, eio $$4, dbm $$5, ja $$6) {
         ...
         if (this.B.b[jf.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jf.a.d()] && !this.B.c[jf.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends elf.r {
      public t(jf $$0, elf.v $$1) {
         super(ejn.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends elf.r {
      private int a;

      public u(jf $$0, eio $$1, int $$2) {
         super(ejn.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
