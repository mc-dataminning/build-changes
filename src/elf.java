...
public class elf extends elj implements elh {
   ...
   public elf.c a() {
      return new elf.c(this.p, this.l, this.t, this.u);
   }

   public void a(elf.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   private IntConsumer a(int $$0, elp.a $$1) {
   ...
   private elf.b o() {
      ...
      this.j += $$5;
      this.i++;
      elf.a $$9 = new elf.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new elf.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == elp.b.a || this.p == elp.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<elq> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      elq $$1 = (elq)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == elq.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == elq.b.c) {
         elh.super.a(this.b, this.c, this.d, this.e);
      }
   }

   @Override
   public elo a(int $$0, int $$1, int $$2, int $$3) {
      if (this.a) {
         throw new IllegalStateException();
      } else {
         return elh.super.a($$0, $$1, $$2, $$3);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, elh.a($$11));
         this.a($$14 + 5, elh.a($$12));
         this.a($$14 + 6, elh.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(elp a, int b, int c, elp.b d, elp.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(elp.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable els $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
