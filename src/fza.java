...
public class fza extends fyq<cvd> {
   ...
   private final hig M = new hig();

   public fza(cvd $$0, crb $$1, wy $$2) {
      super($$0, $$1, $$2);
      this.w -= 2;
   }
   ...
   protected void a(frv $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(gqk::H, L, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      czd $$6 = this.z.b(1).g();
      boolean $$7 = $$6.a(czh.vt);
      boolean $$8 = $$6.a(czh.rE);
      boolean $$9 = $$6.a(czh.gp);
      czd $$10 = this.z.b(0).g();
      eyh $$11 = $$10.a(kj.M);
      boolean $$12 = false;
      eyj $$13;
      if ($$11 != null) {
         $$13 = czq.a($$11, this.m.s);
         if ($$13 != null) {
            if ($$13.i) {
               $$12 = true;
               if ($$8 || $$9) {
                  $$0.a(gqk::H, G, $$4 + 35, $$5 + 31, 28, 21);
               }
            }
   ...
   private void a(frv $$0, @Nullable eyh $$1, @Nullable eyj $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.C;
      int $$8 = this.D;
      if ($$4 && !$$6) {
         $$0.a(gqk::H, H, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 85, $$8 + 31, 0.226F);
      } else if ($$3) {
         $$0.a(gqk::H, I, $$7 + 67 + 16, $$8 + 13, 50, 66);
         this.a($$0, $$1, $$2, $$7 + 86, $$8 + 16, 0.34F);
         $$0.c().a();
         $$0.c().a(0.0F, 0.0F, 1.0F);
         $$0.a(gqk::H, I, $$7 + 67, $$8 + 13 + 16, 50, 66);
         this.a($$0, $$1, $$2, $$7 + 70, $$8 + 32, 0.34F);
         $$0.c().b();
      } else if ($$5) {
         $$0.a(gqk::H, J, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 71, $$8 + 17, 0.45F);
         $$0.c().a();
         $$0.c().a(0.0F, 0.0F, 1.0F);
         $$0.a(gqk::H, K, $$7 + 118, $$8 + 60, 10, 14);
         $$0.c().b();
      } else {
         $$0.a(gqk::H, J, $$7 + 67, $$8 + 13, 66, 66);
         this.a($$0, $$1, $$2, $$7 + 71, $$8 + 17, 0.45F);
   ...
   private void a(frv $$0, @Nullable eyh $$1, @Nullable eyj $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
