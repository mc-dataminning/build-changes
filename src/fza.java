public class fza extends gay {
   ...
   fza(fwr $$0, double $$1, double $$2, double $$3, emv $$4) {
      super($$0, $$1, $$2, $$3);
      this.b(0.01F, 0.01F);
      this.u = 0.06F;
      this.b = $$4;
      ...
      if (!this.o) {
         ...
         if (!this.o) {
            ...
            if (this.b != emx.a) {
               ...
               emw $$1 = this.c.b_($$0);
               if ($$1.a() == this.b && this.h < (double)((float)$$0.v() + $$1.a((daf)this.c, $$0))) {
                  this.k();
               }
            }
         }
   ...
   public static gay g(lb $$0, fwr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      fza $$8 = new fza.g($$1, $$2, $$3, $$4, emx.a, ky.ax);
      $$8.u = 0.01F;
   ...
   public static gay n(lb $$0, fwr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      int $$8 = (int)(64.0F / ayf.b($$1.E_(), 0.1F, 0.9F));
      fza $$9 = new fza.f($$1, $$2, $$3, $$4, emx.a, $$8);
      $$9.u = 0.005F;
   ...
   public static gay o(lb $$0, fwr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      fza.b $$8 = new fza.b($$1, $$2, $$3, $$4, emx.a, ky.aF);
      $$8.a = true;
      $$8.u *= 0.01F;
      $$8.t = 100;
   ...
   public static gay p(lb $$0, fwr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      fza $$8 = new fza.e($$1, $$2, $$3, $$4, emx.a, ky.aG);
      $$8.a = true;
      $$8.u = 0.01F;
      $$8.a(0.51171875F, 0.03125F, 0.890625F);
      return $$8;
   ...
   static class a extends fza.b {
      a(fwr $$0, double $$1, double $$2, double $$3, emv $$4, kw $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
   ...
   static class b extends fza {
      ...
      b(fwr $$0, double $$1, double $$2, double $$3, emv $$4, kw $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
         this.u *= 0.02F;
         this.t = 40;
   ...
   static class c extends fza {
      c(fwr $$0, double $$1, double $$2, double $$3, emv $$4) {
         super($$0, $$1, $$2, $$3, $$4);
   ...
   static class d extends fza.e {
      d(fwr $$0, double $$1, double $$2, double $$3, emv $$4, kw $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
      ...
      protected void i() {
         if (this.m) {
            ...
            avh $$0 = this.g() == emx.e ? avi.hx : avi.hy;
            float $$1 = ayf.b(this.r, 0.3F, 1.0F);
            this.c.a(this.g, this.h, this.i, $$0, avj.e, $$1, 1.0F, false);
         }
      }
   }
   ...
   static class e extends fza.f {
      ...
      e(fwr $$0, double $$1, double $$2, double $$3, emv $$4, kw $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
      }
   ...
   static class f extends fza {
      f(fwr $$0, double $$1, double $$2, double $$3, emv $$4) {
         this($$0, $$1, $$2, $$3, $$4, (int)(64.0 / (Math.random() * 0.8 + 0.2)));
      }

      f(fwr $$0, double $$1, double $$2, double $$3, emv $$4, int $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.t = $$5;
      }
   ...
   static class g extends fza.e {
      g(fwr $$0, double $$1, double $$2, double $$3, emv $$4, kw $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
      ...
      protected void i() {
         if (this.m) {
            this.k();
            this.c.a(this.b, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            float $$0 = ayf.b(this.r, 0.3F, 1.0F);
            this.c.a(this.g, this.h, this.i, avi.bU, avj.e, $$0, 1.0F, false);
         }
      }
   }
}
