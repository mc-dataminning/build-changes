...
public class fza implements fzd.a, AutoCloseable {
   ...
   eks[] f;
   @Nullable
   private final fza.a g;
   private final anx h;

   public fza(aey $$0, gat $$1, eks $$2, anx $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gar $$4 = $$3.a(gar.a).orElse(gar.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eks[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fyv.a(this.f, $$0);
   ...
   @Nullable
   private fza.a a(gat $$0, int $$1, int $$2, gar $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fza.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fza.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fza.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fza.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fza.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fza.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eks[] $$4) {
   ...
   class a {
      ...
      a(List<fza.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fza.this.c;
         int $$4 = this.b($$2) * fza.this.d;
         fza.this.a($$0, $$1, $$3, $$4, fza.this.f);
      }

      public fzc a() {
         return fza.this.new d(this, this.d ? fza.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eks[] b = new eks[fza.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fza.this.c >> $$0;
            int $$2 = fza.this.d >> $$0;
            this.b[$$0] = new eks($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fza.d $$2) {
         fza.a $$3 = $$2.d;
         List<fza.b> $$4 = $$3.b;
         fza.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fza.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fza.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fza.this.f[$$2].a($$3 + ($$0.a($$1) * fza.this.c >> $$2), $$4 + ($$0.b($$1) * fza.this.d >> $$2));
      }
   ...
   class d implements fzc {
      int b;
      int c;
      final fza.a d;
      @Nullable
      private final fza.c e;

      d(fza.a $$0, @Nullable fza.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
