...
public class bmt implements bmu {
   ...
   private static final bmt k = new bmt();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bms $$0) {
      URL $$1 = bmt.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bms $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bmw a = new bmw(() -> bmt.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmt.this.l && $$0.getState() == RecordingState.STOPPED) {
