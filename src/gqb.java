...
public class gqb implements gpu {
   static final Logger c = LogUtils.getLogger();
   public static final MapCodec<gqb> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   private gqb(List<akk> $$0, akk $$1, Map<String, akk> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(gqa a, Supplier<IntUnaryOperator> b, akk c) implements gpu.b {
      @Nullable
      public gpk a(gpt $$0) {
         Object var3;
         try {
            ezp $$1 = this.a.a().a(this.b.get());
            return new gpk(this.c, new grd($$1.a(), $$1.b()), $$1, aty.a);
         } catch (IllegalArgumentException | IOException var7) {
            gqb.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
