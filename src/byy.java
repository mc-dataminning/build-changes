         ...
         (Function<can.b<bvp>, ? extends App<can.c<bvp>, caq<bvp>>>)($$3 -> $$3.group($$3.c(cel.m), $$3.c(cel.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.ad() - $$2.getValue() < 20L) {
                        ...
                        cgl $$7 = $$4x.A();
                        Optional<ji> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cgp.n), $$5.dv(), 48, cgl.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dv()) <= 4.0)) {
                           ...
                           Set<Pair<jr<cgo>, ji>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cgp.n), $$10, $$5.dv(), 48, cgl.b.c).collect(Collectors.toSet());
                           etn $$12 = bwt.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ji $$13 = $$12.l();
                              Optional<jr<cgo>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new ceo($$13, $$0, 1));
                                 agd.c($$4x, $$13);
                              }
