...
public class byy implements byv {
   ...
   public void a() {
      ...
      if (this.d > 0) {
         ...
         this.h().ifPresent($$0 -> this.a.t(this.a(this.a.dH(), $$0, this.c)));
      } else {
   ...
   protected void b() {
      if (!this.a.K().l()) {
         this.a.ba = aye.c(this.a.ba, this.a.aY, (float)this.a.ab());
      }
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(aye.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(aye.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   private static double b(bsd $$0) {
      return $$0 instanceof bsy ? $$0.dy() : ($$0.cK().b + $$0.cK().e) / 2.0;
   }
}
