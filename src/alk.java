...
public class alk {
   ...
   private static int a(ds $$0, float $$1) {
      ...
      $$0.a(() -> vf.a("commands.tick.rate.success", $$3), true);
      return (int)$$1;
   }
   ...
   private static int a(ds $$0) {
      ...
      if ($$1.a()) {
         $$0.a(() -> vf.c("commands.tick.status.sprinting"), false);
         $$0.a(() -> vf.a("commands.tick.query.rate.sprinting", $$4, $$2), false);
      } else {
         if ($$1.l()) {
         ...
         String $$5 = a($$1.h());
         $$0.a(() -> vf.a("commands.tick.query.rate.running", $$4, $$2, $$5), false);
      }
      ...
      $$0.a(() -> vf.a("commands.tick.query.percentiles", $$7, $$8, $$9, $$6.length), false);
      return (int)$$3;
   }
   ...
   private static int a(ds $$0, int $$1) {
      ...
      if ($$2) {
         $$0.a(() -> vf.c("commands.tick.sprint.stop.success"), true);
      }

      $$0.a(() -> vf.c("commands.tick.status.sprinting"), true);
      return 1;
   }
   ...
   private static int a(ds $$0, boolean $$1) {
      ...
      $$2.a($$1);
      if ($$1) {
         $$0.a(() -> vf.c("commands.tick.status.frozen"), true);
      } else {
         $$0.a(() -> vf.c("commands.tick.status.running"), true);
      }
   ...
   private static int b(ds $$0, int $$1) {
      ...
      boolean $$3 = $$2.a($$1);
      if ($$3) {
         $$0.a(() -> vf.a("commands.tick.step.success", $$1), true);
      } else {
         $$0.b(vf.c("commands.tick.step.fail"));
      }
   ...
   private static int b(ds $$0) {
      ...
      boolean $$2 = $$1.b();
      if ($$2) {
         $$0.a(() -> vf.c("commands.tick.step.stop.success"), true);
         return 1;
      } else {
         $$0.b(vf.c("commands.tick.step.stop.fail"));
         return 0;
      }
   }
   ...
   private static int c(ds $$0) {
      ...
      if ($$2) {
         ...
         $$0.b(vf.c("commands.tick.sprint.stop.fail"));
         return 0;
      }
   }
}
