...
public class alk extends eyg {
   ...
   protected void a(eyf $$0, exy $$1, eyd $$2) {
      ...
      if (this.c.contains($$1)) {
         this.b.ah().a(new afi($$0.cB(), $$1.b(), $$2.a(), Optional.ofNullable($$2.d()), Optional.ofNullable($$2.c())));
      }
   ...
   public eql.a<eyh> b() {
      return new eql.a<>(this::h, this::a, azw.n);
   }
