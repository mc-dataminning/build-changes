...
public class fba implements kb {
   public static final Codec<fba> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> af.a($$0, 3).map($$0x -> new fba((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final yn<ByteBuf, fba> b = new yn<ByteBuf, fba>() {
      public fba a(ByteBuf $$0) {
         return vl.f($$0);
      }

      public void a(ByteBuf $$0, fba $$1) {
         vl.a($$0, $$1);
      }
   };
   public static final fba c = new fba(0.0, 0.0, 0.0);
   public final double d;
   public final double e;
   public final double f;

   public static fba a(int $$0) {
   ...
   public static fba a(km $$0) {
      return new fba((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static fba a(km $$0, double $$1, double $$2, double $$3) {
      return new fba((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static fba b(km $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static fba c(km $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static fba a(km $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public fba(double $$0, double $$1, double $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
   }

   public fba(Vector3f $$0) {
   ...
   public fba a(fba $$0) {
      return new fba($$0.d - this.d, $$0.e - this.e, $$0.f - this.f);
   }

   public fba d() {
      double $$0 = Math.sqrt(this.d * this.d + this.e * this.e + this.f * this.f);
      return $$0 < 1.0E-5F ? c : new fba(this.d / $$0, this.e / $$0, this.f / $$0);
   }

   public double b(fba $$0) {
      return this.d * $$0.d + this.e * $$0.e + this.f * $$0.f;
   }

   public fba c(fba $$0) {
      return new fba(this.e * $$0.f - this.f * $$0.e, this.f * $$0.d - this.d * $$0.f, this.d * $$0.e - this.e * $$0.d);
   }
   ...
   public fba a(double $$0) {
      return this.a($$0, $$0, $$0);
   }

   public fba a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }

   public fba b(double $$0) {
      return this.b($$0, $$0, $$0);
   }
   ...
   public fba b(double $$0, double $$1, double $$2) {
      return new fba(this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public boolean a(fba $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.d;
      double $$4 = $$0.b() - this.e;
      double $$5 = $$0.c() - this.f;
   ...
   public fba f() {
      return new fba(this.d, 0.0, this.f);
   }

   public fba a(azh $$0, float $$1) {
   ...
   public fba a(fba $$0, double $$1) {
      return new fba(ayz.d($$1, this.d, $$0.d), ayz.d($$1, this.e, $$0.e), ayz.d($$1, this.f, $$0.f));
   }
   ...
   public static fba a(faz $$0) {
      return a($$0.i, $$0.j);
   }

   public static fba a(float $$0, float $$1) {
      ...
      return new fba((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public fba a(EnumSet<jn.a> $$0) {
   ...
   public fba a(jn.a $$0, double $$1) {
      double $$2 = $$0 == jn.a.a ? $$1 : this.d;
      double $$3 = $$0 == jn.a.b ? $$1 : this.e;
      double $$4 = $$0 == jn.a.c ? $$1 : this.f;
      return new fba($$2, $$3, $$4);
   }

   public fba a(jn $$0, double $$1) {
      km $$2 = $$0.q();
      return new fba(this.d + $$1 * (double)$$2.u(), this.e + $$1 * (double)$$2.v(), this.f + $$1 * (double)$$2.w());
   }
