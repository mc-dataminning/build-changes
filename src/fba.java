...
public class fba {
   ...
   @Nullable
   private String g;
   private static final fba.a h = new fba.a() {
      @Nullable
      @Override
      public faz a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fbd.a(this.d, "Get capabilities")) {
         ...
         if (fbd.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fbd.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fbd.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public faz a(fba.c $$0) {
      return ($$0 == fba.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fba.a {
      private final int a;
      private final Set<faz> b = Sets.newIdentityHashSet();
      ...
      public faz a() {
         if (this.b.size() >= this.a) {
            if (ab.aW) {
               fba.a.warn("Maximum sound pool size {} reached", this.a);
            }
