...
public class bij implements Comparable<bij> {
   ...
   @Nullable
   private bij q;
   private final Optional<bij.a> r;

   public bij(bih $$0) {
      this($$0, 0, 0);
   }

   public bij(bih $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bij(bih $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bij(bih $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bij(bih $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public bij(bih $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bij $$6, Optional<bij.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bjm $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bij $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(qw $$0) {
      ...
      this.r.ifPresent($$1x -> bij.a.a.encodeStart(ri.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static bij b(qw $$0) {
      String $$1 = $$0.l("id");
      bih $$2 = jb.e.a(aez.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static bij a(bih $$0, qw $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = bij.a.a.parse(new Dynamic(ri.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bij($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bij.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  arj.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  arj.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bij $$0) {
         ...
         float $$2 = asb.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = asb.i($$2, this.c, this.d);
      }

      public float a(bjm $$0, float $$1) {
         if ($$0.dG()) {
            this.g = this.e;
         }

         return asb.i($$1, this.g, this.e);
      }
   }
}
