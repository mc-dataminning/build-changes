...
public abstract class bij extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bhx.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bhx.B);
      Type<Pair<String, String>> $$2 = DSL.named(bhx.z.typeName(), bjl.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhx.z), $$2)) {
