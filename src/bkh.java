...
public abstract class bkh extends bux implements bju {
   protected static final aef<Byte> bT = aei.a(bkh.class, aeh.a);
   protected static final aef<Optional<UUID>> bU = aei.a(bkh.class, aeh.q);
   private boolean bW;

   protected bkh(bja<? extends bkh> $$0, cqb $$1) {
      super($$0, $$1);
      this.t();
   }
   ...
   @Override
   public void a(bhu $$0) {
      if (!this.dL().B && this.dL().X().b(cpx.m) && this.O_() instanceof aku) {
         this.O_().a(this.eJ().a());
      }
