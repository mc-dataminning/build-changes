...
public interface ddy {
   Codec<ddy> a = mb.at.q().dispatch(ddy::a, $$0 -> $$0);
   Codec<ddy> b = Codec.either(ddy.b.c, a)
      .xmap($$0 -> (ddy)$$0.map($$0x -> $$0x, $$0x -> $$0x), $$0 -> $$0 instanceof ddy.b $$1 ? Either.left($$1) : Either.right($$0));

   static MapCodec<? extends ddy> a(ke<MapCodec<? extends ddy>> $$0) {
      ke.a($$0, "clamped", ddy.a.c);
      ke.a($$0, "fraction", ddy.c.c);
      ke.a($$0, "levels_squared", ddy.d.c);
      ke.a($$0, "linear", ddy.e.c);
      return ke.a($$0, "lookup", ddy.f.c);
   }
