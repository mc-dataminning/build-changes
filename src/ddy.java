...
public class ddy {
   public static final int a = jx.a(8);
   ...
   public ddy a(ddy.a $$0) {
      return new ddy($$0, this.f);
   }

   public jm<ddw> a(jd $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jm<ddw> a(double $$0, double $$1, double $$2) {
      int $$3 = jx.a(ayo.a($$0));
      int $$4 = jx.a(ayo.a($$1));
      int $$5 = jx.a(ayo.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ayj.a($$7, $$0);
      double $$10 = b($$7);
      return ayo.k($$6 + $$10) + ayo.k($$5 + $$9) + ayo.k($$4 + $$8);
   }
   ...
   public interface a {
      jm<ddw> getNoiseBiome(int var1, int var2, int var3);
   }
}
