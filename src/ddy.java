...
public class ddy extends dcl {
   ...
   public void a(qr $$0) {
      ...
      try {
         this.k = cyx.valueOf($$0.l("rotation"));
      } catch (IllegalArgumentException var11) {
         this.k = cyx.a;
      }

      try {
         this.j = cxg.valueOf($$0.l("mirror"));
      } catch (IllegalArgumentException var10) {
         this.j = cxg.a;
      }

      try {
         this.l = dgj.valueOf($$0.l("mode"));
   ...
   public void a(dgj $$0) {
      this.l = $$0;
      dez $$1 = this.o.a_(this.p());
      if ($$1.a(csm.pa)) {
         this.o.a(this.p(), $$1.a(dak.a, $$0), 2);
      }
   }
   ...
   private Stream<gu> a(gu $$0, gu $$1) {
      return gu.b($$0, $$1)
         .filter($$0x -> this.o.a_($$0x).a(csm.pa))
         .map(this.o::c_)
         .filter($$0x -> $$0x instanceof ddy)
         .map($$0x -> (ddy)$$0x)
         .filter($$0x -> $$0x.l == dgj.c && Objects.equals(this.e, $$0x.e))
         .map(dcl::p);
   }

   private static Optional<duq> a(gu $$0, Stream<gu> $$1) {
   ...
   public boolean b(boolean $$0) {
      if (this.l == dgj.a && !this.o.B && this.e != null) {
         ...
         $$4.a(this.o, $$1, this.i, !this.m, csm.kN);
         $$4.a(this.f);
         if ($$0) {
            try {
               return $$3.c(this.e);
   ...
   public boolean a(akk $$0, boolean $$1, dyr $$2) {
      gu $$3 = this.p();
      if (!asi.b($$2.b())) {
         this.f = $$2.b();
      }
      ...
      if ($$1 && !$$5) {
         ...
         dyn $$7 = new dyn().a(this.j).a(this.k).a(this.m);
         if (this.t < 1.0F) {
            $$7.b().a(new dxv(arp.a(this.t, 0.0F, 1.0F))).a(b(this.u));
         }
   ...
   public boolean F() {
      if (this.l == dgj.b && !this.o.B && this.e != null) {
         akk $$0 = (akk)this.o;
         dys $$1 = $$0.p();
