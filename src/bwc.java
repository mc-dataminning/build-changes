...
public abstract class bwc<E extends buk> implements bwd<E> {
   public static final int a = 60;
   protected final Map<cdn<?>, cdo> b;
   private bwc.a c = bwc.a.a;
   private long d;
   private final int e;
   private final int f;

   public bwc(Map<cdn<?>, cdo> $$0) {
      this($$0, 60);
   }

   public bwc(Map<cdn<?>, cdo> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bwc(Map<cdn<?>, cdo> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cdn<?>, cdo> $$1 : this.b.entrySet()) {
         cdn<?> $$2 = $$1.getKey();
         cdo $$3 = $$1.getValue();
         if (!$$0.dX().a($$2, $$3)) {
            return false;
