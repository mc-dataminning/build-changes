...
public class vw extends ByteBuf {
   ...
   public <T> T a(DynamicOps<uy> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, uk.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<uy> $$0, Codec<T> $$1, uk $$2) {
      uy $$3 = this.a($$2);
   ...
   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = aye.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, yy<? super vw, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, yz<? super vw, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(yy<? super vw, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, yy<? super vw, K> $$1, yy<? super vw, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(yy<? super vw, K> $$0, yy<? super vw, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, yz<? super vw, K> $$1, yz<? super vw, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, yz<? super vw, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(yy<? super vw, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(yy<? super vw, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, yy<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, yz<? super vw, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, yz<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static void a(ByteBuf $$0, @Nullable uy $$1) {
      ...
      try {
         uo.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ub f(ByteBuf $$0) {
      uy $$1 = a($$0, uk.a(2097152L));
      if ($$1 != null && !($$1 instanceof ub)) {
   ...
   @Nullable
   public static uy a(ByteBuf $$0, uk $$1) {
      try {
         uy $$2 = uo.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public <T> akq<T> a(akq<? extends jz<T>> $$0) {
      akr $$1 = this.q();
      return akq.a($$0, $$1);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, ayo.e($$1, 8)));
      }
   }
   ...
   public vw g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public vw b(ByteBuf $$0, int $$1) {
