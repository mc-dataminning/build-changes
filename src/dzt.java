...
public class dzt extends eab<dzs> {
   public dzt(Codec<dzs> $$0) {
      super($$0);
   }

   public boolean a(dzs $$0, azh $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dzw $$0, dzs $$1, dua $$2, Function<iz, ji<dcz>> $$3, azh $$4, dxi $$5, dbh $$6, dtz $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private float[] a(dzw $$0, dzs $$1, azh $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(dzs $$0, azh $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - ayz.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)ayz.b($$1, 0.75F, 1.0F);
   }

   private boolean a(dzw $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
