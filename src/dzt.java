...
public class dzt extends dzu {
   public static final int a = 8;
   public static final int b = 15;
   public static final Codec<dzt> c = RecordCodecBuilder.create(
      $$0 -> a($$0).and(dzs.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, dzt::new)
   );
   private final dzs h;

   public dzt(bmi $$0, dzx $$1, Optional<dzr> $$2, dzs $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(cxh $$0, BiConsumer<ib, dnb> $$1, axd $$2, ib $$3, ib $$4, dys $$5) {
   ...
   private boolean a(cxh $$0, axd $$1, ib $$2, ih $$3, ib $$4, List<ib> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
