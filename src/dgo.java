...
public class dgo {
   public static final Codec<dgo> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> ae.a($$0, 2).map($$0x -> new dgo($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.h, $$0.i))
      .stable();
   public static final zt<ByteBuf, dgo> b = new zt<ByteBuf, dgo>() {
      public dgo a(ByteBuf $$0) {
         return ws.c($$0);
      }

      public void a(ByteBuf $$0, dgo $$1) {
         ws.a($$0, $$1);
      }
   };
   private static final int j = 1056;
   public static final long c = c(1875066, 1875066);
   private static final int k = (32 + eaq.a.a(ear.n).c().b() + 1) * 2;
   public static final int d = kj.a(jh.f) - k;
   public static final dgo e = new dgo(0, 0);
   ...
   public static dgo a(int $$0, int $$1) {
      return new dgo($$0 << 5, $$1 << 5);
   }

   public static dgo b(int $$0, int $$1) {
      return new dgo(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dgo $$1) ? false : this.h == $$1.h && this.i == $$1.i;
      }
   }
   ...
   public static Stream<dgo> a(dgo $$0, int $$1) {
      return a(new dgo($$0.h - $$1, $$0.i - $$1), new dgo($$0.h + $$1, $$0.i + $$1));
   }

   public static Stream<dgo> a(final dgo $$0, final dgo $$1) {
      int $$2 = Math.abs($$0.h - $$1.h) + 1;
      int $$3 = Math.abs($$0.i - $$1.i) + 1;
      final int $$4 = $$0.h < $$1.h ? 1 : -1;
      final int $$5 = $$0.i < $$1.i ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dgo>((long)($$2 * $$3), 64) {
         @Nullable
         private dgo e;

         @Override
         public boolean tryAdvance(Consumer<? super dgo> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
               ...
               if ($$1 == $$1.h) {
                  ...
                  this.e = new dgo($$0.h, $$2 + $$5);
               } else {
                  this.e = new dgo($$1 + $$4, $$2);
               }
            }
