...
public class fzf extends dcw {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dxm e = new dxm();
   private final dxs<bsr> f = new dxs<>(bsr.class, new fzf.b());
   private final fzg D;
   private final gex E;
   private final fzf.a F;
   private final geo G;
   private final brc H;
   private final fgo I = fgo.Q();
   final List<gdy> J = Lists.newArrayList();
   private final Map<eqr, eqt> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<dch, fhr> N = ad.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gel.a, new fhr($$0xx -> this.b($$0xx, gel.a)));
      $$0x.put(gel.b, new fhr($$0xx -> this.b($$0xx, gel.b)));
      $$0x.put(gel.c, new fhr($$0xx -> this.b($$0xx, gel.c)));
   });
   private final fzb O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final gas R = new gas();
   ...
   public void a(jd $$0, dtc $$1, exc $$2) {
      dtc $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cmx $$4 = this.I.s;
         if (this == $$4.dO() && $$4.a($$0, $$1)) {
            $$4.h($$2.c, $$2.d, $$2.e);
         }
      }
   }
   ...
   public fzf(fzg $$0, fzf.a $$1, akq<dcw> $$2, jm<dwy> $$3, int $$4, int $$5, Supplier<bnf> $$6, gex $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.v(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fzb(this, $$4);
      this.H = new brc();
      this.F = $$1;
      this.E = $$7;
      this.G = geo.a($$3.a());
   ...
   public boolean h(bsr $$0) {
      return $$0.dq().a(this.I.s.dq()) <= this.Q;
   }
   ...
   private void a(jd $$0, lk $$1, exv $$2, double $$3) {
   ...
   public void a(@Nullable cmx $$0, bsr $$1, jm<avo> $$2, avq $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.aj().a((gua)(new gtr($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bsr $$0, avo $$1, avq $$2, float $$3, float $$4) {
      this.I.aj().a((gua)(new gtr($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avo $$3, avq $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      gtv $$10 = new gtv($$3, $$4, $$5, $$6, ayw.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<cxl> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.I.g.a(new gbx.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
      }
   }
   ...
   public exc a(exc $$0, float $$1) {
      float $$2 = this.f($$1);
      exc $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      ddy $$4 = this.F_();
      exc $$5 = axo.a($$3, ($$1x, $$2x, $$3x) -> exc.a($$4.a($$1x, $$2x, $$3x).a().a()));
      ...
      return new exc((double)$$7, (double)$$8, (double)$$9);
   }
   ...
   public exc h(float $$0) {
      ...
      return new exc((double)$$3, (double)$$4, (double)$$5);
   }
