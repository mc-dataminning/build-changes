...
public final class fhq implements AutoCloseable {
   ...
   public fhq(int $$0, int $$1, boolean $$2) {
      this(fhq.a.a, $$0, $$1, $$2);
   }

   public fhq(fhq.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private fhq(fhq.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static fhq a(InputStream $$0) throws IOException {
      return a(fhq.a.a, $$0);
   }

   public static fhq a(@Nullable fhq.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fhq a(ByteBuffer $$0) throws IOException {
      return a(fhq.a.a, $$0);
   }

   public static fhq a(byte[] $$0) throws IOException {
   ...
   private static fhq a(ByteBuffer $$0, byte[] $$1) throws IOException {
      $$0.put($$1);
      $$0.rewind();
      return a($$0);
   }

   public static fhq a(@Nullable fhq.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new fhq($$0 == null ? fhq.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
         } catch (Throwable var11) {
            if ($$2 != null) {
               try {
                  $$2.close();
   ...
   public fhq a(IntUnaryOperator $$0) {
      if (this.d != fhq.a.a) {
         ...
         this.j();
         fhq $$1 = new fhq(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fus.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(fhq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fhq $$4) {
      this.j();
      if ($$4.c() != this.d) {
