...
public class fhq extends fgd<cma> {
   ...
   private void b(eyu $$0, int $$1, int $$2, int $$3) {
      List<csd<csv>> $$4 = this.p.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.J()) {
         ...
         this.M = awh.a(this.M - $$5, 0.0F, 1.0F);
