...
public class gdg extends aut<gdg.a> {
   ...
   protected gdg.a a(auo $$0, bng $$1) {
      ...
      $$1.b();
      return new gdg.a($$2, $$3, $$4);
   }

   protected void a(gdg.a $$0, auo $$1, bng $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(auo $$0, bng $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eyp.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eyp.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eyp.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
