...
public class gdg implements aoh<gdf> {
   public gdf b(JsonObject $$0) {
      Builder<gde> $$1 = ImmutableList.builder();
      int $$2 = atc.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = atc.a($$0, "width", -1);
      int $$9 = atc.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = atc.a($$0, "interpolate", false);
      return new gdf($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gde a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gde(atc.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = atc.m($$1, "frames[" + $$0 + "]");
         int $$3 = atc.a($$2, "time", -1);
         if ($$2.has("time")) {
