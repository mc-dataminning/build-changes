...
public class gdg implements ezl, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final ezj c = new ezj();
   private static final boolean d = true;
   private static gdg e;
   ...
   private final List<ezr> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezr> l = Maps.newHashMap();
   private final int m;
   ...
   public gdg(aus $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.s = a($$0, ezo.a.a, $$6);
         this.t = a($$0, ezo.a.b, $$7);
         this.m = ezp.a();
         ezp.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezr.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezm a(aus $$0, ezo.a $$1, String $$2) throws IOException {
      ezo $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezm)) {
   ...
   public static ezk a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezk();
      } else {
         int $$1 = 32774;
