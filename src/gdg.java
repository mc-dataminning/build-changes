...
public class gdg extends fyb {
   ...
   private final fvx s = new fvx(this);
   private final fyb u;
   private final aun v;
   ...
   public gdg(fyb $$0, aun $$1, Consumer<aun> $$2) {
      super(a);
      this.u = $$0;
      this.v = $$1;
      this.w = $$2;
   ...
   protected void aO_() {
      this.s.a(a, this.p);
      fwb $$0 = this.s.c(fwb.d());
      $$0.a(new ftd(b, this.p).d(310), $$0x -> $$0x.e(15));
      gdl.a $$1 = gdl.a(299).a(2, true).b(4);
      this.x.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.x.getBoolean($$1x), $$1xx -> this.x.put($$1x, $$1xx)).a($$1x.c()));
      fvy $$2 = $$1.a().a();
      this.y = new gdg.a($$2, 310, 130);
      $$0.a(this.y);
      fwb $$3 = this.s.b(fwb.e().a(8));
      $$3.a(fsj.a(wx.d, $$0x -> this.m()).a());
      $$3.a(fsj.a(wx.e, $$0x -> this.aL_()).a());
      this.s.a($$1x -> {
   ...
   public class a extends fsa {
      private final List<fsh> a = new ArrayList<>();
      private final fvy c;

      public a(final fvy $$1, final int $$2, final int $$3) {
         super(0, 0, $$2, $$3, wx.a);
         this.c = $$1;
         $$1.a(this::a);
      }
      ...
      @Override
      public fwq b(fwo $$0) {
         return new fwq(this.F(), this.G(), this.g, this.n());
      }
      ...
      @Override
      public Collection<? extends fwe> L() {
         return this.a;
      }
   }
}
