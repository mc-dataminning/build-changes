...
public class alc<E> implements Codec<jj<E>> {
   private final alh<? extends js<E>> a;
   private final Codec<jf<E>> b;
   private final Codec<List<jf<E>>> c;
   private final Codec<Either<axt<E>, List<jf<E>>>> d;

   private static <E> Codec<List<jf<E>>> a(Codec<jf<E>> $$0, boolean $$1) {
      Codec<List<jf<E>>> $$2 = $$0.listOf().validate(ayw.b(jf::f));
      return $$1 ? $$2 : ayw.c($$0, $$2);
   }

   public static <E> Codec<jj<E>> a(alh<? extends js<E>> $$0, Codec<jf<E>> $$1, boolean $$2) {
      return new alc<>($$0, $$1, $$2);
   }

   private alc(alh<? extends js<E>> $$0, Codec<jf<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
   ...
   private static <E> DataResult<jj<E>> a(jg<E> $$0, axt<E> $$1) {
      return $$0.a($$1)
