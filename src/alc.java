...
public class alc<E> implements Codec<ju<E>> {
   private final alh<? extends kd<E>> a;
   private final Codec<jq<E>> b;
   private final Codec<List<jq<E>>> c;
   private final Codec<Either<axq<E>, List<jq<E>>>> d;

   private static <E> Codec<List<jq<E>>> a(Codec<jq<E>> $$0, boolean $$1) {
      Codec<List<jq<E>>> $$2 = $$0.listOf().validate(ayt.b(jq::f));
      return $$1
         ? $$2
         : Codec.either($$2, $$0)
   ...
   public static <E> Codec<ju<E>> a(alh<? extends kd<E>> $$0, Codec<jq<E>> $$1, boolean $$2) {
      return new alc<>($$0, $$1, $$2);
   }

   private alc(alh<? extends kd<E>> $$0, Codec<jq<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(axq.b($$0), this.c);
   }

   public <T> DataResult<Pair<ju<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof alg<T> $$2) {
   ...
   private static <E> DataResult<ju<E>> a(jr<E> $$0, axq<E> $$1) {
      return $$0.a($$1)
