...
public class fyn {
   ...
   public static class b extends gac {
      b(fvw $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * axz.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fzo {
      private boolean b;
      private boolean F;
      private final fze G;
      private float H;
      ...
      c(fvw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fze $$7, fzx $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fyn.c $$0 = new fyn.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fzf<la> {
      ...
      public fzc a(la $$0, fvw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fyn.c $$8 = new fyn.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fde.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fza {
      ...
      private int D;
      private final fze E;
      private final List<cvq> F;
      private boolean G;

      public e(fvw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fze $$7, List<cvq> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, avd.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            fzc $$12 = this.E.a(kx.L, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axj.b.b($$11) / 255.0F, (float)axj.b.c($$11) / 255.0F, (float)axj.b.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               avb $$14 = $$13 ? avc.iN : avc.iM;
               this.c.a(this.g, this.h, this.i, $$14, avd.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         fyn.c $$10 = (fyn.c)this.E.a(kx.C, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = axz.d($$18, $$13, $$16) * $$0;
                  double $$20 = axz.d($$18, $$14, $$17) * $$0;
