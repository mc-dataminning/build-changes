...
public class fyn {
   ...
   public void a(final fyl $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final fzo $$3 = fzo.a($$0.b);
      Optional<InetSocketAddress> $$4 = fzq.a.a($$3).map(fzn::d);
      if ($$4.isEmpty()) {
         this.a(fly.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fzo $$1, final fyl $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)wk.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fye($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(fyl.b.d);
               $$2.h = xp.b($$2xx);
               $$2.d = xp.b($$3);
               $$2.c = fyn.a($$4, $$5);
