...
public class gtw implements guc.a {
   ...
   private final foz F;
   private final Map<iu, gtw.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bwf $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dQ();
      });
   }

   private void b(fjj $$0, gqa $$1, double $$2, double $$3, double $$4) {
      iu $$5 = iu.a($$2, $$3, $$4);
   ...
   private void a(fjj $$0, gqa $$1, gtw.a $$2) {
      int $$3 = 0;
   ...
   private void a(fjj $$0, gqa $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gul.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fjj $$0, gqa $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fjj $$0, gqa $$1, String $$2, gtw.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      guc.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
