...
public class ewo implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ewo.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ewo(List<ewo.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ewo a(BufferedReader $$0) {
      return new ewo($$0.lines().flatMap($$0x -> ewo.a.a($$0x).stream()).toList());
   }

   public static record a(ewo.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ewo.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ewo.a(ewo.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ewo.a(ewo.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ewo.a(ewo.b.b, $$3));
      ...
      static ewo.a b(String $$0) {
         return new ewo.a(ewo.b.a, "glob:" + $$0);
      }

      static ewo.a c(String $$0) {
         return new ewo.a(ewo.b.a, "regex:" + $$0);
      }

      static ewo.a d(String $$0) {
         return new ewo.a(ewo.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ewo.b a = FileSystem::getPathMatcher;
      ewo.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
