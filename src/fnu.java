...
public class fnu extends aob<fnu.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final aez b = new aez("gpu_warnlist.json");
   ...
   protected fnu.a a(anw $$0, bdv $$1) {
      ...
      $$1.b();
      return new fnu.a($$2, $$3, $$4);
   }

   protected void a(fnu.a $$0, anw $$1, bdv $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(anw $$0, bdv $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ekc.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ekc.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ekc.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
