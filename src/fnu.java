...
public class fnu implements ela, AutoCloseable {
   ...
   public fnu(ant $$0, String $$1) throws IOException {
      aew $$2 = new aew("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      anr $$3 = $$0.getResourceOrThrow($$2);
   ...
   public static elb a(ant $$0, eld.a $$1, String $$2) throws IOException {
      eld $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof elb)) {
         ...
         elb $$7;
         if ($$3 == null) {
            aew $$4 = new aew("shaders/program/" + $$2 + $$1.b());
            anr $$5 = $$0.getResourceOrThrow($$4);
