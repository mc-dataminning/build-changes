...
public record dwa(int d, float e, float f, float g, float h, int i, bqr<dhc> j, bqr<akt<evw>> k, akt<evw> l) {
   ...
   public static final Codec<dwa> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               dhc.c.optionalFieldOf("spawn_potentials", bqr.b()).forGetter(dwa::i),
               bqr.a(akt.a(mc.bg)).optionalFieldOf("loot_tables_to_eject", a.k).forGetter(dwa::j),
               akt.a(mc.bg).optionalFieldOf("items_to_drop_when_ominous", a.l).forGetter(dwa::k)
            )
            .apply($$0, dwa::new)
   );
   public static final Codec<jr<dwa>> c = akq.a(mc.bd, b);
   ...
   public dwa a(bur<?> $$0) {
      ...
      return new dwa(this.d, this.e, this.f, this.g, this.h, this.i, bqr.a($$2), this.k, this.l);
   }
   ...
   public static class a {
      ...
      private int f = 40;
      private bqr<dhc> g = bqr.b();
      private bqr<akt<evw>> h = bqr.<akt<evw>>a().a(evn.aM).a(evn.aL).a();
      private akt<evw> i = evn.aP;
      ...
      public dwa.a a(bqr<dhc> $$0) {
         this.g = $$0;
         return this;
      }

      public dwa.a b(bqr<akt<evw>> $$0) {
         this.h = $$0;
         return this;
      }

      public dwa.a a(akt<evw> $$0) {
         this.i = $$0;
         return this;
      }
