...
public abstract class deo extends dfb {
   ...
   public static dse a(dbg $$0, iz $$1) {
      iz $$2 = $$1.d();
      dse $$3 = $$0.a_($$2);
      return dmm.m($$3) ? dfd.cs.o() : ((dib)dfd.cr).b($$0, $$1);
   }
   ...
   protected abstract boolean f(dse var1);
   ...
   protected void b(dse $$0, dca $$1, iz $$2, dse $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<eox> $$5 = eox.a($$1, $$2, je.a.a);
            if ($$5.isPresent()) {
               $$5.get().b();
               return;
            }
   ...
   private static boolean b(dca $$0, iz $$1, je $$2) {
      if (!a($$0)) {
         return false;
      } else {
         iz.a $$3 = $$1.j();
