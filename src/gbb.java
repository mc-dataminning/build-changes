...
public enum gbb implements gbi {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, gbb> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (gbb)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static gbb a(int $$0, int $$1) {
      return r.get(b(ars.b($$0, 360), ars.b($$1, 360)));
   }
