public abstract class gbb extends gax {
   private static final float o = 0.0F;
   private static final float p = 1.2F;
   private static final float q = 0.0F;
   protected final buj n;
   private boolean r;

   public gbb(buj $$0, aot $$1, aov $$2) {
      super($$1, $$2, gbo.t());
      this.n = $$0;
   ...
   public void q() {
      ...
      if (!this.n.dF() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = aro.i(aro.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = aro.i(aro.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
