...
public class acd implements yv<abk> {
   public static final ym<vl, acd> a = yv.a(acd::a, acd::new);
   ...
   public acd(RootCommandNode<fc> $$0) {
   ...
   private static List<acd.b> a(Object2IntMap<CommandNode<fc>> $$0) {
   ...
   @Nullable
   private static acd.e a(vl $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static acd.b a(CommandNode<fc> $$0, Object2IntMap<CommandNode<fc>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<fc> a(et $$0) {
      return (RootCommandNode<fc>)new acd.d($$0, this.j).a(this.i);
   }
   ...
   static class a implements acd.e {
      ...
      @Nullable
      private static aku a(@Nullable SuggestionProvider<fc> $$0) {
         return $$0 != null ? ix.a($$0) : null;
      }

      a(String $$0, it.a<?> $$1, @Nullable aku $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      public a(ArgumentCommandNode<fc, ?> $$0) {
         this($$0.getName(), iu.b($$0.getType()), a($$0.getCustomSuggestions()));
      }
      ...
      private static <A extends ArgumentType<?>> void a(vl $$0, it.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends it.a<A>> void a(vl $$0, it<A, T> $$1, it.a<A> $$2) {
         $$0.c(mb.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
