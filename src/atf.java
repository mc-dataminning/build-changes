...
public class atf extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(ayz.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", atf::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", atf::a);
      return this.a($$0, "minecraft:trident", atf::a);
   }
