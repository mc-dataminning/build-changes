public abstract class ghu<T extends cnb> extends giu<T> {
   public ghu(giv.a $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, ezw $$3, gdm $$4, int $$5) {
      ...
      $$3.a(-4.0F, 0.0F, 0.0F);
      faa $$18 = $$4.getBuffer(gdu.d(this.a($$0)));
      ezw.a $$19 = $$3.c();
   ...
   public void a(ezw.a $$0, faa $$1, int $$2, int $$3, int $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, (float)$$2, (float)$$3, (float)$$4).a(255, 255, 255, 255).a($$5, $$6).c(goo.d).b($$10).b($$0, (float)$$7, (float)$$9, (float)$$8).e();
   }
}
