...
public class ghu extends ghw<lm> {
   private final Vector3f a;
   private final Vector3f b;

   protected ghu(gfj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, lm $$7, gjm $$8) {
   ...
   public static class a implements giu<lm> {
      private final gjm a;
      ...
      public gir a(lm $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
