...
public class ul implements DynamicOps<uu> {
   ...
   public DataResult<String> b(uu $$0) {
      return $$0 instanceof us $$1 ? DataResult.success($$1.s_()) : DataResult.error(() -> "Not a string");
   }
   ...
   public uu a(Stream<Pair<uu, uu>> $$0) {
      tx $$1 = new tx();
      $$0.forEach($$1x -> $$1.a(((uu)$$1x.getFirst()).s_(), (uu)$$1x.getSecond()));
      return $$1;
   }
   ...
   private static Optional<ul.f> k(uu $$0) {
      if ($$0 instanceof tz) {
         ...
         if ($$0 instanceof tw<?> $$1) {
            ...
            if ($$1 instanceof ud $$2) {
               return switch ($$2.f()) {
                  case 0 -> Optional.of(ul.d.a);
                  case 10 -> Optional.of(new ul.b($$2));
                  default -> Optional.of(new ul.c($$2));
               };
            }

            if ($$1 instanceof tu $$3) {
               return Optional.of(new ul.a($$3.e()));
            }

            if ($$1 instanceof ub $$4) {
               return Optional.of(new ul.e($$4.g()));
            }

            if ($$1 instanceof ue $$5) {
               return Optional.of(new ul.g($$5.g()));
            }
         }
   ...
   static class d implements ul.f {
      public static final ul.d a = new ul.d();
      ...
      public ul.f a(uu $$0) {
         if ($$0 instanceof tx $$1) {
            return new ul.b().a($$1);
         } else if ($$0 instanceof tv $$2) {
            return new ul.a($$2.i());
         } else if ($$0 instanceof uc $$3) {
            return new ul.e($$3.g());
         } else {
            return (ul.f)($$0 instanceof uf $$4 ? new ul.g($$4.f()) : new ul.c($$0));
         }
      }
