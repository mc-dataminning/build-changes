public class gac extends gbs<gwu> {
   public gac(geh $$0) {
      super($$0);
   }
   ...
   public static gen a(gel $$0) {
      gep $$1 = gbs.a($$0, 0.0F);
      ger $$2 = $$1.a();
      ger $$3 = $$2.a("head", gem.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gej.a(0.0F, 1.0F, 0.0F));
      $$3.a("hat", gem.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gej.a);
      $$2.a("right_leg", gem.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0.a(-0.1F)), gej.a(-1.9F, 11.0F, 0.0F));
      $$2.a("left_leg", gem.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0.a(-0.1F)), gej.a(1.9F, 11.0F, 0.0F));
