...
public class gac extends atj<gac.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final ajv b = new ajv("gpu_warnlist.json");
   ...
   protected gac.a a(ate $$0, bkt $$1) {
      ...
      $$1.b();
      return new gac.a($$2, $$3, $$4);
   }

   protected void a(gac.a $$0, ate $$1, bkt $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(ate $$0, bkt $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, evk.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, evk.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, evk.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
