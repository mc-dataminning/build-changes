...
public record cvr(int c, int d, iu<cvg> e, Optional<cvr.a> f) {
   private static final int g = 3;
   public static final MapCodec<cvr> a = cvr.a.a
      .flatXmap(cvr::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final ye<vr, cvr> b = ye.a(cvr::a, cvr::b);

   public static cvr a(Map<Character, cvg> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cvr a(Map<Character, cvg> $$0, List<String> $$1) {
      cvr.a $$2 = new cvr.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cvr> a(cvr.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      iu<cvg> $$4 = iu.a($$2 * $$3, cvg.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cvr($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cnf $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cvr b(vr $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      iu<cvg> $$3 = iu.a($$1 * $$2, cvg.a);
      $$3.replaceAll($$1x -> cvg.b.decode($$0));
      return new cvr($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cvr.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cvg> b, List<String> c) {
      ...
      public static final MapCodec<cvr.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(aws.d(e, cvg.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cvr.a::new)
      );

      public Map<Character, cvg> a() {
         return this.b;
      }
