...
public class cpr extends cqr {
   ...
   public cpr(int $$0, cmr $$1) {
      this($$0, $$1, cqa.a);
   }

   public cpr(int $$0, cmr $$1, cqa $$2) {
      super(cqw.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cqs l() {
      return cqs.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   @Override
   protected boolean a(cms $$0, boolean $$1) {
      return ($$0.fP() || $$0.co >= this.w.b()) && this.w.b() > 0;
   }

   @Override
   protected void a(cms $$0, cuk $$1) {
      if (!$$0.gd().d) {
         $$0.c(-this.w.b());
      }
      ...
      this.o.a(($$1x, $$2x) -> {
         drx $$3 = $$1x.a_($$2x);
         if (!$$0.fP() && $$3.a(awl.M) && $$0.el().i() < 0.12F) {
            drx $$4 = ddu.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
      ...
      if (!$$0.e() && czw.a($$0)) {
         ...
         if (!$$5.e()) {
            ...
            if ($$4.l() && $$4.g().a($$0, $$5)) {
               ...
               for (Entry<ji<czv>> $$19 : $$16.b()) {
                  ji<czv> $$20 = (ji<czv>)$$19.getKey();
                  czv $$21 = $$20.a();
                  int $$22 = $$6.a($$21);
                  int $$23 = $$19.getIntValue();
                  $$23 = $$22 == $$23 ? $$23 + 1 : Math.max($$23, $$22);
                  boolean $$24 = $$21.b($$0);
                  if (this.p.gd().d || $$0.a(cun.uw)) {
                     $$24 = true;
                  }
         ...
         if (this.v != null && !azq.h(this.v)) {
            if (!this.v.equals($$0.x().getString())) {
               $$3 = 1;
               $$1 += $$3;
               $$4.b(km.f, xl.b(this.v));
            }
         } else if ($$0.b(km.f)) {
            $$3 = 1;
            $$1 += $$3;
         ...
         int $$27 = (int)ayu.a($$2 + (long)$$1, 0L, 2147483647L);
         this.w.a($$27);
         if ($$1 <= 0) {
            $$4 = cuk.l;
         }
