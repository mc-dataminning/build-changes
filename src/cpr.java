...
public abstract class cpr extends bum implements bwh {
   @Nullable
   private UUID a;
   @Nullable
   private bum b;
   ...
   public bum E() {
      return (bum)MoreObjects.firstNonNull(this.p(), this);
   }
   ...
   private boolean m() {
      bum $$0 = this.p();
      if ($$0 != null) {
         faw $$1 = this.cR().b(this.dy()).g(1.0);
         return $$0.df().da().filter(bur.h).noneMatch($$1x -> $$1.c($$1x.cR()));
      } else {
         return true;
      }
   }

   public fbb d(double $$0, double $$1, double $$2, float $$3, float $$4) {
      return new fbb($$0, $$1, $$2)
         .d()
   ...
   public void a(bum $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
   ...
   public static <T extends cpr> T a(cpr.a<T> $$0, ard $$1, cwq $$2, bvi $$3, float $$4, float $$5, float $$6) {
      return a($$0.create($$1, $$3, $$2), $$1, $$2, $$4x -> $$4x.a($$3, $$3.dN(), $$3.dL(), $$4, $$5, $$6));
   }

   public static <T extends cpr> T a(cpr.a<T> $$0, ard $$1, cwq $$2, bvi $$3, double $$4, double $$5, double $$6, float $$7, float $$8) {
      return a($$0.create($$1, $$3, $$2), $$1, $$2, $$5x -> $$5x.c($$4, $$5, $$6, $$7, $$8));
   }

   public static <T extends cpr> T a(T $$0, ard $$1, cwq $$2, double $$3, double $$4, double $$5, float $$6, float $$7) {
      return a($$0, $$1, $$2, $$6x -> $$0.c($$3, $$4, $$5, $$6, $$7));
   }

   public static <T extends cpr> T a(T $$0, ard $$1, cwq $$2) {
      return a($$0, $$1, $$2, $$0x -> {
      });
   }

   public static <T extends cpr> T a(T $$0, ard $$1, cwq $$2, Consumer<T> $$3) {
      $$3.accept($$0);
      $$1.b($$0);
      $$0.b($$1, $$2);
      return $$0;
   ...
   public void b(ard $$0, cwq $$1) {
      ddc.a($$0, $$1, this, $$0x -> {
      });
      if (this instanceof cpf $$2) {
         cwq $$3 = $$2.dZ();
   ...
   protected cps b(faz $$0) {
      ...
      } else if (this.C() && $$0 instanceof fax $$4 && $$4.f()) {
         cps $$5 = cps.b;
   ...
   protected void a(faz $$0) {
      ...
      if ($$1 == faz.a.c) {
         fay $$2 = (fay)$$0;
         bum $$3 = $$2.a();
         if ($$3.aq().a(awt.H) && $$3 instanceof cpr $$4) {
            $$4.a(cps.c, this.p(), this.p(), true);
         }

         this.a($$2);
         this.dV().a(ebu.J, $$0.g(), ebu.a.a(this, null));
      } else if ($$1 == faz.a.b) {
         fax $$5 = (fax)$$0;
         this.a($$5);
         ji $$6 = $$5.b();
         this.dV().a(ebu.J, $$6, ebu.a.a(this, this.dV().a_($$6)));
      }
   }
   ...
   public boolean c(ard $$0, ji $$1) {
      bum $$2 = this.p();
      return $$2 instanceof coy ? $$2.c($$0, $$1) : $$2 == null || $$0.O().b(dgf.c);
   }

   public boolean a(ard $$0) {
      return this.aq().a(awt.g) && $$0.O().b(dgf.g);
   }
   ...
   @FunctionalInterface
   public interface a<T extends cpr> {
      T create(ard var1, bvi var2, cwq var3);
   }
}
