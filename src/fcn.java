...
public class fcn extends fbt<chg> {
   private static final agi[] E = new agi[]{
      new agi("container/enchanting_table/level_1"), new agi("container/enchanting_table/level_2"), new agi("container/enchanting_table/level_3")
   };
   private static final agi[] F = new agi[]{
      new agi("container/enchanting_table/level_1_disabled"),
      new agi("container/enchanting_table/level_2_disabled"),
      new agi("container/enchanting_table/level_3_disabled")
   };
   private static final agi G = new agi("container/enchanting_table/enchantment_slot_disabled");
   private static final agi H = new agi("container/enchanting_table/enchantment_slot_highlighted");
   private static final agi I = new agi("container/enchanting_table/enchantment_slot");
   private static final agi J = new agi("textures/gui/container/enchanting_table.png");
   private static final agi K = new agi("textures/entity/enchanting_table_book.png");
   ...
   protected void aP_() {
      super.aP_();
      this.M = new fgy(this.f.aO().a(fkn.m));
   }
   ...
   private void d(euo $$0, int $$1, int $$2, float $$3) {
      float $$4 = atm.i($$3, this.D, this.C);
      float $$5 = atm.i($$3, this.z, this.y);
      ems.c();
      $$0.c().a();
      ...
      float $$8 = atm.a(atm.h($$5 + 0.25F) * 1.6F - 0.3F, 0.0F, 1.0F);
      float $$9 = atm.a(atm.h($$5 + 0.75F) * 1.6F - 0.3F, 0.0F, 1.0F);
      this.M.a(0.0F, $$8, $$9, $$4);
      eoa $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, gbl.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      ems.b();
   }
