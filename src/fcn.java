...
public enum fcn {
   ...
   private fcn(final String... $$0) {
      this.c = $$0;
   }

   public List<aur<InputStream>> a(atl $$0) throws IOException {
      return List.of(
   ...
   public aur<InputStream> b(atl $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aur<InputStream> a(atl $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      aur<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
