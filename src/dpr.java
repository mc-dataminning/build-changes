...
public class dpr implements dpq {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<dpr> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dkf.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dkh.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dkg.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bfv.b(1, 20).fieldOf("outer_wall_distance").orElse(bgb.a(4, 5)).forGetter($$0x -> $$0x.i),
               bfv.b(1, 20).fieldOf("distribution_points").orElse(bgb.a(3, 4)).forGetter($$0x -> $$0x.j),
               bfv.b(0, 10).fieldOf("point_offset").orElse(bgb.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dpr(dkf $$0, dkh $$1, dkg $$2, double $$3, double $$4, boolean $$5, bfv $$6, bfv $$7, bfv $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
