...
public class dpr {
   private static final dpr a = new dpr(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dpr.a a(int $$0, int $$1) {
         return new dpr.a(1.0, 0.0);
      }
   ...
   private static final edt b = edt.b(new dpq(42L), pi.a);
   ...
   private final Long2ObjectOpenHashMap<dps> h;
   private final Long2ObjectOpenHashMap<dps> i;

   public static dpr a() {
      return a;
   }

   public static dpr a(@Nullable ank $$0) {
      if ($$0 == null) {
         return a;
      } else {
         csv $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dps> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dps> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = aun.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dpr($$2, $$3);
         }
      }
   }

   dpr(Long2ObjectOpenHashMap<dps> $$0, Long2ObjectOpenHashMap<dps> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dpr.a a(int $$0, int $$1) {
      int $$2 = is.a($$0);
      int $$3 = is.a($$1);
      double $$4 = this.a($$2, 0, $$3, dps::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dpr.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(is.d(csv.a($$5x)), is.d(csv.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = aun.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = aun.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dpr.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(doi.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(is.d(csv.a($$6x)), is.d(csv.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = aun.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = aun.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return aun.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dpr.b $$3) {
      int $$4 = is.e($$0);
      int $$5 = is.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dpr.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dps $$6 = (dps)this.h.get(csv.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - is.d($$1), $$4, $$5 - is.d($$2)) : Double.MAX_VALUE;
   }

   public cuq a(cuq $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ih<cun> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ih<cun> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ih<cun>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(is.d(csv.a($$5x)), $$1, is.d(csv.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = aun.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = aun.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ih)$$4.getValue();
      }
   }

   public static void a(ank $$0, dlc $$1) {
      csv $$2 = $$1.f();
      boolean $$3 = $$1.s();
      hx.a $$4 = new hx.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dop.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dlc $$0, hx $$1) {
      djg $$2 = $$0.a_($$1);
      if ($$2.a(asg.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cuj $$0, dlx $$1) {
      csv $$2 = $$1.f();
      Builder<id, dps> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dol.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dpr.c a(@Nullable dps $$0, Map<id, dps> $$1) {
      List<dpr.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dpr.c a(@Nullable id $$0, dps $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ic $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return aun.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dps var1, int var2, int var3, int var4);
   }
