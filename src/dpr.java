...
public class dpr extends dpw {
   public static final Codec<dpr> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dpr::new));
   ...
   public List<doe.a> a(cms $$0, BiConsumer<gu, dcb> $$1, apf $$2, int $$3, gu $$4, dno $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dpr.a> $$13 = Lists.newArrayList();
      $$13.add(new dpr.a($$4.b($$12), $$11));
      ...
      List<doe.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cms $$0, BiConsumer<gu, dcb> $$1, apf $$2, gu $$3, gu $$4, boolean $$5, dno $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ...
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(cvy.g, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cms $$0, BiConsumer<gu, dcb> $$1, apf $$2, int $$3, gu $$4, List<dpr.a> $$5, dno $$6) {
      for (dpr.a $$7 : $$5) {
         int $$8 = $$7.a();
