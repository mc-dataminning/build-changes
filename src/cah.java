...
public class cah extends bzt {
   public static final double bT = 0.6;
   public static final double bU = 0.8;
   public static final double bW = 1.33;
   private static final cry bX = cry.a(cpc.qY, cpc.qZ);
   private static final aie<Boolean> bY = aih.a(cah.class, aig.k);
   @Nullable
   private cah.a<chh> bZ;
   @Nullable
   private cah.b ca;

   public cah(bnu<? extends cah> $$0, cvn $$1) {
      super($$0, $$1);
      this.w();
   }
   ...
   @Override
   protected void B() {
      this.ca = new cah.b(this, 0.6, bX, true);
      this.bO.a(1, new buv(this));
      this.bO.a(3, this.ca);
      this.bO.a(7, new bvh(this, 0.3F));
      this.bO.a(8, new bvr(this));
      this.bO.a(9, new bun(this, 0.8));
      this.bO.a(10, new bwo(this, 0.8, 1.0000001E-5F));
      this.bO.a(11, new bvj(this, chh.class, 10.0F));
      this.bP.a(1, new bwu<>(this, bzy.class, false));
      this.bP.a(1, new bwu<>(this, cau.class, 10, false, false, cau.bU));
   }
   ...
   public boolean B(bno $$0) {
      return $$0.a(this.dN().b((bog)this), this.gg());
   }
   ...
   protected void w() {
      if (this.bZ == null) {
         this.bZ = new cah.a<>(this, chh.class, 16.0F, 0.8, 1.33);
      }
   ...
   @Nullable
   public cah b(aov $$0, bnj $$1) {
      return bnu.as.a((cvn)$$0);
   }
   ...
   public static boolean c(bnu<cah> $$0, cvo $$1, bok $$2, hz $$3, awo $$4) {
      return $$4.a(3) != 0;
   }
   ...
   static class a<T extends bog> extends bui<T> {
      ...
      public a(cah $$0, Class<T> $$1, float $$2, double $$3, double $$4) {
   ...
   static class b extends bwj {
      ...
      public b(cah $$0, double $$1, cry $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
         this.c = $$0;
      }
