...
public class dpi extends djm implements dmi, dqs {
   ...
   protected void a(dgi $$0, dwx $$1, faw $$2, cpq $$3) {
      if (!$$0.C) {
         ji $$4 = $$2.b();
         if ($$0 instanceof arc $$5 && $$3.c($$5, $$4) && $$3.a($$5) && $$3 instanceof cqd && $$3.dz().g() > 0.6) {
            $$0.b($$4, true);
         }
      }
   }
   ...
   @VisibleForTesting
   public static void a(dwx $$0, arc $$1, ji $$2, float $$3) {
   ...
   private static void a(dwx $$0, arc $$1, ji $$2) {
      ji.a $$3 = $$2.k();
      dwx $$4 = $$0;
   ...
   @VisibleForTesting
   public static void c(dwx $$0, arc $$1, ji $$2, azh $$3) {
      dwx $$4 = $$1.a_($$2.b(1));
      dwx $$5 = $$1.a_($$2.b(2));
      if (a($$4, $$5)) {
   ...
   private static boolean b(dwx $$0, arc $$1, ji $$2) {
      jn $$3 = $$0.c(b);
      ji $$4 = $$2.a($$3);
      dwx $$5 = $$1.a_($$4);
      if (!$$5.y().c()) {
   ...
   public static esy a(arc $$0, ji $$1) {
