...
public abstract class dpi {
   ...
   public final void c(us $$0, jk.a $$1) {
      this.a($$0, $$1);
      dpi.a.a.parse($$1.a(vg.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final us d(jk.a $$0) {
      us $$1 = new us();
      this.b($$1, $$0);
      dpi.a.a.encodeStart($$0.a(vg.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((us)$$1x));
      return $$1;
   }
   ...
   public static void a(us $$0, dpk<?> $$1) {
      $$0.a("id", dpk.a($$1).toString());
   }

   public void a(cuq $$0, jk.a $$1) {
      us $$2 = this.e($$1);
      this.a($$2);
      cso.a($$0, this.r(), $$2);
      $$0.b(this.s());
   ...
   @Nullable
   public static dpi a(iz $$0, dsd $$1, us $$2, jk.a $$3) {
      String $$4 = $$2.l("id");
      alf $$5 = alf.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(dbz $$0, iz $$1, dsd $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
