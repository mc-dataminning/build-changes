...
public class us extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<tv> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, th.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<tv> $$0, Codec<T> $$1, th $$2) {
      tv $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> us a(DynamicOps<tv> $$0, Codec<T> $$1, T $$2) {
      tv $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = awc.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, xr<? super us, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, xs<? super us, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(xr<? super us, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, xr<? super us, K> $$1, xr<? super us, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(xr<? super us, K> $$0, xr<? super us, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, xs<? super us, K> $$1, xs<? super us, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, xs<? super us, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(xr<? super us, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(xr<? super us, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, xr<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, xs<? super us, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, xs<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, xs<? super us, L> $$1, xs<? super us, R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.encode(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(xr<? super us, L> $$0, xr<? super us, R> $$1) {
   ...
   public static ib b(ByteBuf $$0) {
      return ib.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, ib $$1) {
      $$0.writeLong($$1.a());
   }

   public cvl f() {
      return new cvl(this.readLong());
   }
   ...
   public eov k() {
      return new eov(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> us a(ToIntFunction<T> $$0, T $$1) {
   ...
   public static UUID e(ByteBuf $$0) {
   ...
   public us a(@Nullable tv $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable tv $$1) {
      if ($$1 == null) {
         $$1 = ta.b;
      }

      try {
         tl.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static sy f(ByteBuf $$0) {
      tv $$1 = a($$0, th.a(2097152L));
      if ($$1 != null && !($$1 instanceof sy)) {
   ...
   @Nullable
   public static tv a(ByteBuf $$0, th $$1) {
      try {
         tv $$2 = tl.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public us a(String $$0, int $$1) {
      vi.a(this.d, $$0, $$1);
      return this;
   }

   public ajc q() {
      return new ajc(this.d(32767));
   }
   ...
   public <T> ajb<T> a(ajb<? extends ix<T>> $$0) {
      ajc $$1 = this.q();
      return ajb.a($$0, $$1);
   }
   ...
   public eor v() {
      ...
      return new eor(new eov((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, awm.e($$1, 8)));
      }
   }
   ...
   public PropertyMap y() {
      PropertyMap $$0 = new PropertyMap();
      this.a((Consumer<us>)($$1 -> {
         Property $$2 = this.z();
         $$0.put($$2.name(), $$2);
      }));
      return $$0;
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), us::a);
   }

   public Property z() {
      String $$0 = this.p();
      String $$1 = this.p();
      String $$2 = this.c(us::p);
   ...
   public us a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public us a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public us a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public us a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public us a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public us a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public us a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public us a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public us b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public us c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public us d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public us e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public us f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public us g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public us h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public us a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public us b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public us i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public us a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public us a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public us b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public us b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public us b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public us b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public us b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public us b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public us g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public us b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public us a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public us a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public us a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public us a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public us a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public us h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public us c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public us b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public us b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public us b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
