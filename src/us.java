...
public class us implements tn {
   ...
   public us(String $$0, boolean $$1, Optional<tm> $$2, un $$3) {
      this($$0, a($$0), $$1, $$2, $$3);
   }

   private us(String $$0, @Nullable ej.g $$1, boolean $$2, Optional<tm> $$3, un $$4) {
      this.f = $$0;
      this.b = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof us $$1 && this.g.equals($$1.g) && this.e.equals($$1.e) && this.d == $$1.d && this.f.equals($$1.f)) {
            return true;
         }
   ...
   public tz a(@Nullable dt $$0, @Nullable biq $$1, int $$2) throws CommandSyntaxException {
      if ($$0 != null && this.b != null) {
         ...
         if (this.d) {
            tm $$4 = (tm)DataFixUtils.orElse(to.a($$0, this.e, $$1, $$2), to.c);
            return $$3.flatMap($$3x -> {
               try {
                  tz $$4x = tm.a.a($$3x);
            ...
            }).reduce(($$1x, $$2x) -> $$1x.b($$4).b($$2x)).orElseGet(tm::h);
         } else {
            return to.a($$0, this.e, $$1, $$2)
               .map($$1x -> $$3.map(tm::b).reduce(($$1xx, $$2x) -> $$1xx.b($$1x).b($$2x)).orElseGet(tm::h))
               .orElseGet(() -> tm.b($$3.collect(Collectors.joining(", "))));
         }
      } else {
         return tm.h();
      }
