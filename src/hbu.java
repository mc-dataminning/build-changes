...
public class hbu implements hbn {
   ...
   private hbu(List<alz> $$0, alz $$1, Map<String, alz> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(hbt a, Supplier<IntUnaryOperator> b, alz c) implements hbn.b {
      @Nullable
      public hbd a(hbm $$0) {
         Object var3;
         try {
            ffq $$1 = this.a.a().a(this.b.get());
            return new hbd(this.c, new hcx($$1.a(), $$1.b()), $$1, avx.a);
         } catch (IllegalArgumentException | IOException var7) {
            hbu.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
