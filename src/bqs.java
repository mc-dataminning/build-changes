...
public interface bqs<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements bqs<bqs.c> {
   ...
   public static final class b implements bqs<Runnable> {
      private final Queue<Runnable> a;
