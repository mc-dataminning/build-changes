...
public abstract class bqs<R extends Runnable> implements bpz, bqy<R>, Executor {
   ...
   @Override
   public List<bpw> bw() {
      return ImmutableList.of(bpw.a(this.b + "-pending-tasks", bpv.b, this::by));
   }
