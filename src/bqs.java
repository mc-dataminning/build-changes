...
public class bqs extends bqx {
   public static final MapCodec<bqs> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bqs a(float $$0, float $$1, int $$2, int $$3) {
      return new bqs($$0, $$1, $$2, $$3);
   }

   private bqs(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(azn $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)azf.a(azf.c($$0, $$1, $$2), $$3, $$4);
   }
