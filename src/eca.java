...
public record eca(jr<ebt> b, float c, fba d, @Nullable UUID e, @Nullable UUID f, @Nullable buk g) {
   ...
   public eca(jr<ebt> $$0, float $$1, fba $$2, @Nullable buk $$3) {
   ...
   public Optional<buk> a(arc $$0) {
      return Optional.ofNullable(this.g).or(() -> Optional.ofNullable(this.e).map($$0::a));
   }

   public Optional<buk> b(arc $$0) {
