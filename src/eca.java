...
public class eca implements ecb, ecc {
   ...
   private final egq<MinecraftServer> K;
   ...
   public eca(cpp $$0, dlg $$1, eca.a $$2, Lifecycle $$3) {
      this(
         null,
         aa.b().d().c(),
         null,
   ...
   public static <T> eca a(Dynamic<T> $$0, DataFixer $$1, int $$2, @Nullable qr $$3, cpp $$4, eby $$5, eca.a $$6, dlg $$7, Lifecycle $$8) {
      ...
      return new eca(
         ...
         new egq<>(egp.a, $$0.get("ScheduledEvents").asStream()),
         (qr)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dil.a.a).resultOrPartial(e::error).orElse(dil.a.b),
         $$4,
         $$7,
         $$6,
         $$8
   ...
   private void a(hs $$0, qr $$1, @Nullable qr $$2) {
      ...
      dle.a($$4, this.g, $$0).resultOrPartial(ac.a("WorldGenSettings: ", e::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dil.a.a.encodeStart(rc.a, this.C), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<rk> $$5 = cqe.b.encodeStart(rc.a, this.f.g());
   ...
   @Override
   public boolean B() {
      return this.h == eca.a.b;
   }

   @Override
   public boolean C() {
      return this.h == eca.a.c;
   }
