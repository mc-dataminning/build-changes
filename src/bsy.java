...
public class bsy extends btd {
   ...
   public static bsy a(float $$0, float $$1, int $$2, int $$3) {
      return new bsy($$0, $$1, $$2, $$3);
   }

   private bsy(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(azt $$0, float $$1, float $$2, float $$3, float $$4) {
