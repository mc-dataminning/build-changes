...
public class hix extends MinecraftServer {
   ...
   public hix(Thread $$0, flh $$1, evd.c $$2, atz $$3, alt $$4, alp $$5, arn $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hiw(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (ard $$1 : Lists.newArrayList(this.ag().t())) {
   ...
   @Override
   public dgd bd() {
      return this.r() && !this.w_() ? (dgd)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
