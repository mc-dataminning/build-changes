...
public abstract class bzy extends bzl {
   ...
   public bzy(bsw $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bzy(bsw $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
   ...
   public void c() {
      this.h();
      this.d = 0;
      this.j = this.a.et().a(this.a.et().a(1200) + 1200) + 1200;
   }
   ...
   protected abstract boolean a(dcd var1, ir var2);
}
