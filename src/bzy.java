...
public class bzy extends caf {
   private static final int g = 240;
   private final Predicate<bqs> h;
   protected int a;
   protected int b = -1;
   protected int c = -1;

   public bzy(bts $$0, Predicate<bqs> $$1) {
      super($$0);
      this.h = $$1;
   }

   public bzy(bts $$0, int $$1, Predicate<bqs> $$2) {
      this($$0, $$2);
      this.c = $$1;
   }
   ...
   public boolean a() {
      if (!super.a()) {
         ...
         return !this.d.dP().ab().b(dbv.c) ? false : this.a(this.d.dP().al()) && !this.h();
      }
   }
   ...
   public void e() {
      ...
      if (this.a == this.f() && this.a(this.d.dP().al())) {
         ...
         this.d.dP().c(2001, this.e, dfa.i(this.d.dP().a_(this.e)));
      }
   }

   private boolean a(bqs $$0) {
