...
public class faz implements kb {
   public static final Codec<faz> a = Codec.DOUBLE
      .listOf()
      .comapFlatMap(
         $$0 -> af.a($$0, 3).map($$0x -> new faz((Double)$$0x.get(0), (Double)$$0x.get(1), (Double)$$0x.get(2))), $$0 -> List.of($$0.a(), $$0.b(), $$0.c())
      );
   public static final yn<ByteBuf, faz> b = new yn<ByteBuf, faz>() {
      public faz a(ByteBuf $$0) {
         return vl.f($$0);
      }

      public void a(ByteBuf $$0, faz $$1) {
         vl.a($$0, $$1);
      }
   };
   public static final faz c = new faz(0.0, 0.0, 0.0);
   ...
   public static faz a(km $$0) {
      return new faz((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static faz a(km $$0, double $$1, double $$2, double $$3) {
      return new faz((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static faz b(km $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static faz c(km $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static faz a(km $$0, double $$1) {
      return a($$0, 0.5, $$1, 0.5);
   }

   public faz(double $$0, double $$1, double $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
   }

   public faz(Vector3f $$0) {
   ...
   public faz a(faz $$0) {
      return new faz($$0.d - this.d, $$0.e - this.e, $$0.f - this.f);
   }

   public faz d() {
      double $$0 = Math.sqrt(this.d * this.d + this.e * this.e + this.f * this.f);
      return $$0 < 1.0E-5F ? c : new faz(this.d / $$0, this.e / $$0, this.f / $$0);
   }

   public double b(faz $$0) {
      return this.d * $$0.d + this.e * $$0.e + this.f * $$0.f;
   }

   public faz c(faz $$0) {
      return new faz(this.e * $$0.f - this.f * $$0.e, this.f * $$0.d - this.d * $$0.f, this.d * $$0.e - this.e * $$0.d);
   }
   ...
   public faz a(double $$0) {
      return this.a($$0, $$0, $$0);
   }

   public faz a(double $$0, double $$1, double $$2) {
      return this.b(-$$0, -$$1, -$$2);
   }

   public faz b(double $$0) {
      return this.b($$0, $$0, $$0);
   }
   ...
   public faz b(double $$0, double $$1, double $$2) {
      return new faz(this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public boolean a(faz $$0, double $$1, double $$2) {
      double $$3 = $$0.a() - this.d;
      double $$4 = $$0.b() - this.e;
      double $$5 = $$0.c() - this.f;
   ...
   public faz d(double $$0, double $$1, double $$2) {
      return new faz(this.d * $$0, this.e * $$1, this.f * $$2);
   }

   public faz f() {
      return new faz(this.d, 0.0, this.f);
   }

   public faz a(azh $$0, float $$1) {
   ...
   public faz a(faz $$0, double $$1) {
      return new faz(ayz.d($$1, this.d, $$0.d), ayz.d($$1, this.e, $$0.e), ayz.d($$1, this.f, $$0.f));
   }
   ...
   public static faz a(fay $$0) {
      return a($$0.i, $$0.j);
   }

   public static faz a(float $$0, float $$1) {
      ...
      return new faz((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public faz a(EnumSet<jn.a> $$0) {
   ...
   public faz a(jn.a $$0, double $$1) {
      double $$2 = $$0 == jn.a.a ? $$1 : this.d;
      double $$3 = $$0 == jn.a.b ? $$1 : this.e;
      double $$4 = $$0 == jn.a.c ? $$1 : this.f;
      return new faz($$2, $$3, $$4);
   }

   public faz a(jn $$0, double $$1) {
      km $$2 = $$0.q();
      return new faz(this.d + $$1 * (double)$$2.u(), this.e + $$1 * (double)$$2.v(), this.f + $$1 * (double)$$2.w());
   }
