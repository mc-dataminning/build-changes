...
public abstract class faz<T extends faz<T>> {
   ...
   public faz(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fax.a();
         if ($$3 != null) {
         ...
         throw new fci(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fci(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fci(var2.getMessage(), var2);
      }
   }
   ...
   public static faz<?> a(String $$0) {
      return new faz.b($$0, 5000, 60000);
   }

   public static faz<?> a(String $$0, int $$1, int $$2) {
      return new faz.b($$0, $$1, $$2);
   }

   public static faz<?> b(String $$0, String $$1) {
      return new faz.c($$0, $$1, 5000, 60000);
   }

   public static faz<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new faz.c($$0, $$1, $$2, $$3);
   }

   public static faz<?> b(String $$0) {
      return new faz.a($$0, 5000, 60000);
   }

   public static faz<?> c(String $$0, String $$1) {
      return new faz.d($$0, $$1, 5000, 60000);
   }

   public static faz<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new faz.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends faz<faz.a> {
   ...
   public static class b extends faz<faz.b> {
   ...
   public static class c extends faz<faz.c> {
      ...
      public faz.c f() {
         try {
            ...
            throw new fci(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends faz<faz.d> {
      private final String c;
