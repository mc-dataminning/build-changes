...
public class faz {
   ...
   public void a(fcj $$0, String $$1, fdg.a $$2, eqi $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  faz.b $$13 = new faz.b($$1.trim(), this.f, $$3, $$2);
                  faz.a $$14 = new faz.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        faz.c $$30 = new faz.c(this.f, $$2, $$0);
                        faz.a $$31 = new faz.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fcn(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eqi $$2) throws IOException {
      ...
      File $$15 = new File(fft.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final eqi $$2, final fdg.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((faz.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !faz.this.b && !faz.this.d) {
            try {
               faz.this.e = true;
               faz.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               faz.a.error("Error extracting archive", var3);
               faz.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fdg.a c;
      private final fcj d;

      c(final File $$0, final fdg.a $$1, final fcj $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((faz.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !faz.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, faz.this.g);
                  faz.this.c = true;
               } else {
                  faz.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  faz.this.d = true;
               }
            } catch (IOException var3) {
               faz.a.error("Error copying resourcepack file: {}", var3.getMessage());
               faz.this.d = true;
            }
         }
      }
