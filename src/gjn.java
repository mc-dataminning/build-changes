...
public class gjn extends eca {
   ...
   public gjn(gjr $$0, int $$1) {
      this.e = $$0;
      this.b = new ecc($$0, new dic(0, 0), $$0.F_().f(mg.aG).b(dkf.b));
      this.c = new evv(this, true, $$0.B_().g());
      this.d = new gjn.a(b($$1));
   }
   ...
   private static boolean a(@Nullable ecg $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dic $$3 = $$0.f();
   ...
   @Nullable
   public ecg b(int $$0, int $$1, ecx $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         ecg $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public ecg a(int $$0, int $$1, vu $$2, tz $$3, Consumer<adf.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         ecg $$6 = this.d.b.get($$5);
         dic $$7 = new dic($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new ecg(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<ecg> b;
      ...
      void a(int $$0, @Nullable ecg $$1) {
         ecg $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gjn.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  ecg $$5 = gjn.this.d.b.get(gjn.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dic $$6 = $$5.f();
            ...
            gjn.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
