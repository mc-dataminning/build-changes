public class gjn extends gjd {
   gjn(gfj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, gjm $$8) {
   ...
   public static class a implements giu<lw> {
      ...
      public gir a(lw $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjn($$1, $$2, $$3, $$4, $$5, $$6, $$7, ayp.a(255, 204, 31, 102), this.a);
      }
   }
   ...
   public static class b implements giu<lw> {
      ...
      public gir a(lw $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjn($$1, $$2, $$3, $$4, $$5, $$6, $$7, ayp.a(255, 255, 255, 255), this.a);
      }
   }
}
