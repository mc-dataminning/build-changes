...
public record gjn(Map<String, String> c, Set<String> d) {
   public static final gjn a = new gjn(Map.of(), Set.of());
   public static final Codec<gjn> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gjn::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gjn::e)
            )
            .apply($$0, gjn::new)
   );

   public static gjn.a a() {
      return new gjn.a();
   }
   ...
   public gjn a(gjn $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gjn($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gjn.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gjn.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gjn.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gjn a() {
         return new gjn(this.a.build(), this.b.build());
      }
   }
}
