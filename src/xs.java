...
public record xs<S>(List<xs.a<S>> a) {
   public static <S> boolean a(ParseResults<S> $$0) {
      return !b($$0).a().isEmpty();
   }

   public static <S> xs<S> b(ParseResults<S> $$0) {
   ...
   private static <S> List<xs.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<xs.a<S>> $$2 = new ArrayList<>();
