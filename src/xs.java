...
public record xs(int b, UUID c, UUID d) {
   public static final Codec<xs> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(axm.i.fieldOf("index").forGetter(xs::b), jr.a.fieldOf("sender").forGetter(xs::c), jr.a.fieldOf("session_id").forGetter(xs::d))
            .apply($$0, xs::new)
   );
   ...
   public void a(ayo.a $$0) throws SignatureException {
