...
public interface fyw {
   static fyw a(fzc $$0, UserApiService $$1) {
      return new fyw.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, fze var2, AbuseReport var3);
   ...
   public static record b(fzc a, UserApiService b) implements fyw {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, fze $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               xp $$5 = this.a(var7);
               throw new CompletionException(new fyw.a($$5, var7));
            } catch (MinecraftClientException var8) {
               xp $$7 = this.a(var8);
               throw new CompletionException(new fyw.a($$7, var8));
            }
         }, ac.h());
      }
