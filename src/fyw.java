...
public class fyw implements fyp {
   static final Logger c = LogUtils.getLogger();
   public static final Codec<fyw> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
   ...
   private fyw(List<aer> $$0, aer $$1, Map<String, aer> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(fyv a, Supplier<IntUnaryOperator> b, aer c) implements fyp.b {
      @Nullable
      public fyf a(fyo $$0) {
         Object var3;
         try {
            ekh $$1 = this.a.a().a(this.b.get());
            return new fyf(this.c, new fzy($$1.a(), $$1.b()), $$1, ano.a);
         } catch (IllegalArgumentException | IOException var7) {
            fyw.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
