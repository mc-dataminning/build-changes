...
public class ark implements AutoCloseable {
   ...
   private ark(URL $$0, ark.c $$1, URL $$2, ark.b $$3, URL $$4, ark.b $$5, String $$6, ark.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? axm.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static ark a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = axm.a($$0);
            URI $$2 = new URI(axm.i($$1, "apiServer"));
            String $$3 = axm.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axm.a($$1, "ruleId", 1);
               String $$5 = axm.a($$1, "serverId", "");
               String $$6 = axm.a($$1, "roomId", "Java:Chat");
               int $$7 = axm.a($$1, "hashesToDrop", -1);
               int $$8 = axm.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axm.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, ark.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<aqw> a(GameProfile $$0, String $$1, ark.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(aqw.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = axm.a($$4, "response", false);
            if ($$5) {
               return aqw.a($$1);
            } else {
               String $$6 = axm.a($$4, "hashed", null);
               if ($$6 == null) {
                  return aqw.b($$1);
               } else {
                  JsonArray $$7 = axm.v($$4, "hashes");
                  ww $$8 = this.a($$1, $$7, $$2);
                  return new aqw($$1, $$8);
               }
            }
   ...
   private ww a(String $$0, JsonArray $$1, ark.a $$2) {
      if ($$1.isEmpty()) {
         return ww.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return ww.b;
      } else {
         ww $$3 = new ww($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ark.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public arj a(GameProfile $$0) {
      return new ark.d($$0);
   }
   ...
   public interface a {
      ark.a a = ($$0, $$1) -> false;
      ark.a b = ($$0, $$1) -> $$0.length() == $$1;

      static ark.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static ark.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements arj {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bnj<Runnable> $$1 = bnj.a(ark.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         ark.this.a(this.c, ark.this.g, ark.this.h, this.d);
      }

      @Override
      public void b() {
         ark.this.a(this.c, ark.this.i, ark.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<aqw>> a(List<String> $$0) {
         List<CompletableFuture<aqw>> $$1 = $$0.stream().map($$0x -> ark.this.a(this.c, $$0x, ark.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<aqw> a(String $$0) {
         return ark.this.a(this.c, $$0, ark.this.l, this.d);
      }
   }
