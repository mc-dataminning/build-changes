...
public class ark extends ary {
   public static final arn<dzs> a = arn.a("Unloaded level chunk");
   private static final CompletableFuture<arn<dzs>> e = CompletableFuture.completedFuture(a);
   private final dhc f;
   private volatile CompletableFuture<arn<dzs>> g = e;
   private volatile CompletableFuture<arn<dzs>> h = e;
   private volatile CompletableFuture<arn<dzs>> i = e;
   private int j;
   private int k;
   private int l;
   private boolean m;
   ...
   public ark(dgg $$0, int $$1, dhc $$2, ete $$3, ark.a $$4, ark.b $$5) {
      super($$0);
      this.f = $$2;
      this.q = $$3;
      this.r = $$4;
   ...
   public CompletableFuture<arn<dzs>> a() {
      return this.h;
   }

   public CompletableFuture<arn<dzs>> b() {
      return this.i;
   }

   public CompletableFuture<arn<dzs>> c() {
      return this.g;
   }
   ...
   public boolean a(dhj $$0, int $$1) {
      ...
      if ($$2 == null) {
         ...
         if ($$3 == null) {
            ...
            int $$5 = this.q.e();
            if ($$1 >= $$4 && $$1 <= $$5) {
               BitSet $$6 = $$0 == dhj.a ? this.p : this.o;
               int $$7 = $$1 - $$4;
               if (!$$6.get($$7)) {
                  $$6.set($$7);
                  return true;
   ...
   public void a(dzs $$0) {
      if (this.m || !this.p.isEmpty() || !this.o.isEmpty()) {
         ...
         if (!this.p.isEmpty() || !this.o.isEmpty()) {
            ...
            if (!$$2.isEmpty()) {
               aeh $$3 = new aeh($$0.f(), this.q, this.p, this.o);
               this.a($$2, $$3);
            }
         ...
         if (this.m) {
            List<asi> $$4 = this.s.a(this.d, false);
   ...
   private void a(List<asi> $$0, dha $$1, jh $$2, dxn $$3) {
      if ($$3.x()) {
         this.a($$0, $$1, $$2);
      }
   }

   private void a(List<asi> $$0, dha $$1, jh $$2) {
      dup $$3 = $$1.c_($$2);
      if ($$3 != null) {
         aac<?> $$4 = $$3.ay_();
         if ($$4 != null) {
   ...
   private void a(List<asi> $$0, aac<?> $$1) {
   ...
   private void a(arm $$0, CompletableFuture<arn<dzs>> $$1, Executor $$2, arw $$3) {
      this.u.cancel(false);
   ...
   private void a(arm $$0, arw $$1) {
      this.u.cancel(false);
      $$0.a(this.d, $$1);
   }

   protected void a(arm $$0, Executor $$1) {
      arw $$2 = arl.c(this.j);
      arw $$3 = arl.c(this.k);
      boolean $$4 = $$2.a(arw.b);
      boolean $$5 = $$3.a(arw.b);
   ...
   public interface b {
      List<asi> a(dgg var1, boolean var2);
   }
}
