...
public class ark extends arj {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, ark.a> s;
   private final arf t;
   private long u;
   private final ahw v;

   private ark(ahw $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == arg.c($$2, 7, $$0.getLength());
      }
   }
