...
public class ark implements dhg {
   ...
   public ark(arc $$0, azt<aqt> $$1, dzw $$2, dys $$3) {
      this.m = $$2;
      this.b = $$1;
      this.c = $$3;
      this.d = $$0;
   ...
   @Nullable
   @Override
   public cox a(double $$0, double $$1, double $$2, double $$3, Predicate<buk> $$4) {
      return null;
   }
   ...
   @Override
   public List<buk> a(@Nullable buk $$0, fav $$1, @Nullable Predicate<? super buk> $$2) {
      return Collections.emptyList();
   }
