...
public interface ark {
   ark a = new ark() {
      ...
      @Override
      public void a(Consumer<djo> $$0) {
      }
   };

   static ark a(djo $$0, int $$1) {
      return new ark.a($$0, $$1);
   }

   static void a(ark $$0, ark $$1, Consumer<djo> $$2, Consumer<djo> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof ark.a $$4 && $$1 instanceof ark.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new djo($$10, $$11));
                     } else {
                        $$3.accept(new djo($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(djo b, int c) implements ark {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(ark.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return ark.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
