...
public class ark {
   ...
   private static List<ark.b> a(final Path $$0) throws IOException {
      try {
         final List<ark.b> $$1 = new ArrayList<>();
   ...
   private static List<ark.a> a(List<ark.b> $$0) {
      List<ark.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (ark.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new ark.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<ark.a> a = Comparator.comparing(ark.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<ark.b> a = Comparator.comparing(ark.b::b).reversed();
