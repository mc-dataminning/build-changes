...
public class fvv implements hqe {
   private static final long a = 3000L;
   private final frf b;
   private final List<fvv.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fvv.b> e = new ArrayList<>();
   ...
   public void a(ftz $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fvv.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hoz $$0, hqg $$1, float $$2) {
      if ($$1.a() != null) {
         xc $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fvv.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new ffs($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fvv.b($$3, $$2, new ffs($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(ffs a, long b) {
   }

   static class b {
      private final xc a;
      private final float b;
      private final List<fvv.a> c = new ArrayList<>();

      public b(xc $$0, float $$1, ffs $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fvv.a($$2, ag.c()));
      }
      ...
      public void b(ffs $$0) {
         ...
         this.c.add(new fvv.a($$0, ag.c()));
      }

      public boolean c(ffs $$0) {
