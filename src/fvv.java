...
public class fvv extends fvz {
   public static final ald a = ald.b("textures/gui/title/mojangstudios.png");
   private static final int d = axu.a(255, 239, 50, 61);
   private static final int e = axu.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> fnd.Q().n.a().c() ? e : d;
   ...
   public fvv(fnd $$0, auv $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fpz $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(goi.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(goi.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = axu.a($$10);
      $$0.a($$0x -> goi.P(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> goi.P(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
   ...
   private void a(fpz $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends hgj {
      public a() {
         super(fvv.a);
      }

      @Override
      public hgt a(ava $$0) throws IOException {
         avd $$1 = fnd.Q().ae().d();

         hgt var4;
         try (InputStream $$2 = $$1.open(fvv.a)) {
            var4 = new hgt(fgo.a($$2), new hip(true, true));
         }
