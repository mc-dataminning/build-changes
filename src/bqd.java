...
public class bqd {
   ...
   public static bog<bmx> a(float $$0) {
      ...
      return brs.a(
         (Function<brs.b<bmx>, ? extends App<brs.c<bmx>, brv<bmx>>>)($$3 -> $$3.group($$3.c(bvq.m), $$3.c(bvq.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.X() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        bxq $$7 = $$4x.y();
                        Optional<hx> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(bxu.n), $$5.dl(), 48, bxq.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dl()) <= 4.0)) {
                           ...
                           Set<Pair<ih<bxt>, hx>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(bxu.n), $$10, $$5.dl(), 48, bxq.b.c).collect(Collectors.toSet());
                           efo $$12 = bny.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              hx $$13 = $$12.l();
                              Optional<ih<bxt>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new bvt($$13, $$0, 1));
                                 adj.c($$4x, $$13);
                              }
