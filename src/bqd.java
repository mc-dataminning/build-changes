...
public class bqd {
   ...
   private static void a(bql $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bqg $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bqm> $$0) {
      JsonObject $$1 = new JsonObject();
      bqq<bqm> $$2 = bqq.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bqm::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bqq<bqm> $$6 = bqq.a((List<bqm>)$$4);
         ...
         Function<bqm, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<ean, bqq<bqf>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqq)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<ean, bqq<bqf>> $$3 : $$0) {
         bqq<bqf> $$4 = (bqq<bqf>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((ean)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<bqo> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bps.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bqb $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bqd::a));
      $$1.add("chunksWritten", this.a($$0.m(), bqd::a));
      return $$1;
   }

   private JsonElement a(bqi.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bqb $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bqd::a));
      $$1.add("received", this.a($$0.k(), bqd::a));
      return $$1;
   }

   private <T> JsonElement a(bqk<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bqh> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bqh>, ToDoubleFunction<bqh>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bqh::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bqh::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bqh::c));
      return $$1;
   }
}
