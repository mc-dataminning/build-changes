...
public class bqd {
   ...
   private JsonElement a(List<bqm> $$0) {
      ...
      $$0.stream().collect(Collectors.groupingBy(bqm::c)).forEach(($$3x, $$4) -> {
         ...
         JsonObject $$7 = ae.a(new JsonObject(), $$1xx -> $$5.add("durationNanosPercentiles", $$1xx));
   ...
   private JsonElement b(List<Pair<eak, bqq<bqf>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqq)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ae.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<eak, bqq<bqf>> $$3 : $$0) {
         bqq<bqf> $$4 = (bqq<bqf>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((eak)$$3.getFirst()).toString());
         $$5.addProperty("count", $$4.d());
         $$5.addProperty("durationNanosTotal", $$4.f().toNanos());
         $$5.addProperty("durationNanosAvg", $$4.f().toNanos() / (long)$$4.d());
         JsonObject $$6 = ae.a(new JsonObject(), $$1x -> $$5.add("durationNanosPercentiles", $$1x));
   ...
   private JsonElement a(bqn.a $$0) {
      ...
      $$0.a().forEach(($$1x, $$2) -> $$1.add(ae.a(new JsonObject(), $$2x -> {
