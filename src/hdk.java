...
public abstract class hdk extends fqd {
   ...
   private final List<hdi> a = Lists.newArrayList();
   ...
   protected hdi a(hdi $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xd m() {
      return xc.a(this.a.stream().map(hdi::a).collect(Collectors.toList()));
   }
}
