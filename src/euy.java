...
public class euy {
   ...
   @Deprecated
   public static euy a(azt $$0, euy.a $$1) {
      return new euy($$0, $$1, false);
   }

   public static euy a(azt $$0, int $$1, double... $$2) {
      return b($$0, new euy.a($$1, new DoubleArrayList($$2)));
   }

   public static euy b(azt $$0, euy.a $$1) {
      return new euy($$0, $$1, true);
   }

   private euy(azt $$0, euy.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<euy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(euy.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(euy.a::b))
               .apply($$0, euy.a::new)
      );
      public static final Codec<je<euy.a>> b = ala.a(mg.aW, a);
