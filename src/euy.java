...
public class euy {
   ...
   public void a(evi $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == evi.a) {
            ezl.b($$1, ezl.a.a, vf.c("narrator.toast.disabled"), null);
         } else {
            ezl.b($$1, ezl.a.a, vf.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         ezl.b($$1, ezl.a.a, vf.c("narrator.toast.disabled"), vf.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new euy.a("Narrator library is not active");
      }
   }
