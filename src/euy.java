...
public class euy implements Comparable<euy> {
   private static final Map<String, euy> h = Maps.newHashMap();
   private static final Map<eoo.a, euy> i = Maps.newHashMap();
   ...
   private final eoo.a m;
   private final String n;
   private eoo.a o;
   private boolean p;
   private int q;

   public static void a(eoo.a $$0) {
      euy $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(eoo.a $$0, boolean $$1) {
      euy $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (euy $$0 : h.values()) {
         if ($$0.o.a() == eoo.b.a && $$0.o.b() != eoo.bv.b()) {
            $$0.a(eoo.a(eva.N().aL().i(), $$0.o.b()));
         }
      }
   }
   ...
   public euy(String $$0, int $$1, String $$2) {
      this($$0, eoo.b.a, $$1, $$2);
   }

   public euy(String $$0, eoo.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(eoo.a $$0) {
      this.o = $$0;
   }

   public int a(euy $$0) {
      return this.n.equals($$0.n) ? gfl.a(this.l).compareTo(gfl.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<vd> a(String $$0) {
      euy $$1 = h.get($$0);
      return $$1 == null ? () -> vd.c($$0) : $$1::k;
   }

   public boolean b(euy $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(eoo.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == eoo.bv.b() ? this.o.a() == eoo.b.b && this.o.b() == $$1 : this.o.a() == eoo.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == eoo.b.c && this.o.b() == $$0;
   }
