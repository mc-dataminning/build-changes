...
public class enf extends eng {
   ...
   public static final MapCodec<enf> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ene.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, enf::new)
   );
   private final ene h;

   public enf(btg $$0, enj $$1, Optional<end> $$2, ene $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(djb $$0, BiConsumer<iu, dzz> $$1, azv $$2, iu $$3, iu $$4, eme $$5) {
   ...
   private boolean a(djb $$0, azv $$1, iu $$2, ja $$3, iu $$4, List<iu> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
