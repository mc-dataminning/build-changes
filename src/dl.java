...
public record dl(@Nullable Float c, @Nullable Float d) {
   public static final dl a = new dl(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wi.c("argument.range.ints"));

   public static dl a(float $$0) {
      return new dl($$0, $$0);
   }

   public static dl a(float $$0, float $$1) {
      return new dl($$0, $$1);
   }

   public static dl b(float $$0) {
      return new dl($$0, null);
   }

   public static dl c(float $$0) {
      return new dl(null, $$0);
   }
   ...
   public static dl a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (axc.b($$0)) {
         float $$1 = axc.e($$0, "value");
         return new dl($$1, $$1);
      } else {
         JsonObject $$2 = axc.m($$0, "value");
         Float $$3 = $$2.has("min") ? axc.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? axc.m($$2, "max") : null;
         return new dl($$3, $$4);
      }
   }

   public static dl a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static dl a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         throw cm.a.createWithContext($$0);
      } else {
         int $$3 = $$0.getCursor();
         Float $$4 = a(b($$0, $$1), $$2);
         Float $$5;
