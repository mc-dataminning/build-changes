...
public class dl implements BuiltInExceptionProvider {
   ...
   private static final SimpleCommandExceptionType j = new SimpleCommandExceptionType(sw.c("parsing.quote.expected.start"));
   private static final SimpleCommandExceptionType k = new SimpleCommandExceptionType(sw.c("parsing.quote.expected.end"));
   ...
   private static final SimpleCommandExceptionType o = new SimpleCommandExceptionType(sw.c("parsing.int.expected"));
   private static final DynamicCommandExceptionType p = new DynamicCommandExceptionType($$0 -> sw.a("parsing.long.invalid", $$0));
   private static final SimpleCommandExceptionType q = new SimpleCommandExceptionType(sw.c("parsing.long.expected"));
   private static final DynamicCommandExceptionType r = new DynamicCommandExceptionType($$0 -> sw.a("parsing.double.invalid", $$0));
   private static final SimpleCommandExceptionType s = new SimpleCommandExceptionType(sw.c("parsing.double.expected"));
   private static final DynamicCommandExceptionType t = new DynamicCommandExceptionType($$0 -> sw.a("parsing.float.invalid", $$0));
   private static final SimpleCommandExceptionType u = new SimpleCommandExceptionType(sw.c("parsing.float.expected"));
   private static final SimpleCommandExceptionType v = new SimpleCommandExceptionType(sw.c("parsing.bool.expected"));
   private static final DynamicCommandExceptionType w = new DynamicCommandExceptionType($$0 -> sw.a("parsing.expected", $$0));
   private static final SimpleCommandExceptionType x = new SimpleCommandExceptionType(sw.c("command.unknown.command"));
   private static final SimpleCommandExceptionType y = new SimpleCommandExceptionType(sw.c("command.unknown.argument"));
   private static final SimpleCommandExceptionType z = new SimpleCommandExceptionType(sw.c("command.expected.separator"));
