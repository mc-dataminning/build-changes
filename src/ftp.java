...
public abstract class ftp<T extends biy, M extends feo<T>> extends fsn<T> implements fuj<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<fww<T, M>> g = Lists.newArrayList();

   public ftp(fso.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(fww<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, elg $$3, fnl $$4, int $$5) {
      ...
      eqm $$17 = eqm.O();
      boolean $$18 = this.d($$0);
      boolean $$19 = !$$18 && !$$0.d($$17.v);
      boolean $$20 = $$17.b($$0);
      fnt $$21 = this.a($$0, $$18, $$19, $$20);
      if ($$21 != null) {
         elk $$22 = $$4.getBuffer($$21);
         int $$23 = c($$0, this.b($$0, $$2));
         this.f.a($$3, $$22, $$5, $$23, 1.0F, 1.0F, 1.0F, $$19 ? 0.15F : 1.0F);
      }

      if (!$$0.G_()) {
         for (fww<T, M> $$24 : this.g) {
   ...
   @Nullable
   protected fnt a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      aer $$4 = this.a($$0);
      if ($$2) {
         return fnt.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? fnt.q($$4) : null;
      }
   }

   public static int c(biy $$0, float $$1) {
      return fyc.a(fyc.a($$1), fyc.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected void a(T $$0, elg $$1, float $$2, float $$3, float $$4) {
      if (this.a($$0)) {
