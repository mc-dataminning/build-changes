...
public class gpn implements ave, AutoCloseable {
   ...
   private final gsd j;
   private final gqa k;
   private final gqo l = new gqo();
   private final gpa m = new gpa();
   private final gqu n = new gqu();
   private final gqt o = new gqt();
   @Nullable
   private gjr p;
   private final gqh q = new gqh();
   private final ObjectArrayList<gth.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gth.b> s = new ObjectArrayList(50);
   private final Set<dwx> t = Sets.newHashSet();
   @Nullable
   private gqr u;
   private int v;
   ...
   private gth I;
   private int J = -1;
   private final List<bwd> K = new ArrayList<>();
   private int L;
   private gtl M;
   private boolean N;
   @Nullable
   ...
   public gpn(fos $$0, gvx $$1, gsd $$2, gqa $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void a() {
      ...
      this.y = new fhn(this.h.aO().k(), this.h.aO().l(), true);
   ...
   public void e() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gth(this.p, this, af.h(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
         ...
         this.u = new gqr(this.I, this.p, this.h.n.aH(), this);
         this.q.a(this.u);
         this.B();
         fnz $$0 = this.h.j.k();
         this.u.a(jx.a($$0.b()));
   ...
   private void a(fnz $$0, gtl $$1, boolean $$2, boolean $$3) {
      fei $$4 = $$0.b();
   ...
   public static gtl a(gtl $$0) {
      return new gtl($$0).a(8);
   }

   private void b(gtl $$0) {
      if (!fos.Q().bx()) {
         throw new IllegalStateException("applyFrustum called from wrong thread: " + Thread.currentThread().getName());
      } else {
         bql.a().a("apply_frustum");
         this.B();
   ...
   public void a(gth.b $$0) {
      this.q.a($$0);
   }

   public void a(fei $$0, Matrix4f $$1, Matrix4f $$2) {
      this.M = new gtl($$1, $$2);
      this.M.a($$0.a(), $$0.b(), $$0.c());
   }

   public void a(fil $$0, foh $$1, boolean $$2, fnz $$3, gpi $$4, Matrix4f $$5, Matrix4f $$6) {
      float $$7 = $$1.a(false);
      ...
      gtl $$14 = $$13 ? this.O : this.M;
      bql.a().b("captureFrustum");
      if (this.N) {
         this.O = $$13 ? new gtl($$5, $$6) : $$14;
         this.O.a($$10, $$11, $$12);
         this.N = false;
      }
      ...
      Vector4f $$17 = gph.a($$3, $$7, this.h.s, this.h.n.aH(), $$4.c($$7));
      gpg $$18 = gph.a($$3, gph.d.b, $$17, $$15, $$16, $$7);
      gpg $$19 = gph.a($$3, gph.d.a, $$17, $$15, $$16, $$7);
      $$8.b("cullEntities");
   ...
   private void a(fhg $$0, gtl $$1, fnz $$2, Matrix4f $$3, Matrix4f $$4, gpg $$5, boolean $$6, boolean $$7, foh $$8, bqm $$9) {
      fhh $$10 = $$0.a("main");
      ...
      $$10.a(() -> {
         ...
         double $$16 = $$13x.c();
         $$9.a("terrain");
         this.a(gqc.c(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gqc.d(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gqc.e(), $$14x, $$15, $$16, $$3, $$4);
         if (this.p.c().e()) {
            fhy.a();
         } else {
            fhy.b();
         ...
         $$9.b("translucent");
         this.a(gqc.f(), $$14x, $$15, $$16, $$3, $$4);
         $$9.b("string");
         this.a(gqc.s(), $$14x, $$15, $$16, $$3, $$4);
         if ($$6) {
            this.a($$2, $$18, $$17, true);
         }
   ...
   private void a(fhg $$0, fnz $$1, float $$2, gpg $$3) {
      fhh $$4 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fhg $$0, Matrix4f $$1, Matrix4f $$2, fod $$3, fei $$4, float $$5, int $$6, float $$7) {
      fhh $$8 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fhg $$0, fei $$1, float $$2, gpg $$3) {
   ...
   private void a(fhg $$0, fei $$1, gpg $$2) {
      fhh $$3 = $$0.a("late_debug");
   ...
   private boolean a(fnz $$0, gtl $$1, List<bwd> $$2) {
      fei $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      boolean $$7 = false;
      boolean $$8 = this.d();
      bwd.b(azm.a((double)this.h.n.aH() / 8.0, 1.0, 2.5) * this.h.n.g().c());

      for (bwd $$9 : this.p.d()) {
         if (this.i.a($$9, $$1, $$4, $$5, $$6) || $$9.A(this.h.t)) {
            iu $$10 = $$9.dv();
            if ((this.p.e($$10.v()) || this.a($$10))
               && ($$9 != $$0.g() || $$0.i() || $$0.g() instanceof bxc && ((bxc)$$0.g()).fQ())
               && (!($$9 instanceof gop) || $$0.g() == $$9)) {
               $$2.add($$9);
               if ($$8 && this.h.b($$9)) {
                  $$7 = true;
               }
   ...
   private void a(fjc $$0, gps.a $$1, fnz $$2, foh $$3, List<bwd> $$4) {
      fei $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
   ...
   private void a(fjc $$0, gps.a $$1, gps.a $$2, fnz $$3, float $$4) {
      fei $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
         ...
         if (!$$10.isEmpty()) {
            for (dwx $$11 : $$10) {
               ...
               if ($$14 != null && !$$14.isEmpty()) {
                  ...
                  if ($$15 >= 0) {
                     fjc.a $$16 = $$0.c();
                     fjg $$17 = new fjd($$2.getBuffer(hkz.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        fjg $$3x = $$1.getBuffer($$2x);
                        return $$2x.W() ? fjj.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(fjc $$0, fnz $$1, gps.a $$2) {
      fei $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         ...
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            ...
            if ($$9 != null && !$$9.isEmpty()) {
               ...
               fjc.a $$11 = $$0.c();
               fjg $$12 = new fjd($$2.getBuffer(hkz.l.get($$10)), $$11, 1.0F);
   ...
   private void a(fnz $$0, gps.a $$1, fjc $$2, boolean $$3) {
      if (this.h.w instanceof fee $$4) {
         if ($$4.d() != feg.a.a) {
            iu $$6 = $$4.b();
            dzz $$7 = this.p.a_($$6);
            if (!$$7.l() && this.p.A_().a($$6)) {
               ...
               if ($$10) {
                  fjg $$11 = $$1.getBuffer(gqc.z());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               fjg $$12 = $$1.getBuffer(gqc.y());
   ...
   private void a(bwd $$0, double $$1, double $$2, double $$3, float $$4, fjc $$5, gps $$6) {
   ...
   private void a(fei $$0) {
      if (!this.r.isEmpty()) {
         ...
         bql.a().a("translucent_sort");
         gth.d $$3 = new gth.d();
         ObjectListIterator $$5 = this.s.iterator();

         while ($$5.hasNext()) {
            gth.b $$4 = (gth.b)$$5.next();
            this.a($$4, $$3, $$0, $$2, true);
         }
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gth.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gth.b $$0, gth.d $$1, fei $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(gqc $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      RenderSystem.assertOnRenderThread();
      bqr $$6 = bql.a().c(() -> "render_" + $$0.b);
      $$6.a($$0::toString);
      boolean $$7 = $$0 != gqc.f();
      ObjectListIterator<gth.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      gpb $$9 = RenderSystem.getShader();
      if ($$9 == null) {
         $$0.b();
         $$6.close();
      } else {
         $$9.a(fjh.c.h, $$4, $$5, this.h.aO());
         $$9.b();
         fit $$10 = $$9.o;

         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gth.b $$11 = $$7 ? (gth.b)$$8.next() : (gth.b)$$8.previous();
            if (!$$11.d().a($$0)) {
               fjf $$12 = $$11.a($$0);
               iu $$13 = $$11.f();
               if ($$10 != null) {
   ...
   private void b(fhg $$0, fnz $$1, float $$2, gpg $$3) {
      ewi $$4 = $$1.k();
      if ($$4 != ewi.c && $$4 != ewi.a && !this.b($$1)) {
         gpe $$5 = this.p.c();
         gpe.d $$6 = $$5.c();
         if ($$6 != gpe.d.a) {
            fhh $$7 = $$0.a("sky");
   ...
   private boolean b(fnz $$0) {
      return !($$0.g() instanceof bxc $$1) ? false : $$1.b(bvj.o) || $$1.b(bvj.G);
   }

   private void c(fnz $$0) {
      bqm $$1 = bql.a();
      $$1.a("populate_sections_to_compile");
      gtf $$2 = new gtf();
      iu $$3 = $$0.c();
      List<gth.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.r.iterator();

      while (var6.hasNext()) {
         gth.b $$5 = (gth.b)var6.next();
         if ($$5.i() && $$5.a()) {
            boolean $$6 = false;
            if (this.h.n.m().c() == foy.c) {
               iu $$7 = jx.a($$5.g()).k();
               $$6 = $$7.j($$3) < 768.0 || $$5.j();
            } else if (this.h.n.m().c() == foy.b) {
               $$6 = $$5.j();
            }
   ...
   private void a(fjc $$0, fjg $$1, bwd $$2, double $$3, double $$4, double $$5, iu $$6, dzz $$7, int $$8) {
      gqm.a($$0, $$1, $$7.a(this.p, $$6, fen.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }

   public void a(dib $$0, iu $$1, dzz $$2, dzz $$3, int $$4) {
      this.a($$1, ($$4 & 8) != 0);
   }
   ...
   public void a(lv $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      try {
         ...
         $$11.a("ID", mf.i.b($$0.a()));
         $$11.a("Parameters", () -> lx.bk.encodeStart(this.p.F_().a(un.a), $$0).toString());
   ...
   @Nullable
   gna b(lv $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private gna b(lv $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      fnz $$9 = this.h.j.k();
      ari $$10 = this.a($$2);
      if ($$1) {
   ...
   public void a(Collection<dwx> $$0, Collection<dwx> $$1) {
      synchronized (this.t) {
         this.t.removeAll($$0);
         this.t.addAll($$1);
      }
   ...
   public static int a(dhy $$0, iu $$1) {
      return a($$0, $$0.a_($$1), $$1);
   }

   public static int a(dhy $$0, dzz $$1, iu $$2) {
      if ($$1.b($$0, $$2)) {
         return 15728880;
      } else {
         int $$3 = $$0.a(dje.a, $$2);
   ...
   @bav
   public ObjectArrayList<gth.b> w() {
      return this.r;
   }
