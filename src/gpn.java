public class gpn implements gpj<duw> {
   private final gub a;
   ...
   public void a(duw $$0, float $$1, fgr $$2, gmx $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.m().c(dyg.by);
         if ($$6 > 0) {
            jn $$7 = $$0.c();
            if ($$7 != null) {
               ...
               if (!$$8.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = gmt.a($$0.i(), $$0.m(), $$0.aA_().a($$7));
                  this.a.a($$8, cxf.i, $$11, hfh.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
