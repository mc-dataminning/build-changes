...
public interface gpn {
   ...
   public static record a(int d, int e, gpn.a.a f) implements gpn {
      public static final MapCodec<gpn.a> c = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     axn.j.fieldOf("width").forGetter(gpn.a::b), axn.j.fieldOf("height").forGetter(gpn.a::c), gpn.a.a.g.fieldOf("border").forGetter(gpn.a::d)
                  )
                  .apply($$0, gpn.a::new)
         )
         .validate(gpn.a::a);
      ...
      public static record a(int a, int b, int c, int d) {
         private static final Codec<gpn.a.a> e = axn.j.flatComapMap($$0 -> new gpn.a.a($$0, $$0, $$0, $$0), $$0 -> {
            OptionalInt $$1 = $$0.e();
            return $$1.isPresent() ? DataResult.success($$1.getAsInt()) : DataResult.error(() -> "Border has different side sizes");
         });
         private static final Codec<gpn.a.a> f = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     axn.i.fieldOf("left").forGetter(gpn.a.a::a),
                     axn.i.fieldOf("top").forGetter(gpn.a.a::b),
                     axn.i.fieldOf("right").forGetter(gpn.a.a::c),
                     axn.i.fieldOf("bottom").forGetter(gpn.a.a::d)
                  )
                  .apply($$0, gpn.a.a::new)
         );
   ...
   public static record c(int d, int e) implements gpn {
      public static final MapCodec<gpn.c> c = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(axn.j.fieldOf("width").forGetter(gpn.c::b), axn.j.fieldOf("height").forGetter(gpn.c::c)).apply($$0, gpn.c::new)
      );
   ...
   public static enum d implements ayz {
      ...
      public static final Codec<gpn.d> d = ayz.a(gpn.d::values);
