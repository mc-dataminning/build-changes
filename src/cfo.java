...
public class cfo extends cel {
      ...
      this.w = this.a(new cgd(this.z, 0, 143, 57) {
         ...
         public void a(cbu $$0, cjf $$1) {
            ...
            $$2.a(($$0x, $$1x) -> {
               long $$2xx = $$0x.V();
               if (cfo.this.x != $$2xx) {
                  $$0x.a(null, $$1x, apd.yw, ape.e, 1.0F, 1.0F);
                  cfo.this.x = $$2xx;
               }
            });
            super.a($$0, $$1);
   ...
   private List<he<dcm>> c(cjf $$0) {
      if ($$0.b()) {
         return jb.al.b(apq.a).<List<he<dcm>>>map(ImmutableList::copyOf).orElse(ImmutableList.of());
      } else {
         return $$0.d() instanceof cgw $$1 ? jb.al.b($$1.b()).<List<he<dcm>>>map(ImmutableList::copyOf).orElse(ImmutableList.of()) : List.of();
      }
   }
