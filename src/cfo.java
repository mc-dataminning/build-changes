...
public abstract class cfo extends cfb {
   ...
   public cfo(byn $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cfo(byn $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cfb.a.a, cfb.a.c));
   }
   ...
   protected abstract boolean a(dkm var1, iw var2);
}
