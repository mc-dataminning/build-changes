public class gmx<T extends btk, M extends ftv<T> & fsu> extends gne<T, M> {
   private final gdf a;

   public gmx(gko<T, M> $$0, gdf $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   public void a(ezt $$0, gdj $$1, int $$2, T $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      ...
      if (!$$11.e() || !$$12.e()) {
         ...
         this.a($$3, $$12, cuh.c, bte.b, $$0, $$1, $$2);
         this.a($$3, $$11, cuh.b, bte.a, $$0, $$1, $$2);
         $$0.b();
      }
   }
