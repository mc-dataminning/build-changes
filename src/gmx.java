public class gmx extends gnk<cfq, fud<cfq>> {
   private final gdl a;

   public gmx(gku<cfq, fud<cfq>> $$0, gdl $$1) {
      super($$0);
      this.a = $$1;
   }

   public void a(ezz $$0, gdp $$1, int $$2, cfq $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      boolean $$10 = $$3.fL();
      boolean $$11 = $$3.p_();
      $$0.a();
      if ($$11) {
