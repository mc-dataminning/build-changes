...
public class clo extends clk implements cop {
   private static final int bG = 5;
   private static final akj<Integer> bH = akn.a(clo.class, akl.b);
   private static final akj<Integer> bI = akn.a(clo.class, akl.b);
   ...
   public clo(bwr<? extends clo> $$0, djh $$1) {
      super($$0, $$1);
      this.O().a(40.0F);
   }
   ...
   public void a(tz $$0) {
      this.w($$0.f("Strength"));
      super.a($$0);
      this.a($$0.<clo.d>a("Variant", clo.d.f).orElse(clo.d.a));
   }
   ...
   protected void D() {
      ...
      this.bD.a(8, new cen(this, crj.class, 6.0F));
      this.bD.a(9, new cfa(this));
      this.bE.a(1, new clo.c(this));
      this.bE.a(2, new clo.a(this));
   }
   ...
   public clo.d gG() {
      return clo.d.a(this.al.a(bI));
   }

   private void a(clo.d $$0) {
      this.al.a(bI, $$0.i);
   }
   ...
   public <T> T a(kj<? extends T> $$0) {
      return $$0 == kk.aM ? c((kj<T>)$$0, this.gG()) : super.a($$0);
   }
   ...
   @Override
   protected boolean a(crj $$0, czk $$1) {
      int $$2 = 0;
      int $$3 = 0;
      float $$4 = 0.0F;
      boolean $$5 = false;
   ...
   public byb a(djy $$0, bue $$1, bwq $$2, @Nullable byb $$3) {
      ...
      this.b($$4);
      clo.d $$5;
      if ($$3 instanceof clo.b) {
         $$5 = ((clo.b)$$3).a;
      } else {
         $$5 = ag.a(clo.d.values(), $$4);
         $$3 = new clo.b($$5);
      }
   ...
   public boolean a(ciz $$0) {
      return $$0 != this && $$0 instanceof clo && this.hb() && ((clo)$$0).hb();
   }

   @Nullable
   public clo b(arq $$0, bvy $$1) {
      clo $$2 = this.gH();
      if ($$2 != null) {
         this.a($$1, $$2);
         clo $$3 = (clo)$$1;
   ...
   @Override
   public fex cS() {
      return new fex(0.0, 0.75 * (double)this.cR(), (double)this.dp() * 0.5);
   }
   ...
   static class a extends cfy<cki> {
      public a(clo $$0) {
         super($$0, cki.class, 16, false, true, ($$0x, $$1) -> !((cki)$$0x).q());
      }
   ...
   static class c extends cfx {
      ...
      @Override
      public boolean c() {
         if (this.e instanceof clo $$0 && $$0.bL) {
            $$0.D(false);
            return false;
         }
   ...
   public static enum d implements bak {
      ...
      private static final IntFunction<clo.d> h = ayc.a(clo.d::a, values(), ayc.a.c);
      public static final Codec<clo.d> e = bak.a(clo.d::values);
      @Deprecated
      public static final Codec<clo.d> f = Codec.INT.xmap(h::apply, clo.d::a);
      public static final yw<ByteBuf, clo.d> g = yu.a(h, clo.d::a);
      final int i;
