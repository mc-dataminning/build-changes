...
public abstract class clo {
   ...
   private final iu<cqk> l = iu.a();
   public final iu<cnj> i = iu.a();
   private final List<cmg> m = Lists.newArrayList();
   private cqk n = cqk.h;
   private final iu<cqk> o = iu.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cnj> v = Sets.newHashSet();
   private final List<cma> w = Lists.newArrayList();
   @Nullable
   private cmb x;
   private boolean y;

   protected clo(@Nullable cmv<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(clz $$0, cis $$1, daa $$2) {
   ...
   protected static void a(bmv $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cly $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cmg a(cmg $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(cly $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cmg.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cqk $$1 = this.i.get($$0).g();
         Supplier<cqk> $$2 = Suppliers.memoize($$1::q);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cqk $$1, Supplier<cqk> $$2) {
      cqk $$3 = this.l.get($$0);
      if (!cqk.a($$3, $$1)) {
         cqk $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cqk $$1, Supplier<cqk> $$2) {
      if (!this.y) {
         cqk $$3 = this.o.get($$0);
         if (!cqk.a($$3, $$1)) {
            cqk $$4 = $$2.get();
   ...
   public abstract cqk a(cis var1, int var2);

   public void a(int $$0, int $$1, clx $$2, cis $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, clx $$2, cis $$3) {
      cir $$4 = $$3.fZ();
      if ($$2 == clx.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == clx.a || $$2 == clx.b) && ($$1 == 0 || $$1 == 1)) {
         clw $$16 = $$1 == 0 ? clw.a : clw.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == clw.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == clw.a ? $$21.M() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == clw.a ? $$20.M() : ($$20.M() + 1) / 2;
                     Optional<cqk> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cqk> $$26 = $$19.a($$20.M(), $$21.g() - $$21.M(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.M());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == clx.d && $$3.fM() && this.g().b() && $$0 >= 0) {
         cnj $$32 = this.i.get($$0);
         if ($$32.h()) {
            cqk $$33 = $$32.g();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == clx.e && this.g().b() && $$0 >= 0) {
         cnj $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().M();
         cqk $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == clx.g && $$0 >= 0) {
         cnj $$37 = this.i.get($$0);
         cqk $$38 = this.g();
         if (!$$38.b() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.M() < $$38.g(); $$42 += $$40) {
                  cnj $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cqk $$44 = $$43.g();
                     if ($$41 != 0 || $$44.M() != $$44.g()) {
                        cqk $$45 = $$43.b($$44.M(), $$38.g() - $$38.M(), $$3);
                        $$38.g($$45.M());
                     }
                  }
               }
   ...
   private boolean a(cis $$0, clw $$1, cnj $$2, cqk $$3, cqk $$4) {
      clf $$5 = $$0.dM().I();
   ...
   public void a(int $$0, int $$1, cqk $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cqk> $$1, cqk $$2) {
   ...
   protected boolean a(cqk $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cis $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cnj $$0, cqk $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cqk.c($$1, $$0.g()) ? $$0.g().M() + ($$2 ? 0 : $$1.M()) <= $$1.g() : $$3;
   }

   public static int a(Set<cnj> $$0, int $$1, cqk $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dkg $$0) {
      return $$0 instanceof bmv ? b((bmv)$$0) : 0;
   }

   public static int b(@Nullable bmv $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(clo $$0) {
      Table<bmv, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bmv $$0, int $$1) {
