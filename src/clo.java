...
public class clo extends cly implements bvm {
   ...
   private static final ajy<Optional<dwx>> ca = akc.a(clo.class, aka.j);
   private static final ajy<Boolean> cb = akc.a(clo.class, aka.k);
   private static final ajy<Boolean> cc = akc.a(clo.class, aka.k);
   ...
   public clo(bus<? extends clo> $$0, dgi $$1) {
      super($$0, $$1);
      this.a(etq.j, -1.0F);
   }
   ...
   public static bwo.a m() {
      return cly.gx().a(bwp.s, 40.0).a(bwp.v, 0.3F).a(bwp.c, 7.0).a(bwp.m, 64.0).a(bwp.B, 1.0);
   }
   ...
   boolean a(cox $$0) {
      return !bvh.aH.test($$0) ? false : this.a($$0, 0.025, true, false, new double[]{this.dE()});
   }
   ...
   boolean b(bul $$0) {
      fba $$1 = new fba(this.dA() - $$0.dA(), this.e(0.5) - $$0.dE(), this.dG() - $$0.dG());
      $$1 = $$1.d();
      double $$2 = 16.0;
   ...
   private boolean q(double $$0, double $$1, double $$2) {
      ...
      if ($$5 && !$$6) {
         ...
         if ($$8) {
            this.dV().a(ebt.R, $$7, ebt.a.a(this));
            if (!this.bb()) {
   ...
   protected void a(ard $$0, btb $$1, boolean $$2) {
      ...
      if ($$3 != null) {
         ...
         ddb.a($$4, $$0.K_(), den.g, $$0.d_(this.dv()), this.dY());
         evu.a $$5 = new evu.a((ard)this.dV()).a(eyl.f, this.dt()).a(eyl.i, $$4).b(eyl.a, this);
   ...
   private boolean a(ard $$0, btb $$1, cqc $$2, float $$3) {
      cwp $$4 = $$2.l();
   ...
   static class b extends ccf {
      ...
      public boolean b() {
         if (this.a.x() == null) {
            ...
            return !a(this.a).O().b(dge.c) ? false : this.a.dY().a(b(2000)) == 0;
         }
      }
   ...
   static class d extends ccf {
      ...
      public boolean b() {
         if (this.a.x() != null) {
            ...
            return !a(this.a).O().b(dge.c) ? false : this.a.dY().a(b(20)) == 0;
         }
      }
      ...
      public void a() {
         ...
         ji $$5 = new ji($$2, $$3, $$4);
         dwx $$6 = $$1.a_($$5);
         fba $$7 = new fba((double)this.a.dz() + 0.5, (double)$$3 + 0.5, (double)this.a.dF() + 0.5);
