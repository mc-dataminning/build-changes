...
public class cmx {
   ...
   private int g = azd.b(azl.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kh.a.fieldOf("uuid").forGetter(Pair::getFirst), aym.k.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bto> j;
   @VisibleForTesting
   protected final ArrayList<bto> c;
   private final cmx.a k;
   @VisibleForTesting
   protected final Object2IntMap<bto> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cmx> a(Predicate<bto> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cmx::b)).apply($$1, $$1x -> new cmx($$0, $$1x))
      );
   }

   public cmx(Predicate<bto> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cmx.a(this);
   ...
   private List<Pair<UUID, Integer>> b() {
      return Streams.concat(
            new Stream[]{
               this.c.stream().map($$0 -> Pair.of($$0.cD(), this.d.getInt($$0))),
   ...
   public void a(arh $$0, Predicate<bto> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bto>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bto> $$6 = (Entry<bto>)$$5.next();
         int $$7 = $$6.getIntValue();
         bto $$8 = (bto)$$6.getKey();
         bto.c $$9 = $$8.dO();
   ...
   public int b(@Nullable bto $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<buk> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof buk).map($$0 -> (buk)$$0);
   }

   @VisibleForTesting
   protected static record a(cmx a) implements Comparator<bto> {
      public int a(bto $$0, bto $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cnu;
               boolean $$7 = $$1 instanceof cnu;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
