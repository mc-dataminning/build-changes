...
public class cmx extends bxa<cmu> {
   ...
   public static boolean a(arp $$0, cmu $$1) {
      if (!$$1.aJ() && !$$1.bj()) {
         return false;
      } else if (bzu.a($$1)) {
         return false;
   ...
   protected boolean b(arp $$0, cmu $$1) {
      return a($$0, $$1);
   }
   ...
   protected void b(arp $$0, cmu $$1, long $$2) {
      if ($$1.eb().a(cel.aZ, cem.b)) {
         $$1.eb().a(cel.aZ, bas.a, (long)f);
      }

      $$1.b(bvt.r);
      $$0.a(null, $$1, awn.cE, awo.f, 1.0F, 1.0F);
      $$1.eb().c(cel.ba).ifPresent($$1x -> $$1.a(fi.a.b, $$1x.b()));
   }
   ...
   protected void c(arp $$0, cmu $$1, long $$2) {
      ...
      if (a($$1)) {
         ezy $$4 = $$1.eb().c(cel.ba).flatMap($$1x -> a($$1, $$1.dY(), ezy.c($$1x))).orElse(null);
         if ($$4 == null) {
            $$1.b(bvt.a);
            return;
         }
         ...
         $$1.eb().a(cel.aU, bas.a, $$5 ? 2L : 10L);
         $$1.eb().a(cel.aV, bas.a, 100L);
      }
   }
   ...
   @Nullable
   private static jh a(bvh $$0, ezy $$1) {
      deu $$2 = new deu($$1, $$1.a(jm.a, 10.0), deu.a.a, deu.b.a, $$0);
      ezw $$3 = $$0.dV().a($$2);
      if ($$3.d() == ezw.a.b) {
         return jh.a((ka)$$3.g()).d();
      } else {
         deu $$4 = new deu($$1, $$1.a(jm.b, 10.0), deu.a.a, deu.b.a, $$0);
         ezw $$5 = $$0.dV().a($$4);
         return $$5.d() == ezw.a.b ? jh.a((ka)$$5.g()).d() : null;
      }
   }
   ...
   private static boolean c(arp $$0, cmu $$1) {
      jh $$2 = $$1.dv();

      for (int $$3 = 1; $$3 <= 4; $$3++) {
         jh $$4 = $$2.a(jm.b, $$3);
         if (!$$0.a_($$4).l() && !$$0.b_($$4).a(axi.a)) {
            return false;
         }
      }
   ...
   private static Optional<ezy> a(cmu $$0, azu $$1, ezy $$2) {
      for (int $$4 : ae.a(j, $$1)) {
         float $$5 = 0.058333334F * (float)$$0.h(bwp.m);
         Optional<ezy> $$6 = bye.a($$0, $$2, $$5, $$4, false);
         if ($$6.isPresent()) {
            return $$6;
         }
      }
