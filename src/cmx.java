...
public class cmx implements bqo, bra {
   ...
   public final jr<cuq> h = jr.a(36, cuq.l);
   public final jr<cuq> i = jr.a(4, cuq.l);
   public final jr<cuq> j = jr.a(1, cuq.l);
   private final List<jr<cuq>> n = ImmutableList.of(this.h, this.i, this.j);
   public int k;
   public final cmy l;
   private int o;
   ...
   private boolean a(cuq $$0, cuq $$1) {
      return !$$0.e() && cuq.c($$0, $$1) && $$0.k() && $$0.I() < this.e_($$0);
   }
   ...
   public int d(cuq $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         cuq $$2 = this.h.get($$1);
         if (!this.h.get($$1).e() && cuq.c($$0, this.h.get($$1)) && !this.h.get($$1).m() && !$$2.B() && !$$2.b(km.g)) {
            return $$1;
         }
      }
   ...
   public int a(Predicate<cuq> $$0, int $$1, bqo $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
      $$3 += bqp.a(this, $$0, $$1 - $$3, $$4);
      $$3 += bqp.a($$2, $$0, $$1 - $$3, $$4);
      cuq $$5 = this.l.cb.g();
      $$3 += bqp.a($$5, $$0, $$1 - $$3, $$4);
      if ($$5.e()) {
   ...
   public cuq a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).e() ? bqp.a($$2, $$0, $$1) : cuq.l;
   }
   ...
   public void b(uy $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         us $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cuq $$4 = cuq.a(this.l.dR(), (vp)$$2).orElse(cuq.l);
   ...
   public cuq a(boolean $$0) {
      cuq $$1 = this.f();
      return $$1.e() ? cuq.l : this.a(this.k, $$0 ? $$1.I() : 1);
   }
}
