...
public final class cmx {
   ...
   private static final bgc[] f = Stream.of(bgc.values()).filter($$0 -> $$0 != bgc.h).toArray(bgc[]::new);

   private cmx() {
   }

   public static cmx.d a(int $$0, Iterable<bfj> $$1, cmx.b $$2, cmw $$3) {
      cna $$4 = new cna();
      Object2IntOpenHashMap<bgc> $$5 = new Object2IntOpenHashMap();

      for (bfj $$6 : $$1) {
         if ($$6 instanceof bgb $$7 && ($$7.fH() || $$7.T())) {
            continue;
         }
   ...
   public static void a(aif $$0, dei $$1, cmx.d $$2, boolean $$3, boolean $$4, boolean $$5) {
      ...
      // Bytecode:
      // 00: aload 0
      // 01: invokevirtual aif.ad ()Lban;
      // 04: ldc "spawner"
      // 06: invokeinterface ban.a (Ljava/lang/String;)V 2
      // 0b: getstatic cmx.f [Lbgc;
      // 0e: astore 6
      // 10: aload 6
      // 12: arraylength
      // 13: istore 7
      ...
      // 27: ifne 32
      // 2a: aload 9
      // 2c: invokevirtual bgc.d ()Z
      // 2f: ifne 76
      // 32: iload 4
      // 34: ifne 3f
      // 37: aload 9
      // 39: invokevirtual bgc.d ()Z
      // 3c: ifeq 76
      // 3f: iload 5
      // 41: ifne 4c
      // 44: aload 9
      // 46: invokevirtual bgc.e ()Z
      // 49: ifne 76
      // 4c: aload 2
      // 4d: aload 9
      // 4f: aload 1
      // 50: invokevirtual dei.f ()Lclt;
      // 53: invokevirtual cmx$d.a (Lbgc;Lclt;)Z
      // 56: ifeq 76
      // 59: aload 9
      // 5b: aload 0
      // 5c: aload 1
      ...
      // 62: pop
      // 63: invokedynamic test (Lcmx$d;)Lcmx$c; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Lbfn;Lgu;Lddx;)Z, cmx$d.a (Lbfn;Lgu;Lddx;)Z, (Lbfn;Lgu;Lddx;)Z ]
      // 68: aload 2
      // 69: dup
      // 6a: invokestatic java/util/Objects.requireNonNull (Ljava/lang/Object;)Ljava/lang/Object;
      // 6d: pop
      // 6e: invokedynamic run (Lcmx$d;)Lcmx$a; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Lbgb;Lddx;)V, cmx$d.a (Lbgb;Lddx;)V, (Lbgb;Lddx;)V ]
      // 73: invokestatic cmx.a (Lbgc;Laif;Ldei;Lcmx$c;Lcmx$a;)V
      // 76: iinc 8 1
      // 79: goto 18
      // 7c: aload 0
      // 7d: invokevirtual aif.ad ()Lban;
      // 80: invokeinterface ban.c ()V 1
      // 85: return
   }

   public static void a(bgc $$0, aif $$1, dei $$2, cmx.c $$3, cmx.a $$4) {
      gu $$5 = a($$1, $$2);
      if ($$5.v() >= $$1.C_() + 1) {
         a($$0, $$1, $$2, $$5, $$3, $$4);
      }
   ...
   @aqa
   public static void a(bgc $$0, aif $$1, gu $$2) {
      a($$0, $$1, $$1.x($$2), $$2, ($$0x, $$1x, $$2x) -> true, ($$0x, $$1x) -> {
      });
   }

   public static void a(bgc $$0, aif $$1, ddx $$2, gu $$3, cmx.c $$4, cmx.a $$5) {
      cne $$6 = $$1.a();
      ddy $$7 = $$1.k().g();
      int $$8 = $$3.v();
      dcb $$9 = $$2.a_($$3);
         ...
         for (int $$12 = 0; $$12 < 3; $$12++) {
            ...
            for (int $$20 = 0; $$20 < $$18; $$20++) {
               ...
               if ($$23 != null) {
                  ...
                  if (a($$1, $$2, $$10, $$24)) {
                     if ($$16 == null) {
                        Optional<cnw.c> $$25 = a($$1, $$6, $$7, $$0, $$1.z, $$10);
                        if ($$25.isEmpty()) {
                           break;
                        }
   ...
   private static boolean a(aif $$0, ddx $$1, gu.a $$2, double $$3) {
      if ($$3 <= 576.0) {
         ...
         return $$0.R().a(new eei((double)$$2.u() + 0.5, (double)$$2.v(), (double)$$2.w() + 0.5), 24.0)
            ? false
            : Objects.equals(new clt($$2), $$1.f()) || $$0.f($$2);
      }
   }
   ...
   private static boolean a(aif $$0, bgc $$1, cne $$2, ddy $$3, cnw.c $$4, gu.a $$5, double $$6) {
      ...
      if ($$7.f() == bgc.h) {
         ...
         if (!a($$8, $$0, $$5, $$7)) {
            ...
            return !bgu.a($$7, $$0, bgd.a, $$5, $$0.z) ? false : $$0.b($$7.a((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5));
         }
      } else {
         return false;
      }
   ...
   private static boolean a(aif $$0, bgb $$1, double $$2) {
      return $$2 > (double)($$1.ae().f().f() * $$1.ae().f().f()) && $$1.h($$2) ? false : $$1.a($$0, bgd.a) && $$1.a($$0);
   }

   private static Optional<cnw.c> a(aif $$0, cne $$1, ddy $$2, bgc $$3, apf $$4, gu $$5) {
      he<cnk> $$6 = $$0.s($$5);
      return $$3 == bgc.g && $$6.a(amv.al) && $$4.i() < 0.98F ? Optional.empty() : a($$0, $$1, $$2, $$3, $$5, $$6).b($$4);
   }
   ...
   private static bcl<cnw.c> a(aif $$0, cne $$1, ddy $$2, bgc $$3, gu $$4, @Nullable he<cnk> $$5) {
      return a($$4, $$0, $$3, $$1) ? dtz.d : $$2.a($$5 != null ? $$5 : $$0.s($$4), $$1, $$3, $$4);
   }
               ...
               for (int $$16 = 0; $$16 < $$10; $$16++) {
                  ...
                  for (int $$18 = 0; !$$17 && $$18 < 4; $$18++) {
                     ...
                     if ($$9.b.c() && a(bgu.a($$9.b), $$0, $$19, $$9.b)) {
                        ...
                        if (!$$0.b($$9.b.a($$21, (double)$$19.v(), $$22)) || !bgu.a($$9.b, $$0, bgd.b, gu.a($$21, (double)$$19.v(), $$22), $$0.y_())) {
                           continue;
                        }
                        ...
                        if ($$23 instanceof bgb $$26 && $$26.a($$0, bgd.b) && $$26.a($$0)) {
   ...
   @FunctionalInterface
   public interface a {
      void run(bgb var1, ddx var2);
   }

   @FunctionalInterface
   public interface b {
      void query(long var1, Consumer<dei> var3);
   }

   @FunctionalInterface
   public interface c {
      boolean test(bfn<?> var1, gu var2, ddx var3);
   }
