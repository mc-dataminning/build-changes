...
public final class cmx {
   public static final Codec<cmx> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               kd.h.r().fieldOf("id").forGetter(cmx::e),
               Codec.INT.fieldOf("Count").forGetter(cmx::L),
               sn.a.optionalFieldOf("tag").forGetter($$0x -> Optional.ofNullable($$0x.v()))
            )
            .apply($$0, cmx::new)
   );
   private static final Codec<cms> n = atv.a(
      kd.h.q(), (Function<cms, DataResult<cms>>)($$0 -> $$0 == cna.a ? DataResult.error(() -> "Item must not be minecraft:air") : DataResult.success($$0))
   );
   public static final Codec<cmx> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(kd.h.r().fieldOf("item").forGetter(cmx::e), atv.a(tl.i, "nbt").forGetter($$0x -> Optional.ofNullable($$0x.v())))
            .apply($$0, ($$0x, $$1) -> new cmx($$0x, 1, $$1))
   );
   public static final Codec<cmx> c = RecordCodecBuilder.create(
      $$0 -> $$0.group(n.fieldOf("item").forGetter(cmx::d), atv.a(atv.j, "count", Integer.valueOf(1)).forGetter(cmx::L)).apply($$0, cmx::new)
   );
   public static final Codec<cmx> d = n.xmap(cmx::new, cmx::d);
   public static final MapCodec<cmx> e = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kd.h.q().fieldOf("result").forGetter(cmx::d), Codec.INT.fieldOf("count").forGetter(cmx::L)).apply($$0, cmx::new)
   );
   private static final Logger o = LogUtils.getLogger();
   public static final cmx f = new cmx((Void)null);
   ...
   public cmx(ih<cms> $$0, int $$1, Optional<sn> $$2) {
      this($$0, $$1);
      $$2.ifPresent(this::c);
   }

   public cmx(ih<cms> $$0, int $$1) {
      this($$0.a(), $$1);
   }

   public cmx(ctn $$0, int $$1) {
      this.z = $$0.k();
      this.x = $$1;
      if (this.z.o()) {
         this.b(this.k());
   ...
   public boolean b() {
      return this == f || this.z == cna.a || this.x <= 0;
   }
   ...
   public boolean a(Predicate<ih<cms>> $$0) {
      return $$0.test(this.d().j());
   }

   public boolean a(ih<cms> $$0) {
      return this.d().j() == $$0;
   }

   public boolean a(il<cms> $$0) {
      return $$0.a(this.e());
   }

   public Stream<asv<cms>> f() {
      return this.d().j().c();
   }
   ...
   public boolean a(int $$0, auu $$1, @Nullable ane $$2) {
      if (!this.i()) {
         return false;
      } else {
         if ($$0 > 0) {
            int $$3 = crk.a(crm.w, this);
            int $$4 = 0;
   ...
   public <T extends bmk> void a(int $$0, T $$1, Consumer<T> $$2) {
      if (!$$1.dM().B && (!($$1 instanceof cfh) || !((cfh)$$1).fT().d)) {
         if (this.i()) {
   ...
   public boolean a(cjv $$0, cii $$1, cfh $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }

   public boolean a(cmx $$0, cjv $$1, cii $$2, cfh $$3, bnc $$4) {
      return this.d().a(this, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(bmk $$0, cfh $$1) {
      cms $$2 = this.d();
      if ($$2.a(this, $$0, $$1)) {
         $$1.b(asb.c.b($$2));
      }
   ...
   public void a(cto $$0, djg $$1, hx $$2, cfh $$3) {
      cms $$4 = this.d();
      if ($$4.a(this, $$0, $$1, $$2, $$3)) {
         $$3.b(asb.c.b($$4));
      }
   ...
   public boolean b(djg $$0) {
      return this.d().a_($$0);
   }

   public bka a(cfh $$0, bmk $$1, bjz $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public static boolean b(cmx $$0, cmx $$1) {
      return $$0.a($$1.d());
   }

   public static boolean c(cmx $$0, cmx $$1) {
      if (!$$0.a($$1.d())) {
         return false;
      } else {
   ...
   public void a(cto $$0, blu $$1, int $$2, boolean $$3) {
      if (this.y > 0) {
         this.y--;
      }
   ...
   public void a(cto $$0, cfh $$1, int $$2) {
      $$1.a(asb.b.b(this.d()), $$2);
      this.d().b(this, $$0, $$1);
   }
   ...
   public void a(cto $$0, bmk $$1, int $$2) {
      this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public List<vf> a(@Nullable cfh $$0, cop $$1) {
      ...
      $$2.add($$3);
      if (!$$1.a() && !this.A() && this.a(cna.rR)) {
         Integer $$4 = cne.d(this);
         if ($$4 != null) {
            $$2.add(cne.k(this));
         }
      }
      ...
      if (this.u()) {
         if (a($$5, cmx.a.h) && $$0 != null) {
            cpa.a(this, $$0.dM().I_(), $$2);
         }
      ...
      if (a($$5, cmx.a.b)) {
         for (blz $$12 : blz.values()) {
            Multimap<bnl, bno> $$13 = this.a($$12);
            if (!$$13.isEmpty()) {
               $$2.add(ve.a);
               $$2.add(vf.c("item.modifiers." + $$12.e()).a(n.h));

               for (Entry<bnl, bno> $$14 : $$13.entries()) {
                  bno $$15 = $$14.getValue();
                  double $$16 = $$15.c();
                  boolean $$17 = false;
                  if ($$0 != null) {
                  ...
                  double $$18;
                  if ($$15.b() == bno.a.b || $$15.b() == bno.a.c) {
                     $$18 = $$16 * 100.0;
                  } else if ($$14.getKey().equals(bnq.i)) {
                     $$18 = $$16 * 10.0;
                  } else {
                     $$18 = $$16;
                  }
      ...
      if (this.u()) {
         if (a($$5, cmx.a.c) && this.A.q("Unbreakable")) {
            $$2.add(vf.c("item.unbreakable").a(n.j));
         }

         if (a($$5, cmx.a.d) && this.A.b("CanDestroy", 9)) {
         ...
         if (a($$5, cmx.a.e) && this.A.b("CanPlaceOn", 9)) {
   ...
   private static boolean a(int $$0, cmx.a $$1) {
      return ($$0 & $$1.a()) == 0;
   }
   ...
   public static void a(List<vf> $$0, st $$1) {
      for (int $$2 = 0; $$2 < $$1.size(); $$2++) {
         sn $$3 = $$1.a($$2);
         kd.f.b(crk.b($$3)).ifPresent($$2x -> $$0.add($$2x.d(crk.a($$3))));
      }
   }
      ...
      try {
         return (Collection<vf>)fk.b(kd.e.p(), $$0, true)
            .map(
               ...
               $$0x -> $$0x.a().a().map($$0xx -> ((cwp)$$0xx.a()).f().a(n.i)).collect(Collectors.toList())
            );
   ...
   @Nullable
   public cbm G() {
      return this.B instanceof cbm ? (cbm)this.H() : null;
   }
      ...
      if (this.u() && this.A.b("AttributeModifiers", 9)) {
         ...
         for (int $$3 = 0; $$3 < $$2.size(); $$3++) {
            ...
            if (!$$4.b("Slot", 8) || $$4.l("Slot").equals($$0.e())) {
               Optional<bnl> $$5 = kd.u.b(ahg.a($$4.l("AttributeName")));
               if (!$$5.isEmpty()) {
                  bno $$6 = bno.a($$4);
   ...
   public void a(bnl $$0, bno $$1, @Nullable blz $$2) {
      this.w();
   ...
   public boolean a(it<cwp> $$0, djk $$1) {
      if (this.D == null) {
         this.D = new ckf("CanPlaceOn");
      }

      return this.D.a(this, $$0, $$1);
   }

   public boolean b(it<cwp> $$0, djk $$1) {
      if (this.C == null) {
         this.C = new ckf("CanDestroy");
      }
   ...
   public void b(cto $$0, bmk $$1, int $$2) {
      this.d().a($$0, $$1, this, $$2);
   }
