...
public class bfg extends bbj {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfg::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfg::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfg::k);
         $$0 = this.a($$0, "minecraft:fox", bfg::j);
         $$0 = this.a($$0, "minecraft:item", bfg::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfg::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfg::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfg::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfg::e);
         return this.a($$0, "minecraft:piglin", bfg::d);
      });
   }
