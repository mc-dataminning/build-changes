...
public class fiy implements fsf {
   private static final alb a = new alb("hud/hotbar");
   private static final alb b = new alb("hud/hotbar_selection");
   ...
   private float c() {
      ...
      return ayu.a((float)$$0 / 2000.0F, 0.0F, 1.0F);
   }
   ...
   protected void a(fgm $$0, float $$1, int $$2, int $$3, fsg $$4) {
   ...
   private void a(fgm $$0, int $$1, int $$2, float $$3, float $$4, fse $$5) {
      if ($$5 != fsc.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fsc.a || !this.g.a($$1).aP_())) {
         $$1 += $$0;
      }
