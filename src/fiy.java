...
public class fiy {
   ...
   public static void a(File $$0, fbs $$1, Consumer<xe> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fbs $$2, Consumer<xe> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fbs $$2, Consumer<xe> $$3) {
      fci $$4 = a($$2);
   ...
   public static fci a(fbs $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fci $$3 = new fci($$1, $$2, false);
   ...
   public fiy(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
