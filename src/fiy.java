...
public class fiy extends fie<cmi> {
   ...
   protected void aO_() {
      super.aO_();
      this.M = new fnk(this.f.aR().a(frc.n));
   }
   ...
   private void d(fat $$0, int $$1, int $$2, float $$3) {
      ...
      this.M.a(0.0F, $$8, $$9, $$4);
      eud $$10 = $$0.d().getBuffer(this.M.a(K));
      this.M.a($$0.c(), $$10, 15728880, giq.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      esv.d();
   }
