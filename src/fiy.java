...
public class fiy implements far, fbk {
   ...
   private final List<fiy.a> n = Lists.newArrayList();
   private boolean o;
   private int p;
   private int q;
   private exo r;
   ...
   public void a(exo $$0, fjd $$1, int $$2, int $$3, int $$4, int $$5, float $$6) {
      this.r = $$0;
      this.t = $$1;
      if ($$0.s.bW instanceof ckg) {
         this.w = true;
      }

      boolean $$7 = $$0.s.m().a((cls<?>)$$0.s.bW);
      List<csh<?>> $$8 = $$1.b(true);
      List<csh<?>> $$9 = $$7 ? Collections.emptyList() : $$1.b(false);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      float $$17 = (float)($$5 + 50);
      if ($$16 > $$17) {
         this.q = (int)((float)this.q - $$6 * (float)awi.f(($$16 - $$17) / $$6));
      }

      float $$18 = (float)this.q;
      float $$19 = (float)($$5 - 100);
      if ($$18 < $$19) {
         this.q = (int)((float)this.q - $$6 * (float)awi.f(($$18 - $$19) / $$6));
      }
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         csh<?> $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.p + 4 + 25 * ($$20 % $$12);
         int $$24 = this.q + 5 + 25 * ($$20 / $$12);
         if (this.w) {
            this.n.add(new fiy.b($$23, $$24, $$22, $$21));
         } else {
            this.n.add(new fiy.a($$23, $$24, $$22, $$21));
         }
      }
   ...
   public void a(ezb $$0, int $$1, int $$2, float $$3) {
      if (this.o) {
         ...
         int $$6 = awi.f((float)this.n.size() / (float)$$4);
         int $$7 = 4;
   ...
   class a extends ezm implements ail<csc> {
      final csh<?> c;
      private final boolean d;
      protected final List<fiy.a.a> a = Lists.newArrayList();

      public a(int $$0, int $$1, csh<?> $$2, boolean $$3) {
      ...
      public void a(Iterator<csc> $$0, int $$1, int $$2, int $$3, int $$4) {
         cpd[] $$5 = $$0.next().a();
         if ($$5.length != 0) {
            this.a.add(new fiy.a.a(3 + $$4 * 7, 3 + $$3 * 7, $$5));
         }
      }
      ...
      public void b(ezb $$0, int $$1, int $$2, float $$3) {
         ...
         if (this.d) {
            if (fiy.this.w) {
               $$4 = this.z() ? fiy.c : fiy.d;
            } else {
               $$4 = this.z() ? fiy.e : fiy.f;
            }
         } else if (fiy.this.w) {
            $$4 = this.z() ? fiy.g : fiy.h;
         } else {
            $$4 = this.z() ? fiy.i : fiy.j;
         }
         ...
         for (fiy.a.a $$8 : this.a) {
            $$0.c().a();
            $$0.c().a((double)$$8.b, (double)$$8.c, 0.0);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0, -8.0, 0.0);
            if ($$8.a.length > 0) {
               $$0.a($$8.a[awi.d(fiy.this.v / 30.0F) % $$8.a.length], 0, 0);
            }
   ...
   class b extends fiy.a {
      public b(int $$0, int $$1, csh<?> $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
      }
      ...
      protected void a(csh<?> $$0) {
         csc $$1 = $$0.b().a().get(0);
         cpd[] $$2 = $$1.a();
         this.a.add(new fiy.a.a(10, 10, $$2));
      }
   }
}
