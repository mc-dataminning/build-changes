...
class btk extends btm {
   private final float c;
   private final ToIntFunction<azg> d;

   protected btk(btn $$0, int $$1, float $$2, ToIntFunction<azg> $$3) {
      super($$0, $$1, lt.G);
      this.c = $$2;
      this.d = $$3;
   }
   ...
   private void a(arc $$0, bvf $$1, double $$2, double $$3, double $$4) {
      cmd $$5 = buq.bd.a($$0, bup.k);
      if ($$5 != null) {
         azg $$6 = $$1.dZ();
