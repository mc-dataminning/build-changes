...
public abstract class bjn extends DataFix {
   private final String a;

   public bjn(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(biz.B.typeName(), bku.a());
      if (!Objects.equals(this.getOutputSchema().getType(biz.B), $$2)) {
