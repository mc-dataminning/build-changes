...
public class bjn extends DataFix {
   ...
   public bjn(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   @Nullable
   private static bjn.a a(String $$0) {
      if (b.contains($$0)) {
         return null;
      } else {
         String $$1 = c.get($$0);
         if ($$1 != null) {
            return new bjn.a("minecraft:custom", $$1);
         } else {
            ...
            if ($$2 < 0) {
               ...
               if ("stat.mineBlock".equals($$3)) {
                  ...
                  return new bjn.a("minecraft:mined", $$4);
               } else {
                  String $$5 = f.get($$3);
                  if ($$5 != null) {
   ...
   private TypeRewriteRule b() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bix.J);
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         ...
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> (Dynamic)DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
               if (a.contains($$0xxx)) {
                  ...
                  bjn.a $$1xx = a($$0xxx);
                  return $$1xx == null ? "dummy" : blh.b($$1xx.a) + ":" + blh.b($$1xx.b);
               }
