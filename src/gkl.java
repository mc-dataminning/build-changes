...
public class gkl extends djh implements gke.a<gkl> {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final eez e = new eez();
   private final eff<bwi> f = new eff<>(bwi.class, new gkl.b());
   private final gkm E;
   private final gqh F;
   private final gqg G;
   private final gkl.a H;
   private final gpy I;
   private final bup J;
   private final fpo K = fpo.Q();
   final List<gpg> L = Lists.newArrayList();
   final List<cme> M = Lists.newArrayList();
   private final Map<eyo, eyq> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dis, fqr> Q = ag.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gpt.a, new fqr($$0xx -> this.b($$0xx, gpt.a)));
      $$0x.put(gpt.b, new fqr($$0xx -> this.b($$0xx, gpt.b)));
      $$0x.put(gpt.c, new fqr($$0xx -> this.b($$0xx, gpt.c)));
   });
   private final gkh R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final gly U = new gly();
   private final int V;
   private boolean W;
   private static final Set<czg> X = Set.of(czo.if, czo.ig);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(iv $$0, eao $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(iv $$0, eao $$1, fex $$2) {
      eao $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         crj $$4 = this.K.t;
   ...
   public gkl(gkm $$0, gkl.a $$1, alf<djh> $$2, jf<eel> $$3, int $$4, int $$5, gqh $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gkh(this, $$4);
      this.J = new bup();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new gqg(this.K, this, $$6);
      this.I = gpy.a($$3.a());
   ...
   private void a(bwi $$0, bwi $$1) {
      if ($$1.dP() || $$1.dj() != $$0) {
         $$1.bN();
      } else if ($$1 instanceof crj || this.e.c($$1)) {
         $$1.bw();
         $$1.af++;
         $$1.r();
   ...
   private dmm o() {
      if (this.K.r.i() == dje.b) {
         czk $$0 = this.K.t.fa();
         czg $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cxs $$2) {
            return $$2.c();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azv $$4, @Nullable dmm $$5, iv.a $$6) {
   ...
   private void a(iv $$0, eao $$1, lw $$2, boolean $$3) {
      if ($$1.y().c()) {
         ffr $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jb.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(iv $$0, lw $$1, ffr $$2, double $$3) {
   ...
   public void a(@Nullable bwi $$0, bwi $$1, jf<awm> $$2, awo $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hnh)(new hmy($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bwi $$0, awm $$1, awo $$2, float $$3, float $$4) {
      this.K.ak().a((hnh)(new hmy($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }

   @Override
   public void a(awm $$0, awo $$1, float $$2, float $$3) {
      if (this.K.t != null) {
         this.K.ak().a((hnh)(new hmy($$0, $$1, $$2, $$3, this.K.t, this.A.g())));
      }
   }
   ...
   private void a(double $$0, double $$1, double $$2, awm $$3, awo $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hnc $$10 = new hnc($$3, $$4, $$5, $$6, azv.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<dby> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gne.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jf<dkk> a(int $$0, int $$1, int $$2) {
      return this.F_().f(mh.aG).b(dkr.b);
   }
   ...
   public int a(fex $$0, float $$1) {
      float $$2 = this.f($$1);
      fex $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fex $$4 = aym.a($$3, ($$0x, $$1x, $$2x) -> fex.a(this.D_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(iv $$0, dis $$1) {
      fqr $$2 = (fqr)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(iv $$0, dis $$1) {
      int $$2 = fpo.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<eyo, eyq> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<eyo, eyq> $$0) {
      this.N.putAll($$0);
   }
   ...
   @Override
   public int s(iv $$0) {
      return fpo.Q().aw().a(this.a_($$0), this, $$0, 0);
   }

   @Override
   public void registerForCleaning(gke<gkl, ?> $$0) {
      this.E.a($$0);
   }

   public static class a implements ezj {
   ...
   final class b implements efb<bwi> {
      public void a(bwi $$0) {
      }
      ...
      public void e(bwi $$0) {
         ...
         switch ($$0) {
            case gpg $$1:
               ...
               break;
            case cmh $$2:
               gkl.this.M.addAll(Arrays.asList($$2.q()));
               break;
         }
      }
      ...
      public void f(bwi $$0) {
         ...
         switch ($$0) {
            case gpg $$1:
               ...
               break;
            case cmh $$2:
               gkl.this.M.removeAll(Arrays.asList($$2.q()));
               break;
         }
      }
