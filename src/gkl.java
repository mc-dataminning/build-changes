...
public class gkl {
   ...
   static final ThreadLocal<gkl.d> f = ThreadLocal.withInitial(gkl.d::new);

   public gkl(flg $$0) {
      this.d = $$0;
   }

   public void a(deo $$0, hbg $$1, dvv $$2, jh $$3, fer $$4, fev $$5, boolean $$6, azu $$7, long $$8, int $$9) {
      boolean $$10 = fke.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(deo $$0, hbg $$1, dvv $$2, jh $$3, fer $$4, fev $$5, boolean $$6, azu $$7, long $$8, int $$9) {
      ...
      for (jm $$14 : c) {
         $$7.b($$8);
         List<gkn> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || diq.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gkn> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(deo $$0, hbg $$1, dvv $$2, jh $$3, fer $$4, fev $$5, boolean $$6, azu $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jh.a $$11 = $$3.k();

      for (jm $$12 : c) {
         $$7.b($$8);
         List<gkn> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || diq.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = gjc.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gkn> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(deo $$0, dvv $$1, jh $$2, fer $$3, fev $$4, List<gkn> $$5, float[] $$6, BitSet $$7, gkl.b $$8, int $$9) {
      for (gkn $$10 : $$5) {
   ...
   private void a(
      deo $$0, dvv $$1, jh $$2, fev $$3, fer.a $$4, gkn $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(deo $$0, dvv $$1, jh $$2, int[] $$3, jm $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(deo $$0, dvv $$1, jh $$2, int $$3, int $$4, boolean $$5, fer $$6, fev $$7, List<gkn> $$8, BitSet $$9) {
      for (gkn $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fer.a $$0, fev $$1, @Nullable dvv $$2, hbg $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azu $$9 = azu.a();
      long $$10 = 42L;
   ...
   private static void a(fer.a $$0, fev $$1, float $$2, float $$3, float $$4, List<gkn> $$5, int $$6, int $$7) {
      for (gkn $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gkl.e[]{gkl.e.k, gkl.e.d, gkl.e.k, gkl.e.j, gkl.e.e, gkl.e.j, gkl.e.e, gkl.e.d},
         new gkl.e[]{gkl.e.k, gkl.e.c, gkl.e.k, gkl.e.i, gkl.e.e, gkl.e.i, gkl.e.e, gkl.e.c},
         new gkl.e[]{gkl.e.l, gkl.e.c, gkl.e.l, gkl.e.i, gkl.e.f, gkl.e.i, gkl.e.f, gkl.e.c},
         new gkl.e[]{gkl.e.l, gkl.e.d, gkl.e.l, gkl.e.j, gkl.e.f, gkl.e.j, gkl.e.f, gkl.e.d}
      ),
      b(
         new jm[]{jm.f, jm.e, jm.c, jm.d},
         1.0F,
         true,
         new gkl.e[]{gkl.e.f, gkl.e.d, gkl.e.f, gkl.e.j, gkl.e.l, gkl.e.j, gkl.e.l, gkl.e.d},
         new gkl.e[]{gkl.e.f, gkl.e.c, gkl.e.f, gkl.e.i, gkl.e.l, gkl.e.i, gkl.e.l, gkl.e.c},
         new gkl.e[]{gkl.e.e, gkl.e.c, gkl.e.e, gkl.e.i, gkl.e.k, gkl.e.i, gkl.e.k, gkl.e.c},
         new gkl.e[]{gkl.e.e, gkl.e.d, gkl.e.e, gkl.e.j, gkl.e.k, gkl.e.j, gkl.e.k, gkl.e.d}
      ),
      c(
         new jm[]{jm.b, jm.a, jm.f, jm.e},
         0.8F,
         true,
         new gkl.e[]{gkl.e.b, gkl.e.k, gkl.e.b, gkl.e.e, gkl.e.h, gkl.e.e, gkl.e.h, gkl.e.k},
         new gkl.e[]{gkl.e.b, gkl.e.l, gkl.e.b, gkl.e.f, gkl.e.h, gkl.e.f, gkl.e.h, gkl.e.l},
         new gkl.e[]{gkl.e.a, gkl.e.l, gkl.e.a, gkl.e.f, gkl.e.g, gkl.e.f, gkl.e.g, gkl.e.l},
         new gkl.e[]{gkl.e.a, gkl.e.k, gkl.e.a, gkl.e.e, gkl.e.g, gkl.e.e, gkl.e.g, gkl.e.k}
      ),
      d(
         new jm[]{jm.e, jm.f, jm.a, jm.b},
         0.8F,
         true,
         new gkl.e[]{gkl.e.b, gkl.e.k, gkl.e.h, gkl.e.k, gkl.e.h, gkl.e.e, gkl.e.b, gkl.e.e},
         new gkl.e[]{gkl.e.a, gkl.e.k, gkl.e.g, gkl.e.k, gkl.e.g, gkl.e.e, gkl.e.a, gkl.e.e},
         new gkl.e[]{gkl.e.a, gkl.e.l, gkl.e.g, gkl.e.l, gkl.e.g, gkl.e.f, gkl.e.a, gkl.e.f},
         new gkl.e[]{gkl.e.b, gkl.e.l, gkl.e.h, gkl.e.l, gkl.e.h, gkl.e.f, gkl.e.b, gkl.e.f}
      ),
      e(
         new jm[]{jm.b, jm.a, jm.c, jm.d},
         0.6F,
         true,
         new gkl.e[]{gkl.e.b, gkl.e.d, gkl.e.b, gkl.e.j, gkl.e.h, gkl.e.j, gkl.e.h, gkl.e.d},
         new gkl.e[]{gkl.e.b, gkl.e.c, gkl.e.b, gkl.e.i, gkl.e.h, gkl.e.i, gkl.e.h, gkl.e.c},
         new gkl.e[]{gkl.e.a, gkl.e.c, gkl.e.a, gkl.e.i, gkl.e.g, gkl.e.i, gkl.e.g, gkl.e.c},
         new gkl.e[]{gkl.e.a, gkl.e.d, gkl.e.a, gkl.e.j, gkl.e.g, gkl.e.j, gkl.e.g, gkl.e.d}
      ),
      f(
         new jm[]{jm.a, jm.b, jm.c, jm.d},
         0.6F,
         true,
         new gkl.e[]{gkl.e.g, gkl.e.d, gkl.e.g, gkl.e.j, gkl.e.a, gkl.e.j, gkl.e.a, gkl.e.d},
         new gkl.e[]{gkl.e.g, gkl.e.c, gkl.e.g, gkl.e.i, gkl.e.a, gkl.e.i, gkl.e.a, gkl.e.c},
         new gkl.e[]{gkl.e.h, gkl.e.c, gkl.e.h, gkl.e.i, gkl.e.b, gkl.e.i, gkl.e.b, gkl.e.c},
         new gkl.e[]{gkl.e.h, gkl.e.d, gkl.e.h, gkl.e.j, gkl.e.b, gkl.e.j, gkl.e.b, gkl.e.d}
      );
      ...
      final gkl.e[] k;
      final gkl.e[] l;
      private static final gkl.a[] m = ae.a(new gkl.a[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
      ...
      private a(final jm[] $$0, final float $$1, final boolean $$2, final gkl.e[] $$3, final gkl.e[] $$4, final gkl.e[] $$5, final gkl.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(deo $$0, dvv $$1, jh $$2, jm $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dvv $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dvv $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dvv $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dvv $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gkl.c[] k = ae.a(new gkl.c[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dvv $$0, deo $$1, jh $$2) {
         long $$3 = $$2.a();
         if (this.a) {
