...
public class gkl {
   ...
   public gke a(Vector3f $$0, Vector3f $$1, gkg $$2, gyt $$3, jm $$4, hbk $$5, @Nullable gkh $$6, boolean $$7, int $$8) {
      gki $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      $$9.a[0] = azn.h($$11, $$9.a[0], $$12);
      $$9.a[2] = azn.h($$11, $$9.a[2], $$12);
      $$9.a[1] = azn.h($$11, $$9.a[1], $$13);
      $$9.a[3] = azn.h($$11, $$9.a[3], $$13);
      ...
      return new gke($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gki a(gki $$0, jm $$1, j $$2) {
      ...
      Vector3f $$24 = $$23.transform(new Vector3f(azn.b($$22), azn.a($$22), 0.0F));
      int $$25 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$24.y(), (double)$$24.x())) / 90.0)) * 90, 360);
      return new gki(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gki $$0, gyt $$1, jm $$2, float[] $$3, j $$4, @Nullable gkh $$5) {
      int[] $$6 = new int[32];
   ...
   private void a(int[] $$0, int $$1, jm $$2, gki $$3, float[] $$4, gyt $$5, j $$6, @Nullable gkh $$7) {
      gik.b $$8 = gik.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gyt $$3, gki $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gkh $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, jm $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (azn.a($$13, $$18) && azn.a($$14, $$19) && azn.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
