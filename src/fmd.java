...
public class fmd implements Comparable<fmd> {
   private static final Map<String, fmd> h = Maps.newHashMap();
   private static final Map<ffm.a, fmd> i = Maps.newHashMap();
   ...
   public fmd(String $$0, int $$1, String $$2) {
      this($$0, ffm.b.a, $$1, $$2);
   }

   public fmd(String $$0, ffm.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public int a(fmd $$0) {
      return this.n.equals($$0.n) ? hcr.a(this.l).compareTo(hcr.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
