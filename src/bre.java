...
public class bre implements brj {
   ...
   private final Map<String, bre.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, bsv>> o = new ObjectArraySet();

   public bre(LongSupplier $$0, IntSupplier $$1, BooleanSupplier $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> brk.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         if ($$2 > a && !this.n.getAsBoolean()) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> brk.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bre.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bre.a());
      }
   ...
   @Override
   public brk d() {
      return new brh(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }

   @Nullable
   @Override
   public bre.a c(String $$0) {
      return this.f.get($$0);
   }

   @Override
   public Set<Pair<String, bsv>> e() {
      return this.o;
   }
