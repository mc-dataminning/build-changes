...
public interface bre<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements bre<bre.c> {
   ...
   public static final class b implements bre<Runnable> {
      private final Queue<Runnable> a;
