public class bre implements brf {
   private final bln a;
   ...
   private void b() {
      this.a.aU = atq.c(this.a.aU, this.a.aW, (float)this.a.ab());
   }
   ...
   private void d() {
      int $$0 = this.e - 10;
      float $$1 = atq.a((float)$$0 / 10.0F, 0.0F, 1.0F);
      float $$2 = (float)this.a.ab() * (1.0F - $$1);
      this.a.aU = atq.c(this.a.aU, this.a.aW, $$2);
   }

   private boolean e() {
      return !(this.a.cR() instanceof bln);
   }
