...
public class gpt implements gpm {
   ...
   public static final MapCodec<gpt> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   private gpt(List<akk> $$0, akk $$1, Map<String, akk> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   public static int[] a(atu $$0, akk $$1) {
      Optional<ats> $$2 = $$0.getResource(a.a($$1));
      if ($$2.isEmpty()) {
   ...
   static record a(gps a, Supplier<IntUnaryOperator> b, akk c) implements gpm.b {
      @Nullable
      public gpc a(gpl $$0) {
         Object var3;
         try {
            ezh $$1 = this.a.a().a(this.b.get());
            return new gpc(this.c, new gqv($$1.a(), $$1.b()), $$1, atw.a);
         } catch (IllegalArgumentException | IOException var7) {
            gpt.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
