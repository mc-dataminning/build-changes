...
@Deprecated
public class eki extends ejt<eki.a> {
   private static final eao a = dmo.nI.m();

   public eki(Codec<eki.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejv<eki.a> $$0) {
      iv $$1 = $$0.e();
      dkg $$2 = $$0.b();
      azv $$3 = $$0.d();
      eki.a $$4 = $$0.f();
         ...
         if ($$21.y().a(axh.a)) {
            for (int $$39 = 0; $$39 < 16; $$39++) {
               for (int $$40 = 0; $$40 < 16; $$40++) {
                  int $$41 = 4;
                  iv $$42 = $$1.b($$39, 4, $$40);
                  if ($$2.u($$42).a().a($$2, $$42, false) && this.c($$2.a_($$42))) {
                     $$2.a($$42, dmo.ee.m(), 2);
                  }
               }
            }
   ...
   public static record a(eny b, eny c) implements elx {
      public static final Codec<eki.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eny.a.fieldOf("fluid").forGetter(eki.a::a), eny.a.fieldOf("barrier").forGetter(eki.a::b)).apply($$0, eki.a::new)
      );
