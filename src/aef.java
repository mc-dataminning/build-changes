...
public class aef {
   ...
   private static final Object2IntMap<Class<? extends bil>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final bil d;
   private final Int2ObjectMap<aef.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> aec<T> a(Class<? extends bil> $$0, aed<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(aec<T> $$0, T $$1) {
      aef.a<T> $$2 = new aef.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(aec<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> aef.a<T> c(aec<T> $$0) {
      this.f.readLock().lock();

      aef.a<T> $$1;
      try {
         $$1 = (aef.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(aec<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(aec<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(aec<T> $$0, T $$1, boolean $$2) {
      aef.a<T> $$3 = this.c($$0);
   ...
   private <T> void a(aef.a<T> $$0, aef.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public aef.b<T> e() {
         return aef.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, aed<T> b, T c) {

      public static <T> aef.b<T> a(aec<T> $$0, T $$1) {
         aed<T> $$2 = $$0.b();
         return new aef.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static aef.b<?> a(sl $$0, int $$1) {
         int $$2 = $$0.m();
         aed<?> $$3 = aee.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aef.b<T> a(sl $$0, int $$1, aed<T> $$2) {
         return new aef.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
