...
public class aef<C extends bgh> implements aee<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final cbp a = new cbp();
   protected cbk b;
   protected cfm<C> c;
   ...
   public void a(akj $$0, @Nullable clz<C> $$1, boolean $$2) {
      if ($$1 != null && $$0.F().b($$1)) {
         this.b = $$0.fQ();
         if (this.b() || $$0.f()) {
            this.a.a();
   ...
   protected void a(clz<C> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            ciw $$3 = this.c.b($$2).e().p();
            if (!$$3.b()) {
               int $$4 = this.b.d($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (ciw $$5 : $$0) {
                     if (ciw.b($$5, $$3) && $$5.L() != $$5.g() && $$5.L() + $$3.L() <= $$5.g()) {
                        $$5.g($$3.L());
                        $$3.f(0);
                        break;
                     }
