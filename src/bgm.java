...
public class bgm extends DataFix {
   ...
   public bgm(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bfy.F);
      Type<?> $$1 = this.getInputSchema().getType(bfy.F);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bhj.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bfy.g);
      Type<?> $$1 = this.getInputSchema().getType(bfy.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bhj.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
