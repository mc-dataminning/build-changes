...
public class bhq extends DataFix {
   ...
   private TypeRewriteRule a() {
      ...
      return this.fixTypeEverywhereTyped("BlockEntityMobEffectIdFix", $$0, $$0x -> this.a($$0x, biz.s, "minecraft:beacon", $$0xx -> {
   ...
   private TypeRewriteRule b() {
      ...
      return this.fixTypeEverywhereTyped("EntityMobEffectIdFix", $$0, $$0x -> {
         $$0x = this.a($$0x, biz.D, "minecraft:mooshroom", bhq::c);
         $$0x = this.a($$0x, biz.D, "minecraft:arrow", bhq::d);
         $$0x = this.a($$0x, biz.D, "minecraft:area_effect_cloud", bhq::e);
         return $$0x.update(DSL.remainderFinder(), bhq::f);
      });
   }

   private TypeRewriteRule c() {
      Type<?> $$0 = this.getInputSchema().getType(biz.b);
   ...
   private TypeRewriteRule d() {
      OpticFinder<Pair<String, String>> $$0 = DSL.fieldFinder("id", DSL.named(biz.F.typeName(), bku.a()));
