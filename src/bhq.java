...
public class bhq extends bgk {
   public bhq(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bho.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bjc.a($$0.get("id").asString("minecraft:air"));
