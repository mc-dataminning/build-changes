...
public record bhq(Instant a, String b, long c) {
   ...
   public static bhq a(RecordedEvent $$0) {
      ...
      return new bhq($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bhq.a a(List<bhq> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bhq>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bhq $$3 = (bhq)$$2x.get(0);
            bhq $$4 = (bhq)$$2x.get($$2x.size() - 1);
