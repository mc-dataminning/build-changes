...
public class bhq extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      CompoundListType<String, ?> $$0 = DSL.compoundList(DSL.string(), this.getInputSchema().getType(bis.G));
      OpticFinder<? extends List<? extends Pair<String, ?>>> $$1 = $$0.finder();
      return this.a($$0);
   }

   private <SF> TypeRewriteRule a(CompoundListType<String, SF> $$0) {
      Type<?> $$1 = this.getInputSchema().getType(bis.c);
      Type<?> $$2 = this.getInputSchema().getType(bis.G);
      ...
      return TypeRewriteRule.seq(
         ...
         this.fixTypeEverywhereTyped(
            ...
            $$0x -> $$0x.update(
                  DSL.remainderFinder(),
                  $$0xx -> $$0xx.update(
                        "id", $$0xxx -> Objects.equals(bkg.a($$0xxx.asString("")), "minecraft:new_village") ? $$0xxx.createString("minecraft:village") : $$0xxx
                     )
               )
         )
      );
