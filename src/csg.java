...
public class csg extends crz {
   ...
   private float k;
   private int l = 0;
   public final List<csg.a> e = new LinkedList<>();
   public final List<csg.a> f = new LinkedList<>();
   public double g = 0.0;
   public csg.a h = csg.a.b;
   ...
   public void g() {
      if (this.h() instanceof ash $$0) {
         ...
         this.u();
         boolean $$1 = djt.h(this.h().a_(this.a.p()));
         this.a.a($$1);
      }
   }
   ...
   public void s() {
      this.h = new csg.a(this.k(), this.j(), this.p(), this.o(), 0.0F);
   }
   ...
   private csg.b g(float $$0) {
      if ($$0 == this.k && this.l == this.j && this.i != null) {
         ...
         csg.a $$8 = this.f.get($$5);
         csg.a $$9 = $$5 > 0 ? this.f.get($$5 - 1) : this.h;
         this.i = new csg.b($$3, $$8, $$9);
         this.j = this.l;
         this.k = $$0;
         return this.i;
      }
   ...
   public void a(jh $$0, dxn $$1, boolean $$2) {
      if (djt.h($$1)) {
         dyq $$3 = $$1.c(((djt)$$1.b()).c());
         Pair<kl, kl> $$4 = crr.a($$3);
         fbs $$5 = new fbs((kl)$$4.getFirst()).c(0.5);
         fbs $$6 = new fbs((kl)$$4.getSecond()).c(0.5);
         fbs $$7 = $$5.f();
         fbs $$8 = $$6.f();
         ...
         if ($$12) {
            ...
            $$16 = new fbs($$18 ? $$0.b().d : $$11.d, (double)$$0.v(), $$17 ? $$0.b().f : $$11.f);
         }
         ...
         if ($$25 > 0.0) {
            this.e.add(new csg.a(this.k(), this.j(), this.p(), this.o(), $$2 ? 0.0F : (float)$$25));
         }
      }
   }
   ...
   @Override
   public void a(ash $$0) {
      for (csg.c $$1 = new csg.c(); $$1.a() && this.a.bL(); $$1.b = false) {
         fbs $$2 = this.j();
         jh $$3 = this.a.p();
         dxn $$4 = this.h().a_($$3);
         boolean $$5 = djt.h($$4);
         ...
         if ($$5) {
            ...
            this.a.bz();
            if ($$4.a(dkg.hx)) {
               this.a.a($$3.u(), $$3.v(), $$3.w(), $$4.c(dqd.f));
            }

            dyq $$6 = $$4.c(((djt)$$4.b()).c());
            fbs $$7 = this.a($$0, $$2.f(), $$1, $$3, $$4, $$6);
            if ($$1.b) {
               $$1.a = $$7.i();
            } else {
               $$1.a = $$1.a + ($$7.i() - $$2.i());
         ...
         if ($$10 > 1.0E-5F) {
            ...
            this.e.add(new csg.a($$8, this.j(), this.p(), this.o(), (float)Math.min($$10, this.b($$0))));
         } else if ($$2.j() > 0.0) {
            this.e.add(new csg.a($$8, this.j(), this.p(), this.o(), 1.0F));
         }
   ...
   private fbs a(ash $$0, fbs $$1, csg.c $$2, jh $$3, dxn $$4, dyq $$5) {
      fbs $$6 = $$1;
      if (!$$2.c) {
         fbs $$7 = this.a($$1, $$5);
         if ($$7.j() != $$1.j()) {
   ...
   private fbs d(fbs $$0) {
      if (this.a.da() instanceof asi $$1) {
         ...
         if ($$3.h() > 0.0) {
            ...
            double $$5 = $$0.j();
            if ($$4.h() > 0.0 && $$5 < 0.01) {
               return $$0.e(new fbs($$4.d, 0.0, $$4.f).d().c(0.001));
            }
         }
   ...
   private fbs a(fbs $$0, dxn $$1) {
      if ($$1.a(dkg.bw) && !$$1.c(dqd.f)) {
         return $$0.g() < 0.03 ? fbs.c : $$0.c(0.5);
      } else {
         return $$0;
      }
   }

   private fbs a(fbs $$0, jh $$1, dxn $$2) {
      if ($$2.a(dkg.bw) && $$2.c(dqd.f)) {
         if ($$0.g() > 0.01) {
   ...
   public double a(jh $$0, dyq $$1, double $$2) {
      if ($$2 < 1.0E-5F) {
         ...
         if ($$7.g() < 1.0E-5F) {
            ...
            boolean $$8 = $$5.v() != $$6.v();
            fbs $$9 = new fbs($$6).c(0.5).f();
            fbs $$10 = new fbs($$5).c(0.5).f();
            if ($$7.b($$10) < $$7.b($$9)) {
               $$10 = $$9;
            }

            fbs $$11 = $$0.c().e($$10).b(0.0, 0.1, 0.0).e($$10.d().c(1.0E-5F));
            if ($$8 && !this.b($$7, $$1)) {
               $$11 = $$11.b(0.0, 1.0, 0.0);
            }

            fbs $$12 = $$11.d(this.k()).d();
            $$7 = $$12.c($$7.g() / $$12.i());
            fbs $$13 = $$3.e($$7.d().c($$2 * (double)($$8 ? bae.g : 1.0F)));
            if ($$3.g($$11) <= $$3.g($$13)) {
               $$2 = $$11.d($$13).i();
               $$13 = $$11;
            } else {
            ...
            this.a.a(bwf.a, $$13.d($$3));
            dxn $$14 = this.h().a_(jh.a((ka)$$13));
            if ($$8) {
               if (djt.h($$14)) {
                  dyq $$15 = $$14.c(((djt)$$14.b()).c());
                  if (this.a($$1, $$15)) {
                     return 0.0;
                  }
               }
   ...
   public double b(ash $$0) {
      return (double)$$0.N().c(dgw.Z) * (this.a.bj() ? 0.5 : 1.0) / 20.0;
   }

   private boolean b(fbs $$0, dyq $$1) {
      return switch ($$1) {
         case c -> $$0.d < 0.0;
         case d -> $$0.d > 0.0;
         case e -> $$0.f > 0.0;
   ...
   public boolean b(fbn $$0) {
      boolean $$1 = false;
      if (this.a.D()) {
         List<bvf> $$2 = this.h().a(this.a, $$0, bvk.a(this.a));
         if (!$$2.isEmpty()) {
            for (bvf $$3 : $$2) {
               if ($$3 instanceof cps || $$3 instanceof cie || $$3 instanceof crr || this.a.ca() || $$3.bZ()) {
                  $$3.h(this.a);
                  $$1 = true;
               }
            }
         ...
         for (bvf $$4 : this.h().a_(this.a, $$0)) {
            if (!this.a.y($$4) && $$4.bI() && $$4 instanceof crr) {
               $$4.h(this.a);
               $$1 = true;
            }
         }
   ...
   public static record a(fbs c, fbs d, float e, float f, float g) {
      public static final zt<ByteBuf, csg.a> a = zt.a(fbs.b, csg.a::a, fbs.b, csg.a::b, zr.d, csg.a::c, zr.d, csg.a::d, zr.l, csg.a::e, csg.a::new);
      public static csg.a b = new csg.a(fbs.c, fbs.c, 0.0F, 0.0F, 0.0F);
   ...
   static record b(float a, csg.a b, csg.a c) {
   }
