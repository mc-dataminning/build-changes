...
public class aqm extends aqg {
   ...
   private final aqm.b d;
   private final String e;

   aqm(String $$0, aqm.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aqp $$0, aiy $$1) {
   ...
   @Nullable
   private ars<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : ars.create($$1, $$2);
      }
   }
   ...
   public static class a implements ari.c {
      ...
      public aqo a(String $$0) {
         aqm.b $$1 = new aqm.b(this.a);
         return new aqm($$0, $$1, this.b, "");
      }

      @Override
      public aqo a(String $$0, ari.a $$1) {
         aqm.b $$2 = new aqm.b(this.a);
         aqo $$3 = new aqm($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aqo> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aqm($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aqm.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
