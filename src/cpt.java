...
public record cpt(int b, int c, io<cpi> d, Optional<cpt.a> e) {
   private static final int f = 3;
   public static final MapCodec<cpt> a = cpt.a.a
      .flatXmap(cpt::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));

   public static cpt a(Map<Character, cpi> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cpt a(Map<Character, cpi> $$0, List<String> $$1) {
      cpt.a $$2 = new cpt.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cpt> a(cpt.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      io<cpi> $$4 = io.a($$2 * $$3, cpi.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cpt($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cia $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   public static cpt b(ue $$0) {
      int $$1 = $$0.n();
      int $$2 = $$0.n();
      io<cpi> $$3 = io.a($$1 * $$2, cpi.a);
      $$3.replaceAll($$1x -> cpi.b($$0));
      return new cpt($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cpt.a> d() {
      return this.e;
   }

   public static record a(Map<Character, cpi> b, List<String> c) {
      ...
      public static final MapCodec<cpt.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(atg.d(e, cpi.c).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cpt.a::new)
      );

      public Map<Character, cpi> a() {
         return this.b;
      }
