...
public final class kh {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ad.a($$0, 4).map(kh::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final zb<ByteBuf, UUID> g = new zb<ByteBuf, UUID>() {
