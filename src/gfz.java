...
public class gfz extends gfv implements abk, wc {
   ...
   private gga D = new gga(Map.of(), dbr.b.a());
   private final UUID E = UUID.randomUUID();
   private Set<akt<dgi>> F;
   ...
   public void a(adc $$0) {
      ...
      aga $$1 = $$0.m();
      List<akt<dgi>> $$2 = Lists.newArrayList($$0.f());
   ...
   private static boolean a(bvt $$0, Set<bvu> $$1, buk $$2, boolean $$3) {
      ...
      if ($$3 && !$$6) {
         ...
         $$2.v($$5.c());
         $$2.w($$5.d());
         bvt $$7 = new bvt($$2.bC(), fba.c, $$2.N, $$2.O);
         bvt $$8 = bvt.a($$7, $$0, $$1);
         $$2.c($$8.a(), $$8.c(), $$8.d());
         return false;
      }
   ...
   public void a(afn $$0) {
      ...
      this.b.a(aaz.d, new gfw(this.a, this.b, new ggd(this.r, this.e, this.G, this.H, this.d, this.c, this.f, this.h, $$1, this.i, this.j)));
      this.b(agt.a);
      this.b.a(aaz.b);
   }
   ...
   public void a(afs $$0) {
      ...
      if ($$1 != null) {
         if ($$1 instanceof buw) {
            this.s.a($$1.dB(), $$1.dD(), $$1.dH(), awa.jc, awb.h, 0.1F, (this.B.i() - this.B.i()) * 0.35F + 0.9F, false);
         } else {
            this.s.a($$1.dB(), $$1.dD(), $$1.dH(), awa.oa, awb.h, 0.2F, (this.B.i() - this.B.i()) * 1.4F + 2.0F, false);
         }
   ...
   public void a(aco $$0) {
      ...
      if ($$1 != null) {
         switch ($$0.b()) {
            case 21:
               this.a.ak().a((hii)(new hia((clt)$$1)));
               break;
            case 35:
               int $$2 = 40;
               this.a.g.a($$1, lt.am, 30);
               this.s.a($$1.dB(), $$1.dD(), $$1.dH(), awa.Ao, $$1.dn(), 1.0F, 1.0F, false);
               if ($$1 == this.a.t) {
                  this.a.j.a(a((cox)this.a.t));
               }
               break;
            case 63:
               this.a.ak().a((hii)(new hie((cjo)$$1)));
               break;
            default:
               $$1.b($$0.b());
         }
   ...
   private fui.a a(boolean $$0, akt<dgi> $$1, akt<dgi> $$2) {
      fui.a $$3 = fui.a.c;
      if (!$$0) {
         if ($$1 == dgi.j || $$2 == dgi.j) {
            $$3 = fui.a.a;
   ...
   public void a(abr $$0) {
      ...
      this.a.s.a($$1, $$0.e()).ifPresent($$1x -> {
         ...
         if ($$1x instanceof duj && this.a.z instanceof fvk) {
            ((fvk)this.a.z).G();
         }
      });
   }
   ...
   public void a(aex $$0) {
      ...
      if (this.s.a($$0.b()) instanceof bvg $$2) {
         $$0.e().forEach($$1 -> $$2.a((bus)$$1.getFirst(), (cwp)$$1.getSecond()));
      }
   }
   ...
   public void a(acs $$0) {
      ...
      if ($$2 == acs.b) {
         ...
         this.s.a($$1, $$1.dB(), $$1.dF(), $$1.dH(), awa.aF, awb.h, 0.18F, 0.45F);
      } else if ($$2 == acs.i) {
         this.s.e($$3);
      } else if ($$2 == acs.j) {
         this.s.c($$3);
      } else if ($$2 == acs.k) {
         this.s.a($$1, $$1.dB(), $$1.dD(), $$1.dH(), awa.vv, awb.g, 1.0F, 1.0F);
      } else if ($$2 == acs.l) {
         this.s.a(lt.q, $$1.dB(), $$1.dD(), $$1.dH(), 0.0, 0.0, 0.0);
         if ($$4 == 1) {
            this.s.a($$1, $$1.dB(), $$1.dD(), $$1.dH(), awa.il, awb.f, 1.0F, 1.0F);
         }
      } else if ($$2 == acs.m) {
         this.a.t.b($$3 == 0.0F);
      } else if ($$2 == acs.n) {
   ...
   private void a(ads.a $$0, ads.b $$1, ggk $$2) {
      switch ($$0) {
         case b:
            this.a($$1, $$2);
            break;
