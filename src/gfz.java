...
public class gfz {
   ...
   public void a(final gfx $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final gha $$3 = gha.a($$0.b);
      Optional<InetSocketAddress> $$4 = ghc.a.a($$3).map(ggz::d);
      if ($$4.isEmpty()) {
         this.a(fsv.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final gha $$1, final gfx $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)wp.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new gfq($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(gfx.b.d);
               $$2.h = xv.b($$2xx);
               $$2.d = xv.b($$3);
               $$2.c = gfz.a($$4, $$5);
