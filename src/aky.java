...
public class aky extends IOException {
   private final List<aky.a> a = Lists.newArrayList();
   private final String b;

   public aky(String $$0) {
      this.a.add(new aky.a());
      this.b = $$0;
   }

   public aky(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new aky.a());
      this.b = $$0;
   }
   ...
   public static aky a(Exception $$0) {
      if ($$0 instanceof aky) {
         return (aky)$$0;
      } else {
