...
public class aky {
   ...
   static final ayq c = new ayq();
   private final akx d;
   private final aky.b<?>[] e;
   private boolean f;
   ...
   public static <T> aku<T> a(Class<? extends akx> $$0, akv<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> aky.b<T> b(aku<T> $$0) {
      return (aky.b<T>)this.e[$$0.a()];
   }

   public <T> T a(aku<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(aku<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(aku<T> $$0, T $$1, boolean $$2) {
      aky.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(aky.b<T> $$0, aky.c<?> $$1) {
   ...
   public static class a {
      private final akx a;
      private final aky.b<?>[] b;

      public a(akx $$0) {
         this.a = $$0;
         this.b = new aky.b[aky.c.b($$0.getClass())];
      }

      public <T> aky.a a(aku<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public aky.c<T> e() {
         return aky.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, akv<T> b, T c) {

      public static <T> aky.c<T> a(aku<T> $$0, T $$1) {
         akv<T> $$2 = $$0.b();
         return new aky.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static aky.c<?> a(wp $$0, int $$1) {
         int $$2 = $$0.l();
         akv<?> $$3 = akw.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aky.c<T> a(wp $$0, int $$1, akv<T> $$2) {
         return new aky.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
