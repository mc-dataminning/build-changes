...
public class aky implements cqp {
   ...
   private static final aex t = new aex("worldgen_region_random");

   public aky(akr $$0, List<dhf> $$1, dhk $$2, int $$3) {
      this.p = $$2;
      this.q = $$3;
      int $$4 = arx.a(Math.sqrt((double)$$1.size()));
      if ($$4 * $$4 != $$1.size()) {
