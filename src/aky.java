...
public class aky {
   ...
   private static int a(ds $$0, Collection<anf> $$1, hx $$2, float $$3) {
      ahg<ctx> $$4 = $$0.e().ae();
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> vg.a("commands.spawnpoint.success.single", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.iterator().next().Q_()), true);
      } else {
         $$0.a(() -> vg.a("commands.spawnpoint.success.multiple", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.size()), true);
      }
