...
public class fpq extends foc<crw> {
   private static final alf D = new alf("container/stonecutter/scroller");
   private static final alf E = new alf("container/stonecutter/scroller_disabled");
   private static final alf F = new alf("container/stonecutter/recipe_selected");
   private static final alf G = new alf("container/stonecutter/recipe_highlighted");
   private static final alf H = new alf("container/stonecutter/recipe");
   private static final alf I = new alf("textures/gui/container/stonecutter.png");
   ...
   private void b(fgs $$0, int $$1, int $$2, int $$3) {
      List<cyy<czq>> $$4 = this.w.m();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.J()) {
         ...
         this.S = ayz.a(this.S - $$5, 0.0F, 1.0F);
