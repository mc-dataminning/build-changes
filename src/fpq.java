...
public class fpq implements fps {
   ...
   @Override
   public void a(fhd $$0, int $$1, int $$2, fhf $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, fhf $$4, fhd $$5) {
      if ($$2 >= this.f.d()) {
         this.a($$4, $$0, $$1, $$3 ? fpq.a.a : fpq.a.b);
      } else {
         cuc $$6 = this.f.a($$2);
         this.a($$4, $$0, $$1, fpq.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            fny.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(fhf $$0, int $$1, int $$2, fpq.a $$3) {
