...
public class fpq extends fnd {
   ...
   private static final ImmutableList<dtm> x = ImmutableList.copyOf(dtm.values());
   private static final ImmutableList<dtm> y = x.stream().filter($$0 -> $$0 != dtm.d).collect(ImmutableList.toImmutableList());
   private final dqw z;
   private djw A = djw.a;
   private dlm B = dlm.a;
   private dtm C = dtm.d;
   ...
   private fhe V;
   private fhe W;
   private fhl<Boolean> X;
   private fhl<djw> Y;
   private fhl<Boolean> Z;
   private fhl<Boolean> aa;
   ...
   @Override
   protected void aM_() {
      this.c((fhe)fhe.a(xo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
      ...
      this.E = this.z.E();
      this.F = this.z.F();
      this.Q = this.c((fhe)fhe.a(xp.c("structure_block.button.save"), $$0x -> {
         if (this.z.v() == dtm.a) {
            this.a(dqw.a.b);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 185, 50, 20).a());
      this.R = this.c((fhe)fhe.a(xp.c("structure_block.button.load"), $$0x -> {
         if (this.z.v() == dtm.b) {
            this.a(dqw.a.c);
            this.m.a(null);
         }
      ...
      this.c(
         fhl.<dtm>a($$0x -> xp.c("structure_block.mode." + $$0x.c()))
            .a(y, x)
            .a()
            .a(this.C)
      ...
      this.W = this.c((fhe)fhe.a(xp.c("structure_block.button.detect_size"), $$0x -> {
         if (this.z.v() == dtm.a) {
            this.a(dqw.a.d);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 120, 50, 20).a());
      this.X = this.c(fhl.b(!this.z.w()).a().a(this.n / 2 + 4 + 100, 160, 50, 20, s, ($$0x, $$1x) -> this.z.a(!$$1x)));
      this.Y = this.c(fhl.<djw>a(djw::b).a(djw.values()).a().a(this.A).a(this.n / 2 - 20, 185, 40, 20, xp.b("MIRROR"), ($$0x, $$1x) -> this.z.a($$1x)));
      this.Z = this.c(fhl.b(this.z.E()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, v, ($$0x, $$1x) -> this.z.d($$1x)));
      this.aa = this.c(fhl.b(this.z.F()).a().a(this.n / 2 + 4 + 100, 80, 50, 20, w, ($$0x, $$1x) -> this.z.e($$1x)));
      this.S = this.c((fhe)fhe.a(xp.b("0"), $$0x -> {
         this.z.a(dlm.a);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.T = this.c((fhe)fhe.a(xp.b("90"), $$0x -> {
         this.z.a(dlm.b);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.U = this.c((fhe)fhe.a(xp.b("180"), $$0x -> {
         this.z.a(dlm.c);
         this.F();
      }).a(this.n / 2 + 1 + 20, 185, 40, 20).a());
      this.V = this.c((fhe)fhe.a(xp.b("270"), $$0x -> {
         this.z.a(dlm.d);
         this.F();
      }).a(this.n / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.G = new fhn(this.p, this.n / 2 - 152, 40, 300, 20, xp.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !fpq.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.G.f(128);
      this.G.a(this.z.c());
      this.d(this.G);
      iz $$0 = this.z.f();
      this.H = new fhn(this.p, this.n / 2 - 152, 80, 80, 20, xp.c("structure_block.position.x"));
      this.H.f(15);
      this.H.a(Integer.toString($$0.u()));
      this.d(this.H);
      this.I = new fhn(this.p, this.n / 2 - 72, 80, 80, 20, xp.c("structure_block.position.y"));
      this.I.f(15);
      this.I.a(Integer.toString($$0.v()));
      this.d(this.I);
      this.J = new fhn(this.p, this.n / 2 + 8, 80, 80, 20, xp.c("structure_block.position.z"));
      this.J.f(15);
      this.J.a(Integer.toString($$0.w()));
      this.d(this.J);
      kd $$1 = this.z.j();
      this.K = new fhn(this.p, this.n / 2 - 152, 120, 80, 20, xp.c("structure_block.size.x"));
      this.K.f(15);
      this.K.a(Integer.toString($$1.u()));
      this.d(this.K);
      this.L = new fhn(this.p, this.n / 2 - 72, 120, 80, 20, xp.c("structure_block.size.y"));
      this.L.f(15);
      this.L.a(Integer.toString($$1.v()));
      this.d(this.L);
      this.M = new fhn(this.p, this.n / 2 + 8, 120, 80, 20, xp.c("structure_block.size.z"));
      this.M.f(15);
      this.M.a(Integer.toString($$1.w()));
      this.d(this.M);
      this.N = new fhn(this.p, this.n / 2 - 152, 120, 80, 20, xp.c("structure_block.integrity.integrity"));
      this.N.f(15);
      this.N.a(this.ab.format((double)this.z.x()));
      this.d(this.N);
      this.O = new fhn(this.p, this.n / 2 - 72, 120, 80, 20, xp.c("structure_block.integrity.seed"));
      this.O.f(31);
      this.O.a(Long.toString(this.z.y()));
      this.d(this.O);
      this.P = new fhn(this.p, this.n / 2 - 152, 120, 240, 20, xp.c("structure_block.custom_data"));
      this.P.f(128);
      this.P.a(this.z.u());
      this.d(this.P);
      this.F();
