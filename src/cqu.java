...
public abstract class cqu {
   ...
   public void a(bkm<?> $$0, @Nullable crs $$1, ato $$2, ht $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ht $$13 = ht.a($$10, $$11, $$12);
                  if ($$4.b().isPresent()) {
                     if (!$$7.get().f().d() && $$0.ai() == bin.a) {
                        continue;
                     }

                     csj.a $$14 = $$4.b().get();
                     if (!$$14.a().a($$0.a(csb.b, $$13)) || !$$14.b().a($$0.a(csb.a, $$13))) {
                        continue;
                     }
                  } else if (!bls.a($$7.get(), $$0, blc.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        $$15.getClass(),
                        new ejd((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o)
                     )
                     .size();
                  if ($$16 >= this.m) {
                  ...
                  if ($$15 instanceof bla $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, blc.c) || !$$17.a($$0)) {
                        continue;
                     }

                     if ($$4.a().f() == 1 && $$4.a().b("id", 8)) {
                        ((bla)$$15).a($$0, $$0.d_($$15.dl()), blc.c, null, null);
                     }
                  }
   ...
   private void c(crs $$0, ht $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (csj)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable crs $$0, ht $$1, rz $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         csj $$4 = csj.b.parse(sn.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(csj::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = csj.c.parse(sn.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bha::b);
      } else {
         this.e = bha.a(this.f != null ? this.f : new csj());
      }
   ...
   public rz a(rz $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (sw)csj.b.encodeStart(sn.a, this.f).result().orElseThrow(() -> new IllegalStateException("Invalid SpawnData")));
      }

      $$0.a("SpawnPotentials", (sw)csj.c.encodeStart(sn.a, this.e).result().orElseThrow());
      return $$0;
   }

   @Nullable
   public bki a(crs $$0, ato $$1, ht $$2) {
      if (this.l == null) {
         rz $$3 = this.b($$0, $$1, $$2).a();
         if (!$$3.b("id", 8)) {
            return null;
         ...
         this.l = bkm.a($$3, $$0, Function.identity());
         if ($$3.f() == 1 && this.l instanceof bla) {
         }
      }
   ...
   protected void a(@Nullable crs $$0, ht $$1, csj $$2) {
      this.f = $$2;
   }

   private csj b(@Nullable crs $$0, ato $$1, ht $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bhc.b::b).orElseGet(csj::new));
         return this.f;
      }
   }

   public abstract void a(crs var1, ht var2, int var3);
