...
public abstract class cqu extends cro implements bve {
   private static final ajx<Boolean> h = akb.a(cqu.class, ajz.k);
   private static final ajx<Boolean> i = akb.a(cqu.class, ajz.k);
   private static final ajx<Integer> j = akb.a(cqu.class, ajz.b);
   ...
   public cqu(bur<? extends cqu> $$0, dgi $$1, Supplier<cwl> $$2) {
      super($$0, $$1);
      this.aO = $$2;
      this.I = true;
   }
   ...
   protected fba a(buk $$0, bun $$1, float $$2) {
      ...
      return new fba(0.0, this.b($$1), (double)$$3).b(-this.dM() * (float) (Math.PI / 180.0));
   }
   ...
   public void h() {
      ...
      List<buk> $$5 = this.dW().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bup.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dW().C && !(this.cX() instanceof cox);
   ...
   @Override
   public fba cT() {
      return new fba(0.0, (double)(0.88F * this.cS()), (double)(this.dr() * 0.64F));
   }

   @Override
   public void b(buk $$0, float $$1) {
      fba $$2 = $$0.du().d(this.du()).d().c((double)$$1 - 6.0);
      fba $$3 = this.dz();
      boolean $$4 = $$3.b($$2) > 0.0;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dwx $$16 = this.dW().a_($$11);
                     if (!($$16.b() instanceof dsu) && fbr.c($$16.g(this.dW(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, fbe.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               esz $$13 = this.dW().b_($$9);
               if ($$13.a(awv.a) && $$1 < (double)((float)$$9.v() + $$13.a(this.dW(), $$9))) {
                  if (!$$13.b()) {
                     return cqu.a.c;
                  }
   ...
   private void J() {
      if (this.ca()) {
         ...
         this.h(this.dz().b((double)(ayz.a(-this.dM() * (float) (Math.PI / 180.0)) * $$0), 0.0, (double)(ayz.b(this.dM() * (float) (Math.PI / 180.0)) * $$0)));
   ...
   protected void a(buk $$0, buk.a $$1) {
      ...
      if (!$$0.aq().a(awt.s)) {
         ...
         $$0.q($$0.cA() + this.p);
         this.c($$0);
         if ($$0 instanceof cgx && this.cZ().size() == this.t()) {
   ...
   @Override
   public fba b(bvg $$0) {
      fba $$1 = a((double)(this.dr() * ayz.g), (double)$$0.dr(), $$0.dM());
   ...
   public bsj a(cox $$0, bsi $$1) {
      ...
      if ($$2 != bsj.e) {
         ...
         return (bsj)($$0.fY() || !(this.o < 60.0F) || !this.dW().C && !$$0.n(this) ? bsj.e : bsj.a);
      }
   }
   ...
   protected void a(double $$0, boolean $$1, dwx $$2, ji $$3) {
      ...
      if (!this.bZ()) {
         if ($$1) {
            this.k();
         } else if (!this.dW().b_(this.dw().e()).a(awv.a) && $$0 < 0.0) {
            this.Z -= (float)$$0;
         }
      }
   }
   ...
   protected boolean r(buk $$0) {
      return this.cZ().size() < this.t() && !this.a(awv.a);
   }
   ...
   @Override
   public bvg cX() {
      return this.da() instanceof bvg $$0 ? $$0 : super.cX();
   }
