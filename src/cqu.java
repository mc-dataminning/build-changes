...
public class cqu {
   ...
   cqu(Map<dko.a, hi<dmv<?>>> $$0, List<hi<dum>> $$1) {
      this.d = $$0;
      this.e = $$1;
      this.f = Suppliers.memoize(
         () -> $$1.stream().flatMap(hi::a).map(he::a).flatMap(dum::a).filter($$0xx -> $$0xx.b() == dnw.g).collect(ImmutableList.toImmutableList())
      );
      this.g = Suppliers.memoize(() -> $$1.stream().flatMap(hi::a).map(he::a).collect(Collectors.toSet()));
   }

   public Iterable<he<dmv<?>>> a(dko.a $$0) {
   ...
   public static class a extends cqu.b {
      ...
      public a(hf<dum> $$0, hf<dmv<?>> $$1) {
         this.a = $$0;
         this.b = $$1;
      }

      public cqu.a a(dko.b $$0, aev<dum> $$1) {
         this.a($$0.ordinal(), this.a.b($$1));
         return this;
      }

      public cqu.a a(dko.a $$0, aev<dmv<?>> $$1) {
         this.a($$0, this.b.b($$1));
         return this;
      }
   }
   ...
   public static class b {
      ...
      public cqu.b a(dko.b $$0, he<dum> $$1) {
         return this.a($$0.ordinal(), $$1);
      }

      public cqu.b a(int $$0, he<dum> $$1) {
         this.a($$0);
         this.b.get($$0).add($$1);
         return this;
      }

      public cqu.b a(dko.a $$0, he<dmv<?>> $$1) {
