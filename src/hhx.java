...
public class hhx implements hia<String> {
   ...
   private static final MapCodec<hhx.a> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final hia.a<hhx, String> c = hia.a.a(f.flatXmap(hhx::a, $$0 -> DataResult.success($$0.g)), b);
   private final hhx.a g;
   private final DateFormat h;
   private long i;
   private String j = "";

   private hhx(hhx.a $$0, DateFormat $$1) {
      this.g = $$0;
      this.h = $$1;
   }

   public static hhx a(String $$0, String $$1, Optional<TimeZone> $$2) {
      return (hhx)a(new hhx.a($$0, $$1, $$2)).getOrThrow($$0x -> new IllegalStateException("Failed to validate format: " + $$0x));
   }

   private static DataResult<hhx> a(hhx.a $$0) {
      ...
      return DataResult.success(new hhx($$0, $$3));
   }
