...
public class czc extends csv {
   ...
   private static final ImmutableList<hy> d = ImmutableList.of(
      new hy(0, 0, -1), new hy(-1, 0, 0), new hy(0, 0, 1), new hy(1, 0, 0), new hy(-1, 0, -1), new hy(1, 0, -1), new hy(-1, 0, 1), new hy(1, 0, 1)
   );
   private static final ImmutableList<hy> e = new Builder()
      .addAll(d)
      .addAll(d.stream().map(hy::o).iterator())
      .addAll(d.stream().map(hy::p).iterator())
      .add(new hy(0, 1, 0))
      .build();
      ...
      if ($$4 == bgx.a && !a($$6) && a($$3.b(bgx.b))) {
         ...
         if (!$$1.B) {
            ...
            if ($$7.R() != $$1.ac() || !$$2.equals($$7.P())) {
               ...
               $$1.a(null, (double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, apd.tM, ape.e, 1.0F, 1.0F);
               return bgy.a;
            }
         }
   ...
   private void d(dfj $$0, cpv $$1, final gw $$2) {
      ...
      final boolean $$4 = $$3 || $$1.b_($$2.c()).a(apx.a);
      cpo $$5 = new cpo() {
         @Override
   ...
   public static void a(@Nullable biq $$0, cpv $$1, gw $$2, dfj $$3) {
      ...
      $$1.a(null, (double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, apd.tK, ape.e, 1.0F, 1.0F);
   }
   ...
   public void a(dfj $$0, cpv $$1, gw $$2, asc $$3) {
      if ($$0.c(c) != 0) {
         if ($$3.a(100) == 0) {
            $$1.a(null, (double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, apd.tJ, ape.e, 1.0F, 1.0F);
         }
   ...
   public static int a(dfj $$0, int $$1) {
      return arw.d((float)($$0.c(c) - 0) / 4.0F * (float)$$1);
   }
