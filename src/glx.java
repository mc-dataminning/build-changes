...
public class glx implements AutoCloseable {
   ...
   public glx(glq $$0, flk $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new feg(16, 16, false);
      this.e.a(9729);
   ...
   private float b(float $$0) {
      btr $$1 = this.i.t.c(btt.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bvi $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(btt.p)) {
               $$10 = glq.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(btt.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            glj $$18 = Objects.requireNonNull(RenderSystem.setShader(glk.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            ffq $$19 = RenderSystem.renderThreadTesselator().a(fga.c.h, fft.a);
            $$19.a(0.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 1.0F, 0.0F);
            $$19.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(eat $$0, int $$1) {
      return a($$0.s(), $$1);
   }
