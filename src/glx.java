...
public class glx extends edf {
   ...
   public glx(gmb $$0, int $$1) {
      this.e = $$0;
      this.b = new edh($$0, new djc(0, 0), $$0.J_().f(mh.aG).b(dlh.b));
      this.c = new exd(this, true, $$0.F_().g());
      this.d = new glx.a(b($$1));
   }
   ...
   private static boolean a(@Nullable edl $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         djc $$3 = $$0.f();
   ...
   @Nullable
   public edl b(int $$0, int $$1, eec $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         edl $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public edl a(int $$0, int $$1, vw $$2, Map<ehd.a, long[]> $$3, Consumer<adh.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         edl $$6 = this.d.b.get($$5);
         djc $$7 = new djc($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new edl(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<edl> b;
      ...
      void a(int $$0, @Nullable edl $$1) {
         edl $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            glx.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  edl $$5 = glx.this.d.b.get(glx.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     djc $$6 = $$5.f();
            ...
            glx.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
