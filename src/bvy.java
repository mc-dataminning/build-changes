...
public class bvy extends bur implements bje, bke<bvy.d>, but {
   ...
   private static final aee<Integer> ca = aeh.a(bvy.class, aeg.b);
   private static final aee<Boolean> cb = aeh.a(bvy.class, aeg.k);
   private static final aee<Boolean> cc = aeh.a(bvy.class, aeg.k);
   ...
   public static enum d implements asp {
      ...
      private static final IntFunction<bvy.d> g = aqr.a(bvy.d::a, values(), aqr.a.a);
