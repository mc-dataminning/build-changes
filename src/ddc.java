...
public abstract class ddc implements ddb {
   public static final Codec<ddc> a = lp.ab.q().dispatchStable(ddc::a, Function.identity());
   private final Supplier<Set<ji<dcy>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));

   protected ddc() {
   }

   protected abstract MapCodec<? extends ddc> a();

   protected abstract Stream<ji<dcy>> b();
   ...
   @Nullable
   public Pair<iz, ji<dcy>> a(int $$0, int $$1, int $$2, int $$3, Predicate<ji<dcy>> $$4, azh $$5, ddh.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<iz, ji<dcy>> a(iz $$0, int $$1, int $$2, int $$3, Predicate<ji<dcy>> $$4, ddh.f $$5, dcc $$6) {
      Set<ji<dcy>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         ...
         for (iz.a $$10 : iz.a(iz.c, $$8, je.f, je.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = jt.a($$15);
               ji<dcy> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.as ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               ji<dcy> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract ji<dcy> getNoiseBiome(int var1, int var2, int var3, ddh.f var4);
