...
public abstract class fyk<T extends blu> {
   ...
   public final int b(T $$0, float $$1) {
      hx $$2 = hx.a($$0.k($$1));
      return fte.a(this.a($$0, $$2), this.b($$0, $$2));
   }
   ...
   protected void a(T $$0, vf $$1, epz $$2, ftf $$3, int $$4) {
      ...
      if (!($$5 > 4096.0)) {
         ...
         Matrix4f $$9 = $$2.c().a();
         float $$10 = evg.O().m.a(0.25F);
         int $$11 = (int)($$10 * 255.0F) << 24;
         ewq $$12 = this.b();
         float $$13 = (float)(-$$12.a($$1) / 2);
         $$12.a($$1, $$13, (float)$$8, 553648127, false, $$9, $$3, $$6 ? ewq.a.b : ewq.a.a, $$11, $$4);
         if ($$6) {
            $$12.a($$1, $$13, (float)$$8, -1, false, $$9, $$3, ewq.a.a, 0, $$4);
         }
