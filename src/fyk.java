...
public class fyk {
   ...
   private final PriorityBlockingQueue<fyk.b.a> b = Queues.newPriorityBlockingQueue();
   private final Queue<fyk.b.a> c = Queues.newLinkedBlockingDeque();
   private int d = 2;
   ...
   public fyk(fpx $$0, fvj $$1, Executor $$2, fvr $$3) {
      this.l = $$0;
      this.m = $$1;
      this.f = $$3.a();
      this.g = $$3.b();
   ...
   private void j() {
      if (!this.i && !this.g.b()) {
         fyk.b.a $$0 = this.k();
         if ($$0 != null) {
            fvw $$1 = Objects.requireNonNull(this.g.a());
   ...
   public static class a {
      public static final fyk.a a = new fyk.a() {
         @Override
         public boolean a(ie $$0, ie $$1) {
            return false;
         }
      };
      final Set<fvt> b = new ObjectArraySet(fvt.F().size());
   ...
   public class b {
      ...
      public final int b;
      public final AtomicReference<fyk.a> c = new AtomicReference<>(fyk.a.a);
      ...
      private final Map<fvt, esd> i = fvt.F().stream().collect(Collectors.toMap($$0x -> $$0x, $$0x -> new esd(esd.a.a)));
      private enn j;
      ...
      private boolean a(hz $$0) {
         return fyk.this.l.a(jb.a($$0.u()), jb.a($$0.w()), dng.n, false) != null;
      }
      ...
      public fyk.b.a a(fyj $$0) {
         boolean $$1 = this.j();
         hz $$2 = this.l.i();
         int $$3 = 1;
         fyi $$4 = $$0.a(fyk.this.l, $$2.b(-1, -1, -1), $$2.b(16, 16, 16), 1);
         boolean $$5 = this.c.get() == fyk.a.a;
         if ($$5 && $$1) {
            this.e.incrementAndGet();
         }

         this.f = new fyk.b.b(this.c(), $$4, !$$5 || this.e.get() > 2);
         return this.f;
      }

      public void a(fyk $$0, fyj $$1) {
         fyk.b.a $$2 = this.a($$1);
         $$0.a($$2);
      }
      ...
      abstract class a implements Comparable<fyk.b.a> {
         ...
         public abstract CompletableFuture<fyk.c> a(fvw var1);

         public abstract void a();

         protected abstract String b();

         public int a(fyk.b.a $$0) {
            return Doubles.compare(this.a, $$0.a);
         }
      }

      class b extends fyk.b.a {
         @Nullable
         protected fyi e;

         public b(double $$0, @Nullable fyi $$1, boolean $$2) {
            super($$0, $$2);
            this.e = $$1;
         }
         ...
         @Override
         public CompletableFuture<fyk.c> a(fvw $$0) {
            if (this.b.get()) {
               return CompletableFuture.completedFuture(fyk.c.b);
            } else if (!b.this.a()) {
               this.e = null;
               b.this.a(false);
               this.b.set(true);
               ...
               if (this.b.get()) {
                  ...
                  $$5.c.forEach(($$2x, $$3x) -> {
                     $$7.add(fyk.this.a($$3x, b.this.a($$2x)));
                     $$6.b.add($$2x);
                  });
         ...
         private fyk.b.b.a a(float $$0, float $$1, float $$2, fvw $$3) {
            fyk.b.b.a $$4 = new fyk.b.b.a();
            int $$5 = 1;
            hz $$6 = b.this.l.i();
            hz $$7 = $$6.b(15, 15, 15);
            fyl $$8 = new fyl();
            ...
            if ($$9 != null) {
               fwh.a();
               Set<fvt> $$11 = new ReferenceArraySet(fvt.F().size());
               awo $$12 = awo.a();
               fwf $$13 = exh.O().an();
         ...
         private <E extends dit> void a(fyk.b.b.a $$0, E $$1) {
            fxl<E> $$2 = exh.O().ap().a($$1);
            if ($$2 != null) {
               $$0.b.add($$1);
               if ($$2.a($$1)) {
                  $$0.a.add($$1);
         ...
         static final class a {
            ...
            public final Map<fvt, erv.b> c = new Reference2ObjectArrayMap();
            public fym d = new fym();
            @Nullable
            public erv.c e;
         }
      }

      class c extends fyk.b.a {
         private final fyk.a f;

         public c(double $$0, fyk.a $$1) {
            super($$0, true);
            this.f = $$1;
         }
            ...
            if (this.b.get()) {
               ...
               if ($$5 != null && !this.f.a(fvt.f())) {
                  ...
                  if (this.b.get()) {
                     ...
                     CompletableFuture<fyk.c> $$8 = fyk.this.a($$7, b.this.a(fvt.f())).thenApply($$0x -> fyk.c.b);
                     return $$8.handle(($$0x, $$1x) -> {
                        ...
                        return this.b.get() ? fyk.c.b : fyk.c.a;
                     });
                  }
               } else {
                  return CompletableFuture.completedFuture(fyk.c.b);
