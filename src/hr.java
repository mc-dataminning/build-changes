...
public class hr<T extends em<T>> {
   @VisibleForTesting
   public static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> xc.b("command.forkLimit", $$0));
   private final String b;
   private final ContextChain<T> c;

   public hr(String $$0, ContextChain<T> $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   protected void a(T $$0, List<T> $$1, hl<T> $$2, hn $$3, hg $$4) {
      ...
      if ($$5.getStage() != Stage.EXECUTE) {
         ...
         try {
            for (int $$8 = $$2.d(); $$5.getStage() != Stage.EXECUTE; $$5 = $$5.nextStage()) {
               ...
               if ($$10 instanceof hj<T> $$11) {
                  $$11.a($$0, $$7, $$5, $$6, hm.a($$2, $$3));
                  return;
               }
      ...
      if ($$7.isEmpty()) {
         ...
         if ($$17.getCommand() instanceof hi<T> $$19) {
            hm<T> $$20 = hm.a($$2, $$3);
            ...
            hu<T> $$23 = new hu<>(this.b, $$6, $$17);
            ht.a($$2, $$3, $$7, ($$1x, $$2x) -> new hh<>($$1x, $$23.bind((T)$$2x)));
         }
      }
   }

   protected void a(hl<T> $$0, hn $$1) {
      ho $$2 = $$0.b();
      if ($$2 != null) {
         $$2.a($$1.c(), this.b);
      }
   ...
   public static class a<T extends em<T>> extends hr<T> implements hk<T> {
      ...
      public a(String $$0, ContextChain<T> $$1, hg $$2, T $$3, List<T> $$4) {
         super($$0, $$1);
         this.c = $$3;
         this.d = $$4;
         this.b = $$2;
   ...
   public static class b<T extends em<T>> extends hr<T> implements hk<T> {
      ...
      public void execute(hl<T> $$0, hn $$1) {
         this.a($$0, $$1);
         this.a(this.b, List.of(this.b), $$0, $$1, hg.a);
      }
   }
