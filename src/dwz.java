...
public class dwz {
   ...
   static Codec<dwz> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               cxk.a("display_item").forGetter($$0x -> $$0x.d),
               kk.c.lenientOptionalFieldOf("connected_players", Set.of()).forGetter($$0x -> $$0x.e),
               Codec.DOUBLE.lenientOptionalFieldOf("connected_particles_range", dwx.b.d()).forGetter($$0x -> $$0x.f)
            )
            .apply($$0, dwz::new)
   );
   private cxk d = cxk.k;
   private Set<UUID> e = new ObjectLinkedOpenHashSet();
   private double f = dwx.b.d();
   boolean c;

   dwz(cxk $$0, Set<UUID> $$1, double $$2) {
      this.d = $$0;
      this.e.addAll($$1);
      this.f = $$2;
   }
   ...
   void a(ash $$0, jh $$1, dwy $$2, dwx $$3, double $$4) {
