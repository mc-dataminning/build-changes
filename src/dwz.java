...
public class dwz {
   ...
   static class a implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         return $$0.c[hb.f.d()] && !$$0.b[hb.f.d()].d;
      }

      @Override
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         $$1.d = true;
         $$1.b[hb.f.d()].d = true;
         return new dwz.k($$0, $$1);
      }
   }

   static class b implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         if ($$0.c[hb.f.d()] && !$$0.b[hb.f.d()].d && $$0.c[hb.b.d()] && !$$0.b[hb.b.d()].d) {
            dwz.v $$1 = $$0.b[hb.f.d()];
            return $$1.c[hb.b.d()] && !$$1.b[hb.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         ...
         $$1.b[hb.f.d()].d = true;
         $$1.b[hb.b.d()].d = true;
         $$1.b[hb.f.d()].b[hb.b.d()].d = true;
         return new dwz.l($$0, $$1);
      }
   }

   static class c implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         return $$0.c[hb.b.d()] && !$$0.b[hb.b.d()].d;
      }
      ...
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         $$1.d = true;
         $$1.b[hb.b.d()].d = true;
         return new dwz.m($$0, $$1);
      }
   }

   static class d implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         if ($$0.c[hb.c.d()] && !$$0.b[hb.c.d()].d && $$0.c[hb.b.d()] && !$$0.b[hb.b.d()].d) {
            dwz.v $$1 = $$0.b[hb.c.d()];
            return $$1.c[hb.b.d()] && !$$1.b[hb.b.d()].d;
         } else {
            return false;
      ...
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         ...
         $$1.b[hb.c.d()].d = true;
         $$1.b[hb.b.d()].d = true;
         $$1.b[hb.c.d()].b[hb.b.d()].d = true;
         return new dwz.n($$0, $$1);
      }
   }

   static class e implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         return $$0.c[hb.c.d()] && !$$0.b[hb.c.d()].d;
      }

      @Override
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         dwz.v $$3 = $$1;
         if (!$$1.c[hb.c.d()] || $$1.b[hb.c.d()].d) {
            $$3 = $$1.b[hb.d.d()];
         }

         $$3.d = true;
         $$3.b[hb.c.d()].d = true;
         return new dwz.o($$0, $$3);
      }
   }

   static class f implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         return true;
      }
      ...
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         $$1.d = true;
         return new dwz.s($$0, $$1, $$2);
      }
   }

   static class g implements dwz.i {
      @Override
      public boolean a(dwz.v $$0) {
         return !$$0.c[hb.e.d()] && !$$0.c[hb.f.d()] && !$$0.c[hb.c.d()] && !$$0.c[hb.d.d()] && !$$0.c[hb.b.d()];
      }

      @Override
      public dwz.r a(hb $$0, dwz.v $$1, art $$2) {
         $$1.d = true;
         return new dwz.t($$0, $$1);
      }
   }

   public static class h extends dwz.r {
      ...
      private dwz.v G;
      private dwz.v H;
      private final List<dwz.r> I = Lists.newArrayList();

      public h(art $$0, int $$1, int $$2, hb $$3) {
         super(dvo.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dwz.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dwz.p($$3, this.G));
         this.I.add(new dwz.j($$3, this.H));
         List<dwz.i> $$5 = Lists.newArrayList();
         $$5.add(new dwz.b());
         $$5.add(new dwz.d());
         $$5.add(new dwz.e());
         $$5.add(new dwz.a());
         ...
         dup $$10 = dup.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dup $$11 = dup.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dup $$12 = dup.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dwz.u($$3, $$10, $$13++));
         this.I.add(new dwz.u($$3, $$11, $$13++));
         this.I.add(new dwz.q($$3, $$12));
      }
      ...
      private List<dwz.v> b(art $$0) {
         dwz.v[] $$1 = new dwz.v[75];
         ...
         dwz.v $$23 = new dwz.v(1003);
         dwz.v $$24 = new dwz.v(1001);
         dwz.v $$25 = new dwz.v(1002);
         $$1[v].a(hb.b, $$23);
         $$1[w].a(hb.d, $$24);
         $$1[x].a(hb.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[hb.f.d()].d = true;
         this.H.b[hb.c.d()].d = true;
         this.H.b[hb.f.d()].b[hb.c.d()].d = true;
         this.H.b[hb.b.d()].d = true;
         this.H.b[hb.f.d()].b[hb.b.d()].d = true;
         this.H.b[hb.c.d()].b[hb.b.d()].d = true;
         this.H.b[hb.f.d()].b[hb.c.d()].b[hb.b.d()].d = true;
         ObjectArrayList<dwz.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqe $$2, art $$3, dup $$4) {
         int $$5 = 24;
      ...
      private void a(cqe $$0, art $$1, dup $$2) {
      ...
      private void b(cqe $$0, art $$1, dup $$2) {
      ...
      private void c(cqe $$0, art $$1, dup $$2) {
      ...
      private void d(cqe $$0, art $$1, dup $$2) {
      ...
      private void e(cqe $$0, art $$1, dup $$2) {
      ...
      private void f(cqe $$0, art $$1, dup $$2) {
   ...
   interface i {
      boolean a(dwz.v var1);

      dwz.r a(hb var1, dwz.v var2, art var3);
   }

   public static class j extends dwz.r {
      public j(hb $$0, dwz.v $$1) {
         super(dvo.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqe $$0, cqc $$1, dgv $$2, art $$3, dup $$4, cor $$5, gv $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csl.ch.n(), csl.ch.n(), false);
   ...
   public static class k extends dwz.r {
      public k(hb $$0, dwz.v $$1) {
         super(dvo.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(cqe $$0, cqc $$1, dgv $$2, art $$3, dup $$4, cor $$5, gv $$6) {
         dwz.v $$7 = this.B.b[hb.f.d()];
         dwz.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[hb.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[hb.a.d()]);
         }
   ...
   public static class l extends dwz.r {
      public l(hb $$0, dwz.v $$1) {
         super(dvo.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dwz.r {
      public m(hb $$0, dwz.v $$1) {
         super(dvo.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(cqe $$0, cqc $$1, dgv $$2, art $$3, dup $$4, cor $$5, gv $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[hb.a.d()]);
         }

         dwz.v $$7 = this.B.b[hb.b.d()];
         if ($$7.b[hb.b.d()] == null) {
   ...
   public static class n extends dwz.r {
      public n(hb $$0, dwz.v $$1) {
         super(dvo.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(cqe $$0, cqc $$1, dgv $$2, art $$3, dup $$4, cor $$5, gv $$6) {
         dwz.v $$7 = this.B.b[hb.c.d()];
         dwz.v $$8 = this.B;
         dwz.v $$9 = $$7.b[hb.b.d()];
         dwz.v $$10 = $$8.b[hb.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[hb.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[hb.a.d()]);
         }
   ...
   public static class o extends dwz.r {
      public o(hb $$0, dwz.v $$1) {
         super(dvo.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dwz.r {
      public p(hb $$0, dwz.v $$1) {
         super(dvo.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dwz.r {
      public q(hb $$0, dup $$1) {
         super(dvo.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvb {
      protected static final dey b = csl.hZ.n();
      protected static final dey c = csl.ia.n();
      protected static final dey d = csl.ib.n();
      protected static final dey h = c;
      protected static final dey i = csl.ii.n();
      protected static final boolean j = true;
      protected static final dey k = csl.G.n();
      protected static final Set<csk> l = ImmutableSet.builder().add(csl.dO).add(csl.iC).add(csl.mW).add(k.b()).build();
      ...
      public r(dvo $$0, hb $$1, int $$2, dup $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvo $$0, int $$1, hb $$2, dwz.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dup a(hb $$0, dwz.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dup $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqe $$0, dup $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dey $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cqe $$0, dup $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqe $$0, dup $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dey $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dup $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqe $$0, dup $$1, int $$2, int $$3, int $$4) {
         gv $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            byo $$6 = bik.A.a((cpk)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eK());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dk()), bja.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dwz.r {
      private int a;

      public s(hb $$0, dwz.v $$1, art $$2) {
         super(dvo.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(cqe $$0, cqc $$1, dgv $$2, art $$3, dup $$4, cor $$5, gv $$6) {
         ...
         if (this.B.b[hb.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[hb.a.d()] && !this.B.c[hb.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends dwz.r {
      public t(hb $$0, dwz.v $$1) {
         super(dvo.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dwz.r {
      private int a;

      public u(hb $$0, dup $$1, int $$2) {
         super(dvo.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
