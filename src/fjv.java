...
public abstract class fjv<T extends fjv<T>> {
   ...
   public fjv(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fjt.a();
         if ($$3 != null) {
         ...
         throw new fln(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fln(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fln(var2.getMessage(), var2);
      }
   }
   ...
   public static fjv<?> a(String $$0) {
      return new fjv.b($$0, 5000, 60000);
   }

   public static fjv<?> a(String $$0, int $$1, int $$2) {
      return new fjv.b($$0, $$1, $$2);
   }

   public static fjv<?> b(String $$0, String $$1) {
      return new fjv.c($$0, $$1, 5000, 60000);
   }

   public static fjv<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fjv.c($$0, $$1, $$2, $$3);
   }

   public static fjv<?> b(String $$0) {
      return new fjv.a($$0, 5000, 60000);
   }

   public static fjv<?> c(String $$0, String $$1) {
      return new fjv.d($$0, $$1, 5000, 60000);
   }

   public static fjv<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fjv.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fjv<fjv.a> {
   ...
   public static class b extends fjv<fjv.b> {
   ...
   public static class c extends fjv<fjv.c> {
      ...
      public fjv.c f() {
         try {
            ...
            throw new fln(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fjv<fjv.d> {
      private final String c;
