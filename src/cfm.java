...
public class cfm {
   ...
   public boolean a(cqc<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cqc<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cfm.a($$0).a($$2, $$1);
   }

   public int a(cqe<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cqe<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cfm.a($$0.b()).b($$1, $$2);
   }

   public static cmy a(int $$0) {
      return $$0 == 0 ? cmy.f : new cmy(cmt.b($$0));
   }
   ...
   class a {
      private final cqc<?> b;
      private final List<cpz> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cfm.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
