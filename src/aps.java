...
public class aps {
   ...
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(xp.a("commands.worldborder.set.failed.big", 5.999997E7F));
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(xp.a("commands.worldborder.set.failed.far", 2.9999984E7));
   ...
   private static int a(ep $$0, float $$1) throws CommandSyntaxException {
      ...
      if ($$2.n() == (double)$$1) {
         ...
         $$2.b((double)$$1);
         $$0.a(() -> xp.a("commands.worldborder.damage.buffer.success", String.format(Locale.ROOT, "%.2f", $$1)), true);
         return (int)$$1;
      }
   }
   ...
   private static int b(ep $$0, float $$1) throws CommandSyntaxException {
      ...
      if ($$2.o() == (double)$$1) {
         ...
         $$2.c((double)$$1);
         $$0.a(() -> xp.a("commands.worldborder.damage.amount.success", String.format(Locale.ROOT, "%.2f", $$1)), true);
         return (int)$$1;
      }
   }
   ...
   private static int a(ep $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2.q() == $$1) {
         ...
         $$2.b($$1);
         $$0.a(() -> xp.a("commands.worldborder.warning.time.success", $$1), true);
         return $$1;
      }
   }
   ...
   private static int b(ep $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2.r() == $$1) {
         ...
         $$2.c($$1);
         $$0.a(() -> xp.a("commands.worldborder.warning.distance.success", $$1), true);
         return $$1;
      }
   }
   ...
   private static int a(ep $$0) {
      double $$1 = $$0.l().I().C_().i();
      $$0.a(() -> xp.a("commands.worldborder.get", String.format(Locale.ROOT, "%.0f", $$1)), false);
      return ayz.a($$1 + 0.5);
   }

   private static int a(ep $$0, evs $$1) throws CommandSyntaxException {
      dtv $$2 = $$0.l().I().C_();
      if ($$2.a() == (double)$$1.i && $$2.b() == (double)$$1.j) {
         ...
         $$0.a(() -> xp.a("commands.worldborder.center.success", String.format(Locale.ROOT, "%.2f", $$1.i), String.format(Locale.ROOT, "%.2f", $$1.j)), true);
         return 0;
      } else {
         throw e.create();
      }
   ...
   private static int a(ep $$0, double $$1, long $$2) throws CommandSyntaxException {
      ...
      if ($$4 == $$1) {
         ...
         if ($$2 > 0L) {
            $$3.a($$4, $$1, $$2);
            if ($$1 > $$4) {
               $$0.a(() -> xp.a("commands.worldborder.set.grow", String.format(Locale.ROOT, "%.1f", $$1), Long.toString($$2 / 1000L)), true);
            } else {
               $$0.a(() -> xp.a("commands.worldborder.set.shrink", String.format(Locale.ROOT, "%.1f", $$1), Long.toString($$2 / 1000L)), true);
            }
         } else {
            $$3.a($$1);
            $$0.a(() -> xp.a("commands.worldborder.set.immediate", String.format(Locale.ROOT, "%.1f", $$1)), true);
         }
