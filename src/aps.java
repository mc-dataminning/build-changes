      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)azl.a),
               String.format(Locale.ROOT, "%.2f", this.d.aQ().g() / (float)azl.c)
            );
            ...
            $$10.a("Random tick rate", () -> this.d.bb().o().a(dbw.o).toString());
            $$10.a("Level stats", () -> Streams.stream(this.d.K()).map($$0x -> $$0x.af() + ": " + $$0x.F()).collect(Collectors.joining(",\n")));
            akv.a("Crash report:\n" + $$8.e());
            File $$11 = new File(new File(this.d.C(), "crash-reports"), "crash-" + ad.e() + "-server.txt");
            if ($$8.a($$11)) {
