...
public abstract class aps implements yo {
   ...
   public aps(MinecraftServer $$0, uo $$1, apl $$2) {
      this.c = $$0;
      this.d = $$1;
      this.h = ac.b();
      this.k = $$2.b();
   ...
   protected apl a(aol $$0) {
      return new apl(this.j(), this.k, $$0, this.g);
   }
}
