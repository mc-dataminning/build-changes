...
public class dgh {
   ...
   private final Map<Character, Predicate<dgf>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dgh a(char $$0, Predicate<dgf> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dgg b() {
      return new dgg(this.c());
   }

   private Predicate<dgf>[][][] c() {
      this.d();
      Predicate<dgf>[][][] $$0 = (Predicate<dgf>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dgf>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
