...
public abstract class dgh implements dgi, AutoCloseable {
   public static final Codec<aku<dgh>> h = aku.a(mc.be);
   public static final aku<dgh> i = aku.a(mc.be, akv.b("overworld"));
   public static final aku<dgh> j = aku.a(mc.be, akv.b("the_nether"));
   public static final aku<dgh> k = aku.a(mc.be, akv.b("the_end"));
   ...
   protected final List<dvt> s = Lists.newArrayList();
   protected final euf t;
   ...
   private final jr<ear> E;
   protected final evl B;
   public final boolean C;
   private final dym F;
   private final dhl G;
   private final aku<dgh> H;
   private final kf I;
   private final btb J;
   private long K;

   protected dgh(evl $$0, aku<dgh> $$1, kf $$2, jr<ear> $$3, boolean $$4, boolean $$5, long $$6, int $$7) {
      this.B = $$0;
      this.E = $$3;
      final ear $$8 = $$3.a();
      this.H = $$1;
      ...
      this.G = new dhl(this, $$6);
      this.d = $$5;
      this.t = new eua(this, $$7);
      this.I = $$2;
      this.J = new btb($$2);
   }
   ...
   public dzb d(int $$0, int $$1) {
      return (dzb)this.a($$0, $$1, dzs.n);
   }

   @Nullable
   @Override
   public dyr a(int $$0, int $$1, dzs $$2, boolean $$3) {
      dyr $$4 = this.S().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(ji $$0, dww $$1, int $$2) {
   ...
   public boolean a(ji $$0, boolean $$1, @Nullable buk $$2, int $$3) {
      ...
      if ($$4.l()) {
         ...
         esy $$5 = this.b_($$0);
         if (!($$4.b() instanceof diy)) {
            this.c(2001, $$0, djl.j($$4));
         }

         if ($$1) {
            dty $$6 = $$4.x() ? this.c_($$0) : null;
            djl.a($$4, this, $$0, $$6, $$2, cwo.j);
         }

         boolean $$7 = this.a($$0, $$5.g(), 3, $$3);
         if ($$7) {
            this.a(ebs.f, $$0, ebs.a.a($$2, $$4));
         }
   ...
   public boolean b(ji $$0, dww $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(ji var1, dww var2, dww var3, int var4);

   public void b(ji $$0, dww $$1, dww $$2) {
   }
   ...
   @Override
   public void a(jn $$0, ji $$1, ji $$2, dww $$3, int $$4, int $$5) {
   ...
   public dww a_(ji $$0) {
      if (this.s($$0)) {
         ...
         dzb $$1 = this.d(kk.a($$0.u()), kk.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable buk $$0, ji $$1, avz $$2, awb $$3, float $$4, float $$5) {
      this.a($$0 instanceof cow $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }
   ...
   public abstract void a(@Nullable cow var1, double var2, double var4, double var6, jr<avz> var8, awb var9, float var10, float var11, long var12);

   public void a(@Nullable cow $$0, double $$1, double $$2, double $$3, avz $$4, awb $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, mb.b.e($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cow var1, buk var2, jr<avz> var3, awb var4, float var5, float var6, long var7);

   public void a(@Nullable cow $$0, double $$1, double $$2, double $$3, avz $$4, awb $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 1.0F, 1.0F);
   }

   public void a(@Nullable cow $$0, double $$1, double $$2, double $$3, avz $$4, awb $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cow $$0, double $$1, double $$2, double $$3, jr<avz> $$4, awb $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cow $$0, buk $$1, avz $$2, awb $$3, float $$4, float $$5) {
   ...
   protected void X() {
      ...
      Iterator<dvt> $$1 = this.s.iterator();
      boolean $$2 = this.u().i();
   ...
   public boolean n(ji $$0) {
      return this.a(dfn.a($$0));
   }

   public void a(@Nullable buk $$0, double $$1, double $$2, double $$3, float $$4, dgh.a $$5) {
      this.a($$0, dfz.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable buk $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, dgh.a $$6) {
      this.a($$0, dfz.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable buk $$0, @Nullable bta $$1, @Nullable dga $$2, faz $$3, float $$4, boolean $$5, dgh.a $$6) {
      this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, lt.w, lt.v, awa.kE);
   }

   public void a(@Nullable buk $$0, @Nullable bta $$1, @Nullable dga $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, dgh.a $$8) {
   ...
   public dty c_(ji $$0) {
      if (this.s($$0)) {
         ...
         return !this.C && Thread.currentThread() != this.c ? null : this.m($$0).a($$0, dzb.b.a);
      }
   }
   ...
   public boolean a(ji $$0, buk $$1, jn $$2) {
      if (this.s($$0)) {
         ...
         dyr $$3 = this.a(kk.a($$0.u()), kk.a($$0.w()), dzs.n, false);
   ...
   public ji Z() {
      ji $$0 = this.B.a();
      if (!this.F_().a($$0)) {
         $$0 = this.a(ecr.a.e, ji.a(this.F_().a(), 0.0, this.F_().b()));
      }
   ...
   public dfm c(int $$0, int $$1) {
      return this.a($$0, $$1, dzs.n, false);
   }

   @Override
   public List<buk> a(@Nullable buk $$0, fau $$1, Predicate<? super buk> $$2) {
      bor.a().f("getEntities");
   ...
   public <T extends buk> void a(ebg<buk, T> $$0, fau $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends buk> void a(ebg<buk, T> $$0, fau $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      bor.a().f("getEntities");
      this.H().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   public boolean r(ji $$0) {
      if (!this.ag()) {
         ...
         return false;
      } else if (this.a(ecr.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         dhj $$1 = this.t($$0).a();
         return $$1.a($$0, this.P()) == dhj.c.b;
      }
   }

   @Nullable
   public abstract eus a(euq var1);

   public abstract void a(euq var1, eus var2);

   public abstract euq x();
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czd> $$6) {
   }

   public abstract fce R();

   public void c(ji $$0, djl $$1) {
      for (jn $$2 : jn.c.a) {
         ji $$3 = $$0.a($$2);
         if (this.B($$3)) {
            dww $$4 = this.a_($$3);
   ...
   public abstract cym L();

   public abstract duw M();
   ...
   public static enum a implements azv {
      ...
      public static final Codec<dgh.a> f = azv.a(dgh.a::values);
