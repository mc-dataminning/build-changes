...
public class bek extends bat {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bek::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bek::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bek::k);
         $$0 = this.a($$0, "minecraft:fox", bek::j);
         $$0 = this.a($$0, "minecraft:item", bek::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bek::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bek::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bek::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bek::e);
         return this.a($$0, "minecraft:piglin", bek::d);
      });
   }
