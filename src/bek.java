...
public class bek extends bdz {
   private final Supplier<Type<?>> b = Suppliers.memoize(() -> this.getOutputSchema().getChoiceType(bho.B, "ZombieVillager"));
   ...
   private Typed<?> a(Typed<?> $$0, int $$1) {
      return ad.a($$0, this.b.get(), $$1x -> $$1x.set("Profession", $$1x.createInt($$1)));
   }
}
