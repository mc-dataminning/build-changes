...
public class bek extends bhi {
   public bek(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bin.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bin.D.typeName(), bkb.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bin.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bin.D.typeName(), "minecraft:saddle"));
