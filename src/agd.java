...
public final class agd<E> implements Codec<ib<E>> {
   private final agf<? extends io<E>> a;

   public static <E> agd<E> a(agf<? extends io<E>> $$0) {
      return new agd<>($$0);
   }

   private agd(agf<? extends io<E>> $$0) {
      this.a = $$0;
   }
