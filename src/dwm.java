...
public class dwm extends dux {
   ...
   protected void b(ux $$0, js.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vu)dao.a.encodeStart(vl.a, this.i).getOrThrow());
      }
   ...
   protected void a(ux $$0, js.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         dao.a.parse(vl.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }
   ...
   public static void a(dhi $$0, jh $$1, dxv $$2, dwm $$3) {
      if ($$2.b(drr.a) && $$2.c(drr.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
