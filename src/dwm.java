...
public final class dwm {
   ...
   private final Optional<akt<efk<?, ?>>> o;
   private final Optional<akt<efk<?, ?>>> p;
   private final Optional<akt<efk<?, ?>>> q;
   private final Optional<akt<efk<?, ?>>> r;
   private final Optional<akt<efk<?, ?>>> s;
   private final Optional<akt<efk<?, ?>>> t;

   public dwm(String $$0, Optional<akt<efk<?, ?>>> $$1, Optional<akt<efk<?, ?>>> $$2, Optional<akt<efk<?, ?>>> $$3) {
   ...
   @Nullable
   private akt<efk<?, ?>> a(azh $$0, boolean $$1) {
      if ($$0.i() < this.n) {
   ...
   @Nullable
   private akt<efk<?, ?>> a(azh $$0) {
      return this.p.isPresent() && $$0.i() < this.n ? this.p.get() : this.o.orElse(null);
   }

   public boolean a(arc $$0, dyt $$1, ji $$2, dwx $$3, azh $$4) {
      akt<efk<?, ?>> $$5 = this.a($$4);
      if ($$5 != null) {
      ...
      akt<efk<?, ?>> $$11 = this.a($$4, this.a($$0, $$2));
      if ($$11 == null) {
         return false;
      } else {
