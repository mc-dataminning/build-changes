...
public class dwm extends dwk {
   public static final Codec<dwm> a = RecordCodecBuilder.create(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  biq.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  biq.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
                  it.a(kc.f).fieldOf("can_grow_through").forGetter($$0x -> $$0x.j)
               )
            )
            .apply($$0, dwm::new)
   );
   ...
   private final biq i;
   private final ij<cvz> j;

   public dwm(int $$0, int $$1, int $$2, biq $$3, float $$4, biq $$5, ij<cvz> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<dus.a> a(cte $$0, BiConsumer<hv, dip> $$1, auf $$2, int $$3, hv $$4, duc $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new dus.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(cte $$0, BiConsumer<hv, dip> $$1, auf $$2, int $$3, duc $$4, List<dus.a> $$5, hv.a $$6, int $$7, ia $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         hv $$16 = new hv($$12, $$11, $$13);
         $$5.add(new dus.a($$16, 0, false));
         $$5.add(new dus.a($$16.c(2), 0, false));
      }
   }
