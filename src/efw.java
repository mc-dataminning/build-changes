...
public class efw extends egb {
   public static final MapCodec<efw> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, efw::new));
   ...
   public List<eej.a> a(dbz $$0, BiConsumer<iz, drx> $$1, azc $$2, int $$3, iz $$4, edt $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayu.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayu.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<efw.a> $$13 = Lists.newArrayList();
      $$13.add(new efw.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iz $$21 = $$4.b(ayu.a($$19), $$12 - 1, ayu.a($$20));
               iz $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  iz $$27 = new iz($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new efw.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<eej.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dbz $$0, BiConsumer<iz, drx> $$1, azc $$2, iz $$3, iz $$4, boolean $$5, edt $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         iz $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iz $$13 = $$3.b(ayu.d(0.5F + (float)$$12 * $$9), ayu.d(0.5F + (float)$$12 * $$10), ayu.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlg.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dbz $$0, BiConsumer<iz, drx> $$1, azc $$2, int $$3, iz $$4, List<efw.a> $$5, edt $$6) {
      for (efw.a $$7 : $$5) {
         int $$8 = $$7.a();
         iz $$9 = new iz($$4.u(), $$8, $$4.w());
