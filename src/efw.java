...
public class efw implements dqo.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<efw> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final awc<efw> a = awc.a(f);
   private final ega g;
   private final ega h;
   private final ega i;
   ...
   public static efw a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new efw(new drw(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private efw(ega $$0, ega $$1, ega $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public efw(awp $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ega.a($$0, IntStream.rangeClosed(-15, 0)),
         ega.a($$0, IntStream.rangeClosed(-15, 0)),
         ega.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public efw a(awp $$0) {
      return new efw($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dqo.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         efx $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ega.b($$4 * $$13), ega.b($$5 * $$13), ega.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ega.b($$1 * $$13);
         double $$21 = ega.b($$2 * $$13);
         double $$22 = ega.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            efx $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return awi.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
