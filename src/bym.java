...
public class bym {
   ...
   public static bwp<bvd> a(float $$0) {
      ...
      return cab.a(
         (Function<cab.b<bvd>, ? extends App<cab.c<bvd>, cae<bvd>>>)($$3 -> $$3.group($$3.c(cdz.m), $$3.c(cdz.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.aa() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cfz $$7 = $$4x.y();
                        Optional<jg> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cgd.n), $$5.dx(), 48, cfz.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dx()) <= 4.0)) {
                           MutableInt $$9 = new MutableInt(0);
                           $$2.setValue($$4x.aa() + (long)$$4x.E_().a(20));
                           Predicate<jg> $$10 = $$3xxx -> {
                              long $$4xx = $$3xxx.a();
                           ...
                           Set<Pair<jp<cgc>, jg>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cgd.n), $$10, $$5.dx(), 48, cfz.b.c).collect(Collectors.toSet());
                           ers $$12 = bwh.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              jg $$13 = $$12.l();
                              Optional<jp<cgc>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cec($$13, $$0, 1));
                                 agr.c($$4x, $$13);
                              }
