...
public class fck extends esq.a<fck> {
   private static final aez f = new aez("icon/draft_report");
   private static final int g = 10;
   private static final etx h = new etx(
      new aez("social_interactions/report_button"),
      new aez("social_interactions/report_button_disabled"),
      new aez("social_interactions/report_button_highlighted")
   );
   private static final etx i = new etx(new aez("social_interactions/mute_button"), new aez("social_interactions/mute_button_highlighted"));
   private static final etx j = new etx(new aez("social_interactions/unmute_button"), new aez("social_interactions/unmute_button_highlighted"));
   private final eqp k;
   private final List<esi> l;
   ...
   public static final int a = arl.b.a(190, 0, 0, 0);
   private static final int K = 20;
   public static final int b = arl.b.a(255, 74, 74, 74);
   public static final int c = arl.b.a(255, 48, 48, 48);
   public static final int d = arl.b.a(255, 255, 255, 255);
   public static final int e = arl.b.a(140, 255, 255, 255);

   public fck(eqp $$0, fcn $$1, UUID $$2, String $$3, Supplier<gaa> $$4, boolean $$5) {
      this.k = $$0;
      this.m = $$2;
      this.n = $$3;
      this.o = $$4;
      ...
      if ($$11 && $$10 && !$$9.e($$2)) {
         this.x = new esw(0, 0, 20, 20, h, $$3x -> $$6.a($$0, $$1, () -> $$0.a(new fcg($$1, $$6, this)), false), tl.c("gui.socialInteractions.report")) {
            @Override
            protected tz aE_() {
               return fck.this.a(super.aE_());
            }
         };
         this.x.i = this.s;
         this.x.a(this.k());
         this.x.b(10);
         this.v = new esw(0, 0, 20, 20, i, $$3x -> {
            $$9.a($$2);
   ...
   private etv k() {
      return !this.s ? etv.a(E) : etv.a(H, tl.a("gui.socialInteractions.narration.report", this.n));
   }
