...
public class fck extends gvg {
   ...
   public void aM_() {
      this.C.a(a, this.p);
      this.D = this.C.c(new fck.a(this.m));
   ...
   private xp a(String $$0) {
      try {
         return fdh.a.get(Integer.parseInt($$0)).b();
   ...
   private xp b(String $$0) {
      try {
         return fdh.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends fia<fck.b> {
      public a(final fff $$0) {
         super($$0, fck.this.n, fck.this.C.d(), fck.this.C.c(), 36);
         if (fck.this.B.e != null) {
            fck.this.B.e.forEach(($$0x, $$1) -> this.b(fck.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends fia.a<fck.b> {
      ...
      public void a(fgr $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fck.this.p, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(fck.this.p, fck.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
