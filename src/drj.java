...
public class drj<T> implements drl<T> {
   ...
   private drj(iq<T> $$0, int $$1, drm<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private drj(iq<T> $$0, T[] $$1, drm<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public drl<T> c() {
      return new drj<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
