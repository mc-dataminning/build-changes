...
public record bv(Optional<Boolean> d) implements br {
   ...
   public static final MapCodec<bv> c = RecordCodecBuilder.mapCodec($$0 -> $$0.group(asq.a(Codec.BOOL, "in_open_water").forGetter(bv::b)).apply($$0, bv::new));
   ...
   public boolean a(bki $$0, ama $$1, @Nullable eji $$2) {
      if (this.d.isEmpty()) {
         ...
         return $$0 instanceof cea $$3 ? this.d.get() == $$3.q() : false;
      }
   }
