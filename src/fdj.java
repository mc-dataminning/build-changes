...
public class fdj extends gvf {
   ...
   private static final xo F = xo.c("mco.upload.verifying");
   private final fdc G;
   private final epw H;
   @Nullable
   private final feg I;
   ...
   @Nullable
   private volatile xo[] N;
   private volatile xo O = xo.c("mco.upload.preparing");
   @Nullable
   ...
   private Long Y;
   private long Z;
   private final fkq aa = new fkq(this);

   public fdj(@Nullable feg $$0, long $$1, int $$2, fdc $$3, epw $$4) {
      super(few.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aM_() {
      this.U = this.aa.b(fhd.a(xn.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.aa.b(fhd.a(xn.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.J();
         } else {
            List<fee> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fem(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fcu(this.G, $$0.toArray(new fee[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fcn(new fai(new fnh()), this.J));
   }
   ...
   private void c(fgq $$0) {
      ...
      $$0.a(this.p, xo.a("mco.upload.percent", this.P), this.n / 2, 84, -1);
   }

   private void d(fgq $$0) {
      if (this.W % 20 == 0) {
   ...
   private xo I() {
      ...
      $$0.add(this.O);
      if (this.P != null) {
         $$0.add(xo.a("mco.upload.percent", this.P));
      }
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.O = xo.c("mco.upload.close.failure");
                  } else {
                     fbs $$2 = null;
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              this.O = xo.a("mco.upload.uploading", this.H.b());
                              fal $$10 = new fal($$0, this.J, this.K, $$2, this.m.X(), aa.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                                 if ($$0x.a >= 200 && $$0x.a < 300) {
                                    this.R = true;
                                    this.O = xo.c("mco.upload.done");
                                    if (this.U != null) {
                                       this.U.b(xn.d);
                                    }
                                    ...
                                    this.a(xo.a("mco.upload.failed", $$0x.b));
                                 } else {
                                    this.a(xo.a("mco.upload.failed", $$0x.a));
                                 }
                              });
                              ...
                              long $$6 = $$0.length();
                              faj $$7 = faj.a($$6);
                              faj $$8 = faj.a(5368709120L);
                              if (faj.b($$6, $$7).equals(faj.b(5368709120L, $$8)) && $$7 != faj.a) {
                                 faj $$9 = faj.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xo.a("mco.upload.size.failure.line1", this.H.b()),
                                    xo.a("mco.upload.size.failure.line2", faj.b($$6, $$9), faj.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xo.a("mco.upload.size.failure.line1", this.H.b()),
                                    xo.a("mco.upload.size.failure.line2", faj.b($$6, $$7), faj.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(xo.a("mco.upload.failed", var19.getMessage()));
               } catch (fca var20) {
                  this.a(xo.a("mco.upload.failed", var20.a.b()));
   ...
   private void K() {
      this.O = xo.c("mco.upload.cancelled");
