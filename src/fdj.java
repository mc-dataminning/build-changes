public abstract class fdj extends fdn implements fes, ffl {
   private static final ffc a = new ffc(new ajt("widget/text_field"), new ajt("widget/text_field_highlighted"));
   private static final ajt b = new ajt("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fdj(int $$0, int $$1, int $$2, int $$3, wg $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return axk.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = axk.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fdc var1, int var2, int var3, float var4);
}
