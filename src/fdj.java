...
public class fdj {
   public static List<fej> a(fdj.a... $$0) {
      for (fdj.a $$1 : $$0) {
         a($$1.j);
      }

      List<fej> $$2 = Lists.newArrayList();

      for (fdj.a $$3 : $$0) {
         $$2.add(new fej($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fej::a));
      return $$2;
   }
   ...
   public static List<fej> a() {
      return a(fdj.a.values());
   }
