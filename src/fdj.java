...
public class fdj extends gvh {
   ...
   public void aM_() {
      this.a(this.I.a);
      this.c(fhf.a(xp.c("mco.configure.world.subscription.extend"), $$0 -> flv.a(this, axu.a(this.I.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.I.j) {
         this.c(fhf.a(xp.c("mco.configure.world.delete.button"), $$0 -> {
            xp $$1 = xp.c("mco.configure.world.delete.question.line1");
            xp $$2 = xp.c("mco.configure.world.delete.question.line2");
            this.m.a(new fcv(this::c, fcv.a.a, $$1, $$2, true));
         }).a(this.n / 2 - 100, g(10), 200, 20).a());
      } else if (fak.b() && this.I.s != null) {
         this.c(new fhp(this.n / 2 - 100, g(8), 200, 46, xp.a("mco.snapshot.subscription.info", this.I.s), this.p).a(-6250336));
      } else {
         this.c(new fhp(this.n / 2 - 100, g(8), 200, 46, G, this.p).a(-6250336));
      }

      this.c(fhf.a(xo.k, $$0 -> this.d()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  fdj.a.error("Couldn't delete world", var2);
               }

               fdj.this.m.execute(() -> fdj.this.m.a(fdj.this.J));
            }
         }).start();
      }
