...
public class fdj extends gvg {
   ...
   public void aM_() {
      int $$0 = this.n / 4 - 2;
      this.c(fhe.a(xp.c("mco.terms.buttons.agree"), $$0x -> this.E()).a(this.n / 4, g(12), $$0, 20).a());
      this.c(fhe.a(xp.c("mco.terms.buttons.disagree"), $$0x -> this.m.a(this.C)).a(this.n / 2 + 4, g(12), $$0, 20).a());
   }
   ...
   private void E() {
      ...
      try {
         $$0.j();
         this.m.a(new fcv(this.C, new fee(this.C, this.D)));
      } catch (fcb var3) {
