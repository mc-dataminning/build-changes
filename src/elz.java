...
public class elz extends ekk<eno> {
   public elz(Codec<eno> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ekm<eno> $$0) {
      dkw $$1 = $$0.b();
      eno $$2 = $$0.f();
      azx $$3 = $$0.d();
      iv $$4 = $$0.e();
      Predicate<ebe> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, ebd.a::l) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(ekm<eno> $$0, dkw $$1, eno $$2, azx $$3, Set<iv> $$4, int $$5, int $$6) {
      for (iv $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(dkw $$0, eno $$1, Predicate<ebe> $$2, azx $$3, iv.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         ebe $$7 = $$1.c.a($$3, $$4);
         ebe $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
