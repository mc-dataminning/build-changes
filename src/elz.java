...
public abstract class elz<T extends elz<T>> {
   ...
   public elz(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = elx.a();
         if ($$3 != null) {
         ...
         throw new eni(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new eni(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new eni(var2.getMessage(), var2);
      }
   }
   ...
   public static elz<?> a(String $$0) {
      return new elz.b($$0, 5000, 60000);
   }

   public static elz<?> a(String $$0, int $$1, int $$2) {
      return new elz.b($$0, $$1, $$2);
   }

   public static elz<?> c(String $$0, String $$1) {
      return new elz.c($$0, $$1, 5000, 60000);
   }

   public static elz<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new elz.c($$0, $$1, $$2, $$3);
   }

   public static elz<?> b(String $$0) {
      return new elz.a($$0, 5000, 60000);
   }

   public static elz<?> d(String $$0, String $$1) {
      return new elz.d($$0, $$1, 5000, 60000);
   }

   public static elz<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new elz.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends elz<elz.a> {
   ...
   public static class b extends elz<elz.b> {
   ...
   public static class c extends elz<elz.c> {
      ...
      public elz.c f() {
         try {
            ...
            throw new eni(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends elz<elz.d> {
      private final String c;
