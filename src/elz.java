...
public class elz {
   ...
   static class a implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
         return $$0.c[ji.f.d()] && !$$0.b[ji.f.d()].d;
      }

      @Override
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         $$1.d = true;
         $$1.b[ji.f.d()].d = true;
         return new elz.k($$0, $$1);
      }
   }

   static class b implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         ...
         return new elz.l($$0, $$1);
      }
   }

   static class c implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         $$1.d = true;
         $$1.b[ji.b.d()].d = true;
         return new elz.m($$0, $$1);
      }
   }

   static class d implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         ...
         return new elz.n($$0, $$1);
      }
   }

   static class e implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         ...
         $$3.d = true;
         $$3.b[ji.c.d()].d = true;
         return new elz.o($$0, $$3);
      }
   }

   static class f implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
         return true;
      }
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         $$1.d = true;
         return new elz.s($$0, $$1, $$2);
      }
   }

   static class g implements elz.i {
      @Override
      public boolean a(elz.v $$0) {
      ...
      public elz.r a(ji $$0, elz.v $$1, ayw $$2) {
         $$1.d = true;
         return new elz.t($$0, $$1);
      }
   }

   public static class h extends elz.r {
      ...
      private elz.v G;
      private elz.v H;
      private final List<elz.r> I = Lists.newArrayList();

      public h(ayw $$0, int $$1, int $$2, ji $$3) {
         super(ekg.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<elz.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new elz.p($$3, this.G));
         this.I.add(new elz.j($$3, this.H));
         List<elz.i> $$5 = Lists.newArrayList();
         $$5.add(new elz.b());
         $$5.add(new elz.d());
         $$5.add(new elz.e());
         $$5.add(new elz.a());
         ...
         ejh $$10 = ejh.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ejh $$11 = ejh.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ejh $$12 = ejh.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new elz.u($$3, $$10, $$13++));
         this.I.add(new elz.u($$3, $$11, $$13++));
         this.I.add(new elz.q($$3, $$12));
      }
      ...
      private List<elz.v> b(ayw $$0) {
         elz.v[] $$1 = new elz.v[75];
         ...
         elz.v $$23 = new elz.v(1003);
         elz.v $$24 = new elz.v(1001);
         elz.v $$25 = new elz.v(1002);
         $$1[v].a(ji.b, $$23);
         $$1[w].a(ji.d, $$24);
         $$1[x].a(ji.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<elz.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dds $$2, ayw $$3, ejh $$4) {
         int $$5 = 24;
      ...
      private void a(dds $$0, ayw $$1, ejh $$2) {
      ...
      private void b(dds $$0, ayw $$1, ejh $$2) {
      ...
      private void c(dds $$0, ayw $$1, ejh $$2) {
      ...
      private void d(dds $$0, ayw $$1, ejh $$2) {
      ...
      private void e(dds $$0, ayw $$1, ejh $$2) {
      ...
      private void f(dds $$0, ayw $$1, ejh $$2) {
   ...
   interface i {
      boolean a(elz.v var1);

      elz.r a(ji var1, elz.v var2, ayw var3);
   }

   public static class j extends elz.r {
      public j(ji $$0, elz.v $$1) {
         super(ekg.N, 1, $$0, $$1, 2, 2, 2);
      }
   ...
   public static class k extends elz.r {
      public k(ji $$0, elz.v $$1) {
         super(ekg.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends elz.r {
      public l(ji $$0, elz.v $$1) {
         super(ekg.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends elz.r {
      public m(ji $$0, elz.v $$1) {
         super(ekg.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends elz.r {
      public n(ji $$0, elz.v $$1) {
         super(ekg.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends elz.r {
      public o(ji $$0, elz.v $$1) {
         super(ekg.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends elz.r {
      public p(ji $$0, elz.v $$1) {
         super(ekg.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends elz.r {
      public q(ji $$0, ejh $$1) {
         super(ekg.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ejt {
      ...
      public r(ekg $$0, ji $$1, int $$2, ejh $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ekg $$0, int $$1, ji $$2, elz.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ejh a(ji $$0, elz.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ejh $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dds $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
      ...
      protected void a(dds $$0, ejh $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dds $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dtc $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ejh $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dds $$0, ejh $$1, int $$2, int $$3, int $$4) {
         jd $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
   ...
   public static class s extends elz.r {
      private int a;

      public s(ji $$0, elz.v $$1, ayw $$2) {
         super(ekg.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends elz.r {
      public t(ji $$0, elz.v $$1) {
         super(ekg.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends elz.r {
      private int a;

      public u(ji $$0, ejh $$1, int $$2) {
         super(ekg.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
