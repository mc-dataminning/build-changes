...
public class gsl {
   ...
   public gsl(gvd $$0, dkj $$1, int $$2, gri $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   @Nullable
   protected gvd.b a(iw $$0) {
      return this.a(jz.c($$0));
   }

   @Nullable
   protected gvd.b a(long $$0) {
      int $$1 = jz.b($$0);
      int $$2 = jz.c($$0);
      int $$3 = jz.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gvd.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.aq();
