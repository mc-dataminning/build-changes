...
public class gsl extends grk<bvw, gyn> {
   public gsl(grl.a $$0) {
      super($$0);
   }

   public void a(gyn $$0, fgl $$1, glg $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvw $$0, gyn $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bvw $$0) {
      return false;
   }
}
