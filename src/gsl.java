public class gsl extends gsd<cpm, gys> {
   private static final akv a = akv.b("textures/entity/fishing_hook.png");
   private static final gmi b = gmi.f(a);
   ...
   public boolean a(cpm $$0, gpq $$1, double $$2, double $$3, double $$4) {
      return super.a($$0, $$1, $$2, $$3, $$4) && $$0.m() != null;
   }

   public void a(gys $$0, ffu $$1, gly $$2, int $$3) {
      $$1.a();
      $$1.a();
      $$1.b(0.5F, 0.5F, 0.5F);
      $$1.a(this.e.b());
   ...
   public static bvb a(cox $$0) {
      return $$0.eZ().h() instanceof cvy ? $$0.fy() : $$0.fy().e();
   }

   private fba a(cox $$0, float $$1, float $$2) {
      int $$3 = a($$0) == bvb.b ? 1 : -1;
      if (this.e.d.aE().a() && $$0 == flj.Q().t) {
         double $$11 = 960.0 / (double)this.e.d.ak().c().intValue();
         fba $$12 = this.e.b.j().a((float)$$3 * 0.525F, -0.1F).c($$11).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.m($$2).e($$12);
      } else {
   ...
   private static void a(ffy $$0, ffu.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(hei.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }

   private static void a(float $$0, float $$1, float $$2, ffy $$3, ffu.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
   ...
   public void a(cpm $$0, gys $$1, float $$2) {
      super.a($$0, $$1, $$2);
      cox $$3 = $$0.m();
      if ($$3 == null) {
         $$1.a = fba.c;
