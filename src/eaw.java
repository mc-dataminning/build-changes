...
public class eaw implements AutoCloseable {
   ...
   public eaw(ebf $$0, Path $$1, DataFixer $$2, boolean $$3) {
      this.e = $$2;
   ...
   public tq a(akt<dgz> $$0, Supplier<evw> $$1, tq $$2, Optional<akt<MapCodec<? extends dzn>>> $$3) {
      int $$4 = a($$2);
      if ($$4 == ab.b().d().c()) {
         return $$2;
      } else {
   ...
   private eoe a(akt<dgz> $$0, Supplier<evw> $$1) {
      eoe $$2 = this.b;
      if ($$2 == null) {
         synchronized (this) {
            $$2 = this.b;
   ...
   public static void a(tq $$0, akt<dgz> $$1, Optional<akt<MapCodec<? extends dzn>>> $$2) {
      tq $$3 = new tq();
   ...
   public CompletableFuture<Optional<tq>> d(dgg $$0) {
      return this.a.a($$0);
   }
