...
public class eaw extends eba {
   public static final Codec<eaw> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, eaw::new));
   ...
   public List<dzi.a> a(cxh $$0, BiConsumer<ib, dnb> $$1, axd $$2, int $$3, ib $$4, dys $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new dzi.a(new ib($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new dzi.a(new ib($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
