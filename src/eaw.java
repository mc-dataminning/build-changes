...
public class eaw extends eaz<eav> {
   public eaw(Codec<eav> $$0) {
      super($$0);
   }

   public boolean a(eav $$0, ayt $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eau $$0, eav $$1, duy $$2, Function<ir, ja<dcz>> $$3, ayt $$4, dyg $$5, dbh $$6, dux $$7) {
      int $$8 = jt.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         eaz.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eau $$0, eav $$1, duy $$2, Function<ir, ja<dcz>> $$3, dyg $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dux $$10, eaz.a $$11
   ) {
      double $$12 = 1.5 + (double)(aym.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(aym.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = aym.b($$13);
         $$6 += (double)(aym.b($$12) * $$27);
         $$7 += (double)aym.a($$13);
         $$8 += (double)(aym.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
