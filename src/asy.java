...
public class asy {
   ...
   private static List<asy.b> a(final Path $$0) throws IOException {
      try {
         final List<asy.b> $$1 = new ArrayList<>();
   ...
   private static List<asy.a> a(List<asy.b> $$0) {
      List<asy.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (asy.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new asy.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<asy.a> a = Comparator.comparing(asy.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<asy.b> a = Comparator.comparing(asy.b::b).reversed();
