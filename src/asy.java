...
public abstract class asy implements AutoCloseable {
   ...
   protected asy(URL $$0, asy.b $$1, asy.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? azd.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static asy a(aqj $$0) {
      String $$1 = $$0.R;
      if (bak.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<asj> a(GameProfile $$0, String $$1, asy.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(asj.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract asj a(String var1, asy.a var2, JsonObject var3);

   protected xp a(String $$0, JsonArray $$1, asy.a $$2) {
      if ($$1.isEmpty()) {
         return xp.c;
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asy.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      asy.a a = ($$0, $$1) -> false;
      asy.a b = ($$0, $$1) -> $$0.length() == $$1;

      static asy.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static asy.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements asz {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bqx $$2 = new bqx(asy.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a_;
      }
      ...
      public CompletableFuture<asj> a(String $$0) {
         return asy.this.a(this.b, $$0, asy.this.f, this.c);
      }
   }
