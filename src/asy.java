...
public class asy extends ass {
   static final Logger c = LogUtils.getLogger();
   private final asy.b d;
   private final String e;

   asy(ata $$0, asy.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atd $$0, aku $$1) {
   ...
   public static class a implements atw.c {
      ...
      public atb a(ata $$0, atw.a $$1) {
         ...
         if ($$4.isEmpty()) {
            ...
            List<atb> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  asy.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
