...
public class asy {
   ...
   public static ib<ckw> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jy.i
            .b(agf.a(jz.E, new agg($$2)))
   ...
   public static ib<ckw> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ib<ckw> a(JsonObject $$0, String $$1, @Nullable ib<ckw> $$2) {
