...
class asy extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof asx && $$1 instanceof asx && $$0.equals($$1);
   }
   ...
   private static asx a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof asx) {
         return (asx)$$0;
      } else {
