...
public class asy {
   ...
   asy(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static asy.a a() {
      return new asy.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(asy::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public asy.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public asy a(Writer $$0) throws IOException {
         return new asy($$0, this.a);
      }
   }
}
