...
public class asy {
   ...
   public static final Codec<Object> b = a(atj.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(atg.e($$0));
   ...
   public static final Codec<asy.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? agm.b($$0.substring(1)).map($$0x -> new asy.f($$0x, true)) : agm.b($$0).map($$0x -> new asy.f($$0x, false)), asy.f::c
      );
   ...
   private static final MapCodec<GameProfile> z = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(iz.c.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !agm.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> asy.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new asy.b<>($$0, $$1);
   }

   public static <K, V> asy.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new asy.e<>($$0, $$1);
   }
   ...
   public static <T> Codec<ik<T>> b(Codec<ik<T>> $$0) {
      return a(
         $$0,
         (Function<ik<T>, DataResult<ik<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof asy.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(agm a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
