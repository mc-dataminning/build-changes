...
public class dzh<T> implements dzj<T> {
   ...
   private dzh(jw<T> $$0, int $$1, dzk<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dzh(jw<T> $$0, T[] $$1, dzk<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dzj<T> a(dzk<T> $$0) {
      return new dzh<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
