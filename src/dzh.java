...
public class dzh {
   ...
   private final List<dzf> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dzh.a l = new dzh.d(5.999997E7F);
   public static final dzh.c d = new dzh.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public fbx c(double $$0, double $$1, double $$2) {
      return new fbx(ayz.a($$0, this.e(), this.g() - 1.0E-5F), $$1, ayz.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dzh.a)($$0 == $$1 ? new dzh.d($$1) : new dzh.b($$0, $$1, $$2));
   ...
   class b implements dzh.a {
      ...
      @Override
      public double a() {
         return ayz.a(dzh.this.a() - this.e() / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dzh.this.b() - this.e() / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
      }
      ...
      @Override
      public dzg i() {
         return this.c < this.b ? dzg.b : dzg.a;
      }
      ...
      @Override
      public dzh.a l() {
         return (dzh.a)(this.g() <= 0L ? dzh.this.new d(this.c) : this);
      }
   ...
   public static class c {
      ...
      public static dzh.c a(DynamicLike<?> $$0, dzh.c $$1) {
         ...
         return new dzh.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dzh.a {
      ...
      private void n() {
         this.c = ayz.a(dzh.this.a() - this.b / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
         this.d = ayz.a(dzh.this.b() - this.b / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
         this.e = ayz.a(dzh.this.a() + this.b / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
         this.f = ayz.a(dzh.this.b() + this.b / 2.0, (double)(-dzh.this.k), (double)dzh.this.k);
         this.g = fco.a(
            fco.c,
            fco.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fcb.e
