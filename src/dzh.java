...
public class dzh implements dkg.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzh> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final arm<dzh> a = arm.a(f);
   private final dzl g;
   private final dzl h;
   private final dzl i;
   ...
   public static dzh a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzh(new dlo(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzh(dzl $$0, dzl $$1, dzl $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzh(arx $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzl.a($$0, IntStream.rangeClosed(-15, 0)),
         dzl.a($$0, IntStream.rangeClosed(-15, 0)),
         dzl.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzh a(arx $$0) {
      return new dzh($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dkg.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dzi $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzl.b($$4 * $$13), dzl.b($$5 * $$13), dzl.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzl.b($$1 * $$13);
         double $$21 = dzl.b($$2 * $$13);
         double $$22 = dzl.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dzi $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ars.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
