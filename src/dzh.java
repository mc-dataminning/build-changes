...
public class dzh extends dxr {
   ...
   protected void b(tz $$0, jh.a $$1) {
      super.b($$0, $$1);
      $$0.b("profile", dcn.a, this.h);
      $$0.b("note_block_sound", alg.a, this.i);
      $$0.b("custom_name", xa.a, $$1.a(un.a), this.l);
   }

   @Override
   protected void a(tz $$0, jh.a $$1) {
      super.a($$0, $$1);
      this.a($$0.<dcn>a("profile", dcn.a).orElse(null));
      this.i = $$0.<alg>a("note_block_sound", alg.a).orElse(null);
      this.l = a($$0.a("custom_name"), $$1);
   }

   public static void a(djm $$0, iv $$1, eat $$2, dzh $$3) {
      if ($$2.b(dud.a) && $$2.c(dud.a)) {
         $$3.k = true;
         $$3.j++;
      } else {
         $$3.k = false;
