...
public abstract class eqs<T extends eqs<T>> {
   ...
   public eqs(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eqq.a();
         if ($$3 != null) {
         ...
         throw new esb(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new esb(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new esb(var2.getMessage(), var2);
      }
   }
   ...
   public static eqs<?> a(String $$0) {
      return new eqs.b($$0, 5000, 60000);
   }

   public static eqs<?> a(String $$0, int $$1, int $$2) {
      return new eqs.b($$0, $$1, $$2);
   }

   public static eqs<?> b(String $$0, String $$1) {
      return new eqs.c($$0, $$1, 5000, 60000);
   }

   public static eqs<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eqs.c($$0, $$1, $$2, $$3);
   }

   public static eqs<?> b(String $$0) {
      return new eqs.a($$0, 5000, 60000);
   }

   public static eqs<?> c(String $$0, String $$1) {
      return new eqs.d($$0, $$1, 5000, 60000);
   }

   public static eqs<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eqs.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eqs<eqs.a> {
   ...
   public static class b extends eqs<eqs.b> {
   ...
   public static class c extends eqs<eqs.c> {
      ...
      public eqs.c f() {
         try {
            ...
            throw new esb(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eqs<eqs.d> {
      private final String c;
