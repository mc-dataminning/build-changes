...
public interface eqs {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new eqs.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new eqs.d($$0, $$1);
      }
   }

   public static record a(String d) implements eqs {
   ...
   public static record b(int e, @Nullable vf f) implements eqs {
      public static final eqs.b c = new eqs.b(429, vf.c("mco.errorMessage.serviceBusy"));
      public static final vf d = vf.c("mco.errorMessage.retry");

      public static eqs.b a(String $$0) {
         return new eqs.b(500, vf.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static eqs.b a(esc $$0) {
         return new eqs.b(500, vf.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static eqs.b a(int $$0) {
         return new eqs.b($$0, d);
      }

      public static eqs.b b(int $$0) {
         return new eqs.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements eqs {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements eqs {
      @Override
      public int a() {
         return this.c;
      }
