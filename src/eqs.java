...
public abstract class eqs<M extends eqp<M>> {
   private final dfe i;
   ...
   protected final Long2ObjectMap<dxe> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eqs(dfe $$0, dxm $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dxe a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dxe a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dxe c(long $$0) {
      dxe $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = ki.e($$0);
      dxe $$2 = this.a($$1, true);
      return $$2.a(ki.b(jg.a($$0)), ki.b(jg.b($$0)), ki.b(jg.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(ki.b(jg.a($$0)), ki.b(jg.b($$0)), ki.b(jg.c($$0)), $$1);
      ki.a($$0, this.f::add);
   }
   ...
   protected void a(eqv<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dxe $$2 = (dxe)this.g.remove($$1);
            dxe $$3 = this.d.d($$1);
            if (this.k.contains(ki.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dxe>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dxe> $$6 = (Entry<dxe>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dxe $$8 = (dxe)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dxe $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = ki.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eqs.a.a($$9, eqs.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eqs.b l(long $$0) {
      return eqs.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eqs.b c(byte $$0) {
         if ($$0 == 0) {
            return eqs.b.a;
         } else {
            return a($$0) ? eqs.b.c : eqs.b.b;
         }
      }
   }
