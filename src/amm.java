...
public class amm {
   ...
   public amm(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<amm.a> b(Scanner $$0) {
      alg<dev> $$1 = (alg<dev>)amv.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amm.a($$1, new ezh((double)$$2, (double)$$3, (double)$$4), new ezg($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<arn> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            arn $$2 = $$1.get(0);
            arm $$3 = this.e.J();
            ev $$4 = new ev($$2, ezh.a($$3.W()), ezg.a, $$3, 4, "", xg.a, this.e, $$2);
            ew $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(alg<dev> a, ezh b, ezg c) {
   }
}
