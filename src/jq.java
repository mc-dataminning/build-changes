...
public final class jq {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ac.a($$0, 4).map(jq::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static ys<ByteBuf, UUID> g = new ys<ByteBuf, UUID>() {
