...
public class aji {
   ...
   public static final List<aji.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<dt> $$0) {
      ...
      for (aji.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<dt, ?>, aji.b>)(($$0x, $$1x) -> $$0x.then(
                           du.a("insert")
                              .then(
   ...
   private static ArgumentBuilder<dt, ?> a(BiConsumer<ArgumentBuilder<dt, ?>, aji.b> $$0) {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<dt, ?> create(aji.a var1);
   }

   public interface c {
      ajh a(CommandContext<dt> var1) throws CommandSyntaxException;
