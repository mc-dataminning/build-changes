...
public class emr extends LongLinkedOpenHashSet {
   private final emr.a a;

   public emr(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new emr.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = ayf.f(60000000);
      private static final int b = ayf.f(60000000);
