...
public class emr {
   ...
   public static final emr.a bv;

   public static emr.a a(int $$0, int $$1) {
      return $$0 == -1 ? emr.b.b.a($$1) : emr.b.a.a($$0);
   }

   public static emr.a a(String $$0) {
      if (emr.a.e.containsKey($$0)) {
         return emr.a.e.get($$0);
      } else {
         for (emr.b $$1 : emr.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final emr.b b;
      private final int c;
      private final ath<ur> d;
      static final Map<String, emr.a> e = Maps.newHashMap();

      a(String $$0, emr.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ath<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<emr.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, ur> g;

      private static void a(emr.b $$0, String $$1, int $$2) {
         emr.a $$3 = new emr.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public emr.a a(int $$0) {
         return (emr.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
