...
public class cwr {
   private static final cws a = new cws();
   private static final int b = 16;
   private final boolean c;
   private final cwr.a d;
   ...
   private final Map<cis, epr> r = Maps.newHashMap();

   public static bnv a(cwz $$0, @Nullable bow $$1) {
      return $$0.ah().d($$1, b($$1));
   }

   public cwr(cwz $$0, @Nullable bow $$1, double $$2, double $$3, double $$4, float $$5, List<ib> $$6, cwr.a $$7, ka $$8, ka $$9, il<atx> $$10) {
      this($$0, $$1, a($$0, $$1), null, $$2, $$3, $$4, $$5, false, $$7, $$8, $$9, $$10);
      this.q.addAll($$6);
   }

   public cwr(cwz $$0, @Nullable bow $$1, double $$2, double $$3, double $$4, float $$5, boolean $$6, cwr.a $$7, List<ib> $$8) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7);
      this.q.addAll($$8);
   }

   public cwr(cwz $$0, @Nullable bow $$1, double $$2, double $$3, double $$4, float $$5, boolean $$6, cwr.a $$7) {
      this($$0, $$1, a($$0, $$1), null, $$2, $$3, $$4, $$5, $$6, $$7, kc.x, kc.w, aty.jT);
   }
   ...
   private cws a(@Nullable bow $$0) {
      return (cws)($$0 == null ? a : new cwp($$0));
   }

   public static float a(epr $$0, bow $$1) {
      epm $$2 = $$1.cH();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  epr $$16 = new epr($$13 + $$6, $$14, $$15 + $$7);
                  if ($$1.dM().a(new cwi($$16, $$0, cwi.a.a, cwi.b.a, $$1)).c() == epp.a.a) {
                     $$8++;
                  }
   ...
   public epr b() {
      return new epr(this.g, this.h, this.i);
   }

   public void c() {
      this.f.a(this.j, drn.w, new epr(this.g, this.h, this.i));
      ...
      List<bow> $$25 = this.f.a_(this.j, new epm((double)$$19, (double)$$21, (double)$$23, (double)$$20, (double)$$22, (double)$$24));
      epr $$26 = new epr(this.g, this.h, this.i);
      ...
      for (bow $$27 : $$25) {
         if (!$$27.a(this)) {
            ...
            if ($$28 <= 1.0) {
               ...
               double $$30 = ($$27 instanceof cfe ? $$27.dt() : $$27.dv()) - this.h;
               ...
               if ($$32 != 0.0) {
                  ...
                  $$30 *= $$35;
                  $$31 *= $$35;
                  epr $$37 = new epr($$29, $$30, $$31);
                  $$27.g($$27.dp().e($$37));
                  if ($$27 instanceof cis) {
                     cis $$38 = (cis)$$27;
   ...
   public void a(boolean $$0) {
      ...
      if ($$1) {
         ...
         List<Pair<cqk, ib>> $$4 = new ArrayList<>();
         ...
         for (Pair<cqk, ib> $$6 : $$4) {
            daa.a(this.f, (ib)$$6.getSecond(), (cqk)$$6.getFirst());
         }
      ...
      if (this.c) {
         ...
         while (var7.hasNext()) {
            ...
            if (this.e.a(3) == 0 && this.f.a_($$7).i() && this.f.a_($$7.d()).i(this.f, $$7.d())) {
               this.f.b($$7, czn.a(this.f, $$7));
            }
         }
      }
   }

   private static void a(List<Pair<cqk, ib>> $$0, cqk $$1, ib $$2) {
      for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
         Pair<cqk, ib> $$4 = $$0.get($$3);
         cqk $$5 = (cqk)$$4.getFirst();
         if (cfd.a($$5, $$1)) {
            $$0.set($$3, Pair.of(cfd.a($$5, $$1, 16), (ib)$$4.getSecond()));
            if ($$1.b()) {
               return;
            }
         }
   ...
   public boolean d() {
      return this.d != cwr.a.a;
   }

   public Map<cis, epr> e() {
      return this.r;
   }

   @Nullable
   private static bpo b(@Nullable bow $$0) {
      if ($$0 == null) {
         return null;
      } else if ($$0 instanceof cfe $$1) {
         return $$1.p();
      } else if ($$0 instanceof bpo) {
         return (bpo)$$0;
      } else {
