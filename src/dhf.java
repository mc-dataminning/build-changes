...
public class dhf<T> implements dhn<T> {
   private final hj<T> a;
   private final aqo<T> b;
   private final dho<T> c;
   private final int d;

   public dhf(hj<T> $$0, int $$1, dho<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::c);
   }

   public dhf(hj<T> $$0, int $$1, dho<T> $$2) {
      this($$0, $$1, $$2, aqo.c(1 << $$1));
   }

   private dhf(hj<T> $$0, int $$1, dho<T> $$2, aqo<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dhn<T> c() {
      return new dhf<>(this.a, this.d, this.c, this.b.c());
   }
}
