...
public class flp {
   ...
   private static final Map<ebf.a, String> e = ae.a(new EnumMap<>(ebf.a.class), $$0 -> {
      $$0.put(ebf.a.a, "SW");
      $$0.put(ebf.a.b, "S");
      $$0.put(ebf.a.c, "OW");
      $$0.put(ebf.a.d, "O");
   ...
   private dxp l;
   @Nullable
   private CompletableFuture<dxp> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bmx r = new bmx(1);
   private final bmx s = new bmx(bnc.values().length);
   private final bmx t = new bmx(1);
   private final bmx u = new bmx(1);
   private final Map<bmy, bmx> v = Map.of(bmy.a, this.s);
   private final fmy w;
   private final fnb x;
   private final fmz y;
   private final fmx z;
   ...
   public flp(fji $$0) {
      ...
      this.g = new flp.a();
      this.h = $$0.h;
      this.w = new fmy(this.h, this.r);
      this.x = new fnb(this.h, this.s, () -> $$0.s.s().g());
      this.y = new fmz(this.h, this.t);
      this.z = new fmx(this.h, this.u);
      this.A = new fna(this.h);
   }
   ...
   private void a(fku $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dfb $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arn ? ((arn)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azk.h($$15.dN()), azk.h($$15.dP())));
         dxp $$27 = this.u();
         if ($$27.B()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(dfk.a, $$14);
            int $$30 = this.f.s.a(dfk.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dxp $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (ebf.a $$33 : ebf.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.t();
                  bsb $$37 = new bsb($$23.ak(), $$23.ab(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dfm.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bvd> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bvd.values())
   ...
   private static String a(jq<dgc> $$0) {
   ...
   private dfb s() {
      return (dfb)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ag()))), this.f.s);
   }
   ...
   private dxp t() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.g, this.k.h, dyg.n, false).thenApply($$0x -> (dxp)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fcu.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fji.Q().aO().k(), fji.Q().aO().l(), fcu.a()),
            fcu.c(),
            fcu.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == ezl.a.b) {
            ...
            $$4.add(String.valueOf(ly.e.b($$6.b())));

            for (Entry<dwm<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == ezl.a.b) {
            ...
            $$4.add(String.valueOf(ly.c.b($$9.a())));

            for (Entry<dwm<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(ly.f.b($$11.ar())));
         }
   ...
   private String a(Entry<dwm<?>, Comparable<?>> $$0) {
      dwm<?> $$1 = $$0.getKey();
