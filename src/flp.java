...
public class flp extends auu<Map<String, List<flp.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<flp.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(flp.a::a),
                     Codec.LONG.fieldOf("period").forGetter(flp.a::b),
                     Codec.STRING.fieldOf("title").forGetter(flp.a::c),
                     Codec.STRING.fieldOf("message").forGetter(flp.a::d)
                  )
                  .apply($$0, flp.a::new)
         )
         .listOf()
   ...
   public flp(akv $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<flp.a>> a(aup $$0, bou $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<flp.a>> $$0, aup $$1, bou $$2) {
      List<flp.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<flp.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<flp.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<flp.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public flp.b a(List<flp.a> $$0, long $$1) {
         this.cancel();
         return new flp.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (flp.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> frd.a(flk.Q().aA(), frd.a.g, wp.a($$2.c, $$3), wp.a($$2.d, $$3)));
                  return;
               }
            }
         }
