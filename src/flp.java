...
public class flp {
   ...
   public static void a(File $$0, fec $$1, Consumer<wo> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fec $$2, Consumer<wo> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fec $$2, Consumer<wo> $$3) {
      fes $$4 = a($$2);
   ...
   public static fes a(fec $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fes $$3 = new fes($$1, $$2, false);
   ...
   public flp(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
