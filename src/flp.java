...
public class flp {
   ...
   public void a(flp.b $$0, List<atc> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new flp.c($$0, $$1.stream().map(atc::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new flp.c(flp.b.c, ImmutableList.of());
      }

      this.b.c = new flp.a($$0);
   }
