...
public class flp {
   ...
   private static final Comparator<gbx> p = Comparator.<gbx>comparingInt($$0 -> -$$0.j())
      .thenComparingInt($$0 -> $$0.e() == deg.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), ezw::b, ""))
   ...
   private xe t;
   private boolean u;
   private final Map<UUID, flp.a> v = new Object2ObjectOpenHashMap();

   public flp(fip $$0, fka $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public xe a(gbx $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, ezw.a($$0.h(), xe.b($$0.a().getName())));
   }

   private xe a(gbx $$0, xs $$1) {
      return $$0.e() == deg.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fkb $$0, int $$1, fab $$2, @Nullable ezt $$3) {
      List<gbx> $$4 = this.b();
      List<flp.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               cnx $$44 = this.q.s.b($$43.getId());
               boolean $$45 = $$44 != null && gop.b($$44);
               boolean $$46 = $$44 != null && $$44.a(cny.g);
               fln.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45, -1);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == deg.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != deg.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fkb $$0, int $$1, int $$2, int $$3, gbx $$4) {
      ale $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(ghv::B, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(ezt $$0, int $$1, flp.b $$2, int $$3, int $$4, UUID $$5, fkb $$6) {
      if ($$0.h() == fae.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fkb $$4, int $$5) {
      flp.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new flp.a($$5));
      $$6.a($$5, (long)this.r.e());
      int $$7 = azf.e(Math.max($$5, $$6.a()), 2);
      int $$8 = Math.max($$5, Math.max($$6.a(), 20)) / 2;
      boolean $$9 = $$6.a((long)this.r.e());
      if ($$7 > 0) {
         int $$10 = azf.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
            float $$11 = azf.a((float)$$5 / 20.0F, 0.0F, 1.0F);
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(ghv::B, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(ghv::B, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(ghv::B, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(ghv::B, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(ghv::B, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(ghv::B, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
