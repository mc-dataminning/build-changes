public class flp extends fmk {
   private final fmf a;

   flp(fin $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fmf $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cbm $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dr();
            if (this.h > $$1) {
   ...
   public static class b implements fln<iy> {
      ...
      public flk a(iy $$0, fin $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flk $$8 = new flp($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
