...
public class fqf extends fob {
   ...
   private fik W;
   private fik X;
   private fir<Boolean> Y;
   private fir<dkv> Z;
   private fir<Boolean> aa;
   private fir<Boolean> ab;
   ...
   @Override
   protected void aT_() {
      this.c((fik)fik.a(wy.d, $$0x -> this.m()).a(this.m / 2 - 4 - 150, 210, 150, 20).a());
      this.c((fik)fik.a(wy.e, $$0x -> this.C()).a(this.m / 2 + 4, 210, 150, 20).a());
      this.B = this.A.k();
      this.C = this.A.l();
      this.D = this.A.v();
      this.E = this.A.w();
      this.F = this.A.E();
      this.G = this.A.F();
      this.R = this.c((fik)fik.a(wz.c("structure_block.button.save"), $$0x -> {
         if (this.A.v() == dum.a) {
            this.a(drx.a.b);
            this.l.a(null);
         }
      }).a(this.m / 2 + 4 + 100, 185, 50, 20).a());
      this.S = this.c((fik)fik.a(wz.c("structure_block.button.load"), $$0x -> {
         if (this.A.v() == dum.b) {
            this.a(drx.a.c);
            this.l.a(null);
         }
      ...
      this.c(
         fir.<dum>a($$0x -> wz.c("structure_block.mode." + $$0x.c()))
            .a(z, y)
            .a()
            .a(this.D)
      ...
      this.X = this.c((fik)fik.a(wz.c("structure_block.button.detect_size"), $$0x -> {
         if (this.A.v() == dum.a) {
            this.a(drx.a.d);
            this.l.a(null);
         }
      }).a(this.m / 2 + 4 + 100, 120, 50, 20).a());
      this.Y = this.c(fir.b(!this.A.w()).a().a(this.m / 2 + 4 + 100, 160, 50, 20, u, ($$0x, $$1x) -> this.A.a(!$$1x)));
      this.Z = this.c(fir.<dkv>a(dkv::b).a(dkv.values()).a().a(this.B).a(this.m / 2 - 20, 185, 40, 20, wz.b("MIRROR"), ($$0x, $$1x) -> this.A.a($$1x)));
      this.aa = this.c(fir.b(this.A.E()).a().a(this.m / 2 + 4 + 100, 80, 50, 20, w, ($$0x, $$1x) -> this.A.d($$1x)));
      this.ab = this.c(fir.b(this.A.F()).a().a(this.m / 2 + 4 + 100, 80, 50, 20, x, ($$0x, $$1x) -> this.A.e($$1x)));
      this.T = this.c((fik)fik.a(wz.b("0"), $$0x -> {
         this.A.a(dmm.a);
         this.D();
      }).a(this.m / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.U = this.c((fik)fik.a(wz.b("90"), $$0x -> {
         this.A.a(dmm.b);
         this.D();
      }).a(this.m / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.V = this.c((fik)fik.a(wz.b("180"), $$0x -> {
         this.A.a(dmm.c);
         this.D();
      }).a(this.m / 2 + 1 + 20, 185, 40, 20).a());
      this.W = this.c((fik)fik.a(wz.b("270"), $$0x -> {
         this.A.a(dmm.d);
         this.D();
      }).a(this.m / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.H = new fit(this.o, this.m / 2 - 152, 40, 300, 20, wz.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !fqf.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.H.f(128);
      this.H.a(this.A.c());
      this.d(this.H);
      jd $$0 = this.A.f();
      this.I = new fit(this.o, this.m / 2 - 152, 80, 80, 20, wz.c("structure_block.position.x"));
      this.I.f(15);
      this.I.a(Integer.toString($$0.u()));
      this.d(this.I);
      this.J = new fit(this.o, this.m / 2 - 72, 80, 80, 20, wz.c("structure_block.position.y"));
      this.J.f(15);
      this.J.a(Integer.toString($$0.v()));
      this.d(this.J);
      this.K = new fit(this.o, this.m / 2 + 8, 80, 80, 20, wz.c("structure_block.position.z"));
      this.K.f(15);
      this.K.a(Integer.toString($$0.w()));
      this.d(this.K);
      kh $$1 = this.A.j();
      this.L = new fit(this.o, this.m / 2 - 152, 120, 80, 20, wz.c("structure_block.size.x"));
      this.L.f(15);
      this.L.a(Integer.toString($$1.u()));
      this.d(this.L);
      this.M = new fit(this.o, this.m / 2 - 72, 120, 80, 20, wz.c("structure_block.size.y"));
      this.M.f(15);
      this.M.a(Integer.toString($$1.v()));
      this.d(this.M);
      this.N = new fit(this.o, this.m / 2 + 8, 120, 80, 20, wz.c("structure_block.size.z"));
      this.N.f(15);
      this.N.a(Integer.toString($$1.w()));
      this.d(this.N);
      this.O = new fit(this.o, this.m / 2 - 152, 120, 80, 20, wz.c("structure_block.integrity.integrity"));
      this.O.f(15);
      this.O.a(this.ac.format((double)this.A.x()));
      this.d(this.O);
      this.P = new fit(this.o, this.m / 2 - 72, 120, 80, 20, wz.c("structure_block.integrity.seed"));
      this.P.f(31);
      this.P.a(Long.toString(this.A.y()));
      this.d(this.P);
      this.Q = new fit(this.o, this.m / 2 - 152, 120, 240, 20, wz.c("structure_block.custom_data"));
      this.Q.f(128);
      this.Q.a(this.A.u());
      this.d(this.Q);
      this.D();
