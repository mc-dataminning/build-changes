public class fqf extends fhv<fqf.a> {
   static final alb a = new alb("transferable_list/select_highlighted");
   static final alb m = new alb("transferable_list/select");
   static final alb n = new alb("transferable_list/unselect_highlighted");
   static final alb o = new alb("transferable_list/unselect");
   static final alb p = new alb("transferable_list/move_up_highlighted");
   static final alb q = new alb("transferable_list/move_up");
   static final alb r = new alb("transferable_list/move_down_highlighted");
   static final alb s = new alb("transferable_list/move_down");
   static final xl u = xl.c("pack.incompatible");
   static final xl v = xl.c("pack.incompatible.confirm.title");
   private final xl w;
   final fqe x;

   public fqf(ffa $$0, fqe $$1, int $$2, int $$3, xl $$4) {
      super($$0, $$2, $$3, 33, 36);
      this.x = $$1;
      this.w = $$4;
      this.e = false;
   ...
   public static class a extends fhv.a<fqf.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final fqf e;
      protected final ffa a;
      private final fqd.a f;
      private final ayg g;
      private final fhs h;
      private final ayg i;
      private final fhs j;

      public a(ffa $$0, fqf $$1, fqd.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static ayg a(ffa $$0, xl $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fhs b(ffa $$0, xl $$1) {
         return fhs.a($$0.h, $$1, 157, 2);
      }
