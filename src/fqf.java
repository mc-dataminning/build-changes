...
public class fqf {
   public static class a implements fqx<ka> {
      ...
      public fqu a(ka $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqf.b $$8 = new fqf.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends fru {
      b(fnr $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends frg {
      ...
      c(fnr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fqw $$7, frp $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fqf.c $$0 = new fqf.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fqx<ka> {
      ...
      public fqu a(ka $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqf.c $$8 = new fqf.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, evh.O().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fqs {
      private int a;
      private final fqw b;
      private st D;
      private boolean E;

      public e(fnr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fqw $$7, @Nullable sn $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            ...
            fqu $$17 = this.b.a(jx.L, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fqf.c $$10 = (fqf.c)this.b.a(jx.C, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
