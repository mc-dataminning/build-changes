...
public class fqf extends fib<fqf.a> {
   ...
   private final fqc N;
   private final List<fqf.d> O = Lists.newArrayList();
   private final fqf.a P = new fqf.b();
   private final List<fqf.c> Q = Lists.newArrayList();

   public fqf(fqc $$0, ffg $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable fqf.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(fyl $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new fqf.d(this.N, $$0.a($$1)));
      }

      this.I();
   }

   public void a(List<gtg> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (gtg $$2 : $$0) {
         this.Q.add(new fqf.c(this.N, $$2));
      }

      this.I();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         fqf.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fib.a<fqf.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fqf.a {
      private final ffg a = ffg.Q();

      @Override
      public void a(fgs $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fqf.G, this.a.y.n / 2 - this.a.h.a(fqf.G) / 2, $$10, 16777215, false);
         String $$11 = fmp.a(ac.c());
   ...
   public static class c extends fqf.a {
   ...
   public class d extends fqf.a {
      ...
      protected d(final fqc $$1, final fyk $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = ffg.Q();
         this.j = fmi.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fgs $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            fqf.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == aa.b().e() ? fyk.b.e : fyk.b.d);
         ...
         xp $$15 = (xp)(this.i.g() == fyk.b.d ? this.i.h.f().a(n.m) : this.i.c);
      ...
      protected void a(fgs $$0, int $$1, int $$2, alf $$3) {
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fqf.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fqf.this.r();
         double $$4 = $$1 - (double)fqf.this.g(fqf.this.aD_().indexOf(this));
         if ($$3 <= 32.0) {
