...
public class dxd extends dxb {
   ...
   private final bjf i;
   private final il<cwp> j;

   public dxd(int $$0, int $$1, int $$2, bjf $$3, float $$4, bjf $$5, il<cwp> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<dvj.a> a(ctu $$0, BiConsumer<hx, djg> $$1, auu $$2, int $$3, hx $$4, dut $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new dvj.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(ctu $$0, BiConsumer<hx, djg> $$1, auu $$2, int $$3, dut $$4, List<dvj.a> $$5, hx.a $$6, int $$7, ic $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new dvj.a($$16, 0, false));
         $$5.add(new dvj.a($$16.c(2), 0, false));
      }
   }
