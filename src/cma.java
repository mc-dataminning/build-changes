...
public class cma {
   private static final Codec<cja> c = arg.a(
      jd.i.q(),
   ...
   public static final Codec<cjf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(c.fieldOf("item").forGetter(cjf::d), arg.a(arg.j, "count", Integer.valueOf(1)).forGetter(cjf::L)).apply($$0, cjf::new)
   );
   static final Codec<cjf> b = arg.<cja>a(
         jd.i.q(),
