...
public class cma {
   ...
   public void a(arf $$0, Predicate<bsu> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsu>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsu> $$6 = (Entry<bsu>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsu $$8 = (bsu)$$6.getKey();
         bsu.c $$9 = $$8.dL();
   ...
   public int b(@Nullable bsu $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btp> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btp).map($$0 -> (btp)$$0);
   }

   @VisibleForTesting
   protected static record a(cma a) implements Comparator<bsu> {
      public int a(bsu $$0, bsu $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
