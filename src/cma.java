...
public class cma {
   ...
   public boolean a(cxu<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cxu<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cma.a($$0).a($$2, $$1);
   }

   public int a(cxw<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cxw<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cma.a($$0.b()).b($$1, $$2);
   }

   public static cto a(int $$0) {
      return $$0 == 0 ? cto.i : new cto(ctj.b($$0));
   }
   ...
   class a {
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cma.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
