   ...
   public void a(ftz $$0) {
      if (this.e != null) {
         ...
         $$0.a($$4x -> {
            ...
            for (brf $$6x : $$1) {
               int $$7x = azq.a($$6x.a / 4.0) + 1;
               flt $$8x = $$4x.getBuffer(gsn.B());
               int $$9x = aya.f($$6x.a());
               int $$10x = aya.a($$9x, -8355712);
               flq.a $$11x = $$0.c().c();
