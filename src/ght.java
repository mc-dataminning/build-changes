...
public class ght {
   ...
   private ght(int $$0, List<ghv> $$1) {
      this.a = $$1.toArray(ghv[]::new);
      this.b = $$1.size();
   }

   private List<ghv> c() {
      List<ghv> $$0 = new ArrayList<>(this.d());
