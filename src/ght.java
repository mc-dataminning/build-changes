...
public class ght implements ghw.a, AutoCloseable {
   ...
   ese[] f;
   @Nullable
   private final ght.a g;
   private final ash h;

   public ght(ajc $$0, gjl $$1, ese $$2, ash $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gjj $$4 = $$3.a(gjj.a).orElse(gjj.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ese[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gho.a(this.f, $$0);
   ...
   @Nullable
   private ght.a a(gjl $$0, int $$1, int $$2, gjj $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<ght.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new ght.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new ght.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<ght.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            ght.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new ght.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ese[] $$4) {
   ...
   class a {
      ...
      a(List<ght.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * ght.this.c;
         int $$4 = this.b($$2) * ght.this.d;
         ght.this.a($$0, $$1, $$3, $$4, ght.this.f);
      }

      public ghv a() {
         return ght.this.new d(this, this.d ? ght.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ese[] b = new ese[ght.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = ght.this.c >> $$0;
            int $$2 = ght.this.d >> $$0;
            this.b[$$0] = new ese($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, ght.d $$2) {
         ght.a $$3 = $$2.d;
         List<ght.b> $$4 = $$3.b;
         ght.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            ght.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(ght.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return ght.this.f[$$2].a($$3 + ($$0.a($$1) * ght.this.c >> $$2), $$4 + ($$0.b($$1) * ght.this.d >> $$2));
      }
   ...
   class d implements ghv {
      int b;
      int c;
      final ght.a d;
      @Nullable
      private final ght.c e;

      d(ght.a $$0, @Nullable ght.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
