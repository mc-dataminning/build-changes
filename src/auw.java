...
public class auw extends DataFix {
         ...
         ImmutableMap.of(
            ...
            a(
               ...
               DSL.taggedChoiceType(
                  ...
                  ImmutableMap.of(
                     "minecraft:fixed",
                     a("biome", $$0.getType(avw.z)),
                     "minecraft:multi_noise",
                     DSL.list(a("biome", $$0.getType(avw.z))),
                     "minecraft:checkerboard",
                     a("biomes", DSL.list($$0.getType(avw.z))),
               ...
               "settings",
               DSL.or(DSL.string(), a("default_block", $$0.getType(avw.r), "default_fluid", $$0.getType(avw.r)))
            )
         )
      );
      CompoundListType<String, ?> $$2 = DSL.compoundList(axd.a(), a("generator", $$1));
   ...
   protected static Type<? extends Pair<? extends Either<? extends Pair<? extends Either<?, Unit>, ? extends Pair<? extends Either<? extends List<? extends Pair<? extends Either<?, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>> a(
      ...
      return b("settings", a("biome", $$0.getType(avw.z), "layers", DSL.list(b("block", $$0.getType(avw.r)))));
   }
