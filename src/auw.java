...
public class auw<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return auw.this.get(this.b--);
      }

      @Override
      public void remove() {
         auw.this.remove(this.b + 1);
      }
   }
}
