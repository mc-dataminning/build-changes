...
public class auw extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(baa.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(baa.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(baa.s);
