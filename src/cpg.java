...
public abstract class cpg {
   ...
   private final jj<cuh> l = jj.a();
   public final jj<cre> i = jj.a();
   private final List<cpy> m = Lists.newArrayList();
   private cuh n = cuh.i;
   private final jj<cuh> o = jj.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cre> v = Sets.newHashSet();
   private final List<cps> w = Lists.newArrayList();
   @Nullable
   private cpt x;
   private boolean y;

   protected cpg(@Nullable cqo<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cpr $$0, cly $$1, dfc $$2) {
   ...
   protected static void a(bpt $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cpq $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cuh $$1 = this.i.get($$0).g();
         Supplier<cuh> $$2 = Suppliers.memoize($$1::r);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cuh $$1, Supplier<cuh> $$2) {
      cuh $$3 = this.l.get($$0);
      if (!cuh.a($$3, $$1)) {
         cuh $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cuh $$1, Supplier<cuh> $$2) {
      if (!this.y) {
         cuh $$3 = this.o.get($$0);
         if (!cuh.a($$3, $$1)) {
            cuh $$4 = $$2.get();
   ...
   public abstract cuh a(cly var1, int var2);

   public void a(int $$0, int $$1, cpp $$2, cly $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
      } catch (Exception var8) {
         o $$5 = o.a(var8, "Container click");
         p $$6 = $$5.a("Click info");
         $$6.a("Menu Type", () -> this.s != null ? lh.r.b(this.s).toString() : "<no type>");
   ...
   private void b(int $$0, int $$1, cpp $$2, cly $$3) {
      clx $$4 = $$3.gl();
      if ($$2 == cpp.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cpp.a || $$2 == cpp.b) && ($$1 == 0 || $$1 == 1)) {
         cpo $$16 = $$1 == 0 ? cpo.a : cpo.b;
         if ($$0 == -999) {
            if (!this.g().d()) {
               if ($$16 == cpo.a) {
                  $$3.a(this.g(), true);
            ...
            cuh $$20 = $$19.g();
            if ($$20.b(ke.ah)) {
               $$20.b(ke.ah, Integer.valueOf($$20.a(ke.ah, Integer.valueOf(0)) + 1));
            }
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.d()) {
                  if (!$$21.d()) {
                     int $$22 = $$16 == cpo.a ? $$21.G() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.d()) {
                     int $$23 = $$16 == cpo.a ? $$20.G() : ($$20.G() + 1) / 2;
                     Optional<cuh> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cuh> $$26 = $$19.a($$20.G(), $$21.i() - $$21.G(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.G());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cpp.d && $$3.fY() && this.g().d() && $$0 >= 0) {
         cre $$32 = this.i.get($$0);
         if ($$32.h()) {
            cuh $$33 = $$32.g();
            this.b($$33.c($$33.i()));
         }
      } else if ($$2 == cpp.e && this.g().d() && $$0 >= 0) {
         cre $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().G();
         cuh $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cpp.g && $$0 >= 0) {
         cre $$37 = this.i.get($$0);
         cuh $$38 = this.g();
         if (!$$38.d() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.G() < $$38.i(); $$42 += $$40) {
                  cre $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cuh $$44 = $$43.g();
                     if ($$41 != 0 || $$44.G() != $$44.i()) {
                        cuh $$45 = $$43.b($$44.G(), $$38.i() - $$38.G(), $$3);
                        $$38.g($$45.G());
                     }
                  }
               }
   ...
   private boolean a(cly $$0, cpo $$1, cre $$2, cuh $$3, cuh $$4) {
      cop $$5 = $$0.dU().K();
   ...
   public void a(int $$0, int $$1, cuh $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cuh> $$1, cuh $$2) {
   ...
   protected boolean a(cuh $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(@Nullable cre $$0, cuh $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cuh.c($$1, $$0.g()) ? $$0.g().G() + ($$2 ? 0 : $$1.G()) <= $$1.i() : $$3;
   }

   public static int a(Set<cre> $$0, int $$1, cuh $$2) {
      return switch ($$1) {
         case 0 -> aym.d((float)$$2.G() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.i();
         default -> $$2.G();
      };
   ...
   public static int a(@Nullable dqc $$0) {
      return $$0 instanceof bpt ? b((bpt)$$0) : 0;
   }

   public static int b(@Nullable bpt $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cpg $$0) {
      Table<bpt, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bpt $$0, int $$1) {
