...
public class cpg extends cou {
   private static final byte c = 10;
   private int d = -1;

   public cpg(btb<? extends cpg> $$0, dbz $$1) {
      super($$0, $$1);
   }

   public cpg(dbz $$0, double $$1, double $$2, double $$3) {
      super(btb.bd, $$0, $$1, $$2, $$3);
   }
   ...
   public boolean a(bro $$0, float $$1) {
      if ($$0.c() instanceof cne $$3 && $$3.bQ()) {
         bro $$4 = this.dQ().d(this, $$0.d());
         this.a($$4, $$3.ds().g());
      }
   ...
   protected void a(@Nullable bro $$0, double $$1) {
      if (!this.dP().B) {
         ...
         this.dP().a(this, $$0, null, this.du(), this.dw(), this.dA(), (float)(4.0 + this.ah.j() * 1.5 * $$2), false, dbz.a.d);
         this.ao();
      }
   }
   ...
   private static boolean e(bro $$0) {
