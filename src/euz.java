...
public abstract class euz<E extends euz.a<E>> extends ewx implements ewh, eyv {
   protected static final int b = 6;
   private static final agm a = new agm("widget/scroller");
   protected final eti c;
   protected final int d;
   private final List<E> m = new euz.b();
   protected int e;
   protected int f;
   protected int g;
   protected int h;
   ...
   public euz(eti $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected final E a(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = atq.a($$1 - (double)this.g) - this.l + (int)this.l() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void a(eut $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.r) {
         ...
         int $$4 = 32;
         $$0.a(faz.d, this.j, this.g, (float)this.i, (float)(this.h + (int)this.l()), this.i - this.j, this.h - this.g, 32, 32);
      ...
      if (this.r) {
         int $$7 = 4;
         $$0.a(frh.C(), this.j, this.g, this.i, this.g + 4, -16777216, 0, 0);
         $$0.a(frh.C(), this.j, this.h - 4, this.i, this.h, 0, -16777216, 0);
      }
      ...
      if ($$8 > 0) {
         ...
         $$10 = atq.a($$10, 32, this.h - this.g - 8);
   ...
   public void a(double $$0) {
      this.n = atq.a($$0, 0.0, (double)this.m());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.g) {
            ...
            int $$6 = this.h - this.g;
            int $$7 = atq.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(ezf $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.f());
   }

   @Nullable
   protected E a(ezf $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(eut $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public eyv.a q() {
      if (this.aK_()) {
         ...
         return this.t != null ? eyv.a.b : eyv.a.a;
      }
   }
   ...
   protected void a(eyx $$0, E $$1) {
      List<E> $$2 = this.i();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(eyw.b, uv.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
   ...
   @Override
   public ezh s() {
      return new ezh(this.j, this.g, this.i - this.j, this.h - this.g);
   }

   protected abstract static class a<E extends euz.a<E>> implements ewz {
      @Deprecated
      euz<E> a;
      ...
      public abstract void a(eut var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
