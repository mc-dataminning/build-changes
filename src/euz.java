...
public class euz implements eux {
   ...
   public eux.a a(esf $$0, euy $$1, long $$2) {
      ...
      if (this.o) {
         $$0.a(3, 28, 157, 29, -1);
         float $$3 = arw.b(this.m, this.n, (float)($$2 - this.l) / 100.0F);
         int $$4;
         if (this.n >= this.m) {
            $$4 = -16755456;
         } else {
   ...
   public static enum a {
      a(new aew("toast/movement_keys")),
      b(new aew("toast/mouse")),
      c(new aew("toast/tree")),
      d(new aew("toast/recipe_book")),
      e(new aew("toast/wooden_planks")),
      f(new aew("toast/social_interactions")),
      g(new aew("toast/right_click"));
