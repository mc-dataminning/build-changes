...
public class euz {
   ...
   private void a(n $$0, vd $$1) {
      this.b.l.d().a(vd.i().b(vd.c("debug.prefix").a($$0, n.r)).b(vc.u).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(vd.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((ctf)MoreObjects.firstNonNull(this.b.q.k(), ctf.b)).b());
               }
            ...
            case 81:
               ...
               ewz $$3 = this.b.l.d();
               $$3.a(vd.c("debug.reload_chunks.help"));
               $$3.a(vd.c("debug.show_hitboxes.help"));
               $$3.a(vd.c("debug.copy_location.help"));
               $$3.a(vd.c("debug.clear_chat.help"));
               $$3.a(vd.c("debug.chunk_boundaries.help"));
               $$3.a(vd.c("debug.advanced_tooltips.help"));
               $$3.a(vd.c("debug.inspect.help"));
               $$3.a(vd.c("debug.profiling.help"));
               $$3.a(vd.c("debug.creative_spectator.help"));
               $$3.a(vd.c("debug.pause_focus.help"));
               $$3.a(vd.c("debug.help.help"));
               $$3.a(vd.c("debug.dump_dynamic_textures.help"));
               $$3.a(vd.c("debug.reload_resourcepacks.help"));
               $$3.a(vd.c("debug.pause.help"));
               $$3.a(vd.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.X().a($$5);
               vd $$6 = vd.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new vb(vb.a.b, $$5.toFile().toString())));
            ...
            case b:
               ...
               if ($$0) {
                  if ($$1) {
                     ...
                     dgo $$5 = this.b.s.dM().c_($$3);
                     sl $$6 = $$5 != null ? $$5.q() : null;
                     this.a($$4, $$3, $$6);
   ...
   private void a(dja $$0, hx $$1, @Nullable sl $$2) {
   ...
   private void a(ahd $$0, elm $$1, @Nullable sl $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = ta.c((ti)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aL().i()) {
         boolean $$5 = eoo.a(eva.N().aL().i(), 292);
         if (this.d > 0L) {
            if (!eoo.a(eva.N().aL().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eoo.a(eva.N().aL().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fdn) || ((fdn)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aL().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               evl.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aU().a() && this.b.m.s().c()) {
            boolean $$7 = $$6 == null || !($$6.aH_() instanceof exh) || !((exh)$$6.aH_()).d();
            if ($$3 != 0 && $$1 == 66 && fct.r() && $$7) {
               boolean $$8 = this.b.m.ap().c() == evc.a;
               this.b.m.ap().a(evc.a(this.b.m.ap().c().a() + 1));
               this.b.m.as();
               if ($$6 instanceof fcv) {
                  ((fcv)$$6).n();
               }
         ...
         if (this.b.y == null || this.b.y instanceof fco $$10 && !$$10.n()) {
            eoo.a $$11 = eoo.a($$1, $$2);
            if ($$3 == 0) {
               euy.a($$11, false);
               if ($$1 == 292) {
      ...
      if ($$0 == this.b.aL().i()) {
         ...
         if ($$3 != null && this.b.aI() == null) {
            if (Character.charCount($$1) == 1) {
               fct.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fct.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", aui.f((float)$$1 / 1000.0F));
            }
