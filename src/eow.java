...
public class eow extends gew {
   ...
   private static final ti C = ti.c("mco.upload.verifying");
   private final eop D;
   private final ecc E;
   ...
   @Nullable
   private volatile ti[] J;
   private volatile ti K = ti.c("mco.upload.preparing");
   ...
   public eow(long $$0, int $$1, eop $$2, ecc $$3) {
      super(eqi.a);
      this.F = $$0;
      this.G = $$1;
      this.D = $$2;
   ...
   @Override
   public void aD_() {
      this.Q = this.d(esl.a(th.k, $$0 -> this.C()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.Q.j = false;
      this.R = this.d(esl.a(th.e, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.P) {
         if (this.D.b == -1) {
            this.F();
         } else {
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.K = ti.c("mco.upload.close.failure");
                  } else {
                     enf $$3 = null;
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.M) {
                              ...
                              this.K = ti.a("mco.upload.uploading", this.E.b());
                              ely $$11 = new ely($$0, this.F, this.G, $$3, this.f.V(), aa.b().c(), this.H);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    this.N = true;
                                    this.K = ti.c("mco.upload.done");
                                    this.Q.b(th.d);
                                    epj.b($$2);
                                 } else if ($$1x.a == 400 && $$1x.b != null) {
                                    this.a(ti.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(ti.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              elw $$8 = elw.a($$7);
                              elw $$9 = elw.a(5368709120L);
                              if (elw.b($$7, $$8).equals(elw.b(5368709120L, $$9)) && $$8 != elw.a) {
                                 elw $$10 = elw.values()[$$8.ordinal() - 1];
                                 this.a(
                                    ti.a("mco.upload.size.failure.line1", this.E.b()),
                                    ti.a("mco.upload.size.failure.line2", elw.b($$7, $$10), elw.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    ti.a("mco.upload.size.failure.line1", this.E.b()),
                                    ti.a("mco.upload.size.failure.line2", elw.b($$7, $$8), elw.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(ti.a("mco.upload.failed", var21.getMessage()));
               } catch (enn var22) {
                  this.a(ti.a("mco.upload.failed", var22.a.b()));
   ...
   private void G() {
      this.K = ti.c("mco.upload.cancelled");
