...
public class eow {
   ...
   private static final dsc.f e = ($$0, $$1, $$2) -> $$0.a(dfc.co);
   ...
   public static Optional<eow> a(dca $$0, iz $$1, je.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<eow> a(dca $$0, iz $$1, Predicate<eow> $$2, je.a $$3) {
      Optional<eow> $$4 = Optional.of(new eow($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         je.a $$5 = $$3 == je.a.a ? je.a.c : je.a.a;
         return Optional.of(new eow($$0, $$1, $$5)).filter($$2);
      }
   }

   public eow(dca $$0, iz $$1, je.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dsd $$0) {
      return $$0.i() || $$0.a(awp.aK) || $$0.a(dfc.ed);
   }
   ...
   public static evs a(l.a $$0, je.a $$1, evs $$2, bsy $$3) {
      ...
      return new evs($$8, $$11, $$14);
   }

   public static eov a(arf $$0, l.a $$1, je.a $$2, evs $$3, bsv $$4, evs $$5, float $$6, float $$7) {
      iz $$8 = $$1.a;
      dsd $$9 = $$0.a_($$8);
      je.a $$10 = $$9.d(dst.H).orElse(je.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      bsy $$13 = $$4.a($$4.ar());
      int $$14 = $$2 == $$10 ? 0 : 90;
      evs $$15 = $$2 == $$10 ? $$5 : new evs($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == je.a.a;
      evs $$20 = new evs((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      evs $$21 = a($$20, $$0, $$4, $$13);
      return new eov($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static evs a(evs $$0, arf $$1, bsv $$2, bsy $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         evs $$5 = $$0.b(0.0, $$4, 0.0);
         ewl $$6 = ewi.a(evn.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<evs> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<evs> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
