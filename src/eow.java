...
public class eow extends gfb {
   ...
   static final aew b = new aew("widget/slot_frame");
   ...
   class a extends etm.a<eow.a> {
      private static final euc c = new euc(new aew("icon/link"), new aew("icon/link_highlighted"));
      private static final euc d = new euc(new aew("icon/video_link"), new aew("icon/video_link_highlighted"));
