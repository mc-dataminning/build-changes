...
public class eow {
   ...
   static class b {
      static final Optional<eow> a = Optional.ofNullable(a());
      ...
      private static eow a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new eow();
      }
   }
}
