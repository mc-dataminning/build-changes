...
public class eow {
   ...
   public static final eow.a bv;

   public static eow.a a(int $$0, int $$1) {
      return $$0 == -1 ? eow.b.b.a($$1) : eow.b.a.a($$0);
   }

   public static eow.a a(String $$0) {
      if (eow.a.e.containsKey($$0)) {
         return eow.a.e.get($$0);
      } else {
         for (eow.b $$1 : eow.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eow.b b;
      private final int c;
      private final auj<vf> d;
      static final Map<String, eow.a> e = Maps.newHashMap();

      a(String $$0, eow.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new auj<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eow.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vf> g;

      private static void a(eow.b $$0, String $$1, int $$2) {
         eow.a $$3 = new eow.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eow.a a(int $$0) {
         return (eow.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
