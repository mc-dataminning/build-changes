...
public abstract class bvb extends bwo {
   private static final alc<Boolean> bZ = alg.a(bvb.class, ale.k);
   ...
   protected bvb(bvr<? extends bvb> $$0, dhi $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bvb a(ash var1, bvb var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dl() instanceof cru $$0 && !$$0.b((bvk)this)) {
         this.ae();
      }
   }
