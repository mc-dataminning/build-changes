...
public class bvb extends buk implements bue, bwe {
   ...
   private static final ajy<Float> b = akc.a(bvb.class, aka.d);
   private static final ajy<Float> c = akc.a(bvb.class, aka.d);
   private static final ajy<Boolean> d = akc.a(bvb.class, aka.k);
   ...
   public boolean v(buk $$0) {
      if ($$0 instanceof cow $$1) {
         this.j = new bvb.a($$1.cG(), this.dV().ad());
   ...
   public bsj a(cow $$0, bsi $$1) {
      if (this.dV().C) {
         ...
         this.k = new bvb.a($$0.cG(), this.dV().ad());
         return bsj.c;
      }
   }
