...
public record bqw(Instant a, String b, long c) {
   ...
   public static bqw a(RecordedEvent $$0) {
      ...
      return new bqw($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bqw.a a(List<bqw> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bqw>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bqw $$3 = (bqw)$$2x.get(0);
            bqw $$4 = (bqw)$$2x.get($$2x.size() - 1);
