...
public class bqw extends brd {
   public static final MapCodec<bqw> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  brd.c.fieldOf("source").forGetter($$0x -> $$0x.b),
   ...
   public static bqw a(brd $$0, int $$1, int $$2) {
      return new bqw($$0, $$1, $$2);
   }

   public bqw(brd $$0, int $$1, int $$2) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Override
   public int a(azr $$0) {
      return azj.a(this.b.a($$0), this.f, this.g);
   }
