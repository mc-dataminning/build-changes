...
public class bqw extends eox {
   ...
   public static eox.a<bqw> a(long $$0) {
      return new eox.a<>(() -> new bqw($$0), ($$1, $$2) -> a($$0, $$1), bab.m);
   }
   ...
   public azc a(alb $$0) {
      azc $$1 = this.f.computeIfAbsent($$0, this::c).a();
      return new bqw.a($$1);
   }
   ...
   private bqv b(alb $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new bqv($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<alb, bqv> $$0) {
      this.f.forEach($$0);
   }
   ...
   public ur a(ur $$0, jk.a $$1) {
      ...
      ur $$2 = new ur();
      this.f.forEach(($$1x, $$2x) -> $$2.a($$1x.toString(), (vo)bqv.a.encodeStart(vf.a, $$2x).result().orElseThrow()));
      $$0.a("sequences", $$2);
      return $$0;
   }
   ...
   public static bqw a(long $$0, ur $$1) {
      bqw $$2 = new bqw($$0);
      ...
      for (String $$5 : $$3.e()) {
         try {
            bqv $$6 = (bqv)((Pair)bqv.a.decode(vf.a, $$3.c($$5)).result().get()).getFirst();
            $$2.f.put(new alb($$5), $$6);
   ...
   class a implements azc {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return $$0 instanceof bqw.a $$1 ? this.c.equals($$1.c) : false;
         }
      }
   }
}
