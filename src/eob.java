...
public class eob {
   ...
   public static final Codec<eob> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> af.a($$0, 6).map($$0x -> new eob($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public static eob a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jn $$9) {
      switch ($$9) {
         case d:
         default:
   ...
   public static Optional<eob> a(Iterable<ji> $$0) {
