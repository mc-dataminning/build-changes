...
public class eob {
   ...
   static class a implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         return $$0.c[jl.f.d()] && !$$0.b[jl.f.d()].d;
      }

      @Override
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         $$1.d = true;
         $$1.b[jl.f.d()].d = true;
         return new eob.k($$0, $$1);
      }
   }

   static class b implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         if ($$0.c[jl.f.d()] && !$$0.b[jl.f.d()].d && $$0.c[jl.b.d()] && !$$0.b[jl.b.d()].d) {
            eob.v $$1 = $$0.b[jl.f.d()];
            return $$1.c[jl.b.d()] && !$$1.b[jl.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         ...
         $$1.b[jl.f.d()].d = true;
         $$1.b[jl.b.d()].d = true;
         $$1.b[jl.f.d()].b[jl.b.d()].d = true;
         return new eob.l($$0, $$1);
      }
   }

   static class c implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         return $$0.c[jl.b.d()] && !$$0.b[jl.b.d()].d;
      }
      ...
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         $$1.d = true;
         $$1.b[jl.b.d()].d = true;
         return new eob.m($$0, $$1);
      }
   }

   static class d implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         if ($$0.c[jl.c.d()] && !$$0.b[jl.c.d()].d && $$0.c[jl.b.d()] && !$$0.b[jl.b.d()].d) {
            eob.v $$1 = $$0.b[jl.c.d()];
            return $$1.c[jl.b.d()] && !$$1.b[jl.b.d()].d;
         } else {
            return false;
      ...
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         ...
         $$1.b[jl.c.d()].d = true;
         $$1.b[jl.b.d()].d = true;
         $$1.b[jl.c.d()].b[jl.b.d()].d = true;
         return new eob.n($$0, $$1);
      }
   }

   static class e implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         return $$0.c[jl.c.d()] && !$$0.b[jl.c.d()].d;
      }

      @Override
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         eob.v $$3 = $$1;
         if (!$$1.c[jl.c.d()] || $$1.b[jl.c.d()].d) {
            $$3 = $$1.b[jl.d.d()];
         }

         $$3.d = true;
         $$3.b[jl.c.d()].d = true;
         return new eob.o($$0, $$3);
      }
   }

   static class f implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         return true;
      }
      ...
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         $$1.d = true;
         return new eob.s($$0, $$1, $$2);
      }
   }

   static class g implements eob.i {
      @Override
      public boolean a(eob.v $$0) {
         return !$$0.c[jl.e.d()] && !$$0.c[jl.f.d()] && !$$0.c[jl.c.d()] && !$$0.c[jl.d.d()] && !$$0.c[jl.b.d()];
      }

      @Override
      public eob.r a(jl $$0, eob.v $$1, azr $$2) {
         $$1.d = true;
         return new eob.t($$0, $$1);
      }
   }

   public static class h extends eob.r {
      ...
      private eob.v G;
      private eob.v H;
      private final List<eob.r> I = Lists.newArrayList();

      public h(azr $$0, int $$1, int $$2, jl $$3) {
         super(emi.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eob.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eob.p($$3, this.G));
         this.I.add(new eob.j($$3, this.H));
         List<eob.i> $$5 = Lists.newArrayList();
         $$5.add(new eob.b());
         $$5.add(new eob.d());
         $$5.add(new eob.e());
         $$5.add(new eob.a());
         ...
         elj $$10 = elj.a(this.b(1, 1, 1), this.b(23, 8, 21));
         elj $$11 = elj.a(this.b(34, 1, 1), this.b(56, 8, 21));
         elj $$12 = elj.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eob.u($$3, $$10, $$13++));
         this.I.add(new eob.u($$3, $$11, $$13++));
         this.I.add(new eob.q($$3, $$12));
      }
      ...
      private List<eob.v> b(azr $$0) {
         eob.v[] $$1 = new eob.v[75];
         ...
         eob.v $$23 = new eob.v(1003);
         eob.v $$24 = new eob.v(1001);
         eob.v $$25 = new eob.v(1002);
         $$1[v].a(jl.b, $$23);
         $$1[w].a(jl.d, $$24);
         $$1[x].a(jl.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jl.f.d()].d = true;
         this.H.b[jl.c.d()].d = true;
         this.H.b[jl.f.d()].b[jl.c.d()].d = true;
         this.H.b[jl.b.d()].d = true;
         this.H.b[jl.f.d()].b[jl.b.d()].d = true;
         this.H.b[jl.c.d()].b[jl.b.d()].d = true;
         this.H.b[jl.f.d()].b[jl.c.d()].b[jl.b.d()].d = true;
         ObjectArrayList<eob.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dfs $$2, azr $$3, elj $$4) {
         int $$5 = 24;
      ...
      private void a(dfs $$0, azr $$1, elj $$2) {
      ...
      private void b(dfs $$0, azr $$1, elj $$2) {
      ...
      private void c(dfs $$0, azr $$1, elj $$2) {
      ...
      private void d(dfs $$0, azr $$1, elj $$2) {
      ...
      private void e(dfs $$0, azr $$1, elj $$2) {
      ...
      private void f(dfs $$0, azr $$1, elj $$2) {
   ...
   interface i {
      boolean a(eob.v var1);

      eob.r a(jl var1, eob.v var2, azr var3);
   }

   public static class j extends eob.r {
      public j(jl $$0, eob.v $$1) {
         super(emi.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dfs $$0, dfq $$1, dxa $$2, azr $$3, elj $$4, deb $$5, jg $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dia.ch.m(), dia.ch.m(), false);
   ...
   public static class k extends eob.r {
      public k(jl $$0, eob.v $$1) {
         super(emi.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dfs $$0, dfq $$1, dxa $$2, azr $$3, elj $$4, deb $$5, jg $$6) {
         eob.v $$7 = this.B.b[jl.f.d()];
         eob.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jl.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jl.a.d()]);
         }
   ...
   public static class l extends eob.r {
      public l(jl $$0, eob.v $$1) {
         super(emi.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eob.r {
      public m(jl $$0, eob.v $$1) {
         super(emi.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dfs $$0, dfq $$1, dxa $$2, azr $$3, elj $$4, deb $$5, jg $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jl.a.d()]);
         }

         eob.v $$7 = this.B.b[jl.b.d()];
         if ($$7.b[jl.b.d()] == null) {
   ...
   public static class n extends eob.r {
      public n(jl $$0, eob.v $$1) {
         super(emi.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dfs $$0, dfq $$1, dxa $$2, azr $$3, elj $$4, deb $$5, jg $$6) {
         eob.v $$7 = this.B.b[jl.c.d()];
         eob.v $$8 = this.B;
         eob.v $$9 = $$7.b[jl.b.d()];
         eob.v $$10 = $$8.b[jl.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jl.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jl.a.d()]);
         }
   ...
   public static class o extends eob.r {
      public o(jl $$0, eob.v $$1) {
         super(emi.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eob.r {
      public p(jl $$0, eob.v $$1) {
         super(emi.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eob.r {
      public q(jl $$0, elj $$1) {
         super(emi.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends elv {
      protected static final dvd b = dia.hZ.m();
      protected static final dvd c = dia.ia.m();
      protected static final dvd d = dia.ib.m();
      protected static final dvd h = c;
      protected static final dvd i = dia.ii.m();
      protected static final boolean j = true;
      protected static final dvd k = dia.G.m();
      protected static final Set<dhy> l = ImmutableSet.builder().add(dia.dO).add(dia.iC).add(dia.mW).add(k.b()).build();
      ...
      public r(emi $$0, jl $$1, int $$2, elj $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(emi $$0, int $$1, jl $$2, eob.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static elj a(jl $$0, eob.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         elj $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dfs $$0, elj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dvd $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dfs $$0, elj $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dfs $$0, elj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dvd $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(elj $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dfs $$0, elj $$1, int $$2, int $$3, int $$4) {
         jg $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            clb $$6 = bug.D.a($$0.E(), buf.d);
            if ($$6 != null) {
               $$6.c($$6.eV());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dx()), buf.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eob.r {
      private int a;

      public s(jl $$0, eob.v $$1, azr $$2) {
         super(emi.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dfs $$0, dfq $$1, dxa $$2, azr $$3, elj $$4, deb $$5, jg $$6) {
         ...
         if (this.B.b[jl.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jl.a.d()] && !this.B.c[jl.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eob.r {
      public t(jl $$0, eob.v $$1) {
         super(emi.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eob.r {
      private int a;

      public u(jl $$0, elj $$1, int $$2) {
         super(emi.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
