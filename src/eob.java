...
public class eob {
   ...
   private final eob.a g;

   @Deprecated
   public static eob a(ayv $$0, eob.a $$1) {
      return new eob($$0, $$1, false);
   }

   public static eob a(ayv $$0, int $$1, double... $$2) {
      return b($$0, new eob.a($$1, new DoubleArrayList($$2)));
   }

   public static eob b(ayv $$0, eob.a $$1) {
      return new eob($$0, $$1, true);
   }

   private eob(ayv $$0, eob.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eob.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eob.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eob.a::b))
               .apply($$0, eob.a::new)
      );
      public static final Codec<jm<eob.a>> b = akm.a(lu.aP, a);
