...
public class gfn {
   ...
   public void a(dgx $$0, @Nullable dgx $$1) {
      this.j = $$0;
      this.k = $$1;
   ...
   public boolean a(jh $$0) {
      if (this.b.t.a(this.b.s, $$0, this.j)) {
         ...
         if (!this.b.t.eX().h().a($$2, $$1, $$0, this.b.t)) {
            ...
            dke $$3 = $$2.b();
            if ($$3 instanceof dnn && !this.b.t.gE()) {
               return false;
            } else if ($$2.l()) {
               return false;
            } else {
               $$3.a($$1, $$0, $$2, (cps)this.b.t);
               etp $$4 = $$1.b_($$0);
   ...
   public boolean b(jh $$0, jm $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.l()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               dru $$4 = $$3.A();
               this.b.ak().a(new hew($$4.f(), axg.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, hfb.t(), $$0));
            }
   ...
   private boolean b(jh $$0) {
      cxk $$1 = this.b.t.eX();
      return $$0.equals(this.d) && cxk.c($$1, this.e);
   }
   ...
   public bte a(gka $$0, btd $$1, fbo $$2) {
      this.m();
      if (!this.b.s.F_().a($$2.b())) {
         return bte.d;
      } else {
         MutableObject<bte> $$3 = new MutableObject();
         this.a(this.b.s, $$4 -> {
            $$3.setValue(this.b($$0, $$1, $$2));
            return new ajk($$1, $$2, $$4);
         });
         return (bte)$$3.getValue();
      }
   }

   private bte b(gka $$0, btd $$1, fbo $$2) {
      jh $$3 = $$2.b();
      cxk $$4 = $$0.b($$1);
      if (this.j == dgx.d) {
         return bte.c;
         ...
         if (!$$6) {
            ...
            bte $$8 = $$7.a($$0.b($$1), this.b.s, $$0, $$1, $$2);
            if ($$8.a()) {
               return $$8;
            }

            if ($$8 instanceof bte.f && $$1 == btd.a) {
               bte $$9 = $$7.a(this.b.s, $$0, $$2);
               if ($$9.a()) {
                  return $$9;
               }
            }
   ...
   public bte a(cps $$0, btd $$1) {
      if (this.j == dgx.d) {
         ...
         this.m();
         MutableObject<bte> $$2 = new MutableObject();
         this.a(this.b.s, $$3 -> {
            ...
            if ($$0.gC().a($$5)) {
               ...
               bte $$6 = $$5.a(this.b.s, $$0, $$1);
               cxk $$8;
               if ($$6 instanceof bte.d $$7) {
         ...
         return (bte)$$2.getValue();
      }
   }

   public gka a(gfd $$0, axq $$1, flk $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public gka a(gfd $$0, axq $$1, flk $$2, boolean $$3, boolean $$4) {
      return new gka(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }

   public void a(cps $$0, bvf $$1) {
      this.m();
   ...
   public bte a(cps $$0, bvf $$1, btd $$2) {
      this.m();
      this.c.b(aii.a($$1, $$0.cd(), $$2));
      return (bte)(this.j == dgx.d ? bte.e : $$0.a($$1, $$2));
   }

   public bte a(cps $$0, bvf $$1, fbp $$2, btd $$3) {
      this.m();
      fbs $$4 = $$2.g().a($$1.dA(), $$1.dC(), $$1.dG());
      this.c.b(aii.a($$1, $$0.cd(), $$3, $$4));
      return (bte)(this.j == dgx.d ? bte.e : $$1.a($$0, $$4, $$3));
   }

   public void a(int $$0, int $$1, int $$2, cti $$3, cps $$4) {
      csx $$5 = $$4.cd;
      if ($$0 != $$5.l) {
         ...
         jz<cuu> $$6 = $$5.k;
         int $$7 = $$6.size();
         List<cxk> $$8 = Lists.newArrayListWithCapacity($$7);
         ...
         $$5.a($$1, $$2, $$3, $$4);
         Int2ObjectMap<cxk> $$10 = new Int2ObjectOpenHashMap();
   ...
   public void a(int $$0, dde $$1, boolean $$2) {
   ...
   public boolean g() {
      return this.b.t.bZ() && this.b.t.dk() instanceof bvu;
   }
