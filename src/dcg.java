...
public class dcg implements dat {
   ...
   @Override
   public List<dcj> g() {
      return List.of(new dco(List.of(this.e.b(), this.f.b()), new dcp.d(this.g), new dcp.d(cwt.fc)));
   }
   ...
   public static class a implements dbo<dcg> {
      ...
      public static final ym<vz, dcg> w = ym.a(
         yk.o, $$0 -> $$0.c, dar.g, $$0 -> $$0.d, dba.a, $$0 -> $$0.e, dba.a, $$0 -> $$0.f, yk.b(mc.K), $$0 -> $$0.g, dcg::new
      );
