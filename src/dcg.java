...
public class dcg {
   public static <T> List<dcg.b> a(List<T> $$0, Function<T, List<jb<egn>>> $$1, boolean $$2) {
      Object2IntMap<egn> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, egn c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jb<egn>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ix<egn> $$12 : $$10.get($$11)) {
               egn $$13 = $$12.a();
      ...
      Builder<dcg.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<egn> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new dcg.b($$28));
      }
   ...
   public static record b(List<egn> a, ToIntFunction<egn> b) {
      b(List<egn> $$0) {
         this($$0, ac.h($$0));
      }
   }
