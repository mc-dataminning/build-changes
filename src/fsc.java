public class fsc extends fua {
   ...
   fsc(fpx $$0, double $$1, double $$2, double $$3, ego $$4) {
      super($$0, $$1, $$2, $$3);
      this.b(0.01F, 0.01F);
      this.u = 0.06F;
      this.b = $$4;
      ...
      if (!this.o) {
         ...
         if (!this.o) {
            ...
            if (this.b != egq.a) {
               ...
               egp $$1 = this.c.b_($$0);
               if ($$1.a() == this.b && this.h < (double)((float)$$0.v() + $$1.a((cut)this.c, $$0))) {
                  this.k();
               }
            }
         }
   ...
   static class a extends fsc.b {
      a(fpx $$0, double $$1, double $$2, double $$3, ego $$4, jx $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
   ...
   static class b extends fsc {
      private final jx b;

      b(fpx $$0, double $$1, double $$2, double $$3, ego $$4, jx $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
         this.u *= 0.02F;
         this.t = 40;
   ...
   static class c extends fsc {
      c(fpx $$0, double $$1, double $$2, double $$3, ego $$4) {
         super($$0, $$1, $$2, $$3, $$4);
         this.t = (int)(16.0 / (Math.random() * 0.8 + 0.2));
      }
   }

   static class d extends fsc.e {
      d(fpx $$0, double $$1, double $$2, double $$3, ego $$4, jx $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
      ...
      protected void i() {
         if (this.m) {
            ...
            atj $$0 = this.g() == egq.e ? atk.hi : atk.hj;
            float $$1 = awh.b(this.r, 0.3F, 1.0F);
            this.c.a(this.g, this.h, this.i, $$0, atl.e, $$1, 1.0F, false);
         }
      }
   }

   static class e extends fsc.f {
      protected final jx b;

      e(fpx $$0, double $$1, double $$2, double $$3, ego $$4, jx $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.b = $$5;
      }
   ...
   static class f extends fsc {
      f(fpx $$0, double $$1, double $$2, double $$3, ego $$4) {
         this($$0, $$1, $$2, $$3, $$4, (int)(64.0 / (Math.random() * 0.8 + 0.2)));
      }

      f(fpx $$0, double $$1, double $$2, double $$3, ego $$4, int $$5) {
         super($$0, $$1, $$2, $$3, $$4);
         this.t = $$5;
      }
   ...
   static class g extends fsc.e {
      g(fpx $$0, double $$1, double $$2, double $$3, ego $$4, jx $$5) {
         super($$0, $$1, $$2, $$3, $$4, $$5);
      }
      ...
      protected void i() {
         if (this.m) {
            this.k();
            this.c.a(this.b, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            float $$0 = awh.b(this.r, 0.3F, 1.0F);
            this.c.a(this.g, this.h, this.i, atk.bR, atl.e, $$0, 1.0F, false);
         }
      }
   }
}
