...
public class agt implements Comparable<agt> {
   public static final Codec<agt> a = Codec.STRING.comapFlatMap(agt::b, agt::toString).stable();
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(vb.c("argument.id.invalid"));
   ...
   protected agt(String $$0, String $$1, @Nullable agt.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public agt(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private agt(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static agt a(String $$0, char $$1) {
      return new agt(b($$0, $$1));
   }
   ...
   @Nullable
   public static agt a(String $$0, String $$1) {
      try {
         return new agt($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<agt> b(String $$0) {
      try {
         return DataResult.success(new agt($$0));
      } catch (z var2) {
   ...
   public agt c(String $$0) {
      return new agt(this.f, d(this.f, $$0), null);
   }

   public agt a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public agt d(String $$0) {
      return this.c($$0 + this.g);
   }

   public agt e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof agt $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static agt a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<agt>, JsonSerializer<agt> {
      public agt a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new agt(ato.a($$0, "location"));
      }

      public JsonElement a(agt $$0, Type $$1, JsonSerializationContext $$2) {
