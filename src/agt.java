...
public class agt {
   ...
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> ti.a("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(ti.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> ti.a("commands.execute.conditional.fail_count", $$0));
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a(
                                       ...
                                       .then(du.a("at").then(du.a("targets", ee.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bil $$2x : ee.c($$0x, "targets")) {
                                             $$1x.add(((dt)$$0x.getSource()).a((akn)$$2x.dK()).a($$2x.di()).a($$2x.bF()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("positioned")
                                          ...
                                          .then(du.a("as").then(du.a("targets", ee.b()).fork($$2, $$0x -> {
                                             ...
                                             for (bil $$2x : ee.c($$0x, "targets")) {
                                                $$1x.add(((dt)$$0x.getSource()).a($$2x.di()));
                                             }

                                             return $$1x;
                                          }))))
                                       .then(du.a("over").then(du.a("heightmap", eh.a()).redirect($$2, $$0x -> {
                                          ehi $$1x = ((dt)$$0x.getSource()).d();
                                          akn $$2x = ((dt)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(hz.b($$3), hz.b($$4))) {
                                             throw fk.a.create();
                                          } else {
                                             int $$5 = $$2x.a(eh.a($$0x, "heightmap"), ars.a($$3), ars.a($$4));
                                             return ((dt)$$0x.getSource()).a(new ehi($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         du.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)du.a("id", es.a())
                     .suggests(agd.a)
                     .then(du.a("value").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agd.a($$1x), true, $$2))))
                  .then(du.a("max").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agd.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             du.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         ej.a($$2xx, "path"),
                                                         $$1xxx -> qz.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          du.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      ej.a($$2xx, "path"),
                                                      $$1xxx -> qx.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       du.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   ej.a($$2xx, "path"),
                                                   $$1xxx -> ri.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    du.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                ej.a($$2xx, "path"),
                                                $$1xxx -> rc.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 du.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             ej.a($$2xx, "path"),
                                             $$1xxx -> qv.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              du.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          ej.a($$2xx, "path"),
                                          $$1xxx -> qs.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static dt a(dt $$0, Collection<String> $$1, eie $$2, boolean $$3) {
      eih $$4 = $$0.l().aF();
      return $$0.a(($$4x, $$5, $$6) -> {
         for (String $$7 : $$1) {
            eig $$8 = $$4.c($$7, $$2);
   ...
   private static dt a(dt $$0, afs $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4, $$5) -> {
         int $$6 = $$3 ? $$5 : ($$4 ? 1 : 0);
         if ($$2) {
            $$1.a($$6);
   ...
   private static dt a(dt $$0, aje $$1, ej.g $$2, IntFunction<rn> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5, $$6) -> {
         try {
            qu $$7 = $$1.a();
            int $$8 = $$4 ? $$6 : ($$5 ? 1 : 0);
   ...
   private static boolean a(akn $$0, gw $$1) {
      cox $$2 = new cox($$1);
      dhl $$3 = $$0.k().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == akg.d && $$0.c($$2.a());
   }
                                       ...
                                       du.a("pos", fk.a())
                                          .then(
                                             a(
                                                ...
                                                du.a("block", fg.a($$3)),
                                                $$2,
                                                $$0x -> fg.a($$0x, "block").test(new dfi(((dt)$$0x.getSource()).e(), fk.a($$0x, "pos"), true))
                                             )
                                          )
                                    )
                              ))
                  ...
                  du.a("entity")
                     .then(
                        ((RequiredArgumentBuilder)du.a("entities", ee.b()).fork($$0, $$1x -> a($$1x, $$2, !ee.c($$1x, "entities").isEmpty())))
                           .executes(a($$2, (agt.a)($$0x -> ee.c($$0x, "entities").size())))
                     )
               ))
            .then(du.a("predicate").then(a($$0, du.a("predicate", es.a()).suggests(f), $$2, $$0x -> a((dt)$$0x.getSource(), es.c($$0x, "predicate"))))))
         .then(du.a("function").then(a($$0, du.a("function", fv.a()).suggests(agy.a), $$2, $$0x -> a((dt)$$0x.getSource(), fv.a($$0x, "function")))));
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)du.a("path", ej.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), ej.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (agt.a)($$1xx -> a($$4.a($$1xx), ej.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static Command<dt> a(boolean $$0, agt.a $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((dt)$$1x.getSource()).a(() -> ti.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw c.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((dt)$$1x.getSource()).a(() -> ti.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create($$2);
         }
   ...
   private static int a(aje $$0, ej.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }
   ...
   private static boolean a(CommandContext<dt> $$0, BiPredicate<Integer, Integer> $$1) throws CommandSyntaxException {
      ...
      eie $$3 = el.a($$0, "targetObjective");
      String $$4 = ev.a($$0, "source");
      eie $$5 = el.a($$0, "sourceObjective");
      eih $$6 = ((dt)$$0.getSource()).l().aF();
      if ($$6.b($$2, $$3) && $$6.b($$4, $$5)) {
         eig $$7 = $$6.c($$2, $$3);
         eig $$8 = $$6.c($$4, $$5);
   ...
   private static boolean a(CommandContext<dt> $$0, cl.d $$1) throws CommandSyntaxException {
      String $$2 = ev.a($$0, "target");
      eie $$3 = el.a($$0, "targetObjective");
      eih $$4 = ((dt)$$0.getSource()).l().aF();
      return !$$4.b($$2, $$3) ? false : $$1.d($$4.c($$2, $$3).b());
   }

   private static boolean a(dt $$0, Collection<dp> $$1) {
      boolean $$2 = false;

      for (dp $$3 : $$1) {
         try {
            agy.a $$4 = agy.a($$0, $$3, null);
            if ($$4.b() && $$4.a() != 0) {
               $$2 = true;
            }
         } catch (dv var6) {
   ...
   private static boolean a(dt $$0, efk $$1) {
      akn $$2 = $$0.e();
      ecr $$3 = new ecr.a($$2).a(eew.f, $$0.d()).b(eew.a, $$0.f()).a(eev.d);
      ecl $$4 = new ecl.a($$3).a(Optional.empty());
      $$4.b(ecl.a($$1));
      return $$1.test($$4);
   }
   ...
   private static ArgumentBuilder<dt, ?> a(CommandNode<dt> $$0, ArgumentBuilder<dt, ?> $$1, boolean $$2, agt.b $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((dt)$$2x.getSource()).a(() -> ti.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw c.create();
         }
   ...
   private static int a(CommandContext<dt> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((dt)$$0.getSource()).a(() -> ti.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw c.create();
      }
   ...
   private static int b(CommandContext<dt> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((dt)$$0.getSource()).a(() -> ti.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(akn $$0, gw $$1, gw $$2, gw $$3, boolean $$4) throws CommandSyntaxException {
      duv $$5 = duv.a($$1, $$2);
      duv $$6 = duv.a($$3, $$3.a($$5.b()));
   ...
   private static RedirectModifier<dt> a(Function<bil, Optional<bil>> $$0) {
      return $$1 -> {
         dt $$2 = (dt)$$1.getSource();
         bil $$3 = $$2.f();
   ...
   private static RedirectModifier<dt> b(Function<bil, Stream<bil>> $$0) {
      return $$1 -> {
         dt $$2 = (dt)$$1.getSource();
         bil $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<dt> a(CommandNode<dt> $$0, LiteralArgumentBuilder<dt> $$1) {
      return (LiteralArgumentBuilder<dt>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              du.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bil, Optional<bil>>)($$0x -> $$0x instanceof bjj $$1x ? Optional.ofNullable($$1x.I_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              du.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<bil, Optional<bil>>)($$0x -> $$0x instanceof bjd $$1x ? Optional.ofNullable($$1x.fP()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           du.a("target")
                              .fork($$0, a((Function<bil, Optional<bil>>)($$0x -> $$0x instanceof bjx $$1x ? Optional.ofNullable($$1x.j()) : Optional.empty())))
                        ))
                     .then(
                        du.a("attacker")
                           .fork($$0, a((Function<bil, Optional<bil>>)($$0x -> $$0x instanceof bij $$1x ? Optional.ofNullable($$1x.M_()) : Optional.empty())))
                     ))
                  .then(du.a("vehicle").fork($$0, a((Function<bil, Optional<bil>>)($$0x -> Optional.ofNullable($$0x.cY()))))))
               .then(du.a("controller").fork($$0, a((Function<bil, Optional<bil>>)($$0x -> Optional.ofNullable($$0x.cN()))))))
            .then(
               du.a("origin").fork($$0, a((Function<bil, Optional<bil>>)($$0x -> $$0x instanceof bjy $$1x ? Optional.ofNullable($$1x.v()) : Optional.empty())))
            ))
         .then(du.a("passengers").fork($$0, b((Function<bil, Stream<bil>>)($$0x -> $$0x.cP().stream()))));
   }

   private static dt a(dt $$0, hg.c<bip<?>> $$1) throws CommandSyntaxException {
      bil $$2 = aiq.a($$0, $$1, $$0.d(), new qu(), true);
      return $$0.a($$2);
   }
