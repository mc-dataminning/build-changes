...
public interface aok {
   aok a = new aok() {
      ...
      @Override
      public void a(Consumer<cuy> $$0) {
      }
   };

   static aok a(cuy $$0, int $$1) {
      return new aok.a($$0, $$1);
   }

   static void a(aok $$0, aok $$1, Consumer<cuy> $$2, Consumer<cuy> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aok.a $$4 && $$1 instanceof aok.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cuy($$10, $$11));
                     } else {
                        $$3.accept(new cuy($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cuy b, int c) implements aok {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aok.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aok.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
