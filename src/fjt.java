...
public class fjt extends hhs {
   private static final alp a = alp.b("icon/unseen_notification");
   private static final alp b = alp.b("icon/news");
   private static final alp c = alp.b("icon/invite");
   ...
   private void c(fnl $$0) {
      ...
      int $$6 = $$4 - 3;
      if (J) {
         $$0.a(glq::H, a, $$6 - 12, $$5 + 3, 10, 10);
         $$6 -= 16;
      }

      if (this.F != null && this.F.a()) {
         if (I) {
            $$0.a(glq::H, b, $$6 - 14, $$5 + 1, 14, 14);
            $$6 -= 16;
         }

         if ($$1 != 0) {
            $$0.a(glq::H, c, $$6 - 14, $$5 + 1, 14, 14);
            $$6 -= 16;
         }

         if (H) {
            $$0.a(glq::H, C, $$6 - 10, $$5 + 4, 8, 8);
         }
      }
   }
