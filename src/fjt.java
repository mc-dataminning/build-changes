...
public class fjt {
   ...
   public void a(float $$0, eij $$1, fjx.a $$2, fiy $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bdw $$6 = (bdw)MoreObjects.firstNonNull($$3.aH, bdw.a);
   ...
   @VisibleForTesting
   static fjt.a a(fiy $$0) {
      cfz $$1 = $$0.eO();
      cfz $$2 = $$0.eP();
      boolean $$3 = $$1.a(cgc.nG) || $$2.a(cgc.nG);
      boolean $$4 = $$1.a(cgc.uZ) || $$2.a(cgc.uZ);
      if (!$$3 && !$$4) {
         return fjt.a.a;
      } else if ($$0.fi()) {
         return b($$0);
      } else {
         return a($$1) ? fjt.a.b : fjt.a.a;
      }
   }

   private static fjt.a b(fiy $$0) {
      cfz $$1 = $$0.fk();
      bdw $$2 = $$0.fj();
      if (!$$1.a(cgc.nG) && !$$1.a(cgc.uZ)) {
         return $$2 == bdw.a && a($$0.eP()) ? fjt.a.b : fjt.a.a;
      } else {
         return fjt.a.a($$2);
      }
   }
   ...
   public void a() {
      ...
      if ($$0.G()) {
         ...
         float $$3 = $$0.A(1.0F);
         this.ax = this.ax + apa.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + apa.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
