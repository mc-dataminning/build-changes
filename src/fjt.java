...
public class fjt extends fld {
   ...
   protected void aM_() {
      ...
      this.b = new ffn(this.m.i, 4, this.o - 12, this.n - 4, 12, wu.c("chat.editBox")) {
         @Override
         protected xi aK_() {
            return super.aK_().b(fjt.this.v.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.v = new ffh(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.v.b(false);
      this.v.d();
   }
   ...
   public void a(fer $$0, int $$1, int $$2, float $$3) {
      ...
      this.v.a($$0, $$1, $$2);
      $$0.c().b();
      fcz $$4 = this.m.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(fja $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fiz.a, wu.a("chat_screen.message", $$1));
      }
   }
   ...
   public String a(String $$0) {
      return ayu.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
