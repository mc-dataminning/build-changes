...
public class dxn<T> implements dxp<T> {
   ...
   private dxn(ju<T> $$0, int $$1, dxq<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dxn(ju<T> $$0, T[] $$1, dxq<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dxp<T> a(dxq<T> $$0) {
      return new dxn<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
