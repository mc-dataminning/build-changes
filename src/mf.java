...
public class mf implements lo {
   private final lq d;
   private final CompletableFuture<jc.a> e;

   public mf(lq $$0, CompletableFuture<jc.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public CompletableFuture<?> a(lm $$0) {
      Path $$1 = this.d.a(lq.b.c).resolve("blocks.json");
      return this.e
         .thenCompose(
            $$2 -> {
               ...
               $$2.b(li.f)
                  ...
                  .forEach(
                     $$2x -> {
                        ...
                        String $$14 = $$2x.g();
                        JsonElement $$15 = ad.a(
                           dfd.a.codec().encodeStart($$4, (dfc)$$2x.a()),
