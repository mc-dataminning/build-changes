...
public class bei {
   ...
   private JsonElement a(List<Pair<dhm, bes<bek>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bes)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dhm, bes<bek>> $$3 : $$0) {
         bes<bek> $$4 = (bes<bek>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dhm)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<beq> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bdy.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(beg $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(beo $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         beo.b $$3 = (beo.b)$$1x.getFirst();
         beo.a $$4 = (beo.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bel> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bel>, ToDoubleFunction<bel>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bel::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bel::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bel::c));
      return $$1;
   }
}
