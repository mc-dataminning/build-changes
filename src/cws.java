...
public class cws {
   ...
   private final cws.a e;
   private final long f;

   public cws(cws.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cws a(cws.a $$0) {
      return new cws($$0, this.f);
   }

   public ij<cwq> a(hz $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ij<cwq> a(double $$0, double $$1, double $$2) {
      int $$3 = iu.a(awi.a($$0));
      int $$4 = iu.a(awi.a($$1));
      int $$5 = iu.a(awi.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = awe.a($$7, $$0);
      double $$10 = b($$7);
      return awi.k($$6 + $$10) + awi.k($$5 + $$9) + awi.k($$4 + $$8);
   }
   ...
   public interface a {
      ij<cwq> getNoiseBiome(int var1, int var2, int var3);
   }
}
