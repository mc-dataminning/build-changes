...
public class doh extends dok<dog> {
   public doh(Codec<dog> $$0) {
      super($$0);
   }

   public boolean a(dog $$0, ato $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dof $$0, dog $$1, dis $$2, Function<ht, ib<csq>> $$3, ato $$4, dlr $$5, cqz $$6, dir $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dok.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dof $$0, dog $$1, dis $$2, Function<ht, ib<csq>> $$3, dlr $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dir $$10, dok.a $$11
   ) {
      double $$12 = 1.5 + (double)(ati.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ati.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ati.b($$13);
         $$6 += (double)(ati.b($$12) * $$27);
         $$7 += (double)ati.a($$13);
         $$8 += (double)(ati.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
