...
public class doh extends dnm<dpy> {
   ...
   protected boolean a(
      cqf $$0, aru $$1, dpy $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dez $$0, Function<gu, dez> $$1, aru $$2, dpy $$3, dpy.a $$4, gu.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
