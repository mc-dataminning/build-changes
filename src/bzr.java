public class bzr implements bzn {
   ...
   public void a() {
      if (this.k == bzr.a.c) {
         ...
         iz $$14 = this.d.dp();
         dsd $$15 = this.d.dP().a_($$14);
         ewl $$16 = $$15.k(this.d.dP(), $$14);
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         eoj $$3 = $$2.o();
         if ($$3 != null && $$3.a(this.d, iz.a(this.d.du() + (double)$$0, (double)this.d.dv(), this.d.dA() + (double)$$1)) != eon.c) {
            return false;
         }
      }
