...
public class bzr extends bji implements bza {
   private static final aee<Integer> bT = aeh.a(bzr.class, aeg.b);
   ...
   public void l() {
      ...
      if (this.aA() && !this.bU) {
         ...
         for (int $$1 = 0; $$1 < $$0 * 8; $$1++) {
            ...
            float $$4 = arw.a($$2) * (float)$$0 * 0.5F * $$3;
            float $$5 = arw.b($$2) * (float)$$0 * 0.5F * $$3;
   ...
   protected void j(bjg $$0) {
      if (this.bv()) {
         ...
         if (this.f((biq)$$0) < 0.6 * (double)$$1 * 0.6 * (double)$$1 && this.E($$0) && $$0.a(this.dM().b((bjg)this), this.gb())) {
            this.a(apd.vC, 1.0F, (this.ag.i() - this.ag.i()) * 0.2F + 1.0F);
            this.a(this, $$0);
         }
      }
   }
   ...
   protected apc d(bho $$0) {
      return this.gf() ? apd.wt : apd.vE;
   }

   @Override
   protected apc l_() {
      return this.gf() ? apd.ws : apd.vD;
   }

   protected apc gc() {
      return this.gf() ? apd.wv : apd.vG;
   }

   public static boolean c(biu<bzr> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      if ($$1.ai() != bgv.a) {
         if ($$1.s($$3).a(apr.ap) && $$3.v() > 50 && $$3.v() < 70 && $$4.i() < 0.5F && $$4.i() < $$1.an() && $$1.z($$3) <= $$4.a(8)) {
            return a($$0, $$1, $$2, $$3, $$4);
         }
