public class cqe extends bvf implements cqi {
   private static final float a = 12.25F;
   private static final alc<cxk> b = alg.a(cqe.class, ale.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public cqe(bvm<? extends cqe> $$0, dha $$1) {
      super($$0, $$1);
   }

   public cqe(dha $$0, double $$1, double $$2, double $$3) {
      this(bvm.X, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   public void h() {
      ...
      double $$4 = $$0.i();
      this.w(cql.f(this.O, (float)(bae.d($$0.e, $$4) * 180.0F / (float)Math.PI)));
      this.v(cql.f(this.N, (float)(bae.d($$0.d, $$0.f) * 180.0F / (float)Math.PI)));
      if (!this.dV().C) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         ...
         $$0 = new fbs(Math.cos((double)$$8) * $$9, $$10 + ((double)$$11 - $$10) * 0.015F, Math.sin((double)$$8) * $$9);
         this.h($$0);
      }
      ...
      if (!this.dV().C) {
         ...
         if (this.f > 80 && !this.dV().C) {
            this.a(axf.iA, 1.0F, 1.0F);
            this.at();
            if (this.g) {
               this.dV().b(new clw(this.dV(), this.dA(), this.dC(), this.dG(), this.l()));
            } else {
   ...
   public void a(ux $$0) {
      if ($$0.b("Item", 10)) {
         this.a(cxk.a(this.dX(), (vu)$$0.p("Item")).orElse(this.m()));
      } else {
         this.a(this.m());
      }
   }
