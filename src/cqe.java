...
public interface cqe extends cpe, cpl, cqr, crb.a {
   @Nullable
   dgz a(int var1, int var2, dhe var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dkm.a var1, int var2, int var3);

   int A_();

   crb E_();

   default he<cqz> s(gw $$0) {
      return this.E_().a($$0);
   }

   default Stream<dfd> c(ehc $$0) {
      int $$1 = asb.a($$0.a);
      int $$2 = asb.a($$0.d);
      int $$3 = asb.a($$0.b);
      int $$4 = asb.a($$0.e);
   ...
   @Override
   default int a(gw $$0, cpm $$1) {
      return $$1.getColor(this.s($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default he<cqz> getNoiseBiome(int $$0, int $$1, int $$2) {
      dgz $$3 = this.a(hp.e($$0), hp.e($$2), dhe.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   he<cqz> a(int var1, int var2, int var3);
   ...
   default dgz a(int $$0, int $$1) {
      return this.a($$0, $$1, dhe.n, true);
   }

   default dgz a(int $$0, int $$1, dhe $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default cph c(int $$0, int $$1) {
      return this.a($$0, $$1, dhe.c, false);
   }

   default boolean y(gw $$0) {
      return this.b_($$0).a(aqa.a);
   }

   default boolean d(ehc $$0) {
      int $$1 = asb.a($$0.a);
      int $$2 = asb.c($$0.d);
      int $$3 = asb.a($$0.b);
      int $$4 = asb.c($$0.e);
   ...
   default <T> hg<T> a(aey<? extends hq<? extends T>> $$0) {
      hq<T> $$1 = this.G_().d($$0);
      return $$1.p().a(this.G());
   }
}
