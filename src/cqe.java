...
public class cqe {
   ...
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jy.a.fieldOf("uuid").forGetter(Pair::getFirst), ayu.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bwf> j;
   @VisibleForTesting
   protected final ArrayList<bwf> c;
   private final cqe.a k;
   @VisibleForTesting
   protected final Object2IntMap<bwf> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cqe> a(Predicate<bwf> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cqe::b)).apply($$1, $$1x -> new cqe($$0, $$1x))
      );
   }

   public cqe(Predicate<bwf> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cqe.a(this);
   ...
   public void a(arq $$0, Predicate<bwf> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bwf>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bwf> $$6 = (Entry<bwf>)$$5.next();
         int $$7 = $$6.getIntValue();
         bwf $$8 = (bwf)$$6.getKey();
         bwf.e $$9 = $$8.dR();
   ...
   public int b(@Nullable bwf $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bxe> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bxe).map($$0 -> (bxe)$$0);
   }

   @VisibleForTesting
   protected static record a(cqe a) implements Comparator<bwf> {
      public int a(bwf $$0, bwf $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof crc;
               boolean $$7 = $$1 instanceof crc;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
