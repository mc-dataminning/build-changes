...
public class aeb implements zf<abu> {
   ...
   public static enum a {
      ...
      c(($$0, $$1) -> $$0.e = dje.a($$1.l()), ($$0, $$1) -> $$0.c($$1.e().a())),
   ...
   public static record b(UUID a, @Nullable GameProfile b, boolean c, int d, dje e, @Nullable wy f, boolean g, int h, @Nullable xp.a i) {

      b(arr $$0) {
         this($$0.cF(), $$0.gh(), true, $$0.f.k(), $$0.h.b(), $$0.O(), $$0.a(crl.g), $$0.P(), y.a($$0.aa(), xp::a));
      }
   }
