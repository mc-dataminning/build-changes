...
public class apd {
   ...
   private static int a(ew $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2 != null) {
         int $$3 = $$2.l();
         if ($$1 > $$3) {
            $$0.b(xv.b("Sorry, the max raid omen level you can set is " + $$3));
         } else {
            int $$4 = $$2.m();
            $$2.a($$1);
            $$0.a(() -> xv.b("Changed village's raid omen level from " + $$4 + " to " + $$1), false);
         }
      } else {
         $$0.b(xv.b("No raid found here"));
      }
   ...
   private static int b(ew $$0) {
      $$0.a(() -> xv.b("Spawned a raid captain"), false);
      crl $$1 = bvr.aU.a($$0.e(), bvq.n);
      if ($$1 == null) {
         $$0.b(xv.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.x(true);
         $$1.a(bvs.f, crk.a($$0.u().e(mb.d)));
         $$1.a_($$0.d().d, $$0.d().e, $$0.d().f);
         $$1.a($$0.e(), $$0.e().d_(jh.a((ka)$$0.d())), bvq.n, null);
         $$0.e().a_($$1);
         return 1;
      }
   }

   private static int a(ew $$0, @Nullable xv $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         ash $$2 = $$0.e();
         fby $$3 = $$0.d().b(5.0, 0.0, 0.0);
         $$2.a(null, $$3.d, $$3.e, $$3.f, axf.vw, axg.g, 2.0F, 1.0F, $$2.A.g());
      }
   ...
   private static int b(ew $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2.y().e($$3)) {
         ...
         if ($$5 != null) {
            $$5.a($$1);
            $$4.c();
            $$0.a(() -> xv.b("Created a raid in your local village"), false);
         } else {
            $$0.b(xv.b("Failed to create a raid in your local village"));
         }
   ...
   private static int c(ew $$0) throws CommandSyntaxException {
      ...
      if ($$3 != null) {
         $$3.n();
         $$0.a(() -> xv.b("Stopped raid"), false);
         return 1;
      } else {
         $$0.b(xv.b("No raid here"));
         return -1;
      }
   }
   ...
   private static int d(ew $$0) throws CommandSyntaxException {
      ...
      if ($$1 != null) {
         ...
         $$3.append(" / ");
         $$3.append($$1.g());
         $$0.a(() -> xv.b($$3.toString()), false);
         return 1;
      } else {
         $$0.b(xv.b("Found no started raids"));
         return 0;
      }
   }

   @Nullable
   private static crk a(asi $$0) {
      return $$0.y().d($$0.dw());
   }
}
