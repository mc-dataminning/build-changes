...
class apd extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof apc && $$1 instanceof apc && $$0.equals($$1);
   }
   ...
   private static apc a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof apc) {
         return (apc)$$0;
      } else {
