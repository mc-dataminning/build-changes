...
public class apd {
   ...
   public static final List<Function<String, apd.c>> a = ImmutableList.of(ape.a, apb.a, apf.a);
   public static final List<apd.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<apd.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<ee> $$0) {
      ...
      for (apd.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<ee, ?>, apd.b>)(($$0x, $$1x) -> $$0x.then(
                           ef.a("insert")
                              .then(
   ...
   private static List<va> a(List<va> $$0, apd.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<ee, ?> a(BiConsumer<ArgumentBuilder<ee, ?>, apd.b> $$0) {
   ...
   private static List<va> a(CommandContext<ee> $$0, apd.c $$1) throws CommandSyntaxException {
      apc $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<va> b(CommandContext<ee> $$0, apd.c $$1) throws CommandSyntaxException {
      apc $$2 = $$1.a($$0);
      ew.g $$3 = ew.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<ee> $$0, apd.c $$1, apd.a $$2, List<va> $$3) throws CommandSyntaxException {
      apc $$4 = $$1.a($$0);
   ...
   private static int a(ee $$0, apc $$1, ew.g $$2) throws CommandSyntaxException {
      ud $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static va a(ew.g $$0, apc $$1) throws CommandSyntaxException {
   ...
   private static int b(ee $$0, apc $$1, ew.g $$2) throws CommandSyntaxException {
      va $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof ut) {
         $$4 = ayf.a(((ut)$$3).j());
   ...
   private static int a(ee $$0, apc $$1, ew.g $$2, double $$3) throws CommandSyntaxException {
      va $$4 = a($$2, $$1);
      if (!($$4 instanceof ut)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = ayf.a(((ut)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(ee $$0, apc $$1) throws CommandSyntaxException {
      ud $$2 = $$1.a();
      $$0.a(() -> $$1.a((va)$$2), false);
      return 1;
   }

   private static int a(ee $$0, apc $$1, ud $$2) throws CommandSyntaxException {
      ud $$3 = $$1.a();
      if (ew.g.a($$2, 0)) {
         throw ew.b.create();
      } else {
   ...
   @FunctionalInterface
   interface b {
      ArgumentBuilder<ee, ?> create(apd.a var1);
   }

   public interface c {
      apc a(CommandContext<ee> var1) throws CommandSyntaxException;
