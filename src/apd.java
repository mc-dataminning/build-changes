...
class apd implements Path {
   private static final BasicFileAttributes a = new apb() {
      @Override
   ...
   private static final BasicFileAttributes b = new apb() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<apd> c = Comparator.comparing(apd::n);
   ...
   public apd(apf $$0, String $$1, @Nullable apd $$2, apg $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private apd a(@Nullable apd $$0, String $$1) {
      return new apd(this.e, $$1, $$0, apg.b);
   }
   ...
   apd a(String $$0) {
      if (a(this.i)) {
         return new apd(this.e, $$0, this, this.i);
      } else if (this.i instanceof apg.a $$1) {
         apd $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new apd(this.e, $$0, this, apg.a);
      } else if (this.i instanceof apg.b) {
         return new apd(this.e, $$0, this, apg.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(apg $$0) {
      return $$0 == apg.a || $$0 == apg.b;
   }
   ...
   private apd c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof apd $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof apg.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public apg.a i() {
      return this.i instanceof apg.a $$0 ? $$0 : null;
   }
