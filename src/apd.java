...
public class apd {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wv.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wv.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wv.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ex $$0, fct $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bvs> $$6) throws CommandSyntaxException {
      arn $$7 = $$0.e();
      int $$8 = $$7.G_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         apd.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> wv.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bvs> $$0) {
      Set<feb> $$1 = Sets.newHashSet();
   ...
   private static void a(fct $$0, double $$1, arn $$2, azs $$3, double $$4, double $$5, double $$6, double $$7, int $$8, apd.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bvs> $$0, arn $$1, apd.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<feb, apd.a> $$7 = Maps.newHashMap();

      for (bvs $$8 : $$0) {
         apd.a $$10;
         if ($$4) {
            feb $$9 = $$8 instanceof cqi ? $$8.cr() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)azk.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)azk.a($$10.b) + 0.5, Set.of(), $$8.dL(), $$8.dN(), true);
   ...
   private static apd.a[] a(azs $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      apd.a[] $$6 = new apd.a[$$1];
   ...
   static class a {
      ...
      public int a(dgv $$0, int $$1) {
         jj.a $$2 = new jj.a(this.a, (double)($$1 + 1), this.b);
         boolean $$3 = $$0.a_($$2).l();
         $$2.c(jo.a);
         boolean $$4 = $$0.a_($$2).l();
      ...
      public boolean b(dgv $$0, int $$1) {
         jj $$2 = jj.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dym $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.n() && !$$3.a(awz.aN);
      }

      public void a(azs $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = azk.a($$0, $$1, $$3);
         this.b = azk.a($$0, $$2, $$4);
      }
   }
