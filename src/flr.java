...
public class flr extends fkt {
   ...
   public flr(fkk $$0, int $$1, int $$2, int $$3, int $$4, xh $$5, xh $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new flu($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fox $$0) {
      $$0.a(fow.a, xh.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   protected void c(fkm $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aN_()) {
         $$0.a(this.m, (xm)this.n, this.D() + this.a(), this.E() + this.a(), this.g - this.b(), -857677600);
      } else {
         int $$5 = this.o.d();
   ...
   protected void a(fkm $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         xh $$2 = xh.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      flu.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         flu.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
