...
public class flr {
   ...
   public static void a(File $$0, fee $$1, Consumer<wo> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fee $$2, Consumer<wo> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fee $$2, Consumer<wo> $$3) {
      feu $$4 = a($$2);
      ...
      af.h().execute(() -> {
         try {
            $$4.a($$6);
            wo $$3x = wo.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new wm(wm.a.b, $$6.getAbsolutePath())));
            $$3.accept(wo.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(wo.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static feu a(fee $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      feu $$3 = new feu($$1, $$2, false);
   ...
   public flr(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
