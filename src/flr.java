...
public class flr {
   ...
   public static flu a(BooleanConsumer $$0, BanDetails $$1) {
      return new flu($$0, a($$1), b($$1), "https://aka.ms/mcjavamoderation", xo.m, true);
   }

   public static flu a(Runnable $$0) {
   ...
   public static flu a(String $$0, Runnable $$1) {
