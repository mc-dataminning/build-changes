...
public abstract class flr<E extends flr.a<E>> extends flo {
   protected static final int b = 6;
   private static final all a = all.b("widget/scroller");
   private static final all m = all.b("widget/scroller_background");
   private static final all n = all.b("textures/gui/menu_list_background.png");
   private static final all o = all.b("textures/gui/inworld_menu_list_background.png");
   protected final fjx c;
   protected final int d;
   private final List<E> p = new flr.b();
   ...
   public flr(fjx $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xk.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = azn.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void b(flj $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.m()) {
         ...
         $$7 = azn.a($$7, 32, this.h - 8);
         int $$8 = (int)this.n() * (this.h - $$7) / this.p() + this.E();
         if ($$8 < this.E()) {
            $$8 = this.E();
         }

         $$0.a(gjh::B, m, $$6, this.E(), 6, this.w());
         $$0.a(gjh::B, a, $$6, $$8, 6, $$7);
      }
   ...
   protected void a(flj $$0) {
      all $$1 = this.c.s == null ? frp.h : frp.j;
      all $$2 = this.c.s == null ? frp.i : frp.k;
      $$0.a(gjh::B, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(gjh::B, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(flj $$0) {
      all $$1 = this.c.s == null ? n : o;
      $$0.a(gjh::B, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   public void a(double $$0) {
      this.q = azn.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = azn.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fqc $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fqc $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fps.a u() {
      if (this.aM_()) {
         ...
         return this.v != null ? fps.a.b : fps.a.a;
      }
   }
   ...
   protected void a(fpu $$0, E $$1) {
      List<E> $$2 = this.aI_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fpt.b, xl.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends flr.a<E>> implements fnt {
      @Deprecated
      flr<E> a;
      ...
      public abstract void a(flj var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
