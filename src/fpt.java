...
public class fpt {
   ...
   public fpt(flj $$0, foc $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public wo a(ggk $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fca.a($$0.h(), wo.b($$0.a().getName())));
   }

   private wo a(ggk $$0, xc $$1) {
   ...
   public void a(fod $$0, int $$1, fcf $$2, @Nullable fbx $$3) {
      List<ggk> $$4 = this.b();
   ...
   private void a(fbx $$0, int $$1, fpt.b $$2, int $$3, int $$4, UUID $$5, fod $$6) {
      if ($$0.h() == fci.a.b) {
