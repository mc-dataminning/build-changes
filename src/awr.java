...
public class awr extends aww {
   ...
   @Override
   public void a(com $$0, aws<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }
   ...
   private <T> Optional<aws<T>> a(awu<T> $$0, String $$1) {
      return Optional.ofNullable(ali.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      ...
      for (Entry<awu<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(ly.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> ali b(aws<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
