...
public class awr extends awq {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awr.a> s;
   private final awm t;
   private long u;
   private final ami v;

   private awr(ami $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awn.c($$2, 7, $$0.getLength());
      }
   }
