...
public class awr<T> extends AbstractList<T> implements aya<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return awr.this.get(this.b--);
      }

      @Override
      public void remove() {
         awr.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements aya<T> {
      private final awr<T> b;

      public b(final awr<T> $$0) {
         this.b = $$0;
      }
