...
public class awr extends aww {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<aws<?>> e = Sets.newHashSet();

   public awr(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cqs $$0, aws<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<aws<?>> d() {
      Set<aws<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<aws<T>> a(awu<T> $$0, String $$1) {
      return Optional.ofNullable(ale.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<awu<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aws<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<aws<?>>)$$3.next();
         aws<?> $$2 = (aws<?>)$$1.getKey();
      ...
      for (Entry<awu<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> ale b(aws<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(arp $$0) {
      Object2IntMap<aws<?>> $$1 = new Object2IntOpenHashMap();
