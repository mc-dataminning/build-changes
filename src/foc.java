...
public class foc {
   ...
   private static final Comparator<fbx> L = Comparator.comparing(fbx::d).reversed().thenComparing(fbx::c, String.CASE_INSENSITIVE_ORDER);
   ...
   private void h(fod $$0, fky $$1) {
      fce $$2 = this.ak.s.R();
      fbw $$3 = null;
      fbz $$4 = $$2.e(this.ak.t.cI());
      if ($$4 != null) {
         fbv $$5 = fbv.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      fbw $$6 = $$3 != null ? $$3 : $$2.a(fbv.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fod $$0, fky $$1) {
      fce $$2 = this.ak.s.R();
      fbw $$3 = $$2.a(fbv.a);
   ...
   private void j(fod $$0, fky $$1) {
      flm $$2 = this.ak.n;
      if ($$2.aE().a()) {
         if (this.ak.r.j() != dge.d || this.a(this.ak.w)) {
   ...
   private boolean a(@Nullable fax $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.d() == fax.a.c) {
         return ((faw)$$0).a() instanceof bsl;
      } else if ($$0.d() == fax.a.b) {
         ji $$1 = ((fav)$$0).b();
         dgh $$2 = this.ak.s;
   ...
   private void k(fod $$0, fky $$1) {
      Collection<btp> $$2 = this.ak.t.eA();
   ...
   private void l(fod $$0, fky $$1) {
      if (this.ak.r.j() == dge.d) {
         this.av.a($$0);
      } else {
         this.m($$0, $$1);
      }
   ...
   @Nullable
   private cow n() {
      return this.ak.ao() instanceof cow $$0 ? $$0 : null;
   }
   ...
   private static void a(fod $$0, cow $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eP();
      if ($$6 > 0) {
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fod $$0, cow $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      foc.b $$11 = foc.b.a($$1);
   ...
   private void a(fod $$0, cow $$1, int $$2, int $$3, int $$4) {
      int $$5 = $$1.cs();
   ...
   private void a(int $$0, cow $$1, int $$2) {
      if (this.aI != $$0) {
   ...
   private void a(fod $$0, cow $$1, int $$2, int $$3) {
      crx $$4 = $$1.gt();
      int $$5 = $$4.a();
   ...
   private void a(fod $$0, akv $$1, float $$2) {
      int $$3 = axk.a($$2);
   ...
   private void a(buk $$0) {
      ...
      float $$2 = glv.a($$0.dV().G_(), $$0.dV().A($$1));
   ...
   private void a(fod $$0, int $$1, int $$2, fky $$3, cow $$4, cwo $$5, int $$6) {
      if (!$$5.f()) {
