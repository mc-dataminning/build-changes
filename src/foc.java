public class foc extends fpb<cpu> {
   ...
   protected void F() {
      ...
      this.I = new fhl(this.p, $$0 + 62, $$1 + 24, 103, 12, xo.c("container.repair"));
      this.I.f(false);
      this.I.g(-1);
      this.I.h(-1);
      this.I.d(false);
   ...
   @Override
   public void d(fgp $$0, int $$1, int $$2, float $$3) {
      this.I.a($$0, $$1, $$2, $$3);
   }
