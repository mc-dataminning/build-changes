...
public class foc {
   ...
   private foc.a m = foc.a.c;
   @Nullable
   private byte[] n;
   private foc.b o;
   private boolean p;

   public foc(String $$0, String $$1, foc.b $$2) {
      this.a = $$0;
      this.b = $$1;
      this.o = $$2;
   }
   ...
   public void a(foc.a $$0) {
      this.m = $$0;
   }

   public static foc a(sn $$0) {
      foc $$1 = new foc($$0.l("name"), $$0.l("ip"), foc.b.c);
      if ($$0.b("icon", 8)) {
         try {
   ...
   public boolean d() {
      return this.o == foc.b.a;
   }

   public boolean e() {
      return this.o == foc.b.b;
   }
