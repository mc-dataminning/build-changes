...
public abstract class foc extends fnc {
   private final dqq b;
   private dqr c;
   ...
   public foc(dqq $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, xo.c("sign.edit"));
   }

   public foc(dqq $$0, boolean $$1, boolean $$2, xo $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
   ...
   @Override
   protected void aM_() {
      this.c(fhd.a(xn.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fjx(() -> this.d[this.u], this::a, fjx.a(this.m), fjx.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   public void j() {
      fxv $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new aio(this.b.ay_(), this.r, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void a(fgq var1, dsb var2);
   ...
   private void d(fgq $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : ggb.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gdv.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
