...
public abstract class bub extends bvo {
   private static final ajy<Boolean> bY = akc.a(bub.class, aka.k);
   ...
   protected bub(bur<? extends bub> $$0, dgh $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bub a(ard var1, bub var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dk() instanceof cqt $$0 && !$$0.b((buk)this)) {
         this.ae();
      }
   }
