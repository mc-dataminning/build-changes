...
public abstract class bub extends bvo {
   private static final ajx<Boolean> bY = akb.a(bub.class, ajz.k);
   ...
   protected bub(bur<? extends bub> $$0, dgi $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bub a(arc var1, bub var2);
   ...
   protected void i() {
      if (!this.e_() && this.bZ() && this.dl() instanceof cqu $$0 && !$$0.b((buk)this)) {
         this.ae();
      }
   }
