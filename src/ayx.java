...
public class ayx extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bff.z), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", ayx::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", ayx::a);
      return this.a($$0, "minecraft:trident", ayx::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bff.z, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bff.z, $$1);
