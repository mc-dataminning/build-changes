...
public class ayx {
   ...
   ayx(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ayx.a a() {
      return new ayx.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ayx::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ayx.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ayx a(Writer $$0) throws IOException {
         return new ayx($$0, this.a);
      }
   }
}
