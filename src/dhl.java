...
public class dhl<T> implements dhn<T> {
   ...
   private dhl(hj<T> $$0, int $$1, dho<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dhl(hj<T> $$0, T[] $$1, dho<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dhn<T> c() {
      return new dhl<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
