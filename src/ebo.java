...
@Deprecated
public class ebo extends eaz<ebo.a> {
   private static final dsd a = dfc.nc.o();

   public ebo(Codec<ebo.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebb<ebo.a> $$0) {
      iz $$1 = $$0.e();
      dcu $$2 = $$0.b();
      azh $$3 = $$0.d();
      ebo.a $$4 = $$0.f();
   ...
   public static record a(efe b, efe c) implements edd {
      public static final Codec<ebo.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(efe.a.fieldOf("fluid").forGetter(ebo.a::a), efe.a.fieldOf("barrier").forGetter(ebo.a::b)).apply($$0, ebo.a::new)
      );
