...
public class ebo {
   ...
   static class a implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
         return $$0.c[ic.f.d()] && !$$0.b[ic.f.d()].d;
      }

      @Override
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         $$1.d = true;
         $$1.b[ic.f.d()].d = true;
         return new ebo.k($$0, $$1);
      }
   }

   static class b implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         ...
         return new ebo.l($$0, $$1);
      }
   }

   static class c implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         $$1.d = true;
         $$1.b[ic.b.d()].d = true;
         return new ebo.m($$0, $$1);
      }
   }

   static class d implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         ...
         return new ebo.n($$0, $$1);
      }
   }

   static class e implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         ...
         $$3.d = true;
         $$3.b[ic.c.d()].d = true;
         return new ebo.o($$0, $$3);
      }
   }

   static class f implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
         return true;
      }
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         $$1.d = true;
         return new ebo.s($$0, $$1, $$2);
      }
   }

   static class g implements ebo.i {
      @Override
      public boolean a(ebo.v $$0) {
      ...
      public ebo.r a(ic $$0, ebo.v $$1, auu $$2) {
         $$1.d = true;
         return new ebo.t($$0, $$1);
      }
   }

   public static class h extends ebo.r {
      ...
      private ebo.v G;
      private ebo.v H;
      private final List<ebo.r> I = Lists.newArrayList();

      public h(auu $$0, int $$1, int $$2, ic $$3) {
         super(dzw.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ebo.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ebo.p($$3, this.G));
         this.I.add(new ebo.j($$3, this.H));
         List<ebo.i> $$5 = Lists.newArrayList();
         $$5.add(new ebo.b());
         $$5.add(new ebo.d());
         $$5.add(new ebo.e());
         $$5.add(new ebo.a());
         ...
         dyx $$10 = dyx.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dyx $$11 = dyx.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dyx $$12 = dyx.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ebo.u($$3, $$10, $$13++));
         this.I.add(new ebo.u($$3, $$11, $$13++));
         this.I.add(new ebo.q($$3, $$12));
      }
      ...
      private List<ebo.v> b(auu $$0) {
         ebo.v[] $$1 = new ebo.v[75];
         ...
         ebo.v $$23 = new ebo.v(1003);
         ebo.v $$24 = new ebo.v(1001);
         ebo.v $$25 = new ebo.v(1002);
         $$1[v].a(ic.b, $$23);
         $$1[w].a(ic.d, $$24);
         $$1[x].a(ic.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ebo.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cuj $$2, auu $$3, dyx $$4) {
         int $$5 = 24;
      ...
      private void a(cuj $$0, auu $$1, dyx $$2) {
      ...
      private void b(cuj $$0, auu $$1, dyx $$2) {
      ...
      private void c(cuj $$0, auu $$1, dyx $$2) {
      ...
      private void d(cuj $$0, auu $$1, dyx $$2) {
      ...
      private void e(cuj $$0, auu $$1, dyx $$2) {
      ...
      private void f(cuj $$0, auu $$1, dyx $$2) {
   ...
   interface i {
      boolean a(ebo.v var1);

      ebo.r a(ic var1, ebo.v var2, auu var3);
   }

   public static class j extends ebo.r {
      public j(ic $$0, ebo.v $$1) {
         super(dzw.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cuj $$0, cuh $$1, dld $$2, auu $$3, dyx $$4, csv $$5, hx $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cwr.ch.o(), cwr.ch.o(), false);
   ...
   public static class k extends ebo.r {
      public k(ic $$0, ebo.v $$1) {
         super(dzw.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ebo.r {
      public l(ic $$0, ebo.v $$1) {
         super(dzw.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ebo.r {
      public m(ic $$0, ebo.v $$1) {
         super(dzw.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ebo.r {
      public n(ic $$0, ebo.v $$1) {
         super(dzw.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ebo.r {
      public o(ic $$0, ebo.v $$1) {
         super(dzw.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ebo.r {
      public p(ic $$0, ebo.v $$1) {
         super(dzw.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ebo.r {
      public q(ic $$0, dyx $$1) {
         super(dzw.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dzj {
      protected static final djg b = cwr.hZ.o();
      protected static final djg c = cwr.ia.o();
      protected static final djg d = cwr.ib.o();
      protected static final djg h = c;
      protected static final djg i = cwr.ii.o();
      protected static final boolean j = true;
      protected static final djg k = cwr.G.o();
      protected static final Set<cwp> l = ImmutableSet.builder().add(cwr.dO).add(cwr.iC).add(cwr.mW).add(k.b()).build();
      ...
      public r(dzw $$0, ic $$1, int $$2, dyx $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dzw $$0, int $$1, ic $$2, ebo.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dyx a(ic $$0, ebo.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dyx $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cuj $$0, dyx $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  djg $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cuj $$0, dyx $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cuj $$0, dyx $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, djg $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dyx $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cuj $$0, dyx $$1, int $$2, int $$3, int $$4) {
         hx $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            ccd $$6 = bly.B.a((cto)$$0.E());
            if ($$6 != null) {
               $$6.b($$6.eM());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bmo.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ebo.r {
      private int a;

      public s(ic $$0, ebo.v $$1, auu $$2) {
         super(dzw.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ebo.r {
      public t(ic $$0, ebo.v $$1) {
         super(dzw.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ebo.r {
      private int a;

      public u(ic $$0, dyx $$1, int $$2) {
         super(dzw.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
