...
public class ebo extends eax<edi> {
   private static final Logger a = LogUtils.getLogger();
   private static final bsz<?>[] b = new bsz[]{bsz.aN, bsz.bu, bsz.bu, bsz.aW};
   private static final dsb c = dfa.nc.o();

   public ebo(Codec<edi> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eaz<edi> $$0) {
      Predicate<dsb> $$1 = eax.a(awo.bO);
      iz $$2 = $$0.e();
      azg $$3 = $$0.d();
      dcs $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.I_() && !$$4.a_($$23.d()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(dfa.cv)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, dfa.cn.o(), $$1);
                        } else {
                           this.a($$4, $$23, dfa.m.o(), $$1);
                        }
                     }
                  } else if (!$$24.a(dfa.cv) && !$$24.a(dfa.ct)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.u($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, ein.a($$4, $$30, dfa.cv.o()), $$1);
                     brb.a($$4, $$3, $$30, eqd.d);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, dfa.ct.o(), $$1);
         if ($$4.c_($$2) instanceof dqu $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
