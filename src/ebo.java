...
public final class ebo extends ebr<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private ebo(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ebo $$1 && super.equals($$0)) {
   ...
   public static ebo a(String $$0, int $$1, int $$2) {
      return new ebo($$0, $$1, $$2);
   }
