...
public class fxh extends fvw<cai> {
   public fxh(fvx.a $$0) {
      super($$0);
   }

   public void a(cai $$0, float $$1, float $$2, enw $$3, fqu $$4, int $$5) {
      $$3.a();
      $$3.a(a.d.rotationDegrees(180.0F - $$1));
      caj $$6 = $$0.q().a();
      float $$7 = 0.0625F;
      $$3.b(0.0625F, 0.0625F, 0.0625F);
      eoa $$8 = $$4.getBuffer(frc.c(this.a($$0)));
      gct $$9 = etd.N().aC();
   ...
   private void a(enw $$0, eoa $$1, cai $$2, int $$3, int $$4, gbu $$5, gbu $$6) {
      enw.a $$7 = $$0.c();
      Matrix4f $$8 = $$7.a();
      Matrix3f $$9 = $$7.b();
      ...
      for (int $$29 = 0; $$29 < $$25; $$29++) {
         for (int $$30 = 0; $$30 < $$26; $$30++) {
            ...
            int $$35 = $$2.dr();
            int $$36 = atm.a($$2.du() + (double)(($$33 + $$34) / 2.0F / 16.0F));
            int $$37 = $$2.dx();
            hx $$38 = $$2.cE();
            if ($$38 == hx.c) {
               $$35 = atm.a($$2.ds() + (double)(($$31 + $$32) / 2.0F / 16.0F));
            }

            if ($$38 == hx.e) {
               $$37 = atm.a($$2.dy() - (double)(($$31 + $$32) / 2.0F / 16.0F));
            }
            ...
            int $$39 = fqs.a($$2.dN(), new ht($$35, $$36, $$37));
   ...
   private void a(Matrix4f $$0, Matrix3f $$1, eoa $$2, float $$3, float $$4, float $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, $$3, $$4, $$7).a(255, 255, 255, 255).a($$5, $$6).c(gbl.d).b($$11).a($$1, (float)$$8, (float)$$9, (float)$$10).e();
   }
}
