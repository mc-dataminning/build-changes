public class fxh extends fxo {
   ...
   protected void aR_() {
      ...
      if ($$0 != null && !this.m.ad().c().contains("high_contrast")) {
         $$0.j = false;
         $$0.a(fqd.a(wo.c("options.accessibility.high_contrast.error.tooltip")));
      }
   ...
   protected void E() {
      ...
      $$0.a(fos.a(wo.c("options.accessibility.link"), fth.b(this, axv.l)).a());
      $$0.a(fos.a(wn.d, $$0x -> this.m.a(this.b)).a());
   }
