...
public class fxh {
   public static class a implements fxz<kq> {
      ...
      public fxw a(kq $$0, fuq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fxh.b $$8 = new fxh.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends fyw {
      b(fuq $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * axm.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fyi {
      private boolean b;
      private boolean F;
      private final fxy G;
      private float H;
      ...
      c(fuq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fxy $$7, fyr $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fxh.c $$0 = new fxh.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fxz<kq> {
      ...
      public fxw a(kq $$0, fuq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fxh.c $$8 = new fxh.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fby.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fxu {
      ...
      private int D;
      private final fxy E;
      private final List<cug> F;
      private boolean G;

      public e(fuq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fxy $$7, List<cug> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, aup.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            fxw $$12 = this.E.a(kn.M, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)aww.b.b($$11) / 255.0F, (float)aww.b.c($$11) / 255.0F, (float)aww.b.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               aun $$14 = $$13 ? auo.iN : auo.iM;
               this.c.a(this.g, this.h, this.i, $$14, aup.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         fxh.c $$10 = (fxh.c)this.E.a(kn.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = axm.d($$18, $$13, $$16) * $$0;
                  double $$20 = axm.d($$18, $$14, $$17) * $$0;
