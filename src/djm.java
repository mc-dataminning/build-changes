...
public class djm extends djp<djl> {
   ...
   public boolean a(djk $$0, djl $$1, ddx $$2, Function<gu, he<cnk>> $$3, apf $$4, dgw $$5, clt $$6, ddw $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         djp.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      djk $$0, djl $$1, ddx $$2, Function<gu, he<cnk>> $$3, dgw $$4, double $$5, double $$6, double $$7, float $$8, double $$9, ddw $$10, djp.a $$11
   ) {
      double $$12 = 1.5 + (double)(apa.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
