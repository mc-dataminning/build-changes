...
public abstract class djm implements djn, efl<bwi>, AutoCloseable {
   public static final Codec<alf<djm>> h = alf.a(mh.bp);
   public static final alf<djm> i = alf.a(mh.bp, alg.b("overworld"));
   public static final alf<djm> j = alf.a(mh.bp, alg.b("the_nether"));
   public static final alf<djm> k = alf.a(mh.bp, alg.b("the_end"));
   ...
   protected final List<dzp> s = Lists.newArrayList();
   protected final eyh t;
   private final List<dzp> a = Lists.newArrayList();
   private boolean b;
   ...
   private final jf<eeq> E;
   protected final ezo B;
   public final boolean C;
   private final ecl F;
   private final dkr G;
   private final alf<djm> H;
   private final jt I;
   private final buy J;
   private long K;

   protected djm(ezo $$0, alf<djm> $$1, jt $$2, jf<eeq> $$3, boolean $$4, boolean $$5, long $$6, int $$7) {
      this.B = $$0;
      this.E = $$3;
      final eeq $$8 = $$3.a();
      this.H = $$1;
      ...
      this.G = new dkr(this, $$6);
      this.d = $$5;
      this.t = new eyc(this, $$7);
      this.I = $$2;
      this.J = new buy($$2);
   }
   ...
   public eda d(int $$0, int $$1) {
      return (eda)this.a($$0, $$1, edr.n);
   }

   @Nullable
   @Override
   public ecq a(int $$0, int $$1, edr $$2, boolean $$3) {
      ecq $$4 = this.S().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(iv $$0, eat $$1, int $$2) {
   ...
   public boolean a(iv $$0, boolean $$1, @Nullable bwi $$2, int $$3) {
      ...
      if ($$4.l()) {
         ...
         exa $$5 = this.b_($$0);
         if (!($$4.b() instanceof dme)) {
            this.c(2001, $$0, dmr.j($$4));
         }

         if ($$1) {
            dxr $$6 = $$4.x() ? this.c_($$0) : null;
            dmr.a($$4, this, $$0, $$6, $$2, czn.k);
         }

         boolean $$7 = this.a($$0, $$5.g(), 3, $$3);
         if ($$7) {
            this.a(eft.f, $$0, eft.a.a($$2, $$4));
         }
   ...
   public boolean b(iv $$0, eat $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(iv var1, eat var2, eat var3, int var4);
   ...
   @Override
   public void a(jb $$0, iv $$1, iv $$2, eat $$3, int $$4, int $$5) {
   ...
   public eat a_(iv $$0) {
      if (this.t($$0)) {
         ...
         eda $$1 = this.d(jy.a($$0.u()), jy.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   protected void Y() {
      ...
      Iterator<dzp> $$1 = this.s.iterator();
      boolean $$2 = this.u().i();
   ...
   public boolean n(iv $$0) {
      return this.a(dir.a($$0));
   }

   public void a(@Nullable bwi $$0, double $$1, double $$2, double $$3, float $$4, djm.a $$5) {
      this.a($$0, djf.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, ly.w, ly.v, awn.kI);
   }

   public void a(@Nullable bwi $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, djm.a $$6) {
      this.a($$0, djf.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, ly.w, ly.v, awn.kI);
   }

   public void a(@Nullable bwi $$0, @Nullable bux $$1, @Nullable djg $$2, ffc $$3, float $$4, boolean $$5, djm.a $$6) {
      this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, ly.w, ly.v, awn.kI);
   }

   public void a(@Nullable bwi $$0, @Nullable bux $$1, @Nullable djg $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, djm.a $$8) {
   ...
   public dxr c_(iv $$0) {
      if (this.t($$0)) {
         ...
         return !this.C && Thread.currentThread() != this.c ? null : this.m($$0).a($$0, eda.b.a);
      }
   }
   ...
   public boolean a(iv $$0, bwi $$1, jb $$2) {
      if (this.t($$0)) {
         ...
         ecq $$3 = this.a(jy.a($$0.u()), jy.a($$0.w()), edr.n, false);
   ...
   public iv aa() {
      iv $$0 = this.B.a();
      if (!this.A_().a($$0)) {
         $$0 = this.a(egs.a.e, iv.a(this.A_().a(), 0.0, this.A_().b()));
      }
   ...
   public diq c(int $$0, int $$1) {
      return this.a($$0, $$1, edr.n, false);
   }

   @Override
   public List<bwi> a(@Nullable bwi $$0, fex $$1, Predicate<? super bwi> $$2) {
      bqp.a().f("getEntities");
   ...
   public <T extends bwi> void a(eff<bwi, T> $$0, fex $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bwi> void a(eff<bwi, T> $$0, fex $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      bqp.a().f("getEntities");
      this.H().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   public abstract Collection<cmh> s();
   ...
   public boolean r(iv $$0) {
      if (!this.ah()) {
         ...
         return false;
      } else if (this.a(egs.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         dkp $$1 = this.u($$0).a();
         return $$1.a($$0, this.P()) == dkp.c.b;
      }
   }

   @Nullable
   public abstract eyv a(eyt var1);

   public abstract void a(eyt var1, eyv var2);

   public abstract eyt x();
   ...
   public abstract fgh R();

   public void b(iv $$0, dmr $$1) {
      for (jb $$2 : jb.c.a) {
         iv $$3 = $$0.a($$2);
         if (this.C($$3)) {
            eat $$4 = this.a_($$3);
   ...
   public abstract dbi L();

   public abstract dyq M();
   ...
   public static enum a implements bak {
      ...
      public static final Codec<djm.a> f = bak.a(djm.a::values);
