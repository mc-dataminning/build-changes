...
public class eog implements eod {
   @Nullable
   ...
   public eog(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new eog.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements eoc {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / eog.this.c;
         this.d = ($$5 + (float)$$0 + eog.this.e) / eog.this.c;
         this.e = (eog.this.h - (float)$$2 + eog.this.f) / eog.this.c;
         this.g = $$6;
      }
      ...
      public ezy bake(Function<eoe, ezy> $$0) {
         return $$0.apply(new eoe() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = eog.this.b();
               epb $$3 = new epb(epb.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, eog.this.g, eog.this.g, eog.this.e, eog.this.f, 0, 0);
