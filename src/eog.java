...
public class eog extends eoe {
   ...
   private final btd i;
   private final ji<dlu> j;

   public eog(int $$0, int $$1, int $$2, btd $$3, float $$4, btd $$5, ji<dlu> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<emj.a> a(div $$0, BiConsumer<iu, dzo> $$1, azt $$2, int $$3, iu $$4, elt $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new emj.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(div $$0, BiConsumer<iu, dzo> $$1, azt $$2, int $$3, elt $$4, List<emj.a> $$5, iu.a $$6, int $$7, ja $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new emj.a($$16, 0, false));
         $$5.add(new emj.a($$16.c(2), 0, false));
      }
   }
