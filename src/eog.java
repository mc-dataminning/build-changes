...
public class eog extends eov {
   public static final MapCodec<eog> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               jk.a.e.fieldOf("axis").orElse(jk.a.b).forGetter($$0x -> $$0x.g)
            )
            .apply($$0, eog::new)
   );
   ...
   public eog(float $$0, float $$1, int $$2, int $$3, jk.a $$4) {
      if ($$2 >= $$3) {
