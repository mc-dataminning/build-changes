...
public class eog extends eor {
   ...
   public eoh a() {
      ...
      if (this.f() && this.b.be()) {
         ...
         for (dsc $$2 = this.a.a($$1); $$2.a(dfb.G); $$2 = this.a.a($$1)) {
   ...
   private boolean b(@Nullable eoh $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eoh $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   protected eom b(int $$0, int $$1, int $$2) {
      return (eom)this.l.computeIfAbsent(iz.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }

   @Override
   public eom a(eoo $$0, int $$1, int $$2, int $$3) {
      eom $$4 = $$0.a($$1, $$2, $$3);
      if ($$4 == eom.b && $$2 >= $$0.a().I_() + 1) {
         iz $$5 = new iz($$1, $$2 - 1, $$3);
         eom $$6 = $$0.a($$5.u(), $$5.v(), $$5.w());
         if ($$6 == eom.o || $$6 == eom.i) {
            $$4 = eom.o;
         } else if ($$6 == eom.q) {
            $$4 = eom.q;
            ...
            $$4 = $$6 != eom.c && $$6 != eom.b && $$6 != eom.j ? eom.c : eom.b;
         }
      }
