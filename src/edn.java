...
public record edn(edn.a a, byte b, byte c, byte d, @Nullable ur e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements aub {
      ...
      A("red_x", true, false),
      B("village_desert", true, eck.w.ak, false, true),
      C("village_plains", true, eck.w.ak, false, true),
      D("village_savanna", true, eck.w.ak, false, true),
      E("village_snowy", true, eck.w.ak, false, true),
      F("village_taiga", true, eck.w.ak, false, true),
      G("jungle_temple", true, eck.w.ak, false, true),
      H("swamp_hut", true, eck.w.ak, false, true);

      public static final Codec<edn.a> I = aub.a(edn.a::values);
      ...
      public static edn.a a(byte $$0) {
         return values()[ati.a($$0, 0, values().length - 1)];
      }
