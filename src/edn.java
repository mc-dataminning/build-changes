...
public class edn {
   ...
   static class a implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
         return $$0.c[ie.f.d()] && !$$0.b[ie.f.d()].d;
      }

      @Override
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         $$1.d = true;
         $$1.b[ie.f.d()].d = true;
         return new edn.k($$0, $$1);
      }
   }

   static class b implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         ...
         return new edn.l($$0, $$1);
      }
   }

   static class c implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         $$1.d = true;
         $$1.b[ie.b.d()].d = true;
         return new edn.m($$0, $$1);
      }
   }

   static class d implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         ...
         return new edn.n($$0, $$1);
      }
   }

   static class e implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         ...
         $$3.d = true;
         $$3.b[ie.c.d()].d = true;
         return new edn.o($$0, $$3);
      }
   }

   static class f implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
         return true;
      }
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         $$1.d = true;
         return new edn.s($$0, $$1, $$2);
      }
   }

   static class g implements edn.i {
      @Override
      public boolean a(edn.v $$0) {
      ...
      public edn.r a(ie $$0, edn.v $$1, awo $$2) {
         $$1.d = true;
         return new edn.t($$0, $$1);
      }
   }

   public static class h extends edn.r {
      ...
      private edn.v G;
      private edn.v H;
      private final List<edn.r> I = Lists.newArrayList();

      public h(awo $$0, int $$1, int $$2, ie $$3) {
         super(ebv.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<edn.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new edn.p($$3, this.G));
         this.I.add(new edn.j($$3, this.H));
         List<edn.i> $$5 = Lists.newArrayList();
         $$5.add(new edn.b());
         $$5.add(new edn.d());
         $$5.add(new edn.e());
         $$5.add(new edn.a());
         ...
         eaw $$10 = eaw.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eaw $$11 = eaw.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eaw $$12 = eaw.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new edn.u($$3, $$10, $$13++));
         this.I.add(new edn.u($$3, $$11, $$13++));
         this.I.add(new edn.q($$3, $$12));
      }
      ...
      private List<edn.v> b(awo $$0) {
         edn.v[] $$1 = new edn.v[75];
         ...
         edn.v $$23 = new edn.v(1003);
         edn.v $$24 = new edn.v(1001);
         edn.v $$25 = new edn.v(1002);
         $$1[v].a(ie.b, $$23);
         $$1[w].a(ie.d, $$24);
         $$1[x].a(ie.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<edn.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cwi $$2, awo $$3, eaw $$4) {
         int $$5 = 24;
      ...
      private void a(cwi $$0, awo $$1, eaw $$2) {
      ...
      private void b(cwi $$0, awo $$1, eaw $$2) {
      ...
      private void c(cwi $$0, awo $$1, eaw $$2) {
      ...
      private void d(cwi $$0, awo $$1, eaw $$2) {
      ...
      private void e(cwi $$0, awo $$1, eaw $$2) {
      ...
      private void f(cwi $$0, awo $$1, eaw $$2) {
   ...
   interface i {
      boolean a(edn.v var1);

      edn.r a(ie var1, edn.v var2, awo var3);
   }

   public static class j extends edn.r {
      public j(ie $$0, edn.v $$1) {
         super(ebv.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cwi $$0, cwg $$1, dnc $$2, awo $$3, eaw $$4, cuu $$5, hz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cyq.ch.o(), cyq.ch.o(), false);
   ...
   public static class k extends edn.r {
      public k(ie $$0, edn.v $$1) {
         super(ebv.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends edn.r {
      public l(ie $$0, edn.v $$1) {
         super(ebv.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends edn.r {
      public m(ie $$0, edn.v $$1) {
         super(ebv.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends edn.r {
      public n(ie $$0, edn.v $$1) {
         super(ebv.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends edn.r {
      public o(ie $$0, edn.v $$1) {
         super(ebv.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends edn.r {
      public p(ie $$0, edn.v $$1) {
         super(ebv.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends edn.r {
      public q(ie $$0, eaw $$1) {
         super(ebv.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ebi {
      protected static final dlf b = cyq.hZ.o();
      protected static final dlf c = cyq.ia.o();
      protected static final dlf d = cyq.ib.o();
      protected static final dlf h = c;
      protected static final dlf i = cyq.ii.o();
      protected static final boolean j = true;
      protected static final dlf k = cyq.G.o();
      protected static final Set<cyo> l = ImmutableSet.builder().add(cyq.dO).add(cyq.iC).add(cyq.mW).add(k.b()).build();
      ...
      public r(ebv $$0, ie $$1, int $$2, eaw $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ebv $$0, int $$1, ie $$2, edn.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eaw a(ie $$0, edn.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eaw $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cwi $$0, eaw $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dlf $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cwi $$0, eaw $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cwi $$0, eaw $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dlf $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eaw $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cwi $$0, eaw $$1, int $$2, int $$3, int $$4) {
         hz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cec $$6 = bnu.C.a((cvn)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eN());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bok.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends edn.r {
      private int a;

      public s(ie $$0, edn.v $$1, awo $$2) {
         super(ebv.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends edn.r {
      public t(ie $$0, edn.v $$1) {
         super(ebv.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends edn.r {
      private int a;

      public u(ie $$0, eaw $$1, int $$2) {
         super(ebv.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
