...
public record edn(Map<akt<eat>, eat> b) {
   public static final MapCodec<edn> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(Codec.unboundedMap(akt.a(mc.bf), eat.a).fieldOf("dimensions").forGetter(edn::d)).apply($$0, $$0.stable(edn::new))
   );
   private static final Set<akt<eat>> c = ImmutableSet.of(eat.b, eat.c, eat.d);
   private static final int d = c.size();

   public edn(Map<akt<eat>, eat> b) {
      eat $$1 = b.get(eat.b);
      if ($$1 == null) {
   ...
   public static Stream<akt<eat>> a(Stream<akt<eat>> $$0) {
      return Stream.concat(c.stream(), $$0.filter($$0x -> !c.contains($$0x)));
   }

   public edn a(jt.a $$0, dyt $$1) {
      jt<eas> $$2 = $$0.d(mc.aN);
      Map<akt<eat>, eat> $$3 = a($$2, this.b, $$1);
      return new edn($$3);
   }

   public static Map<akt<eat>, eat> a(jt<eas> $$0, Map<akt<eat>, eat> $$1, dyt $$2) {
      eat $$3 = $$1.get(eat.b);
      jr<eas> $$4 = (jr<eas>)($$3 == null ? $$0.b(eaq.a) : $$3.a());
      return a($$1, $$4, $$2);
   }

   public static Map<akt<eat>, eat> a(Map<akt<eat>, eat> $$0, jr<eas> $$1, dyt $$2) {
      Builder<akt<eat>, eat> $$3 = ImmutableMap.builder();
      $$3.putAll($$0);
   ...
   public Optional<eat> a(akt<eat> $$0) {
      return Optional.ofNullable(this.b.get($$0));
   }

   public ImmutableSet<akt<dgi>> b() {
   ...
   static Lifecycle a(akt<eat> $$0, eat $$1) {
      return b($$0, $$1) ? Lifecycle.stable() : Lifecycle.experimental();
   }

   private static boolean b(akt<eat> $$0, eat $$1) {
      if ($$0 == eat.b) {
         return a($$1);
      } else if ($$0 == eat.c) {
         return b($$1);
   ...
   public edn.b a(ke<eat> $$0) {
      Stream<akt<eat>> $$1 = Stream.concat($$0.j().stream(), this.b.keySet().stream()).distinct();

      record a(akt<eat> a, eat b) {
