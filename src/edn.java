...
public class edn implements edi {
   public static final Codec<edn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               lq.e.r().fieldOf("block").flatXmap(edn::a, DataResult::success).orElse((dkf)dfh.fg).forGetter($$0x -> $$0x.b),
   ...
   public final jn<dff> h;
   private final ObjectArrayList<jf> i;

   private static DataResult<dkf> a(dff $$0) {
      return $$0 instanceof dkf $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public edn(dkf $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jn<dff> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<jf> a(aym $$0, jf $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<jf> a(aym $$0) {
