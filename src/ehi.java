...
public class ehi extends egv<eis> {
   public ehi(Codec<eis> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egx<eis> $$0) {
      jh $$1 = $$0.e();
      dif $$2 = $$0.b();
      $$1 = new jh($$1.u(), $$0.c().f(), $$1.w());
      bam $$3 = $$0.d();
      boolean $$4 = $$3.j() > 0.7;
      dxu $$5 = $$0.f().b;
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? bae.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(bam $$0, dhi $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dhi $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dhi $$0, jh $$1) {
      if ($$0.a_($$1.d()).a(dkn.ea)) {
         this.a($$0, $$1.d(), dkn.a.m());
      }
   }

   private void a(dhi $$0, bam $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dxu $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, jh.c, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, jh.c, $$7, $$1);
      if ($$14 < 0.0) {
         jh $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(jh $$0, dhi $$1, bam $$2, int $$3, int $$4, boolean $$5, boolean $$6, dxu $$7) {
      dxu $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dkn.ec) || $$8.a(dkn.eb) || $$8.a(dkn.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dkn.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dkn.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, jh $$2, int $$3, bam $$4) {
      float $$5 = 10.0F * bae.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, jh $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(bam $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(bam $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dxu $$0) {
      return $$0.a(dkn.iT) || $$0.a(dkn.ec) || $$0.a(dkn.nr);
   }
   ...
   private void a(dhi $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dkn.ea)) {
                  if (this.a((dgm)$$0, $$10)) {
                     this.a($$0, $$10, dkn.a.m());
                     this.a($$0, $$10.d(), dkn.a.m());
                  } else if (c($$11)) {
                     dxu[] $$12 = new dxu[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
