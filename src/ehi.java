...
public class ehi extends efy<eiw> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<ehi.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new ehi.b());

   public ehi(Codec<eiw> $$0) {
      super($$0);
   }

   public static List<ehi.a> a(dhg $$0) {
      azh $$1 = azh.a($$0.E());
      long $$2 = $$1.g() & 65535L;
      return (List<ehi.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(ega<eiw> $$0) {
      eiw $$1 = $$0.f();
      dhg $$2 = $$0.b();
      azh $$3 = $$0.d();
      ji $$4 = $$0.e();
   ...
   private void a(dgz $$0, azh $$1, eiw $$2, ehi.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dwx $$18 = djo.fk
                        .m()
                        .b(dnp.a, Boolean.valueOf($$16 && $$11 != -2))
                        .b(dnp.c, Boolean.valueOf($$16 && $$11 != 2))
                        .b(dnp.d, Boolean.valueOf($$17 && $$10 != -2))
                        .b(dnp.b, Boolean.valueOf($$17 && $$10 != 2));
      ...
      if ($$19 != null) {
         ...
         $$0.b($$19);
         ji $$20 = $$19.dw();
         this.a($$0, $$20.e(), djo.I.m());
         this.a($$0, $$20, dmn.a($$0, $$20));
      }
   }
   ...
   public static class a {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new fav((double)($$0 - $$2), (double)eas.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)eas.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<ehi.a>> {
      public List<ehi.a> a(Long $$0) {
         IntArrayList $$1 = af.a(IntStream.range(0, 10), azh.a($$0));
         List<ehi.a> $$2 = Lists.newArrayList();
