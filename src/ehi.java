...
public class ehi {
   private static final ehi a = new ehi(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public ehi.a a(int $$0, int $$1) {
         return new ehi.a(1.0, 0.0);
      }
   ...
   private static final evr b = evr.b(new ehh(42L), ql.a);
   ...
   private final Long2ObjectOpenHashMap<ehj> h;
   private final Long2ObjectOpenHashMap<ehj> i;

   public static ehi a() {
      return a;
   }

   public static ehi a(@Nullable ary $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dih $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<ehj> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<ehj> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azm.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new ehi($$2, $$3);
         }
      }
   }

   ehi(Long2ObjectOpenHashMap<ehj> $$0, Long2ObjectOpenHashMap<ehj> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public ehi.a a(int $$0, int $$1) {
      int $$2 = jp.a($$0);
      int $$3 = jp.a($$1);
      double $$4 = this.a($$2, 0, $$3, ehj::a);
      if ($$4 != Double.MAX_VALUE) {
         return new ehi.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jp.d(dih.a($$5x)), jp.d(dih.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(efz.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jp.d(dih.a($$6x)), jp.d(dih.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, ehi.b $$3) {
      int $$4 = jp.e($$0);
      int $$5 = jp.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(ehi.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      ehj $$6 = (ehj)this.h.get(dih.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jp.d($$1), $$4, $$5 - jp.d($$2)) : Double.MAX_VALUE;
   }

   public dkg a(dkg $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         je<dkd> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private je<dkd> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<je<dkd>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jp.d(dih.a($$5x)), $$1, jp.d(dih.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(ary $$0, ece $$1) {
      dih $$2 = $$1.f();
      boolean $$3 = $$1.u();
      iu.a $$4 = new iu.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(egg.a.e, $$16, $$17)) + 1;
   ...
   private static void a(ece $$0, iu $$1) {
      eah $$2 = $$0.a_($$1);
      if ($$2.a(axc.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(djz $$0, ecy $$1) {
      dih $$2 = $$1.f();
      Builder<jb, ehj> $$3 = ImmutableMap.builder();
   ...
   public static ehi.c a(@Nullable ehj $$0, Map<jb, ehj> $$1) {
      List<ehi.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static ehi.c a(@Nullable jb $$0, ehj $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ja $$4 : $$0.a()) {
   ...
   interface b {
      double get(ehj var1, int var2, int var3, int var4);
   }
