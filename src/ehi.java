...
public class ehi {
   ...
   @Nullable
   private static hc a(ehi $$0, ehn $$1, double[] $$2, @Nullable hc $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ehn f() {
      return new ehn(arx.d(0.5, this.a, this.d), arx.d(0.5, this.b, this.e), arx.d(0.5, this.c, this.f));
   }
