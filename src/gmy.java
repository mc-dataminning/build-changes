...
public class gmy {
   ...
   public void a(dgh $$0, glx $$1, int $$2, float $$3, faz $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = fli.N() ? 10 : 5;
         List<gmy.a> $$7 = new ArrayList<>();
         List<gmy.a> $$8 = new ArrayList<>();
   ...
   private void a(dgh $$0, int $$1, float $$2, faz $$3, int $$4, List<gmy.a> $$5, List<gmy.a> $$6) {
      int $$7 = ayz.a($$3.d);
      int $$8 = ayz.a($$3.e);
      int $$9 = ayz.a($$3.f);
      ji.a $$10 = new ji.a();
   ...
   private void a(glx $$0, faz $$1, int $$2, float $$3, List<gmy.a> $$4, List<gmy.a> $$5) {
      if (!$$4.isEmpty()) {
         gmh $$6 = gmh.f(c, fli.O());
   ...
   private gmy.a a(azh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      int $$8 = $$1 & 131071;
      int $$9 = $$2 * $$2 * 3121 + $$2 * 45238971 + $$5 * $$5 * 418711 + $$5 * 13761 & 0xFF;
      float $$10 = 3.0F + $$0.i();
      float $$11 = -((float)($$8 + $$9) + $$7) / 32.0F * $$10;
      float $$12 = $$11 % 32.0F;
      return new gmy.a($$2, $$5, $$3, $$4, 0.0F, $$12, $$6);
   }

   private gmy.a b(azh $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, float $$7) {
      float $$8 = (float)$$1 + $$7;
      float $$9 = (float)($$0.j() + (double)($$8 * 0.01F * (float)$$0.k()));
      float $$10 = (float)($$0.j() + (double)($$8 * (float)$$0.k() * 0.001F));
      float $$11 = -((float)($$1 & 511) + $$7) / 512.0F;
      int $$12 = glv.a((glv.a($$6) * 3 + 15) / 4, (glv.b($$6) * 3 + 15) / 4);
      return new gmy.a($$2, $$5, $$3, $$4, $$9, $$11 + $$10, $$12);
   }

   private void a(ffx $$0, List<gmy.a> $$1, faz $$2, float $$3, int $$4, float $$5) {
      for (gmy.a $$6 : $$1) {
   ...
   public void a(gfy $$0, fkq $$1, int $$2, aqv $$3) {
      float $$4 = $$0.d(1.0F) / (fli.N() ? 1.0F : 2.0F);
      if (!($$4 <= 0.0F)) {
         ...
         for (int $$9 = 0; $$9 < $$8; $$9++) {
            int $$10 = $$5.a(21) - 10;
            int $$11 = $$5.a(21) - 10;
            ji $$12 = $$0.a(ecr.a.e, $$6.b($$10, 0, $$11));
            if ($$12.v() > $$0.L_() && $$12.v() <= $$6.v() + 10 && $$12.v() >= $$6.v() - 10 && this.a($$0, $$12) == dhj.c.b) {
               $$7 = $$12.e();
               if ($$3 == aqv.c) {
                  break;
               }
               ...
               lr $$21 = !$$16.a(awv.b) && !$$15.a(djn.ll) && !dka.h($$15) ? lt.af : lt.ag;
         ...
         if ($$7 != null && $$5.a(3) < this.g++) {
            this.g = 0;
            if ($$7.v() > $$6.v() + 1 && $$0.a(ecr.a.e, $$6).v() > ayz.d((float)$$6.v())) {
