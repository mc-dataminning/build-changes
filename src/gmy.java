public class gmy extends giu<gbj, fub<gbj>> {
   ...
   public void a(gbj $$0, float $$1, float $$2, eyu $$3, gck $$4, int $$5) {
      this.b($$0);
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
   }

   public eum a(gbj $$0, float $$1) {
      return $$0.ca() ? new eum(0.0, (double)($$0.ee() * -2.0F) / 16.0, 0.0) : super.a($$0, $$1);
   }
   ...
   private static ftj.a a(gbj $$0, bpv $$1) {
      ctq $$2 = $$0.b($$1);
      if ($$2.e()) {
         return ftj.a.a;
      } else {
         ...
         } else if (!$$0.aJ && $$2.a(ctt.vT) && csd.j($$2)) {
            return ftj.a.g;
         }
   ...
   protected void a(gbj $$0, eyu $$1, float $$2) {
      float $$3 = 0.9375F;
      $$1.b(0.9375F, 0.9375F, 0.9375F);
   }

   protected void a(gbj $$0, wx $$1, eyu $$2, gck $$3, int $$4, float $$5) {
      double $$6 = this.c.b($$0);
      $$2.a();
      if ($$6 < 100.0) {
         evq $$7 = $$0.gr();
   ...
   public void a(eyu $$0, gck $$1, int $$2, gbj $$3) {
      this.a($$0, $$1, $$2, $$3, this.f.n, this.f.w);
   }

   public void b(eyu $$0, gck $$1, int $$2, gbj $$3) {
      this.a($$0, $$1, $$2, $$3, this.f.o, this.f.b);
   }

   private void a(eyu $$0, gck $$1, int $$2, gbj $$3, fvw $$4, fvw $$5) {
      fub<gbj> $$6 = this.a();
      this.b($$3);
      $$6.c = 0.0F;
      $$6.t = false;
   ...
   protected void a(gbj $$0, eyu $$1, float $$2, float $$3, float $$4, float $$5) {
      float $$6 = $$0.a($$4);
      float $$7 = $$0.g($$4);
      if ($$0.fE()) {
         super.a($$0, $$1, $$2, $$3, $$4, $$5);
         float $$8 = (float)$$0.fF() + $$4;
         float $$9 = ayf.a($$8 * $$8 / 100.0F, 0.0F, 1.0F);
         if (!$$0.fr()) {
