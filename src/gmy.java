...
public class gmy {
   ...
   public void a(dgi $$0, glx $$1, int $$2, float $$3, fba $$4) {
      float $$5 = $$0.d($$3);
      if (!($$5 <= 0.0F)) {
         int $$6 = flj.N() ? 10 : 5;
   ...
   private void a(dgi $$0, int $$1, float $$2, fba $$3, int $$4, List<gmy.a> $$5, List<gmy.a> $$6) {
      int $$7 = ayz.a($$3.d);
      int $$8 = ayz.a($$3.e);
      int $$9 = ayz.a($$3.f);
      ji.a $$10 = new ji.a();
   ...
   private void a(glx $$0, fba $$1, int $$2, float $$3, List<gmy.a> $$4, List<gmy.a> $$5) {
      if (!$$4.isEmpty()) {
         gmh $$6 = gmh.f(c, flj.O());
   ...
   private void a(ffy $$0, List<gmy.a> $$1, fba $$2, float $$3, int $$4, float $$5) {
      for (gmy.a $$6 : $$1) {
   ...
   public void a(gfy $$0, fkr $$1, int $$2, aqu $$3) {
      ...
      if (!($$4 <= 0.0F)) {
         ...
         if ($$7 != null && $$5.a(3) < this.g++) {
            ...
            if ($$7.v() > $$6.v() + 1 && $$0.a(ecs.a.e, $$6).v() > ayz.d((float)$$6.v())) {
               $$0.a($$7, awa.CT, awb.d, 0.1F, 0.5F, false);
            } else {
               $$0.a($$7, awa.CS, awb.d, 0.2F, 1.0F, false);
            }
         }
      }
   }
