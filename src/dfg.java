...
public class dfg {
   ...
   private final Map<Character, Predicate<dfe>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dfg a(char $$0, Predicate<dfe> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<dfe>[][][] c() {
      this.d();
      Predicate<dfe>[][][] $$0 = (Predicate<dfe>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dfe>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
