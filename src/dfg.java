...
public abstract class dfg implements ew {
   private static final SimpleDateFormat b = new SimpleDateFormat("HH:mm:ss");
   private static final wo c = wo.b("@");
   private long d = -1L;
   ...
   public wo l() {
      return this.h == null ? wn.a : this.h;
   }
   ...
   public tq a(tq $$0, jt.a $$1) {
      ...
      if (this.j != null) {
         $$0.a("CustomName", wo.a.a(this.j, $$1));
      }

      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", wo.a.a(this.h, $$1));
      }
   ...
   public void b(tq $$0, jt.a $$1) {
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = wo.a.a($$0.l("LastOutput"), $$1);
         } catch (Throwable var4) {
            this.h = wo.b(var4.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public void a(wo $$0) {
      if (this.g) {
         this.h = wo.b("[" + b.format(new Date()) + "] ").b($$0);
         this.f();
      }
   }
   ...
   public abstract fay g();

   public abstract ex i();

   @Override
   public boolean y_() {
      return this.e().O().b(dgc.p) && this.g;
   }
