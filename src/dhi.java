...
public abstract class dhi implements dhj, AutoCloseable {
   ...
   protected dhi(ewk $$0, aly<dhi> $$1, ke $$2, jq<ebq> $$3, boolean $$4, boolean $$5, long $$6, int $$7) {
      this.B = $$0;
      this.E = $$3;
      final ebq $$8 = $$3.a();
      this.H = $$1;
      ...
      this.G = new dim(this, $$6);
      this.d = $$5;
      this.t = new euz(this, $$7);
      this.I = $$2;
      this.J = new bub($$2);
   }
   ...
   public eaa d(int $$0, int $$1) {
      return (eaa)this.a($$0, $$1, ear.n);
   }

   @Nullable
   @Override
   public dzq a(int $$0, int $$1, ear $$2, boolean $$3) {
      dzq $$4 = this.R().a($$0, $$1, $$2, $$3);
      if ($$4 == null && $$3) {
   ...
   @Override
   public boolean a(jh $$0, dxv $$1, int $$2) {
      return this.a($$0, $$1, $$2, 512);
   }

   @Override
   public boolean a(jh $$0, dxv $$1, int $$2, int $$3) {
      if (this.s($$0)) {
         return false;
         ...
         if ($$6 == null) {
            ...
            if ($$7 == $$1) {
               ...
               if (($$2 & 2) != 0 && (!this.C || ($$2 & 4) == 0) && (this.C || $$4.F() != null && $$4.F().a(arw.c))) {
                  this.a($$0, $$6, $$1, $$2);
               }
   ...
   @Override
   public boolean a(jh $$0, boolean $$1, @Nullable bvk $$2, int $$3) {
      dxv $$4 = this.a_($$0);
      if ($$4.l()) {
         return false;
      } else {
         etx $$5 = this.b_($$0);
         if (!($$4.b() instanceof djz)) {
            this.c(2001, $$0, dkm.j($$4));
         }

         if ($$1) {
            dux $$6 = $$4.x() ? this.c_($$0) : null;
            dkm.a($$4, this, $$0, $$6, $$2, cxp.j);
         }

         boolean $$7 = this.a($$0, $$5.g(), 3, $$3);
         if ($$7) {
            this.a(ecr.f, $$0, ecr.a.a($$2, $$4));
         }
   ...
   public boolean b(jh $$0, dxv $$1) {
      return this.a($$0, $$1, 3);
   }

   public abstract void a(jh var1, dxv var2, dxv var3, int var4);

   public void b(jh $$0, dxv $$1, dxv $$2) {
   }
   ...
   @Override
   public void a(jm $$0, jh $$1, jh $$2, dxv $$3, int $$4, int $$5) {
   ...
   public dxv a_(jh $$0) {
      if (this.s($$0)) {
         ...
         eaa $$1 = this.d(kj.a($$0.u()), kj.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable bvk $$0, jh $$1, axe $$2, axg $$3, float $$4, float $$5) {
      this.a($$0 instanceof cpx $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }

   @Override
   public void a(@Nullable cpx $$0, jh $$1, axe $$2, axg $$3, float $$4, float $$5) {
      this.a($$0, (double)$$1.u() + 0.5, (double)$$1.v() + 0.5, (double)$$1.w() + 0.5, $$2, $$3, $$4, $$5);
   }

   public abstract void a(@Nullable cpx var1, double var2, double var4, double var6, jq<axe> var8, axg var9, float var10, float var11, long var12);

   public void a(@Nullable cpx $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, ma.b.e($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cpx var1, bvk var2, jq<axe> var3, axg var4, float var5, float var6, long var7);

   public void a(@Nullable cpx $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 1.0F, 1.0F);
   }

   public void a(@Nullable cpx $$0, double $$1, double $$2, double $$3, axe $$4, axg $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cpx $$0, double $$1, double $$2, double $$3, jq<axe> $$4, axg $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cpx $$0, bvk $$1, axe $$2, axg $$3, float $$4, float $$5) {
   ...
   public void a(bvk $$0, axe $$1, axg $$2, float $$3, float $$4) {
   }
   ...
   protected void W() {
      ...
      Iterator<dws> $$1 = this.s.iterator();
      boolean $$2 = this.t().i();
   ...
   public <T extends bvk> void a(Consumer<T> $$0, T $$1) {
      try {
         $$0.accept($$1);
   ...
   public boolean n(jh $$0) {
      return this.a(dgo.a($$0));
   }

   public void a(@Nullable bvk $$0, double $$1, double $$2, double $$3, float $$4, dhi.a $$5) {
      this.a($$0, dha.a(this, $$0), null, $$1, $$2, $$3, $$4, false, $$5, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvk $$0, double $$1, double $$2, double $$3, float $$4, boolean $$5, dhi.a $$6) {
      this.a($$0, dha.a(this, $$0), null, $$1, $$2, $$3, $$4, $$5, $$6, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvk $$0, @Nullable bua $$1, @Nullable dhb $$2, fby $$3, float $$4, boolean $$5, dhi.a $$6) {
      this.a($$0, $$1, $$2, $$3.a(), $$3.b(), $$3.c(), $$4, $$5, $$6, ls.w, ls.v, axf.ky);
   }

   public void a(@Nullable bvk $$0, @Nullable bua $$1, @Nullable dhb $$2, double $$3, double $$4, double $$5, float $$6, boolean $$7, dhi.a $$8) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8, ls.w, ls.v, axf.ky);
   }
   ...
   public dux c_(jh $$0) {
      if (this.s($$0)) {
         ...
         return !this.C && Thread.currentThread() != this.c ? null : this.m($$0).a($$0, eaa.b.a);
      }
   }
   ...
   public boolean a(jh $$0, bvk $$1, jm $$2) {
      if (this.s($$0)) {
         return false;
      } else {
         dzq $$3 = this.a(kj.a($$0.u()), kj.a($$0.w()), ear.n, false);
         return $$3 == null ? false : $$3.a_($$0).a(this, $$0, $$1, $$2);
      }
   }

   public boolean a(jh $$0, bvk $$1) {
   ...
   public jh Y() {
      jh $$0 = this.B.a();
      if (!this.F_().a($$0)) {
         $$0 = this.a(edq.a.e, jh.a(this.F_().a(), 0.0, this.F_().b()));
      }
   ...
   public dgn c(int $$0, int $$1) {
      return this.a($$0, $$1, ear.n, false);
   }

   @Override
   public List<bvk> a(@Nullable bvk $$0, fbt $$1, Predicate<? super bvk> $$2) {
      bps.a().f("getEntities");
      List<bvk> $$3 = Lists.newArrayList();
      this.G().a($$1, $$3x -> {
         if ($$3x != $$0 && $$2.test($$3x)) {
            $$3.add($$3x);
         }

         if ($$3x instanceof cku) {
            for (ckr $$4 : ((cku)$$3x).x()) {
               if ($$3x != $$0 && $$2.test($$4)) {
                  $$3.add($$4);
               }
   ...
   @Override
   public <T extends bvk> List<T> a(ecf<bvk, T> $$0, fbt $$1, Predicate<? super T> $$2) {
      List<T> $$3 = Lists.newArrayList();
      this.a($$0, $$1, $$2, $$3);
      return $$3;
   }

   public <T extends bvk> void a(ecf<bvk, T> $$0, fbt $$1, Predicate<? super T> $$2, List<? super T> $$3) {
      this.a($$0, $$1, $$2, $$3, Integer.MAX_VALUE);
   }

   public <T extends bvk> void a(ecf<bvk, T> $$0, fbt $$1, Predicate<? super T> $$2, List<? super T> $$3, int $$4) {
      bps.a().f("getEntities");
      this.G().a($$0, $$1, $$4x -> {
         if ($$2.test((T)$$4x)) {
            $$3.add((T)$$4x);
   ...
   @Nullable
   public abstract bvk a(int var1);
   ...
   public boolean r(jh $$0) {
      if (!this.af()) {
         ...
         return false;
      } else if (this.a(edq.a.e, $$0).v() > $$0.v()) {
         return false;
      } else {
         dik $$1 = this.t($$0).a();
         return $$1.a($$0, this.O()) == dik.c.b;
      }
   }

   @Nullable
   public abstract evr a(evp var1);

   public abstract void a(evp var1, evr var2);
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<dae> $$6) {
   }

   public abstract fdd Q();

   public void c(jh $$0, dkm $$1) {
      for (jm $$2 : jm.c.a) {
         jh $$3 = $$0.a($$2);
         if (this.B($$3)) {
            dxv $$4 = this.a_($$3);
   ...
   public bth d_(jh $$0) {
      ...
      return new bth(this.al(), this.ad(), $$1, $$2);
   }
   ...
   @Override
   public boolean b(jh $$0, Predicate<etx> $$1) {
   ...
   public static enum a implements bba {
      ...
      public static final Codec<dhi.a> f = bba.a(dhi.a::values);
