...
public class dpm {
   ...
   private final ctk p;
   private static final List<cwj> q = List.of(cwl.l, cwl.L, cwl.i, cwl.b, cwl.k, cwl.I, cwl.K, cwl.fl, cwl.dP, cwl.iA, cwl.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ih<cuh>>> t;
   ...
   public static final Codec<dpm> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dpm::a, Function.identity());

   private static DataResult<dpm> a(dpm $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dpm(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ih<cuh>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = iz.c($$0);
      int $$5 = iz.c($$1) - $$4;
   ...
   @Nullable
   public static dpm a(ang $$0, int $$1, int $$2) {
      dkw $$3 = $$0.a($$1, $$2);
      dpm $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dlb.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<id> a(cud $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dkw $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, aui.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dkw $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(doj.a.a)) {
         $$3 = Math.min($$0.a(doj.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }
   ...
   private static double a(dkw $$0, hx.a $$1) {
      return a($$0, (hx)$$1.c(ic.a)) ? 1.0 : -1.0;
   }

   private static double b(dkw $$0, hx.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dkw $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ih<cuh>> b(dkw $$0, int $$1, int $$2) {
      ObjectArrayList<ih<cuh>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dkw $$0, hx $$1) {
      dja $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(asb.O)) {
         ...
         return $$2.a(cwl.eT) || $$2.a(cwl.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dpm.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dpm.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ih<cuh> var3);
   }
