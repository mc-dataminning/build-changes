...
public abstract class cnd extends cnp {
   ...
   private static final akk<Byte> g = ako.a(cnd.class, akm.a);
   private static final akk<Byte> h = ako.a(cnd.class, akm.a);
   ...
   @Nullable
   private List<bsu> r;
   private cup s = this.x();

   protected cnd(bta<? extends cnd> $$0, dby $$1) {
      super($$0, $$1);
   }

   protected cnd(bta<? extends cnd> $$0, dby $$1, cup $$2) {
      this($$0, $$1);
      this.s = $$2.s();
      this.b($$2.a(km.g));
      bac $$3 = $$2.c(km.u);
   ...
   protected cnd(bta<? extends cnd> $$0, double $$1, double $$2, double $$3, dby $$4, cup $$5) {
      this($$0, $$4, $$5);
      this.a_($$1, $$2, $$3);
   }

   protected cnd(bta<? extends cnd> $$0, btp $$1, dby $$2, cup $$3) {
   ...
   public void l() {
      ...
      if (this.b && !$$0) {
         ...
         evr $$8 = this.dn();
         evr $$9 = $$8.e($$1);
         evp $$10 = this.dP().a(new dbh($$8, $$9, dbh.a.a, dbh.b.a, this));
         if ($$10.c() != evp.a.a) {
            $$9 = $$10.e();
         }
   ...
   private boolean H() {
      return this.b && this.dP().b(new evm(this.dn(), this.dn()).g(0.06));
   }
   ...
   protected void a(evo $$0) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof btp $$10) {
            if (!this.dP().B && this.D() <= 0) {
               $$10.q($$10.eT() + 1);
            }

            if (this.o > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.g(bux.n));
               evr $$12 = this.ds().d(1.0, 0.0, 1.0).d().a((double)this.o * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dP().B && $$5 instanceof btp) {
               dab.a($$10, $$5);
               dab.b((btp)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof cmx && $$5 instanceof arg && !this.aW()) {
   ...
   protected void a(evn $$0) {
      ...
      super.a($$0);
      evr $$1 = $$0.e().a(this.du(), this.dw(), this.dA());
      this.h($$1);
      evr $$2 = $$1.d().a(0.05F);
   ...
   protected evo a(evr $$0, evr $$1) {
      return cnr.a(this.dP(), this, $$0, $$1, this.cK().b(this.ds()).g(1.0), this::b);
   }
   ...
   public void a(us $$0) {
      ...
      if ($$0.b("item", 10)) {
         this.a(cup.a(this.dR(), (vp)$$0.p("item")).orElse(this.x()));
      } else {
         this.a(this.x());
      }
   }
   ...
   public void c(@Nullable bsu $$0) {
      super.c($$0);
      if ($$0 instanceof cmx && this.d == cnd.a.a) {
         this.d = cnd.a.b;
      }
   }
   ...
   @Override
   public buh a_(int $$0) {
      return $$0 == 0 ? buh.a(this::y, this::a) : super.a_($$0);
   }
