...
public class cnd extends chu implements bxg<Optional<cwm>>, cmp {
   private static final alz d = alz.b("covered");
   private static final bxm bZ = new bxm(d, 20.0, bxm.a.a);
   protected static final alc<jm> a = alg.a(cnd.class, ale.q);
   protected static final alc<Byte> b = alg.a(cnd.class, ale.a);
   protected static final alc<Byte> c = alg.a(cnd.class, ale.a);
   ...
   public cnd(bvr<? extends cnd> $$0, dhi $$1) {
      super($$0, $$1);
      this.bO = 5;
   ...
   @Override
   protected void B() {
      this.bT.a(1, new cdm(this, cpx.class, 8.0F, 0.02F, true));
      this.bT.a(4, new cnd.a());
      this.bT.a(7, new cnd.f());
      this.bT.a(8, new cdz(this));
      this.bU.a(1, new cew(this, this.getClass()).a());
      this.bU.a(2, new cnd.e(this));
      this.bU.a(3, new cnd.c(this));
   }
   ...
   public static bxn.a m() {
      return bwi.C().a(bxo.s, 30.0);
   }

   @Override
   protected ccc G() {
      return new cnd.b(this);
   }
   ...
   private void gr() {
      ...
      float $$3 = ($$0 - $$1) * this.ek();
      if (!($$3 <= 0.0F)) {
         for (bvk $$5 : this.dW().a(this, a(this.ek(), $$2, $$1, $$0).d(this.dB() - 0.5, this.dD(), this.dH() - 0.5), bvp.f.and($$0x -> !$$0x.z(this)))) {
            if (!($$5 instanceof cnd) && !$$5.ad) {
               $$5.a(bwk.e, new fby((double)($$3 * (float)$$2.j()), (double)($$3 * (float)$$2.k()), (double)($$3 * (float)$$2.l())));
            }
         }
      }
   }

   public static fbt a(float $$0, jm $$1, float $$2) {
      return a($$0, $$1, -1.0F, $$2);
   }

   public static fbt a(float $$0, jm $$1, float $$2, float $$3) {
      fbt $$4 = new fbt(0.0, 0.0, 0.0, (double)$$0, (double)$$0, (double)$$0);
   ...
   boolean a(jh $$0, jm $$1) {
      if (this.i($$0)) {
         ...
         if (!this.dW().a($$0.a($$1), this, $$2)) {
            ...
            fbt $$3 = a(this.ek(), $$2, 1.0F).a($$0).h(1.0E-6);
   ...
   private boolean i(jh $$0) {
      ...
      if ($$1.l()) {
         ...
         boolean $$2 = $$1.a(dko.bX) && $$0.equals(this.dw());
         return !$$2;
      }
   }
   ...
   protected boolean p() {
      if (!this.gb() && this.bL()) {
         ...
         for (int $$1 = 0; $$1 < 5; $$1++) {
            ...
            if ($$2.v() > this.dW().L_() && this.dW().u($$2) && this.dW().F_().a($$2) && this.dW().a(this, new fbt($$2).h(1.0E-6))) {
               jm $$3 = this.h($$2);
               if ($$3 != null) {
                  this.ao();
                  this.a($$3);
                  ...
                  this.dW().a(ecr.R, $$0, ecr.a.a(this));
                  this.al.a(b, (byte)0);
                  this.h(null);
                  return true;
               }
   ...
   private void gt() {
      ...
      fbt $$1 = this.cR();
      if (!this.gs() && this.p()) {
         int $$2 = this.dW().a(bvr.bc, $$1.g(8.0), bvk::bL).size();
         float $$3 = (float)($$2 - 1) / 5.0F;
         if (!(this.dW().A.i() < $$3)) {
            cnd $$4 = bvr.bc.a(this.dW(), bvq.e);
            if ($$4 != null) {
               $$4.a(this.x());
               $$4.e($$0);
               this.dW().b($$4);
   ...
   class a extends cde {
      ...
      public boolean b() {
         bwg $$0 = cnd.this.O_();
         return $$0 != null && $$0.bL() ? cnd.this.dW().al() != btg.a : false;
      }
      ...
      @Override
      public void a() {
         if (cnd.this.dW().al() != btg.a) {
            this.b--;
            bwg $$0 = cnd.this.O_();
            if ($$0 != null) {
               cnd.this.H().a($$0, 180.0F, 180.0F);
               double $$1 = cnd.this.g((bvk)$$0);
               if ($$1 < 400.0) {
                  if (this.b <= 0) {
                     this.b = 20 + cnd.this.ae.a(10) * 20 / 2;
                     cnd.this.dW().b(new cqt(cnd.this.dW(), cnd.this, $$0, cnd.this.t().o()));
                     cnd.this.a(axf.xp, 2.0F, (cnd.this.ae.i() - cnd.this.ae.i()) * 0.2F + 1.0F);
                  }
               } else {
                  cnd.this.h(null);
               }
   ...
   static class c extends cex<bwg> {
      public c(cnd $$0) {
         super($$0, bwg.class, 10, true, false, ($$0x, $$1) -> $$0x instanceof cmp);
      }
   ...
   class d extends ccg {
      ...
      protected Optional<Float> i() {
         jm $$0 = cnd.this.t().g();
         Vector3f $$1 = $$0.b().transform(new Vector3f(cnd.ch));
         kl $$2 = $$0.q();
   ...
   class e extends cex<cpx> {
      public e(final cnd $$0) {
         super($$0, cpx.class, true);
      }

      @Override
      public boolean b() {
         return cnd.this.dW().al() == btg.a ? false : super.b();
      }
   ...
   class f extends cde {
      ...
      @Override
      public boolean b() {
         return cnd.this.O_() == null && cnd.this.ae.a(b(40)) == 0 && cnd.this.a(cnd.this.dw(), cnd.this.t());
      }

      @Override
      public boolean c() {
         return cnd.this.O_() == null && this.b > 0;
      }

      @Override
      public void d() {
         this.b = this.a(20 * (1 + cnd.this.ae.a(3)));
         cnd.this.b(30);
      }
