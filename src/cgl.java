...
public class cgl<U> {
   ...
   public static final cgl<List<crm>> j = a("nearest_players");
   public static final cgl<crm> k = a("nearest_visible_player");
   public static final cgl<crm> l = a("nearest_visible_targetable_player");
   public static final cgl<List<crm>> m = a("nearest_visible_targetable_players");
   ...
   public static final cgl<exo> u = a("path");
   ...
   public static final cgl<ffc> X = a("ram_target");
   ...
   public static final cgl<cpv> al = a("nearest_visible_huntable_hoglin");
   public static final cgl<cpv> am = a("nearest_visible_baby_hoglin");
   public static final cgl<crm> an = a("nearest_targetable_player_not_wearing_gold");
   public static final cgl<List<cqa>> ao = a("nearby_adult_piglins");
   public static final cgl<List<cqa>> ap = a("nearest_visible_adult_piglins");
   public static final cgl<List<cpv>> aq = a("nearest_visible_adult_hoglins");
   public static final cgl<cqa> ar = a("nearest_visible_adult_piglin");
   ...
   public static final cgl<crm> av = a("nearest_player_holding_wanted_item");
