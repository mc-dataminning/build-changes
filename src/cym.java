...
public class cym extends cua {
   public static final MapCodec<cym> c = b(cym::new);
   ...
   public void a(dhn $$0, csf $$1, hx $$2, atw $$3) {
      if ($$0.c(b)) {
         ...
         if ($$3.j() < 0.1) {
            $$1.a($$4, $$5, $$6, aqv.jl, aqw.e, 1.0F, 1.0F, false);
         }
         ...
         $$1.a(jw.C, $$4 + $$11, $$5 + $$12, $$6 + $$13, 0.0, 0.0, 0.0);
      }
   }
}
