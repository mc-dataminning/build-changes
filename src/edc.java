...
public class edc implements ecx {
   public static final Codec<edc> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               lp.e.q().fieldOf("block").flatXmap(edc::a, DataResult::success).orElse((dju)dew.fg).forGetter($$0x -> $$0x.b),
   ...
   public final jm<deu> h;
   private final ObjectArrayList<je> i;

   private static DataResult<dju> a(deu $$0) {
      return $$0 instanceof dju $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public edc(dju $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jm<deu> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<je> a(azc $$0, je $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<je> a(azc $$0) {
