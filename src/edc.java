...
public class edc {
   ...
   private final edc.a g;

   @Deprecated
   public static edc a(auf $$0, edc.a $$1) {
      return new edc($$0, $$1, false);
   }

   public static edc a(auf $$0, int $$1, double... $$2) {
      return b($$0, new edc.a($$1, new DoubleArrayList($$2)));
   }

   public static edc b(auf $$0, edc.a $$1) {
      return new edc($$0, $$1, true);
   }

   private edc(auf $$0, edc.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<edc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(edc.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(edc.a::b))
               .apply($$0, edc.a::new)
      );
      public static final Codec<ie<edc.a>> b = agp.a(kc.aA, a);
