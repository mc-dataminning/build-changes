...
public class edc extends edf<edb> {
   public edc(Codec<edb> $$0) {
      super($$0);
   }

   public boolean a(edb $$0, azr $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(eda $$0, edb $$1, dwz $$2, Function<jg, jp<dfw>> $$3, azr $$4, eal $$5, deb $$6, dwy $$7) {
      int $$8 = ki.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         edf.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      eda $$0, edb $$1, dwz $$2, Function<jg, jp<dfw>> $$3, eal $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dwy $$10, edf.a $$11
   ) {
      double $$12 = 1.5 + (double)(azj.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(azj.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = azj.b($$13);
         $$6 += (double)(azj.b($$12) * $$27);
         $$7 += (double)azj.a($$13);
         $$8 += (double)(azj.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
