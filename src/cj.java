...
public class cj extends dz<cj.a> {
   ...
   public void a(are $$0, cpq $$1, cxh $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(are $$0, cpq $$1, cxh $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bi> b, cj.a.a c, List<cv> d) implements dz.a {
      ...
      public static aq<cj.a> a(dgy... $$0) {
         cv[] $$1 = new cv[$$0.length];

         for (int $$2 = 0; $$2 < $$0.length; $$2++) {
            $$1[$$2] = new cv(Optional.of(jv.a($$0[$$2].i().f())), dk.d.c, kt.c, Map.of());
         }

         return a($$1);
      }

      public boolean a(cpq $$0, cxh $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
