...
public record cj(
   Optional<cj.b> b, Optional<aew<cqt>> c, Optional<aew<dvi>> d, Optional<aew<cpv>> e, Optional<Boolean> f, Optional<cg> g, Optional<av> h, Optional<bx> i
) {
   public static final Codec<cj> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arg.a(cj.b.a, "position").forGetter(cj::b),
               arg.a(aew.a(je.ap), "biome").forGetter(cj::c),
               arg.a(aew.a(je.az), "structure").forGetter(cj::d),
               arg.a(aew.a(je.aH), "dimension").forGetter(cj::e),
               arg.a(Codec.BOOL, "smokey").forGetter(cj::f),
               arg.a(cg.a, "light").forGetter(cj::g),
               arg.a(av.a, "block").forGetter(cj::h),
               arg.a(bx.a, "fluid").forGetter(cj::i)
            )
            .apply($$0, cj::new)
   );
   ...
   public boolean a(akr $$0, double $$1, double $$2, double $$3) {
   ...
   public static class a {
      ...
      private cl.c b;
      private cl.c c;
      private Optional<aew<cqt>> d;
      private Optional<aew<dvi>> e;
      private Optional<aew<cpv>> f;
      ...
      public static cj.a a(aew<cqt> $$0) {
         return a().d($$0);
      }

      public static cj.a b(aew<cpv> $$0) {
         return a().f($$0);
      }

      public static cj.a c(aew<dvi> $$0) {
         return a().e($$0);
      }
      ...
      public cj.a d(aew<cqt> $$0) {
         this.d = Optional.of($$0);
         return this;
      }

      public cj.a e(aew<dvi> $$0) {
         this.e = Optional.of($$0);
         return this;
      }

      public cj.a f(aew<cpv> $$0) {
   ...
   static record b(cl.c b, cl.c c, cl.c d) {
      public static final Codec<cj.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  arg.a(cl.c.d, "x", cl.c.c).forGetter(cj.b::a), arg.a(cl.c.d, "y", cl.c.c).forGetter(cj.b::b), arg.a(cl.c.d, "z", cl.c.c).forGetter(cj.b::c)
               )
               .apply($$0, cj.b::new)
      );
