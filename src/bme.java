...
public class bme extends blw {
   ...
   public bme(ctx $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bmc.L, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bme(bmc<? extends bme> $$0, ctx $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         emc $$0 = new emc(this.k.dq() - this.dq(), this.k.ds() + (double)this.k.cI() / 2.0 - this.ds(), this.k.dw() - this.dw());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
            double $$2 = 1.0 - Math.sqrt($$1) / 8.0;
            this.g(this.do().e($$0.d().a($$2 * $$2 * 0.1)));
         }
      }
      ...
      float $$3 = 0.98F;
      if (this.aC()) {
         $$3 = this.dL().a_(this.aI()).b().i() * 0.98F;
      }

      this.g(this.do().d((double)$$3, 0.98, (double)$$3));
      if (this.aC()) {
         this.g(this.do().d(1.0, -0.9, 1.0));
      }
   ...
   private void u() {
      ...
      if (this.dL() instanceof ane) {
         for (bme $$1 : this.dL().a(dnn.a(bme.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(ane $$0, emc $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bme($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(ane $$0, emc $$1, int $$2) {
      elx $$3 = elx.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.F_().a(40);
      List<bme> $$5 = $$0.a(dnn.a(bme.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bme $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bme $$0) {
      return $$0 != this && a($$0, this.aj(), this.i);
   }

   private static boolean a(bme $$0, int $$1, int $$2) {
      return !$$0.dG() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bme $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cfq $$0, int $$1) {
      Entry<bmd, cng> $$2 = crt.a(crv.L, $$0, cng::j);
      if ($$2 != null) {
         cng $$3 = $$2.getValue();
