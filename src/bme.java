public abstract class bme extends blx {
   protected static final float bS = 0.0F;

   protected bme(blj<? extends bme> $$0, csy $$1) {
      super($$0, $$1);
   }
   ...
   public boolean gb() {
      return this.bz.a(bux.Y) ? this.bz.c(bux.Y).isPresent() : this.bO.c().anyMatch($$0 -> $$0.k() instanceof btk);
   }
   ...
   protected void fR() {
      ...
      if ($$0 != null && $$0.dM() == this.dM()) {
         this.a($$0.dm(), 5);
         float $$1 = this.e($$0);
         if (this instanceof bmq && ((bmq)this).A()) {
            if ($$1 > 10.0F) {
               this.a(true, true);
            }
         ...
         if ($$1 > 10.0F) {
            ...
            this.bO.b(bsr.a.a);
            float $$5 = 2.0F;
            elb $$6 = new elb($$0.dr() - this.dr(), $$0.dt() - this.dt(), $$0.dx() - this.dx()).d().a((double)Math.max($$1 - 2.0F, 0.0F));
