...
public class gdh extends aut<gdh.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final ale b = new ale("gpu_warnlist.json");
   ...
   protected gdh.a a(auo $$0, bnh $$1) {
      ...
      $$1.b();
      return new gdh.a($$2, $$3, $$4);
   }

   protected void a(gdh.a $$0, auo $$1, bnh $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(auo $$0, bnh $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eyq.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eyq.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eyq.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
