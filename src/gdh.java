...
public class gdh extends fyn {
   ...
   private static final wy x = u.e().a(o.t);
   private static final wy y = v.e().a(o.t);
   private static final wy z = w.e().a(o.t);
   private static final wy A = wy.c("gui.socialInteractions.search_hint").a(o.u).a(o.h);
   static final wy B = wy.c("gui.socialInteractions.search_empty").a(o.h);
   private static final wy C = wy.c("gui.socialInteractions.empty_hidden").a(o.h);
   private static final wy D = wy.c("gui.socialInteractions.empty_blocked").a(o.h);
   ...
   private final fwj M = new fwj(this);
   @Nullable
   private final fyn N;
   gdg O;
   fte P;
   private String Q = "";
   private gdh.a R = gdh.a.a;
   private fsv S;
   private fsv T;
   private fsv U;
   private fsv V;
   ...
   protected void aO_() {
      this.M.a(c, this.p);
      this.O = new gdg(this, this.m, this.n, this.E() - 88, 88, 36);
      int $$0 = this.O.a() / 3;
      int $$1 = this.O.u();
      int $$2 = this.O.v();
      this.S = this.c(fsv.a(u, $$0x -> this.a(gdh.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fsv.a(v, $$0x -> this.a(gdh.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fsv.a(w, $$0x -> this.a(gdh.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fte(this.p, this.F() + 28, 74, 200, 15, A) {
         @Override
         protected xm d() {
            return !gdh.this.P.a().isEmpty() && gdh.this.O.b() ? super.d().f(", ").b(gdh.B) : super.d();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fsv.a(E, fxk.b(this, ayh.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fsv.a(wx.d, $$0x -> this.aL_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fsh $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(gqx::H, d, $$4, 64, 236, this.m() + 16);
      $$0.a(gqx::H, s, $$4 + 10, 76, 12, 12);
   }
