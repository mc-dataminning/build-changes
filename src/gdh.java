...
public class gdh {
   ...
   public static class a extends Thread {
      private final gdh.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gdh.b $$0) throws IOException {
         super("LanServerDetector #" + gdh.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gdh.b));
   ...
   public static class b {
      private final List<gdg> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gdg> a() {
         if (this.b) {
            List<gdg> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
