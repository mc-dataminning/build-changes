...
public class cls extends buy implements clq {
   private static final ajy<Boolean> a = akc.a(cls.class, aka.k);
   private int b = 1;

   public cls(bus<? extends cls> $$0, dgi $$1) {
      super($$0, $$1);
      this.bN = 5;
   ...
   private static boolean j(btb $$0) {
   ...
   public static bwo.a t() {
      return bvj.F().a(bwp.s, 10.0).a(bwp.m, 100.0);
   }
   ...
   public static boolean b(bus<cls> $$0, dgj $$1, bur $$2, ji $$3, azh $$4) {
      return $$1.am() != bsh.a && $$4.a(20) == 0 && a($$0, $$1, $$2, $$3, $$4);
   }
