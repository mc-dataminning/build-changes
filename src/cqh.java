...
public class cqh extends bvj implements bxe {
   ...
   public void h() {
      ...
      if (this.dV().C) {
         ...
         if (this.d == -8) {
            for (bwf $$8 : this.dV().a(bwf.class, this.cR().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.g = true;
         if (!this.bb()) {
            this.dV().a(this.dA(), this.dC(), this.dG(), axf.iV, this.dm(), 1.0F, this.ae.i() * 0.2F + 0.85F, false);
         }
      }
   }
