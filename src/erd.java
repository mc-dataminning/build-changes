...
public class erd extends ers {
   ...
   public erd(float $$0, float $$1, int $$2, int $$3, jm.a $$4) {
      if ($$2 >= $$3) {
   ...
   @Override
   public boolean a(jh $$0, jh $$1, jh $$2, bac $$3) {
      ...
      int $$8 = (int)($$5 + $$6 + $$7);
      float $$9 = $$3.i();
      return $$9 <= azu.b(this.b, this.d, azu.f((float)$$8, (float)this.e, (float)this.f));
   }
