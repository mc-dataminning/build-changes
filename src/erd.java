...
public abstract class erd<T extends erd<T>> {
   ...
   public erd(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = erb.a();
         if ($$3 != null) {
         ...
         throw new esm(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new esm(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new esm(var2.getMessage(), var2);
      }
   }
   ...
   public static erd<?> a(String $$0) {
      return new erd.b($$0, 5000, 60000);
   }

   public static erd<?> a(String $$0, int $$1, int $$2) {
      return new erd.b($$0, $$1, $$2);
   }

   public static erd<?> b(String $$0, String $$1) {
      return new erd.c($$0, $$1, 5000, 60000);
   }

   public static erd<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new erd.c($$0, $$1, $$2, $$3);
   }

   public static erd<?> b(String $$0) {
      return new erd.a($$0, 5000, 60000);
   }

   public static erd<?> c(String $$0, String $$1) {
      return new erd.d($$0, $$1, 5000, 60000);
   }

   public static erd<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new erd.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends erd<erd.a> {
   ...
   public static class b extends erd<erd.b> {
   ...
   public static class c extends erd<erd.c> {
      ...
      public erd.c f() {
         try {
            ...
            throw new esm(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends erd<erd.d> {
      private final String c;
