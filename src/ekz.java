...
public class ekz extends ekm<emj> {
   public ekz(Codec<emj> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azq.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azz $$0, dka $$1, int $$2, int $$3, iw $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iw $$2, dka $$3, boolean $$4, double $$5, iw $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dka $$0, iw $$1) {
      if ($$0.a_($$1.d()).a(dng.ed)) {
         this.a($$0, $$1.d(), dng.a.m());
      }
   }

   private void a(dka $$0, azz $$1, iw $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, ebg $$13) {
   ...
   private void a(iw $$0, dka $$1, azz $$2, int $$3, int $$4, boolean $$5, boolean $$6, ebg $$7) {
      ebg $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dng.ef) || $$8.a(dng.ee) || $$8.a(dng.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dng.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dng.ef.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, iw $$2, int $$3, azz $$4) {
      float $$5 = 10.0F * azq.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(azz $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azz $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(ebg $$0) {
      return $$0.a(dng.je) || $$0.a(dng.ef) || $$0.a(dng.nC);
   }
   ...
   private void a(dka $$0, iw $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dng.ed)) {
                  if (this.a((djd)$$0, $$10)) {
                     this.a($$0, $$10, dng.a.m());
                     this.a($$0, $$10.d(), dng.a.m());
                  } else if (c($$11)) {
                     ebg[] $$12 = new ebg[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
