...
public class ekz {
   ...
   private static final Queue<ekz.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ekz.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ekz::a), ekx::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ekz::a), ekx::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ekz.a(this.b) + ", type=" + ekz.b(this.c) + ", severity=" + ekz.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
