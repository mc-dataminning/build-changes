...
public class ekz {
   ...
   static class a implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
         return $$0.c[jf.f.d()] && !$$0.b[jf.f.d()].d;
      }

      @Override
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         $$1.d = true;
         $$1.b[jf.f.d()].d = true;
         return new ekz.k($$0, $$1);
      }
   }

   static class b implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         ...
         return new ekz.l($$0, $$1);
      }
   }

   static class c implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         $$1.d = true;
         $$1.b[jf.b.d()].d = true;
         return new ekz.m($$0, $$1);
      }
   }

   static class d implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         ...
         return new ekz.n($$0, $$1);
      }
   }

   static class e implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         ...
         $$3.d = true;
         $$3.b[jf.c.d()].d = true;
         return new ekz.o($$0, $$3);
      }
   }

   static class f implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
         return true;
      }
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         $$1.d = true;
         return new ekz.s($$0, $$1, $$2);
      }
   }

   static class g implements ekz.i {
      @Override
      public boolean a(ekz.v $$0) {
      ...
      public ekz.r a(jf $$0, ekz.v $$1, aym $$2) {
         $$1.d = true;
         return new ekz.t($$0, $$1);
      }
   }

   public static class h extends ekz.r {
      ...
      private ekz.v G;
      private ekz.v H;
      private final List<ekz.r> I = Lists.newArrayList();

      public h(aym $$0, int $$1, int $$2, jf $$3) {
         super(ejh.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ekz.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ekz.p($$3, this.G));
         this.I.add(new ekz.j($$3, this.H));
         List<ekz.i> $$5 = Lists.newArrayList();
         $$5.add(new ekz.b());
         $$5.add(new ekz.d());
         $$5.add(new ekz.e());
         $$5.add(new ekz.a());
         ...
         eii $$10 = eii.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eii $$11 = eii.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eii $$12 = eii.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ekz.u($$3, $$10, $$13++));
         this.I.add(new ekz.u($$3, $$11, $$13++));
         this.I.add(new ekz.q($$3, $$12));
      }
      ...
      private List<ekz.v> b(aym $$0) {
         ekz.v[] $$1 = new ekz.v[75];
         ...
         ekz.v $$23 = new ekz.v(1003);
         ekz.v $$24 = new ekz.v(1001);
         ekz.v $$25 = new ekz.v(1002);
         $$1[v].a(jf.b, $$23);
         $$1[w].a(jf.d, $$24);
         $$1[x].a(jf.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ekz.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcz $$2, aym $$3, eii $$4) {
         int $$5 = 24;
      ...
      private void a(dcz $$0, aym $$1, eii $$2) {
      ...
      private void b(dcz $$0, aym $$1, eii $$2) {
      ...
      private void c(dcz $$0, aym $$1, eii $$2) {
      ...
      private void d(dcz $$0, aym $$1, eii $$2) {
      ...
      private void e(dcz $$0, aym $$1, eii $$2) {
      ...
      private void f(dcz $$0, aym $$1, eii $$2) {
   ...
   interface i {
      boolean a(ekz.v var1);

      ekz.r a(jf var1, ekz.v var2, aym var3);
   }

   public static class j extends ekz.r {
      public j(jf $$0, ekz.v $$1) {
         super(ejh.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcz $$0, dcx $$1, due $$2, aym $$3, eii $$4, dbk $$5, ja $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfh.ch.o(), dfh.ch.o(), false);
   ...
   public static class k extends ekz.r {
      public k(jf $$0, ekz.v $$1) {
         super(ejh.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ekz.r {
      public l(jf $$0, ekz.v $$1) {
         super(ejh.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ekz.r {
      public m(jf $$0, ekz.v $$1) {
         super(ejh.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ekz.r {
      public n(jf $$0, ekz.v $$1) {
         super(ejh.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ekz.r {
      public o(jf $$0, ekz.v $$1) {
         super(ejh.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ekz.r {
      public p(jf $$0, ekz.v $$1) {
         super(ejh.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ekz.r {
      public q(jf $$0, eii $$1) {
         super(ejh.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eiu {
      protected static final dsh b = dfh.hZ.o();
      protected static final dsh c = dfh.ia.o();
      protected static final dsh d = dfh.ib.o();
      protected static final dsh h = c;
      protected static final dsh i = dfh.ii.o();
      protected static final boolean j = true;
      protected static final dsh k = dfh.G.o();
      protected static final Set<dff> l = ImmutableSet.builder().add(dfh.dO).add(dfh.iC).add(dfh.mW).add(k.b()).build();
      ...
      public r(ejh $$0, jf $$1, int $$2, eii $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ejh $$0, int $$1, jf $$2, ekz.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eii a(jf $$0, ekz.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eii $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcz $$0, eii $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsh $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dcz $$0, eii $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcz $$0, eii $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsh $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eii $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcz $$0, eii $$1, int $$2, int $$3, int $$4) {
         ja $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjc $$6 = bsj.D.a((dcd)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eN());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), btc.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ekz.r {
      private int a;

      public s(jf $$0, ekz.v $$1, aym $$2) {
         super(ejh.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ekz.r {
      public t(jf $$0, ekz.v $$1) {
         super(ejh.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ekz.r {
      private int a;

      public u(jf $$0, eii $$1, int $$2) {
         super(ejh.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
