...
public class ekz {
   ...
   static class b {
      static final Optional<ekz> a = Optional.ofNullable(a());
      ...
      private static ekz a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ekz();
      }
   }
}
