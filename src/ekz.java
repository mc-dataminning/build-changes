...
@Deprecated
public class ekz extends ekk<ekz.a> {
   private static final ebe a = dne.nI.m();

   public ekz(Codec<ekz.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ekm<ekz.a> $$0) {
      iv $$1 = $$0.e();
      dkw $$2 = $$0.b();
      azx $$3 = $$0.d();
      ekz.a $$4 = $$0.f();
   ...
   public static record a(eoq b, eoq c) implements emp {
      public static final Codec<ekz.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eoq.a.fieldOf("fluid").forGetter(ekz.a::a), eoq.a.fieldOf("barrier").forGetter(ekz.a::b)).apply($$0, ekz.a::new)
      );
