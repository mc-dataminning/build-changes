...
public class gld {
   private static final glu a = glu.u(alz.b("textures/map/map_background.png"));
   private static final glu b = glu.u(alz.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fmf au;
   private final hat av = new hat();
   private cxo aw = cxo.j;
   private cxo ax = cxo.j;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final grn aC;
   private final gsn aD;

   public gld(fmf $$0, grn $$1, gsn $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(bwf $$0, cxo $$1, cxm $$2, boolean $$3, fgr $$4, glk $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dW(), $$6, hbb.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fgr $$0, glk $$1, int $$2, bvz $$3) {
      gww $$4 = (gww)this.aC.<gkd>a(this.au.t);
      $$0.a();
   ...
   private void a(fgr $$0, glk $$1, int $$2, float $$3, bvz $$4, float $$5, cxo $$6) {
   ...
   private void a(fgr $$0, glk $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = bae.c($$5);
   ...
   private void a(fgr $$0, glk $$1, int $$2, cxo $$3) {
   ...
   private void a(fgr $$0, glk $$1, int $$2, float $$3, float $$4, bvz $$5) {
      boolean $$6 = $$5 != bvz.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = bae.c($$4);
   ...
   private void a(fgr $$0, float $$1, bvz $$2, cxo $$3, cpw $$4) {
   ...
   private void a(fgr $$0, float $$1, bvz $$2, cxo $$3, cpw $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fgr $$0, bvz $$1, float $$2) {
      int $$3 = $$1 == bvz.b ? 1 : -1;
   ...
   private void b(fgr $$0, bvz $$1, float $$2) {
      int $$3 = $$1 == bvz.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fgr $$1, glk.a $$2, gkg $$3, int $$4) {
      float $$5 = $$3.D($$0);
   ...
   static gld.a a(gkg $$0) {
      ...
      if (!$$3 && !$$4) {
         ...
         return a($$1) ? gld.a.b : gld.a.a;
      }
   }

   private static gld.a b(gkg $$0) {
      cxo $$1 = $$0.fB();
      bth $$2 = $$0.fA();
      if (!$$1.a(cxs.oR) && !$$1.a(cxs.wL)) {
         return $$2 == bth.a && a($$0.fa()) ? gld.a.b : gld.a.a;
      } else {
         return gld.a.a($$2);
      }
   }
   ...
   private void a(gkd $$0, float $$1, float $$2, bth $$3, float $$4, cxo $$5, float $$6, fgr $$7, glk $$8, int $$9) {
      if (!$$0.gH()) {
         boolean $$10 = $$3 == bth.a;
         bvz $$11 = $$10 ? $$0.fy() : $$0.fy().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cp()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               ...
               float $$15 = (float)$$5.a((bwf)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               ...
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((bwf)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((bwf)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
