...
public enum gld implements glk {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, gld> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (gld)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static gld a(int $$0, int $$1) {
