...
public class gld implements gkq.a {
   private final fib a;
   private double b = Double.MIN_VALUE;
   private List<btj> c = Collections.emptyList();
   ...
   private void a(fcu $$0, ggv $$1, double $$2, double $$3, double $$4, btj $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.ay.ifPresent($$10 -> {
   ...
   private void a(je $$0, fcu $$1, double $$2, double $$3, double $$4, ggv $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      ghl.a($$1, $$5.getBuffer(ghe.z()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gkq.a(
         $$1,
         $$5.getBuffer(ghe.z()),
         this.a.s.a_($$0).b(this.a.s, $$0, eyj.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
