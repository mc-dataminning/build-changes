...
public class gld implements glg.a, AutoCloseable {
   ...
   evj[] f;
   @Nullable
   private final gld.a g;
   private final ate h;

   public gld(ajt $$0, gmv $$1, evj $$2, ate $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gmt $$4 = $$3.a(gmt.a).orElse(gmt.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new evj[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gky.a(this.f, $$0);
   ...
   @Nullable
   private gld.a a(gmv $$0, int $$1, int $$2, gmt $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gld.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gld.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gld.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gld.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gld.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gld.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, evj[] $$4) {
   ...
   class a {
      ...
      a(List<gld.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gld.this.c;
         int $$4 = this.b($$2) * gld.this.d;
         gld.this.a($$0, $$1, $$3, $$4, gld.this.f);
      }

      public glf a() {
         return gld.this.new d(this, this.d ? gld.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final evj[] b = new evj[gld.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gld.this.c >> $$0;
            int $$2 = gld.this.d >> $$0;
            this.b[$$0] = new evj($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gld.d $$2) {
         gld.a $$3 = $$2.d;
         List<gld.b> $$4 = $$3.b;
         gld.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gld.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gld.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gld.this.f[$$2].a($$3 + ($$0.a($$1) * gld.this.c >> $$2), $$4 + ($$0.b($$1) * gld.this.d >> $$2));
      }
   ...
   class d implements glf {
      int b;
      int c;
      final gld.a d;
      @Nullable
      private final gld.c e;

      d(gld.a $$0, @Nullable gld.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
