...
public class gld {
   ...
   public gld(hcb $$0, hcc $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(han $$0, fgl $$1, gle $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fgp $$6 = $$2.getBuffer(glo.t($$0.a));
      ...
      for (han.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fnj.a.b, Integer.MIN_VALUE, $$4);
               $$1.b();
            }
   ...
   public void a(evh $$0, evj $$1, han $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
