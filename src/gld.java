...
public class gld implements glg.a {
      ...
      if (this.b.C || this.b.D) {
         ...
         while ($$27.hasNext()) {
            ...
            if ($$8 != null) {
               ...
               Matrix4f $$10 = $$0.c().a();
               if (this.b.C) {
                  fdi $$11 = $$1.getBuffer(ghq.y());
                  int $$12 = $$8.b == 0 ? 0 : azd.g((float)$$8.b / 50.0F, 0.9F, 0.9F);
                  int $$13 = $$12 >> 16 & 0xFF;
                  int $$14 = $$12 >> 8 & 0xFF;
                  int $$15 = $$12 & 0xFF;
   ...
   private void a(fdi $$0, Matrix4f $$1, Vector4f $$2) {
      $$0.a($$1, $$2.x(), $$2.y(), $$2.z()).a(-16777216).b(0.0F, 0.0F, -1.0F);
   }

   private void a(fdi $$0, Matrix4f $$1, Vector4f[] $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      float $$10 = 0.25F;
