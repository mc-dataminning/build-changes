...
public abstract class exa {
   ...
   public ewc a() {
      if (this.c()) {
         ...
         return new ewc(this.b(jf.a.a), this.b(jf.a.b), this.b(jf.a.c), this.c(jf.a.a), this.c(jf.a.b), this.c(jf.a.c));
      }
   }

   public exa b() {
      return this.c() ? ewx.a() : ewx.a(this.b(jf.a.a), this.b(jf.a.b), this.b(jf.a.c), this.c(jf.a.a), this.c(jf.a.b), this.c(jf.a.c));
   }
   ...
   public exa a(double $$0, double $$1, double $$2) {
      return (exa)(this.c() ? ewx.a() : new ewj(this.a, new eww(this.a(jf.a.a), $$0), new eww(this.a(jf.a.b), $$1), new eww(this.a(jf.a.c), $$2)));
   }

   public exa d() {
      exa[] $$0 = new exa[]{ewx.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewx.b($$0[0], ewx.a($$1, $$2, $$3, $$4, $$5, $$6), ewl.o));
      return $$0[0];
   }
   ...
   public List<ewc> e() {
      List<ewc> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new ewc($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(jf.a.a, $$4.c - (double)$$2.u()), this.a(jf.a.b, $$4.d - (double)$$2.v()), this.a(jf.a.c, $$4.e - (double)$$2.w()))
               ? new ewd($$4, jf.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : ewc.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<ewh> a(ewh $$0) {
      if (this.c()) {
   ...
   public exa a(jf $$0) {
      if (!this.c() && this != ewx.b()) {
         if (this.b != null) {
            exa $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private exa b(jf $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewy(this, $$1, $$4);
      }
   }

   public double a(jf.a $$0, ewc $$1, double $$2) {
      return this.a(ix.a($$0, jf.a.a), $$1, $$2);
   }

   protected double a(ix $$0, ewc $$1, double $$2) {
      if (this.c()) {
         return $$2;
