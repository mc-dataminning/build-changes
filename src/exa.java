...
public class exa extends exe {
   ...
   public static final MapCodec<exa> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(aku.a(mc.bh).fieldOf("name").forGetter($$0x -> $$0x.c)).apply($$0, exa::new)
   );
   private final aku<exf> c;

   private exa(List<eza> $$0, aku<exf> $$1) {
      super($$0);
      this.c = $$1;
   }
   ...
   public static exe.a<?> a(aku<exf> $$0) {
