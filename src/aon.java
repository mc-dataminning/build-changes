...
public class aon {
   ...
   private static int a(ej $$0, Collection<arr> $$1, Collection<dej<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(ej $$0, Collection<arr> $$1, Collection<dej<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
