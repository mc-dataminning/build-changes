...
class aon implements Path {
   private static final BasicFileAttributes a = new aol() {
      @Override
   ...
   private static final BasicFileAttributes b = new aol() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aon> c = Comparator.comparing(aon::n);
   ...
   public aon(aop $$0, String $$1, @Nullable aon $$2, aoq $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aon a(@Nullable aon $$0, String $$1) {
      return new aon(this.e, $$1, $$0, aoq.b);
   }
   ...
   aon a(String $$0) {
      if (a(this.i)) {
         return new aon(this.e, $$0, this, this.i);
      } else if (this.i instanceof aoq.a $$1) {
         aon $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aon(this.e, $$0, this, aoq.a);
      } else if (this.i instanceof aoq.b) {
         return new aon(this.e, $$0, this, aoq.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aoq $$0) {
      return $$0 == aoq.a || $$0 == aoq.b;
   }
   ...
   private aon c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aon $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aoq.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aoq.a i() {
      return this.i instanceof aoq.a $$0 ? $$0 : null;
   }
