...
public class aon {
   ...
   public static void a(CommandDispatcher<ew> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("publish").requires($$0x -> $$0x.c(4)))
               .executes($$0x -> a((ew)$$0x.getSource(), aze.a(), false, null)))
            .then(
               ((RequiredArgumentBuilder)ex.a("allowCommands", BoolArgumentType.bool())
                     .executes($$0x -> a((ew)$$0x.getSource(), aze.a(), BoolArgumentType.getBool($$0x, "allowCommands"), null)))
                  .then(
                     ((RequiredArgumentBuilder)ex.a("gamemode", fk.a())
                           .executes($$0x -> a((ew)$$0x.getSource(), aze.a(), BoolArgumentType.getBool($$0x, "allowCommands"), fk.a($$0x, "gamemode"))))
                        .then(
   ...
   private static int a(ew $$0, int $$1, boolean $$2, @Nullable dfc $$3) throws CommandSyntaxException {
      if ($$0.l().r()) {
