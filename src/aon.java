...
public class aon {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wz.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> wz.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wz.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(et $$0, ewz $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bsr> $$6) throws CommandSyntaxException {
      ...
      if ($$4 < $$8) {
         ...
         aon.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> wz.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static aon.a[] a(ayw $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aon.a[] $$6 = new aon.a[$$1];
