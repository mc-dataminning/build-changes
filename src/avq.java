...
public class avq extends awb<avq.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public avq(avv $$0, List<avp> $$1, Executor $$2, Executor $$3, CompletableFuture<bbk> $$4) {
   ...
   private List<avq.a> a(List<avq.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
