...
public class avq {
   ...
   public static final Codec<Object> b = a(awb.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(avy.e($$0));
   ...
   public static final Codec<avq.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aiy.b($$0.substring(1)).map($$0x -> new avq.f($$0x, true)) : aiy.b($$0).map($$0x -> new avq.f($$0x, false)), avq.f::c
      );
   ...
   private static final MapCodec<GameProfile> z = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jc.d.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !aiy.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> avq.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new avq.b<>($$0, $$1);
   }

   public static <K, V> avq.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new avq.e<>($$0, $$1);
   }
   ...
   public static <T> Codec<in<T>> b(Codec<in<T>> $$0) {
      return a(
         $$0,
         (Function<in<T>, DataResult<in<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof avq.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(aiy a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
