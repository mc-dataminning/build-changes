...
public class jy {
   ...
   static <T> jj<T> a(final jk.b<T> $$0) {
      return new jy.c<T>($$0) {
         @Override
         public Optional<ji.c<T>> a(ald<T> $$0x) {
            return $$0.a($$0);
         }
      };
   }

   static <T> jk.b<T> a(final ald<? extends jv<? extends T>> $$0, final Lifecycle $$1, jl<T> $$2, final Map<ald<T>, ji.c<T>> $$3) {
      return new jy.e<T>($$2) {
         @Override
   ...
   public <T> jy a(ald<? extends jv<T>> $$0, Lifecycle $$1, jy.i<T> $$2) {
      this.a.add(new jy.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> jy a(ald<? extends jv<T>> $$0, jy.i<T> $$1) {
   ...
   private static jk.a a(jy.m $$0, jw $$1, Stream<jk.b<?>> $$2) {
      ...
      final Map<ald<? extends jv<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new jk.a() {
         ...
         <T> Optional<a<T>> c(ald<? extends jv<? extends T>> $$0) {
   ...
   private jk.a a(jw $$0, jk.a $$1, ja.a $$2, Map<ald<? extends jv<?>>, jy.j<?>> $$3, jk.a $$4) {
      jy.m $$5 = new jy.m();
   ...
   private <T> jk.b<T> a(jl<T> $$0, ja.a $$1, ald<? extends jv<? extends T>> $$2, jk.a $$3, jk.a $$4, MutableObject<jk.a> $$5) {
      ja<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<ald<T>, ji.c<T>> $$7 = new HashMap<>();
         jk.b<T> $$8 = $$3.b($$2);
         $$8.b().forEach($$5x -> {
            ald<T> $$6x = $$5x.h();
   ...
   public jy.g a(jw $$0, jk.a $$1, ja.a $$2) {
      jy.b $$3 = this.b($$0);
      Map<ald<? extends jv<?>>, jy.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<ald<? extends jv<?>>> $$5 = $$0.a().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(jy.m a, jy.l b, Map<ale, jj<?>> c, Map<ald<?>, jy.h<?>> d, List<RuntimeException> e) {

      public static jy.b a(jw $$0, Stream<ald<? extends jv<?>>> $$1) {
         jy.m $$2 = new jy.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         jy.l $$4 = new jy.l($$2);
         Builder<ale, jj<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> rc<T> a() {
         return new rc<T>() {
            @Override
            public ji.c<T> a(ald<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jj<S> a(ald<? extends jv<? extends S>> $$0) {
   ...
   static class f<T> extends ji.c<T> {
      ...
      protected f(jl<T> $$0, @Nullable ald<T> $$1) {
   ...
   static record j<T>(ald<? extends jv<? extends T>> a, Lifecycle b, Map<ald<T>, jy.n<T>> c) {

      public jk.b<T> a(jy.m $$0) {
         Map<ald<T>, ji.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            jy.n<T> $$2 = (jy.n<T>)$$1x.getValue();
            ji.c<T> $$3 = $$2.b().orElseGet(() -> ji.c.a($$0.a(), (ald<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(ald<? extends jv<T>> a, Lifecycle b, jy.i<T> c) {
      void b(jy.b $$0) {
         this.c.run($$0.a());
      }

      public jy.j<T> a(jy.b $$0) {
         Map<ald<T>, jy.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<ald<?>, jy.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<ald<?>, jy.h<?>> $$3 = $$2.next();
            ald<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               jy.h<T> $$6 = (jy.h<T>)$$3.getValue();
               ji.c<T> $$7 = (ji.c<T>)$$0.b.a.remove($$4);
               $$1.put((ald<T>)$$4, new jy.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends jy.c<Object> {
      final Map<ald<Object>, ji.c<Object>> a = new HashMap<>();
      ...
      @Override
      public Optional<ji.c<Object>> a(ald<Object> $$0) {
