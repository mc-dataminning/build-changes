...
public class gud extends gtc<bvx, hai> {
   public gud(gtd.a $$0) {
      super($$0);
   }

   public void a(hai $$0, fgr $$1, gmx $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvx $$0, hai $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bvx $$0) {
      return false;
   }
}
