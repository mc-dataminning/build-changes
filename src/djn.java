...
public class djn<T> implements djv<T> {
   private final ih<T> a;
   private final ask<T> b;
   private final djw<T> c;
   private final int d;

   public djn(ih<T> $$0, int $$1, djw<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::c);
   }

   public djn(ih<T> $$0, int $$1, djw<T> $$2) {
      this($$0, $$1, $$2, ask.c(1 << $$1));
   }

   private djn(ih<T> $$0, int $$1, djw<T> $$2, ask<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public djv<T> c() {
      return new djn<>(this.a, this.d, this.c, this.b.c());
   }
}
