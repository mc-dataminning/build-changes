...
public class djn {
   ...
   private final Map<Character, Predicate<djl>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public djn a(char $$0, Predicate<djl> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public djm b() {
      return new djm(this.c());
   }

   private Predicate<djl>[][][] c() {
      this.d();
      Predicate<djl>[][][] $$0 = (Predicate<djl>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<djl>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
