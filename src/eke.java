...
public class eke {
   ...
   public static final eke.a bv;

   public static eke.a a(int $$0, int $$1) {
      return $$0 == -1 ? eke.b.b.a($$1) : eke.b.a.a($$0);
   }

   public static eke.a a(String $$0) {
      if (eke.a.e.containsKey($$0)) {
         return eke.a.e.get($$0);
      } else {
         for (eke.b $$1 : eke.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eke.b b;
      private final int c;
      private final arw<tl> d;
      static final Map<String, eke.a> e = Maps.newHashMap();

      a(String $$0, eke.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new arw<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> qr.a().b($$1) ? tl.c($$1) : tl.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eke.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, tl> g;

      private static void a(eke.b $$0, String $$1, int $$2) {
         eke.a $$3 = new eke.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eke.a a(int $$0) {
         return (eke.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
