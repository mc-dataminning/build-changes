...
public enum eke {
   ...
   public List<anh<InputStream>> a(amd $$0) throws IOException {
      return List.of(
   ...
   public anh<InputStream> b(amd $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private anh<InputStream> a(amd $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      anh<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
