...
public class giz {
   private static final gjq a = gjq.t(alj.b("textures/map/map_background.png"));
   private static final gjq b = gjq.t(alj.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fke au;
   private final gyn av = new gyn();
   private cwm aw = cwm.k;
   private cwm ax = cwm.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gpi aC;
   private final gqi aD;

   public giz(fke $$0, gpi $$1, gqi $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(bvh $$0, cwm $$1, cwk $$2, boolean $$3, fer $$4, gjg $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dV(), $$6, gyv.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fer $$0, gjg $$1, int $$2, bvb $$3) {
      gur $$4 = (gur)this.aC.<ghz>a(this.au.t);
      $$0.a();
      ...
      alj $$6 = this.au.t.d().a();
      if ($$3 == bvb.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cov.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cov.c));
      }

      $$0.b();
   }

   private void a(fer $$0, gjg $$1, int $$2, float $$3, bvb $$4, float $$5, cwm $$6) {
   ...
   private void a(fer $$0, gjg $$1, int $$2, cwm $$3) {
      ...
      etn $$4 = $$3.a(ku.L);
      etp $$5 = cwz.a($$4, this.au.s);
      fev $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fer $$0, gjg $$1, int $$2, float $$3, float $$4, bvb $$5) {
      boolean $$6 = $$5 != bvb.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azm.c($$4);
      ...
      gur $$15 = (gur)this.aC.<ghz>a($$14);
      alj $$16 = $$14.d().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cov.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cov.c));
      }
   }

   private void a(fer $$0, float $$1, bvb $$2, cwm $$3, cou $$4) {
   ...
   private void a(fer $$0, float $$1, bvb $$2, cwm $$3, cou $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fer $$0, bvb $$1, float $$2) {
      int $$3 = $$1 == bvb.b ? 1 : -1;
   ...
   private void b(fer $$0, bvb $$1, float $$2) {
      int $$3 = $$1 == bvb.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fer $$1, gjg.a $$2, gic $$3, int $$4) {
      float $$5 = $$3.D($$0);
      bsj $$6 = (bsj)MoreObjects.firstNonNull($$3.aI, bsj.a);
      float $$7 = $$3.j($$0);
      giz.a $$8 = a($$3);
      float $$9 = azm.h($$0, $$3.cE, $$3.cC);
      float $$10 = azm.h($$0, $$3.cD, $$3.cB);
   ...
   @VisibleForTesting
   static giz.a a(gic $$0) {
      cwm $$1 = $$0.eX();
      cwm $$2 = $$0.eY();
      boolean $$3 = $$1.a(cwq.ow) || $$2.a(cwq.ow);
      boolean $$4 = $$1.a(cwq.wn) || $$2.a(cwq.wn);
      if (!$$3 && !$$4) {
         return giz.a.a;
      } else if ($$0.fx()) {
         return b($$0);
      } else {
         return a($$1) ? giz.a.b : giz.a.a;
      }
   }

   private static giz.a b(gic $$0) {
      cwm $$1 = $$0.fz();
      bsj $$2 = $$0.fy();
      if (!$$1.a(cwq.ow) && !$$1.a(cwq.wn)) {
         return $$2 == bsj.a && a($$0.eY()) ? giz.a.b : giz.a.a;
      } else {
         return giz.a.a($$2);
      }
   }
   ...
   private static boolean a(cwm $$0) {
      return $$0.a(cwq.wn) && cvd.g($$0);
   }

   private void a(ghz $$0, float $$1, float $$2, bsj $$3, float $$4, cwm $$5, float $$6, fer $$7, gjg $$8, int $$9) {
      if (!$$0.gF()) {
         boolean $$10 = $$3 == bsj.a;
         bvb $$11 = $$10 ? $$0.fw() : $$0.fw().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cp()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fx() && $$0.fA() > 0 && $$0.fy() == $$3) {
               ...
               float $$15 = (float)$$5.a((bvh)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cvd.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
               ...
               float $$20 = -0.4F * azm.a(azm.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * azm.a(azm.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * azm.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cwk.e : cwk.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bvb.b;
            if ($$0.fx() && $$0.fA() > 0 && $$0.fy() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((bvh)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((bvh)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * azm.a(azm.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * azm.a(azm.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * azm.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cwk.e : cwk.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.D()) {
         ...
         float $$3 = $$0.H(1.0F);
         this.ay = this.ay + azm.a((this.aw == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + azm.a((float)(this.ax == $$2 ? 1 : 0) - this.aA, -0.4F, 0.4F);
      }
