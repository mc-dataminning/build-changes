...
public class bpq implements bpr {
   ...
   private static final bpq k = new bpq();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bpp $$0) {
      URL $$1 = bpq.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bpp $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bpt a = new bpt(() -> bpq.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bpq.this.l && $$0.getState() == RecordingState.STOPPED) {
