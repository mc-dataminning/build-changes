...
public class bpq extends bps {
   ...
   public bpq(bjs $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dK();
      this.h = $$1;
      this.i = $$0.H();
   ...
   private boolean a(gv $$0) {
      eam $$1 = eav.a(this.g, $$0.j());
      if ($$1 != eam.c) {
         return false;
      } else {
         dey $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof cwr) {
            return false;
         } else {
            gv $$3 = $$0.b(this.e.dk());
