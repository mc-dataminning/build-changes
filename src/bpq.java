...
public record bpq(Instant a, String b, long c) {
   ...
   public static bpq a(RecordedEvent $$0) {
      ...
      return new bpq($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bpq.a a(List<bpq> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bpq>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bpq $$3 = (bpq)$$2x.get(0);
            bpq $$4 = (bpq)$$2x.get($$2x.size() - 1);
