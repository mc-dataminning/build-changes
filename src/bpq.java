...
public interface bpq<T, F> {
   ...
   public static final class a implements bpq<bpq.b, Runnable> {
   ...
   public static final class c<T> implements bpq<T, T> {
