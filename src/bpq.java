...
public class bpq extends bpv {
   ...
   public static bpq a(float $$0, float $$1, int $$2, int $$3) {
      return new bpq($$0, $$1, $$2, $$3);
   }

   private bpq(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(ayv $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)ayn.a(ayn.c($$0, $$1, $$2), $$3, $$4);
   }
