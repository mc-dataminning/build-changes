...
public class pt {
   ...
   private static final Map<String, Consumer<akk>> c = Maps.newHashMap();
   private static final Map<String, Consumer<akk>> d = Maps.newHashMap();
   ...
   private static <T extends Annotation> void a(Method $$0, Class<T> $$1, Function<T, String> $$2, Map<String, Consumer<akk>> $$3) {
      T $$4 = $$0.getAnnotation($$1);
      if ($$4 != null) {
         String $$5 = $$2.apply($$4);
         Consumer<akk> $$6 = $$3.putIfAbsent($$5, (Consumer<akk>)d($$0));
         if ($$6 != null) {
   ...
   @Nullable
   public static Consumer<akk> c(String $$0) {
      return c.get($$0);
   }

   @Nullable
   public static Consumer<akk> d(String $$0) {
      return d.get($$0);
   }
   ...
   private static Collection<qi> b(Method $$0) {
      try {
         ...
         return (Collection<qi>)$$0.invoke($$1);
