...
public class ahr {
   ...
   private static final ahd b = new ahd("tick");
   private static final ahd c = new ahd("load");
   private final MinecraftServer d;
   private List<hb<ds>> e = ImmutableList.of();
   private boolean f;
   private ahq g;

   public ahr(MinecraftServer $$0, ahq $$1) {
      this.d = $$0;
      this.g = $$1;
      this.b($$1);
   }
   ...
   private void a(Collection<hb<ds>> $$0, ahd $$1) {
   ...
   public Iterable<ahd> d() {
      return this.g.a().keySet();
   }

   public Iterable<ahd> e() {
      return this.g.b();
   }
}
