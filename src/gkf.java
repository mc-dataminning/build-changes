public class gkf extends ghn<hgs> {
   ...
   public static gkx a(gkv $$0) {
      gkz $$1 = new gkz();
      glb $$2 = $$1.a();
      $$2.a("shoulders", gkw.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gkt.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         gkw.c()
         ...
         gkt.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         gkw.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gkt.a(-2.0F, 6.9F + azz.b(0.20420352F) * 10.0F, -0.5F + azz.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", gkw.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gkt.a);
      gkw $$4 = gkw.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gkt.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gkt.a(10.0F, 4.0F, 0.0F));
