...
public class gkf {
   ...
   public final Map<jm, gkg> c;
   public final gkh d;
   public final boolean e;
   public final int f;

   public gkf(Vector3f $$0, Vector3f $$1, Map<jm, gkg> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gkf(Vector3f $$0, Vector3f $$1, Map<jm, gkg> $$2, @Nullable gkh $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gkg> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gkf> {
      ...
      public gkf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         gkh $$6 = this.a($$3);
         Map<jm, gkg> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !azd.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = azd.a($$3, "shade", true);
            int $$9 = 0;
            if ($$3.has("light_emission")) {
               boolean $$10 = azd.b($$3, "light_emission");
               if ($$10) {
                  $$9 = azd.o($$3, "light_emission");
               }
            ...
            return new gkf($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gkh a(JsonObject $$0) {
         gkh $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = azd.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            jm.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = azd.a($$2, "rescale", false);
            $$1 = new gkh($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = azd.m($$0, "angle");
         if ($$1 != 0.0F && azn.e($$1) != 22.5F && azn.e($$1) != 45.0F) {
      ...
      private Map<jm, gkg> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gkg> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gkg> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gkg> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = azd.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gkg)$$0.deserialize($$4.getValue(), gkg.class));
         }
