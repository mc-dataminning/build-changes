...
public class sr extends sm<ss> {
   ...
   public static final tm<sr> a = new tm.b<sr>() {
      public sr a(DataInput $$0, sw $$1) throws IOException {
         return new sr(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof sr && Arrays.equals(this.c, ((sr)$$0).c);
   }
   ...
   public ss a(int $$0, ss $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return ss.a($$2);
   }

   public void b(int $$0, ss $$1) {
   ...
   public boolean b(int $$0, tk $$1) {
      if ($$1 instanceof td) {
         this.c = ArrayUtils.add(this.c, $$0, ((td)$$1).g());
         return true;
      } else {
         return false;
      }
