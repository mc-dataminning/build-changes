...
public class fpg {
   ...
   private static final Comparator<gfv> p = Comparator.<gfv>comparingInt($$0 -> -$$0.j())
   ...
   private xv t;
   private boolean u;
   private final Map<UUID, fpg.a> v = new Object2ObjectOpenHashMap();

   public fpg(fmf $$0, fnq $$1) {
      this.q = $$0;
      this.r = $$1;
   }
   ...
   public void a(fnr $$0, int $$1, fdc $$2, @Nullable fcu $$3) {
      List<gfv> $$4 = this.b();
      List<fpg.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            if ($$21) {
               ...
               boolean $$45 = $$44 != null && gsq.b($$44);
               boolean $$46 = $$44 != null && $$44.a(cpx.g);
               fpe.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45, -1);
               $$39 += 9;
            }
   ...
   protected void a(fnr $$0, int $$1, int $$2, int $$3, gfv $$4) {
      alz $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(glu::C, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fcu $$0, int $$1, fpg.b $$2, int $$3, int $$4, UUID $$5, fnr $$6) {
      if ($$0.h() == fdf.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fnr $$4, int $$5) {
      fpg.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fpg.a($$5));
      $$6.a($$5, (long)this.r.e());
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(glu::C, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(glu::C, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(glu::C, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(glu::C, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(glu::C, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(glu::C, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
