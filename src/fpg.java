...
public class fpg extends fpj<fpg.b> {
   ...
   public fpg(gdz $$0, cpl $$1, boolean $$2) {
      super(new fpg.b($$0), $$0.fZ(), wy.a);
      $$0.cd = this.x;
      this.r = 136;
      this.c = 195;
      this.ad = $$2;
      this.a($$0.h.B(), $$1, this.a($$0), $$0.dP().H_());
   }
   ...
   private boolean a(@Nullable fzu $$0, cpl $$1, boolean $$2, jo.a $$3) {
      if (!ctb.a($$1, $$2, $$3)) {
         return false;
      } else {
         if ($$0 != null) {
   ...
   public void C() {
      ...
      if (this.l != null) {
         if (this.l.s != null) {
            this.a(this.l.s.h.x(), this.a(this.l.s), this.l.s.dP().H_());
         }

         if (!this.l.q.f()) {
            this.l.a(new fpr(this.l.s));
         }
      }
   }
      ...
      if ($$0 == null && T.k() != cta.h.b && $$3 != cqe.f) {
         ...
         if ($$0 == this.Y && $$4) {
            ...
            if ($$0 == this.Y) {
               ...
               this.l.s.a($$6, true);
               this.l.q.a($$6);
               this.l.q.a($$7, ((fpg.c)$$0).a.d);
            } else if ($$3 == cqe.e && !this.x.g().e()) {
               this.l.s.a(this.x.g(), true);
               this.l.q.a(this.x.g());
               this.x.b(cuq.l);
            } else {
               this.l.s.cc.a($$0 == null ? $$1 : ((fpg.c)$$0).a.d, $$2, $$3, this.l.s);
               this.l.s.cc.d();
            }
   ...
   protected void aT_() {
      if (this.l.q.f()) {
         super.aT_();
         this.W = new fit(this.o, this.A + 82, this.B + 6, 80, 9, wz.c("itemGroup.search"));
         this.W.f(50);
         this.W.d(false);
         this.W.g(false);
         this.W.g(16777215);
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (T.k() != cta.h.d) {
         ...
         boolean $$4 = fac.a($$0, $$1).e().isPresent();
         if ($$3 && $$4 && this.a($$0, $$1)) {
            this.aa = true;
            return true;
         } else {
   ...
   private void a(cta $$0) {
      ...
      if (T.k() == cta.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.i.size(); $$10++) {
            ...
            crq $$26 = new fpg.c($$9.i.get($$10), $$10, $$14, $$15);
            this.x.i.add($$26);
         }
   ...
   public List<wz> a(cuq $$0) {
      boolean $$1 = this.z != null && this.z instanceof fpg.a;
   ...
   protected void a(fhx $$0, float $$1, int $$2, int $$3) {
      ...
      this.a($$0, T);
      if (T.k() == cta.h.b) {
         fpr.a($$0, this.A + 73, this.B + 6, this.A + 105, this.B + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.l.s);
      }
   }
   ...
   protected boolean a(fhx $$0, cta $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   public static void a(fgm $$0, int $$1, boolean $$2, boolean $$3) {
      gdz $$4 = $$0.s;
      ka $$5 = $$4.dP().H_();
      fgi $$6 = $$0.aB();
      geb $$7 = $$6.a($$1);
   ...
   static class a extends crq {
      ...
      public boolean a(cmx $$0) {
         cuq $$1 = this.g();
         return super.a($$0) && !$$1.e() ? $$1.a($$0.dP().J()) && !$$1.b(kq.s) : $$1.e();
      }
   }
   ...
   public static class b extends cpu {
      ...
      public b(cmx $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new fpg.a(fpg.Q, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }
