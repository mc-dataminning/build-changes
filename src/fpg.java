...
public class fpg {
   ...
   public void a(fpg.b $$0, List<atp> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fpg.c($$0, $$1.stream().map(atp::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fpg.c(fpg.b.c, ImmutableList.of());
      }

      this.b.c = new fpg.a($$0);
   }
