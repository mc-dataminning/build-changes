public class fpg extends fot<cqm> implements fsg {
   private static final akr E = akr.b("textures/gui/container/crafting_table.png");
   private final fsa F = new fsa();
   private boolean G;

   public fpg(cqm $$0, cmw $$1, wz $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aT_() {
      ...
      this.c(new fiy(this.A + 5, this.n / 2 - 49, 20, 18, fsa.a, $$0 -> {
         this.F.e();
         this.A = this.F.a(this.m, this.c);
