...
public class fpg extends fnz<crb> {
   ...
   private int ah;
   private final fpg.a[] ai = new fpg.a[7];
   int aj;
   private boolean ak;

   public fpg(crb $$0, cmu $$1, xo $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.u = 107;
   }
   ...
   protected void aM_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.ai[$$3] = this.c(new fpg.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fpg.a) {
               this.ah = ((fpg.a)$$0x).a() + this.aj;
               this.F();
            }
         }));
         $$2 += 20;
   ...
   private void a(fgp $$0, int $$1, int $$2, dau $$3) {
      int $$4 = this.w.n();
      int $$5 = this.w.l();
      if ($$4 < 5) {
         ...
         if ($$5 >= $$6 && cmj.d($$4)) {
            ...
            int $$9 = Math.min(ayx.d($$8 * (float)($$5 - $$6)), 102);
            $$0.a(F, 102, 5, 0, 0, $$1 + 136, $$2 + 16, 0, $$9, 5);
            int $$10 = this.w.m();
            if ($$10 > 0) {
               int $$11 = Math.min(ayx.d((float)$$10 * $$8), 102 - $$9);
   ...
   private void a(fgp $$0, int $$1, int $$2, dav $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fgp $$0, dau $$1, int $$2, int $$3) {
   ...
   private void a(fgp $$0, cun $$1, cun $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.I() == $$1.I()) {
         $$0.a(this.p, $$1, $$3, $$4);
      } else {
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      ...
      if (this.a($$4)) {
         int $$5 = $$4 - 7;
         this.aj = ayx.a((int)((double)this.aj - $$3), 0, $$5);
      }
   ...
   class a extends fhc {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fhc.c $$3) {
      ...
      public void a(fgp $$0, int $$1, int $$2) {
         if (this.i && fpg.this.w.p().size() > this.a + fpg.this.aj) {
            if ($$1 < this.C() + 20) {
               cun $$3 = fpg.this.w.p().get(this.a + fpg.this.aj).b();
               $$0.b(fpg.this.p, $$3, $$1, $$2);
            } else if ($$1 < this.C() + 50 && $$1 > this.C() + 30) {
               cun $$4 = fpg.this.w.p().get(this.a + fpg.this.aj).c();
               if (!$$4.e()) {
                  $$0.b(fpg.this.p, $$4, $$1, $$2);
               }
            } else if ($$1 > this.C() + 65) {
               cun $$5 = fpg.this.w.p().get(this.a + fpg.this.aj).f();
               $$0.b(fpg.this.p, $$5, $$1, $$2);
            }
         }
      }
   }
