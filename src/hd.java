...
public interface hd<T> {
   ...
   hf<T> a(@Nullable sw var1, CommandDispatcher<T> var2) throws dx;
   ...
   static <T extends dw<T>> hd<T> a(aiy $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      he<T> $$4 = new he<>();
   ...
   static <T extends dw<T>> gu<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new gw.c<>($$2.getString(), $$4.get());
      }
   }
}
