...
public class hd {
   public static <T, C, P> boa<List<T>> a(hd.b<T, C, P> $$0) {
      bnq<List<T>> $$1 = bnq.a("top");
      bnq<Optional<T>> $$2 = bnq.a("type");
      bnq<bat> $$3 = bnq.a("any_type");
   ...
   static class a<T, C, P> extends boc<hd.b<T, C, P>, C> {
      a(bnq<all> $$0, hd.b<T, C, P> $$1) {
         super($$0, $$1);
      }

      @Override
      protected C a(ImmutableStringReader $$0, all $$1) throws Exception {
         return this.a.c($$0, $$1);
      }
   ...
   public interface b<T, C, P> {
      T a(ImmutableStringReader var1, all var2) throws CommandSyntaxException;

      Stream<all> a();

      T b(ImmutableStringReader var1, all var2) throws CommandSyntaxException;

      Stream<all> b();

      C c(ImmutableStringReader var1, all var2) throws CommandSyntaxException;

      Stream<all> c();

      T a(ImmutableStringReader var1, C var2, vk var3) throws CommandSyntaxException;

      T a(ImmutableStringReader var1, C var2);

      P d(ImmutableStringReader var1, all var2) throws CommandSyntaxException;

      Stream<all> d();

      T b(ImmutableStringReader var1, P var2, vk var3) throws CommandSyntaxException;
   ...
   static class c<T, C, P> extends boc<hd.b<T, C, P>, T> {
      c(bnq<all> $$0, hd.b<T, C, P> $$1) {
         super($$0, $$1);
      }

      @Override
      protected T a(ImmutableStringReader $$0, all $$1) throws Exception {
         return this.a.a($$0, $$1);
      }
   ...
   static class d<T, C, P> extends boc<hd.b<T, C, P>, P> {
      d(bnq<all> $$0, hd.b<T, C, P> $$1) {
         super($$0, $$1);
      }

      @Override
      protected P a(ImmutableStringReader $$0, all $$1) throws Exception {
         return this.a.d($$0, $$1);
      }
   ...
   static class e<T, C, P> extends boc<hd.b<T, C, P>, T> {
      e(bnq<all> $$0, hd.b<T, C, P> $$1) {
         super($$0, $$1);
      }
