...
public class dal extends daq implements dak {
   ...
   private static IntStream a(bdq $$0, ha $$1) {
      return $$0 instanceof beg ? IntStream.of(((beg)$$0).a($$1)) : IntStream.range(0, $$0.b());
   }

   private static boolean b(bdq $$0, ha $$1) {
   ...
   private static boolean c(bdq $$0, ha $$1) {
   ...
   private static boolean a(bdq $$0, cfz $$1, int $$2, @Nullable ha $$3) {
      if (!$$0.b($$2, $$1)) {
         ...
         if ($$0 instanceof beg $$4 && !$$4.a($$2, $$1, $$3)) {
            return false;
         }
   ...
   private static boolean a(bdq $$0, bdq $$1, cfz $$2, int $$3, ha $$4) {
      if (!$$1.a($$0, $$3, $$2)) {
         ...
         if ($$1 instanceof beg $$5 && !$$5.b($$3, $$2, $$4)) {
            return false;
         }
   ...
   private static cfz b(@Nullable bdq $$0, bdq $$1, cfz $$2, int $$3, @Nullable ha $$4) {
      ...
      if (a($$1, $$2, $$3, $$4)) {
         ...
         if ($$6) {
            if ($$7 && $$1 instanceof dal $$10 && !$$10.v()) {
               int $$11 = 0;
               if ($$0 instanceof dal $$12 && $$10.l >= $$12.l) {
                  $$11 = 1;
               }
   ...
   public static List<bvh> b(cmm $$0, dak $$1) {
      return $$1.aq_()
         .d()
         .stream()
         .flatMap($$2 -> $$0.a(bvh.class, $$2.d($$1.G() - 0.5, $$1.I() - 0.5, $$1.J() - 0.5), bfm.a).stream())
   ...
   private static bdq a(cmm $$0, double $$1, double $$2, double $$3) {
      ...
      if ($$7 instanceof beh) {
         ...
         if ($$8 instanceof bdq) {
            $$4 = (bdq)$$8;
            if ($$4 instanceof czu && $$7 instanceof cqp) {
      ...
      if ($$4 == null) {
         List<bfj> $$9 = $$0.a((bfj)null, new eed($$1 - 0.5, $$2 - 0.5, $$3 - 0.5, $$1 + 0.5, $$2 + 0.5, $$3 + 0.5), bfm.d);
         if (!$$9.isEmpty()) {
            $$4 = (bdq)$$9.get($$0.z.a($$9.size()));
         }
      }
   ...
   public static void a(cmm $$0, gu $$1, dcb $$2, bfj $$3, dal $$4) {
      if ($$3 instanceof bvh && eey.c(eey.a($$3.cE().d((double)(-$$1.u()), (double)(-$$1.v()), (double)(-$$1.w()))), $$4.aq_(), eem.i)) {
         a($$0, $$1, $$2, $$4, () -> a($$4, (bvh)$$3));
      }
   }
