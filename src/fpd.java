...
public final class fpd {
   ...
   private static final fpd c = new fpd(HostAndPort.fromParts("server.invalid", 25565));

   public fpd(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fpd(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fpd a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fpd($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fpd ? this.b.equals(((fpd)$$0).b) : false;
      }
   }
