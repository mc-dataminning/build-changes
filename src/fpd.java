...
public class fpd extends fqh {
   ...
   protected void aS_() {
      ...
      this.b = new fkx(this.m.i, 4, this.o - 12, this.n - 4, 12, xe.c("chat.editBox")) {
         @Override
         protected xs aP_() {
            return super.aP_().b(fpd.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fkr(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(fkb $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fij $$4 = this.m.m.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(fol $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fok.a, xe.a("chat_screen.message", $$1));
      }
   }
   ...
   public String a(String $$0) {
      return bac.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
