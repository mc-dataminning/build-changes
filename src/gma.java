...
public record gma(Map<String, String> c, Set<String> d) {
   public static final gma a = new gma(Map.of(), Set.of());
   public static final Codec<gma> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gma::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gma::e)
            )
            .apply($$0, gma::new)
   );

   public static gma.a a() {
      return new gma.a();
   }
   ...
   public gma a(gma $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gma($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gma.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gma.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gma.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gma a() {
         return new gma(this.a.build(), this.b.build());
      }
   }
}
