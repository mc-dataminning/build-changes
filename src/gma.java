...
public class gma implements glw {
   ...
   private final cya e;
   private final axd f;
   private final Object2ObjectArrayMap<cxy, gma.a> g = new Object2ObjectArrayMap();
   private Optional<cxw> h = Optional.empty();
   private Optional<cxv> i = Optional.empty();
   private float j;
   @Nullable
   private cxy k;

   public gma(fws $$0, gnq $$1, cya $$2) {
      this.f = $$0.dM().E_();
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   ...
   @Override
   public void a() {
      this.g.values().removeIf(glv::m);
      cxy $$0 = this.e.a(this.c.dr(), this.c.dt(), this.c.dx()).a();
      if ($$0 != this.k) {
         this.k = $$0;
         this.h = $$0.m();
         this.i = $$0.n();
         this.g.values().forEach(gma.a::o);
         ...
         .ifPresent(
            $$0x -> {
               ...
               if ($$4 > 0) {
                  ...
                  this.j = this.j - (float)($$1.a(cxi.b, $$3) - 1) / (float)$$0x.b();
               }
               ...
               if (this.j >= 1.0F) {
                  ...
                  double $$12 = $$11 + $$0x.d();
                  gmh $$13 = gmh.a($$0x.a().a(), this.f, this.c.dr() + $$8 / $$11 * $$12, this.c.dv() + $$9 / $$11 * $$12, this.c.dx() + $$10 / $$11 * $$12);
                  this.d.a($$13);
                  this.j = 0.0F;
               } else {
