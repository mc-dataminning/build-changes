...
public abstract class coh extends ckc {
   protected static final akj<Boolean> c = akn.a(coh.class, akl.k);
   static final Predicate<cjf> b = $$0 -> !$$0.y() && $$0.bD() && cun.a($$0.p(), cog.a($$0.dR().b(lq.d)));
   @Nullable
   protected cog d;
   private int e;
   private boolean bY;
   ...
   protected coh(bsy<? extends coh> $$0, dbw $$1) {
      super($$0, $$1);
   }
   ...
   protected void z() {
      super.z();
      this.bS.a(1, new coh.b<>(this));
      this.bS.a(3, new cbf<>(this));
      this.bS.a(4, new coh.d(this, 1.05F, 1));
      this.bS.a(5, new coh.c(this));
   }
      ...
      if (this.dP() instanceof are && this.bD()) {
         ...
         if (this.gD()) {
            if ($$0 == null) {
               ...
               btn $$2 = this.p();
               if ($$2 != null && ($$2.ak() == bsy.by || $$2.ak() == bsy.af)) {
                  this.bf = 0;
               }
            }
         }
   ...
   public void a(brl $$0) {
      if (this.dP() instanceof are) {
         ...
         if (!this.dP().J().b(cpl.c) && this.gu() && $$2 == null && ((are)this.dP()).d(this.dp()) == null) {
            cun $$3 = this.a(bsz.f);
            cmv $$4 = null;
            if ($$1 instanceof cmv) {
               $$4 = (cmv)$$1;
            } else if ($$1 instanceof cgg $$6) {
               btn $$7 = $$6.P_();
               if ($$6.s() && $$7 instanceof cmv) {
                  $$4 = (cmv)$$7;
               }
            }

            if (!$$3.e() && cun.a($$3, cog.a(this.dR().b(lq.d))) && $$4 != null) {
               bsa $$8 = $$4.c(bsc.E);
               int $$9 = 1;
               if ($$8 != null) {
                  $$9 += $$8.e();
               ...
               $$9 = ayx.a($$9, 0, 4);
               bsa $$10 = new bsa(bsc.E, 120000, $$9, false, false, true);
               if (!this.dP().ab().b(dbs.B)) {
                  $$4.b($$10);
               }
            }
         }
   ...
   public boolean gF() {
      cun $$0 = this.a(bsz.f);
      boolean $$1 = !$$0.e() && cun.a($$0, cog.a(this.dR().b(lq.d)));
      boolean $$2 = this.gu();
      return $$1 && $$2;
   }
   ...
   protected void b(cjf $$0) {
      ...
      if (this.gH() && !$$2 && cun.a($$1, cog.a(this.dR().b(lq.d)))) {
         bsz $$3 = bsz.f;
         cun $$4 = this.a($$3);
   ...
   public bug a(dcl $$0, bqq $$1, btr $$2, @Nullable bug $$3) {
      this.z(this.ak() != bsy.bo || $$2 != btr.a);
      return super.a($$0, $$1, $$2, $$3);
   }

   public abstract avy ae_();

   protected class a extends cal {
      private final coh b;
      private final float c;
      public final cee a = cee.b().a(8.0).d().e();
      ...
      public boolean a() {
         btn $$0 = this.b.em();
         return this.b.gE() == null && this.b.gz() && this.b.p() != null && !this.b.gi() && ($$0 == null || $$0.ak() != bsy.by);
      }
      ...
      public void c() {
         ...
         for (coh $$1 : this.b.dP().a(coh.class, this.a, this.b, this.b.cK().c(8.0, 8.0, 8.0))) {
            $$1.h(this.b.p());
         }
      }
      ...
      public void d() {
         ...
         btn $$0 = this.b.p();
         if ($$0 != null) {
            for (coh $$2 : this.b.dP().a(coh.class, this.a, this.b, this.b.cK().c(8.0, 8.0, 8.0))) {
               $$2.h($$0);
               $$2.v(true);
            }
      ...
      public void e() {
         btn $$0 = this.b.p();
         if ($$0 != null) {
            if (this.b.g((bss)$$0) > (double)this.c) {
   ...
   public class b<T extends coh> extends cal {
      private final T a;
      ...
      public boolean a() {
         cog $$0 = this.a.gE();
         if (this.a.gH() && !this.a.gE().a() && this.a.gr() && !cun.a(this.a.a(bsz.f), cog.a(this.a.dR().b(lq.d)))) {
            coh $$1 = $$0.b(this.a.gI());
            if ($$1 == null || !$$1.bD()) {
               List<cjf> $$2 = this.a.dP().a(cjf.class, this.a.cK().c(16.0, 8.0, 16.0), coh.b);
               if (!$$2.isEmpty()) {
      ...
      public void e() {
         if (this.a.K().h().a(this.a.dn(), 1.414)) {
            List<cjf> $$0 = this.a.dP().a(cjf.class, this.a.cK().c(4.0, 4.0, 4.0), coh.b);
            if (!$$0.isEmpty()) {
               this.a.b($$0.get(0));
            }
         }
   ...
   static class d extends cal {
      ...
      private boolean i() {
         are $$0 = (are)this.a.dP();
         iz $$1 = this.a.dp();
         Optional<iz> $$2 = $$0.y().a($$0x -> $$0x.a(cev.n), this::a, cer.b.c, $$1, 48, this.a.ah);
         if ($$2.isEmpty()) {
            return false;
         } else {
            this.c = $$2.get().i();
      ...
      public void e() {
         if (this.a.K().l()) {
            evp $$0 = evp.c(this.c);
            evp $$1 = cei.a(this.a, 16, 7, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
