public class coh extends cnh {
   ...
   public coh(int $$0, ckk $$1, boj $$2, final cex $$3) {
      super(null, $$0);
      this.k = $$2;
      this.l = $$3.gY();
      this.m = $$3;
      ...
      $$2.d_($$1.m);
      int $$5 = -18;
      this.a(new cpd($$2, 0, 8, 18) {
         @Override
         public boolean a(csd $$0) {
            return $$0.a(csg.nL) && !this.h() && $$3.f();
         }
      ...
      if (this.a($$3)) {
         for (int $$6 = 0; $$6 < 3; $$6++) {
            for (int $$7 = 0; $$7 < ((cew)$$3).gx(); $$7++) {
               this.a(new cpd($$2, 1 + $$7 + $$6 * ((cew)$$3).gx(), 80 + $$7 * 18, 18 + $$6 * 18));
            }
         }
      }
      ...
      for (int $$8 = 0; $$8 < 3; $$8++) {
         for (int $$9 = 0; $$9 < 9; $$9++) {
            this.a(new cpd($$1, $$9 + $$8 * 9 + 9, 8 + $$9 * 18, 102 + $$8 * 18 + -18));
         }
      }

      for (int $$10 = 0; $$10 < 9; $$10++) {
         this.a(new cpd($$1, $$10, 8 + $$10 * 18, 142));
      }
   }
