...
public final class gav {
   ...
   private static final gav c = new gav(HostAndPort.fromParts("server.invalid", 25565));

   public gav(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gav(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gav a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gav($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gav ? this.b.equals(((gav)$$0).b) : false;
      }
   }
