public abstract class evw implements ewc {
   private int c;
   private int d;
   protected int a;
   protected int b;

   public evw(int $$0, int $$1, int $$2, int $$3) {
      this.c = $$0;
      this.d = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   protected abstract static class a {
      ...
      public void b(int $$0, int $$1) {
         ...
         int $$4 = Math.round(ary.i(this.b.f, $$2, $$3));
         this.a.g($$4 + $$0);
      }
   }
}
