...
public class evw extends euy {
   ...
   public evw(eur $$0, int $$1, int $$2, int $$3, int $$4, uv $$5, uv $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new evz($$0, $$3 - this.b());
      this.o.a(this::v);
   }
   ...
   @Override
   public void a(eyx $$0) {
      $$0.a(eyw.a, uv.a("gui.narrate.editBox", this.l(), this.u()));
   }
   ...
   protected void a(eut $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         uv $$2 = uv.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void v() {
      double $$0 = this.c();
      evz.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         evz.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
