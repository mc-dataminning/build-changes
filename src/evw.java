...
public class evw {
   ...
   public static final Codec<jr<evw>> e = akq.a(mc.bg, d);
   private final baj g;
   ...
   evw(baj $$0, Optional<aku> $$1, List<evv> $$2, List<exf> $$3) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static Consumer<cwp> a(arc $$0, Consumer<cwp> $$1) {
      return $$2 -> {
         if ($$2.a($$0.K())) {
            if ($$2.M() < $$2.k()) {
               $$1.accept($$2);
   ...
   public void a(bsc $$0, evu $$1, long $$2) {
