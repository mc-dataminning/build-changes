...
public interface akg {
   akg a = new akg() {
      ...
      @Override
      public void a(Consumer<cpe> $$0) {
      }
   };

   static akg a(cpe $$0, int $$1) {
      return new akg.a($$0, $$1);
   }

   static void a(akg $$0, akg $$1, Consumer<cpe> $$2, Consumer<cpe> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof akg.a $$4 && $$1 instanceof akg.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cpe($$10, $$11));
                     } else {
                        $$3.accept(new cpe($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cpe b, int c) implements akg {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(akg.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return akg.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
