...
public class akg<R extends dbe<?>> {
   ...
   public static <I extends dbk, R extends dbe<I>> ctr.a a(
      akg.a<R> $$0, int $$1, int $$2, List<ctz> $$3, List<ctz> $$4, cow $$5, dbj<R> $$6, boolean $$7, boolean $$8
   ) {
   ...
   private akg(akg.a<R> $$0, cow $$1, boolean $$2, int $$3, int $$4, List<ctz> $$5, List<ctz> $$6) {
      this.c = $$0;
      this.b = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private void b(dbj<R> $$0, cpc $$1) {
      ...
      if ($$1.a($$0.b(), $$6, $$7::add)) {
         OptionalInt $$8 = $$7.stream().mapToInt($$0x -> ((cwl)$$0x.a()).h()).min();
         if ($$8.isPresent()) {
