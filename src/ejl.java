...
public class ejl {
   ...
   @Nullable
   private String g;
   private static final ejl.a h = new ejl.a() {
      @Nullable
      @Override
      public ejk a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ejo.a(this.d, "Get capabilities")) {
         ...
         int $$5 = this.i();
         int $$6 = arw.a((int)arw.c((float)$$5), 2, 8);
         int $$7 = arw.a($$5 - $$6, 8, 255);
         this.i = new ejl.b($$7);
         this.j = new ejl.b($$6);
         ALCapabilities $$8 = AL.createCapabilities($$2);
         ejo.a("Initialization");
         if (!$$8.AL_EXT_source_distance_model) {
            ...
            if (!$$8.AL_EXT_LINEAR_DISTANCE) {
               ...
               ejo.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ejo.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ejk a(ejl.c $$0) {
      return ($$0 == ejl.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ejl.a {
      private final int a;
      private final Set<ejk> b = Sets.newIdentityHashSet();
      ...
      public ejk a() {
         if (this.b.size() >= this.a) {
            if (aa.aT) {
               ejl.a.warn("Maximum sound pool size {} reached", this.a);
            }
