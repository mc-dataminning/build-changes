...
public class ejl {
   ...
   private static final dmy.f e = ($$0, $$1, $$2) -> $$0.a(dac.co);
   ...
   public static Optional<ejl> a(cxa $$0, ib $$1, ih.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<ejl> a(cxa $$0, ib $$1, Predicate<ejl> $$2, ih.a $$3) {
      Optional<ejl> $$4 = Optional.of(new ejl($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ih.a $$5 = $$3 == ih.a.a ? ih.a.c : ih.a.a;
         return Optional.of(new ejl($$0, $$1, $$5)).filter($$2);
      }
   }

   public ejl(cxa $$0, ib $$1, ih.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(dmz $$0) {
      return $$0.i() || $$0.a(aun.aK) || $$0.a(dac.ed);
   }
   ...
   public static epr a(l.a $$0, ih.a $$1, epr $$2, boz $$3) {
      ...
      return new epr($$8, $$11, $$14);
   }

   public static ejk a(apf $$0, l.a $$1, ih.a $$2, epr $$3, bow $$4, epr $$5, float $$6, float $$7) {
      ib $$8 = $$1.a;
      dmz $$9 = $$0.a_($$8);
      ih.a $$10 = $$9.d(dnp.H).orElse(ih.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      boz $$13 = $$4.a($$4.ap());
      int $$14 = $$2 == $$10 ? 0 : 90;
      epr $$15 = $$2 == $$10 ? $$5 : new epr($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a() / 2.0 + ($$11 - (double)$$13.a()) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b()) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == ih.a.a;
      epr $$20 = new epr((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      epr $$21 = a($$20, $$0, $$4, $$13);
      return new ejk($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static epr a(epr $$0, apf $$1, bow $$2, boz $$3) {
      if (!($$3.a() > 4.0F) && !($$3.b() > 4.0F)) {
         double $$4 = (double)$$3.b() / 2.0;
         epr $$5 = $$0.b(0.0, $$4, 0.0);
         eqk $$6 = eqh.a(epm.a($$5, (double)$$3.a(), 0.0, (double)$$3.a()).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<epr> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a(), (double)$$3.b(), (double)$$3.a());
         Optional<epr> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
