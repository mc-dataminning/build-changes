...
public class ejl {
   ...
   public Optional<l.a> a(ib $$0, boolean $$1, dos $$2) {
      cas $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<cat> $$5 = $$3.b($$0x -> $$0x.a(caw.r), $$0, $$4, cas.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<cat>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dnr.H))
         .findFirst();
      return $$5.map($$0x -> {
         ib $$1x = $$0x.f();
         this.n.l().a(apk.f, new cwi($$1x), 3, $$1x);
         dnb $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dnr.H), 21, ih.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(ib $$0, ih.a $$1) {
      ...
      ib $$6 = null;
      dos $$7 = this.n.C_();
      int $$8 = Math.min(this.n.ak(), this.n.I_() + this.n.k()) - 1;
      ib.a $$9 = $$0.j();

      for (ib.a $$10 : ib.a($$0, 16, ih.f, ih.d)) {
         int $$11 = Math.min($$8, this.n.a(dso.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
         if ($$7.a($$10) && $$7.a($$10.c($$2, 1))) {
            ...
            for (int $$13 = $$11; $$13 >= this.n.I_(); $$13--) {
               ...
               if (this.a($$10)) {
                  ...
                  while ($$13 > this.n.I_() && this.a($$10.c(ih.a))) {
                     $$13--;
                  }
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new ib($$0.u(), aww.a($$0.v(), $$17, $$18), $$0.w()).i();
         ih $$19 = $$2.h();
         if (!$$7.a($$4)) {
            return Optional.empty();
         }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, dae.co.o(), 3);
            }
         }
      }

      dnb $$26 = dae.ed.o().a(dff.b, $$1);
