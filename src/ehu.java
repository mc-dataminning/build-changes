...
public class ehu extends ehy {
   public static final MapCodec<ehu> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ehh.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayl.a(jj.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, ehu::new)
   );
   ...
   protected final ehh e;
   protected final int f;
   protected final List<jj> g;

   public ehu(float $$0, int $$1, int $$2, ehh $$3, int $$4, List<jj> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(ehy.a $$0, je $$1, jj $$2) {
