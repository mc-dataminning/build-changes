...
public class bmq extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bmt.a(new Dynamic($$0, $$1), bmq.a, bmt.a);
      }
   };

   public bmq(int $$0, Schema $$1) {
      super($$0, $$1);
   }
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bhu.s.typeName()) ? super.getChoiceType($$0, bji.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bhu.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bhu.s, () -> DSL.optionalFields("components", bhu.w.in($$0), DSL.taggedChoiceLazy("id", bji.a(), $$2)));
      $$0.registerType(
         true,
         bhu.t,
         () -> DSL.hook(
