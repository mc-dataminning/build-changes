...
public class bmq {
   ...
   private bmq(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bmq a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bmq($$0, $$1);
   }

   public bmq.d a() throws IOException {
      bmq.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bmq.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bmq.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bmq.c $$3 = bmq.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bmq.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bmq.a($$0, $$3);
            }
         }
   ...
   public bmq.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bmq.c> $$2 = this.a().c();
      ...
      bmq.e $$4 = new bmq.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bmq.c b) implements bmq.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bmq.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bmq.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bmq.b> {
      private final List<bmq.b> a;

      d(List<bmq.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bmq.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bmq.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bmq.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bmq.d a() {
         ListIterator<bmq.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bmq.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bmq.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bmq.b> b() {
         return this.a.stream();
      }

      public Set<bmq.c> c() {
         return this.a.stream().map(bmq.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bmq.c b) implements bmq.b {
