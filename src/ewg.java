...
public class ewg extends ewj {
   ...
   static final ewg.b l = new ewg.b(854, 480);
   ...
   static enum a {
      ...
      private static final ewg.a[] e = values();
   ...
   static class b {
      ...
      static List<ewg.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ewg.b($$0, $$1), ewg.l) : ImmutableList.of(ewg.l);
      }
