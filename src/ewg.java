...
public class ewg implements ewh, ewi {
   ...
   public ewg(dhl $$0, een $$1, ewg.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         jh.c,
   ...
   public static <T> ewg a(Dynamic<T> $$0, dhl $$1, ewg.a $$2, een $$3, Lifecycle $$4) {
      ...
      return new ewg(
         ...
         $$0.get("DragonFight").read(ebs.a.a).resultOrPartial(f::error).orElse(ebs.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(ke $$0, ux $$1, @Nullable ux $$2) {
      ...
      eel.a($$4, this.h, $$0).resultOrPartial(ae.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vu)ebs.a.a.encodeStart(vl.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      die.b.encodeStart(vl.a, this.g.g()).ifSuccess($$1x -> $$1.a((ux)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
