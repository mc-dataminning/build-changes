...
public class ewg implements ewh, ewi {
   ...
   private final fbk<MinecraftServer> G;
   ...
   public ewg(dhd $$0, eem $$1, ewg.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         ji.c,
   ...
   public static <T> ewg a(Dynamic<T> $$0, dhd $$1, ewg.a $$2, eem $$3, Lifecycle $$4) {
      ...
      return new ewg(
         ...
         new fbk<>(fbj.a, $$0.get("ScheduledEvents").asStream()),
         (tq)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(ebp.a.a).resultOrPartial(f::error).orElse(ebp.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(kf $$0, tq $$1, @Nullable tq $$2) {
      ...
      eek.a($$4, this.h, $$0).resultOrPartial(af.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (un)ebp.a.a.encodeStart(ue.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dhx.b.encodeStart(ue.a, this.g.g()).ifSuccess($$1x -> $$1.a((tq)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == ewg.a.b;
   }

   @Override
   public boolean A() {
      return this.i == ewg.a.c;
   }
