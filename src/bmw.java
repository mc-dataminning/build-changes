...
public class bmw implements bmx {
   ...
   private static final bmw k = new bmw();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bmv $$0) {
      URL $$1 = bmw.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bmv $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bmz a = new bmz(() -> bmw.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmw.this.l && $$0.getState() == RecordingState.STOPPED) {
