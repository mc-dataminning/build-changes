...
public interface bmw {
   static bmq<StringReader> a(String $$0) {
      return new bmw.b($$0);
   }

   static bmq<StringReader> a(char $$0) {
      return new bmw.a($$0);
   }

   public static record a(char a) implements bmq<StringReader> {
      @Override
      public boolean a(bmm<StringReader> $$0, bmo $$1, bmi $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bmq<StringReader> {
      @Override
      public boolean a(bmm<StringReader> $$0, bmo $$1, bmi $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
