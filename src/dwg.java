...
public abstract class dwg<T extends Comparable<T>> {
   ...
   private final Codec<dwg.a<T>> e = this.d.xmap(this::b, dwg.a::b);

   protected dwg(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dwg.a<T> b(T $$0) {
      return new dwg.a<>(this, $$0);
   }

   public dwg.a<T> a(dvf<?, ?> $$0) {
      return new dwg.a<>(this, $$0.c(this));
   }

   public Stream<dwg.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dwg<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dvf<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dwg<T> a, T b) {
      public a(dwg<T> a, T b) {
         if (!a.a().contains(b)) {
