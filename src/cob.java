public class cob extends cok {
   ...
   public cob(bwr<? extends cob> $$0, djh $$1) {
      super($$0, $$1);
      this.by = 3;
   }
   ...
   protected void D() {
      ...
      this.bD.a(7, new cen(this, crj.class, 8.0F));
   ...
   public static byo.a j() {
      return cok.gw().a(byp.s, 8.0).a(byp.v, 0.25).a(byp.c, 2.0);
   }
   ...
   public static boolean b(bwr<cob> $$0, dji $$1, bwq $$2, iv $$3, azv $$4) {
      if (!c($$0, $$1, $$2, $$3, $$4)) {
         return false;
      } else if (bwq.a($$2)) {
         return true;
