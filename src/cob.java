public class cob extends cno {
   ...
   public int a(int $$0, bho $$1) {
      if ($$1.a(apv.d)) {
         ...
         return $$0;
      } else if (this.a == cob.a.b && $$1.a(apv.i)) {
         return $$0 * 2;
      } else if (this.a == cob.a.c && $$1.a(apv.m)) {
         return $$0 * 3;
      } else if (this.a == cob.a.d && $$1.a(apv.l)) {
         return $$0 * 2;
      } else {
         return this.a == cob.a.e && $$1.a(apv.j) ? $$0 * 2 : 0;
      }
   }
   ...
   public static double a(bjg $$0, double $$1) {
      int $$2 = cnq.a(cns.d, $$0);
      if ($$2 > 0) {
         $$1 *= arx.a(1.0 - (double)$$2 * 0.15, 0.0, 1.0);
      }
