...
public class fuc extends fug {
   public static final akv a = akv.b("textures/gui/title/mojangstudios.png");
   private static final int d = axk.a(255, 239, 50, 61);
   private static final int e = axk.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> flk.Q().n.a().c() ? e : d;
   ...
   public fuc(flk $$0, aul $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fof $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gmj.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gmj.L(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
      ...
      int $$23 = (int)($$22 * 0.5);
      int $$24 = axk.a($$10);
      $$0.a($$0x -> gmj.P(), a, $$18 - $$23, $$19 - $$21, -0.0625F, 0.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
      $$0.a($$0x -> gmj.P(), a, $$18, $$19 - $$21, 0.0625F, 60.0F, $$23, (int)$$20, 120, 60, 120, 120, $$24);
   ...
   private void a(fof $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends hek {
      public a() {
         super(fuc.a);
      }

      @Override
      public heu a(aup $$0) throws IOException {
         aus $$1 = flk.Q().ae().d();

         heu var4;
         try (InputStream $$2 = $$1.open(fuc.a)) {
            var4 = new heu(fev.a($$2), new hgq(true, true));
         }
