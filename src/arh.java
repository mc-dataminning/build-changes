...
public class arh {
   ...
   public static final Codec<tn> b = a(tn.a::a, tn.a::c);
   public static final Codec<tn> c = Codec.STRING.flatXmap($$0 -> {
      try {
         return DataResult.success(tn.a.a($$0));
   ...
   public static final Codec<arh.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aey.b($$0.substring(1)).map($$0x -> new arh.f($$0x, true)) : aey.b($$0).map($$0x -> new arh.f($$0x, false)), arh.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !aey.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> arh.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new arh.b<>($$0, $$1);
   }

   public static <K, V> arh.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new arh.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof arh.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(aey a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
