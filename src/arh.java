...
public class arh implements ard.a, AutoCloseable {
   ...
   public arh(btx<Runnable> $$0, Executor $$1) {
      this.d = new ari($$0.z_() + "_queue");
      this.e = $$0;
      this.f = new btu(4, $$1, "dispatcher");
      this.b = true;
   }
   ...
   @Override
   public void onLevelChange(djo $$0, IntSupplier $$1, int $$2, IntConsumer $$3) {
