...
public abstract class arh implements arq {
   ...
   public <T> T a(asd<T> $$0) throws IOException {
      asw<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asd<T> $$0, InputStream $$1) {
      JsonObject $$3;
