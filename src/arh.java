...
public interface arh {
   arh a = new arh() {
      ...
      @Override
      public void a(Consumer<dgf> $$0) {
      }
   };

   static arh a(dgf $$0, int $$1) {
      return new arh.a($$0, $$1);
   }

   static void a(arh $$0, arh $$1, Consumer<dgf> $$2, Consumer<dgf> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof arh.a $$4 && $$1 instanceof arh.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dgf($$10, $$11));
                     } else {
                        $$3.accept(new dgf($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dgf b, int c) implements arh {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(arh.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return arh.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
