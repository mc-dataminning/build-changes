...
public class mh implements kp {
   ...
   public CompletableFuture<?> a(kn $$0) {
      ...
      Consumer<cqh> $$6 = $$4::add;
      new mf($$2, $$5, $$6).a();
      new mg($$5).a();
      List<dac> $$7 = ki.e.g().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
