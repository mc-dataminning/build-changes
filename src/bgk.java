...
public class bgk extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<?> $$6 = DSL.typeFinder($$0.getTypeRaw(bis.B));
      Type<?> $$7 = this.getOutputSchema().getTypeRaw(bis.B);
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", $$1, $$6x -> {
         ...
         if ($$7x.isPresent() && Objects.equals($$7x.get().getSecond(), "minecraft:spawn_egg")) {
            ...
            if ($$15 != null && ($$13.isEmpty() || !Objects.equals($$13.get(), $$15))) {
               ...
               Typed<?> $$20 = ae.a($$18, $$7, $$2xx -> $$2xx.set("id", $$8.createString($$15)));
