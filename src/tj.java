...
public class tj {
   ...
   protected tj(tj.b $$0, Collection<ta> $$1, arp $$2, tm $$3, tj.c $$4, tj.c $$5, boolean $$6) {
      this.c = $$2;
      this.d = $$3;
      this.i = $$0;
      this.l = $$4;
         ...
         $$3.a(new th() {
            private void a() {
               if ($$3.i()) {
                  ...
                  LongSet $$0 = new LongArraySet(tj.this.c.x());
                  $$0.forEach($$0xxx -> tj.this.c.a(des.a($$0xxx), des.b($$0xxx), false));
                  tj.this.a($$0 + 1);
               }
            }
            ...
            public void b(tg $$0x, tj $$1) {
               if (tj.this.n) {
                  tj.this.k.d().accept(tj.this.c);
                  LongSet $$2 = new LongArraySet(tj.this.c.x());
                  $$2.forEach($$0xxx -> tj.this.c.a(des.a($$0xxx), des.b($$0xxx), false));
                  tm.a.a();
               } else {
                  this.a();
               }
   ...
   public static class a {
      ...
      private tj.b c = tb.a();
      private tj.c d = tj.c.a;
      private tj.c e = tj.c.b;
      private final Collection<ta> f;
      private boolean g = false;

      private a(Collection<ta> $$0, arp $$1) {
         this.f = $$0;
         this.a = $$1;
      }

      public static tj.a a(Collection<ta> $$0, arp $$1) {
         return new tj.a($$0, $$1);
      }

      public static tj.a b(Collection<tg> $$0, arp $$1) {
         return a(tb.a().batch($$0), $$1);
      }

      public tj.a a(boolean $$0) {
         this.g = $$0;
         return this;
      }
      ...
      public tj.a a(tj.b $$0) {
         this.c = $$0;
         return this;
      }

      public tj a() {
         return new tj(this.c, this.f, this.a, this.b, this.d, this.e, this.g);
      }
   }
