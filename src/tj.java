...
public abstract class tj {
   ...
   private static volatile tj e = c();
   ...
   private static tj c() {
      ...
      return new tj() {
         ...
         @Override
         public awy a(wn $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> ayf.c($$2xxx, $$1x, $$1) ? Optional.empty() : wn.a, xf.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = tj.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(axc.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract awy a(wn var1);

   public List<awy> a(List<wn> $$0) {
