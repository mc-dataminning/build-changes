...
public class dss extends dta<dsr> {
   public dss(Codec<dsr> $$0) {
      super($$0);
   }

   public boolean a(dsr $$0, awp $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dsv $$0, dsr $$1, dnf $$2, Function<hz, ij<cwq>> $$3, awp $$4, dqh $$5, cuy $$6, dne $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private void a(
      ...
      for (int $$20 = $$12; $$20 < $$13; $$20++) {
         double $$21 = 1.5 + (double)(awi.a((float)$$20 * (float) Math.PI / (float)$$13) * $$9);
         double $$22 = $$21 * $$14;
         $$21 *= (double)$$1.c.e.a($$16);
         $$22 = this.a($$1, $$16, $$22, (float)$$13, (float)$$20);
         float $$23 = awi.b($$11);
         float $$24 = awi.a($$11);
         $$6 += (double)(awi.b($$10) * $$23);
         $$7 += (double)$$24;
         $$8 += (double)(awi.a($$10) * $$23);
         $$11 *= 0.7F;
         $$11 += $$19 * 0.05F;
         $$10 += $$18 * 0.05F;
         $$19 *= 0.8F;
   ...
   private float[] a(dsv $$0, dsr $$1, awp $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(dsr $$0, awp $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - awi.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)awi.b($$1, 0.75F, 1.0F);
   }

   private boolean a(dsv $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
