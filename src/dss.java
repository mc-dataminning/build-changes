...
public class dss extends dre {
   ...
   public dss(je $$0, dua $$1) {
      super(drg.p, $$0, $$1);
   }

   public static void a(final alw $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, alw $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, alw $$1, BooleanSupplier $$2) {
   ...
   protected void b(uf $$0, jp.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vc)cyn.a.encodeStart(ut.a, this.i).getOrThrow());
      }
      ...
      if (this.m != null) {
         $$0.a("custom_name", xd.a.a(this.m, $$1));
      }
   }
   ...
   protected void a(uf $$0, jp.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         cyn.a.parse(ut.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = alb.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dds $$0, je $$1, dua $$2, dss $$3) {
      if ($$2.b(dny.a) && $$2.c(dny.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
   ...
   public static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && azz.f($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
