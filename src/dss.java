...
public class dss {
   ...
   private final List<dsq> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dss.a l = new dss.d(5.999997E7F);
   public static final dss.c e = new dss.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public io b(double $$0, double $$1, double $$2) {
      return io.a(ayd.a($$0, this.e(), this.g()), $$1, ayd.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bru $$0, euf $$1) {
      double $$2 = Math.max(ayd.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dss.a)($$0 == $$1 ? new dss.d($$1) : new dss.b($$0, $$1, $$2));
   ...
   public dss.c t() {
      return new dss.c(this);
   }

   public void a(dss.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dss.a {
      ...
      @Override
      public double a() {
         return ayd.a(dss.this.a() - this.e() / 2.0, (double)(-dss.this.k), (double)dss.this.k);
      }

      @Override
      public double c() {
         return ayd.a(dss.this.b() - this.e() / 2.0, (double)(-dss.this.k), (double)dss.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ayd.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dsr i() {
         return this.c < this.b ? dsr.b : dsr.a;
      }
      ...
      @Override
      public dss.a l() {
         return (dss.a)(this.g() <= 0L ? dss.this.new d(this.c) : this);
      }
      ...
      public evd m() {
         return eva.a(
            eva.c,
            eva.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            euo.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dss.c a(DynamicLike<?> $$0, dss.c $$1) {
         double $$2 = ayd.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ayd.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dss.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dss.a {
      ...
      private void n() {
         this.c = ayd.a(dss.this.a() - this.b / 2.0, (double)(-dss.this.k), (double)dss.this.k);
         this.d = ayd.a(dss.this.b() - this.b / 2.0, (double)(-dss.this.k), (double)dss.this.k);
         this.e = ayd.a(dss.this.a() + this.b / 2.0, (double)(-dss.this.k), (double)dss.this.k);
         this.f = ayd.a(dss.this.b() + this.b / 2.0, (double)(-dss.this.k), (double)dss.this.k);
         this.g = eva.a(
            eva.c,
            eva.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            euo.e
