...
public class kb extends kd {
   ...
   public static kb a(dbe $$0, int $$1) {
      return new kb($$0.e, $$1, $$0.f);
   }

   public static kb a(dwb $$0) {
      return a($$0.dp());
   }
   ...
   public static Stream<kb> a(dbe $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.e;
      int $$5 = $$0.f;
