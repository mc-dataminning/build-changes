...
public class kb implements jv {
   public static final Codec<kb> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(dno.b.fieldOf("destination").forGetter($$0x -> $$0x.c), Codec.INT.fieldOf("arrival_in_ticks").forGetter($$0x -> $$0x.d))
            .apply($$0, kb::new)
   );
   public static final jv.a<kb> b = new jv.a<kb>() {
      public kb a(jw<kb> $$0, StringReader $$1) throws CommandSyntaxException {
         ...
         return new kb(new dng($$6), $$5);
      }

      public kb a(jw<kb> $$0, ug $$1) {
         dno $$2 = dnp.c($$1);
         int $$3 = $$1.n();
         return new kb($$2, $$3);
      }
