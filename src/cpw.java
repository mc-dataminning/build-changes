      ...
      if (!$$0.e() && dae.a($$0)) {
         ...
         if (!$$5.e()) {
            ...
            if ($$4.l() && $$4.g().a($$0, $$5)) {
               ...
               for (Entry<jm<dac>> $$19 : $$16.b()) {
                  jm<dac> $$20 = (jm<dac>)$$19.getKey();
                  int $$21 = $$6.a($$20);
         ...
         if (this.v != null && !azl.h(this.v)) {
            if (!this.v.equals($$0.w().getString())) {
               $$3 = 1;
               $$1 += $$3;
               $$4.b(kq.g, wz.b(this.v));
            }
         } else if ($$0.b(kq.g)) {
            $$3 = 1;
            $$1 += $$3;
         ...
         int $$27 = (int)ayo.a($$2 + (long)$$1, 0L, 2147483647L);
         this.w.a($$27);
         if ($$1 <= 0) {
            $$4 = cuq.l;
         }
