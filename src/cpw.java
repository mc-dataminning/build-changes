...
public class cpw {
   ...
   private final Map<akl, cpw.a> b = Maps.newHashMap();
   private final ajv c;
   ...
   private List<akl> a(cot $$0) {
      return (List<akl>)this.a.computeIfAbsent($$0.a(), $$1 -> this.c.d($$0));
   }

   public void a(cot $$0, bjb $$1) {
      for (akl $$2 : this.a($$0)) {
         this.b.computeIfAbsent($$2, $$0x -> new cpw.a()).a($$1);
      }
   }

   public boolean a(bjb $$0, cot $$1) {
      for (akl $$2 : this.a($$1)) {
         cpw.a $$3 = this.b.get($$2);
         if ($$3 == null || $$3.b($$0)) {
            return true;
         }
      }
