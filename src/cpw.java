public class cpw extends cpz {
   ...
   public cpw(cpz.a $$0, int $$1, bla... $$2) {
      super($$0, cqa.f, $$2);
      this.d = $$1;
   }
   ...
   public float a(int $$0, blq $$1) {
      ...
      } else if (this.d == 1 && $$1 == blq.b) {
         return (float)$$0 * 2.5F;
      } else {
         return this.d == 2 && $$1 == blq.c ? (float)$$0 * 2.5F : 0.0F;
      }
   }

   @Override
   public boolean a(cpz $$0) {
      return !($$0 instanceof cpw);
   }

   @Override
   public boolean a(clo $$0) {
      return $$0.d() instanceof cjd ? true : super.a($$0);
   }

   @Override
   public void a(bll $$0, bkv $$1, int $$2) {
      if ($$1 instanceof bll $$3 && this.d == 2 && $$2 > 0 && $$3.eT() == blq.c) {
         int $$4 = 20 + $$0.eh().a(10 * $$2);
         $$3.b(new bki(bkk.b, $$4, 3));
      }
   }
}
