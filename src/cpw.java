...
public abstract class cpw {
   ...
   private final jr<cur> l = jr.a();
   public final jr<crr> i = jr.a();
   private final List<cqo> m = Lists.newArrayList();
   private cur n = cur.l;
   private final jr<cur> o = jr.a();
   ...
   protected cpw(@Nullable crd<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cqh $$0, cmz $$1, dfb $$2) {
   ...
   protected static void a(bqp $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cqg $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cur $$1 = this.i.get($$0).g();
         Supplier<cur> $$2 = Suppliers.memoize($$1::s);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cur $$1, Supplier<cur> $$2) {
      cur $$3 = this.l.get($$0);
      if (!cur.a($$3, $$1)) {
         cur $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cur $$1, Supplier<cur> $$2) {
      if (!this.y) {
         cur $$3 = this.o.get($$0);
         if (!cur.a($$3, $$1)) {
            cur $$4 = $$2.get();
   ...
   public abstract cur a(cmz var1, int var2);

   public void a(int $$0, int $$1, cqf $$2, cmz $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cqf $$2, cmz $$3) {
      cmy $$4 = $$3.gc();
      if ($$2 == cqf.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cqf.a || $$2 == cqf.b) && ($$1 == 0 || $$1 == 1)) {
         cqe $$16 = $$1 == 0 ? cqe.a : cqe.b;
         if ($$0 == -999) {
            if (!this.g().e()) {
               if ($$16 == cqe.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.e()) {
                  if (!$$21.e()) {
                     int $$22 = $$16 == cqe.a ? $$21.I() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.e()) {
                     int $$23 = $$16 == cqe.a ? $$20.I() : ($$20.I() + 1) / 2;
                     Optional<cur> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cur> $$26 = $$19.a($$20.I(), $$21.j() - $$21.I(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.I());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cqf.d && $$3.fP() && this.g().e() && $$0 >= 0) {
         crr $$32 = this.i.get($$0);
         if ($$32.h()) {
            cur $$33 = $$32.g();
            this.b($$33.c($$33.j()));
         }
      } else if ($$2 == cqf.e && this.g().e() && $$0 >= 0) {
         crr $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().I();
         cur $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cqf.g && $$0 >= 0) {
         crr $$37 = this.i.get($$0);
         cur $$38 = this.g();
         if (!$$38.e() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.I() < $$38.j(); $$42 += $$40) {
                  crr $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cur $$44 = $$43.g();
                     if ($$41 != 0 || $$44.I() != $$44.j()) {
                        cur $$45 = $$43.b($$44.I(), $$38.j() - $$38.I(), $$3);
                        $$38.g($$45.I());
                     }
                  }
               }
   ...
   private boolean a(cmz $$0, cqe $$1, crr $$2, cur $$3, cur $$4) {
      cpn $$5 = $$0.dP().J();
   ...
   public void a(int $$0, int $$1, cur $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cur> $$1, cur $$2) {
   ...
   public abstract boolean a(cmz var1);

   protected boolean a(cur $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cmz $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable crr $$0, cur $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cur.c($$1, $$0.g()) ? $$0.g().I() + ($$2 ? 0 : $$1.I()) <= $$1.j() : $$3;
   }

   public static int a(Set<crr> $$0, int $$1, cur $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dpj $$0) {
      return $$0 instanceof bqp ? b((bqp)$$0) : 0;
   }

   public static int b(@Nullable bqp $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cpw $$0) {
      Table<bqp, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bqp $$0, int $$1) {
