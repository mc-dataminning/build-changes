...
public class aip {
   ...
   private static int a(ds $$0, Collection<? extends aqr<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> vg.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> vg.a("commands.banlist.list", $$1.size()), false);

         for (aqr<?> $$2 : $$1) {
            $$0.a(() -> vg.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
