...
public class elg {
   ...
   @Nullable
   private String g;
   private static final elg.a h = new elg.a() {
      @Nullable
      @Override
      public elf a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (elj.a(this.d, "Get capabilities")) {
         ...
         if (elj.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  elj.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !elj.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public elf a(elg.c $$0) {
      return ($$0 == elg.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements elg.a {
      private final int a;
      private final Set<elf> b = Sets.newIdentityHashSet();
      ...
      public elf a() {
         if (this.b.size() >= this.a) {
            if (aa.aT) {
               elg.a.warn("Maximum sound pool size {} reached", this.a);
            }
