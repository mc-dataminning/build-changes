...
public class gsp extends gro<bwe, gyr> {
   public gsp(grp.a $$0) {
      super($$0);
   }

   public void a(gyr $$0, fgr $$1, glk $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bwe $$0, gyr $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bwe $$0) {
      return false;
   }
}
