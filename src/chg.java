...
public abstract class chg {
   ...
   public chg(bxy $$0, djz $$1) {
      this.a = $$0;
      this.b = $$1;
      this.v = this.a(azq.a($$0.i(bzc.m) * 16.0));
   }

   public void e() {
      int $$0 = azq.d(this.r() * 16.0F);
      this.v.a($$0);
   }
   ...
   private float r() {
      return Math.max((float)this.a.h(bzc.m), this.x);
   }
   ...
   protected abstract eyg a(int var1);
   ...
   @Nullable
   public final eye a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(iw.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eye a(Stream<iw> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eye a(Set<iw> $$0, int $$1) {
   ...
   @Nullable
   protected eye a(Set<iw> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, this.r());
   }

   @Nullable
   protected eye a(Set<iw> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$7 = (int)($$4 + (float)$$1);
         dkm $$8 = new dkm(this.b, $$6.b(-$$7, -$$7, -$$7), $$6.b($$7, $$7, $$7));
         eye $$9 = this.v.a($$8, this.a, $$0, $$4, $$3, this.u);
         $$5.c();
         if ($$9 != null && $$9.l() != null) {
            this.s = $$9.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eye $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.k()) {
         if (this.a()) {
            ...
            if ($$0.e > $$1.e && !this.a.aH() && azq.a($$0.d) == azq.a($$1.d) && azq.a($$0.f) == azq.a($$1.f)) {
               this.c.a();
            }
         }
   ...
   protected double a(ffs $$0) {
      iw $$1 = iw.a((jq)$$0);
      return this.b.a_($$1.e()).l() ? $$0.e : eym.a(this.b, $$1);
   }
   ...
   private boolean c(ffs $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ffs $$1 = ffs.c(this.c.g());
         if (!$$0.a((jq)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ffs $$2 = ffs.c(this.c.d(this.c.f() + 1));
            ffs $$3 = $$1.d($$0);
            ffs $$4 = $$2.d($$0);
            double $$5 = $$3.h();
            double $$6 = $$4.h();
   ...
   protected void d() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eyc $$1 = this.c.a($$0);
            eyc $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            ebg $$3 = this.b.a_(new iw($$1.a, $$1.b, $$1.c));
            if ($$3.a(axg.bo)) {
   ...
   public boolean b(eyh $$0) {
      return $$0 != eyh.n && $$0 != eyh.p && $$0 != eyh.d;
   }

   protected static boolean a(bxy $$0, ffs $$1, ffs $$2, boolean $$3) {
      ffs $$4 = new ffs($$2.d, $$2.e + (double)$$0.dr() * 0.5, $$2.f);
      return $$0.dV().a(new djg($$1, $$4, djg.a.a, $$3 ? djg.b.c : djg.b.a, $$0)).d() == ffq.a.a;
   }
   ...
   public boolean b(iw $$0) {
      if (this.m) {
         ...
         eyc $$1 = this.c.d();
         ffs $$2 = new ffs(((double)$$1.a + this.a.dA()) / 2.0, ((double)$$1.b + this.a.dC()) / 2.0, ((double)$$1.c + this.a.dG()) / 2.0);
