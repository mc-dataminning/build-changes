...
public abstract class ehw {
   ...
   public egy a() {
      if (this.c()) {
         ...
         return new egy(this.b(ha.a.a), this.b(ha.a.b), this.b(ha.a.c), this.c(ha.a.a), this.c(ha.a.b), this.c(ha.a.c));
      }
   }

   public ehw b() {
      return this.c() ? eht.a() : eht.a(this.b(ha.a.a), this.b(ha.a.b), this.b(ha.a.c), this.c(ha.a.a), this.c(ha.a.b), this.c(ha.a.c));
   }
   ...
   public ehw a(double $$0, double $$1, double $$2) {
      return (ehw)(this.c() ? eht.a() : new ehf(this.a, new ehs(this.a(ha.a.a), $$0), new ehs(this.a(ha.a.b), $$1), new ehs(this.a(ha.a.c), $$2)));
   }

   public ehw d() {
      ehw[] $$0 = new ehw[]{eht.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = eht.b($$0[0], eht.a($$1, $$2, $$3, $$4, $$5, $$6), ehh.o));
      return $$0[0];
   }

   public void a(eht.a $$0) {
      this.a
         .a(
   ...
   public List<egy> e() {
      List<egy> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new egy($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(ha.a $$0, double $$1) {
      return arp.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public egz a(ehd $$0, ehd $$1, gu $$2) {
      if (this.c()) {
         return null;
      } else {
         ehd $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ha.a.a, $$4.c - (double)$$2.u()), this.a(ha.a.b, $$4.d - (double)$$2.v()), this.a(ha.a.c, $$4.e - (double)$$2.w()))
               ? new egz($$4, ha.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : egy.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<ehd> a(ehd $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         ehd[] $$1 = new ehd[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = arp.a($$0.a(), $$2, $$5);
            double $$9 = arp.a($$0.b(), $$3, $$6);
            double $$10 = arp.a($$0.c(), $$4, $$7);
   ...
   public ehw a(ha $$0) {
      if (!this.c() && this != eht.b()) {
         if (this.b != null) {
            ehw $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ehw b(ha $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ehu(this, $$1, $$4);
      }
   }

   public double a(ha.a $$0, egy $$1, double $$2) {
      return this.a(gs.a($$0, ha.a.a), $$1, $$2);
   }

   protected double a(gs $$0, egy $$1, double $$2) {
      if (this.c()) {
         return $$2;
