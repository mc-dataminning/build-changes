...
public class ehw extends eie<ehv> {
   public ehw(Codec<ehv> $$0) {
      super($$0);
   }

   public boolean a(ehv $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(ehz $$0, ehv $$1, ebw $$2, Function<iu, je<djy>> $$3, azv $$4, efk $$5, dic $$6, ebv $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private float[] a(ehz $$0, ehv $$1, azv $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(ehv $$0, azv $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - azm.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)azm.b($$1, 0.75F, 1.0F);
   }

   private boolean a(ehz $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
