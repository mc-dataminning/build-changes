...
public class cyp extends dch {
   public static final MapCodec<cyp> b = b(cyp::new);
   ...
   protected cyp(dio.d $$0) {
      super($$0);
      this.k(this.E.b().a(a, ia.b));
   }

   @Override
   public dip a(coq $$0) {
      ia $$1 = $$0.k();
      dip $$2 = $$0.q().a_($$0.a().a($$1.g()));
   ...
   public void a(dip $$0, csy $$1, hv $$2, auf $$3) {
      ...
      if ($$3.a(5) == 0) {
         $$1.a(jv.u, $$5 + (double)$$4.j() * $$8, $$6 + (double)$$4.k() * $$8, $$7 + (double)$$4.l() * $$8, $$3.k() * 0.005, $$3.k() * 0.005, $$3.k() * 0.005);
      }
   }
