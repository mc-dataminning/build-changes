...
public class avz extends asx {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), avz::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", avz::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", avz::k);
         $$0 = this.a($$0, "minecraft:fox", avz::j);
         $$0 = this.a($$0, "minecraft:item", avz::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", avz::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", avz::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", avz::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", avz::e);
         return this.a($$0, "minecraft:piglin", avz::d);
      });
   }
