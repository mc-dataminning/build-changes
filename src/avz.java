...
public class avz extends avy {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avz.a> s;
   private final avu t;
   private long u;
   private final alv v;

   private avz(alv $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avv.c($$2, 7, $$0.getLength());
      }
   }
