...
public class avz extends avn<GameProfile> {
   public avz(@Nullable GameProfile $$0) {
      this($$0, null, null, null, null);
   }

   public avz(@Nullable GameProfile $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public xa e() {
      ...
      return $$0 != null ? xa.b($$0.getName()) : xa.c("commands.banlist.entry.unknown");
   }
