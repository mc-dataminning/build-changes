...
public class avz extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bbw.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", avz::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", avz::a);
      return this.a($$0, "minecraft:trident", avz::a);
   }
