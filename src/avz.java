...
public abstract class avz<T> extends awa<Map<alz, T>> {
   ...
   protected avz(js.a $$0, Codec<T> $$1, String $$2) {
      this($$0.a(JsonOps.INSTANCE), $$1, $$2);
   }

   protected avz(Codec<T> $$0, String $$1) {
      this(JsonOps.INSTANCE, $$0, $$1);
   }

   private avz(DynamicOps<JsonElement> $$0, Codec<T> $$1, String $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }

   protected Map<alz, T> a(avv $$0, bpt $$1) {
      Map<alz, T> $$2 = new HashMap<>();
      a($$0, this.d, this.b, this.c, $$2);
      return $$2;
   }

   public static <T> void a(avv $$0, String $$1, DynamicOps<JsonElement> $$2, Codec<T> $$3, Map<alz, T> $$4) {
      als $$5 = als.a($$1);

      for (Entry<alz, avt> $$6 : $$5.a($$0).entrySet()) {
         alz $$7 = $$6.getKey();
         alz $$8 = $$5.b($$7);
