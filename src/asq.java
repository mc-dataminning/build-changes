...
public record asq<T extends Comparable<T>>(T b, T c) {
   public static final Codec<asq<Integer>> a = a(Codec.INT);
   ...
   public static <T extends Comparable<T>> Codec<asq<T>> a(Codec<T> $$0) {
      return asg.a($$0, "min_inclusive", "max_inclusive", asq::a, asq::a, asq::b);
   }

   public static <T extends Comparable<T>> Codec<asq<T>> a(Codec<T> $$0, T $$1, T $$2) {
      return asg.a(
         a($$0),
         (Function<asq<T>, DataResult<asq<T>>>)($$2x -> {
   ...
   public static <T extends Comparable<T>> DataResult<asq<T>> a(T $$0, T $$1) {
      return $$0.compareTo($$1) <= 0
         ? DataResult.success(new asq($$0, $$1))
