...
public class asq {
   ...
   private static void a(asv $$0, ars $$1, edl $$2) {
      $$0.b(new adi($$2, $$1.B_(), null, null));
      djc $$3 = $$2.f();
      ago.a($$1, $$3);
   }

   private List<edl> a(aqw $$0, djc $$1) {
      int $$2 = azo.d(this.i);
      List<edl> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : azo.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
