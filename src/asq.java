...
public class asq {
   ...
   public static final Codec<Object> b = a(atb.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(asy.e($$0));
   ...
   public static final Codec<asq.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? agg.b($$0.substring(1)).map($$0x -> new asq.f($$0x, true)) : agg.b($$0).map($$0x -> new asq.f($$0x, false)), asq.f::c
      );
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !agg.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> asq.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new asq.b<>($$0, $$1);
   }

   public static <K, V> asq.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new asq.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof asq.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(agg a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
