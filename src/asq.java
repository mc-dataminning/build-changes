...
class asq implements Path {
   private static final BasicFileAttributes a = new aso() {
      @Override
   ...
   private static final BasicFileAttributes b = new aso() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<asq> c = Comparator.comparing(asq::n);
   ...
   public asq(ass $$0, String $$1, @Nullable asq $$2, ast $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private asq a(@Nullable asq $$0, String $$1) {
      return new asq(this.e, $$1, $$0, ast.b);
   }
   ...
   asq a(String $$0) {
      if (a(this.i)) {
         return new asq(this.e, $$0, this, this.i);
      } else if (this.i instanceof ast.a $$1) {
         asq $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new asq(this.e, $$0, this, ast.a);
      } else if (this.i instanceof ast.b) {
         return new asq(this.e, $$0, this, ast.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(ast $$0) {
      return $$0 == ast.a || $$0 == ast.b;
   }
   ...
   private asq c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof asq $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof ast.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public ast.a i() {
      return this.i instanceof ast.a $$0 ? $$0 : null;
   }
