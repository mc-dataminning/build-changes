...
public abstract class asq implements AutoCloseable {
   ...
   protected asq(URL $$0, asq.b $$1, asq.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? ayv.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static asq a(aqc $$0) {
      String $$1 = $$0.R;
      if (bac.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<asb> a(GameProfile $$0, String $$1, asq.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(asb.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract asb a(String var1, asq.a var2, JsonObject var3);

   protected xi a(String $$0, JsonArray $$1, asq.a $$2) {
      if ($$1.isEmpty()) {
         return xi.c;
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asq.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      asq.a a = ($$0, $$1) -> false;
      asq.a b = ($$0, $$1) -> $$0.length() == $$1;

      static asq.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static asq.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements asr {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bql<Runnable> $$2 = bql.a(asq.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a;
      }

      @Override
      public CompletableFuture<List<asb>> a(List<String> $$0) {
         List<CompletableFuture<asb>> $$1 = $$0.stream().map($$0x -> asq.this.a(this.b, $$0x, asq.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return ad.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<asb> a(String $$0) {
         return asq.this.a(this.b, $$0, asq.this.f, this.c);
      }
   }
