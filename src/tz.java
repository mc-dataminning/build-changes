...
public class tz {
   ...
   private static final ua.a<tz.a> n = new ua.a<>(tz.a::new);

   private static ArgumentBuilder<ew, ?> a(
      ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, tz.a> $$1, Function<ArgumentBuilder<ew, ?>, ArgumentBuilder<ew, ?>> $$2
   ) {
      return $$0.executes($$1x -> $$1.apply($$1x).d())
         .then(
            ((RequiredArgumentBuilder)ex.a("numberOfTimes", IntegerArgumentType.integer(0))
                  .executes($$1x -> $$1.apply($$1x).a(new tu(IntegerArgumentType.getInteger($$1x, "numberOfTimes"), false))))
               .then(
                  $$2.apply(
                     ex.a("untilFailed", BoolArgumentType.bool())
                        .executes(
                           $$1x -> $$1.apply($$1x)
                                 .a(new tu(IntegerArgumentType.getInteger($$1x, "numberOfTimes"), BoolArgumentType.getBool($$1x, "untilFailed")))
                        )
                  )
               )
         );
   ...
   private static ArgumentBuilder<ew, ?> a(ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, tz.a> $$1) {
      return a($$0, $$1, $$0x -> $$0x);
   }

   private static ArgumentBuilder<ew, ?> b(ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, tz.a> $$1) {
      return a(
         $$0,
         $$1,
         $$1x -> $$1x.then(
               ((RequiredArgumentBuilder)ex.a("rotationSteps", IntegerArgumentType.integer())
                     .executes(
                        $$1xx -> $$1.apply($$1xx)
                              .a(
                                 new tu(IntegerArgumentType.getInteger($$1xx, "numberOfTimes"), BoolArgumentType.getBool($$1xx, "untilFailed")),
   ...
   public static void a(CommandDispatcher<ew> $$0) {
      ...
      ArgumentBuilder<ew, ?> $$2 = b(ex.a("testClassName", ty.a()), $$0x -> n.a($$0x, ty.a($$0x, "testClassName")));
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a(
                                                                                 ...
                                                                                 .then(
                                                                                    ex.a("run")
                                                                                       .then(b(ex.a("testName", uc.a()), $$0x -> n.b($$0x, "testName")))
                                                                                 ))
                                                                              .then(
                                                                                 ex.a("runmultiple")
                                                                                    .then(
                                                                                       ((RequiredArgumentBuilder)ex.a("testName", uc.a())
                                                            ...
                                                            .then(ex.a("verify").then(ex.a("testName", uc.a()).executes($$0x -> n.b($$0x, "testName").f()))))
                                                         .then(
                                                            ex.a("verifyclass")
                                                               .then(ex.a("testClassName", ty.a()).executes($$0x -> n.a($$0x, ty.a($$0x, "testClassName")).f()))
                                                         ))
                                                      .then(
                                                         ex.a("locate")
                                                            .then(
                                                               ex.a("testName", uc.a())
                                                                  .executes($$0x -> n.c($$0x, "minecraft:" + uc.a($$0x, "testName").d()).e())
                                                            )
                                                      ))
                           ...
                           ((LiteralArgumentBuilder)ex.a("clearall").executes($$0x -> n.a($$0x, 200).b()))
                              .then(
                                 ex.a("radius", IntegerArgumentType.integer())
                                    .executes($$0x -> n.a($$0x, azu.a(IntegerArgumentType.getInteger($$0x, "radius"), 0, 1024)).b())
                              )
                        ))
                     .then(
                        ex.a("import")
   ...
   private static int a(th $$0) {
      $$0.g().a_(null, $$0.e()).stream().forEach($$0x -> $$0x.a(bvb.d.b));
      $$0.f().c($$0.g());
      tx.a($$0.e(), $$0.g());
   ...
   static Stream<th> a(ew $$0, tu $$1, tv $$2) {
      return $$2.findStructureBlockPos().map($$2x -> a($$2x, $$0.e(), $$1)).flatMap(Optional::stream);
   }

   static Stream<th> a(ew $$0, tu $$1, ud $$2, int $$3) {
      return $$2.findTestFunctions().filter($$1x -> a($$0.e(), $$1x.d())).map($$3x -> new th($$3x, tx.a($$3), $$0.e(), $$1));
   }

   private static Optional<th> a(jh $$0, arx $$1, tu $$2) {
      dwi $$3 = (dwi)$$1.c_($$0);
      if ($$3 == null) {
   ...
   private static int a(ew $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         arx $$5 = $$0.e();
         jh $$6 = a($$0).e();
         tx.a($$1.toLowerCase(), $$6, new kl($$2, $$3, $$4), dqv.a, $$5);
         jh $$7 = $$6.d();
         jh $$8 = $$7.b($$2 - 1, 0, $$4 - 1);
         jh.d($$7, $$8).forEach($$1x -> $$5.b($$1x, dkf.I.m()));
         tx.a($$6, new jh(1, 0, -1), dqv.a, $$5);
         return 0;
      } else {
   ...
   private static int a(ew $$0, String $$1) throws CommandSyntaxException {
      fbn $$2 = (fbn)$$0.h().a(10.0, 1.0F, false);
      jh $$3 = $$2.b();
      arx $$4 = $$0.e();
      Optional<jh> $$5 = tx.a($$3, 15, $$4);
      if ($$5.isEmpty()) {
         $$5 = tx.a($$3, 200, $$4);
      }

      if ($$5.isEmpty()) {
         $$0.b(xk.b("Can't find a structure block that contains the targeted pos " + $$3));
         return 0;
      } else {
         dwi $$6 = (dwi)$$4.c_($$5.get());
         if ($$6 == null) {
            ...
            xk $$10 = xk.b($$8)
               .b(
                  yh.a
                     .a(true)
                     .a(n.k)
                     .a(new xq(xq.a.a, xk.b("Click to copy to clipboard")))
                     .a(new xi(xi.a.f, "final BlockPos " + $$1 + " = new BlockPos(" + $$8 + ");"))
               );
            $$0.a(() -> xk.b("Position relative to " + $$9 + ": ").b($$10), false);
            agy.a($$4, new jh($$3), $$8, -2147418368, 10000);
            return 1;
         }
      }
   }
   ...
   private static int b(ew $$0, String $$1) {
      Path $$2 = Paths.get(tx.c);
      alp $$3 = alp.a($$1);
      Path $$4 = $$0.e().r().a($$3, ".nbt");
      Path $$5 = pp.a(mf.a, $$4, $$3.a(), $$2);
      if ($$5 == null) {
   ...
   private static boolean a(arx $$0, String $$1) {
      if ($$0.r().b(alp.a($$1)).isEmpty()) {
   ...
   static void a(arx $$0, String $$1, n $$2) {
      $$0.a($$0x -> true).forEach($$2x -> $$2x.a(xk.b($$1).a($$2)));
   }

   public static class a {
      private final ua<tz.a> a;
      ...
      public int a() {
         tz.a();
         return tz.a(this.a.a(), tu.a(), this.a).map(tz::a).toList().isEmpty() ? 0 : 1;
      }
      ...
      public int b() {
         ...
         }, () -> tz.a($$1, "Could not find any structures to clear", n.m), $$1x -> tz.c($$0, "Cleared " + $$1x + " structures"));
         return 1;
      }
      ...
      public int c() {
         ...
         this.a(this.a.findStructureBlockPos(), $$3 -> {
            dwi $$4 = (dwi)$$2.c_($$3);
            if ($$4 == null) {
               tz.a($$2, "Structure block entity could not be found", n.m);
               $$0.setFalse();
               return 0;
            } else {
               if (tz.a($$1, $$4) != 0) {
         ...
         }, () -> tz.a($$2, "Could not find any structures to export", n.m), $$1x -> tz.c($$1, "Exported " + $$1x + " structures"));
      ...
      int f() {
         ...
         arx $$1 = $$0.e();
         jh $$2 = tz.a($$0);
         Collection<th> $$3 = Stream.concat(tz.a($$0, tu.a(), this.a), tz.a($$0, tu.a(), this.a, 0)).toList();
         tk.a($$1);
         tj.d();
         Collection<tb> $$4 = new ArrayList<>();

         for (th $$5 : $$3) {
            for (dqv $$6 : dqv.values()) {
               Collection<th> $$7 = new ArrayList<>();

               for (int $$8 = 0; $$8 < 100; $$8++) {
                  th $$9 = new th($$5.v(), $$6, $$1, new tu(1, true));
                  $$7.add($$9);
               }

               tb $$10 = tc.a($$7, $$5.v().b(), (long)$$6.ordinal());
               $$4.add($$10);
            }
         }

         tw $$11 = new tw($$2, 10, true);
         tk $$12 = tk.a.a($$4, $$1).a(tc.a(100)).a((tk.c)$$11).a($$11).a(true).a();
         return tz.a($$0, $$1, $$12);
      }

      public int a(tu $$0, int $$1, int $$2) {
         tz.a();
         ew $$3 = this.a.a();
         arx $$4 = $$3.e();
         jh $$5 = tz.a($$3);
         Collection<th> $$6 = Stream.concat(tz.a($$3, $$0, this.a), tz.a($$3, $$0, this.a, $$1)).toList();
         if ($$6.isEmpty()) {
            tz.c($$3, "No tests found");
            return 0;
         } else {
            tk.a($$4);
            tj.d();
            tz.c($$3, "Running " + $$6.size() + " tests...");
            tk $$7 = tk.a.b($$6, $$4).a((tk.c)(new tw($$5, $$2, false))).a();
            return tz.a($$3, $$4, $$7);
         }
      }

      public int a(int $$0, int $$1) {
         return this.a(tu.a(), $$0, $$1);
      }

      public int a(int $$0) {
         return this.a(tu.a(), $$0, 8);
      }

      public int a(tu $$0, int $$1) {
         return this.a($$0, $$1, 8);
      }
      ...
      public int e() {
         tz.c(this.a.a(), "Started locating test structures, this might take a while..");
            ...
            .forEach(
               $$2x -> {
                  ...
                  if ($$3 != null) {
                     ...
                     int $$8 = $$1.u() - $$2x.u();
                     int $$9 = $$1.w() - $$2x.w();
                     int $$10 = azu.d(azu.c((float)($$8 * $$8 + $$9 * $$9)));
                     xk $$11 = xn.a((xk)xk.a("chat.coordinates", $$2x.u(), $$2x.v(), $$2x.w()))
                        .a($$1xx -> $$1xx.a(n.k).a(new xi(xi.a.d, $$7)).a(new xq(xq.a.a, xk.c("chat.coordinates.tooltip"))));
                     xk $$12 = xk.b("Found structure at: ").b($$11).f(" (distance: " + $$10 + ")");
                     this.a.a().a(() -> $$12, false);
                     $$0.increment();
                  }
               }
         ...
         int $$2 = $$0.intValue();
         if ($$2 == 0) {
            tz.a(this.a.a().e(), "No such test structure found", n.m);
            return 0;
         } else {
            tz.a(this.a.a().e(), "Finished locating, found " + $$2 + " structure(s)", n.k);
            return 1;
         }
      }
   }

   static record b(ew a) implements td {
      @Override
      public void a(tb $$0) {
         tz.c(this.a, "Starting batch: " + $$0.a());
      }
   ...
   public static record c(arx a, ts b) implements ti {
      @Override
      public void a(th $$0) {
      }
      ...
      private static void a(arx $$0, ts $$1) {
         if ($$1.i()) {
            tz.a($$0, "GameTest done! " + $$1.h() + " tests were run", n.p);
            if ($$1.d()) {
               tz.a($$0, $$1.a() + " required tests failed :(", n.m);
            } else {
               tz.a($$0, "All required tests passed :)", n.k);
            }

            if ($$1.e()) {
               tz.a($$0, $$1.b() + " optional tests failed", n.h);
            }
         }
      }
   }
