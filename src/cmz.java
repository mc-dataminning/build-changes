...
public abstract class cmz extends btr {
   ...
   public static final btl bF = btl.b;
   ...
   public static final evt bT = new evt(0.0, 0.6, 0.0);
   public static final bsz bU = bsz.b(0.6F, 1.8F).b(1.62F).a(bsy.a().a(bsx.b, bT));
   private static final Map<bud, bsz> c = ImmutableMap.builder()
      .put(bud.a, bU)
      .put(bud.c, aG)
      .put(bud.b, bsz.b(0.6F, 0.6F).b(0.4F))
      .put(bud.d, bsz.b(0.6F, 0.6F).b(0.4F))
      .put(bud.e, bsz.b(0.6F, 0.6F).b(0.4F))
      .put(bud.f, bsz.b(0.6F, 1.5F).b(1.27F).a(bsy.a().a(bsx.b, bT)))
      .put(bud.h, bsz.c(0.2F, 0.2F).b(1.62F))
      .build();
   private static final akk<Float> d = ako.a(cmz.class, akm.d);
   private static final akk<Integer> e = ako.a(cmz.class, akm.b);
   protected static final akk<Byte> bV = ako.a(cmz.class, akm.a);
   protected static final akk<Byte> bW = ako.a(cmz.class, akm.a);
   protected static final akk<us> bX = ako.a(cmz.class, akm.t);
   protected static final akk<us> bY = ako.a(cmz.class, akm.t);
   private long f;
   final cmy g = new cmy(this);
   protected cri bZ = new cri();
   public final cqx ca;
   public cpw cb;
   protected cps cc = new cps();
   protected int cd;
   public float ce;
   public float cf;
   public int cg;
   ...
   public cmz(dca $$0, iz $$1, float $$2, GameProfile $$3) {
      super(btc.by, $$0);
      this.a_($$3.getId());
      this.cC = $$3;
      this.ca = new cqx(this.g, !$$0.B, this);
      this.cb = this.ca;
      this.b((double)$$1.u() + 0.5, (double)($$1.v() + 1), (double)$$1.w() + 0.5, $$2, 0.0F);
      this.bk = 180.0F;
   }

   public boolean a(dca $$0, iz $$1, dbx $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == dbx.d) {
         return true;
         ...
         cur $$3 = this.eX();
         return $$3.e() || !$$3.b(new dsi($$0, $$1, false));
      }
   }

   public static buy.a fQ() {
      return btr.dU().a(buz.c, 1.0).a(buz.r, 0.1F).a(buz.e).a(buz.o).a(buz.g, 4.5).a(buz.h, 3.0).a(buz.f);
   }
   ...
   private void u() {
      cur $$0 = this.a(btd.f);
      if ($$0.a(cuu.oo) && !this.a(awv.a)) {
         this.b(new bse(bsg.m, 200, 0, false, false, true));
      }
   }
   ...
   protected boolean h(bud $$0) {
      return this.dP().a(this, this.a($$0).a(this.dn()).h(1.0E-7));
   }

   @Override
   public int az() {
      return Math.max(1, this.dP().ab().c(this.cA.a ? dbw.F : dbw.E));
   }
   ...
   public void n_() {
      ...
      if (this.dP().al() == bqt.a && this.dP().ab().b(dbw.k)) {
      ...
      if (this.eA() > 0.0F && !this.N_()) {
         ...
         List<bsw> $$4 = this.dP().a_(this, $$2);
         List<bsw> $$5 = Lists.newArrayList();
   ...
   private void c(@Nullable us $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dP().z.a(200) == 0) {
         String $$1 = $$0.l("id");
         btc.a($$1).filter($$0x -> $$0x == btc.ax).ifPresent($$0x -> {
            if (!cfx.a(this.dP(), this)) {
               this.dP().a(null, this.du(), this.dw(), this.dA(), cfx.a(this.dP(), this.dP().z), this.de(), 1.0F, cfx.a(this.dP().z));
            }
         });
      }
   }
   ...
   @Nullable
   public cjj a(cur $$0, boolean $$1) {
      return this.a($$0, false, $$1);
   }

   @Nullable
   public cjj a(cur $$0, boolean $$1, boolean $$2) {
      if ($$0.e()) {
         return null;
      } else {
         if (this.dP().B) {
         ...
         cjj $$4 = new cjj(this.dP(), this.du(), $$3, this.dA(), $$0);
         $$4.b(40);
         if ($$2) {
            $$4.b(this);
         }
   ...
   public float d(dse $$0) {
      ...
      if (bsf.a(this)) {
         $$1 *= 1.0F + (float)(bsf.b(this) + 1) * 0.2F;
      }

      if (this.b(bsg.d)) {
         $$1 *= switch (this.c(bsg.d).e()) {
            case 0 -> 0.3F;
            case 1 -> 0.09F;
            case 2 -> 0.0027F;
            default -> 8.1E-4F;
      ...
      $$1 *= (float)this.g(buz.f);
      if (this.a(awv.a) && !dad.i(this)) {
         $$1 /= 5.0F;
      }
   ...
   public void a(us $$0) {
      ...
      this.cc.a($$0);
      this.cA.b($$0);
      this.f(buz.r).a((double)this.cA.b());
      if ($$0.b("EnderItems", 9)) {
      ...
      if ($$0.b("current_explosion_impact_pos", 9)) {
         evt.a.parse(vg.a, $$0.c("current_explosion_impact_pos")).resultOrPartial(b::error).ifPresent($$0x -> this.cv = $$0x);
      }
   ...
   public void b(us $$0) {
      ...
      if (this.cv != null) {
         $$0.a("current_explosion_impact_pos", (vp)evt.a.encodeStart(vg.a, this.cv).getOrThrow());
      }
   ...
   public boolean b(brp $$0) {
      if (super.b($$0)) {
         ...
         return !this.dP().ab().b(dbw.G);
      } else if ($$0.a(awr.n)) {
         return !this.dP().ab().b(dbw.H);
      } else if ($$0.a(awr.j)) {
         return !this.dP().ab().b(dbw.I);
      } else {
         return $$0.a(awr.p) ? !this.dP().ab().b(dbw.J) : false;
      }
   }
   ...
   protected void b(brp $$0, float $$1) {
      this.a($$0, $$1, new btd[]{btd.c, btd.d, btd.e, btd.f});
   }

   @Override
   protected void c(brp $$0, float $$1) {
      this.a($$0, $$1, new btd[]{btd.f});
   }
   ...
   public void a(chl $$0, bqp $$1) {
   }

   public OptionalInt a(@Nullable bra $$0) {
   ...
   public bqw a(bsw $$0, bqv $$1) {
      if (this.N_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.e() && $$0 instanceof btr) {
               if (this.cA.d) {
                  $$2 = $$3;
               }

               bqw $$5 = $$2.a(this, (btr)$$0, $$1);
               if ($$5.a()) {
                  this.dP().a(dwx.r, $$0.dn(), dwx.a.a(this));
                  if ($$2.e() && !this.cA.d) {
                     this.a($$1, cur.l);
                  }
   ...
   protected evt a(evt $$0, btw $$1) {
      float $$2 = this.dJ();
      if (!this.cA.b && !($$0.d > 0.0) && ($$1 == btw.a || $$1 == btw.b) && this.fT() && this.E($$2)) {
         double $$3 = $$0.c;
         double $$4 = $$0.e;
         double $$5 = 0.05;
   ...
   private boolean b(double $$0, double $$1, float $$2) {
      evo $$3 = this.cK();
      return this.dP().a(this, new evo($$3.a + $$0, $$3.b - (double)$$2 - 1.0E-5F, $$3.c + $$1, $$3.d + $$0, $$3.b, $$3.f + $$1));
   }
   ...
   public void e(bsw $$0) {
      if ($$0.ct()) {
         if (!$$0.u(this)) {
            ...
            float $$2 = dad.a(this.eX(), $$0.ak());
            float $$3 = this.D(0.5F);
            $$1 *= 0.2F + $$3 * $$3 * 0.8F;
            $$2 *= $$3;
            this.gw();
            if ($$0.ak().a(awt.H) && $$0 instanceof cnr $$4) {
               $$4.a(cns.c, this, this, true);
            } else {
               if ($$1 > 0.0F || $$2 > 0.0F) {
                  boolean $$5 = $$3 > 0.9F;
                  boolean $$6 = false;
                  ...
                  if ($$16) {
                     ...
                     if ($$9) {
                        float $$17 = 1.0F + dad.a(this) * $$1;

                        for (btr $$19 : this.dP().a(btr.class, $$0.cK().c(1.0, 0.25, 1.0))) {
                           if ($$19 != this && $$19 != $$0 && !this.s($$19) && (!($$19 instanceof ciz) || !((ciz)$$19).z()) && this.g((bsw)$$19) < 9.0) {
                     ...
                     if (!this.dP().B && !$$20.e() && $$21 instanceof btr) {
                        $$20.a((btr)$$21, this);
                        if ($$20.e()) {
                           this.a(bqv.a, cur.l);
                        }
   ...
   public Either<cmz.a, bac> a(iz $$0) {
      this.b($$0);
      this.cz = 0;
   ...
   public static Optional<evt> a(arf $$0, iz $$1, float $$2, boolean $$3, boolean $$4) {
      dse $$5 = $$0.a_($$1);
      dfb $$6 = $$5.b();
      if ($$6 instanceof dlj && ($$3 || $$5.c(dlj.d) > 0) && dlj.a($$0)) {
         Optional<evt> $$7 = dlj.a(btc.by, $$0, $$1);
         if (!$$3 && !$$4 && $$7.isPresent()) {
            $$0.a($$1, $$5.a(dlj.d, Integer.valueOf($$5.c(dlj.d) - 1)), 3);
         }

         return $$7;
      } else if ($$6 instanceof deu && deu.a($$0)) {
         return deu.a(btc.by, $$0, $$1, $$5.c(deu.aE), $$2);
      } else if (!$$3) {
         ...
         dse $$9 = $$0.a_($$1.c());
         boolean $$10 = $$9.b().a($$9);
         return $$8 && $$10 ? Optional.of(new evt((double)$$1.u() + 0.5, (double)$$1.v() + 0.1, (double)$$1.w() + 0.5)) : Optional.empty();
      }
   }
   ...
   public void a(cyz<?> $$0, List<cur> $$1) {
   }
   ...
   public boolean gh() {
      if (!this.aE() && !this.fE() && !this.be() && !this.b(bsg.y)) {
         cur $$0 = this.a(btd.e);
         if ($$0.a(cuu.nT) && ctn.j($$0)) {
            this.gi();
            return true;
         }
      }
   ...
   public boolean a(iz $$0, je $$1, cur $$2) {
      if (this.cA.e) {
         return true;
      } else {
         iz $$3 = $$0.a($$1.g());
         dsi $$4 = new dsi(this.dP(), $$3, false);
         return $$2.a($$4);
      }
   }
   ...
   @Override
   protected bsw.b bb() {
      return this.cA.b || this.aE() && this.bY() ? bsw.b.a : bsw.b.d;
   }
   ...
   public cur a(btd $$0) {
      if ($$0 == btd.a) {
         ...
         return $$0.a() == btd.a.b ? this.g.i.get($$0.b()) : cur.l;
      }
   }
   ...
   public boolean i(cur $$0) {
      return this.g.f($$0);
   }

   @Override
   public Iterable<cur> fa() {
      return Lists.newArrayList(new cur[]{this.eX(), this.eY()});
   }
   ...
   private void k(us $$0) {
      if (!this.dP().B && !$$0.g()) {
         btc.a($$0, this.dP()).ifPresent($$0x -> {
            if ($$0x instanceof buo) {
               ((buo)$$0x).b(this.az);
            }
   ...
   public buj a_(int $$0) {
      if ($$0 == 499) {
         ...
         if ($$1 >= 0 && $$1 < 4) {
            ...
            return buj.a(this.g, $$0);
         } else {
            int $$2 = $$0 - 200;
            return $$2 >= 0 && $$2 < this.bZ.b() ? buj.a(this.bZ, $$2) : super.a_($$0);
         }
      }
   }
   ...
   @Override
   public btl fu() {
      return this.ao.a(bW) == 0 ? btl.a : btl.b;
   }

   public void a(btl $$0) {
      this.ao.a(bW, (byte)($$0 == btl.a ? 0 : 1));
   }
   ...
   public float gv() {
      return (float)(1.0 / this.g(buz.e) * 20.0);
   }
   ...
   public ImmutableList<bud> fI() {
      return ImmutableList.of(bud.a, bud.f, bud.d);
   }
   ...
   public evt q(float $$0) {
      double $$1 = 0.22 * (this.fu() == btl.b ? -1.0 : 1.0);
      ...
      if (this.fE() || this.fr()) {
         ...
         return this.l($$0).e(new evt($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.cd()) {
         return this.l($$0).e(new evt($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cK().c() - 1.0;
         double $$13 = this.ca() ? -0.2 : 0.07;
         return this.l($$0).e(new evt($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean gA() {
      return this.fv() && this.fx().a(cuu.qX);
   }
   ...
   public boolean b(bsw $$0, double $$1) {
      return $$0.dK() ? false : this.a($$0.cK(), $$1);
   }

   public boolean a(evo $$0, double $$1) {
      double $$2 = this.gD() + $$1;
   ...
   public boolean a(iz $$0, double $$1) {
      double $$2 = this.gC() + $$1;
      return new evo($$0).e(this.bx()) < $$2 * $$2;
   }
