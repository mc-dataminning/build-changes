...
public class fkv {
   public static void a(gae $$0, fkt $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fks>> $$6 : $$1.c().entrySet()) {
         Optional<gcl> $$7 = $$0.a($$6.getKey());
         List<fks> $$8 = $$6.getValue();
   ...
   private static float a(fkt $$0, long $$1) {
