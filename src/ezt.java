...
public enum ezt implements env {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static eou a(int $$0, int $$1, ezt.a $$2) {
      eou $$3 = new eou(eou.a.a, $$0, $$1, false);
