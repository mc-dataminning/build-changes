...
public class ezt extends ezx implements ezv {
   ...
   public ezt.c a() {
      return new ezt.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, fad.a $$1) {
   ...
   private ezt.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezt.a $$9 = new ezt.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezt.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fad.b.a || this.q == fad.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fae> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fae $$1 = (fae)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fae.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fae.b.c) {
         ezv.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezv.a($$11));
         this.a($$14 + 5, ezv.a($$12));
         this.a($$14 + 6, ezv.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fad a, int b, int c, fad.b d, fad.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezt.a c;
      private boolean d;

      b(final int $$1, final ezt.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(fad.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fag $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
