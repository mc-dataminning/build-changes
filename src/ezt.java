...
public class ezt {
   ...
   static class b {
      static final Optional<ezt> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ezt a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezt();
      }
   }
}
