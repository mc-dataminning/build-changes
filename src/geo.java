public class geo extends gby<hav> {
   ...
   public static gfg a(gfe $$0) {
      gfi $$1 = new gfi();
      gfk $$2 = $$1.a();
      $$2.a("shoulders", gff.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gfc.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         gff.c()
         ...
         gfc.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         gff.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gfc.a(-2.0F, 6.9F + ayy.b(0.20420352F) * 10.0F, -0.5F + ayy.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", gff.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gfc.a);
      gff $$4 = gff.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gfc.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gfc.a(10.0F, 4.0F, 0.0F));
