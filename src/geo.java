...
public class geo {
   public static class a implements gfh<lu> {
      ...
      public gfe a(lu $$0, gbx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         geo.b $$8 = new geo.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gge {
      b(gbx $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azj.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }
   ...
   static class c extends gfq {
      ...
      c(gbx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gfg $$7, gfz $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            geo.c $$0 = new geo.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gfh<lu> {
      ...
      public gfe a(lu $$0, gbx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         geo.c $$8 = new geo.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fja.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gfc {
      ...
      private int D;
      private final gfg E;
      private final List<cyk> F;
      private boolean G;

      public e(gbx $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gfg $$7, List<cyk> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gfe $$12 = this.E.a(lq.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         geo.c $$10 = (geo.c)this.E.a(lq.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azj.d($$18, $$13, $$16) * $$0;
                  double $$20 = azj.d($$18, $$14, $$17) * $$0;
