public class geo implements gek<dok> {
   private final gir a;
   ...
   public void a(dok $$0, float $$1, eys $$2, gck $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.n().c(drr.bv);
         if ($$6 > 0) {
            it $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.e()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = gci.a($$0.i(), $$0.n(), $$0.az_().a($$7));
                  this.a.a($$8, ctl.i, $$11, gnm.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
