...
public class cbe {
   ...
   private static <T> cal<bxr> a(cgl<T> $$0, float $$1, int $$2, boolean $$3, Function<T, ffc> $$4) {
      return ccn.a(
         (Function<ccn.b<bxr>, ? extends App<ccn.c<bxr>, ccq<bxr>>>)($$5 -> $$5.group($$5.a(cgl.n), $$5.b($$0)).apply($$5, ($$5x, $$6) -> ($$7, $$8, $$9) -> {
                  ...
                  if ($$10.isPresent() && !$$3) {
                     ...
                     ffc $$11 = $$8.ds();
                     ffc $$12 = $$4.apply($$5.b($$6));
                     if (!$$11.a((jp)$$12, (double)$$2)) {
                        return false;
                     } else {
                        if ($$10.isPresent() && $$10.get().b() == $$1) {
                           ffc $$13 = $$10.get().a().a().d($$11);
                           ffc $$14 = $$12.d($$11);
                           if ($$13.b($$14) < 0.0) {
                              return false;
                           }
