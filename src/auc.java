...
public class auc extends att {
   ...
   private static final asw d = new asw(cpl.h);
   ...
   public static atz a(Path $$0, evf $$1) {
      return new atz(new auc($$1), new atu($$0, atc.b, aua.e, $$1));
   }

   public static atz c() {
      return new atz(new auc(new evf($$0 -> true)));
   }

   public static atz a(epu.c $$0) {
      return a($$0.a(eps.j), $$0.d().e());
   }
}
