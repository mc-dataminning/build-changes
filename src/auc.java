...
class auc extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aub && $$1 instanceof aub && $$0.equals($$1);
   }
   ...
   private static aub a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aub) {
         return (aub)$$0;
      } else {
