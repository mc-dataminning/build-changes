...
public class auc extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("cauldron_rename_fix", this.getInputSchema().getType(ays.u), $$0 -> $$0.update(DSL.remainderFinder(), auc::a));
   }
}
