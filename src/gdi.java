...
public class gdi {
   ...
   public final Map<it, gdj> c;
   public final gdk d;
   public final boolean e;

   public gdi(Vector3f $$0, Vector3f $$1, Map<it, gdj> $$2, @Nullable gdk $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<it, gdj> $$0 : this.c.entrySet()) {
         float[] $$1 = this.a($$0.getKey());
         $$0.getValue().e.a($$1);
      }
   }

   private float[] a(it $$0) {
      switch ($$0) {
         case a:
   ...
   protected static class a implements JsonDeserializer<gdi> {
      private static final boolean a = true;

      public gdi a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gdk $$6 = this.a($$3);
         Map<it, gdj> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !axv.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = axv.a($$3, "shade", true);
            return new gdi($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gdk a(JsonObject $$0) {
         gdk $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = axv.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            it.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = axv.a($$2, "rescale", false);
            $$1 = new gdk($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = axv.m($$0, "angle");
         if ($$1 != 0.0F && ayf.e($$1) != 22.5F && ayf.e($$1) != 45.0F) {
      ...
      private it.a c(JsonObject $$0) {
         String $$1 = axv.i($$0, "axis");
         it.a $$2 = it.a.a($$1.toLowerCase(Locale.ROOT));
         if ($$2 == null) {
      ...
      private Map<it, gdj> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<it, gdj> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<it, gdj> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<it, gdj> $$2 = Maps.newEnumMap(it.class);
         JsonObject $$3 = axv.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            it $$5 = this.a($$4.getKey());
            $$2.put($$5, (gdj)$$0.deserialize($$4.getValue(), gdj.class));
         }

         return $$2;
      }

      private it a(String $$0) {
         it $$1 = it.a($$0);
         if ($$1 == null) {
