...
public class ac {
   ...
   @Deprecated
   public static final int b = 4318;
   @Deprecated
   public static final String c = "main";
   @Deprecated
   public static final String d = "25w09b";
   @Deprecated
   ...
   static {
      ...
      CommandSyntaxException.BUILT_IN_EXCEPTIONS = new ed();
   }
}
