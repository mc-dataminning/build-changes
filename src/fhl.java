...
public class fhl {
   ...
   private final ffn g;
   final Map<UUID, fia> h = Maps.newLinkedHashMap();
   ...
   private void a(fgz $$0, int $$1, int $$2, bpt $$3) {
      this.a($$0, $$1, $$2, $$3, 182, c, e);
      int $$4 = aye.b($$3.j(), 0, 182);
      if ($$4 > 0) {
         this.a($$0, $$1, $$2, $$3, $$4, d, f);
      }
   }

   private void a(fgz $$0, int $$1, int $$2, bpt $$3, int $$4, akk[] $$5, akk[] $$6) {
   ...
   public void a(abx $$0) {
      $$0.a(new abx.b() {
         @Override
         public void a(UUID $$0, wu $$1, float $$2, bpt.a $$3, bpt.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fhl.this.h.put($$0, new fia($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
         ...
         @Override
         public void a(UUID $$0, bpt.a $$1, bpt.b $$2) {
            fia $$3 = fhl.this.h.get($$0);
            $$3.a($$1);
            $$3.a($$2);
         }
