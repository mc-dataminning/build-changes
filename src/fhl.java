...
public abstract class fhl<T extends fhl<T>> {
   ...
   public fhl(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fhj.a();
         if ($$3 != null) {
         ...
         throw new fjd(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fjd(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fjd(var2.getMessage(), var2);
      }
   }
   ...
   public static fhl<?> a(String $$0) {
      return new fhl.b($$0, 5000, 60000);
   }

   public static fhl<?> a(String $$0, int $$1, int $$2) {
      return new fhl.b($$0, $$1, $$2);
   }

   public static fhl<?> b(String $$0, String $$1) {
      return new fhl.c($$0, $$1, 5000, 60000);
   }

   public static fhl<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fhl.c($$0, $$1, $$2, $$3);
   }

   public static fhl<?> b(String $$0) {
      return new fhl.a($$0, 5000, 60000);
   }

   public static fhl<?> c(String $$0, String $$1) {
      return new fhl.d($$0, $$1, 5000, 60000);
   }

   public static fhl<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fhl.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fhl<fhl.a> {
   ...
   public static class b extends fhl<fhl.b> {
   ...
   public static class c extends fhl<fhl.c> {
      ...
      public fhl.c f() {
         try {
            ...
            throw new fjd(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fhl<fhl.d> {
      private final String c;
