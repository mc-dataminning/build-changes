...
public class fhl {
   ...
   public static final fhl.a bv;

   public static fhl.a a(int $$0, int $$1) {
      return $$0 == -1 ? fhl.b.b.a($$1) : fhl.b.a.a($$0);
   }

   public static fhl.a a(String $$0) {
      if (fhl.a.e.containsKey($$0)) {
         return fhl.a.e.get($$0);
      } else {
         for (fhl.b $$1 : fhl.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fhl.b b;
      private final int c;
      private final aze<ww> d;
      static final Map<String, fhl.a> e = Maps.newHashMap();

      a(String $$0, fhl.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? ww.b($$2.toUpperCase(Locale.ROOT)) : ww.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? ww.b($$2) : ww.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ts.a().b($$1) ? ww.c($$1) : ww.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fhl.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, ww> g;

      private static void a(fhl.b $$0, String $$1, int $$2) {
         fhl.a $$3 = new fhl.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, ww> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fhl.a a(int $$0) {
         return (fhl.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
