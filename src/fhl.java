...
public class fhl extends hep {
   ...
   private static final xi F = xi.c("mco.upload.verifying");
   private final fhe G;
   private final etr H;
   @Nullable
   private final fii I;
   ...
   @Nullable
   private volatile xi[] N;
   private volatile xi O = xi.c("mco.upload.preparing");
   @Nullable
   ...
   private Long Y;
   private long Z;
   private final fow aa = new fow(this);

   public fhl(@Nullable fii $$0, long $$1, int $$2, fhe $$3, etr $$4) {
      super(fiz.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aR_() {
      this.U = this.aa.b(flh.a(xh.k, $$0x -> this.D()).a());
      this.U.k = false;
      this.V = this.aa.b(flh.a(xh.e, $$0x -> this.E()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.G();
         } else {
            List<fig> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fio(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fgw(this.G, $$0.toArray(new fig[0])));
         }
      }
   ...
   private void D() {
      this.m.a(new fgq(new fem(new frc()), this.J));
   }
   ...
   private void c(fku $$0) {
      ...
      $$0.a(this.p, xi.a("mco.upload.percent", this.P), this.n / 2, 84, -1);
   }
   ...
   private xi F() {
      ...
      $$0.add(this.O);
      if (this.P != null) {
         $$0.add(xi.a("mco.upload.percent", this.P));
      }
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.O = xi.c("mco.upload.close.failure");
                  } else {
                     ffu $$2 = null;
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              this.O = xi.a("mco.upload.uploading", this.H.b());
                              fep $$10 = new fep($$0, this.J, this.K, $$2, this.m.X(), ab.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                                 if ($$0x.a >= 200 && $$0x.a < 300) {
                                    this.R = true;
                                    this.O = xi.c("mco.upload.done");
                                    if (this.U != null) {
                                       this.U.b(xh.d);
                                    }
                                    ...
                                    this.a(xi.a("mco.upload.failed", $$0x.b));
                                 } else {
                                    this.a(xi.a("mco.upload.failed", $$0x.a));
                                 }
                              });
                              ...
                              long $$6 = $$0.length();
                              fen $$7 = fen.a($$6);
                              fen $$8 = fen.a(5368709120L);
                              if (fen.b($$6, $$7).equals(fen.b(5368709120L, $$8)) && $$7 != fen.a) {
                                 fen $$9 = fen.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xi.a("mco.upload.size.failure.line1", this.H.b()),
                                    xi.a("mco.upload.size.failure.line2", fen.b($$6, $$9), fen.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xi.a("mco.upload.size.failure.line1", this.H.b()),
                                    xi.a("mco.upload.size.failure.line2", fen.b($$6, $$7), fen.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(xi.a("mco.upload.failed", var19.getMessage()));
               } catch (fgc var20) {
                  this.a(xi.a("mco.upload.failed", var20.a.b()));
   ...
   private void J() {
      this.O = xi.c("mco.upload.cancelled");
