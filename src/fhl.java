...
public class fhl extends fdb {
   ...
   protected void aN_() {
      if (this.O) {
         ...
         this.E = new fhk(this, this.f, this.g, this.D() - 88, 88, 36);
      }
      ...
      int $$4 = 64 + this.n();
      int $$5 = (this.g - $$3) / 2 + 3;
      this.I = this.d(exg.a(l, $$0x -> this.a(fhl.a.a)).a($$1, 45, $$0, 20).a());
      this.J = this.d(exg.a(m, $$0x -> this.a(fhl.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.K = this.d(exg.a(n, $$0x -> this.a(fhl.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$6 = this.F != null ? this.F.a() : "";
      this.F = new exp(this.i, this.E() + 28, 74, 200, 15, r) {
         @Override
         protected vt aK_() {
            return !fhl.this.F.a().isEmpty() && fhl.this.E.d() ? super.aK_().f(", ").b(fhl.t) : super.aK_();
         }
      };
      this.F.f(16);
      this.F.g(true);
      ...
      this.e(this.F);
      this.e(this.E);
      this.L = this.d(exg.a(w, fbt.b(this, "https://aka.ms/javablocking")).a($$5, $$4, $$3, 20).a());
      this.O = true;
      this.a(this.H);
   }

   private void a(fhl.a $$0) {
      this.H = $$0;
      this.I.b(l);
      this.J.b(m);
      this.K.b(n);
