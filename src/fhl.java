...
public class fhl {
   ...
   private static final Map<dxt.a, String> e = ac.a(new EnumMap<>(dxt.a.class), $$0 -> {
      $$0.put(dxt.a.a, "SW");
      $$0.put(dxt.a.b, "S");
      $$0.put(dxt.a.c, "OW");
      $$0.put(dxt.a.d, "O");
   ...
   private duh l;
   @Nullable
   private CompletableFuture<duh> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blt r = new blt(1);
   private final blt s = new blt(bly.values().length);
   private final blt t = new blt(1);
   private final blt u = new blt(1);
   private final Map<blu, blt> v = Map.of(blu.a, this.s);
   private final fiu w;
   private final fiw x;
   private final fiv y;
   private final fit z;
   ...
   public fhl(ffe $$0) {
      ...
      this.g = new fhl.a();
      this.h = $$0.h;
      this.w = new fiu(this.h, this.r);
      this.x = new fiw(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fiv(this.h, this.t);
      this.z = new fit(this.h, this.u);
   }
   ...
   private void a(fgq $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         dbx $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof are ? ((are)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, kb.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayy.g($$15.dF()), ayy.g($$15.dH())));
         duh $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dcg.a, $$14);
            int $$30 = this.f.r.a(dcg.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            duh $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dxt.a $$33 : dxt.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqr $$37 = new bqr($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dci.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btr> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btr.values())
   ...
   private static String a(ji<dcw> $$0) {
   ...
   private dbx r() {
      return (dbx)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private duh s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, duw.n, false).thenApply($$0x -> (duh)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eyq.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffe.Q().aO().k(), ffe.Q().aO().l(), eyq.a()),
            eyq.c(),
            eyq.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evo.a.b) {
            ...
            $$4.add(String.valueOf(lp.e.b($$6.b())));

            for (Entry<dte<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evo.a.b) {
            ...
            $$4.add(String.valueOf(lp.c.b($$9.a())));

            for (Entry<dte<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lp.g.b($$11.ak())));
         }
   ...
   private String a(Entry<dte<?>, Comparable<?>> $$0) {
      dte<?> $$1 = $$0.getKey();
