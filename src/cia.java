...
public class cia extends cgz {
   private static final ajy<ji> bZ = akc.a(cia.class, aka.o);
   private static final ajy<Boolean> ca = akc.a(cia.class, aka.k);
   private static final ajy<Boolean> cc = akc.a(cia.class, aka.k);
   private static final ajy<ji> cd = akc.a(cia.class, aka.o);
   private static final ajy<Boolean> ce = akc.a(cia.class, aka.k);
   private static final ajy<Boolean> cf = akc.a(cia.class, aka.k);
   private static final float cg = 0.3F;
   private static final bup ch = but.bA.n().a(buo.a().a(bun.a, 0.0F, but.bA.m(), -0.25F)).a(0.3F);
   int ci;
   public static final cfz.a bY = ($$0, $$1) -> $$0.e_() && !$$0.bj();

   public cia(but<? extends cia> $$0, dgj $$1) {
      super($$0, $$1);
      this.a(etr.j, 0.0F);
      this.a(etr.t, -1.0F);
      this.a(etr.s, -1.0F);
      this.a(etr.r, -1.0F);
      this.bP = new cia.e(this);
   }
   ...
   public static boolean c(but<cia> $$0, dgk $$1, bus $$2, ji $$3, azh $$4) {
      return $$3.v() < $$1.P() + 4 && dsk.a($$1, $$3) && a($$1, $$3);
   }

   @Override
   protected void E() {
      this.bS.a(0, new cia.f(this, 1.2));
      this.bS.a(1, new cia.a(this, 1.0));
      this.bS.a(1, new cia.d(this, 1.0));
      this.bS.a(2, new cdo(this, 1.1, $$0 -> $$0.a(awy.az), false));
      this.bS.a(3, new cia.c(this, 1.0));
      this.bS.a(4, new cia.b(this, 1.0));
      this.bS.a(7, new cia.i(this, 1.0));
      this.bS.a(8, new cco(this, coy.class, 8.0F));
      this.bS.a(9, new cia.h(this, 1.0, 100));
   }

   public static bwp.a x() {
      return cgz.gx().a(bwq.s, 30.0).a(bwq.v, 0.25).a(bwq.B, 1.0);
   }
   ...
   protected ceu b(dgj $$0) {
      return new cia.g(this, $$0);
   }

   @Nullable
   @Override
   public bud a(ard $$0, bud $$1) {
      return but.bA.a($$0, bus.e);
   }
   ...
   public void d_() {
      ...
      if (this.bL() && this.t() && this.ci >= 1 && this.ci % 5 == 0) {
         ji $$0 = this.dv();
         if (dsk.a(this.dV(), $$0)) {
            this.dV().c(2001, $$0, djn.j(this.dV().a_($$0.e())));
            this.a(ebu.u);
         }
      }
   }
   ...
   protected void i() {
      super.i();
      if (!this.e_() && this.dV() instanceof ard $$0 && $$0.O().b(dgf.f)) {
         this.a($$0, cwu.oU, 1);
      }
   }
   ...
   static class a extends cbs {
      ...
      protected void g() {
         ...
         this.c.gD();
         azh $$1 = this.a.dY();
         if (a(this.b).O().b(dgf.f)) {
            this.b.b(new buy(this.b, this.a.dA(), this.a.dC(), this.a.dG(), $$1.a(7) + 1));
         }
      }
   }
   ...
   static class b extends ccg {
      ...
      public void a() {
         ...
         if (this.a.P().k()) {
            fbb $$2 = fbb.c($$0);
            fbb $$3 = cgd.a(this.a, 16, 3, $$2, (float) (Math.PI / 10));
            if ($$3 == null) {
               $$3 = cgd.a(this.a, 8, 7, $$2, (float) (Math.PI / 2));
            }

            if ($$3 != null && !$$1 && !this.a.dV().a_(ji.a((kb)$$3)).a(djp.J)) {
               $$3 = cgd.a(this.a, 16, 5, $$2, (float) (Math.PI / 2));
            }
   ...
   static class c extends cct {
      ...
      protected boolean a(dgm $$0, ji $$1) {
         return $$0.a_($$1).a(djp.J);
      }
   }

   static class d extends cct {
      private final cia g;
      ...
      public void a() {
         ...
         if (!this.g.bj() && this.m()) {
            if (this.g.ci < 1) {
               ...
               ji $$2 = this.e.d();
               dwy $$3 = djp.mH.m().b(dsk.f, Integer.valueOf(this.g.ae.a(4) + 1));
               $$1.a($$2, $$3, 3);
               $$1.a(ebu.i, $$2, ebu.a.a(this.g, $$3));
               this.g.x(false);
               this.g.y(false);
               this.g.r(600);
            }
      ...
      @Override
      protected boolean a(dgm $$0, ji $$1) {
         return !$$0.u($$1.d()) ? false : dsk.b($$0, $$1);
      }
   }

   static class e extends cbj {
      private final cia l;
      ...
      public void a() {
         ...
         if (this.k == cbj.a.b && !this.l.P().k()) {
            ...
            if ($$3 < 1.0E-5F) {
               ...
               this.l.aX = this.l.dL();
               float $$5 = (float)(this.h * this.l.h(bwq.v));
   ...
   static class g extends cer {
      ...
      public boolean a(ji $$0) {
         if (this.a instanceof cia $$1 && $$1.gv()) {
            return this.b.a_($$0).a(djp.J);
         }
   ...
   static class i extends ccg {
      ...
      public void a() {
         if (this.a.P().k()) {
            fbb $$0 = fbb.c(this.a.gt());
            fbb $$1 = cgd.a(this.a, 16, 3, $$0, (float) (Math.PI / 10));
            if ($$1 == null) {
