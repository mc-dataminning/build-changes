...
public class cia {
   ...
   public static OptionalInt a(apf $$0, ib $$1, apg $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.aa().map(cia::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<cia> $$4 = $$3.stream().flatMap($$0x -> $$0x.aa().stream()).max(Comparator.comparingInt(cia::c));
            if ($$4.isPresent()) {
               cia $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(apf $$0, ib $$1) {
      epo $$2 = epo.a(ept.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(chy.class, $$2).isEmpty();
   }

   private static List<apg> b(apf $$0, ib $$1) {
      ept $$2 = ept.b($$1);
      Predicate<apg> $$3 = $$1x -> $$1x.dk().a((iv)$$2, 16.0);
      return $$0.a($$3.and(bpp::bA).and(bpc.f));
   }
