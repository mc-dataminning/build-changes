...
public class cia extends chg {
   ...
   @Nullable
   private coh<cov> y;
   private final List<coh<cov>> z;

   public cia(int $$0, cdl $$1) {
      this($$0, $$1, cgp.a);
   }

   public cia(int $$0, cdl $$1, cgp $$2) {
      super(chl.v, $$0, $$1, $$2);
      this.x = $$1.m.dL();
      this.z = this.x.q().a(cok.g);
   }
   ...
   @Override
   public void m() {
      List<coh<cov>> $$0 = this.x.q().b(cok.g, this.q, this.x);
      if ($$0.isEmpty()) {
         this.r.a(0, clb.b);
      } else {
         coh<cov> $$1 = $$0.get(0);
         clb $$2 = $$1.b().a(this.q, this.x.H_());
         if ($$2.a(this.x.G())) {
            this.y = $$1;
            this.r.a($$1);
            this.r.a(0, $$2);
   ...
   private static OptionalInt a(cov $$0, clb $$1) {
      if ($$0.a($$1)) {
