...
public class cia extends btq implements cju {
   private static final Logger cd = LogUtils.getLogger();
   public static final akj<Integer> b = akn.a(cia.class, akl.b);
   private static final cef ce = cef.a().a(64.0);
   ...
   public int d = -1;
   private final chy[] ck;
   public final chy e;
   private final chy cl;
   ...
   private dvw cs;
   private iz ct = iz.c;
   private final cir cu;
   private int cv = 100;
   private float cw;
   private final eog[] cx = new eog[24];
   private final int[] cz = new int[24];
   private final eoe cA = new eoe();

   public cia(bsz<? extends cia> $$0, dbx $$1) {
      super(bsz.F, $$1);
      this.e = new chy(this, "head", 1.0F, 1.0F);
      this.cl = new chy(this, "neck", 3.0F, 3.0F);
      this.cm = new chy(this, "body", 5.0F, 3.0F);
      this.cn = new chy(this, "tail", 2.0F, 2.0F);
      this.co = new chy(this, "tail", 2.0F, 2.0F);
      this.cp = new chy(this, "tail", 2.0F, 2.0F);
      this.cq = new chy(this, "wing", 4.0F, 2.0F);
      this.cr = new chy(this, "wing", 4.0F, 2.0F);
      this.ck = new chy[]{this.e, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.t(this.eR());
      this.ag = true;
      this.au = true;
      this.cu = new cir(this);
   }
   ...
   public static buv.a u() {
      return btq.A().a(buw.q, 200.0);
   }

   @Override
   public boolean aV() {
      float $$0 = ayy.b(this.bY * (float) (Math.PI * 2));
      float $$1 = ayy.b(this.bX * (float) (Math.PI * 2));
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = ayy.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = ayy.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
         ...
         if (this.gg()) {
            ...
            if (this.dP().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = ayy.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.h(this.ds().b(0.0, $$11 * 0.01, 0.0));
                  this.r(ayy.g(this.dF()));
                  evq $$16 = $$9.a(this.du(), this.dw(), this.dA()).d();
                  evq $$17 = new evq((double)ayy.a(this.dF() * (float) (Math.PI / 180.0)), this.ds().d, (double)(-ayy.b(this.dF() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ayy.a(ayy.g(180.0F - (float)ayy.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dF()), -50.0F, 50.0F);
                     this.cb *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new evq(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(btt.a, this.ds().a(0.8F));
                  } else {
            ...
            this.aY = this.dF();
            evq[] $$24 = new evq[this.ck.length];

            for (int $$25 = 0; $$25 < this.ck.length; $$25++) {
               $$24[$$25] = new evq(this.ck[$$25].du(), this.ck[$$25].dw(), this.ck[$$25].dA());
            }
            ...
            if (!this.dP().B && this.aO == 0) {
               this.b(this.dP().a(this, this.cq.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsy.e));
               this.b(this.dP().a(this, this.cr.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsy.e));
               this.c(this.dP().a(this, this.e.cK().g(1.0), bsy.e));
               this.c(this.dP().a(this, this.cl.cK().g(1.0), bsy.e));
            }

            float $$32 = ayy.a(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$33 = ayy.b(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$34 = this.gp();
   ...
   private void gq() {
      ...
      if (this.ah.a(10) == 0) {
         List<chz> $$0 = this.dP().a(chz.class, this.cK().g(32.0));
         chz $$1 = null;
   ...
   private void b(List<bst> $$0) {
      ...
      for (bst $$3 : $$0) {
         if ($$3 instanceof bto) {
            ...
            if (!this.cu.a().a() && ((bto)$$3).en() < $$3.ai - 2) {
               $$3.a(this.dQ().b((bto)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bst> $$0) {
      for (bst $$1 : $$0) {
         if ($$1 instanceof bto) {
            $$1.a(this.dQ().b((bto)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dsb $$13 = this.dP().a_($$12);
               if (!$$13.i() && !$$13.a(awo.aD)) {
                  if (this.dP().ab().b(dbt.c) && !$$13.a(awo.aC)) {
   ...
   public boolean a(chy $$0, brm $$1, float $$2) {
      if (this.cu.a().i() == ciq.j) {
         return false;
      } else {
         $$2 = this.cu.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cmw || $$1.a(awq.z)) {
               float $$3 = this.eA();
               this.g($$1, $$2);
   ...
   protected boolean g(brm $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void eg() {
      ...
      if (this.dP() instanceof are) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$3) {
            bte.a((are)this.dP(), this.dn(), ayy.d((float)$$4 * 0.08F));
         }
      ...
      this.a(btt.a, new evq(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dP() instanceof are) {
         if ($$3) {
            bte.a((are)this.dP(), this.dn(), ayy.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(this.dP().z_() + 10, this.dP().a(dxt.a.f, new iz($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eog($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eog $$5 = new eog(ayy.a($$0), ayy.a($$1), ayy.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eoi a(int $$0, int $$1, @Nullable eog $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eog $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eoi a(eog $$0, eog $$1) {
      ...
      return new eoi($$2, new iz($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ur $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(ciq.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      ...
      double $$7;
      if ($$4 == ciq.d || $$4 == ciq.e) {
         iz $$5 = this.dP().a(dxt.a.f, eaw.a(this.ct));
   ...
   public evq F(float $$0) {
      cik $$1 = this.cu.a();
      ciq<? extends cik> $$2 = $$1.i();
      evq $$8;
      if ($$2 == ciq.d || $$2 == ciq.e) {
         iz $$3 = this.dP().a(dxt.a.f, eaw.a(this.ct));
   ...
   public void a(chz $$0, iz $$1, brm $$2) {
      cmw $$3;
      if ($$2.d() instanceof cmw) {
         $$3 = (cmw)$$2.d();
      } else {
