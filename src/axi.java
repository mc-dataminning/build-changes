...
public class axi<T> extends AbstractList<T> implements ayq<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axi.this.get(this.b--);
      }

      @Override
      public void remove() {
         axi.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements ayq<T> {
      private final axi<T> b;

      public b(final axi<T> $$0) {
         this.b = $$0;
      }
