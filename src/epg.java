...
public class epg<T> {
   ...
   private final epf<T> e;
   private final Queue<epg.a<T>> f = new PriorityQueue<>(c());
   private UnsignedLong g = UnsignedLong.ZERO;
   private final Table<String, Long, epg.a<T>> h = HashBasedTable.create();

   private static <T> Comparator<epg.a<T>> c() {
      return Comparator.<epg.a<T>>comparingLong($$0 -> $$0.a).thenComparing($$0 -> $$0.b);
   }

   public epg(epf<T> $$0, Stream<? extends Dynamic<?>> $$1) {
      this($$0);
      this.f.clear();
      this.h.clear();
   ...
   public void a(String $$0, long $$1, epe<T> $$2) {
      if (!this.h.contains($$0, $$1)) {
         this.g = this.g.plus(UnsignedLong.ONE);
         epg.a<T> $$3 = new epg.a<>($$1, this.g, $$0, $$2);
         this.h.put($$0, $$1, $$3);
         this.f.add($$3);
      }
   }
   ...
   public int a(String $$0) {
      Collection<epg.a<T>> $$1 = this.h.row($$0).values();
   ...
   public static class a<T> {
      ...
      public final epe<T> d;

      a(long $$0, UnsignedLong $$1, String $$2, epe<T> $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
