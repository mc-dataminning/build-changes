...
public class gdl {
   private static final gdx a = gdx.t(new alf("textures/map/map_background.png"));
   private static final gdx b = gdx.t(new alf("textures/map/map_background_checkerboard.png"));
   ...
   private float az;
   private float aA;
   private final giw aB;
   private final gjw aC;

   public gdl(ffg $$0, giw $$1, gjw $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(btq $$0, cuq $$1, cun $$2, boolean $$3, ezz $$4, gdp $$5, int $$6) {
      if (!$$1.e()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dP(), $$6, gor.d, $$0.al() + $$2.ordinal());
      }
   }
   ...
   private void a(ezz $$0, gdp $$1, int $$2, btk $$3) {
      god $$4 = (god)this.aB.<gco>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == btk.b ? 1.0F : -1.0F;
   ...
   private void a(ezz $$0, gdp $$1, int $$2, float $$3, btk $$4, float $$5, cuq $$6) {
      float $$7 = $$4 == btk.b ? 1.0F : -1.0F;
   ...
   private void a(ezz $$0, gdp $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayz.c($$5);
   ...
   private void a(ezz $$0, gdp $$1, int $$2, cuq $$3) {
      ...
      epj $$4 = $$3.a(km.B);
      epl $$5 = cuy.a($$4, this.au.r);
      fad $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(ezz $$0, gdp $$1, int $$2, float $$3, float $$4, btk $$5) {
      boolean $$6 = $$5 != btk.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayz.c($$4);
   ...
   private void a(ezz $$0, float $$1, btk $$2, cuq $$3) {
   ...
   private void a(ezz $$0, float $$1, btk $$2, cuq $$3, float $$4) {
      this.b($$0, $$2, $$4);
   ...
   private void a(ezz $$0, btk $$1, float $$2) {
      int $$3 = $$1 == btk.b ? 1 : -1;
   ...
   private void b(ezz $$0, btk $$1, float $$2) {
      int $$3 = $$1 == btk.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, ezz $$1, gdp.a $$2, gcr $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bqu $$6 = (bqu)MoreObjects.firstNonNull($$3.aK, bqu.a);
      ...
      if ($$8.d) {
         float $$11 = $$6 == bqu.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ayz.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bqu.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bqu.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ayz.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bqu.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gdl.a a(gcr $$0) {
      cuq $$1 = $$0.eX();
      cuq $$2 = $$0.eY();
      boolean $$3 = $$1.a(cut.ou) || $$2.a(cut.ou);
      boolean $$4 = $$1.a(cut.vT) || $$2.a(cut.vT);
      if (!$$3 && !$$4) {
         return gdl.a.a;
      } else if ($$0.fv()) {
         return b($$0);
      } else {
         return a($$1) ? gdl.a.b : gdl.a.a;
      }
   }

   private static gdl.a b(gcr $$0) {
      cuq $$1 = $$0.fx();
      bqu $$2 = $$0.fw();
      if (!$$1.a(cut.ou) && !$$1.a(cut.vT)) {
         return $$2 == bqu.a && a($$0.eY()) ? gdl.a.b : gdl.a.a;
      } else {
         return gdl.a.a($$2);
      }
   }
   ...
   private static boolean a(cuq $$0) {
      return $$0.a(cut.vT) && ctd.j($$0);
   }

   private void a(gco $$0, float $$1, float $$2, bqu $$3, float $$4, cuq $$5, float $$6, ezz $$7, gdp $$8, int $$9) {
      if (!$$0.gA()) {
         boolean $$10 = $$3 == bqu.a;
         btk $$11 = $$10 ? $$0.fu() : $$0.fu().e();
         $$7.a();
         if ($$5.e()) {
            if ($$10 && !$$0.ch()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
