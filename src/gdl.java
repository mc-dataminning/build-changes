...
public class gdl implements aol<gdk> {
   public gdk b(JsonObject $$0) {
      Builder<gdj> $$1 = ImmutableList.builder();
      int $$2 = atg.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = atg.a($$0, "width", -1);
      int $$9 = atg.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = atg.a($$0, "interpolate", false);
      return new gdk($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gdj a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gdj(atg.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = atg.m($$1, "frames[" + $$0 + "]");
         int $$3 = atg.a($$2, "time", -1);
         if ($$2.has("time")) {
