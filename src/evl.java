...
public class evl {
   ...
   public static void a(File $$0, eof $$1, Consumer<vd> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eof $$2, Consumer<vd> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eof $$2, Consumer<vd> $$3) {
      eou $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            vd $$3x = vd.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new vb(vb.a.b, $$6.getAbsolutePath())));
            $$3.accept(vd.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(vd.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static eou a(eof $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eou $$3 = new eou($$1, $$2, false);
   ...
   public evl(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
