...
public class elk {
   private final ImmutableList<ell> a;
   private final ImmutableMap<String, ell> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private eli e;

   public elk(ImmutableMap<String, ell> $$0) {
      this.b = $$0;
