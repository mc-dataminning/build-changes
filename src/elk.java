...
public class elk implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<elk.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public elk(List<elk.a> $$0) {
      this.c = $$0;
   }
   ...
   public static elk a(BufferedReader $$0) {
      return new elk($$0.lines().flatMap($$0x -> elk.a.a($$0x).stream()).toList());
   }

   public static record a(elk.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<elk.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new elk.a(elk.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new elk.a(elk.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new elk.a(elk.b.b, $$3));
      ...
      static elk.a b(String $$0) {
         return new elk.a(elk.b.a, "glob:" + $$0);
      }

      static elk.a c(String $$0) {
         return new elk.a(elk.b.a, "regex:" + $$0);
      }

      static elk.a d(String $$0) {
         return new elk.a(elk.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      elk.b a = FileSystem::getPathMatcher;
      elk.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
