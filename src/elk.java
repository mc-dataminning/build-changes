...
public class elk {
   ...
   static class b {
      static final Optional<elk> a = Optional.ofNullable(a());
      ...
      private static elk a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new elk();
      }
   }
}
