...
public class elk extends elo implements elm {
   ...
   public elk.c a() {
      return new elk.c(this.p, this.l, this.t, this.u);
   }

   public void a(elk.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   public void a(elu.b $$0, elu $$1) {
      if (this.s) {
         ...
         this.p = $$0;
         this.a($$1);
         this.m = (elv)$$1.c().get(0);
         this.n = 0;
         this.h.rewind();
      }
   }

   private void a(elu $$0) {
      if (this.o != $$0) {
         this.o = $$0;
         boolean $$1 = $$0 == eln.k;
         boolean $$2 = $$0 == eln.j;
   ...
   private IntConsumer a(int $$0, elu.a $$1) {
   ...
   private elk.b o() {
      ...
      this.j += $$5;
      this.i++;
      elk.a $$9 = new elk.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new elk.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == elu.b.a || this.p == elu.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<elv> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      elv $$1 = (elv)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == elv.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == elv.b.c) {
         elm.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, elm.a($$11));
         this.a($$14 + 5, elm.a($$12));
         this.a($$14 + 6, elm.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(elu a, int b, int c, elu.b d, elu.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(elu.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable elx $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
