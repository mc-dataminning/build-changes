   ...
   private <TE> TypeRewriteRule a(Type<?> $$0, ListType<TE> $$1) {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhere(
            "InjectBedBlockEntityType", this.getInputSchema().findChoiceType(bfs.s), this.getOutputSchema().findChoiceType(bfs.s), $$0x -> $$0xx -> $$0xx
         ),
         this.fixTypeEverywhereTyped(
            "BedBlockEntityInjecter",
            this.getOutputSchema().getType(bfs.c),
            $$3x -> {
