...
public class dzr extends dzu<dzq> {
   public dzr(Codec<dzq> $$0) {
      super($$0);
   }

   public boolean a(dzq $$0, azc $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dzp $$0, dzq $$1, dtt $$2, Function<iz, ji<dcs>> $$3, azc $$4, dxb $$5, dba $$6, dts $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dzu.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dzp $$0, dzq $$1, dtt $$2, Function<iz, ji<dcs>> $$3, dxb $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dts $$10, dzu.a $$11
   ) {
      double $$12 = 1.5 + (double)(ayu.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ayu.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ayu.b($$13);
         $$6 += (double)(ayu.b($$12) * $$27);
         $$7 += (double)ayu.a($$13);
         $$8 += (double)(ayu.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
