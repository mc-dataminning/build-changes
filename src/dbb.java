...
public abstract class dbb {
   ...
   public void a(btb<?> $$0, @Nullable dbz $$1, azh $$2, iz $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bum.a($$7.get(), $$0, btu.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dwk.b($$15.getClass()),
                        new evn((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bta.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof bts $$17) {
                     ...
                     if ($$18) {
                        ((bts)$$15).a($$0, $$0.d_($$15.dp()), btu.c, null);
                     }
   ...
   private void d(dbz $$0, iz $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dcq)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dbz $$0, iz $$1, us $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dcq $$4 = dcq.b.parse(vg.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dcq::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dcq.c.parse(vg.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bpf::b);
      } else {
         this.e = bpf.a(this.f != null ? this.f : new dcq());
      }
   ...
   public us a(us $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vp)dcq.b.encodeStart(vg.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vp)dcq.c.encodeStart(vg.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bsv b(dbz $$0, iz $$1) {
      if (this.l == null) {
         ...
         this.l = btb.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof bts) {
         }
      }
   ...
   protected void a(@Nullable dbz $$0, iz $$1, dcq $$2) {
      this.f = $$2;
   }

   private dcq a(@Nullable dbz $$0, azh $$1, iz $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bph.b::b).orElseGet(dcq::new));
         return this.f;
      }
   }

   public abstract void a(dbz var1, iz var2, int var3);
