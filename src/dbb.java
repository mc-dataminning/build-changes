...
public interface dbb<T extends Enum<T>> {
   int v_ = 4;

   Optional<dmz> j_(dmz var1);

   float ax_();

   default void a_(dmz $$0, apf $$1, ib $$2, axd $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dmz> c(dmz $$0, apf $$1, ib $$2, axd $$3) {
      ...
      for (ib $$7 : ib.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dbb<?> $$9) {
            Enum<?> $$10 = $$9.c();
