...
public class io extends js {
   ...
   private static final int h = 1 + ayd.f(ayd.c(30000000));
   ...
   public static io a(double $$0, double $$1, double $$2) {
      return new io(ayd.a($$0), ayd.a($$1), ayd.a($$2));
   }
   ...
   public static Iterable<io> a(ayk $$0, int $$1, io $$2, int $$3) {
   ...
   public static Iterable<io> a(ayk $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      int $$8 = $$5 - $$2 + 1;
      int $$9 = $$6 - $$3 + 1;
      int $$10 = $$7 - $$4 + 1;
   ...
   public static Stream<io> a(ehb $$0) {
      return a(
         Math.min($$0.h(), $$0.k()),
         Math.min($$0.i(), $$0.l()),
         Math.min($$0.j(), $$0.m()),
   ...
   public static Stream<io> a(euf $$0) {
      return a(ayd.a($$0.a), ayd.a($$0.b), ayd.a($$0.c), ayd.a($$0.d), ayd.a($$0.e), ayd.a($$0.f));
   }
   ...
   public static class a extends io {
      ...
      public io.a b(double $$0, double $$1, double $$2) {
         return this.d(ayd.a($$0), ayd.a($$1), ayd.a($$2));
      }
      ...
      public io.a a(it.a $$0, int $$1, int $$2) {
         switch ($$0) {
            case a:
               return this.d(ayd.a(this.u(), $$1, $$2), this.v(), this.w());
            case b:
               return this.d(this.u(), ayd.a(this.v(), $$1, $$2), this.w());
            case c:
               return this.d(this.u(), this.v(), ayd.a(this.w(), $$1, $$2));
            default:
