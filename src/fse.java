...
public class fse {
   private static final alj a = alj.b("advancements/title_box");
   ...
   @Nullable
   private fse v;
   private final List<fse> w = Lists.newArrayList();
   @Nullable
   private aj x;
   private final int y;
   private final int z;

   public fse(fsc $$0, fke $$1, ai $$2, at $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = ug.a().a($$1.h.a($$3.a(), 163));
      this.y = azm.d($$3.f() * 28.0F);
      this.z = azm.d($$3.g() * 27.0F);
      int $$4 = this.e();
      int $$5 = 29 + $$1.h.a(this.r) + $$4;
      this.t = ug.a().a(this.a(xm.a($$3.b().f(), yg.a.a($$3.e().a())), $$5));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         xj $$2 = xj.a("advancements.progress", $$0, $$0);
         return this.u.h.a($$2) + 8;
      }
   }

   private static float a(fkp $$0, List<xo> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xo> a(xj $$0, int $$1) {
      fkp $$2 = this.u.h.b();
      List<xo> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<xo> $$6 = $$2.b($$0, $$1 - $$5, yg.a);
   ...
   public void a(flq $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
   ...
   public void a(flq $$0, int $$1, int $$2) {
      if (!this.q.j() || this.x != null && this.x.a()) {
         ...
         $$0.a(gjq::B, $$4.a(this.q.e()), $$1 + this.y + 3, $$2 + this.z, 26, 26);
   ...
   public void a(flq $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      ...
      if (!this.t.isEmpty()) {
         if ($$9) {
            $$0.a(gjq::B, a, $$26, $$25 + 26 - $$28, this.s, $$28);
         } else {
            $$0.a(gjq::B, a, $$26, $$25, this.s, $$28);
         }
      }

      $$0.a(gjq::B, $$12.a(), 200, 26, 0, 0, $$26, $$25, $$11, 26);
      $$0.a(gjq::B, $$13.a(), 200, 26, 200 - $$24, 0, $$26 + $$11, $$25, $$24, 26);
      $$0.a(gjq::B, $$14.a(this.q.e()), $$1 + this.y + 3, $$2 + this.z, 26, 26);
      if ($$6) {
