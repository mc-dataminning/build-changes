...
public class fse implements fsj.a {
   ...
   private final ero A;
   private final Map<ht, fse.a> B = new HashMap<>();
   private final Map<UUID, wr.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(xb.a $$0, long $$1) {
      this.B.put($$0.a(), new fse.a($$0, $$1));
   }

   public void a(wr.a $$0) {
      this.C.put($$0.b(), $$0);
   }
   ...
   private void b(emh $$0, fpb $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aby::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         fsj.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aby::a).collect(Collectors.toSet()).toString();
      }
   }
   ...
   private void a(emh $$0, fpb $$1, xb.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(emh $$0, fpb $$1, wr.a $$2) {
      if ($$2.e() != null) {
         fsr.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(emh $$0, fpb $$1, wr.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(emh $$0, fpb $$1, String $$2, xb.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }
   ...
   private Set<String> a(xb.a $$0) {
      return this.a($$0.a()).stream().map(aby::a).collect(Collectors.toSet());
   }

   private String a(wr.a $$0, ht $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(wr.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(wr.a $$0) {
      ccx $$1 = this.A.s;
      ht $$2 = ht.a($$1.dq(), $$0.d().b(), $$1.dw());
      ht $$3 = ht.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(ht $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(wr.a::b).collect(Collectors.toSet());
   }

   private Map<ht, List<String>> f() {
      Map<ht, List<String>> $$0 = Maps.newHashMap();

      for (wr.a $$1 : this.C.values()) {
   ...
   private void g() {
      fsj.a(this.A.am(), 8).ifPresent($$0 -> this.D = $$0.cv());
   }

   static record a(xb.a a, long b) {
   }
}
