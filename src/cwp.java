...
public final class cwp implements kq {
   ...
   public static final Codec<cwp> b = Codec.lazyInitialized(
      () -> RecordCodecBuilder.create(
            $$0 -> $$0.group(cwl.e.fieldOf("id").forGetter(cwp::i), ks.b.optionalFieldOf("components", ks.a).forGetter($$0x -> $$0x.p.g()))
   ...
   public static final ym<vz, cwp> g = new ym<vz, cwp>() {
      private static final ym<vz, jr<cwl>> a = yk.b(mc.K);
   ...
   public static final ym<vz, cwp> h = new ym<vz, cwp>() {
      public cwp a(vz $$0) {
   ...
   public static final ym<vz, List<cwp>> i = g.a(yk.a(ka::a));
   ...
   public static ym<vz, cwp> a(final ym<vz, cwp> $$0) {
      return new ym<vz, cwp>() {
         public cwp a(vz $$0x) {
            cwp $$1 = $$0.decode($$0);
            if (!$$1.f()) {
   ...
   public boolean f() {
      return this == j || this.o == cwt.a || this.m <= 0;
   }
   ...
   public cwp a(dgi $$0, bvg $$1) {
      cwp $$2 = this.v();
      cwp $$3 = this.h().a(this, $$0, $$1);
      return $$3.a($$1, $$2);
   }

   private cwp a(bvg $$0, cwp $$1) {
      czv $$2 = $$1.a(kv.y);
      czu $$3 = $$1.a(kv.z);
      int $$4 = $$1.M();
      cwp $$5 = this;
   ...
   public void a(int $$0, arc $$1, @Nullable ard $$2, Consumer<cwl> $$3) {
      int $$4 = this.a($$0, $$1, $$2);
      if ($$4 != 0) {
         this.a(this.o() + $$4, $$2, $$3);
      }
   ...
   private void a(int $$0, @Nullable ard $$1, Consumer<cwl> $$2) {
      if ($$1 != null) {
         ap.u.a($$1, this, $$0);
      }
   ...
   public cwp a(int $$0, dgh $$1, bvg $$2, bus $$3) {
      this.a($$0, $$2, $$3);
      if (this.f()) {
         cwp $$4 = this.b($$1, 1);
         if ($$4.m()) {
   ...
   public boolean a(cwp $$0, ctz $$1, csm $$2, cox $$3, bvy $$4) {
   ...
   public bsj a(cox $$0, bvg $$1, bsi $$2) {
      return this.h().a(this, $$0, $$1, $$2);
   }
   ...
   public cwp v() {
      if (this.f()) {
         ...
         cwp $$0 = new cwp(this.h(), this.m, this.p.h());
         $$0.d(this.L());
         return $$0;
      }
   }
   ...
   private cwp b(dgh $$0, int $$1) {
      return new cwp($$0.j().f(), $$1, this.p.g());
   }
   ...
   public void a(dgi $$0, buk $$1, int $$2, boolean $$3) {
      if (this.n > 0) {
         this.n--;
      }
   ...
   public void a(dgi $$0, bvg $$1, int $$2) {
      cwp $$3 = this.v();
   ...
   private <T extends czs> void a(ku<T> $$0, cwl.b $$1, Consumer<wo> $$2, cyh $$3) {
      T $$4 = (T)this.a($$0);
      if ($$4 != null) {
         $$4.a($$1, $$2, $$3);
      }
   ...
   public List<wo> a(cwl.b $$0, @Nullable cox $$1, cyh $$2) {
      boolean $$3 = cuv.a(this, $$1);
      if (!$$2.b() && this.b(kv.r)) {
         return $$3 ? cuv.a : List.of();
      } else {
   ...
   private void a(Consumer<wo> $$0, @Nullable cox $$1) {
   ...
   private void a(Consumer<wo> $$0, @Nullable cox $$1, jr<bwj> $$2, bwm $$3) {
      double $$4 = $$3.c();
      boolean $$5 = false;
      if ($$1 != null) {
         if ($$3.a(cwl.g)) {
      ...
      if ($$5) {
         $$0.accept(wn.a().b(wo.a("attribute.modifier.equals." + $$3.d().a(), czg.d.format($$6), wo.c($$2.a().c()))).a(n.c));
      } else if ($$4 > 0.0) {
         $$0.accept(wo.a("attribute.modifier.plus." + $$3.d().a(), czg.d.format($$6), wo.c($$2.a().c())).a($$2.a().b(true)));
      } else if ($$4 < 0.0) {
         $$0.accept(wo.a("attribute.modifier.take." + $$3.d().a(), czg.d.format(-$$6), wo.c($$2.a().c())).a($$2.a().b(false)));
      }
   }
   ...
   @Nullable
   public cku I() {
      return this.q instanceof cku ? (cku)this.J() : null;
   }
   ...
   public cwp b(int $$0, @Nullable bvg $$1) {
      cwp $$2 = this.c($$0);
      this.a($$0, $$1);
      return $$2;
   }

   public void b(dgi $$0, bvg $$1, int $$2) {
      cyv $$3 = this.a(kv.x);
      if ($$3 != null && $$3.a($$2)) {
         $$3.a($$1.dZ(), $$1, this, 5);
      }
