...
public abstract class bgp extends DataFix {
   ...
   public bgp(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bgd.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bgd.B);
      Type<Pair<String, String>> $$2 = DSL.named(bgd.z.typeName(), bhp.a());
      if (!Objects.equals(this.getOutputSchema().getType(bgd.z), $$2)) {
