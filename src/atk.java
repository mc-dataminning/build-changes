...
class atk extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atj && $$1 instanceof atj && $$0.equals($$1);
   }
   ...
   private static atj a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atj) {
         return (atj)$$0;
      } else {
