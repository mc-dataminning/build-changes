...
class atk implements Path {
   private static final BasicFileAttributes a = new ati() {
      @Override
   ...
   private static final BasicFileAttributes b = new ati() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atk> c = Comparator.comparing(atk::n);
   ...
   public atk(atm $$0, String $$1, @Nullable atk $$2, atn $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atk a(@Nullable atk $$0, String $$1) {
      return new atk(this.e, $$1, $$0, atn.b);
   }
   ...
   atk a(String $$0) {
      if (a(this.i)) {
         return new atk(this.e, $$0, this, this.i);
      } else if (this.i instanceof atn.a $$1) {
         atk $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atk(this.e, $$0, this, atn.a);
      } else if (this.i instanceof atn.b) {
         return new atk(this.e, $$0, this, atn.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atn $$0) {
      return $$0 == atn.a || $$0 == atn.b;
   }
   ...
   private atk c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atk $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atn.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atn.a i() {
      return this.i instanceof atn.a $$0 ? $$0 : null;
   }
