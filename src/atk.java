...
public class atk extends ate {
   static final Logger c = LogUtils.getLogger();
   private final atk.b d;
   private final String e;

   atk(atm $$0, atk.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(atp $$0, ale $$1) {
   ...
   @Nullable
   private aus<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aus.create($$1, $$2);
      }
   }
   ...
   public static class a implements aui.c {
      ...
      @Override
      public atn a(atm $$0) {
         atk.b $$1 = new atk.b(this.a);
         return new atk($$0, $$1, "");
      }

      @Override
      public atn a(atm $$0, aui.a $$1) {
         atk.b $$2 = new atk.b(this.a);
         atn $$3 = new atk($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<atn> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  atk.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
