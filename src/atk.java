...
public class atk extends axo {
   public atk(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", aym.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(aym.s, "minecraft:jukebox");
