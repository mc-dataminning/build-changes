...
public class atk<K> implements im<K> {
   ...
   private atk(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> atk<A> c(int $$0) {
      return new atk((int)((float)$$0 / 0.8F));
   }
   ...
   private int d(@Nullable K $$0) {
      return (aun.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public atk<K> c() {
      return new atk<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
