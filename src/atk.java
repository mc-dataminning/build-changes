...
public class atk extends FileSystem {
   private static final Set<String> b = Set.of("basic");
   public static final String a = "/";
   private static final Splitter c = Splitter.on('/');
   private final FileStore d;
   private final FileSystemProvider e = new atj();
   private final ati f;

   atk(String $$0, atk.b $$1) {
      this.d = new ath($$0);
      this.f = a($$1, this, "", null);
   }

   private static ati a(atk.b $$0, atk $$1, String $$2, @Nullable ati $$3) {
      Object2ObjectOpenHashMap<String, ati> $$4 = new Object2ObjectOpenHashMap();
      ati $$5 = new ati($$1, $$2, $$3, new atl.a($$4));
      $$0.b.forEach(($$3x, $$4x) -> $$4.put($$3x, new ati($$1, $$3x, $$5, new atl.b($$4x))));
   ...
   public static atk.a c() {
      return new atk.a();
   }

   public static class a {
      private final atk.b a = new atk.b();

      public atk.a a(List<String> $$0, String $$1, Path $$2) {
         atk.b $$3 = this.a;

         for (String $$4 : $$0) {
            $$3 = $$3.a.computeIfAbsent($$4, $$0x -> new atk.b());
         }
      ...
      public atk.a a(List<String> $$0, Path $$1) {
         if ($$0.isEmpty()) {
   ...
   static record b(Map<String, atk.b> a, Map<String, Path> b) {
