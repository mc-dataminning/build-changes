...
public class eyw extends eyb {
   ...
   public eyw(List<ezx> $$0, List<xv> $$1, eya $$2, Optional<ewo.b> $$3) {
      super($$0);
   ...
   public cxo a(cxo $$0, ewo $$1) {
      $$0.a(ku.j, dah.a, $$1x -> new dah(this.a($$1x, $$1)));
      return $$0;
   }

   private List<xv> a(@Nullable dah $$0, ewo $$1) {
      if ($$0 == null && this.b.isEmpty()) {
         return List.of();
      } else {
         UnaryOperator<xv> $$2 = eyx.a($$1, this.d.orElse(null));
