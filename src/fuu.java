...
public class fuu extends fqd {
   private static final xd c = xd.c("gui.socialInteractions.title");
   private static final alc d = alc.b("social_interactions/background");
   private static final alc s = alc.b("icon/search");
   ...
   private final fny M = new fny(this);
   @Nullable
   private final fqd N;
   fut O;
   fkt P;
   private String Q = "";
   private fuu.a R = fuu.a.a;
   private fkk S;
   private fkk T;
   private fkk U;
   private fkk V;
   ...
   protected void aR_() {
      this.M.a(c, this.p);
      this.O = new fut(this, this.m, this.n, this.D() - 88, 88, 36);
      int $$0 = this.O.b() / 3;
      int $$1 = this.O.s();
      int $$2 = this.O.t();
      this.S = this.c(fkk.a(u, $$0x -> this.a(fuu.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fkk.a(v, $$0x -> this.a(fuu.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fkk.a(w, $$0x -> this.a(fuu.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fkt(this.p, this.E() + 28, 74, 200, 15, A) {
         @Override
         protected xr aO_() {
            return !fuu.this.P.a().isEmpty() && fuu.this.O.c() ? super.aO_().f(", ").b(fuu.B) : super.aO_();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fkk.a(E, fpa.b(this, axz.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fkk.a(xc.d, $$0x -> this.d()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fjx $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.E() + 3;
      $$0.a(ghq::B, d, $$4, 64, 236, this.m() + 16);
      $$0.a(ghq::B, s, $$4 + 10, 76, 12, 12);
   }
