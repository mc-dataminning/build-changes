...
public class fuu extends fup<bvi, fge<bvi>> {
   private static final Map<bvi.a, aey> a = ac.a(Maps.newEnumMap(bvi.a.class), $$0 -> {
      $$0.put(bvi.a.a, new aey("textures/entity/panda/panda.png"));
      $$0.put(bvi.a.b, new aey("textures/entity/panda/lazy_panda.png"));
      $$0.put(bvi.a.c, new aey("textures/entity/panda/worried_panda.png"));
      $$0.put(bvi.a.d, new aey("textures/entity/panda/playful_panda.png"));
      $$0.put(bvi.a.e, new aey("textures/entity/panda/brown_panda.png"));
      $$0.put(bvi.a.f, new aey("textures/entity/panda/weak_panda.png"));
      $$0.put(bvi.a.g, new aey("textures/entity/panda/aggressive_panda.png"));
   });

   public fuu(ftj.a $$0) {
      super($$0, new fge<>($$0.a(fid.az)), 0.9F);
      this.a(new fxn(this, $$0.d()));
   }

   public aey a(bvi $$0) {
      return a.getOrDefault($$0.gp(), a.get(bvi.a.a));
   }

   protected void a(bvi $$0, elr $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ary.i($$24, $$0.dD(), $$0.dD() + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(ary.i($$26, $$0.dD(), $$0.dD() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ary.i($$3, $$0, $$1) : $$0;
   }
}
