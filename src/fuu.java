...
public class fuu extends fty {
   ...
   private String G = "";
   private final frb H = new frb(this::R, this::b, this::l, this::a, $$0x -> $$0x.length() < 1024 && this.p.b($$0x, 114) <= 128);
   private final frb I = new frb(() -> this.G, $$0x -> this.G = $$0x, this::l, this::a, $$0x -> $$0x.length() < 16);
   private long J;
   private int K = -1;
   private fvw L;
   private fvw M;
   ...
   private final bti R;
   @Nullable
   private fuu.a S = fuu.a.a;
   private xv T = xu.a;
   private final xv U;

   public fuu(cpx $$0, cxp $$1, bti $$2, daw $$3) {
      super(flx.a);
      this.z = $$0;
      this.A = $$1;
      this.R = $$2;
      $$3.a(fmg.Q().aU()).forEach(this.F::add);
      if (this.F.isEmpty()) {
         this.F.add("");
      }
   ...
   private String l() {
      return this.m != null ? frb.b(this.m) : "";
   }
   ...
   protected void aT_() {
      this.T();
      this.O = this.c((fof)fof.a(xv.c("book.signButton"), $$0x -> {
         this.C = true;
         this.J();
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.N = this.c((fof)fof.a(xu.d, $$0x -> {
         this.m.a(null);
         this.c(false);
      }).a(this.n / 2 + 2, 196, 98, 20).a());
      this.P = this.c((fof)fof.a(xv.c("book.finalizeButton"), $$0x -> {
         if (this.C) {
            this.c(true);
            this.m.a(null);
         }
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.Q = this.c((fof)fof.a(xu.e, $$0x -> {
         if (this.C) {
            this.C = false;
         }
      ...
      int $$0 = (this.n - 192) / 2;
      int $$1 = 2;
      this.L = this.c(new fvw($$0 + 116, 159, true, $$0x -> this.G(), true));
      this.M = this.c(new fvw($$0 + 43, 159, false, $$0x -> this.F(), true));
      this.J();
   }
   ...
   private void c(boolean $$0) {
      if (this.B) {
         this.K();
         this.L();
         int $$1 = this.R == bti.a ? this.z.gi().j : 40;
         this.m.L().b(new aig($$1, this.F, $$0 ? Optional.of(this.G.trim()) : Optional.empty()));
      }
   }

   private void L() {
      this.A.b(ku.S, new daw(this.F.stream().map(asz::a).toList()));
   }
   ...
   public void b(fns $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(glv::C, fuv.s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }

   private void a(fns $$0, fuu.c $$1, boolean $$2) {
      if (this.D / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(fns $$0, gls[] $$1) {
      for (gls $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(glv.J(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private fuu.c a(fuu.c $$0) {
      return new fuu.c($$0.a - (this.n - 192) / 2 - 36, $$0.b - 32);
   }

   private fuu.c b(fuu.c $$0) {
      return new fuu.c($$0.a + (this.n - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ae.c();
            fuu.a $$4 = this.S();
            int $$5 = $$4.a(this.p, this.a(new fuu.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            fuu.a $$5 = this.S();
            int $$6 = $$5.a(this.p, this.a(new fuu.c((int)$$0, (int)$$1)));
            this.H.c($$6, true);
            this.T();
         }
   ...
   private fuu.a V() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<fuu.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, ys.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            fuu.c $$12 = this.b(new fuu.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new fuu.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         fuu.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new fuu.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.p.b($$0.substring($$8[$$11], $$1));
            $$10 = new fuu.c($$12, $$11 * 9);
         }

         List<gls> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new fuu.c(0, $$23), new fuu.c($$25, $$23 + 9)));
               }
         ...
         return new fuu.a($$0, $$10, $$9, $$8, $$4.toArray(new fuu.b[0]), $$14.toArray(new gls[0]));
      }
   }
   ...
   private gls a(String $$0, fmq $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      fuu.c $$8 = new fuu.c((int)$$1.a($$6), $$4);
      fuu.c $$9 = new fuu.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private gls a(fuu.c $$0, fuu.c $$1) {
      fuu.c $$2 = this.b($$0);
      fuu.c $$3 = this.b($$1);
      ...
      return new gls($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fuu.a a = new fuu.a("", new fuu.c(0, 0), true, new int[]{0}, new fuu.b[]{new fuu.b(ys.a, "", 0, 0)}, new gls[0]);
      ...
      public a(String $$0, fuu.c $$1, boolean $$2, int[] $$3, fuu.b[] $$4, gls[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
