...
public class fuu {
   private static final akv a = akv.b("advancements/title_box");
   ...
   private final aj r;
   private final au s;
   private final List<ayl> t;
   private final int u;
   private final List<ayl> v;
   private final flk w;
   @Nullable
   private fuu x;
   private final List<fuu> y = Lists.newArrayList();
   @Nullable
   private ak z;
   private final int A;
   private final int B;

   public fuu(fus $$0, flk $$1, aj $$2, au $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
      this.t = $$1.h.c($$3.a(), 163);
      this.A = ayz.d($$3.f() * 28.0F);
      this.B = ayz.d($$3.g() * 27.0F);
      int $$4 = Math.max(this.t.stream().mapToInt($$1.h::a).max().orElse(0), 80);
      int $$5 = this.e();
      int $$6 = 29 + $$4 + $$5;
      this.v = tl.a().a(this.a(ws.a($$3.b().f(), xm.a.a($$3.e().a())), $$6));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         wp $$2 = wp.a("advancements.progress", $$0, $$0);
         return this.w.h.a($$2) + 8;
      }
   }

   private static float a(flu $$0, List<wu> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<wu> a(wp $$0, int $$1) {
      flu $$2 = this.w.h.b();
      List<wu> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : p) {
         List<wu> $$6 = $$2.b($$0, $$1 - $$5, xm.a);
   ...
   public void a(fof $$0, int $$1, int $$2, boolean $$3) {
      if (this.x != null) {
         int $$4 = $$1 + this.x.A + 13;
   ...
   public void a(fof $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(gmj::H, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(fof $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fod $$6 = this.w.h;
      ...
      wp $$13 = this.z == null ? null : this.z.d();
      int $$14 = $$13 == null ? 0 : $$6.a($$13);
      boolean $$15 = $$9 + $$11 >= 113;
      float $$16 = this.z == null ? 0.0F : this.z.c();
      int $$17 = ayz.d($$16 * (float)this.u);
      fuv $$18;
      fuv $$19;
      fuv $$20;
      if ($$16 >= 1.0F) {
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(gmj::H, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(gmj::H, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(gmj::H, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(gmj::H, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(gmj::H, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(gmj::H, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(fof $$0, List<ayl> $$1, int $$2, int $$3, int $$4) {
      fod $$5 = this.w.h;
