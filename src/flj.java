...
public class flj {
   ...
   private void a(n $$0, wp $$1) {
      this.b.m.d().a(wp.i().b(wp.c("debug.prefix").a($$0, n.r)).b(wo.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(wp.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dgg)MoreObjects.firstNonNull(this.b.r.i(), dgg.b)).b());
               }
            ...
            case 81:
               ...
               fov $$3 = this.b.m.d();
               $$3.a(wp.c("debug.reload_chunks.help"));
               $$3.a(wp.c("debug.show_hitboxes.help"));
               $$3.a(wp.c("debug.copy_location.help"));
               $$3.a(wp.c("debug.clear_chat.help"));
               $$3.a(wp.c("debug.chunk_boundaries.help"));
               $$3.a(wp.c("debug.advanced_tooltips.help"));
               $$3.a(wp.c("debug.inspect.help"));
               $$3.a(wp.c("debug.profiling.help"));
               $$3.a(wp.c("debug.creative_spectator.help"));
               $$3.a(wp.c("debug.pause_focus.help"));
               $$3.a(wp.c("debug.help.help"));
               $$3.a(wp.c("debug.dump_dynamic_textures.help"));
               $$3.a(wp.c("debug.reload_resourcepacks.help"));
               $$3.a(wp.c("debug.pause.help"));
               $$3.a(wp.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               wp $$6 = wp.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new wn(wn.a.b, $$5.toFile().toString())));
   ...
   private void a(dwy $$0, ji $$1, @Nullable tq $$2) {
   ...
   private void a(akv $$0, fbb $$1, @Nullable tq $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = feq.a(flk.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!feq.a(flk.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (feq.a(flk.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxx) || ((fxx)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fls.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aL_() instanceof fpd) || !((fpd)$$6.aL_()).c();
            if ($$7) {
               if (fum.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$8 = this.b.n.av().c() == flm.a;
                  this.b.n.av().a(flm.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof fuh $$14 && !$$14.m()) {
                  break label153;
               }
