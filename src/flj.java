...
public class flj extends fmw {
   private final float a;
   private final fmr b;

   flj(fiz $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, fmr $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements flz<ip> {
      ...
      public flw a(ip $$0, fiz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == czc.a) {
            ...
            gw $$9 = gw.a($$2, $$3, $$4);
            int $$10 = eqx.O().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof cvp) {
               $$10 = ((cvp)$$8.b()).d($$8, $$1, $$9);
            }
            ...
            return new flj($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
