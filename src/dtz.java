...
public class dtz implements dty {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<dtz> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               don.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dop.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               doo.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bjg.b(1, 20).fieldOf("outer_wall_distance").orElse(bjm.a(4, 5)).forGetter($$0x -> $$0x.i),
               bjg.b(1, 20).fieldOf("distribution_points").orElse(bjm.a(3, 4)).forGetter($$0x -> $$0x.j),
               bjg.b(0, 10).fieldOf("point_offset").orElse(bjm.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dtz(don $$0, dop $$1, doo $$2, double $$3, double $$4, boolean $$5, bjg $$6, bjg $$7, bjg $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
