...
public class efo {
   ...
   private static final djf.f e = ($$0, $$1, $$2) -> $$0.a(cwr.co);
   ...
   public static Optional<efo> a(ctp $$0, hx $$1, ic.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<efo> a(ctp $$0, hx $$1, Predicate<efo> $$2, ic.a $$3) {
      Optional<efo> $$4 = Optional.of(new efo($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ic.a $$5 = $$3 == ic.a.a ? ic.a.c : ic.a.a;
         return Optional.of(new efo($$0, $$1, $$5)).filter($$2);
      }
   }

   public efo(ctp $$0, hx $$1, ic.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(djg $$0) {
      return $$0.i() || $$0.a(asg.aJ) || $$0.a(cwr.ed);
   }
   ...
   public static els a(l.a $$0, ic.a $$1, els $$2, blv $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = aun.a(aun.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         ic.a $$10 = ic.a.b;
         $$11 = aun.a(aun.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new els($$8, $$11, $$14);
   }

   public static efn a(and $$0, l.a $$1, ic.a $$2, els $$3, blu $$4, els $$5, float $$6, float $$7) {
      hx $$8 = $$1.a;
      djg $$9 = $$0.a_($$8);
      ic.a $$10 = $$9.d(djw.H).orElse(ic.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      blv $$13 = $$4.a($$4.ap());
      int $$14 = $$2 == $$10 ? 0 : 90;
      els $$15 = $$2 == $$10 ? $$5 : new els($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a / 2.0 + ($$11 - (double)$$13.a) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == ic.a.a;
      els $$20 = new els((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      els $$21 = a($$20, $$0, $$4, $$13);
      return new efn($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static els a(els $$0, and $$1, blu $$2, blv $$3) {
      if (!($$3.a > 4.0F) && !($$3.b > 4.0F)) {
         double $$4 = (double)$$3.b / 2.0;
         els $$5 = $$0.b(0.0, $$4, 0.0);
         eml $$6 = emi.a(eln.a($$5, (double)$$3.a, 0.0, (double)$$3.a).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<els> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a, (double)$$3.b, (double)$$3.a);
         Optional<els> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
