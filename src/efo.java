...
public class efo extends efs {
   public static final MapCodec<efo> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               efb.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayf.a(je.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, efo::new)
   );
   ...
   public efo(float $$0, int $$1, int $$2, efb $$3, int $$4, List<je> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(efs.a $$0, iz $$1, je $$2) {
