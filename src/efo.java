...
public class efo extends efw<efn> {
   public efo(Codec<efn> $$0) {
      super($$0);
   }

   public boolean a(efn $$0, bam $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(efr $$0, efn $$1, dzq $$2, Function<jh, jq<dik>> $$3, bam $$4, edc $$5, dgo $$6, dzp $$7) {
      int $$8 = (this.d() * 2 - 1) * 16;
   ...
   private float[] a(efr $$0, efn $$1, bam $$2) {
      int $$3 = $$0.b();
      float[] $$4 = new float[$$3];
      float $$5 = 1.0F;
   ...
   private double a(efn $$0, bam $$1, double $$2, float $$3, float $$4) {
      float $$5 = 1.0F - bae.e(0.5F - $$4 / $$3) * 2.0F;
      float $$6 = $$0.c.f + $$0.c.g * $$5;
      return (double)$$6 * $$2 * (double)bae.b($$1, 0.75F, 1.0F);
   }

   private boolean a(efr $$0, float[] $$1, double $$2, double $$3, double $$4, int $$5) {
      int $$6 = $$5 - $$0.a();
