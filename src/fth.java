...
public class fth implements ftj {
   ...
   private static final xi n = xi.c("item.minecraft.bundle.full");
   private static final xi o = xi.c("item.minecraft.bundle.empty");
   private static final xi p = xi.c("item.minecraft.bundle.empty.description");
   private final cyf q;
   ...
   @Override
   public void a(fks $$0, int $$1, int $$2, int $$3, int $$4, fku $$5) {
      if (this.q.g()) {
         this.b($$0, $$1, $$2, $$3, $$4, $$5);
      } else {
         this.c($$0, $$1, $$2, $$3, $$4, $$5);
   ...
   private void b(fks $$0, int $$1, int $$2, int $$3, int $$4, fku $$5) {
      b($$1 + this.a($$3), $$2, $$0, $$5);
      this.a($$1 + this.a($$3), $$2 + d($$0) + 4, $$0, $$5);
   }

   private void c(fks $$0, int $$1, int $$2, int $$3, int $$4, fku $$5) {
      boolean $$6 = this.q.e() > 12;
      List<cwb> $$7 = this.b(this.q.a());
      int $$8 = $$1 + this.a($$3) + 96;
      int $$9 = $$2 + this.d() * 24;
      int $$10 = 1;
   ...
   private static boolean a(List<cwb> $$0, int $$1) {
      return $$0.size() >= $$1;
   }

   private int a(List<cwb> $$0) {
      return this.q.b().skip((long)$$0.size()).mapToInt(cwb::L).sum();
   }

   private void a(int $$0, int $$1, int $$2, List<cwb> $$3, int $$4, fks $$5, fku $$6) {
      int $$7 = $$3.size() - $$0;
      boolean $$8 = $$7 == this.q.h();
      cwb $$9 = $$3.get($$7);
      if ($$8) {
         $$6.a(gir::B, d, $$1, $$2, 24, 24);
      }

      $$6.a($$9, $$1 + 4, $$2 + 4, $$4);
      $$6.a($$5, $$9, $$1 + 4, $$2 + 4);
      if ($$8) {
         $$6.a(gir::z, e, $$1, $$2, 24, 24);
      }
   }

   private static void a(int $$0, int $$1, int $$2, fks $$3, fku $$4) {
      $$4.a($$3, "+" + $$2, $$0 + 12, $$1 + 10, 16777215);
   }

   private void a(fks $$0, fku $$1, int $$2, int $$3, int $$4) {
      if (this.q.i()) {
         cwb $$5 = this.q.a(this.q.h());
         xi $$6 = $$5.A();
         int $$7 = $$0.a($$6.g());
         int $$8 = $$2 + $$4 / 2 - 12;
   ...
   private void a(int $$0, int $$1, fks $$2, fku $$3) {
      $$3.a(gir::B, this.g(), $$0 + 1, $$1, this.f(), 13);
      $$3.a(gir::B, a, $$0, $$1, 96, 13);
      xi $$4 = this.h();
      if ($$4 != null) {
   ...
   private static void b(int $$0, int $$1, fks $$2, fku $$3) {
      $$3.a($$2, p, $$0, $$1, 96, 11184810);
   }

   private static int d(fks $$0) {
      return $$0.c(p, 96).size() * 9;
   }

   private int f() {
      return azk.a(azk.a(this.q.f(), 94), 0, 94);
   }
