...
public class fth extends ful {
   ...
   protected void aR_() {
      ...
      this.b = new fpc(this.m.i, 4, this.o - 12, this.n - 4, 12, wp.c("chat.editBox")) {
         @Override
         protected xd d() {
            return super.d().b(fth.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fow(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   protected void a(fsq $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fsp.a, wp.a("chat_screen.message", $$1));
      }
   }
