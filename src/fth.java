...
public class fth<T extends bsw> extends ful<T> {
   private final fxc a;
   private final fxc[] b;
   private final fxc f;
   ...
   public static fxi b() {
      fxk $$0 = new fxk();
      fxl $$1 = $$0.a();
      $$1.a("head", fxh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fxe.a);
      float $$2 = 0.0F;
      fxh $$3 = fxh.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = ayz.b($$2) * 9.0F;
         float $$6 = -2.0F + ayz.b((float)($$4 * 2) * 0.25F);
         float $$7 = ayz.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, fxe.a($$5, $$6, $$7));
         $$2++;
      }
