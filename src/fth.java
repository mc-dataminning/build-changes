public class fth<T extends ceh> extends ftl<T> {
   public fth(fvb $$0) {
   ...
   public static fvh c() {
      ...
      $$1.a(
         ...
         fvd.a(0.0F, 10.0F, -16.0F)
      );
      $$1.a(
         "body",
         fvg.c().a(0, 19).a(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).a(39, 0).a(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F),
         fvd.a(-2.0F, 9.0F, 12.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
      );
      int $$2 = 10;
      fvg $$3 = fvg.c().a(50, 22).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 8.0F);
      $$1.a("right_hind_leg", $$3, fvd.a(-4.5F, 14.0F, 6.0F));
      $$1.a("left_hind_leg", $$3, fvd.a(4.5F, 14.0F, 6.0F));
      fvg $$4 = fvg.c().a(50, 40).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 6.0F);
      $$1.a("right_front_leg", $$4, fvd.a(-3.5F, 14.0F, -8.0F));
      $$1.a("left_front_leg", $$4, fvd.a(3.5F, 14.0F, -8.0F));
