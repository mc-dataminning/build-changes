...
public class cee {
   ...
   private int g = aui.b(aup.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ja.a.fieldOf("uuid").forGetter(Pair::getFirst), atq.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<blp> j;
   @VisibleForTesting
   protected final ArrayList<blp> c;
   private final cee.a k;
   @VisibleForTesting
   protected final Object2IntMap<blp> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cee> a(Predicate<blp> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cee::b)).apply($$1, $$1x -> new cee($$0, $$1x))
      );
   }

   public cee(Predicate<blp> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cee.a(this);
   ...
   public void a(amz $$0, Predicate<blp> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<blp>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<blp> $$6 = (Entry<blp>)$$5.next();
         int $$7 = $$6.getIntValue();
         blp $$8 = (blp)$$6.getKey();
         blp.c $$9 = $$8.dI();
   ...
   public int b(@Nullable blp $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bmf> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bmf).map($$0 -> (bmf)$$0);
   }

   @VisibleForTesting
   protected static record a(cee a) implements Comparator<blp> {
      public int a(blp $$0, blp $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cfb;
               boolean $$7 = $$1 instanceof cfb;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
