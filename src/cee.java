...
public class cee {
   ...
   public cee a(@Nullable Predicate<btn> $$0) {
      this.g = $$0;
      return this;
   }
   ...
   public boolean a(@Nullable btn $$0, btn $$1) {
      if ($$0 == $$1) {
         ...
         if ($$0 == null) {
            ...
            if (this.e && $$0 instanceof btp $$5 && !$$5.M().a($$1)) {
               return false;
            }
         }
