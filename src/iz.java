...
public class iz implements it {
   public static final Codec<iz> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(djr.b.fieldOf("destination").forGetter($$0x -> $$0x.c), Codec.INT.fieldOf("arrival_in_ticks").forGetter($$0x -> $$0x.d))
            .apply($$0, iz::new)
   );
