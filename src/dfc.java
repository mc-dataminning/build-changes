...
public class dfc extends cuu {
   ...
   private void a(cpv $$0, gw $$1, dfj $$2) {
      ...
      if ($$4 && !$$2.c(b)) {
         ...
         dfj $$6 = $$0.a_($$5);
         int $$7 = 1;
         if ($$6.a(csw.bQ) && $$6.c(a) == $$3 && $$0.c_($$5) instanceof dff $$9 && $$9.c() && ($$9.a(0.0F) < 0.5F || $$0.V() == $$9.v() || ((akr)$$0).c())) {
            $$7 = 2;
         }
   ...
   private boolean a(cql $$0, gw $$1, hc $$2) {
      for (hc $$3 : hc.values()) {
         if ($$3 != $$2 && $$0.b($$1.a($$3), $$3)) {
            return true;
         }
   ...
   public boolean a(dfj $$0, cpv $$1, gw $$2, int $$3, int $$4) {
      ...
      if ($$3 == 0) {
         ...
         $$1.a($$2, $$6, 67);
         $$1.a(null, $$2, ape.so, apf.e, 0.5F, $$1.z.i() * 0.25F + 0.6F);
         ...
         $$1.a($$2, $$9, 20);
         $$1.a(dfb.a($$2, $$9, this.n().a(a, hc.a($$4 & 7)), $$5, false, true));
         $$1.b($$2, $$9.b());
         $$9.a($$1, $$2, 2);
         if (this.m) {
         ...
         $$1.a(null, $$2, ape.sn, apf.e, 0.5F, $$1.z.i() * 0.15F + 0.6F);
   ...
   public static boolean a(dfj $$0, cpv $$1, gw $$2, hc $$3, boolean $$4, hc $$5) {
   ...
   private boolean a(cpv $$0, gw $$1, hc $$2, boolean $$3) {
      gw $$4 = $$1.a($$2);
