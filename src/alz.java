...
public class alz {
   ...
   private Optional<alz.a> b(Scanner $$0) {
      akt<dgz> $$1 = (akt<dgz>)ami.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new alz.a($$1, new fbx((double)$$2, (double)$$3, (double)$$4), new fbw($$6, $$5)));
      }
   }
   ...
   private void b(String $$0) {
      this.e.execute(() -> {
         ...
         if (!$$1.isEmpty()) {
            are $$2 = $$1.get(0);
            ard $$3 = this.e.J();
            ex $$4 = new ex($$2.z(), fbx.a($$3.aa()), fbw.a, $$3, 4, "", wo.a, this.e, $$2);
            ey $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(akt<dgz> a, fbx b, fbw c) {
   }
}
