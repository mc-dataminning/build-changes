...
public class alz {
   ...
   private final Queue<alz.a> b = new axw<>();
   private final Object2IntLinkedOpenHashMap<alz.b> c = new Object2IntLinkedOpenHashMap();
   ...
   public synchronized void a(String $$0, Throwable $$1) {
      ...
      this.b.add(new alz.a($$2, $$0, (Class<? extends Throwable>)$$1.getClass(), $$3));

      while (this.b.size() > 8) {
         this.b.remove();
      }

      alz.b $$4 = new alz.b($$0, (Class<? extends Throwable>)$$1.getClass());
   ...
   public synchronized String a() {
      ...
      if (!this.c.isEmpty()) {
         ...
         while (var6.hasNext()) {
            Entry<alz.b> $$3 = (Entry<alz.b>)var6.next();
            $$1.append("\t\t\t")
               .append(((alz.b)$$3.getKey()).a)
               .append(":")
               .append(((alz.b)$$3.getKey()).b)
               .append(" x ")
