...
public class alz extends fgh {
   public static final eyn<fgi> a = new eyn<>("scoreboard", $$0 -> $$0.a().g().h(), $$0 -> {
      alz $$1 = $$0.a().g();
      return fgi.a.a.xmap($$1::a, fgi::a);
   }, bbb.n);
   private final MinecraftServer c;
   private final Set<ffz> d = Sets.newHashSet();
   ...
   public List<zf<?>> d(ffz $$0) {
      List<zf<?>> $$1 = Lists.newArrayList();
      $$1.add(new afk($$0, 0));

      for (ffy $$2 : ffy.values()) {
         if (this.a($$2) == $$0) {
            $$1.add(new afc($$2, $$0));
         }
      }
