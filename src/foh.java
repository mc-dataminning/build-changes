...
public class foh extends fny<cpo> {
   ...
   protected void a(fhf $$0, float $$1, int $$2, int $$3) {
      ...
      cuc $$6 = this.w.b(1).g();
      boolean $$7 = $$6.a(cuf.uj);
      boolean $$8 = $$6.a(cuf.qO);
      boolean $$9 = $$6.a(cuf.fT);
      cuc $$10 = this.w.b(0).g();
      epu $$11 = $$10.a(kn.B);
      boolean $$12 = false;
      epw $$13;
      if ($$11 != null) {
         $$13 = cuk.a($$11, this.l.r);
         if ($$13 != null) {
            if ($$13.h) {
               $$12 = true;
               if ($$8 || $$9) {
   ...
   private void a(fhf $$0, @Nullable epu $$1, @Nullable epw $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.z;
      int $$8 = this.A;
      if ($$4 && !$$6) {
   ...
   private void a(fhf $$0, @Nullable epu $$1, @Nullable epw $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
