...
public class foh {
   private static final Map<String, foh.a> a = Maps.newHashMap();
   ...
   private static alg b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            alg $$4 = hjf.c();
            a.put($$0, new foh.a($$1, $$4));
            return $$4;
         } else {
            alg $$5 = alg.a("realms", "dynamic/" + $$0);
            fpt.Q().aa().a($$5, new hjd($$5::toString, $$3));
            a.put($$0, new foh.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static fiz a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return fiz.a($$2.put($$1).flip());
