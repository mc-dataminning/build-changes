public abstract class foh extends fop {
   ...
   private static final fqf a = new fqf(aku.b("widget/button"), aku.b("widget/button_disabled"), aku.b("widget/button_highlighted"));

   public foh(int $$0, int $$1, int $$2, int $$3, wo $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
