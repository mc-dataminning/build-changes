...
public class foh implements AutoCloseable {
   ...
   public foh(fzf $$0, ant $$1, ekb $$2, aew $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(fzf $$0, aew $$1) throws IOException, JsonSyntaxException {
      anr $$2 = this.c.getResourceOrThrow($$1);

      try {
         try (Reader $$3 = $$2.e()) {
            JsonObject $$4 = arn.a($$3);
            if (arn.d($$4, "targets")) {
   ...
   private void a(JsonElement $$0) throws aez {
      if (arn.a($$0)) {
         this.a($$0.getAsString(), this.i, this.j);
      } else {
         JsonObject $$1 = arn.m($$0, "target");
         String $$2 = arn.i($$1, "name");
         int $$3 = arn.a($$1, "width", this.i);
         int $$4 = arn.a($$1, "height", this.j);
         if (this.f.containsKey($$2)) {
            throw new aez($$2 + " is already defined");
         }
   ...
   private void a(fzf $$0, JsonElement $$1) throws IOException {
      JsonObject $$2 = arn.m($$1, "pass");
      String $$3 = arn.i($$2, "name");
      String $$4 = arn.i($$2, "intarget");
      String $$5 = arn.i($$2, "outtarget");
      ekb $$6 = this.b($$4);
      ekb $$7 = this.b($$5);
      if ($$6 == null) {
         throw new aez("Input target '" + $$4 + "' does not exist");
      } else if ($$7 == null) {
         throw new aez("Output target '" + $$5 + "' does not exist");
      } else {
         foi $$8 = this.a($$3, $$6, $$7);
         JsonArray $$9 = arn.a($$2, "auxtargets", null);
         if ($$9 != null) {
            int $$10 = 0;

            for (JsonElement $$11 : $$9) {
               try {
                  JsonObject $$12 = arn.m($$11, "auxtarget");
                  String $$13 = arn.i($$12, "name");
                  String $$14 = arn.i($$12, "id");
                  boolean $$15;
                  String $$16;
                  ...
                  if ($$19 == null) {
                     if ($$15) {
                        throw new aez("Render target '" + $$16 + "' can't be used as depth buffer");
                     }

                     aew $$20 = new aew("textures/effect/" + $$16 + ".png");
                     this.c.getResource($$20).orElseThrow(() -> new aez("Render target or texture '" + $$16 + "' does not exist"));
                     RenderSystem.setShaderTexture(0, $$20);
                     $$0.a($$20);
                     fyp $$21 = $$0.b($$20);
                     int $$22 = arn.o($$12, "width");
                     int $$23 = arn.o($$12, "height");
                     boolean $$24 = arn.k($$12, "bilinear");
                     if ($$24) {
         ...
         JsonArray $$27 = arn.a($$2, "uniforms", null);
         if ($$27 != null) {
            int $$28 = 0;
   ...
   private void b(JsonElement $$0) throws aez {
      ...
      if ($$3 == null) {
         throw new aez("Uniform '" + $$2 + "' does not exist");
      } else {
         float[] $$4 = new float[4];
         int $$5 = 0;

         for (JsonElement $$7 : arn.v($$1, "values")) {
            try {
               $$4[$$5] = arn.e($$7, "value");
