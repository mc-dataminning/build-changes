...
public class foh {
   ...
   private foh(int $$0, List<foj> $$1) {
      this.a = $$1.toArray(foj[]::new);
      this.b = $$1.size();
   }

   private List<foj> c() {
      List<foj> $$0 = new ArrayList<>(this.d());
