...
public class brb {
   ...
   public static Codec<brb> a(Runnable $$0) {
      return RecordCodecBuilder.create(
            $$1 -> $$1.group(
                     ...
                     bra.a($$0).listOf().fieldOf("Records").forGetter($$0xx -> ImmutableList.copyOf($$0xx.b.values()))
                  )
                  .apply($$1, brb::new)
         )
         .orElseGet(ac.a("Failed to read POI section: ", a::error), () -> new brb($$0, false, ImmutableList.of()));
   }
   ...
   public Stream<bra> a(Predicate<he<brc>> $$0, bqz.b $$1) {
      return this.c.entrySet().stream().filter($$1x -> $$0.test((he<brc>)$$1x.getKey())).flatMap($$0x -> ((Set)$$0x.getValue()).stream()).filter($$1.a());
   }

   public void a(gu $$0, he<brc> $$1) {
      if (this.a(new bra($$0, $$1, this.d))) {
         a.debug("Added POI of type {} @ {}", $$1.e().map($$0x -> $$0x.a().toString()).orElse("[unregistered]"), $$0);
         this.d.run();
      }
   }

   private boolean a(bra $$0) {
      gu $$1 = $$0.f();
      he<brc> $$2 = $$0.g();
      short $$3 = hx.b($$1);
   ...
   public void a(Consumer<BiConsumer<gu, he<brc>>> $$0) {
      if (!this.e) {
         Short2ObjectMap<bra> $$1 = new Short2ObjectOpenHashMap(this.b);
         this.b();
         $$0.accept(($$1x, $$2) -> {
            short $$3 = hx.b($$1x);
            bra $$4 = (bra)$$1.computeIfAbsent($$3, $$2x -> new bra($$1x, $$2, this.d));
            this.a($$4);
         });
         this.e = true;
         this.d.run();
