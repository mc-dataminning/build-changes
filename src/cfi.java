...
public class cfi extends cea {
   private static final cht c = cht.b().d();
   private final cht d;
   ...
   private int k;
   private boolean l;
   private final Predicate<czd> m;
   private final boolean n;

   public cfi(bxm $$0, double $$1, Predicate<czd> $$2, boolean $$3) {
      this.a = $$0;
      this.e = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean b() {
      if (this.k > 0) {
         ...
         this.b = a(this.a).a(this.d.a(this.a.h(byk.E)), this.a);
         return this.b != null;
      }
   }
