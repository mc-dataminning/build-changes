...
public abstract class cfi extends bml {
   private static final Logger b = LogUtils.getLogger();
   public static final int bA = 16;
   public static final bmf bB = bmf.b;
   ...
   public static final blw bL = blw.b(0.6F, 1.8F);
   private static final Map<bmx, blw> c = ImmutableMap.builder()
      .put(bmx.a, bL)
      .put(bmx.c, v)
      .put(bmx.b, blw.b(0.6F, 0.6F))
      .put(bmx.d, blw.b(0.6F, 0.6F))
      .put(bmx.e, blw.b(0.6F, 0.6F))
      .put(bmx.f, blw.b(0.6F, 1.5F))
      .put(bmx.h, blw.c(0.2F, 0.2F))
      .build();
   private static final agm<Float> d = agp.a(cfi.class, ago.d);
   private static final agm<Integer> e = agp.a(cfi.class, ago.b);
   protected static final agm<Byte> bM = agp.a(cfi.class, ago.a);
   protected static final agm<Byte> bN = agp.a(cfi.class, ago.a);
   protected static final agm<sn> bO = agp.a(cfi.class, ago.s);
   protected static final agm<sn> bP = agp.a(cfi.class, ago.s);
   private long f;
   private final cfh cm = new cfh(this);
   protected cjn bQ = new cjn();
   public final cjc bR;
   public cib bS;
   protected chx bT = new chx();
   protected int bU;
   public float bV;
   public float bW;
   public int bX;
   ...
   private boolean cr;
   private cmy cs = cmy.f;
   private final cmu ct = this.k();
   private Optional<ig> cu = Optional.empty();
   @Nullable
   public cfw ck;
   protected float cl;

   public cfi(ctp $$0, hx $$1, float $$2, GameProfile $$3) {
      super(blz.bv, $$0);
      this.a_($$3.getId());
      this.cq = $$3;
      this.bR = new cjc(this.cm, !$$0.B, this);
      this.bS = this.bR;
      this.b((double)$$1.u() + 0.5, (double)($$1.v() + 1), (double)$$1.w() + 0.5, $$2, 0.0F);
      this.bg = 180.0F;
   }

   public boolean a(ctp $$0, hx $$1, ctm $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == ctm.d) {
         return true;
         ...
         cmy $$3 = this.eT();
         return $$3.b() || !$$3.b($$0.I_().d(ke.f), new djl($$0, $$1, false));
      }
   }

   public static bnq.a fH() {
      return bml.dQ().a(bnr.c, 1.0).a(bnr.m, 0.1F).a(bnr.e).a(bnr.j);
   }
   ...
   public void l() {
      ...
      int $$0 = 29999999;
      double $$1 = auo.a(this.dr(), -2.9999999E7, 2.9999999E7);
      double $$2 = auo.a(this.dx(), -2.9999999E7, 2.9999999E7);
   ...
   protected boolean fL() {
      this.ce = this.a(asm.a);
      return this.ce;
   }

   private void u() {
      cmy $$0 = this.c(bma.f);
      if ($$0.a(cnb.on) && !this.a(asm.a)) {
         this.b(new bli(blk.m, 200, 0, false, false, true));
      }
   }
   ...
   protected boolean g(bmx $$0) {
      return this.dM().a(this, this.a($$0).a(this.dk()).h(1.0E-7));
   }

   @Override
   public int ax() {
      return Math.max(1, this.dM().Z().c(this.co.a ? ctl.F : ctl.E));
   }
   ...
   public void d_() {
      ...
      if (this.dM().ak() == bjy.a && this.dM().Z().b(ctl.k)) {
      ...
      if (this.ev() > 0.0F && !this.P_()) {
         ...
         List<blv> $$4 = this.dM().a_(this, $$2);
         List<blv> $$5 = Lists.newArrayList();
   ...
   private void c(@Nullable sn $$0) {
      if ($$0 != null && (!$$0.e("Silent") || !$$0.q("Silent")) && this.dM().z.a(200) == 0) {
         String $$1 = $$0.l("id");
         blz.a($$1).filter($$0x -> $$0x == blz.au).ifPresent($$0x -> {
            if (!byo.a(this.dM(), this)) {
               this.dM().a(null, this.dr(), this.dt(), this.dx(), byo.a(this.dM(), this.dM().z), this.db(), 1.0F, byo.a(this.dM().z));
            }
         });
      }
   }
   ...
   public void a(bkt $$0) {
      ...
      if ($$0 != null) {
         this.o(
            (double)(-auo.b((this.eE() + this.dC()) * (float) (Math.PI / 180.0)) * 0.1F),
            0.1F,
            (double)(-auo.a((this.eE() + this.dC()) * (float) (Math.PI / 180.0)) * 0.1F)
         );
      } else {
         this.o(0.0, 0.1, 0.0);
      }
   ...
   public cbu a(cmy $$0, boolean $$1, boolean $$2) {
      if ($$0.b()) {
         ...
         cbu $$4 = new cbu(this.dM(), this.dr(), $$3, this.dx(), $$0);
         $$4.b(40);
         if ($$2) {
            $$4.a(this);
         }
         ...
         if ($$1) {
            ...
            $$4.o((double)(-auo.a($$6) * $$5), 0.2F, (double)(auo.b($$6) * $$5));
         } else {
            float $$7 = 0.3F;
            float $$8 = auo.a(this.dE() * (float) (Math.PI / 180.0));
            float $$9 = auo.b(this.dE() * (float) (Math.PI / 180.0));
   ...
   public float d(djh $$0) {
      ...
      if (blj.a(this)) {
         $$1 *= 1.0F + (float)(blj.b(this) + 1) * 0.2F;
      }

      if (this.a(blk.d)) {
         $$1 *= switch (this.b(blk.d).e()) {
            case 0 -> 0.3F;
            case 1 -> 0.09F;
            case 2 -> 0.0027F;
            default -> 8.1E-4F;
   ...
   public void a(sn $$0) {
      ...
      this.bT.a($$0);
      this.co.b($$0);
      this.a(bnr.m).a((double)this.co.b());
      if ($$0.b("EnderItems", 9)) {
   ...
   public boolean b(bkt $$0) {
      if (super.b($$0)) {
         ...
         return !this.dM().Z().b(ctl.G);
      } else if ($$0.a(asj.n)) {
         return !this.dM().Z().b(ctl.H);
      } else if ($$0.a(asj.j)) {
         return !this.dM().Z().b(ctl.I);
      } else {
         return $$0.a(asj.p) ? !this.dM().Z().b(ctl.J) : false;
      }
   }
   ...
   protected void f(bkt $$0, float $$1) {
      if (!this.b($$0)) {
         ...
         if ($$3 > 0.0F && $$3 < 3.4028235E37F) {
            this.a(asc.L, Math.round($$3 * 10.0F));
         }
         ...
         if (var7 != 0.0F) {
            ...
            if (var7 < 3.4028235E37F) {
               this.a(asc.J, Math.round(var7 * 10.0F));
            }
   ...
   public bkb a(blv $$0, bka $$1) {
      if (this.P_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.b() && $$0 instanceof bml) {
               if (this.co.d) {
                  $$2 = $$3;
               }

               bkb $$5 = $$2.a(this, (bml)$$0, $$1);
               if ($$5.a()) {
                  this.dM().a(dnr.r, $$0.dk(), dnr.a.a(this));
                  if ($$2.b() && !this.co.d) {
                     this.a($$1, cmy.f);
                  }
   ...
   protected elt a(elt $$0, bmr $$1) {
      if (!this.co.b && $$0.d <= 0.0 && ($$1 == bmr.a || $$1 == bmr.b) && this.fK() && this.A()) {
         double $$2 = $$0.c;
         double $$3 = $$0.e;
         double $$4 = 0.05;
   ...
   public void d(blv $$0) {
      if ($$0.cq()) {
         if (!$$0.u(this)) {
            ...
            float $$2;
            if ($$0 instanceof bml) {
               $$2 = crl.a(this.eT(), ((bml)$$0).eS());
            } else {
               $$2 = crl.a(this.eT(), bmq.a);
            }
            ...
            if ($$1 > 0.0F || $$2 > 0.0F) {
               ...
               $$7 += crl.c(this);
               if (this.bY() && $$5) {
                  this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.tf, this.db(), 1.0F, 1.0F);
                  $$7++;
                  $$6 = true;
               }

               boolean $$8 = $$5 && this.ab > 0.0F && !this.aC() && !this.e_() && !this.aZ() && !this.a(blk.o) && !this.bO() && $$0 instanceof bml;
               $$8 = $$8 && !this.bY();
               if ($$8) {
                  $$1 *= 1.5F;
               }
               ...
               if ($$16) {
                  if ($$7 > 0) {
                     if ($$0 instanceof bml) {
                        ((bml)$$0)
                           .q(
                              (double)((float)$$7 * 0.5F),
                              (double)auo.a(this.dC() * (float) (Math.PI / 180.0)),
                              (double)(-auo.b(this.dC() * (float) (Math.PI / 180.0)))
                           );
                     } else {
                        $$0.j(
                           (double)(-auo.a(this.dC() * (float) (Math.PI / 180.0)) * (float)$$7 * 0.5F),
                           0.1,
                           (double)(auo.b(this.dC() * (float) (Math.PI / 180.0)) * (float)$$7 * 0.5F)
                        );
                     }
                  ...
                  if ($$9) {
                     float $$17 = 1.0F + crl.a(this) * $$1;

                     for (bml $$19 : this.dM().a(bml.class, $$0.cH().c(1.0, 0.25, 1.0))) {
                        if ($$19 != this && $$19 != $$0 && !this.s($$19) && (!($$19 instanceof cbk) || !((cbk)$$19).A()) && this.f($$19) < 9.0) {
                           $$19.q(0.4F, (double)auo.a(this.dC() * (float) (Math.PI / 180.0)), (double)(-auo.b(this.dC() * (float) (Math.PI / 180.0))));
                           $$19.a(this.dN().a(this), $$17);
                        }
                     }

                     this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.ti, this.db(), 1.0F, 1.0F);
                     this.fP();
                  }
                  ...
                  if ($$8) {
                     this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.te, this.db(), 1.0F, 1.0F);
                     this.a($$0);
                  }

                  if (!$$8 && !$$9) {
                     if ($$5) {
                        this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.th, this.db(), 1.0F, 1.0F);
                     } else {
                        this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.tj, this.db(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  if (!this.dM().B && !$$20.b() && $$21 instanceof bml) {
                     $$20.a((bml)$$21, this);
                     if ($$20.b()) {
                        this.a(bka.a, cmy.f);
                     }
                  ...
                  if ($$0 instanceof bml) {
                     float $$22 = $$12 - ((bml)$$0).ev();
                     this.a(asc.G, Math.round($$22 * 10.0F));
                     if ($$14 > 0) {
                        $$0.g($$14 * 4);
                     }
                  ...
                  this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.tg, this.db(), 1.0F, 1.0F);
                  if ($$13) {
                     $$0.aA();
                  }
               }
   ...
   public void s(boolean $$0) {
      float $$1 = 0.25F + (float)crl.g(this) * 0.05F;
      if ($$0) {
         $$1 += 0.75F;
      }

      if (this.ag.i() < $$1) {
         this.gn().a(cnb.vl, 100);
         this.ft();
   ...
   public void fP() {
      double $$0 = (double)(-auo.a(this.dC() * (float) (Math.PI / 180.0)));
      double $$1 = (double)auo.b(this.dC() * (float) (Math.PI / 180.0));
   ...
   public static Optional<elt> a(and $$0, hx $$1, float $$2, boolean $$3, boolean $$4) {
      djh $$5 = $$0.a_($$1);
      cwq $$6 = $$5.b();
      if ($$6 instanceof dcx && ($$3 || $$5.c(dcx.d) > 0) && dcx.a($$0)) {
         Optional<elt> $$7 = dcx.a(blz.bv, $$0, $$1);
         if (!$$3 && !$$4 && $$7.isPresent()) {
            $$0.a($$1, $$5.a(dcx.d, Integer.valueOf($$5.c(dcx.d) - 1)), 3);
         }

         return $$7;
      } else if ($$6 instanceof cwj && cwj.a($$0)) {
         return cwj.a(blz.bv, $$0, $$1, $$5.c(cwj.aE), $$2);
      } else if (!$$3) {
         ...
         djh $$9 = $$0.a_($$1.c());
         boolean $$10 = $$9.b().a($$9);
         return $$8 && $$10 ? Optional.of(new elt((double)$$1.u() + 0.5, (double)$$1.v() + 0.1, (double)$$1.w() + 0.5)) : Optional.empty();
      }
   }
   ...
   public boolean a(float $$0, float $$1, bkt $$2) {
      if (this.co.c) {
         ...
         if ($$0 >= 2.0F) {
            this.a(asc.t, (int)Math.round((double)$$0 * 100.0));
         }
   ...
   public boolean fX() {
      if (!this.aC() && !this.fw() && !this.aZ() && !this.a(blk.y)) {
         cmy $$0 = this.c(bma.e);
         if ($$0.a(cnb.nS) && cls.d($$0)) {
            this.fY();
            return true;
         }
      }
   ...
   @Override
   public bml.a eG() {
      return new bml.a(ars.tu, ars.tk);
   }
   ...
   public void d(int $$0) {
      ...
      this.cg = auo.a(this.cg + $$0, 0, Integer.MAX_VALUE);
   ...
   public void c(int $$0) {
      ...
      if ($$0 > 0 && this.cf % 5 == 0 && (float)this.cp < (float)this.ah - 100.0F) {
         ...
         this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.tt, this.db(), $$1 * 0.75F, 1.0F);
         this.cp = this.ah;
      }
   }
   ...
   public boolean a(hx $$0, ic $$1, cmy $$2) {
      if (this.co.e) {
         return true;
      } else {
         hx $$3 = $$0.a($$1.g());
         djl $$4 = new djl(this.dM(), $$3, false);
   ...
   @Override
   protected blv.b aW() {
      return this.co.b || this.aC() && this.bV() ? blv.b.a : blv.b.d;
   }
   ...
   public cmy c(bma $$0) {
      if ($$0 == bma.a) {
         ...
         return $$0.a() == bma.a.b ? this.cm.j.get($$0.b()) : cmy.f;
      }
   }
   ...
   public Iterable<cmy> bK() {
      return Lists.newArrayList(new cmy[]{this.eT(), this.eU()});
   }
   ...
   private void k(sn $$0) {
      if (!this.dM().B && !$$0.g()) {
         blz.a($$0, this.dM()).ifPresent($$0x -> {
            if ($$0x instanceof bng) {
               ((bng)$$0x).b(this.ay);
            }
   ...
   public bnd a_(int $$0) {
      if ($$0 >= 0 && $$0 < this.cm.i.size()) {
         return bnd.a(this.cm, $$0);
      } else {
         int $$1 = $$0 - 200;
         return $$1 >= 0 && $$1 < this.bQ.b() ? bnd.a(this.bQ, $$1) : super.a_($$0);
      }
   }
   ...
   @Override
   public bmf fm() {
      return this.an.b(bN) == 0 ? bmf.a : bmf.b;
   }

   public void a(bmf $$0) {
      this.an.b(bN, (byte)($$0 == bmf.a ? 0 : 1));
   }
   ...
   public float gl() {
      return (float)(1.0 / this.b(bnr.e) * 20.0);
   }

   public float B(float $$0) {
      return auo.a(((float)this.aP + $$0) / this.gl(), 0.0F, 1.0F);
   }
   ...
   public ImmutableList<bmx> fA() {
      return ImmutableList.of(bmx.a, bmx.f, bmx.d);
   }
   ...
   public cmy g(cmy $$0) {
      if (!($$0.d() instanceof cno)) {
         ...
         if (!$$2.b()) {
            ...
            return this.co.d ? new cmy(cnb.os) : cmy.f;
         }
      }
   }
   ...
   public cmy a(ctp $$0, cmy $$1) {
      this.gc().a($$1.d(), $$1);
      this.b(asc.c.b($$1.d()));
      $$0.a(null, this.dr(), this.dt(), this.dx(), ars.tm, art.h, 0.5F, $$0.z.i() * 0.1F + 0.9F);
   ...
   public elt q(float $$0) {
      double $$1 = 0.22 * (this.fm() == bmf.b ? -1.0 : 1.0);
      float $$2 = auo.i($$0 * 0.5F, this.dE(), this.O) * (float) (Math.PI / 180.0);
      float $$3 = auo.i($$0, this.aV, this.aU) * (float) (Math.PI / 180.0);
      if (this.fw() || this.fj()) {
         elt $$4 = this.f($$0);
         elt $$5 = this.dp();
         double $$6 = $$5.i();
         ...
         return this.l($$0).e(new elt($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.ca()) {
         return this.l($$0).e(new elt($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cH().c() - 1.0;
         double $$13 = this.bX() ? -0.2 : 0.07;
         return this.l($$0).e(new elt($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean gq() {
      return this.fn() && this.fp().a(cnb.qU);
   }
