...
public class bci extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bjb.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bjb.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bjb.s);
