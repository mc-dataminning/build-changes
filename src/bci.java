   ...
   private <TE> TypeRewriteRule a(Type<?> $$0, ListType<TE> $$1) {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhere(
            "InjectBedBlockEntityType", this.getInputSchema().findChoiceType(bhw.s), this.getOutputSchema().findChoiceType(bhw.s), $$0x -> $$0xx -> $$0xx
         ),
         this.fixTypeEverywhereTyped(
            "BedBlockEntityInjecter",
            this.getOutputSchema().getType(bhw.c),
            $$3x -> {
