...
public class fqh {
   ...
   public fqh(Runnable $$0, Function<atw, ale> $$1, atz $$2, Consumer<atz> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fqh.a> a() {
      return this.c.stream().map($$0 -> new fqh.d($$0));
   }

   public Stream<fqh.a> b() {
      return this.b.stream().map($$0 -> new fqh.c($$0));
   }
   ...
   abstract class b implements fqh.a {
      private final atw b;
      ...
      @Override
      public ale a() {
         return fqh.this.d.apply(this.b);
      }
