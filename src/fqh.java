...
public abstract class fqh<E extends fqh.a<E>> extends fqe {
   private static final ald a = ald.b("textures/gui/menu_list_background.png");
   private static final ald m = ald.b("textures/gui/inworld_menu_list_background.png");
   protected final fnd c;
   protected final int d;
   private final List<E> n = new fqh.b();
   ...
   public fqh(fnd $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wu.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fqh(fnd $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(fpz $$0) {
      ald $$1 = this.c.s == null ? fwf.h : fwf.j;
      ald $$2 = this.c.s == null ? fwf.i : fwf.k;
      $$0.a(goi::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(goi::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(fpz $$0) {
      ald $$1 = this.c.s == null ? a : m;
      $$0.a(goi::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(fpz $$0) {
   ...
   @Override
   public Optional<fsk> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fus $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fus $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fui.a w() {
      if (this.aI_()) {
         ...
         return this.q != null ? fui.a.b : fui.a.a;
      }
   }
   ...
   protected void a(fuk $$0, E $$1) {
      List<E> $$2 = this.aD_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fuj.b, wv.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fqh.a<E>> implements fsk {
      @Deprecated
      fqh<E> a;
      ...
      public abstract void a(fpz var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
