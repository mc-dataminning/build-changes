...
public class fqh extends fgg<fqf> {
   private final fqi a;
   private final List<fqf> m = Lists.newArrayList();
   @Nullable
   private String n;

   public fqh(fqi $$0, feb $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.a = $$0;
   }
      ...
      for (GameProfile $$3 : a(this.c.aZ().b())) {
         ...
         if ($$1) {
            $$4 = $$0.computeIfAbsent($$3.getId(), $$1x -> {
               fqf $$2 = new fqf(this.c, this.a, $$3.getId(), $$3.getName(), this.c.am().a($$3), true);
               $$2.c(true);
               return $$2;
            });
         } else {
   ...
   public void a(fxc $$0, fqi.a $$1) {
      ...
      if (($$1 == fqi.a.a || this.c.aM().c($$2)) && (Strings.isNullOrEmpty(this.n) || $$0.a().getName().toLowerCase(Locale.ROOT).contains(this.n))) {
         boolean $$4 = $$0.d();
