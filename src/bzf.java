public abstract class bzf extends bzo {
   protected bss d;
   protected io e = io.c;
   protected boolean f;
   private boolean a;
   ...
   protected boolean h() {
      if (!this.f) {
         ...
         drd $$0 = this.d.dP().a_(this.e);
         if (!($$0.b() instanceof dgg)) {
            this.f = false;
            return false;
         } else {
            return $$0.c(dgg.c);
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         drd $$1 = this.d.dP().a_(this.e);
         if ($$1.b() instanceof dgg) {
            ((dgg)$$1.b()).a(this.d, this.d.dP(), $$1, this.e, $$0);
         }
      }
   }
