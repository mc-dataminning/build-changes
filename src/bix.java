...
public interface bix<T, F> {
   ...
   public static final class a implements bix<bix.b, Runnable> {
   ...
   public static final class c<T> implements bix<T, T> {
