...
public class dmp extends dms<dmo> {
   public dmp(Codec<dmo> $$0) {
      super($$0);
   }

   public boolean a(dmo $$0, arx $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dmn $$0, dmo $$1, dha $$2, Function<gw, hg<cqo>> $$3, arx $$4, djz $$5, cox $$6, dgz $$7) {
      int $$8 = hz.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dms.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dmn $$0, dmo $$1, dha $$2, Function<gw, hg<cqo>> $$3, djz $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dgz $$10, dms.a $$11
   ) {
      double $$12 = 1.5 + (double)(ars.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(ars.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = ars.b($$13);
         $$6 += (double)(ars.b($$12) * $$27);
         $$7 += (double)ars.a($$13);
         $$8 += (double)(ars.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
