...
public class dmp implements dml, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final biv<bix.b> c;
   private final dms d;
   private final Map<cte, dmp.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dmp(Path $$0, boolean $$1, String $$2) {
      this.d = new dms($$0, $$1);
      this.c = new biv<>(new bix.a(dmp.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(cte $$0, int $$1) {
      cte $$2 = new cte($$0.e - $$1, $$0.f - $$1);
      cte $$3 = new cte($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         cte $$3 = cte.b($$0, $$1);
         BitSet $$4 = new BitSet();
         cte.a($$2, $$3).forEach($$1xx -> {
            ts $$2x = new ts(new tu(st.a, "DataVersion"), new tu(so.b, "blending_data"));
            ...
            if ($$2x.d() instanceof so $$5 && this.a($$5)) {
   ...
   private boolean a(so $$0) {
      return $$0.b("DataVersion", 99) && $$0.h("DataVersion") >= 3441 ? $$0.b("blending_data", 10) : true;
   }

   public CompletableFuture<Void> a(cte $$0, @Nullable so $$1) {
      return this.a(() -> {
         dmp.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dmp.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<so>> a(cte $$0) {
      return this.a(() -> {
         dmp.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(cte $$0, ti $$1) {
      return this.a(() -> {
         try {
            dmp.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bix.b(dmp.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cte, dmp.a>> $$0 = this.e.entrySet().iterator();
         Entry<cte, dmp.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bix.b(dmp.b.b.ordinal(), this::a));
   }

   private void a(cte $$0, dmp.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bix.b(dmp.b.c.ordinal(), () -> $$0.a(avt.a))).join();
         this.c.close();
