...
public abstract class fjy implements fld, flx, fnq, fnv {
   ...
   public fjy(int $$0, int $$1, int $$2, int $$3, xd $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fjn $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fjn var1, int var2, int var3, float var4);

   protected static void a(fjn $$0, fjl $$1, xd $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fjn $$0, fjl $$1, xd $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = azc.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = azc.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(fjn $$0, fjl $$1, int $$2, int $$3) {
      int $$4 = this.D() + $$2;
   ...
   public fjk a(fod $$0) {
      if (!this.j || !this.k) {
         ...
         return !this.aO_() ? fjk.a(this) : null;
      }
   }
   ...
   public fnv.a u() {
      if (this.aO_()) {
         ...
         return this.i ? fnv.a.b : fnv.a.a;
      }
   }

   @Override
   public final void b(fnx $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fnx var1);

   protected void c(fnx $$0) {
      $$0.a(fnw.a, this.aQ_());
      if (this.j) {
         if (this.aO_()) {
            $$0.a(fnw.d, xd.c("narration.button.usage.focused"));
         } else {
