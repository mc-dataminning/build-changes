...
public abstract class bsi {
   ...
   public bsi(bja $$0, cpm $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = arp.a($$0.b(bkf.b) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract eau a(int var1);
   ...
   @Nullable
   public final eas a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(gu.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eas a(Stream<gu> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eas a(Set<gu> $$0, int $$1) {
   ...
   @Nullable
   protected eas a(Set<gu> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.b(bkf.b));
   }

   @Nullable
   protected eas a(Set<gu> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         cpz $$7 = new cpz(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         eas $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ad().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eas $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   protected double a(ehe $$0) {
      gu $$1 = gu.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : eax.a(this.b, $$1);
   }
   ...
   private boolean c(ehe $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ehe $$1 = ehe.c(this.c.g());
         if (!$$0.a((ho)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ehe $$2 = ehe.c(this.c.d(this.c.f() + 1));
            ehe $$3 = $$1.d($$0);
            ehe $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void L_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eaq $$1 = this.c.a($$0);
            eaq $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dfa $$3 = this.b.a_(new gu($$1.a, $$1.b, $$1.c));
            if ($$3.a(apl.bk)) {
   ...
   public boolean b(eao $$0) {
      return $$0 != eao.n && $$0 != eao.p && $$0 != eao.d;
   }

   protected static boolean a(bja $$0, ehe $$1, ehe $$2, boolean $$3) {
      ehe $$4 = new ehe($$2.c, $$2.d + (double)$$0.dg() * 0.5, $$2.e);
      return $$0.dK().a(new cov($$1, $$4, cov.a.a, $$3 ? cov.b.c : cov.b.a, $$0)).c() == ehc.a.a;
   }
   ...
   public boolean b(gu $$0) {
      if (this.m) {
         ...
         eaq $$1 = this.c.d();
         ehe $$2 = new ehe(((double)$$1.a + this.a.dp()) / 2.0, ((double)$$1.b + this.a.dr()) / 2.0, ((double)$$1.c + this.a.dv()) / 2.0);
