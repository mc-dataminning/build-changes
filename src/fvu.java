...
public class fvu extends fuz<csx> {
   ...
   private void d(fod $$0, int $$1, int $$2, float $$3) {
      ...
      this.U.a(0.0F, $$8, $$9, $$4);
      $$0.a($$1x -> {
         ffx $$2x = $$1x.getBuffer(this.U.a(S));
         this.U.a($$0.c(), $$2x, 15728880, heh.d);
      });
      $$0.d();
      $$0.c().b();
      fep.d();
   ...
   public void a(fod $$0, int $$1, int $$2, float $$3) {
      ...
      for (int $$7 = 0; $$7 < 3; $$7++) {
         int $$8 = this.z.m[$$7];
         Optional<jr.c<dcy>> $$9 = this.m.s.K_().e(mc.aO).c(this.z.n[$$7]);
         if (!$$9.isEmpty()) {
            int $$10 = this.z.o[$$7];
            int $$11 = $$7 + 1;
            if (this.a(60, 14 + 19 * $$7, 108, 17, (double)$$1, (double)$$2) && $$8 > 0 && $$10 >= 0 && $$9 != null) {
               List<wp> $$12 = Lists.newArrayList();
               $$12.add(wp.a("container.enchant.clue", dcy.a($$9.get(), $$10)).a(n.p));
               if (!$$5) {
                  $$12.add(wo.a);
                  if (this.m.t.cr < $$8) {
