...
public class aty {
   ...
   public static ih<cmm> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return kd.h
            .b(ahc.a(ke.F, new ahd($$2)))
   ...
   public static ih<cmm> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ih<cmm> a(JsonObject $$0, String $$1, @Nullable ih<cmm> $$2) {
