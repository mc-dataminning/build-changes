...
public class aty extends auj<aty.a> {
   ...
   public aty(aud $$0, List<atx> $$1, Executor $$2, Executor $$3, CompletableFuture<azr> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         AtomicLong $$6 = new AtomicLong();
         AtomicLong $$7 = new AtomicLong();
         bmx $$8 = new bmx(ad.c, () -> 0, false);
         bmx $$9 = new bmx(ad.c, () -> 0, false);
   ...
   public static class a {
      ...
      a(String $$0, bnd $$1, bnd $$2, AtomicLong $$3, AtomicLong $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
