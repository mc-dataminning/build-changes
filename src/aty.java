...
class aty extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atx && $$1 instanceof atx && $$0.equals($$1);
   }
   ...
   private static atx a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atx) {
         return (atx)$$0;
      } else {
