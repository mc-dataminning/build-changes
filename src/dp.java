...
public record dp(dh.d d, ce e, List<dp.e<?>> f, Object2BooleanMap<alb> g, Map<alb, dp.c> h, Optional<bv> i) implements bw {
   ...
   public static final MapCodec<dp> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               ayl.d(alb.a).optionalFieldOf("recipes", Object2BooleanMaps.emptyMap()).forGetter(dp::e),
               Codec.unboundedMap(alb.a, dp.c.b).optionalFieldOf("advancements", Map.of()).forGetter(dp::f),
   ...
   public boolean a(btj $$0, arg $$1, @Nullable eye $$2) {
      if (!($$0 instanceof arh $$3)) {
         ...
         if (!this.h.isEmpty()) {
            ...
            for (java.util.Map.Entry<alb, dp.c> $$11 : this.h.entrySet()) {
         ...
         if (this.i.isPresent()) {
            eye $$13 = $$3.bC();
            eye $$14 = $$3.g(1.0F);
            eye $$15 = $$13.b($$14.d * 100.0, $$14.e * 100.0, $$14.f * 100.0);
            eyb $$16 = cok.a($$3.dS(), $$3, $$13, $$15, new exz($$13, $$15).g(1.0), $$0x -> !$$0x.P_(), 0.0F);
            if ($$16 == null || $$16.c() != eyc.a.c) {
               return false;
            }
   ...
   static record a(Object2BooleanMap<String> c) implements dp.c {
      public static final Codec<dp.a> a = ayl.d(Codec.STRING).xmap(dp.a::new, dp.a::a);
   ...
   public static class d {
      ...
      private final Map<alb, dp.c> e = Maps.newHashMap();
      ...
      public <T> dp.d a(awm<T> $$0, jn.c<T> $$1, dh.d $$2) {
         this.c.add(new dp.e<>($$0, $$1, $$2));
         return this;
      }

      public dp.d a(alb $$0, boolean $$1) {
         this.d.put($$0, $$1);
         return this;
      }
      ...
      public dp.d b(alb $$0, boolean $$1) {
         this.e.put($$0, new dp.b($$1));
         return this;
      }

      public dp.d a(alb $$0, Map<String, Boolean> $$1) {
   ...
   static record e<T>(awm<T> b, jn<T> c, dh.d d, Supplier<awk<T>> e) {
      public static final Codec<dp.e<?>> a = lu.v.q().dispatch(dp.e::a, dp.e::a);

      public e(awm<T> $$0, jn<T> $$1, dh.d $$2) {
         this($$0, $$1, $$2, Suppliers.memoize(() -> $$0.b($$1.a())));
      }

      private static <T> MapCodec<dp.e<T>> a(awm<T> $$0) {
