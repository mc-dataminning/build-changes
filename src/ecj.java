...
public class ecj<T extends eby> implements AutoCloseable {
   static final Logger a = LogUtils.getLogger();
   final Set<UUID> b = Sets.newHashSet();
   final ecg<T> c;
   private final ecb<T> d;
   private final eca<T> e;
   final ecd<T> f;
   private final ech<T> g;
   private final Long2ObjectMap<ecl> h = new Long2ObjectOpenHashMap();
   private final Long2ObjectMap<ecj.b> i = new Long2ObjectOpenHashMap();
   private final LongSet j = new LongOpenHashSet();
   private final Queue<ebw<T>> k = Queues.newConcurrentLinkedQueue();

   public ecj(Class<T> $$0, ecg<T> $$1, ecb<T> $$2) {
      this.e = new eca<>();
      this.f = new ecd<>($$0, this.h);
      this.h.defaultReturnValue(ecl.a);
      this.i.defaultReturnValue(ecj.b.a);
      this.c = $$1;
      this.d = $$2;
      this.g = new eci<>(this.e, this.f);
   }
   ...
   static <T extends eby> ecl a(T $$0, ecl $$1) {
      return $$0.dV() ? ecl.c : $$1;
   }
   ...
   public void a(dgo $$0, arw $$1) {
      ecl $$2 = ecl.a($$1);
      this.a($$0, $$2);
   }

   public void a(dgo $$0, ecl $$1) {
      long $$2 = $$0.a();
      if ($$1 == ecl.a) {
         this.h.remove($$2);
         this.j.add($$2);
   ...
   private boolean a(long $$0, Consumer<T> $$1) {
      ecj.b $$2 = (ecj.b)this.i.get($$0);
      if ($$2 == ecj.b.b) {
         return false;
      } else {
         List<T> $$3 = this.f.b($$0).flatMap($$0x -> $$0x.b().filter(eby::dU)).collect(Collectors.toList());
         if ($$3.isEmpty()) {
            if ($$2 == ecj.b.c) {
               this.d.a(new ebw<>(new dgo($$0), ImmutableList.of()));
            }
   ...
   private void g(eby $$0) {
      $$0.c(bvk.d.c);
      $$0.a(ebz.a);
   }

   private void g() {
      this.j.removeIf($$0 -> this.h.get($$0) != ecl.a ? true : this.d($$0));
   }
   ...
   private LongSet i() {
      ...
      while (var2.hasNext()) {
         Entry<ecj.b> $$1 = (Entry<ecj.b>)var2.next();
         if ($$1.getValue() == ecj.b.c) {
            $$0.add($$1.getLongKey());
         }
      }
   ...
   class a implements ebz {
      ...
      private void a(ecl $$0, ecl $$1) {
         ecl $$2 = ecj.a(this.c, $$0);
         ecl $$3 = ecj.a(this.c, $$1);
         if ($$2 == $$3) {
            if ($$3.b()) {
               ecj.this.c.a(this.c);
            }
