public class bti extends cgf {
   private static final akk<Integer> cc = ako.a(bti.class, akm.b);

   public bti(btb<? extends bti> $$0, dbz $$1) {
      super($$0, $$1);
   }
   ...
   public static boolean a(btb<? extends btq> $$0, dco $$1, btu $$2, iz $$3, azh $$4) {
      return $$3.v() <= $$1.z_() - 33 && $$1.b($$3, 0) == 0 && $$1.a_($$3).a(dfc.G);
   }
}
