...
public class bbe extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgw.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgw.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgw.s);
