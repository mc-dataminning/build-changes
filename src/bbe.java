...
public class bbe extends bft {
   public bbe(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgv.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgv.s, "minecraft:jukebox");
