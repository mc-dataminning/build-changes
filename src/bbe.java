...
public class bbe extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bit.D), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bbe::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bbe::a);
      return this.a($$0, "minecraft:trident", bbe::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bit.D, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bit.D, $$1);
