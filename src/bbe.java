...
public class bbe {
   ...
   private JsonElement a(List<Pair<dec, bbp<bbg>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bbp)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dec, bbp<bbg>> $$3 : $$0) {
         bbp<bbg> $$4 = (bbp<bbg>)$$3.getSecond();
   ...
   private JsonElement b(List<bbm> $$0) {
      if ($$0.isEmpty()) {
   ...
   private JsonElement a(bbk $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bbk.b $$3 = (bbk.b)$$1x.getFirst();
         bbk.a $$4 = (bbk.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bbh> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bbh>, ToDoubleFunction<bbh>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bbh::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bbh::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bbh::c));
      return $$1;
   }
}
