...
public class dwr {
   private static final dqh a = ddg.hj.n();
   private static final dqh b = ddg.hk.n();
   private static final dqh c = ddg.iA.n();
   private static final dqh d = ddg.hn.n();
   private static final dqh e = ddg.hv.n();
   private static final dqh f = ddg.hx.n();
   private static final dqh g = ddg.hr.n();
   private static final dqh h = ddg.iC.n();
   private static final dqh i = ddg.dP.n();
   private final dqh j;
   private final int k;
   private final dqh[] l;
   private final eld m;
   ...
   public dwr(dwn $$0, dqh $$1, int $$2, dwm $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dwi.P);
      this.l = a($$3.a(new akh("clay_bands")));
      this.u = $$0.a(dwi.N);
      this.v = $$0.a(dwi.O);
      this.n = $$0.a(dwi.Q);
      this.o = $$0.a(dwi.R);
   ...
   public void a(dwn $$0, dbe $$1, jj<dbc> $$2, boolean $$3, dww $$4, final dsd $$5, dwd $$6, dwq.o $$7) {
      final in.a $$8 = new in.a();
      final czk $$9 = $$5.f();
      int $$10 = $$9.d();
      int $$11 = $$9.e();
      dsa $$12 = new dsa() {
      ...
      dwq.g $$13 = new dwq.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dwq.u $$14 = $$7.apply($$13);
      in.a $$15 = new in.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dvz.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            iw<dbc> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dbj.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dvz.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dqh> a(dwq.o $$0, dxz $$1, Function<in, iw<dbc>> $$2, dsd $$3, dwd $$4, in $$5, boolean $$6) {
      dwq.g $$7 = new dwq.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(le.az), $$1);
      dwq.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dqh $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dsa $$0, int $$1, int $$2, int $$3, daf $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dbc $$1, dsa $$2, in.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(ddg.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(ayg $$0, dqh[] $$1, int $$2, dqh $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dqh a(int $$0, int $$1, int $$2) {
