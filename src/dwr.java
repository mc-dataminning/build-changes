...
public class dwr implements ayd {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dwr> b = dwq.a.xmap($$0 -> new dwr($$0), $$0 -> $$0.e);
   private dwq e;
   private final dvs f = new dvs(this);

   public dwr(long $$0) {
      this.e = new dwq(dwf.c($$0));
   }
   ...
   @Override
   public ayd d() {
      return new dwr(this.e.a(), this.e.a());
   }

   @Override
   public dwd e() {
      return new dwr.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dwd {
      ...
      @Override
      public ayd a(int $$0, int $$1, int $$2) {
         long $$3 = axw.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dwr($$4, this.b);
      }

      @Override
      public ayd a(String $$0) {
         dwf.a $$1 = dwf.a($$0);
         return new dwr($$1.a(this.a, this.b));
      }
