...
public class chm extends cim {
   ...
   public chm(int $$0, ceq $$1) {
      this($$0, $$1, chv.a);
   }

   public chm(int $$0, ceq $$1, chv $$2) {
      super(cir.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cin l() {
      return cin.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected void a(cer $$0, cmh $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dip $$3 = $$1x.a_($$2x);
         if (!$$0.fT().d && $$3.a(arr.M) && $$0.eg().i() < 0.12F) {
            dip $$4 = cuz.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cmh $$4 = $$0.p();
         cmh $$5 = this.q.a(1);
         Map<cqs, Integer> $$6 = cqu.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cmk.up) && !cld.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cqs, Integer> $$16 = cqu.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cqs $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fT().d || $$0.a(cmk.up)) {
                        $$22 = true;
                     }
