...
public class chm extends cgx {
   private static final ajy<Integer> ca = akc.a(chm.class, aka.b);
   private static final ajy<Integer> cc = akc.a(chm.class, aka.b);
   private static final ajy<Integer> cd = akc.a(chm.class, aka.b);
   private static final ajy<Byte> ce = akc.a(chm.class, aka.a);
   private static final ajy<Byte> cf = akc.a(chm.class, aka.a);
   private static final ajy<Byte> cg = akc.a(chm.class, aka.a);
   static final cfx ch = cfx.b().a(8.0);
   private static final bun ci = bur.aN.n().a(0.5F).a(bum.a().a(bul.a, 0.0F, 0.40625F, 0.0F));
   ...
   public chm(bur<? extends chm> $$0, dgh $$1) {
      super($$0, $$1);
   ...
   protected void E() {
      ...
      this.bS.a(6, new chm.c<>(this, cow.class, 8.0F, 2.0, 2.0));
      ...
      this.cy = new chm.g(this, cow.class, 6.0F);
      this.bS.a(9, this.cy);
   ...
   public static bwn.a gF() {
      return cgx.gx().a(bwo.v, 0.15F).a(bwo.c, 6.0);
   }

   public chm.a gG() {
      return chm.a.a(this.gv(), this.gw());
   }

   public boolean gH() {
      return this.gG() == chm.a.b;
   }

   public boolean gI() {
      return this.gG() == chm.a.c;
   }

   public boolean gJ() {
      return this.gG() == chm.a.d;
   }

   public boolean gK() {
      return this.gG() == chm.a.e;
   }

   public boolean gL() {
      return this.gG() == chm.a.f;
   }

   @Override
   public boolean gh() {
      return this.gG() == chm.a.g;
   }
   ...
   private void gQ() {
      if (!this.gt() && this.x() && !this.gM() && !this.a(bus.a).f() && this.ae.a(80) == 1) {
         this.z(true);
      ...
      if (this.gt()) {
         ...
         if (!this.dV().C && this.gP() > 80 && this.ae.a(20) == 1) {
            if (this.gP() > 100 && this.a(bus.a).a(awy.au)) {
               if (!this.dV().C) {
                  this.a(bus.a, cwo.j);
                  this.a(ebs.m);
               }
   ...
   private void gR() {
      if (this.gP() % 5 == 0) {
         ...
         for (int $$0 = 0; $$0 < 6; $$0++) {
            faz $$1 = new faz(((double)this.ae.i() - 0.5) * 0.1, Math.random() * 0.1 + 0.1, ((double)this.ae.i() - 0.5) * 0.1);
            $$1 = $$1.a(-this.dN() * (float) (Math.PI / 180.0));
            $$1 = $$1.b(-this.dL() * (float) (Math.PI / 180.0));
            double $$2 = (double)(-this.ae.i()) * 0.6 - 0.3;
            faz $$3 = new faz(((double)this.ae.i() - 0.5) * 0.8, $$2, 1.0 + ((double)this.ae.i() - 0.5) * 0.4);
            $$3 = $$3.b(-this.aX * (float) (Math.PI / 180.0));
            $$3 = $$3.b(this.dA(), this.dE() + 1.0, this.dG());
            this.dV().a(new lp(lt.T, this.a(bus.a)), $$3.d, $$3.e, $$3.f, $$1.d, $$1.e + 0.05, $$1.f);
         }
      }
   }
      ...
      if (this.bZ > 32) {
         ...
         if (!this.dV().C) {
            ...
            if (this.bZ == 1) {
               ...
               this.cr = new faz($$0.d + (double)(-ayz.a($$1) * $$2), 0.0, $$0.f + (double)(ayz.b($$1) * $$2));
   ...
   private void gW() {
      ...
      if (this.dV() instanceof ard $$4 && $$4.O().b(dgd.f)) {
         this.a($$4, evm.aH, this::a);
      }
   }
   ...
   class k extends cce {
      ...
      @Override
      public boolean b() {
         if (this.b > chm.this.af || chm.this.e_() || chm.this.bj() || !chm.this.gO() || chm.this.p() > 0) {
            return false;
         } else {
            return !chm.this.a(bus.a).f() ? true : !chm.this.dV().a(clb.class, chm.this.cR().c(6.0, 6.0, 6.0), chm::b).isEmpty();
         }
      }

      @Override
      public boolean c() {
         return !chm.this.bj() && (chm.this.gH() || chm.this.ae.a(b(600)) != 1) ? chm.this.ae.a(b(2000)) != 1 : false;
      }
      ...
      public void d() {
         if (chm.this.a(bus.a).f()) {
            List<clb> $$0 = chm.this.dV().a(clb.class, chm.this.cR().c(8.0, 8.0, 8.0), chm::b);
            if (!$$0.isEmpty()) {
               chm.this.P().a($$0.getFirst(), 1.2F);
            }
         } else {
            chm.this.gY();
         }
      ...
      @Override
      public void e() {
         cwo $$0 = chm.this.a(bus.a);
         if (!$$0.f()) {
            chm.this.a(a(chm.this.dV()), $$0);
            chm.this.a(bus.a, cwo.j);
            int $$1 = chm.this.gH() ? chm.this.ae.a(50) + 10 : chm.this.ae.a(150) + 10;
