...
public abstract class bsr extends bss {
   static final Logger p = LogUtils.getLogger();
   public static final int b = -1;
   private static final akj<Integer> q = akn.a(bsr.class, akl.b);
   private static final akj<Integer> r = akn.a(bsr.class, akl.b);
   private static final akj<Integer> s = akn.a(bsr.class, akl.b);
   private static final akj<Vector3f> t = akn.a(bsr.class, akl.D);
   private static final akj<Vector3f> u = akn.a(bsr.class, akl.D);
   private static final akj<Quaternionf> v = akn.a(bsr.class, akl.E);
   private static final akj<Quaternionf> aF = akn.a(bsr.class, akl.E);
   private static final akj<Byte> aG = akn.a(bsr.class, akl.a);
   private static final akj<Integer> aH = akn.a(bsr.class, akl.b);
   private static final akj<Float> aI = akn.a(bsr.class, akl.d);
   private static final akj<Float> aJ = akn.a(bsr.class, akl.d);
   private static final akj<Float> aK = akn.a(bsr.class, akl.d);
   private static final akj<Float> aL = akn.a(bsr.class, akl.d);
   private static final akj<Float> aM = akn.a(bsr.class, akl.d);
   private static final akj<Integer> aN = akn.a(bsr.class, akl.b);
   ...
   protected void a(ur $$0) {
      ...
      if ($$0.b("billboard", 8)) {
         bsr.a.e.decode(vf.a, $$0.c("billboard")).resultOrPartial(ac.a("Display entity", p::error)).ifPresent($$0x -> this.a((bsr.a)$$0x.getFirst()));
      }
   ...
   protected void b(ur $$0) {
      ...
      bsr.a.e.encodeStart(vf.a, this.w()).ifSuccess($$1x -> $$0.a("billboard", $$1x));
   ...
   public void a(double $$0, double $$1, double $$2, float $$3, float $$4, int $$5) {
      int $$6 = this.v();
      this.aZ = new bsr.j($$6, $$0, $$1, $$2, (double)$$3, (double)$$4);
   }
   ...
   private void a(bsr.a $$0) {
      this.ao.a(aG, $$0.a());
   }

   private bsr.a w() {
      return bsr.a.f.apply(this.ao.a(aG));
   }
   ...
   public float a(float $$0) {
      ...
      if ($$1 <= 0) {
         ...
         float $$3 = $$2 + $$0;
         float $$4 = ayx.a(ayx.g($$3, 0.0F, (float)$$1), 0.0F, 1.0F);
         this.aU = $$4;
         return $$4;
      }
   }
   ...
   private void G() {
      ...
      if ($$0 != 0.0F && $$1 != 0.0F) {
         ...
         double $$4 = this.dw();
         double $$5 = this.dA();
         this.aV = new evk($$3 - (double)$$2, $$4, $$5 - (double)$$2, $$3 + (double)$$2, $$4 + (double)$$1, $$5 + (double)$$2);
      } else {
         this.au = true;
      }
   }
   ...
   public boolean a(double $$0) {
      return $$0 < ayx.k((double)this.z() * 64.0 * cD());
   }
   ...
   private bsr.k H() {
      return new bsr.k(bsr.e.constant(a(this.ao)), this.w(), this.y(), bsr.d.constant(this.A()), bsr.d.constant(this.B()), this.D());
   }

   private bsr.k a(bsr.k $$0, float $$1) {
      j $$2 = $$0.a.get($$1);
      float $$3 = $$0.d.get($$1);
      float $$4 = $$0.e.get($$1);
      return new bsr.k(new bsr.m($$2, a(this.ao)), this.w(), this.y(), new bsr.h($$3, this.A()), new bsr.h($$4, this.B()), this.D());
   }
   ...
   public static enum a implements azs {
      ...
      public static final Codec<bsr.a> e = azs.a(bsr.a::values);
      public static final IntFunction<bsr.a> f = axo.a(bsr.a::a, values(), axo.a.a);
   ...
   public static class b extends bsr {
      public static final String p = "block_state";
      private static final akj<dsa> q = akn.a(bsr.b.class, akl.i);
      @Nullable
      private bsr.b.a r;

      public b(bsy<?> $$0, dbw $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(boolean $$0, float $$1) {
         this.r = new bsr.b.a(this.u());
      }

      public static record a(dsa a) {
      }
   }

   static record c(int a, int b) implements bsr.f {
      @Override
      public int get(float $$0) {
         return ayh.b.a($$0, this.a, this.b);
      }
   }

   @FunctionalInterface
   public interface d {
      static bsr.d constant(float $$0) {
         return $$1 -> $$0;
      }
   ...
   public static class g extends bsr {
      private static final String p = "item";
      private static final String q = "item_display";
      private static final akj<cun> r = akn.a(bsr.g.class, akl.h);
      private static final akj<Byte> s = akn.a(bsr.g.class, akl.a);
      private final buf t = buf.a(this::u, this::a);
      @Nullable
      private bsr.g.a u;

      public g(bsy<?> $$0, dbw $$1) {
         super($$0, $$1);
      }
      ...
      private cuk v() {
         return cuk.k.apply(this.ao.a(s));
      }
      ...
      protected void a(ur $$0) {
         super.a($$0);
         if ($$0.e("item")) {
            this.a(cun.a(this.dR(), (vo)$$0.p("item")).orElse(cun.l));
         } else {
            this.a(cun.l);
         }

         if ($$0.b("item_display", 8)) {
            cuk.j.decode(vf.a, $$0.c("item_display")).resultOrPartial(ac.a("Display entity", bsr.p::error)).ifPresent($$0x -> this.a((cuk)$$0x.getFirst()));
         }
      }
      ...
      protected void b(ur $$0) {
         ...
         cuk.j.encodeStart(vf.a, this.v()).ifSuccess($$1 -> $$0.a("item_display", $$1));
      }

      @Override
      public buf a_(int $$0) {
         return $$0 == 0 ? this.t : buf.a;
      }
      ...
      protected void a(boolean $$0, float $$1) {
         cun $$2 = this.u();
         $$2.a(this);
         this.u = new bsr.g.a($$2, this.v());
      }

      public static record a(cun a, cuk b) {
      }
   }

   static record h(float a, float b) implements bsr.d {
      @Override
      public float get(float $$0) {
         return ayx.i($$0, this.a, this.b);
      }
   }

   static record i(int a, int b) implements bsr.f {
      @Override
      public int get(float $$0) {
         return ayx.a($$0, this.a, this.b);
      }
   }
   ...
   public static record k(bsr.e<j> a, bsr.a b, int c, bsr.d d, bsr.d e, int f) {
   }

   public static class l extends bsr {
      ...
      private static final akj<xo> aN = akn.a(bsr.l.class, akl.f);
      private static final akj<Integer> aO = akn.a(bsr.l.class, akl.b);
      private static final akj<Integer> aP = akn.a(bsr.l.class, akl.b);
      private static final akj<Byte> aQ = akn.a(bsr.l.class, akl.a);
      private static final akj<Byte> aR = akn.a(bsr.l.class, akl.a);
      ...
      protected void a(ur $$0) {
         ...
         Optional<bsr.l.a> $$2 = bsr.l.a.d.decode(vf.a, $$0.c("alignment")).resultOrPartial(ac.a("Display entity", bsr.p::error)).map(Pair::getFirst);
         if ($$2.isPresent()) {
            $$1 = switch ((bsr.l.a)$$2.get()) {
               case a -> $$1;
               case b -> (byte)($$1 | 8);
               case c -> (byte)($$1 | 16);
            };
         ...
         if ($$0.b("text", 8)) {
            ...
            try {
               ...
               bsr.p.warn("Failed to parse display entity text {}", $$3, var8);
            }
         }
      }
      ...
      protected void b(ur $$0) {
         ...
         bsr.l.a.d.encodeStart(vf.a, a($$1)).ifSuccess($$1x -> $$0.a("alignment", $$1x));
      }
      ...
      private bsr.l.e z() {
         return new bsr.l.e(this.u(), this.v(), bsr.f.constant(this.w()), bsr.f.constant(this.x()), this.y());
      }

      private bsr.l.e a(bsr.l.e $$0, float $$1) {
         int $$2 = $$0.d.get($$1);
         int $$3 = $$0.c.get($$1);
         return new bsr.l.e(this.u(), this.v(), new bsr.i($$3, this.w()), new bsr.c($$2, this.x()), this.y());
      }

      public bsr.l.b a(bsr.l.d $$0) {
         if (this.aT == null) {
            if (this.aU != null) {
               this.aT = $$0.split(this.aU.a(), this.aU.b());
            } else {
               this.aT = new bsr.l.b(List.of(), 0);
            }
         }
      ...
      public static bsr.l.a a(byte $$0) {
         if (($$0 & 8) != 0) {
            return bsr.l.a.b;
         } else {
            return ($$0 & 16) != 0 ? bsr.l.a.c : bsr.l.a.a;
         }
      }
      ...
      public static enum a implements azs {
         ...
         public static final Codec<bsr.l.a> d = azs.a(bsr.l.a::values);
      ...
      public static record b(List<bsr.l.c> a, int b) {
      }

      public static record c(ayj a, int b) {
      }

      @FunctionalInterface
      public interface d {
         bsr.l.b split(xo var1, int var2);
      }

      public static record e(xo a, int b, bsr.f c, bsr.f d, byte e) {
      }
   }

   static record m(j a, j b) implements bsr.e<j> {
      public j a(float $$0) {
