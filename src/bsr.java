...
public abstract class bsr {
   ...
   public bsr(bjk $$0, cpx $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = ary.a($$0.b(bko.b) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract ebf a(int var1);
   ...
   @Nullable
   public final ebd a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(gw.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ebd a(Stream<gw> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ebd a(Set<gw> $$0, int $$1) {
   ...
   @Nullable
   protected ebd a(Set<gw> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.b(bko.b));
   }

   @Nullable
   protected ebd a(Set<gw> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
      } else if (this.a.ds() < (double)this.b.H_()) {
         return null;
      } else if (!this.a()) {
         return null;
         ...
         gw $$5 = $$2 ? this.a.dl().c() : this.a.dl();
         int $$6 = (int)($$4 + (float)$$1);
         cqk $$7 = new cqk(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         ebd $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ad().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ebd $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            ehp $$0 = this.b();
            ehp $$1 = this.c.a(this.a);
            if ($$0.d > $$1.d && !this.a.aA() && ary.a($$0.c) == ary.a($$1.c) && ary.a($$0.e) == ary.a($$1.e)) {
               this.c.a();
            }
         }

         abd.a(this.b, this.a, this.c, this.l);
         if (!this.l()) {
            ehp $$2 = this.c.a(this.a);
   ...
   protected double a(ehp $$0) {
      gw $$1 = gw.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ebi.a(this.b, $$1);
   }
   ...
   private boolean c(ehp $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         ehp $$1 = ehp.c(this.c.g());
         if (!$$0.a((hq)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            ehp $$2 = ehp.c(this.c.d(this.c.f() + 1));
            ehp $$3 = $$1.d($$0);
            ehp $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void R_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            ebb $$1 = this.c.a($$0);
            ebb $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dfl $$3 = this.b.a_(new gw($$1.a, $$1.b, $$1.c));
            if ($$3.a(apu.bk)) {
   ...
   public boolean b(eaz $$0) {
      return $$0 != eaz.n && $$0 != eaz.p && $$0 != eaz.d;
   }

   protected static boolean a(bjk $$0, ehp $$1, ehp $$2, boolean $$3) {
      ehp $$4 = new ehp($$2.c, $$2.d + (double)$$0.dg() * 0.5, $$2.e);
      return $$0.dL().a(new cpg($$1, $$4, cpg.a.a, $$3 ? cpg.b.c : cpg.b.a, $$0)).c() == ehn.a.a;
   }
   ...
   public boolean b(gw $$0) {
      if (this.m) {
         ...
         ebb $$1 = this.c.d();
         ehp $$2 = new ehp(((double)$$1.a + this.a.dq()) / 2.0, ((double)$$1.b + this.a.ds()) / 2.0, ((double)$$1.c + this.a.dw()) / 2.0);
