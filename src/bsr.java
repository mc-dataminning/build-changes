...
public class bsr extends bsv implements bup {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final akk<Float> f = ako.a(bsr.class, akm.d);
   private static final akk<Boolean> g = ako.a(bsr.class, akm.k);
   private static final akk<lg> h = ako.a(bsr.class, akm.l);
   ...
   private cwr l = cwr.a;
   private final Map<bsv, Integer> m = Maps.newHashMap();
   private int n = 600;
   private int o = 20;
   private int p = 20;
   private int q;
   ...
   public bsr(btb<? extends bsr> $$0, dbz $$1) {
      super($$0, $$1);
      this.ag = true;
   }

   public bsr(dbz $$0, double $$1, double $$2, double $$3) {
      this(btb.b, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void u() {
      ...
      if ($$0 instanceof lb $$1) {
         int $$2 = this.l.equals(cwr.a) ? 0 : this.l.b();
      ...
      if (this.dP().B) {
         ...
         if (this.ai % 5 == 0) {
            ...
            if (!this.l.c()) {
               ...
               List<bsd> $$14 = Lists.newArrayList();
               if (this.l.e().isPresent()) {
                  for (bsd $$15 : this.l.e().get().a().a()) {
                     $$14.add(new bsd($$15.c(), $$15.a($$0x -> $$0x / 4), $$15.e(), $$15.f(), $$15.g()));
                  }
               }

               $$14.addAll(this.l.d());
               List<btq> $$16 = this.dP().a(btq.class, this.cK());
               if (!$$16.isEmpty()) {
                  for (btq $$17 : $$16) {
   ...
   protected void a(us $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cwr.b.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> d.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(us $$0) {
      ...
      if (!this.l.equals(cwr.a)) {
         vp $$2 = (vp)cwr.b.encodeStart($$1, this.l).getOrThrow();
