...
public class ezp extends eyk {
   ...
   protected void l() {
      this.d(esq.a(tl.d, $$0 -> this.az_()).a(this.g / 2 - 100, 196, 200, 20).a());
   }
   ...
   public void a(esf $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.u != this.s) {
         ...
         this.v = tm.a("book.pageIndicator", this.s + 1, Math.max(this.E(), 1));
      }
   ...
   public static class c implements ezp.a {
      ...
      private static List<String> b(cjf $$0) {
         qy $$1 = $$0.v();
         return (List<String>)($$1 != null && clb.a($$1) ? ezp.a($$1) : ImmutableList.of(tm.a.a(tm.c("book.invalid.tag").a(n.e))));
      }
