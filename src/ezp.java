public class ezp extends ezd<cev> implements fbx {
   private static final aeu x = new aeu("textures/gui/container/crafting_table.png");
   private final fbr y = new fbr();
   private boolean z;

   public ezp(cev $$0, cbo $$1, ti $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aD_() {
      ...
      this.d(new esx(this.t + 5, this.h / 2 - 49, 20, 18, fbr.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
