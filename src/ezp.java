...
public class ezp extends eyk {
   ...
   public static final aex l = new aex("textures/gui/book.png");
   ...
   private ezp.a q;
   private int s;
   private List<ark> t = Collections.emptyList();
   private int u = -1;
   private tl v = tk.a;
   private fap w;
   private fap x;
   ...
   public void a(ezp.a $$0) {
      this.q = $$0;
      this.s = arx.a(this.s, 0, $$0.a());
      this.H();
      this.u = -1;
   }

   public boolean a(int $$0) {
      int $$1 = arx.a($$0, 0, this.q.a() - 1);
      if ($$1 != this.s) {
         this.s = $$1;
         this.H();
         this.u = -1;
   ...
   protected void C() {
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.w = this.d(new fap($$0 + 116, 159, true, $$0x -> this.F(), this.y));
      this.x = this.d(new fap($$0 + 43, 159, false, $$0x -> this.E(), this.y));
      this.H();
   }
   ...
   public void a(esf $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.u != this.s) {
         ...
         this.v = tl.a("book.pageIndicator", this.s + 1, Math.max(this.D(), 1));
      }
   ...
   public uh a(double $$0, double $$1) {
      if (this.t.isEmpty()) {
         ...
         int $$2 = arx.a($$0 - (double)((this.g - 192) / 2) - 36.0);
         int $$3 = arx.a($$1 - 2.0 - 30.0);
         if ($$2 >= 0 && $$3 >= 0) {
   ...
   static List<String> a(qx $$0) {
      Builder<String> $$1 = ImmutableList.builder();
      a($$0, $$1::add);
      return $$1.build();
   }

   public static void a(qx $$0, Consumer<String> $$1) {
      rd $$2 = $$0.c("pages", 8).e();
      IntFunction<String> $$4;
      if (eqv.O().aQ() && $$0.b("filtered_pages", 10)) {
         qx $$3 = $$0.p("filtered_pages");
         $$4 = $$2x -> {
