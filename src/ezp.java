...
public class ezp {
   ...
   private final exo i;
   private final auw<String> j = new auw<>(100);
   private final List<exi> k = Lists.newArrayList();
   private final List<exi.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<ezp.a> o = new ArrayList<>();
   ...
   public void a(ezb $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.k()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = awi.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = awi.d((float)($$9 - 40) / $$7);
   ...
   private void a(ezb $$0, int $$1, int $$2, exj.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(exi.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean k() {
      return this.i.m.m().c() == chj.c;
   }
   ...
   public void a(vq $$0) {
      this.a($$0, null, this.i.V() ? exj.b() : exj.a());
   }

   public void a(vq $$0, @Nullable wc $$1, @Nullable exj $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(vq $$0, @Nullable exj $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, exj::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(vq $$0, @Nullable wc $$1, int $$2, @Nullable exj $$3, boolean $$4) {
      int $$5 = awi.a((double)this.f() / this.h());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<avu> $$6 = ezt.a($$0, $$5, this.i.h);
      boolean $$7 = this.e();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new exi.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private ezp.a b(wc $$0) {
      int $$1 = this.i.l.e();
      ListIterator<exi> $$2 = this.k.listIterator();
   ...
   private exi a(exi $$0) {
      return new exi($$0.a(), h, null, exj.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)awi.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)awi.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public wn b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         exi.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), awi.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public exj c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, exi.a $$1, exj $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         exj.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         if (!($$0 < -4.0) && !($$0 > (double)awi.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = awi.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof fec;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return awi.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return awi.a($$0 * 160.0 + 20.0);
   }
