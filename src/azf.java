...
public class azf extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getOutputSchema().getType(aym.c);
      ...
      if (!($$1.findFieldType("TileEntities") instanceof ListType<?> $$3)) {
         ...
         Type<?> $$5 = this.getInputSchema().getType(aym.c);
         ...
         if (!($$8 instanceof ListType)) {
            ...
            return TypeRewriteRule.seq(
               new asx(this.getOutputSchema(), "AddTrappedChestFix", aym.s).makeRule(),
               this.fixTypeEverywhereTyped("Trapped Chest fix", $$5, $$4x -> $$4x.updateTyped($$6, $$3xx -> {
                     ...
                     if (!$$4xx.isPresent()) {
                        ...
                        for (Typed<?> $$7x : $$5x) {
                           azf.a $$8x = new azf.a($$7x, this.getInputSchema());
                           if (!$$8x.b()) {
                        ...
                        TaggedChoiceType<String> $$14 = this.getInputSchema().findChoiceType(aym.s);
                        return $$3xx.updateTyped($$4, $$4xxx -> $$4xxx.updateTyped($$14.finder(), $$4xxxx -> {
                              ...
                              return $$6x.contains(axf.a($$6xx, $$7xx, $$8xx)) ? $$4xxxx.update($$14.finder(), $$0xxxxx -> $$0xxxxx.mapFirst($$0xxxxxx -> {
