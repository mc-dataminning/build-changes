...
public class azf extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bbq.x);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", azf::c), this.a("minecraft:arrow", azf::a), this.a("minecraft:spectral_arrow", azf::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, azf.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bbq.x, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bbq.x, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, azf.a<?> $$1, Type<?> $$2, Type<T> $$3) {
