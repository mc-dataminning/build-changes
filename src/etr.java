...
public class etr {
   private static final aex b = new aex("icon/ping_unknown");
   private static final aex c = new aex("icon/ping_1");
   private static final aex d = new aex("icon/ping_2");
   private static final aex e = new aex("icon/ping_3");
   private static final aex f = new aex("icon/ping_4");
   private static final aex g = new aex("icon/ping_5");
   private static final aex h = new aex("hud/heart/container_blinking");
   private static final aex i = new aex("hud/heart/container");
   private static final aex j = new aex("hud/heart/full_blinking");
   private static final aex k = new aex("hud/heart/half_blinking");
   private static final aex l = new aex("hud/heart/absorbing_full_blinking");
   private static final aex m = new aex("hud/heart/full");
   private static final aex n = new aex("hud/heart/absorbing_half_blinking");
   private static final aex o = new aex("hud/heart/half");
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, esf $$4, int $$5) {
      ...
      $$6.a($$5, (long)this.r.e());
      int $$7 = arx.e(Math.max($$5, $$6.a()), 2);
      int $$8 = Math.max($$5, Math.max($$6.a(), 20)) / 2;
      boolean $$9 = $$6.a((long)this.r.e());
      if ($$7 > 0) {
         int $$10 = arx.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
