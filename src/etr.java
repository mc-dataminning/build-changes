...
public class etr {
   private static final aew b = new aew("icon/ping_unknown");
   private static final aew c = new aew("icon/ping_1");
   private static final aew d = new aew("icon/ping_2");
   private static final aew e = new aew("icon/ping_3");
   private static final aew f = new aew("icon/ping_4");
   private static final aew g = new aew("icon/ping_5");
   private static final aew h = new aew("hud/heart/container_blinking");
   private static final aew i = new aew("hud/heart/container");
   private static final aew j = new aew("hud/heart/full_blinking");
   private static final aew k = new aew("hud/heart/half_blinking");
   private static final aew l = new aew("hud/heart/absorbing_full_blinking");
   private static final aew m = new aew("hud/heart/full");
   private static final aew n = new aew("hud/heart/absorbing_half_blinking");
   private static final aew o = new aew("hud/heart/half");
   private static final Comparator<fjf> p = Comparator.<fjf>comparingInt($$0 -> $$0.e() == cps.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), eik::b, ""))
   ...
   public void a(esf $$0, int $$1, eim $$2, @Nullable eij $$3) {
      List<fjf> $$4 = this.b();
      int $$5 = 0;
      int $$6 = 0;
      ...
      for (int $$28 = 0; $$28 < $$10; $$28++) {
         ...
         if ($$28 < $$4.size()) {
            ...
            GameProfile $$34 = $$33.a();
            if ($$13) {
               cbu $$35 = this.q.r.b($$34.getId());
               boolean $$36 = $$35 != null && fui.e($$35);
               boolean $$37 = $$35 != null && $$35.a(cbv.g);
               etp.a($$0, $$33.g().a(), $$31, $$32, 8, $$37, $$36);
               $$31 += 9;
            }

            $$0.b(this.q.h, this.a($$33), $$31, $$32, $$33.e() == cps.d ? -1862270977 : -1);
            if ($$3 != null && $$33.e() != cps.d) {
               int $$38 = $$31 + $$5 + 1;
               int $$39 = $$38 + $$14;
               if ($$39 - $$38 > 5) {
   ...
   protected void a(esf $$0, int $$1, int $$2, int $$3, fjf $$4) {
      aew $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
   ...
   private void a(eij $$0, int $$1, String $$2, int $$3, int $$4, UUID $$5, esf $$6) {
      int $$7 = $$0.a().c($$2, $$0).b();
      if ($$0.f() == eip.a.b) {
         this.a($$1, $$3, $$4, $$5, $$6, $$7);
      } else {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, esf $$4, int $$5) {
      etr.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new etr.a($$5));
      $$6.a($$5, (long)this.r.e());
      int $$7 = arw.e(Math.max($$5, $$6.a()), 2);
      int $$8 = Math.max($$5, Math.max($$6.a(), 20)) / 2;
      boolean $$9 = $$6.a((long)this.r.e());
      if ($$7 > 0) {
         int $$10 = arw.d(Math.min((float)($$2 - $$1 - 4) / (float)$$8, 9.0F));
         if ($$10 <= 3) {
            float $$11 = arw.a((float)$$5 / 20.0F, 0.0F, 1.0F);
