...
public class etr extends etl<etr.a> {
   protected etr(ead $$0) {
      super(dhr.a, $$0, new etr.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dzv g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kj.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dzv(15) : new dzv();
         }
      }
   }

   private static dzv a(dzv $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends eti<etr.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dzv> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public etr.a a() {
         return new etr.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
