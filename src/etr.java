...
public class etr {
   ...
   private static final Map<dlk.a, String> e = ac.a(new EnumMap<>(dlk.a.class), $$0 -> {
      $$0.put(dlk.a.a, "SW");
      $$0.put(dlk.a.b, "S");
      $$0.put(dlk.a.c, "OW");
      $$0.put(dlk.a.d, "O");
   ...
   private dii l;
   @Nullable
   private CompletableFuture<dii> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final atg r = new atg();
   private final atg s = new atg();
   private final atg t = new atg();
   private final atg u = new atg();
   private final euz v;
   private final evb w;
   private final eva x;
   private final euy y;
   ...
   public etr(ero $$0) {
      ...
      this.g = new etr.a();
      this.h = $$0.h;
      this.v = new euz(this.h, this.r);
      this.w = new evb(this.h, this.s);
      this.x = new eva(this.h, this.t);
      this.y = new euy(this.h, this.u);
   }
   ...
   private void a(esy $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cqz $$16 = this.p();
         LongSet $$17 = (LongSet)($$16 instanceof alq ? ((alq)$$16).u() : LongSets.EMPTY_SET);
         ...
         $$18.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$9, $$14, asy.g($$8.dB()), asy.g($$8.dD())));
         dii $$20 = this.r();
         if ($$20.C()) {
            $$18.add("Waiting for chunk...");
         } else {
            int $$21 = this.f.r.i().p().a($$7, 0);
            int $$22 = this.f.r.a(cri.a, $$7);
            int $$23 = this.f.r.a(cri.b, $$7);
            $$18.add("Client Light: " + $$21 + " (" + $$22 + " sky, " + $$23 + " block)");
            dii $$24 = this.q();
            StringBuilder $$25 = new StringBuilder("CH");

            for (dlk.a $$26 : dlk.a.values()) {
               if ($$26.b()) {
            ...
            if ($$7.v() >= this.f.r.I_() && $$7.v() < this.f.r.aj()) {
               ...
               if ($$24 != null) {
                  float $$28 = $$16.an();
                  long $$29 = $$24.u();
                  bhz $$30 = new bhz($$16.ai(), $$16.W(), $$29, $$28);
         ...
         if ($$31 != null) {
            ...
            crk.d $$37 = $$32.n();
            if ($$37 != null) {
               Object2IntMap<bkm> $$38 = $$37.b();
               int $$39 = $$37.a();
               $$18.add(
                  "SC: "
                     + $$39
                     + ", "
                     + Stream.of(bkm.values())
   ...
   private static String a(ib<crx> $$0) {
   ...
   private cqz p() {
      return (cqz)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ac()))), this.f.r);
   }
   ...
   private dii q() {
      if (this.m == null) {
         ...
         this.m = $$0.k().b(this.k.e, this.k.f, dic.n, false).thenApply($$0x -> (dii)$$0x.map($$0xx -> (dii)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ela.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ero.O().aM().k(), ero.O().aM().l(), ela.a()),
            ela.c(),
            ela.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == eid.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dhe<?>, Comparable<?>> $$7 = (Entry<dhe<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == eid.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dhe<?>, Comparable<?>> $$10 = (Entry<dhe<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dhe<?>, Comparable<?>> $$0) {
      dhe<?> $$1 = $$0.getKey();
