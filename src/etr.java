...
public class etr {
   ...
   public static List<etr.a> a(String $$0, etr.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<etr.a> a(String $$0, List<etr.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<etr.a> a(List<String> $$0, List<etr.b> $$1) {
      int $$2 = 0;
      List<etr.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<etr.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static etr.b a(String $$0, String $$1) {
         return new etr.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static etr.b a(String $$0) {
         return new etr.b($$0);
      }
   }
}
