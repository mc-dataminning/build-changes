...
public class rp implements ro {
   ...
   public void a(ri $$0) {
      ...
      tf $$3 = tf.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = tf.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(qp $$0) {
      tf $$1 = tf.b("b").a(g);
      this.t = tf.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(qw $$0) {
      this.t = tf.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(qu $$0) {
      tf $$1 = tf.b("f").a(g);
      this.t = tf.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(qs $$0) {
      tf $$1 = tf.b("d").a(g);
      this.t = tf.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(qo $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         ts $$5 = tf.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(qv $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(tf.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(qy $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         tf $$5 = tf.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(qx $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            ts $$6 = tf.b(Strings.repeat(this.r, this.s + 1));
   ...
   public void a(qr $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            ts $$6 = tf.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new rp(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static tf a(String $$0) {
      if (h.matcher($$0).matches()) {
         return tf.b($$0).a(d);
      } else {
         String $$1 = ri.b($$0);
         String $$2 = $$1.substring(0, 1);
         tf $$3 = tf.b($$1.substring(1, $$1.length() - 1)).a(d);
         return tf.b($$2).b($$3).f($$2);
      }
   }
