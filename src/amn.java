...
public class amn implements amk {
   private static final Logger c = LogUtils.getLogger();
   private final amf d;
   private final Set<String> e;
   private final List<Path> f;
   private final Map<aml, List<Path>> g;

   amn(amf $$0, Set<String> $$1, List<Path> $$2, Map<aml, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aml $$0, aez $$1, Consumer<Path> $$2) {
   ...
   public void a(aml $$0, String $$1, String $$2, amk.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<aez, ano<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(amk.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      amm.a($$1, $$4, $$3, $$0);
   }
   ...
   public ano<InputStream> a(aml $$0, aez $$1) {
      return (ano<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && amm.a($$5)) {
               return ano.create($$5);
            }
         }
   ...
   public <T> T a(amw<T> $$0) {
      ano<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public anz c() {
      return $$0 -> Optional.ofNullable(this.a(aml.a, $$0)).map($$0x -> new anu(this, $$0x));
   }
}
