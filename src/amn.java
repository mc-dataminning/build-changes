...
public interface amn {
   amn a = new amn() {
      ...
      @Override
      public void a(Consumer<csp> $$0) {
      }
   };

   static amn a(csp $$0, int $$1) {
      return new amn.a($$0, $$1);
   }

   static void a(amn $$0, amn $$1, Consumer<csp> $$2, Consumer<csp> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof amn.a $$4 && $$1 instanceof amn.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new csp($$10, $$11));
                     } else {
                        $$3.accept(new csp($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(csp b, int c) implements amn {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(amn.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return amn.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
