...
public class amn extends ams {
   ...
   private Set<amo<?>> d() {
      Set<amo<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   protected String b() {
      Map<amq<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<amo<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<amo<?>>)$$3.next();
         amo<?> $$2 = (amo<?>)$$1.getKey();
      ...
      for (Entry<amq<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   public void a(aig $$0) {
      Object2IntMap<amo<?>> $$1 = new Object2IntOpenHashMap();
