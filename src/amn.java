...
public class amn {
   ...
   public amn(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<amn.a> b(Scanner $$0) {
      alh<djx> $$1 = (alh<djx>)amw.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amn.a($$1, new ffq((double)$$2, (double)$$3, (double)$$4), new ffp($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<art> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            art $$2 = $$1.get(0);
            ars $$3 = this.e.J();
            ej $$4 = new ej($$2.z(), ffq.a($$3.aa()), ffp.a, $$3, 4, "", wz.a, this.e, $$2);
            ek $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(alh<djx> a, ffq b, ffp c) {
   }
}
