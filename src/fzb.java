...
public class fzb {
   ...
   public void a(final fyz $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final gad $$3 = gad.a($$0.b);
      Optional<InetSocketAddress> $$4 = gaf.a.a($$3).map(gac::d);
      if ($$4.isEmpty()) {
         this.a(fmk.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final gad $$1, final fyz $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vp.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fys($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(fyz.b.d);
               $$2.h = wu.b($$2xx);
               $$2.d = wu.b($$3);
               $$2.c = fzb.a($$4, $$5);
