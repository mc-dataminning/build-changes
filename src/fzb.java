...
public class fzb extends fty {
   ...
   public fzb(fty $$0, avg $$1, Consumer<avg> $$2) {
      super(a);
      this.s = $$0;
      this.u = $$1;
      this.v = $$2;
   ...
   protected void aT_() {
      this.d.a(a, this.p);
      fry $$0 = this.d.c(fry.d());
      $$0.a(new fpa(b, this.p).d(310), $$0x -> $$0x.e(15));
      fzg.a $$1 = fzg.a(310).a(2, true).b(4);
      this.w.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.w.getBoolean($$1x), $$1xx -> this.w.put($$1x, $$1xx)).a($$1x.c()));
      $$1.a($$0::a);
      fry $$2 = this.d.b(fry.e().a(8));
      $$2.a(fof.a(xu.d, $$0x -> this.l()).a());
      $$2.a(fof.a(xu.e, $$0x -> this.aP_()).a());
      this.d.a($$1x -> {
