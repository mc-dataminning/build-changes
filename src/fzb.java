...
public class fzb extends gaf {
   public static final double a = 7.0;
   private static final xc c = xc.c("chat_screen.usage");
   ...
   protected void aS_() {
      ...
      this.b = new fuw(this.m.i, 4, this.o - 12, this.n - 4, 12, xc.c("chat.editBox")) {
         @Override
         protected xq d() {
            return super.d().b(fzb.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fuq(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(ftz $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fqz $$4 = this.m.m.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.p, this.p.c($$4.g(), 210), $$1, $$2);
      } else {
         xz $$5 = this.b((double)$$1, (double)$$2);
         if ($$5 != null && $$5.j() != null) {
            $$0.a(this.p, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(fyk $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fyj.a, xc.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private xz b(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return bap.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
