...
public class fzb extends fza implements abc, wn {
   private static final Logger m = LogUtils.getLogger();
   private final GameProfile n;
   private cpl o;
   private final ka.b p;
   private final fzq q = new fzq();
   @Nullable
   private fzj r;
   @Nullable
   protected fil.b l;

   public fzb(fgm $$0, vt $$1, fzh $$2) {
      super($$0, $$1, $$2);
      this.n = $$2.a();
      this.p = $$2.c();
      this.o = $$2.d();
   ...
   public void a(abd $$0) {
      ...
      this.b
         .a(agh.b.a(wk.a($$1)), new fze(this.a, this.b, new fzh(this.n, this.e, $$1, this.o, this.d, this.c, this.f, this.i, this.l, this.h, this.j, this.k)));
      this.b.a(abl.a);
