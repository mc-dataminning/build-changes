...
public class aej {
   ...
   private static final Object2IntMap<Class<? extends bis>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final bis d;
   private final Int2ObjectMap<aej.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> aeg<T> a(Class<? extends bis> $$0, aeh<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(aeg<T> $$0, T $$1) {
      aej.a<T> $$2 = new aej.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(aeg<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> aej.a<T> c(aeg<T> $$0) {
      this.f.readLock().lock();

      aej.a<T> $$1;
      try {
         $$1 = (aej.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(aeg<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(aeg<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(aeg<T> $$0, T $$1, boolean $$2) {
      aej.a<T> $$3 = this.c($$0);
   ...
   private <T> void a(aej.a<T> $$0, aej.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public aej.b<T> e() {
         return aej.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, aeh<T> b, T c) {

      public static <T> aej.b<T> a(aeg<T> $$0, T $$1) {
         aeh<T> $$2 = $$0.b();
         return new aej.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static aej.b<?> a(sq $$0, int $$1) {
         int $$2 = $$0.m();
         aeh<?> $$3 = aei.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aej.b<T> a(sq $$0, int $$1, aeh<T> $$2) {
         return new aej.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
