...
public abstract class bln extends bll implements bmh {
   private static final afs<Byte> b = afv.a(bln.class, afu.a);
   private static final int c = 1;
   private static final int d = 2;
   private static final int e = 4;
   protected static final int f = 1;
   private static final ja bS = new ja(1, 0, 1);
   ...
   protected brj bL;
   protected brh bM;
   private final bre bU;
   protected buu bN;
   protected final bsh bO;
   protected final bsh bP;
   @Nullable
   private bll bV;
   private final bvp bW;
   private final ip<clo> bX = ip.a(2, clo.b);
   protected final float[] bQ = new float[2];
   private final ip<clo> bY = ip.a(4, clo.b);
   protected final float[] bR = new float[4];
   private boolean bZ;
   private boolean ca;
   private final Map<edi, Float> cb = Maps.newEnumMap(edi.class);
   @Nullable
   private agm cc;
   private long cd;
   @Nullable
   ...
   protected bln(bkz<? extends bln> $$0, csf $$1) {
      super($$0, $$1);
      this.bO = new bsh($$1.af());
      this.bP = new bsh($$1.af());
      this.bK = new bri(this);
      this.bL = new brj(this);
      this.bM = new brh(this);
      this.bU = this.H();
      this.bN = this.b($$1);
      this.bW = new bvp(this);
   ...
   public static bmq.a C() {
      return bll.dR().a(bmr.g, 16.0).a(bmr.d);
   }
   ...
   public float a(edi $$0) {
      bln $$2;
      label17: {
         if (this.db() instanceof bln $$1 && $$1.D()) {
            $$2 = $$1;
            break label17;
         }
   ...
   public brj K() {
      return this.db() instanceof bln $$0 ? $$0.K() : this.bL;
   }
   ...
   public buu N() {
      return this.db() instanceof bln $$0 ? $$0.N() : this.bN;
   }
   ...
   public bll cO() {
      bkv $$0 = this.cR();
      if (!this.fV() && $$0 instanceof bln $$1 && $$0.bR()) {
         return $$1;
      }
   ...
   public void S() {
      if (this.dN().B) {
         for (int $$0 = 0; $$0 < 20; $$0++) {
            ...
            double $$4 = 10.0;
            this.dN().a(jw.W, this.c(1.0) - $$1 * 10.0, this.dv() - $$2 * 10.0, this.g(1.0) - $$3 * 10.0, $$1, $$2, $$3);
         }
      } else {
   ...
   protected void T() {
      boolean $$0 = !(this.cO() instanceof bln);
   ...
   public void b(sd $$0) {
      ...
      if (this.ce != null) {
         sd $$11 = new sd();
         if (this.ce instanceof bll) {
            UUID $$12 = this.ce.cw();
            $$11.a("UUID", $$12);
         } else if (this.ce instanceof cak) {
            hx $$13 = ((cak)this.ce).E();
            $$11.a("X", $$13.u());
            $$11.a("Y", $$13.v());
            $$11.a("Z", $$13.w());
   ...
   public void a(sd $$0) {
      ...
      if ($$0.b("HandItems", 9)) {
         ...
         for (int $$4 = 0; $$4 < this.bX.size(); $$4++) {
            this.bX.set($$4, clo.a($$3.a($$4)));
         }
      }

      if ($$0.b("ArmorDropChances", 9)) {
         sj $$5 = $$0.c("ArmorDropChances", 5);
      ...
      if ($$0.b("DeathLootTable", 8)) {
         this.cc = new agm($$0.l("DeathLootTable"));
   ...
   public void d_() {
      ...
      if (!this.dN().B && this.fL() && this.bx() && !this.ba && this.dN().Y().b(csb.c)) {
         ja $$0 = this.V();

         for (cas $$2 : this.dN().a(cas.class, this.cH().c((double)$$0.u(), (double)$$0.v(), (double)$$0.w()))) {
   ...
   protected boolean b(clo $$0, clo $$1) {
      if ($$1.b()) {
         return true;
      } else if ($$0.d() instanceof cmz) {
         if (!($$1.d() instanceof cmz)) {
            return true;
         } else {
            cmz $$2 = (cmz)$$0.d();
            cmz $$3 = (cmz)$$1.d();
      ...
      } else if ($$0.d() instanceof cjm && $$1.d() instanceof cjm) {
         return this.c($$0, $$1);
      } else if ($$0.d() instanceof cjw && $$1.d() instanceof cjw) {
         return this.c($$0, $$1);
      } else if ($$0.d() instanceof ciy $$4) {
         if (cqb.d($$1)) {
            return false;
         } else if (!($$1.d() instanceof ciy)) {
            return true;
         } else {
            ciy $$5 = (ciy)$$1.d();
            if ($$4.e() != $$5.e()) {
         ...
         if ($$0.d() instanceof cjy) {
            if ($$1.d() instanceof cjh) {
               return true;
            }

            if ($$1.d() instanceof cjy $$6) {
               cjy $$7 = (cjy)$$0.d();
               if ($$7.d() != $$6.d()) {
                  return $$7.d() > $$6.d();
               }
   ...
   public void a(bkv $$0, float $$1, float $$2) {
      ...
      float $$9 = (float)(atq.d($$4, $$3) * 180.0F / (float)Math.PI) - 90.0F;
      float $$10 = (float)(-(atq.d($$6, $$8) * 180.0F / (float)Math.PI));
   ...
   public static boolean a(bkz<? extends bln> $$0, csg $$1, blp $$2, hx $$3, atw $$4) {
      hx $$5 = $$3.d();
      return $$2 == blp.c || $$1.a_($$5).a($$1, $$5, $$0);
   }
   ...
   protected void a(bjt $$0, int $$1, boolean $$2) {
      ...
      for (bla $$3 : bla.values()) {
         clo $$4 = this.c($$3);
         float $$5 = this.f($$3);
         boolean $$6 = $$5 > 1.0F;
         if (!$$4.b() && !cqb.e($$4) && ($$2 || $$6) && Math.max(this.ag.i() - (float)$$1 * 0.01F, 0.0F) < $$5) {
            if (!$$6 && $$4.i()) {
   ...
   protected void a(atw $$0, biz $$1) {
      if ($$0.i() < 0.15F * $$1.d()) {
         int $$2 = $$0.a(2);
         float $$3 = this.dN().aj() == biy.d ? 0.1F : 0.25F;
         if ($$0.i() < 0.095F) {
            $$2++;
         }
   ...
   @Nullable
   public static clj a(bla $$0, int $$1) {
      switch ($$0) {
         case f:
            if ($$1 == 0) {
               return clr.pv;
   ...
   protected void a(atw $$0, float $$1) {
      if (!this.eU().b() && $$0.i() < 0.25F * $$1) {
         this.a(bla.a, cqb.a($$0, this.eU(), (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }

   protected void a(atw $$0, float $$1, bla $$2) {
      clo $$3 = this.c($$2);
      if (!$$3.b() && $$0.i() < 0.5F * $$1) {
         this.a($$2, cqb.a($$0, $$3, (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }
   ...
   public bme a(csu $$0, biz $$1, blp $$2, @Nullable bme $$3, @Nullable sd $$4) {
      atw $$5 = $$0.F_();
      this.a(bmr.g).c(new bmp("Random spawn bonus", $$5.a(0.0, 0.11485000000000001), bmp.a.b));
      if ($$5.i() < 0.05F) {
         this.u(true);
      } else {
         this.u(false);
   ...
   @Override
   public final bjb a(cdz $$0, bja $$1) {
      if (!this.bx()) {
         return bjb.d;
      } else if (this.fU() == $$0) {
         this.a(true, !$$0.fU().d);
   ...
   private bjb c(cdz $$0, bja $$1) {
      clo $$2 = $$0.b($$1);
      if ($$2.a(clr.uC) && this.a($$0)) {
         this.b($$0, true);
         $$2.h(1);
         return bjb.a(this.dN().B);
      } else {
         ...
         if ($$2.d() instanceof cmt) {
            if (this.dN() instanceof ami) {
               cmt $$4 = (cmt)$$2.d();
               Optional<bln> $$5 = $$4.a($$0, this, (bkz<? extends bln>)this.ai(), (ami)this.dN(), this.dl(), $$2);
               $$5.ifPresent($$1x -> this.a($$0, $$1x));
               return $$5.isPresent() ? bjb.a : bjb.d;
            } else {
               return bjb.b;
            }
         } else {
   ...
   @Nullable
   public <T extends bln> T a(bkz<T> $$0, boolean $$1) {
      if (this.dI()) {
         return null;
      } else {
         T $$2 = (T)$$0.a(this.dN());
   ...
   public void a(boolean $$0, boolean $$1) {
      if (this.ce != null) {
         ...
         if (!this.dN().B && $$0 && this.dN() instanceof ami) {
            ((ami)this.dN()).k().b(this, new abj(this, null));
         }
      }
   }

   public boolean a(cdz $$0) {
      return !this.fT() && !(this instanceof cbf);
   }
   ...
   public void b(bkv $$0, boolean $$1) {
      this.ce = $$0;
      this.cg = null;
      if (!this.dN().B && $$1 && this.dN() instanceof ami) {
         ((ami)this.dN()).k().b(this, new abj(this, this.ce));
      }
   ...
   private void gb() {
      if (this.cg != null && this.dN() instanceof ami) {
         if (this.cg.b("UUID")) {
            UUID $$0 = this.cg.a("UUID");
            bkv $$1 = ((ami)this.dN()).a($$0);
            if ($$1 != null) {
               this.b($$1, true);
               return;
            }
   ...
   @Override
   public blf fn() {
      return this.fW() ? blf.a : blf.b;
   }

   public boolean i(bll $$0) {
   ...
   protected eju fY() {
      ...
      if ($$0 != null) {
         eju $$1 = $$0.cH();
         eju $$2 = this.cH();
         $$3 = new eju(Math.min($$2.a, $$1.a), $$2.b, Math.min($$2.c, $$1.c), Math.max($$2.d, $$1.d), $$2.e, Math.max($$2.f, $$1.f));
      } else {
         $$3 = this.cH();
      }
   ...
   public boolean C(bkv $$0) {
      ...
      float $$2 = (float)this.b(bmr.d);
      if ($$0 instanceof bll) {
         $$1 += cqb.a(this.eU(), ((bll)$$0).eT());
         $$2 += (float)cqb.c(this);
      }
      ...
      boolean $$4 = $$0.a(this.dO().b((bll)this), $$1);
      if ($$4) {
         if ($$2 > 0.0F && $$0 instanceof bll) {
            ((bll)$$0).q((double)($$2 * 0.5F), (double)atq.a(this.dD() * (float) (Math.PI / 180.0)), (double)(-atq.b(this.dD() * (float) (Math.PI / 180.0))));
            this.g(this.dq().d(0.6, 1.0, 0.6));
         }

         if ($$0 instanceof cdz $$5) {
            this.a($$5, this.eU(), $$5.fo() ? $$5.fq() : clo.b);
         }
   ...
   private void a(cdz $$0, clo $$1, clo $$2) {
      if (!$$1.b() && !$$2.b() && $$1.d() instanceof cjd && $$2.a(clr.vk)) {
         float $$3 = 0.25F + (float)cqb.g(this) * 0.05F;
         if (this.ag.i() < $$3) {
            $$0.go().a(clr.vk, 100);
            this.dN().a($$0, (byte)30);
         }
   ...
   protected boolean fZ() {
      if (this.dN().O() && !this.dN().B) {
         float $$0 = this.bo();
         hx $$1 = hx.a(this.ds(), this.dw(), this.dy());
