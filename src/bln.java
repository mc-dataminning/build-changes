...
public class bln {
   ...
   private bln(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bln a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bln($$0, $$1);
   }

   public bln.d a() throws IOException {
      bln.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bln.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bln.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bln.c $$3 = bln.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bln.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bln.a($$0, $$3);
            }
         }
   ...
   public bln.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bln.c> $$2 = this.a().c();
      ...
      bln.e $$4 = new bln.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bln.c b) implements bln.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bln.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bln.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bln.b> {
      private final List<bln.b> a;

      d(List<bln.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bln.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bln.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bln.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bln.d a() {
         ListIterator<bln.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bln.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bln.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bln.b> b() {
         return this.a.stream();
      }

      public Set<bln.c> c() {
         return this.a.stream().map(bln.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bln.c b) implements bln.b {
