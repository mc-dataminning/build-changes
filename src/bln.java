...
public class bln extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return blq.a(new Dynamic($$0, $$1), bln.a, blq.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bgx.s.typeName()) ? super.getChoiceType($$0, bii.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bgx.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bgx.s, () -> DSL.optionalFields("components", bgx.w.in($$0), DSL.taggedChoiceLazy("id", bii.a(), $$2)));
      $$0.registerType(
         true,
         bgx.t,
         () -> DSL.hook(
