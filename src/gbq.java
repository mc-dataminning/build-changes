...
public class gbq implements gcj {
   ...
   private CompletableFuture<Optional<coj>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gbq(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(coj::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<coj>> a(Optional<coj> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = coj.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable coj $$0) {
      ...
      if ($$0 != null) {
         if (ab.aW) {
            coj.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private coj a(UserApiService $$0) throws ayi, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cok.a $$2 = a($$1);
         return new coj(ayh.a($$1.keyPair().privateKey()), new cok($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cok.a a(KeyPairResponse $$0) throws ayi {
      KeyPair $$1 = $$0.keyPair();
