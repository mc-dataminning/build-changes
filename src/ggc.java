...
public final class ggc {
   ...
   public boolean l;
   private final List<ggc.a> m;
   private final Map<String, ggc> n;
   private gge o = gge.a;

   public ggc(List<ggc.a> $$0, Map<String, ggc> $$1) {
      this.m = $$0;
      this.n = $$1;
   }

   public gge a() {
      return gge.a(this.b, this.c, this.d, this.e, this.f, this.g);
   }
   ...
   public void a(fgr $$0, ggc.d $$1) {
      this.a($$0, $$1, "");
   }

   private void a(fgr $$0, ggc.d $$1, String $$2) {
      if (!this.m.isEmpty() || !this.n.isEmpty()) {
         $$0.a();
         this.a($$0);
         fgr.a $$3 = $$0.c();
   ...
   public Stream<ggc> e() {
      return Stream.concat(Stream.of(this), this.n.values().stream().flatMap(ggc::e));
   }

   public static class a {
      public final ggc.b[] a;
      ...
      public a(
         ...
         ggc.c $$19 = new ggc.c($$2, $$3, $$4, 0.0F, 0.0F);
         ggc.c $$20 = new ggc.c($$15, $$3, $$4, 0.0F, 8.0F);
         ggc.c $$21 = new ggc.c($$15, $$16, $$4, 8.0F, 8.0F);
         ggc.c $$22 = new ggc.c($$2, $$16, $$4, 8.0F, 0.0F);
         ggc.c $$23 = new ggc.c($$2, $$3, $$17, 0.0F, 0.0F);
         ggc.c $$24 = new ggc.c($$15, $$3, $$17, 0.0F, 8.0F);
         ggc.c $$25 = new ggc.c($$15, $$16, $$17, 8.0F, 8.0F);
         ggc.c $$26 = new ggc.c($$2, $$16, $$17, 8.0F, 0.0F);
         float $$27 = (float)$$0;
         float $$28 = (float)$$0 + $$7;
         ...
         int $$36 = 0;
         if ($$14.contains(jn.a)) {
            this.a[$$36++] = new ggc.b(new ggc.c[]{$$24, $$23, $$19, $$20}, $$28, $$33, $$29, $$34, $$12, $$13, $$11, jn.a);
         }

         if ($$14.contains(jn.b)) {
            this.a[$$36++] = new ggc.b(new ggc.c[]{$$21, $$22, $$26, $$25}, $$29, $$34, $$30, $$33, $$12, $$13, $$11, jn.b);
         }

         if ($$14.contains(jn.e)) {
            this.a[$$36++] = new ggc.b(new ggc.c[]{$$19, $$23, $$26, $$22}, $$27, $$34, $$28, $$35, $$12, $$13, $$11, jn.e);
         }

         if ($$14.contains(jn.c)) {
            this.a[$$36++] = new ggc.b(new ggc.c[]{$$20, $$19, $$22, $$21}, $$28, $$34, $$29, $$35, $$12, $$13, $$11, jn.c);
         }

         if ($$14.contains(jn.f)) {
            this.a[$$36++] = new ggc.b(new ggc.c[]{$$24, $$20, $$21, $$25}, $$29, $$34, $$31, $$35, $$12, $$13, $$11, jn.f);
         }

         if ($$14.contains(jn.d)) {
            this.a[$$36] = new ggc.b(new ggc.c[]{$$23, $$24, $$25, $$26}, $$31, $$34, $$32, $$35, $$12, $$13, $$11, jn.d);
         }
      }
   ...
   public static record b(ggc.c[] a, Vector3f b) {

      public b(ggc.c[] $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, boolean $$7, jn $$8) {
         this($$0, $$8.m());
         float $$9 = 0.0F / $$5;
         float $$10 = 0.0F / $$6;
   ...
   public static record c(Vector3f a, float b, float c) {
      ...
      public ggc.c a(float $$0, float $$1) {
         return new ggc.c(this.a, $$0, $$1);
      }
   }

   @FunctionalInterface
   public interface d {
      void visit(fgr.a var1, String var2, int var3, ggc.a var4);
   }
}
