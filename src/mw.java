...
public class mw implements mi {
   private final mk d;
   private final CompletableFuture<jt.a> e;

   public mw(mk $$0, CompletableFuture<jt.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public CompletableFuture<?> a(mg $$0) {
      Path $$1 = this.d.a(mk.b.c).resolve("blocks.json");
      return this.e
         .thenCompose(
            $$2 -> {
               ...
               $$2.d(mc.f)
                  ...
                  .forEach(
                     $$2x -> {
                        ...
                        $$3x.add("states", $$9);
                        String $$14 = $$2x.g();
                        JsonElement $$15 = (JsonElement)djn.a
                           .codec()
                           .encodeStart($$4, (djm)$$2x.a())
