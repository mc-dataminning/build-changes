...
public record czi(int c, int d, jj<cyv> e, Optional<czi.a> f) {
   private static final int g = 3;
   public static final MapCodec<czi> a = czi.a.a
      .flatXmap(czi::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final zc<wp, czi> b = zc.a(czi::a, czi::b);

   public static czi a(Map<Character, cyv> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static czi a(Map<Character, cyv> $$0, List<String> $$1) {
      czi.a $$2 = new czi.a($$0, $$1);
      return ad.a(a($$2), IllegalArgumentException::new);
   }
   ...
   private boolean a(cpw $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static czi b(wp $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jj<cyv> $$3 = jj.a($$1 * $$2, cyv.a);
      $$3.replaceAll($$1x -> cyv.b.decode($$0));
   ...
   public Optional<czi.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cyv> b, List<String> c) {
      ...
      public static final MapCodec<czi.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(axu.d(e, cyv.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, czi.a::new)
      );

      public Map<Character, cyv> a() {
         return this.b;
      }
