...
public class atw {
   ...
   public static final Codec<Object> b = a(auh.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(aue.e($$0));
   ...
   public static final Codec<atw.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ahg.b($$0.substring(1)).map($$0x -> new atw.f($$0x, true)) : ahg.b($$0).map($$0x -> new atw.f($$0x, false)), atw.f::c
      );
   ...
   private static final MapCodec<GameProfile> z = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ja.d.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !ahg.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> atw.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new atw.b<>($$0, $$1);
   }

   public static <K, V> atw.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new atw.e<>($$0, $$1);
   }
   ...
   public static <T> Codec<il<T>> b(Codec<il<T>> $$0) {
      return a(
         $$0,
         (Function<il<T>, DataResult<il<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof atw.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(ahg a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
