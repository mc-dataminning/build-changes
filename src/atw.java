...
class atw implements Path {
   private static final BasicFileAttributes a = new atu() {
      @Override
   ...
   private static final BasicFileAttributes b = new atu() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atw> c = Comparator.comparing(atw::n);
   ...
   public atw(aty $$0, String $$1, @Nullable atw $$2, atz $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atw a(@Nullable atw $$0, String $$1) {
      return new atw(this.e, $$1, $$0, atz.b);
   }
   ...
   atw a(String $$0) {
      if (a(this.i)) {
         return new atw(this.e, $$0, this, this.i);
      } else if (this.i instanceof atz.a $$1) {
         atw $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atw(this.e, $$0, this, atz.a);
      } else if (this.i instanceof atz.b) {
         return new atw(this.e, $$0, this, atz.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atz $$0) {
      return $$0 == atz.a || $$0 == atz.b;
   }
   ...
   private atw c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atw $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atz.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atz.a i() {
      return this.i instanceof atz.a $$0 ? $$0 : null;
   }
