...
class atw extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atv && $$1 instanceof atv && $$0.equals($$1);
   }
   ...
   private static atv a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atv) {
         return (atv)$$0;
      } else {
