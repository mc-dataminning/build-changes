...
public class gas implements amv<gar> {
   public gar b(JsonObject $$0) {
      Builder<gaq> $$1 = ImmutableList.builder();
      int $$2 = arp.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = arp.a($$0, "width", -1);
      int $$9 = arp.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = arp.a($$0, "interpolate", false);
      return new gar($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gaq a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gaq(arp.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = arp.m($$1, "frames[" + $$0 + "]");
         int $$3 = arp.a($$2, "time", -1);
         if ($$2.has("time")) {
