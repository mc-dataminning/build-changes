...
public class elr implements elq {
   ...
   public static final Codec<elr> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               egd.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               egf.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               ege.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bti.b(1, 20).fieldOf("outer_wall_distance").orElse(bto.a(4, 5)).forGetter($$0x -> $$0x.i),
               bti.b(1, 20).fieldOf("distribution_points").orElse(bto.a(3, 4)).forGetter($$0x -> $$0x.j),
               bti.b(0, 10).fieldOf("point_offset").orElse(bto.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public elr(egd $$0, egf $$1, ege $$2, double $$3, double $$4, boolean $$5, bti $$6, bti $$7, bti $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
