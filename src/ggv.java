...
public class ggv implements gha.a {
   ...
   private final fff J;
   private final Map<iz, ggv.a> K = Maps.newHashMap();
   private final Map<UUID, aau.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsu $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dK();
      });
   }

   private void b(ezy $$0, gdo $$1, double $$2, double $$3, double $$4) {
      iz $$5 = iz.a($$2, $$3, $$4);
   ...
   private static void a(ezy $$0, gdo $$1, iz $$2) {
      float $$3 = 0.05F;
      gha.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(ezy $$0, gdo $$1, iz $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gha.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(ezy $$0, gdo $$1, ggv.a $$2) {
      int $$3 = 0;
   ...
   private void a(ezy $$0, gdo $$1, aau.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghi.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(ezy $$0, gdo $$1, aau.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(ezy $$0, gdo $$1, String $$2, ggv.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }

   private static void a(ezy $$0, gdo $$1, String $$2, iz $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gha.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(ezy $$0, gdo $$1, js $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      iz $$9 = iz.a($$2);
   ...
   private Collection<UUID> b(iz $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(aau.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(iz $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(aau.a::a).collect(Collectors.toSet());
   }

   private Map<iz, List<String>> c() {
      Map<iz, List<String>> $$0 = Maps.newHashMap();

      for (aau.a $$1 : this.L.values()) {
   ...
   private void d() {
      gha.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cz());
   }
