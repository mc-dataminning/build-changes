...
public class ggv implements ghb.a {
   ...
   private final ffg A;
   private final Map<iz, ggv.a> B = new HashMap<>();
   ...
   private void b(ezz $$0, gdp $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         ...
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         ghb.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private void a(ezz $$0, gdp $$1, abe.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(ezz $$0, gdp $$1, aat.a $$2) {
      if ($$2.e() != null) {
         ghj.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(ezz $$0, gdp $$1, aat.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(ezz $$0, gdp $$1, String $$2, abe.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }
   ...
   private void g() {
      ghb.a(this.A.an(), 8).ifPresent($$0 -> this.D = $$0.cz());
   }
