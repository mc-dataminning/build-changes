...
public class ggv {
   ...
   private ggv(int $$0, List<ggx> $$1) {
      this.a = $$1.toArray(ggx[]::new);
      this.b = $$1.size();
   }

   private List<ggx> c() {
      List<ggx> $$0 = new ArrayList<>(this.d());
