...
public class ggv implements ggy.a, AutoCloseable {
   ...
   eri[] f;
   @Nullable
   private final ggv.a g;
   private final asd h;

   public ggv(aiy $$0, gin $$1, eri $$2, asd $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gil $$4 = $$3.a(gil.a).orElse(gil.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eri[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = ggq.a(this.f, $$0);
   ...
   @Nullable
   private ggv.a a(gin $$0, int $$1, int $$2, gil $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<ggv.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new ggv.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new ggv.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<ggv.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            ggv.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new ggv.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eri[] $$4) {
   ...
   class a {
      ...
      a(List<ggv.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * ggv.this.c;
         int $$4 = this.b($$2) * ggv.this.d;
         ggv.this.a($$0, $$1, $$3, $$4, ggv.this.f);
      }

      public ggx a() {
         return ggv.this.new d(this, this.d ? ggv.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eri[] b = new eri[ggv.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = ggv.this.c >> $$0;
            int $$2 = ggv.this.d >> $$0;
            this.b[$$0] = new eri($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, ggv.d $$2) {
         ggv.a $$3 = $$2.d;
         List<ggv.b> $$4 = $$3.b;
         ggv.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            ggv.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(ggv.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return ggv.this.f[$$2].a($$3 + ($$0.a($$1) * ggv.this.c >> $$2), $$4 + ($$0.b($$1) * ggv.this.d >> $$2));
      }
   ...
   class d implements ggx {
      int b;
      int c;
      final ggv.a d;
      @Nullable
      private final ggv.c e;

      d(ggv.a $$0, @Nullable ggv.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
