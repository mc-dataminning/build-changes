public class gis extends gjn {
   ...
   gis(gff $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gji $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cpo $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dD();
            if (this.h > $$1) {
   ...
   public static class a implements giq<lw> {
      ...
      public gin a(lw $$0, gff $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gis($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements giq<lw> {
      ...
      public gin a(lw $$0, gff $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gin $$8 = new gis($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
