...
public class gis {
   ...
   public static class a extends Thread {
      private final gis.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gis.b $$0) throws IOException {
         super("LanServerDetector #" + gis.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gis.b));
   ...
   public static class b {
      private final List<gir> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gir> a() {
         if (this.b) {
            List<gir> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
