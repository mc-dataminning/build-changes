...
public class fgr extends ffl {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   public static final fgr.a k = new fgr.a() {
      @Override
      public int a() {
         return 0;
      }
   ...
   private fgr.a q;
   private int r;
   private List<avu> t = Collections.emptyList();
   private int u = -1;
   private vq v = vp.a;
   private fhs w;
   private fhs x;
   ...
   private fgr(fgr.a $$0, boolean $$1) {
      super(exg.a);
      this.q = $$0;
      this.y = $$1;
   }

   public void a(fgr.a $$0) {
      this.q = $$0;
      this.r = awi.a(this.r, 0, $$0.a());
      this.L();
      this.u = -1;
   }

   public boolean a(int $$0) {
      int $$1 = awi.a($$0, 0, this.q.a() - 1);
      if ($$1 != this.r) {
         this.r = $$1;
         this.L();
         this.u = -1;
   ...
   protected void o() {
      this.c(ezo.a(vp.d, $$0 -> this.d()).a(this.g / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.w = this.c(new fhs($$0 + 116, 159, true, $$0x -> this.J(), this.y));
      this.x = this.c(new fhs($$0 + 43, 159, false, $$0x -> this.I(), this.y));
      this.L();
   }
   ...
   public wn b(double $$0, double $$1) {
      if (this.t.isEmpty()) {
         ...
         int $$2 = awi.a($$0 - (double)((this.g - 192) / 2) - 36.0);
         int $$3 = awi.a($$1 - 2.0 - 30.0);
         if ($$2 >= 0 && $$3 >= 0) {
   ...
   public static void a(sw $$0, Consumer<String> $$1) {
      ...
      if (exo.P().aR() && $$0.b("filtered_pages", 10)) {
   ...
   public interface a {
      ...
      static fgr.a a(cpd $$0) {
         if ($$0.a(cpg.tX)) {
            return new fgr.c($$0);
         } else {
            return (fgr.a)($$0.a(cpg.tW) ? new fgr.b($$0) : fgr.k);
         }
      }
   }

   public static class b implements fgr.a {
      ...
      private static List<String> b(cpd $$0) {
         sw $$1 = $$0.w();
         return (List<String>)($$1 != null ? fgr.a($$1) : ImmutableList.of());
      }
   ...
   public static class c implements fgr.a {
      private final List<String> a;
      ...
      private static List<String> b(cpd $$0) {
         sw $$1 = $$0.w();
         return (List<String>)($$1 != null && cqy.a($$1) ? fgr.a($$1) : ImmutableList.of(vq.a.a(vq.c("book.invalid.tag").a(n.e))));
      }
