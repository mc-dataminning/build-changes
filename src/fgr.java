...
public class fgr {
   ...
   public void a(fgr.b $$0, List<asp> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fgr.c($$0, $$1.stream().map(asp::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fgr.c(fgr.b.c, ImmutableList.of());
      }

      this.b.c = new fgr.a($$0);
   }
   ...
   static class c {
      private final fgr.b a;
      private final List<String> b;
      @Nullable
      fgr.a c;
      boolean d;

      c(fgr.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
