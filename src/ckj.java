   ...
   public void a(ard $$0) {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new fba($$1, this.g.dC() + $$6, $$2);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               fba $$9 = new fba(this.g.dA() - this.a.dA(), 0.0, this.g.dG() - this.a.dG()).d();
               fba $$10 = new fba((double)ayz.a(this.a.dL() * (float) (Math.PI / 180.0)), 0.0, (double)(-ayz.b(this.a.dL() * (float) (Math.PI / 180.0)))).d();
