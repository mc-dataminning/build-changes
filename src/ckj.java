...
public class ckj extends cok {
   private static final Predicate<bsv> e = $$0 -> $$0.bD() && !($$0 instanceof ckj);
   ...
   public ckj(btb<? extends ckj> $$0, dbz $$1) {
      super($$0, $$1);
      this.bN = 20;
      this.a(eon.v, 0.0F);
   }
   ...
   protected void z() {
      ...
      this.bS.a(4, new cay(this, 1.0, true));
      this.bS.a(5, new ccb(this, 0.4));
      this.bS.a(6, new caw(this, cmy.class, 6.0F));
      this.bS.a(10, new caw(this, bts.class, 8.0F));
      this.bT.a(2, new ccg(this, cok.class).a());
      this.bT.a(3, new cch<>(this, cmy.class, true));
      this.bT.a(4, new cch<>(this, cmg.class, true, $$0 -> !$$0.p_()));
      this.bT.a(4, new cch<>(this, cfs.class, true));
   }

   @Override
   protected void S() {
      boolean $$0 = !(this.cQ() instanceof bts) || this.cQ().ak().a(awt.c);
   ...
   public static bux.a s() {
      return cke.gw().a(buy.q, 100.0).a(buy.r, 0.3).a(buy.n, 0.75).a(buy.c, 12.0).a(buy.d, 1.5).a(buy.k, 32.0).a(buy.v, 1.0);
   }
   ...
   public void n_() {
      ...
      if (this.bD()) {
         if (this.fg()) {
            ...
            double $$1 = this.f(buy.r).b();
            this.f(buy.r).a(ayz.d(0.1, $$1, $$0));
         }

         if (this.Q && this.dP().ab().b(dbv.c)) {
            boolean $$2 = false;
            evn $$3 = this.cK().g(0.2);
   ...
   private void gC() {
      if (this.bD()) {
         for (btq $$1 : this.dP().a(btq.class, this.cK().g(4.0), e)) {
            if (!($$1 instanceof cjl)) {
               $$1.a(this.dQ().b((btq)this), 6.0F);
            }
