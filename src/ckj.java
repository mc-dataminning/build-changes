...
public class ckj {
   ...
   protected static byj<?> a(byj<cki> $$0) {
      b($$0);
      c($$0);
   ...
   private static void b(byj<cki> $$0) {
      $$0.a(ctg.a, 0, ImmutableList.of(new cbu(0.8F), new byv(2.5F), new cag(45, 90), new cak(), new bzg(cgl.aP), new bzg(cgl.aQ)));
   }

   private static void c(byj<cki> $$0) {
      $$0.a(
         ctg.b,
         ImmutableList.of(
            Pair.of(0, bzu.a($$0x -> true, 1.75F, true, 32)),
            Pair.of(1, new bzq(ckj::b, 2.25F, 20)),
            Pair.of(2, cbo.a(ckj::b, Predicate.not(ckj::c), 4, 16, 2.25F)),
   ...
   private static boolean a(bxj $$0, byj<?> $$1, je $$2) {
      ...
      djm $$4 = $$0.dU();
      return $$2.a($$4.aj(), $$0.du(), 1024) && $$4.a_($$2.b()).a(dmt.bf) && $$3.isPresent();
   }
