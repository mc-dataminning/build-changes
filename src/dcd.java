...
public interface dcd extends dbd, dbk, dcq, ddb.a {
   @Nullable
   dua a(int var1, int var2, duz var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dxw.a var1, int var2, int var3);

   int B_();

   ddb F_();

   default ji<dcz> t(iz $$0) {
      return this.F_().a($$0);
   }

   default Stream<dse> c(evo $$0) {
      int $$1 = ayz.a($$0.a);
      int $$2 = ayz.a($$0.d);
      int $$3 = ayz.a($$0.b);
      int $$4 = ayz.a($$0.e);
   ...
   @Override
   default int a(iz $$0, dbl $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ji<dcz> getNoiseBiome(int $$0, int $$1, int $$2) {
      dua $$3 = this.a(jt.e($$0), jt.e($$2), duz.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ji<dcz> a(int var1, int var2, int var3);
   ...
   default dua a(int $$0, int $$1) {
      return this.a($$0, $$1, duz.n, true);
   }

   default dua a(int $$0, int $$1, duz $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbg c(int $$0, int $$1) {
