...
public class dcd {
   ...
   private final Map<akt<dbv<?>>, dca<?>> c;

   private dcd(Multimap<dcg<?>, dca<?>> $$0, Map<akt<dbv<?>>, dca<?>> $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static dcd a(Iterable<dca<?>> $$0) {
      ...
      com.google.common.collect.ImmutableMap.Builder<akt<dbv<?>>, dca<?>> $$2 = ImmutableMap.builder();
