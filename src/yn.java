...
public class yn implements xd {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayy.b.validate(yn::b);
   private static final Codec<Object> e = Codec.either(d, xe.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xc $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yn> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xd.a<yn> c = new xd.a<>(b, "translatable");
   private static final xh f = xh.e("%");
   private static final xh g = xh.e("null");
   ...
   @Nullable
   private tv k;
   private List<xh> l = ImmutableList.of();
   ...
   private static yn a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yn($$0, $$1.orElse(null), a($$2));
   }

   public yn(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xh> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yo var4) {
            this.l = ImmutableList.of(xh.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xh> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yo(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xh a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xc) {
            ...
            return $$1 == null ? g : xh.e($$1.toString());
         }
      } else {
         throw new yo(this, $$0);
      }
   ...
   public xq a(@Nullable ek $$0, @Nullable bwv $$1, int $$2) throws CommandSyntaxException {
      ...
      return xq.a(new yn(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yn $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
