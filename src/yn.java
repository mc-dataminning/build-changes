...
public class yn implements ve<wx> {
   ...
   @Nullable
   private final List<ebn> d;
   @Nullable
   private final ebq.b e;

   public yn(int $$0, byte $$1, boolean $$2, @Nullable Collection<ebn> $$3, @Nullable ebq.b $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
