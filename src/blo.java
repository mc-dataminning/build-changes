...
public class blo extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return blr.a(new Dynamic($$0, $$1), blo.a, blr.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bgx.s.typeName()) ? super.getChoiceType($$0, bij.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bgx.s, () -> DSL.optionalFields("components", bgx.w.in($$0), DSL.taggedChoiceLazy("id", bij.a(), $$2)));
      $$0.registerType(
         true,
         bgx.t,
         () -> DSL.hook(
