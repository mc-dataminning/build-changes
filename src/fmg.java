...
public abstract class fmg<T extends fmg<T>> {
   ...
   public fmg(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fme.a();
         if ($$3 != null) {
         ...
         throw new fny(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fny(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fny(var2.getMessage(), var2);
      }
   }
   ...
   public static fmg<?> a(String $$0) {
      return new fmg.b($$0, 5000, 60000);
   }

   public static fmg<?> a(String $$0, int $$1, int $$2) {
      return new fmg.b($$0, $$1, $$2);
   }

   public static fmg<?> b(String $$0, String $$1) {
      return new fmg.c($$0, $$1, 5000, 60000);
   }

   public static fmg<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fmg.c($$0, $$1, $$2, $$3);
   }

   public static fmg<?> b(String $$0) {
      return new fmg.a($$0, 5000, 60000);
   }

   public static fmg<?> c(String $$0, String $$1) {
      return new fmg.d($$0, $$1, 5000, 60000);
   }

   public static fmg<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fmg.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fmg<fmg.a> {
   ...
   public static class b extends fmg<fmg.b> {
   ...
   public static class c extends fmg<fmg.c> {
      ...
      public fmg.c f() {
         try {
            ...
            throw new fny(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fmg<fmg.d> {
      private final String c;
