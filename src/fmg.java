...
public class fmg extends fly {
   ...
   private static final akm b = new akm("textures/misc/credits_vignette.png");
   ...
   private int F;
   private final fgq G = new fgq(false);

   public fmg(boolean $$0, Runnable $$1) {
      super(fdr.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fmg.a $$1) {
      try (Reader $$2 = this.m.ab().openAsReader(new akm($$0))) {
         $$1.read($$2);
