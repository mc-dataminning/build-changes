...
public class fmg {
   ...
   public void a(fmg.b $$0, List<atw> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fmg.c($$0, $$1.stream().map(atw::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fmg.c(fmg.b.c, ImmutableList.of());
      }

      this.b.c = new fmg.a($$0);
   }
   ...
   static class c {
      private final fmg.b a;
      private final List<String> b;
      @Nullable
      fmg.a c;
      boolean d;

      c(fmg.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
