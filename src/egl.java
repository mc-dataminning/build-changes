...
public class egl extends efy<ehv> {
   public egl(Codec<ehv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ega<ehv> $$0) {
      ji $$1 = $$0.e();
      dhg $$2 = $$0.b();
   ...
   private void a(azh $$0, dgj $$1, int $$2, int $$3, ji $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ji $$2, dgj $$3, boolean $$4, double $$5, ji $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dgj $$0, ji $$1) {
      if ($$0.a_($$1.d()).a(djo.ea)) {
         this.a($$0, $$1.d(), djo.a.m());
      }
   }

   private void a(dgj $$0, azh $$1, ji $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dwx $$13) {
   ...
   private void a(ji $$0, dgj $$1, azh $$2, int $$3, int $$4, boolean $$5, boolean $$6, dwx $$7) {
      dwx $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(djo.ec) || $$8.a(djo.eb) || $$8.a(djo.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(djo.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, djo.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dwx $$0) {
      return $$0.a(djo.ja) || $$0.a(djo.ec) || $$0.a(djo.ny);
   }
   ...
   private void a(dgj $$0, ji $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(djo.ea)) {
                  if (this.a((dfn)$$0, $$10)) {
                     this.a($$0, $$10, djo.a.m());
                     this.a($$0, $$10.d(), djo.a.m());
                  } else if (c($$11)) {
                     dwx[] $$12 = new dwx[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
