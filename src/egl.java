...
public class egl extends egs {
   private static final Codec<bpr> b = bpr.a
      .codec()
      .validate(
         $$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final MapCodec<egl> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bpl.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  bpl.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  bpl.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  bpl.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, egl::new)
   );
   ...
   public egl(int $$0, int $$1, int $$2, bpl $$3, bpl $$4, bpr $$5, bpl $$6) {
      super($$0, $$1, $$2);
      this.h = $$3;
      this.i = $$4;
      this.j = $$5;
      this.k = bpr.a($$5.a(), $$5.b() - 1);
      this.l = $$6;
   }
   ...
   public List<efa.a> a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, ja $$4, eek $$5) {
      ...
      List<efa.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new efa.a($$4.b($$11), 0, false));
      }

      ja.a $$16 = new ja.a();
      jf $$17 = jf.c.a.a($$2);
      Function<dsk, dsk> $$18 = $$1x -> $$1x.b(dlt.i, $$17.o());
   ...
   private efa.a a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, ja $$4, eek $$5, Function<dsk, dsk> $$6, jf $$7, int $$8, boolean $$9, ja.a $$10) {
      $$10.g($$4).c(jf.b, $$8);
