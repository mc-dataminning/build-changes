...
@Deprecated
public class egl extends efw<egl.a> {
   private static final dwv a = djm.nE.m();

   public egl(Codec<egl.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efy<egl.a> $$0) {
      ji $$1 = $$0.e();
      dhe $$2 = $$0.b();
      azg $$3 = $$0.d();
      egl.a $$4 = $$0.f();
   ...
   public static record a(ekb b, ekb c) implements eia {
      public static final Codec<egl.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ekb.a.fieldOf("fluid").forGetter(egl.a::a), ekb.a.fieldOf("barrier").forGetter(egl.a::b)).apply($$0, egl.a::new)
      );
