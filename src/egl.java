...
public class egl implements ego {
   ...
   public egl(dnt $$0, boolean $$1, boolean $$2) {
      this.c = $$0.q();
      this.a = $$1 ? new ege($$0) : null;
      this.d = $$2 ? new egp($$0) : null;
   }
   ...
   public egj a(cwa $$0) {
      if ($$0 == cwa.b) {
         return (egj)(this.a == null ? egj.a.a : this.a);
      } else {
         return (egj)(this.d == null ? egj.a.a : this.d);
      }
   }

   public String a(cwa $$0, jb $$1) {
      if ($$0 == cwa.b) {
         if (this.a != null) {
            return this.a.b($$1.s());
         }
