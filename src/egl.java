...
public class egl {
   private static final Codec<egk> f = jb.J.q().dispatch(egk::b, egj::a);
   public static final Codec<egk> a = arf.a(
      (Supplier<Codec<egk>>)(() -> {
         Codec<egk> $$0 = arf.e(f, egn.a);
   ...
   private static egj a(String $$0, Codec<? extends egk> $$1) {
      return hq.a(jb.J, new aew($$0), new egj($$1));
   }
}
