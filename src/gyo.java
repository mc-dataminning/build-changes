...
public class gyo implements ats<gyn> {
   public gyn b(JsonObject $$0) {
      Builder<gym> $$1 = ImmutableList.builder();
      int $$2 = ayt.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = ayt.a($$0, "width", -1);
      int $$9 = ayt.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = ayt.a($$0, "interpolate", false);
      return new gyn($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gym a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gym(ayt.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = ayt.m($$1, "frames[" + $$0 + "]");
         int $$3 = ayt.a($$2, "time", -1);
         if ($$2.has("time")) {
