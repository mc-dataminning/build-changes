...
public class yp<B extends ByteBuf, V, T> implements yq<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<yp.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   yp(Function<V, ? extends T> $$0, List<yp.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         wj.a($$0, $$3);
         yp.b<B, V, T> $$4 = this.c.get($$3);

         try {
            yq<? super B, V> $$5 = (yq<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> yp.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new yp.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<yp.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public yp.a<B, V, T> a(T $$0, yq<? super B, ? extends V> $$1) {
         this.a.add(new yp.b<>($$1, $$0));
         return this;
      }
      ...
      public yp<B, V, T> a() {
         ...
         return new yp<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(yq<? super B, ? extends V> a, T b) {
   }
}
