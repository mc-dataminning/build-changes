...
public class yp implements xf {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = axu.b(axu.b, yp::b);
   private static final Codec<Object> e = Codec.either(d, xg.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xe $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yp> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               axu.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, yp::a)
   );
   public static final xf.a<yp> c = new xf.a<>(b, "translatable");
   private static final xj f = xj.e("%");
   private static final xj g = xj.e("null");
   ...
   @Nullable
   private uf k;
   private List<xj> l = ImmutableList.of();
   ...
   private static yp a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yp($$0, $$1.orElse(null), a($$2));
   }

   public yp(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xj> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yq var4) {
            this.l = ImmutableList.of(xj.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xj> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yq(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xj a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xe) {
            ...
            return $$1 == null ? g : xj.e($$1.toString());
         }
      } else {
         throw new yq(this, $$0);
      }
   ...
   public xs a(@Nullable eh $$0, @Nullable brv $$1, int $$2) throws CommandSyntaxException {
      ...
      return xs.a(new yp(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yp $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
