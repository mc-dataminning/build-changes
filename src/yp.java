...
public class yp implements wu<yo> {
   ...
   public yp(blf $$0, int $$1) {
      this($$0.aj(), $$0.cw(), $$0.dr(), $$0.dt(), $$0.dx(), $$0.dE(), $$0.dC(), $$0.ai(), $$1, $$0.dp(), (double)$$0.cp());
   }

   public yp(blf $$0, int $$1, hv $$2) {
      this($$0.aj(), $$0.cw(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dE(), $$0.dC(), $$0.ai(), $$1, $$0.dp(), (double)$$0.cp());
   }

   public yp(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, blj<?> $$7, int $$8, elb $$9, double $$10) {
      this.c = $$0;
      this.d = $$1;
      this.f = $$2;
      this.g = $$3;
      this.h = $$4;
      this.l = (byte)aty.d($$5 * 256.0F / 360.0F);
      this.m = (byte)aty.d($$6 * 256.0F / 360.0F);
      this.n = (byte)aty.a($$10 * 256.0 / 360.0);
      this.e = $$7;
      this.o = $$8;
      this.i = (int)(aty.a($$9.c, -3.9, 3.9) * 8000.0);
      this.j = (int)(aty.a($$9.d, -3.9, 3.9) * 8000.0);
      this.k = (int)(aty.a($$9.e, -3.9, 3.9) * 8000.0);
   }
