...
public class giw extends gjl {
   private static final float a = 1.0472F;
   private int b;

   giw(gfd $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements gio<lv> {
      private final gjg a;
      ...
      public gil a(lv $$0, gfd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         giw $$8 = new giw($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
