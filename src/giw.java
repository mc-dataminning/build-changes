...
public class giw implements giz.a, AutoCloseable {
   ...
   etc[] f;
   @Nullable
   private final giw.a g;
   private final asq h;

   public giw(ajh $$0, gko $$1, etc $$2, asq $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gkm $$4 = $$3.a(gkm.a).orElse(gkm.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new etc[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gir.a(this.f, $$0);
   ...
   @Nullable
   private giw.a a(gko $$0, int $$1, int $$2, gkm $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<giw.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new giw.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new giw.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<giw.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            giw.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new giw.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, etc[] $$4) {
   ...
   class a {
      ...
      a(List<giw.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * giw.this.c;
         int $$4 = this.b($$2) * giw.this.d;
         giw.this.a($$0, $$1, $$3, $$4, giw.this.f);
      }

      public giy a() {
         return giw.this.new d(this, this.d ? giw.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final etc[] b = new etc[giw.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = giw.this.c >> $$0;
            int $$2 = giw.this.d >> $$0;
            this.b[$$0] = new etc($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, giw.d $$2) {
         giw.a $$3 = $$2.d;
         List<giw.b> $$4 = $$3.b;
         giw.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            giw.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(giw.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return giw.this.f[$$2].a($$3 + ($$0.a($$1) * giw.this.c >> $$2), $$4 + ($$0.b($$1) * giw.this.d >> $$2));
      }
   ...
   class d implements giy {
      ...
      final giw.a d;
      @Nullable
      private final giw.c e;

      d(giw.a $$0, @Nullable giw.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
