...
public class arm extends arl {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, arm.a> s;
   private final arh t;
   private long u;
   private final ahx v;

   private arm(ahx $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == ari.c($$2, 7, $$0.getLength());
      }
   }
