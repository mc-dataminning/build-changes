...
public class gff implements AutoCloseable {
   ...
   public gff(gez $$0, fgj $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gql(16, 16, false);
   ...
   private float b(float $$0) {
      brh $$1 = this.j.s.c(brj.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(bso $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, aym.b(((float)$$0.am - $$2) * (float) Math.PI * 0.025F) * $$3);
   }

   public void a(float $$0) {
      if (this.g) {
         this.g = false;
         this.j.aJ().a("lightTex");
         fzn $$1 = this.j.r;
         if ($$1 != null) {
            float $$2 = $$1.g(1.0F);
            float $$3;
            ...
            if (this.j.s.b(brj.p)) {
               $$9 = gez.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(brj.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   private static void a(Vector3f $$0) {
      $$0.set(aym.a($$0.x, 0.0F, 1.0F), aym.a($$0.y, 0.0F, 1.0F), aym.a($$0.z, 0.0F, 1.0F));
   }
   ...
   public static float a(dwu $$0, int $$1) {
      float $$2 = (float)$$1 / 15.0F;
      float $$3 = $$2 / (4.0F - 3.0F * $$2);
      return aym.i($$0.s(), $$3, 1.0F);
   }
