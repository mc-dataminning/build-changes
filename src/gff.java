...
public class gff extends dgz {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebx e = new ebx();
   private final ecd<bvb> f = new ecd<>(bvb.class, new gff.b());
   private final gfg E;
   private final glc F;
   private final glb G;
   private final gff.a H;
   private final gks I;
   private final btj J;
   private final flz K = flz.Q();
   final List<gjz> L = Lists.newArrayList();
   final List<cki> M = Lists.newArrayList();
   private final Map<evi, evk> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dgj, fnc> Q = ae.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gkm.a, new fnc($$0xx -> this.b($$0xx, gkm.a)));
      $$0x.put(gkm.b, new fnc($$0xx -> this.b($$0xx, gkm.b)));
      $$0x.put(gkm.c, new fnc($$0xx -> this.b($$0xx, gkm.c)));
   });
   private final gfb R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final ggs U = new ggs();
   private final int V;
   private boolean W;
   private static final Set<cxc> X = Set.of(cxk.hY, cxk.hZ);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(jh $$0, dxo $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(jh $$0, dxo $$1, fbr $$2) {
      dxo $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cpo $$4 = this.K.t;
   ...
   public gff(gfg $$0, gff.a $$1, alo<dgz> $$2, jq<ebj> $$3, int $$4, int $$5, glc $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gfb(this, $$4);
      this.J = new btj();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new glb(this.K, this, $$6);
      this.I = gks.a($$3.a());
   ...
   private void a(bvb $$0, bvb $$1) {
      if ($$1.dR() || $$1.dl() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof cpo || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   @Override
   public void ac() {
      this.E.k().a(xk.c("multiplayer.status.quitting"));
   }
   ...
   private dkd o() {
      if (this.K.r.j() == dgw.b) {
         cxg $$0 = this.K.t.eZ();
         cxc $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cvm $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, bac $$4, @Nullable dkd $$5, jh.a $$6) {
   ...
   private void a(jh $$0, dxo $$1, lq $$2, boolean $$3) {
      if ($$1.y().c()) {
         fcl $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jm.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(jh $$0, lq $$1, fcl $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, lq $$5) {
      this.a($$5, azu.d(this.A.j(), $$0, $$1), $$4, azu.d(this.A.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable cpo $$0, bvb $$1, jq<awu> $$2, aww $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hfd)(new heu($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bvb $$0, awu $$1, aww $$2, float $$3, float $$4) {
      this.K.ak().a((hfd)(new heu($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, awu $$3, aww $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.K.j.k().b().c($$0, $$1, $$2);
      hey $$10 = new hey($$3, $$4, $$5, $$6, bac.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czv> $$6) {
      if ($$6.isEmpty()) {
         for (int $$7 = 0; $$7 < this.A.a(3) + 2; $$7++) {
            this.a(ls.ad, $$0, $$1, $$2, this.A.k() * 0.05, 0.005, this.A.k() * 0.05);
         }
      } else {
         this.K.g.a(new ghx.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jq<dib> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mb.aI).b(dii.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (azu.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = azu.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public int a(fbr $$0, float $$1) {
      float $$2 = this.f($$1);
      fbr $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fbr $$4 = ayv.a($$3, ($$0x, $$1x, $$2x) -> fbr.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
      float $$5 = azu.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$5 = azu.a($$5, 0.0F, 1.0F);
      $$4 = $$4.c((double)$$5);
      int $$6 = ayf.a($$4);
      float $$7 = this.d($$1);
      ...
      if ($$15 > 0) {
         ...
         $$16 *= 0.45F;
         $$6 = ayf.a($$16, $$6, ayf.a(204, 204, 255));
      }
   ...
   public int h(float $$0) {
      ...
      float $$2 = this.d($$0);
      if ($$2 > 0.0F) {
         int $$3 = ayf.a(ayf.e($$1), 0.6F);
         $$1 = ayf.a($$2 * 0.95F, $$1, $$3);
      }

      float $$4 = this.f($$0);
      float $$5 = azu.b($$4 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$5 = azu.a($$5, 0.0F, 1.0F);
      $$1 = ayf.a($$1, ayf.a(1.0F, $$5 * 0.9F + 0.1F, $$5 * 0.9F + 0.1F, $$5 * 0.85F + 0.15F));
      float $$6 = this.b($$0);
      if ($$6 > 0.0F) {
         int $$7 = ayf.a(ayf.e($$1), 0.2F);
         $$1 = ayf.a($$6 * 0.95F, $$1, $$7);
      }
   ...
   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (azu.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = azu.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(jh $$0, dgj $$1) {
      fnc $$2 = (fnc)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(jh $$0, dgj $$1) {
      int $$2 = flz.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<evi, evk> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<evi, evk> $$0) {
      this.N.putAll($$0);
   }
   ...
   public static class a implements ewd {
      ...
      public a(bsx $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements ebz<bvb> {
      public void a(bvb $$0) {
      }
      ...
      public void e(bvb $$0) {
         ...
         switch ($$0) {
            case gjz $$1:
               ...
               break;
            case ckl $$2:
               gff.this.M.addAll(Arrays.asList($$2.x()));
               break;
         }
      }
      ...
      public void f(bvb $$0) {
         ...
         switch ($$0) {
            case gjz $$1:
               ...
               break;
            case ckl $$2:
               gff.this.M.removeAll(Arrays.asList($$2.x()));
               break;
         }
      }
