...
public class fhg {
   ...
   private final List<ffa> k = Lists.newArrayList();
   private final List<ffa.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fhg.a> o = new ArrayList<>();
   ...
   public void a(fgs $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fgs $$0, int $$1, int $$2, ffb.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(ffa.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.m.m().c() == cmw.c;
   }
   ...
   public void a(xp $$0) {
      this.a($$0, null, this.i.W() ? ffb.b() : ffb.a());
   }

   public void a(xp $$0, @Nullable yb $$1, @Nullable ffb $$2) {
      ffa $$3 = new ffa(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(ffa $$0) {
      ...
      List<ayl> $$3 = fhk.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new ffa.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fhg.a b(yb $$0) {
      int $$1 = this.i.l.e();
      ListIterator<ffa> $$2 = this.k.listIterator();
   ...
   private ffa d(ffa $$0) {
      return new ffa($$0.b(), h, null, ffb.a());
   }
   ...
   private void n() {
      ...
      for (ffa $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public ffb c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, ffa.a $$1, ffb $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         ffb.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.y instanceof flu;
   }
   ...
   public fhg.b k() {
      return new fhg.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fhg.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<ffa> $$0, List<String> $$1, List<fhg.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
