public class fhg<T extends bzv> extends ffm<T> {
   ...
   public void a(bzv $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      float $$6 = 1.5F;
      this.m.g = 0.1F * arx.a($$1 * 1.5F) * 4.0F * $$2;
      this.m.c = 2.0F;
      this.m.c = this.m.c - 2.0F * arx.b($$1 * 1.5F) * 2.0F * $$2;
      this.l.e = arx.a($$1 * 1.5F * 0.5F) * 2.0F * $$2;
      this.k.e = arx.a($$1 * 1.5F * 0.5F + (float) Math.PI) * 2.0F * $$2;
      this.l.g = (float) (Math.PI / 18) * arx.b($$1 * 1.5F * 0.5F) * $$2;
      this.k.g = (float) (Math.PI / 18) * arx.b($$1 * 1.5F * 0.5F + (float) Math.PI) * $$2;
      this.l.c = 8.0F + 2.0F * arx.a($$1 * 1.5F * 0.5F + (float) Math.PI) * 2.0F * $$2;
      this.k.c = 8.0F + 2.0F * arx.a($$1 * 1.5F * 0.5F) * 2.0F * $$2;
      this.n.g = -1.2217305F;
      this.o.g = -1.134464F;
      ...
      this.r.g = 1.134464F;
      this.s.g = 1.2217305F;
      float $$7 = arx.b($$1 * 1.5F + (float) Math.PI) * $$2;
      this.n.g += $$7 * 1.3F;
      this.o.g += $$7 * 1.2F;
      this.p.g += $$7 * 0.6F;
      this.q.g += $$7 * 0.6F;
      ...
      float $$8 = 1.0F;
      float $$9 = 1.0F;
      this.n.g = this.n.g + 0.05F * arx.a($$3 * 1.0F * -0.4F);
      this.o.g = this.o.g + 0.1F * arx.a($$3 * 1.0F * 0.2F);
      this.p.g = this.p.g + 0.1F * arx.a($$3 * 1.0F * 0.4F);
      this.q.g = this.q.g + 0.1F * arx.a($$3 * 1.0F * 0.4F);
      this.r.g = this.r.g + 0.1F * arx.a($$3 * 1.0F * 0.2F);
      this.s.g = this.s.g + 0.05F * arx.a($$3 * 1.0F * -0.4F);
   }
