...
public class fhg extends fhf {
   ...
   protected void aO_() {
      ...
      this.r = $$0.u_();
      this.t = $$0.bc().m();
      this.c(fbn.a(cww::e).a(cww.a, cww.d, cww.b, cww.c).a(this.r).a(this.g / 2 - 155, 100, 150, 20, k, ($$0x, $$1x) -> this.r = $$1x));
      this.c(fbn.b(this.t).a(this.g / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.t = $$1x));
      fbg $$1 = fbg.a(vu.c("lanServer.start"), $$1x -> {
         this.f.a(null);
         vu $$2;
      ...
      this.v = new fbp(this.i, this.g / 2 - 75, 160, 150, 20, vu.c("lanServer.port"));
      this.v.b($$1x -> {
         vu $$2 = this.a($$1x);
      ...
      this.c(this.v);
      this.c($$1);
      this.c(fbg.a(vt.e, $$0x -> this.f.a(this.q)).a(this.g / 2 + 5, this.h - 28, 150, 20).a());
   }
