public class gjl extends gkg {
   private final gkb a;

   gjl(gfy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gkb $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cow $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dC();
            if (this.h > $$1) {
   ...
   public static class a implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjl($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjg $$8 = new gjl($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
