...
public class epy {
   private final ImmutableList<epz> a;
   private final ImmutableMap<String, epz> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private epw e;

   public epy(ImmutableMap<String, epz> $$0) {
      this.b = $$0;
