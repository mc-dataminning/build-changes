...
public class epy implements epz, eqa {
   ...
   private final evc<MinecraftServer> G;
   ...
   public epy(dca $$0, dyq $$1, epy.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iz.c,
   ...
   public static <T> epy a(Dynamic<T> $$0, dca $$1, epy.a $$2, dyq $$3, Lifecycle $$4) {
      ...
      return new epy(
         ...
         new evc<>(evb.a, $$0.get("ScheduledEvents").asStream()),
         (ur)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dvv.a.a).resultOrPartial(f::error).orElse(dvv.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jw $$0, ur $$1, @Nullable ur $$2) {
      ...
      dyo.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (vo)dvv.a.a.encodeStart(vf.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      dcq.b.encodeStart(vf.a, this.g.g()).ifSuccess($$1x -> $$1.a((ur)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   @Override
   public boolean z() {
      return this.i == epy.a.b;
   }

   @Override
   public boolean A() {
      return this.i == epy.a.c;
   }
