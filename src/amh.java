...
public class amh {
   ...
   public amh(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<amh.a> b(Scanner $$0) {
      alb<deg> $$1 = (alb<deg>)amq.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new amh.a($$1, new eys((double)$$2, (double)$$3, (double)$$4), new eyr($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<ari> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            ari $$2 = $$1.get(0);
            arh $$3 = this.e.J();
            et $$4 = new et($$2, eys.a($$3.W()), eyr.a, $$3, 4, "", xc.a, this.e, $$2);
            eu $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(alb<deg> a, eys b, eyr c) {
   }
}
