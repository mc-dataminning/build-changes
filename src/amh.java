...
public class amh {
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> wo.b("commands.bossbar.create.failed", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> wo.b("commands.bossbar.unknown", $$0));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.players.unchanged"));
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.name.unchanged"));
   private static final SimpleCommandExceptionType f = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.color.unchanged"));
   private static final SimpleCommandExceptionType g = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.style.unchanged"));
   private static final SimpleCommandExceptionType h = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.value.unchanged"));
   private static final SimpleCommandExceptionType i = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.max.unchanged"));
   private static final SimpleCommandExceptionType j = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.visibility.unchanged.hidden"));
   private static final SimpleCommandExceptionType k = new SimpleCommandExceptionType(wo.c("commands.bossbar.set.visibility.unchanged.visible"));
   ...
   private static int a(ex $$0, alw $$1) {
      $$0.a(() -> wo.a("commands.bossbar.get.value", $$1.e(), $$1.c()), true);
      return $$1.c();
   }

   private static int b(ex $$0, alw $$1) {
      $$0.a(() -> wo.a("commands.bossbar.get.max", $$1.e(), $$1.d()), true);
      return $$1.d();
   }

   private static int c(ex $$0, alw $$1) {
      if ($$1.f()) {
         $$0.a(() -> wo.a("commands.bossbar.get.visible.visible", $$1.e()), true);
         return 1;
      } else {
         $$0.a(() -> wo.a("commands.bossbar.get.visible.hidden", $$1.e()), true);
         return 0;
      }
   }
   ...
   private static int a(ex $$0, alw $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.f() == $$2) {
         ...
         $$1.d($$2);
         if ($$2) {
            $$0.a(() -> wo.a("commands.bossbar.set.visible.success.visible", $$1.e()), true);
         } else {
            $$0.a(() -> wo.a("commands.bossbar.set.visible.success.hidden", $$1.e()), true);
         }
   ...
   private static int a(ex $$0, alw $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         ...
         $$1.a($$2);
         $$0.a(() -> wo.a("commands.bossbar.set.value.success", $$1.e(), $$2), true);
         return $$2;
      }
   }
   ...
   private static int b(ex $$0, alw $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         ...
         $$1.b($$2);
         $$0.a(() -> wo.a("commands.bossbar.set.max.success", $$1.e(), $$2), true);
         return $$2;
      }
   }
   ...
   private static int a(ex $$0, alw $$1, bry.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         ...
         $$1.a($$2);
         $$0.a(() -> wo.a("commands.bossbar.set.color.success", $$1.e()), true);
         return 0;
      }
   }
   ...
   private static int a(ex $$0, alw $$1, bry.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         ...
         $$1.a($$2);
         $$0.a(() -> wo.a("commands.bossbar.set.style.success", $$1.e()), true);
         return 0;
      }
   }

   private static int a(ex $$0, alw $$1, wo $$2) throws CommandSyntaxException {
      wo $$3 = wr.a($$0, $$2, null, 0);
      if ($$1.i().equals($$3)) {
         throw e.create();
      } else {
         $$1.a($$3);
         $$0.a(() -> wo.a("commands.bossbar.set.name.success", $$1.e()), true);
         return 0;
      }
   }

   private static int a(ex $$0, alw $$1, Collection<ard> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
   ...
   private static int a(ex $$0) {
      ...
      if ($$1.isEmpty()) {
         $$0.a(() -> wo.c("commands.bossbar.list.bars.none"), false);
      } else {
         $$0.a(() -> wo.a("commands.bossbar.list.bars.some", $$1.size(), wr.b($$1, alw::e)), false);
      }

      return $$1.size();
   }

   private static int a(ex $$0, aku $$1, wo $$2) throws CommandSyntaxException {
      alx $$3 = $$0.l().aM();
      if ($$3.a($$1) != null) {
         throw b.create($$1.toString());
      } else {
         alw $$4 = $$3.a($$1, wr.a($$0, $$2, null, 0));
         $$0.a(() -> wo.a("commands.bossbar.create.success", $$4.e()), true);
         return $$3.b().size();
      }
   }
   ...
   private static int e(ex $$0, alw $$1) {
      ...
      $$1.b();
      $$2.a($$1);
      $$0.a(() -> wo.a("commands.bossbar.remove.success", $$1.e()), true);
      return $$2.b().size();
   }
