...
class amh implements Path {
   private static final BasicFileAttributes a = new amf() {
      @Override
   ...
   private static final BasicFileAttributes b = new amf() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amh> c = Comparator.comparing(amh::n);
   ...
   public amh(amj $$0, String $$1, @Nullable amh $$2, amk $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amh a(@Nullable amh $$0, String $$1) {
      return new amh(this.e, $$1, $$0, amk.b);
   }
   ...
   amh a(String $$0) {
      if (a(this.i)) {
         return new amh(this.e, $$0, this, this.i);
      } else if (this.i instanceof amk.a $$1) {
         amh $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amh(this.e, $$0, this, amk.a);
      } else if (this.i instanceof amk.b) {
         return new amh(this.e, $$0, this, amk.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(amk $$0) {
      return $$0 == amk.a || $$0 == amk.b;
   }
   ...
   private amh c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amh $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof amk.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public amk.a i() {
      return this.i instanceof amk.a $$0 ? $$0 : null;
   }
