...
public class ezx {
   ...
   public void a(cel $$0, esf $$1, float $$2, int $$3, int $$4) {
      cgd $$5 = $$0.b(this.d);
   ...
   private void a(cgd $$0, aew $$1, float $$2, esf $$3, int $$4, int $$5) {
      fze $$6 = eqv.O().a(fzd.e).apply($$1);
