...
public class ezx extends ezp<cfc> implements fbs {
   private float x;
   private float y;
   private final fbm z = new fbm();
   private boolean A;
   private boolean B;
   ...
   public void C() {
      if (this.f.q.g()) {
         this.f.a(new ezm(this.f.s, this.f.s.cl.x(), this.f.m.F().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aC_() {
      if (this.f.q.g()) {
         ...
         this.d(new ess(this.t + 104, this.h / 2 - 22, 20, 18, fbm.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(erv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, biy $$9) {
   ...
   public static void a(erv $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, biy $$7) {
      $$0.c().a();
