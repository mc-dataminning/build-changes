...
public class ezx {
   ...
   public static final ezx.a bv;

   public static ezx.a a(int $$0, int $$1) {
      return $$0 == -1 ? ezx.b.b.a($$1) : ezx.b.a.a($$0);
   }

   public static ezx.a a(String $$0) {
      if (ezx.a.e.containsKey($$0)) {
         return ezx.a.e.get($$0);
      } else {
         for (ezx.b $$1 : ezx.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ezx.b b;
      private final int c;
      private final ayh<xe> d;
      static final Map<String, ezx.a> e = Maps.newHashMap();

      a(String $$0, ezx.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayh<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> uf.a().b($$1) ? xe.c($$1) : xe.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ezx.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xe> g;

      private static void a(ezx.b $$0, String $$1, int $$2) {
         ezx.a $$3 = new ezx.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, xe> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ezx.a a(int $$0) {
         return (ezx.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
