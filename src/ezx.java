...
public class ezx extends ezm implements far {
   private static final fbb d = new fbb(new aiy("widget/text_field"), new aiy("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, avu> D = ($$0x, $$1x) -> avu.forward($$0x, wn.a);
   @Nullable
   private vq E;
   private long F = ac.b();

   public ezx(eyz $$0, int $$1, int $$2, vq $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public ezx(eyz $$0, int $$1, int $$2, int $$3, int $$4, vq $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public ezx(eyz $$0, int $$1, int $$2, int $$3, int $$4, @Nullable ezx $$5, vq $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, avu> $$0) {
      this.D = $$0;
   }
   ...
   protected we aN_() {
      vq $$0 = this.x();
      return vq.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = awi.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = awi.a($$0) - this.B();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.g());
      this.b(this.o.a($$3, $$2).length() + this.v, ffl.v());
   }
   ...
   public void b(ezb $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aL_() && (ac.b() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.B() + 4 : this.B();
         int $$11 = this.r ? this.C() + (this.h - 8) / 2 : this.C();
         int $$12 = $$10;
         int $$13 = awi.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fwb.C(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = awi.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = awi.a(this.v, 0, this.p.length());
      }
   }
