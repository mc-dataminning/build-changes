...
public class emg {
   ...
   public static List<emg.a> a(String $$0, emg.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<emg.a> a(String $$0, List<emg.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<emg.a> a(List<String> $$0, List<emg.b> $$1) {
      int $$2 = 0;
      List<emg.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<emg.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static emg.b a(String $$0, String $$1) {
         return new emg.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static emg.b a(String $$0) {
         return new emg.b($$0);
      }
   }
}
