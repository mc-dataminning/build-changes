...
public class dtn<T> implements dtp<T> {
   ...
   private dtn(jc<T> $$0, int $$1, dtq<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dtn(jc<T> $$0, T[] $$1, dtq<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dtp<T> c() {
      return new dtn<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
