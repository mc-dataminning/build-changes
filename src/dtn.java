...
public abstract class dtn<T extends Comparable<T>> {
   ...
   private final Codec<dtn.a<T>> e = this.d.xmap(this::b, dtn.a::b);

   protected dtn(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dtn.a<T> b(T $$0) {
      return new dtn.a<>(this, $$0);
   }

   public dtn.a<T> a(dsm<?, ?> $$0) {
      return new dtn.a<>(this, $$0.c(this));
   }

   public Stream<dtn.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dtn<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dsm<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.a(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dtn<T> a, T b) {
      public a(dtn<T> a, T b) {
         if (!a.a().contains(b)) {
