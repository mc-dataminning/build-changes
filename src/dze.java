...
public class dze<T> implements dzg<T> {
   private final jw<T> a;
   private final T[] b;
   private final dzh<T> c;
   private final int d;
   private int e;

   private dze(jw<T> $$0, int $$1, dzh<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dze(jw<T> $$0, T[] $$1, dzh<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dzg<T> a(dzh<T> $$0) {
      return new dze<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
