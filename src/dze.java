...
public class dze {
   ...
   static class a implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
         return $$0.c[hx.f.d()] && !$$0.b[hx.f.d()].d;
      }

      @Override
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         $$1.d = true;
         $$1.b[hx.f.d()].d = true;
         return new dze.k($$0, $$1);
      }
   }

   static class b implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         ...
         return new dze.l($$0, $$1);
      }
   }

   static class c implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         $$1.d = true;
         $$1.b[hx.b.d()].d = true;
         return new dze.m($$0, $$1);
      }
   }

   static class d implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         ...
         return new dze.n($$0, $$1);
      }
   }

   static class e implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         ...
         $$3.d = true;
         $$3.b[hx.c.d()].d = true;
         return new dze.o($$0, $$3);
      }
   }

   static class f implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
         return true;
      }
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         $$1.d = true;
         return new dze.s($$0, $$1, $$2);
      }
   }

   static class g implements dze.i {
      @Override
      public boolean a(dze.v $$0) {
      ...
      public dze.r a(hx $$0, dze.v $$1, ato $$2) {
         $$1.d = true;
         return new dze.t($$0, $$1);
      }
   }

   public static class h extends dze.r {
      ...
      private dze.v G;
      private dze.v H;
      private final List<dze.r> I = Lists.newArrayList();

      public h(ato $$0, int $$1, int $$2, hx $$3) {
         super(dxm.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dze.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dze.p($$3, this.G));
         this.I.add(new dze.j($$3, this.H));
         List<dze.i> $$5 = Lists.newArrayList();
         $$5.add(new dze.b());
         $$5.add(new dze.d());
         $$5.add(new dze.e());
         $$5.add(new dze.a());
         ...
         dwn $$10 = dwn.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dwn $$11 = dwn.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dwn $$12 = dwn.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dze.u($$3, $$10, $$13++));
         this.I.add(new dze.u($$3, $$11, $$13++));
         this.I.add(new dze.q($$3, $$12));
      }
      ...
      private List<dze.v> b(ato $$0) {
         dze.v[] $$1 = new dze.v[75];
         ...
         dze.v $$23 = new dze.v(1003);
         dze.v $$24 = new dze.v(1001);
         dze.v $$25 = new dze.v(1002);
         $$1[v].a(hx.b, $$23);
         $$1[w].a(hx.d, $$24);
         $$1[x].a(hx.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dze.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, csm $$2, ato $$3, dwn $$4) {
         int $$5 = 24;
      ...
      private void a(csm $$0, ato $$1, dwn $$2) {
      ...
      private void b(csm $$0, ato $$1, dwn $$2) {
      ...
      private void c(csm $$0, ato $$1, dwn $$2) {
      ...
      private void d(csm $$0, ato $$1, dwn $$2) {
      ...
      private void e(csm $$0, ato $$1, dwn $$2) {
      ...
      private void f(csm $$0, ato $$1, dwn $$2) {
   ...
   interface i {
      boolean a(dze.v var1);

      dze.r a(hx var1, dze.v var2, ato var3);
   }

   public static class j extends dze.r {
      public j(hx $$0, dze.v $$1) {
         super(dxm.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(csm $$0, csk $$1, dit $$2, ato $$3, dwn $$4, cqz $$5, ht $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cuv.ch.o(), cuv.ch.o(), false);
   ...
   public static class k extends dze.r {
      public k(hx $$0, dze.v $$1) {
         super(dxm.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dze.r {
      public l(hx $$0, dze.v $$1) {
         super(dxm.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dze.r {
      public m(hx $$0, dze.v $$1) {
         super(dxm.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dze.r {
      public n(hx $$0, dze.v $$1) {
         super(dxm.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dze.r {
      public o(hx $$0, dze.v $$1) {
         super(dxm.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dze.r {
      public p(hx $$0, dze.v $$1) {
         super(dxm.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dze.r {
      public q(hx $$0, dwn $$1) {
         super(dxm.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dwz {
      protected static final dgw b = cuv.hZ.o();
      protected static final dgw c = cuv.ia.o();
      protected static final dgw d = cuv.ib.o();
      protected static final dgw h = c;
      protected static final dgw i = cuv.ii.o();
      protected static final boolean j = true;
      protected static final dgw k = cuv.G.o();
      protected static final Set<cut> l = ImmutableSet.builder().add(cuv.dO).add(cuv.iC).add(cuv.mW).add(k.b()).build();
      ...
      public r(dxm $$0, hx $$1, int $$2, dwn $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dxm $$0, int $$1, hx $$2, dze.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dwn a(hx $$0, dze.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dwn $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(csm $$0, dwn $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dgw $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(csm $$0, dwn $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(csm $$0, dwn $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dgw $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dwn $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(csm $$0, dwn $$1, int $$2, int $$3, int $$4) {
         ht $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cap $$6 = bkm.A.a((crs)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dl()), blc.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dze.r {
      private int a;

      public s(hx $$0, dze.v $$1, ato $$2) {
         super(dxm.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dze.r {
      public t(hx $$0, dze.v $$1) {
         super(dxm.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dze.r {
      private int a;

      public u(hx $$0, dwn $$1, int $$2) {
         super(dxm.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
