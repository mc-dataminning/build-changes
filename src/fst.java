...
public abstract class fst implements fty, fus, fwl, fwq {
   ...
   @Override
   public final void a(fsh $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fsh var1, int var2, int var3, float var4);

   protected static void a(fsh $$0, fsf $$1, wy $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fsh $$0, fsf $$1, wy $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fsh $$0, fsf $$1, int $$2, int $$3) {
      int $$4 = this.F() + $$2;
   ...
   public static void b(hon $$0) {
      $$0.a(hnc.a(awn.Bv, 1.0F));
   }
   ...
   public fwq.a w() {
      if (this.aJ_()) {
         ...
         return this.i ? fwq.a.b : fwq.a.a;
      }
   }

   @Override
   public final void b(fws $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fws var1);

   protected void c(fws $$0) {
      $$0.a(fwr.a, this.d());
      if (this.j) {
         if (this.aJ_()) {
            $$0.a(fwr.d, wy.c("narration.button.usage.focused"));
         } else {
