...
public class si extends sk<sj> {
   private static final int b = 24;
   public static final tk<si> a = new tk.b<si>() {
      public si a(DataInput $$0, su $$1) throws IOException {
         return new si(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof si && Arrays.equals(this.c, ((si)$$0).c);
   }
   ...
   public sj a(int $$0) {
      return sj.a(this.c[$$0]);
   }

   public sj a(int $$0, sj $$1) {
      byte $$2 = this.c[$$0];
      this.c[$$0] = $$1.i();
      return sj.a($$2);
   }

   public void b(int $$0, sj $$1) {
   ...
   public boolean b(int $$0, ti $$1) {
      if ($$1 instanceof tb) {
         this.c = ArrayUtils.add(this.c, $$0, ((tb)$$1).i());
         return true;
      } else {
         return false;
      }
