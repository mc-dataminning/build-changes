...
public class si extends MessageToMessageDecoder<uw<?>> {
   @Nullable
   private uv.a a;
   @Nullable
   private uv b;
   private final AttributeKey<? extends uv.b> c;

   public si(AttributeKey<? extends uv.b> $$0) {
      this.c = $$0;
   }

   protected void a(ChannelHandlerContext $$0, uw<?> $$1, List<Object> $$2) throws Exception {
      uv.b $$3 = (uv.b)$$0.channel().attr(this.c).get();
      if ($$3 == null) {
