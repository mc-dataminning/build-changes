public class cmd extends cku {
   ...
   public cmd(int $$0, chz $$1) {
      this($$0, $$1, new chk($$1.m));
   }

   public cmd(int $$0, chz $$1, cvb $$2) {
      super(cmb.t, $$0);
      this.v = $$2;
      this.w = new cmc($$2);
      this.a(new cmp(this.w, 0, 136, 37));
      this.a(new cmp(this.w, 1, 162, 37));
      this.a(new cme($$1.m, $$2, this.w, 2, 220, 37));

      for (int $$3 = 0; $$3 < 3; $$3++) {
         for (int $$4 = 0; $$4 < 9; $$4++) {
            this.a(new cmp($$1, $$4 + $$3 * 9 + 9, 108 + $$4 * 18, 84 + $$3 * 18));
         }
      }

      for (int $$5 = 0; $$5 < 9; $$5++) {
         this.a(new cmp($$1, $$5, 108 + $$5 * 18, 142));
      }
   }
   ...
   private void r() {
      if (!this.v.gt()) {
         bof $$0 = (bof)this.v;
         $$0.dJ().a($$0.do(), $$0.dq(), $$0.du(), this.v.gp(), atq.g, 1.0F, 1.0F, false);
      }
   }
   ...
   private void a(int $$0, cpq $$1, boolean $$2) {
      if (!$$1.b()) {
         for (int $$3 = 3; $$3 < 39; $$3++) {
            cpq $$4 = this.i.get($$3).g();
            if (!$$4.b() && cvc.a($$1, $$4, $$2)) {
               cpq $$5 = this.w.a($$0);
               int $$6 = $$5.b() ? 0 : $$5.M();
