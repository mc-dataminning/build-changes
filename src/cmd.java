...
public class cmd {
   ...
   public static OptionalInt a(arf $$0, iz $$1, arg $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.aa().map(cmd::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<cmd> $$4 = $$3.stream().flatMap($$0x -> $$0x.aa().stream()).max(Comparator.comparingInt(cmd::c));
            if ($$4.isPresent()) {
               cmd $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(arf $$0, iz $$1) {
      evm $$2 = evm.a(evr.b($$1), 48.0, 48.0, 48.0);
   ...
   private static List<arg> b(arf $$0, iz $$1) {
      ...
      return $$0.a($$3.and(btp::bD).and(bsz.f));
   }
