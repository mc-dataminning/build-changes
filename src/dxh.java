...
public class dxh implements dxo.c {
   ...
   private final ObjectListIterator<dxh.a> h;
   private final ObjectListIterator<ejm> i;

   public static dxh a(dcr $$0, dbf $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<dxh.a> $$4 = new ObjectArrayList(10);
      ObjectList<ejm> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eiv.a).forEach($$5x -> {
         eiv $$6 = $$5x.h().d();
         ...
         for (eio $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eig) {
                  ...
                  $$4.add(new dxh.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new dxh($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public dxh(ObjectListIterator<dxh.a> $$0, ObjectListIterator<ejm> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(eic a, eiv b, int c) {
   }
}
