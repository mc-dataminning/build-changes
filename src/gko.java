...
public class gko extends gkn implements abc, wm {
   private static final Logger l = LogUtils.getLogger();
   private final GameProfile m;
   private cuw n;
   private final jt.b o;
   private final gle p = new gle();
   @Nullable
   private gkx q;
   @Nullable
   protected ftb.b k;

   public gko(fpt $$0, vr $$1, gkv $$2) {
      super($$0, $$1, $$2);
      this.m = $$2.a();
      this.o = $$2.c();
      this.n = $$2.d();
   ...
   public void a(abd $$0) {
      ...
      this.b.a(ago.b.a(wj.a($$1)), new gkr(this.a, this.b, new gkv(this.m, this.e, $$1, this.n, this.d, this.c, this.f, this.h, this.k, this.i, this.j)));
      this.b.a(abl.a);
