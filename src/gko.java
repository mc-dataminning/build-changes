...
public class gko {
   ...
   private gko.a l = gko.a.c;
   @Nullable
   private byte[] m;
   private gko.c n;
   private gko.b o = gko.b.a;

   public gko(String $$0, String $$1, gko.c $$2) {
      this.a = $$0;
      this.b = $$1;
      this.n = $$2;
   }
   ...
   public void a(gko.a $$0) {
      this.l = $$0;
   }

   public static gko a(tz $$0) {
      gko $$1 = new gko($$0.l("name"), $$0.l("ip"), gko.c.c);
      if ($$0.b("icon", 8)) {
         try {
   ...
   public boolean d() {
      return this.n == gko.c.a;
   }

   public boolean e() {
      return this.n == gko.c.b;
   }
