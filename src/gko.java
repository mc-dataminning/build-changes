public class gko extends gkg<cnl> {
   private static final akr a = akr.b("textures/entity/fishing_hook.png");
   private static final gff g = gff.d(a);
   ...
   public void a(cnl $$0, float $$1, float $$2, fbg $$3, gex $$4, int $$5) {
      cmx $$6 = $$0.t();
      if ($$6 != null) {
         $$3.a();
         $$3.a();
   ...
   private exa a(cmx $$0, float $$1, float $$2) {
      int $$3 = $$0.fr() == btg.b ? 1 : -1;
      cuq $$4 = $$0.eU();
      if (!$$4.a(cut.qV)) {
         $$3 = -$$3;
      }

      if (this.d.d.aA().a() && $$0 == fgm.Q().s) {
         double $$12 = 960.0 / (double)this.d.d.ah().c().intValue();
         exa $$13 = this.d.b.j().a((float)$$3 * 0.525F, -0.1F).a($$12).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.k($$2).e($$13);
      } else {
   ...
   private static void a(fbk $$0, fbg.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(-1).a((float)$$5, (float)$$6).b(gqa.d).c($$2).b($$1, 0.0F, 1.0F, 0.0F);
   }

   private static void a(float $$0, float $$1, float $$2, fbk $$3, fbg.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
