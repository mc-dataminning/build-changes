...
public class hbl {
   ...
   public static class a extends Thread {
      private final hbl.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hbl.b $$0) throws IOException {
         super("LanServerDetector #" + hbl.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hbl.b));
   ...
   public static class b {
      private final List<hbk> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hbk> a() {
         if (this.b) {
            List<hbk> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
