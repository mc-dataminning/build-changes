...
public class fgv {
   ...
   public void a(fgv.b $$0, List<asq> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fgv.c($$0, $$1.stream().map(asq::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fgv.c(fgv.b.c, ImmutableList.of());
      }

      this.b.c = new fgv.a($$0);
   }
   ...
   static class c {
      private final fgv.b a;
      private final List<String> b;
      @Nullable
      fgv.a c;
      boolean d;

      c(fgv.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
