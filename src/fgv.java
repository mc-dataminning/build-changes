...
public class fgv {
   private static final ajc a = new ajc("advancements/title_box");
   ...
   private final avy r;
   private final int s;
   private final List<avy> t;
   private final eyk u;
   @Nullable
   private fgv v;
   private final List<fgv> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fgv(fgt $$0, eyk $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = st.a().a($$1.h.a($$3.a(), 163));
      this.y = awm.d($$3.f() * 28.0F);
      this.z = awm.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = st.a().a(this.a(vv.a($$3.b().f(), wp.a.a($$3.e().a())), $$7));
   ...
   private static float a(eyw $$0, List<vx> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<vx> a(vs $$0, int $$1) {
      eyw $$2 = this.u.h.b();
      List<vx> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<vx> $$6 = $$2.b($$0, $$1 - $$5, wp.a);
