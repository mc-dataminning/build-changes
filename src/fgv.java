...
public class fgv {
   ...
   fgv(List<fgw> $$0, List<String> $$1, IntList $$2, int $$3) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      this.e = $$0.stream().mapToInt(fgw::a).reduce(0, ($$0x, $$1x) -> $$0x | $$1x);
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof fgv $$1 && this.e == $$1.e && this.d == $$1.d && this.c.equals($$1.c) && Arrays.equals(this.f, $$1.f)) {
            return true;
         }
   ...
   public static class a {
      private final Builder<String, fgw> a = ImmutableMap.builder();
      ...
      public fgv.a a(int $$0) {
         this.c += $$0;
         return this;
      }

      public fgv a() {
         ImmutableMap<String, fgw> $$0 = this.a.buildOrThrow();
         ImmutableList<fgw> $$1 = $$0.values().asList();
         ImmutableList<String> $$2 = $$0.keySet().asList();
         return new fgv($$1, $$2, this.b, this.c);
      }
   }
