...
public class apg {
   public static final Codec<apg> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(aoi.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), aoi.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, apg::new)
   );
   ...
   private apg(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
