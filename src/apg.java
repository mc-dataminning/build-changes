...
public interface apg {
   apg a = new apg() {
      ...
      @Override
      public void a(Consumer<cye> $$0) {
      }
   };

   static apg a(cye $$0, int $$1) {
      return new apg.a($$0, $$1);
   }

   static void a(apg $$0, apg $$1, Consumer<cye> $$2, Consumer<cye> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof apg.a $$4 && $$1 instanceof apg.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cye($$10, $$11));
                     } else {
                        $$3.accept(new cye($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cye b, int c) implements apg {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(apg.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return apg.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
