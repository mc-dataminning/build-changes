...
public class apg {
   ...
   private static int a(ek $$0, Collection<arv> $$1, iw $$2, float $$3) {
      alj<djz> $$4 = $$0.e().aj();

      for (arv $$5 : $$1) {
         $$5.a(new arv.a($$4, $$2, $$3, true), false);
      }

      String $$6 = $$4.a().toString();
      if ($$1.size() == 1) {
         $$0.a(() -> xc.a("commands.spawnpoint.success.single", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.iterator().next().m_()), true);
      } else {
         $$0.a(() -> xc.a("commands.spawnpoint.success.multiple", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.size()), true);
      }
