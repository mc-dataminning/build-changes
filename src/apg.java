      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)ayy.a),
               String.format(Locale.ROOT, "%.2f", this.d.aQ().g() / (float)ayy.c)
            );
            ...
            $$10.a("Random tick rate", () -> this.d.bb().o().a(czz.o).toString());
