...
public abstract class brx extends bth {
   private static final ajp<Boolean> ca = ajt.a(brx.class, ajr.k);
   ...
   protected brx(bsj<? extends brx> $$0, dcd $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract brx a(aqk var1, brx var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof coe $$0 && !$$0.b((bsd)this)) {
         this.ac();
      }
   }
