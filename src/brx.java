...
public abstract class brx<R extends Runnable> implements bre, bsd<R>, Executor {
   ...
   @Override
   public List<brb> bw() {
      return ImmutableList.of(brb.a(this.b + "-pending-tasks", bra.b, this::by));
   }
