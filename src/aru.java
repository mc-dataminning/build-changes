...
public class aru extends evv implements AutoCloseable {
   ...
   public aru(ecj $$0, aqu $$1, boolean $$2, bsr $$3, aqw $$4) {
      super($$0, true, $$2);
      this.h = $$1;
      this.i = $$4;
      this.f = $$3;
   ...
   protected void a(dic $$0) {
      this.a($$0.h, $$0.i, () -> 0, aru.a.a, af.a((Runnable)(() -> {
         super.b($$0, false);
         super.a($$0, false);

         for (int $$1 = this.d(); $$1 < this.e(); $$1++) {
            super.a(dje.b, jx.a($$0, $$1), null);
            super.a(dje.a, jx.a($$0, $$1), null);
         }
   ...
   private void a(int $$0, int $$1, aru.a $$2, Runnable $$3) {
      this.a($$0, $$1, this.h.c(dic.c($$0, $$1)), $$2, $$3);
   }
   ...
   public CompletableFuture<ebw> a(ebw $$0, boolean $$1) {
      dic $$2 = $$0.f();
   ...
   public CompletableFuture<ebw> b(ebw $$0, boolean $$1) {
      dic $$2 = $$0.f();
      $$0.a(false);
      this.a($$2.h, $$2.i, aru.a.a, af.a((Runnable)(() -> {
         if (!$$1) {
