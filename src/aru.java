...
public abstract class aru implements asd {
   ...
   public <T> T a(asq<T> $$0) throws IOException {
      atj<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(asq<T> $$0, InputStream $$1) {
      JsonObject $$3;
