...
public class aru implements arr {
   ...
   private final Map<String, ars> b;
   private final List<aqp> c;

   public aru(aqq $$0, List<aqp> $$1) {
      this.c = List.copyOf($$1);
      Map<String, ars> $$2 = new HashMap<>();
   ...
   public Map<aiy, arz> b(String $$0, Predicate<aiy> $$1) {
      a($$0);
      Map<aiy, arz> $$2 = new TreeMap<>();

      for (ars $$3 : this.b.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<aiy, List<arz>> c(String $$0, Predicate<aiy> $$1) {
      a($$0);
      Map<aiy, List<arz>> $$2 = new TreeMap<>();
