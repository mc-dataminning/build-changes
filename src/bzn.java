...
public class bzn extends cdc {
   ...
   @Override
   protected void R() {
      boolean $$0 = !(this.cN() instanceof bji) || this.cN().ag().a(apv.b);
   ...
   public void b_() {
      ...
      if (this.bv()) {
         ...
         if (this.P && this.dL().X().b(cpr.c)) {
            ...
            for (gw $$4 : gw.b(arw.a($$3.a), arw.a($$3.b), arw.a($$3.c), arw.a($$3.d), arw.a($$3.e), arw.a($$3.f))) {
               dfj $$5 = this.dL().a_($$4);
               csv $$6 = $$5.b();
               if ($$6 instanceof cxc) {
