...
public class gev implements gfa.a {
   ...
   private final fde J;
   private final Map<in, gev.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         brh $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dI();
      });
   }

   private void b(exx $$0, gbo $$1, double $$2, double $$3, double $$4) {
      in $$5 = in.a($$2, $$3, $$4);
   ...
   private void a(exx $$0, gbo $$1, gev.a $$2) {
      int $$3 = 0;
   ...
   private void a(exx $$0, gbo $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gfi.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(exx $$0, gbo $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(exx $$0, gbo $$1, String $$2, gev.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gev.a $$0) {
      return this.b($$0.a).stream().map(afv::a).collect(Collectors.toSet());
   }

   private Set<String> c(gev.a $$0) {
      return this.c($$0.a).stream().map(afv::a).collect(Collectors.toSet());
   }
   ...
   private void d() {
      gfa.a(this.J.ao(), 8).ifPresent($$0 -> this.M = $$0.cx());
   }
