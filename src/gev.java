...
public class gev {
   private static final gfh a = gfh.t(akr.b("textures/map/map_background.png"));
   private static final gfh b = gfh.t(akr.b("textures/map/map_background_checkerboard.png"));
   ...
   private float az;
   private float aA;
   private final gkh aB;
   private final glh aC;

   public gev(fgo $$0, gkh $$1, glh $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(btn $$0, cuq $$1, cun $$2, boolean $$3, fbi $$4, gez $$5, int $$6) {
      if (!$$1.e()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dO(), $$6, gqc.d, $$0.an() + $$2.ordinal());
      }
   }
   ...
   private void a(fbi $$0, gez $$1, int $$2, btg $$3) {
      gpo $$4 = (gpo)this.aB.<gdy>a(this.au.s);
      $$0.a();
   ...
   private void a(fbi $$0, gez $$1, int $$2, float $$3, btg $$4, float $$5, cuq $$6) {
   ...
   private void a(fbi $$0, gez $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayo.c($$5);
   ...
   private void a(fbi $$0, gez $$1, int $$2, cuq $$3) {
      ...
      eqr $$4 = $$3.a(kq.B);
      eqt $$5 = cvc.a($$4, this.au.r);
      fbm $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fbi $$0, gez $$1, int $$2, float $$3, float $$4, btg $$5) {
      boolean $$6 = $$5 != btg.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayo.c($$4);
   ...
   private void a(fbi $$0, float $$1, btg $$2, cuq $$3, cmx $$4) {
   ...
   private void a(fbi $$0, float $$1, btg $$2, cuq $$3, cmx $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fbi $$0, btg $$1, float $$2) {
      int $$3 = $$1 == btg.b ? 1 : -1;
   ...
   private void b(fbi $$0, btg $$1, float $$2) {
      int $$3 = $$1 == btg.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fbi $$1, gez.a $$2, geb $$3, int $$4) {
      float $$5 = $$3.B($$0);
      bqq $$6 = (bqq)MoreObjects.firstNonNull($$3.aK, bqq.a);
      float $$7 = ayo.i($$0, $$3.P, $$3.dG());
      gev.a $$8 = a($$3);
   ...
   static gev.a a(geb $$0) {
      ...
      if (!$$3 && !$$4) {
         ...
         return a($$1) ? gev.a.b : gev.a.a;
      }
   }

   private static gev.a b(geb $$0) {
      cuq $$1 = $$0.ft();
      bqq $$2 = $$0.fs();
      if (!$$1.a(cut.ov) && !$$1.a(cut.vW)) {
         return $$2 == bqq.a && a($$0.eU()) ? gev.a.b : gev.a.a;
      } else {
         return gev.a.a($$2);
      }
   }
   ...
   private void a(gdy $$0, float $$1, float $$2, bqq $$3, float $$4, cuq $$5, float $$6, fbi $$7, gez $$8, int $$9) {
      if (!$$0.gw()) {
         boolean $$10 = $$3 == bqq.a;
         btg $$11 = $$10 ? $$0.fq() : $$0.fq().e();
         $$7.a();
         if ($$5.e()) {
            if ($$10 && !$$0.ci()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fr() && $$0.fu() > 0 && $$0.fs() == $$3) {
               ...
               float $$15 = (float)$$5.a((btn)$$0) - ((float)$$0.fu() - $$1 + 1.0F);
            ...
            if ($$0.fr() && $$0.fu() > 0 && $$0.fs() == $$3) {
               ...
               switch ($$5.u()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((btn)$$0) - ((float)$$0.fu() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((btn)$$0) - ((float)$$0.fu() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
