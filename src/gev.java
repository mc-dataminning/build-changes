public class gev implements gek<dpi> {
   private final fse a;

   public gev(gel.a $$0) {
      this.a = new fse($$0.a(fvv.r));
   }

   public void a(dpi $$0, float $$1, eys $$2, gck $$3, int $$4, int $$5) {
      drb $$6 = $$0.n();
      if ($$6.c(dij.d)) {
         $$2.a();
         $$2.a(0.5F, 1.0625F, 0.5F);
         float $$7 = $$6.c(dij.b).h().p();
         $$2.a(a.d.rotationDegrees(-$$7));
         $$2.a(a.f.rotationDegrees(67.5F));
         $$2.a(0.0F, -0.125F, 0.0F);
         this.a.a(0.0F, 0.1F, 0.9F, 1.2F);
         eyw $$8 = get.a.a($$3, gcs::c);
