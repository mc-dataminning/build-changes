...
public class aro {
   ...
   public static hg<cja> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jd.i
            .b(aew.a(je.D, new aex($$2)))
   ...
   public static hg<cja> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static hg<cja> a(JsonObject $$0, String $$1, @Nullable hg<cja> $$2) {
