...
public class aro<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aro.this.get(this.b--);
      }

      @Override
      public void remove() {
         aro.this.remove(this.b + 1);
      }
   }
}
