...
public class emz {
   ...
   @Nullable
   private String g;
   private static final emz.a h = new emz.a() {
      @Nullable
      @Override
      public emy a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (enc.a(this.d, "Get capabilities")) {
         ...
         if (enc.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  enc.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !enc.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public emy a(emz.c $$0) {
      return ($$0 == emz.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements emz.a {
      private final int a;
      private final Set<emy> b = Sets.newIdentityHashSet();
      ...
      public emy a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               emz.a.warn("Maximum sound pool size {} reached", this.a);
            }
