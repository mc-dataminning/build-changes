...
public class emz {
   ...
   private final emz.a g;

   @Deprecated
   public static emz a(azh $$0, emz.a $$1) {
      return new emz($$0, $$1, false);
   }

   public static emz a(azh $$0, int $$1, double... $$2) {
      return b($$0, new emz.a($$1, new DoubleArrayList($$2)));
   }

   public static emz b(azh $$0, emz.a $$1) {
      return new emz($$0, $$1, true);
   }

   private emz(azh $$0, emz.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<emz.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(emz.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(emz.a::b))
               .apply($$0, emz.a::new)
      );
      public static final Codec<ji<emz.a>> b = alb.a(lq.aH, a);
