...
public class bqr extends bqv {
   public static final MapCodec<bqr> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bqr a(float $$0, float $$1, float $$2, float $$3) {
      return new bqr($$0, $$1, $$2, $$3);
   }

   private bqr(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(azn $$0, float $$1, float $$2, float $$3, float $$4) {
      return azf.a(azf.c($$0, $$1, $$2), $$3, $$4);
   }
