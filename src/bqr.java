...
public record bqr(Instant a, String b, long c) {
   ...
   public static bqr a(RecordedEvent $$0) {
      ...
      return new bqr($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bqr.a a(List<bqr> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bqr>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bqr $$3 = (bqr)$$2x.get(0);
            bqr $$4 = (bqr)$$2x.get($$2x.size() - 1);
