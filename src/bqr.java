public class bqr implements bqs {
   ...
   private void b() {
      this.a.aU = ati.c(this.a.aU, this.a.aW, (float)this.a.Z());
   }
   ...
   private void d() {
      int $$0 = this.e - 10;
      float $$1 = ati.a((float)$$0 / 10.0F, 0.0F, 1.0F);
      float $$2 = (float)this.a.Z() * (1.0F - $$1);
      this.a.aU = ati.c(this.a.aU, this.a.aW, $$2);
   }

   private boolean e() {
      return !(this.a.cQ() instanceof bla);
   }
