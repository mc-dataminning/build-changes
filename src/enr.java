...
public class enr extends ens {
   public static final MapCodec<enr> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               emy.a.fieldOf("block_state_provider").forGetter($$0x -> $$0x.e)
            )
            .apply($$0, enr::new)
   );
   private final int b;
   ...
   public enr(int $$0, int $$1, int $$2, emy $$3) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public void a(ens.a $$0) {
      ...
      if (!$$1.isEmpty()) {
         ...
         azt $$9 = $$0.b();
         eqa $$10 = new eqa($$4, $$3, $$6, $$5, $$3, $$7).c(this.c, this.d, this.c);
         iu.a $$11 = new iu.a();
   ...
   private void a(ens.a $$0, iu $$1) {
      iu $$2 = $$1.d();
      if ($$0.a().a($$2, $$0x -> $$0x.l() || $$0x.a(dlw.ft)) && ekf.a($$0.a(), $$1)) {
