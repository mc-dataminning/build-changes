...
public class enr extends env implements ent {
   ...
   public enr.c a() {
      return new enr.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, eob.a $$1) {
   ...
   private enr.b q() {
      ...
      this.k += $$5;
      this.j++;
      enr.a $$9 = new enr.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new enr.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eob.b.a || this.q == eob.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<eoc> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      eoc $$1 = (eoc)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == eoc.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == eoc.b.c) {
         ent.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ent.a($$11));
         this.a($$14 + 5, ent.a($$12));
         this.a($$14 + 6, ent.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eob a, int b, int c, eob.b d, eob.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eob.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eoe $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
