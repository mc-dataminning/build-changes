...
public class enr implements enb {
   public static final Codec<enr> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               err.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               ayc.b(mi.i).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               epc.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               epc.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               eiw.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, enr::new)
   );
   ...
   public enr(jg<err> $$0, int $$1, int $$2, ayc<dno> $$3, epc $$4, int $$5, int $$6, int $$7, int $$8, epc $$9, int $$10, int $$11, eiw $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
