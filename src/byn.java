...
public interface byn extends bze {
   void b(boolean var1);

   void a(biy var1, cix var2, cce var3, float var4);
   ...
   default void b(biy $$0, float $$1) {
      bgp $$2 = ccf.a($$0, cja.uZ);
      cix $$3 = $$0.b($$2);
      if ($$0.b(cja.uZ)) {
         chf.a($$0.dK(), $$0, $$2, $$3, $$1, (float)(14 - $$0.dK().ai().a() * 4));
      }

      this.a();
   }

   default void a(biy $$0, biy $$1, cce $$2, float $$3, float $$4) {
      double $$5 = $$1.dp() - $$0.dp();
      double $$6 = $$1.dv() - $$0.dv();
      double $$7 = Math.sqrt($$5 * $$5 + $$6 * $$6);
      double $$8 = $$1.e(0.3333333333333333) - $$2.dr() + $$7 * 0.2F;
      Vector3f $$9 = this.a($$0, new ehd($$5, $$8, $$6), $$3);
      $$2.c((double)$$9.x(), (double)$$9.y(), (double)$$9.z(), $$4, (float)(14 - $$0.dK().ai().a() * 4));
      $$0.a(aow.fq, 1.0F, 1.0F / ($$0.ee().i() * 0.4F + 0.8F));
   }

   default Vector3f a(biy $$0, ehd $$1, float $$2) {
