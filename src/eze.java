...
public class eze extends exz {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   public static final eze.a k = new eze.a() {
      @Override
      public int a() {
         return 0;
      }
   ...
   private eze(eze.a $$0, boolean $$1) {
      super(eqe.a);
      this.q = $$0;
      this.y = $$1;
   }

   public void a(eze.a $$0) {
      this.q = $$0;
   ...
   protected void l() {
      this.d(esh.a(te.d, $$0 -> this.au_()).a(this.g / 2 - 100, 196, 200, 20).a());
   }
   ...
   protected void B() {
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.w = this.d(new fae($$0 + 116, 159, true, $$0x -> this.E(), this.y));
      this.x = this.d(new fae($$0 + 43, 159, false, $$0x -> this.D(), this.y));
      this.G();
   }
   ...
   public void a(erw $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.u != this.s) {
         ...
         this.v = tf.a("book.pageIndicator", this.s + 1, Math.max(this.C(), 1));
      }
   ...
   public static void a(qr $$0, Consumer<String> $$1) {
      ...
      if (eqm.O().aQ() && $$0.b("filtered_pages", 10)) {
   ...
   public interface a {
      ...
      static eze.a a(ciy $$0) {
         if ($$0.a(cjb.th)) {
            return new eze.c($$0);
         } else {
            return (eze.a)($$0.a(cjb.tg) ? new eze.b($$0) : eze.k);
         }
      }
   }

   public static class b implements eze.a {
      ...
      private static List<String> b(ciy $$0) {
         qr $$1 = $$0.v();
         return (List<String>)($$1 != null ? eze.a($$1) : ImmutableList.of());
      }
   ...
   public static class c implements eze.a {
      private final List<String> a;
      ...
      private static List<String> b(ciy $$0) {
         qr $$1 = $$0.v();
         return (List<String>)($$1 != null && cku.a($$1) ? eze.a($$1) : ImmutableList.of(tf.a.a(tf.c("book.invalid.tag").a(n.e))));
      }
