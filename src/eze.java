public abstract class eze<T extends ceh> extends ezd<T> implements fbx {
   public final fbn x;
   private boolean y;
   private final aeu z;
   private final aeu A;
   ...
   public eze(T $$0, fbn $$1, cbo $$2, ti $$3, aeu $$4, aeu $$5, aeu $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aD_() {
      ...
      this.d(new esx(this.t + 20, this.h / 2 - 49, 20, 18, fbr.a, $$0 -> {
         this.x.f();
         this.t = this.x.a(this.g, this.c);
   ...
   protected void a(esa $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.p.s()) {
         int $$6 = 14;
         int $$7 = ars.f(this.p.r() * 13.0F) + 1;
         $$0.a(this.A, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = ars.f(this.p.q() * 24.0F);
