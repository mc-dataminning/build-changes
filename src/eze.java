...
public class eze extends eya {
   ...
   private String x = "";
   private final eux y = new eux(this::M, this::b, this::l, this::a, $$0x -> $$0x.length() < 1024 && this.i.b($$0x, 114) <= 128);
   ...
   private final bgp I;
   @Nullable
   private eze.a J = eze.a.a;
   private tf K = te.a;
   private final tf L;

   public eze(cbm $$0, cix $$1, bgp $$2) {
      super(eqd.a);
      this.p = $$0;
      this.q = $$1;
      this.I = $$2;
   ...
   protected void aC_() {
      this.O();
      this.F = this.d((esg)esg.a(tf.c("book.signButton"), $$0x -> {
         this.t = true;
         this.F();
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.E = this.d((esg)esg.a(te.d, $$0x -> {
         this.f.a(null);
         this.c(false);
      }).a(this.g / 2 + 2, 196, 98, 20).a());
      this.G = this.d((esg)esg.a(tf.c("book.finalizeButton"), $$0x -> {
         if (this.t) {
            this.c(true);
            this.f.a(null);
         }
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.H = this.d((esg)esg.a(te.e, $$0x -> {
         if (this.t) {
            this.t = false;
         }
      ...
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.C = this.d(new faf($$0 + 116, 159, true, $$0x -> this.E(), true));
      this.D = this.d(new faf($$0 + 43, 159, false, $$0x -> this.D(), true));
      this.F();
   }
   ...
   public void b(erv $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      $$0.a(ezf.l, (this.g - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(erv $$0, eze.c $$1, boolean $$2) {
      if (this.u / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(erv $$0, fnz[] $$1) {
      for (fnz $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(foc.E(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private eze.c a(eze.c $$0) {
      return new eze.c($$0.a - (this.g - 192) / 2 - 36, $$0.b - 32);
   }

   private eze.c b(eze.c $$0) {
      return new eze.c($$0.a + (this.g - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ac.b();
            eze.a $$4 = this.N();
            int $$5 = $$4.a(this.i, this.a(new eze.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.M();
      this.y.a(eqx.a($$1, -1, $$0, false), eqx.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            eze.a $$5 = this.N();
            int $$6 = $$5.a(this.i, this.a(new eze.c((int)$$0, (int)$$1)));
            this.y.c($$6, true);
            this.O();
         }
   ...
   private eze.a N() {
      if (this.J == null) {
         this.J = this.Q();
         this.K = tf.a("book.pageIndicator", this.v + 1, this.C());
      }
   ...
   private eze.a Q() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<eze.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, ub.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            eze.c $$12 = this.b(new eze.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new eze.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         eze.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new eze.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.i.b($$0.substring($$8[$$11], $$1));
            $$10 = new eze.c($$12, $$11 * 9);
         }

         List<fnz> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new eze.c(0, $$23), new eze.c($$25, $$23 + 9)));
               }
         ...
         return new eze.a($$0, $$10, $$9, $$8, $$4.toArray(new eze.b[0]), $$14.toArray(new fnz[0]));
      }
   }
   ...
   private fnz a(String $$0, eqx $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      eze.c $$8 = new eze.c((int)$$1.a($$6), $$4);
      eze.c $$9 = new eze.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private fnz a(eze.c $$0, eze.c $$1) {
      eze.c $$2 = this.b($$0);
      eze.c $$3 = this.b($$1);
      ...
      return new fnz($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final eze.a a = new eze.a("", new eze.c(0, 0), true, new int[]{0}, new eze.b[]{new eze.b(ub.a, "", 0, 0)}, new fnz[0]);
      ...
      public a(String $$0, eze.c $$1, boolean $$2, int[] $$3, eze.b[] $$4, fnz[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
