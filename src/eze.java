...
public class eze {
   ...
   private static final Queue<eze.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eze.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eze::a), ezc::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eze::a), ezc::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eze.a(this.b) + ", type=" + eze.b(this.c) + ", severity=" + eze.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
