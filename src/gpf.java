...
public class gpf {
   ...
   public void a(fgr $$0, glk $$1, double $$2, double $$3, double $$4) {
      gkg $$5 = this.h.t;
      $$5.dW().a(bvq.r, $$5.cR().g(100.0), $$0x -> true).forEach($$6 -> {
         ...
         $$7.map(abe.a::d).map($$1xx -> $$5.dW().a($$1xx)).map($$0xx -> $$0xx.o(this.h.av().a(true))).ifPresent($$6x -> {
            ...
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glu.a(2.0)), $$7x, 4.0F, c);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glu.a(2.0)), $$7x, 8.0F, d);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glu.a(2.0)), $$7x, 24.0F, e);
         });
         $$7.map(abe.a::e).ifPresent($$6x -> {
            a($$0, $$1, $$2, $$3, $$4, $$6.du(), $$6x.b(), a);
            gpk.a($$0, $$1, fbs.a(fbx.a($$6x)).d(-$$2, -$$3, -$$4), 1.0F, 0.0F, 0.0F, 1.0F);
         });
      });
   }

   private static void a(fgr $$0, glk $$1, double $$2, double $$3, double $$4, fbx $$5, fbx $$6, int $$7) {
      fgv $$8 = $$1.getBuffer(glu.a(2.0));
