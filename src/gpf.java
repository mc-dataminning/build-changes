...
public class gpf implements gpl.a {
   ...
   private final fmg F;
   private final Map<jh, gpf.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bvk $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dR();
      });
   }

   private void b(fgs $$0, gll $$1, double $$2, double $$3, double $$4) {
      jh $$5 = jh.a($$2, $$3, $$4);
   ...
   private void a(fgs $$0, gll $$1, gpf.a $$2) {
      int $$3 = 0;
   ...
   private void a(fgs $$0, gll $$1, abc.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gpu.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fgs $$0, gll $$1, abc.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fgs $$0, gll $$1, String $$2, gpf.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      gpl.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
