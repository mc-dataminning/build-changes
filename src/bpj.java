...
public interface bpj {
   ...
   default bpo d(String $$0) {
      this.a($$0);
      return new bpo(this);
   }

   default bpo c(Supplier<String> $$0) {
      this.a($$0);
      return new bpo(this);
   }
   ...
   static bpj a(bpj $$0, bpj $$1) {
      if ($$0 == bpf.a) {
         return $$1;
      } else {
         return (bpj)($$1 == bpf.a ? $$0 : new bpj.a($$0, $$1));
      }
   }

   public static class a implements bpj {
      private final bpj a;
      private final bpj c;

      public a(bpj $$0, bpj $$1) {
         this.a = $$0;
         this.c = $$1;
      }
