...
public class bpj {
   ...
   private bpj(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bpj a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bpj($$0, $$1);
   }

   public bpj.d a() throws IOException {
      bpj.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bpj.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bpj.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bpj.c $$3 = bpj.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bpj.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bpj.a($$0, $$3);
            }
         }
   ...
   public bpj.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bpj.c> $$2 = this.a().c();
      ...
      bpj.e $$4 = new bpj.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bpj.c b) implements bpj.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bpj.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bpj.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bpj.b> {
      private final List<bpj.b> a;

      d(List<bpj.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bpj.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bpj.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bpj.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bpj.d a() {
         ListIterator<bpj.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bpj.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bpj.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bpj.b> b() {
         return this.a.stream();
      }

      public Set<bpj.c> c() {
         return this.a.stream().map(bpj.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bpj.c b) implements bpj.b {
