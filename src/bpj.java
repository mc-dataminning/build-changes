...
public class bpj extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bpj.a(new Dynamic($$0, $$1), bpj.d, bpj.a);
      }
   };
   ...
   protected static void a(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("inTile", bjm.E.in($$0)));
   }

   protected static void b(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", bjm.E.in($$0)));
   }

   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("Items", DSL.list(bjm.t.in($$0))));
   }

   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = Maps.newHashMap();
      $$0.register($$1, "Item", $$1x -> DSL.optionalFields("Item", bjm.t.in($$0)));
      $$0.registerSimple($$1, "XPOrb");
      a($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", bjm.E.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", bjm.E.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", bjm.E.in($$0)));
      a($$0, $$1, "Snowball");
      a($$0, $$1, "Fireball");
      a($$0, $$1, "SmallFireball");
      a($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", bjm.E.in($$0), "Potion", bjm.t.in($$0)));
      a($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", bjm.t.in($$0)));
      a($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", bjm.E.in($$0), "TileEntityData", bjm.s.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", bjm.t.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", bjm.E.in($$0), "Items", DSL.list(bjm.t.in($$0))));
      b($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", bjm.E.in($$0), "Items", DSL.list(bjm.t.in($$0))));
      b($$0, $$1, "MinecartFurnace");
      b($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", bjm.E.in($$0), bjm.H.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", bjm.E.in($$0), "Items", DSL.list(bjm.t.in($$0))));
      $$0.register($$1, "MinecartCommandBlock", () -> DSL.optionalFields("DisplayTile", bjm.E.in($$0), "LastOutput", bjm.z.in($$0)));
      ...
      $$0.register($$1, "Enderman", $$1x -> DSL.optionalFields("carried", bjm.E.in($$0)));
      ...
      $$0.register($$1, "EntityHorse", $$1x -> DSL.optionalFields("Items", DSL.list(bjm.t.in($$0)), "ArmorItem", bjm.t.in($$0), "SaddleItem", bjm.t.in($$0)));
      $$0.registerSimple($$1, "Rabbit");
      $$0.register(
         $$1, "Villager", $$1x -> DSL.optionalFields("Inventory", DSL.list(bjm.t.in($$0)), "Offers", DSL.optionalFields("Recipes", DSL.list(bjm.x.in($$0))))
      );
      $$0.registerSimple($$1, "EnderCrystal");
      $$0.register($$1, "AreaEffectCloud", $$1x -> DSL.optionalFields("Particle", bjm.y.in($$0)));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", $$1x -> DSL.optionalFields("RecordItem", bjm.t.in($$0)));
      c($$0, $$1, "Trap");
      c($$0, $$1, "Dropper");
      $$0.register($$1, "Sign", () -> a($$0));
      $$0.register($$1, "MobSpawner", $$1x -> bjm.H.in($$0));
      $$0.registerSimple($$1, "Music");
      $$0.registerSimple($$1, "Piston");
      c($$0, $$1, "Cauldron");
      $$0.registerSimple($$1, "EnchantTable");
      $$0.registerSimple($$1, "Airportal");
      $$0.register($$1, "Control", () -> DSL.optionalFields("LastOutput", bjm.z.in($$0)));
      $$0.registerSimple($$1, "Beacon");
      $$0.register($$1, "Skull", () -> DSL.optionalFields("custom_name", bjm.z.in($$0)));
      $$0.registerSimple($$1, "DLDetector");
      c($$0, $$1, "Hopper");
      $$0.registerSimple($$1, "Comparator");
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bjm.F.in($$0))));
      $$0.register($$1, "Banner", () -> DSL.optionalFields("CustomName", bjm.z.in($$0)));
   ...
   public static TypeTemplate a(Schema $$0) {
      return DSL.optionalFields(
         new Pair[]{
            Pair.of("Text1", bjm.z.in($$0)),
            Pair.of("Text2", bjm.z.in($$0)),
            Pair.of("Text3", bjm.z.in($$0)),
            Pair.of("Text4", bjm.z.in($$0)),
            Pair.of("FilteredText1", bjm.z.in($$0)),
            Pair.of("FilteredText2", bjm.z.in($$0)),
            Pair.of("FilteredText3", bjm.z.in($$0)),
            Pair.of("FilteredText4", bjm.z.in($$0))
         }
      );
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bjm.b, () -> DSL.optionalFields("Inventory", DSL.list(bjm.t.in($$0)), "EnderItems", DSL.list(bjm.t.in($$0))));
      $$0.registerType(
         false,
         bjm.c,
         () -> DSL.fields(
      ...
      $$0.registerType(true, bjm.s, () -> DSL.optionalFields("components", bjm.w.in($$0), DSL.taggedChoiceLazy("id", DSL.string(), $$2)));
      $$0.registerType(true, bjm.C, () -> DSL.optionalFields("Riding", bjm.C.in($$0), bjm.D.in($$0)));
      $$0.registerType(false, bjm.B, () -> DSL.constType(blh.a()));
      $$0.registerType(
         true,
         bjm.D,
         () -> DSL.and(bjm.A.in($$0), DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", DSL.string(), $$1)))
      );
      $$0.registerType(
         true, bjm.t, () -> DSL.hook(DSL.optionalFields("id", DSL.or(DSL.constType(DSL.intType()), bjm.F.in($$0)), "tag", b($$0)), b, HookFunction.IDENTITY)
      );
      $$0.registerType(false, bjm.e, DSL::remainder);
      $$0.registerType(false, bjm.E, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(blh.a())));
      $$0.registerType(false, bjm.F, () -> DSL.constType(blh.a()));
      $$0.registerType(false, bjm.g, DSL::remainder);
      ...
      $$0.registerType(true, bjm.A, () -> DSL.optional(DSL.field("Equipment", DSL.list(bjm.t.in($$0)))));
   }

   public static TypeTemplate b(Schema $$0) {
      return DSL.optionalFields(
         new Pair[]{
            Pair.of("EntityTag", bjm.C.in($$0)),
            Pair.of("BlockEntityTag", bjm.s.in($$0)),
            Pair.of("CanDestroy", DSL.list(bjm.E.in($$0))),
            Pair.of("CanPlaceOn", DSL.list(bjm.E.in($$0))),
            Pair.of("Items", DSL.list(bjm.t.in($$0))),
            Pair.of("ChargedProjectiles", DSL.list(bjm.t.in($$0))),
            Pair.of("pages", DSL.list(bjm.z.in($$0))),
            Pair.of("filtered_pages", DSL.compoundList(bjm.z.in($$0))),
            Pair.of("display", DSL.optionalFields("Name", bjm.z.in($$0), "Lore", DSL.list(bjm.z.in($$0))))
         }
      );
   }
   ...
   protected static <T> T a(Dynamic<T> $$0, Map<String, String> $$1, Map<String, String> $$2) {
      return (T)$$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
            String $$3x = $$0.get("id").asString().result().map(blh::a).orElse("minecraft:air");
            ...
            if ($$2xx.get("id").result().isPresent()) {
               ...
               String $$3x = blh.a($$0.get("id").asString(""));
               String $$4 = $$2.get($$3x);
