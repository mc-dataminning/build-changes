...
public abstract class bpj<R extends Runnable> implements bor, bpl<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bpj(String $$0) {
      this.b = $$0;
      bop.a.a(this);
   }
   ...
   @Override
   public List<boo> bv() {
      return ImmutableList.of(boo.a(this.b + "-pending-tasks", bon.b, this::bx));
   }
}
