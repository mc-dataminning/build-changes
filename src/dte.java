...
public class dte implements dtg {
   public static final Codec<dte> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               biq.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               biq.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               biq.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bio.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bio.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dte(int $$0, biq $$1, biq $$2, int $$3, int $$4, biq $$5, bio $$6, bio $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
