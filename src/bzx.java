...
public abstract class bzx extends bxy implements bjw, bme, bmt, bmw, bnb {
   ...
   private static final Predicate<bml> cc = $$0 -> $$0 instanceof bzx && ((bzx)$$0).gy();
   private static final bwz cd = bwz.b().a(16.0).d().a(cc);
   private static final cpz ce = cpz.a(cnb.pt, cnb.rx, cws.ij.k(), cnb.oq, cnb.ud, cnb.pX, cnb.pY);
   private static final agm<Byte> cw = agp.a(bzx.class, ago.a);
   ...
   protected bzx(blz<? extends bzx> $$0, ctp $$1) {
      super($$0, $$1);
      this.t(1.0F);
      this.gA();
   }
   ...
   @Override
   protected void B() {
      this.bO.a(1, new bua(this, 1.2));
      this.bO.a(1, new bul(this, 1.2));
      this.bO.a(2, new bst(this, 1.0, bzx.class));
      this.bO.a(4, new btg(this, 1.0));
      this.bO.a(6, new buu(this, 0.7));
      this.bO.a(7, new btp(this, cfi.class, 6.0F));
      this.bO.a(8, new buc(this));
      if (this.gk()) {
         this.bO.a(9, new bud(this));
      }
   ...
   protected void gu() {
      ...
      this.bO.a(3, new bup(this, 1.25, cpz.a(cnb.ud, cnb.pX, cnb.pY), false));
   }
   ...
   public void a(@Nullable art $$0) {
      this.cp.a(0, new cmy(cnb.nK));
   }

   public void b(cfi $$0, cmy $$1) {
      if (this.l($$1)) {
         this.cp.a(1, $$1.c(1));
         if (!$$0.fT().d) {
            $$1.h(1);
   ...
   public int v(int $$0) {
      int $$1 = auo.a(this.gz() + $$0, 0, this.gF());
      this.u($$1);
      return $$1;
   }
      ...
      if (!$$1.k()) {
         ...
         if (this.bP() && this.ct) {
            ...
            if (this.cu > 5 && this.cu % 3 == 0) {
               ...
               this.a(ars.me, $$3.a() * 0.15F, $$3.b());
            }
         } else if (this.b($$3)) {
            this.a(ars.me, $$3.a() * 0.15F, $$3.b());
         } else {
            this.a(ars.md, $$3.a() * 0.15F, $$3.b());
         }
      }
   }

   private boolean b(dec $$0) {
      return $$0 == dec.b || $$0 == dec.aT || $$0 == dec.B || $$0 == dec.aU || $$0 == dec.aS;
   }

   protected void a(dec $$0) {
      this.a(ars.lY, $$0.a() * 0.15F, $$0.b());
   }

   public static bnq.a gE() {
      return bmn.C().a(bnr.h).a(bnr.l, 53.0).a(bnr.m, 0.225F);
   }
   ...
   public void d_() {
      ...
      if (!this.dM().B && this.bx()) {
         ...
         if (this.gH()) {
            if (!this.gw() && !this.bP() && this.ag.a(300) == 0 && this.dM().a_(this.dm().d()).a(cws.i)) {
               this.A(true);
            }
   ...
   protected void gG() {
      if (this.gy() && this.o_() && !this.gw()) {
         bml $$0 = this.dM().a(bzx.class, cd, this, this.dr(), this.dt(), this.dx(), this.cH().g(16.0));
   ...
   protected elt b(cfi $$0, elt $$1) {
      if (this.aC() && this.cr == 0.0F && this.gx() && !this.cs) {
         ...
         return new elt((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void b(float $$0, elt $$1) {
      ...
      this.au = true;
      if ($$1.e > 0.0) {
         float $$5 = auo.a(this.dC() * (float) (Math.PI / 180.0));
         float $$6 = auo.b(this.dC() * (float) (Math.PI / 180.0));
         this.g(this.dp().b((double)(-0.4F * $$5 * $$0), 0.0, (double)(0.4F * $$6 * $$0)));
      }
   }

   protected void gL() {
      this.a(ars.ma, 0.4F, 1.0F);
   }
   ...
   protected void a(blq $$0, bzx $$1) {
      this.a($$0, $$1, bnr.l, (double)bY, (double)bZ);
      this.a($$0, $$1, bnr.h, (double)bW, (double)bX);
      this.a($$0, $$1, bnr.m, (double)bT, (double)bU);
   }

   private void a(blq $$0, bzx $$1, bnm $$2, double $$3, double $$4) {
      double $$5 = a(this.c($$2), $$0.c($$2), $$3, $$4, this.ag);
      $$1.a($$2).a($$5);
   }

   static double a(double $$0, double $$1, double $$2, double $$3, auv $$4) {
      if ($$3 <= $$2) {
   ...
   private bnd a(final int $$0, final Predicate<cmy> $$1) {
      return new bnd() {
         @Override
         public cmy a() {
            return bzx.this.cp.a($$0);
         }
   ...
   public bnd a_(int $$0) {
      ...
      if ($$1 >= 0 && $$1 < 2 && $$1 < this.cp.b()) {
         if ($$1 == 0) {
            return this.a($$1, $$0x -> $$0x.b() || $$0x.a(cnb.nK));
         }
      ...
      int $$2 = $$0 - 500 + 2;
      return $$2 >= 2 && $$2 < this.cp.b() ? bnd.a(this.cp, $$2) : super.a_($$0);
   }
   ...
   private elt a(elt $$0, bml $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (chf.a($$8)) {
               elo $$9 = $$1.e($$6);
               elt $$10 = new elt($$2, (double)$$5.v() + $$8, $$4);
               if (chf.a(this.dM(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public elt b(bml $$0) {
      elt $$1 = a((double)this.dg(), (double)$$0.dg(), this.dC() + ($$0.fm() == bmf.b ? 90.0F : -90.0F));
      elt $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         elt $$3 = a((double)this.dg(), (double)$$0.dg(), this.dC() + ($$0.fm() == bmf.a ? 90.0F : -90.0F));
         elt $$4 = this.a($$3, $$0);
