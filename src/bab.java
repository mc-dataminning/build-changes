...
public class bab extends beo {
   public bab(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bfp.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bfp.s, "minecraft:jukebox");
