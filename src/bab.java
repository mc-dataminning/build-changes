...
public class bab extends ber {
   public bab(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bfs.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bfs.s, "minecraft:piston");
