...
public class bab extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bgr.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bab::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bab::a);
      return this.a($$0, "minecraft:trident", bab::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bgr.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bgr.B, $$1);
