...
public class dtu {
   ...
   private final List<dts> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dtu.a l = new dtu.d(5.999997E7F);
   public static final dtu.c d = new dtu.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(evn $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public iz b(double $$0, double $$1, double $$2) {
      return iz.a(ayz.a($$0, this.e(), this.g()), $$1, ayz.a($$2, this.f(), this.h()));
   }

   public double a(bsv $$0) {
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dtu.a)($$0 == $$1 ? new dtu.d($$1) : new dtu.b($$0, $$1, $$2));
   ...
   class b implements dtu.a {
      ...
      @Override
      public double a() {
         return ayz.a(dtu.this.a() - this.e() / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dtu.this.b() - this.e() / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
      }
      ...
      @Override
      public dtt i() {
         return this.c < this.b ? dtt.b : dtt.a;
      }
      ...
      @Override
      public dtu.a l() {
         return (dtu.a)(this.g() <= 0L ? dtu.this.new d(this.c) : this);
      }
      ...
      public ewl m() {
         return ewi.a(
            ewi.c,
            ewi.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evw.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dtu.c a(DynamicLike<?> $$0, dtu.c $$1) {
         ...
         return new dtu.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dtu.a {
      ...
      private void n() {
         this.c = ayz.a(dtu.this.a() - this.b / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
         this.d = ayz.a(dtu.this.b() - this.b / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
         this.e = ayz.a(dtu.this.a() + this.b / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
         this.f = ayz.a(dtu.this.b() + this.b / 2.0, (double)(-dtu.this.k), (double)dtu.this.k);
         this.g = ewi.a(
            ewi.c,
            ewi.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evw.e
