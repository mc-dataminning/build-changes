...
public class dtu {
   ...
   final boolean g;
   private final axr<dmr> h;
   private final int i;
   private final int j;
   private final int k;
   private final int l;
   private List<dtu.a> m = new ArrayList<>();

   public dtu(boolean $$0, axr<dmr> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static dtu a() {
      return new dtu(false, axc.bW, 10, 4, 10, 5);
   }

   public static dtu b() {
      return new dtu(true, axc.bX, 50, 1, 5, 10);
   }
   ...
   public void a(tz $$0) {
      this.m.clear();
      $$0.<List>a("cursors", dtu.a.b.sizeLimitedListOf(32)).orElse(List.of()).forEach(this::a);
   }

   public void b(tz $$0) {
      $$0.a("cursors", dtu.a.b.listOf(), this.m);
   }

   public void a(iv $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new dtu.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(dtu.a $$0) {
      if (this.m.size() < 32) {
         this.m.add($$0);
      }
   }

   public void a(djn $$0, iv $$1, azv $$2, boolean $$3) {
      if (!this.m.isEmpty()) {
         List<dtu.a> $$4 = new ArrayList<>();
         Map<iv, dtu.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<dtu.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  iv.a.fieldOf("pos").forGetter(dtu.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(dtu.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(dtu.a::c),
      ...
      private boolean a(djn $$0, iv $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(djn $$0, iv $$1, azv $$2, dtu $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.g)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static dtp a(eat $$0) {
         return $$0.b() instanceof dtp $$1 ? $$1 : dtp.u_;
      }
      ...
      @Nullable
      private static iv a(djn $$0, iv $$1, azv $$2) {
         iv.a $$3 = $$1.k();
         iv.a $$4 = $$1.k();
      ...
      private static boolean a(djn $$0, iv $$1, iv $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            iv $$3 = $$2.b($$1);
      ...
      private static boolean a(djn $$0, iv $$1, jb $$2) {
         iv $$3 = $$1.a($$2);
