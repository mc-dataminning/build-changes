...
public class ajt {
   public static void a(CommandDispatcher<ds> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a(
                     ...
                     .then(dt.a("sound").then(dt.a("type", ea.a()).executes($$0x -> a((ds)$$0x.getSource(), ea.a($$0x, "type"))))))
   ...
   private static int a(ds $$0, int $$1) throws CommandSyntaxException {
      ...
      if ($$2 != null) {
         int $$3 = $$2.l();
         if ($$1 > $$3) {
            $$0.b(vb.b("Sorry, the max bad omen level you can set is " + $$3));
         } else {
            int $$4 = $$2.m();
            $$2.a($$1);
            $$0.a(() -> vb.b("Changed village's bad omen level from " + $$4 + " to " + $$1), false);
         }
      } else {
         $$0.b(vb.b("No raid found here"));
      }
   ...
   private static int b(ds $$0) {
      $$0.a(() -> vb.b("Spawned a raid captain"), false);
      cga $$1 = blj.az.a((csy)$$0.e());
      if ($$1 == null) {
         $$0.b(vb.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(blk.f, cfz.s());
         $$1.a_($$0.d().c, $$0.d().d, $$0.d().e);
         $$1.a($$0.e(), $$0.e().d_(hv.a($$0.d())), blz.n, null, null);
         $$0.e().a_($$1);
         return 1;
      }
   }

   private static int a(ds $$0, @Nullable vb $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         amp $$2 = $$0.e();
         elb $$3 = $$0.d().b(5.0, 0.0, 0.0);
         $$2.a(null, $$3.c, $$3.d, $$3.e, arc.uf, ard.g, 2.0F, 1.0F, $$2.z.g());
      }
   ...
   private static int b(ds $$0, int $$1) throws CommandSyntaxException {
      ...
      hv $$3 = $$2.dm();
      if ($$2.z().d($$3)) {
         $$0.b(vb.b("Raid already started close by"));
         return -1;
      } else {
         cgb $$4 = $$2.z().y();
         cfz $$5 = $$4.a($$2);
         if ($$5 != null) {
            $$5.a($$1);
            $$4.c();
            $$0.a(() -> vb.b("Created a raid in your local village"), false);
         } else {
            $$0.b(vb.b("Failed to create a raid in your local village"));
         }
   ...
   private static int c(ds $$0) throws CommandSyntaxException {
      ...
      if ($$3 != null) {
         $$3.n();
         $$0.a(() -> vb.b("Stopped raid"), false);
         return 1;
      } else {
         $$0.b(vb.b("No raid here"));
         return -1;
      }
   }
   ...
   private static int d(ds $$0) throws CommandSyntaxException {
      ...
      if ($$1 != null) {
         ...
         $$3.append(" / ");
         $$3.append($$1.g());
         $$0.a(() -> vb.b($$3.toString()), false);
         return 1;
      } else {
         $$0.b(vb.b("Found no started raids"));
         return 0;
      }
   }

   @Nullable
   private static cfz a(amq $$0) {
      return $$0.z().c($$0.dm());
   }
}
