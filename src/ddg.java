...
public class ddg {
   public static <T> List<ddg.b> a(List<T> $$0, Function<T, List<jm<ehn>>> $$1, boolean $$2) {
      Object2IntMap<ehn> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, ehn c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jm<ehn>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ji<ehn> $$12 : $$10.get($$11)) {
               ehn $$13 = $$12.a();
      ...
      Builder<ddg.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<ehn> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddg.b($$28));
      }
   ...
   public static record b(List<ehn> a, ToIntFunction<ehn> b) {
      b(List<ehn> $$0) {
         this($$0, ac.h($$0));
      }
   }
