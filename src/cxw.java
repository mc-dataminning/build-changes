...
public class cxw extends cwm {
   ...
   public cxw(wp $$0, wp $$1, wp $$2, wp $$3, List<akv> $$4, List<akv> $$5, cwm.a $$6) {
      super($$6);
      this.L = $$0;
      this.M = $$1;
      this.N = $$2;
   ...
   public static cxw a(cwm.a $$0) {
      return new cxw(n, o, p, q, p(), q(), $$0);
   }

   public static cxw b(cwm.a $$0) {
      return new cxw(r, s, t, u, r(), s(), $$0);
   }
