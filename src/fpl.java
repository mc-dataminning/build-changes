...
public class fpl extends foq<cqp> {
   ...
   protected void aT_() {
      super.aT_();
      this.T = new fuq(this.l.aP().a(fyh.r));
   }
   ...
   private void d(fhx $$0, int $$1, int $$2, float $$3) {
      ...
      this.T.a(0.0F, $$8, $$9, $$4);
      fbk $$10 = $$0.d().getBuffer(this.T.a(R));
      this.T.a($$0.c(), $$10, 15728880, gqa.d);
      $$0.e();
      $$0.c().b();
      fad.d();
   }
