...
public class fpl extends fop {
   ...
   public fpl(foc $$0, int $$1, int $$2, int $$3, int $$4, wp $$5, wp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.n = $$0;
      this.o = $$5;
      this.p = new fpo($$0, $$3 - this.b());
      this.p.a(this::r);
   }
   ...
   @Override
   public void a(fsq $$0) {
      $$0.a(fsp.a, wp.a("gui.narrate.editBox", this.B(), this.q()));
   }
   ...
   private void r() {
      double $$0 = this.g();
      fpo.a $$1 = this.p.c((int)($$0 / 9.0));
      if (this.p.d() <= $$1.a()) {
         $$0 = (double)(this.p.g() * 9);
      } else {
         fpo.a $$2 = this.p.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.p.d() > $$2.b()) {
