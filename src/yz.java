...
public class yz {
   ...
   public static <T extends vv> void a(yw<T> $$0, T $$1, bqy<?> $$2) throws alh {
      if (!$$2.bx()) {
         $$2.c(() -> {
            if ($$1.a($$0)) {
               try {
   ...
   public static <T extends vv> z a(Exception $$0, yw<T> $$1, T $$2) {
      if ($$0 instanceof z $$3) {
         a($$3.a(), $$2, $$1);
         return $$3;
      } else {
   ...
   public static <T extends vv> void a(o $$0, T $$1, @Nullable yw<T> $$2) {
      if ($$2 != null) {
