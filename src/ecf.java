...
public class ecf extends ebk<edw> {
   ...
   protected boolean a(
      ddb $$0, ayo $$1, edw $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dsk $$0, Function<ja, dsk> $$1, ayo $$2, edw $$3, edw.a $$4, ja.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
