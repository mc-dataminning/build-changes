...
public class ecf implements ecm.c {
   ...
   private final ObjectListIterator<ecf.a> h;
   private final ObjectListIterator<eop> i;

   public static ecf a(dhe $$0, dfo $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<ecf.a> $$4 = new ObjectArrayList(10);
      ObjectList<eop> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != enx.a).forEach($$5x -> {
         enx $$6 = $$5x.h().d();
         ...
         for (enq $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eni) {
                  ...
                  $$4.add(new ecf.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new ecf($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public ecf(ObjectListIterator<ecf.a> $$0, ObjectListIterator<eop> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(ene a, enx b, int c) {
   }
}
