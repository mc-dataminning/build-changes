...
public class ft implements ArgumentType<UUID> {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wu.c("argument.uuid.invalid"));
   ...
   public static UUID a(CommandContext<ed> $$0, String $$1) {
