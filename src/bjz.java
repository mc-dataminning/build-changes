...
public class bjz extends bjt {
   ...
   public bjz(cqz $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bjx.J, $$0);
      this.e($$1, $$2, $$3);
   ...
   public bjz(bjx<? extends bjz> $$0, cqz $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         eif $$0 = new eif(this.k.dq() - this.dq(), this.k.ds() + (double)this.k.cH() / 2.0 - this.ds(), this.k.dw() - this.dw());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void t() {
      ...
      if (this.dL() instanceof alq) {
         for (bjz $$1 : this.dL().a(djz.a(bjz.class), this.cG().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(alq $$0, eif $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bjz($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(alq $$0, eif $$1, int $$2) {
      eia $$3 = eia.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bjz> $$5 = $$0.a(djz.a(bjz.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bjz $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(bjz $$0, int $$1, int $$2) {
      return !$$0.dG() && ($$0.ah() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bjz $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(ccx $$0, int $$1) {
      Entry<bjy, ckj> $$2 = cov.a(cox.L, $$0, ckj::j);
      if ($$2 != null) {
         ckj $$3 = $$2.getValue();
