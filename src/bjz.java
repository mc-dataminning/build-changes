...
public class bjz extends DataFix {
   ...
   public static int a(int $$0) {
      return b[bae.a($$0 - 1, 0, b.length - 1)];
   }

   public bjz(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(bix.B, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(bix.B), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
