...
public class bjz extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Either<?, Pair<?, Pair<?, Pair<?, Dynamic<?>>>>>>> $$0 = this.getInputSchema().getType(bjb.z);
                        ...
                        $$0xxxx -> $$0xxxx.mapSecond(
                              $$0xxxxx -> $$0xxxxx.mapSecond(
                                    $$0xxxxxx -> $$0xxxxxx.mapSecond(
                                          $$0xxxxxxx -> $$0xxxxxxx.update("bold", bjz::a)
                                                .update("italic", bjz::a)
                                                .update("underlined", bjz::a)
                                                .update("strikethrough", bjz::a)
                                                .update("obfuscated", bjz::a)
                                       )
                                 )
                           )
                     )
