...
public record bo(Optional<Boolean> b, Optional<Boolean> c, Optional<Boolean> d, Optional<Boolean> e, Optional<Boolean> f) {
   public static final Codec<bo> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               arf.a(Codec.BOOL, "is_on_fire").forGetter(bo::a),
               arf.a(Codec.BOOL, "is_sneaking").forGetter(bo::b),
               arf.a(Codec.BOOL, "is_sprinting").forGetter(bo::c),
               arf.a(Codec.BOOL, "is_swimming").forGetter(bo::d),
               arf.a(Codec.BOOL, "is_baby").forGetter(bo::e)
            )
            .apply($$0, bo::new)
   );
