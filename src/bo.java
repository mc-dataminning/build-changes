...
public class bo extends dr<bo.a> {
   @Override
   public Codec<bo.a> a() {
      return bo.a.a;
   }

   public void a(arg $$0, cup $$1, int $$2) {
      this.a($$0, $$2x -> $$2x.a($$1, $$2));
   }

   public static record a(Optional<bf> b, Optional<cp> c, de.d d) implements dr.a {
