public class lg implements lh {
   ...
   @Override
   public final czk dispense(le $$0, czk $$1) {
      czk $$2 = this.a($$0, $$1);
      this.a($$0);
      this.a($$0, $$0.d().c(dos.b));
      return $$2;
   }
   ...
   public static void a(djh $$0, czk $$1, int $$2, jb $$3, jp $$4) {
      double $$5 = $$4.a();
      double $$6 = $$4.b();
      double $$7 = $$4.c();
      if ($$3.o() == jb.a.b) {
   ...
   protected czk a(le $$0, czk $$1, czk $$2) {
      $$1.h(1);
      if ($$1.f()) {
         return $$2;
      } else {
