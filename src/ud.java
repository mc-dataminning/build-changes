...
public record ud<S>(List<ud.a<S>> a) {
   public static <S> ud<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<ud.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<ud.a<S>> $$2 = new ArrayList<>();
