...
public class fxf extends fyb {
   private static final alg a = alg.b("icon/draft_report");
   private int b;
   private final wy c;
   private final boolean d;
   private wy s;
   private final List<fsj> u = Lists.newArrayList();
   @Nullable
   private fsj v;

   public fxf(@Nullable wy $$0, boolean $$1) {
   ...
   protected void aO_() {
      ...
      this.u.add(this.c(fsj.a($$0, $$0x -> {
         this.m.t.gg();
         $$0x.j = false;
      }).a(this.n / 2 - 100, this.o / 4 + 72, 200, 20).a()));
      this.v = this.c(
         fsj.a(wy.c("deathScreen.titleScreen"), $$0x -> this.m.ba().a(this.m, this, this::m, true)).a(this.n / 2 - 100, this.o / 4 + 96, 200, 20).a()
      );
      this.u.add(this.v);
      this.c(false);
      this.s = wy.a("deathScreen.score.value", wy.b(Integer.toString(this.m.t.gd())).a(n.o));
   }
   ...
   private void E() {
      ...
      this.m.b(new fxm(wy.c("menu.savingLevel")));
      this.m.a(new fyd());
   }
   ...
   public void a(frv $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.v != null && this.m.ba().c()) {
         $$0.a(gqk::H, a, this.v.F() + this.v.A() - 17, this.v.G() + 3, 15, 15);
      }
   }
   ...
   static void a(frv $$0, int $$1, int $$2) {
