...
public class bcw extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(bfa.B.typeName(), bgk.a()));
      Type<Pair<String, String>> $$1 = DSL.named(bfa.B.typeName(), bgk.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(bfa.t),
         this.getOutputSchema().getType(bfa.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(bfa.B.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
