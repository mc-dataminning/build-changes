...
public class bcw {
   ...
   private bcw(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bcw a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bcw($$0, $$1);
   }

   public bcw.d a() throws IOException {
      bcw.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bcw.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bcw.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bcw.c $$3 = bcw.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bcw.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bcw.a($$0, $$3);
            }
         }
   ...
   public bcw.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bcw.c> $$2 = this.a().c();
      ...
      bcw.e $$4 = new bcw.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bcw.c b) implements bcw.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bcw.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bcw.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bcw.b> {
      private final List<bcw.b> a;

      d(List<bcw.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bcw.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bcw.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bcw.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bcw.d a() {
         ListIterator<bcw.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bcw.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bcw.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bcw.b> b() {
         return this.a.stream();
      }

      public Set<bcw.c> c() {
         return this.a.stream().map(bcw.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bcw.c b) implements bcw.b {
