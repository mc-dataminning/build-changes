...
public class dwe implements dwd {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<dwe> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dqs.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dqu.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dqt.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               blb.b(1, 20).fieldOf("outer_wall_distance").orElse(blh.a(4, 5)).forGetter($$0x -> $$0x.i),
               blb.b(1, 20).fieldOf("distribution_points").orElse(blh.a(3, 4)).forGetter($$0x -> $$0x.j),
               blb.b(0, 10).fieldOf("point_offset").orElse(blh.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dwe(dqs $$0, dqu $$1, dqt $$2, double $$3, double $$4, boolean $$5, blb $$6, blb $$7, blb $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
