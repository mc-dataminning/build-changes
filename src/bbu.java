...
public class bbu extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhs.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bhs.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bhs.s);
