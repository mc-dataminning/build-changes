...
public class gjx extends gjw implements abc, wm {
   private static final Logger l = LogUtils.getLogger();
   private final GameProfile m;
   private cum n;
   private final js.b o;
   private final gkn p = new gkn();
   @Nullable
   private gkg q;
   @Nullable
   protected fsk.b k;

   public gjx(foz $$0, vr $$1, gke $$2) {
      super($$0, $$1, $$2);
      this.m = $$2.a();
      this.o = $$2.c();
      this.n = $$2.d();
   ...
   public void a(abd $$0) {
      ...
      this.b.a(ago.b.a(wj.a($$1)), new gka(this.a, this.b, new gke(this.m, this.e, $$1, this.n, this.d, this.c, this.f, this.h, this.k, this.i, this.j)));
      this.b.a(abl.a);
