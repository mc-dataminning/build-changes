...
public class gjx extends gjs {
   ...
   gjx(gfk $$0, double $$1, double $$2, double $$3, ecv $$4, int $$5) {
      super($$0, $$1, $$2, $$3, 0.0, 0.0, 0.0);
      this.D = 0.3F;
      this.a = $$4;
      this.t = $$5;
      Optional<fby> $$6 = $$4.a($$0);
      if ($$6.isPresent()) {
         fby $$7 = $$6.get();
         double $$8 = $$1 - $$7.a();
         double $$9 = $$2 - $$7.b();
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         Optional<fby> $$0 = this.a.a(this.c);
         if ($$0.isEmpty()) {
            this.k();
         } else {
            int $$1 = this.t - this.s;
   ...
   public static class a implements giv<ly> {
      private final gjn a;
      ...
      public gis a(ly $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjx $$8 = new gjx($$1, $$2, $$3, $$4, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
