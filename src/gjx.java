...
public abstract class gjx<T extends bto, M extends ftz<T>> extends giv<T> implements gks<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gni<T, M>> g = Lists.newArrayList();

   public gjx(giw.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gni<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, ezx $$3, gdn $$4, int $$5) {
      ...
      this.f.d = $$0.bR();
      this.f.e = $$0.p_();
      float $$6 = ayy.j($$2, $$0.aZ, $$0.aY);
      float $$7 = ayy.j($$2, $$0.bb, $$0.ba);
      float $$8 = $$7 - $$6;
      if ($$0.bR() && $$0.dc() instanceof bto $$9) {
         $$6 = ayy.j($$2, $$9.aZ, $$9.aY);
         $$8 = $$7 - $$6;
         float $$10 = ayy.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected gdv a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      ale $$4 = this.a($$0);
      if ($$2) {
         return gdv.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? gdv.r($$4) : null;
      }
   }

   public static int c(bto $$0, float $$1) {
      return gop.a(gop.a($$1), gop.a($$0.aO > 0 || $$0.aQ > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return ffe.M() && $$0 != $$3.an() && $$5 && !$$0.bS();
      }
   }

   public static boolean e(bto $$0) {
      if ($$0 instanceof cmw || $$0.ag()) {
         String $$1 = n.a($$0.af().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cmw) || ((cmw)$$0).a(cmx.a);
         }
      }
