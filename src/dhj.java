...
public class dhj<T> implements dhr<T> {
   private final hl<T> a;
   private final aqr<T> b;
   private final dhs<T> c;
   private final int d;

   public dhj(hl<T> $$0, int $$1, dhs<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::c);
   }

   public dhj(hl<T> $$0, int $$1, dhs<T> $$2) {
      this($$0, $$1, $$2, aqr.c(1 << $$1));
   }

   private dhj(hl<T> $$0, int $$1, dhs<T> $$2, aqr<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dhr<T> c() {
      return new dhj<>(this.a, this.d, this.c, this.b.c());
   }
}
