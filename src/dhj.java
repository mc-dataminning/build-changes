...
public class dhj<T> implements dhl<T> {
   ...
   private dhj(hk<T> $$0, int $$1, dhm<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dhj(hk<T> $$0, T[] $$1, dhm<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dhl<T> c() {
      return new dhj<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
