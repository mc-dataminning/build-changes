...
public class fat {
   ...
   public void a(fcd $$0, String $$1, fda.a $$2, eqc $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fat.b $$13 = new fat.b($$1.trim(), this.f, $$3, $$2);
                  fat.a $$14 = new fat.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fat.c $$30 = new fat.c(this.f, $$2, $$0);
                        fat.a $$31 = new fat.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fch(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eqc $$2) throws IOException {
      ...
      File $$15 = new File(ffn.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eqc d;
      private final fda.a e;

      b(final String $$0, final File $$1, final eqc $$2, final fda.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fat.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fat.this.b && !fat.this.d) {
            try {
               fat.this.e = true;
               fat.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fat.a.error("Error extracting archive", var3);
               fat.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fda.a c;
      private final fcd d;

      c(final File $$0, final fda.a $$1, final fcd $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fat.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fat.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fat.this.g);
                  fat.this.c = true;
               } else {
                  fat.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fat.this.d = true;
               }
            } catch (IOException var3) {
               fat.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fat.this.d = true;
            }
         }
      }
