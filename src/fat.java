...
public class fat extends esw {
   ...
   private void a(uq $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         uk $$3 = $$0.a($$2);
         String $$4 = $$3.l("Name");
         fan $$5 = this.c.c($$4);
         xi $$6 = xi.a.a($$3.l("DisplayName"), $$1);
         if ($$6 != null) {
            $$5.a($$6);
         }
         ...
         if ($$3.b("MemberNamePrefix", 8)) {
            xi $$7 = xi.a.a($$3.l("MemberNamePrefix"), $$1);
            if ($$7 != null) {
               $$5.b($$7);
            }
         }
         ...
         if ($$3.b("MemberNameSuffix", 8)) {
            xi $$8 = xi.a.a($$3.l("MemberNameSuffix"), $$1);
            if ($$8 != null) {
               $$5.c($$8);
            }
         }
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            fau.b $$9 = fau.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            fau.b $$10 = fau.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            fau.a $$11 = fau.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(uq $$0, js.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         uk $$3 = $$0.a($$2);
         String $$4 = $$3.l("CriteriaName");
         fav $$5 = fav.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, fav.b.d());
            return fav.b;
         });
         String $$6 = $$3.l("Name");
         xi $$7 = xi.a.a($$3.l("DisplayName"), $$1);
         fav.a $$8 = fav.a.a($$3.l("RenderType"));
         boolean $$9 = $$3.q("display_auto_update");
         yy $$10 = (yy)za.b.parse($$1.a(uy.a), $$3.c("format")).result().orElse(null);
   ...
   private uq b(js.a $$0) {
      ...
      for (fan $$3 : this.c.g()) {
         ...
         $$4.a("MemberNamePrefix", xi.a.a($$3.e(), $$0));
         $$4.a("MemberNameSuffix", xi.a.a($$3.f(), $$0));
   ...
   private uq c(js.a $$0) {
      ...
      for (fak $$3 : this.c.c()) {
         ...
         $$4.a("DisplayName", xi.a.a($$3.d(), $$0));
         $$4.a("RenderType", $$3.h().a());
         $$4.a("display_auto_update", $$3.e());
         yy $$5 = $$3.f();
         if ($$5 != null) {
            za.b.encodeStart($$0.a(uy.a), $$5).ifSuccess($$1x -> $$4.a("format", $$1x));
         }
