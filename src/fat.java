...
public class fat implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fat.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fat(List<fat.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fat a(BufferedReader $$0) {
      return new fat($$0.lines().flatMap($$0x -> fat.a.a($$0x).stream()).toList());
   }

   public static record a(fat.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fat.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fat.a(fat.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fat.a(fat.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fat.a(fat.b.b, $$3));
      ...
      static fat.a b(String $$0) {
         return new fat.a(fat.b.a, "glob:" + $$0);
      }

      static fat.a c(String $$0) {
         return new fat.a(fat.b.a, "regex:" + $$0);
      }

      static fat.a d(String $$0) {
         return new fat.a(fat.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fat.b a = FileSystem::getPathMatcher;
      fat.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
