...
public class fat {
   ...
   public fat(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public fat(fay $$0, fay $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static fat a(enc $$0) {
      return new fat((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static fat a(fay $$0) {
      return new fat($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static fat a(ji $$0, ji $$1) {
      return new fat(
   ...
   public fat a(double $$0) {
      return new fat($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public fat b(double $$0) {
      return new fat(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public fat c(double $$0) {
      return new fat(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public fat d(double $$0) {
      return new fat(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public fat e(double $$0) {
      return new fat(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public fat f(double $$0) {
      return new fat(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public fat b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public fat c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public fat d(double $$0, double $$1, double $$2) {
      return new fat(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public fat f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public fat h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fay> b(fay $$0, fay $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fay> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fay $$6, fay $$7) {
   ...
   @Nullable
   public static fau a(Iterable<fat> $$0, fay $$1, fay $$2, ji $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new fau($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jn a(fat $$0, fay $$1, double[] $$2, @Nullable jn $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jn a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fay $$6, double[] $$7, @Nullable jn $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fay $$0, List<fat> $$1) {
      fay $$2 = this.f();
      fay $$3 = $$2.e($$0);

      for (fat $$4 : $$1) {
         fat $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fay f() {
      return new fay(ayy.d(0.5, this.a, this.d), ayy.d(0.5, this.b, this.e), ayy.d(0.5, this.c, this.f));
   }

   public fay g() {
      return new fay(ayy.d(0.5, this.a, this.d), this.b, ayy.d(0.5, this.c, this.f));
   }
   ...
   public fay i() {
      return new fay(this.d, this.e, this.f);
   }

   public static fat a(fay $$0, double $$1, double $$2, double $$3) {
      return new fat($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
