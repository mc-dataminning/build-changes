...
public class fat extends fcc {
   public static final double a = 7.0;
   private static final vb c = vb.c("chat_screen.usage");
   ...
   protected void aP_() {
      ...
      this.b = new ewq(this.f.i, 4, this.h - 12, this.g - 4, 12, vb.c("chat.editBox")) {
         @Override
         protected vp aM_() {
            return super.aM_().b(fat.this.o.e());
         }
      };
      this.b.l(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new ewk(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
      this.c(this.b);
   }
   ...
   public void a(evw $$0, int $$1, int $$2, float $$3) {
      ...
      super.a($$0, $$1, $$2, $$3);
      this.o.a($$0, $$1, $$2);
      euf $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.i, this.i.c($$4.g(), 210), $$1, $$2);
      } else {
         vy $$5 = this.a((double)$$1, (double)$$2);
         if ($$5 != null && $$5.i() != null) {
            $$0.a(this.i, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(faa $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(ezz.a, vb.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private vy a(double $$0, double $$1) {
   ...
   public String a(String $$0) {
      return auu.e(StringUtils.normalizeSpace($$0.trim()));
   }
}
