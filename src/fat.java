...
public abstract class fat<T extends fat<T>> {
   ...
   public fat(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = far.a();
         if ($$3 != null) {
         ...
         throw new fcc(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fcc(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fcc(var2.getMessage(), var2);
      }
   }
   ...
   public static fat<?> a(String $$0) {
      return new fat.b($$0, 5000, 60000);
   }

   public static fat<?> a(String $$0, int $$1, int $$2) {
      return new fat.b($$0, $$1, $$2);
   }

   public static fat<?> b(String $$0, String $$1) {
      return new fat.c($$0, $$1, 5000, 60000);
   }

   public static fat<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fat.c($$0, $$1, $$2, $$3);
   }

   public static fat<?> b(String $$0) {
      return new fat.a($$0, 5000, 60000);
   }

   public static fat<?> c(String $$0, String $$1) {
      return new fat.d($$0, $$1, 5000, 60000);
   }

   public static fat<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fat.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fat<fat.a> {
   ...
   public static class b extends fat<fat.b> {
   ...
   public static class c extends fat<fat.c> {
      ...
      public fat.c f() {
         try {
            ...
            throw new fcc(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fat<fat.d> {
      private final String c;
