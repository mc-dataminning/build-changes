...
public class fat extends fai implements fbn {
   private static final fbx d = new fbx(new ajc("widget/text_field"), new ajc("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, avy> D = ($$0x, $$1x) -> avy.forward($$0x, wp.a);
   @Nullable
   private vs E;
   private long F = ac.b();

   public fat(ezv $$0, int $$1, int $$2, vs $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fat(ezv $$0, int $$1, int $$2, int $$3, int $$4, vs $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fat(ezv $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fat $$5, vs $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, avy> $$0) {
      this.D = $$0;
   }
   ...
   protected wg aM_() {
      vs $$0 = this.x();
      return vs.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = awm.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = awm.a($$0) - this.B();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.g());
      this.b(this.o.a($$3, $$2).length() + this.v, fgh.v());
   }
   ...
   public void b(ezx $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = awm.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fwy.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = awm.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = awm.a(this.v, 0, this.p.length());
      }
   }
