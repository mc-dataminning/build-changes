...
public class aca implements ze<abq> {
   ...
   public static aca b(bpk $$0) {
      return new aca($$0.h(), new aca.f($$0.j()));
   }

   public static aca c(bpk $$0) {
      return new aca($$0.h(), new aca.e($$0.i()));
   }

   public static aca d(bpk $$0) {
      return new aca($$0.h(), new aca.h($$0.k(), $$0.l()));
   }

   public static aca e(bpk $$0) {
   ...
   static class a implements aca.c {
      ...
      private final bpk.a c;
      private final bpk.b d;
      ...
      private a(wi $$0) {
         ...
         this.b = $$0.readFloat();
         this.c = $$0.b(bpk.a.class);
         this.d = $$0.b(bpk.b.class);
   ...
   public interface b {
      default void a(UUID $$0, wx $$1, float $$2, bpk.a $$3, bpk.b $$4, boolean $$5, boolean $$6, boolean $$7) {
      }
      ...
      default void a(UUID $$0, bpk.a $$1, bpk.b $$2) {
      }
   ...
   static class h implements aca.c {
      private final bpk.a a;
      private final bpk.b b;
      ...
      private h(wi $$0) {
         this.a = $$0.b(bpk.a.class);
         this.b = $$0.b(bpk.b.class);
      }
