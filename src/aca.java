...
public class aca implements zk<abz> {
   ...
   public aca(btj $$0, arf $$1) {
      this($$0, $$1, 0);
   }

   public aca(btj $$0, arf $$1, int $$2) {
      this($$0.ap(), $$0.cD(), $$1.b().a(), $$1.b().b(), $$1.b().c(), $$1.d(), $$1.e(), $$0.ao(), $$2, $$1.c(), (double)$$1.f());
   }

   public aca(btj $$0, int $$1, je $$2) {
      this($$0.ap(), $$0.cD(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dK(), $$0.dI(), $$0.ao(), $$1, $$0.dv(), (double)$$0.cx());
   }

   public aca(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, btq<?> $$7, int $$8, eye $$9, double $$10) {
      this.d = $$0;
      this.e = $$1;
      this.g = $$2;
      this.h = $$3;
      this.i = $$4;
      this.m = (byte)azc.d($$5 * 256.0F / 360.0F);
      this.n = (byte)azc.d($$6 * 256.0F / 360.0F);
      this.o = (byte)azc.a($$10 * 256.0 / 360.0);
      this.f = $$7;
      this.p = $$8;
      this.j = (int)(azc.a($$9.d, -3.9, 3.9) * 8000.0);
      this.k = (int)(azc.a($$9.e, -3.9, 3.9) * 8000.0);
      this.l = (int)(azc.a($$9.f, -3.9, 3.9) * 8000.0);
   }
