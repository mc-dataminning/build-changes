...
public final class kl {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> af.a($$0, 4).map(kl::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final ym<ByteBuf, UUID> g = new ym<ByteBuf, UUID>() {
