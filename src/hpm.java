...
public class hpm implements hpq {
   private static final int a = 40;
   private static final int b = 40;
   private static final int c = 100;
   private static final int d = 20;
   private static final int e = -1;
   private static final wy f = wy.a("tutorial.move.title", hpp.a("forward"), hpp.a("left"), hpp.a("back"), hpp.a("right"));
   private static final wy g = wy.a("tutorial.move.description", hpp.a("jump"));
   ...
   public void a() {
      ...
      if (this.m >= 100) {
         ...
         if (this.r == -1 && this.k == null) {
            this.k = new fvh($$0.h, fvh.a.a, f, g, true);
            $$0.aA().a(this.k);
         } else if (this.r != -1 && this.m - this.r >= 20 && this.s == -1 && this.l == null) {
            this.l = new fvh($$0.h, fvh.a.b, h, i, true);
            $$0.aA().a(this.l);
         }
      }
   }
