...
public class dee {
   private static final Codec<tl[]> c = arf.c
      .listOf()
      .comapFlatMap(
   ...
   public dee(tl[] $$0, tl[] $$1, cht $$2, boolean $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   private static dee a(tl[] $$0, Optional<tl[]> $$1, cht $$2, boolean $$3) {
   ...
   public dee a(int $$0, tl $$1) {
      return this.a($$0, $$1, $$1);
   }

   public dee a(int $$0, tl $$1, tl $$2) {
   ...
   public arj[] a(boolean $$0, Function<tl, arj> $$1) {
