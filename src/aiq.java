...
public class aiq {
   ...
   private static int a(dt $$0, ehm $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends biq> $$6) throws CommandSyntaxException {
      akr $$7 = $$0.e();
      int $$8 = $$7.H_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         aiq.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
   ...
   private static int a(Collection<? extends biq> $$0) {
      Set<eio> $$1 = Sets.newHashSet();
   ...
   private static void a(ehm $$0, double $$1, akr $$2, asc $$3, double $$4, double $$5, double $$6, double $$7, int $$8, aiq.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends biq> $$0, akr $$1, aiq.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<eio, aiq.a> $$7 = Maps.newHashMap();
      ...
      for (biq $$8 : $$0) {
         ...
         $$8.a($$1, (double)arx.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)arx.a($$10.b) + 0.5, Set.of(), $$8.dB(), $$8.dD());
   ...
   private static aiq.a[] a(asc $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aiq.a[] $$6 = new aiq.a[$$1];
   ...
   static class a {
      ...
      public boolean b(cpb $$0, int $$1) {
         gw $$2 = gw.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dfj $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(apt.aJ);
      }

      public void a(asc $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = arx.a($$0, $$1, $$3);
         this.b = arx.a($$0, $$2, $$4);
      }
   }
