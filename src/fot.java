...
public class fot {
   ...
   private final List<flb> k = Lists.newArrayList();
   private final List<flb.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   ...
   private void a(fod $$0, int $$1, int $$2, flc.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(flb.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == cot.c;
   }
   ...
   public void a(wp $$0) {
      this.a($$0, null, this.i.W() ? flc.b() : flc.a());
   }

   public void a(wp $$0, @Nullable xb $$1, @Nullable flc $$2) {
      flb $$3 = new flb(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }

   private void a(flb $$0) {
      String $$1 = $$0.c().getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$2 = x.a($$0.e(), flc::h);
      if ($$2 != null) {
         a.info("[{}] [CHAT] {}", $$2, $$1);
      } else {
         a.info("[CHAT] {}", $$1);
   ...
   private void b(flb $$0) {
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new flb.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fot.a b(xb $$0) {
      int $$1 = this.i.m.e();
      ListIterator<flb> $$2 = this.k.listIterator();
   ...
   private flb d(flb $$0) {
      return new flb($$0.b(), h, null, flc.a());
   }
   ...
   private void n() {
      ...
      for (flb $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public flc c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, flb.a $$1, flc $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         flc.a $$3 = $$2.f();
   ...
   public static class b {
      ...
      public b(List<flb> $$0, List<String> $$1, List<fot.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
