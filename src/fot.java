public class fot extends fpo {
   private final fpj a;

   fot(flo $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fpj $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cdz $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.du();
            if (this.h > $$1) {
   ...
   public static class a implements foq<jz> {
      ...
      public fon a(jz $$0, flo $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fot($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements foq<jz> {
      ...
      public fon a(jz $$0, flo $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fon $$8 = new fot($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
