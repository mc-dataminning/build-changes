...
public class fot extends fny<cqc> {
   ...
   protected void aP_() {
      super.aP_();
      this.S = new ftw(this.l.aR().a(fxn.r));
   }
   ...
   private void d(fhf $$0, int $$1, int $$2, float $$3) {
      ...
      this.S.a(0.0F, $$8, $$9, $$4);
      faq $$10 = $$0.d().getBuffer(this.S.a(Q));
      this.S.a($$0.c(), $$10, 15728880, gpf.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$0.e();
      $$0.c().b();
      ezi.d();
   }
   ...
   public void a(fhf $$0, int $$1, int $$2, float $$3) {
      ...
      for (int $$6 = 0; $$6 < 3; $$6++) {
         int $$7 = this.w.k[$$6];
         Optional<jj.c<czl>> $$8 = this.l.r.H_().d(lr.aK).c(this.w.l[$$6]);
         if (!$$8.isEmpty()) {
            int $$9 = this.w.m[$$6];
            int $$10 = $$6 + 1;
            if (this.a(60, 14 + 19 * $$6, 108, 17, (double)$$1, (double)$$2) && $$7 > 0 && $$9 >= 0 && $$8 != null) {
               List<wu> $$11 = Lists.newArrayList();
               $$11.add(wu.a("container.enchant.clue", czl.a($$8.get(), $$9)).a(n.p));
               if (!$$4) {
                  $$11.add(wt.a);
                  if (this.l.s.cq < $$7) {
