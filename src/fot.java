...
public class fot extends fok<cqg> implements fre {
   private float D;
   private float E;
   private final fqy F = new fqy();
   private boolean G;
   private boolean H;

   public fot(cmh $$0) {
      super($$0.cc, $$0.fY(), wu.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void E() {
      if (this.l.q.f()) {
         this.l.a(new foh(this.l.s, this.l.s.cB.x(), this.l.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aO_() {
      if (this.l.q.f()) {
         ...
         this.c(new fhy(this.z + 104, this.n / 2 - 22, 20, 18, fqy.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.m, this.c);
   ...
   public static void a(fgz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bsy $$9) {
   ...
   public static void a(fgz $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bsy $$7) {
      $$0.c().a();
