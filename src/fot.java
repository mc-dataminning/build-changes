...
public class fot {
   ...
   public static final List<gbi> j = Stream.of(
      ...
      .map($$0 -> new gbi(a, new aex("entity/shulker/shulker_" + $$0)))
   ...
   public static final Map<aew<dcm>, gbi> m = jd.al.f().stream().collect(Collectors.toMap(Function.identity(), fot::d));
   public static final Map<aew<dcm>, gbi> n = jd.al.f().stream().collect(Collectors.toMap(Function.identity(), fot::e));
   public static final Map<aew<String>, gbi> o = jd.an.f().stream().collect(Collectors.toMap(Function.identity(), fot::f));
   public static final gbi[] p = Arrays.stream(cht.values())
      .sorted(Comparator.comparingInt(cht::a))
      .map($$0 -> new gbi(b, new aex("entity/bed/" + $$0.b())))
      .toArray(gbi[]::new);
   ...
   private static gbi c(dgw $$0) {
      return new gbi(e, new aex("entity/signs/" + $$0.b()));
   }

   private static gbi d(dgw $$0) {
      return new gbi(e, new aex("entity/signs/hanging/" + $$0.b()));
   }
   ...
   private static gbi d(aew<dcm> $$0) {
      return new gbi(c, dcm.a($$0, true));
   }

   public static gbi a(aew<dcm> $$0) {
      return m.get($$0);
   }

   private static gbi e(aew<dcm> $$0) {
      return new gbi(d, dcm.a($$0, false));
   }

   public static gbi b(aew<dcm> $$0) {
      return n.get($$0);
   }

   private static gbi a(String $$0) {
      return new gbi(f, new aex("entity/chest/" + $$0));
   }

   private static gbi f(aew<String> $$0) {
      return new gbi(h, ddl.a($$0));
   }

   @Nullable
   public static gbi c(@Nullable aew<String> $$0) {
