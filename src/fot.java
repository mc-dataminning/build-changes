...
public class fot {
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.U_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = azm.a(this.b.t.gj().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gj().a($$11);
                  }
               } else {
                  cqx $$12 = this.b.t.gi();
                  $$12.e(fpb.a((double)$$10, $$12.j, cqx.g()));
               }
            }
         }
      }
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            fhx.a(this.b.aO().h(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aO().m() / 2);
         this.g = (double)(this.b.aO().n() / 2);
         fhx.a(this.b.aO().h(), 212993, this.f, this.g);
      }
   }
