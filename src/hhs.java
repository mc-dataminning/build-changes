...
public abstract class hhs extends ftr {
   ...
   private final List<hhr> a = Lists.newArrayList();
   ...
   protected hhr a(hhr $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xk l() {
      return xj.a(this.a.stream().map(hhr::a).collect(Collectors.toList()));
   }
}
