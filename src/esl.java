...
public abstract class esl<M extends esi<M>> {
   private final dgp i;
   protected final dzd a;
   ...
   protected final Long2ObjectMap<dyv> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected esl(dgp $$0, dzd $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dyv a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dyv a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dyv c(long $$0) {
      dyv $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dyv g(long $$0) {
      dyv $$1 = (dyv)this.g.get($$0);
      return $$1 != null ? $$1 : new dyv();
   }
   ...
   protected void a(eso<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dyv>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dyv> $$6 = (Entry<dyv>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dyv $$8 = (dyv)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dyv $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kk.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, esl.a.a($$9, esl.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public esl.b l(long $$0) {
      return esl.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static esl.b c(byte $$0) {
         if ($$0 == 0) {
            return esl.b.a;
         } else {
            return a($$0) ? esl.b.c : esl.b.b;
         }
      }
   }
