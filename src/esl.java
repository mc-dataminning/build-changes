...
public interface esl {
   esl a(double var1, double var3, double var5);

   esl a(int var1, int var2, int var3, int var4);

   esl a(float var1, float var2);

   esl a(int var1, int var2);

   esl b(int var1, int var2);

   esl a(float var1, float var2, float var3);
   ...
   default esl a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default esl a(int $$0) {
      return this.a(avs.b.b($$0), avs.b.c($$0), avs.b.d($$0), avs.b.a($$0));
   }
   ...
   default void a(esh.a $$0, fwq $$1, float $$2, float $$3, float $$4, int $$5, int $$6) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, new int[]{$$5, $$5, $$5, $$5}, $$6, false);
   }

   default void a(esh.a $$0, fwq $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(esf.j.b());
   ...
   default esl a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector4f $$4 = $$0.transform(new Vector4f($$1, $$2, $$3, 1.0F));
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default esl a(Matrix3f $$0, float $$1, float $$2, float $$3) {
