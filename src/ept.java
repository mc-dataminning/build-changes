...
public class ept {
   ...
   static class b {
      static final Optional<ept> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ept a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ept();
      }
   }
}
