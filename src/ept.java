...
public class ept {
   ...
   private final Map<String, ept.a> b = Maps.newHashMap();
   private final epw c;
   ...
   private ept.a a(String $$0) {
      ept.a $$1 = new ept.a();
      this.b.put($$0, $$1);
      return $$1;
   }

   private epi.a<ept.a> b(String $$0) {
      return new epi.a<>(() -> this.a($$0), ($$1, $$2) -> this.a($$0).a($$1), azl.h);
   }

   public tx a(akk $$0) {
      String $$1 = $$0.b();
      ept.a $$2 = this.c.b(this.b($$1), c($$1));
