...
public class ept extends enm {
   public static final bqw<dhw.c> d = bqw.a(
      new dhw.c(bus.o, 10, 2, 3), new dhw.c(bus.bQ, 5, 4, 4), new dhw.c(bus.bJ, 8, 5, 5), new dhw.c(bus.be, 2, 5, 5), new dhw.c(bus.az, 3, 4, 4)
   );
