...
public class ept {
   ...
   private static final MutableObject<Codec<jq<ept>>> d = new MutableObject();
   ...
   public static final Codec<jq<ept>> b = ae.a(alv.a(mb.aX, a), d::setValue);
   private final List<Pair<epr, Integer>> e;
   private final ObjectArrayList<epr> f;
   private final jq<ept> g;
   private int h = Integer.MIN_VALUE;

   public ept(jq<ept> $$0, List<Pair<epr, Integer>> $$1) {
      this.e = $$1;
   ...
   public ept(jq<ept> $$0, List<Pair<Function<ept.a, ? extends epr>, Integer>> $$1, ept.a $$2) {
   ...
   public int a(esm $$0) {
      if (this.h == Integer.MIN_VALUE) {
         this.h = this.f.stream().filter($$0x -> $$0x != epk.b).mapToInt($$1 -> $$1.a($$0, jh.c, drb.a).e()).max().orElse(0);
      }
   ...
   public static enum a implements bba {
      a("terrain_matching", ImmutableList.of(new err(edp.a.a, -1))),
      b("rigid", ImmutableList.of());

      public static final bba.a<ept.a> c = bba.a(ept.a::values);
