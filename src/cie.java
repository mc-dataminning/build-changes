...
public class cie {
   ...
   private static void b(bwi<cid> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzt(0.8F), new bwu(2.5F), new byf(45, 90), new byj(), new bxf(cek.aO), new bxf(cek.aP)));
   }
   ...
   private static boolean a(bvg $$0, bwi<?> $$1, jq $$2) {
      ...
      dgi $$4 = $$0.dW();
      return $$2.a($$4.ai(), $$0.dw(), 1024) && $$4.a_($$2.b()).a(djo.bf) && $$3.isPresent();
   }
   ...
   public static Optional<ard> a(bvg $$0) {
      dgi $$1 = $$0.dW();
      if (!$$1.B_() && $$1 instanceof arc $$2) {
         Optional<UUID> $$3 = $$0.ec().c(cek.aM);
         if ($$3.isPresent()) {
