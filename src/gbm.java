...
public class gbm {
   ...
   public gbf a(Vector3f $$0, Vector3f $$1, gbh $$2, gls $$3, ij $$4, goa $$5, @Nullable gbi $$6, boolean $$7, ajv $$8) {
      gbj $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = axm.i($$11, $$9.a[0], $$12);
      $$9.a[2] = axm.i($$11, $$9.a[2], $$12);
      $$9.a[1] = axm.i($$11, $$9.a[1], $$13);
      $$9.a[3] = axm.i($$11, $$9.a[3], $$13);
      ...
      return new gbf($$14, $$2.c, $$15, $$3, $$7);
   }

   public static gbj a(gbj $$0, ij $$1, j $$2, ajv $$3) {
      Matrix4f $$4 = ic.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(axm.b($$23), axm.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new gbj(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(gbj $$0, gls $$1, ij $$2, float[] $$3, j $$4, @Nullable gbi $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[ij.values().length];
      $$2[fzz.a.f] = $$0.x() / 16.0F;
      $$2[fzz.a.e] = $$0.y() / 16.0F;
      $$2[fzz.a.d] = $$0.z() / 16.0F;
      $$2[fzz.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, ij $$2, gbj $$3, float[] $$4, gls $$5, j $$6, @Nullable gbi $$7, boolean $$8) {
      fzz.b $$9 = fzz.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gls $$3, gbj $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gbi $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static ij a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? ij.b : $$7;
      }
   }

   private void a(int[] $$0, ij $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[ij.values().length];
      $$3[fzz.a.f] = 999.0F;
      $$3[fzz.a.e] = 999.0F;
      $$3[fzz.a.d] = 999.0F;
      $$3[fzz.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (axm.a($$13, $$18) && axm.a($$14, $$19) && axm.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
