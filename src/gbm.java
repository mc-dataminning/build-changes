...
public class gbm implements ant<gbl> {
   public gbl b(JsonObject $$0) {
      Builder<gbk> $$1 = ImmutableList.builder();
      int $$2 = aso.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = aso.a($$0, "width", -1);
      int $$9 = aso.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = aso.a($$0, "interpolate", false);
      return new gbl($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gbk a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gbk(aso.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = aso.m($$1, "frames[" + $$0 + "]");
         int $$3 = aso.a($$2, "time", -1);
         if ($$2.has("time")) {
