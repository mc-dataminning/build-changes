public class fys extends fza {
   private final double a;
   private final int b;

   fys(fvw $$0, double $$1, double $$2, double $$3, double $$4, int $$5, int $$6) {
   ...
   public void a() {
      if (this.s % (this.b + 1) == 0) {
         for (int $$0 = 0; $$0 < 3; $$0++) {
            ...
            this.c.a(kx.x, $$1, $$2, $$3, (double)((float)this.s / (float)this.t), 0.0, 0.0);
         }
      }
   ...
   public static class a implements fzf<la> {
      ...
      public fzc a(la $$0, fvw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fys($$1, $$2, $$3, $$4, this.a, this.b, this.c);
      }
   }
}
