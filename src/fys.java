public class fys extends fyk<gva> {
   public static final gbv a = gbv.scaling(2.35F);
   ...
   private final gbm m;
   private final gbm n;
   private final gbm[] o = new gbm[12];
   private final gbm[] p;
   ...
   public static gbs a() {
      ...
      gbr $$3 = gbr.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gbo.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", gbr.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gbo.a(0.0F, 0.0F, -8.25F));
      gbw $$11 = $$2.a("tail0", gbr.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gbo.a);
      gbw $$12 = $$11.a("tail1", gbr.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gbo.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", gbr.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gbo.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(gva $$0) {
      ...
      if ($$0.e != null && $$0.d != null) {
         ...
         ezn $$3 = $$0.d;
         $$3 = new ezn($$3.d, 0.0, $$3.f);
         ezn $$4 = new ezn($$0.c.d - $$0.e.d, 0.0, $$0.c.f - $$0.e.f).d().b((float) (Math.PI / 2));
         double $$5 = $$3.b($$4);
