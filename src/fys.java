...
public class fys extends fpw<fys.b> {
   private static final int a = 20;
   final fyt m;
   private int n;

   public fys(fyt $$0, fmg $$1) {
   ...
   public class a extends fys.b {
      final wp b;
      private final int c;

      public a(final wp $$1) {
         this.b = $$1;
         this.c = fys.this.c.h.a(this.b);
      }

      @Override
      public void a(fpc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fys.this.c.h, this.b, fys.this.g / 2 - this.c / 2, $$2 + $$5 - 9 - 1, -1);
      }
   ...
   public abstract static class b extends fpw.a<fys.b> {
      abstract void c();
   }

   public class c extends fys.b {
      ...
      public void a(fpc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         this.f.c($$12, $$11);
         this.f.a($$0, $$6, $$7, $$9);
         $$0.b(fys.this.c.h, this.e, $$3, $$2 + $$5 / 2 - 9 / 2, -1);
         if (this.h) {
            int $$13 = 3;
            int $$14 = this.f.F() - 6;
      ...
      protected void c() {
         ...
         if (this.h) {
            ...
            this.f.a(frb.a(wp.a("controls.keybinds.duplicateKeybinds", $$0)));
         } else {
            this.f.a(null);
         }

         if (fys.this.m.a == this.d) {
