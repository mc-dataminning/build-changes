...
public class fys extends fxx<cvg> {
   ...
   protected void aN_() {
      super.aN_();
      this.U = new gek(this.m.aS().a(gif.J));
   }
   ...
   protected void a(frc $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(gpn::H, R, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      this.d($$0, $$4, $$5, $$1);
      fyr.a().a((long)this.z.m());
      int $$6 = this.z.l();
      ...
      for (int $$7 = 0; $$7 < 3; $$7++) {
         ...
         int $$10 = this.z.m[$$7];
         if ($$10 == 0) {
            $$0.a(gpn::H, O, $$8, $$5 + 14 + 19 * $$7, 108, 19);
         } else {
            String $$11 = $$10 + "";
            int $$12 = 86 - this.p.b($$11);
            xb $$13 = fyr.a().a(this.p, $$12);
            int $$14 = 6839882;
            if (($$6 < $$7 + 1 || this.m.t.ce < $$10) && !this.m.t.fU()) {
               $$0.a(gpn::H, O, $$8, $$5 + 14 + 19 * $$7, 108, 19);
               $$0.a(gpn::H, N[$$7], $$8 + 1, $$5 + 15 + 19 * $$7, 16, 16);
               ...
               if ($$15 >= 0 && $$16 >= 0 && $$15 < 108 && $$16 < 19) {
                  $$0.a(gpn::H, P, $$8, $$5 + 14 + 19 * $$7, 108, 19);
                  $$14 = 16777088;
               } else {
                  $$0.a(gpn::H, Q, $$8, $$5 + 14 + 19 * $$7, 108, 19);
               }

               $$0.a(gpn::H, M[$$7], $$8 + 1, $$5 + 15 + 19 * $$7, 16, 16);
   ...
   private void d(frc $$0, int $$1, int $$2, float $$3) {
      ...
      this.U.a(0.0F, $$8, $$9, $$4);
      $$0.a($$1x -> {
         fiu $$2x = $$1x.getBuffer(this.U.a(S));
         this.U.a($$0.c(), $$2x, 15728880, hhp.d);
      });
      $$0.d();
      $$0.c().b();
      fhm.d();
   ...
   public void a(frc $$0, int $$1, int $$2, float $$3) {
      ...
      for (int $$7 = 0; $$7 < 3; $$7++) {
         int $$8 = this.z.m[$$7];
         Optional<je.c<dff>> $$9 = this.m.s.F_().f(mg.aP).c(this.z.n[$$7]);
         if (!$$9.isEmpty()) {
            int $$10 = this.z.o[$$7];
            int $$11 = $$7 + 1;
            if (this.a(60, 14 + 19 * $$7, 108, 17, (double)$$1, (double)$$2) && $$8 > 0 && $$10 >= 0 && $$9 != null) {
               List<ww> $$12 = Lists.newArrayList();
               $$12.add(ww.a("container.enchant.clue", dff.a($$9.get(), $$10)).a(n.p));
               if (!$$5) {
                  $$12.add(wv.a);
                  if (this.m.t.ce < $$8) {
                     $$12.add(ww.a("container.enchant.level.requirement", this.z.m[$$7]).a(n.m));
                  } else {
                     xk $$13;
                     if ($$11 == 1) {
                        $$13 = ww.c("container.enchant.lapis.one");
                     } else {
                        $$13 = ww.a("container.enchant.lapis.many", $$11);
                     }

                     $$12.add($$13.a($$6 >= $$11 ? n.h : n.m));
                     xk $$15;
                     if ($$11 == 1) {
                        $$15 = ww.c("container.enchant.level.one");
                     } else {
                        $$15 = ww.a("container.enchant.level.many", $$11);
                     }
