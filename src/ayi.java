...
public class ayi implements AutoCloseable {
   ...
   private ayi(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayi.a a(Path $$0) {
         return new ayi.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
