...
public class ayi {
   ...
   public static SecretKey a() throws ayj {
      try {
   ...
   public static KeyPair b() throws ayj {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws ayj {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, ayi.a<T> $$3) throws ayj {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws ayj {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", ayi::b);
   }

   public static PublicKey b(String $$0) throws ayj {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", ayi::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws ayj {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws ayj {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws ayj {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws ayj {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws ayj {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws ayj {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws ayj {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws ayj;
   }

   public static record b(long b, byte[] c) {
      public static final ayi.b a = new ayi.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(wf $$0, ayi.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
