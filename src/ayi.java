...
public class ayi {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axk.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axk.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static <K, V> ayi.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayi.c<>($$0, $$1);
   }
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return ayi.a($$0, this.a::get, $$1::get);
      }

      public ayi.b<I, V> a(I $$0, V $$1) {
