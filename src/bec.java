...
public class bec extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgv.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bec::c), this.a("minecraft:arrow", bec::a), this.a("minecraft:spectral_arrow", bec::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bec.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bgv.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bgv.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bec.a<?> $$1, Type<?> $$2, Type<T> $$3) {
