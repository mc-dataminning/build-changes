...
public interface dgw {
   static dgw a(dho $$0, clt $$1, dhq $$2, dhx $$3, int $$4, int $$5, dgw.a $$6) {
      return new dgw.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static dgw a(final dgw.a $$0) {
      return new dgw() {
         @Nullable
         @Override
         public dcb a(dhd.b $$0x, double $$1) {
   ...
   @Nullable
   dcb a(dhd.b var1, double var2);

   boolean a();

   public interface a {
      dgw.b computeFluid(int var1, int var2, int var3);
   }
   ...
   public static class c implements dgw {
      ...
      private static final double k = a(apa.h(10), apa.h(12));
      private final dho l;
      private final dhd m;
      private final dhd n;
      private final dhd o;
      private final dhd p;
      private final dhx q;
      private final dgw.b[] r;
      private final long[] s;
      private final dgw.a t;
      private final dhd u;
      private final dhd v;
      private boolean w;
      private final int x;
      ...
      c(dho $$0, clt $$1, dhq $$2, dhx $$3, int $$4, int $$5, dgw.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dcb a(dhd.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            dgw.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(cpo.H)) {
               this.w = false;
               return cpo.H.n();
            } else {
               ...
               if ($$31 <= 0.0) {
                  this.w = $$31 >= k;
                  return $$32;
               } else if ($$32.a(cpo.G) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(cpo.H)) {
                  this.w = true;
                  return $$32;
               } else {
      ...
      private double a(dhd.b $$0, MutableDouble $$1, dgw.b $$2, dgw.b $$3) {
         int $$4 = $$0.b();
         dcb $$5 = $$2.a($$4);
         dcb $$6 = $$3.a($$4);
      ...
      private dgw.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            dgw.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private dgw.b b(int $$0, int $$1, int $$2) {
         dgw.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               dgw.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).i()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new dgw.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, dgw.b $$3, int $$4, boolean $$5) {
      ...
      private dcb a(int $$0, int $$1, int $$2, dgw.b $$3, int $$4) {
         dcb $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != dfk.g && $$3.b != cpo.H.n()) {
            ...
            double $$11 = this.p.a(new dhd.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = cpo.H.n();
            }
         }
