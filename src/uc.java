...
public class uc extends tx<ud> {
   private static final int b = 24;
   public static final ux<uc> a = new ux.b<uc>() {
      public uc a(DataInput $$0, uh $$1) throws IOException {
         return new uc(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof uc && Arrays.equals(this.c, ((uc)$$0).c);
   }
   ...
   public ud a(int $$0, ud $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return ud.a($$2);
   }

   public void b(int $$0, ud $$1) {
   ...
   public boolean b(int $$0, uv $$1) {
      if ($$1 instanceof uo) {
         this.c = ArrayUtils.add(this.c, $$0, ((uo)$$1).g());
         return true;
      } else {
         return false;
      }
