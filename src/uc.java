...
public class uc implements ub {
   ...
   public void a(tv $$0) {
      ...
      vu $$3 = vu.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = vu.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(sy $$0) {
      vu $$1 = vu.b("b").a(g);
      this.t = vu.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(tf $$0) {
      this.t = vu.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(td $$0) {
      vu $$1 = vu.b("f").a(g);
      this.t = vu.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(tb $$0) {
      vu $$1 = vu.b("d").a(g);
      this.t = vu.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(sx $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         wi $$5 = vu.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(te $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(vu.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(th $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         vu $$5 = vu.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(tg $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new uc(this.r, this.s).a($$0.k($$3)));
         }
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            wi $$6 = vu.b(Strings.repeat(this.r, this.s + 1));
            $$6.b(new uc(this.r, this.s + 1).a($$0.k($$5)));
            if ($$5 != $$0.size() - 1) {
   ...
   public void a(ta $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            wi $$6 = vu.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new uc(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static vu a(String $$0) {
      if (h.matcher($$0).matches()) {
         return vu.b($$0).a(d);
      } else {
         String $$1 = tv.b($$0);
         String $$2 = $$1.substring(0, 1);
         vu $$3 = vu.b($$1.substring(1, $$1.length() - 1)).a(d);
         return vu.b($$2).b($$3).f($$2);
      }
   }
