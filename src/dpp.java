...
public class dpp implements dpr {
   public static final Codec<dpp> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bfv.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bfv.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bfv.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bft.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bft.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dpp(int $$0, bfv $$1, bfv $$2, int $$3, int $$4, bfv $$5, bft $$6, bft $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
