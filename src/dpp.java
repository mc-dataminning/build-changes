...
public class dpp {
   ...
   private boolean a(ji $$0) {
      return diz.a(this.a, $$0) || diz.a(this.a, $$0.d()) || diz.a(this.a, $$0.e());
   }
   ...
   private dpp b(ji $$0) {
      dwv $$2 = this.a.a_($$0);
      if (diz.h($$2)) {
         return new dpp(this.a, $$0, $$2);
      } else {
         ji $$1 = $$0.d();
         $$2 = this.a.a_($$1);
         if (diz.h($$2)) {
            return new dpp(this.a, $$1, $$2);
         } else {
            $$1 = $$0.e();
            $$2 = this.a.a_($$1);
            return diz.h($$2) ? new dpp(this.a, $$1, $$2) : null;
         }
      }
   }

   private boolean a(dpp $$0) {
      return this.c($$0.b);
   }
   ...
   private boolean b(dpp $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dpp $$0) {
      this.f.add($$0.b);
      ji $$1 = this.b.f();
      ji $$2 = this.b.g();
      ji $$3 = this.b.h();
   ...
   public dpp a(boolean $$0, boolean $$1, dxy $$2) {
      ji $$3 = this.b.f();
      ji $$4 = this.b.g();
      ji $$5 = this.b.h();
      ji $$6 = this.b.i();
