...
public class dpp extends dpw {
   private static final Codec<bdi> b = aoi.a(
      bdi.a,
      (Function<bdi, DataResult<bdi>>)($$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final Codec<dpp> a = RecordCodecBuilder.create(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bdc.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  bdc.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  bdc.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  bdc.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, dpp::new)
   );
   ...
   public List<doe.a> a(cms $$0, BiConsumer<gu, dcb> $$1, apf $$2, int $$3, gu $$4, dno $$5) {
      ...
      List<doe.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new doe.a($$4.b($$11), 0, false));
      }

      gu.a $$16 = new gu.a();
      ha $$17 = ha.c.a.a($$2);
      Function<dcb, dcb> $$18 = $$1x -> $$1x.b(cvy.g, $$17.o());
