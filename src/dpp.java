...
public abstract class dpp {
   ...
   public final void c(tx $$0, jl.a $$1) {
      this.a($$0, $$1);
      dpp.a.a.parse($$1.a(ul.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final tx d(jl.a $$0) {
      tx $$1 = new tx();
      this.b($$1, $$0);
      dpp.a.a.encodeStart($$0.a(ul.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((tx)$$1x));
      return $$1;
   }
   ...
   public static void a(tx $$0, dpr<?> $$1) {
      $$0.a("id", dpr.a($$1).toString());
   }

   public void a(cuc $$0, jl.a $$1) {
      tx $$2 = this.e($$1);
      this.a($$2);
      csb.a($$0, this.r(), $$2);
      $$0.b(this.s());
   ...
   @Nullable
   public static dpp a(ja $$0, dsk $$1, tx $$2, jl.a $$3) {
      String $$4 = $$2.l("id");
      akk $$5 = akk.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(dcf $$0, ja $$1, dsk $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
