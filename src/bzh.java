...
public class bzh extends bui implements bjx<Optional<chm>>, byt {
   private static final UUID e = UUID.fromString("7E0292F2-9434-48D5-A29F-9583AF7DF27F");
   private static final bkd bT = new bkd(e, "Covered armor bonus", 20.0, bkd.a.a);
   protected static final adz<ha> b = aec.a(bzh.class, aeb.p);
   protected static final adz<Byte> c = aec.a(bzh.class, aeb.a);
   protected static final adz<Byte> d = aec.a(bzh.class, aeb.a);
   ...
   public bzh(bim<? extends bzh> $$0, cpm $$1) {
      super($$0, $$1);
      this.bJ = 5;
      this.bK = new bzh.d(this);
   }

   @Override
   protected void w() {
      this.bO.a(1, new bqc(this, cbn.class, 8.0F, 0.02F, true));
      this.bO.a(4, new bzh.a());
      this.bO.a(7, new bzh.f());
      this.bO.a(8, new bqp(this));
      this.bP.a(1, new brm(this, this.getClass()).a());
      this.bP.a(2, new bzh.e(this));
      this.bP.a(3, new bzh.c(this));
   }
   ...
   public static bke.a p() {
      return bja.x().a(bkf.a, 30.0);
   }

   @Override
   protected bos B() {
      return new bzh.b(this);
   }
   ...
   private void gd() {
      ...
      if (!($$3 <= 0.0F)) {
         for (bii $$5 : this.dK().a(this, a($$2, $$1, $$0).d(this.dp() - 0.5, this.dr(), this.dv() - 0.5), bil.f.and($$0x -> !$$0x.y(this)))) {
            if (!($$5 instanceof bzh) && !$$5.af) {
               $$5.a(bje.e, new ehe((double)($$3 * (float)$$2.j()), (double)($$3 * (float)$$2.k()), (double)($$3 * (float)$$2.l())));
            }
         }
      }
   }

   public static egz a(ha $$0, float $$1) {
      return a($$0, -1.0F, $$1);
   }

   public static egz a(ha $$0, float $$1, float $$2) {
   ...
   private boolean j(gu $$0) {
      ...
      if ($$1.i()) {
         ...
         boolean $$2 = $$1.a(csn.bQ) && $$0.equals(this.dk());
         return !$$2;
      }
   }
   ...
   protected boolean q() {
      if (!this.fQ() && this.bv()) {
         ...
         for (int $$1 = 0; $$1 < 5; $$1++) {
            ...
            if ($$2.v() > this.dK().C_() && this.dK().t($$2) && this.dK().w_().a($$2) && this.dK().a(this, new egz($$2).h(1.0E-6))) {
               ha $$3 = this.i($$2);
               if ($$3 != null) {
                  this.ae();
                  this.a($$3);
                  ...
                  this.dK().a(djk.R, $$0, djk.a.a(this));
                  this.an.b(c, (byte)0);
                  this.h(null);
                  return true;
               }
   ...
   public Optional<ehe> F(float $$0) {
      if (this.ce != null && this.cf > 0) {
         ...
         return Optional.of(new ehe(-$$3, -$$4, -$$5));
      } else {
         return Optional.empty();
      }
   }

   public void a(Optional<chm> $$0) {
      this.an.b(d, $$0.<Byte>map($$0x -> (byte)$$0x.a()).orElse((byte)16));
   }

   public Optional<chm> fZ() {
   ...
   class a extends bpu {
      ...
      public boolean a() {
         biy $$0 = bzh.this.j();
         return $$0 != null && $$0.bv() ? bzh.this.dK().ai() != bgn.a : false;
      }
      ...
      @Override
      public void e() {
         if (bzh.this.dK().ai() != bgn.a) {
            this.b--;
            biy $$0 = bzh.this.j();
            if ($$0 != null) {
               bzh.this.D().a($$0, 180.0F, 180.0F);
               double $$1 = bzh.this.f($$0);
               if ($$1 < 400.0) {
                  if (this.b <= 0) {
                     this.b = 20 + bzh.this.ag.a(10) * 20 / 2;
                     bzh.this.dK().b(new cch(bzh.this.dK(), bzh.this, $$0, bzh.this.t().o()));
                     bzh.this.a(aow.vi, 2.0F, (bzh.this.ag.i() - bzh.this.ag.i()) * 0.2F + 1.0F);
                  }
               } else {
                  bzh.this.h(null);
               }
   ...
   static class c extends brn<biy> {
      public c(bzh $$0) {
         super($$0, biy.class, 10, true, false, $$0x -> $$0x instanceof byt);
      }
   ...
   class d extends bow {
      ...
      protected Optional<Float> i() {
         ha $$0 = bzh.this.t().g();
         Vector3f $$1 = $$0.b().transform(new Vector3f(bzh.cb));
         hz $$2 = $$0.q();
   ...
   class e extends brn<cbn> {
      public e(bzh $$0) {
         super($$0, cbn.class, true);
      }

      @Override
      public boolean a() {
         return bzh.this.dK().ai() == bgn.a ? false : super.a();
      }
   ...
   class f extends bpu {
      ...
      @Override
      public boolean a() {
         return bzh.this.j() == null && bzh.this.ag.a(b(40)) == 0 && bzh.this.a(bzh.this.dk(), bzh.this.t());
      }

      @Override
      public boolean b() {
         return bzh.this.j() == null && this.b > 0;
      }

      @Override
      public void c() {
         this.b = this.a(20 * (1 + bzh.this.ag.a(3)));
         bzh.this.b(30);
      }
