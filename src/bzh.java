...
public class bzh extends bza {
   ...
   public static bkd.a p() {
      return bza.gg().a(bke.a, 8.0).a(bke.d, 0.25).a(bke.f, 1.0);
   }
   ...
   public float a(gu $$0, cpo $$1) {
      return cwh.h($$1.a_($$0.d())) ? 10.0F : super.a($$0, $$1);
   }

   public static boolean b(bim<bzh> $$0, cpm $$1, bjc $$2, gu $$3, aru $$4) {
      if (c($$0, $$1, $$2, $$3, $$4)) {
   ...
   static class a extends bqq {
      ...
      public boolean a() {
         if (this.b.j() != null) {
            ...
            aru $$0 = this.b.ee();
            if (this.b.dK().X().b(cph.c) && $$0.a(b(10)) == 0) {
               this.i = ha.b($$0);
               gu $$1 = gu.a(this.b.dp(), this.b.dr() + 0.5, this.b.dv()).a(this.i);
               dez $$2 = this.b.dK().a_($$1);
               if (cwh.h($$2)) {
                  this.j = true;
                  return true;
               }
