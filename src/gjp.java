...
public class gjp {
   ...
   public final Map<jm, gjq> c;
   public final gjr d;
   public final boolean e;
   public final int f;

   public gjp(Vector3f $$0, Vector3f $$1, Map<jm, gjq> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gjp(Vector3f $$0, Vector3f $$1, Map<jm, gjq> $$2, @Nullable gjr $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gjq> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gjp> {
      ...
      public gjp a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !aza.c($$3, "shade")) {
            ...
            return new gjp($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gjr a(JsonObject $$0) {
         gjr $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jm, gjq> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gjq> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gjq> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gjq> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = aza.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gjq)$$0.deserialize($$4.getValue(), gjq.class));
         }
