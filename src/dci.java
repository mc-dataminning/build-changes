...
public interface dci extends dbi, dbp, dcv, ddh.a {
   @Nullable
   dug a(int var1, int var2, dvh var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dyf.a var1, int var2, int var3);

   int B_();

   ddh F_();

   default jj<ddf> t(ja $$0) {
      return this.F_().a($$0);
   }

   default Stream<dsk> c(ewa $$0) {
      int $$1 = ayg.a($$0.a);
      int $$2 = ayg.a($$0.d);
      int $$3 = ayg.a($$0.b);
      int $$4 = ayg.a($$0.e);
   ...
   @Override
   default int a(ja $$0, dbq $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default jj<ddf> getNoiseBiome(int $$0, int $$1, int $$2) {
      dug $$3 = this.a(ju.e($$0), ju.e($$2), dvh.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   jj<ddf> a(int var1, int var2, int var3);
   ...
   default dug a(int $$0, int $$1) {
      return this.a($$0, $$1, dvh.n, true);
   }

   default dug a(int $$0, int $$1, dvh $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbl c(int $$0, int $$1) {
