public class gcd implements gbz<dmj> {
   private final ggg a;
   ...
   public void a(dmj $$0, float $$1, ewi $$2, fzz $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.n().c(dpp.bv);
         if ($$6 > 0) {
            ih $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.d()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = fzx.a($$0.i(), $$0.n(), $$0.aA_().a($$7));
                  this.a.a($$8, crg.i, $$11, gla.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
