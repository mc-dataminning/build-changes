...
public class gcd extends gdu {
   private final float a;
   private final gdp b;

   gcd(fzn $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gdp $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gcx<ks> {
      ...
      public gcu a(ks $$0, fzn $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dlw.a) {
            ...
            return new gcd($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
