...
public class bnm {
   ...
   private static void a(bnu $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnp $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvh, bny<bno>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bny)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvh, bny<bno>> $$3 : $$0) {
         bny<bno> $$4 = (bny<bno>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dvh)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnw> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnb.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnm::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnm::a));
      return $$1;
   }

   private JsonElement a(bnr.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bnk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnm::a));
      $$1.add("received", this.a($$0.k(), bnm::a));
      return $$1;
   }

   private <T> JsonElement a(bnt<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bnq> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bnq>, ToDoubleFunction<bnq>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bnq::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bnq::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bnq::c));
      return $$1;
   }
}
