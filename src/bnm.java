...
public class bnm implements bnn {
   ...
   private static final bnm k = new bnm();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bnl $$0) {
      URL $$1 = bnm.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnl $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnp a = new bnp(() -> bnm.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnm.this.l && $$0.getState() == RecordingState.STOPPED) {
