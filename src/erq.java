...
public class erq {
   ...
   public erq(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<err> $$1) throws IOException {
   ...
   public List<err> a(Path $$0) throws IOException {
      List<err> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<err> a(Path $$0, boolean $$1) throws IOException {
      List<err> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<err> $$1) throws IOException {
