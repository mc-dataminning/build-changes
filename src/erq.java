...
public class erq extends esi {
   public static final MapCodec<erq> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(esk.a.fieldOf("delegate").forGetter($$0x -> $$0x.b), bsn.e.fieldOf("limit").forGetter($$0x -> $$0x.c)).apply($$0, erq::new)
   );
   private final esi b;
   private final bsn c;

   public erq(esi $$0, bsn $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   @Override
   public final List<esl.d> a(dhy $$0, jh $$1, jh $$2, List<esl.d> $$3, List<esl.d> $$4, esh $$5) {
