...
public class erq {
   ...
   static class a implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         return $$0.c[jo.f.d()] && !$$0.b[jo.f.d()].d;
      }

      @Override
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         $$1.d = true;
         $$1.b[jo.f.d()].d = true;
         return new erq.k($$0, $$1);
      }
   }

   static class b implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         if ($$0.c[jo.f.d()] && !$$0.b[jo.f.d()].d && $$0.c[jo.b.d()] && !$$0.b[jo.b.d()].d) {
            erq.v $$1 = $$0.b[jo.f.d()];
            return $$1.c[jo.b.d()] && !$$1.b[jo.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         ...
         $$1.b[jo.f.d()].d = true;
         $$1.b[jo.b.d()].d = true;
         $$1.b[jo.f.d()].b[jo.b.d()].d = true;
         return new erq.l($$0, $$1);
      }
   }

   static class c implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         return $$0.c[jo.b.d()] && !$$0.b[jo.b.d()].d;
      }
      ...
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         $$1.d = true;
         $$1.b[jo.b.d()].d = true;
         return new erq.m($$0, $$1);
      }
   }

   static class d implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         if ($$0.c[jo.c.d()] && !$$0.b[jo.c.d()].d && $$0.c[jo.b.d()] && !$$0.b[jo.b.d()].d) {
            erq.v $$1 = $$0.b[jo.c.d()];
            return $$1.c[jo.b.d()] && !$$1.b[jo.b.d()].d;
         } else {
            return false;
      ...
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         ...
         $$1.b[jo.c.d()].d = true;
         $$1.b[jo.b.d()].d = true;
         $$1.b[jo.c.d()].b[jo.b.d()].d = true;
         return new erq.n($$0, $$1);
      }
   }

   static class e implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         return $$0.c[jo.c.d()] && !$$0.b[jo.c.d()].d;
      }

      @Override
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         erq.v $$3 = $$1;
         if (!$$1.c[jo.c.d()] || $$1.b[jo.c.d()].d) {
            $$3 = $$1.b[jo.d.d()];
         }

         $$3.d = true;
         $$3.b[jo.c.d()].d = true;
         return new erq.o($$0, $$3);
      }
   }

   static class f implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         return true;
      }
      ...
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         $$1.d = true;
         return new erq.s($$0, $$1, $$2);
      }
   }

   static class g implements erq.i {
      @Override
      public boolean a(erq.v $$0) {
         return !$$0.c[jo.e.d()] && !$$0.c[jo.f.d()] && !$$0.c[jo.c.d()] && !$$0.c[jo.d.d()] && !$$0.c[jo.b.d()];
      }

      @Override
      public erq.r a(jo $$0, erq.v $$1, azs $$2) {
         $$1.d = true;
         return new erq.t($$0, $$1);
      }
   }

   public static class h extends erq.r {
      ...
      private erq.v G;
      private erq.v H;
      private final List<erq.r> I = Lists.newArrayList();

      public h(azs $$0, int $$1, int $$2, jo $$3) {
         super(epx.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<erq.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new erq.p($$3, this.G));
         this.I.add(new erq.j($$3, this.H));
         List<erq.i> $$5 = Lists.newArrayList();
         $$5.add(new erq.b());
         $$5.add(new erq.d());
         $$5.add(new erq.e());
         $$5.add(new erq.a());
         ...
         eoy $$10 = eoy.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eoy $$11 = eoy.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eoy $$12 = eoy.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new erq.u($$3, $$10, $$13++));
         this.I.add(new erq.u($$3, $$11, $$13++));
         this.I.add(new erq.q($$3, $$12));
      }
      ...
      private List<erq.v> b(azs $$0) {
         erq.v[] $$1 = new erq.v[75];
         ...
         erq.v $$23 = new erq.v(1003);
         erq.v $$24 = new erq.v(1001);
         erq.v $$25 = new erq.v(1002);
         $$1[v].a(jo.b, $$23);
         $$1[w].a(jo.d, $$24);
         $$1[x].a(jo.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jo.f.d()].d = true;
         this.H.b[jo.c.d()].d = true;
         this.H.b[jo.f.d()].b[jo.c.d()].d = true;
         this.H.b[jo.b.d()].d = true;
         this.H.b[jo.f.d()].b[jo.b.d()].d = true;
         this.H.b[jo.c.d()].b[jo.b.d()].d = true;
         this.H.b[jo.f.d()].b[jo.c.d()].b[jo.b.d()].d = true;
         ObjectArrayList<erq.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dio $$2, azs $$3, eoy $$4) {
         int $$5 = 24;
      ...
      private void a(dio $$0, azs $$1, eoy $$2) {
      ...
      private void b(dio $$0, azs $$1, eoy $$2) {
      ...
      private void c(dio $$0, azs $$1, eoy $$2) {
      ...
      private void d(dio $$0, azs $$1, eoy $$2) {
      ...
      private void e(dio $$0, azs $$1, eoy $$2) {
      ...
      private void f(dio $$0, azs $$1, eoy $$2) {
   ...
   interface i {
      boolean a(erq.v var1);

      erq.r a(jo var1, erq.v var2, azs var3);
   }

   public static class j extends erq.r {
      public j(jo $$0, erq.v $$1) {
         super(epx.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dio $$0, dil $$1, eak $$2, azs $$3, eoy $$4, dgw $$5, jj $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dkw.co.m(), dkw.co.m(), false);
   ...
   public static class k extends erq.r {
      public k(jo $$0, erq.v $$1) {
         super(epx.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dio $$0, dil $$1, eak $$2, azs $$3, eoy $$4, dgw $$5, jj $$6) {
         erq.v $$7 = this.B.b[jo.f.d()];
         erq.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jo.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jo.a.d()]);
         }
   ...
   public static class l extends erq.r {
      public l(jo $$0, erq.v $$1) {
         super(epx.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends erq.r {
      public m(jo $$0, erq.v $$1) {
         super(epx.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dio $$0, dil $$1, eak $$2, azs $$3, eoy $$4, dgw $$5, jj $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jo.a.d()]);
         }

         erq.v $$7 = this.B.b[jo.b.d()];
         if ($$7.b[jo.b.d()] == null) {
   ...
   public static class n extends erq.r {
      public n(jo $$0, erq.v $$1) {
         super(epx.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dio $$0, dil $$1, eak $$2, azs $$3, eoy $$4, dgw $$5, jj $$6) {
         erq.v $$7 = this.B.b[jo.c.d()];
         erq.v $$8 = this.B;
         erq.v $$9 = $$7.b[jo.b.d()];
         erq.v $$10 = $$8.b[jo.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jo.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jo.a.d()]);
         }
   ...
   public static class o extends erq.r {
      public o(jo $$0, erq.v $$1) {
         super(epx.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends erq.r {
      public p(jo $$0, erq.v $$1) {
         super(epx.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends erq.r {
      public q(jo $$0, eoy $$1) {
         super(epx.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends epk {
      protected static final dym b = dkw.ix.m();
      protected static final dym c = dkw.iy.m();
      protected static final dym d = dkw.iz.m();
      protected static final dym h = c;
      protected static final dym i = dkw.iG.m();
      protected static final boolean j = true;
      protected static final dym k = dkw.J.m();
      protected static final Set<dku> l = ImmutableSet.builder().add(dkw.eb).add(dkw.ja).add(dkw.ny).add(k.b()).build();
      ...
      public r(epx $$0, jo $$1, int $$2, eoy $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(epx $$0, int $$1, jo $$2, erq.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eoy a(jo $$0, erq.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eoy $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dio $$0, eoy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dym $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dio $$0, eoy $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dio $$0, eoy $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dym $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eoy $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dio $$0, eoy $$1, int $$2, int $$3, int $$4) {
         jj $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cmy $$6 = bwb.M.a($$0.a(), bwa.d);
            if ($$6 != null) {
               $$6.c($$6.eT());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bwa.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends erq.r {
      private int a;

      public s(jo $$0, erq.v $$1, azs $$2) {
         super(epx.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dio $$0, dil $$1, eak $$2, azs $$3, eoy $$4, dgw $$5, jj $$6) {
         ...
         if (this.B.b[jo.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jo.a.d()] && !this.B.c[jo.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends erq.r {
      public t(jo $$0, erq.v $$1) {
         super(epx.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends erq.r {
      private int a;

      public u(jo $$0, eoy $$1, int $$2) {
         super(epx.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
