...
public abstract class dab {
   ...
   public void a(bsc<?> $$0, @Nullable daz $$1, aym $$2, io $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!btm.a($$7.get(), $$0, bsu.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dvk.b($$15.getClass()),
                        new euh((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsb.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof bss $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bsu.c) || !$$17.a($$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((bss)$$15).a($$0, $$0.d_($$15.dp()), bsu.c, null);
                     }
   ...
   private void d(daz $$0, io $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dbq)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable daz $$0, io $$1, ud $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dbq $$4 = dbq.b.parse(ur.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dbq::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dbq.c.parse(ur.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bog::b);
      } else {
         this.e = bog.a(this.f != null ? this.f : new dbq());
      }
   ...
   public ud a(ud $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (va)dbq.b.encodeStart(ur.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (va)dbq.c.encodeStart(ur.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public brw b(daz $$0, io $$1) {
      if (this.l == null) {
         ...
         this.l = bsc.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof bss) {
         }
      }
   ...
   protected void a(@Nullable daz $$0, io $$1, dbq $$2) {
      this.f = $$2;
   }

   private dbq a(@Nullable daz $$0, aym $$1, io $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(boi.b::b).orElseGet(dbq::new));
         return this.f;
      }
   }

   public abstract void a(daz var1, io var2, int var3);
