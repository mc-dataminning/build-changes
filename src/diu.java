...
public class diu {
   public static final int a = kd.a(8);
   private static final int b = 2;
   private static final int c = 4;
   private static final int d = 3;
   private final diu.a e;
   private final long f;

   public diu(diu.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public diu a(diu.a $$0) {
      return new diu($$0, this.f);
   }

   public js<dis> a(jj $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public js<dis> a(double $$0, double $$1, double $$2) {
      int $$3 = kd.a(azk.a($$0));
      int $$4 = kd.a(azk.a($$1));
      int $$5 = kd.a(azk.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      js<dis> getNoiseBiome(int var1, int var2, int var3);
   }
}
