...
public class ahz {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("random").then(a("value", false))).then(a("roll", true)))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("reset").requires($$0x -> $$0x.c(2)))
                  ...
                  .then(
                     ((RequiredArgumentBuilder)du.a("sequence", es.a()).suggests(ahz::a).executes($$0x -> a((dt)$$0x.getSource(), es.e($$0x, "sequence"))))
                        .then(
                           ((RequiredArgumentBuilder)du.a("seed", IntegerArgumentType.integer())
      ...
      return (LiteralArgumentBuilder<dt>)du.a($$0)
         .then(
            ((RequiredArgumentBuilder)du.a("range", ep.a()).executes($$1x -> a((dt)$$1x.getSource(), ep.b.a($$1x, "range"), null, $$1)))
               .then(
                  ((RequiredArgumentBuilder)du.a("sequence", es.a()).suggests(ahz::a).requires($$0x -> $$0x.c(2)))
   ...
   private static int a(dt $$0, cl.d $$1, @Nullable aez $$2, boolean $$3) throws CommandSyntaxException {
      ash $$4;
      if ($$2 != null) {
         $$4 = $$0.e().a($$2);
      } else {
   ...
   private static int a(dt $$0, aez $$1) throws CommandSyntaxException {
      $$0.e().H().b($$1);
      $$0.a(() -> tl.a("commands.random.reset.success", tl.a($$1)), false);
      return 1;
   }

   private static int a(dt $$0, aez $$1, int $$2, boolean $$3, boolean $$4) throws CommandSyntaxException {
      $$0.e().H().a($$1, $$2, $$3, $$4);
      $$0.a(() -> tl.a("commands.random.reset.success", tl.a($$1)), false);
      return 1;
   }
