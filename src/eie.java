...
public class eie {
   ...
   public eie(@Nullable epp $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public ur a(ur $$0) {
      ur $$1 = $$0.p("Level");
      dbe $$2 = new dbe($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dbe.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dbe.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable epp $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            try {
               $$2 = $$0.a($$1, baf.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               ur $$4 = $$2.p($$3);
               long $$5 = dbe.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ur $$14 = $$2.p($$13);
                  $$12.a(dbe.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static eie a(ald<dbx> $$0, @Nullable epp $$1) {
      if ($$0 == dbx.h) {
         return new eie(
            $$1,
         ...
         return new eie($$1, $$2, $$2);
      } else if ($$0 == dbx.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eie($$1, $$3, $$3);
      } else {
