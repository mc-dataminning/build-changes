...
public class emt {
   ...
   private static final Queue<emt.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile emt.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(emt::a), emr::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(emt::a), emr::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + emt.a(this.b) + ", type=" + emt.b(this.c) + ", severity=" + emt.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
