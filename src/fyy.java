...
public class fyy {
   ...
   private fyy(int $$0, List<fza> $$1) {
      this.a = $$1.toArray(fza[]::new);
      this.b = $$1.size();
   }

   private List<fza> c() {
      List<fza> $$0 = new ArrayList<>(this.d());
