...
public class gpi implements gpl.a, AutoCloseable {
   ...
   ezn[] f;
   @Nullable
   private final gpi.a g;
   private final aty h;

   public gpi(akk $$0, grb $$1, ezn $$2, aty $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gqz $$4 = $$3.a(gqz.a).orElse(gqz.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ezn[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gpd.a(this.f, $$0);
   ...
   @Nullable
   private gpi.a a(grb $$0, int $$1, int $$2, gqz $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gpi.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gpi.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gpi.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gpi.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gpi.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gpi.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ezn[] $$4) {
   ...
   class a {
      ...
      a(final List<gpi.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gpi.this.c;
         int $$4 = this.b($$2) * gpi.this.d;
         gpi.this.a($$0, $$1, $$3, $$4, gpi.this.f);
      }

      public gpk a() {
         return gpi.this.new d(this, this.d ? gpi.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ezn[] b = new ezn[gpi.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gpi.this.c >> $$0;
            int $$2 = gpi.this.d >> $$0;
            this.b[$$0] = new ezn($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gpi.d $$2) {
         gpi.a $$3 = $$2.c;
         List<gpi.b> $$4 = $$3.b;
         gpi.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gpi.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gpi.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gpi.this.f[$$2].a($$3 + ($$0.a($$1) * gpi.this.c >> $$2), $$4 + ($$0.b($$1) * gpi.this.d >> $$2));
      }
   ...
   class d implements gpk {
      int a;
      int b;
      final gpi.a c;
      @Nullable
      private final gpi.c d;

      d(final gpi.a $$0, @Nullable final gpi.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
