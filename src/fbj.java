...
public class fbj implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fbj.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fbj(List<fbj.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fbj a(BufferedReader $$0) {
      return new fbj($$0.lines().flatMap($$0x -> fbj.a.a($$0x).stream()).toList());
   }

   public static record a(fbj.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fbj.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fbj.a(fbj.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fbj.a(fbj.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fbj.a(fbj.b.b, $$3));
      ...
      static fbj.a b(String $$0) {
         return new fbj.a(fbj.b.a, "glob:" + $$0);
      }

      static fbj.a c(String $$0) {
         return new fbj.a(fbj.b.a, "regex:" + $$0);
      }

      static fbj.a d(String $$0) {
         return new fbj.a(fbj.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fbj.b a = FileSystem::getPathMatcher;
      fbj.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
