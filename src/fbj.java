...
public class fbj implements fbe {
   protected static final fbe a = new fbj(false, -Double.MAX_VALUE, cwo.j, $$0 -> false, null) {
      @Override
      public boolean a(fbt $$0, ji $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected fbj(boolean $$0, double $$1, cwo $$2, Predicate<esy> $$3, @Nullable buk $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
