...
public record cu(Optional<ju<cwi>> b, dj.d c, ks d, Map<cv.a<?>, cv> e) implements Predicate<cwm> {
   ...
   public static class a {
      private Optional<ju<cwi>> a = Optional.empty();
      ...
      public cu.a a(jr<cwi> $$0, dfl... $$1) {
         this.a = Optional.of(ju.a($$0x -> $$0x.j().f(), $$1));
         return this;
      }

      public cu.a a(jr<cwi> $$0, axs<cwi> $$1) {
