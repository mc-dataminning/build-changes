...
public record cu(Optional<bc<arb<String>, cu.a>> c) implements dt<cxh> {
   ...
   public boolean a(cua $$0, cxh $$1) {
      return !this.c.isPresent() || this.c.get().a($$1.a());
   }

   public Optional<bc<arb<String>, cu.a>> b() {
      return this.c;
   }

   public static record a(String b) implements Predicate<arb<String>> {
      public static final Codec<cu.a> a = Codec.STRING.xmap(cu.a::new, cu.a::a);

      public boolean a(arb<String> $$0) {
