...
public record cu(Map<ix<brc>, cu.b> b) {
   ...
   public boolean a(Map<ix<brc>, bre> $$0) {
      for (Entry<ix<brc>, cu.b> $$1 : this.b.entrySet()) {
         bre $$2 = $$0.get($$1.getKey());
         if (!$$1.getValue().a($$2)) {
            return false;
         }
      }
   ...
   public Map<ix<brc>, cu.b> a() {
      return this.b;
   }

   public static class a {
      private final Builder<ix<brc>, cu.b> a = ImmutableMap.builder();

      public static cu.a a() {
         return new cu.a();
      }

      public cu.a a(ix<brc> $$0) {
         this.a.put($$0, new cu.b());
         return this;
      }

      public cu.a a(ix<brc> $$0, cu.b $$1) {
         this.a.put($$0, $$1);
         return this;
      }
