...
public record cu(Optional<ju<cxg>> b, dj.d c, ks d, Map<cv.a<?>, cv> e) implements Predicate<cxk> {
   ...
   public static class a {
      private Optional<ju<cxg>> a = Optional.empty();
      ...
      public cu.a a(jr<cxg> $$0, dgz... $$1) {
         this.a = Optional.of(ju.a($$0x -> $$0x.j().f(), $$1));
         return this;
      }

      public cu.a a(jr<cxg> $$0, ayk<cxg> $$1) {
