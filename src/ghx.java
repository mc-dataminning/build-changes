...
public class ghx {
   public static class a implements giq<lw> {
      ...
      public gin a(lw $$0, gff $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ghx.b $$8 = new ghx.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gjn {
      b(gff $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azu.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends giz {
      private boolean b;
      private boolean F;
      private final gip G;
      private float H;
      ...
      c(gff $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gip $$7, gji $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            ghx.c $$0 = new ghx.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements giq<lw> {
      ...
      public gin a(lw $$0, gff $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ghx.c $$8 = new ghx.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, flz.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gil {
      ...
      private int D;
      private final gip E;
      private final List<czv> F;
      private boolean G;

      public e(gff $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gip $$7, List<czv> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, aww.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gin $$12 = this.E.a(ls.O, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)ayf.b($$11) / 255.0F, (float)ayf.c($$11) / 255.0F, (float)ayf.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               awu $$14 = $$13 ? awv.js : awv.jr;
               this.c.a(this.g, this.h, this.i, $$14, aww.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         ghx.c $$10 = (ghx.c)this.E.a(ls.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azu.d($$18, $$13, $$16) * $$0;
                  double $$20 = azu.d($$18, $$14, $$17) * $$0;
