...
public class ghx {
   ...
   public static void a(fip $$0, fdi $$1) {
      cnx $$2 = $$0.t;
      if (!$$2.ae) {
         dus $$3 = a($$2);
         if ($$3 != null) {
   ...
   @Nullable
   private static dus a(cnx $$0) {
      jf.a $$1 = new jf.a();

      for (int $$2 = 0; $$2 < 8; $$2++) {
         double $$3 = $$0.dx() + (double)(((float)(($$2 >> 0) % 2) - 0.5F) * $$0.dn() * 0.8F);
         double $$4 = $$0.dB() + (double)(((float)(($$2 >> 1) % 2) - 0.5F) * 0.1F * $$0.eg());
         double $$5 = $$0.dD() + (double)(((float)(($$2 >> 2) % 2) - 0.5F) * $$0.dn() * 0.8F);
         $$1.b($$3, $$4, $$5);
         dus $$6 = $$0.dS().a_($$1);
         if ($$6.o() != dnt.a && $$6.k($$0.dS(), $$1)) {
            return $$6;
         }
      }
   ...
   private static void a(gxg $$0, fdi $$1) {
   ...
   private static void b(fip $$0, fdi $$1) {
      RenderSystem.setShader(ggv.h);
      RenderSystem.setShaderTexture(0, a);
      jf $$2 = jf.a($$0.t.dx(), $$0.t.dB(), $$0.t.dD());
      float $$3 = ghj.a($$0.t.dS().C_(), $$0.t.dS().A($$2));
   ...
   private static void c(fip $$0, fdi $$1) {
      RenderSystem.setShader(ggv.i);
      ...
      float $$8 = ($$6 + $$7) / 2.0F;
      float $$9 = $$2.k();
      float $$10 = azf.h($$9, $$3, $$5);
      float $$11 = azf.h($$9, $$4, $$5);
      float $$12 = azf.h($$9, $$6, $$8);
      float $$13 = azf.h($$9, $$7, $$8);
      float $$14 = 1.0F;
