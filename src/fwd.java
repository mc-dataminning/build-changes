public class fwd extends ful {
   ...
   @Override
   protected void aR_() {
      this.B = new fpc(this.p, this.n / 2 - 153, 20, 300, 20, b);
      this.B.f(128);
      this.B.a(this.y.d().a().toString());
      this.B.b($$0x -> this.H());
      this.d(this.B);
      this.z = new fpc(this.p, this.n / 2 - 153, 55, 300, 20, c);
      this.z.f(128);
      this.z.a(this.y.b().toString());
      this.z.b($$0x -> this.H());
      this.d(this.z);
      this.A = new fpc(this.p, this.n / 2 - 153, 90, 300, 20, d);
      this.A.f(128);
      this.A.a(this.y.c().toString());
      this.A.b($$0x -> this.H());
      this.d(this.A);
      this.C = new fpc(this.p, this.n / 2 - 153, 125, 300, 20, s);
      this.C.f(256);
      this.C.a(this.y.f());
      this.d(this.C);
      this.D = new fpc(this.p, this.n / 2 - 153, 160, 98, 20, w);
      this.D.f(3);
      this.D.a(Integer.toString(this.y.s()));
      this.D.a(fqe.a(x));
      this.d(this.D);
      this.E = new fpc(this.p, this.n / 2 - 50, 160, 98, 20, u);
      this.E.f(3);
      this.E.a(Integer.toString(this.y.k()));
      this.E.a(fqe.a(v));
      this.d(this.E);
      this.K = this.y.j();
      this.H = this.c(fpa.a(dvc.a::a).a(dvc.a.values()).a(this.K).a().a(this.n / 2 + 54, 160, 100, 20, a, ($$0x, $$1) -> this.K = $$1));
      boolean $$0 = dnq.o(this.y.m()).o().b();
      this.H.j = $$0;
      this.H.k = $$0;
      this.c(new fon(this.n / 2 - 154, 185, 100, 20, wo.a, 0.0) {
         {
            this.b();
         }
         ...
         @Override
         protected void b() {
            this.b(wp.a("jigsaw_block.levels", fwd.this.F));
         }

         @Override
         protected void a() {
            fwd.this.F = ayz.a(ayz.b(0.0, 20.0, this.c));
         }
      });
      this.c(fpa.b(this.G).a(this.n / 2 - 50, 185, 100, 20, wp.c("jigsaw_block.keep_jigsaws"), ($$0x, $$1) -> this.G = $$1));
      this.J = this.c((fot)fot.a(wp.c("jigsaw_block.generate"), $$0x -> {
         this.m();
         this.G();
      }).a(this.n / 2 + 54, 185, 100, 20).a());
      this.I = this.c((fot)fot.a(wo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
