...
public class acs implements aac<acr> {
   ...
   public acs(bvk $$0, asf $$1) {
      this($$0, $$1, 0);
   }

   public acs(bvk $$0, asf $$1, int $$2) {
      this($$0.ar(), $$0.cG(), $$1.b().a(), $$1.b().b(), $$1.b().c(), $$1.d(), $$1.e(), $$0.aq(), $$2, $$1.c(), (double)$$1.f());
   }

   public acs(bvk $$0, int $$1, jh $$2) {
      this($$0.ar(), $$0.cG(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dO(), $$0.dM(), $$0.aq(), $$1, $$0.dz(), (double)$$0.cA());
   }

   public acs(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, bvr<?> $$7, int $$8, fby $$9, double $$10) {
      this.d = $$0;
      this.e = $$1;
      this.g = $$2;
      this.h = $$3;
