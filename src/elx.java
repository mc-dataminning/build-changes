...
public class elx {
   ...
   @Nullable
   private String g;
   private static final elx.a h = new elx.a() {
      @Nullable
      @Override
      public elw a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ema.a(this.d, "Get capabilities")) {
         ...
         if (ema.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ema.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ema.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public elw a(elx.c $$0) {
      return ($$0 == elx.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements elx.a {
      private final int a;
      private final Set<elw> b = Sets.newIdentityHashSet();
      ...
      public elw a() {
         if (this.b.size() >= this.a) {
            if (aa.aT) {
               elx.a.warn("Maximum sound pool size {} reached", this.a);
            }
