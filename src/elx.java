...
public interface elx {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new elx.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new elx.d($$0, $$1);
      }
   }

   public static record a(String d) implements elx {
   ...
   public static record b(int e, @Nullable tf f) implements elx {
      public static final elx.b c = new elx.b(429, tf.c("mco.errorMessage.serviceBusy"));
      public static final tf d = tf.c("mco.errorMessage.retry");

      public static elx.b a(String $$0) {
         return new elx.b(500, tf.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static elx.b a(enh $$0) {
         return new elx.b(500, tf.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static elx.b a(int $$0) {
         return new elx.b($$0, d);
      }

      public static elx.b b(int $$0) {
         return new elx.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements elx {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements elx {
      @Override
      public int a() {
         return this.c;
      }
