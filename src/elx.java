...
public class elx {
   ...
   public void a(enh $$0, String $$1, eod.a $$2, ecb $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  elx.b $$13 = new elx.b($$1.trim(), this.f, $$3, $$2);
                  elx.a $$14 = new elx.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        elx.c $$30 = new elx.c(this.f, $$2, $$0);
                        elx.a $$31 = new elx.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new enl(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ecb $$2) throws IOException {
      ...
      File $$15 = new File(eqq.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ecb d;
      private final eod.a e;

      b(String $$0, File $$1, ecb $$2, eod.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((elx.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !elx.this.b && !elx.this.d) {
            try {
               elx.this.e = true;
               elx.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               elx.a.error("Error extracting archive", var3);
               elx.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eod.a c;
      private final enh d;

      c(File $$0, eod.a $$1, enh $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((elx.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !elx.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, elx.this.g);
                  elx.this.c = true;
               } else {
                  elx.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  elx.this.d = true;
               }
            } catch (IOException var3) {
               elx.a.error("Error copying resourcepack file: {}", var3.getMessage());
               elx.this.d = true;
            }
         }
      }
