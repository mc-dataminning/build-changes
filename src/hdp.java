...
public abstract class hdp extends fqh {
   ...
   private final List<hdn> a = Lists.newArrayList();
   ...
   protected hdn a(hdn $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xe m() {
      return xd.a(this.a.stream().map(hdn::a).collect(Collectors.toList()));
   }
}
