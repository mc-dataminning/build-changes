...
public class gkx extends gkt {
   private fba h = fba.c;
   private int i;

   public gkx(gfz $$0, GameProfile $$1) {
      super($$0, $$1);
      this.ad = true;
   }
   ...
   public void d_() {
      ...
      if (this.i > 0) {
         this.j(new fba((this.h.d - this.dy().d) / (double)this.i, (this.h.e - this.dy().e) / (double)this.i, (this.h.f - this.dy().f) / (double)this.i));
         this.i--;
      }
