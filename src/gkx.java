...
public class gkx {
   private static final glo a = glo.t(alz.b("textures/map/map_background.png"));
   private static final glo b = glo.t(alz.b("textures/map/map_background_checkerboard.png"));
   ...
   private final han av = new han();
   private cxk aw = cxk.k;
   private cxk ax = cxk.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final grh aC;
   private final gsh aD;

   public gkx(flz $$0, grh $$1, gsh $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(bwb $$0, cxk $$1, cxi $$2, boolean $$3, fgl $$4, gle $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dV(), $$6, hav.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fgl $$0, gle $$1, int $$2, bvv $$3) {
      gwq $$4 = (gwq)this.aC.<gjx>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bvv.b ? 1.0F : -1.0F;
      ...
      alz $$6 = this.au.t.d().a();
      if ($$3 == bvv.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cpt.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cpt.c));
      }

      $$0.b();
   }

   private void a(fgl $$0, gle $$1, int $$2, float $$3, bvv $$4, float $$5, cxk $$6) {
      float $$7 = $$4 == bvv.b ? 1.0F : -1.0F;
   ...
   private void a(fgl $$0, gle $$1, int $$2, cxk $$3) {
   ...
   private void a(fgl $$0, gle $$1, int $$2, float $$3, float $$4, bvv $$5) {
      boolean $$6 = $$5 != bvv.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = bae.c($$4);
      ...
      gwq $$15 = (gwq)this.aC.<gjx>a($$14);
      alz $$16 = $$14.d().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cpt.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cpt.c));
      }
   }

   private void a(fgl $$0, float $$1, bvv $$2, cxk $$3, cps $$4) {
      float $$5 = (float)$$4.fA() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bwb)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fgl $$0, float $$1, bvv $$2, cxk $$3, cps $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fgl $$0, bvv $$1, float $$2) {
      int $$3 = $$1 == bvv.b ? 1 : -1;
   ...
   private void b(fgl $$0, bvv $$1, float $$2) {
      int $$3 = $$1 == bvv.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fgl $$1, gle.a $$2, gka $$3, int $$4) {
      float $$5 = $$3.D($$0);
      btd $$6 = (btd)MoreObjects.firstNonNull($$3.aJ, btd.a);
      float $$7 = $$3.j($$0);
      gkx.a $$8 = a($$3);
      ...
      if ($$8.d) {
         float $$11 = $$6 == btd.a ? $$5 : 0.0F;
         float $$12 = 1.0F - bae.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, btd.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == btd.b ? $$5 : 0.0F;
         float $$14 = 1.0F - bae.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, btd.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gkx.a a(gka $$0) {
      cxk $$1 = $$0.eX();
      cxk $$2 = $$0.eY();
      boolean $$3 = $$1.a(cxo.oR) || $$2.a(cxo.oR);
      boolean $$4 = $$1.a(cxo.wL) || $$2.a(cxo.wL);
      if (!$$3 && !$$4) {
         return gkx.a.a;
      } else if ($$0.fx()) {
         return b($$0);
      } else {
         return a($$1) ? gkx.a.b : gkx.a.a;
      }
   }

   private static gkx.a b(gka $$0) {
      cxk $$1 = $$0.fz();
      btd $$2 = $$0.fy();
      if (!$$1.a(cxo.oR) && !$$1.a(cxo.wL)) {
         return $$2 == btd.a && a($$0.eY()) ? gkx.a.b : gkx.a.a;
      } else {
         return gkx.a.a($$2);
      }
   }
   ...
   private static boolean a(cxk $$0) {
      return $$0.a(cxo.wL) && cwb.g($$0);
   }

   private void a(gjx $$0, float $$1, float $$2, btd $$3, float $$4, cxk $$5, float $$6, fgl $$7, gle $$8, int $$9) {
      if (!$$0.gF()) {
         boolean $$10 = $$3 == btd.a;
         bvv $$11 = $$10 ? $$0.fw() : $$0.fw().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cp()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fx() && $$0.fA() > 0 && $$0.fy() == $$3) {
               ...
               float $$15 = (float)$$5.a((bwb)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cwb.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? cxi.e : cxi.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bvv.b;
            if ($$0.fx() && $$0.fA() > 0 && $$0.fy() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((bwb)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((bwb)$$0) - ((float)$$0.fA() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$23 ? cxi.e : cxi.d, !$$23, $$7, $$8, $$9);
         }
