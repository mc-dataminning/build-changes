...
public class bjv implements Comparable<bjv> {
   ...
   @Nullable
   private bjv q;
   private final Optional<bjv.a> r;

   public bjv(bjt $$0) {
      this($$0, 0, 0);
   }

   public bjv(bjt $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public bjv(bjt $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public bjv(bjt $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public bjv(bjt $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null, $$0.b());
   }

   public bjv(bjt $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bjv $$6, Optional<bjv.a> $$7) {
      this.k = $$0;
      this.l = $$1;
      this.m = $$2;
      this.n = $$3;
   ...
   public boolean a(bky $$0, Runnable $$1) {
      if (this.j()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bjv $$1) ? false : this.l == $$1.l && this.m == $$1.m && this.n == $$1.n && this.k.equals($$1.k);
      }
   }
   ...
   private void c(rz $$0) {
      ...
      this.r.ifPresent($$1x -> bjv.a.a.encodeStart(sn.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("factor_calculation_data", $$1xx)));
   }

   @Nullable
   public static bjv b(rz $$0) {
      String $$1 = $$0.l("id");
      bjt $$2 = jy.e.a(agg.a($$1));
      return $$2 == null ? null : a($$2, $$0);
   }

   private static bjv a(bjt $$0, rz $$1) {
      int $$2 = $$1.f("amplifier");
      int $$3 = $$1.h("duration");
      ...
      if ($$1.b("factor_calculation_data", 10)) {
         $$8 = bjv.a.a.parse(new Dynamic(sn.a, $$1.p("factor_calculation_data"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bjv($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bjv.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  asq.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  asq.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bjv $$0) {
         ...
         float $$2 = ati.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = ati.i($$2, this.c, this.d);
      }

      public float a(bky $$0, float $$1) {
         if ($$0.dG()) {
            this.g = this.e;
         }

         return ati.i($$1, this.g, this.e);
      }
   }
}
