...
public class bjv implements bjw {
   ...
   private static final bjv k = new bjv();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bju $$0) {
      URL $$1 = bjv.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bju $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bjy a = new bjy(() -> bjv.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bjv.this.l && $$0.getState() == RecordingState.STOPPED) {
