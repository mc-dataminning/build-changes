...
public class gdz {
   private static final gel a = gel.t(new akk("textures/map/map_background.png"));
   private static final gel b = gel.t(new akk("textures/map/map_background_checkerboard.png"));
   ...
   private final fft au;
   private cuc av = cuc.l;
   private cuc aw = cuc.l;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gjk aB;
   private final gkk aC;

   public gdz(fft $$0, gjk $$1, gkk $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(btb $$0, cuc $$1, ctz $$2, boolean $$3, fam $$4, ged $$5, int $$6) {
      if (!$$1.e()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dQ(), $$6, gpf.d, $$0.am() + $$2.ordinal());
      }
   }
   ...
   private void a(fam $$0, ged $$1, int $$2, bsv $$3) {
      gor $$4 = (gor)this.aB.<gdc>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bsv.b ? 1.0F : -1.0F;
   ...
   private void a(fam $$0, ged $$1, int $$2, float $$3, bsv $$4, float $$5, cuc $$6) {
      float $$7 = $$4 == bsv.b ? 1.0F : -1.0F;
   ...
   private void a(fam $$0, ged $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayg.c($$5);
   ...
   private void a(fam $$0, ged $$1, int $$2, cuc $$3) {
      ...
      epu $$4 = $$3.a(kn.B);
      epw $$5 = cuk.a($$4, this.au.r);
      faq $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fam $$0, ged $$1, int $$2, float $$3, float $$4, bsv $$5) {
      boolean $$6 = $$5 != bsv.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayg.c($$4);
   ...
   private void a(fam $$0, float $$1, bsv $$2, cuc $$3, cmk $$4) {
      float $$5 = (float)$$4.fv() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((btb)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fam $$0, float $$1, bsv $$2, cuc $$3, cmk $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fam $$0, bsv $$1, float $$2) {
      int $$3 = $$1 == bsv.b ? 1 : -1;
   ...
   private void b(fam $$0, bsv $$1, float $$2) {
      int $$3 = $$1 == bsv.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fam $$1, ged.a $$2, gdf $$3, int $$4) {
      float $$5 = $$3.A($$0);
      bqf $$6 = (bqf)MoreObjects.firstNonNull($$3.aK, bqf.a);
      float $$7 = ayg.i($$0, $$3.P, $$3.dI());
      gdz.a $$8 = a($$3);
      ...
      if ($$8.d) {
         float $$11 = $$6 == bqf.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ayg.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bqf.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bqf.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ayg.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bqf.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gdz.a a(gdf $$0) {
      cuc $$1 = $$0.eU();
      cuc $$2 = $$0.eV();
      boolean $$3 = $$1.a(cuf.ov) || $$2.a(cuf.ov);
      boolean $$4 = $$1.a(cuf.vW) || $$2.a(cuf.vW);
      if (!$$3 && !$$4) {
         return gdz.a.a;
      } else if ($$0.fs()) {
         return b($$0);
      } else {
         return a($$1) ? gdz.a.b : gdz.a.a;
      }
   }

   private static gdz.a b(gdf $$0) {
      cuc $$1 = $$0.fu();
      bqf $$2 = $$0.ft();
      if (!$$1.a(cuf.ov) && !$$1.a(cuf.vW)) {
         return $$2 == bqf.a && a($$0.eV()) ? gdz.a.b : gdz.a.a;
      } else {
         return gdz.a.a($$2);
      }
   }
   ...
   private static boolean a(cuc $$0) {
      return $$0.a(cuf.vW) && csp.i($$0);
   }

   private void a(gdc $$0, float $$1, float $$2, bqf $$3, float $$4, cuc $$5, float $$6, fam $$7, ged $$8, int $$9) {
      if (!$$0.gx()) {
         boolean $$10 = $$3 == bqf.a;
         bsv $$11 = $$10 ? $$0.fr() : $$0.fr().e();
         $$7.a();
         if ($$5.e()) {
            if ($$10 && !$$0.ci()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               ...
               float $$15 = (float)$$5.a((btb)$$0) - ((float)$$0.fv() - $$1 + 1.0F);
               float $$16 = $$15 / (float)csp.a($$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? ctz.e : ctz.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bsv.b;
            if ($$0.fs() && $$0.fv() > 0 && $$0.ft() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.u()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((btb)$$0) - ((float)$$0.fv() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((btb)$$0) - ((float)$$0.fv() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$23 ? ctz.e : ctz.d, !$$23, $$7, $$8, $$9);
         }
