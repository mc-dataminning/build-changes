...
public class gdz extends aub<gdz.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final akk b = new akk("gpu_warnlist.json");
   ...
   protected gdz.a a(atw $$0, bmv $$1) {
      ...
      $$1.b();
      return new gdz.a($$2, $$3, $$4);
   }

   protected void a(gdz.a $$0, atw $$1, bmv $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(atw $$0, bmv $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ezh.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ezh.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ezh.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
