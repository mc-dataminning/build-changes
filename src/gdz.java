...
public final class gdz {
   ...
   private static final gdz c = new gdz(HostAndPort.fromParts("server.invalid", 25565));

   public gdz(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gdz(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gdz a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gdz($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gdz ? this.b.equals(((gdz)$$0).b) : false;
      }
   }
