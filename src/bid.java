...
public class bid implements Comparable<bid> {
   ...
   public static class a {
      public static final Codec<bid.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  arg.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  arg.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
      ...
      public void a(bid $$0) {
         ...
         float $$2 = arx.a((float)this.f / (float)this.b, 0.0F, 1.0F);
         this.e = arx.i($$2, this.c, this.d);
      }
