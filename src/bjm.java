...
public class bjm extends DataFix {
   ...
   public bjm(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bix.H);
      Type<?> $$1 = this.getInputSchema().getType(bix.H);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bkl.a());
   ...
   private TypeRewriteRule b() {
      ...
      OpticFinder<String> $$4 = bkl.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
