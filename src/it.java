...
public enum it implements ayz {
   ...
   public static final ayz.a<it> g = ayz.a(it::values);
   public static final Codec<it> h = g.validate(it::a);
   public static final IntFunction<it> i = aww.a(it::d, values(), aww.a.b);
   ...
   public static Collection<it> a(aym $$0) {
   ...
   public static it a(brw $$0, it.a $$1) {
      return switch ($$1) {
   ...
   public static it a(int $$0) {
      return s[ayf.a($$0 % s.length)];
   }

   public static it b(int $$0) {
      return t[ayf.a($$0 % t.length)];
   }
   ...
   public static enum a implements ayz, Predicate<it> {
      a("x") {
         @Override
      ...
      public static final ayz.a<it.a> e = ayz.a(it.a::values);
