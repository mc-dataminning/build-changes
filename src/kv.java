...
public record kv(kv.a c) implements dk<dbm> {
   ...
   public static record a(Optional<dbm.a> b, Optional<Boolean> c, Optional<Boolean> d) implements Predicate<dbm> {
      public static final Codec<kv.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  dbm.a.g.optionalFieldOf("shape").forGetter(kv.a::a),
