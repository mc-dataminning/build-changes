...
public class kv {
   ...
   public static final ku<Integer> c = a("max_stack_size", $$0 -> $$0.a(ayi.a(1, 99)).a(yk.h));
   public static final ku<Integer> d = a("max_damage", $$0 -> $$0.a(ayi.m).a(yk.h));
   public static final ku<Integer> e = a("damage", $$0 -> $$0.a(ayi.l).a(yk.h));
   ...
   public static final ku<baf> q = a("hide_additional_tooltip", $$0 -> $$0.a(baf.b).a(ym.a(baf.a)));
   public static final ku<baf> r = a("hide_tooltip", $$0 -> $$0.a(Codec.unit(baf.a)).a(ym.a(baf.a)));
   public static final ku<Integer> s = a("repair_cost", $$0 -> $$0.a(ayi.l).a(yk.h));
   public static final ku<baf> t = a("creative_slot_lock", $$0 -> $$0.a(ym.a(baf.a)));
   ...
   public static final ku<baf> F = a("glider", $$0 -> $$0.a(baf.b).a(ym.a(baf.a)));
   ...
   public static final ku<List<akt<dbe<?>>>> ac = a("recipes", $$0 -> $$0.a(akt.a(mc.bk).listOf()).a());
   ...
   public static final ku<List<dtw.c>> an = a("bees", $$0 -> $$0.a(dtw.c.b).a(dtw.c.c.a(yk.a())).a());
   public static final ku<bsk> ao = a("lock", $$0 -> $$0.a(bsk.b));
