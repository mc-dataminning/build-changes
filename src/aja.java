...
public class aja {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("particle").requires($$0x -> $$0x.c(2)))
            .then(
               ((RequiredArgumentBuilder)dv.a("name", eq.a($$1))
                     .executes(
                        $$0x -> a(
                              (du)$$0x.getSource(), eq.a($$0x, "name"), ((du)$$0x.getSource()).e(), eji.b, 0.0F, 0, false, ((du)$$0x.getSource()).m().ac().t()
                           )
                     ))
                  .then(
                     ((RequiredArgumentBuilder)dv.a("pos", ft.a())
                           .executes(
                              $$0x -> a((du)$$0x.getSource(), eq.a($$0x, "name"), ft.a($$0x, "pos"), eji.b, 0.0F, 0, false, ((du)$$0x.getSource()).m().ac().t())
                           ))
                        .then(
   ...
   private static int a(du $$0, jq $$1, eji $$2, eji $$3, float $$4, int $$5, boolean $$6, Collection<amb> $$7) throws CommandSyntaxException {
      int $$8 = 0;
