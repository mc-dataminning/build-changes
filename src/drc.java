...
public class drc {
   ...
   final boolean f;
   private final ayk<dke> g;
   private final int h;
   private final int i;
   private final int j;
   private final int k;
   private List<drc.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public drc(boolean $$0, ayk<dke> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static drc a() {
      return new drc(false, axu.bU, 10, 4, 10, 5);
   }

   public static drc b() {
      return new drc(true, axu.bV, 50, 1, 5, 10);
   }
   ...
   public void a(ux $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<drc.a> $$1 = (List<drc.a>)drc.a.b.listOf().parse(new Dynamic(vl.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(ux $$0) {
      drc.a.b.listOf().encodeStart(vl.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(jh $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new drc.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(drc.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(dhb $$0, jh $$1, bam $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<drc.a> $$4 = new ArrayList<>();
         Map<jh, drc.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<drc.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  jh.a.fieldOf("pos").forGetter(drc.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(drc.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(drc.a::c),
      ...
      private boolean a(dhb $$0, jh $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dhb $$0, jh $$1, bam $$2, drc $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, axf.wm, axg.e, 1.0F, 1.0F);
               }
      ...
      private static dqx a(dxn $$0) {
         return $$0.b() instanceof dqx $$1 ? $$1 : dqx.u_;
      }
      ...
      @Nullable
      private static jh a(dhb $$0, jh $$1, bam $$2) {
         jh.a $$3 = $$1.k();
         jh.a $$4 = $$1.k();
      ...
      private static boolean a(dhb $$0, jh $$1, jh $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            jh $$3 = $$2.b($$1);
      ...
      private static boolean a(dhb $$0, jh $$1, jm $$2) {
         jh $$3 = $$1.a($$2);
