...
public class xt implements wj {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = awu.b(awu.b, xt::b);
   private static final Codec<Object> e = Codec.either(d, wk.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wi $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<xt> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               awu.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, xt::a)
   );
   public static final wj.a<xt> c = new wj.a<>(b, "translatable");
   private static final wn f = wn.e("%");
   private static final wn g = wn.e("null");
   ...
   @Nullable
   private tj k;
   private List<wn> l = ImmutableList.of();
   ...
   private static xt a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new xt($$0, $$1.orElse(null), a($$2));
   }

   public xt(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<wn> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (xu var4) {
            this.l = ImmutableList.of(wn.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<wn> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new xu(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private wn a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wi) {
            ...
            return $$1 == null ? g : wn.e($$1.toString());
         }
      } else {
         throw new xu(this, $$0);
      }
   ...
   public ww a(@Nullable dv $$0, @Nullable bqa $$1, int $$2) throws CommandSyntaxException {
      ...
      return ww.a(new xt(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof xt $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
