...
public class xt {
   ...
   private xt(String $$0, List<xs> $$1, Int2IntFunction $$2) {
      this.a = $$0;
   ...
   public static xt a(xa $$0) {
      return a($$0, $$0x -> $$0x, $$0x -> $$0x);
   }

   public static xt a(xa $$0, Int2IntFunction $$1, UnaryOperator<String> $$2) {
      StringBuilder $$3 = new StringBuilder();
      List<xs> $$4 = Lists.newArrayList();
      $$0.a(($$2x, $$3x) -> {
      ...
      return new xt($$2.apply($$3.toString()), $$4, $$1);
   }
}
