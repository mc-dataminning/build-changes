...
public class dd extends ds<dd.a> {
   ...
   public void a(aqn $$0, akj<eqz> $$1) {
      this.a($$0, $$1x -> $$1x.b($$1));
   }

   public static record a(Optional<bf> b, akj<eqz> c) implements ds.a {
      ...
      public static an<dd.a> a(akj<eqz> $$0) {
         return am.Q.a(new dd.a(Optional.empty(), $$0));
      }

      public boolean b(akj<eqz> $$0) {
         return this.c == $$0;
      }
