...
public class aol {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xc.c("commands.perf.notRunning"));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xc.c("commands.perf.alreadyRunning"));
   ...
   private static int a(ek $$0) throws CommandSyntaxException {
      ...
      if ($$1.aT()) {
         ...
         Consumer<brb> $$2 = $$1x -> a($$0, $$1x);
         Consumer<Path> $$3 = $$2x -> a($$0, $$2x, $$1);
         $$1.a($$2, $$3);
         $$0.a(() -> xc.c("commands.perf.started"), false);
         return 0;
      }
   }
   ...
   private static void a(ek $$0, Path $$1, MinecraftServer $$2) {
      ...
      try {
         ...
         $$0.b(xc.c("commands.perf.reportFailed"));
         a.error("Failed to create report name", var11);
         return;
      }

      try (azb $$7 = new azb(bsy.a.resolve($$4))) {
      ...
      $$0.a(() -> xc.a("commands.perf.reportSaved", $$4), false);
   }

   private static void a(ek $$0, brb $$1) {
      if ($$1 != bqx.a) {
         int $$2 = $$1.f();
         double $$3 = (double)$$1.g() / (double)bau.a;
         $$0.a(() -> xc.a("commands.perf.stopped", String.format(Locale.ROOT, "%.2f", $$3), $$2, String.format(Locale.ROOT, "%.2f", (double)$$2 / $$3)), false);
      }
   }
}
