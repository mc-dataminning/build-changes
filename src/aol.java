...
public class aol {
                     ...
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)er.a(
                                    ...
                                    .then(
                                       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)er.a("nametagVisibility")
                                                   .then(er.a("never").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.b))))
                                                .then(er.a("hideForOtherTeams").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.c))))
                                             .then(er.a("hideForOwnTeam").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.d))))
                                          .then(er.a("always").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.a)))
                                    ))
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)er.a("deathMessageVisibility")
                                                .then(er.a("never").executes($$0x -> b((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.b))))
                                             .then(er.a("hideForOtherTeams").executes($$0x -> b((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.c))))
                                          .then(er.a("hideForOwnTeam").executes($$0x -> b((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.d))))
                                       .then(er.a("always").executes($$0x -> b((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.b.a)))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)er.a("collisionRule")
                                             .then(er.a("never").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.a.b))))
                                          .then(er.a("pushOwnTeam").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.a.d))))
                                       .then(er.a("pushOtherTeams").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.a.c))))
                                    .then(er.a("always").executes($$0x -> a((eq)$$0x.getSource(), gc.a($$0x, "team"), exf.a.a)))
                              ))
                           .then(
                              er.a("prefix")
   ...
   private static wu a(Collection<exc> $$0) {
      return $$0.iterator().next().hb();
   }

   private static int a(eq $$0, Collection<exc> $$1) {
      exd $$2 = $$0.l().aK();
   ...
   private static int a(eq $$0, ewy $$1, Collection<exc> $$2) {
      exd $$3 = $$0.l().aK();
   ...
   private static int a(eq $$0, ewy $$1, exf.b $$2) throws CommandSyntaxException {
      if ($$1.j() == $$2) {
         throw i.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(eq $$0, ewy $$1, exf.b $$2) throws CommandSyntaxException {
      if ($$1.k() == $$2) {
         throw j.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(eq $$0, ewy $$1, exf.a $$2) throws CommandSyntaxException {
      if ($$1.l() == $$2) {
         throw k.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(eq $$0, ewy $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.i() == $$2) {
         if ($$2) {
            throw g.create();
         } else {
   ...
   private static int b(eq $$0, ewy $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.h() == $$2) {
         if ($$2) {
            throw e.create();
         } else {
   ...
   private static int a(eq $$0, ewy $$1, wu $$2) throws CommandSyntaxException {
      if ($$1.c().equals($$2)) {
         throw c.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(eq $$0, ewy $$1, n $$2) throws CommandSyntaxException {
      if ($$1.n() == $$2) {
         throw d.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(eq $$0, ewy $$1) throws CommandSyntaxException {
      exd $$2 = $$0.l().aK();
   ...
   private static int b(eq $$0, ewy $$1) {
      exd $$2 = $$0.l().aK();
      $$2.d($$1);
   ...
   private static int c(eq $$0, ewy $$1) {
   ...
   private static int a(eq $$0) {
      Collection<ewy> $$1 = $$0.l().aK().g();
      if ($$1.isEmpty()) {
         $$0.a(() -> wu.c("commands.team.list.teams.empty"), false);
      } else {
         $$0.a(() -> wu.a("commands.team.list.teams.success", $$1.size(), wx.b($$1, ewy::d)), false);
      }

      return $$1.size();
   }

   private static int b(eq $$0, ewy $$1, wu $$2) {
      $$1.b($$2);
      $$0.a(() -> wu.a("commands.team.option.prefix.success", $$2), false);
      return 1;
   }

   private static int c(eq $$0, ewy $$1, wu $$2) {
      $$1.c($$2);
