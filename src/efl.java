...
public class efl extends efp {
   public static final MapCodec<efl> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eey.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayc.a(je.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, efl::new)
   );
   ...
   protected final eey e;
   protected final int f;
   protected final List<je> g;

   public efl(float $$0, int $$1, int $$2, eey $$3, int $$4, List<je> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(efp.a $$0, iz $$1, je $$2) {
