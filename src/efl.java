...
public class efl extends efm {
   ...
   public static final MapCodec<efl> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(efk.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, efl::new)
   );
   private final efk h;

   public efl(bpl $$0, efp $$1, Optional<efj> $$2, efk $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, ja $$3, ja $$4, eek $$5) {
   ...
   private boolean a(dcl $$0, ayo $$1, ja $$2, jf $$3, ja $$4, List<ja> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
