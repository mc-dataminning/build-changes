...
public class efl {
   ...
   static class a implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
         return $$0.c[ih.f.d()] && !$$0.b[ih.f.d()].d;
      }

      @Override
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         $$1.d = true;
         $$1.b[ih.f.d()].d = true;
         return new efl.k($$0, $$1);
      }
   }

   static class b implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         ...
         return new efl.l($$0, $$1);
      }
   }

   static class c implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         $$1.d = true;
         $$1.b[ih.b.d()].d = true;
         return new efl.m($$0, $$1);
      }
   }

   static class d implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         ...
         return new efl.n($$0, $$1);
      }
   }

   static class e implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         ...
         $$3.d = true;
         $$3.b[ih.c.d()].d = true;
         return new efl.o($$0, $$3);
      }
   }

   static class f implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
         return true;
      }
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         $$1.d = true;
         return new efl.s($$0, $$1, $$2);
      }
   }

   static class g implements efl.i {
      @Override
      public boolean a(efl.v $$0) {
      ...
      public efl.r a(ih $$0, efl.v $$1, axd $$2) {
         $$1.d = true;
         return new efl.t($$0, $$1);
      }
   }

   public static class h extends efl.r {
      ...
      private efl.v G;
      private efl.v H;
      private final List<efl.r> I = Lists.newArrayList();

      public h(axd $$0, int $$1, int $$2, ih $$3) {
         super(edt.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<efl.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new efl.p($$3, this.G));
         this.I.add(new efl.j($$3, this.H));
         List<efl.i> $$5 = Lists.newArrayList();
         $$5.add(new efl.b());
         $$5.add(new efl.d());
         $$5.add(new efl.e());
         $$5.add(new efl.a());
         ...
         ecu $$10 = ecu.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ecu $$11 = ecu.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ecu $$12 = ecu.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new efl.u($$3, $$10, $$13++));
         this.I.add(new efl.u($$3, $$11, $$13++));
         this.I.add(new efl.q($$3, $$12));
      }
      ...
      private List<efl.v> b(axd $$0) {
         efl.v[] $$1 = new efl.v[75];
         ...
         efl.v $$23 = new efl.v(1003);
         efl.v $$24 = new efl.v(1001);
         efl.v $$25 = new efl.v(1002);
         $$1[v].a(ih.b, $$23);
         $$1[w].a(ih.d, $$24);
         $$1[x].a(ih.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<efl.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cxu $$2, axd $$3, ecu $$4) {
         int $$5 = 24;
      ...
      private void a(cxu $$0, axd $$1, ecu $$2) {
      ...
      private void b(cxu $$0, axd $$1, ecu $$2) {
      ...
      private void c(cxu $$0, axd $$1, ecu $$2) {
      ...
      private void d(cxu $$0, axd $$1, ecu $$2) {
      ...
      private void e(cxu $$0, axd $$1, ecu $$2) {
      ...
      private void f(cxu $$0, axd $$1, ecu $$2) {
   ...
   interface i {
      boolean a(efl.v var1);

      efl.r a(ih var1, efl.v var2, axd var3);
   }

   public static class j extends efl.r {
      public j(ih $$0, efl.v $$1) {
         super(edt.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cxu $$0, cxs $$1, dow $$2, axd $$3, ecu $$4, cwg $$5, ib $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dac.ch.o(), dac.ch.o(), false);
   ...
   public static class k extends efl.r {
      public k(ih $$0, efl.v $$1) {
         super(edt.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends efl.r {
      public l(ih $$0, efl.v $$1) {
         super(edt.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends efl.r {
      public m(ih $$0, efl.v $$1) {
         super(edt.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends efl.r {
      public n(ih $$0, efl.v $$1) {
         super(edt.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends efl.r {
      public o(ih $$0, efl.v $$1) {
         super(edt.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends efl.r {
      public p(ih $$0, efl.v $$1) {
         super(edt.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends efl.r {
      public q(ih $$0, ecu $$1) {
         super(edt.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends edg {
      protected static final dmz b = dac.hZ.o();
      protected static final dmz c = dac.ia.o();
      protected static final dmz d = dac.ib.o();
      protected static final dmz h = c;
      protected static final dmz i = dac.ii.o();
      protected static final boolean j = true;
      protected static final dmz k = dac.G.o();
      protected static final Set<daa> l = ImmutableSet.builder().add(dac.dO).add(dac.iC).add(dac.mW).add(k.b()).build();
      ...
      public r(edt $$0, ih $$1, int $$2, ecu $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(edt $$0, int $$1, ih $$2, efl.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ecu a(ih $$0, efl.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ecu $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cxu $$0, ecu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dmz $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cxu $$0, ecu $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cxu $$0, ecu $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dmz $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ecu $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cxu $$0, ecu $$1, int $$2, int $$3, int $$4) {
         ib $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cfn $$6 = bpc.D.a((cwz)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eO());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bps.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends efl.r {
      private int a;

      public s(ih $$0, efl.v $$1, axd $$2) {
         super(edt.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends efl.r {
      public t(ih $$0, efl.v $$1) {
         super(edt.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends efl.r {
      private int a;

      public u(ih $$0, ecu $$1, int $$2) {
         super(edt.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
