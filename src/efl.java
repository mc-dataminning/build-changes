...
public class efl extends eft {
   ...
   public efm a() {
      ...
      if (this.f() && this.b.aZ()) {
         $$0 = this.b.dr();
         hx.a $$1 = new hx.a(this.b.dq(), (double)$$0, this.b.dw());

         for (djp $$2 = this.a.a_($$1); $$2.a(cxa.G); $$2 = this.a.a_($$1)) {
            $$1.b(this.b.dq(), (double)(++$$0), this.b.dw());
         }
      } else {
         $$0 = aup.a(this.b.ds() + 0.5);
      }

      hx $$4 = hx.a(this.b.dq(), (double)$$0, this.b.dw());
      if (!this.a($$4)) {
   ...
   private boolean b(@Nullable efm $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable efm $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   private efk c(int $$0, int $$1, int $$2) {
      return (efk)this.l.computeIfAbsent(hx.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }
   ...
   public efk a(ctd $$0, int $$1, int $$2, int $$3, bmq $$4) {
      ...
      if ($$5.contains(efk.h)) {
         ...
         return $$6 == efk.b && $$4.a($$8) == 0.0F ? efk.b : $$8;
      }
   }
   ...
   public efk a(ctd $$0, int $$1, int $$2, int $$3) {
      ...
      if ($$5 == efk.b && $$2 >= $$0.J_() + 1) {
         ...
         if ($$6 == efk.o || $$6 == efk.i) {
            ...
            $$5 = $$6 != efk.c && $$6 != efk.b && $$6 != efk.j ? efk.c : efk.b;
         }
      }
   ...
   private Iterable<hx> a(bmq $$0) {
      float $$1 = 1.0F;
      elx $$2 = $$0.cH();
      boolean $$3 = $$2.a() < 1.0;
      if (!$$3) {
         return List.of(
            hx.a($$2.a, (double)$$0.dr(), $$2.c),
            hx.a($$2.a, (double)$$0.dr(), $$2.f),
            hx.a($$2.d, (double)$$0.dr(), $$2.c),
            hx.a($$2.d, (double)$$0.dr(), $$2.f)
         );
      } else {
         ...
         elx $$7 = $$2.c($$5, $$6, $$4);
         return hx.a($$0.eg(), 10, aup.a($$7.a), aup.a($$7.b), aup.a($$7.c), aup.a($$7.d), aup.a($$7.e), aup.a($$7.f));
      }
   }
}
