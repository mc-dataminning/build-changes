...
public class efl implements efs.c {
   ...
   private final ObjectListIterator<efl.a> h;
   private final ObjectListIterator<erw> i;

   public static efl a(djr $$0, dic $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<efl.a> $$4 = new ObjectArrayList(10);
      ObjectList<erw> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != ere.a).forEach($$5x -> {
         ere $$6 = $$5x.h().d();
         ...
         for (eqx $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eqp) {
                  ...
                  $$4.add(new efl.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new efl($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public efl(ObjectListIterator<efl.a> $$0, ObjectListIterator<erw> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(eql a, ere b, int c) {
   }
}
