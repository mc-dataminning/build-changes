...
public class arn {
   ...
   public static he<cja> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jb.i
            .b(aev.a(jc.D, new aew($$2)))
   ...
   public static he<cja> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static he<cja> a(JsonObject $$0, String $$1, @Nullable he<cja> $$2) {
