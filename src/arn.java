...
public class arn implements AutoCloseable {
   ...
   private arn(URL $$0, arn.c $$1, URL $$2, arn.b $$3, URL $$4, arn.b $$5, String $$6, arn.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? axp.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static arn a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = axp.a($$0);
            URI $$2 = new URI(axp.i($$1, "apiServer"));
            String $$3 = axp.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axp.a($$1, "ruleId", 1);
               String $$5 = axp.a($$1, "serverId", "");
               String $$6 = axp.a($$1, "roomId", "Java:Chat");
               int $$7 = axp.a($$1, "hashesToDrop", -1);
               int $$8 = axp.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axp.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, arn.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<aqz> a(GameProfile $$0, String $$1, arn.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(aqz.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = axp.a($$4, "response", false);
            if ($$5) {
               return aqz.a($$1);
            } else {
               String $$6 = axp.a($$4, "hashed", null);
               if ($$6 == null) {
                  return aqz.b($$1);
               } else {
                  JsonArray $$7 = axp.v($$4, "hashes");
                  wy $$8 = this.a($$1, $$7, $$2);
                  return new aqz($$1, $$8);
               }
            }
   ...
   private wy a(String $$0, JsonArray $$1, arn.a $$2) {
      if ($$1.isEmpty()) {
         return wy.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return wy.b;
      } else {
         wy $$3 = new wy($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new arn.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public arm a(GameProfile $$0) {
      return new arn.d($$0);
   }
   ...
   public interface a {
      arn.a a = ($$0, $$1) -> false;
      arn.a b = ($$0, $$1) -> $$0.length() == $$1;

      static arn.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static arn.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements arm {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bof<Runnable> $$1 = bof.a(arn.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         arn.this.a(this.c, arn.this.g, arn.this.h, this.d);
      }

      @Override
      public void b() {
         arn.this.a(this.c, arn.this.i, arn.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<aqz>> a(List<String> $$0) {
         List<CompletableFuture<aqz>> $$1 = $$0.stream().map($$0x -> arn.this.a(this.c, $$0x, arn.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<aqz> a(String $$0) {
         return arn.this.a(this.c, $$0, arn.this.l, this.d);
      }
   }
