...
public class arn extends arh {
   ...
   private final arn.b d;
   private final String e;

   arn(arp $$0, arn.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(ars $$0, ajv $$1) {
   ...
   @Nullable
   private asw<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : asw.create($$1, $$2);
      }
   }
   ...
   public static class a implements asm.c {
      ...
      @Override
      public arq a(arp $$0) {
         arn.b $$1 = new arn.b(this.a);
         return new arn($$0, $$1, "");
      }

      @Override
      public arq a(arp $$0, asm.a $$1) {
         arn.b $$2 = new arn.b(this.a);
         arq $$3 = new arn($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<arq> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  arn.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
