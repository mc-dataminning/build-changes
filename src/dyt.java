...
public final class dyt extends dyw<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private dyt(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dyt $$1 && super.equals($$0)) {
   ...
   public static dyt a(String $$0, int $$1, int $$2) {
