...
public class cff {
   ...
   public boolean a(cpv<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cpv<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cff.a($$0).a($$2, $$1);
   }

   public int a(cpx<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cpx<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cff.a($$0.b()).b($$1, $$2);
   }

   public static cmr a(int $$0) {
      return $$0 == 0 ? cmr.f : new cmr(cmm.b($$0));
   }
   ...
   class a {
      private final cpv<?> b;
      private final List<cps> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cff.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
