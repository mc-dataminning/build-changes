...
public abstract class cff extends bso {
   protected static final int ca = 6000;
   private int bY;
   @Nullable
   private UUID bZ;

   protected cff(bta<? extends cff> $$0, dby $$1) {
      super($$0, $$1);
      this.a(eom.n, 16.0F);
      this.a(eom.o, -1.0F);
   }
   ...
   public float a(iz $$0, dcb $$1) {
      return $$1.a_($$0.d()).a(dfb.i) ? 10.0F : $$1.w($$0);
   }
   ...
   public static boolean b(bta<? extends cff> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      boolean $$5 = btt.b($$2) || a($$1, $$3);
      return $$1.a_($$3.d()).a(awp.bW) && $$5;
   }

   protected static boolean a(dbb $$0, iz $$1) {
      return $$0.b($$1, 0) > 8;
   }
   ...
   public abstract boolean o(cup var1);
   ...
   public void a(arf $$0, cff $$1, @Nullable bso $$2) {
      ...
      $$0.a(this, (byte)18);
      if ($$0.ab().b(dbu.f)) {
         $$0.b(new btf($$0, this.du(), this.dw(), this.dA(), this.el().a(7) + 1));
      }
   }
