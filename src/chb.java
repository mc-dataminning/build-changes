...
public class chb extends chm implements bni<chb.b> {
   private static final agm<Integer> i = agp.a(chb.class, ago.b);
   private static final agm<Boolean> j = agp.a(chb.class, ago.k);
   private static final agm<Boolean> k = agp.a(chb.class, ago.k);
   private static final agm<Integer> l = agp.a(chb.class, ago.b);
   ...
   public chb(bly<? extends chb> $$0, cto $$1) {
      super($$0, $$1);
      this.I = true;
   }

   public chb(cto $$0, double $$1, double $$2, double $$3) {
      this(bly.k, $$0);
      this.a_($$1, $$2, $$3);
      this.K = $$1;
      this.L = $$2;
   ...
   public static boolean a(blu $$0, blu $$1) {
   ...
   protected Vector3f a(blu $$0, blv $$1, float $$2) {
      ...
      return new Vector3f(0.0F, this.y() == chb.b.i ? $$1.b * 0.8888889F : $$1.b / 3.0F, $$3);
   }
   ...
   public void l() {
      this.aN = this.aM;
      this.aM = this.C();
      if (this.aM != chb.a.b && this.aM != chb.a.c) {
         this.q = 0.0F;
      } else {
         this.q++;
      }
      ...
      this.aQ();
      List<blu> $$5 = this.dM().a(this, this.cH().c(0.2F, -0.01F, 0.2F), blx.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dM().B && !(this.cN() instanceof cfh);

         for (blu $$7 : $$5) {
            if (!$$7.x(this)) {
               if ($$6 && this.cP().size() < this.z() && !$$7.bO() && this.a($$7) && $$7 instanceof bmk && !($$7 instanceof byz) && !($$7 instanceof cfh)) {
                  $$7.n(this);
               } else {
                  this.g($$7);
               }
   ...
   private void A() {
      if (this.dM().B) {
         ...
         this.aR = aun.a(this.aR, 0.0F, 1.0F);
         this.aT = this.aS;
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aQ) {
                  ...
                  this.o($$3.c, this.a($$0 -> $$0 instanceof cfh) ? 2.7 : 0.6, $$3.e);
               }
            }
   ...
   public float a(int $$0, float $$1) {
      return this.c($$0) ? aun.b(this.o[$$0] - (float) (Math.PI / 8), this.o[$$0], $$1) : 0.0F;
   }
      ...
      for (int $$8 = $$3; $$8 < $$4; $$8++) {
         ...
         for (int $$10 = $$1; $$10 < $$2; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               eeq $$12 = this.dM().b_($$7);
               if ($$12.a(asl.a)) {
                  $$9 = Math.max($$9, $$12.a((csu)this.dM(), $$7));
               }
   ...
   public float w() {
      eln $$0 = this.cH();
      eln $$1 = new eln($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = aun.a($$1.a) - 1;
      int $$3 = aun.c($$1.d) + 1;
      int $$4 = aun.a($$1.b) - 1;
      int $$5 = aun.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     djg $$16 = this.dM().a_($$11);
                     if (!($$16.b() instanceof dfq) && emi.c($$16.k(this.dM(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, elw.i)) {
                        $$9 += $$16.b().i();
                        $$10++;
                     }
                  }
      ...
      for (int $$9 = $$1; $$9 < $$2; $$9++) {
         for (int $$10 = $$3; $$10 < $$4; $$10++) {
            for (int $$11 = $$5; $$11 < $$6; $$11++) {
               ...
               eeq $$12 = this.dM().b_($$8);
               if ($$12.a(asl.a)) {
                  float $$13 = (float)$$10 + $$12.a((csu)this.dM(), $$8);
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               eeq $$13 = this.dM().b_($$9);
               if ($$13.a(asl.a) && $$1 < (double)((float)$$9.v() + $$13.a((csu)this.dM(), $$9))) {
                  if (!$$13.b()) {
                     return chb.a.c;
                  }
   ...
   private void G() {
      ...
      double $$2 = 0.0;
      this.p = 0.05F;
      if (this.aN == chb.a.e && this.aM != chb.a.e && this.aM != chb.a.d) {
         this.aK = this.e(1.0);
         ...
         if (this.aM == chb.a.a) {
            ...
            this.p = 0.9F;
         } else if (this.aM == chb.a.c) {
            $$1 = -7.0E-4;
            this.p = 0.9F;
         } else if (this.aM == chb.a.b) {
            $$2 = 0.01F;
            this.p = 0.45F;
         } else if (this.aM == chb.a.e) {
            this.p = 0.9F;
         } else if (this.aM == chb.a.d) {
            this.p = this.aL;
            if (this.cN() instanceof cfh) {
               this.aL /= 2.0F;
            }
         }
   ...
   private void H() {
      if (this.bP()) {
         ...
         this.g(this.dp().b((double)(aun.a(-this.dC() * (float) (Math.PI / 180.0)) * $$0), 0.0, (double)(aun.b(this.dC() * (float) (Math.PI / 180.0)) * $$0)));
   ...
   protected void a(blu $$0, blu.a $$1) {
      ...
      if (!$$0.ai().a(asj.t)) {
         ...
         $$0.n($$0.cp() + this.r);
         this.b($$0);
         if ($$0 instanceof bxx && this.cP().size() == this.z()) {
            int $$2 = $$0.aj() % 2 == 0 ? 90 : 270;
            $$0.o(((bxx)$$0).aU + (float)$$2);
            $$0.n($$0.cp() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public els b(bmk $$0) {
      els $$1 = a((double)(this.dg() * aun.g), (double)$$0.dg(), $$0.dC());
      double $$2 = this.dr() + $$1.c;
      double $$3 = this.dx() + $$1.e;
      hx $$4 = hx.a($$2, this.cH().e, $$3);
      hx $$5 = $$4.d();
      if (!this.dM().z($$5)) {
         List<els> $$6 = Lists.newArrayList();
         double $$7 = this.dM().j($$4);
         if (che.a($$7)) {
            $$6.add(new els($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dM().j($$5);
         if (che.a($$8)) {
            $$6.add(new els($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fA().iterator();

         while (var14.hasNext()) {
            bmw $$9 = (bmw)var14.next();

            for (els $$10 : $$6) {
               if (che.a(this.dM(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   protected void b(blu $$0) {
      $$0.o(this.dC());
      float $$1 = aun.g($$0.dC() - this.dC());
      float $$2 = aun.a($$1, -105.0F, 105.0F);
      $$0.N += $$2 - $$1;
      $$0.r($$0.dC() + $$2 - $$1);
      $$0.n($$0.dC());
   }
   ...
   protected void a(double $$0, boolean $$1, djg $$2, hx $$3) {
      ...
      if (!this.bO()) {
         if ($$1) {
            ...
            this.n();
         } else if (!this.dM().b_(this.dm().d()).a(asl.a) && $$0 < 0.0) {
            this.ab -= (float)$$0;
         }
      }
   }
   ...
   public float a(float $$0) {
      return aun.i($$0, this.aT, this.aS);
   }

   public void a(chb.b $$0) {
      this.an.b(i, $$0.ordinal());
   }

   public chb.b y() {
      return chb.b.a(this.an.b(i));
   }

   @Override
   protected boolean r(blu $$0) {
      return this.cP().size() < this.z() && !this.a(asl.a);
   }
   ...
   @Override
   public bmk cN() {
      return this.cQ() instanceof bmk $$0 ? $$0 : super.cN();
   }
   ...
   @Override
   public boolean be() {
      return this.aM == chb.a.b || this.aM == chb.a.c;
   }

   @Override
   public cmx dz() {
      return new cmx(this.ah_());
   }
   ...
   public static enum b implements avj {
      ...
      private final cwp l;
      public static final avj.a<chb.b> j = avj.a(chb.b::values);
      private static final IntFunction<chb.b> m = atf.a(Enum::ordinal, values(), atf.a.a);

      private b(cwp $$0, String $$1) {
         this.k = $$1;
         this.l = $$0;
      }
      ...
      public static chb.b a(int $$0) {
         return m.apply($$0);
      }

      public static chb.b a(String $$0) {
         return j.a($$0, a);
      }
   }
}
