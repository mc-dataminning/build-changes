...
public class chb extends bwe implements bwh<jr<chc>> {
   public static final double cc = 0.6;
   public static final double cd = 0.8;
   public static final double ce = 1.33;
   private static final ajy<jr<chc>> cf = akc.a(chb.class, aka.x);
   private static final ajy<Boolean> cg = akc.a(chb.class, aka.k);
   private static final ajy<Boolean> ch = akc.a(chb.class, aka.k);
   private static final ajy<Integer> ci = akc.a(chb.class, aka.b);
   private static final aku<chc> cj = chc.c;
   @Nullable
   private chb.a<cox> ck;
   @Nullable
   private cdn cl;
   private float cm;
   private float cn;
   ...
   public chb(bus<? extends chb> $$0, dgi $$1) {
      super($$0, $$1);
      this.gK();
   }
   ...
   @Override
   protected void E() {
      this.cl = new chb.c(this, 0.6, $$0 -> $$0.a(awy.ah), true);
      ...
      this.bS.a(12, new ccn(this, cox.class, 10.0F));
   ...
   public static bwo.a gI() {
      return cgy.gx().a(bwp.s, 10.0).a(bwp.v, 0.3F).a(bwp.c, 3.0);
   }
   ...
   private void gM() {
      ...
      if (this.gF()) {
         ...
         for (cox $$2 : this.dV().a(cox.class, new fav($$0).c(2.0, 2.0, 2.0))) {
            if ($$2.fR()) {
               this.cq = true;
               break;
            }
   ...
   public boolean a(cgy $$0) {
      if (!this.p()) {
         ...
         return !($$0 instanceof chb $$1) ? false : $$1.p() && super.a($$0);
      }
   }
   ...
   protected void gK() {
      if (this.ck == null) {
         this.ck = new chb.a<>(this, cox.class, 16.0F, 0.8, 1.33);
      }
   ...
   static class b extends ccf {
      ...
      private boolean h() {
         for (chb $$1 : this.a.dV().a(chb.class, new fav(this.c).g(2.0))) {
   ...
   static class c extends cdn {
      ...
      public c(chb $$0, double $$1, Predicate<cwp> $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
         this.d = $$0;
      }
