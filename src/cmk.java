...
public class cmk implements bqa, bqm {
   ...
   public final js<cud> h = js.a(36, cud.l);
   public final js<cud> i = js.a(4, cud.l);
   public final js<cud> j = js.a(1, cud.l);
   private final List<js<cud>> n = ImmutableList.of(this.h, this.i, this.j);
   public int k;
   public final cml l;
   private int o;
   ...
   public cud f() {
      return d(this.k) ? this.h.get(this.k) : cud.l;
   }
   ...
   private boolean a(cud $$0, cud $$1) {
      return !$$0.e() && cud.c($$0, $$1) && $$0.k() && $$0.H() < this.e_($$0);
   }
   ...
   public int c(cud $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         if (!this.h.get($$1).e() && cud.c($$0, this.h.get($$1))) {
            return $$1;
         }
      }
   ...
   public int d(cud $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         cud $$2 = this.h.get($$1);
         if (!$$2.e() && cud.c($$0, $$2) && !$$2.m() && !$$2.A() && !$$2.b(kn.g)) {
            return $$1;
         }
      }
   ...
   public int a(Predicate<cud> $$0, int $$1, bqa $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
      $$3 += bqb.a(this, $$0, $$1 - $$3, $$4);
      $$3 += bqb.a($$2, $$0, $$1 - $$3, $$4);
      cud $$5 = this.l.ce.g();
      $$3 += bqb.a($$5, $$0, $$1 - $$3, $$4);
      if ($$5.e()) {
   ...
   public void j() {
      for (js<cud> $$0 : this.n) {
         for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
            if (!$$0.get($$1).e()) {
               $$0.get($$1).a(this.l.dR(), this.l, $$1, this.k == $$1);
            }
         }
      }
   }
   ...
   public cud a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).e() ? bqb.a($$2, $$0, $$1) : cud.l;
   }
   ...
   public ud a(ud $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         if (!this.h.get($$1).e()) {
            tx $$2 = new tx();
            $$2.a("Slot", (byte)$$1);
            $$0.add(this.h.get($$1).b(this.l.dT(), $$2));
         }
      }
      ...
      for (int $$3 = 0; $$3 < this.i.size(); $$3++) {
         if (!this.i.get($$3).e()) {
            tx $$4 = new tx();
            $$4.a("Slot", (byte)($$3 + 100));
            $$0.add(this.i.get($$3).b(this.l.dT(), $$4));
         }
      }
      ...
      for (int $$5 = 0; $$5 < this.j.size(); $$5++) {
         if (!this.j.get($$5).e()) {
            tx $$6 = new tx();
            $$6.a("Slot", (byte)($$5 + 150));
            $$0.add(this.j.get($$5).b(this.l.dT(), $$6));
         }
      }
   ...
   public void b(ud $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         tx $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cud $$4 = cud.a(this.l.dT(), (uu)$$2).orElse(cud.l);
   ...
   public cud a(boolean $$0) {
      cud $$1 = this.f();
      return $$1.e() ? cud.l : this.a(this.k, $$0 ? $$1.H() : 1);
   }
}
