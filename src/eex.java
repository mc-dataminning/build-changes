...
public class eex extends eey {
   ...
   public static final MapCodec<eex> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(eew.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, eex::new)
   );
   private final eew h;

   public eex(bpx $$0, efb $$1, Optional<eev> $$2, eew $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, iz $$3, iz $$4, edw $$5) {
   ...
   private boolean a(dcc $$0, azf $$1, iz $$2, je $$3, iz $$4, List<iz> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<iz> a(iz $$0, je $$1, azf $$2, iz $$3) {
      iz $$4 = $$0.d();
      iz $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
