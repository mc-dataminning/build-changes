...
public class apy {
   ...
   final List<uq> g = Collections.synchronizedList(Lists.newArrayList());

   public apy(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (apy.this.e.an()) {
                  $$1.addLast("legacy_query", new apt(apy.this.d()));
               }

               uq.a($$1, ya.a, null);
               int $$2 = apy.this.e.o();
               uq $$3 = (uq)($$2 > 0 ? new vc($$2) : new uq(ya.a));
               apy.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new aqa(apy.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     vs $$3 = vs.b("Internal server error");
                     $$1.a(new yh($$3), uz.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<apy.a.a> d = Lists.newArrayList();
