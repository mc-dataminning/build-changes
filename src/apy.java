...
public class apy {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> xv.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> xv.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> xv.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ew $$0, fbx $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bvk> $$6) throws CommandSyntaxException {
      ash $$7 = $$0.e();
      int $$8 = $$7.L_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         apy.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> xv.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends bvk> $$0) {
      Set<fdf> $$1 = Sets.newHashSet();
   ...
   private static void a(fbx $$0, double $$1, ash $$2, bam $$3, double $$4, double $$5, double $$6, double $$7, int $$8, apy.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bvk> $$0, ash $$1, apy.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<fdf, apy.a> $$7 = Maps.newHashMap();

      for (bvk $$8 : $$0) {
         apy.a $$10;
         if ($$4) {
            fdf $$9 = $$8 instanceof cpx ? $$8.cr() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
   ...
   private static apy.a[] a(bam $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      apy.a[] $$6 = new apy.a[$$1];
   ...
   static class a {
      ...
      public void a(bam $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = bae.a($$0, $$1, $$3);
         this.b = bae.a($$0, $$2, $$4);
      }
   }
