...
public class csx extends csb {
   ...
   private final csv t = csv.a();
   public final int[] m = new int[3];
   public final int[] n = new int[]{-1, -1, -1};
   public final int[] o = new int[]{-1, -1, -1};

   public csx(int $$0, cov $$1) {
      this($$0, $$1, cso.a);
   }

   public csx(int $$0, cov $$1, cso $$2) {
      super(ctk.n, $$0);
      this.r = $$2;
      this.a(new cty(this.q, 0, 15, 47) {
         @Override
         public int a() {
            return 1;
         }
      });
      this.a(new cty(this.q, 1, 35, 47) {
         @Override
      ...
      this.c($$1, 8, 84);
      this.a(csv.a(this.m, 0));
      this.a(csv.a(this.m, 1));
      this.a(csv.a(this.m, 2));
      this.a(this.t).a($$1.k.gr());
      this.a(csv.a(this.n, 0));
      this.a(csv.a(this.n, 1));
      this.a(csv.a(this.n, 2));
      this.a(csv.a(this.o, 0));
      this.a(csv.a(this.o, 1));
      this.a(csv.a(this.o, 2));
   }
      ...
      if ($$0 == this.q) {
         ...
         if (!$$1.f() && $$1.E()) {
            this.r.a(($$1x, $$2x) -> {
               ...
               for (int $$7 = 0; $$7 < 3; $$7++) {
                  if (this.m[$$7] > 0) {
                     List<ddb> $$8 = this.a($$1x.K_(), $$1, $$7, this.m[$$7]);
                     if ($$8 != null && !$$8.isEmpty()) {
                        ddb $$9 = $$8.get(this.s.a($$8.size()));
                        this.n[$$7] = $$3.a($$9.a);
                        this.o[$$7] = $$9.b;
                     }
                  }
   ...
   public boolean a(cow $$0, int $$1) {
      if ($$1 >= 0 && $$1 < this.m.length) {
         ...
         if (($$3.f() || $$3.M() < $$4) && !$$0.fV()) {
            ...
            this.r.a(($$5, $$6) -> {
               cwo $$7 = $$2;
               List<ddb> $$8 = this.a($$5.K_(), $$2, $$1, this.m[$$1]);
               if (!$$8.isEmpty()) {
                  $$0.a($$2, $$4);
                  if ($$2.a(cws.rw)) {
                     $$7 = $$2.a((dgg)cws.vv);
   ...
   private List<ddb> a(kf $$0, cwo $$1, int $$2, int $$3) {
      this.s.b((long)(this.t.b() + $$2));
      Optional<jv.c<dcy>> $$4 = $$0.e(mc.aO).a(aws.k);
      if ($$4.isEmpty()) {
         return List.of();
      } else {
         List<ddb> $$5 = dda.b(this.s, $$1, $$3, $$4.get().a());
         if ($$1.a(cws.rw) && $$5.size() > 1) {
