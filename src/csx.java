...
public class csx extends cvd {
   ...
   private static float a(cwy $$0) {
      return $$0.a(cun.uu) ? 1.6F : 3.15F;
   }
   ...
   public void a(cuk $$0, dbt $$1, btk $$2, int $$3) {
      ...
      float $$5 = a($$4, $$0);
      if ($$5 >= 1.0F && !j($$0) && a($$2, $$0)) {
         $$1.a(null, $$2.du(), $$2.dw(), $$2.dA(), avw.go, $$2.de(), 1.0F, 1.0F / ($$1.E_().i() * 0.5F + 1.0F) + 0.2F);
      }
   }

   private static boolean a(btk $$0, cuk $$1) {
      List<cuk> $$2 = a($$1, $$0.g($$1), $$0);
      if (!$$2.isEmpty()) {
         $$1.b(km.D, cwy.a($$2));
         return true;
      } else {
   ...
   public static boolean j(cuk $$0) {
      cwy $$1 = $$0.a(km.D, cwy.a);
      return !$$1.b();
   }
   ...
   protected void a(btk $$0, cnk $$1, int $$2, float $$3, float $$4, float $$5, @Nullable btk $$6) {
      ...
      float $$16 = a($$0.el(), $$2);
      $$0.dP().a(null, $$0.du(), $$0.dw(), $$0.dA(), avw.gu, $$0.de(), 1.0F, $$16);
   }

   private static Vector3f a(btk $$0, evm $$1, float $$2) {
   ...
   protected cnk a(dbt $$0, btk $$1, cuk $$2, cuk $$3, boolean $$4) {
      if ($$3.a(cun.uu)) {
         return new cnf($$0, $$3, $$1, $$1.du(), $$1.dy() - 0.15F, $$1.dA(), true);
      } else {
         cnk $$5 = super.a($$0, $$1, $$2, $$3, $$4);
         if ($$5 instanceof cmy $$6) {
            $$6.q(true);
            $$6.b(avw.gn);
         }
   ...
   protected int k(cuk $$0) {
      return $$0.a(cun.uu) ? 3 : 1;
   }

   public void a(dbt $$0, btk $$1, bqo $$2, cuk $$3, float $$4, float $$5, @Nullable btk $$6) {
      if (!$$0.x_()) {
         cwy $$7 = $$3.b(km.D, cwy.a);
         if ($$7 != null && !$$7.b()) {
            this.a($$0, $$1, $$2, $$3, $$7.a(), $$4, $$5, $$1 instanceof cms, $$6);
            if ($$1 instanceof arc $$8) {
               am.G.a($$8, $$3);
               $$8.b(awg.c.b($$3.g()));
            }
         }
   ...
   private static float a(azc $$0, int $$1) {
      return $$1 == 0 ? 1.0F : a(($$1 & 1) == 1, $$0);
   }

   private static float a(boolean $$0, azc $$1) {
   ...
   public void a(dbt $$0, btk $$1, cuk $$2, int $$3) {
      if (!$$0.B) {
         ...
         if ($$7 >= 0.2F && !this.l) {
            this.l = true;
            $$0.a(null, $$1.du(), $$1.dw(), $$1.dA(), $$5, avx.h, 0.5F, 1.0F);
         }

         if ($$7 >= 0.5F && $$6 != null && !this.m) {
            this.m = true;
            $$0.a(null, $$1.du(), $$1.dw(), $$1.dA(), $$6, avx.h, 0.5F, 1.0F);
         }
      }
   }
   ...
   private static float a(int $$0, cuk $$1) {
   ...
   public void a(cuk $$0, cuf.b $$1, List<xl> $$2, cwd $$3) {
      ...
      if ($$4 != null && !$$4.b()) {
         cuk $$5 = $$4.a().get(0);
         $$2.add(xl.c("item.minecraft.crossbow.projectile").b(xk.v).b($$5.G()));
         if ($$3.a() && $$5.a(cun.uu)) {
