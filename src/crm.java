...
public class crm {
   ...
   public static final crm b = new crm(0, 0);
   ...
   public static crm a(int $$0, int $$1) {
      return new crm($$0 << 5, $$1 << 5);
   }

   public static crm b(int $$0, int $$1) {
      return new crm(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof crm $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public int a(int $$0) {
      return iy.a(this.e, $$0);
   }

   public int b(int $$0) {
      return iy.a(this.f, $$0);
   }
   ...
   public static Stream<crm> a(crm $$0, int $$1) {
      return a(new crm($$0.e - $$1, $$0.f - $$1), new crm($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<crm> a(final crm $$0, final crm $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<crm>((long)($$2 * $$3), 64) {
         @Nullable
         private crm e;

         @Override
         public boolean tryAdvance(Consumer<? super crm> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new crm($$0.e, $$2 + $$5);
               } else {
                  this.e = new crm($$1 + $$4, $$2);
               }
            }
