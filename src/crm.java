...
public class crm extends cqf {
   ...
   public crm(vu $$0, vu $$1, vu $$2, vu $$3, vu $$4, List<ajh> $$5, List<ajh> $$6) {
      super(new cqf.a());
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static crm a(ajg<csp> $$0) {
      return a($$0.a());
   }

   public static crm a(ajh $$0) {
      return new crm(f, g, vu.c(ac.a("trim_pattern", $$0)).a(a), h, i, A(), B());
   }

   public static crm h() {
      return new crm(j, k, e, r, s, C(), D());
   }
