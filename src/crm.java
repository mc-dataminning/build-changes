...
public abstract class crm extends bxj {
   ...
   public static final ffc bI = new ffc(0.0, 0.6, 0.0);
   ...
   private static final Map<bxv, bwl> b = ImmutableMap.builder()
      ...
      .build();
   private static final akj<Float> c = akn.a(crm.class, akl.d);
   private static final akj<Integer> d = akn.a(crm.class, akl.b);
   protected static final akj<Byte> bK = akn.a(crm.class, akl.a);
   protected static final akj<Byte> bL = akn.a(crm.class, akl.a);
   protected static final akj<tz> bM = akn.a(crm.class, akl.t);
   protected static final akj<tz> bN = akn.a(crm.class, akl.t);
   public static final int bO = 60;
   private long e;
   final crl f;
   protected cwt bP = new cwt();
   public final cwi bQ;
   public cvf bR;
   protected cvb bS = new cvb();
   protected int bT;
   ...
   private boolean cq;
   private czn cr = czn.k;
   private final czk cs = this.g();
   ...
   public crm(djm $$0, iv $$1, float $$2, GameProfile $$3) {
      super(bwr.bS, $$0);
      this.a_($$3.getId());
      this.k = $$3;
      this.f = new crl(this, this.bt);
      this.bQ = new cwi(this.f, !$$0.C, this);
      this.bR = this.bQ;
   ...
   public boolean a(djm $$0, iv $$1, djj $$2) {
      if (!$$2.f()) {
         return false;
      } else if ($$2 == djj.d) {
         return true;
         ...
         czn $$3 = this.fa();
         return $$3.f() || !$$3.b(new eax($$0, $$1, false));
      }
   }
   ...
   public void a(int $$0, float $$1, czn $$2) {
      this.bp = $$0;
      this.bq = $$1;
      this.br = $$2;
      if (!this.dU().C) {
   ...
   public void a(tz $$0) {
      ...
      this.cm = $$0.<ffc>a("current_explosion_impact_pos", ffc.a).orElse(null);
   ...
   public void b(tz $$0) {
      ...
      $$0.b("current_explosion_impact_pos", ffc.a, this.cm);
   ...
   public boolean a(arq $$0, bux $$1) {
      if (super.a($$0, $$1)) {
         ...
         return $$1.a(axd.o) ? !$$0.O().c(dji.L) : false;
      }
   }
      ...
      if (this.V_()) {
         ...
         if ($$4.a()) {
            ...
            if (!$$2.f() && $$0 instanceof bxj) {
               ...
               if ($$5.a()) {
                  this.dU().a(eft.r, $$0.ds(), eft.a.a(this));
                  if ($$2.f() && !this.fU()) {
                     this.a($$1, czn.k);
                  }
   ...
   private boolean q(double $$0, double $$1, double $$2) {
      fex $$3 = this.cQ();
      return this.dU().a(this, new fex($$3.a + 1.0E-7 + $$0, $$3.b - $$2 - 1.0E-7, $$3.c + 1.0E-7 + $$1, $$3.d - 1.0E-7 + $$0, $$3.b, $$3.f - 1.0E-7 + $$1));
   }
   ...
   public void e(bwi $$0) {
      if ($$0.cA()) {
         if (!$$0.v(this)) {
            ...
            $$4 *= $$5;
            this.gD();
            if ($$0.an().a(axf.H) && $$0 instanceof csh $$6 && $$6.a(csi.c, this, this, true)) {
   ...
   public boolean a(iv $$0, jb $$1, czn $$2) {
      if (this.i.e) {
         return true;
      } else {
         iv $$3 = $$0.a($$1.g());
         eax $$4 = new eax(this.dU(), $$3, false);
         return $$2.a($$4);
      }
   }
   ...
   protected int e(arq $$0) {
      return !$$0.O().c(dji.e) && !this.V_() ? Math.min(this.cf * 7, 100) : 0;
   }
      ...
      if ($$0 == 499) {
         ...
         if ($$1 >= 0 && $$1 < 4) {
            return new bya() {
               @Override
               public czn a() {
                  return crm.this.bQ.r().a($$1);
               }

               @Override
               public boolean a(czn $$0) {
                  crm.this.bQ.r().a($$1, $$0);
                  crm.this.bQ.a(crm.this.f);
                  return true;
               }
            };
   ...
   public czn d(czn $$0) {
      if (!($$0.h() instanceof dai)) {
         ...
         if (!$$2.f()) {
            ...
            return this.fU() ? new czn(czr.pk) : czn.k;
         }
      }
   }
   ...
   public ffc v(float $$0) {
      ...
      if (this.fI() || this.fu()) {
         ...
         return this.p($$0).e(new ffc($$1, -0.11, 0.85).c(-$$10).a(-$$2).b(-$$3));
      } else if (this.cj()) {
         return this.p($$0).e(new ffc($$1, 0.2, -0.15).a(-$$2).b(-$$3));
      } else {
         double $$12 = this.cQ().c() - 1.0;
         double $$13 = this.cg() ? -0.2 : 0.07;
         return this.p($$0).e(new ffc($$1, $$12, $$13).b(-$$3));
      }
   }
   ...
   public boolean gG() {
      return this.fy() && this.fA().a(czr.sf);
   }
   ...
   public boolean a(fex $$0, double $$1) {
      double $$2 = this.gL() + $$1;
   ...
   public boolean a(iv $$0, double $$1) {
      double $$2 = this.gK() + $$1;
      return new fex($$0).e(this.bC()) < $$2 * $$2;
   }
