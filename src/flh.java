...
public class flh {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dge)MoreObjects.firstNonNull(this.b.r.i(), dge.b)).b());
               }
   ...
   private void a(dww $$0, ji $$1, @Nullable tq $$2) {
   ...
   private void a(akv $$0, faz $$1, @Nullable tq $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = feo.a(fli.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!feo.a(fli.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (feo.a(fli.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxv) || ((fxv)$$6).u <= af.c() - 20L)) {
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               flq.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }
         ...
         if ($$3 != 0) {
            ...
            if ($$7) {
               if (fuk.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$8 = this.b.n.av().c() == flk.a;
                  this.b.n.av().a(flk.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
