...
public class flh implements Comparable<flh> {
   private static final Map<String, flh> h = Maps.newHashMap();
   private static final Map<fep.a, flh> i = Maps.newHashMap();
   ...
   private final fep.a m;
   private final String n;
   private fep.a o;
   private boolean p;
   private int q;

   public static void a(fep.a $$0) {
      flh $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(fep.a $$0, boolean $$1) {
      flh $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (flh $$0 : h.values()) {
         if ($$0.o.a() == fep.b.a && $$0.o.b() != fep.bv.b()) {
            $$0.a(fep.a(flj.Q().aO().h(), $$0.o.b()));
         }
      }
   }
   ...
   public flh(String $$0, int $$1, String $$2) {
      this($$0, fep.b.a, $$1, $$2);
   }

   public flh(String $$0, fep.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(fep.a $$0) {
      this.o = $$0;
   }

   public int a(flh $$0) {
      return this.n.equals($$0.n) ? hga.a(this.l).compareTo(hga.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(flh $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(fep.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == fep.bv.b() ? this.o.a() == fep.b.b && this.o.b() == $$1 : this.o.a() == fep.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == fep.b.c && this.o.b() == $$0;
   }
