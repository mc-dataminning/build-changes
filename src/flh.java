...
public class flh {
   ...
   private static final Map<eaz.a, String> e = ad.a(new EnumMap<>(eaz.a.class), $$0 -> {
      $$0.put(eaz.a.a, "SW");
      $$0.put(eaz.a.b, "S");
      $$0.put(eaz.a.c, "OW");
      $$0.put(eaz.a.d, "O");
   ...
   private dxj l;
   @Nullable
   private CompletableFuture<dxj> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bmv r = new bmv(1);
   private final bmv s = new bmv(bna.values().length);
   private final bmv t = new bmv(1);
   private final bmv u = new bmv(1);
   private final Map<bmw, bmv> v = Map.of(bmw.a, this.s);
   private final fmq w;
   private final fmt x;
   private final fmr y;
   private final fmp z;
   ...
   public flh(fja $$0) {
      ...
      this.g = new flh.a();
      this.h = $$0.h;
      this.w = new fmq(this.h, this.r);
      this.x = new fmt(this.h, this.s, () -> $$0.s.s().g());
      this.y = new fmr(this.h, this.t);
      this.z = new fmp(this.h, this.u);
      this.A = new fms(this.h);
   }
   ...
   private void a(fkm $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dev $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arm ? ((arm)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.ao().dC(), this.f.ao().dE(), this.f.ao().dI()));
         $$25.add(String.format(Locale.ROOT, "Block: %d %d %d [%d %d %d]", $$14.u(), $$14.v(), $$14.w(), $$14.u() & 15, $$14.v() & 15, $$14.w() & 15));
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, ki.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azj.h($$15.dN()), azj.h($$15.dP())));
         dxj $$27 = this.u();
         if ($$27.B()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(dfe.a, $$14);
            int $$30 = this.f.s.a(dfe.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dxj $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (eaz.a $$33 : eaz.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.t();
                  brw $$37 = new brw($$23.am(), $$23.ab(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dfg.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<buy> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(buy.values())
   ...
   private static String a(jp<dfw> $$0) {
   ...
   private dev s() {
      return (dev)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ag()))), this.f.s);
   }
   ...
   private dxj t() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dya.n, false).thenApply($$0x -> (dxj)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fcm.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fja.Q().aP().l(), fja.Q().aP().m(), fcm.a()),
            fcm.c(),
            fcm.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == ezf.a.b) {
            ...
            $$4.add(String.valueOf(lx.e.b($$6.b())));

            for (Entry<dwg<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == ezf.a.b) {
            ...
            $$4.add(String.valueOf(lx.c.b($$9.a())));

            for (Entry<dwg<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lx.f.b($$11.aq())));
         }
   ...
   private String a(Entry<dwg<?>, Comparable<?>> $$0) {
      dwg<?> $$1 = $$0.getKey();
