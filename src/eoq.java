...
public class eoq extends eos {
   ...
   public eoq(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(eos.a $$0) {
      ...
      if (!$$3.isEmpty()) {
         ...
         iv $$5 = (iv)$$4.getValue();
         if ($$1.i() < this.d) {
            $$2.F_().a(mh.aL).flatMap($$0x -> $$0x.a(ro.M)).ifPresent($$3x -> ((ejf)$$3x.a()).a($$2, $$2.a().m().g(), $$1, $$5.d()));
         }
   ...
   private static void a(iv $$0, eos.a $$1) {
      while ($$1.a($$0.e()) && !((double)$$1.b().i() < 0.5)) {
         $$1.a($$0, dmo.ug.m().b(dqh.b, Boolean.valueOf(false)));
         $$0 = $$0.e();
      }

      $$1.a($$0, dmo.ug.m().b(dqh.b, Boolean.valueOf(true)));
   }
}
