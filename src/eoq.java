...
public class eoq extends ger {
   ...
   public void aC_() {
      int $$0 = this.g / 4 - 2;
      this.d(esg.a(tf.c("mco.terms.buttons.agree"), $$0x -> this.C()).a(this.g / 4, h(12), $$0, 20).a());
      this.d(esg.a(tf.c("mco.terms.buttons.disagree"), $$0x -> this.f.a(this.z)).a(this.g / 2 + 4, h(12), $$0, 20).a());
   }
   ...
   private void C() {
      ...
      try {
         $$0.i();
         this.f.a(new eod(this.z, new epk(this.A, this.z, this.B, new ReentrantLock())));
      } catch (eni var3) {
