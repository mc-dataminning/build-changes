...
public class eoq implements eon {
   @Nullable
   ...
   public eoq(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new eoq.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements eom {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / eoq.this.c;
         this.d = ($$5 + (float)$$0 + eoq.this.e) / eoq.this.c;
         this.e = (eoq.this.h - (float)$$2 + eoq.this.f) / eoq.this.c;
         this.g = $$6;
      }
      ...
      public fak bake(Function<eoo, fak> $$0) {
         return $$0.apply(new eoo() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = eoq.this.b();
               epl $$3 = new epl(epl.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, eoq.this.g, eoq.this.g, eoq.this.e, eoq.this.f, 0, 0);
