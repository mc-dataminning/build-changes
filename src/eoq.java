...
public class eoq extends eox {
   public static final MapCodec<eoq> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eod.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
   ...
   protected final eod e;
   protected final int f;
   protected final List<jb> g;

   public eoq(float $$0, int $$1, int $$2, eod $$3, int $$4, List<jb> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(eox.a $$0, iv $$1, jb $$2) {
