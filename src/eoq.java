...
public class eoq {
   public static List<eps> a(eoq.a... $$0) {
      for (eoq.a $$1 : $$0) {
         a($$1.j);
      }

      List<eps> $$2 = Lists.newArrayList();

      for (eoq.a $$3 : $$0) {
         $$2.add(new eps($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(eps::a));
      return $$2;
   }
   ...
   public static List<eps> a() {
      return a(eoq.a.values());
   }
