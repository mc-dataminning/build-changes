...
public class eoq extends eox {
   private static final Codec<bto> b = bto.a
      .codec()
      .validate(
         $$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final MapCodec<eoq> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bti.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  bti.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  bti.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  bti.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, eoq::new)
   );
   ...
   public eoq(int $$0, int $$1, int $$2, bti $$3, bti $$4, bto $$5, bti $$6) {
      super($$0, $$1, $$2);
      this.h = $$3;
      this.i = $$4;
      this.j = $$5;
      this.k = bto.a($$5.a(), $$5.b() - 1);
      this.l = $$6;
   }
   ...
   public List<enc.a> a(djg $$0, BiConsumer<iu, eah> $$1, azv $$2, int $$3, iu $$4, emm $$5) {
      ...
      List<enc.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new enc.a($$4.b($$11), 0, false));
      }

      iu.a $$16 = new iu.a();
      ja $$17 = ja.c.a.a($$2);
      Function<eah, eah> $$18 = $$1x -> $$1x.c(dsy.d, $$17.o());
   ...
   private enc.a a(djg $$0, BiConsumer<iu, eah> $$1, azv $$2, int $$3, iu $$4, emm $$5, Function<eah, eah> $$6, ja $$7, int $$8, boolean $$9, iu.a $$10) {
      $$10.g($$4).c(ja.b, $$8);
