...
public class ejk {
   ...
   public ejk(@Nullable eqx $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public static ejk a(akq<dcw> $$0, @Nullable eqx $$1) {
      if ($$0 == dcw.h) {
         return new ejk(
            $$1,
         ...
         return new ejk($$1, $$2, $$2);
      } else if ($$0 == dcw.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new ejk($$1, $$3, $$3);
      } else {
