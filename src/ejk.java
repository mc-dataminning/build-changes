...
public class ejk extends eje<elj> {
   private static final ja[] a = ja.values();

   public ejk(Codec<elj> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejg<elj> $$0) {
      elj $$1 = $$0.f();
      azv $$2 = $$0.d();
      iu $$3 = $$0.e();
      dju $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      egx $$9 = new egx(new efz($$4.E()));
      evj $$10 = evj.a($$9, -4, 1.0);
      ...
      for (iu $$44 : $$31) {
         ...
         for (ja $$46 : a) {
            ...
            dzz $$48 = $$4.a_($$47);
            if ($$45.b(eap.I)) {
               $$45 = $$45.b(eap.I, Boolean.valueOf($$48.y().b()));
            }
