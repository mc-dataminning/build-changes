...
public final class etp extends etn<etq.a, etq> {
   ...
   private static final long h = etn.a.a(15, jn.b);
   private static final long i = etn.a.a(15, false, jn.b);
         ...
         if (etn.a.a($$1, $$5)) {
            ...
            if (this.f.b(kk.e($$6))) {
               ...
               if ($$8 > $$7) {
                  ...
                  if ($$10 > $$7) {
                     if ($$3 == null) {
                        $$3 = etn.a.b($$1) ? dkg.a.m() : this.c(this.j.f($$0));
                     }
