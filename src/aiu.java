...
public class aiu {
                           ...
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)dt.a("damageType", er.a($$1, ke.r))
                                    .executes(
                                       $$0x -> a(
                                             ...
                                             new bkt(er.a($$0x, "damageType", ke.r))
                                          )
                                    ))
                                 .then(
                                    dt.a("at")
                                          ...
                                          dt.a("location", ft.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      ef.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bkt(er.a($$0x, "damageType", ke.r), ft.a($$0x, "location"))
                                                   )
                                             )
                                       )
                                 ))
                                       ...
                                       ((RequiredArgumentBuilder)dt.a("entity", ef.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      ef.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bkt(er.a($$0x, "damageType", ke.r), ef.a($$0x, "entity"))
                                                   )
                                             ))
                                          .then(
                                             dt.a("from")
                                                   ...
                                                   dt.a("cause", ef.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               ef.a($$0x, "target"),
                                                               FloatArgumentType.getFloat($$0x, "amount"),
                                                               new bkt(er.a($$0x, "damageType", ke.r), ef.a($$0x, "entity"), ef.a($$0x, "cause"))
                                                            )
                                                      )
                                                )
                                          )
   ...
   private static int a(ds $$0, blv $$1, float $$2, bkt $$3) throws CommandSyntaxException {
      if ($$1.a($$3, $$2)) {
