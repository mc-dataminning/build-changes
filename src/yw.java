...
public class yw implements xm {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayw.b.validate(yw::b);
   private static final Codec<Object> e = Codec.either(d, xn.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xl $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yw> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xm.a<yw> c = new xm.a<>(b, "translatable");
   private static final xq f = xq.e("%");
   private static final xq g = xq.e("null");
   ...
   @Nullable
   private ui k;
   private List<xq> l = ImmutableList.of();
   ...
   private static yw a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yw($$0, $$1.orElse(null), a($$2));
   }

   public yw(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xq> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yx var4) {
            this.l = ImmutableList.of(xq.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xq> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yx(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xq a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xl) {
            ...
            return $$1 == null ? g : xq.e($$1.toString());
         }
      } else {
         throw new yx(this, $$0);
      }
   ...
   public xz a(@Nullable ew $$0, @Nullable bui $$1, int $$2) throws CommandSyntaxException {
      ...
      return xz.a(new yw(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yw $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
