...
public class yd<B extends ByteBuf, V, T> implements ye<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<yd.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   yd(Function<V, ? extends T> $$0, List<yd.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         vx.a($$0, $$3);
         yd.b<B, V, T> $$4 = this.c.get($$3);

         try {
            ye<? super B, V> $$5 = (ye<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> yd.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new yd.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<yd.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public yd.a<B, V, T> a(T $$0, ye<? super B, ? extends V> $$1) {
         this.a.add(new yd.b<>($$1, $$0));
         return this;
      }
      ...
      public yd<B, V, T> a() {
         ...
         return new yd<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(ye<? super B, ? extends V> a, T b) {
   }
}
