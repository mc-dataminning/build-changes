...
public class yd implements wt {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = axe.b(axe.b, yd::b);
   private static final Codec<Object> e = Codec.either(d, wu.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof ws $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yd> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               axe.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, yd::a)
   );
   public static final wt.a<yd> c = new wt.a<>(b, "translatable");
   private static final wx f = wx.e("%");
   private static final wx g = wx.e("null");
   ...
   @Nullable
   private tt k;
   private List<wx> l = ImmutableList.of();
   ...
   private static yd a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yd($$0, $$1.orElse(null), a($$2));
   }

   public yd(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<wx> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (ye var4) {
            this.l = ImmutableList.of(wx.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<wx> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new ye(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private wx a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof ws) {
            ...
            return $$1 == null ? g : wx.e($$1.toString());
         }
      } else {
         throw new ye(this, $$0);
      }
   ...
   public xg a(@Nullable ec $$0, @Nullable bql $$1, int $$2) throws CommandSyntaxException {
      ...
      return xg.a(new yd(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yd $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
