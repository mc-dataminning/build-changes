...
public class fuo {
   ...
   private final wo h;
   private final fuq i;
   private final Map<ai, fuq> j = Maps.newLinkedHashMap();
   private double k;
   private double l;
   ...
   public fuo(flh $$0, fus $$1, fup $$2, int $$3, aj $$4, au $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void b(fob $$0, int $$1, int $$2) {
      if (!this.r) {
      ...
      for (int $$8 = -1; $$8 <= 15; $$8++) {
         for (int $$9 = -1; $$9 <= 8; $$9++) {
            $$0.a(gmf::H, $$3, $$6 + 16 * $$8, $$7 + 16 * $$9, 0.0F, 0.0F, 16, 16, 16, 16);
         }
      }
   ...
   @Nullable
   public static fuo a(flh $$0, fus $$1, int $$2, aj $$3) {
      Optional<au> $$4 = $$3.a().c();
      if ($$4.isEmpty()) {
         return null;
      } else {
         for (fup $$5 : fup.values()) {
            if ($$2 < $$5.a()) {
               return new fuo($$0, $$1, $$5, $$2, $$3, $$4.get());
            }
   ...
   public void a(aj $$0) {
      Optional<au> $$1 = $$0.a().c();
      if (!$$1.isEmpty()) {
         fuq $$2 = new fuq(this, this.a, $$0, $$1.get());
         this.a($$2, $$0.b());
      }
   }

   private void a(fuq $$0, ai $$1) {
      this.j.put($$1, $$0);
      int $$2 = $$0.d();
      int $$3 = $$2 + 28;
      int $$4 = $$0.c();
