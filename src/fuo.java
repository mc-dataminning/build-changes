...
public class fuo extends fuj<bvm, ffx<bvm>> {
   private static final Map<bvm.a, aez> a = ac.a(Maps.newEnumMap(bvm.a.class), $$0 -> {
      $$0.put(bvm.a.a, new aez("textures/entity/panda/panda.png"));
      $$0.put(bvm.a.b, new aez("textures/entity/panda/lazy_panda.png"));
      $$0.put(bvm.a.c, new aez("textures/entity/panda/worried_panda.png"));
      $$0.put(bvm.a.d, new aez("textures/entity/panda/playful_panda.png"));
      $$0.put(bvm.a.e, new aez("textures/entity/panda/brown_panda.png"));
      $$0.put(bvm.a.f, new aez("textures/entity/panda/weak_panda.png"));
      $$0.put(bvm.a.g, new aez("textures/entity/panda/aggressive_panda.png"));
   });

   public fuo(ftd.a $$0) {
      super($$0, new ffx<>($$0.a(fhw.az)), 0.9F);
      this.a(new fxh(this, $$0.d()));
   }

   public aez a(bvm $$0) {
      return a.getOrDefault($$0.gq(), a.get(bvm.a.a));
   }

   protected void a(bvm $$0, elj $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(asb.i($$24, $$0.dD(), $$0.dD() + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(asb.i($$26, $$0.dD(), $$0.dD() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? asb.i($$3, $$0, $$1) : $$0;
   }
}
