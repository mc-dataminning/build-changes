public abstract class fuo<T extends cuq> extends fum<T> implements fxz {
   private final fxu<?> G;
   private boolean H;

   public fuo(T $$0, fxu<?> $$1, cpv $$2, xv $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fsl G();

   private void M() {
      fsl $$0 = this.G();
      this.c(new foq($$0.a(), $$0.b(), 20, 18, fxu.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fsl $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
