...
public class fuo extends ftr {
   ...
   protected void l() {
      this.c(fny.a(xu.d, $$0 -> this.aP_()).a(this.n / 2 - 100, 196, 200, 20).a());
   }
   ...
   public void b(fnl $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(glo::B, s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }
   ...
   public static record a(List<xv> a) {
      ...
      public static fuo.a a(cxk $$0) {
         ...
         if ($$2 != null) {
            ...
            dar $$3 = $$0.a(ku.S);
            return $$3 != null ? new fuo.a($$3.a($$1).map(xv::b).toList()) : null;
         }
      }
