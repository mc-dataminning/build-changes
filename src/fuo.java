...
public enum fuo implements fgo {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fhq a(int $$0, int $$1, fuo.a $$2) {
      fhq $$3 = new fhq(fhq.a.a, $$0, $$1, false);
   ...
   private fuo(final Supplier<fhq> $$0) {
      this.c = $$0.get();
   }
