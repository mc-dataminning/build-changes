...
public abstract class fva extends fui {
   protected final dvk a;
   private dvl c;
   private final String[] d;
   private final boolean s;
   protected final dyh b;
   private int u;
   private int v;
   @Nullable
   private frl w;

   public fva(dvk $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wo.c("sign.edit"));
   }

   public fva(dvk $$0, boolean $$1, boolean $$2, wo $$3) {
      super($$3);
      this.a = $$0;
      this.c = $$0.a($$1);
      this.s = $$1;
      this.b = dqp.a($$0.m().b());
      this.d = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(wo::getString).toArray(String[]::new);
   }

   @Override
   protected void aR_() {
      this.c(fop.a(wn.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.w = new frl(() -> this.d[this.v], this::a, frl.a(this.m), frl.c(this.m), $$0 -> this.m.h.b($$0) <= this.a.c());
   }
   ...
   public void aI_() {
      gfx $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new aic(this.a.aA_(), this.s, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void c(fob var1);
   ...
   private void e(fob $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : gob.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.v && $$4 >= 0) {
            ...
            if ($$3 && $$4 < $$14.length()) {
               $$0.a($$16, $$7 - 1, $$16 + 1, $$7 + this.a.b(), axj.f($$2));
            }
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gmf.N(), $$21, $$7, $$22, $$7 + this.a.b(), -16776961);
            }
         }
      }
   }
