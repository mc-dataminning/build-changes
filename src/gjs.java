public class gjs extends glg {
   ...
   gjs(ggy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, int $$7, int $$8) {
      super($$0, $$1, $$2, $$3);
      this.j = $$4;
      this.k = $$5;
      this.l = $$6;
   ...
   public static class a implements gkj<lx> {
      ...
      public gkg a(lx $$0, ggy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjs $$8 = new gjs($$1, $$2, $$3, $$4, $$5, $$6, $$7, -12210434, -1);
         $$8.d(ayz.b($$1.C_(), 3.0F, 5.0F));
         $$8.a(this.a);
         return $$8;
      }
   }
