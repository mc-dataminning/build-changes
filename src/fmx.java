public abstract class fmx<T extends cou> extends fmw<T> implements fps {
   public final fpi D;
   private boolean E;
   private final akm F;
   private final akm G;
   ...
   public fmx(T $$0, fpi $$1, clv $$2, wx $$3, akm $$4, akm $$5, akm $$6) {
      super($$0, $$2, $$3);
      this.D = $$1;
      this.F = $$4;
      this.G = $$5;
   ...
   public void aM_() {
      ...
      this.c(new fgl(this.z + 20, this.o / 2 - 49, 20, 18, fpm.a, $$0 -> {
         this.D.e();
         this.z = this.D.a(this.n, this.c);
   ...
   protected void a(ffm $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.w.s()) {
         int $$6 = 14;
         int $$7 = ayd.f(this.w.r() * 13.0F) + 1;
         $$0.a(this.G, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = ayd.f(this.w.q() * 24.0F);
