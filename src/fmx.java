...
public class fmx extends fmu {
   ...
   fmx(fix $$0, double $$1, double $$2, double $$3, djx $$4, int $$5) {
      ...
      if ($$6.isPresent()) {
         ...
         double $$9 = $$2 - $$7.b();
         double $$10 = $$3 - $$7.c();
         this.F = this.b = (float)arw.d($$8, $$10);
         this.H = this.G = (float)arw.d($$9, Math.sqrt($$8 * $$8 + $$10 * $$10));
      }
   }

   @Override
   public void a(elt $$0, eqg $$1, float $$2) {
      float $$3 = arw.a(((float)this.s + $$2 - (float) (Math.PI * 2)) * 0.05F) * 2.0F;
      float $$4 = arw.i($$2, this.F, this.b);
      float $$5 = arw.i($$2, this.H, this.G) + (float) (Math.PI / 2);
   ...
   private void a(elt $$0, eqg $$1, float $$2, Consumer<Quaternionf> $$3) {
      ehn $$4 = $$1.b();
      float $$5 = (float)(arw.d((double)$$2, this.d, this.g) - $$4.a());
      float $$6 = (float)(arw.d((double)$$2, this.e, this.h) - $$4.b());
      float $$7 = (float)(arw.d((double)$$2, this.f, this.i) - $$4.c());
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         if ($$0.isEmpty()) {
            ...
            ehn $$3 = $$0.get();
            this.g = arw.d($$2, this.g, $$3.a());
            this.h = arw.d($$2, this.h, $$3.b());
            this.i = arw.d($$2, this.i, $$3.c());
            double $$4 = this.g - $$3.a();
            double $$5 = this.h - $$3.b();
            double $$6 = this.i - $$3.c();
            this.F = this.b;
            this.b = (float)arw.d($$4, $$6);
            this.H = this.G;
            this.G = (float)arw.d($$5, Math.sqrt($$4 * $$4 + $$6 * $$6));
         }
      }
   }

   public static class a implements flx<iz> {
      private final fmp a;
      ...
      public flu a(iz $$0, fix $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
