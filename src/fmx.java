...
public class fmx extends fnj {
   private static final long a = 2000L;
   private final aqz b;
   private long c = -1L;
   private boolean q;
   private static final Object2IntMap<dvh> r = ac.a(new Object2IntOpenHashMap(), $$0 -> {
      $$0.defaultReturnValue(0);
      $$0.put(dvh.c, 5526612);
      $$0.put(dvh.d, 10066329);
      $$0.put(dvh.e, 6250897);
      $$0.put(dvh.f, 8434258);
      $$0.put(dvh.g, 13750737);
      $$0.put(dvh.h, 7497737);
      $$0.put(dvh.i, 3159410);
      $$0.put(dvh.j, 2213376);
      $$0.put(dvh.k, 13421772);
      $$0.put(dvh.l, 16769184);
      $$0.put(dvh.m, 15884384);
      $$0.put(dvh.n, 16777215);
   });
   ...
   protected void b(flo $$0) {
      if (this.q) {
         $$0.a(fln.a, wu.c("narrator.loading.done"));
      } else {
         $$0.a(fln.a, this.m());
      }
   }
   ...
   public static void a(fhf $$0, aqz $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.d();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.e();
