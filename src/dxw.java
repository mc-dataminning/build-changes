...
public class dxw {
   ...
   private final daz p;
   private static final List<ddy> q = List.of(dea.l, dea.L, dea.i, dea.b, dea.k, dea.I, dea.K, dea.fl, dea.dP, dea.iA, dea.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ix<dbw>>> t;
   ...
   public static final Codec<dxw> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dxw::a, Function.identity());

   private static DataResult<dxw> a(dxw $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dxw(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ix<dbw>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jq.c($$0);
      int $$5 = jq.c($$1) - $$4;
   ...
   @Nullable
   public static dxw a(aqt $$0, int $$1, int $$2) {
      dsx $$3 = $$0.a($$1, $$2);
      dxw $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dtw.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<iu> a(dbs $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dsx $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayd.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dsx $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dwt.a.a)) {
         $$3 = Math.min($$0.a(dwt.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }
   ...
   private static double a(dsx $$0, io.a $$1) {
      return a($$0, (io)$$1.c(it.a)) ? 1.0 : -1.0;
   }

   private static double b(dsx $$0, io.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dsx $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ix<dbw>> b(dsx $$0, int $$1, int $$2) {
      ObjectArrayList<ix<dbw>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dsx $$0, io $$1) {
      drb $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avw.O)) {
         ...
         return $$2.a(dea.eT) || $$2.a(dea.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dxw.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dxw.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ix<dbw> var3);
   }
