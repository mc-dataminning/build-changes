...
public class dxw {
   ...
   private final Map<Character, Predicate<dxu>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dxw a(char $$0, Predicate<dxu> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dxv b() {
      return new dxv(this.c());
   }

   private Predicate<dxu>[][][] c() {
      this.d();
      Predicate<dxu>[][][] $$0 = (Predicate<dxu>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxu>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
