...
public abstract class ffd<T extends ffd<T>> {
   ...
   public ffd(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ffb.a();
         if ($$3 != null) {
         ...
         throw new fgu(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fgu(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fgu(var2.getMessage(), var2);
      }
   }
   ...
   public static ffd<?> a(String $$0) {
      return new ffd.b($$0, 5000, 60000);
   }

   public static ffd<?> a(String $$0, int $$1, int $$2) {
      return new ffd.b($$0, $$1, $$2);
   }

   public static ffd<?> b(String $$0, String $$1) {
      return new ffd.c($$0, $$1, 5000, 60000);
   }

   public static ffd<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ffd.c($$0, $$1, $$2, $$3);
   }

   public static ffd<?> b(String $$0) {
      return new ffd.a($$0, 5000, 60000);
   }

   public static ffd<?> c(String $$0, String $$1) {
      return new ffd.d($$0, $$1, 5000, 60000);
   }

   public static ffd<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ffd.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ffd<ffd.a> {
   ...
   public static class b extends ffd<ffd.b> {
   ...
   public static class c extends ffd<ffd.c> {
      ...
      public ffd.c f() {
         try {
            ...
            throw new fgu(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ffd<ffd.d> {
      private final String c;
