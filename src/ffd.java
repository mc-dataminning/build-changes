...
public class ffd extends ffn {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fja.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fhk.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fja.Q().b($$4)) {
               try {
