...
public class ffd {
   ...
   private static final Queue<ffd.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ffd.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ffd::a), ffa::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ffd::a), ffa::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ffd.a(this.b) + ", type=" + ffd.b(this.c) + ", severity=" + ffd.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
