...
public class ffd extends fes implements ffx {
   private static final fgh d = new fgh(new akf("widget/text_field"), new akf("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axi> D = ($$0x, $$1x) -> axi.forward($$0x, xp.a);
   @Nullable
   private ws E;
   private long F = ac.b();

   public ffd(fef $$0, int $$1, int $$2, ws $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public ffd(fef $$0, int $$1, int $$2, int $$3, int $$4, ws $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public ffd(fef $$0, int $$1, int $$2, int $$3, int $$4, @Nullable ffd $$5, ws $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axi> $$0) {
      this.D = $$0;
   }
   ...
   protected xg aK_() {
      ws $$0 = this.y();
      return ws.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = axw.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = axw.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fkt.s());
   }
   ...
   public void b(feh $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = axw.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gbm.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = axw.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = axw.a(this.v, 0, this.p.length());
      }
   }
