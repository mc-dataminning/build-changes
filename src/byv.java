...
public class byv extends bip implements byt {
   private static final adz<Boolean> b = aec.a(byv.class, aeb.k);
   private int c = 1;

   public byv(bim<? extends byv> $$0, cpm $$1) {
      super($$0, $$1);
      this.bJ = 5;
      this.bL = new byv.b(this);
   }

   @Override
   protected void w() {
      this.bO.a(5, new byv.d(this));
      this.bO.a(7, new byv.a(this));
      this.bO.a(7, new byv.c(this));
   ...
   private static boolean h(bhg $$0) {
      return $$0.c() instanceof ccd && $$0.d() instanceof cbn;
   }
   ...
   public static bke.a t() {
      return bja.x().a(bkf.a, 10.0).a(bkf.b, 100.0);
   }
   ...
   public static boolean b(bim<byv> $$0, cpn $$1, bjc $$2, gu $$3, aru $$4) {
         ...
         if ($$0 != null) {
            ...
            if ($$0.f(this.b) < 4096.0 && this.b.E($$0)) {
               ...
               if (this.a == 20) {
                  ...
                  ccd $$8 = new ccd($$2, this.b, $$5, $$6, $$7, this.b.q());
