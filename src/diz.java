...
public class diz {
   ...
   private final List<dix> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private diz.a l = new diz.d(5.999997E7F);
   public static final diz.c e = new diz.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(ejp $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public ht b(double $$0, double $$1, double $$2) {
      return ht.a(atm.a($$0, this.e(), this.g()), $$1, atm.a($$2, this.f(), this.h()));
   }

   public double a(bkq $$0) {
   ...
   public boolean a(bkq $$0, ejp $$1) {
      double $$2 = Math.max(atm.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (diz.a)($$0 == $$1 ? new diz.d($$1) : new diz.b($$0, $$1, $$2));
   ...
   class b implements diz.a {
      ...
      @Override
      public double a() {
         return atm.a(diz.this.a() - this.e() / 2.0, (double)(-diz.this.k), (double)diz.this.k);
      }

      @Override
      public double c() {
         return atm.a(diz.this.b() - this.e() / 2.0, (double)(-diz.this.k), (double)diz.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? atm.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public diy i() {
         return this.c < this.b ? diy.b : diy.a;
      }
      ...
      @Override
      public diz.a l() {
         return (diz.a)(this.g() <= 0L ? diz.this.new d(this.c) : this);
      }
      ...
      public ekn m() {
         return ekk.a(
            ekk.c,
            ekk.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ejy.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static diz.c a(DynamicLike<?> $$0, diz.c $$1) {
         double $$2 = atm.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = atm.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new diz.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements diz.a {
      ...
      private void n() {
         this.c = atm.a(diz.this.a() - this.b / 2.0, (double)(-diz.this.k), (double)diz.this.k);
         this.d = atm.a(diz.this.b() - this.b / 2.0, (double)(-diz.this.k), (double)diz.this.k);
         this.e = atm.a(diz.this.a() + this.b / 2.0, (double)(-diz.this.k), (double)diz.this.k);
         this.f = atm.a(diz.this.b() + this.b / 2.0, (double)(-diz.this.k), (double)diz.this.k);
         this.g = ekk.a(
            ekk.c,
            ekk.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ejy.e
