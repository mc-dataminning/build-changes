...
class bsf extends bsa {
   private static final int b = 2;
   public static final int a = 2;
   private final ToIntFunction<azh> c;

   protected bsf(bsb $$0, int $$1, ToIntFunction<azh> $$2) {
      super($$0, $$1, li.U);
      this.c = $$2;
   }
   ...
   public void a(btp $$0, int $$1, bsu.c $$2) {
      if ($$2 == bsu.c.a) {
         ...
         dby $$4 = $$0.dP();
         int $$5 = $$4.ab().c(dbu.u);
         List<ckm> $$6 = new ArrayList<>();
         $$4.a(bta.aP, $$0.cK().g(2.0), $$1x -> $$1x != $$0, $$6, $$5);
         int $$7 = a($$5, $$6.size(), $$3);
   ...
   private void a(dby $$0, double $$1, double $$2, double $$3) {
      ckm $$4 = bta.aP.a($$0);
      if ($$4 != null) {
         $$4.a(2, true);
