...
public class bsf implements bry {
   ...
   public static Set<brw> a() {
      Builder<brw> $$0 = ImmutableSet.builder();

      try {
         bsf.a $$1 = new bsf.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> brw.a("cpu#" + $$1x, brv.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(brw.a("heap MiB", brv.e, () -> (double)ad.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(brx.a.a());
      return $$0.build();
   }
   ...
   public static brw a(final LongSupplier $$0) {
      ...
      brw.d $$3 = new brw.d(2.0F);
      return brw.a("ticktime", brv.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
