...
public abstract class bsf<R extends Runnable> implements bro, bsl<R>, Executor {
   ...
   @Override
   public List<brl> bw() {
      return ImmutableList.of(brl.a(this.b + "-pending-tasks", brk.b, this::by));
   }
