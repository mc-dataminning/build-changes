...
public class bsf extends brt {
   ...
   public bsf(blh $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!bvp.a(this.a)) {
         ...
         if (this.e && this.a.dL().N()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               eji $$2 = bvr.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.b($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<ht> $$3x = $$0.w().d($$0xx -> $$0xx.a(arm.b), this::a, $$2x, 10, bvx.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<ht> $$3 = $$0.w().d($$0x -> $$0x.a(arm.b), this::a, ht.a($$2), 10, bvx.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().i();
                     ...
                     $$4.b($$5);
                     if (this.c == null) {
                        eji $$6 = bvo.a(this.a, 10, 7, eji.c(this.d), (float) (Math.PI / 2));
                        if ($$6 == null) {
                           return false;
                        }
