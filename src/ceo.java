...
public class ceo {
   ...
   @Nullable
   public static evr a(bty $$0, Supplier<iz> $$1) {
      return a($$1, $$0::d);
   }

   @Nullable
   public static evr a(Supplier<iz> $$0, ToDoubleFunction<iz> $$1) {
      ...
      return $$3 != null ? evr.c($$3) : null;
   }

   public static iz a(bty $$0, int $$1, azh $$2, iz $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.gb() && $$1 > 1) {
         iz $$6 = $$0.fY();
