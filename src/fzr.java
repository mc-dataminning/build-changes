public class fzr<T extends cgz> extends fyl<T> {
   private static final ahg f = new ahg("textures/entity/minecart.png");
   protected final fjw<T> a;
   private final fua g;

   public fzr(fym.a $$0, fmu $$1) {
      super($$0);
      this.d = 0.7F;
      this.a = new fkr<>($$0.a($$1));
      this.g = $$0.c();
   }
   ...
   public void a(T $$0, float $$1, float $$2, eqa $$3, ftg $$4, int $$5) {
      ...
      $$3.a($$7, $$8, $$9);
      double $$10 = aun.d((double)$$2, $$0.ac, $$0.dr());
      double $$11 = aun.d((double)$$2, $$0.ad, $$0.dt());
      double $$12 = aun.d((double)$$2, $$0.ae, $$0.dx());
      double $$13 = 0.3F;
      els $$14 = $$0.q($$10, $$11, $$12);
      float $$15 = aun.i($$2, $$0.O, $$0.dE());
      if ($$14 != null) {
         els $$16 = $$0.a($$10, $$11, $$12, 0.3F);
         els $$17 = $$0.a($$10, $$11, $$12, -0.3F);
         if ($$16 == null) {
            $$16 = $$14;
         }
      ...
      if ($$19 > 0.0F) {
         $$3.a(a.b.rotationDegrees(aun.a($$19) * $$19 * $$20 / 10.0F * (float)$$0.P()));
      }
      ...
      eqe $$24 = $$4.getBuffer(this.a.a(this.a($$0)));
      this.a.a($$3, $$24, $$5, ged.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$3.b();
   }
   ...
   protected void a(T $$0, float $$1, djg $$2, eqa $$3, ftg $$4, int $$5) {
      this.g.a($$2, $$3, $$4, $$5, ged.d);
   }
}
