...
public class dll extends dex {
   public static final MapCodec<dll> c = b(dll::new);
   public static final dtb d = dta.r;
   private static final Map<dbl, List<dll.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dcf $$0, ja $$1, boolean $$2) {
      List<dll.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dll.a($$1.i(), $$0.Z()));
      }
