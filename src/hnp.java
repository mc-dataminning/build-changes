...
public class hnp {
   ...
   private final fow n;
   private boolean o;
   private final fgp p = new fgp();
   private final fgq q = this.p.e();
   private final hno r;
   private final hnq s = new hnq();
   private final hng t = new hng(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hnp.a> w = new AtomicReference<>(hnp.a.c);
   private final Map<hmm, hng.a> x = Maps.newHashMap();
   private final Multimap<awo, hmm> y = HashMultimap.create();
   private final List<hmn> z = Lists.newArrayList();
   private final Map<hmm, Integer> A = Maps.newHashMap();
   private final Map<hmm, Integer> B = Maps.newHashMap();
   private final List<hnr> C = Lists.newArrayList();
   private final List<hmn> D = Lists.newArrayList();
   private final List<hmj> E = Lists.newArrayList();

   public hnp(hns $$0, fow $$1, avg $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hno($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fgo::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hnp.a.c, hnp.a.a)) {
               String $$2 = this.n.aw().c();
               af.i().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hnp.a.a, hnp.a.b);
                     }
                  ...
                  this.w.compareAndSet(hnp.a.a, hnp.a.c);
               });
            }
         }

         return this.w.compareAndSet(hnp.a.b, hnp.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hmm::s).forEach(this::c);
      this.D.clear();
      ...
      for (hmn $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            fei $$3 = new fei($$0.h(), $$0.i(), $$0.j());
            hng.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hmm, hng.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hmm, hng.a> $$6 = $$5.next();
         hng.a $$7 = $$6.getValue();
         hmm $$8 = $$6.getKey();
      ...
      Iterator<Entry<hmm, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hmm, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hmm $$13 = $$12.getKey();
            if ($$13 instanceof hmn) {
               ((hmn)$$13).q();
            }
   ...
   private static boolean d(hmm $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hmm $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hmm $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hmm $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hns.e) {
                  if ($$3 == hns.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        fei $$11 = new fei($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hmm.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hng.a> $$16 = this.t.a($$3.g() ? fgp.c.b : fgp.c.a);
                           hng.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hmm $$0) {
      return azm.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hmm $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fgo::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fgo::e));
      }
   }
   ...
   public void a(fnz $$0) {
      if (this.o && $$0.h()) {
         fgr $$1 = new fgr($$0.b(), new fei($$0.l()), new fei($$0.m()));
