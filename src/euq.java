...
public class euq {
   ...
   private euq(String $$0, @Nullable String[] $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public vs a() {
      if (!gje.a(this.c)) {
         ...
         return this.d == null ? vs.c(this.c) : vs.a(this.c, this.d);
      }
   }

   public static euq a(JsonObject $$0) {
      String $$1 = eww.a("translationKey", $$0);
