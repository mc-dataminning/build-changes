...
public class euq {
   public static List<evs> a(euq.a... $$0) {
      for (euq.a $$1 : $$0) {
         a($$1.j);
      }

      List<evs> $$2 = Lists.newArrayList();

      for (euq.a $$3 : $$0) {
         $$2.add(new evs($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(evs::a));
      return $$2;
   }
   ...
   public static List<evs> a() {
      return a(euq.a.values());
   }
