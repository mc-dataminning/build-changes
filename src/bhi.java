...
public abstract class bhi extends DataFix {
   private final String a;

   public bhi(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bgx.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bgx.B);
      Type<Pair<String, String>> $$2 = DSL.named(bgx.z.typeName(), bii.a());
      if (!Objects.equals(this.getOutputSchema().getType(bgx.z), $$2)) {
