...
public class bhi {
   ...
   private JsonElement a(List<Pair<dlh, bhs<bhk>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bhs)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dlh, bhs<bhk>> $$3 : $$0) {
         bhs<bhk> $$4 = (bhs<bhk>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dlh)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bhq> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bgy.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bhg $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bho $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bho.b $$3 = (bho.b)$$1x.getFirst();
         bho.a $$4 = (bho.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bhl> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bhl>, ToDoubleFunction<bhl>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bhl::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bhl::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bhl::c));
      return $$1;
   }
}
