...
public abstract class doi {
   ...
   public final void c(ud $$0, iz.a $$1) {
      this.a($$0, $$1);
      doi.a.a.parse($$1.a(ur.a), $$0).resultOrPartial($$0x -> d.warn("Failed to load components: {}", $$0x)).ifPresent($$0x -> this.g = $$0x);
   }
   ...
   public final ud d(iz.a $$0) {
      ud $$1 = new ud();
      this.b($$1, $$0);
      doi.a.a.encodeStart($$0.a(ur.a), this.g).resultOrPartial($$0x -> d.warn("Failed to save components: {}", $$0x)).ifPresent($$1x -> $$1.a((ud)$$1x));
      return $$1;
   }
   ...
   public static void a(ud $$0, dok<?> $$1) {
      $$0.a("id", dok.a($$1).toString());
   }

   public void a(ctq $$0, iz.a $$1) {
      ud $$2 = this.e($$1);
      this.a($$2);
      cro.a($$0, this.r(), $$2);
      $$0.a(this.s());
   ...
   @Nullable
   public static doi a(io $$0, drd $$1, ud $$2, iz.a $$3) {
      String $$4 = $$2.l("id");
      akn $$5 = akn.a($$4);
      if ($$5 == null) {
   ...
   protected static void a(daz $$0, io $$1, drd $$2) {
      $$0.q($$1);
      if (!$$2.i()) {
         $$0.c($$1, $$2.b());
      }
