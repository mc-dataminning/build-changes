public abstract class gtv<M extends gaf> extends gtn<gwo, M> {
   private final fzv a;
   private final all b;
   private final gtv.a c;

   public gtv(gqb<?, gwo, M> $$0, fzv $$1, all $$2, gtv.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   private void a(fek $$0, gix $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, gyk.d);
   }
   ...
   public void a(fek $$0, gix $$1, int $$2, gwo $$3, float $$4, float $$5) {
      ...
      if ($$6 > 0) {
         ...
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            ...
            $$0.a(azn.h($$11, $$10.b, $$10.e) / 16.0F, azn.h($$12, $$10.c, $$10.f) / 16.0F, azn.h($$13, $$10.d, $$10.g) / 16.0F);
