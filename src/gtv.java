...
public class gtv {
   ...
   public void a(final fab $$0, fyi $$1) {
      final feb $$2 = feb.Q();
      $$2.aT();
      $$2.aX().c(wx.c("mco.connect.success"));
      final String $$3 = $$1.a();
      final int $$4 = $$1.b();
      (new Thread("Realms-connect-task") {
         ...
         public void run() {
            ...
            try {
               ...
               gtv.this.d = vv.a($$0, $$2.m.az(), $$2.aP().n());
               if (gtv.this.c) {
                  return;
               }
               ...
               gtv.this.d.a(new aiu($$2.X().c(), $$2.X().b()));
               $$2.a(fxw.a($$0));
               $$2.bb().a(gbu.c.c, String.valueOf($$0.a), $$0.c);
