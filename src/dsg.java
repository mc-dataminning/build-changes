...
public abstract class dsg<O, S> {
   ...
   private static final Function<Entry<dth<?>, Comparable<?>>, String> a = new Function<Entry<dth<?>, Comparable<?>>, String>() {
      public String a(@Nullable Entry<dth<?>, Comparable<?>> $$0) {
         if ($$0 == null) {
            return "<NULL>";
         } else {
            dth<?> $$1 = $$0.getKey();
      ...
      private <T extends Comparable<T>> String a(dth<T> $$0, Comparable<?> $$1) {
         return $$0.a((T)$$1);
      }
   };
   protected final O e;
   ...
   protected dsg(O $$0, Reference2ObjectArrayMap<dth<?>, Comparable<?>> $$1, MapCodec<S> $$2) {
      this.e = $$0;
      this.b = $$1;
      this.f = $$2;
   }

   public <T extends Comparable<T>> S a(dth<T> $$0) {
   ...
   public <T extends Comparable<T>> boolean b(dth<T> $$0) {
      return this.b.containsKey($$0);
   }

   public <T extends Comparable<T>> T c(dth<T> $$0) {
   ...
   public <T extends Comparable<T>> Optional<T> d(dth<T> $$0) {
      Comparable<?> $$1 = (Comparable<?>)this.b.get($$0);
      return $$1 == null ? Optional.empty() : Optional.of($$0.g().cast($$1));
   }

   public <T extends Comparable<T>, V extends T> S a(dth<T> $$0, V $$1) {
   ...
   public <T extends Comparable<T>, V extends T> S b(dth<T> $$0, V $$1) {
      Comparable<?> $$2 = (Comparable<?>)this.b.get($$0);
   ...
   public void a(Map<Map<dth<?>, Comparable<?>>, S> $$0) {
      if (this.g != null) {
         throw new IllegalStateException();
      } else {
         Table<dth<?>, Comparable<?>, S> $$1 = HashBasedTable.create();
         ObjectIterator var3 = this.b.entrySet().iterator();

         while (var3.hasNext()) {
            Entry<dth<?>, Comparable<?>> $$2 = (Entry<dth<?>, Comparable<?>>)var3.next();
            dth<?> $$3 = $$2.getKey();
         ...
         this.g = (Table<dth<?>, Comparable<?>, S>)($$1.isEmpty() ? $$1 : ArrayTable.create($$1));
      }
   }

   private Map<dth<?>, Comparable<?>> c(dth<?> $$0, Comparable<?> $$1) {
      Map<dth<?>, Comparable<?>> $$2 = new Reference2ObjectArrayMap(this.b);
      $$2.put($$0, $$1);
      return $$2;
   }
   ...
   protected static <O, S extends dsg<O, S>> Codec<S> a(Codec<O> $$0, Function<O, S> $$1) {
