...
public class dsg extends drt<dtq> {
   public dsg(Codec<dtq> $$0) {
      super($$0);
   }

   @Override
   public boolean a(drv<dtq> $$0) {
      hx $$1 = $$0.e();
      cuj $$2 = $$0.b();
      $$1 = new hx($$1.u(), $$0.c().e(), $$1.w());
      auu $$3 = $$0.d();
      boolean $$4 = $$3.j() > 0.7;
      djg $$5 = $$0.f().b;
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? aun.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(auu $$0, ctp $$1, int $$2, int $$3, hx $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, hx $$2, ctp $$3, boolean $$4, double $$5, hx $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(ctp $$0, hx $$1) {
      if ($$0.a_($$1.c()).a(cwr.dN)) {
         this.a($$0, $$1.c(), cwr.a.o());
      }
   }

   private void a(ctp $$0, auu $$1, hx $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, djg $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, hx.b, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, hx.b, $$7, $$1);
      if ($$14 < 0.0) {
         hx $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(hx $$0, ctp $$1, auu $$2, int $$3, int $$4, boolean $$5, boolean $$6, djg $$7) {
      djg $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cwr.dP) || $$8.a(cwr.dO) || $$8.a(cwr.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cwr.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cwr.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, hx $$2, int $$3, auu $$4) {
      float $$5 = 10.0F * aun.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, hx $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(auu $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(auu $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(djg $$0) {
      return $$0.a(cwr.iC) || $$0.a(cwr.dP) || $$0.a(cwr.mW);
   }

   private boolean a(csu $$0, hx $$1) {
      return $$0.a_($$1.d()).i();
   }

   private void a(ctp $$0, hx $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cwr.dN)) {
                  if (this.a((csu)$$0, $$10)) {
                     this.a($$0, $$10, cwr.a.o());
                     this.a($$0, $$10.c(), cwr.a.o());
                  } else if (c($$11)) {
                     djg[] $$12 = new djg[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
