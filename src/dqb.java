...
public class dqb implements dpx, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final blw<bly.b> c;
   private final dqg d;
   private final Map<cwi, dqb.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dqb(dqi $$0, Path $$1, boolean $$2) {
      this.d = new dqg($$0, $$1, $$2);
      this.c = new blw<>(new bly.a(dqb.b.values().length), ac.g(), "IOWorker-" + $$0.c());
   }

   public boolean a(cwi $$0, int $$1) {
      cwi $$2 = new cwi($$0.e - $$1, $$0.f - $$1);
      cwi $$3 = new cwi($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(cwi $$0, @Nullable ta $$1) {
      return this.a(() -> {
         dqb.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dqb.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(cwi $$0, tu $$1) {
      return this.a(() -> {
         try {
            dqb.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bly.b(dqb.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cwi, dqb.a>> $$0 = this.e.entrySet().iterator();
         Entry<cwi, dqb.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bly.b(dqb.b.b.ordinal(), this::a));
   }

   private void a(cwi $$0, dqb.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bly.b(dqb.b.c.ordinal(), () -> $$0.a(axy.a))).join();
         this.c.close();
