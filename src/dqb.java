...
public class dqb implements dqa {
   ...
   public static final Codec<dqb> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dkp.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dkr.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dkq.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bgd.b(1, 20).fieldOf("outer_wall_distance").orElse(bgj.a(4, 5)).forGetter($$0x -> $$0x.i),
               bgd.b(1, 20).fieldOf("distribution_points").orElse(bgj.a(3, 4)).forGetter($$0x -> $$0x.j),
               bgd.b(0, 10).fieldOf("point_offset").orElse(bgj.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dqb(dkp $$0, dkr $$1, dkq $$2, double $$3, double $$4, boolean $$5, bgd $$6, bgd $$7, bgd $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
