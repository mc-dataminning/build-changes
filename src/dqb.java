...
public class dqb {
   ...
   private final ctz p;
   private static final List<cwy> q = List.of(cxa.l, cxa.L, cxa.i, cxa.b, cxa.k, cxa.I, cxa.K, cxa.fl, cxa.dP, cxa.iA, cxa.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ih<cuw>>> t;
   ...
   public static final Codec<dqb> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dqb::a, Function.identity());

   private static DataResult<dqb> a(dqb $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dqb(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ih<cuw>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = iz.c($$0);
      int $$5 = iz.c($$1) - $$4;
   ...
   @Nullable
   public static dqb a(anl $$0, int $$1, int $$2) {
      dll $$3 = $$0.a($$1, $$2);
      dqb $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dlq.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<id> a(cus $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dll $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, aup.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dll $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(doy.a.a)) {
         $$3 = Math.min($$0.a(doy.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }
   ...
   private static double a(dll $$0, hx.a $$1) {
      return a($$0, (hx)$$1.c(ic.a)) ? 1.0 : -1.0;
   }

   private static double b(dll $$0, hx.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dll $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ih<cuw>> b(dll $$0, int $$1, int $$2) {
      ObjectArrayList<ih<cuw>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dll $$0, hx $$1) {
      djp $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(asi.O)) {
         ...
         return $$2.a(cxa.eT) || $$2.a(cxa.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dqb.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dqb.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ih<cuw> var3);
   }
