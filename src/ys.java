...
public class ys implements xi {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ays.b.validate(ys::b);
   private static final Codec<Object> e = Codec.either(d, xj.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xh $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<ys> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xi.a<ys> c = new xi.a<>(b, "translatable");
   private static final xm f = xm.e("%");
   private static final xm g = xm.e("null");
   ...
   @Nullable
   private ue k;
   private List<xm> l = ImmutableList.of();
   ...
   private static ys a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new ys($$0, $$1.orElse(null), a($$2));
   }

   public ys(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xm> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yt var4) {
            this.l = ImmutableList.of(xm.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xm> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yt(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xm a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xh) {
            ...
            return $$1 == null ? g : xm.e($$1.toString());
         }
      } else {
         throw new yt(this, $$0);
      }
   ...
   public xv a(@Nullable ev $$0, @Nullable btz $$1, int $$2) throws CommandSyntaxException {
      ...
      return xv.a(new ys(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ys $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
