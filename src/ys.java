...
public class ys<B extends ByteBuf, V, T> implements yt<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<ys.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   ys(Function<V, ? extends T> $$0, List<ys.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         wm.a($$0, $$3);
         ys.b<B, V, T> $$4 = this.c.get($$3);

         try {
            yt<? super B, V> $$5 = (yt<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> ys.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new ys.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<ys.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public ys.a<B, V, T> a(T $$0, yt<? super B, ? extends V> $$1) {
         this.a.add(new ys.b<>($$1, $$0));
         return this;
      }
      ...
      public ys<B, V, T> a() {
         ...
         return new ys<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(yt<? super B, ? extends V> a, T b) {
   }
}
