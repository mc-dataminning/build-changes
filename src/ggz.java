...
public class ggz extends gho {
   private static final float a = 1.0472F;
   private int b;

   ggz(gdh $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements ggr<lv> {
      private final ghj a;
      ...
      public ggo a(lv $$0, gdh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ggz $$8 = new ggz($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
