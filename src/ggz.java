...
public class ggz {
   private static final ghq a = ghq.t(alc.b("textures/map/map_background.png"));
   private static final ghq b = ghq.t(alc.b("textures/map/map_background_checkerboard.png"));
   ...
   private final fil au;
   private final gwk av = new gwk();
   private cvp aw = cvp.k;
   private cvp ax = cvp.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gnh aC;
   private final goh aD;

   public ggz(fil $$0, gnh $$1, goh $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(buk $$0, cvp $$1, cvm $$2, boolean $$3, fde $$4, ghg $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dS(), $$6, gws.d, $$0.ap() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = azd.a($$1, 0.0F, 1.0F);
      return -azd.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(fde $$0, ghg $$1, int $$2, bue $$3) {
      gso $$4 = (gso)this.aC.<gfz>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bue.b ? 1.0F : -1.0F;
      ...
      alc $$6 = this.au.t.b().a();
      if ($$3 == bue.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cnv.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cnv.c));
      }

      $$0.b();
   }

   private void a(fde $$0, ghg $$1, int $$2, float $$3, bue $$4, float $$5, cvp $$6) {
      float $$7 = $$4 == bue.b ? 1.0F : -1.0F;
      ...
      float $$8 = azd.c($$5);
      float $$9 = azd.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * azd.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * azd.a($$5 * (float) Math.PI);
   ...
   private void a(fde $$0, ghg $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = azd.c($$5);
      float $$7 = -0.2F * azd.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * azd.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = azd.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.aw);
   }

   private void a(fde $$0, ghg $$1, int $$2, cvp $$3) {
      ...
      esh $$4 = $$3.a(kr.G);
      esj $$5 = cwc.a($$4, this.au.s);
      fdi $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fde $$0, ghg $$1, int $$2, float $$3, float $$4, bue $$5) {
      boolean $$6 = $$5 != bue.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azd.c($$4);
      float $$9 = -0.3F * azd.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * azd.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * azd.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = azd.a($$4 * $$4 * (float) Math.PI);
      float $$13 = azd.a($$8 * (float) Math.PI);
      ...
      gso $$15 = (gso)this.aC.<gfz>a($$14);
      alc $$16 = $$14.b().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cnv.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cnv.c));
      }
   }

   private void a(fde $$0, float $$1, bue $$2, cvp $$3, cnu $$4) {
      float $$5 = (float)$$4.fy() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((buk)$$4);
      if ($$6 < 0.8F) {
         float $$7 = azd.e(azd.b($$5 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$7, 0.0F);
      }
   ...
   private void a(fde $$0, float $$1, bue $$2, cvp $$3, cnu $$4, float $$5) {
      this.b($$0, $$2, $$5);
      ...
      float $$12 = -15.0F;
      int $$13 = 2;
      float $$14 = -15.0F + 75.0F * azd.b($$8 * 2.0F * (float) Math.PI);
      if ($$2 != bue.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(fde $$0, bue $$1, float $$2) {
      int $$3 = $$1 == bue.b ? 1 : -1;
      float $$4 = azd.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = azd.a(azd.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(fde $$0, bue $$1, float $$2) {
      int $$3 = $$1 == bue.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fde $$1, ghg.a $$2, ggc $$3, int $$4) {
      float $$5 = $$3.D($$0);
      bro $$6 = (bro)MoreObjects.firstNonNull($$3.aF, bro.a);
      float $$7 = $$3.j($$0);
      ggz.a $$8 = a($$3);
      float $$9 = azd.h($$0, $$3.cE, $$3.cC);
      float $$10 = azd.h($$0, $$3.cD, $$3.cB);
      $$1.a(a.b.rotationDegrees(($$3.h($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.i($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bro.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azd.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, bro.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bro.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azd.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, bro.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static ggz.a a(ggc $$0) {
      cvp $$1 = $$0.eW();
      cvp $$2 = $$0.eX();
      boolean $$3 = $$1.a(cvt.ow) || $$2.a(cvt.ow);
      boolean $$4 = $$1.a(cvt.vX) || $$2.a(cvt.vX);
      if (!$$3 && !$$4) {
         return ggz.a.a;
      } else if ($$0.fv()) {
         return b($$0);
      } else {
         return a($$1) ? ggz.a.b : ggz.a.a;
      }
   }

   private static ggz.a b(ggc $$0) {
      cvp $$1 = $$0.fx();
      bro $$2 = $$0.fw();
      if (!$$1.a(cvt.ow) && !$$1.a(cvt.vX)) {
         return $$2 == bro.a && a($$0.eX()) ? ggz.a.b : ggz.a.a;
      } else {
         return ggz.a.a($$2);
      }
   }
   ...
   private static boolean a(cvp $$0) {
      return $$0.a(cvt.vX) && cud.g($$0);
   }

   private void a(gfz $$0, float $$1, float $$2, bro $$3, float $$4, cvp $$5, float $$6, fde $$7, ghg $$8, int $$9) {
      if (!$$0.gA()) {
         boolean $$10 = $$3 == bro.a;
         bue $$11 = $$10 ? $$0.fu() : $$0.fu().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cm()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fv() && $$0.fy() > 0 && $$0.fw() == $$3) {
               ...
               float $$15 = (float)$$5.a((buk)$$0) - ((float)$$0.fy() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cud.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = azd.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * azd.a(azd.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * azd.a(azd.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * azd.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cvm.e : cvm.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bue.b;
            if ($$0.fv() && $$0.fy() > 0 && $$0.fw() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((buk)$$0) - ((float)$$0.fy() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((buk)$$0) - ((float)$$0.fy() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * azd.a(azd.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * azd.a(azd.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * azd.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cvm.e : cvm.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.C()) {
         this.ay = azd.a(this.ay - 0.4F, 0.0F, 1.0F);
         this.aA = azd.a(this.aA - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.H(1.0F);
         this.ay = this.ay + azd.a((this.aw == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + azd.a((float)(this.ax == $$2 ? 1 : 0) - this.aA, -0.4F, 0.4F);
      }
