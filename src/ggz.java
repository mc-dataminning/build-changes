...
public interface ggz {
   static ggz a(ghf $$0, UserApiService $$1) {
      return new ggz.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, ghh var2, AbuseReport var3);
   ...
   public static record b(ghf a, UserApiService b) implements ggz {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, ghh $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               wp $$5 = this.a(var7);
               throw new CompletionException(new ggz.a($$5, var7));
            } catch (MinecraftClientException var8) {
               wp $$7 = this.a(var8);
               throw new CompletionException(new ggz.a($$7, var8));
            }
         }, af.h());
      }
