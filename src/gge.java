...
public class gge implements gfw.a {
   private final Map<Integer, eni> a = Maps.newHashMap();
   ...
   public void a(int $$0, eni $$1, float $$2) {
      this.a.put($$0, $$1);
      this.c.put($$0, ac.c());
      this.b.put($$0, $$2);
   }
   ...
   public static void a(eys $$0, gck $$1, eni $$2, float $$3, boolean $$4, boolean $$5, double $$6, double $$7, double $$8) {
   ...
   public static void a(eys $$0, eyw $$1, eni $$2, double $$3, double $$4, double $$5) {
      for (int $$6 = 0; $$6 < $$2.e(); $$6++) {
         eng $$7 = $$2.a($$6);
         if (!(a($$7.a(), $$3, $$4, $$5) > 80.0F)) {
            float $$8 = (float)$$6 / (float)$$2.e() * 0.33F;
            int $$9 = $$6 == 0 ? 0 : ayd.h($$8, 0.9F, 0.9F);
            int $$10 = $$9 >> 16 & 0xFF;
            int $$11 = $$9 >> 8 & 0xFF;
            int $$12 = $$9 & 0xFF;
