...
public class gge<T extends hcw> extends gfq<T> implements geh, gga {
   public static final gjd i = new gem(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public gge(giu $$0, Function<alg, gqc> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gjc a(giy $$0, float $$1) {
      gjc $$2 = new gjc();
      gje $$3 = $$2.a();
      gje $$4 = $$3.a("head", giz.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), giw.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", giz.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), giw.a);
      $$3.a("body", giz.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), giw.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", giz.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), giw.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", giz.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), giw.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", giz.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), giw.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", giz.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), giw.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }
   ...
   public void a(T $$0) {
      ...
      if ($$2 != gge.a.h) {
         gef.a(this.r, $$0.u, 1.0F);
      }

      if ($$1 != gge.a.h) {
         gef.a(this.s, $$0.u, -1.0F);
      }

      if ($$3 > 0.0F) {
         float $$10 = $$5 % 26.0F;
         bwv $$11 = $$0.L;
         float $$12 = $$11 == bwv.b && $$0.H > 0.0F ? 0.0F : $$3;
         float $$13 = $$11 == bwv.a && $$0.H > 0.0F ? 0.0F : $$3;
         if (!$$0.R) {
            if ($$10 < 14.0F) {
   ...
   private void a(T $$0, gge.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gef.a(this.r, this.s, $$0.J, $$0.K, true);
            break;
         case g:
            gef.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, gge.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gef.a(this.r, this.s, $$0.J, $$0.K, false);
            break;
         case g:
            gef.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   private void a(giu $$0, boolean $$1) {
   ...
   protected giu a(bwv $$0) {
      return $$0 == bwv.a ? this.s : this.r;
   }
