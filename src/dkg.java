...
public class dkg {
   ...
   private final List<dke> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dkg.a l = new dkg.d(5.999997E7F);
   public static final dkg.c e = new dkg.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public hv b(double $$0, double $$1, double $$2) {
      return hv.a(aty.a($$0, this.e(), this.g()), $$1, aty.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(blf $$0, ekw $$1) {
      double $$2 = Math.max(aty.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dkg.a)($$0 == $$1 ? new dkg.d($$1) : new dkg.b($$0, $$1, $$2));
   ...
   class b implements dkg.a {
      ...
      @Override
      public double a() {
         return aty.a(dkg.this.a() - this.e() / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
      }

      @Override
      public double c() {
         return aty.a(dkg.this.b() - this.e() / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? aty.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dkf i() {
         return this.c < this.b ? dkf.b : dkf.a;
      }
      ...
      @Override
      public dkg.a l() {
         return (dkg.a)(this.g() <= 0L ? dkg.this.new d(this.c) : this);
      }
      ...
      public elu m() {
         return elr.a(
            elr.c,
            elr.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            elf.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dkg.c a(DynamicLike<?> $$0, dkg.c $$1) {
         double $$2 = aty.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = aty.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dkg.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dkg.a {
      ...
      private void n() {
         this.c = aty.a(dkg.this.a() - this.b / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
         this.d = aty.a(dkg.this.b() - this.b / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
         this.e = aty.a(dkg.this.a() + this.b / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
         this.f = aty.a(dkg.this.b() + this.b / 2.0, (double)(-dkg.this.k), (double)dkg.this.k);
         this.g = elr.a(
            elr.c,
            elr.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            elf.e
