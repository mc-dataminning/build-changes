...
public final class dkg {
   ...
   private static final Codec<dhk> e = jb.o
      .q()
   ...
   private static final Set<aev<cqt>> f = Set.of(cra.aa, cra.Z, cra.ab);
   ...
   public static cqw a(cqw $$0, dhf $$1) {
      if (!$$1.y()) {
         ...
         Predicate<aev<cqt>> $$2 = f::contains;
         return ($$3, $$4, $$5, $$6) -> {
            he<cqt> $$7 = $$0.getNoiseBiome($$3, $$4, $$5, $$6);
