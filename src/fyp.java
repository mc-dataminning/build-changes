...
public abstract class fyp<T extends blv, M extends fiy<T>> extends fxn<T> implements fzj<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gbz<T, M>> g = Lists.newArrayList();

   public fyp(fxo.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gbz<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, epd $$3, fsi $$4, int $$5) {
      ...
      this.f.d = $$0.bO();
      this.f.e = $$0.o_();
      float $$6 = aty.j($$2, $$0.aV, $$0.aU);
      float $$7 = aty.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bO() && $$0.cZ() instanceof blv $$9) {
         $$6 = aty.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = aty.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected fsq a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      agt $$4 = this.a($$0);
      if ($$2) {
         return fsq.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? fsq.r($$4) : null;
      }
   }

   public static int c(blv $$0, float $$1) {
      return gdf.a(gdf.a($$1), gdf.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return euk.J() && $$0 != $$3.al() && $$5 && !$$0.bP();
      }
   }

   public static boolean e(blv $$0) {
      if ($$0 instanceof cer || $$0.ae()) {
         String $$1 = n.a($$0.ad().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cer) || ((cer)$$0).a(ces.a);
         }
      }
