...
public class fyp {
   ...
   private fyp(int $$0, List<fyr> $$1) {
      this.a = $$1.toArray(fyr[]::new);
      this.b = $$1.size();
   }

   private List<fyr> c() {
      List<fyr> $$0 = new ArrayList<>(this.d());
