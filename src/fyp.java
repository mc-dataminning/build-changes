...
public class fyp extends fvi {
   private static final int a = 20;
   private static final int b = 5;
   private static final int c = 20;
   private final wp d;
   private final List<wp> s;
   private final ImmutableList<fyp.a> u;
   private fqj v = fqj.a;
   private int w;
   private int x;

   protected fyp(wp $$0, List<wp> $$1, ImmutableList<fyp.a> $$2) {
      super($$0);
      this.s = $$1;
   ...
   public void aR_() {
      ...
      while ($$1.hasNext()) {
         fyp.a $$0 = (fyp.a)$$1.next();
         this.x = Math.max(this.x, 20 + this.p.a($$0.a) + 20);
      }

      int $$1x = 5 + this.x + 5;
      int $$2 = $$1x * this.u.size();
      this.v = fqj.a(this.p, $$2, this.s.toArray(new wp[0]));
      int $$3 = this.v.a() * 9;
      ...
      for (UnmodifiableIterator var6 = this.u.iterator(); var6.hasNext(); $$5 += $$1x) {
         fyp.a $$6 = (fyp.a)var6.next();
         this.c(fpq.a($$6.a, $$6.b).a($$5, $$4, this.x, 20).a());
      }
   }
