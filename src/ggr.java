...
public class ggr extends giu<chw, frw> {
   public static final akm a = new akm("textures/entity/armorstand/wood.png");
   ...
   protected void a(chw $$0, eys $$1, float $$2, float $$3, float $$4, float $$5) {
      $$1.a(a.d.rotationDegrees(180.0F - $$3));
      float $$6 = (float)($$0.dP().Y() - $$0.bN) + $$4;
      if ($$6 < 5.0F) {
         $$1.a(a.d.rotationDegrees(ayd.a($$6 / 1.5F * (float) Math.PI) * 3.0F));
      }
   }
   ...
   @Nullable
   protected gcs a(chw $$0, boolean $$1, boolean $$2, boolean $$3) {
      if (!$$0.z()) {
