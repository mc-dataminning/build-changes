public class fcs extends fbo<bwh> {
   private final fee a;
   private final fee b;
   private final fee f;
   private final fee g;
   ...
   public static fek b() {
      ...
      fen $$4 = $$3.a(
         "head", fej.c().a(0, 0).a(-8.0F, -20.0F, -14.0F, 16.0F, 20.0F, 16.0F).a(0, 0).a(-2.0F, -6.0F, -18.0F, 4.0F, 8.0F, 4.0F), feg.a(0.0F, 16.0F, -17.0F)
      );
      ...
      $$1.a(
         "body",
         fej.c().a(0, 55).a(-7.0F, -10.0F, -7.0F, 14.0F, 16.0F, 20.0F).a(0, 91).a(-6.0F, 6.0F, -7.0F, 12.0F, 13.0F, 18.0F),
         feg.a(0.0F, 1.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
      );
   ...
   public void a(bwh $$0, float $$1, float $$2, float $$3) {
      ...
      if ($$7 > 0) {
         ...
         if ($$7 > 5) {
            this.f.e = apa.a(((float)(-4 + $$7) - $$3) / 4.0F) * (float) Math.PI * 0.4F;
         } else {
            this.f.e = (float) (Math.PI / 20) * apa.a((float) Math.PI * ((float)$$7 - $$3) / 10.0F);
         }
      } else {
         float $$14 = -1.0F;
