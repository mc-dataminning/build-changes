...
public abstract class fcs {
   ...
   public fbt a() {
      if (this.c()) {
         ...
         return new fbt(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
      }
   }

   public fcs b() {
      return this.c() ? fcp.a() : fcp.a(this.b(jm.a.a), this.b(jm.a.b), this.b(jm.a.c), this.c(jm.a.a), this.c(jm.a.b), this.c(jm.a.c));
   }
   ...
   public fcs a(double $$0, double $$1, double $$2) {
      return (fcs)(this.c() ? fcp.a() : new fca(this.a, new fco(this.a(jm.a.a), $$0), new fco(this.a(jm.a.b), $$1), new fco(this.a(jm.a.c), $$2)));
   }

   public fcs d() {
      fcs[] $$0 = new fcs[]{fcp.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fcp.b($$0[0], fcp.a($$1, $$2, $$3, $$4, $$5, $$6), fcc.o));
      return $$0[0];
   }
   ...
   public List<fbt> e() {
      List<fbt> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fbt($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jm.a.a, $$4.d - (double)$$2.u()), this.a(jm.a.b, $$4.e - (double)$$2.v()), this.a(jm.a.c, $$4.f - (double)$$2.w()))
               ? new fbu($$4, jm.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fbt.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fby> b(fby $$0) {
      if (this.c()) {
   ...
   public fcs a(jm $$0) {
      if (!this.c() && this != fcp.b()) {
         if (this.b != null) {
            fcs $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private fcs b(jm $$0) {
      ...
      if (this.d($$1)) {
         ...
         fcq $$4 = new fcq(this, $$1, $$3);
         if ($$4.c()) {
            return fcp.a();
         } else {
            return (fcs)($$4.f() ? fcp.b() : $$4);
         }
      }
   }
   ...
   public double a(jm.a $$0, fbt $$1, double $$2) {
      return this.a(je.a($$0, jm.a.a), $$1, $$2);
   }

   protected double a(je $$0, fbt $$1, double $$2) {
      if (this.c()) {
         return $$2;
