...
public class fcs extends gvh {
   ...
   public fcs(fne $$0, fbw $$1, String $$2, BooleanConsumer $$3) {
      super(fey.a);
      this.Z = $$3;
      this.E = $$0;
      this.J = $$2;
   ...
   private void E() {
      if (!this.Q) {
         if (!this.Y && this.a(this.F.a) >= 5368709120L) {
            xp $$0 = xp.a("mco.download.confirmation.line1", fal.b(5368709120L));
   ...
   private xp F() {
      ...
      if (this.N != null) {
         ...
         $$0.add(xp.a("mco.download.speed.narration", fal.b(this.U)));
      }
   ...
   private void a(fgs $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.p, xp.a("mco.download.speed", fal.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
