...
public class fcs extends eyk {
   private static final aew c = new aew("social_interactions/background");
   private static final aew k = new aew("icon/search");
   ...
   protected void aH_() {
      ...
      int $$4 = 64 + this.l();
      int $$5 = (this.g - $$3) / 2 + 3;
      this.I = this.d(esq.a(l, $$0x -> this.a(fcs.a.a)).a($$1, 45, $$0, 20).a());
      ...
      this.F = new esz(this.i, this.E() + 28, 74, 200, 15, s) {
         @Override
         protected ty aE_() {
            return !fcs.this.F.a().isEmpty() && fcs.this.E.d() ? super.aE_().f(", ").b(fcs.t) : super.aE_();
         }
      };
      this.F.l(16);
      this.F.g(true);
      ...
      this.e(this.F);
      this.e(this.E);
      this.L = this.d(esq.a(w, $$0x -> this.f.a(new exc($$0xx -> {
            if ($$0xx) {
