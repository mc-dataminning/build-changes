public interface cxk {
   int a = 256;
   float b = 7.0F;
   aly<cxi> c = a("ponder_goat_horn");
   aly<cxi> d = a("sing_goat_horn");
   aly<cxi> e = a("seek_goat_horn");
   aly<cxi> f = a("feel_goat_horn");
   aly<cxi> g = a("admire_goat_horn");
   aly<cxi> h = a("call_goat_horn");
   aly<cxi> i = a("yearn_goat_horn");
   aly<cxi> j = a("dream_goat_horn");

   private static aly<cxi> a(String $$0) {
      return aly.a(mb.I, alz.b($$0));
   }

   static void a(rk<cxi> $$0) {
   ...
   static void a(rk<cxi> $$0, aly<cxi> $$1, jq<axe> $$2, float $$3, float $$4) {
      yj $$5 = xv.c(ae.a("instrument", $$1.a()));
      $$0.a($$1, new cxi($$2, $$3, $$4, $$5));
   }
}
