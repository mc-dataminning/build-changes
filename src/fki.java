...
public class fki {
   ...
   public yi a(xq $$0, int $$1) {
      fki.e $$2 = new fki.e((float)$$1);
      return $$0.<yi>a(($$1x, $$2x) -> bai.c($$2x, $$1x, $$2) ? Optional.empty() : Optional.of($$1x), yi.a).orElse(null);
   }

   @Nullable
   public yi a(ayz $$0, int $$1) {
      fki.e $$2 = new fki.e((float)$$1);
   ...
   public xq a(xq $$0, int $$1, yi $$2) {
      final fki.e $$3 = new fki.e((float)$$1);
      return $$0.a(new xq.b<xq>() {
         private final fjl b = new fjl();
   ...
   public void a(String $$0, int $$1, yi $$2, boolean $$3, fki.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      yi $$7 = $$2;

      while ($$5 < $$6) {
         fki.b $$8 = new fki.b((float)$$1);
         boolean $$9 = bai.a($$0, $$5, $$7, $$2, $$8);
         if ($$9) {
            $$4.accept($$7, $$5, $$6);
            break;
         }
   ...
   public void a(xq $$0, int $$1, yi $$2, BiConsumer<xq, Boolean> $$3) {
      List<fki.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new fki.c($$2x, $$1x));
         }
      ...
      while ($$6) {
         $$6 = false;
         fki.b $$9 = new fki.b((float)$$1);

         for (fki.c $$10 : $$5.a) {
            boolean $$11 = bai.a($$10.c, 0, $$10.d, $$2, $$9);
            if (!$$11) {
               int $$12 = $$9.a();
               yi $$13 = $$9.b();
               char $$14 = $$5.a($$12);
   ...
   static class a {
      ...
      public xq a(int $$0, int $$1, yi $$2) {
         fjl $$3 = new fjl();
         ListIterator<fki.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, yi $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = fki.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements aza {
      ...
      @Override
      public boolean accept(int $$0, yi $$1, int $$2) {
         this.b = this.b - fki.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
