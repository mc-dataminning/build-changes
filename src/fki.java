...
public final class fki {
   ...
   private static final fki c = new fki(HostAndPort.fromParts("server.invalid", 25565));

   public fki(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fki(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fki a(String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            return $$1.getHost().isEmpty() ? c : new fki($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fki ? this.b.equals(((fki)$$0).b) : false;
      }
   }
