...
public class fki {
   ...
   private static final Map<dzw.a, String> e = ad.a(new EnumMap<>(dzw.a.class), $$0 -> {
      $$0.put(dzw.a.a, "SW");
      $$0.put(dzw.a.b, "S");
      $$0.put(dzw.a.c, "OW");
      $$0.put(dzw.a.d, "O");
   ...
   private dwg l;
   @Nullable
   private CompletableFuture<dwg> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bmk r = new bmk(1);
   private final bmk s = new bmk(bmp.values().length);
   private final bmk t = new bmk(1);
   private final bmk u = new bmk(1);
   private final Map<bml, bmk> v = Map.of(bml.a, this.s);
   private final flr w;
   private final flu x;
   private final fls y;
   private final flq z;
   ...
   public fki(fib $$0) {
      ...
      this.g = new fki.a();
      this.h = $$0.h;
      this.w = new flr(this.h, this.r);
      this.x = new flu(this.h, this.s, () -> $$0.s.s().g());
      this.y = new fls(this.h, this.t);
      this.z = new flq(this.h, this.u);
      this.A = new flt(this.h);
   }
   ...
   private void a(fjn $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         dds $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arg ? ((arg)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.an().dx(), this.f.an().dz(), this.f.an().dD()));
         $$25.add(String.format(Locale.ROOT, "Block: %d %d %d [%d %d %d]", $$14.u(), $$14.v(), $$14.w(), $$14.u() & 15, $$14.v() & 15, $$14.w() & 15));
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, kg.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azc.g($$15.dI()), azc.g($$15.dK())));
         dwg $$27 = this.u();
         if ($$27.B()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(deb.a, $$14);
            int $$30 = this.f.s.a(deb.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dwg $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dzw.a $$33 : dzw.a.values()) {
               if ($$33.b()) {
            ...
            $$25.add($$32.toString());
            if ($$14.v() >= this.f.s.G_() && $$14.v() < this.f.s.an()) {
               $$25.add("Biome: " + a(this.f.s.t($$14)));
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.t();
                  bri $$37 = new bri($$23.am(), $$23.ab(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            ded.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bui> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bui.values())
         ...
         $$25.add(this.f.aj().j() + String.format(Locale.ROOT, " (Mood %d%%)", Math.round(this.f.t.c() * 100.0F)));
         return $$25;
      }
   }

   private static String a(jn<det> $$0) {
   ...
   private dds s() {
      return (dds)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ag()))), this.f.s);
   }
   ...
   private dwg t() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dwx.n, false).thenApply($$0x -> (dwg)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fbi.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fib.Q().aO().l(), fib.Q().aO().m(), fbi.a()),
            fbi.c(),
            fbi.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == eyc.a.b) {
            ...
            $$4.add(String.valueOf(lu.e.b($$6.b())));

            for (Entry<dvd<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == eyc.a.b) {
            ...
            $$4.add(String.valueOf(lu.c.b($$9.a())));

            for (Entry<dvd<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lu.f.b($$11.ao())));
         }
   ...
   private String a(Entry<dvd<?>, Comparable<?>> $$0) {
      dvd<?> $$1 = $$0.getKey();
