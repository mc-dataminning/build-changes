...
public class eva extends gnd {
   ...
   public eva(ffl $$0, eue $$1, String $$2, BooleanConsumer $$3) {
      super(exg.a);
      this.T = $$3;
      this.y = $$0;
      this.D = $$2;
   ...
   private void E() {
      if (!this.K) {
         if (!this.S && this.a(this.z.a) >= 5368709120L) {
            vq $$0 = vq.a("mco.download.confirmation.line1", est.b(5368709120L));
   ...
   private vq H() {
      ...
      if (this.H != null) {
         ...
         $$0.add(vq.a("mco.download.speed.narration", est.b(this.O)));
      }
   ...
   private void a(ezb $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, vq.a("mco.download.speed", est.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
