...
public class eva {
   ...
   private static final Queue<eva.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eva.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eva::a), euy::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eva::a), euy::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eva.a(this.b) + ", type=" + eva.b(this.c) + ", severity=" + eva.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
