...
public class eva {
   ...
   private final etd i;
   private final asc<String> j = new asc<>(100);
   private final List<esx> k = Lists.newArrayList();
   private final List<esx.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<eva.a> o = new ArrayList<>();
   ...
   public void a(euo $$0, int $$1, int $$2, int $$3) {
      if (!this.j()) {
         int $$4 = this.i();
         int $$5 = this.l.size();
         if ($$5 > 0) {
            ...
            int $$8 = atm.f((float)this.e() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = atm.d((float)($$9 - 40) / $$7);
   ...
   private void a(euo $$0, int $$1, int $$2, esy.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(esx.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean j() {
      return this.i.m.m().c() == cds.c;
   }
   ...
   public void a(ur $$0) {
      this.a($$0, null, this.i.T() ? esy.b() : esy.a());
   }

   public void a(ur $$0, @Nullable vd $$1, @Nullable esy $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(ur $$0, @Nullable esy $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, esy::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(ur $$0, @Nullable vd $$1, int $$2, @Nullable esy $$3, boolean $$4) {
      int $$5 = atm.a((double)this.e() / this.g());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<asy> $$6 = eve.a($$0, $$5, this.i.h);
      boolean $$7 = this.m();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new esx.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private eva.a b(vd $$0) {
      int $$1 = this.i.l.e();
      ListIterator<esx> $$2 = this.k.listIterator();
   ...
   private esx a(esx $$0) {
      return new esx($$0.a(), h, null, esy.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)atm.a((double)this.e() / this.g()) && $$4 < 0.0 && $$4 > (double)atm.a(-9.0 * this.g())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public vo b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         esx.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), atm.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public esy c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, esx.a $$1, esy $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         esy.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.m() && !this.i.m.Z && !this.j()) {
         if (!($$0 < -4.0) && !($$0 > (double)atm.a((double)this.e() / this.g()))) {
            int $$2 = Math.min(this.i(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = atm.a($$1 + (double)this.m);
   ...
   private boolean m() {
      return this.i.y instanceof ezl;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return atm.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return atm.a($$0 * 160.0 + 20.0);
   }
