...
public class eva {
   ...
   public void a(evk $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == evk.a) {
            ezn.b($$1, ezn.a.a, vf.c("narrator.toast.disabled"), null);
         } else {
            ezn.b($$1, ezn.a.a, vf.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         ezn.b($$1, ezn.a.a, vf.c("narrator.toast.disabled"), vf.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new eva.a("Narrator library is not active");
      }
   }
