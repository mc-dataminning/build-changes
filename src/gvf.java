...
public class gvf extends gue<bwq, hbj> {
   public gvf(guf.a $$0) {
      super($$0);
   }

   public void a(hbj $$0, fho $$1, gny $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bwq $$0, hbj $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bwq $$0) {
      return false;
   }
}
