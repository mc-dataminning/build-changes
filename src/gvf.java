...
public class gvf {
   ...
   public static class a extends Thread {
      private final gvf.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gvf.b $$0) throws IOException {
         super("LanServerDetector #" + gvf.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gvf.b));
   ...
   public static class b {
      ...
      @Nullable
      public synchronized List<gve> a() {
         if (this.b) {
            List<gve> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
