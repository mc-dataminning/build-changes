...
public class fxg extends fpq<fxg.a> {
   ...
   private final fxc N;
   private final List<fxg.d> O = Lists.newArrayList();
   private final fxg.a P = new fxg.b();
   private final List<fxg.c> Q = Lists.newArrayList();

   public fxg(fxc $$0, flk $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable fxg.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(ggq $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new fxg.d(this.N, $$0.a($$1)));
      }

      this.c();
   }

   public void a(List<hjf> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (hjf $$2 : $$0) {
         this.Q.add(new fxg.c(this.N, $$2));
      }

      this.c();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         fxg.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fpq.a<fxg.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fxg.a {
      private final flk a = flk.Q();

      @Override
      public void a(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.b(this.a.h, fxg.G, this.a.z.n / 2 - this.a.h.a(fxg.G) / 2, $$10, -1);
         String $$11 = fub.a(af.c());
   ...
   public static class c extends fxg.a {
   ...
   public class d extends fxg.a {
      ...
      protected d(final fxc $$1, final ggp $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = flk.Q();
         this.j = ftw.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            fxg.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == ab.b().e() ? ggp.b.e : ggp.b.d);
         ...
         wp $$15 = (wp)(this.i.g() == ggp.b.d ? this.i.h.f().a(n.m) : this.i.c);
         ...
         if (this.h.n.ac().c() || $$8) {
            ...
            if (this.e()) {
               if ($$18 < 32 && $$18 > 16) {
                  $$0.a(gmj::H, fxg.y, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gmj::H, fxg.z, $$3, $$2, 32, 32);
               }
            }

            if ($$1 > 0) {
               if ($$18 < 16 && $$19 < 16) {
                  $$0.a(gmj::H, fxg.A, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gmj::H, fxg.B, $$3, $$2, 32, 32);
               }
            }

            if ($$1 < this.g.G().c() - 1) {
               if ($$18 < 16 && $$19 > 16) {
                  $$0.a(gmj::H, fxg.C, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gmj::H, fxg.D, $$3, $$2, 32, 32);
               }
            }
         }
      }
      ...
      protected void a(fof $$0, int $$1, int $$2, akv $$3) {
         $$0.a(gmj::H, $$3, $$1, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
      }
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fxg.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fxg.this.u();
         double $$4 = $$1 - (double)fxg.this.d(fxg.this.aH_().indexOf(this));
         if ($$3 <= 32.0) {
