public class fxg<T extends bvk> extends fxl<T, fer<T>> {
   private final fou a;

   public fxg(fuy<T, fer<T>> $$0, fou $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(elj $$0, foa $$1, int $$2, boolean $$3, dfd $$4, int $$5, gbb $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(foi.q(fyz.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
