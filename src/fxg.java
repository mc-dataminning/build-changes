...
public class fxg implements etk, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final eti c = new eti();
   private static final boolean d = true;
   private static fxg e;
   ...
   private final List<etq> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, etq> l = Maps.newHashMap();
   private final int m;
   ...
   public fxg(aso $$0, String $$1) throws IOException {
      ajh $$2 = new ajh("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      asm $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = awm.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = awm.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(awm.a($$5, "blend", null));
         this.s = a($$0, etn.a.a, $$6);
         this.t = a($$0, etn.a.b, $$7);
         this.m = eto.a();
         eto.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = etq.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static etl a(aso $$0, etn.a $$1, String $$2) throws IOException {
      etn $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof etl)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         etl $$7;
         if ($$3 == null) {
            ajh $$4 = new ajh("shaders/program/" + $$2 + $$1.b());
            asm $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static etj a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new etj();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (awm.a($$0, "func")) {
            $$1 = etj.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (awm.a($$0, "srcrgb")) {
            $$2 = etj.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (awm.a($$0, "dstrgb")) {
            $$3 = etj.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (awm.a($$0, "srcalpha")) {
            $$4 = etj.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (awm.a($$0, "dstalpha")) {
            $$5 = etj.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new etj($$2, $$3, $$4, $$5, $$1) : new etj($$2, $$3, $$1);
         }
      }
   }
