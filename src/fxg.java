public class fxg<T extends cii> extends fuz<T> {
   ...
   public static fxw a(fxu $$0) {
      fxy $$1 = new fxy();
      fxz $$2 = $$1.a();
      $$2.a("shoulders", fxv.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), fxs.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         fxv.c()
         ...
         fxs.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         fxv.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         fxs.a(-2.0F, 6.9F + ayg.b(0.20420352F) * 10.0F, -0.5F + ayg.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", fxv.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fxs.a);
      fxv $$4 = fxv.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, fxs.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, fxs.a(10.0F, 4.0F, 0.0F));
   ...
   private static <T extends cii> void a(T $$0, fxq $$1, int $$2) {
