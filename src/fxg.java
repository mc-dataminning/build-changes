...
public class fxg extends fyw {
   private final float a;
   private final fyr b;

   fxg(fuq $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, fyr $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements fxz<kf> {
      ...
      public fxw a(kf $$0, fuq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dim.a) {
            ...
            id $$9 = id.a($$2, $$3, $$4);
            int $$10 = fby.Q().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof dfd) {
               $$10 = ((dfd)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new fxg($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
