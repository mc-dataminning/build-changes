...
public final class xu {
   ...
   public static final Codec<xu> a = Codec.STRING.comapFlatMap(xu::a, xu::b);
   private static final Map<n, xu> c = Stream.of(n.values())
      .filter(n::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new xu($$0.f(), $$0.g())));
   private static final Map<String, xu> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
   private final String f;

   private xu(int $$0, String $$1) {
      this.e = $$0 & 16777215;
      this.f = $$1;
   }
   ...
   public static DataResult<xu> a(String $$0) {
      if ($$0.startsWith("#")) {
         try {
