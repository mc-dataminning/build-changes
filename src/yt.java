...
public interface yt {
   ...
   private static <T, R> yv<wi, R> a(final akl<? extends jk<T>> $$0, final Function<jk<T>, jc<R>> $$1) {
      return new yv<wi, R>() {
   ...
   static <T> yv<wi, T> a(akl<? extends jk<T>> $$0) {
      return a($$0, $$0x -> $$0x);
   }

   static <T> yv<wi, ix<T>> b(akl<? extends jk<T>> $$0) {
      return a($$0, jk::t);
   }

   static <T> yv<wi, ix<T>> a(final akl<? extends jk<T>> $$0, final yv<? super wi, T> $$1) {
   ...
   static <T> yv<wi, jb<T>> c(final akl<? extends jk<T>> $$0) {
      return new yv<wi, jb<T>>() {
         ...
         public jb<T> a(wi $$0x) {
            ...
            if ($$1 == -1) {
               jk<T> $$2 = $$0.G().d($$0);
               return $$2.b(awl.a($$0, akm.b.decode($$0))).orElseThrow();
            } else {
         ...
         public void a(wi $$0x, jb<T> $$1) {
            Optional<awl<T>> $$2 = $$1.d();
            if ($$2.isPresent()) {
               wo.a($$0, 0);
               akm.b.encode($$0, $$2.get().b());
            } else {
               wo.a($$0, $$1.b() + 1);
