...
public class yt implements xj {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayt.b.validate(yt::b);
   private static final Codec<Object> e = Codec.either(d, xk.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof xi $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yt> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xj.a<yt> c = new xj.a<>(b, "translatable");
   private static final xn f = xn.e("%");
   private static final xn g = xn.e("null");
   ...
   @Nullable
   private uf k;
   private List<xn> l = ImmutableList.of();
   ...
   private static yt a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yt($$0, $$1.orElse(null), a($$2));
   }

   public yt(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xn> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yu var4) {
            this.l = ImmutableList.of(xn.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xn> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yu(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xn a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof xi) {
            ...
            return $$1 == null ? g : xn.e($$1.toString());
         }
      } else {
         throw new yu(this, $$0);
      }
   ...
   public xw a(@Nullable ew $$0, @Nullable bue $$1, int $$2) throws CommandSyntaxException {
      ...
      return xw.a(new yt(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yt $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
