...
public class dnv {
   ...
   private final List<dnt> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dnv.a l = new dnv.d(5.999997E7F);
   public static final dnv.c e = new dnv.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public ib b(double $$0, double $$1, double $$2) {
      return ib.a(awm.a($$0, this.e(), this.g()), $$1, awm.a($$2, this.f(), this.h()));
   }

   public double a(bof $$0) {
      return this.b($$0.do(), $$0.du());
   }
   ...
   public boolean a(bof $$0, eoq $$1) {
      double $$2 = Math.max(awm.a($$1.b(), $$1.d()), 1.0);
      return this.a($$0) < $$2 * 2.0 && this.a($$0.do(), $$0.du(), $$2);
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dnv.a)($$0 == $$1 ? new dnv.d($$1) : new dnv.b($$0, $$1, $$2));
   ...
   class b implements dnv.a {
      ...
      @Override
      public double a() {
         return awm.a(dnv.this.a() - this.e() / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
      }

      @Override
      public double c() {
         return awm.a(dnv.this.b() - this.e() / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? awm.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dnu i() {
         return this.c < this.b ? dnu.b : dnu.a;
      }
      ...
      @Override
      public dnv.a l() {
         return (dnv.a)(this.g() <= 0L ? dnv.this.new d(this.c) : this);
      }
      ...
      public epo m() {
         return epl.a(
            epl.c,
            epl.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eoz.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dnv.c a(DynamicLike<?> $$0, dnv.c $$1) {
         double $$2 = awm.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = awm.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dnv.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dnv.a {
      ...
      private void n() {
         this.c = awm.a(dnv.this.a() - this.b / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
         this.d = awm.a(dnv.this.b() - this.b / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
         this.e = awm.a(dnv.this.a() + this.b / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
         this.f = awm.a(dnv.this.b() + this.b / 2.0, (double)(-dnv.this.k), (double)dnv.this.k);
         this.g = epl.a(
            epl.c,
            epl.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eoz.e
