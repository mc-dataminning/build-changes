...
public class clt extends clo {
   ...
   public clt(bwr<? extends clt> $$0, djh $$1) {
      super($$0, $$1);
   }
   ...
   protected void D() {
      ...
      this.bE.a(1, new clt.a(this));
      this.bE.a(2, new cfy<>(this, cpe.class, true, ($$0, $$1) -> $$0.an() != bwr.bR));
      this.bE.a(2, new cfy<>(this, cnr.class, true));
   }
   ...
   private void hg() {
      if (this.hh()) {
         this.bG = this.hi() ? ((crb)this.C()).gB() - 1 : this.bG - 1;
         if (this.bG <= 0) {
            this.z();
            this.aq();
         }
   ...
   protected static class a extends cgf {
      ...
      public boolean b() {
         if (!this.a.O_()) {
            return false;
         } else if (!(this.a.C() instanceof crb $$1)) {
            return false;
         } else {
            this.b = $$1.eq();
            int $$2 = $$1.es();
