...
public abstract class clt extends cjk implements bxk, byb, bye {
   ...
   private static final cij.a bR = ($$0, $$1) -> {
      if ($$0 instanceof clt $$2 && $$2.gQ()) {
         return true;
      }

      return false;
   };
   private static final cij bS = cij.b().a(16.0).d().a(bR);
   private static final akl<Byte> cg = akp.a(clt.class, akn.a);
   ...
   protected clt(bxc<? extends clt> $$0, djx $$1) {
      super($$0, $$1);
      this.gT();
   }
   ...
   @Override
   protected void D() {
      this.bF.a(1, new cfj(this, 1.2));
      this.bF.a(1, new cfu(this, 1.2));
      this.bF.a(2, new cec(this, 1.0, clt.class));
      this.bF.a(4, new cep(this, 1.0));
      this.bF.a(6, new cgd(this, 0.7));
      this.bF.a(7, new cey(this, crx.class, 6.0F));
      this.bF.a(8, new cfl(this));
      if (this.gv()) {
         this.bF.a(9, new cfm(this));
      }
   ...
   protected void gM() {
      ...
      this.bF.a(3, new cfy(this, 1.25, $$0 -> $$0.a(axm.ak), false));
   }
   ...
   public void j(@Nullable bxu $$0) {
      this.cB = $$0 != null ? new bwz<>($$0) : null;
   }
   ...
   public boolean e(bxd $$0) {
      return $$0 != bxd.h ? super.e($$0) : this.bJ() && !this.n_() && this.gL();
   }

   public void b(crx $$0, czy $$1) {
      if (this.a($$1, bxd.g)) {
         this.h($$1.b(1, $$0));
      }
   }
   ...
   protected boolean f(bxd $$0) {
      return ($$0 == bxd.g || $$0 == bxd.h) && this.gL() || super.f($$0);
   }
   ...
   public int u(int $$0) {
      int $$1 = azo.a(this.gR() + $$0, 0, this.gW());
      this.t($$1);
      return $$1;
   }
   ...
   protected jf<awo> a(bxd $$0, czy $$1, dih $$2) {
      return (jf<awo>)($$0 == bxd.h ? awp.ns : super.a($$0, $$1, $$2));
   }
      ...
      if (!$$1.n()) {
         ...
         if (this.bZ() && this.ce) {
            ...
            if (this.cf > 5 && this.cf % 3 == 0) {
               ...
               this.a(awp.nu, $$3.a() * 0.15F, $$3.b());
            }
         } else if (this.b($$3)) {
            this.a(awp.nu, $$3.a() * 0.15F, $$3.b());
         } else {
            this.a(awp.nt, $$3.a() * 0.15F, $$3.b());
         }
      }
   }

   private boolean b(duz $$0) {
      return $$0 == duz.b || $$0 == duz.aV || $$0 == duz.B || $$0 == duz.aW || $$0 == duz.aU;
   }

   protected void a(duz $$0) {
      this.a(awp.no, $$0.a() * 0.15F, $$0.b());
   }

   public static byz.a gV() {
      return cjk.gz().a(bza.o, 0.7).a(bza.s, 53.0).a(bza.v, 0.225F).a(bza.B, 1.0).a(bza.x, 6.0).a(bza.k, 0.5);
   }
   ...
   public bur c(crx $$0, czy $$1) {
      boolean $$2 = this.a($$0, $$1);
      if ($$2) {
         $$1.a(1, $$0);
      }

      return (bur)(!$$2 && !this.dV().C ? bur.e : bur.b);
   }
   ...
   public void k_() {
      ...
      if (this.dV() instanceof ars $$0 && this.bJ()) {
         ...
         if (this.gX()) {
            if (!this.gO() && !this.bZ() && this.ae.a(300) == 0 && $$0.a_(this.dv().e()).a(dne.i)) {
               this.A(true);
            }
   ...
   protected void g(ars $$0) {
      if (this.gQ() && this.n_() && !this.gO()) {
         bxu $$1 = $$0.a(clt.class, bS, this, this.dA(), this.dC(), this.dG(), this.cR().g(16.0));
   ...
   protected ffq b(crx $$0, ffq $$1) {
      if (this.aH() && this.cc == 0.0F && this.gP() && !this.cd) {
         ...
         return new ffq((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void b(float $$0, ffq $$1) {
      ...
      this.ar = true;
      if ($$1.f > 0.0) {
         float $$4 = azo.a(this.dL() * (float) (Math.PI / 180.0));
         float $$5 = azo.b(this.dL() * (float) (Math.PI / 180.0));
         this.i(this.dy().b((double)(-0.4F * $$4 * $$0), 0.0, (double)(0.4F * $$5 * $$0)));
      }
   }

   protected void hb() {
      this.a(awp.nq, 0.4F, 1.0F);
   }
   ...
   protected void a(bwj $$0, clt $$1) {
      this.a($$0, $$1, bza.s, (double)bN, (double)bO);
      this.a($$0, $$1, bza.o, (double)bK, (double)bM);
      this.a($$0, $$1, bza.v, (double)bI, (double)bJ);
   }

   private void a(bwj $$0, clt $$1, jf<byv> $$2, double $$3, double $$4) {
      double $$5 = a(this.i($$2), $$0.i($$2), $$3, $$4, this.ae);
      $$1.g($$2).a($$5);
   }

   static double a(double $$0, double $$1, double $$2, double $$3, azx $$4) {
      if ($$3 <= $$2) {
   ...
   public float J(float $$0) {
      return azo.h($$0, this.cw, this.cv);
   }

   public float K(float $$0) {
      return azo.h($$0, this.cy, this.cx);
   }

   public float L(float $$0) {
      return azo.h($$0, this.cA, this.cz);
   }
   ...
   public byl a_(int $$0) {
      int $$1 = $$0 - 500;
      return $$1 >= 0 && $$1 < this.ca.b() ? byl.a(this.ca, $$1) : super.a_($$0);
   }
   ...
   private ffq a(ffq $$0, bxu $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (cuq.a($$8)) {
               ffl $$9 = $$1.f($$6);
               ffq $$10 = new ffq($$2, (double)$$5.v() + $$8, $$4);
               if (cuq.a(this.dV(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public ffq b(bxu $$0) {
      ffq $$1 = a((double)this.dq(), (double)$$0.dq(), this.dL() + ($$0.fy() == bxl.b ? 90.0F : -90.0F));
      ffq $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         ffq $$3 = a((double)this.dq(), (double)$$0.dq(), this.dL() + ($$0.fy() == bxl.a ? 90.0F : -90.0F));
         ffq $$4 = this.a($$3, $$0);
   ...
   protected ffq a(bwt $$0, bww $$1, float $$2) {
      return super.a($$0, $$1, $$2)
         .e(new ffq(0.0, 0.15 * (double)this.cy * (double)$$2, -0.7 * (double)this.cy * (double)$$2).b(-this.dL() * (float) (Math.PI / 180.0)));
   }
