...
public class clt {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof clt $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public static Stream<clt> a(clt $$0, int $$1) {
      return a(new clt($$0.e - $$1, $$0.f - $$1), new clt($$0.e + $$1, $$0.f + $$1));
   }
   ...
   public static Stream<clt> a(final clt $$0, final clt $$1) {
      ...
      return StreamSupport.stream(new AbstractSpliterator<clt>((long)($$2 * $$3), 64) {
         @Nullable
         private clt e;

         @Override
         public boolean tryAdvance(Consumer<? super clt> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
