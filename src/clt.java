...
public class clt extends clx {
   ...
   private static final ajy<Integer> d = akc.a(clt.class, aka.b);
   private float bY;
   private float bZ;
   private float ca;
   private float cb;
   ...
   public clt(bur<? extends clt> $$0, dgh $$1) {
      super($$0, $$1);
      this.bN = 10;
      this.a(etp.j, 0.0F);
   ...
   public static bwn.a x() {
      return clx.gx().a(bwo.c, 6.0).a(bwo.v, 0.5).a(bwo.s, 30.0);
   }
   ...
   public static boolean b(bur<? extends clt> $$0, dgi $$1, buq $$2, ji $$3, azh $$4) {
      return ($$4.a(20) == 0 || !$$1.v($$3)) && $$1.am() != bsg.a && (buq.a($$2) || $$1.b_($$3).a(awv.a)) && $$1.b_($$3.e()).a(awv.a);
   }

   @Override
   public boolean a(ard $$0, bta $$1, float $$2) {
      if (!this.gs() && !$$1.a(awr.w) && !$$1.a(btd.P) && $$1.c() instanceof bvg $$3) {
         ...
         if ($$0 != null) {
            ...
            if (!this.a.E($$0)) {
               ...
               if (this.b == 0) {
                  ...
                  ard $$2 = a(this.a);
                  $$0.a($$2, this.a.dW().c(this.a, (buk)this.a), $$1);
                  this.a.c($$2, $$0);
                  this.a.h(null);
               }
   ...
   static class b implements cfx.a {
      ...
      @Override
      public boolean test(@Nullable bvg $$0, ard $$1) {
         return ($$0 instanceof cow || $$0 instanceof chw || $$0 instanceof cij) && $$0.g(this.a) > 9.0;
      }
   }
