...
public abstract class bee extends DataFix {
   ...
   public bee(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bdt.y);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bdt.y);
      Type<Pair<String, String>> $$2 = DSL.named(bdt.w.typeName(), bfc.a());
      if (!Objects.equals(this.getOutputSchema().getType(bdt.w), $$2)) {
