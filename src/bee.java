...
public class bee extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(bgq.D.typeName(), bic.a()));
      Type<Pair<String, String>> $$1 = DSL.named(bgq.D.typeName(), bic.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(bgq.t),
         this.getOutputSchema().getType(bgq.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(bgq.D.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
