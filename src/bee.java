...
public class bee extends bas {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bee::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bee::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bee::k);
         $$0 = this.a($$0, "minecraft:fox", bee::j);
         $$0 = this.a($$0, "minecraft:item", bee::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bee::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bee::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bee::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bee::e);
         return this.a($$0, "minecraft:piglin", bee::d);
      });
   }
