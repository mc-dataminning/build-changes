...
public class bee {
   ...
   private bee(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bee a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bee($$0, $$1);
   }

   public bee.d a() throws IOException {
      bee.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bee.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bee.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bee.c $$3 = bee.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bee.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bee.a($$0, $$3);
            }
         }
   ...
   public bee.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bee.c> $$2 = this.a().c();
      ...
      bee.e $$4 = new bee.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bee.c b) implements bee.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bee.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bee.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bee.b> {
      private final List<bee.b> a;

      d(List<bee.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bee.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bee.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bee.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bee.d a() {
         ListIterator<bee.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bee.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bee.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bee.b> b() {
         return this.a.stream();
      }

      public Set<bee.c> c() {
         return this.a.stream().map(bee.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bee.c b) implements bee.b {
