...
public class hls {
   ...
   private static final Set<ald> k = Sets.newHashSet();
   ...
   private final fnh n;
   private boolean o;
   private final ffb p = new ffb();
   private final ffc q = this.p.e();
   private final hlr r;
   private final hlt s = new hlt();
   private final hlj t = new hlj(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hls.a> w = new AtomicReference<>(hls.a.c);
   private final Map<hkp, hlj.a> x = Maps.newHashMap();
   private final Multimap<awl, hkp> y = HashMultimap.create();
   private final List<hkq> z = Lists.newArrayList();
   private final Map<hkp, Integer> A = Maps.newHashMap();
   private final Map<hkp, Integer> B = Maps.newHashMap();
   private final List<hlu> C = Lists.newArrayList();
   private final List<hkq> D = Lists.newArrayList();
   private final List<hkm> E = Lists.newArrayList();

   public hls(hlv $$0, fnh $$1, avd $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hlr($$2);
   }
   ...
   public void a() {
      ...
      for (awj $$0 : md.b) {
         if ($$0 != awk.rG) {
            ald $$1 = $$0.a();
            if (this.m.a($$1) == null) {
               e.warn("Missing sound for event: {}", md.b.b($$0));
               k.add($$1);
            }
         }
      }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(ffa::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hls.a.c, hls.a.a)) {
               String $$2 = this.n.aw().c();
               af.i().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hls.a.a, hls.a.b);
                     }
                  ...
                  this.w.compareAndSet(hls.a.a, hls.a.c);
               });
            }
         }

         return this.w.compareAndSet(hls.a.b, hls.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hkp::s).forEach(this::c);
      this.D.clear();
      ...
      for (hkq $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            fcu $$3 = new fcu($$0.h(), $$0.i(), $$0.j());
            hlj.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hkp, hlj.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hkp, hlj.a> $$6 = $$5.next();
         hlj.a $$7 = $$6.getValue();
         hkp $$8 = $$6.getKey();
      ...
      Iterator<Entry<hkp, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hkp, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hkp $$13 = $$12.getKey();
            if ($$13 instanceof hkq) {
               ((hkq)$$13).q();
            }
   ...
   private static boolean d(hkp $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hkp $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hkp $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hkp $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hlv.e) {
                  if ($$3 == hlv.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        fcu $$11 = new fcu($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hkp.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hlj.a> $$16 = this.t.a($$3.g() ? ffb.c.b : ffb.c.a);
                           hlj.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hkp $$0) {
      return azk.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hkp $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(ffa::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(ffa::e));
      }
   }
   ...
   public void a(fml $$0) {
      if (this.o && $$0.h()) {
         ffd $$1 = new ffd($$0.b(), new fcu($$0.l()), new fcu($$0.m()));
