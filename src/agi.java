...
public class agi {
   ...
   public static BiMap<String, aex<cpx>> a = ImmutableBiMap.of("o", cpx.h, "n", cpx.i, "e", cpx.j);
   @Nullable
   private static aga g;
   @Nullable
   ...
   private static int a(dt $$0) {
      if (h != null) {
         h.b();
         $$0.a(() -> tn.b("You have now stopped chasing"), false);
         h = null;
      }

      if (g != null) {
         g.b();
         $$0.a(() -> tn.b("You are no longer being chased"), false);
         g = null;
      }
   ...
   private static boolean b(dt $$0) {
      if (g != null) {
         $$0.b(tn.b("Chase server is already running. Stop it using /chase stop"));
         return true;
      } else if (h != null) {
         $$0.b(tn.b("You are already chasing someone. Stop it using /chase stop"));
         return true;
      } else {
         return false;
      }
   ...
   private static int a(dt $$0, String $$1, int $$2) {
      if (b($$0)) {
         ...
         g = new aga($$1, $$2, $$0.l().ac(), 100);

         try {
            g.a();
            $$0.a(() -> tn.b("Chase server is now running on port " + $$2 + ". Clients can follow you using /chase follow <ip> <port>"), false);
         } catch (IOException var4) {
            b.error("Failed to start chase server", var4);
            $$0.b(tn.b("Failed to start chase server on port " + $$2));
            g = null;
         }
