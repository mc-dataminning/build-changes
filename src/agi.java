...
public class agi implements Comparable<agi> {
   public static final Codec<agi> a = Codec.STRING.comapFlatMap(agi::b, agi::toString).stable();
   ...
   protected agi(String $$0, String $$1, @Nullable agi.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public agi(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private agi(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static agi a(String $$0, char $$1) {
      return new agi(b($$0, $$1));
   }
   ...
   @Nullable
   public static agi a(String $$0, String $$1) {
      try {
         return new agi($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<agi> b(String $$0) {
      try {
         return DataResult.success(new agi($$0));
      } catch (z var2) {
   ...
   public agi c(String $$0) {
      return new agi(this.f, d(this.f, $$0), null);
   }

   public agi a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public agi d(String $$0) {
      return this.c($$0 + this.g);
   }

   public agi e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof agi $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static agi a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<agi>, JsonSerializer<agi> {
      public agi a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new agi(atc.a($$0, "location"));
      }

      public JsonElement a(agi $$0, Type $$1, JsonSerializationContext $$2) {
