...
public class agi {
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tl.b("commands.bossbar.create.failed", $$0));
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> tl.b("commands.bossbar.unknown", $$0));
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)du.a(
                                          ...
                                          .then(
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a(
                                                                  ...
                                                                  .then(du.a("pink").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.a))))
                                                               .then(du.a("blue").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.b))))
                                                            .then(du.a("red").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.c))))
                                                         .then(du.a("green").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.d))))
                                                      .then(du.a("yellow").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.e))))
                                                   .then(du.a("purple").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.f))))
                                                .then(du.a("white").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.a.g)))
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("style")
                                                         .then(du.a("progress").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.b.a))))
                                                      .then(du.a("notched_6").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.b.b))))
                                                   .then(du.a("notched_10").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.b.c))))
                                                .then(du.a("notched_12").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.b.d))))
                                             .then(du.a("notched_20").executes($$0x -> a((dt)$$0x.getSource(), a($$0x), bgu.b.e)))
                                       ))
                                    .then(
                                       du.a("value")
                                          .then(
   ...
   private static int d(dt $$0, afx $$1) {
      if ($$1.h().isEmpty()) {
         $$0.a(() -> tl.a("commands.bossbar.get.players.none", $$1.e()), true);
      } else {
         $$0.a(() -> tl.a("commands.bossbar.get.players.some", $$1.e(), $$1.h().size(), to.b($$1.h(), cca::N_)), true);
      }

      return $$1.h().size();
   }

   private static int a(dt $$0, afx $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.g() == $$2) {
         if ($$2) {
            throw k.create();
         } else {
   ...
   private static int a(dt $$0, afx $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         throw h.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(dt $$0, afx $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         throw i.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(dt $$0, afx $$1, bgu.a $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(dt $$0, afx $$1, bgu.b $$2) throws CommandSyntaxException {
      if ($$1.m().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(dt $$0, afx $$1, tl $$2) throws CommandSyntaxException {
      tl $$3 = to.a($$0, $$2, null, 0);
      if ($$1.j().equals($$3)) {
         throw e.create();
      } else {
         $$1.a($$3);
   ...
   private static int a(dt $$0, afx $$1, Collection<aku> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
         if ($$1.h().isEmpty()) {
            ...
            $$0.a(() -> tl.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), to.b($$2, cca::N_)), true);
         }
   ...
   private static int a(dt $$0) {
      Collection<afx> $$1 = $$0.l().aJ().b();
      if ($$1.isEmpty()) {
         $$0.a(() -> tl.c("commands.bossbar.list.bars.none"), false);
      } else {
         $$0.a(() -> tl.a("commands.bossbar.list.bars.some", $$1.size(), to.b($$1, afx::e)), false);
      }

      return $$1.size();
   }

   private static int a(dt $$0, aez $$1, tl $$2) throws CommandSyntaxException {
      afy $$3 = $$0.l().aJ();
      if ($$3.a($$1) != null) {
         throw b.create($$1.toString());
      } else {
         afx $$4 = $$3.a($$1, to.a($$0, $$2, null, 0));
         $$0.a(() -> tl.a("commands.bossbar.create.success", $$4.e()), true);
         return $$3.b().size();
      }
   }

   private static int e(dt $$0, afx $$1) {
      afy $$2 = $$0.l().aJ();
      $$1.b();
      $$2.a($$1);
   ...
   public static afx a(CommandContext<dt> $$0) throws CommandSyntaxException {
      aez $$1 = es.e($$0, "id");
      afx $$2 = ((dt)$$0.getSource()).l().aJ().a($$1);
      if ($$2 == null) {
