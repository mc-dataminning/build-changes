...
public class bbp extends bgq {
   public bbp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bhv.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bhv.s, "minecraft:jukebox");
