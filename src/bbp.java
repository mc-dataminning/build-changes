...
public class bbp extends bgh {
   public bbp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bhm.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bhm.s, "minecraft:jukebox");
