...
public record bbp<T extends bbo>(T a, T b, @Nullable T c, int d, Map<Integer, Double> e, Duration f) {
   public static <T extends bbo> bbp<T> a(List<T> $$0) {
      if ($$0.isEmpty()) {
         throw new IllegalArgumentException("No values");
      } else {
         List<T> $$1 = $$0.stream().sorted(Comparator.comparing(bbo::a)).toList();
         ...
         int $$6 = $$1.size();
         Map<Integer, Double> $$7 = bau.a($$1.stream().mapToLong($$0x -> $$0x.a().toNanos()).toArray());
         return new bbp<>($$3, $$4, $$5, $$6, $$7, $$2);
      }
   }
}
