...
public class bbp extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhw.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bhw.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bhw.s);
