...
public abstract class bwl extends bum implements bgo, biu, bjj, bjm, bjr {
   ...
   private static final Predicate<bjb> cc = $$0 -> $$0 instanceof bwl && ((bwl)$$0).gu();
   private static final btn cd = btn.b().a(16.0).d().a(cc);
   private static final cmb ce = cmb.a(cjd.oI, cjd.qM, csr.ij.k(), cjd.nF, cjd.tq, cjd.pm, cjd.pn);
   private static final aec<Byte> cv = aef.a(bwl.class, aee.a);
   ...
   protected bwl(bip<? extends bwl> $$0, cpq $$1) {
      super($$0, $$1);
      this.t(1.0F);
      this.gw();
   }
   ...
   @Override
   protected void w() {
      this.bO.a(1, new bqp(this, 1.2));
      this.bO.a(1, new bra(this, 1.2));
      this.bO.a(2, new bpi(this, 1.0, bwl.class));
      this.bO.a(4, new bpv(this, 1.0));
      this.bO.a(6, new brj(this, 0.7));
      this.bO.a(7, new bqe(this, cbp.class, 6.0F));
      this.bO.a(8, new bqr(this));
      if (this.gg()) {
         this.bO.a(9, new bqs(this));
      }
   ...
   protected void gq() {
      ...
      this.bO.a(3, new bre(this, 1.25, cmb.a(cjd.tq, cjd.pm, cjd.pn), false));
   }
   ...
   public void a(@Nullable apa $$0) {
      this.cp.a(0, new cja(cjd.mZ));
   }

   public void b(cbp $$0, cja $$1) {
      if (this.l($$1)) {
         this.cp.a(1, $$1.c(1));
         if (!$$0.fR().d) {
            $$1.h(1);
   ...
   public int v(int $$0) {
      int $$1 = ars.a(this.gv() + $$0, 0, this.gB());
      this.u($$1);
      return $$1;
   }
      ...
      if (!$$1.k()) {
         ...
         if (this.bO() && this.ct) {
            ...
            if (this.cu > 5 && this.cu % 3 == 0) {
               ...
               this.a(aoz.lq, $$3.a() * 0.15F, $$3.b());
            }
         } else if (this.b($$3)) {
            this.a(aoz.lq, $$3.a() * 0.15F, $$3.b());
         } else {
            this.a(aoz.lp, $$3.a() * 0.15F, $$3.b());
         }
      }
   }

   private boolean b(dad $$0) {
      return $$0 == dad.b || $$0 == dad.aP || $$0 == dad.B || $$0 == dad.aQ || $$0 == dad.aO;
   }

   protected void a(dad $$0) {
      this.a(aoz.lk, $$0.a() * 0.15F, $$0.b());
   }

   public static bkg.a gA() {
      return bjd.x().a(bkh.n).a(bkh.a, 53.0).a(bkh.d, 0.225F);
   }
   ...
   public void b_() {
      ...
      if (!this.dK().B && this.bv()) {
         ...
         if (this.gD()) {
            if (!this.gs() && !this.bO() && this.ag.a(300) == 0 && this.dK().a_(this.dk().d()).a(csr.i)) {
               this.A(true);
            }
   ...
   protected void gC() {
      if (this.gu() && this.i_() && !this.gs()) {
         bjb $$0 = this.dK().a(bwl.class, cd, this, this.dp(), this.dr(), this.dv(), this.cG().g(16.0));
   ...
   protected ehi b(cbp $$0, ehi $$1) {
      if (this.aA() && this.cr == 0.0F && this.gt() && !this.cs) {
         ...
         return new ehi((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void b(float $$0, ehi $$1) {
      ...
      this.au = true;
      if ($$1.e > 0.0) {
         float $$5 = ars.a(this.dA() * (float) (Math.PI / 180.0));
         float $$6 = ars.b(this.dA() * (float) (Math.PI / 180.0));
         this.f(this.dn().b((double)(-0.4F * $$5 * $$0), 0.0, (double)(0.4F * $$6 * $$0)));
      }
   }

   protected void gH() {
      this.a(aoz.lm, 0.4F, 1.0F);
   }
   ...
   public void b(qu $$0) {
      ...
      if (!this.cp.a(0).b()) {
         $$0.a("SaddleItem", this.cp.a(0).b(new qu()));
      }
   }
   ...
   protected void a(big $$0, bwl $$1) {
      this.a($$0, $$1, bkh.a, (double)bY, (double)bZ);
      this.a($$0, $$1, bkh.n, (double)bW, (double)bX);
      this.a($$0, $$1, bkh.d, (double)bT, (double)bU);
   }

   private void a(big $$0, bwl $$1, bkc $$2, double $$3, double $$4) {
      double $$5 = a(this.c($$2), $$0.c($$2), $$3, $$4, this.ag);
      $$1.a($$2).a($$5);
   }

   static double a(double $$0, double $$1, double $$2, double $$3, arx $$4) {
      if ($$3 <= $$2) {
   ...
   public float E(float $$0) {
      return ars.i($$0, this.cG, this.cF);
   }

   public float F(float $$0) {
      return ars.i($$0, this.cI, this.cH);
   }

   public float G(float $$0) {
      return ars.i($$0, this.cK, this.cJ);
   }
   ...
   private bjt a(final int $$0, final Predicate<cja> $$1) {
      return new bjt() {
         @Override
         public cja a() {
            return bwl.this.cp.a($$0);
         }
   ...
   public bjt a_(int $$0) {
      ...
      if ($$1 >= 0 && $$1 < 2 && $$1 < this.cp.b()) {
         if ($$1 == 0) {
            return this.a($$1, $$0x -> $$0x.b() || $$0x.a(cjd.mZ));
         }
      ...
      int $$2 = $$0 - 500 + 2;
      return $$2 >= 2 && $$2 < this.cp.b() ? bjt.a(this.cp, $$2) : super.a_($$0);
   }
   ...
   private ehi a(ehi $$0, bjb $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (cdl.a($$8)) {
               ehd $$9 = $$1.e($$6);
               ehi $$10 = new ehi($$2, (double)$$5.v() + $$8, $$4);
               if (cdl.a(this.dK(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public ehi b(bjb $$0) {
      ehi $$1 = a((double)this.df(), (double)$$0.df(), this.dA() + ($$0.fk() == biv.b ? 90.0F : -90.0F));
      ehi $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         ehi $$3 = a((double)this.df(), (double)$$0.df(), this.dA() + ($$0.fk() == biv.a ? 90.0F : -90.0F));
         ehi $$4 = this.a($$3, $$0);
