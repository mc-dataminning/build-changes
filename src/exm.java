...
public class exm {
   ...
   private static final Queue<exm.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile exm.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(exm::a), exk::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(exm::a), exk::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + exm.a(this.b) + ", type=" + exm.b(this.c) + ", severity=" + exm.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
