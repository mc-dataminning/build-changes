...
public class exm {
   ...
   public Optional<iu> a(iu $$0, boolean $$1, ebz $$2) {
      cig $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cik.r), $$0, $$4, cig.b.c)
         .map(cih::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(eax.J))
   ...
   public Optional<l.a> a(iu $$0, ja.a $$1) {
      ...
      for (iu.a $$11 : iu.a($$0, 16, ja.f, ja.d)) {
         int $$12 = Math.min($$8, this.n.a(egg.a.e, $$11.u(), $$11.w()));
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dmh.cy.m(), 3);
            }
         }
      }

      eah $$26 = dmh.eu.m().b(drq.b, $$1);
