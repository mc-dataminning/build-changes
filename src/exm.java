...
public class exm implements exh {
   protected static final exh a = new exm(false, -Double.MAX_VALUE, cuq.l, $$0 -> false, null) {
      @Override
      public boolean a(exv $$0, jd $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected exm(boolean $$0, double $$1, cuq $$2, Predicate<epe> $$3, @Nullable bsr $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected exm(bsr $$0) {
      ...
      // 05: aload 1
      // 06: invokevirtual bsr.dv ()D
      // 09: aload 1
      // 0a: instanceof btn
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast btn
      // 14: invokevirtual btn.eT ()Lcuq;
      // 17: goto 1d
