...
public class exm {
   ...
   private static final Map<dop.a, String> e = ac.a(new EnumMap<>(dop.a.class), $$0 -> {
      $$0.put(dop.a.a, "SW");
      $$0.put(dop.a.b, "S");
      $$0.put(dop.a.c, "OW");
      $$0.put(dop.a.d, "O");
   ...
   private dln l;
   @Nullable
   private CompletableFuture<dln> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final auw r = new auw();
   private final auw s = new auw();
   private final auw t = new auw();
   private final auw u = new auw();
   private final eyu v;
   private final eyw w;
   private final eyv x;
   private final eyt y;
   ...
   public exm(evg $$0) {
      ...
      this.g = new exm.a();
      this.h = $$0.h;
      this.v = new eyu(this.h, this.r);
      this.w = new eyw(this.h, this.s, () -> $$0.r.s().g());
      this.x = new eyv(this.h, this.t);
      this.y = new eyt(this.h, this.u);
   }
   ...
   private void a(ews $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cto $$23 = this.p();
         LongSet $$24 = (LongSet)($$23 instanceof and ? ((and)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, aun.g($$15.dC()), aun.g($$15.dE())));
         dln $$27 = this.r();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(ctx.a, $$14);
            int $$30 = this.f.r.a(ctx.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dln $$31 = this.q();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dop.a $$33 : dop.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.J_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  bjy $$37 = new bjy($$23.ak(), $$23.Y(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            ctz.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bmn> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bmn.values())
         ...
         $$25.add(this.f.ai().i() + String.format(Locale.ROOT, " (Mood %d%%)", Math.round(this.f.s.d() * 100.0F)));
         return $$25;
      }
   }

   private static String a(ih<cun> $$0) {
   ...
   private cto p() {
      return (cto)DataFixUtils.orElse(Optional.ofNullable(this.f.T()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private dln q() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dlh.n, false).thenApply($$0x -> (dln)$$0x.map($$0xx -> (dln)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eos.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", evg.O().aM().k(), evg.O().aM().l(), eos.a()),
            eos.c(),
            eos.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == elq.a.b) {
            ...
            while (var12.hasNext()) {
               Entry<dkj<?>, Comparable<?>> $$7 = (Entry<dkj<?>, Comparable<?>>)var12.next();
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == elq.a.b) {
            ...
            while (var17.hasNext()) {
               Entry<dkj<?>, Comparable<?>> $$10 = (Entry<dkj<?>, Comparable<?>>)var17.next();
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dkj<?>, Comparable<?>> $$0) {
      dkj<?> $$1 = $$0.getKey();
