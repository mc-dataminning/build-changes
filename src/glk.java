...
public class glk {
   ...
   public glk(hci $$0, hcj $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(hau $$0, fgs $$1, gll $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fgw $$6 = $$2.getBuffer(glv.u($$0.a));
      ...
      for (hau.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fnq.a.a, Integer.MIN_VALUE, $$4, false);
               $$1.b();
            }
   ...
   public void a(evp $$0, evr $$1, hau $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
