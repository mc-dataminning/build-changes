public class glv implements glr<dtc> {
   private final gqi a;
   ...
   public void a(dtc $$0, float $$1, fer $$2, gjg $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.m().c(dwl.bv);
         if ($$6 > 0) {
            jm $$7 = $$0.c();
            if ($$7 != null) {
               ...
               if (!$$8.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = gjc.a($$0.i(), $$0.m(), $$0.aA_().a($$7));
                  this.a.a($$8, cwk.i, $$11, gyv.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
