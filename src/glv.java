...
public class glv {
   ...
   public static class b extends gnl {
      b(gjd $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gmx {
      ...
      c(gjd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gmn $$7, gng $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            glv.c $$0 = new glv.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gmo<mb> {
      ...
      public gml a(mb $$0, gjd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         glv.c $$8 = new glv.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fof.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gmj {
      ...
      private int D;
      private final gmn E;
      private final List<dbg> F;
      private boolean G;

      public e(gjd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gmn $$7, List<dbg> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gml $$12 = this.E.a(lx.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         glv.c $$10 = (glv.c)this.E.a(lx.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
