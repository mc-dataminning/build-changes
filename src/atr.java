...
public class atr extends atq {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, atr.a> s;
   private final atm t;
   private long u;
   private final ajx v;

   private atr(ajx $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == atn.c($$2, 7, $$0.getLength());
      }
   }
