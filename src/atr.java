...
public class atr extends ati {
   private static final ate c = new ate(wy.c("dataPack.vanilla.description"), ab.b().a(asr.b), Optional.empty());
   private static final asl d = new asl(cpl.g);
   private static final ash e = ash.a(ate.b, c, asl.a, d);
   private static final aso f = new aso("vanilla", wy.c("dataPack.vanilla.name"), atp.c, Optional.of(b));
   private static final asq g = new asq(false, atl.b.b, false);
   private static final asq h = new asq(false, atl.b.a, false);
   private static final akq i = akq.b("datapacks");
   ...
   public static ato a(Path $$0, ewm $$1) {
      return new ato(new atr($$1), new atj($$0, asr.b, atp.e, $$1));
   }

   public static ato c() {
      return new ato(new atr(new ewm($$0 -> true)));
   }

   public static ato a(eqz.c $$0) {
      return a($$0.a(eqx.j), $$0.d().e());
   }
}
