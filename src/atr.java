...
public class atr extends atw {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<ats<?>> e = Sets.newHashSet();

   public atr(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(chl $$0, ats<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<ats<?>> d() {
      Set<ats<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  sw $$4 = a($$3.getAsJsonObject());
                  $$4 = axo.g.a($$0, $$4, tl.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<ats<T>> a(atu<T> $$0, String $$1) {
      return Optional.ofNullable(aiy.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static sw a(JsonObject $$0) {
      sw $$1 = new sw();
   ...
   protected String b() {
      Map<atu<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<ats<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<ats<?>>)$$3.next();
         ats<?> $$2 = (ats<?>)$$1.getKey();
      ...
      for (Entry<atu<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(kf.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> aiy b(ats<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aox $$0) {
      Object2IntMap<ats<?>> $$1 = new Object2IntOpenHashMap();
