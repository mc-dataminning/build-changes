   ...
   public void a(fob $$0) {
      if (this.e != null) {
         ...
         $$0.a($$4x -> {
            ...
            for (bot $$6x : $$1) {
               int $$7x = ayy.a($$6x.a / 4.0) + 1;
               ffw $$8x = $$4x.getBuffer(gmf.D());
               int $$9x = axj.f($$6x.a());
               int $$10x = axj.a($$9x, -8355712);
               ffs.a $$11x = $$0.c().c();
