...
public class fqj {
   public static void a(ghl $$0, fqh $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fqg>> $$6 : $$1.c().entrySet()) {
         Optional<gjt> $$7 = $$0.a($$6.getKey());
         List<fqg> $$8 = $$6.getValue();
   ...
   private static float a(fqh $$0, long $$1) {
