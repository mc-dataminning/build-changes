...
public class fqj {
   ...
   public fqj(Runnable $$0, Function<atx, alf> $$1, aua $$2, Consumer<aua> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fqj.a> a() {
      return this.c.stream().map($$0 -> new fqj.d($$0));
   }

   public Stream<fqj.a> b() {
      return this.b.stream().map($$0 -> new fqj.c($$0));
   }
   ...
   abstract class b implements fqj.a {
      private final atx b;
      ...
      @Override
      public alf a() {
         return fqj.this.d.apply(this.b);
      }
