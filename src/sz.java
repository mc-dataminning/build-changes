...
public class sz {
   ...
   public static void a(Class<?> $$0) {
      Arrays.stream($$0.getDeclaredMethods()).sorted(Comparator.comparing(Method::getName)).forEach(sz::a);
   }

   public static void a(Method $$0) {
      String $$1 = $$0.getDeclaringClass().getSimpleName();
      so $$2 = $$0.getAnnotation(so.class);
      if ($$2 != null) {
         a.add(c($$0));
         b.add($$1);
      }

      sv $$3 = $$0.getAnnotation(sv.class);
      if ($$3 != null) {
         a.addAll(b($$0));
         b.add($$1);
      }
   ...
   private static <T extends Annotation> void a(Method $$0, Class<T> $$1, Function<T, String> $$2, Map<String, Consumer<aqu>> $$3) {
      T $$4 = $$0.getAnnotation($$1);
      if ($$4 != null) {
         String $$5 = $$2.apply($$4);
         Consumer<aqu> $$6 = $$3.putIfAbsent($$5, (Consumer<aqu>)d($$0));
         if ($$6 != null) {
   ...
   public static Stream<tr> a(String $$0) {
   ...
   public static Consumer<aqu> c(String $$0) {
      return c.getOrDefault($$0, $$0x -> {
      });
   }

   public static Consumer<aqu> d(String $$0) {
      return d.getOrDefault($$0, $$0x -> {
      });
   }

   public static Optional<tr> e(String $$0) {
      return a().stream().filter($$1 -> $$1.c().equalsIgnoreCase($$0)).findFirst();
   }

   public static tr f(String $$0) {
      Optional<tr> $$1 = e($$0);
      if ($$1.isEmpty()) {
   ...
   private static Collection<tr> b(Method $$0) {
      try {
         Object $$1 = $$0.getDeclaringClass().newInstance();
         return (Collection<tr>)$$0.invoke($$1);
      } catch (ReflectiveOperationException var2) {
         throw new RuntimeException(var2);
      }
   }

   private static tr c(Method $$0) {
      so $$1 = $$0.getAnnotation(so.class);
      ...
      String $$6 = $$1.b();
      dmm $$7 = tn.a($$1.d());
      return new tr($$6, $$4, $$5, $$7, $$1.a(), $$1.h(), $$1.e(), $$1.f(), $$1.j(), $$1.i(), $$1.c(), (Consumer<sw>)d($$0));
   }
   ...
   private static boolean a(tr $$0, String $$1) {
