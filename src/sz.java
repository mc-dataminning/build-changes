...
public class sz {
   ...
   protected sz(sz.b $$0, Collection<sq> $$1, aqt $$2, tc $$3, sz.c $$4, sz.c $$5) {
      this.c = $$2;
      this.d = $$3;
      this.i = $$0;
      this.l = $$4;
         ...
         $$3.a(new sx() {
            private void a() {
               if ($$3.i()) {
                  ...
                  $$0.forEach($$0xxx -> sz.this.c.a(dcb.a($$0xxx), dcb.b($$0xxx), false));
                  sz.this.a($$0 + 1);
               }
            }
   ...
   public static class a {
      ...
      private a(Collection<sq> $$0, aqt $$1) {
         this.f = $$0;
         this.a = $$1;
      }

      public static sz.a a(Collection<sq> $$0, aqt $$1) {
         return new sz.a($$0, $$1);
      }

      public static sz.a b(Collection<sw> $$0, aqt $$1) {
