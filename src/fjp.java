...
public class fjp {
   ...
   private static final List<fjp.e> c = Lists.newArrayList(new fjp.e[]{new fjp.a(), new fjp.b()});
   ...
   public static void a(emz $$0, float $$1, few $$2, int $$3, float $$4) {
      dxg $$5 = $$0.k();
      bfj $$6 = $$0.g();
      if ($$5 == dxg.b) {
         long $$7 = ac.b();
         ...
         float $$16 = apa.i($$15, (float)$$12, (float)$$9);
         float $$17 = apa.i($$15, (float)$$13, (float)$$10);
         float $$18 = apa.i($$15, (float)$$14, (float)$$11);
         d = $$16 / 255.0F;
         e = $$17 / 255.0F;
         f = $$18 / 255.0F;
         if (g != $$8) {
         ...
         eei $$27 = aoc.a($$26, ($$3x, $$4x, $$5x) -> $$2.d().a(eei.a($$25.a($$3x, $$4x, $$5x).a().e()), $$24));
         d = (float)$$27.a();
         e = (float)$$27.b();
         f = (float)$$27.c();
         if ($$3 >= 4) {
      ...
      if ($$5 == dxg.b) {
         ...
         label86: {
            if ($$6 instanceof bfz $$42 && $$42.a(bfc.p) && !$$42.a(bfc.G)) {
               $$40 = fjq.a($$42, $$1);
               break label86;
            }
   ...
   @Nullable
   private static fjp.e a(bfj $$0, float $$1) {
      return $$0 instanceof bfz $$2 ? c.stream().filter($$2x -> $$2x.a($$2, $$1)).findFirst().orElse(null) : null;
   }

   public static void a(emz $$0, fjp.d $$1, float $$2, boolean $$3, float $$4) {
      dxg $$5 = $$0.k();
      bfj $$6 = $$0.g();
      fjp.c $$7 = new fjp.c($$1);
      fjp.e $$8 = a($$6, $$4);
      if ($$5 == dxg.a) {
         ...
         $$7.b = -8.0F;
         $$7.c = 96.0F;
         if ($$6 instanceof fiy $$11) {
            $$7.c = $$7.c * Math.max(0.25F, $$11.J());
   ...
   static class a implements fjp.e {
      @Override
      public bey a() {
         return bfc.o;
      }
      ...
      @Override
      public void a(fjp.c $$0, bfz $$1, bfa $$2, float $$3, float $$4) {
         float $$5 = $$2.b() ? 5.0F : apa.i(Math.min(1.0F, (float)$$2.d() / 20.0F), $$3, 5.0F);
         if ($$0.a == fjp.d.a) {
            $$0.b = 0.0F;
            $$0.c = $$5 * 0.8F;
         } else {
   ...
   static class b implements fjp.e {
      @Override
      public bey a() {
         return bfc.G;
      }
   ...
   interface e {
      ...
      void a(fjp.c var1, bfz var2, bfa var3, float var4, float var5);

      default boolean a(bfz $$0, float $$1) {
         return $$0.a(this.a());
      }

      default float a(bfz $$0, bfa $$1, float $$2, float $$3) {
         bfa $$4 = $$0.b(this.a());
         if ($$4 != null) {
            if ($$4.a(19)) {
