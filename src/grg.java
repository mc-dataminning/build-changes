...
public class grg {
   ...
   public static gqz a(Vector3f $$0, Vector3f $$1, grb $$2, hip $$3, ja $$4, hlf $$5, @Nullable grc $$6, boolean $$7, int $$8) {
      grd $$9 = $$2.d();
      if ($$5.b()) {
         $$9 = a($$2.d(), $$4, $$5.a());
      }
      ...
      $$9.a[0] = azm.h($$11, $$9.a[0], $$12);
      $$9.a[2] = azm.h($$11, $$9.a[2], $$12);
      $$9.a[1] = azm.h($$11, $$9.a[1], $$13);
      $$9.a[3] = azm.h($$11, $$9.a[3], $$13);
      ...
      return new gqz($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static grd a(grd $$0, ja $$1, j $$2) {
      Matrix4f $$3 = it.a($$2, $$1).c();
      float $$4 = $$0.a($$0.c(0));
      float $$5 = $$0.b($$0.c(0));
      ...
      Vector3f $$24 = $$23.transform(new Vector3f(azm.b($$22), azm.a($$22), 0.0F));
      int $$25 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$24.y(), (double)$$24.x())) / 90.0)) * 90, 360);
      return new grd(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private static int[] a(grd $$0, hip $$1, ja $$2, float[] $$3, j $$4, @Nullable grc $$5) {
      int[] $$6 = new int[32];
   ...
   private static float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[ja.values().length];
      $$2[gpf.a.f] = $$0.x() / 16.0F;
      $$2[gpf.a.e] = $$0.y() / 16.0F;
      $$2[gpf.a.d] = $$0.z() / 16.0F;
      $$2[gpf.a.c] = $$1.x() / 16.0F;
   ...
   private static void a(int[] $$0, int $$1, ja $$2, grd $$3, float[] $$4, hip $$5, j $$6, @Nullable grc $$7) {
      gpf.b $$8 = gpf.a($$2).a($$1);
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hip $$3, grd $$4) {
      int $$5 = $$1 * 8;
   ...
   private static void a(Vector3f $$0, @Nullable grc $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private static ja a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? ja.b : $$7;
      }
   }

   private static void a(int[] $$0, ja $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[ja.values().length];
      $$3[gpf.a.f] = 999.0F;
      $$3[gpf.a.e] = 999.0F;
      $$3[gpf.a.d] = 999.0F;
      $$3[gpf.a.c] = -999.0F;
