...
public class grg {
   ...
   static final ja[] c = ja.values();
   private final fqb d;
   private static final int e = 100;
   static final ThreadLocal<grg.d> f = ThreadLocal.withInitial(grg.d::new);

   public grg(fqb $$0) {
      this.d = $$0;
   }

   public void a(did $$0, hkx $$1, eah $$2, iu $$3, fjj $$4, fjn $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      boolean $$10 = foz.P() && $$2.k() == 0 && $$1.a();
      $$4.a($$2.a($$3));
   ...
   public void b(did $$0, hkx $$1, eah $$2, iu $$3, fjj $$4, fjn $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      ...
      for (ja $$14 : c) {
         $$7.b($$8);
         List<grh> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dmf.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<grh> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(did $$0, hkx $$1, eah $$2, iu $$3, fjj $$4, fjn $$5, boolean $$6, azv $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      iu.a $$11 = $$3.k();

      for (ja $$12 : c) {
         $$7.b($$8);
         List<grh> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dmf.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = gpv.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<grh> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(did $$0, eah $$1, iu $$2, fjj $$3, fjn $$4, List<grh> $$5, float[] $$6, BitSet $$7, grg.b $$8, int $$9) {
      for (grh $$10 : $$5) {
   ...
   private void a(
      did $$0, eah $$1, iu $$2, fjn $$3, fjj.a $$4, grh $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(did $$0, eah $$1, iu $$2, int[] $$3, ja $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(did $$0, eah $$1, iu $$2, int $$3, int $$4, boolean $$5, fjj $$6, fjn $$7, List<grh> $$8, BitSet $$9) {
      for (grh $$10 : $$8) {
         if ($$5) {
            this.a($$0, $$1, $$2, $$10.b(), $$10.e(), null, $$9);
            iu $$11 = $$9.get(0) ? $$2.a($$10.e()) : $$2;
            $$3 = gpv.a($$0, $$1, $$11);
         }
   ...
   public void a(fjj.a $$0, fjn $$1, @Nullable eah $$2, hkx $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azv $$9 = azv.a();
      long $$10 = 42L;
   ...
   private static void a(fjj.a $$0, fjn $$1, float $$2, float $$3, float $$4, List<grh> $$5, int $$6, int $$7) {
      for (grh $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         new ja[]{ja.e, ja.f, ja.c, ja.d},
         0.5F,
         true,
         new grg.e[]{grg.e.k, grg.e.d, grg.e.k, grg.e.j, grg.e.e, grg.e.j, grg.e.e, grg.e.d},
         new grg.e[]{grg.e.k, grg.e.c, grg.e.k, grg.e.i, grg.e.e, grg.e.i, grg.e.e, grg.e.c},
         new grg.e[]{grg.e.l, grg.e.c, grg.e.l, grg.e.i, grg.e.f, grg.e.i, grg.e.f, grg.e.c},
         new grg.e[]{grg.e.l, grg.e.d, grg.e.l, grg.e.j, grg.e.f, grg.e.j, grg.e.f, grg.e.d}
      ),
      b(
         new ja[]{ja.f, ja.e, ja.c, ja.d},
         1.0F,
         true,
         new grg.e[]{grg.e.f, grg.e.d, grg.e.f, grg.e.j, grg.e.l, grg.e.j, grg.e.l, grg.e.d},
         new grg.e[]{grg.e.f, grg.e.c, grg.e.f, grg.e.i, grg.e.l, grg.e.i, grg.e.l, grg.e.c},
         new grg.e[]{grg.e.e, grg.e.c, grg.e.e, grg.e.i, grg.e.k, grg.e.i, grg.e.k, grg.e.c},
         new grg.e[]{grg.e.e, grg.e.d, grg.e.e, grg.e.j, grg.e.k, grg.e.j, grg.e.k, grg.e.d}
      ),
      c(
         new ja[]{ja.b, ja.a, ja.f, ja.e},
         0.8F,
         true,
         new grg.e[]{grg.e.b, grg.e.k, grg.e.b, grg.e.e, grg.e.h, grg.e.e, grg.e.h, grg.e.k},
         new grg.e[]{grg.e.b, grg.e.l, grg.e.b, grg.e.f, grg.e.h, grg.e.f, grg.e.h, grg.e.l},
         new grg.e[]{grg.e.a, grg.e.l, grg.e.a, grg.e.f, grg.e.g, grg.e.f, grg.e.g, grg.e.l},
         new grg.e[]{grg.e.a, grg.e.k, grg.e.a, grg.e.e, grg.e.g, grg.e.e, grg.e.g, grg.e.k}
      ),
      d(
         new ja[]{ja.e, ja.f, ja.a, ja.b},
         0.8F,
         true,
         new grg.e[]{grg.e.b, grg.e.k, grg.e.h, grg.e.k, grg.e.h, grg.e.e, grg.e.b, grg.e.e},
         new grg.e[]{grg.e.a, grg.e.k, grg.e.g, grg.e.k, grg.e.g, grg.e.e, grg.e.a, grg.e.e},
         new grg.e[]{grg.e.a, grg.e.l, grg.e.g, grg.e.l, grg.e.g, grg.e.f, grg.e.a, grg.e.f},
         new grg.e[]{grg.e.b, grg.e.l, grg.e.h, grg.e.l, grg.e.h, grg.e.f, grg.e.b, grg.e.f}
      ),
      e(
         new ja[]{ja.b, ja.a, ja.c, ja.d},
         0.6F,
         true,
         new grg.e[]{grg.e.b, grg.e.d, grg.e.b, grg.e.j, grg.e.h, grg.e.j, grg.e.h, grg.e.d},
         new grg.e[]{grg.e.b, grg.e.c, grg.e.b, grg.e.i, grg.e.h, grg.e.i, grg.e.h, grg.e.c},
         new grg.e[]{grg.e.a, grg.e.c, grg.e.a, grg.e.i, grg.e.g, grg.e.i, grg.e.g, grg.e.c},
         new grg.e[]{grg.e.a, grg.e.d, grg.e.a, grg.e.j, grg.e.g, grg.e.j, grg.e.g, grg.e.d}
      ),
      f(
         new ja[]{ja.a, ja.b, ja.c, ja.d},
         0.6F,
         true,
         new grg.e[]{grg.e.g, grg.e.d, grg.e.g, grg.e.j, grg.e.a, grg.e.j, grg.e.a, grg.e.d},
         new grg.e[]{grg.e.g, grg.e.c, grg.e.g, grg.e.i, grg.e.a, grg.e.i, grg.e.a, grg.e.c},
         new grg.e[]{grg.e.h, grg.e.c, grg.e.h, grg.e.i, grg.e.b, grg.e.i, grg.e.b, grg.e.c},
         new grg.e[]{grg.e.h, grg.e.d, grg.e.h, grg.e.j, grg.e.b, grg.e.j, grg.e.b, grg.e.d}
      );
      ...
      final grg.e[] k;
      final grg.e[] l;
      private static final grg.a[] m = af.a(new grg.a[6], $$0 -> {
         $$0[ja.a.d()] = a;
         $$0[ja.b.d()] = b;
         $$0[ja.c.d()] = c;
         $$0[ja.d.d()] = d;
      ...
      private a(final ja[] $$0, final float $$1, final boolean $$2, final grg.e[] $$3, final grg.e[] $$4, final grg.e[] $$5, final grg.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(did $$0, eah $$1, iu $$2, ja $$3, float[] $$4, BitSet $$5, boolean $$6) {
         iu $$7 = $$5.get(0) ? $$2.a($$3) : $$2;
         grg.a $$8 = grg.a.a($$3);
         iu.a $$9 = new iu.a();
         grg.d $$10 = grg.f.get();
         $$9.a($$7, $$8.g[0]);
         ...
         eah $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         eah $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         eah $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         eah $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final grg.c[] k = af.a(new grg.c[6], $$0 -> {
         $$0[ja.a.d()] = a;
         $$0[ja.b.d()] = b;
         $$0[ja.c.d()] = c;
         $$0[ja.d.d()] = d;
   ...
   static class d {
      ...
      public float b(eah $$0, did $$1, iu $$2) {
         long $$3 = $$2.a();
         if (this.a) {
   ...
   protected static enum e {
      ...
      private e(final ja $$0, final boolean $$1) {
         this.m = $$0.d() + ($$1 ? grg.c.length : 0);
      }
   }
}
