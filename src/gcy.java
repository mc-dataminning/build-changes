...
public class gcy implements eyk, AutoCloseable {
   ...
   private static final eyd t = new eyd();
   ...
   private final List<eyl> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, eyl> C = Maps.newHashMap();
   private final int D;
   ...
   public gcy(aua $$0, String $$1, eyz $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      akn $$3 = new akn("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         JsonArray $$13 = axv.a($$5, "uniforms", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         this.G = a(axv.a($$5, "blend", null));
         this.H = a($$0, eyi.a.a, $$6);
         this.I = a($$0, eyi.a.b, $$7);
         this.D = eyj.a();
         int $$18 = 0;
   ...
   private static eyi a(final aua $$0, eyi.a $$1, String $$2) throws IOException {
      eyi $$3 = $$1.c().get($$2);
      eyi $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         atv $$5 = $$0.getResourceOrThrow(new akn($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = eyi.a($$1, $$2, $$6, $$5.b(), new eyb() {
   ...
   public static eye a(JsonObject $$0) {
      if ($$0 == null) {
         return new eye();
      } else {
         int $$1 = 32774;
