...
public class gcy extends MinecraftServer {
   ...
   public gcy(Thread $$0, eqq $$1, ecb.c $$2, ana $$3, afp $$4, afm $$5, akx $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gcx(this, this.aV(), this.i));
      this.p = $$1;
   }
   ...
   public boolean a(@Nullable cpn $$0, boolean $$1, int $$2) {
      try {
         ...
         this.r = $$2;
         this.t = new gdb(this.aa(), $$2 + "");
         this.t.start();
         this.s = $$0;
         this.ac().b($$1);
         int $$3 = this.c(this.p.s.fP());
         this.p.s.a($$3);
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (ako $$1 : Lists.newArrayList(this.ac().t())) {
   ...
   @Override
   public cpn aW() {
      return this.p() ? (cpn)MoreObjects.firstNonNull(this.s, this.m.m()) : null;
   }
}
