...
public class gcy extends ru {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gcy(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gcy a(aph $$0, List<String> $$1, boolean $$2) {
      ...
      return new gcy(ImmutableMap.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<apf> $$1, Map<String, String> $$2) {
      for (apf $$3 : $$1) {
