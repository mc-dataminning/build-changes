...
public class gcy implements eyi, AutoCloseable {
   ...
   private static final eyb t = new eyb();
   ...
   private final List<eyj> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, eyj> C = Maps.newHashMap();
   private final int D;
   ...
   public gcy(atz $$0, String $$1, eyx $$2) throws IOException {
      this.E = $$1;
      this.J = $$2;
      akm $$3 = new akm("shaders/core/" + $$1 + ".json");
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         this.H = a($$0, eyg.a.a, $$6);
         this.I = a($$0, eyg.a.b, $$7);
         this.D = eyh.a();
         int $$18 = 0;
   ...
   private static eyg a(final atz $$0, eyg.a $$1, String $$2) throws IOException {
      eyg $$3 = $$1.c().get($$2);
      eyg $$8;
      if ($$3 == null) {
         String $$4 = "shaders/core/" + $$2 + $$1.b();
         atu $$5 = $$0.getResourceOrThrow(new akm($$4));

         try (InputStream $$6 = $$5.d()) {
            final String $$7 = v.a($$4);
            $$8 = eyg.a($$1, $$2, $$6, $$5.b(), new exz() {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gcy.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
