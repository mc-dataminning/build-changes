...
public class ayk extends DataFix {
   public ayk(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(bat.F));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(bat.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(bat.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(bat.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(bat.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(bat.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(bat.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(bat.s);
      Type<?> $$9 = this.getOutputSchema().getType(bat.s);
