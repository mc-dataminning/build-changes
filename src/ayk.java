...
public class ayk {
   ...
   ayk(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ayk.a a() {
      return new ayk.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ayk::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ayk.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ayk a(Writer $$0) throws IOException {
         return new ayk($$0, this.a);
      }
   }
}
