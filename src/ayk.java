...
public class ayk<T> extends AbstractList<T> implements azv<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return ayk.this.get(this.b--);
      }

      @Override
      public void remove() {
         ayk.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azv<T> {
      private final ayk<T> b;

      public b(final ayk<T> $$0) {
         this.b = $$0;
      }
