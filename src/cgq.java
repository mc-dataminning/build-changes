...
public class cgq extends cgp {
   ...
   private static final ajx<Byte> bX = akb.a(cgq.class, ajz.a);
   private static final int bY = 1;
   private static final cfw bZ = cfw.b().a(4.0);
   public final bub c = new bub();
   public final bub d = new bub();
   @Nullable
   private ji ca;

   public cgq(buq<? extends cgq> $$0, dgg $$1) {
      super($$0, $$1);
      if (!$$1.C) {
         this.x(true);
      }
   ...
   @Override
   public avy u() {
      return this.p() && this.ae.a(4) != 0 ? null : avz.bF;
   }
   ...
   public void h() {
      ...
      if (this.p()) {
         this.h(fay.c);
         this.o(this.dB(), (double)ayy.a(this.dD()) + 1.0 - (double)this.ds(), this.dH());
      } else {
   ...
   protected void a(arc $$0) {
      ...
      if (this.p()) {
         ...
         fay $$7 = this.dz();
         fay $$8 = $$7.b((Math.signum($$4) * 0.5 - $$7.d) * 0.1F, (Math.signum($$5) * 0.7F - $$7.e) * 0.1F, (Math.signum($$6) * 0.5 - $$7.f) * 0.1F);
         this.h($$8);
         float $$9 = (float)(ayy.d($$8.f, $$8.d) * 180.0F / (float)Math.PI) - 90.0F;
         float $$10 = ayy.h($$9 - this.dM());
         this.bp = 0.5F;
         this.v(this.dM() + $$10);
   ...
   public static boolean b(buq<cgq> $$0, dgh $$1, bup $$2, ji $$3, azg $$4) {
      if ($$3.v() >= $$1.a(ecq.a.b, $$3).v()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
         int $$6 = 4;
         ...
         if ($$5 > $$4.a($$6)) {
            ...
            return !$$1.a_($$3.e()).a(awo.cj) ? false : a($$0, $$1, $$2, $$3, $$4);
         }
      }
   }
