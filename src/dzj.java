...
public class dzj extends efw {
   ...
   public static efw.a<dzj> a() {
      return new efw.a<>(dzj::new, dzj::b, avw.o);
   }

   private dzj(LongSet $$0, LongSet $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static dzj b(sn $$0) {
      return new dzj(new LongOpenHashSet($$0.o("All")), new LongOpenHashSet($$0.o("Remaining")));
   }
