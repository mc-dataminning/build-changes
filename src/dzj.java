...
public class dzj {
   ...
   private final dzj.a g;

   @Deprecated
   public static dzj a(ash $$0, dzj.a $$1) {
      return new dzj($$0, $$1, false);
   }

   public static dzj a(ash $$0, int $$1, double... $$2) {
      return b($$0, new dzj.a($$1, new DoubleArrayList($$2)));
   }

   public static dzj b(ash $$0, dzj.a $$1) {
      return new dzj($$0, $$1, true);
   }

   private dzj(ash $$0, dzj.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<dzj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(dzj.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(dzj.a::b))
               .apply($$0, dzj.a::new)
      );
      public static final Codec<he<dzj.a>> b = aev.a(jc.ay, a);
