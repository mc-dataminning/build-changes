...
public class dzj {
   ...
   private final dci p;
   private static final List<dfi> q = List.of(dfk.l, dfk.L, dfk.i, dfk.b, dfk.k, dfk.I, dfk.K, dfk.fl, dfk.dP, dfk.iA, dfk.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<jj<ddg>>> t;
   ...
   public static final Codec<dzj> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dzj::a, Function.identity());
   ...
   private dzj(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<jj<ddg>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kc.c($$0);
      int $$5 = kc.c($$1) - $$4;
   ...
   @Nullable
   public static dzj a(aqt $$0, int $$1, int $$2) {
      duh $$3 = $$0.a($$1, $$2);
      dzj $$4 = $$3.t();
      if ($$4 != null && !$$3.k().d(dvi.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jg> a(ddc $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, duh $$1, int $$2, int $$3) {
   ...
   private int a(duh $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dyg.a.a)) {
         $$3 = Math.min($$0.a(dyg.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(duh $$0, ja.a $$1) {
      return a($$0, (ja)$$1.c(jf.a)) ? 1.0 : -1.0;
   }

   private static double b(duh $$0, ja.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(duh $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jj<ddg>> b(duh $$0, int $$1, int $$2) {
      ObjectArrayList<jj<ddg>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(duh $$0, ja $$1) {
      dsl $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avw.O)) {
         ...
         return $$2.a(dfk.eT) || $$2.a(dfk.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dzj.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dzj.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, jj<ddg> var3);
   }
